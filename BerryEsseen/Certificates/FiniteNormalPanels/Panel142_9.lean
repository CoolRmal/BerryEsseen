...
namespace FiniteNormalPanel142_9
...
def j2 : Jet := ⟨⟨442622234, 442622238⟩, ⟨442622234, 442622238⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨45614885, 45614887⟩, ⟨91229770, 91229774⟩, ⟨45614885, 45614887⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1006), (-1005)⟩, ⟨(-2012), (-2009)⟩, ⟨(-1006), (-1003)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112050, 5112052⟩, ⟨(-2012), (-2009)⟩, ⟨(-1006), (-1003)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨54292, 54293⟩, ⟨108563, 108565⟩, ⟨54238, 54241⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143111285), (-143111283)⟩, ⟨108563, 108565⟩, ⟨54238, 54241⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1519920), (-1519919)⟩, ⟨(-3038688), (-3038685)⟩, ⟨(-1517039), (-1517035)⟩, ⟨2303, 2307⟩, ⟨574, 577⟩⟩
...
def j19 : Jet := ⟨⟨1430135845, 1430135847⟩, ⟨(-3038688), (-3038685)⟩, ⟨(-1517039), (-1517035)⟩, ⟨2303, 2307⟩, ⟨574, 577⟩⟩
...
def j25 : Jet := ⟨⟨125, 126⟩, ⟨250, 252⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852052), (-852050)⟩, ⟨250, 252⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9050), (-9049)⟩, ⟨(-18097), (-18095)⟩, ⟨(-9044), (-9041)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782344, 35782346⟩, ⟨(-18097), (-18095)⟩, ⟨(-9044), (-9041)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨380027, 380028⟩, ⟨759862, 759864⟩, ⟨379545, 379548⟩, ⟨(-386), (-383)⟩, ⟨(-98), (-94)⟩⟩
...
def j33 : Jet := ⟨⟨(-715447856), (-715447854)⟩, ⟨759862, 759864⟩, ⟨379545, 379548⟩, ⟨(-386), (-383)⟩, ⟨(-98), (-94)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7598446), (-7598444)⟩, ⟨(-15188821), (-15188818)⟩, ⟨(-7578276), (-7578271)⟩, ⟨16126, 16130⟩, ⟨4019, 4024⟩⟩
...
def j36 : Jet := ⟨⟨4287368850, 4287368852⟩, ⟨(-15188821), (-15188818)⟩, ⟨(-7578276), (-7578271)⟩, ⟨16126, 16130⟩, ⟨4019, 4024⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨147384107, 147384110⟩, ⟨147070951, 147070956⟩, ⟨(-469497), (-469493)⟩, ⟨(-156104), (-156101)⟩, ⟨296, 298⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302579206, 4302579209⟩, ⟨15242702, 15242707⟩, ⟨7659155, 7659163⟩, ⟨37889, 37897⟩, ⟨9573, 9584⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨147645313, 147645317⟩, ⟨147854663, 147854670⟩, ⟨314448, 314455⟩, ⟨105521, 105528⟩, ⟨528, 536⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-140891034), (-140891033)⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4154076262, 4154076263⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5075507, 5075508⟩, ⟨10165408, 10165410⟩, ⟨5111529, 5111532⟩, ⟨28902, 28908⟩, ⟨7323, 7328⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300042803, 4300042804⟩, ⟨10165408, 10165410⟩, ⟨5111529, 5111532⟩, ⟨28902, 28908⟩, ⟨7323, 7328⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297504300, 4297504301⟩, ⟨5079703, 5079705⟩, ⟨2551253, 2551256⟩, ⟨11426, 11431⟩, ⟨2887, 2892⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4156530042, 4156530045⟩, ⟨(-136061189), (-136061184)⟩, ⟨2300928, 2300933⟩, ⟨(-72640), (-72633)⟩, ⟨2417, 2424⟩⟩
...
def j47 : Jet := ⟨⟨1567482233, 1567482246⟩, ⟨1567482233, 1567482246⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨572065019, 572065030⟩, ⟨1144130038, 1144130060⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨572065019, 572065030⟩, ⟨1144130038, 1144130060⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-572065030), (-572065019)⟩, ⟨(-1144130060), (-1144130038)⟩, ⟨(-572065030), (-572065019)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-286032515), (-286032509)⟩, ⟨(-572065030), (-572065019)⟩, ⟨(-286032515), (-286032509)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4018251293, 4018251300⟩, ⟨(-535208046), (-535208033)⟩, ⟨(-231960703), (-231960693)⟩, ⟨34060825, 34060828⟩, ⟨6589781, 6589783⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3888733269, 3888733280⟩, ⟨(-645252032), (-645252012)⟩, ⟨(-205376393), (-205376375)⟩, ⟨39956607, 39956620⟩, ⟨5185399, 5185412⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 281782067⟩, ⟨140891033, 140891034⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 885244472⟩, ⟨442622234, 442622238⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 182459545⟩, ⟨0, 182459546⟩, ⟨45614885, 45614887⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4023), 0⟩, ⟨(-4023), 2⟩, ⟨(-1006), (-1002)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109033, 5113057⟩, ⟨(-4023), 2⟩, ⟨(-1006), (-1002)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 217214⟩, ⟨(-171), 217215⟩, ⟨54046, 54305⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142948362)⟩, ⟨(-171), 217215⟩, ⟨54046, 54305⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6081985), 0⟩, ⟨(-6081993), 9228⟩, ⟨(-1520505), (-1506654)⟩, ⟨(-6), 4615⟩, ⟨568, 578⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425573780, 1431655766⟩, ⟨(-6081993), 9228⟩, ⟨(-1520505), (-1506654)⟩, ⟨(-6), 4615⟩, ⟨568, 578⟩⟩
...
def j72 : Jet := ⟨⟨0, 503⟩, ⟨(-1), 503⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851673)⟩, ⟨(-1), 503⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-36203), 0⟩, ⟨(-36204), 22⟩, ⟨(-9052), (-9017)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35755191, 35791395⟩, ⟨(-36204), 22⟩, ⟨(-9052), (-9017)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1520497⟩, ⟨(-1539), 1520498⟩, ⟨377815, 380126⟩, ⟨(-771), 2⟩, ⟨(-99), (-93)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714307385)⟩, ⟨(-1539), 1520498⟩, ⟨377815, 380126⟩, ⟨(-771), 2⟩, ⟨(-99), (-93)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30409925), 0⟩, ⟨(-30409991), 64595⟩, ⟨(-7602548), (-7505588)⟩, ⟨(-50), 32299⟩, ⟨3974, 4039⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264557371, 4294967296⟩, ⟨(-30409991), 64595⟩, ⟨(-7602548), (-7505588)⟩, ⟨(-50), 32299⟩, ⟨3974, 4039⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 295081491⟩, ⟨145660387, 147542650⟩, ⟨(-940181), 952⟩, ⟨(-156700), (-154317)⟩, ⟨(-1), 596⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4325594070⟩, ⟨(-65520), 30845237⟩, ⟨7505124, 7931314⟩, ⟨(-33000), 111599⟩, ⟨8581, 10936⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 297185674⟩, ⟨145655885, 150713947⟩, ⟨(-949137), 1605483⟩, ⟨87691, 125827⟩, ⟨(-3999), 5192⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-281782067), 0⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4013185229, 4294967296⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20563446⟩, ⟨0, 20856982⟩, ⟨4808300, 5510857⟩, ⟨(-66614), 130090⟩, ⟨5037, 10153⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315530742⟩, ⟨0, 20856982⟩, ⟨4808300, 5510857⟩, ⟨(-66614), 130090⟩, ⟨5037, 10153⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305236742⟩, ⟨0, 10428491⟩, ⟨2385784, 2755429⟩, ⟨(-39998), 65045⟩, ⟨1472, 4512⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4013185229, 4305236742⟩, ⟨(-141227911), (-130462542)⟩, ⟨1887164, 2755429⟩, ⟨(-130387), (-13217)⟩, ⟨(-759), 5825⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3134964479⟩, ⟨1567482233, 1567482246⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2288260098⟩, ⟨0, 2288260108⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2288260098⟩, ⟨0, 2288260108⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2288260098), 0⟩, ⟨(-2288260108), 0⟩, ⟨(-572065030), (-572065019)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1144130049), 0⟩, ⟨(-1144130054), 0⟩, ⟨(-286032515), (-286032509)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3290552239, 4294967296⟩, ⟨(-1144130054), 0⟩, ⟨(-286032515), (-66749779)⟩, ⟨0, 76195784⟩, ⟨(-2851750), 9524473⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3074667332, 4305236742⟩, ⟨(-1288093628), (-99952754)⟩, ⟨(-285270597), (-21993566)⟩, ⟨1163167, 85773221⟩, ⟨(-5548316), 9558477⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297504300, 4297504301⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2858
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305236742⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2859
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (250764081 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(26243 / 400000), prawitzNormalCorrection
