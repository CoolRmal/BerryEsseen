...
namespace FiniteNormalPanel116_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (40159 / 160000)
def radius : Rat := (5737 / 160000)

def j0 : Jet := ⟨⟨1078009947, 1078009948⟩, ⟨154001421, 154001422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3386668129, 3386668134⟩, ⟨483809732, 483809737⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2670455960, 2670455969⟩, ⟨762987416, 762987426⟩, ⟨54499101, 54499103⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨668, 670⟩, ⟨190, 192⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94019), (-94016)⟩, ⟨190, 192⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-58458), (-58455)⟩, ⟨(-16585), (-16581)⟩, ⟨(-1153), (-1148)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5054598, 5054602⟩, ⟨(-16585), (-16581)⟩, ⟨(-1153), (-1148)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3142766, 3142770⟩, ⟨887621, 887626⟩, ⟨60474, 60481⟩, ⟨(-414), (-409)⟩, ⟨(-15), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-140022811), (-140022806)⟩, ⟨887621, 887626⟩, ⟨60474, 60481⟩, ⟨(-414), (-409)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-87061141), (-87061137)⟩, ⟨(-24322722), (-24322716)⟩, ⟨(-1581476), (-1581468)⟩, ⟨21748, 21755⟩, ⟨683, 690⟩⟩
...
def j19 : Jet := ⟨⟨1344594624, 1344594629⟩, ⟨(-24322722), (-24322716)⟩, ⟨(-1581476), (-1581468)⟩, ⟨21748, 21755⟩, ⟨683, 690⟩⟩
...
def j22 : Jet := ⟨⟨(-68), (-66)⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11767, 11770⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7316, 7319⟩, ⟨2077, 2080⟩, ⟨143, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844861), (-844857)⟩, ⟨2077, 2080⟩, ⟨143, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-525305), (-525301)⟩, ⟨(-148796), (-148792)⟩, ⟨(-10265), (-10258)⟩, ⟨49, 54⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35266089, 35266094⟩, ⟨(-148796), (-148792)⟩, ⟨(-10265), (-10258)⟩, ⟨49, 54⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21927183, 21927188⟩, ⟨6172393, 6172398⟩, ⟨414676, 414684⟩, ⟨(-3683), (-3676)⟩, ⟨(-124), (-118)⟩⟩
...
def j33 : Jet := ⟨⟨(-693900700), (-693900694)⟩, ⟨6172393, 6172398⟩, ⟨414676, 414684⟩, ⟨(-3683), (-3676)⟩, ⟨(-124), (-118)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-431442463), (-431442457)⟩, ⟨(-119431505), (-119431498)⟩, ⟨(-7450613), (-7450604)⟩, ⟨149696, 149705⟩, ⟨4528, 4536⟩⟩
...
def j36 : Jet := ⟨⟨3863524833, 3863524839⟩, ⟨(-119431505), (-119431498)⟩, ⟨(-7450613), (-7450604)⟩, ⟨149696, 149705⟩, ⟨4528, 4536⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1060239914, 1060239921⟩, ⟨132283888, 132283897⟩, ⟨(-3986877), (-3986869)⟩, ⟨(-160999), (-160990)⟩, ⟨2987, 2996⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4774589226, 4774589235⟩, ⟨147594842, 147594853⟩, ⟨13770079, 13770094⟩, ⟨525288, 525305⟩, ⟨31465, 31482⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1178637628, 1178637639⟩, ⟨183490842, 183490857⟩, ⟨3513019, 3513035⟩, ⟨237798, 237817⟩, ⟨8949, 8969⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1078009948), (-1078009947)⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3216957348, 3216957349⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨323445223, 323445230⟩, ⟨100708198, 100708210⟩, ⟨9767255, 9767267⟩, ⟨430682, 430696⟩, ⟨28101, 28120⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4618412519, 4618412526⟩, ⟨100708198, 100708210⟩, ⟨9767255, 9767267⟩, ⟨430682, 430696⟩, ⟨28101, 28120⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4453754677, 4453754682⟩, ⟨48558850, 48558857⟩, ⟨4444797, 4444805⟩, ⟨159202, 159210⟩, ⟨9594, 9607⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3335890088, 3335890094⟩, ⟨(-123324061), (-123324053)⟩, ⟨1588041, 1588049⟩, ⟨(-40132), (-40123)⟩, ⟨1476, 1488⟩⟩
...
def j47 : Jet := ⟨⟨9342860547, 9342860558⟩, ⟨1334694363, 1334694373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20323564112, 20323564161⟩, ⟨5806732598, 5806732652⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20323564112, 20323564161⟩, ⟨5806732598, 5806732652⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20323564161), (-20323564112)⟩, ⟨(-5806732652), (-5806732598)⟩, ⟨(-414766621), (-414766614)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10161782081), (-10161782056)⟩, ⟨(-2903366326), (-2903366299)⟩, ⟨(-207383311), (-207383307)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨403116237, 403116245⟩, ⟨(-272503619), (-272503610)⟩, ⟨72640673, 72640679⟩, ⟨(-7596264), (-7596260)⟩, ⟨(-469981), (-469979)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨313099347, 313099355⟩, ⟨(-223227790), (-223227780)⟩, ⟨64393438, 64393447⟩, ⟨(-8090301), (-8090292)⟩, ⟨(-117377), (-117368)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨924008526, 1232011369⟩, ⟨154001421, 154001422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2902858397, 3870477867⟩, ⟨483809732, 483809737⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1961967645, 3487942489⟩, ⟨653989214, 871985630⟩, ⟨54499101, 54499103⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨491, 874⟩, ⟨163, 219⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94196), (-93812)⟩, ⟨163, 219⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-76497), (-42853)⟩, ⟨(-19051), (-14106)⟩, ⟨(-1167), (-1133)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5036559, 5070204⟩, ⟨(-19051), (-14106)⟩, ⟨(-1167), (-1133)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2300731, 4117513⟩, ⟨751438, 1022936⟩, ⟨59093, 61673⟩, ⟨(-478), (-345)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140864846), (-139048063)⟩, ⟨751438, 1022936⟩, ⟨59093, 61673⟩, ⟨(-478), (-345)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-114396327), (-63518015)⟩, ⟨(-28255821), (-20341944)⟩, ⟨(-1646029), (-1506622)⟩, ⟨18144, 25346⟩, ⟨638, 726⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1317259438, 1368137751⟩, ⟨(-28255821), (-20341944)⟩, ⟨(-1646029), (-1506622)⟩, ⟨18144, 25346⟩, ⟨638, 726⟩⟩
...
def j72 : Jet := ⟨⟨5366, 9574⟩, ⟨1770, 2387⟩, ⟨142, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846811), (-842602)⟩, ⟨1770, 2387⟩, ⟨142, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-687696), (-384905)⟩, ⟨(-171116), (-126362)⟩, ⟨(-10413), (-10085)⟩, ⟨41, 62⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35103698, 35406490⟩, ⟨(-171116), (-126362)⟩, ⟨(-10413), (-10085)⟩, ⟨41, 62⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16035586, 28753607⟩, ⟨5206231, 7130680⟩, ⟨402234, 425430⟩, ⟨(-4269), (-3087)⟩, ⟨(-128), (-112)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699792297), (-687074275)⟩, ⟨5206231, 7130680⟩, ⟨402234, 425430⟩, ⟨(-4269), (-3087)⟩, ⟨(-128), (-112)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-568301251), (-313859781)⟩, ⟨(-139697076), (-98829102)⟩, ⟨(-7903220), (-6925128)⟩, ⟨123842, 175445⟩, ⟨4132, 4878⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3726666045, 3981107515⟩, ⟨(-139697076), (-98829102)⟩, ⟨(-7903220), (-6925128)⟩, ⟨123842, 175445⟩, ⟨4132, 4878⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨890301917, 1232919024⟩, ⟨122920470, 140366282⟩, ⟨(-4666244), (-3309720)⟩, ⟨(-173156), (-146873)⟩, ⟨2474, 3511⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4633570935, 4949932152⟩, ⟨115026195, 185552191⟩, ⟨10915556, 17453002⟩, ⟨252919, 893767⟩, ⟨11022, 61560⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨960490919, 1420934107⟩, ⟨156454918, 215036422⟩, ⟨176861, 7503571⟩, ⟨(-36329), 579867⟩, ⟨(-14252), 38585⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1232011369), (-924008526)⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3062955927, 3370958770⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨214796235, 470097582⟩, ⟨69976564, 142284012⟩, ⟨5778363, 15731162⟩, ⟨(-11154), 1135048⟩, ⟨(-13063), 96708⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4509763531, 4765064878⟩, ⟨69976564, 142284012⟩, ⟨5778363, 15731162⟩, ⟨(-11154), 1135048⟩, ⟨(-13063), 96708⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4401055200, 4523913993⟩, ⟨33217591, 69427121⟩, ⟨2210227, 7550624⟩, ⟨(-124556), 537162⟩, ⟨(-21327), 48600⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3138612515, 3550650448⟩, ⟨(-138521468), (-103314591)⟩, ⟨(-913174), 4735144⟩, ⟨(-368498), 342349⟩, ⟨(-36000), 42612⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8008166183, 10677554922⟩, ⟨1334694363, 1334694373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14931598122, 26545063386⟩, ⟨4977199370, 6636265886⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14931598122, 26545063386⟩, ⟨4977199370, 6636265886⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-26545063386), (-14931598122)⟩, ⟨(-6636265886), (-4977199370)⟩, ⟨(-414766621), (-414766614)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13272531693), (-7465799061)⟩, ⟨(-3318132943), (-2488599685)⟩, ⟨(-207383311), (-207383307)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨195380142, 755162098⟩, ⟨(-583410318), (-113207604)⟩, ⟨(-3665643), 215926655⟩, ⟨(-51961484), 19724033⟩, ⟨(-9022545), 10124379⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨142777003, 624292680⟩, ⟨(-506660965), (-87428004)⟩, ⟨(-467761), 198155348⟩, ⟨(-50628642), 16608324⟩, ⟨(-8193826), 10341297⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1078009947, 1078009948⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4453754677, 4453754682⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2340
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨924008526, 1232011369⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4401055200, 4523913993⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2341
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (12070365 / 2147483648)

theorem envelope_integral : (∫ s in ((17211 / 80000) : ℝ)..(5737 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((17211 / 80000) : ℝ)..(5737 / 20000), prawitzNormalCorrection
