...
namespace FiniteNormalPanel95_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (88377 / 800000)
def radius : Rat := (29459 / 800000)

def j0 : Jet := ⟨⟨474470405, 474470406⟩, ⟨158156801, 158156802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1490592738, 1490592742⟩, ⟨496864244, 496864248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨517318656, 517318660⟩, ⟨344879102, 344879108⟩, ⟨57479850, 57479852⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-11390), (-11389)⟩, ⟨(-7583), (-7581)⟩, ⟨(-1259), (-1256)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101666, 5101668⟩, ⟨(-7583), (-7581)⟩, ⟨(-1259), (-1256)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨614483, 614484⟩, ⟨408741, 408743⟩, ⟨67514, 67517⟩, ⟨(-204), (-200)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-142551094), (-142551092)⟩, ⟨408741, 408743⟩, ⟨67514, 67517⟩, ⟨(-204), (-200)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17169943), (-17169941)⟩, ⟨(-11397398), (-11397394)⟩, ⟨(-1866820), (-1866816)⟩, ⟨10866, 10869⟩, ⟨883, 887⟩⟩
...
def j19 : Jet := ⟨⟨1414485822, 1414485825⟩, ⟨(-11397398), (-11397394)⟩, ⟨(-1866820), (-1866816)⟩, ⟨10866, 10869⟩, ⟨883, 887⟩⟩
...
def j25 : Jet := ⟨⟨1423, 1425⟩, ⟨947, 950⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850754), (-850751)⟩, ⟨947, 950⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-102472), (-102470)⟩, ⟨(-68201), (-68198)⟩, ⟨(-11292), (-11288)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35688922, 35688925⟩, ⟨(-68201), (-68198)⟩, ⟨(-11292), (-11288)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4298646, 4298647⟩, ⟨2857549, 2857551⟩, ⟨470789, 470793⟩, ⟨(-1818), (-1814)⟩, ⟨(-151), (-147)⟩⟩
...
def j33 : Jet := ⟨⟨(-711529237), (-711529235)⟩, ⟨2857549, 2857551⟩, ⟨470789, 470793⟩, ⟨(-1818), (-1814)⟩, ⟨(-151), (-147)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-85702015), (-85702014)⟩, ⟨(-56790492), (-56790489)⟩, ⟨(-9236286), (-9236282)⟩, ⟨75826, 75829⟩, ⟨6135, 6139⟩⟩
...
def j36 : Jet := ⟨⟨4209265281, 4209265282⟩, ⟨(-56790492), (-56790489)⟩, ⟨(-9236286), (-9236282)⟩, ⟨75826, 75829⟩, ⟨6135, 6139⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨490905319, 490905323⟩, ⟨159679573, 159679578⟩, ⟨(-1966402), (-1966399)⟩, ⟨(-212193), (-212190)⟩, ⟨1563, 1566⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4382414230, 4382414232⟩, ⟨59126575, 59126581⟩, ⟨10413940, 10413947⟩, ⟨191294, 191301⟩, ⟨17974, 17983⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨500900311, 500900316⟩, ⟨169688738, 169688746⟩, ⟨1382076, 1382083⟩, ⟨165451, 165459⟩, ⟨3069, 3079⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-474470406), (-474470405)⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3820496890, 3820496891⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨58417469, 58417471⟩, ⟨39579878, 39579882⟩, ⟨7026555, 7026561⟩, ⟨147798, 147804⟩, ⟨14230, 14241⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4353384765, 4353384767⟩, ⟨39579878, 39579882⟩, ⟨7026555, 7026561⟩, ⟨147798, 147804⟩, ⟨14230, 14241⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4324077380, 4324077382⟩, ⟨19656711, 19656714⟩, ⟨3444947, 3444951⟩, ⟨57740, 57745⟩, ⟨5431, 5439⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3846391146, 3846391150⟩, ⟨(-141743536), (-141743530)⟩, ⟨2340545, 2340550⟩, ⟨(-75496), (-75489)⟩, ⟨2704, 2713⟩⟩
...
def j47 : Jet := ⟨⟨4309334414, 4309334425⟩, ⟨1436444798, 1436444809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4323749591, 4323749614⟩, ⟨2882499714, 2882499744⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4323749591, 4323749614⟩, ⟨2882499714, 2882499744⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4323749614), (-4323749591)⟩, ⟨(-2882499744), (-2882499714)⟩, ⟨(-480416625), (-480416616)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2161874807), (-2161874795)⟩, ⟨(-1441249872), (-1441249857)⟩, ⟨(-240208313), (-240208308)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2596315270, 2596315288⟩, ⟨(-871238084), (-871238068)⟩, ⟨973081, 973091⟩, ⟨32375471, 32375475⟩, ⟨(-2743248), (-2743246)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2325150199, 2325150219⟩, ⟨(-865928216), (-865928195)⟩, ⟨31039118, 31039135⟩, ⟨28441567, 28441580⟩, ⟨(-3507724), (-3507710)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨316313603, 632627208⟩, ⟨158156801, 158156802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨993728491, 1987456990⟩, ⟨496864244, 496864248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨229919402, 919677617⟩, ⟨229919400, 459838810⟩, ⟨57479850, 57479852⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-20264), (-5056)⟩, ⟨(-10129), (-5031)⟩, ⟨(-1264), (-1247)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092792, 5108001⟩, ⟨(-10129), (-5031)⟩, ⟨(-1264), (-1247)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨272628, 1093772⟩, ⟨270459, 546617⟩, ⟨66801, 68026⟩, ⟨(-272), (-132)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142892949), (-142071804)⟩, ⟨270459, 546617⟩, ⟨66801, 68026⟩, ⟨(-272), (-132)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-30597544), (-7605427)⟩, ⟨(-15284294), (-7488380)⟩, ⟨(-1894293), (-1828265)⟩, ⟨7136, 14593⟩, ⟨860, 904⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1401058221, 1424050339⟩, ⟨(-15284294), (-7488380)⟩, ⟨(-1894293), (-1828265)⟩, ⟨7136, 14593⟩, ⟨860, 904⟩⟩
...
def j72 : Jet := ⟨⟨632, 2534⟩, ⟨629, 1267⟩, ⟨155, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851545), (-849642)⟩, ⟨629, 1267⟩, ⟨155, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-182341), (-45483)⟩, ⟨(-91138), (-45211)⟩, ⟨(-11356), (-11199)⟩, ⟨15, 35⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35609053, 35745912⟩, ⟨(-91138), (-45211)⟩, ⟨(-11356), (-11199)⟩, ⟨15, 35⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1906233, 7654242⟩, ⟨1886717, 3824701⟩, ⟨464368, 475372⟩, ⟨(-2436), (-1196)⟩, ⟨(-152), (-144)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713921650), (-708173640)⟩, ⟨1886717, 3824701⟩, ⟨464368, 475372⟩, ⟨(-2436), (-1196)⟩, ⟨(-152), (-144)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-152871423), (-37910151)⟩, ⟨(-76334712), (-37091170)⟩, ⟨(-9428607), (-8966256)⟩, ⟨49586, 102019⟩, ⟨5920, 6291⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4142095873, 4257057145⟩, ⟨(-76334712), (-37091170)⟩, ⟨(-9428607), (-8966256)⟩, ⟨49586, 102019⟩, ⟨5920, 6291⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨324163462, 658966322⟩, ⟨155009062, 163008992⟩, ⟨(-2644734), (-1289300)⟩, ⟨(-217491), (-204750)⟩, ⟨1023, 2108⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4333215046, 4453480712⟩, ⟨37754723, 82073226⟩, ⟨9455611, 11649939⟩, ⟨55177, 349648⟩, ⟨11845, 26320⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨327050218, 683286648⟩, ⟨159239000, 181617425⟩, ⟨(-666079), 3601607⟩, ⟨69368, 277896⟩, ⟨(-7414), 14859⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-632627208), (-316313603)⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3662340088, 3978653693⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨24903995, 108704121⟩, ⟨24251242, 57787058⟩, ⟨5691966, 8825853⟩, ⟨(-45768), 393018⟩, ⟨2223, 31253⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4319871291, 4403671417⟩, ⟨24251242, 57787058⟩, ⟨5691966, 8825853⟩, ⟨(-45768), 393018⟩, ⟨2223, 31253⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307401295, 4348979734⟩, ⟨11975026, 28810124⟩, ⟨2715209, 4383543⟩, ⟨(-52139), 188394⟩, ⟨(-2383), 15075⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3672942621, 4028688250⟩, ⟨(-149934579), (-131926336)⟩, ⟨1254375, 3619742⟩, ⟨(-209719), 74536⟩, ⟨(-9146), 15885⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2872889606, 5745779233⟩, ⟨1436444798, 1436444809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1921666480, 7686665979⟩, ⟨1921666472, 3843332992⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1921666480, 7686665979⟩, ⟨1921666472, 3843332992⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7686665979), (-1921666480)⟩, ⟨(-3843332992), (-1921666472)⟩, ⟨(-480416625), (-480416616)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3843332990), (-960833240)⟩, ⟨(-1921666496), (-960833236)⟩, ⟨(-240208313), (-240208308)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1755227092, 3434023204⟩, ⟨(-1536460440), (-392664346)⟩, ⟨(-148135807), 245557667⟩, ⟨(-21982121), 79380408⟩, ⟨(-15745910), 6601286⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1501023861, 3221120903⟩, ⟨(-1561082654), (-389710601)⟩, ⟨(-126377798), 286864610⟩, ⟨(-30654128), 79575230⟩, ⟨(-17699642), 7254080⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨474470405, 474470406⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4324077380, 4324077382⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1918
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨316313603, 632627208⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307401295, 4348979734⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1919
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (172110335 / 4294967296)

theorem envelope_integral : (∫ s in ((29459 / 400000) : ℝ)..(29459 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (29459 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (29459 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((29459 / 400000) : ℝ)..(29459 / 200000), prawitzNormalCorrection
