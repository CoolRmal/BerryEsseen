...
namespace FiniteNormalPanel54_17
...
def j2 : Jet := ⟨⟨1667739457, 1667739462⟩, ⟨555913151, 555913155⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨647584650, 647584655⟩, ⟨431723098, 431723104⟩, ⟨71953849, 71953851⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-14253), (-14251)⟩, ⟨(-9486), (-9484)⟩, ⟨(-1572), (-1569)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098803, 5098806⟩, ⟨(-9486), (-9484)⟩, ⟨(-1572), (-1569)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨768785, 768786⟩, ⟨511092, 511095⟩, ⟨84228, 84232⟩, ⟨(-318), (-314)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-142396792), (-142396790)⟩, ⟨511092, 511095⟩, ⟨84228, 84232⟩, ⟨(-318), (-314)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-21470240), (-21470239)⟩, ⟨(-14236433), (-14236430)⟩, ⟨(-2321510), (-2321506)⟩, ⟨16980, 16983⟩, ⟨1374, 1378⟩⟩
...
def j19 : Jet := ⟨⟨1410185525, 1410185527⟩, ⟨(-14236433), (-14236430)⟩, ⟨(-2321510), (-2321506)⟩, ⟨16980, 16983⟩, ⟨1374, 1378⟩⟩
...
def j25 : Jet := ⟨⟨1781, 1783⟩, ⟨1185, 1188⟩, ⟨194, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850396), (-850393)⟩, ⟨1185, 1188⟩, ⟨194, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-128221), (-128220)⟩, ⟨(-85303), (-85300)⟩, ⟨(-14099), (-14096)⟩, ⟨37, 40⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35663173, 35663175⟩, ⟨(-85303), (-85300)⟩, ⟨(-14099), (-14096)⟩, ⟨37, 40⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5377205, 5377207⟩, ⟨3571941, 3571944⟩, ⟨586766, 586769⟩, ⟨(-2843), (-2838)⟩, ⟨(-234), (-230)⟩⟩
...
def j33 : Jet := ⟨⟨(-710450678), (-710450675)⟩, ⟨3571941, 3571944⟩, ⟨586766, 586769⟩, ⟨(-2843), (-2838)⟩, ⟨(-234), (-230)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-107120015), (-107120012)⟩, ⟨(-70874775), (-70874772)⟩, ⟨(-11454708), (-11454705)⟩, ⟨118391, 118396⟩, ⟨9508, 9512⟩⟩
...
def j36 : Jet := ⟨⟨4187847281, 4187847284⟩, ⟨(-70874775), (-70874772)⟩, ⟨(-11454708), (-11454705)⟩, ⟨118391, 118396⟩, ⟨9508, 9512⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨547576239, 547576243⟩, ⟨176997392, 176997398⟩, ⟨(-2744119), (-2744114)⟩, ⟨(-293889), (-293885)⟩, ⟨2730, 2735⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4404827306, 4404827311⟩, ⟨74546922, 74546928⟩, ⟨13309818, 13309824⟩, ⟨304625, 304634⟩, ⟨29446, 29456⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨561582569, 561582575⟩, ⟨191028943, 191028953⟩, ⟨1954700, 1954710⟩, ⟨238303, 238312⟩, ⟨5501, 5513⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-530857958), (-530857957)⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3764109338, 3764109339⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨73428960, 73428962⟩, ⟨49955454, 49955460⟩, ⟨9007637, 9007643⟩, ⟨236194, 236204⟩, ⟨23525, 23532⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4368396256, 4368396258⟩, ⟨49955454, 49955460⟩, ⟨9007637, 9007643⟩, ⟨236194, 236204⟩, ⟨23525, 23532⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4331526180, 4331526182⟩, ⟨24766910, 24766914⟩, ⟨4394998, 4395003⟩, ⟨91970, 91977⟩, ⟨8906, 8912⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3796149543, 3796149547⟩, ⟨(-156753161), (-156753154)⟩, ⟨2831379, 2831385⟩, ⟨(-100473), (-100464)⟩, ⟨4015, 4022⟩⟩
...
def j47 : Jet := ⟨⟨3791349441, 3791349450⟩, ⟨1263783144, 1263783153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3346784641, 3346784658⟩, ⟨2231189754, 2231189778⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3346784641, 3346784658⟩, ⟨2231189754, 2231189778⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3346784658), (-3346784641)⟩, ⟨(-2231189778), (-2231189754)⟩, ⟨(-371864964), (-371864958)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1673392329), (-1673392320)⟩, ⟨(-1115594889), (-1115594877)⟩, ⟨(-185932482), (-185932479)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2909051045, 2909051057⟩, ⟨(-755610525), (-755610513)⟩, ⟨(-27802186), (-27802179)⟩, ⟨24214467, 24214470⟩, ⟨(-970607), (-970605)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2571193686, 2571193700⟩, ⟨(-774025337), (-774025317)⟩, ⟨4921968, 4921984⟩, ⟨21850715, 21850729⟩, ⟨(-1739572), (-1739557)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨353905305, 707810611⟩, ⟨176952652, 176952653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1111826306, 2223652616⟩, ⟨555913151, 555913155⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨287815401, 1151261609⟩, ⟨287815398, 575630806⟩, ⟨71953849, 71953851⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-25362), (-6325)⟩, ⟨(-12677), (-6286)⟩, ⟨(-1581), (-1555)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5087694, 5106732⟩, ⟨(-12677), (-6286)⟩, ⟨(-1581), (-1555)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨340937, 1368855⟩, ⟨337538, 684007⟩, ⟨83110, 85029⟩, ⟨(-425), (-207)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142824640), (-141796721)⟩, ⟨337538, 684007⟩, ⟨83110, 85029⟩, ⟨(-425), (-207)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-38284000), (-9502116)⟩, ⟨(-19119381), (-9318768)⟩, ⟨(-2364562), (-2261063)⟩, ⟨11109, 22843⟩, ⟨1327, 1411⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1393371765, 1422153650⟩, ⟨(-19119381), (-9318768)⟩, ⟨(-2364562), (-2261063)⟩, ⟨11109, 22843⟩, ⟨1327, 1411⟩⟩
...
def j72 : Jet := ⟨⟨791, 3171⟩, ⟨786, 1586⟩, ⟨193, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851386), (-849005)⟩, ⟨786, 1586⟩, ⟨193, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-228214), (-56893)⟩, ⟨(-114055), (-56467)⟩, ⟨(-14200), (-13956)⟩, ⟨24, 54⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35563180, 35734502⟩, ⟨(-114055), (-56467)⟩, ⟨(-14200), (-13956)⟩, ⟨24, 54⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2383168, 9578597⟩, ⟨2352595, 4785516⟩, ⟨576698, 593945⟩, ⟨(-3814), (-1865)⟩, ⟨(-237), (-223)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713444715), (-706249285)⟩, ⟨2352595, 4785516⟩, ⟨576698, 593945⟩, ⟨(-3814), (-1865)⟩, ⟨(-237), (-223)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-191238130), (-47327350)⟩, ⟨(-95461413), (-46044596)⟩, ⟨(-11756087), (-11031253)⟩, ⟨77035, 159653⟩, ⟨9085, 9813⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4103729166, 4247639946⟩, ⟨(-95461413), (-46044596)⟩, ⟨(-11756087), (-11031253)⟩, ⟨77035, 159653⟩, ⟨9085, 9813⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨360698295, 736297967⟩, ⟨170450384, 181662169⟩, ⟨(-3698907), (-1791476)⟩, ⟨(-303179), (-280830)⟩, ⟨1780, 3688⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4342821968, 4495117326⟩, ⟨47076372, 104565930⟩, ⟨11788752, 15309736⟩, ⟨81093, 574169⟩, ⟨17178, 46719⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨364717207, 770610233⟩, ⟨176303096, 208053842⟩, ⟨(-1012966), 5235929⟩, ⟨67296, 442386⟩, ⟨(-14109), 28161⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-707810611), (-353905305)⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3587156685, 3941061991⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨30970815, 138264180⟩, ⟨29942380, 74658740⟩, ⟨6873526, 11957281⟩, ⟨(-86712), 666020⟩, ⟨(-775), 59350⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4325938111, 4433231476⟩, ⟨29942380, 74658740⟩, ⟨6873526, 11957281⟩, ⟨(-86712), 666020⟩, ⟨(-775), 59350⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310424887, 4363551788⟩, ⟨14735879, 37195504⟩, ⟨3224215, 5932013⟩, ⟨(-94390), 320794⟩, ⟨(-7238), 29178⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3600066865, 4003995121⟩, ⟨(-167470929), (-143458909)⟩, ⟨1160409, 4836098⟩, ⟨(-331012), 161524⟩, ⟨(-19859), 30663⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2527566296, 5055132602⟩, ⟨1263783144, 1263783153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1487459843, 5949839397⟩, ⟨1487459838, 2974919706⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1487459843, 5949839397⟩, ⟨1487459838, 2974919706⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5949839397), (-1487459843)⟩, ⟨(-2974919706), (-1487459838)⟩, ⟨(-371864964), (-371864958)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2974919699), (-743729921)⟩, ⟨(-1487459853), (-743729919)⟩, ⟨(-185932482), (-185932479)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2148546292, 3612069314⟩, ⟨(-1250954367), (-372048970)⟩, ⟨(-124156718), 123606917⟩, ⟨(-3531914), 50436103⟩, ⟨(-7042357), 2993220⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1800924146, 3367361592⟩, ⟨(-1307048786), (-383618584)⟩, ⟨(-102737911), 168077720⟩, ⟨(-9799310), 51895684⟩, ⟨(-8735428), 3189536⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4331526180, 4331526182⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1076
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310424887, 4363551788⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1077
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (212054115 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((103 / 1250) : ℝ)..(103 / 625), prawitzNormalCorrection
