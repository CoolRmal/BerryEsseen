...
namespace FiniteNormalPanel109_18
...
def j2 : Jet := ⟨⟨1554499138, 1554499143⟩, ⟨518166378, 518166382⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨562627699, 562627704⟩, ⟨375085132, 375085138⟩, ⟨62514188, 62514190⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨140, 141⟩, ⟨93, 94⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94547), (-94545)⟩, ⟨93, 94⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12386), (-12385)⟩, ⟨(-8245), (-8243)⟩, ⟨(-1368), (-1364)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100670, 5100672⟩, ⟨(-8245), (-8243)⟩, ⟨(-1368), (-1364)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨668172, 668173⟩, ⟨444367, 444370⟩, ⟨73340, 73345⟩, ⟨(-241), (-237)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-142497405), (-142497403)⟩, ⟨444367, 444370⟩, ⟨73340, 73345⟩, ⟨(-241), (-237)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18666729), (-18666727)⟩, ⟨(-12386276), (-12386273)⟩, ⟨(-2025667), (-2025664)⟩, ⟨12839, 12843⟩, ⟨1042, 1046⟩⟩
...
def j19 : Jet := ⟨⟨1412989036, 1412989039⟩, ⟨(-12386276), (-12386273)⟩, ⟨(-2025667), (-2025664)⟩, ⟨12839, 12843⟩, ⟨1042, 1046⟩⟩
...
def j25 : Jet := ⟨⟨1548, 1549⟩, ⟨1030, 1032⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850629), (-850627)⟩, ⟨1030, 1032⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-111430), (-111429)⟩, ⟨(-74153), (-74150)⟩, ⟨(-12271), (-12267)⟩, ⟨27, 32⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35679964, 35679966⟩, ⟨(-74153), (-74150)⟩, ⟨(-12271), (-12267)⟩, ⟨27, 32⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4673967, 4673968⟩, ⟨3106264, 3106266⟩, ⟨511245, 511249⟩, ⟨(-2149), (-2145)⟩, ⟨(-177), (-174)⟩⟩
...
def j33 : Jet := ⟨⟨(-711153916), (-711153914)⟩, ⟨3106264, 3106266⟩, ⟨511245, 511249⟩, ⟨(-2149), (-2145)⟩, ⟨(-177), (-174)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-93159009), (-93159007)⟩, ⟨(-61699096), (-61699092)⟩, ⟨(-10012757), (-10012752)⟩, ⟨89577, 89582⟩, ⟨7229, 7233⟩⟩
...
def j36 : Jet := ⟨⟨4201808287, 4201808289⟩, ⟨(-61699096), (-61699092)⟩, ⟨(-10012757), (-10012752)⟩, ⟨89577, 89582⟩, ⟨7229, 7233⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨511410236, 511410239⟩, ⟨165987050, 165987054⟩, ⟨(-2227503), (-2227500)⟩, ⟨(-239741), (-239737)⟩, ⟨1925, 1929⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4390191747, 4390191750⟩, ⟨64465302, 64465309⟩, ⟨11408266, 11408274⟩, ⟨227536, 227545⟩, ⟨21592, 21601⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨522748799, 522748803⟩, ⟨177343187, 177343194⟩, ⟨1572896, 1572903⟩, ⟨189495, 189505⟩, ⟨3815, 3825⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-494812445), (-494812444)⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3800154851, 3800154852⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨63624770, 63624772⟩, ⟨43169566, 43169570⟩, ⟨7705544, 7705550⟩, ⟨176018, 176026⟩, ⟨17152, 17159⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4358592066, 4358592068⟩, ⟨43169566, 43169570⟩, ⟨7705544, 7705550⟩, ⟨176018, 176026⟩, ⟨17152, 17159⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4326662730, 4326662732⟩, ⟨21426661, 21426664⟩, ⟨3771493, 3771497⟩, ⟨68686, 68692⟩, ⟨6528, 6534⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3828198733, 3828198737⟩, ⟨(-147196518), (-147196512)⟩, ⟨2514150, 2514156⟩, ⟨(-84063), (-84055)⟩, ⟨3137, 3145⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨32181555981, 32181555987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value480

def j47 : Jet := ⟨⟨3707556605, 3707556614⟩, ⟨1235852199, 1235852207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3200484434, 3200484451⟩, ⟨2133656284, 2133656306⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3200484434, 3200484451⟩, ⟨2133656284, 2133656306⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3200484451), (-3200484434)⟩, ⟨(-2133656306), (-2133656284)⟩, ⟨(-355609385), (-355609380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1600242226), (-1600242217)⟩, ⟨(-1066828153), (-1066828142)⟩, ⟨(-177804693), (-177804690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2959021125, 2959021136⟩, ⟨(-734992105), (-734992094)⟩, ⟨(-31216238), (-31216232)⟩, ⟨22869590, 22869593⟩, ⟨(-773996), (-773994)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2637440553, 2637440566⟩, ⟨(-756525775), (-756525757)⟩, ⟨(-902049), (-902036)⟩, ⟨20965845, 20965858⟩, ⟨(-1475393), (-1475380)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨329874963, 659749927⟩, ⟨164937481, 164937482⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1036332760, 2072665524⟩, ⟨518166378, 518166382⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨250056756, 1000227029⟩, ⟨250056754, 500113516⟩, ⟨62514188, 62514190⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨62, 251⟩, ⟨62, 126⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94625), (-94435)⟩, ⟨62, 126⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-22037), (-5498)⟩, ⟨(-11016), (-5468)⟩, ⟨(-1375), (-1355)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5091019, 5107559⟩, ⟨(-11016), (-5468)⟩, ⟨(-1375), (-1355)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨296403, 1189467⟩, ⟨293837, 594416⟩, ⟨72496, 73946⟩, ⟨(-322), (-156)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142869174), (-141976109)⟩, ⟨293837, 594416⟩, ⟨72496, 73946⟩, ⟨(-322), (-156)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-33271874), (-8265973)⟩, ⟨(-16618830), (-8127543)⟩, ⟨(-2058166), (-1980057)⟩, ⟨8421, 17254⟩, ⟨1012, 1068⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1398383891, 1423389793⟩, ⟨(-16618830), (-8127543)⟩, ⟨(-2058166), (-1980057)⟩, ⟨8421, 17254⟩, ⟨1012, 1068⟩⟩
...
def j72 : Jet := ⟨⟨687, 2756⟩, ⟨683, 1378⟩, ⟨168, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851490), (-849420)⟩, ⟨683, 1378⟩, ⟨168, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-198298), (-49453)⟩, ⟨(-99110), (-49132)⟩, ⟨(-12346), (-12161)⟩, ⟨17, 42⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35593096, 35741942⟩, ⟨(-99110), (-49132)⟩, ⟨(-12346), (-12161)⟩, ⟨17, 42⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2072261, 8323709⟩, ⟨2049179, 4158995⟩, ⟨503648, 516664⟩, ⟨(-2881), (-1413)⟩, ⟨(-180), (-171)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713755622), (-707504173)⟩, ⟨2049179, 4158995⟩, ⟨503648, 516664⟩, ⟨(-2881), (-1413)⟩, ⟨(-180), (-171)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-166221910), (-41191512)⟩, ⟨(-82991652), (-40222950)⟩, ⟨(-10240244), (-9693273)⟩, ⟨58477, 120616⟩, ⟨6952, 7430⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4128745386, 4253775784⟩, ⟨(-82991652), (-40222950)⟩, ⟨(-10240244), (-9693273)⟩, ⟨58477, 120616⟩, ⟨6952, 7430⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨337416081, 686899515⟩, ⟨160688124, 169763784⟩, ⟨(-2998209), (-1458315)⟩, ⟨(-246277), (-230556)⟩, ⟨1259, 2598⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4336557686, 4467881245⟩, ⟨41005720, 89808602⟩, ⟨10269653, 12886618⟩, ⟨63861, 420361⟩, ⟨13652, 32530⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨340683455, 714553861⟩, ⟨165465592, 190961621⟩, ⟨(-777973), 4138332⟩, ⟨70348, 329878⟩, ⟨(-9414), 18835⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-659749927), (-329874963)⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3635217369, 3965092333⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨27023539, 118880352⟩, ⟨26249972, 63540584⟩, ⟨6115774, 9867472⟩, ⟨(-58022), 477760⟩, ⟨1536, 39590⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4321990835, 4413847648⟩, ⟨26249972, 63540584⟩, ⟨6115774, 9867472⟩, ⟨(-58022), 477760⟩, ⟨1536, 39590⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308457878, 4354001757⟩, ⟨12947028, 31670814⟩, ⟨2901239, 4898835⟩, ⟨(-64932), 229415⟩, ⟨(-3707), 19235⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3646635662, 4019592653⟩, ⟨(-156246318), (-136217215)⟩, ⟨1239340, 4025382⟩, ⟨(-248073), 100381⟩, ⟨(-12234), 20252⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2471704405, 4943408821⟩, ⟨1235852199, 1235852207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1422437528, 5689750140⟩, ⟨1422437524, 2844875074⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1422437528, 5689750140⟩, ⟨1422437524, 2844875074⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5689750140), (-1422437528)⟩, ⟨(-2844875074), (-1422437524)⟩, ⟨(-355609385), (-355609380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2844875070), (-711218764)⟩, ⟨(-1422437537), (-711218762)⟩, ⟨(-177804693), (-177804690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2214595669, 3639514955⟩, ⟨(-1205360212), (-366722696)⟩, ⟨(-120306577), 107919172⟩, ⟨(-1792661), 46547968⟩, ⟨(-6087861), 2638676⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1880299193, 3406165069⟩, ⟨(-1260479416), (-381602466)⟩, ⟨(-100323198), 148260651⟩, ⟨(-6943627), 47919382⟩, ⟨(-7542195), 2722641⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4326662730, 4326662732⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar480 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2204
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar480 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308457878, 4354001757⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2205
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((15361 / 200000) : ℝ)..(15361 / 100000), prawitzNormalCorrection
      ((112959 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
