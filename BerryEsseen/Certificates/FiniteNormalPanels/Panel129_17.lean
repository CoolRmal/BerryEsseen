...
namespace FiniteNormalPanel129_17

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (223027 / 800000)
def radius : Rat := (31861 / 800000)

def j0 : Jet := ⟨⟨1197367088, 1197367089⟩, ⟨171052441, 171052442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3761639647, 3761639651⟩, ⟨537377092, 537377096⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3294537969, 3294537977⟩, ⟨941296560, 941296570⟩, ⟨67235468, 67235470⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨824, 826⟩, ⟨235, 236⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93863), (-93860)⟩, ⟨235, 236⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-72000), (-71997)⟩, ⟨(-20392), (-20388)⟩, ⟨(-1407), (-1403)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5041056, 5041060⟩, ⟨(-20392), (-20388)⟩, ⟨(-1407), (-1403)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3866839, 3866843⟩, ⟨1089168, 1089174⟩, ⟨73365, 73372⟩, ⟨(-625), (-619)⟩, ⟨(-22), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-139298738), (-139298733)⟩, ⟨1089168, 1089174⟩, ⟨73365, 73372⟩, ⟨(-625), (-619)⟩, ⟨(-22), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-106851800), (-106851794)⟩, ⟨(-29693619), (-29693611)⟩, ⟨(-1885669), (-1885659)⟩, ⟨32648, 32658⟩, ⟨994, 1001⟩⟩
...
def j19 : Jet := ⟨⟨1324803965, 1324803972⟩, ⟨(-29693619), (-29693611)⟩, ⟨(-1885669), (-1885659)⟩, ⟨32648, 32658⟩, ⟨994, 1001⟩⟩
...
def j22 : Jet := ⟨⟨(-83), (-82)⟩, ⟨(-24), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11752, 11754⟩, ⟨(-24), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9014, 9017⟩, ⟨2556, 2560⟩, ⟨175, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843163), (-843159)⟩, ⟨2556, 2560⟩, ⟨175, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-646765), (-646761)⟩, ⟨(-182830), (-182824)⟩, ⟨(-12506), (-12498)⟩, ⟨76, 81⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35144629, 35144634⟩, ⟨(-182830), (-182824)⟩, ⟨(-12506), (-12498)⟩, ⟨76, 81⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨26958369, 26958374⟩, ⟨7562147, 7562155⟩, ⟨500507, 500517⟩, ⟨(-5546), (-5538)⟩, ⟨(-180), (-174)⟩⟩
...
def j33 : Jet := ⟨⟨(-688869514), (-688869508)⟩, ⟨7562147, 7562155⟩, ⟨500507, 500517⟩, ⟨(-5546), (-5538)⟩, ⟨(-180), (-174)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-528410724), (-528410717)⟩, ⟨(-145173803), (-145173792)⟩, ⟨(-8742630), (-8742617)⟩, ⟨223818, 223829⟩, ⟨6480, 6490⟩⟩
...
def j36 : Jet := ⟨⟨3766556572, 3766556579⟩, ⟨(-145173803), (-145173792)⟩, ⟨(-8742630), (-8742617)⟩, ⟨223818, 223829⟩, ⟨6480, 6490⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1160296406, 1160296414⟩, ⟨139750215, 139750226⟩, ⟨(-5366719), (-5366707)⟩, ⟨(-207338), (-207326)⟩, ⟨4954, 4964⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4897508821, 4897508831⟩, ⟨188763904, 188763921⟩, ⟨18643184, 18643206⟩, ⟨865666, 865686⟩, ⟨56980, 56999⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1323074540, 1323074553⟩, ⟨210350841, 210350861⟩, ⟨5058910, 5058933⟩, ⟨368181, 368207⟩, ⟨16799, 16822⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1197367089), (-1197367088)⟩, ⟨(-171052442), (-171052441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3097600207, 3097600208⟩, ⟨(-171052442), (-171052441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨407576150, 407576159⟩, ⟨129598118, 129598134⟩, ⟨13418984, 13419003⟩, ⟨722368, 722390⟩, ⟨52370, 52393⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4702543446, 4702543455⟩, ⟨129598118, 129598134⟩, ⟨13418984, 13419003⟩, ⟨722368, 722390⟩, ⟨52370, 52393⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4494137326, 4494137331⟩, ⟨61927310, 61927319⟩, ⟨5985476, 5985486⟩, ⟨262698, 262711⟩, ⟨17418, 17431⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3241244869, 3241244874⟩, ⟨(-134321656), (-134321647)⟩, ⟨1850489, 1850498⟩, ⟨(-48918), (-48907)⟩, ⟨2099, 2110⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨29830461417, 29830461424⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value544

def j47 : Jet := ⟨⟨8316247891, 8316247901⟩, ⟨1188035412, 1188035420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16102562422, 16102562461⟩, ⟨4600732116, 4600732154⟩, ⟨328623722, 328623727⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16102562422, 16102562461⟩, ⟨4600732116, 4600732154⟩, ⟨328623722, 328623727⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16102562461), (-16102562422)⟩, ⟨(-4600732154), (-4600732116)⟩, ⟨(-328623727), (-328623722)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8051281231), (-8051281211)⟩, ⟨(-2300366077), (-2300366058)⟩, ⟨(-164311864), (-164311861)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨658927968, 658927978⟩, ⟨(-352919002), (-352918992)⟩, ⟨69302448, 69302454⟩, ⟨(-3371657), (-3371654)⟩, ⟨(-874186), (-874184)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨497267324, 497267333⟩, ⟨(-286941697), (-286941686)⟩, ⟨63621019, 63621029⟩, ⟨(-4871400), (-4871392)⟩, ⟨(-520072), (-520062)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1026314647, 1368419531⟩, ⟨171052441, 171052442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3224262555, 4299016746⟩, ⟨537377092, 537377096⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2420476876, 4303070014⟩, ⟨806825624, 1075767510⟩, ⟨67235468, 67235470⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨605, 1079⟩, ⟨201, 270⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94082), (-93607)⟩, ⟨201, 270⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-94260), (-52753)⟩, ⟨(-23452), (-17313)⟩, ⟨(-1427), (-1379)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5018796, 5060304⟩, ⟨(-23452), (-17313)⟩, ⟨(-1427), (-1379)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2828398, 5069851⟩, ⟨919302, 1257707⟩, ⟨71261, 75188⟩, ⟨(-723), (-519)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140337179), (-138095725)⟩, ⟨919302, 1257707⟩, ⟨71261, 75188⟩, ⟨(-723), (-519)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-140601934), (-77825390)⟩, ⟨(-34632402), (-24681716)⟩, ⟨(-1984053), (-1771466)⟩, ⟨27052, 38230⟩, ⟨910, 1072⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1291053831, 1353830376⟩, ⟨(-34632402), (-24681716)⟩, ⟨(-1984053), (-1771466)⟩, ⟨27052, 38230⟩, ⟨910, 1072⟩⟩
...
def j72 : Jet := ⟨⟨6608, 11799⟩, ⟨2173, 2939⟩, ⟨172, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845569), (-840377)⟩, ⟨2173, 2939⟩, ⟨172, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-847165), (-473603)⟩, ⟨(-210568), (-154922)⟩, ⟨(-12733), (-12235)⟩, ⟨63, 93⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34944229, 35317792⟩, ⟨(-210568), (-154922)⟩, ⟨(-12733), (-12235)⟩, ⟨63, 93⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19693211, 35384422⟩, ⟨6353437, 8758798⟩, ⟨481533, 516885⟩, ⟨(-6452), (-4629)⟩, ⟨(-191), (-163)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696134672), (-680443460)⟩, ⟨6353437, 8758798⟩, ⟨481533, 516885⟩, ⟨(-6452), (-4629)⟩, ⟨(-191), (-163)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-697447973), (-383471525)⟩, ⟨(-170781445), (-119048518)⟩, ⟨(-9432736), (-7940294)⟩, ⟨183451, 263973⟩, ⟨5729, 7132⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3597519323, 3911495771⟩, ⟨(-170781445), (-119048518)⟩, ⟨(-9432736), (-7940294)⟩, ⟨183451, 263973⟩, ⟨5729, 7132⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨969203310, 1355106817⟩, ⟨126868830, 150859613⟩, ⟨(-6319056), (-4417975)⟩, ⟨(-227933), (-183375)⟩, ⟨4067, 5858⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4716033239, 5127628907⟩, ⟨143535056, 243418811⟩, ⟨13942064, 25000280⟩, ⟨369661, 1584574⟩, ⟨13774, 125948⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1064221147, 1617820209⟩, ⟨171696829, 256907802⟩, ⟨(-158082), 11586772⟩, ⟨(-135008), 1029082⟩, ⟨(-31210), 81921⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1368419531), (-1026314647)⟩, ⟨(-171052442), (-171052441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2926547765, 3268652649⟩, ⟨(-171052442), (-171052441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨263696222, 609397476⟩, ⟨85087210, 193543098⟩, ⟨6744707, 24096168⟩, ⟨(-120622), 2161416⟩, ⟨(-40093), 216087⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4558663518, 4904364772⟩, ⟨85087210, 193543098⟩, ⟨6744707, 24096168⟩, ⟨(-120622), 2161416⟩, ⟨(-40093), 216087⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4424851491, 4589562758⟩, ⟨39812810, 93930981⟩, ⟨2194682, 11515324⟩, ⟨(-302990), 1029240⟩, ⟨(-56292), 110761⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3015049556, 3492852316⟩, ⟨(-155657025), (-104739772)⟩, ⟨(-2245485), 7178057⟩, ⟨(-689202), 695891⟩, ⟨(-83832), 96361⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7128212479, 9504283321⟩, ⟨1188035412, 1188035420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11830454027, 21031918341⟩, ⟨3943484672, 5257979608⟩, ⟨328623722, 328623727⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11830454027, 21031918341⟩, ⟨3943484672, 5257979608⟩, ⟨328623722, 328623727⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21031918341), (-11830454027)⟩, ⟨(-5257979608), (-3943484672)⟩, ⟨(-328623727), (-328623722)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10515959171), (-5915227013)⟩, ⟨(-2628989804), (-1971742336)⟩, ⟨(-164311864), (-164311861)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨371207670, 1083501399⟩, ⟨(-663221379), (-170414773)⟩, ⟨(-2334156), 188780786⟩, ⟨(-34171811), 17391422⟩, ⟨(-6272442), 5273871⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨260586273, 881149986⟩, ⟨(-578628141), (-128682979)⟩, ⟨1691130, 179371777⟩, ⟨(-35914021), 14750347⟩, ⟨(-5958622), 5973625⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1197367088, 1197367089⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4494137326, 4494137331⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar544 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2602
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar544 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1026314647, 1368419531⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4424851491, 4589562758⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2603
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((95583 / 400000) : ℝ)..(31861 / 100000), prawitzNormalCorrection
      ((24079 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
