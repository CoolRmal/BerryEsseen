...
namespace FiniteNormalPanel71_15
...
def j2 : Jet := ⟨⟨560129724, 560129729⟩, ⟨560129724, 560129729⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨73049521, 73049524⟩, ⟨146099042, 146099048⟩, ⟨73049521, 73049524⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1611), (-1610)⟩, ⟨(-3221), (-3219)⟩, ⟨(-1610), (-1607)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111445, 5111447⟩, ⟨(-3221), (-3219)⟩, ⟨(-1610), (-1607)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨86936, 86937⟩, ⟨173817, 173819⟩, ⟨86798, 86801⟩, ⟨(-110), (-107)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-143078641), (-143078639)⟩, ⟨173817, 173819⟩, ⟨86798, 86801⟩, ⟨(-110), (-107)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2433506), (-2433505)⟩, ⟨(-4864056), (-4864053)⟩, ⟨(-2426118), (-2426115)⟩, ⟨5906, 5909⟩, ⟨1471, 1474⟩⟩
...
def j19 : Jet := ⟨⟨1429222259, 1429222261⟩, ⟨(-4864056), (-4864053)⟩, ⟨(-2426118), (-2426115)⟩, ⟨5906, 5909⟩, ⟨1471, 1474⟩⟩
...
def j25 : Jet := ⟨⟨201, 202⟩, ⟨401, 403⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851976), (-851974)⟩, ⟨401, 403⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14491), (-14490)⟩, ⟨(-28976), (-28974)⟩, ⟨(-14475), (-14472)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35776903, 35776905⟩, ⟨(-28976), (-28974)⟩, ⟨(-14475), (-14472)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨608499, 608500⟩, ⟨1216506, 1216508⟩, ⟨607266, 607269⟩, ⟨(-986), (-983)⟩, ⟨(-247), (-244)⟩⟩
...
def j33 : Jet := ⟨⟨(-715219384), (-715219382)⟩, ⟨1216506, 1216508⟩, ⟨607266, 607269⟩, ⟨(-986), (-983)⟩, ⟨(-247), (-244)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-12164572), (-12164570)⟩, ⟨(-24308453), (-24308450)⟩, ⟨(-12112863), (-12112859)⟩, ⟨41329, 41333⟩, ⟨10289, 10292⟩⟩
...
def j36 : Jet := ⟨⟨4282802724, 4282802726⟩, ⟨(-24308453), (-24308450)⟩, ⟨(-12112863), (-12112859)⟩, ⟨41329, 41333⟩, ⟨10289, 10292⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨186392541, 186392544⟩, ⟨185758193, 185758197⟩, ⟨(-950752), (-950749)⟩, ⟨(-315634), (-315631)⟩, ⟨961, 964⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4307166417, 4307166420⟩, ⟨24446734, 24446739⟩, ⟨12320520, 12320527⟩, ⟨97501, 97509⟩, ⟨24809, 24817⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨186921957, 186921961⟩, ⟨187346743, 187346750⟩, ⟨638557, 638563⟩, ⟨215152, 215160⟩, ⟨1730, 1740⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-178294830), (-178294829)⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4116672466, 4116672467⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8135060, 8135061⟩, ⟨16307094, 16307096⟩, ⟨8227656, 8227662⟩, ⟨74432, 74440⟩, ⟨19012, 19019⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303102356, 4303102357⟩, ⟨16307094, 16307096⟩, ⟨8227656, 8227662⟩, ⟨74432, 74440⟩, ⟨19012, 19019⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299032901, 4299032903⟩, ⟨8145836, 8145838⟩, ⟨4102219, 4102224⟩, ⟨29407, 29413⟩, ⟨7483, 7489⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4120569297, 4120569301⟩, ⟨(-170655923), (-170655918)⟩, ⟨3593770, 3593777⟩, ⟨(-142108), (-142101)⟩, ⟨5950, 5959⟩⟩
...
def j47 : Jet := ⟨⟨1174639378, 1174639386⟩, ⟨1174639378, 1174639386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨321254522, 321254527⟩, ⟨642509044, 642509054⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨321254522, 321254527⟩, ⟨642509044, 642509054⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-321254527), (-321254522)⟩, ⟨(-642509054), (-642509044)⟩, ⟨(-321254527), (-321254522)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-160627264), (-160627261)⟩, ⟨(-321254527), (-321254522)⟩, ⟨(-160627264), (-160627261)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4137306580, 4137306584⟩, ⟨(-309461838), (-309461831)⟩, ⟨(-143157373), (-143157367)⟩, ⟨11284988, 11284989⟩, ⟨2465944, 2465945⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3969310425, 3969310434⟩, ⟨(-461287523), (-461287509)⟩, ⟨(-121586458), (-121586442)⟩, ⟨16119130, 16119142⟩, ⟨1813599, 1813615⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 356589660⟩, ⟨178294829, 178294830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1120259457⟩, ⟨560129724, 560129729⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 292198093⟩, ⟨0, 292198094⟩, ⟨73049521, 73049524⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 74⟩, ⟨0, 74⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94612)⟩, ⟨0, 74⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6442), 0⟩, ⟨(-6442), 6⟩, ⟨(-1611), (-1601)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106614, 5113057⟩, ⟨(-6442), 6⟩, ⟨(-1611), (-1601)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 347855⟩, ⟨(-439), 347856⟩, ⟨86305, 86965⟩, ⟨(-220), 2⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142817721)⟩, ⟨(-439), 347856⟩, ⟨86305, 86965⟩, ⟨(-220), 2⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9739937), 0⟩, ⟨(-9739967), 23666⟩, ⟨(-2435015), (-2399484)⟩, ⟨(-23), 11835⟩, ⟨1450, 1481⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421915828, 1431655766⟩, ⟨(-9739967), 23666⟩, ⟨(-2435015), (-2399484)⟩, ⟨(-23), 11835⟩, ⟨1450, 1481⟩⟩
...
def j72 : Jet := ⟨⟨0, 806⟩, ⟨(-1), 806⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851370)⟩, ⟨(-1), 806⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-57976), 0⟩, ⟨(-57977), 55⟩, ⟨(-14495), (-14411)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35733418, 35791395⟩, ⟨(-57977), 55⟩, ⟨(-14495), (-14411)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2434985⟩, ⟨(-3945), 2434989⟩, ⟨602827, 608751⟩, ⟨(-1975), 3⟩, ⟨(-248), (-242)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713392897)⟩, ⟨(-3945), 2434989⟩, ⟨602827, 608751⟩, ⟨(-1975), 3⟩, ⟨(-248), (-242)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-48699683), 0⟩, ⟨(-48699952), 165659⟩, ⟨(-12175190), (-11926431)⟩, ⟨(-203), 82831⟩, ⟨10100, 10355⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4246267613, 4294967296⟩, ⟨(-48699952), 165659⟩, ⟨(-12175190), (-11926431)⟩, ⟨(-203), 82831⟩, ⟨10100, 10355⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 373419820⟩, ⟨182899187, 186716083⟩, ⟨(-1905369), 3087⟩, ⟨(-317570), (-309842)⟩, ⟨(-3), 1931⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4344225507⟩, ⟨(-169481), 49823421⟩, ⟨11924509, 13027482⟩, ⟨(-85738), 292478⟩, ⟨20704, 30497⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 377702506⟩, ⟨182884451, 193189324⟩, ⟨(-1934590), 3301764⟩, ⟨157027, 282011⟩, ⟨(-13196), 17344⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-356589660), 0⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3938377636, 4294967296⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 33215430⟩, ⟨0, 33978416⟩, ⟨7447161, 9270453⟩, ⟨(-174038), 346632⟩, ⟨9562, 30961⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4328182726⟩, ⟨0, 33978416⟩, ⟨7447161, 9270453⟩, ⟨(-174038), 346632⟩, ⟨9562, 30961⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311543026⟩, ⟨0, 16989208⟩, ⟨3675792, 4635227⟩, ⟨(-105355), 173316⟩, ⟨1587, 14325⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3938377636, 4311543026⟩, ⟨(-178982930), (-161305621)⟩, ⟨2665344, 4635227⟩, ⟨(-297775), 20725⟩, ⟨(-5740), 18699⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2349278771⟩, ⟨1174639378, 1174639386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1285018107⟩, ⟨0, 1285018108⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1285018107⟩, ⟨0, 1285018108⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1285018107), 0⟩, ⟨(-1285018108), 0⟩, ⟨(-321254527), (-321254522)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-642509054), 0⟩, ⟨(-642509054), 0⟩, ⟨(-160627264), (-160627261)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3698207135, 4294967296⟩, ⟨(-642509054), 0⟩, ⟨(-160627264), (-90250731)⟩, ⟨0, 24029164⟩, ⟨788975, 3003646⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3391163487, 4311543026⟩, ⟨(-823971644), (-138893164)⟩, ⟨(-158952169), (-51347343)⟩, ⟨2398350, 30836400⟩, ⟨(-460085), 3022477⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299032901, 4299032903⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1424
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311543026⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1425
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (326237283 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(3321 / 40000), prawitzNormalCorrection
