...
namespace FiniteNormalPanel159_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (76281 / 800000)
def radius : Rat := (25427 / 800000)

def j0 : Jet := ⟨⟨409530500, 409530501⟩, ⟨136510166, 136510167⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1286578010, 1286578014⟩, ⟨428859334, 428859338⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨385400600, 385400604⟩, ⟨256933732, 256933736⟩, ⟨42822288, 42822290⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨96, 97⟩, ⟨64, 65⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94591), (-94589)⟩, ⟨64, 65⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8488), (-8487)⟩, ⟨(-5654), (-5652)⟩, ⟨(-941), (-938)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104568, 5104570⟩, ⟨(-5654), (-5652)⟩, ⟨(-941), (-938)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨458048, 458049⟩, ⟨304857, 304859⟩, ⟨50470, 50473⟩, ⟨(-114), (-111)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142707529), (-142707527)⟩, ⟨304857, 304859⟩, ⟨50470, 50473⟩, ⟨(-114), (-111)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12805585), (-12805584)⟩, ⟨(-8509702), (-8509700)⟩, ⟨(-1400078), (-1400074)⟩, ⟨6047, 6051⟩, ⟨495, 498⟩⟩
...
def j19 : Jet := ⟨⟨1418850180, 1418850182⟩, ⟨(-8509702), (-8509700)⟩, ⟨(-1400078), (-1400074)⟩, ⟨6047, 6051⟩, ⟨495, 498⟩⟩
...
def j22 : Jet := ⟨⟨(-10), (-9)⟩, ⟨(-7), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11825, 11827⟩, ⟨(-7), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1061, 1062⟩, ⟨706, 708⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851116), (-851114)⟩, ⟨706, 708⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-76374), (-76373)⟩, ⟨(-50853), (-50851)⟩, ⟨(-8434), (-8431)⟩, ⟨12, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35715020, 35715022⟩, ⟨(-50853), (-50851)⟩, ⟨(-8434), (-8431)⟩, ⟨12, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3204818, 3204819⟩, ⟨2131981, 2131983⟩, ⟨352290, 352293⟩, ⟨(-1012), (-1009)⟩, ⟨(-86), (-82)⟩⟩
...
def j33 : Jet := ⟨⟨(-712623065), (-712623063)⟩, ⟨2131981, 2131983⟩, ⟨352290, 352293⟩, ⟨(-1012), (-1009)⟩, ⟨(-86), (-82)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-63945856), (-63945855)⟩, ⟨(-42439262), (-42439259)⟩, ⟨(-6945945), (-6945941)⟩, ⟨42239, 42242⟩, ⟨3443, 3446⟩⟩
...
def j36 : Jet := ⟨⟨4231021440, 4231021441⟩, ⟨(-42439262), (-42439259)⟩, ⟨(-6945945), (-6945941)⟩, ⟨42239, 42242⟩, ⟨3443, 3446⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨425023362, 425023365⟩, ⟨139125331, 139125334⟩, ⟨(-1269109), (-1269105)⟩, ⟨(-137990), (-137986)⟩, ⟨751, 755⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4359879601, 4359879603⟩, ⟨43731769, 43731774⟩, ⟨7596133, 7596141⟩, ⟨104456, 104463⟩, ⟨9527, 9535⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨431446983, 431446988⟩, ⟨145555639, 145555646⟩, ⟨879998, 880006⟩, ⟨103395, 103405⟩, ⟨1436, 1447⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-409530501), (-409530500)⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3885436795, 3885436796⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨43340609, 43340611⟩, ⟨29243314, 29243318⟩, ⟨5109651, 5109656⟩, ⟨80416, 80424⟩, ⟨7476, 7483⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4338307905, 4338307907⟩, ⟨29243314, 29243318⟩, ⟨5109651, 5109656⟩, ⟨80416, 80424⟩, ⟨7476, 7483⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316583205, 4316583207⟩, ⟨14548436, 14548439⟩, ⟨2517514, 2517518⟩, ⟨31521, 31527⟩, ⟨2878, 2884⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3904991600, 3904991603⟩, ⟨(-124035978), (-124035972)⟩, ⟨1815061, 1815067⟩, ⟨(-51502), (-51495)⟩, ⟨1600, 1609⟩⟩
...
def j47 : Jet := ⟨⟨4546910687, 4546910700⟩, ⟨1515636888, 1515636900⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4813633113, 4813633141⟩, ⟨3209088724, 3209088762⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4813633113, 4813633141⟩, ⟨3209088724, 3209088762⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4813633141), (-4813633113)⟩, ⟨(-3209088762), (-3209088724)⟩, ⟨(-534848127), (-534848118)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2406816571), (-2406816556)⟩, ⟨(-1604544381), (-1604544362)⟩, ⟨(-267424064), (-267424059)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2452390561, 2452390581⟩, ⟨(-916181488), (-916181469)⟩, ⟨18439872, 18439883⟩, ⟨35734096, 35734100⟩, ⟨(-3911525), (-3911524)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2229717685, 2229717706⟩, ⟨(-903817287), (-903817263)⟩, ⟨44260695, 44260714⟩, ⟨31540378, 31540392⟩, ⟨(-4568656), (-4568643)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨273020333, 546040668⟩, ⟨136510166, 136510167⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨857718672, 1715437352⟩, ⟨428859334, 428859338⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨171289155, 685156628⟩, ⟨171289154, 342578314⟩, ⟨42822288, 42822290⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨42, 172⟩, ⟨42, 86⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94645), (-94514)⟩, ⟨42, 86⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-15099), (-3769)⟩, ⟨(-7549), (-3755)⟩, ⟨(-943), (-933)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097957, 5109288⟩, ⟨(-7549), (-3755)⟩, ⟨(-943), (-933)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨203313, 815062⟩, ⟨202108, 407382⟩, ⟨50074, 50756⟩, ⟨(-152), (-73)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142962264), (-142350514)⟩, ⟨202108, 407382⟩, ⟨50074, 50756⟩, ⟨(-152), (-73)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-22806121), (-5677132)⟩, ⟨(-11395001), (-5612144)⟩, ⟨(-1415326), (-1378692)⟩, ⟨3987, 8109⟩, ⟨484, 505⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408849644, 1425978634⟩, ⟨(-11395001), (-5612144)⟩, ⟨(-1415326), (-1378692)⟩, ⟨3987, 8109⟩, ⟨484, 505⟩⟩
...
def j70 : Jet := ⟨⟨(-18), (-4)⟩, ⟨(-9), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11817, 11832⟩, ⟨(-9), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨471, 1888⟩, ⟨469, 944⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851706), (-850288)⟩, ⟨469, 944⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-135869), (-33910)⟩, ⟨(-67917), (-33759)⟩, ⟨(-8470), (-8382)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35655525, 35757485⟩, ⟨(-67917), (-33759)⟩, ⟨(-8470), (-8382)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1421990, 5704230⟩, ⟨1411155, 2850769⟩, ⟨348727, 354835⟩, ⟨(-1354), (-666)⟩, ⟨(-86), (-80)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714405893), (-710123652)⟩, ⟨1411155, 2850769⟩, ⟨348727, 354835⟩, ⟨(-1354), (-666)⟩, ⟨(-86), (-80)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-113965928), (-28320699)⟩, ⟨(-56926686), (-27865928)⟩, ⟨(-7052686), (-6796182)⟩, ⟨27760, 56701⟩, ⟨3354, 3509⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4181001368, 4266646597⟩, ⟨(-56926686), (-27865928)⟩, ⟨(-7052686), (-6796182)⟩, ⟨27760, 56701⟩, ⟨3354, 3509⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨281351768, 569544969⟩, ⟨136124646, 141265480⟩, ⟨(-1703101), (-835710)⟩, ⟨(-140527), (-134425)⟩, ⟨494, 1012⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4323475979, 4412039713⟩, ⟨28237086, 60072404⟩, ⟨7071121, 8260332⟩, ⟨32525, 185097⟩, ⟨7047, 12801⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨283219295, 585069653⟩, ⟨138877934, 153082154⟩, ⟨(-391370), 2229964⟩, ⟨58063, 155426⟩, ⟨(-3254), 6569⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-546040668), (-273020333)⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3748926628, 4021946963⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨18676083, 79699443⟩, ⟨18315812, 41706360⟩, ⟨4383995, 6063730⟩, ⟨(-20244), 201308⟩, ⟨2662, 14028⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4313643379, 4374666739⟩, ⟨18315812, 41706360⟩, ⟨4383995, 6063730⟩, ⟨(-20244), 201308⟩, ⟨2662, 14028⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304295208, 4334633846⟩, ⟨9074101, 20807989⟩, ⟨2121994, 3015730⟩, ⟨(-24680), 95963⟩, ⟨(-193), 6596⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3757068635, 4059092010⟩, ⟨(-129850454), (-117321364)⟩, ⟨1190858, 2535620⟩, ⟨(-118964), 22419⟩, ⟨(-3232), 6962⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3031273788, 6062547600⟩, ⟨1515636888, 1515636900⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2139392489, 8557570028⟩, ⟨2139392480, 4278785014⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2139392489, 8557570028⟩, ⟨2139392480, 4278785014⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8557570028), (-2139392489)⟩, ⟨(-4278785014), (-2139392480)⟩, ⟨(-534848127), (-534848118)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4278785014), (-1069696244)⟩, ⟨(-2139392507), (-1069696240)⟩, ⟨(-267424064), (-267424059)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1585994524, 3348076080⟩, ⟨(-1667730715), (-395004725)⟩, ⟨(-159276784), 316610608⟩, ⟨(-36173100), 95673077⟩, ⟨(-21770880), 9463248⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1387365693, 3164203108⟩, ⟨(-1677363557), (-388857653)⟩, ⟨(-139299767), 351620054⟩, ⟨(-44835967), 95142205⟩, ⟨(-23573005), 10275704⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨409530500, 409530501⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316583205, 4316583207⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3222
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨273020333, 546040668⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304295208, 4334633846⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3223
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (142806069 / 4294967296)

theorem envelope_integral : (∫ s in ((25427 / 400000) : ℝ)..(25427 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (25427 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (25427 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((25427 / 400000) : ℝ)..(25427 / 200000), prawitzNormalCorrection
