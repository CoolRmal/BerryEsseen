...
namespace FiniteNormalPanel70_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (22757 / 80000)
def radius : Rat := (3251 / 80000)

def j0 : Jet := ⟨⟨1221757134, 1221757135⟩, ⟨174536733, 174536734⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3838263236, 3838263240⟩, ⟨548323318, 548323322⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3430122665, 3430122673⟩, ⟨980035044, 980035054⟩, ⟨70002503, 70002505⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨858, 860⟩, ⟨245, 246⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93829), (-93826)⟩, ⟨245, 246⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-74936), (-74932)⟩, ⟨(-21216), (-21212)⟩, ⟨(-1462), (-1457)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5038120, 5038125⟩, ⟨(-21216), (-21212)⟩, ⟨(-1462), (-1457)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4023632, 4023637⟩, ⟨1132665, 1132671⟩, ⟨76104, 76113⟩, ⟨(-676), (-669)⟩, ⟨(-23), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-139141945), (-139141939)⟩, ⟨1132665, 1132671⟩, ⟨76104, 76113⟩, ⟨(-676), (-669)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-111123999), (-111123993)⟩, ⟨(-30845127), (-30845118)⟩, ⟨(-1948605), (-1948593)⟩, ⟨35285, 35296⟩, ⟨1066, 1074⟩⟩
...
def j19 : Jet := ⟨⟨1320531766, 1320531773⟩, ⟨(-30845127), (-30845118)⟩, ⟨(-1948605), (-1948593)⟩, ⟨35285, 35296⟩, ⟨1066, 1074⟩⟩
...
def j22 : Jet := ⟨⟨(-87), (-85)⟩, ⟨(-25), (-24)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11748, 11751⟩, ⟨(-25), (-24)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9382, 9385⟩, ⟨2660, 2663⟩, ⟨183, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842795), (-842791)⟩, ⟨2660, 2663⟩, ⟨183, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-673088), (-673084)⟩, ⟨(-190187), (-190182)⟩, ⟨(-12985), (-12978)⟩, ⟨82, 87⟩, ⟨0, 4⟩⟩
...
def j30 : Jet := ⟨⟨35118306, 35118311⟩, ⟨(-190187), (-190182)⟩, ⟨(-12985), (-12978)⟩, ⟨82, 87⟩, ⟨0, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨28046802, 28046807⟩, ⟨7861480, 7861488⟩, ⟨518614, 518624⟩, ⟨(-5998), (-5990)⟩, ⟨(-194), (-187)⟩⟩
...
def j33 : Jet := ⟨⟨(-687781081), (-687781075)⟩, ⟨7861480, 7861488⟩, ⟨518614, 518624⟩, ⟨(-5998), (-5990)⟩, ⟨(-194), (-187)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-549287880), (-549287873)⟩, ⟨(-150660921), (-150660911)⟩, ⟨(-9001924), (-9001911)⟩, ⟨241679, 241691⟩, ⟨6928, 6938⟩⟩
...
def j36 : Jet := ⟨⟨3745679416, 3745679423⟩, ⟨(-150660921), (-150660911)⟩, ⟨(-9001924), (-9001911)⟩, ⟨241679, 241691⟩, ⟨6928, 6938⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1180113416, 1180113424⟩, ⟨141022410, 141022422⟩, ⟨(-5679290), (-5679276)⟩, ⟨(-217240), (-217226)⟩, ⟨5456, 5467⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4924805887, 4924805897⟩, ⟨198088425, 198088441⟩, ⟨19803307, 19803329⟩, ⟨954825, 954847⟩, ⟨64091, 64113⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1353172002, 1353172015⟩, ⟨216130819, 216130840⟩, ⟨5433254, 5433280⟩, ⟨401548, 401576⟩, ⟨19010, 19034⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1221757135), (-1221757134)⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3073210161, 3073210162⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨426330246, 426330255⟩, ⟨136188310, 136188328⟩, ⟨14299708, 14299729⟩, ⟨799844, 799868⟩, ⟨59263, 59286⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4721297542, 4721297551⟩, ⟨136188310, 136188328⟩, ⟨14299708, 14299729⟩, ⟨799844, 799868⟩, ⟨59263, 59286⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4503089887, 4503089893⟩, ⟨64946997, 64947007⟩, ⟨6351045, 6351057⟩, ⟨289838, 289851⟩, ⟨19601, 19616⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3222129679, 3222129685⟩, ⟨(-136522306), (-136522294)⟩, ⟨1905125, 1905137⟩, ⟨(-50703), (-50690)⟩, ⟨2246, 2258⟩⟩
...
def j47 : Jet := ⟨⟨8447466841, 8447466851⟩, ⟨1206780974, 1206780982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16614723957, 16614723997⟩, ⟨4747063974, 4747064014⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16614723957, 16614723997⟩, ⟨4747063974, 4747064014⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16614723997), (-16614723957)⟩, ⟨(-4747064014), (-4747063974)⟩, ⟨(-339076002), (-339075997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8307361999), (-8307361978)⟩, ⟨(-2373532007), (-2373531987)⟩, ⟨(-169538001), (-169537998)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨620788705, 620788715⟩, ⟨(-343067079), (-343067070)⟩, ⟨70289954, 70289959⟩, ⟨(-3920066), (-3920063)⟩, ⟨(-845714), (-845712)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨465722221, 465722230⟩, ⟨(-277105283), (-277105272)⟩, ⟨63912553, 63912562⟩, ⟨(-5334658), (-5334648)⟩, ⟨(-474309), (-474300)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1047220400, 1396293868⟩, ⟨174536733, 174536734⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3289939915, 4386586559⟩, ⟨548323318, 548323322⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2520090119, 4480160224⟩, ⟨840030036, 1120040062⟩, ⟨70002503, 70002505⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨630, 1123⟩, ⟨210, 281⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94057), (-93563)⟩, ⟨210, 281⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-98113), (-54898)⟩, ⟨(-24406), (-18005)⟩, ⟨(-1484), (-1431)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5014943, 5058159⟩, ⟨(-24406), (-18005)⟩, ⟨(-1484), (-1431)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2942538, 5276260⟩, ⟨955387, 1308501⟩, ⟨73824, 78082⟩, ⟨(-782), (-561)⟩, ⟨(-24), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140223039), (-137889316)⟩, ⟨955387, 1308501⟩, ⟨73824, 78082⟩, ⟨(-782), (-561)⟩, ⟨(-24), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-146269259), (-80907135)⟩, ⟨(-36006738), (-25604123)⟩, ⟨(-2055283), (-1824740)⟩, ⟨29193, 41361⟩, ⟨973, 1154⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1285386506, 1350748631⟩, ⟨(-36006738), (-25604123)⟩, ⟨(-2055283), (-1824740)⟩, ⟨29193, 41361⟩, ⟨973, 1154⟩⟩
...
def j72 : Jet := ⟨⟨6877, 12282⟩, ⟨2261, 3060⟩, ⟨180, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845300), (-839894)⟩, ⟨2261, 3060⟩, ⟨180, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-881749), (-492811)⟩, ⟨(-219112), (-161078)⟩, ⟨(-13231), (-12693)⟩, ⟨68, 100⟩, ⟨(-1), 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34909645, 35298584⟩, ⟨(-219112), (-161078)⟩, ⟨(-13231), (-12693)⟩, ⟨68, 100⟩, ⟨(-1), 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨20483380, 36820610⟩, ⟨6599233, 9110640⟩, ⟨498040, 536372⟩, ⟨(-6984), (-5002)⟩, ⟨(-205), (-174)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-695344503), (-679007272)⟩, ⟨6599233, 9110640⟩, ⟨498040, 536372⟩, ⟨(-6984), (-5002)⟩, ⟨(-205), (-174)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-725326777), (-398410371)⟩, ⟨(-177459569), (-123299978)⟩, ⟨(-9750296), (-8131584)⟩, ⟨197682, 285433⟩, ⟨6081, 7663⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3569640519, 3896556925⟩, ⟨(-177459569), (-123299978)⟩, ⟨(-9750296), (-8131584)⟩, ⟨197682, 285433⟩, ⟨6081, 7663⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨984604557, 1379562493⟩, ⟨127325933, 152832585⟩, ⟨(-6695980), (-4666536)⟩, ⟨(-240030), (-190714)⟩, ⟨4471, 6460⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4734113841, 5167675562⟩, ⟨149803054, 256903595⟩, ⟨14619716, 26886846⟩, ⟨396687, 1776194⟩, ⟨14077, 145384⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1085277195, 1659880249⟩, ⟨174686365, 266405704⟩, ⟨(-264077), 12634186⟩, ⟨(-164979), 1154292⟩, ⟨(-36362), 95141⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1396293868), (-1047220400)⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2898673428, 3247746896⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨274234123, 641495558⟩, ⟨88281522, 205916152⟩, ⟨6900785, 26289951⟩, ⟨(-160282), 2459534⟩, ⟨(-49351), 253902⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4569201419, 4936462854⟩, ⟨88281522, 205916152⟩, ⟨6900785, 26289951⟩, ⟨(-160282), 2459534⟩, ⟨(-49351), 253902⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4429962828, 4604557147⟩, ⟨41172933, 99820605⟩, ⟨2136414, 12553071⟩, ⟨(-360559), 1172437⟩, ⟨(-68129), 130693⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2989781912, 3481851002⟩, ⟨(-159330080), (-104540766)⟩, ⟨(-2614595), 7819154⟩, ⟨(-782772), 799750⟩, ⟨(-99163), 113480⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7240685860, 9654247825⟩, ⟨1206780974, 1206780982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12206735956, 21700863975⟩, ⟨4068911976, 5425216012⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12206735956, 21700863975⟩, ⟨4068911976, 5425216012⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21700863975), (-12206735956)⟩, ⟨(-5425216012), (-4068911976)⟩, ⟨(-339076002), (-339075997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10850431988), (-6103367978)⟩, ⟨(-2712608006), (-2034455988)⟩, ⟨(-169538001), (-169537998)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨343396634, 1037063178⟩, ⟨(-654986566), (-162661387)⟩, ⟨(-2411638), 193282525⟩, ⟨(-36410457), 17744184⟩, ⟨(-6616493), 5796612⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨239042808, 840728047⟩, ⟨(-569457420), (-121589055)⟩, ⟨1372833, 182876591⟩, ⟨(-38068914), 15066186⟩, ⟨(-6285695), 6548577⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1221757134, 1221757135⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4503089887, 4503089893⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1400
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1047220400, 1396293868⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4429962828, 4604557147⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1401
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (2480595 / 268435456)

theorem envelope_integral : (∫ s in ((9753 / 40000) : ℝ)..(3251 / 10000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((9753 / 40000) : ℝ)..(3251 / 10000), prawitzNormalCorrection
