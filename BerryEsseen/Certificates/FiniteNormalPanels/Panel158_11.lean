...
namespace FiniteNormalPanel158_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (11109 / 50000)
def radius : Rat := (1587 / 50000)

def j0 : Jet := ⟨⟨954255833, 954255834⟩, ⟨136322261, 136322262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2997883114, 2997883118⟩, ⟨428269013, 428269017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2092519580, 2092519587⟩, ⟨597862732, 597862740⟩, ⟨42704480, 42704482⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨523, 525⟩, ⟨149, 150⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94164), (-94161)⟩, ⟨149, 150⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-45877), (-45875)⟩, ⟨(-13036), (-13033)⟩, ⟨(-913), (-909)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5067179, 5067182⟩, ⟨(-13036), (-13033)⟩, ⟨(-913), (-909)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2468743, 2468745⟩, ⟨699003, 699007⟩, ⟨48122, 48127⟩, ⟨(-258), (-253)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140696834), (-140696831)⟩, ⟨699003, 699007⟩, ⟨48122, 48127⟩, ⟨(-258), (-253)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-68547875), (-68547873)⟩, ⟨(-19244552), (-19244547)⟩, ⟨(-1278191), (-1278185)⟩, ⟨13522, 13528⟩, ⟨437, 441⟩⟩
...
def j19 : Jet := ⟨⟨1363107890, 1363107893⟩, ⟨(-19244552), (-19244547)⟩, ⟨(-1278191), (-1278185)⟩, ⟨13522, 13528⟩, ⟨437, 441⟩⟩
...
def j25 : Jet := ⟨⟨5740, 5742⟩, ⟨1632, 1635⟩, ⟨113, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846437), (-846434)⟩, ⟨1632, 1635⟩, ⟨113, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-412387), (-412384)⟩, ⟨(-117030), (-117027)⟩, ⟨(-8135), (-8130)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35379007, 35379011⟩, ⟨(-117030), (-117027)⟩, ⟨(-8135), (-8130)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17236747, 17236750⟩, ⟨4867766, 4867771⟩, ⟨331515, 331521⟩, ⟨(-2283), (-2277)⟩, ⟨(-78), (-74)⟩⟩
...
def j33 : Jet := ⟨⟨(-698591136), (-698591132)⟩, ⟨4867766, 4867771⟩, ⟨331515, 331521⟩, ⟨(-2283), (-2277)⟩, ⟨(-78), (-74)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-340355476), (-340355472)⟩, ⟨(-94872834), (-94872827)⟩, ⟨(-6106921), (-6106913)⟩, ⟨93433, 93439⟩, ⟨2939, 2945⟩⟩
...
def j36 : Jet := ⟨⟨3954611820, 3954611824⟩, ⟨(-94872834), (-94872827)⟩, ⟨(-6106921), (-6106913)⟩, ⟨93433, 93439⟩, ⟨2939, 2945⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨951448019, 951448023⟩, ⟨122488464, 122488472⟩, ⟨(-2811132), (-2811124)⟩, ⟨(-118016), (-118010)⟩, ⟨1653, 1657⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4664615617, 4664615622⟩, ⟨111906121, 111906130⟩, ⟨9888012, 9888024⟩, ⟨299812, 299823⟩, ⟨16342, 16354⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1033334827, 1033334833⟩, ⟨157820632, 157820645⟩, ⟨2328838, 2328852⟩, ⟨146993, 147007⟩, ⟨4418, 4429⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-954255834), (-954255833)⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3340711462, 3340711463⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨248612106, 248612109⟩, ⟨75940766, 75940774⟩, ⟨6919792, 6919804⟩, ⟨241878, 241888⟩, ⟨14188, 14199⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4543579402, 4543579405⟩, ⟨75940766, 75940774⟩, ⟨6919792, 6919804⟩, ⟨241878, 241888⟩, ⟨14188, 14199⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4417524752, 4417524754⟩, ⟨36916952, 36916957⟩, ⟨3209650, 3209657⟩, ⟨90760, 90766⟩, ⟨4971, 4979⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3436039102, 3436039106⟩, ⟨(-111497493), (-111497486)⟩, ⟨1324784, 1324792⟩, ⟨(-31281), (-31274)⟩, ⟨985, 993⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨48769849087, 48769849095⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value644

def j47 : Jet := ⟨⟨10835685060, 10835685074⟩, ⟨1547954998, 1547955011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨27337127998, 27337128069⟩, ⟨7810607946, 7810608022⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨27337127998, 27337128069⟩, ⟨7810607946, 7810608022⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-27337128069), (-27337127998)⟩, ⟨(-7810608022), (-7810607946)⟩, ⟨(-557900574), (-557900563)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-13668564035), (-13668563999)⟩, ⟨(-3905304011), (-3905303973)⟩, ⟨(-278950287), (-278950281)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨178170088, 178170094⟩, ⟨(-162005514), (-162005506)⟩, ⟨62081910, 62081916⟩, ⟨(-11801859), (-11801856)⟩, ⟨666727, 666729⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨142538777, 142538783⟩, ⟨(-134232176), (-134232167)⟩, ⟨53927095, 53927103⟩, ⟨(-11104585), (-11104579)⟩, ⟨860135, 860143⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨817933571, 1090578096⟩, ⟨136322261, 136322262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2569614097, 3426152135⟩, ⟨428269013, 428269017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1537361323, 2733086807⟩, ⟨512453770, 683271702⟩, ⟨42704480, 42704482⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨384, 685⟩, ⟨128, 172⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94303), (-94001)⟩, ⟨128, 172⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-60010), (-33647)⟩, ⟨(-14958), (-11105)⟩, ⟨(-920), (-899)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5053046, 5079410⟩, ⟨(-14958), (-11105)⟩, ⟨(-920), (-899)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1808711, 3232265⟩, ⟨593384, 804093⟩, ⟨47275, 48860⟩, ⟨(-296), (-214)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141356866), (-139933311)⟩, ⟨593384, 804093⟩, ⟨47275, 48860⟩, ⟨(-296), (-214)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-89951928), (-50088404)⟩, ⟨(-22275584), (-16184452)⟩, ⟨(-1317779), (-1232331)⟩, ⟨11350, 15693⟩, ⟨415, 459⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1341703837, 1381567362⟩, ⟨(-22275584), (-16184452)⟩, ⟨(-1317779), (-1232331)⟩, ⟨11350, 15693⟩, ⟨415, 459⟩⟩
...
def j72 : Jet := ⟨⟨4211, 7508⟩, ⟨1391, 1873⟩, ⟨111, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847966), (-844668)⟩, ⟨1391, 1873⟩, ⟨111, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-539601), (-302344)⟩, ⟨(-134404), (-99589)⟩, ⟨(-8228), (-8025)⟩, ⟨24, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35251793, 35489051⟩, ⟨(-134404), (-99589)⟩, ⟨(-8228), (-8025)⟩, ⟨24, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12618196, 22583329⟩, ⟨4120537, 5610186⟩, ⟨323887, 338111⟩, ⟨(-2638), (-1922)⟩, ⟨(-81), (-70)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703209687), (-693244553)⟩, ⟨4120537, 5610186⟩, ⟨323887, 338111⟩, ⟨(-2638), (-1922)⟩, ⟨(-81), (-70)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-447484925), (-248143301)⟩, ⟨(-110396308), (-79144411)⟩, ⟨(-6384379), (-5785207)⟩, ⟨77935, 108884⟩, ⟨2748, 3108⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3847482371, 4046823995⟩, ⟨(-110396308), (-79144411)⟩, ⟨(-6384379), (-5785207)⟩, ⟨77935, 108884⟩, ⟨2748, 3108⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨802721151, 1102094531⟩, ⟨116017329, 128078904⟩, ⟨(-3272401), (-2351103)⟩, ⟨(-124612), (-110361)⟩, ⟨1379, 1932⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4558326256, 4794497361⟩, ⟨89147944, 137569132⟩, ⟨8259913, 11903112⟩, ⟨159980, 477484⟩, ⟨7550, 28394⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨851942435, 1230274635⟩, ⟨139792862, 178275667⟩, ⟨298858, 4661494⟩, ⟨9095, 311556⟩, ⟨(-5867), 16871⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1090578096), (-817933571)⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3204389200, 3477033725⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨168989857, 352406800⟩, ⟨55458150, 102132574⟩, ⟨4668546, 10070404⟩, ⟨23062, 565468⟩, ⟨(-2750), 40592⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4463957153, 4647374096⟩, ⟨55458150, 102132574⟩, ⟨4668546, 10070404⟩, ⟨23062, 565468⟩, ⟨(-2750), 40592⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4378647049, 4467697367⟩, ⟨26657013, 50090366⟩, ⟨1963226, 4857832⟩, ⟨(-44262), 265380⟩, ⟨(-7081), 19976⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3266820990, 3616869082⟩, ⟨(-121916451), (-98427099)⟩, ⟨(-125146), 3086614⟩, ⟨(-190021), 152530⟩, ⟨(-14157), 17577⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9287730050, 12383640085⟩, ⟨1547954998, 1547955011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨20084420564, 35705636665⟩, ⟨6694806808, 8926409170⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨20084420564, 35705636665⟩, ⟨6694806808, 8926409170⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-35705636665), (-20084420564)⟩, ⟨(-8926409170), (-6694806808)⟩, ⟨(-557900574), (-557900563)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-17852818333), (-10042210282)⟩, ⟨(-4463204585), (-3347403404)⟩, ⟨(-278950287), (-278950281)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨67256657, 414496670⟩, ⟨(-430732835), (-52418364)⟩, ⟨(-6493941), 219434295⟩, ⟨(-73740253), 20899646⟩, ⟨(-12555504), 19368065⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨51156491, 349055089⟩, ⟨(-374493711), (-41411558)⟩, ⟨(-4279480), 197314177⟩, ⟨(-68654718), 17811577⟩, ⟨(-11189529), 18581832⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨954255833, 954255834⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨136322261, 136322262⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4417524752, 4417524754⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar644 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3194
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar644 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨817933571, 1090578096⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4378647049, 4467697367⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3195
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((4761 / 25000) : ℝ)..(1587 / 6250),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (4761 / 25000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (1587 / 6250) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((4761 / 25000) : ℝ)..(1587 / 6250), prawitzNormalCorrection
      ((137701 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
