...
namespace FiniteNormalPanel63_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2351 / 25000)
def radius : Rat := (2351 / 25000)

def j0 : Jet := ⟨⟨403898724, 403898725⟩, ⟨403898724, 403898725⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1268885264, 1268885268⟩, ⟨1268885264, 1268885268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨374873590, 374873594⟩, ⟨749747180, 749747188⟩, ⟨374873590, 374873594⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨93, 94⟩, ⟨187, 188⟩, ⟨93, 94⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94594), (-94592)⟩, ⟨187, 188⟩, ⟨93, 94⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8257), (-8256)⟩, ⟨(-16497), (-16495)⟩, ⟨(-8217), (-8214)⟩, ⟨32, 34⟩, ⟨8, 9⟩⟩
...
def j13 : Jet := ⟨⟨5104799, 5104801⟩, ⟨(-16497), (-16495)⟩, ⟨(-8217), (-8214)⟩, ⟨32, 34⟩, ⟨8, 9⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨445557, 445558⟩, ⟨889674, 889677⟩, ⟨441959, 441963⟩, ⟨(-2873), (-2869)⟩, ⟨(-713), (-709)⟩⟩
...
def j16 : Jet := ⟨⟨(-142720020), (-142720018)⟩, ⟨889674, 889677⟩, ⟨441959, 441963⟩, ⟨(-2873), (-2869)⟩, ⟨(-713), (-709)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12456898), (-12456897)⟩, ⟨(-24836143), (-24836141)⟩, ⟨(-12263018), (-12263015)⟩, ⟨154551, 154554⟩, ⟨38010, 38015⟩⟩
...
def j19 : Jet := ⟨⟨1419198867, 1419198869⟩, ⟨(-24836143), (-24836141)⟩, ⟨(-12263018), (-12263015)⟩, ⟨154551, 154554⟩, ⟨38010, 38015⟩⟩
...
def j25 : Jet := ⟨⟨1032, 1033⟩, ⟨2062, 2064⟩, ⟨1027, 1030⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851145), (-851143)⟩, ⟨2062, 2064⟩, ⟨1027, 1030⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-74290), (-74289)⟩, ⟨(-148401), (-148398)⟩, ⟨(-73842), (-73838)⟩, ⟨357, 361⟩, ⟨87, 90⟩⟩
...
def j30 : Jet := ⟨⟨35717104, 35717106⟩, ⟨(-148401), (-148398)⟩, ⟨(-73842), (-73838)⟩, ⟨357, 361⟩, ⟨87, 90⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3117462, 3117463⟩, ⟨6221971, 6221974⟩, ⟨3085110, 3085115⟩, ⟨(-25813), (-25809)⟩, ⟨(-6377), (-6372)⟩⟩
...
def j33 : Jet := ⟨⟨(-712710421), (-712710419)⟩, ⟨6221971, 6221974⟩, ⟨3085110, 3085115⟩, ⟨(-25813), (-25809)⟩, ⟨(-6377), (-6372)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-62206834), (-62206833)⟩, ⟨(-123870602), (-123870599)⟩, ⟨(-60851428), (-60851423)⟩, ⟨1079361, 1079366⟩, ⟨264210, 264215⟩⟩
...
def j36 : Jet := ⟨⟨4232760462, 4232760463⟩, ⟨(-123870602), (-123870599)⟩, ⟨(-60851428), (-60851423)⟩, ⟨1079361, 1079366⟩, ⟨264210, 264215⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨419281546, 419281549⟩, ⟨411944070, 411944075⟩, ⟨(-10960406), (-10960402)⟩, ⟨(-3577271), (-3577267)⟩, ⟨56888, 56892⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4358088352, 4358088354⟩, ⟨127538285, 127538290⟩, ⟨66385546, 66385555⟩, ⟨2664957, 2664967⟩, ⟨727804, 727815⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨425443523, 425443528⟩, ⟨430448702, 430448710⟩, ⟨7591781, 7591790⟩, ⟨2672094, 2672104⟩, ⟨108739, 108750⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-403898725), (-403898724)⟩, ⟨(-403898725), (-403898724)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3891068571, 3891068572⟩, ⟨(-403898725), (-403898724)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨42142856, 42142858⟩, ⟨85277302, 85277306⟩, ⟨44644304, 44644311⟩, ⟨2051094, 2051102⟩, ⟨570563, 570572⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4337110152, 4337110154⟩, ⟨85277302, 85277306⟩, ⟨44644304, 44644311⟩, ⟨2051094, 2051102⟩, ⟨570563, 570572⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4315987287, 4315987289⟩, ⟨42430989, 42430992⟩, ⟨22004865, 22004870⟩, ⟨804219, 804225⟩, ⟨219889, 219896⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3910111842, 3910111845⟩, ⟨(-367434668), (-367434661)⟩, ⟨15945316, 15945323⟩, ⟨(-1340748), (-1340741)⟩, ⟨123580, 123589⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨22154864919, 22154864925⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value337

def j47 : Jet := ⟨⟨2083443494, 2083443501⟩, ⟨2083443494, 2083443501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1010656541, 1010656549⟩, ⟨2021313082, 2021313098⟩, ⟨1010656541, 1010656549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1010656541, 1010656549⟩, ⟨2021313082, 2021313098⟩, ⟨1010656541, 1010656549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1010656549), (-1010656541)⟩, ⟨(-2021313098), (-2021313082)⟩, ⟨(-1010656549), (-1010656541)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-505328275), (-505328270)⟩, ⟨(-1010656549), (-1010656541)⟩, ⟨(-505328275), (-505328270)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3818234081, 3818234087⟩, ⟨(-898475593), (-898475583)⟩, ⟨(-343526838), (-343526829)⟩, ⟨97419279, 97419283⟩, ⟨14478002, 14478005⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3476096851, 3476096860⟩, ⟨(-1144616781), (-1144616762)⟩, ⟨(-221704679), (-221704658)⟩, ⟨113551076, 113551093⟩, ⟨3961430, 3961446⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 807797450⟩, ⟨403898724, 403898725⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2537770535⟩, ⟨1268885264, 1268885268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1499494373⟩, ⟨0, 1499494374⟩, ⟨374873590, 374873594⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 376⟩, ⟨0, 376⟩, ⟨93, 94⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94310)⟩, ⟨0, 376⟩, ⟨93, 94⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-33058), 0⟩, ⟨(-33058), 132⟩, ⟨(-8265), (-8066)⟩, ⟨0, 66⟩, ⟨8, 9⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5079998, 5113057⟩, ⟨(-33058), 132⟩, ⟨(-8265), (-8066)⟩, ⟨0, 66⟩, ⟨8, 9⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1785113⟩, ⟨(-11542), 1785160⟩, ⟨428964, 446326⟩, ⟨(-5772), 36⟩, ⟨(-722), (-676)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141380463)⟩, ⟨(-11542), 1785160⟩, ⟨428964, 446326⟩, ⟨(-5772), 36⟩, ⟨(-722), (-676)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-49983146), 0⟩, ⟨(-49987176), 623250⟩, ⟨(-12499817), (-11560901)⟩, ⟨(-3024), 311652⟩, ⟨35171, 38970⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1381672619, 1431655766⟩, ⟨(-49987176), 623250⟩, ⟨(-12499817), (-11560901)⟩, ⟨(-3024), 311652⟩, ⟨35171, 38970⟩⟩
...
def j70 : Jet := ⟨⟨(-38), 0⟩, ⟨(-38), 0⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11797, 11836⟩, ⟨(-38), 0⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 4133⟩, ⟨(-14), 4133⟩, ⟨1011, 1034⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848043)⟩, ⟨(-14), 4133⟩, ⟨1011, 1034⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-297520), 0⟩, ⟨(-297525), 1443⟩, ⟨(-74385), (-72214)⟩, ⟨(-5), 722⟩, ⟨84, 91⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35493874, 35791395⟩, ⟨(-297525), 1443⟩, ⟨(-74385), (-72214)⟩, ⟨(-5), 722⟩, ⟨84, 91⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 12495787⟩, ⟨(-103875), 12496291⟩, ⟨2968133, 3124451⟩, ⟨(-51941), 379⟩, ⟨(-6495), (-6017)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-703332095)⟩, ⟨(-103875), 12496291⟩, ⟨2968133, 3124451⟩, ⟨(-51941), 379⟩, ⟨(-6495), (-6017)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-249915729), 0⟩, ⟨(-249951996), 4362809⟩, ⟨(-62515199), (-55934629)⟩, ⟨(-27202), 2181671⟩, ⟨238661, 272842⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4045051567, 4294967296⟩, ⟨(-249951996), 4362809⟩, ⟨(-62515199), (-55934629)⟩, ⟨(-27202), 2181671⟩, ⟨238661, 272842⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 845923513⟩, ⟨378659004, 423330018⟩, ⟨(-22153758), 184131⟩, ⟨(-3694676), (-3231352)⟩, ⟨(-894), 115101⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4560323588⟩, ⟨(-4918559), 281791708⟩, ⟨55648386, 87891078⟩, ⟨(-2630392), 9816654⟩, ⟨138806, 1714173⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 898187270⟩, ⟨377690259, 504985475⟩, ⟨(-24007280), 45280839⟩, ⟨(-988370), 7390391⟩, ⟨(-955969), 1435404⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-807797450), 0⟩, ⟨(-403898725), (-403898724)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3487169846, 4294967296⟩, ⟨(-403898725), (-403898724)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 187833881⟩, ⟨0, 211210702⟩, ⟨23172205, 78312980⟩, ⟨(-6058754), 13738930⟩, ⟨(-885358), 2815614⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4482801177⟩, ⟨0, 211210702⟩, ⟨23172205, 78312980⟩, ⟨(-6058754), 13738930⟩, ⟨(-885358), 2815614⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4387879266⟩, ⟨0, 105605351⟩, ⟨10069940, 39156490⟩, ⟨(-3992164), 6869465⟩, ⟨(-790079), 1494163⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3487169846, 4387879266⟩, ⟨(-412636167), (-298293373)⟩, ⟨(-1755143), 39156490⟩, ⟨(-7674441), 5922488⟩, ⟨(-1436084), 1869587⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4166887001⟩, ⟨2083443494, 2083443501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4042626191⟩, ⟨0, 4042626192⟩, ⟨1010656541, 1010656549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4042626191⟩, ⟨0, 4042626192⟩, ⟨1010656541, 1010656549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4042626191), 0⟩, ⟨(-4042626192), 0⟩, ⟨(-1010656549), (-1010656541)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2021313096), 0⟩, ⟨(-2021313096), 0⟩, ⟨(-505328275), (-505328270)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2682690773, 4294967296⟩, ⟨(-2021313096), 0⟩, ⟨(-505328275), 160004439⟩, ⟨(-25100624), 237819427⟩, ⟨(-37393595), 32680666⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2178130291, 4387879266⟩, ⟨(-2477675832), (-186317805)⟩, ⟨(-518015061), 396818597⟩, ⟨(-67118353), 298261700⟩, ⟨(-69881208), 42739260⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨403898724, 403898725⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨403898724, 403898725⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4315987287, 4315987289⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar337 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1240
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar337 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 807797450⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4387879266⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1241
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(2351 / 12500), prawitzNormalCorrection
      ((52647 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
