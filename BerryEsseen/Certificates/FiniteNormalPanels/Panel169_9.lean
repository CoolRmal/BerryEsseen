...
namespace FiniteNormalPanel169_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (5031 / 32000)
def radius : Rat := (5031 / 160000)

def j0 : Jet := ⟨⟨675249389, 675249390⟩, ⟨135049877, 135049878⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2121358519, 2121358524⟩, ⟨424271701, 424271705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1047775607, 1047775613⟩, ⟨419110240, 419110246⟩, ⟨41911023, 41911025⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨262, 263⟩, ⟨104, 105⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94425), (-94423)⟩, ⟨104, 105⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23036), (-23034)⟩, ⟨(-9190), (-9187)⟩, ⟨(-910), (-907)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5090020, 5090023⟩, ⟨(-9190), (-9187)⟩, ⟨(-910), (-907)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1241732, 1241733⟩, ⟨494450, 494453⟩, ⟨48550, 48553⟩, ⟨(-179), (-176)⟩, ⟨(-9), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-141923845), (-141923843)⟩, ⟨494450, 494453⟩, ⟨48550, 48553⟩, ⟨(-179), (-176)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-34622929), (-34622927)⟩, ⟨(-13728549), (-13728546)⟩, ⟨(-1324826), (-1324822)⟩, ⟨9517, 9521⟩, ⟨452, 456⟩⟩
...
def j19 : Jet := ⟨⟨1397032836, 1397032839⟩, ⟨(-13728549), (-13728546)⟩, ⟨(-1324826), (-1324822)⟩, ⟨9517, 9521⟩, ⟨452, 456⟩⟩
...
def j22 : Jet := ⟨⟨(-27), (-26)⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11808, 11810⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2880, 2882⟩, ⟨1149, 1151⟩, ⟨112, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849297), (-849294)⟩, ⟨1149, 1151⟩, ⟨112, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-207190), (-207188)⟩, ⟨(-82596), (-82594)⟩, ⟨(-8149), (-8145)⟩, ⟨20, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35584204, 35584207⟩, ⟨(-82596), (-82594)⟩, ⟨(-8149), (-8145)⟩, ⟨20, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8680918, 8680920⟩, ⟨3452217, 3452219⟩, ⟨337188, 337191⟩, ⟨(-1598), (-1593)⟩, ⟨(-80), (-75)⟩⟩
...
def j33 : Jet := ⟨⟨(-707146965), (-707146962)⟩, ⟨3452217, 3452219⟩, ⟨337188, 337191⟩, ⟨(-1598), (-1593)⟩, ⟨(-80), (-75)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-172511522), (-172511520)⟩, ⟨(-68162426), (-68162423)⟩, ⟨(-6481330), (-6481326)⟩, ⟨66200, 66204⟩, ⟨3114, 3118⟩⟩
...
def j36 : Jet := ⟨⟨4122455774, 4122455776⟩, ⟨(-68162426), (-68162423)⟩, ⟨(-6481330), (-6481326)⟩, ⟨66200, 66204⟩, ⟨3114, 3118⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨690018643, 690018647⟩, ⟨131222959, 131222965⟩, ⟨(-2010509), (-2010505)⟩, ⟨(-126171), (-126167)⟩, ⟨1163, 1167⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4474697868, 4474697871⟩, ⟨73986542, 73986547⟩, ⟨8258444, 8258451⟩, ⟨181007, 181016⟩, ⟨11401, 11411⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨718893704, 718893710⟩, ⟨148600708, 148600718⟩, ⟨1492627, 1492635⟩, ⟨115312, 115322⟩, ⟨2532, 2543⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-675249390), (-675249389)⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3619717906, 3619717907⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨120328775, 120328778⟩, ⟨49745716, 49745722⟩, ⟨5641077, 5641083⟩, ⟨141886, 141894⟩, ⟨9342, 9353⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4415296071, 4415296074⟩, ⟨49745716, 49745722⟩, ⟨5641077, 5641083⟩, ⟨141886, 141894⟩, ⟨9342, 9353⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4354716090, 4354716092⟩, ⟨24531590, 24531594⟩, ⟨2712741, 2712746⟩, ⟨54687, 54693⟩, ⟨3452, 3460⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3670073069, 3670073072⟩, ⟨(-116253841), (-116253835)⟩, ⟨1514881, 1514887⟩, ⟨(-39210), (-39203)⟩, ⟨1189, 1198⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨49347923976, 49347923984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value679

def j47 : Jet := ⟨⟨7758418916, 7758418929⟩, ⟨1551683774, 1551683786⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14014789852, 14014789900⟩, ⟨5605915906, 5605915962⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14014789852, 14014789900⟩, ⟨5605915906, 5605915962⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14014789900), (-14014789852)⟩, ⟨(-5605915962), (-5605915906)⟩, ⟨(-560591597), (-560591587)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7007394950), (-7007394926)⟩, ⟨(-2802957981), (-2802957953)⟩, ⟨(-280295799), (-280295793)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨840219307, 840219320⟩, ⟨(-548339321), (-548339306)⟩, ⟨124093159, 124093169⟩, ⟨(-3138056), (-3138051)⟩, ⟨(-3537266), (-3537264)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨717971997, 717972010⟩, ⟨(-491301554), (-491301537)⟩, ⟨121176786, 121176800⟩, ⟨(-6241451), (-6241441)⟩, ⟨(-2888670), (-2888660)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨540199511, 810299268⟩, ⟨135049877, 135049878⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1697086815, 2545630228⟩, ⟨424271701, 424271705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨670576388, 1508796881⟩, ⟨335288192, 502932294⟩, ⟨41911023, 41911025⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨167, 378⟩, ⟨83, 126⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94520), (-94308)⟩, ⟨83, 126⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-33205), (-14724)⟩, ⟨(-11057), (-7317)⟩, ⟨(-916), (-901)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5079851, 5098333⟩, ⟨(-11057), (-7317)⟩, ⟨(-916), (-901)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨793120, 1791015⟩, ⟨392675, 595863⟩, ⟨47953, 49040⟩, ⟨(-216), (-139)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142372457), (-141374561)⟩, ⟨392675, 595863⟩, ⟨47953, 49040⟩, ⟨(-216), (-139)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-50014612), (-22072913)⟩, ⟨(-16610230), (-10827132)⟩, ⟨(-1351155), (-1292554)⟩, ⟨7498, 11537⟩, ⟨437, 469⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1381641153, 1409582853⟩, ⟨(-16610230), (-10827132)⟩, ⟨(-1351155), (-1292554)⟩, ⟨7498, 11537⟩, ⟨437, 469⟩⟩
...
def j72 : Jet := ⟨⟨1841, 4153⟩, ⟨915, 1384⟩, ⟨112, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850336), (-848023)⟩, ⟨915, 1384⟩, ⟨112, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-298719), (-132402)⟩, ⟨(-99431), (-65714)⟩, ⟨(-8210), (-8071)⟩, ⟨15, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35492675, 35658993⟩, ⟨(-99431), (-65714)⟩, ⟨(-8210), (-8071)⟩, ⟨15, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5541497, 12526796⟩, ⟨2735818, 4165340⟩, ⟨331814, 341578⟩, ⟨(-1931), (-1261)⟩, ⟨(-81), (-73)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710286386), (-703301086)⟩, ⟨2735818, 4165340⟩, ⟨331814, 341578⟩, ⟨(-1931), (-1261)⟩, ⟨(-81), (-73)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-249519452), (-109806913)⟩, ⟨(-82746006), (-53440196)⟩, ⟨(-6665718), (-6255182)⟩, ⟨51920, 80450⟩, ⟨2981, 3225⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4045447844, 4185160383⟩, ⟨(-82746006), (-53440196)⟩, ⟨(-6665718), (-6255182)⟩, ⟨51920, 80450⟩, ⟨2981, 3225⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨545933140, 835460779⟩, ⟨126638388, 134965299⟩, ⟨(-2441647), (-1580272)⟩, ⟨(-130510), (-120844)⟩, ⟨912, 1418⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4407655235, 4559876876⟩, ⟨56281226, 93268191⟩, ⟨7306377, 9421066⟩, ⟨89757, 289811⟩, ⟨6756, 17483⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨560256899, 886991222⟩, ⟨137114929, 161432443⟩, ⟨(-4065), 3141726⟩, ⟨35256, 207703⟩, ⟨(-3752), 9744⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-810299268), (-540199511)⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3484668028, 3754767785⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨73082696, 183180308⟩, ⟨35771906, 66677650⟩, ⟨4375653, 7365320⟩, ⟨8890, 321964⟩, ⟨697, 21939⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4368049992, 4478147604⟩, ⟨35771906, 66677650⟩, ⟨4375653, 7365320⟩, ⟨8890, 321964⟩, ⟨697, 21939⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4331354506, 4385601157⟩, ⟨17516317, 33058750⟩, ⟨2018013, 3616304⟩, ⟨(-23195), 151469⟩, ⟨(-2321), 10585⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3514190335, 3834002173⟩, ⟨(-123688103), (-107293241)⟩, ⟨597797, 2610686⟩, ⟨(-133989), 68965⟩, ⟨(-6793), 9984⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6206735130, 9310102715⟩, ⟨1551683774, 1551683786⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8969465497, 20181297456⟩, ⟨4484732724, 6727099154⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8969465497, 20181297456⟩, ⟨4484732724, 6727099154⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20181297456), (-8969465497)⟩, ⟨(-6727099154), (-4484732724)⟩, ⟨(-560591597), (-560591587)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10090648728), (-4484732748)⟩, ⟨(-3363549577), (-2242366362)⟩, ⟨(-280295799), (-280295793)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨409848250, 1511739135⟩, ⟨(-1183899476), (-213978329)⟩, ⟨(-42800146), 436830696⟩, ⟨(-104723131), 62681464⟩, ⟨(-26526153), 21899751⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨335342427, 1349489002⟩, ⟨(-1100370967), (-185317946)⟩, ⟨(-32804075), 424960349⟩, ⟨(-106830342), 57181131⟩, ⟨(-25531729), 22871154⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨675249389, 675249390⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4354716090, 4354716092⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar679 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3420
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar679 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨540199511, 810299268⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4331354506, 4385601157⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3421
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((5031 / 40000) : ℝ)..(15093 / 80000), prawitzNormalCorrection
      ((32949 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
