...
namespace FiniteNormalPanel0_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (71613 / 400000)
def radius : Rat := (23871 / 400000)

def j0 : Jet := ⟨⟨768938732, 768938733⟩, ⟨256312910, 256312911⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2415692271, 2415692275⟩, ⟨805230755, 805230759⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1358699320, 1358699326⟩, ⟨905799544, 905799552⟩, ⟨150966590, 150966592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨340, 341⟩, ⟨226, 227⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94347), (-94345)⟩, ⟨226, 227⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-29847), (-29845)⟩, ⟨(-19827), (-19825)⟩, ⟨(-3259), (-3255)⟩, ⟨14, 17⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5083209, 5083212⟩, ⟨(-19827), (-19825)⟩, ⟨(-3259), (-3255)⟩, ⟨14, 17⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1608057, 1608059⟩, ⟨1065765, 1065768⟩, ⟨173460, 173464⟩, ⟨(-1381), (-1376)⟩, ⟨(-113), (-109)⟩⟩
...
def j16 : Jet := ⟨⟨(-141557520), (-141557517)⟩, ⟨1065765, 1065768⟩, ⟨173460, 173464⟩, ⟨(-1381), (-1376)⟩, ⟨(-113), (-109)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-44781274), (-44781272)⟩, ⟨(-29517032), (-29517028)⟩, ⟨(-4696058), (-4696052)⟩, ⟨73606, 73611⟩, ⟨5769, 5774⟩⟩
...
def j19 : Jet := ⟨⟨1386874491, 1386874494⟩, ⟨(-29517032), (-29517028)⟩, ⟨(-4696058), (-4696052)⟩, ⟨73606, 73611⟩, ⟨5769, 5774⟩⟩
...
def j22 : Jet := ⟨⟨(-35), (-33)⟩, ⟨(-23), (-22)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11800, 11803⟩, ⟨(-23), (-22)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3732, 3734⟩, ⟨2480, 2484⟩, ⟨407, 411⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848445), (-848442)⟩, ⟨2480, 2484⟩, ⟨407, 411⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-268403), (-268401)⟩, ⟨(-178152), (-178148)⟩, ⟨(-29172), (-29167)⟩, ⟨171, 175⟩, ⟨12, 15⟩⟩
...
def j30 : Jet := ⟨⟨35522991, 35522994⟩, ⟨(-178152), (-178148)⟩, ⟨(-29172), (-29167)⟩, ⟨171, 175⟩, ⟨12, 15⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11237585, 11237587⟩, ⟨7435365, 7435369⟩, ⟨1201819, 1201824⟩, ⟨(-12361), (-12356)⟩, ⟨(-987), (-983)⟩⟩
...
def j33 : Jet := ⟨⟨(-704590298), (-704590295)⟩, ⟨7435365, 7435369⟩, ⟨1201819, 1201824⟩, ⟨(-12361), (-12356)⟩, ⟨(-987), (-983)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-222894914), (-222894911)⟩, ⟨(-146244456), (-146244451)⟩, ⟨(-22817809), (-22817803)⟩, ⟨510900, 510906⟩, ⟨39323, 39329⟩⟩
...
def j36 : Jet := ⟨⟨4072072382, 4072072385⟩, ⟨(-146244456), (-146244451)⟩, ⟨(-22817809), (-22817803)⟩, ⟨510900, 510906⟩, ⟨39323, 39329⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨780043655, 780043659⟩, ⟨243412779, 243412784⟩, ⟨(-8175209), (-8175204)⟩, ⟨(-839030), (-839024)⟩, ⟨17043, 17049⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4530062908, 4530062913⟩, ⟨162692727, 162692734⟩, ⟨31227094, 31227103⟩, ⟨1464767, 1464778⟩, ⟨163418, 163431⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨822741265, 822741271⟩, ⟨286284514, 286284523⟩, ⟨6269144, 6269155⟩, ⟨841157, 841170⟩, ⟨39446, 39461⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-768938733), (-768938732)⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3526028563, 3526028564⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨157603805, 157603808⟩, ⟨109680966, 109680972⟩, ⟨21484351, 21484359⟩, ⟨1158010, 1158022⟩, ⟨136396, 136409⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4452571101, 4452571104⟩, ⟨109680966, 109680972⟩, ⟨21484351, 21484359⟩, ⟨1158010, 1158022⟩, ⟨136396, 136409⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4373059256, 4373059259⟩, ⟨53861168, 53861172⟩, ⟨10218653, 10218659⟩, ⟨442805, 442813⟩, ⟨49585, 49594⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3590139524, 3590139528⟩, ⟨(-216754977), (-216754970)⟩, ⟨5174881, 5174888⟩, ⟨(-246297), (-246287)⟩, ⟨14281, 14291⟩⟩
...
def j47 : Jet := ⟨⟨2256196959, 2256196963⟩, ⟨752065651, 752065655⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1185206863, 1185206868⟩, ⟨790137906, 790137914⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1185206863, 1185206868⟩, ⟨790137906, 790137914⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1185206868), (-1185206863)⟩, ⟨(-790137914), (-790137906)⟩, ⟨(-131689653), (-131689650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-592603434), (-592603431)⟩, ⟨(-395068957), (-395068953)⟩, ⟨(-65844827), (-65844825)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3741429291, 3741429296⟩, ⟨(-344152230), (-344152225)⟩, ⟨(-41530430), (-41530426)⟩, ⟨4790775, 4790776⟩, ⟨208176, 208177⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3127440152, 3127440160⟩, ⟨(-476494420), (-476494407)⟩, ⟨(-12838721), (-12838708)⟩, ⟨5471291, 5471306⟩, ⟨(-85630), (-85613)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨512625821, 1025251644⟩, ⟨256312910, 256312911⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1610461513, 3220923033⟩, ⟨805230755, 805230759⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨603866364, 2415465467⟩, ⟨603866362, 1207732736⟩, ⟨150966590, 150966592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨151, 606⟩, ⟨151, 303⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94536), (-94080)⟩, ⟨151, 303⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-53167), (-13227)⟩, ⟨(-26563), (-13056)⟩, ⟨(-3297), (-3198)⟩, ⟨10, 22⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5059889, 5099830⟩, ⟨(-26563), (-13056)⟩, ⟨(-3297), (-3198)⟩, ⟨10, 22⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨711413, 2868116⟩, ⟨696474, 1432223⟩, ⟨168528, 176974⟩, ⟨(-1861), (-894)⟩, ⟨(-115), (-103)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142454164), (-140297460)⟩, ⟨696474, 1432223⟩, ⟨168528, 176974⟩, ⟨(-1861), (-894)⟩, ⟨(-115), (-103)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-80115422), (-19725625)⟩, ⟨(-39959788), (-18920150)⟩, ⟨(-4885597), (-4429138)⟩, ⟨47127, 99983⟩, ⟨5334, 6082⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1351540343, 1411930141⟩, ⟨(-39959788), (-18920150)⟩, ⟨(-4885597), (-4429138)⟩, ⟨47127, 99983⟩, ⟨5334, 6082⟩⟩
...
def j70 : Jet := ⟨⟨(-61), (-15)⟩, ⟨(-31), (-15)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11774, 11821⟩, ⟨(-31), (-15)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1655, 6649⟩, ⟨1637, 3323⟩, ⟨401, 414⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850522), (-845527)⟩, ⟨1637, 3323⟩, ⟨401, 414⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-478329), (-118879)⟩, ⟨(-238935), (-117010)⟩, ⟨(-29610), (-28551)⟩, ⟨110, 234⟩, ⟨11, 15⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35313065, 35672516⟩, ⟨(-238935), (-117010)⟩, ⟨(-29610), (-28551)⟩, ⟨110, 234⟩, ⟨11, 15⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨4964967, 20062023⟩, ⟨4830591, 10014561⟩, ⟨1157400, 1233412⟩, ⟨(-16711), (-7994)⟩, ⟨(-1025), (-928)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710862916), (-695765859)⟩, ⟨4830591, 10014561⟩, ⟨1157400, 1233412⟩, ⟨(-16711), (-7994)⟩, ⟨(-1025), (-928)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-399785309), (-97823701)⟩, ⟨(-199213481), (-92191568)⟩, ⟨(-24144680), (-20946194)⟩, ⟨323122, 697718⟩, ⟨35405, 42101⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3895181987, 4197143595⟩, ⟨(-199213481), (-92191568)⟩, ⟨(-24144680), (-20946194)⟩, ⟨323122, 697718⟩, ⟨35405, 42101⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨506780041, 1058848182⟩, ⟨223422992, 257617656⟩, ⟨(-11155611), (-5207965)⟩, ⟨(-898294), (-755404)⟩, ⟨10835, 23308⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4395070994, 4735784910⟩, ⟨96539104, 242204909⟩, ⟨24054478, 41742466⟩, ⟨222889, 3271602⟩, ⟨37171, 378112⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨518591669, 1167523964⟩, ⟨240021385, 343769798⟩, ⟨(-4440358), 19489281⟩, ⟨(-341982), 2420253⟩, ⟨(-132013), 269007⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1025251644), (-512625821)⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3269715652, 3782341475⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨62616849, 317374293⟩, ⟨57962298, 186897572⟩, ⟨10999341, 38111136⟩, ⟨(-896740), 4435672⟩, ⟨(-146668), 622125⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4357584145, 4612341589⟩, ⟨57962298, 186897572⟩, ⟨10999341, 38111136⟩, ⟨(-896740), 4435672⟩, ⟨(-146668), 622125⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4326162432, 4450826472⟩, ⟨27966286, 92774945⟩, ⟨4340162, 18827769⟩, ⟨(-848901), 2173788⟩, ⟨(-160393), 324848⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3293464197, 3919598080⟩, ⟨(-244323744), (-176472765)⟩, ⟨(-2232456), 14911623⟩, ⟨(-1871176), 1655326⟩, ⟨(-270977), 336737⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1504131305, 3008262617⟩, ⟨752065651, 752065655⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨526758605, 2107034432⟩, ⟨526758604, 1053517218⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨526758605, 2107034432⟩, ⟨526758604, 1053517218⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2107034432), (-526758605)⟩, ⟨(-1053517218), (-526758604)⟩, ⟨(-131689653), (-131689650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1053517216), (-263379302)⟩, ⟨(-526758609), (-263379302)⟩, ⟨(-65844827), (-65844825)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3360711976, 4039500997⟩, ⟨(-495426806), (-206088175)⟩, ⟨(-55609403), (-21141097)⟩, ⟨2538459, 7336907⟩, ⟨(-62906), 387350⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2577059103, 3686458886⟩, ⟨(-681919039), (-296118240)⟩, ⟨(-44381146), 25996148⟩, ⟨(-664752), 11673463⟩, ⟨(-1113650), 810652⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨768938732, 768938733⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4373059256, 4373059259⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified4
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨512625821, 1025251644⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4326162432, 4450826472⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified5
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (46598023 / 536870912)

theorem envelope_integral : (∫ s in ((23871 / 200000) : ℝ)..(23871 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((23871 / 200000) : ℝ)..(23871 / 100000), prawitzNormalCorrection
