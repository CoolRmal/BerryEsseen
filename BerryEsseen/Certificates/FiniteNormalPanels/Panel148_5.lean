...
namespace FiniteNormalPanel148_5

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (26807 / 160000)
def radius : Rat := (26807 / 800000)

def j0 : Jet := ⟨⟨719594926, 719594927⟩, ⟨143918985, 143918986⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2260674132, 2260674137⟩, ⟨452134825, 452134830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1189915354, 1189915360⟩, ⟨475966140, 475966148⟩, ⟨47596613, 47596615⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨297, 299⟩, ⟨119, 120⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94390), (-94387)⟩, ⟨119, 120⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-26151), (-26149)⟩, ⟨(-10429), (-10425)⟩, ⟨(-1031), (-1027)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5086905, 5086908⟩, ⟨(-10429), (-10425)⟩, ⟨(-1031), (-1027)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1409320, 1409322⟩, ⟨560838, 560841⟩, ⟨54930, 54934⟩, ⟨(-231), (-226)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-141756257), (-141756254)⟩, ⟨560838, 560841⟩, ⟨54930, 54934⟩, ⟨(-231), (-226)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-39273396), (-39273394)⟩, ⟨(-15553980), (-15553976)⟩, ⟨(-1493567), (-1493562)⟩, ⟨12238, 12242⟩, ⟨578, 582⟩⟩
...
def j19 : Jet := ⟨⟨1392382369, 1392382372⟩, ⟨(-15553980), (-15553976)⟩, ⟨(-1493567), (-1493562)⟩, ⟨12238, 12242⟩, ⟨578, 582⟩⟩
...
def j22 : Jet := ⟨⟨(-30), (-29)⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11805, 11807⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3270, 3272⟩, ⟨1304, 1306⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848907), (-848904)⟩, ⟨1304, 1306⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-235189), (-235187)⟩, ⟨(-93715), (-93713)⟩, ⟨(-9229), (-9225)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35556205, 35556208⟩, ⟨(-93715), (-93713)⟩, ⟨(-9229), (-9225)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9850802, 9850804⟩, ⟨3914356, 3914359⟩, ⟨381089, 381093⟩, ⟨(-2055), (-2051)⟩, ⟨(-102), (-97)⟩⟩
...
def j33 : Jet := ⟨⟨(-705977081), (-705977078)⟩, ⟨3914356, 3914359⟩, ⟨381089, 381093⟩, ⟨(-2055), (-2051)⟩, ⟨(-102), (-97)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-195590075), (-195590072)⟩, ⟨(-77151564), (-77151559)⟩, ⟨(-7284238), (-7284232)⟩, ⟨85040, 85044⟩, ⟨3966, 3971⟩⟩
...
def j36 : Jet := ⟨⟨4099377221, 4099377224⟩, ⟨(-77151564), (-77151559)⟩, ⟨(-7284238), (-7284232)⟩, ⟨85040, 85044⟩, ⟨3966, 3971⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨732886326, 732886330⟩, ⟨138390361, 138390367⟩, ⟨(-2423527), (-2423522)⟩, ⟨(-150789), (-150784)⟩, ⟨1592, 1596⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4499889389, 4499889393⟩, ⟨84689322, 84689330⟩, ⟨9589785, 9589795⟩, ⟨237613, 237622⟩, ⟨15395, 15405⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨767853903, 767853908⟩, ⟨159444510, 159444521⟩, ⟨1826044, 1826054⟩, ⟨143770, 143781⟩, ⟨3563, 3575⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-719594927), (-719594926)⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3575372369, 3575372370⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨137276858, 137276860⟩, ⟨57010952, 57010958⟩, ⟨6572067, 6572074⟩, ⟨186984, 186992⟩, ⟨12722, 12733⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4432244154, 4432244156⟩, ⟨57010952, 57010958⟩, ⟨6572067, 6572074⟩, ⟨186984, 186992⟩, ⟨12722, 12733⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4363065858, 4363065860⟩, ⟨28060563, 28060567⟩, ⟨3144510, 3144515⟩, ⟨71808, 71814⟩, ⟨4665, 4673⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3632061442, 3632061446⟩, ⟨(-122841693), (-122841687)⟩, ⟨1677392, 1677398⟩, ⟨(-45592), (-45585)⟩, ⟨1476, 1485⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨40777579596, 40777579603⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value607

def j47 : Jet := ⟨⟨6832028592, 6832028604⟩, ⟨1366405716, 1366405727⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10867746239, 10867746279⟩, ⟨4347098488, 4347098532⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10867746239, 10867746279⟩, ⟨4347098488, 4347098532⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10867746279), (-10867746239)⟩, ⟨(-4347098532), (-4347098488)⟩, ⟨(-434709856), (-434709848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5433873140), (-5433873119)⟩, ⟨(-2173549266), (-2173549244)⟩, ⟨(-217354928), (-217354924)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1211999839, 1211999857⟩, ⟨(-613355404), (-613355388)⟩, ⟨93864492, 93864502⟩, ⟨4859370, 4859374⟩, ⟨(-2989890), (-2989888)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1024933970, 1024933987⟩, ⟨(-553351975), (-553351956)⟩, ⟨97393107, 97393121⟩, ⟨1172291, 1172301⟩, ⟨(-2623819), (-2623808)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨575675941, 863513913⟩, ⟨143918985, 143918986⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1808539307, 2712808966⟩, ⟨452134825, 452134830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨761545827, 1713478120⟩, ⟨380772912, 571159378⟩, ⟨47596613, 47596615⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨190, 430⟩, ⟨95, 144⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94497), (-94256)⟩, ⟨95, 144⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-37700), (-16712)⟩, ⟨(-12551), (-8298)⟩, ⟨(-1039), (-1019)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5075356, 5096345⟩, ⟨(-12551), (-8298)⟩, ⟨(-1039), (-1019)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨899917, 2033188⟩, ⟨444950, 676259⟩, ⟨54159, 55563⟩, ⟨(-279), (-179)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142265660), (-141132388)⟩, ⟨444950, 676259⟩, ⟨54159, 55563⟩, ⟨(-279), (-179)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-56756916), (-25024353)⟩, ⟨(-18840078), (-12242382)⟩, ⟨(-1527533), (-1451923)⟩, ⟨9619, 14853⟩, ⟨557, 600⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1374898849, 1406631413⟩, ⟨(-18840078), (-12242382)⟩, ⟨(-1527533), (-1451923)⟩, ⟨9619, 14853⟩, ⟨557, 600⟩⟩
...
def j70 : Jet := ⟨⟨(-44), (-18)⟩, ⟨(-15), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11791, 11818⟩, ⟨(-15), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2090, 4715⟩, ⟨1039, 1571⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850087), (-847461)⟩, ⟨1039, 1571⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-339143), (-150264)⟩, ⟨(-112864), (-74505)⟩, ⟨(-9307), (-9129)⟩, ⟨21, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35452251, 35641131⟩, ⟨(-112864), (-74505)⟩, ⟨(-9307), (-9129)⟩, ⟨21, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6286081, 14219037⟩, ⟨3098012, 4726469⟩, ⟨374156, 386751⟩, ⟨(-2486), (-1619)⟩, ⟨(-104), (-95)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709541802), (-701608845)⟩, ⟨3098012, 4726469⟩, ⟨374156, 386751⟩, ⟨(-2486), (-1619)⟩, ⟨(-104), (-95)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-283071854), (-124403109)⟩, ⟨(-93807974), (-60315928)⟩, ⟨(-7522110), (-6992357)⟩, ⟨66511, 103524⟩, ⟨3773, 4127⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4011895442, 4170564187⟩, ⟨(-93807974), (-60315928)⟩, ⟨(-7522110), (-6992357)⟩, ⟨66511, 103524⟩, ⟨3773, 4127⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨578947042, 888463648⟩, ⟨132836893, 142922213⟩, ⟨(-2948140), (-1900145)⟩, ⟨(-156755), (-143463)⟩, ⟨1246, 1943⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4423081205, 4598012172⟩, ⟨63967903, 107512824⟩, ⟨8340847, 11134967⟩, ⟨113739, 388618⟩, ⟨8408, 24746⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨596216362, 951151985⟩, ⟨145421919, 175246809⟩, ⟨(-53408), 3924242⟩, ⟨31685, 274884⟩, ⟨(-5635), 14306⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-863513913), (-575675941)⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3431453383, 3719291355⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨82765228, 210639578⟩, ⟨40374196, 77619382⟩, ⟨4900138, 8888672⟩, ⟨4436, 441994⟩, ⟨(-401), 32358⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4377732524, 4505606874⟩, ⟨40374196, 77619382⟩, ⟨4900138, 8888672⟩, ⟨4436, 441994⟩, ⟨(-401), 32358⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4336152444, 4399026503⟩, ⟨19709571, 38441074⟩, ⟨2224152, 4357330⟩, ⟨(-36433), 208789⟩, ⟨(-4240), 15780⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3464358154, 3809402987⟩, ⟨(-131658968), (-112010422)⟩, ⟨488867, 3112853⟩, ⟨(-177559), 106276⟩, ⟨(-10669), 14886⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5465622876, 8198434330⟩, ⟨1366405716, 1366405727⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6955357599, 15649554661⟩, ⟨3477678792, 5216518242⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6955357599, 15649554661⟩, ⟨3477678792, 5216518242⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15649554661), (-6955357599)⟩, ⟨(-5216518242), (-3477678792)⟩, ⟨(-434709856), (-434709848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7824777331), (-3477678799)⟩, ⟨(-2608259121), (-1738839396)⟩, ⟨(-217354928), (-217354924)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨694610509, 1911204648⟩, ⟨(-1160641424), (-281216604)⟩, ⟨(-39794132), 317266625⟩, ⟨(-54735842), 47213063⟩, ⟨(-15195857), 9316961⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨560278906, 1695134839⟩, ⟨(-1088012509), (-244946836)⟩, ⟨(-27882199), 318362049⟩, ⟨(-59193499), 43110569⟩, ⟨(-14987492), 10226078⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨719594926, 719594927⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨143918985, 143918986⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4363065858, 4363065860⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar607 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2978
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar607 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨575675941, 863513913⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4336152444, 4399026503⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2979
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26807 / 200000) : ℝ)..(80421 / 400000), prawitzNormalCorrection
      ((245141 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
