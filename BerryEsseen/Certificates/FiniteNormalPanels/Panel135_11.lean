...
namespace FiniteNormalPanel135_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (28069 / 160000)
def radius : Rat := (28069 / 800000)

def j0 : Jet := ⟨⟨753471481, 753471482⟩, ⟨150694296, 150694297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2367100469, 2367100473⟩, ⟨473420093, 473420097⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1304588427, 1304588432⟩, ⟨521835370, 521835376⟩, ⟨52183536, 52183538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨326, 327⟩, ⟨130, 131⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94361), (-94359)⟩, ⟨130, 131⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-28662), (-28661)⟩, ⟨(-11426), (-11424)⟩, ⟨(-1129), (-1125)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5084394, 5084396⟩, ⟨(-11426), (-11424)⟩, ⟨(-1129), (-1125)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1544375, 1544376⟩, ⟨614279, 614281⟩, ⟨60043, 60047⟩, ⟨(-277), (-272)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-141621202), (-141621200)⟩, ⟨614279, 614281⟩, ⟨60043, 60047⟩, ⟨(-277), (-272)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-43017181), (-43017179)⟩, ⟨(-17020287), (-17020284)⟩, ⟨(-1627817), (-1627812)⟩, ⟨14673, 14678⟩, ⟨690, 694⟩⟩
...
def j19 : Jet := ⟨⟨1388638584, 1388638587⟩, ⟨(-17020287), (-17020284)⟩, ⟨(-1627817), (-1627812)⟩, ⟨14673, 14678⟩, ⟨690, 694⟩⟩
...
def j25 : Jet := ⟨⟨3584, 3586⟩, ⟨1428, 1432⟩, ⟨140, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848593), (-848590)⟩, ⟨1428, 1432⟩, ⟨140, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-257759), (-257757)⟩, ⟨(-102671), (-102668)⟩, ⟨(-10096), (-10092)⟩, ⟨33, 36⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35533635, 35533638⟩, ⟨(-102671), (-102668)⟩, ⟨(-10096), (-10092)⟩, ⟨33, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10793276, 10793278⟩, ⟨4286123, 4286126⟩, ⟨416189, 416193⟩, ⟨(-2465), (-2462)⟩, ⟨(-120), (-116)⟩⟩
...
def j33 : Jet := ⟨⟨(-705034607), (-705034604)⟩, ⟨4286123, 4286126⟩, ⟨416189, 416193⟩, ⟨(-2465), (-2462)⟩, ⟨(-120), (-116)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-214152968), (-214152965)⟩, ⟨(-84359287), (-84359283)⟩, ⟨(-7918943), (-7918938)⟩, ⟨101893, 101898⟩, ⟨4719, 4723⟩⟩
...
def j36 : Jet := ⟨⟨4080814328, 4080814331⟩, ⟨(-84359287), (-84359283)⟩, ⟨(-7918943), (-7918938)⟩, ⟨101893, 101898⟩, ⟨4719, 4723⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨765325278, 765325282⟩, ⟨143684604, 143684609⟩, ⟨(-2773236), (-2773230)⟩, ⟨(-171343), (-171338)⟩, ⟨1997, 2001⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4520358579, 4520358584⟩, ⟨93445615, 93445622⟩, ⟨10703609, 10703618⟩, ⟨289726, 289735⟩, ⟨19194, 19203⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨805488016, 805488022⟩, ⟨167876068, 167876076⟩, ⟨2114664, 2114675⟩, ⟨169033, 169044⟩, ⟨4573, 4584⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-753471482), (-753471481)⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3541495814, 3541495815⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨151063069, 151063072⟩, ⟨62967724, 62967730⟩, ⟨7354896, 7354905⟩, ⟨228710, 228718⟩, ⟨15967, 15978⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4446030365, 4446030368⟩, ⟨62967724, 62967730⟩, ⟨7354896, 7354905⟩, ⟨228710, 228718⟩, ⟨15967, 15978⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4369846108, 4369846111⟩, ⟨30944375, 30944379⟩, ⟨3504869, 3504875⟩, ⟨87576, 87582⟩, ⟨5819, 5828⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3603238542, 3603238546⟩, ⟨(-127805750), (-127805744)⟩, ⟨1804282, 1804289⟩, ⟨(-50761), (-50754)⟩, ⟨1725, 1734⟩⟩
...
def j47 : Jet := ⟨⟨6738528642, 6738528653⟩, ⟨1347705726, 1347705736⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10572319910, 10572319946⟩, ⟨4228927956, 4228927996⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10572319910, 10572319946⟩, ⟨4228927956, 4228927996⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10572319946), (-10572319910)⟩, ⟨(-4228927996), (-4228927956)⟩, ⟨(-422892802), (-422892794)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5286159973), (-5286159955)⟩, ⟨(-2114463998), (-2114463978)⟩, ⟨(-211446401), (-211446397)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1254408202, 1254408218⟩, ⟨(-617560236), (-617560222)⟩, ⟨90260132, 90260141⟩, ⟨5456770, 5456774⟩, ⟨(-2893417), (-2893415)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1052378672, 1052378687⟩, ⟨(-555426216), (-555426200)⟩, ⟨94626991, 94627005⟩, ⟨1617786, 1617796⟩, ⟨(-2544077), (-2544067)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨602777185, 904165778⟩, ⟨150694296, 150694297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1893680376, 2840520566⟩, ⟨473420093, 473420097⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨834936594, 1878607340⟩, ⟨417468296, 626202452⟩, ⟨52183536, 52183538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨208, 471⟩, ⟨104, 157⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94479), (-94215)⟩, ⟨104, 157⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-41325), (-18315)⟩, ⟨(-13755), (-9088)⟩, ⟨(-1136), (-1114)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5071731, 5094742⟩, ⟨(-13755), (-9088)⟩, ⟨(-1136), (-1114)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨985938, 2228427⟩, ⟨486952, 741043⟩, ⟨59118, 60802⟩, ⟨(-334), (-215)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142179639), (-140937149)⟩, ⟨486952, 741043⟩, ⟨59118, 60802⟩, ⟨(-334), (-215)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-62188999), (-27398016)⟩, ⟨(-20635005), (-13374877)⟩, ⟨(-1668650), (-1577736)⟩, ⟨11515, 17828⟩, ⟨662, 717⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1369466766, 1404257750⟩, ⟨(-20635005), (-13374877)⟩, ⟨(-1668650), (-1577736)⟩, ⟨11515, 17828⟩, ⟨662, 717⟩⟩
...
def j72 : Jet := ⟨⟨2291, 5169⟩, ⟨1138, 1722⟩, ⟨139, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849886), (-847007)⟩, ⟨1138, 1722⟩, ⟨139, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-371738), (-164657)⟩, ⟨(-123692), (-81574)⟩, ⟨(-10190), (-9976)⟩, ⟨25, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35419656, 35626738⟩, ⟨(-123692), (-81574)⟩, ⟨(-10190), (-9976)⟩, ⟨25, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6885539, 15583042⟩, ⟨3388666, 5178491⟩, ⟨407853, 422996⟩, ⟨(-2985), (-1941)⟩, ⟨(-123), (-113)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708942344), (-700244840)⟩, ⟨3388666, 5178491⟩, ⟨407853, 422996⟩, ⟨(-2985), (-1941)⟩, ⟨(-123), (-113)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-310089507), (-136126773)⟩, ⟨(-102704418), (-65798327)⟩, ⟨(-8204936), (-7567885)⟩, ⟨79509, 124215⟩, ⟨4465, 4931⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3984877789, 4158840523⟩, ⟨(-102704418), (-65798327)⟩, ⟨(-8204936), (-7567885)⟩, ⟨79509, 124215⟩, ⟨4465, 4931⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨603807238, 928720231⟩, ⟨137304637, 148889633⟩, ⟨(-3378108), (-2169902)⟩, ⟨(-178853), (-162117)⟩, ⟨1560, 2441⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4435549757, 4629186904⟩, ⟨70176230, 119310548⟩, ⟨9181695, 12606637⟩, ⟨134703, 482082⟩, ⟨9785, 32014⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨623570999, 1000990051⟩, ⟨151664592, 186274775⟩, ⟨(-106730), 4621092⟩, ⟨25852, 338389⟩, ⟨(-7593), 18980⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-904165778), (-602777185)⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3390801518, 3692190111⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨90534051, 233291901⟩, ⟨44039282, 86826830⟩, ⟨5305855, 10232822⟩, ⟨(-1752), 558570⟩, ⟨(-1831), 43174⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4385501347, 4528259197⟩, ⟨44039282, 86826830⟩, ⟨5305855, 10232822⟩, ⟨(-1752), 558570⟩, ⟨(-1831), 43174⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4339998255, 4410070880⟩, ⟨21444924, 42962967⟩, ⟨2374412, 5010343⟩, ⟨(-50466), 264656⟩, ⟨(-6419), 21214⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3426352672, 3791139483⟩, ⟨(-137802459), (-115340933)⟩, ⟨367146, 3554746⟩, ⟨(-219179), 144204⟩, ⟨(-14805), 20008⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5390822915, 8086234380⟩, ⟨1347705726, 1347705736⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6766284746, 15224140708⟩, ⟨3383142366, 5074713592⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6766284746, 15224140708⟩, ⟨3383142366, 5074713592⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15224140708), (-6766284746)⟩, ⟨(-5074713592), (-3383142366)⟩, ⟨(-422892802), (-422892794)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7612070354), (-3383142373)⟩, ⟨(-2537356796), (-1691571183)⟩, ⟨(-211446401), (-211446397)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨729876962, 1953738520⟩, ⟨(-1154218734), (-287461754)⟩, ⟨(-39576547), 305008731⟩, ⟨(-50629061), 45675988⟩, ⟨(-14254025), 8451789⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨582266570, 1724552187⟩, ⟨(-1081506300), (-248926234)⟩, ⟨(-27151811), 307878916⟩, ⟨(-55531032), 41628720⟩, ⟨(-14125678), 9405200⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨753471481, 753471482⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4369846108, 4369846111⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2718
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨602777185, 904165778⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4339998255, 4410070880⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2719
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (38096723 / 2147483648)

theorem envelope_integral : (∫ s in ((28069 / 200000) : ℝ)..(84207 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((28069 / 200000) : ℝ)..(84207 / 400000), prawitzNormalCorrection
