...
namespace FiniteNormalPanel106_15
...
def j2 : Jet := ⟨⟨487739579, 487739583⟩, ⟨487739579, 487739583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨55388057, 55388059⟩, ⟨110776114, 110776118⟩, ⟨55388057, 55388059⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1221), (-1220)⟩, ⟨(-2442), (-2440)⟩, ⟨(-1221), (-1218)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111835, 5111837⟩, ⟨(-2442), (-2440)⟩, ⟨(-1221), (-1218)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨65922, 65923⟩, ⟨131812, 131814⟩, ⟨65843, 65846⟩, ⟨(-64), (-61)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-143099655), (-143099653)⟩, ⟨131812, 131814⟩, ⟨65843, 65846⟩, ⟨(-64), (-61)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1845419), (-1845418)⟩, ⟨(-3689139), (-3689136)⟩, ⟨(-1841171), (-1841168)⟩, ⟨3396, 3399⟩, ⟨846, 849⟩⟩
...
def j19 : Jet := ⟨⟨1429810346, 1429810348⟩, ⟨(-3689139), (-3689136)⟩, ⟨(-1841171), (-1841168)⟩, ⟨3396, 3399⟩, ⟨846, 849⟩⟩
...
def j25 : Jet := ⟨⟨152, 153⟩, ⟨304, 306⟩, ⟨150, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852025), (-852023)⟩, ⟨304, 306⟩, ⟨150, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10988), (-10987)⟩, ⟨(-21973), (-21971)⟩, ⟨(-10980), (-10977)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780406, 35780408⟩, ⟨(-21973), (-21971)⟩, ⟨(-10980), (-10977)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨461425, 461426⟩, ⟨922566, 922568⟩, ⟨460716, 460719⟩, ⟨(-568), (-565)⟩, ⟨(-143), (-139)⟩⟩
...
def j33 : Jet := ⟨⟨(-715366458), (-715366456)⟩, ⟨922566, 922568⟩, ⟨460716, 460719⟩, ⟨(-568), (-565)⟩, ⟨(-143), (-139)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9225393), (-9225392)⟩, ⟨(-18438889), (-18438886)⟩, ⟨(-9195658), (-9195655)⟩, ⟨23771, 23774⟩, ⟨5924, 5927⟩⟩
...
def j36 : Jet := ⟨⟨4285741903, 4285741904⟩, ⟨(-18438889), (-18438886)⟩, ⟨(-9195658), (-9195655)⟩, ⟨23771, 23774⟩, ⟨5924, 5927⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨162370292, 162370295⟩, ⟨161951350, 161951355⟩, ⟨(-628027), (-628024)⟩, ⟨(-208700), (-208698)⟩, ⟨481, 483⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304212546, 4304212548⟩, ⟨18518353, 18518358⟩, ⟨9314958, 9314964⟩, ⟨55932, 55939⟩, ⟨14170, 14178⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨162719806, 162719810⟩, ⟨163000044, 163000051⟩, ⟨421045, 421053⟩, ⟨141497, 141503⟩, ⟨863, 870⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-155252331), (-155252330)⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4139714965, 4139714966⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6164828, 6164829⟩, ⟨12350890, 12350892⟩, ⟨6217982, 6217988⟩, ⟨42678, 42684⟩, ⟨10845, 10850⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301132124, 4301132125⟩, ⟨12350890, 12350892⟩, ⟨6217982, 6217988⟩, ⟨42678, 42684⟩, ⟨10845, 10850⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298048604, 4298048606⟩, ⟨6171017, 6171019⟩, ⟨3102331, 3102336⟩, ⟨16868, 16873⟩, ⟨4273, 4278⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4142684891, 4142684895⟩, ⟨(-149415763), (-149415758)⟩, ⟨2767122, 2767129⟩, ⟨(-95884), (-95877)⟩, ⟨3508, 3515⟩⟩
...
def j47 : Jet := ⟨⟨1348497259, 1348497269⟩, ⟨1348497259, 1348497269⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨423389686, 423389693⟩, ⟨846779372, 846779386⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨423389686, 423389693⟩, ⟨846779372, 846779386⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-423389693), (-423389686)⟩, ⟨(-846779386), (-846779372)⟩, ⟨(-423389693), (-423389686)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-211694847), (-211694843)⟩, ⟨(-423389693), (-423389686)⟩, ⟨(-211694847), (-211694843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4088404897, 4088404902⟩, ⟨(-403027166), (-403027158)⟩, ⟨(-181648760), (-181648753)⟩, ⟨19212078, 19212080⟩, ⟨4003174, 4003175⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3943446370, 3943446380⟩, ⟨(-530967185), (-530967170)⟩, ⟨(-158553444), (-158553426)⟩, ⟨24499260, 24499275⟩, ⟨3088179, 3088193⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 310504661⟩, ⟨155252330, 155252331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 975479162⟩, ⟨487739579, 487739583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 221552234⟩, ⟨0, 221552236⟩, ⟨55388057, 55388059⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4885), 0⟩, ⟨(-4885), 3⟩, ⟨(-1222), (-1216)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108171, 5113057⟩, ⟨(-4885), 3⟩, ⟨(-1222), (-1216)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 263753⟩, ⟨(-252), 263754⟩, ⟨65559, 65940⟩, ⟨(-127), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142901823)⟩, ⟨(-252), 263754⟩, ⟨65559, 65940⟩, ⟨(-127), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7385075), 0⟩, ⟨(-7385088), 13606⟩, ⟨(-1846282), (-1825859)⟩, ⟨(-11), 6805⟩, ⟨837, 852⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424270690, 1431655766⟩, ⟨(-7385088), 13606⟩, ⟨(-1846282), (-1825859)⟩, ⟨(-11), 6805⟩, ⟨837, 852⟩⟩
...
def j72 : Jet := ⟨⟨0, 611⟩, ⟨(-1), 611⟩, ⟨150, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851565)⟩, ⟨(-1), 611⟩, ⟨150, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-43959), 0⟩, ⟨(-43960), 32⟩, ⟨(-10991), (-10941)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35747435, 35791395⟩, ⟨(-43960), 32⟩, ⟨(-10991), (-10941)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1846269⟩, ⟨(-2268), 1846271⟩, ⟨458165, 461570⟩, ⟨(-1135), 2⟩, ⟨(-144), (-139)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713981613)⟩, ⟨(-2268), 1846271⟩, ⟨458165, 461570⟩, ⟨(-1135), 2⟩, ⟨(-144), (-139)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-36925373), 0⟩, ⟨(-36925490), 95239⟩, ⟨(-9231461), (-9088484)⟩, ⟨(-89), 47621⟩, ⟨5841, 5954⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4258041923, 4294967296⟩, ⟨(-36925490), 95239⟩, ⟨(-9231461), (-9088484)⟩, ⟨(-89), 47621⟩, ⟨5841, 5954⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 325159721⟩, ⟨160063893, 162582953⟩, ⟨(-1257987), 1546⟩, ⟨(-209669), (-205799)⟩, ⟨(-2), 967⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4332212883⟩, ⟨(-96899), 37568697⟩, ⟨9087650, 9718059⟩, ⟨(-48880), 165815⟩, ⟨12386, 16618⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 327979479⟩, ⟨160056557, 166837078⟩, ⟨(-1272566), 2159424⟩, ⟨112483, 174655⟩, ⟨(-6536), 8521⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-310504661), 0⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3984462635, 4294967296⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 25045718⟩, ⟨0, 25480586⟩, ⟨5770323, 6810555⟩, ⟨(-98866), 194442⟩, ⟨6742, 15958⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4320013014⟩, ⟨0, 25480586⟩, ⟨5770323, 6810555⟩, ⟨(-98866), 194442⟩, ⟨6742, 15958⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307471952⟩, ⟨0, 12740293⟩, ⟨2857944, 3405278⟩, ⟨(-59535), 97221⟩, ⟨1726, 7206⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3984462635, 4307471952⟩, ⟨(-155704344), (-142512037)⟩, ⟨2190798, 3405278⟩, ⟨(-182628), (-6086)⟩, ⟨(-1914), 9359⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2696994529⟩, ⟨1348497259, 1348497269⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1693558761⟩, ⟨0, 1693558766⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1693558761⟩, ⟨0, 1693558766⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1693558761), 0⟩, ⟨(-1693558766), 0⟩, ⟨(-423389693), (-423389686)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-846779381), 0⟩, ⟨(-846779383), 0⟩, ⟨(-211694847), (-211694843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3526436081, 4294967296⟩, ⟨(-846779383), 0⟩, ⟨(-211694847), (-90340774)⟩, ⟨0, 41736950⟩, ⟨169230, 5217119⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3271492384, 4307471952⟩, ⟨(-1004949098), (-117011272)⟩, ⟨(-210512409), (-49706233)⟩, ⟨2143612, 49527989⟩, ⟨(-1525841), 5231594⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298048604, 4298048606⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2142
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307471952⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2143
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (281346227 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(14459 / 200000), prawitzNormalCorrection
