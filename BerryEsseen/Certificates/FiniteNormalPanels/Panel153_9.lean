...
namespace FiniteNormalPanel153_9
...
def j2 : Jet := ⟨⟨449351886, 449351891⟩, ⟨449351886, 449351891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨47012492, 47012494⟩, ⟨94024984, 94024988⟩, ⟨47012492, 47012494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1037), (-1036)⟩, ⟨(-2073), (-2071)⟩, ⟨(-1037), (-1034)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112019, 5112021⟩, ⟨(-2073), (-2071)⟩, ⟨(-1037), (-1034)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨55955, 55956⟩, ⟨111888, 111890⟩, ⟨55897, 55900⟩, ⟨(-46), (-43)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-143109622), (-143109620)⟩, ⟨111888, 111890⟩, ⟨55897, 55900⟩, ⟨(-46), (-43)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1566471), (-1566470)⟩, ⟨(-3131718), (-3131716)⟩, ⟨(-1563411), (-1563408)⟩, ⟨2446, 2449⟩, ⟨608, 612⟩⟩
...
def j19 : Jet := ⟨⟨1430089294, 1430089296⟩, ⟨(-3131718), (-3131716)⟩, ⟨(-1563411), (-1563408)⟩, ⟨2446, 2449⟩, ⟨608, 612⟩⟩
...
def j25 : Jet := ⟨⟨129, 130⟩, ⟨258, 260⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852048), (-852046)⟩, ⟨258, 260⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9327), (-9326)⟩, ⟨(-18651), (-18649)⟩, ⟨(-9321), (-9318)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782067, 35782069⟩, ⟨(-18651), (-18649)⟩, ⟨(-9321), (-9318)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨391668, 391669⟩, ⟨783132, 783134⟩, ⟨391156, 391160⟩, ⟨(-410), (-406)⟩, ⟨(-104), (-99)⟩⟩
...
def j33 : Jet := ⟨⟨(-715436215), (-715436213)⟩, ⟨783132, 783134⟩, ⟨391156, 391160⟩, ⟨(-410), (-406)⟩, ⟨(-104), (-99)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7831129), (-7831128)⟩, ⟨(-15653685), (-15653683)⟩, ⟨(-7809704), (-7809701)⟩, ⟨17130, 17133⟩, ⟨4270, 4273⟩⟩
...
def j36 : Jet := ⟨⟨4287136167, 4287136168⟩, ⟨(-15653685), (-15653683)⟩, ⟨(-7809704), (-7809701)⟩, ⟨17130, 17133⟩, ⟨4270, 4273⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨149620073, 149620076⟩, ⟨149292423, 149292427⟩, ⟨(-491219), (-491217)⟩, ⟨(-163314), (-163311)⟩, ⟨318, 322⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302812728, 4302812730⟩, ⟨15710922, 15710926⟩, ⟨7895622, 7895628⟩, ⟨40251, 40258⟩, ⟨10176, 10184⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨149893377, 149893381⟩, ⟨150112436, 150112442⟩, ⟨329044, 329050⟩, ⟨110442, 110449⟩, ⟨569, 578⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-143033149), (-143033148)⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4151934147, 4151934148⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5231244, 5231245⟩, ⟨10477778, 10477782⟩, ⟨5269511, 5269515⟩, ⟨30708, 30712⟩, ⟨7783, 7790⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300198540, 4300198541⟩, ⟨10477778, 10477782⟩, ⟨5269511, 5269515⟩, ⟨30708, 30712⟩, ⟨7783, 7790⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297582122, 4297582123⟩, ⟨5235701, 5235704⟩, ⟨2629962, 2629966⟩, ⟨12139, 12143⟩, ⟨3069, 3075⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4154461892, 4154461895⟩, ⟨(-138058891), (-138058886)⟩, ⟨2368014, 2368021⟩, ⟨(-75851), (-75845)⟩, ⟨2561, 2569⟩⟩
...
def j47 : Jet := ⟨⟨1801740637, 1801740651⟩, ⟨1801740637, 1801740651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨755830975, 755830988⟩, ⟨1511661950, 1511661976⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨755830975, 755830988⟩, ⟨1511661950, 1511661976⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-755830988), (-755830975)⟩, ⟨(-1511661976), (-1511661950)⟩, ⟨(-755830988), (-755830975)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-377915494), (-377915487)⟩, ⟨(-755830988), (-755830975)⟩, ⟨(-377915494), (-377915487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3933201138, 3933201145⟩, ⟨(-692167159), (-692167144)⟩, ⟨(-285179581), (-285179570)⟩, ⟨57331357, 57331361⟩, ⟨10024216, 10024218⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3804530538, 3804530549⟩, ⟨(-795953786), (-795953764)⟩, ⟨(-251432417), (-251432395)⟩, ⟨64171641, 64171656⟩, ⟨7710739, 7710754⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 286066297⟩, ⟨143033148, 143033149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 898703778⟩, ⟨449351886, 449351891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 188049973⟩, ⟨0, 188049974⟩, ⟨47012492, 47012494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4146), 0⟩, ⟨(-4146), 3⟩, ⟨(-1037), (-1031)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108910, 5113057⟩, ⟨(-4146), 3⟩, ⟨(-1037), (-1031)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 223870⟩, ⟨(-182), 223871⟩, ⟨55693, 55969⟩, ⟨(-92), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142941706)⟩, ⟨(-182), 223871⟩, ⟨55693, 55969⟩, ⟨(-92), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6268333), 0⟩, ⟨(-6268341), 9802⟩, ⟨(-1567092), (-1552379)⟩, ⟨(-7), 4903⟩, ⟨603, 614⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425387432, 1431655766⟩, ⟨(-6268341), 9802⟩, ⟨(-1567092), (-1552379)⟩, ⟨(-7), 4903⟩, ⟨603, 614⟩⟩
...
def j72 : Jet := ⟨⟨0, 519⟩, ⟨(-1), 519⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851657)⟩, ⟨(-1), 519⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-37312), 0⟩, ⟨(-37313), 23⟩, ⟨(-9329), (-9293)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35754082, 35791395⟩, ⟨(-37313), 23⟩, ⟨(-9329), (-9293)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1567084⟩, ⟨(-1634), 1567086⟩, ⟨389319, 391773⟩, ⟨(-819), 2⟩, ⟨(-105), (-99)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714260798)⟩, ⟨(-1634), 1567086⟩, ⟨389319, 391773⟩, ⟨(-819), 2⟩, ⟨(-105), (-99)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-31341663), 0⟩, ⟨(-31341735), 68613⟩, ⟨(-7835488), (-7732495)⟩, ⟨(-54), 34309⟩, ⟨4220, 4290⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4263625633, 4294967296⟩, ⟨(-31341735), 68613⟩, ⟨(-7835488), (-7732495)⟩, ⟨(-54), 34309⟩, ⟨4220, 4290⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 299567927⟩, ⟨147816526, 149786016⟩, ⟨(-983720), 1026⟩, ⟨(-163956), (-161388)⟩, ⟨(-1), 642⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4326539350⟩, ⟨(-69627), 31804212⟩, ⟨7731986, 8184901⟩, ⟨(-35077), 118671⟩, ⟨9087, 11666⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 301770034⟩, ⟨147811669, 153105385⟩, ⟨(-993381), 1681085⟩, ⟨91211, 132353⟩, ⟨(-4316), 5605⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-286066297), 0⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4008900999, 4294967296⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 21202759⟩, ⟨0, 21514772⟩, ⟨4947357, 5694076⟩, ⟨(-70824), 138454⟩, ⟨5281, 10884⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4316170055⟩, ⟨0, 21514772⟩, ⟨4947357, 5694076⟩, ⟨(-70824), 138454⟩, ⟨5281, 10884⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305555624⟩, ⟨0, 10757386⟩, ⟨2454156, 2847038⟩, ⟨(-42543), 69227⟩, ⟨1518, 4848⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4008900999, 4305555624⟩, ⟨(-143385767), (-132275762)⟩, ⟨1932448, 2847038⟩, ⟨(-137357), (-12502)⟩, ⟨(-890), 6265⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3603481289⟩, ⟨1801740637, 1801740651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3023323929⟩, ⟨0, 3023323940⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3023323929⟩, ⟨0, 3023323940⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3023323929), 0⟩, ⟨(-3023323940), 0⟩, ⟨(-755830988), (-755830975)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1511661965), 0⟩, ⟨(-1511661970), 0⟩, ⟨(-377915494), (-377915487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3020682235, 4294967296⟩, ⟨(-1511661970), 0⟩, ⟨(-377915494), 232449⟩, ⟨(-27272), 133011602⟩, ⟨(-11713959), 16628851⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2819489694, 4305555624⟩, ⟨(-1658774418), (-93030520)⟩, ⟨(-377488061), 53546292⟩, ⟨(-1174505), 145947280⟩, ⟨(-16434780), 16725522⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297582122, 4297582123⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3086
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305555624⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3087
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (62010335 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(13321 / 200000), prawitzNormalCorrection
