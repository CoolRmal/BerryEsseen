...
namespace FiniteNormalPanel0_11
...
def j2 : Jet := ⟨⟨805230755, 805230759⟩, ⟨805230755, 805230759⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨150966590, 150966592⟩, ⟨301933180, 301933184⟩, ⟨150966590, 150966592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨37, 38⟩, ⟨75, 76⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94650), (-94648)⟩, ⟨75, 76⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-3327), (-3326)⟩, ⟨(-6652), (-6650)⟩, ⟨(-3321), (-3318)⟩, ⟨4, 6⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5109729, 5109731⟩, ⟨(-6652), (-6650)⟩, ⟨(-3321), (-3318)⟩, ⟨4, 6⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨179605, 179606⟩, ⟨358976, 358978⟩, ⟨179020, 179023⟩, ⟨(-468), (-465)⟩, ⟨(-117), (-114)⟩⟩
...
def j16 : Jet := ⟨⟨(-142985972), (-142985970)⟩, ⟨358976, 358978⟩, ⟨179020, 179023⟩, ⟨(-468), (-465)⟩, ⟨(-117), (-114)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-5025907), (-5025906)⟩, ⟨(-10039197), (-10039195)⟩, ⟨(-4994380), (-4994377)⟩, ⟨25184, 25188⟩, ⟨6254, 6257⟩⟩
...
def j19 : Jet := ⟨⟨1426629858, 1426629860⟩, ⟨(-10039197), (-10039195)⟩, ⟨(-4994380), (-4994377)⟩, ⟨25184, 25188⟩, ⟨6254, 6257⟩⟩
...
def j22 : Jet := ⟨⟨(-4), (-3)⟩, ⟨(-8), (-7)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11831, 11833⟩, ⟨(-8), (-7)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨415, 416⟩, ⟨830, 832⟩, ⟨413, 416⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851762), (-851760)⟩, ⟨830, 832⟩, ⟨413, 416⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-29940), (-29939)⟩, ⟨(-59850), (-59848)⟩, ⟨(-29868), (-29865)⟩, ⟨57, 60⟩, ⟨12, 15⟩⟩
...
def j30 : Jet := ⟨⟨35761454, 35761456⟩, ⟨(-59850), (-59848)⟩, ⟨(-29868), (-29865)⟩, ⟨57, 60⟩, ⟨12, 15⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨1257002, 1257003⟩, ⟨2511901, 2511903⟩, ⟨1251744, 1251747⟩, ⟨(-4202), (-4199)⟩, ⟨(-1046), (-1043)⟩⟩
...
def j33 : Jet := ⟨⟨(-714570881), (-714570879)⟩, ⟨2511901, 2511903⟩, ⟨1251744, 1251747⟩, ⟨(-4202), (-4199)⟩, ⟨(-1046), (-1043)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-25116916), (-25116915)⟩, ⟨(-50145539), (-50145537)⟩, ⟨(-24896334), (-24896330)⟩, ⟨176140, 176143⟩, ⟨43665, 43668⟩⟩
...
def j36 : Jet := ⟨⟨4269850380, 4269850381⟩, ⟨(-50145539), (-50145537)⟩, ⟨(-24896334), (-24896330)⟩, ⟨176140, 176143⟩, ⟨43665, 43668⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨267467982, 267467985⟩, ⟨265585809, 265585813⟩, ⟨(-2818532), (-2818529)⟩, ⟨(-931638), (-931634)⟩, ⟨5893, 5897⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4320231958, 4320231960⟩, ⟨50737222, 50737226⟩, ⟨25785952, 25785959⟩, ⟨420443, 420450⟩, ⟨109010, 109018⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨269041332, 269041336⟩, ⟨270307734, 270307740⟩, ⟨1908113, 1908120⟩, ⟨650280, 650289⟩, ⟨10785, 10796⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-256312911), (-256312910)⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4038654385, 4038654386⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨16853035, 16853037⟩, ⟨33864728, 33864732⟩, ⟨17251118, 17251122⟩, ⟨321644, 321650⟩, ⟨84047, 84056⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4311820331, 4311820333⟩, ⟨33864728, 33864732⟩, ⟨17251118, 17251122⟩, ⟨321644, 321650⟩, ⟨84047, 84056⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4303385563, 4303385565⟩, ⟨16899240, 16899243⟩, ⟨8575504, 8575507⟩, ⟨126831, 126836⟩, ⟨32897, 32904⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4046570270, 4046570274⟩, ⟨(-240924558), (-240924552)⟩, ⟨7055234, 7055239⟩, ⟨(-392503), (-392497)⟩, ⟨23363, 23373⟩⟩
...
def j47 : Jet := ⟨⟨752065651, 752065655⟩, ⟨752065651, 752065655⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨131689650, 131689653⟩, ⟨263379300, 263379306⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨131689650, 131689653⟩, ⟨263379300, 263379306⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-131689653), (-131689650)⟩, ⟨(-263379306), (-263379300)⟩, ⟨(-131689653), (-131689650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-65844827), (-65844825)⟩, ⟨(-131689653), (-131689650)⟩, ⟨(-65844827), (-65844825)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4229624623, 4229624626⟩, ⟨(-129686157), (-129686153)⟩, ⟨(-62854901), (-62854897)⟩, ⟨1967858, 1967859⟩, ⟨466720, 466721⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3985006653, 3985006661⟩, ⟨(-359445017), (-359445006)⟩, ⟨(-44997132), (-44997120)⟩, ⟨4780304, 4780314⟩, ⟨260947, 260963⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 512625822⟩, ⟨256312910, 256312911⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1610461517⟩, ⟨805230755, 805230759⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 603866368⟩, ⟨0, 603866368⟩, ⟨150966590, 150966592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 152⟩, ⟨0, 152⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94534)⟩, ⟨0, 152⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-13313), 0⟩, ⟨(-13313), 22⟩, ⟨(-3329), (-3294)⟩, ⟨0, 12⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5099743, 5113057⟩, ⟨(-13313), 22⟩, ⟨(-3329), (-3294)⟩, ⟨0, 12⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 718889⟩, ⟨(-1872), 718893⟩, ⟨176913, 179727⟩, ⟨(-937), 3⟩, ⟨(-118), (-112)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142446687)⟩, ⟨(-1872), 718893⟩, ⟨176913, 179727⟩, ⟨(-937), 3⟩, ⟨(-118), (-112)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-20128879), 0⟩, ⟨(-20129143), 101076⟩, ⟨(-5032484), (-4880604)⟩, ⟨(-198), 50540⟩, ⟨6069, 6319⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1411526886, 1431655766⟩, ⟨(-20129143), 101076⟩, ⟨(-5032484), (-4880604)⟩, ⟨(-198), 50540⟩, ⟨6069, 6319⟩⟩
...
def j70 : Jet := ⟨⟨(-16), 0⟩, ⟨(-16), 0⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11819, 11836⟩, ⟨(-16), 0⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 1665⟩, ⟨(-3), 1665⟩, ⟨411, 417⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-850511)⟩, ⟨(-3), 1665⟩, ⟨411, 417⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-119815), 0⟩, ⟨(-119816), 235⟩, ⟨(-29955), (-29601)⟩, ⟨(-2), 118⟩, ⟨12, 15⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35671579, 35791395⟩, ⟨(-119816), 235⟩, ⟨(-29955), (-29601)⟩, ⟨(-2), 118⟩, ⟨12, 15⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 5032220⟩, ⟨(-16846), 5032254⟩, ⟨1232785, 1258089⟩, ⟨(-8425), 26⟩, ⟨(-1054), (-1020)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-710795662)⟩, ⟨(-16846), 5032254⟩, ⟨1232785, 1258089⟩, ⟨(-8425), 26⟩, ⟨(-1054), (-1020)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-100644395), 0⟩, ⟨(-100646764), 707528⟩, ⟨(-25163468), (-24099803)⟩, ⟨(-1778), 353772⟩, ⟨41997, 44226⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4194322901, 4294967296⟩, ⟨(-100646764), 707528⟩, ⟨(-25163468), (-24099803)⟩, ⟨(-1778), 353772⟩, ⟨41997, 44226⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 536820506⟩, ⟨257088721, 268448154⟩, ⟨(-5660865), 18950⟩, ⟨(-943578), (-896076)⟩, ⟨(-38), 11846⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4398026693⟩, ⟨(-741891), 105534831⟩, ⟨24082417, 28917981⟩, ⟨(-380284), 1328927⟩, ⟨72237, 162440⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 549701722⟩, ⟨256995993, 288080288⟩, ⟨(-5843071), 10230053⟩, ⟨288678, 1078463⟩, ⟨(-85109), 115788⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-512625822), 0⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3782341474, 4294967296⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 70354898⟩, ⟨0, 73741298⟩, ⟨13882071, 21941310⟩, ⟨(-783836), 1648400⟩, ⟨(-1158), 198681⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4365322194⟩, ⟨0, 73741298⟩, ⟨13882071, 21941310⟩, ⟨(-783836), 1648400⟩, ⟨(-1158), 198681⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4330001855⟩, ⟨0, 36870649⟩, ⟨6727894, 10970655⟩, ⟨(-486097), 824200⟩, ⟨(-21667), 98245⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3782341474, 4330001855⟩, ⟨(-258403686), (-219442261)⟩, ⟨3724537, 10970655⟩, ⟨(-1140799), 422697⟩, ⟨(-70854), 127255⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1504131309⟩, ⟨752065651, 752065655⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 526758609⟩, ⟨0, 526758610⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 526758609⟩, ⟨0, 526758610⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-526758609), 0⟩, ⟨(-526758610), 0⟩, ⟨(-131689653), (-131689650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-263379305), 0⟩, ⟨(-263379305), 0⟩, ⟨(-65844827), (-65844825)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨4039500993, 4294967296⟩, ⟨(-263379305), 0⟩, ⟨(-65844827), (-53852774)⟩, ⟨0, 4037788⟩, ⟨350897, 504724⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3557366351, 4330001855⟩, ⟨(-523931408), (-206389751)⟩, ⟨(-62878932), (-20608490)⟩, ⟨937943, 8454930⟩, ⟨(-198879), 659354⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4303385563, 4303385565⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4330001855⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(23871 / 200000), prawitzNormalCorrection
