...
namespace FiniteNormalPanel106_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (101213 / 400000)
def radius : Rat := (14459 / 400000)

def j0 : Jet := ⟨⟨1086766312, 1086766313⟩, ⟨155252330, 155252331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3414177061, 3414177066⟩, ⟨487739579, 487739583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2714014845, 2714014854⟩, ⟨775432810, 775432820⟩, ⟨55388057, 55388059⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨679, 680⟩, ⟨194, 195⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94008), (-94006)⟩, ⟨194, 195⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-59405), (-59402)⟩, ⟨(-16851), (-16848)⟩, ⟨(-1170), (-1167)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5053651, 5053655⟩, ⟨(-16851), (-16848)⟩, ⟨(-1170), (-1167)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3193431, 3193435⟩, ⟨901759, 901764⟩, ⟨61389, 61395⟩, ⟨(-428), (-423)⟩, ⟨(-16), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-139972146), (-139972141)⟩, ⟨901759, 901764⟩, ⟨61389, 61395⟩, ⟨(-428), (-423)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-88449215), (-88449210)⟩, ⟨(-24701379), (-24701373)⟩, ⟨(-1603488), (-1603480)⟩, ⟨22441, 22448⟩, ⟨702, 709⟩⟩
...
def j19 : Jet := ⟨⟨1343206550, 1343206556⟩, ⟨(-24701379), (-24701373)⟩, ⟨(-1603488), (-1603480)⟩, ⟨22441, 22448⟩, ⟨702, 709⟩⟩
...
def j22 : Jet := ⟨⟨(-69), (-67)⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11766, 11769⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7435, 7437⟩, ⟨2111, 2113⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844742), (-844739)⟩, ⟨2111, 2113⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-533798), (-533795)⟩, ⟨(-151181), (-151176)⟩, ⟨(-10422), (-10416)⟩, ⟨51, 55⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35257596, 35257600⟩, ⟨(-151181), (-151176)⟩, ⟨(-10422), (-10416)⟩, ⟨51, 55⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22279480, 22279483⟩, ⟨6270032, 6270039⟩, ⟨420802, 420810⟩, ⟨(-3800), (-3794)⟩, ⟨(-127), (-122)⟩⟩
...
def j33 : Jet := ⟨⟨(-693548403), (-693548399)⟩, ⟨6270032, 6270039⟩, ⟨420802, 420810⟩, ⟨(-3800), (-3794)⟩, ⟨(-127), (-122)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-438257277), (-438257272)⟩, ⟨(-121254297), (-121254287)⟩, ⟨(-7546101), (-7546090)⟩, ⟨154429, 154437⟩, ⟨4658, 4666⟩⟩
...
def j36 : Jet := ⟨⟨3856710019, 3856710024⟩, ⟨(-121254297), (-121254287)⟩, ⟨(-7546101), (-7546090)⟩, ⟨154429, 154437⟩, ⟨4658, 4666⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1067748524, 1067748531⟩, ⟨132899758, 132899767⟩, ⟨(-4079760), (-4079751)⟩, ⟨(-164256), (-164247)⟩, ⟨3106, 3114⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4783025936, 4783025943⟩, ⟨150377495, 150377511⟩, ⟨14086372, 14086391⟩, ⟨545572, 545586⟩, ⟨32903, 32920⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1189082135, 1189082145⟩, ⟨185386355, 185386372⟩, ⟨3611723, 3611742⟩, ⟨245742, 245761⟩, ⟨9385, 9406⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1086766313), (-1086766312)⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3208200983, 3208200984⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨329203047, 329203054⟩, ⟨102650188, 102650200⟩, ⟨10001790, 10001805⟩, ⟨447858, 447874⟩, ⟨29447, 29464⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4624170343, 4624170350⟩, ⟨102650188, 102650200⟩, ⟨10001790, 10001805⟩, ⟨447858, 447874⟩, ⟨29447, 29464⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4456530084, 4456530088⟩, ⟨49464402, 49464409⟩, ⟨4545086, 4545095⟩, ⟨165362, 165373⟩, ⟨10035, 10046⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3328883134, 3328883139⟩, ⟨(-124144123), (-124144114)⟩, ⟨1607016, 1607025⟩, ⟨(-40774), (-40764)⟩, ⟨1517, 1528⟩⟩
...
def j47 : Jet := ⟨⟨9439480835, 9439480847⟩, ⟨1348497259, 1348497269⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20746094741, 20746094795⟩, ⟨5927455626, 5927455680⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20746094741, 20746094795⟩, ⟨5927455626, 5927455680⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20746094795), (-20746094741)⟩, ⟨(-5927455680), (-5927455626)⟩, ⟨(-423389693), (-423389686)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10373047398), (-10373047370)⟩, ⟨(-2963727840), (-2963727813)⟩, ⟨(-211694847), (-211694843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨383767118, 383767130⟩, ⟨(-264817227), (-264817215)⟩, ⟨72452600, 72452607⟩, ⟨(-7963502), (-7963498)⟩, ⟨(-411764), (-411762)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨297444846, 297444856⟩, ⟨(-216343449), (-216343437)⟩, ⟨63953561, 63953571⟩, ⟨(-8369181), (-8369172)⟩, ⟨(-59207), (-59198)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨931513981, 1242018643⟩, ⟨155252330, 155252331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2926437479, 3901916645⟩, ⟨487739579, 487739583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1993970088, 3544835725⟩, ⟨664656694, 886208936⟩, ⟨55388057, 55388059⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨499, 889⟩, ⟨166, 223⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94188), (-93797)⟩, ⟨166, 223⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-77738), (-43545)⟩, ⟨(-19358), (-14330)⟩, ⟨(-1184), (-1150)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5035318, 5069512⟩, ⟨(-19358), (-14330)⟩, ⟨(-1184), (-1150)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2337683, 4184104⟩, ⟨763249, 1039374⟩, ⟨59962, 62627⟩, ⟨(-494), (-356)⟩, ⟨(-16), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140827894), (-138981472)⟩, ⟨763249, 1039374⟩, ⟨59962, 62627⟩, ⟨(-494), (-356)⟩, ⟨(-16), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-116231794), (-64523168)⟩, ⟨(-28703606), (-20649878)⟩, ⟨(-1670171), (-1526160)⟩, ⟨18713, 26162⟩, ⟨657, 748⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1315423971, 1367132598⟩, ⟨(-28703606), (-20649878)⟩, ⟨(-1670171), (-1526160)⟩, ⟨18713, 26162⟩, ⟨657, 748⟩⟩
...
def j70 : Jet := ⟨⟨(-90), (-49)⟩, ⟨(-23), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11745, 11787⟩, ⟨(-23), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5452, 9729⟩, ⟨1798, 2426⟩, ⟨144, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846725), (-842447)⟩, ⟨1798, 2426⟩, ⟨144, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-698842), (-391112)⟩, ⟨(-173877), (-128367)⟩, ⟨(-10576), (-10238)⟩, ⟨43, 64⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35092552, 35400283⟩, ⟨(-173877), (-128367)⟩, ⟨(-10576), (-10238)⟩, ⟨43, 64⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16291974, 29217496⟩, ⟨5287149, 7244779⟩, ⟨407947, 431906⟩, ⟨(-4407), (-3186)⟩, ⟨(-132), (-116)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699535909), (-686610386)⟩, ⟨5287149, 7244779⟩, ⟨407947, 431906⟩, ⟨(-4407), (-3186)⟩, ⟨(-132), (-116)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-577359433), (-318763910)⟩, ⟨(-141885262), (-100275183)⟩, ⟨(-8013651), (-7003215)⟩, ⟨127675, 181069⟩, ⟨4241, 5024⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3717607863, 3976203386⟩, ⟨(-141885262), (-100275183)⟩, ⟨(-8013651), (-7003215)⟩, ⟨127675, 181069⟩, ⟨4241, 5024⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨896282961, 1242020503⟩, ⟨123303675, 141182474⟩, ⟨(-4776930), (-3384885)⟩, ⟨(-176916), (-149543)⟩, ⟨2572, 3651⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4639285842, 4961992968⟩, ⟨116997343, 189378144⟩, ⟨11121624, 17923798⟩, ⟨260578, 932971⟩, ⟨11263, 64937⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨968136091, 1434911276⟩, ⟨157603927, 217873134⟩, ⟨160938, 7752132⟩, ⟨(-41356), 605245⟩, ⟨(-15129), 40829⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1242018643), (-931513981)⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3052948653, 3363453315⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨218229249, 479391397⟩, ⟨71051552, 145579046⟩, ⟨5855833, 16232009⟩, ⟨(-15824), 1190910⟩, ⟨(-14300), 102681⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4513196545, 4774358693⟩, ⟨71051552, 145579046⟩, ⟨5855833, 16232009⟩, ⟨(-15824), 1190910⟩, ⟨(-14300), 102681⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4402730012, 4528323581⟩, ⟨33695040, 71007902⟩, ⟨2220301, 7788418⟩, ⟨(-133332), 563889⟩, ⟨(-22959), 51676⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3129548546, 3546198123⟩, ⟨(-139736470), (-103540328)⟩, ⟨(-988525), 4881236⟩, ⟨(-385947), 361332⟩, ⟨(-38364), 45289⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8090983567, 10787978107⟩, ⟨1348497259, 1348497269⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15242028767, 27096940121⟩, ⟨5080676246, 6774235060⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15242028767, 27096940121⟩, ⟨5080676246, 6774235060⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-27096940121), (-15242028767)⟩, ⟨(-6774235060), (-5080676246)⟩, ⟨(-423389693), (-423389686)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13548470061), (-7621014383)⟩, ⟨(-3387117530), (-2540338123)⟩, ⟨(-211694847), (-211694843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨183222306, 728358625⟩, ⟨(-574401642), (-108370233)⟩, ⟨(-3851311), 217462825⟩, ⟨(-53604546), 19886887⟩, ⟨(-9280091), 10663382⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨133505813, 601379199⟩, ⟨(-497959622), (-83381496)⟩, ⟨(-735007), 199067038⟩, ⟨(-52052721), 16738663⟩, ⟨(-8414135), 10854832⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1086766312, 1086766313⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4456530084, 4456530088⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2140
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨931513981, 1242018643⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4402730012, 4528323581⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2141
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (23201901 / 4294967296)

theorem envelope_integral : (∫ s in ((43377 / 200000) : ℝ)..(14459 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((43377 / 200000) : ℝ)..(14459 / 50000), prawitzNormalCorrection
