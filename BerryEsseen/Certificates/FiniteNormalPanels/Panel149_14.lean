...
namespace FiniteNormalPanel149_14
...
def j2 : Jet := ⟨⟨2279311392, 2279311396⟩, ⟨455862278, 455862282⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1209615827, 1209615833⟩, ⟨483846330, 483846336⟩, ⟨48384633, 48384634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨302, 304⟩, ⟨121, 122⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94385), (-94382)⟩, ⟨121, 122⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-26583), (-26581)⟩, ⟨(-10599), (-10597)⟩, ⟨(-1048), (-1045)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5086473, 5086476⟩, ⟨(-10599), (-10597)⟩, ⟨(-1048), (-1045)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1432532, 1432533⟩, ⟨570026, 570030⟩, ⟨55810, 55815⟩, ⟨(-239), (-234)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-141733045), (-141733043)⟩, ⟨570026, 570030⟩, ⟨55810, 55815⟩, ⟨(-239), (-234)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-39917076), (-39917075)⟩, ⟨(-15806292), (-15806289)⟩, ⟨(-1516751), (-1516746)⟩, ⟨12640, 12645⟩, ⟨597, 601⟩⟩
...
def j19 : Jet := ⟨⟨1391738689, 1391738691⟩, ⟨(-15806292), (-15806289)⟩, ⟨(-1516751), (-1516746)⟩, ⟨12640, 12645⟩, ⟨597, 601⟩⟩
...
def j22 : Jet := ⟨⟨(-31), (-30)⟩, ⟨(-13), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11804, 11806⟩, ⟨(-13), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3324, 3325⟩, ⟨1325, 1327⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848853), (-848851)⟩, ⟨1325, 1327⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-239068), (-239066)⟩, ⟨(-95254), (-95252)⟩, ⟨(-9378), (-9374)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35552326, 35552329⟩, ⟨(-95254), (-95252)⟩, ⟨(-9378), (-9374)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10012801, 10012803⟩, ⟨3978293, 3978296⟩, ⟨387139, 387143⟩, ⟨(-2124), (-2120)⟩, ⟨(-104), (-100)⟩⟩
...
def j33 : Jet := ⟨⟨(-705815082), (-705815079)⟩, ⟨3978293, 3978296⟩, ⟨387139, 387143⟩, ⟨(-2124), (-2120)⟩, ⟨(-104), (-100)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-198782678), (-198782675)⟩, ⟨(-78392643), (-78392640)⟩, ⟨(-7394105), (-7394101)⟩, ⟨87830, 87835⟩, ⟨4091, 4096⟩⟩
...
def j36 : Jet := ⟨⟨4096184618, 4096184621⟩, ⟨(-78392643), (-78392640)⟩, ⟨(-7394105), (-7394101)⟩, ⟨87830, 87835⟩, ⟨4091, 4096⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨738586729, 738586732⟩, ⟨139329047, 139329053⟩, ⟨(-2482590), (-2482586)⟩, ⟨(-154279), (-154274)⟩, ⟨1657, 1662⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4503396643, 4503396647⟩, ⟨86185848, 86185854⟩, ⟨9778588, 9778595⟩, ⟨246149, 246158⟩, ⟨16008, 16019⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨774429411, 774429416⟩, ⟨160911512, 160911522⟩, ⟨1874388, 1874397⟩, ⟨147963, 147973⟩, ⟨3725, 3737⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-725527351), (-725527350)⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3569439945, 3569439946⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨139638062, 139638065⟩, ⟨58028198, 58028204⟩, ⟨6704514, 6704522⟩, ⟨193806, 193814⟩, ⟨13246, 13255⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4434605358, 4434605361⟩, ⟨58028198, 58028204⟩, ⟨6704514, 6704522⟩, ⟨193806, 193814⟩, ⟨13246, 13255⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4364227879, 4364227881⟩, ⟨28553643, 28553647⟩, ⟨3205647, 3205653⟩, ⟨74391, 74397⟩, ⟨4853, 4860⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3627000684, 3627000687⟩, ⟨(-123715222), (-123715215)⟩, ⟨1699448, 1699455⟩, ⟨(-46479), (-46472)⟩, ⟨1519, 1527⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨39812954403, 39812954410⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value615

def j47 : Jet := ⟨⟨6725403318, 6725403329⟩, ⟨1345080663, 1345080674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10531174435, 10531174471⟩, ⟨4212469772, 4212469814⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10531174435, 10531174471⟩, ⟨4212469772, 4212469814⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10531174471), (-10531174435)⟩, ⟨(-4212469814), (-4212469772)⟩, ⟨(-421246984), (-421246977)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5265587236), (-5265587217)⟩, ⟨(-2106234907), (-2106234886)⟩, ⟨(-210623492), (-210623488)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1260431181, 1260431199⟩, ⟨(-618110455), (-618110439)⟩, ⟨89748404, 89748413⟩, ⟨5537171, 5537175⟩, ⟨(-2879466), (-2879464)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1064405021, 1064405038⟩, ⟨(-558286340), (-558286322)⟩, ⟨94093666, 94093679⟩, ⟨1832618, 1832629⟩, ⟨(-2548496), (-2548484)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨580421880, 870632821⟩, ⟨145105470, 145105471⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1823449114, 2735173675⟩, ⟨455862278, 455862282⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨774154130, 1741846799⟩, ⟨387077064, 580615604⟩, ⟨48384633, 48384634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨193, 437⟩, ⟨96, 146⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94494), (-94249)⟩, ⟨96, 146⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-38323), (-16988)⟩, ⟨(-12758), (-8434)⟩, ⟨(-1055), (-1035)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5074733, 5096069⟩, ⟨(-12758), (-8434)⟩, ⟨(-1055), (-1035)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨914704, 2066738⟩, ⟨452177, 687393⟩, ⟨55016, 56464⟩, ⟨(-287), (-186)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142250873), (-141098838)⟩, ⟨452177, 687393⟩, ⟨55016, 56464⟩, ⟨(-287), (-186)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-57690598), (-25432614)⟩, ⟨(-19148697), (-12437531)⟩, ⟨(-1551850), (-1473712)⟩, ⟨9934, 15345⟩, ⟨575, 620⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1373965167, 1406223152⟩, ⟨(-19148697), (-12437531)⟩, ⟨(-1551850), (-1473712)⟩, ⟨9934, 15345⟩, ⟨575, 620⟩⟩
...
def j70 : Jet := ⟨⟨(-44), (-19)⟩, ⟨(-15), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11791, 11817⟩, ⟨(-15), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2125, 4793⟩, ⟨1055, 1597⟩, ⟨128, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850052), (-847383)⟩, ⟨1055, 1597⟩, ⟨128, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-344744), (-152738)⟩, ⟨(-114725), (-75721)⟩, ⟨(-9459), (-9275)⟩, ⟨21, 37⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35446650, 35638657⟩, ⟨(-114725), (-75721)⟩, ⟨(-9459), (-9275)⟩, ⟨21, 37⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6389145, 14453447⟩, ⟨3148044, 4804168⟩, ⟨379974, 392990⟩, ⟨(-2569), (-1672)⟩, ⟨(-107), (-97)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709438738), (-701374435)⟩, ⟨3148044, 4804168⟩, ⟨379974, 392990⟩, ⟨(-2569), (-1672)⟩, ⟨(-107), (-97)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-287716649), (-126420500)⟩, ⟨(-95338127), (-61261894)⟩, ⟨(-7639929), (-7092449)⟩, ⟨68666, 106947⟩, ⟨3888, 4261⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4007250647, 4168546796⟩, ⟨(-95338127), (-61261894)⟩, ⟨(-7639929), (-7092449)⟩, ⟨68666, 106947⟩, ⟨3888, 4261⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨583323549, 895528251⟩, ⟨133636379, 143974297⟩, ⟨(-3020687), (-1945774)⟩, ⟨(-160495), (-146644)⟩, ⟨1298, 2024⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4425221780, 4603341717⟩, ⟨65034045, 109519973⟩, ⟨8484914, 11382028⟩, ⟨117242, 403772⟩, ⟨8642, 25902⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨601014139, 959826298⟩, ⟨146521837, 177147128⟩, ⟨(-61676), 4039731⟩, ⟨30882, 285182⟩, ⟨(-5942), 15044⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-870632821), (-580421880)⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3424334475, 3714545416⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨84102618, 214499078⟩, ⟨41006922, 79176610⟩, ⟨4970991, 9112057⟩, ⟨3554, 460704⟩, ⟨(-609), 34050⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4379069914, 4509466374⟩, ⟨41006922, 79176610⟩, ⟨4970991, 9112057⟩, ⟨3554, 460704⟩, ⟨(-609), 34050⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4336814737, 4400910202⟩, ⟨20009882, 39206304⟩, ⟨2251024, 4465904⟩, ⟨(-38614), 217744⟩, ⟨(-4570), 16627⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3457699021, 3806171198⟩, ⟨(-132731075), (-112611320)⟩, ⟨470133, 3186349⟩, ⟨(-184277), 112269⟩, ⟨(-11310), 15686⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5380322654, 8070483993⟩, ⟨1345080663, 1345080674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6739951637, 15164891231⟩, ⟨3369975816, 5054963776⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6739951637, 15164891231⟩, ⟨3369975816, 5054963776⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15164891231), (-6739951637)⟩, ⟨(-5054963776), (-3369975816)⟩, ⟨(-421246984), (-421246977)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7582445616), (-3369975818)⟩, ⟨(-2527481888), (-1684987908)⟩, ⟨(-210623492), (-210623488)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨734928724, 1959737045⟩, ⟨(-1153256718), (-288324899)⟩, ⟨(-39547374), 303290897⟩, ⟨(-50066836), 45461052⟩, ⟨(-14124809), 8335468⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨591660460, 1736705820⟩, ⟨(-1082571809), (-251387714)⟩, ⟨(-27406476), 305868335⟩, ⟨(-54681417), 41529114⟩, ⟨(-13986881), 9215740⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4364227879, 4364227881⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar615 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3008
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar615 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4336814737, 4400910202⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3009
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((6757 / 50000) : ℝ)..(20271 / 100000), prawitzNormalCorrection
      ((119671 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
