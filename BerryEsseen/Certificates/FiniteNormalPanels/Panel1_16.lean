...
namespace FiniteNormalPanel1_16
...
def j2 : Jet := ⟨⟨2529944569, 2529944570⟩, ⟨843314856, 843314857⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1490260363, 1490260365⟩, ⟨993506908, 993506910⟩, ⟨165584484, 165584486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨373, 374⟩, ⟨248, 249⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94314), (-94312)⟩, ⟨248, 249⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-32725), (-32724)⟩, ⟨(-21731), (-21729)⟩, ⟨(-3566), (-3563)⟩, ⟨18, 20⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5080331, 5080333⟩, ⟨(-21731), (-21729)⟩, ⟨(-3566), (-3563)⟩, ⟨18, 20⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1762764, 1762766⟩, ⟨1167635, 1167638⟩, ⟨189597, 189601⟩, ⟨(-1657), (-1654)⟩, ⟨(-134), (-131)⟩⟩
...
def j16 : Jet := ⟨⟨(-141402813), (-141402810)⟩, ⟨1167635, 1167638⟩, ⟨189597, 189601⟩, ⟨(-1657), (-1654)⟩, ⟨(-134), (-131)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-49063705), (-49063703)⟩, ⟨(-32303994), (-32303989)⟩, ⟨(-5115642), (-5115637)⟩, ⟨88297, 88303⟩, ⟨6878, 6883⟩⟩
...
def j19 : Jet := ⟨⟨1382592060, 1382592063⟩, ⟨(-32303994), (-32303989)⟩, ⟨(-5115642), (-5115637)⟩, ⟨88297, 88303⟩, ⟨6878, 6883⟩⟩
...
def j22 : Jet := ⟨⟨(-38), (-37)⟩, ⟨(-25), (-24)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11797, 11799⟩, ⟨(-25), (-24)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4093, 4094⟩, ⟨2719, 2722⟩, ⟨446, 449⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848084), (-848082)⟩, ⟨2719, 2722⟩, ⟨446, 449⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-294267), (-294266)⟩, ⟨(-195235), (-195232)⟩, ⟨(-31915), (-31910)⟩, ⟨205, 209⟩, ⟨15, 18⟩⟩
...
def j30 : Jet := ⟨⟨35497127, 35497129⟩, ⟨(-195235), (-195232)⟩, ⟨(-31915), (-31910)⟩, ⟨205, 209⟩, ⟨15, 18⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12316732, 12316733⟩, ⟨8143411, 8143415⟩, ⟨1312289, 1312294⟩, ⟨(-14839), (-14834)⟩, ⟨(-1179), (-1174)⟩⟩
...
def j33 : Jet := ⟨⟨(-703511151), (-703511149)⟩, ⟨8143411, 8143415⟩, ⟨1312289, 1312294⟩, ⟨(-14839), (-14834)⟩, ⟨(-1179), (-1174)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-244103090), (-244103088)⟩, ⟨(-159909807), (-159909802)⟩, ⟨(-24783507), (-24783501)⟩, ⟨612362, 612367⟩, ⟨46749, 46756⟩⟩
...
def j36 : Jet := ⟨⟨4050864206, 4050864208⟩, ⟨(-159909807), (-159909802)⟩, ⟨(-24783507), (-24783501)⟩, ⟨612362, 612367⟩, ⟨46749, 46756⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨814413948, 814413951⟩, ⟨252442691, 252442697⟩, ⟨(-9356237), (-9356231)⟩, ⟨(-952443), (-952437)⟩, ⟨21388, 21394⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4553779916, 4553779919⟩, ⟨179762639, 179762647⟩, ⟨34956592, 34956603⟩, ⟨1791336, 1791346⟩, ⟨204843, 204857⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨863490132, 863490137⟩, ⟨301741448, 301741459⟩, ⟨7274246, 7274259⟩, ⟨992860, 992872⟩, ⟨50791, 50806⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-805306368), (-805306368)⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3489660928, 3489660928⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨173602068, 173602071⟩, ⟨121328402, 121328410⟩, ⟨24123671, 24123680⟩, ⟨1421320, 1421330⟩, ⟨172248, 172259⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4468569364, 4468569367⟩, ⟨121328402, 121328410⟩, ⟨24123671, 24123680⟩, ⟨1421320, 1421330⟩, ⟨172248, 172259⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4380908499, 4380908501⟩, ⟨59474138, 59474143⟩, ⟨11421512, 11421518⟩, ⟨541662, 541669⟩, ⟨62191, 62199⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3559488155, 3559488158⟩, ⟨(-225484045), (-225484039)⟩, ⟨5562844, 5562851⟩, ⟨(-273745), (-273737)⟩, ⟨16675, 16684⟩⟩
...
def j47 : Jet := ⟨⟨2261839836, 2261839837⟩, ⟨753946612, 753946613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1191142816, 1191142819⟩, ⟨794095210, 794095214⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1191142816, 1191142819⟩, ⟨794095210, 794095214⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1191142819), (-1191142816)⟩, ⟨(-794095214), (-794095210)⟩, ⟨(-132349203), (-132349201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-595571410), (-595571408)⟩, ⟨(-397047607), (-397047605)⟩, ⟨(-66174602), (-66174600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3738844723, 3738844727⟩, ⟨(-345636940), (-345636937)⟩, ⟨(-41629981), (-41629977)⟩, ⟨4833086, 4833088⟩, ⟨209007, 209009⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3098597169, 3098597176⟩, ⟨(-482737188), (-482737177)⟩, ⟨(-11512826), (-11512813)⟩, ⟨5505044, 5505057⟩, ⟨(-97897), (-97882)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨536870912, 1073741824⟩, ⟨268435456, 268435456⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1686629713, 3373259427⟩, ⟨843314856, 843314857⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨662337939, 2649351760⟩, ⟨662337938, 1324675882⟩, ⟨165584484, 165584486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨165, 664⟩, ⟨165, 332⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94522), (-94022)⟩, ⟨165, 332⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-58306), (-14499)⟩, ⟨(-29128), (-14294)⟩, ⟨(-3614), (-3495)⟩, ⟨12, 26⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5054750, 5098558⟩, ⟨(-29128), (-14294)⟩, ⟨(-3614), (-3495)⟩, ⟨12, 26⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨779505, 3145047⟩, ⟨761537, 1570320⟩, ⟨183662, 193824⟩, ⟨(-2237), (-1072)⟩, ⟨(-139), (-123)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142386072), (-140020529)⟩, ⟨761537, 1570320⟩, ⟨183662, 193824⟩, ⟨(-2237), (-1072)⟩, ⟨(-139), (-123)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-87830888), (-21592925)⟩, ⟨(-43798006), (-20624272)⟩, ⟨(-5343671), (-4794343)⟩, ⟨56301, 120157⟩, ⟨6304, 7290⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1343824877, 1410062841⟩, ⟨(-43798006), (-20624272)⟩, ⟨(-5343671), (-4794343)⟩, ⟨56301, 120157⟩, ⟨6304, 7290⟩⟩
...
def j70 : Jet := ⟨⟨(-67), (-16)⟩, ⟨(-34), (-16)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11768, 11820⟩, ⟨(-34), (-16)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1814, 7292⟩, ⟨1793, 3644⟩, ⟨438, 454⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850363), (-844884)⟩, ⟨1793, 3644⟩, ⟨438, 454⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-524547), (-130291)⟩, ⟨(-261998), (-128043)⟩, ⟨(-32442), (-31167)⟩, ⟨133, 282⟩, ⟨13, 18⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35266847, 35661104⟩, ⟨(-261998), (-128043)⟩, ⟨(-32442), (-31167)⟩, ⟨133, 282⟩, ⟨13, 18⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5438591, 21997562⟩, ⟨5276977, 10979036⟩, ⟨1258828, 1350297⟩, ⟨(-20087), (-9568)⟩, ⟨(-1229), (-1102)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710389292), (-693830320)⟩, ⟨5276977, 10979036⟩, ⟨1258828, 1350297⟩, ⟨(-20087), (-9568)⟩, ⟨(-1229), (-1102)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-438203831), (-106997355)⟩, ⟨(-218288140), (-100224933)⟩, ⟨(-26379837), (-22530195)⟩, ⟨385180, 838268⟩, ⟨41576, 50415⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3856763465, 4187969941⟩, ⟨(-218288140), (-100224933)⟩, ⟨(-26379837), (-22530195)⟩, ⟨385180, 838268⟩, ⟨41576, 50415⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨527718795, 1107460766⟩, ⟨229460523, 268766060⟩, ⟨(-12796629), (-5932300)⟩, ⟨(-1027119), (-846995)⟩, ⟨13529, 29319⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4404698298, 4782959661⟩, ⟨105411594, 270709724⟩, ⟨26218807, 48036760⟩, ⟨237182, 4130547⟩, ⟨34960, 504342⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨541201345, 1233289990⟩, ⟨248274778, 369105866⟩, ⟨(-5397436), 23242652⟩, ⟨(-520493), 3056831⟩, ⟨(-177022), 364174⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1073741824), (-536870912)⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3221225472, 3758096384⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨68195838, 354136387⟩, ⟨62569344, 211975804⟩, ⟨11252041, 45068797⟩, ⟨(-1226622), 5750432⟩, ⟨(-220335), 860328⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4363163134, 4649103683⟩, ⟨62569344, 211975804⟩, ⟨11252041, 45068797⟩, ⟨(-1226622), 5750432⟩, ⟨(-220335), 860328⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4328930926, 4468528648⟩, ⟨30069549, 105156350⟩, ⟨4170196, 22253166⟩, ⟨(-1149064), 2823691⟩, ⟨(-235093), 452694⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3246698194, 3909962567⟩, ⟨(-256730880), (-178546375)⟩, ⟨(-3444625), 17592175⟩, ⟨(-2396254), 2210093⟩, ⟨(-382188), 467925⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1507893224, 3015786449⟩, ⟨753946612, 753946613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨529396807, 2117587232⟩, ⟨529396806, 1058793618⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨529396807, 2117587232⟩, ⟨529396806, 1058793618⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2117587232), (-529396807)⟩, ⟨(-1058793618), (-529396806)⟩, ⟨(-132349203), (-132349201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1058793616), (-264698403)⟩, ⟨(-529396809), (-264698403)⟩, ⟨(-66174602), (-66174600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3356585851, 4038260547⟩, ⟨(-497755187), (-206866048)⟩, ⟨(-55844833), (-21039909)⟩, ⟨2557084, 7407242⟩, ⟨(-66169), 390816⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2537346729, 3676267242⟩, ⟨(-694522247), (-295913279)⟩, ⟨(-45477953), 30389215⟩, ⟨(-1484207), 12558571⟩, ⟨(-1347225), 1011939⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4380908499, 4380908501⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified14
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4328930926, 4468528648⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified15
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (386870245 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((1 / 8) : ℝ)..(1 / 4), prawitzNormalCorrection
