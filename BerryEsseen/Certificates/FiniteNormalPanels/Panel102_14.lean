...
namespace FiniteNormalPanel102_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (483 / 1600)
def radius : Rat := (69 / 1600)

def j0 : Jet := ⟨⟨1296543252, 1296543253⟩, ⟨185220464, 185220465⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4073210755, 4073210759⟩, ⟨581887248, 581887253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3862903885, 3862903893⟩, ⟨1103686818, 1103686830⟩, ⟨78834772, 78834774⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨966, 968⟩, ⟨276, 277⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93721), (-93718)⟩, ⟨276, 277⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-84293), (-84290)⟩, ⟨(-23836), (-23832)⟩, ⟨(-1634), (-1630)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5028763, 5028767⟩, ⟨(-23836), (-23832)⟩, ⟨(-1634), (-1630)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4522881, 4522886⟩, ⟨1270812, 1270819⟩, ⟨84707, 84714⟩, ⟨(-850), (-844)⟩, ⟨(-28), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-138642696), (-138642690)⟩, ⟨1270812, 1270819⟩, ⟨84707, 84714⟩, ⟨(-850), (-844)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-124695574), (-124695567)⟩, ⟨(-34484336), (-34484326)⟩, ⟨(-2142060), (-2142049)⟩, ⟨44327, 44338⟩, ⟨1309, 1318⟩⟩
...
def j19 : Jet := ⟨⟨1306960191, 1306960199⟩, ⟨(-34484336), (-34484326)⟩, ⟨(-2142060), (-2142049)⟩, ⟨44327, 44338⟩, ⟨1309, 1318⟩⟩
...
def j25 : Jet := ⟨⟨10556, 10559⟩, ⟨2990, 2993⟩, ⟨205, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841621), (-841617)⟩, ⟨2990, 2993⟩, ⟨205, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-756956), (-756952)⟩, ⟨(-213585), (-213580)⟩, ⟨(-14497), (-14489)⟩, ⟨104, 109⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35034438, 35034443⟩, ⟨(-213585), (-213580)⟩, ⟨(-14497), (-14489)⟩, ⟨104, 109⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨31510057, 31510063⟩, ⟨8810774, 8810781⟩, ⟨575137, 575148⟩, ⟨(-7554), (-7544)⟩, ⟨(-241), (-232)⟩⟩
...
def j33 : Jet := ⟨⟨(-684317826), (-684317819)⟩, ⟨8810774, 8810781⟩, ⟨575137, 575148⟩, ⟨(-7554), (-7544)⟩, ⟨(-241), (-232)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-615477095), (-615477087)⟩, ⟨(-167926169), (-167926157)⟩, ⟨(-9779356), (-9779340)⟩, ⟨302722, 302736⟩, ⟨8397, 8411⟩⟩
...
def j36 : Jet := ⟨⟨3679490201, 3679490209⟩, ⟨(-167926169), (-167926157)⟩, ⟨(-9779356), (-9779340)⟩, ⟨302722, 302736⟩, ⟨8397, 8411⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1239479590, 1239479600⟩, ⟨144364661, 144364675⟩, ⟨(-6703441), (-6703428)⟩, ⟨(-248171), (-248158)⟩, ⟨7246, 7257⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5013396700, 5013396712⟩, ⟨228803555, 228803574⟩, ⟨23766827, 23766855⟩, ⟨1280306, 1280333⟩, ⟨91311, 91337⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1446810291, 1446810307⟩, ⟨234543031, 234543056⟩, ⟨6724761, 6724788⟩, ⟨521551, 521579⟩, ⟨27527, 27553⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1296543253), (-1296543252)⟩, ⟨(-185220465), (-185220464)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2998424043, 2998424044⟩, ⟨(-185220465), (-185220464)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨487375077, 487375089⟩, ⟨158017160, 158017182⟩, ⟨17338742, 17338768⟩, ⟨1085842, 1085868⟩, ⟨86035, 86060⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4782342373, 4782342385⟩, ⟨158017160, 158017182⟩, ⟨17338742, 17338768⟩, ⟨1085842, 1085868⟩, ⟨86035, 86060⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4532108128, 4532108135⟩, ⟨74874485, 74874497⟩, ⟨7597252, 7597266⟩, ⟨388998, 389013⟩, ⟨27971, 27985⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3163977986, 3163977993⟩, ⟨(-143175415), (-143175403)⟩, ⟨2074868, 2074880⟩, ⟨(-56064), (-56051)⟩, ⟨2750, 2763⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨26085221240, 26085221246⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value457

def j47 : Jet := ⟨⟨7874476158, 7874476167⟩, ⟨1124925162, 1124925169⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14437216977, 14437217011⟩, ⟨4124919122, 4124919156⟩, ⟨294637079, 294637084⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14437216977, 14437217011⟩, ⟨4124919122, 4124919156⟩, ⟨294637079, 294637084⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14437217011), (-14437216977)⟩, ⟨(-4124919156), (-4124919122)⟩, ⟨(-294637084), (-294637079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7218608506), (-7218608488)⟩, ⟨(-2062459578), (-2062459561)⟩, ⟨(-147318542), (-147318539)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨799899387, 799899398⟩, ⟨(-384114724), (-384114714)⟩, ⟨64789903, 64789909⟩, ⟨(-1587295), (-1587292)⟩, ⟨(-920600), (-920599)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨589262706, 589262716⟩, ⟨(-309631337), (-309631324)⟩, ⟨60919971, 60919983⟩, ⟨(-3525135), (-3525124)⟩, ⟨(-588444), (-588434)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1111322787, 1481763718⟩, ⟨185220464, 185220465⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3491323503, 4655098011⟩, ⟨581887248, 581887253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2838051831, 5045425495⟩, ⟨946017272, 1261356378⟩, ⟨78834772, 78834774⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-110398), (-61731)⟩, ⟨(-27445), (-20204)⟩, ⟨(-1662), (-1596)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5002658, 5051326⟩, ⟨(-27445), (-20204)⟩, ⟨(-1662), (-1596)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3305683, 5933943⟩, ⟨1069653, 1470136⟩, ⟨81810, 87214⟩, ⟨(-988), (-706)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139859894), (-137231633)⟩, ⟨1069653, 1470136⟩, ⟨81810, 87214⟩, ⟨(-988), (-706)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-164297567), (-90680664)⟩, ⟨(-40367581), (-28499874)⟩, ⟨(-2277489), (-1984700)⟩, ⟨36491, 52133⟩, ⟨1174, 1431⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1267358198, 1340975102⟩, ⟨(-40367581), (-28499874)⟩, ⟨(-2277489), (-1984700)⟩, ⟨36491, 52133⟩, ⟨1174, 1431⟩⟩
...
def j72 : Jet := ⟨⟨7736, 13822⟩, ⟨2540, 3441⟩, ⟨201, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844441), (-838354)⟩, ⟨2540, 3441⟩, ⟨201, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-991990), (-553972)⟩, ⟨(-246320), (-180614)⟩, ⟨(-14809), (-14129)⟩, ⟨87, 126⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34799404, 35237423⟩, ⟨(-246320), (-180614)⟩, ⟨(-14809), (-14129)⟩, ⟨87, 126⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨22994939, 41394447⟩, ⟨7375619, 10229265⟩, ⟨549011, 597671⟩, ⟨(-8815), (-6278)⟩, ⟨(-253), (-216)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692832944), (-674433435)⟩, ⟨7375619, 10229265⟩, ⟨549011, 597671⟩, ⟨(-8815), (-6278)⟩, ⟨(-253), (-216)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-813891413), (-445655790)⟩, ⟨(-198599153), (-136535307)⟩, ⟨(-10729709), (-8673069)⟩, ⟨245950, 359138⟩, ⟨7190, 9447⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3481075883, 3849311506⟩, ⟨(-198599153), (-136535307)⟩, ⟨(-10729709), (-8673069)⟩, ⟨245950, 359138⟩, ⟨7190, 9447⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1030219128, 1453415149⟩, ⟨127950805, 158509716⟩, ⟨(-7937504), (-5474533)⟩, ⟨(-278894), (-212384)⟩, ⟨5897, 8615⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4792219087, 5299150233⟩, ⟨169980294, 302322267⟩, ⟨16826789, 33581369⟩, ⟨485428, 2509117⟩, ⟨13918, 224752⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1149493215, 1793230238⟩, ⟨183536959, 297875741⟩, ⟨(-693285), 16413055⟩, ⟨(-285101), 1634802⟩, ⟨(-57316), 149435⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1481763718), (-1111322787)⟩, ⟨(-185220465), (-185220464)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2813203578, 3183644509⟩, ⟨(-185220465), (-185220464)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨307647197, 748707608⟩, ⟨98242652, 248737534⟩, ⟨7264170, 34364578⟩, ⟨(-334238), 3641764⟩, ⟨(-90060), 414270⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4602614493, 5043674904⟩, ⟨98242652, 248737534⟩, ⟨7264170, 34364578⟩, ⟨(-334238), 3641764⟩, ⟨(-90060), 414270⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4446130758, 4654290361⟩, ⟨45329034, 120140369⟩, ⟨1801097, 16367043⟩, ⟨(-603697), 1740613⟩, ⟨(-120659), 216041⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2912215645, 3449992732⟩, ⟨(-171025756), (-102685339)⟩, ⟨(-4001336), 10177257⟩, ⟨(-1153320), 1212558⟩, ⟨(-164503), 186176⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6749550990, 8999401336⟩, ⟨1124925162, 1124925169⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10606934914, 18856773248⟩, ⟨3535644960, 4714193322⟩, ⟨294637079, 294637084⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10606934914, 18856773248⟩, ⟨3535644960, 4714193322⟩, ⟨294637079, 294637084⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18856773248), (-10606934914)⟩, ⟨(-4714193322), (-3535644960)⟩, ⟨(-294637084), (-294637079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9428386624), (-5303467457)⟩, ⟨(-2357096661), (-1767822480)⟩, ⟨(-147318542), (-147318539)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨478177443, 1249363479⟩, ⟨(-685656091), (-196819387)⟩, ⟨(-2347757), 171743902⟩, ⟨(-26917294), 16108280⟩, ⟨(-5155505), 3733347⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨324229670, 1003568742⟩, ⟨(-600512574), (-144886390)⟩, ⟨1655796, 168219014⟩, ⟨(-30420750), 14024193⟩, ⟨(-5184096), 4715949⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1296543252, 1296543253⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4532108128, 4532108135⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar457 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2062
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar457 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1111322787, 1481763718⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4446130758, 4654290361⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2063
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((207 / 800) : ℝ)..(69 / 200), prawitzNormalCorrection
      ((192059 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
