...
namespace FiniteNormalPanel131_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (189259 / 800000)
def radius : Rat := (27037 / 800000)

def j0 : Jet := ⟨⟨1016076519, 1016076520⟩, ⟨145153788, 145153789⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3192098527, 3192098531⟩, ⟨456014074, 456014078⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2372426215, 2372426222⟩, ⟨677836058, 677836068⟩, ⟨48416861, 48416863⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨593, 595⟩, ⟨169, 170⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94094), (-94091)⟩, ⟨169, 170⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-51976), (-51973)⟩, ⟨(-14758), (-14755)⟩, ⟨(-1029), (-1025)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5061080, 5061084⟩, ⟨(-14758), (-14755)⟩, ⟨(-1029), (-1025)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2795606, 2795609⟩, ⟨790592, 790596⟩, ⟨54154, 54160⟩, ⟨(-329), (-324)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-140369971), (-140369967)⟩, ⟨790592, 790596⟩, ⟨54154, 54160⟩, ⟨(-329), (-324)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-77536656), (-77536653)⟩, ⟨(-21716629), (-21716624)⟩, ⟨(-1427696), (-1427690)⟩, ⟨17276, 17283⟩, ⟨551, 556⟩⟩
...
def j19 : Jet := ⟨⟨1354119109, 1354119113⟩, ⟨(-21716629), (-21716624)⟩, ⟨(-1427696), (-1427690)⟩, ⟨17276, 17283⟩, ⟨551, 556⟩⟩
...
def j22 : Jet := ⟨⟨(-60), (-59)⟩, ⟨(-18), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11775, 11777⟩, ⟨(-18), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6504, 6506⟩, ⟨1848, 1851⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845673), (-845670)⟩, ⟨1848, 1851⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-467128), (-467125)⟩, ⟨(-132445), (-132441)⟩, ⟨(-9173), (-9167)⟩, ⟨38, 42⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35324266, 35324270⟩, ⟨(-132445), (-132441)⟩, ⟨(-9173), (-9167)⟩, ⟨38, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19512189, 19512192⟩, ⟨5501751, 5501756⟩, ⟨372237, 372245⟩, ⟨(-2922), (-2914)⟩, ⟨(-100), (-94)⟩⟩
...
def j33 : Jet := ⟨⟨(-696315694), (-696315690)⟩, ⟨5501751, 5501756⟩, ⟨372237, 372245⟩, ⟨(-2922), (-2914)⟩, ⟨(-100), (-94)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-384626354), (-384626350)⟩, ⟨(-106854224), (-106854217)⟩, ⟨(-6775614), (-6775605)⟩, ⟨119151, 119161⟩, ⟨3678, 3687⟩⟩
...
def j36 : Jet := ⟨⟨3910340942, 3910340946⟩, ⟨(-106854224), (-106854217)⟩, ⟨(-6775614), (-6775605)⟩, ⟨119151, 119161⟩, ⟨3678, 3687⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1006406176, 1006406181⟩, ⟨127632112, 127632120⟩, ⟨(-3366833), (-3366826)⟩, ⟨(-138746), (-138737)⟩, ⟨2243, 2250⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4717426006, 4717426012⟩, ⟨128908672, 128908683⟩, ⟨11696638, 11696654⟩, ⟨399231, 399248⟩, ⟨22798, 22815⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1105397629, 1105397637⟩, ⟨170392339, 170392353⟩, ⟨2873517, 2873532⟩, ⟨187687, 187705⟩, ⟨6333, 6352⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1016076520), (-1016076519)⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3278890776, 3278890777⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨284496675, 284496680⟩, ⟨87707902, 87707912⟩, ⟨8239015, 8239028⟩, ⟨324608, 324622⟩, ⟨20072, 20087⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4579463971, 4579463976⟩, ⟨87707902, 87707912⟩, ⟨8239015, 8239028⟩, ⟨324608, 324622⟩, ⟨20072, 20087⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4434934947, 4434934950⟩, ⟨42469909, 42469915⟩, ⟨3786143, 3786151⟩, ⟨120924, 120932⟩, ⟨6944, 6954⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3385745754, 3385745759⟩, ⟨(-117461528), (-117461521)⟩, ⟨1455116, 1455125⟩, ⟨(-35642), (-35634)⟩, ⟨1213, 1223⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨46132356224, 46132356232⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value552

def j47 : Jet := ⟨⟨10913704504, 10913704518⟩, ⟨1559100638, 1559100650⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨27732212562, 27732212634⟩, ⟨7923489274, 7923489348⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨27732212562, 27732212634⟩, ⟨7923489274, 7923489348⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-27732212634), (-27732212562)⟩, ⟨(-7923489348), (-7923489274)⟩, ⟨(-565963527), (-565963517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-13866106317), (-13866106281)⟩, ⟨(-3961744674), (-3961744637)⟩, ⟨(-282981764), (-282981758)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨170160949, 170160955⟩, ⟨(-156959114), (-156959106)⟩, ⟨61179394, 61179401⟩, ⟨(-11916586), (-11916582)⟩, ⟨732551, 732554⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨134138788, 134138794⟩, ⟨(-128385384), (-128385375)⟩, ⟨52578311, 52578320⟩, ⟨(-11121674), (-11121666)⟩, ⟨925452, 925460⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨870922730, 1161230308⟩, ⟨145153788, 145153789⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2736084450, 3648112605⟩, ⟨456014074, 456014078⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1743007012, 3098679143⟩, ⟨581002336, 774669790⟩, ⟨48416861, 48416863⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨436, 777⟩, ⟨145, 195⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94251), (-93909)⟩, ⟨145, 195⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-68000), (-38110)⟩, ⟨(-16942), (-12562)⟩, ⟨(-1040), (-1012)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5045056, 5074947⟩, ⟨(-16942), (-12562)⟩, ⟨(-1040), (-1012)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2047412, 3661410⟩, ⟨670246, 910256⟩, ⟨53065, 55101⟩, ⟨(-379), (-272)⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141118165), (-139504166)⟩, ⟨670246, 910256⟩, ⟨53065, 55101⟩, ⟨(-379), (-272)⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-101812164), (-56614340)⟩, ⟨(-25181040), (-18214725)⟩, ⟨(-1478614), (-1368685)⟩, ⟨14459, 20091⟩, ⟨520, 583⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1329843601, 1375041426⟩, ⟨(-25181040), (-18214725)⟩, ⟨(-1478614), (-1368685)⟩, ⟨14459, 20091⟩, ⟨520, 583⟩⟩
...
def j72 : Jet := ⟨⟨4771, 8509⟩, ⟨1575, 2123⟩, ⟨126, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847406), (-843667)⟩, ⟨1575, 2123⟩, ⟨126, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-611376), (-342381)⟩, ⟨(-152205), (-112595)⟩, ⟨(-9289), (-9031)⟩, ⟨32, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35180018, 35449014⟩, ⟨(-152205), (-112595)⟩, ⟨(-9289), (-9031)⟩, ⟨32, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14276946, 25575311⟩, ⟨4649171, 6348135⟩, ⟨362426, 380719⟩, ⟨(-3380), (-2455)⟩, ⟨(-102), (-90)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701550937), (-690252571)⟩, ⟨4649171, 6348135⟩, ⟨362426, 380719⟩, ⟨(-3380), (-2455)⟩, ⟨(-102), (-90)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-506146173), (-280122056)⟩, ⟨(-124649793), (-88794045)⟩, ⟨(-7132537), (-6361497)⟩, ⟨98997, 139237⟩, ⟨3401, 3924⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3788821123, 4014845240⟩, ⟨(-124649793), (-88794045)⟩, ⟨(-7132537), (-6361497)⟩, ⟨98997, 139237⟩, ⟨3401, 3924⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨847169290, 1167949746⟩, ⟨119806296, 134390133⟩, ⟨(-3929498), (-2805843)⟩, ⟨(-147780), (-128252)⟩, ⟨1866, 2630⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4594633907, 4868729211⟩, ⟨101616899, 160178080⟩, ⟨9527570, 14435245⟩, ⟨202875, 656399⟩, ⟨9267, 41993⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨906277621, 1323975401⟩, ⟨148208994, 195901170⟩, ⟨259406, 5935826⟩, ⟨(-8288), 426595⟩, ⟨(-9237), 25683⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1161230308), (-870922730)⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3133736988, 3424044566⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨191232917, 408131365⟩, ⟨62546922, 120777792⟩, ⟨5223810, 12594985⟩, ⟨12792, 804496⟩, ⟨(-6439), 62956⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4486200213, 4703098661⟩, ⟨62546922, 120777792⟩, ⟨5223810, 12594985⟩, ⟨12792, 804496⟩, ⟨(-6439), 62956⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4389542481, 4494402624⟩, ⟨29885727, 59087783⟩, ⟨2107590, 6060073⟩, ⟨(-75318), 379233⟩, ⟨(-12440), 31309⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3202741880, 3583038897⟩, ⟨(-130088434), (-101243963)⟩, ⟨(-459186), 3821202⟩, ⟨(-264854), 231106⟩, ⟨(-22735), 27507⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9354603854, 12472805157⟩, ⟨1559100638, 1559100650⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨20374686751, 36221665444⟩, ⟨6791562230, 9055416392⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨20374686751, 36221665444⟩, ⟨6791562230, 9055416392⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-36221665444), (-20374686751)⟩, ⟨(-9055416392), (-6791562230)⟩, ⟨(-565963527), (-565963517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-18110832722), (-10187343375)⟩, ⟨(-4527708196), (-3395781115)⟩, ⟨(-282981764), (-282981758)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨63335269, 400724242⟩, ⟨(-422439174), (-50075517)⟩, ⟨(-6606548), 218492451⟩, ⟨(-74577918), 20876969⟩, ⟨(-12699957), 19872452⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨47228885, 334300694⟩, ⟨(-364553552), (-38834118)⟩, ⟨(-4373884), 195427020⟩, ⟨(-69234355), 17683260⟩, ⟨(-11275376), 19060289⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1016076519, 1016076520⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4434934947, 4434934950⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar552 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2634
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar552 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨870922730, 1161230308⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4389542481, 4494402624⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2635
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((81111 / 400000) : ℝ)..(27037 / 100000), prawitzNormalCorrection
      ((143533 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
