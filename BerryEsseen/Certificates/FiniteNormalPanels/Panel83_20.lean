...
namespace FiniteNormalPanel83_20
...
def j2 : Jet := ⟨⟨1746319536, 1746319541⟩, ⟨582106510, 582106514⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨710047763, 710047768⟩, ⟨473365172, 473365180⟩, ⟨78894195, 78894197⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨177, 178⟩, ⟨118, 119⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94510), (-94508)⟩, ⟨118, 119⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-15625), (-15624)⟩, ⟨(-10398), (-10396)⟩, ⟨(-1721), (-1718)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097431, 5097433⟩, ⟨(-10398), (-10396)⟩, ⟨(-1721), (-1718)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨842711, 842713⟩, ⟨560087, 560091⟩, ⟨92202, 92206⟩, ⟨(-382), (-378)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-142322866), (-142322863)⟩, ⟨560087, 560091⟩, ⟨92202, 92206⟩, ⟨(-382), (-378)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-23528942), (-23528940)⟩, ⟨(-15593367), (-15593365)⟩, ⟨(-2537356), (-2537352)⟩, ⟨20385, 20390⟩, ⟨1644, 1649⟩⟩
...
def j19 : Jet := ⟨⟨1408126823, 1408126826⟩, ⟨(-15593367), (-15593365)⟩, ⟨(-2537356), (-2537352)⟩, ⟨20385, 20390⟩, ⟨1644, 1649⟩⟩
...
def j22 : Jet := ⟨⟨(-18), (-17)⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11817, 11819⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1953, 1954⟩, ⟨1300, 1302⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850224), (-850222)⟩, ⟨1300, 1302⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-140560), (-140559)⟩, ⟨(-93493), (-93490)⟩, ⟨(-15440), (-15437)⟩, ⟨45, 48⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35650834, 35650836⟩, ⟨(-93493), (-93490)⟩, ⟨(-15440), (-15437)⟩, ⟨45, 48⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5893827, 5893828⟩, ⟨3913761, 3913764⟩, ⟨642011, 642015⟩, ⟨(-3413), (-3410)⟩, ⟨(-280), (-276)⟩⟩
...
def j33 : Jet := ⟨⟨(-709934056), (-709934054)⟩, ⟨3913761, 3913764⟩, ⟨642011, 642015⟩, ⟨(-3413), (-3410)⟩, ⟨(-280), (-276)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-117366923), (-117366920)⟩, ⟨(-77597589), (-77597586)⟩, ⟨(-12503283), (-12503277)⟩, ⟨142084, 142088⟩, ⟨11369, 11374⟩⟩
...
def j36 : Jet := ⟨⟨4177600373, 4177600376⟩, ⟨(-77597589), (-77597586)⟩, ⟨(-12503283), (-12503277)⟩, ⟨142084, 142088⟩, ⟨11369, 11374⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨572539721, 572539725⟩, ⟨184506361, 184506365⟩, ⟨(-3145085), (-3145081)⟩, ⟨(-335606), (-335601)⟩, ⟨3430, 3435⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4415631562, 4415631566⟩, ⟨82018937, 82018944⟩, ⟨14739162, 14739172⟩, ⟨369067, 369076⟩, ⟨36153, 36165⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨588624845, 588624851⟩, ⟨200623462, 200623469⟩, ⟨2254784, 2254795⟩, ⟨277277, 277288⟩, ⟨6996, 7008⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-555870774), (-555870773)⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3739096522, 3739096523⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨80670977, 80670979⟩, ⟨54990850, 54990854⟩, ⟨9989414, 9989422⟩, ⟨286646, 286656⟩, ⟨29001, 29012⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4375638273, 4375638275⟩, ⟨54990850, 54990854⟩, ⟨9989414, 9989422⟩, ⟨286646, 286656⟩, ⟨29001, 29012⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4335115140, 4335115142⟩, ⟨27240787, 27240790⟩, ⟨4862863, 4862868⟩, ⟨111438, 111445⟩, ⟨10938, 10946⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3774048281, 3774048285⟩, ⟨(-163307105), (-163307100)⟩, ⟨3058291, 3058297⟩, ⟨(-112776), (-112767)⟩, ⟨4714, 4723⟩⟩
...
def j47 : Jet := ⟨⟨3352314345, 3352314353⟩, ⟨1117438111, 1117438118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2616553443, 2616553456⟩, ⟨1744368956, 1744368972⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2616553443, 2616553456⟩, ⟨1744368956, 1744368972⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2616553456), (-2616553443)⟩, ⟨(-1744368972), (-1744368956)⟩, ⟨(-290728162), (-290728158)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1308276728), (-1308276721)⟩, ⟨(-872184486), (-872184478)⟩, ⟨(-145364081), (-145364079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3167165512, 3167165524⟩, ⟨(-643160342), (-643160333)⟩, ⟨(-41889697), (-41889692)⟩, ⟨17347462, 17347464⟩, ⟨(-171811), (-171809)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2783032962, 2783032976⟩, ⟨(-685578869), (-685578855)⟩, ⟨(-10099025), (-10099012)⟩, ⟨16295090, 16295104⟩, ⟨(-820041), (-820027)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨370580515, 741161032⟩, ⟨185290257, 185290258⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1164213023, 2328426054⟩, ⟨582106510, 582106514⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨315576783, 1262307142⟩, ⟨315576782, 631153572⟩, ⟨78894195, 78894197⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨78, 317⟩, ⟨78, 159⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94609), (-94369)⟩, ⟨78, 159⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-27806), (-6933)⟩, ⟨(-13898), (-6886)⟩, ⟨(-1732), (-1703)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5085250, 5106124⟩, ⟨(-13898), (-6886)⟩, ⟨(-1732), (-1703)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨373643, 1500710⟩, ⟨369558, 749850⟩, ⟨90857, 93165⟩, ⟨(-511), (-249)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142791934), (-141664866)⟩, ⟨369558, 749850⟩, ⟨90857, 93165⟩, ⟨(-511), (-249)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-41967090), (-10408959)⟩, ⟨(-20956392), (-10188575)⟩, ⟨(-2589116), (-2464665)⟩, ⟨13312, 27447⟩, ⟨1582, 1692⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1389688675, 1421246807⟩, ⟨(-20956392), (-10188575)⟩, ⟨(-2589116), (-2464665)⟩, ⟨13312, 27447⟩, ⟨1582, 1692⟩⟩
...
def j70 : Jet := ⟨⟨(-32), (-7)⟩, ⟨(-16), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11803, 11829⟩, ⟨(-16), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨867, 3477⟩, ⟨862, 1739⟩, ⟨212, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851310), (-848699)⟩, ⟨862, 1739⟩, ⟨212, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-250204), (-62358)⟩, ⟨(-125039), (-61846)⟩, ⟨(-15560), (-15268)⟩, ⟨29, 65⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35541190, 35729037⟩, ⟨(-125039), (-61846)⟩, ⟨(-15560), (-15268)⟩, ⟨29, 65⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2611422, 10500900⟩, ⟨2574672, 5245906⟩, ⟨629906, 650642⟩, ⟨(-4582), (-2237)⟩, ⟨(-284), (-268)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713216461), (-705326982)⟩, ⟨2574672, 5245906⟩, ⟨629906, 650642⟩, ⟨(-4582), (-2237)⟩, ⟨(-284), (-268)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-209617017), (-51824566)⟩, ⟨(-104619333), (-50282774)⟩, ⟨(-12865606), (-11994018)⟩, ⟨92229, 191812⟩, ⟨10812, 11769⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4085350279, 4243142730⟩, ⟨(-104619333), (-50282774)⟩, ⟨(-12865606), (-11994018)⟩, ⟨92229, 191812⟩, ⟨10812, 11769⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨376695220, 770499021⟩, ⟨176986542, 189862996⟩, ⟨(-4243902), (-2048963)⟩, ⟨(-347301), (-319161)⟩, ⟨2232, 4638⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4347424832, 4515339644⟩, ⟨51518553, 115630678⟩, ⟨12899302, 17180849⟩, ⟨94369, 705976⟩, ⟨19827, 59518⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨381296070, 810032891⟩, ⟨183666702, 220348417⟩, ⟨(-1207337), 6119745⟩, ⟨60452, 538510⟩, ⟨(-18443), 36782⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-741161032), (-370580515)⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3553806264, 3924386781⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨33850477, 152772592⟩, ⟨32610906, 83115636⟩, ⟨7398772, 13613100⟩, ⟨(-113152), 831062⟩, ⟨(-3509), 77852⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4328817773, 4447739888⟩, ⟨32610906, 83115636⟩, ⟨7398772, 13613100⟩, ⟨(-113152), 831062⟩, ⟨(-3509), 77852⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4311859316, 4370686143⟩, ⟨16022973, 41395013⟩, ⟨3439269, 6750115⟩, ⟨(-121158), 401124⟩, ⟨(-10884), 38566⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3567783312, 3993572417⟩, ⟨(-175298896), (-148195651)⟩, ⟨1059938, 5476448⟩, ⟨(-401914), 218141⟩, ⟨(-27250), 40466⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2234876228, 4469752470⟩, ⟨1117438111, 1117438118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1162912639, 4651650587⟩, ⟨1162912636, 2325825296⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1162912639, 4651650587⟩, ⟨1162912636, 2325825296⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4651650587), (-1162912639)⟩, ⟨(-2325825296), (-1162912636)⟩, ⟨(-290728162), (-290728158)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2325825294), (-581456319)⟩, ⟨(-1162912648), (-581456318)⟩, ⟨(-145364081), (-145364079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2499074690, 3751152373⟩, ⟨(-1015668395), (-338326852)⟩, ⟨(-104057062), 52920339⟩, ⟨2857562, 32308565⟩, ⟨(-3082531), 1664202⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2075954567, 3487919143⟩, ⟨(-1097498033), (-367273784)⟩, ⟨(-84464435), 95444208⟩, ⟨(-1432285), 34395457⟩, ⟨(-4392959), 1646687⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4335115140, 4335115142⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1682
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4311859316, 4370686143⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1683
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (239865003 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((34513 / 400000) : ℝ)..(34513 / 200000), prawitzNormalCorrection
