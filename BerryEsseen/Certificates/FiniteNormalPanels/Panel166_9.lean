...
namespace FiniteNormalPanel166_9
...
def j2 : Jet := ⟨⟨434037288, 434037292⟩, ⟨434037288, 434037292⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨43862584, 43862586⟩, ⟨87725168, 87725172⟩, ⟨43862584, 43862586⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-967), (-966)⟩, ⟨(-1934), (-1932)⟩, ⟨(-967), (-964)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112089, 5112091⟩, ⟨(-1934), (-1932)⟩, ⟨(-967), (-964)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨52207, 52208⟩, ⟨104394, 104397⟩, ⟨52157, 52160⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143113370), (-143113368)⟩, ⟨104394, 104397⟩, ⟨52157, 52160⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1461554), (-1461552)⟩, ⟨(-2922041), (-2922038)⟩, ⟨(-1458890), (-1458886)⟩, ⟨2130, 2133⟩, ⟨530, 533⟩⟩
...
def j19 : Jet := ⟨⟨1430194211, 1430194214⟩, ⟨(-2922041), (-2922038)⟩, ⟨(-1458890), (-1458886)⟩, ⟨2130, 2133⟩, ⟨530, 533⟩⟩
...
def j25 : Jet := ⟨⟨120, 121⟩, ⟨240, 242⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852057), (-852055)⟩, ⟨240, 242⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8702), (-8701)⟩, ⟨(-17402), (-17400)⟩, ⟨(-8697), (-8694)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782692, 35782694⟩, ⟨(-17402), (-17400)⟩, ⟨(-8697), (-8694)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨365432, 365433⟩, ⟨730687, 730689⟩, ⟨364987, 364990⟩, ⟨(-356), (-353)⟩, ⟨(-90), (-86)⟩⟩
...
def j33 : Jet := ⟨⟨(-715462451), (-715462449)⟩, ⟨730687, 730689⟩, ⟨364987, 364990⟩, ⟨(-356), (-353)⟩, ⟨(-90), (-86)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7306700), (-7306698)⟩, ⟨(-14605937), (-14605934)⟩, ⟨(-7288049), (-7288045)⟩, ⟨14912, 14915⟩, ⟨3718, 3721⟩⟩
...
def j36 : Jet := ⟨⟨4287660596, 4287660598⟩, ⟨(-14605937), (-14605934)⟩, ⟨(-7288049), (-7288045)⟩, ⟨14912, 14915⟩, ⟨3718, 3721⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨144531395, 144531398⟩, ⟨144236101, 144236106⟩, ⟨(-442726), (-442722)⟩, ⟨(-147217), (-147214)⟩, ⟨268, 270⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302286445, 4302286448⟩, ⟨14655756, 14655761⟩, ⟨7362828, 7362835⟩, ⟨35025, 35032⟩, ⟨8848, 8856⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨144777694, 144777698⟩, ⟨144975081, 144975089⟩, ⟨296466, 296473⟩, ⟨99461, 99469⟩, ⟨479, 487⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-138158361), (-138158360)⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4156808935, 4156808936⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4880265, 4880266⟩, ⟨9773838, 9773840⟩, ⟨4913567, 4913571⟩, ⟨26718, 26722⟩, ⟨6766, 6771⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299847561, 4299847562⟩, ⟨9773838, 9773840⟩, ⟨4913567, 4913571⟩, ⟨26718, 26722⟩, ⟨6766, 6771⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297406735, 4297406737⟩, ⟨4884144, 4884146⟩, ⟨2452612, 2452616⟩, ⟨10563, 10566⟩, ⟨2667, 2672⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4159169903, 4159169907⟩, ⟨(-133509799), (-133509794)⟩, ⟨2216606, 2216612⟩, ⟨(-68672), (-68667)⟩, ⟨2241, 2248⟩⟩
...
def j47 : Jet := ⟨⟨1804872421, 1804872436⟩, ⟨1804872421, 1804872436⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨758460829, 758460842⟩, ⟨1516921658, 1516921684⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨758460829, 758460842⟩, ⟨1516921658, 1516921684⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-758460842), (-758460829)⟩, ⟨(-1516921684), (-1516921658)⟩, ⟨(-758460842), (-758460829)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-379230421), (-379230414)⟩, ⟨(-758460842), (-758460829)⟩, ⟨(-379230421), (-379230414)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3931997151, 3931997159⟩, ⟨(-694362884), (-694362870)⟩, ⟨(-285871658), (-285871647)⟩, ⟨57700825, 57700829⟩, ⟨10073337, 10073339⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3807676073, 3807676085⟩, ⟨(-794635472), (-794635451)⟩, ⟨(-253219360), (-253219341)⟩, ⟨64341594, 64341608⟩, ⟨7826814, 7826829⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 276316721⟩, ⟨138158360, 138158361⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 868074581⟩, ⟨434037288, 434037292⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 175450342⟩, ⟨0, 175450342⟩, ⟨43862584, 43862586⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3868), 0⟩, ⟨(-3868), 2⟩, ⟨(-967), (-963)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109188, 5113057⟩, ⟨(-3868), 2⟩, ⟨(-967), (-963)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 208870⟩, ⟨(-159), 208871⟩, ⟨51978, 52219⟩, ⟨(-80), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142956706)⟩, ⟨(-159), 208871⟩, ⟨51978, 52219⟩, ⟨(-80), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5848345), 0⟩, ⟨(-5848352), 8533⟩, ⟨(-1462094), (-1449286)⟩, ⟨(-6), 4269⟩, ⟨525, 535⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425807420, 1431655766⟩, ⟨(-5848352), 8533⟩, ⟨(-1462094), (-1449286)⟩, ⟨(-6), 4269⟩, ⟨525, 535⟩⟩
...
def j72 : Jet := ⟨⟨0, 484⟩, ⟨(-1), 484⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851692)⟩, ⟨(-1), 484⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-34812), 0⟩, ⟨(-34813), 20⟩, ⟨(-8704), (-8672)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35756582, 35791395⟩, ⟨(-34813), 20⟩, ⟨(-8704), (-8672)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1462087⟩, ⟨(-1423), 1462088⟩, ⟨363387, 365523⟩, ⟨(-713), 2⟩, ⟨(-91), (-86)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714365795)⟩, ⟨(-1423), 1462088⟩, ⟨363387, 365523⟩, ⟨(-713), 2⟩, ⟨(-91), (-86)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-29241724), 0⟩, ⟨(-29241783), 59727⟩, ⟨(-7310491), (-7220840)⟩, ⟨(-45), 29865⟩, ⟨3677, 3734⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4265725572, 4294967296⟩, ⟨(-29241783), 59727⟩, ⟨(-7310491), (-7220840)⟩, ⟨(-45), 29865⟩, ⟨3677, 3734⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 289358194⟩, ⟨142906042, 144680823⟩, ⟨(-886529), 863⟩, ⟨(-147758), (-145597)⟩, ⟨(-1), 541⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4324409474⟩, ⟨(-60550), 29644065⟩, ⟨7220427, 7614275⟩, ⟨(-30488), 103047⟩, ⟨7964, 10056⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 291341757⟩, ⟨142901962, 147669781⟩, ⟨(-894647), 1512448⟩, ⟨83299, 117855⟩, ⟨(-3622), 4700⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-276316721), 0⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4018650575, 4294967296⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19762670⟩, ⟨0, 20033854⟩, ⟨4633253, 5282380⟩, ⟨(-61520), 119994⟩, ⟨4734, 9277⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314729966⟩, ⟨0, 20033854⟩, ⟨4633253, 5282380⟩, ⟨(-61520), 119994⟩, ⟨4734, 9277⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304837291⟩, ⟨0, 10016927⟩, ⟨2299660, 2641190⟩, ⟨(-36920), 59997⟩, ⟨1411, 4110⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4018650575, 4304837291⟩, ⟨(-138475855), (-128141433)⟩, ⟨1829491, 2641190⟩, ⟨(-121881), (-13977)⟩, ⟨(-610), 5298⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3609744858⟩, ⟨1804872421, 1804872436⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3033843344⟩, ⟨0, 3033843356⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3033843344⟩, ⟨0, 3033843356⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3033843344), 0⟩, ⟨(-3033843356), 0⟩, ⟨(-758460842), (-758460829)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1516921672), 0⟩, ⟨(-1516921678), 0⟩, ⟨(-379230421), (-379230414)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3016985309, 4294967296⟩, ⟨(-1516921678), 0⟩, ⟨(-379230421), 1488511⟩, ⟨(-175241), 133938819⟩, ⟨(-11892040), 16757826⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2822887559, 4304837291⟩, ⟨(-1658883476), (-90012517)⟩, ⟨(-378816788), 53040835⟩, ⟨(-1278348), 146463727⟩, ⟨(-16471566), 16851249⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297406735, 4297406737⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3360
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304837291⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3361
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (119876689 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(12867 / 200000), prawitzNormalCorrection
