...
namespace FiniteNormalPanel88_16
...
def j2 : Jet := ⟨⟨1546706911, 1546706915⟩, ⟨515568969, 515568973⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨557001276, 557001280⟩, ⟨371334182, 371334188⟩, ⟨61889030, 61889032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨139, 140⟩, ⟨92, 94⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94548), (-94546)⟩, ⟨92, 94⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12262), (-12261)⟩, ⟨(-8164), (-8161)⟩, ⟨(-1355), (-1350)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100794, 5100796⟩, ⟨(-8164), (-8161)⟩, ⟨(-1355), (-1350)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨661506, 661507⟩, ⟨439945, 439947⟩, ⟨72618, 72621⟩, ⟨(-236), (-232)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-142504071), (-142504069)⟩, ⟨439945, 439947⟩, ⟨72618, 72621⟩, ⟨(-236), (-232)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18480921), (-18480920)⟩, ⟨(-12263559), (-12263557)⟩, ⟨(-2005983), (-2005980)⟩, ⟨12586, 12589⟩, ⟨1022, 1025⟩⟩
...
def j19 : Jet := ⟨⟨1413174844, 1413174846⟩, ⟨(-12263559), (-12263557)⟩, ⟨(-2005983), (-2005980)⟩, ⟨12586, 12589⟩, ⟨1022, 1025⟩⟩
...
def j22 : Jet := ⟨⟨(-15), (-13)⟩, ⟨(-10), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11820, 11823⟩, ⟨(-10), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1532, 1534⟩, ⟨1019, 1022⟩, ⟨168, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850645), (-850642)⟩, ⟨1019, 1022⟩, ⟨168, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-110318), (-110317)⟩, ⟨(-73414), (-73411)⟩, ⟨(-12149), (-12145)⟩, ⟨27, 30⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35681076, 35681078⟩, ⟨(-73414), (-73411)⟩, ⟨(-12149), (-12145)⟩, ⟨27, 30⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4627370, 4627371⟩, ⟨3075392, 3075394⟩, ⟨506228, 506232⟩, ⟨(-2106), (-2103)⟩, ⟨(-174), (-171)⟩⟩
...
def j33 : Jet := ⟨⟨(-711200513), (-711200511)⟩, ⟨3075392, 3075394⟩, ⟨506228, 506232⟩, ⟨(-2106), (-2103)⟩, ⟨(-174), (-171)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-92233438), (-92233436)⟩, ⟨(-61090121), (-61090118)⟩, ⟨(-9916617), (-9916614)⟩, ⟨87808, 87812⟩, ⟨7088, 7092⟩⟩
...
def j36 : Jet := ⟨⟨4202733858, 4202733860⟩, ⟨(-61090121), (-61090118)⟩, ⟨(-9916617), (-9916614)⟩, ⟨87808, 87812⟩, ⟨7088, 7092⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨508913606, 508913609⟩, ⟨165221505, 165221510⟩, ⟨(-2194518), (-2194515)⟩, ⟨(-236267), (-236264)⟩, ⟨1878, 1882⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4389224892, 4389224895⟩, ⟨63800914, 63800920⟩, ⟨11284047, 11284054⟩, ⟨222854, 222862⟩, ⟨21122, 21131⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨520082252, 520082257⟩, ⟨176407278, 176407286⟩, ⟨1548707, 1548716⟩, ⟨186434, 186443⟩, ⟨3717, 3728⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-492332102), (-492332101)⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3802635194, 3802635195⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨62977324, 62977326⟩, ⟨42722696, 42722700⟩, ⟨7620647, 7620653⟩, ⟨172370, 172376⟩, ⟨16772, 16779⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4357944620, 4357944622⟩, ⟨42722696, 42722700⟩, ⟨7620647, 7620653⟩, ⟨172370, 172376⟩, ⟨16772, 16779⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4326341366, 4326341368⟩, ⟨21206438, 21206441⟩, ⟨3730717, 3730722⟩, ⟨67272, 67277⟩, ⟨6385, 6391⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3830412854, 3830412858⟩, ⟨(-146533961), (-146533956)⟩, ⟨2492765, 2492773⟩, ⟨(-82991), (-82984)⟩, ⟨3082, 3089⟩⟩
...
def j47 : Jet := ⟨⟨3879227400, 3879227409⟩, ⟨1293075797, 1293075806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3503729873, 3503729890⟩, ⟨2335819910, 2335819932⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3503729873, 3503729890⟩, ⟨2335819910, 2335819932⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3503729890), (-3503729873)⟩, ⟨(-2335819932), (-2335819910)⟩, ⟨(-389303323), (-389303317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1751864945), (-1751864936)⟩, ⟨(-1167909966), (-1167909955)⟩, ⟨(-194651662), (-194651658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2856382881, 2856382892⟩, ⟨(-776722573), (-776722562)⟩, ⟨(-23848534), (-23848527)⟩, ⟨25629500, 25629503⟩, ⟨(-1201910), (-1201908)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2547429339, 2547429353⟩, ⟨(-790163230), (-790163215)⟩, ⟨6888710, 6888726⟩, ⟨23165002, 23165016⟩, ⟨(-1943113), (-1943099)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨328221400, 656442802⟩, ⟨164110700, 164110701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1031137938, 2062275885⟩, ⟨515568969, 515568973⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨247556121, 990224496⟩, ⟨247556120, 495112250⟩, ⟨61889030, 61889032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨61, 249⟩, ⟨61, 125⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94626), (-94437)⟩, ⟨61, 125⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-21817), (-5443)⟩, ⟨(-10906), (-5414)⟩, ⟨(-1361), (-1341)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5091239, 5107614⟩, ⟨(-10906), (-5414)⟩, ⟨(-1361), (-1341)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨293452, 1177584⟩, ⟨290937, 588480⟩, ⟨71791, 73210⟩, ⟨(-315), (-154)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142872125), (-141987992)⟩, ⟨290937, 588480⟩, ⟨71791, 73210⟩, ⟨(-315), (-154)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-32939827), (-8183996)⟩, ⟨(-16453145), (-8048319)⟩, ⟨(-2037834), (-1961281)⟩, ⟨8256, 16912⟩, ⟨992, 1047⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1398715938, 1423471770⟩, ⟨(-16453145), (-8048319)⟩, ⟨(-2037834), (-1961281)⟩, ⟨8256, 16912⟩, ⟨992, 1047⟩⟩
...
def j72 : Jet := ⟨⟨680, 2728⟩, ⟨677, 1364⟩, ⟨167, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851497), (-849448)⟩, ⟨677, 1364⟩, ⟨167, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-196317), (-48961)⟩, ⟨(-98120), (-48646)⟩, ⟨(-12222), (-12042)⟩, ⟨17, 40⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35595077, 35742434⟩, ⟨(-98120), (-48646)⟩, ⟨(-12222), (-12042)⟩, ⟨17, 40⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2051652, 8240583⟩, ⟨2029029, 4117489⟩, ⟨498783, 511540⟩, ⟨(-2823), (-1384)⟩, ⟨(-177), (-167)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713776231), (-707587299)⟩, ⟨2029029, 4117489⟩, ⟨498783, 511540⟩, ⟨(-2823), (-1384)⟩, ⟨(-177), (-167)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-164564399), (-40784377)⟩, ⟨(-82165250), (-39835070)⟩, ⟨(-10139577), (-9603502)⟩, ⟨57335, 118222⟩, ⟨6820, 7284⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4130402897, 4254182919⟩, ⟨(-82165250), (-39835070)⟩, ⟨(-10139577), (-9603502)⟩, ⟨57335, 118222⟩, ⟨6820, 7284⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨335804435, 683495660⟩, ⟨160002058, 168941672⟩, ⟨(-2953529), (-1436987)⟩, ⟨(-242641), (-227311)⟩, ⟨1229, 2534⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4336142668, 4466088306⟩, ⟨40602519, 88842971⟩, ⟨10168710, 12730976⟩, ⟨62761, 411163⟩, ⟨13425, 31710⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨339023754, 710727641⟩, ⟨164710509, 189811041⟩, ⟨(-763578), 4069850⟩, ⟨70321, 323129⟩, ⟨(-9148), 18306⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-656442802), (-328221400)⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3638524494, 3966745896⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨26760880, 117610624⟩, ⟨26002886, 62819550⟩, ⟨6063877, 9735429⟩, ⟨(-56392), 466670⟩, ⟨1640, 38479⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4321728176, 4412577920⟩, ⟨26002886, 62819550⟩, ⟨6063877, 9735429⟩, ⟨(-56392), 466670⟩, ⟨1640, 38479⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308326958, 4353375456⟩, ⟨12827005, 31312377⟩, ⟨2878649, 4833526⟩, ⟨(-63239), 224042⟩, ⟨(-3524), 18679⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3649842265, 4020690505⟩, ⟨(-155475952), (-135701686)⟩, ⟨1242230, 3974029⟩, ⟨(-243097), 96928⟩, ⟨(-11816), 19669⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2586151594, 5172303206⟩, ⟨1293075797, 1293075806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1557213269, 6228853123⟩, ⟨1557213268, 3114426574⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1557213269, 6228853123⟩, ⟨1557213268, 3114426574⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6228853123), (-1557213269)⟩, ⟨(-3114426574), (-1557213268)⟩, ⟨(-389303323), (-389303317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3114426562), (-778606634)⟩, ⟨(-1557213287), (-778606634)⟩, ⟨(-194651662), (-194651658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2079879581, 3582856752⟩, ⟨(-1299025524), (-377047816)⟩, ⟨(-128201921), 141229922⟩, ⟨(-5676346), 54742574⟩, ⟨(-8162295), 3419626⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1767471526, 3354055371⟩, ⟨(-1345767560), (-386128252)⟩, ⟨(-107500362), 182550266⟩, ⟨(-11831066), 55859370⟩, ⟨(-9780506), 3627342⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4326341366, 4326341368⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1788
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308326958, 4353375456⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1789
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (194905471 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((3821 / 50000) : ℝ)..(3821 / 25000), prawitzNormalCorrection
