...
namespace FiniteNormalPanel77_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (30973 / 800000)
def radius : Rat := (30973 / 800000)

def j0 : Jet := ⟨⟨166285027, 166285028⟩, ⟨166285027, 166285028⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨522399819, 522399823⟩, ⟨522399819, 522399823⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨63539848, 63539850⟩, ⟨127079696, 127079700⟩, ⟨63539848, 63539850⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨15, 16⟩, ⟨31, 32⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94672), (-94670)⟩, ⟨31, 32⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1401), (-1400)⟩, ⟨(-2802), (-2800)⟩, ⟨(-1401), (-1398)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111655, 5111657⟩, ⟨(-2802), (-2800)⟩, ⟨(-1401), (-1398)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨75621, 75622⟩, ⟨151201, 151203⟩, ⟨75517, 75520⟩, ⟨(-84), (-81)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-143089956), (-143089954)⟩, ⟨151201, 151203⟩, ⟨75517, 75520⟩, ⟨(-84), (-81)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2116877), (-2116876)⟩, ⟨(-4231517), (-4231515)⟩, ⟨(-2111287), (-2111284)⟩, ⟨4468, 4471⟩, ⟨1113, 1116⟩⟩
...
def j19 : Jet := ⟨⟨1429538888, 1429538890⟩, ⟨(-4231517), (-4231515)⟩, ⟨(-2111287), (-2111284)⟩, ⟨4468, 4471⟩, ⟨1113, 1116⟩⟩
...
def j25 : Jet := ⟨⟨175, 176⟩, ⟨349, 351⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852002), (-852000)⟩, ⟨349, 351⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-12605), (-12604)⟩, ⟨(-25205), (-25203)⟩, ⟨(-12593), (-12590)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778789, 35778791⟩, ⟨(-25205), (-25203)⟩, ⟨(-12593), (-12590)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨529312, 529313⟩, ⟨1058251, 1058253⟩, ⟨528379, 528382⟩, ⟨(-746), (-743)⟩, ⟨(-187), (-184)⟩⟩
...
def j33 : Jet := ⟨⟨(-715298571), (-715298569)⟩, ⟨1058251, 1058253⟩, ⟨528379, 528382⟩, ⟨(-746), (-743)⟩, ⟨(-187), (-184)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10582145), (-10582143)⟩, ⟨(-21148634), (-21148631)⟩, ⟨(-10543018), (-10543014)⟩, ⟨31276, 31280⟩, ⟨7790, 7794⟩⟩
...
def j36 : Jet := ⟨⟨4284385151, 4284385153⟩, ⟨(-21148634), (-21148631)⟩, ⟨(-10543018), (-10543014)⟩, ⟨31276, 31280⟩, ⟨7790, 7794⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨173875795, 173875798⟩, ⟨173361112, 173361116⟩, ⟨(-771481), (-771478)⟩, ⟨(-256255), (-256252)⟩, ⟨678, 680⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305575576, 4305575579⟩, ⟨21253230, 21253235⟩, ⟨10700068, 10700075⟩, ⟨73681, 73689⟩, ⟨18704, 18713⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨174305256, 174305260⟩, ⟨174649709, 174649715⟩, ⟨517650, 517656⟩, ⟨174171, 174179⟩, ⟨1219, 1226⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-166285028), (-166285027)⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4128682268, 4128682269⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7073935, 7073936⟩, ⟨14175828, 14175832⟩, ⟨7143937, 7143941⟩, ⟨56234, 56238⟩, ⟨14324, 14329⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302041231, 4302041232⟩, ⟨14175828, 14175832⟩, ⟨7143937, 7143941⟩, ⟨56234, 56238⟩, ⟨14324, 14329⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298502808, 4298502809⟩, ⟨7082084, 7082087⟩, ⟨3563196, 3563199⟩, ⟨22222, 22226⟩, ⟨5641, 5646⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4132080898, 4132080901⟩, ⟨(-159614018), (-159614012)⟩, ⟨3151050, 3151055⟩, ⟨(-116593), (-116587)⟩, ⟨4561, 4568⟩⟩
...
def j47 : Jet := ⟨⟨1348572510, 1348572519⟩, ⟨1348572510, 1348572519⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨423436941, 423436947⟩, ⟨846873882, 846873894⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨423436941, 423436947⟩, ⟨846873882, 846873894⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-423436947), (-423436941)⟩, ⟨(-846873894), (-846873882)⟩, ⟨(-423436947), (-423436941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-211718474), (-211718470)⟩, ⟨(-423436947), (-423436941)⟩, ⟨(-211718474), (-211718470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4088382407, 4088382412⟩, ⟨(-403069930), (-403069923)⟩, ⟨(-181665816), (-181665810)⟩, ⟨19216188, 19216190⟩, ⟨4003940, 4003941⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3933330729, 3933330738⟩, ⟨(-539720223), (-539720208)⟩, ⟨(-156797365), (-156797350)⟩, ⟨24831964, 24831976⟩, ⟨3019958, 3019971⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 332570056⟩, ⟨166285027, 166285028⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1044799645⟩, ⟨522399819, 522399823⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 254159398⟩, ⟨0, 254159398⟩, ⟨63539848, 63539850⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 64⟩, ⟨0, 64⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94622)⟩, ⟨0, 64⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5604), 0⟩, ⟨(-5604), 4⟩, ⟨(-1401), (-1394)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107452, 5113057⟩, ⟨(-5604), 4⟩, ⟨(-1401), (-1394)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 302571⟩, ⟨(-332), 302572⟩, ⟨75144, 75644⟩, ⟨(-166), 2⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142863005)⟩, ⟨(-332), 302572⟩, ⟨75144, 75644⟩, ⟨(-166), 2⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8471980), 0⟩, ⟨(-8472000), 17906⟩, ⟨(-2118016), (-2091135)⟩, ⟨(-15), 8955⟩, ⟨1099, 1121⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423183785, 1431655766⟩, ⟨(-8472000), 17906⟩, ⟨(-2118016), (-2091135)⟩, ⟨(-15), 8955⟩, ⟨1099, 1121⟩⟩
...
def j72 : Jet := ⟨⟨0, 701⟩, ⟨(-1), 701⟩, ⟨172, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851475)⟩, ⟨(-1), 701⟩, ⟨172, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-50429), 0⟩, ⟨(-50430), 42⟩, ⟨(-12609), (-12543)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35740965, 35791395⟩, ⟨(-50430), 42⟩, ⟨(-12609), (-12543)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2117996⟩, ⟨(-2985), 2117999⟩, ⟨525020, 529502⟩, ⟨(-1495), 3⟩, ⟨(-188), (-182)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713709886)⟩, ⟨(-2985), 2117999⟩, ⟨525020, 529502⟩, ⟨(-1495), 3⟩, ⟨(-188), (-182)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-42359900), 0⟩, ⟨(-42360077), 125335⟩, ⟨(-10590153), (-10401971)⟩, ⟨(-134), 62669⟩, ⟨7666, 7835⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4252607396, 4294967296⟩, ⟨(-42360077), 125335⟩, ⟨(-10590153), (-10401971)⟩, ⟨(-134), 62669⟩, ⟨7666, 7835⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 348266549⟩, ⟨171041909, 174137631⟩, ⟨(-1545688), 2178⟩, ⟨(-257620), (-252167)⟩, ⟨(-2), 1363⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4337749140⟩, ⟨(-127845), 43208172⟩, ⟨10400710, 11232576⟩, ⟨(-64575), 219626⟩, ⟨16007, 22422⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 351735606⟩, ⟨171031542, 179375830⟩, ⟨(-1566269), 2664876⟩, ⟨133221, 221110⟩, ⟨(-9257), 12115⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-332570056), 0⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3962397240, 4294967296⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 28805327⟩, ⟨0, 29379906⟩, ⟨6554172, 7927967⟩, ⟨(-130828), 258810⟩, ⟨8120, 22110⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4323772623⟩, ⟨0, 29379906⟩, ⟨6554172, 7927967⟩, ⟨(-130828), 258810⟩, ⟨8120, 22110⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309345892⟩, ⟨0, 14689953⟩, ⟨3241113, 3963984⟩, ⟨(-78972), 129405⟩, ⟨1781, 10104⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3962397240, 4309345892⟩, ⟨(-166841714), (-151595074)⟩, ⟨2421405, 3963984⟩, ⟨(-232443), 3922⟩, ⟨(-3368), 13162⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2697145038⟩, ⟨1348572510, 1348572519⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1693747788⟩, ⟨0, 1693747788⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1693747788⟩, ⟨0, 1693747788⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1693747788), 0⟩, ⟨(-1693747788), 0⟩, ⟨(-423436947), (-423436941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-846873894), 0⟩, ⟨(-846873894), 0⟩, ⟨(-211718474), (-211718470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3526358481, 4294967296⟩, ⟨(-846873894), 0⟩, ⟨(-211718474), (-90337713)⟩, ⟨0, 41746267⟩, ⟨168714, 5218284⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3253303727, 4309345892⟩, ⟨(-1016550754), (-124466273)⟩, ⟨(-210439181), (-46481106)⟩, ⟨2174502, 50114334⟩, ⟨(-1665565), 5243819⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨166285027, 166285028⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298502808, 4298502809⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1548
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 332570056⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309345892⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1549
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (300601771 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(30973 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (30973 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(30973 / 400000), prawitzNormalCorrection
