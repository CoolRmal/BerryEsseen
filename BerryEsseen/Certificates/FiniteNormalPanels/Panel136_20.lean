...
namespace FiniteNormalPanel136_20
...
def j2 : Jet := ⟨⟨1449810034, 1449810038⟩, ⟨483270010, 483270014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨489398169, 489398173⟩, ⟨326265444, 326265450⟩, ⟨54377574, 54377576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨122, 123⟩, ⟨81, 82⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94565), (-94563)⟩, ⟨81, 82⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10776), (-10775)⟩, ⟨(-7175), (-7173)⟩, ⟨(-1191), (-1188)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102280, 5102282⟩, ⟨(-7175), (-7173)⟩, ⟨(-1191), (-1188)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨581388, 581390⟩, ⟨386774, 386776⟩, ⟨63916, 63920⟩, ⟨(-182), (-179)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-142584189), (-142584186)⟩, ⟨386774, 386776⟩, ⟨63916, 63920⟩, ⟨(-182), (-179)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16247026), (-16247024)⟩, ⟨(-10787280), (-10787277)⟩, ⟨(-1768562), (-1768558)⟩, ⟨9730, 9733⟩, ⟨793, 796⟩⟩
...
def j19 : Jet := ⟨⟨1415408739, 1415408742⟩, ⟨(-10787280), (-10787277)⟩, ⟨(-1768562), (-1768558)⟩, ⟨9730, 9733⟩, ⟨793, 796⟩⟩
...
def j22 : Jet := ⟨⟨(-13), (-12)⟩, ⟨(-9), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11822, 11824⟩, ⟨(-9), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1347, 1348⟩, ⟨896, 899⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850830), (-850828)⟩, ⟨896, 899⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-96950), (-96949)⟩, ⟨(-64531), (-64529)⟩, ⟨(-10689), (-10685)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35694444, 35694446⟩, ⟨(-64531), (-64529)⟩, ⟨(-10689), (-10685)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4067270, 4067272⟩, ⟨2704159, 2704163⟩, ⟨445797, 445802⟩, ⟨(-1628), (-1624)⟩, ⟨(-136), (-132)⟩⟩
...
def j33 : Jet := ⟨⟨(-711760613), (-711760610)⟩, ⟨2704159, 2704163⟩, ⟨445797, 445802⟩, ⟨(-1628), (-1624)⟩, ⟨(-136), (-132)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-81102910), (-81102908)⟩, ⟨(-53760477), (-53760474)⟩, ⟨(-8755218), (-8755215)⟩, ⟨67914, 67918⟩, ⟨5504, 5507⟩⟩
...
def j36 : Jet := ⟨⟨4213864386, 4213864388⟩, ⟨(-53760477), (-53760474)⟩, ⟨(-8755218), (-8755215)⟩, ⟨67914, 67918⟩, ⟨5504, 5507⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨477785661, 477785665⟩, ⟨155620529, 155620534⟩, ⟨(-1810783), (-1810779)⟩, ⟨(-195715), (-195712)⟩, ⟨1361, 1365⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4377631165, 4377631168⟩, ⟨55849809, 55849814⟩, ⟨9808005, 9808012⟩, ⟨170610, 170618⟩, ⟨15931, 15939⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨486981449, 486981455⟩, ⟨164828615, 164828623⟩, ⟨1269056, 1269065⟩, ⟨151325, 151333⟩, ⟨2659, 2670⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-461488868), (-461488867)⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3833478428, 3833478429⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨55216004, 55216006⟩, ⟨37377922, 37377926⟩, ⟨6613432, 6613438⟩, ⟨131718, 131726⟩, ⟨12590, 12597⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4350183300, 4350183302⟩, ⟨37377922, 37377926⟩, ⟨6613432, 6613438⟩, ⟨131718, 131726⟩, ⟨12590, 12597⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4322487131, 4322487133⟩, ⟨18569974, 18569977⟩, ⟨3245773, 3245777⟩, ⟨51495, 51501⟩, ⟨4814, 4820⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3858041291, 3858041294⟩, ⟨(-138240628), (-138240622)⟩, ⟨2231911, 2231917⟩, ⟨(-70291), (-70283)⟩, ⟨2451, 2459⟩⟩
...
def j47 : Jet := ⟨⟨3923914923, 3923914934⟩, ⟨1307971638, 1307971648⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3584918641, 3584918662⟩, ⟨2389945754, 2389945782⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3584918641, 3584918662⟩, ⟨2389945754, 2389945782⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3584918662), (-3584918641)⟩, ⟨(-2389945782), (-2389945754)⟩, ⟨(-398324298), (-398324291)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1792459331), (-1792459320)⟩, ⟨(-1194972891), (-1194972877)⟩, ⟨(-199162149), (-199162145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2829512626, 2829512640⟩, ⟨(-787244854), (-787244840)⟩, ⟨(-21691365), (-21691358)⟩, ⟨26348615, 26348618⟩, ⟨(-1329795), (-1329793)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2541666977, 2541666992⟩, ⟨(-798231169), (-798231150)⟩, ⟨7324444, 7324459⟩, ⟨23910941, 23910954⟩, ⟨(-2039367), (-2039354)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨307659244, 615318490⟩, ⟨153829622, 153829623⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨966540020, 1933080048⟩, ⟨483270010, 483270014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨217510296, 870041194⟩, ⟨217510296, 435020600⟩, ⟨54377574, 54377576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨54, 218⟩, ⟨54, 109⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94633), (-94468)⟩, ⟨54, 109⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-19171), (-4784)⟩, ⟨(-9584), (-4761)⟩, ⟨(-1197), (-1181)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5093885, 5108273⟩, ⟨(-9584), (-4761)⟩, ⟨(-1197), (-1181)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨257969, 1034795⟩, ⟨256027, 517157⟩, ⟨63278, 64375⟩, ⟨(-244), (-118)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142907608), (-142130781)⟩, ⟨256027, 517157⟩, ⟨63278, 64375⟩, ⟨(-244), (-118)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-28949116), (-7197937)⟩, ⟨(-14461594), (-7093175)⟩, ⟨(-1793151), (-1734062)⟩, ⟨6395, 13064⟩, ⟨772, 811⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1402706649, 1424457829⟩, ⟨(-14461594), (-7093175)⟩, ⟨(-1793151), (-1734062)⟩, ⟨6395, 13064⟩, ⟨772, 811⟩⟩
...
def j72 : Jet := ⟨⟨598, 2397⟩, ⟨595, 1199⟩, ⟨146, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851579), (-849779)⟩, ⟨595, 1199⟩, ⟨146, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-172507), (-43035)⟩, ⟨(-86224), (-42792)⟩, ⟨(-10745), (-10605)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35618887, 35748360⟩, ⟨(-86224), (-42792)⟩, ⟨(-10745), (-10605)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1803849, 7241626⟩, ⟨1786382, 3618646⟩, ⟨440051, 449898⟩, ⟨(-2181), (-1071)⟩, ⟨(-138), (-129)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714024034), (-708586256)⟩, ⟨1786382, 3618646⟩, ⟨440051, 449898⟩, ⟨(-2181), (-1071)⟩, ⟨(-138), (-129)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-144641456), (-35884977)⟩, ⟨(-72230262), (-35151939)⟩, ⟨(-8927340), (-8513588)⟩, ⟨44459, 91330⟩, ⟨5322, 5637⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4150325840, 4259082319⟩, ⟨(-72230262), (-35151939)⟩, ⟨(-8927340), (-8513588)⟩, ⟨44459, 91330⟩, ⟨5322, 5637⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨315665293, 641120367⟩, ⟨151323767, 158683844⟩, ⟨(-2434282), (-1188357)⟩, ⟨(-200327), (-189236)⟩, ⟨892, 1836⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4331154622, 4444649598⟩, ⟨35746780, 77352531⟩, ⟨8952686, 10906637⟩, ⟨50035, 309805⟩, ⟨10765, 22918⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨318324936, 663463814⟩, ⟨155226013, 175760680⟩, ⟨(-601669), 3287595⟩, ⟨67954, 248488⟩, ⟨(-6338), 12717⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-615318490), (-307659244)⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3679648806, 3987308052⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨23592907, 102488379⟩, ⟨23009400, 54301160⟩, ⟨5424195, 8208264⟩, ⟨(-39172), 345846⟩, ⟨2489, 26785⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4318560203, 4397455675⟩, ⟨23009400, 54301160⟩, ⟨5424195, 8208264⟩, ⟨(-39172), 345846⟩, ⟨2489, 26785⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306747593, 4345909377⟩, ⟨11369843, 27076315⟩, ⟨2595959, 4077899⟩, ⟨(-45171), 165597⟩, ⟨(-1731), 12858⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3689741398, 4034601025⟩, ⟨(-145913236), (-129114777)⟩, ⟨1254275, 3378564⟩, ⟨(-187992), 60758⟩, ⟨(-7540), 13555⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2615943276, 5231886572⟩, ⟨1307971638, 1307971648⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1593297166, 6373188716⟩, ⟨1593297166, 3186594370⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1593297166, 6373188716⟩, ⟨1593297166, 3186594370⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6373188716), (-1593297166)⟩, ⟨(-3186594370), (-1593297166)⟩, ⟨(-398324298), (-398324291)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3186594358), (-796648583)⟩, ⟨(-1593297185), (-796648583)⟩, ⟨(-199162149), (-199162145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2045223601, 3567837747⟩, ⟨(-1323555093), (-379356668)⟩, ⟨(-130262054), 150659398⟩, ⟨(-6902515), 57024130⟩, ⟨(-8781656), 3660349⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1757020640, 3351550976⟩, ⟨(-1364529946), (-387382830)⟩, ⟨(-110363959), 189298052⟩, ⟨(-12799758), 57932348⟩, ⟨(-10314044), 3860663⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4322487131, 4322487133⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2746
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306747593, 4345909377⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2747
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (182296161 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((28653 / 400000) : ℝ)..(28653 / 200000), prawitzNormalCorrection
