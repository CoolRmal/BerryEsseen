...
namespace FiniteNormalPanel68_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (47889 / 400000)
def radius : Rat := (15963 / 400000)

def j0 : Jet := ⟨⟨514204222, 514204223⟩, ⟨171401407, 171401408⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1615420206, 1615420210⟩, ⟨538473401, 538473405⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨607590759, 607590763⟩, ⟨405060504, 405060510⟩, ⟨67510084, 67510086⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨152, 153⟩, ⟨101, 102⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94535), (-94533)⟩, ⟨101, 102⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-13374), (-13373)⟩, ⟨(-8902), (-8900)⟩, ⟨(-1475), (-1472)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5099682, 5099684⟩, ⟨(-8902), (-8900)⟩, ⟨(-1475), (-1472)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨721430, 721431⟩, ⟨479693, 479695⟩, ⟨79109, 79112⟩, ⟨(-280), (-276)⟩, ⟨(-24), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-142444147), (-142444145)⟩, ⟨479693, 479695⟩, ⟨79109, 79112⟩, ⟨(-280), (-276)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-20150968), (-20150967)⟩, ⟨(-13366119), (-13366117)⟩, ⟨(-2182566), (-2182563)⟩, ⟨14960, 14964⟩, ⟨1212, 1216⟩⟩
...
def j19 : Jet := ⟨⟨1411504797, 1411504799⟩, ⟨(-13366119), (-13366117)⟩, ⟨(-2182566), (-2182563)⟩, ⟨14960, 14964⟩, ⟨1212, 1216⟩⟩
...
def j22 : Jet := ⟨⟨(-16), (-15)⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11819, 11821⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1671, 1673⟩, ⟨1112, 1114⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850506), (-850503)⟩, ⟨1112, 1114⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-120318), (-120317)⟩, ⟨(-80055), (-80053)⟩, ⟨(-13240), (-13235)⟩, ⟨33, 36⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35671076, 35671078⟩, ⟨(-80055), (-80053)⟩, ⟨(-13240), (-13235)⟩, ⟨33, 36⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5046235, 5046236⟩, ⟨3352830, 3352834⟩, ⟨551267, 551272⟩, ⟨(-2504), (-2500)⟩, ⟨(-206), (-203)⟩⟩
...
def j33 : Jet := ⟨⟨(-710781648), (-710781646)⟩, ⟨3352830, 3352834⟩, ⟨551267, 551272⟩, ⟨(-2504), (-2500)⟩, ⟨(-206), (-203)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-100551258), (-100551256)⟩, ⟨(-66559863), (-66559858)⟩, ⟨(-10778171), (-10778166)⟩, ⟨104336, 104340⟩, ⟨8398, 8403⟩⟩
...
def j36 : Jet := ⟨⟨4194416038, 4194416040⟩, ⟨(-66559863), (-66559858)⟩, ⟨(-10778171), (-10778166)⟩, ⟨104336, 104340⟩, ⟨8398, 8403⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨530894233, 530894236⟩, ⟨171937488, 171937492⟩, ⟨(-2496658), (-2496655)⟩, ⟨(-268010), (-268005)⟩, ⟨2330, 2335⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4397929031, 4397929034⟩, ⟨69789340, 69789348⟩, ⟨12408586, 12408594⟩, ⟨266838, 266846⟩, ⟨25571, 25581⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨543621173, 543621177⟩, ⟨184685835, 184685842⟩, ⟨1771124, 1771132⟩, ⟨214723, 214733⟩, ⟨4658, 4670⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-514204223), (-514204222)⟩, ⟨(-171401408), (-171401407)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3780763073, 3780763074⟩, ⟨(-171401408), (-171401407)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨68807038, 68807040⟩, ⟨46751988, 46751992⟩, ⟨8389935, 8389940⟩, ⟨206672, 206680⟩, ⟨20374, 20383⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4363774334, 4363774336⟩, ⟨46751988, 46751992⟩, ⟨8389935, 8389940⟩, ⟨206672, 206680⟩, ⟨20374, 20383⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4329234118, 4329234120⟩, ⟨23190967, 23190970⟩, ⟨4099648, 4099651⟩, ⟨80556, 80562⟩, ⟨7732, 7740⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3810927385, 3810927389⟩, ⟨(-152354426), (-152354420)⟩, ⟨2683333, 2683338⟩, ⟨(-92696), (-92689)⟩, ⟨3590, 3600⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨31803813257, 31803813264⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value353

def j47 : Jet := ⟨⟨3807632031, 3807632041⟩, ⟨1269210674, 1269210683⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3375593033, 3375593052⟩, ⟨2250395350, 2250395374⟩, ⟨375065890, 375065897⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3375593033, 3375593052⟩, ⟨2250395350, 2250395374⟩, ⟨375065890, 375065897⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3375593052), (-3375593033)⟩, ⟨(-2250395374), (-2250395350)⟩, ⟨(-375065897), (-375065890)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1687796526), (-1687796516)⟩, ⟨(-1125197687), (-1125197675)⟩, ⟨(-187532949), (-187532945)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2899311192, 2899311204⟩, ⟨(-759563004), (-759562992)⟩, ⟨(-27098490), (-27098483)⟩, ⟨24476501, 24476504⟩, ⟨(-1011486), (-1011484)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2572560780, 2572560794⟩, ⟨(-776807394), (-776807377)⟩, ⟨4710679, 4710693⟩, ⟨22142150, 22142163⟩, ⟨(-1763859), (-1763844)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨342802814, 685605630⟩, ⟨171401407, 171401408⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1076946802, 2153893611⟩, ⟨538473401, 538473405⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨270040336, 1080161354⟩, ⟨270040336, 540080680⟩, ⟨67510084, 67510086⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨67, 271⟩, ⟨67, 136⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94620), (-94415)⟩, ⟨67, 136⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-23797), (-5936)⟩, ⟨(-11895), (-5901)⟩, ⟨(-1483), (-1461)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5089259, 5107121⟩, ⟨(-11895), (-5901)⟩, ⟨(-1483), (-1461)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨319980, 1284414⟩, ⟨316988, 641836⟩, ⟨78126, 79814⟩, ⟨(-374), (-181)⟩, ⟨(-24), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142845597), (-141881162)⟩, ⟨316988, 641836⟩, ⟨78126, 79814⟩, ⟨(-374), (-181)⟩, ⟨(-24), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-35924906), (-8920588)⟩, ⟨(-17942523), (-8759169)⟩, ⟨(-2220465), (-2129364)⟩, ⟨9799, 20115⟩, ⟨1173, 1243⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1395730859, 1422735178⟩, ⟨(-17942523), (-8759169)⟩, ⟨(-2220465), (-2129364)⟩, ⟨9799, 20115⟩, ⟨1173, 1243⟩⟩
...
def j70 : Jet := ⟨⟨(-28), (-6)⟩, ⟨(-14), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11807, 11830⟩, ⟨(-14), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨742, 2976⟩, ⟨738, 1488⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851435), (-849200)⟩, ⟨738, 1488⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-214132), (-53392)⟩, ⟨(-107020), (-53017)⟩, ⟨(-13327), (-13113)⟩, ⟨21, 48⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35577262, 35738003⟩, ⟨(-107020), (-53017)⟩, ⟨(-13327), (-13113)⟩, ⟨21, 48⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2236872, 8987918⟩, ⟨2209957, 4490626⟩, ⟨542408, 557588⟩, ⟨(-3358), (-1644)⟩, ⟨(-209), (-198)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713591011), (-706839964)⟩, ⟨2209957, 4490626⟩, ⟨542408, 557588⟩, ⟨(-3358), (-1644)⟩, ⟨(-209), (-198)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-179464332), (-44441619)⟩, ⟨(-89593219), (-43312250)⟩, ⟨(-11043470), (-10405488)⟩, ⟨67995, 140599⟩, ⟨8049, 8650⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4115502964, 4250525677⟩, ⟨(-89593219), (-43312250)⟩, ⟨(-11043470), (-10405488)⟩, ⟨67995, 140599⟩, ⟨8049, 8650⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨349974232, 713490930⟩, ⟨165989076, 176176406⟩, ⟨(-3363057), (-1632093)⟩, ⟨(-275930), (-256876)⟩, ⟨1522, 3146⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4339873576, 4482257512⟩, ⟨44222691, 97577352⟩, ⟨11074838, 14151843⟩, ⟨72844, 498219⟩, ⟨15502, 39604⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨353633407, 744604059⟩, ⟨171328057, 200068713⟩, ⟨(-898191), 4704336⟩, ⟨69579, 386900⟩, ⟨(-11736), 23449⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-685605630), (-342802814)⟩, ⟨(-171401408), (-171401407)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3609361666, 3952164482⟩, ⟨(-171401408), (-171401407)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨29117005, 129089506⟩, ⟨28213170, 69370484⟩, ⟨6522914, 10950777⟩, ⟨(-72224), 572428⟩, ⟨496, 49331⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4324084301, 4424056802⟩, ⟨28213170, 69370484⟩, ⟨6522914, 10950777⟩, ⟨(-72224), 572428⟩, ⟨496, 49331⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4309501207, 4359034215⟩, ⟨13899253, 34568266⟩, ⟨3076453, 5434509⟩, ⟨(-79583), 275328⟩, ⟨(-5389), 24124⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3621575528, 4011117900⟩, ⟨(-162277644), (-140172219)⟩, ⟨1205824, 4446070⟩, ⟨(-290110), 130580⟩, ⟨(-15947), 25375⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2538421349, 5076842716⟩, ⟨1269210674, 1269210683⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1500263564, 6001054301⟩, ⟨1500263562, 3000527160⟩, ⟨375065890, 375065897⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1500263564, 6001054301⟩, ⟨1500263562, 3000527160⟩, ⟨375065890, 375065897⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6001054301), (-1500263564)⟩, ⟨(-3000527160), (-1500263562)⟩, ⟨(-375065897), (-375065890)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3000527151), (-750131782)⟩, ⟨(-1500263580), (-750131781)⟩, ⟨(-187532949), (-187532945)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2135774344, 3606689357⟩, ⟨(-1259843048), (-373020817)⟩, ⟨(-124905657), 126781005⟩, ⟨(-3903603), 51216190⟩, ⟨(-7240394), 3067794⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1800914317, 3368327450⟩, ⟨(-1312853782), (-384240246)⟩, ⟨(-103877112), 169736687⟩, ⟨(-9983600), 52555638⟩, ⟨(-8877994), 3250188⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨514204222, 514204223⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨171401407, 171401408⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4329234118, 4329234120⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar353 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1346
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar353 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨342802814, 685605630⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4309501207, 4359034215⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1347
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((15963 / 200000) : ℝ)..(15963 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (15963 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (15963 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((15963 / 200000) : ℝ)..(15963 / 100000), prawitzNormalCorrection
      ((279879 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
