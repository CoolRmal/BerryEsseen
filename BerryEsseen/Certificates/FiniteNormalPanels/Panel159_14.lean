...
namespace FiniteNormalPanel159_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (25427 / 800000)
def radius : Rat := (25427 / 800000)

def j0 : Jet := ⟨⟨136510166, 136510167⟩, ⟨136510166, 136510167⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨428859334, 428859338⟩, ⟨428859334, 428859338⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨42822288, 42822290⟩, ⟨85644576, 85644580⟩, ⟨42822288, 42822290⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨10, 11⟩, ⟨21, 22⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94677), (-94675)⟩, ⟨21, 22⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-944), (-943)⟩, ⟨(-1888), (-1886)⟩, ⟨(-944), (-941)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112112, 5112114⟩, ⟨(-1888), (-1886)⟩, ⟨(-944), (-941)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨50969, 50970⟩, ⟨101919, 101922⟩, ⟨50921, 50924⟩, ⟨(-38), (-35)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143114608), (-143114606)⟩, ⟨101919, 101922⟩, ⟨50921, 50924⟩, ⟨(-38), (-35)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1426902), (-1426901)⟩, ⟨(-2852787), (-2852785)⟩, ⟨(-1424363), (-1424360)⟩, ⟨2030, 2033⟩, ⟨505, 508⟩⟩
...
def j19 : Jet := ⟨⟨1430228863, 1430228865⟩, ⟨(-2852787), (-2852785)⟩, ⟨(-1424363), (-1424360)⟩, ⟨2030, 2033⟩, ⟨505, 508⟩⟩
...
def j25 : Jet := ⟨⟨117, 118⟩, ⟨234, 236⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852060), (-852058)⟩, ⟨234, 236⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8496), (-8495)⟩, ⟨(-16989), (-16987)⟩, ⟨(-8491), (-8488)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782898, 35782900⟩, ⟨(-16989), (-16987)⟩, ⟨(-8491), (-8488)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨356767, 356768⟩, ⟨713365, 713367⟩, ⟨356343, 356346⟩, ⟨(-340), (-337)⟩, ⟨(-86), (-82)⟩⟩
...
def j33 : Jet := ⟨⟨(-715471116), (-715471114)⟩, ⟨713365, 713367⟩, ⟨356343, 356346⟩, ⟨(-340), (-337)⟩, ⟨(-86), (-82)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7133492), (-7133490)⟩, ⟨(-14259871), (-14259868)⟩, ⟨(-7115716), (-7115711)⟩, ⟨14213, 14216⟩, ⟨3544, 3547⟩⟩
...
def j36 : Jet := ⟨⟨4287833804, 4287833806⟩, ⟨(-14259871), (-14259868)⟩, ⟨(-7115716), (-7115711)⟩, ⟨14213, 14216⟩, ⟨3544, 3547⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨142810632, 142810635⟩, ⟨142525776, 142525780⟩, ⟨(-427081), (-427079)⟩, ⟨(-142023), (-142021)⟩, ⟨252, 254⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302112653, 4302112656⟩, ⟨14307354, 14307359⟩, ⟨7186987, 7186995⟩, ⟨33379, 33386⟩, ⟨8430, 8438⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨143048220, 143048224⟩, ⟨143238619, 143238625⟩, ⟨285960, 285965⟩, ⟨95921, 95928⟩, ⟨450, 457⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-136510167), (-136510166)⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4158457129, 4158457130⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4764365, 4764366⟩, ⟨9541412, 9541416⟩, ⟨4796104, 4796108⟩, ⟨25460, 25466⟩, ⟨6443, 6452⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299731661, 4299731662⟩, ⟨9541412, 9541416⟩, ⟨4796104, 4796108⟩, ⟨25460, 25466⟩, ⟨6443, 6452⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297348818, 4297348819⟩, ⟨4768062, 4768065⟩, ⟨2394077, 2394081⟩, ⟨10066, 10071⟩, ⟨2540, 2547⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4160762957, 4160762960⟩, ⟨(-131969346), (-131969340)⟩, ⟨2166437, 2166443⟩, ⟨(-66347), (-66341)⟩, ⟨2138, 2148⟩⟩
...
def j47 : Jet := ⟨⟨1515636888, 1515636900⟩, ⟨1515636888, 1515636900⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨534848118, 534848127⟩, ⟨1069696236, 1069696254⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨534848118, 534848127⟩, ⟨1069696236, 1069696254⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-534848127), (-534848118)⟩, ⟨(-1069696254), (-1069696236)⟩, ⟨(-534848127), (-534848118)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-267424064), (-267424059)⟩, ⟨(-534848127), (-534848118)⟩, ⟨(-267424064), (-267424059)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4035698608, 4035698614⟩, ⟨(-502561649), (-502561639)⟩, ⟨(-219989068), (-219989061)⟩, ⟨29992846, 29992848⟩, ⟨5915010, 5915012⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3909595607, 3909595616⟩, ⟨(-610861090), (-610861073)⟩, ⟨(-195637475), (-195637458)⟩, ⟨35499316, 35499328⟩, ⟨4707412, 4707430⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 273020334⟩, ⟨136510166, 136510167⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 857718676⟩, ⟨428859334, 428859338⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 171289157⟩, ⟨0, 171289158⟩, ⟨42822288, 42822290⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 43⟩, ⟨0, 43⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94643)⟩, ⟨0, 43⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-3777), 0⟩, ⟨(-3777), 2⟩, ⟨(-945), (-940)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109279, 5113057⟩, ⟨(-3777), 2⟩, ⟨(-945), (-940)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 203916⟩, ⟨(-151), 203917⟩, ⟨50752, 50980⟩, ⟨(-76), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142961660)⟩, ⟨(-151), 203917⟩, ⟨50752, 50980⟩, ⟨(-76), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5709639), 0⟩, ⟨(-5709646), 8133⟩, ⟨(-1427417), (-1415209)⟩, ⟨(-6), 4069⟩, ⟨501, 510⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425946126, 1431655766⟩, ⟨(-5709646), 8133⟩, ⟨(-1427417), (-1415209)⟩, ⟨(-6), 4069⟩, ⟨501, 510⟩⟩
...
def j72 : Jet := ⟨⟨0, 473⟩, ⟨(-1), 473⟩, ⟨115, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851703)⟩, ⟨(-1), 473⟩, ⟨115, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-33986), 0⟩, ⟨(-33987), 19⟩, ⟨(-8498), (-8467)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35757408, 35791395⟩, ⟨(-33987), 19⟩, ⟨(-8498), (-8467)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1427410⟩, ⟨(-1356), 1427411⟩, ⟨354818, 356854⟩, ⟨(-679), 2⟩, ⟨(-87), (-82)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714400472)⟩, ⟨(-1356), 1427411⟩, ⟨354818, 356854⟩, ⟨(-679), 2⟩, ⟨(-87), (-82)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-28548193), 0⟩, ⟨(-28548249), 56928⟩, ⟨(-7137104), (-7051656)⟩, ⟨(-42), 28465⟩, ⟨3505, 3559⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4266419103, 4294967296⟩, ⟨(-28548249), 56928⟩, ⟨(-7137104), (-7051656)⟩, ⟨(-42), 28465⟩, ⟨3505, 3559⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 285906226⟩, ⟨141242759, 142954738⟩, ⟨(-855178), 813⟩, ⟨(-142532), (-140497)⟩, ⟨(-1), 509⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4323706516⟩, ⟨(-57693), 28931582⟩, ⟨7051272, 7426532⟩, ⟨(-29045), 98137⟩, ⟨7608, 9554⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 287819331⟩, ⟨141238918, 145837212⟩, ⟨(-862822), 1458153⟩, ⟨80704, 113235⟩, ⟨(-3409), 4420⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-273020334), 0⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4021946962, 4294967296⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19287683⟩, ⟨0, 19546026⟩, ⟨4528964, 5147389⟩, ⟨(-58596), 114204⟩, ⟨4555, 8780⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314254979⟩, ⟨0, 19546026⟩, ⟨4528964, 5147389⟩, ⟨(-58596), 114204⟩, ⟨4555, 8780⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304600335⟩, ⟨0, 9773013⟩, ⟨2248319, 2573695⟩, ⟨(-35155), 57102⟩, ⟨1372, 3882⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4021946962, 4304600335⟩, ⟨(-136816342), (-126737153)⟩, ⟨1794774, 2573695⟩, ⟨(-116957), (-14358)⟩, ⟨(-531), 5000⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3031273800⟩, ⟨1515636888, 1515636900⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2139392507⟩, ⟨0, 2139392508⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2139392507⟩, ⟨0, 2139392508⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2139392507), 0⟩, ⟨(-2139392508), 0⟩, ⟨(-534848127), (-534848118)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1069696254), 0⟩, ⟨(-1069696254), 0⟩, ⟨(-267424064), (-267424059)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3348076070, 4294967296⟩, ⟨(-1069696254), 0⟩, ⟨(-267424064), (-75258094)⟩, ⟨0, 66604121⟩, ⟨(-1804120), 8325516⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3135247244, 4304600335⟩, ⟨(-1208911783), (-98796009)⟩, ⟨(-266624773), (-33825216)⟩, ⟨1462780, 75261118⟩, ⟨(-4090625), 8346872⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨136510166, 136510167⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297348818, 4297348819⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3220
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 273020334⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304600335⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3221
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (244483943 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(25427 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (25427 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(25427 / 400000), prawitzNormalCorrection
