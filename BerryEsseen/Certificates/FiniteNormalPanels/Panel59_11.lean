...
namespace FiniteNormalPanel59_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (33761 / 160000)
def radius : Rat := (33761 / 800000)

def j0 : Jet := ⟨⟨906264943, 906264944⟩, ⟨181252988, 181252989⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2847115287, 2847115291⟩, ⟨569423055, 569423059⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1887340437, 1887340444⟩, ⟨754936172, 754936180⟩, ⟨75493616, 75493618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨472, 473⟩, ⟨188, 190⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94215), (-94213)⟩, ⟨188, 190⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-41401), (-41400)⟩, ⟨(-16479), (-16476)⟩, ⟨(-1617), (-1613)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5071655, 5071657⟩, ⟨(-16479), (-16476)⟩, ⟨(-1617), (-1613)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2228640, 2228642⟩, ⟨884214, 884217⟩, ⟨85537, 85542⟩, ⟨(-573), (-568)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-140936937), (-140936934)⟩, ⟨884214, 884217⟩, ⟨85537, 85542⟩, ⟨(-573), (-568)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-61932016), (-61932013)⟩, ⟨(-24384257), (-24384252)⟩, ⟨(-2284274), (-2284269)⟩, ⟨30325, 30330⟩, ⟨1389, 1395⟩⟩
...
def j19 : Jet := ⟨⟨1369723749, 1369723753⟩, ⟨(-24384257), (-24384252)⟩, ⟨(-2284274), (-2284269)⟩, ⟨30325, 30330⟩, ⟨1389, 1395⟩⟩
...
def j22 : Jet := ⟨⟨(-48), (-47)⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11787, 11789⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5179, 5181⟩, ⟨2062, 2066⟩, ⟨202, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846998), (-846995)⟩, ⟨2062, 2066⟩, ⟨202, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-372197), (-372195)⟩, ⟨(-147973), (-147970)⟩, ⟨(-14438), (-14432)⟩, ⟨70, 74⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35419197, 35419200⟩, ⟨(-147973), (-147970)⟩, ⟨(-14438), (-14432)⟩, ⟨70, 74⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15564282, 15564284⟩, ⟨6160688, 6160692⟩, ⟨590216, 590222⟩, ⟨(-5109), (-5103)⟩, ⟨(-242), (-237)⟩⟩
...
def j33 : Jet := ⟨⟨(-700263601), (-700263598)⟩, ⟨6160688, 6160692⟩, ⟨590216, 590222⟩, ⟨(-5109), (-5103)⟩, ⟨(-242), (-237)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-307717318), (-307717315)⟩, ⟨(-120379733), (-120379727)⟩, ⟨(-10966456), (-10966451)⟩, ⟨209784, 209791⟩, ⟨9368, 9375⟩⟩
...
def j36 : Jet := ⟨⟨3987249978, 3987249981⟩, ⟨(-120379733), (-120379727)⟩, ⟨(-10966456), (-10966451)⟩, ⟨209784, 209791⟩, ⟨9368, 9375⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨907983962, 907983967⟩, ⟨165432572, 165432579⟩, ⟨(-4747080), (-4747075)⟩, ⟨(-282746), (-282740)⟩, ⟨4940, 4947⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4626432794, 4626432799⟩, ⟨139677400, 139677410⟩, ⟨16941468, 16941478⟩, ⟨652224, 652238⟩, ⟨48058, 48072⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨978057919, 978057927⟩, ⟨207728592, 207728605⟩, ⟨3848160, 3848170⟩, ⟨331482, 331497⟩, ⟨12681, 12696⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-906264944), (-906264943)⟩, ⟨(-181252989), (-181252988)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3388702352, 3388702353⟩, ⟨(-181252989), (-181252988)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨222725163, 222725168⟩, ⟨94608680, 94608688⟩, ⟨11799534, 11799542⟩, ⟨523206, 523218⟩, ⟨41285, 41300⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4517692459, 4517692464⟩, ⟨94608680, 94608688⟩, ⟨11799534, 11799542⟩, ⟨523206, 523218⟩, ⟨41285, 41300⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4404922401, 4404922405⟩, ⟨46123535, 46123540⟩, ⟨5511019, 5511025⟩, ⟨197367, 197375⟩, ⟨14612, 14622⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3475456242, 3475456247⟩, ⟨(-149502053), (-149502045)⟩, ⟨2401687, 2401695⟩, ⟨(-76852), (-76843)⟩, ⟨3198, 3208⟩⟩
...
def j47 : Jet := ⟨⟨5775412583, 5775412592⟩, ⟨1155082512, 1155082520⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7766157040, 7766157065⟩, ⟨3106462802, 3106462832⟩, ⟨310646279, 310646284⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7766157040, 7766157065⟩, ⟨3106462802, 3106462832⟩, ⟨310646279, 310646284⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7766157065), (-7766157040)⟩, ⟨(-3106462832), (-3106462802)⟩, ⟨(-310646284), (-310646279)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3883078533), (-3883078520)⟩, ⟨(-1553231416), (-1553231401)⟩, ⟨(-155323142), (-155323139)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1739059178, 1739059189⟩, ⟨(-628913140), (-628913129)⟩, ⟨50828715, 50828721⟩, ⟨9035439, 9035442⟩, ⟨(-1735979), (-1735977)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1407234015, 1407234027⟩, ⟨(-569446251), (-569446236)⟩, ⟨63994304, 63994317⟩, ⟨5159332, 5159342⟩, ⟨(-1678286), (-1678274)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨725011954, 1087517932⟩, ⟨181252988, 181252989⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2277692228, 3416538346⟩, ⟨569423055, 569423059⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1207897878, 2717770234⟩, ⟨603948936, 905923414⟩, ⟨75493616, 75493618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨302, 681⟩, ⟨151, 227⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94385), (-94005)⟩, ⟨151, 227⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-59725), (-26437)⟩, ⟨(-19867), (-13074)⟩, ⟨(-1634), (-1591)⟩, ⟨4, 9⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5053331, 5086620⟩, ⟨(-19867), (-13074)⟩, ⟨(-1634), (-1591)⟩, ⟨4, 9⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1421176, 3218713⟩, ⟨698016, 1069229⟩, ⟨83598, 87124⟩, ⟨(-694), (-446)⟩, ⟨(-29), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141744401), (-139946863)⟩, ⟨698016, 1069229⟩, ⟨83598, 87124⟩, ⟨(-694), (-446)⟩, ⟨(-29), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-89693050), (-39358045)⟩, ⟨(-29701378), (-19002435)⟩, ⟨(-2369811), (-2179217)⟩, ⟨23584, 37047⟩, ⟨1303, 1464⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1341962715, 1392297721⟩, ⟨(-29701378), (-19002435)⟩, ⟨(-2369811), (-2179217)⟩, ⟨23584, 37047⟩, ⟨1303, 1464⟩⟩
...
def j70 : Jet := ⟨⟨(-69), (-30)⟩, ⟨(-23), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11766, 11806⟩, ⟨(-23), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3309, 7471⟩, ⟨1639, 2487⟩, ⟨199, 206⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848868), (-844705)⟩, ⟨1639, 2487⟩, ⟨199, 206⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-537147), (-237561)⟩, ⟨(-178589), (-117206)⟩, ⟨(-14636), (-14191)⟩, ⟨53, 88⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35254247, 35553834⟩, ⟨(-178589), (-117206)⟩, ⟨(-14636), (-14191)⟩, ⟨53, 88⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9914750, 22497762⟩, ⟨4844367, 7466293⟩, ⟨572739, 604466⟩, ⟨(-6214), (-3999)⟩, ⟨(-251), (-227)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705913133), (-693330120)⟩, ⟨4844367, 7466293⟩, ⟨572739, 604466⟩, ⟨(-6214), (-3999)⟩, ⟨(-251), (-227)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-446687849), (-194989140)⟩, ⟨(-147533542), (-92770046)⟩, ⟨(-11565718), (-10229485)⟩, ⟨161754, 257612⟩, ⟨8597, 10000⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3848279447, 4099978156⟩, ⟨(-147533542), (-92770046)⟩, ⟨(-11565718), (-10229485)⟩, ⟨161754, 257612⟩, ⟨8597, 10000⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨711665033, 1107537783⟩, ⟨154289558, 174512326⟩, ⟨(-5822909), (-3675000)⟩, ⟨(-301682), (-259448)⟩, ⟨3817, 6077⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4499229842, 4793504300⟩, ⟨101803897, 183771133⟩, ⟨13529133, 21451855⟩, ⟨258935, 1185609⟩, ⟨16373, 95598⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨745510811, 1236094890⟩, ⟨178495993, 242157621⟩, ⟨(-599925), 9148942⟩, ⟨(-56934), 818466⟩, ⟨(-25982), 61884⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1087517932), (-725011954)⟩, ⟨(-181252989), (-181252988)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3207449364, 3569955342⟩, ⟨(-181252989), (-181252988)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨129404098, 355749060⟩, ⟨61965868, 139386300⟩, ⟨7072857, 18919408⟩, ⟨(-100422), 1502780⟩, ⟨(-22656), 147405⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4424371394, 4650716356⟩, ⟨61965868, 139386300⟩, ⟨7072857, 18919408⟩, ⟨(-100422), 1502780⟩, ⟨(-22656), 147405⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4359189195, 4469303599⟩, ⟨29774367, 68666394⟩, ⟨2870985, 9218656⟩, ⟨(-194685), 720712⟩, ⟨(-32263), 74739⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3255409796, 3714862806⟩, ⟨(-166374926), (-126888068)⟩, ⟨(-753778), 6405986⟩, ⟨(-550861), 477894⟩, ⟨(-57232), 70339⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4620330064, 6930495105⟩, ⟨1155082512, 1155082520⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4970340500, 11183266156⟩, ⟨2485170240, 3727755394⟩, ⟨310646279, 310646284⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4970340500, 11183266156⟩, ⟨2485170240, 3727755394⟩, ⟨310646279, 310646284⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11183266156), (-4970340500)⟩, ⟨(-3727755394), (-2485170240)⟩, ⟨(-310646284), (-310646279)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5591633078), (-2485170250)⟩, ⟨(-1863877697), (-1242585120)⟩, ⟨(-155323142), (-155323139)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1168289142, 2408056895⟩, ⟨(-1045019259), (-337999943)⟩, ⟨(-38191238), 184502385⟩, ⟨(-18540418), 30719299⟩, ⟨(-6668968), 2702061⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨885515454, 2082810038⟩, ⟨(-997153919), (-290705421)⟩, ⟨(-23469841), 203655110⟩, ⟨(-25050848), 28500930⟩, ⟨(-7163527), 3503966⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨906264943, 906264944⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4404922401, 4404922405⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1168
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨725011954, 1087517932⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4359189195, 4469303599⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1169
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (60316823 / 2147483648)

theorem envelope_integral : (∫ s in ((33761 / 200000) : ℝ)..(101283 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((33761 / 200000) : ℝ)..(101283 / 400000), prawitzNormalCorrection
