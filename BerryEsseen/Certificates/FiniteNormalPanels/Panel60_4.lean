...
namespace FiniteNormalPanel60_4

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (34553 / 160000)
def radius : Rat := (34553 / 800000)

def j0 : Jet := ⟨⟨927525031, 927525032⟩, ⟨185505006, 185505007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2913905823, 2913905827⟩, ⟨582781164, 582781168⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1976929406, 1976929412⟩, ⟨790771760, 790771770⟩, ⟨79077176, 79077178⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨494, 496⟩, ⟨197, 199⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94193), (-94190)⟩, ⟨197, 199⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-43357), (-43354)⟩, ⟨(-17253), (-17249)⟩, ⟨(-1691), (-1687)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5069699, 5069703⟩, ⟨(-17253), (-17249)⟩, ⟨(-1691), (-1687)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2333530, 2333533⟩, ⟨925470, 925474⟩, ⟨89385, 89391⟩, ⟨(-628), (-623)⟩, ⟨(-31), (-28)⟩⟩
...
def j16 : Jet := ⟨⟨(-140832047), (-140832043)⟩, ⟨925470, 925474⟩, ⟨89385, 89391⟩, ⟨(-628), (-623)⟩, ⟨(-31), (-28)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-64823548), (-64823545)⟩, ⟨(-25503436), (-25503431)⟩, ⟨(-2381407), (-2381400)⟩, ⟨33206, 33213⟩, ⟨1514, 1520⟩⟩
...
def j19 : Jet := ⟨⟨1366832217, 1366832221⟩, ⟨(-25503436), (-25503431)⟩, ⟨(-2381407), (-2381400)⟩, ⟨33206, 33213⟩, ⟨1514, 1520⟩⟩
...
def j25 : Jet := ⟨⟨5424, 5426⟩, ⟨2159, 2163⟩, ⟨211, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846753), (-846750)⟩, ⟨2159, 2163⟩, ⟨211, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-389752), (-389750)⟩, ⟨(-154908), (-154904)⟩, ⟨(-15097), (-15092)⟩, ⟨76, 80⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35401642, 35401645⟩, ⟨(-154908), (-154904)⟩, ⟨(-15097), (-15092)⟩, ⟨76, 80⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16295012, 16295015⟩, ⟨6446702, 6446706⟩, ⟨616329, 616335⟩, ⟨(-5599), (-5593)⟩, ⟨(-265), (-260)⟩⟩
...
def j33 : Jet := ⟨⟨(-699532871), (-699532867)⟩, ⟨6446702, 6446706⟩, ⟨616329, 616335⟩, ⟨(-5599), (-5593)⟩, ⟨(-265), (-260)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-321987809), (-321987805)⟩, ⟨(-125827775), (-125827768)⟩, ⟨(-11408884), (-11408877)⟩, ⟨229591, 229599⟩, ⟨10194, 10200⟩⟩
...
def j36 : Jet := ⟨⟨3972979487, 3972979491⟩, ⟨(-125827775), (-125827768)⟩, ⟨(-11408884), (-11408877)⟩, ⟨229591, 229599⟩, ⟨10194, 10200⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨927322627, 927322632⟩, ⟨168161806, 168161813⟩, ⟨(-5076202), (-5076195)⟩, ⟨(-300604), (-300596)⟩, ⟨5532, 5539⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4643050414, 4643050420⟩, ⟨147049505, 147049515⟩, ⟨17990250, 17990263⟩, ⟨723712, 723726⟩, ⟨54162, 54174⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1002476948, 1002476955⟩, ⟨213539710, 213539723⟩, ⟨4154120, 4154133⟩, ⟨361867, 361884⟩, ⟨14454, 14469⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-927525032), (-927525031)⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3367442264, 3367442265⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨233985490, 233985495⟩, ⟨99683476, 99683484⟩, ⟨12556096, 12556107⟩, ⟨581996, 582010⟩, ⟨46745, 46760⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4528952786, 4528952791⟩, ⟨99683476, 99683484⟩, ⟨12556096, 12556107⟩, ⟨581996, 582010⟩, ⟨46745, 46760⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4410408609, 4410408612⟩, ⟨48537143, 48537148⟩, ⟨5846642, 5846649⟩, ⟨219037, 219046⟩, ⟨16474, 16483⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3457953303, 3457953308⟩, ⟨(-152435819), (-152435812)⟩, ⟨2487642, 2487650⟩, ⟨(-80791), (-80781)⟩, ⟨3455, 3464⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨26062591392, 26062591397⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value328

def j47 : Jet := ⟨⟨5628379501, 5628379509⟩, ⟨1125675899, 1125675906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7375761821, 7375761843⟩, ⟨2950304724, 2950304750⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7375761821, 7375761843⟩, ⟨2950304724, 2950304750⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7375761843), (-7375761821)⟩, ⟨(-2950304750), (-2950304724)⟩, ⟨(-295030476), (-295030472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3687880922), (-3687880910)⟩, ⟨(-1475152375), (-1475152362)⟩, ⟨(-147515238), (-147515236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1819919463, 1819919478⟩, ⟨(-625070776), (-625070765)⟩, ⟨44836535, 44836540⟩, ⟨9179285, 9179287⟩, ⟨(-1558161), (-1558160)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1465248995, 1465249011⟩, ⟨(-567847509), (-567847493)⟩, ⟨59337615, 59337627⟩, ⟨5402799, 5402810⟩, ⟨(-1541104), (-1541093)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨742020024, 1113030038⟩, ⟨185505006, 185505007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2331124656, 3496686991⟩, ⟨582781164, 582781168⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1265234817, 2846778351⟩, ⟨632617408, 948926122⟩, ⟨79077176, 79077178⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨316, 714⟩, ⟨158, 238⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94371), (-93972)⟩, ⟨158, 238⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-62551), (-27682)⟩, ⟨(-20805), (-13683)⟩, ⟨(-1710), (-1663)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5050505, 5085375⟩, ⟨(-20805), (-13683)⟩, ⟨(-1710), (-1663)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1487805, 3370675⟩, ⟨730112, 1119529⟩, ⟨87256, 91126⟩, ⟨(-761), (-488)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141677772), (-139794901)⟩, ⟨730112, 1119529⟩, ⟨87256, 91126⟩, ⟨(-761), (-488)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-93906470), (-41181541)⟩, ⟨(-31087077), (-19848726)⟩, ⟨(-2475270), (-2266098)⟩, ⟨25789, 40604⟩, ⟨1415, 1600⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1337749295, 1390474225⟩, ⟨(-31087077), (-19848726)⟩, ⟨(-2475270), (-2266098)⟩, ⟨25789, 40604⟩, ⟨1415, 1600⟩⟩
...
def j72 : Jet := ⟨⟨3465, 7825⟩, ⟨1716, 2605⟩, ⟨208, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848712), (-844351)⟩, ⟨1716, 2605⟩, ⟨208, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-562541), (-248733)⟩, ⟨(-187009), (-122639)⟩, ⟨(-15314), (-14825)⟩, ⟨59, 96⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35228853, 35542662⟩, ⟨(-187009), (-122639)⟩, ⟨(-15314), (-14825)⟩, ⟨59, 96⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10377907, 23558289⟩, ⟨5065000, 7816637⟩, ⟨597150, 631967⟩, ⟨(-6811), (-4376)⟩, ⟨(-274), (-247)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705449976), (-692269593)⟩, ⟨5065000, 7816637⟩, ⟨597150, 631967⟩, ⟨(-6811), (-4376)⟩, ⟨(-274), (-247)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-467584404), (-203932540)⟩, ⟨(-154369394), (-96785268)⟩, ⟨(-12066508), (-10599903)⟩, ⟨176694, 282255⟩, ⟨9307, 10920⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3827382892, 4091034756⟩, ⟨(-154369394), (-96785268)⟩, ⟨(-12066508), (-10599903)⟩, ⟨176694, 282255⟩, ⟨9307, 10920⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨726073134, 1132034961⟩, ⟨156209178, 177899455⟩, ⟨(-6233392), (-3923201)⟩, ⟨(-321871), (-274427)⟩, ⟨4267, 6813⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4509065596, 4819675636⟩, ⟨106674996, 194391424⟩, ⟨14206728, 23035257⟩, ⟨279968, 1333770⟩, ⟨17153, 110532⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨762266895, 1270333613⟩, ⟨182029622, 250869328⟩, ⟨(-713440), 10004472⟩, ⟨(-79289), 920129⟩, ⟨(-30440), 72233⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1113030038), (-742020024)⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3181937258, 3552947272⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨135286436, 375729867⟩, ⟨64612902, 148400544⟩, ⟨7292760, 20571393⟩, ⟨(-130250), 1713022⟩, ⟨(-28934), 173524⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4430253732, 4670697163⟩, ⟨64612902, 148400544⟩, ⟨7292760, 20571393⟩, ⟨(-130250), 1713022⟩, ⟨(-28934), 173524⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4362086071, 4478894012⟩, ⟨30979779, 73058564⟩, ⟨2900783, 10017423⟩, ⟨(-231902), 822731⟩, ⟨(-39527), 88347⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3231662370, 3705097889⟩, ⟨(-170497586), (-127967347)⟩, ⟨(-1006439), 6948708⟩, ⟨(-624504), 555304⟩, ⟨(-68234), 83101⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4502703596, 6754055409⟩, ⟨1125675899, 1125675906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4720487555, 10621097048⟩, ⟨2360243776, 3540365698⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4720487555, 10621097048⟩, ⟨2360243776, 3540365698⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10621097048), (-4720487555)⟩, ⟨(-3540365698), (-2360243776)⟩, ⟨(-295030476), (-295030472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5310548524), (-2360243777)⟩, ⟨(-1770182849), (-1180121888)⟩, ⟨(-147515238), (-147515236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1247305350, 2479127950⟩, ⟨(-1021779557), (-342720268)⟩, ⟨(-38063924), 167724626⟩, ⟨(-15195331), 28625458⟩, ⟨(-5829857), 2219373⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨938510001, 2138645327⟩, ⟨(-979862785), (-295036134)⟩, ⟨(-23205918), 189261942⟩, ⟨(-21780169), 26765038⟩, ⟨(-6398611), 2985674⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨927525031, 927525032⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨185505006, 185505007⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4410408609, 4410408612⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar328 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1182
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar328 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨742020024, 1113030038⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4362086071, 4478894012⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1183
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((34553 / 200000) : ℝ)..(103659 / 400000), prawitzNormalCorrection
      ((61933 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
