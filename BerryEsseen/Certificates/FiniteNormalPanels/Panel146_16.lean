...
namespace FiniteNormalPanel146_16
...
def j2 : Jet := ⟨⟨1330194255, 1330194259⟩, ⟨443398085, 443398089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨411974442, 411974445⟩, ⟨274649628, 274649632⟩, ⟨45774938, 45774939⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨103, 104⟩, ⟨68, 69⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94584), (-94582)⟩, ⟨68, 69⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9073), (-9072)⟩, ⟨(-6043), (-6041)⟩, ⟨(-1004), (-1001)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103983, 5103985⟩, ⟨(-6043), (-6041)⟩, ⟨(-1004), (-1001)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨489575, 489576⟩, ⟨325803, 325805⟩, ⟨53913, 53916⟩, ⟨(-130), (-127)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142676002), (-142676000)⟩, ⟨325803, 325805⟩, ⟨53913, 53916⟩, ⟨(-130), (-127)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13685522), (-13685521)⟩, ⟨(-9092430), (-9092428)⟩, ⟨(-1494609), (-1494606)⟩, ⟨6906, 6909⟩, ⟨563, 567⟩⟩
...
def j19 : Jet := ⟨⟨1417970243, 1417970245⟩, ⟨(-9092430), (-9092428)⟩, ⟨(-1494609), (-1494606)⟩, ⟨6906, 6909⟩, ⟨563, 567⟩⟩
...
def j25 : Jet := ⟨⟨1134, 1135⟩, ⟨755, 757⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851043), (-851041)⟩, ⟨755, 757⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-81633), (-81632)⟩, ⟨(-54350), (-54348)⟩, ⟨(-9012), (-9008)⟩, ⟨14, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35709761, 35709763⟩, ⟨(-54350), (-54348)⟩, ⟨(-9012), (-9008)⟩, ⟨14, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3425290, 3425291⟩, ⟨2278312, 2278314⟩, ⟨376246, 376249⟩, ⟨(-1156), (-1153)⟩, ⟨(-98), (-93)⟩⟩
...
def j33 : Jet := ⟨⟨(-712402593), (-712402591)⟩, ⟨2278312, 2278314⟩, ⟨376246, 376249⟩, ⟨(-1156), (-1153)⟩, ⟨(-98), (-93)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-68333853), (-68333852)⟩, ⟨(-45337367), (-45337364)⟩, ⟨(-7410872), (-7410868)⟩, ⟨48229, 48232⟩, ⟨3925, 3929⟩⟩
...
def j36 : Jet := ⟨⟨4226633443, 4226633444⟩, ⟨(-45337367), (-45337364)⟩, ⟨(-7410872), (-7410868)⟩, ⟨48229, 48232⟩, ⟨3925, 3929⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨439159542, 439159545⟩, ⟨143570497, 143570501⟩, ⟨(-1401569), (-1401565)⟩, ⟨(-152161), (-152158)⟩, ⟨886, 890⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4364405931, 4364405933⟩, ⟨46815192, 46815197⟩, ⟨8154600, 8154607⟩, ⟨119750, 119757⟩, ⟨10989, 10998⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨446259628, 446259632⟩, ⟨150678507, 150678514⟩, ⟨974497, 974504⟩, ⟨114932, 114941⟩, ⟨1704, 1715⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-423413983), (-423413982)⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3871553313, 3871553314⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨46367676, 46367678⟩, ⟨31311872, 31311876⟩, ⟨5488695, 5488699⟩, ⟨92256, 92264⟩, ⟨8639, 8646⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4341334972, 4341334974⟩, ⟨31311872, 31311876⟩, ⟨5488695, 5488699⟩, ⟨92256, 92264⟩, ⟨8639, 8646⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4318088897, 4318088899⟩, ⟨15572104, 15572107⟩, ⟨2701573, 2701577⟩, ⟨36137, 36144⟩, ⟨3319, 3325⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3892395499, 3892395503⟩, ⟨(-127860853), (-127860847)⟩, ⟨1923522, 1923528⟩, ⟨(-56204), (-56196)⟩, ⟨1803, 1811⟩⟩
...
def j47 : Jet := ⟨⟨4314856289, 4314856301⟩, ⟨1438285429, 1438285441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4334837383, 4334837408⟩, ⟨2889891586, 2889891620⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4334837383, 4334837408⟩, ⟨2889891586, 2889891620⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4334837408), (-4334837383)⟩, ⟨(-2889891620), (-2889891586)⟩, ⟨(-481648606), (-481648597)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2167418704), (-2167418691)⟩, ⟨(-1444945810), (-1444945793)⟩, ⟨(-240824303), (-240824298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2592966136, 2592966157⟩, ⟨(-872345545), (-872345527)⟩, ⟨1349656, 1349667⟩, ⟨32457662, 32457666⟩, ⟨(-2767754), (-2767752)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2349924695, 2349924718⟩, ⟨(-867772090), (-867772067)⟩, ⟨28354082, 28354101⟩, ⟨28950573, 28950586⟩, ⟨(-3461488), (-3461474)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨282275988, 564551977⟩, ⟨141137994, 141137995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨886796170, 1773592344⟩, ⟨443398085, 443398089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨183099752, 732399012⟩, ⟨183099752, 366199510⟩, ⟨45774938, 45774939⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨45, 184⟩, ⟨45, 92⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94642), (-94502)⟩, ⟨45, 92⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-16139), (-4028)⟩, ⟨(-8069), (-4012)⟩, ⟨(-1008), (-996)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096917, 5109029⟩, ⟨(-8069), (-4012)⟩, ⟨(-1008), (-996)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨217287, 871217⟩, ⟨215911, 435438⟩, ⟨53461, 54239⟩, ⟨(-172), (-83)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142948290), (-142294359)⟩, ⟨215911, 435438⟩, ⟨53461, 54239⟩, ⟨(-172), (-83)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-24376248), (-6066183)⟩, ⟨(-12178920), (-5991929)⟩, ⟨(-1512033), (-1470168)⟩, ⟨4550, 9263⟩, ⟨552, 576⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407279517, 1425589583⟩, ⟨(-12178920), (-5991929)⟩, ⟨(-1512033), (-1470168)⟩, ⟨4550, 9263⟩, ⟨552, 576⟩⟩
...
def j72 : Jet := ⟨⟨503, 2018⟩, ⟨501, 1009⟩, ⟨123, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851674), (-850158)⟩, ⟨501, 1009⟩, ⟨123, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-145232), (-36243)⟩, ⟨(-72595), (-36070)⟩, ⟨(-9051), (-8951)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35646162, 35755152⟩, ⟨(-72595), (-36070)⟩, ⟨(-9051), (-8951)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1519639, 6097145⟩, ⟨1507259, 3047036⟩, ⟨372175, 379154⟩, ⟨(-1546), (-761)⟩, ⟨(-98), (-92)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714308244), (-709730737)⟩, ⟨1507259, 3047036⟩, ⟨372175, 379154⟩, ⟨(-1546), (-761)⟩, ⟨(-98), (-92)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-121807366), (-30256696)⟩, ⟨(-60839428), (-29737100)⟩, ⟨(-7532839), (-7239720)⟩, ⟨31666, 64771⟩, ⟨3817, 4006⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4173159930, 4264710600⟩, ⟨(-60839428), (-29737100)⟩, ⟨(-7532839), (-7239720)⟩, ⟨31666, 64771⟩, ⟨3817, 4006⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨290565678, 588692439⟩, ⟨140253594, 145935938⟩, ⟨(-1881701), (-922136)⟩, ⟨(-155159), (-147949)⟩, ⟨582, 1195⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4325438653, 4420330010⟩, ⟨30160545, 64442858⟩, ⟨7553114, 8918495⟩, ⟨36730, 213525⟩, ⟨7945, 15028⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨292627144, 605875360⟩, ⟨143289085, 159028460⟩, ⟨(-440736), 2483405⟩, ⟨61211, 176830⟩, ⟨(-3915), 7887⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-564551977), (-282275988)⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3730415319, 4012691308⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19937438, 85468626⟩, ⟨19525306, 44867130⟩, ⟨4656075, 6588949⟩, ⟨(-24298), 233796⟩, ⟨2723, 16758⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314904734, 4380435922⟩, ⟨19525306, 44867130⟩, ⟨4656075, 6588949⟩, ⟨(-24298), 233796⟩, ⟨2723, 16758⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304924472, 4337491099⟩, ⟨9666942, 22381677⟩, ⟨2247468, 3276002⟩, ⟨(-29154), 111582⟩, ⟨(-469), 7925⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3739063673, 4052420341⟩, ⟨(-134139111), (-120554501)⟩, ⟨1216559, 2743028⟩, ⟨(-134892), 30395⟩, ⟨(-4106), 8364⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2876570859, 5753141731⟩, ⟨1438285429, 1438285441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1926594392, 7706377604⟩, ⟨1926594390, 3853188824⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1926594392, 7706377604⟩, ⟨1926594390, 3853188824⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7706377604), (-1926594392)⟩, ⟨(-3853188824), (-1926594390)⟩, ⟨(-481648606), (-481648597)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3853188802), (-963297196)⟩, ⟨(-1926594412), (-963297195)⟩, ⟨(-240824303), (-240824298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1751203925, 3432053723⟩, ⟨(-1539517084), (-392768957)⟩, ⟨(-148393524), 247098518⟩, ⟨(-22264975), 79736766⟩, ⟨(-15869450), 6657159⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1524543152, 3238237538⟩, ⟨(-1559765773), (-391086482)⟩, ⟨(-128492813), 283417929⟩, ⟨(-29815947), 79781462⟩, ⟨(-17572531), 7189436⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4318088897, 4318088899⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2948
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304924472, 4337491099⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2949
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (155158597 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26289 / 400000) : ℝ)..(26289 / 200000), prawitzNormalCorrection
