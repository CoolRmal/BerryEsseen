...
namespace FiniteNormalPanel123_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (82467 / 800000)
def radius : Rat := (27489 / 800000)

def j0 : Jet := ⟨⟨442741334, 442741335⟩, ⟨147580444, 147580445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1390912922, 1390912926⟩, ⟨463637638, 463637642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨450443186, 450443190⟩, ⟨300295456, 300295460⟩, ⟨50049242, 50049244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-9919), (-9918)⟩, ⟨(-6606), (-6604)⟩, ⟨(-1097), (-1094)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103137, 5103139⟩, ⟨(-6606), (-6604)⟩, ⟨(-1097), (-1094)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨535201, 535202⟩, ⟨356108, 356110⟩, ⟨58888, 58892⟩, ⟨(-154), (-151)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-142630376), (-142630374)⟩, ⟨356108, 356110⟩, ⟨58888, 58892⟩, ⟨(-154), (-151)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14958643), (-14958642)⟩, ⟨(-9935082), (-9935080)⟩, ⟨(-1630999), (-1630995)⟩, ⟨8249, 8253⟩, ⟨673, 676⟩⟩
...
def j19 : Jet := ⟨⟨1416697122, 1416697124⟩, ⟨(-9935082), (-9935080)⟩, ⟨(-1630999), (-1630995)⟩, ⟨8249, 8253⟩, ⟨673, 676⟩⟩
...
def j25 : Jet := ⟨⟨1239, 1241⟩, ⟨825, 827⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850938), (-850935)⟩, ⟨825, 827⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-89244), (-89243)⟩, ⟨(-59410), (-59408)⟩, ⟨(-9845), (-9842)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35702150, 35702152⟩, ⟨(-59410), (-59408)⟩, ⟨(-9845), (-9842)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3744333, 3744334⟩, ⟨2489991, 2489993⟩, ⟨410850, 410853⟩, ⟨(-1381), (-1377)⟩, ⟨(-115), (-111)⟩⟩
...
def j33 : Jet := ⟨⟨(-712083550), (-712083548)⟩, ⟨2489991, 2489993⟩, ⟨410850, 410853⟩, ⟨(-1381), (-1377)⟩, ⟨(-115), (-111)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-74681171), (-74681169)⟩, ⟨(-49526306), (-49526303)⟩, ⟨(-8080725), (-8080721)⟩, ⟨57595, 57599⟩, ⟨4677, 4681⟩⟩
...
def j36 : Jet := ⟨⟨4220286125, 4220286127⟩, ⟨(-49526306), (-49526303)⟩, ⟨(-8080725), (-8080721)⟩, ⟨57595, 57599⟩, ⟨4677, 4681⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨458793326, 458793329⟩, ⟨149713659, 149713663⟩, ⟨(-1600678), (-1600675)⟩, ⟨(-173394), (-173391)⟩, ⟨1107, 1110⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4370970005, 4370970008⟩, ⟨51294622, 51294627⟩, ⟨8971196, 8971203⟩, ⟨143838, 143846⟩, ⟨13315, 13324⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨466912022, 466912026⟩, ⟨157842305, 157842312⟩, ⟨1117333, 1117340⟩, ⟨132501, 132509⟩, ⟨2146, 2156⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-442741335), (-442741334)⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3852225961, 3852225962⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨50758672, 50758673⟩, ⟨34318524, 34318528⟩, ⟨6043719, 6043725⟩, ⟨110932, 110938⟩, ⟨10494, 10501⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4345725968, 4345725969⟩, ⟨34318524, 34318528⟩, ⟨6043719, 6043725⟩, ⟨110932, 110938⟩, ⟨10494, 10501⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320272087, 4320272088⟩, ⟨17058756, 17058759⟩, ⟨2970480, 2970485⟩, ⟨43411, 43416⟩, ⟨4022, 4028⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3874922239, 3874922242⟩, ⟨(-133149675), (-133149669)⟩, ⟨2078110, 2078117⟩, ⟨(-63134), (-63128)⟩, ⟨2115, 2122⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨42540679773, 42540679780⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value526

def j47 : Jet := ⟨⟨4385252788, 4385252800⟩, ⟨1461750922, 1461750934⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4477436192, 4477436217⟩, ⟨2984957446, 2984957480⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4477436192, 4477436217⟩, ⟨2984957446, 2984957480⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4477436217), (-4477436192)⟩, ⟨(-2984957480), (-2984957446)⟩, ⟨(-497492914), (-497492905)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2238718109), (-2238718096)⟩, ⟨(-1492478740), (-1492478723)⟩, ⟨(-248746457), (-248746452)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2550276439, 2550276460⟩, ⟨(-886207772), (-886207754)⟩, ⟨6274989, 6274999⟩, ⟨33490108, 33490112⟩, ⟨(-3091121), (-3091119)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2300861032, 2300861054⟩, ⟨(-878599168), (-878599144)⟩, ⟨34368856, 34368874⟩, ⟨29553982, 29553996⟩, ⟨(-3809734), (-3809721)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨295160889, 590321780⟩, ⟨147580444, 147580445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨927275280, 1854550568⟩, ⟨463637638, 463637642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨200196971, 800787893⟩, ⟨200196970, 400393948⟩, ⟨50049242, 50049244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-17645), (-4404)⟩, ⟨(-8821), (-4385)⟩, ⟨(-1101), (-1088)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095411, 5108653⟩, ⟨(-8821), (-4385)⟩, ⟨(-1101), (-1088)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨237507, 952498⟩, ⟨235862, 476045⟩, ⟨58347, 59278⟩, ⟨(-206), (-100)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142928070), (-142213078)⟩, ⟨235862, 476045⟩, ⟨58347, 59278⟩, ⟨(-206), (-100)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-26648648), (-6628834)⟩, ⟨(-13313331), (-6540076)⟩, ⟨(-1651829), (-1601776)⟩, ⟨5428, 11071⟩, ⟨656, 687⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1405007117, 1425026932⟩, ⟨(-13313331), (-6540076)⟩, ⟨(-1651829), (-1601776)⟩, ⟨5428, 11071⟩, ⟨656, 687⟩⟩
...
def j72 : Jet := ⟨⟨550, 2207⟩, ⟨547, 1104⟩, ⟨134, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851627), (-849969)⟩, ⟨547, 1104⟩, ⟨134, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-158785), (-39618)⟩, ⟨(-79368), (-39412)⟩, ⟨(-9894), (-9775)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35632609, 35751777⟩, ⟨(-79368), (-39412)⟩, ⟨(-9894), (-9775)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1660906, 6665846⟩, ⟨1646107, 3331086⟩, ⟨405981, 414324⟩, ⟨(-1848), (-909)⟩, ⟨(-117), (-109)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714166977), (-709162036)⟩, ⟨1646107, 3331086⟩, ⟨405981, 414324⟩, ⟨(-1848), (-909)⟩, ⟨(-117), (-109)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-133154977), (-33055453)⟩, ⟨(-66500761), (-32434378)⟩, ⟨(-8226536), (-7876075)⟩, ⟨37760, 77401⟩, ⟨4535, 4782⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4161812319, 4261911843⟩, ⟨(-66500761), (-32434378)⟩, ⟨(-8226536), (-7876075)⟩, ⟨37760, 77401⟩, ⟨4535, 4782⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨303338367, 615321218⟩, ⟨145920537, 152418316⟩, ⟨(-2150416), (-1051814)⟩, ⟨(-177143), (-168129)⟩, ⟨726, 1493⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4328279127, 4432382496⟩, ⟨32939451, 70824148⟩, ⟨8249400, 9893050⟩, ⟨43155, 258807⟩, ⟨9311, 18679⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨305691063, 635008094⟩, ⟨149378695, 167441527⟩, ⟨(-517483), 2870747⟩, ⟨65046, 210662⟩, ⟨(-5022), 10094⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-590321780), (-295160889)⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3704645516, 3999806407⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21757331, 93885530⟩, ⟨21263832, 49512240⟩, ⟨5042361, 7376673⟩, ⟨(-31092), 286130⟩, ⟨2692, 21331⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316724627, 4388852826⟩, ⟨21263832, 49512240⟩, ⟨5042361, 7376673⟩, ⟨(-31092), 286130⟩, ⟨2692, 21331⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305832219, 4341656292⟩, ⟨10517583, 24693653⟩, ⟨2423844, 3666185⟩, ⟨(-36533), 136784⟩, ⟨(-1004), 10168⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3714017109, 4043286819⟩, ⟨(-140112745), (-124957132)⟩, ⟨1242193, 3052839⟩, ⟨(-159998), 44098⟩, ⟨(-5637), 10726⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2923501855, 5847003733⟩, ⟨1461750922, 1461750934⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1989971635, 7959886607⟩, ⟨1989971628, 3979943306⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1989971635, 7959886607⟩, ⟨1989971628, 3979943306⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7959886607), (-1989971635)⟩, ⟨(-3979943306), (-1989971628)⟩, ⟨(-497492914), (-497492905)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3979943304), (-994985817)⟩, ⟨(-1989971653), (-994985814)⟩, ⟨(-248746457), (-248746452)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1700276996, 3406824935⟩, ⟨(-1578471868), (-393891588)⟩, ⟨(-151683894), 267200933⟩, ⟨(-26058718), 84372022⟩, ⟨(-17510524), 7410870⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1470292418, 3207188648⟩, ⟨(-1597114395), (-390080229)⟩, ⟨(-130843804), 305458561⟩, ⟨(-34497363), 84297286⟩, ⟨(-19365353), 8083939⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨442741334, 442741335⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320272087, 4320272088⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar526 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2480
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar526 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨295160889, 590321780⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305832219, 4341656292⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2481
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((27489 / 400000) : ℝ)..(27489 / 200000), prawitzNormalCorrection
      ((274709 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
