...
namespace FiniteNormalPanel114_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (7847 / 32000)
def radius : Rat := (1121 / 32000)

def j0 : Jet := ⟨⟨1053206511, 1053206512⟩, ⟨150458073, 150458074⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3308745837, 3308745841⟩, ⟨472677976, 472677980⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2548983090, 2548983098⟩, ⟨728280882, 728280890⟩, ⟨52020062, 52020064⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨637, 639⟩, ⟨182, 183⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94050), (-94047)⟩, ⟨182, 183⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-55817), (-55815)⟩, ⟨(-15840), (-15838)⟩, ⟨(-1103), (-1098)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5057239, 5057242⟩, ⟨(-15840), (-15838)⟩, ⟨(-1103), (-1098)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3001377, 3001379⟩, ⟨848135, 848138⟩, ⟨57911, 57917⟩, ⟨(-378), (-373)⟩, ⟨(-14), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140164200), (-140164197)⟩, ⟨848135, 848138⟩, ⟨57911, 57917⟩, ⟨(-378), (-373)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-83184843), (-83184840)⟩, ⟨(-23263746), (-23263742)⟩, ⟨(-1519467), (-1519460)⟩, ⟨19866, 19873⟩, ⟨627, 634⟩⟩
...
def j19 : Jet := ⟨⟨1348470922, 1348470926⟩, ⟨(-23263746), (-23263742)⟩, ⟨(-1519467), (-1519460)⟩, ⟨19866, 19873⟩, ⟨627, 634⟩⟩
...
def j25 : Jet := ⟨⟨6985, 6988⟩, ⟨1983, 1987⟩, ⟨136, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845192), (-845188)⟩, ⟨1983, 1987⟩, ⟨136, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-501606), (-501603)⟩, ⟨(-142140), (-142135)⟩, ⟨(-9821), (-9815)⟩, ⟨45, 49⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35289788, 35289792⟩, ⟨(-142140), (-142135)⟩, ⟨(-9821), (-9815)⟩, ⟨45, 49⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20943831, 20943835⟩, ⟨5899593, 5899599⟩, ⟨397493, 397500⟩, ⟨(-3362), (-3355)⟩, ⟨(-113), (-107)⟩⟩
...
def j33 : Jet := ⟨⟨(-694884052), (-694884047)⟩, ⟨5899593, 5899599⟩, ⟨397493, 397500⟩, ⟨(-3362), (-3355)⟩, ⟨(-113), (-107)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-412400743), (-412400738)⟩, ⟨(-114327487), (-114327479)⟩, ⟨(-7180067), (-7180059)⟩, ⟨136860, 136868⟩, ⟨4175, 4184⟩⟩
...
def j36 : Jet := ⟨⟨3882566553, 3882566558⟩, ⟨(-114327487), (-114327479)⟩, ⟨(-7180067), (-7180059)⟩, ⟨136860, 136868⟩, ⟨4175, 4184⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1038831553, 1038831559⟩, ⟨130482642, 130482649⟩, ⟨(-3730831), (-3730822)⟩, ⟨(-151920), (-151912)⟩, ⟨2669, 2677⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4751172658, 4751172665⟩, ⟨139904772, 139904784⟩, ⟨12906064, 12906078⟩, ⟨471274, 471288⟩, ⟨27689, 27707⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1149174773, 1149174783⟩, ⟨178181345, 178181357⟩, ⟨3244854, 3244871⟩, ⟨216491, 216509⟩, ⟨7806, 7824⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1053206512), (-1053206511)⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3241760784, 3241760785⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨307476767, 307476773⟩, ⟨95349506, 95349516⟩, ⟨9128451, 9128463⟩, ⟨385082, 385094⟩, ⟨24589, 24606⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4602444063, 4602444069⟩, ⟨95349506, 95349516⟩, ⟨9128451, 9128463⟩, ⟨385082, 385094⟩, ⟨24589, 24606⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4446048440, 4446048444⟩, ⟨46054717, 46054723⟩, ⟨4170597, 4170604⟩, ⟨142795, 142803⟩, ⟨8440, 8451⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3355793998, 3355794003⟩, ⟨(-120989400), (-120989392)⟩, ⟨1534533, 1534540⟩, ⟨(-38324), (-38315)⟩, ⟨1367, 1377⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨40828913856, 40828913864⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value497

def j47 : Jet := ⟨⟨10012015213, 10012015226⟩, ⟨1430287887, 1430287898⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨23339048173, 23339048235⟩, ⟨6668299474, 6668299536⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨23339048173, 23339048235⟩, ⟨6668299474, 6668299536⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-23339048235), (-23339048173)⟩, ⟨(-6668299536), (-6668299474)⟩, ⟨(-476307113), (-476307105)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11669524118), (-11669524086)⟩, ⟨(-3334149768), (-3334149737)⟩, ⟨(-238153557), (-238153552)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨283773504, 283773513⟩, ⟨(-220291176), (-220291166)⟩, ⟨69770075, 69770082⟩, ⟨(-9910643), (-9910639)⟩, ⟨(-10969), (-10966)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨221721227, 221721235⟩, ⟨(-180114387), (-180114376)⟩, ⟨60820567, 60820577⟩, ⟨(-9790167), (-9790159)⟩, ⟨297594, 297602⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨902748438, 1203664585⟩, ⟨150458073, 150458074⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2836067860, 3781423818⟩, ⟨472677976, 472677980⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1872722270, 3329284045⟩, ⟨624240754, 832321018⟩, ⟨52020062, 52020064⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨468, 835⟩, ⟨156, 209⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94219), (-93851)⟩, ⟨156, 209⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-73035), (-40921)⟩, ⟨(-18191), (-13477)⟩, ⟨(-1115), (-1084)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5040021, 5072136⟩, ⟨(-18191), (-13477)⟩, ⟨(-1115), (-1084)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2197585, 3931714⟩, ⟨718427, 977053⟩, ⟨56653, 59004⟩, ⟨(-438), (-315)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140967992), (-139233862)⟩, ⟨718427, 977053⟩, ⟨56653, 59004⟩, ⟨(-438), (-315)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-109272657), (-60709741)⟩, ⟨(-27004912), (-19479208)⟩, ⟨(-1578267), (-1451300)⟩, ⟨16595, 23132⟩, ⟨590, 666⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1322383108, 1370946025⟩, ⟨(-27004912), (-19479208)⟩, ⟨(-1578267), (-1451300)⟩, ⟨16595, 23132⟩, ⟨590, 666⟩⟩
...
def j72 : Jet := ⟨⟨5123, 9140⟩, ⟨1690, 2279⟩, ⟨135, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847054), (-843036)⟩, ⟨1690, 2279⟩, ⟨135, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-656602), (-367586)⟩, ⟨(-163415), (-120761)⟩, ⟨(-9957), (-9658)⟩, ⟨37, 56⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35134792, 35423809⟩, ⟨(-163415), (-120761)⟩, ⟨(-9957), (-9658)⟩, ⟨37, 56⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15319722, 27459097⟩, ⟨4979901, 6812120⟩, ⟨386159, 407287⟩, ⟨(-3894), (-2821)⟩, ⟨(-117), (-103)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700508161), (-688368785)⟩, ⟨4979901, 6812120⟩, ⟨386159, 407287⟩, ⟨(-3894), (-2821)⟩, ⟨(-117), (-103)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-543005449), (-300147466)⟩, ⟨(-133579993), (-94768676)⟩, ⟨(-7592296), (-6701596)⟩, ⟨113421, 160207⟩, ⟨3831, 4480⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3751961847, 3994819830⟩, ⟨(-133579993), (-94768676)⟩, ⟨(-7592296), (-6701596)⟩, ⟨113421, 160207⟩, ⟨3831, 4480⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨873200649, 1207023848⟩, ⟨121757470, 138015404⟩, ⟨(-4361553), (-3102090)⟩, ⟨(-162737), (-139354)⟩, ⟨2215, 3133⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4617666092, 4916559610⟩, ⟨109544389, 175042826⟩, ⟨10345173, 16180922⟩, ⟨232011, 790705⟩, ⟨10322, 52872⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨938807853, 1381711266⟩, ⟨153176852, 207182446⟩, ⟨215932, 6837062⟩, ⟨(-23605), 513233⟩, ⟨(-12009), 32830⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1203664585), (-902748438)⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3091302711, 3392218858⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨205207659, 444503041⟩, ⟨66963784, 133303144⟩, ⟨5557337, 14393187⟩, ⟨214, 989840⟩, ⟨(-9996), 81524⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4500174955, 4739470337⟩, ⟨66963784, 133303144⟩, ⟨5557337, 14393187⟩, ⟨214, 989840⟩, ⟨(-9996), 81524⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4396373989, 4511748010⟩, ⟨31873152, 65114188⟩, ⟨2175290, 6915059⟩, ⟨(-102315), 467735⟩, ⟨(-17250), 40801⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3164290178, 3563434976⟩, ⟨(-135111473), (-102582476)⟩, ⟨(-715368), 4345045⟩, ⟨(-323054), 293220⟩, ⟨(-30011), 35811⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8581727326, 11442303114⟩, ⟨1430287887, 1430287898⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17147055803, 30483654829⟩, ⟨5715685264, 7620913754⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17147055803, 30483654829⟩, ⟨5715685264, 7620913754⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-30483654829), (-17147055803)⟩, ⟨(-7620913754), (-5715685264)⟩, ⟨(-476307113), (-476307105)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15241827415), (-8573527901)⟩, ⟨(-3810456877), (-2857842632)⟩, ⟨(-238153557), (-238153552)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨123523907, 583485269⟩, ⟨(-517662954), (-82191984)⟩, ⟨(-5008936), 222783658⟩, ⟨(-62845562), 20617378⟩, ⟨(-10749504), 14077878⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨91005462, 484104226⟩, ⟨(-447848307), (-63504714)⟩, ⟨(-2289884), 201713424⟩, ⟨(-59717445), 17389391⟩, ⟨(-9643726), 13926277⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1053206511, 1053206512⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨150458073, 150458074⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4446048440, 4446048444⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar497 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2296
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar497 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨902748438, 1203664585⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4396373989, 4511748010⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2297
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((3363 / 16000) : ℝ)..(1121 / 4000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (3363 / 16000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (1121 / 4000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((3363 / 16000) : ℝ)..(1121 / 4000), prawitzNormalCorrection
      ((274421 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
