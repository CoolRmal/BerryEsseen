...
namespace FiniteNormalPanel104_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (19999 / 80000)
def radius : Rat := (2857 / 80000)

def j0 : Jet := ⟨⟨1073688136, 1073688137⟩, ⟨153384019, 153384020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3373090760, 3373090764⟩, ⟨481870107, 481870111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2649086824, 2649086831⟩, ⟨756881946, 756881956⟩, ⟨54062996, 54062997⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨663, 664⟩, ⟨189, 190⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94024), (-94022)⟩, ⟨189, 190⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-57993), (-57991)⟩, ⟨(-16454), (-16451)⟩, ⟨(-1143), (-1140)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5055063, 5055066⟩, ⟨(-16454), (-16451)⟩, ⟨(-1143), (-1140)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3117905, 3117908⟩, ⟨880681, 880685⟩, ⟨60025, 60029⟩, ⟨(-408), (-403)⟩, ⟨(-15), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-140047672), (-140047668)⟩, ⟨880681, 880685⟩, ⟨60025, 60029⟩, ⟨(-408), (-403)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-86379807), (-86379803)⟩, ⟨(-24136752), (-24136746)⟩, ⟨(-1570634), (-1570628)⟩, ⟨21410, 21417⟩, ⟨673, 679⟩⟩
...
def j19 : Jet := ⟨⟨1345275958, 1345275963⟩, ⟨(-24136752), (-24136746)⟩, ⟨(-1570634), (-1570628)⟩, ⟨21410, 21417⟩, ⟨673, 679⟩⟩
...
def j22 : Jet := ⟨⟨(-67), (-65)⟩, ⟨(-20), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11768, 11771⟩, ⟨(-20), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7258, 7261⟩, ⟨2060, 2064⟩, ⟨142, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844919), (-844915)⟩, ⟨2060, 2064⟩, ⟨142, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-521137), (-521133)⟩, ⟨(-147627), (-147621)⟩, ⟨(-10186), (-10180)⟩, ⟨48, 52⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35270257, 35270262⟩, ⟨(-147627), (-147621)⟩, ⟨(-10186), (-10180)⟩, ⟨48, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21754292, 21754296⟩, ⟨6124456, 6124463⟩, ⟨411666, 411674⟩, ⟨(-3626), (-3618)⟩, ⟨(-122), (-116)⟩⟩
...
def j33 : Jet := ⟨⟨(-694073591), (-694073586)⟩, ⟨6124456, 6124463⟩, ⟨411666, 411674⟩, ⟨(-3626), (-3618)⟩, ⟨(-122), (-116)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-428096673), (-428096668)⟩, ⟨(-118535842), (-118535834)⟩, ⟨(-7403473), (-7403464)⟩, ⟨147399, 147409⟩, ⟨4466, 4474⟩⟩
...
def j36 : Jet := ⟨⟨3866870623, 3866870628⟩, ⟨(-118535842), (-118535834)⟩, ⟨(-7403473), (-7403464)⟩, ⟨147399, 147409⟩, ⟨4466, 4474⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1056524436, 1056524443⟩, ⟨131976048, 131976056⟩, ⟨(-3941514), (-3941507)⟩, ⟨(-159402), (-159394)⟩, ⟨2930, 2937⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4770458039, 4770458046⟩, ⟨146234584, 146234596⟩, ⟨13616164, 13616179⟩, ⟨515515, 515532⟩, ⟨30775, 30792⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1173491005, 1173491015⟩, ⟨182559389, 182559404⟩, ⟨3465088, 3465103⟩, ⟨233959, 233976⟩, ⟨8740, 8758⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1073688137), (-1073688136)⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3221279159, 3221279160⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨320626687, 320626694⟩, ⟨99759456, 99759466⟩, ⟨9653257, 9653269⟩, ⟨422416, 422430⟩, ⟨27457, 27474⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4615593983, 4615593990⟩, ⟨99759456, 99759466⟩, ⟨9653257, 9653269⟩, ⟨422416, 422430⟩, ⟨27457, 27474⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4452395446, 4452395450⟩, ⟨48116076, 48116082⟩, ⟨4395977, 4395985⟩, ⟨156233, 156242⟩, ⟨9383, 9394⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3339352239, 3339352244⟩, ⟨(-122918515), (-122918508)⟩, ⟨1578691, 1578699⟩, ⟨(-39816), (-39807)⟩, ⟨1457, 1467⟩⟩
...
def j47 : Jet := ⟨⟨10194668078, 10194668090⟩, ⟨1456381149, 1456381160⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨24198381514, 24198381572⟩, ⟨6913823266, 6913823328⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨24198381514, 24198381572⟩, ⟨6913823266, 6913823328⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-24198381572), (-24198381514)⟩, ⟨(-6913823328), (-6913823266)⟩, ⟨(-493844525), (-493844517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12099190786), (-12099190757)⟩, ⟨(-3456911664), (-3456911633)⟩, ⟨(-246922263), (-246922258)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨256758725, 256758734⟩, ⟨(-206658678), (-206658668)⟩, ⟨68405859, 68405866⟩, ⟨(-10432039), (-10432035)⟩, ⟨132757, 132760⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨199630815, 199630823⟩, ⟨(-168026082), (-168026072)⟩, ⟨59194576, 59194586⟩, ⟨(-10147012), (-10147004)⟩, ⟨428920, 428927⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨920304117, 1227072157⟩, ⟨153384019, 153384020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2891220652, 3854960874⟩, ⟨481870107, 481870111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1946267871, 3460031781⟩, ⟨648755954, 865007950⟩, ⟨54062996, 54062997⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨487, 867⟩, ⟨162, 217⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94200), (-93819)⟩, ⟨162, 217⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-75888), (-42514)⟩, ⟨(-18899), (-13996)⟩, ⟨(-1157), (-1124)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5037168, 5070543⟩, ⟨(-18899), (-13996)⟩, ⟨(-1157), (-1124)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2282596, 4084837⟩, ⟨745639, 1014868⟩, ⟨58665, 61203⟩, ⟨(-471), (-340)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140882981), (-139080739)⟩, ⟨745639, 1014868⟩, ⟨58665, 61203⟩, ⟨(-471), (-340)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-113495531), (-63024548)⟩, ⟨(-28035997), (-20190602)⟩, ⟨(-1634156), (-1496980)⟩, ⟨17866, 24948⟩, ⟨630, 716⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1318160234, 1368631218⟩, ⟨(-28035997), (-20190602)⟩, ⟨(-1634156), (-1496980)⟩, ⟨17866, 24948⟩, ⟨630, 716⟩⟩
...
def j72 : Jet := ⟨⟨5323, 9497⟩, ⟨1756, 2368⟩, ⟨140, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846854), (-842679)⟩, ⟨1756, 2368⟩, ⟨140, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-682227), (-381860)⟩, ⟨(-169762), (-125378)⟩, ⟨(-10332), (-10011)⟩, ⟨41, 60⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35109167, 35409535⟩, ⟨(-169762), (-125378)⟩, ⟨(-10332), (-10011)⟩, ⟨41, 60⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15909747, 28525972⟩, ⟨5166488, 7074679⟩, ⟨399422, 422245⟩, ⟨(-4200), (-3041)⟩, ⟨(-126), (-111)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699918136), (-687301910)⟩, ⟨5166488, 7074679⟩, ⟨399422, 422245⟩, ⟨(-4200), (-3041)⟩, ⟨(-126), (-111)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-563855049), (-311451411)⟩, ⟨(-138622565), (-98117764)⟩, ⟨(-7848839), (-6886423)⟩, ⟨121981, 172716⟩, ⟨4079, 4807⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3731112247, 3983515885⟩, ⟨(-138622565), (-98117764)⟩, ⟨(-7848839), (-6886423)⟩, ⟨121981, 172716⟩, ⟨4079, 4807⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨887339024, 1228419086⟩, ⟨122726042, 139960786⟩, ⟨(-4612217), (-3272980)⟩, ⟨(-171317), (-145559)⟩, ⟨2428, 3443⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4630769552, 4944033536⟩, ⟨114060233, 183686411⟩, ⟨10814759, 17224894⟩, ⟨249193, 874973⟩, ⟨10901, 59954⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨956715674, 1414060863⟩, ⟨155886195, 213648825⟩, ⟨184299, 7383496⟩, ⟨(-33954), 567708⟩, ⟨(-13836), 37519⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1227072157), (-920304117)⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3067895139, 3374663179⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨213111024, 465560734⟩, ⟨69448148, 140682070⟩, ⟨5740008, 15489582⟩, ⟨(-8980), 1108392⟩, ⟨(-12485), 93881⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4508078320, 4760528030⟩, ⟨69448148, 140682070⟩, ⟨5740008, 15489582⟩, ⟨(-8980), 1108392⟩, ⟨(-12485), 93881⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4400232829, 4521759857⟩, ⟨32982459, 68658287⟩, ⟨2204803, 7435903⟩, ⟨(-120408), 524413⟩, ⟨(-20560), 47145⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3143086309, 3552859765⟩, ⟨(-137923980), (-103196781)⟩, ⟨(-877070), 4664689⟩, ⟨(-360163), 333306⟩, ⟨(-34884), 41345⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8738286928, 11651049250⟩, ⟨1456381149, 1456381160⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17778402761, 31606049423⟩, ⟨5926134230, 7901512378⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17778402761, 31606049423⟩, ⟨5926134230, 7901512378⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-31606049423), (-17778402761)⟩, ⟨(-7901512378), (-5926134230)⟩, ⟨(-493844525), (-493844517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15803024712), (-8889201380)⟩, ⟨(-3950756189), (-2963067115)⟩, ⟨(-246922263), (-246922258)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨108393790, 542138092⟩, ⟨(-498689577), (-74780097)⟩, ⟨(-5372973), 223129902⟩, ⟨(-65549751), 20760921⟩, ⟨(-11188259), 15228551⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨79323313, 448464559⟩, ⟨(-429932955), (-57329002)⟩, ⟨(-2758543), 201179509⟩, ⟨(-61976150), 17490190⟩, ⟨(-10010457), 14991652⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1073688136, 1073688137⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4452395446, 4452395450⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2094
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨920304117, 1227072157⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4400232829, 4521759857⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2095
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (124079 / 33554432)

theorem envelope_integral : (∫ s in ((8571 / 40000) : ℝ)..(2857 / 10000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((8571 / 40000) : ℝ)..(2857 / 10000), prawitzNormalCorrection
