...
namespace FiniteNormalPanel136_19
...
def j2 : Jet := ⟨⟨483270010, 483270014⟩, ⟨483270010, 483270014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨54377574, 54377576⟩, ⟨108755148, 108755152⟩, ⟨54377574, 54377576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨13, 14⟩, ⟨27, 28⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94674), (-94672)⟩, ⟨27, 28⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1199), (-1198)⟩, ⟨(-2398), (-2396)⟩, ⟨(-1199), (-1196)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111857, 5111859⟩, ⟨(-2398), (-2396)⟩, ⟨(-1199), (-1196)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨64720, 64721⟩, ⟨129409, 129411⟩, ⟨64643, 64646⟩, ⟨(-62), (-59)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-143100857), (-143100855)⟩, ⟨129409, 129411⟩, ⟨64643, 64646⟩, ⟨(-62), (-59)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1811767), (-1811766)⟩, ⟨(-3621895), (-3621893)⟩, ⟨(-1807673), (-1807670)⟩, ⟨3273, 3276⟩, ⟨815, 818⟩⟩
...
def j19 : Jet := ⟨⟨1429843998, 1429844000⟩, ⟨(-3621895), (-3621893)⟩, ⟨(-1807673), (-1807670)⟩, ⟨3273, 3276⟩, ⟨815, 818⟩⟩
...
def j25 : Jet := ⟨⟨149, 150⟩, ⟨298, 300⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852028), (-852026)⟩, ⟨298, 300⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10788), (-10787)⟩, ⟨(-21572), (-21570)⟩, ⟨(-10780), (-10777)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780606, 35780608⟩, ⟨(-21572), (-21570)⟩, ⟨(-10780), (-10777)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨453009, 453010⟩, ⟨905745, 905747⟩, ⟨452325, 452328⟩, ⟨(-547), (-544)⟩, ⟨(-138), (-134)⟩⟩
...
def j33 : Jet := ⟨⟨(-715374874), (-715374872)⟩, ⟨905745, 905747⟩, ⟨452325, 452328⟩, ⟨(-547), (-544)⟩, ⟨(-138), (-134)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9057194), (-9057193)⟩, ⟨(-18102921), (-18102919)⟩, ⟨(-9028534), (-9028531)⟩, ⟨22913, 22916⟩, ⟨5710, 5713⟩⟩
...
def j36 : Jet := ⟨⟨4285910102, 4285910103⟩, ⟨(-18102921), (-18102919)⟩, ⟨(-9028534), (-9028531)⟩, ⟨22913, 22916⟩, ⟨5710, 5713⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨160886143, 160886145⟩, ⟨160478607, 160478610⟩, ⟨(-610936), (-610934)⟩, ⟨(-203032), (-203030)⟩, ⟨459, 462⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304043629, 4304043631⟩, ⟨18179510, 18179514⟩, ⟨9143516, 9143522⟩, ⟨53902, 53909⟩, ⟨13652, 13660⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨161226135, 161226138⟩, ⟨161498728, 161498733⟩, ⟨409546, 409551⟩, ⟨137612, 137618⟩, ⟨823, 831⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-153829623), (-153829622)⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4141137673, 4141137674⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6052168, 6052169⟩, ⟨12124802, 12124804⟩, ⟨6103397, 6103400⟩, ⟨41128, 41132⟩, ⟨10447, 10454⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301019464, 4301019465⟩, ⟨12124802, 12124804⟩, ⟨6103397, 6103400⟩, ⟨41128, 41132⟩, ⟨10447, 10454⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297992314, 4297992316⟩, ⟨6058134, 6058136⟩, ⟨3045280, 3045283⟩, ⟨16256, 16260⟩, ⟨4117, 4123⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4144054346, 4144054350⟩, ⟨(-148096814), (-148096809)⟩, ⟨2719229, 2719234⟩, ⟨(-93398), (-93392)⟩, ⟨3386, 3394⟩⟩
...
def j47 : Jet := ⟨⟨1307971638, 1307971648⟩, ⟨1307971638, 1307971648⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨398324291, 398324298⟩, ⟨796648582, 796648596⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨398324291, 398324298⟩, ⟨796648582, 796648596⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-398324298), (-398324291)⟩, ⟨(-796648596), (-796648582)⟩, ⟨(-398324298), (-398324291)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-199162149), (-199162145)⟩, ⟨(-398324298), (-398324291)⟩, ⟨(-199162149), (-199162145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4100352270, 4100352275⟩, ⟨(-380275292), (-380275284)⟩, ⟨(-172503882), (-172503876)⟩, ⟨17088633, 17088635⟩, ⟨3603383, 3603385⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3956277539, 3956277548⟩, ⟨(-508299700), (-508299685)⟩, ⟨(-150734120), (-150734105)⟩, ⟨22106447, 22106459⟩, ⟨2789812, 2789828⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 307659245⟩, ⟨153829622, 153829623⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 966540024⟩, ⟨483270010, 483270014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 217510299⟩, ⟨0, 217510300⟩, ⟨54377574, 54377576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 55⟩, ⟨0, 55⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94631)⟩, ⟨0, 55⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4796), 0⟩, ⟨(-4796), 3⟩, ⟨(-1199), (-1194)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108260, 5113057⟩, ⟨(-4796), 3⟩, ⟨(-1199), (-1194)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 258941⟩, ⟨(-243), 258942⟩, ⟨64370, 64737⟩, ⟨(-122), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142906635)⟩, ⟨(-243), 258942⟩, ⟨64370, 64737⟩, ⟨(-122), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7250344), 0⟩, ⟨(-7250357), 13114⟩, ⟨(-1812599), (-1792914)⟩, ⟨(-11), 6559⟩, ⟨806, 821⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424405421, 1431655766⟩, ⟨(-7250357), 13114⟩, ⟨(-1812599), (-1792914)⟩, ⟨(-11), 6559⟩, ⟨806, 821⟩⟩
...
def j72 : Jet := ⟨⟨0, 600⟩, ⟨(-1), 600⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851576)⟩, ⟨(-1), 600⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-43157), 0⟩, ⟨(-43158), 31⟩, ⟨(-10791), (-10742)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35748237, 35791395⟩, ⟨(-43158), 31⟩, ⟨(-10791), (-10742)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1812586⟩, ⟨(-2186), 1812588⟩, ⟨449867, 453149⟩, ⟨(-1095), 2⟩, ⟨(-139), (-134)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714015296)⟩, ⟨(-2186), 1812588⟩, ⟨449867, 453149⟩, ⟨(-1095), 2⟩, ⟨(-139), (-134)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-36251717), 0⟩, ⟨(-36251828), 91796⟩, ⟨(-9063041), (-8925235)⟩, ⟨(-84), 45899⟩, ⟨5631, 5739⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4258715579, 4294967296⟩, ⟨(-36251828), 91796⟩, ⟨(-9063041), (-8925235)⟩, ⟨(-84), 45899⟩, ⟨5631, 5739⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 322180009⟩, ⟨158642572, 161092957⟩, ⟨(-1223719), 1476⟩, ⟨(-203957), (-200261)⟩, ⟨(-2), 924⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4331527601⟩, ⟨(-93367), 36871633⟩, ⟨8924446, 9531860⟩, ⟨(-47090), 159693⟩, ⟨11964, 15967⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 324922522⟩, ⟨158635568, 165230105⟩, ⟨(-1237638), 2099466⟩, ⟨109907, 169262⟩, ⟨(-6237), 8129⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-307659245), 0⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3987308051, 4294967296⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 24581013⟩, ⟨0, 24999950⟩, ⟨5671979, 6674165⟩, ⟨(-95226), 187146⟩, ⟨6569, 15281⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4319548309⟩, ⟨0, 24999950⟩, ⟨5671979, 6674165⟩, ⟨(-95226), 187146⟩, ⟨6569, 15281⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307240268⟩, ⟨0, 12499975⟩, ⟨2809770, 3337083⟩, ⟨(-57326), 93573⟩, ⟨1710, 6889⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3987308051, 4307240268⟩, ⟨(-154269195), (-141329647)⟩, ⟨2160796, 3337083⟩, ⟨(-176848), (-7062)⟩, ⟨(-1765), 8943⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2615943286⟩, ⟨1307971638, 1307971648⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1593297179⟩, ⟨0, 1593297186⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1593297179⟩, ⟨0, 1593297186⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1593297179), 0⟩, ⟨(-1593297186), 0⟩, ⟨(-398324298), (-398324291)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-796648590), 0⟩, ⟨(-796648593), 0⟩, ⟨(-199162149), (-199162145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3567837739, 4294967296⟩, ⟨(-796648593), 0⟩, ⟨(-199162149), (-91561518)⟩, ⟨0, 36941433⟩, ⟨409888, 4617680⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3312264602, 4307240268⟩, ⟨(-953194231), (-117402814)⟩, ⟨(-197936283), (-53051155)⟩, ⟨2217086, 44194754⟩, ⟨(-1102869), 4626558⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297992314, 4297992316⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2744
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307240268⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2745
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (279865181 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(28653 / 400000), prawitzNormalCorrection
