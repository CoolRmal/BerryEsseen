...
namespace FiniteNormalPanel103_9
...
def j2 : Jet := ⟨⟨494351167, 494351172⟩, ⟨494351167, 494351172⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨56899868, 56899871⟩, ⟨113799736, 113799742⟩, ⟨56899868, 56899871⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1255), (-1254)⟩, ⟨(-2509), (-2507)⟩, ⟨(-1255), (-1252)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111801, 5111803⟩, ⟨(-2509), (-2507)⟩, ⟨(-1255), (-1252)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨67721, 67722⟩, ⟨135408, 135410⟩, ⟨67637, 67640⟩, ⟨(-68), (-65)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-143097856), (-143097854)⟩, ⟨135408, 135410⟩, ⟨67637, 67640⟩, ⟨(-68), (-65)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1895766), (-1895765)⟩, ⟨(-3789738), (-3789736)⟩, ⟨(-1891283), (-1891280)⟩, ⟨3584, 3587⟩, ⟨893, 896⟩⟩
...
def j19 : Jet := ⟨⟨1429759999, 1429760001⟩, ⟨(-3789738), (-3789736)⟩, ⟨(-1891283), (-1891280)⟩, ⟨3584, 3587⟩, ⟨893, 896⟩⟩
...
def j25 : Jet := ⟨⟨156, 157⟩, ⟨312, 314⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852021), (-852019)⟩, ⟨312, 314⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11288), (-11287)⟩, ⟨(-22572), (-22570)⟩, ⟨(-11278), (-11275)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35780106, 35780108⟩, ⟨(-22572), (-22570)⟩, ⟨(-11278), (-11275)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨474016, 474017⟩, ⟨947732, 947734⟩, ⟨473267, 473270⟩, ⟨(-599), (-596)⟩, ⟨(-150), (-147)⟩⟩
...
def j33 : Jet := ⟨⟨(-715353867), (-715353865)⟩, ⟨947732, 947734⟩, ⟨473267, 473270⟩, ⟨(-599), (-596)⟩, ⟨(-150), (-147)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9477033), (-9477031)⟩, ⟨(-18941510), (-18941507)⟩, ⟨(-9445653), (-9445649)⟩, ⟨25086, 25089⟩, ⟨6251, 6254⟩⟩
...
def j36 : Jet := ⟨⟨4285490263, 4285490265⟩, ⟨(-18941510), (-18941507)⟩, ⟨(-9445653), (-9445649)⟩, ⟨25086, 25089⟩, ⟨6251, 6254⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨164565519, 164565522⟩, ⟨164129319, 164129324⟩, ⟨(-653887), (-653884)⟩, ⟨(-217275), (-217273)⟩, ⟨514, 517⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304465284, 4304465287⟩, ⟨19025374, 19025379⟩, ⟨9571562, 9571569⟩, ⟨59038, 59045⟩, ⟨14963, 14971⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨164929442, 164929447⟩, ⟨165221252, 165221259⟩, ⟨438450, 438457⟩, ⟨147379, 147386⟩, ⟨923, 931⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-157356865), (-157356864)⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4137610431, 4137610432⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6333394, 6333395⟩, ⟨12689198, 12689202⟩, ⟨6389497, 6389502⟩, ⟨45050, 45054⟩, ⟨11452, 11457⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301300690, 4301300691⟩, ⟨12689198, 12689202⟩, ⟨6389497, 6389502⟩, ⟨45050, 45054⟩, ⟨11452, 11457⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298132826, 4298132827⟩, ⟨6339926, 6339929⟩, ⟨3187719, 3187723⟩, ⟨17805, 17809⟩, ⟨4512, 4517⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4140659983, 4140659986⟩, ⟨(-151365197), (-151365191)⟩, ⟨2838648, 2838654⟩, ⟨(-99639), (-99633)⟩, ⟨3693, 3700⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨42653332137, 42653332144⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value462

def j47 : Jet := ⟨⟨1562711453, 1562711464⟩, ⟨1562711453, 1562711464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨568588051, 568588060⟩, ⟨1137176102, 1137176120⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨568588051, 568588060⟩, ⟨1137176102, 1137176120⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-568588060), (-568588051)⟩, ⟨(-1137176120), (-1137176102)⟩, ⟨(-568588060), (-568588051)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-284294030), (-284294025)⟩, ⟨(-568588060), (-568588051)⟩, ⟨(-284294030), (-284294025)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4019878100, 4019878106⟩, ⟨(-532170454), (-532170444)⟩, ⟨(-230859609), (-230859602)⟩, ⟨33671173, 33671175⟩, ⟨6526183, 6526185⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3875454046, 3875454055⟩, ⟨(-654721295), (-654721277)⟩, ⟨(-201153582), (-201153565)⟩, ⟨40152527, 40152540⟩, ⟨4968277, 4968292⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 314713729⟩, ⟨157356864, 157356865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 988702340⟩, ⟨494351167, 494351172⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 227599479⟩, ⟨0, 227599480⟩, ⟨56899868, 56899871⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5018), 0⟩, ⟨(-5018), 4⟩, ⟨(-1255), (-1248)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108038, 5113057⟩, ⟨(-5018), 4⟩, ⟨(-1255), (-1248)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 270952⟩, ⟨(-266), 270953⟩, ⟨67338, 67739⟩, ⟨(-134), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142894624)⟩, ⟨(-266), 270953⟩, ⟨67338, 67739⟩, ⟨(-134), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7586650), 0⟩, ⟨(-7586665), 14359⟩, ⟨(-1896678), (-1875123)⟩, ⟨(-12), 7181⟩, ⟨883, 899⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424069115, 1431655766⟩, ⟨(-7586665), 14359⟩, ⟨(-1896678), (-1875123)⟩, ⟨(-12), 7181⟩, ⟨883, 899⟩⟩
...
def j72 : Jet := ⟨⟨0, 628⟩, ⟨(-1), 628⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851548)⟩, ⟨(-1), 628⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-45159), 0⟩, ⟨(-45160), 34⟩, ⟨(-11291), (-11238)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35746235, 35791395⟩, ⟨(-45160), 34⟩, ⟨(-11291), (-11238)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1896663⟩, ⟨(-2394), 1896665⟩, ⟨470574, 474168⟩, ⟨(-1199), 2⟩, ⟨(-151), (-146)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713931219)⟩, ⟨(-2394), 1896665⟩, ⟨470574, 474168⟩, ⟨(-1199), 2⟩, ⟨(-151), (-146)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-37933247), 0⟩, ⟨(-37933374), 100509⟩, ⟨(-9483439), (-9332547)⟩, ⟨(-96), 50257⟩, ⟨6161, 6283⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4257034049, 4294967296⟩, ⟨(-37933374), 100509⟩, ⟨(-9483439), (-9332547)⟩, ⟨(-96), 50257⟩, ⟨6161, 6283⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 329567447⟩, ⟨162164046, 164787031⟩, ⟨(-1309842), 1653⟩, ⟨(-218311), (-214172)⟩, ⟨(-2), 1034⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4333238556⟩, ⟨(-102309), 38612414⟩, ⟨9331643, 9997268⟩, ⟨(-51621), 175200⟩, ⟨13029, 17620⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 332504131⟩, ⟨162156195, 169218265⟩, ⟨(-1325440), 2250254⟩, ⟨116337, 182874⟩, ⟨(-6996), 9129⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-314713729), 0⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3980253567, 4294967296⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 25741523⟩, ⟨0, 26200792⟩, ⟨5916971, 7015482⟩, ⟨(-104444), 205634⟩, ⟨7005, 17005⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4320708819⟩, ⟨0, 26200792⟩, ⟨5916971, 7015482⟩, ⟨(-104444), 205634⟩, ⟨7005, 17005⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307818831⟩, ⟨0, 13100396⟩, ⟨2929739, 3507741⟩, ⟨(-62922), 102817⟩, ⟨1750, 7696⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3980253567, 4307818831⟩, ⟨(-157827714), (-144256468)⟩, ⟨2235096, 3507741⟩, ⟨(-191437), (-4521)⟩, ⟨(-2146), 10002⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3125422917⟩, ⟨1562711453, 1562711464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2274352222⟩, ⟨0, 2274352230⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2274352222⟩, ⟨0, 2274352230⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2274352222), 0⟩, ⟨(-2274352230), 0⟩, ⟨(-568588060), (-568588051)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1137176111), 0⟩, ⟨(-1137176115), 0⟩, ⟨(-284294030), (-284294025)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3295884253, 4294967296⟩, ⟨(-1137176115), 0⟩, ⟨(-284294030), (-67617614)⟩, ⟨0, 75272374⟩, ⟨(-2744572), 9409047⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3054378334, 4307818831⟩, ⟨(-1298406523), (-110699939)⟩, ⟨(-283429530), (-17367235)⟩, ⟨1150914, 85941128⟩, ⟨(-5753161), 9462703⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298132826, 4298132827⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar462 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2074
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar462 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307818831⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2075
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(2931 / 40000), prawitzNormalCorrection
      ((299431 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
