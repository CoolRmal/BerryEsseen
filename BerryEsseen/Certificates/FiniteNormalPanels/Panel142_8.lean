...
namespace FiniteNormalPanel142_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (183701 / 800000)
def radius : Rat := (26243 / 800000)

def j0 : Jet := ⟨⟨986237234, 986237235⟩, ⟨140891033, 140891034⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3098355648, 3098355653⟩, ⟨442622234, 442622238⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2235129410, 2235129418⟩, ⟨638608400, 638608408⟩, ⟨45614885, 45614887⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨559, 560⟩, ⟨159, 160⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94128), (-94126)⟩, ⟨159, 160⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48985), (-48983)⟩, ⟨(-13914), (-13911)⟩, ⟨(-972), (-968)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064071, 5064074⟩, ⟨(-13914), (-13911)⟩, ⟨(-972), (-968)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2635376, 2635378⟩, ⟨745723, 745727⟩, ⟨51208, 51213⟩, ⟨(-292), (-287)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140530201), (-140530198)⟩, ⟨745723, 745727⟩, ⟨51208, 51213⟩, ⟨(-292), (-287)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-73132848), (-73132845)⟩, ⟨(-20507021), (-20507016)⟩, ⟨(-1354981), (-1354974)⟩, ⟨15380, 15387⟩, ⟨493, 498⟩⟩
...
def j19 : Jet := ⟨⟨1358522917, 1358522921⟩, ⟨(-20507021), (-20507016)⟩, ⟨(-1354981), (-1354974)⟩, ⟨15380, 15387⟩, ⟨493, 498⟩⟩
...
def j25 : Jet := ⟨⟨6129, 6131⟩, ⟨1742, 1745⟩, ⟨120, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846048), (-846045)⟩, ⟨1742, 1745⟩, ⟨120, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-440289), (-440287)⟩, ⟨(-124891), (-124887)⟩, ⟨(-8665), (-8660)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35351105, 35351108⟩, ⟨(-124891), (-124887)⟩, ⟨(-8665), (-8660)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18396949, 18396951⟩, ⟨5191276, 5191280⟩, ⟨352367, 352373⟩, ⟨(-2599), (-2593)⟩, ⟨(-90), (-83)⟩⟩
...
def j33 : Jet := ⟨⟨(-697430934), (-697430931)⟩, ⟨5191276, 5191280⟩, ⟨352367, 352373⟩, ⟨(-2599), (-2593)⟩, ⟨(-90), (-83)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-362947676), (-362947672)⟩, ⟨(-100997763), (-100997757)⟩, ⟨(-6451844), (-6451838)⟩, ⟨106173, 106180⟩, ⟨3308, 3315⟩⟩
...
def j36 : Jet := ⟨⟨3932019620, 3932019624⟩, ⟨(-100997763), (-100997757)⟩, ⟨(-6451844), (-6451838)⟩, ⟨106173, 106180⟩, ⟨3308, 3315⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨980027754, 980027759⟩, ⟨125210360, 125210367⟩, ⟨(-3090845), (-3090838)⟩, ⟨(-128544), (-128537)⟩, ⟨1940, 1946⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4691417092, 4691417098⟩, ⟨120503620, 120503630⟩, ⟨10793144, 10793154⟩, ⟨348270, 348284⟩, ⟨19444, 19459⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1070489863, 1070489871⟩, ⟨164264560, 164264571⟩, ⟨2599654, 2599669⟩, ⟨166988, 167003⟩, ⟨5333, 5348⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-986237235), (-986237234)⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3308730061, 3308730062⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨266811937, 266811942⟩, ⟨81883532, 81883540⟩, ⟨7578323, 7578333⟩, ⟨282090, 282104⟩, ⟨17003, 17016⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4561779233, 4561779238⟩, ⟨81883532, 81883540⟩, ⟨7578323, 7578333⟩, ⟨282090, 282104⟩, ⟨17003, 17016⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4426363362, 4426363365⟩, ⟨39726414, 39726419⟩, ⟨3498409, 3498415⟩, ⟨105459, 105468⟩, ⟨5919, 5928⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3409954141, 3409954145⟩, ⟨(-114597132), (-114597125)⟩, ⟨1391906, 1391913⟩, ⟨(-33520), (-33510)⟩, ⟨1099, 1108⟩⟩
...
def j47 : Jet := ⟨⟨10972375669, 10972375682⟩, ⟨1567482233, 1567482246⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨28031186159, 28031186226⟩, ⟨8008910302, 8008910380⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨28031186159, 28031186226⟩, ⟨8008910302, 8008910380⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-28031186226), (-28031186159)⟩, ⟨(-8008910380), (-8008910302)⟩, ⟨(-572065030), (-572065019)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-14015593113), (-14015593079)⟩, ⟨(-4004455190), (-4004455151)⟩, ⟨(-286032515), (-286032509)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨164340359, 164340366⟩, ⟨(-153224364), (-153224355)⟩, ⟨60485522, 60485529⟩, ⟨(-11995226), (-11995221)⟩, ⟨781884, 781886⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨130476683, 130476690⟩, ⟨(-126036116), (-126036105)⟩, ⟨52163533, 52163542⟩, ⟨(-11188311), (-11188302)⟩, ⟨961662, 961668⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨845346200, 1127128268⟩, ⟨140891033, 140891034⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2655733411, 3540977887⟩, ⟨442622234, 442622238⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1642135891, 2919352706⟩, ⟨547378628, 729838180⟩, ⟨45614885, 45614887⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨411, 732⟩, ⟨137, 183⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94276), (-93954)⟩, ⟨137, 183⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-64081), (-35922)⟩, ⟨(-15969), (-11849)⟩, ⟨(-981), (-956)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5048975, 5077135⟩, ⟨(-15969), (-11849)⟩, ⟨(-981), (-956)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1930422, 3451004⟩, ⟨632619, 858221⟩, ⟨50241, 52047⟩, ⟨(-337), (-242)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141235155), (-139714572)⟩, ⟨632619, 858221⟩, ⟨50241, 52047⟩, ⟨(-337), (-242)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-95999621), (-53418407)⟩, ⟨(-23758031), (-17222789)⟩, ⟨(-1400161), (-1302629)⟩, ⟨12891, 17868⟩, ⟨467, 520⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1335656144, 1378237359⟩, ⟨(-23758031), (-17222789)⟩, ⟨(-1400161), (-1302629)⟩, ⟨12891, 17868⟩, ⟨467, 520⟩⟩
...
def j72 : Jet := ⟨⟨4496, 8018⟩, ⟨1485, 2001⟩, ⟨118, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847681), (-844158)⟩, ⟨1485, 2001⟩, ⟨118, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-576182), (-322754)⟩, ⟨(-143479), (-106223)⟩, ⟨(-8769), (-8539)⟩, ⟨28, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35215212, 35468641⟩, ⟨(-143479), (-106223)⟩, ⟨(-8769), (-8539)⟩, ⟨28, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13464168, 24108560⟩, ⟨4390531, 5986527⟩, ⟨343661, 359896⟩, ⟨(-3005), (-2186)⟩, ⟨(-92), (-80)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702363715), (-691719322)⟩, ⟨4390531, 5986527⟩, ⟨343661, 359896⟩, ⟨(-3005), (-2186)⟩, ⟨(-92), (-80)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-477406991), (-264471658)⟩, ⟨(-117673076), (-84088088)⟩, ⟨(-6768533), (-6084524)⟩, ⟨88384, 123903⟩, ⟨3075, 3515⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3817560305, 4030495638⟩, ⟨(-117673076), (-84088088)⟩, ⟨(-6768533), (-6084524)⟩, ⟨88384, 123903⟩, ⟨3075, 3515⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨825884437, 1136285256⟩, ⟨118060140, 131386186⟩, ⟨(-3602770), (-2580374)⟩, ⟨(-136326), (-119511)⟩, ⟨1616, 2271⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4576792963, 4832076667⟩, ⟨95485468, 148944688⟩, ⟨8901335, 13158366⟩, ⟨181308, 563715⟩, ⟨8425, 34812⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨880077034, 1278384001⟩, ⟨144167984, 187221863⟩, ⟨283037, 5287839⟩, ⟨1227, 366944⟩, ⟨(-7441), 21008⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1127128268), (-845346200)⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3167839028, 3449621096⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨180335618, 380507125⟩, ⟨59082606, 111452042⟩, ⟨4955239, 11309006⟩, ⟨19502, 679446⟩, ⟨(-4330), 51009⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4475302914, 4675474421⟩, ⟨59082606, 111452042⟩, ⟨4955239, 11309006⟩, ⟨19502, 679446⟩, ⟨(-4330), 51009⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4384207984, 4481183966⟩, ⟨28313707, 54591717⟩, ⟨2042131, 5447980⟩, ⟨(-58286), 319620⟩, ⟨(-9487), 25237⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3233660282, 3599186136⟩, ⟨(-126116300), (-99971623)⟩, ⟨(-284600), 3446900⟩, ⟨(-225530), 189723⟩, ⟨(-18105), 22182⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9404893424, 12539857916⟩, ⟨1567482233, 1567482246⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨20594340822, 36612161565⟩, ⟨6864780254, 9153040430⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨20594340822, 36612161565⟩, ⟨6864780254, 9153040430⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-36612161565), (-20594340822)⟩, ⟨(-9153040430), (-6864780254)⟩, ⟨(-572065030), (-572065019)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-18306080783), (-10297170411)⟩, ⟨(-4576520215), (-3432390127)⟩, ⟨(-286032515), (-286032509)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨60520529, 390607186⟩, ⟨(-416213108), (-48365925)⟩, ⟨(-6687128), 217718309⟩, ⟨(-75182862), 20854233⟩, ⟨(-12805037), 20250525⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨45565616, 327329144⟩, ⟨(-360256616), (-37823176)⟩, ⟨(-4503916), 194983177⟩, ⟨(-69750866), 17717060⟩, ⟨(-11377451), 19376210⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨986237234, 986237235⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4426363362, 4426363365⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2856
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨845346200, 1127128268⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4384207984, 4481183966⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2857
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (2488817 / 1073741824)

theorem envelope_integral : (∫ s in ((78729 / 400000) : ℝ)..(26243 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((78729 / 400000) : ℝ)..(26243 / 100000), prawitzNormalCorrection
