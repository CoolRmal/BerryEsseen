...
namespace FiniteNormalPanel95_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (206213 / 800000)
def radius : Rat := (29459 / 800000)

def j0 : Jet := ⟨⟨1107097613, 1107097614⟩, ⟨158156801, 158156802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3478049727, 3478049732⟩, ⟨496864244, 496864248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2816512692, 2816512701⟩, ⟨804717906, 804717916⟩, ⟨57479850, 57479852⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨704, 706⟩, ⟨201, 202⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93983), (-93980)⟩, ⟨201, 202⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-61632), (-61629)⟩, ⟨(-17478), (-17475)⟩, ⟨(-1212), (-1209)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5051424, 5051428⟩, ⟨(-17478), (-17475)⟩, ⟨(-1212), (-1209)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3312574, 3312578⟩, ⟨934987, 934992⟩, ⟨63533, 63538⟩, ⟨(-460), (-455)⟩, ⟨(-17), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-139853003), (-139852998)⟩, ⟨934987, 934992⟩, ⟨63533, 63538⟩, ⟨(-460), (-455)⟩, ⟨(-17), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-91711469), (-91711465)⟩, ⟨(-25590141), (-25590134)⟩, ⟨(-1654819), (-1654812)⟩, ⟨24113, 24121⟩, ⟨751, 758⟩⟩
...
def j19 : Jet := ⟨⟨1339944296, 1339944301⟩, ⟨(-25590141), (-25590134)⟩, ⟨(-1654819), (-1654812)⟩, ⟨24113, 24121⟩, ⟨751, 758⟩⟩
...
def j25 : Jet := ⟨⟨7714, 7716⟩, ⟨2190, 2192⟩, ⟨151, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844463), (-844460)⟩, ⟨2190, 2192⟩, ⟨151, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-553774), (-553771)⟩, ⟨(-156786), (-156782)⟩, ⟨(-10793), (-10788)⟩, ⟨55, 60⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35237620, 35237624⟩, ⟨(-156786), (-156782)⟩, ⟨(-10793), (-10788)⟩, ⟨55, 60⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23107790, 23107794⟩, ⟨6499409, 6499414⟩, ⟨435133, 435139⟩, ⟨(-4086), (-4079)⟩, ⟨(-135), (-130)⟩⟩
...
def j33 : Jet := ⟨⟨(-692720093), (-692720088)⟩, ⟨6499409, 6499414⟩, ⟨435133, 435139⟩, ⟨(-4086), (-4079)⟩, ⟨(-135), (-130)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-454265378), (-454265372)⟩, ⟨(-125527989), (-125527981)⟩, ⟨(-7767628), (-7767619)⟩, ⟨165829, 165838⟩, ⟨4968, 4975⟩⟩
...
def j36 : Jet := ⟨⟨3840701918, 3840701924⟩, ⟨(-125527989), (-125527981)⟩, ⟨(-7767628), (-7767619)⟩, ⟨165829, 165838⟩, ⟨4968, 4975⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1085082276, 1085082283⟩, ⟨134288944, 134288953⟩, ⟨(-4300469), (-4300461)⟩, ⟨(-171913), (-171903)⟩, ⟨3397, 3405⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4802961656, 4802961664⟩, ⟨156978096, 156978108⟩, ⟨14844347, 14844363⟩, ⟨595258, 595274⟩, ⟨36474, 36490⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1213422176, 1213422187⟩, ⟨189831199, 189831215⟩, ⟨3849334, 3849351⟩, ⟨265090, 265111⟩, ⟨10475, 10495⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1107097614), (-1107097613)⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3187869682, 3187869683⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨342818297, 342818304⟩, ⟨107262928, 107262940⟩, ⟨10565300, 10565312⟩, ⟨490054, 490072⟩, ⟨32799, 32818⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4637785593, 4637785600⟩, ⟨107262928, 107262940⟩, ⟨10565300, 10565312⟩, ⟨490054, 490072⟩, ⟨32799, 32818⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4463086090, 4463086094⟩, ⟨51611234, 51611241⟩, ⟨4785242, 4785249⟩, ⟨180460, 180470⟩, ⟨11128, 11140⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3312653124, 3312653129⟩, ⟨(-126039968), (-126039960)⟩, ⟨1651248, 1651255⟩, ⟨(-42268), (-42259)⟩, ⟨1613, 1624⟩⟩
...
def j47 : Jet := ⟨⟨10055113645, 10055113657⟩, ⟨1436444798, 1436444809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨23540414500, 23540414557⟩, ⟨6725832674, 6725832736⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨23540414500, 23540414557⟩, ⟨6725832674, 6725832736⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-23540414557), (-23540414500)⟩, ⟨(-6725832736), (-6725832674)⟩, ⟨(-480416625), (-480416616)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11770207279), (-11770207250)⟩, ⟨(-3362916368), (-3362916337)⟩, ⟨(-240208313), (-240208308)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨277198615, 277198624⟩, ⟨(-217043746), (-217043736)⟩, ⟨69468409, 69468416⟩, ⟨(-10038498), (-10038494)⟩, ⟨22400, 22402⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨213799732, 213799740⟩, ⟨(-175537717), (-175537706)⟩, ⟨60056020, 60056030⟩, ⟨(-9867357), (-9867349)⟩, ⟨340811, 340819⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨948940811, 1265254416⟩, ⟨158156801, 158156802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2981185480, 3974913979⟩, ⟨496864244, 496864248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2069274630, 3678710466⟩, ⟨689758206, 919677618⟩, ⟨57479850, 57479852⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨517, 922⟩, ⟨172, 231⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94170), (-93764)⟩, ⟨172, 231⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-80659), (-45174)⟩, ⟨(-20083), (-14860)⟩, ⟨(-1228), (-1191)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5032397, 5067883⟩, ⟨(-20083), (-14860)⟩, ⟨(-1228), (-1191)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2424561, 4340726⟩, ⟨790985, 1078023⟩, ⟨61995, 64865⟩, ⟨(-531), (-382)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140741016), (-138824850)⟩, ⟨790985, 1078023⟩, ⟨61995, 64865⟩, ⟨(-531), (-382)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-120547007), (-66884500)⟩, ⟨(-29755663), (-21371488)⟩, ⟨(-1726651), (-1571507)⟩, ⟨20086, 28134⟩, ⟨700, 803⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1311108758, 1364771266⟩, ⟨(-29755663), (-21371488)⟩, ⟨(-1726651), (-1571507)⟩, ⟨20086, 28134⟩, ⟨700, 803⟩⟩
...
def j72 : Jet := ⟨⟨5657, 10095⟩, ⟨1864, 2516⟩, ⟨149, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846520), (-842081)⟩, ⟨1864, 2516⟩, ⟨149, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-725059), (-405706)⟩, ⟨(-180367), (-133080)⟩, ⟨(-10960), (-10596)⟩, ⟨45, 68⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35066335, 35385689⟩, ⟨(-180367), (-133080)⟩, ⟨(-10960), (-10596)⟩, ⟨45, 68⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16894628, 30308428⟩, ⟨5477054, 7512991⟩, ⟨421285, 447093⟩, ⟨(-4740), (-3423)⟩, ⟨(-141), (-123)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698933255), (-685519454)⟩, ⟨5477054, 7512991⟩, ⟨421285, 447093⟩, ⟨(-4740), (-3423)⟩, ⟨(-141), (-123)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-598647884), (-330276790)⟩, ⟨(-147023180), (-103657261)⟩, ⟨(-8271306), (-7182661)⟩, ⟨136896, 194634⟩, ⟨4502, 5376⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3696319412, 3964690506⟩, ⟨(-147023180), (-103657261)⟩, ⟨(-8271306), (-7182661)⟩, ⟨136896, 194634⟩, ⟨4502, 5376⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨910055449, 1263070941⟩, ⟨124137583, 143049676⟩, ⟨(-5040276), (-3563165)⟩, ⟨(-185808), (-155762)⟩, ⟨2808, 3999⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4652757647, 4990570895⟩, ⟨121646850, 198502760⟩, ⟨11609672, 19063031⟩, ⟨278920, 1030119⟩, ⟨11811, 73461⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨985867215, 1467635175⟩, ⟨160254413, 224593706⟩, ⟨119332, 8357499⟩, ⟨(-54198), 668204⟩, ⟨(-17356), 46519⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1265254416), (-948940811)⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3029712880, 3346026485⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨226296057, 501506265⟩, ⟨73569626, 153492030⟩, ⟨6034216, 17456211⟩, ⟨(-28138), 1330732⟩, ⟨(-17529), 117941⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4521263353, 4796473561⟩, ⟨73569626, 153492030⟩, ⟨6034216, 17456211⟩, ⟨(-28138), 1330732⟩, ⟨(-17529), 117941⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4406662936, 4538799080⟩, ⟨34808672, 74800735⟩, ⟨2238654, 8369397⟩, ⟨(-155779), 630818⟩, ⟨(-27200), 59553⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3108504101, 3535985466⟩, ⟨(-142581218), (-103995779)⟩, ⟨(-1175276), 5238457⟩, ⟨(-429554), 409009⟩, ⟨(-44421), 52133⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8618668837, 11491558465⟩, ⟨1436444798, 1436444809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17294998402, 30746663910⟩, ⟨5764999434, 7686665984⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17294998402, 30746663910⟩, ⟨5764999434, 7686665984⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-30746663910), (-17294998402)⟩, ⟨(-7686665984), (-5764999434)⟩, ⟨(-480416625), (-480416616)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15373331955), (-8647499201)⟩, ⟨(-3843332992), (-2882499717)⟩, ⟨(-240208313), (-240208308)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨119799131, 573522073⟩, ⟨(-513213758), (-80401301)⟩, ⟨(-5095826), 222923453⟩, ⟨(-63496250), 20655290⟩, ⟨(-10854640), 14347336⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨86705221, 472172563⟩, ⟨(-441560956), (-61091588)⟩, ⟨(-2405472), 201266518⟩, ⟨(-60359326), 17369428⟩, ⟨(-9737978), 14250046⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1107097613, 1107097614⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4463086090, 4463086094⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1914
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨948940811, 1265254416⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4406662936, 4538799080⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1915
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (8715019 / 2147483648)

theorem envelope_integral : (∫ s in ((88377 / 400000) : ℝ)..(29459 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((88377 / 400000) : ℝ)..(29459 / 100000), prawitzNormalCorrection
