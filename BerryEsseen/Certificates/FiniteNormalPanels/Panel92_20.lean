...
namespace FiniteNormalPanel92_20
...
def j2 : Jet := ⟨⟨1689598178, 1689598183⟩, ⟨563199390, 563199395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨664671418, 664671422⟩, ⟨443114276, 443114282⟩, ⟨73852379, 73852381⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨166, 167⟩, ⟨110, 112⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94521), (-94519)⟩, ⟨110, 112⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-14628), (-14627)⟩, ⟨(-9735), (-9733)⟩, ⟨(-1613), (-1610)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098428, 5098430⟩, ⟨(-9735), (-9733)⟩, ⟨(-1613), (-1610)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨789011, 789012⟩, ⟨524500, 524502⟩, ⟨86412, 86416⟩, ⟨(-335), (-332)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-142376566), (-142376564)⟩, ⟨524500, 524502⟩, ⟨86412, 86416⟩, ⟨(-335), (-332)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-22033611), (-22033609)⟩, ⟨(-14607905), (-14607902)⟩, ⟨(-2380695), (-2380690)⟩, ⟨17881, 17884⟩, ⟨1445, 1449⟩⟩
...
def j19 : Jet := ⟨⟨1409622154, 1409622157⟩, ⟨(-14607905), (-14607902)⟩, ⟨(-2380695), (-2380690)⟩, ⟨17881, 17884⟩, ⟨1445, 1449⟩⟩
...
def j25 : Jet := ⟨⟨1828, 1830⟩, ⟨1217, 1219⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850349), (-850346)⟩, ⟨1217, 1219⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-131597), (-131596)⟩, ⟨(-87544), (-87541)⟩, ⟨(-14467), (-14463)⟩, ⟨39, 42⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35659797, 35659799⟩, ⟨(-87544), (-87541)⟩, ⟨(-14467), (-14463)⟩, ⟨39, 42⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5518563, 5518564⟩, ⟨3665494, 3665496⟩, ⟨601902, 601905⟩, ⟨(-2993), (-2990)⟩, ⟨(-245), (-242)⟩⟩
...
def j33 : Jet := ⟨⟨(-710309320), (-710309318)⟩, ⟨3665494, 3665496⟩, ⟨601902, 601905⟩, ⟨(-2993), (-2990)⟩, ⟨(-245), (-242)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-109924541), (-109924539)⟩, ⟨(-72715772), (-72715767)⟩, ⟨(-11742520), (-11742516)⟩, ⟨124662, 124666⟩, ⟨10002, 10005⟩⟩
...
def j36 : Jet := ⟨⟨4185042755, 4185042757⟩, ⟨(-72715772), (-72715767)⟩, ⟨(-11742520), (-11742516)⟩, ⟨124662, 124666⟩, ⟨10002, 10005⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨554531585, 554531589⟩, ⟨179097252, 179097258⟩, ⟨(-2852079), (-2852075)⟩, ⟨(-305147), (-305144)⟩, ⟨2912, 2917⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4407779118, 4407779121⟩, ⟨76585844, 76585853⟩, ⟨13698166, 13698173⟩, ⟨321592, 321600⟩, ⟨31202, 31210⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨569096938, 569096944⟩, ⟨193689576, 193689585⟩, ⟨2035182, 2035190⟩, ⟨248705, 248714⟩, ⟨5887, 5898⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-537815805), (-537815804)⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3757151491, 3757151492⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨75407169, 75407171⟩, ⟨51328978, 51328984⟩, ⟨9274129, 9274135⟩, ⟨249468, 249474⟩, ⟨24954, 24963⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4370374465, 4370374467⟩, ⟨51328978, 51328984⟩, ⟨9274129, 9274135⟩, ⟨249468, 249474⟩, ⟨24954, 24963⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4332506826, 4332506828⟩, ⟨25442115, 25442119⟩, ⟨4522183, 4522187⟩, ⟨97096, 97101⟩, ⟨9437, 9444⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3789990321, 3789990324⟩, ⟨(-158582583), (-158582576)⟩, ⟨2893960, 2893966⟩, ⟨(-103820), (-103812)⟩, ⟨4202, 4210⟩⟩
...
def j47 : Jet := ⟨⟨3457327383, 3457327391⟩, ⟨1152442456, 1152442464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2783050908, 2783050921⟩, ⟨1855367262, 1855367282⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2783050908, 2783050921⟩, ⟨1855367262, 1855367282⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2783050921), (-2783050908)⟩, ⟨(-1855367282), (-1855367262)⟩, ⟨(-309227881), (-309227875)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1391525461), (-1391525454)⟩, ⟨(-927683641), (-927683631)⟩, ⟨(-154613941), (-154613937)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3106367917, 3106367927⟩, ⟨(-670954285), (-670954275)⟩, ⟨(-39364943), (-39364936)⟩, ⟨18936579, 18936582⟩, ⟨(-313997), (-313996)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2741139461, 2741139473⟩, ⟨(-706763496), (-706763479)⟩, ⟨(-7870001), (-7869986)⟩, ⟨17636412, 17636427⟩, ⟨(-983543), (-983531)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨358543869, 717087740⟩, ⟨179271934, 179271935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1126398784, 2252797577⟩, ⟨563199390, 563199395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨295409518, 1181638084⟩, ⟨295409516, 590819044⟩, ⟨73852379, 73852381⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨73, 297⟩, ⟨73, 149⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94614), (-94389)⟩, ⟨73, 149⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-26031), (-6492)⟩, ⟨(-13011), (-6451)⟩, ⟨(-1621), (-1596)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5087025, 5106565⟩, ⟨(-13011), (-6451)⟩, ⟨(-1621), (-1596)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨349887, 1404927⟩, ⟨346307, 702021⟩, ⟨85235, 87256⟩, ⟨(-447), (-217)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142815690), (-141760649)⟩, ⟨346307, 702021⟩, ⟨85235, 87256⟩, ⟨(-447), (-217)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-39291675), (-9750352)⟩, ⟨(-19622019), (-9557210)⟩, ⟨(-2426049), (-2317010)⟩, ⟨11693, 24062⟩, ⟨1395, 1486⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1392364090, 1421905414⟩, ⟨(-19622019), (-9557210)⟩, ⟨(-2426049), (-2317010)⟩, ⟨11693, 24062⟩, ⟨1395, 1486⟩⟩
...
def j72 : Jet := ⟨⟨811, 3255⟩, ⟨806, 1628⟩, ⟨198, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851366), (-848921)⟩, ⟨806, 1628⟩, ⟨198, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-234230), (-58389)⟩, ⟨(-117060), (-57941)⟩, ⟨(-14572), (-14316)⟩, ⟨25, 57⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35557164, 35733006⟩, ⟨(-117060), (-57941)⟩, ⟨(-14572), (-14316)⟩, ⟨25, 57⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2445635, 9830921⟩, ⟨2413429, 4911476⟩, ⟨591295, 609464⟩, ⟨(-4017), (-1964)⟩, ⟨(-250), (-236)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713382248), (-705996961)⟩, ⟨2413429, 4911476⟩, ⟨591295, 609464⟩, ⟨(-4017), (-1964)⟩, ⟨(-250), (-236)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-196266834), (-48558745)⟩, ⟨(-97967422), (-47207491)⟩, ⟨(-12060013), (-11296382)⟩, ⟨81062, 168158⟩, ⟨9545, 10329⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4098700462, 4246408551⟩, ⟨(-97967422), (-47207491)⟩, ⟨(-12060013), (-11296382)⟩, ⟨81062, 168158⟩, ⟨9545, 10329⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨365161620, 745818269⟩, ⟨172288661, 183948093⟩, ⟨(-3845549), (-1860896)⟩, ⟨(-315062), (-291207)⟩, ⟨1898, 3936⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4344081322, 4500632395⟩, ⟨48293322, 107574428⟩, ⟨12093090, 15813911⟩, ⟨84683, 608600⟩, ⟨17902, 50009⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨369337334, 781531880⟩, ⟨178364761, 211436703⟩, ⟨(-1064288), 5471180⟩, ⟨65834, 467513⟩, ⟨(-15215), 30363⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-717087740), (-358543869)⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3577879556, 3936423427⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨31760443, 142211113⟩, ⟨30676258, 76947978⟩, ⟨7019945, 12399928⟩, ⟨(-93466), 708824⟩, ⟨(-1426), 64052⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4326727739, 4437178409⟩, ⟨30676258, 76947978⟩, ⟨7019945, 12399928⟩, ⟨(-93466), 708824⟩, ⟨(-1426), 64052⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310818267, 4365493805⟩, ⟨15090334, 38332520⟩, ⟨3284971, 6150755⟩, ⟨(-101256), 341611⟩, ⟨(-8137), 31558⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3591084048, 4001062384⟩, ⟨(-169644861), (-144801031)⟩, ⟨1136512, 5007420⟩, ⟨(-349537), 175980⟩, ⟨(-21717), 33151⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2304884920, 4609769854⟩, ⟨1152442456, 1152442464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1236911512, 4947646081⟩, ⟨1236911508, 2473823042⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1236911512, 4947646081⟩, ⟨1236911508, 2473823042⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4947646081), (-1236911512)⟩, ⟨(-2473823042), (-1236911508)⟩, ⟨(-309227881), (-309227875)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2473823041), (-618455756)⟩, ⟨(-1236911521), (-618455754)⟩, ⟨(-154613941), (-154613937)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2414427329, 3718976477⟩, ⟨(-1071031404), (-347666552)⟩, ⟨(-108847726), 67307015⟩, ⟨1882463, 36152995⟩, ⟨(-3814422), 1891431⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2018737482, 3464486657⟩, ⟨(-1144634726), (-372089300)⟩, ⟨(-89039106), 109341234⟩, ⟨(-2635931), 38038752⟩, ⟨(-5170984), 1892878⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4332506826, 4332506828⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1866
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310818267, 4365493805⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1867
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (57160733 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((2087 / 25000) : ℝ)..(2087 / 12500), prawitzNormalCorrection
