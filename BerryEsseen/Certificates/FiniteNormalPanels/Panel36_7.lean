...
namespace FiniteNormalPanel36_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (21283 / 80000)
def radius : Rat := (21283 / 400000)

def j0 : Jet := ⟨⟨1142622362, 1142622363⟩, ⟨228524472, 228524473⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3589654018, 3589654022⟩, ⟨717930802, 717930806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3000166259, 3000166267⟩, ⟨1200066500, 1200066510⟩, ⟨120006649, 120006652⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨750, 752⟩, ⟨300, 301⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93937), (-93934)⟩, ⟨300, 301⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-65618), (-65615)⟩, ⟨(-26039), (-26035)⟩, ⟨(-2522), (-2517)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5047438, 5047442⟩, ⟨(-26039), (-26035)⟩, ⟨(-2522), (-2517)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3525790, 3525793⟩, ⟨1392126, 1392132⟩, ⟨131993, 132000⟩, ⟨(-1422), (-1417)⟩, ⟨(-67), (-63)⟩⟩
...
def j16 : Jet := ⟨⟨(-139639787), (-139639783)⟩, ⟨1392126, 1392132⟩, ⟨131993, 132000⟩, ⟨(-1422), (-1417)⟩, ⟨(-67), (-63)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-97542671), (-97542667)⟩, ⟨(-38044627), (-38044619)⟩, ⟨(-3420529), (-3420520)⟩, ⟨74783, 74792⟩, ⟨3243, 3250⟩⟩
...
def j19 : Jet := ⟨⟨1334113094, 1334113099⟩, ⟨(-38044627), (-38044619)⟩, ⟨(-3420529), (-3420520)⟩, ⟨74783, 74792⟩, ⟨3243, 3250⟩⟩
...
def j25 : Jet := ⟨⟨8214, 8217⟩, ⟨3263, 3267⟩, ⟨316, 320⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843963), (-843959)⟩, ⟨3263, 3267⟩, ⟨316, 320⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-589535), (-589531)⟩, ⟨(-233535), (-233529)⟩, ⟨(-22451), (-22444)⟩, ⟨176, 182⟩, ⟨6, 9⟩⟩
...
def j30 : Jet := ⟨⟨35201859, 35201864⟩, ⟨(-233535), (-233529)⟩, ⟨(-22451), (-22444)⟩, ⟨176, 182⟩, ⟨6, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨24589577, 24589581⟩, ⟨9672698, 9672706⟩, ⟨902647, 902657⟩, ⟨(-12678), (-12668)⟩, ⟨(-575), (-569)⟩⟩
...
def j33 : Jet := ⟨⟨(-691238306), (-691238301)⟩, ⟨9672698, 9672706⟩, ⟨902647, 902657⟩, ⟨(-12678), (-12668)⟩, ⟨(-575), (-569)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-482851139), (-482851133)⟩, ⟨(-186383781), (-186383770)⟩, ⟨(-15980850), (-15980838)⟩, ⟨513621, 513634⟩, ⟨21276, 21286⟩⟩
...
def j36 : Jet := ⟨⟨3812116157, 3812116163⟩, ⟨(-186383781), (-186383770)⟩, ⟨(-15980850), (-15980838)⟩, ⟨513621, 513634⟩, ⟨21276, 21286⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1115026983, 1115026989⟩, ⟨191208402, 191208412⟩, ⟨(-9218214), (-9218204)⟩, ⟨(-509261), (-509251)⟩, ⟨15210, 15219⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4838977430, 4838977438⟩, ⟨236589551, 236589568⟩, ⟨31853006, 31853027⟩, ⟨1897191, 1897213⟩, ⟨167390, 167411⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1256258786, 1256258796⟩, ⟨276848877, 276848895⟩, ⟨8416393, 8416415⟩, ⟨829048, 829072⟩, ⟨48634, 48655⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1142622363), (-1142622362)⟩, ⟨(-228524473), (-228524472)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3152344933, 3152344934⟩, ⟨(-228524473), (-228524472)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨367450094, 367450101⟩, ⟨161954124, 161954138⟩, ⟨22768888, 22768906⟩, ⟨1570006, 1570026⟩, ⟨151820, 151841⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4662417390, 4662417397⟩, ⟨161954124, 161954138⟩, ⟨22768888, 22768906⟩, ⟨1570006, 1570026⟩, ⟨151820, 151841⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4474922369, 4474922373⟩, ⟨77720640, 77720648⟩, ⟨10251700, 10251710⟩, ⟨575382, 575393⟩, ⟨51120, 51133⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3284425208, 3284425213⟩, ⟨(-181055398), (-181055389)⟩, ⟨3389041, 3389051⟩, ⟨(-123160), (-123150)⟩, ⟨6904, 6916⟩⟩
...
def j47 : Jet := ⟨⟨4723143795, 4723143801⟩, ⟨944628757, 944628762⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5194006326, 5194006340⟩, ⟨2077602526, 2077602540⟩, ⟨207760252, 207760255⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5194006326, 5194006340⟩, ⟨2077602526, 2077602540⟩, ⟨207760252, 207760255⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5194006340), (-5194006326)⟩, ⟨(-2077602540), (-2077602526)⟩, ⟨(-207760255), (-207760252)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2597003170), (-2597003163)⟩, ⟨(-1038801270), (-1038801263)⟩, ⟨(-103880128), (-103880126)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2346164856, 2346164872⟩, ⟨(-567454624), (-567454615)⟩, ⟨11878176, 11878180⟩, ⟨8192180, 8192182⟩, ⟨(-638996), (-638995)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1794147071, 1794147087⟩, ⟨(-532844125), (-532844111)⟩, ⟨34855898, 34855910⟩, ⟨5248910, 5248924⟩, ⟨(-804581), (-804567)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨914097889, 1371146835⟩, ⟨228524472, 228524473⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2871723212, 4307584824⟩, ⟨717930802, 717930806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1920106403, 4320239420⟩, ⟨960053200, 1440079812⟩, ⟨120006649, 120006652⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨480, 1083⟩, ⟨240, 361⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94207), (-93603)⟩, ⟨240, 361⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-94762), (-41846)⟩, ⟨(-31481), (-20559)⟩, ⟨(-2567), (-2461)⟩, ⟨12, 22⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5018294, 5071211⟩, ⟨(-31481), (-20559)⟩, ⟨(-2567), (-2461)⟩, ⟨12, 22⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2243476, 5101051⟩, ⟨1090071, 1691160⟩, ⟨127078, 136001⟩, ⟨(-1736), (-1101)⟩, ⟨(-70), (-58)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140922101), (-138064525)⟩, ⟨1090071, 1691160⟩, ⟨127078, 136001⟩, ⟨(-1736), (-1101)⟩, ⟨(-70), (-58)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-141751305), (-61723072)⟩, ⟨(-46763109), (-29160425)⟩, ⟨(-3637063), (-3153852)⟩, ⟨57115, 92363⟩, ⟨2896, 3530⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1289904460, 1369932694⟩, ⟨(-46763109), (-29160425)⟩, ⟨(-3637063), (-3153852)⟩, ⟨57115, 92363⟩, ⟨2896, 3530⟩⟩
...
def j72 : Jet := ⟨⟨5242, 11859⟩, ⟨2583, 3943⟩, ⟨309, 325⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846935), (-840317)⟩, ⟨2583, 3943⟩, ⟨309, 325⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-851919), (-375671)⟩, ⟨(-282819), (-183868)⟩, ⟨(-22950), (-21829)⟩, ⟨136, 220⟩, ⟨4, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34939475, 35415724⟩, ⟨(-282819), (-183868)⟩, ⟨(-22950), (-21829)⟩, ⟨136, 220⟩, ⟨4, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15620028, 35624115⟩, ⟨7525530, 11792506⟩, ⟨858337, 938702⟩, ⟨(-15539), (-9794)⟩, ⟨(-611), (-524)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700207855), (-680203767)⟩, ⟨7525530, 11792506⟩, ⟨858337, 938702⟩, ⟨(-15539), (-9794)⟩, ⟨(-611), (-524)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-704327966), (-304091630)⟩, ⟨(-231411630), (-140183920)⟩, ⟨(-17498759), (-14107535)⟩, ⟨386504, 639862⟩, ⟨18156, 23806⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3590639330, 3990875666⟩, ⟨(-231411630), (-140183920)⟩, ⟨(-17498759), (-14107535)⟩, ⟨386504, 639862⟩, ⟨18156, 23806⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨862462580, 1373957210⟩, ⟨168715156, 209495476⟩, ⟨(-11464496), (-6983092)⟩, ⟨(-569770), (-434551)⟩, ⟨11483, 18981⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4622229710, 5137453913⟩, ⟨162360928, 331101644⟩, ⟨22042443, 46376099⟩, ⟨524505, 4104933⟩, ⟨12609, 449722⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨928179398, 1643468125⟩, ⟨214174024, 356508616⟩, ⟨(-2909171), 23470638⟩, ⟨(-594144), 2843611⟩, ⟨(-132225), 314533⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1371146835), (-914097889)⟩, ⟨(-228524473), (-228524472)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2923820461, 3380869407⟩, ⟨(-228524473), (-228524472)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨200587556, 628872653⟩, ⟨92569698, 272835860⟩, ⟨8453672, 47554469⟩, ⟨(-937660), 6072630⟩, ⟨(-215726), 841048⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4495554852, 4923839949⟩, ⟨92569698, 272835860⟩, ⟨8453672, 47554469⟩, ⟨(-937660), 6072630⟩, ⟨(-215726), 841048⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4394116642, 4598666280⟩, ⟨43228166, 133339781⟩, ⟨2014578, 23028089⟩, ⟨(-1157041), 2947985⟩, ⟨(-255228), 445686⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2991316874, 3619932137⟩, ⟨(-215255747), (-128838884)⟩, ⟨(-5723243), 15826959⟩, ⟨(-2136056), 2213376⟩, ⟨(-357763), 412395⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3778515033, 5667772558⟩, ⟨944628757, 944628762⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3324164043, 7479369121⟩, ⟨1662082018, 2493123048⟩, ⟨207760252, 207760255⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3324164043, 7479369121⟩, ⟨1662082018, 2493123048⟩, ⟨207760252, 207760255⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7479369121), (-3324164043)⟩, ⟨(-2493123048), (-1662082018)⟩, ⟨(-207760255), (-207760252)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3739684561), (-1662082021)⟩, ⟨(-1246561524), (-831041009)⟩, ⟨(-103880128), (-103880126)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1798100402, 2916721802⟩, ⟨(-846542692), (-347917706)⟩, ⟨(-36885612), 79359599⟩, ⟨(-2067782), 17218456⟩, ⟨(-2209077), 596104⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1252323406, 2458303931⟩, ⟨(-859673189), (-296253094)⟩, ⟨(-24538300), 120062005⟩, ⟨(-10290260), 18992057⟩, ⟨(-3539977), 1599569⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1142622362, 1142622363⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4474922369, 4474922373⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified710
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨914097889, 1371146835⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4394116642, 4598666280⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified711
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (48048651 / 1073741824)

theorem envelope_integral : (∫ s in ((21283 / 100000) : ℝ)..(63849 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((21283 / 100000) : ℝ)..(63849 / 200000), prawitzNormalCorrection
