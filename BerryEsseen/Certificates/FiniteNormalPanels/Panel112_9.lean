...
namespace FiniteNormalPanel112_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (28341 / 800000)
def radius : Rat := (28341 / 800000)

def j0 : Jet := ⟨⟨152154585, 152154586⟩, ⟨152154585, 152154586⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨478007726, 478007730⟩, ⟨478007726, 478007730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨53199796, 53199798⟩, ⟨106399592, 106399596⟩, ⟨53199796, 53199798⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨13, 14⟩, ⟨26, 27⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94674), (-94672)⟩, ⟨26, 27⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1173), (-1172)⟩, ⟨(-2346), (-2344)⟩, ⟨(-1173), (-1170)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111883, 5111885⟩, ⟨(-2346), (-2344)⟩, ⟨(-1173), (-1170)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨63318, 63319⟩, ⟨126607, 126609⟩, ⟨63244, 63247⟩, ⟨(-60), (-56)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-143102259), (-143102257)⟩, ⟨126607, 126609⟩, ⟨63244, 63247⟩, ⟨(-60), (-56)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1772543), (-1772542)⟩, ⟨(-3543517), (-3543515)⟩, ⟨(-1768624), (-1768621)⟩, ⟨3133, 3136⟩, ⟨780, 783⟩⟩
...
def j19 : Jet := ⟨⟨1429883222, 1429883224⟩, ⟨(-3543517), (-3543515)⟩, ⟨(-1768624), (-1768621)⟩, ⟨3133, 3136⟩, ⟨780, 783⟩⟩
...
def j22 : Jet := ⟨⟨(-2), (-1)⟩, ⟨(-3), (-2)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11833, 11835⟩, ⟨(-3), (-2)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨146, 147⟩, ⟨292, 294⟩, ⟨144, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852031), (-852029)⟩, ⟨292, 294⟩, ⟨144, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10554), (-10553)⟩, ⟨(-21105), (-21103)⟩, ⟨(-10546), (-10543)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780840, 35780842⟩, ⟨(-21105), (-21103)⟩, ⟨(-10546), (-10543)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨443200, 443201⟩, ⟨886139, 886141⟩, ⟨442546, 442549⟩, ⟨(-524), (-521)⟩, ⟨(-132), (-128)⟩⟩
...
def j33 : Jet := ⟨⟨(-715384683), (-715384681)⟩, ⟨886139, 886141⟩, ⟨442546, 442549⟩, ⟨(-524), (-521)⟩, ⟨(-132), (-128)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8861144), (-8861142)⟩, ⟨(-17711311), (-17711308)⟩, ⟨(-8833711), (-8833707)⟩, ⟨21932, 21935⟩, ⟨5466, 5469⟩⟩
...
def j36 : Jet := ⟨⟨4286106152, 4286106154⟩, ⟨(-17711311), (-17711308)⟩, ⟨(-8833711), (-8833707)⟩, ⟨21932, 21935⟩, ⟨5466, 5469⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨159138633, 159138636⟩, ⟨158744257, 158744262⟩, ⟨(-591215), (-591212)⟩, ⟨(-196491), (-196488)⟩, ⟨434, 438⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303846757, 4303846760⟩, ⟨17784616, 17784621⟩, ⟨8943760, 8943767⟩, ⟨51584, 51591⟩, ⟨13061, 13069⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨159467637, 159467642⟩, ⟨159731407, 159731415⟩, ⟨396277, 396283⟩, ⟨133130, 133137⟩, ⟨777, 787⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-152154586), (-152154585)⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4142812710, 4142812711⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5920866, 5920867⟩, ⟨11861318, 11861322⟩, ⟨5969895, 5969899⟩, ⟨39358, 39364⟩, ⟨9994, 10001⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300888162, 4300888163⟩, ⟨11861318, 11861322⟩, ⟨5969895, 5969899⟩, ⟨39358, 39364⟩, ⟨9994, 10001⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297926709, 4297926710⟩, ⟨5926575, 5926578⟩, ⟨2978805, 2978808⟩, ⟨15557, 15562⟩, ⟨3939, 3945⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4145667282, 4145667285⟩, ⟨(-146542809), (-146542803)⟩, ⟨2663320, 2663325⟩, ⟨(-90523), (-90516)⟩, ⟨3247, 3255⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨44452946579, 44452946586⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value491

def j47 : Jet := ⟨⟨1574801196, 1574801208⟩, ⟨1574801196, 1574801208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨577419718, 577419728⟩, ⟨1154839436, 1154839456⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨577419718, 577419728⟩, ⟨1154839436, 1154839456⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-577419728), (-577419718)⟩, ⟨(-1154839456), (-1154839436)⟩, ⟨(-577419728), (-577419718)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-288709864), (-288709859)⟩, ⟨(-577419728), (-577419718)⟩, ⟨(-288709864), (-288709859)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4015747221, 4015747227⟩, ⟨(-539881101), (-539881090)⟩, ⟨(-233649473), (-233649465)⟩, ⟨34664741, 34664744⟩, ⟨6687926, 6687928⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3876153348, 3876153358⟩, ⟨(-658129878), (-658129859)⟩, ⟨(-204616710), (-204616693)⟩, ⟨41012355, 41012370⟩, ⟨5142217, 5142233⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 304309171⟩, ⟨152154585, 152154586⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 956015457⟩, ⟨478007726, 478007730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 212799189⟩, ⟨0, 212799190⟩, ⟨53199796, 53199798⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 54⟩, ⟨0, 54⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94632)⟩, ⟨0, 54⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4692), 0⟩, ⟨(-4692), 3⟩, ⟨(-1173), (-1168)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108364, 5113057⟩, ⟨(-4692), 3⟩, ⟨(-1173), (-1168)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 253333⟩, ⟨(-233), 253334⟩, ⟨62982, 63335⟩, ⟨(-118), 2⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142912243)⟩, ⟨(-233), 253334⟩, ⟨62982, 63335⟩, ⟨(-118), 2⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7093307), 0⟩, ⟨(-7093319), 12552⟩, ⟨(-1773339), (-1754497)⟩, ⟨(-9), 6278⟩, ⟨773, 786⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424562458, 1431655766⟩, ⟨(-7093319), 12552⟩, ⟨(-1773339), (-1754497)⟩, ⟨(-9), 6278⟩, ⟨773, 786⟩⟩
...
def j70 : Jet := ⟨⟨(-6), 0⟩, ⟨(-6), 0⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11829, 11836⟩, ⟨(-6), 0⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 587⟩, ⟨(-1), 587⟩, ⟨144, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851589)⟩, ⟨(-1), 587⟩, ⟨144, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-42223), 0⟩, ⟨(-42224), 30⟩, ⟨(-10557), (-10510)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35749171, 35791395⟩, ⟨(-42224), 30⟩, ⟨(-10557), (-10510)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1773327⟩, ⟨(-2093), 1773329⟩, ⟨440191, 443334⟩, ⟨(-1049), 2⟩, ⟨(-133), (-128)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714054555)⟩, ⟨(-2093), 1773329⟩, ⟨440191, 443334⟩, ⟨(-1049), 2⟩, ⟨(-133), (-128)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-35466532), 0⟩, ⟨(-35466636), 87862⟩, ⟨(-8866738), (-8734839)⟩, ⟨(-78), 43933⟩, ⟨5393, 5493⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4259500764, 4294967296⟩, ⟨(-35466636), 87862⟩, ⟨(-8866738), (-8734839)⟩, ⟨(-78), 43933⟩, ⟨5393, 5493⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 318671820⟩, ⟨156967560, 159338705⟩, ⟨(-1184177), 1397⟩, ⟨(-197367), (-193868)⟩, ⟨(-2), 874⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4330729139⟩, ⟨(-89332), 36059719⟩, ⟨8734101, 9315262⟩, ⟨(-45047), 152708⟩, ⟨11482, 15227⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 321325226⟩, ⟨156960931, 163340940⟩, ⟨(-1197352), 2030348⟩, ⟨106906, 163075⟩, ⟨(-5902), 7687⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-304309171), 0⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3990658125, 4294967296⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 24039741⟩, ⟨0, 24440496⟩, ⟨5557026, 6515783⟩, ⟨(-91074), 178834⟩, ⟨6361, 14516⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4319007037⟩, ⟨0, 24440496⟩, ⟨5557026, 6515783⟩, ⟨(-91074), 178834⟩, ⟨6361, 14516⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306970395⟩, ⟨0, 12220248⟩, ⟨2753433, 3257892⟩, ⟨(-54807), 89417⟩, ⟨1684, 6532⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3990658125, 4306970395⟩, ⟨(-152579811), (-139934337)⟩, ⟨2125427, 3257892⟩, ⟨(-170222), (-8126)⟩, ⟨(-1604), 8474⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3149602405⟩, ⟨1574801196, 1574801208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2309678893⟩, ⟨0, 2309678902⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2309678893⟩, ⟨0, 2309678902⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2309678893), 0⟩, ⟨(-2309678902), 0⟩, ⟨(-577419728), (-577419718)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1154839447), 0⟩, ⟨(-1154839451), 0⟩, ⟨(-288709864), (-288709859)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3282357547, 4294967296⟩, ⟨(-1154839451), 0⟩, ⟨(-288709864), (-65383945)⟩, ⟨0, 77628890⟩, ⟨(-3020683), 9703612⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3049794308, 4306970395⟩, ⟨(-1310646680), (-106942496)⟩, ⟨(-287892397), (-16467470)⟩, ⟨1084063, 88096121⟩, ⟨(-6007514), 9752619⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨152154585, 152154586⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨152154585, 152154586⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297926709, 4297926710⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar491 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2254
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar491 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 304309171⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306970395⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2255
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(28341 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (28341 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(28341 / 400000), prawitzNormalCorrection
      ((298779 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
