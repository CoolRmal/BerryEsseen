...
namespace FiniteNormalPanel118_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (209279 / 800000)
def radius : Rat := (29897 / 800000)

def j0 : Jet := ⟨⟨1123558075, 1123558076⟩, ⟨160508296, 160508297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3529761794, 3529761798⟩, ⟨504251683, 504251687⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2900887821, 2900887828⟩, ⟨828825088, 828825098⟩, ⟨59201791, 59201793⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨726, 727⟩, ⟨207, 208⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93961), (-93959)⟩, ⟨207, 208⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-63463), (-63461)⟩, ⟨(-17994), (-17990)⟩, ⟨(-1248), (-1243)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5049593, 5049596⟩, ⟨(-17994), (-17990)⟩, ⟨(-1248), (-1243)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3410573, 3410576⟩, ⟨962295, 962301⟩, ⟨65287, 65294⟩, ⟨(-488), (-481)⟩, ⟨(-18), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-139755004), (-139755000)⟩, ⟨962295, 962301⟩, ⟨65287, 65294⟩, ⟨(-488), (-481)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-94392708), (-94392704)⟩, ⟨(-26319397), (-26319389)⟩, ⟨(-1696588), (-1696579)⟩, ⟨25532, 25542⟩, ⟨791, 800⟩⟩
...
def j19 : Jet := ⟨⟨1337263057, 1337263062⟩, ⟨(-26319397), (-26319389)⟩, ⟨(-1696588), (-1696579)⟩, ⟨25532, 25542⟩, ⟨791, 800⟩⟩
...
def j25 : Jet := ⟨⟨7944, 7946⟩, ⟨2254, 2258⟩, ⟨155, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844233), (-844230)⟩, ⟨2254, 2258⟩, ⟨155, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-570209), (-570206)⟩, ⟨(-161395), (-161390)⟩, ⟨(-11099), (-11091)⟩, ⟨58, 63⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35221185, 35221189⟩, ⟨(-161395), (-161390)⟩, ⟨(-11099), (-11091)⟩, ⟨58, 63⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23788937, 23788940⟩, ⟨6687830, 6687835⟩, ⟨446845, 446854⟩, ⟨(-4328), (-4321)⟩, ⟨(-142), (-136)⟩⟩
...
def j33 : Jet := ⟨⟨(-692038946), (-692038942)⟩, ⟨6687830, 6687835⟩, ⟨446845, 446854⟩, ⟨(-4328), (-4321)⟩, ⟨(-142), (-136)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-467413887), (-467413882)⟩, ⟨(-129029762), (-129029754)⟩, ⟨(-7946664), (-7946654)⟩, ⟨175490, 175501⟩, ⟨5227, 5236⟩⟩
...
def j36 : Jet := ⟨⟨3827553409, 3827553414⟩, ⟨(-129029762), (-129029754)⟩, ⟨(-7946664), (-7946654)⟩, ⟨175490, 175501⟩, ⟨5227, 5236⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1099011871, 1099011878⟩, ⟨135371448, 135371458⟩, ⟨(-4484355), (-4484344)⟩, ⟨(-178206), (-178195)⟩, ⟨3647, 3657⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4819460913, 4819460920⟩, ⟨162467714, 162467726⟩, ⟨15482932, 15482949⟩, ⟨638268, 638288⟩, ⟨39616, 39634⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1233221207, 1233221218⟩, ⟨193475593, 193475610⟩, ⟨4050610, 4050631⟩, ⟨281721, 281744⟩, ⟨11438, 11459⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1123558076), (-1123558075)⟩, ⟨(-160508297), (-160508296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3171409220, 3171409221⟩, ⟨(-160508297), (-160508296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨354096886, 354096893⟩, ⟨111105946, 111105958⟩, ⟨11041620, 11041636⟩, ⟨526718, 526734⟩, ⟨35768, 35787⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4649064182, 4649064189⟩, ⟨111105946, 111105958⟩, ⟨11041620, 11041636⟩, ⟨526718, 526734⟩, ⟨35768, 35787⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4468509664, 4468509668⟩, ⟨53395476, 53395483⟩, ⟨4987380, 4987389⟩, ⟨193535, 193544⟩, ⟨12092, 12103⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3299553121, 3299553126⟩, ⟨(-127566507), (-127566499)⟩, ⟨1687231, 1687240⟩, ⟨(-43479), (-43470)⟩, ⟨1695, 1705⟩⟩
...
def j47 : Jet := ⟨⟨8809539682, 8809539692⟩, ⟨1258505665, 1258505674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨18069518126, 18069518168⟩, ⟨5162719448, 5162719492⟩, ⟨368765673, 368765680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨18069518126, 18069518168⟩, ⟨5162719448, 5162719492⟩, ⟨368765673, 368765680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-18069518168), (-18069518126)⟩, ⟨(-5162719492), (-5162719448)⟩, ⟨(-368765680), (-368765673)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9034759084), (-9034759063)⟩, ⟨(-2581359746), (-2581359724)⟩, ⟨(-184382840), (-184382836)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨524072713, 524072724⟩, ⟨(-314978006), (-314977996)⟩, ⟨72155552, 72155558⟩, ⟨(-5440972), (-5440969)⟩, ⟨(-731286), (-731284)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨402612089, 402612099⟩, ⟨(-257543473), (-257543462)⟩, ⟨64993730, 64993740⟩, ⟨(-6452121), (-6452113)⟩, ⟨(-368460), (-368450)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨963049779, 1284066373⟩, ⟨160508296, 160508297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3025510110, 4034013485⟩, ⟨504251683, 504251687⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2131264523, 3788914718⟩, ⟨710421504, 947228682⟩, ⟨59201791, 59201793⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨533, 950⟩, ⟨177, 238⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94154), (-93736)⟩, ⟨177, 238⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-83061), (-46514)⟩, ⟨(-20679), (-15294)⟩, ⟨(-1263), (-1225)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5029995, 5066543⟩, ⟨(-20679), (-15294)⟩, ⟨(-1263), (-1225)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2496002, 4469580⟩, ⟨813757, 1109806⟩, ⟨63657, 66702⟩, ⟨(-564), (-404)⟩, ⟨(-18), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140669575), (-138695996)⟩, ⟨813757, 1109806⟩, ⟨63657, 66702⟩, ⟨(-564), (-404)⟩, ⟨(-18), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-124095246), (-68824239)⟩, ⟨(-30620007), (-21962368)⟩, ⟨(-1772800), (-1608180)⟩, ⟨21247, 29809⟩, ⟨736, 848⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1307560519, 1362831527⟩, ⟨(-30620007), (-21962368)⟩, ⟨(-1772800), (-1608180)⟩, ⟨21247, 29809⟩, ⟨736, 848⟩⟩
...
def j72 : Jet := ⟨⟨5825, 10395⟩, ⟨1919, 2591⟩, ⟨153, 161⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846352), (-841781)⟩, ⟨1919, 2591⟩, ⟨153, 161⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-746631), (-417711)⟩, ⟨(-185706), (-136951)⟩, ⟨(-11275), (-10888)⟩, ⟨49, 72⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35044763, 35373684⟩, ⟨(-185706), (-136951)⟩, ⟨(-11275), (-10888)⟩, ⟨49, 72⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17390041, 31205796⟩, ⟨5632854, 7733491⟩, ⟨432152, 459537⟩, ⟨(-5023), (-3623)⟩, ⟨(-148), (-131)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698437842), (-684622086)⟩, ⟨5632854, 7733491⟩, ⟨432152, 459537⟩, ⟨(-5023), (-3623)⟩, ⟨(-148), (-131)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-616144720), (-339725698)⟩, ⟨(-151241026), (-106419602)⟩, ⟨(-8481100), (-7325857)⟩, ⟨144692, 206151⟩, ⟨4717, 5671⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3678822576, 3955241598⟩, ⟨(-151241026), (-106419602)⟩, ⟨(-8481100), (-7325857)⟩, ⟨144692, 206151⟩, ⟨4717, 5671⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨921086773, 1280028550⟩, ⟨124754865, 144532587⟩, ⟨(-5260039), (-3711349)⟩, ⟨(-193170), (-160810)⟩, ⟨3012, 4297⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4663872892, 5014306533⟩, ⟨125486011, 206144453⟩, ⟨12014698, 20034764⟩, ⟨294338, 1115465⟩, ⟨12238, 81132⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1000201243, 1494413131⟩, ⟨162381756, 230176720⟩, ⟨80586, 8877927⟩, ⟨(-65879), 723589⟩, ⟨(-19366), 51655⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1284066373), (-963049779)⟩, ⟨(-160508297), (-160508296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3010900923, 3331917517⟩, ⟨(-160508297), (-160508296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨232924364, 519973833⟩, ⟨75630114, 160177758⟩, ⟨6176771, 18513740⟩, ⟨(-39754), 1455116⟩, ⟨(-20539), 131858⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4527891660, 4814941129⟩, ⟨75630114, 160177758⟩, ⟨6176771, 18513740⟩, ⟨(-39754), 1455116⟩, ⟨(-20539), 131858⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4409891903, 4547528415⟩, ⟨35714880, 78001712⟩, ⟨2247898, 8871007⟩, ⟨(-176270), 690393⟩, ⟨(-31137), 66757⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3091466520, 3527847488⟩, ⟨(-144909620), (-104291588)⟩, ⟨(-1339179), 5547175⟩, ⟨(-468267), 451582⟩, ⟨(-49957), 58377⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7551034016, 10068045366⟩, ⟨1258505665, 1258505674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13275564348, 23601003339⟩, ⟨4425188100, 5900250850⟩, ⟨368765673, 368765680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13275564348, 23601003339⟩, ⟨4425188100, 5900250850⟩, ⟨368765673, 368765680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23601003339), (-13275564348)⟩, ⟨(-5900250850), (-4425188100)⟩, ⟨(-368765680), (-368765673)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11800501670), (-6637782174)⟩, ⟨(-2950125425), (-2212594050)⟩, ⟨(-184382840), (-184382836)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨275250285, 915728689⟩, ⟨(-628995358), (-141797853)⟩, ⟨(-2787942), 204205553⟩, ⟨(-42696625), 18640164⟩, ⟨(-7584157), 7391704⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨198121890, 752171305⟩, ⟨(-547547264), (-108748115)⟩, ⟨867657, 190137243⟩, ⟨(-42872618), 15697331⟩, ⟨(-6998925), 7856807⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1123558075, 1123558076⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4468509664, 4468509668⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2380
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨963049779, 1284066373⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4409891903, 4547528415⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2381
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (7957237 / 1073741824)

theorem envelope_integral : (∫ s in ((89691 / 400000) : ℝ)..(29897 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((89691 / 400000) : ℝ)..(29897 / 100000), prawitzNormalCorrection
