...
namespace FiniteNormalPanel19_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (20537 / 80000)
def radius : Rat := (20537 / 400000)

def j0 : Jet := ⟨⟨1102571791, 1102571792⟩, ⟨220514358, 220514359⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3463831438, 3463831442⟩, ⟨692766287, 692766291⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2793531918, 2793531926⟩, ⟨1117412766, 1117412776⟩, ⟨111741276, 111741278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨699, 700⟩, ⟨279, 280⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93988), (-93986)⟩, ⟨279, 280⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-61132), (-61130)⟩, ⟨(-24272), (-24269)⟩, ⟨(-2357), (-2353)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5051924, 5051927⟩, ⟨(-24272), (-24269)⟩, ⟨(-2357), (-2353)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3285871, 3285874⟩, ⟨1298561, 1298565⟩, ⟨123585, 123591⟩, ⟨(-1237), (-1232)⟩, ⟨(-59), (-55)⟩⟩
...
def j16 : Jet := ⟨⟨(-139879706), (-139879702)⟩, ⟨1298561, 1298565⟩, ⟨123585, 123591⟩, ⟨(-1237), (-1232)⟩, ⟨(-59), (-55)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-90980536), (-90980532)⟩, ⟨(-35547606), (-35547600)⟩, ⟨(-3220997), (-3220989)⟩, ⟨65131, 65139⟩, ⟨2854, 2861⟩⟩
...
def j19 : Jet := ⟨⟨1340675229, 1340675234⟩, ⟨(-35547606), (-35547600)⟩, ⟨(-3220997), (-3220989)⟩, ⟨65131, 65139⟩, ⟨2854, 2861⟩⟩
...
def j22 : Jet := ⟨⟨(-71), (-69)⟩, ⟨(-29), (-27)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11764, 11767⟩, ⟨(-29), (-27)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7651, 7654⟩, ⟨3041, 3045⟩, ⟨296, 299⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844526), (-844522)⟩, ⟨3041, 3045⟩, ⟨296, 299⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-549297), (-549293)⟩, ⟨(-217742), (-217736)⟩, ⟨(-20989), (-20983)⟩, ⟨154, 158⟩, ⟨5, 8⟩⟩
...
def j30 : Jet := ⟨⟨35242097, 35242102⟩, ⟨(-217742), (-217736)⟩, ⟨(-20989), (-20983)⟩, ⟨154, 158⟩, ⟨5, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22922158, 22922163⟩, ⟨9027239, 9027246⟩, ⟨846584, 846593⟩, ⟨(-11026), (-11020)⟩, ⟨(-504), (-497)⟩⟩
...
def j33 : Jet := ⟨⟨(-692905725), (-692905719)⟩, ⟨9027239, 9027246⟩, ⟨846584, 846593⟩, ⟨(-11026), (-11020)⟩, ⟨(-504), (-497)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-450679629), (-450679623)⟩, ⟨(-174400358), (-174400349)⟩, ⟨(-15127953), (-15127943)⟩, ⟨447941, 447950⟩, ⟨18828, 18836⟩⟩
...
def j36 : Jet := ⟨⟨3844287667, 3844287673⟩, ⟨(-174400358), (-174400349)⟩, ⟨(-15127953), (-15127943)⟩, ⟨447941, 447950⟩, ⟨18828, 18836⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1081235941, 1081235947⟩, ⟨187578537, 187578546⟩, ⟨(-8331421), (-8331411)⟩, ⟨(-467011), (-467002)⟩, ⟨12806, 12815⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4798481706, 4798481715⟩, ⟨217688412, 217688427⟩, ⟨28758536, 28758554⟩, ⟨1602166, 1602184⟩, ⟨136973, 136990⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1207993105, 1207993115⟩, ⟨264370979, 264370995⟩, ⟨7438999, 7439019⟩, ⟨715302, 715322⟩, ⟨39304, 39324⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1102571792), (-1102571791)⟩, ⟨(-220514359), (-220514358)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3192395504, 3192395505⟩, ⟨(-220514359), (-220514358)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨339757497, 339757504⟩, ⟨148712806, 148712818⟩, ⟨20457554, 20457571⟩, ⟨1318162, 1318178⟩, ⟨123050, 123069⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4634724793, 4634724800⟩, ⟨148712806, 148712818⟩, ⟨20457554, 20457571⟩, ⟨1318162, 1318178⟩, ⟨123050, 123069⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4461613095, 4461613099⟩, ⟨71579115, 71579122⟩, ⟨9272537, 9272547⟩, ⟨485700, 485710⟩, ⟨41798, 41810⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3316261243, 3316261248⟩, ⟨(-175866511), (-175866502)⟩, ⟨3217108, 3217119⟩, ⟨(-115062), (-115052)⟩, ⟨6129, 6140⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨18555871790, 18555871795⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value171

def j47 : Jet := ⟨⟨4763524232, 4763524239⟩, ⟨952704845, 952704851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5283198111, 5283198128⟩, ⟨2113279240, 2113279260⟩, ⟨211327923, 211327927⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5283198111, 5283198128⟩, ⟨2113279240, 2113279260⟩, ⟨211327923, 211327927⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5283198128), (-5283198111)⟩, ⟨(-2113279260), (-2113279240)⟩, ⟨(-211327927), (-211327923)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2641599064), (-2641599055)⟩, ⟨(-1056639630), (-1056639620)⟩, ⟨(-105663964), (-105663961)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2321929982, 2321929998⟩, ⟨(-571236772), (-571236762)⟩, ⟨13143608, 13143613⟩, ⟨8291115, 8291117⟩, ⟨(-671620), (-671619)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1792825387, 1792825403⟩, ⟨(-536143803), (-536143788)⟩, ⟨35278253, 35278267⟩, ⟨5373514, 5373528⟩, ⟨(-829615), (-829602)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨882057433, 1323086151⟩, ⟨220514358, 220514359⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2771065151, 4156597733⟩, ⟨692766287, 692766291⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1787860428, 4022685978⟩, ⟨893930212, 1340895330⟩, ⟨111741276, 111741278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨447, 1008⟩, ⟨223, 336⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94240), (-93678)⟩, ⟨223, 336⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-88266), (-38995)⟩, ⟨(-29330), (-19182)⟩, ⟨(-2395), (-2305)⟩, ⟨10, 18⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5024790, 5074062⟩, ⟨(-29330), (-19182)⟩, ⟨(-2395), (-2305)⟩, ⟨10, 18⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2091662, 4752390⟩, ⟨1018360, 1576146⟩, ⟨119327, 127060⟩, ⟨(-1508), (-961)⟩, ⟨(-61), (-52)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141073915), (-138413186)⟩, ⟨1018360, 1576146⟩, ⟨119327, 127060⟩, ⟨(-1508), (-961)⟩, ⟨(-61), (-52)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-132130473), (-57617076)⟩, ⟨(-43619581), (-27332312)⟩, ⟨(-3408664), (-2989986)⟩, ⟨49917, 80276⟩, ⟨2575, 3085⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1299525292, 1374038690⟩, ⟨(-43619581), (-27332312)⟩, ⟨(-3408664), (-2989986)⟩, ⟨49917, 80276⟩, ⟨2575, 3085⟩⟩
...
def j70 : Jet := ⟨⟨(-102), (-44)⟩, ⟨(-34), (-22)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11733, 11792⟩, ⟨(-34), (-22)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4884, 11045⟩, ⟨2410, 3673⟩, ⟨291, 303⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847293), (-841131)⟩, ⟨2410, 3673⟩, ⟨291, 303⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-793579), (-350136)⟩, ⟨(-263524), (-171627)⟩, ⟨(-21422), (-20452)⟩, ⟨120, 191⟩, ⟨5, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34997815, 35441259⟩, ⟨(-263524), (-171627)⟩, ⟨(-21422), (-20452)⟩, ⟨120, 191⟩, ⟨5, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14568494, 33194445⟩, ⟨7037429, 10993374⟩, ⟨808193, 877834⟩, ⟨(-13496), (-8542)⟩, ⟨(-532), (-464)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701259389), (-682633437)⟩, ⟨7037429, 10993374⟩, ⟨808193, 877834⟩, ⟨(-13496), (-8542)⟩, ⟨(-532), (-464)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-656802746), (-284158929)⟩, ⟨(-216004789), (-131783019)⟩, ⟨(-16443366), (-13505599)⟩, ⟨338662, 556520⟩, ⟨16313, 20869⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3638164550, 4010808367⟩, ⟨(-216004789), (-131783019)⟩, ⟨(-16443366), (-13505599)⟩, ⟨338662, 556520⟩, ⟨16313, 20869⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨838439271, 1329771733⟩, ⟨167395513, 203994120⟩, ⟨(-10334567), (-6337730)⟩, ⟨(-517604), (-404586)⟩, ⟨9712, 15935⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4599258400, 5070343527⟩, ⟨151117705, 301035996⟩, ⟨20452356, 40789453⟩, ⟨477324, 3354212⟩, ⟨16397, 348816⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨897841262, 1569837216⟩, ⟨208755544, 334025693⟩, ⟨(-2317905), 20140173⟩, ⟨(-445096), 2319602⟩, ⟨(-102225), 241708⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1323086151), (-882057433)⟩, ⟨(-220514359), (-220514358)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2971881145, 3412909863⟩, ⟨(-220514359), (-220514358)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨187689189, 573785251⟩, ⟨87278588, 244176930⟩, ⟨8452080, 40700370⟩, ⟨(-685906), 4828318⟩, ⟨(-154830), 631933⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4482656485, 4868752547⟩, ⟨87278588, 244176930⟩, ⟨8452080, 40700370⟩, ⟨(-685906), 4828318⟩, ⟨(-154830), 631933⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4387808450, 4572869227⟩, ⟨40987251, 119505209⟩, ⟨2407668, 19728164⟩, ⟨(-873008), 2340589⟩, ⟨(-183876), 332398⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3036122117, 3633739075⟩, ⟨(-206421616), (-130318629)⟩, ⟨(-4469724), 13572204⟩, ⟨(-1706613), 1736288⟩, ⟨(-266286), 308957⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3810819387, 5716229089⟩, ⟨952704845, 952704851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3381246794, 7607805310⟩, ⟨1690623392, 2535935112⟩, ⟨211327923, 211327927⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3381246794, 7607805310⟩, ⟨1690623392, 2535935112⟩, ⟨211327923, 211327927⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7607805310), (-3381246794)⟩, ⟨(-2535935112), (-1690623392)⟩, ⟨(-211327927), (-211327923)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3803902655), (-1690623397)⟩, ⟨(-1267967556), (-845311696)⟩, ⟨(-105663964), (-105663961)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1771415308, 2897403550⟩, ⟨(-855376408), (-348640158)⟩, ⟨(-36972656), 82682821⟩, ⟨(-2418470), 17667582⟩, ⟨(-2321037), 633294⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1252217496, 2451336127⟩, ⟨(-862940541), (-300203101)⟩, ⟨(-23717358), 120219807⟩, ⟨(-9874280), 18786027⟩, ⟨(-3455100), 1461621⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1102571791, 1102571792⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨220514358, 220514359⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4461613095, 4461613099⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar171 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified384
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar171 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨882057433, 1323086151⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4387808450, 4572869227⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified385
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((20537 / 100000) : ℝ)..(61611 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (20537 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (61611 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((20537 / 100000) : ℝ)..(61611 / 200000), prawitzNormalCorrection
      ((249437 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
