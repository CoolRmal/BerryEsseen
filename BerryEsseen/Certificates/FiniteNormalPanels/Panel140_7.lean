...
namespace FiniteNormalPanel140_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (5349 / 32000)
def radius : Rat := (5349 / 160000)

def j0 : Jet := ⟨⟨717930627, 717930628⟩, ⟨143586125, 143586126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2255445583, 2255445587⟩, ⟨451089115, 451089119⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1184417581, 1184417586⟩, ⟨473767030, 473767038⟩, ⟨47376702, 47376704⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨296, 297⟩, ⟨118, 119⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94391), (-94389)⟩, ⟨118, 119⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-26031), (-26029)⟩, ⟨(-10381), (-10378)⟩, ⟨(-1026), (-1023)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5087025, 5087028⟩, ⟨(-10381), (-10378)⟩, ⟨(-1026), (-1023)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1402842, 1402844⟩, ⟨558273, 558277⟩, ⟨54684, 54688⟩, ⟨(-229), (-224)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-141762735), (-141762732)⟩, ⟨558273, 558277⟩, ⟨54684, 54688⟩, ⟨(-229), (-224)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-39093727), (-39093725)⟩, ⟨(-15483537), (-15483534)⟩, ⟨(-1487089), (-1487083)⟩, ⟨12126, 12131⟩, ⟨573, 578⟩⟩
...
def j19 : Jet := ⟨⟨1392562038, 1392562041⟩, ⟨(-15483537), (-15483534)⟩, ⟨(-1487089), (-1487083)⟩, ⟨12126, 12131⟩, ⟨573, 578⟩⟩
...
def j25 : Jet := ⟨⟨3255, 3257⟩, ⟨1298, 1300⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848922), (-848919)⟩, ⟨1298, 1300⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-234107), (-234105)⟩, ⟨(-93286), (-93283)⟩, ⟨(-9187), (-9184)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35557287, 35557290⟩, ⟨(-93286), (-93283)⟩, ⟨(-9187), (-9184)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9805587, 9805588⟩, ⟨3896508, 3896512⟩, ⟨379398, 379403⟩, ⟨(-2037), (-2032)⟩, ⟨(-101), (-96)⟩⟩
...
def j33 : Jet := ⟨⟨(-706022296), (-706022294)⟩, ⟨3896508, 3896512⟩, ⟨379398, 379403⟩, ⟨(-2037), (-2032)⟩, ⟨(-101), (-96)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-194698858), (-194698855)⟩, ⟨(-76805010), (-76805004)⟩, ⟨(-7253516), (-7253511)⟩, ⟨84269, 84273⟩, ⟨3932, 3936⟩⟩
...
def j36 : Jet := ⟨⟨4100268438, 4100268441⟩, ⟨(-76805010), (-76805004)⟩, ⟨(-7253516), (-7253511)⟩, ⟨84269, 84273⟩, ⟨3932, 3936⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨731285637, 731285641⟩, ⟨138126151, 138126155⟩, ⟨(-2407122), (-2407116)⟩, ⟨(-149819), (-149813)⟩, ⟨1573, 1579⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4498911312, 4498911316⟩, ⟨84272262, 84272271⟩, ⟨9537284, 9537293⟩, ⟨235262, 235271⟩, ⟨15226, 15235⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨766010308, 766010314⟩, ⟨159033666, 159033674⟩, ⟨1812645, 1812655⟩, ⟨142611, 142623⟩, ⟨3519, 3531⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-717930628), (-717930627)⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3577036668, 3577036669⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨136618454, 136618457⟩, ⟨56727522, 56727528⟩, ⟨6535256, 6535263⟩, ⟨185104, 185112⟩, ⟨12579, 12590⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4431585750, 4431585753⟩, ⟨56727522, 56727528⟩, ⟨6535256, 6535263⟩, ⟨185104, 185112⟩, ⟨12579, 12590⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4362741783, 4362741785⟩, ⟨27923134, 27923138⟩, ⟨3127506, 3127511⟩, ⟨71096, 71102⟩, ⟨4614, 4622⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3633482225, 3633482229⟩, ⟨(-122596305), (-122596299)⟩, ⟨1671217, 1671223⟩, ⟨(-45346), (-45339)⟩, ⟨1464, 1474⟩⟩
...
def j47 : Jet := ⟨⟨8324416389, 8324416403⟩, ⟨1664883273, 1664883286⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16134210912, 16134210968⟩, ⟨6453684346, 6453684408⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16134210912, 16134210968⟩, ⟨6453684346, 6453684408⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16134210968), (-16134210912)⟩, ⟨(-6453684408), (-6453684346)⟩, ⟨(-645368443), (-645368432)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8067105484), (-8067105456)⟩, ⟨(-3226842204), (-3226842173)⟩, ⟨(-322684222), (-322684216)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨656504698, 656504711⟩, ⟨(-493237076), (-493237061)⟩, ⟨135962702, 135962713⟩, ⟨(-9345092), (-9345087)⟩, ⟨(-3352234), (-3352231)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨555393786, 555393799⟩, ⟨(-436011051), (-436011035)⟩, ⟨129357040, 129357054⟩, ⟨(-11985619), (-11985608)⟩, ⟨(-2510864), (-2510853)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨574344501, 861516753⟩, ⟨143586125, 143586126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1804356464, 2706534703⟩, ⟨451089115, 451089119⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨758027250, 1705561322⟩, ⟨379013624, 568520444⟩, ⟨47376702, 47376704⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨189, 428⟩, ⟨94, 143⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94498), (-94258)⟩, ⟨94, 143⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-37526), (-16635)⟩, ⟨(-12493), (-8260)⟩, ⟨(-1034), (-1015)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5075530, 5096422⟩, ⟨(-12493), (-8260)⟩, ⟨(-1034), (-1015)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨895790, 2023825⟩, ⟨442933, 673152⟩, ⟨53921, 55311⟩, ⟨(-275), (-178)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142269787), (-141141751)⟩, ⟨442933, 673152⟩, ⟨53921, 55311⟩, ⟨(-275), (-178)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-56496320), (-24910386)⟩, ⟨(-18753933), (-12187878)⟩, ⟨(-1520740), (-1445829)⟩, ⟨9533, 14717⟩, ⟨552, 595⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1375159445, 1406745380⟩, ⟨(-18753933), (-12187878)⟩, ⟨(-1520740), (-1445829)⟩, ⟨9533, 14717⟩, ⟨552, 595⟩⟩
...
def j72 : Jet := ⟨⟨2081, 4694⟩, ⟨1034, 1564⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850096), (-847482)⟩, ⟨1034, 1564⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-337580), (-149573)⟩, ⟨(-112345), (-74164)⟩, ⟨(-9265), (-9087)⟩, ⟨21, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35453814, 35641822⟩, ⟨(-112345), (-74164)⟩, ⟨(-9265), (-9087)⟩, ⟨21, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6257313, 14153615⟩, ⟨3084043, 4704783⟩, ⟨372531, 385009⟩, ⟨(-2464), (-1604)⟩, ⟨(-103), (-94)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709570570), (-701674267)⟩, ⟨3084043, 4704783⟩, ⟨372531, 385009⟩, ⟨(-2464), (-1604)⟩, ⟨(-103), (-94)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-281775399), (-123839875)⟩, ⟨(-93380826), (-60051635)⟩, ⟨(-7489193), (-6964334)⟩, ⟨65914, 102579⟩, ⟨3741, 4090⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4013191897, 4171127421⟩, ⟨(-93380826), (-60051635)⟩, ⟨(-7489193), (-6964334)⟩, ⟨65914, 102579⟩, ⟨3741, 4090⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨577717515, 886480601⟩, ⟨132611320, 142626525⟩, ⟨(-2927993), (-1887466)⟩, ⟨(-155716), (-142576)⟩, ⟨1232, 1921⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4422483950, 4596526792⟩, ⟨63670409, 106954136⟩, ⟨8300672, 11066441⟩, ⟨112769, 384457⟩, ⟨8342, 24430⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨594869823, 948722436⟩, ⟨145112849, 174715979⟩, ⟨(-51163), 3892323⟩, ⟨31895, 272056⟩, ⟨(-5552), 14106⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-861516753), (-574344501)⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3433450543, 3720622795⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨82391804, 209564870⟩, ⟨40197396, 77186604⟩, ⟨4880282, 8826877⟩, ⟨4670, 436864⟩, ⟨(-347), 31896⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4377359100, 4504532166⟩, ⟨40197396, 77186604⟩, ⟨4880282, 8826877⟩, ⟨4670, 436864⟩, ⟨(-347), 31896⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4335967501, 4398501829⟩, ⟨19625602, 38228371⟩, ⟨2216577, 4327291⟩, ⟨(-35840), 206335⟩, ⟨(-4151), 15549⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3466226619, 3810312173⟩, ⟨(-131358464), (-111840530)⟩, ⟨493936, 3092517⟩, ⟨(-175715), 104641⟩, ⟨(-10495), 14669⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6659533104, 9989299676⟩, ⟨1664883273, 1664883286⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10325894961, 23233263758⟩, ⟨5162947470, 7744421284⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10325894961, 23233263758⟩, ⟨5162947470, 7744421284⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23233263758), (-10325894961)⟩, ⟨(-7744421284), (-5162947470)⟩, ⟨(-645368443), (-645368432)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11616631879), (-5162947480)⟩, ⟨(-3872210642), (-2581473735)⟩, ⟨(-322684222), (-322684216)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨287289762, 1290915380⟩, ⟨(-1163849671), (-172674417)⟩, ⟨(-45094824), 503061263⟩, ⟨(-142532755), 71845989⟩, ⟨(-35091226), 33819794⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨231855413, 1145245179⟩, ⟨(-1071999602), (-146836810)⟩, ⟨(-35476746), 482819543⟩, ⟨(-142725583), 65129491⟩, ⟨(-33392782), 34776990⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨717930627, 717930628⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4362741783, 4362741785⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2810
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨574344501, 861516753⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4335967501, 4398501829⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2811
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (40483119 / 4294967296)

theorem envelope_integral : (∫ s in ((5349 / 40000) : ℝ)..(16047 / 80000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((5349 / 40000) : ℝ)..(16047 / 80000), prawitzNormalCorrection
