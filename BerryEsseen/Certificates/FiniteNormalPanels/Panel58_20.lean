...
namespace FiniteNormalPanel58_20
...
def j2 : Jet := ⟨⟨1695821843, 1695821847⟩, ⟨565273947, 565273952⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨669577094, 669577098⟩, ⟨446384728, 446384736⟩, ⟨74397454, 74397457⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨167, 168⟩, ⟨111, 112⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94520), (-94518)⟩, ⟨111, 112⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-14736), (-14735)⟩, ⟨(-9807), (-9805)⟩, ⟨(-1625), (-1622)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098320, 5098322⟩, ⟨(-9807), (-9805)⟩, ⟨(-1625), (-1622)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨794818, 794819⟩, ⟨528349, 528352⟩, ⟨87039, 87043⟩, ⟨(-339), (-336)⟩, ⟨(-29), (-26)⟩⟩
...
def j16 : Jet := ⟨⟨(-142370759), (-142370757)⟩, ⟨528349, 528352⟩, ⟨87039, 87043⟩, ⟨(-339), (-336)⟩, ⟨(-29), (-26)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-22195327), (-22195325)⟩, ⟨(-14714517), (-14714513)⟩, ⟨(-2397667), (-2397664)⟩, ⟨18145, 18148⟩, ⟨1466, 1470⟩⟩
...
def j19 : Jet := ⟨⟨1409460438, 1409460441⟩, ⟨(-14714517), (-14714513)⟩, ⟨(-2397667), (-2397664)⟩, ⟨18145, 18148⟩, ⟨1466, 1470⟩⟩
...
def j25 : Jet := ⟨⟨1842, 1843⟩, ⟨1226, 1228⟩, ⟨201, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850335), (-850333)⟩, ⟨1226, 1228⟩, ⟨201, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-132566), (-132565)⟩, ⟨(-88187), (-88184)⟩, ⟨(-14572), (-14569)⟩, ⟨40, 44⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35658828, 35658830⟩, ⟨(-88187), (-88184)⟩, ⟨(-14572), (-14569)⟩, ⟨40, 44⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5559142, 5559143⟩, ⟨3692345, 3692349⟩, ⟨606244, 606247⟩, ⟨(-3037), (-3034)⟩, ⟨(-249), (-246)⟩⟩
...
def j33 : Jet := ⟨⟨(-710268741), (-710268739)⟩, ⟨3692345, 3692349⟩, ⟨606244, 606247⟩, ⟨(-3037), (-3034)⟩, ⟨(-249), (-246)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-110729524), (-110729522)⟩, ⟨(-73244055), (-73244050)⟩, ⟨(-11825017), (-11825013)⟩, ⟨126492, 126496⟩, ⟨10146, 10149⟩⟩
...
def j36 : Jet := ⟨⟨4184237772, 4184237774⟩, ⟨(-73244055), (-73244050)⟩, ⟨(-11825017), (-11825013)⟩, ⟨126492, 126496⟩, ⟨10146, 10149⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨556510360, 556510363⟩, ⟨179693583, 179693589⟩, ⟨(-2883318), (-2883313)⟩, ⟨(-308401), (-308397)⟩, ⟨2966, 2970⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4408627107, 4408627110⟩, ⟨77171928, 77171937⟩, ⟨13810031, 13810038⟩, ⟨326553, 326562⟩, ⟨31716, 31725⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨571237564, 571237569⟩, ⟨194448273, 194448283⟩, ⟨2058513, 2058522⟩, ⟨251727, 251736⟩, ⟨6001, 6011⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-539796859), (-539796858)⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3755170437, 3755170438⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨75975515, 75975517⟩, ⟨51723866, 51723870⟩, ⟨9350927, 9350933⟩, ⟨253352, 253358⟩, ⟨25374, 25381⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4370942811, 4370942813⟩, ⟨51723866, 51723870⟩, ⟨9350927, 9350933⟩, ⟨253352, 253358⟩, ⟨25374, 25381⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4332788527, 4332788529⟩, ⟨25636182, 25636185⟩, ⟨4558808, 4558813⟩, ⟨98595, 98600⟩, ⟨9594, 9599⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3788238248, 3788238252⟩, ⟨(-159102567), (-159102561)⟩, ⟨2911855, 2911861⟩, ⟨(-104783), (-104777)⟩, ⟨4257, 4263⟩⟩
...
def j47 : Jet := ⟨⟨3523523043, 3523523052⟩, ⟨1174507681, 1174507689⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2890642414, 2890642430⟩, ⟨1927094942, 1927094962⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2890642414, 2890642430⟩, ⟨1927094942, 1927094962⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2890642430), (-2890642414)⟩, ⟨(-1927094962), (-1927094942)⟩, ⟨(-321182495), (-321182490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1445321215), (-1445321207)⟩, ⟨(-963547481), (-963547471)⟩, ⟨(-160591248), (-160591245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3067702381, 3067702393⟩, ⟨(-688218725), (-688218714)⟩, ⟨(-37504467), (-37504460)⟩, ⟨19959882, 19959884⟩, ⟨(-418311), (-418310)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2705768564, 2705768578⟩, ⟨(-720661094), (-720661076)⟩, ⟨(-5505467), (-5505451)⟩, ⟨18452853, 18452862⟩, ⟨(-1113950), (-1113938)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨359864572, 719729145⟩, ⟨179932286, 179932287⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1130547895, 2261095795⟩, ⟨565273947, 565273952⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨297589819, 1190359284⟩, ⟨297589818, 595179646⟩, ⟨74397454, 74397457⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨74, 299⟩, ⟨74, 150⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94613), (-94387)⟩, ⟨74, 150⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-26223), (-6539)⟩, ⟨(-13107), (-6497)⟩, ⟨(-1633), (-1607)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5086833, 5106518⟩, ⟨(-13107), (-6497)⟩, ⟨(-1633), (-1607)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨352456, 1415283⟩, ⟨348823, 707192⟩, ⟨85844, 87895⟩, ⟨(-455), (-221)⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142813121), (-141750293)⟩, ⟨348823, 707192⟩, ⟨85844, 87895⟩, ⟨(-455), (-221)⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-39580960), (-9821598)⟩, ⟨(-19766311), (-9625598)⟩, ⟨(-2443694), (-2333038)⟩, ⟨11862, 24416⟩, ⟨1413, 1507⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1392074805, 1421834168⟩, ⟨(-19766311), (-9625598)⟩, ⟨(-2443694), (-2333038)⟩, ⟨11862, 24416⟩, ⟨1413, 1507⟩⟩
...
def j72 : Jet := ⟨⟨817, 3279⟩, ⟨812, 1640⟩, ⟨200, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851360), (-848897)⟩, ⟨812, 1640⟩, ⟨200, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-235957), (-58818)⟩, ⟨(-117923), (-58363)⟩, ⟨(-14679), (-14419)⟩, ⟨26, 58⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35555437, 35732577⟩, ⟨(-117923), (-58363)⟩, ⟨(-14679), (-14419)⟩, ⟨26, 58⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2463566, 9903360⟩, ⟨2430883, 4947637⟩, ⟨595480, 613918⟩, ⟨(-4077), (-1992)⟩, ⟨(-254), (-238)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713364317), (-705924522)⟩, ⟨2430883, 4947637⟩, ⟨595480, 613918⟩, ⟨(-4077), (-1992)⟩, ⟨(-254), (-238)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-197710432), (-48912118)⟩, ⟨(-98686786), (-47540869)⟩, ⟨(-12147213), (-11372255)⟩, ⟨82236, 170641⟩, ⟨9678, 10481⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4097256864, 4246055178⟩, ⟨(-98686786), (-47540869)⟩, ⟨(-12147213), (-11372255)⟩, ⟨82236, 170641⟩, ⟨9678, 10481⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨366430552, 748527995⟩, ⟨172809254, 184598291⟩, ⟨(-3887995), (-1880970)⟩, ⟨(-318501), (-294204)⟩, ⟨1932, 4008⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4344442853, 4502218115⟩, ⟨48642464, 108440709⟩, ⟨12180391, 15959720⟩, ⟨85719, 618707⟩, ⟨18109, 50982⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨370651621, 784647721⟩, ⟨178949910, 212405035⟩, ⟨(-1079280), 5539625⟩, ⟨65357, 474885⟩, ⟨(-15544), 31016⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-719729145), (-359864572)⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3575238151, 3935102724⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨31986884, 143347319⟩, ⟨30886416, 77608568⟩, ⟨7061604, 12528434⟩, ⟨(-95472), 721432⟩, ⟨(-1627), 65451⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4326954180, 4438314615⟩, ⟨30886416, 77608568⟩, ⟨7061604, 12528434⟩, ⟨(-95472), 721432⟩, ⟨(-1627), 65451⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310931070, 4366052694⟩, ⟨15191771, 38660589⟩, ⟨3302149, 6214253⟩, ⟨(-103290), 347744⟩, ⟨(-8410), 32267⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3588526795, 4000232055⟩, ⟨(-170264312), (-145179753)⟩, ⟨1129153, 5057137⟩, ⟨(-354975), 180269⟩, ⟨(-22275), 33892⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2349015362, 4698030733⟩, ⟨1174507681, 1174507689⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1284729961, 5138919868⟩, ⟨1284729960, 2569459948⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1284729961, 5138919868⟩, ⟨1284729960, 2569459948⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5138919868), (-1284729961)⟩, ⟨(-2569459948), (-1284729960)⟩, ⟨(-321182495), (-321182490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2569459934), (-642364980)⟩, ⟨(-1284729974), (-642364980)⟩, ⟨(-160591248), (-160591245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2361258945, 3698331196⟩, ⟨(-1106261495), (-353155204)⟩, ⟨(-111873345), 77166162⟩, ⟨1109017, 38730514⟩, ⟨(-4338955), 2050037⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1972876720, 3444539151⟩, ⟨(-1176958092), (-374883856)⟩, ⟨(-91637983), 120080630⟩, ⟨(-3740714), 40570044⟩, ⟨(-5773927), 2083346⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4332788527, 4332788529⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1156
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310931070, 4366052694⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1157
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (113295367 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((6703 / 80000) : ℝ)..(6703 / 40000), prawitzNormalCorrection
