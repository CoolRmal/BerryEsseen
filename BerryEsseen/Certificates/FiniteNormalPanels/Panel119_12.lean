...
namespace FiniteNormalPanel119_12
...
def j2 : Jet := ⟨⟨2590072918, 2590072923⟩, ⟨518014583, 518014587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1561939185, 1561939192⟩, ⟨624775672, 624775680⟩, ⟨62477567, 62477569⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨390, 392⟩, ⟨156, 157⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94297), (-94294)⟩, ⟨156, 157⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-34293), (-34291)⟩, ⟨(-13662), (-13658)⟩, ⟨(-1345), (-1342)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5078763, 5078766⟩, ⟨(-13662), (-13658)⟩, ⟨(-1345), (-1342)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1846980, 1846982⟩, ⟨733823, 733827⟩, ⟨71401, 71406⟩, ⟨(-394), (-390)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-141318597), (-141318594)⟩, ⟨733823, 733827⟩, ⟨71401, 71406⟩, ⟨(-394), (-390)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-51392954), (-51392952)⟩, ⟨(-20290315), (-20290311)⟩, ⟨(-1923007), (-1923001)⟩, ⟨20916, 20922⟩, ⟨972, 977⟩⟩
...
def j19 : Jet := ⟨⟨1380262811, 1380262814⟩, ⟨(-20290315), (-20290311)⟩, ⟨(-1923007), (-1923001)⟩, ⟨20916, 20922⟩, ⟨972, 977⟩⟩
...
def j25 : Jet := ⟨⟨4289, 4291⟩, ⟨1709, 1712⟩, ⟨167, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847888), (-847885)⟩, ⟨1709, 1712⟩, ⟨167, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-308350), (-308348)⟩, ⟨(-122719), (-122716)⟩, ⟨(-12026), (-12021)⟩, ⟨47, 50⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35483044, 35483047⟩, ⟨(-122719), (-122716)⟩, ⟨(-12026), (-12021)⟩, ⟨47, 50⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12904023, 12904025⟩, ⟨5116980, 5116983⟩, ⟨493934, 493939⟩, ⟨(-3519), (-3514)⟩, ⟨(-169), (-164)⟩⟩
...
def j33 : Jet := ⟨⟨(-702923860), (-702923857)⟩, ⟨5116980, 5116983⟩, ⟨493934, 493939⟩, ⟨(-3519), (-3514)⟩, ⟨(-169), (-164)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-255630428), (-255630425)⟩, ⟨(-100391294), (-100391289)⟩, ⟨(-9301240), (-9301234)⟩, ⟨145006, 145011⟩, ⟨6611, 6616⟩⟩
...
def j36 : Jet := ⟨⟨4039336868, 4039336871⟩, ⟨(-100391294), (-100391289)⟩, ⟨(-9301240), (-9301234)⟩, ⟨145006, 145011⟩, ⟨6611, 6616⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨832365203, 832365207⟩, ⟨154236999, 154237005⟩, ⟨(-3606876), (-3606869)⟩, ⟨(-219321), (-219315)⟩, ⟨3108, 3114⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4566775355, 4566775359⟩, ⟨113499932, 113499940⟩, ⟨13336606, 13336616⟩, ⟨428864, 428876⟩, ⟨29811, 29822⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨885041639, 885041645⟩, ⟨185994226, 185994235⟩, ⟨2825403, 2825416⟩, ⟨233527, 233540⟩, ⟨7485, 7500⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-824445817), (-824445816)⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3470521479, 3470521480⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨182375941, 182375944⟩, ⟨76653730, 76653736⟩, ⟨9218940, 9218948⟩, ⟨340950, 340962⟩, ⟨25166, 25179⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4477343237, 4477343240⟩, ⟨76653730, 76653736⟩, ⟨9218940, 9218948⟩, ⟨340950, 340962⟩, ⟨25166, 25179⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4385207267, 4385207269⟩, ⟨37538164, 37538168⟩, ⟨4353948, 4353953⟩, ⟨129696, 129703⟩, ⟨9051, 9060⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3543439323, 3543439327⟩, ⟨(-138021112), (-138021105)⟩, ⟨2077042, 2077048⟩, ⟨(-62354), (-62347)⟩, ⟨2333, 2342⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨31945585101, 31945585108⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value512

def j47 : Jet := ⟨⟨6132154719, 6132154729⟩, ⟨1226430942, 1226430951⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8755205547, 8755205577⟩, ⟨3502082212, 3502082246⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8755205547, 8755205577⟩, ⟨3502082212, 3502082246⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8755205577), (-8755205547)⟩, ⟨(-3502082246), (-3502082212)⟩, ⟨(-350208227), (-350208220)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4377602789), (-4377602773)⟩, ⟨(-1751041123), (-1751041106)⟩, ⟨(-175104114), (-175104110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1549920845, 1549920865⟩, ⟨(-631896587), (-631896571)⟩, ⟨65621201, 65621209⟩, ⟨8256945, 8256949⟩, ⟨(-2179257), (-2179255)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1278717645, 1278717664⟩, ⟨(-571135669), (-571135651)⟩, ⟨75194764, 75194777⟩, ⟨4375293, 4375304⟩, ⟨(-2021529), (-2021517)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨659556652, 989334980⟩, ⟨164889163, 164889164⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2072058332, 3108087506⟩, ⟨518014583, 518014587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨999641076, 2249192434⟩, ⟨499820538, 749730816⟩, ⟨62477567, 62477569⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-49455), (-21906)⟩, ⟨(-16456), (-10854)⟩, ⟨(-1357), (-1327)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5063601, 5091151⟩, ⟨(-16456), (-10854)⟩, ⟨(-1357), (-1327)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1178538, 2666139⟩, ⟨580651, 886187⟩, ⟨70074, 72489⟩, ⟨(-477), (-307)⟩, ⟨(-20), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141987039), (-140499437)⟩, ⟨580651, 886187⟩, ⟨70074, 72489⟩, ⟨(-477), (-307)⟩, ⟨(-20), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-74355904), (-32700833)⟩, ⟨(-24650158), (-15886336)⟩, ⟨(-1981561), (-1851146)⟩, ⟨16350, 25475⟩, ⟨924, 1017⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1357299861, 1398954933⟩, ⟨(-24650158), (-15886336)⟩, ⟨(-1981561), (-1851146)⟩, ⟨16350, 25475⟩, ⟨924, 1017⟩⟩
...
def j72 : Jet := ⟨⟨2741, 6186⟩, ⟨1360, 2060⟩, ⟨165, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849436), (-845990)⟩, ⟨1360, 2060⟩, ⟨165, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-444834), (-196901)⟩, ⟨(-147962), (-97371)⟩, ⟨(-12161), (-11856)⟩, ⟨36, 60⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35346560, 35594494⟩, ⟨(-147962), (-97371)⟩, ⟨(-12161), (-11856)⟩, ⟨36, 60⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8226808, 18640158⟩, ⟨4035919, 6190724⟩, ⟨481977, 503693⟩, ⟨(-4268), (-2763)⟩, ⟨(-173), (-159)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707601075), (-697187724)⟩, ⟨4035919, 6190724⟩, ⟨481977, 503693⟩, ⟨(-4268), (-2763)⟩, ⟨(-173), (-159)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-370557184), (-162268403)⟩, ⟨(-122579714), (-77892236)⟩, ⟨(-9711404), (-8797345)⟩, ⟨112562, 177337⟩, ⟨6174, 6970⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3924410112, 4132698893⟩, ⟨(-122579714), (-77892236)⟩, ⟨(-9711404), (-8797345)⟩, ⟨112562, 177337⟩, ⟨6174, 6970⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨654813946, 1012364950⟩, ⟨145865201, 161063311⟩, ⟨(-4407021), (-2809109)⟩, ⟨(-231109), (-204830)⟩, ⟨2416, 3809⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4463607088, 4700513848⟩, ⟨84129123, 146821466⟩, ⟨11087401, 16217961⟩, ⟨186355, 741872⟩, ⟨12883, 53874⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨680524895, 1107956159⟩, ⟨164418915, 210878727⟩, ⟨(-275573), 6409197⟩, ⟨1376, 515153⟩, ⟨(-13741), 33426⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-989334980), (-659556652)⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3305632316, 3635410644⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨107827161, 285815180⟩, ⟨52103382, 108799146⟩, ⟨6152067, 13660653⟩, ⟨(-26626), 895158⟩, ⟨(-7398), 77399⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4402794457, 4580782476⟩, ⟨52103382, 108799146⟩, ⟨6152067, 13660653⟩, ⟨(-26626), 895158⟩, ⟨(-7398), 77399⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4348546677, 4435573348⟩, ⟨25225861, 53729305⟩, ⟨2653105, 6673002⟩, ⟨(-95600), 426675⟩, ⟨(-14046), 38596⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3346869820, 3754424528⟩, ⟨(-150872061), (-121467777)⟩, ⟨(-20768), 4679811⟩, ⟨(-337105), 259297⟩, ⟨(-28271), 36341⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4905723770, 7358585672⟩, ⟨1226430942, 1226430951⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5603331538, 12607496021⟩, ⟨2801665768, 4202498694⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5603331538, 12607496021⟩, ⟨2801665768, 4202498694⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12607496021), (-5603331538)⟩, ⟨(-4202498694), (-2801665768)⟩, ⟨(-350208227), (-350208220)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6303748011), (-2801665769)⟩, ⟨(-2101249347), (-1400832884)⟩, ⟨(-175104114), (-175104110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨989790702, 2236987958⟩, ⟨(-1094413336), (-322826989)⟩, ⟨(-38555001), 227359411⟩, ⟨(-28303060), 36033354⟩, ⟨(-9041874), 4247650⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨771298219, 1955452017⟩, ⟨(-1035256139), (-279556862)⟩, ⟨(-24583477), 239626698⟩, ⟨(-34095636), 32993072⟩, ⟨(-9292485), 5059842⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4385207267, 4385207269⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar512 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2400
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar512 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4348546677, 4435573348⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2401
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((30713 / 200000) : ℝ)..(92139 / 400000), prawitzNormalCorrection
      ((107357 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
