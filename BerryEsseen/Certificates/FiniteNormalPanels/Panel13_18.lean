...
namespace FiniteNormalPanel13_18
...
def j2 : Jet := ⟨⟨646653829, 646653834⟩, ⟨646653829, 646653834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨97360735, 97360737⟩, ⟨194721470, 194721474⟩, ⟨97360735, 97360737⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-2146), (-2145)⟩, ⟨(-4291), (-4289)⟩, ⟨(-2144), (-2141)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110910, 5110912⟩, ⟨(-4291), (-4289)⟩, ⟨(-2144), (-2141)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨115856, 115858⟩, ⟨231615, 231618⟩, ⟨115612, 115616⟩, ⟨(-196), (-193)⟩, ⟨(-49), (-46)⟩⟩
...
def j16 : Jet := ⟨⟨(-143049721), (-143049718)⟩, ⟨231615, 231618⟩, ⟨115612, 115616⟩, ⟨(-196), (-193)⟩, ⟨(-49), (-46)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3242732), (-3242731)⟩, ⟨(-6480214), (-6480211)⟩, ⟨(-3229612), (-3229609)⟩, ⟨10486, 10489⟩, ⟨2609, 2612⟩⟩
...
def j19 : Jet := ⟨⟨1428413033, 1428413035⟩, ⟨(-6480214), (-6480211)⟩, ⟨(-3229612), (-3229609)⟩, ⟨10486, 10489⟩, ⟨2609, 2612⟩⟩
...
def j25 : Jet := ⟨⟨268, 269⟩, ⟨535, 537⟩, ⟨266, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851909), (-851907)⟩, ⟨535, 537⟩, ⟨266, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-19312), (-19311)⟩, ⟨(-38612), (-38610)⟩, ⟨(-19282), (-19279)⟩, ⟨23, 26⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35772082, 35772084⟩, ⟨(-38612), (-38610)⟩, ⟨(-19282), (-19279)⟩, ⟨23, 26⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨810901, 810902⟩, ⟨1620927, 1620929⟩, ⟨808712, 808715⟩, ⟨(-1751), (-1748)⟩, ⟨(-437), (-434)⟩⟩
...
def j33 : Jet := ⟨⟨(-715016982), (-715016980)⟩, ⟨1620927, 1620929⟩, ⟨808712, 808715⟩, ⟨(-1751), (-1748)⟩, ⟨(-437), (-434)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-16208408), (-16208407)⟩, ⟨(-32380072), (-32380069)⟩, ⟨(-16116588), (-16116585)⟩, ⟨73368, 73371⟩, ⟨18242, 18245⟩⟩
...
def j36 : Jet := ⟨⟨4278758888, 4278758889⟩, ⟨(-32380072), (-32380069)⟩, ⟨(-16116588), (-16116585)⟩, ⟨73368, 73371⟩, ⟨18242, 18245⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨215063047, 215063050⟩, ⟨214087380, 214087385⟩, ⟨(-1461921), (-1461917)⟩, ⟨(-484676), (-484672)⟩, ⟨1970, 1974⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4311237102, 4311237104⟩, ⟨32625851, 32625856⟩, ⟨16485818, 16485824⟩, ⟨173719, 173726⟩, ⟨44464, 44472⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨215877729, 215877733⟩, ⟨216532048, 216532056⟩, ⟨984310, 984318⟩, ⟨332832, 332843⟩, ⟨3568, 3577⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-205836308), (-205836307)⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4089130988, 4089130989⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨10850651, 10850653⟩, ⟨21767078, 21767082⟩, ⟨11015475, 11015479⟩, ⟨132706, 132710⟩, ⟨34141, 34148⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4305817947, 4305817949⟩, ⟨21767078, 21767082⟩, ⟨11015475, 11015479⟩, ⟨132706, 132710⟩, ⟨34141, 34148⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4300389199, 4300389201⟩, ⟨10869817, 10869820⟩, ⟨5487055, 5487059⟩, ⟨52399, 52403⟩, ⟨13415, 13421⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4094293046, 4094293050⟩, ⟨(-195747272), (-195747267)⟩, ⟨4703150, 4703157⟩, ⟨(-213081), (-213075)⟩, ⟨10260, 10267⟩⟩
...
def j47 : Jet := ⟨⟨1033191893, 1033191899⟩, ⟨1033191893, 1033191899⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨248543333, 248543337⟩, ⟨497086666, 497086674⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨248543333, 248543337⟩, ⟨497086666, 497086674⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-248543337), (-248543333)⟩, ⟨(-497086674), (-497086666)⟩, ⟨(-248543337), (-248543333)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-124271669), (-124271666)⟩, ⟨(-248543337), (-248543333)⟩, ⟨(-124271669), (-124271666)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4172476265, 4172476269⟩, ⟨(-241454965), (-241454960)⟩, ⟨(-113741165), (-113741160)⟩, ⟨6851555, 6851557⟩, ⟨1546385, 1546386⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3977525177, 3977525186⟩, ⟨(-420338064), (-420338052)⟩, ⟨(-92853265), (-92853250)⟩, ⟨11243883, 11243895⟩, ⟨1059259, 1059274⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 411672616⟩, ⟨205836307, 205836308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1293307667⟩, ⟨646653829, 646653834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 389442948⟩, ⟨0, 389442948⟩, ⟨97360735, 97360737⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-8586), 0⟩, ⟨(-8586), 9⟩, ⟨(-2147), (-2132)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5104470, 5113057⟩, ⟨(-8586), 9⟩, ⟨(-2147), (-2132)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 463623⟩, ⟨(-779), 463624⟩, ⟨114736, 115907⟩, ⟨(-390), 2⟩, ⟨(-49), (-46)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142701953)⟩, ⟨(-779), 463624⟩, ⟨114736, 115907⟩, ⟨(-390), 2⟩, ⟨(-49), (-46)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-12981432), 0⟩, ⟨(-12981503), 42039⟩, ⟨(-3245429), (-3182299)⟩, ⟨(-54), 21021⟩, ⟨2559, 2629⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1418674333, 1431655766⟩, ⟨(-12981503), 42039⟩, ⟨(-3245429), (-3182299)⟩, ⟨(-54), 21021⟩, ⟨2559, 2629⟩⟩
...
def j72 : Jet := ⟨⟨0, 1074⟩, ⟨(-1), 1074⟩, ⟨266, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851102)⟩, ⟨(-1), 1074⟩, ⟨266, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-77271), 0⟩, ⟨(-77272), 98⟩, ⟨(-19319), (-19170)⟩, ⟨(-2), 50⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35714123, 35791395⟩, ⟨(-77272), 98⟩, ⟨(-19319), (-19170)⟩, ⟨(-2), 50⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3245358⟩, ⟨(-7007), 3245367⟩, ⟨800828, 811349⟩, ⟨(-3505), 8⟩, ⟨(-439), (-428)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712582524)⟩, ⟨(-7007), 3245367⟩, ⟨800828, 811349⟩, ⟨(-3505), 8⟩, ⟨(-439), (-428)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-64907159), 0⟩, ⟨(-64907795), 294272⟩, ⟨(-16227426), (-15785380)⟩, ⟨(-477), 147138⟩, ⟨17795, 18394⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4230060137, 4294967296⟩, ⟨(-64907795), 294272⟩, ⟨(-16227426), (-15785380)⟩, ⟨(-477), 147138⟩, ⟨17795, 18394⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 431102556⟩, ⟨209687769, 215563938⟩, ⟨(-2931775), 6330⟩, ⟨(-488652), (-472799)⟩, ⟨(-9), 3957⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4360870408⟩, ⟨(-303373), 66915003⟩, ⟨15780795, 17756015⟩, ⟨(-154089), 529651⟩, ⟨34700, 58188⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 437717508⟩, ⟨209657318, 225588127⟩, ⟨(-2991988), 5147126⟩, ⟨213150, 471746⟩, ⟨(-27479), 36505⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-411672616), 0⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3883294680, 4294967296⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 44609564⟩, ⟨0, 45981200⟩, ⟨9624496, 12897883⟩, ⟨(-314302), 636850⟩, ⟨11620, 63167⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4339576860⟩, ⟨0, 45981200⟩, ⟨9624496, 12897883⟩, ⟨(-314302), 636850⟩, ⟨11620, 63167⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4317214460⟩, ⟨0, 22990600⟩, ⟨4726233, 6448942⟩, ⟨(-191672), 318425⟩, ⟨(-737), 30011⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3883294680, 4317214460⟩, ⟨(-206902504), (-182845707)⟩, ⟨3171398, 6448942⟩, ⟨(-500738), 91921⟩, ⟨(-15998), 39197⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2066383797⟩, ⟨1033191893, 1033191899⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 994173344⟩, ⟨0, 994173344⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 994173344⟩, ⟨0, 994173344⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-994173344), 0⟩, ⟨(-994173344), 0⟩, ⟨(-248543337), (-248543333)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-497086672), 0⟩, ⟨(-497086672), 0⟩, ⟨(-124271669), (-124271666)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3825567916, 4294967296⟩, ⟨(-497086672), 0⟩, ⟨(-124271669), (-81924283)⟩, ⟨0, 14382832⟩, ⟨769052, 1797854⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3458887230, 4317214460⟩, ⟨(-706563997), (-162862397)⟩, ⟨(-122090581), (-43676620)⟩, ⟨2240567, 20535824⟩, ⟨(-210763), 1843826⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4300389199, 4300389201⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified268
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4317214460⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified269
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (189157237 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1917 / 20000), prawitzNormalCorrection
