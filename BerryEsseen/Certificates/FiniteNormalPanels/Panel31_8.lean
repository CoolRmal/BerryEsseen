...
namespace FiniteNormalPanel31_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (37721 / 160000)
def radius : Rat := (37721 / 800000)

def j0 : Jet := ⟨⟨1012565383, 1012565384⟩, ⟨202513076, 202513077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3181067968, 3181067972⟩, ⟨636213591, 636213595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2356058316, 2356058323⟩, ⟨942423322, 942423330⟩, ⟨94242331, 94242334⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨589, 591⟩, ⟨235, 237⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94098), (-94095)⟩, ⟨235, 237⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-51619), (-51616)⟩, ⟨(-20520), (-20515)⟩, ⟨(-2002), (-1997)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5061437, 5061441⟩, ⟨(-20520), (-20515)⟩, ⟨(-2002), (-1997)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2776514, 2776518⟩, ⟨1099348, 1099354⟩, ⟨105458, 105465⟩, ⟨(-886), (-881)⟩, ⟨(-42), (-39)⟩⟩
...
def j16 : Jet := ⟨⟨(-140389063), (-140389058)⟩, ⟨1099348, 1099354⟩, ⟨105458, 105465⟩, ⟨(-886), (-881)⟩, ⟨(-42), (-39)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-77012187), (-77012183)⟩, ⟨(-30201814), (-30201808)⟩, ⟨(-2781414), (-2781406)⟩, ⟨46775, 46782⟩, ⟨2095, 2101⟩⟩
...
def j19 : Jet := ⟨⟨1354643578, 1354643583⟩, ⟨(-30201814), (-30201808)⟩, ⟨(-2781414), (-2781406)⟩, ⟨46775, 46782⟩, ⟨2095, 2101⟩⟩
...
def j22 : Jet := ⟨⟨(-60), (-58)⟩, ⟨(-24), (-23)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11775, 11778⟩, ⟨(-24), (-23)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6459, 6461⟩, ⟨2569, 2573⟩, ⟨250, 253⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845718), (-845715)⟩, ⟨2569, 2573⟩, ⟨250, 253⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-463930), (-463927)⟩, ⟨(-184163), (-184159)⟩, ⟨(-17858), (-17853)⟩, ⟨108, 113⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35327464, 35327468⟩, ⟨(-184163), (-184159)⟩, ⟨(-17858), (-17853)⟩, ⟨108, 113⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19379324, 19379327⟩, ⟨7650704, 7650709⟩, ⟨724965, 724972⟩, ⟨(-7901), (-7895)⟩, ⟨(-368), (-362)⟩⟩
...
def j33 : Jet := ⟨⟨(-696448559), (-696448555)⟩, ⟨7650704, 7650709⟩, ⟨724965, 724972⟩, ⟨(-7901), (-7895)⟩, ⟨(-368), (-362)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-382045616), (-382045612)⟩, ⟨(-148621358), (-148621351)⟩, ⟨(-13205382), (-13205373)⟩, ⟨322615, 322624⟩, ⟨13971, 13978⟩⟩
...
def j36 : Jet := ⟨⟨3912921680, 3912921684⟩, ⟨(-148621358), (-148621351)⟩, ⟨(-13205382), (-13205373)⟩, ⟨322615, 322624⟩, ⟨13971, 13978⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1003316904, 1003316910⟩, ⟨178294403, 178294411⟩, ⟨(-6533851), (-6533842)⟩, ⟨(-377368), (-377359)⟩, ⟨8479, 8487⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4714314663, 4714314669⟩, ⟨179060014, 179060025⟩, ⟨22711013, 22711028⟩, ⟨1078205, 1078222⟩, ⟨85991, 86005⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1101277673, 1101277682⟩, ⟨237531460, 237531474⟩, ⟨5566772, 5566789⟩, ⟨508044, 508063⟩, ⟨23868, 23887⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1012565384), (-1012565383)⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3282401912, 3282401913⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨282379918, 282379923⟩, ⟨121811448, 121811458⟩, ⟨15991347, 15991361⟩, ⟨876272, 876288⟩, ⟨75649, 75664⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4577347214, 4577347219⟩, ⟨121811448, 121811458⟩, ⟨15991347, 15991361⟩, ⟨876272, 876288⟩, ⟨75649, 75664⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4433909853, 4433909856⟩, ⟨58997160, 58997166⟩, ⟨7352612, 7352621⟩, ⟨326572, 326582⟩, ⟨26196, 26206⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3388587892, 3388587897⟩, ⟨(-163976183), (-163976175)⟩, ⟨2837396, 2837406⟩, ⟨(-97106), (-97095)⟩, ⟨4621, 4630⟩⟩
...
def j47 : Jet := ⟨⟨5209102109, 5209102116⟩, ⟨1041820418, 1041820425⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6317800092, 6317800110⟩, ⟨2527120026, 2527120050⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6317800092, 6317800110⟩, ⟨2527120026, 2527120050⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6317800110), (-6317800092)⟩, ⟨(-2527120050), (-2527120026)⟩, ⟨(-252712006), (-252712001)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3158900055), (-3158900046)⟩, ⟨(-1263560025), (-1263560013)⟩, ⟨(-126356003), (-126356000)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2058453978, 2058453993⟩, ⟨(-605587890), (-605587879)⟩, ⟨28521822, 28521828⟩, ⟨9080416, 9080419⟩, ⟨(-1087405), (-1087403)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1624052465, 1624052480⟩, ⟨(-556377980), (-556377964)⟩, ⟨46983205, 46983218⟩, ⟨5628609, 5628622⟩, ⟨(-1169860), (-1169848)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨810052306, 1215078461⟩, ⟨202513076, 202513077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2544854373, 3817281567⟩, ⟨636213591, 636213595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1507877320, 3392723986⟩, ⟨753938656, 1130907998⟩, ⟨94242331, 94242334⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨377, 850⟩, ⟨188, 284⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94310), (-93836)⟩, ⟨188, 284⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-74499), (-32943)⟩, ⟨(-24767), (-16246)⟩, ⟨(-2029), (-1964)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5038557, 5080114⟩, ⟨(-24767), (-16246)⟩, ⟨(-2029), (-1964)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1768936, 4012936⟩, ⟨864903, 1331943⟩, ⟨102433, 107931⟩, ⟨(-1077), (-688)⟩, ⟨(-44), (-38)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141396641), (-139152640)⟩, ⟨864903, 1331943⟩, ⟨102433, 107931⟩, ⟨(-1077), (-688)⟩, ⟨(-44), (-38)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-111693465), (-48853715)⟩, ⟨(-36927505), (-23374715)⟩, ⟨(-2914810), (-2617385)⟩, ⟨36108, 57406⟩, ⟨1928, 2236⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1319962300, 1382802051⟩, ⟨(-36927505), (-23374715)⟩, ⟨(-2914810), (-2617385)⟩, ⟨36108, 57406⟩, ⟨1928, 2236⟩⟩
...
def j70 : Jet := ⟨⟨(-86), (-37)⟩, ⟨(-29), (-18)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11749, 11799⟩, ⟨(-29), (-18)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4124, 9321⟩, ⟨2039, 3101⟩, ⟨246, 256⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848053), (-842855)⟩, ⟨2039, 3101⟩, ⟨246, 256⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-669903), (-295909)⟩, ⟨(-222586), (-145504)⟩, ⟨(-18166), (-17474)⟩, ⟨85, 137⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35121491, 35495486⟩, ⟨(-222586), (-145504)⟩, ⟨(-18166), (-17474)⟩, ⟨85, 137⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12330454, 28038954⟩, ⟨5989399, 9295235⟩, ⟨697693, 747185⟩, ⟨(-9640), (-6150)⟩, ⟨(-384), (-341)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703497429), (-687788928)⟩, ⟨5989399, 9295235⟩, ⟨697693, 747185⟩, ⟨(-9640), (-6150)⟩, ⟨(-384), (-341)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-555713802), (-241468969)⟩, ⟨(-183135177), (-113391896)⟩, ⟨(-14140170), (-12054057)⟩, ⟨246280, 398544⟩, ⟨12466, 15198⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3739253494, 4053498327⟩, ⟨(-183135177), (-113391896)⟩, ⟨(-14140170), (-12054057)⟩, ⟨246280, 398544⟩, ⟨12466, 15198⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨782104169, 1229006979⟩, ⟨162705608, 190984509⟩, ⟨(-8060699), (-5013349)⟩, ⟨(-410377), (-336691)⟩, ⟨6490, 10492⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4550820695, 4933269195⟩, ⟨127303909, 241613769⟩, ⟨17094143, 30488772⟩, ⟨371712, 2107174⟩, ⟨18976, 194944⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨828694514, 1411657378⟩, ⟨195579827, 288505808⟩, ⟨(-1323209), 14156232⟩, ⟨(-209561), 1453372⟩, ⟨(-55895), 131604⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1215078461), (-810052306)⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3079888835, 3484914990⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨159892858, 463979448⟩, ⟨75472486, 189650504⟩, ⟨8036296, 28685459⟩, ⟨(-315524), 2857216⟩, ⟨(-69260), 328428⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4454860154, 4758946744⟩, ⟨75472486, 189650504⟩, ⟨8036296, 28685459⟩, ⟨(-315524), 2857216⟩, ⟨(-69260), 328428⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4374183200, 4521008807⟩, ⟨35849505, 93107979⟩, ⟨2858491, 13936079⟩, ⟨(-451546), 1379310⟩, ⟨(-85564), 169919⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3136693965, 3668323942⟩, ⟨(-187463806), (-130700855)⟩, ⟨(-2340356), 9617317⟩, ⟨(-1023487), 984385⟩, ⟨(-134464), 159163⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4167281685, 6250922540⟩, ⟨1041820418, 1041820425⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4043392055, 9097632161⟩, ⟨2021696020, 3032544060⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4043392055, 9097632161⟩, ⟨2021696020, 3032544060⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9097632161), (-4043392055)⟩, ⟨(-3032544060), (-2021696020)⟩, ⟨(-252712006), (-252712001)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4548816081), (-2021696027)⟩, ⟨(-1516272030), (-1010848010)⟩, ⟨(-126356003), (-126356000)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1489350562, 2682451605⟩, ⟨(-946998210), (-350528175)⟩, ⟨(-37666995), 123345543⟩, ⟨(-7640161), 23006092⟩, ⟨(-3844872), 1228384⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1087700230, 2291077154⟩, ⟨(-925911310), (-301319873)⟩, ⟨(-22966020), 152689706⟩, ⟨(-14668902), 22424358⟩, ⟨(-4673428), 1983907⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1012565383, 1012565384⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4433909853, 4433909856⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified612
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨810052306, 1215078461⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4374183200, 4521008807⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified613
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (154666505 / 4294967296)

theorem envelope_integral : (∫ s in ((37721 / 200000) : ℝ)..(113163 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((37721 / 200000) : ℝ)..(113163 / 400000), prawitzNormalCorrection
