...
namespace FiniteNormalPanel100_19

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3941 / 100000)
def radius : Rat := (3941 / 100000)

def j0 : Jet := ⟨⟨169264661, 169264662⟩, ⟨169264661, 169264662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨531760615, 531760619⟩, ⟨531760615, 531760619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨65837370, 65837372⟩, ⟨131674740, 131674744⟩, ⟨65837370, 65837372⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1452), (-1451)⟩, ⟨(-2903), (-2901)⟩, ⟨(-1452), (-1448)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111604, 5111606⟩, ⟨(-2903), (-2901)⟩, ⟨(-1452), (-1448)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨78355, 78356⟩, ⟨156666, 156668⟩, ⟨78243, 78246⟩, ⟨(-90), (-87)⟩, ⟨(-23), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-143087222), (-143087220)⟩, ⟨156666, 156668⟩, ⟨78243, 78246⟩, ⟨(-90), (-87)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2193378), (-2193377)⟩, ⟨(-4384355), (-4384353)⟩, ⟨(-2187376), (-2187373)⟩, ⟨4797, 4800⟩, ⟨1195, 1198⟩⟩
...
def j19 : Jet := ⟨⟨1429462387, 1429462389⟩, ⟨(-4384355), (-4384353)⟩, ⟨(-2187376), (-2187373)⟩, ⟨4797, 4800⟩, ⟨1195, 1198⟩⟩
...
def j25 : Jet := ⟨⟨181, 182⟩, ⟨361, 363⟩, ⟨179, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851996), (-851994)⟩, ⟨361, 363⟩, ⟨179, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13061), (-13060)⟩, ⟨(-26116), (-26114)⟩, ⟨(-13048), (-13045)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778333, 35778335⟩, ⟨(-26116), (-26114)⟩, ⟨(-13048), (-13045)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨548444, 548445⟩, ⟨1096488, 1096490⟩, ⟨547442, 547446⟩, ⟨(-802), (-798)⟩, ⟨(-201), (-197)⟩⟩
...
def j33 : Jet := ⟨⟨(-715279439), (-715279437)⟩, ⟨1096488, 1096490⟩, ⟨547442, 547446⟩, ⟨(-802), (-798)⟩, ⟨(-201), (-197)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10964489), (-10964487)⟩, ⟨(-21912169), (-21912166)⟩, ⟨(-10922482), (-10922478)⟩, ⟨33578, 33581⟩, ⟨8362, 8365⟩⟩
...
def j36 : Jet := ⟨⟨4284002807, 4284002809⟩, ⟨(-21912169), (-21912166)⟩, ⟨(-10922482), (-10922478)⟩, ⟨33578, 33581⟩, ⟨8362, 8365⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨176981975, 176981978⟩, ⟨176439147, 176439151⟩, ⟨(-813648), (-813646)⟩, ⟨(-270227), (-270224)⟩, ⟨740, 744⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305959845, 4305959848⟩, ⟨22024473, 22024478⟩, ⟨11091111, 11091119⟩, ⟨79129, 79136⟩, ⟨20099, 20107⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨177434943, 177434947⟩, ⟨177798283, 177798289⟩, ⟨546073, 546078⟩, ⟨183795, 183803⟩, ⟨1331, 1340⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-169264662), (-169264661)⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4125702634, 4125702635⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7330244, 7330245⟩, ⟨14690508, 14690510⟩, ⟨7405413, 7405417⟩, ⟨60394, 60400⟩, ⟨15393, 15400⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302297540, 4302297541⟩, ⟨14690508, 14690510⟩, ⟨7405413, 7405417⟩, ⟨60394, 60400⟩, ⟨15393, 15400⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298630855, 4298630857⟩, ⟨7338993, 7338995⟩, ⟨3693285, 3693289⟩, ⟨23865, 23870⟩, ⟨6062, 6068⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4129221812, 4129221816⟩, ⟨(-162359280), (-162359275)⟩, ⟨3258502, 3258508⟩, ⟨(-122629), (-122622)⟩, ⟨4882, 4889⟩⟩
...
def j47 : Jet := ⟨⟨1214305752, 1214305760⟩, ⟨1214305752, 1214305760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨343317738, 343317744⟩, ⟨686635476, 686635488⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨343317738, 343317744⟩, ⟨686635476, 686635488⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-343317744), (-343317738)⟩, ⟨(-686635488), (-686635476)⟩, ⟨(-343317744), (-343317738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-171658872), (-171658869)⟩, ⟨(-343317744), (-343317738)⟩, ⟨(-171658872), (-171658869)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4126693559, 4126693563⟩, ⟨(-329866802), (-329866795)⟩, ⟨(-151749469), (-151749464)⟩, ⟨12832647, 12832649⟩, ⟨2776074, 2776076⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3967441864, 3967441872⟩, ⟨(-473135197), (-473135183)⟩, ⟨(-130292831), (-130292818)⟩, ⟨17705803, 17705817⟩, ⟨2082817, 2082832⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 338529323⟩, ⟨169264661, 169264662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1063521235⟩, ⟨531760615, 531760619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 263349484⟩, ⟨0, 263349484⟩, ⟨65837370, 65837372⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5806), 0⟩, ⟨(-5806), 5⟩, ⟨(-1452), (-1443)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107250, 5113057⟩, ⟨(-5806), 5⟩, ⟨(-1452), (-1443)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 313512⟩, ⟨(-356), 313513⟩, ⟨77842, 78379⟩, ⟨(-179), 2⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142852064)⟩, ⟨(-356), 313513⟩, ⟨77842, 78379⟩, ⟨(-179), 2⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8778317), 0⟩, ⟨(-8778339), 19224⟩, ⟨(-2194602), (-2165743)⟩, ⟨(-17), 9613⟩, ⟨1180, 1203⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422877448, 1431655766⟩, ⟨(-8778339), 19224⟩, ⟨(-2194602), (-2165743)⟩, ⟨(-17), 9613⟩, ⟨1180, 1203⟩⟩
...
def j72 : Jet := ⟨⟨0, 726⟩, ⟨(-1), 726⟩, ⟨179, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851450)⟩, ⟨(-1), 726⟩, ⟨179, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-52252), 0⟩, ⟨(-52253), 45⟩, ⟨(-13064), (-12994)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35739142, 35791395⟩, ⟨(-52253), 45⟩, ⟨(-13064), (-12994)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2194580⟩, ⟨(-3204), 2194583⟩, ⟨543837, 548648⟩, ⟨(-1604), 3⟩, ⟨(-202), (-196)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713633302)⟩, ⟨(-3204), 2194583⟩, ⟨543837, 548648⟩, ⟨(-1604), 3⟩, ⟨(-202), (-196)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-43891581), 0⟩, ⟨(-43891778), 134563⟩, ⟨(-10973093), (-10771050)⟩, ⟨(-149), 67283⟩, ⟨8224, 8412⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4251075715, 4294967296⟩, ⟨(-43891778), 134563⟩, ⟨(-10973093), (-10771050)⟩, ⟨(-149), 67283⟩, ⟨8224, 8412⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 354507079⟩, ⟨173992997, 177258301⟩, ⟨(-1630277), 2381⟩, ⟨(-271720), (-265760)⟩, ⟨(-3), 1489⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4339312050⟩, ⟨(-137357), 44802807⟩, ⟨10769646, 11663438⟩, ⟨(-69405), 236225⟩, ⟨17097, 24241⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 358167300⟩, ⟨173981659, 182786490⟩, ⟨(-1652779), 2814173⟩, ⟨139026, 235156⟩, ⟨(-10132), 13272⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-338529323), 0⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3956437973, 4294967296⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 29868404⟩, ⟨0, 30485982⟩, ⟨6772034, 8248444⟩, ⟨(-140680), 278756⟩, ⟨8489, 24074⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4324835700⟩, ⟨0, 30485982⟩, ⟨6772034, 8248444⟩, ⟨(-140680), 278756⟩, ⟨8489, 24074⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309875624⟩, ⟨0, 15242991⟩, ⟨3347348, 4124222⟩, ⟨(-84978), 139378⟩, ⟨1762, 11035⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3956437973, 4309875624⟩, ⟨(-169852200), (-154021670)⟩, ⟨2482783, 4124222⟩, ⟨(-247514), 7460⟩, ⟨(-3870), 14384⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2428611512⟩, ⟨1214305752, 1214305760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1373270964⟩, ⟨0, 1373270968⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1373270964⟩, ⟨0, 1373270968⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1373270964), 0⟩, ⟨(-1373270968), 0⟩, ⟨(-343317744), (-343317738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-686635482), 0⟩, ⟨(-686635484), 0⟩, ⟨(-171658872), (-171658869)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3660406327, 4294967296⟩, ⟨(-686635484), 0⟩, ⟨(-171658872), (-91410955)⟩, ⟨0, 27443067⟩, ⟨729901, 3430384⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3371893099, 4309875624⟩, ⟨(-858871076), (-131265701)⟩, ⟨(-170138757), (-52927486)⟩, ⟨2371232, 34334345⟩, ⟨(-582814), 3443406⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨169264661, 169264662⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298630855, 4298630857⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2026
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 338529323⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309875624⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2027
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (38668103 / 536870912)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(3941 / 50000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (3941 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(3941 / 50000), prawitzNormalCorrection
