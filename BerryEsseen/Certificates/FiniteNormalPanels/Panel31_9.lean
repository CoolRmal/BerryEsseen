...
namespace FiniteNormalPanel31_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (264047 / 800000)
def radius : Rat := (37721 / 800000)

def j0 : Jet := ⟨⟨1417591537, 1417591538⟩, ⟨202513076, 202513077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4453495158, 4453495162⟩, ⟨636213591, 636213595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4617874306, 4617874315⟩, ⟨1319392652, 1319392664⟩, ⟨94242331, 94242334⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1155, 1157⟩, ⟨330, 331⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93532), (-93529)⟩, ⟨330, 331⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-100564), (-100560)⟩, ⟨(-28379), (-28375)⟩, ⟨(-1928), (-1924)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5012492, 5012497⟩, ⟨(-28379), (-28375)⟩, ⟨(-1928), (-1924)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5389344, 5389350⟩, ⟨1509299, 1509307⟩, ⟨99195, 99203⟩, ⟨(-1201), (-1195)⟩, ⟨(-39), (-35)⟩⟩
...
def j16 : Jet := ⟨⟨(-137776233), (-137776226)⟩, ⟨1509299, 1509307⟩, ⟨99195, 99203⟩, ⟨(-1201), (-1195)⟩, ⟨(-39), (-35)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-148134616), (-148134607)⟩, ⟨(-40701404), (-40701392)⟩, ⟨(-2452855), (-2452841)⟩, ⟨62297, 62309⟩, ⟨1765, 1773⟩⟩
...
def j19 : Jet := ⟨⟨1283521149, 1283521159⟩, ⟨(-40701404), (-40701392)⟩, ⟨(-2452855), (-2452841)⟩, ⟨62297, 62309⟩, ⟨1765, 1773⟩⟩
...
def j22 : Jet := ⟨⟨(-117), (-115)⟩, ⟨(-34), (-32)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11718, 11721⟩, ⟨(-34), (-32)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨12598, 12603⟩, ⟨3562, 3567⟩, ⟨242, 247⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-839579), (-839573)⟩, ⟨3562, 3567⟩, ⟨242, 247⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-902701), (-902694)⟩, ⟨(-254086), (-254076)⟩, ⟨(-17069), (-17060)⟩, ⟨149, 155⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34888693, 34888701⟩, ⟨(-254086), (-254076)⟩, ⟨(-17069), (-17060)⟩, ⟨149, 155⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨37511717, 37511726⟩, ⟨10444444, 10444459⟩, ⟨669138, 669154⟩, ⟨(-10660), (-10648)⟩, ⟨(-328), (-319)⟩⟩
...
def j33 : Jet := ⟨⟨(-678316166), (-678316156)⟩, ⟨10444444, 10444459⟩, ⟨669138, 669154⟩, ⟨(-10660), (-10648)⟩, ⟨(-328), (-319)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-729313773), (-729313760)⟩, ⟨(-197145680), (-197145656)⟩, ⟨(-10956029), (-10956004)⟩, ⟨423270, 423291⟩, ⟨11054, 11070⟩⟩
...
def j36 : Jet := ⟨⟨3565653523, 3565653536⟩, ⟨(-197145680), (-197145656)⟩, ⟨(-10956029), (-10956004)⟩, ⟨423270, 423291⟩, ⟨11054, 11070⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1330896099, 1330896112⟩, ⟨147924314, 147924331⟩, ⟨(-8572491), (-8572473)⟩, ⟨(-298746), (-298730)⟩, ⟨11058, 11069⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5173453866, 5173453886⟩, ⟨286041238, 286041278⟩, ⟨31711484, 31711527⟩, ⟨2018077, 2018117⟩, ⟨158996, 159030⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1603115715, 1603115738⟩, ⟨266817114, 266817150⟩, ⟨9352283, 9352324⟩, ⟨786760, 786798⟩, ⟨48900, 48932⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1417591538), (-1417591537)⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2877375758, 2877375759⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨598370096, 598370114⟩, ⟨199181356, 199181388⟩, ⟨23557095, 23557132⟩, ⟨1749308, 1749346⟩, ⟨154620, 154653⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4893337392, 4893337410⟩, ⟨199181356, 199181388⟩, ⟨23557095, 23557132⟩, ⟨1749308, 1749346⟩, ⟨154620, 154653⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4584400077, 4584400086⟩, ⟨93303092, 93303108⟩, ⟨10085450, 10085469⟩, ⟨614170, 614190⟩, ⟨48834, 48852⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3071278717, 3071278725⟩, ⟨(-153652605), (-153652592)⟩, ⟨2357299, 2357315⟩, ⟨(-64086), (-64069)⟩, ⟨3755, 3770⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨22095287454, 22095287456⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value231

def j47 : Jet := ⟨⟨7292742957, 7292742964⟩, ⟨1041820418, 1041820425⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12382888197, 12382888221⟩, ⟨3537968040, 3537968070⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12382888197, 12382888221⟩, ⟨3537968040, 3537968070⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12382888221), (-12382888197)⟩, ⟨(-3537968070), (-3537968040)⟩, ⟨(-252712006), (-252712001)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6191444111), (-6191444098)⟩, ⟨(-1768984035), (-1768984020)⟩, ⟨(-126356003), (-126356000)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1016012872, 1016012883⟩, ⟨(-418468977), (-418468968)⟩, ⟨56287537, 56287542⟩, ⟨479659, 479661⟩, ⟨(-877368), (-877366)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨726538409, 726538420⟩, ⟨(-335589959), (-335589945)⟩, ⟨55778911, 55778922⟩, ⟨(-1915531), (-1915521)⟩, ⟨(-606533), (-606521)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1215078460, 1620104614⟩, ⟨202513076, 202513077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3817281563, 5089708754⟩, ⟨636213591, 636213595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3392723978, 6031509303⟩, ⟨1130907986, 1507877328⟩, ⟨94242331, 94242334⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨849, 1512⟩, ⟨283, 378⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93838), (-93174)⟩, ⟨283, 378⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-131779), (-73600)⟩, ⟨(-32722), (-24002)⟩, ⟨(-1968), (-1877)⟩, ⟨12, 18⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4981277, 5039457⟩, ⟨(-32722), (-24002)⟩, ⟨(-1968), (-1877)⟩, ⟨12, 18⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3934860, 7077012⟩, ⟨1265667, 1750294⟩, ⟨95048, 102778⟩, ⟨(-1401), (-994)⟩, ⟨(-41), (-32)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139230717), (-136088564)⟩, ⟨1265667, 1750294⟩, ⟨95048, 102778⟩, ⟨(-1401), (-994)⟩, ⟨(-41), (-32)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-195524508), (-107500453)⟩, ⟨(-47881339), (-33375510)⟩, ⟨(-2646728), (-2227295)⟩, ⟨50830, 73705⟩, ⟨1535, 1970⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1236131257, 1324155313⟩, ⟨(-47881339), (-33375510)⟩, ⟨(-2646728), (-2227295)⟩, ⟨50830, 73705⟩, ⟨1535, 1970⟩⟩
...
def j70 : Jet := ⟨⟨(-152), (-84)⟩, ⟨(-38), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11683, 11752⟩, ⟨(-38), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9228, 16504⟩, ⟨3022, 4104⟩, ⟨237, 250⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842949), (-835672)⟩, ⟨3022, 4104⟩, ⟨237, 250⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1183771), (-660122)⟩, ⟨(-293556), (-214276)⟩, ⟨(-17515), (-16543)⟩, ⟨123, 179⟩, ⟨1, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34607623, 35131273⟩, ⟨(-293556), (-214276)⟩, ⟨(-17515), (-16543)⟩, ⟨123, 179⟩, ⟨1, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨27337603, 49335557⟩, ⟨8700287, 12164627⟩, ⟨631718, 701381⟩, ⟨(-12495), (-8804)⟩, ⟨(-353), (-290)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-688490280), (-666492325)⟩, ⟨8700287, 12164627⟩, ⟨631718, 701381⟩, ⟨(-12495), (-8804)⟩, ⟨(-353), (-290)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-966860804), (-526482353)⟩, ⟨(-234842584), (-158411084)⟩, ⟨(-12317316), (-9368787)⟩, ⟨339696, 506210⟩, ⟨8978, 12844⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3328106492, 3768484943⟩, ⟨(-234842584), (-158411084)⟩, ⟨(-12317316), (-9368787)⟩, ⟨339696, 506210⟩, ⟨8978, 12844⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1098648891, 1569177231⟩, ⟨126366837, 166483666⟩, ⟨(-10229143), (-6923489)⟩, ⟨(-346884), (-242585)⟩, ⟨8893, 13253⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4895002727, 5542714489⟩, ⟨205765101, 391112905⟩, ⟨20818898, 48111844⟩, ⟨642149, 4342819⟩, ⟨7320, 450302⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1252137431, 2025044844⟩, ⟨196655655, 357743562⟩, ⟨(-1821361), 24847553⟩, ⟨(-602361), 2843428⟩, ⟨(-115275), 304781⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1620104614), (-1215078460)⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2674862682, 3079888836⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨365043093, 954793445⟩, ⟨114664390, 337346810⟩, ⟨7286845, 53228642⟩, ⟨(-871434), 6820598⟩, ⟨(-219588), 904834⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4660010389, 5249760741⟩, ⟨114664390, 337346810⟩, ⟨7286845, 53228642⟩, ⟨(-871434), 6820598⟩, ⟨(-219588), 904834⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4473767117, 4748426129⟩, ⟨51857161, 161932157⟩, ⟨534359, 25250098⟩, ⟨(-1332255), 3267809⟩, ⟨(-294945), 482527⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2786217422, 3405060765⟩, ⟨(-191598107), (-94823375)⟩, ⟨(-7302511), 15661527⟩, ⟨(-2145925), 2318127⟩, ⟨(-365585), 408835⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6250922533, 8334563383⟩, ⟨1041820418, 1041820425⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9097632140, 16173568272⟩, ⟨3032544034, 4043392078⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9097632140, 16173568272⟩, ⟨3032544034, 4043392078⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16173568272), (-9097632140)⟩, ⟨(-4043392078), (-3032544034)⟩, ⟨(-252712006), (-252712001)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8086784136), (-4548816070)⟩, ⟨(-2021696039), (-1516272017)⟩, ⟨(-126356003), (-126356000)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨653503612, 1489350581⟩, ⟨(-701056368), (-230709379)⟩, ⟨(-3091829), 145772319⟩, ⟨(-18347388), 14234964⟩, ⟨(-3819423), 2204568⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨423938769, 1180760849⟩, ⟨(-622239031), (-164092962)⟩, ⟨110076, 152273613⟩, ⟨(-24349272), 13419261⟩, ⟨(-4416075), 3589865⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1417591537, 1417591538⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4584400077, 4584400086⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar231 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified614
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar231 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1215078460, 1620104614⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4473767117, 4748426129⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified615
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((113163 / 400000) : ℝ)..(37721 / 100000), prawitzNormalCorrection
      ((257223 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
