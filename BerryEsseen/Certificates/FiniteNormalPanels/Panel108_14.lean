...
namespace FiniteNormalPanel108_14
...
def j2 : Jet := ⟨⟨1516145180, 1516145185⟩, ⟨505381726, 505381731⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨535206917, 535206921⟩, ⟨356804610, 356804616⟩, ⟨59467435, 59467437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨133, 135⟩, ⟨89, 90⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94554), (-94551)⟩, ⟨89, 90⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11783), (-11782)⟩, ⟨(-7845), (-7842)⟩, ⟨(-1302), (-1299)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101273, 5101275⟩, ⟨(-7845), (-7842)⟩, ⟨(-1302), (-1299)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨635682, 635683⟩, ⟨422810, 422812⟩, ⟨69816, 69820⟩, ⟨(-218), (-214)⟩, ⟨(-19), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-142529895), (-142529893)⟩, ⟨422810, 422812⟩, ⟨69816, 69820⟩, ⟨(-218), (-214)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17761017), (-17761016)⟩, ⟨(-11787991), (-11787989)⟩, ⟨(-1929624), (-1929619)⟩, ⟨11625, 11630⟩, ⟨944, 949⟩⟩
...
def j19 : Jet := ⟨⟨1413894748, 1413894750⟩, ⟨(-11787991), (-11787989)⟩, ⟨(-1929624), (-1929619)⟩, ⟨11625, 11630⟩, ⟨944, 949⟩⟩
...
def j22 : Jet := ⟨⟨(-14), (-13)⟩, ⟨(-9), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11821, 11823⟩, ⟨(-9), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1473, 1474⟩, ⟨980, 983⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850704), (-850702)⟩, ⟨980, 983⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-106009), (-106008)⟩, ⟨(-70551), (-70549)⟩, ⟨(-11678), (-11675)⟩, ⟨25, 28⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35685385, 35685387⟩, ⟨(-70551), (-70549)⟩, ⟨(-11678), (-11675)⟩, ⟨25, 28⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4446847, 4446848⟩, ⟨2955773, 2955775⟩, ⟨486776, 486781⟩, ⟨(-1945), (-1941)⟩, ⟨(-160), (-157)⟩⟩
...
def j33 : Jet := ⟨⟨(-711381036), (-711381034)⟩, ⟨2955773, 2955775⟩, ⟨486776, 486781⟩, ⟨(-1945), (-1941)⟩, ⟨(-160), (-157)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-88647021), (-88647019)⟩, ⟨(-58729688), (-58729685)⟩, ⟨(-9543462), (-9543456)⟩, ⟨81120, 81125⟩, ⟨6557, 6560⟩⟩
...
def j36 : Jet := ⟨⟨4206320275, 4206320277⟩, ⟨(-58729688), (-58729685)⟩, ⟨(-9543462), (-9543456)⟩, ⟨81120, 81125⟩, ⟨6557, 6560⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨499111997, 499112001⟩, ⟨162209444, 162209449⟩, ⟨(-2068242), (-2068238)⟩, ⟨(-222953), (-222949)⟩, ⟨1700, 1705⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4385482526, 4385482529⟩, ⟨61231192, 61231197⟩, ⟨10804869, 10804878⟩, ⟨205202, 205211⟩, ⟨19356, 19365⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨509630642, 509630647⟩, ⟨172743551, 172743558⟩, ⟨1456326, 1456334⟩, ⟨174779, 174788⟩, ⟨3350, 3362⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-482604001), (-482604000)⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3812363295, 3812363296⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨60471564, 60471566⟩, ⟨40994680, 40994684⟩, ⟨7293352, 7293357⟩, ⟨158622, 158628⟩, ⟨15345, 15352⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4355438860, 4355438862⟩, ⟨40994680, 40994684⟩, ⟨7293352, 7293357⟩, ⟨158622, 158628⟩, ⟨15345, 15352⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4325097393, 4325097395⟩, ⟨20354548, 20354551⟩, ⟨3573376, 3573379⟩, ⟨61941, 61946⟩, ⟨5850, 5856⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3839107823, 3839107827⟩, ⟨(-143929115), (-143929110)⟩, ⟨2409473, 2409478⟩, ⟨(-78861), (-78854)⟩, ⟨2871, 2878⟩⟩
...
def j47 : Jet := ⟨⟨3805417449, 3805417458⟩, ⟨1268472483, 1268472492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3371667573, 3371667590⟩, ⟨2247778382, 2247778404⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3371667573, 3371667590⟩, ⟨2247778382, 2247778404⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3371667590), (-3371667573)⟩, ⟨(-2247778404), (-2247778382)⟩, ⟨(-374629736), (-374629730)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1685833795), (-1685833786)⟩, ⟨(-1123889202), (-1123889191)⟩, ⟨(-187314868), (-187314865)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2900636433, 2900636444⟩, ⟨(-759026497), (-759026485)⟩, ⟨(-27194970), (-27194963)⟩, ⟨24440854, 24440856⟩, ⟨(-1005874), (-1005873)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2592768525, 2592768538⟩, ⟨(-775668445), (-775668428)⟩, ⟨2754522, 2754536⟩, ⟨22279007, 22279019⟩, ⟨(-1717538), (-1717526)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨321736000, 643472001⟩, ⟨160868000, 160868001⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1010763453, 2021526912⟩, ⟨505381726, 505381731⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨237869740, 951478970⟩, ⟨237869740, 475739488⟩, ⟨59467435, 59467437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨59, 239⟩, ⟨59, 120⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94628), (-94447)⟩, ⟨59, 120⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-20964), (-5230)⟩, ⟨(-10479), (-5203)⟩, ⟨(-1308), (-1289)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092092, 5107827⟩, ⟨(-10479), (-5203)⟩, ⟨(-1308), (-1289)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨282017, 1131555⟩, ⟨279695, 565490⟩, ⟨69053, 70364⟩, ⟨(-291), (-142)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142883560), (-142034021)⟩, ⟨279695, 565490⟩, ⟨69053, 70364⟩, ⟨(-291), (-142)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-31653490), (-7866321)⟩, ⟨(-15811255), (-7741046)⟩, ⟨(-1959030), (-1888354)⟩, ⟨7631, 15617⟩, ⟨918, 968⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1400002275, 1423789445⟩, ⟨(-15811255), (-7741046)⟩, ⟨(-1959030), (-1888354)⟩, ⟨7631, 15617⟩, ⟨918, 968⟩⟩
...
def j70 : Jet := ⟨⟨(-24), (-5)⟩, ⟨(-12), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11811, 11831⟩, ⟨(-12), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨654, 2621⟩, ⟨651, 1311⟩, ⟨160, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851523), (-849555)⟩, ⟨651, 1311⟩, ⟨160, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-188641), (-47051)⟩, ⟨(-94285), (-46760)⟩, ⟨(-11747), (-11579)⟩, ⟨16, 38⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35602753, 35744344⟩, ⟨(-94285), (-46760)⟩, ⟨(-11747), (-11579)⟩, ⟨16, 38⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1971800, 7918569⟩, ⟨1950912, 3956696⟩, ⟨479903, 491681⟩, ⟨(-2608), (-1279)⟩, ⟨(-163), (-154)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713856083), (-707909313)⟩, ⟨1950912, 3956696⟩, ⟨479903, 491681⟩, ⟨(-2608), (-1279)⟩, ⟨(-163), (-154)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-158143009), (-39206399)⟩, ⟨(-78963457), (-38329858)⟩, ⟨(-9749313), (-9254404)⟩, ⟨53012, 109176⟩, ⟨6318, 6730⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4136824287, 4255760897⟩, ⟨(-78963457), (-38329858)⟩, ⟨(-9749313), (-9254404)⟩, ⟨53012, 109176⟩, ⟨6318, 6730⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨329471922, 670139837⟩, ⟨157294023, 165713209⟩, ⟨(-2782549), (-1355275)⟩, ⟨(-228721), (-214848)⟩, ⟨1113, 2294⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4334534885, 4459155815⟩, ⟨39039341, 85116103⟩, ⟨9777312, 12133649⟩, ⟨58558, 376657⟩, ⟨12551, 28667⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨332507197, 695758023⟩, ⟨161737854, 185328703⟩, ⟨(-709161), 3809488⟩, ⟨69956, 297779⟩, ⟨(-8165), 16351⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-643472001), (-321736000)⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3651495295, 3973231296⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨25741997, 112708478⟩, ⟨25042798, 60044198⟩, ⟨5860887, 9231199⟩, ⟨(-50372), 425240⟩, ⟨1992, 34377⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4320709293, 4407675774⟩, ⟨25042798, 60044198⟩, ⟨5860887, 9231199⟩, ⟨(-50372), 425240⟩, ⟨1992, 34377⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307819066, 4350956597⟩, ⟨12360270, 29932533⟩, ⟨2789772, 4584098⟩, ⟨(-56964), 203982⟩, ⟨(-2864), 16630⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3662421612, 4025026439⟩, ⟨(-152456627), (-133659076)⟩, ⟨1250684, 3777751⟩, ⟨(-224395), 84212⟩, ⟨(-10291), 17519⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2536944966, 5073889942⟩, ⟨1268472483, 1268472492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1498518921, 5994075710⟩, ⟨1498518920, 2997037872⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1498518921, 5994075710⟩, ⟨1498518920, 2997037872⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5994075710), (-1498518921)⟩, ⟨(-2997037872), (-1498518920)⟩, ⟨(-374629736), (-374629730)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2997037855), (-749259460)⟩, ⟨(-1498518936), (-749259460)⟩, ⟨(-187314868), (-187314865)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2137510181, 3607421961⟩, ⟨(-1258633593), (-372889853)⟩, ⟨(-124803778), 126346878⟩, ⟨(-3852383), 51109617⟩, ⟨(-7213212), 3057537⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1822706191, 3380693675⟩, ⟨(-1307578961), (-384491284)⟩, ⟨(-104733056), 166256099⟩, ⟨(-9390680), 52289607⟩, ⟨(-8717173), 3193723⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4325097393, 4325097395⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2184
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307819066, 4350956597⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2185
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (194340921 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((7491 / 100000) : ℝ)..(7491 / 50000), prawitzNormalCorrection
