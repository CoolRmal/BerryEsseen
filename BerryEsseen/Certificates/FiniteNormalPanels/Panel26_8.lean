...
namespace FiniteNormalPanel26_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (35983 / 160000)
def radius : Rat := (35983 / 800000)

def j0 : Jet := ⟨⟨965911301, 965911302⟩, ⟨193182260, 193182261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3034499847, 3034499851⟩, ⟨606899968, 606899972⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2143948646, 2143948653⟩, ⟨857579456, 857579464⟩, ⟨85757945, 85757947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨536, 538⟩, ⟨214, 215⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94151), (-94148)⟩, ⟨214, 215⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-46999), (-46996)⟩, ⟨(-18694), (-18690)⟩, ⟨(-1828), (-1825)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5066057, 5066061⟩, ⟨(-18694), (-18690)⟩, ⟨(-1828), (-1825)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2528858, 2528861⟩, ⟨1002211, 1002216⟩, ⟨96508, 96514⟩, ⟨(-736), (-732)⟩, ⟨(-36), (-33)⟩⟩
...
def j16 : Jet := ⟨⟨(-140636719), (-140636715)⟩, ⟨1002211, 1002216⟩, ⟨96508, 96514⟩, ⟨(-736), (-732)⟩, ⟨(-36), (-33)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-70202608), (-70202605)⟩, ⟨(-27580764), (-27580758)⟩, ⟨(-2559819), (-2559812)⟩, ⟨38912, 38919⟩, ⟨1761, 1766⟩⟩
...
def j19 : Jet := ⟨⟨1361453157, 1361453161⟩, ⟨(-27580764), (-27580758)⟩, ⟨(-2559819), (-2559812)⟩, ⟨38912, 38919⟩, ⟨1761, 1766⟩⟩
...
def j25 : Jet := ⟨⟨5880, 5882⟩, ⟨2341, 2343⟩, ⟨228, 232⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846297), (-846294)⟩, ⟨2341, 2343⟩, ⟨228, 232⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-422452), (-422450)⟩, ⟨(-167813), (-167810)⟩, ⟨(-16319), (-16314)⟩, ⟨90, 94⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35368942, 35368945⟩, ⟨(-167813), (-167810)⟩, ⟨(-16319), (-16314)⟩, ⟨90, 94⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17655360, 17655362⟩, ⟨6978375, 6978379⟩, ⟨664559, 664566⟩, ⟨(-6566), (-6560)⟩, ⟨(-309), (-303)⟩⟩
...
def j33 : Jet := ⟨⟨(-698172523), (-698172520)⟩, ⟨6978375, 6978379⟩, ⟨664559, 664566⟩, ⟨(-6566), (-6560)⟩, ⟨(-309), (-303)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-348511628), (-348511624)⟩, ⟨(-135921209), (-135921203)⟩, ⟨(-12215357), (-12215348)⟩, ⟨268752, 268759⟩, ⟨11802, 11810⟩⟩
...
def j36 : Jet := ⟨⟨3946455668, 3946455672⟩, ⟨(-135921209), (-135921203)⟩, ⟨(-12215357), (-12215348)⟩, ⟨268752, 268759⟩, ⟨11802, 11810⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨961900082, 961900087⟩, ⟨172893529, 172893536⟩, ⟨(-5705873), (-5705866)⟩, ⟨(-334223), (-334216)⟩, ⟨6742, 6748⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4674255992, 4674255998⟩, ⟨160987617, 160987627⟩, ⟨20012714, 20012728⟩, ⟨869239, 869253⟩, ⟨66929, 66944⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1046845508, 1046845516⟩, ⟨224216517, 224216530⟩, ⟨4752826, 4752839⟩, ⟨422672, 422687⟩, ⟨18202, 18216⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-965911302), (-965911301)⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3329055994, 3329055995⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨255155730, 255155735⟩, ⟨109300042, 109300050⟩, ⟨14021989, 14022002⟩, ⟨702278, 702290⟩, ⟨58261, 58274⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4550123026, 4550123031⟩, ⟨109300042, 109300050⟩, ⟨14021989, 14022002⟩, ⟨702278, 702290⟩, ⟨58261, 58274⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4420704648, 4420704651⟩, ⟨53095619, 53095624⟩, ⟨6492724, 6492732⟩, ⟨263168, 263177⟩, ⟨20372, 20380⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3426515801, 3426515805⟩, ⟨(-157683025), (-157683017)⟩, ⟨2644375, 2644384⟩, ⟨(-88052), (-88043)⟩, ⟨3952, 3961⟩⟩
...
def j47 : Jet := ⟨⟨5632731069, 5632731076⟩, ⟨1126546212, 1126546219⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7387171335, 7387171354⟩, ⟨2954868528, 2954868552⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7387171335, 7387171354⟩, ⟨2954868528, 2954868552⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7387171354), (-7387171335)⟩, ⟨(-2954868552), (-2954868528)⟩, ⟨(-295486857), (-295486852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3693585677), (-3693585667)⟩, ⟨(-1477434276), (-1477434264)⟩, ⟨(-147743429), (-147743426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1817503775, 1817503788⟩, ⟨(-625206715), (-625206705)⟩, ⟨45012370, 45012376⟩, ⟨9176440, 9176442⟩, ⟨(-1563351), (-1563349)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1450000657, 1450000670⟩, ⟨(-565515410), (-565515395)⟩, ⟨59983281, 59983295⟩, ⟨5246186, 5246197⟩, ⟨(-1541937), (-1541925)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨772729041, 1159093562⟩, ⟨193182260, 193182261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2427599878, 3641399820⟩, ⟨606899968, 606899972⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1372127134, 3087286058⟩, ⟨686063564, 1029095356⟩, ⟨85757945, 85757947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨343, 774⟩, ⟨171, 258⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94344), (-93912)⟩, ⟨171, 258⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-67816), (-30002)⟩, ⟨(-22552), (-14815)⟩, ⟨(-1851), (-1797)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5045240, 5083055⟩, ⟨(-22552), (-14815)⟩, ⟨(-1851), (-1797)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1611819, 3653776⟩, ⟨789698, 1213194⟩, ⟨94003, 98554⟩, ⟨(-894), (-573)⟩, ⟨(-37), (-31)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141553758), (-139511800)⟩, ⟨789698, 1213194⟩, ⟨94003, 98554⟩, ⟨(-894), (-573)⟩, ⟨(-37), (-31)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-101750937), (-44570287)⟩, ⟨(-33664692), (-21413081)⟩, ⟨(-2670241), (-2424111)⟩, ⟨30139, 47656⟩, ⟨1634, 1868⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1329904828, 1387085479⟩, ⟨(-33664692), (-21413081)⟩, ⟨(-2670241), (-2424111)⟩, ⟨30139, 47656⟩, ⟨1634, 1868⟩⟩
...
def j72 : Jet := ⟨⟨3756, 8484⟩, ⟨1859, 2823⟩, ⟨224, 234⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848421), (-843692)⟩, ⟨1859, 2823⟩, ⟨224, 234⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-609858), (-269537)⟩, ⟨(-202693), (-132738)⟩, ⟨(-16574), (-16000)⟩, ⟨70, 114⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35181536, 35521858⟩, ⟨(-202693), (-132738)⟩, ⟨(-16574), (-16000)⟩, ⟨70, 114⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11239559, 25533638⟩, ⟨5474080, 8468807⟩, ⟨641991, 682954⟩, ⟨(-7998), (-5123)⟩, ⟨(-320), (-287)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704588324), (-690294244)⟩, ⟨5474080, 8468807⟩, ⟨641991, 682954⟩, ⟨(-7998), (-5123)⟩, ⟨(-320), (-287)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-506468516), (-220530541)⟩, ⟨(-167074017), (-104177766)⟩, ⟨(-12989062), (-11263072)⟩, ⟨206100, 331102⟩, ⟨10670, 12728⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3788498780, 4074436755⟩, ⟨(-167074017), (-104177766)⟩, ⟨(-12989062), (-11263072)⟩, ⟨206100, 331102⟩, ⟨10670, 12728⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨751688330, 1176011939⟩, ⟨159380164, 183898898⟩, ⟨(-7020896), (-4395928)⟩, ⟨(-360284), (-302133)⟩, ⟨5181, 8319⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4527434141, 4869143465⟩, ⟨115760287, 214730797⟩, ⟨15475135, 26163807⟩, ⟨319993, 1643750⟩, ⟨18297, 143148⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨792373765, 1333228045⟩, ⟨188266590, 267279358⟩, ⟨(-955394), 11724289⟩, ⟨(-129203), 1133375⟩, ⟨(-40246), 95028⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1159093562), (-772729041)⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3135873734, 3522238255⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨146184159, 413855776⟩, ⟨69466188, 165935764⟩, ⟨7659381, 23911837⟩, ⟨(-199124), 2162864⟩, ⟨(-43679), 232065⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4441151455, 4708823072⟩, ⟨69466188, 165935764⟩, ⟨7659381, 23911837⟩, ⟨(-199124), 2162864⟩, ⟨(-43679), 232065⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4367447796, 4497136989⟩, ⟨33171660, 81590979⟩, ⟨2917378, 11631531⟩, ⟨(-315206), 1041327⟩, ⟨(-56420), 119022⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3188793740, 3688034588⟩, ⟨(-178056061), (-129530803)⟩, ⟨(-1539804), 8046826⟩, ⟨(-781668), 722757⟩, ⟨(-93108), 111787⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4506184856, 6759277289⟩, ⟨1126546212, 1126546219⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4727789656, 10637526743⟩, ⟨2363894822, 3545842262⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4727789656, 10637526743⟩, ⟨2363894822, 3545842262⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10637526743), (-4727789656)⟩, ⟨(-3545842262), (-2363894822)⟩, ⟨(-295486857), (-295486852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5318763372), (-2363894828)⟩, ⟨(-1772921131), (-1181947411)⟩, ⟨(-147743429), (-147743426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1244921950, 2477021398⟩, ⟨(-1022490575), (-342594523)⟩, ⟨(-38067643), 168212816⟩, ⟨(-15288893), 28686556⟩, ⟨(-5853577), 2232526⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨924290931, 2126987230⟩, ⟨(-980689489), (-291904203)⟩, ⟨(-23244035), 191472352⟩, ⟨(-22468459), 26994365⟩, ⟨(-6512735), 3116590⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨965911301, 965911302⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4420704648, 4420704651⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified516
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨772729041, 1159093562⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4367447796, 4497136989⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified517
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (132293157 / 4294967296)

theorem envelope_integral : (∫ s in ((35983 / 200000) : ℝ)..(107949 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((35983 / 200000) : ℝ)..(107949 / 400000), prawitzNormalCorrection
