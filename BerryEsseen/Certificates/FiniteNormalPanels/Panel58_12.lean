...
namespace FiniteNormalPanel58_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (46921 / 160000)
def radius : Rat := (6703 / 160000)

def j0 : Jet := ⟨⟨1259526003, 1259526004⟩, ⟨179932286, 179932287⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3956917637, 3956917642⟩, ⟨565273947, 565273952⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3645475298, 3645475308⟩, ⟨1041564368, 1041564380⟩, ⟨74397454, 74397457⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨912, 914⟩, ⟨260, 261⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93775), (-93772)⟩, ⟨260, 261⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-79595), (-79591)⟩, ⟨(-22522), (-22518)⟩, ⟨(-1547), (-1543)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5033461, 5033466⟩, ⟨(-22522), (-22518)⟩, ⟨(-1547), (-1543)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4272292, 4272298⟩, ⟨1201538, 1201545⟩, ⟨80413, 80421⟩, ⟨(-761), (-755)⟩, ⟨(-26), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-138893285), (-138893278)⟩, ⟨1201538, 1201545⟩, ⟨80413, 80421⟩, ⟨(-761), (-755)⟩, ⟨(-26), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-117889615), (-117889608)⟩, ⟨(-32662909), (-32662899)⟩, ⟨(-2046277), (-2046265)⟩, ⟨39667, 39677⟩, ⟨1184, 1193⟩⟩
...
def j19 : Jet := ⟨⟨1313766150, 1313766158⟩, ⟨(-32662909), (-32662899)⟩, ⟨(-2046277), (-2046265)⟩, ⟨39667, 39677⟩, ⟨1184, 1193⟩⟩
...
def j25 : Jet := ⟨⟨9967, 9970⟩, ⟨2824, 2828⟩, ⟨194, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842210), (-842206)⟩, ⟨2824, 2828⟩, ⟨194, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-714850), (-714846)⟩, ⟨(-201847), (-201840)⟩, ⟨(-13741), (-13733)⟩, ⟨93, 98⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35076544, 35076549⟩, ⟨(-201847), (-201840)⟩, ⟨(-13741), (-13733)⟩, ⟨93, 98⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29772211, 29772216⟩, ⟨8335022, 8335031⟩, ⟨546982, 546994⟩, ⟨(-6752), (-6742)⟩, ⟨(-217), (-209)⟩⟩
...
def j33 : Jet := ⟨⟨(-686055672), (-686055666)⟩, ⟨8335022, 8335031⟩, ⟨546982, 546994⟩, ⟨(-6752), (-6742)⟩, ⟨(-217), (-209)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-582309210), (-582309203)⟩, ⟨(-159299475), (-159299463)⟩, ⟨(-9398286), (-9398271)⟩, ⟨271295, 271309⟩, ⟨7651, 7665⟩⟩
...
def j36 : Jet := ⟨⟨3712658086, 3712658093⟩, ⟨(-159299475), (-159299463)⟩, ⟨(-9398286), (-9398271)⟩, ⟨271295, 271309⟩, ⟨7651, 7665⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1210361823, 1210361833⟩, ⟨142816764, 142816778⟩, ⟨(-6184085), (-6184071)⟩, ⟨(-232773), (-232760)⟩, ⟨6310, 6323⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4968608369, 4968608379⟩, ⟨213188670, 213188689⟩, ⟨21724910, 21724935⟩, ⟨1108729, 1108755⟩, ⟨76727, 76752⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1400200157, 1400200172⟩, ⟨225295311, 225295335⟩, ⟨6057233, 6057260⟩, ⟨458607, 458635⟩, ⟨22952, 22981⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1259526004), (-1259526003)⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3035441292, 3035441293⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨456478558, 456478569⟩, ⟨146896824, 146896844⟩, ⟨15767442, 15767466⟩, ⟨934492, 934516⟩, ⟨71618, 71647⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4751445854, 4751445865⟩, ⟨146896824, 146896844⟩, ⟨15767442, 15767466⟩, ⟨934492, 934516⟩, ⟨71618, 71647⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4517444471, 4517444477⟩, ⟨69831190, 69831201⟩, ⟨6955730, 6955743⟩, ⟨336711, 336724⟩, ⟨23484, 23501⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3192675644, 3192675651⟩, ⟨(-139899934), (-139899924)⟩, ⟨1990427, 1990438⟩, ⟨(-53435), (-53423)⟩, ⟨2490, 2504⟩⟩
...
def j47 : Jet := ⟨⟨8221553775, 8221553784⟩, ⟨1174507681, 1174507689⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15737942064, 15737942100⟩, ⟨4496554870, 4496554908⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15737942064, 15737942100⟩, ⟨4496554870, 4496554908⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15737942100), (-15737942064)⟩, ⟨(-4496554908), (-4496554870)⟩, ⟨(-321182495), (-321182490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7868971050), (-7868971032)⟩, ⟨(-2248277454), (-2248277435)⟩, ⟨(-160591248), (-160591245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨687499857, 687499865⟩, ⟨(-359884102), (-359884094)⟩, ⟨68487874, 68487879⟩, ⟨(-2979557), (-2979554)⟩, ⟨(-890476), (-890474)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨511054892, 511054900⟩, ⟨(-289914757), (-289914747)⟩, ⟨62951756, 62951766⟩, ⟨(-4621055), (-4621045)⟩, ⟨(-528273), (-528263)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1079593716, 1439458290⟩, ⟨179932286, 179932287⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3391643686, 4522191590⟩, ⟨565273947, 565273952⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2678308378, 4761437135⟩, ⟨892769458, 1190359292⟩, ⟨74397454, 74397457⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨670, 1193⟩, ⟨223, 299⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94017), (-93493)⟩, ⟨223, 299⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-104229), (-58301)⟩, ⟨(-25919), (-19101)⟩, ⟨(-1572), (-1514)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5008827, 5054756⟩, ⟨(-25919), (-19101)⟩, ⟨(-1572), (-1514)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3123465, 5603746⟩, ⟨1012420, 1389026⟩, ⟨77835, 82645⟩, ⟨(-882), (-630)⟩, ⟨(-27), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140042112), (-137561830)⟩, ⟨1012420, 1389026⟩, ⟨77835, 82645⟩, ⟨(-882), (-630)⟩, ⟨(-27), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-155251872), (-85782492)⟩, ⟨(-38181632), (-27054278)⟩, ⟨(-2166829), (-1906253)⟩, ⟨32738, 46575⟩, ⟨1073, 1290⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1276403893, 1345873274⟩, ⟨(-38181632), (-27054278)⟩, ⟨(-2166829), (-1906253)⟩, ⟨32738, 46575⟩, ⟨1073, 1290⟩⟩
...
def j72 : Jet := ⟨⟨7305, 13049⟩, ⟨2401, 3250⟩, ⟨190, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844872), (-839127)⟩, ⟨2401, 3250⟩, ⟨190, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-936633), (-523273)⟩, ⟨(-232662), (-170821)⟩, ⟨(-14018), (-13412)⟩, ⟨77, 113⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34854761, 35268122⟩, ⟨(-232662), (-170821)⟩, ⟨(-14018), (-13412)⟩, ⟨77, 113⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21735159, 39098539⟩, ⟨6987121, 9668113⟩, ⟨523730, 567045⟩, ⟨(-7869), (-5619)⟩, ⟨(-227), (-195)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694092724), (-676729343)⟩, ⟨6987121, 9668113⟩, ⟨523730, 567045⟩, ⟨(-7869), (-5619)⟩, ⟨(-227), (-195)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-769477075), (-422003182)⟩, ⟨(-188012157), (-129949575)⟩, ⟨(-10244116), (-8414140)⟩, ⟨221170, 321127⟩, ⟨6639, 8535⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3525490221, 3872964114⟩, ⟨(-188012157), (-129949575)⟩, ⟨(-10244116), (-8414140)⟩, ⟨221170, 321127⟩, ⟨6639, 8535⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1007948816, 1417076402⟩, ⟨127789846, 155770369⟩, ⟨(-7306668), (-5066024)⟩, ⟨(-259332), (-201847)⟩, ⟨5155, 7489⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4762952490, 5232391219⟩, ⟨159811356, 279040106⟩, ⟨15709818, 30084940⟩, ⟨440461, 2116426⟩, ⟨14239, 181294⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1117776223, 1726368937⟩, ⟨179218740, 281835129⟩, ⟨(-459699), 14428425⟩, ⟨(-219856), 1377076⟩, ⟨(-45868), 119659⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1439458290), (-1079593716)⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2855509006, 3215373580⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨290904120, 693916741⟩, ⟨93284270, 226568158⟩, ⟨7108816, 30093039⟩, ⟨(-237076), 3000620⟩, ⟨(-67273), 325395⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4585871416, 4988884037⟩, ⟨93284270, 226568158⟩, ⟨7108816, 30093039⟩, ⟨(-237076), 3000620⟩, ⟨(-67273), 325395⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4438036475, 4628940893⟩, ⟨43276950, 109632136⟩, ⟨1999693, 14350460⟩, ⟨(-469215), 1432445⟩, ⟨(-91141), 168594⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2950628549, 3465398739⟩, ⟨(-165151014), (-103851261)⟩, ⟨(-3263407), 8930260⟩, ⟨(-952467), 988609⟩, ⟨(-128243), 145874⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7047046087, 9396061466⟩, ⟨1174507681, 1174507689⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11562569661, 20555679471⟩, ⟨3854189886, 5138919894⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11562569661, 20555679471⟩, ⟨3854189886, 5138919894⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20555679471), (-11562569661)⟩, ⟨(-5138919894), (-3854189886)⟩, ⟨(-321182495), (-321182490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10277839736), (-5781284830)⟩, ⟨(-2569459947), (-1927094943)⟩, ⟨(-160591248), (-160591245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨392369173, 1117823710⟩, ⟨(-668736932), (-176050851)⟩, ⟨(-2300217), 185364701⟩, ⟨(-32576324), 17128335⟩, ⟨(-6027198), 4915192⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨269556344, 901917200⟩, ⟨(-582553875), (-130433751)⟩, ⟨1551586, 177600338⟩, ⟨(-35050282), 14673884⟩, ⟨(-5849825), 5790146⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1259526003, 1259526004⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4517444471, 4517444477⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1148
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1079593716, 1439458290⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4438036475, 4628940893⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1149
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (1396101 / 134217728)

theorem envelope_integral : (∫ s in ((20109 / 80000) : ℝ)..(6703 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((20109 / 80000) : ℝ)..(6703 / 20000), prawitzNormalCorrection
