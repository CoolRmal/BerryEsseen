...
namespace FiniteNormalPanel17_19
...
def j2 : Jet := ⟨⟨672880922, 672880927⟩, ⟨672880922, 672880927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨105418436, 105418438⟩, ⟨210836872, 210836876⟩, ⟨105418436, 105418438⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨26, 27⟩, ⟨52, 53⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94661), (-94659)⟩, ⟨52, 53⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2324), (-2323)⟩, ⟨(-4646), (-4644)⟩, ⟨(-2322), (-2319)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110732, 5110734⟩, ⟨(-4646), (-4644)⟩, ⟨(-2322), (-2319)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨125441, 125442⟩, ⟨250767, 250770⟩, ⟨125155, 125159⟩, ⟨(-229), (-225)⟩, ⟨(-57), (-54)⟩⟩
...
def j16 : Jet := ⟨⟨(-143040136), (-143040134)⟩, ⟨250767, 250770⟩, ⟨125155, 125159⟩, ⟨(-229), (-225)⟩, ⟨(-57), (-54)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3510870), (-3510868)⟩, ⟨(-7015585), (-7015581)⟩, ⟨(-3495490), (-3495485)⟩, ⟨12291, 12295⟩, ⟨3057, 3060⟩⟩
...
def j19 : Jet := ⟨⟨1428144895, 1428144898⟩, ⟨(-7015585), (-7015581)⟩, ⟨(-3495490), (-3495485)⟩, ⟨12291, 12295⟩, ⟨3057, 3060⟩⟩
...
def j25 : Jet := ⟨⟨290, 291⟩, ⟨579, 581⟩, ⟨288, 291⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851887), (-851885)⟩, ⟨579, 581⟩, ⟨288, 291⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-20910), (-20909)⟩, ⟨(-41805), (-41803)⟩, ⟨(-20875), (-20872)⟩, ⟨27, 30⟩, ⟨5, 8⟩⟩
...
def j30 : Jet := ⟨⟨35770484, 35770486⟩, ⟨(-41805), (-41803)⟩, ⟨(-20875), (-20872)⟩, ⟨27, 30⟩, ⟨5, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨877973, 877974⟩, ⟨1754920, 1754922⟩, ⟨875407, 875410⟩, ⟨(-2052), (-2049)⟩, ⟨(-512), (-509)⟩⟩
...
def j33 : Jet := ⟨⟨(-714949910), (-714949908)⟩, ⟨1754920, 1754922⟩, ⟨875407, 875410⟩, ⟨(-2052), (-2049)⟩, ⟨(-512), (-509)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-17548191), (-17548189)⟩, ⟨(-35053308), (-35053305)⟩, ⟨(-17440558), (-17440554)⟩, ⟨85995, 85998⟩, ⟨21372, 21375⟩⟩
...
def j36 : Jet := ⟨⟨4277419105, 4277419107⟩, ⟨(-35053308), (-35053305)⟩, ⟨(-17440558), (-17440554)⟩, ⟨85995, 85998⟩, ⟨21372, 21375⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨223743602, 223743605⟩, ⟨222644489, 222644493⟩, ⟨(-1646742), (-1646740)⟩, ⟨(-545704), (-545701)⟩, ⟨2403, 2407⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4312587476, 4312587479⟩, ⟨35341507, 35341512⟩, ⟨17873570, 17873577⟩, ⟨203866, 203873⟩, ⟨52284, 52292⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨224661514, 224661518⟩, ⟨225398984, 225398991⟩, ⟨1109663, 1109668⟩, ⟨375664, 375671⟩, ⟨4359, 4369⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-214184651), (-214184650)⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4080782645, 4080782646⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨11751613, 11751614⟩, ⟨23580378, 23580380⟩, ⟨11944979, 11944983⟩, ⟨155768, 155774⟩, ⟨40170, 40177⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4306718909, 4306718910⟩, ⟨23580378, 23580380⟩, ⟨11944979, 11944983⟩, ⟨155768, 155774⟩, ⟨40170, 40177⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4300839088, 4300839090⟩, ⟨11774092, 11774094⟩, ⟨5948218, 5948221⟩, ⟨61492, 61497⟩, ⟨15775, 15781⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4086361618, 4086361621⟩, ⟨(-203290539), (-203290533)⟩, ⟨5064427, 5064432⟩, ⟨(-238206), (-238199)⟩, ⟨11921, 11929⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨19538651498, 19538651503⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value158

def j47 : Jet := ⟨⟨974368125, 974368131⟩, ⟨974368125, 974368131⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨221047839, 221047843⟩, ⟨442095678, 442095686⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨221047839, 221047843⟩, ⟨442095678, 442095686⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-221047843), (-221047839)⟩, ⟨(-442095686), (-442095678)⟩, ⟨(-221047843), (-221047839)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-110523922), (-110523919)⟩, ⟨(-221047843), (-221047839)⟩, ⟨(-110523922), (-110523919)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4185853329, 4185853333⟩, ⟨(-215432107), (-215432102)⟩, ⟨(-102172264), (-102172259)⟩, ⟨5448683, 5448685⟩, ⟨1244511, 1244512⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3982547293, 3982547301⟩, ⟨(-403094543), (-403094530)⟩, ⟨(-82077126), (-82077112)⟩, ⟨9533902, 9533915⟩, ⟨829254, 829268⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 428369301⟩, ⟨214184650, 214184651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1345761850⟩, ⟨672880922, 672880927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 421673748⟩, ⟨0, 421673750⟩, ⟨105418436, 105418438⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 106⟩, ⟨0, 106⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94580)⟩, ⟨0, 106⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-9297), 0⟩, ⟨(-9297), 11⟩, ⟨(-2325), (-2307)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5103759, 5113057⟩, ⟨(-9297), 11⟩, ⟨(-2325), (-2307)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 501993⟩, ⟨(-913), 501995⟩, ⟨124127, 125501⟩, ⟨(-458), 2⟩, ⟨(-58), (-54)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142663583)⟩, ⟨(-913), 501995⟩, ⟨124127, 125501⟩, ⟨(-458), 2⟩, ⟨(-58), (-54)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-14055792), 0⟩, ⟨(-14055882), 49286⟩, ⟨(-3514038), (-3440018)⟩, ⟨(-68), 24645⟩, ⟨2995, 3082⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1417599973, 1431655766⟩, ⟨(-14055882), 49286⟩, ⟨(-3514038), (-3440018)⟩, ⟨(-68), 24645⟩, ⟨2995, 3082⟩⟩
...
def j72 : Jet := ⟨⟨0, 1163⟩, ⟨(-2), 1163⟩, ⟨287, 291⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851013)⟩, ⟨(-2), 1163⟩, ⟨287, 291⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-83666), 0⟩, ⟨(-83667), 115⟩, ⟨(-20918), (-20743)⟩, ⟨(-2), 58⟩, ⟨5, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35707728, 35791395⟩, ⟨(-83667), 115⟩, ⟨(-20918), (-20743)⟩, ⟨(-2), 58⟩, ⟨5, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3513948⟩, ⟨(-8215), 3513961⟩, ⟨866164, 878500⟩, ⟨(-4109), 9⟩, ⟨(-515), (-502)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712313934)⟩, ⟨(-8215), 3513961⟩, ⟨866164, 878500⟩, ⟨(-4109), 9⟩, ⟨(-515), (-502)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-70278959), 0⟩, ⟨(-70279766), 344996⟩, ⟨(-17570547), (-17052244)⟩, ⟨(-606), 172500⟩, ⟨20804, 21564⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4224688337, 4294967296⟩, ⟨(-70279766), 344996⟩, ⟨(-17570547), (-17052244)⟩, ⟨(-606), 172500⟩, ⟨20804, 21564⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 448587284⟩, ⟨217687362, 224309087⟩, ⟨(-3303168), 7722⟩, ⟨(-550557), (-531215)⟩, ⟨(-11), 4828⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4366415367⟩, ⟨(-356571), 72637466⟩, ⟨17046409, 19368354⟩, ⟨(-181353), 624931⟩, ⟨39870, 69816⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 456049669⟩, ⟨217650119, 235627148⟩, ⟨(-3376741), 5824344⟩, ⟨229463, 545864⟩, ⟨(-33692), 44920⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-428369301), 0⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3866597995, 4294967296⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 48424421⟩, ⟨0, 50038884⟩, ⟨10312452, 14163679⟩, ⟨(-370506), 754986⟩, ⟨11520, 77333⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4343391717⟩, ⟨0, 50038884⟩, ⟨10312452, 14163679⟩, ⟨(-370506), 754986⟩, ⟨11520, 77333⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4319111643⟩, ⟨0, 25019442⟩, ⟨5054936, 7081840⟩, ⟨(-226507), 377493⟩, ⟨(-2279), 37012⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3866597995, 4319111643⟩, ⟨(-215388700), (-189165208)⟩, ⟨3303080, 7081840⟩, ⟨(-579670), 125410⟩, ⟨(-21105), 48308⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1948736256⟩, ⟨974368125, 974368131⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 884191365⟩, ⟨0, 884191368⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 884191365⟩, ⟨0, 884191368⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-884191365), 0⟩, ⟨(-884191368), 0⟩, ⟨(-221047843), (-221047839)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-442095683), 0⟩, ⟨(-442095684), 0⟩, ⟨(-110523922), (-110523919)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3874863818, 4294967296⟩, ⟨(-442095684), 0⟩, ⟨(-110523922), (-76960035)⟩, ⟨0, 11376606⟩, ⟨697461, 1422076⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3488394587, 4319111643⟩, ⟨(-659969645), (-170662398)⟩, ⟨(-108165243), (-40031696)⟩, ⟨2080957, 17108646⟩, ⟨(-158884), 1478861⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4300839088, 4300839090⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar158 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified350
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar158 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4319111643⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified351
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(7979 / 80000), prawitzNormalCorrection
      ((32831 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
