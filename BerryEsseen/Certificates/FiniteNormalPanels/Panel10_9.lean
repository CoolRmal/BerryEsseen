...
namespace FiniteNormalPanel10_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (84637 / 200000)
def radius : Rat := (12091 / 200000)

def j0 : Jet := ⟨⟨1817565735, 1817565736⟩, ⟨259652247, 259652248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5710051160, 5710051164⟩, ⟨815721591, 815721595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨7591369620, 7591369631⟩, ⟨2168962738, 2168962752⟩, ⟨154925909, 154925911⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1900, 1902⟩, ⟨542, 544⟩, ⟨38, 39⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-92787), (-92784)⟩, ⟨542, 544⟩, ⟨38, 39⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-164002), (-163996)⟩, ⟨(-45901), (-45894)⟩, ⟨(-3007), (-3002)⟩, ⟨38, 40⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨4949054, 4949061⟩, ⟨(-45901), (-45894)⟩, ⟨(-3007), (-3002)⟩, ⟨38, 40⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨8747470, 8747483⟩, ⟨2418146, 2418164⟩, ⟨150023, 150039⟩, ⟨(-3108), (-3100)⟩, ⟨(-89), (-83)⟩⟩
...
def j16 : Jet := ⟨⟨(-134418107), (-134418093)⟩, ⟨2418146, 2418164⟩, ⟨150023, 150039⟩, ⟨(-3108), (-3100)⟩, ⟨(-89), (-83)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-237584472), (-237584446)⟩, ⟨(-63607197), (-63607156)⟩, ⟨(-3362331), (-3362291)⟩, ⟨157493, 157518⟩, ⟨3683, 3702⟩⟩
...
def j19 : Jet := ⟨⟨1194071293, 1194071320⟩, ⟨(-63607197), (-63607156)⟩, ⟨(-3362331), (-3362291)⟩, ⟨157493, 157518⟩, ⟨3683, 3702⟩⟩
...
def j22 : Jet := ⟨⟨(-191), (-189)⟩, ⟨(-55), (-54)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11644, 11647⟩, ⟨(-55), (-54)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨20580, 20587⟩, ⟨5782, 5787⟩, ⟨384, 389⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-831597), (-831589)⟩, ⟨5782, 5787⟩, ⟨384, 389⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1469851), (-1469836)⟩, ⟨(-409739), (-409724)⟩, ⟨(-26400), (-26385)⟩, ⟨392, 403⟩, ⟨8, 14⟩⟩
...
def j30 : Jet := ⟨⟨34321543, 34321559⟩, ⟨(-409739), (-409724)⟩, ⟨(-26400), (-26385)⟩, ⟨392, 403⟩, ⟨8, 14⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨60663446, 60663475⟩, ⟨16608197, 16608234⟩, ⟨984447, 984485⟩, ⟨(-27421), (-27390)⟩, ⟨(-742), (-722)⟩⟩
...
def j33 : Jet := ⟨⟨(-655164437), (-655164407)⟩, ⟨16608197, 16608234⟩, ⟨984447, 984485⟩, ⟨(-27421), (-27390)⟩, ⟨(-742), (-722)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-1158005421), (-1158005365)⟩, ⟨(-301503647), (-301503562)⟩, ⟨(-13505596), (-13505506)⟩, ⟨1047761, 1047839⟩, ⟨20350, 20405⟩⟩
...
def j36 : Jet := ⟨⟨3136961875, 3136961931⟩, ⟨(-301503647), (-301503562)⟩, ⟨(-13505596), (-13505506)⟩, ⟨1047761, 1047839⟩, ⟨20350, 20405⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1587487797, 1587487835⟩, ⟨142219798, 142219861⟩, ⟨(-16550731), (-16550669)⟩, ⟨(-429209), (-429166)⟩, ⟨34807, 34839⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5880448816, 5880448922⟩, ⟨565188963, 565189145⟩, ⟨79639129, 79639336⟩, ⟨8123424, 8123614⟩, ⟨896593, 896738⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨2173506826, 2173506918⟩, ⟨403622822, 403622986⟩, ⟨25490641, 25490822⟩, ⟨2874027, 2874177⟩, ⟨284666, 284784⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1817565736), (-1817565735)⟩, ⟨(-259652248), (-259652247)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2477401560, 2477401561⟩, ⟨(-259652248), (-259652247)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨1099922676, 1099922770⟩, ⟨408513916, 408514102⟩, ⟨63730298, 63730515⟩, ⟨7699858, 7700050⟩, ⟨979577, 979734⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5394889972, 5394890066⟩, ⟨408513916, 408514102⟩, ⟨63730298, 63730515⟩, ⟨7699858, 7700050⟩, ⟨979577, 979734⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4813613610, 4813613653⟩, ⟨182249141, 182249226⟩, ⟨24981726, 24981828⟩, ⟨2489272, 2489364⟩, ⟨277939, 278015⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2776564533, 2776564560⟩, ⟨(-185882976), (-185882921)⟩, ⟨3391957, 3392023⟩, ⟨(-74428), (-74367)⟩, ⟨9824, 9876⟩⟩
...
def j47 : Jet := ⟨⟨5868488448, 5868488455⟩, ⟨838355489, 838355494⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8018491013, 8018491033⟩, ⟨2290997422, 2290997440⟩, ⟨163642672, 163642675⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8018491013, 8018491033⟩, ⟨2290997422, 2290997440⟩, ⟨163642672, 163642675⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8018491033), (-8018491013)⟩, ⟨(-2290997440), (-2290997422)⟩, ⟨(-163642675), (-163642672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4009245517), (-4009245506)⟩, ⟨(-1145498720), (-1145498711)⟩, ⟨(-81821338), (-81821336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1688716418, 1688716430⟩, ⟨(-450392838), (-450392831)⟩, ⟨27890588, 27890592⟩, ⟨3240602, 3240604⟩, ⟨(-481739), (-481737)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1091703333, 1091703352⟩, ⟨(-364251535), (-364251504)⟩, ⟨38856734, 38856771⟩, ⟨502895, 502932⟩, ⟨(-417995), (-417961)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1557913487, 2077217984⟩, ⟨259652247, 259652248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4894329565, 6525772759⟩, ⟨815721591, 815721595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨5577332780, 9915258294⟩, ⟨1859110918, 2478814574⟩, ⟨154925909, 154925911⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1395, 2485⟩, ⟨465, 622⟩, ⟨38, 39⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93292), (-92201)⟩, ⟨465, 622⟩, ⟨38, 39⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-215372), (-119729)⟩, ⟨(-53240), (-38473)⟩, ⟨(-3116), (-2875)⟩, ⟨32, 46⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4897684, 4993328⟩, ⟨(-53240), (-38473)⟩, ⟨(-3116), (-2875)⟩, ⟨32, 46⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨6360005, 11527478⟩, ⟨1997092, 2831910⟩, ⟨138744, 159731⟩, ⟨(-3679), (-2524)⟩, ⟨(-99), (-71)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-136805572), (-131638098)⟩, ⟨1997092, 2831910⟩, ⟨138744, 159731⟩, ⟨(-3679), (-2524)⟩, ⟨(-99), (-71)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-315826057), (-170941808)⟩, ⟨(-76363144), (-50442922)⟩, ⟨(-3890157), (-2745211)⟩, ⟨123600, 191063⟩, ⟨2651, 4578⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1115829708, 1260713958⟩, ⟨(-76363144), (-50442922)⟩, ⟨(-3890157), (-2745211)⟩, ⟨123600, 191063⟩, ⟨2651, 4578⟩⟩
...
def j70 : Jet := ⟨⟨(-250), (-138)⟩, ⟨(-63), (-46)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11585, 11698⟩, ⟨(-63), (-46)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨15043, 27006⟩, ⟨4868, 6693⟩, ⟨370, 400⟩, ⟨(-6), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-837134), (-825170)⟩, ⟨4868, 6693⟩, ⟨370, 400⟩, ⟨(-6), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1932588), (-1071544)⟩, ⟨(-476826), (-341729)⟩, ⟨(-27610), (-24978)⟩, ⟨321, 471⟩, ⟨6, 15⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨33858806, 34719851⟩, ⟨(-476826), (-341729)⟩, ⟨(-27610), (-24978)⟩, ⟨321, 471⟩, ⟨6, 15⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨43968164, 80153414⟩, ⟨13555264, 19594594⟩, ⟨882399, 1072043⟩, ⟨(-32719), (-22049)⟩, ⟨(-851), (-593)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-671859719), (-635674468)⟩, ⟨13555264, 19594594⟩, ⟨882399, 1072043⟩, ⟨(-32719), (-22049)⟩, ⟨(-851), (-593)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1551039203), (-825470324)⟩, ⟨(-370157288), (-229921164)⟩, ⟨(-17221624), (-9145935)⟩, ⟨795376, 1296899⟩, ⟨10980, 28357⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨2743928093, 3469496972⟩, ⟨(-370157288), (-229921164)⟩, ⟨(-17221624), (-9145935)⟩, ⟨795376, 1296899⟩, ⟨10980, 28357⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1271543635, 1915528627⟩, ⟨95897786, 181958853⟩, ⟨(-20413974), (-12708675)⟩, ⟨(-597991), (-231082)⟩, ⟨26494, 43244⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5316835328, 6722750542⟩, ⟨352342998, 906902451⟩, ⟨37365225, 164535376⟩, ⟨892010, 26346692⟩, ⟨(-298834), 4463446⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1574072083, 2998304814⟩, ⟨223026664, 689286177⟩, ⟨(-13023995), 96070866⟩, ⟨(-4148149), 17392468⟩, ⟨(-988872), 3045034⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-2077217984), (-1557913487)⟩, ⟨(-259652248), (-259652247)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2217749312, 2737053809⟩, ⟨(-259652248), (-259652247)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨576885166, 2093108315⟩, ⟨163475072, 962377556⟩, ⟨(-6602826), 244755047⟩, ⟨(-9971988), 55119508⟩, ⟨(-3003430), 11982927⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4871852462, 6388075611⟩, ⟨163475072, 962377556⟩, ⟨(-6602826), 244755047⟩, ⟨(-9971988), 55119508⟩, ⟨(-3003430), 11982927⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4574324758, 5237993494⟩, ⟨67021855, 451802217⟩, ⟨(-25411857), 114412843⟩, ⟨(-15981957), 28386568⟩, ⟨(-5644568), 7521886⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2361998331, 3338016115⟩, ⟨(-282055492), 11379197⟩, ⟨(-43507919), 68860067⟩, ⟨(-17101651), 19626183⟩, ⟨(-5313224), 5759663⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5030132955, 6706843948⟩, ⟨838355489, 838355494⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5891136253, 10473131143⟩, ⟨1963712076, 2618282788⟩, ⟨163642672, 163642675⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5891136253, 10473131143⟩, ⟨1963712076, 2618282788⟩, ⟨163642672, 163642675⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10473131143), (-5891136253)⟩, ⟨(-2618282788), (-1963712076)⟩, ⟨(-163642675), (-163642672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5236565572), (-2945568126)⟩, ⟨(-1309141394), (-981856038)⟩, ⟨(-81821338), (-81821336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1268976923, 2163279638⟩, ⟨(-659385445), (-290095958)⟩, ⟨(-8052728), 76318394⟩, ⟨(-4069841), 9192601⟩, ⟨(-1427448), 386835⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨697868264, 1681284582⟩, ⟨(-654534472), (-153805544)⟩, ⟨(-29919486), 137299975⟩, ⟨(-27360442), 24238087⟩, ⟨(-8175461), 7318060⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1817565735, 1817565736⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4813613610, 4813613653⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified202
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1557913487, 2077217984⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4574324758, 5237993494⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified203
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (33435219 / 1073741824)

theorem envelope_integral : (∫ s in ((36273 / 100000) : ℝ)..(12091 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((36273 / 100000) : ℝ)..(12091 / 25000), prawitzNormalCorrection
