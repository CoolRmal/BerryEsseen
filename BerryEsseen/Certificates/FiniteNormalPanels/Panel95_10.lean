...
namespace FiniteNormalPanel95_10
...
def j2 : Jet := ⟨⟨496864244, 496864248⟩, ⟨496864244, 496864248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨57479850, 57479852⟩, ⟨114959700, 114959704⟩, ⟨57479850, 57479852⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1268), (-1266)⟩, ⟨(-2535), (-2532)⟩, ⟨(-1268), (-1264)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111788, 5111791⟩, ⟨(-2535), (-2532)⟩, ⟨(-1268), (-1264)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨68411, 68412⟩, ⟨136788, 136790⟩, ⟨68326, 68329⟩, ⟨(-68), (-65)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-143097166), (-143097164)⟩, ⟨136788, 136790⟩, ⟨68326, 68329⟩, ⟨(-68), (-65)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1915080), (-1915079)⟩, ⟨(-3828330), (-3828327)⟩, ⟨(-1910505), (-1910502)⟩, ⟨3657, 3660⟩, ⟨911, 914⟩⟩
...
def j19 : Jet := ⟨⟨1429740685, 1429740687⟩, ⟨(-3828330), (-3828327)⟩, ⟨(-1910505), (-1910502)⟩, ⟨3657, 3660⟩, ⟨911, 914⟩⟩
...
def j25 : Jet := ⟨⟨158, 159⟩, ⟨315, 317⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852019), (-852017)⟩, ⟨315, 317⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11403), (-11402)⟩, ⟨(-22802), (-22800)⟩, ⟨(-11393), (-11390)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779991, 35779993⟩, ⟨(-22802), (-22800)⟩, ⟨(-11393), (-11390)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨478846, 478847⟩, ⟨957386, 957388⟩, ⟨478082, 478085⟩, ⟨(-611), (-608)⟩, ⟨(-153), (-150)⟩⟩
...
def j33 : Jet := ⟨⟨(-715349037), (-715349035)⟩, ⟨957386, 957388⟩, ⟨478082, 478085⟩, ⟨(-611), (-608)⟩, ⟨(-153), (-150)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9573567), (-9573566)⟩, ⟨(-19134322), (-19134320)⟩, ⟨(-9541544), (-9541541)⟩, ⟨25599, 25602⟩, ⟨6378, 6381⟩⟩
...
def j36 : Jet := ⟨⟨4285393729, 4285393730⟩, ⟨(-19134322), (-19134320)⟩, ⟨(-9541544), (-9541541)⟩, ⟨25599, 25602⟩, ⟨6378, 6381⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨165399868, 165399870⟩, ⟨164956986, 164956990⟩, ⟨(-663900), (-663896)⟩, ⟨(-220595), (-220592)⟩, ⟨528, 530⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304562249, 4304562251⟩, ⟨19219907, 19219911⟩, ⟨9670035, 9670041⟩, ⟨60252, 60259⟩, ⟨15273, 15281⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨165769371, 165769374⟩, ⟨166065660, 166065666⟩, ⟨445189, 445196⟩, ⟨149658, 149665⟩, ⟨948, 955⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-158156802), (-158156801)⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4136810494, 4136810495⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6398066, 6398067⟩, ⟨12819002, 12819006⟩, ⟨6455321, 6455325⟩, ⟨45978, 45982⟩, ⟨11690, 11695⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301365362, 4301365363⟩, ⟨12819002, 12819006⟩, ⟨6455321, 6455325⟩, ⟨45978, 45982⟩, ⟨11690, 11695⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298165138, 4298165140⟩, ⟨6404732, 6404735⟩, ⟨3220487, 3220490⟩, ⟨18172, 18176⟩, ⟨4606, 4611⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4139890579, 4139890583⟩, ⟨(-152105674), (-152105668)⟩, ⟨2866049, 2866054⟩, ⟨(-101089), (-101083)⟩, ⟨3766, 3773⟩⟩
...
def j47 : Jet := ⟨⟨1436444798, 1436444809⟩, ⟨1436444798, 1436444809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨480416616, 480416625⟩, ⟨960833232, 960833250⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨480416616, 480416625⟩, ⟨960833232, 960833250⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-480416625), (-480416616)⟩, ⟨(-960833250), (-960833232)⟩, ⟨(-480416625), (-480416616)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-240208313), (-240208308)⟩, ⟨(-480416625), (-480416616)⟩, ⟨(-240208313), (-240208308)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4061352656, 4061352662⟩, ⟨(-454285494), (-454285484)⟩, ⟨(-201735535), (-201735528)⟩, ⟨24459898, 24459900⟩, ⟨4957322, 4957324⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3914710972, 3914710982⟩, ⟨(-581715029), (-581715012)⟩, ⟨(-175652935), (-175652920)⟩, ⟨30322429, 30322443⟩, ⟨3791717, 3791732⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 316313604⟩, ⟨158156801, 158156802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 993728495⟩, ⟨496864244, 496864248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 229919405⟩, ⟨0, 229919406⟩, ⟨57479850, 57479852⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5069), 0⟩, ⟨(-5069), 4⟩, ⟨(-1268), (-1261)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107987, 5113057⟩, ⟨(-5069), 4⟩, ⟨(-1268), (-1261)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 273714⟩, ⟨(-272), 273715⟩, ⟨68020, 68430⟩, ⟨(-136), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142891862)⟩, ⟨(-272), 273715⟩, ⟨68020, 68430⟩, ⟨(-136), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7663981), 0⟩, ⟨(-7663996), 14653⟩, ⟨(-1916011), (-1894014)⟩, ⟨(-12), 7329⟩, ⟨901, 917⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423991784, 1431655766⟩, ⟨(-7663996), 14653⟩, ⟨(-1916011), (-1894014)⟩, ⟨(-12), 7329⟩, ⟨901, 917⟩⟩
...
def j72 : Jet := ⟨⟨0, 634⟩, ⟨(-1), 634⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851542)⟩, ⟨(-1), 634⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-45619), 0⟩, ⟨(-45620), 34⟩, ⟨(-11406), (-11353)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35745775, 35791395⟩, ⟨(-45620), 34⟩, ⟨(-11406), (-11353)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1915996⟩, ⟨(-2443), 1915998⟩, ⟨475334, 479001⟩, ⟨(-1223), 2⟩, ⟨(-154), (-149)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713911886)⟩, ⟨(-2443), 1915998⟩, ⟨475334, 479001⟩, ⟨(-1223), 2⟩, ⟨(-154), (-149)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-38319901), 0⟩, ⟨(-38320033), 102568⟩, ⟨(-9580107), (-9426122)⟩, ⟨(-99), 51286⟩, ⟨6286, 6412⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4256647395, 4294967296⟩, ⟨(-38320033), 102568⟩, ⟨(-9580107), (-9426122)⟩, ⟨(-99), 51286⟩, ⟨6286, 6412⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 331242832⟩, ⟨162961582, 165624808⟩, ⟨(-1329921), 1696⟩, ⟨(-221658), (-217413)⟩, ⟨(-2), 1061⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4333632167⟩, ⟨(-104424), 39013081⟩, ⟨9425190, 10104583⟩, ⟨(-52694), 178871⟩, ⟨13278, 18012⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 334224802⟩, ⟨162953528, 170124649⟩, ⟨(-1345921), 2285457⟩, ⟨117815, 186075⟩, ⟨(-7179), 9369⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-316313604), 0⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3978653692, 4294967296⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 26008631⟩, ⟨0, 26477444⟩, ⟨5973076, 7094377⟩, ⟨(-106626), 210016⟩, ⟨7103, 17419⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4320975927⟩, ⟨0, 26477444⟩, ⟨5973076, 7094377⟩, ⟨(-106626), 210016⟩, ⟨7103, 17419⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307951984⟩, ⟨0, 13238722⟩, ⟨2957194, 3547189⟩, ⟨(-64247), 105008⟩, ⟨1757, 7891⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3978653692, 4307951984⟩, ⟨(-158634947), (-144918079)⟩, ⟨2251904, 3547189⟩, ⟨(-194868), (-3886)⟩, ⟨(-2240), 10257⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2872889617⟩, ⟨1436444798, 1436444809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1921666496⟩, ⟨0, 1921666498⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1921666496⟩, ⟨0, 1921666498⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1921666496), 0⟩, ⟨(-1921666498), 0⟩, ⟨(-480416625), (-480416616)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-960833248), 0⟩, ⟨(-960833249), 0⟩, ⟨(-240208313), (-240208308)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3434023196, 4294967296⟩, ⟨(-960833249), 0⟩, ⟨(-240208313), (-84582863)⟩, ⟨0, 53737344⟩, ⟨(-640146), 6717168⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3181115972, 4307951984⟩, ⟨(-1122373020), (-115868645)⟩, ⟨(-239134019), (-39317907)⟩, ⟨1865526, 62768811⟩, ⟨(-2827502), 6746981⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298165138, 4298165140⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1916
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307951984⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1917
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (71023981 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(29459 / 400000), prawitzNormalCorrection
