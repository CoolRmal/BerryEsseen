...
namespace FiniteNormalPanel97_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3567 / 32000)
def radius : Rat := (1189 / 32000)

def j0 : Jet := ⟨⟨478754635, 478754636⟩, ⟨159584878, 159584879⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1504052044, 1504052048⟩, ⟨501350680, 501350684⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨526703091, 526703094⟩, ⟨351135392, 351135398⟩, ⟨58522565, 58522567⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨131, 132⟩, ⟨87, 88⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94556), (-94554)⟩, ⟨87, 88⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11596), (-11595)⟩, ⟨(-7721), (-7719)⟩, ⟨(-1281), (-1278)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101460, 5101462⟩, ⟨(-7721), (-7719)⟩, ⟨(-1281), (-1278)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨625605, 625606⟩, ⟨416123, 416125⟩, ⟨68721, 68725⟩, ⟨(-211), (-208)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-142539972), (-142539970)⟩, ⟨416123, 416125⟩, ⟨68721, 68725⟩, ⟨(-211), (-208)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17480051), (-17480049)⟩, ⟨(-11602337), (-11602335)⟩, ⟨(-1899781), (-1899778)⟩, ⟨11262, 11265⟩, ⟨915, 919⟩⟩
...
def j19 : Jet := ⟨⟨1414175714, 1414175717⟩, ⟨(-11602337), (-11602335)⟩, ⟨(-1899781), (-1899778)⟩, ⟨11262, 11265⟩, ⟨915, 919⟩⟩
...
def j25 : Jet := ⟨⟨1449, 1450⟩, ⟨964, 967⟩, ⟨159, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850728), (-850726)⟩, ⟨964, 967⟩, ⟨159, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-104328), (-104326)⟩, ⟨(-69434), (-69432)⟩, ⟨(-11495), (-11491)⟩, ⟨24, 28⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35687066, 35687069⟩, ⟨(-69434), (-69432)⟩, ⟨(-11495), (-11491)⟩, ⟨24, 28⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4376398, 4376399⟩, ⟨2909083, 2909086⟩, ⟨479179, 479182⟩, ⟨(-1885), (-1881)⟩, ⟨(-156), (-152)⟩⟩
...
def j33 : Jet := ⟨⟨(-711451485), (-711451483)⟩, ⟨2909083, 2909086⟩, ⟨479179, 479182⟩, ⟨(-1885), (-1881)⟩, ⟨(-156), (-152)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-87247160), (-87247159)⟩, ⟨(-57808026), (-57808023)⟩, ⟨(-9397536), (-9397531)⟩, ⟨78581, 78585⟩, ⟨6354, 6359⟩⟩
...
def j36 : Jet := ⟨⟨4207720136, 4207720137⟩, ⟨(-57808026), (-57808023)⟩, ⟨(-9397536), (-9397531)⟩, ⟨78581, 78585⟩, ⟨6354, 6359⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨495229352, 495229355⟩, ⟨161013434, 161013439⟩, ⟨(-2019623), (-2019620)⟩, ⟨(-217819), (-217815)⟩, ⟨1634, 1637⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4384023526, 4384023528⟩, ⟨60230177, 60230182⟩, ⟨10618761, 10618770⟩, ⟨198524, 198533⟩, ⟨18691, 18702⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨505497942, 505497946⟩, ⟨171296864, 171296872⟩, ⟨1420851, 1420859⟩, ⟨170316, 170325⟩, ⟨3215, 3224⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-478754636), (-478754635)⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3816212660, 3816212661⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨59494788, 59494790⟩, ⟨40321708, 40321712⟩, ⟨7166314, 7166319⟩, ⟨153426, 153432⟩, ⟨14810, 14819⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4354462084, 4354462086⟩, ⟨40321708, 40321712⟩, ⟨7166314, 7166319⟩, ⟨153426, 153432⟩, ⟨14810, 14819⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4324612380, 4324612382⟩, ⟨20022651, 20022654⟩, ⟨3512242, 3512246⟩, ⟨59925, 59930⟩, ⟨5649, 5656⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3842553243, 3842553247⟩, ⟨(-142895629), (-142895624)⟩, ⟨2376769, 2376775⟩, ⟨(-77257), (-77251)⟩, ⟨2792, 2800⟩⟩
...
def j47 : Jet := ⟨⟨3980233342, 3980233352⟩, ⟨1326744444, 1326744454⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3688563000, 3688563020⟩, ⟨2459041994, 2459042020⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3688563000, 3688563020⟩, ⟨2459041994, 2459042020⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3688563020), (-3688563000)⟩, ⟨(-2459042020), (-2459041994)⟩, ⟨(-409840338), (-409840331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1844281510), (-1844281500)⟩, ⟨(-1229521010), (-1229520997)⟩, ⟨(-204920169), (-204920165)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2795577457, 2795577468⟩, ⟨(-800290432), (-800290420)⟩, ⟨(-18832105), (-18832097)⟩, ⟨27252496, 27252499⟩, ⟨(-1501139), (-1501138)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2501102914, 2501102928⟩, ⟨(-809001364), (-809001348)⟩, ⟨11324665, 11324681⟩, ⟨24515226, 24515238⟩, ⟨(-2243931), (-2243919)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨319169757, 638339515⟩, ⟨159584878, 159584879⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1002701363, 2005402731⟩, ⟨501350680, 501350684⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨234090262, 936361057⟩, ⟨234090262, 468180530⟩, ⟨58522565, 58522567⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨58, 235⟩, ⟨58, 118⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94629), (-94451)⟩, ⟨58, 118⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-20631), (-5147)⟩, ⟨(-10313), (-5121)⟩, ⟨(-1287), (-1269)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092425, 5107910⟩, ⟨(-10313), (-5121)⟩, ⟨(-1287), (-1269)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨277554, 1113594⟩, ⟨275305, 556518⟩, ⟨67982, 69252⟩, ⟨(-282), (-137)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142888023), (-142051982)⟩, ⟨275305, 556518⟩, ⟨67982, 69252⟩, ⟨(-282), (-137)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-31151525), (-7742314)⟩, ⟨(-15560758), (-7620985)⟩, ⟨(-1928261), (-1859815)⟩, ⟨7394, 15126⟩, ⟨891, 937⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1400504240, 1423913452⟩, ⟨(-15560758), (-7620985)⟩, ⟨(-1928261), (-1859815)⟩, ⟨7394, 15126⟩, ⟨891, 937⟩⟩
...
def j72 : Jet := ⟨⟨643, 2580⟩, ⟨640, 1290⟩, ⟨157, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851534), (-849596)⟩, ⟨640, 1290⟩, ⟨157, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-185646), (-46305)⟩, ⟨(-92789), (-46023)⟩, ⟨(-11561), (-11399)⟩, ⟨15, 36⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35605748, 35745090⟩, ⟨(-92789), (-46023)⟩, ⟨(-11561), (-11399)⟩, ⟨15, 36⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1940633, 7792914⟩, ⟨1920403, 3893949⟩, ⟨472522, 483929⟩, ⟨(-2526), (-1240)⟩, ⟨(-158), (-150)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713887250), (-708034968)⟩, ⟨1920403, 3893949⟩, ⟨472522, 483929⟩, ⟨(-2526), (-1240)⟩, ⟨(-158), (-150)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-155637092), (-38590303)⟩, ⟨(-77713879), (-37741369)⟩, ⟨(-9596897), (-9117604)⟩, ⟨51370, 105744⟩, ⟨6127, 6519⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4139330204, 4256376993⟩, ⟨(-77713879), (-37741369)⟩, ⟨(-9596897), (-9117604)⟩, ⟨51370, 105744⟩, ⟨6127, 6519⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨326961164, 664852543⟩, ⟨156214964, 164433944⟩, ⟨(-2716748), (-1323787)⟩, ⟨(-223360), (-210032)⟩, ⟨1071, 2204⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4333907476, 4456456278⟩, ⟨38428832, 83667765⟩, ⟨9624430, 11902965⟩, ⟨56942, 363671⟩, ⟨12215, 27535⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨329925546, 689850722⟩, ⟨160556736, 183568199⟩, ⟨(-688504), 3710010⟩, ⟨69707, 288225⟩, ⟨(-7802), 15629⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-638339515), (-319169757)⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3656627781, 3975797539⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨25343817, 110802711⟩, ⟨24666902, 58968858⟩, ⟨5780842, 9037553⟩, ⟨(-48146), 409724⟩, ⟨2107, 32865⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4320311113, 4405770007⟩, ⟨24666902, 58968858⟩, ⟨5780842, 9037553⟩, ⟨(-48146), 409724⟩, ⟨2107, 32865⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307620565, 4350015873⟩, ⟨12177373, 29397822⟩, ⟨2754506, 4488291⟩, ⟨(-54635), 196475⟩, ⟨(-2630), 15877⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3667400457, 4026755319⟩, ⟨(-151262768), (-132841829)⟩, ⟨1252804, 3702290⟩, ⟨(-217344), 79528⟩, ⟨(-9736), 16729⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2653488897, 5306977805⟩, ⟨1326744444, 1326744454⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1639361336, 6557445374⟩, ⟨1639361330, 3278722694⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1639361336, 6557445374⟩, ⟨1639361330, 3278722694⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6557445374), (-1639361336)⟩, ⟨(-3278722694), (-1639361330)⟩, ⟨(-409840338), (-409840331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3278722687), (-819680668)⟩, ⟨(-1639361347), (-819680665)⟩, ⟨(-204920169), (-204920165)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2001820117, 3548756157⟩, ⟨(-1354537363), (-382040917)⟩, ⟨(-132861533), 162998864⟩, ⟨(-8586660), 59988980⟩, ⟨(-9612829), 3988893⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1709320585, 3327143549⟩, ⟨(-1394931510), (-388133916)⟩, ⟨(-112164297), 203583889⟩, ⟨(-15138239), 60876264⟩, ⟨(-11272912), 4265082⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨478754635, 478754636⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4324612380, 4324612382⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1964
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨319169757, 638339515⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307620565, 4350015873⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1965
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (186207123 / 4294967296)

theorem envelope_integral : (∫ s in ((1189 / 16000) : ℝ)..(1189 / 8000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (1189 / 16000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (1189 / 8000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((1189 / 16000) : ℝ)..(1189 / 8000), prawitzNormalCorrection
