...
namespace FiniteNormalPanel62_18
...
def j2 : Jet := ⟨⟨614253673, 614253677⟩, ⟨614253673, 614253677⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨87848765, 87848767⟩, ⟨175697530, 175697534⟩, ⟨87848765, 87848767⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨21, 23⟩, ⟨43, 45⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94666), (-94663)⟩, ⟨43, 45⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1937), (-1936)⟩, ⟨(-3873), (-3871)⟩, ⟨(-1936), (-1933)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111119, 5111121⟩, ⟨(-3873), (-3871)⟩, ⟨(-1936), (-1933)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨104542, 104543⟩, ⟨209004, 209006⟩, ⟨104343, 104346⟩, ⟨(-160), (-157)⟩, ⟨(-40), (-37)⟩⟩
...
def j16 : Jet := ⟨⟨(-143061035), (-143061033)⟩, ⟨209004, 209006⟩, ⟨104343, 104346⟩, ⟨(-160), (-157)⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2926154), (-2926153)⟩, ⟨(-5848034), (-5848032)⟩, ⟨(-2915471), (-2915468)⟩, ⟨8538, 8541⟩, ⟨2126, 2129⟩⟩
...
def j19 : Jet := ⟨⟨1428729611, 1428729613⟩, ⟨(-5848034), (-5848032)⟩, ⟨(-2915471), (-2915468)⟩, ⟨8538, 8541⟩, ⟨2126, 2129⟩⟩
...
def j25 : Jet := ⟨⟨242, 243⟩, ⟨483, 485⟩, ⟨240, 243⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851935), (-851933)⟩, ⟨483, 485⟩, ⟨240, 243⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-17426), (-17425)⟩, ⟨(-34842), (-34840)⟩, ⟨(-17403), (-17400)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35773968, 35773970⟩, ⟨(-34842), (-34840)⟩, ⟨(-17403), (-17400)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨731716, 731717⟩, ⟨1462720, 1462722⟩, ⟨729934, 729937⟩, ⟨(-1425), (-1422)⟩, ⟨(-356), (-353)⟩⟩
...
def j33 : Jet := ⟨⟨(-715096167), (-715096165)⟩, ⟨1462720, 1462722⟩, ⟨729934, 729937⟩, ⟨(-1425), (-1422)⟩, ⟨(-356), (-353)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-14626495), (-14626494)⟩, ⟨(-29223072), (-29223069)⟩, ⟨(-14551730), (-14551726)⟩, ⟨59747, 59751⟩, ⟨14862, 14866⟩⟩
...
def j36 : Jet := ⟨⟨4280340801, 4280340802⟩, ⟨(-29223072), (-29223069)⟩, ⟨(-14551730), (-14551726)⟩, ⟨59747, 59751⟩, ⟨14862, 14866⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨204332734, 204332736⟩, ⟨203496365, 203496368⟩, ⟨(-1253332), (-1253329)⟩, ⟨(-415742), (-415739)⟩, ⟨1525, 1527⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4309643770, 4309643772⟩, ⟨29423128, 29423133⟩, ⟨14852225, 14852232⟩, ⟨141267, 141275⟩, ⟨36076, 36085⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨205030966, 205030969⟩, ⟨205591542, 205591547⟩, ⟨843051, 843057⟩, ⟨284671, 284679⟩, ⟨2755, 2762⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-195523018), (-195523017)⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4099444278, 4099444279⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨9787664, 9787665⟩, ⟨19628848, 19628850⟩, ⟨9921748, 9921751⟩, ⟨107888, 107892⟩, ⟨27679, 27686⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4304754960, 4304754961⟩, ⟨19628848, 19628850⟩, ⟨9921748, 9921751⟩, ⟨107888, 107892⟩, ⟨27679, 27686⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299858343, 4299858344⟩, ⟨9803260, 9803262⟩, ⟨4944055, 4944058⟩, ⟨42610, 42614⟩, ⟨10883, 10889⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4104112666, 4104112669⟩, ⟨(-186388699), (-186388694)⟩, ⟨4272701, 4272705⟩, ⟨(-184403), (-184396)⟩, ⟨8447, 8455⟩⟩
...
def j47 : Jet := ⟨⟨1066432259, 1066432265⟩, ⟨1066432259, 1066432265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨264793113, 264793117⟩, ⟨529586226, 529586234⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨264793113, 264793117⟩, ⟨529586226, 529586234⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-264793117), (-264793113)⟩, ⟨(-529586234), (-529586226)⟩, ⟨(-264793117), (-264793113)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-132396559), (-132396556)⟩, ⟨(-264793117), (-264793113)⟩, ⟨(-132396559), (-132396556)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4164590556, 4164590559⟩, ⟨(-256755137), (-256755132)⟩, ⟨(-120462842), (-120462837)⟩, ⟨7752074, 7752076⟩, ⟨1737209, 1737210⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3979529451, 3979529458⟩, ⟨(-426076499), (-426076487)⟩, ⟨(-99824457), (-99824445)⟩, ⟨12201090, 12201104⟩, ⟨1222969, 1222983⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 391046035⟩, ⟨195523017, 195523018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1228507351⟩, ⟨614253673, 614253677⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 351395065⟩, ⟨0, 351395066⟩, ⟨87848765, 87848767⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 89⟩, ⟨0, 89⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94597)⟩, ⟨0, 89⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-7747), 0⟩, ⟨(-7747), 8⟩, ⟨(-1937), (-1924)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5105309, 5113057⟩, ⟨(-7747), 8⟩, ⟨(-1937), (-1924)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 418328⟩, ⟨(-634), 418329⟩, ⟨103630, 104583⟩, ⟨(-318), 2⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142747248)⟩, ⟨(-634), 418329⟩, ⟨103630, 104583⟩, ⟨(-318), 2⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-11713169), 0⟩, ⟨(-11713221), 34226⟩, ⟨(-2928345), (-2876952)⟩, ⟨(-40), 17115⟩, ⟨2088, 2141⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1419942596, 1431655766⟩, ⟨(-11713221), 34226⟩, ⟨(-2928345), (-2876952)⟩, ⟨(-40), 17115⟩, ⟨2088, 2141⟩⟩
...
def j72 : Jet := ⟨⟨0, 969⟩, ⟨(-1), 969⟩, ⟨239, 243⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851207)⟩, ⟨(-1), 969⟩, ⟨239, 243⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-69722), 0⟩, ⟨(-69723), 80⟩, ⟨(-17432), (-17310)⟩, ⟨(-2), 40⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35721672, 35791395⟩, ⟨(-69723), 80⟩, ⟨(-17432), (-17310)⟩, ⟨(-2), 40⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2928293⟩, ⟨(-5705), 2928300⟩, ⟨723514, 732081⟩, ⟨(-2855), 6⟩, ⟨(-358), (-349)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712899589)⟩, ⟨(-5705), 2928300⟩, ⟨723514, 732081⟩, ⟨(-2855), 6⟩, ⟨(-358), (-349)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-58565845), 0⟩, ⟨(-58566312), 239581⟩, ⟨(-14641929), (-14282088)⟩, ⟨(-351), 119793⟩, ⟨14534, 14975⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4236401451, 4294967296⟩, ⟨(-58566312), 239581⟩, ⟨(-14641929), (-14282088)⟩, ⟨(-351), 119793⟩, ⟨14534, 14975⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 409502451⟩, ⟨199725659, 204761016⟩, ⟨(-2512798), 4895⟩, ⟨(-418816), (-406557)⟩, ⟨(-6), 3061⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4354342781⟩, ⟨(-246252), 60196798⟩, ⟨14278730, 15881755⟩, ⟨(-124879), 427974⟩, ⟨28916, 46081⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 415163590⟩, ⟨199702180, 213331168⟩, ⟨(-2559277), 4389066⟩, ⟨192261, 391551⟩, ⟨(-21123), 27946⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-391046035), 0⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3903921261, 4294967296⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 40130878⟩, ⟨0, 41242380⟩, ⟨8790735, 11444687⟩, ⟨(-254240), 511710⟩, ⟨11178, 48788⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4335098174⟩, ⟨0, 41242380⟩, ⟨8790735, 11444687⟩, ⟨(-254240), 511710⟩, ⟨11178, 48788⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4314986082⟩, ⟨0, 20621190⟩, ⟨4325701, 5722344⟩, ⟨(-154595), 255855⟩, ⟨544, 22959⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3903921261, 4314986082⟩, ⟨(-196434349), (-174901827)⟩, ⟨2993102, 5722344⟩, ⟨(-415098), 58933⟩, ⟨(-11154), 29997⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2132864525⟩, ⟨1066432259, 1066432265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1059172462⟩, ⟨0, 1059172464⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1059172462⟩, ⟨0, 1059172464⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1059172462), 0⟩, ⟨(-1059172464), 0⟩, ⟨(-264793117), (-264793113)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-529586231), 0⟩, ⟨(-529586232), 0⟩, ⟨(-132396559), (-132396556)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3796729498, 4294967296⟩, ⟨(-529586232), 0⟩, ⟨(-132396559), (-84387864)⟩, ⟨0, 16325013⟩, ⟨797434, 2040627⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3451046768, 4314986082⟩, ⟨(-728488976), (-154612335)⟩, ⟨(-130367771), (-46761093)⟩, ⟨2315799, 22515318⟩, ⟨(-216629), 2072512⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299858343, 4299858344⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1236
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4314986082⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1237
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (44916795 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(36419 / 400000), prawitzNormalCorrection
