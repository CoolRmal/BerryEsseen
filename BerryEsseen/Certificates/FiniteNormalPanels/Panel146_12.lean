...
namespace FiniteNormalPanel146_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (26289 / 160000)
def radius : Rat := (26289 / 800000)

def j0 : Jet := ⟨⟨705689970, 705689971⟩, ⟨141137994, 141137995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2216990425, 2216990429⟩, ⟨443398085, 443398089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1144373450, 1144373455⟩, ⟨457749380, 457749386⟩, ⟨45774938, 45774939⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨286, 287⟩, ⟨114, 115⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94401), (-94399)⟩, ⟨114, 115⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-25153), (-25152)⟩, ⟨(-10032), (-10029)⟩, ⟨(-993), (-989)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5087903, 5087905⟩, ⟨(-10032), (-10029)⟩, ⟨(-993), (-989)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1355647, 1355648⟩, ⟨539585, 539588⟩, ⟨52890, 52895⟩, ⟨(-213), (-209)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141809930), (-141809928)⟩, ⟨539585, 539588⟩, ⟨52890, 52895⟩, ⟨(-213), (-209)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-37784577), (-37784575)⟩, ⟨(-14970062), (-14970059)⟩, ⟨(-1439785), (-1439780)⟩, ⟨11329, 11334⟩, ⟨537, 540⟩⟩
...
def j19 : Jet := ⟨⟨1393871188, 1393871191⟩, ⟨(-14970062), (-14970059)⟩, ⟨(-1439785), (-1439780)⟩, ⟨11329, 11334⟩, ⟨537, 540⟩⟩
...
def j22 : Jet := ⟨⟨(-29), (-28)⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11806, 11808⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3145, 3147⟩, ⟨1254, 1257⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849032), (-849029)⟩, ⟨1254, 1257⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-226221), (-226219)⟩, ⟨(-90155), (-90152)⟩, ⟨(-8884), (-8880)⟩, ⟨25, 28⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35565173, 35565176⟩, ⟨(-90155), (-90152)⟩, ⟨(-8884), (-8880)⟩, ⟨25, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9476169, 9476171⟩, ⟨3766445, 3766449⟩, ⟨367069, 367073⟩, ⟨(-1902), (-1898)⟩, ⟨(-94), (-90)⟩⟩
...
def j33 : Jet := ⟨⟨(-706351714), (-706351711)⟩, ⟨3766445, 3766449⟩, ⟨367069, 367073⟩, ⟨(-1902), (-1898)⟩, ⟨(-94), (-90)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-188204030), (-188204027)⟩, ⟨(-74278062), (-74278058)⟩, ⟨(-7028939), (-7028935)⟩, ⟨78756, 78760⟩, ⟨3683, 3688⟩⟩
...
def j36 : Jet := ⟨⟨4106763266, 4106763269⟩, ⟨(-74278062), (-74278058)⟩, ⟨(-7028939), (-7028935)⟩, ⟨78756, 78760⟩, ⟨3683, 3688⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨719493040, 719493044⟩, ⟨136171311, 136171316⟩, ⟨(-2288653), (-2288648)⟩, ⟨(-142792), (-142787)⟩, ⟨1446, 1450⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4491796304, 4491796308⟩, ⟨81242058, 81242066⟩, ⟨9157343, 9157351⟩, ⟨218529, 218539⟩, ⟨14031, 14043⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨752465840, 752465846⟩, ⟨156021416, 156021426⟩, ⟨1716268, 1716277⟩, ⟨134311, 134322⟩, ⟨3208, 3220⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-705689971), (-705689970)⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3589277325, 3589277326⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨131829837, 131829840⟩, ⟨54669000, 54669006⟩, ⟨6269092, 6269098⟩, ⟨171752, 171760⟩, ⟨11567, 11576⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4426797133, 4426797136⟩, ⟨54669000, 54669006⟩, ⟨6269092, 6269098⟩, ⟨171752, 171760⟩, ⟨11567, 11576⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4360384032, 4360384035⟩, ⟨26924413, 26924417⟩, ⟨3004393, 3004397⟩, ⟨66035, 66041⟩, ⟨4253, 4260⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3643945682, 3643945686⟩, ⟨(-120787108), (-120787101)⟩, ⟨1625981, 1625987⟩, ⟨(-43544), (-43537)⟩, ⟨1383, 1392⟩⟩
...
def j47 : Jet := ⟨⟨7191427149, 7191427161⟩, ⟨1438285429, 1438285441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12041214955, 12041214997⟩, ⟨4816485978, 4816486028⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12041214955, 12041214997⟩, ⟨4816485978, 4816486028⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12041214997), (-12041214955)⟩, ⟨(-4816486028), (-4816485978)⟩, ⟨(-481648606), (-481648597)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6020607499), (-6020607477)⟩, ⟨(-2408243014), (-2408242989)⟩, ⟨(-240824303), (-240824298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1057240291, 1057240311⟩, ⟨(-592808145), (-592808127)⟩, ⟨106916727, 106916737⟩, ⟨2176478, 2176483⟩, ⟨(-3302575), (-3302573)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨896986153, 896986172⟩, ⟨(-532684309), (-532684289)⟩, ⟨107782280, 107782294⟩, ⟨(-1395386), (-1395375)⟩, ⟨(-2816364), (-2816353)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨564551976, 846827965⟩, ⟨141137994, 141137995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1773592340, 2660388514⟩, ⟨443398085, 443398089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨732399008, 1647897774⟩, ⟨366199504, 549299264⟩, ⟨45774938, 45774939⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨183, 413⟩, ⟨91, 138⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94504), (-94273)⟩, ⟨91, 138⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-36260), (-16075)⟩, ⟨(-12072), (-7984)⟩, ⟨(-1000), (-981)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5076796, 5096982⟩, ⟨(-12072), (-7984)⟩, ⟨(-1000), (-981)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨865720, 1955616⟩, ⟨428228, 650511⟩, ⟨52179, 53476⟩, ⟨(-257), (-166)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142299857), (-141209960)⟩, ⟨428228, 650511⟩, ⟨52179, 53476⟩, ⟨(-257), (-166)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-54597766), (-24079818)⟩, ⟨(-18126233), (-11790320)⟩, ⟨(-1471197), (-1401273)⟩, ⟨8912, 13746⟩, ⟨518, 555⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1377057999, 1407575948⟩, ⟨(-18126233), (-11790320)⟩, ⟨(-1471197), (-1401273)⟩, ⟨8912, 13746⟩, ⟨518, 555⟩⟩
...
def j70 : Jet := ⟨⟨(-42), (-18)⟩, ⟨(-14), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11793, 11818⟩, ⟨(-14), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2011, 4535⟩, ⟨999, 1511⟩, ⟨122, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850166), (-847641)⟩, ⟨999, 1511⟩, ⟨122, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-326193), (-144543)⟩, ⟨(-108561), (-71691)⟩, ⟨(-8956), (-8790)⟩, ⟨19, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35465201, 35646852⟩, ⟨(-108561), (-71691)⟩, ⟨(-8956), (-8790)⟩, ⟨19, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6047701, 13677024⟩, ⟨2982197, 4546783⟩, ⟨360659, 372308⟩, ⟨(-2301), (-1499)⟩, ⟨(-96), (-87)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709780182), (-702150858)⟩, ⟨2982197, 4546783⟩, ⟨360659, 372308⟩, ⟨(-2301), (-1499)⟩, ⟨(-96), (-87)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-272329241), (-119734227)⟩, ⟨(-90267877), (-58122598)⟩, ⟨(-7248932), (-6759036)⟩, ⟨61650, 95820⟩, ⟨3511, 3827⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4022638055, 4175233069⟩, ⟨(-90267877), (-58122598)⟩, ⟨(-7248932), (-6759036)⟩, ⟨61650, 95820⟩, ⟨3511, 3827⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨568651482, 871880652⟩, ⟨130935119, 140444671⟩, ⟨(-2782581), (-1795843)⟩, ⟨(-148202), (-136147)⟩, ⟨1133, 1764⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4418135172, 4585733000⟩, ⟨61503989, 102903711⟩, ⟨8008439, 10572806⟩, ⟨105806, 354982⟩, ⟨7869, 22223⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨584958846, 930906246⟩, ⟨142833074, 170842168⟩, ⟨(-35655), 3663878⟩, ⟨33245, 252024⟩, ⟨(-4970), 12707⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-846827965), (-564551976)⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3448139331, 3730415320⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨79669256, 201767879⟩, ⟨38906684, 74057860⟩, ⟨4734588, 8383883⟩, ⟨6216, 400730⟩, ⟨23, 28686⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4374636552, 4496735175⟩, ⟨38906684, 74057860⟩, ⟨4734588, 8383883⟩, ⟨6216, 400730⟩, ⟨23, 28686⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4334618890, 4394693450⟩, ⟨19011898, 36690203⟩, ⟨2160415, 4111902⟩, ⟨(-31727), 189057⟩, ⟨(-3541), 13944⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3479972919, 3817032970⟩, ⟨(-129151753), (-110573534)⟩, ⟨528765, 2946660⟩, ⟨(-162680), 93214⟩, ⟨(-9289), 13155⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5753141719, 8629712592⟩, ⟨1438285429, 1438285441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7706377571, 17339349590⟩, ⟨3853188782, 5779783234⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7706377571, 17339349590⟩, ⟨3853188782, 5779783234⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17339349590), (-7706377571)⟩, ⟨(-5779783234), (-3853188782)⟩, ⟨(-481648606), (-481648597)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8669674795), (-3853188785)⟩, ⟨(-2889891617), (-1926594391)⟩, ⟨(-240824303), (-240824298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨570568510, 1751203942⟩, ⟨(-1178306899), (-255940037)⟩, ⟨(-40788705), 364422532⟩, ⟨(-72167291), 53194415⟩, ⟨(-19164855), 13283075⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨462299902, 1556333896⟩, ⟨(-1099847105), (-222063197)⟩, ⟨(-29590434), 360504126⟩, ⟨(-75969776), 48508095⟩, ⟨(-18689161), 14275087⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨705689970, 705689971⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4360384032, 4360384035⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2942
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨564551976, 846827965⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4334618890, 4394693450⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2943
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (30750527 / 2147483648)

theorem envelope_integral : (∫ s in ((26289 / 200000) : ℝ)..(78867 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26289 / 200000) : ℝ)..(78867 / 400000), prawitzNormalCorrection
