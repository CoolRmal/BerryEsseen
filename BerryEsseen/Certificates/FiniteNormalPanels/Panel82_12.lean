...
namespace FiniteNormalPanel82_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (235529 / 800000)
def radius : Rat := (33647 / 800000)

def j0 : Jet := ⟨⟨1264486690, 1264486691⟩, ⟨180640955, 180640956⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3972502095, 3972502100⟩, ⟨567500297, 567500301⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3674247510, 3674247520⟩, ⟨1049784998, 1049785008⟩, ⟨74984642, 74984644⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨919, 921⟩, ⟨262, 263⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93768), (-93765)⟩, ⟨262, 263⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-80217), (-80213)⟩, ⟨(-22695), (-22693)⟩, ⟨(-1559), (-1555)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5032839, 5032844⟩, ⟨(-22695), (-22693)⟩, ⟨(-1559), (-1555)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4305480, 4305485⟩, ⟨1210721, 1210726⟩, ⟨80984, 80992⟩, ⟨(-773), (-767)⟩, ⟨(-27), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-138860097), (-138860091)⟩, ⟨1210721, 1210726⟩, ⟨80984, 80992⟩, ⟨(-773), (-767)⟩, ⟨(-27), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-118791677), (-118791671)⟩, ⟨(-32904736), (-32904728)⟩, ⟨(-2059115), (-2059103)⟩, ⟨40269, 40279⟩, ⟨1200, 1209⟩⟩
...
def j19 : Jet := ⟨⟨1312864088, 1312864095⟩, ⟨(-32904736), (-32904728)⟩, ⟨(-2059115), (-2059103)⟩, ⟨40269, 40279⟩, ⟨1200, 1209⟩⟩
...
def j22 : Jet := ⟨⟨(-93), (-91)⟩, ⟨(-27), (-26)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11742, 11745⟩, ⟨(-27), (-26)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10045, 10048⟩, ⟨2846, 2849⟩, ⟨196, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842132), (-842128)⟩, ⟨2846, 2849⟩, ⟨196, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-720425), (-720421)⟩, ⟨(-203402), (-203396)⟩, ⟨(-13841), (-13833)⟩, ⟨94, 99⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35070969, 35070974⟩, ⟨(-203402), (-203396)⟩, ⟨(-13841), (-13833)⟩, ⟨94, 99⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨30002421, 30002427⟩, ⟨8398114, 8398122⟩, ⟨550737, 550748⟩, ⟨(-6856), (-6847)⟩, ⟨(-220), (-212)⟩⟩
...
def j33 : Jet := ⟨⟨(-685825462), (-685825455)⟩, ⟨8398114, 8398122⟩, ⟨550737, 550748⟩, ⟨(-6856), (-6847)⟩, ⟨(-220), (-212)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-586708194), (-586708185)⟩, ⟨(-160446517), (-160446505)⟩, ⟨(-9449810), (-9449796)⟩, ⟨275366, 275379⟩, ⟨7750, 7762⟩⟩
...
def j36 : Jet := ⟨⟨3708259102, 3708259111⟩, ⟨(-160446517), (-160446505)⟩, ⟨(-9449810), (-9449796)⟩, ⟨275366, 275379⟩, ⟨7750, 7762⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1214294540, 1214294549⟩, ⟨143036391, 143036403⟩, ⟨(-6252269), (-6252254)⟩, ⟨(-234829), (-234817)⟩, ⟨6429, 6442⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4974502461, 4974502474⟩, ⟨215233485, 215233504⟩, ⟨21989155, 21989180⟩, ⟨1130480, 1130503⟩, ⟨78549, 78573⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1406416105, 1406416120⟩, ⟨226519005, 226519028⟩, ⟨6143376, 6143404⟩, ⟨466621, 466648⟩, ⟨23522, 23551⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1264486691), (-1264486690)⟩, ⟨(-180640956), (-180640955)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3030480605, 3030480606⟩, ⟨(-180640956), (-180640955)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨460540470, 460540481⟩, ⟨148350362, 148350380⟩, ⟨15970120, 15970143⟩, ⟨953606, 953630⟩, ⟨73409, 73436⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4755507766, 4755507777⟩, ⟨148350362, 148350380⟩, ⟨15970120, 15970143⟩, ⟨953606, 953630⟩, ⟨73409, 73436⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4519374993, 4519374999⟩, ⟨70492042, 70492052⟩, ⟨7038806, 7038818⟩, ⟨343336, 343351⟩, ⟨24044, 24059⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3188820151, 3188820157⟩, ⟨(-140340873), (-140340863)⟩, ⟨2001694, 2001704⟩, ⟨(-53790), (-53778)⟩, ⟨2524, 2536⟩⟩
...
def j47 : Jet := ⟨⟨8063631722, 8063631731⟩, ⟨1151947384, 1151947391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15139150560, 15139150595⟩, ⟨4325471570, 4325471602⟩, ⟨308962253, 308962258⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15139150560, 15139150595⟩, ⟨4325471570, 4325471602⟩, ⟨308962253, 308962258⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15139150595), (-15139150560)⟩, ⟨(-4325471602), (-4325471570)⟩, ⟨(-308962258), (-308962253)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7569575298), (-7569575280)⟩, ⟨(-2162735801), (-2162735785)⟩, ⟨(-154481129), (-154481126)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨737134320, 737134331⟩, ⟨(-371184854), (-371184845)⟩, ⟨66942076, 66942081⟩, ⟨(-2335752), (-2335750)⟩, ⟨(-909843), (-909841)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨547289097, 547289107⟩, ⟨(-299674418), (-299674407)⟩, ⟨62173734, 62173744⟩, ⟨(-4103794), (-4103786)⟩, ⟨(-562918), (-562909)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1083845734, 1445127647⟩, ⟨180640955, 180640956⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3405001795, 4540002400⟩, ⟨567500297, 567500301⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2699447149, 4799017169⟩, ⟨899815712, 1199754296⟩, ⟨74984642, 74984644⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨675, 1203⟩, ⟨225, 301⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94012), (-93483)⟩, ⟨225, 301⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-105046), (-58755)⟩, ⟨(-26121), (-19248)⟩, ⟨(-1584), (-1525)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5008010, 5054302⟩, ⟨(-26121), (-19248)⟩, ⟨(-1584), (-1525)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3147604, 5647467⟩, ⟨1020014, 1399770⟩, ⟨78366, 83252⟩, ⟨(-897), (-641)⟩, ⟨(-27), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140017973), (-137518109)⟩, ⟨1020014, 1399770⟩, ⟨78366, 83252⟩, ⟨(-897), (-641)⟩, ⟨(-27), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-156450239), (-86432059)⟩, ⟨(-38471467), (-27246641)⟩, ⟨(-2181584), (-1916855)⟩, ⟨33223, 47293⟩, ⟨1086, 1308⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1275205526, 1345223707⟩, ⟨(-38471467), (-27246641)⟩, ⟨(-2181584), (-1916855)⟩, ⟨33223, 47293⟩, ⟨1086, 1308⟩⟩
...
def j70 : Jet := ⟨⟨(-121), (-67)⟩, ⟨(-31), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11714, 11769⟩, ⟨(-31), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7362, 13151⟩, ⟨2419, 3275⟩, ⟨192, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844815), (-839025)⟩, ⟨2419, 3275⟩, ⟨192, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-943962), (-527338)⟩, ⟨(-234471), (-172119)⟩, ⟨(-14124), (-13507)⟩, ⟨79, 115⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34847432, 35264057⟩, ⟨(-234471), (-172119)⟩, ⟨(-14124), (-13507)⟩, ⟨79, 115⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21902099, 39402586⟩, ⟨7038710, 9742468⟩, ⟨527111, 571118⟩, ⟨(-7991), (-5704)⟩, ⟨(-231), (-197)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-693925784), (-676425296)⟩, ⟨7038710, 9742468⟩, ⟨527111, 571118⟩, ⟨(-7991), (-5704)⟩, ⟨(-231), (-197)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-775363705), (-425142780)⟩, ⟨(-189417000), (-130828431)⟩, ⟨(-10309120), (-8449920)⟩, ⟨224389, 326043⟩, ⟨6710, 8653⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3519603591, 3869824516⟩, ⟨(-189417000), (-130828431)⟩, ⟨(-10309120), (-8449920)⟩, ⟨224389, 326043⟩, ⟨6710, 8653⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1010968607, 1421970981⟩, ⟨127828438, 156145543⟩, ⟨(-7389340), (-5119799)⟩, ⟨(-261918), (-203284)⟩, ⟨5249, 7632⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4766816685, 5241142532⟩, ⟨161153339, 282066282⟩, ⟨15856701, 30531769⟩, ⟨446376, 2165436⟩, ⟨14228, 186609⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1122034626, 1735229183⟩, ⟨179804790, 283930245⟩, ⟨(-488475), 14680797⟩, ⟨(-227903), 1409209⟩, ⟨(-47272), 123295⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1445127647), (-1083845734)⟩, ⟨(-180640956), (-180640955)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2849839649, 3211121562⟩, ⟨(-180640956), (-180640955)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨293124863, 701057799⟩, ⟨93945860, 229423888⟩, ⟨7132657, 30632477⟩, ⟨(-248738), 3079710⟩, ⟨(-70002), 336128⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4588092159, 4996025095⟩, ⟨93945860, 229423888⟩, ⟨7132657, 30632477⟩, ⟨(-248738), 3079710⟩, ⟨(-70002), 336128⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4439110921, 4632252627⟩, ⟨43552719, 110987101⟩, ⟨1977050, 14605250⟩, ⟨(-485494), 1470457⟩, ⟨(-94657), 174306⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2945483268, 3463292097⟩, ⟨(-165928221), (-103724226)⟩, ⟨(-3356148), 9087807⟩, ⟨(-977258), 1016232⟩, ⟨(-132617), 150740⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6911684331, 9215579122⟩, ⟨1151947384, 1151947391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11122641221, 19773584454⟩, ⟨3707547058, 4943396118⟩, ⟨308962253, 308962258⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11122641221, 19773584454⟩, ⟨3707547058, 4943396118⟩, ⟨308962253, 308962258⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19773584454), (-11122641221)⟩, ⟨(-4943396118), (-3707547058)⟩, ⟨(-308962258), (-308962253)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9886792227), (-5561320610)⟩, ⟨(-2471698059), (-1853773529)⟩, ⟨(-154481129), (-154481126)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨429770356, 1176563721⟩, ⟨(-677097185), (-185495454)⟩, ⟨(-2287238), 179372377⟩, ⟨(-29960901), 16674620⟩, ⟨(-5624835), 4351662⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨294735979, 948734544⟩, ⟨(-591438836), (-137591583)⟩, ⟨1716025, 173286734⟩, ⟨(-32789408), 14341601⟩, ⟨(-5516542), 5241390⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1264486690, 1264486691⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4519374993, 4519374999⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1658
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1083845734, 1445127647⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4439110921, 4632252627⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1659
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (23934035 / 2147483648)

theorem envelope_integral : (∫ s in ((100941 / 400000) : ℝ)..(33647 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((100941 / 400000) : ℝ)..(33647 / 100000), prawitzNormalCorrection
