...
namespace FiniteNormalPanel157_11
...
def j2 : Jet := ⟨⟨428673804, 428673808⟩, ⟨428673804, 428673808⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨42785245, 42785247⟩, ⟨85570490, 85570494⟩, ⟨42785245, 42785247⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-944), (-943)⟩, ⟨(-1887), (-1885)⟩, ⟨(-944), (-941)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112112, 5112114⟩, ⟨(-1887), (-1885)⟩, ⟨(-944), (-941)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨50925, 50926⟩, ⟨101831, 101833⟩, ⟨50877, 50880⟩, ⟨(-38), (-35)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143114652), (-143114650)⟩, ⟨101831, 101833⟩, ⟨50877, 50880⟩, ⟨(-38), (-35)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1425668), (-1425667)⟩, ⟨(-2850322), (-2850320)⟩, ⟨(-1423134), (-1423131)⟩, ⟨2026, 2029⟩, ⟨504, 507⟩⟩
...
def j19 : Jet := ⟨⟨1430230097, 1430230099⟩, ⟨(-2850322), (-2850320)⟩, ⟨(-1423134), (-1423131)⟩, ⟨2026, 2029⟩, ⟨504, 507⟩⟩
...
def j28 : Jet := ⟨⟨(-8488), (-8487)⟩, ⟨(-16974), (-16972)⟩, ⟨(-8483), (-8480)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782906, 35782908⟩, ⟨(-16974), (-16972)⟩, ⟨(-8483), (-8480)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨356459, 356460⟩, ⟨712748, 712750⟩, ⟨356035, 356038⟩, ⟨(-340), (-336)⟩, ⟨(-86), (-82)⟩⟩
...
def j33 : Jet := ⟨⟨(-715471424), (-715471422)⟩, ⟨712748, 712750⟩, ⟨356035, 356038⟩, ⟨(-340), (-336)⟩, ⟨(-86), (-82)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7127324), (-7127323)⟩, ⟨(-14247548), (-14247545)⟩, ⟨(-7109578), (-7109575)⟩, ⟨14189, 14192⟩, ⟨3538, 3541⟩⟩
...
def j36 : Jet := ⟨⟨4287839972, 4287839973⟩, ⟨(-14247548), (-14247545)⟩, ⟨(-7109578), (-7109575)⟩, ⟨14189, 14192⟩, ⟨3538, 3541⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨142748974, 142748976⟩, ⟨142464487, 142464491⟩, ⟨(-426528), (-426525)⟩, ⟨(-141839), (-141837)⟩, ⟨252, 254⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302106466, 4302106468⟩, ⟨14294948, 14294953⟩, ⟨7180728, 7180734⟩, ⟨33321, 33328⟩, ⟨8414, 8422⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨142986253, 142986256⟩, ⟨143176404, 143176411⟩, ⟨285588, 285595⟩, ⟨95797, 95803⟩, ⟨449, 456⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-136451111), (-136451110)⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4158516185, 4158516186⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4760238, 4760239⟩, ⟨9533136, 9533140⟩, ⟨4791921, 4791925⟩, ⟨25418, 25422⟩, ⟨6432, 6439⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299727534, 4299727535⟩, ⟨9533136, 9533140⟩, ⟨4791921, 4791925⟩, ⟨25418, 25422⟩, ⟨6432, 6439⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297346755, 4297346757⟩, ⟨4763928, 4763931⟩, ⟨2391992, 2391996⟩, ⟨10049, 10053⟩, ⟨2536, 2542⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4160820048, 4160820052⟩, ⟨(-131914129), (-131914124)⟩, ⟨2164647, 2164654⟩, ⟨(-66265), (-66259)⟩, ⟨2135, 2143⟩⟩
...
def j47 : Jet := ⟨⟨1582656640, 1582656653⟩, ⟨1582656640, 1582656653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨583194671, 583194681⟩, ⟨1166389342, 1166389362⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨583194671, 583194681⟩, ⟨1166389342, 1166389362⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-583194681), (-583194671)⟩, ⟨(-1166389362), (-1166389342)⟩, ⟨(-583194681), (-583194671)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-291597341), (-291597335)⟩, ⟨(-583194681), (-583194671)⟩, ⟨(-291597341), (-291597335)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4013048369, 4013048375⟩, ⟨(-544914154), (-544914142)⟩, ⟨(-235461334), (-235461325)⟩, ⟨35321247, 35321250⟩, ⟨6794034, 6794036⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3887706461, 3887706471⟩, ⟨(-651149900), (-651149881)⟩, ⟨(-209348170), (-209348150)⟩, ⟨41113361, 41113376⟩, ⟨5388714, 5388730⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 272902222⟩, ⟨136451110, 136451111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 857347616⟩, ⟨428673804, 428673808⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 171140986⟩, ⟨0, 171140986⟩, ⟨42785245, 42785247⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3773), 0⟩, ⟨(-3773), 2⟩, ⟨(-944), (-939)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109283, 5113057⟩, ⟨(-3773), 2⟩, ⟨(-944), (-939)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 203740⟩, ⟨(-151), 203741⟩, ⟨50708, 50936⟩, ⟨(-76), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142961836)⟩, ⟨(-151), 203741⟩, ⟨50708, 50936⟩, ⟨(-76), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5704700), 0⟩, ⟨(-5704707), 8119⟩, ⟨(-1426182), (-1413996)⟩, ⟨(-6), 4061⟩, ⟨500, 509⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425951065, 1431655766⟩, ⟨(-5704707), 8119⟩, ⟨(-1426182), (-1413996)⟩, ⟨(-6), 4061⟩, ⟨500, 509⟩⟩
...
def j72 : Jet := ⟨⟨0, 472⟩, ⟨(-1), 472⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851704)⟩, ⟨(-1), 472⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-33957), 0⟩, ⟨(-33958), 19⟩, ⟨(-8491), (-8460)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35757437, 35791395⟩, ⟨(-33958), 19⟩, ⟨(-8491), (-8460)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1426175⟩, ⟨(-1354), 1426176⟩, ⟨354512, 356545⟩, ⟨(-679), 2⟩, ⟨(-87), (-82)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714401707)⟩, ⟨(-1354), 1426176⟩, ⟨354512, 356545⟩, ⟨(-679), 2⟩, ⟨(-87), (-82)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-28523498), 0⟩, ⟨(-28523552), 56829⟩, ⟨(-7130929), (-7045630)⟩, ⟨(-42), 28417⟩, ⟨3499, 3553⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4266443798, 4294967296⟩, ⟨(-28523552), 56829⟩, ⟨(-7130929), (-7045630)⟩, ⟨(-42), 28417⟩, ⟨3499, 3553⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 285782539⟩, ⟨141183135, 142892891⟩, ⟨(-854068), 811⟩, ⟨(-142347), (-140317)⟩, ⟨(-1), 508⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4323681490⟩, ⟨(-57592), 28906219⟩, ⟨7045247, 7419852⟩, ⟨(-28995), 97964⟩, ⟨7595, 9537⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 287693151⟩, ⟨141179302, 145771597⟩, ⟨(-861695), 1456233⟩, ⟨80611, 113072⟩, ⟨(-3402), 4411⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-272902222), 0⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4022065074, 4294967296⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19270776⟩, ⟨0, 19528666⟩, ⟨4525246, 5142590⟩, ⟨(-58494), 113998⟩, ⟨4549, 8762⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314238072⟩, ⟨0, 19528666⟩, ⟨4525246, 5142590⟩, ⟨(-58494), 113998⟩, ⟨4549, 8762⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304591901⟩, ⟨0, 9764333⟩, ⟨2246489, 2571295⟩, ⟨(-35093), 56999⟩, ⟨1371, 3874⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4022065074, 4304591901⟩, ⟨(-136756885), (-126686777)⟩, ⟨1793534, 2571295⟩, ⟨(-116784), (-14371)⟩, ⟨(-528), 4989⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3165313305⟩, ⟨1582656640, 1582656653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2332778722⟩, ⟨0, 2332778724⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2332778722⟩, ⟨0, 2332778724⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2332778722), 0⟩, ⟨(-2332778724), 0⟩, ⟨(-583194681), (-583194671)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1166389361), 0⟩, ⟨(-1166389362), 0⟩, ⟨(-291597341), (-291597335)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3273542576, 4294967296⟩, ⟨(-1166389362), 0⟩, ⟨(-291597341), (-63871084)⟩, ⟨0, 79189436⟩, ⟨(-3208200), 9898680⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3065541680, 4304591901⟩, ⟨(-1305760013), (-96558257)⟩, ⟨(-290883786), (-20102190)⟩, ⟨1068903, 88640747⟩, ⟨(-5911978), 9930896⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297346755, 4297346757⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3174
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304591901⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3175
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (121358539 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(3177 / 50000), prawitzNormalCorrection
