...
namespace FiniteNormalPanel17_20
...
def j2 : Jet := ⟨⟨2018642771, 2018642776⟩, ⟨672880922, 672880927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨948765929, 948765934⟩, ⟨632510616, 632510626⟩, ⟨105418436, 105418438⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨237, 238⟩, ⟨158, 159⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94450), (-94448)⟩, ⟨158, 159⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-20865), (-20863)⟩, ⟨(-13876), (-13873)⟩, ⟨(-2291), (-2288)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5092191, 5092194⟩, ⟨(-13876), (-13873)⟩, ⟨(-2291), (-2288)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1124874, 1124875⟩, ⟨746850, 746853⟩, ⟨122435, 122439⟩, ⟨(-678), (-674)⟩, ⟨(-57), (-53)⟩⟩
...
def j16 : Jet := ⟨⟨(-142040703), (-142040701)⟩, ⟨746850, 746853⟩, ⟨122435, 122439⟩, ⟨(-678), (-674)⟩, ⟨(-57), (-53)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-31377045), (-31377043)⟩, ⟨(-20753050), (-20753047)⟩, ⟨(-3349307), (-3349303)⟩, ⟨36211, 36216⟩, ⟨2892, 2896⟩⟩
...
def j19 : Jet := ⟨⟨1400278720, 1400278723⟩, ⟨(-20753050), (-20753047)⟩, ⟨(-3349307), (-3349303)⟩, ⟨36211, 36216⟩, ⟨2892, 2896⟩⟩
...
def j25 : Jet := ⟨⟨2609, 2610⟩, ⟨1735, 1737⟩, ⟨285, 288⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849568), (-849566)⟩, ⟨1735, 1737⟩, ⟨285, 288⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-187672), (-187670)⟩, ⟨(-124732), (-124729)⟩, ⟨(-20536), (-20532)⟩, ⟨82, 86⟩, ⟨4, 8⟩⟩
...
def j30 : Jet := ⟨⟨35603722, 35603725⟩, ⟨(-124732), (-124729)⟩, ⟨(-20536), (-20532)⟩, ⟨82, 86⟩, ⟨4, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7864925, 7864927⟩, ⟨5215729, 5215733⟩, ⟨850973, 850978⟩, ⟨(-6069), (-6065)⟩, ⟨(-493), (-488)⟩⟩
...
def j33 : Jet := ⟨⟨(-707962958), (-707962955)⟩, ⟨5215729, 5215733⟩, ⟨850973, 850978⟩, ⟨(-6069), (-6065)⟩, ⟨(-493), (-488)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-156390280), (-156390278)⟩, ⟨(-103108025), (-103108019)⟩, ⟨(-16420608), (-16420604)⟩, ⟨251997, 252002⟩, ⟨19883, 19887⟩⟩
...
def j36 : Jet := ⟨⟨4138577016, 4138577018⟩, ⟨(-103108025), (-103108019)⟩, ⟨(-16420608), (-16420604)⟩, ⟨251997, 252002⟩, ⟨19883, 19887⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨658133652, 658133656⟩, ⟨209623910, 209623915⟩, ⟨(-4825506), (-4825501)⟩, ⟨(-507708), (-507704)⟩, ⟨7032, 7036⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4457267315, 4457267318⟩, ⟨111047830, 111047839⟩, ⟨20451700, 20451708⟩, ⟨678726, 678736⟩, ⟨69873, 69883⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨683003481, 683003487⟩, ⟨234561532, 234561542⟩, ⟨3545930, 3545940⟩, ⟨450526, 450537⟩, ⟨15023, 15035⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-642553952), (-642553951)⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3652413344, 3652413345⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨108614041, 108614044⟩, ⟨74601890, 74601896⟩, ⟨13937911, 13937919⟩, ⟨530596, 530604⟩, ⟨56913, 56922⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4403581337, 4403581340⟩, ⟨74601890, 74601896⟩, ⟨13937911, 13937919⟩, ⟨530596, 530604⟩, ⟨56913, 56922⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4348935252, 4348935254⟩, ⟨36838060, 36838064⟩, ⟨6726453, 6726459⟩, ⟨205027, 205034⟩, ⟨21164, 21170⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3698307356, 3698307360⟩, ⟨(-185549111), (-185549104)⟩, ⟨3883064, 3883071⟩, ⟨(-161088), (-161079)⟩, ⟨7772, 7779⟩⟩
...
def j47 : Jet := ⟨⟨2923104380, 2923104386⟩, ⟨974368125, 974368131⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1989430565, 1989430574⟩, ⟨1326287040, 1326287054⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1989430565, 1989430574⟩, ⟨1326287040, 1326287054⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1989430574), (-1989430565)⟩, ⟨(-1326287054), (-1326287040)⟩, ⟨(-221047843), (-221047839)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-994715287), (-994715282)⟩, ⟨(-663143527), (-663143520)⟩, ⟨(-110523922), (-110523919)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3407039526, 3407039533⟩, ⟨(-526047362), (-526047354)⟩, ⟨(-47063671), (-47063666)⟩, ⟨11446854, 11446856⟩, ⟨163703, 163705⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2933731149, 2933731159⟩, ⟨(-600157769), (-600157754)⟩, ⟨(-14719219), (-14719203)⟩, ⟨11286484, 11286499⟩, ⟨(-370219), (-370206)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨428369300, 856738602⟩, ⟨214184650, 214184651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1345761845, 2691523699⟩, ⟨672880922, 672880927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨421673744, 1686694991⟩, ⟨421673744, 843347500⟩, ⟨105418436, 105418438⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨105, 423⟩, ⟨105, 212⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94582), (-94263)⟩, ⟨105, 212⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-37144), (-9254)⟩, ⟨(-18562), (-9170)⟩, ⟨(-2310), (-2260)⟩, ⟨4, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5075912, 5103803⟩, ⟨(-18562), (-9170)⟩, ⟨(-2310), (-2260)⟩, ⟨4, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨498345, 2004337⟩, ⟨491055, 1001269⟩, ⟨120033, 124151⟩, ⟨(-910), (-441)⟩, ⟨(-57), (-51)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142667232), (-141161239)⟩, ⟨491055, 1001269⟩, ⟨120033, 124151⟩, ⟨(-910), (-441)⟩, ⟨(-57), (-51)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-56027460), (-13859008)⟩, ⟨(-27965519), (-13465795)⟩, ⟨(-3441722), (-3219389)⟩, ⟨23478, 48911⟩, ⟨2744, 3000⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1375628305, 1417796758⟩, ⟨(-27965519), (-13465795)⟩, ⟨(-3441722), (-3219389)⟩, ⟨23478, 48911⟩, ⟨2744, 3000⟩⟩
...
def j70 : Jet := ⟨⟨(-43), (-10)⟩, ⟨(-22), (-10)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11792, 11826⟩, ⟨(-22), (-10)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1157, 4645⟩, ⟨1148, 2323⟩, ⟨282, 291⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851020), (-847531)⟩, ⟨1148, 2323⟩, ⟨282, 291⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-334208), (-83209)⟩, ⟨(-166992), (-82296)⟩, ⟨(-20749), (-20230)⟩, ⟨54, 116⟩, ⟨4, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35457186, 35708186⟩, ⟨(-166992), (-82296)⟩, ⟨(-20749), (-20230)⟩, ⟨54, 116⟩, ⟨4, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3481135, 14023115⟩, ⟨3415554, 7003479⟩, ⟨829343, 866380⟩, ⟨(-8169), (-3959)⟩, ⟨(-505), (-469)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712346748), (-701804767)⟩, ⟨3415554, 7003479⟩, ⟨829343, 866380⟩, ⟨(-8169), (-3959)⟩, ⟨(-505), (-469)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-279748741), (-68902187)⟩, ⟨(-139539038), (-66151820)⟩, ⟨(-17067540), (-15510122)⟩, ⟨162047, 341630⟩, ⟨18551, 20831⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4015218555, 4226065109⟩, ⟨(-139539038), (-66151820)⟩, ⟨(-17067540), (-15510122)⟩, ⟨162047, 341630⟩, ⟨18551, 20831⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨431031939, 888489554⟩, ⟨197990839, 217903091⟩, ⟨(-6538105), (-3118394)⟩, ⟨(-531850), (-473720)⟩, ⟨4537, 9544⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4364992871, 4594206722⟩, ⟨68326495, 159660347⟩, ⟨17089535, 25077256⟩, ⟨146880, 1374007⟩, ⟨29465, 131426⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨438059526, 950392495⟩, ⟨208075973, 266113411⟩, ⟨(-2128830), 10118727⟩, ⟨(-9414), 1025470⟩, ⟨(-43609), 87164⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-856738602), (-428369300)⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3438228694, 3866597996⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨44679303, 210303324⟩, ⟨42444868, 117771416⟩, ⟨9138406, 20966370⟩, ⟨(-267970), 1707734⟩, ⟨(-25484), 189492⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4339646599, 4505270620⟩, ⟨42444868, 117771416⟩, ⟨9138406, 20966370⟩, ⟨(-267970), 1707734⟩, ⟨(-25484), 189492⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4317249149, 4398862350⟩, ⟨20721189, 58581792⟩, ⟨4071203, 10379354⟩, ⟨(-274134), 829921⟩, ⟨(-36416), 96059⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3456065874, 3960130818⟩, ⟨(-202777939), (-162556827)⟩, ⟨337698, 8310805⟩, ⟨(-764399), 544122⟩, ⟨(-74172), 100150⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1948736250, 3897472512⟩, ⟨974368125, 974368131⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨884191359, 3536765460⟩, ⟨884191358, 1768382736⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨884191359, 3536765460⟩, ⟨884191358, 1768382736⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3536765460), (-884191359)⟩, ⟨(-1768382736), (-884191358)⟩, ⟨(-221047843), (-221047839)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1768382730), (-442095679)⟩, ⟨(-884191368), (-442095679)⟩, ⟨(-110523922), (-110523919)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2845418767, 3874863822⟩, ⟨(-797705992), (-292888689)⟩, ⟨(-84639233), 8888437⟩, ⟨4414727, 19493239⟩, ⟨(-1117618), 975421⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2289646001, 3572778692⟩, ⟨(-918460309), (-343375104)⟩, ⟨(-66731706), 53355422⟩, ⟨899582, 22437481⟩, ⟨(-2282578), 981816⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4348935252, 4348935254⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified352
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4317249149, 4398862350⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified353
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (292133245 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((7979 / 80000) : ℝ)..(7979 / 40000), prawitzNormalCorrection
