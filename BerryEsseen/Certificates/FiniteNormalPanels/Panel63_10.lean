...
namespace FiniteNormalPanel63_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (16457 / 50000)
def radius : Rat := (2351 / 50000)

def j0 : Jet := ⟨⟨1413645535, 1413645536⟩, ⟨201949362, 201949363⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4441098427, 4441098431⟩, ⟨634442632, 634442636⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4592201495, 4592201504⟩, ⟨1312057568, 1312057580⟩, ⟨93718397, 93718399⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1149, 1151⟩, ⟨328, 329⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93538), (-93535)⟩, ⟨328, 329⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-100012), (-100008)⟩, ⟨(-28225), (-28221)⟩, ⟨(-1918), (-1913)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5013044, 5013049⟩, ⟨(-28225), (-28221)⟩, ⟨(-1918), (-1913)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5359972, 5359979⟩, ⟨1501241, 1501249⟩, ⟨98713, 98722⟩, ⟨(-1188), (-1181)⟩, ⟨(-38), (-34)⟩⟩
...
def j16 : Jet := ⟨⟨(-137805605), (-137805597)⟩, ⟨1501241, 1501249⟩, ⟨98713, 98722⟩, ⟨(-1188), (-1181)⟩, ⟨(-38), (-34)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-147342474), (-147342465)⟩, ⟨(-40492716), (-40492703)⟩, ⟨(-2442837), (-2442821)⟩, ⟨61641, 61656⟩, ⟨1749, 1759⟩⟩
...
def j19 : Jet := ⟨⟨1284313291, 1284313301⟩, ⟨(-40492716), (-40492703)⟩, ⟨(-2442837), (-2442821)⟩, ⟨61641, 61656⟩, ⟨1749, 1759⟩⟩
...
def j22 : Jet := ⟨⟨(-116), (-114)⟩, ⟨(-33), (-32)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11719, 11722⟩, ⟨(-33), (-32)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨12530, 12534⟩, ⟨3544, 3547⟩, ⟨240, 245⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-839647), (-839642)⟩, ⟨3544, 3547⟩, ⟨240, 245⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-897755), (-897749)⟩, ⟨(-252713), (-252706)⟩, ⟨(-16984), (-16975)⟩, ⟨147, 153⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34893639, 34893646⟩, ⟨(-252713), (-252706)⟩, ⟨(-16984), (-16975)⟩, ⟨147, 153⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨37308461, 37308469⟩, ⟨10389357, 10389369⟩, ⟨666036, 666051⟩, ⟨(-10547), (-10535)⟩, ⟨(-325), (-316)⟩⟩
...
def j33 : Jet := ⟨⟨(-678519422), (-678519413)⟩, ⟨10389357, 10389369⟩, ⟨666036, 666051⟩, ⟨(-10547), (-10535)⟩, ⟨(-325), (-316)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-725476516), (-725476504)⟩, ⟨(-196170652), (-196170633)⟩, ⟨(-10919700), (-10919676)⟩, ⟨418889, 418909⟩, ⟨10963, 10979⟩⟩
...
def j36 : Jet := ⟨⟨3569490780, 3569490792⟩, ⟨(-196170652), (-196170633)⟩, ⟨(-10919700), (-10919676)⟩, ⟨418889, 418909⟩, ⟨10963, 10979⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1328010516, 1328010528⟩, ⟨147845354, 147845373⟩, ⟨(-8507443), (-8507423)⟩, ⟨(-297113), (-297093)⟩, ⟨10913, 10927⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5167892326, 5167892344⟩, ⟨284014938, 284014970⟩, ⟨31418234, 31418275⟩, ⟨1989024, 1989062⟩, ⟨156195, 156228⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1597920282, 1597920303⟩, ⟨265711847, 265711882⟩, ⟨9254664, 9254706⟩, ⟨776441, 776484⟩, ⟨48011, 48047⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1413645536), (-1413645535)⟩, ⟨(-201949363), (-201949362)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2881321760, 2881321761⟩, ⟨(-201949363), (-201949362)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨594497944, 594497960⟩, ⟨197713426, 197713456⟩, ⟨23324790, 23324829⟩, ⟨1722834, 1722876⟩, ⟨151735, 151770⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4889465240, 4889465256⟩, ⟨197713426, 197713456⟩, ⟨23324790, 23324829⟩, ⟨1722834, 1722876⟩, ⟨151735, 151770⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4582585874, 4582585883⟩, ⟨92652131, 92652146⟩, ⟨9993788, 9993808⟩, ⟨605292, 605315⟩, ⟨47968, 47988⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3074273559, 3074273567⟩, ⟨(-153316582), (-153316568)⟩, ⟨2347928, 2347944⟩, ⟨(-63843), (-63825)⟩, ⟨3717, 3734⟩⟩
...
def j47 : Jet := ⟨⟨7292052235, 7292052243⟩, ⟨1041721747, 1041721753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12380542652, 12380542680⟩, ⟨3537297896, 3537297922⟩, ⟨252664135, 252664139⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12380542652, 12380542680⟩, ⟨3537297896, 3537297922⟩, ⟨252664135, 252664139⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12380542680), (-12380542652)⟩, ⟨(-3537297922), (-3537297896)⟩, ⟨(-252664139), (-252664135)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6190271340), (-6190271326)⟩, ⟨(-1768648961), (-1768648948)⟩, ⟨(-126332070), (-126332067)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1016290339, 1016290354⟩, ⟨(-418503974), (-418503964)⟩, ⟨56275919, 56275924⟩, ⟨481849, 481852⟩, ⟨(-877256), (-877255)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨727445473, 727445486⟩, ⟨(-335837219), (-335837206)⟩, ⟨55776288, 55776300⟩, ⟨(-1907863), (-1907851)⟩, ⟨(-607266), (-607256)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1211696173, 1615594899⟩, ⟨201949362, 201949363⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3806655795, 5075541067⟩, ⟨634442632, 634442636⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3373862323, 5997977481⟩, ⟨1124620772, 1499494378⟩, ⟨93718397, 93718399⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨844, 1503⟩, ⟨281, 376⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93843), (-93183)⟩, ⟨281, 376⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-131053), (-73198)⟩, ⟨(-32544), (-23873)⟩, ⟨(-1957), (-1867)⟩, ⟨12, 18⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4982003, 5039859⟩, ⟨(-32544), (-23873)⟩, ⟨(-1957), (-1867)⟩, ⟨12, 18⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3913555, 7038229⟩, ⟨1259069, 1740805⟩, ⟨94613, 102256⟩, ⟨(-1386), (-982)⟩, ⟨(-40), (-31)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139252022), (-136127347)⟩, ⟨1259069, 1740805⟩, ⟨94613, 102256⟩, ⟨(-1386), (-982)⟩, ⟨(-40), (-31)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-194467254), (-106933276)⟩, ⟨(-47627767), (-33213368)⟩, ⟨(-2634547), (-2219801)⟩, ⟨50311, 72916⟩, ⟨1524, 1951⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1237188511, 1324722490⟩, ⟨(-47627767), (-33213368)⟩, ⟨(-2634547), (-2219801)⟩, ⟨50311, 72916⟩, ⟨1524, 1951⟩⟩
...
def j70 : Jet := ⟨⟨(-151), (-84)⟩, ⟨(-38), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11684, 11752⟩, ⟨(-38), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9178, 16412⟩, ⟨3005, 4082⟩, ⟨235, 249⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842999), (-835764)⟩, ⟨3005, 4082⟩, ⟨235, 249⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1177260), (-656524)⟩, ⟨(-291955), (-213140)⟩, ⟨(-17425), (-16462)⟩, ⟨121, 177⟩, ⟨1, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34614134, 35134871⟩, ⟨(-291955), (-213140)⟩, ⟨(-17425), (-16462)⟩, ⟨121, 177⟩, ⟨1, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨27190736, 49066303⟩, ⟨8655859, 12099147⟩, ⟨629033, 697921⟩, ⟨(-12360), (-8712)⟩, ⟨(-350), (-288)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-688637147), (-666761579)⟩, ⟨8655859, 12099147⟩, ⟨629033, 697921⟩, ⟨(-12360), (-8712)⟩, ⟨(-350), (-288)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-961690699), (-523766914)⟩, ⟨(-233623166), (-157692355)⟩, ⟨(-12265786), (-9350270)⟩, ⟨336323, 500831⟩, ⟨8920, 12722⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3333276597, 3771200382⟩, ⟨(-233623166), (-157692355)⟩, ⟨(-12265786), (-9350270)⟩, ⟨336323, 500831⟩, ⟨8920, 12722⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1096527747, 1565479534⟩, ⟨126470915, 166247732⟩, ⟨(-10148818), (-6873624)⟩, ⟨(-344580), (-241735)⟩, ⟨8781, 13077⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4891478098, 5534117418⟩, ⟨204536651, 387876013⟩, ⟨20680551, 47549948⟩, ⟨636926, 4266452⟩, ⟨7726, 440279⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1248820093, 2017139354⟩, ⟨196255236, 355589770⟩, ⟨(-1774175), 24517020⟩, ⟨(-588955), 2792983⟩, ⟨(-112751), 297865⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1615594899), (-1211696173)⟩, ⟨(-201949363), (-201949362)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2679372397, 3083271123⟩, ⟨(-201949363), (-201949362)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨363111408, 947353238⟩, ⟨114127752, 334006790⟩, ⟨7301242, 52468986⟩, ⟨(-846984), 6683096⟩, ⟨(-213558), 882213⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4658078704, 5242320534⟩, ⟨114127752, 334006790⟩, ⟨7301242, 52468986⟩, ⟨(-846984), 6683096⟩, ⟨(-213558), 882213⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4472839779, 4745060090⟩, ⟨51651080, 160362132⟩, ⟨594574, 24892994⟩, ⟨(-1299126), 3201799⟩, ⟨(-286596), 470103⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2790336366, 3406383739⟩, ⟨(-190890718), (-95192158)⟩, ⟨(-7169309), 15441550⟩, ⟨(-2103086), 2270552⟩, ⟨(-356291), 398563⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6250330488, 8333773996⟩, ⟨1041721747, 1041721753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9095908889, 16170504740⟩, ⟨3031969626, 4042626200⟩, ⟨252664135, 252664139⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9095908889, 16170504740⟩, ⟨3031969626, 4042626200⟩, ⟨252664135, 252664139⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16170504740), (-9095908889)⟩, ⟨(-4042626200), (-3031969626)⟩, ⟨(-252664139), (-252664135)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8085252370), (-4547954444)⟩, ⟨(-2021313100), (-1515984813)⟩, ⟨(-126332070), (-126332067)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨653736721, 1489649390⟩, ⟨(-701064204), (-230747959)⟩, ⟨(-3093224), 145739694⟩, ⟨(-18338038), 14232640⟩, ⟨(-3817947), 2203071⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨424716935, 1181456601⟩, ⟨(-622229174), (-164400559)⟩, ⟨174373, 152102316⟩, ⟨(-24271462), 13383287⟩, ⟨(-4398097), 3567813⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1413645535, 1413645536⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4582585874, 4582585883⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1252
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1211696173, 1615594899⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4472839779, 4745060090⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1253
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (70224479 / 4294967296)

theorem envelope_integral : (∫ s in ((7053 / 25000) : ℝ)..(2351 / 6250),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((7053 / 25000) : ℝ)..(2351 / 6250), prawitzNormalCorrection
