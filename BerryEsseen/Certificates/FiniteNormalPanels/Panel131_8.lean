...
namespace FiniteNormalPanel131_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (27037 / 160000)
def radius : Rat := (27037 / 800000)

def j0 : Jet := ⟨⟨725768942, 725768943⟩, ⟨145153788, 145153789⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2280070376, 2280070380⟩, ⟨456014074, 456014078⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1210421537, 1210421543⟩, ⟨484168612, 484168620⟩, ⟨48416861, 48416863⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-26600), (-26599)⟩, ⟨(-10606), (-10604)⟩, ⟨(-1048), (-1045)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5086456, 5086458⟩, ⟨(-10606), (-10604)⟩, ⟨(-1048), (-1045)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1433481, 1433483⟩, ⟨570402, 570405⟩, ⟨55847, 55851⟩, ⟨(-239), (-234)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-141732096), (-141732093)⟩, ⟨570402, 570405⟩, ⟨55847, 55851⟩, ⟨(-239), (-234)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-39943397), (-39943395)⟩, ⟨(-15816607), (-15816604)⟩, ⟨(-1517697), (-1517692)⟩, ⟨12657, 12663⟩, ⟨598, 602⟩⟩
...
def j19 : Jet := ⟨⟨1391712368, 1391712371⟩, ⟨(-15816607), (-15816604)⟩, ⟨(-1517697), (-1517692)⟩, ⟨12657, 12663⟩, ⟨598, 602⟩⟩
...
def j25 : Jet := ⟨⟨3326, 3328⟩, ⟨1326, 1328⟩, ⟨130, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848851), (-848848)⟩, ⟨1326, 1328⟩, ⟨130, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-239226), (-239225)⟩, ⟨(-95318), (-95315)⟩, ⟨(-9385), (-9381)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35552168, 35552170⟩, ⟨(-95318), (-95315)⟩, ⟨(-9385), (-9381)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10019426, 10019428⟩, ⟨3980907, 3980910⟩, ⟨387386, 387391⟩, ⟨(-2126), (-2122)⟩, ⟨(-104), (-100)⟩⟩
...
def j33 : Jet := ⟨⟨(-705808457), (-705808454)⟩, ⟨3980907, 3980910⟩, ⟨387386, 387391⟩, ⟨(-2126), (-2122)⟩, ⟨(-104), (-100)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-198913217), (-198913215)⟩, ⟨(-78443376), (-78443372)⟩, ⟨(-7398591), (-7398586)⟩, ⟨87945, 87950⟩, ⟨4096, 4101⟩⟩
...
def j36 : Jet := ⟨⟨4096054079, 4096054081⟩, ⟨(-78443376), (-78443372)⟩, ⟨(-7398591), (-7398586)⟩, ⟨87945, 87950⟩, ⟨4096, 4101⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨738818697, 738818701⟩, ⟨139367172, 139367177⟩, ⟨(-2485015), (-2485009)⟩, ⟨(-154422), (-154416)⟩, ⟨1660, 1665⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4503540165, 4503540168⟩, ⟨86247121, 86247128⟩, ⟨9786331, 9786339⟩, ⟨246501, 246511⟩, ⟨16034, 16046⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨774697325, 774697331⟩, ⟨160971340, 160971348⟩, ⟨1876376, 1876386⟩, ⟨148135, 148147⟩, ⟨3732, 3745⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-725768943), (-725768942)⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3569198353, 3569198354⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨139734695, 139734698⟩, ⟨58069856, 58069860⟩, ⟨6709950, 6709956⟩, ⟨194086, 194096⟩, ⟨13267, 13278⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4434701991, 4434701994⟩, ⟨58069856, 58069860⟩, ⟨6709950, 6709956⟩, ⟨194086, 194096⟩, ⟨13267, 13278⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4364275428, 4364275431⟩, ⟨28573830, 28573833⟩, ⟨3208155, 3208160⟩, ⟨74496, 74503⟩, ⟨4860, 4868⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3626794710, 3626794714⟩, ⟨(-123750757), (-123750751)⟩, ⟨1700347, 1700354⟩, ⟨(-46517), (-46509)⟩, ⟨1520, 1529⟩⟩
...
def j47 : Jet := ⟨⟨7795503216, 7795503229⟩, ⟨1559100638, 1559100650⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14149088037, 14149088086⟩, ⟨5659635196, 5659635250⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14149088037, 14149088086⟩, ⟨5659635196, 5659635250⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14149088086), (-14149088037)⟩, ⟨(-5659635250), (-5659635196)⟩, ⟨(-565963527), (-565963517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7074544043), (-7074544018)⟩, ⟨(-2829817625), (-2829817598)⟩, ⟨(-282981764), (-282981758)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨827185168, 827185181⟩, ⟨(-545006061), (-545006046)⟩, ⟨125042984, 125042994⟩, ⟨(-3523142), (-3523137)⟩, ⟨(-3539023), (-3539020)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨698499100, 698499112⟩, ⟨(-484052556), (-484052539)⟩, ⟨121620632, 121620646⟩, ⟨(-6802628), (-6802618)⟩, ⟨(-2831246), (-2831235)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨580615153, 870922731⟩, ⟨145153788, 145153789⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1824056299, 2736084454⟩, ⟨456014074, 456014078⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨774669782, 1743007019⟩, ⟨387334890, 581002344⟩, ⟨48416861, 48416863⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-38349), (-16999)⟩, ⟨(-12766), (-8439)⟩, ⟨(-1056), (-1036)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5074707, 5096058⟩, ⟨(-12766), (-8439)⟩, ⟨(-1056), (-1036)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨915308, 2068111⟩, ⟨452473, 687849⟩, ⟨55050, 56501⟩, ⟨(-287), (-186)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142250269), (-141097465)⟩, ⟨452473, 687849⟩, ⟨55050, 56501⟩, ⟨(-287), (-186)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-57728779), (-25449307)⟩, ⟨(-19161316), (-12445506)⟩, ⟨(-1552844), (-1474602)⟩, ⟨9947, 15366⟩, ⟨576, 620⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1373926986, 1406206459⟩, ⟨(-19161316), (-12445506)⟩, ⟨(-1552844), (-1474602)⟩, ⟨9947, 15366⟩, ⟨576, 620⟩⟩
...
def j72 : Jet := ⟨⟨2126, 4796⟩, ⟨1056, 1598⟩, ⟨128, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850051), (-847380)⟩, ⟨1056, 1598⟩, ⟨128, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-344973), (-152839)⟩, ⟨(-114801), (-75770)⟩, ⟨(-9465), (-9280)⟩, ⟨21, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35446421, 35638556⟩, ⟨(-114801), (-75770)⟩, ⟨(-9465), (-9280)⟩, ⟨21, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6393359, 14463033⟩, ⟨3150089, 4807345⟩, ⟨380212, 393245⟩, ⟨(-2573), (-1674)⟩, ⟨(-107), (-97)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709434524), (-701364849)⟩, ⟨3150089, 4807345⟩, ⟨380212, 393245⟩, ⟨(-2573), (-1674)⟩, ⟨(-107), (-97)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-287906583), (-126502978)⟩, ⟨(-95400691), (-61300545)⟩, ⟨(-7644744), (-7096532)⟩, ⟨68753, 107089⟩, ⟨3893, 4267⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4007060713, 4168464318⟩, ⟨(-95400691), (-61300545)⟩, ⟨(-7644744), (-7096532)⟩, ⟨68753, 107089⟩, ⟨3893, 4267⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨583501572, 895815816⟩, ⟨133668785, 144017078⟩, ⟨(-3023666), (-1947646)⟩, ⟨(-160648), (-146775)⟩, ⟨1300, 2027⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4425309338, 4603559915⟩, ⟨65077652, 109602233⟩, ⟨8490810, 11392184⟩, ⟨117386, 404401⟩, ⟨8651, 25949⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨601209456, 960180020⟩, ⟨146566571, 177224787⟩, ⟨(-62021), 4044493⟩, ⟨30847, 285608⟩, ⟨(-5954), 15074⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-870922731), (-580615153)⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3424044565, 3714352143⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨84157290, 214657204⟩, ⟨41032772, 79240512⟩, ⟨4973879, 9121261⟩, ⟨3514, 461482⟩, ⟨(-619), 34121⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4379124586, 4509624500⟩, ⟨41032772, 79240512⟩, ⟨4973879, 9121261⟩, ⟨3514, 461482⟩, ⟨(-619), 34121⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4336841809, 4400987361⟩, ⟨20022144, 39237702⟩, ⟨2252113, 4470377⟩, ⟨(-38707), 218117⟩, ⟨(-4585), 16663⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3457427868, 3806039886⟩, ⟨(-132774767), (-112635635)⟩, ⟨469347, 3189377⟩, ⟨(-184557), 112519⟩, ⟨(-11338), 15720⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6236402566, 9354603868⟩, ⟨1559100638, 1559100650⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9055416324, 20374686813⟩, ⟨4527708152, 6791562296⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9055416324, 20374686813⟩, ⟨4527708152, 6791562296⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20374686813), (-9055416324)⟩, ⟨(-6791562296), (-4527708152)⟩, ⟨(-565963527), (-565963517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10187343407), (-4527708162)⟩, ⟨(-3395781148), (-2263854076)⟩, ⟨(-282981764), (-282981758)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨400724233, 1496688110⟩, ⟨(-1183344347), (-211219579)⟩, ⟨(-42945680), 441398371⟩, ⟨(-107051626), 63296088⟩, ⟨(-27052304), 22574654⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨322581066, 1326309202⟩, ⟨(-1094904310), (-180539740)⟩, ⟨(-32473832), 428844146⟩, ⟨(-109453613), 57434389⟩, ⟨(-25996327), 23698319⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨725768942, 725768943⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4364275428, 4364275431⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2632
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨580615153, 870922731⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4336841809, 4400987361⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2633
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (25136941 / 2147483648)

theorem envelope_integral : (∫ s in ((27037 / 200000) : ℝ)..(81111 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((27037 / 200000) : ℝ)..(81111 / 400000), prawitzNormalCorrection
