...
namespace FiniteNormalPanel149_19
...
def j2 : Jet := ⟨⟨1367586835, 1367586839⟩, ⟨455862278, 455862282⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨435461697, 435461701⟩, ⟨290307798, 290307802⟩, ⟨48384633, 48384634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨108, 110⟩, ⟨72, 73⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94579), (-94576)⟩, ⟨72, 73⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9590), (-9588)⟩, ⟨(-6386), (-6384)⟩, ⟨(-1061), (-1058)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103466, 5103469⟩, ⟨(-6386), (-6384)⟩, ⟨(-1061), (-1058)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨517434, 517435⟩, ⟨344308, 344310⟩, ⟨56952, 56955⟩, ⟨(-144), (-141)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-142648143), (-142648141)⟩, ⟨344308, 344310⟩, ⟨56952, 56955⟩, ⟨(-144), (-141)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14462929), (-14462927)⟩, ⟨(-9607045), (-9607041)⟩, ⟨(-1577947), (-1577943)⟩, ⟨7712, 7715⟩, ⟨629, 633⟩⟩
...
def j19 : Jet := ⟨⟨1417192836, 1417192839⟩, ⟨(-9607045), (-9607041)⟩, ⟨(-1577947), (-1577943)⟩, ⟨7712, 7715⟩, ⟨629, 633⟩⟩
...
def j25 : Jet := ⟨⟨1198, 1200⟩, ⟨798, 800⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850979), (-850976)⟩, ⟨798, 800⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-86280), (-86279)⟩, ⟨(-57440), (-57437)⟩, ⟨(-9521), (-9517)⟩, ⟨15, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35705114, 35705116⟩, ⟨(-57440), (-57437)⟩, ⟨(-9521), (-9517)⟩, ⟨15, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3620099, 3620100⟩, ⟨2407575, 2407577⟩, ⟨397384, 397388⟩, ⟨(-1291), (-1287)⟩, ⟨(-108), (-104)⟩⟩
...
def j33 : Jet := ⟨⟨(-712207784), (-712207782)⟩, ⟨2407575, 2407577⟩, ⟨397384, 397388⟩, ⟨(-1291), (-1287)⟩, ⟨(-108), (-104)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-72209913), (-72209911)⟩, ⟨(-47895841), (-47895839)⟩, ⟨(-7820300), (-7820297)⟩, ⟨53851, 53854⟩, ⟨4377, 4381⟩⟩
...
def j36 : Jet := ⟨⟨4222757383, 4222757385⟩, ⟨(-47895841), (-47895839)⟩, ⟨(-7820300), (-7820297)⟩, ⟨53851, 53854⟩, ⟨4377, 4381⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨451257048, 451257051⟩, ⟨147359977, 147359982⟩, ⟨(-1522124), (-1522120)⟩, ⟨(-165027), (-165023)⟩, ⟨1018, 1021⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4368412009, 4368412012⟩, ⟨49547898, 49547903⟩, ⟨8652027, 8652033⟩, ⟨134181, 134189⟩, ⟨12379, 12388⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨458973624, 458973629⟩, ⟨155085681, 155085689⟩, ⟨1060868, 1060876⟩, ⟨125538, 125547⟩, ⟨1967, 1977⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-435316411), (-435316410)⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3859650885, 3859650886⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨49047355, 49047357⟩, ⟨33145880, 33145884⟩, ⟨5826676, 5826681⟩, ⟨103442, 103448⟩, ⟨9748, 9755⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4344014651, 4344014653⟩, ⟨33145880, 33145884⟩, ⟨5826676, 5826681⟩, ⟨103442, 103448⟩, ⟨9748, 9755⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4319421357, 4319421359⟩, ⟨16479113, 16479116⟩, ⟨2865409, 2865413⟩, ⟨40495, 40500⟩, ⟨3740, 3746⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3881626404, 3881626408⟩, ⟨(-131122780), (-131122774)⟩, ⟨2018238, 2018244⟩, ⟨(-60418), (-60411)⟩, ⟨1991, 1999⟩⟩
...
def j47 : Jet := ⟨⟨4035241990, 4035242001⟩, ⟨1345080663, 1345080674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3791222795, 3791222817⟩, ⟨2527481862, 2527481892⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3791222795, 3791222817⟩, ⟨2527481862, 2527481892⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3791222817), (-3791222795)⟩, ⟨(-2527481892), (-2527481862)⟩, ⟨(-421246984), (-421246977)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1895611409), (-1895611397)⟩, ⟨(-1263740946), (-1263740931)⟩, ⟨(-210623492), (-210623488)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2762365880, 2762365894⟩, ⟨(-812791961), (-812791946)⟩, ⟨(-15888346), (-15888338)⟩, ⟨28130977, 28130981⟩, ⟨(-1679720), (-1679718)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2496520135, 2496520152⟩, ⟨(-818903520), (-818903500)⟩, ⟨11752829, 11752844⟩, ⟨25487959, 25487971⟩, ⟨(-2371645), (-2371631)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨290210940, 580421881⟩, ⟨145105470, 145105471⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨911724557, 1823449118⟩, ⟨455862278, 455862282⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨193538532, 774154134⟩, ⟨193538532, 387077070⟩, ⟨48384633, 48384634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-17059), (-4257)⟩, ⟨(-8528), (-4239)⟩, ⟨(-1065), (-1052)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095997, 5108800⟩, ⟨(-8528), (-4239)⟩, ⟨(-1065), (-1052)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨229634, 920845⟩, ⟨228096, 460232⟩, ⟨56447, 57315⟩, ⟨(-193), (-93)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142935943), (-142244731)⟩, ⟨228096, 460232⟩, ⟨56447, 57315⟩, ⟨(-193), (-93)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-25763748), (-6409789)⟩, ⟨(-12871596), (-6326833)⟩, ⟨(-1597414), (-1550638)⟩, ⟨5077, 10347⟩, ⟨614, 642⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1405892017, 1425245977⟩, ⟨(-12871596), (-6326833)⟩, ⟨(-1597414), (-1550638)⟩, ⟨5077, 10347⟩, ⟨614, 642⟩⟩
...
def j72 : Jet := ⟨⟨532, 2133⟩, ⟨530, 1067⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851645), (-850043)⟩, ⟨530, 1067⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-153507), (-38304)⟩, ⟨(-76731), (-38111)⟩, ⟨(-9567), (-9454)⟩, ⟨9, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35637887, 35753091⟩, ⟨(-76731), (-38111)⟩, ⟨(-9567), (-9454)⟩, ⟨9, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1605903, 6444381⟩, ⟨1592072, 3220474⟩, ⟨392834, 400631⟩, ⟨(-1728), (-850)⟩, ⟨(-109), (-102)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714221980), (-709383501)⟩, ⟨1592072, 3220474⟩, ⟨392834, 400631⟩, ⟨(-1728), (-850)⟩, ⟨(-109), (-102)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-128736231), (-31966027)⟩, ⟨(-64296375), (-31385546)⟩, ⟨(-7956573), (-7629052)⟩, ⟨35324, 72350⟩, ⟨4249, 4472⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4166231065, 4263001269⟩, ⟨(-64296375), (-31385546)⟩, ⟨(-7956573), (-7629052)⟩, ⟨35324, 72350⟩, ⟨4249, 4472⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨298439123, 605095067⟩, ⟨143754862, 149930725⟩, ⟨(-2044365), (-1000686)⟩, ⟨(-168471), (-160189)⟩, ⟨668, 1372⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4327173019, 4427681467⟩, ⟨31857997, 68331273⟩, ⟨7978440, 9510426⟩, ⟨40606, 240584⟩, ⟨8769, 17195⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨300676962, 623792460⟩, ⟨147046481, 164190404⟩, ⟨(-486844), 2717026⟩, ⟨63660, 197078⟩, ⟨(-4567), 9191⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-580421881), (-290210940)⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3714545415, 4004756356⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21049435, 90598370⟩, ⟨20588510, 47693372⟩, ⟨4893001, 7065995⟩, ⟨(-28312), 264984⟩, ⟨2722, 19459⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316016731, 4385565666⟩, ⟨20588510, 47693372⟩, ⟨4893001, 7065995⟩, ⟨(-28312), 264984⟩, ⟨2722, 19459⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305479149, 4340030082⟩, ⟨10187369, 23788465⟩, ⟨2355903, 3512320⟩, ⟨(-33528), 126595⟩, ⟨(-776), 9247⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3723636696, 4046774250⟩, ⟨(-137817271), (-123279533)⟩, ⟨1233832, 2930813⟩, ⟨(-149927), 38447⟩, ⟨(-5002), 9756⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2690161327, 5380322665⟩, ⟨1345080663, 1345080674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1684987909, 6739951666⟩, ⟨1684987908, 3369975854⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1684987909, 6739951666⟩, ⟨1684987908, 3369975854⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6739951666), (-1684987909)⟩, ⟨(-3369975854), (-1684987908)⟩, ⟨(-421246984), (-421246977)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3369975833), (-842493954)⟩, ⟨(-1684987927), (-842493954)⟩, ⟨(-210623492), (-210623488)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1959737031, 3529956444⟩, ⟨(-1384861300), (-384418899)⟩, ⟨(-135404164), 175547469⟩, ⟨(-10388909), 62982477⟩, ⟨(-10481661), 4339020⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1699046400, 3325971040⟩, ⟨(-1418103933), (-389533066)⟩, ⟨(-115982518), 212249446⟩, ⟨(-16489777), 63608939⟩, ⟨(-12005853), 4597796⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4319421357, 4319421359⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3014
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305479149, 4340030082⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3015
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (169016715 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((6757 / 100000) : ℝ)..(6757 / 50000), prawitzNormalCorrection
