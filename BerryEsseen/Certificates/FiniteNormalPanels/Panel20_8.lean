...
namespace FiniteNormalPanel20_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (41819 / 160000)
def radius : Rat := (41819 / 800000)

def j0 : Jet := ⟨⟨1122570233, 1122570234⟩, ⟨224514046, 224514047⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3526658396, 3526658401⟩, ⟨705331677, 705331681⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2895789091, 2895789100⟩, ⟨1158315632, 1158315642⟩, ⟨115831562, 115831565⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨724, 726⟩, ⟨289, 291⟩, ⟨28, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93963), (-93960)⟩, ⟨289, 291⟩, ⟨28, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-63353), (-63350)⟩, ⟨(-25148), (-25143)⟩, ⟨(-2440), (-2434)⟩, ⟨14, 17⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5049703, 5049707⟩, ⟨(-25148), (-25143)⟩, ⟨(-2440), (-2434)⟩, ⟨14, 17⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3404653, 3404657⟩, ⟨1344905, 1344911⟩, ⟨127757, 127766⟩, ⟨(-1329), (-1322)⟩, ⟨(-63), (-59)⟩⟩
...
def j16 : Jet := ⟨⟨(-139760924), (-139760919)⟩, ⟨1344905, 1344911⟩, ⟨127757, 127766⟩, ⟨(-1329), (-1322)⟩, ⟨(-63), (-59)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-94230790), (-94230786)⟩, ⟨(-36785543), (-36785536)⟩, ⟨(-3320386), (-3320376)⟩, ⟨69827, 69839⟩, ⟨3043, 3051⟩⟩
...
def j19 : Jet := ⟨⟨1337424975, 1337424980⟩, ⟨(-36785543), (-36785536)⟩, ⟨(-3320386), (-3320376)⟩, ⟨69827, 69839⟩, ⟨3043, 3051⟩⟩
...
def j22 : Jet := ⟨⟨(-73), (-72)⟩, ⟨(-30), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11762, 11764⟩, ⟨(-30), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7930, 7932⟩, ⟨3151, 3155⟩, ⟨305, 310⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844247), (-844244)⟩, ⟨3151, 3155⟩, ⟨305, 310⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-569216), (-569213)⟩, ⟨(-225563), (-225557)⟩, ⟨(-21715), (-21707)⟩, ⟨164, 170⟩, ⟨6, 9⟩⟩
...
def j30 : Jet := ⟨⟨35222178, 35222182⟩, ⟨(-225563), (-225557)⟩, ⟨(-21715), (-21707)⟩, ⟨164, 170⟩, ⟨6, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23747794, 23747797⟩, ⟨9347036, 9347043⟩, ⟨874437, 874447⟩, ⟨(-11831), (-11822)⟩, ⟨(-538), (-532)⟩⟩
...
def j33 : Jet := ⟨⟨(-692080089), (-692080085)⟩, ⟨9347036, 9347043⟩, ⟨874437, 874447⟩, ⟨(-11831), (-11822)⟩, ⟨(-538), (-532)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-466620079), (-466620074)⟩, ⟨(-180345995), (-180345986)⟩, ⟨(-15554420), (-15554407)⟩, ⟨479932, 479943⟩, ⟨20028, 20038⟩⟩
...
def j36 : Jet := ⟨⟨3828347217, 3828347222⟩, ⟨(-180345995), (-180345986)⟩, ⟨(-15554420), (-15554407)⟩, ⟨479932, 479943⟩, ⟨20028, 20038⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1098178563, 1098178570⟩, ⟨189430582, 189430592⟩, ⟨(-8767442), (-8767431)⟩, ⟨(-487949), (-487935)⟩, ⟨13965, 13976⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4818461598, 4818461605⟩, ⟨226988346, 226988360⟩, ⟨30270175, 30270197⟩, ⟨1744140, 1744161⟩, ⟨151470, 151489⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1232030623, 1232030633⟩, ⟨270557990, 270558007⟩, ⟨7915078, 7915101⟩, ⟨770250, 770275⟩, ⟨43740, 43764⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1122570234), (-1122570233)⟩, ⟨(-224514047), (-224514046)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3172397062, 3172397063⟩, ⟨(-224514047), (-224514046)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨353413507, 353413514⟩, ⟨155221544, 155221556⟩, ⟨21584531, 21584550⟩, ⟨1439104, 1439126⟩, ⟨136722, 136741⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4648380803, 4648380810⟩, ⟨155221544, 155221556⟩, ⟨21584531, 21584550⟩, ⟨1439104, 1439126⟩, ⟨136722, 136741⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4468181232, 4468181237⟩, ⟨74602105, 74602112⟩, ⟨9751101, 9751112⟩, ⟨528849, 528862⟩, ⟨46239, 46252⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3300338288, 3300338293⟩, ⟨(-178465144), (-178465135)⟩, ⟨3302734, 3302746⟩, ⟨(-119104), (-119091)⟩, ⟨6507, 6520⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨18098441434, 18098441439⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value179

def j47 : Jet := ⟨⟨4730367012, 4730367019⟩, ⟨946073400, 946073405⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5209905111, 5209905127⟩, ⟨2083962038, 2083962054⟩, ⟨208396203, 208396206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5209905111, 5209905127⟩, ⟨2083962038, 2083962054⟩, ⟨208396203, 208396206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5209905127), (-5209905111)⟩, ⟨(-2083962054), (-2083962038)⟩, ⟨(-208396206), (-208396203)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2604952564), (-2604952555)⟩, ⟨(-1041981027), (-1041981019)⟩, ⟨(-104198103), (-104198101)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2341826447, 2341826460⟩, ⟨(-568139074), (-568139065)⟩, ⟨12102812, 12102817⟩, ⟨8210160, 8210162⟩, ⟨(-644768), (-644766)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1799506015, 1799506029⟩, ⟨(-533877300), (-533877285)⟩, ⟨34708253, 34708268⟩, ⟨5304121, 5304135⟩, ⟨(-807997), (-807981)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨898056186, 1347084281⟩, ⟨224514046, 224514047⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2821326716, 4231990082⟩, ⟨705331677, 705331681⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1853305017, 4169936305⟩, ⟨926652504, 1389978770⟩, ⟨115831562, 115831565⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨463, 1045⟩, ⟨231, 349⟩, ⟨28, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94224), (-93641)⟩, ⟨231, 349⟩, ⟨28, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-91482), (-40406)⟩, ⟨(-30395), (-19864)⟩, ⟨(-2481), (-2382)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5021574, 5072651⟩, ⟨(-30395), (-19864)⟩, ⟨(-2481), (-2382)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2166840, 4924981⟩, ⟨1053909, 1633090⟩, ⟨123181, 131494⟩, ⟨(-1618), (-1028)⟩, ⟨(-65), (-56)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140998737), (-138240595)⟩, ⟨1053909, 1633090⟩, ⟨123181, 131494⟩, ⟨(-1618), (-1028)⟩, ⟨(-65), (-56)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-136894117), (-59651673)⟩, ⟨(-45176605), (-28240286)⟩, ⟨(-3522078), (-3072045)⟩, ⟨53428, 86157⟩, ⟨2734, 3302⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1294761648, 1372004093⟩, ⟨(-45176605), (-28240286)⟩, ⟨(-3522078), (-3072045)⟩, ⟨53428, 86157⟩, ⟨2734, 3302⟩⟩
...
def j70 : Jet := ⟨⟨(-105), (-46)⟩, ⟨(-35), (-23)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11730, 11790⟩, ⟨(-35), (-23)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5061, 11447⟩, ⟨2496, 3807⟩, ⟨301, 314⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847116), (-840729)⟩, ⟨2496, 3807⟩, ⟨301, 314⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-822456), (-362779)⟩, ⟨(-273075), (-177692)⟩, ⟨(-22179), (-21135)⟩, ⟨129, 205⟩, ⟨6, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34968938, 35428616⟩, ⟨(-273075), (-177692)⟩, ⟨(-22179), (-21135)⟩, ⟨129, 205⟩, ⟨6, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15089313, 34397252⟩, ⟨7279530, 11389076⟩, ⟨833172, 908024⟩, ⟨(-14488), (-9151)⟩, ⟨(-570), (-493)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700738570), (-681430630)⟩, ⟨7279530, 11389076⟩, ⟨833172, 908024⟩, ⟨(-14488), (-9151)⟩, ⟨(-570), (-493)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-680339338), (-294041541)⟩, ⟨(-223638618), (-135963241)⟩, ⟨(-16968217), (-13810162)⟩, ⟨362014, 597070⟩, ⟨17226, 22303⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3614627958, 4000925755⟩, ⟨(-223638618), (-135963241)⟩, ⟨(-16968217), (-13810162)⟩, ⟨362014, 597070⟩, ⟨17226, 22303⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨850517681, 1351886363⟩, ⟨168115239, 206763596⟩, ⟨(-10889464), (-6655698)⟩, ⟨(-543310), (-419605)⟩, ⟨10569, 17403⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4610618942, 5103358987⟩, ⟨156682410, 315747061⟩, ⟨21239194, 43492206⟩, ⟨501006, 3711336⟩, ⟨14769, 396126⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨913025096, 1606336195⟩, ⟨211497876, 345065027⟩, ⟨(-2600216), 21745134⟩, ⟨(-515553), 2568692⟩, ⟨(-116334), 275812⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1347084281), (-898056186)⟩, ⟨(-224514047), (-224514046)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2947883015, 3396911110⟩, ⟨(-224514047), (-224514046)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨194091076, 600776629⟩, ⟨89920530, 258111602⟩, ⟨8469845, 43988664⟩, ⟨(-803452), 5415488⟩, ⟨(-183027), 729153⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4489058372, 4895743925⟩, ⟨89920530, 258111602⟩, ⟨8469845, 43988664⟩, ⟨(-803452), 5415488⟩, ⟨(-183027), 729153⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4390940548, 4585527238⟩, ⟨42111377, 126235015⟩, ⟨2229015, 21311665⟩, ⟨(-1005635), 2627184⟩, ⟨(-216762), 384955⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3013754976, 3626716421⟩, ⟨(-210799246), (-129691022)⟩, ⟨(-5068877), 14654184⟩, ⟨(-1909403), 1961335⟩, ⟨(-308772), 357032⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3784293608, 5676440423⟩, ⟨946073400, 946073405⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3334339268, 7502263383⟩, ⟨1667169630, 2500754466⟩, ⟨208396203, 208396206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3334339268, 7502263383⟩, ⟨1667169630, 2500754466⟩, ⟨208396203, 208396206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7502263383), (-3334339268)⟩, ⟨(-2500754466), (-1667169630)⟩, ⟨(-208396206), (-208396203)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3751131692), (-1667169634)⟩, ⟨(-1250377233), (-833584815)⟩, ⟨(-104198103), (-104198101)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1793314407, 2913268838⟩, ⟨(-848128700), (-348053793)⟩, ⟨(-36901541), 79949493⟩, ⟨(-2129154), 17298359⟩, ⟨(-2228810), 602589⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1258358875, 2459995434⟩, ⟨(-859153728), (-298378436)⟩, ⟨(-24088421), 119076719⟩, ⟨(-9910757), 18749391⟩, ⟨(-3453697), 1505343⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1122570233, 1122570234⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨224514046, 224514047⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4468181232, 4468181237⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar179 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified402
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar179 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨898056186, 1347084281⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4390940548, 4585527238⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified403
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((41819 / 200000) : ℝ)..(125457 / 400000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (41819 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (125457 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((41819 / 200000) : ℝ)..(125457 / 400000), prawitzNormalCorrection
      ((30411 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
