...
namespace FiniteNormalPanel28_22
...
def j2 : Jet := ⟨⟨1846252348, 1846252352⟩, ⟨615417448, 615417452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨793637645, 793637649⟩, ⟨529091762, 529091768⟩, ⟨88181960, 88181962⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨198, 199⟩, ⟨132, 133⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94489), (-94487)⟩, ⟨132, 133⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-17460), (-17459)⟩, ⟨(-11616), (-11614)⟩, ⟨(-1920), (-1917)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5095596, 5095598⟩, ⟨(-11616), (-11614)⟩, ⟨(-1920), (-1917)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨941580, 941581⟩, ⟨625573, 625575⟩, ⟨102834, 102837⟩, ⟨(-476), (-472)⟩, ⟨(-40), (-37)⟩⟩
...
def j16 : Jet := ⟨⟨(-142223997), (-142223995)⟩, ⟨625573, 625575⟩, ⟨102834, 102837⟩, ⟨(-476), (-472)⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-26280601), (-26280599)⟩, ⟨(-17404806), (-17404803)⟩, ⟨(-2824003), (-2823999)⟩, ⟨25422, 25426⟩, ⟨2044, 2048⟩⟩
...
def j19 : Jet := ⟨⟨1405375164, 1405375167⟩, ⟨(-17404806), (-17404803)⟩, ⟨(-2824003), (-2823999)⟩, ⟨25422, 25426⟩, ⟨2044, 2048⟩⟩
...
def j25 : Jet := ⟨⟨2183, 2184⟩, ⟨1452, 1454⟩, ⟨239, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849994), (-849992)⟩, ⟨1452, 1454⟩, ⟨239, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-157065), (-157064)⟩, ⟨(-104442), (-104440)⟩, ⟨(-17230), (-17226)⟩, ⟨57, 60⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35634329, 35634331⟩, ⟨(-104442), (-104440)⟩, ⟨(-17230), (-17226)⟩, ⟨57, 60⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6584624, 6584625⟩, ⟨4370449, 4370452⟩, ⟨715573, 715577⟩, ⟨(-4258), (-4254)⟩, ⟨(-347), (-344)⟩⟩
...
def j33 : Jet := ⟨⟨(-709243259), (-709243257)⟩, ⟨4370449, 4370452⟩, ⟨715573, 715577⟩, ⟨(-4258), (-4254)⟩, ⟨(-347), (-344)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-131056214), (-131056212)⟩, ⟨(-86563225), (-86563222)⟩, ⟨(-13891187), (-13891183)⟩, ⟨177094, 177098⟩, ⟨14101, 14105⟩⟩
...
def j36 : Jet := ⟨⟨4163911082, 4163911084⟩, ⟨(-86563225), (-86563222)⟩, ⟨(-13891187), (-13891183)⟩, ⟨177094, 177098⟩, ⟨14101, 14105⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨604120361, 604120365⟩, ⟨193891751, 193891756⟩, ⟨(-3707839), (-3707835)⟩, ⟨(-393718), (-393715)⟩, ⟨4520, 4525⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4430148411, 4430148414⟩, ⟨92098008, 92098013⟩, ⟨16693991, 16693999⟩, ⟨465873, 465883⟩, ⟨46452, 46461⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨623134630, 623134635⟩, ⟨212948655, 212948663⟩, ⟨2681264, 2681273⟩, ⟨333540, 333551⟩, ⟨9371, 9383⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-587680376), (-587680375)⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3707286920, 3707286921⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨90407386, 90407388⟩, ⟨61791240, 61791246⟩, ⟨11336221, 11336229⟩, ⟨362660, 362670⟩, ⟨37465, 37474⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4385374682, 4385374684⟩, ⟨61791240, 61791246⟩, ⟨11336221, 11336229⟩, ⟨362660, 362670⟩, ⟨37465, 37474⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4339935580, 4339935582⟩, ⟨30575494, 30575498⟩, ⟨5501675, 5501680⟩, ⟨140690, 140697⟩, ⟨14059, 14066⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3746102193, 3746102197⟩, ⟨(-171552614), (-171552608)⟩, ⟨3354331, 3354338⟩, ⟨(-129493), (-129485)⟩, ⟨5717, 5726⟩⟩
...
def j47 : Jet := ⟨⟨3278010609, 3278010616⟩, ⟨1092670201, 1092670208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2501847583, 2501847595⟩, ⟨1667898386, 1667898402⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2501847583, 2501847595⟩, ⟨1667898386, 1667898402⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2501847595), (-2501847583)⟩, ⟨(-1667898402), (-1667898386)⟩, ⟨(-277983068), (-277983063)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1250923798), (-1250923791)⟩, ⟨(-833949201), (-833949193)⟩, ⟨(-138991534), (-138991531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3209741959, 3209741970⟩, ⟨(-623232162), (-623232153)⟩, ⟨(-43365869), (-43365863)⟩, ⟨16252580, 16252582⟩, ⟨(-87245), (-87244)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2799560639, 2799560653⟩, ⟨(-671793474), (-671793459)⟩, ⟨(-10423676), (-10423661)⟩, ⟨15324255, 15324269⟩, ⟨(-736077), (-736062)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨391786916, 783573834⟩, ⟨195893458, 195893459⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1230834897, 2461669801⟩, ⟨615417448, 615417452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨352727841, 1410911375⟩, ⟨352727840, 705455690⟩, ⟨88181960, 88181962⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨88, 354⟩, ⟨88, 177⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94599), (-94332)⟩, ⟨88, 177⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-31077), (-7747)⟩, ⟨(-15532), (-7688)⟩, ⟨(-1935), (-1898)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5081979, 5105310⟩, ⟨(-15532), (-7688)⟩, ⟨(-1935), (-1898)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨417361, 1677112⟩, ⟨412258, 837925⟩, ⟨101152, 104034⟩, ⟨(-637), (-309)⟩, ⟨(-40), (-35)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142748216), (-141488464)⟩, ⟨412258, 837925⟩, ⟨101152, 104034⟩, ⟨(-637), (-309)⟩, ⟨(-40), (-35)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-46893275), (-11619860)⟩, ⟨(-23412781), (-11344598)⟩, ⟨(-2888666), (-2733158)⟩, ⟨16561, 34267⟩, ⟨1957, 2109⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1384762490, 1420035906⟩, ⟨(-23412781), (-11344598)⟩, ⟨(-2888666), (-2733158)⟩, ⟨16561, 34267⟩, ⟨1957, 2109⟩⟩
...
def j72 : Jet := ⟨⟨969, 3886⟩, ⟨963, 1943⟩, ⟨238, 243⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851208), (-848290)⟩, ⟨963, 1943⟩, ⟨238, 243⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-279625), (-69666)⟩, ⟨(-139734), (-69027)⟩, ⟨(-17379), (-17016)⟩, ⟨37, 80⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35511769, 35721729⟩, ⟨(-139734), (-69027)⟩, ⟨(-17379), (-17016)⟩, ⟨37, 80⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2916434, 11734710⟩, ⟨2870530, 5861687⟩, ⟨700446, 726355⟩, ⟨(-5721), (-2787)⟩, ⟨(-354), (-333)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712911449), (-704093172)⟩, ⟨2870530, 5861687⟩, ⟨700446, 726355⟩, ⟨(-5721), (-2787)⟩, ⟨(-354), (-333)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-234193838), (-57824250)⟩, ⟨(-116861176), (-55898665)⟩, ⟨(-14343848), (-13254658)⟩, ⟨114580, 239428⟩, ⟨13324, 14659⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4060773458, 4237143046⟩, ⟨(-116861176), (-55898665)⟩, ⟨(-14343848), (-13254658)⟩, ⟨114580, 239428⟩, ⟨13324, 14659⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨396839807, 813896653⟩, ⟨185000816, 200223074⟩, ⟨(-5010418), (-2408802)⟩, ⟨(-409167), (-371987)⟩, ⟨2932, 6120⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4353580672, 4542667614⟩, ⟨57434772, 130729155⟩, ⟨14376608, 19808173⟩, ⟨112637, 908975⟩, ⟨23353, 80225⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨402255475, 860835884⟩, ⟨192832290, 236543571⟩, ⟨(-1497096), 7406318⟩, ⟨44391, 686396⟩, ⟨(-25583), 51014⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-783573834), (-391786916)⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3511393462, 3903180380⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨37674202, 172536453⟩, ⟨36120342, 94820370⟩, ⟨8057518, 15996423⟩, ⟨(-156590), 1090948⟩, ⟨(-8852), 108828⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4332641498, 4467503749⟩, ⟨36120342, 94820370⟩, ⟨8057518, 15996423⟩, ⟨(-156590), 1090948⟩, ⟨(-8852), 108828⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4313763268, 4380386113⟩, ⟨17707992, 47203609⟩, ⟨3695860, 7927017⟩, ⟨(-164697), 527927⟩, ⟨(-17469), 54397⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3526760296, 3980807293⟩, ⟨(-185312067), (-153853046)⟩, ⟨868630, 6396254⟩, ⟨(-511226), 311202⟩, ⟨(-39955), 56947⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2185340402, 4370680818⟩, ⟨1092670201, 1092670208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1111932255, 4447729051⟩, ⟨1111932254, 2223864534⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1111932255, 4447729051⟩, ⟨1111932254, 2223864534⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4447729051), (-1111932255)⟩, ⟨(-2223864534), (-1111932254)⟩, ⟨(-277983068), (-277983063)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2223864526), (-555966127)⟩, ⟨(-1111932267), (-555966127)⟩, ⟨(-138991534), (-138991531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2559111506, 3773481273⟩, ⟨(-976923757), (-331266623)⟩, ⟨(-100674909), 43642172⟩, ⟨3380651, 29764445⟩, ⟨(-2632607), 1519593⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2101383370, 3497465927⟩, ⟨(-1068277479), (-363687303)⟩, ⟨(-80926837), 88220227⟩, ⟨(-1011052), 32137467⟩, ⟨(-3980090), 1518651⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4339935580, 4339935582⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified566
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4313763268, 4380386113⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified567
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (255086681 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((4561 / 50000) : ℝ)..(4561 / 25000), prawitzNormalCorrection
