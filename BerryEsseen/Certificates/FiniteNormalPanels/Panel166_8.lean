...
namespace FiniteNormalPanel166_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (90069 / 400000)
def radius : Rat := (12867 / 400000)

def j0 : Jet := ⟨⟨967108523, 967108524⟩, ⟨138158360, 138158361⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3038261030, 3038261035⟩, ⟨434037288, 434037292⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2149266676, 2149266684⟩, ⟨614076190, 614076198⟩, ⟨43862584, 43862586⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨537, 539⟩, ⟨153, 154⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94150), (-94147)⟩, ⟨153, 154⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-47115), (-47112)⟩, ⟨(-13386), (-13382)⟩, ⟨(-936), (-932)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5065941, 5065945⟩, ⟨(-13386), (-13382)⟩, ⟨(-936), (-932)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2535073, 2535076⟩, ⟨717607, 717612⟩, ⟨49353, 49358⟩, ⟨(-270), (-266)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140630504), (-140630500)⟩, ⟨717607, 717612⟩, ⟨49353, 49358⟩, ⟨(-270), (-266)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-70373635), (-70373631)⟩, ⟨(-19747652), (-19747647)⟩, ⟨(-1308901), (-1308894)⟩, ⟨14248, 14253⟩, ⟨459, 464⟩⟩
...
def j19 : Jet := ⟨⟨1361282130, 1361282135⟩, ⟨(-19747652), (-19747647)⟩, ⟨(-1308901), (-1308894)⟩, ⟨14248, 14253⟩, ⟨459, 464⟩⟩
...
def j25 : Jet := ⟨⟨5894, 5897⟩, ⟨1675, 1678⟩, ⟨115, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846283), (-846279)⟩, ⟨1675, 1678⟩, ⟨115, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-423493), (-423490)⟩, ⟨(-120160), (-120157)⟩, ⟨(-8347), (-8342)⟩, ⟨31, 36⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35367901, 35367905⟩, ⟨(-120160), (-120157)⟩, ⟨(-8347), (-8342)⟩, ⟨31, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17698633, 17698636⟩, ⟨4996622, 4996625⟩, ⟨339839, 339844⟩, ⟨(-2407), (-2400)⟩, ⟨(-83), (-77)⟩⟩
...
def j33 : Jet := ⟨⟨(-698129250), (-698129246)⟩, ⟨4996622, 4996625⟩, ⟨339839, 339844⟩, ⟨(-2407), (-2400)⟩, ⟨(-83), (-77)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-349354451), (-349354446)⟩, ⟨(-97315173), (-97315168)⟩, ⟨(-6245228), (-6245221)⟩, ⟨98411, 98419⟩, ⟨3083, 3090⟩⟩
...
def j36 : Jet := ⟨⟨3945612845, 3945612850⟩, ⟨(-97315173), (-97315168)⟩, ⟨(-6245228), (-6245221)⟩, ⟨98411, 98419⟩, ⟨3083, 3090⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨962971347, 962971354⟩, ⟨123597839, 123597847⟩, ⟨(-2921560), (-2921552)⟩, ⟨(-122195), (-122190)⟩, ⟨1763, 1770⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4675254459, 4675254466⟩, ⟨115311153, 115311162⟩, ⟨10244166, 10244179⟩, ⟨318559, 318574⟩, ⟨17530, 17546⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1048235242, 1048235252⟩, ⟨160395326, 160395340⟩, ⟨2434944, 2434959⟩, ⟨154770, 154783⟩, ⟨4766, 4781⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-967108524), (-967108523)⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3327858772, 3327858773⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨255833641, 255833647⟩, ⟨78292578, 78292588⟩, ⟨7178504, 7178516⟩, ⟨257410, 257422⟩, ⟨15264, 15277⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4550800937, 4550800943⟩, ⟨78292578, 78292588⟩, ⟨7178504, 7178516⟩, ⟨257410, 257422⟩, ⟨15264, 15277⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4421033950, 4421033954⟩, ⟨38030024, 38030030⟩, ⟨3323334, 3323342⟩, ⟨96447, 96454⟩, ⟨5334, 5344⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3425538682, 3425538687⟩, ⟨(-112746903), (-112746895)⟩, ⟨1351679, 1351687⟩, ⟨(-32175), (-32167)⟩, ⟨1029, 1039⟩⟩
...
def j47 : Jet := ⟨⟨12634106992, 12634107008⟩, ⟨1804872421, 1804872436⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨37164580888, 37164580983⟩, ⟨10618451644, 10618451748⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨37164580888, 37164580983⟩, ⟨10618451644, 10618451748⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-37164580983), (-37164580888)⟩, ⟨(-10618451748), (-10618451644)⟩, ⟨(-758460842), (-758460829)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-18582290492), (-18582290444)⟩, ⟨(-5309225874), (-5309225822)⟩, ⟨(-379230421), (-379230414)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨56750958, 56750962⟩, ⟨(-70152729), (-70152723)⟩, ⟨38348751, 38348757⟩, ⟨(-11672121), (-11672116)⟩, ⟨1914092, 1914095⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨45262882, 45262887⟩, ⟨(-57441505), (-57441498)⟩, ⟨32445261, 32445269⟩, ⟨(-10338534), (-10338525)⟩, ⟨1845632, 1845640⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨828950162, 1105266884⟩, ⟨138158360, 138158361⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2604223739, 3472298324⟩, ⟨434037288, 434037292⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1579053067, 2807205462⟩, ⟨526351020, 701801368⟩, ⟨43862584, 43862586⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨395, 704⟩, ⟨131, 176⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94292), (-93982)⟩, ⟨131, 176⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-61630), (-34552)⟩, ⟨(-15360), (-11401)⟩, ⟨(-944), (-922)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5051426, 5078505⟩, ⟨(-15360), (-11401)⟩, ⟨(-944), (-922)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1857166, 3319329⟩, ⟨609015, 825642⟩, ⟨48459, 50130⟩, ⟨(-312), (-225)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141308411), (-139846247)⟩, ⟨609015, 825642⟩, ⟨48459, 50130⟩, ⟨(-312), (-225)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-92359666), (-51414744)⟩, ⟨(-22866012), (-16598605)⟩, ⟨(-1350669), (-1260510)⟩, ⟨11953, 16542⟩, ⟨436, 483⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1339296099, 1380241022⟩, ⟨(-22866012), (-16598605)⟩, ⟨(-1350669), (-1260510)⟩, ⟨11953, 16542⟩, ⟨436, 483⟩⟩
...
def j72 : Jet := ⟨⟨4325, 7711⟩, ⟨1429, 1924⟩, ⟨115, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847852), (-844465)⟩, ⟨1429, 1924⟩, ⟨115, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-554159), (-310469)⟩, ⟨(-138015), (-102231)⟩, ⟨(-8442), (-8230)⟩, ⟨26, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35237235, 35480926⟩, ⟨(-138015), (-102231)⟩, ⟨(-8442), (-8230)⟩, ⟨26, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12955037, 23190456⟩, ⟨4228137, 5760029⟩, ⟨331792, 346798⟩, ⟨(-2781), (-2025)⟩, ⟨(-85), (-75)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702872846), (-692637426)⟩, ⟨4228137, 5760029⟩, ⟨331792, 346798⟩, ⟨(-2781), (-2025)⟩, ⟨(-85), (-75)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-459400121), (-254649494)⟩, ⟨(-113295549), (-81118389)⟩, ⟨(-6537984), (-5905733)⟩, ⟨82023, 114749⟩, ⟨2877, 3267⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3835567175, 4040317802⟩, ⟨(-113295549), (-81118389)⟩, ⟨(-6537984), (-5905733)⟩, ⟨82023, 114749⟩, ⟨2877, 3267⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨812072934, 1115866143⟩, ⟨116859290, 129418820⟩, ⟨(-3402734), (-2441709)⟩, ⟨(-129248), (-114009)⟩, ⟨1471, 2063⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4565666607, 4809391476⟩, ⟨91665937, 142060516⟩, ⟨8514032, 12394140⟩, ⟨168333, 510617⟩, ⟨7899, 30827⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨863255531, 1249517575⟩, ⟨141556370, 181828228⟩, ⟨293586, 4905156⟩, ⟨6202, 332826⟩, ⟨(-6460), 18435⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1105266884), (-828950162)⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3189700412, 3466017134⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨173507749, 363517127⟩, ⟨56903492, 105797112⟩, ⟨4783524, 10551808⟩, ⟨21844, 608978⟩, ⟨(-3332), 44513⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4468475045, 4658484423⟩, ⟨56903492, 105797112⟩, ⟨4783524, 10551808⟩, ⟨21844, 608978⟩, ⟨(-3332), 44513⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4380862264, 4473034568⟩, ⟨27319108, 51861382⟩, ⟨1995901, 5087280⟩, ⟨(-49517), 286073⟩, ⟨(-7975), 21952⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3253491168, 3609716533⟩, ⟨(-123597532), (-99069510)⟩, ⟨(-185977), 3226623⟩, ⟨(-203606), 166657⟩, ⟨(-15639), 19309⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨10829234557, 14438979430⟩, ⟨1804872421, 1804872436⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨27304590002, 48541493477⟩, ⟨9101529974, 12135373418⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨27304590002, 48541493477⟩, ⟨9101529974, 12135373418⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-48541493477), (-27304590002)⟩, ⟨(-12135373418), (-9101529974)⟩, ⟨(-758460842), (-758460829)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-24270746739), (-13652295001)⟩, ⟨(-6067686709), (-4550764987)⟩, ⟨(-379230421), (-379230414)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨15092917, 178846268⟩, ⟨(-252663886), (-15991814)⟩, ⟨(-7319370), 177141968⟩, ⟨(-82477369), 18319683⟩, ⟨(-14290758), 29452977⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨11433072, 150311816⟩, ⟨(-217498738), (-12462137)⟩, ⟨(-5790456), 156284775⟩, ⟨(-74614284), 15625339⟩, ⟨(-12556025), 27273171⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨967108523, 967108524⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4421033950, 4421033954⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3358
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨828950162, 1105266884⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4380862264, 4473034568⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3359
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (3958701 / 4294967296)

theorem envelope_integral : (∫ s in ((38601 / 200000) : ℝ)..(12867 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((38601 / 200000) : ℝ)..(12867 / 50000), prawitzNormalCorrection
