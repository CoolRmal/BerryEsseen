...
namespace FiniteNormalPanel3_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (57967 / 160000)
def radius : Rat := (8281 / 160000)

def j0 : Jet := ⟨⟨1556039807, 1556039808⟩, ⟨222291401, 222291402⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4888443226, 4888443230⟩, ⟨698349032, 698349036⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5563925293, 5563925303⟩, ⟨1589692940, 1589692952⟩, ⟨113549495, 113549497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1392, 1394⟩, ⟨397, 399⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93295), (-93292)⟩, ⟨397, 399⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-120860), (-120855)⟩, ⟨(-34018), (-34013)⟩, ⟨(-2285), (-2280)⟩, ⟨20, 22⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4992196, 4992202⟩, ⟨(-34018), (-34013)⟩, ⟨(-2285), (-2280)⟩, ⟨20, 22⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6467151, 6467160⟩, ⟨1803688, 1803698⟩, ⟨116429, 116441⟩, ⟨(-1721), (-1713)⟩, ⟨(-54), (-49)⟩⟩
...
def j16 : Jet := ⟨⟨(-136698426), (-136698416)⟩, ⟨1803688, 1803698⟩, ⟨116429, 116441⟩, ⟨(-1721), (-1713)⟩, ⟨(-54), (-49)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-177086292), (-177086278)⟩, ⟨(-48259493), (-48259474)⟩, ⟨(-2795581), (-2795559)⟩, ⟨88548, 88566⟩, ⟨2371, 2382⟩⟩
...
def j19 : Jet := ⟨⟨1254569473, 1254569488⟩, ⟨(-48259493), (-48259474)⟩, ⟨(-2795581), (-2795559)⟩, ⟨88548, 88566⟩, ⟨2371, 2382⟩⟩
...
def j22 : Jet := ⟨⟨(-140), (-138)⟩, ⟨(-40), (-39)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11695, 11698⟩, ⟨(-40), (-39)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨15150, 15155⟩, ⟨4276, 4280⟩, ⟨290, 294⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-837027), (-837021)⟩, ⟨4276, 4280⟩, ⟨290, 294⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1084329), (-1084320)⟩, ⟨(-304270), (-304260)⟩, ⟨(-20173), (-20162)⟩, ⟨214, 222⟩, ⟨3, 8⟩⟩
...
def j30 : Jet := ⟨⟨34707065, 34707075⟩, ⟨(-304270), (-304260)⟩, ⟨(-20173), (-20162)⟩, ⟨214, 222⟩, ⟨3, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨44961347, 44961361⟩, ⟨12451931, 12451950⟩, ⟨778824, 778846⟩, ⟨(-15235), (-15217)⟩, ⟨(-452), (-439)⟩⟩
...
def j33 : Jet := ⟨⟨(-670866536), (-670866521)⟩, ⟨12451931, 12451950⟩, ⟨778824, 778846⟩, ⟨(-15235), (-15217)⟩, ⟨(-452), (-439)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-869075604), (-869075582)⟩, ⟨(-232176435), (-232176401)⟩, ⟨(-12118485), (-12118447)⟩, ⟨597729, 597765⟩, ⟨14365, 14391⟩⟩
...
def j36 : Jet := ⟨⟨3425891692, 3425891714⟩, ⟨(-232176435), (-232176401)⟩, ⟨(-12118485), (-12118447)⟩, ⟨597729, 597765⟩, ⟨14365, 14391⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1427925108, 1427925127⟩, ⟨149061340, 149061367⟩, ⟨(-11028725), (-11028695)⟩, ⟨(-353771), (-353745)⟩, ⟨17095, 17113⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5384508797, 5384508833⟩, ⟨364914006, 364914067⟩, ⟨43777303, 43777375⟩, ⟨3318133, 3318205⟩, ⟨293433, 293490⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1790159220, 1790159257⟩, ⟨308196052, 308196111⟩, ⟨13392652, 13392723⟩, ⟨1241947, 1242013⟩, ⟨91675, 91726⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1556039808), (-1556039807)⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2738927488, 2738927489⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨746145386, 746145418⟩, ⟨256914646, 256914702⟩, ⟨33279591, 33279663⟩, ⟨2957342, 2957410⟩, ⟨296417, 296474⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5041112682, 5041112714⟩, ⟨256914646, 256914702⟩, ⟨33279591, 33279663⟩, ⟨2957342, 2957410⟩, ⟨296417, 296474⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4653108004, 4653108020⟩, ⟨118570211, 118570238⟩, ⟨13848362, 13848397⟩, ⟨1011976, 1012010⟩, ⟨90404, 90434⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2967316055, 2967316068⟩, ⟨(-165214459), (-165214439)⟩, ⟨2694435, 2694461⟩, ⟨(-71399), (-71373)⟩, ⟨5273, 5295⟩⟩
...
def j47 : Jet := ⟨⟨6518800218, 6518800226⟩, ⟨931257174, 931257179⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9894081457, 9894081482⟩, ⟨2826880416, 2826880436⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9894081457, 9894081482⟩, ⟨2826880416, 2826880436⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9894081482), (-9894081457)⟩, ⟨(-2826880436), (-2826880416)⟩, ⟨(-201920032), (-201920029)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4947040741), (-4947040728)⟩, ⟨(-1413440218), (-1413440208)⟩, ⟨(-100960016), (-100960014)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1357468080, 1357468092⟩, ⟨(-446732156), (-446732147)⟩, ⟨41598591, 41598595⟩, ⟨2437507, 2437509⟩, ⟨(-689462), (-689461)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨937850407, 937850420⟩, ⟨(-360856965), (-360856949)⟩, ⟨46775763, 46775779⟩, ⟨(-218970), (-218954)⟩, ⟨(-534916), (-534900)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1333748406, 1778331209⟩, ⟨222291401, 222291402⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4190094193, 5586792263⟩, ⟨698349032, 698349036⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4087781847, 7267167743⟩, ⟨1362593948, 1816791944⟩, ⟨113549495, 113549497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1023, 1821⟩, ⟨341, 456⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93664), (-92865)⟩, ⟨341, 456⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-158482), (-88385)⟩, ⟨(-39297), (-28689)⟩, ⟨(-2343), (-2212)⟩, ⟨17, 26⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4954574, 5024672⟩, ⟨(-39297), (-28689)⟩, ⟨(-2343), (-2212)⟩, ⟨17, 26⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4715569, 8501843⟩, ⟨1505364, 2098156⟩, ⟨110400, 121636⟩, ⟨(-2015), (-1415)⟩, ⟨(-57), (-45)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138450008), (-134663733)⟩, ⟨1505364, 2098156⟩, ⟨110400, 121636⟩, ⟨(-2015), (-1415)⟩, ⟨(-57), (-45)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-234260092), (-128167672)⟩, ⟨(-57132278), (-39172436)⟩, ⟨(-3077658), (-2466871)⟩, ⟨71412, 105578⟩, ⟨1968, 2726⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1197395673, 1303488094⟩, ⟨(-57132278), (-39172436)⟩, ⟨(-3077658), (-2466871)⟩, ⟨71412, 105578⟩, ⟨1968, 2726⟩⟩
...
def j70 : Jet := ⟨⟨(-183), (-101)⟩, ⟨(-46), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11652, 11735⟩, ⟨(-46), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨11089, 19856⟩, ⟨3618, 4933⟩, ⟨282, 300⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-841088), (-832320)⟩, ⟨3618, 4933⟩, ⟨282, 300⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1423138), (-792169)⟩, ⟨(-352342), (-255709)⟩, ⟨(-20822), (-19409)⟩, ⟨177, 258⟩, ⟨3, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34368256, 34999226⟩, ⟨(-352342), (-255709)⟩, ⟨(-20822), (-19409)⟩, ⟨177, 258⟩, ⟨3, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨32710361, 59219368⟩, ⟨10307283, 14561469⟩, ⟨724346, 825707⟩, ⟨(-17956), (-12480)⟩, ⟨(-493), (-389)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-683117522), (-656608514)⟩, ⟨10307283, 14561469⟩, ⟨724346, 825707⟩, ⟨(-17956), (-12480)⟩, ⟨(-493), (-389)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1155848061), (-624934296)⟩, ⟨(-279151949), (-183673143)⟩, ⟨(-14100701), (-9802600)⟩, ⟨471920, 722376⟩, ⟨10719, 17501⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3139119235, 3670033000⟩, ⟨(-279151949), (-183673143)⟩, ⟨(-14100701), (-9802600)⟩, ⟨471920, 722376⟩, ⟨10719, 17501⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1168158058, 1695546601⟩, ⟨120376687, 173727391⟩, ⟨(-13292887), (-8775957)⟩, ⟨(-430751), (-263771)⟩, ⟨13530, 20713⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5026315587, 5876407583⟩, ⟨251550647, 522570348⟩, ⟨26014495, 72866937⟩, ⟨817168, 8071545⟩, ⟨(-23970), 990114⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1367072354, 2319860017⟩, ⟨209291961, 443992983⟩, ⟨(-4061627), 39633212⟩, ⟨(-1255335), 5311164⟩, ⟨(-248660), 677097⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1778331209), (-1333748406)⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2516636087, 2961218890⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨435134121, 1253036433⟩, ⟨133233728, 479631858⟩, ⟨5811059, 88712383⟩, ⟨(-2195844), 13931668⟩, ⟨(-565642), 2195263⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4730101417, 5548003729⟩, ⟨133233728, 479631858⟩, ⟨5811059, 88712383⟩, ⟨(-2195844), 13931668⟩, ⟨(-565642), 2195263⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4507286422, 4881443903⟩, ⟨58613241, 228519219⟩, ⟨(-3024295), 41885654⟩, ⟨(-3169805), 6791036⟩, ⟨(-808424), 1220689⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2641044478, 3365572518⟩, ⟨(-218300805), (-75724809)⟩, ⟨(-13912436), 25844987⟩, ⟨(-4353307), 4838692⟩, ⟨(-908858), 1005678⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5587543044, 7450057400⟩, ⟨931257174, 931257179⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7269121070, 12922881931⟩, ⟨2423040356, 3230720498⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7269121070, 12922881931⟩, ⟨2423040356, 3230720498⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12922881931), (-7269121070)⟩, ⟨(-3230720498), (-2423040356)⟩, ⟨(-201920032), (-201920029)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6461440966), (-3634560535)⟩, ⟨(-1615360249), (-1211520178)⟩, ⟨(-100960016), (-100960014)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨954108842, 1842653908⟩, ⟨(-693032024), (-269134089)⟩, ⟨(-5355962), 107898692⟩, ⟨(-9309478), 11532014⟩, ⟨(-2352479), 938287⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨586696874, 1443919110⟩, ⟨(-636722513), (-182316826)⟩, ⟨(-5420660), 130863324⟩, ⟨(-18817174), 13629639⟩, ⟨(-3949764), 2991614⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1556039807, 1556039808⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4653108004, 4653108020⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified52
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1333748406, 1778331209⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4507286422, 4881443903⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified53
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (98755135 / 4294967296)

theorem envelope_integral : (∫ s in ((24843 / 80000) : ℝ)..(8281 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((24843 / 80000) : ℝ)..(8281 / 20000), prawitzNormalCorrection
