...
namespace FiniteNormalPanel34_10
...
def j2 : Jet := ⟨⟨662727411, 662727415⟩, ⟨662727411, 662727415⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨102260993, 102260995⟩, ⟨204521986, 204521990⟩, ⟨102260993, 102260995⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨25, 26⟩, ⟨51, 52⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94662), (-94660)⟩, ⟨51, 52⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2254), (-2253)⟩, ⟨(-4507), (-4505)⟩, ⟨(-2252), (-2249)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110802, 5110804⟩, ⟨(-4507), (-4505)⟩, ⟨(-2252), (-2249)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨121685, 121686⟩, ⟨243263, 243265⟩, ⟨121416, 121419⟩, ⟨(-216), (-213)⟩, ⟨(-54), (-51)⟩⟩
...
def j16 : Jet := ⟨⟨(-143043892), (-143043890)⟩, ⟨243263, 243265⟩, ⟨121416, 121419⟩, ⟨(-216), (-213)⟩, ⟨(-54), (-51)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3405803), (-3405802)⟩, ⟨(-6805815), (-6805811)⟩, ⟨(-3391330), (-3391326)⟩, ⟨11566, 11570⟩, ⟨2877, 2880⟩⟩
...
def j19 : Jet := ⟨⟨1428249962, 1428249964⟩, ⟨(-6805815), (-6805811)⟩, ⟨(-3391330), (-3391326)⟩, ⟨11566, 11570⟩, ⟨2877, 2880⟩⟩
...
def j25 : Jet := ⟨⟨281, 282⟩, ⟨562, 564⟩, ⟨279, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851896), (-851894)⟩, ⟨562, 564⟩, ⟨279, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-20284), (-20283)⟩, ⟨(-40554), (-40552)⟩, ⟨(-20252), (-20249)⟩, ⟨25, 28⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35771110, 35771112⟩, ⟨(-40554), (-40552)⟩, ⟨(-20252), (-20249)⟩, ⟨25, 28⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨851691, 851693⟩, ⟨1702417, 1702420⟩, ⟨849276, 849280⟩, ⟨(-1931), (-1928)⟩, ⟨(-482), (-479)⟩⟩
...
def j33 : Jet := ⟨⟨(-714976192), (-714976189)⟩, ⟨1702417, 1702420⟩, ⟨849276, 849280⟩, ⟨(-1931), (-1928)⟩, ⟨(-482), (-479)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-17023221), (-17023220)⟩, ⟨(-34005909), (-34005906)⟩, ⟨(-16921934), (-16921931)⟩, ⟨80928, 80931⟩, ⟨20116, 20119⟩⟩
...
def j36 : Jet := ⟨⟨4277944075, 4277944076⟩, ⟨(-34005909), (-34005906)⟩, ⟨(-16921934), (-16921931)⟩, ⟨80928, 80931⟩, ⟨20116, 20119⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨220383610, 220383613⟩, ⟨219333450, 219333455⟩, ⟨(-1573454), (-1573450)⟩, ⟨(-521510), (-521506)⟩, ⟨2227, 2231⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4312058256, 4312058258⟩, ⟨34277083, 34277088⟩, ⟨17329345, 17329351⟩, ⟨191762, 191769⟩, ⟨49142, 49150⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨221260582, 221260586⟩, ⟨221965070, 221965077⟩, ⟨1059934, 1059941⟩, ⟨358662, 358671⟩, ⟨4036, 4046⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-210952688), (-210952687)⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4084014608, 4084014609⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨11398514, 11398515⟩, ⟨22869612, 22869616⟩, ⟨11580420, 11580426⟩, ⟨146506, 146514⟩, ⟨37745, 37754⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4306365810, 4306365811⟩, ⟨22869612, 22869616⟩, ⟨11580420, 11580426⟩, ⟨146506, 146514⟩, ⟨37745, 37754⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4300662776, 4300662778⟩, ⟨11419662, 11419665⟩, ⟨5767379, 5767384⟩, ⟨57841, 57847⟩, ⟨14826, 14833⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4089430347, 4089430351⟩, ⟨(-200373658), (-200373653)⟩, ⟨4923214, 4923222⟩, ⟨(-228273), (-228266)⟩, ⟨11255, 11265⟩⟩
...
def j47 : Jet := ⟨⟨1002945016, 1002945022⟩, ⟨1002945016, 1002945022⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨234204042, 234204046⟩, ⟨468408084, 468408092⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨234204042, 234204046⟩, ⟨468408084, 468408092⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-234204046), (-234204042)⟩, ⟨(-468408092), (-468408084)⟩, ⟨(-234204046), (-234204042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-117102023), (-117102021)⟩, ⟨(-234204046), (-234204042)⟩, ⟨(-117102023), (-117102021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4179447252, 4179447255⟩, ⟨(-227904753), (-227904748)⟩, ⟨(-107738568), (-107738564)⟩, ⟨6100862, 6100864⟩, ⟨1385572, 1385574⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3979438549, 3979438557⟩, ⟨(-411982590), (-411982578)⟩, ⟨(-87159442), (-87159427)⟩, ⟨10351867, 10351881⟩, ⟨934205, 934221⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 421905375⟩, ⟨210952687, 210952688⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1325454827⟩, ⟨662727411, 662727415⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 409043976⟩, ⟨0, 409043978⟩, ⟨102260993, 102260995⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 103⟩, ⟨0, 103⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94583)⟩, ⟨0, 103⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-9018), 0⟩, ⟨(-9018), 10⟩, ⟨(-2255), (-2238)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5104038, 5113057⟩, ⟨(-9018), 10⟩, ⟨(-2255), (-2238)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 486958⟩, ⟨(-859), 486959⟩, ⟨120450, 121741⟩, ⟨(-430), 2⟩, ⟨(-54), (-51)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142678618)⟩, ⟨(-859), 486959⟩, ⟨120450, 121741⟩, ⟨(-430), 2⟩, ⟨(-54), (-51)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-13634800), 0⟩, ⟨(-13634882), 46377⟩, ⟨(-3408782), (-3339133)⟩, ⟨(-62), 23191⟩, ⟨2820, 2900⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1418020965, 1431655766⟩, ⟨(-13634882), 46377⟩, ⟨(-3408782), (-3339133)⟩, ⟨(-62), 23191⟩, ⟨2820, 2900⟩⟩
...
def j72 : Jet := ⟨⟨0, 1128⟩, ⟨(-2), 1128⟩, ⟨278, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851048)⟩, ⟨(-2), 1128⟩, ⟨278, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-81160), 0⟩, ⟨(-81161), 108⟩, ⟨(-20291), (-20128)⟩, ⟨(-2), 54⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35710234, 35791395⟩, ⟨(-81161), 108⟩, ⟨(-20291), (-20128)⟩, ⟨(-2), 54⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3408700⟩, ⟨(-7730), 3408711⟩, ⟨840579, 852186⟩, ⟨(-3867), 9⟩, ⟨(-485), (-472)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712419182)⟩, ⟨(-7730), 3408711⟩, ⟨840579, 852186⟩, ⟨(-3867), 9⟩, ⟨(-485), (-472)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-68173997), 0⟩, ⟨(-68174734), 324639⟩, ⟨(-17044237), (-16556539)⟩, ⟨(-554), 162322⟩, ⟨19597, 20292⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4226793299, 4294967296⟩, ⟨(-68174734), 324639⟩, ⟨(-17044237), (-16556539)⟩, ⟨(-554), 162322⟩, ⟨19597, 20292⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 441818276⟩, ⟨214597428, 220923452⟩, ⟨(-3155880), 7157⟩, ⟨(-526007), (-508082)⟩, ⟨(-10), 4474⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4364240873⟩, ⟨(-335197), 70391653⟩, ⟨16551218, 18733846⟩, ⟨(-170394), 586584⟩, ⟨37816, 65105⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 448944369⟩, ⟨214562946, 231727837⟩, ⟨(-3224024), 5555191⟩, ⟨223236, 516134⟩, ⟨(-31163), 41492⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-421905375), 0⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3873061921, 4294967296⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 46927260⟩, ⟨0, 48444098⟩, ⟨10044882, 13663840⟩, ⟨(-347894), 707346⟩, ⟨11617, 71558⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4341894556⟩, ⟨0, 48444098⟩, ⟨10044882, 13663840⟩, ⟨(-347894), 707346⟩, ⟨11617, 71558⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4318367183⟩, ⟨0, 24222049⟩, ⟨4927294, 6831920⟩, ⟨(-212477), 353673⟩, ⟨(-1621), 34152⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3873061921, 4318367183⟩, ⟨(-212102003), (-186730638)⟩, ⟨3253576, 6831920⟩, ⟨(-548036), 111663⟩, ⟨(-18993), 44589⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2005890039⟩, ⟨1002945016, 1002945022⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 936816179⟩, ⟨0, 936816182⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 936816179⟩, ⟨0, 936816182⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-936816179), 0⟩, ⟨(-936816182), 0⟩, ⟨(-234204046), (-234204042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-468408090), 0⟩, ⟨(-468408091), 0⟩, ⟨(-117102023), (-117102021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3851197673, 4294967296⟩, ⟨(-468408091), 0⟩, ⟨(-117102023), (-79460432)⟩, ⟨0, 12771119⟩, ⟨735037, 1596390⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3472884897, 4318367183⟩, ⟨(-683062080), (-167437037)⟩, ⟨(-114822614), (-41691122)⟩, ⟨2161546, 18735311⟩, ⟨(-185298), 1649253⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4300662776, 4300662778⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified674
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4318367183⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified675
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (194044319 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(39293 / 400000), prawitzNormalCorrection
