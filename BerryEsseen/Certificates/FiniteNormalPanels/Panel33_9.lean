...
namespace FiniteNormalPanel33_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (67529 / 200000)
def radius : Rat := (9647 / 200000)

def j0 : Jet := ⟨⟨1450174232, 1450174233⟩, ⟨207167747, 207167748⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4555856713, 4555856717⟩, ⟨650836672, 650836676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4832593349, 4832593358⟩, ⟨1380740954, 1380740964⟩, ⟨98624353, 98624355⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1209, 1211⟩, ⟨345, 346⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93478), (-93475)⟩, ⟨345, 346⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-105180), (-105175)⟩, ⟨(-29664), (-29660)⟩, ⟨(-2010), (-2005)⟩, ⟨14, 17⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5007876, 5007882⟩, ⟨(-29664), (-29660)⟩, ⟨(-2010), (-2005)⟩, ⟨14, 17⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5634740, 5634748⟩, ⟨1576547, 1576556⟩, ⟨103195, 103205⟩, ⟨(-1314), (-1305)⟩, ⟨(-43), (-38)⟩⟩
...
def j16 : Jet := ⟨⟨(-137530837), (-137530828)⟩, ⟨1576547, 1576556⟩, ⟨103195, 103205⟩, ⟨(-1314), (-1305)⟩, ⟨(-43), (-38)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-154746373), (-154746362)⟩, ⟨(-42439358), (-42439343)⟩, ⟨(-2535152), (-2535134)⟩, ⟨67897, 67914⟩, ⟨1897, 1909⟩⟩
...
def j19 : Jet := ⟨⟨1276909392, 1276909404⟩, ⟨(-42439358), (-42439343)⟩, ⟨(-2535152), (-2535134)⟩, ⟨67897, 67914⟩, ⟨1897, 1909⟩⟩
...
def j22 : Jet := ⟨⟨(-122), (-120)⟩, ⟨(-35), (-34)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11713, 11716⟩, ⟨(-35), (-34)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨13179, 13183⟩, ⟨3725, 3729⟩, ⟨252, 258⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-838998), (-838993)⟩, ⟨3725, 3729⟩, ⟨252, 258⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-944021), (-944014)⟩, ⟨(-265530), (-265522)⟩, ⟨(-17786), (-17775)⟩, ⟨163, 169⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34847373, 34847381⟩, ⟨(-265530), (-265522)⟩, ⟨(-17786), (-17775)⟩, ⟨163, 169⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨39209421, 39209431⟩, ⟨10903923, 10903937⟩, ⟨694816, 694834⟩, ⟨(-11633), (-11620)⟩, ⟨(-355), (-346)⟩⟩
...
def j33 : Jet := ⟨⟨(-676618462), (-676618451)⟩, ⟨10903923, 10903937⟩, ⟨694816, 694834⟩, ⟨(-11633), (-11620)⟩, ⟨(-355), (-346)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-761314735), (-761314720)⟩, ⟨(-205249667), (-205249644)⟩, ⟨(-11249866), (-11249838)⟩, ⟨460662, 460686⟩, ⟨11814, 11832⟩⟩
...
def j36 : Jet := ⟨⟨3533652561, 3533652576⟩, ⟨(-205249667), (-205249644)⟩, ⟨(-11249866), (-11249838)⟩, ⟨460662, 460686⟩, ⟨11814, 11832⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1354472764, 1354472779⟩, ⟨148478853, 148478874⟩, ⟨(-9120182), (-9120159)⟩, ⟨(-312143), (-312120)⟩, ⟨12300, 12317⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5220304961, 5220304984⟩, ⟨303217622, 303217661⟩, ⟨34231687, 34231736⟩, ⟨2273076, 2273122⟩, ⟨183998, 184035⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1646289809, 1646289835⟩, ⟨276091718, 276091760⟩, ⟨10192663, 10192713⟩, ⟨876983, 877032⟩, ⟨56829, 56868⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1450174233), (-1450174232)⟩, ⟨(-207167748), (-207167747)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2844793063, 2844793064⟩, ⟨(-207167748), (-207167747)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨631033940, 631033960⟩, ⟨211655618, 211655656⟩, ⟨25561728, 25561775⟩, ⟨1982728, 1982776⟩, ⟨180500, 180542⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4926001236, 4926001256⟩, ⟨211655618, 211655656⟩, ⟨25561728, 25561775⟩, ⟨1982728, 1982776⟩, ⟨180500, 180542⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4599675446, 4599675456⟩, ⟨98817184, 98817203⟩, ⟨10872717, 10872741⟩, ⟨692105, 692130⟩, ⟨56550, 56573⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3046618029, 3046618038⟩, ⟨(-156413292), (-156413275)⟩, ⟨2435150, 2435169⟩, ⟨(-66028), (-66009)⟩, ⟨4071, 4089⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨20953427450, 20953427452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value237

def j47 : Jet := ⟨⟨7074820008, 7074820014⟩, ⟨1010688570, 1010688576⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11653890401, 11653890422⟩, ⟨3329682962, 3329682986⟩, ⟨237834496, 237834500⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11653890401, 11653890422⟩, ⟨3329682962, 3329682986⟩, ⟨237834496, 237834500⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11653890422), (-11653890401)⟩, ⟨(-3329682986), (-3329682962)⟩, ⟨(-237834500), (-237834496)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5826945211), (-5826945200)⟩, ⟨(-1664841493), (-1664841481)⟩, ⟨(-118917250), (-118917248)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1106002908, 1106002924⟩, ⟨(-428715619), (-428715608)⟩, ⟨52468137, 52468143⟩, ⟨1134057, 1134059⟩, ⟨(-836256), (-836255)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨784538779, 784538793⟩, ⟨(-344385929), (-344385913)⟩, ⟨53458023, 53458037⟩, ⟨(-1366415), (-1366403)⟩, ⟨(-597111), (-597100)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1243006485, 1657341981⟩, ⟨207167747, 207167748⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3905020041, 5206693393⟩, ⟨650836672, 650836676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3550476748, 6311958677⟩, ⟨1183492246, 1577989674⟩, ⟨98624353, 98624355⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨888, 1582⟩, ⟨296, 396⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93799), (-93104)⟩, ⟨296, 396⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-137849), (-76965)⟩, ⟨(-34219), (-25073)⟩, ⟨(-2054), (-1954)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4975207, 5036092⟩, ⟨(-34219), (-25073)⟩, ⟨(-2054), (-1954)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4112803, 7401129⟩, ⟨1320645, 1829557⟩, ⟨98652, 107120⟩, ⟨(-1532), (-1083)⟩, ⟨(-45), (-34)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139052774), (-135764447)⟩, ⟨1320645, 1829557⟩, ⟨98652, 107120⟩, ⟨(-1532), (-1083)⟩, ⟨(-45), (-34)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-204354377), (-112231008)⟩, ⟨(-49996871), (-34721587)⟩, ⟨(-2747579), (-2287913)⟩, ⟨55256, 80474⟩, ⟨1635, 2134⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1227301388, 1319424758⟩, ⟨(-49996871), (-34721587)⟩, ⟨(-2747579), (-2287913)⟩, ⟨55256, 80474⟩, ⟨1635, 2134⟩⟩
...
def j70 : Jet := ⟨⟨(-159), (-88)⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11676, 11748⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9652, 17266⟩, ⟨3158, 4294⟩, ⟨248, 262⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842525), (-834910)⟩, ⟨3158, 4294⟩, ⟨248, 262⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1238190), (-690186)⟩, ⟨(-306938), (-223751)⟩, ⟨(-18272), (-17207)⟩, ⟨135, 196⟩, ⟨1, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34553204, 35101209⟩, ⟨(-306938), (-223751)⟩, ⟨(-18272), (-17207)⟩, ⟨135, 196⟩, ⟨1, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨28563744, 51585348⟩, ⟨9070166, 12711372⟩, ⟨653813, 730143⟩, ⟨(-13652), (-9589)⟩, ⟨(-383), (-311)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-687264139), (-664242534)⟩, ⟨9070166, 12711372⟩, ⟨653813, 730143⟩, ⟨(-13652), (-9589)⟩, ⟨(-383), (-311)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1010015339), (-549102591)⟩, ⟨(-245005895), (-164353342)⟩, ⟨(-12741697), (-9509604)⟩, ⟨368372, 552221⟩, ⟨9434, 13868⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3284951957, 3745864705⟩, ⟨(-245005895), (-164353342)⟩, ⟨(-12741697), (-9509604)⟩, ⟨368372, 552221⟩, ⟨9434, 13868⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1115872644, 1599509309⟩, ⟨125368677, 168369509⟩, ⟨(-10907091), (-7341715)⟩, ⟨(-366115), (-249141)⟩, ⟨9859, 14783⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4924562291, 5615529334⟩, ⟨216069808, 418830416⟩, ⟨21982222, 53019740⟩, ⟨685175, 5026769⟩, ⟨3333, 542203⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1279447307, 2091306133⟩, ⟨199883301, 376116268⟩, ⟨(-2242473), 27746221⟩, ⟨(-722639), 3295496⟩, ⟨(-138178), 368204⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1657341981), (-1243006485)⟩, ⟨(-207167748), (-207167747)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2637625315, 3051960811⟩, ⟨(-207167748), (-207167747)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨381140366, 1018299103⟩, ⟨119088288, 366277182⟩, ⟨7118548, 59957416⟩, ⟨(-1096490), 8068840⟩, ⟨(-275617), 1115002⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4676107662, 5313266399⟩, ⟨119088288, 366277182⟩, ⟨7118548, 59957416⟩, ⟨(-1096490), 8068840⟩, ⟨(-275617), 1115002⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4481487418, 4777060333⟩, ⟨53535047, 175516338⟩, ⟨(-25891), 28411231⟩, ⟨(-1638147), 3867522⟩, ⟨(-373604), 598538⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2752171052, 3394531303⟩, ⟨(-197544563), (-91444390)⟩, ⟨(-8484429), 17606475⟩, ⟨(-2534467), 2749472⟩, ⟨(-452030), 504333⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6064131437, 8085508590⟩, ⟨1010688570, 1010688576⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8562041932, 15221407907⟩, ⟨2854013968, 3805351986⟩, ⟨237834496, 237834500⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8562041932, 15221407907⟩, ⟨2854013968, 3805351986⟩, ⟨237834496, 237834500⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15221407907), (-8562041932)⟩, ⟨(-3805351986), (-2854013968)⟩, ⟨(-237834500), (-237834496)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7610703954), (-4281020966)⟩, ⟨(-1902675993), (-1427006984)⟩, ⟨(-118917250), (-118917248)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨730109202, 1585169078⟩, ⟨(-702231925), (-242579479)⟩, ⟨(-3590864), 135329864⟩, ⟨(-15506142), 13492322⟩, ⟨(-3367758), 1767022⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨467846498, 1252839821⟩, ⟨(-627918585), (-170987241)⟩, ⟨(-804669), 145754964⟩, ⟨(-22293804), 13230807⟩, ⟨(-4165995), 3265054⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1450174232, 1450174233⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨207167747, 207167748⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4599675446, 4599675456⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar237 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified654
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar237 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1243006485, 1657341981⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4481487418, 4777060333⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified655
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((28941 / 100000) : ℝ)..(9647 / 25000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (28941 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (9647 / 25000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((28941 / 100000) : ℝ)..(9647 / 25000), prawitzNormalCorrection
      ((24393 / 10000) * sqrt n) s) ≤ (upper : ℝ) :=
