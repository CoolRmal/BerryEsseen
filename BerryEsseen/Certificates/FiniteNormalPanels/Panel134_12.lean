...
namespace FiniteNormalPanel134_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6889 / 40000)
def radius : Rat := (6889 / 200000)

def j0 : Jet := ⟨⟨739700742, 739700743⟩, ⟨147940148, 147940149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2323838416, 2323838421⟩, ⟨464767682, 464767686⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1257337858, 1257337865⟩, ⟨502935142, 502935148⟩, ⟨50293514, 50293515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨314, 315⟩, ⟨125, 126⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94373), (-94371)⟩, ⟨125, 126⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-27628), (-27626)⟩, ⟨(-11015), (-11013)⟩, ⟨(-1089), (-1086)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5085428, 5085431⟩, ⟨(-11015), (-11013)⟩, ⟨(-1089), (-1086)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1488742, 1488744⟩, ⟨592272, 592274⟩, ⟨57940, 57944⟩, ⟨(-257), (-253)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-141676835), (-141676832)⟩, ⟨592272, 592274⟩, ⟨57940, 57944⟩, ⟨(-257), (-253)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-41475438), (-41475436)⟩, ⟨(-16416791), (-16416787)⟩, ⟨(-1572703), (-1572699)⟩, ⟨13643, 13648⟩, ⟨643, 648⟩⟩
...
def j19 : Jet := ⟨⟨1390180327, 1390180330⟩, ⟨(-16416791), (-16416787)⟩, ⟨(-1572703), (-1572699)⟩, ⟨13643, 13648⟩, ⟨643, 648⟩⟩
...
def j25 : Jet := ⟨⟨3455, 3456⟩, ⟨1378, 1380⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848722), (-848720)⟩, ⟨1378, 1380⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-248461), (-248460)⟩, ⟨(-98982), (-98980)⟩, ⟨(-9739), (-9735)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35542933, 35542935⟩, ⟨(-98982), (-98980)⟩, ⟨(-9739), (-9735)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10405079, 10405080⟩, ⟨4133054, 4133056⟩, ⟨401760, 401765⟩, ⟨(-2293), (-2288)⟩, ⟨(-113), (-108)⟩⟩
...
def j33 : Jet := ⟨⟨(-705422804), (-705422802)⟩, ⟨4133054, 4133056⟩, ⟨401760, 401765⟩, ⟨(-2293), (-2288)⟩, ⟨(-113), (-108)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-206510258), (-206510255)⟩, ⟨(-81394166), (-81394163)⟩, ⟨(-7658823), (-7658818)⟩, ⟨94770, 94776⟩, ⟨4401, 4407⟩⟩
...
def j36 : Jet := ⟨⟨4088457038, 4088457041⟩, ⟨(-81394166), (-81394163)⟩, ⟨(-7658823), (-7658818)⟩, ⟨94770, 94776⟩, ⟨4401, 4407⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨752172071, 752172075⟩, ⟨141551931, 141551937⟩, ⟨(-2627425), (-2627420)⟩, ⟨(-162805), (-162800)⟩, ⟨1823, 1828⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4511908499, 4511908503⟩, ⟨89824353, 89824359⟩, ⟨10240308, 10240317⟩, ⟨267538, 267550⟩, ⟨17561, 17572⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨790164703, 790164709⟩, ⟨164432620, 164432629⟩, ⟨1993630, 1993640⟩, ⟨158370, 158381⟩, ⟨4137, 4149⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-739700743), (-739700742)⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3555266553, 3555266554⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨145370200, 145370203⟩, ⟨60502836, 60502842⟩, ⟨7028849, 7028856⟩, ⟨210924, 210932⟩, ⟨14573, 14582⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4440337496, 4440337499⟩, ⟨60502836, 60502842⟩, ⟨7028849, 7028856⟩, ⟨210924, 210932⟩, ⟨14573, 14582⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4367047552, 4367047555⟩, ⟨29752103, 29752107⟩, ⟨3355068, 3355073⟩, ⟨80862, 80868⟩, ⟨5325, 5332⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3614932786, 3614932791⟩, ⟨(-125794907), (-125794901)⟩, ⟨1752429, 1752435⟩, ⟨(-48631), (-48624)⟩, ⟨1621, 1629⟩⟩
...
def j47 : Jet := ⟨⟨6943428942, 6943428954⟩, ⟨1388685784, 1388685795⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11225046001, 11225046041⟩, ⟨4490018386, 4490018430⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11225046001, 11225046041⟩, ⟨4490018386, 4490018430⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11225046041), (-11225046001)⟩, ⟨(-4490018430), (-4490018386)⟩, ⟨(-449001845), (-449001837)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5612523021), (-5612523000)⟩, ⟨(-2245009215), (-2245009193)⟩, ⟨(-224500923), (-224500918)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1162620591, 1162620609⟩, ⟨(-607709862), (-607709846)⟩, ⟨98056088, 98056098⟩, ⟨4092075, 4092079⟩, ⟨(-3097470), (-3097468)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨978539533, 978539550⟩, ⟨(-545541305), (-545541287)⟩, ⟨100804113, 100804128⟩, ⟨311084, 311095⟩, ⟨(-2679567), (-2679557)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨591760594, 887640892⟩, ⟨147940148, 147940149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1859070734, 2788606106⟩, ⟨464767682, 464767686⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨804696230, 1810566526⟩, ⟨402348114, 603522178⟩, ⟨50293514, 50293515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨201, 454⟩, ⟨100, 152⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94486), (-94232)⟩, ⟨100, 152⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-39832), (-17655)⟩, ⟨(-13260), (-8762)⟩, ⟨(-1096), (-1075)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073224, 5095402⟩, ⟨(-13260), (-8762)⟩, ⟨(-1096), (-1075)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨950508, 2147995⟩, ⟨469664, 714358⟩, ⟨57079, 58646⟩, ⟨(-311), (-200)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142215069), (-141017581)⟩, ⟨469664, 714358⟩, ⟨57079, 58646⟩, ⟨(-311), (-200)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-59951526), (-26420763)⟩, ⟨(-19895848), (-12909239)⟩, ⟨(-1610630), (-1526193)⟩, ⟨10714, 16570⟩, ⟨618, 668⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1371704239, 1405235003⟩, ⟨(-19895848), (-12909239)⟩, ⟨(-1610630), (-1526193)⟩, ⟨10714, 16570⟩, ⟨618, 668⟩⟩
...
def j70 : Jet := ⟨⟨(-46), (-20)⟩, ⟨(-16), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11789, 11816⟩, ⟨(-16), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2208, 4982⟩, ⟨1097, 1660⟩, ⟨134, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849969), (-847194)⟩, ⟨1097, 1660⟩, ⟨134, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-358309), (-158728)⟩, ⟨(-119232), (-78664)⟩, ⟨(-9827), (-9627)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35433085, 35632667⟩, ⟨(-119232), (-78664)⟩, ⟨(-9827), (-9627)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6638669, 15021143⟩, ⟨3269071, 4992310⟩, ⟨394018, 408082⟩, ⟨(-2774), (-1805)⟩, ⟨(-115), (-105)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709189214), (-700806739)⟩, ⟨3269071, 4992310⟩, ⟨394018, 408082⟩, ⟨(-2774), (-1805)⟩, ⟨(-115), (-105)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-298962522), (-131301707)⟩, ⟨(-99041689), (-63546317)⟩, ⟨(-7924450), (-7332814)⟩, ⟨74021, 115466⟩, ⟨4174, 4591⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3996004774, 4163665589⟩, ⟨(-99041689), (-63546317)⟩, ⟨(-7924450), (-7332814)⟩, ⟨74021, 115466⟩, ⟨4174, 4591⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨593740308, 912381083⟩, ⟨135517239, 146475769⟩, ⟨(-3198712), (-2057546)⟩, ⟨(-169653), (-154393)⟩, ⟨1426, 2228⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4430409618, 4616296806⟩, ⟨67617392, 114415739⟩, ⟨8834572, 11990363⟩, ⟨125898, 442015⟩, ⟨9215, 28855⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨612463981, 980641200⟩, ⟨149138282, 181739773⟩, ⟨(-83224), 4326727⟩, ⟨28598, 311165⟩, ⟨(-6735), 16938⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-887640892), (-591760594)⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3407326404, 3703206702⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨87337598, 223903257⟩, ⟨42534352, 82990858⟩, ⟨5140668, 9666030⟩, ⟨1112, 508262⟩, ⟨(-1174), 38429⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4382304894, 4518870553⟩, ⟨42534352, 82990858⟩, ⟨5140668, 9666030⟩, ⟨1112, 508262⟩, ⟨(-1174), 38429⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4338416324, 4405496708⟩, ⟨20733604, 41079855⟩, ⟨2314318, 4735070⟩, ⟨(-44286), 240526⟩, ⟨(-5444), 18825⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3441795821, 3798507372⟩, ⟨(-135298745), (-114016876)⟩, ⟨421021, 3368505⟩, ⟨(-201285), 127671⟩, ⟨(-12979), 17758⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5554743157, 8332114748⟩, ⟨1388685784, 1388685795⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7184029449, 16164066311⟩, ⟨3592014710, 5388022118⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7184029449, 16164066311⟩, ⟨3592014710, 5388022118⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16164066311), (-7184029449)⟩, ⟨(-5388022118), (-3592014710)⟩, ⟨(-449001845), (-449001837)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8082033156), (-3592014724)⟩, ⟨(-2694011059), (-1796007355)⟩, ⟨(-224500923), (-224500918)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨654226900, 1860997890⟩, ⟨(-1167307817), (-273575150)⟩, ⟨(-40075801), 331899046⟩, ⟨(-59861066), 49056487⟩, ⟨(-16366947), 10434334⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨524268348, 1645883128⟩, ⟨(-1091002028), (-236598475)⟩, ⟨(-28116769), 331766215⟩, ⟨(-64399771), 44676954⟩, ⟨(-16092193), 11436652⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨739700742, 739700743⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4367047552, 4367047555⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2698
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨591760594, 887640892⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4338416324, 4405496708⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2699
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (69883963 / 4294967296)

theorem envelope_integral : (∫ s in ((6889 / 50000) : ℝ)..(20667 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((6889 / 50000) : ℝ)..(20667 / 100000), prawitzNormalCorrection
