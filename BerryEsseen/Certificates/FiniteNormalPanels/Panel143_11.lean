...
namespace FiniteNormalPanel143_11
...
def j2 : Jet := ⟨⟨441205463, 441205468⟩, ⟨441205463, 441205468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨45323339, 45323341⟩, ⟨90646678, 90646682⟩, ⟨45323339, 45323341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1000), (-999)⟩, ⟨(-1999), (-1997)⟩, ⟨(-1000), (-997)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112056, 5112058⟩, ⟨(-1999), (-1997)⟩, ⟨(-1000), (-997)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨53945, 53946⟩, ⟨107869, 107871⟩, ⟨53891, 53894⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143111632), (-143111630)⟩, ⟨107869, 107871⟩, ⟨53891, 53894⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1510209), (-1510208)⟩, ⟨(-3019280), (-3019278)⟩, ⟨(-1507365), (-1507362)⟩, ⟨2274, 2277⟩, ⟨566, 569⟩⟩
...
def j19 : Jet := ⟨⟨1430145556, 1430145558⟩, ⟨(-3019280), (-3019278)⟩, ⟨(-1507365), (-1507362)⟩, ⟨2274, 2277⟩, ⟨566, 569⟩⟩
...
def j25 : Jet := ⟨⟨124, 125⟩, ⟨248, 250⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852053), (-852051)⟩, ⟨248, 250⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8992), (-8991)⟩, ⟨(-17981), (-17979)⟩, ⟨(-8986), (-8983)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782402, 35782404⟩, ⟨(-17981), (-17979)⟩, ⟨(-8986), (-8983)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨377599, 377600⟩, ⟨755009, 755011⟩, ⟨377124, 377127⟩, ⟨(-380), (-377)⟩, ⟨(-96), (-92)⟩⟩
...
def j33 : Jet := ⟨⟨(-715450284), (-715450282)⟩, ⟨755009, 755011⟩, ⟨377124, 377127⟩, ⟨(-380), (-377)⟩, ⟨(-96), (-92)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7549906), (-7549905)⟩, ⟨(-15091844), (-15091842)⟩, ⟨(-7529993), (-7529990)⟩, ⟨15921, 15925⟩, ⟨3968, 3973⟩⟩
...
def j36 : Jet := ⟨⟨4287417390, 4287417391⟩, ⟨(-15091844), (-15091842)⟩, ⟨(-7529993), (-7529990)⟩, ⟨15921, 15925⟩, ⟨3968, 3973⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨146913349, 146913352⟩, ⟨146603189, 146603194⟩, ⟨(-465006), (-465003)⟩, ⟨(-154613), (-154611)⟩, ⟨291, 293⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302530495, 4302530497⟩, ⟨15145039, 15145043⟩, ⟨7609842, 7609848⟩, ⟨37402, 37410⟩, ⟨9451, 9461⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨147172055, 147172059⟩, ⟨147379399, 147379406⟩, ⟨311432, 311438⟩, ⟨104505, 104511⟩, ⟨520, 527⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-140440062), (-140440061)⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4154527234, 4154527235⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5043021, 5043023⟩, ⟨10100252, 10100256⟩, ⟨5078583, 5078587⟩, ⟨28532, 28538⟩, ⟨7228, 7235⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300010317, 4300010319⟩, ⟨10100252, 10100256⟩, ⟨5078583, 5078587⟩, ⟨28532, 28538⟩, ⟨7228, 7235⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297488066, 4297488068⟩, ⟨5047163, 5047166⟩, ⟨2534837, 2534841⟩, ⟨11280, 11285⟩, ⟨2849, 2855⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4156965577, 4156965581⟩, ⟨(-135640362), (-135640357)⟩, ⟨2286913, 2286920⟩, ⟨(-71976), (-71970)⟩, ⟨2385, 2394⟩⟩
...
def j47 : Jet := ⟨⟨1528888641, 1528888653⟩, ⟨1528888641, 1528888653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨544241740, 544241750⟩, ⟨1088483480, 1088483500⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨544241740, 544241750⟩, ⟨1088483480, 1088483500⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-544241750), (-544241740)⟩, ⟨(-1088483500), (-1088483480)⟩, ⟨(-544241750), (-544241740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-272120875), (-272120870)⟩, ⟨(-544241750), (-544241740)⟩, ⟨(-272120875), (-272120870)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4031287736, 4031287742⟩, ⟨(-510829291), (-510829280)⟩, ⟨(-223049485), (-223049477)⟩, ⟨30998098, 30998100⟩, ⟨6084002, 6084004⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3901758312, 3901758323⟩, ⟨(-621728858), (-621728840)⟩, ⟨(-197603546), (-197603528)⟩, ⟨36706717, 36706730⟩, ⟨4801587, 4801605⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 280880124⟩, ⟨140440061, 140440062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 882410935⟩, ⟨441205463, 441205468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 181293362⟩, ⟨0, 181293362⟩, ⟨45323339, 45323341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3997), 0⟩, ⟨(-3997), 2⟩, ⟨(-1000), (-995)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109059, 5113057⟩, ⟨(-3997), 2⟩, ⟨(-1000), (-995)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 215826⟩, ⟨(-169), 215827⟩, ⟨53702, 53958⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142949750)⟩, ⟨(-169), 215827⟩, ⟨53702, 53958⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6043113), 0⟩, ⟨(-6043121), 9111⟩, ⟨(-1510787), (-1497111)⟩, ⟨(-6), 4557⟩, ⟨561, 571⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425612652, 1431655766⟩, ⟨(-6043121), 9111⟩, ⟨(-1510787), (-1497111)⟩, ⟨(-6), 4557⟩, ⟨561, 571⟩⟩
...
def j72 : Jet := ⟨⟨0, 500⟩, ⟨(-1), 500⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851676)⟩, ⟨(-1), 500⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-35971), 0⟩, ⟨(-35972), 22⟩, ⟨(-8994), (-8959)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35755423, 35791395⟩, ⟨(-35972), 22⟩, ⟨(-8994), (-8959)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1510779⟩, ⟨(-1519), 1510780⟩, ⟨375415, 377696⟩, ⟨(-761), 2⟩, ⟨(-97), (-92)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714317103)⟩, ⟨(-1519), 1510780⟩, ⟨375415, 377696⟩, ⟨(-761), 2⟩, ⟨(-97), (-92)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30215561), 0⟩, ⟨(-30215626), 63772⟩, ⟨(-7553956), (-7458232)⟩, ⟨(-50), 31887⟩, ⟨3923, 3987⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264751735, 4294967296⟩, ⟨(-30215626), 63772⟩, ⟨(-7553956), (-7458232)⟩, ⟨(-50), 31887⟩, ⟨3923, 3987⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 294136979⟩, ⟨145206127, 147070362⟩, ⟨(-931182), 936⟩, ⟨(-155200), (-152855)⟩, ⟨(-1), 587⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4325396933⟩, ⟨(-64680), 30645296⟩, ⟨7457776, 7878497⟩, ⟨(-32574), 110152⟩, ⟨8476, 10786⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 296220926⟩, ⟨145201697, 150211065⟩, ⟨(-939995), 1589867⟩, ⟨86959, 124484⟩, ⟨(-3935), 5108⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-280880124), 0⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4014087172, 4294967296⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20430153⟩, ⟨0, 20719908⟩, ⟨4779230, 5472749⟩, ⟨(-65752), 128380⟩, ⟨4986, 10003⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315397449⟩, ⟨0, 20719908⟩, ⟨4779230, 5472749⟩, ⟨(-65752), 128380⟩, ⟨4986, 10003⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305170254⟩, ⟨0, 10359954⟩, ⟨2371486, 2736375⟩, ⟨(-39477), 64190⟩, ⟨1462, 4443⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4014087172, 4305170254⟩, ⟨(-140773686), (-130080107)⟩, ⟨1877638, 2736375⟩, ⟨(-128954), (-13354)⟩, ⟨(-733), 5734⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3057777306⟩, ⟨1528888641, 1528888653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2176966997⟩, ⟨0, 2176966998⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2176966997⟩, ⟨0, 2176966998⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2176966997), 0⟩, ⟨(-2176966998), 0⟩, ⟨(-544241750), (-544241740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1088483499), 0⟩, ⟨(-1088483499), 0⟩, ⟨(-272120875), (-272120870)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3333462743, 4294967296⟩, ⟨(-1088483499), 0⟩, ⟨(-272120875), (-73273344)⟩, ⟨0, 68964223⟩, ⟨(-2048212), 8620528⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3115462613, 4305170254⟩, ⟨(-1231842945), (-100959369)⟩, ⟨(-271310020), (-30068474)⟩, ⟨1396763, 78036839⟩, ⟨(-4487584), 8647390⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297488066, 4297488068⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2880
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305170254⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2881
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (1960709 / 33554432)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(26159 / 400000), prawitzNormalCorrection
