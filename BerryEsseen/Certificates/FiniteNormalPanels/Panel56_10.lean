...
namespace FiniteNormalPanel56_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (232141 / 800000)
def radius : Rat := (33163 / 800000)

def j0 : Jet := ⟨⟨1246297503, 1246297504⟩, ⟨178042500, 178042501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3915359079, 3915359083⟩, ⟨559337010, 559337014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3569302316, 3569302324⟩, ⟨1019800658, 1019800668⟩, ⟨72842904, 72842906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨893, 895⟩, ⟨255, 256⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93794), (-93791)⟩, ⟨255, 256⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-77947), (-77944)⟩, ⟨(-22060), (-22056)⟩, ⟨(-1517), (-1513)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5035109, 5035113⟩, ⟨(-22060), (-22056)⟩, ⟨(-1517), (-1513)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4184391, 4184396⟩, ⟨1177207, 1177213⟩, ⟨78896, 78903⟩, ⟨(-730), (-724)⟩, ⟨(-25), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-138981186), (-138981180)⟩, ⟨1177207, 1177213⟩, ⟨78896, 78903⟩, ⟨(-730), (-724)⟩, ⟨(-25), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-115499336), (-115499330)⟩, ⟨(-32021502), (-32021493)⟩, ⟨(-2012048), (-2012038)⟩, ⟨38091, 38100⟩, ⟨1143, 1151⟩⟩
...
def j19 : Jet := ⟨⟨1316156429, 1316156436⟩, ⟨(-32021502), (-32021493)⟩, ⟨(-2012048), (-2012038)⟩, ⟨38091, 38100⟩, ⟨1143, 1151⟩⟩
...
def j25 : Jet := ⟨⟨9760, 9764⟩, ⟨2766, 2770⟩, ⟨190, 195⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842417), (-842412)⟩, ⟨2766, 2770⟩, ⟨190, 195⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-700085), (-700080)⟩, ⟨(-197727), (-197721)⟩, ⟨(-13475), (-13466)⟩, ⟨89, 94⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35091309, 35091315⟩, ⟨(-197727), (-197721)⟩, ⟨(-13475), (-13466)⟩, ⟨89, 94⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29162385, 29162391⟩, ⟨8167790, 8167798⟩, ⟨537002, 537014⟩, ⟨(-6481), (-6471)⟩, ⟨(-208), (-201)⟩⟩
...
def j33 : Jet := ⟨⟨(-686665498), (-686665491)⟩, ⟨8167790, 8167798⟩, ⟨537002, 537014⟩, ⟨(-6481), (-6471)⟩, ⟨(-208), (-201)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-570648527), (-570648519)⟩, ⟨(-156254653), (-156254641)⟩, ⟨(-9260252), (-9260237)⟩, ⟨260646, 260660⟩, ⟨7395, 7405⟩⟩
...
def j36 : Jet := ⟨⟨3724318769, 3724318777⟩, ⟨(-156254653), (-156254641)⟩, ⟨(-9260252), (-9260237)⟩, ⟨260646, 260660⟩, ⟨7395, 7405⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1199828699, 1199828707⟩, ⟨142212799, 142212811⟩, ⟨(-6004401), (-6004389)⟩, ⟨(-227307), (-227296)⟩, ⟨6001, 6012⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4953051867, 4953051879⟩, ⟨207806416, 207806435⟩, ⟨21033952, 21033978⟩, ⟨1052520, 1052545⟩, ⟨72063, 72083⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1383669156, 1383669170⟩, ⟨222055117, 222055139⟩, ⟨5832351, 5832375⟩, ⟨437841, 437867⟩, ⟨21497, 21521⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1246297504), (-1246297503)⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3048669792, 3048669793⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨445763658, 445763668⟩, ⟨143074810, 143074828⟩, ⟨15238429, 15238451⟩, ⟨885188, 885212⟩, ⟨67042, 67067⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4740730954, 4740730964⟩, ⟨143074810, 143074828⟩, ⟨15238429, 15238451⟩, ⟨885188, 885212⟩, ⟨67042, 67067⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4512347992, 4512347998⟩, ⟨68091116, 68091126⟩, ⟨6738415, 6738427⟩, ⟨319588, 319603⟩, ⟨22051, 22066⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3202971772, 3202971779⟩, ⟨(-138721056), (-138721045)⟩, ⟨1960454, 1960464⟩, ⟨(-52483), (-52470)⟩, ⟨2403, 2415⟩⟩
...
def j47 : Jet := ⟨⟨8524191641, 8524191651⟩, ⟨1217741660, 1217741668⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16917903705, 16917903746⟩, ⟨4833686760, 4833686800⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16917903705, 16917903746⟩, ⟨4833686760, 4833686800⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16917903746), (-16917903705)⟩, ⟨(-4833686800), (-4833686760)⟩, ⟨(-345263344), (-345263339)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8458951873), (-8458951852)⟩, ⟨(-2416843400), (-2416843380)⟩, ⟨(-172631672), (-172631669)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨599260267, 599260277⟩, ⟨(-337212870), (-337212860)⟩, ⟨70790766, 70790773⟩, ⟨(-4242406), (-4242403)⟩, ⟨(-825865), (-825863)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨446898331, 446898341⟩, ⟨(-270831708), (-270831696)⟩, ⟨63957218, 63957230⟩, ⟨(-5611458), (-5611449)⟩, ⟨(-442100), (-442092)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1068255003, 1424340005⟩, ⟨178042500, 178042501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3356022069, 4474696097⟩, ⟨559337010, 559337014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2622344560, 4661945897⟩, ⟨874114850, 1165486478⟩, ⟨72842904, 72842906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨656, 1168⟩, ⟨218, 292⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94031), (-93518)⟩, ⟨218, 292⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-102066), (-57098)⟩, ⟨(-25384), (-18715)⟩, ⟨(-1541), (-1485)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5010990, 5055959⟩, ⟨(-25384), (-18715)⟩, ⟨(-1541), (-1485)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3059520, 5487960⟩, ⟨992287, 1360564⟩, ⟨76424, 81036⟩, ⟨(-847), (-607)⟩, ⟨(-26), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140106057), (-137677616)⟩, ⟨992287, 1360564⟩, ⟨76424, 81036⟩, ⟨(-847), (-607)⟩, ⟨(-26), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-152077260), (-84060744)⟩, ⟨(-37413464), (-26543431)⟩, ⟨(-2127597), (-1877855)⟩, ⟨31462, 44697⟩, ⟨1037, 1240⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1279578505, 1347595022⟩, ⟨(-37413464), (-26543431)⟩, ⟨(-2127597), (-1877855)⟩, ⟨31462, 44697⟩, ⟨1037, 1240⟩⟩
...
def j70 : Jet := ⟨⟨(-118), (-65)⟩, ⟨(-30), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11717, 11771⟩, ⟨(-30), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7153, 12777⟩, ⟨2351, 3183⟩, ⟨186, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845024), (-839399)⟩, ⟨2351, 3183⟩, ⟨186, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-917227), (-512505)⟩, ⟨(-227872), (-167380)⟩, ⟨(-13741), (-13159)⟩, ⟨73, 108⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34874167, 35278890⟩, ⟨(-227872), (-167380)⟩, ⟨(-13741), (-13159)⟩, ⟨73, 108⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21292847, 38293255⟩, ⟨6850272, 9471119⟩, ⟨514715, 556234⟩, ⟨(-7550), (-5398)⟩, ⟨(-220), (-188)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694535036), (-677534627)⟩, ⟨6850272, 9471119⟩, ⟨514715, 556234⟩, ⟨(-7550), (-5398)⟩, ⟨(-220), (-188)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-753878794), (-413677013)⟩, ⟨(-184287183), (-127611968)⟩, ⟨(-10070920), (-8317174)⟩, ⟨212740, 308277⟩, ⟨6441, 8222⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3541088502, 3881290283⟩, ⟨(-184287183), (-127611968)⟩, ⟨(-10070920), (-8317174)⟩, ⟨212740, 308277⟩, ⟨6441, 8222⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨999843166, 1403986986⟩, ⟨127661445, 154757742⟩, ⟨(-7089016), (-4924099)⟩, ⟨(-252496), (-197986)⟩, ⟨4907, 7113⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4752734974, 5209342852⟩, ⟨156263978, 271107351⟩, ⟨15322345, 28924577⟩, ⟨424875, 1990812⟩, ⟨14231, 167838⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1106408793, 1702888303⟩, ⟨177645236, 276327444⟩, ⟨(-386568), 13774903⟩, ⟨(-199385), 1294760⟩, ⟨(-42312), 110458⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1424340005), (-1068255003)⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2870627291, 3226712293⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨285017401, 675168954⟩, ⟨91524910, 219119142⟩, ⟨7041091, 28701291⟩, ⟨(-207850), 2799192⟩, ⟨(-60450), 298374⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4579984697, 4970136250⟩, ⟨91524910, 219119142⟩, ⟨7041091, 28701291⟩, ⟨(-207850), 2799192⟩, ⟨(-60450), 298374⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4435187086, 4620235130⟩, ⟨42540745, 106095812⟩, ⟨2054541, 13692928⟩, ⟨(-428194), 1335642⟩, ⟨(-82358), 154239⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2964345992, 3471078699⟩, ⟨(-163093116), (-104147739)⟩, ⟨(-3024877), 8523716⟩, ⟨(-889317), 918270⟩, ⟨(-117242), 133628⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7306449981, 9741933318⟩, ⟨1217741660, 1217741668⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12429480283, 22096853884⟩, ⟨4143160082, 5524213486⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12429480283, 22096853884⟩, ⟨4143160082, 5524213486⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-22096853884), (-12429480283)⟩, ⟨(-5524213486), (-4143160082)⟩, ⟨(-345263344), (-345263339)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11048426942), (-6214740141)⟩, ⟨(-2762106743), (-2071580041)⟩, ⟨(-172631672), (-172631669)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨327925635, 1010516916⟩, ⟨(-649866552), (-158167490)⟩, ⟨(-2472410), 195784971⟩, ⟨(-37731724), 17943805⟩, ⟨(-6819615), 6116036⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨226331185, 816672981⟩, ⟨(-563577353), (-117117510)⟩, ⟨1125541, 184911109⟩, ⟨(-39427289), 15269335⟩, ⟨(-6497232), 6930163⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1246297503, 1246297504⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4512347992, 4512347998⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1108
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1068255003, 1424340005⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4435187086, 4620235130⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1109
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (38933649 / 4294967296)

theorem envelope_integral : (∫ s in ((99489 / 400000) : ℝ)..(33163 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((99489 / 400000) : ℝ)..(33163 / 100000), prawitzNormalCorrection
