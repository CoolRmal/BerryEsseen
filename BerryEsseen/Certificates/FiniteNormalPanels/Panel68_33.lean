...
namespace FiniteNormalPanel68_33

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (143667 / 800000)
def radius : Rat := (15963 / 800000)

def j0 : Jet := ⟨⟨771306333, 771306334⟩, ⟨85700703, 85700704⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2423130309, 2423130313⟩, ⟨269236698, 269236703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1367079209, 1367079214⟩, ⟨303795376, 303795384⟩, ⟨16877520, 16877522⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨342, 343⟩, ⟨76, 77⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94345), (-94343)⟩, ⟨76, 77⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-30030), (-30029)⟩, ⟨(-6650), (-6648)⟩, ⟨(-365), (-362)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5083026, 5083028⟩, ⟨(-6650), (-6648)⟩, ⟨(-365), (-362)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1617916, 1617918⟩, ⟨357420, 357422⟩, ⟨19386, 19390⟩, ⟨(-53), (-50)⟩, ⟨(-2), 1⟩⟩
...
def j16 : Jet := ⟨⟨(-141547661), (-141547658)⟩, ⟨357420, 357422⟩, ⟨19386, 19390⟩, ⟨(-53), (-50)⟩, ⟨(-2), 1⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-45054328), (-45054326)⟩, ⟨(-9898307), (-9898305)⟩, ⟨(-524776), (-524772)⟩, ⟨2758, 2762⟩, ⟨71, 75⟩⟩
...
def j19 : Jet := ⟨⟨1386601437, 1386601440⟩, ⟨(-9898307), (-9898305)⟩, ⟨(-524776), (-524772)⟩, ⟨2758, 2762⟩, ⟨71, 75⟩⟩
...
def j22 : Jet := ⟨⟨(-35), (-34)⟩, ⟨(-8), (-7)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11800, 11802⟩, ⟨(-8), (-7)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3755, 3757⟩, ⟨831, 833⟩, ⟨44, 47⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848422), (-848419)⟩, ⟨831, 833⟩, ⟨44, 47⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-270051), (-270050)⟩, ⟨(-59748), (-59745)⟩, ⟨(-3262), (-3259)⟩, ⟨5, 8⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35521343, 35521345⟩, ⟨(-59748), (-59745)⟩, ⟨(-3262), (-3259)⟩, ⟨5, 8⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11306370, 11306371⟩, ⟨2493508, 2493511⟩, ⟨134318, 134323⟩, ⟨(-465), (-461)⟩, ⟨(-14), (-10)⟩⟩
...
def j33 : Jet := ⟨⟨(-704521513), (-704521511)⟩, ⟨2493508, 2493511⟩, ⟨134318, 134323⟩, ⟨(-465), (-461)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-224247742), (-224247740)⟩, ⟨(-49039154), (-49039150)⟩, ⟨(-2549366), (-2549361)⟩, ⟨19149, 19155⟩, ⟨489, 493⟩⟩
...
def j36 : Jet := ⟨⟨4070719554, 4070719556⟩, ⟨(-49039154), (-49039150)⟩, ⟨(-2549366), (-2549361)⟩, ⟨19149, 19155⟩, ⟨489, 493⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨782291397, 782291401⟩, ⟨81336848, 81336853⟩, ⟨(-916559), (-916555)⟩, ⟨(-31341), (-31337)⟩, ⟨212, 217⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4531568392, 4531568395⟩, ⟨54590903, 54590910⟩, ⟨3495620, 3495629⟩, ⟨54974, 54985⟩, ⟨2042, 2053⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨825386254, 825386259⟩, ⟨95760795, 95760803⟩, ⟨703472, 703480⟩, ⟨31494, 31504⟩, ⟨490, 502⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-771306334), (-771306333)⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3523660962, 3523660963⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨158618778, 158618781⟩, ⟨36805702, 36805706⟩, ⟨2405465, 2405472⟩, ⟨43472, 43480⟩, ⟨1707, 1716⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4453586074, 4453586077⟩, ⟨36805702, 36805706⟩, ⟨2405465, 2405472⟩, ⟨43472, 43480⟩, ⟨1707, 1716⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4373557652, 4373557654⟩, ⟨18072162, 18072165⟩, ⟨1143781, 1143786⟩, ⟨16618, 16624⟩, ⟨619, 626⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3588137767, 3588137770⟩, ⟨(-72442182), (-72442177)⟩, ⟨577768, 577774⟩, ⟨(-9190), (-9183)⟩, ⟨175, 183⟩⟩
...
def j47 : Jet := ⟨⟨5711448047, 5711448057⟩, ⟨634605333, 634605342⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7595084326, 7595084354⟩, ⟨1687796502, 1687796530⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7595084326, 7595084354⟩, ⟨1687796502, 1687796530⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7595084354), (-7595084326)⟩, ⟨(-1687796530), (-1687796502)⟩, ⟨(-93766475), (-93766471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3797542177), (-3797542163)⟩, ⟨(-843898265), (-843898251)⟩, ⟨(-46883238), (-46883235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1774040565, 1774040577⟩, ⟨(-348573031), (-348573022)⟩, ⟨14879581, 14879585⟩, ⟨1562107, 1562109⟩, ⟨(-157945), (-157944)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1482083916, 1482083928⟩, ⟨(-321130136), (-321130125)⟩, ⟨18548768, 18548778⟩, ⟨1003369, 1003378⟩, ⟨(-155482), (-155473)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨685605629, 857007037⟩, ⟨85700703, 85700704⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2153893607, 2692367012⟩, ⟨269236698, 269236703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1080161349, 1687752113⟩, ⟨270040334, 337550426⟩, ⟨16877520, 16877522⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨270, 423⟩, ⟨67, 85⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94417), (-94263)⟩, ⟨67, 85⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-37103), (-23706)⟩, ⟨(-7405), (-5892)⟩, ⟨(-367), (-361)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5075953, 5089351⟩, ⟨(-7405), (-5892)⟩, ⟨(-367), (-361)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1276575, 1999914⟩, ⟨316233, 398502⟩, ⟨19219, 19540⟩, ⟨(-59), (-44)⟩, ⟨(-2), 1⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141889002), (-141165662)⟩, ⟨316233, 398502⟩, ⟨19219, 19540⟩, ⟨(-59), (-44)⟩, ⟨(-2), 1⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-55756761), (-35502410)⟩, ⟨(-11071823), (-8719006)⟩, ⟨(-532853), (-515726)⟩, ⟨2426, 3091⟩, ⟨69, 76⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1375899004, 1396153356⟩, ⟨(-11071823), (-8719006)⟩, ⟨(-532853), (-515726)⟩, ⟨2426, 3091⟩, ⟨69, 76⟩⟩
...
def j70 : Jet := ⟨⟨(-43), (-26)⟩, ⟨(-9), (-6)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11792, 11810⟩, ⟨(-9), (-6)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2965, 4641⟩, ⟨737, 928⟩, ⟨44, 47⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849212), (-847535)⟩, ⟨737, 928⟩, ⟨44, 47⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-333707), (-213150)⟩, ⟨(-66557), (-52922)⟩, ⟨(-3281), (-3238)⟩, ⟨3, 8⟩, ⟨(-2), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35457687, 35578245⟩, ⟨(-66557), (-52922)⟩, ⟨(-3281), (-3238)⟩, ⟨3, 8⟩, ⟨(-2), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8917419, 13980842⟩, ⟨2203199, 2782860⟩, ⟨132813, 135668⟩, ⟨(-520), (-406)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706910464), (-701847040)⟩, ⟨2203199, 2782860⟩, ⟨132813, 135668⟩, ⟨(-520), (-406)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-277787827), (-176510784)⟩, ⟨(-55003474), (-43034141)⟩, ⟨(-2605955), (-2485956)⟩, ⟨16802, 21497⟩, ⟨474, 507⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4017179469, 4118456512⟩, ⟨(-55003474), (-43034141)⟩, ⟨(-2605955), (-2485956)⟩, ⟨16802, 21497⟩, ⟨474, 507⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨690002941, 875200434⟩, ⟨79309821, 83147529⟩, ⟨(-1028083), (-805196)⟩, ⟨(-32187), (-30391)⟩, ⟨186, 242⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4479043063, 4591964143⟩, ⟨46801943, 62873463⟩, ⟨3192647, 3839688⟩, ⟨37640, 74627⟩, ⟨1424, 2790⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨719575417, 935720516⟩, ⟨90227830, 101709123⟩, ⟨277968, 1159908⟩, ⟨15538, 49075⟩, ⟨(-276), 1344⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-857007037), (-685605629)⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3437960259, 3609361667⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨120557095, 203860199⟩, ⟨30233398, 44317598⟩, ⟨1988628, 2913980⟩, ⟨16884, 76320⟩, ⟨547, 3226⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4415524391, 4498827495⟩, ⟨30233398, 44317598⟩, ⟨1988628, 2913980⟩, ⟨16884, 76320⟩, ⟨547, 3226⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4354828682, 4395715751⟩, ⟨14770228, 21854205⟩, ⟨917197, 1411915⟩, ⟨1228, 34525⟩, ⟨(-134), 1491⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3485877053, 3694027647⟩, ⟨(-75888001), (-68529543)⟩, ⟨298107, 891811⟩, ⟨(-27191), 10713⟩, ⟨(-802), 1229⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5076842706, 6346053391⟩, ⟨634605333, 634605342⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6001054277, 9376647334⟩, ⟨1500263556, 1875329476⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6001054277, 9376647334⟩, ⟨1500263556, 1875329476⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9376647334), (-6001054277)⟩, ⟨(-1875329476), (-1500263556)⟩, ⟨(-93766475), (-93766471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4688323667), (-3000527138)⟩, ⟨(-937664738), (-750131778)⟩, ⟨(-46883238), (-46883235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1441751245, 2135774357⟩, ⟨(-466276031), (-251807138)⟩, ⟨(-1324283), 35160067⟩, ⟨(-726222), 3489573⟩, ⟨(-382360), 46865⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1170152700, 1836942864⟩, ⟨(-438773120), (-227375719)⟩, ⟨2978853, 38922702⟩, ⟨(-1356198), 3012572⟩, ⟨(-392358), 64005⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨771306333, 771306334⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4373557652, 4373557654⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1360
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨685605629, 857007037⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4354828682, 4395715751⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1361
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (59393521 / 4294967296)

theorem envelope_integral : (∫ s in ((15963 / 100000) : ℝ)..(15963 / 80000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (15963 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (15963 / 80000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((15963 / 100000) : ℝ)..(15963 / 80000), prawitzNormalCorrection
