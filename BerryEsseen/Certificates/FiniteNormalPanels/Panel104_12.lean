...
namespace FiniteNormalPanel104_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8571 / 80000)
def radius : Rat := (2857 / 80000)

def j0 : Jet := ⟨⟨460152058, 460152059⟩, ⟨153384019, 153384020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1445610324, 1445610329⟩, ⟨481870107, 481870111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨486566966, 486566970⟩, ⟨324377976, 324377982⟩, ⟨54062996, 54062997⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨121, 122⟩, ⟨81, 82⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94566), (-94564)⟩, ⟨81, 82⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10714), (-10712)⟩, ⟨(-7134), (-7131)⟩, ⟨(-1184), (-1181)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102342, 5102345⟩, ⟨(-7134), (-7131)⟩, ⟨(-1184), (-1181)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨578032, 578033⟩, ⟨384546, 384549⟩, ⟨63551, 63555⟩, ⟨(-180), (-177)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-142587545), (-142587543)⟩, ⟨384546, 384549⟩, ⟨63551, 63555⟩, ⟨(-180), (-177)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16153416), (-16153414)⟩, ⟨(-10725380), (-10725378)⟩, ⟨(-1758583), (-1758579)⟩, ⟨9618, 9621⟩, ⟨783, 786⟩⟩
...
def j19 : Jet := ⟨⟨1415502349, 1415502352⟩, ⟨(-10725380), (-10725378)⟩, ⟨(-1758583), (-1758579)⟩, ⟨9618, 9621⟩, ⟨783, 786⟩⟩
...
def j25 : Jet := ⟨⟨1339, 1340⟩, ⟨890, 894⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850838), (-850836)⟩, ⟨890, 894⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-96390), (-96389)⟩, ⟨(-64160), (-64157)⟩, ⟨(-10627), (-10624)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35695004, 35695006⟩, ⟨(-64160), (-64157)⟩, ⟨(-10627), (-10624)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4043804, 4043806⟩, ⟨2688600, 2688603⟩, ⟨443261, 443264⟩, ⟨(-1609), (-1606)⟩, ⟨(-134), (-130)⟩⟩
...
def j33 : Jet := ⟨⟨(-711784079), (-711784076)⟩, ⟨2688600, 2688603⟩, ⟨443261, 443264⟩, ⟨(-1609), (-1606)⟩, ⟨(-134), (-130)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-80636382), (-80636380)⟩, ⟨(-53453004), (-53453000)⟩, ⟨(-8706327), (-8706322)⟩, ⟨67136, 67140⟩, ⟨5441, 5445⟩⟩
...
def j36 : Jet := ⟨⟨4214330914, 4214330916⟩, ⟨(-53453004), (-53453000)⟩, ⟨(-8706327), (-8706322)⟩, ⟨67136, 67140⟩, ⟨5441, 5445⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨476433152, 476433156⟩, ⟨155201076, 155201080⟩, ⟨(-1795234), (-1795230)⟩, ⟨(-194066), (-194063)⟩, ⟨1342, 1345⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4377146560, 4377146563⟩, ⟨55518092, 55518098⟩, ⟨9746850, 9746858⟩, ⟨168584, 168592⟩, ⟨15732, 15741⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨485549152, 485549158⟩, ⟨164329194, 164329200⟩, ⟨1257793, 1257801⟩, ⟨149921, 149930⟩, ⟨2619, 2629⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-460152059), (-460152058)⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3834815237, 3834815238⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨54891681, 54891684⟩, ⟨37155066, 37155070⟩, ⟨6571766, 6571771⟩, ⟨130144, 130150⟩, ⟨12432, 12439⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4349858977, 4349858980⟩, ⟨37155066, 37155070⟩, ⟨6571766, 6571771⟩, ⟨130144, 130150⟩, ⟨12432, 12439⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4322325999, 4322326002⟩, ⟨18459944, 18459947⟩, ⟨3225664, 3225668⟩, ⟨50882, 50887⟩, ⟨4755, 4761⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3859242796, 3859242801⟩, ⟨(-137878877), (-137878871)⟩, ⟨2220823, 2220828⟩, ⟨(-69767), (-69760)⟩, ⟨2427, 2434⟩⟩
...
def j47 : Jet := ⟨⟨4369143459, 4369143470⟩, ⟨1456381149, 1456381160⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4444600680, 4444600703⟩, ⟨2963067112, 2963067142⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4444600680, 4444600703⟩, ⟨2963067112, 2963067142⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4444600703), (-4444600680)⟩, ⟨(-2963067142), (-2963067112)⟩, ⟨(-493844525), (-493844517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2222300352), (-2222300340)⟩, ⟨(-1481533571), (-1481533556)⟩, ⟨(-246922263), (-246922258)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2560043671, 2560043692⟩, ⟨(-883077894), (-883077877)⟩, ⟨5127622, 5127632⟩, ⟨33256474, 33256478⟩, ⟨(-3015323), (-3015321)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2300327200, 2300327223⟩, ⟨(-875673247), (-875673225)⟩, ⟨34280102, 34280119⟩, ⟨29219788, 29219801⟩, ⟨(-3758593), (-3758581)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨306768039, 613536079⟩, ⟨153384019, 153384020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨963740217, 1927480439⟩, ⟨481870107, 481870111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨216251985, 865007947⟩, ⟨216251984, 432503976⟩, ⟨54062996, 54062997⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨54, 217⟩, ⟨54, 109⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94633), (-94469)⟩, ⟨54, 109⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-19060), (-4756)⟩, ⟨(-9528), (-4734)⟩, ⟨(-1190), (-1175)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5093996, 5108301⟩, ⟨(-9528), (-4734)⟩, ⟨(-1190), (-1175)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨256483, 1028814⟩, ⟨254564, 514169⟩, ⟨62920, 64004⟩, ⟨(-240), (-117)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142909094), (-142136762)⟩, ⟨254564, 514169⟩, ⟨62920, 64004⟩, ⟨(-240), (-117)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-28781943), (-7156598)⟩, ⟨(-14378155), (-7053044)⟩, ⟨(-1782887), (-1724481)⟩, ⟨6323, 12914⟩, ⟨763, 801⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1402873822, 1424499168⟩, ⟨(-14378155), (-7053044)⟩, ⟨(-1782887), (-1724481)⟩, ⟨6323, 12914⟩, ⟨763, 801⟩⟩
...
def j72 : Jet := ⟨⟨594, 2383⟩, ⟨591, 1192⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851583), (-849793)⟩, ⟨591, 1192⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-171510), (-42787)⟩, ⟨(-85726), (-42546)⟩, ⟨(-10684), (-10544)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35619884, 35748608⟩, ⟨(-85726), (-42546)⟩, ⟨(-10684), (-10544)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1793464, 7199783⟩, ⟨1776198, 3597750⟩, ⟨437581, 447315⟩, ⟨(-2156), (-1058)⟩, ⟨(-136), (-127)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714034419), (-708628099)⟩, ⟨1776198, 3597750⟩, ⟨437581, 447315⟩, ⟨(-2156), (-1058)⟩, ⟨(-136), (-127)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-143806787), (-35679487)⟩, ⟨(-71813963), (-34954898)⟩, ⟨(-8876462), (-8467486)⟩, ⟨43954, 90279⟩, ⟨5262, 5572⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4151160509, 4259287809⟩, ⟨(-71813963), (-34954898)⟩, ⟨(-8876462), (-8467486)⟩, ⟨43954, 90279⟩, ⟨5262, 5572⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨314788408, 639281767⟩, ⟨150941624, 158237823⟩, ⟨(-2413263), (-1178263)⟩, ⟨(-198612), (-187680)⟩, ⟨880, 1809⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4330945665, 4443755917⟩, ⟨35542975, 76875786⟩, ⟨8901634, 10832053⟩, ⟨49522, 305921⟩, ⟨10658, 22591⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨317425348, 661428118⟩, ⟨154811070, 175162115⟩, ⟨(-595327), 3256463⟩, ⟨67777, 245615⟩, ⟨(-6234), 12511⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-613536079), (-306768039)⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3681431217, 3988199257⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨23459748, 101860416⟩, ⟨22883040, 53950190⟩, ⟨5396766, 8146652⟩, ⟨(-38542), 341268⟩, ⟨2512, 26358⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4318427044, 4396827712⟩, ⟨22883040, 53950190⟩, ⟨5396766, 8146652⟩, ⟨(-38542), 341268⟩, ⟨2512, 26358⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306681196, 4345599065⟩, ⟨11308211, 26901725⟩, ⟨2583674, 4047401⟩, ⟨(-44502), 163387⟩, ⟨(-1671), 12647⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3691471786, 4035214652⟩, ⟨(-145499375), (-128822081)⟩, ⟨1253868, 3354472⟩, ⟨(-185867), 59449⟩, ⟨(-7387), 13334⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2912762309, 5825524630⟩, ⟨1456381149, 1456381160⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1975378084, 7901512370⟩, ⟨1975378076, 3950756192⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1975378084, 7901512370⟩, ⟨1975378076, 3950756192⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7901512370), (-1975378084)⟩, ⟨(-3950756192), (-1975378076)⟩, ⟨(-493844525), (-493844517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3950756185), (-987689042)⟩, ⟨(-1975378096), (-987689038)⟩, ⟨(-246922263), (-246922258)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1711870844, 3412617752⟩, ⟨(-1569560347), (-393669136)⟩, ⟨(-150930126), 262525527⟩, ⟨(-25159356), 83296161⟩, ⟨(-17124008), 7231444⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1471332023, 3206228175⟩, ⟨(-1590244161), (-389699188)⟩, ⟨(-129494752), 302485292⟩, ⟨(-33904810), 83303871⟩, ⟨(-19055654), 7929974⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨460152058, 460152059⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4322325999, 4322326002⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2098
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨306768039, 613536079⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306681196, 4345599065⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2099
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (165230305 / 4294967296)

theorem envelope_integral : (∫ s in ((2857 / 40000) : ℝ)..(2857 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((2857 / 40000) : ℝ)..(2857 / 20000), prawitzNormalCorrection
