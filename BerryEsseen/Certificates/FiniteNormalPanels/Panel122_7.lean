...
namespace FiniteNormalPanel122_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (27499 / 160000)
def radius : Rat := (27499 / 800000)

def j0 : Jet := ⟨⟨738170660, 738170661⟩, ⟨147634132, 147634133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2319031522, 2319031526⟩, ⟨463806304, 463806308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1252141594, 1252141600⟩, ⟨500856636, 500856644⟩, ⟨50085663, 50085665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨313, 314⟩, ⟨125, 126⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94374), (-94372)⟩, ⟨125, 126⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-27514), (-27512)⟩, ⟨(-10970), (-10968)⟩, ⟨(-1084), (-1081)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5085542, 5085545⟩, ⟨(-10970), (-10968)⟩, ⟨(-1084), (-1081)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1482623, 1482625⟩, ⟨589850, 589853⟩, ⟨57707, 57711⟩, ⟨(-255), (-251)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-141682954), (-141682951)⟩, ⟨589850, 589853⟩, ⟨57707, 57711⟩, ⟨(-255), (-251)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-41305815), (-41305813)⟩, ⟨(-16350363), (-16350361)⟩, ⟨(-1566625), (-1566621)⟩, ⟨13532, 13536⟩, ⟨638, 642⟩⟩
...
def j19 : Jet := ⟨⟨1390349950, 1390349953⟩, ⟨(-16350363), (-16350361)⟩, ⟨(-1566625), (-1566621)⟩, ⟨13532, 13536⟩, ⟨638, 642⟩⟩
...
def j25 : Jet := ⟨⟨3441, 3442⟩, ⟨1372, 1374⟩, ⟨134, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848736), (-848734)⟩, ⟨1372, 1374⟩, ⟨134, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-247438), (-247437)⟩, ⟨(-98577), (-98573)⟩, ⟨(-9700), (-9696)⟩, ⟨29, 33⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35543956, 35543958⟩, ⟨(-98577), (-98573)⟩, ⟨(-9700), (-9696)⟩, ⟨29, 33⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10362375, 10362377⟩, ⟨4116211, 4116214⟩, ⟨400171, 400175⟩, ⟨(-2274), (-2269)⟩, ⟨(-112), (-108)⟩⟩
...
def j33 : Jet := ⟨⟨(-705465508), (-705465505)⟩, ⟨4116211, 4116214⟩, ⟨400171, 400175⟩, ⟨(-2274), (-2269)⟩, ⟨(-112), (-108)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-205669252), (-205669249)⟩, ⟨(-81067675), (-81067670)⟩, ⟨(-7630096), (-7630091)⟩, ⟨94003, 94008⟩, ⟨4367, 4372⟩⟩
...
def j36 : Jet := ⟨⟨4089298044, 4089298047⟩, ⟨(-81067675), (-81067670)⟩, ⟨(-7630096), (-7630091)⟩, ⟨94003, 94008⟩, ⟨4367, 4372⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨750707779, 750707783⟩, ⟨141313313, 141313318⟩, ⟨(-2611536), (-2611531)⟩, ⟨(-161872), (-161867)⟩, ⟨1805, 1809⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4510980579, 4510980583⟩, ⟨89427250, 89427259⟩, ⟨10189730, 10189738⟩, ⟨265160, 265170⟩, ⟨17388, 17400⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨788464260, 788464266⟩, ⟨164051387, 164051395⟩, ⟨1980499, 1980509⟩, ⟨157219, 157230⟩, ⟨4091, 4102⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-738170661), (-738170660)⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3556796635, 3556796636⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨144745197, 144745200⟩, ⟨60232660, 60232666⟩, ⟨6993291, 6993299⟩, ⟨209018, 209026⟩, ⟨14425, 14434⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4439712493, 4439712496⟩, ⟨60232660, 60232666⟩, ⟨6993291, 6993299⟩, ⟨209018, 209026⟩, ⟨14425, 14434⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4366740198, 4366740200⟩, ⟨29621329, 29621333⟩, ⟨3338706, 3338712⟩, ⟨80142, 80148⟩, ⟨5273, 5280⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3616234018, 3616234021⟩, ⟨(-125570889), (-125570883)⟩, ⟨1746689, 1746696⟩, ⟨(-48397), (-48389)⟩, ⟨1611, 1619⟩⟩
...
def j47 : Jet := ⟨⟨7634973485, 7634973498⟩, ⟨1526994697, 1526994708⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13572354828, 13572354875⟩, ⟨5428941930, 5428941980⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13572354828, 13572354875⟩, ⟨5428941930, 5428941980⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13572354875), (-13572354828)⟩, ⟨(-5428941980), (-5428941930)⟩, ⟨(-542894201), (-542894193)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6786177438), (-6786177414)⟩, ⟨(-2714470990), (-2714470965)⟩, ⟨(-271447101), (-271447096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨884629714, 884629726⟩, ⟨(-559096627), (-559096614)⟩, ⟨120768227, 120768236⟩, ⟨(-1885274), (-1885270)⟩, ⟨(-3518471), (-3518469)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨744831763, 744831775⟩, ⟨(-496606339), (-496606325)⟩, ⟨118389165, 118389179⟩, ⟨(-5355561), (-5355550)⟩, ⟨(-2851585), (-2851575)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨590536528, 885804793⟩, ⟨147634132, 147634133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1855225217, 2782837831⟩, ⟨463806304, 463806308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨801370620, 1803083903⟩, ⟨400685308, 601027972⟩, ⟨50085663, 50085665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨200, 452⟩, ⟨100, 151⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94487), (-94234)⟩, ⟨100, 151⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-39667), (-17582)⟩, ⟨(-13205), (-8727)⟩, ⟨(-1091), (-1070)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073389, 5095475⟩, ⟨(-13205), (-8727)⟩, ⟨(-1091), (-1070)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨946611, 2139148⟩, ⟨467761, 711422⟩, ⟨56856, 58408⟩, ⟨(-307), (-198)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142218966), (-141026428)⟩, ⟨467761, 711422⟩, ⟨56856, 58408⟩, ⟨(-307), (-198)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-59705398), (-26313223)⟩, ⟨(-19814524), (-12857946)⟩, ⟨(-1604238), (-1520500)⟩, ⟨10629, 16435⟩, ⟨614, 663⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1371950367, 1405342543⟩, ⟨(-19814524), (-12857946)⟩, ⟨(-1604238), (-1520500)⟩, ⟨10629, 16435⟩, ⟨614, 663⟩⟩
...
def j72 : Jet := ⟨⟨2199, 4961⟩, ⟨1092, 1653⟩, ⟨133, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849978), (-847215)⟩, ⟨1092, 1653⟩, ⟨133, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-356832), (-158076)⟩, ⟨(-118741), (-78344)⟩, ⟨(-9787), (-9589)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35434562, 35633319⟩, ⟨(-118741), (-78344)⟩, ⟨(-9787), (-9589)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6611509, 14959338⟩, ⟨3255904, 4971829⟩, ⟨392493, 406441⟩, ⟨(-2751), (-1790)⟩, ⟨(-114), (-104)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709216374), (-700868544)⟩, ⟨3255904, 4971829⟩, ⟨392493, 406441⟩, ⟨(-2751), (-1790)⟩, ⟨(-114), (-104)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-297738386), (-130770602)⟩, ⟨(-98638632), (-63298060)⟩, ⟨(-7893530), (-7306785)⟩, ⟨73429, 114523⟩, ⟨4144, 4555⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3997228910, 4164196694⟩, ⟨(-98638632), (-63298060)⟩, ⟨(-7893530), (-7306785)⟩, ⟨73429, 114523⟩, ⟨4144, 4555⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨592618462, 910563487⟩, ⟨135316191, 146206551⟩, ⟨(-3179172), (-2045291)⟩, ⟨(-168648), (-153547)⟩, ⟨1412, 2205⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4429844560, 4614883083⟩, ⟨67336051, 113880332⟩, ⟨8796453, 11923442⟩, ⟨124944, 437743⟩, ⟨9151, 28521⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨611228791, 978387900⟩, ⟨148856611, 181240359⟩, ⟨(-80772), 4294977⟩, ⟨28871, 308263⟩, ⟨(-6644), 16724⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-885804793), (-590536528)⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3409162503, 3704430768⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨86985676, 222875477⟩, ⟨42368400, 82572632⟩, ⟨5122329, 9604819⟩, ⟨1398, 502926⟩, ⟨(-1109), 37933⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4381952972, 4517842773⟩, ⟨42368400, 82572632⟩, ⟨5122329, 9604819⟩, ⟨1398, 502926⟩, ⟨(-1109), 37933⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4338242121, 4404995683⟩, ⟨20655059, 40874477⟩, ⟨2307551, 4705334⟩, ⟨(-43642), 237969⟩, ⟨(-5344), 18576⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3443512219, 3799330802⟩, ⟨(-135021115), (-113867209)⟩, ⟨426625, 3348384⟩, ⟨(-199382), 125931⟩, ⟨(-12790), 17523⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6107978788, 9161968196⟩, ⟨1526994697, 1526994708⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8686307090, 19544191013⟩, ⟨4343153544, 6514730376⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8686307090, 19544191013⟩, ⟨4343153544, 6514730376⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19544191013), (-8686307090)⟩, ⟨(-6514730376), (-4343153544)⟩, ⟨(-542894201), (-542894193)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9772095507), (-4343153545)⟩, ⟨(-3257365188), (-2171576772)⟩, ⟨(-271447101), (-271447096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨441401956, 1562402516⟩, ⟨(-1184948619), (-223177074)⟩, ⟨(-42325482), 421443934⟩, ⟨(-97139682), 60626872⟩, ⟨(-24812956), 19755545⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨353896298, 1382102260⟩, ⟨(-1097323634), (-190635721)⟩, ⟨(-31480484), 411278926⟩, ⟨(-100175106), 54984802⟩, ⟨(-23927883), 20919498⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨738170660, 738170661⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4366740198, 4366740200⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2452
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨590536528, 885804793⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4338242121, 4404995683⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2453
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (27102971 / 2147483648)

theorem envelope_integral : (∫ s in ((27499 / 200000) : ℝ)..(82497 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((27499 / 200000) : ℝ)..(82497 / 400000), prawitzNormalCorrection
