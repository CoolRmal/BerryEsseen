...
namespace FiniteNormalPanel115_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (14143 / 80000)
def radius : Rat := (14143 / 400000)

def j0 : Jet := ⟨⟨759296530, 759296531⟩, ⟨151859306, 151859307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2385400400, 2385400404⟩, ⟨477080080, 477080084⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1324837810, 1324837815⟩, ⟨529935124, 529935130⟩, ⟨52993512, 52993514⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨331, 332⟩, ⟨132, 133⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94356), (-94354)⟩, ⟨132, 133⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-29106), (-29104)⟩, ⟨(-11603), (-11599)⟩, ⟨(-1145), (-1142)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5083950, 5083953⟩, ⟨(-11603), (-11599)⟩, ⟨(-1145), (-1142)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1568209, 1568211⟩, ⟨623703, 623708⟩, ⟨60942, 60946⟩, ⟨(-286), (-281)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-141597368), (-141597365)⟩, ⟨623703, 623708⟩, ⟨60942, 60946⟩, ⟨(-286), (-281)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-43677527), (-43677525)⟩, ⟨(-17278622), (-17278619)⟩, ⟨(-1651349), (-1651344)⟩, ⟨15125, 15130⟩, ⟨710, 715⟩⟩
...
def j19 : Jet := ⟨⟨1387978238, 1387978241⟩, ⟨(-17278622), (-17278619)⟩, ⟨(-1651349), (-1651344)⟩, ⟨15125, 15130⟩, ⟨710, 715⟩⟩
...
def j22 : Jet := ⟨⟨(-34), (-33)⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11801, 11803⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3640, 3641⟩, ⟨1451, 1453⟩, ⟨142, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848537), (-848535)⟩, ⟨1451, 1453⟩, ⟨142, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-261743), (-261741)⟩, ⟨(-104250), (-104247)⟩, ⟨(-10248), (-10244)⟩, ⟨33, 36⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35529651, 35529654⟩, ⟨(-104250), (-104247)⟩, ⟨(-10248), (-10244)⟩, ⟨33, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10959577, 10959579⟩, ⟨4351672, 4351676⟩, ⟨422358, 422363⟩, ⟨(-2542), (-2537)⟩, ⟨(-124), (-120)⟩⟩
...
def j33 : Jet := ⟨⟨(-704868306), (-704868303)⟩, ⟨4351672, 4351676⟩, ⟨422358, 422363⟩, ⟨(-2542), (-2537)⟩, ⟨(-124), (-120)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-217425681), (-217425678)⟩, ⟨(-85627944), (-85627940)⟩, ⟨(-8029816), (-8029810)⟩, ⟨105020, 105026⟩, ⟨4858, 4862⟩⟩
...
def j36 : Jet := ⟨⟨4077541615, 4077541618⟩, ⟨(-85627944), (-85627940)⟩, ⟨(-8029816), (-8029810)⟩, ⟨105020, 105026⟩, ⟨4858, 4862⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨770875216, 770875220⟩, ⟨144578594, 144578599⟩, ⟨(-2836440), (-2836436)⟩, ⟨(-175030), (-175025)⟩, ⟨2074, 2079⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4523986706, 4523986710⟩, ⟨95003239, 95003245⟩, ⟨10904041, 10904050⟩, ⟨299543, 299555⟩, ⟨19919, 19929⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨811980392, 811980398⟩, ⟨169339421, 169339429⟩, ⟨2167437, 2167445⟩, ⟨173711, 173724⟩, ⟨4768, 4779⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-759296531), (-759296530)⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3535670765, 3535670766⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨153508073, 153508077⟩, ⟨64028560, 64028566⟩, ⟨7496138, 7496143⟩, ⟨236592, 236602⟩, ⟨16591, 16602⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4448475369, 4448475373⟩, ⟨64028560, 64028566⟩, ⟨7496138, 7496143⟩, ⟨236592, 236602⟩, ⟨16591, 16602⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4371047497, 4371047500⟩, ⟨31457055, 31457059⟩, ⟨3569638, 3569642⟩, ⟨90547, 90553⟩, ⟨6040, 6048⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3598300937, 3598300941⟩, ⟨(-128653473), (-128653466)⟩, ⟨1826327, 1826332⟩, ⟨(-51675), (-51668)⟩, ⟨1770, 1778⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨39024039031, 39024039039⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value500

def j47 : Jet := ⟨⟨6898962292, 6898962304⟩, ⟨1379792458, 1379792468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11081732974, 11081733013⟩, ⟨4432693188, 4432693230⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11081732974, 11081733013⟩, ⟨4432693188, 4432693230⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11081733013), (-11081732974)⟩, ⟨(-4432693230), (-4432693188)⟩, ⟨(-443269326), (-443269318)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5540866507), (-5540866487)⟩, ⟨(-2216346615), (-2216346594)⟩, ⟨(-221634663), (-221634659)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1182180268, 1182180290⟩, ⟨(-610044526), (-610044507)⟩, ⟨96397218, 96397228⟩, ⟨4405492, 4405496⟩, ⟨(-3055556), (-3055554)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨990424390, 990424410⟩, ⟨(-546503672), (-546503650)⟩, ⟨99537331, 99537346⟩, ⟨529738, 529748⟩, ⟨(-2643079), (-2643070)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨607437224, 911155838⟩, ⟨151859306, 151859307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1908320320, 2862480488⟩, ⟨477080080, 477080084⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨847896198, 1907766458⟩, ⟨423948098, 635922158⟩, ⟨52993512, 52993514⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨212, 478⟩, ⟨106, 160⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94475), (-94208)⟩, ⟨106, 160⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-41965), (-18598)⟩, ⟨(-13969), (-9227)⟩, ⟨(-1154), (-1131)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5071091, 5094459⟩, ⟨(-13969), (-9227)⟩, ⟨(-1154), (-1131)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1001115, 2262890⟩, ⟨494352, 752476⟩, ⟨59987, 61726⟩, ⟨(-344), (-221)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142164462), (-140902686)⟩, ⟨494352, 752476⟩, ⟨59987, 61726⟩, ⟨(-344), (-221)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-63147534), (-27816475)⟩, ⟨(-20951586), (-13573997)⟩, ⟨(-1693461), (-1599697)⟩, ⟨11867, 18382⟩, ⟨682, 739⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1368508231, 1403839291⟩, ⟨(-20951586), (-13573997)⟩, ⟨(-1693461), (-1599697)⟩, ⟨11867, 18382⟩, ⟨682, 739⟩⟩
...
def j72 : Jet := ⟨⟨2326, 5249⟩, ⟨1155, 1749⟩, ⟨141, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849851), (-846927)⟩, ⟨1155, 1749⟩, ⟨141, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-377493), (-167197)⟩, ⟨(-125603), (-82821)⟩, ⟨(-10345), (-10125)⟩, ⟨26, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35413901, 35624198⟩, ⟨(-125603), (-82821)⟩, ⟨(-10345), (-10125)⟩, ⟨26, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6991278, 15823788⟩, ⟨3439847, 5258246⟩, ⟨413760, 429377⟩, ⟨(-3077), (-2000)⟩, ⟨(-127), (-116)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708836605), (-700004094)⟩, ⟨3439847, 5258246⟩, ⟨413760, 429377⟩, ⟨(-3077), (-2000)⟩, ⟨(-127), (-116)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-314855646), (-138192160)⟩, ⟨(-104272802), (-66760438)⟩, ⟨(-8324769), (-7667737)⟩, ⟨81916, 128060⟩, ⟨4592, 5079⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3980111650, 4156775136⟩, ⟨(-104272802), (-66760438)⟩, ⟨(-8324769), (-7667737)⟩, ⟨81916, 128060⟩, ⟨4592, 5079⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨608049348, 935621229⟩, ⟨138048666, 149905737⟩, ⟨(-3455926), (-2218554)⟩, ⟨(-182836), (-165440)⟩, ⟨1621, 2535⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4437753660, 4634730304⟩, ⟨71273130, 121422805⟩, ⟨9330730, 12875057⟩, ⟨138543, 499941⟩, ⟨10031, 33443⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨628263973, 1009635642⟩, ⟨152728415, 188215268⟩, ⟨(-117483), 4750389⟩, ⟨24517, 350527⟩, ⟨(-7982), 19908⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-911155838), (-607437224)⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3383811458, 3687530072⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨91901891, 237339207⟩, ⟨44681950, 88489076⟩, ⟨5375764, 10481411⟩, ⟨(-3126), 581146⟩, ⟨(-2142), 45337⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4386869187, 4532306503⟩, ⟨44681950, 88489076⟩, ⟨5375764, 10481411⟩, ⟨(-3126), 581146⟩, ⟨(-2142), 45337⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4340675026, 4412041275⟩, ⟨21748154, 43778639⟩, ⟨2399360, 5131039⟩, ⟨(-53297), 275493⟩, ⟨(-6872), 22306⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3419822521, 3788046279⟩, ⟨(-138864360), (-115888390)⟩, ⟨342443, 3636397⟩, ⟨(-227181), 151696⟩, ⟨(-15642), 21037⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5519169834, 8278754771⟩, ⟨1379792458, 1379792468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7092309104, 15957695563⟩, ⟨3546154550, 5319231878⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7092309104, 15957695563⟩, ⟨3546154550, 5319231878⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15957695563), (-7092309104)⟩, ⟨(-5319231878), (-3546154550)⟩, ⟨(-443269326), (-443269318)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7978847782), (-3546154552)⟩, ⟨(-2659615939), (-1773077275)⟩, ⟨(-221634663), (-221634659)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨670134842, 1880975443⟩, ⟨(-1164775405), (-276649570)⟩, ⟨(-39960451), 326056618⟩, ⟨(-57785083), 48319240⟩, ⟨(-15893109), 9976757⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨533587817, 1658970031⟩, ⟨(-1088116224), (-238361134)⟩, ⟨(-27725959), 326825150⟩, ⟨(-62592590), 43952654⟩, ⟨(-15661375), 11014420⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨759296530, 759296531⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4371047497, 4371047500⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar500 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2318
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar500 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨607437224, 911155838⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4340675026, 4412041275⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2319
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((14143 / 100000) : ℝ)..(42429 / 200000), prawitzNormalCorrection
      ((26229 / 10000) * sqrt n) s) ≤ (upper : ℝ) :=
