...
namespace FiniteNormalPanel107_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (14671 / 80000)
def radius : Rat := (14671 / 400000)

def j0 : Jet := ⟨⟨787643314, 787643315⟩, ⟨157528662, 157528663⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2474454448, 2474454453⟩, ⟨494890887, 494890891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1425604525, 1425604532⟩, ⟨570241806, 570241814⟩, ⟨57024180, 57024182⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨356, 358⟩, ⟨142, 143⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94331), (-94328)⟩, ⟨142, 143⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-31311), (-31309)⟩, ⟨(-12478), (-12475)⟩, ⟨(-1231), (-1228)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5081745, 5081748⟩, ⟨(-12478), (-12475)⟩, ⟨(-1231), (-1228)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1686755, 1686757⟩, ⟨670560, 670563⟩, ⟨65404, 65408⟩, ⟨(-330), (-326)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-141478822), (-141478819)⟩, ⟨670560, 670563⟩, ⟨65404, 65408⟩, ⟨(-330), (-326)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-46960277), (-46960274)⟩, ⟨(-18561536), (-18561532)⟩, ⟨(-1767673), (-1767668)⟩, ⟨17476, 17481⟩, ⟨818, 822⟩⟩
...
def j19 : Jet := ⟨⟨1384695488, 1384695492⟩, ⟨(-18561536), (-18561532)⟩, ⟨(-1767673), (-1767668)⟩, ⟨17476, 17481⟩, ⟨818, 822⟩⟩
...
def j25 : Jet := ⟨⟨3916, 3918⟩, ⟨1561, 1563⟩, ⟨153, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848261), (-848258)⟩, ⟨1561, 1563⟩, ⟨153, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-281559), (-281557)⟩, ⟨(-112106), (-112104)⟩, ⟨(-11006), (-11002)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35509835, 35509838⟩, ⟨(-112106), (-112104)⟩, ⟨(-11006), (-11002)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11786581, 11786583⟩, ⟨4677421, 4677423⟩, ⟨452924, 452929⟩, ⟨(-2939), (-2934)⟩, ⟨(-142), (-139)⟩⟩
...
def j33 : Jet := ⟨⟨(-704041302), (-704041299)⟩, ⟨4677421, 4677423⟩, ⟨452924, 452929⟩, ⟨(-2939), (-2934)⟩, ⟨(-142), (-139)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-233688502), (-233688499)⟩, ⟨(-91922851), (-91922848)⟩, ⟨(-8576185), (-8576179)⟩, ⟨121260, 121266⟩, ⟨5574, 5579⟩⟩
...
def j36 : Jet := ⟨⟨4061278794, 4061278797⟩, ⟨(-91922851), (-91922848)⟩, ⟨(-8576185), (-8576179)⟩, ⟨121260, 121266⟩, ⟨5574, 5579⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨797762980, 797762984⟩, ⟨148858759, 148858764⟩, ⟨(-3157176), (-3157170)⟩, ⟨(-193614), (-193608)⟩, ⟨2484, 2489⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4542102376, 4542102380⟩, ⟨102805792, 102805797⟩, ⟨11918433, 11918443⟩, ⟨351231, 351241⟩, ⟨23806, 23817⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨843666756, 843666762⟩, ⟨176519708, 176519716⟩, ⟨2438064, 2438075⟩, ⟨197990, 198002⟩, ⟨5823, 5836⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-787643315), (-787643314)⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3507323981, 3507323982⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨165722704, 165722707⟩, ⟨69348052, 69348058⟩, ⟨8212642, 8212649⟩, ⟨278186, 278194⟩, ⟨19943, 19954⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4460690000, 4460690003⟩, ⟨69348052, 69348058⟩, ⟨8212642, 8212649⟩, ⟨278186, 278194⟩, ⟨19943, 19954⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4377044398, 4377044401⟩, ⟨34023828, 34023832⟩, ⟨3897082, 3897087⟩, ⟨106191, 106197⟩, ⟨7222, 7230⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3574349168, 3574349172⟩, ⟨(-132754764), (-132754757)⟩, ⟨1934495, 1934502⟩, ⟨(-56220), (-56213)⟩, ⟨2001, 2011⟩⟩
...
def j47 : Jet := ⟨⟨6523374370, 6523374381⟩, ⟨1304674867, 1304674877⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9907971408, 9907971443⟩, ⟨3963188542, 3963188580⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9907971408, 9907971443⟩, ⟨3963188542, 3963188580⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9907971443), (-9907971408)⟩, ⟨(-3963188580), (-3963188542)⟩, ⟨(-396318859), (-396318852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4953985722), (-4953985704)⟩, ⟨(-1981594290), (-1981594271)⟩, ⟨(-198159430), (-198159426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1355274820, 1355274835⟩, ⟨(-625291112), (-625291098)⟩, ⟨81718000, 81718008⟩, ⟨6665375, 6665378⟩, ⟨(-2653948), (-2653946)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1127884123, 1127884138⟩, ⟨(-562269233), (-562269215)⟩, ⟨87944976, 87944990⟩, ⟨2721812, 2721822⟩, ⟨(-2369067), (-2369056)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨630114651, 945171978⟩, ⟨157528662, 157528663⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1979563558, 2969345343⟩, ⟨494890887, 494890891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨912386896, 2052870525⟩, ⟨456193444, 684290176⟩, ⟨57024180, 57024182⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨228, 515⟩, ⟨114, 172⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94459), (-94171)⟩, ⟨114, 172⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-45149), (-20004)⟩, ⟨(-15026), (-9919)⟩, ⟨(-1241), (-1214)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5067907, 5093053⟩, ⟨(-15026), (-9919)⟩, ⟨(-1241), (-1214)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1076583, 2434333⟩, ⟨531109, 809338⟩, ⟨64298, 66311⟩, ⟨(-398), (-256)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142088994), (-140731243)⟩, ⟨531109, 809338⟩, ⟨64298, 66311⟩, ⟨(-398), (-256)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-67914443), (-29895767)⟩, ⟨(-22525324), (-14561042)⟩, ⟨(-1816443), (-1707843)⟩, ⟨13689, 21257⟩, ⟨780, 852⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1363741322, 1401759999⟩, ⟨(-22525324), (-14561042)⟩, ⟨(-1816443), (-1707843)⟩, ⟨13689, 21257⟩, ⟨780, 852⟩⟩
...
def j72 : Jet := ⟨⟨2503, 5647⟩, ⟨1242, 1881⟩, ⟨152, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849674), (-846529)⟩, ⟨1242, 1881⟩, ⟨152, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-406120), (-179829)⟩, ⟨(-135111), (-89014)⟩, ⟨(-11119), (-10864)⟩, ⟨31, 50⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35385274, 35611566⟩, ⟨(-135111), (-89014)⟩, ⟨(-11119), (-10864)⟩, ⟨31, 50⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7516951, 17021302⟩, ⟨3693895, 5654859⟩, ⟨442967, 461053⟩, ⟨(-3560), (-2310)⟩, ⟨(-145), (-134)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708310932), (-698806580)⟩, ⟨3693895, 5654859⟩, ⟨442967, 461053⟩, ⟨(-3560), (-2310)⟩, ⟨(-145), (-134)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-338552202), (-148448619)⟩, ⟨(-112066035), (-71521449)⟩, ⟨(-8917778), (-8156713)⟩, ⟨94391, 148047⟩, ⟨5243, 5849⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3956415094, 4146518677⟩, ⟨(-112066035), (-71521449)⟩, ⟨(-8917778), (-8156713)⟩, ⟨94391, 148047⟩, ⟨5243, 5849⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨628552544, 969113206⟩, ⟨141565148, 154807640⟩, ⟨(-3851305), (-2464957)⟩, ⟨(-202993), (-182090)⟩, ⟨1936, 3040⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4448730491, 4662489561⟩, ⟨76734164, 132065698⟩, ⟨10074752, 14250055⟩, ⟨158249, 595178⟩, ⟨11253, 41254⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨651055217, 1052040655⟩, ⟨157863051, 197853805⟩, ⟨(-177249), 5422340⟩, ⟨16441, 415278⟩, ⟨(-10155), 25028⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-945171978), (-630114651)⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3349795318, 3664852645⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨98690599, 257694521⟩, ⟨47859532, 96927512⟩, ⟨5715478, 11770795⟩, ⟨(-11348), 703020⟩, ⟨(-3992), 57370⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4393657895, 4552661817⟩, ⟨47859532, 96927512⟩, ⟨5715478, 11770795⟩, ⟨(-11348), 703020⟩, ⟨(-3992), 57370⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4344032339, 4421937767⟩, ⟨23242652, 47916367⟩, ⟨2516069, 5756744⟩, ⟨(-69110), 334079⟩, ⟨(-9475), 28397⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3388062862, 3773195279⟩, ⟨(-144057866), (-118441688)⟩, ⟨204917, 4059691⟩, ⟨(-270114), 192784⟩, ⟨(-20339), 26766⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5218699494, 7828049257⟩, ⟨1304674867, 1304674877⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6341101696, 14267478877⟩, ⟨3170550832, 4755826296⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6341101696, 14267478877⟩, ⟨3170550832, 4755826296⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14267478877), (-6341101696)⟩, ⟨(-4755826296), (-3170550832)⟩, ⟨(-396318859), (-396318852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7133739439), (-3170550848)⟩, ⟨(-2377913148), (-1585275416)⟩, ⟨(-198159430), (-198159426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨815862691, 2052877668⟩, ⟨(-1136577874), (-301135486)⟩, ⟨(-39140165), 276991831⟩, ⟨(-41856497), 42182639⟩, ⟨(-12228484), 6696390⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨643589087, 1803484822⟩, ⟨(-1067357009), (-260048105)⟩, ⟨(-26041948), 283404091⟩, ⟨(-47265613), 38448685⟩, ⟨(-12255501), 7632890⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨787643314, 787643315⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4377044398, 4377044401⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2158
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨630114651, 945171978⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4344032339, 4421937767⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2159
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (84998325 / 4294967296)

theorem envelope_integral : (∫ s in ((14671 / 100000) : ℝ)..(44013 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((14671 / 100000) : ℝ)..(44013 / 200000), prawitzNormalCorrection
