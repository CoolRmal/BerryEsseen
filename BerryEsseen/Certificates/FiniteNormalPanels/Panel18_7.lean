...
namespace FiniteNormalPanel18_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (10139 / 40000)
def radius : Rat := (10139 / 200000)

def j0 : Jet := ⟨⟨1088666835, 1088666836⟩, ⟨217733367, 217733368⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3420147730, 3420147735⟩, ⟨684029546, 684029550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2723515614, 2723515623⟩, ⟨1089406244, 1089406254⟩, ⟨108940624, 108940626⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨681, 683⟩, ⟨272, 273⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94006), (-94003)⟩, ⟨272, 273⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-59611), (-59608)⟩, ⟨(-23673), (-23669)⟩, ⟨(-2300), (-2296)⟩, ⟨12, 15⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5053445, 5053449⟩, ⟨(-23673), (-23669)⟩, ⟨(-2300), (-2296)⟩, ⟨12, 15⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3204479, 3204483⟩, ⟨1266779, 1266785⟩, ⟨120715, 120722⟩, ⟨(-1178), (-1172)⟩, ⟨(-56), (-53)⟩⟩
...
def j16 : Jet := ⟨⟨(-139961098), (-139961093)⟩, ⟨1266779, 1266785⟩, ⟨120715, 120722⟩, ⟨(-1178), (-1172)⟩, ⟨(-56), (-53)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-88751837), (-88751833)⟩, ⟨(-34697448), (-34697441)⟩, ⟨(-3152213), (-3152204)⟩, ⟨62003, 62010⟩, ⟨2726, 2733⟩⟩
...
def j19 : Jet := ⟨⟨1342903928, 1342903933⟩, ⟨(-34697448), (-34697441)⟩, ⟨(-3152213), (-3152204)⟩, ⟨62003, 62010⟩, ⟨2726, 2733⟩⟩
...
def j22 : Jet := ⟨⟨(-69), (-67)⟩, ⟨(-28), (-27)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11766, 11769⟩, ⟨(-28), (-27)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7461, 7463⟩, ⟨2966, 2969⟩, ⟨288, 292⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844716), (-844713)⟩, ⟨2966, 2969⟩, ⟨288, 292⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-535650), (-535647)⟩, ⟨(-212380), (-212376)⟩, ⟨(-20492), (-20485)⟩, ⟨146, 151⟩, ⟨5, 8⟩⟩
...
def j30 : Jet := ⟨⟨35255744, 35255748⟩, ⟨(-212380), (-212376)⟩, ⟨(-20492), (-20485)⟩, ⟨146, 151⟩, ⟨5, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22356298, 22356301⟩, ⟨8807845, 8807850⟩, ⟨827386, 827396⟩, ⟨(-10493), (-10485)⟩, ⟨(-480), (-474)⟩⟩
...
def j33 : Jet := ⟨⟨(-693471585), (-693471581)⟩, ⟨8807845, 8807850⟩, ⟨827386, 827396⟩, ⟨(-10493), (-10485)⟩, ⟨(-480), (-474)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-439742743), (-439742738)⟩, ⟨(-170311886), (-170311878)⟩, ⟨(-14830966), (-14830955)⟩, ⟨426618, 426628⟩, ⟨18019, 18028⟩⟩
...
def j36 : Jet := ⟨⟨3855224553, 3855224558⟩, ⟨(-170311886), (-170311878)⟩, ⟨(-14830966), (-14830955)⟩, ⟨426618, 426628⟩, ⟨18019, 18028⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1069374806, 1069374813⟩, ⟨186244855, 186244865⟩, ⟨(-8036178), (-8036166)⟩, ⟨(-452659), (-452649)⟩, ⟨12044, 12053⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4784868895, 4784868902⟩, ⟨211380683, 211380697⟩, ⟨27745416, 27745434⟩, ⟨1509376, 1509395⟩, ⟨127646, 127663⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1191352085, 1191352096⟩, ⟨260118951, 260118968⟩, ⟨7121533, 7121554⟩, ⟨679147, 679168⟩, ⟨36456, 36477⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1088666836), (-1088666835)⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3206300460, 3206300461⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨330461140, 330461147⟩, ⟨144305290, 144305304⟩, ⟨19704544, 19704559⟩, ⟨1239380, 1239396⟩, ⟨114294, 114313⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4625428436, 4625428443⟩, ⟨144305290, 144305304⟩, ⟨19704544, 19704559⟩, ⟨1239380, 1239396⟩, ⟨114294, 114313⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4457136284, 4457136289⟩, ⟨69527434, 69527442⟩, ⟨8951521, 8951530⟩, ⟨457506, 457516⟩, ⟨38941, 38952⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3327363663, 3327363669⟩, ⟨(-174050559), (-174050549)⟩, ⟨3157840, 3157848⟩, ⟨(-112259), (-112249)⟩, ⟨5876, 5886⟩⟩
...
def j47 : Jet := ⟨⟨4836442821, 4836442828⟩, ⟨967288564, 967288569⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5446183299, 5446183316⟩, ⟨2178473318, 2178473334⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5446183299, 5446183316⟩, ⟨2178473318, 2178473334⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5446183316), (-5446183299)⟩, ⟨(-2178473334), (-2178473318)⟩, ⟨(-217847335), (-217847331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2723091658), (-2723091649)⟩, ⟨(-1089236667), (-1089236659)⟩, ⟨(-108923668), (-108923665)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2278289078, 2278289089⟩, ⟨(-577791598), (-577791590)⟩, ⟨15487029, 15487034⟩, ⟨8459614, 8459617⟩, ⟨(-732738), (-732737)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1765018396, 1765018409⟩, ⟨(-539948294), (-539948280)⟩, ⟨37087683, 37087696⟩, ⟨5441797, 5441809⟩, ⟨(-880881), (-880867)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨870933468, 1306400203⟩, ⟨217733367, 217733368⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2736118184, 4104177281⟩, ⟨684029546, 684029550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1743049993, 3921862495⟩, ⟨871524996, 1307287506⟩, ⟨108940624, 108940626⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨436, 983⟩, ⟨218, 328⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94251), (-93703)⟩, ⟨218, 328⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-86064), (-38027)⟩, ⟨(-28600), (-18713)⟩, ⟨(-2337), (-2250)⟩, ⟨10, 18⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5026992, 5075030⟩, ⟨(-28600), (-18713)⟩, ⟨(-2337), (-2250)⟩, ⟨10, 18⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2040131, 4634161⟩, ⟨993949, 1537127⟩, ⟨116668, 124017⟩, ⟨(-1434), (-913)⟩, ⟨(-58), (-50)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141125446), (-138531415)⟩, ⟨993949, 1537127⟩, ⟨116668, 124017⟩, ⟨(-1434), (-913)⟩, ⟨(-58), (-50)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-128865846), (-56220959)⟩, ⟨(-42551904), (-26706882)⟩, ⟨(-3330570), (-2932699)⟩, ⟨47575, 76367⟩, ⟨2469, 2941⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1302789919, 1375434807⟩, ⟨(-42551904), (-26706882)⟩, ⟨(-3330570), (-2932699)⟩, ⟨47575, 76367⟩, ⟨2469, 2941⟩⟩
...
def j70 : Jet := ⟨⟨(-99), (-43)⟩, ⟨(-33), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11736, 11793⟩, ⟨(-33), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4762, 10769⟩, ⟨2350, 3582⟩, ⟨283, 296⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847415), (-841407)⟩, ⟨2350, 3582⟩, ⟨283, 296⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-773800), (-341472)⟩, ⟨(-256981), (-167465)⟩, ⟨(-20905), (-19980)⟩, ⟨114, 182⟩, ⟨5, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35017594, 35449923⟩, ⟨(-256981), (-167465)⟩, ⟨(-20905), (-19980)⟩, ⟨114, 182⟩, ⟨5, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14211381, 32370381⟩, ⟨6871032, 10722164⟩, ⟨790902, 857089⟩, ⟨(-12836), (-8134)⟩, ⟨(-506), (-442)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701616502), (-683457501)⟩, ⟨6871032, 10722164⟩, ⟨790902, 857089⟩, ⟨(-12836), (-8134)⟩, ⟨(-506), (-442)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-640666915), (-277371283)⟩, ⟨(-210767132), (-128894913)⟩, ⟨(-16081074), (-13289495)⟩, ⟨323048, 529542⟩, ⟨15691, 19911⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3654300381, 4017596013⟩, ⟨(-210767132), (-128894913)⟩, ⟨(-16081074), (-13289495)⟩, ⟨323048, 529542⟩, ⟨15691, 19911⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨829945129, 1314335570⟩, ⟨166824608, 202042254⟩, ⟨(-9959567), (-6121701)⟩, ⟨(-500130), (-394095)⟩, ⟨9148, 14974⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4591488047, 5047955054⟩, ⟨147306859, 291148209⟩, ⟨19913813, 39006376⟩, ⟨460801, 3125079⟩, ⟨17260, 319161⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨887243808, 1544763075⟩, ⟨206807116, 326560501⟩, ⟨(-2135912), 19088387⟩, ⟨(-400423), 2159993⟩, ⟨(-93343), 220379⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1306400203), (-870933468)⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2988567093, 3424033828⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨183284649, 555602126⟩, ⟨85443412, 234906844⟩, ⟨8421536, 38560442⟩, ⟨(-612842), 4456468⟩, ⟨(-137531), 571828⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4478251945, 4850569422⟩, ⟨85443412, 234906844⟩, ⟨8421536, 38560442⟩, ⟨(-612842), 4456468⟩, ⟨(-137531), 571828⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4385652248, 4564322188⟩, ⟨40200564, 115024763⟩, ⟨2512916, 18697305⟩, ⟨(-790469), 2159126⟩, ⟨(-163830), 300015⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3051668403, 3638768936⟩, ⟨(-203415557), (-130630598)⟩, ⟨(-4082619), 12867899⟩, ⟨(-1578038), 1593907⟩, ⟨(-240066), 279251⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3869154256, 5803731392⟩, ⟨967288564, 967288569⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3485557310, 7842503971⟩, ⟨1742778654, 2614168000⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3485557310, 7842503971⟩, ⟨1742778654, 2614168000⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7842503971), (-3485557310)⟩, ⟨(-2614168000), (-1742778654)⟩, ⟨(-217847335), (-217847331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3921251986), (-1742778655)⟩, ⟨(-1307084000), (-871389327)⟩, ⟨(-108923668), (-108923665)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1723670994, 2862432151⟩, ⟨(-871121713), (-349708950)⟩, ⟨(-37117928), 88840273⟩, ⟨(-3099639), 18493567⟩, ⟨(-2533563), 706498⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1224706021, 2425100933⟩, ⟨(-873597772), (-300900993)⟩, ⟨(-23531519), 125100470⟩, ⟨(-10495285), 19316352⟩, ⟨(-3616844), 1517707⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1088666835, 1088666836⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4457136284, 4457136289⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified362
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨870933468, 1306400203⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4385652248, 4564322188⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified363
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (90119717 / 2147483648)

theorem envelope_integral : (∫ s in ((10139 / 50000) : ℝ)..(30417 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (10139 / 50000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (30417 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((10139 / 50000) : ℝ)..(30417 / 100000), prawitzNormalCorrection
