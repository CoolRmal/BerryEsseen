...
namespace FiniteNormalPanel26_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (251881 / 800000)
def radius : Rat := (35983 / 800000)

def j0 : Jet := ⟨⟨1352275821, 1352275822⟩, ⟨193182260, 193182261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4248299784, 4248299789⟩, ⟨606899968, 606899972⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4202139343, 4202139354⟩, ⟨1200611238, 1200611250⟩, ⟨85757945, 85757947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1051, 1053⟩, ⟨300, 301⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93636), (-93633)⟩, ⟨300, 301⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-91613), (-91609)⟩, ⟨(-25882), (-25879)⟩, ⟨(-1767), (-1762)⟩, ⟨10, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5021443, 5021448⟩, ⟨(-25882), (-25879)⟩, ⟨(-1767), (-1762)⟩, ⟨10, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4912913, 4912919⟩, ⟨1378366, 1378373⟩, ⟨91298, 91307⟩, ⟨(-1002), (-994)⟩, ⟨(-34), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-138252664), (-138252657)⟩, ⟨1378366, 1378373⟩, ⟨91298, 91307⟩, ⟨(-1002), (-994)⟩, ⟨(-34), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-135264583), (-135264575)⟩, ⟨(-37298449), (-37298439)⟩, ⟨(-2285871), (-2285857)⟩, ⟨52061, 52075⟩, ⟨1507, 1518⟩⟩
...
def j19 : Jet := ⟨⟨1296391182, 1296391191⟩, ⟨(-37298449), (-37298439)⟩, ⟨(-2285871), (-2285857)⟩, ⟨52061, 52075⟩, ⟨1507, 1518⟩⟩
...
def j22 : Jet := ⟨⟨(-106), (-104)⟩, ⟨(-31), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11729, 11732⟩, ⟨(-31), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11475, 11479⟩, ⟨3247, 3252⟩, ⟨222, 226⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840702), (-840697)⟩, ⟨3247, 3252⟩, ⟨222, 226⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-822532), (-822526)⟩, ⟨(-231834), (-231825)⟩, ⟨(-15663), (-15654)⟩, ⟨124, 129⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨34968862, 34968869⟩, ⟨(-231834), (-231825)⟩, ⟨(-15663), (-15654)⟩, ⟨124, 129⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨34213073, 34213081⟩, ⟨9548339, 9548352⟩, ⟨618093, 618108⟩, ⟨(-8888), (-8876)⟩, ⟨(-278), (-270)⟩⟩
...
def j33 : Jet := ⟨⟨(-681614810), (-681614801)⟩, ⟨9548339, 9548352⟩, ⟨618093, 618108⟩, ⟨(-8888), (-8876)⟩, ⟨(-278), (-270)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-666882940), (-666882929)⟩, ⟨(-181196016), (-181195997)⟩, ⟨(-10335990), (-10335968)⟩, ⟨354737, 354755⟩, ⟨9584, 9597⟩⟩
...
def j36 : Jet := ⟨⟨3628084356, 3628084367⟩, ⟨(-181196016), (-181195997)⟩, ⟨(-10335990), (-10335968)⟩, ⟨354737, 354755⟩, ⟨9584, 9597⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1282305079, 1282305090⟩, ⟨146293260, 146293275⟩, ⟨(-7531489), (-7531471)⟩, ⟨(-271510), (-271492)⟩, ⟨8846, 8861⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5084430847, 5084430864⟩, ⟨253929737, 253929769⟩, ⟨27166832, 27166870⟩, ⟨1583038, 1583071⟩, ⟨118173, 118203⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1518007251, 1518007270⟩, ⟨248996856, 248996886⟩, ⟨7844306, 7844343⟩, ⟨631276, 631313⟩, ⟨35980, 36014⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1352275822), (-1352275821)⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2942691474, 2942691475⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨536522365, 536522380⟩, ⟨176010202, 176010228⟩, ⟨19980328, 19980360⟩, ⟨1355766, 1355800⟩, ⟨112952, 112985⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4831489661, 4831489676⟩, ⟨176010202, 176010228⟩, ⟨19980328, 19980360⟩, ⟨1355766, 1355800⟩, ⟨112952, 112985⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4555336440, 4555336448⟩, ⟨82974997, 82975010⟩, ⟨8663465, 8663482⟩, ⟨481332, 481350⟩, ⟨36241, 36259⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3121083067, 3121083075⟩, ⟨(-148043126), (-148043113)⟩, ⟨2203649, 2203663⟩, ⟨(-59889), (-59874)⟩, ⟨3179, 3194⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨25046187684, 25046187686⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value216

def j47 : Jet := ⟨⟨7885823495, 7885823502⟩, ⟨1126546212, 1126546219⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14478855811, 14478855838⟩, ⟨4136815940, 4136815970⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14478855811, 14478855838⟩, ⟨4136815940, 4136815970⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14478855838), (-14478855811)⟩, ⟨(-4136815970), (-4136815940)⟩, ⟨(-295486857), (-295486852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7239427919), (-7239427905)⟩, ⟨(-2068407985), (-2068407970)⟩, ⟨(-147743429), (-147743426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨796031338, 796031347⟩, ⟨(-383359752), (-383359744)⟩, ⟨64928031, 64928036⟩, ⟨(-1631360), (-1631357)⟩, ⟨(-920326), (-920324)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨578463061, 578463070⟩, ⟨(-306019701), (-306019689)⟩, ⟨60804587, 60804598⟩, ⟨(-3631281), (-3631272)⟩, ⟨(-573309), (-573300)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1159093561, 1545458083⟩, ⟨193182260, 193182261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3641399815, 4855199761⟩, ⟨606899968, 606899972⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3087286048, 5488508549⟩, ⟨1029095346, 1372127142⟩, ⟨85757945, 85757947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨772, 1376⟩, ⟨257, 344⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93915), (-93310)⟩, ⟨257, 344⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-120014), (-67072)⟩, ⟨(-29820), (-21917)⟩, ⟨(-1800), (-1724)⟩, ⟨10, 15⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4993042, 5045985⟩, ⟨(-29820), (-21917)⟩, ⟨(-1800), (-1724)⟩, ⟨10, 15⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3589072, 6448229⟩, ⟨1158250, 1596304⟩, ⟨87868, 94264⟩, ⟨(-1165), (-830)⟩, ⟨(-34), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139576505), (-136717347)⟩, ⟨1158250, 1596304⟩, ⟨87868, 94264⟩, ⟨(-1165), (-830)⟩, ⟨(-34), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-178363836), (-98274452)⟩, ⟨(-43758393), (-30718244)⟩, ⟨(-2446253), (-2099408)⟩, ⟨42690, 61393⟩, ⟨1337, 1666⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1253291929, 1333381314⟩, ⟨(-43758393), (-30718244)⟩, ⟨(-2446253), (-2099408)⟩, ⟨42690, 61393⟩, ⟨1337, 1666⟩⟩
...
def j70 : Jet := ⟨⟨(-139), (-76)⟩, ⟨(-35), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11696, 11760⟩, ⟨(-35), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8407, 15029⟩, ⟨2757, 3741⟩, ⟨217, 229⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843770), (-837147)⟩, ⟨2757, 3741⟩, ⟨217, 229⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1078248), (-601753)⟩, ⟨(-267581), (-195803)⟩, ⟨(-16033), (-15226)⟩, ⟨103, 149⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34713146, 35189642⟩, ⟨(-267581), (-195803)⟩, ⟨(-16033), (-15226)⟩, ⟨103, 149⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨24952323, 44968597⟩, ⟨7975500, 11101404⟩, ⟨587146, 644776⟩, ⟨(-10392), (-7366)⟩, ⟨(-297), (-249)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-690875560), (-670859285)⟩, ⟨7975500, 11101404⟩, ⟨587146, 644776⟩, ⟨(-10392), (-7366)⟩, ⟨(-297), (-249)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-882865027), (-482223581)⟩, ⟨(-214983351), (-146554786)⟩, ⟨(-11461749), (-9024542)⟩, ⟨286650, 422358⟩, ⟨8023, 10933⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3412102269, 3812743715⟩, ⟨(-214983351), (-146554786)⟩, ⟨(-11461749), (-9024542)⟩, ⟨286650, 422358⟩, ⟨8023, 10933⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1062577822, 1507306620⟩, ⟨127630096, 162369497⟩, ⟨(-8948617), (-6120577)⟩, ⟨(-309475), (-227254)⟩, ⟨7165, 10560⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4838180966, 5406269397⟩, ⟨185970688, 340628101⟩, ⟨18600059, 39622107⟩, ⟨556249, 3234203⟩, ⟨12169, 309876⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1196969252, 1897314948⟩, ⟨189781614, 323924292⟩, ⟨(-1136021), 19887888⟩, ⟨(-408915), 2111919⟩, ⟨(-79489), 207966⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1545458083), (-1159093561)⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2749509213, 3135873735⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨333584703, 838144686⟩, ⟨105780900, 286189096⟩, ⟨7382193, 42001281⟩, ⟨(-532638), 4865764⟩, ⟨(-137173), 594392⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4628551999, 5133111982⟩, ⟨105780900, 286189096⟩, ⟨7382193, 42001281⟩, ⟨(-532638), 4865764⟩, ⟨(-137173), 594392⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4458640988, 4695375181⟩, ⟨48380106, 137841645⟩, ⟨1353028, 19967239⟩, ⟨(-873843), 2328892⟩, ⟨(-182779), 313097⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2854288200, 3428222544⟩, ⟨(-180220616), (-99902122)⟩, ⟨(-5333778), 12402555⟩, ⟨(-1536119), 1639532⟩, ⟨(-238203), 267906⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6759277282, 9012369721⟩, ⟨1126546212, 1126546219⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10637526720, 18911158664⟩, ⟨3545842234, 4727789684⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10637526720, 18911158664⟩, ⟨3545842234, 4727789684⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18911158664), (-10637526720)⟩, ⟨(-4727789684), (-3545842234)⟩, ⟨(-295486857), (-295486852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9455579332), (-5318763360)⟩, ⟨(-2363894842), (-1772921117)⟩, ⟨(-147743429), (-147743426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨475159524, 1244921968⟩, ⟨(-685189064), (-196141273)⟩, ⟨(-2341704), 172214525⟩, ⟨(-27096820), 16142918⟩, ⟨(-5183235), 3768712⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨315774749, 993690816⟩, ⟨(-599152689), (-141401114)⟩, ⟨1147134, 169806911⟩, ⟨(-31278699), 14309604⟩, ⟨(-5359079), 4965196⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1352275821, 1352275822⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4555336440, 4555336448⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar216 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified518
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar216 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1159093561, 1545458083⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4458640988, 4695375181⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified519
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((107949 / 400000) : ℝ)..(35983 / 100000), prawitzNormalCorrection
      ((36447 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
