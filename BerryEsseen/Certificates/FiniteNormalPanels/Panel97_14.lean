...
namespace FiniteNormalPanel97_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1189 / 32000)
def radius : Rat := (1189 / 32000)

def j0 : Jet := ⟨⟨159584878, 159584879⟩, ⟨159584878, 159584879⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨501350680, 501350684⟩, ⟨501350680, 501350684⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨58522565, 58522567⟩, ⟨117045130, 117045134⟩, ⟨58522565, 58522567⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨14, 15⟩, ⟨29, 30⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94673), (-94671)⟩, ⟨29, 30⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1290), (-1289)⟩, ⟨(-2580), (-2578)⟩, ⟨(-1290), (-1287)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111766, 5111768⟩, ⟨(-2580), (-2578)⟩, ⟨(-1290), (-1287)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨69652, 69653⟩, ⟨139268, 139270⟩, ⟨69563, 69566⟩, ⟨(-72), (-69)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-143095925), (-143095923)⟩, ⟨139268, 139270⟩, ⟨69563, 69566⟩, ⟨(-72), (-69)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1949804), (-1949803)⟩, ⟨(-3897710), (-3897708)⟩, ⟨(-1945062), (-1945059)⟩, ⟨3791, 3794⟩, ⟨944, 947⟩⟩
...
def j19 : Jet := ⟨⟨1429705961, 1429705963⟩, ⟨(-3897710), (-3897708)⟩, ⟨(-1945062), (-1945059)⟩, ⟨3791, 3794⟩, ⟨944, 947⟩⟩
...
def j25 : Jet := ⟨⟨161, 162⟩, ⟨321, 323⟩, ⟨159, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852016), (-852014)⟩, ⟨321, 323⟩, ⟨159, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11610), (-11609)⟩, ⟨(-23215), (-23213)⟩, ⟨(-11600), (-11597)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779784, 35779786⟩, ⟨(-23215), (-23213)⟩, ⟨(-11600), (-11597)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨487529, 487530⟩, ⟨974742, 974744⟩, ⟨486737, 486740⟩, ⟨(-634), (-631)⟩, ⟨(-159), (-156)⟩⟩
...
def j33 : Jet := ⟨⟨(-715340354), (-715340352)⟩, ⟨974742, 974744⟩, ⟨486737, 486740⟩, ⟨(-634), (-631)⟩, ⟨(-159), (-156)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9747119), (-9747117)⟩, ⟨(-19480956), (-19480953)⟩, ⟨(-9713924), (-9713920)⟩, ⟨26536, 26539⟩, ⟨6611, 6614⟩⟩
...
def j36 : Jet := ⟨⟨4285220177, 4285220179⟩, ⟨(-19480956), (-19480953)⟩, ⟨(-9713924), (-9713920)⟩, ⟨26536, 26539⟩, ⟨6611, 6614⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨166889293, 166889295⟩, ⟨166434314, 166434317⟩, ⟨(-682026), (-682024)⟩, ⟨(-226605), (-226603)⟩, ⟨552, 554⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304736583, 4304736586⟩, ⟨19569675, 19569680⟩, ⟨9847125, 9847132⟩, ⟨62465, 62472⟩, ⟨15838, 15846⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨167268897, 167268900⟩, ⟨167573300, 167573305⟩, ⟨457395, 457400⟩, ⟨153784, 153790⟩, ⟨991, 998⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-159584879), (-159584878)⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4135382417, 4135382418⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6514341, 6514342⟩, ⟨13052392, 13052394⟩, ⟨6573699, 6573702⟩, ⟨47668, 47674⟩, ⟨12124, 12129⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301481637, 4301481638⟩, ⟨13052392, 13052394⟩, ⟨6573699, 6573702⟩, ⟨47668, 47674⟩, ⟨12124, 12129⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298223232, 4298223233⟩, ⟨6521252, 6521254⟩, ⟨3279412, 3279415⟩, ⟨18839, 18844⟩, ⟨4777, 4782⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4138517374, 4138517377⟩, ⟨(-153426912), (-153426907)⟩, ⟨2915255, 2915260⟩, ⟨(-103712), (-103706)⟩, ⟨3898, 3906⟩⟩
...
def j47 : Jet := ⟨⟨1326744444, 1326744454⟩, ⟨1326744444, 1326744454⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨409840331, 409840338⟩, ⟨819680662, 819680676⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨409840331, 409840338⟩, ⟨819680662, 819680676⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-409840338), (-409840331)⟩, ⟨(-819680676), (-819680662)⟩, ⟨(-409840338), (-409840331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-204920169), (-204920165)⟩, ⟨(-409840338), (-409840331)⟩, ⟨(-204920169), (-204920165)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4094858842, 4094858847⟩, ⟨(-390745312), (-390745304)⟩, ⟨(-176729536), (-176729530)⟩, ⟨18050123, 18050125⟩, ⟨3785431, 3785433⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3945698137, 3945698146⟩, ⟨(-522790434), (-522790419)⟩, ⟨(-153554105), (-153554090)⟩, ⟨23341737, 23341749⟩, ⟨2895937, 2895953⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 319169758⟩, ⟨159584878, 159584879⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1002701368⟩, ⟨501350680, 501350684⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 234090266⟩, ⟨0, 234090266⟩, ⟨58522565, 58522567⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 59⟩, ⟨0, 59⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94627)⟩, ⟨0, 59⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5161), 0⟩, ⟨(-5161), 4⟩, ⟨(-1291), (-1284)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107895, 5113057⟩, ⟨(-5161), 4⟩, ⟨(-1291), (-1284)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 278679⟩, ⟨(-282), 278680⟩, ⟨69246, 69671⟩, ⟨(-142), 2⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142886897)⟩, ⟨(-282), 278680⟩, ⟨69246, 69671⟩, ⟨(-142), 2⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7803009), 0⟩, ⟨(-7803025), 15190⟩, ⟨(-1950769), (-1927966)⟩, ⟨(-12), 7597⟩, ⟨934, 951⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423852756, 1431655766⟩, ⟨(-7803025), 15190⟩, ⟨(-1950769), (-1927966)⟩, ⟨(-12), 7597⟩, ⟨934, 951⟩⟩
...
def j72 : Jet := ⟨⟨0, 646⟩, ⟨(-1), 646⟩, ⟨159, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851530)⟩, ⟨(-1), 646⟩, ⟨159, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-46447), 0⟩, ⟨(-46448), 36⟩, ⟨(-11613), (-11557)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35744947, 35791395⟩, ⟨(-46448), 36⟩, ⟨(-11613), (-11557)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1950753⟩, ⟨(-2532), 1950755⟩, ⟨483890, 487691⟩, ⟨(-1267), 2⟩, ⟨(-160), (-155)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713877129)⟩, ⟨(-2532), 1950755⟩, ⟨483890, 487691⟩, ⟨(-1267), 2⟩, ⟨(-160), (-155)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-39015045), 0⟩, ⟨(-39015184), 106323⟩, ⟨(-9753901), (-9594276)⟩, ⟨(-105), 53163⟩, ⟨6514, 6647⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4255952251, 4294967296⟩, ⟨(-39015184), 106323⟩, ⟨(-9753901), (-9594276)⟩, ⟨(-105), 53163⟩, ⟨6514, 6647⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 334233790⟩, ⟨164384357, 167120442⟩, ⟨(-1366272), 1774⟩, ⟨(-227716), (-223277)⟩, ⟨(-2), 1110⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4334339999⟩, ⟨(-108282), 39733781⟩, ⟨9593292, 10297801⟩, ⟨(-54649), 185573⟩, ⟨13732, 18732⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 337297769⟩, ⟨164375930, 171744542⟩, ⟨(-1383011), 2349237⟩, ⟨120473, 191896⟩, ⟨(-7513), 9811⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-319169758), 0⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3975797538, 4294967296⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 26489093⟩, ⟨0, 26975318⟩, ⟨6073729, 7236605⟩, ⟨(-110608), 218022⟩, ⟨7281, 18175⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4321456389⟩, ⟨0, 26975318⟩, ⟨6073729, 7236605⟩, ⟨(-110608), 218022⟩, ⟨7281, 18175⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4308191484⟩, ⟨0, 13487659⟩, ⟨3006429, 3618303⟩, ⟨(-66667), 109011⟩, ⟨1767, 8246⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3975797538, 4308191484⟩, ⟨(-160076241), (-146097219)⟩, ⟨2281862, 3618303⟩, ⟨(-201110), (-2696)⟩, ⟨(-2416), 10724⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2653488907⟩, ⟨1326744444, 1326744454⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1639361349⟩, ⟨0, 1639361350⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1639361349⟩, ⟨0, 1639361350⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1639361349), 0⟩, ⟨(-1639361350), 0⟩, ⟨(-409840338), (-409840331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-819680675), 0⟩, ⟨(-819680675), 0⟩, ⟨(-204920169), (-204920165)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3548756149, 4294967296⟩, ⟨(-819680675), 0⟩, ⟨(-204920169), (-91100458)⟩, ⟨0, 39108355⟩, ⟨307352, 4888545⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3285039207, 4308191484⟩, ⟨(-982280710), (-120714168)⟩, ⟨(-203665709), (-50162216)⟩, ⟨2207212, 46864052⟩, ⟨(-1348135), 4904303⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨159584878, 159584879⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298223232, 4298223233⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1962
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 319169758⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4308191484⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1963
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (289483921 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(1189 / 16000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (1189 / 16000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1189 / 16000), prawitzNormalCorrection
