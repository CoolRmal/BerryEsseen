...
namespace FiniteNormalPanel82_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (33647 / 160000)
def radius : Rat := (33647 / 800000)

def j0 : Jet := ⟨⟨903204778, 903204779⟩, ⟨180640955, 180640956⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2837501495, 2837501499⟩, ⟨567500297, 567500301⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1874616074, 1874616081⟩, ⟨749846426, 749846434⟩, ⟨74984642, 74984644⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨469, 470⟩, ⟨187, 188⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94218), (-94216)⟩, ⟨187, 188⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-41124), (-41122)⟩, ⟨(-16369), (-16365)⟩, ⟨(-1606), (-1602)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5071932, 5071935⟩, ⟨(-16369), (-16365)⟩, ⟨(-1606), (-1602)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2213736, 2213738⟩, ⟨878349, 878354⟩, ⟨84990, 84994⟩, ⟨(-565), (-560)⟩, ⟨(-28), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-140951841), (-140951838)⟩, ⟨878349, 878354⟩, ⟨84990, 84994⟩, ⟨(-565), (-560)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-61520978), (-61520976)⟩, ⟨(-24225021), (-24225016)⟩, ⟨(-2270397), (-2270391)⟩, ⟨29925, 29930⟩, ⟨1371, 1377⟩⟩
...
def j19 : Jet := ⟨⟨1370134787, 1370134790⟩, ⟨(-24225021), (-24225016)⟩, ⟨(-2270397), (-2270391)⟩, ⟨29925, 29930⟩, ⟨1371, 1377⟩⟩
...
def j22 : Jet := ⟨⟨(-48), (-46)⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11787, 11790⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5144, 5146⟩, ⟨2048, 2052⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847033), (-847030)⟩, ⟨2048, 2052⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-369703), (-369701)⟩, ⟨(-146989), (-146984)⟩, ⟨(-14345), (-14340)⟩, ⟨68, 72⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35421691, 35421694⟩, ⟨(-146989), (-146984)⟩, ⟨(-14345), (-14340)⟩, ⟨68, 72⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15460437, 15460439⟩, ⟨6120017, 6120023⟩, ⟨586492, 586499⟩, ⟨(-5043), (-5037)⟩, ⟨(-240), (-235)⟩⟩
...
def j33 : Jet := ⟨⟨(-700367446), (-700367443)⟩, ⟨6120017, 6120023⟩, ⟨586492, 586499⟩, ⟨(-5043), (-5037)⟩, ⟨(-240), (-235)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-305688027), (-305688024)⟩, ⟨(-119604020), (-119604014)⟩, ⟨(-10903061), (-10903053)⟩, ⟨207039, 207046⟩, ⟨9253, 9259⟩⟩
...
def j36 : Jet := ⟨⟨3989279269, 3989279272⟩, ⟨(-119604020), (-119604014)⟩, ⟨(-10903061), (-10903053)⟩, ⟨207039, 207046⟩, ⟨9253, 9259⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨905189548, 905189552⟩, ⟨165033472, 165033478⟩, ⟨(-4700843), (-4700836)⟩, ⟨(-280221), (-280216)⟩, ⟨4859, 4865⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4624079392, 4624079397⟩, ⟨138636183, 138636192⟩, ⟨16794518, 16794531⟩, ⟨642432, 642447⟩, ⟨47231, 47245⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨974551852, 974551858⟩, ⟨206897942, 206897953⟩, ⟨3805560, 3805574⟩, ⟨327290, 327303⟩, ⟨12442, 12456⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-903204779), (-903204778)⟩, ⟨(-180640956), (-180640955)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3391762517, 3391762518⟩, ⟨(-180640956), (-180640955)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨221131209, 221131213⟩, ⟨93892576, 93892582⟩, ⟨11693729, 11693739⟩, ⟨515170, 515180⟩, ⟨40549, 40560⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4516098505, 4516098509⟩, ⟨93892576, 93892582⟩, ⟨11693729, 11693739⟩, ⟨515170, 515180⟩, ⟨40549, 40560⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4404145250, 4404145253⟩, ⟨45782498, 45782502⟩, ⟨5463959, 5463966⟩, ⟨194399, 194406⟩, ⟨14360, 14368⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3477981029, 3477981034⟩, ⟨(-149078121), (-149078115)⟩, ⟨2389367, 2389375⟩, ⟨(-76290), (-76283)⟩, ⟨3163, 3171⟩⟩
...
def j47 : Jet := ⟨⟨5759736940, 5759736949⟩, ⟨1151947384, 1151947391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7724056397, 7724056422⟩, ⟨3089622548, 3089622572⟩, ⟨308962253, 308962258⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7724056397, 7724056422⟩, ⟨3089622548, 3089622572⟩, ⟨308962253, 308962258⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7724056422), (-7724056397)⟩, ⟨(-3089622572), (-3089622548)⟩, ⟨(-308962258), (-308962253)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3862028211), (-3862028198)⟩, ⟨(-1544811286), (-1544811274)⟩, ⟨(-154481129), (-154481126)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1747603505, 1747603520⟩, ⟨(-628576997), (-628576985)⟩, ⟨50185397, 50185403⟩, ⟨9055527, 9055530⟩, ⟨(-1716805), (-1716804)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1415175347, 1415175362⟩, ⟨(-569668675), (-569668659)⟩, ⟨63429258, 63429271⟩, ⟨5210322, 5210334⟩, ⟨(-1664184), (-1664173)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨722563823, 1083845735⟩, ⟨180640955, 180640956⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2270001197, 3405001799⟩, ⟨567500297, 567500301⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1199754288, 2699447156⟩, ⟨599877142, 899815722⟩, ⟨74984642, 74984644⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨300, 677⟩, ⟨150, 226⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94387), (-94009)⟩, ⟨150, 226⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-59324), (-26260)⟩, ⟨(-19734), (-12987)⟩, ⟨(-1623), (-1581)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5053732, 5086797⟩, ⟨(-19734), (-12987)⟩, ⟨(-1623), (-1581)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1411707, 3197124⟩, ⟨693449, 1062081⟩, ⟨83075, 86555⟩, ⟨(-685), (-440)⟩, ⟨(-29), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141753870), (-139968452)⟩, ⟨693449, 1062081⟩, ⟨83075, 86555⟩, ⟨(-685), (-440)⟩, ⟨(-29), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-89094295), (-39098726)⟩, ⟨(-29504392), (-18881830)⟩, ⟨(-2354783), (-2166757)⟩, ⟨23278, 36555⟩, ⟨1287, 1445⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1342561470, 1392557040⟩, ⟨(-29504392), (-18881830)⟩, ⟨(-2354783), (-2166757)⟩, ⟨23278, 36555⟩, ⟨1287, 1445⟩⟩
...
def j72 : Jet := ⟨⟨3286, 7421⟩, ⟨1628, 2471⟩, ⟨198, 206⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848891), (-844755)⟩, ⟨1628, 2471⟩, ⟨198, 206⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-533540), (-235973)⟩, ⟨(-177393), (-116432)⟩, ⟨(-14539), (-14100)⟩, ⟨53, 88⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35257854, 35555422⟩, ⟨(-177393), (-116432)⟩, ⟨(-14539), (-14100)⟩, ⟨53, 88⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9848913, 22347082⟩, ⟨4812962, 7416504⟩, ⟨569254, 600553⟩, ⟨(-6130), (-3945)⟩, ⟨(-247), (-224)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705978970), (-693480800)⟩, ⟨4812962, 7416504⟩, ⟨569254, 600553⟩, ⟨(-6130), (-3945)⟩, ⟨(-247), (-224)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-443717680), (-193716623)⟩, ⟨(-146561444), (-92196934)⟩, ⟨(-11494252), (-10176039)⟩, ⟨159682, 254201⟩, ⟨8497, 9873⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3851249616, 4101250673⟩, ⟨(-146561444), (-92196934)⟩, ⟨(-11494252), (-10176039)⟩, ⟨159682, 254201⟩, ⟨8497, 9873⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨709578428, 1104003570⟩, ⟨154003855, 174021061⟩, ⟨(-5765305), (-3640070)⟩, ⟨(-298838), (-257315)⟩, ⟨3755, 5977⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4497833842, 4789807443⟩, ⟨101112202, 182278784⟩, ⟨13433063, 21232148⟩, ⟨255977, 1165533⟩, ⟨16253, 93609⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨743094335, 1231200183⟩, ⟨177982911, 240924723⟩, ⟨(-584691), 9031102⟩, ⟨(-53994), 804707⟩, ⟨(-25389), 60512⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1083845735), (-722563823)⟩, ⟨(-180640956), (-180640955)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3211121561, 3572403473⟩, ⟨(-180640956), (-180640955)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨128566564, 352937238⟩, ⟨61587472, 138127508⟩, ⟨7040371, 18692323⟩, ⟨(-96554), 1474552⟩, ⟨(-21846), 143964⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4423533860, 4647904534⟩, ⟨61587472, 138127508⟩, ⟨7040371, 18692323⟩, ⟨(-96554), 1474552⟩, ⟨(-21846), 143964⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4358776578, 4467952324⟩, ⟨29601499, 68052712⟩, ⟨2865629, 9108826⟩, ⟨(-189786), 707022⟩, ⟨(-31321), 72951⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3258828411, 3716286365⟩, ⟨(-165785005), (-126720829)⟩, ⟨(-719733), 6331401⟩, ⟨(-540964), 467553⟩, ⟨(-55789), 68662⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4607789556, 6911684340⟩, ⟨1151947384, 1151947391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4943396102, 11122641251⟩, ⟨2471698040, 3707547088⟩, ⟨308962253, 308962258⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4943396102, 11122641251⟩, ⟨2471698040, 3707547088⟩, ⟨308962253, 308962258⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11122641251), (-4943396102)⟩, ⟨(-3707547088), (-2471698040)⟩, ⟨(-308962258), (-308962253)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5561320626), (-2471698051)⟩, ⟨(-1853773544), (-1235849020)⟩, ⟨(-154481129), (-154481126)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1176563706, 2415622204⟩, ⟨(-1042619472), (-338548585)⟩, ⟨(-38177376), 182686680⟩, ⟨(-18165525), 30493231⟩, ⟨(-6575769), 2646711⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨892723731, 2090154184⟩, ⟨(-995385105), (-291589385)⟩, ⟨(-23449658), 201878364⟩, ⟨(-24610902), 28296063⟩, ⟨(-7067978), 3430542⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨903204778, 903204779⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4404145250, 4404145253⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1656
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨722563823, 1083845735⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4358776578, 4467952324⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1657
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (7554827 / 268435456)

theorem envelope_integral : (∫ s in ((33647 / 200000) : ℝ)..(100941 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((33647 / 200000) : ℝ)..(100941 / 400000), prawitzNormalCorrection
