...
namespace FiniteNormalPanel125_16

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (42141 / 400000)
def radius : Rat := (14047 / 400000)

def j0 : Jet := ⟨⟨452485542, 452485543⟩, ⟨150828514, 150828515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1421525254, 1421525258⟩, ⟨473841751, 473841755⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨470488808, 470488812⟩, ⟨313659204, 313659210⟩, ⟨52276534, 52276536⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨117, 118⟩, ⟨78, 79⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94570), (-94568)⟩, ⟨78, 79⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10360), (-10359)⟩, ⟨(-6899), (-6897)⟩, ⟨(-1146), (-1143)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102696, 5102698⟩, ⟨(-6899), (-6897)⟩, ⟨(-1146), (-1143)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨558970, 558972⟩, ⟨371891, 371893⟩, ⟨61477, 61480⟩, ⟨(-168), (-165)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-142606607), (-142606604)⟩, ⟨371891, 371893⟩, ⟨61477, 61480⟩, ⟨(-168), (-165)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15621729), (-15621728)⟩, ⟨(-10373748), (-10373746)⟩, ⟨(-1701855), (-1701852)⟩, ⟨8996, 8999⟩, ⟨733, 736⟩⟩
...
def j19 : Jet := ⟨⟨1416034036, 1416034038⟩, ⟨(-10373748), (-10373746)⟩, ⟨(-1701855), (-1701852)⟩, ⟨8996, 8999⟩, ⟨733, 736⟩⟩
...
def j22 : Jet := ⟨⟨(-12), (-11)⟩, ⟨(-8), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11823, 11825⟩, ⟨(-8), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1295, 1296⟩, ⟨862, 864⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850882), (-850880)⟩, ⟨862, 864⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-93210), (-93208)⟩, ⟨(-62046), (-62044)⟩, ⟨(-10280), (-10276)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35698184, 35698187⟩, ⟨(-62046), (-62044)⟩, ⟨(-10280), (-10276)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3910529, 3910530⟩, ⟨2600222, 2600224⟩, ⟨428844, 428848⟩, ⟨(-1505), (-1502)⟩, ⟨(-126), (-122)⟩⟩
...
def j33 : Jet := ⟨⟨(-711917354), (-711917352)⟩, ⟨2600222, 2600224⟩, ⟨428844, 428848⟩, ⟨(-1505), (-1502)⟩, ⟨(-126), (-122)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-77986427), (-77986425)⟩, ⟨(-51706113), (-51706110)⟩, ⟨(-8428290), (-8428287)⟩, ⟨62801, 62804⟩, ⟨5095, 5098⟩⟩
...
def j36 : Jet := ⟨⟨4216980869, 4216980871⟩, ⟨(-51706113), (-51706110)⟩, ⟨(-8428290), (-8428287)⟩, ⟨62801, 62804⟩, ⟨5095, 5098⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨468671355, 468671358⟩, ⟨152790336, 152790341⟩, ⟨(-1707754), (-1707751)⟩, ⟨(-184780), (-184777)⟩, ⟨1234, 1237⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4374395957, 4374395960⟩, ⟨53636239, 53636245⟩, ⟨9400559, 9400565⟩, ⟨157314, 157321⟩, ⟨14627, 14635⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨477338694, 477338698⟩, ⟨161468794, 161468803⟩, ⟨1194531, 1194538⟩, ⟨142059, 142067⟩, ⟨2402, 2410⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-452485543), (-452485542)⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3842481753, 3842481754⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨53050981, 53050982⟩, ⟨35890984, 35890988⟩, ⟨6335918, 6335922⟩, ⟨121392, 121398⟩, ⟨11544, 11551⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4348018277, 4348018278⟩, ⟨35890984, 35890988⟩, ⟨6335918, 6335922⟩, ⟨121392, 121398⟩, ⟨11544, 11551⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4321411378, 4321411379⟩, ⟨17835677, 17835680⟩, ⟨3111766, 3111769⟩, ⟨47480, 47485⟩, ⟨4419, 4425⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3866139884, 3866139887⟩, ⟨(-135800523), (-135800517)⟩, ⟨2157588, 2157593⟩, ⟨(-66801), (-66794)⟩, ⟨2285, 2292⟩⟩
...
def j47 : Jet := ⟨⟨4087899934, 4087899945⟩, ⟨1362633311, 1362633321⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3890815626, 3890815648⟩, ⟨2593877082, 2593877110⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3890815626, 3890815648⟩, ⟨2593877082, 2593877110⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3890815648), (-3890815626)⟩, ⟨(-2593877110), (-2593877082)⟩, ⟨(-432312854), (-432312847)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1945407824), (-1945407813)⟩, ⟨(-1296938555), (-1296938541)⟩, ⟨(-216156427), (-216156423)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2730523597, 2730523608⟩, ⟨(-824528128), (-824528115)⟩, ⟨(-12931201), (-12931193)⟩, ⟨28966076, 28966079⟩, ⟨(-1861301), (-1861300)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2457896755, 2457896768⟩, ⟨(-828538933), (-828538915)⟩, ⟨15801948, 15801963⟩, ⟨26026173, 26026185⟩, ⟨(-2583549), (-2583537)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨301657028, 603314057⟩, ⟨150828514, 150828515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨947683503, 1895367010⟩, ⟨473841751, 473841755⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨209106137, 836424554⟩, ⟨209106136, 418212280⟩, ⟨52276534, 52276536⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨52, 210⟩, ⟨52, 105⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94635), (-94476)⟩, ⟨52, 105⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-18430), (-4599)⟩, ⟨(-9213), (-4578)⟩, ⟨(-1150), (-1135)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5094626, 5108458⟩, ⟨(-9213), (-4578)⟩, ⟨(-1150), (-1135)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨248038, 994849⟩, ⟨246243, 497203⟩, ⟨60887, 61902⟩, ⟨(-225), (-109)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142917539), (-142170727)⟩, ⟨246243, 497203⟩, ⟨60887, 61902⟩, ⟨(-225), (-109)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-27832515), (-6921769)⟩, ⟨(-13904270), (-6824940)⟩, ⟨(-1724581), (-1669972)⟩, ⟨5917, 12075⟩, ⟨716, 749⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1403823250, 1424733997⟩, ⟨(-13904270), (-6824940)⟩, ⟨(-1724581), (-1669972)⟩, ⟨5917, 12075⟩, ⟨716, 749⟩⟩
...
def j70 : Jet := ⟨⟨(-22), (-5)⟩, ⟨(-11), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11813, 11831⟩, ⟨(-11), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨575, 2305⟩, ⟨572, 1153⟩, ⟨140, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851602), (-849871)⟩, ⟨572, 1153⟩, ⟨140, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-165846), (-41377)⟩, ⟨(-82896), (-41152)⟩, ⟨(-10333), (-10202)⟩, ⟨11, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35625548, 35750018⟩, ⟨(-82896), (-41152)⟩, ⟨(-10333), (-10202)⟩, ⟨11, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1734476, 6962147⟩, ⟨1718332, 3479071⟩, ⟨423534, 432636⟩, ⟨(-2016), (-990)⟩, ⟨(-127), (-120)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714093407), (-708865735)⟩, ⟨1718332, 3479071⟩, ⟨423534, 432636⟩, ⟨(-2016), (-990)⟩, ⟨(-127), (-120)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-139066312), (-34512061)⟩, ⟨(-69449498), (-33834528)⟩, ⟨(-8587366), (-8204994)⟩, ⟨41141, 84425⟩, ⟨4933, 5213⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4155900984, 4260455235⟩, ⟨(-69449498), (-33834528)⟩, ⟨(-8587366), (-8204994)⟩, ⟨41141, 84425⟩, ⟨4933, 5213⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨309753263, 628734431⟩, ⟨148740683, 155677688⟩, ⟨(-2295044), (-1121438)⟩, ⟨(-188960), (-178910)⟩, ⟨809, 1664⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4329758923, 4438687097⟩, ⟨34384904, 74175154⟩, ⟨8611530, 10411236⟩, ⟨46650, 284391⟩, ⟨10051, 20789⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨312262436, 649773378⟩, ⟨152425406, 171745434⟩, ⟨(-559983), 3082158⟩, ⟨66673, 229667⟩, ⟨(-5674), 11393⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-603314057), (-301657028)⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3691653239, 3993310268⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨22702810, 98302365⟩, ⟨22163952, 51965756⟩, ⟨5240033, 7800270⟩, ⟨(-35092), 315990⟩, ⟨2612, 24028⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4317670106, 4393269661⟩, ⟨22163952, 51965756⟩, ⟨5240033, 7800270⟩, ⟨(-35092), 315990⟩, ⟨2612, 24028⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306303739, 4343840412⟩, ⟨10957291, 25914478⟩, ⟨2513237, 3875928⟩, ⟨(-40826), 151185⟩, ⟨(-1353), 11496⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3701397251, 4038750781⟩, ⟨(-143126697), (-127132246)⟩, ⟨1250150, 3218911⟩, ⟨(-174072), 52309⟩, ⟨(-6568), 12123⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2725266623, 5450533257⟩, ⟨1362633311, 1362633321⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1729251389, 6917005588⟩, ⟨1729251388, 3458502812⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1729251389, 6917005588⟩, ⟨1729251388, 3458502812⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6917005588), (-1729251389)⟩, ⟨(-3458502812), (-1729251388)⟩, ⟨(-432312854), (-432312847)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3458502794), (-864625694)⟩, ⟨(-1729251406), (-864625694)⟩, ⟨(-216156427), (-216156423)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1919756792, 3511813549⟩, ⟨(-1413935916), (-386468844)⟩, ⟨(-137841708), 188024151⟩, ⟨(-12267504), 65939629⟩, ⟨(-11368623), 4703432⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1654443916, 3302316115⟩, ⟨(-1446616152), (-389883692)⟩, ⟨(-117620378), 226557926⟩, ⟨(-19003478), 66529754⟩, ⟨(-13013719), 5039791⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨452485542, 452485543⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4321411378, 4321411379⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2524
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨301657028, 603314057⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306303739, 4343840412⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2525
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (43267781 / 1073741824)

theorem envelope_integral : (∫ s in ((14047 / 200000) : ℝ)..(14047 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (14047 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (14047 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((14047 / 200000) : ℝ)..(14047 / 100000), prawitzNormalCorrection
