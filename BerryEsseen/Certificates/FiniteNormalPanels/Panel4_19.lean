...
namespace FiniteNormalPanel4_19

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (25191 / 160000)
def radius : Rat := (8397 / 160000)

def j0 : Jet := ⟨⟨676215757, 676215758⟩, ⟨225405252, 225405253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2124394454, 2124394458⟩, ⟨708131483, 708131487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1050776754, 1050776759⟩, ⟨700517834, 700517840⟩, ⟨116752972, 116752974⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨263, 264⟩, ⟨175, 176⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94424), (-94422)⟩, ⟨175, 176⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23102), (-23100)⟩, ⟨(-15359), (-15356)⟩, ⟨(-2532), (-2529)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5089954, 5089957⟩, ⟨(-15359), (-15356)⟩, ⟨(-2532), (-2529)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1245272, 1245274⟩, ⟨826423, 826427⟩, ⟨135237, 135242⟩, ⟨(-830), (-826)⟩, ⟨(-68), (-65)⟩⟩
...
def j16 : Jet := ⟨⟨(-141920305), (-141920302)⟩, ⟨826423, 826427⟩, ⟨135237, 135242⟩, ⟨(-830), (-826)⟩, ⟨(-68), (-65)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-34721233), (-34721231)⟩, ⟨(-22945303), (-22945299)⟩, ⟨(-3690038), (-3690034)⟩, ⟨44318, 44323⟩, ⟨3523, 3528⟩⟩
...
def j19 : Jet := ⟨⟨1396934532, 1396934535⟩, ⟨(-22945303), (-22945299)⟩, ⟨(-3690038), (-3690034)⟩, ⟨44318, 44323⟩, ⟨3523, 3528⟩⟩
...
def j22 : Jet := ⟨⟨(-27), (-26)⟩, ⟨(-18), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11808, 11810⟩, ⟨(-18), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2888, 2890⟩, ⟨1920, 1923⟩, ⟨316, 320⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849289), (-849286)⟩, ⟨1920, 1923⟩, ⟨316, 320⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-207782), (-207780)⟩, ⟨(-138052), (-138049)⟩, ⟨(-22697), (-22693)⟩, ⟨102, 106⟩, ⟨6, 9⟩⟩
...
def j30 : Jet := ⟨⟨35583612, 35583615⟩, ⟨(-138052), (-138049)⟩, ⟨(-22697), (-22693)⟩, ⟨102, 106⟩, ⟨6, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8705638, 8705640⟩, ⟨5769983, 5769986⟩, ⟨939223, 939227⟩, ⟨(-7431), (-7427)⟩, ⟨(-600), (-595)⟩⟩
...
def j33 : Jet := ⟨⟨(-707122245), (-707122242)⟩, ⟨5769983, 5769986⟩, ⟨939223, 939227⟩, ⟨(-7431), (-7427)⟩, ⟨(-600), (-595)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-172999600), (-172999597)⟩, ⟨(-113921424), (-113921419)⟩, ⟨(-18051300), (-18051295)⟩, ⟨308219, 308223⟩, ⟨24171, 24176⟩⟩
...
def j36 : Jet := ⟨⟨4121967696, 4121967699⟩, ⟨(-113921424), (-113921419)⟩, ⟨(-18051300), (-18051295)⟩, ⟨308219, 308223⟩, ⟨24171, 24176⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨690957524, 690957528⟩, ⟨218969873, 218969879⟩, ⟨(-5608283), (-5608278)⟩, ⟨(-586474), (-586469)⟩, ⟨9048, 9054⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4475227711, 4475227716⟩, ⟨123684687, 123684696⟩, ⟨23016673, 23016682⟩, ⟨843137, 843146⟩, ⟨88599, 88611⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨719957113, 719957119⟩, ⟨248057979, 248057988⟩, ⟨4164971, 4164981⟩, ⟨536501, 536514⟩, ⟨19720, 19735⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-676215758), (-676215757)⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3618751538, 3618751539⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨120685027, 120685030⟩, ⟨83162964, 83162970⟩, ⟨15723044, 15723050⟩, ⟨660962, 660972⟩, ⟨72618, 72631⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4415652323, 4415652326⟩, ⟨83162964, 83162970⟩, ⟨15723044, 15723050⟩, ⟨660962, 660972⟩, ⟨72618, 72631⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4354891768, 4354891771⟩, ⟨41009309, 41009313⟩, ⟨7560255, 7560260⟩, ⟨254738, 254745⟩, ⟨26846, 26855⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3669241276, 3669241280⟩, ⟨(-193997516), (-193997510)⟩, ⟨4217719, 4217726⟩, ⟨(-182141), (-182134)⟩, ⟨9249, 9259⟩⟩
...
def j47 : Jet := ⟨⟨2769043975, 2769043981⟩, ⟨923014657, 923014662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1785253299, 1785253308⟩, ⟨1190168864, 1190168874⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1785253299, 1785253308⟩, ⟨1190168864, 1190168874⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1785253308), (-1785253299)⟩, ⟨(-1190168874), (-1190168864)⟩, ⟨(-198361480), (-198361477)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-892626654), (-892626649)⟩, ⟨(-595084437), (-595084432)⟩, ⟨(-99180740), (-99180738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3488992813, 3488992819⟩, ⟨(-483413536), (-483413531)⟩, ⟨(-47079511), (-47079507)⟩, ⟨9616441, 9616442⟩, ⟨210488, 210489⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2980687758, 2980687767⟩, ⟨(-570578698), (-570578686)⟩, ⟨(-14959248), (-14959234)⟩, ⟨9719270, 9719282⟩, ⟨(-272760), (-272745)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨450810504, 901621010⟩, ⟨225405252, 225405253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1416262967, 2832525942⟩, ⟨708131483, 708131487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨467011889, 1868047569⟩, ⟨467011888, 934023786⟩, ⟨116752972, 116752974⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨116, 468⟩, ⟨116, 234⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94571), (-94218)⟩, ⟨116, 234⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-41133), (-10244)⟩, ⟨(-20555), (-10142)⟩, ⟨(-2556), (-2496)⟩, ⟨6, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5071923, 5102813⟩, ⟨(-20555), (-10142)⟩, ⟨(-2556), (-2496)⟩, ⟨6, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨551493, 2219411⟩, ⟨542552, 1108604⟩, ⟨132290, 137341⟩, ⟨(-1115), (-539)⟩, ⟨(-70), (-62)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142614084), (-140946165)⟩, ⟨542552, 1108604⟩, ⟨132290, 137341⟩, ⟨(-1115), (-539)⟩, ⟨(-70), (-62)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-62028387), (-15325735)⟩, ⟨(-30955200), (-14843560)⟩, ⟨(-3803397), (-3530610)⟩, ⟨28647, 59946⟩, ⟨3322, 3670⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1369627378, 1416330031⟩, ⟨(-30955200), (-14843560)⟩, ⟨(-3803397), (-3530610)⟩, ⟨28647, 59946⟩, ⟨3322, 3670⟩⟩
...
def j70 : Jet := ⟨⟨(-47), (-11)⟩, ⟨(-24), (-11)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11788, 11825⟩, ⟨(-24), (-11)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1281, 5144⟩, ⟨1270, 2571⟩, ⟨312, 321⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850896), (-847032)⟩, ⟨1270, 2571⟩, ⟨312, 321⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-370088), (-92101)⟩, ⟨(-184906), (-90982)⟩, ⟨(-22960), (-22325)⟩, ⟨66, 140⟩, ⟨6, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35421306, 35699294⟩, ⟨(-184906), (-90982)⟩, ⟨(-22960), (-22325)⟩, ⟨66, 140⟩, ⟨6, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3851524, 15527006⟩, ⟨3771101, 7753611⟩, ⟨912682, 958119⟩, ⟨(-10014), (-4839)⟩, ⟨(-618), (-571)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-711976359), (-700300876)⟩, ⟨3771101, 7753611⟩, ⟨912682, 958119⟩, ⟨(-10014), (-4839)⟩, ⟨(-618), (-571)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-309666085), (-76146990)⟩, ⟨(-154422994), (-72774644)⟩, ⟨(-18844842), (-16933850)⟩, ⟨197396, 418608⟩, ⟨22363, 25458⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3985301211, 4218820306⟩, ⟨(-154422994), (-72774644)⟩, ⟨(-18844842), (-16933850)⟩, ⟨197396, 418608⟩, ⟨22363, 25458⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨451633831, 934068011⟩, ⟨205401996, 228622348⟩, ⟨(-7612066), (-3611543)⟩, ⟨(-617638), (-542573)⟩, ⟨5818, 12305⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4372488690, 4628695072⟩, ⟨75425422, 179353308⟩, ⟨18851744, 28836793⟩, ⟨168663, 1748888⟩, ⟨32848, 175855⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨459785530, 1006647013⟩, ⟨217040668, 285392470⟩, ⟨(-2614065), 12141716⟩, ⟨(-64204), 1299550⟩, ⟨(-59458), 119221⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-901621010), (-450810504)⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3393346286, 3844156792⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨49221034, 235936188⟩, ⟨46469344, 133779588⟩, ⟨9742510, 24655301⟩, ⟨(-377498), 2222764⟩, ⟨(-43796), 262917⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4344188330, 4530903484⟩, ⟨46469344, 133779588⟩, ⟨9742510, 24655301⟩, ⟨(-377498), 2222764⟩, ⟨(-43796), 262917⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4319507704, 4411358327⟩, ⟨22621639, 66509774⟩, ⟨4241347, 12198378⟩, ⟨(-375503), 1082856⟩, ⟨(-55672), 134412⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3412735048, 3948331130⟩, ⟨(-213640809), (-167164421)⟩, ⟨(-139535), 9730795⟩, ⟨(-976277), 746606⟩, ⟨(-106659), 140011⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1846029314, 3692058639⟩, ⟨923014657, 923014662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨793445908, 3173783653⟩, ⟨793445908, 1586891832⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨793445908, 3173783653⟩, ⟨793445908, 1586891832⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3173783653), (-793445908)⟩, ⟨(-1586891832), (-793445908)⟩, ⟨(-198361480), (-198361477)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1586891827), (-396722954)⟩, ⟨(-793445916), (-396722954)⟩, ⟨(-99180740), (-99180738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2968233203, 3916015491⟩, ⟨(-723438920), (-274173506)⟩, ⟨(-77767264), (-1719857)⟩, ⟨4273820, 15926124⟩, ⟨(-715685), 799221⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2358526336, 3599963587⟩, ⟨(-859842899), (-333381936)⟩, ⟨(-60946979), 43491044⟩, ⟨933687, 19213313⟩, ⟨(-1849323), 863005⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨676215757, 676215758⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4354891768, 4354891771⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified84
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨450810504, 901621010⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4319507704, 4411358327⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified85
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (312355171 / 4294967296)

theorem envelope_integral : (∫ s in ((8397 / 80000) : ℝ)..(8397 / 40000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((8397 / 80000) : ℝ)..(8397 / 40000), prawitzNormalCorrection
