...
namespace FiniteNormalPanel49_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (134729 / 400000)
def radius : Rat := (19247 / 400000)

def j0 : Jet := ⟨⟨1446641622, 1446641623⟩, ⟨206663088, 206663089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4544758691, 4544758696⟩, ⟨649251239, 649251243⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4809077726, 4809077738⟩, ⟨1374022202, 1374022214⟩, ⟨98144442, 98144444⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1203, 1205⟩, ⟨343, 345⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93484), (-93481)⟩, ⟨343, 345⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-104675), (-104670)⟩, ⟨(-29523), (-29518)⟩, ⟨(-2002), (-1997)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5008381, 5008387⟩, ⟨(-29523), (-29518)⟩, ⟨(-2002), (-1997)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5607887, 5607895⟩, ⟨1569196, 1569205⟩, ⟨102759, 102768⟩, ⟨(-1301), (-1294)⟩, ⟨(-42), (-37)⟩⟩
...
def j16 : Jet := ⟨⟨(-137557690), (-137557681)⟩, ⟨1569196, 1569205⟩, ⟨102759, 102768⟩, ⟨(-1301), (-1294)⟩, ⟨(-42), (-37)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-154023437), (-154023426)⟩, ⟨(-42249668), (-42249653)⟩, ⟨(-2526269), (-2526253)⟩, ⟨67274, 67287⟩, ⟨1883, 1895⟩⟩
...
def j19 : Jet := ⟨⟨1277632328, 1277632340⟩, ⟨(-42249668), (-42249653)⟩, ⟨(-2526269), (-2526253)⟩, ⟨67274, 67287⟩, ⟨1883, 1895⟩⟩
...
def j22 : Jet := ⟨⟨(-121), (-119)⟩, ⟨(-35), (-34)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11714, 11717⟩, ⟨(-35), (-34)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨13116, 13120⟩, ⟨3707, 3711⟩, ⟨251, 256⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-839061), (-839056)⟩, ⟨3707, 3711⟩, ⟨251, 256⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-939498), (-939491)⟩, ⟨(-264278), (-264270)⟩, ⟨(-17708), (-17698)⟩, ⟨161, 167⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34851896, 34851904⟩, ⟨(-264278), (-264270)⟩, ⟨(-17708), (-17698)⟩, ⟨161, 167⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨39023691, 39023701⟩, ⟨10853712, 10853726⟩, ⟨692026, 692044⟩, ⟨(-11526), (-11512)⟩, ⟨(-352), (-343)⟩⟩
...
def j33 : Jet := ⟨⟨(-676804192), (-676804181)⟩, ⟨10853712, 10853726⟩, ⟨692026, 692044⟩, ⟨(-11526), (-11512)⟩, ⟨(-352), (-343)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-757818104), (-757818089)⟩, ⟨(-204366551), (-204366528)⟩, ⟨(-11218556), (-11218527)⟩, ⟨456501, 456525⟩, ⟨11730, 11748⟩⟩
...
def j36 : Jet := ⟨⟨3537149192, 3537149207⟩, ⟨(-204366551), (-204366528)⟩, ⟨(-11218556), (-11218527)⟩, ⟨456501, 456525⟩, ⟨11730, 11748⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1351938263, 1351938278⟩, ⟨148427165, 148427186⟩, ⟨(-9059891), (-9059870)⟩, ⟨(-310699), (-310681)⟩, ⟨12161, 12178⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5215144455, 5215144478⟩, ⟨301316370, 301316409⟩, ⟨33949717, 33949768⟩, ⟨2244084, 2244129⟩, ⟨181120, 181155⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1641584871, 1641584897⟩, ⟨275073162, 275073203⟩, ⟨10098519, 10098567⟩, ⟨866755, 866798⟩, ⟨55915, 55955⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1446641623), (-1446641622)⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2848325673, 2848325674⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨627432225, 627432246⟩, ⟨210272120, 210272156⟩, ⟨25336721, 25336767⟩, ⟨1956094, 1956136⟩, ⟨177508, 177549⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4922399521, 4922399542⟩, ⟨210272120, 210272156⟩, ⟨25336721, 25336767⟩, ⟨1956094, 1956136⟩, ⟨177508, 177549⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4597993579, 4597993590⟩, ⟨98207170, 98207188⟩, ⟨10784675, 10784698⟩, ⟨683241, 683264⟩, ⟨55662, 55684⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3049285885, 3049285895⟩, ⟨(-156115172), (-156115157)⟩, ⟨2426668, 2426687⟩, ⟨(-65823), (-65805)⟩, ⟨4036, 4054⟩⟩
...
def j47 : Jet := ⟨⟨7150824575, 7150824582⟩, ⟨1021546363, 1021546369⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11905630142, 11905630167⟩, ⟨3401608596, 3401608620⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11905630142, 11905630167⟩, ⟨3401608596, 3401608620⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11905630167), (-11905630142)⟩, ⟨(-3401608620), (-3401608596)⟩, ⟨(-242972045), (-242972041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5952815084), (-5952815071)⟩, ⟨(-1700804310), (-1700804298)⟩, ⟨(-121486023), (-121486020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1074060329, 1074060344⟩, ⟨(-425327212), (-425327202)⟩, ⟨53834134, 53834139⟩, ⟨914347, 914350⟩, ⟨(-851889), (-851887)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨762547599, 762547613⟩, ⟨(-341008740), (-341008726)⟩, ⟨54287275, 54287287⟩, ⟨(-1564403), (-1564392)⟩, ⟨(-600109), (-600096)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1239978533, 1653304711⟩, ⟨206663088, 206663089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3895507449, 5194009935⟩, ⟨649251239, 649251243⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3533199961, 6281244384⟩, ⟨1177733314, 1570311100⟩, ⟨98144442, 98144444⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨884, 1574⟩, ⟨294, 394⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93803), (-93112)⟩, ⟨294, 394⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-137184), (-76597)⟩, ⟨(-34055), (-24955)⟩, ⟨(-2045), (-1945)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4975872, 5036460⟩, ⟨(-34055), (-24955)⟩, ⟨(-2045), (-1945)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4093337, 7365653⟩, ⟨1314640, 1820886⟩, ⟨98260, 106647⟩, ⟨(-1518), (-1073)⟩, ⟨(-44), (-34)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139072240), (-135799923)⟩, ⟨1314640, 1820886⟩, ⟨98260, 106647⟩, ⟨(-1518), (-1073)⟩, ⟨(-44), (-34)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-203388447), (-111714071)⟩, ⟨(-49765641), (-34575038)⟩, ⟨(-2736623), (-2281453)⟩, ⟨54763, 79720⟩, ⟨1624, 2116⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1228267318, 1319941695⟩, ⟨(-49765641), (-34575038)⟩, ⟨(-2736623), (-2281453)⟩, ⟨54763, 79720⟩, ⟨1624, 2116⟩⟩
...
def j70 : Jet := ⟨⟨(-158), (-88)⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11677, 11748⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9605, 17182⟩, ⟨3142, 4273⟩, ⟨246, 261⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842572), (-834994)⟩, ⟨3142, 4273⟩, ⟨246, 261⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1232234), (-686897)⟩, ⟨(-305475), (-222715)⟩, ⟨(-18191), (-17135)⟩, ⟨133, 194⟩, ⟨1, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34559160, 35104498⟩, ⟨(-305475), (-222715)⟩, ⟨(-18191), (-17135)⟩, ⟨133, 194⟩, ⟨1, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨28429651, 51339141⟩, ⟨9029803, 12651573⟩, ⟨651421, 727009⟩, ⟨(-13523), (-9503)⟩, ⟨(-380), (-311)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-687398232), (-664488741)⟩, ⟨9029803, 12651573⟩, ⟨651421, 727009⟩, ⟨(-13523), (-9503)⟩, ⟨(-380), (-311)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1005296662), (-546633171)⟩, ⟨(-243895915), (-163708558)⟩, ⟨(-12695794), (-9495402)⟩, ⟨365190, 547092⟩, ⟨9384, 13753⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3289670634, 3748334125⟩, ⟨(-243895915), (-163708558)⟩, ⟨(-12695794), (-9495402)⟩, ⟨365190, 547092⟩, ⟨9384, 13753⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1114030481, 1596238064⟩, ⟨125488928, 168170425⟩, ⟨(-10832319), (-7295818)⟩, ⟨(-364015), (-248469)⟩, ⟨9750, 14610⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4921317966, 5607474464⟩, ⟨214938647, 415737705⟩, ⟨21854290, 52463633⟩, ⟨680530, 4947785⟩, ⟨3828, 531405⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1276493589, 2084035469⟩, ⟨199540312, 374072165⟩, ⟨(-2194007), 27416786⟩, ⟨(-708740), 3243268⟩, ⟨(-135509), 360749⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1653304711), (-1239978533)⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2641662585, 3054988763⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨379382605, 1011230945⟩, ⟨118609484, 363020068⟩, ⟨7141277, 59186737⟩, ⟨(-1069980), 7923202⟩, ⟨(-268970), 1090055⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4674349901, 5306198241⟩, ⟨118609484, 363020068⟩, ⟨7141277, 59186737⟩, ⟨(-1069980), 7923202⟩, ⟨(-268970), 1090055⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4480645037, 4773881850⟩, ⟨53355306, 173988266⟩, ⟨41856, 28049345⟩, ⟨(-1602007), 3796935⟩, ⟨(-364149), 584650⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2755865536, 3395638291⟩, ⟨(-196890547), (-91840452)⟩, ⟨(-8346138), 17384036⟩, ⟨(-2489165), 2698727⟩, ⟨(-441718), 492944⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6129278206, 8172370946⟩, ⟨1021546363, 1021546369⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8746993571, 15550210811⟩, ⟨2915664510, 3887552706⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8746993571, 15550210811⟩, ⟨2915664510, 3887552706⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15550210811), (-8746993571)⟩, ⟨(-3887552706), (-2915664510)⟩, ⟨(-242972045), (-242972041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7775105406), (-4373496785)⟩, ⟨(-1943776353), (-1457832255)⟩, ⟨(-121486023), (-121486020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨702690414, 1551403295⟩, ⟨(-702119675), (-238512817)⟩, ⟨(-3403514), 139003329⟩, ⟨(-16471949), 13753394⟩, ⟨(-3521998), 1911816⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨450881266, 1226552863⟩, ⟨(-626221555), (-168067555)⟩, ⟨(-605408), 148363275⟩, ⟨(-23136055), 13368782⟩, ⟨(-4285856), 3414207⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1446641622, 1446641623⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4597993579, 4597993590⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified970
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1239978533, 1653304711⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4480645037, 4773881850⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified971
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (75190929 / 4294967296)

theorem envelope_integral : (∫ s in ((57741 / 200000) : ℝ)..(19247 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (57741 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (19247 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((57741 / 200000) : ℝ)..(19247 / 50000), prawitzNormalCorrection
