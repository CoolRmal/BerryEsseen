...
namespace FiniteNormalPanel101_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1621 / 20000)
def radius : Rat := (1621 / 20000)

def j0 : Jet := ⟨⟨348107099, 348107100⟩, ⟨348107099, 348107100⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1093610704, 1093610709⟩, ⟨1093610704, 1093610709⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨278461811, 278461814⟩, ⟨556923622, 556923628⟩, ⟨278461811, 278461814⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-6135), (-6134)⟩, ⟨(-12261), (-12258)⟩, ⟨(-6113), (-6110)⟩, ⟨17, 20⟩, ⟨4, 5⟩⟩
...
def j13 : Jet := ⟨⟨5106921, 5106923⟩, ⟨(-12261), (-12258)⟩, ⟨(-6113), (-6110)⟩, ⟨17, 20⟩, ⟨4, 5⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨331104, 331105⟩, ⟨661413, 661416⟩, ⟨329117, 329120⟩, ⟨(-1587), (-1584)⟩, ⟨(-395), (-392)⟩⟩
...
def j16 : Jet := ⟨⟨(-142834473), (-142834471)⟩, ⟨661413, 661416⟩, ⟨329117, 329120⟩, ⟨(-1587), (-1584)⟩, ⟨(-395), (-392)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-9260594), (-9260593)⟩, ⟨(-18478306), (-18478303)⟩, ⟨(-9153492), (-9153488)⟩, ⟨85455, 85458⟩, ⟨21106, 21109⟩⟩
...
def j19 : Jet := ⟨⟨1422395171, 1422395173⟩, ⟨(-18478306), (-18478303)⟩, ⟨(-9153492), (-9153488)⟩, ⟨85455, 85458⟩, ⟨21106, 21109⟩⟩
...
def j25 : Jet := ⟨⟨766, 767⟩, ⟨1532, 1534⟩, ⟨763, 766⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851411), (-851409)⟩, ⟨1532, 1534⟩, ⟨763, 766⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-55201), (-55200)⟩, ⟨(-110303), (-110301)⟩, ⟨(-54954), (-54951)⟩, ⟨196, 200⟩, ⟨47, 50⟩⟩
...
def j30 : Jet := ⟨⟨35736193, 35736195⟩, ⟨(-110303), (-110301)⟩, ⟨(-54954), (-54951)⟩, ⟨196, 200⟩, ⟨47, 50⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2316936, 2316937⟩, ⟨4626720, 4626722⟩, ⟨2299070, 2299073⟩, ⟨(-14266), (-14263)⟩, ⟨(-3535), (-3532)⟩⟩
...
def j33 : Jet := ⟨⟨(-713510947), (-713510945)⟩, ⟨4626720, 4626722⟩, ⟨2299070, 2299073⟩, ⟨(-14266), (-14263)⟩, ⟨(-3535), (-3532)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-46260086), (-46260084)⟩, ⟨(-92220201), (-92220197)⟩, ⟨(-45511087), (-45511082)⟩, ⟨597162, 597166⟩, ⟨146978, 146983⟩⟩
...
def j36 : Jet := ⟨⟨4248707210, 4248707212⟩, ⟨(-92220201), (-92220197)⟩, ⟨(-45511087), (-45511082)⟩, ⟨597162, 597166⟩, ⟨146978, 146983⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨362178912, 362178915⟩, ⟨357473853, 357473858⟩, ⟨(-7035777), (-7035773)⟩, ⟨(-2308959), (-2308956)⟩, ⟨27133, 27135⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4341731061, 4341731064⟩, ⟨94239322, 94239329⟩, ⟨48553038, 48553046⟩, ⟨1453092, 1453100⟩, ⟨388179, 388190⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨366122329, 366122333⟩, ⟨369312898, 369312907⟩, ⟨4825537, 4825546⟩, ⟨1675166, 1675176⟩, ⟨50903, 50911⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-348107100), (-348107099)⟩, ⟨(-348107100), (-348107099)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3946860196, 3946860197⟩, ⟨(-348107100), (-348107099)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨31209913, 31209915⟩, ⟨62963784, 62963788⟩, ⟨32578941, 32578947⟩, ⟨1115466, 1115472⟩, ⟨302185, 302190⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4326177209, 4326177211⟩, ⟨62963784, 62963788⟩, ⟨32578941, 32578947⟩, ⟨1115466, 1115472⟩, ⟨302185, 302190⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4310544006, 4310544008⟩, ⟨31368128, 31368131⟩, ⟨16116472, 16116476⟩, ⟨438435, 438440⟩, ⟨117226, 117231⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3961174413, 3961174417⟩, ⟨(-320543852), (-320543847)⟩, ⟨12267843, 12267850⟩, ⟨(-903342), (-903335)⟩, ⟨72188, 72195⟩⟩
...
def j47 : Jet := ⟨⟨2367999225, 2367999233⟩, ⟨2367999225, 2367999233⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1305579284, 1305579294⟩, ⟨2611158568, 2611158588⟩, ⟨1305579284, 1305579294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1305579284, 1305579294⟩, ⟨2611158568, 2611158588⟩, ⟨1305579284, 1305579294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1305579294), (-1305579284)⟩, ⟨(-2611158588), (-2611158568)⟩, ⟨(-1305579294), (-1305579284)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-652789647), (-652789642)⟩, ⟨(-1305579294), (-1305579284)⟩, ⟨(-652789647), (-652789642)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3689365556, 3689365562⟩, ⟨(-1121489165), (-1121489154)⟩, ⟨(-390290083), (-390290073)⟩, ⟨153182977, 153182982⟩, ⟨18018885, 18018888⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3402638351, 3402638361⟩, ⟨(-1309676479), (-1309676460)⟩, ⟨(-265720322), (-265720301)⟩, ⟨166427005, 166427022⟩, ⟨4369175, 4369191⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 696214199⟩, ⟨348107099, 348107100⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2187221413⟩, ⟨1093610704, 1093610709⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1113847250⟩, ⟨0, 1113847254⟩, ⟨278461811, 278461814⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-24556), 0⟩, ⟨(-24556), 73⟩, ⟨(-6139), (-6028)⟩, ⟨0, 38⟩, ⟨4, 5⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5088500, 5113057⟩, ⟨(-24556), 73⟩, ⟨(-6139), (-6028)⟩, ⟨0, 38⟩, ⟨4, 5⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1326009⟩, ⟨(-6369), 1326028⟩, ⟨321948, 331522⟩, ⟨(-3186), 15⟩, ⟨(-399), (-378)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141839567)⟩, ⟨(-6369), 1326028⟩, ⟨321948, 331522⟩, ⟨(-3186), 15⟩, ⟨(-399), (-378)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-37128242), 0⟩, ⟨(-37129894), 343890⟩, ⟨(-9283713), (-8766222)⟩, ⟨(-1240), 171954⟩, ⟨19942, 21499⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1394527523, 1431655766⟩, ⟨(-37129894), 343890⟩, ⟨(-9283713), (-8766222)⟩, ⟨(-1240), 171954⟩, ⟨19942, 21499⟩⟩
...
def j72 : Jet := ⟨⟨0, 3070⟩, ⟨(-8), 3070⟩, ⟨754, 768⟩, ⟨(-5), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-849106)⟩, ⟨(-8), 3070⟩, ⟨754, 768⟩, ⟨(-5), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-221002), 0⟩, ⟨(-221005), 797⟩, ⟨(-55254), (-54054)⟩, ⟨(-3), 400⟩, ⟨45, 50⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35570392, 35791395⟩, ⟨(-221005), 797⟩, ⟨(-55254), (-54054)⟩, ⟨(-3), 400⟩, ⟨45, 50⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 9282061⟩, ⟨(-57315), 9282268⟩, ⟨2234541, 2320723⟩, ⟨(-28660), 156⟩, ⟨(-3584), (-3387)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-706545821)⟩, ⟨(-57315), 9282268⟩, ⟨2234541, 2320723⟩, ⟨(-28660), 156⟩, ⟨(-3584), (-3387)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-185641209), 0⟩, ⟨(-185656074), 2407243⟩, ⟨(-46425167), (-42799409)⟩, ⟨(-11149), 1203704⟩, ⟨136512, 150504⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4109326087, 4294967296⟩, ⟨(-185656074), 2407243⟩, ⟨(-46425167), (-42799409)⟩, ⟨(-11149), 1203704⟩, ⟨136512, 150504⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 729073805⟩, ⟨336174602, 364712031⟩, ⟨(-14181991), 87564⟩, ⟨(-2364508), (-2144540)⟩, ⟨(-316), 54733⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4488994956⟩, ⟨(-2629654), 202809211⟩, ⟨42685738, 59877241⟩, ⟨(-1379703), 5008626⟩, ⟨151579, 760842⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 762010141⟩, ⟨335728216, 415615122⟩, ⟨(-15045972), 27477500⟩, ⟨(-34123), 3798906⟩, ⟨(-426859), 614343⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-696214199), 0⟩, ⟨(-348107100), (-348107099)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3598753097, 4294967296⟩, ⟨(-348107100), (-348107099)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 135195315⟩, ⟨0, 147476298⟩, ⟨20904249, 49968298⟩, ⟨(-2924046), 6665882⟩, ⟨(-254333), 1129011⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4430162611⟩, ⟨0, 147476298⟩, ⟨20904249, 49968298⟩, ⟨(-2924046), 6665882⟩, ⟨(-254333), 1129011⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4362041212⟩, ⟨0, 73738149⟩, ⟨9668151, 24984149⟩, ⟨(-1890964), 3332941⟩, ⟨(-257056), 586090⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3598753097, 4362041212⟩, ⟨(-353543441), (-274368950)⟩, ⟨2124466, 24984149⟩, ⟨(-3915930), 2549338⟩, ⟨(-527191), 739353⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4735998459⟩, ⟨2367999225, 2367999233⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 5222317159⟩, ⟨0, 5222317166⟩, ⟨1305579284, 1305579294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 5222317159⟩, ⟨0, 5222317166⟩, ⟨1305579284, 1305579294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5222317159), 0⟩, ⟨(-5222317166), 0⟩, ⟨(-1305579294), (-1305579284)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2611158580), 0⟩, ⟨(-2611158583), 0⟩, ⟨(-652789647), (-652789642)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2338445062, 4294967296⟩, ⟨(-2611158583), 0⟩, ⟨(-652789647), 438318090⟩, ⟨(-88826291), 396868515⟩, ⟨(-93629680), 63109223⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1959383117, 4362041212⟩, ⟨(-3005480130), (-149383376)⟩, ⟨(-661827484), 685086863⟩, ⟨(-145399198), 459350563⟩, ⟨(-133634819), 77076398⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨348107099, 348107100⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨348107099, 348107100⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4310544006, 4310544008⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2030
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 696214199⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4362041212⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2031
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (269854371 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(1621 / 10000),
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1621 / 10000), prawitzNormalCorrection
