...
namespace FiniteNormalPanel45_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (17743 / 200000)
def radius : Rat := (17743 / 200000)

def j0 : Jet := ⟨⟨381028023, 381028024⟩, ⟨381028023, 381028024⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1197034837, 1197034842⟩, ⟨1197034837, 1197034842⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨333621260, 333621263⟩, ⟨667242520, 667242526⟩, ⟨333621260, 333621263⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨83, 84⟩, ⟨167, 168⟩, ⟨83, 84⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94604), (-94602)⟩, ⟨167, 168⟩, ⟨83, 84⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-7349), (-7348)⟩, ⟨(-14686), (-14682)⟩, ⟨(-7318), (-7314)⟩, ⟨24, 28⟩, ⟨6, 7⟩⟩
...
def j13 : Jet := ⟨⟨5105707, 5105709⟩, ⟨(-14686), (-14682)⟩, ⟨(-7318), (-7314)⟩, ⟨24, 28⟩, ⟨6, 7⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨396597, 396598⟩, ⟨792053, 792055⟩, ⟨393746, 393750⟩, ⟨(-2277), (-2273)⟩, ⟨(-566), (-562)⟩⟩
...
def j16 : Jet := ⟨⟨(-142768980), (-142768978)⟩, ⟨792053, 792055⟩, ⟨393746, 393750⟩, ⟨(-2277), (-2273)⟩, ⟨(-566), (-562)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-11089903), (-11089901)⟩, ⟨(-22118281), (-22118278)⟩, ⟨(-10936269), (-10936265)⟩, ⟨122517, 122520⟩, ⟨30187, 30190⟩⟩
...
def j19 : Jet := ⟨⟨1420565862, 1420565865⟩, ⟨(-22118281), (-22118278)⟩, ⟨(-10936269), (-10936265)⟩, ⟨122517, 122520⟩, ⟨30187, 30190⟩⟩
...
def j25 : Jet := ⟨⟨918, 919⟩, ⟨1835, 1837⟩, ⟨914, 917⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851259), (-851257)⟩, ⟨1835, 1837⟩, ⟨914, 917⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-66124), (-66123)⟩, ⟨(-132105), (-132103)⟩, ⟨(-65769), (-65765)⟩, ⟨282, 286⟩, ⟨68, 72⟩⟩
...
def j30 : Jet := ⟨⟨35725270, 35725272⟩, ⟨(-132105), (-132103)⟩, ⟨(-65769), (-65765)⟩, ⟨282, 286⟩, ⟨68, 72⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2775040, 2775042⟩, ⟨5539819, 5539822⟩, ⟨2749407, 2749412⟩, ⟨(-20459), (-20454)⟩, ⟨(-5061), (-5057)⟩⟩
...
def j33 : Jet := ⟨⟨(-713052843), (-713052840)⟩, ⟨5539819, 5539822⟩, ⟨2749407, 2749412⟩, ⟨(-20459), (-20454)⟩, ⟨(-5061), (-5057)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-55387987), (-55387985)⟩, ⟨(-110345656), (-110345652)⟩, ⟨(-54313786), (-54313781)⟩, ⟨855859, 855865⟩, ⟨209993, 209998⟩⟩
...
def j36 : Jet := ⟨⟨4239579309, 4239579311⟩, ⟨(-110345656), (-110345652)⟩, ⟨(-54313786), (-54313781)⟩, ⟨855859, 855865⟩, ⟨209993, 209998⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨395920785, 395920788⟩, ⟨389756278, 389756283⟩, ⟨(-9212516), (-9212511)⟩, ⟨(-3013863), (-3013858)⟩, ⟨42559, 42563⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4351078897, 4351078900⟩, ⟨113247706, 113247712⟩, ⟨58689769, 58689778⟩, ⟨2100002, 2100012⟩, ⟨568153, 568166⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨401093292, 401093296⟩, ⟨405287703, 405287712⟩, ⟨6354208, 6354217⟩, ⟨2223365, 2223376⟩, ⟨80701, 80712⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-381028024), (-381028023)⟩, ⟨(-381028024), (-381028023)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3913939272, 3913939273⟩, ⟨(-381028024), (-381028023)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨37456822, 37456824⟩, ⟨75697050, 75697054⟩, ⟨39431122, 39431129⟩, ⟨1614472, 1614480⟩, ⟨444080, 444089⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4332424118, 4332424120⟩, ⟨75697050, 75697054⟩, ⟨39431122, 39431129⟩, ⟨1614472, 1614480⟩, ⟨444080, 444089⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4313655051, 4313655053⟩, ⟨37684556, 37684559⟩, ⟨19465540, 19465545⟩, ⟨633684, 633691⟩, ⟨171621, 171628⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3930969142, 3930969146⟩, ⟨(-348344539), (-348344533)⟩, ⟨14395468, 14395475⟩, ⟨(-1149420), (-1149411)⟩, ⟨100177, 100186⟩⟩
...
def j47 : Jet := ⟨⟨2206606611, 2206606618⟩, ⟨2206606611, 2206606618⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1133678652, 1133678660⟩, ⟨2267357304, 2267357320⟩, ⟨1133678652, 1133678660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1133678652, 1133678660⟩, ⟨2267357304, 2267357320⟩, ⟨1133678652, 1133678660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1133678660), (-1133678652)⟩, ⟨(-2267357320), (-2267357304)⟩, ⟨(-1133678660), (-1133678652)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-566839330), (-566839326)⟩, ⟨(-1133678660), (-1133678652)⟩, ⟨(-566839330), (-566839326)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3763940351, 3763940358⟩, ⟨(-993511375), (-993511365)⟩, ⟨(-365634477), (-365634469)⟩, ⟨119584504, 119584508⟩, ⟨16236537, 16236539⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3444946690, 3444946701⟩, ⟨(-1214586811), (-1214586793)⟩, ⟨(-241452344), (-241452325)⟩, ⟨134767345, 134767363⟩, ⟨4289727, 4289745⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 762056048⟩, ⟨381028023, 381028024⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2394069683⟩, ⟨1197034837, 1197034842⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1334485051⟩, ⟨0, 1334485052⟩, ⟨333621260, 333621263⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 335⟩, ⟨0, 335⟩, ⟨83, 84⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94351)⟩, ⟨0, 335⟩, ⟨83, 84⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-29421), 0⟩, ⟨(-29421), 105⟩, ⟨(-7356), (-7196)⟩, ⟨0, 54⟩, ⟨6, 7⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5083635, 5113057⟩, ⟨(-29421), 105⟩, ⟨(-7356), (-7196)⟩, ⟨0, 54⟩, ⟨6, 7⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1588673⟩, ⟨(-9142), 1588706⟩, ⟨383454, 397202⟩, ⟨(-4572), 26⟩, ⟨(-572), (-538)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141576903)⟩, ⟨(-9142), 1588706⟩, ⟨383454, 397202⟩, ⟨(-4572), 26⟩, ⟨(-572), (-538)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-44482836), 0⟩, ⟨(-44485677), 493626⟩, ⟨(-11123550), (-10380263)⟩, ⟨(-2132), 246831⟩, ⟨28186, 30863⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1387172929, 1431655766⟩, ⟨(-44485677), 493626⟩, ⟨(-11123550), (-10380263)⟩, ⟨(-2132), 246831⟩, ⟨28186, 30863⟩⟩
...
def j72 : Jet := ⟨⟨0, 3678⟩, ⟨(-11), 3678⟩, ⟨902, 920⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848498)⟩, ⟨(-11), 3678⟩, ⟨902, 920⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-264780), 0⟩, ⟨(-264784), 1143⟩, ⟨(-66199), (-64479)⟩, ⟨(-3), 572⟩, ⟨67, 72⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35526614, 35791395⟩, ⟨(-264784), 1143⟩, ⟨(-66199), (-64479)⟩, ⟨(-3), 572⟩, ⟨67, 72⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 11120710⟩, ⟨(-82271), 11121066⟩, ⟨2656769, 2780534⟩, ⟨(-41138), 267⟩, ⟨(-5144), (-4807)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-704707172)⟩, ⟨(-82271), 11121066⟩, ⟨2656769, 2780534⟩, ⟨(-41138), 267⟩, ⟨(-5144), (-4807)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-222414176), 0⟩, ⟨(-222439739), 3455416⟩, ⟨(-55629107), (-50420364)⟩, ⟨(-19173), 1727874⟩, ⟨191989, 216068⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4072553120, 4294967296⟩, ⟨(-222439739), 3455416⟩, ⟨(-55629107), (-50420364)⟩, ⟨(-19173), 1727874⟩, ⟨191989, 216068⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 798023229⟩, ⟨361817075, 399286769⟩, ⟨(-18598852), 137577⟩, ⟨(-3101394), (-2755458)⟩, ⟨(-595), 85998⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4529528169⟩, ⟨(-3843144), 247399368⟩, ⟨50221324, 75383932⟩, ⟨(-2038215), 7518096⟩, ⟨156608, 1239500⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 841605639⟩, ⟨361103002, 467060859⟩, ⟨(-19971874), 37151525⟩, ⟨(-490066), 5666238⟩, ⟨(-695203), 1025120⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-762056048), 0⟩, ⟨(-381028024), (-381028023)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3532911248, 4294967296⟩, ⟨(-381028024), (-381028023)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 164913957⟩, ⟨0, 183042630⟩, ⟨22532997, 65350840⟩, ⟨(-4535788), 10300784⟩, ⟨(-551797), 1955474⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4459881253⟩, ⟨0, 183042630⟩, ⟨22532997, 65350840⟩, ⟨(-4535788), 10300784⟩, ⟨(-551797), 1955474⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4376647590⟩, ⟨0, 91521315⟩, ⟨10099320, 32675420⟩, ⟨(-2964174), 5150392⟩, ⟨(-509944), 1029028⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3532911248, 4376647590⟩, ⟨(-388274292), (-289506708)⟩, ⟨188083, 32675420⟩, ⟨(-5862974), 4254431⟩, ⟨(-966862), 1291995⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4413213236⟩, ⟨2206606611, 2206606618⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4534714638⟩, ⟨0, 4534714638⟩, ⟨1133678652, 1133678660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4534714638⟩, ⟨0, 4534714638⟩, ⟨1133678652, 1133678660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4534714638), 0⟩, ⟨(-4534714638), 0⟩, ⟨(-1133678660), (-1133678652)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2267357319), 0⟩, ⟨(-2267357319), 0⟩, ⟨(-566839330), (-566839326)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2533327545, 4294967296⟩, ⟨(-2267357319), 0⟩, ⟨(-566839330), 264138200⟩, ⟨(-46480423), 299240301⟩, ⟨(-56923166), 43539411⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2083839238, 4376647590⟩, ⟨(-2698751477), (-170761560)⟩, ⟨(-577508359), 506810899⟩, ⟨(-94355700), 360429084⟩, ⟨(-92582924), 54966002⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨381028023, 381028024⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨381028023, 381028024⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4313655051, 4313655053⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified876
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 762056048⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4376647590⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified877
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (299453561 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(17743 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(17743 / 100000), prawitzNormalCorrection
