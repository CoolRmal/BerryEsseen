...
namespace FiniteNormalPanel149_18
...
def j2 : Jet := ⟨⟨455862278, 455862282⟩, ⟨455862278, 455862282⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨48384633, 48384634⟩, ⟨96769266, 96769268⟩, ⟨48384633, 48384634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1067), (-1066)⟩, ⟨(-2134), (-2132)⟩, ⟨(-1067), (-1064)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111989, 5111991⟩, ⟨(-2134), (-2132)⟩, ⟨(-1067), (-1064)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨57588, 57589⟩, ⟨115152, 115154⟩, ⟨57526, 57530⟩, ⟨(-50), (-46)⟩, ⟨(-13), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-143107989), (-143107987)⟩, ⟨115152, 115154⟩, ⟨57526, 57530⟩, ⟨(-50), (-46)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1612173), (-1612172)⟩, ⟨(-3223048), (-3223046)⟩, ⟨(-1608931), (-1608928)⟩, ⟨2592, 2595⟩, ⟨645, 648⟩⟩
...
def j19 : Jet := ⟨⟨1430043592, 1430043594⟩, ⟨(-3223048), (-3223046)⟩, ⟨(-1608931), (-1608928)⟩, ⟨2592, 2595⟩, ⟨645, 648⟩⟩
...
def j28 : Jet := ⟨⟨(-9599), (-9598)⟩, ⟨(-19196), (-19193)⟩, ⟨(-9593), (-9589)⟩, ⟨3, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781795, 35781797⟩, ⟨(-19196), (-19193)⟩, ⟨(-9593), (-9589)⟩, ⟨3, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨403097, 403098⟩, ⟨805977, 805979⟩, ⟨402555, 402558⟩, ⟨(-434), (-431)⟩, ⟨(-110), (-106)⟩⟩
...
def j33 : Jet := ⟨⟨(-715424786), (-715424784)⟩, ⟨805977, 805979⟩, ⟨402555, 402558⟩, ⟨(-434), (-431)⟩, ⟨(-110), (-106)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8059565), (-8059564)⟩, ⟨(-16110051), (-16110048)⟩, ⟨(-8036872), (-8036869)⟩, ⟨18143, 18146⟩, ⟨4522, 4525⟩⟩
...
def j36 : Jet := ⟨⟨4286907731, 4286907732⟩, ⟨(-16110051), (-16110048)⟩, ⟨(-8036872), (-8036869)⟩, ⟨18143, 18146⟩, ⟨4522, 4525⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨151782978, 151782981⟩, ⟨151440887, 151440892⟩, ⟨(-512861), (-512858)⟩, ⟨(-170495), (-170493)⟩, ⟨343, 345⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303042012, 4303042014⟩, ⟨16170679, 16170684⟩, ⟨8127884, 8127890⟩, ⟨42644, 42652⟩, ⟨10785, 10793⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨152068336, 152068340⟩, ⟨152297069, 152297076⟩, ⟨343590, 343596⟩, ⟨115349, 115356⟩, ⟨614, 621⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-145105471), (-145105470)⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4149861825, 4149861826⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5384157, 5384158⟩, ⟨10784510, 10784514⟩, ⟨5424696, 5424699⟩, ⟨32534, 32538⟩, ⟨8249, 8254⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300351453, 4300351454⟩, ⟨10784510, 10784514⟩, ⟨5424696, 5424699⟩, ⟨32534, 32538⟩, ⟨8249, 8254⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297658531, 4297658532⟩, ⟨5388878, 5388881⟩, ⟨2707270, 2707273⟩, ⟨12861, 12865⟩, ⟨3251, 3256⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4152462136, 4152462139⟩, ⟨(-139989581), (-139989575)⟩, ⟨2433740, 2433745⟩, ⟨(-79040), (-79034)⟩, ⟨2706, 2712⟩⟩
...
def j47 : Jet := ⟨⟨1345080663, 1345080674⟩, ⟨1345080663, 1345080674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨421246977, 421246984⟩, ⟨842493954, 842493968⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨421246977, 421246984⟩, ⟨842493954, 842493968⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-421246984), (-421246977)⟩, ⟨(-842493968), (-842493954)⟩, ⟨(-421246984), (-421246977)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-210623492), (-210623488)⟩, ⟨(-421246984), (-421246977)⟩, ⟨(-210623492), (-210623488)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4089424854, 4089424859⟩, ⟨(-401087545), (-401087537)⟩, ⟨(-180874600), (-180874593)⟩, ⟨19026127, 19026129⟩, ⟨3968492, 3968493⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3953739503, 3953739512⟩, ⟨(-521069793), (-521069777)⟩, ⟨(-159482999), (-159482984)⟩, ⟨23987714, 23987728⟩, ⟨3124146, 3124160⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 290210941⟩, ⟨145105470, 145105471⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 911724561⟩, ⟨455862278, 455862282⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 193538535⟩, ⟨0, 193538536⟩, ⟨48384633, 48384634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4267), 0⟩, ⟨(-4267), 3⟩, ⟨(-1067), (-1062)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108789, 5113057⟩, ⟨(-4267), 3⟩, ⟨(-1067), (-1062)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 230404⟩, ⟨(-193), 230405⟩, ⟨57310, 57602⟩, ⟨(-98), 2⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142935172)⟩, ⟨(-193), 230405⟩, ⟨57310, 57602⟩, ⟨(-98), 2⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6451285), 0⟩, ⟨(-6451294), 10383⟩, ⟨(-1612831), (-1597246)⟩, ⟨(-8), 5193⟩, ⟨639, 650⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425204480, 1431655766⟩, ⟨(-6451294), 10383⟩, ⟨(-1612831), (-1597246)⟩, ⟨(-8), 5193⟩, ⟨639, 650⟩⟩
...
def j72 : Jet := ⟨⟨0, 534⟩, ⟨(-1), 534⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851642)⟩, ⟨(-1), 534⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-38401), 0⟩, ⟨(-38402), 25⟩, ⟨(-9602), (-9562)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35752993, 35791395⟩, ⟨(-38402), 25⟩, ⟨(-9602), (-9562)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1612822⟩, ⟨(-1731), 1612824⟩, ⟨400608, 403208⟩, ⟨(-867), 2⟩, ⟨(-111), (-105)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714215060)⟩, ⟨(-1731), 1612824⟩, ⟨400608, 403208⟩, ⟨(-867), 2⟩, ⟨(-111), (-105)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-32256423), 0⟩, ⟨(-32256502), 72677⟩, ⟨(-8064185), (-7955089)⟩, ⟨(-60), 36341⟩, ⟨4467, 4544⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4262710873, 4294967296⟩, ⟨(-32256502), 72677⟩, ⟨(-8064185), (-7955089)⟩, ⟨(-60), 36341⟩, ⟨4467, 4544⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 303908188⟩, ⟨149899896, 151956300⟩, ⟨(-1027101), 1103⟩, ⟨(-171186), (-168426)⟩, ⟨(-1), 690⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4327467808⟩, ⟨(-73782), 32746527⟩, ⟨7954534, 8434491⟩, ⟨(-37178), 125838⟩, ⟨9596, 12411⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 306207897⟩, ⟨149894675, 155423288⟩, ⟨(-1037485), 1756505⟩, ⟨94678, 138910⟩, ⟨(-4642), 6034⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-290210941), 0⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4004756355, 4294967296⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 21830964⟩, ⟨0, 22161678⟩, ⟨5083399, 5874810⟩, ⟨(-75088), 146936⟩, ⟨5521, 11635⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4316798260⟩, ⟨0, 22161678⟩, ⟨5083399, 5874810⟩, ⟨(-75088), 146936⟩, ⟨5521, 11635⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305868943⟩, ⟨0, 11080839⟩, ⟨2521006, 2937405⟩, ⟨(-45123), 73468⟩, ⟨1562, 5195⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4004756355, 4305868943⟩, ⟨(-145473784), (-134024631)⟩, ⟨1976294, 2937405⟩, ⟨(-144364), (-11704)⟩, ⟨(-1027), 6720⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2690161337⟩, ⟨1345080663, 1345080674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1684987922⟩, ⟨0, 1684987930⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1684987922⟩, ⟨0, 1684987930⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1684987922), 0⟩, ⟨(-1684987930), 0⟩, ⟨(-421246984), (-421246977)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-842493961), 0⟩, ⟨(-842493965), 0⟩, ⟨(-210623492), (-210623488)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3529956434, 4294967296⟩, ⟨(-842493965), 0⟩, ⟨(-210623492), (-90476520)⟩, ⟨0, 41315570⟩, ⟨192367, 5164447⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3291437277, 4305868943⟩, ⟨(-990106199), (-110152435)⟩, ⟨(-209533825), (-52889709)⟩, ⟨2102762, 48544797⟩, ⟨(-1365099), 5170963⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297658531, 4297658532⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3012
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305868943⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3013
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (263631971 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(6757 / 100000), prawitzNormalCorrection
