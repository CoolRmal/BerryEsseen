...
namespace FiniteNormalPanel123_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (192423 / 800000)
def radius : Rat := (27489 / 800000)

def j0 : Jet := ⟨⟨1033063114, 1033063115⟩, ⟨147580444, 147580445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3245463489, 3245463493⟩, ⟨463637638, 463637642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2452412913, 2452412920⟩, ⟨700689398, 700689406⟩, ⟨50049242, 50049244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨613, 615⟩, ⟨175, 176⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94074), (-94071)⟩, ⟨175, 176⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-53716), (-53714)⟩, ⟨(-15249), (-15245)⟩, ⟨(-1063), (-1059)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5059340, 5059343⟩, ⟨(-15249), (-15245)⟩, ⟨(-1063), (-1059)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2888867, 2888870⟩, ⟨816682, 816688⟩, ⟨55861, 55866⟩, ⟨(-351), (-345)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140276710), (-140276706)⟩, ⟨816682, 816688⟩, ⟨55861, 55866⟩, ⟨(-351), (-345)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-80097564), (-80097561)⟩, ⟨(-22418697), (-22418690)⟩, ⟨(-1469514), (-1469507)⟩, ⟨18428, 18436⟩, ⟨584, 591⟩⟩
...
def j19 : Jet := ⟨⟨1351558201, 1351558205⟩, ⟨(-22418697), (-22418690)⟩, ⟨(-1469514), (-1469507)⟩, ⟨18428, 18436⟩, ⟨584, 591⟩⟩
...
def j25 : Jet := ⟨⟨6722, 6724⟩, ⟨1909, 1912⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845455), (-845452)⟩, ⟨1909, 1912⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-482753), (-482750)⟩, ⟨(-136840), (-136836)⟩, ⟨(-9467), (-9462)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35308641, 35308645⟩, ⟨(-136840), (-136836)⟩, ⟨(-9467), (-9462)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20161123, 20161127⟩, ⟨5682185, 5682190⟩, ⟨383720, 383727⟩, ⟨(-3117), (-3110)⟩, ⟨(-106), (-100)⟩⟩
...
def j33 : Jet := ⟨⟨(-695666760), (-695666755)⟩, ⟨5682185, 5682190⟩, ⟨383720, 383727⟩, ⟨(-3117), (-3110)⟩, ⟨(-106), (-100)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-397223549), (-397223544)⟩, ⟨(-110247934), (-110247927)⟩, ⟨(-6960500), (-6960491)⟩, ⟨127034, 127042⟩, ⟨3901, 3908⟩⟩
...
def j36 : Jet := ⟨⟨3897743747, 3897743752⟩, ⟨(-110247934), (-110247927)⟩, ⟨(-6960500), (-6960491)⟩, ⟨127034, 127042⟩, ⟨3901, 3908⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1021295970, 1021295976⟩, ⟨128958883, 128958892⟩, ⟨(-3530507), (-3530499)⟩, ⟨(-144709), (-144699)⟩, ⟨2430, 2438⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4732672347, 4732672354⟩, ⟨133863933, 133863944⟩, ⟨12237834, 12237848⟩, ⟨430942, 430956⟩, ⟨24931, 24947⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1125377415, 1125377424⟩, ⟨173932600, 173932616⟩, ⟨3039058, 3039073⟩, ⟨200426, 200444⟩, ⟨6973, 6992⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1033063115), (-1033063114)⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3261904181, 3261904182⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨294874032, 294874038⟩, ⟨91148456, 91148466⟩, ⟨8636322, 8636334⟩, ⟨351176, 351188⟩, ⟨22036, 22053⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4589841328, 4589841334⟩, ⟨91148456, 91148466⟩, ⟨8636322, 8636334⟩, ⟨351176, 351188⟩, ⟨22036, 22053⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4439957026, 4439957030⟩, ⟨44085971, 44085977⟩, ⟨3958275, 3958282⟩, ⟨130549, 130558⟩, ⟨7596, 7607⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3372019712, 3372019717⟩, ⟨(-119080447), (-119080439)⟩, ⟨1491346, 1491353⟩, ⟨(-36864), (-36855)⟩, ⟨1281, 1293⟩⟩
...
def j47 : Jet := ⟨⟨10232256520, 10232256532⟩, ⟨1461750922, 1461750934⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨24377152670, 24377152729⟩, ⟨6964900718, 6964900784⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨24377152670, 24377152729⟩, ⟨6964900718, 6964900784⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-24377152729), (-24377152670)⟩, ⟨(-6964900784), (-6964900718)⟩, ⟨(-497492914), (-497492905)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12188576365), (-12188576335)⟩, ⟨(-3482450392), (-3482450359)⟩, ⟨(-248746457), (-248746452)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨251470359, 251470368⟩, ⟨(-203897498), (-203897487)⟩, ⟨68098091, 68098098⟩, ⟨(-10532537), (-10532533)⟩, ⟨163022, 163024⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨197431772, 197431781⟩, ⟨(-167054030), (-167054018)⟩, ⟨59204952, 59204961⟩, ⟨(-10230215), (-10230205)⟩, ⟨445479, 445486⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨885482669, 1180643560⟩, ⟨147580444, 147580445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2781825847, 3709101135⟩, ⟨463637638, 463637642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1801772751, 3203151569⟩, ⟨600590912, 800787894⟩, ⟨50049242, 50049244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨450, 803⟩, ⟨150, 201⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94237), (-93883)⟩, ⟨150, 201⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-70282), (-39384)⟩, ⟨(-17509), (-12978)⟩, ⟨(-1074), (-1046)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5042774, 5073673⟩, ⟨(-17509), (-12978)⟩, ⟨(-1074), (-1046)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2115483, 3783904⟩, ⟨692102, 940532⟩, ⟨54697, 56872⟩, ⟨(-406), (-292)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141050094), (-139381672)⟩, ⟨692102, 940532⟩, ⟨54697, 56872⟩, ⟨(-406), (-292)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-105194010), (-58471713)⟩, ⟨(-26008161), (-18789129)⟩, ⟨(-1523932), (-1406438)⟩, ⟨15410, 21443⟩, ⟨551, 620⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1326461755, 1373184053⟩, ⟨(-26008161), (-18789129)⟩, ⟨(-1523932), (-1406438)⟩, ⟨15410, 21443⟩, ⟨551, 620⟩⟩
...
def j72 : Jet := ⟨⟨4930, 8795⟩, ⟨1627, 2194⟩, ⟨130, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847247), (-843381)⟩, ⟨1627, 2194⟩, ⟨130, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-631870), (-353805)⟩, ⟨(-157286), (-116297)⟩, ⟨(-9592), (-9314)⟩, ⟨34, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35159524, 35437590⟩, ⟨(-157286), (-116297)⟩, ⟨(-9592), (-9314)⟩, ⟨34, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14749698, 26429066⟩, ⟨4799263, 6558480⟩, ⟨373233, 392786⟩, ⟨(-3608), (-2618)⟩, ⟨(-109), (-96)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701078185), (-689398816)⟩, ⟨4799263, 6558480⟩, ⟨373233, 392786⟩, ⟨(-3608), (-2618)⟩, ⟨(-109), (-96)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-522858391), (-289208255)⟩, ⟨(-128701270), (-91511490)⟩, ⟨(-7341980), (-6517809)⟩, ⟨105425, 148563⟩, ⟨3594, 4172⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3772108905, 4005759041⟩, ⟨(-128701270), (-91511490)⟩, ⟨(-7341980), (-6517809)⟩, ⟨105425, 148563⟩, ⟨3594, 4172⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨859141721, 1185871319⟩, ⟨120729834, 136064304⟩, ⟨(-4123614), (-2939209)⟩, ⟨(-154528), (-133304)⟩, ⟨2019, 2851⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4605055842, 4890299973⟩, ⟨105202413, 166853035⟩, ⟨9896277, 15211303⟩, ⟨215886, 715054⟩, ⟨9750, 46679⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨921170134, 1350246948⟩, ⟨150490414, 200993730⟩, ⟨241599, 6334432⟩, ⟨(-14781), 464404⟩, ⟨(-10427), 28752⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1180643560), (-885482669)⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3114323736, 3409484627⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨197569470, 424489105⟩, ⟨64553354, 126376362⟩, ⟨5376634, 13388828⟩, ⟨7636, 884870⟩, ⟨(-7929), 70889⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4492536766, 4719456401⟩, ⟨64553354, 126376362⟩, ⟨5376634, 13388828⟩, ⟨7636, 884870⟩, ⟨(-7929), 70889⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4392641401, 4502211779⟩, ⟨30790926, 61783139⟩, ⟨2140649, 6437642⟩, ⟨(-86814), 417593⟩, ⟨(-14469), 35357⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3185148206, 3574002034⟩, ⟨(-132374817), (-101891184)⟩, ⟨(-570741), 4052396⟩, ⟨(-290122), 257944⟩, ⟨(-25836), 31052⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8770505587, 11694007465⟩, ⟨1461750922, 1461750934⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17909744813, 31839546420⟩, ⟨5969914900, 7959886610⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17909744813, 31839546420⟩, ⟨5969914900, 7959886610⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-31839546420), (-17909744813)⟩, ⟨(-7959886610), (-5969914900)⟩, ⟨(-497492914), (-497492905)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15919773210), (-8954872406)⟩, ⟨(-3979943305), (-2984957450)⟩, ⟨(-248746457), (-248746452)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨105487047, 533911731⟩, ⟨(-494750780), (-73312396)⟩, ⟨(-5446249), 223121723⟩, ⟨(-66088157), 20784852⟩, ⟨(-11276222), 15467906⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨78229205, 444287810⟩, ⟨(-428156174), (-56870990)⟩, ⟨(-2863759), 201420315⟩, ⟨(-62374105), 17561520⟩, ⟨(-10086549), 15156121⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1033063114, 1033063115⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4439957026, 4439957030⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2476
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨885482669, 1180643560⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4392641401, 4502211779⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2477
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (15132557 / 4294967296)

theorem envelope_integral : (∫ s in ((82467 / 400000) : ℝ)..(27489 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((82467 / 400000) : ℝ)..(27489 / 100000), prawitzNormalCorrection
