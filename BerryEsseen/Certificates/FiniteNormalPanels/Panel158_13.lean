...
namespace FiniteNormalPanel158_13
...
def j2 : Jet := ⟨⟨428269013, 428269017⟩, ⟨428269013, 428269017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨42704480, 42704482⟩, ⟨85408960, 85408964⟩, ⟨42704480, 42704482⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-942), (-941)⟩, ⟨(-1883), (-1881)⟩, ⟨(-942), (-939)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112114, 5112116⟩, ⟨(-1883), (-1881)⟩, ⟨(-942), (-939)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨50829, 50830⟩, ⟨101639, 101641⟩, ⟨50781, 50784⟩, ⟨(-38), (-35)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143114748), (-143114746)⟩, ⟨101639, 101641⟩, ⟨50781, 50784⟩, ⟨(-38), (-35)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1422978), (-1422977)⟩, ⟨(-2844945), (-2844943)⟩, ⟨(-1420453), (-1420450)⟩, ⟨2018, 2021⟩, ⟨502, 505⟩⟩
...
def j19 : Jet := ⟨⟨1430232787, 1430232789⟩, ⟨(-2844945), (-2844943)⟩, ⟨(-1420453), (-1420450)⟩, ⟨2018, 2021⟩, ⟨502, 505⟩⟩
...
def j28 : Jet := ⟨⟨(-8472), (-8471)⟩, ⟨(-16942), (-16940)⟩, ⟨(-8467), (-8464)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782922, 35782924⟩, ⟨(-16942), (-16940)⟩, ⟨(-8467), (-8464)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨355786, 355787⟩, ⟨711403, 711405⟩, ⟨355364, 355367⟩, ⟨(-338), (-335)⟩, ⟨(-86), (-82)⟩⟩
...
def j33 : Jet := ⟨⟨(-715472097), (-715472095)⟩, ⟨711403, 711405⟩, ⟨355364, 355367⟩, ⟨(-338), (-335)⟩, ⟨(-86), (-82)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7113877), (-7113875)⟩, ⟨(-14220680), (-14220677)⟩, ⟨(-7096198), (-7096194)⟩, ⟨14135, 14138⟩, ⟨3525, 3528⟩⟩
...
def j36 : Jet := ⟨⟨4287853419, 4287853421⟩, ⟨(-14220680), (-14220677)⟩, ⟨(-7096198), (-7096194)⟩, ⟨14135, 14138⟩, ⟨3525, 3528⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨142614446, 142614449⟩, ⟨142330764, 142330768⟩, ⟨(-425322), (-425319)⟩, ⟨(-141439), (-141436)⟩, ⟨251, 253⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302092973, 4302092976⟩, ⟨14267902, 14267907⟩, ⟨7167079, 7167086⟩, ⟨33195, 33202⟩, ⟨8382, 8390⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨142851054, 142851058⟩, ⟨143040666, 143040673⟩, ⟨284777, 284784⟩, ⟨95524, 95531⟩, ⟨449, 456⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-136322262), (-136322261)⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4158645034, 4158645035⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4751240, 4751242⟩, ⟨9515094, 9515096⟩, ⟨4782804, 4782807⟩, ⟨25322, 25326⟩, ⟨6408, 6415⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299718536, 4299718538⟩, ⟨9515094, 9515096⟩, ⟨4782804, 4782807⟩, ⟨25322, 25326⟩, ⟨6408, 6415⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297342259, 4297342261⟩, ⟨4754917, 4754919⟩, ⟨2387449, 2387452⟩, ⟨10011, 10015⟩, ⟨2526, 2532⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4160944615, 4160944619⟩, ⟨(-131793649), (-131793644)⟩, ⟨2160749, 2160754⟩, ⟨(-66085), (-66079)⟩, ⟨2127, 2135⟩⟩
...
def j47 : Jet := ⟨⟨1547954998, 1547955011⟩, ⟨1547954998, 1547955011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨557900563, 557900574⟩, ⟨1115801126, 1115801148⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨557900563, 557900574⟩, ⟨1115801126, 1115801148⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-557900574), (-557900563)⟩, ⟨(-1115801148), (-1115801126)⟩, ⟨(-557900574), (-557900563)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-278950287), (-278950281)⟩, ⟨(-557900574), (-557900563)⟩, ⟨(-278950287), (-278950281)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4024882694, 4024882700⟩, ⟨(-522817571), (-522817559)⟩, ⟨(-227452740), (-227452731)⟩, ⟨32485789, 32485792⟩, ⟨6331373, 6331374⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3899287891, 3899287902⟩, ⟨(-630009208), (-630009188)⟩, ⟨(-202287331), (-202287313)⟩, ⟨38126651, 38126665⟩, ⟨5032564, 5032580⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 272644524⟩, ⟨136322261, 136322262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 856538034⟩, ⟨428269013, 428269017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 170817926⟩, ⟨0, 170817926⟩, ⟨42704480, 42704482⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3766), 0⟩, ⟨(-3766), 2⟩, ⟨(-942), (-938)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109290, 5113057⟩, ⟨(-3766), 2⟩, ⟨(-942), (-938)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 203355⟩, ⟨(-150), 203356⟩, ⟨50613, 50840⟩, ⟨(-76), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142962221)⟩, ⟨(-150), 203356⟩, ⟨50613, 50840⟩, ⟨(-76), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5693931), 0⟩, ⟨(-5693937), 8088⟩, ⟨(-1423489), (-1411350)⟩, ⟨(-6), 4045⟩, ⟨498, 507⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425961834, 1431655766⟩, ⟨(-5693937), 8088⟩, ⟨(-1423489), (-1411350)⟩, ⟨(-6), 4045⟩, ⟨498, 507⟩⟩
...
def j72 : Jet := ⟨⟨0, 471⟩, ⟨(-1), 471⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851705)⟩, ⟨(-1), 471⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-33893), 0⟩, ⟨(-33894), 19⟩, ⟨(-8475), (-8444)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35757501, 35791395⟩, ⟨(-33894), 19⟩, ⟨(-8475), (-8444)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1423483⟩, ⟨(-1349), 1423484⟩, ⟨353846, 355872⟩, ⟨(-677), 2⟩, ⟨(-87), (-81)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714404399)⟩, ⟨(-1349), 1423484⟩, ⟨353846, 355872⟩, ⟨(-677), 2⟩, ⟨(-87), (-81)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-28469655), 0⟩, ⟨(-28469709), 56615⟩, ⟨(-7117468), (-7032490)⟩, ⟨(-41), 28309⟩, ⟨3487, 3540⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4266497641, 4294967296⟩, ⟨(-28469709), 56615⟩, ⟨(-7117468), (-7032490)⟩, ⟨(-41), 28309⟩, ⟨3487, 3540⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 285512679⟩, ⟨141053039, 142757953⟩, ⟨(-851651), 807⟩, ⟨(-141944), (-139924)⟩, ⟨(-1), 506⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4323626925⟩, ⟨(-57374), 28850925⟩, ⟨7032109, 7405291⟩, ⟨(-28884), 97587⟩, ⟨7567, 9496⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 287417860⟩, ⟨141049225, 145628451⟩, ⟨(-859242), 1452048⟩, ⟨80410, 112717⟩, ⟨(-3386), 4390⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-272644524), 0⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4022322772, 4294967296⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19233913⟩, ⟨0, 19490822⟩, ⟨4517136, 5132132⟩, ⟨(-58270), 113556⟩, ⟨4535, 8723⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314201209⟩, ⟨0, 19490822⟩, ⟨4517136, 5132132⟩, ⟨(-58270), 113556⟩, ⟨4535, 8723⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304573510⟩, ⟨0, 9745411⟩, ⟨2242495, 2566066⟩, ⟨(-34958), 56778⟩, ⟨1368, 3857⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4022322772, 4304573510⟩, ⟨(-136627164), (-126576850)⟩, ⟨1790821, 2566066⟩, ⟨(-116405), (-14398)⟩, ⟨(-522), 4967⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3095910022⟩, ⟨1547954998, 1547955011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2231602293⟩, ⟨0, 2231602294⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2231602293⟩, ⟨0, 2231602294⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2231602293), 0⟩, ⟨(-2231602294), 0⟩, ⟨(-557900574), (-557900563)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1115801147), 0⟩, ⟨(-1115801147), 0⟩, ⟨(-278950287), (-278950281)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3312327919, 4294967296⟩, ⟨(-1115801147), 0⟩, ⟨(-278950287), (-70191152)⟩, ⟨0, 72469249⟩, ⟨(-2427352), 9058657⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3102061342, 4304573510⟩, ⟨(-1254923936), (-97617514)⟩, ⟨(-278193093), (-27674611)⟩, ⟨1285550, 81493918⟩, ⟨(-4905285), 9084861⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297342259, 4297342261⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3196
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304573510⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3197
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (121680869 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1587 / 25000), prawitzNormalCorrection
