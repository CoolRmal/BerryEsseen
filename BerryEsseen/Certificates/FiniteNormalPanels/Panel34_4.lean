...
namespace FiniteNormalPanel34_4

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (39293 / 160000)
def radius : Rat := (39293 / 800000)

def j0 : Jet := ⟨⟨1054763437, 1054763438⟩, ⟨210952687, 210952688⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3313637064, 3313637069⟩, ⟨662727411, 662727415⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2556524842, 2556524851⟩, ⟨1022609934, 1022609944⟩, ⟨102260993, 102260995⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨639, 641⟩, ⟨255, 257⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94048), (-94045)⟩, ⟨255, 257⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-55981), (-55979)⟩, ⟨(-22242), (-22238)⟩, ⟨(-2166), (-2161)⟩, ⟨11, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5057075, 5057078⟩, ⟨(-22242), (-22238)⟩, ⟨(-2166), (-2161)⟩, ⟨11, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3010159, 3010162⟩, ⟨1190823, 1190829⟩, ⟨113820, 113827⟩, ⟨(-1040), (-1034)⟩, ⟨(-50), (-46)⟩⟩
...
def j16 : Jet := ⟨⟨(-140155418), (-140155414)⟩, ⟨1190823, 1190829⟩, ⟨113820, 113827⟩, ⟨(-1040), (-1034)⟩, ⟨(-50), (-46)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-83425737), (-83425733)⟩, ⟨(-32661473), (-32661467)⟩, ⟨(-2985753), (-2985743)⟩, ⟨54831, 54841⟩, ⟨2431, 2438⟩⟩
...
def j19 : Jet := ⟨⟨1348230028, 1348230033⟩, ⟨(-32661473), (-32661467)⟩, ⟨(-2985753), (-2985743)⟩, ⟨54831, 54841⟩, ⟨2431, 2438⟩⟩
...
def j22 : Jet := ⟨⟨(-65), (-63)⟩, ⟨(-26), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11770, 11773⟩, ⟨(-26), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7005, 7008⟩, ⟨2786, 2790⟩, ⟨271, 275⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845172), (-845168)⟩, ⟨2786, 2790⟩, ⟨271, 275⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-503078), (-503075)⟩, ⟨(-199574), (-199569)⟩, ⟨(-19300), (-19294)⟩, ⟨128, 133⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35288316, 35288320⟩, ⟨(-199574), (-199569)⟩, ⟨(-19300), (-19294)⟩, ⟨128, 133⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21004922, 21004926⟩, ⟨8283175, 8283181⟩, ⟨781189, 781198⟩, ⟨(-9272), (-9264)⟩, ⟨(-428), (-422)⟩⟩
...
def j33 : Jet := ⟨⟨(-694822961), (-694822956)⟩, ⟨8283175, 8283181⟩, ⟨781189, 781198⟩, ⟨(-9272), (-9264)⟩, ⟨(-428), (-422)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-413584562), (-413584557)⟩, ⟨(-160503372), (-160503363)⟩, ⟨(-14106210), (-14106199)⟩, ⟨377695, 377705⟩, ⟨16136, 16144⟩⟩
...
def j36 : Jet := ⟨⟨3881382734, 3881382739⟩, ⟨(-160503372), (-160503363)⟩, ⟨(-14106210), (-14106199)⟩, ⟨377695, 377705⟩, ⟨16136, 16144⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1040181375, 1040181382⟩, ⟨182837416, 182837425⟩, ⟨(-7343329), (-7343319)⟩, ⟨(-418409), (-418398)⟩, ⟨10335, 10344⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4752621762, 4752621769⟩, ⟨196530933, 196530946⟩, ⟨25399529, 25399548⟩, ⟨1302092, 1302109⟩, ⟨107259, 107276⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1151018924, 1151018935⟩, ⟨249916896, 249916912⟩, ⟨6391958, 6391978⟩, ⟨597596, 597618⟩, ⟨30269, 30288⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1054763438), (-1054763437)⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3240203858, 3240203859⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨308464412, 308464419⟩, ⟨133951694, 133951706⟩, ⟨17968234, 17968251⟩, ⟨1064176, 1064194⟩, ⟨95280, 95297⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4603431708, 4603431715⟩, ⟨133951694, 133951706⟩, ⟨17968234, 17968251⟩, ⟨1064176, 1064194⟩, ⟨95280, 95297⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4446525456, 4446525460⟩, ⟨64693000, 64693007⟩, ⟨8207283, 8207293⟩, ⟨394542, 394553⟩, ⟨32701, 32711⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3354542175, 3354542180⟩, ⟨(-169591045), (-169591037)⟩, ⟨3014250, 3014259⟩, ⟨(-105463), (-105451)⟩, ⟨5291, 5300⟩⟩
...
def j47 : Jet := ⟨⟨5014725093, 5014725100⟩, ⟨1002945016, 1002945022⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5855101104, 5855101121⟩, ⟨2342040434, 2342040454⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5855101104, 5855101121⟩, ⟨2342040434, 2342040454⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5855101121), (-5855101104)⟩, ⟨(-2342040454), (-2342040434)⟩, ⟨(-234204046), (-234204042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2927550561), (-2927550552)⟩, ⟨(-1171020227), (-1171020217)⟩, ⟨(-117102023), (-117102021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2172373737, 2172373749⟩, ⟨(-592296385), (-592296376)⟩, ⟨21514984, 21514988⟩, ⟨8810600, 8810602⟩, ⟨(-893854), (-893853)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1696711247, 1696711260⟩, ⟨(-548385629), (-548385616)⟩, ⟨41716068, 41716080⟩, ⟨5562867, 5562880⟩, ⟨(-1013715), (-1013705)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨843810749, 1265716125⟩, ⟨210952687, 210952688⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2650909649, 3976364480⟩, ⟨662727411, 662727415⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1636175896, 3681395780⟩, ⟨818087946, 1227131930⟩, ⟨102260993, 102260995⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨409, 923⟩, ⟨204, 308⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94278), (-93763)⟩, ⟨204, 308⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-80810), (-35719)⟩, ⟨(-26860), (-17595)⟩, ⟨(-2198), (-2121)⟩, ⟨8, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5032246, 5077338⟩, ⟨(-26860), (-17595)⟩, ⟨(-2198), (-2121)⟩, ⟨8, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1917043, 4351999⟩, ⟨935498, 1443965⟩, ⟨110256, 116731⟩, ⟨(-1265), (-807)⟩, ⟨(-52), (-44)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141248534), (-138813577)⟩, ⟨935498, 1443965⟩, ⟨110256, 116731⟩, ⟨(-1265), (-807)⟩, ⟨(-52), (-44)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-121070016), (-52881294)⟩, ⟨(-40000293), (-25202963)⟩, ⟨(-3142866), (-2792463)⟩, ⟨42189, 67426⟩, ⟨2218, 2611⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1310585749, 1378774472⟩, ⟨(-40000293), (-25202963)⟩, ⟨(-3142866), (-2792463)⟩, ⟨42189, 67426⟩, ⟨2218, 2611⟩⟩
...
def j70 : Jet := ⟨⟨(-93), (-40)⟩, ⟨(-31), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11742, 11796⟩, ⟨(-31), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4473, 10111⟩, ⟨2209, 3364⟩, ⟨267, 278⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847704), (-842065)⟩, ⟨2209, 3364⟩, ⟨267, 278⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-726603), (-320786)⟩, ⟨(-241360), (-157509)⟩, ⟨(-19663), (-18848)⟩, ⟨100, 161⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35064791, 35470609⟩, ⟨(-241360), (-157509)⟩, ⟨(-19663), (-18848)⟩, ⟨100, 161⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13357998, 30403340⟩, ⟨6472119, 10074444⟩, ⟨749060, 807357⟩, ⟨(-11327), (-7202)⟩, ⟨(-449), (-396)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702469885), (-685424542)⟩, ⟨6472119, 10074444⟩, ⟨749060, 807357⟩, ⟨(-11327), (-7202)⟩, ⟨(-449), (-396)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-602116266), (-261113772)⟩, ⟨(-198239858), (-121921659)⟩, ⟨(-15207316), (-12749181)⟩, ⟨287065, 467799⟩, ⟨14212, 17702⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3692851030, 4033853524⟩, ⟨(-198239858), (-121921659)⟩, ⟨(-15207316), (-12749181)⟩, ⟨287065, 467799⟩, ⟨14212, 17702⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨808910561, 1276496295⟩, ⟨165194588, 197193787⟩, ⟨(-9081903), (-5612443)⟩, ⟨(-458916), (-368461)⟩, ⟨7877, 12823⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4572983119, 4995258115⟩, ⟨138216641, 268155757⟩, ⟨18630668, 34965840⟩, ⟨420651, 2625835⟩, ⟨18577, 256610⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨861271829, 1484627947⟩, ⟨201919339, 309043959⟩, ⟨(-1737678), 16728140⟩, ⟨(-304966), 1812872⟩, ⟨(-74527), 175539⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1265716125), (-843810749)⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3029251171, 3451156547⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨172711248, 513186712⟩, ⟨80981960, 213652524⟩, ⟨8291519, 33801957⟩, ⟨(-460904), 3660644⟩, ⟨(-102180), 447404⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4467678544, 4808154008⟩, ⟨80981960, 213652524⟩, ⟨8291519, 33801957⟩, ⟨(-460904), 3660644⟩, ⟨(-102180), 447404⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4380471805, 4544322196⟩, ⟨38269169, 104741070⟩, ⟨2711197, 16403915⟩, ⟨(-618188), 1770910⟩, ⟨(-123153), 233279⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3089557714, 3651521937⟩, ⟨(-196208726), (-130989231)⟩, ⟨(-3232275), 11301482⟩, ⟨(-1302435), 1289826⟩, ⟨(-185939), 217812⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4011780072, 6017670117⟩, ⟨1002945016, 1002945022⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3747264702, 8431345606⟩, ⟨1873632346, 2810448544⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3747264702, 8431345606⟩, ⟨1873632346, 2810448544⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8431345606), (-3747264702)⟩, ⟨(-2810448544), (-1873632346)⟩, ⟨(-234204046), (-234204042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4215672803), (-1873632351)⟩, ⟨(-1405224272), (-936816173)⟩, ⟨(-117102023), (-117102021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1609471922, 2776538245⟩, ⟨(-908425761), (-351057231)⟩, ⟨(-37415931), 104726886⟩, ⟨(-5040454), 20592689⟩, ⟨(-3112062), 922355⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1157763505, 2360574508⟩, ⟨(-899172768), (-301616979)⟩, ⟨(-23193405), 137843329⟩, ⟨(-12301953), 20734392⟩, ⟨(-4078046), 1706298⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1054763437, 1054763438⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4446525456, 4446525460⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified666
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨843810749, 1265716125⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4380471805, 4544322196⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified667
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (84035835 / 2147483648)

theorem envelope_integral : (∫ s in ((39293 / 200000) : ℝ)..(117879 / 400000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (39293 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (117879 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((39293 / 200000) : ℝ)..(117879 / 400000), prawitzNormalCorrection
