...
namespace FiniteNormalPanel169_14
...
def j2 : Jet := ⟨⟨424271701, 424271705⟩, ⟨424271701, 424271705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨41911023, 41911025⟩, ⟨83822046, 83822050⟩, ⟨41911023, 41911025⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-924), (-923)⟩, ⟨(-1848), (-1846)⟩, ⟨(-924), (-921)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112132, 5112134⟩, ⟨(-1848), (-1846)⟩, ⟨(-924), (-921)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨49885, 49886⟩, ⟨99751, 99753⟩, ⟨49838, 49842⟩, ⟨(-38), (-34)⟩, ⟨(-10), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-143115692), (-143115690)⟩, ⟨99751, 99753⟩, ⟨49838, 49842⟩, ⟨(-38), (-34)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1396548), (-1396547)⟩, ⟨(-2792122), (-2792120)⟩, ⟨(-1394116), (-1394113)⟩, ⟨1944, 1947⟩, ⟨484, 487⟩⟩
...
def j19 : Jet := ⟨⟨1430259217, 1430259219⟩, ⟨(-2792122), (-2792120)⟩, ⟨(-1394116), (-1394113)⟩, ⟨1944, 1947⟩, ⟨484, 487⟩⟩
...
def j25 : Jet := ⟨⟨115, 116⟩, ⟨229, 231⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852062), (-852060)⟩, ⟨229, 231⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8315), (-8314)⟩, ⟨(-16628), (-16626)⟩, ⟨(-8310), (-8307)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35783079, 35783081⟩, ⟨(-16628), (-16626)⟩, ⟨(-8310), (-8307)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨349177, 349178⟩, ⟨698191, 698193⟩, ⟨348770, 348773⟩, ⟨(-326), (-323)⟩, ⟨(-83), (-79)⟩⟩
...
def j33 : Jet := ⟨⟨(-715478706), (-715478704)⟩, ⟨698191, 698193⟩, ⟨348770, 348773⟩, ⟨(-326), (-323)⟩, ⟨(-83), (-79)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-6981764), (-6981763)⟩, ⟨(-13956715), (-13956712)⟩, ⟨(-6964735), (-6964732)⟩, ⟨13615, 13618⟩, ⟨3395, 3398⟩⟩
...
def j36 : Jet := ⟨⟨4287985532, 4287985533⟩, ⟨(-13956715), (-13956712)⟩, ⟨(-6964735), (-6964732)⟩, ⟨13615, 13618⟩, ⟨3395, 3398⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨141285944, 141285946⟩, ⟨141010128, 141010131⟩, ⟨(-413532), (-413530)⟩, ⟨(-137524), (-137522)⟩, ⟨239, 242⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4301960426, 4301960428⟩, ⟨14002197, 14002202⟩, ⟨7033004, 7033010⟩, ⟨31970, 31977⟩, ⟨8071, 8079⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨141515987, 141515990⟩, ⟨141700334, 141700339⟩, ⟨276861, 276867⟩, ⟨92857, 92864⟩, ⟨426, 434⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-135049878), (-135049877)⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4159917418, 4159917419⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4662846, 4662848⟩, ⟨9337840, 9337844⟩, ⟨4693246, 4693250⟩, ⟨24386, 24390⟩, ⟨6171, 6176⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299630142, 4299630144⟩, ⟨9337840, 9337844⟩, ⟨4693246, 4693250⟩, ⟨24386, 24390⟩, ⟨6171, 6176⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297298086, 4297298088⟩, ⟨4666387, 4666390⟩, ⟨2342816, 2342820⟩, ⟨9641, 9645⟩, ⟨2434, 2439⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4162174919, 4162174923⟩, ⟨(-130603509), (-130603503)⟩, ⟨2122420, 2122425⟩, ⟨(-64331), (-64324)⟩, ⟨2053, 2060⟩⟩
...
def j47 : Jet := ⟨⟨1551683774, 1551683786⟩, ⟨1551683774, 1551683786⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨560591587, 560591597⟩, ⟨1121183174, 1121183194⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨560591587, 560591597⟩, ⟨1121183174, 1121183194⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-560591597), (-560591587)⟩, ⟨(-1121183194), (-1121183174)⟩, ⟨(-560591597), (-560591587)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-280295799), (-280295793)⟩, ⟨(-560591597), (-560591587)⟩, ⟨(-280295799), (-280295793)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4023621990, 4023621997⟩, ⟨(-525174822), (-525174810)⟩, ⟨(-228313742), (-228313733)⟩, ⟨32782503, 32782506⟩, ⟨6380325, 6380327⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3899219103, 3899219115⟩, ⟨(-631289703), (-631289683)⟩, ⟨(-203296602), (-203296583)⟩, ⟨38391815, 38391830⟩, ⟨5083153, 5083167⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 270099756⟩, ⟨135049877, 135049878⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 848543410⟩, ⟨424271701, 424271705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 167644099⟩, ⟨0, 167644100⟩, ⟨41911023, 41911025⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3696), 0⟩, ⟨(-3696), 2⟩, ⟨(-924), (-920)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109360, 5113057⟩, ⟨(-3696), 2⟩, ⟨(-924), (-920)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 199577⟩, ⟨(-145), 199578⟩, ⟨49676, 49896⟩, ⟨(-74), 2⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142965999)⟩, ⟨(-145), 199578⟩, ⟨49676, 49896⟩, ⟨(-74), 2⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5588137), 0⟩, ⟨(-5588143), 7791⟩, ⟨(-1397041), (-1385347)⟩, ⟨(-5), 3897⟩, ⟨480, 488⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1426067628, 1431655766⟩, ⟨(-5588143), 7791⟩, ⟨(-1397041), (-1385347)⟩, ⟨(-5), 3897⟩, ⟨480, 488⟩⟩
...
def j72 : Jet := ⟨⟨0, 462⟩, ⟨(-1), 462⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851714)⟩, ⟨(-1), 462⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-33263), 0⟩, ⟨(-33264), 19⟩, ⟨(-8317), (-8287)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35758131, 35791395⟩, ⟨(-33264), 19⟩, ⟨(-8317), (-8287)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1397035⟩, ⟨(-1299), 1397036⟩, ⟨347309, 349260⟩, ⟨(-651), 2⟩, ⟨(-84), (-78)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714430847)⟩, ⟨(-1299), 1397036⟩, ⟨347309, 349260⟩, ⟨(-651), 2⟩, ⟨(-84), (-78)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-27940684), 0⟩, ⟨(-27940735), 54531⟩, ⟨(-6985222), (-6903373)⟩, ⟨(-39), 27267⟩, ⟨3359, 3410⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4267026612, 4294967296⟩, ⟨(-27940735), 54531⟩, ⟨(-6985222), (-6903373)⟩, ⟨(-39), 27267⟩, ⟨3359, 3410⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 282847804⟩, ⟨139767851, 141425442⟩, ⟨(-828027), 770⟩, ⟨(-138006), (-136079)⟩, ⟨(-1), 482⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4323090937⟩, ⟨(-55249), 28307849⟩, ⟨6903013, 7262363⟩, ⟨(-27810), 93938⟩, ⟨7301, 9126⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 284699905⟩, ⟨139764212, 144215735⟩, ⟨(-835269), 1411170⟩, ⟨78439, 109256⟩, ⟨(-3229), 4185⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-270099756), 0⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4024867540, 4294967296⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 18871864⟩, ⟨0, 19119218⟩, ⟨4437385, 5029540⟩, ⟨(-56094), 109256⟩, ⟨4399, 8358⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4313839160⟩, ⟨0, 19119218⟩, ⟨4437385, 5029540⟩, ⟨(-56094), 109256⟩, ⟨4399, 8358⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304392886⟩, ⟨0, 9559609⟩, ⟨2203218, 2514770⟩, ⟨(-33645), 54628⟩, ⟨1338, 3689⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4024867540, 4304392886⟩, ⟨(-135346254), (-125490268)⟩, ⟨1764073, 2514770⟩, ⟨(-112719), (-14649)⟩, ⟨(-465), 4747⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3103367572⟩, ⟨1551683774, 1551683786⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2242366385⟩, ⟨0, 2242366386⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2242366385⟩, ⟨0, 2242366386⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2242366385), 0⟩, ⟨(-2242366386), 0⟩, ⟨(-560591597), (-560591587)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1121183193), 0⟩, ⟨(-1121183193), 0⟩, ⟨(-280295799), (-280295793)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3308179823, 4294967296⟩, ⟨(-1121183193), 0⟩, ⟨(-280295799), (-69556527)⟩, ⟨0, 73170043⟩, ⟨(-2505504), 9146256⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3100136664, 4304392886⟩, ⟨(-1258989958), (-96658331)⟩, ⟨(-279552158), (-27335948)⟩, ⟨1263111, 82152230⟩, ⟨(-4981376), 9171933⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297298086, 4297298088⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3428
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304392886⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3429
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (120532949 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(5031 / 80000), prawitzNormalCorrection
