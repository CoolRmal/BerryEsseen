...
namespace FiniteNormalPanel86_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (30177 / 160000)
def radius : Rat := (30177 / 800000)

def j0 : Jet := ⟨⟨810057675, 810057676⟩, ⟨162011535, 162011536⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2544871240, 2544871244⟩, ⟨508974248, 508974252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1507897309, 1507897314⟩, ⟨603158922, 603158930⟩, ⟨60315892, 60315894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨377, 378⟩, ⟨150, 152⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94310), (-94308)⟩, ⟨150, 152⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-33111), (-33110)⟩, ⟨(-13193), (-13190)⟩, ⟨(-1299), (-1296)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5079945, 5079947⟩, ⟨(-13193), (-13190)⟩, ⟨(-1299), (-1296)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1783490, 1783492⟩, ⟨708764, 708767⟩, ⟨69029, 69033⟩, ⟨(-368), (-364)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-141382087), (-141382084)⟩, ⟨708764, 708767⟩, ⟨69029, 69033⟩, ⟨(-368), (-364)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-49637088), (-49637086)⟩, ⟨(-19606000), (-19605996)⟩, ⟨(-1861715), (-1861711)⟩, ⟨19517, 19522⟩, ⟨910, 914⟩⟩
...
def j19 : Jet := ⟨⟨1382018677, 1382018680⟩, ⟨(-19606000), (-19605996)⟩, ⟨(-1861715), (-1861711)⟩, ⟨19517, 19522⟩, ⟨910, 914⟩⟩
...
def j25 : Jet := ⟨⟨4141, 4143⟩, ⟨1650, 1652⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848036), (-848033)⟩, ⟨1650, 1652⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-297733), (-297731)⟩, ⟨(-118514), (-118512)⟩, ⟨(-11623), (-11619)⟩, ⟨44, 48⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35493661, 35493664⟩, ⟨(-118514), (-118512)⟩, ⟨(-11623), (-11619)⟩, ⟨44, 48⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12461281, 12461283⟩, ⟨4942903, 4942907⟩, ⟨477726, 477730⟩, ⟨(-3283), (-3278)⟩, ⟨(-158), (-154)⟩⟩
...
def j33 : Jet := ⟨⟨(-703366602), (-703366599)⟩, ⟨4942903, 4942907⟩, ⟨477726, 477730⟩, ⟨(-3283), (-3278)⟩, ⟨(-158), (-154)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-246941254), (-246941252)⟩, ⟨(-97041126), (-97041120)⟩, ⟨(-9015778), (-9015774)⟩, ⟨135350, 135356⟩, ⟨6190, 6195⟩⟩
...
def j36 : Jet := ⟨⟨4048026042, 4048026044⟩, ⟨(-97041126), (-97041120)⟩, ⟨(-9015778), (-9015774)⟩, ⟨135350, 135356⟩, ⟨6190, 6195⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨818879246, 818879250⟩, ⟨152158823, 152158828⟩, ⟨(-3426517), (-3426512)⟩, ⟨(-209059), (-209053)⟩, ⟨2851, 2856⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4556972675, 4556972679⟩, ⟨109241818, 109241828⟩, ⟨12768094, 12768103⟩, ⟨397010, 397021⟩, ⟨27327, 27337⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨868833239, 868833245⟩, ⟨182269013, 182269023⟩, ⟨2668957, 2668967⟩, ⟨219065, 219079⟩, ⟨6793, 6807⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-810057676), (-810057675)⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3484909620, 3484909621⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨175757146, 175757150⟩, ⟨73742762, 73742768⟩, ⟨8814908, 8814917⟩, ⟨315156, 315168⟩, ⟨22998, 23009⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4470724442, 4470724446⟩, ⟨73742762, 73742768⟩, ⟨8814908, 8814917⟩, ⟨315156, 315168⟩, ⟨22998, 23009⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4381964772, 4381964775⟩, ⟨36139353, 36139357⟩, ⟨4170924, 4170930⟩, ⟨120050, 120058⟩, ⟨8294, 8302⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3555498828, 3555498832⟩, ⟨(-135969945), (-135969939)⟩, ⟨2021039, 2021046⟩, ⟨(-59926), (-59917)⟩, ⟨2200, 2209⟩⟩
...
def j47 : Jet := ⟨⟨6975520047, 6975520057⟩, ⟨1395104009, 1395104019⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11329045502, 11329045535⟩, ⟨4531618198, 4531618240⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11329045502, 11329045535⟩, ⟨4531618198, 4531618240⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11329045535), (-11329045502)⟩, ⟨(-4531618240), (-4531618198)⟩, ⟨(-453161827), (-453161819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5664522768), (-5664522751)⟩, ⟨(-2265809120), (-2265809099)⟩, ⟨(-226580914), (-226580909)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1148629454, 1148629468⟩, ⟨(-605959242), (-605959228)⟩, ⟨99240907, 99240915⟩, ⟨3860069, 3860073⟩, ⟨(-3126822), (-3126820)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨950868864, 950868878⟩, ⟨(-537993961), (-537993944)⟩, ⟨101878444, 101878457⟩, ⟨(-247458), (-247447)⟩, ⟨(-2654939), (-2654928)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨648046140, 972069211⟩, ⟨162011535, 162011536⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2035896992, 3053845493⟩, ⟨508974248, 508974252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨965054277, 2171372133⟩, ⟨482527138, 723790716⟩, ⟨60315892, 60315894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨241, 544⟩, ⟨120, 182⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94446), (-94142)⟩, ⟨120, 182⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-47749), (-21153)⟩, ⟨(-15891), (-10483)⟩, ⟨(-1311), (-1282)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5065307, 5091904⟩, ⟨(-15891), (-10483)⟩, ⟨(-1311), (-1282)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1138145, 2574274⟩, ⟨561038, 855737⟩, ⟨67793, 70043⟩, ⟨(-445), (-287)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142027432), (-140591302)⟩, ⟨561038, 855737⟩, ⟨67793, 70043⟩, ⟨(-445), (-287)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-71803669), (-31590051)⟩, ⟨(-23808496), (-15362396)⟩, ⟨(-1916285), (-1794756)⟩, ⟨15269, 23758⟩, ⟨867, 949⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1359852096, 1400065715⟩, ⟨(-23808496), (-15362396)⟩, ⟨(-1916285), (-1794756)⟩, ⟨15269, 23758⟩, ⟨867, 949⟩⟩
...
def j72 : Jet := ⟨⟨2646, 5972⟩, ⟨1313, 1989⟩, ⟨159, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849531), (-846204)⟩, ⟨1313, 1989⟩, ⟨159, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-429491), (-190137)⟩, ⟨(-142869), (-94062)⟩, ⟨(-11749), (-11463)⟩, ⟨33, 56⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35361903, 35601258⟩, ⟨(-142869), (-94062)⟩, ⟨(-11749), (-11463)⟩, ⟨33, 56⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7945614, 17998643⟩, ⟨3900577, 5978413⟩, ⟨466583, 486821⟩, ⟨(-3980), (-2578)⟩, ⟨(-162), (-148)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707882269), (-697829239)⟩, ⟨3900577, 5978413⟩, ⟨466583, 486821⟩, ⟨(-3980), (-2578)⟩, ⟨(-162), (-148)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-357878356), (-156798188)⟩, ⟨(-118416349), (-75376635)⟩, ⟨(-9398010), (-8546280)⟩, ⟨105183, 165419⟩, ⟨5799, 6515⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3937088940, 4138169108⟩, ⟨(-118416349), (-75376635)⟩, ⟨(-9398010), (-8546280)⟩, ⟨105183, 165419⟩, ⟨5799, 6515⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨644596012, 995487062⟩, ⟨144220476, 158632442⟩, ⟨(-4183956), (-2671265)⟩, ⟨(-219852), (-195794)⟩, ⟨2219, 3491⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4457706679, 4685376520⟩, ⟨81197002, 140922696⟩, ⟨10685199, 15422759⟩, ⟨175026, 681172⟩, ⟨12242, 48571⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨669020215, 1085976071⟩, ⟨161871276, 205715057⟩, ⟨(-234114), 6007114⟩, ⟨7947, 473802⟩, ⟨(-12222), 29880⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-972069211), (-648046140)⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3322898085, 3646921156⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨104212213, 274587429⟩, ⟨50428860, 104029492⟩, ⟨5982308, 12890867⟩, ⟨(-19954), 815046⟩, ⟨(-5912), 68902⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4399179509, 4569554725⟩, ⟨50428860, 104029492⟩, ⟨5982308, 12890867⟩, ⟨(-19954), 815046⟩, ⟨(-5912), 68902⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4346761106, 4430134096⟩, ⟨24445118, 51394965⟩, ⟨2601769, 6299897⟩, ⟨(-84347), 388036⟩, ⟨(-12075), 34260⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3362969531, 3761693314⟩, ⟨(-148197682), (-120325026)⟩, ⟨74234, 4427238⟩, ⟨(-309261), 231347⟩, ⟨(-24892), 32273⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5580416037, 8370624067⟩, ⟨1395104009, 1395104019⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7250589119, 16313825565⟩, ⟨3625294558, 5437941886⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7250589119, 16313825565⟩, ⟨3625294558, 5437941886⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16313825565), (-7250589119)⟩, ⟨(-5437941886), (-3625294558)⟩, ⟨(-453161827), (-453161819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8156912783), (-3625294559)⟩, ⟨(-2718970943), (-1812647279)⟩, ⟨(-226580914), (-226580909)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨642919782, 1846633547⟩, ⟨(-1169029381), (-271337757)⟩, ⟨(-40161446), 336115508⟩, ⟨(-61384123), 49589614⟩, ⟨(-16714181), 10774313⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨503407706, 1617350865⟩, ⟨(-1087597762), (-230469728)⟩, ⟨(-27562165), 336623378⟩, ⟨(-66698169), 44912993⟩, ⟨(-16465067), 11999125⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨810057675, 810057676⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4381964772, 4381964775⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1732
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨648046140, 972069211⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4346761106, 4430134096⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1733
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (74478963 / 4294967296)

theorem envelope_integral : (∫ s in ((30177 / 200000) : ℝ)..(90531 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((30177 / 200000) : ℝ)..(90531 / 400000), prawitzNormalCorrection
