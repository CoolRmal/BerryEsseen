...
namespace FiniteNormalPanel171_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (5649 / 25000)
def radius : Rat := (807 / 25000)

def j0 : Jet := ⟨⟨970490810, 970490811⟩, ⟨138641544, 138641545⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3048886798, 3048886803⟩, ⟨435555256, 435555260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2164326307, 2164326315⟩, ⟨618378942, 618378952⟩, ⟨44169924, 44169926⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨541, 543⟩, ⟨154, 155⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94146), (-94143)⟩, ⟨154, 155⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-47443), (-47440)⟩, ⟨(-13478), (-13475)⟩, ⟨(-942), (-938)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5065613, 5065617⟩, ⟨(-13478), (-13475)⟩, ⟨(-942), (-938)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2552671, 2552674⟩, ⟨722542, 722546⟩, ⟨49679, 49684⟩, ⟨(-274), (-270)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140612906), (-140612902)⟩, ⟨722542, 722546⟩, ⟨49679, 49684⟩, ⟨(-274), (-270)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-70857865), (-70857862)⟩, ⟨(-19881001), (-19880996)⟩, ⟨(-1317016), (-1317010)⟩, ⟨14443, 14449⟩, ⟨464, 470⟩⟩
...
def j19 : Jet := ⟨⟨1360797900, 1360797904⟩, ⟨(-19881001), (-19880996)⟩, ⟨(-1317016), (-1317010)⟩, ⟨14443, 14449⟩, ⟨464, 470⟩⟩
...
def j25 : Jet := ⟨⟨5936, 5938⟩, ⟨1687, 1690⟩, ⟨116, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846241), (-846238)⟩, ⟨1687, 1690⟩, ⟨116, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-426440), (-426437)⟩, ⟨(-120990), (-120987)⟩, ⟨(-8403), (-8397)⟩, ⟨31, 36⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35364954, 35364958⟩, ⟨(-120990), (-120987)⟩, ⟨(-8403), (-8397)⟩, ⟨31, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17821160, 17821163⟩, ⟨5030790, 5030794⟩, ⟨342042, 342048⟩, ⟨(-2440), (-2433)⟩, ⟨(-84), (-78)⟩⟩
...
def j33 : Jet := ⟨⟨(-698006723), (-698006719)⟩, ⟨5030790, 5030794⟩, ⟨342042, 342048⟩, ⟨(-2440), (-2433)⟩, ⟨(-84), (-78)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-351740588), (-351740583)⟩, ⟨(-97962189), (-97962183)⟩, ⟨(-6281698), (-6281691)⟩, ⟨99753, 99760⟩, ⟨3122, 3129⟩⟩
...
def j36 : Jet := ⟨⟨3943226708, 3943226713⟩, ⟨(-97962189), (-97962183)⟩, ⟨(-6281698), (-6281691)⟩, ⟨99753, 99760⟩, ⟨3122, 3129⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨965995423, 965995428⟩, ⟨123886333, 123886341⟩, ⟨(-2951061), (-2951054)⟩, ⟨(-123308), (-123301)⟩, ⟨1793, 1800⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4678083563, 4678083570⟩, ⟨116218342, 116218352⟩, ⟨10339571, 10339583⟩, ⟨323655, 323666⟩, ⟨17857, 17871⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1052163380, 1052163388⟩, ⟨161076198, 161076211⟩, ⟨2463470, 2463485⟩, ⟨156872, 156886⟩, ⟨4861, 4877⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-970490811), (-970490810)⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3324476485, 3324476486⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨257754646, 257754651⟩, ⟨78919564, 78919574⟩, ⟨7247897, 7247909⟩, ⟨261634, 261648⟩, ⟨15558, 15571⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4552721942, 4552721947⟩, ⟨78919564, 78919574⟩, ⟨7247897, 7247909⟩, ⟨261634, 261648⟩, ⟨15558, 15571⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4421966966, 4421966969⟩, ⟨38326490, 38326495⟩, ⟨3353774, 3353781⟩, ⟨97991, 98000⟩, ⟨5433, 5442⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3422779309, 3422779313⟩, ⟨(-113074859), (-113074852)⟩, ⟨1358775, 1358782⟩, ⟨(-32413), (-32403)⟩, ⟨1041, 1050⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨44936242937, 44936242945⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value685

def j47 : Jet := ⟨⟨10153793451, 10153793465⟩, ⟨1450541918, 1450541930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨24004727938, 24004728005⟩, ⟨6858493678, 6858493748⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨24004727938, 24004728005⟩, ⟨6858493678, 6858493748⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-24004728005), (-24004727938)⟩, ⟨(-6858493748), (-6858493678)⟩, ⟨(-489892413), (-489892404)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12002364003), (-12002363969)⟩, ⟨(-3429246874), (-3429246839)⟩, ⟨(-244946207), (-244946202)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨262612897, 262612904⟩, ⟨(-209679008), (-209678999)⟩, ⟨68730322, 68730329⟩, ⟨(-10320073), (-10320069)⟩, ⟨100093, 100095⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨209283547, 209283553⟩, ⟨(-174012941), (-174012932)⟩, ⟨60376471, 60376481⟩, ⟨(-10102157), (-10102149)⟩, ⟨374852, 374861⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨831849265, 1109132355⟩, ⟨138641544, 138641545⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2613331539, 3484442059⟩, ⟨435555256, 435555260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1590117284, 2826875184⟩, ⟨530039094, 706718802⟩, ⟨44169924, 44169926⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨397, 709⟩, ⟨132, 178⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94290), (-93977)⟩, ⟨132, 178⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-62061), (-34792)⟩, ⟨(-15468), (-11479)⟩, ⟨(-950), (-928)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5050995, 5078265⟩, ⟨(-15468), (-11479)⟩, ⟨(-950), (-928)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1870019, 3342429⟩, ⟨613158, 831359⟩, ⟨48772, 50467⟩, ⟨(-317), (-229)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141295558), (-139823147)⟩, ⟨613158, 831359⟩, ⟨48772, 50467⟩, ⟨(-317), (-229)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-92998359), (-51766448)⟩, ⟨(-23022582), (-16708295)⟩, ⟨(-1359375), (-1267942)⟩, ⟨12114, 16771⟩, ⟨441, 490⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1338657406, 1379889318⟩, ⟨(-23022582), (-16708295)⟩, ⟨(-1359375), (-1267942)⟩, ⟨12114, 16771⟩, ⟨441, 490⟩⟩
...
def j70 : Jet := ⟨⟨(-72), (-39)⟩, ⟨(-18), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11763, 11797⟩, ⟨(-18), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4354, 7765⟩, ⟨1439, 1938⟩, ⟨115, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847823), (-844411)⟩, ⟨1439, 1938⟩, ⟨115, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-558023), (-312624)⟩, ⟨(-138974), (-102932)⟩, ⟨(-8501), (-8285)⟩, ⟨26, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35233371, 35478771⟩, ⟨(-138974), (-102932)⟩, ⟨(-8501), (-8285)⟩, ⟨26, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13044381, 23351530⟩, ⟨4256656, 5799775⟩, ⟨333879, 349099⟩, ⟨(-2820), (-2053)⟩, ⟨(-86), (-76)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702783502), (-692476352)⟩, ⟨4256656, 5799775⟩, ⟨333879, 349099⟩, ⟨(-2820), (-2053)⟩, ⟨(-86), (-76)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-462560273), (-256374156)⟩, ⟨(-114064137), (-81640736)⟩, ⟨(-6578583), (-5937403)⟩, ⟨83121, 116329⟩, ⟨2911, 3310⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3832407023, 4038593140⟩, ⟨(-114064137), (-81640736)⟩, ⟨(-6578583), (-5937403)⟩, ⟨83121, 116329⟩, ⟨2911, 3310⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨814524390, 1119483350⟩, ⟨117076191, 129769030⟩, ⟨(-3437576), (-2465894)⟩, ⟨(-130486), (-114975)⟩, ⟨1496, 2099⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4567616354, 4813357236⟩, ⟨92335015, 143260212⟩, ⟨8581718, 12526313⟩, ⟨170581, 519673⟩, ⟨7990, 31501⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨866231258, 1254601703⟩, ⟨142019299, 182772550⟩, ⟨291961, 4971047⟩, ⟨5380, 338641⟩, ⟨(-6625), 18868⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1109132355), (-831849265)⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3185834941, 3463118031⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨174706008, 366481355⟩, ⟨57286376, 106779278⟩, ⟨4813841, 10682080⟩, ⟨21478, 620930⟩, ⟨(-3499), 45600⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4469673304, 4661448651⟩, ⟨57286376, 106779278⟩, ⟨4813841, 10682080⟩, ⟨21478, 620930⟩, ⟨(-3499), 45600⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4381449607, 4474457455⟩, ⟨27494183, 52335819⟩, ⟨2004293, 5149353⟩, ⟨(-50982), 291761⟩, ⟨(-8227), 22502⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3249984059, 3607844537⟩, ⟨(-124041403), (-99233774)⟩, ⟨(-202697), 3264515⟩, ⟨(-207330), 170555⟩, ⟨(-16053), 19790⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8703251522, 11604335384⟩, ⟨1450541918, 1450541930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17636126618, 31353114104⟩, ⟨5878708862, 7838278564⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17636126618, 31353114104⟩, ⟨5878708862, 7838278564⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-31353114104), (-17636126618)⟩, ⟨(-7838278564), (-5878708862)⟩, ⟨(-489892413), (-489892404)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15676557052), (-8818063309)⟩, ⟨(-3919139282), (-2939354431)⟩, ⟨(-244946207), (-244946202)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨111632959, 551192368⟩, ⟨(-502960678), (-76398447)⟩, ⟨(-5292573), 223108197⟩, ⟨(-64957040), 20732712⟩, ⟨(-11091668), 14969176⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨84472200, 463010831⟩, ⟨(-438414192), (-60389631)⟩, ⟨(-2706705), 202359404⟩, ⟨(-61417409), 17614305⟩, ⟨(-9948526), 14646760⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨970490810, 970490811⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4421966966, 4421966969⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar685 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3464
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar685 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨831849265, 1109132355⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4381449607, 4474457455⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3465
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((2421 / 12500) : ℝ)..(807 / 3125), prawitzNormalCorrection
      ((240027 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
