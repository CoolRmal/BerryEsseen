...
namespace FiniteNormalPanel52_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (16721 / 80000)
def radius : Rat := (16721 / 400000)

def j0 : Jet := ⟨⟨897701851, 897701852⟩, ⟨179540370, 179540371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2820213540, 2820213544⟩, ⟨564042707, 564042711⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1851842834, 1851842840⟩, ⟨740737132, 740737140⟩, ⟨74073713, 74073715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨463, 464⟩, ⟨185, 186⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94224), (-94222)⟩, ⟨185, 186⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-40627), (-40625)⟩, ⟨(-16172), (-16169)⟩, ⟨(-1588), (-1583)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5072429, 5072432⟩, ⟨(-16172), (-16169)⟩, ⟨(-1588), (-1583)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2187057, 2187060⟩, ⟨867850, 867853⟩, ⟨84007, 84013⟩, ⟨(-551), (-547)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-140978520), (-140978516)⟩, ⟨867850, 867853⟩, ⟨84007, 84013⟩, ⟨(-551), (-547)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-60785111), (-60785108)⟩, ⟨(-23939858), (-23939854)⟩, ⟨(-2245511), (-2245504)⟩, ⟨29217, 29223⟩, ⟨1340, 1345⟩⟩
...
def j19 : Jet := ⟨⟨1370870654, 1370870658⟩, ⟨(-23939858), (-23939854)⟩, ⟨(-2245511), (-2245504)⟩, ⟨29217, 29223⟩, ⟨1340, 1345⟩⟩
...
def j22 : Jet := ⟨⟨(-47), (-46)⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11788, 11790⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5082, 5084⟩, ⟨2024, 2027⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847095), (-847092)⟩, ⟨2024, 2027⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-365239), (-365237)⟩, ⟨(-145224), (-145220)⟩, ⟨(-14176), (-14172)⟩, ⟨67, 70⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35426155, 35426158⟩, ⟨(-145224), (-145220)⟩, ⟨(-14176), (-14172)⟩, ⟨67, 70⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15274545, 15274547⟩, ⟨6047201, 6047206⟩, ⟨579821, 579827⟩, ⟨(-4922), (-4917)⟩, ⟨(-234), (-229)⟩⟩
...
def j33 : Jet := ⟨⟨(-700553338), (-700553335)⟩, ⟨6047201, 6047206⟩, ⟨579821, 579827⟩, ⟨(-4922), (-4917)⟩, ⟨(-234), (-229)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-302054613), (-302054610)⟩, ⟨(-118214500), (-118214494)⟩, ⟨(-10789249), (-10789242)⟩, ⟨202169, 202175⟩, ⟨9049, 9055⟩⟩
...
def j36 : Jet := ⟨⟨3992912683, 3992912686⟩, ⟨(-118214500), (-118214494)⟩, ⟨(-10789249), (-10789242)⟩, ⟨202169, 202175⟩, ⟨9049, 9055⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨900157722, 900157727⟩, ⟨164311863, 164311870⟩, ⟨(-4618412), (-4618405)⟩, ⟨(-275711), (-275705)⟩, ⟨4715, 4722⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4619871638, 4619871643⟩, ⟨136776291, 136776299⟩, ⟨16532755, 16532767⟩, ⟨625130, 625143⟩, ⟨45777, 45789⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨968252571, 968252579⟩, ⟨205407838, 205407850⟩, ⟨3729848, 3729862⟩, ⟨319862, 319876⟩, ⟨12021, 12036⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-897701852), (-897701851)⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3397265444, 3397265445⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨218281764, 218281769⟩, ⟨92613820, 92613828⟩, ⟨11505382, 11505393⟩, ⟨500978, 500990⟩, ⟨39253, 39266⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4513249060, 4513249065⟩, ⟨92613820, 92613828⟩, ⟨11505382, 11505393⟩, ⟨500978, 500990⟩, ⟨39253, 39266⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4402755627, 4402755630⟩, ⟨45173223, 45173228⟩, ⟨5380109, 5380116⟩, ⟨189154, 189162⟩, ⟨13917, 13926⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3482524666, 3482524670⟩, ⟨(-148314739), (-148314732)⟩, ⟨2367244, 2367252⟩, ⟨(-75285), (-75277)⟩, ⟨3100, 3109⟩⟩
...
def j47 : Jet := ⟨⟨6682601920, 6682601930⟩, ⟨1336520382, 1336520391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10397557267, 10397557299⟩, ⟨4159022900, 4159022936⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10397557267, 10397557299⟩, ⟨4159022900, 4159022936⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10397557299), (-10397557267)⟩, ⟨(-4159022936), (-4159022900)⟩, ⟨(-415902296), (-415902289)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5198778650), (-5198778633)⟩, ⟨(-2079511468), (-2079511450)⟩, ⟨(-207951148), (-207951144)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1280190579, 1280190594⟩, ⟨(-619834993), (-619834979)⟩, ⟨88070487, 88070495⟩, ⟨5793383, 5793387⟩, ⟨(-2833325), (-2833323)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1038027756, 1038027771⟩, ⟨(-546793871), (-546793854)⟩, ⟨93520810, 93520823⟩, ⟨1292152, 1292164⟩, ⟨(-2437100), (-2437091)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨718161481, 1077242223⟩, ⟨179540370, 179540371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2256170832, 3384256255⟩, ⟨564042707, 564042711⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1185179414, 2666653693⟩, ⟨592589704, 888884568⟩, ⟨74073713, 74073715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨296, 669⟩, ⟨148, 223⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94391), (-94017)⟩, ⟨148, 223⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-58606), (-25943)⟩, ⟨(-19496), (-12832)⟩, ⟨(-1604), (-1562)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5054450, 5087114⟩, ⟨(-19496), (-12832)⟩, ⟨(-1604), (-1562)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1394755, 3158481⟩, ⟨685272, 1049287⟩, ⟨82141, 85535⟩, ⟨(-668), (-431)⟩, ⟨(-28), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141770822), (-140007095)⟩, ⟨685272, 1049287⟩, ⟨82141, 85535⟩, ⟨(-668), (-431)⟩, ⟨(-28), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-88022484), (-38634409)⟩, ⟨(-29151730), (-18665724)⟩, ⟨(-2327855), (-2144383)⟩, ⟨22736, 35682⟩, ⟨1259, 1411⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1343633281, 1393021357⟩, ⟨(-29151730), (-18665724)⟩, ⟨(-2327855), (-2144383)⟩, ⟨22736, 35682⟩, ⟨1259, 1411⟩⟩
...
def j70 : Jet := ⟨⟨(-68), (-29)⟩, ⟨(-23), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11767, 11807⟩, ⟨(-23), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3247, 7331⟩, ⟨1608, 2441⟩, ⟨195, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848930), (-844845)⟩, ⟨1608, 2441⟩, ⟨195, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-527083), (-233131)⟩, ⟨(-175252), (-115049)⟩, ⟨(-14368), (-13937)⟩, ⟨51, 86⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35264311, 35558264⟩, ⟨(-175252), (-115049)⟩, ⟨(-14368), (-13937)⟩, ⟨51, 86⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9731048, 22077369⟩, ⟨4756713, 7327376⟩, ⟨562998, 593543⟩, ⟨(-5983), (-3852)⟩, ⟨(-241), (-219)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706096835), (-693750513)⟩, ⟨4756713, 7327376⟩, ⟨562998, 593543⟩, ⟨(-5983), (-3852)⟩, ⟨(-241), (-219)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-438400482), (-191437738)⟩, ⟨(-144820899), (-91169456)⟩, ⟨(-11366137), (-10079868)⟩, ⟨156000, 248151⟩, ⟨8320, 9646⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3856566814, 4103529558⟩, ⟨(-144820899), (-91169456)⟩, ⟨(-11366137), (-10079868)⟩, ⟨156000, 248151⟩, ⟨8320, 9646⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨705818230, 1097643106⟩, ⟨153484201, 173135308⟩, ⟨(-5662647), (-3577758)⟩, ⟨(-293766), (-253498)⟩, ⟨3646, 5798⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4495335981, 4783203550⟩, ⟨99874346, 179617747⟩, ⟨13261237, 20842102⟩, ⟨250705, 1130194⟩, ⟨16036, 90131⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨738746040, 1222419181⟩, ⟨177057502, 238720701⟩, ⟨(-557965), 8822452⟩, ⟨(-48876), 780489⟩, ⟨(-24356), 58113⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1077242223), (-718161481)⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3217725073, 3576805815⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨127066325, 347920846⟩, ⟨60908742, 135887770⟩, ⟨6981477, 18290488⟩, ⟨(-89848), 1425014⟩, ⟨(-20447), 137965⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4422033621, 4642888142⟩, ⟨60908742, 135887770⟩, ⟨6981477, 18290488⟩, ⟨(-89848), 1425014⟩, ⟨(-20447), 137965⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4358037377, 4465540587⟩, ⟨29291084, 66960593⟩, ⟨2855364, 8914458⟩, ⟨(-181244), 683005⟩, ⟨(-29689), 69835⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3264976231, 3718857547⟩, ⟨(-164726322), (-126412744)⟩, ⟨(-659926), 6199432⟩, ⟨(-523586), 449439⟩, ⟨(-53277), 65735⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5346081538, 8019122321⟩, ⟨1336520382, 1336520391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6654436656, 14972482529⟩, ⟨3327218320, 4990827526⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6654436656, 14972482529⟩, ⟨3327218320, 4990827526⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14972482529), (-6654436656)⟩, ⟨(-4990827526), (-3327218320)⟩, ⟨(-415902296), (-415902289)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7486241265), (-3327218328)⟩, ⟨(-2495413763), (-1663609160)⟩, ⟨(-207951148), (-207951144)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨751576381, 1979344162⟩, ⟨(-1150016362), (-291114987)⟩, ⟨(-39454576), 297695436⟩, ⟨(-48257869), 44761687⟩, ⟨(-13708553), 7964706⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨571338231, 1713842847⟩, ⟨(-1071672215), (-243422655)⟩, ⟨(-25898109), 304727745⟩, ⟨(-55103616), 40654576⟩, ⟨(-13788349), 9347393⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨897701851, 897701852⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4402755627, 4402755630⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1026
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨718161481, 1077242223⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4358037377, 4465540587⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1027
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (699585 / 33554432)

theorem envelope_integral : (∫ s in ((16721 / 100000) : ℝ)..(50163 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (16721 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (50163 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((16721 / 100000) : ℝ)..(50163 / 200000), prawitzNormalCorrection
