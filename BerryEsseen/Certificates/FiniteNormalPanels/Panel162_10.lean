...
namespace FiniteNormalPanel162_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (22911 / 100000)
def radius : Rat := (3273 / 100000)

def j0 : Jet := ⟨⟨984019957, 984019958⟩, ⟨140574279, 140574280⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3091389867, 3091389872⟩, ⟨441627122, 441627126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2225090588, 2225090597⟩, ⟨635740164, 635740174⟩, ⟨45410011, 45410013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨556, 558⟩, ⟨159, 160⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94131), (-94128)⟩, ⟨159, 160⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48767), (-48764)⟩, ⟨(-13852), (-13849)⟩, ⟨(-968), (-964)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064289, 5064293⟩, ⟨(-13852), (-13849)⟩, ⟨(-968), (-964)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2623652, 2623655⟩, ⟨742438, 742442⟩, ⟨50990, 50996⟩, ⟨(-290), (-285)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140541925), (-140541921)⟩, ⟨742438, 742442⟩, ⟨50990, 50996⟩, ⟨(-290), (-285)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-72810454), (-72810450)⟩, ⟨(-20418353), (-20418348)⟩, ⟨(-1349617), (-1349610)⟩, ⟨15245, 15252⟩, ⟨490, 494⟩⟩
...
def j19 : Jet := ⟨⟨1358845311, 1358845316⟩, ⟨(-20418353), (-20418348)⟩, ⟨(-1349617), (-1349610)⟩, ⟨15245, 15252⟩, ⟨490, 494⟩⟩
...
def j22 : Jet := ⟨⟨(-56), (-55)⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11779, 11781⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6102, 6104⟩, ⟨1734, 1737⟩, ⟨119, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846075), (-846072)⟩, ⟨1734, 1737⟩, ⟨119, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-438326), (-438323)⟩, ⟨(-124338), (-124335)⟩, ⟨(-8629), (-8623)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35353068, 35353072⟩, ⟨(-124338), (-124335)⟩, ⟨(-8629), (-8623)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18315338, 18315341⟩, ⟨5168537, 5168541⟩, ⟨350906, 350912⟩, ⟨(-2576), (-2570)⟩, ⟨(-89), (-83)⟩⟩
...
def j33 : Jet := ⟨⟨(-697512545), (-697512541)⟩, ⟨5168537, 5168541⟩, ⟨350906, 350912⟩, ⟨(-2576), (-2570)⟩, ⟨(-89), (-83)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-361359820), (-361359815)⟩, ⟨(-100568004), (-100567997)⟩, ⟨(-6427853), (-6427845)⟩, ⟨105252, 105258⟩, ⟨3281, 3289⟩⟩
...
def j36 : Jet := ⟨⟨3933607476, 3933607481⟩, ⟨(-100568004), (-100567997)⟩, ⟨(-6427853), (-6427845)⟩, ⟨105252, 105258⟩, ⟨3281, 3289⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨978056486, 978056493⟩, ⟨125025830, 125025837⟩, ⟨(-3070919), (-3070911)⟩, ⟨(-127802), (-127794)⟩, ⟨1919, 1925⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4689523335, 4689523342⟩, ⟨119894007, 119894018⟩, ⟨10728326, 10728339⟩, ⟨344714, 344726⟩, ⟨19212, 19227⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1067905387, 1067905397⟩, ⟨163813739, 163813752⟩, ⟨2580136, 2580152⟩, ⟨165529, 165546⟩, ⟨5264, 5279⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-984019958), (-984019957)⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3310947338, 3310947339⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨265525168, 265525174⟩, ⟨81461656, 81461664⟩, ⟨7531050, 7531062⟩, ⟨279130, 279144⟩, ⟨16791, 16806⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4560492464, 4560492470⟩, ⟨81461656, 81461664⟩, ⟨7531050, 7531062⟩, ⟨279130, 279144⟩, ⟨16791, 16806⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4425739032, 4425739036⟩, ⟨39527313, 39527318⟩, ⟨3477747, 3477754⟩, ⟨104379, 104388⟩, ⟨5847, 5857⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3411757961, 3411757966⟩, ⟨(-114383230), (-114383222)⟩, ⟨1387230, 1387238⟩, ⟨(-33363), (-33354)⟩, ⟨1090, 1100⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨42459388116, 42459388123⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value656

def j47 : Jet := ⟨⟨9727870409, 9727870421⟩, ⟨1389695767, 1389695778⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨22033104369, 22033104424⟩, ⟨6295172650, 6295172710⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨22033104369, 22033104424⟩, ⟨6295172650, 6295172710⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-22033104424), (-22033104369)⟩, ⟨(-6295172710), (-6295172650)⟩, ⟨(-449655195), (-449655187)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11016552212), (-11016552184)⟩, ⟨(-3147586355), (-3147586325)⟩, ⟨(-224827598), (-224827593)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨330368357, 330368367⟩, ⟨(-242111964), (-242111953)⟩, ⟨71422711, 71422718⟩, ⟨(-8998306), (-8998302)⟩, ⟨(-220763), (-220761)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨262432003, 262432012⟩, ⟨(-201122842), (-201122830)⟩, ⟨63290083, 63290094⟩, ⟨(-9130804), (-9130794)⟩, ⟨89307, 89314⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨843445677, 1124594237⟩, ⟨140574279, 140574280⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2649762742, 3533016994⟩, ⟨441627122, 441627126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1634760431, 2906240775⟩, ⟨544920140, 726560198⟩, ⟨45410011, 45410013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨409, 729⟩, ⟨136, 183⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94278), (-93957)⟩, ⟨136, 183⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-63795), (-35762)⟩, ⟨(-15898), (-11796)⟩, ⟨(-976), (-953)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5049261, 5077295⟩, ⟨(-15898), (-11796)⟩, ⟨(-976), (-953)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1921861, 3435613⟩, ⟨629862, 854415⟩, ⟨50034, 51824⟩, ⟨(-335), (-240)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141243716), (-139729963)⟩, ⟨629862, 854415⟩, ⟨50034, 51824⟩, ⟨(-335), (-240)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-95574243), (-53184343)⟩, ⟨(-23653822), (-17149963)⟩, ⟨(-1394391), (-1297736)⟩, ⟨12780, 17710⟩, ⟨464, 515⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1336081522, 1378471423⟩, ⟨(-23653822), (-17149963)⟩, ⟨(-1394391), (-1297736)⟩, ⟨12780, 17710⟩, ⟨464, 515⟩⟩
...
def j70 : Jet := ⟨⟨(-74), (-40)⟩, ⟨(-19), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11761, 11796⟩, ⟨(-19), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4476, 7982⟩, ⟨1479, 1992⟩, ⟨118, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847701), (-844194)⟩, ⟨1479, 1992⟩, ⟨118, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-573607), (-321319)⟩, ⟨(-142840), (-105758)⟩, ⟨(-8732), (-8504)⟩, ⟨27, 43⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35217787, 35470076⟩, ⟨(-142840), (-105758)⟩, ⟨(-8732), (-8504)⟩, ⟨27, 43⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13404675, 24001250⟩, ⟨4371570, 5960060⟩, ⟨342279, 358367⟩, ⟨(-2979), (-2166)⟩, ⟨(-91), (-79)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702423208), (-691826632)⟩, ⟨4371570, 5960060⟩, ⟨342279, 358367⟩, ⟨(-2979), (-2166)⟩, ⟨(-91), (-79)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-475303030), (-263324660)⟩, ⟨(-117161842), (-83741940)⟩, ⟨(-6741692), (-6063842)⟩, ⟨87629, 122815⟩, ⟨3052, 3485⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3819664266, 4031642636⟩, ⟨(-117161842), (-83741940)⟩, ⟨(-6741692), (-6063842)⟩, ⟨87629, 122815⟩, ⟨3052, 3485⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨824290103, 1133923178⟩, ⟨117924176, 131159798⟩, ⟨(-3579208), (-2564065)⟩, ⟨(-135494), (-118869)⟩, ⟨1600, 2246⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4575490870, 4829415046⟩, ⟨95038304, 148134268⟩, ⟨8855879, 13067672⟩, ⟨179771, 557319⟩, ⟨8365, 34325⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨878128185, 1275023832⟩, ⟨143866082, 186590009⟩, ⟨284436, 5242217⟩, ⟨1848, 362831⟩, ⟨(-7320), 20693⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1124594237), (-843445677)⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3170373059, 3451521619⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨179537830, 378509465⟩, ⟨58828322, 110783946⟩, ⟨4935308, 11218651⟩, ⟨19808, 670910⟩, ⟨(-4208), 50213⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4474505126, 4673476761⟩, ⟨58828322, 110783946⟩, ⟨4935308, 11218651⟩, ⟨19808, 670910⟩, ⟨(-4208), 50213⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4383817193, 4480226540⟩, ⟨28197873, 54269306⟩, ⟨2036931, 5404950⟩, ⟨(-57208), 315555⟩, ⟨(-9301), 24833⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3235958498, 3600399653⟩, ⟨(-125823275), (-99870436)⟩, ⟨(-272655), 3420610⟩, ⟨(-222879), 186919⟩, ⟨(-17804), 21830⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8338174632, 11117566189⟩, ⟨1389695767, 1389695778⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨16187586866, 28777932275⟩, ⟨5395862268, 7194483092⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨16187586866, 28777932275⟩, ⟨5395862268, 7194483092⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-28777932275), (-16187586866)⟩, ⟨(-7194483092), (-5395862268)⟩, ⟨(-449655195), (-449655187)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-14388966138), (-8093793433)⟩, ⟨(-3597241546), (-2697931134)⟩, ⟨(-224827598), (-224827593)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨150657185, 652437986⟩, ⟨(-546448173), (-94636974)⟩, ⟨(-4429381), 220951891⟩, ⟨(-58383318), 20306466⟩, ⟨(-10034968), 12340641⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨113509688, 546927913⟩, ⟨(-477191923), (-74805579)⟩, ⟨(-1553913), 201748394⟩, ⟨(-55883727), 17215419⟩, ⟨(-9047550), 12262971⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨984019957, 984019958⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨140574279, 140574280⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4425739032, 4425739036⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar656 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3276
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar656 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨843445677, 1124594237⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4383817193, 4480226540⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3277
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((9819 / 50000) : ℝ)..(3273 / 12500),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (9819 / 50000) := by norm_num [center, radius]
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((9819 / 50000) : ℝ)..(3273 / 12500), prawitzNormalCorrection
      ((239767 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
