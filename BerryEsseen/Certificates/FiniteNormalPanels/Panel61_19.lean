...
namespace FiniteNormalPanel61_19
...
def j2 : Jet := ⟨⟨589207222, 589207226⟩, ⟨589207222, 589207226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨80830685, 80830687⟩, ⟨161661370, 161661374⟩, ⟨80830685, 80830687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1782), (-1781)⟩, ⟨(-3564), (-3562)⟩, ⟨(-1781), (-1778)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111274, 5111276⟩, ⟨(-3564), (-3562)⟩, ⟨(-1781), (-1778)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨96193, 96194⟩, ⟨192318, 192321⟩, ⟨96024, 96027⟩, ⟨(-136), (-132)⟩, ⟨(-34), (-31)⟩⟩
...
def j16 : Jet := ⟨⟨(-143069384), (-143069382)⟩, ⟨192318, 192321⟩, ⟨96024, 96027⟩, ⟨(-136), (-132)⟩, ⟨(-34), (-31)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2692546), (-2692545)⟩, ⟨(-5381473), (-5381471)⟩, ⟨(-2683501), (-2683498)⟩, ⟨7230, 7233⟩, ⟨1800, 1804⟩⟩
...
def j19 : Jet := ⟨⟨1428963219, 1428963221⟩, ⟨(-5381473), (-5381471)⟩, ⟨(-2683501), (-2683498)⟩, ⟨7230, 7233⟩, ⟨1800, 1804⟩⟩
...
def j25 : Jet := ⟨⟨222, 223⟩, ⟨444, 446⟩, ⟨220, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851955), (-851953)⟩, ⟨444, 446⟩, ⟨220, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-16034), (-16033)⟩, ⟨(-32060), (-32058)⟩, ⟨(-16014), (-16011)⟩, ⟨15, 18⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35775360, 35775362⟩, ⟨(-32060), (-32058)⟩, ⟨(-16014), (-16011)⟩, ⟨15, 18⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨673287, 673288⟩, ⟨1345970, 1345972⟩, ⟨671778, 671781⟩, ⟨(-1207), (-1204)⟩, ⟨(-302), (-299)⟩⟩
...
def j33 : Jet := ⟨⟨(-715154596), (-715154594)⟩, ⟨1345970, 1345972⟩, ⟨671778, 671781⟩, ⟨(-1207), (-1204)⟩, ⟨(-302), (-299)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-13459111), (-13459109)⟩, ⟨(-26892891), (-26892887)⟩, ⟨(-13395808), (-13395803)⟩, ⟨50592, 50596⟩, ⟨12590, 12593⟩⟩
...
def j36 : Jet := ⟨⟨4281508185, 4281508187⟩, ⟨(-26892891), (-26892887)⟩, ⟨(-13395808), (-13395803)⟩, ⟨50592, 50596⟩, ⟨12590, 12593⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨196033029, 196033031⟩, ⟨195294768, 195294772⟩, ⟨(-1106399), (-1106396)⟩, ⟨(-367147), (-367144)⟩, ⟨1237, 1241⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4308468714, 4308468717⟩, ⟨27062229, 27062236⟩, ⟨13650137, 13650145⟩, ⟨119493, 119501⟩, ⟨30465, 30473⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨196649267, 196649270⟩, ⟨197143872, 197143879⟩, ⟨743683, 743690⟩, ⟨250859, 250867⟩, ⟨2232, 2241⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-187550485), (-187550484)⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4107416811, 4107416812⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨9003778, 9003779⟩, ⟨18052848, 18052850⟩, ⟨9117227, 9117231⟩, ⟨91240, 91248⟩, ⟨23360, 23367⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303971074, 4303971075⟩, ⟨18052848, 18052850⟩, ⟨9117227, 9117231⟩, ⟨91240, 91248⟩, ⟨23360, 23367⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299466828, 4299466829⟩, ⟨9016977, 9016979⟩, ⟨4544387, 4544390⟩, ⟨36041, 36047⟩, ⟨9189, 9195⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4111719859, 4111719862⟩, ⟨(-179123741), (-179123736)⟩, ⟨3952195, 3952200⟩, ⟨(-163976), (-163969)⟩, ⟨7212, 7221⟩⟩
...
def j47 : Jet := ⟨⟨1108034063, 1108034071⟩, ⟨1108034063, 1108034071⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨285855374, 285855379⟩, ⟨571710748, 571710758⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨285855374, 285855379⟩, ⟨571710748, 571710758⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-285855379), (-285855374)⟩, ⟨(-571710758), (-571710748)⟩, ⟨(-285855379), (-285855374)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-142927690), (-142927687)⟩, ⟨(-285855379), (-285855374)⟩, ⟨(-142927690), (-142927687)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4154391613, 4154391617⟩, ⟨(-276499240), (-276499234)⟩, ⟨(-129048295), (-129048290)⟩, ⟨8997191, 8997193⟩, ⟨1997526, 1997528⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3977141924, 3977141932⟩, ⟨(-437963193), (-437963180)⟩, ⟨(-108187995), (-108187982)⟩, ⟨13582299, 13582313⟩, ⟨1435847, 1435864⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 375100969⟩, ⟨187550484, 187550485⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1178414449⟩, ⟨589207222, 589207226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 323322745⟩, ⟨0, 323322746⟩, ⟨80830685, 80830687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 82⟩, ⟨0, 82⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94604)⟩, ⟨0, 82⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-7128), 0⟩, ⟨(-7128), 7⟩, ⟨(-1782), (-1771)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5105928, 5113057⟩, ⟨(-7128), 7⟩, ⟨(-1782), (-1771)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 384909⟩, ⟨(-537), 384910⟩, ⟨95420, 96229⟩, ⟨(-270), 2⟩, ⟨(-34), (-31)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142780667)⟩, ⟨(-537), 384910⟩, ⟨95420, 96229⟩, ⟨(-270), 2⟩, ⟨(-34), (-31)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-10777425), 0⟩, ⟨(-10777466), 28976⟩, ⟨(-2694398), (-2650891)⟩, ⟨(-32), 14490⟩, ⟨1771, 1813⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1420878340, 1431655766⟩, ⟨(-10777466), 28976⟩, ⟨(-2694398), (-2650891)⟩, ⟨(-32), 14490⟩, ⟨1771, 1813⟩⟩
...
def j72 : Jet := ⟨⟨0, 892⟩, ⟨(-1), 892⟩, ⟨220, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851284)⟩, ⟨(-1), 892⟩, ⟨220, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-64152), 0⟩, ⟨(-64153), 68⟩, ⟨(-16039), (-15936)⟩, ⟨(-2), 34⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35727242, 35791395⟩, ⟨(-64153), 68⟩, ⟨(-16039), (-15936)⟩, ⟨(-2), 34⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2694357⟩, ⟨(-4830), 2694363⟩, ⟨666343, 673596⟩, ⟨(-2417), 5⟩, ⟨(-303), (-295)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713133525)⟩, ⟨(-4830), 2694363⟩, ⟨666343, 673596⟩, ⟨(-2417), 5⟩, ⟨(-303), (-295)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-53887125), 0⟩, ⟨(-53887489), 202831⟩, ⟨(-13472146), (-13167534)⟩, ⟨(-273), 101417⟩, ⟨12335, 12678⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4241080171, 4294967296⟩, ⟨(-53887489), 202831⟩, ⟨(-13472146), (-13167534)⟩, ⟨(-273), 101417⟩, ⟨12335, 12678⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 392804817⟩, ⟨191966875, 196410360⟩, ⟨(-2217778), 3976⟩, ⟨(-369642), (-359687)⟩, ⟨(-5), 2486⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4349539111⟩, ⟨(-208019), 55265577⟩, ⟨13164924, 14518885⟩, ⟨(-105367), 360316⟩, ⟨24893, 38213⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 397795792⟩, ⟨191947850, 203960373⟩, ⟨(-2255471), 3859196⟩, ⟨175902, 337329⟩, ⟨(-17080), 22523⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-375100969), 0⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3919866327, 4294967296⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 36843469⟩, ⟨0, 37781234⟩, ⟨8160606, 10400589⟩, ⟨(-214218), 429022⟩, ⟨10531, 39682⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4331810765⟩, ⟨0, 37781234⟩, ⟨8160606, 10400589⟩, ⟨(-214218), 429022⟩, ⟨10531, 39682⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4313349693⟩, ⟨0, 18890617⟩, ⟨4021547, 5200295⟩, ⟨(-129982), 214511⟩, ⟨1168, 18531⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3919866327, 4313349693⟩, ⟨(-188353199), (-168659867)⟩, ⟨2845418, 5200295⟩, ⟨(-357066), 38901⟩, ⟨(-8303), 24207⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2216068135⟩, ⟨1108034063, 1108034071⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1143421508⟩, ⟨0, 1143421512⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1143421508⟩, ⟨0, 1143421512⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1143421508), 0⟩, ⟨(-1143421512), 0⟩, ⟨(-285855379), (-285855374)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-571710754), 0⟩, ⟨(-571710756), 0⟩, ⟨(-142927690), (-142927687)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3759673648, 4294967296⟩, ⟨(-571710756), 0⟩, ⟨(-142927690), (-87063494)⟩, ⟨0, 19025360⟩, ⟨815522, 2378170⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3431322549, 4313349693⟩, ⟨(-762510869), (-147639321)⟩, ⟨(-141048634), (-49187477)⟩, ⟨2369625, 25413698⟩, ⟨(-276586), 2402407⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299466828, 4299466829⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1212
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4313349693⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1213
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (172118061 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(17467 / 200000), prawitzNormalCorrection
