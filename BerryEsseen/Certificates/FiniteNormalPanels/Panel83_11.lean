...
namespace FiniteNormalPanel83_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (34513 / 160000)
def radius : Rat := (34513 / 800000)

def j0 : Jet := ⟨⟨926451289, 926451290⟩, ⟨185290257, 185290258⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2910532563, 2910532567⟩, ⟨582106510, 582106514⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1972354902, 1972354908⟩, ⟨788941956, 788941964⟩, ⟨78894195, 78894197⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨493, 495⟩, ⟨197, 198⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94194), (-94191)⟩, ⟨197, 198⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-43257), (-43254)⟩, ⟨(-17213), (-17210)⟩, ⟨(-1687), (-1683)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5069799, 5069803⟩, ⟨(-17213), (-17210)⟩, ⟨(-1687), (-1683)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2328176, 2328179⟩, ⟨923365, 923369⟩, ⟨89190, 89195⟩, ⟨(-625), (-621)⟩, ⟨(-30), (-27)⟩⟩
...
def j16 : Jet := ⟨⟨(-140837401), (-140837397)⟩, ⟨923365, 923369⟩, ⟨89190, 89195⟩, ⟨(-625), (-621)⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-64676008), (-64676005)⟩, ⟨(-25446373), (-25446368)⟩, ⟨(-2376471), (-2376465)⟩, ⟨33056, 33062⟩, ⟨1509, 1513⟩⟩
...
def j19 : Jet := ⟨⟨1366979757, 1366979761⟩, ⟨(-25446373), (-25446368)⟩, ⟨(-2376471), (-2376465)⟩, ⟨33056, 33062⟩, ⟨1509, 1513⟩⟩
...
def j22 : Jet := ⟨⟨(-50), (-49)⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11785, 11787⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5411, 5413⟩, ⟨2154, 2158⟩, ⟨211, 214⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846766), (-846763)⟩, ⟨2154, 2158⟩, ⟨211, 214⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-388856), (-388854)⟩, ⟨(-154554), (-154549)⟩, ⟨(-15064), (-15058)⟩, ⟨76, 80⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35402538, 35402541⟩, ⟨(-154554), (-154549)⟩, ⟨(-15064), (-15058)⟩, ⟨76, 80⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16257718, 16257720⟩, ⟨6432111, 6432116⟩, ⟨614999, 615005⟩, ⟨(-5574), (-5567)⟩, ⟨(-264), (-259)⟩⟩
...
def j33 : Jet := ⟨⟨(-699570165), (-699570162)⟩, ⟨6432111, 6432116⟩, ⟨614999, 615005⟩, ⟨(-5574), (-5567)⟩, ⟨(-264), (-259)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-321259874), (-321259870)⟩, ⟨(-125550167), (-125550160)⟩, ⟨(-11386461), (-11386453)⟩, ⟨228560, 228567⟩, ⟨10150, 10158⟩⟩
...
def j36 : Jet := ⟨⟨3973707422, 3973707426⟩, ⟨(-125550167), (-125550160)⟩, ⟨(-11386461), (-11386453)⟩, ⟨228560, 228567⟩, ⟨10150, 10158⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨926349101, 926349106⟩, ⟨168025800, 168025807⟩, ⟨(-5059247), (-5059241)⟩, ⟨(-299689), (-299682)⟩, ⟨5502, 5507⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4642199864, 4642199869⟩, ⟨146671325, 146671335⟩, ⟨17936095, 17936108⟩, ⟨719953, 719965⟩, ⟨53835, 53850⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1001241074, 1001241082⟩, ⟨213244509, 213244521⟩, ⟨4138242, 4138253⟩, ⟨360278, 360293⟩, ⟨14359, 14374⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-926451290), (-926451289)⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3368516006, 3368516007⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨233408922, 233408927⟩, ⟨99422950, 99422958⟩, ⟨12516969, 12516977⟩, ⟨578900, 578912⟩, ⟨46455, 46468⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4528376218, 4528376223⟩, ⟨99422950, 99422958⟩, ⟨12516969, 12516977⟩, ⟨578900, 578912⟩, ⟨46455, 46468⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4410127862, 4410127865⟩, ⟨48413371, 48413376⟩, ⟨5829322, 5829327⟩, ⟨217898, 217906⟩, ⟨16375, 16384⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3458835718, 3458835722⟩, ⟨(-152288125), (-152288118)⟩, ⟨2483286, 2483292⟩, ⟨(-80589), (-80581)⟩, ⟨3441, 3450⟩⟩
...
def j47 : Jet := ⟨⟨5587190580, 5587190588⟩, ⟨1117438111, 1117438118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7268204022, 7268204044⟩, ⟨2907281594, 2907281620⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7268204022, 7268204044⟩, ⟨2907281594, 2907281620⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7268204044), (-7268204022)⟩, ⟨(-2907281620), (-2907281594)⟩, ⟨(-290728162), (-290728158)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3634102022), (-3634102011)⟩, ⟨(-1453640810), (-1453640797)⟩, ⟨(-145364081), (-145364079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1842850628, 1842850638⟩, ⟨(-623716716), (-623716706)⟩, ⟨43177449, 43177455⟩, ⟨9202048, 9202051⟩, ⟨(-1509289), (-1509287)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1484089897, 1484089908⟩, ⟨(-567635971), (-567635957)⟩, ⟨57952633, 57952646⟩, ⟨5484458, 5484468⟩, ⟨(-1503605), (-1503593)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨741161031, 1111741548⟩, ⟨185290257, 185290258⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2328426050, 3492639081⟩, ⟨582106510, 582106514⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1262307136, 2840191068⟩, ⟨631153564, 946730358⟩, ⟨78894195, 78894197⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨315, 712⟩, ⟨157, 238⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94372), (-93974)⟩, ⟨157, 238⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-62407), (-27619)⟩, ⟨(-20757), (-13651)⟩, ⟨(-1706), (-1659)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5050649, 5085438⟩, ⟨(-20757), (-13651)⟩, ⟨(-1706), (-1659)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1484404, 3362917⟩, ⟨728475, 1116961⟩, ⟨87070, 90922⟩, ⟨(-758), (-486)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141681173), (-139802659)⟩, ⟨728475, 1116961⟩, ⟨87070, 90922⟩, ⟨(-758), (-486)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-93691425), (-41088530)⟩, ⟨(-31016374), (-19805637)⟩, ⟨(-2469900), (-2261697)⟩, ⟨25674, 40418⟩, ⟨1409, 1593⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1337964340, 1390567236⟩, ⟨(-31016374), (-19805637)⟩, ⟨(-2469900), (-2261697)⟩, ⟨25674, 40418⟩, ⟨1409, 1593⟩⟩
...
def j70 : Jet := ⟨⟨(-72), (-31)⟩, ⟨(-24), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11763, 11805⟩, ⟨(-24), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3457, 7807⟩, ⟨1712, 2599⟩, ⟨208, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848720), (-844369)⟩, ⟨1712, 2599⟩, ⟨208, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-561245), (-248163)⟩, ⟨(-186579), (-122362)⟩, ⟨(-15279), (-14794)⟩, ⟨59, 96⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35230149, 35543232⟩, ⟨(-186579), (-122362)⟩, ⟨(-15279), (-14794)⟩, ⟨59, 96⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10354274, 23504154⟩, ⟨5053754, 7798756⟩, ⟨595910, 630565⟩, ⟨(-6779), (-4357)⟩, ⟨(-273), (-246)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705473609), (-692323728)⟩, ⟨5053754, 7798756⟩, ⟨595910, 630565⟩, ⟨(-6779), (-4357)⟩, ⟨(-273), (-246)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-466518068), (-203476562)⟩, ⟨(-154020706), (-96581091)⟩, ⟨(-12041038), (-10581239)⟩, ⟨175919, 280971⟩, ⟨9270, 10871⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3828449228, 4091490734⟩, ⟨(-154020706), (-96581091)⟩, ⟨(-12041038), (-10581239)⟩, ⟨175919, 280971⟩, ⟨9270, 10871⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨725349183, 1130800106⟩, ⟨156114984, 177729477⟩, ⟨(-6212226), (-3910433)⟩, ⟨(-320834), (-273664)⟩, ⟨4242, 6774⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4508563082, 4818333215⟩, ⟨106426231, 193844307⟩, ⟨14172081, 22952839⟩, ⟨278886, 1325906⟩, ⟨17117, 109726⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨761421990, 1268594459⟩, ⟨181852474, 250423097⟩, ⟨(-707373), 9959678⟩, ⟨(-78076), 914731⟩, ⟨(-30201), 71674⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1111741548), (-741161031)⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3183225748, 3553806265⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨134986696, 374701783⟩, ⟨64478474, 147933772⟩, ⟨7281912, 20484746⟩, ⟨(-128614), 1701786⟩, ⟨(-28589), 172108⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4429953992, 4669669079⟩, ⟨64478474, 147933772⟩, ⟨7281912, 20484746⟩, ⟨(-128614), 1701786⟩, ⟨(-28589), 172108⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4361938504, 4478401052⟩, ⟨30918729, 72831233⟩, ⟨2899604, 9975536⟩, ⟨(-229882), 817277⟩, ⟨(-39129), 87609⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3232861626, 3705585775⟩, ⟨(-170288327), (-127916366)⟩, ⟨(-992983), 6920236⟩, ⟨(-620571), 551152⟩, ⟨(-67636), 82409⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4469752462, 6704628705⟩, ⟨1117438111, 1117438118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4651650570, 10466213821⟩, ⟨2325825274, 3488737942⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4651650570, 10466213821⟩, ⟨2325825274, 3488737942⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10466213821), (-4651650570)⟩, ⟨(-3488737942), (-2325825274)⟩, ⟨(-290728162), (-290728158)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5233106911), (-2325825285)⟩, ⟨(-1744368971), (-1162912637)⟩, ⟨(-145364081), (-145364079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1269999220, 2499074703⟩, ⟨(-1014980574), (-343867144)⟩, ⟨(-38028689), 163130007⟩, ⟨(-14325842), 28049846⟩, ⟨(-5608644), 2098129⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨955940164, 2156136481⟩, ⟨(-974782936), (-296656177)⟩, ⟨(-23146598), 185013229⟩, ⟨(-20824266), 26263806⟩, ⟨(-6181999), 2835654⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨926451289, 926451290⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4410127862, 4410127865⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1672
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨741161031, 1111741548⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4361938504, 4478401052⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1673
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (4055209 / 134217728)

theorem envelope_integral : (∫ s in ((34513 / 200000) : ℝ)..(103539 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((34513 / 200000) : ℝ)..(103539 / 400000), prawitzNormalCorrection
