...
namespace FiniteNormalPanel121_9
...
def j2 : Jet := ⟨⟨470181764, 470181768⟩, ⟨470181764, 470181768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨51472077, 51472079⟩, ⟨102944154, 102944158⟩, ⟨51472077, 51472079⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1135), (-1134)⟩, ⟨(-2270), (-2268)⟩, ⟨(-1135), (-1132)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111921, 5111923⟩, ⟨(-2270), (-2268)⟩, ⟨(-1135), (-1132)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨61262, 61263⟩, ⟨122497, 122499⟩, ⟨61193, 61196⟩, ⟨(-56), (-53)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-143104315), (-143104313)⟩, ⟨122497, 122499⟩, ⟨61193, 61196⟩, ⟨(-56), (-53)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1715002), (-1715001)⟩, ⟨(-3428536), (-3428534)⟩, ⟨(-1711333), (-1711330)⟩, ⟨2933, 2936⟩, ⟨730, 733⟩⟩
...
def j19 : Jet := ⟨⟨1429940763, 1429940765⟩, ⟨(-3428536), (-3428534)⟩, ⟨(-1711333), (-1711330)⟩, ⟨2933, 2936⟩, ⟨730, 733⟩⟩
...
def j25 : Jet := ⟨⟨141, 142⟩, ⟨282, 284⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852036), (-852034)⟩, ⟨282, 284⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10212), (-10211)⟩, ⟨(-20420), (-20418)⟩, ⟨(-10205), (-10202)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781182, 35781184⟩, ⟨(-20420), (-20418)⟩, ⟨(-10205), (-10202)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨428811, 428812⟩, ⟨857378, 857380⟩, ⟨428198, 428201⟩, ⟨(-490), (-487)⟩, ⟨(-124), (-120)⟩⟩
...
def j33 : Jet := ⟨⟨(-715399072), (-715399070)⟩, ⟨857378, 857380⟩, ⟨428198, 428201⟩, ⟨(-490), (-487)⟩, ⟨(-124), (-120)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8573541), (-8573540)⟩, ⟨(-17136807), (-17136804)⟩, ⟨(-8547860), (-8547857)⟩, ⟨20532, 20535⟩, ⟨5117, 5120⟩⟩
...
def j36 : Jet := ⟨⟨4286393755, 4286393756⟩, ⟨(-17136807), (-17136804)⟩, ⟨(-8547860), (-8547857)⟩, ⟨20532, 20535⟩, ⟨5117, 5120⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨156539508, 156539511⟩, ⟨156164176, 156164181⟩, ⟨(-562677), (-562673)⟩, ⟨(-187024), (-187021)⟩, ⟨400, 403⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303557984, 4303557986⟩, ⟨17205425, 17205430⟩, ⟨8650871, 8650877⟩, ⟨48277, 48284⟩, ⟨12218, 12227⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨156852614, 156852618⟩, ⟨157103620, 157103627⟩, ⟨377081, 377090⟩, ⟨126648, 126656⟩, ⟨716, 724⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-149663505), (-149663504)⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4145303791, 4145303792⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5728272, 5728273⟩, ⟨11474878, 11474880⟩, ⟨5774162, 5774166⟩, ⟨36836, 36840⟩, ⟨9349, 9354⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300695568, 4300695569⟩, ⟨11474878, 11474880⟩, ⟨5774162, 5774166⟩, ⟨36836, 36840⟩, ⟨9349, 9354⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297830477, 4297830479⟩, ⟨5733616, 5733618⟩, ⟨2881332, 2881336⟩, ⟨14561, 14565⟩, ⟨3685, 3690⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4148067200, 4148067204⟩, ⟨(-144229457), (-144229452)⟩, ⟨2581132, 2581138⟩, ⟨(-86351), (-86345)⟩, ⟨3048, 3055⟩⟩
...
def j47 : Jet := ⟨⟨1613564646, 1613564658⟩, ⟨1613564646, 1613564658⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨606195737, 606195747⟩, ⟨1212391474, 1212391494⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨606195737, 606195747⟩, ⟨1212391474, 1212391494⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-606195747), (-606195737)⟩, ⟨(-1212391494), (-1212391474)⟩, ⟨(-606195747), (-606195737)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-303097874), (-303097868)⟩, ⟨(-606195747), (-606195737)⟩, ⟨(-303097874), (-303097868)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4002317097, 4002317104⟩, ⟨(-564890823), (-564890811)⟩, ⟨(-242580801), (-242580792)⟩, ⟨37989100, 37989104⟩, ⟨7219065, 7219067⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3865426470, 3865426481⟩, ⟨(-679971911), (-679971893)⟩, ⟨(-212908972), (-212908954)⟩, ⟨44415928, 44415943⟩, ⟨5564850, 5564865⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 299327009⟩, ⟨149663504, 149663505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 940363533⟩, ⟨470181764, 470181768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 205888314⟩, ⟨0, 205888316⟩, ⟨51472077, 51472079⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 52⟩, ⟨0, 52⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94634)⟩, ⟨0, 52⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4540), 0⟩, ⟨(-4540), 3⟩, ⟨(-1135), (-1130)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108516, 5113057⟩, ⟨(-4540), 3⟩, ⟨(-1135), (-1130)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 245106⟩, ⟨(-218), 245107⟩, ⟨60948, 61278⟩, ⟨(-110), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142920470)⟩, ⟨(-218), 245107⟩, ⟨60948, 61278⟩, ⟨(-110), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6862944), 0⟩, ⟨(-6862955), 11750⟩, ⟨(-1715747), (-1698110)⟩, ⟨(-9), 5877⟩, ⟨723, 736⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424792821, 1431655766⟩, ⟨(-6862955), 11750⟩, ⟨(-1715747), (-1698110)⟩, ⟨(-9), 5877⟩, ⟨723, 736⟩⟩
...
def j72 : Jet := ⟨⟨0, 568⟩, ⟨(-1), 568⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851608)⟩, ⟨(-1), 568⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-40851), 0⟩, ⟨(-40852), 28⟩, ⟨(-10214), (-10170)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35750543, 35791395⟩, ⟨(-40852), 28⟩, ⟨(-10214), (-10170)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1715736⟩, ⟨(-1959), 1715739⟩, ⟨425995, 428937⟩, ⟨(-981), 2⟩, ⟨(-125), (-119)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714112146)⟩, ⟨(-1959), 1715739⟩, ⟨425995, 428937⟩, ⟨(-981), 2⟩, ⟨(-125), (-119)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-34314720), 0⟩, ⟨(-34314814), 82248⟩, ⟨(-8578774), (-8455307)⟩, ⟨(-72), 41125⟩, ⟨5051, 5142⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4260652576, 4294967296⟩, ⟨(-34314814), 82248⟩, ⟨(-8578774), (-8455307)⟩, ⟨(-72), 41125⟩, ⟨5051, 5142⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 313454512⟩, ⟨154473336, 156729830⟩, ⟨(-1126962), 1287⟩, ⟨(-187830), (-184609)⟩, ⟨(-1), 806⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4329558383⟩, ⟨(-83579), 34869774⟩, ⟨8454639, 8998354⟩, ⟨(-42134), 142756⟩, ⟨10789, 14179⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 315979033⟩, ⟨154467236, 160536971⟩, ⟨(-1139089), 1930466⟩, ⟨102511, 154196⟩, ⟨(-5427), 7065⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-299327009), 0⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3995640287, 4294967296⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 23246452⟩, ⟨0, 23621284⟩, ⟨5387762, 6284588⟩, ⟨(-85154), 167004⟩, ⟨6060, 13436⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4318213748⟩, ⟨0, 23621284⟩, ⟨5387762, 6284588⟩, ⟨(-85154), 167004⟩, ⟨6060, 13436⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306574837⟩, ⟨0, 11810642⟩, ⟨2670424, 3142294⟩, ⟨(-51218), 83502⟩, ⟨1646, 6029⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3995640287, 4306574837⟩, ⟨(-150067985), (-137852862)⟩, ⟨2072758, 3142294⟩, ⟨(-160716), (-9552)⟩, ⟨(-1379), 7814⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3227129305⟩, ⟨1613564646, 1613564658⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2424782969⟩, ⟨0, 2424782978⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2424782969⟩, ⟨0, 2424782978⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2424782969), 0⟩, ⟨(-2424782978), 0⟩, ⟨(-606195747), (-606195737)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1212391485), 0⟩, ⟨(-1212391489), 0⟩, ⟨(-303097874), (-303097868)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3238667728, 4294967296⟩, ⟨(-1212391489), 0⟩, ⟨(-303097874), (-57436228)⟩, ⟨0, 85559041⟩, ⟨(-4011292), 10694881⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3012956876, 4306574837⟩, ⟨(-1365736073), (-103949479)⟩, ⟨(-302354038), (-7929584)⟩, ⟨795765, 96373440⟩, ⟨(-7234736), 10749249⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297830477, 4297830479⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2434
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306574837⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2435
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (66148753 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(27877 / 400000), prawitzNormalCorrection
