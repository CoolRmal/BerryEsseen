...
namespace FiniteNormalPanel111_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (33543 / 400000)
def radius : Rat := (33543 / 400000)

def j0 : Jet := ⟨⟨360165220, 360165221⟩, ⟨360165220, 360165221⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1131492409, 1131492413⟩, ⟨1131492409, 1131492413⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨298087268, 298087272⟩, ⟨596174536, 596174544⟩, ⟨298087268, 298087272⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨74, 75⟩, ⟨149, 150⟩, ⟨74, 75⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94613), (-94611)⟩, ⟨149, 150⟩, ⟨74, 75⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-6567), (-6566)⟩, ⟨(-13124), (-13121)⟩, ⟨(-6542), (-6539)⟩, ⟨20, 22⟩, ⟨5, 6⟩⟩
...
def j13 : Jet := ⟨⟨5106489, 5106491⟩, ⟨(-13124), (-13121)⟩, ⟨(-6542), (-6539)⟩, ⟨20, 22⟩, ⟨5, 6⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨354409, 354411⟩, ⟨707908, 707911⟩, ⟨352132, 352137⟩, ⟨(-1819), (-1815)⟩, ⟨(-453), (-448)⟩⟩
...
def j16 : Jet := ⟨⟨(-142811168), (-142811165)⟩, ⟨707908, 707911⟩, ⟨352132, 352137⟩, ⟨(-1819), (-1815)⟩, ⟨(-453), (-448)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-9911646), (-9911644)⟩, ⟨(-19774160), (-19774157)⟩, ⟨(-9788944), (-9788940)⟩, ⟨97882, 97887⟩, ⟨24154, 24158⟩⟩
...
def j19 : Jet := ⟨⟨1421744119, 1421744122⟩, ⟨(-19774160), (-19774157)⟩, ⟨(-9788944), (-9788940)⟩, ⟨97882, 97887⟩, ⟨24154, 24158⟩⟩
...
def j22 : Jet := ⟨⟨(-8), (-7)⟩, ⟨(-15), (-14)⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11827, 11829⟩, ⟨(-15), (-14)⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨820, 821⟩, ⟨1639, 1642⟩, ⟨816, 820⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851357), (-851355)⟩, ⟨1639, 1642⟩, ⟨816, 820⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-59088), (-59087)⟩, ⟨(-118062), (-118060)⟩, ⟨(-58805), (-58802)⟩, ⟨225, 228⟩, ⟨54, 57⟩⟩
...
def j30 : Jet := ⟨⟨35732306, 35732308⟩, ⟨(-118062), (-118060)⟩, ⟨(-58805), (-58802)⟩, ⟨225, 228⟩, ⟨54, 57⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2479959, 2479960⟩, ⟨4951725, 4951727⟩, ⟨2459489, 2459492⟩, ⟨(-16342), (-16339)⟩, ⟨(-4048), (-4045)⟩⟩
...
def j33 : Jet := ⟨⟨(-713347924), (-713347922)⟩, ⟨4951725, 4951727⟩, ⟨2459489, 2459492⟩, ⟨(-16342), (-16339)⟩, ⟨(-4048), (-4045)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-49509094), (-49509092)⟩, ⟨(-98674519), (-98674516)⟩, ⟨(-48651059), (-48651055)⟩, ⟨683929, 683933⟩, ⟨168148, 168152⟩⟩
...
def j36 : Jet := ⟨⟨4245458202, 4245458204⟩, ⟨(-98674519), (-98674516)⟩, ⟨(-48651059), (-48651055)⟩, ⟨683929, 683933⟩, ⟨168148, 168152⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨374552951, 374552954⟩, ⟨369343525, 369343530⟩, ⟨(-7788286), (-7788282)⟩, ⟨(-2553074), (-2553070)⟩, ⟨32149, 32153⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4345053746, 4345053749⟩, ⟨100989351, 100989356⟩, ⟨52139606, 52139614⟩, ⟨1669161, 1669170⟩, ⟨447925, 447934⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨378920860, 378920864⟩, ⟨382457702, 382457710⟩, ⟨5352375, 5352384⟩, ⟨1863303, 1863312⟩, ⟨60543, 60554⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-360165221), (-360165220)⟩, ⟨(-360165221), (-360165220)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3934802075, 3934802076⟩, ⟨(-360165221), (-360165220)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨33430060, 33430062⟩, ⟨67484192, 67484196⟩, ⟨35001464, 35001469⟩, ⟨1282010, 1282018⟩, ⟨349198, 349205⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4328397356, 4328397358⟩, ⟨67484192, 67484196⟩, ⟨35001464, 35001469⟩, ⟨1282010, 1282018⟩, ⟨349198, 349205⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4311649926, 4311649928⟩, ⟨33611541, 33611544⟩, ⟨17302008, 17302012⟩, ⟨503645, 503652⟩, ⟨135281, 135287⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3950085741, 3950085745⟩, ⟨(-330771224), (-330771219)⟩, ⟨13032523, 13032530⟩, ⟨(-989494), (-989485)⟩, ⟨81701, 81709⟩⟩
...
def j47 : Jet := ⟨⟨2303764200, 2303764208⟩, ⟨2303764200, 2303764208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1235708941, 1235708950⟩, ⟨2471417882, 2471417900⟩, ⟨1235708941, 1235708950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1235708941, 1235708950⟩, ⟨2471417882, 2471417900⟩, ⟨1235708941, 1235708950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1235708950), (-1235708941)⟩, ⟨(-2471417900), (-2471417882)⟩, ⟨(-1235708950), (-1235708941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-617854475), (-617854470)⟩, ⟨(-1235708950), (-1235708941)⟩, ⟨(-617854475), (-617854470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3719497153, 3719497162⟩, ⟨(-1070139914), (-1070139903)⟩, ⟨(-381124496), (-381124486)⟩, ⟨139181531, 139181535⟩, ⟨17402406, 17402408⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3420825271, 3420825284⟩, ⟨(-1270660909), (-1270660891)⟩, ⟨(-256818843), (-256818823)⟩, ⟨153253073, 153253090⟩, ⟨4446949, 4446966⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 720330441⟩, ⟨360165220, 360165221⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2262984822⟩, ⟨1131492409, 1131492413⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1192349081⟩, ⟨0, 1192349084⟩, ⟨298087268, 298087272⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 299⟩, ⟨0, 299⟩, ⟨74, 75⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94387)⟩, ⟨0, 299⟩, ⟨74, 75⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-26287), 0⟩, ⟨(-26287), 84⟩, ⟨(-6572), (-6445)⟩, ⟨0, 42⟩, ⟨5, 6⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5086769, 5113057⟩, ⟨(-26287), 84⟩, ⟨(-6572), (-6445)⟩, ⟨0, 42⟩, ⟨5, 6⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1419464⟩, ⟨(-7298), 1419488⟩, ⟨343918, 354890⟩, ⟨(-3650), 18⟩, ⟨(-457), (-433)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141746112)⟩, ⟨(-7298), 1419488⟩, ⟨343918, 354890⟩, ⟨(-3650), 18⟩, ⟨(-457), (-433)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-39744970), 0⟩, ⟨(-39746997), 394072⟩, ⟨(-9938270), (-9345130)⟩, ⟨(-1521), 197046⟩, ⟨22728, 24636⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1391910795, 1431655766⟩, ⟨(-39746997), 394072⟩, ⟨(-9938270), (-9345130)⟩, ⟨(-1521), 197046⟩, ⟨22728, 24636⟩⟩
...
def j70 : Jet := ⟨⟨(-30), 0⟩, ⟨(-30), 0⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11805, 11836⟩, ⟨(-30), 0⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 3286⟩, ⟨(-9), 3286⟩, ⟨807, 822⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848890)⟩, ⟨(-9), 3286⟩, ⟨807, 822⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-236578), 0⟩, ⟨(-236581), 913⟩, ⟨(-59148), (-57774)⟩, ⟨(-3), 458⟩, ⟨53, 58⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35554816, 35791395⟩, ⟨(-236581), 913⟩, ⟨(-59148), (-57774)⟩, ⟨(-3), 458⟩, ⟨53, 58⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 9936243⟩, ⟨(-65679), 9936497⟩, ⟨2385541, 2484315⟩, ⟨(-32842), 192⟩, ⟨(-4107), (-3864)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-705891639)⟩, ⟨(-65679), 9936497⟩, ⟨2385541, 2484315⟩, ⟨(-32842), 192⟩, ⟨(-4107), (-3864)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-198724847), 0⟩, ⟨(-198743082), 2758525⟩, ⟨(-49699447), (-45543387)⟩, ⟨(-13677), 1379371⟩, ⟨155306, 172476⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4096242449, 4294967296⟩, ⟨(-198743082), 2758525⟩, ⟨(-49699447), (-45543387)⟩, ⟨(-13677), 1379371⟩, ⟨155306, 172476⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 754328275⟩, ⟨345751094, 377371772⟩, ⟨(-15707590), 103817⟩, ⟨(-2619001), (-2358115)⟩, ⟨(-401), 64893⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4503333068⟩, ⟨(-3032672), 218494464⟩, ⟨45403054, 65239652⟩, ⟨(-1597186), 5831340⟩, ⟨156525, 912658⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 790923710⟩, ⟨345218463, 434053907⟩, ⟨(-16736090), 30764678⟩, ⟨(-170644), 4409339⟩, ⟨(-512586), 744124⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-720330441), 0⟩, ⟨(-360165221), (-360165220)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3574636855, 4294967296⟩, ⟨(-360165221), (-360165220)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 145649611⟩, ⟨0, 159863164⟩, ⟨21583829, 55196654⟩, ⟨(-3445584), 7842194⟩, ⟨(-343160), 1385657⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4440616907⟩, ⟨0, 159863164⟩, ⟨21583829, 55196654⟩, ⟨(-3445584), 7842194⟩, ⟨(-343160), 1385657⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4367184951⟩, ⟨0, 79931582⟩, ⟨9881969, 27598327⟩, ⟨(-2236412), 3921097⟩, ⟨(-333224), 723082⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3574636855, 4367184951⟩, ⟨(-366221214), (-280233638)⟩, ⟨1521751, 27598327⟩, ⟨(-4550739), 3092420⟩, ⟨(-662038), 910622⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4607528408⟩, ⟨2303764200, 2303764208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4942835782⟩, ⟨0, 4942835790⟩, ⟨1235708941, 1235708950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4942835782⟩, ⟨0, 4942835790⟩, ⟨1235708941, 1235708950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4942835782), 0⟩, ⟨(-4942835790), 0⟩, ⟨(-1235708950), (-1235708941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2471417891), 0⟩, ⟨(-2471417895), 0⟩, ⟨(-617854475), (-617854470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2415779766, 4294967296⟩, ⟨(-2471417895), 0⟩, ⟨(-617854475), 363530797⟩, ⟨(-69727851), 355526947⟩, ⟨(-77292435), 54471601⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2010617262, 4367184951⟩, ⟨(-2879194724), (-157622329)⟩, ⟨(-627387444), 607973385⟩, ⟨(-122329078), 417280289⟩, ⟨(-115318624), 67198205⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨360165220, 360165221⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨360165220, 360165221⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4311649926, 4311649928⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2230
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 720330441⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4367184951⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2231
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (280810143 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(33543 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(33543 / 200000), prawitzNormalCorrection
