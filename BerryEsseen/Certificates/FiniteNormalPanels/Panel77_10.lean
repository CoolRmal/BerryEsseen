...
namespace FiniteNormalPanel77_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (92919 / 800000)
def radius : Rat := (30973 / 800000)

def j0 : Jet := ⟨⟨498855082, 498855083⟩, ⟨166285027, 166285028⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1567199460, 1567199465⟩, ⟨522399819, 522399823⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨571858637, 571858642⟩, ⟨381239090, 381239096⟩, ⟨63539848, 63539850⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨143, 144⟩, ⟨95, 96⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94544), (-94542)⟩, ⟨95, 96⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12589), (-12587)⟩, ⟨(-8381), (-8378)⟩, ⟨(-1390), (-1386)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100467, 5100470⟩, ⟨(-8381), (-8378)⟩, ⟨(-1390), (-1386)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨679107, 679109⟩, ⟨451622, 451624⟩, ⟨74526, 74530⟩, ⟨(-248), (-245)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-142486470), (-142486467)⟩, ⟨451622, 451624⟩, ⟨74526, 74530⟩, ⟨(-248), (-245)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18971535), (-18971533)⟩, ⟨(-12587559), (-12587556)⟩, ⟨(-2057940), (-2057935)⟩, ⟨13262, 13266⟩, ⟨1076, 1080⟩⟩
...
def j19 : Jet := ⟨⟨1412684230, 1412684233⟩, ⟨(-12587559), (-12587556)⟩, ⟨(-2057940), (-2057935)⟩, ⟨13262, 13266⟩, ⟨1076, 1080⟩⟩
...
def j25 : Jet := ⟨⟨1573, 1575⟩, ⟨1047, 1049⟩, ⟨172, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850604), (-850601)⟩, ⟨1047, 1049⟩, ⟨172, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-113255), (-113254)⟩, ⟨(-75365), (-75362)⟩, ⟨(-12470), (-12465)⟩, ⟨29, 32⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35678139, 35678141⟩, ⟨(-75365), (-75362)⟩, ⟨(-12470), (-12465)⟩, ⟨29, 32⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4750409, 4750410⟩, ⟨3156904, 3156906⟩, ⟨519472, 519476⟩, ⟨(-2219), (-2215)⟩, ⟨(-183), (-180)⟩⟩
...
def j33 : Jet := ⟨⟨(-711077474), (-711077472)⟩, ⟨3156904, 3156906⟩, ⟨519472, 519476⟩, ⟨(-2219), (-2215)⟩, ⟨(-183), (-180)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-94677275), (-94677273)⟩, ⟨(-62697855), (-62697851)⟩, ⟨(-10170314), (-10170308)⟩, ⟨92517, 92521⟩, ⟨7463, 7467⟩⟩
...
def j36 : Jet := ⟨⟨4200290021, 4200290023⟩, ⟨(-62697855), (-62697851)⟩, ⟨(-10170314), (-10170308)⟩, ⟨92517, 92521⟩, ⟨7463, 7467⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨515477257, 515477261⟩, ⟨167232651, 167232655⟩, ⟨(-2281960), (-2281957)⟩, ⟨(-245470), (-245467)⟩, ⟨2005, 2009⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4391778656, 4391778659⟩, ⟨65556206, 65556213⟩, ⟨11612524, 11612534⟩, ⟨235333, 235341⟩, ⟨22376, 22386⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨527096450, 527096455⟩, ⟨178870166, 178870174⟩, ⟨1612879, 1612886⟩, ⟨194564, 194573⟩, ⟨3981, 3991⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-498855083), (-498855082)⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3796112213, 3796112214⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨64687493, 64687495⟩, ⟨43903398, 43903402⟩, ⟨7845186, 7845192⟩, ⟨182094, 182100⟩, ⟨17785, 17794⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4359654789, 4359654791⟩, ⟨43903398, 43903402⟩, ⟨7845186, 7845192⟩, ⟨182094, 182100⟩, ⟨17785, 17794⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4327190166, 4327190168⟩, ⟨21788233, 21788236⟩, ⟨3838528, 3838533⟩, ⟨71041, 71045⟩, ⟨6765, 6772⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3824592436, 3824592440⟩, ⟨(-148275021), (-148275015)⟩, ⟨2549128, 2549135⟩, ⟨(-85825), (-85819)⟩, ⟨3228, 3236⟩⟩
...
def j47 : Jet := ⟨⟨4045717539, 4045717549⟩, ⟨1348572510, 1348572519⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3810932488, 3810932508⟩, ⟨2540621652, 2540621678⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3810932488, 3810932508⟩, ⟨2540621652, 2540621678⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3810932508), (-3810932488)⟩, ⟨(-2540621678), (-2540621652)⟩, ⟨(-423436947), (-423436941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1905466254), (-1905466244)⟩, ⟨(-1270310839), (-1270310826)⟩, ⟨(-211718474), (-211718470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2756034869, 2756034883⟩, ⟨(-815144970), (-815144956)⟩, ⟨(-15310890), (-15310882)⟩, ⟨28297620, 28297623⟩, ⟨(-1715007), (-1715005)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2454200320, 2454200336⟩, ⟨(-821018690), (-821018671)⟩, ⟨16142893, 16142909⟩, ⟨25188231, 25188242⟩, ⟨(-2494832), (-2494819)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨332570055, 665140111⟩, ⟨166285027, 166285028⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1044799641, 2089599287⟩, ⟨522399819, 522399823⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨254159395, 1016637586⟩, ⟨254159394, 508318794⟩, ⟨63539848, 63539850⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨63, 255⟩, ⟨63, 128⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94624), (-94431)⟩, ⟨63, 128⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-22398), (-5588)⟩, ⟨(-11196), (-5557)⟩, ⟨(-1397), (-1377)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5090658, 5107469⟩, ⟨(-11196), (-5557)⟩, ⟨(-1397), (-1377)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨301245, 1208961⟩, ⟨298594, 604153⟩, ⟨73654, 75152⟩, ⟨(-332), (-162)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142864332), (-141956615)⟩, ⟨298594, 604153⟩, ⟨73654, 75152⟩, ⟨(-332), (-162)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-33816614), (-8400438)⟩, ⟨(-16890638), (-8257432)⟩, ⟨(-2091512), (-2010817)⟩, ⟨8696, 17824⟩, ⟨1044, 1102⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1397839151, 1423255328⟩, ⟨(-16890638), (-8257432)⟩, ⟨(-2091512), (-2010817)⟩, ⟨8696, 17824⟩, ⟨1044, 1102⟩⟩
...
def j70 : Jet := ⟨⟨(-26), (-6)⟩, ⟨(-13), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11809, 11830⟩, ⟨(-13), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨698, 2801⟩, ⟨694, 1401⟩, ⟨171, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851479), (-849375)⟩, ⟨694, 1401⟩, ⟨171, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-201549), (-50262)⟩, ⟨(-100734), (-49930)⟩, ⟨(-12546), (-12357)⟩, ⟨19, 42⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35589845, 35741133⟩, ⟨(-100734), (-49930)⟩, ⟨(-12546), (-12357)⟩, ⟨19, 42⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2106068, 8460083⟩, ⟨2082223, 4227088⟩, ⟨511624, 525071⟩, ⟨(-2975), (-1459)⟩, ⟨(-185), (-176)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713721815), (-707367799)⟩, ⟨2082223, 4227088⟩, ⟨511624, 525071⟩, ⟨(-2975), (-1459)⟩, ⟨(-185), (-176)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-168941083), (-41859264)⟩, ⟨(-84347325), (-40858693)⟩, ⟨(-10405326), (-9840242)⟩, ⟨60374, 124594⟩, ⟨7171, 7672⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4126026213, 4253108032⟩, ⟨(-84347325), (-40858693)⟩, ⟨(-10405326), (-9840242)⟩, ⟨60374, 124594⟩, ⟨7171, 7672⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨340040270, 692446092⟩, ⟨161802454, 171102810⟩, ⟨(-3071989), (-1493511)⟩, ⟨(-252278), (-235905)⟩, ⟨1310, 2705⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4337238540, 4470825711⟩, ⟨41666915, 91395976⟩, ⟨10435175, 13143254⟩, ⟨65678, 435711⟩, ⟨14029, 33907⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨343386960, 720798456⟩, ⟨166693764, 192843758⟩, ⟨(-801903), 4251812⟩, ⟨70338, 341133⟩, ⟨(-9864), 19725⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-665140111), (-332570055)⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3629827185, 3962397241⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨27454133, 120967258⟩, ⟨26654668, 64727610⟩, ⟨6200463, 10085785⟩, ⟨(-60766), 496316⟩, ⟨1352, 41466⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4322421429, 4415934554⟩, ⟨26654668, 64727610⟩, ⟨6200463, 10085785⟩, ⟨(-60766), 496316⟩, ⟨1352, 41466⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308672495, 4355030941⟩, ⟨13143526, 32260861⟩, ⟨2937983, 5006805⟩, ⟨(-67775), 238408⟩, ⟨(-4021), 20175⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3641409928, 4017810008⟩, ⟨(-157502415), (-137052818)⟩, ⟨1233972, 4110248⟩, ⟨(-256373), 106201⟩, ⟨(-12941), 21237⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2697145029, 5394290068⟩, ⟨1348572510, 1348572519⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1693747776, 6774991131⟩, ⟨1693747770, 3387495572⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1693747776, 6774991131⟩, ⟨1693747770, 3387495572⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6774991131), (-1693747776)⟩, ⟨(-3387495572), (-1693747770)⟩, ⟨(-423436947), (-423436941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3387495566), (-846873888)⟩, ⟨(-1693747786), (-846873885)⟩, ⟨(-211718474), (-211718470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1951759290, 3526358489⟩, ⟨(-1390641994), (-384844367)⟩, ⟨(-135888792), 177993186⟩, ⟨(-10750431), 63563585⟩, ⟨(-10653724), 4409164⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1654763625, 3298800073⟩, ⟨(-1430219343), (-388564124)⟩, ⟨(-114278619), 220878630⟩, ⟨(-18125284), 64421641⟩, ⟨(-12472255), 4789657⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨498855082, 498855083⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4327190166, 4327190168⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1550
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨332570055, 665140111⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308672495, 4355030941⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1551
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (190525705 / 4294967296)

theorem envelope_integral : (∫ s in ((30973 / 400000) : ℝ)..(30973 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (30973 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (30973 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((30973 / 400000) : ℝ)..(30973 / 200000), prawitzNormalCorrection
