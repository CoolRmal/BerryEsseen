...
namespace FiniteNormalPanel8_5

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (19719 / 50000)
def radius : Rat := (2817 / 50000)

def j0 : Jet := ⟨⟨1693849202, 1693849203⟩, ⟨241978457, 241978458⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5321384209, 5321384213⟩, ⟨760197742, 760197747⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨6593095580, 6593095591⟩, ⟨1883741588, 1883741604⟩, ⟨134552970, 134552973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1650, 1652⟩, ⟨471, 472⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93037), (-93034)⟩, ⟨471, 472⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-142819), (-142814)⟩, ⟨(-40083), (-40079)⟩, ⟨(-2659), (-2653)⟩, ⟨28, 30⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨4970237, 4970243⟩, ⟨(-40083), (-40079)⟩, ⟨(-2659), (-2653)⟩, ⟨28, 30⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨7629685, 7629695⟩, ⟨2118378, 2118389⟩, ⟨134044, 134059⟩, ⟨(-2381), (-2371)⟩, ⟨(-71), (-65)⟩⟩
...
def j16 : Jet := ⟨⟨(-135535892), (-135535881)⟩, ⟨2118378, 2118389⟩, ⟨134044, 134059⟩, ⟨(-2381), (-2371)⟩, ⟨(-71), (-65)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-208057718), (-208057700)⟩, ⟨(-56193195), (-56193170)⟩, ⟨(-3111204), (-3111173)⟩, ⟨121498, 121525⟩, ⟨3045, 3062⟩⟩
...
def j19 : Jet := ⟨⟨1223598047, 1223598066⟩, ⟨(-56193195), (-56193170)⟩, ⟨(-3111204), (-3111173)⟩, ⟨121498, 121525⟩, ⟨3045, 3062⟩⟩
...
def j22 : Jet := ⟨⟨(-166), (-164)⟩, ⟨(-48), (-46)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11669, 11672⟩, ⟨(-48), (-46)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨17912, 17918⟩, ⟨5043, 5050⟩, ⟨336, 342⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-834265), (-834258)⟩, ⟨5043, 5050⟩, ⟨336, 342⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1280660), (-1280648)⟩, ⟨(-358162), (-358146)⟩, ⟨(-23410), (-23395)⟩, ⟨297, 306⟩, ⟨6, 11⟩⟩
...
def j30 : Jet := ⟨⟨34510734, 34510747⟩, ⟨(-358162), (-358146)⟩, ⟨(-23410), (-23395)⟩, ⟨297, 306⟩, ⟨6, 11⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨52976554, 52976575⟩, ⟨14586352, 14586385⟩, ⟨888129, 888162⟩, ⟨(-21034), (-21010)⟩, ⟨(-595), (-580)⟩⟩
...
def j33 : Jet := ⟨⟨(-662851329), (-662851307)⟩, ⟨14586352, 14586385⟩, ⟨888129, 888162⟩, ⟨(-21034), (-21010)⟩, ⟨(-595), (-580)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-1017526299), (-1017526262)⟩, ⟨(-268330662), (-268330597)⟩, ⟨(-13005032), (-13004961)⟩, ⟨814199, 814255⟩, ⟨17683, 17721⟩⟩
...
def j36 : Jet := ⟨⟨3277440997, 3277441034⟩, ⟨(-268330662), (-268330597)⟩, ⟨(-13005032), (-13004961)⟩, ⟨814199, 814255⟩, ⟨17683, 17721⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1516015111, 1516015137⟩, ⟨146951267, 146951305⟩, ⟨(-13800770), (-13800726)⟩, ⟨(-400142), (-400101)⟩, ⟨25276, 25304⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5628398461, 5628398526⟩, ⟨460808142, 460808268⟩, ⟨60060888, 60061034⟩, ⟨5347467, 5347591⟩, ⟨531212, 531303⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1986682675, 1986682733⟩, ⟨355227940, 355228042⟩, ⟨18881009, 18881130⟩, ⟨1937427, 1937540⟩, ⟨167666, 167749⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1693849203), (-1693849202)⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2601118093, 2601118094⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨918961141, 918961196⟩, ⟨328628902, 328629008⟩, ⟨46847394, 46847528⟩, ⟨4915572, 4915702⟩, ⟨558592, 558696⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5213928437, 5213928492⟩, ⟨328628902, 328629008⟩, ⟨46847394, 46847528⟩, ⟨4915572, 4915702⟩, ⟨558592, 558696⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4732193161, 4732193187⟩, ⟨149132794, 149132844⟩, ⟨18909563, 18909627⟩, ⟨1634772, 1634836⟩, ⟨164188, 164240⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2865910821, 2865910839⟩, ⟨(-176293963), (-176293929)⟩, ⟨3049864, 3049908⟩, ⟨(-75319), (-75274)⟩, ⟨7328, 7365⟩⟩
...
def j47 : Jet := ⟨⟨6090444571, 6090444577⟩, ⟨870063508, 870063513⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8636506989, 8636507007⟩, ⟨2467573418, 2467573438⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8636506989, 8636507007⟩, ⟨2467573418, 2467573438⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8636507007), (-8636506989)⟩, ⟨(-2467573438), (-2467573418)⟩, ⟨(-176255246), (-176255243)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4318253504), (-4318253494)⟩, ⟨(-1233786719), (-1233786709)⟩, ⟨(-88127623), (-88127621)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1571486827, 1571486842⟩, ⟨(-451430585), (-451430576)⟩, ⟨32594688, 32594692⟩, ⟨3054125, 3054127⟩, ⟨(-553737), (-553736)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1048608939, 1048608957⟩, ⟨(-365731179), (-365731156)⟩, ⟨41395136, 41395161⟩, ⟨351902, 351929⟩, ⟨(-461119), (-461095)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1451870744, 1935827660⟩, ⟨241978457, 241978458⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4561186463, 6081581956⟩, ⟨760197742, 760197747⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4843906953, 8611390155⟩, ⟨1614635646, 2152847546⟩, ⟨134552970, 134552973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1212, 2158⟩, ⟨404, 540⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93475), (-92528)⟩, ⟨404, 540⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-187417), (-104354)⟩, ⟨(-46400), (-33701)⟩, ⟨(-2741), (-2558)⟩, ⟨24, 35⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4925639, 5008703⟩, ⟨(-46400), (-33701)⟩, ⟨(-2741), (-2558)⟩, ⟨24, 35⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨5555184, 10042428⟩, ⟨1758696, 2472599⟩, ⟨125556, 141360⟩, ⟨(-2801), (-1945)⟩, ⟨(-76), (-57)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-137610393), (-133123148)⟩, ⟨1758696, 2472599⟩, ⟨125556, 141360⟩, ⟨(-2801), (-1945)⟩, ⟨(-76), (-57)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-275908221), (-150137614)⟩, ⟨(-66993582), (-45088321)⟩, ⟨(-3508306), (-2647674)⟩, ⟨96681, 146126⟩, ⟨2376, 3634⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1155747544, 1281518152⟩, ⟨(-66993582), (-45088321)⟩, ⟨(-3508306), (-2647674)⟩, ⟨96681, 146126⟩, ⟨2376, 3634⟩⟩
...
def j70 : Jet := ⟨⟨(-217), (-120)⟩, ⟨(-55), (-40)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11618, 11716⟩, ⟨(-55), (-40)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨13102, 23491⟩, ⟨4256, 5828⟩, ⟨326, 350⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-839075), (-828685)⟩, ⟨4256, 5828⟩, ⟨326, 350⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1682342), (-934599)⟩, ⟨(-415787), (-299847)⟩, ⟨(-24321), (-22337)⟩, ⟨244, 357⟩, ⟨4, 11⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34109052, 34856796⟩, ⟨(-415787), (-299847)⟩, ⟨(-24321), (-22337)⟩, ⟨244, 357⟩, ⟨4, 11⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨38468529, 69887720⟩, ⟨11989190, 17133760⟩, ⟨811393, 954082⟩, ⟨(-24942), (-17074)⟩, ⟨(-667), (-497)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-677359354), (-645940162)⟩, ⟨11989190, 17133760⟩, ⟨811393, 954082⟩, ⟨(-24942), (-17074)⟩, ⟨(-667), (-497)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1358102466), (-728497757)⟩, ⟨(-326004090), (-208479472)⟩, ⟨(-15798079), (-9734838)⟩, ⟨630620, 995745⟩, ⟨11578, 22912⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨2936864830, 3566469539⟩, ⟨(-326004090), (-208479472)⟩, ⟨(-15798079), (-9734838)⟩, ⟨630620, 995745⟩, ⟨11578, 22912⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1227385376, 1814602332⟩, ⟨109702746, 178942219⟩, ⟨(-16825373), (-10792299)⟩, ⟨(-518288), (-261719)⟩, ⟨19635, 31010⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5172270188, 6281100814⟩, ⟨302347221, 697228057⟩, ⟨31791774, 111182690⟩, ⟨930008, 14981672⟩, ⟨(-114003), 2175796⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1478094791, 2653733871⟩, ⟨218513607, 556266350⟩, ⟨(-7798148), 63026143⟩, ⟨(-2411526), 9887004⟩, ⟨(-520459), 1490491⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1935827660), (-1451870744)⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2359139636, 2843096552⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨508680057, 1639664047⟩, ⟨150401062, 687401210⟩, ⟨1480749, 149929309⟩, ⟨(-4999990), 28543548⟩, ⟨(-1382250), 5327782⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4803647353, 5934631343⟩, ⟨150401062, 687401210⟩, ⟨1480749, 149929309⟩, ⟨(-4999990), 28543548⟩, ⟨(-1382250), 5327782⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4542192012, 5048667897⟩, ⟨63974067, 324993496⟩, ⟨(-10926554), 70433923⟩, ⟨(-7403467), 14276778⟩, ⟨(-2221107), 3133335⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2494935227, 3342016202⟩, ⟨(-249302275), (-40774402)⟩, ⟨(-25543076), 43020142⟩, ⟨(-8869048), 10066259⟩, ⟨(-2274638), 2491255⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5220381058, 6960508086⟩, ⟨870063508, 870063513⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6345188801, 11280335676⟩, ⟨2115062928, 2820083928⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6345188801, 11280335676⟩, ⟨2115062928, 2820083928⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11280335676), (-6345188801)⟩, ⟨(-2820083928), (-2115062928)⟩, ⟨(-176255246), (-176255243)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5640167838), (-3172594400)⟩, ⟨(-1410041964), (-1057531464)⟩, ⟨(-88127623), (-88127621)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1155161347, 2051901136⟩, ⟨(-673641150), (-284430447)⟩, ⟨(-7085525), 86875988⟩, ⟨(-5616375), 9990273⟩, ⟨(-1711251), 533659⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨671030193, 1596633076⟩, ⟨(-643279232), (-176191458)⟩, ⟨(-15016256), 127254593⟩, ⟨(-20397583), 17000347⟩, ⟨(-5093658), 4192689⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1693849202, 1693849203⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4732193161, 4732193187⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified158
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1451870744, 1935827660⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4542192012, 5048667897⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified159
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (59903273 / 2147483648)

theorem envelope_integral : (∫ s in ((8451 / 25000) : ℝ)..(2817 / 6250),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((8451 / 25000) : ℝ)..(2817 / 6250), prawitzNormalCorrection
