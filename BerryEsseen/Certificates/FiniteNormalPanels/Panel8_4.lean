...
namespace FiniteNormalPanel8_4

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2817 / 10000)
def radius : Rat := (2817 / 50000)

def j0 : Jet := ⟨⟨1209892287, 1209892288⟩, ⟨241978457, 241978458⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3800988720, 3800988724⟩, ⟨760197742, 760197747⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3363824274, 3363824282⟩, ⟨1345529706, 1345529718⟩, ⟨134552970, 134552973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨841, 843⟩, ⟨336, 338⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93846), (-93843)⟩, ⟨336, 338⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-73501), (-73497)⟩, ⟨(-29138), (-29134)⟩, ⟨(-2811), (-2806)⟩, ⟨20, 22⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5039555, 5039560⟩, ⟨(-29138), (-29134)⟩, ⟨(-2811), (-2806)⟩, ⟨20, 22⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3946986, 3946991⟩, ⟨1555973, 1555980⟩, ⟨146548, 146556⟩, ⟨(-1779), (-1773)⟩, ⟨(-83), (-78)⟩⟩
...
def j16 : Jet := ⟨⟨(-139218591), (-139218585)⟩, ⟨1555973, 1555980⟩, ⟨146548, 146556⟩, ⟨(-1779), (-1773)⟩, ⟨(-83), (-78)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-109036192), (-109036186)⟩, ⟨(-42395837), (-42395828)⟩, ⟨(-3759216), (-3759205)⟩, ⟨93261, 93272⟩, ⟨3967, 3976⟩⟩
...
def j19 : Jet := ⟨⟨1322619573, 1322619580⟩, ⟨(-42395837), (-42395828)⟩, ⟨(-3759216), (-3759205)⟩, ⟨93261, 93272⟩, ⟨3967, 3976⟩⟩
...
def j22 : Jet := ⟨⟨(-85), (-83)⟩, ⟨(-34), (-33)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11750, 11753⟩, ⟨(-34), (-33)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9202, 9205⟩, ⟨3654, 3657⟩, ⟨353, 357⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842975), (-842971)⟩, ⟨3654, 3657⟩, ⟨353, 357⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-660220), (-660216)⟩, ⟨(-261227), (-261221)⟩, ⟨(-24989), (-24982)⟩, ⟨220, 227⟩, ⟨8, 12⟩⟩
...
def j30 : Jet := ⟨⟨35131174, 35131179⟩, ⟨(-261227), (-261221)⟩, ⟨(-24989), (-24982)⟩, ⟨220, 227⟩, ⟨8, 12⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨27514783, 27514788⟩, ⟨10801319, 10801328⟩, ⟨999181, 999192⟩, ⟨(-15841), (-15831)⟩, ⟨(-709), (-700)⟩⟩
...
def j33 : Jet := ⟨⟨(-688313100), (-688313094)⟩, ⟨10801319, 10801328⟩, ⟨999181, 999192⟩, ⟨(-15841), (-15831)⟩, ⟨(-709), (-700)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-539087765), (-539087758)⟩, ⟨(-207175500), (-207175487)⟩, ⟨(-17397109), (-17397095)⟩, ⟨639000, 639015⟩, ⟨25783, 25796⟩⟩
...
def j36 : Jet := ⟨⟨3755879531, 3755879538⟩, ⟨(-207175500), (-207175487)⟩, ⟨(-17397109), (-17397095)⟩, ⟨639000, 639015⟩, ⟨25783, 25796⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1170500665, 1170500673⟩, ⟨196580382, 196580395⟩, ⟨(-10830806), (-10830794)⟩, ⟨(-582838), (-582824)⟩, ⟨20016, 20028⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4911431233, 4911431244⟩, ⟨270916077, 270916098⟩, ⟨37693382, 37693405⟩, ⟨2498433, 2498459⟩, ⟨232580, 232606⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1338504609, 1338504622⟩, ⟨298628228, 298628251⟩, ⟨10286958, 10286983⟩, ⟨1056442, 1056470⟩, ⟨68806, 68835⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1209892288), (-1209892287)⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3085075008, 3085075009⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨417138121, 417138130⟩, ⟨186131922, 186131940⟩, ⟨27175315, 27175337⟩, ⟨2088968, 2088992⟩, ⟨214432, 214459⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4712105417, 4712105426⟩, ⟨186131922, 186131940⟩, ⟨27175315, 27175337⟩, ⟨2088968, 2088992⟩, ⟨214432, 214459⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4498704109, 4498704114⟩, ⟨88851199, 88851209⟩, ⟨12094877, 12094889⟩, ⟨758302, 758315⟩, ⟨71124, 71139⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3231419160, 3231419166⟩, ⟨(-189635175), (-189635165)⟩, ⟨3681872, 3681883⟩, ⟨(-136739), (-136727)⟩, ⟨8364, 8378⟩⟩
...
def j47 : Jet := ⟨⟨4350317550, 4350317556⟩, ⟨870063508, 870063513⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4406381115, 4406381128⟩, ⟨1762552442, 1762552456⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4406381115, 4406381128⟩, ⟨1762552442, 1762552456⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4406381128), (-4406381115)⟩, ⟨(-1762552456), (-1762552442)⟩, ⟨(-176255246), (-176255243)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2203190564), (-2203190557)⟩, ⟨(-881276228), (-881276221)⟩, ⟨(-88127623), (-88127621)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2571459564, 2571459581⟩, ⟨(-527632935), (-527632927)⟩, ⟨1368707, 1368711⟩, ⟨7123985, 7123987⟩, ⟨(-379482), (-379481)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1934697782, 1934697800⟩, ⟨(-510514334), (-510514319)⟩, ⟨26530680, 26530694⟩, ⟨4765278, 4765293⟩, ⟨(-577082), (-577065)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨967913829, 1451870745⟩, ⟨241978457, 241978458⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3040790974, 4561186467⟩, ⟨760197742, 760197747⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2152847533, 4843906963⟩, ⟨1076423764, 1614635660⟩, ⟨134552970, 134552973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨538, 1214⟩, ⟨269, 405⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94149), (-93472)⟩, ⟨269, 405⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-106183), (-46852)⟩, ⟨(-35261), (-22969)⟩, ⟨(-2867), (-2736)⟩, ⟨16, 26⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5006873, 5066205⟩, ⟨(-35261), (-22969)⟩, ⟨(-2867), (-2736)⟩, ⟨16, 26⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2509689, 5713717⟩, ⟨1215076, 1893060⟩, ⟨140365, 151588⟩, ⟨(-2175), (-1374)⟩, ⟨(-86), (-72)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140655888), (-137451859)⟩, ⟨1215076, 1893060⟩, ⟨140365, 151588⟩, ⟨(-2175), (-1374)⟩, ⟨(-86), (-72)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-158633114), (-68897589)⟩, ⟨(-52268650), (-32313782)⟩, ⟨(-4031592), (-3423465)⟩, ⟨70790, 115606⟩, ⟨3482, 4369⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1273022651, 1362758177⟩, ⟨(-52268650), (-32313782)⟩, ⟨(-4031592), (-3423465)⟩, ⟨70790, 115606⟩, ⟨3482, 4369⟩⟩
...
def j70 : Jet := ⟨⟨(-122), (-53)⟩, ⟨(-41), (-26)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11713, 11783⟩, ⟨(-41), (-26)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5871, 13289⟩, ⟨2888, 4417⟩, ⟨345, 363⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846306), (-838887)⟩, ⟨2888, 4417⟩, ⟨345, 363⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-954473), (-420491)⟩, ⟨(-316711), (-205263)⟩, ⟨(-25619), (-24209)⟩, ⟨171, 276⟩, ⟨6, 12⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34836921, 35370904⟩, ⟨(-316711), (-205263)⟩, ⟨(-25619), (-24209)⟩, ⟨171, 276⟩, ⟨6, 12⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17461967, 39891659⟩, ⟨8373793, 13194333⟩, ⟨943414, 1044525⟩, ⟨(-19469), (-12185)⟩, ⟨(-758), (-640)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698365916), (-675936223)⟩, ⟨8373793, 13194333⟩, ⟨943414, 1044525⟩, ⟨(-19469), (-12185)⟩, ⟨(-758), (-640)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-787624047), (-338812272)⟩, ⟨(-258343996), (-154525434)⟩, ⟨(-19306885), (-15037506)⟩, ⟨476818, 799922⟩, ⟨21380, 29350⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3507343249, 3956155024⟩, ⟨(-258343996), (-154525434)⟩, ⟨(-19306885), (-15037506)⟩, ⟨476818, 799922⟩, ⟨21380, 29350⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨901286440, 1447227354⟩, ⟨169813139, 218326748⟩, ⟨(-13532899), (-8143229)⟩, ⟨(-663464), (-483172)⟩, ⟨14994, 25102⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4662796063, 5259463579⟩, ⟨182126478, 387401730⟩, ⟨24837245, 57487038⟩, ⟨598951, 5733016⟩, ⟨449, 685551⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨978474240, 1772222938⟩, ⟨222574956, 397893592⟩, ⟨(-4159020), 30222993⟩, ⟨(-925414), 3984178⟩, ⟨(-200926), 485592⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1451870745), (-967913829)⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2843096551, 3327053467⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨222914814, 731268466⟩, ⟨101413512, 328363922⟩, ⟨8102083, 61803283⟩, ⟨(-1534304), 8887794⟩, ⟨(-366549), 1351617⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4517882110, 5026235762⟩, ⟨101413512, 328363922⟩, ⟨8102083, 61803283⟩, ⟨(-1534304), 8887794⟩, ⟨(-366549), 1351617⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4405014859, 4646236996⟩, ⟨46873170, 160080313⟩, ⟨987086, 29880262⟩, ⟨(-1833851), 4322376⟩, ⟨(-437117), 725459⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2915943635, 3599161028⟩, ⟨(-230740830), (-124173922)⟩, ⟨(-8365514), 20505613⟩, ⟨(-3104029), 3292674⟩, ⟨(-582132), 665290⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3480254038, 5220381065⟩, ⟨870063508, 870063513⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2820083910, 6345188819⟩, ⟨1410041952, 2115062946⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2820083910, 6345188819⟩, ⟨1410041952, 2115062946⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6345188819), (-2820083910)⟩, ⟨(-2115062946), (-1410041952)⟩, ⟨(-176255246), (-176255243)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3172594410), (-1410041955)⟩, ⟨(-1057531473), (-705020976)⟩, ⟨(-88127623), (-88127621)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2051901124, 3093004553⟩, ⟨(-761577315), (-336820570)⟩, ⟨(-35820147), 51657397⟩, ⟨367644, 13357722⟩, ⟨(-1352228), 352407⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1393078831, 2591922285⟩, ⟨(-804365108), (-287998096)⟩, ⟨(-26303513), 98970308⟩, ⟨(-8396999), 16972657⟩, ⟨(-3024878), 1560826⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1209892287, 1209892288⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4498704109, 4498704114⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified156
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨967913829, 1451870745⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4405014859, 4646236996⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified157
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (27379177 / 536870912)

theorem envelope_integral : (∫ s in ((2817 / 12500) : ℝ)..(8451 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((2817 / 12500) : ℝ)..(8451 / 25000), prawitzNormalCorrection
