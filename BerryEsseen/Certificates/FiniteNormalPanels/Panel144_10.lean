...
namespace FiniteNormalPanel144_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3661 / 16000)
def radius : Rat := (523 / 16000)

def j0 : Jet := ⟨⟨982742204, 982742205⟩, ⟨140391743, 140391744⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3087375688, 3087375692⟩, ⟨441053668, 441053672⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2219315767, 2219315773⟩, ⟨634090216, 634090224⟩, ⟨45292158, 45292159⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨555, 556⟩, ⟨158, 159⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94132), (-94130)⟩, ⟨158, 159⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48641), (-48639)⟩, ⟨(-13817), (-13813)⟩, ⟨(-965), (-961)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064415, 5064418⟩, ⟨(-13817), (-13813)⟩, ⟨(-965), (-961)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2616908, 2616910⟩, ⟨740548, 740552⟩, ⟨50867, 50872⟩, ⟨(-288), (-283)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140548669), (-140548666)⟩, ⟨740548, 740552⟩, ⟨50867, 50872⟩, ⟨(-288), (-283)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-72624972), (-72624969)⟩, ⟨(-20367333), (-20367329)⟩, ⟨(-1346528), (-1346523)⟩, ⟨15169, 15175⟩, ⟨487, 492⟩⟩
...
def j19 : Jet := ⟨⟨1359030793, 1359030797⟩, ⟨(-20367333), (-20367329)⟩, ⟨(-1346528), (-1346523)⟩, ⟨15169, 15175⟩, ⟨487, 492⟩⟩
...
def j25 : Jet := ⟨⟨6086, 6088⟩, ⟨1730, 1733⟩, ⟨119, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846091), (-846088)⟩, ⟨1730, 1733⟩, ⟨119, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-437197), (-437194)⟩, ⟨(-124021), (-124016)⟩, ⟨(-8607), (-8602)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35354197, 35354201⟩, ⟨(-124021), (-124016)⟩, ⟨(-8607), (-8602)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18268387, 18268390⟩, ⟨5155454, 5155458⟩, ⟨350066, 350072⟩, ⟨(-2562), (-2556)⟩, ⟨(-88), (-82)⟩⟩
...
def j33 : Jet := ⟨⟨(-697559496), (-697559492)⟩, ⟨5155454, 5155458⟩, ⟨350066, 350072⟩, ⟨(-2562), (-2556)⟩, ⟨(-88), (-82)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-360446236), (-360446232)⟩, ⟨(-100320690), (-100320684)⟩, ⟨(-6414031), (-6414024)⟩, ⟨104724, 104731⟩, ⟨3266, 3273⟩⟩
...
def j36 : Jet := ⟨⟨3934521060, 3934521064⟩, ⟨(-100320690), (-100320684)⟩, ⟨(-6414031), (-6414024)⟩, ⟨104724, 104731⟩, ⟨3266, 3273⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨976919808, 976919813⟩, ⟨124919206, 124919212⟩, ⟨(-3059471), (-3059465)⟩, ⟨(-127373), (-127366)⟩, ⟨1907, 1913⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4688434443, 4688434448⟩, ⟨119543634, 119543643⟩, ⟨10691116, 10691129⟩, ⟨342676, 342689⟩, ⟨19081, 19095⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1066416612, 1066416620⟩, ⟨163554225, 163554236⟩, ⟨2568942, 2568955⟩, ⟨164697, 164710⟩, ⟨5225, 5241⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-982742205), (-982742204)⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3312225091, 3312225092⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨264785343, 264785348⟩, ⟨81219216, 81219226⟩, ⟨7503924, 7503933⟩, ⟨277438, 277448⟩, ⟨16672, 16687⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4559752639, 4559752644⟩, ⟨81219216, 81219226⟩, ⟨7503924, 7503933⟩, ⟨277438, 277448⟩, ⟨16672, 16687⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4425380035, 4425380039⟩, ⟨39412872, 39412878⟩, ⟨3465886, 3465892⟩, ⟨103763, 103770⟩, ⟨5808, 5817⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3412797765, 3412797770⟩, ⟨(-114259897), (-114259890)⟩, ⟨1384538, 1384545⟩, ⟨(-33272), (-33264)⟩, ⟨1087, 1095⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨45771041161, 45771041168⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value593

def j47 : Jet := ⟨⟨10472986351, 10472986364⟩, ⟨1496140902, 1496140914⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨25537666657, 25537666721⟩, ⟨7296476160, 7296476230⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨25537666657, 25537666721⟩, ⟨7296476160, 7296476230⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-25537666721), (-25537666657)⟩, ⟨(-7296476230), (-7296476160)⟩, ⟨(-521176876), (-521176866)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12768833361), (-12768833328)⟩, ⟨(-3648238115), (-3648238080)⟩, ⟨(-260588438), (-260588433)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨219691330, 219691338⟩, ⟨(-186610575), (-186610565)⟩, ⟨65926197, 65926204⟩, ⟨(-11118237), (-11118233)⟩, ⟨361047, 361049⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨174567587, 174567595⟩, ⟨(-154125985), (-154125975)⟩, ⟨57420471, 57420480⟩, ⟨(-10650303), (-10650296)⟩, ⟨605421, 605428⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨842350460, 1123133948⟩, ⟨140391743, 140391744⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2646322016, 3528429361⟩, ⟨441053668, 441053672⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1630517703, 2898698151⟩, ⟨543505898, 724674542⟩, ⟨45292158, 45292159⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-63630), (-35670)⟩, ⟨(-15857), (-11767)⟩, ⟨(-974), (-950)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5049426, 5077387⟩, ⟨(-15857), (-11767)⟩, ⟨(-974), (-950)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1916936, 3426758⟩, ⟨628276, 852223⟩, ⟨49914, 51695⟩, ⟨(-333), (-240)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141248641), (-139738818)⟩, ⟨628276, 852223⟩, ⟨49914, 51695⟩, ⟨(-333), (-240)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-95329521), (-53049674)⟩, ⟨(-23593866), (-17108053)⟩, ⟨(-1391070), (-1294919)⟩, ⟨12716, 17620⟩, ⟨461, 513⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1336326244, 1378606092⟩, ⟨(-23593866), (-17108053)⟩, ⟨(-1391070), (-1294919)⟩, ⟨12716, 17620⟩, ⟨461, 513⟩⟩
...
def j72 : Jet := ⟨⟨4465, 7962⟩, ⟨1475, 1987⟩, ⟨118, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847712), (-844214)⟩, ⟨1475, 1987⟩, ⟨118, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-572126), (-320492)⟩, ⟨(-142473), (-105488)⟩, ⟨(-8710), (-8482)⟩, ⟨27, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35219268, 35470903⟩, ⟨(-142473), (-105488)⟩, ⟨(-8710), (-8482)⟩, ⟨27, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13370448, 23939517⟩, ⟨4360660, 5944834⟩, ⟨341483, 357487⟩, ⟨(-2963), (-2156)⟩, ⟨(-90), (-79)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702457435), (-691888365)⟩, ⟨4360660, 5944834⟩, ⟨341483, 357487⟩, ⟨(-2963), (-2156)⟩, ⟨(-90), (-79)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-474092567), (-262664684)⟩, ⟨(-116867687), (-83542691)⟩, ⟨(-6726241), (-6051919)⟩, ⟨87196, 122191⟩, ⟨3040, 3469⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3820874729, 4032302612⟩, ⟨(-116867687), (-83542691)⟩, ⟨(-6726241), (-6051919)⟩, ⟨87196, 122191⟩, ⟨3040, 3469⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨823370544, 1132561409⟩, ⟨117845437, 131029139⟩, ⟨(-3565675), (-2554696)⟩, ⟨(-135017), (-118500)⟩, ⟨1589, 2232⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4574741989, 4827885074⟩, ⟨94781144, 147668742⟩, ⟨8829752, 13015666⟩, ⟨178890, 553664⟩, ⟨8327, 34047⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨877005001, 1273089164⟩, ⟨143692006, 186226691⟩, ⟨285219, 5216077⟩, ⟨2199, 360481⟩, ⟨(-7253), 20512⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1123133948), (-842350460)⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3171833348, 3452616836⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨179078842, 377361668⟩, ⟨58681986, 110400460⟩, ⟨4923823, 11166896⟩, ⟨19982, 666036⟩, ⟨(-4136), 49759⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4474046138, 4672328964⟩, ⟨58681986, 110400460⟩, ⟨4923823, 11166896⟩, ⟨19982, 666036⟩, ⟨(-4136), 49759⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4383592344, 4479676339⟩, ⟨28131185, 54084223⟩, ⟨2033914, 5380301⟩, ⟨(-56594), 313234⟩, ⟨(-9194), 24604⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3237282945, 3601099818⟩, ⟨(-125654541), (-99811719)⟩, ⟨(-265834), 3405552⟩, ⟨(-221364), 185318⟩, ⟨(-17630), 21629⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8976845437, 11969127267⟩, ⟨1496140902, 1496140914⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨18762367311, 33355319764⟩, ⟨6254122418, 8338829974⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨18762367311, 33355319764⟩, ⟨6254122418, 8338829974⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-33355319764), (-18762367311)⟩, ⟨(-8338829974), (-6254122418)⟩, ⟨(-521176876), (-521176866)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-16677659882), (-9381183655)⟩, ⟨(-4169414987), (-3127061209)⟩, ⟨(-260588438), (-260588433)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨88422717, 483461749⟩, ⟨(-469328990), (-64378429)⟩, ⟨(-5896879), 222439814⟩, ⟨(-69375100), 20891890⟩, ⟨(-11818335), 17015666⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨66647621, 405356758⟩, ⟨(-407651464), (-50579386)⟩, ⟨(-3478037), 200618000⟩, ⟨(-65072110), 17739161⟩, ⟨(-10556263), 16499380⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨982742204, 982742205⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4425380035, 4425380039⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar593 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2900
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar593 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨842350460, 1123133948⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4383592344, 4479676339⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2901
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((1569 / 8000) : ℝ)..(523 / 2000), prawitzNormalCorrection
      ((6879 / 2500) * sqrt n) s) ≤ (upper : ℝ) :=
