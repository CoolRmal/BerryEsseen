...
namespace FiniteNormalPanel96_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (7371 / 40000)
def radius : Rat := (7371 / 200000)

def j0 : Jet := ⟨⟨791455098, 791455099⟩, ⟨158291019, 158291020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2486429521, 2486429525⟩, ⟨497285902, 497285906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1439436283, 1439436289⟩, ⟨575774510, 575774518⟩, ⟨57577450, 57577452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨360, 361⟩, ⟨144, 145⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94327), (-94325)⟩, ⟨144, 145⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-31614), (-31612)⟩, ⟨(-12598), (-12596)⟩, ⟨(-1242), (-1238)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5081442, 5081445⟩, ⟨(-12598), (-12596)⟩, ⟨(-1242), (-1238)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1703019, 1703021⟩, ⟨676984, 676988⟩, ⟨66014, 66019⟩, ⟨(-336), (-331)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-141462558), (-141462555)⟩, ⟨676984, 676988⟩, ⟨66014, 66019⟩, ⟨(-336), (-331)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-47410452), (-47410450)⟩, ⟨(-18737294), (-18737290)⟩, ⟨(-1783540), (-1783535)⟩, ⟨17811, 17817⟩, ⟨832, 838⟩⟩
...
def j19 : Jet := ⟨⟨1384245313, 1384245316⟩, ⟨(-18737294), (-18737290)⟩, ⟨(-1783540), (-1783535)⟩, ⟨17811, 17817⟩, ⟨832, 838⟩⟩
...
def j22 : Jet := ⟨⟨(-37), (-35)⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11798, 11801⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3954, 3956⟩, ⟨1575, 1579⟩, ⟨154, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848223), (-848220)⟩, ⟨1575, 1579⟩, ⟨154, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-284278), (-284276)⟩, ⟨(-113185), (-113180)⟩, ⟨(-11110), (-11106)⟩, ⟨40, 44⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35507116, 35507119⟩, ⟨(-113185), (-113180)⟩, ⟨(-11110), (-11106)⟩, ⟨40, 44⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11900027, 11900030⟩, ⟨4722077, 4722081⟩, ⟨457103, 457108⟩, ⟨(-2995), (-2990)⟩, ⟨(-144), (-140)⟩⟩
...
def j33 : Jet := ⟨⟨(-703927856), (-703927852)⟩, ⟨4722077, 4722081⟩, ⟨457103, 457108⟩, ⟨(-2995), (-2990)⟩, ⟨(-144), (-140)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-235917816), (-235917812)⟩, ⟨(-92784548), (-92784542)⟩, ⟨(-8650487), (-8650481)⟩, ⟨123577, 123581⟩, ⟨5676, 5682⟩⟩
...
def j36 : Jet := ⟨⟨4059049480, 4059049484⟩, ⟨(-92784548), (-92784542)⟩, ⟨(-8650487), (-8650481)⟩, ⟨123577, 123581⟩, ⟨5676, 5682⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨801363124, 801363128⟩, ⟨149425286, 149425291⟩, ⟨(-3201990), (-3201985)⟩, ⟨(-196194), (-196188)⟩, ⟨2543, 2549⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4544596991, 4544596997⟩, ⟨103883520, 103883528⟩, ⟨12059899, 12059909⟩, ⟨358701, 358709⟩, ⟨24373, 24387⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨847939504, 847939511⟩, ⟨177492882, 177492891⟩, ⟨2476252, 2476263⟩, ⟨201454, 201466⟩, ⟨5979, 5994⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-791455099), (-791455098)⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3503512197, 3503512198⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨167405559, 167405563⟩, ⟨70083526, 70083532⟩, ⟨8312786, 8312793⟩, ⟨284210, 284218⟩, ⟨20437, 20448⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4462372855, 4462372859⟩, ⟨70083526, 70083532⟩, ⟨8312786, 8312793⟩, ⟨284210, 284218⟩, ⟨20437, 20448⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4377869970, 4377869973⟩, ⟨34378185, 34378189⟩, ⟨3942702, 3942707⟩, ⟨108452, 108458⟩, ⟨7396, 7404⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3571137980, 3571137985⟩, ⟨(-133303255), (-133303248)⟩, ⟨1949151, 1949157⟩, ⟨(-56842), (-56836)⟩, ⟨2035, 2044⟩⟩
...
def j47 : Jet := ⟨⟨6884754428, 6884754439⟩, ⟨1376950880, 1376950890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11036136079, 11036136115⟩, ⟨4414454412, 4414454454⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11036136079, 11036136115⟩, ⟨4414454412, 4414454454⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11036136115), (-11036136079)⟩, ⟨(-4414454454), (-4414454412)⟩, ⟨(-441445446), (-441445439)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5518068058), (-5518068039)⟩, ⟨(-2207227227), (-2207227206)⟩, ⟨(-220722723), (-220722719)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1188472178, 1188472193⟩, ⟨(-610767907), (-610767892)⟩, ⟨95863112, 95863121⟩, ⟨4503643, 4503647⟩, ⟨(-3041869), (-3041867)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨988179383, 988179397⟩, ⟨(-544722119), (-544722102)⟩, ⟨99203141, 99203156⟩, ⟨476423, 476432⟩, ⟨(-2616856), (-2616846)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨633164078, 949746119⟩, ⟨158291019, 158291020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1989143615, 2983715431⟩, ⟨497285902, 497285906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨921239219, 2072788257⟩, ⟨460619608, 690929420⟩, ⟨57577450, 57577452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨230, 520⟩, ⟨115, 174⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94457), (-94166)⟩, ⟨115, 174⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-45586), (-20197)⟩, ⟨(-15172), (-10014)⟩, ⟨(-1252), (-1226)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5067470, 5092860⟩, ⟨(-15172), (-10014)⟩, ⟨(-1252), (-1226)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1086935, 2457859⟩, ⟨536144, 817140⟩, ⟨64887, 66939⟩, ⟨(-406), (-262)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142078642), (-140707717)⟩, ⟨536144, 817140⟩, ⟨64887, 66939⟩, ⟨(-406), (-262)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-68568378), (-30180780)⟩, ⟨(-22741129), (-14696031)⟩, ⟨(-1833262), (-1722539)⟩, ⟨13949, 21668⟩, ⟨794, 867⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1363087387, 1401474986⟩, ⟨(-22741129), (-14696031)⟩, ⟨(-1833262), (-1722539)⟩, ⟨13949, 21668⟩, ⟨794, 867⟩⟩
...
def j70 : Jet := ⟨⟨(-53), (-22)⟩, ⟨(-18), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11782, 11814⟩, ⟨(-18), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2527, 5702⟩, ⟨1254, 1899⟩, ⟨153, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849650), (-846474)⟩, ⟨1254, 1899⟩, ⟨153, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-410049), (-181562)⟩, ⟨(-136415), (-89864)⟩, ⟨(-11225), (-10964)⟩, ⟨31, 52⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35381345, 35609833⟩, ⟨(-136415), (-89864)⟩, ⟨(-11225), (-10964)⟩, ⟨31, 52⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7589040, 17185613⟩, ⟨3728684, 5709263⟩, ⟨446951, 465391⟩, ⟨(-3629), (-2353)⟩, ⟨(-148), (-135)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708238843), (-698642269)⟩, ⟨3728684, 5709263⟩, ⟨446951, 465391⟩, ⟨(-3629), (-2353)⟩, ⟨(-148), (-135)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-341802174), (-149853680)⟩, ⟨(-113134284), (-72171500)⟩, ⟨(-8998751), (-8222805)⟩, ⟨96166, 150902⟩, ⟨5335, 5959⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3953165122, 4145113616⟩, ⟨(-113134284), (-72171500)⟩, ⟨(-8998751), (-8222805)⟩, ⟨96166, 150902⟩, ⟨5335, 5959⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨631291552, 973605212⟩, ⟨142024615, 155461311⟩, ⟨(-3906614), (-2499321)⟩, ⟨(-205802), (-184388)⟩, ⟨1982, 3112⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4450238469, 4666322682⟩, ⟨77484096, 133543898⟩, ⟨10177183, 14443989⟩, ⟨161026, 609103⟩, ⟨11419, 42424⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨654113932, 1057785956⟩, ⟨158547995, 199175365⟩, ⟨(-186290), 5518338⟩, ⟨15137, 424750⟩, ⟨(-10483), 25799⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-949746119), (-633164078)⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3345221177, 3661803218⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨99620091, 260516799⟩, ⟨48293010, 98107804⟩, ⟨5761010, 11954752⟩, ⟨(-12670), 721038⟩, ⟨(-4288), 59195⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4394587387, 4555484095⟩, ⟨48293010, 98107804⟩, ⟨5761010, 11954752⟩, ⟨(-12670), 721038⟩, ⟨(-4288), 59195⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4344491812, 4423308175⟩, ⟨23445901, 48494718⟩, ⟨2531093, 5845973⟩, ⟨(-71519), 342750⟩, ⟨(-9881), 29322⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3383794336, 3771224085⟩, ⟨(-144759716), (-118770618)⟩, ⟨184119, 4120062⟩, ⟨(-276430), 198939⟩, ⟨(-21058), 27636⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5507803539, 8261705329⟩, ⟨1376950880, 1376950890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7063127081, 15892036014⟩, ⟨3531563528, 5297345346⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7063127081, 15892036014⟩, ⟨3531563528, 5297345346⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15892036014), (-7063127081)⟩, ⟨(-5297345346), (-3531563528)⟩, ⟨(-441445446), (-441445439)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7946018007), (-3531563540)⟩, ⟨(-2648672673), (-1765781764)⟩, ⟨(-220722723), (-220722719)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨675276831, 1887376427⟩, ⟨(-1163930252), (-277625283)⟩, ⟨(-39924410), 324190173⟩, ⟨(-57130218), 48084061⟩, ⟨(-15743497), 9833818⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨532017535, 1657223199⟩, ⟨(-1085609635), (-237401086)⟩, ⟨(-27349648), 325697501⟩, ⟨(-62328236), 43641678⟩, ⟨(-15545797), 10958242⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨791455098, 791455099⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4377869970, 4377869973⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1934
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨633164078, 949746119⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4344491812, 4423308175⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1935
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (9429709 / 536870912)

theorem envelope_integral : (∫ s in ((7371 / 50000) : ℝ)..(22113 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (7371 / 50000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (22113 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((7371 / 50000) : ℝ)..(22113 / 100000), prawitzNormalCorrection
