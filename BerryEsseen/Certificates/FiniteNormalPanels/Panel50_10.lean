...
namespace FiniteNormalPanel50_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (278593 / 800000)
def radius : Rat := (39799 / 800000)

def j0 : Jet := ⟨⟨1495684779, 1495684780⟩, ⟨213669254, 213669255⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4698832313, 4698832318⟩, ⟨671261758, 671261762⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5140673626, 5140673638⟩, ⟨1468763890, 1468763902⟩, ⟨104911706, 104911708⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1286, 1288⟩, ⟨367, 368⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93401), (-93398)⟩, ⟨367, 368⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-111793), (-111788)⟩, ⟨(-31502), (-31498)⟩, ⟨(-2126), (-2122)⟩, ⟨16, 19⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5001263, 5001269⟩, ⟨(-31502), (-31498)⟩, ⟨(-2126), (-2122)⟩, ⟨16, 19⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5986043, 5986051⟩, ⟨1672593, 1672601⟩, ⟨108846, 108855⟩, ⟨(-1479), (-1471)⟩, ⟨(-47), (-42)⟩⟩
...
def j16 : Jet := ⟨⟨(-137179534), (-137179525)⟩, ⟨1672593, 1672601⟩, ⟨108846, 108855⟩, ⟨(-1479), (-1471)⟩, ⟨(-47), (-42)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-164191056), (-164191044)⟩, ⟨(-44909794), (-44909779)⟩, ⟨(-2648578), (-2648562)⟩, ⟨76306, 76323⟩, ⟨2095, 2106⟩⟩
...
def j19 : Jet := ⟨⟨1267464709, 1267464722⟩, ⟨(-44909794), (-44909779)⟩, ⟨(-2648578), (-2648562)⟩, ⟨76306, 76323⟩, ⟨2095, 2106⟩⟩
...
def j22 : Jet := ⟨⟨(-130), (-128)⟩, ⟨(-37), (-36)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11705, 11708⟩, ⟨(-37), (-36)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨14009, 14014⟩, ⟨3957, 3961⟩, ⟨268, 272⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-838168), (-838162)⟩, ⟨3957, 3961⟩, ⟨268, 272⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1003209), (-1003201)⟩, ⟨(-281896), (-281887)⟩, ⟨(-18801), (-18792)⟩, ⟨183, 191⟩, ⟨2, 7⟩⟩
...
def j30 : Jet := ⟨⟨34788185, 34788194⟩, ⟨(-281896), (-281887)⟩, ⟨(-18801), (-18792)⟩, ⟨183, 191⟩, ⟨2, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨41638199, 41638211⟩, ⟨11559224, 11559240⟩, ⟨730854, 730871⟩, ⟨(-13097), (-13082)⟩, ⟨(-396), (-384)⟩⟩
...
def j33 : Jet := ⟨⟨(-674189684), (-674189671)⟩, ⟨11559224, 11559240⟩, ⟨730854, 730871⟩, ⟨(-13097), (-13082)⟩, ⟨(-396), (-384)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-806941916), (-806941897)⟩, ⟨(-216719526), (-216719499)⟩, ⟨(-11640495), (-11640465)⟩, ⟨516609, 516636⟩, ⟨12899, 12921⟩⟩
...
def j36 : Jet := ⟨⟨3488025380, 3488025399⟩, ⟨(-216719526), (-216719499)⟩, ⟨(-11640495), (-11640465)⟩, ⟨516609, 516636⟩, ⟨12899, 12921⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1386647142, 1386647159⟩, ⟨148959689, 148959710⟩, ⟨(-9916596), (-9916574)⟩, ⟨(-330467), (-330444)⟩, ⟨14216, 14234⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5288592244, 5288592274⟩, ⟨328593094, 328593140⟩, ⟨38065719, 38065774⟩, ⟨2678385, 2678437⟩, ⟨225184, 225232⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1707442877, 1707442909⟩, ⟨289508544, 289508589⟩, ⟨11475292, 11475343⟩, ⟨1019331, 1019383⟩, ⟨69924, 69970⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1495684780), (-1495684779)⟩, ⟨(-213669255), (-213669254)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2799282516, 2799282517⟩, ⟨(-213669255), (-213669254)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨678785419, 678785446⟩, ⟨230185362, 230185404⟩, ⟨28638636, 28638685⟩, ⟨2357474, 2357528⟩, ⟨223671, 223722⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4973752715, 4973752742⟩, ⟨230185362, 230185404⟩, ⟨28638636, 28638685⟩, ⟨2357474, 2357528⟩, ⟨223671, 223722⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4621915755, 4621915768⟩, ⟨106951170, 106951191⟩, ⟨12068961, 12068986⟩, ⟨816077, 816105⟩, ⟨69281, 69308⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3012374034, 3012374045⟩, ⟨(-160228173), (-160228156)⟩, ⟨2545361, 2545381⟩, ⟨(-68532), (-68511)⟩, ⟨4553, 4575⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨20060978747, 20060978753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value297

def j47 : Jet := ⟨⟨6986060311, 6986060318⟩, ⟨998008615, 998008621⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11363308566, 11363308590⟩, ⟨3246659586, 3246659612⟩, ⟨231904256, 231904259⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11363308566, 11363308590⟩, ⟨3246659586, 3246659612⟩, ⟨231904256, 231904259⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11363308590), (-11363308566)⟩, ⟨(-3246659612), (-3246659586)⟩, ⟨(-231904259), (-231904256)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5681654295), (-5681654283)⟩, ⟨(-1623329806), (-1623329793)⟩, ⟨(-115952130), (-115952128)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1144056991, 1144057006⟩, ⟨(-432408843), (-432408833)⟩, ⟨50830473, 50830478⟩, ⟨1378575, 1378578⟩, ⟨(-816403), (-816402)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨802410667, 802410681⟩, ⟨(-345960107), (-345960092)⟩, ⟨52460585, 52460600⟩, ⟨(-1203908), (-1203894)⟩, ⟨(-585801), (-585787)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1282015525, 1709354035⟩, ⟨213669254, 213669255⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4027570554, 5370094079⟩, ⟨671261758, 671261762⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3776821439, 6714349245⟩, ⟨1258940478, 1678587318⟩, ⟨104911706, 104911708⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨945, 1683⟩, ⟨315, 421⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93742), (-93003)⟩, ⟨315, 421⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-146548), (-81783)⟩, ⟨(-36361), (-26602)⟩, ⟨(-2176), (-2063)⟩, ⟨14, 22⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4966508, 5031274⟩, ⟨(-36361), (-26602)⟩, ⟨(-2176), (-2063)⟩, ⟨14, 22⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4367347, 7865423⟩, ⟨1398938, 1942964⟩, ⟨103702, 113287⟩, ⟨(-1728), (-1218)⟩, ⟨(-50), (-39)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138798230), (-135300153)⟩, ⟨1398938, 1942964⟩, ⟨103702, 113287⟩, ⟨(-1728), (-1218)⟩, ⟨(-50), (-39)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-216984142), (-118977510)⟩, ⟨(-53015867), (-36621722)⟩, ⟨(-2889131), (-2368465)⟩, ⟨61866, 90666⟩, ⟨1778, 2377⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1214671623, 1312678256⟩, ⟨(-53015867), (-36621722)⟩, ⟨(-2889131), (-2368465)⟩, ⟨61866, 90666⟩, ⟨1778, 2377⟩⟩
...
def j70 : Jet := ⟨⟨(-169), (-94)⟩, ⟨(-43), (-31)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11666, 11742⟩, ⟨(-43), (-31)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨10258, 18357⟩, ⟨3351, 4563⟩, ⟨262, 277⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-841919), (-833819)⟩, ⟨3351, 4563⟩, ⟨262, 277⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1316178), (-733226)⟩, ⟨(-326099), (-237274)⟩, ⟨(-19354), (-18149)⟩, ⟨150, 221⟩, ⟨2, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34475216, 35058169⟩, ⟨(-326099), (-237274)⟩, ⟨(-19354), (-18149)⟩, ⟨150, 221⟩, ⟨2, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨30316117, 54806655⟩, ⟨9595579, 13493015⟩, ⟨684408, 770846⟩, ⟨(-15400), (-10768)⟩, ⟨(-429), (-345)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-685511766), (-661021227)⟩, ⟨9595579, 13493015⟩, ⟨684408, 770846⟩, ⟨(-15400), (-10768)⟩, ⟨(-429), (-345)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1071664833), (-581275471)⟩, ⟨(-259478244), (-172664775)⟩, ⟨(-13330269), (-9668042)⟩, ⟨410925, 621390⟩, ⟨10027, 15371⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3223302463, 3713691825⟩, ⟨(-259478244), (-172664775)⟩, ⟨(-13330269), (-9668042)⟩, ⟨410925, 621390⟩, ⟨10027, 15371⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1139048408, 1641271108⟩, ⟨123554471, 170817169⟩, ⟨(-11898213), (-7944628)⟩, ⟨(-393530), (-256806)⟩, ⟨11336, 17144⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4967225322, 5722933013⟩, ⟨230946691, 460700362⟩, ⟨23669087, 60754448⟩, ⟨744121, 6162800⟩, ⟨(-5254), 702474⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1317334849, 2186951369⟩, ⟨204141800, 403660678⟩, ⟨(-2933188), 32351189⟩, ⟨(-922395), 4047141⟩, ⟨(-178012), 478802⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1709354035), (-1282015525)⟩, ⟨(-213669255), (-213669254)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2585613261, 3012951771⟩, ⟨(-213669255), (-213669254)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨404047571, 1113572226⟩, ⟨125227080, 411079394⟩, ⟨6715859, 70883638⟩, ⟨(-1490698), 10202548⟩, ⟨(-376760), 1492021⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4699014867, 5408539522⟩, ⟨125227080, 411079394⟩, ⟨6715859, 70883638⟩, ⟨(-1490698), 10202548⟩, ⟨(-376760), 1492021⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4492450909, 4819699199⟩, ⟨55796657, 196504380⟩, ⟨(-1087333), 33537333⟩, ⟨(-2179543), 4924589⟩, ⟨(-520689), 812611⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2704500370, 3381055137⟩, ⟨(-206183867), (-85644519)⟩, ⟨(-10538621), 20750878⟩, ⟨(-3197407), 3508731⟩, ⟨(-610261), 678483⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5988051695, 7984068938⟩, ⟨998008615, 998008621⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8348553232, 14841872456⟩, ⟨2782851074, 3710468128⟩, ⟨231904256, 231904259⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8348553232, 14841872456⟩, ⟨2782851074, 3710468128⟩, ⟨231904256, 231904259⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14841872456), (-8348553232)⟩, ⟨(-3710468128), (-2782851074)⟩, ⟨(-231904259), (-231904256)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7420936228), (-4174276616)⟩, ⟨(-1855234064), (-1391425537)⟩, ⟨(-115952130), (-115952128)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨763091432, 1625059504⟩, ⟨(-701953133), (-247216062)⟩, ⟨(-3827210), 131004865⟩, ⟨(-14413322), 13184912⟩, ⟨(-3192207), 1608140⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨480511472, 1279268364⟩, ⟨(-630599284), (-170886173)⟩, ⟨(-2070610), 144678051⟩, ⟨(-22236596), 13613037⟩, ⟨(-4271706), 3370105⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1495684779, 1495684780⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨213669254, 213669255⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4621915755, 4621915768⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar297 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified992
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar297 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1282015525, 1709354035⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4492450909, 4819699199⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified993
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((119397 / 400000) : ℝ)..(39799 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (119397 / 400000) := by norm_num [center, radius]
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((119397 / 400000) : ℝ)..(39799 / 100000), prawitzNormalCorrection
      ((41777 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
