...
namespace FiniteNormalPanel1_15
...
def j2 : Jet := ⟨⟨843314856, 843314857⟩, ⟨843314856, 843314857⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨165584484, 165584486⟩, ⟨331168968, 331168972⟩, ⟨165584484, 165584486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨41, 42⟩, ⟨82, 83⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94646), (-94644)⟩, ⟨82, 83⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-3649), (-3648)⟩, ⟨(-7295), (-7293)⟩, ⟨(-3642), (-3639)⟩, ⟨6, 8⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5109407, 5109409⟩, ⟨(-7295), (-7293)⟩, ⟨(-3642), (-3639)⟩, ⟨6, 8⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨196983, 196984⟩, ⟨393685, 393687⟩, ⟨196279, 196282⟩, ⟨(-563), (-560)⟩, ⟨(-141), (-138)⟩⟩
...
def j16 : Jet := ⟨⟨(-142968594), (-142968592)⟩, ⟨393685, 393687⟩, ⟨196279, 196282⟩, ⟨(-563), (-560)⟩, ⟨(-141), (-138)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-5511889), (-5511888)⟩, ⟨(-11008601), (-11008598)⟩, ⟨(-5473967), (-5473964)⟩, ⟨30289, 30292⟩, ⟨7517, 7520⟩⟩
...
def j19 : Jet := ⟨⟨1426143876, 1426143878⟩, ⟨(-11008601), (-11008598)⟩, ⟨(-5473967), (-5473964)⟩, ⟨30289, 30292⟩, ⟨7517, 7520⟩⟩
...
def j22 : Jet := ⟨⟨(-5), (-4)⟩, ⟨(-9), (-8)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11830, 11832⟩, ⟨(-9), (-8)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨456, 457⟩, ⟨911, 913⟩, ⟨454, 457⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851721), (-851719)⟩, ⟨911, 913⟩, ⟨454, 457⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-32837), (-32836)⟩, ⟨(-65639), (-65636)⟩, ⟨(-32750), (-32747)⟩, ⟨69, 72⟩, ⟨15, 18⟩⟩
...
def j30 : Jet := ⟨⟨35758557, 35758559⟩, ⟨(-65639), (-65636)⟩, ⟨(-32750), (-32747)⟩, ⟨69, 72⟩, ⟨15, 18⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨1378604, 1378605⟩, ⟨2754678, 2754680⟩, ⟨1372279, 1372283⟩, ⟨(-5055), (-5051)⟩, ⟨(-1258), (-1255)⟩⟩
...
def j33 : Jet := ⟨⟨(-714449279), (-714449277)⟩, ⟨2754678, 2754680⟩, ⟨1372279, 1372283⟩, ⟨(-5055), (-5051)⟩, ⟨(-1258), (-1255)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-27544265), (-27544264)⟩, ⟨(-54982329), (-54982326)⟩, ⟨(-27278958), (-27278954)⟩, ⟨211817, 211820⟩, ⟨52466, 52469⟩⟩
...
def j36 : Jet := ⟨⟨4267423031, 4267423032⟩, ⟨(-54982329), (-54982326)⟩, ⟨(-27278958), (-27278954)⟩, ⟨211817, 211820⟩, ⟨52466, 52469⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨280022695, 280022696⟩, ⟨277861161, 277861163⟩, ⟨(-3236345), (-3236343)⟩, ⟨(-1068864), (-1068862)⟩, ⟨7422, 7425⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4322689345, 4322689347⟩, ⟨55694387, 55694392⟩, ⟨28349813, 28349820⟩, ⟨506719, 506726⟩, ⟨131836, 131844⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨281830113, 281830115⟩, ⟨283285782, 283285786⟩, ⟨2194237, 2194243⟩, ⟨749384, 749392⟩, ⟨13621, 13630⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-268435456), (-268435456)⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4026531840, 4026531840⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨18493321, 18493323⟩, ⟨37177680, 37177684⟩, ⟨18972817, 18972822⟩, ⟨387798, 387806⟩, ⟨101761, 101770⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4313460617, 4313460619⟩, ⟨37177680, 37177684⟩, ⟨18972817, 18972822⟩, ⟨387798, 387806⟩, ⟨101761, 101770⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4304204024, 4304204026⟩, ⟨18548948, 18548951⟩, ⟨9426082, 9426086⟩, ⟨152860, 152866⟩, ⟨39789, 39796⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4035191272, 4035191275⟩, ⟨(-251623114), (-251623109)⟩, ⟨7677641, 7677647⟩, ⟨(-445825), (-445818)⟩, ⟨27747, 27756⟩⟩
...
def j47 : Jet := ⟨⟨753946612, 753946613⟩, ⟨753946612, 753946613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨132349201, 132349203⟩, ⟨264698402, 264698406⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨132349201, 132349203⟩, ⟨264698402, 264698406⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-132349203), (-132349201)⟩, ⟨(-264698406), (-264698402)⟩, ⟨(-132349203), (-132349201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-66174602), (-66174600)⟩, ⟨(-132349203), (-132349201)⟩, ⟨(-66174602), (-66174600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4229299877, 4229299880⟩, ⟨(-130325665), (-130325662)⟩, ⟨(-63154844), (-63154841)⟩, ⟨1987363, 1987365⟩, ⟨471218, 471219⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3973495669, 3973495676⟩, ⟨(-370219023), (-370219013)⟩, ⟨(-44139541), (-44139530)⟩, ⟨4895142, 4895156⟩, ⟨254238, 254255⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 536870912⟩, ⟨268435456, 268435456⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1686629714⟩, ⟨843314856, 843314857⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 662337941⟩, ⟨0, 662337942⟩, ⟨165584484, 165584486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 166⟩, ⟨0, 166⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94520)⟩, ⟨0, 166⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-14602), 0⟩, ⟨(-14602), 26⟩, ⟨(-3651), (-3611)⟩, ⟨0, 14⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5098454, 5113057⟩, ⟨(-14602), 26⟩, ⟨(-3651), (-3611)⟩, ⟨0, 14⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 788498⟩, ⟨(-2252), 788503⟩, ⟨193745, 197130⟩, ⟨(-1127), 5⟩, ⟨(-141), (-135)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142377078)⟩, ⟨(-2252), 788503⟩, ⟨193745, 197130⟩, ⟨(-1127), 5⟩, ⟨(-141), (-135)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-22077932), 0⟩, ⟨(-22078280), 121598⟩, ⟨(-5519831), (-5337085)⟩, ⟨(-261), 60801⟩, ⟨7273, 7601⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1409577833, 1431655766⟩, ⟨(-22078280), 121598⟩, ⟨(-5519831), (-5337085)⟩, ⟨(-261), 60801⟩, ⟨7273, 7601⟩⟩
...
def j70 : Jet := ⟨⟨(-17), 0⟩, ⟨(-17), 0⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11818, 11836⟩, ⟨(-17), 0⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 1826⟩, ⟨(-3), 1826⟩, ⟨451, 457⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-850350)⟩, ⟨(-3), 1826⟩, ⟨451, 457⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-131417), 0⟩, ⟨(-131418), 282⟩, ⟨(-32856), (-32430)⟩, ⟨(-2), 142⟩, ⟨15, 18⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35659977, 35791395⟩, ⟨(-131418), 282⟩, ⟨(-32856), (-32430)⟩, ⟨(-2), 142⟩, ⟨15, 18⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 5519483⟩, ⟨(-20267), 5519527⟩, ⟨1349470, 1379915⟩, ⟨(-10135), 33⟩, ⟨(-1268), (-1225)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-710308399)⟩, ⟨(-20267), 5519527⟩, ⟨1349470, 1379915⟩, ⟨(-10135), 33⟩, ⟨(-1268), (-1225)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-110389657), 0⟩, ⟨(-110392784), 851181⟩, ⟨(-27600541), (-26320638)⟩, ⟨(-2345), 425603⟩, ⟨50267, 53207⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4184577639, 4294967296⟩, ⟨(-110392784), 851181⟩, ⟨(-27600541), (-26320638)⟩, ⟨(-2345), 425603⟩, ⟨50267, 53207⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 562209905⟩, ⟨268099839, 281152705⟩, ⟨(-6502694), 23876⟩, ⟨(-1083920), (-1024057)⟩, ⟨(-52), 14924⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4408269046⟩, ⟨(-896683), 116293958⟩, ⟨26297590, 32143897⟩, ⟨(-460809), 1617505⟩, ⟨83178, 203185⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 577041070⟩, ⟨267982463, 303792391⟩, ⟨(-6732934), 11844848⟩, ⟨292637, 1293203⟩, ⟨(-108237), 148205⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-536870912), 0⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3758096384, 4294967296⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 77527109⟩, ⟨0, 81630744⟩, ⟨14911461, 24670678⟩, ⟨(-952472), 2023116⟩, ⟨(-11137), 255435⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4372494405⟩, ⟨0, 81630744⟩, ⟨14911461, 24670678⟩, ⟨(-952472), 2023116⟩, ⟨(-11137), 255435⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4333557485⟩, ⟨0, 40815372⟩, ⟨7197128, 12335339⟩, ⟨(-593460), 1011558⟩, ⟨(-32896), 127328⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3758096384, 4333557485⟩, ⟨(-270847343), (-227620084)⟩, ⟨3746526, 12335339⟩, ⟨(-1364419), 561738⟩, ⟨(-96119), 164420⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1507893225⟩, ⟨753946612, 753946613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 529396809⟩, ⟨0, 529396810⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 529396809⟩, ⟨0, 529396810⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-529396809), 0⟩, ⟨(-529396810), 0⟩, ⟨(-132349203), (-132349201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-264698405), 0⟩, ⟨(-264698405), 0⟩, ⟨(-66174602), (-66174600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨4038260544, 4294967296⟩, ⟨(-264698405), 0⟩, ⟨(-66174602), (-54062728)⟩, ⟨0, 4078335⟩, ⟨353648, 509792⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3533477976, 4333557485⟩, ⟨(-537924058), (-214015414)⟩, ⟨(-63246581), (-18277253)⟩, ⟨740513, 8849791⟩, ⟨(-268541), 715724⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4304204024, 4304204026⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified12
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4333557485⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified13
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (247432853 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1 / 8), prawitzNormalCorrection
