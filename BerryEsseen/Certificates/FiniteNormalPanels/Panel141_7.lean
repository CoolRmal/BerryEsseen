...
namespace FiniteNormalPanel141_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (26419 / 160000)
def radius : Rat := (26419 / 800000)

def j0 : Jet := ⟨⟨709179631, 709179632⟩, ⟨141835926, 141835927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2227953518, 2227953523⟩, ⟨445590703, 445590707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1155719365, 1155719371⟩, ⟨462287744, 462287752⟩, ⟨46228774, 46228776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-25402), (-25400)⟩, ⟨(-10131), (-10128)⟩, ⟨(-1003), (-999)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5087654, 5087657⟩, ⟨(-10131), (-10128)⟩, ⟨(-1003), (-999)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1369020, 1369022⟩, ⟨544881, 544884⟩, ⟨53399, 53403⟩, ⟨(-218), (-214)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141796557), (-141796554)⟩, ⟨544881, 544884⟩, ⟨53399, 53403⟩, ⟨(-218), (-214)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-38155594), (-38155592)⟩, ⟨(-15115618), (-15115615)⟩, ⟨(-1453208), (-1453203)⟩, ⟨11552, 11557⟩, ⟨547, 550⟩⟩
...
def j19 : Jet := ⟨⟨1393500171, 1393500174⟩, ⟨(-15115618), (-15115615)⟩, ⟨(-1453208), (-1453203)⟩, ⟨11552, 11557⟩, ⟨547, 550⟩⟩
...
def j25 : Jet := ⟨⟨3176, 3178⟩, ⟨1266, 1269⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849001), (-848998)⟩, ⟨1266, 1269⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-228456), (-228454)⟩, ⟨(-91043), (-91039)⟩, ⟨(-8970), (-8966)⟩, ⟨25, 28⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35562938, 35562941⟩, ⟨(-91043), (-91039)⟩, ⟨(-8970), (-8966)⟩, ⟨25, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9569520, 9569522⟩, ⟨3803309, 3803312⟩, ⟨370566, 370571⟩, ⟨(-1940), (-1936)⟩, ⟨(-96), (-91)⟩⟩
...
def j33 : Jet := ⟨⟨(-706258363), (-706258360)⟩, ⟨3803309, 3803312⟩, ⟨370566, 370571⟩, ⟨(-1940), (-1936)⟩, ⟨(-96), (-91)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-190044863), (-190044861)⟩, ⟨(-74994526), (-74994522)⟩, ⟨(-7092713), (-7092709)⟩, ⟨80298, 80304⟩, ⟨3753, 3757⟩⟩
...
def j36 : Jet := ⟨⟨4104922433, 4104922435⟩, ⟨(-74994526), (-74994522)⟩, ⟨(-7092713), (-7092709)⟩, ⟨80298, 80304⟩, ⟨3753, 3757⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨722858497, 722858502⟩, ⟨136730686, 136730691⟩, ⟨(-2322035), (-2322030)⟩, ⟨(-144775), (-144769)⟩, ⟨1481, 1486⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4493810629, 4493810633⟩, ⟨82099279, 82099287⟩, ⟨9264555, 9264563⟩, ⟨223200, 223210⟩, ⟨14364, 14375⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨756324547, 756324554⟩, ⟨156878486, 156878495⟩, ⟨1743358, 1743367⟩, ⟨136637, 136650⟩, ⟨3294, 3306⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-709179632), (-709179631)⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3585787664, 3585787665⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨133185372, 133185376⟩, ⟨55251200, 55251206⟩, ⟨6344156, 6344163⟩, ⟨175478, 175486⟩, ⟨11847, 11858⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4428152668, 4428152672⟩, ⟨55251200, 55251206⟩, ⟨6344156, 6344163⟩, ⟨175478, 175486⟩, ⟨11847, 11858⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4361051580, 4361051583⟩, ⟨27206981, 27206985⟩, ⟨3039143, 3039148⟩, ⟨67449, 67455⟩, ⟨4353, 4360⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3640960193, 3640960198⟩, ⟨(-121303680), (-121303674)⟩, ⟨1638846, 1638852⟩, ⟨(-44054), (-44046)⟩, ⟨1406, 1414⟩⟩
...
def j47 : Jet := ⟨⟨8053260984, 8053260998⟩, ⟨1610652194, 1610652207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15100234299, 15100234352⟩, ⟨6040093708, 6040093770⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15100234299, 15100234352⟩, ⟨6040093708, 6040093770⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15100234352), (-15100234299)⟩, ⟨(-6040093770), (-6040093708)⟩, ⟨(-604009380), (-604009369)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7550117176), (-7550117149)⟩, ⟨(-3020046885), (-3020046854)⟩, ⟨(-302004690), (-302004684)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨740481444, 740481454⟩, ⟨(-520676540), (-520676527)⟩, ⟨130991656, 130991666⟩, ⟨(-6294769), (-6294764)⟩, ⟨(-3498846), (-3498844)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨627726191, 627726201⟩, ⟨(-462305194), (-462305179)⟩, ⟨126033302, 126033315⟩, ⟨(-9242147), (-9242136)⟩, ⟨(-2732720), (-2732710)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨567343704, 851015558⟩, ⟨141835926, 141835927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1782362812, 2673544226⟩, ⟨445590703, 445590707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨739660391, 1664235892⟩, ⟨369830194, 554745302⟩, ⟨46228774, 46228776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨185, 417⟩, ⟨92, 139⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94502), (-94269)⟩, ⟨92, 139⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-36619), (-16234)⟩, ⟨(-12192), (-8063)⟩, ⟨(-1010), (-991)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5076437, 5096823⟩, ⟨(-12192), (-8063)⟩, ⟨(-1010), (-991)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨874241, 1974944⟩, ⟨432395, 656927⟩, ⟨52673, 53996⟩, ⟨(-263), (-169)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142291336), (-141190632)⟩, ⟨432395, 656927⟩, ⟨52673, 53996⟩, ⟨(-263), (-169)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-55135775), (-24315230)⟩, ⟨(-18304127), (-11903065)⟩, ⟨(-1485247), (-1413928)⟩, ⟨9087, 14017⟩, ⟨527, 567⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1376519990, 1407340536⟩, ⟨(-18304127), (-11903065)⟩, ⟨(-1485247), (-1413928)⟩, ⟨9087, 14017⟩, ⟨527, 567⟩⟩
...
def j72 : Jet := ⟨⟨2030, 4580⟩, ⟨1009, 1526⟩, ⟨123, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850147), (-847596)⟩, ⟨1009, 1526⟩, ⟨123, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-329420), (-145969)⟩, ⟨(-109634), (-72392)⟩, ⟨(-9044), (-8875)⟩, ⟨19, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35461974, 35645426⟩, ⟨(-109634), (-72392)⟩, ⟨(-9044), (-8875)⟩, ⟨19, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6107105, 13812072⟩, ⟨3011070, 4591558⟩, ⟨364028, 375908⟩, ⟨(-2347), (-1529)⟩, ⟨(-98), (-89)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709720778), (-702015810)⟩, ⟨3011070, 4591558⟩, ⟨364028, 375908⟩, ⟨(-2347), (-1529)⟩, ⟨(-98), (-89)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-275006237), (-120898077)⟩, ⟨(-91150194), (-58669877)⟩, ⟨(-7317096), (-6817416)⟩, ⟨62844, 97712⟩, ⟨3576, 3901⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4019961059, 4174069219⟩, ⟨(-91150194), (-58669877)⟩, ⟨(-7317096), (-6817416)⟩, ⟨62844, 97712⟩, ⟨3576, 3901⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨571240214, 876045592⟩, ⟨131416044, 141067963⟩, ⟨(-2823544), (-1821673)⟩, ⟨(-150320), (-137965)⟩, ⟨1160, 1808⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4419367074, 4588786758⟩, ⟨62117734, 104047975⟩, ⟨8091169, 10711694⟩, ⟨107761, 363182⟩, ⟨8004, 22832⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨587785661, 935976024⟩, ⟨143484184, 171941140⟩, ⟨(-39903), 3727882⟩, ⟨32897, 257597⟩, ⟨(-5130), 13093⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-851015558), (-567343704)⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3443951738, 3727623592⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨80441120, 203971546⟩, ⟨39272916, 74940168⟩, ⟨4776058, 8508139⟩, ⟨5808, 410752⟩, ⟨(-73), 29570⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4375408416, 4498938842⟩, ⟨39272916, 74940168⟩, ⟨4776058, 8508139⟩, ⟨5808, 410752⟩, ⟨(-73), 29570⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4335001274, 4395770148⟩, ⟨19186158, 37124046⟩, ⟨2176503, 4172326⟩, ⟨(-32854), 193848⟩, ⟨(-3705), 14384⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3476053283, 3815110892⟩, ⟨(-129780252), (-110937852)⟩, ⟨519269, 2987585⟩, ⟨(-166301), 96366⟩, ⟨(-9618), 13569⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6442608778, 9663913193⟩, ⟨1610652194, 1610652207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9664149923, 21744337446⟩, ⟨4832074960, 7248112520⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9664149923, 21744337446⟩, ⟨4832074960, 7248112520⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21744337446), (-9664149923)⟩, ⟨(-7248112520), (-4832074960)⟩, ⟨(-604009380), (-604009369)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10872168723), (-4832074961)⟩, ⟨(-3624056260), (-2416037480)⟩, ⟨(-302004690), (-302004684)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨341663101, 1394294875⟩, ⟨(-1176493958), (-192194911)⟩, ⟨(-43983697), 472333351⟩, ⟨(-123840688), 67521879⟩, ⟨(-30849878), 27670304⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨276518786, 1238516897⟩, ⟨(-1087181004), (-164374504)⟩, ⟨(-34063958), 456081558⟩, ⟨(-125149325), 61315075⟩, ⟨(-29503580), 28699419⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨709179631, 709179632⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4361051580, 4361051583⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2832
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨567343704, 851015558⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4335001274, 4395770148⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2833
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (11153395 / 1073741824)

theorem envelope_integral : (∫ s in ((26419 / 200000) : ℝ)..(79257 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26419 / 200000) : ℝ)..(79257 / 400000), prawitzNormalCorrection
