...
namespace FiniteNormalPanel38_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (17431 / 80000)
def radius : Rat := (17431 / 400000)

def j0 : Jet := ⟨⟨935819686, 935819687⟩, ⟨187163937, 187163938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2939964250, 2939964254⟩, ⟨587992849, 587992853⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2012446008, 2012446014⟩, ⟨804978402, 804978410⟩, ⟨80497840, 80497842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨503, 505⟩, ⟨201, 202⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94184), (-94181)⟩, ⟨201, 202⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-44131), (-44129)⟩, ⟨(-17559), (-17556)⟩, ⟨(-1720), (-1717)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5068925, 5068928⟩, ⟨(-17559), (-17556)⟩, ⟨(-1720), (-1717)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2375090, 2375093⟩, ⟨941808, 941811⟩, ⟨90906, 90910⟩, ⟨(-651), (-646)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-140790487), (-140790483)⟩, ⟨941808, 941811⟩, ⟨90906, 90910⟩, ⟨(-651), (-646)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-65968664), (-65968661)⟩, ⟨(-25946174), (-25946169)⟩, ⟨(-2419636), (-2419631)⟩, ⟨34382, 34389⟩, ⟨1565, 1570⟩⟩
...
def j19 : Jet := ⟨⟨1365687101, 1365687105⟩, ⟨(-25946174), (-25946169)⟩, ⟨(-2419636), (-2419631)⟩, ⟨34382, 34389⟩, ⟨1565, 1570⟩⟩
...
def j25 : Jet := ⟨⟨5521, 5523⟩, ⟨2198, 2200⟩, ⟨214, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846656), (-846653)⟩, ⟨2198, 2200⟩, ⟨214, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-396709), (-396706)⟩, ⟨(-157655), (-157651)⟩, ⟨(-15358), (-15352)⟩, ⟨80, 83⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35394685, 35394689⟩, ⟨(-157655), (-157651)⟩, ⟨(-15358), (-15352)⟩, ⟨80, 83⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16584501, 16584504⟩, ⟨6559929, 6559934⟩, ⟨626634, 626641⟩, ⟨(-5797), (-5792)⟩, ⟨(-274), (-268)⟩⟩
...
def j33 : Jet := ⟨⟨(-699243382), (-699243378)⟩, ⟨6559929, 6559934⟩, ⟨626634, 626641⟩, ⟨(-5797), (-5792)⟩, ⟨(-274), (-268)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-327636851), (-327636847)⟩, ⟨(-127981027), (-127981021)⟩, ⟨(-11582375), (-11582367)⟩, ⟨237677, 237684⟩, ⟨10528, 10535⟩⟩
...
def j36 : Jet := ⟨⟨3967330445, 3967330449⟩, ⟨(-127981027), (-127981021)⟩, ⟨(-11582375), (-11582367)⟩, ⟨237677, 237684⟩, ⟨10528, 10535⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨934831624, 934831629⟩, ⟨169205810, 169205818⟩, ⟨(-5208378), (-5208371)⟩, ⟨(-307721), (-307714)⟩, ⟨5777, 5783⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4649661607, 4649661613⟩, ⟨149992153, 149992162⟩, ⟨18412943, 18412957⟩, ⟨753307, 753319⟩, ⟨56719, 56734⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1012033482, 1012033490⟩, ⟨215826361, 215826374⟩, ⟨4278343, 4278358⟩, ⟨374338, 374353⟩, ⟨15200, 15214⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-935819687), (-935819686)⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3359147609, 3359147610⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨238467885, 238467890⟩, ⟨101711368, 101711378⟩, ⟨12861720, 12861730⟩, ⟨606392, 606404⟩, ⟨49043, 49056⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4533435181, 4533435186⟩, ⟨101711368, 101711378⟩, ⟨12861720, 12861730⟩, ⟨606392, 606404⟩, ⟨49043, 49056⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4412590604, 4412590607⟩, ⟨49500059, 49500065⟩, ⟨5981793, 5981799⟩, ⟨228009, 228018⟩, ⟨17254, 17263⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3451142268, 3451142272⟩, ⟨(-153575054), (-153575046)⟩, ⟨2521345, 2521352⟩, ⟨(-82344), (-82335)⟩, ⟨3557, 3566⟩⟩
...
def j47 : Jet := ⟨⟨6390290683, 6390290692⟩, ⟨1278058135, 1278058143⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9507829093, 9507829121⟩, ⟨3803131632, 3803131662⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9507829093, 9507829121⟩, ⟨3803131632, 3803131662⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9507829121), (-9507829093)⟩, ⟨(-3803131662), (-3803131632)⟩, ⟨(-380313168), (-380313162)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4753914561), (-4753914546)⟩, ⟨(-1901565831), (-1901565816)⟩, ⟨(-190156584), (-190156581)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1419900712, 1419900731⟩, ⟨(-628650821), (-628650806)⟩, ⟨76300224, 76300232⟩, ⟨7294914, 7294917⟩, ⟨(-2496512), (-2496511)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1140935198, 1140935215⟩, ⟨(-555912210), (-555912191)⟩, ⟨84621845, 84621858⟩, ⟨2737156, 2737166⟩, ⟨(-2208855), (-2208845)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨748655749, 1122983625⟩, ⟨187163937, 187163938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2351971401, 3527957107⟩, ⟨587992849, 587992853⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1287965446, 2897922264⟩, ⟨643982720, 965974092⟩, ⟨80497840, 80497842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨322, 727⟩, ⟨161, 243⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94365), (-93959)⟩, ⟨161, 243⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-63671), (-28176)⟩, ⟨(-21176), (-13924)⟩, ⟨(-1740), (-1691)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5049385, 5084881⟩, ⟨(-21176), (-13924)⟩, ⟨(-1740), (-1691)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1514198, 3430897⟩, ⟨742811, 1139458⟩, ⟨88699, 92709⟩, ⟨(-788), (-506)⟩, ⟨(-33), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141651379), (-139734679)⟩, ⟨742811, 1139458⟩, ⟨88699, 92709⟩, ⟨(-788), (-506)⟩, ⟨(-33), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-95575742), (-41903331)⟩, ⟨(-31635829), (-20182844)⟩, ⟨(-2516908), (-2300130)⟩, ⟨26689, 42058⟩, ⟨1461, 1655⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1336080023, 1389752435⟩, ⟨(-31635829), (-20182844)⟩, ⟨(-2516908), (-2300130)⟩, ⟨26689, 42058⟩, ⟨1461, 1655⟩⟩
...
def j70 : Jet := ⟨⟨(-73), (-32)⟩, ⟨(-25), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11762, 11804⟩, ⟨(-25), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3527, 7965⟩, ⟨1746, 2651⟩, ⟨211, 220⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848650), (-844211)⟩, ⟨1746, 2651⟩, ⟨211, 220⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-572606), (-253160)⟩, ⟨(-190346), (-124791)⟩, ⟨(-15582), (-15076)⟩, ⟨61, 100⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35218788, 35538235⟩, ⟨(-190346), (-124791)⟩, ⟨(-15582), (-15076)⟩, ⟨61, 100⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10561333, 23978540⟩, ⟨5152234, 7955425⟩, ⟨606758, 642840⟩, ⟨(-7055), (-4530)⟩, ⟨(-284), (-255)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705266550), (-691849342)⟩, ⟨5152234, 7955425⟩, ⟨606758, 642840⟩, ⟨(-7055), (-4530)⟩, ⟨(-284), (-255)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-475861048), (-207470275)⟩, ⟨(-157075310), (-98367412)⟩, ⟨(-12263890), (-10743909)⟩, ⟨182780, 292327⟩, ⟨9593, 11294⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3819106248, 4087497021⟩, ⟨(-157075310), (-98367412)⟩, ⟨(-12263890), (-10743909)⟩, ⟨182780, 292327⟩, ⟨9593, 11294⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨731652137, 1141565615⟩, ⟨156926841, 179208590⟩, ⟨(-6398463), (-4022662)⟩, ⟨(-329957), (-280346)⟩, ⟨4453, 7118⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4512968200, 4830120682⟩, ⟨108606562, 198657136⟩, ⟨14475915, 23680987⟩, ⟨288401, 1395912⟩, ⟨17434, 116926⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨768788817, 1283804814⟩, ⟨183393262, 254339370⟩, ⟨(-761528), 10356383⟩, ⟨(-88982), 962823⟩, ⟨(-32356), 76681⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1122983625), (-748655749)⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3171983671, 3546311547⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨137611349, 383740944⟩, ⟨65653904, 152048706⟩, ⟨7375557, 21252705⟩, ⟨(-143390), 1802164⟩, ⟨(-31721), 184849⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4432578645, 4678708240⟩, ⟨65653904, 152048706⟩, ⟨7375557, 21252705⟩, ⟨(-143390), 1802164⟩, ⟨(-31721), 184849⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4363230490, 4482733416⟩, ⟨31451945, 74834945⟩, ⟨2908661, 10346744⟩, ⟨(-248034), 866018⟩, ⟨(-42735), 94264⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3222398428, 3701348155⟩, ⟨(-172117955), (-128348210)⟩, ⟨(-1112973), 7172607⟩, ⟨(-655686), 588311⟩, ⟨(-73025), 88642⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5112232548, 7668348835⟩, ⟨1278058135, 1278058143⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6085010623, 13691273950⟩, ⟨3042505306, 4563757998⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6085010623, 13691273950⟩, ⟨3042505306, 4563757998⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13691273950), (-6085010623)⟩, ⟨(-4563757998), (-3042505306)⟩, ⟨(-380313168), (-380313162)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6845636975), (-3042505311)⟩, ⟨(-2281878999), (-1521252653)⟩, ⟨(-190156584), (-190156581)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨872467282, 2115001398⟩, ⟨(-1123681961), (-309022880)⟩, ⟨(-38913103), 259873397⟩, ⟨(-36901654), 40058206⟩, ⟨(-11073499), 5762808⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨654588732, 1822681288⟩, ⟨(-1053132087), (-257923839)⟩, ⟨(-24848234), 272518453⟩, ⟨(-44415067), 36661962⟩, ⟨(-11405530), 7094312⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨935819686, 935819687⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4412590604, 4412590607⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified746
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨748655749, 1122983625⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4363230490, 4482733416⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified747
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (25505069 / 1073741824)

theorem envelope_integral : (∫ s in ((17431 / 100000) : ℝ)..(52293 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((17431 / 100000) : ℝ)..(52293 / 200000), prawitzNormalCorrection
