...
namespace FiniteNormalPanel62_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (254933 / 800000)
def radius : Rat := (36419 / 800000)

def j0 : Jet := ⟨⟨1368661122, 1368661123⟩, ⟨195523017, 195523018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4299775725, 4299775730⟩, ⟨614253673, 614253677⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4304589537, 4304589548⟩, ⟨1229882720, 1229882732⟩, ⟨87848765, 87848767⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1077, 1079⟩, ⟨307, 309⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93610), (-93607)⟩, ⟨307, 309⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-93820), (-93816)⟩, ⟨(-26499), (-26494)⟩, ⟨(-1807), (-1801)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5019236, 5019241⟩, ⟨(-26499), (-26494)⟩, ⟨(-1807), (-1801)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5030480, 5030486⟩, ⟨1410721, 1410729⟩, ⟨93261, 93272⟩, ⟨(-1049), (-1041)⟩, ⟨(-34), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-138135097), (-138135090)⟩, ⟨1410721, 1410729⟩, ⟨93261, 93272⟩, ⟨(-1049), (-1041)⟩, ⟨(-34), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-138444569), (-138444561)⟩, ⟨(-38141711), (-38141698)⟩, ⟨(-2327965), (-2327949)⟩, ⟨54507, 54521⟩, ⟨1571, 1581⟩⟩
...
def j19 : Jet := ⟨⟨1293211196, 1293211205⟩, ⟨(-38141711), (-38141698)⟩, ⟨(-2327965), (-2327949)⟩, ⟨54507, 54521⟩, ⟨1571, 1581⟩⟩
...
def j25 : Jet := ⟨⟨11752, 11756⟩, ⟨3325, 3329⟩, ⟨226, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840425), (-840420)⟩, ⟨3325, 3329⟩, ⟨226, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-842308), (-842302)⟩, ⟨(-237328), (-237320)⟩, ⟨(-16012), (-16004)⟩, ⟨129, 135⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨34949086, 34949093⟩, ⟨(-237328), (-237320)⟩, ⟨(-16012), (-16004)⟩, ⟨129, 135⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨35027384, 35027392⟩, ⟨9769964, 9769976⟩, ⟨630836, 630849⟩, ⟨(-9312), (-9300)⟩, ⟨(-291), (-282)⟩⟩
...
def j33 : Jet := ⟨⟨(-680800499), (-680800490)⟩, ⟨9769964, 9769976⟩, ⟨630836, 630849⟩, ⟨(-9312), (-9300)⟩, ⟨(-291), (-282)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-682325734), (-682325723)⟩, ⟨(-185158359), (-185158340)⟩, ⟨(-10495095), (-10495075)⟩, ⟨371142, 371161⟩, ⟨9944, 9959⟩⟩
...
def j36 : Jet := ⟨⟨3612641562, 3612641573⟩, ⟨(-185158359), (-185158340)⟩, ⟨(-10495095), (-10495075)⟩, ⟨371142, 371161⟩, ⟨9944, 9959⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1294659010, 1294659021⟩, ⟨146766873, 146766891⟩, ⟨(-7785489), (-7785469)⟩, ⟨(-278371), (-278353)⟩, ⟨9367, 9381⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5106165032, 5106165048⟩, ⟨261705740, 261705771⟩, ⟨28247081, 28247116⟩, ⟨1683418, 1683452⟩, ⟨127375, 127405⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1539183446, 1539183465⟩, ⟨253374587, 253374621⟩, ⟨8201709, 8201749⟩, ⟨667354, 667392⟩, ⟨38889, 38922⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1368661123), (-1368661122)⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2926306173, 2926306174⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨551595743, 551595758⟩, ⟨181603230, 181603260⟩, ⟨20825896, 20825933⟩, ⟨1446010, 1446044⟩, ⟨122272, 122305⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4846563039, 4846563054⟩, ⟨181603230, 181603260⟩, ⟨20825896, 20825933⟩, ⟨1446010, 1446044⟩, ⟨122272, 122305⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4562436821, 4562436829⟩, ⟨85478436, 85478451⟩, ⟨9001765, 9001784⟩, ⟨511968, 511986⟩, ⟨39078, 39096⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3108542187, 3108542194⟩, ⟨(-149459892), (-149459878)⟩, ⟨2241906, 2241922⟩, ⟨(-60974), (-60960)⟩, ⟨3317, 3332⟩⟩
...
def j47 : Jet := ⟨⟨7465025830, 7465025838⟩, ⟨1066432259, 1066432265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12974862624, 12974862653⟩, ⟨3707103598, 3707103624⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12974862624, 12974862653⟩, ⟨3707103598, 3707103624⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12974862653), (-12974862624)⟩, ⟨(-3707103624), (-3707103598)⟩, ⟨(-264793117), (-264793113)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6487431327), (-6487431312)⟩, ⟨(-1853551812), (-1853551799)⟩, ⟨(-132396559), (-132396556)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨948352629, 948352641⟩, ⟨(-409274539), (-409274530)⟩, ⟨59080110, 59080115⟩, ⟨(-88086), (-88084)⟩, ⟨(-901098), (-901097)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨686383376, 686383387⟩, ⟨(-329219704), (-329219692)⟩, ⟨57497352, 57497364⟩, ⟨(-2346775), (-2346765)⟩, ⟨(-611740), (-611728)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1173138104, 1564184140⟩, ⟨195523017, 195523018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3685522049, 4914029404⟩, ⟨614253673, 614253677⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3162555576, 5622321038⟩, ⟨1054185188, 1405580264⟩, ⟨87848765, 87848767⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨791, 1409⟩, ⟨263, 353⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93896), (-93277)⟩, ⟨263, 353⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-122915), (-68683)⟩, ⟨(-30536), (-22431)⟩, ⟨(-1842), (-1760)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4990141, 5044374⟩, ⟨(-30536), (-22431)⟩, ⟨(-1842), (-1760)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3674439, 6603331⟩, ⟨1184839, 1634317⟩, ⟨89661, 96378⟩, ⟨(-1221), (-868)⟩, ⟨(-36), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139491138), (-136562245)⟩, ⟨1184839, 1634317⟩, ⟨89661, 96378⟩, ⟨(-1221), (-868)⟩, ⟨(-36), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-182600683), (-100556223)⟩, ⟨(-44777727), (-31379339)⟩, ⟨(-2496302), (-2132213)⟩, ⟨44641, 64331⟩, ⟨1385, 1740⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1249055082, 1331099543⟩, ⟨(-44777727), (-31379339)⟩, ⟨(-2496302), (-2132213)⟩, ⟨44641, 64331⟩, ⟨1385, 1740⟩⟩
...
def j72 : Jet := ⟨⟨8610, 15392⟩, ⟨2822, 3829⟩, ⟨223, 234⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843567), (-836784)⟩, ⟨2822, 3829⟩, ⟨223, 234⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1104271), (-616157)⟩, ⟨(-273991), (-200372)⟩, ⟨(-16399), (-15554)⟩, ⟨108, 156⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34687123, 35175238⟩, ⟨(-273991), (-200372)⟩, ⟨(-16399), (-15554)⟩, ⟨108, 156⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨25541510, 46046097⟩, ⟨8155168, 11363984⟩, ⟨598351, 658838⟩, ⟨(-10893), (-7710)⟩, ⟨(-310), (-259)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-690286373), (-669781785)⟩, ⟨8155168, 11363984⟩, ⟨598351, 658838⟩, ⟨(-10893), (-7710)⟩, ⟨(-310), (-259)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-903618429), (-493187019)⟩, ⟨(-219899633), (-149519664)⟩, ⟨(-11676792), (-9118186)⟩, ⟨299407, 442374⟩, ⟨8267, 11394⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3391348867, 3801780277⟩, ⟨(-219899633), (-149519664)⟩, ⟨(-11676792), (-9118186)⟩, ⟨299407, 442374⟩, ⟨8267, 11394⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1071817252, 1522959745⟩, ⟨127404370, 163443281⟩, ⟨(-9260091), (-6317438)⟩, ⟨(-318708), (-231338)⟩, ⟨7572, 11192⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4852133140, 5439353130⟩, ⟨190828838, 352694992⟩, ⟨19142430, 41597519⟩, ⟨577610, 3483237⟩, ⟨11285, 340410⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1210859047, 1928749461⟩, ⟨191553636, 332055148⟩, ⟨(-1289718), 21034835⟩, ⟨(-452074), 2276069⟩, ⟨(-87354), 229002⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1564184140), (-1173138104)⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2730783156, 3121829192⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨341371547, 866147337⟩, ⟨108007552, 298233326⟩, ⟨7384853, 44564362⟩, ⟨(-605452), 5296756⟩, ⟨(-154679), 660636⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4636338843, 5161114633⟩, ⟨108007552, 298233326⟩, ⟨7384853, 44564362⟩, ⟨(-605452), 5296756⟩, ⟨(-154679), 660636⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4462389909, 4708165095⟩, ⟨49264298, 143522015⟩, ⟨1180834, 21174249⟩, ⟨(-972388), 2535979⟩, ⟨(-206240), 349044⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2837232127, 3422165112⟩, ⟨(-183010599), (-98824668)⟩, ⟨(-5782875), 13147967⟩, ⟨(-1670720), 1789541⟩, ⟨(-265356), 297973⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6398593565, 8531458098⟩, ⟨1066432259, 1066432265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9532552121, 16946759373⟩, ⟨3177517368, 4236689856⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9532552121, 16946759373⟩, ⟨3177517368, 4236689856⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16946759373), (-9532552121)⟩, ⟨(-4236689856), (-3177517368)⟩, ⟨(-264793117), (-264793113)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8473379687), (-4766276060)⟩, ⟨(-2118344928), (-1588758684)⟩, ⟨(-132396559), (-132396556)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨597250588, 1415819934⟩, ⟨(-698304497), (-220929984)⟩, ⟨(-2781738), 153796509⟩, ⟨(-20744692), 14807945⟩, ⟨(-4196342), 2600777⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨394540502, 1128103953⟩, ⟨(-616727244), (-159687534)⟩, ⟨960717, 156632003⟩, ⟨(-25770833), 13447415⟩, ⟨(-4560063), 3796875⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1368661122, 1368661123⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4562436821, 4562436829⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1230
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1173138104, 1564184140⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4462389909, 4708165095⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1231
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (16076907 / 1073741824)

theorem envelope_integral : (∫ s in ((109257 / 400000) : ℝ)..(36419 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((109257 / 400000) : ℝ)..(36419 / 100000), prawitzNormalCorrection
