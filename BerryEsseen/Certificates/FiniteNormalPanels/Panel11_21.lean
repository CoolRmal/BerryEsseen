...
namespace FiniteNormalPanel11_21
...
def j2 : Jet := ⟨⟨645152729, 645152733⟩, ⟨645152729, 645152733⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨96909246, 96909248⟩, ⟨193818492, 193818496⟩, ⟨96909246, 96909248⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-2136), (-2135)⟩, ⟨(-4271), (-4269)⟩, ⟨(-2134), (-2131)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110920, 5110922⟩, ⟨(-4271), (-4269)⟩, ⟨(-2134), (-2131)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨115319, 115320⟩, ⟨230542, 230544⟩, ⟨115077, 115080⟩, ⟨(-194), (-191)⟩, ⟨(-49), (-46)⟩⟩
...
def j16 : Jet := ⟨⟨(-143050258), (-143050256)⟩, ⟨230542, 230544⟩, ⟨115077, 115080⟩, ⟨(-194), (-191)⟩, ⟨(-49), (-46)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3227707), (-3227706)⟩, ⟨(-6450212), (-6450210)⟩, ⟨(-3214708), (-3214705)⟩, ⟨10389, 10392⟩, ⟨2585, 2588⟩⟩
...
def j19 : Jet := ⟨⟨1428428058, 1428428060⟩, ⟨(-6450212), (-6450210)⟩, ⟨(-3214708), (-3214705)⟩, ⟨10389, 10392⟩, ⟨2585, 2588⟩⟩
...
def j25 : Jet := ⟨⟨266, 268⟩, ⟨532, 535⟩, ⟨264, 268⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851911), (-851908)⟩, ⟨532, 535⟩, ⟨264, 268⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-19223), (-19221)⟩, ⟨(-38433), (-38430)⟩, ⟨(-19194), (-19189)⟩, ⟨22, 26⟩, ⟨3, 7⟩⟩
...
def j30 : Jet := ⟨⟨35772171, 35772174⟩, ⟨(-38433), (-38430)⟩, ⟨(-19194), (-19189)⟩, ⟨22, 26⟩, ⟨3, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨807143, 807144⟩, ⟨1613418, 1613420⟩, ⟨804974, 804978⟩, ⟨(-1735), (-1731)⟩, ⟨(-434), (-429)⟩⟩
...
def j33 : Jet := ⟨⟨(-715020740), (-715020738)⟩, ⟨1613418, 1613420⟩, ⟨804974, 804978⟩, ⟨(-1735), (-1731)⟩, ⟨(-434), (-429)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-16133330), (-16133329)⟩, ⟨(-32230255), (-32230253)⟩, ⟨(-16042360), (-16042356)⟩, ⟨72689, 72693⟩, ⟨18073, 18077⟩⟩
...
def j36 : Jet := ⟨⟨4278833966, 4278833967⟩, ⟨(-32230255), (-32230253)⟩, ⟨(-16042360), (-16042356)⟩, ⟨72689, 72693⟩, ⟨18073, 18077⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨214566071, 214566074⟩, ⟨213597176, 213597180⟩, ⟨(-1451781), (-1451779)⟩, ⟨(-481326), (-481324)⟩, ⟨1948, 1950⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4311161455, 4311161457⟩, ⟨32473759, 32473763⟩, ⟨16408166, 16408173⟩, ⟨172102, 172110⟩, ⟨44046, 44056⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨215375091, 215375095⟩, ⟨216024852, 216024858⟩, ⟨977439, 977446⟩, ⟨330489, 330496⟩, ⟨3526, 3534⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-205358493), (-205358492)⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4089608803, 4089608804⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨10800182, 10800183⟩, ⟨21665530, 21665532⟩, ⟨10963474, 10963477⟩, ⟨131468, 131474⟩, ⟨33818, 33827⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4305767478, 4305767479⟩, ⟨21665530, 21665532⟩, ⟨10963474, 10963477⟩, ⟨131468, 131474⟩, ⟨33818, 33827⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4300363996, 4300363997⟩, ⟨10819170, 10819172⟩, ⟨5461247, 5461250⟩, ⟨51910, 51915⟩, ⟨13288, 13295⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4094747466, 4094747469⟩, ⟨(-195314666), (-195314661)⟩, ⟨4682818, 4682823⟩, ⟨(-211696), (-211689)⟩, ⟨10169, 10178⟩⟩
...
def j47 : Jet := ⟨⟨1078587754, 1078587760⟩, ⟨1078587754, 1078587760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨270863888, 270863892⟩, ⟨541727776, 541727784⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨270863888, 270863892⟩, ⟨541727776, 541727784⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-270863892), (-270863888)⟩, ⟨(-541727784), (-541727776)⟩, ⟨(-270863892), (-270863888)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-135431946), (-135431944)⟩, ⟨(-270863892), (-270863888)⟩, ⟨(-135431946), (-135431944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4161648350, 4161648353⟩, ⟨(-262456078), (-262456073)⟩, ⟨(-122952089), (-122952085)⟩, ⟨8101974, 8101976⟩, ⟨1810767, 1810768⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3967643490, 3967643497⟩, ⟨(-439473038), (-439473026)⟩, ⟨(-100747683), (-100747671)⟩, ⟨12824273, 12824286⟩, ⟨1246645, 1246661⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 410716986⟩, ⟨205358492, 205358493⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1290305466⟩, ⟨645152729, 645152733⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 387636991⟩, ⟨0, 387636992⟩, ⟨96909246, 96909248⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-8546), 0⟩, ⟨(-8546), 9⟩, ⟨(-2137), (-2122)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5104510, 5113057⟩, ⟨(-8546), 9⟩, ⟨(-2137), (-2122)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 461473⟩, ⟨(-772), 461474⟩, ⟨114210, 115370⟩, ⟨(-386), 2⟩, ⟨(-49), (-45)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142704103)⟩, ⟨(-772), 461474⟩, ⟨114210, 115370⟩, ⟨(-386), 2⟩, ⟨(-49), (-45)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-12921234), 0⟩, ⟨(-12921304), 41650⟩, ⟨(-3230379), (-3167832)⟩, ⟨(-53), 20827⟩, ⟨2536, 2605⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1418734531, 1431655766⟩, ⟨(-12921304), 41650⟩, ⟨(-3230379), (-3167832)⟩, ⟨(-53), 20827⟩, ⟨2536, 2605⟩⟩
...
def j72 : Jet := ⟨⟨0, 1069⟩, ⟨(-1), 1069⟩, ⟨264, 268⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851107)⟩, ⟨(-1), 1069⟩, ⟨264, 268⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-76913), 0⟩, ⟨(-76914), 97⟩, ⟨(-19230), (-19081)⟩, ⟨(-2), 50⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35714481, 35791395⟩, ⟨(-76914), 97⟩, ⟨(-19230), (-19081)⟩, ⟨(-2), 50⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3230309⟩, ⟨(-6942), 3230318⟩, ⟨797163, 807587⟩, ⟨(-3473), 8⟩, ⟨(-435), (-424)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712597573)⟩, ⟨(-6942), 3230318⟩, ⟨797163, 807587⟩, ⟨(-3473), 8⟩, ⟨(-435), (-424)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-64606166), 0⟩, ⟨(-64606793), 291549⟩, ⟨(-16152169), (-15714217)⟩, ⟨(-471), 145777⟩, ⟨17632, 18223⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4230361130, 4294967296⟩, ⟨(-64606793), 291549⟩, ⟨(-16152169), (-15714217)⟩, ⟨(-471), 145777⟩, ⟨17632, 18223⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 430101823⟩, ⟨209228140, 215063425⟩, ⟨(-2911407), 6257⟩, ⟨(-485256), (-469587)⟩, ⟨(-8), 3912⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4360560129⟩, ⟨(-300523), 66595215⟩, ⟨15709696, 17666344⟩, ⟨(-152631), 524561⟩, ⟨34418, 57576⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 436670348⟩, ⟨209198045, 225016783⟩, ⟨(-2970920), 5110123⟩, ⟨212198, 467762⟩, ⟨(-27153), 36065⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-410716986), 0⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3884250310, 4294967296⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 44396379⟩, ⟨0, 45755020⟩, ⟨9585448, 12827906⟩, ⟨(-311298), 630564⟩, ⟨11613, 62428⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4339363675⟩, ⟨0, 45755020⟩, ⟨9585448, 12827906⟩, ⟨(-311298), 630564⟩, ⟨11613, 62428⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4317108416⟩, ⟨0, 22877510⟩, ⟨4707526, 6413953⟩, ⟨(-189814), 315282⟩, ⟨(-663), 29647⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3884250310, 4317108416⟩, ⟨(-206417143), (-182480982)⟩, ⟨3163497, 6413953⟩, ⟨(-496490), 90198⟩, ⟨(-15738), 38723⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2157175520⟩, ⟨1078587754, 1078587760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1083455567⟩, ⟨0, 1083455568⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1083455567⟩, ⟨0, 1083455568⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1083455567), 0⟩, ⟨(-1083455568), 0⟩, ⟨(-270863892), (-270863888)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-541727784), 0⟩, ⟨(-541727784), 0⟩, ⟨(-135431946), (-135431944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3786011582, 4294967296⟩, ⟨(-541727784), 0⟩, ⟨(-135431946), (-85218905)⟩, ⟨0, 17082144⟩, ⟨804945, 2135268⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3423964758, 4317108416⟩, ⟨(-750937605), (-160856896)⟩, ⟨(-133341495), (-44620115)⟩, ⟨2315221, 23769295⟩, ⟨(-322367), 2184854⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4300363996, 4300363997⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified224
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4317108416⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified225
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (376246199 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(38251 / 400000), prawitzNormalCorrection
