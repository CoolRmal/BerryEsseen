...
namespace FiniteNormalPanel30_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (18579 / 80000)
def radius : Rat := (18579 / 400000)

def j0 : Jet := ⟨⟨997452467, 997452468⟩, ⟨199490493, 199490494⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3133589342, 3133589346⟩, ⟨626717867, 626717871⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2286253069, 2286253076⟩, ⟨914501224, 914501234⟩, ⟨91450122, 91450124⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨572, 573⟩, ⟨228, 230⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94115), (-94113)⟩, ⟨228, 230⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-50099), (-50097)⟩, ⟨(-19919), (-19915)⟩, ⟨(-1945), (-1941)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5062957, 5062960⟩, ⟨(-19919), (-19915)⟩, ⟨(-1945), (-1941)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2695061, 2695064⟩, ⟨1067420, 1067426⟩, ⟨102524, 102530⟩, ⟨(-836), (-831)⟩, ⟨(-41), (-37)⟩⟩
...
def j16 : Jet := ⟨⟨(-140470516), (-140470512)⟩, ⟨1067420, 1067426⟩, ⟨102524, 102530⟩, ⟨(-836), (-831)⟩, ⟨(-41), (-37)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-74773829), (-74773826)⟩, ⟨(-29341334), (-29341328)⟩, ⟨(-2709101), (-2709094)⟩, ⟨44110, 44119⟩, ⟨1981, 1989⟩⟩
...
def j19 : Jet := ⟨⟨1356881936, 1356881940⟩, ⟨(-29341334), (-29341328)⟩, ⟨(-2709101), (-2709094)⟩, ⟨44110, 44119⟩, ⟨1981, 1989⟩⟩
...
def j22 : Jet := ⟨⟨(-58), (-56)⟩, ⟨(-23), (-22)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11777, 11780⟩, ⟨(-23), (-22)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6269, 6271⟩, ⟨2494, 2498⟩, ⟨243, 246⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845908), (-845905)⟩, ⟨2494, 2498⟩, ⟨243, 246⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-450286), (-450283)⟩, ⟨(-178788), (-178783)⟩, ⟨(-17352), (-17348)⟩, ⟨102, 107⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35341108, 35341112⟩, ⟨(-178788), (-178783)⟩, ⟨(-17352), (-17348)⟩, ⟨102, 107⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18812417, 18812420⟩, ⟨7429795, 7429801⟩, ⟨705190, 705196⟩, ⟨(-7448), (-7442)⟩, ⟨(-348), (-342)⟩⟩
...
def j33 : Jet := ⟨⟨(-697015466), (-697015462)⟩, ⟨7429795, 7429801⟩, ⟨705190, 705196⟩, ⟨(-7448), (-7442)⟩, ⟨(-348), (-342)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-371028147), (-371028142)⟩, ⟨(-144456308), (-144456300)⟩, ⟨(-12883767), (-12883759)⟩, ⟨304384, 304392⟩, ⟨13243, 13250⟩⟩
...
def j36 : Jet := ⟨⟨3923939149, 3923939154⟩, ⟨(-144456308), (-144456300)⟩, ⟨(-12883767), (-12883759)⟩, ⟨304384, 304392⟩, ⟨13243, 13250⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨989975122, 989975127⟩, ⟨176587714, 176587722⟩, ⟨(-6258011), (-6258003)⟩, ⟨(-363128), (-363118)⟩, ⟨7881, 7890⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4701078011, 4701078018⟩, ⟨173065969, 173065981⟩, ⟨21806664, 21806677⟩, ⟨1006354, 1006368⟩, ⟨79346, 79360⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1083582238, 1083582246⟩, ⟨233176075, 233176089⟩, ⟨5292234, 5292250⟩, ⟨478911, 478930⟩, ⟨21883, 21903⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-997452468), (-997452467)⟩, ⟨(-199490494), (-199490493)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3297514828, 3297514829⟩, ⟨(-199490494), (-199490493)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨273378208, 273378213⟩, ⟨117656520, 117656530⟩, ⟨15329620, 15329632⟩, ⟨816286, 816300⟩, ⟨69561, 69578⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4568345504, 4568345509⟩, ⟨117656520, 117656530⟩, ⟨15329620, 15329632⟩, ⟨816286, 816300⟩, ⟨69561, 69578⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4429547893, 4429547896⟩, ⟨57040912, 57040918⟩, ⟨7064665, 7064672⟩, ⟨304767, 304777⟩, ⟨24164, 24175⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3400840763, 3400840767⟩, ⟨(-161947554), (-161947547)⟩, ⟨2774575, 2774584⟩, ⟨(-94149), (-94139)⟩, ⟨4395, 4406⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨22613002812, 22613002814⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value228

def j47 : Jet := ⟨⟨5251587238, 5251587245⟩, ⟨1050317445, 1050317451⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6421275557, 6421275575⟩, ⟨2568510216, 2568510236⟩, ⟨256851021, 256851024⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6421275557, 6421275575⟩, ⟨2568510216, 2568510236⟩, ⟨256851021, 256851024⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6421275575), (-6421275557)⟩, ⟨(-2568510236), (-2568510216)⟩, ⟨(-256851024), (-256851021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3210637788), (-3210637778)⟩, ⟨(-1284255118), (-1284255108)⟩, ⟨(-128425512), (-128425510)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2033806328, 2033806344⟩, ⟨(-608136460), (-608136450)⟩, ⟨30106992, 30106997⟩, ⟨9121947, 9121949⟩, ⟨(-1132019), (-1132017)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1610408412, 1610408427⟩, ⟨(-558222000), (-558221985)⟩, ⟨48083773, 48083786⟩, ⟨5650268, 5650282⟩, ⟨(-1205453), (-1205440)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨797961973, 1196942961⟩, ⟨199490493, 199490494⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2506871472, 3760307214⟩, ⟨626717867, 626717871⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1463201962, 3292204427⟩, ⟨731600980, 1097401480⟩, ⟨91450122, 91450124⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨366, 825⟩, ⟨183, 275⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94321), (-93861)⟩, ⟨183, 275⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-72300), (-31976)⟩, ⟨(-24038), (-15777)⟩, ⟨(-1971), (-1909)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5040756, 5081081⟩, ⟨(-24038), (-15777)⟩, ⟨(-1971), (-1909)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1717275, 3894782⟩, ⟨840211, 1292887⟩, ⟨99676, 104852⟩, ⟨(-1014), (-650)⟩, ⟨(-41), (-35)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141448302), (-139270794)⟩, ⟨840211, 1292887⟩, ⟨99676, 104852⟩, ⟨(-1014), (-650)⟩, ⟨(-41), (-35)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-108423812), (-47446531)⟩, ⟨(-35855030), (-22732233)⟩, ⟨(-2834696), (-2554692)⟩, ⟨34090, 54099⟩, ⟨1830, 2112⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1323231953, 1384209235⟩, ⟨(-35855030), (-22732233)⟩, ⟨(-2834696), (-2554692)⟩, ⟨34090, 54099⟩, ⟨1830, 2112⟩⟩
...
def j70 : Jet := ⟨⟨(-83), (-36)⟩, ⟨(-28), (-18)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11752, 11800⟩, ⟨(-28), (-18)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4003, 9046⟩, ⟨1979, 3010⟩, ⟨239, 249⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848174), (-843130)⟩, ⟨1979, 3010⟩, ⟨239, 249⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-650148), (-287236)⟩, ⟨(-216042), (-141310)⟩, ⟨(-17642), (-16991)⟩, ⟨80, 129⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35141246, 35504159⟩, ⟨(-216042), (-141310)⟩, ⟨(-17642), (-16991)⟩, ⟨80, 129⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11971858, 27214864⟩, ⟨5820327, 9023481⟩, ⟨679516, 726111⟩, ⟨(-9082), (-5803)⟩, ⟨(-362), (-323)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703856025), (-688613018)⟩, ⟨5820327, 9023481⟩, ⟨679516, 726111⟩, ⟨(-9082), (-5803)⟩, ⟨(-362), (-323)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-539523997), (-234595481)⟩, ⟨(-177858475), (-110381006)⟩, ⟨(-13763853), (-11800055)⟩, ⟨232714, 375684⟩, ⟨11869, 14363⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3755443299, 4060371815⟩, ⟨(-177858475), (-110381006)⟩, ⟨(-13763853), (-11800055)⟩, ⟨232714, 375684⟩, ⟨11869, 14363⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨772339392, 1211895601⟩, ⟨161693239, 188714331⟩, ⟨(-7713754), (-4808180)⟩, ⟨(-393740), (-325413)⟩, ⟨6042, 9745⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4543116964, 4912001755⟩, ⟨123504408, 232633294⟩, ⟨16560445, 29020243⟩, ⟨354634, 1945493⟩, ⟨18866, 176491⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨816962726, 1386002014⟩, ⟨193244454, 281467194⟩, ⟨(-1194390), 13324112⟩, ⟨(-180893), 1341583⟩, ⟨(-50315), 118533⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1196942961), (-797961973)⟩, ⟨(-199490494), (-199490493)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3098024335, 3497005323⟩, ⟨(-199490494), (-199490493)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨155397713, 447268035⟩, ⟨73515584, 181661034⟩, ⟨7923822, 27045206⟩, ⟨(-273298), 2612238⟩, ⟨(-59890), 293679⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4450365009, 4742235331⟩, ⟨73515584, 181661034⟩, ⟨7923822, 27045206⟩, ⟨(-273298), 2612238⟩, ⟨(-59890), 293679⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4371975774, 4513063888⟩, ⟨34981449, 89230618⟩, ⟨2888331, 13144467⟩, ⟨(-402517), 1260004⟩, ⟨(-74895), 151515⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3153571705, 3674581750⟩, ⟨(-184387893), (-130414882)⟩, ⟨(-2061144), 9077557⟩, ⟨(-938262), 891753⟩, ⟨(-119506), 142062⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4201269787, 6301904690⟩, ⟨1050317445, 1050317451⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4109616350, 9246636816⟩, ⟨2054808170, 3082212280⟩, ⟨256851021, 256851024⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4109616350, 9246636816⟩, ⟨2054808170, 3082212280⟩, ⟨256851021, 256851024⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9246636816), (-4109616350)⟩, ⟨(-3082212280), (-2054808170)⟩, ⟨(-256851024), (-256851021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4623318408), (-2054808175)⟩, ⟨(-1541106140), (-1027404085)⟩, ⟨(-128425512), (-128425510)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1463738438, 2661850697⟩, ⟨(-955116575), (-350142561)⟩, ⟨(-37714046), 127588086⟩, ⟨(-8280414), 23550356⟩, ⟨(-4020097), 1306640⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1074747210, 2277360296⟩, ⟨(-931431302), (-301537324)⟩, ⟨(-22911934), 155788821⟩, ⟨(-15162025), 22778772⟩, ⟨(-4802545), 2039750⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨997452467, 997452468⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4429547893, 4429547896⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar228 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified596
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar228 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨797961973, 1196942961⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4371975774, 4513063888⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified597
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((18579 / 100000) : ℝ)..(55737 / 200000), prawitzNormalCorrection
      ((1053 / 400) * sqrt n) s) ≤ (upper : ℝ) :=
