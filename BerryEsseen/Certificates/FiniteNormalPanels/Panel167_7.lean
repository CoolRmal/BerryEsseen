...
namespace FiniteNormalPanel167_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (176183 / 800000)
def radius : Rat := (25169 / 800000)

def j0 : Jet := ⟨⟨945875278, 945875279⟩, ⟨135125039, 135125040⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2971554824, 2971554828⟩, ⟨424507829, 424507833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2055926730, 2055926737⟩, ⟨587407632, 587407640⟩, ⟨41957687, 41957689⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨514, 516⟩, ⟨147, 148⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94173), (-94170)⟩, ⟨147, 148⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-45079), (-45077)⟩, ⟨(-12810), (-12808)⟩, ⟨(-896), (-892)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5067977, 5067980⟩, ⟨(-12810), (-12808)⟩, ⟨(-896), (-892)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2425953, 2425955⟩, ⟨686997, 687000⟩, ⟨47328, 47333⟩, ⟨(-249), (-244)⟩, ⟨(-9), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-140739624), (-140739621)⟩, ⟨686997, 687000⟩, ⟨47328, 47333⟩, ⟨(-249), (-244)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-67369630), (-67369627)⟩, ⟨(-18919613), (-18919608)⟩, ⟨(-1258278), (-1258273)⟩, ⟨13063, 13070⟩, ⟨422, 428⟩⟩
...
def j19 : Jet := ⟨⟨1364286135, 1364286139⟩, ⟨(-18919613), (-18919608)⟩, ⟨(-1258278), (-1258273)⟩, ⟨13063, 13070⟩, ⟨422, 428⟩⟩
...
def j25 : Jet := ⟨⟨5640, 5642⟩, ⟨1603, 1606⟩, ⟨111, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846537), (-846534)⟩, ⟨1603, 1606⟩, ⟨111, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-405223), (-405221)⟩, ⟨(-115011), (-115008)⟩, ⟨(-7998), (-7993)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35386171, 35386174⟩, ⟨(-115011), (-115008)⟩, ⟨(-7998), (-7993)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16938749, 16938751⟩, ⟨4784588, 4784592⟩, ⟨326129, 326134⟩, ⟨(-2205), (-2200)⟩, ⟨(-77), (-72)⟩⟩
...
def j33 : Jet := ⟨⟨(-698889134), (-698889131)⟩, ⟨4784588, 4784592⟩, ⟨326129, 326134⟩, ⟨(-2205), (-2200)⟩, ⟨(-77), (-72)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-334546170), (-334546166)⟩, ⟨(-93294321), (-93294316)⟩, ⟨(-6016990), (-6016985)⟩, ⟨90287, 90293⟩, ⟨2846, 2853⟩⟩
...
def j36 : Jet := ⟨⟨3960421126, 3960421130⟩, ⟨(-93294321), (-93294316)⟩, ⟨(-6016990), (-6016985)⟩, ⟨90287, 90293⟩, ⟨2846, 2853⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨943907314, 943907319⟩, ⟨121754006, 121754013⟩, ⟨(-2740549), (-2740544)⟩, ⟨(-115330), (-115322)⟩, ⟨1582, 1589⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4657773370, 4657773375⟩, ⟨109721609, 109721616⟩, ⟨9661131, 9661141⟩, ⟨288087, 288100⟩, ⟨15605, 15619⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1023641403, 1023641411⟩, ⟨156152433, 156152444⟩, ⟨2261577, 2261587⟩, ⟨142102, 142117⟩, ⟨4198, 4215⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-945875279), (-945875278)⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3349092017, 3349092018⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨243969662, 243969667⟩, ⟨74433206, 74433214⟩, ⟨6755271, 6755278⟩, ⟨232182, 232194⟩, ⟨13522, 13535⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4538936958, 4538936963⟩, ⟨74433206, 74433214⟩, ⟨6755271, 6755278⟩, ⟨232182, 232194⟩, ⟨13522, 13535⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4415267352, 4415267355⟩, ⟨36202585, 36202590⟩, ⟨3137186, 3137191⟩, ⟨87204, 87212⟩, ⟨4746, 4754⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3442898542, 3442898546⟩, ⟨(-110680097), (-110680090)⟩, ⟨1307308, 1307314⟩, ⟨(-30701), (-30693)⟩, ⟨956, 965⟩⟩
...
def j47 : Jet := ⟨⟨11857799069, 11857799085⟩, ⟨1693971286, 1693971300⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨32737711155, 32737711245⟩, ⟨9353631704, 9353631796⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨32737711155, 32737711245⟩, ⟨9353631704, 9353631796⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-32737711245), (-32737711155)⟩, ⟨(-9353631796), (-9353631704)⟩, ⟨(-668116558), (-668116546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-16368855623), (-16368855577)⟩, ⟨(-4676815898), (-4676815852)⟩, ⟨(-334058279), (-334058273)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨95014358, 95014362⟩, ⟨(-103461715), (-103461708)⟩, ⟨48939917, 48939923⟩, ⟨(-12398895), (-12398890)⟩, ⟨1472057, 1472060⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨76164676, 76164680⟩, ⟨(-85384676), (-85384669)⟩, ⟨41925936, 41925945⟩, ⟨(-11232448), (-11232438)⟩, ⟨1515189, 1515198⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨810750239, 1081000319⟩, ⟨135125039, 135125040⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2547046994, 3396062661⟩, ⟨424507829, 424507833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1510476784, 2685292065⟩, ⟨503492256, 671323018⟩, ⟨41957687, 41957689⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨378, 673⟩, ⟨126, 169⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94309), (-94013)⟩, ⟨126, 169⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-58964), (-33062)⟩, ⟨(-14697), (-10914)⟩, ⟨(-905), (-884)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5054092, 5079995⟩, ⟨(-14697), (-10914)⟩, ⟨(-905), (-884)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1777449, 3176106⟩, ⟨583294, 790189⟩, ⟨46509, 48038⟩, ⟨(-286), (-206)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141388128), (-139989470)⟩, ⟨583294, 790189⟩, ⟨46509, 48038⟩, ⟨(-286), (-206)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-88398443), (-49232236)⟩, ⟨(-21894476), (-15916704)⟩, ⟨(-1296492), (-1214016)⟩, ⟨10971, 15157⟩, ⟨403, 444⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1343257322, 1382423530⟩, ⟨(-21894476), (-15916704)⟩, ⟨(-1296492), (-1214016)⟩, ⟨10971, 15157⟩, ⟨403, 444⟩⟩
...
def j72 : Jet := ⟨⟨4138, 7377⟩, ⟨1368, 1841⟩, ⟨109, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848039), (-844799)⟩, ⟨1368, 1841⟩, ⟨109, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-530210), (-297103)⟩, ⟨(-132072), (-97882)⟩, ⟨(-8087), (-7892)⟩, ⟨23, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35261184, 35494292⟩, ⟨(-132072), (-97882)⟩, ⟨(-8087), (-7892)⟩, ⟨23, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12400839, 22191681⟩, ⟨4051039, 5513498⟩, ⟨318766, 332497⟩, ⟨(-2548), (-1858)⟩, ⟨(-79), (-69)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703427044), (-693636201)⟩, ⟨4051039, 5513498⟩, ⟨318766, 332497⟩, ⟨(-2548), (-1858)⟩, ⟨(-79), (-69)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-439795447), (-243941642)⟩, ⟨(-108524172), (-77866740)⟩, ⟨(-6284803), (-5706487)⟩, ⟨75348, 105180⟩, ⟨2665, 3008⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3855171849, 4051025654⟩, ⟨(-108524172), (-77866740)⟩, ⟨(-6284803), (-5706487)⟩, ⟨75348, 105180⟩, ⟨2665, 3008⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨796592683, 1093092592⟩, ⟨115453320, 127197483⟩, ⟨(-3189162), (-2293130)⟩, ⟨(-121638), (-108006)⟩, ⟨1322, 1851⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4553598433, 4784934316⟩, ⟨87526936, 134697248⟩, ⟨8096833, 11592293⟩, ⟨154692, 456917⟩, ⟨7326, 26904⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨844561307, 1217791870⟩, ⟨138639325, 175989272⟩, ⟨301566, 4508210⟩, ⟨10808, 298360⟩, ⟨(-5506), 15920⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1081000319), (-810750239)⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3213966977, 3484217057⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨166074326, 345291812⟩, ⟨54524004, 99799738⟩, ⟨4593803, 9767793⟩, ⟨23718, 538650⟩, ⟨(-2407), 38213⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4461041622, 4640259108⟩, ⟨54524004, 99799738⟩, ⟨4593803, 9767793⟩, ⟨23718, 538650⟩, ⟨(-2407), 38213⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4377216909, 4464276102⟩, ⟨26228083, 48962232⟩, ⟨1941292, 4713548⟩, ⟨(-41090), 252634⟩, ⟨(-6546), 18778⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3275515184, 3621565863⟩, ⟨(-120824971), (-97992960)⟩, ⟨(-87726), 2998616⟩, ⟨(-181629), 143870⟩, ⟨(-13260), 16527⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨10163827782, 13551770384⟩, ⟨1693971286, 1693971300⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨24052195991, 42759459592⟩, ⟨8017398610, 10689864912⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨24052195991, 42759459592⟩, ⟨8017398610, 10689864912⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-42759459592), (-24052195991)⟩, ⟨(-10689864912), (-8017398610)⟩, ⟨(-668116558), (-668116546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-21379729796), (-12026097995)⟩, ⟨(-5344932456), (-4008699305)⟩, ⟨(-334058279), (-334058273)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨29587232, 261165707⟩, ⟨(-325011338), (-27615184)⟩, ⟨(-7425921), 199931201⟩, ⟨(-81503811), 19933137⟩, ⟨(-13976744), 25645932⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨22564415, 220217931⟩, ⟨(-281400352), (-21735507)⟩, ⟨(-5636897), 177909769⟩, ⟨(-74587327), 17032144⟩, ⟨(-12362987), 24072128⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨945875278, 945875279⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4415267352, 4415267355⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3376
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨810750239, 1081000319⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4377216909, 4464276102⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3377
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (2987385 / 2147483648)

theorem envelope_integral : (∫ s in ((75507 / 400000) : ℝ)..(25169 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((75507 / 400000) : ℝ)..(25169 / 100000), prawitzNormalCorrection
