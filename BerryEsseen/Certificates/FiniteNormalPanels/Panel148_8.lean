...
namespace FiniteNormalPanel148_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (80421 / 800000)
def radius : Rat := (26807 / 800000)

def j0 : Jet := ⟨⟨431756956, 431756957⟩, ⟨143918985, 143918986⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1356404481, 1356404485⟩, ⟨452134825, 452134830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨428369528, 428369532⟩, ⟨285579684, 285579690⟩, ⟨47596613, 47596615⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨107, 108⟩, ⟨71, 72⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94580), (-94578)⟩, ⟨71, 72⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9434), (-9432)⟩, ⟨(-6282), (-6280)⟩, ⟨(-1044), (-1041)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103622, 5103625⟩, ⟨(-6282), (-6280)⟩, ⟨(-1044), (-1041)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨509022, 509024⟩, ⟨338721, 338723⟩, ⟨56035, 56039⟩, ⟨(-140), (-137)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-142656555), (-142656552)⟩, ⟨338721, 338723⟩, ⟨56035, 56039⟩, ⟨(-140), (-137)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14228216), (-14228215)⟩, ⟨(-9451695), (-9451692)⟩, ⟨(-1552803), (-1552799)⟩, ⟨7464, 7468⟩, ⟨608, 613⟩⟩
...
def j19 : Jet := ⟨⟨1417427549, 1417427551⟩, ⟨(-9451695), (-9451692)⟩, ⟨(-1552803), (-1552799)⟩, ⟨7464, 7468⟩, ⟨608, 613⟩⟩
...
def j25 : Jet := ⟨⟨1179, 1180⟩, ⟨785, 787⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850998), (-850996)⟩, ⟨785, 787⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-84877), (-84876)⟩, ⟨(-56507), (-56505)⟩, ⟨(-9367), (-9363)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35706517, 35706519⟩, ⟨(-56507), (-56505)⟩, ⟨(-9367), (-9363)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3561280, 3561281⟩, ⟨2368551, 2368553⟩, ⟨391004, 391008⟩, ⟨(-1249), (-1246)⟩, ⟨(-105), (-100)⟩⟩
...
def j33 : Jet := ⟨⟨(-712266603), (-712266601)⟩, ⟨2368551, 2368553⟩, ⟨391004, 391008⟩, ⟨(-1249), (-1246)⟩, ⟨(-105), (-100)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-71039729), (-71039727)⟩, ⟨(-47123587), (-47123584)⟩, ⟨(-7696819), (-7696813)⟩, ⟨52121, 52124⟩, ⟨4238, 4243⟩⟩
...
def j36 : Jet := ⟨⟨4223927567, 4223927569⟩, ⟨(-47123587), (-47123584)⟩, ⟨(-7696819), (-7696813)⟩, ⟨52121, 52124⟩, ⟨4238, 4243⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨447641378, 447641380⟩, ⟨146228828, 146228832⟩, ⟨(-1485383), (-1485380)⟩, ⟨(-161108), (-161105)⟩, ⟨977, 981⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4367201797, 4367201801⟩, ⟨48721999, 48722004⟩, ⟨8501444, 8501453⟩, ⟨129732, 129739⟩, ⟨11948, 11958⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨455169992, 455169995⟩, ⟨153766195, 153766201⟩, ⟨1034510, 1034517⟩, ⟨122296, 122304⟩, ⟨1885, 1896⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-431756957), (-431756956)⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3863210339, 3863210340⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨48237787, 48237789⟩, ⟨32591520, 32591524⟩, ⟨5724325, 5724331⟩, ⟨99992, 100000⟩, ⟨9403, 9410⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4343205083, 4343205085⟩, ⟨32591520, 32591524⟩, ⟨5724325, 5724331⟩, ⟨99992, 100000⟩, ⟨9403, 9410⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4319018845, 4319018847⟩, ⟨16205012, 16205015⟩, ⟨2815823, 2815827⟩, ⟨39151, 39157⟩, ⟨3609, 3615⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3884844075, 3884844079⟩, ⟨(-130148942), (-130148936)⟩, ⟨1989748, 1989754⟩, ⟨(-59140), (-59133)⟩, ⟨1933, 1941⟩⟩
...
def j47 : Jet := ⟨⟨4099217159, 4099217170⟩, ⟨1366405716, 1366405727⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3912388653, 3912388675⟩, ⟨2608259094, 2608259124⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3912388653, 3912388675⟩, ⟨2608259094, 2608259124⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3912388675), (-3912388653)⟩, ⟨(-2608259124), (-2608259094)⟩, ⟨(-434709856), (-434709848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1956194338), (-1956194326)⟩, ⟨(-1304129562), (-1304129547)⟩, ⟨(-217354928), (-217354924)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2723674677, 2723674691⟩, ⟨(-827020193), (-827020179)⟩, ⟨(-12277950), (-12277942)⟩, ⟨29144641, 29144644⟩, ⟨(-1901706), (-1901704)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2463593015, 2463593031⟩, ⟨(-830583247), (-830583228)⟩, ⟨15217181, 15217197⟩, ⟨26313051, 26313063⟩, ⟨(-2596353), (-2596340)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨287837970, 575675942⟩, ⟨143918985, 143918986⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨904269651, 1808539311⟩, ⟨452134825, 452134830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨190386455, 761545832⟩, ⟨190386454, 380772918⟩, ⟨47596613, 47596615⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨47, 191⟩, ⟨47, 96⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94640), (-94495)⟩, ⟨47, 96⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-16781), (-4188)⟩, ⟨(-8389), (-4170)⟩, ⟨(-1047), (-1035)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096275, 5108869⟩, ⟨(-8389), (-4170)⟩, ⟨(-1047), (-1035)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨225906, 905860⟩, ⟨224418, 452746⟩, ⟨55546, 56388⟩, ⟨(-186), (-90)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142939671), (-142259716)⟩, ⟨224418, 452746⟩, ⟨55546, 56388⟩, ⟨(-186), (-90)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-25344806), (-6306060)⟩, ⟨(-12662456), (-6225783)⟩, ⟨(-1571642), (-1526377)⟩, ⟨4915, 10015⟩, ⟨595, 622⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1406310959, 1425349706⟩, ⟨(-12662456), (-6225783)⟩, ⟨(-1571642), (-1526377)⟩, ⟨4915, 10015⟩, ⟨595, 622⟩⟩
...
def j72 : Jet := ⟨⟨523, 2098⟩, ⟨521, 1049⟩, ⟨128, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851654), (-850078)⟩, ⟨521, 1049⟩, ⟨128, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-151008), (-37682)⟩, ⟨(-75481), (-37496)⟩, ⟨(-9410), (-9303)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35640386, 35753713⟩, ⟨(-75481), (-37496)⟩, ⟨(-9410), (-9303)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1579859, 6339534⟩, ⟨1566475, 3168106⟩, ⟨386603, 394147⟩, ⟨(-1672), (-822)⟩, ⟨(-106), (-99)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714248024), (-709488348)⟩, ⟨1566475, 3168106⟩, ⟨386603, 394147⟩, ⟨(-1672), (-822)⟩, ⟨(-106), (-99)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-126644179), (-31450058)⟩, ⟨(-63252652), (-30888317)⟩, ⟨(-7828687), (-7511756)⟩, ⟨34199, 70017⟩, ⟨4116, 4328⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4168323117, 4263517238⟩, ⟨(-63252652), (-30888317)⟩, ⟨(-7828687), (-7511756)⟩, ⟨34199, 70017⟩, ⟨4116, 4328⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨296087078, 600191061⟩, ⟨142711589, 148736980⟩, ⟨(-1994781), (-976758)⟩, ⟨(-164415), (-156464)⟩, ⟨642, 1317⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4326649346, 4425459245⟩, ⟨31345696, 67154592⟩, ⟨7850078, 9330671⟩, ⟨39420, 232219⟩, ⟨8519, 16521⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨298271179, 618426381⟩, ⟨145925222, 162640361⟩, ⟨(-472676), 2645531⟩, ⟨62955, 190832⟩, ⟨(-4363), 8783⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-575675942), (-287837970)⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3719291354, 4007129326⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨20713940, 89046357⟩, ⟨20268040, 46836720⟩, ⟨4821815, 6920664⟩, ⟨(-27056), 255318⟩, ⟨2726, 18614⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4315681236, 4384013653⟩, ⟨20268040, 46836720⟩, ⟨4821815, 6920664⟩, ⟨(-27056), 255318⟩, ⟨2726, 18614⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305311808, 4339262065⟩, ⟨10030572, 23362092⟩, ⟨2323407, 3440334⟩, ⟨(-32165), 121940⟩, ⟨(-678), 8833⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3728249339, 4048455571⟩, ⟨(-136717125), (-122469192)⟩, ⟨1229154, 2873661⟩, ⟨(-145292), 35914⟩, ⟨(-4720), 9320⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2732811433, 5465622887⟩, ⟨1366405716, 1366405727⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1738839393, 6955357628⟩, ⟨1738839392, 3477678828⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1738839393, 6955357628⟩, ⟨1738839392, 3477678828⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6955357628), (-1738839393)⟩, ⟨(-3477678828), (-1738839392)⟩, ⟨(-434709856), (-434709848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3477678814), (-869419696)⟩, ⟨(-1738839414), (-869419696)⟩, ⟨(-217354928), (-217354924)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1911204636, 3507895882⟩, ⟨(-1420189538), (-386880467)⟩, ⟨(-138366062), 190765373⟩, ⟨(-12691568), 66586984⟩, ⟨(-11566542), 4785700⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1659022509, 3306558502⟩, ⟨(-1450340191), (-390329056)⟩, ⟨(-118845784), 227370737⟩, ⟨(-19104445), 67088266⟩, ⟨(-13130578), 5098314⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨431756956, 431756957⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4319018845, 4319018847⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2984
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨287837970, 575675942⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305311808, 4339262065⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2985
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (165512121 / 4294967296)

theorem envelope_integral : (∫ s in ((26807 / 400000) : ℝ)..(26807 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26807 / 400000) : ℝ)..(26807 / 200000), prawitzNormalCorrection
