...
namespace FiniteNormalPanel145_15
...
def j2 : Jet := ⟨⟨1325589754, 1325589759⟩, ⟨441863250, 441863254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨409127258, 409127262⟩, ⟨272751504, 272751510⟩, ⟨45458584, 45458585⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-9010), (-9009)⟩, ⟨(-6001), (-5999)⟩, ⟨(-997), (-994)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104046, 5104048⟩, ⟨(-6001), (-5999)⟩, ⟨(-997), (-994)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨486197, 486199⟩, ⟨323559, 323562⟩, ⟨53544, 53549⟩, ⟨(-128), (-125)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142679380), (-142679377)⟩, ⟨323559, 323562⟩, ⟨53544, 53549⟩, ⟨(-128), (-125)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13591262), (-13591261)⟩, ⟨(-9030021), (-9030018)⟩, ⟨(-1484494), (-1484491)⟩, ⟨6811, 6815⟩, ⟨555, 560⟩⟩
...
def j19 : Jet := ⟨⟨1418064503, 1418064505⟩, ⟨(-9030021), (-9030018)⟩, ⟨(-1484494), (-1484491)⟩, ⟨6811, 6815⟩, ⟨555, 560⟩⟩
...
def j25 : Jet := ⟨⟨1126, 1127⟩, ⟨749, 752⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851051), (-851049)⟩, ⟨749, 752⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-81069), (-81068)⟩, ⟨(-53975), (-53973)⟩, ⟨(-8950), (-8946)⟩, ⟨13, 17⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35710325, 35710327⟩, ⟨(-53975), (-53973)⟩, ⟨(-8950), (-8946)⟩, ⟨13, 17⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3401671, 3401672⟩, ⟨2262638, 2262641⟩, ⟨373682, 373685⟩, ⟨(-1140), (-1137)⟩, ⟨(-96), (-91)⟩⟩
...
def j33 : Jet := ⟨⟨(-712426212), (-712426210)⟩, ⟨2262638, 2262641⟩, ⟨373682, 373685⟩, ⟨(-1140), (-1137)⟩, ⟨(-96), (-91)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-67863843), (-67863841)⟩, ⟨(-45027031), (-45027027)⟩, ⟨(-7361145), (-7361140)⟩, ⟨47569, 47572⟩, ⟨3872, 3876⟩⟩
...
def j36 : Jet := ⟨⟨4227103453, 4227103455⟩, ⟨(-45027031), (-45027027)⟩, ⟨(-7361145), (-7361140)⟩, ⟨47569, 47572⟩, ⟨3872, 3876⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨437668472, 437668475⟩, ⟨143102483, 143102487⟩, ⟨(-1387175), (-1387171)⟩, ⟨(-150622), (-150619)⟩, ⟨871, 875⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4363920653, 4363920657⟩, ⟨46484400, 46484406⟩, ⟨8094546, 8094554⟩, ⟨118058, 118065⟩, ⟨10827, 10836⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨444695000, 444695005⟩, ⟨150136797, 150136804⟩, ⟨964206, 964214⟩, ⟨113674, 113682⟩, ⟨1674, 1685⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-421948325), (-421948324)⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3873018971, 3873018972⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨46043107, 46043110⟩, ⟨31089914, 31089918⟩, ⟨5447912, 5447918⟩, ⟨90948, 90954⟩, ⟨8508, 8515⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4341010403, 4341010406⟩, ⟨31089914, 31089918⟩, ⟨5447912, 5447918⟩, ⟨90948, 90954⟩, ⟨8508, 8515⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317927478, 4317927481⟩, ⟨15462298, 15462301⟩, ⟨2681786, 2681791⟩, ⟨35628, 35633⟩, ⟨3270, 3275⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3893723487, 3893723492⟩, ⟨(-127458088), (-127458083)⟩, ⟨1911968, 1911975⟩, ⟨(-55695), (-55688)⟩, ⟨1781, 1788⟩⟩
...
def j47 : Jet := ⟨⟨4396256329, 4396256341⟩, ⟨1465418772, 1465418784⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4499934080, 4499934106⟩, ⟨2999956044, 2999956078⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4499934080, 4499934106⟩, ⟨2999956044, 2999956078⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4499934106), (-4499934080)⟩, ⟨(-2999956078), (-2999956044)⟩, ⟨(-499992681), (-499992672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2249967053), (-2249967040)⟩, ⟨(-1499978039), (-1499978022)⟩, ⟨(-249996341), (-249996336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2543605752, 2543605767⟩, ⟨(-888331046), (-888331030)⟩, ⟨7065565, 7065575⟩, ⟨33648746, 33648750⟩, ⟨(-3143513), (-3143510)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2305977386, 2305977403⟩, ⟨(-880825937), (-880825916)⟩, ⟨33900051, 33900069⟩, ⟨29867096, 29867111⟩, ⟨(-3832691), (-3832677)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨281298883, 562597767⟩, ⟨140649441, 140649442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨883726504, 1767453012⟩, ⟨441863250, 441863254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨181834337, 727337355⟩, ⟨181834336, 363668678⟩, ⟨45458584, 45458585⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-16028), (-4000)⟩, ⟨(-8013), (-3984)⟩, ⟨(-1001), (-989)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097028, 5109057⟩, ⟨(-8013), (-3984)⟩, ⟨(-1001), (-989)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨215790, 865201⟩, ⟨214433, 432433⟩, ⟨53098, 53867⟩, ⟨(-170), (-82)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142949787), (-142300375)⟩, ⟨214433, 432433⟩, ⟨53098, 53867⟩, ⟨(-170), (-82)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-24208036), (-6024514)⟩, ⟨(-12094940), (-5951283)⟩, ⟨(-1501678), (-1460389)⟩, ⟨4487, 9136⟩, ⟨544, 568⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407447729, 1425631252⟩, ⟨(-12094940), (-5951283)⟩, ⟨(-1501678), (-1460389)⟩, ⟨4487, 9136⟩, ⟨544, 568⟩⟩
...
def j72 : Jet := ⟨⟨500, 2004⟩, ⟨498, 1002⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851677), (-850172)⟩, ⟨498, 1002⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-144229), (-35993)⟩, ⟨(-72094), (-35823)⟩, ⟨(-8989), (-8891)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35647165, 35755402⟩, ⟨(-72094), (-35823)⟩, ⟨(-8989), (-8891)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1509179, 6055050⟩, ⟨1496970, 3026009⟩, ⟨369666, 376549⟩, ⟨(-1526), (-751)⟩, ⟨(-97), (-91)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714318704), (-709772832)⟩, ⟨1496970, 3026009⟩, ⟨369666, 376549⟩, ⟨(-1526), (-751)⟩, ⟨(-97), (-91)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-120967319), (-30049372)⟩, ⟨(-60420284), (-29536928)⟩, ⟨(-7481432), (-7192353)⟩, ⟨31235, 63881⟩, ⟨3765, 3952⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4173999977, 4264917924⟩, ⟨(-60420284), (-29536928)⟩, ⟨(-7481432), (-7192353)⟩, ⟨31235, 63881⟩, ⟨3765, 3952⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨289594489, 586671814⟩, ⟨139819967, 145443427⟩, ⟨(-1862287), (-912750)⟩, ⟨(-153569), (-146483)⟩, ⟨572, 1174⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4325228387, 4419440388⟩, ⟨29954610, 63973131⟩, ⟨7501511, 8847394⟩, ⟨36269, 210370⟩, ⟨7846, 14781⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨291634887, 603674238⟩, ⟨142824830, 158396967⟩, ⟨(-435306), 2455699⟩, ⟨60892, 174462⟩, ⟨(-3840), 7738⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-562597767), (-281298883)⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3732369529, 4013668413⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19802457, 84848746⟩, ⟨19396050, 44526612⟩, ⟨4627128, 6531944⟩, ⟨(-23840), 230176⟩, ⟨2719, 16451⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314769753, 4379816042⟩, ⟨19396050, 44526612⟩, ⟨4627128, 6531944⟩, ⟨(-23840), 230176⟩, ⟨2719, 16451⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304857138, 4337184186⟩, ⟨9603627, 22212159⟩, ⟨2234166, 3247758⟩, ⟨(-28652), 109841⟩, ⟨(-437), 7776⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3740963900, 4053120308⟩, ⟨(-133686293), (-120215934)⟩, ⟨1214119, 2720553⟩, ⟨(-133132), 29484⟩, ⟨(-4007), 8206⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2930837556, 5861675124⟩, ⟨1465418772, 1465418784⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1999970707, 7999882861⟩, ⟨1999970698, 3999941440⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1999970707, 7999882861⟩, ⟨1999970698, 3999941440⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7999882861), (-1999970707)⟩, ⟨(-3999941440), (-1999970698)⟩, ⟨(-499992681), (-499992672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3999941431), (-999985353)⟩, ⟨(-1999970720), (-999985349)⟩, ⟨(-249996341), (-249996336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1692378610, 3402861543⟩, ⟨(-1584557689), (-394031828)⟩, ⟨(-152199042), 270420229⟩, ⟨(-26683907), 85112087⟩, ⟨(-17778356), 7535881⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1474080440, 3211248486⟩, ⟨(-1601250586), (-390575667)⟩, ⟨(-132121467), 306669864⟩, ⟨(-34707709), 84968840⟩, ⟨(-19536951), 8169023⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317927478, 4317927481⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2928
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304857138, 4337184186⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2929
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (37969273 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((13099 / 200000) : ℝ)..(13099 / 100000), prawitzNormalCorrection
