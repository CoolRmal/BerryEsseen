...
namespace FiniteNormalPanel162_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (9819 / 100000)
def radius : Rat := (3273 / 100000)

def j0 : Jet := ⟨⟨421722838, 421722839⟩, ⟨140574279, 140574280⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1324881369, 1324881373⟩, ⟨441627122, 441627126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨408690106, 408690110⟩, ⟨272460070, 272460074⟩, ⟨45410011, 45410013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨102, 103⟩, ⟨68, 69⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94585), (-94583)⟩, ⟨68, 69⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9001), (-9000)⟩, ⟨(-5995), (-5993)⟩, ⟨(-996), (-993)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104055, 5104057⟩, ⟨(-5995), (-5993)⟩, ⟨(-996), (-993)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨485679, 485680⟩, ⟨323215, 323217⟩, ⟨53488, 53491⟩, ⟨(-128), (-124)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142679898), (-142679896)⟩, ⟨323215, 323217⟩, ⟨53488, 53491⟩, ⟨(-128), (-124)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13576789), (-13576788)⟩, ⟨(-9020438), (-9020436)⟩, ⟨(-1482941), (-1482938)⟩, ⟨6797, 6801⟩, ⟨554, 559⟩⟩
...
def j19 : Jet := ⟨⟨1418078976, 1418078978⟩, ⟨(-9020438), (-9020436)⟩, ⟨(-1482941), (-1482938)⟩, ⟨6797, 6801⟩, ⟨554, 559⟩⟩
...
def j22 : Jet := ⟨⟨(-11), (-10)⟩, ⟨(-7), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11824, 11826⟩, ⟨(-7), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1125, 1126⟩, ⟨749, 751⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851052), (-851050)⟩, ⟨749, 751⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-80983), (-80982)⟩, ⟨(-53918), (-53916)⟩, ⟨(-8941), (-8938)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35710411, 35710413⟩, ⟨(-53918), (-53916)⟩, ⟨(-8941), (-8938)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3398044, 3398046⟩, ⟨2260232, 2260234⟩, ⟨373288, 373291⟩, ⟨(-1138), (-1135)⟩, ⟨(-96), (-91)⟩⟩
...
def j33 : Jet := ⟨⟨(-712429839), (-712429836)⟩, ⟨2260232, 2260234⟩, ⟨373288, 373291⟩, ⟨(-1138), (-1135)⟩, ⟨(-96), (-91)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-67791676), (-67791674)⟩, ⟨(-44979378), (-44979375)⟩, ⟨(-7353507), (-7353504)⟩, ⟨47468, 47471⟩, ⟨3863, 3867⟩⟩
...
def j36 : Jet := ⟨⟨4227175620, 4227175622⟩, ⟨(-44979378), (-44979375)⟩, ⟨(-7353507), (-7353504)⟩, ⟨47468, 47471⟩, ⟨3863, 3867⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨437439050, 437439053⟩, ⟨143030454, 143030458⟩, ⟨(-1384969), (-1384966)⟩, ⟨(-150387), (-150384)⟩, ⟨868, 873⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4363846152, 4363846155⟩, ⟨46433621, 46433626⟩, ⟨8085329, 8085335⟩, ⟨117799, 117807⟩, ⟨10802, 10812⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨444454307, 444454311⟩, ⟨150053475, 150053483⟩, ⟨962630, 962637⟩, ⟨113480, 113488⟩, ⟨1669, 1682⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-421722839), (-421722838)⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3873244457, 3873244458⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨45993279, 45993281⟩, ⟨31055842, 31055846⟩, ⟨5441655, 5441660⟩, ⟨90748, 90754⟩, ⟨8487, 8496⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4340960575, 4340960577⟩, ⟨31055842, 31055846⟩, ⟨5441655, 5441660⟩, ⟨90748, 90754⟩, ⟨8487, 8496⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317902697, 4317902699⟩, ⟨15445441, 15445444⟩, ⟨2678750, 2678754⟩, ⟨35550, 35555⟩, ⟨3262, 3269⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3893927830, 3893927834⟩, ⟨(-127396103), (-127396098)⟩, ⟨1910193, 1910199⟩, ⟨(-55617), (-55611)⟩, ⟨1777, 1786⟩⟩
...
def j47 : Jet := ⟨⟨4169087311, 4169087322⟩, ⟨1389695767, 1389695778⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4046896706, 4046896729⟩, ⟨2697931130, 2697931160⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4046896706, 4046896729⟩, ⟨2697931130, 2697931160⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4046896729), (-4046896706)⟩, ⟨(-2697931160), (-2697931130)⟩, ⟨(-449655195), (-449655187)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2023448365), (-2023448353)⟩, ⟨(-1348965580), (-1348965565)⟩, ⟨(-224827598), (-224827593)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2681357388, 2681357402⟩, ⟨(-842162139), (-842162124)⟩, ⟨(-8106999), (-8106989)⟩, ⟨30238384, 30238387⟩, ⟨(-2162135), (-2162134)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2430987580, 2430987596⟩, ⟨(-843059523), (-843059503)⟩, ⟨18822496, 18822513⟩, ⟨27246086, 27246098⟩, ⟨(-2848764), (-2848751)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨281148559, 562297119⟩, ⟨140574279, 140574280⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨883254247, 1766508499⟩, ⟨441627122, 441627126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨181640047, 726560196⟩, ⟨181640046, 363280100⟩, ⟨45410011, 45410013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨45, 183⟩, ⟨45, 92⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94642), (-94503)⟩, ⟨45, 92⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-16011), (-3996)⟩, ⟨(-8005), (-3980)⟩, ⟨(-1000), (-988)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097045, 5109061⟩, ⟨(-8005), (-3980)⟩, ⟨(-1000), (-988)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨215561, 864277⟩, ⟨214206, 431971⟩, ⟨53042, 53809⟩, ⟨(-170), (-82)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142950016), (-142301299)⟩, ⟨214206, 431971⟩, ⟨53042, 53809⟩, ⟨(-170), (-82)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-24182208), (-6018116)⟩, ⟨(-12082045), (-5945041)⟩, ⟨(-1500087), (-1458888)⟩, ⟨4478, 9117⟩, ⟨543, 566⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407473557, 1425637650⟩, ⟨(-12082045), (-5945041)⟩, ⟨(-1500087), (-1458888)⟩, ⟨4478, 9117⟩, ⟨543, 566⟩⟩
...
def j70 : Jet := ⟨⟨(-19), (-4)⟩, ⟨(-10), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11816, 11832⟩, ⟨(-10), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨499, 2002⟩, ⟨497, 1001⟩, ⟨122, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851678), (-850174)⟩, ⟨497, 1001⟩, ⟨122, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-144075), (-35955)⟩, ⟨(-72017), (-35785)⟩, ⟨(-8979), (-8881)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35647319, 35755440⟩, ⟨(-72017), (-35785)⟩, ⟨(-8979), (-8881)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1507573, 6048587⟩, ⟨1495390, 3022781⟩, ⟨369282, 376149⟩, ⟨(-1522), (-749)⟩, ⟨(-96), (-90)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714320310), (-709779295)⟩, ⟨1495390, 3022781⟩, ⟨369282, 376149⟩, ⟨(-1522), (-749)⟩, ⟨(-96), (-90)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-120838337), (-30017538)⟩, ⟨(-60355927), (-29506186)⟩, ⟨(-7473538), (-7185076)⟩, ⟨31169, 63745⟩, ⟨3758, 3943⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4174128959, 4264949758⟩, ⟨(-60355927), (-29506186)⟩, ⟨(-7473538), (-7185076)⟩, ⟨31169, 63745⟩, ⟨3758, 3943⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨289445043, 586360932⟩, ⟨139753208, 145367645⟩, ⟨(-1859311), (-911312)⟩, ⟨(-153326), (-146259)⟩, ⟨571, 1171⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4325196103, 4419303825⟩, ⟨29922987, 63901041⟩, ⟨7493586, 8836490⟩, ⟨36200, 209888⟩, ⟨7831, 14741⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨291482212, 603335703⟩, ⟨142753377, 158299894⟩, ⟨(-434474), 2451456⟩, ⟨60842, 174099⟩, ⟨(-3829), 7715⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-562297119), (-281148559)⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3732670177, 4013818737⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19781729, 84753608⟩, ⟨19376198, 44474368⟩, ⟨4622679, 6523208⟩, ⟨(-23770), 229622⟩, ⟨2720, 16402⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314749025, 4379720904⟩, ⟨19376198, 44474368⟩, ⟨4622679, 6523208⟩, ⟨(-23770), 229622⟩, ⟨2720, 16402⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304846797, 4337137080⟩, ⟨9593902, 22186151⟩, ⟨2232120, 3243429⟩, ⟨(-28575), 109573⟩, ⟨(-432), 7752⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3741256253, 4053228087⟩, ⟨(-133616630), (-120163789)⟩, ⟨1213737, 2717107⟩, ⟨(-132863), 29344⟩, ⟨(-3991), 8181⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2779391544, 5558783100⟩, ⟨1389695767, 1389695778⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1798620762, 7194483083⟩, ⟨1798620756, 3597241550⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1798620762, 7194483083⟩, ⟨1798620756, 3597241550⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7194483083), (-1798620762)⟩, ⟨(-3597241550), (-1798620756)⟩, ⟨(-449655195), (-449655187)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3597241542), (-899310381)⟩, ⟨(-1798620775), (-899310378)⟩, ⟨(-224827598), (-224827593)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1858734493, 3483567550⟩, ⟨(-1458827632), (-389194865)⟩, ⟨(-141607280), 208160850⟩, ⟨(-15475395), 70677079⟩, ⟨(-12847704), 5326515⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1619104772, 3287497405⟩, ⟨(-1485092494), (-391022837)⟩, ⟨(-122222925), 244032654⟩, ⟨(-22110923), 71018296⟩, ⟨(-14426139), 5691610⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨421722838, 421722839⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317902697, 4317902699⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3284
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨281148559, 562297119⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304846797, 4337137080⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3285
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (79808835 / 2147483648)

theorem envelope_integral : (∫ s in ((3273 / 50000) : ℝ)..(3273 / 25000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (3273 / 50000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (3273 / 25000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((3273 / 50000) : ℝ)..(3273 / 25000), prawitzNormalCorrection
