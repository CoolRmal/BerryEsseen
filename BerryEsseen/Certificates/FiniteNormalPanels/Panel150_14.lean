...
namespace FiniteNormalPanel150_14
...
def j2 : Jet := ⟨⟨465374870, 465374874⟩, ⟨465374870, 465374874⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨50425010, 50425012⟩, ⟨100850020, 100850024⟩, ⟨50425010, 50425012⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1112), (-1111)⟩, ⟨(-2224), (-2222)⟩, ⟨(-1112), (-1109)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111944, 5111946⟩, ⟨(-2224), (-2222)⟩, ⟨(-1112), (-1109)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨60016, 60017⟩, ⟨120006, 120008⟩, ⟨59949, 59952⟩, ⟨(-54), (-51)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-143105561), (-143105559)⟩, ⟨120006, 120008⟩, ⟨59949, 59952⟩, ⟨(-54), (-51)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1680130), (-1680129)⟩, ⟨(-3358851), (-3358849)⟩, ⟨(-1676610), (-1676607)⟩, ⟨2814, 2817⟩, ⟨700, 703⟩⟩
...
def j19 : Jet := ⟨⟨1429975635, 1429975637⟩, ⟨(-3358851), (-3358849)⟩, ⟨(-1676610), (-1676607)⟩, ⟨2814, 2817⟩, ⟨700, 703⟩⟩
...
def j25 : Jet := ⟨⟨138, 139⟩, ⟨276, 278⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852039), (-852037)⟩, ⟨276, 278⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10004), (-10003)⟩, ⟨(-20004), (-20002)⟩, ⟨(-9997), (-9994)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781390, 35781392⟩, ⟨(-20004), (-20002)⟩, ⟨(-9997), (-9994)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨420090, 420092⟩, ⟨839946, 839949⟩, ⟨419502, 419506⟩, ⟨(-470), (-467)⟩, ⟨(-119), (-115)⟩⟩
...
def j33 : Jet := ⟨⟨(-715407793), (-715407790)⟩, ⟨839946, 839949⟩, ⟨419502, 419506⟩, ⟨(-470), (-467)⟩, ⟨(-119), (-115)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8399237), (-8399236)⟩, ⟨(-16788613), (-16788610)⟩, ⟨(-8374590), (-8374587)⟩, ⟨19705, 19708⟩, ⟨4911, 4915⟩⟩
...
def j36 : Jet := ⟨⟨4286568059, 4286568060⟩, ⟨(-16788613), (-16788610)⟩, ⟨(-8374590), (-8374587)⟩, ⟨19705, 19708⟩, ⟨4911, 4915⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨154942908, 154942911⟩, ⟨154578964, 154578968⟩, ⟨(-545611), (-545609)⟩, ⟨(-181363), (-181360)⟩, ⟨379, 383⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303382989, 4303382991⟩, ⟨16854466, 16854471⟩, ⟨8473448, 8473454⟩, ⟨46327, 46334⟩, ⟨11722, 11731⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨155246507, 155246512⟩, ⟨155489882, 155489888⟩, ⟨365606, 365611⟩, ⟨122775, 122782⟩, ⟨679, 689⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-148133423), (-148133422)⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4146833873, 4146833874⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5611562, 5611563⟩, ⟨11240718, 11240722⟩, ⟨5655600, 5655603⟩, ⟨35344, 35352⟩, ⟨8967, 8974⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300578858, 4300578859⟩, ⟨11240718, 11240722⟩, ⟨5655600, 5655603⟩, ⟨35344, 35352⟩, ⟨8967, 8974⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297772161, 4297772162⟩, ⟨5616690, 5616693⟩, ⟨2822283, 2822286⟩, ⟨13971, 13977⟩, ⟨3534, 3540⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4149541998, 4149542001⟩, ⟨(-142807193), (-142807187)⟩, ⟨2531222, 2531227⟩, ⟨(-83852), (-83845)⟩, ⟨2929, 2937⟩⟩
...
def j47 : Jet := ⟨⟨1306264720, 1306264730⟩, ⟨1306264720, 1306264730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨397285334, 397285341⟩, ⟨794570668, 794570682⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨397285334, 397285341⟩, ⟨794570668, 794570682⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-397285341), (-397285334)⟩, ⟨(-794570682), (-794570668)⟩, ⟨(-397285341), (-397285334)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-198642671), (-198642667)⟩, ⟨(-397285341), (-397285334)⟩, ⟨(-198642671), (-198642667)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4100848239, 4100848244⟩, ⟨(-379329290), (-379329282)⟩, ⟨(-172120629), (-172120623)⟩, ⟨17003075, 17003077⟩, ⟨3587100, 3587102⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3961995708, 3961995717⟩, ⟨(-502838160), (-502838144)⟩, ⟨(-151263243), (-151263228)⟩, ⟨21846730, 21846744⟩, ⟨2809053, 2809068⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 296266845⟩, ⟨148133422, 148133423⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 930749744⟩, ⟨465374870, 465374874⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 201700043⟩, ⟨0, 201700044⟩, ⟨50425010, 50425012⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4447), 0⟩, ⟨(-4447), 3⟩, ⟨(-1112), (-1107)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108609, 5113057⟩, ⟨(-4447), 3⟩, ⟨(-1112), (-1107)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 240120⟩, ⟨(-209), 240121⟩, ⟨59715, 60031⟩, ⟨(-106), 2⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142925456)⟩, ⟨(-209), 240121⟩, ⟨59715, 60031⟩, ⟨(-106), 2⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6723335), 0⟩, ⟨(-6723345), 11277⟩, ⟨(-1680844), (-1663917)⟩, ⟨(-8), 5641⟩, ⟨695, 706⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424932430, 1431655766⟩, ⟨(-6723345), 11277⟩, ⟨(-1680844), (-1663917)⟩, ⟨(-8), 5641⟩, ⟨695, 706⟩⟩
...
def j72 : Jet := ⟨⟨0, 556⟩, ⟨(-1), 556⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851620)⟩, ⟨(-1), 556⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-40020), 0⟩, ⟨(-40021), 27⟩, ⟨(-10006), (-9964)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35751374, 35791395⟩, ⟨(-40021), 27⟩, ⟨(-10006), (-9964)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1680834⟩, ⟨(-1880), 1680836⟩, ⟨417388, 420211⟩, ⟨(-941), 2⟩, ⟨(-120), (-114)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714147048)⟩, ⟨(-1880), 1680836⟩, ⟨417388, 420211⟩, ⟨(-941), 2⟩, ⟨(-120), (-114)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-33616674), 0⟩, ⟨(-33616764), 78936⟩, ⟨(-8404258), (-8285764)⟩, ⟨(-68), 39469⟩, ⟨4849, 4935⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4261350622, 4294967296⟩, ⟨(-33616764), 78936⟩, ⟨(-8404258), (-8285764)⟩, ⟨(-68), 39469⟩, ⟨4849, 4935⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 310249915⟩, ⟨152939462, 155127403⟩, ⟨(-1092750), 1222⟩, ⟨(-182128), (-179068)⟩, ⟨(-1), 765⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4328849164⟩, ⟨(-80187), 34149244⟩, ⟨8285136, 8806775⟩, ⟨(-40417), 136895⟩, ⟨10378, 13564⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 312697396⟩, ⟨152933669, 158817958⟩, ⟨(-1104268), 1870813⟩, ⟨99851, 148929⟩, ⟨(-5152), 6704⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-296266845), 0⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3998700451, 4294967296⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22766102⟩, ⟨0, 23125654⟩, ⟨5284813, 6145133⟩, ⟨(-81668), 160044⟩, ⟨5877, 12809⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317733398⟩, ⟨0, 23125654⟩, ⟨5284813, 6145133⟩, ⟨(-81668), 160044⟩, ⟨5877, 12809⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306335303⟩, ⟨0, 11562827⟩, ⟨2619907, 3072567⟩, ⟨(-49106), 80022⟩, ⟨1618, 5739⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3998700451, 4306335303⟩, ⟨(-148525506), (-136570595)⟩, ⟨2040383, 3072567⟩, ⟨(-155079), (-10338)⟩, ⟨(-1254), 7433⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2612529451⟩, ⟨1306264720, 1306264730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1589141352⟩, ⟨0, 1589141358⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1589141352⟩, ⟨0, 1589141358⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1589141352), 0⟩, ⟨(-1589141358), 0⟩, ⟨(-397285341), (-397285334)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-794570676), 0⟩, ⟨(-794570679), 0⟩, ⟨(-198642671), (-198642667)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3569564282, 4294967296⟩, ⟨(-794570679), 0⟩, ⟨(-198642671), (-91594757)⟩, ⟨0, 36748975⟩, ⟨418489, 4593622⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3323335737, 4306335303⟩, ⟨(-945199271), (-113504360)⟩, ⟨(-197472673), (-54726704)⟩, ⟨2189007, 43706972⟩, ⟨(-1024567), 4598391⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297772161, 4297772162⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3028
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306335303⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3029
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (269883859 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(3449 / 50000), prawitzNormalCorrection
