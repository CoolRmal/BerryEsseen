...
namespace FiniteNormalPanel93_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6027 / 20000)
def radius : Rat := (861 / 20000)

def j0 : Jet := ⟨⟨1294288394, 1294288395⟩, ⟨184898342, 184898343⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4066126910, 4066126914⟩, ⟨580875272, 580875277⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3849479381, 3849479389⟩, ⟨1099851250, 1099851262⟩, ⟨78560803, 78560805⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨963, 965⟩, ⟨275, 276⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93724), (-93721)⟩, ⟨275, 276⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-84003), (-83999)⟩, ⟨(-23755), (-23751)⟩, ⟨(-1628), (-1625)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5029053, 5029058⟩, ⟨(-23755), (-23751)⟩, ⟨(-1628), (-1625)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4507423, 4507428⟩, ⟨1266543, 1266550⟩, ⟨84444, 84451⟩, ⟨(-844), (-839)⟩, ⟨(-28), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-138658154), (-138658148)⟩, ⟨1266543, 1266550⟩, ⟨84444, 84451⟩, ⟨(-844), (-839)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-124276082), (-124276075)⟩, ⟨(-34372280), (-34372270)⟩, ⟨(-2136227), (-2136217)⟩, ⟨44033, 44043⟩, ⟨1301, 1310⟩⟩
...
def j19 : Jet := ⟨⟨1307379683, 1307379691⟩, ⟨(-34372280), (-34372270)⟩, ⟨(-2136227), (-2136217)⟩, ⟨44033, 44043⟩, ⟨1301, 1310⟩⟩
...
def j25 : Jet := ⟨⟨10520, 10524⟩, ⟨2979, 2983⟩, ⟨204, 209⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841657), (-841652)⟩, ⟨2979, 2983⟩, ⟨204, 209⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-754358), (-754353)⟩, ⟨(-212861), (-212855)⟩, ⟨(-14452), (-14442)⟩, ⟨104, 109⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35037036, 35037042⟩, ⟨(-212861), (-212855)⟩, ⟨(-14452), (-14442)⟩, ⟨104, 109⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨31402881, 31402887⟩, ⟨8781468, 8781478⟩, ⟨573412, 573425⟩, ⟨(-7502), (-7493)⟩, ⟨(-239), (-232)⟩⟩
...
def j33 : Jet := ⟨⟨(-684425002), (-684424995)⟩, ⟨8781468, 8781478⟩, ⟨573412, 573425⟩, ⟨(-7502), (-7493)⟩, ⟨(-239), (-232)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-613434226), (-613434218)⟩, ⟨(-167396298), (-167396284)⟩, ⟨(-9756382), (-9756364)⟩, ⟨300739, 300754⟩, ⟨8351, 8364⟩⟩
...
def j36 : Jet := ⟨⟨3681533070, 3681533078⟩, ⟨(-167396298), (-167396284)⟩, ⟨(-9756382), (-9756364)⟩, ⟨300739, 300754⟩, ⟨8351, 8364⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1237721115, 1237721124⟩, ⟨144276412, 144276426⟩, ⟨(-6671106), (-6671094)⟩, ⟨(-247230), (-247216)⟩, ⟨7186, 7198⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5010614785, 5010614797⟩, ⟨227828536, 227828558⟩, ⟨23637713, 23637744⟩, ⟨1269218, 1269246⟩, ⟨90353, 90380⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1443955981, 1443955996⟩, ⟨233971911, 233971937⟩, ⟨6682434, 6682461⟩, ⟨517502, 517531⟩, ⟨27224, 27254⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1294288395), (-1294288394)⟩, ⟨(-184898343), (-184898342)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3000678901, 3000678902⟩, ⟨(-184898343), (-184898342)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨485453958, 485453969⟩, ⟨157321402, 157321424⟩, ⟨17239044, 17239068⟩, ⟨1076026, 1076052⟩, ⟨85083, 85110⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4780421254, 4780421265⟩, ⟨157321402, 157321424⟩, ⟨17239044, 17239068⟩, ⟨1076026, 1076052⟩, ⟨85083, 85110⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4531197738, 4531197744⟩, ⟨74559786, 74559798⟩, ⟨7556717, 7556730⟩, ⟨385619, 385633⟩, ⟨27676, 27691⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3165721299, 3165721305⟩, ⟨(-142976870), (-142976859)⟩, ⟨2069700, 2069712⟩, ⟨(-55906), (-55893)⟩, ⟨2733, 2747⟩⟩
...
def j47 : Jet := ⟨⟨7866490715, 7866490723⟩, ⟨1123784387, 1123784395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14407950492, 14407950523⟩, ⟨4116557280, 4116557316⟩, ⟨294039805, 294039810⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14407950492, 14407950523⟩, ⟨4116557280, 4116557316⟩, ⟨294039805, 294039810⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14407950523), (-14407950492)⟩, ⟨(-4116557316), (-4116557280)⟩, ⟨(-294039810), (-294039805)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7203975262), (-7203975246)⟩, ⟨(-2058278658), (-2058278640)⟩, ⟨(-147019905), (-147019902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨802629342, 802629354⟩, ⟨(-384644343), (-384644332)⟩, ⟨64692020, 64692026⟩, ⟨(-1556355), (-1556352)⟩, ⟨(-920766), (-920764)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨591599569, 591599580⟩, ⟨(-310231519), (-310231506)⟩, ⟨60874349, 60874360⟩, ⟨(-3496519), (-3496510)⟩, ⟨(-590177), (-590166)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1109390052, 1479186737⟩, ⟨184898342, 184898343⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3485251637, 4647002187⟩, ⟨580875272, 580875277⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2828188932, 5027891446⟩, ⟨942729642, 1256972870⟩, ⟨78560803, 78560805⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨707, 1260⟩, ⟨235, 315⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93980), (-93426)⟩, ⟨235, 315⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-110018), (-61519)⟩, ⟨(-27351), (-20137)⟩, ⟨(-1657), (-1591)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5003038, 5051538⟩, ⟨(-27351), (-20137)⟩, ⟨(-1657), (-1591)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3294445, 5913569⟩, ⟨1066129, 1465134⟩, ⟨81567, 86934⟩, ⟨(-981), (-702)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139871132), (-137252007)⟩, ⟨1066129, 1465134⟩, ⟨81567, 86934⟩, ⟨(-981), (-702)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-163739750), (-90378943)⟩, ⟨(-40232904), (-28411158)⟩, ⟨(-2270713), (-1979967)⟩, ⟨36254, 51781⟩, ⟨1167, 1422⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1267916015, 1341276823⟩, ⟨(-40232904), (-28411158)⟩, ⟨(-2270713), (-1979967)⟩, ⟨36254, 51781⟩, ⟨1167, 1422⟩⟩
...
def j72 : Jet := ⟨⟨7709, 13774⟩, ⟨2531, 3429⟩, ⟨201, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844468), (-838402)⟩, ⟨2531, 3429⟩, ⟨201, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-988575), (-552078)⟩, ⟨(-245478), (-180011)⟩, ⟨(-14760), (-14083)⟩, ⟨87, 125⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34802819, 35239317⟩, ⟨(-245478), (-180011)⟩, ⟨(-14760), (-14083)⟩, ⟨87, 125⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨22917275, 41252808⟩, ⟨7351722, 10194668⟩, ⟨547468, 595792⟩, ⟨(-8754), (-6236)⟩, ⟨(-251), (-215)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692910608), (-674575074)⟩, ⟨7351722, 10194668⟩, ⟨547468, 595792⟩, ⟨(-8754), (-6236)⟩, ⟨(-251), (-215)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-811153865), (-444200299)⟩, ⟨(-197947440), (-136132406)⟩, ⟨(-10700103), (-8657844)⟩, ⟨244392, 356735⟩, ⟨7157, 9389⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3483813431, 3850766997⟩, ⟨(-197947440), (-136132406)⟩, ⟨(-10700103), (-8657844)⟩, ⟨244392, 356735⟩, ⟨7157, 9389⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1028880096, 1451213921⟩, ⟨127949440, 158346844⟩, ⟨(-7898153), (-5449173)⟩, ⟨(-277685), (-211755)⟩, ⟨5849, 8543⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4790407752, 5294986210⟩, ⟨169350607, 300856802⟩, ⟨16757364, 33357336⟩, ⟨482634, 2483333⟩, ⟨13954, 221836⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1147565242, 1789107384⟩, ⟨183277636, 296871163⟩, ⟨(-677766), 16285246⟩, ⟨(-280768), 1617865⟩, ⟨(-56552), 147436⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1479186737), (-1109390052)⟩, ⟨(-184898343), (-184898342)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2815780559, 3185577244⟩, ⟨(-184898343), (-184898342)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨306616068, 745268826⟩, ⟨97939298, 247328724⟩, ⟨7256282, 34087478⟩, ⟨(-327610), 3599170⟩, ⟨(-88500), 408237⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4601583364, 5040236122⟩, ⟨97939298, 247328724⟩, ⟨7256282, 34087478⟩, ⟨(-327610), 3599170⟩, ⟨(-88500), 408237⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4445632694, 4652703441⟩, ⟨45204480, 119473296⟩, ⟨1815248, 16236290⟩, ⟨(-594593), 1720139⟩, ⟨(-118629), 212810⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2914556793, 3450910143⟩, ⟨(-170662828), (-102771143)⟩, ⟨(-3953250), 10096405⟩, ⟨(-1139983), 1197682⟩, ⟨(-162040), 183440⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6742706327, 8990275111⟩, ⟨1123784387, 1123784395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10585433014, 18818547617⟩, ⟨3528477668, 4704636930⟩, ⟨294039805, 294039810⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10585433014, 18818547617⟩, ⟨3528477668, 4704636930⟩, ⟨294039805, 294039810⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18818547617), (-10585433014)⟩, ⟨(-4704636930), (-3528477668)⟩, ⟨(-294039810), (-294039805)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9409273809), (-5292716507)⟩, ⟨(-2352318465), (-1764238834)⟩, ⟨(-147019905), (-147019902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨480310098, 1252494742⟩, ⟨(-685981128), (-197296432)⟩, ⟨(-2352206), 171411759⟩, ⟨(-26791205), 16083856⟩, ⟨(-5136025), 3708590⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨325937536, 1006351507⟩, ⟨(-600939042), (-145377980)⟩, ⟨1678173, 167927648⟩, ⟨(-30282286), 13997157⟩, ⟨(-5162102), 4682851⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1294288394, 1294288395⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4531197738, 4531197744⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1882
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1109390052, 1479186737⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4445632694, 4652703441⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1883
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (52764457 / 4294967296)

theorem envelope_integral : (∫ s in ((2583 / 10000) : ℝ)..(861 / 2500),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((2583 / 10000) : ℝ)..(861 / 2500), prawitzNormalCorrection
