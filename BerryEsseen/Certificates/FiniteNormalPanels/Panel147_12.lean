...
namespace FiniteNormalPanel147_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6609 / 40000)
def radius : Rat := (6609 / 200000)

def j0 : Jet := ⟨⟨709635971, 709635972⟩, ⟨141927194, 141927195⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2229387153, 2229387157⟩, ⟨445877429, 445877434⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1157207199, 1157207204⟩, ⟨462882878, 462882886⟩, ⟨46288287, 46288289⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨289, 290⟩, ⟨115, 116⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94398), (-94396)⟩, ⟨115, 116⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-25434), (-25433)⟩, ⟨(-10144), (-10141)⟩, ⟨(-1004), (-1000)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5087622, 5087624⟩, ⟨(-10144), (-10141)⟩, ⟨(-1004), (-1000)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1370774, 1370776⟩, ⟨545575, 545579⟩, ⟨53465, 53471⟩, ⟨(-219), (-214)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141794803), (-141794800)⟩, ⟨545575, 545579⟩, ⟨53465, 53471⟩, ⟨(-219), (-214)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-38204242), (-38204240)⟩, ⟨(-15134701), (-15134698)⟩, ⟨(-1454967), (-1454963)⟩, ⟨11581, 11586⟩, ⟨549, 552⟩⟩
...
def j19 : Jet := ⟨⟨1393451523, 1393451526⟩, ⟨(-15134701), (-15134698)⟩, ⟨(-1454967), (-1454963)⟩, ⟨11581, 11586⟩, ⟨549, 552⟩⟩
...
def j22 : Jet := ⟨⟨(-30), (-28)⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11805, 11808⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3180, 3182⟩, ⟨1268, 1271⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848997), (-848994)⟩, ⟨1268, 1271⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-228749), (-228747)⟩, ⟨(-91159), (-91155)⟩, ⟨(-8981), (-8977)⟩, ⟨25, 28⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35562645, 35562648⟩, ⟨(-91159), (-91155)⟩, ⟨(-8981), (-8977)⟩, ⟨25, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9581760, 9581762⟩, ⟨3808142, 3808145⟩, ⟨371025, 371029⟩, ⟨(-1945), (-1941)⟩, ⟨(-96), (-91)⟩⟩
...
def j33 : Jet := ⟨⟨(-706246123), (-706246120)⟩, ⟨3808142, 3808145⟩, ⟨371025, 371029⟩, ⟨(-1945), (-1941)⟩, ⟨(-96), (-91)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-190286223), (-190286220)⟩, ⟨(-75088450), (-75088445)⟩, ⟨(-7101068), (-7101063)⟩, ⟨80502, 80508⟩, ⟨3762, 3766⟩⟩
...
def j36 : Jet := ⟨⟨4104681073, 4104681076⟩, ⟨(-75088450), (-75088445)⟩, ⟨(-7101068), (-7101063)⟩, ⟨80502, 80508⟩, ⟨3762, 3766⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨723298388, 723298392⟩, ⟨136803713, 136803718⟩, ⟨(-2326423), (-2326419)⟩, ⟨(-145035), (-145031)⟩, ⟨1486, 1490⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4494074870, 4494074874⟩, ⟨82211769, 82211776⟩, ⟨9278640, 9278648⟩, ⟨223816, 223827⟩, ⟨14407, 14418⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨756829303, 756829309⟩, ⟨156990663, 156990672⟩, ⟨1746922, 1746932⟩, ⟨136944, 136955⟩, ⟨3306, 3318⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-709635972), (-709635971)⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3585331324, 3585331325⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨133363202, 133363205⟩, ⟨55327608, 55327612⟩, ⟨6354019, 6354027⟩, ⟨175968, 175978⟩, ⟨11884, 11895⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4428330498, 4428330501⟩, ⟨55327608, 55327612⟩, ⟨6354019, 6354027⟩, ⟨175968, 175978⟩, ⟨11884, 11895⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4361139147, 4361139150⟩, ⟨27244059, 27244062⟩, ⟨3043707, 3043713⟩, ⟨67633, 67641⟩, ⟨4366, 4374⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3640569930, 3640569935⟩, ⟨(-121371185), (-121371180)⟩, ⟨1640529, 1640537⟩, ⟨(-44122), (-44113)⟩, ⟨1408, 1418⟩⟩
...
def j47 : Jet := ⟨⟨7064316298, 7064316310⟩, ⟨1412863257, 1412863268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11619311933, 11619311974⟩, ⟨4647724764, 4647724810⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11619311933, 11619311974⟩, ⟨4647724764, 4647724810⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11619311974), (-11619311933)⟩, ⟨(-4647724810), (-4647724764)⟩, ⟨(-464772483), (-464772475)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5809655987), (-5809655966)⟩, ⟨(-2323862405), (-2323862382)⟩, ⟨(-232386242), (-232386237)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1110464053, 1110464068⟩, ⟨(-600834773), (-600834758)⟩, ⟨102462263, 102462273⟩, ⟨3193134, 3193139⟩, ⟨(-3203870), (-3203868)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨941269574, 941269589⟩, ⟨(-540669857), (-540669840)⟩, ⟨104253832, 104253846⟩, ⟨(-429767), (-429755)⟩, ⟨(-2760280), (-2760270)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨567708777, 851563166⟩, ⟨141927194, 141927195⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1783509723, 2675264587⟩, ⟨445877429, 445877434⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨740612608, 1666378372⟩, ⟨370306302, 555459462⟩, ⟨46288287, 46288289⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨185, 418⟩, ⟨92, 140⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94502), (-94268)⟩, ⟨92, 140⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-36666), (-16255)⟩, ⟨(-12207), (-8072)⟩, ⟨(-1011), (-991)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5076390, 5096802⟩, ⟨(-12207), (-8072)⟩, ⟨(-1011), (-991)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨875359, 1977478⟩, ⟨432942, 657769⟩, ⟨52737, 54065⟩, ⟨(-263), (-169)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142290218), (-141188098)⟩, ⟨432942, 657769⟩, ⟨52737, 54065⟩, ⟨(-263), (-169)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-55206321), (-24346095)⟩, ⟨(-18327453), (-11917843)⟩, ⟨(-1487089), (-1415585)⟩, ⟨9108, 14053⟩, ⟨528, 568⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1376449444, 1407309671⟩, ⟨(-18327453), (-11917843)⟩, ⟨(-1487089), (-1415585)⟩, ⟨9108, 14053⟩, ⟨528, 568⟩⟩
...
def j72 : Jet := ⟨⟨2033, 4586⟩, ⟨1010, 1528⟩, ⟨124, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850144), (-847590)⟩, ⟨1010, 1528⟩, ⟨124, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-329843), (-146156)⟩, ⟨(-109774), (-72485)⟩, ⟨(-9055), (-8886)⟩, ⟨19, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35461551, 35645239⟩, ⟨(-109774), (-72485)⟩, ⟨(-9055), (-8886)⟩, ⟨19, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6114894, 13829781⟩, ⟨3014856, 4597428⟩, ⟨364469, 376380⟩, ⟨(-2353), (-1533)⟩, ⟨(-98), (-89)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709712989), (-701998101)⟩, ⟨3014856, 4597428⟩, ⟨364469, 376380⟩, ⟨(-2353), (-1533)⟩, ⟨(-98), (-89)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-275357249), (-121050664)⟩, ⟨(-91265878), (-58741602)⟩, ⟨(-7326029), (-6825059)⟩, ⟨63003, 97962⟩, ⟨3584, 3910⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4019610047, 4173916632⟩, ⟨(-91265878), (-58741602)⟩, ⟨(-7326029), (-6825059)⟩, ⟨63003, 97962⟩, ⟨3584, 3910⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨571578500, 876590081⟩, ⟨131478754, 141149396⟩, ⟨(-2828929), (-1825067)⟩, ⟨(-150599), (-138203)⟩, ⟨1164, 1813⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4419528634, 4589187473⟩, ⟨62198221, 104198224⟩, ⟨8102021, 10729964⟩, ⟨108019, 364265⟩, ⟨8022, 22915⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨588155246, 936639547⟩, ⟨143569260, 172085169⟩, ⟨(-40468), 3736318⟩, ⟨32848, 258335⟩, ⟨(-5152), 13144⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-851563166), (-567708777)⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3443404130, 3727258519⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨80542311, 204260844⟩, ⟨39320910, 75056114⟩, ⟨4781484, 8524507⟩, ⟨5752, 412080⟩, ⟨(-88), 29687⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4375509607, 4499228140⟩, ⟨39320910, 75056114⟩, ⟨4781484, 8524507⟩, ⟨5752, 412080⟩, ⟨(-88), 29687⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4335051402, 4395911478⟩, ⟨19208988, 37181054⟩, ⟨2178602, 4180285⟩, ⟨(-33005), 194482⟩, ⟨(-3728), 14443⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3475540760, 3814859900⟩, ⟨(-129862475), (-110985310)⟩, ⟨518002, 2992974⟩, ⟨(-166781), 96785⟩, ⟨(-9663), 13625⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5651453040, 8477179568⟩, ⟨1412863257, 1412863268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7436359641, 16731809226⟩, ⟨3718179812, 5577269770⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7436359641, 16731809226⟩, ⟨3718179812, 5577269770⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16731809226), (-7436359641)⟩, ⟨(-5577269770), (-3718179812)⟩, ⟨(-464772483), (-464772475)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8365904613), (-3718179820)⟩, ⟨(-2788634885), (-1859089906)⟩, ⟨(-232386242), (-232386237)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨612384444, 1807126006⟩, ⟨(-1173330151), (-265072504)⟩, ⟨(-40408787), 347775636⟩, ⟨(-65706428), 51068835⟩, ⟨(-17697975), 11758654⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨495549080, 1605118750⟩, ⟨(-1096811146), (-230324447)⟩, ⟨(-28968206), 345636059⟩, ⟨(-69764669), 46590724⟩, ⟨(-17322413), 12724572⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨709635971, 709635972⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4361139147, 4361139150⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2962
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨567708777, 851563166⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4335051402, 4395911478⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2963
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (64673413 / 4294967296)

theorem envelope_integral : (∫ s in ((6609 / 50000) : ℝ)..(19827 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((6609 / 50000) : ℝ)..(19827 / 100000), prawitzNormalCorrection
