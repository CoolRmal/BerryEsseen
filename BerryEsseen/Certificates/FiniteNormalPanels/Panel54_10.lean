...
namespace FiniteNormalPanel54_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (103 / 500)
def radius : Rat := (103 / 2500)

def j0 : Jet := ⟨⟨884763262, 884763263⟩, ⟨176952652, 176952653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2779565763, 2779565768⟩, ⟨555913151, 555913155⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1798846253, 1798846261⟩, ⟨719538498, 719538506⟩, ⟨71953849, 71953851⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨450, 451⟩, ⟨180, 181⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94237), (-94235)⟩, ⟨180, 181⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-39469), (-39468)⟩, ⟨(-15713), (-15711)⟩, ⟨(-1542), (-1539)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5073587, 5073589⟩, ⟨(-15713), (-15711)⟩, ⟨(-1542), (-1539)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2124952, 2124954⟩, ⟨843399, 843402⟩, ⟨81719, 81723⟩, ⟨(-521), (-516)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-141040625), (-141040622)⟩, ⟨843399, 843402⟩, ⟨81719, 81723⟩, ⟨(-521), (-516)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-59071556), (-59071554)⟩, ⟨(-23275386), (-23275381)⟩, ⟨(-2187342), (-2187338)⟩, ⟨27600, 27606⟩, ⟨1270, 1275⟩⟩
...
def j19 : Jet := ⟨⟨1372584209, 1372584212⟩, ⟨(-23275386), (-23275381)⟩, ⟨(-2187342), (-2187338)⟩, ⟨27600, 27606⟩, ⟨1270, 1275⟩⟩
...
def j25 : Jet := ⟨⟨4937, 4939⟩, ⟨1967, 1969⟩, ⟨192, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847240), (-847237)⟩, ⟨1967, 1969⟩, ⟨192, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-354847), (-354845)⟩, ⟨(-141116), (-141113)⟩, ⟨(-13785), (-13780)⟩, ⟨63, 66⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35436547, 35436550⟩, ⟨(-141116), (-141113)⟩, ⟨(-13785), (-13780)⟩, ⟨63, 66⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨14841766, 14841768⟩, ⟨5877602, 5877606⟩, ⟨564254, 564260⟩, ⟨(-4649), (-4644)⟩, ⟨(-221), (-216)⟩⟩
...
def j33 : Jet := ⟨⟨(-700986117), (-700986114)⟩, ⟨5877602, 5877606⟩, ⟨564254, 564260⟩, ⟨(-4649), (-4644)⟩, ⟨(-221), (-216)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-293591585), (-293591582)⟩, ⟨(-114974940), (-114974934)⟩, ⟨(-10522662), (-10522656)⟩, ⟨191048, 191054⟩, ⟨8580, 8586⟩⟩
...
def j36 : Jet := ⟨⟨4001375711, 4001375714⟩, ⟨(-114974940), (-114974934)⟩, ⟨(-10522662), (-10522656)⟩, ⟨191048, 191054⟩, ⟨8580, 8586⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨888292694, 888292699⟩, ⟨162595450, 162595458⟩, ⟨(-4428196), (-4428191)⟩, ⟨(-265255), (-265249)⟩, ⟨4393, 4400⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4610100473, 4610100477⟩, ⟨132465939, 132465949⟩, ⟨15929711, 15929721⟩, ⟨585955, 585966⟩, ⟨42508, 42521⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨953469092, 953469099⟩, ⟨201922348, 201922361⟩, ⟨3556294, 3556305⟩, ⟨302948, 302961⟩, ⟨11082, 11099⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-884763263), (-884763262)⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3410204033, 3410204034⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨211667108, 211667112⟩, ⟨89652238, 89652246⟩, ⟨11072088, 11072098⟩, ⟨468894, 468906⟩, ⟨36348, 36361⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4506634404, 4506634408⟩, ⟨89652238, 89652246⟩, ⟨11072088, 11072098⟩, ⟨468894, 468906⟩, ⟨36348, 36361⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4399528086, 4399528089⟩, ⟨43760765, 43760770⟩, ⟨5186834, 5186841⟩, ⟨177283, 177290⟩, ⟨12920, 12929⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3493225300, 3493225304⟩, ⟨(-146514511), (-146514504)⟩, ⟨2315402, 2315409⟩, ⟨(-72936), (-72928)⟩, ⟨2953, 2962⟩⟩
...
def j47 : Jet := ⟨⟨6318915737, 6318915747⟩, ⟨1263783144, 1263783153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9296624011, 9296624041⟩, ⟨3718649594, 3718649628⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9296624011, 9296624041⟩, ⟨3718649594, 3718649628⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9296624041), (-9296624011)⟩, ⟨(-3718649628), (-3718649594)⟩, ⟨(-371864964), (-371864958)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4648312021), (-4648312005)⟩, ⟨(-1859324814), (-1859324797)⟩, ⟨(-185932482), (-185932479)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1455245269, 1455245288⟩, ⟨(-629987027), (-629987012)⟩, ⟨73364439, 73364447⟩, ⟨7595071, 7595074⟩, ⟨(-2409994), (-2409993)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1183594481, 1183594499⟩, ⟨(-562030166), (-562030148)⟩, ⟨81944796, 81944811⟩, ⟨3310273, 3310284⟩, ⟨(-2167966), (-2167956)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨707810610, 1061715916⟩, ⟨176952652, 176952653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2223652612, 3335478923⟩, ⟨555913151, 555913155⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1151261604, 2590338618⟩, ⟨575630798, 863446208⟩, ⟨71953849, 71953851⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨288, 649⟩, ⟨144, 217⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94399), (-94037)⟩, ⟨144, 217⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-56934), (-25206)⟩, ⟨(-18940), (-12472)⟩, ⟨(-1559), (-1519)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5056122, 5087851⟩, ⟨(-18940), (-12472)⟩, ⟨(-1559), (-1519)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1355288, 3068535⟩, ⟨666221, 1019502⟩, ⟨79956, 83160⟩, ⟨(-631), (-406)⟩, ⟨(-27), (-22)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141810289), (-140097041)⟩, ⟨666221, 1019502⟩, ⟨79956, 83160⟩, ⟨(-631), (-406)⟩, ⟨(-27), (-22)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-85527233), (-37552868)⟩, ⟨(-28330499), (-18161561)⟩, ⟨(-2265036), (-2091941)⟩, ⟨21496, 33691⟩, ⟨1195, 1335⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1346128532, 1394102898⟩, ⟨(-28330499), (-18161561)⟩, ⟨(-2265036), (-2091941)⟩, ⟨21496, 33691⟩, ⟨1195, 1335⟩⟩
...
def j72 : Jet := ⟨⟨3154, 7122⟩, ⟨1563, 2371⟩, ⟨190, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849023), (-845054)⟩, ⟨1563, 2371⟩, ⟨190, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-512055), (-226515)⟩, ⟨(-170267), (-111827)⟩, ⟨(-13965), (-13561)⟩, ⟨49, 80⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35279339, 35564880⟩, ⟨(-170267), (-111827)⟩, ⟨(-13965), (-13561)⟩, ⟨49, 80⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9456590, 21449543⟩, ⟨4625605, 7119873⟩, ⟨548383, 577199⟩, ⟨(-5648), (-3641)⟩, ⟨(-228), (-207)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706371293), (-694378339)⟩, ⟨4625605, 7119873⟩, ⟨548383, 577199⟩, ⟨(-5648), (-3641)⟩, ⟨(-228), (-207)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-426019738), (-186127405)⟩, ⟨(-140766692), (-88769633)⟩, ⟨(-11066945), (-9853490)⟩, ⟨147582, 234344⟩, ⟨7913, 9128⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3868947558, 4108839891⟩, ⟨(-140766692), (-88769633)⟩, ⟨(-11066945), (-9853490)⟩, ⟨147582, 234344⟩, ⟨7913, 9128⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨696937140, 1082662687⟩, ⟨152232770, 171040916⟩, ⟨(-5425950), (-3433785)⟩, ⟨(-282043), (-244602)⟩, ⟨3400, 5398⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4489526134, 4767897160⟩, ⟨96994186, 173473821⟩, ⟨12861935, 19949972⟩, ⟨238545, 1050816⟩, ⟨15509, 82420⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨728507876, 1201877453⟩, ⟨174867884, 233603440⟩, ⟨(-498427), 8347946⟩, ⟨(-37663), 726140⟩, ⟨(-22071), 52813⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1061715916), (-707810610)⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3233251380, 3587156686⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨123568746, 336326057⟩, ⟨59321816, 130740324⟩, ⟨6840722, 17377779⟩, ⟨(-75300), 1314490⟩, ⟨(-17421), 124774⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4418536042, 4631293353⟩, ⟨59321816, 130740324⟩, ⟨6840722, 17377779⟩, ⟨(-75300), 1314490⟩, ⟨(-17421), 124774⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4356313555, 4459961154⟩, ⟨28563618, 64449610⟩, ⟨2828155, 8472889⟩, ⟨(-162473), 629447⟩, ⟨(-26141), 62996⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3279432843, 3724959557⟩, ⟨(-162247709), (-125651802)⟩, ⟨(-526289), 5899736⟩, ⟨(-484782), 409196⟩, ⟨(-47767), 59309⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5055132593, 7582698899⟩, ⟨1263783144, 1263783153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5949839375, 13387138628⟩, ⟨2974919676, 4462379554⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5949839375, 13387138628⟩, ⟨2974919676, 4462379554⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13387138628), (-5949839375)⟩, ⟨(-4462379554), (-2974919676)⟩, ⟨(-371864964), (-371864958)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6693569314), (-2974919687)⟩, ⟨(-2231189777), (-1487459838)⟩, ⟨(-185932482), (-185932479)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨903911232, 2148546311⟩, ⟨(-1116146931), (-313048170)⟩, ⟨(-38803849), 250782202⟩, ⟨(-34391496), 38931977⟩, ⟨(-10484466), 5306429⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨690183644, 1863401410⟩, ⟨(-1049181190), (-265473156)⟩, ⟨(-24758853), 262614736⟩, ⟨(-41076524), 35572443⟩, ⟨(-10747261), 6401504⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨884763262, 884763263⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4399528086, 4399528089⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1066
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨707810610, 1061715916⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4356313555, 4459961154⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1067
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (99884435 / 4294967296)

theorem envelope_integral : (∫ s in ((103 / 625) : ℝ)..(309 / 1250),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((103 / 625) : ℝ)..(309 / 1250), prawitzNormalCorrection
