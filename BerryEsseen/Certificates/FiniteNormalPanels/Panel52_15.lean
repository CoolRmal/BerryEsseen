...
namespace FiniteNormalPanel52_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (50163 / 400000)
def radius : Rat := (16721 / 400000)

def j0 : Jet := ⟨⟨538621111, 538621112⟩, ⟨179540370, 179540371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1692128125, 1692128129⟩, ⟨564042707, 564042711⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨666663421, 666663425⟩, ⟨444442278, 444442284⟩, ⟨74073713, 74073715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨166, 168⟩, ⟨111, 112⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94521), (-94518)⟩, ⟨111, 112⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-14672), (-14671)⟩, ⟨(-9765), (-9762)⟩, ⟨(-1618), (-1615)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098384, 5098386⟩, ⟨(-9765), (-9762)⟩, ⟨(-1618), (-1615)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨791369, 791370⟩, ⟨526063, 526065⟩, ⟨86666, 86670⟩, ⟨(-337), (-334)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-142374208), (-142374206)⟩, ⟨526063, 526065⟩, ⟨86666, 86670⟩, ⟨(-337), (-334)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-22099279), (-22099277)⟩, ⟨(-14651198), (-14651195)⟩, ⟨(-2387588), (-2387584)⟩, ⟨17987, 17991⟩, ⟨1454, 1458⟩⟩
...
def j19 : Jet := ⟨⟨1409556486, 1409556489⟩, ⟨(-14651198), (-14651195)⟩, ⟨(-2387588), (-2387584)⟩, ⟨17987, 17991⟩, ⟨1454, 1458⟩⟩
...
def j22 : Jet := ⟨⟨(-17), (-16)⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11818, 11820⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1834, 1835⟩, ⟨1220, 1223⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850343), (-850341)⟩, ⟨1220, 1223⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-131990), (-131989)⟩, ⟨(-87805), (-87803)⟩, ⟨(-14509), (-14506)⟩, ⟨40, 44⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35659404, 35659406⟩, ⟨(-87805), (-87803)⟩, ⟨(-14509), (-14506)⟩, ⟨40, 44⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5535041, 5535042⟩, ⟨3676397, 3676400⟩, ⟨603664, 603669⟩, ⟨(-3011), (-3008)⟩, ⟨(-247), (-244)⟩⟩
...
def j33 : Jet := ⟨⟨(-710292842), (-710292840)⟩, ⟨3676397, 3676400⟩, ⟨603664, 603669⟩, ⟨(-3011), (-3008)⟩, ⟨(-247), (-244)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-110251424), (-110251422)⟩, ⟨(-72930301), (-72930297)⟩, ⟨(-11776027), (-11776021)⟩, ⟨125404, 125408⟩, ⟨10060, 10064⟩⟩
...
def j36 : Jet := ⟨⟨4184715872, 4184715874⟩, ⟨(-72930301), (-72930297)⟩, ⟨(-11776027), (-11776021)⟩, ⟨125404, 125408⟩, ⟨10060, 10064⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨555336050, 555336053⟩, ⟨179339747, 179339751⟩, ⟨(-2864751), (-2864747)⟩, ⟨(-306468), (-306463)⟩, ⟨2934, 2938⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4408123425, 4408123428⟩, ⟨76823793, 76823800⟩, ⟨13743569, 13743578⟩, ⟨323600, 323611⟩, ⟨31408, 31418⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨569967052, 569967057⟩, ⟨193997928, 193997935⟩, ⟨2044644, 2044652⟩, ⟨249929, 249939⟩, ⟨5935, 5945⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-538621112), (-538621111)⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3756346184, 3756346185⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨75637931, 75637933⟩, ⟨51489298, 51489302⟩, ⟨9305298, 9305304⟩, ⟨251040, 251048⟩, ⟨25123, 25132⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4370605227, 4370605229⟩, ⟨51489298, 51489302⟩, ⟨9305298, 9305304⟩, ⟨251040, 251048⟩, ⟨25123, 25132⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4332621205, 4332621207⟩, ⟨25520907, 25520910⟩, ⟨4537049, 4537053⟩, ⟨97703, 97709⟩, ⟨9500, 9507⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3789278010, 3789278014⟩, ⟨(-158794006), (-158794000)⟩, ⟨2901231, 2901236⟩, ⟨(-104211), (-104203)⟩, ⟨4223, 4231⟩⟩
...
def j47 : Jet := ⟨⟨4009561155, 4009561164⟩, ⟨1336520382, 1336520391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3743120621, 3743120639⟩, ⟨2495413742, 2495413766⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3743120621, 3743120639⟩, ⟨2495413742, 2495413766⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3743120639), (-3743120621)⟩, ⟨(-2495413766), (-2495413742)⟩, ⟨(-415902296), (-415902289)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1871560320), (-1871560310)⟩, ⟨(-1247706883), (-1247706871)⟩, ⟨(-207951148), (-207951144)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2777878052, 2777878066⟩, ⟨(-806985792), (-806985779)⟩, ⟨(-17281176), (-17281168)⟩, ⟨27721519, 27721522⟩, ⟨(-1594952), (-1594950)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2450810795, 2450810811⟩, ⟨(-814675333), (-814675314)⟩, ⟨16465918, 16465933⟩, ⟨24483990, 24484004⟩, ⟨(-2421452), (-2421438)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨359080740, 718161482⟩, ⟨179540370, 179540371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1128085414, 2256170837⟩, ⟨564042707, 564042711⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨296294852, 1185179420⟩, ⟨296294852, 592589712⟩, ⟨74073713, 74073715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨74, 297⟩, ⟨74, 149⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94613), (-94389)⟩, ⟨74, 149⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-26109), (-6511)⟩, ⟨(-13050), (-6469)⟩, ⟨(-1626), (-1600)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5086947, 5106546⟩, ⟨(-13050), (-6469)⟩, ⟨(-1626), (-1600)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨350930, 1409132⟩, ⟨347328, 704120⟩, ⟨85482, 87515⟩, ⟨(-451), (-219)⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142814647), (-141756444)⟩, ⟨347328, 704120⟩, ⟨85482, 87515⟩, ⟨(-451), (-219)⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-39409144), (-9779283)⟩, ⟨(-19680612), (-9584983)⟩, ⟨(-2433215), (-2323520)⟩, ⟨11762, 24204⟩, ⟨1402, 1494⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1392246621, 1421876483⟩, ⟨(-19680612), (-9584983)⟩, ⟨(-2433215), (-2323520)⟩, ⟨11762, 24204⟩, ⟨1402, 1494⟩⟩
...
def j72 : Jet := ⟨⟨814, 3265⟩, ⟨809, 1633⟩, ⟨199, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851363), (-848911)⟩, ⟨809, 1633⟩, ⟨199, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-234931), (-58563)⟩, ⟨(-117411), (-58112)⟩, ⟨(-14616), (-14357)⟩, ⟨25, 58⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35556463, 35732832⟩, ⟨(-117411), (-58112)⟩, ⟨(-14616), (-14357)⟩, ⟨25, 58⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2452916, 9860336⟩, ⟨2420516, 4926160⟩, ⟨592995, 611273⟩, ⟨(-4041), (-1975)⟩, ⟨(-252), (-236)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713374967), (-705967546)⟩, ⟨2420516, 4926160⟩, ⟨592995, 611273⟩, ⟨(-4041), (-1975)⟩, ⟨(-252), (-236)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-196853031), (-48702245)⟩, ⟨(-98259534), (-47342890)⟩, ⟨(-12095425), (-11327204)⟩, ⟨81537, 169164⟩, ⟨9599, 10391⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4098114265, 4246265051⟩, ⟨(-98259534), (-47342890)⟩, ⟨(-12095425), (-11327204)⟩, ⟨81537, 169164⟩, ⟨9599, 10391⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨365677547, 746919833⟩, ⟨172500435, 184212436⟩, ⟨(-3862767), (-1869040)⟩, ⟨(-316457), (-292424)⟩, ⟨1912, 3964⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4344228128, 4501276168⟩, ⟨48435109, 107926054⟩, ⟨12128544, 15873061⟩, ⟨85104, 612692⟩, ⟨17985, 50403⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨369871660, 782798148⟩, ⟨178602726, 211830056⟩, ⟨(-1070363), 5498923⟩, ⟨65643, 470498⟩, ⟨(-15347), 30626⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-718161482), (-359080740)⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3576805814, 3935886556⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨31852406, 142672319⟩, ⟨30761624, 77216038⟩, ⟨7036881, 12452033⟩, ⟨(-94276), 713926⟩, ⟨(-1509), 64617⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4326819702, 4437639615⟩, ⟨30761624, 77216038⟩, ⟨7036881, 12452033⟩, ⟨(-94276), 713926⟩, ⟨(-1509), 64617⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310864079, 4365720676⟩, ⟨15131541, 38465648⟩, ⟨3291961, 6176502⟩, ⟨(-102078), 344093⟩, ⟨(-8248), 31845⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3590044495, 4000724600⟩, ⟨(-169896644), (-144955167)⟩, ⟨1133551, 5027580⟩, ⟨(-351738), 177714⟩, ⟨(-21943), 33451⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2673040765, 5346081547⟩, ⟨1336520382, 1336520391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1663609159, 6654436679⟩, ⟨1663609158, 3327218350⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1663609159, 6654436679⟩, ⟨1663609158, 3327218350⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6654436679), (-1663609159)⟩, ⟨(-3327218350), (-1663609158)⟩, ⟨(-415902296), (-415902289)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3327218340), (-831804579)⟩, ⟨(-1663609175), (-831804579)⟩, ⟨(-207951148), (-207951144)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1979344146, 3538752790⟩, ⟨(-1370697657), (-383338780)⟩, ⟨(-134216676), 169627770⟩, ⟨(-9527651), 61572871⟩, ⟨(-10068865), 4171820⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1654479083, 3296317380⟩, ⟨(-1416775879), (-387225168)⟩, ⟨(-111561580), 216370051⟩, ⟨(-17479227), 62709074⟩, ⟨(-12046614), 4601279⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨538621111, 538621112⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4332621205, 4332621207⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1032
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨359080740, 718161482⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310864079, 4365720676⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1033
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (102717927 / 2147483648)

theorem envelope_integral : (∫ s in ((16721 / 200000) : ℝ)..(16721 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((16721 / 200000) : ℝ)..(16721 / 100000), prawitzNormalCorrection
