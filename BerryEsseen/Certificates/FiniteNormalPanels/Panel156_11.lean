...
namespace FiniteNormalPanel156_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (19137 / 200000)
def radius : Rat := (6379 / 200000)

def j0 : Jet := ⟨⟨410963945, 410963946⟩, ⟨136987981, 136987982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1291081310, 1291081314⟩, ⟨430360434, 430360438⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨388103292, 388103295⟩, ⟨258735526, 258735530⟩, ⟨43122587, 43122589⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨97, 98⟩, ⟨64, 65⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94590), (-94588)⟩, ⟨64, 65⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8548), (-8547)⟩, ⟨(-5694), (-5692)⟩, ⟨(-947), (-944)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104508, 5104510⟩, ⟨(-5694), (-5692)⟩, ⟨(-947), (-944)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨461255, 461256⟩, ⟨306988, 306990⟩, ⟨50820, 50824⟩, ⟨(-116), (-112)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142704322), (-142704320)⟩, ⟨306988, 306990⟩, ⟨50820, 50824⟩, ⟨(-116), (-112)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12895097), (-12895096)⟩, ⟨(-8568991), (-8568989)⟩, ⟨(-1409704), (-1409701)⟩, ⟨6132, 6135⟩, ⟨502, 505⟩⟩
...
def j19 : Jet := ⟨⟨1418760668, 1418760670⟩, ⟨(-8568991), (-8568989)⟩, ⟨(-1409704), (-1409701)⟩, ⟨6132, 6135⟩, ⟨502, 505⟩⟩
...
def j25 : Jet := ⟨⟨1068, 1069⟩, ⟨711, 713⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851109), (-851107)⟩, ⟨711, 713⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-76909), (-76908)⟩, ⟨(-51209), (-51207)⟩, ⟨(-8494), (-8491)⟩, ⟨12, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35714485, 35714487⟩, ⟨(-51209), (-51207)⟩, ⟨(-8494), (-8491)⟩, ⟨12, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3227244, 3227245⟩, ⟨2146868, 2146870⟩, ⟨354729, 354732⟩, ⟨(-1026), (-1023)⟩, ⟨(-87), (-83)⟩⟩
...
def j33 : Jet := ⟨⟨(-712600639), (-712600637)⟩, ⟨2146868, 2146870⟩, ⟨354729, 354732⟩, ⟨(-1026), (-1023)⟩, ⟨(-87), (-83)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-64392262), (-64392260)⟩, ⟨(-42734179), (-42734176)⟩, ⟨(-6993312), (-6993309)⟩, ⟨42831, 42834⟩, ⟨3491, 3494⟩⟩
...
def j36 : Jet := ⟨⟨4230575034, 4230575036⟩, ⟨(-42734179), (-42734176)⟩, ⟨(-6993312), (-6993309)⟩, ⟨42831, 42834⟩, ⟨3491, 3494⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨426484127, 426484130⟩, ⟨139585508, 139585511⟩, ⟨(-1282385), (-1282382)⟩, ⟨(-139411), (-139408)⟩, ⟨764, 767⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4360339650, 4360339653⟩, ⟨44044962, 44044967⟩, ⟨7652723, 7652730⟩, ⟨105961, 105968⟩, ⟨9670, 9679⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨432975508, 432975512⟩, ⟨146083696, 146083702⟩, ⟨889451, 889458⟩, ⟨104548, 104557⟩, ⟨1463, 1472⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-410963946), (-410963945)⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3884003350, 3884003351⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨43648246, 43648248⟩, ⟨29453384, 29453388⟩, ⟨5148039, 5148045⟩, ⟨81582, 81588⟩, ⟨7588, 7597⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4338615542, 4338615544⟩, ⟨29453384, 29453388⟩, ⟨5148039, 5148045⟩, ⟨81582, 81588⟩, ⟨7588, 7597⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316736251, 4316736253⟩, ⟨14652426, 14652429⟩, ⟨2536170, 2536175⟩, ⟨31975, 31980⟩, ⟨2920, 2927⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3903689342, 3903689346⟩, ⟨(-124431895), (-124431889)⟩, ⟨1826156, 1826163⟩, ⟨(-51977), (-51971)⟩, ⟨1619, 1628⟩⟩
...
def j47 : Jet := ⟨⟨4870995067, 4870995081⟩, ⟨1623665014, 1623665027⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5524277906, 5524277939⟩, ⟨3682851918, 3682851960⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5524277906, 5524277939⟩, ⟨3682851918, 3682851960⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5524277939), (-5524277906)⟩, ⟨(-3682851960), (-3682851918)⟩, ⟨(-613808660), (-613808649)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2762138970), (-2762138953)⟩, ⟨(-1841425980), (-1841425959)⟩, ⟨(-306904330), (-306904324)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2257670080, 2257670100⟩, ⟨(-967954374), (-967954353)⟩, ⟨46174835, 46174847⟩, ⟨39512228, 39512233⟩, ⟨(-5884875), (-5884873)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2051992953, 2051992975⟩, ⟨(-945180503), (-945180477)⟩, ⟨70971309, 70971329⟩, ⟨34135962, 34135977⟩, ⟨(-6461291), (-6461278)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨273975963, 547951928⟩, ⟨136987981, 136987982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨860720872, 1721441752⟩, ⟨430360434, 430360438⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨172490351, 689961414⟩, ⟨172490350, 344980708⟩, ⟨43122587, 43122589⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨43, 173⟩, ⟨43, 87⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94644), (-94513)⟩, ⟨43, 87⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-15205), (-3795)⟩, ⟨(-7602), (-3781)⟩, ⟨(-950), (-939)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097851, 5109262⟩, ⟨(-7602), (-3781)⟩, ⟨(-950), (-939)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨204734, 820774⟩, ⟨203512, 410236⟩, ⟨50419, 51111⟩, ⟨(-154), (-73)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142960843), (-142344802)⟩, ⟨203512, 410236⟩, ⟨50419, 51111⟩, ⟨(-154), (-73)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-22965825), (-5716715)⟩, ⟨(-11474740), (-5650812)⟩, ⟨(-1425168), (-1388015)⟩, ⟨4042, 8223⟩, ⟨491, 512⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408689940, 1425939051⟩, ⟨(-11474740), (-5650812)⟩, ⟨(-1425168), (-1388015)⟩, ⟨4042, 8223⟩, ⟨491, 512⟩⟩
...
def j72 : Jet := ⟨⟨474, 1901⟩, ⟨472, 951⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851703), (-850275)⟩, ⟨472, 951⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-136822), (-34147)⟩, ⟨(-68393), (-33994)⟩, ⟨(-8530), (-8439)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35654572, 35757248⟩, ⟨(-68393), (-33994)⟩, ⟨(-8530), (-8439)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1431924, 5744194⟩, ⟨1420937, 2870732⟩, ⟨351116, 357310⟩, ⟨(-1373), (-675)⟩, ⟨(-87), (-81)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714395959), (-710083688)⟩, ⟨1420937, 2870732⟩, ⟨351116, 357310⟩, ⟨(-1373), (-675)⟩, ⟨(-87), (-81)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-114763539), (-28517699)⟩, ⟨(-57324704), (-28056531)⟩, ⟨(-7101555), (-6841440)⟩, ⟨28146, 57496⟩, ⟨3400, 3558⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4180203757, 4266449597⟩, ⟨(-57324704), (-28056531)⟩, ⟨(-7101555), (-6841440)⟩, ⟨28146, 57496⟩, ⟨3400, 3558⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨282304555, 571522634⟩, ⟨136553150, 141748224⟩, ⟨(-1720996), (-844378)⟩, ⟨(-141994), (-135784)⟩, ⟨503, 1030⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4323675612, 4412881560⟩, ⟨28432853, 60515503⟩, ⟨7120180, 8326714⟩, ⟨32945, 187884⟩, ⟨7136, 13016⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨284191528, 587213248⟩, ⟨139334762, 153692464⟩, ⟨(-396255), 2255213⟩, ⟨58400, 157532⟩, ⟨(-3316), 6696⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-547951928), (-273975963)⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3747015368, 4020991333⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨18804526, 80284523⟩, ⟨18439142, 42026050⟩, ⟨4411861, 6116452⟩, ⟨(-20632), 204480⟩, ⟨2671, 14293⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4313771822, 4375251819⟩, ⟨18439142, 42026050⟩, ⟨4411861, 6116452⟩, ⟨(-20632), 204480⟩, ⟨2671, 14293⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304359290, 4334923699⟩, ⟨9134591, 20967176⟩, ⟨2134890, 3041861⟩, ⟨(-25112), 97487⟩, ⟨(-218), 6725⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3755209131, 4058398918⟩, ⟨(-130293193), (-117657858)⟩, ⟨1193771, 2556474⟩, ⟨(-120532), 23177⟩, ⟨(-3315), 7098⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3247330041, 6494660108⟩, ⟨1623665014, 1623665027⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2455234619, 9820938558⟩, ⟨2455234608, 4910469280⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2455234619, 9820938558⟩, ⟨2455234608, 4910469280⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9820938558), (-2455234619)⟩, ⟨(-4910469280), (-2455234608)⟩, ⟨(-613808660), (-613808649)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4910469279), (-1227617309)⟩, ⟨(-2455234640), (-1227617304)⟩, ⟨(-306904330), (-306904324)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1369076210, 3227206859⟩, ⟨(-1844845263), (-391318846)⟩, ⟨(-174680927), 429476749⟩, ⟨(-63195771), 121170086⟩, ⟨(-32661340), 15272591⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1197021334, 3049451119⟩, ⟨(-1841131856), (-379645888)⟩, ⟨(-153958982), 463707612⟩, ⟨(-73932305), 119703809⟩, ⟨(-34654610), 16661238⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨410963945, 410963946⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316736251, 4316736253⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3154
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨273975963, 547951928⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304359290, 4334923699⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3155
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (132618283 / 4294967296)

theorem envelope_integral : (∫ s in ((6379 / 100000) : ℝ)..(6379 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((6379 / 100000) : ℝ)..(6379 / 50000), prawitzNormalCorrection
