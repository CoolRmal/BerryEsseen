...
namespace FiniteNormalPanel117_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (14633 / 80000)
def radius : Rat := (14633 / 400000)

def j0 : Jet := ⟨⟨785603205, 785603206⟩, ⟨157120641, 157120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2468045257, 2468045261⟩, ⟨493609051, 493609055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1418229050, 1418229056⟩, ⟨567291618, 567291626⟩, ⟨56729161, 56729163⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨354, 356⟩, ⟨141, 143⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94333), (-94330)⟩, ⟨141, 143⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-31150), (-31148)⟩, ⟨(-12414), (-12411)⟩, ⟨(-1224), (-1221)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5081906, 5081909⟩, ⟨(-12414), (-12411)⟩, ⟨(-1224), (-1221)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1678081, 1678083⟩, ⟨667132, 667136⟩, ⟨65078, 65082⟩, ⟨(-326), (-322)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-141487496), (-141487493)⟩, ⟨667132, 667136⟩, ⟨65078, 65082⟩, ⟨(-326), (-322)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-46720188), (-46720186)⟩, ⟨(-18467785), (-18467780)⟩, ⟨(-1759203), (-1759198)⟩, ⟨17298, 17303⟩, ⟨809, 814⟩⟩
...
def j19 : Jet := ⟨⟨1384935577, 1384935580⟩, ⟨(-18467785), (-18467780)⟩, ⟨(-1759203), (-1759198)⟩, ⟨17298, 17303⟩, ⟨809, 814⟩⟩
...
def j25 : Jet := ⟨⟨3896, 3897⟩, ⟨1553, 1555⟩, ⟨152, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848281), (-848279)⟩, ⟨1553, 1555⟩, ⟨152, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-280109), (-280107)⟩, ⟨(-111532), (-111529)⟩, ⟨(-10950), (-10946)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35511285, 35511288⟩, ⟨(-111532), (-111529)⟩, ⟨(-10950), (-10946)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11726081, 11726083⟩, ⟨4653603, 4653606⟩, ⟨450695, 450699⟩, ⟨(-2909), (-2904)⟩, ⟨(-140), (-137)⟩⟩
...
def j33 : Jet := ⟨⟨(-704101802), (-704101799)⟩, ⟨4653603, 4653606⟩, ⟨450695, 450699⟩, ⟨(-2909), (-2904)⟩, ⟨(-140), (-137)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-232499474), (-232499471)⟩, ⟨(-91463137), (-91463133)⟩, ⟨(-8536497), (-8536491)⟩, ⟨120034, 120039⟩, ⟨5520, 5525⟩⟩
...
def j36 : Jet := ⟨⟨4062467822, 4062467825⟩, ⟨(-91463137), (-91463133)⟩, ⟨(-8536497), (-8536491)⟩, ⟨120034, 120039⟩, ⟨5520, 5525⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨795834623, 795834627⟩, ⟨148554659, 148554666⟩, ⟨(-3133356), (-3133351)⟩, ⟨(-192241), (-192236)⟩, ⟨2452, 2457⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4540772965, 4540772970⟩, ⟨102231780, 102231787⟩, ⟨11843220, 11843230⟩, ⟨347287, 347297⟩, ⟨23506, 23518⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨841381107, 841381113⟩, ⟨175999609, 175999620⟩, ⟨2417803, 2417814⟩, ⟨196157, 196169⟩, ⟨5741, 5754⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-785603206), (-785603205)⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3509364090, 3509364091⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨164825973, 164825977⟩, ⟨68956402, 68956408⟩, ⟨8159419, 8159429⟩, ⟨275006, 275016⟩, ⟨19685, 19696⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4459793269, 4459793273⟩, ⟨68956402, 68956408⟩, ⟨8159419, 8159429⟩, ⟨275006, 275016⟩, ⟨19685, 19696⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4376604418, 4376604421⟩, ⟨33835076, 33835080⟩, ⟨3872822, 3872828⟩, ⟨104997, 105004⟩, ⟨7132, 7140⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3576068761, 3576068766⟩, ⟨(-132460916), (-132460910)⟩, ⟨1926662, 1926669⟩, ⟨(-55887), (-55879)⟩, ⟨1985, 1994⟩⟩
...
def j47 : Jet := ⟨⟨6484002658, 6484002668⟩, ⟨1296800531, 1296800541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9788733550, 9788733581⟩, ⟨3915493418, 3915493456⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9788733550, 9788733581⟩, ⟨3915493418, 3915493456⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9788733581), (-9788733550)⟩, ⟨(-3915493456), (-3915493418)⟩, ⟨(-391549348), (-391549341)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4894366791), (-4894366775)⟩, ⟨(-1957746728), (-1957746709)⟩, ⟨(-195774674), (-195774670)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1374218721, 1374218740⟩, ⟨(-626401101), (-626401085)⟩, ⟨80124033, 80124042⟩, ⟨6861080, 6861084⟩, ⟨(-2607982), (-2607980)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1144199780, 1144199799⟩, ⟨(-563935304), (-563935286)⟩, ⟨86648008, 86648022⟩, ⟨2942680, 2942690⟩, ⟨(-2338331), (-2338321)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨628482564, 942723847⟩, ⟨157120641, 157120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1974436205, 2961654313⟩, ⟨493609051, 493609055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨907666591, 2042249840⟩, ⟨453833294, 680749952⟩, ⟨56729161, 56729163⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨227, 512⟩, ⟨113, 171⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94460), (-94174)⟩, ⟨113, 171⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-44916), (-19902)⟩, ⟨(-14949), (-9869)⟩, ⟨(-1235), (-1207)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5068140, 5093155⟩, ⟨(-14949), (-9869)⟩, ⟨(-1235), (-1207)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1071063, 2421787⟩, ⟨528422, 805178⟩, ⟨63983, 65975⟩, ⟨(-394), (-254)⟩, ⟨(-17), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142094514), (-140743789)⟩, ⟨528422, 805178⟩, ⟨63983, 65975⟩, ⟨(-394), (-254)⟩, ⟨(-17), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-67565707), (-29743750)⟩, ⟨(-22410231), (-14489014)⟩, ⟨(-1807469), (-1699991)⟩, ⟨13551, 21041⟩, ⟨773, 844⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1364090058, 1401912016⟩, ⟨(-22410231), (-14489014)⟩, ⟨(-1807469), (-1699991)⟩, ⟨13551, 21041⟩, ⟨773, 844⟩⟩
...
def j72 : Jet := ⟨⟨2490, 5618⟩, ⟨1236, 1871⟩, ⟨151, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849687), (-846558)⟩, ⟨1236, 1871⟩, ⟨151, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-404025), (-178905)⟩, ⟨(-134414), (-88562)⟩, ⟨(-11062), (-10809)⟩, ⟨30, 50⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35387369, 35612490⟩, ⟨(-134414), (-88562)⟩, ⟨(-11062), (-10809)⟩, ⟨30, 50⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7478504, 16933681⟩, ⟨3675338, 5625845⟩, ⟨440841, 458739⟩, ⟨(-3524), (-2287)⟩, ⟨(-145), (-132)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708349379), (-698894201)⟩, ⟨3675338, 5625845⟩, ⟨440841, 458739⟩, ⟨(-3524), (-2287)⟩, ⟨(-145), (-132)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-336818958), (-147699126)⟩, ⟨(-111496269), (-71174482)⟩, ⟨(-8874560), (-8121371)⟩, ⟨93450, 146535⟩, ⟨5194, 5792⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3958148338, 4147268170⟩, ⟨(-111496269), (-71174482)⟩, ⟨(-8874560), (-8121371)⟩, ⟨93450, 146535⟩, ⟨5194, 5792⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨627084820, 966707890⟩, ⟨141317919, 154457250⟩, ⟨(-3821914), (-2446684)⟩, ⟨(-201499), (-180865)⟩, ⟨1912, 3001⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4447926518, 4660447891⟩, ⟨76334312, 131279203⟩, ⟨10020165, 14147164⟩, ⟨156776, 587838⟩, ⟨11164, 40643⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨649417564, 1048969978⟩, ⟨157495915, 197149024⟩, ⟨(-172514), 5371527⟩, ⟨17118, 410287⟩, ⟨(-9981), 24624⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-942723847), (-628482564)⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3352243449, 3666484732⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨98194734, 256192409⟩, ⟨47628122, 96300342⟩, ⟨5691087, 11673403⟩, ⟨(-10662), 693544⟩, ⟨(-3838), 56414⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4393162030, 4551159705⟩, ⟨47628122, 96300342⟩, ⟨5691087, 11673403⟩, ⟨(-10662), 693544⟩, ⟨(-3838), 56414⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4343787200, 4421208217⟩, ⟨23134086, 47609011⟩, ⟨2507958, 5709500⟩, ⟨(-67849), 329519⟩, ⟨(-9262), 27911⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3390347628, 3774252820⟩, ⟨(-143682582), (-118264210)⟩, ⟨215816, 4027727⟩, ⟨(-266789), 189554⟩, ⟨(-19962), 26310⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5187202126, 7780803200⟩, ⟨1296800531, 1296800541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6264789471, 14095776351⟩, ⟨3132394734, 4698592146⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6264789471, 14095776351⟩, ⟨3132394734, 4698592146⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14095776351), (-6264789471)⟩, ⟨(-4698592146), (-3132394734)⟩, ⟨(-391549348), (-391549341)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7047888176), (-3132394735)⟩, ⟨(-2349296073), (-1566197367)⟩, ⟨(-195774674), (-195774670)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨832334893, 2071196503⟩, ⟨(-1132919875), (-303518194)⟩, ⟨(-39069710), 271907081⟩, ⟨(-40353268), 41550985⟩, ⟨(-11879055), 6408635⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨657025871, 1820088188⟩, ⟨(-1064855815), (-262509010)⟩, ⟨(-25933609), 278784228⟩, ⟨(-45748292), 37896602⟩, ⟨(-11925161), 7319682⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨785603205, 785603206⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4376604418, 4376604421⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2358
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨628482564, 942723847⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4343787200, 4421208217⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2359
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (85935689 / 4294967296)

theorem envelope_integral : (∫ s in ((14633 / 100000) : ℝ)..(43899 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((14633 / 100000) : ℝ)..(43899 / 200000), prawitzNormalCorrection
