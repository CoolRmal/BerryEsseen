...
namespace FiniteNormalPanel2_26

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (24657 / 160000)
def radius : Rat := (8219 / 160000)

def j0 : Jet := ⟨⟨661881303, 661881304⟩, ⟨220627101, 220627102⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2079361438, 2079361443⟩, ⟨693120479, 693120483⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1006700096, 1006700101⟩, ⟨671133396, 671133404⟩, ⟨111855566, 111855568⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨251, 253⟩, ⟨167, 169⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94436), (-94433)⟩, ⟨167, 169⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-22135), (-22134)⟩, ⟨(-14718), (-14716)⟩, ⟨(-2428), (-2425)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5090921, 5090923⟩, ⟨(-14718), (-14716)⟩, ⟨(-2428), (-2425)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1193264, 1193265⟩, ⟨792059, 792061⟩, ⟨129714, 129718⟩, ⟨(-763), (-758)⟩, ⟨(-63), (-60)⟩⟩
...
def j16 : Jet := ⟨⟨(-141972313), (-141972311)⟩, ⟨792059, 792061⟩, ⟨129714, 129718⟩, ⟨(-763), (-758)⟩, ⟨(-63), (-60)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-33276981), (-33276979)⟩, ⟨(-21999003), (-21999001)⟩, ⟨(-3543273), (-3543269)⟩, ⟨40717, 40721⟩, ⟨3243, 3247⟩⟩
...
def j19 : Jet := ⟨⟨1398378784, 1398378787⟩, ⟨(-21999003), (-21999001)⟩, ⟨(-3543273), (-3543269)⟩, ⟨40717, 40721⟩, ⟨3243, 3247⟩⟩
...
def j22 : Jet := ⟨⟨(-26), (-25)⟩, ⟨(-17), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11809, 11811⟩, ⟨(-17), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2767, 2769⟩, ⟨1841, 1843⟩, ⟨303, 306⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849410), (-849407)⟩, ⟨1841, 1843⟩, ⟨303, 306⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-199094), (-199093)⟩, ⟨(-132299), (-132296)⟩, ⟨(-21764), (-21761)⟩, ⟨93, 96⟩, ⟨5, 8⟩⟩
...
def j30 : Jet := ⟨⟨35592300, 35592302⟩, ⟨(-132299), (-132296)⟩, ⟨(-21764), (-21761)⟩, ⟨93, 96⟩, ⟨5, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8342501, 8342503⟩, ⟨5530657, 5530661⟩, ⟨901168, 901173⟩, ⟨(-6826), (-6822)⟩, ⟨(-552), (-548)⟩⟩
...
def j33 : Jet := ⟨⟨(-707485382), (-707485379)⟩, ⟨5530657, 5530661⟩, ⟨901168, 901173⟩, ⟨(-6826), (-6822)⟩, ⟨(-552), (-548)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-165827947), (-165827944)⟩, ⟨(-109255631), (-109255626)⟩, ⟨(-17349881), (-17349876)⟩, ⟨283253, 283257⟩, ⟨22272, 22276⟩⟩
...
def j36 : Jet := ⟨⟨4129139349, 4129139352⟩, ⟨(-109255631), (-109255626)⟩, ⟨(-17349881), (-17349876)⟩, ⟨283253, 283257⟩, ⟨22272, 22276⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨677009792, 677009796⟩, ⟨215019353, 215019358⟩, ⟨(-5265630), (-5265625)⟩, ⟨(-552101), (-552096)⟩, ⟨8140, 8144⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4467454958, 4467454963⟩, ⟨118207341, 118207349⟩, ⟨21899141, 21899149⟩, ⟨769662, 769670⟩, ⟨80169, 80178⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨704198785, 704198791⟩, ⟨242287479, 242287488⟩, ⟨3892656, 3892665⟩, ⟨498461, 498473⟩, ⟨17588, 17602⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-661881304), (-661881303)⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3633085992, 3633085993⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨115459768, 115459771⟩, ⟨79450452, 79450458⟩, ⟨14944381, 14944387⟩, ⟨602638, 602646⟩, ⟨65532, 65543⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4410427064, 4410427067⟩, ⟨79450452, 79450458⟩, ⟨14944381, 14944387⟩, ⟨602638, 602646⟩, ⟨65532, 65543⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4352314327, 4352314329⟩, ⟨39201797, 39201801⟩, ⟨7197187, 7197192⟩, ⟨232522, 232528⟩, ⟨24288, 24296⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3681595487, 3681595490⟩, ⟨(-190412393), (-190412387)⟩, ⟨4074307, 4074313⟩, ⟨(-173023), (-173016)⟩, ⟨8600, 8608⟩⟩
...
def j47 : Jet := ⟨⟨2838798626, 2838798632⟩, ⟨946266208, 946266214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1876330384, 1876330393⟩, ⟨1250886922, 1250886934⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1876330384, 1876330393⟩, ⟨1250886922, 1250886934⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1876330393), (-1876330384)⟩, ⟨(-1250886934), (-1250886922)⟩, ⟨(-208481157), (-208481153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-938165197), (-938165192)⟩, ⟨(-625443467), (-625443461)⟩, ⟨(-104240579), (-104240576)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3452195253, 3452195259⟩, ⟨(-502716977), (-502716970)⟩, ⟨(-47182738), (-47182733)⟩, ⟨10424382, 10424384⟩, ⟨193065, 193067⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2959181196, 2959181205⟩, ⟨(-583972158), (-583972145)⟩, ⟨(-14882283), (-14882270)⟩, ⟨10411486, 10411497⟩, ⟨(-314256), (-314244)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨441254202, 882508406⟩, ⟨220627101, 220627102⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1386240959, 2772481926⟩, ⟨693120479, 693120483⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨447422265, 1789689072⟩, ⟨447422264, 894844538⟩, ⟨111855566, 111855568⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨111, 449⟩, ⟨111, 225⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94576), (-94237)⟩, ⟨111, 225⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-39410), (-9817)⟩, ⟨(-19694), (-9723)⟩, ⟨(-2451), (-2394)⟩, ⟨4, 13⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073646, 5103240⟩, ⟨(-19694), (-9723)⟩, ⟨(-2451), (-2394)⟩, ⟨4, 13⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨528540, 2126492⟩, ⟨520333, 1062234⟩, ⟨127009, 131645⟩, ⟨(-1024), (-496)⟩, ⟨(-64), (-58)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142637037), (-141039084)⟩, ⟨520333, 1062234⟩, ⟨127009, 131645⟩, ⟨(-1024), (-496)⟩, ⟨(-64), (-58)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-59436063), (-14692551)⟩, ⟨(-29663828), (-14249923)⟩, ⟨(-3647320), (-3396967)⟩, ⟨26354, 55042⟩, ⟨3066, 3372⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1372219702, 1416963215⟩, ⟨(-29663828), (-14249923)⟩, ⟨(-3647320), (-3396967)⟩, ⟨26354, 55042⟩, ⟨3066, 3372⟩⟩
...
def j72 : Jet := ⟨⟨1228, 4928⟩, ⟨1218, 2463⟩, ⟨300, 307⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850949), (-847248)⟩, ⟨1218, 2463⟩, ⟨300, 307⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-354586), (-88260)⟩, ⟨(-177167), (-87233)⟩, ⟨(-22005), (-21423)⟩, ⟨61, 129⟩, ⟨5, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35436808, 35703135⟩, ⟨(-177167), (-87233)⟩, ⟨(-22005), (-21423)⟩, ⟨61, 129⟩, ⟨5, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3691580, 14877299⟩, ⟨3617755, 7429563⟩, ⟨876812, 918514⟩, ⟨(-9194), (-4448)⟩, ⟨(-568), (-526)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712136303), (-700950583)⟩, ⟨3617755, 7429563⟩, ⟨876812, 918514⟩, ⟨(-9194), (-4448)⟩, ⟨(-568), (-526)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-296743252), (-73020555)⟩, ⟨(-147994752), (-69924697)⟩, ⟨(-18078240), (-16324469)⟩, ⟨181726, 384399⟩, ⟨20682, 23405⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3998224044, 4221946741⟩, ⟨(-147994752), (-69924697)⟩, ⟨(-18078240), (-16324469)⟩, ⟨181726, 384399⟩, ⟨20682, 23405⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨442896773, 914676326⟩, ⟨202299828, 224069786⟩, ⟨(-7141554), (-3396050)⟩, ⟨(-580098), (-512670)⟩, ⟨5242, 11060⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4369250775, 4613734466⟩, ⟨72364374, 170777946⟩, ⟨18092542, 27182680⟩, ⟨159382, 1579766⟩, ⟨31466, 155497⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨450556880, 982562474⟩, ⟨213260907, 277069640⟩, ⟨(-2397414), 11243704⟩, ⟨(-38496), 1175810⟩, ⟨(-52183), 104472⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-882508406), (-441254202)⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3412458890, 3853713094⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨47264970, 224781460⟩, ⟨44743608, 126770806⟩, ⟨9492271, 23018307⟩, ⟨(-326930), 1988652⟩, ⟨(-35121), 228941⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4342232266, 4519748756⟩, ⟨44743608, 126770806⟩, ⟨9492271, 23018307⟩, ⟨(-326930), 1988652⟩, ⟨(-35121), 228941⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4318535119, 4405924772⟩, ⟨21808399, 63039486⟩, ⟨4175629, 11391279⟩, ⟨(-328857), 967814⟩, ⟨(-46618), 116629⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3431184114, 3953271077⟩, ⟨(-208999531), (-165274783)⟩, ⟨79381, 9100698⟩, ⟨(-880228), 653888⟩, ⟨(-91545), 121540⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1892532417, 3785064845⟩, ⟨946266208, 946266214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨833924615, 3335698480⟩, ⟨833924614, 1667849246⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨833924615, 3335698480⟩, ⟨833924614, 1667849246⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3335698480), (-833924615)⟩, ⟨(-1667849246), (-833924614)⟩, ⟨(-208481157), (-208481153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1667849240), (-416962307)⟩, ⟨(-833924623), (-416962307)⟩, ⟨(-104240579), (-104240576)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2912807895, 3897605300⟩, ⟨(-756771544), (-282780057)⟩, ⟨(-80870074), 2773582⟩, ⟨4395947, 17478764⟩, ⟨(-882092), 874684⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2326997969, 3587522149⟩, ⟨(-886228108), (-337996549)⟩, ⟨(-63500762), 47637279⟩, ⟨974556, 20611625⟩, ⟨(-2032108), 907207⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨661881303, 661881304⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4352314327, 4352314329⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified42
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨441254202, 882508406⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4318535119, 4405924772⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified43
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (303527865 / 4294967296)

theorem envelope_integral : (∫ s in ((8219 / 80000) : ℝ)..(8219 / 40000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((8219 / 80000) : ℝ)..(8219 / 40000), prawitzNormalCorrection
