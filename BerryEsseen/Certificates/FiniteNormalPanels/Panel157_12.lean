...
namespace FiniteNormalPanel157_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (9531 / 100000)
def radius : Rat := (3177 / 100000)

def j0 : Jet := ⟨⟨409353332, 409353333⟩, ⟨136451110, 136451111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1286021420, 1286021424⟩, ⟨428673804, 428673808⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨385067214, 385067217⟩, ⟨256711474, 256711478⟩, ⟨42785245, 42785247⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-8481), (-8480)⟩, ⟨(-5649), (-5647)⟩, ⟨(-940), (-937)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104575, 5104577⟩, ⟨(-5649), (-5647)⟩, ⟨(-940), (-937)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨457652, 457654⟩, ⟨304594, 304597⟩, ⟨50427, 50430⟩, ⟨(-114), (-111)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142707925), (-142707922)⟩, ⟨304594, 304597⟩, ⟨50427, 50430⟩, ⟨(-114), (-111)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12794543), (-12794542)⟩, ⟨(-8502388), (-8502385)⟩, ⟨(-1398890), (-1398887)⟩, ⟨6037, 6041⟩, ⟨494, 497⟩⟩
...
def j19 : Jet := ⟨⟨1418861222, 1418861224⟩, ⟨(-8502388), (-8502385)⟩, ⟨(-1398890), (-1398887)⟩, ⟨6037, 6041⟩, ⟨494, 497⟩⟩
...
def j25 : Jet := ⟨⟨1060, 1061⟩, ⟨705, 707⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851117), (-851115)⟩, ⟨705, 707⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-76308), (-76307)⟩, ⟨(-50809), (-50807)⟩, ⟨(-8427), (-8424)⟩, ⟨12, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35715086, 35715088⟩, ⟨(-50809), (-50807)⟩, ⟨(-8427), (-8424)⟩, ⟨12, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3202052, 3202053⟩, ⟨2130145, 2130147⟩, ⟨351990, 351993⟩, ⟨(-1010), (-1007)⟩, ⟨(-85), (-81)⟩⟩
...
def j33 : Jet := ⟨⟨(-712625831), (-712625829)⟩, ⟨2130145, 2130147⟩, ⟨351990, 351993⟩, ⟨(-1010), (-1007)⟩, ⟨(-85), (-81)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-63890789), (-63890787)⟩, ⟨(-42402880), (-42402877)⟩, ⟨(-6940101), (-6940097)⟩, ⟨42166, 42169⟩, ⟨3437, 3440⟩⟩
...
def j36 : Jet := ⟨⟨4231076507, 4231076509⟩, ⟨(-42402880), (-42402877)⟩, ⟨(-6940101), (-6940097)⟩, ⟨42166, 42169⟩, ⟨3437, 3440⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨424842798, 424842800⟩, ⟨139068435, 139068439⟩, ⟨(-1267473), (-1267471)⟩, ⟨(-137814), (-137811)⟩, ⟨749, 752⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4359822857, 4359822860⟩, ⟨43693142, 43693147⟩, ⟨7589156, 7589164⟩, ⟨104272, 104279⟩, ⟨9512, 9520⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨431258078, 431258081⟩, ⟨145490387, 145490393⟩, ⟨878836, 878841⟩, ⟨103255, 103263⟩, ⟨1434, 1443⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-409353333), (-409353332)⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3885613963, 3885613964⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨43302664, 43302666⟩, ⟨29217406, 29217410⟩, ⟨5104919, 5104923⟩, ⟨80274, 80280⟩, ⟨7459, 7466⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4338269960, 4338269962⟩, ⟨29217406, 29217410⟩, ⟨5104919, 5104923⟩, ⟨80274, 80280⟩, ⟨7459, 7466⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316564328, 4316564330⟩, ⟨14535611, 14535614⟩, ⟨2515214, 2515218⟩, ⟨31465, 31470⟩, ⟨2871, 2877⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3905152581, 3905152585⟩, ⟨(-123987028), (-123987022)⟩, ⟨1813691, 1813697⟩, ⟨(-51443), (-51437)⟩, ⟨1597, 1604⟩⟩
...
def j47 : Jet := ⟨⟨4747969944, 4747969957⟩, ⟨1582656640, 1582656653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5248752094, 5248752123⟩, ⟨3499168044, 3499168084⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5248752094, 5248752123⟩, ⟨3499168044, 3499168084⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5248752123), (-5248752094)⟩, ⟨(-3499168084), (-3499168044)⟩, ⟨(-583194681), (-583194671)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2624376062), (-2624376047)⟩, ⟨(-1749584042), (-1749584022)⟩, ⟨(-291597341), (-291597335)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2331259714, 2331259734⟩, ⟨(-949654456), (-949654436)⟩, ⟨35148340, 35148353⟩, ⟨38210489, 38210494⟩, ⟨(-5084486), (-5084484)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2119672691, 2119672713⟩, ⟨(-930761808), (-930761783)⟩, ⟨60357301, 60357322⟩, ⟨33298864, 33298877⟩, ⟨(-5698993), (-5698982)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨272902221, 545804444⟩, ⟨136451110, 136451111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨857347612, 1714695232⟩, ⟨428673804, 428673808⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨171140983, 684563942⟩, ⟨171140982, 342281972⟩, ⟨42785245, 42785247⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-15086), (-3766)⟩, ⟨(-7542), (-3752)⟩, ⟨(-942), (-932)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097970, 5109291⟩, ⟨(-7542), (-3752)⟩, ⟨(-942), (-932)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨203138, 814357⟩, ⟨201935, 407030⟩, ⟨50031, 50712⟩, ⟨(-152), (-73)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142962439), (-142351219)⟩, ⟨201935, 407030⟩, ⟨50031, 50712⟩, ⟨(-152), (-73)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-22786421), (-5672249)⟩, ⟨(-11385165), (-5607373)⟩, ⟨(-1414113), (-1377541)⟩, ⟨3979, 8095⟩, ⟨483, 504⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408869344, 1425983517⟩, ⟨(-11385165), (-5607373)⟩, ⟨(-1414113), (-1377541)⟩, ⟨3979, 8095⟩, ⟨483, 504⟩⟩
...
def j72 : Jet := ⟨⟨470, 1886⟩, ⟨468, 943⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851707), (-850290)⟩, ⟨468, 943⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-135752), (-33881)⟩, ⟨(-67858), (-33730)⟩, ⟨(-8463), (-8375)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35655642, 35757514⟩, ⟨(-67858), (-33730)⟩, ⟨(-8463), (-8375)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1420765, 5699300⟩, ⟨1409949, 2848306⟩, ⟨348434, 354530⟩, ⟨(-1351), (-665)⟩, ⟨(-86), (-80)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714407118), (-710128582)⟩, ⟨1409949, 2848306⟩, ⟨348434, 354530⟩, ⟨(-1351), (-665)⟩, ⟨(-86), (-80)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-113867539), (-28296397)⟩, ⟨(-56877588), (-27842412)⟩, ⟨(-7046656), (-6790598)⟩, ⟨27713, 56603⟩, ⟨3349, 3503⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4181099757, 4266670899⟩, ⟨(-56877588), (-27842412)⟩, ⟨(-7046656), (-6790598)⟩, ⟨27713, 56603⟩, ⟨3349, 3503⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨281233984, 569300526⟩, ⟨136071650, 141205807⟩, ⟨(-1700898), (-834642)⟩, ⟨(-140347), (-134258)⟩, ⟨493, 1010⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4323451353, 4411935890⟩, ⟨28212935, 60017769⟩, ⟨7065070, 8252151⟩, ⟨32473, 184755⟩, ⟨7036, 12773⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨283099116, 584804785⟩, ⟨138821450, 153006781⟩, ⟨(-390769), 2226858⟩, ⟨58020, 155167⟩, ⟨(-3247), 6554⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-545804444), (-272902221)⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3749162852, 4022065075⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨18660237, 79627298⟩, ⟨18300594, 41666952⟩, ⟨4380555, 6057238⟩, ⟨(-20196), 200920⟩, ⟨2661, 13997⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4313627533, 4374594594⟩, ⟨18300594, 41666952⟩, ⟨4380555, 6057238⟩, ⟨(-20196), 200920⟩, ⟨2661, 13997⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304287302, 4334598103⟩, ⟨9066636, 20788366⟩, ⟨2120401, 3012513⟩, ⟨(-24627), 95777⟩, ⟨(-190), 6582⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3757298471, 4059177741⟩, ⟨(-129795735), (-117279732)⟩, ⟨1190493, 2533051⟩, ⟨(-118771), 22327⟩, ⟨(-3221), 6947⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3165313292, 6330626610⟩, ⟨1582656640, 1582656653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2332778702, 9331114888⟩, ⟨2332778692, 4665557446⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2332778702, 9331114888⟩, ⟨2332778692, 4665557446⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9331114888), (-2332778702)⟩, ⟨(-4665557446), (-2332778692)⟩, ⟨(-583194681), (-583194671)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4665557444), (-1166389351)⟩, ⟨(-2332778723), (-1166389346)⟩, ⟨(-291597341), (-291597335)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1449413796, 3273542587⟩, ⟨(-1777999685), (-393619018)⟩, ⟨(-168802170), 384448729⟩, ⟨(-51787535), 111036785⟩, ⟨(-28127846), 12762227⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1267967801, 3093828262⟩, ⟨(-1779317068), (-383921664)⟩, ⟨(-148385056), 419005416⟩, ⟨(-61701795), 109950161⟩, ⟨(-30050487), 13907837⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨409353332, 409353333⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316564328, 4316564330⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3176
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨272902221, 545804444⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304287302, 4334598103⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3177
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (68069557 / 2147483648)

theorem envelope_integral : (∫ s in ((3177 / 50000) : ℝ)..(3177 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((3177 / 50000) : ℝ)..(3177 / 25000), prawitzNormalCorrection
