...
namespace FiniteNormalPanel81_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (45829 / 160000)
def radius : Rat := (6547 / 160000)

def j0 : Jet := ⟨⟨1230212851, 1230212852⟩, ⟨175744693, 175744694⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3864827654, 3864827659⟩, ⟨552118236, 552118240⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3477766363, 3477766373⟩, ⟨993647530, 993647542⟩, ⟨70974823, 70974825⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨870, 872⟩, ⟨248, 249⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93817), (-93814)⟩, ⟨248, 249⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-75967), (-75964)⟩, ⟨(-21505), (-21502)⟩, ⟨(-1481), (-1477)⟩, ⟨7, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5037089, 5037093⟩, ⟨(-21505), (-21502)⟩, ⟨(-1481), (-1477)⟩, ⟨7, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4078685, 4078689⟩, ⟨1147924, 1147930⟩, ⟨77062, 77070⟩, ⟨(-694), (-687)⟩, ⟨(-24), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-139086892), (-139086887)⟩, ⟨1147924, 1147930⟩, ⟨77062, 77070⟩, ⟨(-694), (-687)⟩, ⟨(-24), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-112622911), (-112622905)⟩, ⟨(-31248466), (-31248458)⟩, ⟨(-1970454), (-1970444)⟩, ⟨36235, 36245⟩, ⟨1092, 1100⟩⟩
...
def j19 : Jet := ⟨⟨1319032854, 1319032861⟩, ⟨(-31248466), (-31248458)⟩, ⟨(-1970454), (-1970444)⟩, ⟨36235, 36245⟩, ⟨1092, 1100⟩⟩
...
def j22 : Jet := ⟨⟨(-88), (-86)⟩, ⟨(-25), (-24)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11747, 11750⟩, ⟨(-25), (-24)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9511, 9515⟩, ⟨2696, 2700⟩, ⟨186, 190⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842666), (-842661)⟩, ⟨2696, 2700⟩, ⟨186, 190⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-682333), (-682328)⟩, ⟨(-192770), (-192763)⟩, ⟨(-13153), (-13146)⟩, ⟨85, 89⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35109061, 35109067⟩, ⟨(-192770), (-192763)⟩, ⟨(-13153), (-13146)⟩, ⟨85, 89⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨28428880, 28428886⟩, ⟨7966445, 7966453⟩, ⟨524932, 524942⟩, ⟨(-6161), (-6153)⟩, ⟨(-199), (-192)⟩⟩
...
def j33 : Jet := ⟨⟨(-687399003), (-687398996)⟩, ⟨7966445, 7966453⟩, ⟨524932, 524942⟩, ⟨(-6161), (-6153)⟩, ⟨(-199), (-192)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-556607996), (-556607988)⟩, ⟨(-152580183), (-152580172)⟩, ⟨(-9091246), (-9091232)⟩, ⟨248100, 248112⟩, ⟨7086, 7097⟩⟩
...
def j36 : Jet := ⟨⟨3738359300, 3738359308⟩, ⟨(-152580183), (-152580172)⟩, ⟨(-9091246), (-9091232)⟩, ⟨248100, 248112⟩, ⟨7086, 7097⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1186932122, 1186932131⟩, ⟨141442789, 141442800⟩, ⟨(-5790106), (-5790094)⟩, ⟨(-220696), (-220684)⟩, ⟨5640, 5650⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4934449193, 4934449205⟩, ⟨201398271, 201398289⟩, ⟨20219992, 20220017⟩, ⟨987553, 987575⟩, ⟨66743, 66764⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1363655610, 1363655625⟩, ⟨218159596, 218159616⟩, ⟨5568169, 5568194⟩, ⟨413739, 413764⟩, ⟨19837, 19861⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1230212852), (-1230212851)⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3064754444, 3064754445⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨432961765, 432961775⟩, ⟨138531698, 138531714⟩, ⟨14617046, 14617067⟩, ⟨828384, 828408⟩, ⟨61844, 61865⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4727929061, 4727929071⟩, ⟨138531698, 138531714⟩, ⟨14617046, 14617067⟩, ⟨828384, 828408⟩, ⟨61844, 61865⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4506251290, 4506251296⟩, ⟨66018190, 66018199⟩, ⟨6482253, 6482265⟩, ⟨299803, 299817⟩, ⟨20416, 20429⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3215520099, 3215520105⟩, ⟨(-137281655), (-137281645)⟩, ⟨1924150, 1924161⟩, ⟨(-51317), (-51304)⟩, ⟨2299, 2311⟩⟩
...
def j47 : Jet := ⟨⟨8264668480, 8264668489⟩, ⟨1180666925, 1180666933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15903437762, 15903437798⟩, ⟨4543839356, 4543839394⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15903437762, 15903437798⟩, ⟨4543839356, 4543839394⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15903437798), (-15903437762)⟩, ⟨(-4543839394), (-4543839356)⟩, ⟨(-324559959), (-324559953)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7951718899), (-7951718881)⟩, ⟨(-2271919697), (-2271919678)⟩, ⟨(-162279980), (-162279976)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨674381100, 674381111⟩, ⟨(-356729080), (-356729070)⟩, ⟨68869288, 68869294⟩, ⟨(-3157614), (-3157611)⟩, ⟨(-883498), (-883497)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨504889986, 504889996⟩, ⟨(-288628435), (-288628423)⟩, ⟨63264868, 63264878⟩, ⟨(-4733186), (-4733177)⟩, ⟨(-525049), (-525040)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1054468158, 1405957545⟩, ⟨175744693, 175744694⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3312709418, 4416945895⟩, ⟨552118236, 552118240⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2555093655, 4542388730⟩, ⟨851697884, 1135597190⟩, ⟨70974823, 70974825⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨639, 1138⟩, ⟨213, 285⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94048), (-93548)⟩, ⟨213, 285⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-99466), (-55652)⟩, ⟨(-24741), (-18248)⟩, ⟨(-1503), (-1449)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5013590, 5057405⟩, ⟨(-24741), (-18248)⟩, ⟨(-1503), (-1449)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2982605, 5348749⟩, ⟨968034, 1326333⟩, ⟨74718, 79095⟩, ⟨(-804), (-577)⟩, ⟨(-24), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140182972), (-137816827)⟩, ⟨968034, 1326333⟩, ⟨74718, 79095⟩, ⟨(-804), (-577)⟩, ⟨(-24), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-148258534), (-81987795)⟩, ⟨(-36488747), (-25926525)⟩, ⟨(-2080128), (-1843101)⟩, ⟨29961, 42488⟩, ⟨995, 1184⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1283397231, 1349667971⟩, ⟨(-36488747), (-25926525)⟩, ⟨(-2080128), (-1843101)⟩, ⟨29961, 42488⟩, ⟨995, 1184⟩⟩
...
def j70 : Jet := ⟨⟨(-115), (-63)⟩, ⟨(-29), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11720, 11773⟩, ⟨(-29), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6972, 12452⟩, ⟨2293, 3101⟩, ⟨182, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845205), (-839724)⟩, ⟨2293, 3101⟩, ⟨182, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-893895), (-499555)⟩, ⟨(-222110), (-163238)⟩, ⟨(-13406), (-12853)⟩, ⟨70, 103⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34897499, 35291840⟩, ⟨(-222110), (-163238)⟩, ⟨(-13406), (-12853)⟩, ⟨70, 103⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨20760665, 37324908⟩, ⟨6685315, 9234117⟩, ⟨503779, 543186⟩, ⟨(-7175), (-5136)⟩, ⟨(-209), (-179)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-695067218), (-678502974)⟩, ⟨6685315, 9234117⟩, ⟨503779, 543186⟩, ⟨(-7175), (-5136)⟩, ⟨(-209), (-179)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-735108159), (-403644201)⟩, ⟨(-179799920), (-124781996)⟩, ⟨(-9860659), (-8196342)⟩, ⟨202786, 293160⟩, ⟨6205, 7853⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3559859137, 3891323095⟩, ⟨(-179799920), (-124781996)⟩, ⟨(-9860659), (-8196342)⟩, ⟨202786, 293160⟩, ⟨6205, 7853⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨989884625, 1387999022⟩, ⟨127455729, 153502744⟩, ⟨(-6829836), (-4754439)⟩, ⟨(-244293), (-193235)⟩, ⟨4618, 6680⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4740481225, 5181874722⟩, ⟨152011717, 261724026⟩, ⟨14859451, 27572626⟩, ⟨406290, 1847554⟩, ⟨14149, 152771⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1092564659, 1674619747⟩, ⟨175711593, 269781957⟩, ⟨(-304415), 13017052⟩, ⟨(-176331), 1200970⟩, ⟨(-38320), 100175⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1405957545), (-1054468158)⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2889009751, 3240499138⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨277929365, 652938918⟩, ⟨89395920, 210377478⟩, ⟨6951158, 27096721⟩, ⟨(-175748), 2571818⟩, ⟨(-52959), 268446⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4572896661, 4947906214⟩, ⟨89395920, 210377478⟩, ⟨6951158, 27096721⟩, ⟨(-175748), 2571818⟩, ⟨(-52959), 268446⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4431753784, 4609891037⟩, ⟨41644428, 101942079⟩, ⟨2110983, 12934527⟩, ⟨(-382692), 1226384⟩, ⟨(-72749), 138382⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2981019182, 3478105165⟩, ⟨(-160618856), (-104427800)⟩, ⟨(-2751391), 8054902⟩, ⟨(-818002), 838914⟩, ⟨(-105072), 120068⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7084001554, 9445335415⟩, ⟨1180666925, 1180666933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11684158355, 20771837119⟩, ⟨3894719448, 5192959308⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11684158355, 20771837119⟩, ⟨3894719448, 5192959308⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20771837119), (-11684158355)⟩, ⟨(-5192959308), (-3894719448)⟩, ⟨(-324559959), (-324559953)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10385918560), (-5842079177)⟩, ⟨(-2596479654), (-1947359724)⟩, ⟨(-162279980), (-162279976)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨382618769, 1102112607⟩, ⟨(-666271188), (-173481269)⟩, ⟨(-2313312), 186937030⟩, ⟨(-33300458), 17248981⟩, ⟨(-6138517), 5076568⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨265565209, 892501220⟩, ⟨(-580768410), (-129711587)⟩, ⟨1638657, 178366849⟩, ⟨(-35417358), 14696990⟩, ⟨(-5892947), 5864684⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1230212851, 1230212852⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4506251290, 4506251296⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1636
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1054468158, 1405957545⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4431753784, 4609891037⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1637
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (43140739 / 4294967296)

theorem envelope_integral : (∫ s in ((19641 / 80000) : ℝ)..(6547 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((19641 / 80000) : ℝ)..(6547 / 20000), prawitzNormalCorrection
