...
namespace FiniteNormalPanel161_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (90251 / 400000)
def radius : Rat := (12893 / 400000)

def j0 : Jet := ⟨⟨969062733, 969062734⟩, ⟨138437533, 138437534⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3044400362, 3044400367⟩, ⟨434914336, 434914340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2157961382, 2157961390⟩, ⟨616560392, 616560400⟩, ⟨44040027, 44040029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨540, 541⟩, ⟨154, 155⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94147), (-94145)⟩, ⟨154, 155⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-47304), (-47302)⟩, ⟨(-13439), (-13436)⟩, ⟨(-939), (-935)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5065752, 5065755⟩, ⟨(-13439), (-13436)⟩, ⟨(-939), (-935)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2545234, 2545236⟩, ⟨720456, 720461⟩, ⟨49541, 49547⟩, ⟨(-272), (-268)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140620343), (-140620340)⟩, ⟨720456, 720461⟩, ⟨49541, 49547⟩, ⟨(-272), (-268)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-70653221), (-70653218)⟩, ⟨(-19824650), (-19824644)⟩, ⟨(-1313588), (-1313581)⟩, ⟨14361, 14367⟩, ⟨461, 468⟩⟩
...
def j19 : Jet := ⟨⟨1361002544, 1361002548⟩, ⟨(-19824650), (-19824644)⟩, ⟨(-1313588), (-1313581)⟩, ⟨14361, 14367⟩, ⟨461, 468⟩⟩
...
def j22 : Jet := ⟨⟨(-55), (-53)⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11780, 11783⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5918, 5921⟩, ⟨1682, 1685⟩, ⟨115, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846259), (-846255)⟩, ⟨1682, 1685⟩, ⟨115, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-425194), (-425191)⟩, ⟨(-120639), (-120636)⟩, ⟨(-8380), (-8375)⟩, ⟨31, 36⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35366200, 35366204⟩, ⟨(-120639), (-120636)⟩, ⟨(-8380), (-8375)⟩, ⟨31, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17769377, 17769380⟩, ⟨5016350, 5016354⟩, ⟨341110, 341117⟩, ⟨(-2426), (-2419)⟩, ⟨(-83), (-77)⟩⟩
...
def j33 : Jet := ⟨⟨(-698058506), (-698058502)⟩, ⟨5016350, 5016354⟩, ⟨341110, 341117⟩, ⟨(-2426), (-2419)⟩, ⟨(-83), (-77)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-350732195), (-350732190)⟩, ⟨(-97688787), (-97688781)⟩, ⟨(-6266296), (-6266289)⟩, ⟨99184, 99192⟩, ⟨3106, 3113⟩⟩
...
def j36 : Jet := ⟨⟨3944235101, 3944235106⟩, ⟨(-97688787), (-97688781)⟩, ⟨(-6266296), (-6266289)⟩, ⟨99184, 99192⟩, ⟨3106, 3113⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨964719019, 964719024⟩, ⟨123764701, 123764708⟩, ⟨(-2938583), (-2938575)⟩, ⟨(-122837), (-122831)⟩, ⟨1780, 1787⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4676887553, 4676887560⟩, ⟨115834738, 115834747⟩, ⟨10299203, 10299215⟩, ⟨321495, 321510⟩, ⟨17718, 17733⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1050504476, 1050504484⟩, ⟨160788549, 160788562⟩, ⟨2451395, 2451410⟩, ⟨155981, 155996⟩, ⟨4821, 4837⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-969062734), (-969062733)⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3325904562, 3325904563⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨256942504, 256942509⟩, ⟨78654424, 78654432⟩, ⟨7218530, 7218542⟩, ⟨259844, 259858⟩, ⟨15435, 15448⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4551909800, 4551909805⟩, ⟨78654424, 78654432⟩, ⟨7218530, 7218542⟩, ⟨259844, 259858⟩, ⟨15435, 15448⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4421572539, 4421572543⟩, ⟨38201134, 38201139⟩, ⟨3340894, 3340902⟩, ⟨97336, 97345⟩, ⟨5393, 5401⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3423944180, 3423944185⟩, ⟨(-112936431), (-112936424)⟩, ⟨1355777, 1355785⟩, ⟨(-32312), (-32303)⟩, ⟨1038, 1046⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨44542628270, 44542628278⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value653

def j47 : Jet := ⟨⟨10050041853, 10050041867⟩, ⟨1435720261, 1435720273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨23516672953, 23516673020⟩, ⟨6719049396, 6719049464⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨23516672953, 23516673020⟩, ⟨6719049396, 6719049464⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-23516673020), (-23516672953)⟩, ⟨(-6719049464), (-6719049396)⟩, ⟨(-479932107), (-479932098)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11758336510), (-11758336476)⟩, ⟨(-3359524732), (-3359524698)⟩, ⟨(-239966054), (-239966049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨277965819, 277965828⟩, ⟨(-217424956), (-217424946)⟩, ⟨69504574, 69504581⟩, ⟨(-10023604), (-10023600)⟩, ⟨18454, 18457⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨221594108, 221594116⟩, ⟨(-180640115), (-180640104)⟩, ⟨61213931, 61213940⟩, ⟨(-9889164), (-9889154)⟩, ⟨301924, 301931⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨830625200, 1107500267⟩, ⟨138437533, 138437534⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2609486026, 3479314703⟩, ⟨434914336, 434914340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1585441017, 2818561812⟩, ⟨528480336, 704640458⟩, ⟨44040027, 44040029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨396, 707⟩, ⟨132, 177⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94291), (-93979)⟩, ⟨132, 177⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-61879), (-34691)⟩, ⟨(-15422), (-11446)⟩, ⟨(-947), (-925)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5051177, 5078366⟩, ⟨(-15422), (-11446)⟩, ⟨(-947), (-925)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1864587, 3332666⟩, ⟨611408, 828942⟩, ⟨48641, 50324⟩, ⟨(-315), (-227)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141300990), (-139832910)⟩, ⟨611408, 828942⟩, ⟨48641, 50324⟩, ⟨(-315), (-227)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-92728431), (-51617815)⟩, ⟨(-22956414), (-16661946)⟩, ⟨(-1355696), (-1264804)⟩, ⟨12047, 16674⟩, ⟨439, 488⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1338927334, 1380037951⟩, ⟨(-22956414), (-16661946)⟩, ⟨(-1355696), (-1264804)⟩, ⟨12047, 16674⟩, ⟨439, 488⟩⟩
...
def j70 : Jet := ⟨⟨(-71), (-39)⟩, ⟨(-18), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11764, 11797⟩, ⟨(-18), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4342, 7742⟩, ⟨1435, 1932⟩, ⟨115, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847835), (-844434)⟩, ⟨1435, 1932⟩, ⟨115, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-556390), (-311713)⟩, ⟨(-138569), (-102636)⟩, ⟨(-8476), (-8262)⟩, ⟨26, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35235004, 35479682⟩, ⟨(-138569), (-102636)⟩, ⟨(-8476), (-8262)⟩, ⟨26, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13006623, 23283455⟩, ⟨4244604, 5782978⟩, ⟨332998, 348127⟩, ⟨(-2803), (-2041)⟩, ⟨(-85), (-75)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702821260), (-692544427)⟩, ⟨4244604, 5782978⟩, ⟨332998, 348127⟩, ⟨(-2803), (-2041)⟩, ⟨(-85), (-75)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-461224738), (-255645332)⟩, ⟨(-113739337), (-81420044)⟩, ⟨(-6561432), (-5924034)⟩, ⟨82657, 115660⟩, ⟨2898, 3292⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3833742558, 4039321964⟩, ⟨(-113739337), (-81420044)⟩, ⟨(-6561432), (-5924034)⟩, ⟨82657, 115660⟩, ⟨2898, 3292⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨813489818, 1117956437⟩, ⟨116984848, 129621286⟩, ⟨(-3422837), (-2455665)⟩, ⟨(-129961), (-114567)⟩, ⟨1485, 2085⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4566792208, 4811680439⟩, ⟨92052186, 142752765⟩, ⟨8553099, 12470353⟩, ⟨169629, 515830⟩, ⟨7951, 31212⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨864974912, 1252454035⟩, ⟨141823898, 182373352⟩, ⟨292659, 4943135⟩, ⟨5731, 336173⟩, ⟨(-6556), 18684⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1107500267), (-830625200)⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3187467029, 3464342096⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨174199603, 365227720⟩, ⟨57124584, 106363670⟩, ⟨4801037, 10626891⟩, ⟨21634, 615856⟩, ⟨(-3427), 45138⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4469166899, 4660195016⟩, ⟨57124584, 106363670⟩, ⟨4801037, 10626891⟩, ⟨21634, 615856⟩, ⟨(-3427), 45138⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4381201395, 4473855741⟩, ⟨27420220, 52135071⟩, ⟨2000760, 5123057⟩, ⟨(-50359), 289346⟩, ⟨(-8119), 22268⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3251464803, 3608634411⟩, ⟨(-123853914), (-99164664)⟩, ⟨(-195600), 3248462⟩, ⟨(-205749), 168899⟩, ⟨(-15876), 19586⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8614321592, 11485762129⟩, ⟨1435720261, 1435720273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17277555654, 30715654531⟩, ⟨5759185200, 7678913670⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17277555654, 30715654531⟩, ⟨5759185200, 7678913670⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-30715654531), (-17277555654)⟩, ⟨(-7678913670), (-5759185200)⟩, ⟨(-479932107), (-479932098)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15357827266), (-8638777827)⟩, ⟨(-3839456835), (-2879592600)⟩, ⟨(-239966054), (-239966049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨120232384, 574687849⟩, ⟨(-513738299), (-80610691)⟩, ⟨(-5085627), 222908874⟩, ⟨(-63420068), 20650957⟩, ⟨(-10842317), 14315556⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨91020801, 482853118⟩, ⟨(-448215531), (-63801563)⟩, ⟨(-2437936), 202537512⟩, ⟨(-60129698), 17543600⟩, ⟨(-9737715), 14052612⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨969062733, 969062734⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨138437533, 138437534⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4421572539, 4421572543⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar653 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3260
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar653 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨830625200, 1107500267⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4381201395, 4473855741⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3261
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((38679 / 200000) : ℝ)..(12893 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (38679 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (12893 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((38679 / 200000) : ℝ)..(12893 / 50000), prawitzNormalCorrection
      ((251531 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
