...
namespace FiniteNormalPanel108_13
...
def j2 : Jet := ⟨⟨505381726, 505381731⟩, ⟨505381726, 505381731⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨59467435, 59467437⟩, ⟨118934870, 118934874⟩, ⟨59467435, 59467437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1311), (-1310)⟩, ⟨(-2622), (-2620)⟩, ⟨(-1311), (-1308)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111745, 5111747⟩, ⟨(-2622), (-2620)⟩, ⟨(-1311), (-1308)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨70776, 70777⟩, ⟨141515, 141517⟩, ⟨70684, 70687⟩, ⟨(-74), (-71)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-143094801), (-143094799)⟩, ⟨141515, 141517⟩, ⟨70684, 70687⟩, ⟨(-74), (-71)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1981268), (-1981267)⟩, ⟨(-3960577), (-3960575)⟩, ⟨(-1976372), (-1976369)⟩, ⟨3914, 3918⟩, ⟨974, 978⟩⟩
...
def j19 : Jet := ⟨⟨1429674497, 1429674499⟩, ⟨(-3960577), (-3960575)⟩, ⟨(-1976372), (-1976369)⟩, ⟨3914, 3918⟩, ⟨974, 978⟩⟩
...
def j25 : Jet := ⟨⟨163, 164⟩, ⟨326, 328⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852014), (-852012)⟩, ⟨326, 328⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11797), (-11796)⟩, ⟨(-23590), (-23588)⟩, ⟨(-11786), (-11783)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779597, 35779599⟩, ⟨(-23590), (-23588)⟩, ⟨(-11786), (-11783)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨495398, 495399⟩, ⟨990470, 990472⟩, ⟨494580, 494583⟩, ⟨(-654), (-651)⟩, ⟨(-164), (-161)⟩⟩
...
def j33 : Jet := ⟨⟨(-715332485), (-715332483)⟩, ⟨990470, 990472⟩, ⟨494580, 494583⟩, ⟨(-654), (-651)⟩, ⟨(-164), (-161)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9904381), (-9904379)⟩, ⟨(-19795048), (-19795045)⟩, ⟨(-9870107), (-9870103)⟩, ⟨27398, 27401⟩, ⟨6825, 6828⟩⟩
...
def j36 : Jet := ⟨⟨4285062915, 4285062917⟩, ⟨(-19795048), (-19795045)⟩, ⟨(-9870107), (-9870103)⟩, ⟨27398, 27401⟩, ⟨6825, 6828⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨168227442, 168227445⟩, ⟨167761407, 167761411⟩, ⟨(-698592), (-698590)⟩, ⟨(-232097), (-232094)⟩, ⟨574, 578⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304894567, 4304894570⟩, ⟨19886657, 19886662⟩, ⟨10007649, 10007656⟩, ⟨64507, 64514⟩, ⟨16361, 16369⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨168616278, 168616282⟩, ⟨168928096, 168928102⟩, ⟨468549, 468554⟩, ⟨157555, 157563⟩, ⟨1031, 1041⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-160868001), (-160868000)⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4134099295, 4134099296⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6619712, 6619713⟩, ⟨13263908, 13263910⟩, ⟨6681006, 6681010⟩, ⟨49226, 49230⟩, ⟨12523, 12530⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301587008, 4301587009⟩, ⟨13263908, 13263910⟩, ⟨6681006, 6681010⟩, ⟨49226, 49230⟩, ⟨12523, 12530⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298275877, 4298275879⟩, ⟨6626849, 6626851⟩, ⟨3332823, 3332826⟩, ⟨19455, 19459⟩, ⟨4933, 4939⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4137283953, 4137283957⟩, ⟨(-154613284), (-154613279)⟩, ⟨2959783, 2959788⟩, ⟨(-106105), (-106099)⟩, ⟨4019, 4027⟩⟩
...
def j47 : Jet := ⟨⟨1268472483, 1268472492⟩, ⟨1268472483, 1268472492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨374629730, 374629736⟩, ⟨749259460, 749259472⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨374629730, 374629736⟩, ⟨749259460, 749259472⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-374629736), (-374629730)⟩, ⟨(-749259472), (-749259460)⟩, ⟨(-374629736), (-374629730)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-187314868), (-187314865)⟩, ⟨(-374629736), (-374629730)⟩, ⟨(-187314868), (-187314865)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4111678337, 4111678341⟩, ⟨(-358642306), (-358642299)⟩, ⟨(-163679816), (-163679811)⟩, ⟨15186564, 15186566⟩, ⟨3238091, 3238092⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3960724175, 3960724184⟩, ⟨(-493490405), (-493490392)⟩, ⟨(-141926423), (-141926409)⟩, ⟨20172544, 20172556⟩, ⟨2472421, 2472436⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 321736001⟩, ⟨160868000, 160868001⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1010763458⟩, ⟨505381726, 505381731⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 237869744⟩, ⟨0, 237869746⟩, ⟨59467435, 59467437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5245), 0⟩, ⟨(-5245), 4⟩, ⟨(-1312), (-1305)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107811, 5113057⟩, ⟨(-5245), 4⟩, ⟨(-1312), (-1305)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 283179⟩, ⟨(-291), 283180⟩, ⟨70357, 70796⟩, ⟨(-146), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142882397)⟩, ⟨(-291), 283180⟩, ⟨70357, 70796⟩, ⟨(-146), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7928992), 0⟩, ⟨(-7929009), 15684⟩, ⟨(-1982265), (-1958721)⟩, ⟨(-14), 7843⟩, ⟨963, 982⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423726773, 1431655766⟩, ⟨(-7929009), 15684⟩, ⟨(-1982265), (-1958721)⟩, ⟨(-14), 7843⟩, ⟨963, 982⟩⟩
...
def j72 : Jet := ⟨⟨0, 656⟩, ⟨(-1), 656⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851520)⟩, ⟨(-1), 656⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-47197), 0⟩, ⟨(-47198), 37⟩, ⟨(-11801), (-11743)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35744197, 35791395⟩, ⟨(-47198), 37⟩, ⟨(-11801), (-11743)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1982248⟩, ⟨(-2614), 1982251⟩, ⟨491640, 495565⟩, ⟨(-1309), 3⟩, ⟨(-165), (-159)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713845634)⟩, ⟨(-2614), 1982251⟩, ⟨491640, 495565⟩, ⟨(-1309), 3⟩, ⟨(-165), (-159)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-39644958), 0⟩, ⟨(-39645103), 109784⟩, ⟨(-9911385), (-9746562)⟩, ⟨(-110), 54894⟩, ⟨6724, 6863⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4255322338, 4294967296⟩, ⟨(-39645103), 109784⟩, ⟨(-9911385), (-9746562)⟩, ⟨(-110), 54894⟩, ⟨6724, 6863⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 336921153⟩, ⟨165661596, 168464270⟩, ⟨(-1399494), 1846⟩, ⟨(-233254), (-228633)⟩, ⟨(-2), 1155⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4334981609⟩, ⟨(-111840), 40387257⟩, ⟨9745529, 10473198⟩, ⟨(-56455), 191758⟩, ⟨14149, 19398⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 340060099⟩, ⟨165652822, 173201980⟩, ⟨(-1416920), 2407576⟩, ⟨122878, 197244⟩, ⟨(-7825), 10222⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-321736001), 0⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3973231295, 4294967296⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 26924739⟩, ⟨0, 27427024⟩, ⟨6164698, 7365918⟩, ⟨(-114280), 225416⟩, ⟨7443, 18880⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4321892035⟩, ⟨0, 27427024⟩, ⟨6164698, 7365918⟩, ⟨(-114280), 225416⟩, ⟨7443, 18880⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4308408633⟩, ⟨0, 13713512⟩, ⟨3050907, 3682959⟩, ⟨(-68900), 112708⟩, ⟨1776, 8577⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3973231295, 4308408633⟩, ⟨(-161371447), (-147154488)⟩, ⟨2308723, 3682959⟩, ⟨(-206846), (-1563)⟩, ⟨(-2580), 11158⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2536944975⟩, ⟨1268472483, 1268472492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1498518933⟩, ⟨0, 1498518938⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1498518933⟩, ⟨0, 1498518938⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1498518933), 0⟩, ⟨(-1498518938), 0⟩, ⟨(-374629736), (-374629730)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-749259467), 0⟩, ⟨(-749259469), 0⟩, ⟨(-187314868), (-187314865)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3607421953, 4294967296⟩, ⟨(-749259469), 0⟩, ⟨(-187314868), (-91974828)⟩, ⟨0, 32677185⟩, ⟨580494, 4084649⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3337189973, 4308408633⟩, ⟨(-912975765), (-123597758)⟩, ⟨(-185961943), (-53250693)⟩, ⟨2301907, 39815975⟩, ⟨(-853950), 4095236⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298275877, 4298275879⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2182
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4308408633⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2183
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (146607651 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(7491 / 100000), prawitzNormalCorrection
