...
namespace FiniteNormalPanel164_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6823 / 40000)
def radius : Rat := (6823 / 200000)

def j0 : Jet := ⟨⟨732614046, 732614047⟩, ⟨146522809, 146522810⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2301574904, 2301574909⟩, ⟨460314980, 460314984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1233361437, 1233361443⟩, ⟨493344574, 493344580⟩, ⟨49334457, 49334459⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-27103), (-27101)⟩, ⟨(-10806), (-10804)⟩, ⟨(-1068), (-1065)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5085953, 5085956⟩, ⟨(-10806), (-10804)⟩, ⟨(-1068), (-1065)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1460504, 1460506⟩, ⟨581097, 581101⟩, ⟨56871, 56875⟩, ⟨(-248), (-244)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-141705073), (-141705070)⟩, ⟨581097, 581101⟩, ⟨56871, 56875⟩, ⟨(-248), (-244)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-40692644), (-40692642)⟩, ⟨(-16110188), (-16110184)⟩, ⟨(-1544627), (-1544623)⟩, ⟨13134, 13138⟩, ⟨620, 624⟩⟩
...
def j19 : Jet := ⟨⟨1390963121, 1390963124⟩, ⟨(-16110188), (-16110184)⟩, ⟨(-1544627), (-1544623)⟩, ⟨13134, 13138⟩, ⟨620, 624⟩⟩
...
def j22 : Jet := ⟨⟨(-32), (-30)⟩, ⟨(-13), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11803, 11806⟩, ⟨(-13), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3389, 3391⟩, ⟨1351, 1354⟩, ⟨132, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848788), (-848785)⟩, ⟨1351, 1354⟩, ⟨132, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-243742), (-243740)⟩, ⟨(-97110), (-97107)⟩, ⟨(-9558), (-9554)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35547652, 35547655⟩, ⟨(-97110), (-97107)⟩, ⟨(-9558), (-9554)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10208017, 10208019⟩, ⟨4055320, 4055323⟩, ⟨394420, 394424⟩, ⟨(-2206), (-2202)⟩, ⟨(-108), (-104)⟩⟩
...
def j33 : Jet := ⟨⟨(-705619866), (-705619863)⟩, ⟨4055320, 4055323⟩, ⟨394420, 394424⟩, ⟨(-2206), (-2202)⟩, ⟨(-108), (-104)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-202628863), (-202628860)⟩, ⟨(-79887003), (-79886998)⟩, ⟨(-7526075), (-7526071)⟩, ⟨91252, 91256⟩, ⟨4244, 4250⟩⟩
...
def j36 : Jet := ⟨⟨4092338433, 4092338436⟩, ⟨(-79887003), (-79886998)⟩, ⟨(-7526075), (-7526071)⟩, ⟨91252, 91256⟩, ⟨4244, 4250⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨745385375, 745385379⟩, ⟨140443992, 140443998⟩, ⟨(-2554348), (-2554343)⟩, ⟨(-158509), (-158504)⟩, ⟨1739, 1744⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4507629161, 4507629166⟩, ⟨87993934, 87993942⟩, ⟨10007555, 10007562⟩, ⟨256666, 256675⟩, ⟨16770, 16781⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨782292534, 782292540⟩, ⟨162669183, 162669193⟩, ⟨1933343, 1933352⟩, ⟨153096, 153106⟩, ⟨3927, 3940⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-732614047), (-732614046)⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3562353249, 3562353250⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨142488071, 142488075⟩, ⟨59257674, 59257680⟩, ⟨6865276, 6865282⟩, ⟨202218, 202224⟩, ⟨13896, 13905⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4437455367, 4437455371⟩, ⟨59257674, 59257680⟩, ⟨6865276, 6865282⟩, ⟨202218, 202224⟩, ⟨13896, 13905⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4365630043, 4365630046⟩, ⟨29149260, 29149264⟩, ⟨3279761, 3279766⟩, ⟨77572, 77577⟩, ⟨5084, 5091⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3620962697, 3620962702⟩, ⟨(-124756346), (-124756339)⟩, ⟨1725887, 1725893⟩, ⟨(-47550), (-47544)⟩, ⟨1569, 1577⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨38373127787, 38373127794⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value662

def j47 : Jet := ⟨⟨6545496267, 6545496278⟩, ⟨1309099251, 1309099261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9975284659, 9975284694⟩, ⟨3990113856, 3990113894⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9975284659, 9975284694⟩, ⟨3990113856, 3990113894⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9975284694), (-9975284659)⟩, ⟨(-3990113894), (-3990113856)⟩, ⟨(-399011392), (-399011384)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4987642347), (-4987642329)⟩, ⟨(-1995056947), (-1995056928)⟩, ⟨(-199505696), (-199505692)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1344695991, 1344696007⟩, ⟨(-624625271), (-624625257)⟩, ⟨82609932, 82609941⟩, ⟨6551935, 6551939⟩, ⟨(-2679520), (-2679518)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1133674295, 1133674311⟩, ⟨(-565663020), (-565663004)⟩, ⟨88329946, 88329959⟩, ⟨2858278, 2858289⟩, ⟨(-2408741), (-2408731)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨586091237, 879136856⟩, ⟨146522809, 146522810⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1841259924, 2761889889⟩, ⟨460314980, 460314984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨789351320, 1776040476⟩, ⟨394675658, 592013496⟩, ⟨49334457, 49334459⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-39074), (-17320)⟩, ⟨(-13007), (-8598)⟩, ⟨(-1075), (-1055)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073982, 5095737⟩, ⟨(-13007), (-8598)⟩, ⟨(-1075), (-1055)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨932522, 2107173⟩, ⟨460882, 700811⟩, ⟨56044, 57550⟩, ⟨(-299), (-192)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142233055), (-141058403)⟩, ⟨460882, 700811⟩, ⟨56044, 57550⟩, ⟨(-299), (-192)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-58815737), (-25924443)⟩, ⟨(-19520543), (-12672423)⟩, ⟨(-1581120), (-1499879)⟩, ⟨10319, 15948⟩, ⟨595, 644⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1372840028, 1405731323⟩, ⟨(-19520543), (-12672423)⟩, ⟨(-1581120), (-1499879)⟩, ⟨10319, 15948⟩, ⟨595, 644⟩⟩
...
def j72 : Jet := ⟨⟨2166, 4887⟩, ⟨1076, 1628⟩, ⟨131, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850011), (-847289)⟩, ⟨1076, 1628⟩, ⟨131, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-351494), (-155719)⟩, ⟨(-116968), (-77185)⟩, ⟨(-9642), (-9450)⟩, ⟨23, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35439900, 35635676⟩, ⟨(-116968), (-77185)⟩, ⟨(-9642), (-9450)⟩, ⟨23, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6513328, 14735946⟩, ⟨3208295, 4897797⟩, ⟨386972, 400504⟩, ⟨(-2670), (-1738)⟩, ⟨(-110), (-101)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709314555), (-701091936)⟩, ⟨3208295, 4897797⟩, ⟨386972, 400504⟩, ⟨(-2670), (-1738)⟩, ⟨(-110), (-101)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-293313377), (-128850304)⟩, ⟨(-97181490), (-62399831)⟩, ⟨(-7781658), (-7212420)⟩, ⟨71306, 111146⟩, ⟨4029, 4424⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4001653919, 4166116992⟩, ⟨(-97181490), (-62399831)⟩, ⟨(-7781658), (-7212420)⟩, ⟨71306, 111146⟩, ⟨4029, 4424⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨588538899, 903959183⟩, ⟨134581988, 145227176⟩, ⟨(-3108867), (-2001172)⟩, ⟨(-165035), (-150494)⟩, ⟨1360, 2125⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4427802701, 4609779968⟩, ⟨66319342, 111950033⟩, ⟨8658777, 11682972⟩, ⟨121519, 422527⟩, ⟨8925, 27343⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨606741320, 970217617⟩, ⟨147832092, 179434100⟩, ⟨(-72126), 4181250⟩, ⟨29806, 297923⟩, ⟨(-6328), 15967⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-879136856), (-586091237)⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3415830440, 3708876059⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨85713115, 219168660⟩, ⟨41767878, 81067032⟩, ⟨5055769, 9385415⟩, ⟨2392, 483968⟩, ⟨(-881), 36179⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4380680411, 4514135956⟩, ⟨41767878, 81067032⟩, ⟨5055769, 9385415⟩, ⟨2392, 483968⟩, ⟨(-881), 36179⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4337612142, 4403188198⟩, ⟨20370656, 40135015⟩, ⟨2282838, 4598739⟩, ⟨(-41368), 228885⟩, ⟨(-4992), 17695⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3449746312, 3802329137⟩, ⟨(-134013781), (-113319446)⟩, ⟨446356, 3276252⟩, ⟨(-192609), 119773⟩, ⟨(-12120), 16693⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5236397015, 7854595530⟩, ⟨1309099251, 1309099261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6384182185, 14364409945⟩, ⟨3192091086, 4788136672⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6384182185, 14364409945⟩, ⟨3192091086, 4788136672⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14364409945), (-6384182185)⟩, ⟨(-4788136672), (-3192091086)⟩, ⟨(-399011392), (-399011384)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7182204973), (-3192091092)⟩, ⟨(-2394068336), (-1596045543)⟩, ⟨(-199505696), (-199505692)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨806708033, 2042607790⟩, ⟨(-1138575057), (-299779409)⟩, ⟨(-39180996), 279855543⟩, ⟨(-42714947), 42538656⟩, ⟨(-12427685), 6862461⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨647953260, 1808318104⟩, ⟨(-1071713564), (-262069193)⟩, ⟨(-26693599), 284840292⟩, ⟨(-47507807), 38907773⟩, ⟨(-12396933), 7680620⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨732614046, 732614047⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4365630043, 4365630046⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar662 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3314
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar662 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨586091237, 879136856⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4337612142, 4403188198⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3315
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((6823 / 50000) : ℝ)..(20469 / 100000), prawitzNormalCorrection
      ((54173 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
