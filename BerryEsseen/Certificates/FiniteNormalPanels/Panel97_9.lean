...
namespace FiniteNormalPanel97_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1189 / 6400)
def radius : Rat := (1189 / 32000)

def j0 : Jet := ⟨⟨797924392, 797924393⟩, ⟨159584878, 159584879⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2506753407, 2506753412⟩, ⟨501350680, 501350684⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1463064142, 1463064149⟩, ⟨585225654, 585225662⟩, ⟨58522565, 58522567⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨366, 367⟩, ⟨146, 147⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94321), (-94319)⟩, ⟨146, 147⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-32131), (-32129)⟩, ⟨(-12804), (-12800)⟩, ⟨(-1263), (-1258)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5080925, 5080928⟩, ⟨(-12804), (-12800)⟩, ⟨(-1263), (-1258)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1730797, 1730799⟩, ⟨687957, 687960⟩, ⟨67055, 67060⟩, ⟨(-348), (-342)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-141434780), (-141434777)⟩, ⟨687957, 687960⟩, ⟨67055, 67060⟩, ⟨(-348), (-342)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-48179216), (-48179214)⟩, ⟨(-19037338), (-19037334)⟩, ⟨(-1810588), (-1810583)⟩, ⟨18390, 18397⟩, ⟨858, 863⟩⟩
...
def j19 : Jet := ⟨⟨1383476549, 1383476552⟩, ⟨(-19037338), (-19037334)⟩, ⟨(-1810588), (-1810583)⟩, ⟨18390, 18397⟩, ⟨858, 863⟩⟩
...
def j22 : Jet := ⟨⟨(-37), (-36)⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11798, 11800⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4018, 4020⟩, ⟨1601, 1604⟩, ⟨156, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848159), (-848156)⟩, ⟨1601, 1604⟩, ⟨156, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-288923), (-288921)⟩, ⟨(-115024), (-115021)⟩, ⟨(-11286), (-11282)⟩, ⟨41, 44⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35502471, 35502474⟩, ⟨(-115024), (-115021)⟩, ⟨(-11286), (-11282)⟩, ⟨41, 44⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12093780, 12093782⟩, ⟨4798329, 4798332⟩, ⟨464233, 464237⟩, ⟨(-3093), (-3089)⟩, ⟨(-149), (-145)⟩⟩
...
def j33 : Jet := ⟨⟨(-703734103), (-703734100)⟩, ⟨4798329, 4798332⟩, ⟨464233, 464237⟩, ⟨(-3093), (-3089)⟩, ⟨(-149), (-145)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-239724326), (-239724322)⟩, ⟨(-94255199), (-94255194)⟩, ⟨(-8777023), (-8777017)⟩, ⟨127582, 127587⟩, ⟨5852, 5857⟩⟩
...
def j36 : Jet := ⟨⟨4055242970, 4055242974⟩, ⟨(-94255199), (-94255194)⟩, ⟨(-8777023), (-8777017)⟩, ⟨127582, 127587⟩, ⟨5852, 5857⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨807464717, 807464721⟩, ⟨150381818, 150381824⟩, ⟨(-3278973), (-3278968)⟩, ⟨(-200617), (-200610)⟩, ⟨2646, 2652⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4548862840, 4548862846⟩, ⟨105728300, 105728308⟩, ⟨12302810, 12302819⟩, ⟨371666, 371678⟩, ⟨25367, 25379⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨855197721, 855197727⟩, ⟨179148775, 179148786⟩, ⟨2542067, 2542077⟩, ⟨207443, 207457⟩, ⟨6252, 6265⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-797924393), (-797924392)⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3497042903, 3497042904⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨170283751, 170283754⟩, ⟨71342858, 71342866⟩, ⟨8484864, 8484872⟩, ⟨294674, 294686⟩, ⟨21296, 21309⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4465251047, 4465251050⟩, ⟨71342858, 71342866⟩, ⟨8484864, 8484872⟩, ⟨294674, 294686⟩, ⟨21296, 21309⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4379281586, 4379281589⟩, ⟨34984647, 34984652⟩, ⟨4021011, 4021017⟩, ⟨112376, 112384⟩, ⟨7698, 7707⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3565693178, 3565693183⟩, ⟨(-134232527), (-134232520)⟩, ⟨1974083, 1974090⟩, ⟨(-57908), (-57899)⟩, ⟨2091, 2101⟩⟩
...
def j47 : Jet := ⟨⟨6633722239, 6633722250⟩, ⟨1326744444, 1326744454⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10246008342, 10246008377⟩, ⟨4098403324, 4098403364⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10246008342, 10246008377⟩, ⟨4098403324, 4098403364⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10246008377), (-10246008342)⟩, ⟨(-4098403364), (-4098403324)⟩, ⟨(-409840338), (-409840331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5123004189), (-5123004171)⟩, ⟨(-2049201682), (-2049201662)⟩, ⟨(-204920169), (-204920165)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1302976902, 1302976921⟩, ⟨(-621672371), (-621672354)⟩, ⟨86137968, 86137977⟩, ⟨6074731, 6074734⟩, ⟨(-2779485), (-2779483)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1081734860, 1081734879⟩, ⟨(-556836562), (-556836543)⟩, ⟨91540253, 91540266⟩, ⟨2047841, 2047852⟩, ⟨(-2448788), (-2448778)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨638339514, 957509272⟩, ⟨159584878, 159584879⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2005402727, 3008104095⟩, ⟨501350680, 501350684⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨936361052, 2106812375⟩, ⟨468180524, 702270794⟩, ⟨58522565, 58522567⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨234, 528⟩, ⟨117, 176⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94453), (-94158)⟩, ⟨117, 176⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-46333), (-20527)⟩, ⟨(-15420), (-10176)⟩, ⟨(-1273), (-1245)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5066723, 5092530⟩, ⟨(-15420), (-10176)⟩, ⟨(-1273), (-1245)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1104614, 2498042⟩, ⟨544743, 830463⟩, ⟨65891, 68011⟩, ⟨(-420), (-270)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142060963), (-140667534)⟩, ⟨544743, 830463⟩, ⟨65891, 68011⟩, ⟨(-420), (-270)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-69685233), (-30667427)⟩, ⟨(-23109650), (-14926345)⟩, ⟨(-1861956), (-1747562)⟩, ⟨14397, 22379⟩, ⟨819, 895⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1361970532, 1400988339⟩, ⟨(-23109650), (-14926345)⟩, ⟨(-1861956), (-1747562)⟩, ⟨14397, 22379⟩, ⟨819, 895⟩⟩
...
def j70 : Jet := ⟨⟨(-53), (-23)⟩, ⟨(-18), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11782, 11813⟩, ⟨(-18), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2568, 5795⟩, ⟨1275, 1930⟩, ⟨156, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849609), (-846381)⟩, ⟨1275, 1930⟩, ⟨156, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-416760), (-184522)⟩, ⟨(-138643), (-91314)⟩, ⟨(-11405), (-11137)⟩, ⟨33, 54⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35374634, 35606873⟩, ⟨(-138643), (-91314)⟩, ⟨(-11405), (-11137)⟩, ⟨33, 54⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7712149, 17466257⟩, ⟨3788065, 5802179⟩, ⟨453744, 472793⟩, ⟨(-3748), (-2431)⟩, ⟨(-153), (-140)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708115734), (-698361625)⟩, ⟨3788065, 5802179⟩, ⟨453744, 472793⟩, ⟨(-3748), (-2431)⟩, ⟨(-153), (-140)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-347352352), (-152252294)⟩, ⟨(-114958269), (-73280000)⟩, ⟨(-9136831), (-8335132)⟩, ⟨99237, 155838⟩, ⟨5493, 6149⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3947614944, 4142715002⟩, ⟨(-114958269), (-73280000)⟩, ⟨(-9136831), (-8335132)⟩, ⟨99237, 155838⟩, ⟨5493, 6149⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨635930201, 981222550⟩, ⟨142797039, 156567696⟩, ⟨(-4001660), (-2558319)⟩, ⟨(-210624), (-188318)⟩, ⟨2062, 3240⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4452815138, 4672883333⟩, ⟨78765323, 136078769⟩, ⟨10352322, 14778222⟩, ⟨165812, 633378⟩, ⟨11704, 44476⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨659301789, 1067560749⟩, ⟨159707400, 201432532⟩, ⟨(-202210), 5684456⟩, ⟨12796, 441268⟩, ⟨(-11063), 27158⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-957509272), (-638339514)⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3337458024, 3656627782⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨101206556, 265353814⟩, ⟨49031978, 100136486⟩, ⟨5838160, 12272987⟩, ⟨(-15040), 752564⟩, ⟨(-4818), 62418⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4396173852, 4560321110⟩, ⟨49031978, 100136486⟩, ⟨5838160, 12272987⟩, ⟨(-15040), 752564⟩, ⟨(-4818), 62418⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4345275931, 4425655887⟩, ⟨23792037, 49488565⟩, ⟨2556184, 6000312⟩, ⟨(-75772), 357930⟩, ⟨(-10602), 30960⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3376550977, 3767892782⟩, ⟨(-145952878), (-119320830)⟩, ⟨147504, 4224494⟩, ⟨(-287461), 209755⟩, ⟨(-22327), 29175⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5306977795, 7960466703⟩, ⟨1326744444, 1326744454⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6557445348, 14754252073⟩, ⟨3278722662, 4918084038⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6557445348, 14754252073⟩, ⟨3278722662, 4918084038⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14754252073), (-6557445348)⟩, ⟨(-4918084038), (-3278722662)⟩, ⟨(-409840338), (-409840331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7377126037), (-3278722674)⟩, ⟨(-2459042019), (-1639361331)⟩, ⟨(-204920169), (-204920165)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨770915069, 2001820133⟩, ⟨(-1146122772), (-294253312)⟩, ⟨(-39352936), 291319096⟩, ⟨(-46237763), 43966022⟩, ⟨(-13242745), 7557044⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨606066088, 1756158572⟩, ⟨(-1073498077), (-252748730)⟩, ⟨(-26322294), 296485545⟩, ⟨(-51724500), 39995515⟩, ⟨(-13216764), 8577766⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨797924392, 797924393⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4379281586, 4379281589⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1958
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨638339514, 957509272⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4345275931, 4425655887⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1959
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (82781439 / 4294967296)

theorem envelope_integral : (∫ s in ((1189 / 8000) : ℝ)..(3567 / 16000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (1189 / 8000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (3567 / 16000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((1189 / 8000) : ℝ)..(3567 / 16000), prawitzNormalCorrection
