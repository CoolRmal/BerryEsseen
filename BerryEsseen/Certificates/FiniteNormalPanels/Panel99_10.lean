...
namespace FiniteNormalPanel99_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (107639 / 400000)
def radius : Rat := (15377 / 400000)

def j0 : Jet := ⟨⟨1155764961, 1155764962⟩, ⟨165109280, 165109281⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3630942710, 3630942715⟩, ⟨518706101, 518706105⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3069579825, 3069579835⟩, ⟨877022806, 877022816⟩, ⟨62644486, 62644488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨768, 770⟩, ⟨219, 220⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93919), (-93916)⟩, ⟨219, 220⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-67124), (-67121)⟩, ⟨(-19023), (-19019)⟩, ⟨(-1316), (-1312)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5045932, 5045936⟩, ⟨(-19023), (-19019)⟩, ⟨(-1316), (-1312)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3606288, 3606292⟩, ⟨1016772, 1016777⟩, ⟨68771, 68778⟩, ⟨(-543), (-538)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-139559289), (-139559284)⟩, ⟨1016772, 1016777⟩, ⟨68771, 68778⟩, ⟨(-543), (-538)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-99741943), (-99741938)⟩, ⟨(-27771019), (-27771013)⟩, ⟨(-1778778), (-1778769)⟩, ⟨28483, 28492⟩, ⟨878, 884⟩⟩
...
def j19 : Jet := ⟨⟨1331913822, 1331913828⟩, ⟨(-27771019), (-27771013)⟩, ⟨(-1778778), (-1778769)⟩, ⟨28483, 28492⟩, ⟨878, 884⟩⟩
...
def j25 : Jet := ⟨⟨8402, 8405⟩, ⟨2383, 2387⟩, ⟨164, 168⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843775), (-843771)⟩, ⟨2383, 2387⟩, ⟨164, 168⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-603040), (-603036)⟩, ⟨(-170594), (-170590)⟩, ⟨(-11704), (-11697)⟩, ⟨65, 70⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35188354, 35188359⟩, ⟨(-170594), (-170590)⟩, ⟨(-11704), (-11697)⟩, ⟨65, 70⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25148843, 25148848⟩, ⟨7063460, 7063467⟩, ⟨470041, 470049⟩, ⟨(-4833), (-4825)⟩, ⟨(-158), (-152)⟩⟩
...
def j33 : Jet := ⟨⟨(-690679040), (-690679034)⟩, ⟨7063460, 7063467⟩, ⟨470041, 470049⟩, ⟨(-4833), (-4825)⟩, ⟨(-158), (-152)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-493622957), (-493622950)⟩, ⟨(-135986932), (-135986922)⟩, ⟨(-8295663), (-8295651)⟩, ⟨195550, 195560⟩, ⟨5755, 5763⟩⟩
...
def j36 : Jet := ⟨⟨3801344339, 3801344346⟩, ⟨(-135986932), (-135986922)⟩, ⟨(-8295663), (-8295651)⟩, ⟨195550, 195560⟩, ⟨5755, 5763⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1125992923, 1125992931⟩, ⟨137378657, 137378667⟩, ⟨(-4857695), (-4857684)⟩, ⟨(-190746), (-190736)⟩, ⟨4181, 4189⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4852689573, 4852689583⟩, ⟨173597089, 173597105⟩, ⟨16800148, 16800167⟩, ⟨730189, 730208⟩, ⟨46494, 46511⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1272208550, 1272208562⟩, ⟨200729134, 200729152⟩, ⟨4468599, 4468621⟩, ⟨316940, 316962⟩, ⟨13555, 13574⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1155764962), (-1155764961)⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3139202334, 3139202335⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨376839794, 376839802⟩, ⟨118915606, 118915620⟩, ⟨12028533, 12028552⟩, ⟨605446, 605468⟩, ⟨42303, 42320⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4671807090, 4671807098⟩, ⟨118915606, 118915620⟩, ⟨12028533, 12028552⟩, ⟨605446, 605468⟩, ⟨42303, 42320⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4479426153, 4479426158⟩, ⟨57009382, 57009390⟩, ⟨5403826, 5403837⟩, ⟨221481, 221495⟩, ⟨14201, 14212⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3274023773, 3274023779⟩, ⟨(-130532042), (-130532033)⟩, ⟨1758085, 1758095⟩, ⟨(-45857), (-45844)⟩, ⟨1864, 1874⟩⟩
...
def j47 : Jet := ⟨⟨8724820694, 8724820704⟩, ⟨1246402955, 1246402964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17723649773, 17723649815⟩, ⟨5063899930, 5063899974⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17723649773, 17723649815⟩, ⟨5063899930, 5063899974⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17723649815), (-17723649773)⟩, ⟨(-5063899974), (-5063899930)⟩, ⟨(-361707143), (-361707137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8861824908), (-8861824886)⟩, ⟨(-2531949987), (-2531949965)⟩, ⟨(-180853572), (-180853568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨545604747, 545604763⟩, ⟨(-321642490), (-321642477)⟩, ⟨71832155, 71832162⟩, ⟨(-5086191), (-5086187)⟩, ⟨(-762767), (-762766)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨415910713, 415910727⟩, ⟨(-261767784), (-261767769)⟩, ⟨64755800, 64755810⟩, ⟨(-6197769), (-6197759)⟩, ⟨(-393802), (-393794)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨990655681, 1320874243⟩, ⟨165109280, 165109281⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3112236609, 4149648819⟩, ⟨518706101, 518706105⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2255201505, 4009247134⟩, ⟨751733834, 1002311790⟩, ⟨62644486, 62644488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨564, 1005⟩, ⟨188, 252⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94123), (-93681)⟩, ⟨188, 252⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-87862), (-49190)⟩, ⟨(-21868), (-16160)⟩, ⟨(-1334), (-1292)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5025194, 5063867⟩, ⟨(-21868), (-16160)⟩, ⟨(-1334), (-1292)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2638628, 4726997⟩, ⟨859128, 1173265⟩, ⟨66945, 70354⟩, ⟨(-629), (-453)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140526949), (-138438579)⟩, ⟨859128, 1173265⟩, ⟨66945, 70354⟩, ⟨(-629), (-453)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-131178477), (-72691331)⟩, ⟨(-32343510), (-23135228)⟩, ⟨(-1864143), (-1679725)⟩, ⟨23659, 33295⟩, ⟨810, 941⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1300477288, 1358964435⟩, ⟨(-32343510), (-23135228)⟩, ⟨(-1864143), (-1679725)⟩, ⟨23659, 33295⟩, ⟨810, 941⟩⟩
...
def j72 : Jet := ⟨⟨6161, 10997⟩, ⟨2028, 2741⟩, ⟨162, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846016), (-841179)⟩, ⟨2028, 2741⟩, ⟨162, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-789736), (-441686)⟩, ⟨(-196370), (-144669)⟩, ⟨(-11901), (-11471)⟩, ⟨55, 80⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35001658, 35349709⟩, ⟨(-196370), (-144669)⟩, ⟨(-11901), (-11471)⟩, ⟨55, 80⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18378671, 32998091⟩, ⟨5942916, 8173561⟩, ⟨453581, 484253⟩, ⟨(-5615), (-4042)⟩, ⟨(-165), (-145)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697449212), (-682829791)⟩, ⟨5942916, 8173561⟩, ⟨453581, 484253⟩, ⟨(-5615), (-4042)⟩, ⟨(-165), (-145)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-651051816), (-358540278)⟩, ⟨(-159642449), (-111883606)⟩, ⟨(-8894351), (-7599958)⟩, ⟨160826, 230104⟩, ⟨5149, 6281⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3643915480, 3936427018⟩, ⟨(-159642449), (-111883606)⟩, ⟨(-8894351), (-7599958)⟩, ⟨160826, 230104⟩, ⟨5149, 6281⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨942357123, 1312984425⟩, ⟨125810339, 147358712⟩, ⟨(-5707219), (-4011226)⟩, ⟨(-207991), (-170692)⟩, ⟨3443, 4932⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4686164379, 5062341368⟩, ⟨133193112, 221784666⟩, ⟨12833153, 22073095⟩, ⟨325982, 1301563⟩, ⟨12996, 98403⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1028189524, 1547572988⟩, ⟨166493329, 241487268⟩, ⟨(-9642), 9980582⟩, ⟨(-92426), 844580⟩, ⟨(-23918), 63276⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1320874243), (-990655681)⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2974093053, 3304311615⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨246142432, 557625237⟩, ⟨79715016, 174026552⟩, ⟨6447122, 20770232⟩, ⟨(-67694), 1730974⟩, ⟨(-27655), 163769⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4541109728, 4852592533⟩, ⟨79715016, 174026552⟩, ⟨6447122, 20770232⟩, ⟨(-67694), 1730974⟩, ⟨(-27655), 163769⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4416324010, 4565273950⟩, ⟨37497573, 84622228⟩, ⟨2248414, 9940553⟩, ⟨(-223391), 822615⟩, ⟨(-40399), 83344⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3058127723, 3512270688⟩, ⟨(-149534976), (-104670846)⟩, ⟨(-1696155), 6206215⟩, ⟨(-554005), 546441⟩, ⟨(-62705), 72709⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7478417739, 9971223667⟩, ⟨1246402955, 1246402964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13021456980, 23149256925⟩, ⟨4340485654, 5787314258⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13021456980, 23149256925⟩, ⟨4340485654, 5787314258⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23149256925), (-13021456980)⟩, ⟨(-5787314258), (-4340485654)⟩, ⟨(-361707143), (-361707137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11574628463), (-6510728490)⟩, ⟨(-2893657129), (-2170242827)⟩, ⟨(-180853572), (-180853568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨290113148, 943222421⟩, ⟨(-635479178), (-146593893)⟩, ⟨(-2680573), 201855188⟩, ⟨(-41216895), 18441275⟩, ⟨(-7356005), 6998724⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨206568059, 771333571⟩, ⟨(-552511690), (-111448865)⟩, ⟨1008006, 188557960⟩, ⟨(-41773492), 15544911⟩, ⟨(-6831875), 7547948⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1155764961, 1155764962⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4479426153, 4479426158⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2000
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨990655681, 1320874243⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4416324010, 4565273950⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2001
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (33752945 / 4294967296)

theorem envelope_integral : (∫ s in ((46131 / 200000) : ℝ)..(15377 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((46131 / 200000) : ℝ)..(15377 / 50000), prawitzNormalCorrection
