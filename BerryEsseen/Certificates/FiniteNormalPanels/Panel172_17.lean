...
namespace FiniteNormalPanel172_17
...
def j2 : Jet := ⟨⟨443802876, 443802880⟩, ⟨443802876, 443802880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨45858554, 45858556⟩, ⟨91717108, 91717112⟩, ⟨45858554, 45858556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1011), (-1010)⟩, ⟨(-2022), (-2020)⟩, ⟨(-1011), (-1008)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112045, 5112047⟩, ⟨(-2022), (-2020)⟩, ⟨(-1011), (-1008)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨54582, 54583⟩, ⟨109143, 109145⟩, ⟨54527, 54530⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143110995), (-143110993)⟩, ⟨109143, 109145⟩, ⟨54527, 54530⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1528036), (-1528035)⟩, ⟨(-3054907), (-3054905)⟩, ⟨(-1525124), (-1525121)⟩, ⟨2328, 2331⟩, ⟨580, 583⟩⟩
...
def j19 : Jet := ⟨⟨1430127729, 1430127731⟩, ⟨(-3054907), (-3054905)⟩, ⟨(-1525124), (-1525121)⟩, ⟨2328, 2331⟩, ⟨580, 583⟩⟩
...
def j28 : Jet := ⟨⟨(-9098), (-9097)⟩, ⟨(-18194), (-18192)⟩, ⟨(-9092), (-9089)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782296, 35782298⟩, ⟨(-18194), (-18192)⟩, ⟨(-9092), (-9089)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨382057, 382058⟩, ⟨763919, 763922⟩, ⟨381570, 381573⟩, ⟨(-390), (-387)⟩, ⟨(-99), (-95)⟩⟩
...
def j33 : Jet := ⟨⟨(-715445826), (-715445824)⟩, ⟨763919, 763922⟩, ⟨381570, 381573⟩, ⟨(-390), (-387)⟩, ⟨(-99), (-95)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7639014), (-7639012)⟩, ⟨(-15269871), (-15269868)⟩, ⟨(-7618627), (-7618623)⟩, ⟨16299, 16302⟩, ⟨4063, 4066⟩⟩
...
def j36 : Jet := ⟨⟨4287328282, 4287328284⟩, ⟨(-15269871), (-15269868)⟩, ⟨(-7618627), (-7618623)⟩, ⟨16299, 16302⟩, ⟨4063, 4066⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨147776398, 147776401⟩, ⟨147460731, 147460735⟩, ⟨(-473260), (-473258)⟩, ⟨(-157353), (-157351)⟩, ⟨299, 302⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302619918, 4302619921⟩, ⟨15324330, 15324335⟩, ⟨7700374, 7700381⟩, ⟨38296, 38303⟩, ⟨9679, 9687⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨148039700, 148039704⟩, ⟨148250733, 148250739⟩, ⟨316976, 316983⟩, ⟨106373, 106380⟩, ⟨535, 544⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-141266844), (-141266843)⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4153700452, 4153700453⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5102658, 5102660⟩, ⟨10219864, 10219868⟩, ⟨5139067, 5139070⟩, ⟨29214, 29218⟩, ⟨7401, 7406⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300069954, 4300069956⟩, ⟨10219864, 10219868⟩, ⟨5139067, 5139070⟩, ⟨29214, 29218⟩, ⟨7401, 7406⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297517867, 4297517869⟩, ⟨5106899, 5106902⟩, ⟨2564973, 2564976⟩, ⟨11550, 11554⟩, ⟨2918, 2923⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4156167131, 4156167135⟩, ⟨(-136411810), (-136411804)⟩, ⟨2312634, 2312639⟩, ⟨(-73196), (-73191)⟩, ⟨2441, 2448⟩⟩
...
def j47 : Jet := ⟨⟨1406709435, 1406709446⟩, ⟨1406709435, 1406709446⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨460732596, 460732604⟩, ⟨921465192, 921465208⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨460732596, 460732604⟩, ⟨921465192, 921465208⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-460732604), (-460732596)⟩, ⟨(-921465208), (-921465192)⟩, ⟨(-460732604), (-460732596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-230366302), (-230366298)⟩, ⟨(-460732604), (-460732596)⟩, ⟨(-230366302), (-230366298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4070670006, 4070670011⟩, ⟨(-436671636), (-436671627)⟩, ⟨(-194914354), (-194914347)⟩, ⟨22583970, 22583972⟩, ⟨4621584, 4621586⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3939118441, 3939118450⟩, ⟨(-551847687), (-551847670)⟩, ⟨(-172554400), (-172554384)⟩, ⟨27740267, 27740280⟩, ⟨3659742, 3659756⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 282533687⟩, ⟨141266843, 141266844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 887605756⟩, ⟨443802876, 443802880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 183434221⟩, ⟨0, 183434222⟩, ⟨45858554, 45858556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4044), 0⟩, ⟨(-4044), 2⟩, ⟨(-1011), (-1007)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109012, 5113057⟩, ⟨(-4044), 2⟩, ⟨(-1011), (-1007)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 218375⟩, ⟨(-173), 218376⟩, ⟨54333, 54595⟩, ⟨(-88), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142947201)⟩, ⟨(-173), 218376⟩, ⟨54333, 54595⟩, ⟨(-88), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6114475), 0⟩, ⟨(-6114483), 9327⟩, ⟨(-1528627), (-1514627)⟩, ⟨(-6), 4665⟩, ⟨575, 584⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425541290, 1431655766⟩, ⟨(-6114483), 9327⟩, ⟨(-1528627), (-1514627)⟩, ⟨(-6), 4665⟩, ⟨575, 584⟩⟩
...
def j72 : Jet := ⟨⟨0, 506⟩, ⟨(-1), 506⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851670)⟩, ⟨(-1), 506⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-36396), 0⟩, ⟨(-36397), 22⟩, ⟨(-9100), (-9065)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35754998, 35791395⟩, ⟨(-36397), 22⟩, ⟨(-9100), (-9065)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1528619⟩, ⟨(-1555), 1528620⟩, ⟨379822, 382156⟩, ⟨(-779), 2⟩, ⟨(-100), (-94)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714299263)⟩, ⟨(-1555), 1528620⟩, ⟨379822, 382156⟩, ⟨(-779), 2⟩, ⟨(-100), (-94)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30572371), 0⟩, ⟨(-30572438), 65286⟩, ⟨(-7643160), (-7545162)⟩, ⟨(-51), 32645⟩, ⟨4016, 4082⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264394925, 4294967296⟩, ⟨(-30572438), 65286⟩, ⟨(-7643160), (-7545162)⟩, ⟨(-51), 32645⟩, ⟨4016, 4082⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 295868586⟩, ⟨146038846, 147936222⟩, ⟨(-947725), 964⟩, ⟨(-157957), (-155542)⟩, ⟨(-1), 604⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4325758847⟩, ⟨(-66227), 31012371⟩, ⟨7544690, 7975480⟩, ⟨(-33358), 112817⟩, ⟨8668, 11061⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 297989732⟩, ⟨146034283, 151133167⟩, ⟨(-956802), 1618574⟩, ⟨88304, 126954⟩, ⟨(-4052), 5262⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-282533687), 0⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4012433609, 4294967296⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20674868⟩, ⟨0, 20971584⟩, ⟨4832579, 5542738⟩, ⟨(-67338), 131530⟩, ⟨5079, 10278⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315642164⟩, ⟨0, 20971584⟩, ⟨4832579, 5542738⟩, ⟨(-67338), 131530⟩, ⟨5079, 10278⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305292320⟩, ⟨0, 10485792⟩, ⟨2397724, 2771369⟩, ⟨(-40436), 65765⟩, ⟨1480, 4569⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4012433609, 4305292320⟩, ⟨(-141606447), (-130781051)⟩, ⟨1895104, 2771369⟩, ⟨(-131590), (-13099)⟩, ⟨(-782), 5899⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2813418882⟩, ⟨1406709435, 1406709446⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1842930403⟩, ⟨0, 1842930410⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1842930403⟩, ⟨0, 1842930410⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1842930403), 0⟩, ⟨(-1842930410), 0⟩, ⟨(-460732604), (-460732596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-921465202), 0⟩, ⟨(-921465205), 0⟩, ⟨(-230366302), (-230366298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3465644452, 4294967296⟩, ⟨(-921465205), 0⟩, ⟨(-230366302), (-87036429)⟩, ⟨0, 49424016⟩, ⟨(-316766), 6178003⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3237665695, 4305292320⟩, ⟨(-1065286838), (-105528306)⟩, ⟨(-229390924), (-48158583)⟩, ⟨1924070, 57127513⟩, ⟨(-2096483), 6188584⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297517867, 4297517869⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3488
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305292320⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3489
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (127711397 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(26313 / 400000), prawitzNormalCorrection
