...
namespace FiniteNormalPanel14_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (9661 / 40000)
def radius : Rat := (9661 / 200000)

def j0 : Jet := ⟨⟨1037341976, 1037341977⟩, ⟨207468395, 207468396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3258905930, 3258905935⟩, ⟨651781185, 651781189⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2472770367, 2472770376⟩, ⟨989108144, 989108154⟩, ⟨98910814, 98910816⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨618, 620⟩, ⟨247, 248⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94069), (-94066)⟩, ⟨247, 248⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-54159), (-54157)⟩, ⟨(-21522), (-21519)⟩, ⟨(-2098), (-2093)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5058897, 5058900⟩, ⟨(-21522), (-21519)⟩, ⟨(-2098), (-2093)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2912592, 2912595⟩, ⟨1152645, 1152649⟩, ⟨110338, 110344⟩, ⟨(-975), (-970)⟩, ⟨(-47), (-44)⟩⟩
...
def j16 : Jet := ⟨⟨(-140252985), (-140252981)⟩, ⟨1152645, 1152649⟩, ⟨110338, 110344⟩, ⟨(-975), (-970)⟩, ⟨(-47), (-44)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-80748794), (-80748790)⟩, ⟨(-31635898), (-31635893)⟩, ⟨(-2900979), (-2900972)⟩, ⟨51392, 51399⟩, ⟨2288, 2294⟩⟩
...
def j19 : Jet := ⟨⟨1350906971, 1350906976⟩, ⟨(-31635898), (-31635893)⟩, ⟨(-2900979), (-2900972)⟩, ⟨51392, 51399⟩, ⟨2288, 2294⟩⟩
...
def j22 : Jet := ⟨⟨(-63), (-61)⟩, ⟨(-25), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11772, 11775⟩, ⟨(-25), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6777, 6780⟩, ⟨2696, 2699⟩, ⟨263, 266⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845400), (-845396)⟩, ⟨2696, 2699⟩, ⟨263, 266⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-486728), (-486725)⟩, ⟨(-193140), (-193136)⟩, ⟨(-18699), (-18693)⟩, ⟨120, 125⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35304666, 35304670⟩, ⟨(-193140), (-193136)⟩, ⟨(-18699), (-18693)⟩, ⟨120, 125⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20326192, 20326195⟩, ⟨8019278, 8019283⟩, ⟨757801, 757808⟩, ⟨(-8686), (-8679)⟩, ⟨(-402), (-396)⟩⟩
...
def j33 : Jet := ⟨⟨(-695501691), (-695501687)⟩, ⟨8019278, 8019283⟩, ⟨757801, 757808⟩, ⟨(-8686), (-8679)⟩, ⟨(-402), (-396)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-400425862), (-400425857)⟩, ⟨(-155553354), (-155553346)⟩, ⟨(-13733945), (-13733937)⟩, ⟨354195, 354204⟩, ⟨15218, 15227⟩⟩
...
def j36 : Jet := ⟨⟨3894541434, 3894541439⟩, ⟨(-155553354), (-155553346)⟩, ⟨(-13733945), (-13733937)⟩, ⟨354195, 354204⟩, ⟨15218, 15227⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1025031958, 1025031964⟩, ⟨181001920, 181001928⟩, ⟨(-7002081), (-7002072)⟩, ⟨(-401244), (-401234)⟩, ⟨9534, 9542⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4736563819, 4736563826⟩, ⟨189184877, 189184890⟩, ⟨24259596, 24259610⟩, ⟨1205326, 1205343⟩, ⟨97965, 97983⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1130422876, 1130422885⟩, ⟨244762676, 244762690⟩, ⟨6040530, 6040547⟩, ⟨559101, 559120⟩, ⟨27463, 27483⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1037341977), (-1037341976)⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3257625319, 3257625320⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨297524006, 297524012⟩, ⟨128841646, 128841656⟩, ⟨17128294, 17128309⟩, ⟨982784, 982800⟩, ⟨86675, 86692⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4592491302, 4592491308⟩, ⟨128841646, 128841656⟩, ⟨17128294, 17128309⟩, ⟨982784, 982800⟩, ⟨86675, 86692⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4441238560, 4441238564⟩, ⟨62299136, 62299142⟩, ⟨7845140, 7845148⟩, ⟨365159, 365170⟩, ⟨29858, 29869⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3368568415, 3368568421⟩, ⟨(-167281693), (-167281686)⟩, ⟨2940981, 2940990⟩, ⟨(-101997), (-101986)⟩, ⟨5006, 5016⟩⟩
...
def j47 : Jet := ⟨⟨5089558323, 5089558331⟩, ⟨1017911663, 1017911669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6031152774, 6031152794⟩, ⟨2412461104, 2412461124⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6031152774, 6031152794⟩, ⟨2412461104, 2412461124⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6031152794), (-6031152774)⟩, ⟨(-2412461124), (-2412461104)⟩, ⟨(-241246114), (-241246110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3015576397), (-3015576387)⟩, ⟨(-1206230562), (-1206230552)⟩, ⟨(-120623057), (-120623055)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2128303847, 2128303861⟩, ⟨(-597728687), (-597728678)⟩, ⟨24162413, 24162418⟩, ⟨8929386, 8929388⟩, ⟨(-966247), (-966246)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1669241375, 1669241390⟩, ⟨(-551695995), (-551695981)⟩, ⟨43688598, 43688610⟩, ⟨5602443, 5602457⟩, ⟨(-1072401), (-1072389)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨829873580, 1244810372⟩, ⟨207468395, 207468396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2607124742, 3910687120⟩, ⟨651781185, 651781189⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1582573033, 3560789338⟩, ⟨791286514, 1186929784⟩, ⟨98910814, 98910816⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨396, 893⟩, ⟨198, 298⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94291), (-93793)⟩, ⟨198, 298⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-78173), (-34560)⟩, ⟨(-25986), (-17032)⟩, ⟨(-2128), (-2056)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5034883, 5078497⟩, ⟨(-25986), (-17032)⟩, ⟨(-2128), (-2056)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1855210, 4210384⟩, ⟨906061, 1397187⟩, ⟨107003, 113062⟩, ⟨(-1186), (-758)⟩, ⟨(-49), (-42)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141310367), (-138955192)⟩, ⟨906061, 1397187⟩, ⟨107003, 113062⟩, ⟨(-1186), (-758)⟩, ⟨(-49), (-42)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-117154897), (-51201027)⟩, ⟨(-38717776), (-24442159)⟩, ⟨(-3047948), (-2720210)⟩, ⟨39595, 63144⟩, ⟨2095, 2450⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1314500868, 1380454739⟩, ⟨(-38717776), (-24442159)⟩, ⟨(-3047948), (-2720210)⟩, ⟨39595, 63144⟩, ⟨2095, 2450⟩⟩
...
def j72 : Jet := ⟨⟨4327, 9781⟩, ⟨2138, 3254⟩, ⟨258, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847850), (-842395)⟩, ⟨2138, 3254⟩, ⟨258, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-702920), (-310398)⟩, ⟨(-233520), (-152501)⟩, ⟨(-19038), (-18275)⟩, ⟨94, 150⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35088474, 35480997⟩, ⟨(-233520), (-152501)⟩, ⟨(-19038), (-18275)⟩, ⟨94, 150⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12929102, 29415907⟩, ⟨6270948, 9749111⟩, ⟨727749, 782280⟩, ⟨(-10606), (-6753)⟩, ⟨(-421), (-372)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702898781), (-686411975)⟩, ⟨6270948, 9749111⟩, ⟨727749, 782280⟩, ⟨(-10606), (-6753)⟩, ⟨(-421), (-372)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-582745878), (-252923248)⟩, ⟨(-191937962), (-118379016)⟩, ⟨(-14763900), (-12464941)⟩, ⟨269699, 438215⟩, ⟨13477, 16635⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3712221418, 4042044048⟩, ⟨(-191937962), (-118379016)⟩, ⟨(-14763900), (-12464941)⟩, ⟨269699, 438215⟩, ⟨13477, 16635⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨797926386, 1256942416⟩, ⟨164227984, 194653561⟩, ⟨(-8650844), (-5360427)⟩, ⟨(-438507), (-355309)⟩, ⟨7279, 11814⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4563716737, 4969192836⟩, ⟨133657201, 256928842⟩, ⟨17988092, 33047348⟩, ⟨400257, 2398966⟩, ⟨18886, 229194⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨847855117, 1454257698⟩, ⟨199335301, 300401786⟩, ⟨(-1556308), 15619971⟩, ⟨(-262670), 1655465⟩, ⟨(-66250), 155962⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1244810372), (-829873580)⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3050156924, 3465093716⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨167372240, 492405485⟩, ⟨78700228, 203429540⟩, ⟨8197503, 31588637⟩, ⟨(-395584), 3306076⟩, ⟨(-87268), 394001⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4462339536, 4787372781⟩, ⟨78700228, 203429540⟩, ⟨8197503, 31588637⟩, ⟨(-395584), 3306076⟩, ⟨(-87268), 394001⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4377853626, 4534491100⟩, ⟨37271536, 99788995⟩, ⟨2784233, 15336625⟩, ⟨(-543632), 1598038⟩, ⟨(-106098), 204778⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3109020308, 3658336731⟩, ⟨(-192569468), (-130964453)⟩, ⟨(-2843030), 10572882⟩, ⟨(-1179428), 1154774⟩, ⟨(-162792), 191472⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4071646655, 6107469995⟩, ⟨1017911663, 1017911669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3859937769, 8684860017⟩, ⟨1929968882, 2894953348⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3859937769, 8684860017⟩, ⟨1929968882, 2894953348⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8684860017), (-3859937769)⟩, ⟨(-2894953348), (-1929968882)⟩, ⟨(-241246114), (-241246110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4342430009), (-1929968884)⟩, ⟨(-1447476674), (-964984441)⟩, ⟨(-120623057), (-120623055)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1562665729, 2740356564⟩, ⟨(-923546545), (-351096530)⟩, ⟨(-37520389), 111738343⟩, ⟨(-5978934), 21506715⟩, ⟨(-3381104), 1030626⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1131174966, 2334161446⟩, ⟨(-909518744), (-301799713)⟩, ⟨(-23066991), 143329804⟩, ⟨(-13128612), 21349232⟩, ⟨(-4288753), 1796778⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1037341976, 1037341977⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4441238560, 4441238564⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified278
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨829873580, 1244810372⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4377853626, 4534491100⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified279
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (162707047 / 4294967296)

theorem envelope_integral : (∫ s in ((9661 / 50000) : ℝ)..(28983 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((9661 / 50000) : ℝ)..(28983 / 100000), prawitzNormalCorrection
