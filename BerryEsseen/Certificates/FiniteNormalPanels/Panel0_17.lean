...
namespace FiniteNormalPanel0_17
...
def j2 : Jet := ⟨⟨5233999923, 5233999928⟩, ⟨402615377, 402615381⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨6378338484, 6378338497⟩, ⟨981282838, 981282852⟩, ⟨37741647, 37741649⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1596, 1598⟩, ⟨245, 246⟩, ⟨9, 10⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93091), (-93088)⟩, ⟨245, 246⟩, ⟨9, 10⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-138247), (-138242)⟩, ⟨(-20906), (-20902)⟩, ⟨(-751), (-746)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4974809, 4974815⟩, ⟨(-20906), (-20902)⟩, ⟨(-751), (-746)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨7387952, 7387962⟩, ⟨1105561, 1105570⟩, ⟨37822, 37834⟩, ⟨(-351), (-344)⟩, ⟨(-7), (-2)⟩⟩
...
def j16 : Jet := ⟨⟨(-135777625), (-135777614)⟩, ⟨1105561, 1105570⟩, ⟨37822, 37834⟩, ⟨(-351), (-344)⟩, ⟨(-7), (-2)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-201639639), (-201639621)⟩, ⟨(-29379646), (-29379628)⟩, ⟨(-884376), (-884353)⟩, ⟨17834, 17851⟩, ⟨240, 253⟩⟩
...
def j19 : Jet := ⟨⟨1230016126, 1230016145⟩, ⟨(-29379646), (-29379628)⟩, ⟨(-884376), (-884353)⟩, ⟨17834, 17851⟩, ⟨240, 253⟩⟩
...
def j22 : Jet := ⟨⟨(-161), (-158)⟩, ⟨(-25), (-24)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11674, 11678⟩, ⟨(-25), (-24)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨17336, 17343⟩, ⟨2629, 2634⟩, ⟨94, 98⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-834841), (-834833)⟩, ⟨2629, 2634⟩, ⟨94, 98⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1239800), (-1239787)⟩, ⟨(-186835), (-186824)⟩, ⟨(-6598), (-6588)⟩, ⟨41, 47⟩, ⟨(-3), 1⟩⟩
...
def j30 : Jet := ⟨⟨34551594, 34551608⟩, ⟨(-186835), (-186824)⟩, ⟨(-6598), (-6588)⟩, ⟨41, 47⟩, ⟨(-3), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨51311627, 51311649⟩, ⟨7616632, 7616653⟩, ⟨251133, 251153⟩, ⟨(-3090), (-3076)⟩, ⟨(-54), (-44)⟩⟩
...
def j33 : Jet := ⟨⟨(-664516256), (-664516233)⟩, ⟨7616632, 7616653⟩, ⟨251133, 251153⟩, ⟨(-3090), (-3076)⟩, ⟨(-54), (-44)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-986854923), (-986854886)⟩, ⟨(-140512585), (-140512543)⟩, ⟨(-3726237), (-3726198)⟩, ⟨119718, 119745⟩, ⟨1419, 1440⟩⟩
...
def j36 : Jet := ⟨⟨3308112373, 3308112410⟩, ⟨(-140512585), (-140512543)⟩, ⟨(-3726237), (-3726198)⟩, ⟨119718, 119745⟩, ⟨1419, 1440⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1498941403, 1498941429⟩, ⟨79500102, 79500129⟩, ⟨(-3831817), (-3831785)⟩, ⟨(-61170), (-61146)⟩, ⟨1963, 1983⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5576214404, 5576214468⟩, ⟨236850495, 236850574⟩, ⟨16341204, 16341281⟩, ⟨759033, 759089⟩, ⟨39644, 39690⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1946095992, 1946096049⟩, ⟨185876764, 185876831⟩, ⟨5112286, 5112361⟩, ⟨276650, 276708⟩, ⟨12478, 12529⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1666033921), (-1666033920)⟩, ⟨(-128156456), (-128156455)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2628933375, 2628933376⟩, ⟨(-128156456), (-128156455)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨881797077, 881797130⟩, ⟨168445530, 168445598⟩, ⟨12677200, 12677277⟩, ⟨693202, 693264⟩, ⟨41335, 41394⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5176764373, 5176764426⟩, ⟨168445530, 168445598⟩, ⟨12677200, 12677277⟩, ⟨693202, 693264⟩, ⟨41335, 41394⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4715297835, 4715297861⟩, ⟨76714988, 76715020⟩, ⟨5149511, 5149548⟩, ⟨231923, 231954⟩, ⟨12238, 12268⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2886216121, 2886216139⟩, ⟨(-93741639), (-93741615)⟩, ⟨862915, 862941⟩, ⟨(-11698), (-11675)⟩, ⟨568, 590⟩⟩
...
def j47 : Jet := ⟨⟨4888426746, 4888426751⟩, ⟨376032825, 376032829⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5563887779, 5563887791⟩, ⟨855982730, 855982742⟩, ⟨32922412, 32922414⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5563887779, 5563887791⟩, ⟨855982730, 855982742⟩, ⟨32922412, 32922414⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5563887791), (-5563887779)⟩, ⟨(-855982742), (-855982730)⟩, ⟨(-32922414), (-32922412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2781943896), (-2781943889)⟩, ⟨(-427991371), (-427991365)⟩, ⟨(-16461207), (-16461206)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2247283496, 2247283510⟩, ⟨(-223940693), (-223940687)⟩, ⟨2544685, 2544687⟩, ⟨487668, 487670⟩, ⟨(-17026), (-17025)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1510173514, 1510173533⟩, ⟨(-199537092), (-199537073)⟩, ⟨7049246, 7049266⟩, ⟨221056, 221075⟩, ⟨(-20670), (-20652)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1537877464, 1794190376⟩, ⟨128156455, 128156456⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4831384542, 5636615305⟩, ⟨402615377, 402615381⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨5434797283, 7397362985⟩, ⟨905799542, 1056766148⟩, ⟨37741647, 37741649⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1360, 1854⟩, ⟨226, 265⟩, ⟨9, 10⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93327), (-92832)⟩, ⟨226, 265⟩, ⟨9, 10⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-160741), (-117468)⟩, ⟨(-22678), (-19121)⟩, ⟨(-763), (-731)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4952315, 4995589⟩, ⟨(-22678), (-19121)⟩, ⟨(-763), (-731)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨6266596, 8604067⟩, ⟨1005372, 1204958⟩, ⟨36623, 38943⟩, ⟨(-386), (-311)⟩, ⟨(-7), (-2)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-136898981), (-134561509)⟩, ⟨1005372, 1204958⟩, ⟨36623, 38943⟩, ⟨(-386), (-311)⟩, ⟨(-7), (-2)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-235785604), (-170272431)⟩, ⟨(-32411473), (-26303399)⟩, ⟨(-944616), (-818897)⟩, ⟨15892, 19778⟩, ⟨213, 276⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1195870161, 1261383335⟩, ⟨(-32411473), (-26303399)⟩, ⟨(-944616), (-818897)⟩, ⟨15892, 19778⟩, ⟨213, 276⟩⟩
...
def j70 : Jet := ⟨⟨(-187), (-135)⟩, ⟨(-27), (-22)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11648, 11701⟩, ⟨(-27), (-22)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨14739, 20154⟩, ⟨2409, 2853⟩, ⟨93, 99⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-837438), (-832022)⟩, ⟨2409, 2853⟩, ⟨93, 99⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1442347), (-1052830)⟩, ⟨(-203002), (-170557)⟩, ⟨(-6734), (-6438)⟩, ⟨36, 51⟩, ⟨(-3), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34349047, 34738565⟩, ⟨(-203002), (-170557)⟩, ⟨(-6734), (-6438)⟩, ⟨36, 51⟩, ⟨(-3), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨43464849, 59831370⟩, ⟨6894503, 8331519⟩, ⟨240291, 261147⟩, ⟨(-3396), (-2767)⟩, ⟨(-59), (-41)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-672363034), (-655996512)⟩, ⟨6894503, 8331519⟩, ⟨240291, 261147⟩, ⟨(-3396), (-2767)⟩, ⟨(-59), (-41)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1158032897), (-830089687)⟩, ⟨(-156709057), (-123998631)⟩, ⟨(-4150235), (-3264778)⟩, ⟨105410, 133967⟩, ⟨1173, 1661⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3136934399, 3464877609⟩, ⟨(-156709057), (-123998631)⟩, ⟨(-4150235), (-3264778)⟩, ⟨105410, 133967⟩, ⟨1173, 1661⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1345227614, 1655410187⟩, ⟨69566235, 88655041⟩, ⟨(-4277984), (-3386884)⟩, ⟨(-70674), (-50807)⟩, ⟨1728, 2218⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5323923715, 5880500428⟩, ⟨190528879, 293766960⟩, ⟨11834976, 22455493⟩, ⟨375699, 1331553⟩, ⟨10416, 87836⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1667507271, 2266522570⟩, ⟨145907987, 234609662⟩, ⟨935612, 10520562⟩, ⟨(-80007), 763516⟩, ⟨(-15713), 52793⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1794190376), (-1537877464)⟩, ⟨(-128156456), (-128156455)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2500776920, 2757089832⟩, ⟨(-128156456), (-128156455)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨647404347, 1196080018⟩, ⟨113296614, 247614504⟩, ⟨5683260, 23919129⟩, ⟨(-20874), 1955198⟩, ⟨(-25125), 164905⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4942371643, 5491047314⟩, ⟨113296614, 247614504⟩, ⟨5683260, 23919129⟩, ⟨(-20874), 1955198⟩, ⟨(-25125), 164905⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4607312076, 4856322543⟩, ⟨50100178, 115413953⟩, ⟨1141711, 10876391⟩, ⟨(-282186), 898911⟩, ⟨(-47068), 83791⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2682642010, 3117443413⟩, ⟨(-115735391), (-63388176)⟩, ⟨(-2779040), 5487011⟩, ⟨(-505684), 542976⟩, ⟨(-57038), 62210⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4512393918, 5264459576⟩, ⟨376032825, 376032829⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4740827454, 6452792936⟩, ⟨790137904, 921827568⟩, ⟨32922412, 32922414⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4740827454, 6452792936⟩, ⟨790137904, 921827568⟩, ⟨32922412, 32922414⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6452792936), (-4740827454)⟩, ⟨(-921827568), (-790137904)⟩, ⟨(-32922414), (-32922412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3226396468), (-2370413727)⟩, ⟨(-460913784), (-395068952)⟩, ⟨(-16461207), (-16461206)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2026357755, 2473264629⟩, ⟨(-265418031), (-186392812)⟩, ⟨(-906624), 6475282⟩, ⟨244623, 710606⟩, ⟨(-31474), (-3887)⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1265665618, 1795185387⟩, ⟨(-259296490), (-146327612)⟩, ⟨492540, 15011855⟩, ⟨(-651981), 1024627⟩, ⟨(-112585), 69310⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4715297835, 4715297861⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified6
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4607312076, 4856322543⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified7
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (22566109 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((71613 / 200000) : ℝ)..(167097 / 400000), prawitzNormalCorrection
