...
namespace FiniteNormalPanel162_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3273 / 100000)
def radius : Rat := (3273 / 100000)

def j0 : Jet := ⟨⟨140574279, 140574280⟩, ⟨140574279, 140574280⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨441627122, 441627126⟩, ⟨441627122, 441627126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨45410011, 45410013⟩, ⟨90820022, 90820026⟩, ⟨45410011, 45410013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨11, 12⟩, ⟨22, 23⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94676), (-94674)⟩, ⟨22, 23⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1001), (-1000)⟩, ⟨(-2002), (-2000)⟩, ⟨(-1001), (-998)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112055, 5112057⟩, ⟨(-2002), (-2000)⟩, ⟨(-1001), (-998)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨54048, 54049⟩, ⟨108075, 108077⟩, ⟨53994, 53997⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143111529), (-143111527)⟩, ⟨108075, 108077⟩, ⟨53994, 53997⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1513096), (-1513095)⟩, ⟨(-3025050), (-3025048)⟩, ⟨(-1510241), (-1510238)⟩, ⟨2282, 2285⟩, ⟨568, 571⟩⟩
...
def j19 : Jet := ⟨⟨1430142669, 1430142671⟩, ⟨(-3025050), (-3025048)⟩, ⟨(-1510241), (-1510238)⟩, ⟨2282, 2285⟩, ⟨568, 571⟩⟩
...
def j25 : Jet := ⟨⟨125, 126⟩, ⟨249, 251⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852052), (-852050)⟩, ⟨249, 251⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9009), (-9008)⟩, ⟨(-18016), (-18014)⟩, ⟨(-9003), (-9000)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782385, 35782387⟩, ⟨(-18016), (-18014)⟩, ⟨(-9003), (-9000)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨378321, 378322⟩, ⟨756452, 756454⟩, ⟨377844, 377847⟩, ⟨(-382), (-379)⟩, ⟨(-97), (-93)⟩⟩
...
def j33 : Jet := ⟨⟨(-715449562), (-715449560)⟩, ⟨756452, 756454⟩, ⟨377844, 377847⟩, ⟨(-382), (-379)⟩, ⟨(-97), (-93)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7564336), (-7564335)⟩, ⟨(-15120675), (-15120672)⟩, ⟨(-7544347), (-7544344)⟩, ⟨15981, 15984⟩, ⟨3983, 3987⟩⟩
...
def j36 : Jet := ⟨⟨4287402960, 4287402961⟩, ⟨(-15120675), (-15120672)⟩, ⟨(-7544347), (-7544344)⟩, ⟨15981, 15984⟩, ⟨3983, 3987⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨147053457, 147053460⟩, ⟨146742408, 146742412⟩, ⟨(-466339), (-466337)⟩, ⟨(-155056), (-155054)⟩, ⟨292, 294⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302544976, 4302544978⟩, ⟨15174073, 15174078⟩, ⟨7624503, 7624509⟩, ⟨37549, 37556⟩, ⟨9488, 9497⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨147312905, 147312909⟩, ⟨147520845, 147520852⟩, ⟨312328, 312334⟩, ⟨104806, 104812⟩, ⟨522, 531⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-140574280), (-140574279)⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4154393016, 4154393017⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5052679, 5052680⟩, ⟨10119622, 10119624⟩, ⟨5088377, 5088381⟩, ⟨28642, 28646⟩, ⟨7254, 7263⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300019975, 4300019976⟩, ⟨10119622, 10119624⟩, ⟨5088377, 5088381⟩, ⟨28642, 28646⟩, ⟨7254, 7263⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297492892, 4297492894⟩, ⟨5056837, 5056839⟩, ⟨2539718, 2539721⟩, ⟨11323, 11327⟩, ⟨2860, 2867⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4156835949, 4156835953⟩, ⟨(-135765617), (-135765612)⟩, ⟨2291082, 2291086⟩, ⟨(-72174), (-72167)⟩, ⟨2395, 2404⟩⟩
...
def j47 : Jet := ⟨⟨1389695767, 1389695778⟩, ⟨1389695767, 1389695778⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨449655187, 449655195⟩, ⟨899310374, 899310390⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨449655187, 449655195⟩, ⟨899310374, 899310390⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-449655195), (-449655187)⟩, ⟨(-899310390), (-899310374)⟩, ⟨(-449655195), (-449655187)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-224827598), (-224827593)⟩, ⟨(-449655195), (-449655187)⟩, ⟨(-224827598), (-224827593)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4075922847, 4075922852⟩, ⟨(-426722664), (-426722655)⟩, ⟨(-191023787), (-191023780)⟩, ⟨21558013, 21558015⟩, ⟨4435491, 4435492⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3944836234, 3944836244⟩, ⟨(-541840284), (-541840267)⟩, ⟨(-169217124), (-169217110)⟩, ⟨26606895, 26606908⟩, ⟨3518925, 3518940⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 281148560⟩, ⟨140574279, 140574280⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 883254251⟩, ⟨441627122, 441627126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 181640050⟩, ⟨0, 181640050⟩, ⟨45410011, 45410013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 46⟩, ⟨0, 46⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94640)⟩, ⟨0, 46⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4005), 0⟩, ⟨(-4005), 2⟩, ⟨(-1002), (-997)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109051, 5113057⟩, ⟨(-4005), 2⟩, ⟨(-1002), (-997)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 216239⟩, ⟨(-170), 216240⟩, ⟨53804, 54061⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142949337)⟩, ⟨(-170), 216240⟩, ⟨53804, 54061⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6054669), 0⟩, ⟨(-6054677), 9146⟩, ⟨(-1513676), (-1499947)⟩, ⟨(-6), 4575⟩, ⟨563, 573⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425601096, 1431655766⟩, ⟨(-6054677), 9146⟩, ⟨(-1513676), (-1499947)⟩, ⟨(-6), 4575⟩, ⟨563, 573⟩⟩
...
def j72 : Jet := ⟨⟨0, 501⟩, ⟨(-1), 501⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851675)⟩, ⟨(-1), 501⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-36040), 0⟩, ⟨(-36041), 22⟩, ⟨(-9011), (-8976)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35755354, 35791395⟩, ⟨(-36041), 22⟩, ⟨(-9011), (-8976)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1513668⟩, ⟨(-1525), 1513669⟩, ⟨376128, 378418⟩, ⟨(-765), 2⟩, ⟨(-98), (-92)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714314214)⟩, ⟨(-1525), 1513669⟩, ⟨376128, 378418⟩, ⟨(-765), 2⟩, ⟨(-98), (-92)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30273342), 0⟩, ⟨(-30273407), 64016⟩, ⟨(-7568401), (-7472311)⟩, ⟨(-50), 32009⟩, ⟨3938, 4002⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264693954, 4294967296⟩, ⟨(-30273407), 64016⟩, ⟨(-7568401), (-7472311)⟩, ⟨(-50), 32009⟩, ⟨3938, 4002⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 294418084⟩, ⟨145341336, 147210924⟩, ⟨(-933855), 941⟩, ⟨(-155645), (-153290)⟩, ⟨(-1), 589⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4325455537⟩, ⟨(-64929), 30704731⟩, ⟨7471853, 7894195⟩, ⟨(-32701), 110581⟩, ⟨8508, 10831⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 296508040⟩, ⟨145336885, 150360711⟩, ⟨(-942711), 1594504⟩, ⟨87177, 124882⟩, ⟨(-3953), 5133⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-281148560), 0⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4013818736, 4294967296⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20469776⟩, ⟨0, 20760652⟩, ⟨4787873, 5484074⟩, ⟨(-66006), 128888⟩, ⟨5002, 10046⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315437072⟩, ⟨0, 20760652⟩, ⟨4787873, 5484074⟩, ⟨(-66006), 128888⟩, ⟨5002, 10046⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305190019⟩, ⟨0, 10380326⟩, ⟨2375737, 2742037⟩, ⟨(-39631), 64444⟩, ⟨1466, 4462⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4013818736, 4305190019⟩, ⟨(-140908870), (-130193953)⟩, ⟨1880472, 2742037⟩, ⟨(-129378), (-13313)⟩, ⟨(-740), 5760⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2779391555⟩, ⟨1389695767, 1389695778⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1798620778⟩, ⟨0, 1798620778⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1798620778⟩, ⟨0, 1798620778⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1798620778), 0⟩, ⟨(-1798620778), 0⟩, ⟨(-449655195), (-449655187)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-899310389), 0⟩, ⟨(-899310389), 0⟩, ⟨(-224827598), (-224827593)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3483567540, 4294967296⟩, ⟨(-899310389), 0⟩, ⟨(-224827598), (-88201490)⟩, ⟨0, 47075981⟩, ⟨(-155745), 5884498⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3255533208, 4305190019⟩, ⟨(-1042359765), (-105597877)⟩, ⟨(-223837510), (-50181295)⟩, ⟨1970139, 54553356⟩, ⟨(-1844858), 5892739⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨140574279, 140574280⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297492892, 4297492894⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3282
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 281148560⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305190019⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3283
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (254613811 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(3273 / 50000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (3273 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(3273 / 50000), prawitzNormalCorrection
