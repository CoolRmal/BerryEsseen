...
namespace FiniteNormalPanel155_10
...
def j2 : Jet := ⟨⟨433699963, 433699967⟩, ⟨433699963, 433699967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨43794433, 43794434⟩, ⟨87588866, 87588868⟩, ⟨43794433, 43794434⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-966), (-965)⟩, ⟨(-1931), (-1929)⟩, ⟨(-966), (-963)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112090, 5112092⟩, ⟨(-1931), (-1929)⟩, ⟨(-966), (-963)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨52126, 52127⟩, ⟨104232, 104234⟩, ⟨52076, 52079⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143113451), (-143113449)⟩, ⟨104232, 104234⟩, ⟨52076, 52079⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1459283), (-1459282)⟩, ⟨(-2917504), (-2917502)⟩, ⟨(-1456627), (-1456624)⟩, ⟨2123, 2126⟩, ⟨529, 532⟩⟩
...
def j19 : Jet := ⟨⟨1430196482, 1430196484⟩, ⟨(-2917504), (-2917502)⟩, ⟨(-1456627), (-1456624)⟩, ⟨2123, 2126⟩, ⟨529, 532⟩⟩
...
def j28 : Jet := ⟨⟨(-8689), (-8688)⟩, ⟨(-17375), (-17373)⟩, ⟨(-8684), (-8681)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782705, 35782707⟩, ⟨(-17375), (-17373)⟩, ⟨(-8684), (-8681)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨364865, 364866⟩, ⟨729552, 729554⟩, ⟨364421, 364424⟩, ⟨(-356), (-353)⟩, ⟨(-90), (-86)⟩⟩
...
def j33 : Jet := ⟨⟨(-715463018), (-715463016)⟩, ⟨729552, 729554⟩, ⟨364421, 364424⟩, ⟨(-356), (-353)⟩, ⟨(-90), (-86)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7295352), (-7295351)⟩, ⟨(-14583265), (-14583263)⟩, ⟨(-7276759), (-7276756)⟩, ⟨14866, 14869⟩, ⟨3706, 3709⟩⟩
...
def j36 : Jet := ⟨⟨4287671944, 4287671945⟩, ⟨(-14583265), (-14583263)⟩, ⟨(-7276759), (-7276756)⟩, ⟨14866, 14869⟩, ⟨3706, 3709⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨144419297, 144419300⟩, ⟨144124691, 144124695⟩, ⟨(-441695), (-441692)⟩, ⟨(-146875), (-146872)⟩, ⟨267, 269⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302275059, 4302275061⟩, ⟨14632931, 14632935⟩, ⟨7351308, 7351314⟩, ⟨34915, 34922⟩, ⟨8819, 8827⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨144665022, 144665026⟩, ⟨144861950, 144861956⟩, ⟨295774, 295780⟩, ⟨99229, 99236⟩, ⟨476, 483⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-138050987), (-138050986)⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4156916309, 4156916310⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4872672, 4872673⟩, ⟨9758610, 9758612⟩, ⟨4905871, 4905874⟩, ⟨26634, 26640⟩, ⟨6744, 6751⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299839968, 4299839969⟩, ⟨9758610, 9758612⟩, ⟨4905871, 4905874⟩, ⟨26634, 26640⟩, ⟨6744, 6751⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297402941, 4297402942⟩, ⟨4876539, 4876541⟩, ⟨2448778, 2448781⟩, ⟨10530, 10535⟩, ⟨2659, 2665⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4159273666, 4159273669⟩, ⟨(-133409481), (-133409476)⟩, ⟨2213323, 2213328⟩, ⟨(-68519), (-68512)⟩, ⟨2234, 2242⟩⟩
...
def j47 : Jet := ⟨⟨1670040654, 1670040667⟩, ⟨1670040654, 1670040667⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨649372997, 649373008⟩, ⟨1298745994, 1298746016⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨649372997, 649373008⟩, ⟨1298745994, 1298746016⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-649373008), (-649372997)⟩, ⟨(-1298746016), (-1298745994)⟩, ⟨(-649373008), (-649372997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-324686504), (-324686498)⟩, ⟨(-649373008), (-649372997)⟩, ⟨(-324686504), (-324686498)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3982249948, 3982249955⟩, ⟨(-602092043), (-602092031)⟩, ⟨(-255529691), (-255529682)⟩, ⟨43222399, 43222402⟩, ⟨8024892, 8024894⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3856436195, 3856436206⟩, ⟨(-706765681), (-706765662)⟩, ⟨(-226702340), (-226702322)⟩, ⟨49420253, 49420269⟩, ⟨6308781, 6308797⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 276101973⟩, ⟨138050986, 138050987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 867399931⟩, ⟨433699963, 433699967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 175177735⟩, ⟨0, 175177736⟩, ⟨43794433, 43794434⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3862), 0⟩, ⟨(-3862), 2⟩, ⟨(-966), (-962)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109194, 5113057⟩, ⟨(-3862), 2⟩, ⟨(-966), (-962)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 208545⟩, ⟨(-158), 208546⟩, ⟨51898, 52138⟩, ⟨(-80), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142957031)⟩, ⟨(-158), 208546⟩, ⟨51898, 52138⟩, ⟨(-80), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5839258), 0⟩, ⟨(-5839265), 8506⟩, ⟨(-1459822), (-1447054)⟩, ⟨(-6), 4255⟩, ⟨524, 533⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425816507, 1431655766⟩, ⟨(-5839265), 8506⟩, ⟨(-1459822), (-1447054)⟩, ⟨(-6), 4255⟩, ⟨524, 533⟩⟩
...
def j72 : Jet := ⟨⟨0, 483⟩, ⟨(-1), 483⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851693)⟩, ⟨(-1), 483⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-34758), 0⟩, ⟨(-34759), 20⟩, ⟨(-8691), (-8659)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35756636, 35791395⟩, ⟨(-34759), 20⟩, ⟨(-8691), (-8659)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1459815⟩, ⟨(-1418), 1459816⟩, ⟨362826, 364955⟩, ⟨(-711), 2⟩, ⟨(-91), (-86)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714368067)⟩, ⟨(-1418), 1459816⟩, ⟨362826, 364955⟩, ⟨(-711), 2⟩, ⟨(-91), (-86)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-29196290), 0⟩, ⟨(-29196348), 59542⟩, ⟨(-7299131), (-7209758)⟩, ⟨(-44), 29773⟩, ⟨3666, 3723⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4265771006, 4294967296⟩, ⟨(-29196348), 59542⟩, ⟨(-7299131), (-7209758)⟩, ⟨(-44), 29773⟩, ⟨3666, 3723⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 289133311⟩, ⟨142797730, 144568374⟩, ⟨(-884464), 859⟩, ⟨(-147413), (-145261)⟩, ⟨(-1), 538⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4324363415⟩, ⟨(-60361), 29597375⟩, ⟨7209347, 7601964⟩, ⟨(-30393), 102721⟩, ⟨7939, 10023⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 291112232⟩, ⟨142793666, 147550315⟩, ⟨(-892550), 1508870⟩, ⟨83130, 117550⟩, ⟨(-3608), 4680⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-276101973), 0⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4018865323, 4294967296⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19731543⟩, ⟨0, 20001876⟩, ⟨4626430, 5273521⟩, ⟨(-61326), 119610⟩, ⟨4722, 9245⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314698839⟩, ⟨0, 20001876⟩, ⟨4626430, 5273521⟩, ⟨(-61326), 119610⟩, ⟨4722, 9245⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304821763⟩, ⟨0, 10000938⟩, ⟨2296302, 2636761⟩, ⟨(-36803), 59805⟩, ⟨1408, 4095⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4018865323, 4304821763⟩, ⟨(-138367735), (-128050048)⟩, ⟨1827228, 2636761⟩, ⟨(-121556), (-14003)⟩, ⟨(-606), 5278⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3340081321⟩, ⟨1670040654, 1670040667⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2597492010⟩, ⟨0, 2597492020⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2597492010⟩, ⟨0, 2597492020⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2597492010), 0⟩, ⟨(-2597492020), 0⟩, ⟨(-649373008), (-649372997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1298746005), 0⟩, ⟨(-1298746010), 0⟩, ⟨(-324686504), (-324686498)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3174201397, 4294967296⟩, ⟨(-1298746010), 0⟩, ⟨(-324686504), (-43597476)⟩, ⟨0, 98181261⟩, ⟨(-5774288), 12272658⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2970147859, 4304821763⟩, ⟨(-1440093617), (-94635561)⟩, ⟨(-324081057), 3682674⟩, ⟨380933, 108856365⟩, ⟨(-9150507), 12324306⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297402941, 4297402942⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3130
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304821763⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3131
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (243211603 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(12857 / 200000), prawitzNormalCorrection
