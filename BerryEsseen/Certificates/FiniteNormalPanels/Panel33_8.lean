...
namespace FiniteNormalPanel33_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (9647 / 40000)
def radius : Rat := (9647 / 200000)

def j0 : Jet := ⟨⟨1035838737, 1035838738⟩, ⟨207167747, 207167748⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3254183366, 3254183370⟩, ⟨650836672, 650836676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2465608850, 2465608858⟩, ⟨986243538, 986243546⟩, ⟨98624353, 98624355⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨617, 618⟩, ⟨246, 248⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94070), (-94068)⟩, ⟨246, 248⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-54003), (-54001)⟩, ⟨(-21461), (-21457)⟩, ⟨(-2092), (-2088)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5059053, 5059056⟩, ⟨(-21461), (-21457)⟩, ⟨(-2092), (-2088)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2904246, 2904249⟩, ⟨1149377, 1149383⟩, ⟨110039, 110045⟩, ⟨(-969), (-964)⟩, ⟨(-47), (-43)⟩⟩
...
def j16 : Jet := ⟨⟨(-140261331), (-140261327)⟩, ⟨1149377, 1149383⟩, ⟨110039, 110045⟩, ⟨(-969), (-964)⟩, ⟨(-47), (-43)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-80519724), (-80519721)⟩, ⟨(-31548068), (-31548062)⟩, ⟨(-2893691), (-2893683)⟩, ⟨51103, 51111⟩, ⟨2276, 2282⟩⟩
...
def j19 : Jet := ⟨⟨1351136041, 1351136045⟩, ⟨(-31548068), (-31548062)⟩, ⟨(-2893691), (-2893683)⟩, ⟨51103, 51111⟩, ⟨2276, 2282⟩⟩
...
def j22 : Jet := ⟨⟨(-62), (-61)⟩, ⟨(-25), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11773, 11775⟩, ⟨(-25), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6758, 6760⟩, ⟨2688, 2691⟩, ⟨262, 265⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845419), (-845416)⟩, ⟨2688, 2691⟩, ⟨262, 265⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-485330), (-485327)⟩, ⟨(-192589), (-192585)⟩, ⟨(-18647), (-18642)⟩, ⟨119, 123⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35306064, 35306068⟩, ⟨(-192589), (-192585)⟩, ⟨(-18647), (-18642)⟩, ⟨119, 123⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20268127, 20268130⟩, ⟨7996690, 7996695⟩, ⟨755796, 755803⟩, ⟨(-8637), (-8631)⟩, ⟨(-400), (-394)⟩⟩
...
def j33 : Jet := ⟨⟨(-695559756), (-695559752)⟩, ⟨7996690, 7996695⟩, ⟨755796, 755803⟩, ⟨(-8637), (-8631)⟩, ⟨(-400), (-394)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-399299501), (-399299496)⟩, ⟨(-155129147), (-155129140)⟩, ⟨(-13701841), (-13701832)⟩, ⟨352218, 352227⟩, ⟨15141, 15149⟩⟩
...
def j36 : Jet := ⟨⟨3895667795, 3895667800⟩, ⟨(-155129147), (-155129140)⟩, ⟨(-13701841), (-13701832)⟩, ⟨352218, 352227⟩, ⟨15141, 15149⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1023720118, 1023720123⟩, ⟨180840884, 180840893⟩, ⟨(-6973102), (-6973093)⟩, ⟨(-399776), (-399767)⟩, ⟨9467, 9476⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4735194328, 4735194335⟩, ⟨188559871, 188559882⟩, ⟨24163242, 24163257⟩, ⟨1197270, 1197287⟩, ⟨97198, 97214⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1128649734, 1128649742⟩, ⟨244320662, 244320678⟩, ⟨6010926, 6010943⟩, ⟨555883, 555902⟩, ⟨27232, 27253⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1035838738), (-1035838737)⟩, ⟨(-207167748), (-207167747)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3259128558, 3259128559⟩, ⟨(-207167748), (-207167747)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨296591367, 296591372⟩, ⟨128407240, 128407252⟩, ⟨17057415, 17057430⟩, ⟨976020, 976036⟩, ⟨85966, 85983⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4591558663, 4591558668⟩, ⟨128407240, 128407252⟩, ⟨17057415, 17057430⟩, ⟨976020, 976036⟩, ⟨85966, 85983⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4440787576, 4440787579⟩, ⟨62095392, 62095399⟩, ⟨7814514, 7814523⟩, ⟨362714, 362725⟩, ⟨29622, 29633⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3369780631, 3369780636⟩, ⟨(-167081855), (-167081846)⟩, ⟨2934676, 2934685⟩, ⟨(-101698), (-101688)⟩, ⟨4980, 4992⟩⟩
...
def j47 : Jet := ⟨⟨5053442862, 5053442868⟩, ⟨1010688570, 1010688576⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5945862447, 5945862462⟩, ⟨2378344972, 2378344992⟩, ⟨237834496, 237834500⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5945862447, 5945862462⟩, ⟨2378344972, 2378344992⟩, ⟨237834496, 237834500⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5945862462), (-5945862447)⟩, ⟨(-2378344992), (-2378344972)⟩, ⟨(-237834500), (-237834496)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2972931231), (-2972931223)⟩, ⟨(-1189172496), (-1189172486)⟩, ⟨(-118917250), (-118917248)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2149541251, 2149541262⟩, ⟨(-595155952), (-595155943)⟩, ⟨22876542, 22876546⟩, ⟨8874297, 8874299⟩, ⟨(-930968), (-930967)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1686504686, 1686504698⟩, ⟨(-550573307), (-550573293)⟩, ⟨42570028, 42570041⟩, ⟨5615170, 5615182⟩, ⟨(-1043440), (-1043426)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨828670990, 1243006486⟩, ⟨207167747, 207167748⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2603346694, 3905020045⟩, ⟨650836672, 650836676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1577989666, 3550476756⟩, ⟨788994830, 1183492256⟩, ⟨98624353, 98624355⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨394, 890⟩, ⟨197, 297⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94293), (-93796)⟩, ⟨197, 297⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-77949), (-34461)⟩, ⟨(-25911), (-16984)⟩, ⟨(-2122), (-2050)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5035107, 5078596⟩, ⟨(-25911), (-16984)⟩, ⟨(-2122), (-2050)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1849920, 4198272⟩, ⟨903540, 1393185⟩, ⟨106725, 112747⟩, ⟨(-1178), (-753)⟩, ⟨(-48), (-42)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141315657), (-138967304)⟩, ⟨903540, 1393185⟩, ⟨106725, 112747⟩, ⟨(-1178), (-753)⟩, ⟨(-48), (-42)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-116819972), (-51057191)⟩, ⟨(-38608027), (-24376904)⟩, ⟨(-3039807), (-2713973)⟩, ⟨39378, 62784⟩, ⟨2085, 2436⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1314835793, 1380598575⟩, ⟨(-38608027), (-24376904)⟩, ⟨(-3039807), (-2713973)⟩, ⟨39378, 62784⟩, ⟨2085, 2436⟩⟩
...
def j70 : Jet := ⟨⟨(-90), (-39)⟩, ⟨(-30), (-19)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11745, 11797⟩, ⟨(-30), (-19)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4315, 9753⟩, ⟨2132, 3245⟩, ⟨257, 268⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847862), (-842423)⟩, ⟨2132, 3245⟩, ⟨257, 268⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-700894), (-309509)⟩, ⟨(-232849), (-152071)⟩, ⟨(-18985), (-18227)⟩, ⟨93, 149⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35090500, 35481886⟩, ⟨(-232849), (-152071)⟩, ⟨(-18985), (-18227)⟩, ⟨93, 149⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12892402, 29331449⟩, ⟨6253714, 9721279⟩, ⟨725917, 780132⟩, ⟨(-10545), (-6715)⟩, ⟨(-418), (-370)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702935481), (-686496433)⟩, ⟨6253714, 9721279⟩, ⟨725917, 780132⟩, ⟨(-10545), (-6715)⟩, ⟨(-418), (-370)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-581088496), (-252221775)⟩, ⟨(-191398525), (-118074696)⟩, ⟨(-14725823), (-12440225)⟩, ⟨268236, 435729⟩, ⟨13417, 16546⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3713878800, 4042745521⟩, ⟨(-191398525), (-118074696)⟩, ⟨(-14725823), (-12440225)⟩, ⟨268236, 435729⟩, ⟨13417, 16546⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨796973103, 1255251726⟩, ⟨164140535, 194432833⟩, ⟨(-8614275), (-5338991)⟩, ⟨(-436769), (-354177)⟩, ⟨7230, 11729⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4562924868, 4966975249⟩, ⟨133267345, 255978128⟩, ⟨17933185, 32886544⟩, ⟨398509, 2380259⟩, ⟨18902, 226959⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨846695245, 1451653488⟩, ⟨199110111, 299667022⟩, ⟨(-1541353), 15527484⟩, ⟨(-259217), 1642495⟩, ⟨(-65575), 154371⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1243006486), (-828670990)⟩, ⟨(-207167748), (-207167747)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3051960810, 3466296306⟩, ⟨(-207167748), (-207167747)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨166914620, 490643515⟩, ⟨78503780, 202568564⟩, ⟨8188608, 31404520⟩, ⟨(-390312), 3277050⟩, ⟨(-86075), 389689⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4461881916, 4785610811⟩, ⟨78503780, 202568564⟩, ⟨8188608, 31404520⟩, ⟨(-390312), 3277050⟩, ⟨(-86075), 389689⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4377629142, 4533656574⟩, ⟨37185345, 99371753⟩, ⟨2789696, 15247825⟩, ⟨(-537596), 1583890⟩, ⟨(-104736), 202482⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3110699491, 3658932875⟩, ⟨(-192257392), (-130955974)⟩, ⟨(-2810867), 10512275⟩, ⟨(-1169352), 1143735⟩, ⟨(-160928), 189347⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4042754291, 6064131444⟩, ⟨1010688570, 1010688576⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3805351969, 8562041952⟩, ⟨1902675978, 2854013990⟩, ⟨237834496, 237834500⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3805351969, 8562041952⟩, ⟨1902675978, 2854013990⟩, ⟨237834496, 237834500⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8562041952), (-3805351969)⟩, ⟨(-2854013990), (-1902675978)⟩, ⟨(-237834500), (-237834496)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4281020976), (-1902675984)⟩, ⟨(-1427006995), (-951337989)⟩, ⟨(-118917250), (-118917248)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1585169067, 2757825945⟩, ⟨(-916290310), (-351115957)⟩, ⟨(-37471323), 108329673⟩, ⟨(-5516513), 21063202⟩, ⟨(-3249261), 976962⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1148084320, 2349424180⟩, ⟨(-904048133), (-302634105)⟩, ⟨(-23021412), 140053596⟩, ⟨(-12542331), 20955406⟩, ⟨(-4149998), 1715422⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1035838737, 1035838738⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4440787576, 4440787579⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified652
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨828670990, 1243006486⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4377629142, 4533656574⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified653
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (164099117 / 4294967296)

theorem envelope_integral : (∫ s in ((9647 / 50000) : ℝ)..(28941 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (9647 / 50000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (28941 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((9647 / 50000) : ℝ)..(28941 / 100000), prawitzNormalCorrection
