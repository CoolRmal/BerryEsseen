...
namespace FiniteNormalPanel163_16
...
def j2 : Jet := ⟨⟨1351243394, 1351243398⟩, ⟨450414464, 450414468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨425115858, 425115862⟩, ⟨283410572, 283410576⟩, ⟨47235095, 47235097⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨106, 107⟩, ⟨70, 72⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94581), (-94579)⟩, ⟨70, 72⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9362), (-9361)⟩, ⟨(-6236), (-6232)⟩, ⟨(-1036), (-1033)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103694, 5103696⟩, ⟨(-6236), (-6232)⟩, ⟨(-1036), (-1033)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨505163, 505164⟩, ⟨336157, 336160⟩, ⟨55614, 55617⟩, ⟨(-138), (-135)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-142660414), (-142660412)⟩, ⟨336157, 336160⟩, ⟨55614, 55617⟩, ⟨(-138), (-135)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14120528), (-14120527)⟩, ⟨(-9380414), (-9380410)⟩, ⟨(-1541263), (-1541259)⟩, ⟨7351, 7355⟩, ⟨599, 604⟩⟩
...
def j19 : Jet := ⟨⟨1417535237, 1417535239⟩, ⟨(-9380414), (-9380410)⟩, ⟨(-1541263), (-1541259)⟩, ⟨7351, 7355⟩, ⟨599, 604⟩⟩
...
def j25 : Jet := ⟨⟨1170, 1171⟩, ⟨779, 781⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851007), (-851005)⟩, ⟨779, 781⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-84233), (-84232)⟩, ⟨(-56079), (-56076)⟩, ⟨(-9297), (-9294)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35707161, 35707163⟩, ⟨(-56079), (-56076)⟩, ⟨(-9297), (-9294)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3534294, 3534295⟩, ⟨2350645, 2350647⟩, ⟨388077, 388081⟩, ⟨(-1230), (-1227)⟩, ⟨(-104), (-99)⟩⟩
...
def j33 : Jet := ⟨⟨(-712293589), (-712293587)⟩, ⟨2350645, 2350647⟩, ⟨388077, 388081⟩, ⟨(-1230), (-1227)⟩, ⟨(-104), (-99)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-70502820), (-70502818)⟩, ⟨(-46769214), (-46769210)⟩, ⟨(-7640125), (-7640121)⟩, ⟨51336, 51340⟩, ⟨4174, 4180⟩⟩
...
def j36 : Jet := ⟨⟨4224464476, 4224464478⟩, ⟨(-46769214), (-46769210)⟩, ⟨(-7640125), (-7640121)⟩, ⟨51336, 51340⟩, ⟨4174, 4180⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨445971992, 445971995⟩, ⟨145706149, 145706155⟩, ⟨(-1468626), (-1468622)⟩, ⟨(-159321), (-159318)⟩, ⟨958, 963⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4366646747, 4366646750⟩, ⟨48343314, 48343321⟩, ⟨8432473, 8432480⟩, ⟨127717, 127725⟩, ⟨11754, 11766⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨453414895, 453414899⟩, ⟨153157637, 153157646⟩, ⟨1022495, 1022504⟩, ⟨120820, 120828⟩, ⟨1847, 1860⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-430114132), (-430114131)⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3864853164, 3864853165⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨47866503, 47866505⟩, ⟨32337360, 32337364⟩, ⟨5677455, 5677460⟩, ⟨98430, 98438⟩, ⟨9247, 9256⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4342833799, 4342833801⟩, ⟨32337360, 32337364⟩, ⟨5677455, 5677460⟩, ⟨98430, 98438⟩, ⟨9247, 9256⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4318834233, 4318834235⟩, ⟨16079327, 16079330⟩, ⟨2793107, 2793111⟩, ⟨38543, 38549⟩, ⟨3550, 3557⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3886329976, 3886329980⟩, ⟨(-129699005), (-129698999)⟩, ⟨1976645, 1976651⟩, ⟨(-58555), (-58548)⟩, ⟨1907, 1915⟩⟩
...
def j47 : Jet := ⟨⟨4046415922, 4046415933⟩, ⟨1348805307, 1348805318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3812248309, 3812248331⟩, ⟨2541498872, 2541498902⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3812248309, 3812248331⟩, ⟨2541498872, 2541498902⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3812248331), (-3812248309)⟩, ⟨(-2541498902), (-2541498872)⟩, ⟨(-423583153), (-423583145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1906124166), (-1906124154)⟩, ⟨(-1270749451), (-1270749436)⟩, ⟨(-211791577), (-211791572)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2755612729, 2755612739⟩, ⟨(-815301523), (-815301509)⟩, ⟨(-15272201), (-15272193)⟩, ⟨28308721, 28308725⟩, ⟨(-1717374), (-1717372)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2493434667, 2493434679⟩, ⟨(-820944781), (-820944761)⟩, ⟨12069437, 12069453⟩, ⟨25663732, 25663746⟩, ⟨(-2403535), (-2403521)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨286742754, 573485509⟩, ⟨143371377, 143371378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨900828929, 1801657863⟩, ⟨450414464, 450414468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨188940381, 755761531⟩, ⟨188940380, 377880768⟩, ⟨47235095, 47235097⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨47, 190⟩, ⟨47, 95⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94640), (-94496)⟩, ⟨47, 95⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-16654), (-4156)⟩, ⟨(-8325), (-4139)⟩, ⟨(-1039), (-1027)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096402, 5108901⟩, ⟨(-8325), (-4139)⟩, ⟨(-1039), (-1027)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨224196, 898985⟩, ⟨222731, 449311⟩, ⟨55133, 55960⟩, ⟨(-184), (-89)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142941381), (-142266591)⟩, ⟨222731, 449311⟩, ⟨55133, 55960⟩, ⟨(-184), (-89)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-25152601), (-6258465)⟩, ⟨(-12566503), (-6179402)⟩, ⟨(-1559815), (-1515237)⟩, ⟨4841, 9863⟩, ⟨586, 613⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1406503164, 1425397301⟩, ⟨(-12566503), (-6179402)⟩, ⟨(-1559815), (-1515237)⟩, ⟨4841, 9863⟩, ⟨586, 613⟩⟩
...
def j72 : Jet := ⟨⟨519, 2083⟩, ⟨517, 1042⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851658), (-850093)⟩, ⟨517, 1042⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-149862), (-37396)⟩, ⟨(-74909), (-37212)⟩, ⟨(-9340), (-9233)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35641532, 35753999⟩, ⟨(-74909), (-37212)⟩, ⟨(-9340), (-9233)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1567910, 6291433⟩, ⟨1554728, 3144081⟩, ⟨383742, 391173⟩, ⟨(-1646), (-810)⟩, ⟨(-104), (-97)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714259973), (-709536449)⟩, ⟨1554728, 3144081⟩, ⟨383742, 391173⟩, ⟨(-1646), (-810)⟩, ⟨(-104), (-97)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-125684359), (-31213296)⟩, ⟨(-62773786), (-30660049)⟩, ⟨(-7769998), (-7457867)⟩, ⟨33689, 68960⟩, ⟨4056, 4264⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4169282937, 4263754000⟩, ⟨(-62773786), (-30660049)⟩, ⟨(-7769998), (-7457867)⟩, ⟨33689, 68960⟩, ⟨4056, 4264⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨295000788, 597927314⟩, ⟨142228982, 148185759⟩, ⟨(-1972167), (-965841)⟩, ⟨(-162564), (-154765)⟩, ⟨629, 1293⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4326409092, 4424440450⟩, ⟨31110592, 66615503⟩, ⟨7791170, 9248499⟩, ⟨38882, 228437⟩, ⟨8403, 16217⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨297160374, 615952023⟩, ⟨145407022, 161926797⟩, ⟨(-466246), 2613008⟩, ⟨62622, 188004⟩, ⟨(-4272), 8599⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-573485509), (-286742754)⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3721481787, 4008224542⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨20559944, 88335224⟩, ⟨20120854, 46444656⟩, ⟨4789053, 6854365⟩, ⟨(-26494), 250956⟩, ⟨2730, 18236⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4315527240, 4383302520⟩, ⟨20120854, 46444656⟩, ⟨4789053, 6854365⟩, ⟨(-26494), 250956⟩, ⟨2730, 18236⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305234994, 4338910114⟩, ⟨9958538, 23166945⟩, ⟨2308427, 3407492⟩, ⟨(-31552), 119840⟩, ⟨(-633), 8649⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3730378490, 4049233628⟩, ⟨(-136209421), (-122093863)⟩, ⟨1226852, 2847572⟩, ⟨(-143193), 34782⟩, ⟨(-4592), 9126⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2697610614, 5395221241⟩, ⟨1348805307, 1348805318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1694332581, 6777330358⟩, ⟨1694332580, 3388665200⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1694332581, 6777330358⟩, ⟨1694332580, 3388665200⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6777330358), (-1694332581)⟩, ⟨(-3388665200), (-1694332580)⟩, ⟨(-423583153), (-423583145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3388665179), (-847166290)⟩, ⟨(-1694332600), (-847166290)⟩, ⟨(-211791577), (-211791572)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1951227855, 3526118422⟩, ⟨(-1391027448), (-384872421)⟩, ⟨(-135921108), 178156878⟩, ⟨(-10774746), 63602453⟩, ⟨(-10665272), 4413882⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1694731977, 3324373926⟩, ⟨(-1423267106), (-389747495)⟩, ⟨(-116646267), 214416241⟩, ⟨(-16848111), 64192665⟩, ⟨(-12177288), 4675042⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4318834233, 4318834235⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3304
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305234994, 4338910114⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3305
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (20849869 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((5341 / 80000) : ℝ)..(5341 / 40000), prawitzNormalCorrection
