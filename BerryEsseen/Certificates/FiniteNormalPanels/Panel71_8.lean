...
namespace FiniteNormalPanel71_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (23247 / 80000)
def radius : Rat := (3321 / 80000)

def j0 : Jet := ⟨⟨1248063809, 1248063810⟩, ⟨178294829, 178294830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3920908093, 3920908097⟩, ⟨560129724, 560129729⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3579426620, 3579426628⟩, ⟨1022693312, 1022693324⟩, ⟨73049521, 73049524⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨895, 897⟩, ⟨255, 257⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93792), (-93789)⟩, ⟨255, 257⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-78167), (-78163)⟩, ⟨(-22122), (-22117)⟩, ⟨(-1521), (-1517)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5034889, 5034894⟩, ⟨(-22122), (-22117)⟩, ⟨(-1521), (-1517)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4196077, 4196082⟩, ⟨1180442, 1180449⟩, ⟨79098, 79105⟩, ⟨(-734), (-728)⟩, ⟨(-25), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-138969500), (-138969494)⟩, ⟨1180442, 1180449⟩, ⟨79098, 79105⟩, ⟨(-734), (-728)⟩, ⟨(-25), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-115817210), (-115817204)⟩, ⟨(-32106852), (-32106842)⟩, ⟨(-2016617), (-2016607)⟩, ⟨38299, 38309⟩, ⟨1149, 1156⟩⟩
...
def j19 : Jet := ⟨⟨1315838555, 1315838562⟩, ⟨(-32106852), (-32106842)⟩, ⟨(-2016617), (-2016607)⟩, ⟨38299, 38309⟩, ⟨1149, 1156⟩⟩
...
def j25 : Jet := ⟨⟨9787, 9790⟩, ⟨2774, 2778⟩, ⟨190, 195⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842390), (-842386)⟩, ⟨2774, 2778⟩, ⟨190, 195⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-702048), (-702044)⟩, ⟨(-198275), (-198268)⟩, ⟨(-13510), (-13502)⟩, ⟨90, 95⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35089346, 35089351⟩, ⟨(-198275), (-198268)⟩, ⟨(-13510), (-13502)⟩, ⟨90, 95⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29243468, 29243473⟩, ⟨8190033, 8190042⟩, ⟨538332, 538344⟩, ⟨(-6515), (-6507)⟩, ⟨(-209), (-202)⟩⟩
...
def j33 : Jet := ⟨⟨(-686584415), (-686584409)⟩, ⟨8190033, 8190042⟩, ⟨538332, 538344⟩, ⟨(-6515), (-6507)⟩, ⟨(-209), (-202)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-572199593), (-572199586)⟩, ⟨(-156660024), (-156660011)⟩, ⟨(-9278734), (-9278718)⟩, ⟨262051, 262064⟩, ⟨7429, 7440⟩⟩
...
def j36 : Jet := ⟨⟨3722767703, 3722767710⟩, ⟨(-156660024), (-156660011)⟩, ⟨(-9278734), (-9278718)⟩, ⟨262051, 262064⟩, ⟨7429, 7440⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1201238958, 1201238966⟩, ⟨142294976, 142294989⟩, ⟨(-6028212), (-6028200)⟩, ⟨(-228035), (-228023)⟩, ⟨6042, 6053⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4955115524, 4955115534⟩, ⟨208519174, 208519194⟩, ⟨21125071, 21125096⟩, ⟨1059879, 1059903⟩, ⟨72669, 72693⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1385872673, 1385872686⟩, ⟨222485838, 222485861⟩, ⟨5861976, 5862002⟩, ⟨440565, 440591⟩, ⟨21685, 21712⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1248063810), (-1248063809)⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3046903486, 3046903487⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨447184561, 447184570⟩, ⟨143580624, 143580642⟩, ⟨15308114, 15308136⟩, ⟨891634, 891658⟩, ⟨67636, 67661⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4742151857, 4742151866⟩, ⟨143580624, 143580642⟩, ⟨15308114, 15308136⟩, ⟨891634, 891658⟩, ⟨67636, 67661⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4513024167, 4513024173⟩, ⟨68321602, 68321611⟩, ⟨6767081, 6767093⟩, ⟨321830, 321843⟩, ⟨22237, 22251⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3201595755, 3201595762⟩, ⟨(-138878719), (-138878709)⟩, ⟨1964450, 1964461⟩, ⟨(-52609), (-52598)⟩, ⟨2414, 2427⟩⟩
...
def j47 : Jet := ⟨⟨8222475688, 8222475697⟩, ⟨1174639378, 1174639386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15741471769, 15741471804⟩, ⟨4497563338, 4497563376⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15741471769, 15741471804⟩, ⟨4497563338, 4497563376⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15741471804), (-15741471769)⟩, ⟨(-4497563376), (-4497563338)⟩, ⟨(-321254527), (-321254522)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7870735902), (-7870735884)⟩, ⟨(-2248781688), (-2248781669)⟩, ⟨(-160627264), (-160627261)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨687217412, 687217422⟩, ⟨(-359816932), (-359816923)⟩, ⟨68496213, 68496218⟩, ⟨(-2983355), (-2983352)⟩, ⟨(-890334), (-890332)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨512272200, 512272210⟩, ⟨(-290439521), (-290439510)⟩, ⟨63008185, 63008195⟩, ⟨(-4611717), (-4611707)⟩, ⟨(-531094), (-531084)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1069768979, 1426358640⟩, ⟨178294829, 178294830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3360778365, 4481037825⟩, ⟨560129724, 560129729⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2629782822, 4675169473⟩, ⟨876594268, 1168792372⟩, ⟨73049521, 73049524⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨658, 1172⟩, ⟨219, 293⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94029), (-93514)⟩, ⟨219, 293⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-102353), (-57258)⟩, ⟨(-25455), (-18767)⟩, ⟨(-1545), (-1489)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5010703, 5055799⟩, ⟨(-25455), (-18767)⟩, ⟨(-1545), (-1489)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3068023, 5503353⟩, ⟨994965, 1364349⟩, ⟨76612, 81249⟩, ⟨(-851), (-610)⟩, ⟨(-26), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140097554), (-137662223)⟩, ⟨994965, 1364349⟩, ⟨76612, 81249⟩, ⟨(-851), (-610)⟩, ⟨(-26), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-152499371), (-84289756)⟩, ⟨(-37515632), (-26611460)⟩, ⟨(-2132824), (-1881658)⟩, ⟨31631, 44944⟩, ⟨1042, 1246⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1279156394, 1347366010⟩, ⟨(-37515632), (-26611460)⟩, ⟨(-2132824), (-1881658)⟩, ⟨31631, 44944⟩, ⟨1042, 1246⟩⟩
...
def j72 : Jet := ⟨⟨7174, 12814⟩, ⟨2358, 3192⟩, ⟨187, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845003), (-839362)⟩, ⟨2358, 3192⟩, ⟨187, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-919805), (-513936)⟩, ⟨(-228509), (-167837)⟩, ⟨(-13777), (-13192)⟩, ⟨75, 109⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34871589, 35277459⟩, ⟨(-228509), (-167837)⟩, ⟨(-13777), (-13192)⟩, ⟨75, 109⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21351665, 38400316⟩, ⟨6868483, 9497314⟩, ⟨515919, 557673⟩, ⟨(-7592), (-5427)⟩, ⟨(-220), (-189)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694476218), (-677427566)⟩, ⟨6868483, 9497314⟩, ⟨515919, 557673⟩, ⟨(-7592), (-5427)⟩, ⟨(-220), (-189)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-755953141), (-414784852)⟩, ⟨(-184782755), (-127923573)⟩, ⟨(-10094031), (-8330250)⟩, ⟨213853, 309970⟩, ⟨6467, 8263⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3539014155, 3880182444⟩, ⟨(-184782755), (-127923573)⟩, ⟨(-10094031), (-8330250)⟩, ⟨213853, 309970⟩, ⟨6467, 8263⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1000929887, 1405737842⟩, ⟨127680727, 154893972⟩, ⟨(-7117840), (-4942925)⟩, ⟨(-253403), (-198505)⟩, ⟨4940, 7162⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4754091937, 5212396240⟩, ⟨156735007, 272155153⟩, ⟨15373729, 29076933⟩, ⟨426941, 2007166⟩, ⟨14236, 169578⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1107927576, 1706011278⟩, ⟨177856223, 277056256⟩, ⟨(-396032), 13860553⟩, ⟨(-202036), 1305473⟩, ⟨(-42769), 111646⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1426358640), (-1069768979)⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2868608656, 3225198317⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨285800433, 677647647⟩, ⟨91759400, 220099976⟩, ⟨7050475, 28883268⟩, ⟨(-211598), 2825312⟩, ⟨(-61323), 301853⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4580767729, 4972614943⟩, ⟨91759400, 220099976⟩, ⟨7050475, 28883268⟩, ⟨(-211598), 2825312⟩, ⟨(-61323), 301853⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4435566208, 4621387082⟩, ⟨42639105, 106561616⟩, ⟨2047673, 13778918⟩, ⟨(-433476), 1348194⟩, ⟨(-83482), 156084⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2962514669, 3470315095⟩, ⟨(-163366674), (-104111659)⟩, ⟨(-3056000), 8576879⟩, ⟨(-897506), 927389⟩, ⟨(-118656), 135203⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7047836303, 9397115083⟩, ⟨1174639378, 1174639386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11565162929, 20560289706⟩, ⟨3855054290, 5140072430⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11565162929, 20560289706⟩, ⟨3855054290, 5140072430⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20560289706), (-11565162929)⟩, ⟨(-5140072430), (-3855054290)⟩, ⟨(-321254527), (-321254522)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10280144853), (-5782581464)⟩, ⟨(-2570036215), (-1927527145)⟩, ⟨(-160627264), (-160627261)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨392158646, 1117486296⟩, ⟨(-668685011), (-175995853)⟩, ⟨(-2300455), 185398613⟩, ⟨(-32591765), 17130930⟩, ⟨(-6029572), 4918609⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨270496993, 902924119⟩, ⟨(-582800179), (-130901714)⟩, ⟨1612323, 177467475⟩, ⟨(-34954827), 14646303⟩, ⟨(-5830651), 5759047⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1248063809, 1248063810⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4513024167, 4513024173⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1418
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1069768979, 1426358640⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4435566208, 4621387082⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1419
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (22185391 / 2147483648)

theorem envelope_integral : (∫ s in ((9963 / 40000) : ℝ)..(3321 / 10000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((9963 / 40000) : ℝ)..(3321 / 10000), prawitzNormalCorrection
