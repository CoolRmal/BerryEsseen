...
namespace FiniteNormalPanel35_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (41141 / 400000)
def radius : Rat := (41141 / 400000)

def j0 : Jet := ⟨⟨441748123, 441748124⟩, ⟨441748123, 441748124⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1387792657, 1387792662⟩, ⟨1387792657, 1387792662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨448424475, 448424480⟩, ⟨896848950, 896848960⟩, ⟨448424475, 448424480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨112, 113⟩, ⟨224, 225⟩, ⟨112, 113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94575), (-94573)⟩, ⟨224, 225⟩, ⟨112, 113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9875), (-9874)⟩, ⟨(-19726), (-19724)⟩, ⟨(-9818), (-9815)⟩, ⟨46, 48⟩, ⟨11, 12⟩⟩
...
def j13 : Jet := ⟨⟨5103181, 5103183⟩, ⟨(-19726), (-19724)⟩, ⟨(-9818), (-9815)⟩, ⟨46, 48⟩, ⟨11, 12⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨532807, 532808⟩, ⟨1063555, 1063557⟩, ⟨527661, 527666⟩, ⟨(-4107), (-4102)⟩, ⟨(-1016), (-1011)⟩⟩
...
def j16 : Jet := ⟨⟨(-142632770), (-142632768)⟩, ⟨1063555, 1063557⟩, ⟨527661, 527666⟩, ⟨(-4107), (-4102)⟩, ⟨(-1016), (-1011)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14891854), (-14891853)⟩, ⟨(-29672666), (-29672664)⟩, ⟨(-14614678), (-14614674)⟩, ⟨220795, 220800⟩, ⟨54126, 54132⟩⟩
...
def j19 : Jet := ⟨⟨1416763911, 1416763913⟩, ⟨(-29672666), (-29672664)⟩, ⟨(-14614678), (-14614674)⟩, ⟨220795, 220800⟩, ⟨54126, 54132⟩⟩
...
def j25 : Jet := ⟨⟨1234, 1235⟩, ⟨2465, 2468⟩, ⟨1227, 1230⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850943), (-850941)⟩, ⟨2465, 2468⟩, ⟨1227, 1230⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-88845), (-88844)⟩, ⟨(-177432), (-177430)⟩, ⟨(-88203), (-88199)⟩, ⟨512, 515⟩, ⟨125, 129⟩⟩
...
def j30 : Jet := ⟨⟨35702549, 35702551⟩, ⟨(-177432), (-177430)⟩, ⟨(-88203), (-88199)⟩, ⟨512, 515⟩, ⟨125, 129⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3727594, 3727595⟩, ⟨7436663, 7436666⟩, ⟨3681333, 3681338⟩, ⟨(-36892), (-36887)⟩, ⟨(-9091), (-9086)⟩⟩
...
def j33 : Jet := ⟨⟨(-712100289), (-712100287)⟩, ⟨7436663, 7436666⟩, ⟨3681333, 3681338⟩, ⟨(-36892), (-36887)⟩, ⟨(-9091), (-9086)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-74348227), (-74348225)⟩, ⟨(-147920015), (-147920011)⟩, ⟨(-72410993), (-72410987)⟩, ⟨1541300, 1541304⟩, ⟨375702, 375708⟩⟩
...
def j36 : Jet := ⟨⟨4220619069, 4220619071⟩, ⟨(-147920015), (-147920011)⟩, ⟨(-72410993), (-72410987)⟩, ⟨1541300, 1541304⟩, ⟨375702, 375708⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨457785686, 457785689⟩, ⟨448197834, 448197839⟩, ⟨(-14310157), (-14310153)⟩, ⟨(-4650962), (-4650957)⟩, ⟨88832, 88838⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4370625200, 4370625203⟩, ⟨153177274, 153177280⟩, ⟨80352967, 80352976⟩, ⟨3848028, 3848037⟩, ⟨1068435, 1068446⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨465849799, 465849804⟩, ⟨472419688, 472419695⟩, ⟨9986996, 9987005⟩, ⟨3552061, 3552072⟩, ⟨172235, 172248⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-441748124), (-441748123)⟩, ⟨(-441748124), (-441748123)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3853219172, 3853219173⟩, ⟨(-441748124), (-441748123)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨50527983, 50527985⟩, ⟨102481160, 102481164⟩, ⟨54129687, 54129693⟩, ⟨2967556, 2967564⟩, ⟨841992, 842001⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4345495279, 4345495281⟩, ⟨102481160, 102481164⟩, ⟨54129687, 54129693⟩, ⟨2967556, 2967564⟩, ⟨841992, 842001⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320157417, 4320157419⟩, ⟨50941804, 50941807⟩, ⟨26606688, 26606692⟩, ⟨1161388, 1161395⟩, ⟨322913, 322920⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3875818426, 3875818429⟩, ⟨(-398636680), (-398636674)⟩, ⟨18630630, 18630637⟩, ⟨(-1694629), (-1694621)⟩, ⟨170247, 170256⟩⟩
...
def j47 : Jet := ⟨⟨1933584544, 1933584549⟩, ⟨1933584544, 1933584549⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨870495380, 870495385⟩, ⟨1740990760, 1740990770⟩, ⟨870495380, 870495385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨870495380, 870495385⟩, ⟨1740990760, 1740990770⟩, ⟨870495380, 870495385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-870495385), (-870495380)⟩, ⟨(-1740990770), (-1740990760)⟩, ⟨(-870495385), (-870495380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-435247693), (-435247690)⟩, ⟨(-870495385), (-870495380)⟩, ⟨(-435247693), (-435247690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3881046914, 3881046917⟩, ⟨(-786602831), (-786602824)⟩, ⟨(-313587873), (-313587867)⟩, ⟨74328149, 74328152⟩, ⟨12123169, 12123171⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3502292824, 3502292830⟩, ⟨(-1070056439), (-1070056424)⟩, ⟨(-193141070), (-193141054)⟩, ⟨91236592, 91236608⟩, ⟨3145227, 3145246⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 883496248⟩, ⟨441748123, 441748124⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2775585323⟩, ⟨1387792657, 1387792662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1793697916⟩, ⟨0, 1793697916⟩, ⟨448424475, 448424480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 450⟩, ⟨0, 450⟩, ⟨112, 113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94236)⟩, ⟨0, 450⟩, ⟨112, 113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-39544), 0⟩, ⟨(-39544), 188⟩, ⟨(-9886), (-9602)⟩, ⟨0, 95⟩, ⟨11, 12⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073512, 5113057⟩, ⟨(-39544), 188⟩, ⟨(-9886), (-9602)⟩, ⟨0, 95⟩, ⟨11, 12⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2135355⟩, ⟨(-16515), 2135434⟩, ⟨509065, 533918⟩, ⟨(-8258), 60⟩, ⟨(-1033), (-956)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141030221)⟩, ⟨(-16515), 2135434⟩, ⟨509065, 533918⟩, ⟨(-8258), 60⟩, ⟨(-1033), (-956)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-59789931), 0⟩, ⟨(-59796829), 891817⟩, ⟨(-14954381), (-13609739)⟩, ⟨(-5174), 445961⟩, ⟨49268, 55771⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1371865834, 1431655766⟩, ⟨(-59796829), 891817⟩, ⟨(-14954381), (-13609739)⟩, ⟨(-5174), 445961⟩, ⟨49268, 55771⟩⟩
...
def j70 : Jet := ⟨⟨(-46), 0⟩, ⟨(-46), 0⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11789, 11836⟩, ⟨(-46), 0⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 4944⟩, ⟨(-20), 4944⟩, ⟨1204, 1236⟩, ⟨(-11), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-847232)⟩, ⟨(-20), 4944⟩, ⟨1204, 1236⟩, ⟨(-11), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-355893), 0⟩, ⟨(-355902), 2065⟩, ⟨(-88983), (-85874)⟩, ⟨(-8), 1034⟩, ⟨119, 130⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35435501, 35791395⟩, ⟨(-355902), 2065⟩, ⟨(-88983), (-85874)⟩, ⟨(-8), 1034⟩, ⟨119, 130⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 14947483⟩, ⟨(-148635), 14948346⟩, ⟨3513915, 3737734⟩, ⟨(-74325), 648⟩, ⟨(-9295), (-8478)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-700880399)⟩, ⟨(-148635), 14948346⟩, ⟨3513915, 3737734⟩, ⟨(-74325), 648⟩, ⟨(-9295), (-8478)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-298949653), 0⟩, ⟨(-299011728), 6242846⟩, ⟨(-74799489), (-65372963)⟩, ⟨(-46560), 3121965⟩, ⟨331954, 390517⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3996017643, 4294967296⟩, ⟨(-299011728), 6242846⟩, ⟨(-74799489), (-65372963)⟩, ⟨(-46560), 3121965⟩, ⟨331954, 390517⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 925195109⟩, ⟨404635008, 463173884⟩, ⟨(-28985730), 288165⟩, ⟨(-4835414), (-4109388)⟩, ⟨(-1672), 180142⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4616281940⟩, ⟨(-7211866), 345424512⟩, ⟨64870879, 112257141⟩, ⟨(-3916932), 14919534⟩, ⟨43875, 2866525⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 994410709⟩, ⟨403081472, 572233999⟩, ⟨(-31931944), 61742410⟩, ⟨(-2260535), 11259089⟩, ⟨(-1570694), 2435699⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-883496248), 0⟩, ⟨(-441748124), (-441748123)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3411471048, 4294967296⟩, ⟨(-441748124), (-441748123)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 230235201⟩, ⟨0, 264977858⟩, ⟨23042720, 104831156⟩, ⟨(-9555580), 21665948⟩, ⟨(-1788723), 5015632⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4525202497⟩, ⟨0, 264977858⟩, ⟨23042720, 104831156⟩, ⟨(-9555580), 21665948⟩, ⟨(-1788723), 5015632⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4408582169⟩, ⟨0, 132488929⟩, ⟨9233627, 52415578⟩, ⟨(-6394679), 10832974⟩, ⟨(-1548371), 2695151⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3411471048, 4408582169⟩, ⟨(-453433698), (-309259194)⟩, ⟨(-6292595), 52415578⟩, ⟨(-11785753), 9883273⟩, ⟨(-2662570), 3352860⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3867169098⟩, ⟨1933584544, 1933584549⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3481981539⟩, ⟨0, 3481981540⟩, ⟨870495380, 870495385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3481981539⟩, ⟨0, 3481981540⟩, ⟨870495380, 870495385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3481981539), 0⟩, ⟨(-3481981540), 0⟩, ⟨(-870495385), (-870495380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1740990770), 0⟩, ⟨(-1740990770), 0⟩, ⟨(-435247693), (-435247690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2863623951, 4294967296⟩, ⟨(-1740990770), 0⟩, ⟨(-435247693), 62663742⟩, ⟨(-8467042), 176430265⟩, ⟨(-21054408), 22911825⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2274562185, 4408582169⟩, ⟨(-2240478939), (-206195291)⟩, ⟨(-453053906), 300539037⟩, ⟨(-48339360), 239481913⟩, ⟨(-52218238), 33306839⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨441748123, 441748124⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨441748123, 441748124⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320157417, 4320157419⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified682
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 883496248⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4408582169⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified683
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (44285379 / 268435456)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(41141 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(41141 / 200000), prawitzNormalCorrection
