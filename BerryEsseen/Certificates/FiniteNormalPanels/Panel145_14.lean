...
namespace FiniteNormalPanel145_14
...
def j2 : Jet := ⟨⟨441863250, 441863254⟩, ⟨441863250, 441863254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨45458584, 45458585⟩, ⟨90917168, 90917170⟩, ⟨45458584, 45458585⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1003), (-1002)⟩, ⟨(-2005), (-2003)⟩, ⟨(-1003), (-1000)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112053, 5112055⟩, ⟨(-2005), (-2003)⟩, ⟨(-1003), (-1000)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨54106, 54107⟩, ⟨108191, 108193⟩, ⟨54052, 54055⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143111471), (-143111469)⟩, ⟨108191, 108193⟩, ⟨54052, 54055⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1514714), (-1514713)⟩, ⟨(-3028283), (-3028280)⟩, ⟨(-1511852), (-1511849)⟩, ⟨2288, 2291⟩, ⟨570, 573⟩⟩
...
def j19 : Jet := ⟨⟨1430141051, 1430141053⟩, ⟨(-3028283), (-3028280)⟩, ⟨(-1511852), (-1511849)⟩, ⟨2288, 2291⟩, ⟨570, 573⟩⟩
...
def j28 : Jet := ⟨⟨(-9019), (-9018)⟩, ⟨(-18035), (-18033)⟩, ⟨(-9013), (-9010)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782375, 35782377⟩, ⟨(-18035), (-18033)⟩, ⟨(-9013), (-9010)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨378726, 378727⟩, ⟨757261, 757263⟩, ⟨378248, 378251⟩, ⟨(-382), (-379)⟩, ⟨(-97), (-93)⟩⟩
...
def j33 : Jet := ⟨⟨(-715449157), (-715449155)⟩, ⟨757261, 757263⟩, ⟨378248, 378251⟩, ⟨(-382), (-379)⟩, ⟨(-97), (-93)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7572423), (-7572422)⟩, ⟨(-15136831), (-15136829)⟩, ⟨(-7552391), (-7552388)⟩, ⟨16015, 16018⟩, ⟨3992, 3996⟩⟩
...
def j36 : Jet := ⟨⟨4287394873, 4287394874⟩, ⟨(-15136831), (-15136829)⟩, ⟨(-7552391), (-7552388)⟩, ⟨16015, 16018⟩, ⟨3992, 3996⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨147131917, 147131919⟩, ⟨146820369, 146820372⟩, ⟨(-467087), (-467084)⟩, ⟨(-155304), (-155301)⟩, ⟨293, 295⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302553092, 4302553094⟩, ⟨15190344, 15190348⟩, ⟨7632719, 7632725⟩, ⟨37630, 37637⟩, ⟨9508, 9517⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨147391782, 147391785⟩, ⟨147600055, 147600062⟩, ⟨312830, 312837⟩, ⟨104977, 104984⟩, ⟨523, 531⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-140649442), (-140649441)⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4154317854, 4154317855⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5058091, 5058092⟩, ⟨10130476, 10130480⟩, ⟨5093866, 5093869⟩, ⟨28704, 28708⟩, ⟨7270, 7277⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300025387, 4300025388⟩, ⟨10130476, 10130480⟩, ⟨5093866, 5093869⟩, ⟨28704, 28708⟩, ⟨7270, 7277⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297495597, 4297495598⟩, ⟨5062258, 5062261⟩, ⟨2542452, 2542455⟩, ⟨11348, 11352⟩, ⟨2866, 2872⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4156763359, 4156763362⟩, ⟨(-135835757), (-135835751)⟩, ⟨2293416, 2293420⟩, ⟨(-72284), (-72277)⟩, ⟨2400, 2407⟩⟩
...
def j47 : Jet := ⟨⟨1465418772, 1465418784⟩, ⟨1465418772, 1465418784⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨499992672, 499992681⟩, ⟨999985344, 999985362⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨499992672, 499992681⟩, ⟨999985344, 999985362⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-499992681), (-499992672)⟩, ⟨(-999985362), (-999985344)⟩, ⟨(-499992681), (-499992672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-249996341), (-249996336)⟩, ⟨(-499992681), (-499992672)⟩, ⟨(-249996341), (-249996336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4052107564, 4052107569⟩, ⟨(-471720502), (-471720492)⟩, ⟨(-208402908), (-208402900)⟩, ⟨26391874, 26391876⟩, ⟨5297140, 5297141⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3921718394, 3921718403⟩, ⟨(-584696327), (-584696309)⟩, ⟨(-184614189), (-184614173)⟩, ⟨31813648, 31813660⟩, ⟨4190918, 4190931⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 281298884⟩, ⟨140649441, 140649442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 883726508⟩, ⟨441863250, 441863254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 181834340⟩, ⟨0, 181834340⟩, ⟨45458584, 45458585⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4009), 0⟩, ⟨(-4009), 2⟩, ⟨(-1003), (-998)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109047, 5113057⟩, ⟨(-4009), 2⟩, ⟨(-1003), (-998)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 216470⟩, ⟨(-170), 216471⟩, ⟨53861, 54119⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142949106)⟩, ⟨(-170), 216471⟩, ⟨53861, 54119⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6061145), 0⟩, ⟨(-6061153), 9165⟩, ⟨(-1515295), (-1501537)⟩, ⟨(-6), 4585⟩, ⟨565, 574⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425594620, 1431655766⟩, ⟨(-6061153), 9165⟩, ⟨(-1515295), (-1501537)⟩, ⟨(-6), 4585⟩, ⟨565, 574⟩⟩
...
def j72 : Jet := ⟨⟨0, 502⟩, ⟨(-1), 502⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851674)⟩, ⟨(-1), 502⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-36079), 0⟩, ⟨(-36080), 22⟩, ⟨(-9021), (-8986)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35755315, 35791395⟩, ⟨(-36080), 22⟩, ⟨(-9021), (-8986)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1515287⟩, ⟨(-1528), 1515288⟩, ⟨376529, 378823⟩, ⟨(-765), 2⟩, ⟨(-98), (-93)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714312595)⟩, ⟨(-1528), 1515288⟩, ⟨376529, 378823⟩, ⟨(-765), 2⟩, ⟨(-98), (-93)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30305724), 0⟩, ⟨(-30305789), 64153⟩, ⟨(-7576496), (-7480200)⟩, ⟨(-50), 32079⟩, ⟨3947, 4011⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264661572, 4294967296⟩, ⟨(-30305789), 64153⟩, ⟨(-7576496), (-7480200)⟩, ⟨(-50), 32079⟩, ⟨3947, 4011⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 294575503⟩, ⟨145417048, 147289638⟩, ⟨(-935353), 943⟩, ⟨(-155895), (-153533)⟩, ⟨(-1), 591⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4325488380⟩, ⟨(-65069), 30738041⟩, ⟨7479740, 7902994⟩, ⟨(-32773), 110822⟩, ⟨8524, 10855⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 296668829⟩, ⟨145412585, 150444521⟩, ⟨(-944232), 1597104⟩, ⟨87299, 125105⟩, ⟨(-3964), 5147⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-281298884), 0⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4013668412, 4294967296⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20491983⟩, ⟨0, 20783488⟩, ⟨4792718, 5490421⟩, ⟨(-66150), 129172⟩, ⟨5010, 10072⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315459279⟩, ⟨0, 20783488⟩, ⟨4792718, 5490421⟩, ⟨(-66150), 129172⟩, ⟨5010, 10072⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305201096⟩, ⟨0, 10391744⟩, ⟨2378121, 2745211⟩, ⟨(-39718), 64586⟩, ⟨1467, 4475⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4013668412, 4305201096⟩, ⟨(-140984574), (-130257697)⟩, ⟨1882061, 2745211⟩, ⟨(-129617), (-13291)⟩, ⟨(-746), 5776⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2930837568⟩, ⟨1465418772, 1465418784⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1999970724⟩, ⟨0, 1999970724⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1999970724⟩, ⟨0, 1999970724⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1999970724), 0⟩, ⟨(-1999970724), 0⟩, ⟨(-499992681), (-499992672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-999985362), 0⟩, ⟨(-999985362), 0⟩, ⟨(-249996341), (-249996336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3402861533, 4294967296⟩, ⟨(-999985362), 0⟩, ⟨(-249996341), (-81657793)⟩, ⟨0, 58205957⟩, ⟨(-1011464), 7275745⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3179991116, 4305201096⟩, ⟨(-1143352644), (-103201928)⟩, ⟨(-249100880), (-40739355)⟩, ⟨1707739, 66540380⟩, ⟨(-3085053), 7293255⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297495597, 4297495598⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2926
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305201096⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2927
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (252918047 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(13099 / 200000), prawitzNormalCorrection
