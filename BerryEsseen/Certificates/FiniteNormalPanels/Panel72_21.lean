...
namespace FiniteNormalPanel72_21
...
def j2 : Jet := ⟨⟨571969866, 571969870⟩, ⟨571969866, 571969870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨76170435, 76170437⟩, ⟨152340870, 152340874⟩, ⟨76170435, 76170437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨19, 20⟩, ⟨38, 39⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94668), (-94666)⟩, ⟨38, 39⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1679), (-1678)⟩, ⟨(-3358), (-3356)⟩, ⟨(-1678), (-1675)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111377, 5111379⟩, ⟨(-3358), (-3356)⟩, ⟨(-1678), (-1675)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨90649, 90650⟩, ⟨181238, 181240⟩, ⟨90499, 90502⟩, ⟨(-120), (-117)⟩, ⟨(-30), (-27)⟩⟩
...
def j16 : Jet := ⟨⟨(-143074928), (-143074926)⟩, ⟨181238, 181240⟩, ⟨90499, 90502⟩, ⟨(-120), (-117)⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2537407), (-2537406)⟩, ⟨(-5071600), (-5071598)⟩, ⟨(-2529375), (-2529371)⟩, ⟨6420, 6424⟩, ⟨1598, 1602⟩⟩
...
def j19 : Jet := ⟨⟨1429118358, 1429118360⟩, ⟨(-5071600), (-5071598)⟩, ⟨(-2529375), (-2529371)⟩, ⟨6420, 6424⟩, ⟨1598, 1602⟩⟩
...
def j25 : Jet := ⟨⟨209, 210⟩, ⟨418, 420⟩, ⟨207, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851968), (-851966)⟩, ⟨418, 420⟩, ⟨207, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-15110), (-15109)⟩, ⟨(-30212), (-30210)⟩, ⟨(-15093), (-15090)⟩, ⟨13, 16⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35776284, 35776286⟩, ⟨(-30212), (-30210)⟩, ⟨(-15093), (-15090)⟩, ⟨13, 16⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨634485, 634486⟩, ⟨1268435, 1268437⟩, ⟨633145, 633148⟩, ⟨(-1072), (-1069)⟩, ⟨(-268), (-265)⟩⟩
...
def j33 : Jet := ⟨⟨(-715193398), (-715193396)⟩, ⟨1268435, 1268437⟩, ⟨633145, 633148⟩, ⟨(-1072), (-1069)⟩, ⟨(-268), (-265)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-12683821), (-12683819)⟩, ⟨(-25345146), (-25345143)⟩, ⟨(-12627603), (-12627599)⟩, ⟨44932, 44936⟩, ⟨11184, 11188⟩⟩
...
def j36 : Jet := ⟨⟨4282283475, 4282283477⟩, ⟨(-25345146), (-25345143)⟩, ⟨(-12627603), (-12627599)⟩, ⟨44932, 44936⟩, ⟨11184, 11188⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨190318710, 190318712⟩, ⟨189643314, 189643317⟩, ⟨(-1012239), (-1012236)⟩, ⟨(-335989), (-335985)⟩, ⟨1066, 1070⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4307688683, 4307688686⟩, ⟨25495505, 25495510⟩, ⟨12853411, 12853418⟩, ⟨106051, 106059⟩, ⟨27005, 27014⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨190882420, 190882423⟩, ⟨191334780, 191334786⟩, ⟨680070, 680077⟩, ⟨229244, 229252⟩, ⟨1922, 1933⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-182063664), (-182063663)⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4112903632, 4112903633⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8483440, 8483441⟩, ⟨17007088, 17007090⟩, ⟨8584144, 8584148⟩, ⟨80968, 80972⟩, ⟨20701, 20706⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303450736, 4303450737⟩, ⟨17007088, 17007090⟩, ⟨8584144, 8584148⟩, ⟨80968, 80972⟩, ⟨20701, 20706⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299206923, 4299206924⟩, ⟨8495158, 8495160⟩, ⟨4279446, 4279449⟩, ⟨31987, 31991⟩, ⟨8146, 8151⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4116963541, 4116963544⟩, ⟨(-174108334), (-174108329)⟩, ⟨3737930, 3737935⟩, ⟨(-150775), (-150770)⟩, ⟨6443, 6451⟩⟩
...
def j47 : Jet := ⟨⟨1138794831, 1138794838⟩, ⟨1138794831, 1138794838⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨301947274, 301947278⟩, ⟨603894548, 603894556⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨301947274, 301947278⟩, ⟨603894548, 603894556⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-301947278), (-301947274)⟩, ⟨(-603894556), (-603894548)⟩, ⟨(-301947278), (-301947274)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-150973639), (-150973637)⟩, ⟨(-301947278), (-301947274)⟩, ⟨(-150973639), (-150973637)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4146616296, 4146616299⟩, ⟨(-291517821), (-291517816)⟩, ⟨(-135511684), (-135511680)⟩, ⟨10007091, 10007092⟩, ⟨2205823, 2205825⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3974760907, 3974760914⟩, ⟨(-447530463), (-447530451)⟩, ⟨(-114469144), (-114469131)⟩, ⟨14686410, 14686420⟩, ⟨1607253, 1607269⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 364127328⟩, ⟨182063663, 182063664⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1143939739⟩, ⟨571969866, 571969870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 304681745⟩, ⟨0, 304681746⟩, ⟨76170435, 76170437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 77⟩, ⟨0, 77⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94609)⟩, ⟨0, 77⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6718), 0⟩, ⟨(-6718), 6⟩, ⟨(-1680), (-1669)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106338, 5113057⟩, ⟨(-6718), 6⟩, ⟨(-1680), (-1669)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 362717⟩, ⟨(-477), 362718⟩, ⟨89962, 90681⟩, ⟨(-240), 2⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142802859)⟩, ⟨(-477), 362718⟩, ⟨89962, 90681⟩, ⟨(-240), 2⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-10156059), 0⟩, ⟨(-10156093), 25731⟩, ⟨(-2539049), (-2500417)⟩, ⟨(-27), 12867⟩, ⟨1574, 1610⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421499706, 1431655766⟩, ⟨(-10156093), 25731⟩, ⟨(-2539049), (-2500417)⟩, ⟨(-27), 12867⟩, ⟨1574, 1610⟩⟩
...
def j72 : Jet := ⟨⟨0, 840⟩, ⟨(-1), 840⟩, ⟨207, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851336)⟩, ⟨(-1), 840⟩, ⟨207, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-60453), 0⟩, ⟨(-60454), 60⟩, ⟨(-15115), (-15023)⟩, ⟨(-2), 30⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35730941, 35791395⟩, ⟨(-60454), 60⟩, ⟨(-15115), (-15023)⟩, ⟨(-2), 30⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2539015⟩, ⟨(-4289), 2539020⟩, ⟨628319, 634759⟩, ⟨(-2147), 5⟩, ⟨(-270), (-262)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713288867)⟩, ⟨(-4289), 2539020⟩, ⟨628319, 634759⟩, ⟨(-2147), 5⟩, ⟨(-270), (-262)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-50780291), 0⟩, ⟨(-50780597), 180117⟩, ⟨(-12695378), (-12424896)⟩, ⟨(-230), 90061⟩, ⟨10970, 11259⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4244187005, 4294967296⟩, ⟨(-50780597), 180117⟩, ⟨(-12695378), (-12424896)⟩, ⟨(-230), 90061⟩, ⟨10970, 11259⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 381313247⟩, ⟨186599101, 190663478⟩, ⟨(-2028771), 3427⟩, ⟨(-338139), (-329557)⟩, ⟨(-4), 2143⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4346355157⟩, ⟨(-184454), 52003014⟩, ⟨12422715, 13623191⟩, ⟨(-93361), 318789⟩, ⟨22348, 33469⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 385875534⟩, ⟨186582724, 197561605⟩, ⟨(-2061234), 3521490⟩, ⟨164678, 303599⟩, ⟨(-14681), 19319⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-364127328), 0⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3930839968, 4294967296⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 34668467⟩, ⟨0, 35499312⟩, ⟨7735181, 9720285⟩, ⟨(-189628), 378520⟩, ⟨9977, 34292⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4329635763⟩, ⟨0, 35499312⟩, ⟨7735181, 9720285⟩, ⟨(-189628), 378520⟩, ⟨9977, 34292⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4312266690⟩, ⟨0, 17749656⟩, ⟨3815545, 4860143⟩, ⟨(-114900), 189260⟩, ⟨1449, 15927⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3930839968, 4312266690⟩, ⟨(-182796986), (-164314007)⟩, ⟨2739655, 4860143⟩, ⟨(-320922), 27520⟩, ⟨(-6697), 20798⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2277589676⟩, ⟨1138794831, 1138794838⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1207789112⟩, ⟨0, 1207789112⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1207789112⟩, ⟨0, 1207789112⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1207789112), 0⟩, ⟨(-1207789112), 0⟩, ⟨(-301947278), (-301947274)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-603894556), 0⟩, ⟨(-603894556), 0⟩, ⟨(-150973639), (-150973637)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3731606293, 4294967296⟩, ⟨(-603894556), 0⟩, ⟨(-150973639), (-88715426)⟩, ⟨0, 21227673⟩, ⟨813050, 2653460⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3415240710, 4312266690⟩, ⟨(-789123927), (-142761315)⟩, ⟨(-149201436), (-50631789)⟩, ⟨2389731, 27766245⟩, ⟨(-340755), 2673481⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299206923, 4299206924⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1448
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4312266690⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1449
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (333790665 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(4239 / 50000), prawitzNormalCorrection
