...
namespace FiniteNormalPanel85_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (15261 / 80000)
def radius : Rat := (15261 / 400000)

def j0 : Jet := ⟨⟨819318698, 819318699⟩, ⟨163863739, 163863740⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2573965602, 2573965606⟩, ⟨514793118, 514793122⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1542572612, 1542572617⟩, ⟨617029040, 617029048⟩, ⟨61702903, 61702905⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨386, 387⟩, ⟨154, 155⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94301), (-94299)⟩, ⟨154, 155⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-33869), (-33868)⟩, ⟨(-13493), (-13491)⟩, ⟨(-1328), (-1325)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5079187, 5079189⟩, ⟨(-13493), (-13491)⟩, ⟨(-1328), (-1325)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1824231, 1824233⟩, ⟨724845, 724848⟩, ⟨70553, 70557⟩, ⟨(-384), (-380)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-141341346), (-141341343)⟩, ⟨724845, 724848⟩, ⟨70553, 70557⟩, ⟨(-384), (-380)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-50763900), (-50763898)⟩, ⟨(-20045227), (-20045223)⟩, ⟨(-1901085), (-1901078)⟩, ⟨20410, 20415⟩, ⟨949, 954⟩⟩
...
def j19 : Jet := ⟨⟨1380891865, 1380891868⟩, ⟨(-20045227), (-20045223)⟩, ⟨(-1901085), (-1901078)⟩, ⟨20410, 20415⟩, ⟨949, 954⟩⟩
...
def j25 : Jet := ⟨⟨4236, 4238⟩, ⟨1688, 1690⟩, ⟨165, 168⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847941), (-847938)⟩, ⟨1688, 1690⟩, ⟨165, 168⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-304545), (-304543)⟩, ⟨(-121212), (-121210)⟩, ⟨(-11881), (-11877)⟩, ⟨46, 50⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35486849, 35486852⟩, ⟨(-121212), (-121210)⟩, ⟨(-11881), (-11877)⟩, ⟨46, 50⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12745391, 12745394⟩, ⟨5054621, 5054625⟩, ⟨488133, 488138⟩, ⟨(-3433), (-3429)⟩, ⟨(-165), (-160)⟩⟩
...
def j33 : Jet := ⟨⟨(-703082492), (-703082488)⟩, ⟨5054621, 5054625⟩, ⟨488133, 488138⟩, ⟨(-3433), (-3429)⟩, ⟨(-165), (-160)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-252517825), (-252517822)⟩, ⟨(-99191723), (-99191718)⟩, ⟨(-9199235), (-9199229)⟩, ⟨141509, 141514⟩, ⟨6458, 6464⟩⟩
...
def j36 : Jet := ⟨⟨4042449471, 4042449474⟩, ⟨(-99191723), (-99191718)⟩, ⟨(-9199235), (-9199229)⟩, ⟨141509, 141514⟩, ⟨6458, 6464⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨827565826, 827565830⟩, ⟨153500098, 153500104⟩, ⟨(-3541931), (-3541924)⟩, ⟨(-215633), (-215627)⟩, ⟨3014, 3019⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4563259032, 4563259036⟩, ⟨111971097, 111971104⟩, ⟨13131905, 13131916⟩, ⟨417284, 417294⟩, ⟨28904, 28916⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨879260997, 879261003⟩, ⟨184663608, 184663618⟩, ⟨2768900, 2768913⟩, ⟨228288, 228300⟩, ⟨7232, 7244⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-819318699), (-819318698)⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3475648597, 3475648598⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨180001347, 180001350⟩, ⟨75608262, 75608268⟩, ⟨9073367, 9073375⟩, ⟨331566, 331578⟩, ⟨24375, 24384⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4474968643, 4474968646⟩, ⟨75608262, 75608268⟩, ⟨9073367, 9073375⟩, ⟨331566, 331578⟩, ⟨24375, 24384⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4384044248, 4384044250⟩, ⟨37036009, 37036013⟩, ⟨4288066, 4288072⟩, ⟨126188, 126196⟩, ⟨8775, 8782⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3547733006, 3547733010⟩, ⟨(-137291322), (-137291316)⟩, ⟨2057046, 2057053⟩, ⟨(-61485), (-61477)⟩, ⟨2286, 2293⟩⟩
...
def j47 : Jet := ⟨⟨7353516405, 7353516415⟩, ⟨1470703275, 1470703285⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12590131610, 12590131645⟩, ⟨5036052622, 5036052666⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12590131610, 12590131645⟩, ⟨5036052622, 5036052666⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12590131645), (-12590131610)⟩, ⟨(-5036052666), (-5036052622)⟩, ⟨(-503605268), (-503605260)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6295065823), (-6295065805)⟩, ⟨(-2518026333), (-2518026311)⟩, ⟨(-251802634), (-251802630)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨991793565, 991793581⟩, ⟨(-581462485), (-581462469)⟩, ⟨112301823, 112301833⟩, ⟨779872, 779877⟩, ⟨(-3406287), (-3406284)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨819242271, 819242287⟩, ⟨(-512003505), (-512003487)⟩, ⟨111825482, 111825496⟩, ⟨(-3238297), (-3238286)⟩, ⟨(-2775960), (-2775949)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨655454959, 983182439⟩, ⟨163863739, 163863740⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2059172483, 3088758728⟩, ⟨514793118, 514793122⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨987246473, 2221304570⟩, ⟨493623232, 740434858⟩, ⟨61702903, 61702905⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨247, 557⟩, ⟨123, 186⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94440), (-94129)⟩, ⟨123, 186⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-48844), (-21636)⟩, ⟨(-16254), (-10721)⟩, ⟨(-1340), (-1310)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5064212, 5091421⟩, ⟨(-16254), (-10721)⟩, ⟨(-1340), (-1310)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1164066, 2633221⟩, ⟨573625, 875277⟩, ⟨69257, 71613⟩, ⟨(-466), (-300)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142001511), (-140532355)⟩, ⟨573625, 875277⟩, ⟨69257, 71613⟩, ⟨(-466), (-300)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-73441446), (-32302940)⟩, ⟨(-24348628), (-15698786)⟩, ⟨(-1958195), (-1831000)⟩, ⟨15957, 24853⟩, ⟨902, 992⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1358214319, 1399352826⟩, ⟨(-24348628), (-15698786)⟩, ⟨(-1958195), (-1831000)⟩, ⟨15957, 24853⟩, ⟨902, 992⟩⟩
...
def j70 : Jet := ⟨⟨(-56), (-24)⟩, ⟨(-19), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11779, 11812⟩, ⟨(-19), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2707, 6110⟩, ⟨1343, 2035⟩, ⟨163, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849470), (-846066)⟩, ⟨1343, 2035⟩, ⟨163, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-439336), (-194477)⟩, ⟨(-146138), (-96185)⟩, ⟨(-12013), (-11715)⟩, ⟨35, 60⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35352058, 35596918⟩, ⟨(-146138), (-96185)⟩, ⟨(-12013), (-11715)⟩, ⟨35, 60⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8126067, 18410291⟩, ⟨3987452, 6114655⟩, ⟨476472, 497651⟩, ⟨(-4163), (-2695)⟩, ⟨(-169), (-155)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707701816), (-697417591)⟩, ⟨3987452, 6114655⟩, ⟨476472, 497651⟩, ⟨(-4163), (-2695)⟩, ⟨(-169), (-155)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-366014727), (-160309266)⟩, ⟨(-121088349), (-76992207)⟩, ⟨(-9599274), (-8707806)⟩, ⟨109892, 173021⟩, ⟨6039, 6806⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3928952569, 4134658030⟩, ⟨(-121088349), (-76992207)⟩, ⟨(-9599274), (-8707806)⟩, ⟨109892, 173021⟩, ⟨6039, 6806⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨651180174, 1006355336⟩, ⟨145284539, 160199289⟩, ⟨(-4326669), (-2759501)⟩, ⟨(-227059), (-201588)⟩, ⟨2344, 3693⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4461492084, 4695079350⟩, ⟨83078241, 144699994⟩, ⟨10943149, 15930669⟩, ⟨182267, 719724⟩, ⟨12654, 51926⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨676427779, 1100105736⟩, ⟨163513403, 209027898⟩, ⟨(-260331), 6263439⟩, ⟨3823, 500062⟩, ⟨(-13182), 32122⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-983182439), (-655454959)⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3311784857, 3639512337⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨106532718, 281779243⟩, ⟨51504470, 107080114⟩, ⟨6091745, 13381605⟩, ⟨(-24136), 865832⟩, ⟨(-6844), 74267⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4401500014, 4576746539⟩, ⟨51504470, 107080114⟩, ⟨6091745, 13381605⟩, ⟨(-24136), 865832⟩, ⟨(-6844), 74267⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4347907383, 4433618918⟩, ⟨24946890, 52888154⟩, ⟨2635170, 6537767⟩, ⟨(-91447), 412526⟩, ⟨(-13314), 36997⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3352606163, 3757004335⟩, ⟨(-149917475), (-121066642)⟩, ⟨14124, 4588253⟩, ⟨(-326925), 249033⟩, ⟨(-27022), 34840⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5882813129, 8824219700⟩, ⟨1470703275, 1470703285⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8057684244, 18129789577⟩, ⟨4028842102, 6043263200⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8057684244, 18129789577⟩, ⟨4028842102, 6043263200⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18129789577), (-8057684244)⟩, ⟨(-6043263200), (-4028842102)⟩, ⟨(-503605268), (-503605260)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9064894789), (-4028842122)⟩, ⟨(-3021631600), (-2014421051)⟩, ⟨(-251802634), (-251802630)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨520408417, 1681028886⟩, ⟨(-1182651614), (-244081409)⟩, ⟨(-41314899), 385504342⟩, ⟨(-80864522), 55912571⟩, ⟨(-21134574), 15433715⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨406225320, 1470472853⟩, ⟨(-1093196415), (-205196658)⟩, ⟨(-29258149), 380295007⟩, ⟨(-85583441), 50448066⟩, ⟨(-20562317), 16838673⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨819318698, 819318699⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4384044248, 4384044250⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1702
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨655454959, 983182439⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4347907383, 4433618918⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1703
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (16403385 / 1073741824)

theorem envelope_integral : (∫ s in ((15261 / 100000) : ℝ)..(45783 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((15261 / 100000) : ℝ)..(45783 / 200000), prawitzNormalCorrection
