...
namespace FiniteNormalPanel154_9
...
def j2 : Jet := ⟨⟨439721231, 439721235⟩, ⟨439721231, 439721235⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨45018913, 45018915⟩, ⟨90037826, 90037830⟩, ⟨45018913, 45018915⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-993), (-992)⟩, ⟨(-1985), (-1983)⟩, ⟨(-993), (-990)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112063, 5112065⟩, ⟨(-1985), (-1983)⟩, ⟨(-993), (-990)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨53583, 53584⟩, ⟨107146, 107148⟩, ⟨53530, 53533⟩, ⟨(-42), (-39)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143111994), (-143111992)⟩, ⟨107146, 107148⟩, ⟨53530, 53533⟩, ⟨(-42), (-39)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1500069), (-1500068)⟩, ⟨(-2999015), (-2999013)⟩, ⟨(-1497262), (-1497259)⟩, ⟨2244, 2247⟩, ⟨559, 562⟩⟩
...
def j19 : Jet := ⟨⟨1430155696, 1430155698⟩, ⟨(-2999015), (-2999013)⟩, ⟨(-1497262), (-1497259)⟩, ⟨2244, 2247⟩, ⟨559, 562⟩⟩
...
def j25 : Jet := ⟨⟨124, 125⟩, ⟨247, 249⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852053), (-852051)⟩, ⟨247, 249⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8932), (-8931)⟩, ⟨(-17861), (-17859)⟩, ⟨(-8926), (-8923)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782462, 35782464⟩, ⟨(-17861), (-17859)⟩, ⟨(-8926), (-8923)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨375063, 375065⟩, ⟨749939, 749942⟩, ⟨374594, 374598⟩, ⟨(-376), (-373)⟩, ⟨(-95), (-91)⟩⟩
...
def j33 : Jet := ⟨⟨(-715452820), (-715452817)⟩, ⟨749939, 749942⟩, ⟨374594, 374598⟩, ⟨(-376), (-373)⟩, ⟨(-95), (-91)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7499222), (-7499220)⟩, ⟨(-14990583), (-14990580)⟩, ⟨(-7479575), (-7479571)⟩, ⟨15708, 15711⟩, ⟨3917, 3920⟩⟩
...
def j36 : Jet := ⟨⟨4287468074, 4287468076⟩, ⟨(-14990583), (-14990580)⟩, ⟨(-7479575), (-7479571)⟩, ⟨15708, 15711⟩, ⟨3917, 3920⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨146420165, 146420168⟩, ⟨146113124, 146113128⟩, ⟨(-460332), (-460330)⟩, ⟨(-153062), (-153059)⟩, ⟨286, 289⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302479632, 4302479635⟩, ⟨15043065, 15043070⟩, ⟨7558354, 7558361⟩, ⟨36902, 36909⟩, ⟨9323, 9331⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨146676268, 146676272⟩, ⟨146881524, 146881530⟩, ⟨308293, 308298⟩, ⟨103447, 103454⟩, ⟨510, 519⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-139967616), (-139967615)⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4154999680, 4154999681⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5009101, 5009102⟩, ⟨10032222, 10032224⟩, ⟨5044186, 5044190⟩, ⟨28150, 28156⟩, ⟨7130, 7135⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299976397, 4299976398⟩, ⟨10032222, 10032224⟩, ⟨5044186, 5044190⟩, ⟨28150, 28156⟩, ⟨7130, 7135⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297471116, 4297471118⟩, ⟨5013188, 5013190⟩, ⟨2517699, 2517702⟩, ⟨11129, 11134⟩, ⟨2812, 2817⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4157421903, 4157421907⟩, ⟨(-135199399), (-135199394)⟩, ⟨2272276, 2272281⟩, ⟨(-71283), (-71276)⟩, ⟨2357, 2364⟩⟩
...
def j47 : Jet := ⟨⟨1728862643, 1728862657⟩, ⟨1728862643, 1728862657⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨695922886, 695922898⟩, ⟨1391845772, 1391845796⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨695922886, 695922898⟩, ⟨1391845772, 1391845796⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-695922898), (-695922886)⟩, ⟨(-1391845796), (-1391845772)⟩, ⟨(-695922898), (-695922886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-347961449), (-347961443)⟩, ⟨(-695922898), (-695922886)⟩, ⟨(-347961449), (-347961443)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3960728024, 3960728030⟩, ⟨(-641765383), (-641765370)⟩, ⟨(-268889373), (-268889364)⟩, ⟨49185121, 49185125⟩, ⟨8899788, 8899790⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3833886570, 3833886581⟩, ⟨(-745891015), (-745890995)⟩, ⟨(-237980956), (-237980937)⟩, ⟨55668961, 55668977⟩, ⟨6937061, 6937077⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 279935231⟩, ⟨139967615, 139967616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 879442466⟩, ⟨439721231, 439721235⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 180075656⟩, ⟨0, 180075658⟩, ⟨45018913, 45018915⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3970), 0⟩, ⟨(-3970), 2⟩, ⟨(-993), (-988)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109086, 5113057⟩, ⟨(-3970), 2⟩, ⟨(-993), (-988)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 214376⟩, ⟨(-167), 214377⟩, ⟨53343, 53595⟩, ⟨(-84), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142951200)⟩, ⟨(-167), 214377⟩, ⟨53343, 53595⟩, ⟨(-84), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6002522), 0⟩, ⟨(-6002530), 8989⟩, ⟨(-1500639), (-1487146)⟩, ⟨(-6), 4497⟩, ⟨554, 563⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425653243, 1431655766⟩, ⟨(-6002530), 8989⟩, ⟨(-1500639), (-1487146)⟩, ⟨(-6), 4497⟩, ⟨554, 563⟩⟩
...
def j72 : Jet := ⟨⟨0, 497⟩, ⟨(-1), 497⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851679)⟩, ⟨(-1), 497⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-35730), 0⟩, ⟨(-35731), 21⟩, ⟨(-8934), (-8900)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35755664, 35791395⟩, ⟨(-35731), 21⟩, ⟨(-8934), (-8900)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1500631⟩, ⟨(-1499), 1500632⟩, ⟨372909, 375159⟩, ⟨(-751), 2⟩, ⟨(-96), (-91)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714327251)⟩, ⟨(-1499), 1500632⟩, ⟨372909, 375159⟩, ⟨(-751), 2⟩, ⟨(-96), (-91)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30012610), 0⟩, ⟨(-30012673), 62918⟩, ⟨(-7503216), (-7408774)⟩, ⟨(-48), 31461⟩, ⟨3871, 3934⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264954686, 4294967296⟩, ⟨(-30012673), 62918⟩, ⟨(-7503216), (-7408774)⟩, ⟨(-48), 31461⟩, ⟨3871, 3934⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 293147489⟩, ⟨144730116, 146575587⟩, ⟨(-921816), 921⟩, ⟨(-153639), (-151333)⟩, ⟨(-1), 577⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4325191106⟩, ⟨(-63807), 30436561⟩, ⟨7408328, 7823373⟩, ⟨(-32135), 108651⟩, ⟨8369, 10633⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 295210377⟩, ⟨144725760, 149684453⟩, ⟨(-930481), 1573621⟩, ⟨86194, 123088⟩, ⟨(-3868), 5021⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-279935231), 0⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4015032065, 4294967296⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20290997⟩, ⟨0, 20576830⟩, ⟨4748852, 5432996⟩, ⟨(-64858), 126608⟩, ⟨4935, 9849⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315258293⟩, ⟨0, 20576830⟩, ⟨4748852, 5432996⟩, ⟨(-64858), 126608⟩, ⟨4935, 9849⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305100840⟩, ⟨0, 10288415⟩, ⟨2356542, 2716498⟩, ⟨(-38937), 63304⟩, ⟨1452, 4373⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4015032065, 4305100840⟩, ⟨(-140297856), (-129679200)⟩, ⟨1867661, 2716498⟩, ⟨(-127465), (-13492)⟩, ⟨(-706), 5642⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3457725301⟩, ⟨1728862643, 1728862657⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2783691571⟩, ⟨0, 2783691582⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2783691571⟩, ⟨0, 2783691582⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2783691571), 0⟩, ⟨(-2783691582), 0⟩, ⟨(-695922898), (-695922886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1391845786), 0⟩, ⟨(-1391845791), 0⟩, ⟨(-347961449), (-347961443)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3106136248, 4294967296⟩, ⟨(-1391845791), 0⟩, ⟨(-347961449), (-26123201)⟩, ⟨0, 112761902⟩, ⟨(-8077329), 14095238⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2903686052, 4305100840⟩, ⟨(-1535427568), (-93784477)⟩, ⟨(-347431731), 23761476⟩, ⟨(-219041), 124384580⟩, ⟨(-12000614), 14164085⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297471116, 4297471118⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3108
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305100840⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3109
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (244897445 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(26071 / 400000), prawitzNormalCorrection
