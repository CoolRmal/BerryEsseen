...
namespace FiniteNormalPanel87_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (10577 / 40000)
def radius : Rat := (1511 / 40000)

def j0 : Jet := ⟨⟨1135696727, 1135696728⟩, ⟨162242389, 162242390⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3567896494, 3567896498⟩, ⟨509699497, 509699501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2963907409, 2963907417⟩, ⟨846830684, 846830694⟩, ⟨60487905, 60487907⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨741, 743⟩, ⟨211, 213⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93946), (-93943)⟩, ⟨211, 213⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-64832), (-64828)⟩, ⟨(-18379), (-18375)⟩, ⟨(-1273), (-1269)⟩, ⟨4, 7⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5048224, 5048229⟩, ⟨(-18379), (-18375)⟩, ⟨(-1273), (-1269)⟩, ⟨4, 7⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3483721, 3483725⟩, ⟨982664, 982670⟩, ⟨66593, 66600⟩, ⟨(-508), (-503)⟩, ⟨(-18), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-139681856), (-139681851)⟩, ⟨982664, 982670⟩, ⟨66593, 66600⟩, ⟨(-508), (-503)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-96392839), (-96392834)⟩, ⟨(-26862687), (-26862679)⟩, ⟨(-1727496), (-1727488)⟩, ⟨26618, 26625⟩, ⟨823, 830⟩⟩
...
def j19 : Jet := ⟨⟨1335262926, 1335262932⟩, ⟨(-26862687), (-26862679)⟩, ⟨(-1727496), (-1727488)⟩, ⟨26618, 26625⟩, ⟨823, 830⟩⟩
...
def j25 : Jet := ⟨⟨8115, 8118⟩, ⟨2302, 2306⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844062), (-844058)⟩, ⟨2302, 2306⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-582478), (-582474)⟩, ⟨(-164835), (-164829)⟩, ⟨(-11326), (-11320)⟩, ⟨61, 65⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35208916, 35208921⟩, ⟨(-164835), (-164829)⟩, ⟨(-11326), (-11320)⟩, ⟨61, 65⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨24297266, 24297271⟩, ⟨6828325, 6828332⟩, ⟨455545, 455553⟩, ⟨(-4514), (-4507)⟩, ⟨(-148), (-143)⟩⟩
...
def j33 : Jet := ⟨⟨(-691530617), (-691530611)⟩, ⟨6828325, 6828332⟩, ⟨455545, 455553⟩, ⟨(-4514), (-4507)⟩, ⟨(-148), (-143)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-477217307), (-477217301)⟩, ⟨(-131635655), (-131635645)⟩, ⟨(-8078435), (-8078426)⟩, ⟨182868, 182878⟩, ⟨5421, 5430⟩⟩
...
def j36 : Jet := ⟨⟨3817749989, 3817749995⟩, ⟨(-131635655), (-131635645)⟩, ⟨(-8078435), (-8078426)⟩, ⟨182868, 182878⟩, ⟨5421, 5430⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1109223792, 1109223799⟩, ⟨136145286, 136145297⟩, ⟨(-4622952), (-4622943)⟩, ⟨(-182898), (-182889)⟩, ⟨3841, 3850⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4831836578, 4831836587⟩, ⟨166601250, 166601265⟩, ⟨15968645, 15968660⟩, ⟨671672, 671689⟩, ⟨42094, 42111⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1247876345, 1247876356⟩, ⟨196190048, 196190066⟩, ⟨4204320, 4204338⟩, ⟨294567, 294587⟩, ⟨12199, 12218⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1135696728), (-1135696727)⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3159270568, 3159270569⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨362562800, 362562808⟩, ⟨114003624, 114003638⟩, ⟨11404854, 11404868⟩, ⟨555266, 555284⟩, ⟨38113, 38130⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4657530096, 4657530104⟩, ⟨114003624, 114003638⟩, ⟨11404854, 11404868⟩, ⟨555266, 555284⟩, ⟨38113, 38130⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4472576376, 4472576381⟩, ⟨54738230, 54738238⟩, ⟨5141018, 5141026⟩, ⟨203687, 203699⟩, ⟨12851, 12862⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3289915366, 3289915372⟩, ⟨(-128687501), (-128687491)⟩, ⟨1713867, 1713875⟩, ⟨(-44376), (-44365)⟩, ⟨1757, 1767⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨35408741178, 35408741181⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value411

def j47 : Jet := ⟨⟨9362956383, 9362956394⟩, ⟨1337565192, 1337565202⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20411087253, 20411087302⟩, ⟨5831739190, 5831739242⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20411087253, 20411087302⟩, ⟨5831739190, 5831739242⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20411087302), (-20411087253)⟩, ⟨(-5831739242), (-5831739190)⟩, ⟨(-416552804), (-416552797)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10205543651), (-10205543626)⟩, ⟨(-2915869621), (-2915869595)⟩, ⟨(-208276402), (-208276398)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨399029723, 399029735⟩, ⟨(-270902804), (-270902793)⟩, ⟨72608266, 72608273⟩, ⟨(-7673396), (-7673392)⟩, ⟨(-458128), (-458126)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨305654019, 305654030⟩, ⟨(-219465570), (-219465557)⟩, ⟨63893555, 63893565⟩, ⟨(-8165512), (-8165504)⟩, ⟨(-89076), (-89069)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨973454337, 1297939117⟩, ⟨162242389, 162242390⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3058196993, 4077595995⟩, ⟨509699497, 509699501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2177564624, 3871226008⟩, ⟨725854872, 967806506⟩, ⟨60487905, 60487907⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨545, 970⟩, ⟨181, 243⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94142), (-93716)⟩, ⟨181, 243⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-84854), (-47514)⟩, ⟨(-21123), (-15618)⟩, ⟨(-1289), (-1249)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5028202, 5065543⟩, ⟨(-21123), (-15618)⟩, ⟨(-1289), (-1249)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2549317, 4565777⟩, ⟨830732, 1133527⟩, ⟨64892, 68069⟩, ⟨(-587), (-422)⟩, ⟨(-19), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140616260), (-138599799)⟩, ⟨830732, 1133527⟩, ⟨64892, 68069⟩, ⟨(-587), (-422)⟩, ⟨(-19), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-126743066), (-70270621)⟩, ⟨(-31264583), (-22401846)⟩, ⟨(-1807067), (-1635183)⟩, ⟨22135, 31090⟩, ⟨762, 881⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1304912699, 1361385145⟩, ⟨(-31264583), (-22401846)⟩, ⟨(-1807067), (-1635183)⟩, ⟨22135, 31090⟩, ⟨762, 881⟩⟩
...
def j72 : Jet := ⟨⟨5950, 10620⟩, ⟨1960, 2646⟩, ⟨157, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846227), (-841556)⟩, ⟨1960, 2646⟩, ⟨157, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-762739), (-426672)⟩, ⟨(-189692), (-139839)⟩, ⟨(-11508), (-11108)⟩, ⟨51, 75⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35028655, 35364723⟩, ⟨(-189692), (-139839)⟩, ⟨(-11508), (-11108)⟩, ⟨51, 75⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17759660, 31875641⟩, ⟨5748909, 7898013⟩, ⟨440205, 468794⟩, ⟨(-5241), (-3778)⟩, ⟨(-155), (-136)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698068223), (-683952241)⟩, ⟨5748909, 7898013⟩, ⟨440205, 468794⟩, ⟨(-5241), (-3778)⟩, ⟨(-155), (-136)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-629196843), (-346766366)⟩, ⟨(-154384494), (-108469992)⟩, ⟨(-8636444), (-7430156)⟩, ⟨150635, 214953⟩, ⟨4878, 5897⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3665770453, 3948200930⟩, ⟨(-154384494), (-108469992)⟩, ⟨(-8636444), (-7430156)⟩, ⟨150635, 214953⟩, ⟨4878, 5897⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨929152614, 1292484490⟩, ⟨125176507, 145609508⟩, ⟨(-5425894), (-3822827)⟩, ⟨(-198691), (-164536)⟩, ⟨3168, 4527⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4672189789, 5032160173⟩, ⟨128360333, 211930212⟩, ⟨12319113, 20781092⟩, ⟨306040, 1182511⟩, ⟨12535, 87273⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1010759117, 1514327940⟩, ⟨163939486, 234378241⟩, ⟨48908, 9280007⟩, ⟨(-75284), 767146⟩, ⟨(-20983), 55778⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1297939117), (-973454337)⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2997028179, 3321512959⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨237867700, 533924697⟩, ⟨77161626, 165275076⟩, ⟨6280610, 19334049⟩, ⟨(-49356), 1553794⟩, ⟨(-23016), 143114⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4532834996, 4828891993⟩, ⟨77161626, 165275076⟩, ⟨6280610, 19334049⟩, ⟨(-49356), 1553794⟩, ⟨(-23016), 143114⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4412298501, 4554111680⟩, ⟨36385434, 80440053⟩, ⟨2251197, 9259937⟩, ⟨(-192839), 737675⟩, ⟨(-34368), 72597⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3078901893, 3521922269⟩, ⟨(-146641815), (-104466260)⟩, ⟨(-1467739), 5786714⟩, ⟨(-498928), 485443⟩, ⟨(-54445), 63428⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8025391182, 10700521587⟩, ⟨1337565192, 1337565202⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14995900826, 26659379303⟩, ⟨4998633590, 6664844844⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14995900826, 26659379303⟩, ⟨4998633590, 6664844844⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-26659379303), (-14995900826)⟩, ⟨(-6664844844), (-4998633590)⟩, ⟨(-416552804), (-416552797)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13329689652), (-7497950413)⟩, ⟨(-3332422422), (-2499316795)⟩, ⟨(-208276402), (-208276398)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨192797224, 749530195⟩, ⟨(-581553027), (-112192085)⟩, ⟨(-3703794), 216261266⟩, ⟨(-52304626), 19758797⟩, ⟨(-9076257), 10235465⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨138209140, 614623327⟩, ⟨(-502471120), (-85115718)⟩, ⟨(-564453), 198202367⟩, ⟨(-51144749), 16612352⟩, ⟨(-8266391), 10549023⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1135696727, 1135696728⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4472576376, 4472576381⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar411 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1756
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar411 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨973454337, 1297939117⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4412298501, 4554111680⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1757
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((4533 / 20000) : ℝ)..(1511 / 5000), prawitzNormalCorrection
      ((34351 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
