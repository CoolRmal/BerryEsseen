...
namespace FiniteNormalPanel145_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (13099 / 80000)
def radius : Rat := (13099 / 400000)

def j0 : Jet := ⟨⟨703247207, 703247208⟩, ⟨140649441, 140649442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2209316259, 2209316263⟩, ⟨441863250, 441863254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1136464609, 1136464614⟩, ⟨454585842, 454585848⟩, ⟨45458584, 45458585⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨284, 285⟩, ⟨113, 114⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94403), (-94401)⟩, ⟨113, 114⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-24980), (-24978)⟩, ⟨(-9963), (-9960)⟩, ⟨(-987), (-982)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5088076, 5088079⟩, ⟨(-9963), (-9960)⟩, ⟨(-987), (-982)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1346324, 1346325⟩, ⟨535892, 535895⟩, ⟨52535, 52540⟩, ⟨(-211), (-206)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141819253), (-141819251)⟩, ⟨535892, 535895⟩, ⟨52535, 52540⟩, ⟨(-211), (-206)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-37525912), (-37525910)⟩, ⟨(-14868566), (-14868564)⟩, ⟨(-1430418), (-1430413)⟩, ⟨11175, 11179⟩, ⟨530, 534⟩⟩
...
def j19 : Jet := ⟨⟨1394129853, 1394129856⟩, ⟨(-14868566), (-14868564)⟩, ⟨(-1430418), (-1430413)⟩, ⟨11175, 11179⟩, ⟨530, 534⟩⟩
...
def j25 : Jet := ⟨⟨3123, 3125⟩, ⟨1245, 1248⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849054), (-849051)⟩, ⟨1245, 1248⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-224663), (-224662)⟩, ⟨(-89537), (-89533)⟩, ⟨(-8824), (-8820)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35566731, 35566733⟩, ⟨(-89537), (-89533)⟩, ⟨(-8824), (-8820)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9411091, 9411093⟩, ⟨3740744, 3740747⟩, ⟨364631, 364635⟩, ⟨(-1876), (-1872)⟩, ⟨(-93), (-89)⟩⟩
...
def j33 : Jet := ⟨⟨(-706416792), (-706416789)⟩, ⟨3740744, 3740747⟩, ⟨364631, 364635⟩, ⟨(-1876), (-1872)⟩, ⟨(-93), (-89)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-186920559), (-186920557)⟩, ⟨(-73778409), (-73778406)⟩, ⟨(-6984415), (-6984411)⟩, ⟨77688, 77692⟩, ⟨3635, 3639⟩⟩
...
def j36 : Jet := ⟨⟨4108046737, 4108046739⟩, ⟨(-73778409), (-73778406)⟩, ⟨(-6984415), (-6984411)⟩, ⟨77688, 77692⟩, ⟨3635, 3639⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨717135554, 717135557⟩, ⟨135778771, 135778775⟩, ⟨(-2265471), (-2265466)⟩, ⟨(-141413), (-141408)⟩, ⟨1421, 1426⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4490392939, 4490392943⟩, ⟨80645147, 80645152⟩, ⟨9082812, 9082819⟩, ⟨215308, 215318⟩, ⟨13804, 13814⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨749765994, 749765999⟩, ⟨155422262, 155422269⟩, ⟨1697486, 1697495⟩, ⟨132703, 132713⟩, ⟨3148, 3160⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-703247208), (-703247207)⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3591720088, 3591720089⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨130885524, 130885526⟩, ⟨54263660, 54263666⟩, ⟨6216929, 6216937⟩, ⟨169184, 169192⟩, ⟨11372, 11381⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4425852820, 4425852822⟩, ⟨54263660, 54263666⟩, ⟨6216929, 6216937⟩, ⟨169184, 169192⟩, ⟨11372, 11381⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4359918934, 4359918936⟩, ⟨26727635, 26727639⟩, ⟨2980231, 2980237⟩, ⟨65061, 65067⟩, ⟨4183, 4190⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3646036707, 3646036710⟩, ⟨(-120425128), (-120425121)⟩, ⟨1616991, 1616998⟩, ⟨(-43188), (-43181)⟩, ⟨1367, 1374⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨44749027510, 44749027517⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value596

def j47 : Jet := ⟨⟨7327093885, 7327093897⟩, ⟨1465418772, 1465418784⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12499816901, 12499816943⟩, ⟨4999926742, 4999926794⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12499816901, 12499816943⟩, ⟨4999926742, 4999926794⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12499816943), (-12499816901)⟩, ⟨(-4999926794), (-4999926742)⟩, ⟨(-499992681), (-499992672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6249908472), (-6249908450)⟩, ⟨(-2499963397), (-2499963371)⟩, ⟨(-249996341), (-249996336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1002276308, 1002276328⟩, ⟨(-583393065), (-583393047)⟩, ⟨111447928, 111447939⟩, ⟨1014868, 1014873⟩, ⟨(-3391196), (-3391194)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨850841451, 850841470⟩, ⟨(-523350153), (-523350133)⟩, ⟨111344057, 111344071⟩, ⟨(-2493040), (-2493029)⟩, ⟨(-2859132), (-2859123)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨562597766, 843896650⟩, ⟨140649441, 140649442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1767453008, 2651179517⟩, ⟨441863250, 441863254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨727337350, 1636509046⟩, ⟨363668672, 545503018⟩, ⟨45458584, 45458585⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨182, 410⟩, ⟨91, 137⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94505), (-94276)⟩, ⟨91, 137⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-36010), (-15965)⟩, ⟨(-11989), (-7929)⟩, ⟨(-993), (-974)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5077046, 5097092⟩, ⟨(-11989), (-7929)⟩, ⟨(-993), (-974)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨859779, 1942143⟩, ⟨425320, 646039⟩, ⟨51834, 53114⟩, ⟨(-254), (-163)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142305798), (-141223433)⟩, ⟨425320, 646039⟩, ⟨51834, 53114⟩, ⟨(-254), (-163)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-54222701), (-23915683)⟩, ⟨(-18002208), (-11711681)⟩, ⟨(-1461397), (-1392438)⟩, ⟨8792, 13557⟩, ⟨510, 549⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1377433064, 1407740083⟩, ⟨(-18002208), (-11711681)⟩, ⟨(-1461397), (-1392438)⟩, ⟨8792, 13557⟩, ⟨510, 549⟩⟩
...
def j72 : Jet := ⟨⟨1997, 4504⟩, ⟨992, 1501⟩, ⟨121, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850180), (-847672)⟩, ⟨992, 1501⟩, ⟨121, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-323944), (-143550)⟩, ⟨(-107815), (-71203)⟩, ⟨(-8896), (-8731)⟩, ⟨19, 33⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35467450, 35647845⟩, ⟨(-107815), (-71203)⟩, ⟨(-8896), (-8731)⟩, ⟨19, 33⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6006285, 13582879⟩, ⟨2962061, 4515570⟩, ⟨358308, 369797⟩, ⟨(-2269), (-1479)⟩, ⟨(-95), (-86)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709821598), (-702245003)⟩, ⟨2962061, 4515570⟩, ⟨358308, 369797⟩, ⟨(-2269), (-1479)⟩, ⟨(-95), (-86)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-270462937), (-118922679)⟩, ⟨(-89652699), (-57740773)⟩, ⟨(-7201375), (-6718241)⟩, ⟨60824, 94512⟩, ⟨3466, 3775⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4024504359, 4176044617⟩, ⟨(-89652699), (-57740773)⟩, ⟨(-7201375), (-6718241)⟩, ⟨60824, 94512⟩, ⟨3466, 3775⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨566837427, 868963933⟩, ⟨130597028, 140007765⟩, ⟨(-2754141), (-1777901)⟩, ⟨(-146730), (-134884)⟩, ⟨1113, 1734⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4417276577, 4583606435⟩, ⟨61076206, 102107653⟩, ⟨7950803, 10476446⟩, ⟨104453, 349332⟩, ⟨7779, 21803⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨582979454, 927361817⟩, ⟨142376746, 170075419⟩, ⟨(-32764), 3619596⟩, ⟨33476, 248184⟩, ⟨(-4862), 12442⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-843896650), (-562597766)⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3451070646, 3732369530⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨79130996, 200234340⟩, ⟨38651152, 73444774⟩, ⟨4705592, 8297852⟩, ⟨6490, 393840⟩, ⟨90, 28081⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4374098292, 4495201636⟩, ⟨38651152, 73444774⟩, ⟨4705592, 8297852⟩, ⟨6490, 393840⟩, ⟨90, 28081⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4334352213, 4393944016⟩, ⟨18890253, 36388703⟩, ⟨2149119, 4070062⟩, ⟨(-30956), 185765⟩, ⟨(-3427), 13641⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3482717017, 3818381290⟩, ⟨(-128712082), (-110317051)⟩, ⟨535209, 2918317⟩, ⟨(-160187), 91054⟩, ⟨(-9063), 12869⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5861675112, 8792512681⟩, ⟨1465418772, 1465418784⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7999882828, 17999736417⟩, ⟨3999941396, 5999912156⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7999882828, 17999736417⟩, ⟨3999941396, 5999912156⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17999736417), (-7999882828)⟩, ⟨(-5999912156), (-3999941396)⟩, ⟨(-499992681), (-499992672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8999868209), (-3999941414)⟩, ⟨(-2999956078), (-1999970698)⟩, ⟨(-249996341), (-249996336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨528347442, 1692378625⟩, ⟨(-1182095507), (-246027345)⟩, ⟨(-41226094), 382082625⟩, ⟨(-79412264), 55469230⟩, ⟨(-20805966), 15066824⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨428428088, 1504585817⟩, ⟨(-1101643068), (-213070155)⟩, ⟨(-30266392), 376260379⟩, ⟨(-82916996), 50554842⟩, ⟨(-20216212), 16083564⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨703247207, 703247208⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4359918934, 4359918936⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar596 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2922
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar596 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨562597766, 843896650⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4334352213, 4393944016⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2923
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((13099 / 100000) : ℝ)..(39297 / 200000), prawitzNormalCorrection
      ((33627 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
