...
namespace FiniteNormalPanel40_15
...
def j2 : Jet := ⟨⟨580588545, 580588550⟩, ⟨580588545, 580588550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨78483265, 78483267⟩, ⟨156966530, 156966534⟩, ⟨78483265, 78483267⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1730), (-1729)⟩, ⟨(-3460), (-3458)⟩, ⟨(-1729), (-1726)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111326, 5111328⟩, ⟨(-3460), (-3458)⟩, ⟨(-1729), (-1726)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨93400, 93401⟩, ⟨186737, 186739⟩, ⟨93241, 93244⟩, ⟨(-128), (-125)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-143072177), (-143072175)⟩, ⟨186737, 186739⟩, ⟨93241, 93244⟩, ⟨(-128), (-125)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2614403), (-2614402)⟩, ⟨(-5225393), (-5225391)⟩, ⟨(-2605876), (-2605873)⟩, ⟨6816, 6819⟩, ⟨1697, 1700⟩⟩
...
def j19 : Jet := ⟨⟨1429041362, 1429041364⟩, ⟨(-5225393), (-5225391)⟩, ⟨(-2605876), (-2605873)⟩, ⟨6816, 6819⟩, ⟨1697, 1700⟩⟩
...
def j25 : Jet := ⟨⟨216, 217⟩, ⟨431, 433⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851961), (-851959)⟩, ⟨431, 433⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-15569), (-15568)⟩, ⟨(-31130), (-31128)⟩, ⟨(-15551), (-15548)⟩, ⟨13, 16⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35775825, 35775827⟩, ⟨(-31130), (-31128)⟩, ⟨(-15551), (-15548)⟩, ⟨13, 16⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨653742, 653743⟩, ⟨1306916, 1306918⟩, ⟨652319, 652322⟩, ⟨(-1138), (-1135)⟩, ⟨(-285), (-282)⟩⟩
...
def j33 : Jet := ⟨⟨(-715174141), (-715174139)⟩, ⟨1306916, 1306918⟩, ⟨652319, 652322⟩, ⟨(-1138), (-1135)⟩, ⟨(-285), (-282)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-13068599), (-13068598)⟩, ⟨(-26113316), (-26113314)⟩, ⟨(-13008916), (-13008913)⟩, ⟨47700, 47703⟩, ⟨11872, 11875⟩⟩
...
def j36 : Jet := ⟨⟨4281898697, 4281898698⟩, ⟨(-26113316), (-26113314)⟩, ⟨(-13008916), (-13008913)⟩, ⟨47700, 47703⟩, ⟨11872, 11875⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨193176103, 193176106⟩, ⟨192469740, 192469744⟩, ⟨(-1058623), (-1058620)⟩, ⟨(-351339), (-351336)⟩, ⟨1150, 1152⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4308075780, 4308075782⟩, ⟨26272955, 26272959⟩, ⟨13248667, 13248673⟩, ⟨112621, 112628⟩, ⟨28695, 28703⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨193765687, 193765691⟩, ⟨194238855, 194238861⟩, ⟨711401, 711407⟩, ⟨239887, 239894⟩, ⟨2073, 2081⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-184807075), (-184807074)⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4110160221, 4110160222⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8741659, 8741660⟩, ⟨17526012, 17526014⟩, ⟨8848593, 8848596⟩, ⟨85988, 85994⟩, ⟨21999, 22006⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303708955, 4303708956⟩, ⟨17526012, 17526014⟩, ⟨8848593, 8848596⟩, ⟨85988, 85994⟩, ⟨21999, 22006⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299335903, 4299335905⟩, ⟨8754101, 8754103⟩, ⟨4410888, 4410891⟩, ⟨33968, 33973⟩, ⟨8655, 8661⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4114340852, 4114340856⟩, ⟨(-176617629), (-176617624)⟩, ⟨3844414, 3844418⟩, ⟨(-157290), (-157282)⟩, ⟨6820, 6828⟩⟩
...
def j47 : Jet := ⟨⟨1201792132, 1201792140⟩, ⟨1201792132, 1201792140⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨336278306, 336278311⟩, ⟨672556612, 672556622⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨336278306, 336278311⟩, ⟨672556612, 672556622⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-336278311), (-336278306)⟩, ⟨(-672556622), (-672556612)⟩, ⟨(-336278311), (-336278306)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-168139156), (-168139153)⟩, ⟨(-336278311), (-336278306)⟩, ⟨(-168139156), (-168139153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4130076761, 4130076765⟩, ⟨(-323368060), (-323368054)⟩, ⟨(-149024835), (-149024831)⟩, ⟨12328807, 12328809⟩, ⟨2675684, 2675685⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3956384849, 3956384858⟩, ⟨(-479605699), (-479605686)⟩, ⟨(-125763182), (-125763170)⟩, ⟨17497813, 17497828⟩, ⟨1941178, 1941192⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 369614149⟩, ⟨184807074, 184807075⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1161177096⟩, ⟨580588545, 580588550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 313933066⟩, ⟨0, 313933068⟩, ⟨78483265, 78483267⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6921), 0⟩, ⟨(-6921), 6⟩, ⟨(-1731), (-1720)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106135, 5113057⟩, ⟨(-6921), 6⟩, ⟨(-1731), (-1720)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 373730⟩, ⟨(-506), 373731⟩, ⟨92672, 93434⟩, ⟨(-254), 2⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142791846)⟩, ⟨(-506), 373731⟩, ⟨92672, 93434⟩, ⟨(-254), 2⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-10464436), 0⟩, ⟨(-10464473), 27318⟩, ⟨(-2616146), (-2575131)⟩, ⟨(-29), 13661⟩, ⟨1671, 1709⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421191329, 1431655766⟩, ⟨(-10464473), 27318⟩, ⟨(-2616146), (-2575131)⟩, ⟨(-29), 13661⟩, ⟨1671, 1709⟩⟩
...
def j72 : Jet := ⟨⟨0, 866⟩, ⟨(-1), 866⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851310)⟩, ⟨(-1), 866⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-62289), 0⟩, ⟨(-62290), 64⟩, ⟨(-15574), (-15476)⟩, ⟨(-2), 32⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35729105, 35791395⟩, ⟨(-62290), 64⟩, ⟨(-15574), (-15476)⟩, ⟨(-2), 32⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2616109⟩, ⟨(-4553), 2616114⟩, ⟨647196, 654033⟩, ⟨(-2279), 5⟩, ⟨(-286), (-278)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713211773)⟩, ⟨(-4553), 2616114⟩, ⟨647196, 654033⟩, ⟨(-2279), 5⟩, ⟨(-286), (-278)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-52322178), 0⟩, ⟨(-52322512), 191221⟩, ⟨(-13080878), (-12793712)⟩, ⟨(-251), 95613⟩, ⟨11638, 11953⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4242645118, 4294967296⟩, ⟨(-52322512), 191221⟩, ⟨(-13080878), (-12793712)⟩, ⟨(-251), 95613⟩, ⟨11638, 11953⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 387059033⟩, ⟨189285795, 193536903⟩, ⟨(-2121870), 3693⟩, ⟨(-353656), (-344409)⟩, ⟨(-4), 2310⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4347934735⟩, ⟨(-195968), 53621000⟩, ⟨12791324, 14066790⟩, ⟨(-99226), 339062⟩, ⟨23598, 35777⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 391832417⟩, ⟨189268134, 200755968⟩, ⟨(-2156869), 3687661⟩, ⟨170281, 320113⟩, ⟨(-15843), 20873⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-369614149), 0⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3925353147, 4294967296⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 35747105⟩, ⟨0, 36630174⟩, ⟨7947012, 10056620⟩, ⟨(-201634), 403150⟩, ⟨10262, 36903⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4330714401⟩, ⟨0, 36630174⟩, ⟨7947012, 10056620⟩, ⟨(-201634), 403150⟩, ⟨10262, 36903⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4312803812⟩, ⟨0, 18315087⟩, ⟨3918183, 5028310⟩, ⟨(-122260), 201575⟩, ⟨1322, 17187⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3925353147, 4312803812⟩, ⟨(-185574558), (-166491987)⟩, ⟨2792917, 5028310⟩, ⟨(-338622), 32981⟩, ⟨(-7466), 22448⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2403584272⟩, ⟨1201792132, 1201792140⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1345113235⟩, ⟨0, 1345113240⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1345113235⟩, ⟨0, 1345113240⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1345113235), 0⟩, ⟨(-1345113240), 0⟩, ⟨(-336278311), (-336278306)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-672556618), 0⟩, ⟨(-672556620), 0⟩, ⟨(-168139156), (-168139153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3672424792, 4294967296⟩, ⟨(-672556620), 0⟩, ⟨(-168139156), (-91109468)⟩, ⟨0, 26329212⟩, ⟨752639, 3291152⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3356385094, 4312803812⟩, ⟨(-860924230), (-142359477)⟩, ⟨(-166449327), (-49181051)⟩, ⟨2405792, 33736400⟩, ⟨(-659230), 3321048⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299335903, 4299335905⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified794
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4312803812⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified795
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (336926129 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(34423 / 400000), prawitzNormalCorrection
