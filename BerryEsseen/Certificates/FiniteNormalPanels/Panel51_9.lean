...
namespace FiniteNormalPanel51_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (42919 / 160000)
def radius : Rat := (42919 / 800000)

def j0 : Jet := ⟨⟨1152098133, 1152098134⟩, ⟨230419626, 230419627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3619423030, 3619423035⟩, ⟨723884604, 723884608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3050133369, 3050133378⟩, ⟨1220053344, 1220053354⟩, ⟨122005334, 122005336⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨763, 765⟩, ⟨305, 306⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93924), (-93921)⟩, ⟨305, 306⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-66702), (-66699)⟩, ⟨(-26465), (-26461)⟩, ⟨(-2562), (-2557)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5046354, 5046358⟩, ⟨(-26465), (-26461)⟩, ⟨(-2562), (-2557)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3583741, 3583745⟩, ⟨1414701, 1414707⟩, ⟨134011, 134019⟩, ⟨(-1469), (-1464)⟩, ⟨(-69), (-65)⟩⟩
...
def j16 : Jet := ⟨⟨(-139581836), (-139581831)⟩, ⟨1414701, 1414707⟩, ⟨134011, 134019⟩, ⟨(-1469), (-1464)⟩, ⟨(-69), (-65)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-99126068), (-99126063)⟩, ⟨(-38645757), (-38645750)⟩, ⟨(-3468006), (-3467996)⟩, ⟨77209, 77219⟩, ⟨3338, 3347⟩⟩
...
def j19 : Jet := ⟨⟨1332529697, 1332529703⟩, ⟨(-38645757), (-38645750)⟩, ⟨(-3468006), (-3467996)⟩, ⟨77209, 77219⟩, ⟨3338, 3347⟩⟩
...
def j22 : Jet := ⟨⟨(-77), (-75)⟩, ⟨(-31), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11758, 11761⟩, ⟨(-31), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8350, 8353⟩, ⟨3317, 3320⟩, ⟨322, 325⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843827), (-843823)⟩, ⟨3317, 3320⟩, ⟨322, 325⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-599256), (-599253)⟩, ⟨(-237348), (-237343)⟩, ⟨(-22801), (-22795)⟩, ⟨182, 188⟩, ⟨7, 10⟩⟩
...
def j30 : Jet := ⟨⟨35192138, 35192142⟩, ⟨(-237348), (-237343)⟩, ⟨(-22801), (-22795)⟩, ⟨182, 188⟩, ⟨7, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨24992207, 24992211⟩, ⟨9828326, 9828333⟩, ⟨916072, 916080⟩, ⟨(-13091), (-13083)⟩, ⟨(-593), (-585)⟩⟩
...
def j33 : Jet := ⟨⟨(-690835676), (-690835671)⟩, ⟨9828326, 9828333⟩, ⟨916072, 916080⟩, ⟨(-13091), (-13083)⟩, ⟨(-593), (-585)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-490606985), (-490606979)⟩, ⟨(-189263067), (-189263057)⟩, ⟨(-16181828), (-16181817)⟩, ⟨530116, 530127⟩, ⟨21881, 21892⟩⟩
...
def j36 : Jet := ⟨⟨3804360311, 3804360317⟩, ⟨(-189263067), (-189263057)⟩, ⟨(-16181828), (-16181817)⟩, ⟨530116, 530127⟩, ⟨21881, 21892⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1122939557, 1122939564⟩, ⟨192020643, 192020654⟩, ⟨(-9435987), (-9435975)⟩, ⟨(-519443), (-519430)⟩, ⟨15824, 15836⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4848842521, 4848842530⟩, ⟨241224984, 241224999⟩, ⟨32625209, 32625229⟩, ⟨1973445, 1973465⟩, ⟨175428, 175451⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1267752859, 1267752871⟩, ⟨279852872, 279852890⟩, ⟨8661927, 8661949⟩, ⟨858184, 858209⟩, ⟨51106, 51133⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1152098134), (-1152098133)⟩, ⟨(-230419627), (-230419626)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3142869162, 3142869163⟩, ⟨(-230419627), (-230419626)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨374204784, 374204792⟩, ⟨165209302, 165209318⟩, ⟨23348254, 23348273⟩, ⟨1635414, 1635438⟩, ⟨159473, 159498⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4669172080, 4669172088⟩, ⟨165209302, 165209318⟩, ⟨23348254, 23348273⟩, ⟨1635414, 1635438⟩, ⟨159473, 159498⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4478162724, 4478162728⟩, ⟨79225409, 79225417⟩, ⟨10495746, 10495756⟩, ⟨598569, 598583⟩, ⟨53584, 53598⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3276923561, 3276923566⟩, ⟨(-182274145), (-182274136)⟩, ⟨3429982, 3429992⟩, ⟨(-125079), (-125066)⟩, ⟨7096, 7109⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨17843260284, 17843260289⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value300

def j47 : Jet := ⟨⟨4786343048, 4786343054⟩, ⟨957268607, 957268612⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5333935789, 5333935803⟩, ⟨2133574308, 2133574324⟩, ⟨213357430, 213357433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5333935789, 5333935803⟩, ⟨2133574308, 2133574324⟩, ⟨213357430, 213357433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5333935803), (-5333935789)⟩, ⟨(-2133574324), (-2133574308)⟩, ⟨(-213357433), (-213357430)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2666967902), (-2666967894)⟩, ⟨(-1066787162), (-1066787154)⟩, ⟨(-106678717), (-106678715)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2308255595, 2308255606⟩, ⟨(-573326240), (-573326232)⟩, ⟨13868972, 13868976⟩, ⟨8345283, 8345285⟩, ⟨(-690442), (-690441)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1761125667, 1761125679⟩, ⟨(-535389778), (-535389764)⟩, ⟨36756362, 36756375⟩, ⟨5253514, 5253528⟩, ⟨(-849370), (-849355)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨921678506, 1382517761⟩, ⟨230419626, 230419627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2895538423, 4343307642⟩, ⟨723884604, 723884608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1952085355, 4392192065⟩, ⟨976042674, 1464064024⟩, ⟨122005334, 122005336⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨488, 1101⟩, ⟨244, 367⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94199), (-93585)⟩, ⟨244, 367⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-96332), (-42534)⟩, ⟨(-32001), (-20891)⟩, ⟨(-2608), (-2500)⟩, ⟨12, 22⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5016724, 5070523⟩, ⟨(-32001), (-20891)⟩, ⟨(-2608), (-2500)⟩, ⟨12, 22⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2280127, 5185304⟩, ⟨1107337, 1718940⟩, ⟨128930, 138154⟩, ⟨(-1795), (-1138)⟩, ⟨(-73), (-61)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140885450), (-137980272)⟩, ⟨1107337, 1718940⟩, ⟨128930, 138154⟩, ⟨(-1795), (-1138)⟩, ⟨(-73), (-61)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-144074661), (-62712763)⟩, ⟨(-47521597), (-29598529)⟩, ⟨(-3691830), (-3192314)⟩, ⟨58918, 95407⟩, ⟨2975, 3640⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1287581104, 1368943003⟩, ⟨(-47521597), (-29598529)⟩, ⟨(-3691830), (-3192314)⟩, ⟨58918, 95407⟩, ⟨2975, 3640⟩⟩
...
def j70 : Jet := ⟨⟨(-111), (-48)⟩, ⟨(-37), (-24)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11724, 11788⟩, ⟨(-37), (-24)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5328, 12055⟩, ⟨2626, 4009⟩, ⟨315, 329⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846849), (-840121)⟩, ⟨2626, 4009⟩, ⟨315, 329⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-866020), (-381839)⟩, ⟨(-287481), (-186819)⟩, ⟨(-23318), (-22160)⟩, ⟨140, 227⟩, ⟨4, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34925374, 35409556⟩, ⟨(-287481), (-186819)⟩, ⟨(-23318), (-22160)⟩, ⟨140, 227⟩, ⟨4, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15873767, 36211119⟩, ⟨7642894, 11985463⟩, ⟨870267, 953339⟩, ⟨(-16053), (-10108)⟩, ⟨(-631), (-540)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699954116), (-679616763)⟩, ⟨7642894, 11985463⟩, ⟨870267, 953339⟩, ⟨(-16053), (-10108)⟩, ⟨(-631), (-540)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-715798912), (-308889413)⟩, ⟨(-235125903), (-142187929)⟩, ⟨(-17750897), (-14245075)⟩, ⟨398461, 660847⟩, ⟨18602, 24540⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3579168384, 3986077883⟩, ⟨(-235125903), (-142187929)⟩, ⟨(-17750897), (-14245075)⟩, ⟨398461, 660847⟩, ⟨18602, 24540⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨868048649, 1384350613⟩, ⟨168955703, 210770661⟩, ⟨(-11742792), (-7140772)⟩, ⟨(-582511), (-441559)⟩, ⟨11935, 19762⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4627793187, 5153919038⟩, ⟨165078642, 338575820⟩, ⟨22426919, 47802902⟩, ⟨535473, 4304278⟩, ⟨11384, 477413⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨935315532, 1661207290⟩, ⟨215412196, 362052249⟩, ⟨(-3064696), 24328897⟩, ⟨(-634248), 2982992⟩, ⟨(-140395), 334566⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1382517761), (-921678506)⟩, ⟨(-230419627), (-230419626)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2912449535, 3373288790⟩, ⟨(-230419627), (-230419626)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨203683773, 642521694⟩, ⟨93820678, 280069112⟩, ⟨8433175, 49339728⟩, ⟨(-1007320), 6409224⟩, ⟨(-232897), 899534⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4498651069, 4937488990⟩, ⟨93820678, 280069112⟩, ⟨8433175, 49339728⟩, ⟨(-1007320), 6409224⟩, ⟨(-232897), 899534⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4395629558, 4605035694⟩, ⟨43751750, 136827690⟩, ⟨1899919, 23887171⟩, ⟨(-1235689), 3112315⟩, ⟨(-275569), 477523⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2980709369, 3616818061⟩, ⟨(-217386020), (-128354878)⟩, ⟨(-6052286), 16413878⟩, ⟨(-2252034), 2342500⟩, ⟨(-383406), 441343⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3829074436, 5743611666⟩, ⟨957268607, 957268612⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3413718900, 7680867559⟩, ⟨1706859446, 2560289190⟩, ⟨213357430, 213357433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3413718900, 7680867559⟩, ⟨1706859446, 2560289190⟩, ⟨213357430, 213357433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7680867559), (-3413718900)⟩, ⟨(-2560289190), (-1706859446)⟩, ⟨(-213357433), (-213357430)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3840433780), (-1706859450)⟩, ⟨(-1280144595), (-853429723)⟩, ⟨(-106678717), (-106678715)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1756412312, 2886471314⟩, ⟨(-860332663), (-349007191)⟩, ⟨(-37019724), 84588141⟩, ⟨(-2624916), 17924000⟩, ⟨(-2386097), 655344⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1218950989, 2430715035⟩, ⟨(-870587590), (-294701450)⟩, ⟨(-24811967), 125808270⟩, ⟨(-11293207), 19754276⟩, ⟨(-3784935), 1755714⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1152098133, 1152098134⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4478162724, 4478162728⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar300 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1008
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar300 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨921678506, 1382517761⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4395629558, 4605035694⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1009
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((42919 / 200000) : ℝ)..(128757 / 400000), prawitzNormalCorrection
      ((185793 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
