...
namespace FiniteNormalPanel92_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (14609 / 50000)
def radius : Rat := (2087 / 50000)

def j0 : Jet := ⟨⟨1254903544, 1254903545⟩, ⟨179271934, 179271935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3942395754, 3942395759⟩, ⟨563199390, 563199395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3618766619, 3618766629⟩, ⟨1033933312, 1033933324⟩, ⟨73852379, 73852381⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨905, 907⟩, ⟨258, 260⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93782), (-93779)⟩, ⟨258, 260⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-79017), (-79014)⟩, ⟨(-22360), (-22355)⟩, ⟨(-1536), (-1532)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5034039, 5034043⟩, ⟨(-22360), (-22355)⟩, ⟨(-1536), (-1532)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4241478, 4241483⟩, ⟨1193011, 1193018⟩, ⟨79882, 79890⟩, ⟨(-749), (-743)⟩, ⟨(-26), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-138924099), (-138924093)⟩, ⟨1193011, 1193018⟩, ⟨79882, 79890⟩, ⟨(-749), (-743)⟩, ⟨(-26), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-117051856), (-117051850)⟩, ⟨(-32438205), (-32438196)⟩, ⟨(-2034314), (-2034303)⟩, ⟨39111, 39122⟩, ⟨1170, 1178⟩⟩
...
def j19 : Jet := ⟨⟨1314603909, 1314603916⟩, ⟨(-32438205), (-32438196)⟩, ⟨(-2034314), (-2034303)⟩, ⟨39111, 39122⟩, ⟨1170, 1178⟩⟩
...
def j22 : Jet := ⟨⟨(-91), (-90)⟩, ⟨(-26), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11744, 11746⟩, ⟨(-26), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9895, 9897⟩, ⟨2805, 2807⟩, ⟨192, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842282), (-842279)⟩, ⟨2805, 2807⟩, ⟨192, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-709673), (-709670)⟩, ⟨(-200401), (-200396)⟩, ⟨(-13648), (-13641)⟩, ⟨92, 97⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35081721, 35081725⟩, ⟨(-200401), (-200396)⟩, ⟨(-13648), (-13641)⟩, ⟨92, 97⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29558446, 29558450⟩, ⟨8276420, 8276427⟩, ⟨543490, 543500⟩, ⟨(-6655), (-6646)⟩, ⟨(-213), (-206)⟩⟩
...
def j33 : Jet := ⟨⟨(-686269437), (-686269432)⟩, ⟨8276420, 8276427⟩, ⟨543490, 543500⟩, ⟨(-6655), (-6646)⟩, ⟨(-213), (-206)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-578223015), (-578223008)⟩, ⟨(-158233198), (-158233187)⟩, ⟨(-9350155), (-9350141)⟩, ⟨267540, 267553⟩, ⟨7562, 7574⟩⟩
...
def j36 : Jet := ⟨⟨3716744281, 3716744288⟩, ⟨(-158233198), (-158233187)⟩, ⟨(-9350155), (-9350141)⟩, ⟨267540, 267553⟩, ⟨7562, 7574⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1206688785, 1206688794⟩, ⟨142608740, 142608752⟩, ⟨(-6120944), (-6120931)⟩, ⟨(-230860), (-230847)⟩, ⟨6201, 6213⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4963145872, 4963145883⟩, ⟨211296319, 211296336⟩, ⟨21481219, 21481242⟩, ⟨1088797, 1088820⟩, ⟨75065, 75090⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1394416313, 1394416327⟩, ⟨224159302, 224159324⟩, ⟨5977858, 5977883⟩, ⟨451253, 451280⟩, ⟨22434, 22461⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1254903545), (-1254903544)⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3040063751, 3040063752⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨452715171, 452715181⟩, ⟨145552394, 145552412⟩, ⟨15580708, 15580730⟩, ⟨916992, 917014⟩, ⟨69988, 70013⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4747682467, 4747682477⟩, ⟨145552394, 145552412⟩, ⟨15580708, 15580730⟩, ⟨916992, 917014⟩, ⟨69988, 70013⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4515655093, 4515655099⟩, ⟨69219499, 69219509⟩, ⟨6879100, 6879112⟩, ⟨330639, 330652⟩, ⟨22974, 22989⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3196270987, 3196270993⟩, ⟨(-139488499), (-139488489)⟩, ⟨1979941, 1979953⟩, ⟨(-53103), (-53090)⟩, ⟨2459, 2473⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨27610025463, 27610025466⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value426

def j47 : Jet := ⟨⟨8067097236, 8067097244⟩, ⟨1152442456, 1152442464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15152166088, 15152166119⟩, ⟨4329190286, 4329190322⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15152166088, 15152166119⟩, ⟨4329190286, 4329190322⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15152166119), (-15152166088)⟩, ⟨(-4329190322), (-4329190286)⟩, ⟨(-309227881), (-309227875)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7576083060), (-7576083044)⟩, ⟨(-2164595161), (-2164595143)⟩, ⟨(-154613941), (-154613937)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨736018253, 736018264⟩, ⟨(-370941492), (-370941482)⟩, ⟨66978479, 66978485⟩, ⟨(-2349717), (-2349714)⟩, ⟨(-909521), (-909519)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨547737299, 547737309⟩, ⟨(-299954698), (-299954686)⟩, ⟨62231137, 62231148⟩, ⟨(-4104013), (-4104003)⟩, ⟨(-564663), (-564653)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1075631609, 1434175480⟩, ⟨179271934, 179271935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3379196360, 4505595153⟩, ⟨563199390, 563199395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2658685678, 4726552331⟩, ⟨886228554, 1181638086⟩, ⟨73852379, 73852381⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨665, 1185⟩, ⟨221, 297⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94022), (-93501)⟩, ⟨221, 297⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-103470), (-57879)⟩, ⟨(-25732), (-18966)⟩, ⟨(-1561), (-1504)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5009586, 5055178⟩, ⟨(-25732), (-18966)⟩, ⟨(-1561), (-1504)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3101051, 5563154⟩, ⟨1005365, 1379049⟩, ⟨77342, 82081⟩, ⟨(-870), (-622)⟩, ⟨(-26), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140064526), (-137602422)⟩, ⟨1005365, 1379049⟩, ⟨77342, 82081⟩, ⟨(-870), (-622)⟩, ⟨(-26), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-154139081), (-85179132)⟩, ⟨(-37912427), (-26875419)⟩, ⟨(-2153100), (-1896349)⟩, ⟨32287, 45911⟩, ⟨1060, 1273⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1277516684, 1346476634⟩, ⟨(-37912427), (-26875419)⟩, ⟨(-2153100), (-1896349)⟩, ⟨32287, 45911⟩, ⟨1060, 1273⟩⟩
...
def j70 : Jet := ⟨⟨(-119), (-66)⟩, ⟨(-30), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11716, 11770⟩, ⟨(-30), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7252, 12953⟩, ⟨2383, 3226⟩, ⟨189, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844925), (-839223)⟩, ⟨2383, 3226⟩, ⟨189, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-929829), (-519498)⟩, ⟨(-230983), (-169615)⟩, ⟨(-13922), (-13323)⟩, ⟨75, 111⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34861565, 35271897⟩, ⟨(-230983), (-169615)⟩, ⟨(-13922), (-13323)⟩, ⟨75, 111⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21580127, 38816237⟩, ⟨6939181, 9599065⟩, ⟨520577, 563259⟩, ⟨(-7757), (-5542)⟩, ⟨(-225), (-193)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694247756), (-677011645)⟩, ⟨6939181, 9599065⟩, ⟨520577, 563259⟩, ⟨(-7757), (-5542)⟩, ⟨(-225), (-193)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-764010090), (-419086116)⟩, ⟨(-186707007), (-129131732)⟩, ⟨(-10183571), (-8380511)⟩, ⟨218198, 316592⟩, ⟨6568, 8424⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3530957206, 3875881180⟩, ⟨(-186707007), (-129131732)⟩, ⟨(-10183571), (-8380511)⟩, ⟨218198, 316592⟩, ⟨6568, 8424⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1005125168, 1412508683⟩, ⟨127749184, 155418532⟩, ⟨(-7230150), (-5016185)⟩, ⟨(-256935), (-200505)⟩, ⟨5066, 7357⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4759367797, 5224289902⟩, ⟨158566626, 276245640⟩, ⟨15573726, 29674369⟩, ⟨434986, 2071704⟩, ⟨14246, 176481⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1113806002, 1718139940⟩, ⟨178670663, 279897553⟩, ⟨(-433556), 14196880⟩, ⟨(-212543), 1347759⟩, ⟨(-44596), 116368⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1434175480), (-1075631609)⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2860791816, 3219335687⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨288841270, 687317191⟩, ⟨92668670, 223937988⟩, ⟨7085824, 29599084⟩, ⟨(-226560), 2928690⟩, ⟨(-64818), 315696⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4583808566, 4982284487⟩, ⟨92668670, 223937988⟩, ⟨7085824, 29599084⟩, ⟨(-226560), 2928690⟩, ⟨(-64818), 315696⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4437038188, 4625878180⟩, ⟨43019821, 108383825⟩, ⟨2019759, 14117120⟩, ⟨(-454494), 1397876⟩, ⟨(-87976), 163438⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2955422395, 3467373250⟩, ⟨(-164429514), (-103961793)⟩, ⟨(-3178620), 8785982⟩, ⟨(-929920), 963488⟩, ⟨(-124292), 141478⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6914654773, 9219539707⟩, ⟨1152442456, 1152442464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11132203654, 19790584317⟩, ⟨3710734530, 4947646082⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11132203654, 19790584317⟩, ⟨3710734530, 4947646082⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19790584317), (-11132203654)⟩, ⟨(-4947646082), (-3710734530)⟩, ⟨(-309227881), (-309227875)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9895292159), (-5566101827)⟩, ⟨(-2473823041), (-1855367265)⟩, ⟨(-154613941), (-154613937)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨428920663, 1175254683⟩, ⟨(-676925321), (-185287873)⟩, ⟨(-2286917), 179507681⟩, ⟨(-30017619), 16684770⟩, ⟨(-5633568), 4363564⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨295145840, 948795735⟩, ⟨(-591482807), (-137881210)⟩, ⟨1768947, 173238200⟩, ⟨(-32745070), 14321972⟩, ⟨(-5505521), 5224443⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1254903544, 1254903545⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4515655093, 4515655099⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar426 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1858
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar426 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1075631609, 1434175480⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4437038188, 4625878180⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1859
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((6261 / 25000) : ℝ)..(2087 / 6250), prawitzNormalCorrection
      ((107141 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
