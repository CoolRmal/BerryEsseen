...
namespace FiniteNormalPanel121_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (83631 / 800000)
def radius : Rat := (27877 / 800000)

def j0 : Jet := ⟨⟨448990512, 448990513⟩, ⟨149663504, 149663505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1410545293, 1410545298⟩, ⟨470181764, 470181768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨463248701, 463248705⟩, ⟨308832466, 308832472⟩, ⟨51472077, 51472079⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨115, 117⟩, ⟨77, 78⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94572), (-94569)⟩, ⟨77, 78⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10201), (-10200)⟩, ⟨(-6793), (-6791)⟩, ⟨(-1128), (-1125)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102855, 5102857⟩, ⟨(-6793), (-6791)⟩, ⟨(-1128), (-1125)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨550386, 550387⟩, ⟨366191, 366193⟩, ⟨60543, 60546⟩, ⟨(-164), (-160)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-142615191), (-142615189)⟩, ⟨366191, 366193⟩, ⟨60543, 60546⟩, ⟨(-164), (-160)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15382260), (-15382259)⟩, ⟨(-10215344), (-10215341)⟩, ⟨(-1676279), (-1676276)⟩, ⟨8723, 8726⟩, ⟨711, 714⟩⟩
...
def j19 : Jet := ⟨⟨1416273505, 1416273507⟩, ⟨(-10215344), (-10215341)⟩, ⟨(-1676279), (-1676276)⟩, ⟨8723, 8726⟩, ⟨711, 714⟩⟩
...
def j25 : Jet := ⟨⟨1275, 1276⟩, ⟨849, 851⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850902), (-850900)⟩, ⟨849, 851⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-91778), (-91776)⟩, ⟨(-61094), (-61092)⟩, ⟨(-10123), (-10119)⟩, ⟨18, 22⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35699616, 35699619⟩, ⟨(-61094), (-61092)⟩, ⟨(-10123), (-10119)⟩, ⟨18, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3850506, 3850508⟩, ⟨2560414, 2560416⟩, ⟨422348, 422352⟩, ⟨(-1460), (-1456)⟩, ⟨(-122), (-118)⟩⟩
...
def j33 : Jet := ⟨⟨(-711977377), (-711977374)⟩, ⟨2560414, 2560416⟩, ⟨422348, 422352⟩, ⟨(-1460), (-1456)⟩, ⟨(-122), (-118)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-76792808), (-76792806)⟩, ⟨(-50919044), (-50919041)⟩, ⟨(-8302874), (-8302869)⟩, ⟨60895, 60898⟩, ⟨4942, 4946⟩⟩
...
def j36 : Jet := ⟨⟨4218174488, 4218174490⟩, ⟨(-50919044), (-50919041)⟩, ⟨(-8302874), (-8302869)⟩, ⟨60895, 60898⟩, ⟨4942, 4946⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨465129950, 465129953⟩, ⟨151688411, 151688416⟩, ⟨(-1668823), (-1668820)⟩, ⟨(-180643), (-180640)⟩, ⟨1187, 1191⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4373158132, 4373158135⟩, ⟨52789901, 52789906⟩, ⟨9245176, 9245184⟩, ⟨152374, 152381⟩, ⟨14144, 14155⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨473597744, 473597748⟩, ⟨160166893, 160166901⟩, ⟨1166433, 1166440⟩, ⟨138575, 138583⟩, ⟨2306, 2316⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-448990513), (-448990512)⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3845976783, 3845976784⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨52222708, 52222709⟩, ⟨35322586, 35322590⟩, ⟨6230145, 6230151⟩, ⟨117556, 117562⟩, ⟨11158, 11167⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4347190004, 4347190005⟩, ⟨35322586, 35322590⟩, ⟨6230145, 6230151⟩, ⟨117556, 117562⟩, ⟨11158, 11167⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320999756, 4320999758⟩, ⟨17554890, 17554893⟩, ⟨3060644, 3060649⟩, ⟨45989, 45994⟩, ⟨4274, 4281⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3869287842, 3869287845⟩, ⟨(-134850916), (-134850910)⟩, ⟨2128965, 2128971⟩, ⟨(-65472), (-65465)⟩, ⟨2224, 2232⟩⟩
...
def j47 : Jet := ⟨⟨4840693939, 4840693951⟩, ⟨1613564646, 1613564658⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5455761638, 5455761666⟩, ⟨3637174424, 3637174462⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5455761638, 5455761666⟩, ⟨3637174424, 3637174462⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5455761666), (-5455761638)⟩, ⟨(-3637174462), (-3637174424)⟩, ⟨(-606195747), (-606195737)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2727880833), (-2727880819)⟩, ⟨(-1818587231), (-1818587212)⟩, ⟨(-303097874), (-303097868)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2275750045, 2275750065⟩, ⟨(-963604546), (-963604526)⟩, ⟨43405319, 43405331⟩, ⟨39208414, 39208419⟩, ⟨(-5682003), (-5682001)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2050197678, 2050197699⟩, ⟨(-939553218), (-939553193)⟩, ⟨70486126, 70486145⟩, ⟨33447263, 33447276⟩, ⟨(-6312517), (-6312504)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨299327008, 598654017⟩, ⟨149663504, 149663505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨940363529, 1880727062⟩, ⟨470181764, 470181768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨205888312, 823553252⟩, ⟨205888310, 411776628⟩, ⟨51472077, 51472079⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨51, 207⟩, ⟨51, 104⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94636), (-94479)⟩, ⟨51, 104⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-18147), (-4529)⟩, ⟨(-9072), (-4509)⟩, ⟨(-1133), (-1119)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5094909, 5108528⟩, ⟨(-9072), (-4509)⟩, ⟨(-1133), (-1119)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨244235, 979553⟩, ⟨242495, 489561⟩, ⟨59970, 60954⟩, ⟨(-218), (-106)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142921342), (-142186023)⟩, ⟨242495, 489561⟩, ⟨59970, 60954⟩, ⟨(-218), (-106)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-27404944), (-6815986)⟩, ⟨(-13690848), (-6722113)⟩, ⟨(-1698311), (-1645371)⟩, ⟨5738, 11707⟩, ⟨694, 726⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1404250821, 1424839780⟩, ⟨(-13690848), (-6722113)⟩, ⟨(-1698311), (-1645371)⟩, ⟨5738, 11707⟩, ⟨694, 726⟩⟩
...
def j72 : Jet := ⟨⟨566, 2269⟩, ⟨563, 1135⟩, ⟨138, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851611), (-849907)⟩, ⟨563, 1135⟩, ⟨138, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-163296), (-40742)⟩, ⟨(-81622), (-40524)⟩, ⟨(-10174), (-10048)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35628098, 35750653⟩, ⟨(-81622), (-40524)⟩, ⟨(-10174), (-10048)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1707907, 6855132⟩, ⟨1692256, 3425624⟩, ⟨417199, 426023⟩, ⟨(-1955), (-960)⟩, ⟨(-123), (-116)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714119976), (-708972750)⟩, ⟨1692256, 3425624⟩, ⟨417199, 426023⟩, ⟨(-1955), (-960)⟩, ⟨(-123), (-116)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-136931387), (-33986103)⟩, ⟨(-68384573), (-33329244)⟩, ⟨(-8457092), (-8086405)⟩, ⟨39904, 81853⟩, ⟨4787, 5055⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4158035909, 4260981193⟩, ⟨(-68384573), (-33329244)⟩, ⟨(-8457092), (-8086405)⟩, ⟨39904, 81853⟩, ⟨4787, 5055⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨307454321, 623924363⟩, ⟨147732062, 154509316⟩, ⟨(-2242450), (-1096134)⟩, ⟨(-184663), (-174996)⟩, ⟨779, 1600⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4329224476, 4436408073⟩, ⟨33863040, 72962784⟩, ⟨8480790, 10223251⟩, ⟨45377, 274990⟩, ⟨9783, 20009⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨309906613, 644471283⟩, ⟨151334468, 170196788⟩, ⟨(-544432), 3005043⟩, ⟨66117, 222692⟩, ⟨(-5431), 10910⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-598654017), (-299327008)⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3696313279, 3995640288⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨22361546, 96704633⟩, ⟨21839304, 51076964⟩, ⟨5168927, 7646223⟩, ⟨(-33610), 304994⟩, ⟨2647, 23029⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4317328842, 4391671929⟩, ⟨21839304, 51076964⟩, ⟨5168927, 7646223⟩, ⟨(-33610), 304994⟩, ⟨2647, 23029⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306133553, 4343050462⟩, ⟨10798757, 25472259⟩, ⟨2481151, 3799658⟩, ⟨(-39238), 145880⟩, ⟨(-1221), 11003⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3705923127, 4040372418⟩, ⟨(-142045452), (-126355572)⟩, ⟨1247702, 3158555⟩, ⟨(-168908), 49256⟩, ⟨(-6220), 11605⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3227129292, 6454258598⟩, ⟨1613564646, 1613564658⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2424782949, 9699131840⟩, ⟨2424782948, 4849565946⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2424782949, 9699131840⟩, ⟨2424782948, 4849565946⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9699131840), (-2424782949)⟩, ⟨(-4849565946), (-2424782948)⟩, ⟨(-606195747), (-606195737)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4849565920), (-1212391474)⟩, ⟨(-2424782973), (-1212391474)⟩, ⟨(-303097874), (-303097868)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1388628240, 3238667745⟩, ⟨(-1828434506), (-391984600)⟩, ⟨(-173229239), 418137799⟩, ⟨(-60246794), 118621978⟩, ⟨(-31496510), 14615725⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1198181302, 3046687653⟩, ⟨(-1827160450), (-379077556)⟩, ⟨(-151025273), 456204348⟩, ⟨(-71976407), 117242766⟩, ⟨(-33705662), 16130018⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨448990512, 448990513⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320999756, 4320999758⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2436
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨299327008, 598654017⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306133553, 4343050462⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2437
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (36186421 / 1073741824)

theorem envelope_integral : (∫ s in ((27877 / 400000) : ℝ)..(27877 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((27877 / 400000) : ℝ)..(27877 / 200000), prawitzNormalCorrection
