...
namespace FiniteNormalPanel114_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3363 / 32000)
def radius : Rat := (1121 / 32000)

def j0 : Jet := ⟨⟨451374219, 451374220⟩, ⟨150458073, 150458074⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1418033930, 1418033934⟩, ⟨472677976, 472677980⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨468180567, 468180571⟩, ⟨312120376, 312120382⟩, ⟨52020062, 52020064⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-10309), (-10308)⟩, ⟨(-6865), (-6863)⟩, ⟨(-1140), (-1137)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102747, 5102749⟩, ⟨(-6865), (-6863)⟩, ⟨(-1140), (-1137)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨556234, 556235⟩, ⟨370073, 370075⟩, ⟨61179, 61183⟩, ⟨(-167), (-164)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-142609343), (-142609341)⟩, ⟨370073, 370075⟩, ⟨61179, 61183⟩, ⟨(-167), (-164)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15545386), (-15545385)⟩, ⟨(-10323251), (-10323249)⟩, ⟨(-1693705), (-1693701)⟩, ⟨8908, 8913⟩, ⟨725, 730⟩⟩
...
def j19 : Jet := ⟨⟨1416110379, 1416110381⟩, ⟨(-10323251), (-10323249)⟩, ⟨(-1693705), (-1693701)⟩, ⟨8908, 8913⟩, ⟨725, 730⟩⟩
...
def j25 : Jet := ⟨⟨1288, 1290⟩, ⟨858, 860⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850889), (-850886)⟩, ⟨858, 860⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-92753), (-92752)⟩, ⟨(-61743), (-61740)⟩, ⟨(-10229), (-10226)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35698641, 35698643⟩, ⟨(-61743), (-61740)⟩, ⟨(-10229), (-10226)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3891394, 3891395⟩, ⟨2587531, 2587533⟩, ⟨426774, 426778⟩, ⟨(-1490), (-1487)⟩, ⟨(-124), (-120)⟩⟩
...
def j33 : Jet := ⟨⟨(-711936489), (-711936487)⟩, ⟨2587531, 2587533⟩, ⟨426774, 426778⟩, ⟨(-1490), (-1487)⟩, ⟨(-124), (-120)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-77605907), (-77605905)⟩, ⟨(-51455214), (-51455211)⟩, ⟨(-8388320), (-8388316)⟩, ⟨62190, 62193⟩, ⟨5046, 5049⟩⟩
...
def j36 : Jet := ⟨⟨4217361389, 4217361391⟩, ⟨(-51455214), (-51455211)⟩, ⟨(-8388320), (-8388316)⟩, ⟨62190, 62193⟩, ⟨5046, 5049⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨467545484, 467545487⟩, ⟨152440151, 152440156⟩, ⟨(-1695312), (-1695308)⟩, ⟨(-183458), (-183455)⟩, ⟨1219, 1223⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4374001268, 4374001271⟩, ⟨53366343, 53366348⟩, ⟨9350983, 9350990⟩, ⟨155730, 155738⟩, ⟨14474, 14482⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨476149036, 476149040⟩, ⟨161054685, 161054692⟩, ⟨1185545, 1185553⟩, ⟨140944, 140953⟩, ⟨2371, 2381⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-451374220), (-451374219)⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3843593076, 3843593077⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨52786875, 52786877⟩, ⟨35709716, 35709720⟩, ⟨6302165, 6302171⟩, ⟨120162, 120168⟩, ⟨11421, 11428⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4347754171, 4347754173⟩, ⟨35709716, 35709720⟩, ⟨6302165, 6302171⟩, ⟨120162, 120168⟩, ⟨11421, 11428⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4321280131, 4321280133⟩, ⟨17746137, 17746140⟩, ⟨3095455, 3095460⟩, ⟨47003, 47008⟩, ⟨4373, 4379⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3867140596, 3867140600⟩, ⟨(-135498718), (-135498712)⟩, ⟨2148472, 2148478⟩, ⟨(-66375), (-66369)⟩, ⟨2266, 2273⟩⟩
...
def j47 : Jet := ⟨⟨4290863663, 4290863674⟩, ⟨1430287887, 1430287898⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4286763950, 4286763973⟩, ⟨2857842632, 2857842662⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4286763950, 4286763973⟩, ⟨2857842632, 2857842662⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4286763973), (-4286763950)⟩, ⟨(-2857842662), (-2857842632)⟩, ⟨(-476307113), (-476307105)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2143381987), (-2143381975)⟩, ⟨(-1428921331), (-1428921316)⟩, ⟨(-238153557), (-238153552)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2607518317, 2607518328⟩, ⟨(-867512674), (-867512660)⟩, ⟨(-276161), (-276152)⟩, ⟨32099354, 32099358⟩, ⟨(-2662182), (-2662180)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2347780377, 2347780390⟩, ⟨(-863361376), (-863361357)⟩, ⟨28424214, 28424229⟩, ⟨28436356, 28436369⟩, ⟨(-3395037), (-3395026)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨300916146, 601832293⟩, ⟨150458073, 150458074⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨945355953, 1890711911⟩, ⟨472677976, 472677980⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨208080252, 832321013⟩, ⟨208080250, 416160510⟩, ⟨52020062, 52020064⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-18340), (-4577)⟩, ⟨(-9168), (-4556)⟩, ⟨(-1145), (-1130)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5094716, 5108480⟩, ⟨(-9168), (-4556)⟩, ⟨(-1145), (-1130)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨246826, 989972⟩, ⟨245049, 494766⟩, ⟨60595, 61600⟩, ⟨(-223), (-108)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142918751), (-142175604)⟩, ⟨245049, 494766⟩, ⟨60595, 61600⟩, ⟨(-223), (-108)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-27696202), (-6888046)⟩, ⟨(-13836229), (-6792165)⟩, ⟨(-1716206), (-1662132)⟩, ⟨5859, 11957⟩, ⟨708, 742⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1403959563, 1424767720⟩, ⟨(-13836229), (-6792165)⟩, ⟨(-1716206), (-1662132)⟩, ⟨5859, 11957⟩, ⟨708, 742⟩⟩
...
def j72 : Jet := ⟨⟨572, 2293⟩, ⟨569, 1147⟩, ⟨140, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851605), (-849883)⟩, ⟨569, 1147⟩, ⟨140, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-165033), (-41174)⟩, ⟨(-82490), (-40951)⟩, ⟨(-10282), (-10153)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35626361, 35750221⟩, ⟨(-82490), (-40951)⟩, ⟨(-10282), (-10153)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1726006, 6928030⟩, ⟨1710020, 3462032⟩, ⟨421515, 430528⟩, ⟨(-1997), (-980)⟩, ⟨(-126), (-118)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714101877), (-708899852)⟩, ⟨1710020, 3462032⟩, ⟨421515, 430528⟩, ⟨(-1997), (-980)⟩, ⟨(-126), (-118)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-138385687), (-34344396)⟩, ⟨(-69109998), (-33673489)⟩, ⟨(-8545839), (-8167212)⟩, ⟨40745, 83601⟩, ⟨4886, 5163⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4156581609, 4260622900⟩, ⟨(-69109998), (-33673489)⟩, ⟨(-8545839), (-8167212)⟩, ⟨40745, 83601⟩, ⟨4886, 5163⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨309022499, 627205079⟩, ⟨148420324, 155306263⟩, ⟨(-2278233), (-1113352)⟩, ⟨(-187587), (-177660)⟩, ⟨799, 1643⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4329588538, 4437960279⟩, ⟨34218553, 73788382⟩, ⟨8569854, 10351202⟩, ⟨46242, 281374⟩, ⟨9965, 20538⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨311513494, 648086711⟩, ⟨152078744, 171252405⟩, ⟨(-555000), 3057480⟩, ⟨66499, 227429⟩, ⟨(-5596), 11237⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-601832293), (-300916146)⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3693135003, 3994051150⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨22594038, 97792686⟩, ⟨22060508, 51682074⟩, ⟨5217400, 7751029⟩, ⟨(-34614), 312458⟩, ⟨2622, 23707⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4317561334, 4392759982⟩, ⟨22060508, 51682074⟩, ⟨5217400, 7751029⟩, ⟨(-34614), 312458⟩, ⟨2622, 23707⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306249496, 4343588432⟩, ⟨10906783, 25773335⟩, ⟨2503033, 3851549⟩, ⟨(-40315), 149481⟩, ⟨(-1311), 11337⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3702836284, 4039265768⟩, ⟨(-142782864), (-126885711)⟩, ⟨1249422, 3199622⟩, ⟨(-172416), 51324⟩, ⟨(-6457), 11956⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2860575775, 5721151562⟩, ⟨1430287887, 1430287898⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1905228422, 7620913721⟩, ⟨1905228420, 3810456882⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1905228422, 7620913721⟩, ⟨1905228420, 3810456882⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7620913721), (-1905228422)⟩, ⟨(-3810456882), (-1905228420)⟩, ⟨(-476307113), (-476307105)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3810456861), (-952614211)⟩, ⟨(-1905228441), (-952614210)⟩, ⟨(-238153557), (-238153552)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1768714155, 3440600987⟩, ⟨(-1526235337), (-392296872)⟩, ⟨(-147274132), 240441396⟩, ⟨(-21051150), 78195987⟩, ⟨(-15338020), 6417684⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1524868176, 3235764287⟩, ⟨(-1549750804), (-390465288)⟩, ⟨(-126402040), 279428340⟩, ⟨(-29066275), 78363588⟩, ⟨(-17157562), 6985406⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨451374219, 451374220⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4321280131, 4321280133⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2300
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨300916146, 601832293⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306249496, 4343588432⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2301
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (165253071 / 4294967296)

theorem envelope_integral : (∫ s in ((1121 / 16000) : ℝ)..(1121 / 8000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((1121 / 16000) : ℝ)..(1121 / 8000), prawitzNormalCorrection
