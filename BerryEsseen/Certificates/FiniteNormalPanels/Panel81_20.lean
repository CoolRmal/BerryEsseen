...
namespace FiniteNormalPanel81_20
...
def j2 : Jet := ⟨⟨1656354709, 1656354713⟩, ⟨552118236, 552118240⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨638773413, 638773417⟩, ⟨425848942, 425848948⟩, ⟨70974823, 70974825⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨159, 161⟩, ⟨106, 107⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94528), (-94525)⟩, ⟨106, 107⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-14059), (-14058)⟩, ⟨(-9358), (-9356)⟩, ⟨(-1551), (-1548)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098997, 5098999⟩, ⟨(-9358), (-9356)⟩, ⟨(-1551), (-1548)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨758353, 758354⟩, ⟨504177, 504179⟩, ⟨83102, 83105⟩, ⟨(-309), (-306)⟩, ⟨(-26), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-142407224), (-142407222)⟩, ⟨504177, 504179⟩, ⟨83102, 83105⟩, ⟨(-309), (-306)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-21179661), (-21179660)⟩, ⟨(-14044790), (-14044788)⟩, ⟨(-2290948), (-2290945)⟩, ⟨16524, 16527⟩, ⟨1338, 1341⟩⟩
...
def j19 : Jet := ⟨⟨1410476104, 1410476106⟩, ⟨(-14044790), (-14044788)⟩, ⟨(-2290948), (-2290945)⟩, ⟨16524, 16527⟩, ⟨1338, 1341⟩⟩
...
def j22 : Jet := ⟨⟨(-17), (-15)⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11818, 11821⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1757, 1759⟩, ⟨1169, 1172⟩, ⟨192, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850420), (-850417)⟩, ⟨1169, 1172⟩, ⟨192, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-126480), (-126479)⟩, ⟨(-84147), (-84144)⟩, ⟨(-13911), (-13906)⟩, ⟨37, 40⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35664914, 35664916⟩, ⟨(-84147), (-84144)⟩, ⟨(-13911), (-13906)⟩, ⟨37, 40⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5304300, 5304302⟩, ⟨3523685, 3523687⟩, ⟨578953, 578957⟩, ⟨(-2766), (-2762)⟩, ⟨(-227), (-224)⟩⟩
...
def j33 : Jet := ⟨⟨(-710523583), (-710523580)⟩, ⟨3523685, 3523687⟩, ⟨578953, 578957⟩, ⟨(-2766), (-2762)⟩, ⟨(-227), (-224)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-105673349), (-105673347)⟩, ⟨(-69924837), (-69924834)⟩, ⟨(-11306004), (-11306000)⟩, ⟨115220, 115224⟩, ⟨9258, 9262⟩⟩
...
def j36 : Jet := ⟨⟨4189293947, 4189293949⟩, ⟨(-69924837), (-69924834)⟩, ⟨(-11306004), (-11306000)⟩, ⟨115220, 115224⟩, ⟨9258, 9262⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨543950297, 543950300⟩, ⟨175900389, 175900394⟩, ⟨(-2688964), (-2688961)⟩, ⟨(-288130), (-288127)⟩, ⟨2639, 2643⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4403306212, 4403306216⟩, ⟨73496980, 73496985⟩, ⟨13110333, 13110340⟩, ⟨296069, 296077⟩, ⟨28565, 28575⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨557671236, 557671240⟩, ⟨189645676, 189645684⟩, ⟨1913676, 1913684⟩, ⟨233016, 233025⟩, ⟨5307, 5317⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-527234080), (-527234079)⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3767733216, 3767733217⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨72409679, 72409682⟩, ⟨49248308, 49248312⟩, ⟨8870820, 8870826⟩, ⟨229506, 229514⟩, ⟨22806, 22815⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4367376975, 4367376978⟩, ⟨49248308, 49248312⟩, ⟨8870820, 8870826⟩, ⟨229506, 229514⟩, ⟨22806, 22815⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4331020812, 4331020814⟩, ⟨24419170, 24419173⟩, ⟨4329647, 4329651⟩, ⟨89385, 89391⟩, ⟨8638, 8645⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3799360937, 3799360941⟩, ⟨(-155798395), (-155798390)⟩, ⟨2798952, 2798959⟩, ⟨(-98752), (-98745)⟩, ⟨3919, 3927⟩⟩
...
def j47 : Jet := ⟨⟨3542000777, 3542000785⟩, ⟨1180666925, 1180666933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2921039588, 2921039603⟩, ⟨1947359724, 1947359744⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2921039588, 2921039603⟩, ⟨1947359724, 1947359744⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2921039603), (-2921039588)⟩, ⟨(-1947359744), (-1947359724)⟩, ⟨(-324559959), (-324559953)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1460519802), (-1460519794)⟩, ⟨(-973679872), (-973679862)⟩, ⟨(-162279980), (-162279976)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3056865896, 3056865908⟩, ⟨(-692999179), (-692999168)⟩, ⟨(-36947539), (-36947533)⟩, ⟨20248104, 20248107⟩, ⟨(-449567), (-449565)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2704126964, 2704126978⟩, ⟨(-723919091), (-723919075)⟩, ⟨(-5553679), (-5553664)⟩, ⟨18729983, 18729997⟩, ⟨(-1137542), (-1137529)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨351489386, 702978773⟩, ⟨175744693, 175744694⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1104236472, 2208472949⟩, ⟨552118236, 552118240⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨283899294, 1135597184⟩, ⟨283899294, 567798596⟩, ⟨70974823, 70974825⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨71, 285⟩, ⟨71, 143⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94616), (-94401)⟩, ⟨71, 143⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-25017), (-6239)⟩, ⟨(-12505), (-6201)⟩, ⟨(-1559), (-1535)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5088039, 5106818⟩, ⟨(-12505), (-6201)⟩, ⟨(-1559), (-1535)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨336321, 1350252⟩, ⟨333014, 674717⟩, ⟨82013, 83881⟩, ⟨(-414), (-201)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142829256), (-141815324)⟩, ⟨333014, 674717⟩, ⟨82013, 83881⟩, ⟨(-414), (-201)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-37764316), (-9374057)⟩, ⟨(-18860146), (-9195660)⟩, ⟨(-2332837), (-2232136)⟩, ⟨10814, 22227⟩, ⟨1293, 1373⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1393891449, 1422281709⟩, ⟨(-18860146), (-9195660)⟩, ⟨(-2332837), (-2232136)⟩, ⟨10814, 22227⟩, ⟨1293, 1373⟩⟩
...
def j70 : Jet := ⟨⟨(-29), (-7)⟩, ⟨(-15), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11806, 11829⟩, ⟨(-15), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨780, 3128⟩, ⟨776, 1564⟩, ⟨192, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851397), (-849048)⟩, ⟨776, 1564⟩, ⟨192, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-225111), (-56122)⟩, ⟨(-112505), (-55708)⟩, ⟨(-14007), (-13771)⟩, ⟨23, 52⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35566283, 35735273⟩, ⟨(-112505), (-55708)⟩, ⟨(-14007), (-13771)⟩, ⟨23, 52⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2350947, 9448472⟩, ⟨2321200, 4720554⟩, ⟨569158, 585938⟩, ⟨(-3711), (-1816)⟩, ⟨(-231), (-218)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713476936), (-706379410)⟩, ⟨2321200, 4720554⟩, ⟨569158, 585938⟩, ⟨(-3711), (-1816)⟩, ⟨(-231), (-218)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-188644603), (-46692000)⟩, ⟨(-94168871), (-45443876)⟩, ⟨(-11599235), (-10894014)⟩, ⟨74997, 155350⟩, ⟨8852, 9549⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4106322693, 4248275296⟩, ⟨(-94168871), (-45443876)⟩, ⟨(-11599235), (-10894014)⟩, ⟨74997, 155350⟩, ⟨8852, 9549⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨358369614, 731337509⟩, ⟨169486916, 180470173⟩, ⟨(-3624019), (-1755984)⟩, ⟨(-297107), (-275511)⟩, ⟨1722, 3564⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4342172479, 4492278239⟩, ⟨46448295, 103019857⟩, ⟨11631655, 15051974⟩, ⟨79259, 556882⟩, ⟨16808, 45082⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨362308387, 764935179⟩, ⟨175225334, 206302972⟩, ⟨(-987039), 5116524⟩, ⟨67934, 429765⟩, ⟨(-13559), 27071⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-702978773), (-351489386)⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3591988523, 3943477910⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨30563065, 136235224⟩, ⟨29562790, 73485264⟩, ⟨6797228, 11731996⟩, ⟨(-83364), 644616⟩, ⟨(-464), 57028⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4325530361, 4431202520⟩, ⟨29562790, 73485264⟩, ⟨6797228, 11731996⟩, ⟨(-83364), 644616⟩, ⟨(-464), 57028⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310221738, 4362553141⟩, ⟨14552397, 36612595⟩, ⟨3192326, 5820672⟩, ⟨(-90978), 310390⟩, ⟨(-6799), 28005⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3604746194, 4005532699⟩, ⟨(-166339690), (-142752573)⟩, ⟨1171680, 4748858⟩, ⟨(-321708), 154364⟩, ⟨(-18944), 29437⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2361333851, 4722667711⟩, ⟨1180666925, 1180666933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1298239816, 5192959288⟩, ⟨1298239816, 2596479656⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1298239816, 5192959288⟩, ⟨1298239816, 2596479656⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5192959288), (-1298239816)⟩, ⟨(-2596479656), (-1298239816)⟩, ⟨(-324559959), (-324559953)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2596479644), (-649119908)⟩, ⟨(-1298239828), (-649119908)⟩, ⟨(-162279980), (-162279976)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2346450854, 3692519202⟩, ⟨(-1116137834), (-354630863)⟩, ⟨(-112718663), 80029785⟩, ⟨869321, 39471741⟩, ⟨(-4494694), 2096622⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1969365353, 3443683127⟩, ⟨(-1183929642), (-375629437)⟩, ⟨(-92695593), 121946260⟩, ⟨(-3880529), 41213218⟩, ⟨(-5901534), 2123839⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4331020812, 4331020814⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1644
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310221738, 4362553141⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1645
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (221182255 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((6547 / 80000) : ℝ)..(6547 / 40000), prawitzNormalCorrection
