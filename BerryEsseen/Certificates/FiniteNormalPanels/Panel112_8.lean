...
namespace FiniteNormalPanel112_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (198387 / 800000)
def radius : Rat := (28341 / 800000)

def j0 : Jet := ⟨⟨1065082096, 1065082097⟩, ⟨152154585, 152154586⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3346054088, 3346054092⟩, ⟨478007726, 478007730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2606790037, 2606790045⟩, ⟨744797152, 744797160⟩, ⟨53199796, 53199798⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨652, 654⟩, ⟨186, 187⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94035), (-94032)⟩, ⟨186, 187⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-57074), (-57071)⟩, ⟨(-16195), (-16192)⟩, ⟨(-1126), (-1122)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5055982, 5055986⟩, ⟨(-16195), (-16192)⟩, ⟨(-1126), (-1122)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3068680, 3068684⟩, ⟨866935, 866940⟩, ⟨59133, 59140⟩, ⟨(-395), (-390)⟩, ⟨(-14), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140096897), (-140096892)⟩, ⟨866935, 866940⟩, ⟨59133, 59140⟩, ⟨(-395), (-390)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-85030496), (-85030491)⟩, ⟨(-23768250), (-23768244)⟩, ⟨(-1549091), (-1549083)⟩, ⟨20752, 20759⟩, ⟨654, 660⟩⟩
...
def j19 : Jet := ⟨⟨1346625269, 1346625275⟩, ⟨(-23768250), (-23768244)⟩, ⟨(-1549091), (-1549083)⟩, ⟨20752, 20759⟩, ⟨654, 660⟩⟩
...
def j22 : Jet := ⟨⟨(-66), (-64)⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11769, 11772⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7143, 7145⟩, ⟨2028, 2032⟩, ⟨139, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845034), (-845031)⟩, ⟨2028, 2032⟩, ⟨139, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-512886), (-512883)⟩, ⟨(-145309), (-145304)⟩, ⟨(-10033), (-10027)⟩, ⟨47, 51⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35278508, 35278512⟩, ⟨(-145309), (-145304)⟩, ⟨(-10033), (-10027)⟩, ⟨47, 51⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21411958, 21411962⟩, ⟨6029508, 6029514⟩, ⟨405689, 405697⟩, ⟨(-3512), (-3506)⟩, ⟨(-118), (-113)⟩⟩
...
def j33 : Jet := ⟨⟨(-694415925), (-694415920)⟩, ⟨6029508, 6029514⟩, ⟨405689, 405697⟩, ⟨(-3512), (-3506)⟩, ⟨(-118), (-113)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-421469221), (-421469216)⟩, ⟨(-116760226), (-116760218)⟩, ⟨(-7309598), (-7309590)⟩, ⟨142903, 142911⟩, ⟨4343, 4351⟩⟩
...
def j36 : Jet := ⟨⟨3873498075, 3873498080⟩, ⟨(-116760226), (-116760218)⟩, ⟨(-7309598), (-7309590)⟩, ⟨142903, 142911⟩, ⟨4343, 4351⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1049107170, 1049107177⟩, ⟨131355465, 131355474⟩, ⟨(-3852125), (-3852117)⟩, ⟨(-156239), (-156231)⟩, ⟨2818, 2826⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4762295912, 4762295919⟩, ⟨143551564, 143551576⟩, ⟨13313943, 13313958⟩, ⟨496515, 496529⟩, ⟨29442, 29459⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1163258866, 1163258876⟩, ⟨180712566, 180712583⟩, ⟨3371171, 3371188⟩, ⟨226477, 226494⟩, ⟨8335, 8354⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1065082097), (-1065082096)⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3229885199, 3229885200⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨315059718, 315059725⟩, ⟨97889216, 97889228⟩, ⟨9429667, 9429682⟩, ⟨406364, 406380⟩, ⟨26218, 26233⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4610027014, 4610027021⟩, ⟨97889216, 97889228⟩, ⟨9429667, 9429682⟩, ⟨406364, 406380⟩, ⟨26218, 26233⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4449709570, 4449709574⟩, ⟨47242519, 47242526⟩, ⟨4300084, 4300093⟩, ⟨150462, 150471⟩, ⟨8976, 8986⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3346253903, 3346253908⟩, ⟨(-122109384), (-122109375)⟩, ⟨1560107, 1560115⟩, ⟨(-39188), (-39178)⟩, ⟨1419, 1428⟩⟩
...
def j47 : Jet := ⟨⟨11023608389, 11023608402⟩, ⟨1574801196, 1574801208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨28293566292, 28293566360⟩, ⟨8083876070, 8083876144⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨28293566292, 28293566360⟩, ⟨8083876070, 8083876144⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-28293566360), (-28293566292)⟩, ⟨(-8083876144), (-8083876070)⟩, ⟨(-577419728), (-577419718)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-14146783180), (-14146783146)⟩, ⟨(-4041938072), (-4041938035)⟩, ⟨(-288709864), (-288709859)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨159396463, 159396468⟩, ⟨(-150005951), (-150005944)⟩, ⟨59869613, 59869619⟩, ⟨(-12058525), (-12058521)⟩, ⟨824796, 824798⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨124187450, 124187455⟩, ⟨(-121402976), (-121402967)⟩, ⟨50967729, 50967737⟩, ⟨(-11153009), (-11153001)⟩, ⟨1008607, 1008613⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨912927511, 1217236682⟩, ⟨152154585, 152154586⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2868046361, 3824061818⟩, ⟨478007726, 478007730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1915192680, 3404786994⟩, ⟨638397558, 851196754⟩, ⟨53199796, 53199798⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨479, 853⟩, ⟨159, 214⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94208), (-93833)⟩, ⟨159, 214⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-74683), (-41841)⟩, ⟨(-18601), (-13777)⟩, ⟨(-1139), (-1107)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5038373, 5071216⟩, ⟨(-18601), (-13777)⟩, ⟨(-1139), (-1107)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2246688, 4020150⟩, ⟨734150, 998895⟩, ⟨57818, 60275⟩, ⟨(-457), (-329)⟩, ⟨(-15), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140918889), (-139145426)⟩, ⟨734150, 998895⟩, ⟨57818, 60275⟩, ⟨(-457), (-329)⟩, ⟨(-15), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-111711864), (-62047108)⟩, ⟨(-27600599), (-19890506)⟩, ⟨(-1610595), (-1477781)⟩, ⟨17323, 24173⟩, ⟨613, 695⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1319943901, 1369608658⟩, ⟨(-27600599), (-19890506)⟩, ⟨(-1610595), (-1477781)⟩, ⟨17323, 24173⟩, ⟨613, 695⟩⟩
...
def j70 : Jet := ⟨⟨(-86), (-47)⟩, ⟨(-22), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11749, 11789⟩, ⟨(-22), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5239, 9346⟩, ⟨1728, 2331⟩, ⟨138, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846938), (-842830)⟩, ⟨1728, 2331⟩, ⟨138, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-671401), (-375830)⟩, ⟨(-167081), (-123428)⟩, ⟨(-10174), (-9862)⟩, ⟨39, 58⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35119993, 35415565⟩, ⟨(-167081), (-123428)⟩, ⟨(-10174), (-9862)⟩, ⟨39, 58⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15660550, 28075291⟩, ⟨5087731, 6963785⟩, ⟨393836, 415934⟩, ⟨(-4070), (-2947)⟩, ⟨(-123), (-108)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700167333), (-687752591)⟩, ⟨5087731, 6963785⟩, ⟨393836, 415934⟩, ⟨(-4070), (-2947)⟩, ⟨(-123), (-108)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-555049775), (-306679571)⟩, ⟨(-136493747), (-96706060)⟩, ⟨(-7740804), (-6809033)⟩, ⟨118331, 167376⟩, ⟨3973, 4666⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3739917521, 3988287725⟩, ⟨(-136493747), (-96706060)⟩, ⟨(-7740804), (-6809033)⟩, ⟨118331, 167376⟩, ⟨3973, 4666⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨881417724, 1219443087⟩, ⟨122328517, 139148123⟩, ⟨(-4505813), (-3200526)⟩, ⟨(-167684), (-142946)⟩, ⟨2336, 3310⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4625229006, 4932393287⟩, ⟨112150301, 180014891⟩, ⟨10615820, 16778874⟩, ⟨241878, 838621⟩, ⟨10661, 56877⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨949194380, 1400423445⟩, ⟨154750577, 210909915⟩, ⟨198302, 7149404⟩, ⟨(-29429), 544198⟩, ⟨(-13041), 35479⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1217236682), (-912927511)⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3077730614, 3382039785⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨209773418, 456624159⟩, ⟨68400230, 137539204⟩, ⟨5663417, 15019296⟩, ⟨(-4904), 1057048⟩, ⟨(-11389), 88487⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4504740714, 4751591455⟩, ⟨68400230, 137539204⟩, ⟨5663417, 15019296⟩, ⟨(-4904), 1057048⟩, ⟨(-11389), 88487⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4398603647, 4517513686⟩, ⟨32515313, 67149309⟩, ⟨2193148, 7212533⟩, ⟨(-112502), 499860⟩, ⟨(-19106), 44373⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3151995386, 3557282271⟩, ⟨(-136738423), (-102949812)⟩, ⟨(-807262), 4527561⟩, ⟨(-344102), 315917⟩, ⟨(-32754), 38928⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9448807192, 12598409599⟩, ⟨1574801196, 1574801208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨20787109935, 36954862165⟩, ⟨6929036632, 9238715590⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨20787109935, 36954862165⟩, ⟨6929036632, 9238715590⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-36954862165), (-20787109935)⟩, ⟨(-9238715590), (-6929036632)⟩, ⟨(-577419728), (-577419718)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-18477431083), (-10393554967)⟩, ⟨(-4619357795), (-3464518316)⟩, ⟨(-288709864), (-288709859)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨58153556, 381939086⟩, ⟨(-410786200), (-46909335)⟩, ⟨(-6754524), 216996930⟩, ⟨(-75693249), 20830398⟩, ⟨(-12894241), 20579575⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨42677796, 316338879⟩, ⟨(-352391093), (-35819808)⟩, ⟨(-4541775), 193207256⟩, ⟨(-70064647), 17573007⟩, ⟨(-11416673), 19719879⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1065082096, 1065082097⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4449709570, 4449709574⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2252
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨912927511, 1217236682⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4398603647, 4517513686⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2253
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (10282163 / 4294967296)

theorem envelope_integral : (∫ s in ((85023 / 400000) : ℝ)..(28341 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((85023 / 400000) : ℝ)..(28341 / 100000), prawitzNormalCorrection
