...
namespace FiniteNormalPanel172_18
...
def j2 : Jet := ⟨⟨1331408628, 1331408632⟩, ⟨443802876, 443802880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨412726992, 412726995⟩, ⟨275151328, 275151332⟩, ⟨45858554, 45858556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-9090), (-9088)⟩, ⟨(-6054), (-6052)⟩, ⟨(-1005), (-1002)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103966, 5103969⟩, ⟨(-6054), (-6052)⟩, ⟨(-1005), (-1002)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨490468, 490469⟩, ⟨326396, 326398⟩, ⟨54011, 54014⟩, ⟨(-130), (-127)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142675109), (-142675107)⟩, ⟨326396, 326398⟩, ⟨54011, 54014⟩, ⟨(-130), (-127)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13710435), (-13710434)⟩, ⟨(-9108925), (-9108923)⟩, ⟨(-1497282), (-1497279)⟩, ⟨6932, 6935⟩, ⟨565, 569⟩⟩
...
def j19 : Jet := ⟨⟨1417945330, 1417945332⟩, ⟨(-9108925), (-9108923)⟩, ⟨(-1497282), (-1497279)⟩, ⟨6932, 6935⟩, ⟨565, 569⟩⟩
...
def j25 : Jet := ⟨⟨1136, 1137⟩, ⟨756, 758⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851041), (-851039)⟩, ⟨756, 758⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-81782), (-81781)⟩, ⟨(-54449), (-54447)⟩, ⟨(-9028), (-9024)⟩, ⟨14, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35709612, 35709614⟩, ⟨(-54449), (-54447)⟩, ⟨(-9028), (-9024)⟩, ⟨14, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3431532, 3431533⟩, ⟨2282455, 2282457⟩, ⟨376924, 376927⟩, ⟨(-1160), (-1157)⟩, ⟨(-98), (-93)⟩⟩
...
def j33 : Jet := ⟨⟨(-712396351), (-712396349)⟩, ⟨2282455, 2282457⟩, ⟨376924, 376927⟩, ⟨(-1160), (-1157)⟩, ⟨(-98), (-93)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-68458078), (-68458077)⟩, ⟨(-45419386), (-45419384)⟩, ⟨(-7424012), (-7424008)⟩, ⟨48405, 48408⟩, ⟨3939, 3943⟩⟩
...
def j36 : Jet := ⟨⟨4226509218, 4226509219⟩, ⟨(-45419386), (-45419384)⟩, ⟨(-7424012), (-7424008)⟩, ⟨48405, 48408⟩, ⟨3939, 3943⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨439552740, 439552743⟩, ⟨143693879, 143693883⟩, ⟨(-1405381), (-1405378)⟩, ⟨(-152568), (-152565)⟩, ⟨891, 894⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4364534209, 4364534211⟩, ⟨46902642, 46902646⟩, ⟨8170482, 8170490⟩, ⟨120197, 120204⟩, ⟨11032, 11041⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨446672311, 446672315⟩, ⟨150821412, 150821419⟩, ⟨977223, 977229⟩, ⟨115267, 115274⟩, ⟨1714, 1722⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-423800530), (-423800529)⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3871166766, 3871166767⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨46453474, 46453476⟩, ⟨31370552, 31370556⟩, ⟨5499481, 5499485⟩, ⟨92606, 92612⟩, ⟨8672, 8679⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4341420770, 4341420772⟩, ⟨31370552, 31370556⟩, ⟨5499481, 5499485⟩, ⟨92606, 92612⟩, ⟨8672, 8679⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4318131566, 4318131568⟩, ⟨15601133, 15601136⟩, ⟨2706806, 2706810⟩, ⟨36274, 36279⟩, ⟨3333, 3338⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3892045330, 3892045334⟩, ⟨(-127967036), (-127967030)⟩, ⟨1926574, 1926579⟩, ⟨(-56337), (-56330)⟩, ⟨1810, 1816⟩⟩
...
def j47 : Jet := ⟨⟨4220128306, 4220128318⟩, ⟨1406709435, 1406709446⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4146593371, 4146593395⟩, ⟨2764395580, 2764395610⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4146593371, 4146593395⟩, ⟨2764395580, 2764395610⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4146593395), (-4146593371)⟩, ⟨(-2764395610), (-2764395580)⟩, ⟨(-460732604), (-460732596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2073296698), (-2073296685)⟩, ⟨(-1382197805), (-1382197790)⟩, ⟨(-230366302), (-230366298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2650416866, 2650416878⟩, ⟨(-852951872), (-852951857)⟩, ⟨(-4911016), (-4911007)⟩, ⟨31026290, 31026293⟩, ⟨(-2364501), (-2364500)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2401774419, 2401774434⟩, ⟨(-851902494), (-851902474)⟩, ⟨22151982, 22151998⟩, ⟨27844582, 27844594⟩, ⟨(-3057001), (-3056989)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨282533686, 565067373⟩, ⟨141266843, 141266844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨887605752, 1775211508⟩, ⟨443802876, 443802880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨183434218, 733736879⟩, ⟨183434218, 366868442⟩, ⟨45858554, 45858556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-16169), (-4036)⟩, ⟨(-8084), (-4020)⟩, ⟨(-1010), (-998)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096887, 5109021⟩, ⟨(-8084), (-4020)⟩, ⟨(-1010), (-998)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨217683, 872807⟩, ⟨216301, 436233⟩, ⟨53556, 54338⟩, ⟨(-174), (-83)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142947894), (-142292769)⟩, ⟨216301, 436233⟩, ⟨53556, 54338⟩, ⟨(-174), (-83)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-24420708), (-6077197)⟩, ⟨(-12201117), (-6002672)⟩, ⟨(-1514770), (-1472753)⟩, ⟨4566, 9297⟩, ⟨554, 578⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407235057, 1425578569⟩, ⟨(-12201117), (-6002672)⟩, ⟨(-1514770), (-1472753)⟩, ⟨4566, 9297⟩, ⟨554, 578⟩⟩
...
def j72 : Jet := ⟨⟨504, 2022⟩, ⟨502, 1011⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851673), (-850154)⟩, ⟨502, 1011⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-145497), (-36309)⟩, ⟨(-72728), (-36136)⟩, ⟨(-9068), (-8968)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35645897, 35755086⟩, ⟨(-72728), (-36136)⟩, ⟨(-9068), (-8968)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1522404, 6108272⟩, ⟨1509979, 3052593⟩, ⟨372838, 379841⟩, ⟨(-1552), (-764)⟩, ⟨(-98), (-92)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714305479), (-709719610)⟩, ⟨1509979, 3052593⟩, ⟨372838, 379841⟩, ⟨(-1552), (-764)⟩, ⟨(-98), (-92)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-122029398), (-30311490)⟩, ⟨(-60950211), (-29789995)⟩, ⟨(-7546426), (-7252233)⟩, ⟨31779, 65008⟩, ⟨3830, 4021⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4172937898, 4264655806⟩, ⟨(-60950211), (-29789995)⟩, ⟨(-7546426), (-7252233)⟩, ⟨31779, 65008⟩, ⟨3830, 4021⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨290821756, 589225321⟩, ⟨140367867, 146065809⟩, ⟨(-1886844), (-924622)⟩, ⟨(-155580), (-148337)⟩, ⟨585, 1200⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4325494228, 4420565205⟩, ⟨30214970, 64567073⟩, ⟨7566751, 8937313⟩, ⟨36852, 214365⟩, ⟨7970, 15096⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨292888802, 606456062⟩, ⟨143411468, 159195157⟩, ⟨(-442178), 2490751⟩, ⟨61295, 177460⟩, ⟨(-3934), 7928⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-565067373), (-282533686)⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3729899923, 4012433610⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19973109, 85632540⟩, ⟨19559456, 44957208⟩, ⟨4663718, 6604046⟩, ⟨(-24422), 234758⟩, ⟨2723, 16841⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314940405, 4380599836⟩, ⟨19559456, 44957208⟩, ⟨4663718, 6604046⟩, ⟨(-24422), 234758⟩, ⟨2723, 16841⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304942267, 4337572251⟩, ⟨9683668, 22426519⟩, ⟨2250978, 3283481⟩, ⟨(-29288), 112044⟩, ⟨(-479), 7966⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3738562536, 4052235905⟩, ⟨(-134258539), (-120643685)⟩, ⟨1217191, 2748979⟩, ⟨(-135360), 30637⟩, ⟨(-4134), 8406⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2813418870, 5626837753⟩, ⟨1406709435, 1406709446⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1842930386, 7371721580⟩, ⟨1842930386, 3685860810⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1842930386, 7371721580⟩, ⟨1842930386, 3685860810⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7371721580), (-1842930386)⟩, ⟨(-3685860810), (-1842930386)⟩, ⟨(-460732604), (-460732596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3685860790), (-921465193)⟩, ⟨(-1842930405), (-921465193)⟩, ⟨(-230366302), (-230366298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1820775660, 3465644462⟩, ⟨(-1487075713), (-390638922)⟩, ⟨(-143979587), 221385429⟩, ⟨(-17696515), 73767627⟩, ⟨(-13850402), 5759622⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1584897672, 3269782505⟩, ⟨(-1511367496), (-391177163)⟩, ⟨(-124353661), 257577185⟩, ⟨(-24677813), 74013374⟩, ⟨(-15479681), 6182648⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4318131566, 4318131568⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3490
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304942267, 4337572251⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3491
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (158561807 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((26313 / 400000) : ℝ)..(26313 / 200000), prawitzNormalCorrection
