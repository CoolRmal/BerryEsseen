...
namespace FiniteNormalPanel131_10
...
def j2 : Jet := ⟨⟨456014074, 456014078⟩, ⟨456014074, 456014078⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨48416861, 48416863⟩, ⟨96833722, 96833726⟩, ⟨48416861, 48416863⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1068), (-1067)⟩, ⟨(-2135), (-2133)⟩, ⟨(-1068), (-1065)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111988, 5111990⟩, ⟨(-2135), (-2133)⟩, ⟨(-1068), (-1065)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨57627, 57628⟩, ⟨115229, 115231⟩, ⟨57565, 57568⟩, ⟨(-50), (-47)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-143107950), (-143107948)⟩, ⟨115229, 115231⟩, ⟨57565, 57568⟩, ⟨(-50), (-47)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1613246), (-1613245)⟩, ⟨(-3225194), (-3225192)⟩, ⟨(-1610001), (-1609998)⟩, ⟨2594, 2597⟩, ⟨645, 648⟩⟩
...
def j19 : Jet := ⟨⟨1430042519, 1430042521⟩, ⟨(-3225194), (-3225192)⟩, ⟨(-1610001), (-1609998)⟩, ⟨2594, 2597⟩, ⟨645, 648⟩⟩
...
def j28 : Jet := ⟨⟨(-9606), (-9605)⟩, ⟨(-19209), (-19206)⟩, ⟨(-9600), (-9596)⟩, ⟨3, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781788, 35781790⟩, ⟨(-19209), (-19206)⟩, ⟨(-9600), (-9596)⟩, ⟨3, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨403365, 403366⟩, ⟨806514, 806516⟩, ⟨402822, 402825⟩, ⟨(-434), (-431)⟩, ⟨(-110), (-106)⟩⟩
...
def j33 : Jet := ⟨⟨(-715424518), (-715424516)⟩, ⟨806514, 806516⟩, ⟨402822, 402825⟩, ⟨(-434), (-431)⟩, ⟨(-110), (-106)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8064931), (-8064929)⟩, ⟨(-16120770), (-16120767)⟩, ⟨(-8042208), (-8042203)⟩, ⟨18167, 18171⟩, ⟨4528, 4532⟩⟩
...
def j36 : Jet := ⟨⟨4286902365, 4286902367⟩, ⟨(-16120770), (-16120767)⟩, ⟨(-8042208), (-8042203)⟩, ⟨18167, 18171⟩, ⟨4528, 4532⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨151833406, 151833408⟩, ⟨151490974, 151490977⟩, ⟨(-513373), (-513371)⟩, ⟨(-170666), (-170664)⟩, ⟨343, 345⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303047397, 4303047400⟩, ⟨16181478, 16181483⟩, ⟨8133339, 8133347⟩, ⟨42700, 42708⟩, ⟨10799, 10808⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨152119049, 152119052⟩, ⟨152348012, 152348017⟩, ⟨343934, 343940⟩, ⟨115463, 115469⟩, ⟨614, 622⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-145153789), (-145153788)⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4149813507, 4149813508⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5387748, 5387750⟩, ⟨10791716, 10791718⟩, ⟨5428341, 5428345⟩, ⟨32576, 32580⟩, ⟨8259, 8266⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300355044, 4300355046⟩, ⟨10791716, 10791718⟩, ⟨5428341, 5428345⟩, ⟨32576, 32580⟩, ⟨8259, 8266⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297660325, 4297660327⟩, ⟨5392476, 5392478⟩, ⟨2709086, 2709089⟩, ⟨12877, 12881⟩, ⟨3255, 3261⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4152415521, 4152415525⟩, ⟨(-140034574), (-140034569)⟩, ⟨2435283, 2435287⟩, ⟨(-79117), (-79110)⟩, ⟨2708, 2716⟩⟩
...
def j47 : Jet := ⟨⟨1559100638, 1559100650⟩, ⟨1559100638, 1559100650⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨565963517, 565963527⟩, ⟨1131927034, 1131927054⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨565963517, 565963527⟩, ⟨1131927034, 1131927054⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-565963527), (-565963517)⟩, ⟨(-1131927054), (-1131927034)⟩, ⟨(-565963527), (-565963517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-282981764), (-282981758)⟩, ⟨(-565963527), (-565963517)⟩, ⟨(-282981764), (-282981758)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4021106504, 4021106511⟩, ⟨(-529875892), (-529875880)⟩, ⟨(-230026108), (-230026098)⟩, ⟨33378352, 33378355⟩, ⟨6478247, 6478249⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3887644284, 3887644295⟩, ⟨(-643394613), (-643394594)⟩, ⟨(-202835192), (-202835174)⟩, ⟨39395840, 39395855⟩, ⟨5056818, 5056833⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 290307577⟩, ⟨145153788, 145153789⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 912028152⟩, ⟨456014074, 456014078⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 193667447⟩, ⟨0, 193667448⟩, ⟨48416861, 48416863⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4270), 0⟩, ⟨(-4270), 3⟩, ⟨(-1068), (-1062)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108786, 5113057⟩, ⟨(-4270), 3⟩, ⟨(-1068), (-1062)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 230557⟩, ⟨(-193), 230558⟩, ⟨57348, 57641⟩, ⟨(-98), 2⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142935019)⟩, ⟨(-193), 230558⟩, ⟨57348, 57641⟩, ⟨(-98), 2⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6455582), 0⟩, ⟨(-6455591), 10397⟩, ⟨(-1613905), (-1598299)⟩, ⟨(-8), 5201⟩, ⟨640, 651⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425200183, 1431655766⟩, ⟨(-6455591), 10397⟩, ⟨(-1613905), (-1598299)⟩, ⟨(-8), 5201⟩, ⟨640, 651⟩⟩
...
def j74 : Jet := ⟨⟨(-38427), 0⟩, ⟨(-38428), 25⟩, ⟨(-9608), (-9568)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35752967, 35791395⟩, ⟨(-38428), 25⟩, ⟨(-9608), (-9568)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1613896⟩, ⟨(-1733), 1613898⟩, ⟨400873, 403476⟩, ⟨(-869), 2⟩, ⟨(-111), (-105)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714213986)⟩, ⟨(-1733), 1613898⟩, ⟨400873, 403476⟩, ⟨(-869), 2⟩, ⟨(-111), (-105)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-32277908), 0⟩, ⟨(-32277988), 72774⟩, ⟨(-8069557), (-7960315)⟩, ⟨(-60), 36389⟩, ⟨4473, 4550⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4262689388, 4294967296⟩, ⟨(-32277988), 72774⟩, ⟨(-8069557), (-7960315)⟩, ⟨(-60), 36389⟩, ⟨4473, 4550⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 304009385⟩, ⟨149948443, 152006901⟩, ⟨(-1028127), 1104⟩, ⟨(-171357), (-168592)⟩, ⟨(-1), 692⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4327489619⟩, ⟨(-73882), 32768670⟩, ⟨7959759, 8440361⟩, ⟨(-37228), 126008⟩, ⟨9609, 12428⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 306311403⟩, ⟨149943213, 155477382⟩, ⟨(-1038528), 1758290⟩, ⟨94759, 139067⟩, ⟨(-4649), 6044⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-290307577), 0⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4004659719, 4294967296⟩, ⟨(-145153789), (-145153788)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 21845726⟩, ⟨0, 22176884⟩, ⟨5086589, 5879064⟩, ⟨(-75190), 147138⟩, ⟨5526, 11654⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4316813022⟩, ⟨0, 22176884⟩, ⟨5086589, 5879064⟩, ⟨(-75190), 147138⟩, ⟨5526, 11654⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305876305⟩, ⟨0, 11088442⟩, ⟨2522573, 2939532⟩, ⟨(-45185), 73569⟩, ⟨1563, 5204⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4004659719, 4305876305⟩, ⟨(-145522473), (-134065346)⟩, ⟨1977317, 2939532⟩, ⟨(-144531), (-11684)⟩, ⟨(-1030), 6732⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3118201290⟩, ⟨1559100638, 1559100650⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2263854092⟩, ⟨0, 2263854100⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2263854092⟩, ⟨0, 2263854100⟩, ⟨565963517, 565963527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2263854092), 0⟩, ⟨(-2263854100), 0⟩, ⟨(-565963527), (-565963517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1131927046), 0⟩, ⟨(-1131927050), 0⟩, ⟨(-282981764), (-282981758)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3299914759, 4294967296⟩, ⟨(-1131927050), 0⟩, ⟨(-282981764), (-68262744)⟩, ⟨0, 74579081⟩, ⟨(-2664972), 9322386⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3076865270, 4305876305⟩, ⟨(-1280324563), (-103005257)⟩, ⟨(-282181310), (-22357106)⟩, ⟨1211551, 84347546⟩, ⟨(-5393344), 9359462⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297660325, 4297660327⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2636
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305876305⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2637
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (129166039 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(27037 / 400000), prawitzNormalCorrection
