...
namespace FiniteNormalPanel80_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (31963 / 160000)
def radius : Rat := (31963 / 800000)

def j0 : Jet := ⟨⟨858000248, 858000249⟩, ⟨171600049, 171600050⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2695487275, 2695487280⟩, ⟨539097453, 539097457⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1691666350, 1691666357⟩, ⟨676666536, 676666544⟩, ⟨67666653, 67666655⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨423, 424⟩, ⟨169, 170⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94264), (-94262)⟩, ⟨169, 170⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-37128), (-37127)⟩, ⟨(-14786), (-14783)⟩, ⟨(-1454), (-1451)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5075928, 5075930⟩, ⟨(-14786), (-14783)⟩, ⟨(-1454), (-1451)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1999264, 1999266⟩, ⟨793881, 793885⟩, ⟨77067, 77071⟩, ⟨(-462), (-457)⟩, ⟨(-23), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-141166313), (-141166310)⟩, ⟨793881, 793885⟩, ⟨77067, 77071⟩, ⟨(-462), (-457)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-55601426), (-55601423)⟩, ⟨(-21927884), (-21927880)⟩, ⟨(-2068630), (-2068623)⟩, ⟨24466, 24472⟩, ⟨1131, 1137⟩⟩
...
def j19 : Jet := ⟨⟨1376054339, 1376054343⟩, ⟨(-21927884), (-21927880)⟩, ⟨(-2068630), (-2068623)⟩, ⟨24466, 24472⟩, ⟨1131, 1137⟩⟩
...
def j22 : Jet := ⟨⟨(-43), (-42)⟩, ⟨(-18), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11792, 11794⟩, ⟨(-18), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4644, 4646⟩, ⟨1849, 1853⟩, ⟨181, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847533), (-847530)⟩, ⟨1849, 1853⟩, ⟨181, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-333820), (-333818)⟩, ⟨(-132800), (-132797)⟩, ⟨(-12991), (-12987)⟩, ⟨56, 59⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35457574, 35457577⟩, ⟨(-132800), (-132797)⟩, ⟨(-12991), (-12987)⟩, ⟨56, 59⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13965737, 13965739⟩, ⟨5533987, 5533992⟩, ⟨532589, 532594⟩, ⟨(-4118), (-4114)⟩, ⟨(-197), (-192)⟩⟩
...
def j33 : Jet := ⟨⟨(-701862146), (-701862143)⟩, ⟨5533987, 5533992⟩, ⟨532589, 532594⟩, ⟨(-4118), (-4114)⟩, ⟨(-197), (-192)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-276443684), (-276443681)⟩, ⟨(-108397793), (-108397787)⟩, ⟨(-9976105), (-9976099)⟩, ⟨169473, 169478⟩, ⟨7663, 7668⟩⟩
...
def j36 : Jet := ⟨⟨4018523612, 4018523615⟩, ⟨(-108397793), (-108397787)⟩, ⟨(-9976105), (-9976099)⟩, ⟨169473, 169478⟩, ⟨7663, 7668⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨863600745, 863600751⟩, ⟨158958382, 158958389⟩, ⟨(-4050610), (-4050603)⟩, ⟨(-244298), (-244291)⟩, ⟨3779, 3786⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4590428187, 4590428191⟩, ⟨123824643, 123824652⟩, ⟨14735978, 14735989⟩, ⟨511295, 511304⟩, ⟨36390, 36401⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨923009869, 923009877⟩, ⟨194791259, 194791271⟩, ⟨3216539, 3216551⟩, ⟨270307, 270320⟩, ⟨9336, 9352⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-858000249), (-858000248)⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3436967047, 3436967048⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨198359419, 198359423⟩, ⟨83723222, 83723230⟩, ⟨10216940, 10216948⟩, ⟨407940, 407952⟩, ⟨30938, 30949⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4493326715, 4493326719⟩, ⟨83723222, 83723230⟩, ⟨10216940, 10216948⟩, ⟨407940, 407952⟩, ⟨30938, 30949⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4393027576, 4393027579⟩, ⟨40927184, 40927189⟩, ⟨4803792, 4803797⟩, ⟨154662, 154670⟩, ⟨11056, 11063⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3515437947, 3515437951⟩, ⟨(-142766716), (-142766708)⟩, ⟨2208949, 2208955⟩, ⟨(-68165), (-68157)⟩, ⟨2667, 2674⟩⟩
...
def j47 : Jet := ⟨⟨6058726845, 6058726854⟩, ⟨1211745364, 1211745373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8546787077, 8546787103⟩, ⟨3418714816, 3418714848⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8546787077, 8546787103⟩, ⟨3418714816, 3418714848⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8546787103), (-8546787077)⟩, ⟨(-3418714848), (-3418714816)⟩, ⟨(-341871486), (-341871480)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4273393552), (-4273393538)⟩, ⟨(-1709357424), (-1709357408)⟩, ⟨(-170935743), (-170935740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1587986667, 1587986681⟩, ⟨(-632004073), (-632004061)⟩, ⟨62565488, 62565495⟩, ⟨8468622, 8468625⟩, ⟨(-2087634), (-2087632)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1299769754, 1299769768⟩, ⟨(-570081815), (-570081799)⟩, ⟨73034784, 73034796⟩, ⟨4501623, 4501634⟩, ⟨(-1947041), (-1947031)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨686400198, 1029600298⟩, ⟨171600049, 171600050⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2156389819, 3234584733⟩, ⟨539097453, 539097457⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1082666463, 2435999549⟩, ⟨541333228, 811999852⟩, ⟨67666653, 67666655⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨270, 611⟩, ⟨135, 204⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94417), (-94075)⟩, ⟨135, 204⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-53551), (-23714)⟩, ⟨(-17817), (-11741)⟩, ⟨(-1467), (-1433)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5059505, 5089343⟩, ⟨(-17817), (-11741)⟩, ⟨(-1467), (-1433)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1275389, 2886550⟩, ⟨627588, 959225⟩, ⟨75509, 78342⟩, ⟨(-558), (-359)⟩, ⟨(-24), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141890188), (-140279026)⟩, ⟨627588, 959225⟩, ⟨75509, 78342⟩, ⟨(-558), (-359)⟩, ⟨(-24), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-80476617), (-35361246)⟩, ⟨(-26667338), (-17136574)⟩, ⟨(-2137328), (-1984293)⟩, ⟨19087, 29835⟩, ⟨1069, 1186⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1351179148, 1396294520⟩, ⟨(-26667338), (-17136574)⟩, ⟨(-2137328), (-1984293)⟩, ⟨19087, 29835⟩, ⟨1069, 1186⟩⟩
...
def j70 : Jet := ⟨⟨(-62), (-26)⟩, ⟨(-21), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11773, 11810⟩, ⟨(-21), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2967, 6699⟩, ⟨1471, 2230⟩, ⟨179, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849210), (-845477)⟩, ⟨1471, 2230⟩, ⟨179, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-481651), (-213126)⟩, ⟨(-160181), (-105298)⟩, ⟨(-13150), (-12792)⟩, ⟨43, 72⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35309743, 35578269⟩, ⟨(-160181), (-105298)⟩, ⟨(-13150), (-12792)⟩, ⟨43, 72⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8900806, 20179117⟩, ⟨4359552, 6699830⟩, ⟨518557, 544037⟩, ⟨(-5001), (-3229)⟩, ⟨(-203), (-185)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706927077), (-695648765)⟩, ⟨4359552, 6699830⟩, ⟨518557, 544037⟩, ⟨(-5001), (-3229)⟩, ⟨(-203), (-185)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-400951608), (-175357700)⟩, ⟨(-132551591), (-83878870)⟩, ⟨(-10457356), (-9384631)⟩, ⟨131205, 207597⟩, ⟨7107, 8120⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3894015688, 4119609596⟩, ⟨(-132551591), (-83878870)⟩, ⟨(-10457356), (-9384631)⟩, ⟨131205, 207597⟩, ⟨7107, 8120⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨678391418, 1051563988⟩, ⟨149514403, 166656845⟩, ⟨(-4956887), (-3147216)⟩, ⟨(-258692), (-226595)⟩, ⟨2931, 4639⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4477789373, 4737203328⟩, ⟨91171724, 161253547⟩, ⟨12056913, 18210775⟩, ⟨214461, 902065⟩, ⟨14366, 68369⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨707268221, 1159839431⟩, ⟨170279322, 223297577⟩, ⟨(-389059), 7434571⟩, ⟨(-17842), 624442⟩, ⟨(-17942), 43216⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1029600298), (-686400198)⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3265366998, 3608567098⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨116468485, 313210187⟩, ⟨56081056, 120601308⟩, ⟨6540807, 15624713⟩, ⟨(-50094), 1110314⟩, ⟨(-12222), 101144⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4411435781, 4608177483⟩, ⟨56081056, 120601308⟩, ⟨6540807, 15624713⟩, ⟨(-50094), 1110314⟩, ⟨(-12222), 101144⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4352812011, 4448816875⟩, ⟨27070826, 59499316⟩, ⟨2759428, 7624359⟩, ⟨(-128934), 530619⟩, ⟨(-19961), 50789⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3309345033, 3737829207⟩, ⟨(-157165579), (-123920729)⟩, ⟨(-279290), 5324292⟩, ⟨(-412951), 335570⟩, ⟨(-37972), 47825⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4846981473, 7270472220⟩, ⟨1211745364, 1211745373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5469943722, 12307373412⟩, ⟨2734971850, 4102457814⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5469943722, 12307373412⟩, ⟨2734971850, 4102457814⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12307373412), (-5469943722)⟩, ⟨(-4102457814), (-2734971850)⟩, ⟨(-341871486), (-341871480)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6153686706), (-2734971861)⟩, ⟨(-2051228907), (-1367485925)⟩, ⟨(-170935743), (-170935740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1024984098, 2271995872⟩, ⟨(-1085080116), (-326347380)⟩, ⟨(-38470044), 218317713⟩, ⟨(-26096493), 34914416⟩, ⟨(-8513107), 3881386⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨789767604, 1977275249⟩, ⟨(-1027463865), (-281029579)⟩, ⟨(-24211547), 232520593⟩, ⟨(-32263756), 32041167⟩, ⟨(-8838975), 4733114⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨858000248, 858000249⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4393027576, 4393027579⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1614
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨686400198, 1029600298⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4352812011, 4448816875⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1615
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (52941169 / 2147483648)

theorem envelope_integral : (∫ s in ((31963 / 200000) : ℝ)..(95889 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((31963 / 200000) : ℝ)..(95889 / 400000), prawitzNormalCorrection
