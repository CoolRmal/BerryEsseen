...
namespace FiniteNormalPanel58_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6703 / 32000)
def radius : Rat := (6703 / 160000)

def j0 : Jet := ⟨⟨899661430, 899661431⟩, ⟨179932286, 179932287⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2826369739, 2826369743⟩, ⟨565273947, 565273952⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1859936374, 1859936380⟩, ⟨743974548, 743974558⟩, ⟨74397454, 74397457⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨465, 466⟩, ⟨186, 187⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94222), (-94220)⟩, ⟨186, 187⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-40803), (-40801)⟩, ⟨(-16242), (-16239)⟩, ⟨(-1594), (-1590)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5072253, 5072256⟩, ⟨(-16242), (-16239)⟩, ⟨(-1594), (-1590)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2196540, 2196542⟩, ⟨871582, 871585⟩, ⟨84356, 84362⟩, ⟨(-557), (-552)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-140969037), (-140969034)⟩, ⟨871582, 871585⟩, ⟨84356, 84362⟩, ⟨(-557), (-552)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-61046668), (-61046665)⟩, ⟨(-24041230), (-24041225)⟩, ⟨(-2254362), (-2254356)⟩, ⟨29467, 29473⟩, ⟨1352, 1357⟩⟩
...
def j19 : Jet := ⟨⟨1370609097, 1370609101⟩, ⟨(-24041230), (-24041225)⟩, ⟨(-2254362), (-2254356)⟩, ⟨29467, 29473⟩, ⟨1352, 1357⟩⟩
...
def j25 : Jet := ⟨⟨5104, 5106⟩, ⟨2032, 2036⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847073), (-847070)⟩, ⟨2032, 2036⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-366826), (-366823)⟩, ⟨(-145852), (-145847)⟩, ⟨(-14237), (-14231)⟩, ⟨68, 71⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35424568, 35424572⟩, ⟨(-145852), (-145847)⟩, ⟨(-14237), (-14231)⟩, ⟨68, 71⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15340615, 15340618⟩, ⟨6073084, 6073089⟩, ⟨582193, 582200⟩, ⟨(-4965), (-4960)⟩, ⟨(-236), (-231)⟩⟩
...
def j33 : Jet := ⟨⟨(-700487268), (-700487264)⟩, ⟨6073084, 6073089⟩, ⟨582193, 582200⟩, ⟨(-4965), (-4960)⟩, ⟨(-236), (-231)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-303346141), (-303346137)⟩, ⟨(-118708508), (-118708501)⟩, ⟨(-10829748), (-10829742)⟩, ⟨203894, 203901⟩, ⟨9120, 9126⟩⟩
...
def j36 : Jet := ⟨⟨3991621155, 3991621159⟩, ⟨(-118708508), (-118708501)⟩, ⟨(-10829748), (-10829742)⟩, ⟨203894, 203901⟩, ⟨9120, 9126⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨901950540, 901950545⟩, ⟨164569403, 164569411⟩, ⟨(-4647659), (-4647653)⟩, ⟨(-277313), (-277306)⟩, ⟨4767, 4773⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4621366442, 4621366447⟩, ⟨137436760, 137436771⟩, ⟨16625604, 16625614⟩, ⟨631246, 631258⟩, ⟨46291, 46304⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨970494923, 970494931⟩, ⟨205937929, 205937943⟩, ⟨3756679, 3756692⟩, ⟨322490, 322505⟩, ⟨12172, 12185⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-899661431), (-899661430)⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3395305865, 3395305866⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨219293962, 219293966⟩, ⟨93067862, 93067872⟩, ⟨11572171, 11572182⟩, ⟨505994, 506006⟩, ⟨39709, 39722⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4514261258, 4514261262⟩, ⟨93067862, 93067872⟩, ⟨11572171, 11572182⟩, ⟨505994, 506006⟩, ⟨39709, 39722⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4403249308, 4403249310⟩, ⟨45389597, 45389602⟩, ⟨5409854, 5409861⟩, ⟨191009, 191017⟩, ⟨14073, 14081⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3480906179, 3480906182⟩, ⟨(-148586733), (-148586726)⟩, ⟨2375117, 2375125⟩, ⟨(-75642), (-75634)⟩, ⟨3122, 3130⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨28035391491, 28035391497⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value322

def j47 : Jet := ⟨⟨5872538406, 5872538415⟩, ⟨1174507681, 1174507689⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8029562265, 8029562290⟩, ⟨3211824904, 3211824934⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8029562265, 8029562290⟩, ⟨3211824904, 3211824934⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8029562290), (-8029562265)⟩, ⟨(-3211824934), (-3211824904)⟩, ⟨(-321182495), (-321182490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4014781145), (-4014781132)⟩, ⟨(-1605912467), (-1605912452)⟩, ⟨(-160591248), (-160591245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1686541295, 1686541308⟩, ⟨(-630607296), (-630607285)⟩, ⟨54833076, 54833083⟩, ⟨8885041, 8885044⟩, ⟨(-1855663), (-1855661)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1366877000, 1366877013⟩, ⟨(-569429832), (-569429816)⟩, ⟨67188961, 67188974⟩, ⟨4925572, 4925584⟩, ⟨(-1768676), (-1768664)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨719729144, 1079593717⟩, ⟨179932286, 179932287⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2261095791, 3391643691⟩, ⟨565273947, 565273952⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1190359279, 2678308387⟩, ⟨595179638, 892769468⟩, ⟨74397454, 74397457⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨297, 671⟩, ⟨148, 224⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94390), (-94015)⟩, ⟨148, 224⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-58861), (-26056)⟩, ⟨(-19580), (-12888)⟩, ⟨(-1612), (-1569)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5054195, 5087001⟩, ⟨(-19580), (-12888)⟩, ⟨(-1612), (-1569)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1400780, 3172215⟩, ⟨688180, 1053834⟩, ⟨82472, 85899⟩, ⟨(-675), (-435)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141764797), (-139993361)⟩, ⟨688180, 1053834⟩, ⟨82472, 85899⟩, ⟨(-675), (-435)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-88403431), (-38799456)⟩, ⟨(-29277081), (-18742565)⟩, ⟨(-2337429), (-2152344)⟩, ⟨22927, 35991⟩, ⟨1269, 1422⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1343252334, 1392856310⟩, ⟨(-29277081), (-18742565)⟩, ⟨(-2337429), (-2152344)⟩, ⟨22927, 35991⟩, ⟨1269, 1422⟩⟩
...
def j72 : Jet := ⟨⟨3261, 7363⟩, ⟨1615, 2452⟩, ⟨196, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848916), (-844813)⟩, ⟨1615, 2452⟩, ⟨196, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-529378), (-234141)⟩, ⟨(-176013), (-115540)⟩, ⟨(-14428), (-13995)⟩, ⟨52, 86⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35262016, 35557254⟩, ⟨(-176013), (-115540)⟩, ⟨(-14428), (-13995)⟩, ⟨52, 86⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9772942, 22173229⟩, ⟨4776710, 7359055⟩, ⟨565223, 596035⟩, ⟨(-6035), (-3886)⟩, ⟨(-243), (-221)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706054941), (-693654653)⟩, ⟨4776710, 7359055⟩, ⟨565223, 596035⟩, ⟨(-6035), (-3886)⟩, ⟨(-243), (-221)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-440290401), (-192247855)⟩, ⟨(-145439593), (-91534877)⟩, ⟨(-11411701), (-10114123)⟩, ⟨157304, 250292⟩, ⟨8383, 9726⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3854676895, 4102719441⟩, ⟨(-145439593), (-91534877)⟩, ⟨(-11411701), (-10114123)⟩, ⟨157304, 250292⟩, ⟨8383, 9726⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨707158399, 1099908799⟩, ⟨153670115, 173451067⟩, ⟨(-5699066), (-3599873)⟩, ⟨(-295568), (-254854)⟩, ⟨3685, 5860⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4496223624, 4785548719⟩, ⟨100314261, 180562024⟩, ⟨13322288, 20980260⟩, ⟨252577, 1142668⟩, ⟨16115, 91356⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨740294880, 1225543010⟩, ⟨177387444, 239503639⟩, ⟨(-567382), 8896277⟩, ⟨(-50675), 789037⟩, ⟨(-24720), 58955⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1079593717), (-719729144)⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3215373579, 3575238152⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨127599693, 349701306⟩, ⟨61150182, 136681838⟩, ⟨7002520, 18432628⟩, ⟨(-92200), 1442476⟩, ⟨(-20936), 140074⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4422566989, 4644668602⟩, ⟨61150182, 136681838⟩, ⟨7002520, 18432628⟩, ⟨(-92200), 1442476⟩, ⟨(-20936), 140074⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4358300194, 4466396730⟩, ⟨29401556, 67347819⟩, ⟨2859112, 8983214⟩, ⟨(-184247), 691470⟩, ⟨(-30260), 70930⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3262786961, 3717940299⟩, ⟨(-165103002), (-126523529)⟩, ⟨(-681015), 6246111⟩, ⟨(-529713), 455819⟩, ⟨(-54159), 66763⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4698030725, 7047046096⟩, ⟨1174507681, 1174507689⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5138919850, 11562569691⟩, ⟨2569459924, 3854189918⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5138919850, 11562569691⟩, ⟨2569459924, 3854189918⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11562569691), (-5138919850)⟩, ⟨(-3854189918), (-2569459924)⟩, ⟨(-321182495), (-321182490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5781284846), (-2569459925)⟩, ⟨(-1927094959), (-1284729962)⟩, ⟨(-160591248), (-160591245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1117823695, 2361258961⟩, ⟨(-1059465632), (-334368458)⟩, ⟨(-38279904), 195888044⟩, ⟨(-20962641), 32134574⟩, ⟨(-7266772), 3067069⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨849184714, 2044024842⟩, ⟨(-1007896129), (-286941426)⟩, ⟨(-23661409), 213731476⟩, ⟨(-27508450), 29707417⟩, ⟨(-7723658), 3913087⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨899661430, 899661431⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4403249308, 4403249310⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar322 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1146
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar322 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨719729144, 1079593717⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4358300194, 4466396730⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1147
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((6703 / 40000) : ℝ)..(20109 / 80000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (6703 / 40000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (20109 / 80000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((6703 / 40000) : ℝ)..(20109 / 80000), prawitzNormalCorrection
      ((66621 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
