...
namespace FiniteNormalPanel97_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8323 / 32000)
def radius : Rat := (1189 / 32000)

def j0 : Jet := ⟨⟨1117094150, 1117094151⟩, ⟨159584878, 159584879⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3509454774, 3509454779⟩, ⟨501350680, 501350684⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2867605725, 2867605735⟩, ⟨819315918, 819315928⟩, ⟨58522565, 58522567⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨717, 719⟩, ⟨205, 206⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93970), (-93967)⟩, ⟨205, 206⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-62741), (-62738)⟩, ⟨(-17790), (-17787)⟩, ⟨(-1233), (-1229)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5050315, 5050319⟩, ⟨(-17790), (-17787)⟩, ⟨(-1233), (-1229)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3371926, 3371929⟩, ⟨951529, 951534⟩, ⟨64596, 64602⟩, ⟨(-477), (-471)⟩, ⟨(-17), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-139793651), (-139793647)⟩, ⟨951529, 951534⟩, ⟨64596, 64602⟩, ⟨(-477), (-471)⟩, ⟨(-17), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-93335537), (-93335533)⟩, ⟨(-26031993), (-26031987)⟩, ⟨(-1680164), (-1680156)⟩, ⟨24968, 24976⟩, ⟨777, 784⟩⟩
...
def j19 : Jet := ⟨⟨1338320228, 1338320233⟩, ⟨(-26031993), (-26031987)⟩, ⟨(-1680164), (-1680156)⟩, ⟨24968, 24976⟩, ⟨777, 784⟩⟩
...
def j22 : Jet := ⟨⟨(-73), (-71)⟩, ⟨(-21), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11762, 11765⟩, ⟨(-21), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7853, 7856⟩, ⟨2228, 2232⟩, ⟨153, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844324), (-844320)⟩, ⟨2228, 2232⟩, ⟨153, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-563727), (-563724)⟩, ⟨(-159578), (-159573)⟩, ⟨(-10978), (-10972)⟩, ⟨57, 62⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35227667, 35227671⟩, ⟨(-159578), (-159573)⟩, ⟨(-10978), (-10972)⟩, ⟨57, 62⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23520332, 23520336⟩, ⟨6613550, 6613555⟩, ⟨442234, 442242⟩, ⟨(-4232), (-4225)⟩, ⟨(-140), (-134)⟩⟩
...
def j33 : Jet := ⟨⟨(-692307551), (-692307546)⟩, ⟨6613550, 6613555⟩, ⟨442234, 442242⟩, ⟨(-4232), (-4225)⟩, ⟨(-140), (-134)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-462230552), (-462230546)⟩, ⟨(-127650228), (-127650220)⟩, ⟨(-7876400), (-7876390)⟩, ⟨171650, 171659⟩, ⟨5123, 5132⟩⟩
...
def j36 : Jet := ⟨⟨3832736744, 3832736750⟩, ⟨(-127650228), (-127650220)⟩, ⟨(-7876400), (-7876390)⟩, ⟨171650, 171659⟩, ⟨5123, 5132⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1093552986, 1093552993⟩, ⟨134950888, 134950897⟩, ⟨(-4411587), (-4411577)⟩, ⟨(-175725), (-175715)⟩, ⟨3548, 3557⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4812943146, 4812943155⟩, ⟨160296229, 160296241⟩, ⟨15229446, 15229463⟩, ⟨621071, 621089⟩, ⟨38355, 38373⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1225436187, 1225436198⟩, ⟨192039498, 192039515⟩, ⟨3970601, 3970619⟩, ⟨275084, 275105⟩, ⟨11052, 11073⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1117094151), (-1117094150)⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3177873145, 3177873146⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨349640345, 349640352⟩, ⟨109585070, 109585084⟩, ⟨10852376, 10852391⟩, ⟨512044, 512062⟩, ⟨34574, 34593⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4644607641, 4644607648⟩, ⟨109585070, 109585084⟩, ⟨10852376, 10852391⟩, ⟨512044, 512062⟩, ⟨34574, 34593⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4466367418, 4466367423⟩, ⟨52689831, 52689839⟩, ⟨4907162, 4907171⟩, ⟨188306, 188316⟩, ⟨11705, 11716⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3304693166, 3304693172⟩, ⟨(-126967930), (-126967921)⟩, ⟨1673082, 1673091⟩, ⟨(-43005), (-42994)⟩, ⟨1662, 1673⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨35707167691, 35707167697⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value442

def j47 : Jet := ⟨⟨9287211145, 9287211156⟩, ⟨1326744444, 1326744454⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20082176395, 20082176444⟩, ⟨5737764660, 5737764712⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20082176395, 20082176444⟩, ⟨5737764660, 5737764712⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20082176444), (-20082176395)⟩, ⟨(-5737764712), (-5737764660)⟩, ⟨(-409840338), (-409840331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10041088222), (-10041088197)⟩, ⟨(-2868882356), (-2868882330)⟩, ⟨(-204920169), (-204920165)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨414604966, 414604975⟩, ⟨(-276941084), (-276941075)⟩, ⟨72711788, 72711795⟩, ⟨(-7380729), (-7380726)⟩, ⟨(-502088), (-502086)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨319011089, 319011098⟩, ⟨(-225344405), (-225344394)⟩, ⟨64295355, 64295365⟩, ⟨(-7940525), (-7940517)⟩, ⟨(-136879), (-136871)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨957509271, 1276679029⟩, ⟨159584878, 159584879⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3008104091, 4010805459⟩, ⟨501350680, 501350684⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2106812368, 3745444220⟩, ⟨702270786, 936361058⟩, ⟨58522565, 58522567⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨527, 939⟩, ⟨175, 235⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94160), (-93747)⟩, ⟨175, 235⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-82113), (-45985)⟩, ⟨(-20444), (-15123)⟩, ⟨(-1250), (-1211)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5030943, 5067072⟩, ⟨(-20444), (-15123)⟩, ⟨(-1250), (-1211)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2467830, 4418762⟩, ⟨804781, 1097273⟩, ⟨63001, 65978⟩, ⟨(-551), (-397)⟩, ⟨(-18), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140697747), (-138746814)⟩, ⟨804781, 1097273⟩, ⟨63001, 65978⟩, ⟨(-551), (-397)⟩, ⟨(-18), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-122696060), (-68059541)⟩, ⟨(-30279246), (-21729631)⟩, ⟨(-1754634), (-1593784)⟩, ⟨20785, 29143⟩, ⟨721, 830⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1308959705, 1363596225⟩, ⟨(-30279246), (-21729631)⟩, ⟨(-1754634), (-1593784)⟩, ⟨20785, 29143⟩, ⟨721, 830⟩⟩
...
def j70 : Jet := ⟨⟨(-95), (-52)⟩, ⟨(-24), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11740, 11784⟩, ⟨(-24), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5758, 10277⟩, ⟨1898, 2562⟩, ⟨151, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846419), (-841899)⟩, ⟨1898, 2562⟩, ⟨151, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-738124), (-412977)⟩, ⟨(-183600), (-135424)⟩, ⟨(-11150), (-10773)⟩, ⟨47, 70⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35053270, 35378418⟩, ⟨(-183600), (-135424)⟩, ⟨(-11150), (-10773)⟩, ⟨47, 70⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17194697, 30851898⟩, ⟨5571455, 7646546⟩, ⟨427878, 454634⟩, ⟨(-4910), (-3544)⟩, ⟨(-145), (-127)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698633186), (-684975984)⟩, ⟨5571455, 7646546⟩, ⟨427878, 454634⟩, ⟨(-4910), (-3544)⟩, ⟨(-145), (-127)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-609245997), (-336001598)⟩, ⟨(-149578532), (-105332329)⟩, ⟨(-8398593), (-7269860)⟩, ⟨141595, 201570⟩, ⟨4632, 5554⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3685721299, 3958965698⟩, ⟨(-149578532), (-105332329)⟩, ⟨(-8398593), (-7269860)⟩, ⟨141595, 201570⟩, ⟨4632, 5554⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨916767642, 1273378540⟩, ⟨124518682, 143953345⟩, ⟨(-5173036), (-3652747)⟩, ⟨(-190262), (-158827)⟩, ⟨2930, 4178⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4659485704, 5004921040⟩, ⟨123970378, 203115940⟩, ⟨11854584, 19647737⟩, ⟨288223, 1081205⟩, ⟨12071, 78034⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨994574679, 1483866723⟩, ⟨161548388, 227968816⟩, ⟨96365, 8670220⟩, ⟨(-61149), 701348⟩, ⟨(-18553), 49579⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1276679029), (-957509271)⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3018288267, 3337458025⟩, ⟨(-159584879), (-159584878)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨230311134, 512660587⟩, ⟨74818700, 157521732⟩, ⟨6121014, 18091102⟩, ⟨(-35006), 1405018⟩, ⟨(-19310), 126217⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4525278430, 4807627883⟩, ⟨74818700, 157521732⟩, ⟨6121014, 18091102⟩, ⟨(-35006), 1405018⟩, ⟨(-19310), 126217⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4408619155, 4544073562⟩, ⟨35358568, 76730453⟩, ⟨2244901, 8670569⟩, ⟨(-167961), 666395⟩, ⟨(-29532), 63834⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3098157110, 3531029163⟩, ⟨(-143992501), (-104183396)⟩, ⟨(-1273412), 5423784⟩, ⟨(-452683), 434419⟩, ⟨(-47710), 55845⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7960466692, 10613955601⟩, ⟨1326744444, 1326744454⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14754252032, 26229781448⟩, ⟨4918083992, 6557445382⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14754252032, 26229781448⟩, ⟨4918083992, 6557445382⟩, ⟨409840331, 409840338⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-26229781448), (-14754252032)⟩, ⟨(-6557445382), (-4918083992)⟩, ⟨(-409840338), (-409840331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13114890724), (-7377126016)⟩, ⟨(-3278722691), (-2459041996)⟩, ⟨(-204920169), (-204920165)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨202684536, 770915083⟩, ⟨(-588506641), (-116045071)⟩, ⟨(-3561424), 214958771⟩, ⟨(-51007781), 19625349⟩, ⟨(-8873459), 9819632⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨146205661, 633793800⟩, ⟨(-509675617), (-88625173)⟩, ⟨(-341614), 197428166⟩, ⟨(-49966233), 16506486⟩, ⟨(-8084933), 10126620⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1117094150, 1117094151⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨159584878, 159584879⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4466367418, 4466367423⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar442 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1960
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar442 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨957509271, 1276679029⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4408619155, 4544073562⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1961
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((3567 / 16000) : ℝ)..(1189 / 4000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (3567 / 16000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (1189 / 4000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((3567 / 16000) : ℝ)..(1189 / 4000), prawitzNormalCorrection
      ((262903 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
