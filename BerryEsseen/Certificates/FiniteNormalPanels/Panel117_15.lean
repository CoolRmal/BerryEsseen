...
namespace FiniteNormalPanel117_15
...
def j2 : Jet := ⟨⟨493609051, 493609055⟩, ⟨493609051, 493609055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨56729161, 56729163⟩, ⟨113458322, 113458326⟩, ⟨56729161, 56729163⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1251), (-1250)⟩, ⟨(-2501), (-2499)⟩, ⟨(-1251), (-1248)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111805, 5111807⟩, ⟨(-2501), (-2499)⟩, ⟨(-1251), (-1248)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨67518, 67519⟩, ⟨135002, 135004⟩, ⟨67434, 67437⟩, ⟨(-68), (-64)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-143098059), (-143098057)⟩, ⟨135002, 135004⟩, ⟨67434, 67437⟩, ⟨(-68), (-64)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1890081), (-1890080)⟩, ⟨(-3778378), (-3778376)⟩, ⟨(-1885625), (-1885622)⟩, ⟨3563, 3566⟩, ⟨887, 890⟩⟩
...
def j19 : Jet := ⟨⟨1429765684, 1429765686⟩, ⟨(-3778378), (-3778376)⟩, ⟨(-1885625), (-1885622)⟩, ⟨3563, 3566⟩, ⟨887, 890⟩⟩
...
def j28 : Jet := ⟨⟨(-11254), (-11253)⟩, ⟨(-22504), (-22502)⟩, ⟨(-11244), (-11241)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35780140, 35780142⟩, ⟨(-22504), (-22502)⟩, ⟨(-11244), (-11241)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨472594, 472595⟩, ⟨944890, 944892⟩, ⟨471850, 471853⟩, ⟨(-596), (-592)⟩, ⟨(-149), (-146)⟩⟩
...
def j33 : Jet := ⟨⟨(-715355289), (-715355287)⟩, ⟨944890, 944892⟩, ⟨471850, 471853⟩, ⟨(-596), (-592)⟩, ⟨(-149), (-146)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9448619), (-9448617)⟩, ⟨(-18884757), (-18884754)⟩, ⟨(-9417427), (-9417423)⟩, ⟨24936, 24939⟩, ⟨6214, 6217⟩⟩
...
def j36 : Jet := ⟨⟨4285518677, 4285518679⟩, ⟨(-18884757), (-18884754)⟩, ⟨(-9417427), (-9417423)⟩, ⟨24936, 24939⟩, ⟨6214, 6217⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨164319128, 164319130⟩, ⟨163884889, 163884892⟩, ⟨(-650949), (-650947)⟩, ⟨(-216301), (-216299)⟩, ⟨510, 513⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304436745, 4304436748⟩, ⟨18968118, 18968123⟩, ⟨9542579, 9542587⟩, ⟨58683, 58690⟩, ⟨14871, 14879⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨164681415, 164681418⟩, ⟨164971910, 164971915⟩, ⟨436474, 436479⟩, ⟨146712, 146718⟩, ⟨915, 924⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-157120642), (-157120641)⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4137846654, 4137846655⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6314359, 6314360⟩, ⟨12650996, 12650998⟩, ⟨6370126, 6370129⟩, ⟨44780, 44784⟩, ⟨11384, 11389⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301281655, 4301281656⟩, ⟨12650996, 12650998⟩, ⟨6370126, 6370129⟩, ⟨44780, 44784⟩, ⟨11384, 11389⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298123315, 4298123317⟩, ⟨6320853, 6320855⟩, ⟨3178076, 3178079⟩, ⟨17698, 17702⟩, ⟨4485, 4490⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4140887217, 4140887221⟩, ⟨(-151146478), (-151146473)⟩, ⟨2830581, 2830585⟩, ⟨(-99213), (-99206)⟩, ⟨3672, 3679⟩⟩
...
def j47 : Jet := ⟨⟨1296800531, 1296800541⟩, ⟨1296800531, 1296800541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨391549341, 391549348⟩, ⟨783098682, 783098696⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨391549341, 391549348⟩, ⟨783098682, 783098696⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-391549348), (-391549341)⟩, ⟨(-783098696), (-783098682)⟩, ⟨(-391549348), (-391549341)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-195774674), (-195774670)⟩, ⟨(-391549348), (-391549341)⟩, ⟨(-195774674), (-195774670)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4103587526, 4103587531⟩, ⟨(-374102272), (-374102264)⟩, ⟨(-169998679), (-169998673)⟩, ⟨16534263, 16534265⟩, ⟨3497633, 3497635⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3956373112, 3956373122⟩, ⟨(-505093048), (-505093033)⟩, ⟨(-148030368), (-148030355)⟩, ⟨21582272, 21582285⟩, ⟨2690400, 2690415⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 314241283⟩, ⟨157120641, 157120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 987218107⟩, ⟨493609051, 493609055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 226916651⟩, ⟨0, 226916652⟩, ⟨56729161, 56729163⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5003), 0⟩, ⟨(-5003), 4⟩, ⟨(-1251), (-1244)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108053, 5113057⟩, ⟨(-5003), 4⟩, ⟨(-1251), (-1244)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 270139⟩, ⟨(-265), 270140⟩, ⟨67136, 67536⟩, ⟨(-134), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142895437)⟩, ⟨(-265), 270140⟩, ⟨67136, 67536⟩, ⟨(-134), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7563889), 0⟩, ⟨(-7563904), 14273⟩, ⟨(-1890988), (-1869561)⟩, ⟨(-12), 7139⟩, ⟨877, 894⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424091876, 1431655766⟩, ⟨(-7563904), 14273⟩, ⟨(-1890988), (-1869561)⟩, ⟨(-12), 7139⟩, ⟨877, 894⟩⟩
...
def j72 : Jet := ⟨⟨0, 626⟩, ⟨(-1), 626⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851550)⟩, ⟨(-1), 626⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-45024), 0⟩, ⟨(-45025), 34⟩, ⟨(-11257), (-11204)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35746370, 35791395⟩, ⟨(-45025), 34⟩, ⟨(-11257), (-11204)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1890973⟩, ⟨(-2379), 1890975⟩, ⟨469174, 472746⟩, ⟨(-1191), 2⟩, ⟨(-150), (-145)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713936909)⟩, ⟨(-2379), 1890975⟩, ⟨469174, 472746⟩, ⟨(-1191), 2⟩, ⟨(-150), (-145)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-37819442), 0⟩, ⟨(-37819569), 99907⟩, ⟨(-9454987), (-9304999)⟩, ⟨(-95), 49955⟩, ⟨6125, 6246⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4257147854, 4294967296⟩, ⟨(-37819569), 99907⟩, ⟨(-9454987), (-9304999)⟩, ⟨(-95), 49955⟩, ⟨6125, 6246⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 329072703⟩, ⟨161928453, 164539633⟩, ⟨(-1303953), 1641⟩, ⟨(-217330), (-213222)⟩, ⟨(-2), 1027⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4333122717⟩, ⟨(-101691), 38494514⟩, ⟨9304103, 9965703⟩, ⟨(-51307), 174127⟩, ⟨12955, 17505⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 331996104⟩, ⟨161920661, 168950744⟩, ⟨(-1319433), 2239931⟩, ⟨115902, 181936⟩, ⟨(-6943), 9060⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-314241283), 0⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3980726013, 4294967296⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 25662923⟩, ⟨0, 26119404⟩, ⟨5900441, 6992291⟩, ⟨(-103806), 204352⟩, ⟨6975, 16885⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4320630219⟩, ⟨0, 26119404⟩, ⟨5900441, 6992291⟩, ⟨(-103806), 204352⟩, ⟨6975, 16885⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307779648⟩, ⟨0, 13059702⟩, ⟨2921649, 3496146⟩, ⟨(-62534), 102176⟩, ⟨1748, 7640⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3980726013, 4307779648⟩, ⟨(-157589350), (-144060939)⟩, ⟨2230129, 3496146⟩, ⟨(-190432), (-4705)⟩, ⟨(-2118), 9928⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2593601073⟩, ⟨1296800531, 1296800541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1566197380⟩, ⟨0, 1566197386⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1566197380⟩, ⟨0, 1566197386⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1566197380), 0⟩, ⟨(-1566197386), 0⟩, ⟨(-391549348), (-391549341)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-783098690), 0⟩, ⟨(-783098693), 0⟩, ⟨(-195774674), (-195774670)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3579111440, 4294967296⟩, ⟨(-783098693), 0⟩, ⟨(-195774674), (-91753336)⟩, ⟨0, 35695474⟩, ⟨464082, 4461935⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3317245750, 4307779648⟩, ⟨(-943024112), (-120049844)⟩, ⟨(-194500266), (-52810889)⟩, ⟨2249689, 42981330⟩, ⟨(-1041080), 4472254⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298123315, 4298123317⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2362
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307779648⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2363
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (285923269 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(14633 / 200000), prawitzNormalCorrection
