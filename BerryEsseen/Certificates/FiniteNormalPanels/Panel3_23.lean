...
namespace FiniteNormalPanel3_23
...
def j2 : Jet := ⟨⟨698349032, 698349036⟩, ⟨698349032, 698349036⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨113549495, 113549497⟩, ⟨227098990, 227098994⟩, ⟨113549495, 113549497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨28, 29⟩, ⟨56, 57⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94659), (-94657)⟩, ⟨56, 57⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2503), (-2502)⟩, ⟨(-5005), (-5003)⟩, ⟨(-2501), (-2497)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110553, 5110555⟩, ⟨(-5005), (-5003)⟩, ⟨(-2501), (-2497)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨135111, 135112⟩, ⟨270090, 270092⟩, ⟨134779, 134782⟩, ⟨(-266), (-263)⟩, ⟨(-67), (-64)⟩⟩
...
def j16 : Jet := ⟨⟨(-143030466), (-143030464)⟩, ⟨270090, 270092⟩, ⟨134779, 134782⟩, ⟨(-266), (-263)⟩, ⟨(-67), (-64)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3781412), (-3781411)⟩, ⟨(-7555683), (-7555681)⟩, ⟨(-3763568), (-3763565)⟩, ⟨14258, 14262⟩, ⟨3546, 3550⟩⟩
...
def j19 : Jet := ⟨⟨1427874353, 1427874355⟩, ⟨(-7555683), (-7555681)⟩, ⟨(-3763568), (-3763565)⟩, ⟨14258, 14262⟩, ⟨3546, 3550⟩⟩
...
def j25 : Jet := ⟨⟨312, 313⟩, ⟨624, 626⟩, ⟨310, 313⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851865), (-851863)⟩, ⟨624, 626⟩, ⟨310, 313⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-22522), (-22521)⟩, ⟨(-45027), (-45025)⟩, ⟨(-22482), (-22478)⟩, ⟨31, 34⟩, ⟨6, 9⟩⟩
...
def j30 : Jet := ⟨⟨35768872, 35768874⟩, ⟨(-45027), (-45025)⟩, ⟨(-22482), (-22478)⟩, ⟨31, 34⟩, ⟨6, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨945650, 945651⟩, ⟨1890109, 1890111⟩, ⟨942674, 942677⟩, ⟨(-2380), (-2377)⟩, ⟨(-594), (-591)⟩⟩
...
def j33 : Jet := ⟨⟨(-714882233), (-714882231)⟩, ⟨1890109, 1890111⟩, ⟨942674, 942677⟩, ⟨(-2380), (-2377)⟩, ⟨(-594), (-591)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-18899916), (-18899914)⟩, ⟨(-37749861), (-37749858)⟩, ⟨(-18775054), (-18775050)⟩, ⟨99751, 99754⟩, ⟨24780, 24783⟩⟩
...
def j36 : Jet := ⟨⟨4276067380, 4276067382⟩, ⟨(-37749861), (-37749858)⟩, ⟨(-18775054), (-18775050)⟩, ⟨99751, 99754⟩, ⟨24780, 24783⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨232168164, 232168166⟩, ⟨230939632, 230939635⟩, ⟨(-1840478), (-1840475)⟩, ⟨(-609628), (-609625)⟩, ⟨2894, 2897⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4313950746, 4313950749⟩, ⟨38084298, 38084303⟩, ⟨19277599, 19277606⟩, ⟨236764, 236772⟩, ⟨60839, 60848⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨233194330, 233194333⟩, ⟨234019047, 234019052⟩, ⟨1241239, 1241246⟩, ⟨420708, 420715⟩, ⟨5257, 5267⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-222291402), (-222291401)⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4072675894, 4072675895⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨12661236, 12661237⟩, ⟨25412028, 25412030⟩, ⟨12885734, 12885739⟩, ⟨180946, 180950⟩, ⟨46774, 46779⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4307628532, 4307628533⟩, ⟨25412028, 25412030⟩, ⟨12885734, 12885739⟩, ⟨180946, 180950⟩, ⟨46774, 46779⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4301293255, 4301293256⟩, ⟨12687327, 12687329⟩, ⟨6414679, 6414683⟩, ⟨71418, 71422⟩, ⟨18358, 18363⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4078674445, 4078674448⟩, ⟨(-210588132), (-210588127)⟩, ⟨5426030, 5426036⟩, ⟨(-264279), (-264273)⟩, ⟨13710, 13717⟩⟩
...
def j47 : Jet := ⟨⟨931257174, 931257179⟩, ⟨931257174, 931257179⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨201920029, 201920032⟩, ⟨403840058, 403840064⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨201920029, 201920032⟩, ⟨403840058, 403840064⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-201920032), (-201920029)⟩, ⟨(-403840064), (-403840058)⟩, ⟨(-201920032), (-201920029)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-100960016), (-100960014)⟩, ⟨(-201920032), (-201920029)⟩, ⟨(-100960016), (-100960014)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4195184649, 4195184652⟩, ⟨(-197228934), (-197228930)⟩, ⟨(-93978289), (-93978285)⟩, ⟨4563524, 4563526⟩, ⟨1050917, 1050919⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3983916812, 3983916819⟩, ⟨(-392992217), (-392992206)⟩, ⟨(-74275207), (-74275194)⟩, ⟨8434280, 8434293⟩, ⟨681035, 681049⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 444582803⟩, ⟨222291401, 222291402⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1396698068⟩, ⟨698349032, 698349036⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 454197986⟩, ⟨0, 454197988⟩, ⟨113549495, 113549497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 114⟩, ⟨0, 114⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94572)⟩, ⟨0, 114⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-10014), 0⟩, ⟨(-10014), 13⟩, ⟨(-2504), (-2483)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5103042, 5113057⟩, ⟨(-10014), 13⟩, ⟨(-2504), (-2483)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 540712⟩, ⟨(-1059), 540714⟩, ⟨133589, 135180⟩, ⟨(-530), 2⟩, ⟨(-67), (-63)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142624864)⟩, ⟨(-1059), 540714⟩, ⟨133589, 135180⟩, ⟨(-530), 2⟩, ⟨(-67), (-63)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-15139933), 0⟩, ⟨(-15140045), 57182⟩, ⟨(-3785096), (-3699209)⟩, ⟨(-85), 28593⟩, ⟨3466, 3575⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1416515832, 1431655766⟩, ⟨(-15140045), 57182⟩, ⟨(-3785096), (-3699209)⟩, ⟨(-85), 28593⟩, ⟨3466, 3575⟩⟩
...
def j70 : Jet := ⟨⟨(-12), 0⟩, ⟨(-12), 0⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11823, 11836⟩, ⟨(-12), 0⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 1252⟩, ⟨(-2), 1252⟩, ⟨309, 313⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-850924)⟩, ⟨(-2), 1252⟩, ⟨309, 313⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-90119), 0⟩, ⟨(-90120), 133⟩, ⟨(-22531), (-22329)⟩, ⟨(-2), 68⟩, ⟨6, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35701275, 35791395⟩, ⟨(-90120), 133⟩, ⟨(-22531), (-22329)⟩, ⟨(-2), 68⟩, ⟨6, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3784984⟩, ⟨(-9531), 3784999⟩, ⟨931949, 946261⟩, ⟨(-4767), 12⟩, ⟨(-597), (-581)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712042898)⟩, ⟨(-9531), 3784999⟩, ⟨931949, 946261⟩, ⟨(-4767), 12⟩, ⟨(-597), (-581)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-75699665), 0⟩, ⟨(-75700673), 400269⟩, ⟨(-18925925), (-18324511)⟩, ⟨(-757), 200139⟩, ⟨24069, 25020⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4219267631, 4294967296⟩, ⟨(-75700673), 400269⟩, ⟨(-18925925), (-18324511)⟩, ⟨(-757), 200139⟩, ⟨24069, 25020⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 465566023⟩, ⟨225397848, 232801609⟩, ⟨(-3692618), 9298⟩, ⟨(-615474), (-592181)⟩, ⟨(-14), 5813⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4372025121⟩, ⟨(-414762), 78441397⟩, ⟨18317200, 21018504⟩, ⟨(-211241), 729749⟩, ⟨45301, 82895⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 473918940⟩, ⟨225352888, 245481296⟩, ⟨(-3781351), 6539617⟩, ⟨244420, 626554⟩, ⟨(-40777), 54565⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-444582803), 0⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3850384493, 4294967296⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 52293568⟩, ⟨0, 54174214⟩, ⟨10989561, 15473823⟩, ⟨(-432252), 885824⟩, ⟨10890, 93624⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4347260864⟩, ⟨0, 54174214⟩, ⟨10989561, 15473823⟩, ⟨(-432252), 885824⟩, ⟨10890, 93624⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4321034974⟩, ⟨0, 27087107⟩, ⟨5376731, 7736912⟩, ⟨(-264921), 442912⟩, ⟨(-4318), 45118⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3850384493, 4321034974⟩, ⟨(-223640568), (-195204294)⟩, ⟨3418244, 7736912⟩, ⟨(-665355), 164633⟩, ⟨(-27242), 58830⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1862514354⟩, ⟨931257174, 931257179⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 807680125⟩, ⟨0, 807680126⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 807680125⟩, ⟨0, 807680126⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-807680125), 0⟩, ⟨(-807680126), 0⟩, ⟨(-201920032), (-201920029)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-403840063), 0⟩, ⟨(-403840063), 0⟩, ⟨(-100960016), (-100960014)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3909531708, 4294967296⟩, ⟨(-403840063), 0⟩, ⟨(-100960016), (-72913937)⟩, ⟨0, 9492901⟩, ⟨633833, 1186613⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3504846306, 4321034974⟩, ⟨(-629931680), (-177686423)⟩, ⟨(-98461293), (-36601416)⟩, ⟨1921075, 14972177⟩, ⟨(-150667), 1257176⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4301293255, 4301293256⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified62
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4321034974⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified63
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (409848413 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(8281 / 80000), prawitzNormalCorrection
