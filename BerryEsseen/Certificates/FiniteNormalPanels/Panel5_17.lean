...
namespace FiniteNormalPanel5_17
...
def j2 : Jet := ⟨⟨2148631323, 2148631327⟩, ⟨716210441, 716210445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1074889805, 1074889810⟩, ⟨716593202, 716593210⟩, ⟨119432200, 119432202⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨269, 270⟩, ⟨179, 180⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94418), (-94416)⟩, ⟨179, 180⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23630), (-23629)⟩, ⟨(-15710), (-15706)⟩, ⟨(-2590), (-2586)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5089426, 5089428⟩, ⟨(-15710), (-15706)⟩, ⟨(-2590), (-2586)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1273716, 1273718⟩, ⟨845212, 845215⟩, ⟨138253, 138258⟩, ⟨(-868), (-863)⟩, ⟨(-72), (-67)⟩⟩
...
def j16 : Jet := ⟨⟨(-141891861), (-141891858)⟩, ⟨845212, 845215⟩, ⟨138253, 138258⟩, ⟨(-868), (-863)⟩, ⟨(-72), (-67)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-35510892), (-35510890)⟩, ⟨(-23462400), (-23462396)⟩, ⟨(-3770036), (-3770032)⟩, ⟨46351, 46357⟩, ⟨3680, 3686⟩⟩
...
def j19 : Jet := ⟨⟨1396144873, 1396144876⟩, ⟨(-23462400), (-23462396)⟩, ⟨(-3770036), (-3770032)⟩, ⟨46351, 46357⟩, ⟨3680, 3686⟩⟩
...
def j22 : Jet := ⟨⟨(-28), (-26)⟩, ⟨(-19), (-17)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11807, 11810⟩, ⟨(-19), (-17)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2954, 2956⟩, ⟨1964, 1967⟩, ⟨322, 327⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849223), (-849220)⟩, ⟨1964, 1967⟩, ⟨322, 327⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-212533), (-212531)⟩, ⟨(-141198), (-141194)⟩, ⟨(-23208), (-23203)⟩, ⟨106, 110⟩, ⟨6, 10⟩⟩
...
def j30 : Jet := ⟨⟨35578861, 35578864⟩, ⟨(-141198), (-141194)⟩, ⟨(-23208), (-23203)⟩, ⟨106, 110⟩, ⟨6, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8904224, 8904226⟩, ⟨5900811, 5900815⟩, ⟨959990, 959996⟩, ⟨(-7774), (-7769)⟩, ⟨(-628), (-623)⟩⟩
...
def j33 : Jet := ⟨⟨(-706923659), (-706923656)⟩, ⟨5900811, 5900815⟩, ⟨959990, 959996⟩, ⟨(-7774), (-7769)⟩, ⟨(-628), (-623)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-176919866), (-176919864)⟩, ⟨(-116469799), (-116469794)⟩, ⟨(-18432991), (-18432985)⟩, ⟨322309, 322314⟩, ⟨25238, 25245⟩⟩
...
def j36 : Jet := ⟨⟨4118047430, 4118047432⟩, ⟨(-116469799), (-116469794)⟩, ⟨(-18432991), (-18432985)⟩, ⟨322309, 322314⟩, ⟨25238, 25245⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨698445505, 698445509⟩, ⟨221077698, 221077704⟩, ⟨(-5798516), (-5798512)⟩, ⟨(-605489), (-605483)⟩, ⟨9569, 9575⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4479488004, 4479488007⟩, ⟨126692334, 126692342⟩, ⟨23634055, 23634065⟩, ⟨884925, 884934⟩, ⟨93438, 93451⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨728452173, 728452178⟩, ⟨251178300, 251178310⟩, ⟨4317043, 4317053⟩, ⟨557890, 557902⟩, ⟨20955, 20968⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-683930593), (-683930592)⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3611036703, 3611036704⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨123549850, 123549853⟩, ⟨85202686, 85202692⟩, ⟨16153802, 16153810⟩, ⟨694180, 694188⟩, ⟨76699, 76710⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4418517146, 4418517149⟩, ⟨85202686, 85202692⟩, ⟨16153802, 16153810⟩, ⟨694180, 694188⟩, ⟨76699, 76710⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4356304240, 4356304243⟩, ⟨42001514, 42001518⟩, ⟨7760698, 7760703⟩, ⟨267377, 267383⟩, ⟨28318, 28325⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3662606352, 3662606356⟩, ⟨(-195919439), (-195919431)⟩, ⟨4295443, 4295449⟩, ⟨(-187140), (-187132)⟩, ⟨9615, 9623⟩⟩
...
def j47 : Jet := ⟨⟨2731256573, 2731256579⟩, ⟨910418857, 910418863⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1736861296, 1736861305⟩, ⟨1157907530, 1157907542⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1736861296, 1736861305⟩, ⟨1157907530, 1157907542⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1736861305), (-1736861296)⟩, ⟨(-1157907542), (-1157907530)⟩, ⟨(-192984591), (-192984588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-868430653), (-868430648)⟩, ⟨(-578953771), (-578953765)⟩, ⟨(-96492296), (-96492294)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3508703770, 3508703776⟩, ⟨(-472966881), (-472966874)⟩, ⟨(-46950279), (-46950274)⟩, ⟨9193500, 9193502⟩, ⟨217583, 217585⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2992106768, 2992106777⟩, ⟨(-563383750), (-563383735)⟩, ⟨(-14953678), (-14953665)⟩, ⟨9355697, 9355710⟩, ⟨(-252320), (-252305)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨455953728, 911907457⟩, ⟨227976864, 227976865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1432420882, 2864841768⟩, ⟨716210441, 716210445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨477728802, 1910915216⟩, ⟨477728802, 955457612⟩, ⟨119432200, 119432202⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨119, 479⟩, ⟨119, 240⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94568), (-94207)⟩, ⟨119, 240⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-42076), (-10478)⟩, ⟨(-21025), (-10371)⟩, ⟨(-2614), (-2551)⟩, ⟨6, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5070980, 5102579⟩, ⟨(-21025), (-10371)⟩, ⟨(-2614), (-2551)⟩, ⟨6, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨564044, 2270238⟩, ⟨554689, 1133966⟩, ⟨135169, 140454⟩, ⟨(-1167), (-564)⟩, ⟨(-73), (-65)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142601533), (-140895338)⟩, ⟨554689, 1133966⟩, ⟨135169, 140454⟩, ⟨(-1167), (-564)⟩, ⟨(-73), (-65)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-63446220), (-15671774)⟩, ⟨(-31661413), (-15167250)⟩, ⟨(-3888657), (-3603190)⟩, ⟨29938, 62717⟩, ⟨3465, 3837⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1368209545, 1415983992⟩, ⟨(-31661413), (-15167250)⟩, ⟨(-3888657), (-3603190)⟩, ⟨29938, 62717⟩, ⟨3465, 3837⟩⟩
...
def j70 : Jet := ⟨⟨(-49), (-11)⟩, ⟨(-25), (-11)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11786, 11825⟩, ⟨(-25), (-11)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1310, 5262⟩, ⟨1298, 2630⟩, ⟨319, 328⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850867), (-846914)⟩, ⟨1298, 2630⟩, ⟨319, 328⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-378568), (-94202)⟩, ⟨(-189140), (-93031)⟩, ⟨(-23482), (-22818)⟩, ⟨70, 147⟩, ⟨6, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35412826, 35697193⟩, ⟨(-189140), (-93031)⟩, ⟨(-23482), (-22818)⟩, ⟨70, 147⟩, ⟨6, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3938965, 15882382⟩, ⟨3854812, 7930844⟩, ⟨932216, 979764⟩, ⟨(-10477), (-5058)⟩, ⟨(-646), (-596)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-711888918), (-699945500)⟩, ⟨3854812, 7930844⟩, ⟨932216, 979764⟩, ⟨(-10477), (-5058)⟩, ⟨(-646), (-596)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-316733347), (-77854871)⟩, ⟨(-157937904), (-74326282)⟩, ⟨(-19263375), (-17263505)⟩, ⟨206220, 437934⟩, ⟨23303, 26617⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3978233949, 4217112425⟩, ⟨(-157937904), (-74326282)⟩, ⟨(-19263375), (-17263505)⟩, ⟨206220, 437934⟩, ⟨23303, 26617⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨456313584, 944493824⟩, ⟨207037902, 231065006⟩, ⟨(-7873547), (-3730930)⟩, ⟨(-638472), (-559018)⟩, ⟨6147, 13019⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4374259496, 4636917867⟩, ⟨77095986, 184087991⟩, ⟨19265623, 29761237⟩, ⟨173631, 1846178⟩, ⟨33540, 187788⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨464737887, 1019691185⟩, ⟨219051133, 289943868⟩, ⟨(-2737166), 12648652⟩, ⟨(-79635), 1370805⟩, ⟨(-63733), 127906⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-911907457), (-455953728)⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3383059839, 3839013568⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨50287065, 242090345⟩, ⟨47404952, 137674254⟩, ⟨9872313, 25579448⟩, ⟨(-407376), 2358668⟩, ⟨(-49077), 283067⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4345254361, 4537057641⟩, ⟨47404952, 137674254⟩, ⟨9872313, 25579448⟩, ⟨(-407376), 2358668⟩, ⟨(-49077), 283067⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4320037658, 4414353202⟩, ⟨23061444, 68437647⟩, ⟨4272148, 12653949⟩, ⟨(-402969), 1149686⟩, ⟨(-61143), 144985⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3402807261, 3945725467⟩, ⟨(-216148831), (-168135291)⟩, ⟨(-267586), 10086505⟩, ⟨(-1031862), 800871⟩, ⟨(-115679), 150984⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1820837715, 3641675438⟩, ⟨910418857, 910418863⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨771938353, 3087753430⟩, ⟨771938352, 1543876722⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨771938353, 3087753430⟩, ⟨771938352, 1543876722⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3087753430), (-771938353)⟩, ⟨(-1543876722), (-771938352)⟩, ⟨(-192984591), (-192984588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1543876715), (-385969176)⟩, ⟨(-771938361), (-385969176)⟩, ⟨(-96492296), (-96492294)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2998110121, 3925832731⟩, ⟨(-705593472), (-269426520)⟩, ⟨(-76093118), (-3948153)⟩, ⟨4153623, 15126842⟩, ⟨(-635341), 761452⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2375336105, 3606606784⟩, ⟨(-845790443), (-330827811)⟩, ⟨(-59603004), 41601327⟩, ⟨845153, 18502284⟩, ⟨(-1760963), 849202⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4356304240, 4356304243⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified106
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4320037658, 4414353202⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified107
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (158565463 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((1327 / 12500) : ℝ)..(1327 / 6250), prawitzNormalCorrection
