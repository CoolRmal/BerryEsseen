...
namespace FiniteNormalPanel30_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (130053 / 400000)
def radius : Rat := (18579 / 400000)

def j0 : Jet := ⟨⟨1396433454, 1396433455⟩, ⟨199490493, 199490494⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4387025080, 4387025084⟩, ⟨626717867, 626717871⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4481056018, 4481056028⟩, ⟨1280301716, 1280301726⟩, ⟨91450122, 91450124⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1121, 1123⟩, ⟨320, 321⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93566), (-93563)⟩, ⟨320, 321⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-97620), (-97616)⟩, ⟨(-27559), (-27555)⟩, ⟨(-1876), (-1872)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5015436, 5015441⟩, ⟨(-27559), (-27555)⟩, ⟨(-1876), (-1872)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5232740, 5232746⟩, ⟨1466314, 1466323⟩, ⟨96616, 96625⟩, ⟨(-1135), (-1129)⟩, ⟨(-37), (-32)⟩⟩
...
def j16 : Jet := ⟨⟨(-137932837), (-137932830)⟩, ⟨1466314, 1466323⟩, ⟨96616, 96625⟩, ⟨(-1135), (-1129)⟩, ⟨(-37), (-32)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-143909075), (-143909067)⟩, ⟨(-39587034), (-39587021)⟩, ⟨(-2399020), (-2399005)⟩, ⟨58836, 58849⟩, ⟨1679, 1689⟩⟩
...
def j19 : Jet := ⟨⟨1287746690, 1287746699⟩, ⟨(-39587034), (-39587021)⟩, ⟨(-2399020), (-2399005)⟩, ⟨58836, 58849⟩, ⟨1679, 1689⟩⟩
...
def j22 : Jet := ⟨⟨(-113), (-111)⟩, ⟨(-33), (-31)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11722, 11725⟩, ⟨(-33), (-31)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨12229, 12234⟩, ⟨3459, 3464⟩, ⟨235, 239⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-839948), (-839942)⟩, ⟨3459, 3464⟩, ⟨235, 239⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-876341), (-876334)⟩, ⟨(-246776), (-246766)⟩, ⟨(-16609), (-16601)⟩, ⟨140, 146⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34915053, 34915061⟩, ⟨(-246776), (-246766)⟩, ⟨(-16609), (-16601)⟩, ⟨140, 146⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨36427822, 36427832⟩, ⟨10150480, 10150495⟩, ⟨652532, 652547⟩, ⟨(-10061), (-10049)⟩, ⟨(-311), (-302)⟩⟩
...
def j33 : Jet := ⟨⟨(-679400061), (-679400050)⟩, ⟨10150480, 10150495⟩, ⟨652532, 652547⟩, ⟨(-10061), (-10049)⟩, ⟨(-311), (-302)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-708836536), (-708836522)⟩, ⟨(-191934455), (-191934432)⟩, ⟨(-10759457), (-10759433)⟩, ⟨400145, 400166⟩, ⟨10568, 10585⟩⟩
...
def j36 : Jet := ⟨⟨3586130760, 3586130774⟩, ⟨(-191934455), (-191934432)⟩, ⟨(-10759457), (-10759433)⟩, ⟨400145, 400166⟩, ⟨10568, 10585⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1315348089, 1315348100⟩, ⟨147471331, 147471348⟩, ⟨(-8226947), (-8226927)⟩, ⟨(-289966), (-289949)⟩, ⟨10299, 10314⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5143912823, 5143912844⟩, ⟨275308974, 275309011⟩, ⟨30168128, 30168170⟩, ⟨1866647, 1866687⟩, ⟨144512, 144546⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1575340493, 1575340514⟩, ⟨260934885, 260934921⟩, ⟨8838966, 8839007⟩, ⟨732882, 732921⟩, ⟨44309, 44345⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1396433455), (-1396433454)⟩, ⟨(-199490494), (-199490493)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2898533841, 2898533842⟩, ⟨(-199490494), (-199490493)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨577815265, 577815282⟩, ⟨191415328, 191415360⟩, ⟨22336787, 22336824⟩, ⟨1611620, 1611658⟩, ⟨139742, 139779⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4872782561, 4872782578⟩, ⟨191415328, 191415360⟩, ⟨22336787, 22336824⟩, ⟨1611620, 1611658⟩, ⟨139742, 139779⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4574761386, 4574761395⟩, ⟨89854147, 89854164⟩, ⟨9602904, 9602924⟩, ⟨567912, 567932⟩, ⟨44363, 44383⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3087357778, 3087357787⟩, ⟨(-151846588), (-151846572)⟩, ⟨2307185, 2307202⟩, ⟨(-62767), (-62751)⟩, ⟨3559, 3575⟩⟩
...
def j47 : Jet := ⟨⟨7352222134, 7352222141⟩, ⟨1050317445, 1050317451⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12585700095, 12585700120⟩, ⟨3595914302, 3595914328⟩, ⟨256851021, 256851024⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12585700095, 12585700120⟩, ⟨3595914302, 3595914328⟩, ⟨256851021, 256851024⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12585700120), (-12585700095)⟩, ⟨(-3595914328), (-3595914302)⟩, ⟨(-256851024), (-256851021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6292850060), (-6292850047)⟩, ⟨(-1797957164), (-1797957151)⟩, ⟨(-128425512), (-128425510)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨992305365, 992305376⟩, ⟨(-415398404), (-415398396)⟩, ⟨57275623, 57275628⟩, ⟨288428, 288431⟩, ⟨(-886497), (-886495)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨713300352, 713300363⟩, ⟨(-333683958), (-333683945)⟩, ⟨56390787, 56390800⟩, ⟨(-2055272), (-2055261)⟩, ⟨(-609782), (-609772)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1196942960, 1595923948⟩, ⟨199490493, 199490494⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3760307209, 5013742951⟩, ⟨626717867, 626717871⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3292204417, 5852807868⟩, ⟨1097401470, 1463201972⟩, ⟨91450122, 91450124⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨824, 1467⟩, ⟨274, 367⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93863), (-93219)⟩, ⟨274, 367⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-127909), (-71454)⟩, ⟨(-31768), (-23317)⟩, ⟨(-1913), (-1826)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4985147, 5041603⟩, ⟨(-31768), (-23317)⟩, ⟨(-1913), (-1826)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3821245, 6870259⟩, ⟨1230457, 1699692⟩, ⟨92715, 99992⟩, ⟨(-1322), (-940)⟩, ⟨(-39), (-30)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139344332), (-136295317)⟩, ⟨1230457, 1699692⟩, ⟨92715, 99992⟩, ⟨(-1322), (-940)⟩, ⟨(-39), (-30)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-189886336), (-104473914)⟩, ⟨(-46528408), (-32508444)⟩, ⟨(-2581515), (-2186743)⟩, ⟨48086, 69537⟩, ⟨1469, 1868⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1241769429, 1327181852⟩, ⟨(-46528408), (-32508444)⟩, ⟨(-2581515), (-2186743)⟩, ⟨48086, 69537⟩, ⟨1469, 1868⟩⟩
...
def j70 : Jet := ⟨⟨(-148), (-82)⟩, ⟨(-37), (-27)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11687, 11754⟩, ⟨(-37), (-27)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8958, 16018⟩, ⟨2935, 3985⟩, ⟨230, 244⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843219), (-836158)⟩, ⟨2935, 3985⟩, ⟨230, 244⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1149066), (-640936)⟩, ⟨(-285018), (-208214)⟩, ⟨(-17030), (-16112)⟩, ⟨115, 169⟩, ⟨0, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34642328, 35150459⟩, ⟨(-285018), (-208214)⟩, ⟨(-17030), (-16112)⟩, ⟨115, 169⟩, ⟨0, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨26554247, 47899989⟩, ⟨8463017, 11815397⟩, ⟨617309, 682888⟩, ⟨(-11783), (-8318)⟩, ⟨(-334), (-276)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-689273636), (-667927893)⟩, ⟨8463017, 11815397⟩, ⟨617309, 682888⟩, ⟨(-11783), (-8318)⟩, ⟨(-334), (-276)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-939282161), (-511984145)⟩, ⟨(-228333418), (-154560385)⟩, ⟨(-12040727), (-9265951)⟩, ⟨321867, 477850⟩, ⟨8672, 12205⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3355685135, 3782983151⟩, ⟨(-228333418), (-154560385)⟩, ⟨(-12040727), (-9265951)⟩, ⟨321867, 477850⟩, ⟨8672, 12205⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1087187448, 1549289715⟩, ⟨126882830, 165199593⟩, ⟨(-9802925), (-6658128)⟩, ⟨(-334593), (-237912)⟩, ⟨8302, 12328⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4876242726, 5497161782⟩, ⟨199227414, 374047532⟩, ⟨20083539, 45176284⟩, ⟨614152, 3948393⟩, ⟨9299, 399055⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1234326019, 1982947861⟩, ⟨194485536, 346367454⟩, ⟨(-1577465), 23124044⟩, ⟨(-533212), 2582958⟩, ⟨(-102331), 269429⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1595923948), (-1196942960)⟩, ⟨(-199490494), (-199490493)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2699043348, 3098024336⟩, ⟨(-199490494), (-199490493)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨354731623, 915509235⟩, ⟨111785976, 319829492⟩, ⟨7350127, 49285117⟩, ⟨(-746790), 6114734⟩, ⟨(-188988), 789892⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4649698919, 5210476531⟩, ⟨111785976, 319829492⟩, ⟨7350127, 49285117⟩, ⟨(-746790), 6114734⟩, ⟨(-188988), 789892⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4468814696, 4730626418⟩, ⟨50745616, 153693687⟩, ⟨839931, 23395785⟩, ⟨(-1163509), 2928892⟩, ⟨(-252794), 419520⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2808292531, 3412271796⟩, ⟨(-187836212), (-96703708)⟩, ⟨(-6610859), 14518725⟩, ⟨(-1925933), 2073642⟩, ⟨(-318385), 356650⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6301904683, 8402539587⟩, ⟨1050317445, 1050317451⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9246636795, 16438465452⟩, ⟨3082212258, 4109616374⟩, ⟨256851021, 256851024⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9246636795, 16438465452⟩, ⟨3082212258, 4109616374⟩, ⟨256851021, 256851024⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16438465452), (-9246636795)⟩, ⟨(-4109616374), (-3082212258)⟩, ⟨(-256851024), (-256851021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8219232726), (-4623318397)⟩, ⟨(-2054808187), (-1541106129)⟩, ⟨(-128425512), (-128425510)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨633658376, 1463738451⟩, ⟨(-700285136), (-227367227)⟩, ⟨(-2976239), 148568749⟩, ⟨(-19160471), 14434302⟩, ⟨(-3947630), 2336197⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨414321684, 1162913031⟩, ⟨(-620378719), (-162932742)⟩, ⟨501737, 153609431⟩, ⟨(-24743761), 13382540⟩, ⟨(-4442879), 3631822⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1396433454, 1396433455⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4574761386, 4574761395⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified598
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1196942960, 1595923948⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4468814696, 4730626418⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified599
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (34037827 / 2147483648)

theorem envelope_integral : (∫ s in ((55737 / 200000) : ℝ)..(18579 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((55737 / 200000) : ℝ)..(18579 / 50000), prawitzNormalCorrection
