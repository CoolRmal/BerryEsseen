...
namespace FiniteNormalPanel124_14
...
def j2 : Jet := ⟨⟨467500022, 467500026⟩, ⟨467500022, 467500026⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨50886597, 50886599⟩, ⟨101773194, 101773198⟩, ⟨50886597, 50886599⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1122), (-1121)⟩, ⟨(-2244), (-2242)⟩, ⟨(-1122), (-1119)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111934, 5111936⟩, ⟨(-2244), (-2242)⟩, ⟨(-1122), (-1119)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨60565, 60567⟩, ⟨121104, 121107⟩, ⟨60497, 60501⟩, ⟨(-54), (-51)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-143105012), (-143105009)⟩, ⟨121104, 121107⟩, ⟨60497, 60501⟩, ⟨(-54), (-51)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1695503), (-1695502)⟩, ⟨(-3389571), (-3389569)⟩, ⟨(-1691918), (-1691915)⟩, ⟨2866, 2869⟩, ⟨713, 716⟩⟩
...
def j19 : Jet := ⟨⟨1429960262, 1429960264⟩, ⟨(-3389571), (-3389569)⟩, ⟨(-1691918), (-1691915)⟩, ⟨2866, 2869⟩, ⟨713, 716⟩⟩
...
def j25 : Jet := ⟨⟨140, 141⟩, ⟨279, 281⟩, ⟨138, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852037), (-852035)⟩, ⟨279, 281⟩, ⟨138, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10095), (-10094)⟩, ⟨(-20187), (-20185)⟩, ⟨(-10088), (-10085)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781299, 35781301⟩, ⟨(-20187), (-20185)⟩, ⟨(-10088), (-10085)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨423935, 423936⟩, ⟨847630, 847632⟩, ⟨423336, 423339⟩, ⟨(-480), (-476)⟩, ⟨(-121), (-117)⟩⟩
...
def j33 : Jet := ⟨⟨(-715403948), (-715403946)⟩, ⟨847630, 847632⟩, ⟨423336, 423339⟩, ⟨(-480), (-476)⟩, ⟨(-121), (-117)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8476078), (-8476076)⟩, ⟨(-16942113), (-16942110)⟩, ⟨(-8450978), (-8450974)⟩, ⟨20067, 20070⟩, ⟨5001, 5004⟩⟩
...
def j36 : Jet := ⟨⟨4286491218, 4286491220⟩, ⟨(-16942113), (-16942110)⟩, ⟨(-8450978), (-8450974)⟩, ⟨20067, 20070⟩, ⟨5001, 5004⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨155648787, 155648790⟩, ⟨155279837, 155279842⟩, ⟨(-553113), (-553110)⟩, ⟨(-183852), (-183849)⟩, ⟨388, 391⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303460132, 4303460135⟩, ⟨17009178, 17009183⟩, ⟨8551655, 8551662⟩, ⟨47184, 47191⟩, ⟨11941, 11949⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨155956565, 155956569⟩, ⟨156203295, 156203302⟩, ⟨370651, 370657⟩, ⟨124477, 124485⟩, ⟨694, 704⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-148809880), (-148809879)⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4146157416, 4146157417⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5663011, 5663013⟩, ⟨11343940, 11343944⟩, ⟨5707860, 5707865⟩, ⟨35998, 36004⟩, ⟨9135, 9140⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300630307, 4300630309⟩, ⟨11343940, 11343944⟩, ⟨5707860, 5707865⟩, ⟨35998, 36004⟩, ⟨9135, 9140⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297797868, 4297797870⟩, ⟨5668234, 5668237⟩, ⟨2848312, 2848316⟩, ⟨14229, 14234⟩, ⟨3601, 3606⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4148889915, 4148889919⟩, ⟨(-143436110), (-143436104)⟩, ⟨2553234, 2553239⟩, ⟨(-84952), (-84945)⟩, ⟨2982, 2990⟩⟩
...
def j47 : Jet := ⟨⟨1409012024, 1409012035⟩, ⟨1409012024, 1409012035⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨462242142, 462242150⟩, ⟨924484284, 924484300⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨462242142, 462242150⟩, ⟨924484284, 924484300⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-462242150), (-462242142)⟩, ⟨(-924484300), (-924484284)⟩, ⟨(-462242150), (-462242142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-231121075), (-231121071)⟩, ⟨(-462242150), (-462242142)⟩, ⟨(-231121075), (-231121071)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4069954712, 4069954717⟩, ⟨(-438025366), (-438025357)⟩, ⟨(-195441633), (-195441627)⟩, ⟨22725445, 22725447⟩, ⟨4647107, 4647108⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3931530299, 3931530309⟩, ⟨(-559049077), (-559049060)⟩, ⟨(-171746506), (-171746492)⟩, ⟨28138658, 28138671⟩, ⟨3625408, 3625422⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 297619759⟩, ⟨148809879, 148809880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 935000049⟩, ⟨467500022, 467500026⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 203546391⟩, ⟨0, 203546392⟩, ⟨50886597, 50886599⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4488), 0⟩, ⟨(-4488), 3⟩, ⟨(-1122), (-1117)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108568, 5113057⟩, ⟨(-4488), 3⟩, ⟨(-1122), (-1117)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 242318⟩, ⟨(-213), 242319⟩, ⟨60259, 60581⟩, ⟨(-108), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142923258)⟩, ⟨(-213), 242319⟩, ⟨60259, 60581⟩, ⟨(-108), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6784880), 0⟩, ⟨(-6784891), 11484⟩, ⟨(-1696231), (-1678992)⟩, ⟨(-9), 5744⟩, ⟨706, 719⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424870885, 1431655766⟩, ⟨(-6784891), 11484⟩, ⟨(-1696231), (-1678992)⟩, ⟨(-9), 5744⟩, ⟨706, 719⟩⟩
...
def j72 : Jet := ⟨⟨0, 561⟩, ⟨(-1), 561⟩, ⟨138, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851615)⟩, ⟨(-1), 561⟩, ⟨138, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-40387), 0⟩, ⟨(-40388), 27⟩, ⟨(-10098), (-10055)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35751007, 35791395⟩, ⟨(-40388), 27⟩, ⟨(-10098), (-10055)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1696220⟩, ⟨(-1915), 1696222⟩, ⟨421182, 424058⟩, ⟨(-959), 2⟩, ⟨(-122), (-117)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714131662)⟩, ⟨(-1915), 1696222⟩, ⟨421182, 424058⟩, ⟨(-959), 2⟩, ⟨(-122), (-117)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-33924399), 0⟩, ⟨(-33924490), 80388⟩, ⟨(-8481191), (-8360517)⟩, ⟨(-69), 40195⟩, ⟨4938, 5026⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4261042897, 4294967296⟩, ⟨(-33924490), 80388⟩, ⟨(-8481191), (-8360517)⟩, ⟨(-69), 40195⟩, ⟨4938, 5026⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 311666684⟩, ⟨153617768, 155835844⟩, ⟨(-1107789), 1251⟩, ⟨(-184634), (-181504)⟩, ⟨(-1), 783⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4329161785⟩, ⟨(-81675), 34466823⟩, ⟨8359871, 8891186⟩, ⟨(-41171), 139462⟩, ⟨10557, 13833⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 314148027⟩, ⟨153611841, 159577640⟩, ⟨(-1119573), 1897028⟩, ⟨101024, 151242⟩, ⟨(-5272), 6862⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-297619759), 0⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3997347537, 4294967296⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22977820⟩, ⟨0, 23344068⟩, ⟨5330231, 6206548⟩, ⟨(-83196), 163094⟩, ⟨5959, 13082⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317945116⟩, ⟨0, 23344068⟩, ⟨5330231, 6206548⟩, ⟨(-83196), 163094⟩, ⟨5959, 13082⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306440881⟩, ⟨0, 11672034⟩, ⟨2642196, 3103274⟩, ⟨(-50032), 81547⟩, ⟨1631, 5865⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3997347537, 4306440881⟩, ⟨(-149207412), (-137137845)⟩, ⟨2054698, 3103274⟩, ⟨(-157553), (-9998)⟩, ⟨(-1309), 7599⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2818024059⟩, ⟨1409012024, 1409012035⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1848968584⟩, ⟨0, 1848968592⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1848968584⟩, ⟨0, 1848968592⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1848968584), 0⟩, ⟨(-1848968592), 0⟩, ⟨(-462242150), (-462242142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-924484292), 0⟩, ⟨(-924484296), 0⟩, ⟨(-231121075), (-231121071)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3463209179, 4294967296⟩, ⟨(-924484296), 0⟩, ⟨(-231121075), (-86865622)⟩, ⟨0, 49748413⟩, ⟨(-339856), 6218552⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3223226098, 4306440881⟩, ⟨(-1076161378), (-110579897)⟩, ⟨(-230081706), (-45626356)⟩, ⟨1948081, 57902411⟩, ⟨(-2237330), 6235122⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297797868, 4297797870⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2502
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306440881⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2503
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (67138687 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(13859 / 200000), prawitzNormalCorrection
