...
namespace FiniteNormalPanel56_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (33163 / 160000)
def radius : Rat := (33163 / 800000)

def j0 : Jet := ⟨⟨890212502, 890212503⟩, ⟨178042500, 178042501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2796685056, 2796685060⟩, ⟨559337010, 559337014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1821072609, 1821072615⟩, ⟨728429042, 728429050⟩, ⟨72842904, 72842906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨455, 457⟩, ⟨182, 183⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94232), (-94229)⟩, ⟨182, 183⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-39955), (-39953)⟩, ⟨(-15905), (-15903)⟩, ⟨(-1562), (-1557)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5073101, 5073104⟩, ⟨(-15905), (-15903)⟩, ⟨(-1562), (-1557)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2151002, 2151004⟩, ⟨853656, 853660⟩, ⟨82679, 82684⟩, ⟨(-533), (-529)⟩, ⟨(-26), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-141014575), (-141014572)⟩, ⟨853656, 853660⟩, ⟨82679, 82684⟩, ⟨(-533), (-529)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-59790393), (-59790391)⟩, ⟨(-23554207), (-23554202)⟩, ⟨(-2211780), (-2211774)⟩, ⟨28274, 28279⟩, ⟨1299, 1305⟩⟩
...
def j19 : Jet := ⟨⟨1371865372, 1371865375⟩, ⟨(-23554207), (-23554202)⟩, ⟨(-2211780), (-2211774)⟩, ⟨28274, 28279⟩, ⟨1299, 1305⟩⟩
...
def j25 : Jet := ⟨⟨4998, 5000⟩, ⟨1990, 1993⟩, ⟨194, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847179), (-847176)⟩, ⟨1990, 1993⟩, ⟨194, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-359206), (-359203)⟩, ⟨(-142840), (-142835)⟩, ⟨(-13950), (-13945)⟩, ⟨64, 68⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35432188, 35432192⟩, ⟨(-142840), (-142835)⟩, ⟨(-13950), (-13945)⟩, ⟨64, 68⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15023301, 15023303⟩, ⟨5948755, 5948760⟩, ⟨570791, 570797⟩, ⟨(-4762), (-4758)⟩, ⟨(-227), (-222)⟩⟩
...
def j33 : Jet := ⟨⟨(-700804582), (-700804579)⟩, ⟨5948755, 5948760⟩, ⟨570791, 570797⟩, ⟨(-4762), (-4758)⟩, ⟨(-227), (-222)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-297142201), (-297142198)⟩, ⟨(-116334600), (-116334594)⟩, ⟨(-10634761), (-10634754)⟩, ⟨195677, 195683⟩, ⟨8775, 8781⟩⟩
...
def j36 : Jet := ⟨⟨3997825095, 3997825098⟩, ⟨(-116334600), (-116334594)⟩, ⟨(-10634761), (-10634754)⟩, ⟨195677, 195683⟩, ⟨8775, 8781⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨893295599, 893295603⟩, ⟨163321703, 163321710⟩, ⟨(-4507694), (-4507687)⟩, ⟨(-269632), (-269627)⟩, ⟨4527, 4533⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4614194873, 4614194878⟩, ⟨134270627, 134270637⟩, ⟨16181583, 16181595⟩, ⟨602199, 602211⟩, ⟨43860, 43872⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨959690653, 959690660⟩, ⟨203387234, 203387246⟩, ⟨3628633, 3628646⟩, ⟨309980, 309992⟩, ⟨11470, 11483⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-890212503), (-890212502)⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3404754793, 3404754794⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨214438454, 214438458⟩, ⟨90891880, 90891888⟩, ⟨11252959, 11252969⟩, ⟨482192, 482202⟩, ⟨37547, 37558⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4509405750, 4509405754⟩, ⟨90891880, 90891888⟩, ⟨11252959, 11252969⟩, ⟨482192, 482202⟩, ⟨37547, 37558⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4400880618, 4400880621⟩, ⟨44352220, 44352225⟩, ⟨5267578, 5267585⟩, ⟨182205, 182213⟩, ⟨13332, 13340⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3488715593, 3488715597⟩, ⟨(-147273616), (-147273609)⟩, ⟨2337206, 2337215⟩, ⟨(-73923), (-73914)⟩, ⟨3014, 3023⟩⟩
...
def j47 : Jet := ⟨⟨6088708314, 6088708323⟩, ⟨1217741660, 1217741668⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8631583520, 8631583546⟩, ⟨3452633400, 3452633430⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8631583520, 8631583546⟩, ⟨3452633400, 3452633430⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8631583546), (-8631583520)⟩, ⟨(-3452633430), (-3452633400)⟩, ⟨(-345263344), (-345263339)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4315791773), (-4315791760)⟩, ⟨(-1726316715), (-1726316700)⟩, ⟨(-172631672), (-172631669)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1572387807, 1572387828⟩, ⟨(-632004671), (-632004656)⟩, ⟨63813327, 63813335⟩, ⟨8385473, 8385476⟩, ⟨(-2125069), (-2125067)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1277219005, 1277219025⟩, ⟨(-567281572), (-567281553)⟩, ⟨74361252, 74361266⟩, ⟨4252217, 4252230⟩, ⟨(-1966984), (-1966974)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨712170002, 1068255004⟩, ⟨178042500, 178042501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2237348046, 3356022073⟩, ⟨559337010, 559337014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1165486471, 2622344568⟩, ⟨582743234, 874114860⟩, ⟨72842904, 72842906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨291, 657⟩, ⟨145, 219⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94396), (-94029)⟩, ⟨145, 219⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-57635), (-25515)⟩, ⟨(-19173), (-12623)⟩, ⟨(-1578), (-1537)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5055421, 5087542⟩, ⟨(-19173), (-12623)⟩, ⟨(-1578), (-1537)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1371843, 3106261⟩, ⟨674214, 1031996⟩, ⟨80873, 84157⟩, ⟨(-647), (-417)⟩, ⟨(-27), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141793734), (-140059315)⟩, ⟨674214, 1031996⟩, ⟨80873, 84157⟩, ⟨(-647), (-417)⟩, ⟨(-27), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-86573891), (-38006630)⟩, ⟨(-28675009), (-18373217)⟩, ⟨(-2291409), (-2113997)⟩, ⟨22010, 34518⟩, ⟨1222, 1366⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1345081874, 1393649136⟩, ⟨(-28675009), (-18373217)⟩, ⟨(-2291409), (-2113997)⟩, ⟨22010, 34518⟩, ⟨1222, 1366⟩⟩
...
def j70 : Jet := ⟨⟨(-66), (-29)⟩, ⟨(-22), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11769, 11807⟩, ⟨(-22), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3193, 7209⟩, ⟨1582, 2400⟩, ⟨192, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848984), (-844967)⟩, ⟨1582, 2400⟩, ⟨192, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-518358), (-229291)⟩, ⟨(-172357), (-113179)⟩, ⟨(-14133), (-13718)⟩, ⟨50, 82⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35273036, 35562104⟩, ⟨(-172357), (-113179)⟩, ⟨(-14133), (-13718)⟩, ⟨50, 82⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9571725, 21712876⟩, ⟨4680627, 7206914⟩, ⟨554523, 584058⟩, ⟨(-5788), (-3729)⟩, ⟨(-234), (-212)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706256158), (-694115006)⟩, ⟨4680627, 7206914⟩, ⟨554523, 584058⟩, ⟨(-5788), (-3729)⟩, ⟨(-234), (-212)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-431213295), (-188355717)⟩, ⟨(-142467627), (-89777588)⟩, ⟨(-11192604), (-9948871)⟩, ⟨151086, 240087⟩, ⟨8083, 9344⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3863754001, 4106611579⟩, ⟨(-142467627), (-89777588)⟩, ⟨(-11192604), (-9948871)⟩, ⟨151086, 240087⟩, ⟨8083, 9344⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨700684334, 1088976223⟩, ⟨152764867, 171925004⟩, ⟨(-5524843), (-3493988)⟩, ⟨(-286948), (-248335)⟩, ⟨3502, 5564⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4491962222, 4774306043⟩, ⟨98202014, 176042278⟩, ⟨13029303, 20321493⟩, ⟨243628, 1083625⟩, ⟨15735, 85590⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨732822240, 1210511142⟩, ⟨175792402, 235747649⟩, ⟨(-522950), 8545080⟩, ⟨(-42251), 748595⟩, ⟨(-23009), 54987⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1068255004), (-712170002)⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3226712292, 3582797294⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨125036676, 341175410⟩, ⟨59988620, 132888164⟩, ⟨6900376, 17756780⟩, ⟨(-81228), 1360044⟩, ⟨(-18651), 130177⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4420003972, 4636142706⟩, ⟨59988620, 132888164⟩, ⟨6900376, 17756780⟩, ⟨(-81228), 1360044⟩, ⟨(-18651), 130177⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4357037124, 4462295520⟩, ⟨28869576, 65497528⟩, ⟨2840125, 8656266⟩, ⟨(-170162), 651517⟩, ⟨(-27587), 65794⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3273343957, 3722379989⟩, ⟨(-163289822), (-125978471)⟩, ⟨(-581397), 6024176⟩, ⟨(-500782), 425753⟩, ⟨(-50021), 61939⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4870966654, 7306449991⟩, ⟨1217741660, 1217741668⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5524213459, 12429480318⟩, ⟨2762106720, 4143160116⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5524213459, 12429480318⟩, ⟨2762106720, 4143160116⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12429480318), (-5524213459)⟩, ⟨(-4143160116), (-2762106720)⟩, ⟨(-345263344), (-345263339)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6214740159), (-2762106729)⟩, ⟨(-2071580058), (-1381053360)⟩, ⟨(-172631672), (-172631669)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1010516904, 2257687038⟩, ⟨(-1088944135), (-324933269)⟩, ⟨(-38503949), 221997095⟩, ⟨(-26984856), 35369809⟩, ⟨(-8726426), 4027697⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨770150078, 1956701524⟩, ⟨(-1029605319), (-277283071)⟩, ⟨(-24145551), 236968451⟩, ⟨(-33618035), 32489539⟩, ⟨(-9096023), 4987580⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨890212502, 890212503⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4400880618, 4400880621⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1106
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨712170002, 1068255004⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4357037124, 4462295520⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1107
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (54014387 / 2147483648)

theorem envelope_integral : (∫ s in ((33163 / 200000) : ℝ)..(99489 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((33163 / 200000) : ℝ)..(99489 / 400000), prawitzNormalCorrection
