...
namespace FiniteNormalPanel128_11
...
def j2 : Jet := ⟨⟨2531799862, 2531799866⟩, ⟨506359971, 506359975⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1492446880, 1492446885⟩, ⟨596978750, 596978758⟩, ⟨59697874, 59697876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨373, 374⟩, ⟨149, 150⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94314), (-94312)⟩, ⟨149, 150⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-32773), (-32772)⟩, ⟨(-13059), (-13055)⟩, ⟨(-1287), (-1283)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5080283, 5080285⟩, ⟨(-13059), (-13055)⟩, ⟨(-1287), (-1283)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1765334, 1765335⟩, ⟨701595, 701598⟩, ⟨68349, 68355⟩, ⟨(-360), (-356)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-141400243), (-141400241)⟩, ⟨701595, 701598⟩, ⟨68349, 68355⟩, ⟨(-360), (-356)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-49134799), (-49134797)⟩, ⟨(-19410125), (-19410121)⟩, ⟨(-1844124), (-1844119)⟩, ⟨19125, 19130⟩, ⟨892, 897⟩⟩
...
def j19 : Jet := ⟨⟨1382520966, 1382520969⟩, ⟨(-19410125), (-19410121)⟩, ⟨(-1844124), (-1844119)⟩, ⟨19125, 19130⟩, ⟨892, 897⟩⟩
...
def j22 : Jet := ⟨⟨(-38), (-37)⟩, ⟨(-16), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11797, 11799⟩, ⟨(-16), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4099, 4101⟩, ⟨1633, 1637⟩, ⟨159, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848078), (-848075)⟩, ⟨1633, 1637⟩, ⟨159, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-294697), (-294695)⟩, ⟨(-117312), (-117309)⟩, ⟨(-11507), (-11502)⟩, ⟨43, 46⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35496697, 35496700⟩, ⟨(-117312), (-117309)⟩, ⟨(-11507), (-11502)⟩, ⟨43, 46⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12334653, 12334655⟩, ⟨4893096, 4893099⟩, ⟨473081, 473086⟩, ⟨(-3217), (-3212)⟩, ⟨(-155), (-150)⟩⟩
...
def j33 : Jet := ⟨⟨(-703493230), (-703493227)⟩, ⟨4893096, 4893099⟩, ⟨473081, 473086⟩, ⟨(-3217), (-3212)⟩, ⟨(-155), (-150)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-244455012), (-244455009)⟩, ⟨(-96081717), (-96081712)⟩, ⟨(-8933697), (-8933691)⟩, ⟨132648, 132653⟩, ⟨6073, 6078⟩⟩
...
def j36 : Jet := ⟨⟨4050512284, 4050512287⟩, ⟨(-96081717), (-96081712)⟩, ⟨(-8933697), (-8933691)⟩, ⟨132648, 132653⟩, ⟨6073, 6078⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨814969276, 814969280⟩, ⟨151551962, 151551968⟩, ⟨(-3375455), (-3375449)⟩, ⟨(-206143), (-206137)⟩, ⟨2779, 2785⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4554175562, 4554175567⟩, ⟨108029046, 108029055⟩, ⟨12607098, 12607108⟩, ⟨388168, 388177⟩, ⟨26640, 26650⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨864153998, 864154004⟩, ⟨181196861, 181196871⟩, ⟨2624930, 2624942⟩, ⟨215020, 215034⟩, ⟨6601, 6617⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-805896927), (-805896926)⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3489070369, 3489070370⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨173869107, 173869111⟩, ⟨72914170, 72914178⟩, ⟨8700644, 8700653⟩, ⟨308006, 308016⟩, ⟨22402, 22413⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4468836403, 4468836407⟩, ⟨72914170, 72914178⟩, ⟨8700644, 8700653⟩, ⟨308006, 308016⟩, ⟨22402, 22413⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4381039397, 4381039400⟩, ⟨35740830, 35740835⟩, ⟨4119065, 4119070⟩, ⟨117372, 117379⟩, ⟨8086, 8094⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3558992116, 3558992120⟩, ⟨(-135374947), (-135374940)⟩, ⟨2004908, 2004916⟩, ⟨(-59231), (-59223)⟩, ⟨2163, 2172⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨33332867797, 33332867803⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value541

def j47 : Jet := ⟨⟨6254495981, 6254495991⟩, ⟨1250899194, 1250899203⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9108036751, 9108036781⟩, ⟨3643214692, 3643214728⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9108036751, 9108036781⟩, ⟨3643214692, 3643214728⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9108036781), (-9108036751)⟩, ⟨(-3643214728), (-3643214692)⟩, ⟨(-364321475), (-364321468)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4554018391), (-4554018375)⟩, ⟨(-1821607364), (-1821607346)⟩, ⟨(-182160738), (-182160734)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1487547669, 1487547690⟩, ⟨(-630907674), (-630907658)⟩, ⟨70701406, 70701414⟩, ⟨7843520, 7843523⟩, ⟨(-2330977), (-2330975)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1232645107, 1232645127⟩, ⟨(-569683531), (-569683512)⟩, ⟨79166429, 79166444⟩, ⟨3955977, 3955987⟩, ⟨(-2136320), (-2136309)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨644717540, 967076312⟩, ⟨161179385, 161179386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2025439887, 3038159838⟩, ⟨506359971, 506359975⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨955166000, 2149123513⟩, ⟨477582998, 716374508⟩, ⟨59697874, 59697876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨239, 539⟩, ⟨119, 180⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94448), (-94147)⟩, ⟨119, 180⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-47261), (-20937)⟩, ⟨(-15728), (-10377)⟩, ⟨(-1297), (-1269)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5065795, 5092120⟩, ⟨(-15728), (-10377)⟩, ⟨(-1297), (-1269)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1126591, 2548005⟩, ⟨555424, 847028⟩, ⟨67138, 69343⟩, ⟨(-436), (-281)⟩, ⟨(-19), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142038986), (-140617571)⟩, ⟨555424, 847028⟩, ⟨67138, 69343⟩, ⟨(-436), (-281)⟩, ⟨(-19), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-71073726), (-31272210)⟩, ⟨(-23567721), (-15212267)⟩, ⟨(-1897581), (-1778535)⟩, ⟨14966, 23278⟩, ⟨850, 930⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1360582039, 1400383556⟩, ⟨(-23567721), (-15212267)⟩, ⟨(-1897581), (-1778535)⟩, ⟨14966, 23278⟩, ⟨850, 930⟩⟩
...
def j70 : Jet := ⟨⟨(-55), (-23)⟩, ⟨(-19), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11780, 11813⟩, ⟨(-19), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2619, 5912⟩, ⟨1299, 1969⟩, ⟨157, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849558), (-846264)⟩, ⟨1299, 1969⟩, ⟨157, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-425104), (-188202)⟩, ⟨(-141414), (-93115)⟩, ⟨(-11631), (-11350)⟩, ⟨33, 56⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35366290, 35603193⟩, ⟨(-141414), (-93115)⟩, ⟨(-11631), (-11350)⟩, ⟨33, 56⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7865176, 17815191⟩, ⟨3861827, 5917689⟩, ⟨462166, 481989⟩, ⟨(-3899), (-2527)⟩, ⟨(-159), (-145)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707962707), (-698012691)⟩, ⟨3861827, 5917689⟩, ⟨462166, 481989⟩, ⟨(-3899), (-2527)⟩, ⟨(-159), (-145)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-354251662), (-155232378)⟩, ⟨(-117225049), (-74655085)⟩, ⟨(-9308125), (-8473809)⟩, ⟨103116, 162085⟩, ⟨5692, 6388⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3940715634, 4139734918⟩, ⟨(-117225049), (-74655085)⟩, ⟨(-9308125), (-8473809)⟩, ⟨103116, 162085⟩, ⟨5692, 6388⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨641629363, 990598714⟩, ⟨143736083, 157925919⟩, ⟨(-4120848), (-2632196)⟩, ⟨(-216661), (-193215)⟩, ⟨2164, 3403⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4456020600, 4681064504⟩, ⟨80358912, 139248317⟩, ⟨10570402, 15199100⟩, ⟨171833, 664442⟩, ⟨12057, 47130⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨665689273, 1079648845⟩, ⟨161130815, 204239185⟩, ⟨(-222867), 5894809⟩, ⟨9678, 462412⟩, ⟨(-11812), 28919⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-967076312), (-644717540)⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3327890984, 3650249756⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨103177085, 271397091⟩, ⟨49948252, 102681388⟩, ⟨5932966, 12675835⟩, ⟨(-18198), 793112⟩, ⟨(-5520), 66611⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4398144381, 4566364387⟩, ⟨49948252, 102681388⟩, ⟨5932966, 12675835⟩, ⟨(-18198), 793112⟩, ⟨(-5520), 66611⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4346249679, 4428587326⟩, ⟨24220602, 50734914⟩, ⟨2586362, 6195648⟩, ⟨(-81316), 377465⟩, ⟨(-11551), 33093⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3367626369, 3763812084⟩, ⟨(-147426842), (-119984787)⟩, ⟨100048, 4356682⟩, ⟨(-301618), 223745⟩, ⟨(-23984), 31178⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5003596778, 7505395186⟩, ⟨1250899194, 1250899203⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5829143504, 13115572953⟩, ⟨2914571750, 4371857670⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5829143504, 13115572953⟩, ⟨2914571750, 4371857670⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13115572953), (-5829143504)⟩, ⟨(-4371857670), (-2914571750)⟩, ⟨(-364321475), (-364321468)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6557786477), (-2914571752)⟩, ⟨(-2185928835), (-1457285875)⟩, ⟨(-182160738), (-182160734)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨932944366, 2178948291⟩, ⟨(-1108978386), (-316548777)⟩, ⟨(-38712239), 242639353⟩, ⟨(-32213428), 37923987⟩, ⟨(-9970849), 4919710⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨731509189, 1909479478⟩, ⟨(-1046625367), (-274264518)⟩, ⟨(-25059846), 252908817⟩, ⟨(-37836266), 34668914⟩, ⟨(-10148731), 5756860⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4381039397, 4381039400⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar541 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2580
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar541 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4346249679, 4428587326⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2581
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((15011 / 100000) : ℝ)..(45033 / 200000), prawitzNormalCorrection
      ((215249 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
