...
namespace FiniteNormalPanel112_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (28341 / 160000)
def radius : Rat := (28341 / 800000)

def j0 : Jet := ⟨⟨760772925, 760772926⟩, ⟨152154585, 152154586⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2390038632, 2390038636⟩, ⟨478007726, 478007730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1329994914, 1329994920⟩, ⟨531997964, 531997972⟩, ⟨53199796, 53199798⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨332, 334⟩, ⟨133, 134⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94355), (-94352)⟩, ⟨133, 134⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-29219), (-29217)⟩, ⟨(-11647), (-11644)⟩, ⟨(-1149), (-1146)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5083837, 5083840⟩, ⟨(-11647), (-11644)⟩, ⟨(-1149), (-1146)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1574279, 1574281⟩, ⟨626104, 626108⟩, ⟨61172, 61176⟩, ⟨(-288), (-283)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-141591298), (-141591295)⟩, ⟨626104, 626108⟩, ⟨61172, 61176⟩, ⟨(-288), (-283)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-43845668), (-43845666)⟩, ⟨(-17344387), (-17344383)⟩, ⟨(-1657333), (-1657328)⟩, ⟨15242, 15247⟩, ⟨716, 720⟩⟩
...
def j19 : Jet := ⟨⟨1387810097, 1387810100⟩, ⟨(-17344387), (-17344383)⟩, ⟨(-1657333), (-1657328)⟩, ⟨15242, 15247⟩, ⟨716, 720⟩⟩
...
def j25 : Jet := ⟨⟨3654, 3655⟩, ⟨1456, 1458⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848523), (-848521)⟩, ⟨1456, 1458⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-262757), (-262756)⟩, ⟨(-104653), (-104650)⟩, ⟨(-10287), (-10283)⟩, ⟨34, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35528637, 35528639⟩, ⟨(-104653), (-104650)⟩, ⟨(-10287), (-10283)⟩, ⟨34, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11001924, 11001926⟩, ⟨4368361, 4368365⟩, ⟨423927, 423932⟩, ⟨(-2562), (-2557)⟩, ⟨(-125), (-121)⟩⟩
...
def j33 : Jet := ⟨⟨(-704825959), (-704825956)⟩, ⟨4368361, 4368365⟩, ⟨423927, 423932⟩, ⟨(-2562), (-2557)⟩, ⟨(-125), (-121)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-218258926), (-218258923)⟩, ⟨(-85950849), (-85950844)⟩, ⟨(-8057996), (-8057989)⟩, ⟨105823, 105829⟩, ⟨4893, 4899⟩⟩
...
def j36 : Jet := ⟨⟨4076708370, 4076708373⟩, ⟨(-85950849), (-85950844)⟩, ⟨(-8057996), (-8057989)⟩, ⟨105823, 105829⟩, ⟨4893, 4899⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨772280559, 772280563⟩, ⟨144804406, 144804412⟩, ⟨(-2852605), (-2852600)⟩, ⟨(-175972), (-175967)⟩, ⟨2094, 2098⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4524911371, 4524911375⟩, ⟨95400483, 95400490⟩, ⟨10955267, 10955279⟩, ⟨302076, 302087⟩, ⟨20106, 20119⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨813626936, 813626942⟩, ⟨169710964, 169710973⟩, ⟨2180962, 2180973⟩, ⟨174914, 174927⟩, ⟨4819, 4830⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-760772926), (-760772925)⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3534194370, 3534194371⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨154131276, 154131279⟩, ⟨64299166, 64299172⟩, ⟨7532254, 7532261⟩, ⟨238626, 238634⟩, ⟨16753, 16764⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4449098572, 4449098575⟩, ⟨64299166, 64299172⟩, ⟨7532254, 7532261⟩, ⟨238626, 238634⟩, ⟨16753, 16764⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4371353664, 4371353667⟩, ⟨31587791, 31587795⟩, ⟨3586188, 3586193⟩, ⟨91312, 91319⟩, ⟨6098, 6106⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3597050325, 3597050329⟩, ⟨(-128868063), (-128868057)⟩, ⟨1831924, 1831931⟩, ⟨(-51909), (-51901)⟩, ⟨1781, 1791⟩⟩
...
def j47 : Jet := ⟨⟨7874005984, 7874005997⟩, ⟨1574801196, 1574801208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14435492976, 14435493025⟩, ⟨5774197186, 5774197242⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14435492976, 14435493025⟩, ⟨5774197186, 5774197242⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14435493025), (-14435492976)⟩, ⟨(-5774197242), (-5774197186)⟩, ⟨(-577419728), (-577419718)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7217746513), (-7217746488)⟩, ⟨(-2887098621), (-2887098593)⟩, ⟨(-288709864), (-288709859)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨800059937, 800059953⟩, ⟨(-537804325), (-537804308)⟩, ⟨126976945, 126976956⟩, ⟨(-4350533), (-4350528)⟩, ⟨(-3536616), (-3536614)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨670053031, 670053046⟩, ⟨(-474418375), (-474418357)⟩, ⟨122821402, 122821416⟩, ⟨(-7692519), (-7692509)⟩, ⟨(-2770406), (-2770396)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨608618340, 912927512⟩, ⟨152154585, 152154586⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1912030905, 2868046366⟩, ⟨478007726, 478007730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨851196744, 1915192688⟩, ⟨425598372, 638397566⟩, ⟨53199796, 53199798⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨213, 480⟩, ⟨106, 160⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94474), (-94206)⟩, ⟨106, 160⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-42128), (-18670)⟩, ⟨(-14022), (-9263)⟩, ⟨(-1159), (-1135)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5070928, 5094387⟩, ⟨(-14022), (-9263)⟩, ⟨(-1159), (-1135)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1004980, 2271667⟩, ⟨496237, 755388⟩, ⟨60209, 61961⟩, ⟨(-347), (-223)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142160597), (-140893909)⟩, ⟨496237, 755388⟩, ⟨60209, 61961⟩, ⟨(-347), (-223)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-63391621), (-27923015)⟩, ⟨(-21032195), (-13624667)⟩, ⟨(-1699774), (-1605278)⟩, ⟨11957, 18523⟩, ⟨686, 744⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1368264144, 1403732751⟩, ⟨(-21032195), (-13624667)⟩, ⟨(-1699774), (-1605278)⟩, ⟨11957, 18523⟩, ⟨686, 744⟩⟩
...
def j70 : Jet := ⟨⟨(-49), (-21)⟩, ⟨(-17), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11786, 11815⟩, ⟨(-17), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2335, 5269⟩, ⟨1159, 1756⟩, ⟨141, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849842), (-846907)⟩, ⟨1159, 1756⟩, ⟨141, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-378958), (-167843)⟩, ⟨(-126091), (-83137)⟩, ⟨(-10386), (-10162)⟩, ⟨26, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35412436, 35623552⟩, ⟨(-126091), (-83137)⟩, ⟨(-10386), (-10162)⟩, ⟨26, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7018202, 15885096⟩, ⟨3452875, 5278556⟩, ⟨415263, 431002⟩, ⟨(-3101), (-2015)⟩, ⟨(-128), (-117)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708809681), (-699942786)⟩, ⟨3452875, 5278556⟩, ⟨415263, 431002⟩, ⟨(-3101), (-2015)⟩, ⟨(-128), (-117)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-316069257), (-138717941)⟩, ⟨(-104672114), (-67005179)⟩, ⟨(-8355251), (-7693083)⟩, ⟨82535, 129049⟩, ⟨4624, 5117⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3978898039, 4156249355⟩, ⟨(-104672114), (-67005179)⟩, ⟨(-8355251), (-7693083)⟩, ⟨82535, 129049⟩, ⟨4624, 5117⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨609122991, 937369330⟩, ⟨138236097, 150162803⟩, ⟨(-3475832), (-2230991)⟩, ⟨(-183854), (-166289)⟩, ⟨1635, 2559⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4438315052, 4636143951⟩, ⟨71552514, 121962158⟩, ⟨9368713, 12943832⟩, ⟨139527, 504556⟩, ⟨10094, 33814⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨629452927, 1011830557⟩, ⟨152997586, 188709228⟩, ⟨(-120286), 4783622⟩, ⟨24164, 353662⟩, ⟨(-8087), 20148⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-912927512), (-608618340)⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3382039784, 3686348956⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨92250059, 238372264⟩, ⟨44845406, 88914188⟩, ⟨5393484, 10545275⟩, ⟨(-3490), 586996⟩, ⟨(-2226), 45900⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4387217355, 4533339560⟩, ⟨44845406, 88914188⟩, ⟨5393484, 10545275⟩, ⟨(-3490), 586996⟩, ⟨(-2226), 45900⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4340847274, 4412544068⟩, ⟨21825227, 43987211⟩, ⟨2405637, 5162043⟩, ⟨(-54036), 278302⟩, ⟨(-6992), 22590⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3418167628, 3787264512⟩, ⟨(-139133780), (-116025936)⟩, ⟨335998, 3657371⟩, ⟨(-229251), 153644⟩, ⟨(-15862), 21304⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6299204787, 9448807205⟩, ⟨1574801196, 1574801208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9238715504, 20787109993⟩, ⟨4619357750, 6929036696⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9238715504, 20787109993⟩, ⟨4619357750, 6929036696⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20787109993), (-9238715504)⟩, ⟨(-6929036696), (-4619357750)⟩, ⟨(-577419728), (-577419718)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10393554997), (-4619357752)⟩, ⟨(-3464518348), (-2309678875)⟩, ⟨(-288709864), (-288709859)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨381939076, 1465088876⟩, ⟨(-1181808136), (-205393092)⟩, ⟨(-43257505), 450976289⟩, ⟨(-112054995), 64592324⟩, ⟨(-28183213), 24051076⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨303967805, 1291902528⟩, ⟨(-1089569035), (-173780800)⟩, ⟨(-32565641), 437198744⟩, ⟨(-114502882), 58394599⟩, ⟨(-27028678), 25292383⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨760772925, 760772926⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4371353664, 4371353667⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2250
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨608618340, 912927512⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4340847274, 4412544068⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2251
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (25367037 / 2147483648)

theorem envelope_integral : (∫ s in ((28341 / 200000) : ℝ)..(85023 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((28341 / 200000) : ℝ)..(85023 / 400000), prawitzNormalCorrection
