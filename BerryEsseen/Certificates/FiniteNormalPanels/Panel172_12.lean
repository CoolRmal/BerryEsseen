...
namespace FiniteNormalPanel172_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (184191 / 800000)
def radius : Rat := (26313 / 800000)

def j0 : Jet := ⟨⟨988867901, 988867902⟩, ⟨141266843, 141266844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3106620133, 3106620137⟩, ⟨443802876, 443802880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2247069182, 2247069189⟩, ⟨642019766, 642019774⟩, ⟨45858554, 45858556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨562, 563⟩, ⟨160, 161⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94125), (-94123)⟩, ⟨160, 161⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-49245), (-49243)⟩, ⟨(-13987), (-13984)⟩, ⟨(-977), (-972)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5063811, 5063814⟩, ⟨(-13987), (-13984)⟩, ⟨(-977), (-972)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2649317, 2649320⟩, ⟨749629, 749633⟩, ⟨51464, 51470⟩, ⟨(-296), (-291)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140516260), (-140516256)⟩, ⟨749629, 749633⟩, ⟨51464, 51470⟩, ⟨(-296), (-291)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-73516220), (-73516217)⟩, ⟨(-20612440), (-20612435)⟩, ⟨(-1361352), (-1361344)⟩, ⟨15540, 15547⟩, ⟨498, 503⟩⟩
...
def j19 : Jet := ⟨⟨1358139545, 1358139549⟩, ⟨(-20612440), (-20612435)⟩, ⟨(-1361352), (-1361344)⟩, ⟨15540, 15547⟩, ⟨498, 503⟩⟩
...
def j25 : Jet := ⟨⟨6162, 6164⟩, ⟨1751, 1755⟩, ⟨120, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846015), (-846012)⟩, ⟨1751, 1755⟩, ⟨120, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-442624), (-442622)⟩, ⟨(-125548), (-125544)⟩, ⟨(-8711), (-8705)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35348770, 35348773⟩, ⟨(-125548), (-125544)⟩, ⟨(-8711), (-8705)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18494001, 18494004⟩, ⟨5218314, 5218319⟩, ⟨354102, 354109⟩, ⟨(-2627), (-2621)⟩, ⟨(-91), (-84)⟩⟩
...
def j33 : Jet := ⟨⟨(-697333882), (-697333878)⟩, ⟨5218314, 5218319⟩, ⟨354102, 354109⟩, ⟨(-2627), (-2621)⟩, ⟨(-91), (-84)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-364835719), (-364835715)⟩, ⟨(-101508627), (-101508620)⟩, ⟨(-6480324), (-6480315)⟩, ⟨107273, 107280⟩, ⟨3339, 3347⟩⟩
...
def j36 : Jet := ⟨⟨3930131577, 3930131581⟩, ⟨(-101508627), (-101508620)⟩, ⟨(-6480324), (-6480315)⟩, ⟨107273, 107280⟩, ⟨3339, 3347⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨982364559, 982364564⟩, ⟨125428478, 125428485⟩, ⟨(-3114592), (-3114583)⟩, ⟨(-129430), (-129422)⟩, ⟨1965, 1971⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4693670858, 4693670864⟩, ⟨121229541, 121229552⟩, ⟨10870451, 10870465⟩, ⟨352535, 352548⟩, ⟨19720, 19737⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1073557860, 1073557868⟩, ⟨164800228, 164800241⟩, ⟨2622956, 2622971⟩, ⟨168730, 168746⟩, ⟨5415, 5430⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-988867902), (-988867901)⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3306099394, 3306099395⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨268343481, 268343486⟩, ⟨82385996, 82386004⟩, ⟨7634726, 7634738⟩, ⟨285638, 285650⟩, ⟨17255, 17268⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4563310777, 4563310782⟩, ⟨82385996, 82386004⟩, ⟨7634726, 7634738⟩, ⟨285638, 285650⟩, ⟨17255, 17268⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4427106340, 4427106343⟩, ⟨39963480, 39963485⟩, ⟨3523047, 3523055⟩, ⟨106752, 106761⟩, ⟨6003, 6012⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3407814909, 3407814914⟩, ⟨(-114850725), (-114850718)⟩, ⟨1397456, 1397464⟩, ⟨(-33705), (-33696)⟩, ⟨1108, 1117⟩⟩
...
def j47 : Jet := ⟨⟨9846966048, 9846966060⟩, ⟨1406709435, 1406709446⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨22575897246, 22575897302⟩, ⟨6450256354, 6450256414⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨22575897246, 22575897302⟩, ⟨6450256354, 6450256414⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-22575897302), (-22575897246)⟩, ⟨(-6450256414), (-6450256354)⟩, ⟨(-460732604), (-460732596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11287948651), (-11287948623)⟩, ⟨(-3225128207), (-3225128177)⟩, ⟨(-230366302), (-230366298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨310138465, 310138475⟩, ⟨(-232885672), (-232885662)⟩, ⟨70803240, 70803246⟩, ⟨(-9394836), (-9394832)⟩, ⟨(-135149), (-135147)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨246077423, 246077432⟩, ⟨(-193075021), (-193075010)⟩, ⟨62506837, 62506846⟩, ⟨(-9425817), (-9425809)⟩, ⟨168935, 168942⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨847601058, 1130134745⟩, ⟨141266843, 141266844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2662817256, 3550423013⟩, ⟨443802876, 443802880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1650907969, 2934947511⟩, ⟨550302656, 733736884⟩, ⟨45858554, 45858556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨413, 736⟩, ⟨137, 184⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94274), (-93950)⟩, ⟨137, 184⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-64422), (-36112)⟩, ⟨(-16054), (-11911)⟩, ⟨(-986), (-962)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5048634, 5076945⟩, ⟨(-16054), (-11911)⟩, ⟨(-986), (-962)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1940603, 3469309⟩, ⟨635896, 862750⟩, ⟨50488, 52313⟩, ⟨(-341), (-246)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141224974), (-139696267)⟩, ⟨635896, 862750⟩, ⟨50488, 52313⟩, ⟨(-341), (-246)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-96505482), (-53696725)⟩, ⟨(-23881945), (-17309351)⟩, ⟨(-1407018), (-1308437)⟩, ⟨13023, 18055⟩, ⟨472, 525⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1335150283, 1377959041⟩, ⟨(-23881945), (-17309351)⟩, ⟨(-1407018), (-1308437)⟩, ⟨13023, 18055⟩, ⟨472, 525⟩⟩
...
def j72 : Jet := ⟨⟨4520, 8061⟩, ⟨1493, 2012⟩, ⟨119, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847657), (-844115)⟩, ⟨1493, 2012⟩, ⟨119, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-579243), (-324462)⟩, ⟨(-144238), (-106779)⟩, ⟨(-8815), (-8582)⟩, ⟨28, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35212151, 35466933⟩, ⟨(-144238), (-106779)⟩, ⟨(-8815), (-8582)⟩, ⟨28, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13534915, 24236177⟩, ⟨4413073, 6018002⟩, ⟨345303, 361712⟩, ⟨(-3037), (-2208)⟩, ⟨(-93), (-81)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702292968), (-691591705)⟩, ⟨4413073, 6018002⟩, ⟨345303, 361712⟩, ⟨(-3037), (-2208)⟩, ⟨(-93), (-81)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-479908893), (-265835378)⟩, ⟨(-118280920), (-84499416)⟩, ⟨(-6800414), (-6109046)⟩, ⟨89285, 125202⟩, ⟨3103, 3550⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3815058403, 4029131918⟩, ⟨(-118280920), (-84499416)⟩, ⟨(-6800414), (-6109046)⟩, ⟨89285, 125202⟩, ⟨3103, 3550⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨827773756, 1139086087⟩, ⟨118220347, 131654217⟩, ⟨(-3630852), (-2599801)⟩, ⟨(-137315), (-120275)⟩, ⟨1637, 2300⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4578342047, 4835245526⟩, ⟨96017512, 149910495⟩, ⟨8955457, 13266698⟩, ⟨183145, 571389⟩, ⟨8499, 35394⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨882388882, 1282375517⟩, ⟨144525887, 187973825⟩, ⟨281318, 5342412⟩, ⟨478, 371877⟩, ⟨(-7585), 21384⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1130134745), (-847601058)⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3164832551, 3447366238⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨181284299, 382886959⟩, ⟨59384868, 112249066⟩, ⟨4978894, 11417111⟩, ⟨19128, 689702⟩, ⟨(-4480), 51968⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4476251595, 4677854255⟩, ⟨59384868, 112249066⟩, ⟨4978894, 11417111⟩, ⟨19128, 689702⟩, ⟨(-4480), 51968⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4384672645, 4482324290⟩, ⟨28451317, 54976290⟩, ⟨2048244, 5499458⟩, ⟨(-59586), 324506⟩, ⟨(-9713), 25722⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3230933731, 3597748798⟩, ⟨(-126464329), (-100090507)⟩, ⟨(-298950), 3478355⟩, ⟨(-228712), 193097⟩, ⟨(-18471), 22606⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8440256612, 11253675496⟩, ⟨1406709435, 1406709446⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨16586373484, 29486886266⟩, ⟨5528791160, 7371721614⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨16586373484, 29486886266⟩, ⟨5528791160, 7371721614⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-29486886266), (-16586373484)⟩, ⟨(-7371721614), (-5528791160)⟩, ⟨(-460732604), (-460732596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-14743443133), (-8293186742)⟩, ⟨(-3685860807), (-2764395580)⟩, ⟨(-230366302), (-230366298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨138722266, 622840967⟩, ⟨(-534510499), (-89286644)⟩, ⟨(-4672858), 221912916⟩, ⟨(-60287837), 20449510⟩, ⟨(-10338645), 13059792⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨104355264, 521732807⟩, ⟨(-466080772), (-70399606)⟩, ⟨(-1876901), 202131902⟩, ⟨(-57501309), 17332663⟩, ⟨(-9304624), 12926372⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨988867901, 988867902⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4427106340, 4427106343⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3482
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨847601058, 1130134745⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4384672645, 4482324290⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3483
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (8864137 / 2147483648)

theorem envelope_integral : (∫ s in ((78939 / 400000) : ℝ)..(26313 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((78939 / 400000) : ℝ)..(26313 / 100000), prawitzNormalCorrection
