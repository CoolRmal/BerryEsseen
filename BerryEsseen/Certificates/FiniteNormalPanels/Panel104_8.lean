...
namespace FiniteNormalPanel104_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2857 / 16000)
def radius : Rat := (2857 / 80000)

def j0 : Jet := ⟨⟨766920097, 766920098⟩, ⟨153384019, 153384020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2409350542, 2409350546⟩, ⟨481870107, 481870111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1351574909, 1351574914⟩, ⟨540629962, 540629968⟩, ⟨54062996, 54062997⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨338, 339⟩, ⟨135, 136⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94349), (-94347)⟩, ⟨135, 136⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-29691), (-29689)⟩, ⟨(-11835), (-11832)⟩, ⟨(-1168), (-1164)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5083365, 5083368⟩, ⟨(-11835), (-11832)⟩, ⟨(-1168), (-1164)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1599674, 1599676⟩, ⟨636144, 636148⟩, ⟨62128, 62133⟩, ⟨(-297), (-292)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-141565903), (-141565900)⟩, ⟨636144, 636148⟩, ⟨62128, 62133⟩, ⟨(-297), (-292)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-44549099), (-44549097)⟩, ⟨(-17619454), (-17619450)⟩, ⟨(-1682340), (-1682334)⟩, ⟨15733, 15739⟩, ⟨739, 744⟩⟩
...
def j19 : Jet := ⟨⟨1387106666, 1387106669⟩, ⟨(-17619454), (-17619450)⟩, ⟨(-1682340), (-1682334)⟩, ⟨15733, 15739⟩, ⟨739, 744⟩⟩
...
def j25 : Jet := ⟨⟨3713, 3715⟩, ⟨1480, 1482⟩, ⟨145, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848464), (-848461)⟩, ⟨1480, 1482⟩, ⟨145, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-267002), (-267000)⟩, ⟨(-106336), (-106333)⟩, ⟨(-10450), (-10446)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35524392, 35524395⟩, ⟨(-106336), (-106333)⟩, ⟨(-10450), (-10446)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11179101, 11179103⟩, ⟨4438177, 4438181⟩, ⟨430489, 430494⟩, ⟨(-2644), (-2640)⟩, ⟨(-129), (-125)⟩⟩
...
def j33 : Jet := ⟨⟨(-704648782), (-704648779)⟩, ⟨4438177, 4438181⟩, ⟨430489, 430494⟩, ⟨(-2644), (-2640)⟩, ⟨(-129), (-125)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-221744557), (-221744554)⟩, ⟨(-87301182), (-87301178)⟩, ⟨(-8175658), (-8175652)⟩, ⟨109219, 109225⟩, ⟨5044, 5048⟩⟩
...
def j36 : Jet := ⟨⟨4073222739, 4073222742⟩, ⟨(-87301182), (-87301178)⟩, ⟨(-8175658), (-8175652)⟩, ⟨109219, 109225⟩, ⟨5044, 5048⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨778126110, 778126114⟩, ⟨145741224, 145741230⟩, ⟨(-2920544), (-2920537)⟩, ⟨(-179924), (-179917)⟩, ⟨2179, 2184⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4528783531, 4528783535⟩, ⟨97065188, 97065195⟩, ⟨11170432, 11170442⟩, ⟨312798, 312809⟩, ⟨20908, 20917⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨820486972, 820486978⟩, ⟨171260770, 171260781⟩, ⟨2237942, 2237954⟩, ⟨179993, 180006⟩, ⟨5035, 5047⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-766920098), (-766920097)⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3528047198, 3528047199⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨156741326, 156741329⟩, ⟨65433434, 65433440⟩, ⟨7684029, 7684037⟩, ⟨247242, 247252⟩, ⟨17442, 17453⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4451708622, 4451708625⟩, ⟨65433434, 65433440⟩, ⟨7684029, 7684037⟩, ⟨247242, 247252⟩, ⟨17442, 17453⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4372635697, 4372635699⟩, ⟨32135590, 32135594⟩, ⟨3655684, 3655690⟩, ⟨94558, 94564⟩, ⟨6342, 6350⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3591846935, 3591846938⟩, ⟨(-129760375), (-129760368)⟩, ⟨1855272, 1855279⟩, ⟨(-52881), (-52874)⟩, ⟨1831, 1841⟩⟩
...
def j47 : Jet := ⟨⟨7281905768, 7281905780⟩, ⟨1456381149, 1456381160⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12346113010, 12346113052⟩, ⟨4938445188, 4938445236⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12346113010, 12346113052⟩, ⟨4938445188, 4938445236⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12346113052), (-12346113010)⟩, ⟨(-4938445236), (-4938445188)⟩, ⟨(-493844525), (-493844517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6173056526), (-6173056505)⟩, ⟨(-2469222618), (-2469222594)⟩, ⟨(-246922263), (-246922258)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1020371942, 1020371959⟩, ⟨(-586622749), (-586622733)⟩, ⟨109965563, 109965573⟩, ⟨1410250, 1410254⟩, ⟨(-3363712), (-3363710)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨853328926, 853328942⟩, ⟨(-521415607), (-521415588)⟩, ⟨110127245, 110127258⟩, ⟨(-2408886), (-2408876)⟩, ⟨(-2800497), (-2800486)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨613536078, 920304118⟩, ⟨153384019, 153384020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1927480435, 2891220657⟩, ⟨481870107, 481870111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨865007943, 1946267879⟩, ⟨432503970, 648755962⟩, ⟨54062996, 54062997⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨216, 488⟩, ⟨108, 163⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94471), (-94198)⟩, ⟨108, 163⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-42810), (-18971)⟩, ⟨(-14249), (-9411)⟩, ⟨(-1178), (-1153)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5070246, 5094086⟩, ⟨(-14249), (-9411)⟩, ⟨(-1178), (-1153)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1021149, 2308390⟩, ⟨504117, 767569⟩, ⟨61134, 62943⟩, ⟨(-358), (-231)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142144428), (-140857186)⟩, ⟨504117, 767569⟩, ⟨61134, 62943⟩, ⟨(-358), (-231)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-64412862), (-28368687)⟩, ⟨(-21369425), (-13836518)⟩, ⟨(-1726171), (-1628577)⟩, ⟨12338, 19124⟩, ⟨707, 768⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1367242903, 1403287079⟩, ⟨(-21369425), (-13836518)⟩, ⟨(-1726171), (-1628577)⟩, ⟨12338, 19124⟩, ⟨707, 768⟩⟩
...
def j72 : Jet := ⟨⟨2373, 5354⟩, ⟨1178, 1783⟩, ⟨144, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849804), (-846822)⟩, ⟨1178, 1783⟩, ⟨144, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-385090), (-170550)⟩, ⟨(-128127), (-84467)⟩, ⟨(-10550), (-10321)⟩, ⟨27, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35406304, 35620845⟩, ⟨(-128127), (-84467)⟩, ⟨(-10550), (-10321)⟩, ⟨27, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7130842, 16141615⟩, ⟨3507360, 5363528⟩, ⟨421542, 437796⟩, ⟨(-3202), (-2081)⟩, ⟨(-132), (-121)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708697041), (-699686267)⟩, ⟨3507360, 5363528⟩, ⟨421542, 437796⟩, ⟨(-3202), (-2081)⟩, ⟨(-132), (-121)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-321146634), (-140917063)⟩, ⟨(-106342496), (-68028043)⟩, ⟨(-8482651), (-7798765)⟩, ⟨85146, 133225⟩, ⟨4762, 5278⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3973820662, 4154050233⟩, ⟨(-106342496), (-68028043)⟩, ⟨(-8482651), (-7798765)⟩, ⟨85146, 133225⟩, ⟨4762, 5278⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨613586498, 944643419⟩, ⟨139011480, 151231067⟩, ⟨(-3559523), (-2283243)⟩, ⟨(-188130), (-169842)⟩, ⟨1701, 2663⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4440664661, 4642067583⟩, ⟨72721731, 124225298⟩, ⟨9527765, 13233479⟩, ⟨143679, 524167⟩, ⟨10355, 35399⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨634401076, 1020985328⟩, ⟨154116292, 190775247⟩, ⟨(-132314), 4924026⟩, ⟨22614, 366993⟩, ⟨(-8523), 21182⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-920304118), (-613536078)⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3374663178, 3681431218⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨93706121, 242705234⟩, ⟨45528420, 90700914⟩, ⟨5467246, 10814965⟩, ⟨(-5076), 611916⟩, ⟨(-2584), 48322⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4388673417, 4537672530⟩, ⟨45528420, 90700914⟩, ⟨5467246, 10814965⟩, ⟨(-5076), 611916⟩, ⟨(-2584), 48322⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4341567550, 4414652322⟩, ⟨22147052, 44863688⟩, ⟨2431549, 5292954⟩, ⟨(-57207), 290271⟩, ⟨(-7506), 23813⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3411278162, 3784019239⟩, ⟨(-140256780), (-116593319)⟩, ⟨308333, 3745930⟩, ⟨(-238060), 161970⟩, ⟨(-16801), 22456⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5825524618, 8738286940⟩, ⟨1456381149, 1456381160⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7901512336, 17778402811⟩, ⟨3950756152, 5926134284⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7901512336, 17778402811⟩, ⟨3950756152, 5926134284⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17778402811), (-7901512336)⟩, ⟨(-5926134284), (-3950756152)⟩, ⟨(-493844525), (-493844517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8889201406), (-3950756168)⟩, ⟨(-2963067142), (-1975378076)⟩, ⟨(-246922263), (-246922258)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨542138077, 1711870859⟩, ⟨(-1181007432), (-249344779)⟩, ⟨(-41076896), 376216183⟩, ⟨(-76959551), 54711140⟩, ⟨(-20250742), 14454239⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨430593216, 1508219230⟩, ⟨(-1096412619), (-212759262)⟩, ⟨(-29382454), 371519971⟩, ⟨(-81214775), 49590533⟩, ⟨(-19715339), 15650433⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨766920097, 766920098⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4372635697, 4372635699⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2092
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨613536078, 920304118⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4341567550, 4414652322⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2093
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (63794533 / 4294967296)

theorem envelope_integral : (∫ s in ((2857 / 20000) : ℝ)..(8571 / 40000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((2857 / 20000) : ℝ)..(8571 / 40000), prawitzNormalCorrection
