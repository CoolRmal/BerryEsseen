...
namespace FiniteNormalPanel148_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (26807 / 800000)
def radius : Rat := (26807 / 800000)

def j0 : Jet := ⟨⟨143918985, 143918986⟩, ⟨143918985, 143918986⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨452134825, 452134830⟩, ⟨452134825, 452134830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨47596613, 47596615⟩, ⟨95193226, 95193230⟩, ⟨47596613, 47596615⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1050), (-1049)⟩, ⟨(-2099), (-2097)⟩, ⟨(-1050), (-1047)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112006, 5112008⟩, ⟨(-2099), (-2097)⟩, ⟨(-1050), (-1047)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨56650, 56652⟩, ⟨113277, 113280⟩, ⟨56591, 56595⟩, ⟨(-48), (-45)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-143108927), (-143108924)⟩, ⟨113277, 113280⟩, ⟨56591, 56595⟩, ⟨(-48), (-45)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1585927), (-1585925)⟩, ⟨(-3170598), (-3170595)⟩, ⟨(-1582790), (-1582786)⟩, ⟨2508, 2511⟩, ⟨624, 628⟩⟩
...
def j19 : Jet := ⟨⟨1430069838, 1430069841⟩, ⟨(-3170598), (-3170595)⟩, ⟨(-1582790), (-1582786)⟩, ⟨2508, 2511⟩, ⟨624, 628⟩⟩
...
def j25 : Jet := ⟨⟨131, 132⟩, ⟨261, 263⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852046), (-852044)⟩, ⟨261, 263⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9443), (-9442)⟩, ⟨(-18883), (-18881)⟩, ⟨(-9437), (-9434)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781951, 35781953⟩, ⟨(-18883), (-18881)⟩, ⟨(-9437), (-9434)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨396533, 396534⟩, ⟨792857, 792859⟩, ⟨396009, 396012⟩, ⟨(-420), (-417)⟩, ⟨(-106), (-102)⟩⟩
...
def j33 : Jet := ⟨⟨(-715431350), (-715431348)⟩, ⟨792857, 792859⟩, ⟨396009, 396012⟩, ⟨(-420), (-417)⟩, ⟨(-106), (-102)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7928375), (-7928374)⟩, ⟨(-15847964), (-15847961)⟩, ⟨(-7906415), (-7906412)⟩, ⟨17558, 17561⟩, ⟨4376, 4379⟩⟩
...
def j36 : Jet := ⟨⟨4287038921, 4287038922⟩, ⟨(-15847964), (-15847961)⟩, ⟨(-7906415), (-7906412)⟩, ⟨17558, 17561⟩, ⟨4376, 4379⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨150544656, 150544659⟩, ⟨150210884, 150210888⟩, ⟨(-500394), (-500392)⟩, ⟨(-166358), (-166356)⟩, ⟨329, 332⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302910332, 4302910334⟩, ⟨15906632, 15906637⟩, ⟨7994483, 7994489⟩, ⟨41261, 41268⟩, ⟨10433, 10441⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨150823070, 150823074⟩, ⟨151046230, 151046237⟩, ⟨335210, 335216⟩, ⟨112522, 112528⟩, ⟨588, 596⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-143918986), (-143918985)⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4151048310, 4151048311⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5296337, 5296339⟩, ⟨10608348, 10608350⟩, ⟨5335564, 5335568⟩, ⟨31478, 31482⟩, ⟨7980, 7985⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300263633, 4300263635⟩, ⟨10608348, 10608350⟩, ⟨5335564, 5335568⟩, ⟨31478, 31482⟩, ⟨7980, 7985⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297614648, 4297614650⟩, ⟨5300906, 5300908⟩, ⟨2662869, 2662872⟩, ⟨12444, 12448⟩, ⟨3146, 3151⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4153606952, 4153606956⟩, ⟨(-138884417), (-138884412)⟩, ⟨2396012, 2396017⟩, ⟨(-77203), (-77198)⟩, ⟨2622, 2630⟩⟩
...
def j47 : Jet := ⟨⟨1366405716, 1366405727⟩, ⟨1366405716, 1366405727⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨434709848, 434709856⟩, ⟨869419696, 869419712⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨434709848, 434709856⟩, ⟨869419696, 869419712⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-434709856), (-434709848)⟩, ⟨(-869419712), (-869419696)⟩, ⟨(-434709856), (-434709848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-217354928), (-217354924)⟩, ⟨(-434709856), (-434709848)⟩, ⟨(-217354928), (-217354924)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4083020581, 4083020586⟩, ⟨(-413257930), (-413257921)⟩, ⟨(-185715269), (-185715262)⟩, ⟨20208111, 20208114⟩, ⟨4187900, 4187902⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3948636043, 3948636053⟩, ⟨(-531687156), (-531687141)⟩, ⟨(-163961711), (-163961696)⟩, ⟨25244454, 25244465⟩, ⟨3302916, 3302932⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 287837971⟩, ⟨143918985, 143918986⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 904269656⟩, ⟨452134825, 452134830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 190386459⟩, ⟨0, 190386460⟩, ⟨47596613, 47596615⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 48⟩, ⟨0, 48⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94638)⟩, ⟨0, 48⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4198), 0⟩, ⟨(-4198), 3⟩, ⟨(-1050), (-1044)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108858, 5113057⟩, ⟨(-4198), 3⟩, ⟨(-1050), (-1044)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 226651⟩, ⟨(-187), 226652⟩, ⟨56382, 56664⟩, ⟨(-94), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142938925)⟩, ⟨(-187), 226652⟩, ⟨56382, 56664⟩, ⟨(-94), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6346216), 0⟩, ⟨(-6346225), 10047⟩, ⟨(-1586563), (-1571483)⟩, ⟨(-8), 5025⟩, ⟨618, 629⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425309549, 1431655766⟩, ⟨(-6346225), 10047⟩, ⟨(-1586563), (-1571483)⟩, ⟨(-8), 5025⟩, ⟨618, 629⟩⟩
...
def j72 : Jet := ⟨⟨0, 525⟩, ⟨(-1), 525⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851651)⟩, ⟨(-1), 525⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-37776), 0⟩, ⟨(-37777), 24⟩, ⟨(-9445), (-9407)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35753618, 35791395⟩, ⟨(-37777), 24⟩, ⟨(-9445), (-9407)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1586554⟩, ⟨(-1675), 1586556⟩, ⟨394125, 396641⟩, ⟨(-839), 2⟩, ⟨(-107), (-102)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714241328)⟩, ⟨(-1675), 1586556⟩, ⟨394125, 396641⟩, ⟨(-839), 2⟩, ⟨(-107), (-102)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-31731077), 0⟩, ⟨(-31731152), 70329⟩, ⟨(-7932845), (-7827274)⟩, ⟨(-57), 35167⟩, ⟨4324, 4397⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4263236219, 4294967296⟩, ⟨(-31731152), 70329⟩, ⟨(-7932845), (-7827274)⟩, ⟨(-57), 35167⟩, ⟨4324, 4397⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 301423219⟩, ⟨148707391, 150713727⟩, ⟨(-1002111), 1058⟩, ⟨(-167021), (-164373)⟩, ⟨(-1), 662⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4326934546⟩, ⟨(-71381), 32205258⟩, ⟨7826746, 8291076⟩, ⟨(-35963), 121697⟩, ⟨9303, 11980⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 303666699⟩, ⟨148702381, 154095667⟩, ⟨(-1012075), 1713047⟩, ⟨92686, 135126⟩, ⟨(-4452), 5785⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-287837971), 0⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4007129325, 4294967296⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 21470121⟩, ⟨0, 21790026⟩, ⟨5005329, 5770911⟩, ⟨(-72624), 142032⟩, ⟨5384, 11202⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4316437417⟩, ⟨0, 21790026⟩, ⟨5005329, 5770911⟩, ⟨(-72624), 142032⟩, ⟨5384, 11202⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305688975⟩, ⟨0, 10895013⟩, ⟨2482647, 2885456⟩, ⟨(-43632), 71016⟩, ⟨1537, 4995⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4007129325, 4305688975⟩, ⟨(-144278257), (-133023972)⟩, ⟨1951187, 2885456⟩, ⟨(-140321), (-12174)⟩, ⟨(-947), 6458⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2732811444⟩, ⟨1366405716, 1366405727⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1738839408⟩, ⟨0, 1738839414⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1738839408⟩, ⟨0, 1738839414⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1738839408), 0⟩, ⟨(-1738839414), 0⟩, ⟨(-434709856), (-434709848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-869419704), 0⟩, ⟨(-869419707), 0⟩, ⟨(-217354928), (-217354924)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3507895872, 4294967296⟩, ⟨(-869419707), 0⟩, ⟨(-217354928), (-89526438)⟩, ⟨0, 43998626⟩, ⟨38693, 5499829⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3272805460, 4305688975⟩, ⟨(-1015868328), (-108646750)⟩, ⟨(-216303896), (-51435248)⟩, ⟨2048400, 51399993⟩, ⟨(-1588892), 5507751⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨143918985, 143918986⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297614648, 4297614650⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2982
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 287837971⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305688975⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2983
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (261038773 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(26807 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(26807 / 400000), prawitzNormalCorrection
