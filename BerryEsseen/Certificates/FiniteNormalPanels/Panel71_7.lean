...
namespace FiniteNormalPanel71_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3321 / 16000)
def radius : Rat := (3321 / 80000)

def j0 : Jet := ⟨⟨891474149, 891474150⟩, ⟨178294829, 178294830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2800648637, 2800648641⟩, ⟨560129724, 560129729⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1826238070, 1826238076⟩, ⟨730495222, 730495232⟩, ⟨73049521, 73049524⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨457, 458⟩, ⟨182, 184⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94230), (-94228)⟩, ⟨182, 184⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-40067), (-40066)⟩, ⟨(-15950), (-15947)⟩, ⟨(-1566), (-1561)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5072989, 5072991⟩, ⟨(-15950), (-15947)⟩, ⟨(-1566), (-1561)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2157056, 2157058⟩, ⟨856039, 856043⟩, ⟨82903, 82908⟩, ⟨(-537), (-532)⟩, ⟨(-26), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-141008521), (-141008518)⟩, ⟨856039, 856043⟩, ⟨82903, 82908⟩, ⟨(-537), (-532)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-59957414), (-59957412)⟩, ⟨(-23618975), (-23618970)⟩, ⟨(-2217451), (-2217445)⟩, ⟨28430, 28436⟩, ⟨1306, 1312⟩⟩
...
def j19 : Jet := ⟨⟨1371698351, 1371698354⟩, ⟨(-23618975), (-23618970)⟩, ⟨(-2217451), (-2217445)⟩, ⟨28430, 28436⟩, ⟨1306, 1312⟩⟩
...
def j25 : Jet := ⟨⟨5012, 5014⟩, ⟨1996, 1999⟩, ⟨195, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847165), (-847162)⟩, ⟨1996, 1999⟩, ⟨195, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-360219), (-360216)⟩, ⟨(-143240), (-143236)⟩, ⟨(-13988), (-13983)⟩, ⟨65, 68⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35431175, 35431179⟩, ⟨(-143240), (-143236)⟩, ⟨(-13988), (-13983)⟩, ⟨65, 68⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15065483, 15065486⟩, ⟨5965286, 5965291⟩, ⟨572308, 572314⟩, ⟨(-4790), (-4785)⟩, ⟨(-227), (-223)⟩⟩
...
def j33 : Jet := ⟨⟨(-700762400), (-700762396)⟩, ⟨5965286, 5965291⟩, ⟨572308, 572314⟩, ⟨(-4790), (-4785)⟩, ⟨(-227), (-223)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-297967107), (-297967103)⟩, ⟨(-116650379), (-116650373)⟩, ⟨(-10660753), (-10660745)⟩, ⟨196760, 196766⟩, ⟨8821, 8828⟩⟩
...
def j36 : Jet := ⟨⟨3997000189, 3997000193⟩, ⟨(-116650379), (-116650373)⟩, ⟨(-10660753), (-10660745)⟩, ⟨196760, 196766⟩, ⟨8821, 8828⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨894452705, 894452709⟩, ⟨163489152, 163489160⟩, ⟨(-4526227), (-4526220)⟩, ⟨(-270652), (-270645)⟩, ⟨4558, 4565⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4615147156, 4615147161⟩, ⟨134690670, 134690679⟩, ⟨16240334, 16240347⟩, ⟨606012, 606024⟩, ⟨44175, 44189⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨961132081, 961132087⟩, ⟨203727029, 203727042⟩, ⟨3645537, 3645551⟩, ⟨311624, 311641⟩, ⟨11561, 11577⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-891474150), (-891474149)⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3403493146, 3403493147⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨215083099, 215083102⟩, ⟨91180476, 91180484⟩, ⟨11295168, 11295180⟩, ⟨485314, 485326⟩, ⟨37830, 37843⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4510050395, 4510050398⟩, ⟨91180476, 91180484⟩, ⟨11295168, 11295180⟩, ⟨485314, 485326⟩, ⟨37830, 37843⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4401195172, 4401195175⟩, ⟨44489865, 44489870⟩, ⟨5286408, 5286415⟩, ⟨183361, 183369⟩, ⟨13429, 13438⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3487672098, 3487672102⟩, ⟨(-147449178), (-147449171)⟩, ⟨2342261, 2342269⟩, ⟨(-74151), (-74143)⟩, ⟨3028, 3038⟩⟩
...
def j47 : Jet := ⟨⟨5873196918, 5873196927⟩, ⟨1174639378, 1174639386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8031363142, 8031363167⟩, ⟨3212545240, 3212545270⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8031363142, 8031363167⟩, ⟨3212545240, 3212545270⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8031363167), (-8031363142)⟩, ⟨(-3212545270), (-3212545240)⟩, ⟨(-321254527), (-321254522)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4015681584), (-4015681571)⟩, ⟨(-1606272635), (-1606272620)⟩, ⟨(-160627264), (-160627261)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1686187748, 1686187762⟩, ⟨(-630616504), (-630616492)⟩, ⟨54860318, 54860325⟩, ⟨8883867, 8883870⟩, ⟨(-1856479), (-1856477)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1369246738, 1369246752⟩, ⟨(-569971882), (-569971867)⟩, ⟨67117662, 67117675⟩, ⟨4957615, 4957625⟩, ⟨(-1770528), (-1770516)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨713179319, 1069768980⟩, ⟨178294829, 178294830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2240518909, 3360778369⟩, ⟨560129724, 560129729⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1168792364, 2629782829⟩, ⟨584396178, 876594278⟩, ⟨73049521, 73049524⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨292, 659⟩, ⟨146, 220⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94395), (-94027)⟩, ⟨146, 220⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-57798), (-25587)⟩, ⟨(-19227), (-12658)⟩, ⟨(-1583), (-1542)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5055258, 5087470⟩, ⟨(-19227), (-12658)⟩, ⟨(-1583), (-1542)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1375690, 3115028⟩, ⟨676072, 1034899⟩, ⟨81085, 84388⟩, ⟨(-651), (-419)⟩, ⟨(-27), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141789887), (-140050548)⟩, ⟨676072, 1034899⟩, ⟨81085, 84388⟩, ⟨(-651), (-419)⟩, ⟨(-27), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-86817102), (-38112050)⟩, ⟨(-28755055), (-18422362)⟩, ⟨(-2297533), (-2119111)⟩, ⟨22131, 34712⟩, ⟨1229, 1373⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1344838663, 1393543716⟩, ⟨(-28755055), (-18422362)⟩, ⟨(-2297533), (-2119111)⟩, ⟨22131, 34712⟩, ⟨1229, 1373⟩⟩
...
def j72 : Jet := ⟨⟨3202, 7230⟩, ⟨1586, 2407⟩, ⟨193, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848975), (-844946)⟩, ⟨1586, 2407⟩, ⟨193, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-519823), (-229935)⟩, ⟨(-172844), (-113493)⟩, ⟨(-14173), (-13755)⟩, ⟨50, 82⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35271571, 35561460⟩, ⟨(-172844), (-113493)⟩, ⟨(-14173), (-13755)⟩, ⟨50, 82⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9598476, 21774070⟩, ⟨4693406, 7227140⟩, ⟨555947, 585651⟩, ⟨(-5820), (-3750)⟩, ⟨(-236), (-213)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706229407), (-694053812)⟩, ⟨4693406, 7227140⟩, ⟨555947, 585651⟩, ⟨(-5820), (-3750)⟩, ⟨(-236), (-213)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-432420049), (-188873334)⟩, ⟨(-142862798), (-90011531)⟩, ⟨(-11221770), (-9970947)⟩, ⟨151907, 241432⟩, ⟨8122, 9394⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3862547247, 4106093962⟩, ⟨(-142862798), (-90011531)⟩, ⟨(-11221770), (-9970947)⟩, ⟨151907, 241432⟩, ⟨8122, 9394⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨701550500, 1090437076⟩, ⟨152887017, 172129277⟩, ⟨(-5547904), (-3508017)⟩, ⟨(-288090), (-249202)⟩, ⟨3527, 5602⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4492528481, 4775797653⟩, ⟨98482735, 176640899⟩, ⟨13068220, 20408378⟩, ⟨244811, 1091348⟩, ⟨15786, 86340⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨733820628, 1212513733⟩, ⟨176005970, 236246359⟩, ⟨(-528741), 8591280⟩, ⟨(-43340), 753884⟩, ⟨(-23230), 55502⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1069768980), (-713179319)⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3225198316, 3581787977⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨125377605, 342305180⟩, ⟨60143326, 133389586⟩, ⟨6914111, 17845640⟩, ⟨(-82640), 1370794⟩, ⟨(-18944), 131460⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4420344901, 4637272476⟩, ⟨60143326, 133389586⟩, ⟨6914111, 17845640⟩, ⟨(-82640), 1370794⟩, ⟨(-18944), 131460⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4357205157, 4462839190⟩, ⟨28940502, 65742132⟩, ⟨2842792, 8699257⟩, ⟨(-171986), 656726⟩, ⟨(-27931), 66460⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3271934281, 3721784744⟩, ⟨(-163531467), (-126052827)⟩, ⟨(-594398), 6053354⟩, ⟨(-504556), 429666⟩, ⟨(-50557), 62565⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4698557533, 7047836312⟩, ⟨1174639378, 1174639386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5140072407, 11565162959⟩, ⟨2570036192, 3855054322⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5140072407, 11565162959⟩, ⟨2570036192, 3855054322⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11565162959), (-5140072407)⟩, ⟨(-3855054322), (-2570036192)⟩, ⟨(-321254527), (-321254522)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5782581480), (-2570036203)⟩, ⟨(-1927527161), (-1285018096)⟩, ⟨(-160627264), (-160627261)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1117486281, 2360942159⟩, ⟨(-1059561069), (-334342497)⟩, ⟨(-38280525), 195966012⟩, ⟨(-20979654), 32144253⟩, ⟨(-7270946), 3069677⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨851308384, 2045863893⟩, ⟨(-1008051113), (-287501370)⟩, ⟨(-23685956), 213483934⟩, ⟨(-27411967), 29694821⟩, ⟨(-7712246), 3893881⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨891474149, 891474150⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4401195172, 4401195175⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1416
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨713179319, 1069768980⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4357205157, 4462839190⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1417
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (28900963 / 1073741824)

theorem envelope_integral : (∫ s in ((3321 / 20000) : ℝ)..(9963 / 40000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((3321 / 20000) : ℝ)..(9963 / 40000), prawitzNormalCorrection
