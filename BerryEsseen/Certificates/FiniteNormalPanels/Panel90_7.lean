...
namespace FiniteNormalPanel90_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (31731 / 160000)
def radius : Rat := (31731 / 800000)

def j0 : Jet := ⟨⟨851772545, 851772546⟩, ⟨170354509, 170354510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2675922369, 2675922374⟩, ⟨535184473, 535184478⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1667197915, 1667197923⟩, ⟨666879164, 666879174⟩, ⟨66687916, 66687918⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨417, 418⟩, ⟨166, 168⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94270), (-94268)⟩, ⟨166, 168⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-36594), (-36592)⟩, ⟨(-14574), (-14570)⟩, ⟨(-1433), (-1429)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5076462, 5076465⟩, ⟨(-14574), (-14570)⟩, ⟨(-1433), (-1429)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1970554, 1970556⟩, ⟨782563, 782568⟩, ⟨76002, 76007⟩, ⟨(-449), (-444)⟩, ⟨(-23), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-141195023), (-141195020)⟩, ⟨782563, 782568⟩, ⟨76002, 76007⟩, ⟨(-449), (-444)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-54808345), (-54808343)⟩, ⟨(-21619568), (-21619563)⟩, ⟨(-2041324), (-2041319)⟩, ⟨23775, 23781⟩, ⟨1101, 1106⟩⟩
...
def j19 : Jet := ⟨⟨1376847420, 1376847423⟩, ⟨(-21619568), (-21619563)⟩, ⟨(-2041324), (-2041319)⟩, ⟨23775, 23781⟩, ⟨1101, 1106⟩⟩
...
def j22 : Jet := ⟨⟨(-42), (-41)⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11793, 11795⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4577, 4579⟩, ⟨1824, 1826⟩, ⟨179, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847600), (-847597)⟩, ⟨1824, 1826⟩, ⟨179, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-329017), (-329015)⟩, ⟨(-130899), (-130897)⟩, ⟨(-12809), (-12805)⟩, ⟨54, 58⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35462377, 35462380⟩, ⟨(-130899), (-130897)⟩, ⟨(-12809), (-12805)⟩, ⟨54, 58⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13765599, 13765602⟩, ⟨5455427, 5455431⟩, ⟨525325, 525331⟩, ⟨(-4002), (-3997)⟩, ⟨(-191), (-186)⟩⟩
...
def j33 : Jet := ⟨⟨(-702062284), (-702062280)⟩, ⟨5455427, 5455431⟩, ⟨525325, 525331⟩, ⟨(-4002), (-3997)⟩, ⟨(-191), (-186)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-272522863), (-272522859)⟩, ⟨(-106891487), (-106891482)⟩, ⟨(-9849935), (-9849928)⟩, ⟨164719, 164725⟩, ⟨7459, 7465⟩⟩
...
def j36 : Jet := ⟨⟨4022444433, 4022444437⟩, ⟨(-106891487), (-106891482)⟩, ⟨(-9849935), (-9849928)⟩, ⟨164719, 164725⟩, ⟨7459, 7465⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨857826510, 857826515⟩, ⟨158095516, 158095523⟩, ⟨(-3965778), (-3965772)⟩, ⟨(-239552), (-239546)⟩, ⟨3647, 3654⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4585953731, 4585953736⟩, ⟨121866043, 121866051⟩, ⟨14468254, 14468266⟩, ⟨495091, 495103⟩, ⟨35082, 35094⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨915944735, 915944742⟩, ⟨193146672, 193146684⟩, ⟨3141082, 3141095⟩, ⟨263143, 263157⟩, ⟨8966, 8982⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-851772546), (-851772545)⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3443194750, 3443194751⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨195334376, 195334380⟩, ⟨82380918, 82380926⟩, ⟨10025629, 10025637⟩, ⟨394744, 394756⟩, ⟨29787, 29800⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4490301672, 4490301676⟩, ⟨82380918, 82380926⟩, ⟨10025629, 10025637⟩, ⟨394744, 394756⟩, ⟨29787, 29800⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4391548568, 4391548571⟩, ⟨40284576, 40284581⟩, ⟨4717800, 4717805⟩, ⟨149753, 149761⟩, ⟨10657, 10666⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3520622144, 3520622149⟩, ⟨(-141889897), (-141889890)⟩, ⟨2184333, 2184339⟩, ⟨(-67072), (-67064)⟩, ⟨2602, 2612⟩⟩
...
def j47 : Jet := ⟨⟨6090011859, 6090011868⟩, ⟨1218002371, 1218002380⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8635279825, 8635279852⟩, ⟨3454111926, 3454111960⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8635279825, 8635279852⟩, ⟨3454111926, 3454111960⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8635279852), (-8635279825)⟩, ⟨(-3454111960), (-3454111926)⟩, ⟨(-345411198), (-345411192)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4317639926), (-4317639912)⟩, ⟨(-1727055980), (-1727055963)⟩, ⟨(-172705599), (-172705596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1571711343, 1571711364⟩, ⟨(-632003302), (-632003286)⟩, ⟨63867580, 63867587⟩, ⟨8381756, 8381759⟩, ⟨(-2126696), (-2126694)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1288345492, 1288345512⟩, ⟨(-569982173), (-569982154)⟩, ⟨74031211, 74031223⟩, ⟨4414678, 4414687⟩, ⟨(-1976874), (-1976863)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨681418036, 1022127055⟩, ⟨170354509, 170354510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2140737895, 3211106848⟩, ⟨535184473, 535184478⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1067006666, 2400765007⟩, ⟨533503332, 800255008⟩, ⟨66687916, 66687918⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨267, 602⟩, ⟨133, 201⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94420), (-94084)⟩, ⟨133, 201⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-52779), (-23373)⟩, ⟨(-17560), (-11573)⟩, ⟨(-1448), (-1412)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5060277, 5089684⟩, ⟨(-17560), (-11573)⟩, ⟨(-1448), (-1412)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1257133, 2844990⟩, ⟨618750, 945455⟩, ⟨74488, 77241⟩, ⟨(-543), (-349)⟩, ⟨(-23), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141908444), (-140320586)⟩, ⟨618750, 945455⟩, ⟨74488, 77241⟩, ⟨(-543), (-349)⟩, ⟨(-23), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-79322799), (-34860102)⟩, ⟨(-26287217), (-16901568)⟩, ⟨(-2108049), (-1959419)⟩, ⟨18555, 28987⟩, ⟨1041, 1153⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1352332966, 1396795664⟩, ⟨(-26287217), (-16901568)⟩, ⟨(-2108049), (-1959419)⟩, ⟨18555, 28987⟩, ⟨1041, 1153⟩⟩
...
def j70 : Jet := ⟨⟨(-61), (-26)⟩, ⟨(-21), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11774, 11810⟩, ⟨(-21), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2925, 6602⟩, ⟨1450, 2198⟩, ⟨176, 183⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849252), (-845574)⟩, ⟨1450, 2198⟩, ⟨176, 183⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-474708), (-210067)⟩, ⟨(-157876), (-103804)⟩, ⟨(-12964), (-12616)⟩, ⟨41, 70⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35316686, 35581328⟩, ⟨(-157876), (-103804)⟩, ⟨(-12964), (-12616)⟩, ⟨41, 70⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8773789, 19888955⟩, ⟨4298645, 6603864⟩, ⟨511697, 536443⟩, ⟨(-4858), (-3138)⟩, ⟨(-197), (-179)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707054094), (-695938927)⟩, ⟨4298645, 6603864⟩, ⟨511697, 536443⟩, ⟨(-4858), (-3138)⟩, ⟨(-197), (-179)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-395223202), (-172893394)⟩, ⟨(-130673149), (-82755323)⟩, ⟨(-10317342), (-9275522)⟩, ⟨127589, 201713⟩, ⟨6928, 7897⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3899744094, 4122073902⟩, ⟨(-130673149), (-82755323)⟩, ⟨(-10317342), (-9275522)⟩, ⟨127589, 201713⟩, ⟨6928, 7897⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨674042484, 1044306002⟩, ⟨148857137, 165626764⟩, ⟨(-4851652), (-3082691)⟩, ⟨(-253431), (-222485)⟩, ⟨2830, 4475⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4475112409, 4730244762⟩, ⟨89842972, 158501678⟩, ⟨11873631, 17825650⟩, ⟨209066, 870232⟩, ⟨14094, 65434⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨702314051, 1150142168⟩, ⟨169200449, 220951482⟩, ⟨(-366106), 7234554⟩, ⟨(-13830), 602705⟩, ⟨(-17086), 41224⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1022127055), (-681418036)⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3272840241, 3613549260⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨114842556, 307994664⟩, ⟨55335392, 118336462⟩, ⟨6469582, 15241349⟩, ⟨(-45078), 1067150⟩, ⟨(-11193), 96279⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4409809852, 4602961960⟩, ⟨55335392, 118336462⟩, ⟨6469582, 15241349⟩, ⟨(-45078), 1067150⟩, ⟨(-11193), 96279⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4352009776, 4446298583⟩, ⟨26726016, 58392704⟩, ⟨2741261, 7438727⟩, ⟨(-122053), 509748⟩, ⟨(-18721), 48284⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3316307608, 3740871082⟩, ⟨(-155991186), (-123488617)⟩, ⟨(-227186), 5198482⟩, ⟨(-397737), 320146⟩, ⟨(-35970), 45466⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4872009487, 7308014240⟩, ⟨1218002371, 1218002380⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5526579087, 12434802981⟩, ⟨2763289542, 4144934350⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5526579087, 12434802981⟩, ⟨2763289542, 4144934350⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12434802981), (-5526579087)⟩, ⟨(-4144934350), (-2763289542)⟩, ⟨(-345411198), (-345411192)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6217401491), (-2763289543)⟩, ⟨(-2072467175), (-1381644771)⟩, ⟨(-172705599), (-172705596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1009890940, 2257065369⟩, ⟨(-1089110480), (-324871050)⟩, ⟨(-38505447), 222157465⟩, ⟨(-27023874), 35389656⟩, ⟨(-8735782), 4034159⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨779775205, 1965880061⟩, ⟨(-1030579258), (-279881611)⟩, ⟨(-24316557), 235784656⟩, ⟨(-33133404), 32448369⟩, ⟨(-9040802), 4888849⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨851772545, 851772546⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4391548568, 4391548571⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1818
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨681418036, 1022127055⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4352009776, 4446298583⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1819
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (26059091 / 1073741824)

theorem envelope_integral : (∫ s in ((31731 / 200000) : ℝ)..(95193 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((31731 / 200000) : ℝ)..(95193 / 400000), prawitzNormalCorrection
