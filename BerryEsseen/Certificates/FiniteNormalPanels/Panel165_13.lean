...
namespace FiniteNormalPanel165_13
...
def j2 : Jet := ⟨⟨486036082, 486036086⟩, ⟨486036082, 486036086⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨55001832, 55001834⟩, ⟨110003664, 110003668⟩, ⟨55001832, 55001834⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1213), (-1212)⟩, ⟨(-2425), (-2423)⟩, ⟨(-1213), (-1210)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111843, 5111845⟩, ⟨(-2425), (-2423)⟩, ⟨(-1213), (-1210)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨65462, 65463⟩, ⟨130893, 130895⟩, ⟨65383, 65386⟩, ⟨(-64), (-60)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-143100115), (-143100113)⟩, ⟨130893, 130895⟩, ⟨65383, 65386⟩, ⟨(-64), (-60)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1832557), (-1832556)⟩, ⟨(-3663437), (-3663435)⟩, ⟨(-1828368), (-1828365)⟩, ⟨3349, 3352⟩, ⟨834, 837⟩⟩
...
def j19 : Jet := ⟨⟨1429823208, 1429823210⟩, ⟨(-3663437), (-3663435)⟩, ⟨(-1828368), (-1828365)⟩, ⟨3349, 3352⟩, ⟨834, 837⟩⟩
...
def j25 : Jet := ⟨⟨151, 152⟩, ⟨302, 304⟩, ⟨149, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852026), (-852024)⟩, ⟨302, 304⟩, ⟨149, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10912), (-10911)⟩, ⟨(-21820), (-21818)⟩, ⟨(-10904), (-10901)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780482, 35780484⟩, ⟨(-21820), (-21818)⟩, ⟨(-10904), (-10901)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨458208, 458209⟩, ⟨916137, 916139⟩, ⟨457509, 457512⟩, ⟨(-560), (-557)⟩, ⟨(-141), (-137)⟩⟩
...
def j33 : Jet := ⟨⟨(-715369675), (-715369673)⟩, ⟨916137, 916139⟩, ⟨457509, 457512⟩, ⟨(-560), (-557)⟩, ⟨(-141), (-137)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9161105), (-9161104)⟩, ⟨(-18310477), (-18310475)⟩, ⟨(-9131783), (-9131780)⟩, ⟨23441, 23444⟩, ⟨5841, 5844⟩⟩
...
def j36 : Jet := ⟨⟨4285806191, 4285806192⟩, ⟨(-18310477), (-18310475)⟩, ⟨(-9131783), (-9131780)⟩, ⟨23441, 23444⟩, ⟨5841, 5844⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨161804647, 161804650⟩, ⟨161390077, 161390081⟩, ⟨(-621476), (-621474)⟩, ⟨(-206528), (-206525)⟩, ⟨472, 475⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304147982, 4304147984⟩, ⟨18388837, 18388841⟩, ⟨9249423, 9249429⟩, ⟨55151, 55158⟩, ⟨13971, 13979⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨162150511, 162150515⟩, ⟨162427819, 162427825⟩, ⟨416638, 416643⟩, ⟨140007, 140014⟩, ⟨847, 855⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-154710091), (-154710090)⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4140257205, 4140257206⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6121766, 6121768⟩, ⟨12264472, 12264474⟩, ⟨6174181, 6174184⟩, ⟨42082, 42088⟩, ⟨10690, 10699⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301089062, 4301089064⟩, ⟨12264472, 12264474⟩, ⟨6174181, 6174184⟩, ⟨42082, 42088⟩, ⟨10690, 10699⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298027089, 4298027091⟩, ⟨6127870, 6127872⟩, ⟨3080524, 3080527⟩, ⟨16633, 16638⟩, ⟨4212, 4219⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4143206780, 4143206784⟩, ⟨(-148913173), (-148913168)⟩, ⟨2748825, 2748830⟩, ⟨(-94932), (-94925)⟩, ⟨3460, 3469⟩⟩
...
def j47 : Jet := ⟨⟨1240120633, 1240120642⟩, ⟨1240120633, 1240120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨358070056, 358070063⟩, ⟨716140112, 716140126⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨358070056, 358070063⟩, ⟨716140112, 716140126⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-358070063), (-358070056)⟩, ⟨(-716140126), (-716140112)⟩, ⟨(-358070063), (-358070056)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-179035032), (-179035028)⟩, ⟨(-358070063), (-358070056)⟩, ⟨(-179035032), (-179035028)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4119612474, 4119612478⟩, ⟨(-343450788), (-343450780)⟩, ⟨(-157408704), (-157408698)⟩, ⟨13918831, 13918833⟩, ⟨2990676, 2990677⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3974048032, 3974048041⟩, ⟨(-474148477), (-474148462)⟩, ⟨(-137302181), (-137302167)⟩, ⟨18573749, 18573762⟩, ⟨2312577, 2312593⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 309420182⟩, ⟨154710090, 154710091⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 972072171⟩, ⟨486036082, 486036086⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 220007335⟩, ⟨0, 220007336⟩, ⟨55001832, 55001834⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 56⟩, ⟨0, 56⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94630)⟩, ⟨0, 56⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4851), 0⟩, ⟨(-4851), 3⟩, ⟨(-1213), (-1207)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108205, 5113057⟩, ⟨(-4851), 3⟩, ⟨(-1213), (-1207)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 261914⟩, ⟨(-249), 261915⟩, ⟨65104, 65480⟩, ⟨(-126), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142903662)⟩, ⟨(-249), 261915⟩, ⟨65104, 65480⟩, ⟨(-126), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7333578), 0⟩, ⟨(-7333591), 13417⟩, ⟨(-1833408), (-1813268)⟩, ⟨(-11), 6711⟩, ⟨825, 840⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424322187, 1431655766⟩, ⟨(-7333591), 13417⟩, ⟨(-1833408), (-1813268)⟩, ⟨(-11), 6711⟩, ⟨825, 840⟩⟩
...
def j72 : Jet := ⟨⟨0, 607⟩, ⟨(-1), 607⟩, ⟨149, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851569)⟩, ⟨(-1), 607⟩, ⟨149, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-43653), 0⟩, ⟨(-43654), 32⟩, ⟨(-10915), (-10865)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35747741, 35791395⟩, ⟨(-43654), 32⟩, ⟨(-10915), (-10865)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1833395⟩, ⟨(-2237), 1833397⟩, ⟨454992, 458351⟩, ⟨(-1121), 2⟩, ⟨(-142), (-137)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713994487)⟩, ⟨(-2237), 1833397⟩, ⟨454992, 458351⟩, ⟨(-1121), 2⟩, ⟨(-142), (-137)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-36667890), 0⟩, ⟨(-36668005), 93915⟩, ⟨(-9167088), (-9026099)⟩, ⟨(-87), 46959⟩, ⟨5760, 5871⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4258299406, 4294967296⟩, ⟨(-36668005), 93915⟩, ⟨(-9167088), (-9026099)⟩, ⟨(-87), 46959⟩, ⟨5760, 5871⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 324024058⟩, ⟨159522330, 162015066⟩, ⟨(-1244852), 1519⟩, ⟨(-207479), (-203677)⟩, ⟨(-2), 951⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4331950931⟩, ⟨(-95540), 37302216⟩, ⟨9025283, 9646852⟩, ⟨(-48191), 163462⟩, ⟨12225, 16369⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 326814205⟩, ⟨159515122, 166224348⟩, ⟨(-1259176), 2136435⟩, ⟨111500, 172584⟩, ⟨(-6420), 8371⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-309420182), 0⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3985547114, 4294967296⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 24868065⟩, ⟨0, 25296808⟩, ⟨5732764, 6758369⟩, ⟨(-97466), 191636⟩, ⟨6677, 15697⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4319835361⟩, ⟨0, 25296808⟩, ⟨5732764, 6758369⟩, ⟨(-97466), 191636⟩, ⟨6677, 15697⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307383383⟩, ⟨0, 12648404⟩, ⟨2839548, 3379185⟩, ⟨(-58685), 95818⟩, ⟨1721, 7083⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3985547114, 4307383383⟩, ⟨(-155157334), (-142061686)⟩, ⟨2179367, 3379185⟩, ⟨(-180408), (-6466)⟩, ⟨(-1855), 9197⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2480241284⟩, ⟨1240120633, 1240120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1432280249⟩, ⟨0, 1432280250⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1432280249⟩, ⟨0, 1432280250⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1432280249), 0⟩, ⟨(-1432280250), 0⟩, ⟨(-358070063), (-358070056)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-716140125), 0⟩, ⟨(-716140125), 0⟩, ⟨(-179035032), (-179035028)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3635347025, 4294967296⟩, ⟨(-716140125), 0⟩, ⟨(-179035032), (-91834486)⟩, ⟨0, 29852188⟩, ⟨669669, 3731524⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3373447536, 4307383383⟩, ⟨(-873367710), (-120243878)⟩, ⟨(-177707935), (-55968479)⟩, ⟨2293694, 36400724⟩, ⟨(-599714), 3734993⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298027089, 4298027091⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3342
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307383383⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3343
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (283056975 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(28817 / 400000), prawitzNormalCorrection
