...
namespace FiniteNormalPanel76_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (43771 / 160000)
def radius : Rat := (6253 / 160000)

def j0 : Jet := ⟨⟨1174968834, 1174968835⟩, ⟨167852690, 167852691⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3691273456, 3691273461⟩, ⟨527324777, 527324781⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3172433871, 3172433881⟩, ⟨906409672, 906409682⟩, ⟨64743547, 64743549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨794, 795⟩, ⟨226, 228⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93893), (-93891)⟩, ⟨226, 228⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-69354), (-69351)⟩, ⟨(-19650), (-19645)⟩, ⟨(-1358), (-1353)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5043702, 5043706⟩, ⟨(-19650), (-19645)⟩, ⟨(-1358), (-1353)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3725479, 3725483⟩, ⟨1049907, 1049914⟩, ⟨70879, 70887⟩, ⟨(-580), (-575)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-139440098), (-139440093)⟩, ⟨1049907, 1049914⟩, ⟨70879, 70887⟩, ⟨(-580), (-575)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-102996010), (-102996005)⟩, ⟨(-28651929), (-28651920)⟩, ⟨(-1828034), (-1828025)⟩, ⟨30355, 30363⟩, ⟨930, 936⟩⟩
...
def j19 : Jet := ⟨⟨1328659755, 1328659761⟩, ⟨(-28651929), (-28651920)⟩, ⟨(-1828034), (-1828025)⟩, ⟨30355, 30363⟩, ⟨930, 936⟩⟩
...
def j22 : Jet := ⟨⟨(-80), (-79)⟩, ⟨(-23), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11755, 11757⟩, ⟨(-23), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8682, 8685⟩, ⟨2463, 2466⟩, ⟨170, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843495), (-843491)⟩, ⟨2463, 2466⟩, ⟨170, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-623039), (-623036)⟩, ⟨(-176193), (-176188)⟩, ⟨(-12072), (-12065)⟩, ⟨70, 75⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35168355, 35168359⟩, ⟨(-176193), (-176188)⟩, ⟨(-12072), (-12065)⟩, ⟨70, 75⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25976747, 25976751⟩, ⟨7291783, 7291790⟩, ⟨484036, 484045⟩, ⟨(-5153), (-5145)⟩, ⟨(-168), (-162)⟩⟩
...
def j33 : Jet := ⟨⟨(-689851136), (-689851131)⟩, ⟨7291783, 7291790⟩, ⟨484036, 484045⟩, ⟨(-5153), (-5145)⟩, ⟨(-168), (-162)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-509551521), (-509551515)⟩, ⟨(-140200149), (-140200139)⟩, ⟨(-8502626), (-8502616)⟩, ⟨208261, 208272⟩, ⟨6083, 6093⟩⟩
...
def j36 : Jet := ⟨⟨3785415775, 3785415781⟩, ⟨(-140200149), (-140200139)⟩, ⟨(-8502626), (-8502616)⟩, ⟨208261, 208272⟩, ⟨6083, 6093⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1141905432, 1141905439⟩, ⟨138504686, 138504698⟩, ⟨(-5088898), (-5088887)⟩, ⟨(-198354), (-198344)⟩, ⟨4525, 4533⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4873109095, 4873109104⟩, ⟨180484948, 180484963⟩, ⟨17630345, 17630362⟩, ⟨790251, 790272⟩, ⟨51092, 51112⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1295616325, 1295616336⟩, ⟨205134317, 205134337⟩, ⟨4733781, 4733802⟩, ⟨339746, 339769⟩, ⟨14975, 14996⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1174968835), (-1174968834)⟩, ⟨(-167852691), (-167852690)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3119998461, 3119998462⟩, ⟨(-167852691), (-167852690)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨390834561, 390834569⟩, ⟨123761300, 123761316⟩, ⟨12653509, 12653526⟩, ⟨657158, 657178⟩, ⟨46703, 46722⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4685801857, 4685801865⟩, ⟨123761300, 123761316⟩, ⟨12653509, 12653526⟩, ⟨657158, 657178⟩, ⟨46703, 46722⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4486130373, 4486130378⟩, ⟨59243790, 59243799⟩, ⟨5665971, 5665981⟩, ⟨239751, 239763⟩, ⟨15611, 15622⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3258865293, 3258865299⟩, ⟨(-132287044), (-132287034)⟩, ⟨1800616, 1800625⟩, ⟨(-47272), (-47261)⟩, ⟨1969, 1980⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨36314265334, 36314265341⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value378

def j47 : Jet := ⟨⟨9934448170, 9934448182⟩, ⟨1419206876, 1419206886⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨22978815353, 22978815409⟩, ⟨6565375790, 6565375846⟩, ⟨468955411, 468955419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨22978815353, 22978815409⟩, ⟨6565375790, 6565375846⟩, ⟨468955411, 468955419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-22978815409), (-22978815353)⟩, ⟨(-6565375846), (-6565375790)⟩, ⟨(-468955419), (-468955411)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11489407705), (-11489407676)⟩, ⟨(-3282687923), (-3282687895)⟩, ⟨(-234477710), (-234477705)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨295927063, 295927072⟩, ⟨(-226180122), (-226180112)⟩, ⟨70280175, 70280182⟩, ⟨(-9673300), (-9673297)⟩, ⟨(-70074), (-70072)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨224538714, 224538722⟩, ⟨(-180731964), (-180731953)⟩, ⟨60416563, 60416573⟩, ⟨(-9602495), (-9602487)⟩, ⟨276859, 276867⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1007116143, 1342821526⟩, ⟨167852690, 167852691⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3163948676, 4218598242⟩, ⟨527324777, 527324781⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2330767741, 4143587111⟩, ⟨776922576, 1035896780⟩, ⟨64743547, 64743549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨583, 1039⟩, ⟨194, 260⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94104), (-93647)⟩, ⟨194, 260⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-90788), (-50819)⟩, ⟨(-22592), (-16688)⟩, ⟨(-1376), (-1331)⟩, ⟨4, 9⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5022268, 5062238⟩, ⟨(-22592), (-16688)⟩, ⟨(-1376), (-1331)⟩, ⟨4, 9⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2725455, 4883815⟩, ⟨886689, 1211898⟩, ⟨68930, 72570⟩, ⟨(-671), (-482)⟩, ⟨(-21), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140440122), (-138281761)⟩, ⟨886689, 1211898⟩, ⟨68930, 72570⟩, ⟨(-671), (-482)⟩, ⟨(-21), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-135490178), (-75041937)⟩, ⟨(-33391362), (-23844795)⟩, ⟨(-1919235), (-1722189)⟩, ⟨25186, 35512⟩, ⟨856, 999⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1296165587, 1356613829⟩, ⟨(-33391362), (-23844795)⟩, ⟨(-1919235), (-1722189)⟩, ⟨25186, 35512⟩, ⟨856, 999⟩⟩
...
def j70 : Jet := ⟨⟨(-105), (-58)⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11730, 11778⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6365, 11363⟩, ⟨2094, 2831⟩, ⟨167, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845812), (-840813)⟩, ⟨2094, 2831⟩, ⟨167, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-816001), (-456287)⟩, ⟨(-202865), (-149363)⟩, ⟨(-12283), (-11822)⟩, ⟨59, 86⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34975393, 35335108⟩, ⟨(-202865), (-149363)⟩, ⟨(-12283), (-11822)⟩, ⟨59, 86⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18980241, 34089689⟩, ⟨6131032, 8441368⟩, ⟨466448, 499219⟩, ⟨(-5990), (-4306)⟩, ⟨(-176), (-154)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696847642), (-681738193)⟩, ⟨6131032, 8441368⟩, ⟨466448, 499219⟩, ⟨(-5990), (-4306)⟩, ⟨(-176), (-154)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-672286588), (-369961696)⟩, ⟨(-164744496), (-115176719)⟩, ⟨(-9142299), (-7759127)⟩, ⟨171017, 245318⟩, ⟨5416, 6665⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3622680708, 3925005600⟩, ⟨(-164744496), (-115176719)⟩, ⟨(-9142299), (-7759127)⟩, ⟨171017, 245318⟩, ⟨5416, 6665⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨954838793, 1332491803⟩, ⟨126342169, 148995870⟩, ⟨(-5984813), (-4196275)⟩, ⟨(-217086), (-176564)⟩, ⟨3722, 5343⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4699800701, 5092014881⟩, ⟨137912573, 231563723⟩, ⟨13337728, 23380912⟩, ⟨345759, 1425785⟩, ⟨13391, 110309⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1044839627, 1579771771⟩, ⟨168911015, 248487562⟩, ⟨(-73391), 10695137⟩, ⟨(-110832), 925497⟩, ⟨(-27067), 71320⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1342821526), (-1007116143)⟩, ⟨(-167852691), (-167852690)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2952145770, 3287851153⟩, ⟨(-167852691), (-167852690)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨254178849, 581070513⟩, ⟨82182194, 182797032⟩, ⟨6588885, 22244133⟩, ⟨(-90028), 1918378⟩, ⟨(-32921), 186191⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4549146145, 4876037809⟩, ⟨82182194, 182797032⟩, ⟨6588885, 22244133⟩, ⟨(-90028), 1918378⟩, ⟨(-32921), 186191⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4420230075, 4576289209⟩, ⟨38565070, 88808418⟩, ⟨2230202, 10638651⟩, ⟨(-257484), 912550⟩, ⟨(-47132), 95069⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3038245141, 3503206594⟩, ⟨(-152339404), (-104764160)⟩, ⟨(-1937815), 6636850⟩, ⟨(-612880), 611410⟩, ⟨(-71745), 82840⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8515241285, 11353655067⟩, ⟨1419206876, 1419206886⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨16882394939, 30013146666⟩, ⟨5627464960, 7503286682⟩, ⟨468955411, 468955419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨16882394939, 30013146666⟩, ⟨5627464960, 7503286682⟩, ⟨468955411, 468955419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-30013146666), (-16882394939)⟩, ⟨(-7503286682), (-5627464960)⟩, ⟨(-468955419), (-468955411)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15006573333), (-8441197469)⟩, ⟨(-3751643341), (-2813732480)⟩, ⟨(-234477710), (-234477705)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨130478581, 601742605⟩, ⟨(-525620682), (-85479538)⟩, ⟨(-4851482), 222440891⟩, ⟨(-61656100), 20542935⟩, ⟨(-10557976), 13596543⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨92300100, 490813671⟩, ⟨(-450067909), (-63650605)⟩, ⟨(-2143583), 201008008⟩, ⟨(-59077945), 17250816⟩, ⟨(-9525537), 13707313⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1174968834, 1174968835⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨167852690, 167852691⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4486130373, 4486130378⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar378 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1510
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar378 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1007116143, 1342821526⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4420230075, 4576289209⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1511
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((18759 / 80000) : ℝ)..(6253 / 20000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (18759 / 80000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (6253 / 20000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((18759 / 80000) : ℝ)..(6253 / 20000), prawitzNormalCorrection
      ((74733 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
