...
namespace FiniteNormalPanel0_18
...
def j2 : Jet := ⟨⟨6039230681, 6039230686⟩, ⟨402615377, 402615381⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨8491870765, 8491870780⟩, ⟨1132249430, 1132249444⟩, ⟨37741647, 37741649⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨2125, 2128⟩, ⟨283, 284⟩, ⟨9, 10⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-92562), (-92558)⟩, ⟨283, 284⟩, ⟨9, 10⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-183011), (-183002)⟩, ⟨(-23843), (-23838)⟩, ⟨(-723), (-718)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4930045, 4930055⟩, ⟨(-23843), (-23838)⟩, ⟨(-723), (-718)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨9747525, 9747546⟩, ⟨1252528, 1252542⟩, ⟨35606, 35620⟩, ⟨(-394), (-386)⟩, ⟨(-6), (-2)⟩⟩
...
def j16 : Jet := ⟨⟨(-133418052), (-133418030)⟩, ⟨1252528, 1252542⟩, ⟨35606, 35620⟩, ⟨(-394), (-386)⟩, ⟨(-6), (-2)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-263789869), (-263789824)⟩, ⟨(-32695526), (-32695490)⟩, ⟨(-771807), (-771773)⟩, ⟨19612, 19635⟩, ⟨196, 210⟩⟩
...
def j19 : Jet := ⟨⟨1167865896, 1167865942⟩, ⟨(-32695526), (-32695490)⟩, ⟨(-771807), (-771773)⟩, ⟨19612, 19635⟩, ⟨196, 210⟩⟩
...
def j22 : Jet := ⟨⟨(-214), (-211)⟩, ⟨(-29), (-28)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11621, 11625⟩, ⟨(-29), (-28)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨22976, 22985⟩, ⟨3005, 3010⟩, ⟨92, 96⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-829201), (-829191)⟩, ⟨3005, 3010⟩, ⟨92, 96⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1639470), (-1639449)⟩, ⟨(-212655), (-212641)⟩, ⟨(-6314), (-6302)⟩, ⟨46, 53⟩, ⟨(-3), 1⟩⟩
...
def j30 : Jet := ⟨⟨34151924, 34151946⟩, ⟨(-212655), (-212641)⟩, ⟨(-6314), (-6302)⟩, ⟨46, 53⟩, ⟨(-3), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨67524082, 67524126⟩, ⟨8582755, 8582791⟩, ⟨231562, 231592⟩, ⟨(-3444), (-3424)⟩, ⟨(-50), (-39)⟩⟩
...
def j33 : Jet := ⟨⟨(-648303801), (-648303756)⟩, ⟨8582755, 8582791⟩, ⟨231562, 231592⟩, ⟨(-3444), (-3424)⟩, ⟨(-50), (-39)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-1281805361), (-1281805269)⟩, ⟨(-153937837), (-153937750)⟩, ⟨(-2976471), (-2976399)⟩, ⟨129654, 129705⟩, ⟨1027, 1057⟩⟩
...
def j36 : Jet := ⟨⟨3013161935, 3013162027⟩, ⟨(-153937837), (-153937750)⟩, ⟨(-2976471), (-2976399)⟩, ⟨129654, 129705⟩, ⟨1027, 1057⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1642157218, 1642157286⟩, ⟨63503380, 63503438⟩, ⟨(-4150170), (-4150117)⟩, ⟨(-44775), (-44736)⟩, ⟨2113, 2137⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨6122055139, 6122055327⟩, ⟨312766250, 312766449⟩, ⟨22026100, 22026268⟩, ⟨1170696, 1170821⟩, ⟨65953, 66032⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨2340734246, 2340734415⟩, ⟨210102309, 210102477⟩, ⟨7130312, 7130462⟩, ⟨407230, 407345⟩, ⟨20991, 21066⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1922346832), (-1922346831)⟩, ⟨(-128156456), (-128156455)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2372620464, 2372620465⟩, ⟨(-128156456), (-128156455)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨1275687667, 1275687852⟩, ⟨229009272, 229009474⟩, ⟨18049800, 18049985⟩, ⟨1141480, 1141624⟩, ⟨74555, 74654⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5570654963, 5570655148⟩, ⟨229009272, 229009474⟩, ⟨18049800, 18049985⟩, ⟨1141480, 1141624⟩, ⟨74555, 74654⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4891398663, 4891398745⟩, ⟨100542542, 100542634⟩, ⟨6891124, 6891209⟩, ⟨359497, 359565⟩, ⟨20486, 20533⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2702100334, 2702100381⟩, ⟨(-90411640), (-90411584)⟩, ⟨806719, 806771⟩, ⟨(-7034), (-6991)⟩, ⟨587, 617⟩⟩
...
def j47 : Jet := ⟨⟨5640492400, 5640492405⟩, ⟨376032825, 376032829⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7407542903, 7407542917⟩, ⟨987672382, 987672396⟩, ⟨32922412, 32922414⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7407542903, 7407542917⟩, ⟨987672382, 987672396⟩, ⟨32922412, 32922414⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7407542917), (-7407542903)⟩, ⟨(-987672396), (-987672382)⟩, ⟨(-32922414), (-32922412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3703771459), (-3703771451)⟩, ⟨(-493836198), (-493836191)⟩, ⟨(-16461207), (-16461206)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1813198558, 1813198571⟩, ⟨(-208481935), (-208481929)⟩, ⟨5036248, 5036251⟩, ⟨339672, 339673⟩, ⟨(-19416), (-19414)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1140740799, 1140740829⟩, ⟨(-169331528), (-169331496)⟩, ⟨7897701, 7897730⟩, ⟨65549, 65576⟩, ⟨(-17836), (-17813)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1794190375, 2050503287⟩, ⟨128156455, 128156456⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨5636615301, 6441846063⟩, ⟨402615377, 402615381⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨7397362974, 9661861859⟩, ⟨1056766134, 1207732740⟩, ⟨37741647, 37741649⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1851, 2421⟩, ⟨264, 303⟩, ⟨9, 10⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-92836), (-92265)⟩, ⟨264, 303⟩, ⟨9, 10⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-208842), (-158911)⟩, ⟨(-25652), (-22019)⟩, ⟨(-737), (-701)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4904214, 4954146⟩, ⟨(-25652), (-22019)⟩, ⟨(-737), (-701)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨8446688, 11144736⟩, ⟨1148962, 1355168⟩, ⟨34223, 36911⟩, ⟨(-428), (-351)⟩, ⟨(-7), (-1)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-134718889), (-132020840)⟩, ⟨1148962, 1355168⟩, ⟨34223, 36911⟩, ⟨(-428), (-351)⟩, ⟨(-7), (-1)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-303060584), (-227383820)⟩, ⟨(-35903680), (-29434846)⟩, ⟨(-842189), (-696016)⟩, ⟨17553, 21685⟩, ⟨163, 238⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1128595181, 1204271946⟩, ⟨(-35903680), (-29434846)⟩, ⟨(-842189), (-696016)⟩, ⟨17553, 21685⟩, ⟨163, 238⟩⟩
...
def j70 : Jet := ⟨⟨(-243), (-184)⟩, ⟨(-31), (-26)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11592, 11652⟩, ⟨(-31), (-26)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨19965, 26213⟩, ⟨2782, 3233⟩, ⟨89, 97⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-832212), (-825963)⟩, ⟨2782, 3233⟩, ⟨89, 97⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1872126), (-1422583)⟩, ⟨(-229225), (-195953)⟩, ⟨(-6476), (-6129)⟩, ⟨40, 57⟩, ⟨(-4), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨33919268, 34368812⟩, ⟨(-229225), (-195953)⟩, ⟨(-6476), (-6129)⟩, ⟨40, 57⟩, ⟨(-4), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨58420267, 77315307⟩, ⟨7830092, 9326918⟩, ⟨219035, 243244⟩, ⟨(-3769), (-3100)⟩, ⟨(-57), (-33)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-657407616), (-638512575)⟩, ⟨7830092, 9326918⟩, ⟨219035, 243244⟩, ⟨(-3769), (-3100)⟩, ⟨(-57), (-33)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1478889392), (-1099731140)⟩, ⟨(-171375152), (-136122821)⟩, ⟨(-3473087), (-2440972)⟩, ⟨114220, 145021⟩, ⟨735, 1320⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨2816077904, 3195236156⟩, ⟨(-171375152), (-136122821)⟩, ⟨(-3473087), (-2440972)⟩, ⟨114220, 145021⟩, ⟨735, 1320⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1481142096, 1806238316⟩, ⟨51945399, 74260288⟩, ⟨(-4628819), (-3672692)⟩, ⟨(-55912), (-32720)⟩, ⟨1858, 2390⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5773202096, 6550509149⟩, ⟨245948817, 398637589⟩, ⟨14888247, 32338263⟩, ⟨524847, 2225460⟩, ⟨12930, 163838⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1990919153, 2754801096⟩, ⟨154640626, 280904860⟩, ⟨1049226, 15555500⟩, ⟨(-153839), 1240748⟩, ⟨(-26740), 96423⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-2050503287), (-1794190375)⟩, ⟨(-128156456), (-128156455)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2244464009, 2500776921⟩, ⟨(-128156456), (-128156455)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨922884576, 1766935242⟩, ⟨143366392, 360345942⟩, ⟨6540577, 38326756⟩, ⟨(-121792), 3626400⟩, ⟨(-54172), 342329⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨5217851872, 6061902538⟩, ⟨143366392, 360345942⟩, ⟨6540577, 38326756⟩, ⟨(-121792), 3626400⟩, ⟨(-54172), 342329⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4733973293, 5102516355⟩, ⟨60338264, 163464594⟩, ⟨134334, 17001729⟩, ⟨(-642321), 1643341⟩, ⟨(-111850), 177470⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2473879762, 2970978418⟩, ⟨(-120721142), (-46077359)⟩, ⟨(-4807380), 8098967⟩, ⟨(-881308), 952840⟩, ⟨(-114162), 122501⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5264459572, 6016525230⟩, ⟨376032825, 376032829⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6452792926, 8428137713⟩, ⟨921827556, 1053517222⟩, ⟨32922412, 32922414⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6452792926, 8428137713⟩, ⟨921827556, 1053517222⟩, ⟨32922412, 32922414⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8428137713), (-6452792926)⟩, ⟨(-1053517222), (-921827556)⟩, ⟨(-32922414), (-32922412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4214068857), (-3226396463)⟩, ⟨(-526758611), (-460913778)⟩, ⟨(-16461207), (-16461206)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1610073090, 2026357765⟩, ⟨(-248523756), (-172784754)⟩, ⟨1504817, 9069283⟩, ⟨70715, 581178⟩, ⟨(-35200), (-4780)⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨927394077, 1401702219⟩, ⟨(-228868551), (-116796377)⟩, ⟨452326, 17080019⟩, ⟨(-1098624), 1113601⟩, ⟨(-159836), 122383⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4891398663, 4891398745⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified8
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4733973293, 5102516355⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified9
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (8529391 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((167097 / 400000) : ℝ)..(23871 / 50000), prawitzNormalCorrection
