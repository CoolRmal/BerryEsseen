...
namespace FiniteNormalPanel76_32
...
def j2 : Jet := ⟨⟨2900286287, 2900286291⟩, ⟨263662388, 263662393⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1958492339, 1958492345⟩, ⟨356089512, 356089522⟩, ⟨16185886, 16185888⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨490, 491⟩, ⟨89, 90⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94197), (-94195)⟩, ⟨89, 90⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-42954), (-42952)⟩, ⟨(-7770), (-7767)⟩, ⟨(-347), (-343)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5070102, 5070105⟩, ⟨(-7770), (-7767)⟩, ⟨(-347), (-343)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2311951, 2311953⟩, ⟨416810, 416815⟩, ⟨18303, 18309⟩, ⟨(-59), (-56)⟩, ⟨(-2), 1⟩⟩
...
def j16 : Jet := ⟨⟨(-140853626), (-140853623)⟩, ⟨416810, 416815⟩, ⟨18303, 18309⟩, ⟨(-59), (-56)⟩, ⟨(-2), 1⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-64228836), (-64228834)⟩, ⟨(-11487907), (-11487902)⟩, ⟨(-487914), (-487909)⟩, ⟨3060, 3064⟩, ⟨62, 66⟩⟩
...
def j19 : Jet := ⟨⟨1367426929, 1367426932⟩, ⟨(-11487907), (-11487902)⟩, ⟨(-487914), (-487909)⟩, ⟨3060, 3064⟩, ⟨62, 66⟩⟩
...
def j22 : Jet := ⟨⟨(-50), (-48)⟩, ⟨(-9), (-8)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11785, 11788⟩, ⟨(-9), (-8)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5373, 5376⟩, ⟨972, 975⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846804), (-846800)⟩, ⟨972, 975⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-386141), (-386138)⟩, ⟨(-69765), (-69761)⟩, ⟨(-3093), (-3089)⟩, ⟨5, 8⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35405253, 35405257⟩, ⟨(-69765), (-69761)⟩, ⟨(-3093), (-3089)⟩, ⟨5, 8⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16144690, 16144693⟩, ⟨2903585, 2903589⟩, ⟨126231, 126237⟩, ⟨(-518), (-514)⟩, ⟨(-13), (-9)⟩⟩
...
def j33 : Jet := ⟨⟨(-699683193), (-699683189)⟩, ⟨2903585, 2903589⟩, ⟨126231, 126237⟩, ⟨(-518), (-514)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-319053461), (-319053457)⟩, ⟨(-56685695), (-56685690)⟩, ⟨(-2338514), (-2338508)⟩, ⟨21170, 21176⟩, ⟨426, 430⟩⟩
...
def j36 : Jet := ⟨⟨3975913835, 3975913839⟩, ⟨(-56685695), (-56685690)⟩, ⟨(-2338514), (-2338508)⟩, ⟨21170, 21176⟩, ⟨426, 430⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨923389934, 923389938⟩, ⟨76187035, 76187042⟩, ⟨(-1034705), (-1034700)⟩, ⟨(-27887), (-27882)⟩, ⟨228, 234⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4639623699, 4639623704⟩, ⟨66148382, 66148390⟩, ⟨3671976, 3671985⟩, ⟨66546, 66558⟩, ⟨2252, 2261⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨997488810, 997488817⟩, ⟨96522253, 96522265⟩, ⟨845097, 845107⟩, ⟨33380, 33393⟩, ⟨595, 608⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-923189799), (-923189798)⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3371777497, 3371777498⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨231662747, 231662752⟩, ⟨44833806, 44833814⟩, ⟨2561717, 2561724⟩, ⟨53488, 53498⟩, ⟨1942, 1953⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4526630043, 4526630048⟩, ⟨44833806, 44833814⟩, ⟨2561717, 2561724⟩, ⟨53488, 53498⟩, ⟨1942, 1953⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4409277491, 4409277494⟩, ⟨21835746, 21835751⟩, ⟨1193584, 1193589⟩, ⟨20139, 20145⟩, ⟨683, 691⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3461517072, 3461517077⟩, ⟨(-69017819), (-69017812)⟩, ⟨510341, 510347⟩, ⟨(-7514), (-7508)⟩, ⟨142, 150⟩⟩
...
def j47 : Jet := ⟨⟨7805637847, 7805637858⟩, ⟨709603438, 709603447⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14185901311, 14185901352⟩, ⟨2579254774, 2579254812⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14185901311, 14185901352⟩, ⟨2579254774, 2579254812⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14185901352), (-14185901311)⟩, ⟨(-2579254812), (-2579254774)⟩, ⟨(-117238856), (-117238852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7092950676), (-7092950655)⟩, ⟨(-1289627406), (-1289627387)⟩, ⟨(-58619428), (-58619426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨823647744, 823647754⟩, ⟨(-247312411), (-247312404)⟩, ⟨25888128, 25888131⟩, ⟨(-340820), (-340818)⟩, ⟨(-151083), (-151081)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨663816632, 663816642⟩, ⟨(-212556336), (-212556326)⟩, ⟨24936510, 24936516⟩, ⟨(-721520), (-721514)⟩, ⟨(-112754), (-112747)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨839263453, 1007116144⟩, ⟨83926345, 83926346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2636623898, 3163948680⟩, ⟨263662388, 263662393⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1618588711, 2330767748⟩, ⟨323717738, 388461296⟩, ⟨16185886, 16185888⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨405, 584⟩, ⟨81, 98⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94282), (-94102)⟩, ⟨81, 98⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-51165), (-35463)⟩, ⟨(-8498), (-7038)⟩, ⟨(-349), (-342)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5061891, 5077594⟩, ⟨(-8498), (-7038)⟩, ⟨(-349), (-342)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1907609, 2755480⟩, ⟨376909, 456595⟩, ⟨18117, 18478⟩, ⟨(-65), (-49)⟩, ⟨(-2), 1⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141257968), (-140410096)⟩, ⟨376909, 456595⟩, ⟨18117, 18478⟩, ⟨(-65), (-49)⟩, ⟨(-2), 1⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-76657049), (-52914534)⟩, ⟨(-12634135), (-10335123)⟩, ⟨(-497106), (-477819)⟩, ⟨2749, 3375⟩, ⟨60, 68⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1354998716, 1378741232⟩, ⟨(-12634135), (-10335123)⟩, ⟨(-497106), (-477819)⟩, ⟨2749, 3375⟩, ⟨60, 68⟩⟩
...
def j70 : Jet := ⟨⟨(-59), (-40)⟩, ⟨(-10), (-8)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11776, 11796⟩, ⟨(-10), (-8)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4437, 6402⟩, ⟨881, 1064⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847740), (-845774)⟩, ⟨881, 1064⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-460047), (-318735)⟩, ⟨(-76343), (-63169)⟩, ⟨(-3114), (-3065)⟩, ⟨4, 10⟩, ⟨(-2), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35331347, 35472660⟩, ⟨(-76343), (-63169)⟩, ⟨(-3114), (-3065)⟩, ⟨4, 10⟩, ⟨(-2), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13314867, 19250096⟩, ⟨2621543, 3184545⟩, ⟨124553, 127766⟩, ⟨(-569), (-463)⟩, ⟨(-14), (-9)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702513016), (-696577786)⟩, ⟨2621543, 3184545⟩, ⟨124553, 127766⟩, ⟨(-569), (-463)⟩, ⟨(-14), (-9)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-381235658), (-262510250)⟩, ⟨(-62551331), (-50773878)⟩, ⟨(-2402943), (-2267737)⟩, ⟨18957, 23384⟩, ⟨409, 445⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3913731638, 4032457046⟩, ⟨(-62551331), (-50773878)⟩, ⟨(-2402943), (-2267737)⟩, ⟨18957, 23384⟩, ⟨409, 445⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨831815878, 1015669318⟩, ⟨73874471, 78294516⟩, ⟨(-1141794), (-927785)⟩, ⟨(-28830), (-26845)⟩, ⟨204, 259⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4574566787, 4713339028⟩, ⟨57599744, 75331081⟩, ⟨3297858, 4097867⟩, ⟨46583, 89590⟩, ⟨1481, 3193⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨885966533, 1114605423⟩, ⟨89839119, 103735381⟩, ⟨376416, 1354115⟩, ⟨14078, 54855⟩, ⟨(-292), 1603⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1007116144), (-839263453)⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3287851152, 3455703843⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨182757316, 289256044⟩, ⟨37064054, 53841630⟩, ⟨2034485, 3208324⟩, ⟨21554, 93884⟩, ⟨468, 3911⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4477724612, 4584223340⟩, ⟨37064054, 53841630⟩, ⟨2034485, 3208324⟩, ⟨21554, 93884⟩, ⟨468, 3911⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4385394026, 4437238931⟩, ⟨17937832, 26365709⟩, ⟨906294, 1534399⟩, ⟨1313, 42268⟩, ⟨(-295), 1817⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3357073944, 3570174712⟩, ⟨(-72974789), (-64479654)⟩, ⟨178576, 884052⟩, ⟨(-28979), 16300⟩, ⟨(-1064), 1437⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7096034408, 8515241296⟩, ⟨709603438, 709603447⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11723885387, 16882394983⟩, ⟨2344777068, 2813732520⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11723885387, 16882394983⟩, ⟨2344777068, 2813732520⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16882394983), (-11723885387)⟩, ⟨(-2813732520), (-2344777068)⟩, ⟨(-117238856), (-117238852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8441197492), (-5861942693)⟩, ⟨(-1406866260), (-1172388534)⟩, ⟨(-58619428), (-58619426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨601742593, 1097027288⟩, ⟨(-359343989), (-164256458)⟩, ⟨7445710, 50640820⟩, ⟨(-4034771), 2592167⟩, ⟨(-557857), 279598⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨470339874, 911899629⟩, ⟨(-317342617), (-137421587)⟩, ⟨8310761, 48426320⟩, ⟨(-4295683), 2040283⟩, ⟨(-509087), 314186⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4409277491, 4409277494⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1532
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4385394026, 4437238931⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1533
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (13135045 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((6253 / 32000) : ℝ)..(18759 / 80000), prawitzNormalCorrection
