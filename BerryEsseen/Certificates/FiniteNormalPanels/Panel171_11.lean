...
namespace FiniteNormalPanel171_11
...
def j2 : Jet := ⟨⟨2177776283, 2177776287⟩, ⟨435555256, 435555260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1104248114, 1104248119⟩, ⟨441699244, 441699252⟩, ⟨44169924, 44169926⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨276, 277⟩, ⟨110, 111⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94411), (-94409)⟩, ⟨110, 111⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-24274), (-24272)⟩, ⟨(-9682), (-9680)⟩, ⟨(-958), (-954)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5088782, 5088785⟩, ⟨(-9682), (-9680)⟩, ⟨(-958), (-954)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1308340, 1308341⟩, ⟨520846, 520849⟩, ⟨51090, 51094⟩, ⟨(-199), (-195)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-141857237), (-141857235)⟩, ⟨520846, 520849⟩, ⟨51090, 51094⟩, ⟨(-199), (-195)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-36471893), (-36471892)⟩, ⟨(-14454848), (-14454844)⟩, ⟨(-1392177), (-1392173)⟩, ⟨10558, 10562⟩, ⟨501, 505⟩⟩
...
def j19 : Jet := ⟨⟨1395183872, 1395183874⟩, ⟨(-14454848), (-14454844)⟩, ⟨(-1392177), (-1392173)⟩, ⟨10558, 10562⟩, ⟨501, 505⟩⟩
...
def j22 : Jet := ⟨⟨(-28), (-27)⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11807, 11809⟩, ⟨(-12), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3035, 3037⟩, ⟨1210, 1213⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849142), (-849139)⟩, ⟨1210, 1213⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-218317), (-218316)⟩, ⟨(-87016), (-87014)⟩, ⟨(-8579), (-8575)⟩, ⟨23, 26⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35573077, 35573079⟩, ⟨(-87016), (-87014)⟩, ⟨(-8579), (-8575)⟩, ⟨23, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9145937, 9145939⟩, ⟨3636002, 3636005⟩, ⟨354682, 354686⟩, ⟨(-1773), (-1768)⟩, ⟨(-88), (-84)⟩⟩
...
def j33 : Jet := ⟨⟨(-706681946), (-706681943)⟩, ⟨3636002, 3636005⟩, ⟨354682, 354686⟩, ⟨(-1773), (-1768)⟩, ⟨(-88), (-84)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-181689908), (-181689905)⟩, ⟨(-71741138), (-71741133)⟩, ⟨(-6802478), (-6802474)⟩, ⟨73412, 73417⟩, ⟨3441, 3446⟩⟩
...
def j36 : Jet := ⟨⟨4113277388, 4113277391⟩, ⟨(-71741138), (-71741133)⟩, ⟨(-6802478), (-6802474)⟩, ⟨73412, 73417⟩, ⟨3441, 3446⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨707432242, 707432246⟩, ⟨134157073, 134157078⟩, ⟨(-2171783), (-2171779)⟩, ⟨(-135829), (-135825)⟩, ⟨1324, 1329⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4484682728, 4484682732⟩, ⟨78218945, 78218952⟩, ⟨8780940, 8780950⟩, ⟨202461, 202471⟩, ⟨12896, 12909⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨738680632, 738680637⟩, ⟨152966592, 152966600⟩, ⟨1621847, 1621857⟩, ⟨126245, 126256⟩, ⟨2915, 2927⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-693207722), (-693207721)⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3601759574, 3601759575⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨127043825, 127043828⟩, ⟨52616678, 52616684⟩, ⟨6005826, 6005834⟩, ⟨158948, 158956⟩, ⟨10606, 10615⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4422011121, 4422011124⟩, ⟨52616678, 52616684⟩, ⟨6005826, 6005834⟩, ⟨158948, 158956⟩, ⟨10606, 10615⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4358026290, 4358026292⟩, ⟨25927667, 25927671⟩, ⟨2882334, 2882340⟩, ⟨61175, 61181⟩, ⟨3908, 3915⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3654640846, 3654640850⟩, ⟨(-118934149), (-118934143)⟩, ⟨1580179, 1580186⟩, ⟨(-41741), (-41734)⟩, ⟨1302, 1310⟩⟩
...
def j47 : Jet := ⟨⟨7252709604, 7252709616⟩, ⟨1450541918, 1450541930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12247310159, 12247310201⟩, ⟨4898924054, 4898924104⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12247310159, 12247310201⟩, ⟨4898924054, 4898924104⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12247310201), (-12247310159)⟩, ⟨(-4898924104), (-4898924054)⟩, ⟨(-489892413), (-489892404)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6123655101), (-6123655079)⟩, ⟨(-2449462052), (-2449462027)⟩, ⟨(-244946207), (-244946202)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1032176186, 1032176206⟩, ⟨(-588660233), (-588660215)⟩, ⟨108993326, 108993337⟩, ⟨1661256, 1661260⟩, ⟨(-3344857), (-3344855)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨878291495, 878291514⟩, ⟨(-529480804), (-529480784)⟩, ⟨109424414, 109424428⟩, ⟨(-1831218), (-1831208)⟩, ⟨(-2846053), (-2846043)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨554566177, 831849266⟩, ⟨138641544, 138641545⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1742221027, 2613331544⟩, ⟨435555256, 435555260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨706718793, 1590117291⟩, ⟨353359396, 530039102⟩, ⟨44169924, 44169926⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨176, 399⟩, ⟨88, 133⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94511), (-94287)⟩, ⟨88, 133⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34991), (-15514)⟩, ⟨(-11650), (-7707)⟩, ⟨(-964), (-947)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078065, 5097543⟩, ⟨(-11650), (-7707)⟩, ⟨(-964), (-947)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨835574, 1887254⟩, ⟨413473, 627817⟩, ⟨50428, 51635⟩, ⟨(-239), (-154)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142330003), (-141278322)⟩, ⟨413473, 627817⟩, ⟨50428, 51635⟩, ⟨(-239), (-154)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-52694557), (-23246753)⟩, ⟨(-17496818), (-11390940)⟩, ⟨(-1421424), (-1356326)⟩, ⟨8311, 12805⟩, ⟨484, 519⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1378961208, 1408409013⟩, ⟨(-17496818), (-11390940)⟩, ⟨(-1421424), (-1356326)⟩, ⟨8311, 12805⟩, ⟨484, 519⟩⟩
...
def j72 : Jet := ⟨⟨1940, 4376⟩, ⟨964, 1458⟩, ⟨118, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850237), (-847800)⟩, ⟨964, 1458⟩, ⟨118, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-314782), (-139501)⟩, ⟨(-104770), (-69210)⟩, ⟨(-8646), (-8492)⟩, ⟨17, 31⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35476612, 35651894⟩, ⟨(-104770), (-69210)⟩, ⟨(-8646), (-8492)⟩, ⟨17, 31⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5837527, 13199331⟩, ⟨2879974, 4388389⟩, ⟨348714, 359558⟩, ⟨(-2143), (-1397)⟩, ⟨(-89), (-82)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709990356), (-702628551)⟩, ⟨2879974, 4388389⟩, ⟨348714, 359558⟩, ⟨(-2143), (-1397)⟩, ⟨(-89), (-82)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-262858333), (-115614571)⟩, ⟨(-87145558), (-56182580)⟩, ⟨(-7007299), (-6551222)⟩, ⟨57512, 89275⟩, ⟨3288, 3571⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4032108963, 4179352725⟩, ⟨(-87145558), (-56182580)⟩, ⟨(-7007299), (-6551222)⟩, ⟨57512, 89275⟩, ⟨3288, 3571⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨559365193, 856965711⟩, ⟨129195119, 138206972⟩, ⟨(-2639249), (-1705345)⟩, ⟨(-140777), (-129753)⟩, ⟨1038, 1615⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4413780144, 4574961700⟩, ⟨59333961, 98878180⟩, ⟨7716311, 10087754⟩, ⟨99010, 326911⟩, ⟨7403, 20155⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨574839064, 912832401⟩, ⟨140496576, 166945816⟩, ⟨(-21555), 3442052⟩, ⟨34289, 232941⟩, ⟨(-4432), 11408⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-831849266), (-554566177)⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3463118030, 3740401119⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨76936546, 194009159⟩, ⟨37608164, 70963778⟩, ⟨4586747, 7952317⟩, ⟨7502, 366604⟩, ⟨340, 25719⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4371903842, 4488976455⟩, ⟨37608164, 70963778⟩, ⟨4586747, 7952317⟩, ⟨7502, 366604⟩, ⟨340, 25719⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4333264822, 4390900485⟩, ⟨18393247, 35168299⟩, ⟨2102429, 3901981⟩, ⟨(-27951), 172759⟩, ⟨(-2991), 12463⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3493998091, 3823947415⟩, ⟨(-126907427), (-109250419)⟩, ⟨559997, 2804424⟩, ⟨(-150298), 82587⟩, ⟨(-8182), 11757⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5802167685, 8703251535⟩, ⟨1450541918, 1450541930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7838278507, 17636126672⟩, ⟨3919139244, 5878708922⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7838278507, 17636126672⟩, ⟨3919139244, 5878708922⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17636126672), (-7838278507)⟩, ⟨(-5878708922), (-3919139244)⟩, ⟨(-489892413), (-489892404)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8818063336), (-3919139253)⟩, ⟨(-2939354461), (-1959569622)⟩, ⟨(-244946207), (-244946202)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨551192352, 1724519098⟩, ⟨(-1180212224), (-251480329)⟩, ⟨(-40982339), 372416936⟩, ⟨(-75395769), 54221495⟩, ⟨(-19896568), 14068317⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨448400393, 1535394776⟩, ⟨(-1101736857), (-218602312)⟩, ⟨(-30019162), 367573640⟩, ⟨(-78962405), 49486456⟩, ⟨(-19369429), 15042459⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4358026290, 4358026292⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3462
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4333264822, 4390900485⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3463
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (59251543 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((807 / 6250) : ℝ)..(2421 / 12500), prawitzNormalCorrection
