...
namespace FiniteNormalPanel68_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (15963 / 400000)
def radius : Rat := (15963 / 400000)

def j0 : Jet := ⟨⟨171401407, 171401408⟩, ⟨171401407, 171401408⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨538473401, 538473405⟩, ⟨538473401, 538473405⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨67510084, 67510086⟩, ⟨135020168, 135020172⟩, ⟨67510084, 67510086⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1489), (-1488)⟩, ⟨(-2977), (-2975)⟩, ⟨(-1488), (-1485)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111567, 5111569⟩, ⟨(-2977), (-2975)⟩, ⟨(-1488), (-1485)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨80345, 80346⟩, ⟨160644, 160646⟩, ⟨80227, 80230⟩, ⟨(-94), (-91)⟩, ⟨(-24), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-143085232), (-143085230)⟩, ⟨160644, 160646⟩, ⟨80227, 80230⟩, ⟨(-94), (-91)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2249074), (-2249073)⟩, ⟨(-4495622), (-4495620)⟩, ⟨(-2242763), (-2242760)⟩, ⟨5045, 5048⟩, ⟨1257, 1260⟩⟩
...
def j19 : Jet := ⟨⟨1429406691, 1429406693⟩, ⟨(-4495622), (-4495620)⟩, ⟨(-2242763), (-2242760)⟩, ⟨5045, 5048⟩, ⟨1257, 1260⟩⟩
...
def j25 : Jet := ⟨⟨185, 187⟩, ⟨370, 373⟩, ⟨183, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851992), (-851989)⟩, ⟨370, 373⟩, ⟨183, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13392), (-13391)⟩, ⟨(-26779), (-26777)⟩, ⟨(-13379), (-13376)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778002, 35778004⟩, ⟨(-26779), (-26777)⟩, ⟨(-13379), (-13376)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨562373, 562374⟩, ⟨1124326, 1124328⟩, ⟨561320, 561323⟩, ⟨(-842), (-839)⟩, ⟨(-211), (-208)⟩⟩
...
def j33 : Jet := ⟨⟨(-715265510), (-715265508)⟩, ⟨1124326, 1124328⟩, ⟨561320, 561323⟩, ⟨(-842), (-839)⟩, ⟨(-211), (-208)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11242842), (-11242841)⟩, ⟨(-22468011), (-22468009)⟩, ⟨(-11198674), (-11198671)⟩, ⟨35304, 35307⟩, ⟨8792, 8795⟩⟩
...
def j36 : Jet := ⟨⟨4283724454, 4283724455⟩, ⟨(-22468011), (-22468009)⟩, ⟨(-11198674), (-11198671)⟩, ⟨35304, 35307⟩, ⟨8792, 8795⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨179209160, 179209162⟩, ⟨178645529, 178645533⟩, ⟨(-844814), (-844810)⟩, ⟨(-280551), (-280548)⟩, ⟨789, 791⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306239644, 4306239646⟩, ⟨22586100, 22586104⟩, ⟨11375993, 11375999⟩, ⟨83217, 83224⟩, ⟨21146, 21154⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨179679503, 179679506⟩, ⟨180056805, 180056811⟩, ⟨567084, 567091⟩, ⟨190915, 190923⟩, ⟨1420, 1427⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-171401408), (-171401407)⟩, ⟨(-171401408), (-171401407)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4123565888, 4123565889⟩, ⟨(-171401408), (-171401407)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7516873, 7516874⟩, ⟨15065314, 15065316⟩, ⟨7595920, 7595926⟩, ⟨63518, 63526⟩, ⟨16198, 16205⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302484169, 4302484170⟩, ⟨15065314, 15065316⟩, ⟨7595920, 7595926⟩, ⟨63518, 63526⟩, ⟨16198, 16205⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298724089, 4298724090⟩, ⟨7526073, 7526075⟩, ⟨3788052, 3788057⟩, ⟨25099, 25105⟩, ⟨6378, 6384⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4127172756, 4127172759⟩, ⟨(-164325607), (-164325602)⟩, ⟨3336533, 3336540⟩, ⟨(-127075), (-127067)⟩, ⟨5121, 5129⟩⟩
...
def j47 : Jet := ⟨⟨1269210674, 1269210683⟩, ⟨1269210674, 1269210683⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨375065890, 375065897⟩, ⟨750131780, 750131794⟩, ⟨375065890, 375065897⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨375065890, 375065897⟩, ⟨750131780, 750131794⟩, ⟨375065890, 375065897⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-375065897), (-375065890)⟩, ⟨(-750131794), (-750131780)⟩, ⟨(-375065897), (-375065890)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-187532949), (-187532945)⟩, ⟨(-375065897), (-375065890)⟩, ⟨(-187532949), (-187532945)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4111469568, 4111469572⟩, ⟨(-359041622), (-359041614)⟩, ⟨(-163843829), (-163843822)⟩, ⟨15220642, 15220644⟩, ⟨3244697, 3244699⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3950843864, 3950843871⟩, ⟨(-502319667), (-502319652)⟩, ⟨(-140511899), (-140511881)⟩, ⟨20494108, 20494122⟩, ⟨2423833, 2423847⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 342802815⟩, ⟨171401407, 171401408⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1076946806⟩, ⟨538473401, 538473405⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 270040339⟩, ⟨0, 270040340⟩, ⟨67510084, 67510086⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5954), 0⟩, ⟨(-5954), 5⟩, ⟨(-1489), (-1480)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107102, 5113057⟩, ⟨(-5954), 5⟩, ⟨(-1489), (-1480)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 321477⟩, ⟨(-375), 321478⟩, ⟨79806, 80371⟩, ⟨(-188), 2⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142844099)⟩, ⟨(-375), 321478⟩, ⟨79806, 80371⟩, ⟨(-188), 2⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9001345), 0⟩, ⟨(-9001369), 20213⟩, ⟨(-2250361), (-2220016)⟩, ⟨(-18), 10109⟩, ⟨1240, 1265⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422654420, 1431655766⟩, ⟨(-9001369), 20213⟩, ⟨(-2250361), (-2220016)⟩, ⟨(-18), 10109⟩, ⟨1240, 1265⟩⟩
...
def j72 : Jet := ⟨⟨0, 745⟩, ⟨(-1), 745⟩, ⟨183, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851431)⟩, ⟨(-1), 745⟩, ⟨183, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-53580), 0⟩, ⟨(-53581), 47⟩, ⟨(-13396), (-13324)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35737814, 35791395⟩, ⟨(-53581), 47⟩, ⟨(-13396), (-13324)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2250337⟩, ⟨(-3369), 2250340⟩, ⟨557529, 562588⟩, ⟨(-1687), 3⟩, ⟨(-212), (-206)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713577545)⟩, ⟨(-3369), 2250340⟩, ⟨557529, 562588⟩, ⟨(-1687), 3⟩, ⟨(-212), (-206)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-45006724), 0⟩, ⟨(-45006936), 141488⟩, ⟨(-11251894), (-11039448)⟩, ⟨(-160), 70745⟩, ⟨8642, 8844⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4249960572, 4294967296⟩, ⟨(-45006936), 141488⟩, ⟨(-11251894), (-11039448)⟩, ⟨(-160), 70745⟩, ⟨8642, 8844⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 358982269⟩, ⟨176105547, 179496205⟩, ⟨(-1692800), 2535⟩, ⟨(-282140), (-275795)⟩, ⟨(-3), 1586⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4340450638⟩, ⟨(-144502), 45965224⟩, ⟨11037933, 11978241⟩, ⟨(-73035), 248709⟩, ⟨17909, 25618⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 362783862⟩, ⟨176093469, 185238924⟩, ⟨(-1716767), 2924718⟩, ⟨143235, 245648⟩, ⟨(-10799), 14158⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-342802815), 0⟩, ⟨(-171401408), (-171401407)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3952164481, 4294967296⟩, ⟨(-171401408), (-171401407)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 30643338⟩, ⟨0, 31293228⟩, ⟨6929802, 8483311⟩, ⟨(-148086), 293784⟩, ⟨8748, 25574⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4325610634⟩, ⟨0, 31293228⟩, ⟨6929802, 8483311⟩, ⟨(-148086), 293784⟩, ⟨8748, 25574⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4310261734⟩, ⟨0, 15646614⟩, ⟨3424206, 4241656⟩, ⟨(-89496), 146892⟩, ⟨1736, 11750⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3952164481, 4310261734⟩, ⟨(-172011771), (-155754793)⟩, ⟨2526484, 4241656⟩, ⟨(-258770), 10241⟩, ⟨(-4266), 15322⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2538421358⟩, ⟨1269210674, 1269210683⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1500263576⟩, ⟨0, 1500263580⟩, ⟨375065890, 375065897⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1500263576⟩, ⟨0, 1500263580⟩, ⟨375065890, 375065897⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1500263576), 0⟩, ⟨(-1500263580), 0⟩, ⟨(-375065897), (-375065890)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-750131788), 0⟩, ⟨(-750131790), 0⟩, ⟨(-187532949), (-187532945)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3606689349, 4294967296⟩, ⟨(-750131790), 0⟩, ⟨(-187532949), (-91973743)⟩, ⟨0, 32753318⟩, ⟨577821, 4094165⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3318821438, 4310261734⟩, ⟨(-924814791), (-130794745)⟩, ⟨(-186079148), (-50348715)⟩, ⟨2335789, 40390817⟩, ⟨(-971317), 4115161⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨171401407, 171401408⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298724089, 4298724090⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1344
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 342802815⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4310261734⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1345
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (38957997 / 536870912)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(15963 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (15963 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(15963 / 200000), prawitzNormalCorrection
