...
namespace FiniteNormalPanel123_12
...
def j2 : Jet := ⟨⟨463637638, 463637642⟩, ⟨463637638, 463637642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨50049242, 50049244⟩, ⟨100098484, 100098488⟩, ⟨50049242, 50049244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1104), (-1103)⟩, ⟨(-2207), (-2205)⟩, ⟨(-1104), (-1101)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111952, 5111954⟩, ⟨(-2207), (-2205)⟩, ⟨(-1104), (-1101)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨59569, 59570⟩, ⟨119113, 119115⟩, ⟨59504, 59507⟩, ⟨(-52), (-49)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-143106008), (-143106006)⟩, ⟨119113, 119115⟩, ⟨59504, 59507⟩, ⟨(-52), (-49)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1667614), (-1667613)⟩, ⟨(-3333840), (-3333838)⟩, ⟨(-1664145), (-1664142)⟩, ⟨2773, 2776⟩, ⟨690, 693⟩⟩
...
def j19 : Jet := ⟨⟨1429988151, 1429988153⟩, ⟨(-3333840), (-3333838)⟩, ⟨(-1664145), (-1664142)⟩, ⟨2773, 2776⟩, ⟨690, 693⟩⟩
...
def j28 : Jet := ⟨⟨(-9929), (-9928)⟩, ⟨(-19855), (-19853)⟩, ⟨(-9922), (-9919)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781465, 35781467⟩, ⟨(-19855), (-19853)⟩, ⟨(-9922), (-9919)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨416961, 416962⟩, ⟨833690, 833692⟩, ⟨416382, 416385⟩, ⟨(-464), (-461)⟩, ⟨(-117), (-113)⟩⟩
...
def j33 : Jet := ⟨⟨(-715410922), (-715410920)⟩, ⟨833690, 833692⟩, ⟨416382, 416385⟩, ⟨(-464), (-461)⟩, ⟨(-117), (-113)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8336682), (-8336681)⟩, ⟨(-16663650), (-16663646)⟩, ⟨(-8312401), (-8312397)⟩, ⟨19412, 19416⟩, ⟨4839, 4842⟩⟩
...
def j36 : Jet := ⟨⟨4286630614, 4286630615⟩, ⟨(-16663650), (-16663646)⟩, ⟨(-8312401), (-8312397)⟩, ⟨19412, 19416⟩, ⟨4839, 4842⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨154365861, 154365864⟩, ⟨154005976, 154005980⟩, ⟨(-539528), (-539526)⟩, ⟨(-179344), (-179342)⟩, ⟨373, 375⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303320190, 4303320192⟩, ⟨16728523, 16728529⟩, ⟨8409789, 8409796⟩, ⟨45638, 45646⟩, ⟨11547, 11555⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨154666073, 154666077⟩, ⟨154906729, 154906735⟩, ⟨361518, 361524⟩, ⟨121397, 121403⟩, ⟨668, 675⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-147580445), (-147580444)⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4147386851, 4147386852⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5569680, 5569681⟩, ⟨11156692, 11156694⟩, ⟨5613062, 5613065⟩, ⟨34818, 34824⟩, ⟨8834, 8839⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300536976, 4300536977⟩, ⟨11156692, 11156694⟩, ⟨5613062, 5613065⟩, ⟨34818, 34824⟩, ⟨8834, 8839⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297751233, 4297751235⟩, ⟨5574732, 5574734⟩, ⟨2801097, 2801100⟩, ⟨13764, 13769⟩, ⟨3483, 3488⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4150075128, 4150075132⟩, ⟨(-142292928), (-142292923)⟩, ⟨2513292, 2513297⟩, ⟨(-82959), (-82953)⟩, ⟨2889, 2897⟩⟩
...
def j47 : Jet := ⟨⟨1461750922, 1461750934⟩, ⟨1461750922, 1461750934⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨497492905, 497492914⟩, ⟨994985810, 994985828⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨497492905, 497492914⟩, ⟨994985810, 994985828⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-497492914), (-497492905)⟩, ⟨(-994985828), (-994985810)⟩, ⟨(-497492914), (-497492905)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-248746457), (-248746452)⟩, ⟨(-497492914), (-497492905)⟩, ⟨(-248746457), (-248746452)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4053286944, 4053286950⟩, ⟨(-469498694), (-469498684)⟩, ⟨(-207557957), (-207557950)⟩, ⟨26141516, 26141518⟩, ⟨5253438, 5253440⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3916547944, 3916547954⟩, ⟨(-587946019), (-587946002)⟩, ⟨(-182629490), (-182629474)⟩, ⟨31783020, 31783032⟩, ⟨4100473, 4100489⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 295160890⟩, ⟨147580444, 147580445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 927275284⟩, ⟨463637638, 463637642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 200196974⟩, ⟨0, 200196974⟩, ⟨50049242, 50049244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4414), 0⟩, ⟨(-4414), 3⟩, ⟨(-1104), (-1098)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108642, 5113057⟩, ⟨(-4414), 3⟩, ⟨(-1104), (-1098)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 238330⟩, ⟨(-206), 238331⟩, ⟨59272, 59584⟩, ⟨(-104), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142927246)⟩, ⟨(-206), 238331⟩, ⟨59272, 59584⟩, ⟨(-104), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6673233), 0⟩, ⟨(-6673243), 11110⟩, ⟨(-1668319), (-1651642)⟩, ⟨(-8), 5557⟩, ⟨684, 696⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424982532, 1431655766⟩, ⟨(-6673243), 11110⟩, ⟨(-1668319), (-1651642)⟩, ⟨(-8), 5557⟩, ⟨684, 696⟩⟩
...
def j72 : Jet := ⟨⟨0, 552⟩, ⟨(-1), 552⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851624)⟩, ⟨(-1), 552⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-39722), 0⟩, ⟨(-39723), 26⟩, ⟨(-9932), (-9890)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35751672, 35791395⟩, ⟨(-39723), 26⟩, ⟨(-9932), (-9890)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1668309⟩, ⟨(-1852), 1668311⟩, ⟨414299, 417080⟩, ⟨(-927), 2⟩, ⟨(-118), (-113)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714159573)⟩, ⟨(-1852), 1668311⟩, ⟨414299, 417080⟩, ⟨(-927), 2⟩, ⟨(-118), (-113)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-33366163), 0⟩, ⟨(-33366250), 77764⟩, ⟨(-8341628), (-8224894)⟩, ⟨(-66), 38883⟩, ⟨4777, 4862⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4261601133, 4294967296⟩, ⟨(-33366250), 77764⟩, ⟨(-8341628), (-8224894)⟩, ⟨(-66), 38883⟩, ⟨4777, 4862⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 309091762⟩, ⟨152384769, 154548280⟩, ⟨(-1080558), 1200⟩, ⟨(-180096), (-177093)⟩, ⟨(-1), 751⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4328594700⟩, ⟨(-78987), 33890778⟩, ⟨8224280, 8738110⟩, ⟨(-39811), 134822⟩, ⟨10231, 13348⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 311511793⟩, ⟨152379084, 158197300⟩, ⟨(-1091862), 1849570⟩, ⟨98896, 147059⟩, ⟨(-5056), 6577⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-295160890), 0⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3999806406, 4294967296⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22593792⟩, ⟨0, 22947940⟩, ⟨5247798, 6095208⟩, ⟨(-80434), 157586⟩, ⟨5811, 12587⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317561088⟩, ⟨0, 22947940⟩, ⟨5247798, 6095208⟩, ⟨(-80434), 157586⟩, ⟨5811, 12587⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306249375⟩, ⟨0, 11473970⟩, ⟨2601738, 3047604⟩, ⟨(-48359), 78793⟩, ⟨1608, 5636⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3999806406, 4306249375⟩, ⟨(-147968112), (-136106474)⟩, ⟨2028680, 3047604⟩, ⟨(-153079), (-10605)⟩, ⟨(-1211), 7298⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2923501867⟩, ⟨1461750922, 1461750934⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1989971653⟩, ⟨0, 1989971654⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1989971653⟩, ⟨0, 1989971654⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1989971653), 0⟩, ⟨(-1989971654), 0⟩, ⟨(-497492914), (-497492905)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-994985827), 0⟩, ⟨(-994985827), 0⟩, ⟨(-248746457), (-248746452)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3406824923, 4294967296⟩, ⟨(-994985827), 0⟩, ⟨(-248746457), (-82058183)⟩, ⟨0, 57625398⟩, ⟨(-961189), 7203175⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3172699397, 4306249375⟩, ⟨(-1145567582), (-107961457)⟩, ⟨(-247790693), (-39092570)⟩, ⟨1741306, 66338050⟩, ⟨(-3126713), 7226099⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297751233, 4297751235⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2478
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306249375⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2479
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (132535351 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(27489 / 400000), prawitzNormalCorrection
