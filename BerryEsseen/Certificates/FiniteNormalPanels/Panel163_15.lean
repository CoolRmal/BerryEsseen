...
namespace FiniteNormalPanel163_15
...
def j2 : Jet := ⟨⟨450414464, 450414468⟩, ⟨450414464, 450414468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨47235095, 47235097⟩, ⟨94470190, 94470194⟩, ⟨47235095, 47235097⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1042), (-1041)⟩, ⟨(-2083), (-2081)⟩, ⟨(-1042), (-1039)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112014, 5112016⟩, ⟨(-2083), (-2081)⟩, ⟨(-1042), (-1039)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨56220, 56221⟩, ⟨112418, 112420⟩, ⟨56162, 56165⟩, ⟨(-46), (-43)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-143109357), (-143109355)⟩, ⟨112418, 112420⟩, ⟨56162, 56165⟩, ⟨(-46), (-43)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1573885), (-1573884)⟩, ⟨(-3146534), (-3146532)⟩, ⟨(-1570796), (-1570793)⟩, ⟨2470, 2473⟩, ⟨614, 618⟩⟩
...
def j19 : Jet := ⟨⟨1430081880, 1430081882⟩, ⟨(-3146534), (-3146532)⟩, ⟨(-1570796), (-1570793)⟩, ⟨2470, 2473⟩, ⟨614, 618⟩⟩
...
def j25 : Jet := ⟨⟨130, 131⟩, ⟨259, 261⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852047), (-852045)⟩, ⟨259, 261⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9371), (-9370)⟩, ⟨(-18740), (-18738)⟩, ⟨(-9365), (-9362)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782023, 35782025⟩, ⟨(-18740), (-18738)⟩, ⟨(-9365), (-9362)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨393522, 393523⟩, ⟨786838, 786840⟩, ⟨393006, 393009⟩, ⟨(-413), (-410)⟩, ⟨(-104), (-100)⟩⟩
...
def j33 : Jet := ⟨⟨(-715434361), (-715434359)⟩, ⟨786838, 786840⟩, ⟨393006, 393009⟩, ⟨(-413), (-410)⟩, ⟨(-104), (-100)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7868189), (-7868187)⟩, ⟨(-15727724), (-15727721)⟩, ⟨(-7846561), (-7846557)⟩, ⟨17292, 17295⟩, ⟨4310, 4313⟩⟩
...
def j36 : Jet := ⟨⟨4287099107, 4287099109⟩, ⟨(-15727724), (-15727721)⟩, ⟨(-7846561), (-7846557)⟩, ⟨17292, 17295⟩, ⟨4310, 4313⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨149973100, 149973103⟩, ⟨149643122, 149643126⟩, ⟨(-494708), (-494706)⟩, ⟨(-164471), (-164469)⟩, ⟨323, 325⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302849923, 4302849926⟩, ⟨15785504, 15785509⟩, ⟨7933294, 7933301⟩, ⟨40635, 40642⟩, ⟨10274, 10282⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨150248348, 150248352⟩, ⟨150468967, 150468973⟩, ⟨331391, 331396⟩, ⟨111233, 111241⟩, ⟨577, 586⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-143371378), (-143371377)⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4151595918, 4151595919⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5256050, 5256052⟩, ⟨10527536, 10527538⟩, ⟨5294681, 5294687⟩, ⟨31000, 31006⟩, ⟨7857, 7864⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300223346, 4300223348⟩, ⟨10527536, 10527538⟩, ⟨5294681, 5294687⟩, ⟨31000, 31006⟩, ⟨7857, 7864⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297594517, 4297594519⟩, ⟨5260550, 5260552⟩, ⟨2642502, 2642506⟩, ⟨12255, 12260⟩, ⟨3097, 3103⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4154135439, 4154135443⟩, ⟨(-138374132), (-138374127)⟩, ⟨2378687, 2378693⟩, ⟨(-76366), (-76359)⟩, ⟨2583, 2591⟩⟩
...
def j47 : Jet := ⟨⟨1348805307, 1348805318⟩, ⟨1348805307, 1348805318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨423583145, 423583153⟩, ⟨847166290, 847166306⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨423583145, 423583153⟩, ⟨847166290, 847166306⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-423583153), (-423583145)⟩, ⟨(-847166306), (-847166290)⟩, ⟨(-423583153), (-423583145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-211791577), (-211791572)⟩, ⟨(-423583153), (-423583145)⟩, ⟨(-211791577), (-211791572)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4088312821, 4088312826⟩, ⟨(-403202241), (-403202232)⟩, ⟨(-181718587), (-181718580)⟩, ⟨19228908, 19228910⟩, ⟨4006310, 4006311⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3954257158, 3954257168⟩, ⟨(-521697445), (-521697429)⟩, ⟨(-160505542), (-160505525)⟩, ⟨24156954, 24156968⟩, ⟨3164415, 3164430⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 286742755⟩, ⟨143371377, 143371378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 900828933⟩, ⟨450414464, 450414468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 188940384⟩, ⟨0, 188940384⟩, ⟨47235095, 47235097⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4166), 0⟩, ⟨(-4166), 3⟩, ⟨(-1042), (-1036)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108890, 5113057⟩, ⟨(-4166), 3⟩, ⟨(-1042), (-1036)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 224930⟩, ⟨(-184), 224931⟩, ⟨55956, 56234⟩, ⟨(-92), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142940646)⟩, ⟨(-184), 224931⟩, ⟨55956, 56234⟩, ⟨(-92), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6298013), 0⟩, ⟨(-6298022), 9895⟩, ⟨(-1574513), (-1559660)⟩, ⟨(-8), 4949⟩, ⟨609, 620⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425357752, 1431655766⟩, ⟨(-6298022), 9895⟩, ⟨(-1574513), (-1559660)⟩, ⟨(-8), 4949⟩, ⟨609, 620⟩⟩
...
def j72 : Jet := ⟨⟨0, 521⟩, ⟨(-1), 521⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851655)⟩, ⟨(-1), 521⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-37489), 0⟩, ⟨(-37490), 23⟩, ⟨(-9374), (-9337)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35753905, 35791395⟩, ⟨(-37490), 23⟩, ⟨(-9374), (-9337)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1574504⟩, ⟨(-1650), 1574506⟩, ⟨391150, 393628⟩, ⟨(-827), 2⟩, ⟨(-106), (-100)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714253378)⟩, ⟨(-1650), 1574506⟩, ⟨391150, 393628⟩, ⟨(-827), 2⟩, ⟨(-106), (-100)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-31490065), 0⟩, ⟨(-31490138), 69265⟩, ⟨(-7872590), (-7768617)⟩, ⟨(-56), 34635⟩, ⟨4259, 4331⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4263477231, 4294967296⟩, ⟨(-31490138), 69265⟩, ⟨(-7872590), (-7768617)⟩, ⟨(-56), 34635⟩, ⟨4259, 4331⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 300276312⟩, ⟨148156729, 150140233⟩, ⟨(-990716), 1038⟩, ⟨(-165122), (-162522)⟩, ⟨(-1), 651⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4326689947⟩, ⟨(-70293), 31957030⟩, ⟨7768101, 8225350⟩, ⟨(-35413), 119821⟩, ⟨9169, 11785⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 302494155⟩, ⟨148151814, 153483399⟩, ⟨(-1000492), 1693240⟩, ⟨91773, 133409⟩, ⟨(-4367), 5674⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-286742755), 0⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4008224541, 4294967296⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 21304636⟩, ⟨0, 21619644⟩, ⟨4969460, 5723338⟩, ⟨(-71508), 139812⟩, ⟨5319, 11004⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4316271932⟩, ⟨0, 21619644⟩, ⟨4969460, 5723338⟩, ⟨(-71508), 139812⟩, ⟨5319, 11004⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305606437⟩, ⟨0, 10809822⟩, ⟨2465020, 2861669⟩, ⟨(-42957), 69906⟩, ⟨1526, 4904⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4008224541, 4305606437⟩, ⟨(-143726526), (-132561555)⟩, ⟨1939603, 2861669⟩, ⟨(-138484), (-12379)⟩, ⟨(-910), 6338⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2697610625⟩, ⟨1348805307, 1348805318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1694332596⟩, ⟨0, 1694332602⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1694332596⟩, ⟨0, 1694332602⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1694332596), 0⟩, ⟨(-1694332602), 0⟩, ⟨(-423583153), (-423583145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-847166298), 0⟩, ⟨(-847166301), 0⟩, ⟨(-211791577), (-211791572)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3526118414, 4294967296⟩, ⟨(-847166301), 0⟩, ⟨(-211791577), (-90328229)⟩, ⟨0, 41775100⟩, ⟨167117, 5221888⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3290705932, 4305606437⟩, ⟨(-992991358), (-108831501)⟩, ⟨(-210723819), (-53086499)⟩, ⟨2084987, 48955800⟩, ⟨(-1384025), 5227686⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297594517, 4297594519⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3302
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305606437⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3303
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (260493981 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(5341 / 80000), prawitzNormalCorrection
