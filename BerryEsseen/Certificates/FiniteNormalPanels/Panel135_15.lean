...
namespace FiniteNormalPanel135_15
...
def j2 : Jet := ⟨⟨473420093, 473420097⟩, ⟨473420093, 473420097⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨52183536, 52183538⟩, ⟨104367072, 104367076⟩, ⟨52183536, 52183538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1151), (-1150)⟩, ⟨(-2301), (-2299)⟩, ⟨(-1151), (-1148)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111905, 5111907⟩, ⟨(-2301), (-2299)⟩, ⟨(-1151), (-1148)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨62109, 62110⟩, ⟨124190, 124192⟩, ⟨62039, 62042⟩, ⟨(-56), (-53)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-143103468), (-143103466)⟩, ⟨124190, 124192⟩, ⟨62039, 62042⟩, ⟨(-56), (-53)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1738697), (-1738696)⟩, ⟨(-3475886), (-3475884)⟩, ⟨(-1734927), (-1734924)⟩, ⟨3014, 3017⟩, ⟨750, 753⟩⟩
...
def j19 : Jet := ⟨⟨1429917068, 1429917070⟩, ⟨(-3475886), (-3475884)⟩, ⟨(-1734927), (-1734924)⟩, ⟨3014, 3017⟩, ⟨750, 753⟩⟩
...
def j25 : Jet := ⟨⟨143, 144⟩, ⟨286, 288⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852034), (-852032)⟩, ⟨286, 288⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10353), (-10352)⟩, ⟨(-20702), (-20700)⟩, ⟨(-10346), (-10343)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781041, 35781043⟩, ⟨(-20702), (-20700)⟩, ⟨(-10346), (-10343)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨434737, 434738⟩, ⟨869222, 869224⟩, ⟨434107, 434110⟩, ⟨(-504), (-501)⟩, ⟨(-127), (-123)⟩⟩
...
def j33 : Jet := ⟨⟨(-715393146), (-715393144)⟩, ⟨869222, 869224⟩, ⟨434107, 434110⟩, ⟨(-504), (-501)⟩, ⟨(-127), (-123)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8691975), (-8691973)⟩, ⟨(-17373389), (-17373385)⟩, ⟨(-8665580), (-8665575)⟩, ⟨21101, 21105⟩, ⟨5259, 5262⟩⟩
...
def j36 : Jet := ⟨⟨4286275321, 4286275323⟩, ⟨(-17373389), (-17373385)⟩, ⟨(-8665580), (-8665575)⟩, ⟨21101, 21105⟩, ⟨5259, 5262⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨157615046, 157615049⟩, ⟨157231910, 157231914⟩, ⟨(-574372), (-574369)⟩, ⟨(-190904), (-190901)⟩, ⟨414, 417⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303676895, 4303676898⟩, ⟨17443917, 17443923⟩, ⟨8771459, 8771467⟩, ⟨49628, 49636⟩, ⟨12563, 12571⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨157934667, 157934671⟩, ⟨158190904, 158190910⟩, ⟨384948, 384954⟩, ⟨129305, 129312⟩, ⟨741, 750⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-150694297), (-150694296)⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4144272999, 4144273000⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5807578, 5807579⟩, ⟨11634000, 11634004⟩, ⟨5854748, 5854751⟩, ⟨37864, 37870⟩, ⟨9612, 9617⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300774874, 4300774875⟩, ⟨11634000, 11634004⟩, ⟨5854748, 5854751⟩, ⟨37864, 37870⟩, ⟨9612, 9617⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297870104, 4297870105⟩, ⟨5813071, 5813074⟩, ⟨2921465, 2921468⟩, ⟨14966, 14971⟩, ⟨3788, 3793⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4147073958, 4147073961⟩, ⟨(-145187034), (-145187028)⟩, ⟨2615002, 2615007⟩, ⟨(-88064), (-88057)⟩, ⟨3129, 3135⟩⟩
...
def j47 : Jet := ⟨⟨1347705726, 1347705736⟩, ⟨1347705726, 1347705736⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨422892794, 422892802⟩, ⟨845785588, 845785604⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨422892794, 422892802⟩, ⟨845785588, 845785604⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-422892802), (-422892794)⟩, ⟨(-845785604), (-845785588)⟩, ⟨(-422892802), (-422892794)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-211446401), (-211446397)⟩, ⟨(-422892802), (-422892794)⟩, ⟨(-211446401), (-211446397)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4088641402, 4088641406⟩, ⟨(-402577460), (-402577451)⟩, ⟨(-181469359), (-181469353)⟩, ⟨19168883, 19168885⟩, ⟨3995123, 3995124⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3947852710, 3947852718⟩, ⟨(-526927464), (-526927447)⟩, ⟨(-159122523), (-159122508)⟩, ⟨24314262, 24314275⟩, ⟨3110311, 3110324⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 301388593⟩, ⟨150694296, 150694297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 946840190⟩, ⟨473420093, 473420097⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 208734150⟩, ⟨0, 208734152⟩, ⟨52183536, 52183538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4602), 0⟩, ⟨(-4602), 3⟩, ⟨(-1151), (-1145)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108454, 5113057⟩, ⟨(-4602), 3⟩, ⟨(-1151), (-1145)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 248494⟩, ⟨(-224), 248495⟩, ⟨61787, 62125⟩, ⟨(-112), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142917082)⟩, ⟨(-224), 248495⟩, ⟨61787, 62125⟩, ⟨(-112), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6957806), 0⟩, ⟨(-6957817), 12077⟩, ⟨(-1739463), (-1721335)⟩, ⟨(-9), 6041⟩, ⟨743, 756⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424697959, 1431655766⟩, ⟨(-6957817), 12077⟩, ⟨(-1739463), (-1721335)⟩, ⟨(-9), 6041⟩, ⟨743, 756⟩⟩
...
def j72 : Jet := ⟨⟨0, 576⟩, ⟨(-1), 576⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851600)⟩, ⟨(-1), 576⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-41416), 0⟩, ⟨(-41417), 28⟩, ⟨(-10355), (-10311)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35749978, 35791395⟩, ⟨(-41417), 28⟩, ⟨(-10355), (-10311)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1739452⟩, ⟨(-2013), 1739454⟩, ⟨431842, 434865⟩, ⟨(-1009), 2⟩, ⟨(-128), (-123)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714088430)⟩, ⟨(-2013), 1739454⟩, ⟨431842, 434865⟩, ⟨(-1009), 2⟩, ⟨(-128), (-123)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-34789026), 0⟩, ⟨(-34789124), 84537⟩, ⟨(-8697355), (-8570449)⟩, ⟨(-75), 42271⟩, ⟨5189, 5285⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4260178270, 4294967296⟩, ⟨(-34789124), 84537⟩, ⟨(-8697355), (-8570449)⟩, ⟨(-75), 42271⟩, ⟨5189, 5285⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 315613397⟩, ⟨155505886, 157809363⟩, ⟨(-1150409), 1332⟩, ⟨(-191738), (-188405)⟩, ⟨(-1), 833⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4330040413⟩, ⟨(-85924), 35359628⟩, ⟨8569753, 9128735⟩, ⟨(-43322), 146813⟩, ⟨11071, 14607⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 318190727⟩, ⟨155499571, 161696434⟩, ⟨(-1162962), 1971378⟩, ⟨104321, 157824⟩, ⟨(-5619), 7316⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-301388593), 0⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3993578703, 4294967296⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 23573018⟩, ⟨0, 23958416⟩, ⟨5457556, 6379627⟩, ⟨(-87568), 171824⟩, ⟨6184, 13875⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4318540314⟩, ⟨0, 23958416⟩, ⟨5457556, 6379627⟩, ⟨(-87568), 171824⟩, ⟨6184, 13875⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306737677⟩, ⟨0, 11979208⟩, ⟨2704659, 3189814⟩, ⟨(-52681), 85912⟩, ⟨1662, 6233⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3993578703, 4306737677⟩, ⟨(-151107276), (-138715088)⟩, ⟨2094560, 3189814⟩, ⟨(-164600), (-8984)⟩, ⟨(-1470), 8082⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2695411463⟩, ⟨1347705726, 1347705736⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1691571194⟩, ⟨0, 1691571200⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1691571194⟩, ⟨0, 1691571200⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1691571194), 0⟩, ⟨(-1691571200), 0⟩, ⟨(-422892802), (-422892794)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-845785597), 0⟩, ⟨(-845785600), 0⟩, ⟨(-211446401), (-211446397)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3527252134, 4294967296⟩, ⟨(-845785600), 0⟩, ⟨(-211446401), (-90372775)⟩, ⟨0, 41639042⟩, ⟨174639, 5204881⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3279736033, 4306737677⟩, ⟨(-999210756), (-113920096)⟩, ⟨(-210305710), (-51084506)⟩, ⟨2126026, 49184970⟩, ⟨(-1461087), 5215570⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297870104, 4297870105⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2722
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306737677⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2723
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (273381885 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(28069 / 400000), prawitzNormalCorrection
