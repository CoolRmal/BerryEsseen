...
namespace FiniteNormalPanel17_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (55853 / 160000)
def radius : Rat := (7979 / 160000)

def j0 : Jet := ⟨⟨1499292552, 1499292553⟩, ⟨214184650, 214184651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4710166466, 4710166471⟩, ⟨672880922, 672880927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5165503392, 5165503404⟩, ⟨1475858108, 1475858122⟩, ⟨105418436, 105418438⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1292, 1295⟩, ⟨369, 370⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93395), (-93391)⟩, ⟨369, 370⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-112325), (-112320)⟩, ⟨(-31650), (-31646)⟩, ⟨(-2136), (-2131)⟩, ⟨17, 20⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5000731, 5000737⟩, ⟨(-31650), (-31646)⟩, ⟨(-2136), (-2131)⟩, ⟨17, 20⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6014316, 6014324⟩, ⟨1680310, 1680319⟩, ⟨109296, 109306⟩, ⟨(-1491), (-1483)⟩, ⟨(-48), (-43)⟩⟩
...
def j16 : Jet := ⟨⟨(-137151261), (-137151252)⟩, ⟨1680310, 1680319⟩, ⟨109296, 109306⟩, ⟨(-1491), (-1483)⟩, ⟨(-48), (-43)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-164950105), (-164950093)⟩, ⟨(-45107715), (-45107699)⟩, ⟨(-2657485), (-2657467)⟩, ⟨77004, 77021⟩, ⟨2111, 2123⟩⟩
...
def j19 : Jet := ⟨⟨1266705660, 1266705673⟩, ⟨(-45107715), (-45107699)⟩, ⟨(-2657485), (-2657467)⟩, ⟨77004, 77021⟩, ⟨2111, 2123⟩⟩
...
def j22 : Jet := ⟨⟨(-130), (-128)⟩, ⟨(-38), (-36)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11705, 11708⟩, ⟨(-38), (-36)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨14077, 14082⟩, ⟨3976, 3981⟩, ⟨269, 274⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-838100), (-838094)⟩, ⟨3976, 3981⟩, ⟨269, 274⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1007973), (-1007965)⟩, ⟨(-283212), (-283202)⟩, ⟨(-18882), (-18872)⟩, ⟨185, 193⟩, ⟨2, 7⟩⟩
...
def j30 : Jet := ⟨⟨34783421, 34783430⟩, ⟨(-283212), (-283202)⟩, ⟨(-18882), (-18872)⟩, ⟨185, 193⟩, ⟨2, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨41833584, 41833596⟩, ⟨11611836, 11611854⟩, ⟨733717, 733735⟩, ⟨(-13219), (-13202)⟩, ⟨(-399), (-387)⟩⟩
...
def j33 : Jet := ⟨⟨(-673994299), (-673994286)⟩, ⟨11611836, 11611854⟩, ⟨733717, 733735⟩, ⟨(-13219), (-13202)⟩, ⟨(-399), (-387)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-810604507), (-810604489)⟩, ⟨(-217635880), (-217635849)⟩, ⟨(-11670401), (-11670370)⟩, ⟨521232, 521262⟩, ⟨12985, 13009⟩⟩
...
def j36 : Jet := ⟨⟨3484362789, 3484362807⟩, ⟨(-217635880), (-217635849)⟩, ⟨(-11670401), (-11670370)⟩, ⟨521232, 521262⟩, ⟨12985, 13009⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1389159476, 1389159493⟩, ⟨148983025, 148983048⟩, ⟨(-9981291), (-9981268)⟩, ⟨(-331893), (-331871)⟩, ⟨14379, 14396⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5294151354, 5294151382⟩, ⟨330676564, 330676616⟩, ⟨38386294, 38386350⟩, ⟨2713180, 2713237⟩, ⟨228799, 228848⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1712334463, 1712334494⟩, ⟨290596197, 290596246⟩, ⟨11582721, 11582774⟩, ⟨1031501, 1031555⟩, ⟨71079, 71124⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1499292553), (-1499292552)⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2795674743, 2795674744⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨682680242, 682680267⟩, ⟨231712070, 231712114⟩, ⟨28897339, 28897393⟩, ⟨2389850, 2389906⟩, ⟨227494, 227539⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4977647538, 4977647563⟩, ⟨231712070, 231712114⟩, ⟨28897339, 28897393⟩, ⟨2389850, 2389906⟩, ⟨227494, 227539⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4623725055, 4623725067⟩, ⟨107618397, 107618419⟩, ⟨12168911, 12168938⟩, ⟨826727, 826756⟩, ⟨70402, 70425⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3009669332, 3009669342⟩, ⟨(-160528559), (-160528541)⟩, ⟨2554175, 2554196⟩, ⟨(-68718), (-68697)⟩, ⟨4595, 4614⟩⟩
...
def j47 : Jet := ⟨⟨6820576886, 6820576893⟩, ⟨974368125, 974368131⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10831344187, 10831344210⟩, ⟨3094669762, 3094669786⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10831344187, 10831344210⟩, ⟨3094669762, 3094669786⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10831344210), (-10831344187)⟩, ⟨(-3094669786), (-3094669762)⟩, ⟨(-221047843), (-221047839)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5415672105), (-5415672093)⟩, ⟨(-1547334893), (-1547334881)⟩, ⟨(-110523922), (-110523919)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1217146905, 1217146913⟩, ⟨(-438497842), (-438497835)⟩, ⟨47666869, 47666873⟩, ⟨1798413, 1798415⟩, ⟨(-775292), (-775291)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨852907475, 852907484⟩, ⟨(-352766447), (-352766435)⟩, ⟨50515340, 50515354⟩, ⟨(-801618), (-801604)⟩, ⟨(-573837), (-573824)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1285107902, 1713477203⟩, ⟨214184650, 214184651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4037285543, 5383047394⟩, ⟨672880922, 672880927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3795063718, 6746779952⟩, ⟨1265021234, 1686694996⟩, ⟨105418436, 105418438⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨949, 1691⟩, ⟨316, 423⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93738), (-92995)⟩, ⟨316, 423⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-147250), (-82171)⟩, ⟨(-36534), (-26725)⟩, ⟨(-2186), (-2072)⟩, ⟨14, 22⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4965806, 5030886⟩, ⟨(-36534), (-26725)⟩, ⟨(-2186), (-2072)⟩, ⟨14, 22⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4387821, 7902804⟩, ⟨1405217, 1952087⟩, ⟨104101, 113781⟩, ⟨(-1744), (-1230)⟩, ⟨(-50), (-39)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138777756), (-135262772)⟩, ⟨1405217, 1952087⟩, ⟨104101, 113781⟩, ⟨(-1744), (-1230)⟩, ⟨(-50), (-39)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-218000026), (-119519149)⟩, ⟨(-53258348), (-36773266)⟩, ⟨(-2900381), (-2374629)⟩, ⟨62411, 91512⟩, ⟨1791, 2397⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1213655739, 1312136617⟩, ⟨(-53258348), (-36773266)⟩, ⟨(-2900381), (-2374629)⟩, ⟨62411, 91512⟩, ⟨1791, 2397⟩⟩
...
def j70 : Jet := ⟨⟨(-170), (-94)⟩, ⟨(-43), (-31)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11665, 11742⟩, ⟨(-43), (-31)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨10307, 18446⟩, ⟨3367, 4585⟩, ⟨264, 279⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-841870), (-833730)⟩, ⟨3367, 4585⟩, ⟨264, 279⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1322458), (-736689)⟩, ⟨(-327640), (-238360)⟩, ⟨(-19440), (-18223)⟩, ⟨152, 223⟩, ⟨2, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34468936, 35054706⟩, ⟨(-327640), (-238360)⟩, ⟨(-19440), (-18223)⟩, ⟨152, 223⟩, ⟨2, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨30456997, 55065935⟩, ⟨9637656, 13555868⟩, ⟨686820, 774100⟩, ⟨(-15543), (-10866)⟩, ⟨(-433), (-348)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-685370886), (-660761947)⟩, ⟨9637656, 13555868⟩, ⟨686820, 774100⟩, ⟨(-15543), (-10866)⟩, ⟨(-433), (-348)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1076619736), (-583853966)⟩, ⟨(-260639035), (-173323655)⟩, ⟨(-13376672), (-9678581)⟩, ⟨414429, 627124⟩, ⟨10072, 15494⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3218347560, 3711113330⟩, ⟨(-260639035), (-173323655)⟩, ⟨(-13376672), (-9678581)⟩, ⟨414429, 627124⟩, ⟨10072, 15494⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1140840996, 1644551195⟩, ⟨123389432, 171001892⟩, ⟨(-11979001), (-7993328)⟩, ⟨(-395729), (-257330)⟩, ⟨11460, 17342⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4970676568, 5731743925⟩, ⟨232150233, 464187345⟩, ⟨23805853, 61415680⟩, ⟨748691, 6263035⟩, ⟨(-6137), 717034⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1320324746, 2194695716⟩, ⟨204466157, 405944631⟩, ⟨(-2993502), 32746677⟩, ⟨(-939983), 4113497⟩, ⟨(-181643), 488845⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1713477203), (-1285107902)⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2581490093, 3009859394⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨405883750, 1121472867⟩, ⟨125710724, 414869256⟩, ⟨6674499, 71835013⟩, ⟨(-1526520), 10394126⟩, ⟨(-386150), 1526855⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4700851046, 5416440163⟩, ⟨125710724, 414869256⟩, ⟨6674499, 71835013⟩, ⟨(-1526520), 10394126⟩, ⟨(-386150), 1526855⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4493328555, 4823218154⟩, ⟨55971286, 198277276⟩, ⟨(-1184771), 33983299⟩, ⟨(-2229148), 5019916⟩, ⟨(-534575), 832573⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2700715127, 3380050993⟩, ⟨(-206886321), (-85126441)⟩, ⟨(-10718113), 21023854⟩, ⟨(-3256865), 3576979⟩, ⟨(-624961), 694622⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5846208761, 7794945019⟩, ⟨974368125, 974368131⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7957722264, 14147061820⟩, ⟨2652574082, 3536765470⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7957722264, 14147061820⟩, ⟨2652574082, 3536765470⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14147061820), (-7957722264)⟩, ⟨(-3536765470), (-2652574082)⟩, ⟨(-221047843), (-221047839)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7073530910), (-3978861132)⟩, ⟨(-1768382735), (-1326287041)⟩, ⟨(-110523922), (-110523919)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨827380312, 1700705467⟩, ⟨(-700237739), (-255495259)⟩, ⟨(-4316358), 122864464⟩, ⟨(-12479314), 12605375⟩, ⟨(-2878372), 1340076⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨520264386, 1338420251⟩, ⟨(-632994800), (-177056493)⟩, ⟨(-2577079), 138746843⟩, ⟨(-20456585), 13291936⟩, ⟨(-4009674), 3063201⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1499292552, 1499292553⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4623725055, 4623725067⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified344
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1285107902, 1713477203⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4493328555, 4823218154⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified345
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (86807389 / 4294967296)

theorem envelope_integral : (∫ s in ((23937 / 80000) : ℝ)..(7979 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((23937 / 80000) : ℝ)..(7979 / 20000), prawitzNormalCorrection
