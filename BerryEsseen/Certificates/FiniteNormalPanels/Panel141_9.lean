...
namespace FiniteNormalPanel141_9
...
def j2 : Jet := ⟨⟨445590703, 445590707⟩, ⟨445590703, 445590707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨46228774, 46228776⟩, ⟨92457548, 92457552⟩, ⟨46228774, 46228776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨11, 12⟩, ⟨23, 24⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94676), (-94674)⟩, ⟨23, 24⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1020), (-1019)⟩, ⟨(-2039), (-2037)⟩, ⟨(-1020), (-1017)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112036, 5112038⟩, ⟨(-2039), (-2037)⟩, ⟨(-1020), (-1017)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨55023, 55024⟩, ⟨110024, 110026⟩, ⟨54968, 54971⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143110554), (-143110552)⟩, ⟨110024, 110026⟩, ⟨54968, 54971⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1540367), (-1540366)⟩, ⟨(-3079550), (-3079548)⟩, ⟨(-1537408), (-1537405)⟩, ⟨2366, 2369⟩, ⟨589, 592⟩⟩
...
def j19 : Jet := ⟨⟨1430115398, 1430115400⟩, ⟨(-3079550), (-3079548)⟩, ⟨(-1537408), (-1537405)⟩, ⟨2366, 2369⟩, ⟨589, 592⟩⟩
...
def j25 : Jet := ⟨⟨127, 128⟩, ⟨253, 255⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852050), (-852048)⟩, ⟨253, 255⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9172), (-9170)⟩, ⟨(-18341), (-18338)⟩, ⟨(-9166), (-9162)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782222, 35782225⟩, ⟨(-18341), (-18338)⟩, ⟨(-9166), (-9162)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨385141, 385142⟩, ⟨770084, 770086⟩, ⟨384647, 384650⟩, ⟨(-396), (-393)⟩, ⟨(-100), (-96)⟩⟩
...
def j33 : Jet := ⟨⟨(-715442742), (-715442740)⟩, ⟨770084, 770086⟩, ⟨384647, 384650⟩, ⟨(-396), (-393)⟩, ⟨(-100), (-96)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7700651), (-7700650)⟩, ⟨(-15393014), (-15393011)⟩, ⟨(-7679934), (-7679931)⟩, ⟨16563, 16566⟩, ⟨4129, 4132⟩⟩
...
def j36 : Jet := ⟨⟨4287266645, 4287266646⟩, ⟨(-15393014), (-15393011)⟩, ⟨(-7679934), (-7679931)⟩, ⟨16563, 16566⟩, ⟨4129, 4132⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨148370425, 148370428⟩, ⟨148050930, 148050934⟩, ⟨(-478997), (-478995)⟩, ⟨(-159257), (-159255)⟩, ⟨306, 308⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302681777, 4302681779⟩, ⟨15448357, 15448362⟩, ⟨7763009, 7763015⟩, ⟨38918, 38925⟩, ⟨9837, 9845⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨148636923, 148636927⟩, ⟨148850520, 148850526⟩, ⟨320833, 320838⟩, ⟨107674, 107680⟩, ⟨547, 555⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-141835927), (-141835926)⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4153131369, 4153131370⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5143912, 5143913⟩, ⟨10302608, 10302610⟩, ⟨5180912, 5180916⟩, ⟨29690, 29694⟩, ⟨7521, 7528⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300111208, 4300111209⟩, ⟨10302608, 10302610⟩, ⟨5180912, 5180916⟩, ⟨29690, 29694⟩, ⟨7521, 7528⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297538482, 4297538483⟩, ⟨5148222, 5148224⟩, ⟨2585822, 2585825⟩, ⟨11737, 11741⟩, ⟨2965, 2971⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4155617644, 4155617647⟩, ⟨(-136942630), (-136942625)⟩, ⟨2330414, 2330419⟩, ⟨(-74045), (-74039)⟩, ⟨2479, 2486⟩⟩
...
def j47 : Jet := ⟨⟨1610652194, 1610652207⟩, ⟨1610652194, 1610652207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨604009369, 604009380⟩, ⟨1208018738, 1208018760⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨604009369, 604009380⟩, ⟨1208018738, 1208018760⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-604009380), (-604009369)⟩, ⟨(-1208018760), (-1208018738)⟩, ⟨(-604009380), (-604009369)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-302004690), (-302004684)⟩, ⟨(-604009380), (-604009369)⟩, ⟨(-302004690), (-302004684)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4003335924, 4003335930⟩, ⟨(-562996710), (-562996697)⟩, ⟨(-241910711), (-241910701)⟩, ⟨37731882, 37731885⟩, ⟨7178513, 7178515⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3873448213, 3873448223⟩, ⟨(-672374484), (-672374464)⟩, ⟨(-213938939), (-213938921)⟩, ⟨43846366, 43846379⟩, ⟨5623301, 5623318⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 283671853⟩, ⟨141835926, 141835927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 891181410⟩, ⟨445590703, 445590707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 184915100⟩, ⟨0, 184915102⟩, ⟨46228774, 46228776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 47⟩, ⟨0, 47⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94639)⟩, ⟨0, 47⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4077), 0⟩, ⟨(-4077), 3⟩, ⟨(-1020), (-1014)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108979, 5113057⟩, ⟨(-4077), 3⟩, ⟨(-1020), (-1014)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 220138⟩, ⟨(-176), 220139⟩, ⟨54770, 55036⟩, ⟨(-88), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142945438)⟩, ⟨(-176), 220139⟩, ⟨54770, 55036⟩, ⟨(-88), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6163837), 0⟩, ⟨(-6163845), 9478⟩, ⟨(-1540968), (-1526741)⟩, ⟨(-6), 4741⟩, ⟨584, 594⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425491928, 1431655766⟩, ⟨(-6163845), 9478⟩, ⟨(-1540968), (-1526741)⟩, ⟨(-6), 4741⟩, ⟨584, 594⟩⟩
...
def j72 : Jet := ⟨⟨0, 510⟩, ⟨(-1), 510⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851666)⟩, ⟨(-1), 510⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-36690), 0⟩, ⟨(-36691), 22⟩, ⟨(-9174), (-9138)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35754704, 35791395⟩, ⟨(-36691), 22⟩, ⟨(-9174), (-9138)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1540960⟩, ⟨(-1580), 1540961⟩, ⟨382869, 385241⟩, ⟨(-791), 2⟩, ⟨(-101), (-96)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714286922)⟩, ⟨(-1580), 1540961⟩, ⟨382869, 385241⟩, ⟨(-791), 2⟩, ⟨(-101), (-96)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30819184), 0⟩, ⟨(-30819253), 66345⟩, ⟨(-7704866), (-7605277)⟩, ⟨(-53), 33175⟩, ⟨4081, 4148⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264148112, 4294967296⟩, ⟨(-30819253), 66345⟩, ⟨(-7704866), (-7605277)⟩, ⟨(-53), 33175⟩, ⟨4081, 4148⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 297060471⟩, ⟨146611790, 148532203⟩, ⟨(-959225), 984⟩, ⟨(-159874), (-157411)⟩, ⟨(-1), 616⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4326009227⟩, ⟨(-67308), 31266357⟩, ⟨7604794, 8042623⟩, ⟨(-33905), 114679⟩, ⟨8802, 11252⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 299207480⟩, ⟨146607134, 151768253⟩, ⟨(-968486), 1638539⟩, ⟨89236, 128674⟩, ⟨(-4136), 5371⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-283671853), 0⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4011295443, 4294967296⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20844191⟩, ⟨0, 21145772⟩, ⟨4869440, 5591227⟩, ⟨(-68446), 133730⟩, ⟨5144, 10470⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315811487⟩, ⟨0, 21145772⟩, ⟨4869440, 5591227⟩, ⟨(-68446), 133730⟩, ⟨5144, 10470⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305376778⟩, ⟨0, 10572886⟩, ⟨2415850, 2795614⟩, ⟨(-41105), 66865⟩, ⟨1493, 4658⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4011295443, 4305376778⟩, ⟨(-142179688), (-131263040)⟩, ⟨1907132, 2795614⟩, ⟨(-133427), (-12915)⟩, ⟨(-815), 6016⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3221304402⟩, ⟨1610652194, 1610652207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2416037501⟩, ⟨0, 2416037510⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2416037501⟩, ⟨0, 2416037510⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2416037501), 0⟩, ⟨(-2416037510), 0⟩, ⟨(-604009380), (-604009369)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1208018751), 0⟩, ⟨(-1208018755), 0⟩, ⟨(-302004690), (-302004684)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3241966716, 4294967296⟩, ⟨(-1208018755), 0⟩, ⟨(-302004690), (-58075989)⟩, ⟨0, 84942982⟩, ⟨(-3931013), 10617873⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3027842918, 4305376778⟩, ⟨(-1353126254), (-99081175)⟩, ⟨(-301297085), (-11454603)⟩, ⟨855189, 95136606⟩, ⟨(-6949868), 10661365⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297538482, 4297538483⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2836
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305376778⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2837
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (31407795 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(26419 / 400000), prawitzNormalCorrection
