...
namespace FiniteNormalPanel43_20
...
def j2 : Jet := ⟨⟨586407416, 586407420⟩, ⟨586407416, 586407420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨80064325, 80064327⟩, ⟨160128650, 160128654⟩, ⟨80064325, 80064327⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1765), (-1764)⟩, ⟨(-3530), (-3528)⟩, ⟨(-1764), (-1761)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111291, 5111293⟩, ⟨(-3530), (-3528)⟩, ⟨(-1764), (-1761)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨95281, 95282⟩, ⟨190497, 190499⟩, ⟨95116, 95119⟩, ⟨(-132), (-129)⟩, ⟨(-33), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-143070296), (-143070294)⟩, ⟨190497, 190499⟩, ⟨95116, 95119⟩, ⟨(-132), (-129)⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2667035), (-2667034)⟩, ⟨(-5330519), (-5330517)⟩, ⟨(-2658160), (-2658157)⟩, ⟨7094, 7097⟩, ⟨1767, 1770⟩⟩
...
def j19 : Jet := ⟨⟨1428988730, 1428988732⟩, ⟨(-5330519), (-5330517)⟩, ⟨(-2658160), (-2658157)⟩, ⟨7094, 7097⟩, ⟨1767, 1770⟩⟩
...
def j22 : Jet := ⟨⟨(-3), (-1)⟩, ⟨(-5), (-3)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11832, 11835⟩, ⟨(-5), (-3)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨220, 221⟩, ⟨440, 442⟩, ⟨218, 221⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851957), (-851955)⟩, ⟨440, 442⟩, ⟨218, 221⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-15882), (-15881)⟩, ⟨(-31756), (-31754)⟩, ⟨(-15862), (-15859)⟩, ⟨15, 18⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35775512, 35775514⟩, ⟨(-31756), (-31754)⟩, ⟨(-15862), (-15859)⟩, ⟨15, 18⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨666906, 666907⟩, ⟨1333221, 1333223⟩, ⟨665426, 665429⟩, ⟨(-1184), (-1181)⟩, ⟨(-296), (-293)⟩⟩
...
def j33 : Jet := ⟨⟨(-715160977), (-715160975)⟩, ⟨1333221, 1333223⟩, ⟨665426, 665429⟩, ⟨(-1184), (-1181)⟩, ⟨(-296), (-293)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-13331623), (-13331622)⟩, ⟨(-26638392), (-26638390)⟩, ⟨(-13269513), (-13269510)⟩, ⟨49638, 49642⟩, ⟨12353, 12356⟩⟩
...
def j36 : Jet := ⟨⟨4281635673, 4281635674⟩, ⟨(-26638392), (-26638390)⟩, ⟨(-13269513), (-13269510)⟩, ⟨49638, 49642⟩, ⟨12353, 12356⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨195104998, 195105001⟩, ⟨194377202, 194377207⟩, ⟨(-1090725), (-1090721)⟩, ⟨(-361961), (-361958)⟩, ⟨1209, 1211⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4308340428, 4308340430⟩, ⟨26804534, 26804538⟩, ⟨13519036, 13519043⟩, ⟨117227, 117235⟩, ⟨29881, 29889⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨195712491, 195712495⟩, ⟨196200063, 196200070⟩, ⟨733090, 733098⟩, ⟨247258, 247265⟩, ⟨2181, 2188⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-186659279), (-186659278)⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4108308017, 4108308018⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8918200, 8918201⟩, ⟨17880836, 17880838⟩, ⟨9029500, 9029504⟩, ⟨89510, 89514⟩, ⟨22913, 22918⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303885496, 4303885497⟩, ⟨17880836, 17880838⟩, ⟨9029500, 9029504⟩, ⟨89510, 89514⟩, ⟨22913, 22918⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299424083, 4299424085⟩, ⟨8931150, 8931152⟩, ⟨4500793, 4500797⟩, ⟨35358, 35362⟩, ⟨9014, 9019⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4112571112, 4112571115⟩, ⟨(-178309970), (-178309964)⟩, ⟨3917040, 3917046⟩, ⟨(-161784), (-161778)⟩, ⟨7085, 7092⟩⟩
...
def j47 : Jet := ⟨⟨1133716123, 1133716130⟩, ⟨1133716123, 1133716130⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨299260077, 299260082⟩, ⟨598520154, 598520164⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨299260077, 299260082⟩, ⟨598520154, 598520164⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-299260082), (-299260077)⟩, ⟨(-598520164), (-598520154)⟩, ⟨(-299260082), (-299260077)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-149630041), (-149630038)⟩, ⟨(-299260082), (-299260077)⟩, ⟨(-149630041), (-149630038)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4147913688, 4147913692⟩, ⟨(-289013841), (-289013835)⟩, ⟨(-134438125), (-134438120)⟩, ⟨9834941, 9834943⟩, ⟨2170491, 2170492⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3971762491, 3971762499⟩, ⟨(-448945058), (-448945044)⟩, ⟨(-112947254), (-112947241)⟩, ⟨14578783, 14578796⟩, ⟨1565126, 1565139⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 373318558⟩, ⟨186659278, 186659279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1172814840⟩, ⟨586407416, 586407420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 320257305⟩, ⟨0, 320257306⟩, ⟨80064325, 80064327⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-7061), 0⟩, ⟨(-7061), 7⟩, ⟨(-1766), (-1754)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5105995, 5113057⟩, ⟨(-7061), 7⟩, ⟨(-1766), (-1754)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 381259⟩, ⟨(-527), 381260⟩, ⟨94524, 95316⟩, ⟨(-264), 2⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142784317)⟩, ⟨(-527), 381260⟩, ⟨94524, 95316⟩, ⟨(-264), 2⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-10675244), 0⟩, ⟨(-10675284), 28429⟩, ⟨(-2668851), (-2626166)⟩, ⟨(-30), 14217⟩, ⟨1739, 1778⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1420980521, 1431655766⟩, ⟨(-10675284), 28429⟩, ⟨(-2668851), (-2626166)⟩, ⟨(-30), 14217⟩, ⟨1739, 1778⟩⟩
...
def j70 : Jet := ⟨⟨(-9), 0⟩, ⟨(-9), 0⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11826, 11836⟩, ⟨(-9), 0⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 883⟩, ⟨(-1), 883⟩, ⟨218, 221⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851293)⟩, ⟨(-1), 883⟩, ⟨218, 221⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-63544), 0⟩, ⟨(-63545), 66⟩, ⟨(-15887), (-15786)⟩, ⟨(-2), 34⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35727850, 35791395⟩, ⟨(-63545), 66⟩, ⟨(-15887), (-15786)⟩, ⟨(-2), 34⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2668811⟩, ⟨(-4739), 2668816⟩, ⟨660094, 667208⟩, ⟨(-2371), 5⟩, ⟨(-298), (-290)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713159071)⟩, ⟨(-4739), 2668816⟩, ⟨660094, 667208⟩, ⟨(-2371), 5⟩, ⟨(-298), (-290)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-53376218), 0⟩, ⟨(-53376572), 199003⟩, ⟨(-13344409), (-13045549)⟩, ⟨(-266), 99503⟩, ⟨12105, 12439⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4241591078, 4294967296⟩, ⟨(-53376572), 199003⟩, ⟨(-13344409), (-13045549)⟩, ⟨(-266), 99503⟩, ⟨12105, 12439⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 390938281⟩, ⟨191096537, 195476905⟩, ⟨(-2186312), 3882⟩, ⟨(-364397), (-354676)⟩, ⟨(-5), 2428⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4349015201⟩, ⟨(-204044), 54728408⟩, ⟨13043013, 14371084⟩, ⟨(-103341), 353302⟩, ⟨24467, 37407⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 395857852⟩, ⟨191077964, 202918301⟩, ⟨(-2223112), 3802877⟩, ⟨174075, 331659⟩, ⟨(-16670), 21975⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-373318558), 0⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3921648738, 4294967296⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 36485363⟩, ⟨0, 37405084⟩, ⟨8091030, 10288003⟩, ⟨(-210066), 420478⟩, ⟨10445, 38760⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4331452659⟩, ⟨0, 37405084⟩, ⟨8091030, 10288003⟩, ⟨(-210066), 420478⟩, ⟨10445, 38760⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4313171399⟩, ⟨0, 18702542⟩, ⟨3987891, 5144002⟩, ⟨(-127433), 210239⟩, ⟨1220, 18084⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3921648738, 4313171399⟩, ⟨(-187450430), (-167956736)⟩, ⟨2828450, 5144002⟩, ⟨(-350992), 36926⟩, ⟨(-8024), 23623⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2267432260⟩, ⟨1133716123, 1133716130⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1197040327⟩, ⟨0, 1197040328⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1197040327⟩, ⟨0, 1197040328⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1197040327), 0⟩, ⟨(-1197040328), 0⟩, ⟨(-299260082), (-299260077)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-598520164), 0⟩, ⟨(-598520164), 0⟩, ⟨(-149630041), (-149630038)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3736278660, 4294967296⟩, ⟨(-598520164), 0⟩, ⟨(-149630041), (-88463146)⟩, ⟨0, 20851521⟩, ⟨814524, 2606441⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3411521318, 4313171399⟩, ⟨(-788507406), (-146108951)⟩, ⟨(-147803719), (-49507990)⟩, ⟨2391564, 27507311⟩, ⟨(-358704), 2631768⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299424083, 4299424085⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified854
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4313171399⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified855
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (170999445 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(2173 / 25000), prawitzNormalCorrection
