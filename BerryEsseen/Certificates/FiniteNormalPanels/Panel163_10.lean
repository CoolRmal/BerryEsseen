...
namespace FiniteNormalPanel163_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (37387 / 160000)
def radius : Rat := (5341 / 160000)

def j0 : Jet := ⟨⟨1003599639, 1003599640⟩, ⟨143371377, 143371378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3152901252, 3152901257⟩, ⟨450414464, 450414468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2314519673, 2314519682⟩, ⟨661291334, 661291342⟩, ⟨47235095, 47235097⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨579, 580⟩, ⟨165, 166⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94108), (-94106)⟩, ⟨165, 166⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-50714), (-50712)⟩, ⟨(-14402), (-14399)⟩, ⟨(-1005), (-1001)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5062342, 5062345⟩, ⟨(-14402), (-14399)⟩, ⟨(-1005), (-1001)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2728051, 2728053⟩, ⟨771681, 771685⟩, ⟨52914, 52920⟩, ⟨(-313), (-309)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-140437526), (-140437523)⟩, ⟨771681, 771685⟩, ⟨52914, 52920⟩, ⟨(-313), (-309)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-75680534), (-75680531)⟩, ⟨(-21207158), (-21207154)⟩, ⟨(-1397173), (-1397165)⟩, ⟨16464, 16470⟩, ⟨525, 532⟩⟩
...
def j19 : Jet := ⟨⟨1355975231, 1355975235⟩, ⟨(-21207158), (-21207154)⟩, ⟨(-1397173), (-1397165)⟩, ⟨16464, 16470⟩, ⟨525, 532⟩⟩
...
def j25 : Jet := ⟨⟨6345, 6348⟩, ⟨1803, 1806⟩, ⟨124, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845832), (-845828)⟩, ⟨1803, 1806⟩, ⟨124, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-455812), (-455809)⟩, ⟨(-129261), (-129257)⟩, ⟨(-8960), (-8954)⟩, ⟨36, 40⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35335582, 35335586⟩, ⟨(-129261), (-129257)⟩, ⟨(-8960), (-8954)⟩, ⟨36, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19042030, 19042034⟩, ⟨5370922, 5370926⟩, ⟨363880, 363887⟩, ⟨(-2783), (-2777)⟩, ⟨(-95), (-89)⟩⟩
...
def j33 : Jet := ⟨⟨(-696785853), (-696785848)⟩, ⟨5370922, 5370926⟩, ⟨363880, 363887⟩, ⟨(-2783), (-2777)⟩, ⟨(-95), (-89)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-375491700), (-375491695)⟩, ⟨(-104389002), (-104388996)⟩, ⟨(-6640052), (-6640043)⟩, ⟨113594, 113601⟩, ⟨3520, 3528⟩⟩
...
def j36 : Jet := ⟨⟨3919475596, 3919475601⟩, ⟨(-104389002), (-104388996)⟩, ⟨(-6640052), (-6640043)⟩, ⟨113594, 113601⟩, ⟨3520, 3528⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨995410607, 995410612⟩, ⟨126633509, 126633515⟩, ⟨(-3249655), (-3249647)⟩, ⟨(-134436), (-134430)⟩, ⟨2111, 2119⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4706431663, 4706431670⟩, ⟨125348317, 125348327⟩, ⟨11311689, 11311703⟩, ⟨377212, 377225⟩, ⟨21338, 21352⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1090772449, 1090772457⟩, ⟨167816178, 167816189⟩, ⟨2756433, 2756447⟩, ⟨178781, 178796⟩, ⟨5896, 5914⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1003599640), (-1003599639)⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3291367656, 3291367657⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨277018299, 277018304⟩, ⟨85238954, 85238962⟩, ⟨7957115, 7957125⟩, ⟨306210, 306220⟩, ⟨18733, 18748⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4571985595, 4571985600⟩, ⟨85238954, 85238962⟩, ⟨7957115, 7957125⟩, ⟨306210, 306220⟩, ⟨18733, 18748⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4431312289, 4431312293⟩, ⟨41308138, 41308142⟩, ⟨3663608, 3663614⟩, ⟨114242, 114249⟩, ⟨6498, 6507⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3395853084, 3395853089⟩, ⟨(-116267028), (-116267022)⟩, ⟨1428619, 1428625⟩, ⟨(-34750), (-34742)⟩, ⟨1165, 1174⟩⟩
...
def j47 : Jet := ⟨⟨9441637151, 9441637163⟩, ⟨1348805307, 1348805318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20755574128, 20755574182⟩, ⟨5930164034, 5930164092⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20755574128, 20755574182⟩, ⟨5930164034, 5930164092⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20755574182), (-20755574128)⟩, ⟨(-5930164092), (-5930164034)⟩, ⟨(-423583153), (-423583145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10377787091), (-10377787064)⟩, ⟨(-2965082046), (-2965082017)⟩, ⟨(-211791577), (-211791572)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨383343847, 383343858⟩, ⟨(-264646018), (-264646007)⟩, ⟨72447479, 72447487⟩, ⟨(-7971591), (-7971587)⟩, ⟨(-410430), (-410428)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨303094132, 303094142⟩, ⟨(-219621988), (-219621976)⟩, ⟨64572842, 64572853⟩, ⟨(-8355131), (-8355123)⟩, ⟨(-82376), (-82366)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨860228262, 1146971017⟩, ⟨143371377, 143371378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2702486788, 3603315722⟩, ⟨450414464, 450414468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1700463434, 3023046114⟩, ⟨566821144, 755761534⟩, ⟨47235095, 47235097⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨425, 758⟩, ⟨141, 190⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94262), (-93928)⟩, ⟨141, 190⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-66348), (-37187)⟩, ⟨(-16532), (-12261)⟩, ⟨(-1015), (-989)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5046708, 5075870⟩, ⟨(-16532), (-12261)⟩, ⟨(-1015), (-989)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1998092, 3572691⟩, ⟨654393, 888319⟩, ⟨51877, 53815⟩, ⟨(-361), (-259)⟩, ⟨(-12), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141167485), (-139592885)⟩, ⟨654393, 888319⟩, ⟨51877, 53815⟩, ⟨(-361), (-259)⟩, ⟨(-12), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-99361832), (-55267614)⟩, ⟨(-24581372), (-17797287)⟩, ⟨(-1445628), (-1341019)⟩, ⟨13787, 19138⟩, ⟨497, 556⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1332293933, 1376388152⟩, ⟨(-24581372), (-17797287)⟩, ⟨(-1445628), (-1341019)⟩, ⟨13787, 19138⟩, ⟨497, 556⟩⟩
...
def j72 : Jet := ⟨⟨4655, 8302⟩, ⟨1536, 2071⟩, ⟨123, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847522), (-843874)⟩, ⟨1536, 2071⟩, ⟨123, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-596535), (-334106)⟩, ⟨(-148526), (-109910)⟩, ⟨(-9071), (-8824)⟩, ⟨30, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35194859, 35457289⟩, ⟨(-148526), (-109910)⟩, ⟨(-9071), (-8824)⟩, ⟨30, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13934348, 24956889⟩, ⟨4540240, 6195708⟩, ⟨354544, 371954⟩, ⟨(-3220), (-2339)⟩, ⟨(-98), (-86)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701893535), (-690870993)⟩, ⟨4540240, 6195708⟩, ⟨354544, 371954⟩, ⟨(-3220), (-2339)⟩, ⟨(-98), (-86)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-494033221), (-273529640)⟩, ⟨(-121710735), (-86815648)⟩, ⟨(-6979709), (-6246017)⟩, ⟨94455, 132665⟩, ⟨3263, 3749⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3800934075, 4021437656⟩, ⟨(-121710735), (-86815648)⟩, ⟨(-6979709), (-6246017)⟩, ⟨94455, 132665⟩, ⟨3263, 3749⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨838308304, 1154737796⟩, ⟨119095205, 133143787⟩, ⟨(-3790684), (-2710204)⟩, ⟨(-142929), (-124576)⟩, ⟨1757, 2475⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4587101840, 4853213371⟩, ⟨99027325, 155406056⟩, ⟨9262417, 13888326⟩, ⟨193659, 616107⟩, ⟨8913, 38837⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨895328252, 1304826912⟩, ⟨146524342, 192231605⟩, ⟨270419, 5657028⟩, ⟨(-4031), 400647⟩, ⟨(-8446), 23623⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1146971017), (-860228262)⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3147996279, 3434739034⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨186639995, 396411231⟩, ⟨61088884, 116801342⟩, ⟨5111472, 12041041⟩, ⟨16000, 749826⟩, ⟨(-5477), 57670⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4481607291, 4691378527⟩, ⟨61088884, 116801342⟩, ⟨5111472, 12041041⟩, ⟨16000, 749826⟩, ⟨(-5477), 57670⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4387294923, 4488799099⟩, ⟨29225495, 57171669⟩, ⟨2081291, 5796482⟩, ⟨(-67704), 353160⟩, ⟨(-11114), 28618⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3215667813, 3589748750⟩, ⟨(-128420900), (-100732489)⟩, ⟨(-382980), 3659937⟩, ⟨(-247638), 212951⟩, ⟨(-20678), 25148⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8092831844, 10790442471⟩, ⟨1348805307, 1348805318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15248993238, 27109321375⟩, ⟨5082997744, 6777330390⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15248993238, 27109321375⟩, ⟨5082997744, 6777330390⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-27109321375), (-15248993238)⟩, ⟨(-6777330390), (-5082997744)⟩, ⟨(-423583153), (-423583145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13554660688), (-7624496619)⟩, ⟨(-3388665195), (-2541498872)⟩, ⟨(-211791577), (-211791572)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨182958406, 727768329⟩, ⟨(-574198367), (-108263590)⟩, ⟨(-3855515), 217495013⟩, ⟨(-53641011), 19890397⟩, ⟨(-9285817), 10675551⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨136982057, 608271326⟩, ⟨(-501677519), (-85348635)⟩, ⟨(-748176), 199571977⟩, ⟨(-51867780), 16827031⟩, ⟨(-8407217), 10749255⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1003599639, 1003599640⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4431312289, 4431312293⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3296
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨860228262, 1146971017⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4387294923, 4488799099⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3297
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (5453967 / 1073741824)

theorem envelope_integral : (∫ s in ((16023 / 80000) : ℝ)..(5341 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((16023 / 80000) : ℝ)..(5341 / 20000), prawitzNormalCorrection
