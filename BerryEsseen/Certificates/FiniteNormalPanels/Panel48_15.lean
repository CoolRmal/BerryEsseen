...
namespace FiniteNormalPanel48_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (110529 / 800000)
def radius : Rat := (36843 / 800000)

def j0 : Jet := ⟨⟨593398050, 593398051⟩, ⟨197799350, 197799351⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1864214954, 1864214958⟩, ⟨621404984, 621404989⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨809155729, 809155733⟩, ⟨539437152, 539437158⟩, ⟨89906191, 89906194⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨202, 203⟩, ⟨135, 136⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94485), (-94483)⟩, ⟨135, 136⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-17801), (-17800)⟩, ⟨(-11843), (-11840)⟩, ⟨(-1958), (-1954)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5095255, 5095257⟩, ⟨(-11843), (-11840)⟩, ⟨(-1958), (-1954)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨959926, 959928⟩, ⟨637719, 637722⟩, ⟨104801, 104804⟩, ⟨(-494), (-490)⟩, ⟨(-41), (-38)⟩⟩
...
def j16 : Jet := ⟨⟨(-142205651), (-142205648)⟩, ⟨637719, 637722⟩, ⟨104801, 104804⟩, ⟨(-494), (-490)⟩, ⟨(-41), (-38)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-26791012), (-26791010)⟩, ⟨(-17740532), (-17740528)⟩, ⟨(-2876941), (-2876936)⟩, ⟨26417, 26422⟩, ⟨2122, 2126⟩⟩
...
def j19 : Jet := ⟨⟨1404864753, 1404864756⟩, ⟨(-17740532), (-17740528)⟩, ⟨(-2876941), (-2876936)⟩, ⟨26417, 26422⟩, ⟨2122, 2126⟩⟩
...
def j22 : Jet := ⟨⟨(-21), (-20)⟩, ⟨(-14), (-13)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11814, 11816⟩, ⟨(-14), (-13)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2225, 2227⟩, ⟨1480, 1483⟩, ⟨244, 247⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849952), (-849949)⟩, ⟨1480, 1483⟩, ⟨244, 247⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-160128), (-160127)⟩, ⟨(-106474), (-106471)⟩, ⟨(-17562), (-17557)⟩, ⟨59, 64⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35631266, 35631268⟩, ⟨(-106474), (-106471)⟩, ⟨(-17562), (-17557)⟩, ⟨59, 64⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6712796, 6712798⟩, ⟨4455137, 4455141⟩, ⟨729184, 729188⟩, ⟨(-4424), (-4420)⟩, ⟨(-361), (-356)⟩⟩
...
def j33 : Jet := ⟨⟨(-709115087), (-709115084)⟩, ⟨4455137, 4455141⟩, ⟨729184, 729188⟩, ⟨(-4424), (-4420)⟩, ⟨(-361), (-356)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-133594624), (-133594622)⟩, ⟨(-88223752), (-88223749)⟩, ⟨(-14146919), (-14146914)⟩, ⟨184008, 184013⟩, ⟨14638, 14643⟩⟩
...
def j36 : Jet := ⟨⟨4161372672, 4161372674⟩, ⟨(-88223752), (-88223749)⟩, ⟨(-14146919), (-14146914)⟩, ⟨184008, 184013⟩, ⟨14638, 14643⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨609776443, 609776446⟩, ⟨195558600, 195558606⟩, ⟨(-3815464), (-3815460)⟩, ⟨(-404776), (-404772)⟩, ⟨4743, 4746⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4432850772, 4432850775⟩, ⟨93979256, 93979262⟩, ⟨17062243, 17062253⟩, ⟨485201, 485211⟩, ⟨48534, 48545⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨629352400, 629352404⟩, ⟨215179386, 215179395⟩, ⟨2763517, 2763527⟩, ⟨344505, 344515⟩, ⟨9861, 9872⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-593398051), (-593398050)⟩, ⟨(-197799351), (-197799350)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3701569245, 3701569246⟩, ⟨(-197799351), (-197799350)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨92220595, 92220598⟩, ⟨63061556, 63061562⟩, ⟨11590453, 11590459⟩, ⟨377868, 377874⟩, ⟨39184, 39195⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4387187891, 4387187894⟩, ⟨63061556, 63061562⟩, ⟨11590453, 11590459⟩, ⟨377868, 377874⟩, ⟨39184, 39195⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4340832698, 4340832700⟩, ⟨31197622, 31197626⟩, ⟨5621884, 5621889⟩, ⟨146532, 146537⟩, ⟨14690, 14698⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3741097825, 3741097829⟩, ⟨(-173024306), (-173024300)⟩, ⟨3408389, 3408395⟩, ⟨(-132624), (-132616)⟩, ⟨5911, 5920⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨23027412486, 23027412491⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value291

def j47 : Jet := ⟨⟨3181496091, 3181496098⟩, ⟨1060498697, 1060498703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2356692537, 2356692549⟩, ⟨1571128358, 1571128372⟩, ⟨261854726, 261854730⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2356692537, 2356692549⟩, ⟨1571128358, 1571128372⟩, ⟨261854726, 261854730⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2356692549), (-2356692537)⟩, ⟨(-1571128372), (-1571128358)⟩, ⟨(-261854730), (-261854726)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1178346275), (-1178346268)⟩, ⟨(-785564186), (-785564179)⟩, ⟨(-130927365), (-130927363)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3264441915, 3264441925⟩, ⟨(-597077577), (-597077569)⟩, ⟨(-44909168), (-44909164)⟩, ⟨14872182, 14872184⟩, ⟨4459, 4461⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2843466714, 2843466727⟩, ⟨(-651588996), (-651588981)⟩, ⟨(-12473711), (-12473699)⟩, ⟨14188847, 14188861⟩, ⟨(-607960), (-607945)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨395598700, 791197401⟩, ⟨197799350, 197799351⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1242809969, 2485619943⟩, ⟨621404984, 621404989⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨359624768, 1438499080⟩, ⟨359624768, 719249544⟩, ⟨89906191, 89906194⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨90, 361⟩, ⟨90, 181⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94597), (-94325)⟩, ⟨90, 181⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-31684), (-7897)⟩, ⟨(-15835), (-7836)⟩, ⟨(-1973), (-1935)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5081372, 5105160⟩, ⟨(-15835), (-7836)⟩, ⟨(-1973), (-1935)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨425471, 1709855⟩, ⟨420167, 854272⟩, ⟨103054, 106048⟩, ⟨(-663), (-323)⟩, ⟨(-42), (-37)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142740106), (-141455721)⟩, ⟨420167, 854272⟩, ⟨103054, 106048⟩, ⟨(-663), (-323)⟩, ⟨(-42), (-37)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-47807468), (-11844323)⟩, ⟨(-23868554), (-11558204)⟩, ⟨(-2944158), (-2782501)⟩, ⟨17200, 35616⟩, ⟨2030, 2190⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1383848297, 1419811443⟩, ⟨(-23868554), (-11558204)⟩, ⟨(-2944158), (-2782501)⟩, ⟨17200, 35616⟩, ⟨2030, 2190⟩⟩
...
def j70 : Jet := ⟨⟨(-37), (-8)⟩, ⟨(-19), (-8)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11798, 11828⟩, ⟨(-19), (-8)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨987, 3962⟩, ⟨980, 1981⟩, ⟨240, 248⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851190), (-848214)⟩, ⟨980, 1981⟩, ⟨240, 248⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-285087), (-71022)⟩, ⟨(-142462), (-70358)⟩, ⟨(-17716), (-17339)⟩, ⟨39, 84⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35506307, 35720373⟩, ⟨(-142462), (-70358)⟩, ⟨(-17716), (-17339)⟩, ⟨39, 84⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2973002, 11963706⟩, ⟨2925287, 5975962⟩, ⟨713458, 740390⟩, ⟨(-5947), (-2894)⟩, ⟨(-368), (-344)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712854881), (-703864176)⟩, ⟨2925287, 5975962⟩, ⟨713458, 740390⟩, ⟨(-5947), (-2894)⟩, ⟨(-368), (-344)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-238754110), (-58935720)⟩, ⟨(-119132117), (-56934210)⟩, ⟨(-14617455), (-13485197)⟩, ⟨118981, 248842⟩, ⟨13814, 15229⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4056213186, 4236031576⟩, ⟨(-119132117), (-56934210)⟩, ⟨(-14617455), (-13485197)⟩, ⟨118981, 248842⟩, ⟨13814, 15229⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨400436217, 821685335⟩, ⟨186404695, 202076805⟩, ⟨(-5157223), (-2477421)⟩, ⟨(-420991), (-381966)⟩, ⟨3075, 6421⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4354722986, 4547774791⟩, ⟨58529476, 133569420⟩, ⟨14649706, 20311878⟩, ⟨116066, 950177⟩, ⟨23998, 84560⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨406007468, 870050829⟩, ⟨194455061, 239524952⟩, ⟨(-1554716), 7658446⟩, ⟨40471, 716410⟩, ⟨(-27092), 54028⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-791197401), (-395598700)⟩, ⟨(-197799351), (-197799350)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3503769895, 3899368596⟩, ⟨(-197799351), (-197799350)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨38380283, 176250107⟩, ⟨36764054, 97043294⟩, ⟨8174079, 16460819⟩, ⟨(-165760), 1144458⟩, ⟨(-10087), 115454⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4333347579, 4471217403⟩, ⟨36764054, 97043294⟩, ⟨8174079, 16460819⟩, ⟨(-165760), 1144458⟩, ⟨(-10087), 115454⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4314114756, 4382206353⟩, ⟨18016085, 48306292⟩, ⟨3739429, 8156262⟩, ⟨(-173841), 554074⟩, ⟨(-18936), 57798⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3519390105, 3978572282⟩, ⟨(-187119786), (-154824241)⟩, ⟨825884, 6575302⟩, ⟨(-533456), 330826⟩, ⟨(-42710), 60482⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2120997394, 4241994796⟩, ⟨1060498697, 1060498703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1047418905, 4189675639⟩, ⟨1047418904, 2094837828⟩, ⟨261854726, 261854730⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1047418905, 4189675639⟩, ⟨1047418904, 2094837828⟩, ⟨261854726, 261854730⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4189675639), (-1047418905)⟩, ⟨(-2094837828), (-1047418904)⟩, ⟨(-261854730), (-261854726)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2094837820), (-523709452)⟩, ⟨(-1047418914), (-523709452)⟩, ⟨(-130927365), (-130927363)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2637157155, 3801928098⟩, ⟨(-927180844), (-321563363)⟩, ⟨(-96292595), 32665522⟩, ⟨3879610, 26670392⟩, ⟨(-2123922), 1349422⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2160944230, 3521853534⟩, ⟨(-1024518158), (-358559836)⟩, ⟨(-77100300), 76474355⟩, ⟨(-135779), 29131896⟩, ⟨(-3386060), 1328873⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨593398050, 593398051⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨197799350, 197799351⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4340832698, 4340832700⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar291 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified938
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar291 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨395598700, 791197401⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4314114756, 4382206353⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified939
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((36843 / 400000) : ℝ)..(36843 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (36843 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (36843 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((36843 / 400000) : ℝ)..(36843 / 200000), prawitzNormalCorrection
      ((239773 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
