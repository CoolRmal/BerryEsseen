...
namespace FiniteNormalPanel113_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (196049 / 800000)
def radius : Rat := (28007 / 800000)

def j0 : Jet := ⟨⟨1052530054, 1052530055⟩, ⟨150361436, 150361437⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3306620685, 3306620689⟩, ⟨472374382, 472374386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2545709804, 2545709811⟩, ⟨727345654, 727345664⟩, ⟨51953260, 51953262⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨637, 638⟩, ⟨182, 183⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94050), (-94048)⟩, ⟨182, 183⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-55746), (-55744)⟩, ⟨(-15821), (-15817)⟩, ⟨(-1101), (-1097)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5057310, 5057313⟩, ⟨(-15821), (-15817)⟩, ⟨(-1101), (-1097)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2997565, 2997567⟩, ⟨847069, 847073⟩, ⟨57841, 57847⟩, ⟨(-377), (-372)⟩, ⟨(-14), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140168012), (-140168009)⟩, ⟨847069, 847073⟩, ⟨57841, 57847⟩, ⟨(-377), (-372)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-83080280), (-83080277)⟩, ⟨(-23235149), (-23235144)⟩, ⟨(-1517784), (-1517776)⟩, ⟨19817, 19824⟩, ⟨626, 633⟩⟩
...
def j19 : Jet := ⟨⟨1348575485, 1348575489⟩, ⟨(-23235149), (-23235144)⟩, ⟨(-1517784), (-1517776)⟩, ⟨19817, 19824⟩, ⟨626, 633⟩⟩
...
def j25 : Jet := ⟨⟨6976, 6979⟩, ⟨1981, 1984⟩, ⟨136, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845201), (-845197)⟩, ⟨1981, 1984⟩, ⟨136, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-500967), (-500964)⟩, ⟨(-141960), (-141956)⟩, ⟨(-9809), (-9804)⟩, ⟨44, 48⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35290427, 35290431⟩, ⟨(-141960), (-141956)⟩, ⟨(-9809), (-9804)⟩, ⟨44, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20917315, 20917318⟩, ⟨5892232, 5892237⟩, ⟨397028, 397034⟩, ⟨(-3354), (-3348)⟩, ⟨(-113), (-107)⟩⟩
...
def j33 : Jet := ⟨⟨(-694910568), (-694910564)⟩, ⟨5892232, 5892237⟩, ⟨397028, 397034⟩, ⟨(-3354), (-3348)⟩, ⟨(-113), (-107)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-411886874), (-411886869)⟩, ⟨(-114189526), (-114189519)⟩, ⟨(-7172690), (-7172683)⟩, ⟨136522, 136529⟩, ⟨4167, 4174⟩⟩
...
def j36 : Jet := ⟨⟨3883080422, 3883080427⟩, ⟨(-114189526), (-114189519)⟩, ⟨(-7172690), (-7172683)⟩, ⟨136522, 136529⟩, ⟨4167, 4174⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1038244830, 1038244836⟩, ⟨130432351, 130432359⟩, ⟨(-3723993), (-3723985)⟩, ⟨(-151675), (-151666)⟩, ⟨2660, 2669⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4750543909, 4750543916⟩, ⟨139698966, 139698976⟩, ⟨12883148, 12883159⟩, ⟨469870, 469883⟩, ⟨27595, 27608⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1148373739, 1148373748⟩, ⟨178037755, 178037768⟩, ⟨3237772, 3237788⟩, ⟨215935, 215953⟩, ⟨7776, 7794⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1052530055), (-1052530054)⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3242437241, 3242437242⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨307048262, 307048268⟩, ⟨95206258, 95206266⟩, ⟨9111543, 9111555⟩, ⟨383898, 383912⟩, ⟨24500, 24513⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4602015558, 4602015564⟩, ⟨95206258, 95206266⟩, ⟨9111543, 9111555⟩, ⟨383898, 383912⟩, ⟨24500, 24513⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4445841463, 4445841467⟩, ⟨45987668, 45987673⟩, ⟨4163318, 4163326⟩, ⟨142368, 142377⟩, ⟨8411, 8420⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3356337996, 3356338001⟩, ⟨(-120925482), (-120925474)⟩, ⟨1533079, 1533087⟩, ⟨(-38274), (-38266)⟩, ⟨1364, 1373⟩⟩
...
def j47 : Jet := ⟨⟨10450004265, 10450004277⟩, ⟨1492857749, 1492857760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨25425709117, 25425709177⟩, ⟨7264488304, 7264488366⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨25425709117, 25425709177⟩, ⟨7264488304, 7264488366⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-25425709177), (-25425709117)⟩, ⟨(-7264488366), (-7264488304)⟩, ⟨(-518892029), (-518892020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12712854589), (-12712854558)⟩, ⟨(-3632244183), (-3632244152)⟩, ⟨(-259446015), (-259446010)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨222573436, 222573441⟩, ⟨(-188229859), (-188229852)⟩, ⟨66147790, 66147796⟩, ⟨(-11066750), (-11066746)⟩, ⟨341886, 341888⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨173931866, 173931872⟩, ⟨(-153360384), (-153360375)⟩, ⟨57070828, 57070837⟩, ⟨(-10579780), (-10579772)⟩, ⟨604112, 604121⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨902168617, 1202891491⟩, ⟨150361436, 150361437⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2834246299, 3778995072⟩, ⟨472374382, 472374386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1870317404, 3325008730⟩, ⟨623439132, 831252188⟩, ⟨51953260, 51953262⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨468, 834⟩, ⟨156, 209⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94219), (-93852)⟩, ⟨156, 209⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-72941), (-40869)⟩, ⟨(-18169), (-13461)⟩, ⟨(-1113), (-1083)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5040115, 5072188⟩, ⟨(-18169), (-13461)⟩, ⟨(-1113), (-1083)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2194804, 3926705⟩, ⟨717535, 975816⟩, ⟨56587, 58931⟩, ⟨(-436), (-314)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140970773), (-139238871)⟩, ⟨717535, 975816⟩, ⟨56587, 58931⟩, ⟨(-436), (-314)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-109134487), (-60633961)⟩, ⟨(-26971160), (-19455878)⟩, ⟨(-1576432), (-1449792)⟩, ⟨16554, 23074⟩, ⟨588, 664⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1322521278, 1371021805⟩, ⟨(-26971160), (-19455878)⟩, ⟨(-1576432), (-1449792)⟩, ⟨16554, 23074⟩, ⟨588, 664⟩⟩
...
def j72 : Jet := ⟨⟨5117, 9128⟩, ⟨1688, 2276⟩, ⟨135, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847060), (-843048)⟩, ⟨1688, 2276⟩, ⟨135, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-655764), (-367119)⟩, ⟨(-163206), (-120611)⟩, ⟨(-9944), (-9646)⟩, ⟨37, 56⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35135630, 35424276⟩, ⟨(-163206), (-120611)⟩, ⟨(-9944), (-9646)⟩, ⟨37, 56⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15300414, 27424197⟩, ⟨4973789, 6803528⟩, ⟨385724, 406797⟩, ⟨(-3884), (-2814)⟩, ⟨(-117), (-103)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700527469), (-688403685)⟩, ⟨4973789, 6803528⟩, ⟨385724, 406797⟩, ⟨(-3884), (-2814)⟩, ⟨(-117), (-103)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-542323094), (-299777228)⟩, ⟨(-133414854), (-94658696)⟩, ⟨(-7583856), (-6695455)⟩, ⟨113147, 159805⟩, ⟨3822, 4469⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3752644202, 3995190068⟩, ⟨(-133414854), (-94658696)⟩, ⟨(-7583856), (-6695455)⟩, ⟨113147, 159805⟩, ⟨3822, 4469⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨872730984, 1206315273⟩, ⟨121724160, 137950488⟩, ⟨(-4353425), (-3096536)⟩, ⟨(-162459), (-139149)⟩, ⟨2208, 3123⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4617238168, 4915665617⟩, ⟨109396983, 174762855⟩, ⟨10329891, 16147459⟩, ⟨231459, 788050⟩, ⟨10305, 52653⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨938215947, 1380649049⟩, ⟨153086979, 206971909⟩, ⟨216878, 6819634⟩, ⟨(-23288), 511520⟩, ⟨(-11954), 32685⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1202891491), (-902168617)⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3092075805, 3392798679⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨204948979, 443819863⟩, ⟨66882298, 133065308⟩, ⟨5551283, 14358297⟩, ⟨486, 986134⟩, ⟨(-9922), 81143⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4499916275, 4738787159⟩, ⟨66882298, 133065308⟩, ⟨5551283, 14358297⟩, ⟨486, 986134⟩, ⟨(-9922), 81143⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4396247631, 4511422822⟩, ⟨31836661, 64999882⟩, ⟨2174213, 6898480⟩, ⟨(-101760), 465964⟩, ⟨(-17150), 40605⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3164990556, 3563787181⟩, ⟨(-135019108), (-102560638)⟩, ⟨(-710284), 4334877⟩, ⟨(-321894), 291972⟩, ⟨(-29861), 35639⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8957146505, 11942862027⟩, ⟨1492857749, 1492857760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨18680112788, 33209089515⟩, ⟨6226704254, 8302272416⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨18680112788, 33209089515⟩, ⟨6226704254, 8302272416⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-33209089515), (-18680112788)⟩, ⟨(-8302272416), (-6226704254)⟩, ⟨(-518892029), (-518892020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-16604544758), (-9340056394)⟩, ⟨(-4151136208), (-3113352127)⟩, ⟨(-259446015), (-259446010)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨89940861, 488113465⟩, ⟨(-471767383), (-65196671)⟩, ⟨(-5855458), 222551296⟩, ⟨(-69073923), 20885153⟩, ⟨(-11768263), 16867045⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨66278031, 405016474⟩, ⟨(-406797789), (-50191590)⟩, ⟨(-3382494), 199987317⟩, ⟨(-64823688), 17624918⟩, ⟨(-10493649), 16431059⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1052530054, 1052530055⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4445841463, 4445841467⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2274
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨902168617, 1202891491⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4396247631, 4511422822⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2275
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (13740353 / 4294967296)

theorem envelope_integral : (∫ s in ((84021 / 400000) : ℝ)..(28007 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((84021 / 400000) : ℝ)..(28007 / 100000), prawitzNormalCorrection
