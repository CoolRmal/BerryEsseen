...
namespace FiniteNormalPanel98_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (30209 / 800000)
def radius : Rat := (30209 / 800000)

def j0 : Jet := ⟨⟨162183333, 162183334⟩, ⟨162183333, 162183334⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨509513967, 509513971⟩, ⟨509513967, 509513971⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨60443878, 60443880⟩, ⟨120887756, 120887760⟩, ⟨60443878, 60443880⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨15, 16⟩, ⟨30, 31⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94672), (-94670)⟩, ⟨30, 31⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1333), (-1332)⟩, ⟨(-2665), (-2663)⟩, ⟨(-1333), (-1330)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111723, 5111725⟩, ⟨(-2665), (-2663)⟩, ⟨(-1333), (-1330)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨71938, 71939⟩, ⟨143838, 143840⟩, ⟨71843, 71847⟩, ⟨(-76), (-73)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-143093639), (-143093637)⟩, ⟨143838, 143840⟩, ⟨71843, 71847⟩, ⟨(-76), (-73)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2013784), (-2013783)⟩, ⟨(-4025544), (-4025542)⟩, ⟨(-2008725), (-2008722)⟩, ⟨4044, 4047⟩, ⟨1007, 1010⟩⟩
...
def j19 : Jet := ⟨⟨1429641981, 1429641983⟩, ⟨(-4025544), (-4025542)⟩, ⟨(-2008725), (-2008722)⟩, ⟨4044, 4047⟩, ⟨1007, 1010⟩⟩
...
def j25 : Jet := ⟨⟨166, 167⟩, ⟨332, 334⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852011), (-852009)⟩, ⟨332, 334⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11991), (-11990)⟩, ⟨(-23978), (-23975)⟩, ⟨(-11980), (-11977)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779403, 35779405⟩, ⟨(-23978), (-23975)⟩, ⟨(-11980), (-11977)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨503530, 503531⟩, ⟨1006722, 1006724⟩, ⟨502686, 502689⟩, ⟨(-676), (-673)⟩, ⟨(-169), (-166)⟩⟩
...
def j33 : Jet := ⟨⟨(-715324353), (-715324351)⟩, ⟨1006722, 1006724⟩, ⟨502686, 502689⟩, ⟨(-676), (-673)⟩, ⟨(-169), (-166)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10066894), (-10066893)⟩, ⟨(-20119621), (-20119618)⟩, ⟨(-10031485), (-10031482)⟩, ⟨28305, 28308⟩, ⟨7051, 7055⟩⟩
...
def j36 : Jet := ⟨⟨4284900402, 4284900403⟩, ⟨(-20119621), (-20119618)⟩, ⟨(-10031485), (-10031482)⟩, ⟨28305, 28308⟩, ⟨7051, 7055⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨169599092, 169599095⟩, ⟨169121539, 169121544⟩, ⟨(-715849), (-715846)⟩, ⟨(-237817), (-237814)⟩, ⟨598, 601⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305057840, 4305057842⟩, ⟨20214265, 20214270⟩, ⟨10173586, 10173593⟩, ⟨66651, 66658⟩, ⟨16906, 16915⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨169997546, 169997550⟩, ⟨170317089, 170317096⟩, ⟨480172, 480178⟩, ⟨161487, 161495⟩, ⟨1074, 1082⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-162183334), (-162183333)⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4132783962, 4132783963⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6728611, 6728612⟩, ⟨13482518, 13482520⟩, ⟨6791940, 6791944⟩, ⟨50864, 50870⟩, ⟨12943, 12950⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301695907, 4301695908⟩, ⟨13482518, 13482520⟩, ⟨6791940, 6791944⟩, ⟨50864, 50870⟩, ⟨12943, 12950⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298330284, 4298330286⟩, ⟨6735984, 6735986⟩, ⟨3388034, 3388038⟩, ⟨20102, 20107⟩, ⟨5099, 5105⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4136019959, 4136019963⟩, ⟨(-155828701), (-155828696)⟩, ⟨3005737, 3005743⟩, ⟨(-108595), (-108588)⟩, ⟨4146, 4154⟩⟩
...
def j47 : Jet := ⟨⟨1286628656, 1286628665⟩, ⟨1286628656, 1286628665⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨385430943, 385430950⟩, ⟨770861886, 770861900⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨385430943, 385430950⟩, ⟨770861886, 770861900⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-385430950), (-385430943)⟩, ⟨(-770861900), (-770861886)⟩, ⟨(-385430950), (-385430943)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-192715475), (-192715471)⟩, ⟨(-385430950), (-385430943)⟩, ⟨(-192715475), (-192715471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4106511451, 4106511456⟩, ⟨(-368518898), (-368518890)⟩, ⟨(-167723982), (-167723976)⟩, ⟨16040835, 16040837⟩, ⟨3403016, 3403017⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3954538452, 3954538461⟩, ⟨(-503872025), (-503872010)⟩, ⟨(-145272545), (-145272530)⟩, ⟨21170776, 21170790⟩, ⟨2590990, 2591004⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 324366668⟩, ⟨162183333, 162183334⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1019027942⟩, ⟨509513967, 509513971⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 241775519⟩, ⟨0, 241775520⟩, ⟨60443878, 60443880⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 61⟩, ⟨0, 61⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94625)⟩, ⟨0, 61⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5331), 0⟩, ⟨(-5331), 4⟩, ⟨(-1333), (-1326)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107725, 5113057⟩, ⟨(-5331), 4⟩, ⟨(-1333), (-1326)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 287829⟩, ⟨(-301), 287830⟩, ⟨71504, 71959⟩, ⟨(-152), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142877747)⟩, ⟨(-301), 287830⟩, ⟨71504, 71959⟩, ⟨(-152), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8059184), 0⟩, ⟨(-8059202), 16203⟩, ⟨(-2014814), (-1990491)⟩, ⟨(-14), 8103⟩, ⟨995, 1014⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423596581, 1431655766⟩, ⟨(-8059202), 16203⟩, ⟨(-2014814), (-1990491)⟩, ⟨(-14), 8103⟩, ⟨995, 1014⟩⟩
...
def j72 : Jet := ⟨⟨0, 667⟩, ⟨(-1), 667⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851509)⟩, ⟨(-1), 667⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-47972), 0⟩, ⟨(-47973), 38⟩, ⟨(-11994), (-11935)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35743422, 35791395⟩, ⟨(-47973), 38⟩, ⟨(-11994), (-11935)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2014797⟩, ⟨(-2701), 2014800⟩, ⟨499646, 503703⟩, ⟨(-1353), 3⟩, ⟨(-170), (-164)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713813085)⟩, ⟨(-2701), 2014800⟩, ⟨499646, 503703⟩, ⟨(-1353), 3⟩, ⟨(-170), (-164)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-40295920), 0⟩, ⟨(-40296074), 113419⟩, ⟨(-10074134), (-9903851)⟩, ⟨(-116), 56711⟩, ⟨6944, 7090⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4254671376, 4294967296⟩, ⟨(-40296074), 113419⟩, ⟨(-10074134), (-9903851)⟩, ⟨(-116), 56711⟩, ⟨6944, 7090⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 339675981⟩, ⟨166969790, 169841836⟩, ⟨(-1434104), 1923⟩, ⟨(-239023), (-234209)⟩, ⟨(-2), 1203⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4335644858⟩, ⟨(-115579), 41062976⟩, ⟨9902766, 10654771⟩, ⟨(-58351), 198260⟩, ⟨14585, 20100⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 342893047⟩, ⟨166960649, 174697953⟩, ⟨(-1452258), 2468407⟩, ⟨125362, 202847⟩, ⟨(-8155), 10658⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-324366668), 0⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3970600628, 4294967296⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 27375213⟩, ⟨0, 27894376⟩, ⟨6258468, 7499982⟩, ⟨(-118142), 233196⟩, ⟨7607, 19623⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4322342509⟩, ⟨0, 27894376⟩, ⟨6258468, 7499982⟩, ⟨(-118142), 233196⟩, ⟨7607, 19623⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4308633162⟩, ⟨0, 13947188⟩, ⟨3096734, 3749991⟩, ⟨(-71249), 116598⟩, ⟨1781, 8928⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3970600628, 4308633162⟩, ⟨(-162699375), (-148236145)⟩, ⟨2336196, 3749991⟩, ⟨(-212854), (-338)⟩, ⟨(-2757), 11619⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2573257329⟩, ⟨1286628656, 1286628665⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1541723796⟩, ⟨0, 1541723798⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1541723796⟩, ⟨0, 1541723798⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1541723796), 0⟩, ⟨(-1541723798), 0⟩, ⟨(-385430950), (-385430943)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-770861898), 0⟩, ⟨(-770861899), 0⟩, ⟨(-192715475), (-192715471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3589323227, 4294967296⟩, ⟨(-770861899), 0⟩, ⟨(-192715475), (-91875922)⟩, ⟨0, 34588626⟩, ⟨509245, 4323579⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3318248563, 4308633162⟩, ⟨(-936014028), (-123881604)⟩, ⟨(-191376295), (-51985902)⟩, ⟨2285093, 41998733⟩, ⟨(-1010501), 4337185⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨162183333, 162183334⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298330284, 4298330286⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1982
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 324366668⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4308633162⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1983
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (73766257 / 1073741824)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(30209 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (30209 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(30209 / 400000), prawitzNormalCorrection
