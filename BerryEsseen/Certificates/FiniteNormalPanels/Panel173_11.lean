...
namespace FiniteNormalPanel173_11
...
def j2 : Jet := ⟨⟨465796525, 465796529⟩, ⟨465796525, 465796529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨50516427, 50516429⟩, ⟨101032854, 101032858⟩, ⟨50516427, 50516429⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1114), (-1113)⟩, ⟨(-2228), (-2226)⟩, ⟨(-1114), (-1111)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111942, 5111944⟩, ⟨(-2228), (-2226)⟩, ⟨(-1114), (-1111)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨60125, 60126⟩, ⟨120223, 120226⟩, ⟨60058, 60061⟩, ⟨(-54), (-51)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-143105452), (-143105450)⟩, ⟨120223, 120226⟩, ⟨60058, 60061⟩, ⟨(-54), (-51)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1683174), (-1683173)⟩, ⟨(-3364934), (-3364932)⟩, ⟨(-1679640), (-1679637)⟩, ⟨2825, 2828⟩, ⟨703, 706⟩⟩
...
def j19 : Jet := ⟨⟨1429972591, 1429972593⟩, ⟨(-3364934), (-3364932)⟩, ⟨(-1679640), (-1679637)⟩, ⟨2825, 2828⟩, ⟨703, 706⟩⟩
...
def j25 : Jet := ⟨⟨139, 140⟩, ⟨277, 279⟩, ⟨137, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852038), (-852036)⟩, ⟨277, 279⟩, ⟨137, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10022), (-10021)⟩, ⟨(-20040), (-20038)⟩, ⟨(-10015), (-10012)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781372, 35781374⟩, ⟨(-20040), (-20038)⟩, ⟨(-10015), (-10012)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨420852, 420853⟩, ⟨841468, 841470⟩, ⟨420262, 420265⟩, ⟨(-472), (-469)⟩, ⟨(-119), (-115)⟩⟩
...
def j33 : Jet := ⟨⟨(-715407031), (-715407029)⟩, ⟨841468, 841470⟩, ⟨420262, 420265⟩, ⟨(-472), (-469)⟩, ⟨(-119), (-115)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8414455), (-8414454)⟩, ⟨(-16819013), (-16819011)⟩, ⟨(-8389718), (-8389715)⟩, ⟨19777, 19780⟩, ⟨4929, 4932⟩⟩
...
def j36 : Jet := ⟨⟨4286552841, 4286552842⟩, ⟨(-16819013), (-16819011)⟩, ⟨(-8389718), (-8389715)⟩, ⟨19777, 19780⟩, ⟨4929, 4932⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨155082965, 155082967⟩, ⟨154718032, 154718035⟩, ⟨(-547093), (-547091)⟩, ⟨(-181854), (-181852)⟩, ⟨382, 384⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303398267, 4303398269⟩, ⟨16885106, 16885110⟩, ⟨8488935, 8488941⟩, ⟨46497, 46504⟩, ⟨11767, 11775⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨155387391, 155387394⟩, ⟨155631429, 155631434⟩, ⟨366605, 366611⟩, ⟨123113, 123120⟩, ⟨683, 692⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-148267640), (-148267639)⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4146699656, 4146699657⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5621752, 5621753⟩, ⟨11261162, 11261164⟩, ⟨5665950, 5665953⟩, ⟨35476, 35480⟩, ⟨9001, 9008⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300589048, 4300589049⟩, ⟨11261162, 11261164⟩, ⟨5665950, 5665953⟩, ⟨35476, 35480⟩, ⟨9001, 9008⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297777252, 4297777254⟩, ⟨5626899, 5626901⟩, ⟨2827439, 2827442⟩, ⟨14023, 14027⟩, ⟨3548, 3554⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4149412608, 4149412612⟩, ⟨(-142931993), (-142931988)⟩, ⟨2535584, 2535589⟩, ⟨(-84069), (-84063)⟩, ⟨2940, 2948⟩⟩
...
def j47 : Jet := ⟨⟨1330601103, 1330601113⟩, ⟨1330601103, 1330601113⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨412226490, 412226497⟩, ⟨824452980, 824452994⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨412226490, 412226497⟩, ⟨824452980, 824452994⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-412226497), (-412226490)⟩, ⟨(-824452994), (-824452980)⟩, ⟨(-412226497), (-412226490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-206113249), (-206113245)⟩, ⟨(-412226497), (-412226490)⟩, ⟨(-206113249), (-206113245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4093721508, 4093721512⟩, ⟨(-392911136), (-392911128)⟩, ⟨(-177599968), (-177599962)⟩, ⟨18252353, 18252355⟩, ⟨3823504, 3823505⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3954986957, 3954986966⟩, ⟨(-515830285), (-515830270)⟩, ⟨(-156088734), (-156088720)⟩, ⟨23232036, 23232049⟩, ⟨2992150, 2992162⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 296535280⟩, ⟨148267639, 148267640⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 931593058⟩, ⟨465796525, 465796529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 202065713⟩, ⟨0, 202065714⟩, ⟨50516427, 50516429⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4455), 0⟩, ⟨(-4455), 3⟩, ⟨(-1114), (-1109)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108601, 5113057⟩, ⟨(-4455), 3⟩, ⟨(-1114), (-1109)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 240555⟩, ⟨(-210), 240556⟩, ⟨59823, 60140⟩, ⟨(-106), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142925021)⟩, ⟨(-210), 240556⟩, ⟨59823, 60140⟩, ⟨(-106), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6735524), 0⟩, ⟨(-6735534), 11318⟩, ⟨(-1683891), (-1666903)⟩, ⟨(-8), 5661⟩, ⟨697, 709⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424920241, 1431655766⟩, ⟨(-6735534), 11318⟩, ⟨(-1683891), (-1666903)⟩, ⟨(-8), 5661⟩, ⟨697, 709⟩⟩
...
def j72 : Jet := ⟨⟨0, 557⟩, ⟨(-1), 557⟩, ⟨137, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851619)⟩, ⟨(-1), 557⟩, ⟨137, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-40093), 0⟩, ⟨(-40094), 27⟩, ⟨(-10025), (-9982)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35751301, 35791395⟩, ⟨(-40094), 27⟩, ⟨(-10025), (-9982)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1683881⟩, ⟨(-1887), 1683883⟩, ⟨418139, 420973⟩, ⟨(-945), 2⟩, ⟨(-120), (-115)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714144001)⟩, ⟨(-1887), 1683883⟩, ⟨418139, 420973⟩, ⟨(-945), 2⟩, ⟨(-120), (-115)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-33677619), 0⟩, ⟨(-33677709), 79222⟩, ⟨(-8419494), (-8300571)⟩, ⟨(-68), 39613⟩, ⟨4867, 4953⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4261289677, 4294967296⟩, ⟨(-33677709), 79222⟩, ⟨(-8419494), (-8300571)⟩, ⟨(-68), 39613⟩, ⟨4867, 4953⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 310531020⟩, ⟨153074068, 155267965⟩, ⟨(-1095723), 1228⟩, ⟨(-182623), (-179550)⟩, ⟨(-1), 768⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4328911075⟩, ⟨(-80481), 34212134⟩, ⟨8299939, 8823487⟩, ⟨(-40567), 137401⟩, ⟨10412, 13616⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 312985194⟩, ⟨153068249, 158968649⟩, ⟨(-1107293), 1875995⟩, ⟨100082, 149386⟩, ⟨(-5176), 6735⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-296535280), 0⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3998432016, 4294967296⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22808028⟩, ⟨0, 23168900⟩, ⟨5293812, 6157289⟩, ⟨(-81968), 160646⟩, ⟨5892, 12862⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317775324⟩, ⟨0, 23168900⟩, ⟨5293812, 6157289⟩, ⟨(-81968), 160646⟩, ⟨5892, 12862⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306356211⟩, ⟨0, 11584450⟩, ⟨2624324, 3078645⟩, ⟨(-49288), 80323⟩, ⟨1621, 5763⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3998432016, 4306356211⟩, ⟨(-148660800), (-136683189)⟩, ⟨2043224, 3078645⟩, ⟨(-155567), (-10271)⟩, ⟨(-1264), 7465⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2661202225⟩, ⟨1330601103, 1330601113⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1648905986⟩, ⟨0, 1648905988⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1648905986⟩, ⟨0, 1648905988⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1648905986), 0⟩, ⟨(-1648905988), 0⟩, ⟨(-412226497), (-412226490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-824452993), 0⟩, ⟨(-824452994), 0⟩, ⟨(-206113249), (-206113245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3544815166, 4294967296⟩, ⟨(-824452994), 0⟩, ⟨(-206113249), (-90983693)⟩, ⟨0, 39565071⟩, ⟨284422, 4945634⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3300072264, 4306356211⟩, ⟨(-975299987), (-112810321)⟩, ⟨(-204973441), (-53086687)⟩, ⟨2148930, 46795664⟩, ⟨(-1253681), 4952794⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297777252, 4297777254⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3502
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306356211⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3503
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (269538327 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(27617 / 400000), prawitzNormalCorrection
