...
namespace FiniteNormalPanel24_15
...
def j2 : Jet := ⟨⟨613224830, 613224834⟩, ⟨613224830, 613224834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨87554727, 87554729⟩, ⟨175109454, 175109458⟩, ⟨87554727, 87554729⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨21, 22⟩, ⟨43, 44⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94666), (-94664)⟩, ⟨43, 44⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1930), (-1929)⟩, ⟨(-3860), (-3858)⟩, ⟨(-1929), (-1926)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111126, 5111128⟩, ⟨(-3860), (-3858)⟩, ⟨(-1929), (-1926)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨104192, 104193⟩, ⟨208305, 208308⟩, ⟨103994, 103997⟩, ⟨(-158), (-155)⟩, ⟨(-40), (-37)⟩⟩
...
def j16 : Jet := ⟨⟨(-143061385), (-143061383)⟩, ⟨208305, 208308⟩, ⟨103994, 103997⟩, ⟨(-158), (-155)⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2916367), (-2916366)⟩, ⟨(-5828488), (-5828486)⟩, ⟨(-2905756), (-2905752)⟩, ⟨8481, 8485⟩, ⟨2111, 2115⟩⟩
...
def j19 : Jet := ⟨⟨1428739398, 1428739400⟩, ⟨(-5828488), (-5828486)⟩, ⟨(-2905756), (-2905752)⟩, ⟨8481, 8485⟩, ⟨2111, 2115⟩⟩
...
def j25 : Jet := ⟨⟨241, 242⟩, ⟨481, 483⟩, ⟨239, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851936), (-851934)⟩, ⟨481, 483⟩, ⟨239, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-17368), (-17367)⟩, ⟨(-34726), (-34724)⟩, ⟨(-17345), (-17342)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35774026, 35774028⟩, ⟨(-34726), (-34724)⟩, ⟨(-17345), (-17342)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨729268, 729269⟩, ⟨1457829, 1457831⟩, ⟨727498, 727501⟩, ⟨(-1416), (-1413)⟩, ⟨(-354), (-351)⟩⟩
...
def j33 : Jet := ⟨⟨(-715098615), (-715098613)⟩, ⟨1457829, 1457831⟩, ⟨727498, 727501⟩, ⟨(-1416), (-1413)⟩, ⟨(-354), (-351)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-14577589), (-14577588)⟩, ⟨(-29125459), (-29125457)⟩, ⟨(-14503323), (-14503319)⟩, ⟨59349, 59352⟩, ⟨14764, 14767⟩⟩
...
def j36 : Jet := ⟨⟨4280389707, 4280389708⟩, ⟨(-29125459), (-29125457)⟩, ⟨(-14503323), (-14503319)⟩, ⟨59349, 59352⟩, ⟨14764, 14767⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨203991884, 203991887⟩, ⟨203159706, 203159711⟩, ⟨(-1247055), (-1247052)⟩, ⟨(-413667), (-413664)⟩, ⟨1511, 1514⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4309594530, 4309594532⟩, ⟨29324177, 29324181⟩, ⟨14801806, 14801813⟩, ⟨140318, 140325⟩, ⟨35830, 35839⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨204686612, 204686616⟩, ⟨205244368, 205244375⟩, ⟨838803, 838809⟩, ⟨283225, 283232⟩, ⟨2731, 2740⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-195195527), (-195195526)⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4099771769, 4099771770⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨9754814, 9754815⟩, ⟨19562790, 19562794⟩, ⟨9887999, 9888002⟩, ⟨107162, 107168⟩, ⟨27491, 27496⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4304722110, 4304722111⟩, ⟨19562790, 19562794⟩, ⟨9887999, 9888002⟩, ⟨107162, 107168⟩, ⟨27491, 27496⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299841936, 4299841938⟩, ⟨9770306, 9770309⟩, ⟨4927294, 4927297⟩, ⟨42323, 42328⟩, ⟨10809, 10814⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4104424868, 4104424872⟩, ⟨(-186090798), (-186090793)⟩, ⟨4259323, 4259329⟩, ⟨(-183535), (-183528)⟩, ⟨8393, 8400⟩⟩
...
def j47 : Jet := ⟨⟨1189810424, 1189810431⟩, ⟨1189810424, 1189810431⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨329606431, 329606436⟩, ⟨659212862, 659212872⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨329606431, 329606436⟩, ⟨659212862, 659212872⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-329606436), (-329606431)⟩, ⟨(-659212872), (-659212862)⟩, ⟨(-329606436), (-329606431)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-164803218), (-164803215)⟩, ⟨(-329606436), (-329606431)⟩, ⟨(-164803218), (-164803215)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4133285873, 4133285877⟩, ⟨(-317198604), (-317198598)⟩, ⟨(-146427999), (-146427994)⟩, ⟨11859951, 11859952⟩, ⟨2581770, 2581772⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3949916298, 3949916307⟩, ⟨(-482211893), (-482211880)⟩, ⟨(-122089402), (-122089387)⟩, ⟨17186980, 17186991⟩, ⟨1829786, 1829798⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 390391053⟩, ⟨195195526, 195195527⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1226449665⟩, ⟨613224830, 613224834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 350218914⟩, ⟨0, 350218916⟩, ⟨87554727, 87554729⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 88⟩, ⟨0, 88⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94598)⟩, ⟨0, 88⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-7721), 0⟩, ⟨(-7721), 8⟩, ⟨(-1931), (-1918)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5105335, 5113057⟩, ⟨(-7721), 8⟩, ⟨(-1931), (-1918)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 416928⟩, ⟨(-630), 416929⟩, ⟨103286, 104233⟩, ⟨(-316), 2⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142748648)⟩, ⟨(-630), 416929⟩, ⟨103286, 104233⟩, ⟨(-316), 2⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-11673964), 0⟩, ⟨(-11674016), 33998⟩, ⟨(-2918543), (-2867493)⟩, ⟨(-39), 17001⟩, ⟨2075, 2126⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1419981801, 1431655766⟩, ⟨(-11674016), 33998⟩, ⟨(-2918543), (-2867493)⟩, ⟨(-39), 17001⟩, ⟨2075, 2126⟩⟩
...
def j72 : Jet := ⟨⟨0, 966⟩, ⟨(-1), 966⟩, ⟨239, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851210)⟩, ⟨(-1), 966⟩, ⟨239, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-69488), 0⟩, ⟨(-69489), 79⟩, ⟨(-17373), (-17253)⟩, ⟨(-2), 40⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35721906, 35791395⟩, ⟨(-69489), 79⟩, ⟨(-17373), (-17253)⟩, ⟨(-2), 40⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2918492⟩, ⟨(-5667), 2918499⟩, ⟨721122, 729630⟩, ⟨(-2835), 6⟩, ⟨(-356), (-346)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712909390)⟩, ⟨(-5667), 2918499⟩, ⟨721122, 729630⟩, ⟨(-2835), 6⟩, ⟨(-356), (-346)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-58369820), 0⟩, ⟨(-58370283), 237980⟩, ⟨(-14592918), (-14235483)⟩, ⟨(-348), 118992⟩, ⟨14438, 14875⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4236597476, 4294967296⟩, ⟨(-58370283), 237980⟩, ⟨(-14592918), (-14235483)⟩, ⟨(-348), 118992⟩, ⟨14438, 14875⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 408816556⟩, ⟨199407921, 204417988⟩, ⟨(-2500193), 4855⟩, ⟨(-416715), (-404558)⟩, ⟨(-6), 3036⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4354141308⟩, ⟨(-244583), 59989759⟩, ⟨14232159, 15824315⟩, ⟨(-124027), 425015⟩, ⟨28742, 45734⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 414449036⟩, ⟨199384640, 212944489⟩, ⟨(-2546281), 4366359⟩, ⟨191589, 389196⟩, ⟨(-20944), 27703⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-390391053), 0⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3904576243, 4294967296⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 39992855⟩, ⟨0, 41096770⟩, ⟨8764588, 11400467⟩, ⟨(-252490), 508084⟩, ⟨11155, 48381⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4334960151⟩, ⟨0, 41096770⟩, ⟨8764588, 11400467⟩, ⟨(-252490), 508084⟩, ⟨11155, 48381⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4314917390⟩, ⟨0, 20548385⟩, ⟨4313104, 5700234⟩, ⟨(-153517), 254042⟩, ⟨575, 22760⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3904576243, 4314917390⟩, ⟨(-196102209), (-174647141)⟩, ⟨2987191, 5700234⟩, ⟨(-412579), 58023⟩, ⟨(-11024), 29737⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2379620856⟩, ⟨1189810424, 1189810431⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1318425736⟩, ⟨0, 1318425740⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1318425736⟩, ⟨0, 1318425740⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1318425736), 0⟩, ⟨(-1318425740), 0⟩, ⟨(-329606436), (-329606431)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-659212868), 0⟩, ⟨(-659212870), 0⟩, ⟨(-164803218), (-164803215)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3683852149, 4294967296⟩, ⟨(-659212870), 0⟩, ⟨(-164803218), (-90764340)⟩, ⟨0, 25294815⟩, ⟨770776, 3161852⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3349008407, 4314917390⟩, ⟨(-858377119), (-149797239)⟩, ⟨(-163006574), (-46715341)⟩, ⟨2403289, 32995018⟩, ⟨(-692866), 3206474⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299841936, 4299841938⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified480
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4314917390⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified481
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (355386829 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(18179 / 200000), prawitzNormalCorrection
