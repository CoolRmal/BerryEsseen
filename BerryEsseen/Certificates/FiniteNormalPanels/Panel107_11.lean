...
namespace FiniteNormalPanel107_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (102697 / 400000)
def radius : Rat := (14671 / 400000)

def j0 : Jet := ⟨⟨1102700640, 1102700641⟩, ⟨157528662, 157528663⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3464236229, 3464236233⟩, ⟨494890887, 494890891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2794184873, 2794184880⟩, ⟨798338530, 798338540⟩, ⟨57024180, 57024182⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨699, 701⟩, ⟨199, 201⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93988), (-93985)⟩, ⟨199, 201⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-61146), (-61143)⟩, ⟨(-17342), (-17338)⟩, ⟨(-1203), (-1199)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5051910, 5051914⟩, ⟨(-17342), (-17338)⟩, ⟨(-1203), (-1199)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3286630, 3286634⟩, ⟨927754, 927760⟩, ⟨63067, 63073⟩, ⟨(-453), (-448)⟩, ⟨(-16), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-139878947), (-139878942)⟩, ⟨927754, 927760⟩, ⟨63067, 63073⟩, ⟨(-453), (-448)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-91001308), (-91001303)⟩, ⟨(-25396804), (-25396797)⟩, ⟨(-1643693), (-1643685)⟩, ⟨23744, 23751⟩, ⟨741, 748⟩⟩
...
def j19 : Jet := ⟨⟨1340654457, 1340654463⟩, ⟨(-25396804), (-25396797)⟩, ⟨(-1643693), (-1643685)⟩, ⟨23744, 23751⟩, ⟨741, 748⟩⟩
...
def j25 : Jet := ⟨⟨7653, 7656⟩, ⟨2172, 2176⟩, ⟨150, 154⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844524), (-844520)⟩, ⟨2172, 2176⟩, ⟨150, 154⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-549424), (-549420)⟩, ⟨(-155566), (-155561)⟩, ⟨(-10713), (-10706)⟩, ⟨53, 58⟩, ⟨(-1), 3⟩⟩
...
def j30 : Jet := ⟨⟨35241970, 35241975⟩, ⟨(-155566), (-155561)⟩, ⟨(-10713), (-10706)⟩, ⟨53, 58⟩, ⟨(-1), 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22927434, 22927438⟩, ⟨6449488, 6449494⟩, ⟨432019, 432027⟩, ⟨(-4024), (-4017)⟩, ⟨(-135), (-129)⟩⟩
...
def j33 : Jet := ⟨⟨(-692900449), (-692900444)⟩, ⟨6449488, 6449494⟩, ⟨432019, 432027⟩, ⟨(-4024), (-4017)⟩, ⟨(-135), (-129)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-450781537), (-450781532)⟩, ⟨(-124598871), (-124598862)⟩, ⟨(-7719750), (-7719740)⟩, ⟨163313, 163322⟩, ⟨4899, 4908⟩⟩
...
def j36 : Jet := ⟨⟨3844185759, 3844185764⟩, ⟨(-124598871), (-124598862)⟩, ⟨(-7719750), (-7719740)⟩, ⟨163313, 163322⟩, ⟨4899, 4908⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1081345542, 1081345549⟩, ⟨133993369, 133993379⟩, ⟨(-4252138), (-4252129)⟩, ⟨(-170245), (-170236)⟩, ⟨3332, 3341⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4798608913, 4798608921⟩, ⟨155533900, 155533914⟩, ⟨14677582, 14677599⟩, ⟨584199, 584214⟩, ⟨35673, 35690⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1208147582, 1208147593⟩, ⟨188864688, 188864705⟩, ⟨3796931, 3796949⟩, ⟨260799, 260817⟩, ⟨10230, 10251⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1102700641), (-1102700640)⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3192266655, 3192266656⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨339844399, 339844406⟩, ⟨106252922, 106252936⟩, ⟨10441144, 10441159⟩, ⟨480650, 480666⟩, ⟨32046, 32065⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4634811695, 4634811702⟩, ⟨106252922, 106252936⟩, ⟨10441144, 10441159⟩, ⟨480650, 480666⟩, ⟨32046, 32065⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4461654923, 4461654927⟩, ⟨51141653, 51141661⟩, ⟨4732425, 4732434⟩, ⟨177100, 177110⟩, ⟨10884, 10895⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3316158483, 3316158488⟩, ⟨(-125630932), (-125630923)⟩, ⟨1641661, 1641671⟩, ⟨(-41944), (-41934)⟩, ⟨1593, 1603⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨35571532296, 35571532303⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value474

def j47 : Jet := ⟨⟨9132724122, 9132724133⟩, ⟨1304674867, 1304674877⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨19419623978, 19419624026⟩, ⟨5548463960, 5548464012⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨19419623978, 19419624026⟩, ⟨5548463960, 5548464012⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-19419624026), (-19419623978)⟩, ⟨(-5548464012), (-5548463960)⟩, ⟨(-396318859), (-396318852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9709812013), (-9709811989)⟩, ⟨(-2774232006), (-2774231980)⟩, ⟨(-198159430), (-198159426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨447849586, 447849597⟩, ⟨(-289277799), (-289277789)⟩, ⟨72763353, 72763360⟩, ⟨(-6768869), (-6768865)⟩, ⟨(-585517), (-585515)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨345786149, 345786159⟩, ⟨(-236452276), (-236452265)⟩, ⟨64813592, 64813603⟩, ⟨(-7469595), (-7469586)⟩, ⟨(-223284), (-223276)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨945171977, 1260229304⟩, ⟨157528662, 157528663⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2969345339, 3959127124⟩, ⟨494890887, 494890891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2052870519, 3649547600⟩, ⟨684290168, 912386902⟩, ⟨57024180, 57024182⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨513, 915⟩, ⟨171, 229⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94174), (-93771)⟩, ⟨171, 229⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-80023), (-44819)⟩, ⟨(-19925), (-14744)⟩, ⟨(-1218), (-1182)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5033033, 5068238⟩, ⟨(-19925), (-14744)⟩, ⟨(-1218), (-1182)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2405644, 4306617⟩, ⟨784950, 1069608⟩, ⟨61555, 64378⟩, ⟨(-523), (-376)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140759933), (-138858959)⟩, ⟨784950, 1069608⟩, ⟨61555, 64378⟩, ⟨(-523), (-376)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-119607448), (-66370578)⟩, ⟨(-29526679), (-21214650)⟩, ⟨(-1714385), (-1561704)⟩, ⟨19783, 27699⟩, ⟨690, 791⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1312048317, 1365285188⟩, ⟨(-29526679), (-21214650)⟩, ⟨(-1714385), (-1561704)⟩, ⟨19783, 27699⟩, ⟨690, 791⟩⟩
...
def j70 : Jet := ⟨⟨(-92), (-51)⟩, ⟨(-23), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11743, 11785⟩, ⟨(-23), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5612, 10015⟩, ⟨1850, 2496⟩, ⟨148, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846565), (-842161)⟩, ⟨1850, 2496⟩, ⟨148, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-719349), (-402528)⟩, ⟨(-178954), (-132055)⟩, ⟨(-10876), (-10518)⟩, ⟨45, 67⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35072045, 35388867⟩, ⟨(-178954), (-132055)⟩, ⟨(-10876), (-10518)⟩, ⟨45, 67⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16763426, 30070859⟩, ⟨5435746, 7454597⟩, ⟨418392, 443792⟩, ⟨(-4666), (-3371)⟩, ⟨(-139), (-121)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699064457), (-685757023)⟩, ⟨5435746, 7454597⟩, ⟨418392, 443792⟩, ⟨(-4666), (-3371)⟩, ⟨(-139), (-121)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-594013607), (-327772082)⟩, ⟨(-145905273), (-102922991)⟩, ⟨(-8215441), (-7144084)⟩, ⟨134864, 191640⟩, ⟨4443, 5299⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3700953689, 3967195214⟩, ⟨(-145905273), (-102922991)⟩, ⟨(-8215441), (-7144084)⟩, ⟨134864, 191640⟩, ⟨4443, 5299⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨907090621, 1258528238⟩, ⟨123963895, 142649185⟩, ⟨(-4982566), (-3524165)⟩, ⟨(-183865), (-154414)⟩, ⟨2756, 3922⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4649820106, 4984321779⟩, ⟨120632680, 196500387⟩, ⟨11502982, 18811057⟩, ⟨274887, 1008358⟩, ⟨11694, 71535⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨982034999, 1460525605⟩, ⟨159683307, 223124104⟩, ⟨128901, 8223146⟩, ⟨(-51275), 654094⟩, ⟨(-16851), 45230⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1260229304), (-945171977)⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3034737992, 3349795319⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨224540182, 496659206⟩, ⟨73022486, 151748988⟩, ⟨5995836, 17183972⟩, ⟨(-25290), 1299246⟩, ⟨(-16787), 114469⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4519507478, 4791626502⟩, ⟨73022486, 151748988⟩, ⟨5995836, 17183972⟩, ⟨(-25290), 1299246⟩, ⟨(-16787), 114469⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4405807169, 4536505166⟩, ⟨34567269, 73965669⟩, ⟨2235310, 8240228⟩, ⟨(-150666), 615743⟩, ⟨(-26227), 57758⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3113055229, 3538179158⟩, ⟨(-141963129), (-103905576)⟩, ⟨(-1133451), 5159002⟩, ⟨(-419741), 398255⟩, ⟨(-43040), 50575⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7828049246, 10437399009⟩, ⟨1304674867, 1304674877⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14267478836, 25364406890⟩, ⟨4755826250, 6341101728⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14267478836, 25364406890⟩, ⟨4755826250, 6341101728⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-25364406890), (-14267478836)⟩, ⟨(-6341101728), (-4755826250)⟩, ⟨(-396318859), (-396318852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12682203445), (-7133739418)⟩, ⟨(-3170550864), (-2377913125)⟩, ⟨(-198159430), (-198159426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨224167517, 815862701⟩, ⟨(-602270987), (-124110579)⟩, ⟨(-3284962), 211956095⟩, ⟨(-48337987), 19333209⟩, ⟨(-8457522), 8996573⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨162479900, 672104863⟩, ⟨(-523115760), (-95380316)⟩, ⟨81084, 195495773⟩, ⟨(-47629696), 16269804⟩, ⟨(-7726265), 9332145⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1102700640, 1102700641⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨157528662, 157528663⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4461654923, 4461654927⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar474 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2160
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar474 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨945171977, 1260229304⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4405807169, 4536505166⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2161
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((44013 / 200000) : ℝ)..(14671 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (44013 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (14671 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((44013 / 200000) : ℝ)..(14671 / 50000), prawitzNormalCorrection
      ((62429 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
