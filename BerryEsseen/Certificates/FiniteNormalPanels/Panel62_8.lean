...
namespace FiniteNormalPanel62_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (36419 / 160000)
def radius : Rat := (36419 / 800000)

def j0 : Jet := ⟨⟨977615087, 977615088⟩, ⟨195523017, 195523018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3071268375, 3071268379⟩, ⟨614253673, 614253677⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2196219151, 2196219158⟩, ⟨878487656, 878487666⟩, ⟨87848765, 87848767⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨549, 551⟩, ⟨219, 221⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94138), (-94135)⟩, ⟨219, 221⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48138), (-48135)⟩, ⟨(-19144), (-19140)⟩, ⟨(-1872), (-1867)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064918, 5064922⟩, ⟨(-19144), (-19140)⟩, ⟨(-1872), (-1867)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2589931, 2589934⟩, ⟨1026182, 1026187⟩, ⟨98723, 98730⟩, ⟨(-771), (-766)⟩, ⟨(-38), (-34)⟩⟩
...
def j16 : Jet := ⟨⟨(-140575646), (-140575642)⟩, ⟨1026182, 1026187⟩, ⟨98723, 98730⟩, ⟨(-771), (-766)⟩, ⟨(-38), (-34)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-71882952), (-71882949)⟩, ⟨(-28228446), (-28228441)⟩, ⟨(-2614944), (-2614935)⟩, ⟨40786, 40794⟩, ⟨1841, 1847⟩⟩
...
def j19 : Jet := ⟨⟨1359772813, 1359772817⟩, ⟨(-28228446), (-28228441)⟩, ⟨(-2614944), (-2614935)⟩, ⟨40786, 40794⟩, ⟨1841, 1847⟩⟩
...
def j25 : Jet := ⟨⟨6023, 6025⟩, ⟨2397, 2400⟩, ⟨233, 236⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846154), (-846151)⟩, ⟨2397, 2400⟩, ⟨233, 236⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-432679), (-432676)⟩, ⟨(-171847), (-171842)⟩, ⟨(-16699), (-16695)⟩, ⟨94, 99⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35358715, 35358719⟩, ⟨(-171847), (-171842)⟩, ⟨(-16699), (-16695)⟩, ⟨94, 99⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18080577, 18080580⟩, ⟨7144356, 7144362⟩, ⟨679534, 679540⟩, ⟨(-6883), (-6877)⟩, ⟨(-322), (-317)⟩⟩
...
def j33 : Jet := ⟨⟨(-697747306), (-697747302)⟩, ⟨7144356, 7144362⟩, ⟨679534, 679540⟩, ⟨(-6883), (-6877)⟩, ⟨(-322), (-317)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-356791076), (-356791072)⟩, ⟨(-139063186), (-139063179)⟩, ⟨(-12462869), (-12462861)⟩, ⟨281600, 281607⟩, ⟨12326, 12332⟩⟩
...
def j36 : Jet := ⟨⟨3938176220, 3938176224⟩, ⟨(-139063186), (-139063179)⟩, ⟨(-12462869), (-12462861)⟩, ⟨281600, 281607⟩, ⟨12326, 12332⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨972353675, 972353680⟩, ⟨174284984, 174284992⟩, ⟨(-5907059), (-5907050)⟩, ⟨(-344817), (-344808)⟩, ⟨7149, 7156⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4684082942, 4684082947⟩, ⟨165402314, 165402325⟩, ⟨20663991, 20664004⟩, ⟨918167, 918182⟩, ⟨71318, 71332⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1060447018, 1060447025⟩, ⟨227520910, 227520922⟩, ⟨4947811, 4947828⟩, ⟨442845, 442864⟩, ⟨19498, 19516⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-977615088), (-977615087)⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3317352208, 3317352209⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨261829206, 261829210⟩, ⟨112351900, 112351908⟩, ⟨14495930, 14495942⟩, ⟨742888, 742904⟩, ⟨62245, 62260⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4556796502, 4556796506⟩, ⟨112351900, 112351908⟩, ⟨14495930, 14495942⟩, ⟨742888, 742904⟩, ⟨62245, 62260⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4423945292, 4423945295⟩, ⟨54538167, 54538172⟩, ⟨6700481, 6700489⟩, ⟨278011, 278021⟩, ⟨21712, 21722⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3416972393, 3416972398⟩, ⟨(-159270324), (-159270317)⟩, ⟨2692542, 2692552⟩, ⟨(-90302), (-90292)⟩, ⟨4112, 4122⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨23425843907, 23425843913⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value334

def j47 : Jet := ⟨⟨5332161306, 5332161314⟩, ⟨1066432259, 1066432265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6619827866, 6619827887⟩, ⟨2647931140, 2647931162⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6619827866, 6619827887⟩, ⟨2647931140, 2647931162⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6619827887), (-6619827866)⟩, ⟨(-2647931162), (-2647931140)⟩, ⟨(-264793117), (-264793113)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3309913944), (-3309913933)⟩, ⟨(-1323965581), (-1323965570)⟩, ⟨(-132396559), (-132396556)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1987335002, 1987335012⟩, ⟨(-612615411), (-612615402)⟩, ⟨33160795, 33160800⟩, ⟨9182264, 9182266⟩, ⟨(-1218739), (-1218737)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1581075796, 1581075807⟩, ⟨(-561078416), (-561078402)⟩, ⟨50345423, 50345436⟩, ⟨5649646, 5649657⟩, ⟨(-1274539), (-1274524)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨782092069, 1173138105⟩, ⟨195523017, 195523018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2457014698, 3685522053⟩, ⟨614253673, 614253677⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1405580254, 3162555584⟩, ⟨702790124, 1054185198⟩, ⟨87848765, 87848767⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨351, 793⟩, ⟨175, 265⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94336), (-93893)⟩, ⟨175, 265⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-69464), (-30727)⟩, ⟨(-23098), (-15167)⟩, ⟨(-1896), (-1837)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5043592, 5082330⟩, ⟨(-23098), (-15167)⟩, ⟨(-1896), (-1837)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1650576, 3742323⟩, ⟨808280, 1242478⟩, ⟨96094, 100872⟩, ⟨(-938), (-601)⟩, ⟨(-39), (-33)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141515001), (-139423253)⟩, ⟨808280, 1242478⟩, ⟨96094, 100872⟩, ⟨(-938), (-601)⟩, ⟨(-39), (-33)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-104203135), (-45627954)⟩, ⟨(-34469860), (-21899090)⟩, ⟨(-2730826), (-2472507)⟩, ⟨31564, 49977⟩, ⟨1705, 1956⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1327452630, 1386027812⟩, ⟨(-34469860), (-21899090)⟩, ⟨(-2730826), (-2472507)⟩, ⟨31564, 49977⟩, ⟨1705, 1956⟩⟩
...
def j72 : Jet := ⟨⟨3846, 8690⟩, ⟨1903, 2892⟩, ⟨230, 240⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848331), (-843486)⟩, ⟨1903, 2892⟩, ⟨230, 240⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-624660), (-276041)⟩, ⟨(-207598), (-135890)⟩, ⟨(-16966), (-16365)⟩, ⟨73, 119⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35166734, 35515354⟩, ⟨(-207598), (-135890)⟩, ⟨(-16966), (-16365)⟩, ⟨73, 119⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11508741, 26151371⟩, ⟨5601507, 8672653⟩, ⟨655848, 698837⟩, ⟨(-8389), (-5368)⟩, ⟨(-337), (-300)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704319142), (-689676511)⟩, ⟨5601507, 8672653⟩, ⟨655848, 698837⟩, ⟨(-8389), (-5368)⟩, ⟨(-337), (-300)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-518618253), (-225705021)⟩, ⟨(-171039591), (-106466489)⟩, ⟨(-13274849), (-11463307)⟩, ⟨215711, 347162⟩, ⟨11105, 13318⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3776349043, 4069262275⟩, ⟨(-171039591), (-106466489)⟩, ⟨(-13274849), (-11463307)⟩, ⟨215711, 347162⟩, ⟨11105, 13318⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨759393587, 1189353892⟩, ⟨160269723, 185697875⟩, ⟨(-7273108), (-4546385)⟩, ⟨(-372499), (-310724)⟩, ⟨5489, 8827⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4533191233, 4884809075⟩, ⟨118604533, 221244313⟩, ⟨15873335, 27192044⟩, ⟨332677, 1750381⟩, ⟨18555, 154763⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨801513984, 1352691717⟩, ⟨190129695, 272466907⟩, ⟨(-1039572), 12297168⟩, ⟨(-147168), 1206888⟩, ⟨(-43750), 103195⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1173138105), (-782092069)⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3121829191, 3512875227⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨149576148, 426027664⟩, ⟨70962872, 171625862⟩, ⟨7761841, 25030872⟩, ⟨(-224602), 2320448⟩, ⟨(-49209), 253341⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4444543444, 4720994960⟩, ⟨70962872, 171625862⟩, ⟨7761841, 25030872⟩, ⟨(-224602), 2320448⟩, ⟨(-49209), 253341⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4369115326, 4502945587⟩, ⟨33842649, 84356605⟩, ⟨2911517, 12171967⟩, ⟨(-345406), 1117983⟩, ⟨(-62729), 130221⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3175724242, 3682981712⟩, ⟨(-180392187), (-129902823)⟩, ⟨(-1723973), 8414869⟩, ⟨(-836624), 781861⟩, ⟨(-102202), 122234⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4265729042, 6398593573⟩, ⟨1066432259, 1066432265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4236689829, 9532552146⟩, ⟨2118344910, 3177517392⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4236689829, 9532552146⟩, ⟨2118344910, 3177517392⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9532552146), (-4236689829)⟩, ⟨(-3177517392), (-2118344910)⟩, ⟨(-264793117), (-264793113)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4766276073), (-2118344914)⟩, ⟨(-1588758696), (-1059172455)⟩, ⟨(-132396559), (-132396556)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1415819920, 2622762972⟩, ⟨(-970190736), (-349152241)⟩, ⟨(-37797396), 135798428⟩, ⟨(-9569171), 24598618⟩, ⟨(-4367889), 1467509⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1046865629, 2249048106⟩, ⟨(-942107451), (-300987213)⟩, ⟨(-22904210), 162336084⟩, ⟨(-16321046), 23547988⟩, ⟨(-5091757), 2190012⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨977615087, 977615088⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4423945292, 4423945295⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar334 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1228
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar334 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨782092069, 1173138105⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4369115326, 4502945587⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1229
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((36419 / 200000) : ℝ)..(109257 / 400000), prawitzNormalCorrection
      ((222669 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
