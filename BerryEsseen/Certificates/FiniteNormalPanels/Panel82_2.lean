...
namespace FiniteNormalPanel82_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (33647 / 400000)
def radius : Rat := (33647 / 400000)

def j0 : Jet := ⟨⟨361281911, 361281912⟩, ⟨361281911, 361281912⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1135000597, 1135000601⟩, ⟨1135000597, 1135000601⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨299938571, 299938574⟩, ⟨599877142, 599877148⟩, ⟨299938571, 299938574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨75, 76⟩, ⟨150, 151⟩, ⟨75, 76⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94612), (-94610)⟩, ⟨150, 151⟩, ⟨75, 76⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-6608), (-6607)⟩, ⟨(-13205), (-13203)⟩, ⟨(-6583), (-6579)⟩, ⟨20, 22⟩, ⟨5, 6⟩⟩
...
def j13 : Jet := ⟨⟨5106448, 5106450⟩, ⟨(-13205), (-13203)⟩, ⟨(-6583), (-6579)⟩, ⟨20, 22⟩, ⟨5, 6⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨356608, 356609⟩, ⟨712293, 712295⟩, ⟨354303, 354306⟩, ⟨(-1842), (-1838)⟩, ⟨(-458), (-454)⟩⟩
...
def j16 : Jet := ⟨⟨(-142808969), (-142808967)⟩, ⟨712293, 712295⟩, ⟨354303, 354306⟩, ⟨(-1842), (-1838)⟩, ⟨(-458), (-454)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-9973049), (-9973048)⟩, ⟨(-19896356), (-19896353)⟩, ⟨(-9848822), (-9848818)⟩, ⟨99098, 99102⟩, ⟨24452, 24456⟩⟩
...
def j19 : Jet := ⟨⟨1421682716, 1421682718⟩, ⟨(-19896356), (-19896353)⟩, ⟨(-9848822), (-9848818)⟩, ⟨99098, 99102⟩, ⟨24452, 24456⟩⟩
...
def j22 : Jet := ⟨⟨(-8), (-7)⟩, ⟨(-16), (-14)⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11827, 11829⟩, ⟨(-16), (-14)⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨825, 827⟩, ⟨1649, 1653⟩, ⟨821, 826⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851352), (-851349)⟩, ⟨1649, 1653⟩, ⟨821, 826⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-59455), (-59453)⟩, ⟨(-118794), (-118791)⟩, ⟨(-59168), (-59164)⟩, ⟨228, 232⟩, ⟨55, 58⟩⟩
...
def j30 : Jet := ⟨⟨35731939, 35731942⟩, ⟨(-118794), (-118791)⟩, ⟨(-59168), (-59164)⟩, ⟨228, 232⟩, ⟨55, 58⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2495336, 2495337⟩, ⟨4982376, 4982378⟩, ⟨2474612, 2474615⟩, ⟨(-16545), (-16541)⟩, ⟨(-4098), (-4093)⟩⟩
...
def j33 : Jet := ⟨⟨(-713332547), (-713332545)⟩, ⟨4982376, 4982378⟩, ⟨2474612, 2474615⟩, ⟨(-16545), (-16541)⟩, ⟨(-4098), (-4093)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-49815501), (-49815500)⟩, ⟨(-99283059), (-99283056)⟩, ⟨(-48946800), (-48946797)⟩, ⟨692415, 692418⟩, ⟨170216, 170220⟩⟩
...
def j36 : Jet := ⟨⟨4245151795, 4245151796⟩, ⟨(-99283059), (-99283056)⟩, ⟨(-48946800), (-48946797)⟩, ⟨692415, 692418⟩, ⟨170216, 170220⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨375698025, 375698028⟩, ⟨370440155, 370440160⟩, ⟨(-7860549), (-7860545)⟩, ⟨(-2576492), (-2576488)⟩, ⟨32648, 32652⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4345367364, 4345367367⟩, ⟨101626836, 101626842⟩, ⟨52479073, 52479080⟩, ⟨1690345, 1690352⟩, ⟨453803, 453812⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨380106721, 380106725⟩, ⟨383676858, 383676866⟩, ⟨5403060, 5403068⟩, ⟨1881448, 1881458⟩, ⟨61506, 61517⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-361281912), (-361281911)⟩, ⟨(-361281912), (-361281911)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3933685384, 3933685385⟩, ⟨(-361281912), (-361281911)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨33639632, 33639633⟩, ⟨67911180, 67911184⟩, ⟨35230863, 35230869⟩, ⟨1298346, 1298352⟩, ⟨353829, 353836⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4328606928, 4328606929⟩, ⟨67911180, 67911184⟩, ⟨35230863, 35230869⟩, ⟨1298346, 1298352⟩, ⟨353829, 353836⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4311754305, 4311754307⟩, ⟨33823390, 33823393⟩, ⟨17414185, 17414190⟩, ⟨510040, 510045⟩, ⟨137058, 137064⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3949060311, 3949060315⟩, ⟨(-331715744), (-331715738)⟩, ⟨13104207, 13104213⟩, ⟨(-997703), (-997695)⟩, ⟨82625, 82632⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨27389006786, 27389006792⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value396

def j47 : Jet := ⟨⟨2303894774, 2303894782⟩, ⟨2303894774, 2303894782⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1235849021, 1235849030⟩, ⟨2471698042, 2471698060⟩, ⟨1235849021, 1235849030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1235849021, 1235849030⟩, ⟨2471698042, 2471698060⟩, ⟨1235849021, 1235849030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1235849030), (-1235849021)⟩, ⟨(-2471698060), (-2471698042)⟩, ⟨(-1235849030), (-1235849021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-617924515), (-617924510)⟩, ⟨(-1235849030), (-1235849021)⟩, ⟨(-617924515), (-617924510)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3719436499, 3719436506⟩, ⟨(-1070243772), (-1070243761)⟩, ⟨(-381144031), (-381144022)⟩, ⟨139209144, 139209148⟩, ⟨17403798, 17403800⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3419881467, 3419881478⟩, ⟨(-1271314187), (-1271314169)⟩, ⟨(-256440558), (-256440539)⟩, ⟨153305282, 153305300⟩, ⟨4407781, 4407798⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 722563824⟩, ⟨361281911, 361281912⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2270001202⟩, ⟨1135000597, 1135000601⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1199754295⟩, ⟨0, 1199754296⟩, ⟨299938571, 299938574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 301⟩, ⟨0, 301⟩, ⟨75, 76⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94385)⟩, ⟨0, 301⟩, ⟨75, 76⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-26450), 0⟩, ⟨(-26450), 85⟩, ⟨(-6613), (-6484)⟩, ⟨0, 44⟩, ⟨5, 6⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5086606, 5113057⟩, ⟨(-26450), 85⟩, ⟨(-6613), (-6484)⟩, ⟨0, 44⟩, ⟨5, 6⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1428280⟩, ⟨(-7389), 1428304⟩, ⟨345985, 357094⟩, ⟨(-3696), 19⟩, ⟨(-462), (-437)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141737296)⟩, ⟨(-7389), 1428304⟩, ⟨345985, 357094⟩, ⟨(-3696), 19⟩, ⟨(-462), (-437)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-39991810), 0⟩, ⟨(-39993875), 398982⟩, ⟨(-10000018), (-9399475)⟩, ⟨(-1550), 199503⟩, ⟨22998, 24944⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1391663955, 1431655766⟩, ⟨(-39993875), 398982⟩, ⟨(-10000018), (-9399475)⟩, ⟨(-1550), 199503⟩, ⟨22998, 24944⟩⟩
...
def j70 : Jet := ⟨⟨(-31), 0⟩, ⟨(-31), 0⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11804, 11836⟩, ⟨(-31), 0⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 3307⟩, ⟨(-9), 3307⟩, ⟨812, 827⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848869)⟩, ⟨(-9), 3307⟩, ⟨812, 827⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-238047), 0⟩, ⟨(-238050), 924⟩, ⟨(-59515), (-58124)⟩, ⟨(-3), 463⟩, ⟨53, 58⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35553347, 35791395⟩, ⟨(-238050), 924⟩, ⟨(-59515), (-58124)⟩, ⟨(-3), 463⟩, ⟨53, 58⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 9997953⟩, ⟨(-66497), 9998212⟩, ⟨2399742, 2499748⟩, ⟨(-33251), 195⟩, ⟨(-4158), (-3912)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-705829929)⟩, ⟨(-66497), 9998212⟩, ⟨2399742, 2499748⟩, ⟨(-33251), 195⟩, ⟨(-4158), (-3912)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-199959050), 0⟩, ⟨(-199977626), 2792897⟩, ⟨(-50008339), (-45800379)⟩, ⟨(-13933), 1396559⟩, ⟨157134, 174625⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4095008246, 4294967296⟩, ⟨(-199977626), 2792897⟩, ⟨(-50008339), (-45800379)⟩, ⟨(-13933), 1396559⟩, ⟨157134, 174625⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 756667068⟩, ⟨346627382, 378544407⟩, ⟨(-15854167), 105437⟩, ⟨(-2643454), (-2378489)⟩, ⟨(-410), 65906⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4504690337⟩, ⟨(-3072312), 219984242⟩, ⟨45657329, 65754205⟩, ⟨(-1618644), 5912855⟩, ⟨156828, 927985⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 793615084⟩, ⟨346086116, 435784498⟩, ⟨(-16899110), 31083546⟩, ⟨(-184940), 4469913⟩, ⟨(-521211), 757260⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-722563824), 0⟩, ⟨(-361281912), (-361281911)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3572403472, 4294967296⟩, ⟨(-361281912), (-361281911)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 146642538⟩, ⟨0, 161046700⟩, ⟨21642263, 55703538⟩, ⟨(-3497650), 7959606⟩, ⟨(-352451), 1411880⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4441609834⟩, ⟨0, 161046700⟩, ⟨21642263, 55703538⟩, ⟨(-3497650), 7959606⟩, ⟨(-352451), 1411880⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4367673177⟩, ⟨0, 80523350⟩, ⟨9898725, 27851769⟩, ⟨(-2270999), 3979803⟩, ⟨(-341147), 737112⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3572403472, 4367673177⟩, ⟨(-367397749), (-280758561)⟩, ⟨1459989, 27851769⟩, ⟨(-4613821), 3147148⟩, ⟨(-675919), 928143⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4607789564⟩, ⟨2303894774, 2303894782⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4943396120⟩, ⟨0, 4943396120⟩, ⟨1235849021, 1235849030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4943396120⟩, ⟨0, 4943396120⟩, ⟨1235849021, 1235849030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4943396120), 0⟩, ⟨(-4943396120), 0⟩, ⟨(-1235849030), (-1235849021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2471698060), 0⟩, ⟨(-2471698060), 0⟩, ⟨(-617924515), (-617924510)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2415622188, 4294967296⟩, ⟨(-2471698060), 0⟩, ⟨(-617924515), 363675294⟩, ⟨(-69763475), 355607557⟩, ⟨(-77323190), 54487939⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2009229988, 4367673177⟩, ⟨(-2880937102), (-157907281)⟩, ⟨(-627563697), 609116063⟩, ⟨(-122695911), 417632648⟩, ⟨(-115545464), 67319670⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨361281911, 361281912⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨361281911, 361281912⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4311754305, 4311754307⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar396 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1646
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar396 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 722563824⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4367673177⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1647
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(33647 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (33647 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(33647 / 200000), prawitzNormalCorrection
      ((225461 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
