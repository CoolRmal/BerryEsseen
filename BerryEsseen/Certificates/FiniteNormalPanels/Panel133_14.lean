...
namespace FiniteNormalPanel133_14
...
def j2 : Jet := ⟨⟨458797013, 458797017⟩, ⟨458797013, 458797017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨49009616, 49009618⟩, ⟨98019232, 98019236⟩, ⟨49009616, 49009618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1081), (-1080)⟩, ⟨(-2161), (-2159)⟩, ⟨(-1081), (-1078)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111975, 5111977⟩, ⟨(-2161), (-2159)⟩, ⟨(-1081), (-1078)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨58332, 58333⟩, ⟨116639, 116641⟩, ⟨58269, 58272⟩, ⟨(-50), (-47)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-143107245), (-143107243)⟩, ⟨116639, 116641⟩, ⟨58269, 58272⟩, ⟨(-50), (-47)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1632989), (-1632988)⟩, ⟨(-3264647), (-3264645)⟩, ⟨(-1629664), (-1629661)⟩, ⟨2658, 2661⟩, ⟨661, 664⟩⟩
...
def j19 : Jet := ⟨⟨1430022776, 1430022778⟩, ⟨(-3264647), (-3264645)⟩, ⟨(-1629664), (-1629661)⟩, ⟨2658, 2661⟩, ⟨661, 664⟩⟩
...
def j25 : Jet := ⟨⟨135, 136⟩, ⟨269, 271⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852042), (-852040)⟩, ⟨269, 271⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9723), (-9722)⟩, ⟨(-19443), (-19441)⟩, ⟨(-9716), (-9713)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781671, 35781673⟩, ⟨(-19443), (-19441)⟩, ⟨(-9716), (-9713)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨408302, 408303⟩, ⟨816383, 816385⟩, ⟨407747, 407750⟩, ⟨(-444), (-441)⟩, ⟨(-112), (-108)⟩⟩
...
def j33 : Jet := ⟨⟨(-715419581), (-715419579)⟩, ⟨816383, 816385⟩, ⟨407747, 407750⟩, ⟨(-444), (-441)⟩, ⟨(-112), (-108)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8163611), (-8163610)⟩, ⟨(-16317907), (-16317904)⟩, ⟨(-8140328), (-8140325)⟩, ⟨18614, 18617⟩, ⟨4639, 4642⟩⟩
...
def j36 : Jet := ⟨⟨4286803685, 4286803686⟩, ⟨(-16317907), (-16317904)⟩, ⟨(-8140328), (-8140325)⟩, ⟨18614, 18617⟩, ⟨4639, 4642⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨152757898, 152757901⟩, ⟨152409161, 152409166⟩, ⟨(-522821), (-522818)⟩, ⟨(-173801), (-173798)⟩, ⟨353, 356⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303146452, 4303146454⟩, ⟨16380113, 16380118⟩, ⟨8233710, 8233716⟩, ⟨43757, 43764⟩, ⟨11069, 11078⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨153048803, 153048807⟩, ⟨153281988, 153281996⟩, ⟨350285, 350292⟩, ⟨117607, 117614⟩, ⟨632, 641⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-146039626), (-146039625)⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4148927670, 4148927671⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5453810, 5453811⟩, ⟨10924238, 10924240⟩, ⟨5495405, 5495409⟩, ⟨33382, 33388⟩, ⟨8466, 8471⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300421106, 4300421107⟩, ⟨10924238, 10924240⟩, ⟨5495405, 5495409⟩, ⟨33382, 33388⟩, ⟨8466, 8471⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297693335, 4297693337⟩, ⟨5458654, 5458656⟩, ⟨2742492, 2742496⟩, ⟨13196, 13201⟩, ⟨3337, 3342⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4151561016, 4151561020⟩, ⟨(-140859273), (-140859268)⟩, ⟨2463632, 2463638⟩, ⟨(-80505), (-80498)⟩, ⟨2774, 2781⟩⟩
...
def j47 : Jet := ⟨⟨1436406640, 1436406651⟩, ⟨1436406640, 1436406651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨480391093, 480391101⟩, ⟨960782186, 960782202⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨480391093, 480391101⟩, ⟨960782186, 960782202⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-480391101), (-480391093)⟩, ⟨(-960782202), (-960782186)⟩, ⟨(-480391101), (-480391093)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-240195551), (-240195546)⟩, ⟨(-480391101), (-480391093)⟩, ⟨(-240195551), (-240195546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4061364724, 4061364730⟩, ⟨(-454262708), (-454262699)⟩, ⟨(-201726766), (-201726759)⟩, ⟨24457422, 24457425⟩, ⟨4956883, 4956885⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3925758288, 3925758298⟩, ⟨(-572293121), (-572293105)⟩, ⟨(-177763441), (-177763424)⟩, ⟨29920008, 29920022⟩, ⟨3884683, 3884697⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 292079251⟩, ⟨146039625, 146039626⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 917594030⟩, ⟨458797013, 458797017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 196038467⟩, ⟨0, 196038468⟩, ⟨49009616, 49009618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4322), 0⟩, ⟨(-4322), 3⟩, ⟨(-1081), (-1075)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108734, 5113057⟩, ⟨(-4322), 3⟩, ⟨(-1081), (-1075)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 233380⟩, ⟨(-198), 233381⟩, ⟨58047, 58346⟩, ⟨(-100), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142932196)⟩, ⟨(-198), 233381⟩, ⟨58047, 58346⟩, ⟨(-100), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6534616), 0⟩, ⟨(-6534626), 10653⟩, ⟨(-1633664), (-1617673)⟩, ⟨(-8), 5329⟩, ⟨656, 667⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425121149, 1431655766⟩, ⟨(-6534626), 10653⟩, ⟨(-1633664), (-1617673)⟩, ⟨(-8), 5329⟩, ⟨656, 667⟩⟩
...
def j72 : Jet := ⟨⟨0, 541⟩, ⟨(-1), 541⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851635)⟩, ⟨(-1), 541⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-38897), 0⟩, ⟨(-38898), 25⟩, ⟨(-9726), (-9685)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35752497, 35791395⟩, ⟨(-38898), 25⟩, ⟨(-9726), (-9685)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1633654⟩, ⟨(-1776), 1633656⟩, ⟨405749, 408416⟩, ⟨(-889), 2⟩, ⟨(-113), (-108)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714194228)⟩, ⟨(-1776), 1633656⟩, ⟨405749, 408416⟩, ⟨(-889), 2⟩, ⟨(-113), (-108)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-32673078), 0⟩, ⟨(-32673161), 74567⟩, ⟨(-8168352), (-8056418)⟩, ⟨(-62), 37285⟩, ⟨4582, 4662⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4262294218, 4294967296⟩, ⟨(-32673161), 74567⟩, ⟨(-8168352), (-8056418)⟩, ⟨(-62), 37285⟩, ⟨4582, 4662⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 305864677⟩, ⟨150838212, 152934616⟩, ⟨(-1047065), 1138⟩, ⟨(-174514), (-171664)⟩, ⟨(-1), 713⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4327890834⟩, ⟨(-75715), 33176001⟩, ⟨8055842, 8548380⟩, ⟨(-38155), 129173⟩, ⟨9832, 12758⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 308209316⟩, ⟨150832819, 156469571⟩, ⟨(-1057789), 1791245⟩, ⟨96261, 141945⟩, ⟨(-4794), 6235⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-292079251), 0⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4002888045, 4294967296⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22117278⟩, ⟨0, 22456694⟩, ⟨5145206, 5957412⟩, ⟨(-77074), 150888⟩, ⟨5628, 11988⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317084574⟩, ⟨0, 22456694⟩, ⟨5145206, 5957412⟩, ⟨(-77074), 150888⟩, ⟨5628, 11988⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306011735⟩, ⟨0, 11228347⟩, ⟨2551364, 2978706⟩, ⟨(-46325), 75444⟩, ⟨1578, 5359⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4002888045, 4306011735⟩, ⟨(-146415165), (-134811278)⟩, ⟨1996066, 2978706⟩, ⟨(-147609), (-11308)⟩, ⟨(-1096), 6935⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2872813292⟩, ⟨1436406640, 1436406651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1921564390⟩, ⟨0, 1921564398⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1921564390⟩, ⟨0, 1921564398⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1921564390), 0⟩, ⟨(-1921564398), 0⟩, ⟨(-480391101), (-480391093)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-960782195), 0⟩, ⟨(-960782199), 0⟩, ⟨(-240195551), (-240195546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3434064015, 4294967296⟩, ⟨(-960782199), 0⟩, ⟨(-240195551), (-84586363)⟩, ⟨0, 53731634⟩, ⟨(-639695), 6716455⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3200530491, 4306011735⟩, ⟨(-1109668000), (-107789076)⟩, ⟨(-239217245), (-43102356)⟩, ⟨1841068, 62049016⟩, ⟨(-2640729), 6734372⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297693335, 4297693337⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2682
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306011735⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2683
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (263033187 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(13601 / 200000), prawitzNormalCorrection
