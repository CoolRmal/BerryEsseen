...
namespace FiniteNormalPanel75_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38471 / 400000)
def radius : Rat := (38471 / 400000)

def j0 : Jet := ⟨⟨413079217, 413079218⟩, ⟨413079217, 413079218⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1297726633, 1297726637⟩, ⟨1297726633, 1297726637⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨392108786, 392108789⟩, ⟨784217572, 784217578⟩, ⟨392108786, 392108789⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨98, 99⟩, ⟨196, 197⟩, ⟨98, 99⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94589), (-94587)⟩, ⟨196, 197⟩, ⟨98, 99⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8636), (-8635)⟩, ⟨(-17254), (-17252)⟩, ⟨(-8593), (-8589)⟩, ⟨34, 37⟩, ⟨8, 10⟩⟩
...
def j13 : Jet := ⟨⟨5104420, 5104422⟩, ⟨(-17254), (-17252)⟩, ⟨(-8593), (-8589)⟩, ⟨34, 37⟩, ⟨8, 10⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨466007, 466008⟩, ⟨930439, 930441⟩, ⟨462071, 462074⟩, ⟨(-3142), (-3139)⟩, ⟨(-779), (-776)⟩⟩
...
def j16 : Jet := ⟨⟨(-142699570), (-142699568)⟩, ⟨930439, 930441⟩, ⟨462071, 462074⟩, ⟨(-3142), (-3139)⟩, ⟨(-779), (-776)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13027749), (-13027748)⟩, ⟨(-25970554), (-25970552)⟩, ⟨(-12815677), (-12815672)⟩, ⟨169026, 169030⟩, ⟨41538, 41543⟩⟩
...
def j19 : Jet := ⟨⟨1418628016, 1418628018⟩, ⟨(-25970554), (-25970552)⟩, ⟨(-12815677), (-12815672)⟩, ⟨169026, 169030⟩, ⟨41538, 41543⟩⟩
...
def j25 : Jet := ⟨⟨1079, 1080⟩, ⟨2157, 2159⟩, ⟨1074, 1077⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851098), (-851096)⟩, ⟨2157, 2159⟩, ⟨1074, 1077⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-77701), (-77700)⟩, ⟨(-155206), (-155203)⟩, ⟨(-77210), (-77206)⟩, ⟨391, 395⟩, ⟨96, 99⟩⟩
...
def j30 : Jet := ⟨⟨35713693, 35713695⟩, ⟨(-155206), (-155203)⟩, ⟨(-77210), (-77206)⟩, ⟨391, 395⟩, ⟨96, 99⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3260479, 3260480⟩, ⟨6506788, 6506791⟩, ⟨3225090, 3225094⟩, ⟨(-28233), (-28229)⟩, ⟨(-6970), (-6965)⟩⟩
...
def j33 : Jet := ⟨⟨(-712567404), (-712567402)⟩, ⟨6506788, 6506791⟩, ⟨3225090, 3225094⟩, ⟨(-28233), (-28229)⟩, ⟨(-6970), (-6965)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-65053800), (-65053798)⟩, ⟨(-129513564), (-129513559)⟩, ⟨(-63571293), (-63571288)⟩, ⟨1180326, 1180331⟩, ⟨288641, 288646⟩⟩
...
def j36 : Jet := ⟨⟨4229913496, 4229913498⟩, ⟨(-129513564), (-129513559)⟩, ⟨(-63571293), (-63571288)⟩, ⟨1180326, 1180331⟩, ⟨288641, 288646⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨428639203, 428639205⟩, ⟨420792186, 420792190⟩, ⟨(-11719281), (-11719277)⟩, ⟨(-3821193), (-3821189)⟩, ⟨63621, 63626⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4361021586, 4361021589⟩, ⟨133527889, 133527897⟩, ⟨69630129, 69630139⟩, ⟨2921840, 2921849⟩, ⟨801077, 801087⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨435231443, 435231447⟩, ⟨440589871, 440589879⟩, ⟨8131761, 8131770⟩, ⟨2869187, 2869197⟩, ⟨122015, 122027⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-413079218), (-413079217)⟩, ⟨(-413079218), (-413079217)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3881888078, 3881888079⟩, ⟨(-413079218), (-413079217)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨44104272, 44104274⟩, ⟨89294540, 89294544⟩, ⟨46845018, 46845025⟩, ⟨2249856, 2249862⟩, ⟨628782, 628791⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4339071568, 4339071570⟩, ⟨89294540, 89294544⟩, ⟨46845018, 46845025⟩, ⟨2249856, 2249862⟩, ⟨628782, 628791⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316963108, 4316963110⟩, ⟨44419782, 44419786⟩, ⟨23074635, 23074640⟩, ⟨881767, 881772⟩, ⟨242046, 242053⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3901768387, 3901768391⟩, ⟨(-375047123), (-375047116)⟩, ⟨16583190, 16583196⟩, ⟨(-1422302), (-1422294)⟩, ⟨133959, 133967⟩⟩
...
def j47 : Jet := ⟨⟨2063251406, 2063251412⟩, ⟨2063251406, 2063251412⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨991161531, 991161538⟩, ⟨1982323062, 1982323076⟩, ⟨991161531, 991161538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨991161531, 991161538⟩, ⟨1982323062, 1982323076⟩, ⟨991161531, 991161538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-991161538), (-991161531)⟩, ⟨(-1982323076), (-1982323062)⟩, ⟨(-991161538), (-991161531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-495580769), (-495580765)⟩, ⟨(-991161538), (-991161531)⟩, ⟨(-495580769), (-495580765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3826909473, 3826909478⟩, ⟨(-883146535), (-883146527)⟩, ⟨(-339670180), (-339670172)⟩, ⟨94064268, 94064271⟩, ⟨14169788, 14169790⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3476560674, 3476560684⟩, ⟨(-1136470733), (-1136470715)⟩, ⟨(-216679288), (-216679269)⟩, ⟨110436436, 110436454⟩, ⟨3758961, 3758977⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 826158435⟩, ⟨413079217, 413079218⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2595453271⟩, ⟨1297726633, 1297726637⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1568435152⟩, ⟨0, 1568435154⟩, ⟨392108786, 392108789⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 393⟩, ⟨0, 393⟩, ⟨98, 99⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94293)⟩, ⟨0, 393⟩, ⟨98, 99⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34578), 0⟩, ⟨(-34578), 144⟩, ⟨(-8645), (-8427)⟩, ⟨0, 73⟩, ⟨8, 10⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078478, 5113057⟩, ⟨(-34578), 144⟩, ⟨(-8645), (-8427)⟩, ⟨0, 73⟩, ⟨8, 10⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1867185⟩, ⟨(-12628), 1867238⟩, ⟨447854, 466850⟩, ⟨(-6314), 41⟩, ⟨(-790), (-738)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141298391)⟩, ⟨(-12628), 1867238⟩, ⟨447854, 466850⟩, ⟨(-6314), 41⟩, ⟨(-790), (-738)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-52281172), 0⟩, ⟨(-52285784), 681878⟩, ⟨(-13074906), (-12047465)⟩, ⟨(-3459), 340970⟩, ⟨38291, 42637⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1379374593, 1431655766⟩, ⟨(-52285784), 681878⟩, ⟨(-13074906), (-12047465)⟩, ⟨(-3459), 340970⟩, ⟨38291, 42637⟩⟩
...
def j72 : Jet := ⟨⟨0, 4323⟩, ⟨(-15), 4323⟩, ⟨1057, 1081⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-847853)⟩, ⟨(-15), 4323⟩, ⟨1057, 1081⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-311198), 0⟩, ⟨(-311204), 1579⟩, ⟨(-77806), (-75430)⟩, ⟨(-5), 790⟩, ⟨92, 99⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35480196, 35791395⟩, ⟨(-311204), 1579⟩, ⟨(-77806), (-75430)⟩, ⟨(-5), 790⟩, ⟨92, 99⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 13070294⟩, ⟨(-113646), 13070871⟩, ⟨3097102, 3268151⟩, ⟨(-56828), 434⟩, ⟨(-7106), (-6560)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-702757588)⟩, ⟨(-113646), 13070871⟩, ⟨3097102, 3268151⟩, ⟨(-56828), 434⟩, ⟨(-7106), (-6560)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-261405859), 0⟩, ⟨(-261447362), 4773218⟩, ⟨(-65392967), (-58191531)⟩, ⟨(-31129), 2386927⟩, ⟨259401, 298525⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4033561437, 4294967296⟩, ⟨(-261447362), 4773218⟩, ⟨(-65392967), (-58191531)⟩, ⟨(-31129), 2386927⟩, ⟨259401, 298525⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 865151091⟩, ⟨385182405, 432987606⟩, ⟨(-23699358), 206030⟩, ⟨(-3952681), (-3434098)⟩, ⟨(-1046), 128791⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4573314269⟩, ⟨(-5411950), 296433059⟩, ⟨57862089, 93357755⟩, ⟨(-2904554), 10892396⟩, ⟨124536, 1946552⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 921219548⟩, ⟨384092255, 520760143⟩, ⟨(-25780853), 48909022⟩, ⟨(-1240418), 8201517⟩, ⟨(-1081883), 1636793⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-826158435), 0⟩, ⟨(-413079218), (-413079217)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3468808861, 4294967296⟩, ⟨(-413079218), (-413079217)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 197590668⟩, ⟨0, 223393750⟩, ⟨23289397, 84122417⟩, ⟨(-6783912), 15378592⟩, ⟨(-1058484), 3247951⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4492557964⟩, ⟨0, 223393750⟩, ⟨23289397, 84122417⟩, ⟨(-6783912), 15378592⟩, ⟨(-1058484), 3247951⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4392651766⟩, ⟨0, 111696875⟩, ⟨9965621, 42061209⟩, ⟨(-4485819), 7689296⟩, ⟨(-935170), 1729075⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3468808861, 4392651766⟩, ⟨(-422474267), (-301382342)⟩, ⟨(-2694044), 42061209⟩, ⟨(-8531161), 6730828⟩, ⟨(-1674708), 2160510⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4126502819⟩, ⟨2063251406, 2063251412⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3964646141⟩, ⟨0, 3964646146⟩, ⟨991161531, 991161538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3964646141⟩, ⟨0, 3964646146⟩, ⟨991161531, 991161538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3964646141), 0⟩, ⟨(-3964646146), 0⟩, ⟨(-991161538), (-991161531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1982323071), 0⟩, ⟨(-1982323073), 0⟩, ⟨(-495580769), (-495580765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2707155311, 4294967296⟩, ⟨(-1982323073), 0⟩, ⟨(-495580769), 145097330⟩, ⟨(-22323010), 228733103⟩, ⟨(-34763816), 31167410⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2186420450, 4392651766⟩, ⟨(-2449883174), (-189963916)⟩, ⟨(-509546272), 385449745⟩, ⟨(-65047543), 290657429⟩, ⟨(-67688389), 41591071⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨413079217, 413079218⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨413079217, 413079218⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316963108, 4316963110⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1490
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 826158435⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4392651766⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1491
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (656440767 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(38471 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(38471 / 200000), prawitzNormalCorrection
