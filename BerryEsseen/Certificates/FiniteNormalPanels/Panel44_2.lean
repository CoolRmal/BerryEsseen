...
namespace FiniteNormalPanel44_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (35189 / 400000)
def radius : Rat := (35189 / 400000)

def j0 : Jet := ⟨⟨377839010, 377839011⟩, ⟨377839010, 377839011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1187016258, 1187016262⟩, ⟨1187016258, 1187016262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨328060145, 328060148⟩, ⟨656120290, 656120296⟩, ⟨328060145, 328060148⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨82, 83⟩, ⟨164, 165⟩, ⟨82, 83⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94605), (-94603)⟩, ⟨164, 165⟩, ⟨82, 83⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-7227), (-7226)⟩, ⟨(-14441), (-14439)⟩, ⟨(-7196), (-7193)⟩, ⟨24, 26⟩, ⟨6, 7⟩⟩
...
def j13 : Jet := ⟨⟨5105829, 5105831⟩, ⟨(-14441), (-14439)⟩, ⟨(-7196), (-7193)⟩, ⟨24, 26⟩, ⟨6, 7⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨389995, 389996⟩, ⟨778887, 778890⟩, ⟨387238, 387242⟩, ⟨(-2203), (-2198)⟩, ⟨(-547), (-544)⟩⟩
...
def j16 : Jet := ⟨⟨(-142775582), (-142775580)⟩, ⟨778887, 778890⟩, ⟨387238, 387242⟩, ⟨(-2203), (-2198)⟩, ⟨(-547), (-544)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-10905550), (-10905549)⟩, ⟨(-21751607), (-21751604)⟩, ⟨(-10756986), (-10756982)⟩, ⟨118480, 118484⟩, ⟨29199, 29203⟩⟩
...
def j19 : Jet := ⟨⟨1420750215, 1420750217⟩, ⟨(-21751607), (-21751604)⟩, ⟨(-10756986), (-10756982)⟩, ⟨118480, 118484⟩, ⟨29199, 29203⟩⟩
...
def j25 : Jet := ⟨⟨903, 904⟩, ⟨1804, 1806⟩, ⟨899, 902⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851274), (-851272)⟩, ⟨1804, 1806⟩, ⟨899, 902⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-65023), (-65022)⟩, ⟨(-129908), (-129906)⟩, ⟨(-64680), (-64677)⟩, ⟨273, 276⟩, ⟨66, 69⟩⟩
...
def j30 : Jet := ⟨⟨35726371, 35726373⟩, ⟨(-129908), (-129906)⟩, ⟨(-64680), (-64677)⟩, ⟨273, 276⟩, ⟨66, 69⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2728867, 2728869⟩, ⟨5447812, 5447815⟩, ⟨2704080, 2704084⟩, ⟨(-19784), (-19780)⟩, ⟨(-4895), (-4891)⟩⟩
...
def j33 : Jet := ⟨⟨(-713099016), (-713099013)⟩, ⟨5447812, 5447815⟩, ⟨2704080, 2704084⟩, ⟨(-19784), (-19780)⟩, ⟨(-4895), (-4891)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-54468254), (-54468253)⟩, ⟨(-108520391), (-108520388)⟩, ⟨(-53429476), (-53429473)⟩, ⟨827693, 827698⟩, ⟨203147, 203151⟩⟩
...
def j36 : Jet := ⟨⟨4240499042, 4240499043⟩, ⟨(-108520391), (-108520388)⟩, ⟨(-53429476), (-53429473)⟩, ⟨827693, 827698⟩, ⟨203147, 203151⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨392658078, 392658080⟩, ⟨386646504, 386646508⟩, ⟨(-8984523), (-8984519)⟩, ⟨(-2940205), (-2940201)⟩, ⟨40813, 40817⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4350135181, 4350135183⟩, ⟨111326131, 111326136⟩, ⟨57659860, 57659866⟩, ⟨2029186, 2029196⟩, ⟨548297, 548307⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨397701682, 397701685⟩, ⟨401790641, 401790647⟩, ⟨6193428, 6193437⟩, ⟨2165382, 2165393⟩, ⟨77307, 77318⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-377839011), (-377839010)⟩, ⟨(-377839011), (-377839010)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3917128285, 3917128286⟩, ⟨(-377839011), (-377839010)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨36826037, 36826039⟩, ⟨74409326, 74409330⟩, ⟨38734168, 38734174⟩, ⟨1559796, 1559802⟩, ⟨428385, 428394⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4331793333, 4331793335⟩, ⟨74409326, 74409330⟩, ⟨38734168, 38734174⟩, ⟨1559796, 1559802⟩, ⟨428385, 428394⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4313341013, 4313341015⟩, ⟨37046180, 37046183⟩, ⟨19125494, 19125499⟩, ⟨612311, 612316⟩, ⟨165618, 165625⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3933885620, 3933885624⟩, ⟨(-345668259), (-345668253)⟩, ⟨14183930, 14183937⟩, ⟨(-1124074), (-1124067)⟩, ⟨97181, 97189⟩⟩
...
def j47 : Jet := ⟨⟨2242117404, 2242117412⟩, ⟨2242117404, 2242117412⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1170460705, 1170460715⟩, ⟨2340921410, 2340921430⟩, ⟨1170460705, 1170460715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1170460705, 1170460715⟩, ⟨2340921410, 2340921430⟩, ⟨1170460705, 1170460715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1170460715), (-1170460705)⟩, ⟨(-2340921430), (-2340921410)⟩, ⟨(-1170460715), (-1170460705)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-585230358), (-585230352)⟩, ⟨(-1170460715), (-1170460705)⟩, ⟨(-585230358), (-585230352)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3747857636, 3747857645⟩, ⟨(-1021362874), (-1021362862)⟩, ⟨(-371510984), (-371510973)⟩, ⟨126528250, 126528254⟩, ⟨16690618, 16690621⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3432771950, 3432771962⟩, ⟨(-1237131692), (-1237131672)⟩, ⟨(-245699114), (-245699092)⟩, ⟨141437022, 141437040⟩, ⟨4229365, 4229381⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 755678021⟩, ⟨377839010, 377839011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2374032520⟩, ⟨1187016258, 1187016262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1312240588⟩, ⟨0, 1312240590⟩, ⟨328060145, 328060148⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 329⟩, ⟨0, 329⟩, ⟨82, 83⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94357)⟩, ⟨0, 329⟩, ⟨82, 83⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-28930), 0⟩, ⟨(-28930), 101⟩, ⟨(-7233), (-7080)⟩, ⟨0, 52⟩, ⟨6, 7⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5084126, 5113057⟩, ⟨(-28930), 101⟩, ⟨(-7233), (-7080)⟩, ⟨0, 52⟩, ⟨6, 7⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1562192⟩, ⟨(-8839), 1562223⟩, ⟨377289, 390579⟩, ⟨(-4420), 24⟩, ⟨(-553), (-521)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141603384)⟩, ⟨(-8839), 1562223⟩, ⟨377289, 390579⟩, ⟨(-4420), 24⟩, ⟨(-553), (-521)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-43741354), 0⟩, ⟨(-43744055), 477306⟩, ⟨(-10938040), (-10219374)⟩, ⟨(-2027), 238669⟩, ⟨27298, 29842⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1387914411, 1431655766⟩, ⟨(-43744055), 477306⟩, ⟨(-10938040), (-10219374)⟩, ⟨(-2027), 238669⟩, ⟨27298, 29842⟩⟩
...
def j70 : Jet := ⟨⟨(-33), 0⟩, ⟨(-33), 0⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11802, 11836⟩, ⟨(-33), 0⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 3617⟩, ⟨(-11), 3617⟩, ⟨887, 905⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848559)⟩, ⟨(-11), 3617⟩, ⟨887, 905⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-260366), 0⟩, ⟨(-260370), 1106⟩, ⟨(-65096), (-63432)⟩, ⟨(-3), 554⟩, ⟨64, 70⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35531028, 35791395⟩, ⟨(-260370), 1106⟩, ⟨(-65096), (-63432)⟩, ⟨(-3), 554⟩, ⟨64, 70⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 10935339⟩, ⟨(-79551), 10935677⟩, ⟨2614507, 2734173⟩, ⟨(-39778), 255⟩, ⟨(-4974), (-4653)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-704892543)⟩, ⟨(-79551), 10935677⟩, ⟨2614507, 2734173⟩, ⟨(-39778), 255⟩, ⟨(-4974), (-4653)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-218706765), 0⟩, ⟨(-218731072), 3341176⟩, ⟨(-54700998), (-49664874)⟩, ⟨(-18231), 1670744⟩, ⟨186028, 208921⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4076260531, 4294967296⟩, ⟨(-218731072), 3341176⟩, ⟨(-54700998), (-49664874)⟩, ⟨(-18231), 1670744⟩, ⟨186028, 208921⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 791344174⟩, ⟨359403705, 395935918⟩, ⟨(-18135684), 131915⟩, ⟨(-3024109), (-2692442)⟩, ⟨(-561), 82458⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4525408505⟩, ⟨(-3709329), 242832235⟩, ⟨49475967, 73758614⟩, ⟨(-1965073), 7236774⟩, ⟨157446, 1183633⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 833802777⟩, ⟨358720264, 461921014⟩, ⟨(-19450681), 36114693⟩, ⟨(-433640), 5456104⟩, ⟨(-664174), 976975⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-755678021), 0⟩, ⟨(-377839011), (-377839010)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3539289275, 4294967296⟩, ⟨(-377839011), (-377839010)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 161870167⟩, ⟨0, 179349922⟩, ⟨22408590, 63701555⟩, ⟨(-4352188), 9886666⟩, ⟨(-514710), 1856607⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4456837463⟩, ⟨0, 179349922⟩, ⟨22408590, 63701555⟩, ⟨(-4352188), 9886666⟩, ⟨(-514710), 1856607⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4375153843⟩, ⟨0, 89674961⟩, ⟨10079938, 31850778⟩, ⟨(-2841109), 4943333⟩, ⟨(-478669), 975796⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3539289275, 4375153843⟩, ⟨(-384893223), (-288164049)⟩, ⟨417492, 31850778⟩, ⟨(-5643102), 4056576⟩, ⟨(-913547), 1225736⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4484234817⟩, ⟨2242117404, 2242117412⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4681842843⟩, ⟨0, 4681842850⟩, ⟨1170460705, 1170460715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4681842843⟩, ⟨0, 4681842850⟩, ⟨1170460705, 1170460715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4681842843), 0⟩, ⟨(-4681842850), 0⟩, ⟨(-1170460715), (-1170460705)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2340921422), 0⟩, ⟨(-2340921425), 0⟩, ⟨(-585230358), (-585230352)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2490306256, 4294967296⟩, ⟨(-2340921425), 0⟩, ⟨(-585230358), 298617816⟩, ⟨(-54252710), 318972926⟩, ⟨(-63807877), 47264067⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2052149321, 4375153843⟩, ⟨(-2769519383), (-167083166)⟩, ⟨(-595914472), 545825281⟩, ⟨(-105029214), 381430072⟩, ⟨(-101048413), 59524281⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨377839010, 377839011⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨377839010, 377839011⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4313341013, 4313341015⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified858
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 755678021⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4375153843⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified859
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (591663821 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(35189 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(35189 / 200000), prawitzNormalCorrection
