...
namespace FiniteNormalPanel5_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1327 / 5000)
def radius : Rat := (1327 / 25000)

def j0 : Jet := ⟨⟨1139884320, 1139884321⟩, ⟨227976864, 227976865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3581052205, 3581052209⟩, ⟨716210441, 716210445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2985805015, 2985805023⟩, ⟨1194322006, 1194322016⟩, ⟨119432200, 119432202⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨747, 749⟩, ⟨298, 300⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93940), (-93937)⟩, ⟨298, 300⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-65306), (-65303)⟩, ⟨(-25916), (-25912)⟩, ⟨(-2511), (-2507)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5047750, 5047754⟩, ⟨(-25916), (-25912)⟩, ⟨(-2511), (-2507)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3509129, 3509133⟩, ⟨1385634, 1385641⟩, ⟨131412, 131419⟩, ⟨(-1409), (-1404)⟩, ⟨(-66), (-62)⟩⟩
...
def j16 : Jet := ⟨⟨(-139656448), (-139656443)⟩, ⟨1385634, 1385641⟩, ⟨131412, 131419⟩, ⟨(-1409), (-1404)⟩, ⟨(-66), (-62)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-97087334), (-97087330)⟩, ⟨(-37871660), (-37871652)⟩, ⟨(-3406830), (-3406820)⟩, ⟨74092, 74101⟩, ⟨3216, 3222⟩⟩
...
def j19 : Jet := ⟨⟨1334568431, 1334568436⟩, ⟨(-37871660), (-37871652)⟩, ⟨(-3406830), (-3406820)⟩, ⟨74092, 74101⟩, ⟨3216, 3222⟩⟩
...
def j22 : Jet := ⟨⟨(-76), (-74)⟩, ⟨(-31), (-29)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11759, 11762⟩, ⟨(-31), (-29)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8174, 8177⟩, ⟨3247, 3251⟩, ⟨314, 319⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844003), (-843999)⟩, ⟨3247, 3251⟩, ⟨314, 319⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-586740), (-586737)⟩, ⟨(-232439), (-232433)⟩, ⟨(-22350), (-22342)⟩, ⟨174, 180⟩, ⟨6, 9⟩⟩
...
def j30 : Jet := ⟨⟨35204654, 35204658⟩, ⟨(-232439), (-232433)⟩, ⟨(-22350), (-22342)⟩, ⟨174, 180⟩, ⟨6, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨24473814, 24473818⟩, ⟨9627936, 9627943⟩, ⟨898778, 898789⟩, ⟨(-12559), (-12549)⟩, ⟨(-570), (-563)⟩⟩
...
def j33 : Jet := ⟨⟨(-691354069), (-691354064)⟩, ⟨9627936, 9627943⟩, ⟨898778, 898789⟩, ⟨(-12559), (-12549)⟩, ⟨(-570), (-563)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-480620296), (-480620290)⟩, ⟨(-185554905), (-185554896)⟩, ⟨(-15922709), (-15922696)⟩, ⟨508924, 508937⟩, ⟨21102, 21114⟩⟩
...
def j36 : Jet := ⟨⟨3814347000, 3814347006⟩, ⟨(-185554905), (-185554896)⟩, ⟨(-15922709), (-15922696)⟩, ⟨508924, 508937⟩, ⟨21102, 21114⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1112734717, 1112734724⟩, ⟨190970359, 190970370⟩, ⟨(-9155860), (-9155848)⟩, ⟨(-506333), (-506322)⟩, ⟨15036, 15044⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4836147326, 4836147334⟩, ⟨235261975, 235261989⟩, ⟨31632809, 31632829⟩, ⟨1875636, 1875657⟩, ⟨165129, 165153⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1252942957, 1252942968⟩, ⟨275984629, 275984648⟩, ⟨8346489, 8346511⟩, ⟨820793, 820816⟩, ⟨47939, 47960⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1139884321), (-1139884320)⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3155082975, 3155082976⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨365512923, 365512931⟩, ⟨161022412, 161022426⟩, ⟨22603865, 22603883⟩, ⟨1551540, 1551560⟩, ⟨149671, 149692⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4660480219, 4660480227⟩, ⟨161022412, 161022426⟩, ⟨22603865, 22603883⟩, ⟨1551540, 1551560⟩, ⟨149671, 149692⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4473992637, 4473992642⟩, ⟨77289576, 77289584⟩, ⟨10182088, 10182098⟩, ⟨568828, 568840⟩, ⟨50427, 50439⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3286594990, 3286594996⟩, ⟨(-180702609), (-180702600)⟩, ⟨3377229, 3377240⟩, ⟨(-122605), (-122595)⟩, ⟨6848, 6860⟩⟩
...
def j47 : Jet := ⟨⟨4552094289, 4552094296⟩, ⟨910418857, 910418863⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4824614714, 4824614730⟩, ⟨1929845884, 1929845900⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4824614714, 4824614730⟩, ⟨1929845884, 1929845900⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4824614730), (-4824614714)⟩, ⟨(-1929845900), (-1929845884)⟩, ⟨(-192984591), (-192984588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2412307365), (-2412307357)⟩, ⟨(-964922950), (-964922942)⟩, ⟨(-96492296), (-96492294)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2449257367, 2449257383⟩, ⟨(-550259059), (-550259050)⟩, ⟨6785691, 6785695⟩, ⟨7733380, 7733381⟩, ⟨(-510578), (-510577)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1874220788, 1874220805⟩, ⟨(-524117116), (-524117101)⟩, ⟨30269556, 30269571⟩, ⟨5129641, 5129652⟩, ⟨(-691127), (-691114)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨911907456, 1367861185⟩, ⟨227976864, 227976865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2864841764, 4297262651⟩, ⟨716210441, 716210445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1910915210, 4299559233⟩, ⟨955457604, 1433186418⟩, ⟨119432200, 119432202⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨478, 1078⟩, ⟨239, 360⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94209), (-93608)⟩, ⟨239, 360⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-94310), (-41648)⟩, ⟨(-31331), (-20463)⟩, ⟨(-2555), (-2451)⟩, ⟨12, 22⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5018746, 5071409⟩, ⟨(-31331), (-20463)⟩, ⟨(-2555), (-2451)⟩, ⟨12, 22⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2232938, 5076832⟩, ⟨1085104, 1683174⟩, ⟨126545, 135382⟩, ⟨(-1720), (-1091)⟩, ⟨(-70), (-58)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140932639), (-138088744)⟩, ⟨1085104, 1683174⟩, ⟨126545, 135382⟩, ⟨(-1720), (-1091)⟩, ⟨(-70), (-58)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-141083317), (-61438391)⟩, ⟨(-46544989), (-29034221)⟩, ⟨(-3621288), (-3142714)⟩, ⟨56603, 91496⟩, ⟨2873, 3498⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1290572448, 1370217375⟩, ⟨(-46544989), (-29034221)⟩, ⟨(-3621288), (-3142714)⟩, ⟨56603, 91496⟩, ⟨2873, 3498⟩⟩
...
def j70 : Jet := ⟨⟨(-109), (-47)⟩, ⟨(-37), (-23)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11726, 11789⟩, ⟨(-37), (-23)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5217, 11802⟩, ⟨2570, 3924⟩, ⟨308, 323⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846960), (-840374)⟩, ⟨2570, 3924⟩, ⟨308, 323⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-847866), (-373898)⟩, ⟨(-281479), (-183020)⟩, ⟨(-22844), (-21734)⟩, ⟨134, 218⟩, ⟨4, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34943528, 35417497⟩, ⟨(-281479), (-183020)⟩, ⟨(-22844), (-21734)⟩, ⟨134, 218⟩, ⟨4, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15547061, 35455364⟩, ⟨7491750, 11737026⟩, ⟨854895, 934489⟩, ⟨(-15392), (-9704)⟩, ⟨(-606), (-521)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700280822), (-680372518)⟩, ⟨7491750, 11737026⟩, ⟨854895, 934489⟩, ⟨(-15392), (-9704)⟩, ⟨(-606), (-521)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-701029523), (-302711081)⟩, ⟨(-230343283), (-139605965)⟩, ⟨(-17426071), (-14067428)⟩, ⟨383096, 633891⟩, ⟨18028, 23597⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3593937773, 3992256215⟩, ⟨(-230343283), (-139605965)⟩, ⟨(-17426071), (-14067428)⟩, ⟨383096, 633891⟩, ⟨18028, 23597⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨860841443, 1370949659⟩, ⟨168640496, 209125120⟩, ⟨(-11384869), (-6937884)⟩, ⟨(-566116), (-432520)⟩, ⟨11354, 18758⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4620631312, 5132738862⟩, ⟨161579732, 328968390⟩, ⟨21931930, 45971619⟩, ⟨521317, 4048969⟩, ⟨12937, 442013⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨926114368, 1638365582⟩, ⟨213813055, 354923247⟩, ⟨(-2865392), 23227868⟩, ⟨(-582917), 2804497⟩, ⟨(-129947), 308958⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1367861185), (-911907456)⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2927106111, 3383059840⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨199696007, 624973742⟩, ⟨92208078, 270779260⟩, ⟨8458014, 47050882⟩, ⟨(-918298), 5978582⟩, ⟨(-210979), 824845⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4494663303, 4919941038⟩, ⟨92208078, 270779260⟩, ⟨8458014, 47050882⟩, ⟨(-918298), 5978582⟩, ⟨(-210979), 824845⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4393680904, 4596845207⟩, ⟨43076355, 132347808⟩, ⟨2046071, 22785728⟩, ⟨(-1135193), 2902071⟩, ⟨(-249622), 436876⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2994381409, 3620843033⟩, ⟨(-214643148), (-128968860)⟩, ⟨(-5630584), 15661371⟩, ⟨(-2103636), 2177299⟩, ⟨(-350665), 404376⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3641675431, 5462513154⟩, ⟨910418857, 910418863⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3087753417, 6947445208⟩, ⟨1543876706, 2315815080⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3087753417, 6947445208⟩, ⟨1543876706, 2315815080⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6947445208), (-3087753417)⟩, ⟨(-2315815080), (-1543876706)⟩, ⟨(-192984591), (-192984588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3473722604), (-1543876708)⟩, ⟨(-1157907540), (-771938353)⟩, ⟨(-96492296), (-96492294)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1912965909, 2998110132⟩, ⟨(-808279572), (-343819091)⟩, ⟨(-36459175), 65977229⟩, ⟨(-779498), 15382489⟩, ⟨(-1777901), 462091⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1333688747, 2527536402⟩, ⟨(-831246669), (-297147437)⟩, ⟨(-24342935), 106948284⟩, ⟨(-8370194), 17369670⟩, ⟨(-3055077), 1347266⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1139884320, 1139884321⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4473992637, 4473992642⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified96
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨911907456, 1367861185⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4393680904, 4596845207⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified97
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (100033513 / 2147483648)

theorem envelope_integral : (∫ s in ((1327 / 6250) : ℝ)..(3981 / 12500),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((1327 / 6250) : ℝ)..(3981 / 12500), prawitzNormalCorrection
