...
namespace FiniteNormalPanel29_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1469 / 6400)
def radius : Rat := (1469 / 32000)

def j0 : Jet := ⟨⟨985829212, 985829213⟩, ⟨197165842, 197165843⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3097073809, 3097073814⟩, ⟨619414760, 619414764⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2233280376, 2233280384⟩, ⟨893312146, 893312156⟩, ⟨89331214, 89331216⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨558, 560⟩, ⟨223, 224⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94129), (-94126)⟩, ⟨223, 224⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48945), (-48943)⟩, ⟨(-19463), (-19460)⟩, ⟨(-1901), (-1898)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064111, 5064114⟩, ⟨(-19463), (-19460)⟩, ⟨(-1901), (-1898)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2633216, 2633219⟩, ⟨1043165, 1043170⟩, ⟨100290, 100296⟩, ⟨(-797), (-792)⟩, ⟨(-39), (-35)⟩⟩
...
def j16 : Jet := ⟨⟨(-140532361), (-140532357)⟩, ⟨1043165, 1043170⟩, ⟨100290, 100296⟩, ⟨(-797), (-792)⟩, ⟨(-39), (-35)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-73073471), (-73073467)⟩, ⟨(-28686969), (-28686963)⟩, ⟨(-2653823), (-2653816)⟩, ⟨42140, 42147⟩, ⟨1898, 1905⟩⟩
...
def j19 : Jet := ⟨⟨1358582294, 1358582299⟩, ⟨(-28686969), (-28686963)⟩, ⟨(-2653823), (-2653816)⟩, ⟨42140, 42147⟩, ⟨1898, 1905⟩⟩
...
def j22 : Jet := ⟨⟨(-57), (-55)⟩, ⟨(-23), (-22)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11778, 11781⟩, ⟨(-23), (-22)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6124, 6126⟩, ⟨2437, 2440⟩, ⟨237, 241⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846053), (-846050)⟩, ⟨2437, 2440⟩, ⟨237, 241⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-439928), (-439925)⟩, ⟨(-174704), (-174701)⟩, ⟨(-16969), (-16963)⟩, ⟨97, 102⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨35351466, 35351470⟩, ⟨(-174704), (-174701)⟩, ⟨(-16969), (-16963)⟩, ⟨97, 102⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18381917, 18381920⟩, ⟨7261925, 7261928⟩, ⟨690115, 690121⟩, ⟨(-7114), (-7107)⟩, ⟨(-332), (-326)⟩⟩
...
def j33 : Jet := ⟨⟨(-697445966), (-697445962)⟩, ⟨7261925, 7261928⟩, ⟨690115, 690121⟩, ⟨(-7114), (-7107)⟩, ⟨(-332), (-326)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-362655240), (-362655236)⟩, ⟨(-141286070), (-141286063)⟩, ⟨(-12636957), (-12636950)⟩, ⟨290878, 290886⟩, ⟨12700, 12707⟩⟩
...
def j36 : Jet := ⟨⟨3932312056, 3932312060⟩, ⟨(-141286070), (-141286063)⟩, ⟨(-12636957), (-12636950)⟩, ⟨290878, 290886⟩, ⟨12700, 12707⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨979665117, 979665123⟩, ⟨175247029, 175247038⟩, ⟨(-6050855), (-6050846)⟩, ⟨(-352346), (-352337)⟩, ⟨7445, 7453⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4691068204, 4691068209⟩, ⟨168547802, 168547813⟩, ⟨21131142, 21131154⟩, ⟨953865, 953878⟩, ⟨74550, 74564⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1070014173, 1070014182⟩, ⟨229854175, 229854190⟩, ⟨5088273, 5088289⟩, ⟨457487, 457504⟩, ⟨20456, 20474⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-985829213), (-985829212)⟩, ⟨(-197165843), (-197165842)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3309138083, 3309138084⟩, ⟨(-197165843), (-197165842)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨266574865, 266574871⟩, ⟨114528100, 114528110⟩, ⟨14836431, 14836444⟩, ⟨772566, 772580⟩, ⟨65186, 65201⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4561542161, 4561542167⟩, ⟨114528100, 114528110⟩, ⟨14836431, 14836444⟩, ⟨772566, 772580⟩, ⟨65186, 65201⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4426248343, 4426248347⟩, ⟨55565617, 55565623⟩, ⟨6849417, 6849425⟩, ⟨288840, 288848⟩, ⟨22700, 22709⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3410286027, 3410286032⟩, ⟨(-160380893), (-160380885)⟩, ⟨2726451, 2726459⟩, ⟨(-91890), (-91882)⟩, ⟨4229, 4238⟩⟩
...
def j47 : Jet := ⟨⟨5367623176, 5367623183⟩, ⟨1073524633, 1073524639⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6708171814, 6708171833⟩, ⟨2683268720, 2683268740⟩, ⟨268326871, 268326875⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6708171814, 6708171833⟩, ⟨2683268720, 2683268740⟩, ⟨268326871, 268326875⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6708171833), (-6708171814)⟩, ⟨(-2683268740), (-2683268720)⟩, ⟨(-268326875), (-268326871)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3354085917), (-3354085907)⟩, ⟨(-1341634370), (-1341634360)⟩, ⟨(-134163438), (-134163435)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1967000817, 1967000834⟩, ⟨(-614439120), (-614439109)⟩, ⟨34523363, 34523368⟩, ⟨9200906, 9200909⟩, ⟨(-1257740), (-1257739)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1561836200, 1561836216⟩, ⟨(-561327325), (-561327309)⟩, ⟨51604993, 51605005⟩, ⟨5584405, 5584416⟩, ⟨(-1305252), (-1305241)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨788663369, 1182995055⟩, ⟨197165842, 197165843⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2477659046, 3716488575⟩, ⟨619414760, 619414764⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1429299439, 3215923749⟩, ⟨714649716, 1071974586⟩, ⟨89331214, 89331216⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨357, 806⟩, ⟨178, 269⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94330), (-93880)⟩, ⟨178, 269⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-70632), (-31241)⟩, ⟨(-23485), (-15418)⟩, ⟨(-1926), (-1866)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5042424, 5081816⟩, ⟨(-23485), (-15418)⟩, ⟨(-1926), (-1866)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1678041, 3805089⟩, ⟨821435, 1263233⟩, ⟨97572, 102512⟩, ⟨(-969), (-621)⟩, ⟨(-41), (-34)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141487536), (-139360487)⟩, ⟨821435, 1263233⟩, ⟨97572, 102512⟩, ⟨(-969), (-621)⟩, ⟨(-41), (-34)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-105941000), (-46377039)⟩, ⟨(-35040306), (-22242653)⟩, ⟨(-2773656), (-2506517)⟩, ⟨32594, 51655⟩, ⟨1756, 2019⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1325714765, 1385278727⟩, ⟨(-35040306), (-22242653)⟩, ⟨(-2773656), (-2506517)⟩, ⟨32594, 51655⟩, ⟨1756, 2019⟩⟩
...
def j70 : Jet := ⟨⟨(-81), (-35)⟩, ⟨(-27), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11754, 11801⟩, ⟨(-27), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3911, 8837⟩, ⟨1934, 2941⟩, ⟨234, 244⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848266), (-843339)⟩, ⟨1934, 2941⟩, ⟨234, 244⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-635153), (-280650)⟩, ⟨(-211075), (-138122)⟩, ⟨(-17246), (-16622)⟩, ⟨76, 123⟩, ⟨2, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35156241, 35510745⟩, ⟨(-211075), (-138122)⟩, ⟨(-17246), (-16622)⟩, ⟨76, 123⟩, ⟨2, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11699459, 26589225⟩, ⟨5691683, 8817111⟩, ⟨665620, 710077⟩, ⟨(-8671), (-5544)⟩, ⟨(-347), (-309)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704128424), (-689238657)⟩, ⟨5691683, 8817111⟩, ⟨665620, 710077⟩, ⟨(-8671), (-5544)⟩, ⟨(-347), (-309)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-527227140), (-229368085)⟩, ⟨(-173848276), (-108082092)⟩, ⟨(-13476639), (-11603173)⟩, ⟨222642, 358772⟩, ⟨11419, 13745⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3767740156, 4065599211⟩, ⟨(-173848276), (-108082092)⟩, ⟨(-13476639), (-11603173)⟩, ⟨222642, 358772⟩, ⟨11419, 13745⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨764771639, 1198698898⟩, ⟨160872096, 186951922⟩, ⟨(-7453549), (-4653753)⟩, ⟨(-381212), (-316788)⟩, ⟨5712, 9198⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4537275593, 4895970346⟩, ⟨120621392, 225906239⟩, ⟨16155994, 27935749⟩, ⟨341701, 1828911⟩, ⟨18702, 163435⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨807917605, 1366435145⟩, ⟨191426103, 276161504⟩, ⟨(-1101777), 12713672⟩, ⟨(-160615), 1261073⟩, ⟨(-46370), 109309⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1182995055), (-788663369)⟩, ⟨(-197165843), (-197165842)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3111972241, 3506303927⟩, ⟨(-197165843), (-197165842)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨151975745, 434728574⟩, ⟨72017552, 175720448⟩, ⟨7830777, 25846529⟩, ⟨(-243888), 2437366⟩, ⟨(-53424), 269361⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4446943041, 4729695870⟩, ⟨72017552, 175720448⟩, ⟨7830777, 25846529⟩, ⟨(-243888), 2437366⟩, ⟨(-53424), 269361⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4370294604, 4507093197⟩, ⟨34314026, 86345847⟩, ⟨2904013, 12565807⟩, ⟨(-368111), 1174877⟩, ⟨(-67530), 138668⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3166551583, 3679478210⟩, ⟨(-182041092), (-130133245)⟩, ⟨(-1859677), 8683183⟩, ⟨(-877367), 825829⟩, ⟨(-109065), 130105⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4294098537, 6441147816⟩, ⟨1073524633, 1073524639⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4293229953, 9659767428⟩, ⟨2146614974, 3219922486⟩, ⟨268326871, 268326875⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4293229953, 9659767428⟩, ⟨2146614974, 3219922486⟩, ⟨268326871, 268326875⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9659767428), (-4293229953)⟩, ⟨(-3219922486), (-2146614974)⟩, ⟨(-268326875), (-268326871)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4829883714), (-2146614976)⟩, ⟨(-1609961243), (-1073307487)⟩, ⟨(-134163438), (-134163435)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1395006398, 2605556279⟩, ⟨(-976688375), (-348610526)⟩, ⟨(-37832011), 139478680⟩, ⟨(-10168002), 25066533⟩, ⟨(-4527510), 1543751⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1028496706, 2232167766⟩, ⟨(-947160159), (-299287475)⟩, ⟨(-22976134), 166155098⟩, ⟨(-17129489), 24001771⟩, ⟨(-5271583), 2313925⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨985829212, 985829213⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4426248343, 4426248347⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified578
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨788663369, 1182995055⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4370294604, 4507093197⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified579
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (72508953 / 2147483648)

theorem envelope_integral : (∫ s in ((1469 / 8000) : ℝ)..(4407 / 16000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((1469 / 8000) : ℝ)..(4407 / 16000), prawitzNormalCorrection
