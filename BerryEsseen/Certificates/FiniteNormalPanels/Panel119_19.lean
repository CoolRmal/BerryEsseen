...
namespace FiniteNormalPanel119_19
...
def j2 : Jet := ⟨⟨1554043749, 1554043753⟩, ⟨518014583, 518014587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨562298105, 562298109⟩, ⟨374865402, 374865408⟩, ⟨62477567, 62477569⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-12379), (-12377)⟩, ⟨(-8241), (-8238)⟩, ⟨(-1367), (-1363)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100677, 5100680⟩, ⟨(-8241), (-8238)⟩, ⟨(-1367), (-1363)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨667781, 667783⟩, ⟨444108, 444111⟩, ⟨73298, 73302⟩, ⟨(-240), (-236)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-142497796), (-142497793)⟩, ⟨444108, 444111⟩, ⟨73298, 73302⟩, ⟨(-240), (-236)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18655845), (-18655843)⟩, ⟨(-12379088), (-12379085)⟩, ⟨(-2024515), (-2024511)⟩, ⟨12825, 12829⟩, ⟨1042, 1045⟩⟩
...
def j19 : Jet := ⟨⟨1412999920, 1412999923⟩, ⟨(-12379088), (-12379085)⟩, ⟨(-2024515), (-2024511)⟩, ⟨12825, 12829⟩, ⟨1042, 1045⟩⟩
...
def j25 : Jet := ⟨⟨1547, 1548⟩, ⟨1029, 1031⟩, ⟨169, 172⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850630), (-850628)⟩, ⟨1029, 1031⟩, ⟨169, 172⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-111365), (-111364)⟩, ⟨(-74110), (-74107)⟩, ⟨(-12263), (-12260)⟩, ⟨27, 31⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35680029, 35680031⟩, ⟨(-74110), (-74107)⟩, ⟨(-12263), (-12260)⟩, ⟨27, 31⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4671237, 4671238⟩, ⟨3104455, 3104457⟩, ⟨510951, 510954⟩, ⟨(-2147), (-2143)⟩, ⟨(-177), (-174)⟩⟩
...
def j33 : Jet := ⟨⟨(-711156646), (-711156644)⟩, ⟨3104455, 3104457⟩, ⟨510951, 510954⟩, ⟨(-2147), (-2143)⟩, ⟨(-177), (-174)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-93104793), (-93104791)⟩, ⟨(-61663427), (-61663423)⟩, ⟨(-10007128), (-10007123)⟩, ⟨89472, 89477⟩, ⟨7220, 7224⟩⟩
...
def j36 : Jet := ⟨⟨4201862503, 4201862505⟩, ⟨(-61663427), (-61663423)⟩, ⟨(-10007128), (-10007123)⟩, ⟨89472, 89477⟩, ⟨7220, 7224⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨511264357, 511264360⟩, ⟨165942338, 165942343⟩, ⟨(-2225567), (-2225563)⟩, ⟨(-239537), (-239533)⟩, ⟨1923, 1927⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4390135101, 4390135104⟩, ⟨64426371, 64426378⟩, ⟨11400984, 11400992⟩, ⟨227262, 227271⟩, ⟨21564, 21574⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨522592943, 522592947⟩, ⟨177288471, 177288479⟩, ⟨1571474, 1571484⟩, ⟨189315, 189325⟩, ⟨3809, 3820⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-494667490), (-494667489)⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3800299806, 3800299807⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨63586836, 63586838⟩, ⟨43143380, 43143384⟩, ⟨7700566, 7700572⟩, ⟨175804, 175812⟩, ⟨17128, 17135⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4358554132, 4358554134⟩, ⟨43143380, 43143384⟩, ⟨7700566, 7700572⟩, ⟨175804, 175812⟩, ⟨17128, 17135⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4326643902, 4326643904⟩, ⟨21413757, 21413760⟩, ⟨3769102, 3769106⟩, ⟨68604, 68609⟩, ⟨6518, 6524⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3828328098, 3828328102⟩, ⟨(-147157815), (-147157810)⟩, ⟨2512898, 2512904⟩, ⟨(-83999), (-83992)⟩, ⟨3133, 3140⟩⟩
...
def j47 : Jet := ⟨⟨3679292827, 3679292836⟩, ⟨1226430942, 1226430951⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3151873989, 3151874006⟩, ⟨2101249324, 2101249348⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3151873989, 3151874006⟩, ⟨2101249324, 2101249348⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3151874006), (-3151873989)⟩, ⟨(-2101249348), (-2101249324)⟩, ⟨(-350208227), (-350208220)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1575937003), (-1575936994)⟩, ⟨(-1050624674), (-1050624662)⟩, ⟨(-175104114), (-175104110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2975813698, 2975813709⟩, ⟨(-727936465), (-727936453)⟩, ⟨(-32289706), (-32289699)⟩, ⟨22417996, 22417999⟩, ⟨(-712741), (-712739)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2652497774, 2652497788⟩, ⟨(-750807550), (-750807533)⟩, ⟨(-2099235), (-2099219)⟩, ⟨20604562, 20604575⟩, ⟨(-1405897), (-1405884)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨329778326, 659556653⟩, ⟨164889163, 164889164⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1036029166, 2072058336⟩, ⟨518014583, 518014587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨249910269, 999641081⟩, ⟨249910268, 499820544⟩, ⟨62477567, 62477569⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-22024), (-5494)⟩, ⟨(-11009), (-5464)⟩, ⟨(-1374), (-1354)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5091032, 5107563⟩, ⟨(-11009), (-5464)⟩, ⟨(-1374), (-1354)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨296230, 1188771⟩, ⟨293667, 594069⟩, ⟨72455, 73904⟩, ⟨(-321), (-156)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142869347), (-141976805)⟩, ⟨293667, 594069⟩, ⟨72455, 73904⟩, ⟨(-321), (-156)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-33252423), (-8261171)⟩, ⟨(-16609125), (-8122903)⟩, ⟨(-2056975), (-1978957)⟩, ⟨8411, 17234⟩, ⟨1010, 1067⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1398403342, 1423394595⟩, ⟨(-16609125), (-8122903)⟩, ⟨(-2056975), (-1978957)⟩, ⟨8411, 17234⟩, ⟨1010, 1067⟩⟩
...
def j72 : Jet := ⟨⟨687, 2754⟩, ⟨683, 1377⟩, ⟨168, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851490), (-849422)⟩, ⟨683, 1377⟩, ⟨168, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-198182), (-49425)⟩, ⟨(-99052), (-49104)⟩, ⟨(-12339), (-12154)⟩, ⟨17, 42⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35593212, 35741970⟩, ⟨(-99052), (-49104)⟩, ⟨(-12339), (-12154)⟩, ⟨17, 42⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2071053, 8318840⟩, ⟨2047998, 4156563⟩, ⟨503363, 516364⟩, ⟨(-2877), (-1411)⟩, ⟨(-180), (-170)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713756830), (-707509042)⟩, ⟨2047998, 4156563⟩, ⟨503363, 516364⟩, ⟨(-2877), (-1411)⟩, ⟨(-180), (-170)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-166124816), (-41167665)⟩, ⟨(-82943243), (-40200236)⟩, ⟨(-10234347), (-9688019)⟩, ⟨58410, 120475⟩, ⟨6945, 7421⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4128842480, 4253799631⟩, ⟨(-82943243), (-40200236)⟩, ⟨(-10234347), (-9688019)⟩, ⟨58410, 120475⟩, ⟨6945, 7421⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨337321927, 686700604⟩, ⟨160648078, 169715751⟩, ⟨(-2995587), (-1457062)⟩, ⟨(-246064), (-230366)⟩, ⟨1257, 2594⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4336533375, 4467776178⟩, ⟨40982105, 89751995⟩, ⟨10263742, 12877484⟩, ⟨63797, 419819⟩, ⟨13640, 32482⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨340586480, 714330143⟩, ⟨165421495, 190894292⟩, ⟨(-777128), 4134306⟩, ⟨70348, 329480⟩, ⟨(-9399), 18804⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-659556653), (-329778326)⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3635410643, 3965188970⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨27008156, 118805923⟩, ⟨26235508, 63498294⟩, ⟨6112738, 9859716⟩, ⟨(-57926), 477106⟩, ⟨1541, 39526⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4321975452, 4413773219⟩, ⟨26235508, 63498294⟩, ⟨6112738, 9859716⟩, ⟨(-57926), 477106⟩, ⟨1541, 39526⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308450210, 4353965047⟩, ⟨12940003, 31649791⟩, ⟨2899919, 4894999⟩, ⟨(-64832), 229098⟩, ⟨(-3697), 19203⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3646823053, 4019656727⟩, ⟨(-156201291), (-136187147)⟩, ⟨1239516, 4022367⟩, ⟨(-247781), 100177⟩, ⟨(-12210), 20218⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2452861885, 4905723779⟩, ⟨1226430942, 1226430951⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1400832884, 5603331560⟩, ⟨1400832884, 2801665794⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1400832884, 5603331560⟩, ⟨1400832884, 2801665794⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5603331560), (-1400832884)⟩, ⟨(-2801665794), (-1400832884)⟩, ⟨(-350208227), (-350208220)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2801665780), (-700416442)⟩, ⟨(-1400832897), (-700416442)⟩, ⟨(-175104114), (-175104110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2236987941, 3648680263⟩, ⟨(-1190041971), (-364804438)⟩, ⟨(-119009384), 102869047⟩, ⟨(-1268527), 45283601⟩, ⟨(-5789355), 2529418⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1899408919, 3414797170⟩, ⟨(-1246456240), (-380684211)⟩, ⟨(-99167791), 142972145⟩, ⟨(-6253410), 46688898⟩, ⟨(-7214735), 2595587⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4326643902, 4326643904⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2406
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308450210, 4353965047⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2407
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (203651543 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((30713 / 400000) : ℝ)..(30713 / 200000), prawitzNormalCorrection
