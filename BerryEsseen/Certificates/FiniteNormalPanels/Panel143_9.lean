...
namespace FiniteNormalPanel143_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (183113 / 800000)
def radius : Rat := (26159 / 800000)

def j0 : Jet := ⟨⟨983080433, 983080434⟩, ⟨140440061, 140440062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3088438266, 3088438270⟩, ⟨441205463, 441205468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2220843667, 2220843674⟩, ⟨634526756, 634526766⟩, ⟨45323339, 45323341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨555, 557⟩, ⟨158, 159⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94132), (-94129)⟩, ⟨158, 159⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48674), (-48672)⟩, ⟨(-13826), (-13823)⟩, ⟨(-966), (-962)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064382, 5064385⟩, ⟨(-13826), (-13823)⟩, ⟨(-966), (-962)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2618692, 2618695⟩, ⟨741047, 741052⟩, ⟨50899, 50904⟩, ⟨(-288), (-284)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140546885), (-140546881)⟩, ⟨741047, 741052⟩, ⟨50899, 50904⟩, ⟨(-288), (-284)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-72674049), (-72674045)⟩, ⟨(-20380834), (-20380828)⟩, ⟨(-1347346), (-1347339)⟩, ⟨15190, 15196⟩, ⟨488, 493⟩⟩
...
def j19 : Jet := ⟨⟨1358981716, 1358981721⟩, ⟨(-20380834), (-20380828)⟩, ⟨(-1347346), (-1347339)⟩, ⟨15190, 15196⟩, ⟨488, 493⟩⟩
...
def j25 : Jet := ⟨⟨6090, 6092⟩, ⟨1731, 1734⟩, ⟨119, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846087), (-846084)⟩, ⟨1731, 1734⟩, ⟨119, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-437496), (-437493)⟩, ⟨(-124104), (-124101)⟩, ⟨(-8613), (-8607)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35353898, 35353902⟩, ⟨(-124104), (-124101)⟩, ⟨(-8613), (-8607)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18280809, 18280812⟩, ⟨5158916, 5158920⟩, ⟨350288, 350294⟩, ⟨(-2566), (-2560)⟩, ⟨(-88), (-82)⟩⟩
...
def j33 : Jet := ⟨⟨(-697547074), (-697547070)⟩, ⟨5158916, 5158920⟩, ⟨350288, 350294⟩, ⟨(-2566), (-2560)⟩, ⟨(-88), (-82)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-360687964), (-360687960)⟩, ⟨(-100386131), (-100386124)⟩, ⟨(-6417688), (-6417682)⟩, ⟨104863, 104870⟩, ⟨3270, 3277⟩⟩
...
def j36 : Jet := ⟨⟨3934279332, 3934279336⟩, ⟨(-100386131), (-100386124)⟩, ⟨(-6417688), (-6417682)⟩, ⟨104863, 104870⟩, ⟨3270, 3277⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨977220743, 977220749⟩, ⟨124947449, 124947457⟩, ⟨(-3062499), (-3062492)⟩, ⟨(-127486), (-127478)⟩, ⟨1910, 1917⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4688722507, 4688722513⟩, ⟨119636314, 119636324⟩, ⟨10700956, 10700966⟩, ⟨343214, 343227⟩, ⟨19115, 19131⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1066810659, 1066810668⟩, ⟨163622899, 163622913⟩, ⟨2571902, 2571916⟩, ⟨164917, 164934⟩, ⟨5235, 5252⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-983080434), (-983080433)⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3311886862, 3311886863⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨264981058, 264981064⟩, ⟨81283344, 81283352⟩, ⟨7511095, 7511107⟩, ⟨277886, 277898⟩, ⟨16704, 16719⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4559948354, 4559948360⟩, ⟨81283344, 81283352⟩, ⟨7511095, 7511107⟩, ⟨277886, 277898⟩, ⟨16704, 16719⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4425475008, 4425475012⟩, ⟨39443144, 39443149⟩, ⟨3469022, 3469029⟩, ⟨103926, 103933⟩, ⟨5819, 5828⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3412522500, 3412522505⟩, ⟨(-114292549), (-114292542)⟩, ⟨1385251, 1385258⟩, ⟨(-33295), (-33288)⟩, ⟨1088, 1097⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨46756791960, 46756791968⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value590

def j47 : Jet := ⟨⟨10702220556, 10702220570⟩, ⟨1528888641, 1528888653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨26667845628, 26667845699⟩, ⟨7619384416, 7619384486⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨26667845628, 26667845699⟩, ⟨7619384416, 7619384486⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-26667845699), (-26667845628)⟩, ⟨(-7619384486), (-7619384416)⟩, ⟨(-544241750), (-544241740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-13333922850), (-13333922814)⟩, ⟨(-3809692243), (-3809692208)⟩, ⟨(-272120875), (-272120870)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨192607294, 192607300⟩, ⟨(-170845198), (-170845190)⟩, ⟨63567731, 63567737⟩, ⟨(-11578857), (-11578854)⟩, ⟨553883, 553885⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨153034162, 153034168⟩, ⟨(-140868748), (-140868739)⟩, ⟨55115541, 55115549⟩, ⟨(-10948049), (-10948042)⟩, ⟨770078, 770085⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨842640371, 1123520495⟩, ⟨140440061, 140440062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2647232799, 3529643734⟩, ⟨441205463, 441205468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1631640245, 2900693773⟩, ⟨543880076, 725173446⟩, ⟨45323339, 45323341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨408, 727⟩, ⟨136, 182⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94279), (-93959)⟩, ⟨136, 182⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-63674), (-35694)⟩, ⟨(-15868), (-11775)⟩, ⟨(-974), (-951)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5049382, 5077363⟩, ⟨(-15868), (-11775)⟩, ⟨(-974), (-951)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1918239, 3429101⟩, ⟨628696, 852803⟩, ⟨49946, 51728⟩, ⟨(-333), (-240)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141247338), (-139736475)⟩, ⟨628696, 852803⟩, ⟨49946, 51728⟩, ⟨(-333), (-240)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-95394271), (-53085306)⟩, ⟨(-23609729), (-17119144)⟩, ⟨(-1391950), (-1295665)⟩, ⟨12733, 17643⟩, ⟨462, 513⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1336261494, 1378570460⟩, ⟨(-23609729), (-17119144)⟩, ⟨(-1391950), (-1295665)⟩, ⟨12733, 17643⟩, ⟨462, 513⟩⟩
...
def j70 : Jet := ⟨⟨(-73), (-40)⟩, ⟨(-19), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11762, 11796⟩, ⟨(-19), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4468, 7967⟩, ⟨1476, 1988⟩, ⟨118, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847709), (-844209)⟩, ⟨1476, 1988⟩, ⟨118, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-572518), (-320711)⟩, ⟨(-142570), (-105560)⟩, ⟨(-8716), (-8488)⟩, ⟨27, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35218876, 35470684⟩, ⟨(-142570), (-105560)⟩, ⟨(-8716), (-8488)⟩, ⟨27, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13379504, 23955850⟩, ⟨4363546, 5948862⟩, ⟨341693, 357720⟩, ⟨(-2967), (-2158)⟩, ⟨(-90), (-79)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702448379), (-691872032)⟩, ⟨4363546, 5948862⟩, ⟨341693, 357720⟩, ⟨(-2967), (-2158)⟩, ⟨(-90), (-79)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-474412842), (-262839312)⟩, ⟨(-116945518), (-83595417)⟩, ⟨(-6730330), (-6055075)⟩, ⟨87312, 122357⟩, ⟨3043, 3472⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3820554454, 4032127984⟩, ⟨(-116945518), (-83595417)⟩, ⟨(-6730330), (-6055075)⟩, ⟨87312, 122357⟩, ⟨3043, 3472⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨823614014, 1132921918⟩, ⟨117866307, 131063739⟩, ⟨(-3569255), (-2557175)⟩, ⟨(-135142), (-118598)⟩, ⟨1592, 2235⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4574940117, 4828289793⟩, ⟨94849177, 147791861⟩, ⟨8836663, 13029413⟩, ⟨179122, 554626⟩, ⟨8338, 34120⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨877302324, 1273601161⟩, ⟨143738091, 186322806⟩, ⟨285012, 5222984⟩, ⟨2107, 361101⟩, ⟨(-7271), 20559⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1123520495), (-842640371)⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3171446801, 3452326925⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨179200285, 377665255⟩, ⟨58720708, 110501864⟩, ⟨4926863, 11180573⟩, ⟨19936, 667322⟩, ⟨(-4156), 49878⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4474167581, 4672632551⟩, ⟨58720708, 110501864⟩, ⟨4926863, 11180573⟩, ⟨19936, 667322⟩, ⟨(-4156), 49878⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4383651838, 4479821871⟩, ⟨28148833, 54133165⟩, ⟨2034714, 5386815⟩, ⟨(-56756), 313846⟩, ⟨(-9223), 24665⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3236932353, 3600914419⟩, ⟨(-125699197), (-99827289)⟩, ⟨(-267634), 3409532⟩, ⟨(-221764), 185740⟩, ⟨(-17677), 21682⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9173331904, 12231109212⟩, ⟨1528888641, 1528888653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨19592702905, 34831471871⟩, ⟨6530900926, 8707867978⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨19592702905, 34831471871⟩, ⟨6530900926, 8707867978⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-34831471871), (-19592702905)⟩, ⟨(-8707867978), (-6530900926)⟩, ⟨(-544241750), (-544241740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-17415735936), (-9796351452)⟩, ⟨(-4353933989), (-3265450463)⟩, ⟨(-272120875), (-272120870)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨74461498, 438916160⟩, ⟨(-444942152), (-56612848)⟩, ⟨(-6287598), 220807701⟩, ⟨(-72221822), 20918428⟩, ⟨(-12296382), 18502529⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨56118432, 367988723⟩, ⟨(-385886529), (-44397368)⟩, ⟨(-3983050), 198496275⟩, ⟨(-67389184), 17768803⟩, ⟨(-10956348), 17826746⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨983080433, 983080434⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4425475008, 4425475012⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar590 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2878
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar590 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨842640371, 1123520495⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4383651838, 4479821871⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2879
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((78477 / 400000) : ℝ)..(26159 / 100000), prawitzNormalCorrection
      ((140543 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
