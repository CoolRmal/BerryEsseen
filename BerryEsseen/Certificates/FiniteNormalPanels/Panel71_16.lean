...
namespace FiniteNormalPanel71_16

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (9963 / 80000)
def radius : Rat := (3321 / 80000)

def j0 : Jet := ⟨⟨534884489, 534884490⟩, ⟨178294829, 178294830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1680389181, 1680389185⟩, ⟨560129724, 560129729⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨657445704, 657445708⟩, ⟨438297132, 438297140⟩, ⟨73049521, 73049524⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-14469), (-14468)⟩, ⟨(-9630), (-9628)⟩, ⟨(-1595), (-1592)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098587, 5098589⟩, ⟨(-9630), (-9628)⟩, ⟨(-1595), (-1592)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨780458, 780459⟩, ⟨518830, 518833⟩, ⟨85489, 85493⟩, ⟨(-327), (-324)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-142385119), (-142385117)⟩, ⟨518830, 518833⟩, ⟨85489, 85493⟩, ⟨(-327), (-324)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-21795390), (-21795389)⟩, ⟨(-14450841), (-14450839)⟩, ⟨(-2355678), (-2355675)⟩, ⟨17497, 17501⟩, ⟨1415, 1419⟩⟩
...
def j19 : Jet := ⟨⟨1409860375, 1409860377⟩, ⟨(-14450841), (-14450839)⟩, ⟨(-2355678), (-2355675)⟩, ⟨17497, 17501⟩, ⟨1415, 1419⟩⟩
...
def j22 : Jet := ⟨⟨(-17), (-16)⟩, ⟨(-12), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11818, 11820⟩, ⟨(-12), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1809, 1810⟩, ⟨1204, 1206⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850368), (-850366)⟩, ⟨1204, 1206⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-130169), (-130168)⟩, ⟨(-86596), (-86594)⟩, ⟨(-14312), (-14308)⟩, ⟨39, 42⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35661225, 35661227⟩, ⟨(-86596), (-86594)⟩, ⟨(-14312), (-14308)⟩, ⟨39, 42⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5458788, 5458790⟩, ⟨3625936, 3625938⟩, ⟨595503, 595507⟩, ⟨(-2929), (-2925)⟩, ⟨(-241), (-237)⟩⟩
...
def j33 : Jet := ⟨⟨(-710369095), (-710369092)⟩, ⟨3625936, 3625938⟩, ⟨595503, 595507⟩, ⟨(-2929), (-2925)⟩, ⟨(-241), (-237)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-108738689), (-108738687)⟩, ⟨(-71937426), (-71937421)⟩, ⟨(-11620899), (-11620895)⟩, ⟨121991, 121995⟩, ⟨9792, 9795⟩⟩
...
def j36 : Jet := ⟨⟨4186228607, 4186228609⟩, ⟨(-71937426), (-71937421)⟩, ⟨(-11620899), (-11620895)⟩, ⟨121991, 121995⟩, ⟨9792, 9795⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨551602365, 551602368⟩, ⟨178213618, 178213623⟩, ⟨(-2806262), (-2806259)⟩, ⟨(-300372), (-300368)⟩, ⟨2834, 2839⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4406530506, 4406530509⟩, ⟨75723154, 75723162⟩, ⟨13533697, 13533705⟩, ⟨314357, 314365⟩, ⟨30452, 30461⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨565930420, 565930425⟩, ⟨192567895, 192567903⟩, ⟨2001000, 2001008⟩, ⟨244281, 244291⟩, ⟨5721, 5734⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-534884490), (-534884489)⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3760082806, 3760082807⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨74570356, 74570358⟩, ⟨50747780, 50747784⟩, ⟨9161243, 9161249⟩, ⟨243806, 243814⟩, ⟨24342, 24351⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4369537652, 4369537654⟩, ⟨50747780, 50747784⟩, ⟨9161243, 9161249⟩, ⟨243806, 243814⟩, ⟨24342, 24351⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4332092025, 4332092027⟩, ⟨25156443, 25156446⟩, ⟨4468324, 4468329⟩, ⟨94910, 94916⟩, ⟨9210, 9217⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3792584114, 3792584117⟩, ⟨(-157812449), (-157812443)⟩, ⟨2867543, 2867549⟩, ⟨(-102402), (-102395)⟩, ⟨4122, 4131⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨28296040570, 28296040577⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value362

def j47 : Jet := ⟨⟨3523918148, 3523918156⟩, ⟨1174639378, 1174639386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2891290726, 2891290740⟩, ⟨1927527142, 1927527162⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2891290726, 2891290740⟩, ⟨1927527142, 1927527162⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2891290740), (-2891290726)⟩, ⟨(-1927527162), (-1927527142)⟩, ⟨(-321254527), (-321254522)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1445645370), (-1445645363)⟩, ⟨(-963763581), (-963763571)⟩, ⟨(-160627264), (-160627261)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3067470862, 3067470871⟩, ⟨(-688321123), (-688321113)⟩, ⟨(-37492730), (-37492724)⟩, ⟨19966033, 19966036⟩, ⟨(-418970), (-418968)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2708668182, 2708668194⟩, ⟨(-720517909), (-720517893)⟩, ⟨(-5767820), (-5767806)⟩, ⟨18475522, 18475534⟩, ⟨(-1109267), (-1109253)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨356589659, 713179320⟩, ⟨178294829, 178294830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1120259453, 2240518913⟩, ⟨560129724, 560129729⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨292198090, 1168792369⟩, ⟨292198088, 584396186⟩, ⟨73049521, 73049524⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨73, 293⟩, ⟨73, 147⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94614), (-94393)⟩, ⟨73, 147⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-25748), (-6421)⟩, ⟨(-12870), (-6380)⟩, ⟨(-1605), (-1578)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5087308, 5106636⟩, ⟨(-12870), (-6380)⟩, ⟨(-1605), (-1578)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨346103, 1389673⟩, ⟨342600, 694403⟩, ⟨84336, 86314⟩, ⟨(-438), (-213)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142819474), (-141775903)⟩, ⟨342600, 694403⟩, ⟨84336, 86314⟩, ⟨(-438), (-213)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-38865561), (-9645393)⟩, ⟨(-19409474), (-9456424)⟩, ⟨(-2400054), (-2293374)⟩, ⟨11443, 23542⟩, ⟨1366, 1454⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1392790204, 1422010373⟩, ⟨(-19409474), (-9456424)⟩, ⟨(-2400054), (-2293374)⟩, ⟨11443, 23542⟩, ⟨1366, 1454⟩⟩
...
def j72 : Jet := ⟨⟨803, 3220⟩, ⟨798, 1610⟩, ⟨196, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851374), (-848956)⟩, ⟨798, 1610⟩, ⟨196, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-231685), (-57756)⟩, ⟨(-115789), (-57317)⟩, ⟨(-14414), (-14164)⟩, ⟨25, 56⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35559709, 35733639⟩, ⟨(-115789), (-57317)⟩, ⟨(-14414), (-14164)⟩, ⟨25, 56⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2419221, 9724220⟩, ⟨2387711, 4858211⟩, ⟨585127, 602902⟩, ⟨(-3931), (-1921)⟩, ⟨(-245), (-230)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713408662), (-706103662)⟩, ⟨2387711, 4858211⟩, ⟨585127, 602902⟩, ⟨(-3931), (-1921)⟩, ⟨(-245), (-230)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-194140385), (-48038116)⟩, ⟨(-96907751), (-46716047)⟩, ⟨(-11931526), (-11184424)⟩, ⟨79347, 164535⟩, ⟨9349, 10110⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4100826911, 4246929180⟩, ⟨(-96907751), (-46716047)⟩, ⟨(-11931526), (-11184424)⟩, ⟨79347, 164535⟩, ⟨9349, 10110⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨363282484, 741808009⟩, ⟨171516066, 182985478⟩, ⟨(-3783310), (-1831444)⟩, ⟨(-310020), (-286810)⟩, ⟨1848, 3830⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4343548783, 4498298630⟩, ⟨47778858, 106300514⟩, ⟨11964439, 15600004⟩, ⟨83160, 593893⟩, ⟨17594, 48600⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨367391666, 776926510⟩, ⟨177497421, 210008095⟩, ⟨(-1042418), 5371100⟩, ⟨66489, 456781⟩, ⟨(-14740), 29418⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-713179320), (-356589659)⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3581787976, 3938377637⟩, ⟨(-178294830), (-178294829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨31426697, 140540023⟩, ⟨30366272, 75977696⟩, ⟨6958275, 12211806⟩, ⟨(-90568), 690514⟩, ⟨(-1144), 62031⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4326393993, 4435507319⟩, ⟨30366272, 75977696⟩, ⟨6958275, 12211806⟩, ⟨(-90568), 690514⟩, ⟨(-1144), 62031⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310652005, 4364671681⟩, ⟨14940659, 37850623⟩, ⟨3259453, 6057795⟩, ⟨(-98312), 332705⟩, ⟨(-7750), 30535⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3594868239, 4002294816⟩, ⟨(-168728672), (-144237864)⟩, ⟨1146946, 4934623⟩, ⟨(-341625), 169775⟩, ⟨(-20919), 32082⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2349278763, 4698557542⟩, ⟨1174639378, 1174639386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1285018098, 5140072428⟩, ⟨1285018094, 2570036216⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1285018098, 5140072428⟩, ⟨1285018094, 2570036216⟩, ⟨321254522, 321254527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5140072428), (-1285018098)⟩, ⟨(-2570036216), (-1285018094)⟩, ⟨(-321254527), (-321254522)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2570036214), (-642509049)⟩, ⟨(-1285018108), (-642509047)⟩, ⟨(-160627264), (-160627261)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2360942145, 3698207141⟩, ⟨(-1106472487), (-353187017)⟩, ⟨(-111891416), 77226880⟩, ⟨1104004, 38746263⟩, ⟨(-4342242), 2051023⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1976097917, 3446199761⟩, ⟨(-1176358825), (-374903445)⟩, ⟨(-91775234), 119681386⟩, ⟨(-3675249), 40553520⟩, ⟨(-5758811), 2078549⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨534884489, 534884490⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4332092025, 4332092027⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar362 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1426
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar362 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨356589659, 713179320⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310652005, 4364671681⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1427
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((3321 / 40000) : ℝ)..(3321 / 20000), prawitzNormalCorrection
      ((24901 / 10000) * sqrt n) s) ≤ (upper : ℝ) :=
