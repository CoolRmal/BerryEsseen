...
namespace FiniteNormalPanel138_17

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (13643 / 50000)
def radius : Rat := (1949 / 50000)

def j0 : Jet := ⟨⟨1171924776, 1171924777⟩, ⟨167417825, 167417826⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3681710266, 3681710271⟩, ⟨525958609, 525958613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3156017158, 3156017168⟩, ⟨901719186, 901719196⟩, ⟨64408513, 64408515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨789, 791⟩, ⟨225, 226⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93898), (-93895)⟩, ⟨225, 226⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-68998), (-68995)⟩, ⟨(-19549), (-19546)⟩, ⟨(-1351), (-1347)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5044058, 5044062⟩, ⟨(-19549), (-19546)⟩, ⟨(-1351), (-1347)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3706462, 3706466⟩, ⟨1044624, 1044629⟩, ⟨70544, 70551⟩, ⟨(-574), (-569)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-139459115), (-139459110)⟩, ⟨1044624, 1044629⟩, ⟨70544, 70551⟩, ⟨(-574), (-569)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-102477000), (-102476995)⟩, ⟨(-28511535), (-28511529)⟩, ⟨(-1820216), (-1820206)⟩, ⟨30053, 30061⟩, ⟨921, 928⟩⟩
...
def j19 : Jet := ⟨⟨1329178765, 1329178771⟩, ⟨(-28511535), (-28511529)⟩, ⟨(-1820216), (-1820206)⟩, ⟨30053, 30061⟩, ⟨921, 928⟩⟩
...
def j22 : Jet := ⟨⟨(-80), (-78)⟩, ⟨(-23), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11755, 11758⟩, ⟨(-23), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8637, 8640⟩, ⟨2450, 2453⟩, ⟨169, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843540), (-843536)⟩, ⟨2450, 2453⟩, ⟨169, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-619848), (-619845)⟩, ⟨(-175300), (-175295)⟩, ⟨(-12012), (-12005)⟩, ⟨69, 74⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35171546, 35171550⟩, ⟨(-175300), (-175295)⟩, ⟨(-12012), (-12005)⟩, ⟨69, 74⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25844667, 25844671⟩, ⟨7255376, 7255383⟩, ⟨481811, 481820⟩, ⟨(-5101), (-5093)⟩, ⟨(-167), (-161)⟩⟩
...
def j33 : Jet := ⟨⟨(-689983216), (-689983211)⟩, ⟨7255376, 7255383⟩, ⟨481811, 481820⟩, ⟨(-5101), (-5093)⟩, ⟨(-167), (-161)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-507011748), (-507011742)⟩, ⟨(-139529124), (-139529114)⟩, ⟨(-8469886), (-8469875)⟩, ⟨206209, 206220⟩, ⟨6031, 6039⟩⟩
...
def j36 : Jet := ⟨⟨3787955548, 3787955554⟩, ⟨(-139529124), (-139529114)⟩, ⟨(-8469886), (-8469875)⟩, ⟨206209, 206220⟩, ⟨6031, 6039⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1139391936, 1139391944⟩, ⟨138329761, 138329770⟩, ⟨(-5051820), (-5051808)⟩, ⟨(-197142), (-197132)⟩, ⟨4469, 4478⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4869841741, 4869841750⟩, ⟨179380325, 179380341⟩, ⟨17496437, 17496455⟩, ⟨780453, 780474⟩, ⟨50338, 50354⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1291897708, 1291897721⟩, ⟨204431949, 204431966⟩, ⟨4690925, 4690947⟩, ⟨336035, 336059⟩, ⟨14742, 14763⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1171924777), (-1171924776)⟩, ⟨(-167417826), (-167417825)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3123042519, 3123042520⟩, ⟨(-167417826), (-167417825)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨388594271, 388594280⟩, ⟨122983550, 122983564⟩, ⟨12552554, 12552571⟩, ⟨648710, 648730⟩, ⟨45979, 45998⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4683561567, 4683561576⟩, ⟨122983550, 122983564⟩, ⟨12552554, 12552571⟩, ⟨648710, 648730⟩, ⟨45979, 45998⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4485057832, 4485057837⟩, ⟨58885564, 58885572⟩, ⟨5623706, 5623716⟩, ⟨236771, 236783⟩, ⟨15379, 15391⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3261264951, 3261264956⟩, ⟨(-132009508), (-132009499)⟩, ⟨1793861, 1793870⟩, ⟨(-47048), (-47037)⟩, ⟨1952, 1963⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨31041383960, 31041383967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value573

def j47 : Jet := ⟨⟨8469952024, 8469952034⟩, ⟨1209993145, 1209993153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16703290699, 16703290739⟩, ⟨4772368766, 4772368804⟩, ⟨340883482, 340883488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16703290699, 16703290739⟩, ⟨4772368766, 4772368804⟩, ⟨340883482, 340883488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16703290739), (-16703290699)⟩, ⟨(-4772368804), (-4772368766)⟩, ⟨(-340883488), (-340883482)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8351645370), (-8351645349)⟩, ⟨(-2386184402), (-2386184383)⟩, ⟨(-170441744), (-170441741)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨614420930, 614420938⟩, ⟨(-341358050), (-341358042)⟩, ⟨70442594, 70442599⟩, ⟨(-4014444), (-4014442)⟩, ⟨(-840142), (-840140)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨466543586, 466543593⟩, ⟨(-278085577), (-278085566)⟩, ⟨64237193, 64237202⟩, ⟨(-5362678), (-5362669)⟩, ⟨(-481114), (-481106)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1004506951, 1339342602⟩, ⟨167417825, 167417826⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3155751657, 4207668880⟩, ⟨525958609, 525958613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2318706484, 4122144870⟩, ⟨772902160, 1030536224⟩, ⟨64408513, 64408515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨580, 1033⟩, ⟨193, 259⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94107), (-93653)⟩, ⟨193, 259⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-90321), (-50560)⟩, ⟨(-22477), (-16604)⟩, ⟨(-1370), (-1324)⟩, ⟨4, 9⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5022735, 5062497⟩, ⟨(-22477), (-16604)⟩, ⟨(-1370), (-1324)⟩, ⟨4, 9⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2711603, 4858791⟩, ⟨882294, 1205735⟩, ⟨68613, 72218⟩, ⟨(-665), (-477)⟩, ⟨(-21), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140453974), (-138306785)⟩, ⟨882294, 1205735⟩, ⟨68613, 72218⟩, ⟨(-665), (-477)⟩, ⟨(-21), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-134802337), (-74667120)⟩, ⟨(-33224265), (-23731821)⟩, ⟨(-1910473), (-1715468)⟩, ⟨24939, 35154⟩, ⟨847, 991⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1296853428, 1356988646⟩, ⟨(-33224265), (-23731821)⟩, ⟨(-1910473), (-1715468)⟩, ⟨24939, 35154⟩, ⟨847, 991⟩⟩
...
def j70 : Jet := ⟨⟨(-104), (-57)⟩, ⟨(-26), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11731, 11779⟩, ⟨(-26), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6333, 11306⟩, ⟨2086, 2817⟩, ⟨166, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845844), (-840870)⟩, ⟨2086, 2817⟩, ⟨166, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-811809), (-453957)⟩, ⟨(-201827), (-148615)⟩, ⟨(-12221), (-11766)⟩, ⟨58, 85⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34979585, 35337438⟩, ⟨(-201827), (-148615)⟩, ⟨(-12221), (-11766)⟩, ⟨58, 85⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18884285, 33915518⟩, ⟨6101055, 8398648⟩, ⟨464406, 496834⟩, ⟨(-5929), (-4263)⟩, ⟨(-174), (-152)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696943598), (-681912364)⟩, ⟨6101055, 8398648⟩, ⟨464406, 496834⟩, ⟨(-5929), (-4263)⟩, ⟨(-174), (-152)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-668899733), (-368141247)⟩, ⟨(-163931184), (-114653048)⟩, ⟨(-9102926), (-7734126)⟩, ⟨169374, 242859⟩, ⟨5374, 6602⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3626067563, 3926826049⟩, ⟨(-163931184), (-114653048)⟩, ⟨(-9102926), (-7734126)⟩, ⟨169374, 242859⟩, ⟨5374, 6602⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨952870434, 1329406839⟩, ⟨126262780, 148738766⟩, ⟨(-5940262), (-4166630)⟩, ⟨(-215632), (-175634)⟩, ⟨3676, 5276⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4697621907, 5087258788⟩, ⟨137158270, 229990298⟩, ⟨13256916, 23168771⟩, ⟨342579, 1405386⟩, ⟨13335, 108334⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1042202353, 1574642171⟩, ⟨168529539, 247364695⟩, ⟨(-62759), 10578882⟩, ⟨(-107777), 912204⟩, ⟨(-26543), 69985⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1339342602), (-1004506951)⟩, ⟨(-167417826), (-167417825)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2955624694, 3290460345⟩, ⟨(-167417826), (-167417825)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨252897326, 577303108⟩, ⟨81789624, 181380138⟩, ⟨6566883, 22003709⟩, ⟨(-86258), 1887436⟩, ⟨(-32035), 182451⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4547864622, 4872270404⟩, ⟨81789624, 181380138⟩, ⟨6566883, 22003709⟩, ⟨(-86258), 1887436⟩, ⟨(-32035), 182451⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4419607428, 4574520964⟩, ⟨38395688, 88132462⟩, ⟨2233809, 10524802⟩, ⟨(-251792), 897698⟩, ⟨(-46000), 93110⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3041397047, 3504632002⟩, ⟨(-151892453), (-104756255)⟩, ⟨(-1898186), 6566599⟩, ⟨(-603160), 600672⟩, ⟨(-70235), 81149⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7259958879, 9679945180⟩, ⟨1209993145, 1209993153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12271805416, 21816542998⟩, ⟨4090601800, 5454135776⟩, ⟨340883482, 340883488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12271805416, 21816542998⟩, ⟨4090601800, 5454135776⟩, ⟨340883482, 340883488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21816542998), (-12271805416)⟩, ⟨(-5454135776), (-4090601800)⟩, ⟨(-340883488), (-340883482)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10908271499), (-6135902708)⟩, ⟨(-2727067888), (-2045300900)⟩, ⟨(-170441744), (-170441741)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨338803174, 1029237019⟩, ⟨(-653508870), (-161341027)⟩, ⟨(-2428303), 194026000⟩, ⟨(-36796834), 17803204⟩, ⟨(-6675884), 5889174⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨239916837, 839842715⟩, ⟨(-569653101), (-122514058)⟩, ⟨1498843, 183007538⟩, ⟨(-38031159), 15045806⟩, ⟨(-6271021), 6514681⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1171924776, 1171924777⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4485057832, 4485057837⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar573 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2780
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar573 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1004506951, 1339342602⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4419607428, 4574520964⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2781
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((5847 / 25000) : ℝ)..(1949 / 6250), prawitzNormalCorrection
      ((4829 / 2500) * sqrt n) s) ≤ (upper : ℝ) :=
