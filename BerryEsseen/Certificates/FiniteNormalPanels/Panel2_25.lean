...
namespace FiniteNormalPanel2_25
...
def j2 : Jet := ⟨⟨693120479, 693120483⟩, ⟨693120479, 693120483⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨111855566, 111855568⟩, ⟨223711132, 223711136⟩, ⟨111855566, 111855568⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨27, 29⟩, ⟨55, 57⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94660), (-94657)⟩, ⟨55, 57⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2466), (-2465)⟩, ⟨(-4930), (-4928)⟩, ⟨(-2464), (-2461)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110590, 5110592⟩, ⟨(-4930), (-4928)⟩, ⟨(-2464), (-2461)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨133097, 133098⟩, ⟨266065, 266067⟩, ⟨132775, 132778⟩, ⟨(-258), (-255)⟩, ⟨(-65), (-62)⟩⟩
...
def j16 : Jet := ⟨⟨(-143032480), (-143032478)⟩, ⟨266065, 266067⟩, ⟨132775, 132778⟩, ⟨(-258), (-255)⟩, ⟨(-65), (-62)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3725053), (-3725052)⟩, ⟨(-7443177), (-7443175)⟩, ⟨(-3707738), (-3707735)⟩, ⟨13837, 13840⟩, ⟨3441, 3444⟩⟩
...
def j19 : Jet := ⟨⟨1427930712, 1427930714⟩, ⟨(-7443177), (-7443175)⟩, ⟨(-3707738), (-3707735)⟩, ⟨13837, 13840⟩, ⟨3441, 3444⟩⟩
...
def j25 : Jet := ⟨⟨308, 309⟩, ⟨615, 617⟩, ⟨306, 309⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851869), (-851867)⟩, ⟨615, 617⟩, ⟨306, 309⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-22186), (-22185)⟩, ⟨(-44356), (-44354)⟩, ⟨(-22147), (-22143)⟩, ⟨30, 34⟩, ⟨5, 9⟩⟩
...
def j30 : Jet := ⟨⟨35769208, 35769210⟩, ⟨(-44356), (-44354)⟩, ⟨(-22147), (-22143)⟩, ⟨30, 34⟩, ⟨5, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨931551, 931552⟩, ⟨1861947, 1861949⟩, ⟨928663, 928666⟩, ⟨(-2310), (-2307)⟩, ⟨(-576), (-573)⟩⟩
...
def j33 : Jet := ⟨⟨(-714896332), (-714896330)⟩, ⟨1861947, 1861949⟩, ⟨928663, 928666⟩, ⟨(-2310), (-2307)⟩, ⟨(-576), (-573)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-18618334), (-18618333)⟩, ⟨(-37188177), (-37188175)⟩, ⟨(-18497167), (-18497164)⟩, ⟨96801, 96804⟩, ⟨24048, 24052⟩⟩
...
def j36 : Jet := ⟨⟨4276348962, 4276348963⟩, ⟨(-37188177), (-37188175)⟩, ⟨(-18497167), (-18497164)⟩, ⟨96801, 96804⟩, ⟨24048, 24052⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨230439011, 230439014⟩, ⟨229237833, 229237837⟩, ⟨(-1799532), (-1799530)⟩, ⟨(-596121), (-596119)⟩, ⟨2788, 2790⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4313666689, 4313666691⟩, ⟨37512698, 37512702⟩, ⟨18984798, 18984804⟩, ⟨229705, 229712⟩, ⟨59001, 59010⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨231442294, 231442298⟩, ⟨232248564, 232248570⟩, ⟨1213416, 1213421⟩, ⟨411175, 411182⟩, ⟨5063, 5071⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-220627102), (-220627101)⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4074340194, 4074340195⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨12471698, 12471699⟩, ⟨25030290, 25030292⟩, ⟨12689518, 12689521⟩, ⟨175540, 175548⟩, ⟨45354, 45361⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4307438994, 4307438995⟩, ⟨25030290, 25030292⟩, ⟨12689518, 12689521⟩, ⟨175540, 175548⟩, ⟨45354, 45361⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4301198624, 4301198626⟩, ⟨12497013, 12497015⟩, ⟨6317411, 6317414⟩, ⟨69287, 69293⟩, ⟨17802, 17808⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4080251426, 4080251430⟩, ⟨(-209092141), (-209092137)⟩, ⟨5350936, 5350942⟩, ⟨(-258791), (-258783)⟩, ⟨13327, 13335⟩⟩
...
def j47 : Jet := ⟨⟨946266208, 946266214⟩, ⟨946266208, 946266214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨208481153, 208481157⟩, ⟨416962306, 416962314⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨208481153, 208481157⟩, ⟨416962306, 416962314⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-208481157), (-208481153)⟩, ⟨(-416962314), (-416962306)⟩, ⟨(-208481157), (-208481153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-104240579), (-104240576)⟩, ⟨(-208481157), (-208481153)⟩, ⟨(-104240579), (-104240576)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4191981525, 4191981529⟩, ⟨(-203482146), (-203482141)⟩, ⟨(-96802481), (-96802476)⟩, ⟨4858685, 4858686⟩, ⟨1115756, 1115757⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3982414164, 3982414173⟩, ⟨(-397388058), (-397388047)⟩, ⟨(-76834329), (-76834314)⟩, ⟨8822330, 8822343⟩, ⟨728104, 728118⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 441254203⟩, ⟨220627101, 220627102⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1386240963⟩, ⟨693120479, 693120483⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 447422268⟩, ⟨0, 447422270⟩, ⟨111855566, 111855568⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 113⟩, ⟨0, 113⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94573)⟩, ⟨0, 113⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-9864), 0⟩, ⟨(-9864), 12⟩, ⟨(-2466), (-2447)⟩, ⟨0, 7⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5103192, 5113057⟩, ⟨(-9864), 12⟩, ⟨(-2466), (-2447)⟩, ⟨0, 7⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 532646⟩, ⟨(-1028), 532648⟩, ⟨131619, 133164⟩, ⟨(-514), 2⟩, ⟨(-65), (-61)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142632930)⟩, ⟨(-1028), 532648⟩, ⟨131619, 133164⟩, ⟨(-514), 2⟩, ⟨(-65), (-61)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-14914076), 0⟩, ⟨(-14914184), 55488⟩, ⟨(-3728627), (-3645285)⟩, ⟨(-81), 27746⟩, ⟨3366, 3470⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1416741689, 1431655766⟩, ⟨(-14914184), 55488⟩, ⟨(-3728627), (-3645285)⟩, ⟨(-81), 27746⟩, ⟨3366, 3470⟩⟩
...
def j72 : Jet := ⟨⟨0, 1233⟩, ⟨(-2), 1233⟩, ⟨304, 309⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-850943)⟩, ⟨(-2), 1233⟩, ⟨304, 309⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-88775), 0⟩, ⟨(-88776), 129⟩, ⟨(-22195), (-21999)⟩, ⟨(-2), 66⟩, ⟨5, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35702619, 35791395⟩, ⟨(-88776), 129⟩, ⟨(-22195), (-21999)⟩, ⟨(-2), 66⟩, ⟨5, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3728519⟩, ⟨(-9249), 3728534⟩, ⟨918255, 932144⟩, ⟨(-4627), 11⟩, ⟨(-580), (-564)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712099363)⟩, ⟨(-9249), 3728534⟩, ⟨918255, 932144⟩, ⟨(-4627), 11⟩, ⟨(-580), (-564)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-74570379), 0⟩, ⟨(-74571343), 388415⟩, ⟨(-18643559), (-18059970)⟩, ⟨(-724), 194211⟩, ⟨23370, 24279⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4220396917, 4294967296⟩, ⟨(-74571343), 388415⟩, ⟨(-18643559), (-18059970)⟩, ⟨(-724), 194211⟩, ⟨23370, 24279⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 462080322⟩, ⟨223819637, 231058072⟩, ⟨(-3610297), 8955⟩, ⟨(-601752), (-579318)⟩, ⟨(-14), 5598⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4370855263⟩, ⟨(-402263), 77229834⟩, ⟨18052985, 20672803⟩, ⟨(-204817), 707187⟩, ⟨44153, 80055⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 470244840⟩, ⟨223776358, 243449533⟩, ⟨(-3695729), 6387993⟩, ⟨241438, 609249⟩, ⟨(-39233), 52456⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-441254203), 0⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3853713093, 4294967296⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 51485890⟩, ⟨0, 53309318⟩, ⟨10849922, 15198141⟩, ⟨(-418968), 857588⟩, ⟨11069, 90057⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4346453186⟩, ⟨0, 53309318⟩, ⟨10849922, 15198141⟩, ⟨(-418968), 857588⟩, ⟨11069, 90057⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4320633552⟩, ⟨0, 26654659⟩, ⟨5310515, 7599071⟩, ⟨(-256644), 428794⟩, ⟨(-3851), 43339⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3853713093, 4320633552⟩, ⟨(-221945546), (-193972442)⟩, ⟨3395708, 7599071⟩, ⟨(-646999), 156000⟩, ⟨(-25878), 56523⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1892532423⟩, ⟨946266208, 946266214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 833924621⟩, ⟨0, 833924624⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 833924621⟩, ⟨0, 833924624⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-833924621), 0⟩, ⟨(-833924624), 0⟩, ⟨(-208481157), (-208481153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-416962311), 0⟩, ⟨(-416962312), 0⟩, ⟨(-104240579), (-104240576)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3897605295, 4294967296⟩, ⟨(-416962312), 0⟩, ⟨(-104240579), (-74356756)⟩, ⟨0, 10119843⟩, ⟨656721, 1264981⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3497175070, 4320633552⟩, ⟨(-641399580), (-176026489)⟩, ⟨(-101781967), (-37571627)⟩, ⟨1973424, 15723027⟩, ⟨(-159156), 1333088⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4301198624, 4301198626⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified40
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4320633552⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified41
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (406539413 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(8219 / 80000), prawitzNormalCorrection
