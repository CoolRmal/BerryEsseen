...
namespace FiniteNormalPanel100_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (27587 / 100000)
def radius : Rat := (3941 / 100000)

def j0 : Jet := ⟨⟨1184852627, 1184852628⟩, ⟨169264661, 169264662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3722324308, 3722324312⟩, ⟨531760615, 531760619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3226031142, 3226031150⟩, ⟨921723182, 921723192⟩, ⟨65837370, 65837372⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨807, 809⟩, ⟨230, 231⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93880), (-93877)⟩, ⟨230, 231⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-70516), (-70512)⟩, ⟨(-19976), (-19972)⟩, ⟨(-1379), (-1376)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5042540, 5042545⟩, ⟨(-19976), (-19972)⟩, ⟨(-1379), (-1376)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3787547, 3787551⟩, ⟨1067151, 1067157⟩, ⟨71973, 71978⟩, ⟨(-599), (-594)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-139378030), (-139378025)⟩, ⟨1067151, 1067157⟩, ⟨71973, 71978⟩, ⟨(-599), (-594)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-104689474), (-104689469)⟩, ⟨(-29109722), (-29109715)⟩, ⟨(-1853444), (-1853436)⟩, ⟨31353, 31360⟩, ⟨958, 964⟩⟩
...
def j19 : Jet := ⟨⟨1326966291, 1326966297⟩, ⟨(-29109722), (-29109715)⟩, ⟨(-1853444), (-1853436)⟩, ⟨31353, 31360⟩, ⟨958, 964⟩⟩
...
def j22 : Jet := ⟨⟨(-82), (-80)⟩, ⟨(-24), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11753, 11756⟩, ⟨(-24), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8827, 8831⟩, ⟨2503, 2507⟩, ⟨172, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843350), (-843345)⟩, ⟨2503, 2507⟩, ⟨172, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-633457), (-633452)⟩, ⟨(-179108), (-179102)⟩, ⟨(-12262), (-12255)⟩, ⟨72, 77⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35157937, 35157943⟩, ⟨(-179108), (-179102)⟩, ⟨(-12262), (-12255)⟩, ⟨72, 77⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨26407791, 26407796⟩, ⟨7410551, 7410559⟩, ⟨491285, 491295⟩, ⟨(-5324), (-5316)⟩, ⟨(-173), (-167)⟩⟩
...
def j33 : Jet := ⟨⟨(-689420092), (-689420086)⟩, ⟨7410551, 7410559⟩, ⟨491285, 491295⟩, ⟨(-5324), (-5316)⟩, ⟨(-173), (-167)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-517836468), (-517836461)⟩, ⟨(-142387074), (-142387063)⟩, ⟨(-8608735), (-8608723)⟩, ⟨215029, 215040⟩, ⟨6257, 6267⟩⟩
...
def j36 : Jet := ⟨⟨3777130828, 3777130835⟩, ⟨(-142387074), (-142387063)⟩, ⟨(-8608735), (-8608723)⟩, ⟨215029, 215040⟩, ⟨6257, 6267⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1150043420, 1150043428⟩, ⟨139063360, 139063370⟩, ⟨(-5210407), (-5210397)⟩, ⟨(-202304), (-202295)⟩, ⟨4711, 4719⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4883798014, 4883798024⟩, ⟨184105260, 184105276⟩, ⟨18071247, 18071266⟩, ⟨822794, 822814⟩, ⟨53617, 53636⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1307711883, 1307711895⟩, ⟨207425654, 207425672⟩, ⟨4875109, 4875129⟩, ⟨352043, 352064⟩, ⟨15756, 15777⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1184852628), (-1184852627)⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3110114668, 3110114669⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨398166097, 398166106⟩, ⟨126312016, 126312030⟩, ⟨12986332, 12986348⟩, ⟨685262, 685280⟩, ⟨49129, 49148⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4693133393, 4693133402⟩, ⟨126312016, 126312030⟩, ⟨12986332, 12986348⟩, ⟨685262, 685280⟩, ⟨49129, 49148⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4489638564, 4489638569⟩, ⟨60417555, 60417563⟩, ⟨5805098, 5805107⟩, ⟨249654, 249664⟩, ⟨16385, 16397⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3251081973, 3251081978⟩, ⟨(-133186493), (-133186485)⟩, ⟨1822588, 1822598⟩, ⟨(-47999), (-47988)⟩, ⟨2024, 2036⟩⟩
...
def j47 : Jet := ⟨⟨8500140264, 8500140274⟩, ⟨1214305752, 1214305760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16822569190, 16822569231⟩, ⟨4806448340, 4806448378⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16822569190, 16822569231⟩, ⟨4806448340, 4806448378⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16822569231), (-16822569190)⟩, ⟨(-4806448378), (-4806448340)⟩, ⟨(-343317744), (-343317738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8411284616), (-8411284595)⟩, ⟨(-2403224189), (-2403224170)⟩, ⟨(-171658872), (-171658869)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨605948138, 605948151⟩, ⟨(-339054795), (-339054784)⟩, ⟨70639874, 70639880⟩, ⟨(-4141278), (-4141274)⟩, ⟨(-832342), (-832340)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨458673357, 458673368⟩, ⟨(-275438429), (-275438418)⟩, ⟨64242148, 64242158⟩, ⟨(-5475936), (-5475927)⟩, ⟨(-467574), (-467565)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1015587966, 1354117290⟩, ⟨169264661, 169264662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3190563692, 4254084931⟩, ⟨531760615, 531760619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2370145328, 4213591712⟩, ⟨790048442, 1053397934⟩, ⟨65837370, 65837372⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨593, 1056⟩, ⟨197, 264⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94094), (-93630)⟩, ⟨197, 264⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-92312), (-51669)⟩, ⟨(-22970), (-16964)⟩, ⟨(-1399), (-1353)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5020744, 5061388⟩, ⟨(-22970), (-16964)⟩, ⟨(-1399), (-1353)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2770659, 4965492⟩, ⟨901018, 1232012⟩, ⟨69955, 73720⟩, ⟨(-695), (-498)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140394918), (-138200084)⟩, ⟨901018, 1232012⟩, ⟨69955, 73720⟩, ⟨(-695), (-498)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-137734894), (-76264674)⟩, ⟨(-33936505), (-24212888)⟩, ⟨(-1947765), (-1743971)⟩, ⟨25997, 36693⟩, ⟨879, 1032⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1293920871, 1355391092⟩, ⟨(-33936505), (-24212888)⟩, ⟨(-1947765), (-1743971)⟩, ⟨25997, 36693⟩, ⟨879, 1032⟩⟩
...
def j70 : Jet := ⟨⟨(-106), (-59)⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11729, 11777⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6472, 11554⟩, ⟨2130, 2879⟩, ⟨170, 178⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845705), (-840622)⟩, ⟨2130, 2879⟩, ⟨170, 178⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-829682), (-463890)⟩, ⟨(-206246), (-151805)⟩, ⟨(-12480), (-12003)⟩, ⟨61, 89⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34961712, 35327505⟩, ⟨(-206246), (-151805)⟩, ⟨(-12480), (-12003)⟩, ⟨61, 89⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19293357, 34658165⟩, ⟨6228780, 8580770⟩, ⟨473097, 506987⟩, ⟨(-6190), (-4446)⟩, ⟨(-181), (-158)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696534526), (-681169717)⟩, ⟨6228780, 8580770⟩, ⟨473097, 506987⟩, ⟨(-6190), (-4446)⟩, ⟨(-181), (-158)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-683337475), (-375898373)⟩, ⟨(-167397065), (-116881264)⟩, ⟨(-9270306), (-7839690)⟩, ⟨176432, 253428⟩, ⟨5555, 6868⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3611629821, 3919068923⟩, ⟨(-167397065), (-116881264)⟩, ⟨(-9270306), (-7839690)⟩, ⟨176432, 253428⟩, ⟨5555, 6868⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨961203349, 1342489576⟩, ⟨126587083, 149824388⟩, ⟨(-6130910), (-4293329)⟩, ⟨(-221842), (-179577)⟩, ⟨3870, 5566⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4706920045, 5107595460⟩, ⟨140377924, 236734254⟩, ⟨13602297, 24082644⟩, ⟨356196, 1493929⟩, ⟨13571, 116965⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1053397383, 1596494966⟩, ⟨170144952, 252168541⟩, ⟨(-109340), 11080623⟩, ⟨(-121126), 969929⟩, ⟨(-28830), 75829⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1354117290), (-1015587966)⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2940850006, 3279379330⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨258359603, 593437855⟩, ⟨83460586, 187468626⟩, ⟨6658997, 23043086⟩, ⟨(-102890), 2022216⟩, ⟨(-35941), 198857⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4553326899, 4888405151⟩, ⟨83460586, 187468626⟩, ⟨6658997, 23043086⟩, ⟨(-102890), 2022216⟩, ⟨(-35941), 198857⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4422260747, 4582089071⟩, ⟨39115399, 91036199⟩, ⟨2216519, 11016909⟩, ⟨(-276758), 962399⟩, ⟨(-50990), 101710⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3028010377, 3498608291⟩, ⟨(-153797037), (-104771515)⟩, ⟨(-2070043), 6870314⟩, ⟨(-645493), 647478⟩, ⟨(-76862), 88568⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7285834512, 9714446033⟩, ⟨1214305752, 1214305760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12359438588, 21972335347⟩, ⟨4119812862, 5493083864⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12359438588, 21972335347⟩, ⟨4119812862, 5493083864⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21972335347), (-12359438588)⟩, ⟨(-5493083864), (-4119812862)⟩, ⟨(-343317744), (-343317738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10986167674), (-6179719294)⟩, ⟨(-2746541932), (-2059906431)⟩, ⟨(-171658872), (-171658869)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨332713820, 1018790282⟩, ⟨(-651495119), (-159572655)⟩, ⟨(-2452178), 195011044⟩, ⟨(-37316690), 17881770⟩, ⟨(-6755802), 6014815⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨234567769, 829889469⟩, ⟨(-567178511), (-120617119)⟩, ⟨1404088, 183811572⟩, ⟨(-38575895), 15121587⟩, ⟨(-6353924), 6666696⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1184852627, 1184852628⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4489638564, 4489638569⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2020
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1015587966, 1354117290⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4422260747, 4582089071⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2021
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (37945585 / 4294967296)

theorem envelope_integral : (∫ s in ((11823 / 50000) : ℝ)..(3941 / 12500),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (11823 / 50000) := by norm_num [center, radius]
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((11823 / 50000) : ℝ)..(3941 / 12500), prawitzNormalCorrection
