...
namespace FiniteNormalPanel142_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (78729 / 800000)
def radius : Rat := (26243 / 800000)

def j0 : Jet := ⟨⟨422673100, 422673101⟩, ⟨140891033, 140891034⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1327866705, 1327866710⟩, ⟨442622234, 442622238⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨410533972, 410533976⟩, ⟨273689314, 273689318⟩, ⟨45614885, 45614887⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-9041), (-9040)⟩, ⟨(-6022), (-6020)⟩, ⟨(-1000), (-997)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104015, 5104017⟩, ⟨(-6022), (-6020)⟩, ⟨(-1000), (-997)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨487866, 487867⟩, ⟨324668, 324670⟩, ⟨53727, 53730⟩, ⟨(-128), (-125)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142677711), (-142677709)⟩, ⟨324668, 324670⟩, ⟨53727, 53730⟩, ⟨(-128), (-125)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13637834), (-13637832)⟩, ⟨(-9060856), (-9060854)⟩, ⟨(-1489492), (-1489488)⟩, ⟨6858, 6862⟩, ⟨559, 564⟩⟩
...
def j19 : Jet := ⟨⟨1418017931, 1418017934⟩, ⟨(-9060856), (-9060854)⟩, ⟨(-1489492), (-1489488)⟩, ⟨6858, 6862⟩, ⟨559, 564⟩⟩
...
def j25 : Jet := ⟨⟨1130, 1131⟩, ⟨752, 754⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851047), (-851045)⟩, ⟨752, 754⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-81348), (-81347)⟩, ⟨(-54161), (-54158)⟩, ⟨(-8981), (-8976)⟩, ⟨13, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35710046, 35710048⟩, ⟨(-54161), (-54158)⟩, ⟨(-8981), (-8976)⟩, ⟨13, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3413340, 3413342⟩, ⟨2270383, 2270385⟩, ⟨374949, 374953⟩, ⟨(-1148), (-1144)⟩, ⟨(-97), (-92)⟩⟩
...
def j33 : Jet := ⟨⟨(-712414543), (-712414540)⟩, ⟨2270383, 2270385⟩, ⟨374949, 374953⟩, ⟨(-1148), (-1144)⟩, ⟨(-97), (-92)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-68096066), (-68096064)⟩, ⟨(-45180364), (-45180361)⟩, ⟨(-7385715), (-7385712)⟩, ⟨47894, 47898⟩, ⟨3898, 3903⟩⟩
...
def j36 : Jet := ⟨⟨4226871230, 4226871232⟩, ⟨(-45180364), (-45180361)⟩, ⟨(-7385715), (-7385712)⟩, ⟨47894, 47898⟩, ⟨3898, 3903⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨438405852, 438405855⟩, ⟨143333955, 143333960⟩, ⟨(-1394280), (-1394277)⟩, ⟨(-151382), (-151378)⟩, ⟨878, 883⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4364160406, 4364160409⟩, ⟨46647823, 46647828⟩, ⟨8124210, 8124216⟩, ⟨118892, 118900⟩, ⟨10905, 10916⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨445468691, 445468695⟩, ⟨150404648, 150404656⟩, ⟨969286, 969292⟩, ⟨114295, 114304⟩, ⟨1689, 1700⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-422673101), (-422673100)⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3872294195, 3872294196⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨46203461, 46203462⟩, ⟨31199566, 31199570⟩, ⟨5468057, 5468061⟩, ⟨91594, 91600⟩, ⟨8572, 8579⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4341170757, 4341170758⟩, ⟨31199566, 31199570⟩, ⟨5468057, 5468061⟩, ⟨91594, 91600⟩, ⟨8572, 8579⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4318007228, 4318007230⟩, ⟨15516545, 15516548⟩, ⟨2691560, 2691564⟩, ⟨35880, 35885⟩, ⟨3294, 3300⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3893066738, 3893066742⟩, ⟨(-127657289), (-127657283)⟩, ⟨1917679, 1917684⟩, ⟨(-55945), (-55939)⟩, ⟨1791, 1800⟩⟩
...
def j47 : Jet := ⟨⟨4702446712, 4702446725⟩, ⟨1567482233, 1567482246⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5148585205, 5148585235⟩, ⟨3432390126, 3432390166⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5148585205, 5148585235⟩, ⟨3432390126, 3432390166⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5148585235), (-5148585205)⟩, ⟨(-3432390166), (-3432390126)⟩, ⟨(-572065030), (-572065019)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2574292618), (-2574292602)⟩, ⟨(-1716195083), (-1716195063)⟩, ⟨(-286032515), (-286032509)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2358603557, 2358603577⟩, ⟨(-942457436), (-942457416)⟩, ⟨31218647, 31218659⟩, ⟨37685161, 37685166⟩, ⟨(-4804123), (-4804121)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2137897782, 2137897803⟩, ⟨(-924370867), (-924370842)⟩, ⟨57362688, 57362707⟩, ⟨32779355, 32779369⟩, ⟨(-5447483), (-5447469)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨281782066, 563564134⟩, ⟨140891033, 140891034⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨885244468, 1770488944⟩, ⟨442622234, 442622238⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨182459542, 729838177⟩, ⟨182459542, 364919092⟩, ⟨45614885, 45614887⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-16083), (-4014)⟩, ⟨(-8041), (-3998)⟩, ⟨(-1005), (-992)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096973, 5109043⟩, ⟨(-8041), (-3998)⟩, ⟨(-1005), (-992)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨216530, 868173⟩, ⟨215163, 433918⟩, ⟨53277, 54050⟩, ⟨(-172), (-83)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142949047), (-142297403)⟩, ⟨215163, 433918⟩, ⟨53277, 54050⟩, ⟨(-172), (-83)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-24291145), (-6045102)⟩, ⟨(-12136433), (-5971366)⟩, ⟨(-1506794), (-1465222)⟩, ⟨4518, 9199⟩, ⟨548, 572⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407364620, 1425610664⟩, ⟨(-12136433), (-5971366)⟩, ⟨(-1506794), (-1465222)⟩, ⟨4518, 9199⟩, ⟨548, 572⟩⟩
...
def j72 : Jet := ⟨⟨501, 2011⟩, ⟨499, 1006⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851676), (-850165)⟩, ⟨499, 1006⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-144725), (-36116)⟩, ⟨(-72342), (-35945)⟩, ⟨(-9020), (-8921)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35646669, 35755279⟩, ⟨(-72342), (-35945)⟩, ⟨(-9020), (-8921)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1514347, 6075848⟩, ⟨1502054, 3036397⟩, ⟨370906, 377836⟩, ⟨(-1536), (-755)⟩, ⟨(-97), (-91)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714313536), (-709752034)⟩, ⟨1502054, 3036397⟩, ⟨370906, 377836⟩, ⟨(-1536), (-755)⟩, ⟨(-97), (-91)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-121382366), (-30151808)⟩, ⟨(-60627374), (-29635837)⟩, ⟨(-7506832), (-7215760)⟩, ⟨31446, 64320⟩, ⟨3791, 3978⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4173584930, 4264815488⟩, ⟨(-60627374), (-29635837)⟩, ⟨(-7506832), (-7215760)⟩, ⟨31446, 64320⟩, ⟨3791, 3978⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨290074791, 587671045⟩, ⟨140034465, 145686992⟩, ⟨(-1871870), (-917384)⟩, ⟨(-154354), (-147206)⟩, ⟨577, 1185⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4325332274, 4419879884⟩, ⟨30056362, 64205166⟩, ⟨7527007, 8882506⟩, ⟨36498, 211927⟩, ⟨7895, 14903⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨292125590, 604762564⟩, ⟨143054449, 158709131⟩, ⟨(-437983), 2469371⟩, ⟨61050, 175632⟩, ⟨(-3877), 7812⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-563564134), (-281782066)⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3731403162, 4013185230⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19869152, 85154958⟩, ⟨19459922, 44694796⟩, ⟨4641436, 6560088⟩, ⟨(-24066), 231962⟩, ⟨2722, 16602⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314836448, 4380122254⟩, ⟨19459922, 44694796⟩, ⟨4641436, 6560088⟩, ⟨(-24066), 231962⟩, ⟨2722, 16602⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304890408, 4337335800⟩, ⟨9634915, 22295886⟩, ⟨2240742, 3261702⟩, ⟨(-28900), 110700⟩, ⟨(-452), 7850⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3740024212, 4052774043⟩, ⟨(-133910211), (-120383439)⟩, ⟨1215334, 2731649⟩, ⟨(-134001), 29934⟩, ⟨(-4055), 8284⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3134964467, 6269928958⟩, ⟨1567482233, 1567482246⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2288260080, 9153040392⟩, ⟨2288260078, 4576520216⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2288260080, 9153040392⟩, ⟨2288260078, 4576520216⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9153040392), (-2288260080)⟩, ⟨(-4576520216), (-2288260078)⟩, ⟨(-572065030), (-572065019)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4576520196), (-1144130040)⟩, ⟨(-2288260108), (-1144130039)⟩, ⟨(-286032515), (-286032509)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1479774623, 3290552253⟩, ⟨(-1753130801), (-394194991)⟩, ⟨(-166636839), 368465202⟩, ⟨(-47935101), 107429088⟩, ⟨(-26578303), 11933449⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1288576265, 3104997976⟩, ⟨(-1756865893), (-384738475)⟩, ⟨(-145772586), 404440091⟩, ⟨(-57937873), 106478022⟩, ⟨(-28550330), 13050455⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨422673100, 422673101⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4318007228, 4318007230⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2860
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨281782066, 563564134⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304890408, 4337335800⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2861
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (141687847 / 4294967296)

theorem envelope_integral : (∫ s in ((26243 / 400000) : ℝ)..(26243 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26243 / 400000) : ℝ)..(26243 / 200000), prawitzNormalCorrection
