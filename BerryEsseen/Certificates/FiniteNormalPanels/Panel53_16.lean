...
namespace FiniteNormalPanel53_16
...
def j2 : Jet := ⟨⟨558409363, 558409367⟩, ⟨558409363, 558409367⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨72601488, 72601490⟩, ⟨145202976, 145202980⟩, ⟨72601488, 72601490⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1601), (-1600)⟩, ⟨(-3201), (-3199)⟩, ⟨(-1600), (-1597)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111455, 5111457⟩, ⟨(-3201), (-3199)⟩, ⟨(-1600), (-1597)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨86403, 86404⟩, ⟨172751, 172753⟩, ⟨86266, 86270⟩, ⟨(-110), (-106)⟩, ⟨(-28), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-143079174), (-143079172)⟩, ⟨172751, 172753⟩, ⟨86266, 86270⟩, ⟨(-110), (-106)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2418590), (-2418589)⟩, ⟨(-4834259), (-4834257)⟩, ⟨(-2411292), (-2411289)⟩, ⟨5834, 5837⟩, ⟨1453, 1456⟩⟩
...
def j19 : Jet := ⟨⟨1429237175, 1429237177⟩, ⟨(-4834259), (-4834257)⟩, ⟨(-2411292), (-2411289)⟩, ⟨5834, 5837⟩, ⟨1453, 1456⟩⟩
...
def j25 : Jet := ⟨⟨200, 201⟩, ⟨399, 401⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851977), (-851975)⟩, ⟨399, 401⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14402), (-14401)⟩, ⟨(-28798), (-28796)⟩, ⟨(-14386), (-14383)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35776992, 35776994⟩, ⟨(-28798), (-28796)⟩, ⟨(-14386), (-14383)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨604768, 604769⟩, ⟨1209050, 1209052⟩, ⟨603550, 603553⟩, ⟨(-974), (-971)⟩, ⟨(-244), (-241)⟩⟩
...
def j33 : Jet := ⟨⟨(-715223115), (-715223113)⟩, ⟨1209050, 1209052⟩, ⟨603550, 603553⟩, ⟨(-974), (-971)⟩, ⟨(-244), (-241)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-12090026), (-12090025)⟩, ⟨(-24159614), (-24159612)⟩, ⟨(-12038949), (-12038946)⟩, ⟨40824, 40827⟩, ⟨10164, 10167⟩⟩
...
def j36 : Jet := ⟨⟨4282877270, 4282877271⟩, ⟨(-24159614), (-24159612)⟩, ⟨(-12038949), (-12038946)⟩, ⟨40824, 40827⟩, ⟨10164, 10167⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨185822001, 185822004⟩, ⟨185193475, 185193479⟩, ⟨(-942030), (-942028)⟩, ⟨(-312746), (-312744)⟩, ⟨946, 949⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4307091449, 4307091451⟩, ⟨24296203, 24296207⟩, ⟨12244064, 12244070⟩, ⟨96305, 96312⟩, ⟨24502, 24510⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨186346553, 186346557⟩, ⟨186767428, 186767435⟩, ⟨632671, 632676⟩, ⟨213156, 213162⟩, ⟨1704, 1712⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-177747222), (-177747221)⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4117220074, 4117220075⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8085052, 8085054⟩, ⟨16206626, 16206628⟩, ⟨8176513, 8176518⟩, ⟨73518, 73524⟩, ⟨18777, 18784⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303052348, 4303052350⟩, ⟨16206626, 16206628⟩, ⟨8176513, 8176518⟩, ⟨73518, 73524⟩, ⟨18777, 18784⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299007921, 4299007923⟩, ⟨8095696, 8095698⟩, ⟨4076791, 4076795⟩, ⟨29046, 29051⟩, ⟨7391, 7397⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4121093477, 4121093481⟩, ⟨(-170153789), (-170153784)⟩, ⟨3573032, 3573037⟩, ⟨(-140876), (-140868)⟩, ⟨5882, 5889⟩⟩
...
def j47 : Jet := ⟨⟨1297061625, 1297061633⟩, ⟨1297061625, 1297061633⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨391707024, 391707030⟩, ⟨783414048, 783414060⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨391707024, 391707030⟩, ⟨783414048, 783414060⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-391707030), (-391707024)⟩, ⟨(-783414060), (-783414048)⟩, ⟨(-391707030), (-391707024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-195853515), (-195853512)⟩, ⟨(-391707030), (-391707024)⟩, ⟨(-195853515), (-195853512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4103512199, 4103512203⟩, ⟨(-374246058), (-374246051)⟩, ⟨(-170057148), (-170057143)⟩, ⟨16547070, 16547072⟩, ⟨3500083, 3500084⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3937389086, 3937389094⟩, ⟨(-521664308), (-521664294)⟩, ⟨(-144932430), (-144932416)⟩, ⟨22168411, 22168425⟩, ⟨2579262, 2579276⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 355494444⟩, ⟨177747221, 177747222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1116818734⟩, ⟨558409363, 558409367⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 290405957⟩, ⟨0, 290405958⟩, ⟨72601488, 72601490⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6403), 0⟩, ⟨(-6403), 5⟩, ⟨(-1601), (-1592)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106653, 5113057⟩, ⟨(-6403), 5⟩, ⟨(-1601), (-1592)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 345722⟩, ⟨(-433), 345723⟩, ⟨85780, 86432⟩, ⟨(-218), 2⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142819854)⟩, ⟨(-433), 345723⟩, ⟨85780, 86432⟩, ⟨(-218), 2⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9680199), 0⟩, ⟨(-9680229), 23377⟩, ⟨(-2420080), (-2384983)⟩, ⟨(-23), 11691⟩, ⟨1433, 1463⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421975566, 1431655766⟩, ⟨(-9680229), 23377⟩, ⟨(-2420080), (-2384983)⟩, ⟨(-23), 11691⟩, ⟨1433, 1463⟩⟩
...
def j72 : Jet := ⟨⟨0, 801⟩, ⟨(-1), 801⟩, ⟨197, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851375)⟩, ⟨(-1), 801⟩, ⟨197, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-57621), 0⟩, ⟨(-57622), 55⟩, ⟨(-14407), (-14322)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35733773, 35791395⟩, ⟨(-57622), 55⟩, ⟨(-14407), (-14322)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2420050⟩, ⟨(-3897), 2420054⟩, ⟨599166, 605017⟩, ⟨(-1951), 3⟩, ⟨(-245), (-239)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713407832)⟩, ⟨(-3897), 2420054⟩, ⟨599166, 605017⟩, ⟨(-1951), 3⟩, ⟨(-245), (-239)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-48400993), 0⟩, ⟨(-48401258), 163633⟩, ⟨(-12100513), (-11854797)⟩, ⟨(-198), 81819⟩, ⟨9979, 10229⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4246566303, 4294967296⟩, ⟨(-48401258), 163633⟩, ⟨(-12100513), (-11854797)⟩, ⟨(-198), 81819⟩, ⟨9979, 10229⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 372272912⟩, ⟨182360738, 186142535⟩, ⟨(-1887867), 3040⟩, ⟨(-314653), (-307042)⟩, ⟨(-3), 1902⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4343919948⟩, ⟨(-167386), 49510870⟩, ⟨11852910, 12942234⟩, ⟨(-84673), 288797⟩, ⟨20470, 30084⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 376515959⟩, ⟨182346229, 192555559⟩, ⟨(-1916640), 3270650⟩, ⟨155921, 278977⟩, ⟨(-12991), 17072⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-355494444), 0⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3939472852, 4294967296⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 33007066⟩, ⟨0, 33760556⟩, ⟨7405609, 9206252⟩, ⟨(-171858), 342180⟩, ⟨9500, 30501⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4327974362⟩, ⟨0, 33760556⟩, ⟨7405609, 9206252⟩, ⟨(-171858), 342180⟩, ⟨9500, 30501⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311439243⟩, ⟨0, 16880278⟩, ⟨3655612, 4603126⟩, ⟨(-104021), 171090⟩, ⟨1603, 14104⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3939472852, 4311439243⟩, ⟨(-178428914), (-160866943)⟩, ⟨2654445, 4603126⟩, ⟨(-294522), 19803⟩, ⟨(-5611), 18409⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2594123266⟩, ⟨1297061625, 1297061633⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1566828117⟩, ⟨0, 1566828118⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1566828117⟩, ⟨0, 1566828118⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1566828117), 0⟩, ⟨(-1566828118), 0⟩, ⟨(-391707030), (-391707024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-783414059), 0⟩, ⟨(-783414059), 0⟩, ⟨(-195853515), (-195853512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3578848645, 4294967296⟩, ⟨(-783414059), 0⟩, ⟨(-195853515), (-91749541)⟩, ⟨0, 35724230⟩, ⟨462871, 4465529⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3282627341, 4311439243⟩, ⟨(-964847503), (-134044895)⟩, ⟨(-194392791), (-47006371)⟩, ⟨2302310, 44017526⟩, ⟨(-1278689), 4498083⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299007921, 4299007923⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1054
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311439243⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1055
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (10061671 / 134217728)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(8277 / 100000), prawitzNormalCorrection
