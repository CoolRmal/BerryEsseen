...
namespace FiniteNormalPanel93_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (861 / 10000)
def radius : Rat := (861 / 10000)

def j0 : Jet := ⟨⟨369796684, 369796685⟩, ⟨369796684, 369796685⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1161750545, 1161750549⟩, ⟨1161750545, 1161750549⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨314243214, 314243217⟩, ⟨628486428, 628486434⟩, ⟨314243214, 314243217⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨78, 79⟩, ⟨157, 158⟩, ⟨78, 79⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94609), (-94607)⟩, ⟨157, 158⟩, ⟨78, 79⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-6923), (-6921)⟩, ⟨(-13834), (-13831)⟩, ⟨(-6896), (-6891)⟩, ⟨22, 24⟩, ⟨5, 6⟩⟩
...
def j13 : Jet := ⟨⟨5106133, 5106136⟩, ⟨(-13834), (-13831)⟩, ⟨(-6896), (-6891)⟩, ⟨22, 24⟩, ⟨5, 6⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨373592, 373593⟩, ⟨746172, 746175⟩, ⟨371062, 371066⟩, ⟨(-2022), (-2017)⟩, ⟨(-502), (-499)⟩⟩
...
def j16 : Jet := ⟨⟨(-142791985), (-142791983)⟩, ⟨746172, 746175⟩, ⟨371062, 371066⟩, ⟨(-2022), (-2017)⟩, ⟨(-502), (-499)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-10447440), (-10447439)⟩, ⟨(-20840286), (-20840284)⟩, ⟨(-10311104), (-10311100)⟩, ⟨108743, 108747⟩, ⟨26815, 26819⟩⟩
...
def j19 : Jet := ⟨⟨1421208325, 1421208327⟩, ⟨(-20840286), (-20840284)⟩, ⟨(-10311104), (-10311100)⟩, ⟨108743, 108747⟩, ⟨26815, 26819⟩⟩
...
def j25 : Jet := ⟨⟨865, 866⟩, ⟨1728, 1730⟩, ⟨861, 864⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851312), (-851310)⟩, ⟨1728, 1730⟩, ⟨861, 864⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-62287), (-62286)⟩, ⟨(-124448), (-124445)⟩, ⟨(-61973), (-61968)⟩, ⟨250, 254⟩, ⟨60, 64⟩⟩
...
def j30 : Jet := ⟨⟨35729107, 35729109⟩, ⟨(-124448), (-124445)⟩, ⟨(-61973), (-61968)⟩, ⟨250, 254⟩, ⟨60, 64⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2614136, 2614137⟩, ⟨5219166, 5219168⟩, ⟨2591390, 2591394⟩, ⟨(-18157), (-18153)⟩, ⟨(-4495), (-4490)⟩⟩
...
def j33 : Jet := ⟨⟨(-713213747), (-713213745)⟩, ⟨5219166, 5219168⟩, ⟨2591390, 2591394⟩, ⟨(-18157), (-18153)⟩, ⟨(-4495), (-4490)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-52182606), (-52182604)⟩, ⟨(-103983349), (-103983345)⟩, ⟨(-51229281), (-51229277)⟩, ⟨759733, 759737⟩, ⟨186614, 186617⟩⟩
...
def j36 : Jet := ⟨⟨4242784690, 4242784692⟩, ⟨(-103983349), (-103983345)⟩, ⟨(-51229281), (-51229277)⟩, ⟨759733, 759737⟩, ⟨186614, 186617⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨384424241, 384424244⟩, ⟨378787128, 378787133⟩, ⟨(-8426176), (-8426172)⟩, ⟨(-2759649), (-2759645)⟩, ⟨36667, 36671⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4347791701, 4347791704⟩, ⟨106556885, 106556891⟩, ⟨55108703, 55108710⟩, ⟨1858692, 1858700⟩, ⟨500641, 500650⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨389152328, 389152332⟩, ⟨392983336, 392983344⟩, ⟨5800332, 5800340⟩, ⟨2023936, 2023946⟩, ⟨69267, 69279⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-369796685), (-369796684)⟩, ⟨(-369796685), (-369796684)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3925170611, 3925170612⟩, ⟨(-369796685), (-369796684)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨35259764, 35259765⟩, ⟨71213756, 71213760⟩, ⟨37008506, 37008513⟩, ⟨1428206, 1428212⟩, ⟨390759, 390768⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4330227060, 4330227061⟩, ⟨71213756, 71213760⟩, ⟨37008506, 37008513⟩, ⟨1428206, 1428212⟩, ⟨390759, 390768⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4312561142, 4312561143⟩, ⟨35461613, 35461616⟩, ⟨18282963, 18282968⟩, ⟨560850, 560855⟩, ⟨151215, 151222⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3941249626, 3941249629⟩, ⟨(-338903148), (-338903143)⟩, ⟨13655553, 13655561⟩, ⟨(-1061604), (-1061597)⟩, ⟨89905, 89913⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨26104166979, 26104166982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value429

def j47 : Jet := ⟨⟨2247568775, 2247568783⟩, ⟨2247568775, 2247568783⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1176159223, 1176159232⟩, ⟨2352318446, 2352318464⟩, ⟨1176159223, 1176159232⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1176159223, 1176159232⟩, ⟨2352318446, 2352318464⟩, ⟨1176159223, 1176159232⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1176159232), (-1176159223)⟩, ⟨(-2352318464), (-2352318446)⟩, ⟨(-1176159232), (-1176159223)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-588079616), (-588079611)⟩, ⟨(-1176159232), (-1176159223)⟩, ⟨(-588079616), (-588079611)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3745372153, 3745372159⟩, ⟨(-1025654852), (-1025654841)⟩, ⟨(-372391735), (-372391726)⟩, ⟨127616443, 127616448⟩, ⟨16757676, 16757679⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3436917112, 3436917121⟩, ⟨(-1236721925), (-1236721908)⟩, ⟨(-248883389), (-248883368)⟩, ⟨142303990, 142304007⟩, ⟨4455657, 4455675⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 739593369⟩, ⟨369796684, 369796685⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2323501095⟩, ⟨1161750545, 1161750549⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1256972863⟩, ⟨0, 1256972866⟩, ⟨314243214, 314243217⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 315⟩, ⟨0, 315⟩, ⟨78, 79⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94371)⟩, ⟨0, 315⟩, ⟨78, 79⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-27712), 0⟩, ⟨(-27712), 93⟩, ⟨(-6928), (-6787)⟩, ⟨0, 48⟩, ⟨5, 6⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5085344, 5113057⟩, ⟨(-27712), 93⟩, ⟨(-6928), (-6787)⟩, ⟨0, 48⟩, ⟨5, 6⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1496397⟩, ⟨(-8111), 1496425⟩, ⟨361932, 374128⟩, ⟨(-4056), 22⟩, ⟨(-507), (-479)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141669179)⟩, ⟨(-8111), 1496425⟩, ⟨361932, 374128⟩, ⟨(-4056), 22⟩, ⟨(-507), (-479)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-41899096), 0⟩, ⟨(-41901470), 437947⟩, ⟨(-10477148), (-9817849)⟩, ⟨(-1782), 218987⟩, ⟨25143, 27381⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1389756669, 1431655766⟩, ⟨(-41901470), 437947⟩, ⟨(-10477148), (-9817849)⟩, ⟨(-1782), 218987⟩, ⟨25143, 27381⟩⟩
...
def j70 : Jet := ⟨⟨(-32), 0⟩, ⟨(-32), 0⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11803, 11836⟩, ⟨(-32), 0⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 3464⟩, ⟨(-10), 3464⟩, ⟨850, 866⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848712)⟩, ⟨(-10), 3464⟩, ⟨850, 866⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-249400), 0⟩, ⟨(-249403), 1014⟩, ⟨(-62353), (-60828)⟩, ⟨(-3), 508⟩, ⟨59, 64⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35541994, 35791395⟩, ⟨(-249403), 1014⟩, ⟨(-62353), (-60828)⟩, ⟨(-3), 508⟩, ⟨59, 64⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 10474775⟩, ⟨(-72991), 10475072⟩, ⟨2509205, 2618991⟩, ⟨(-36498), 224⟩, ⟨(-4564), (-4282)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-705353107)⟩, ⟨(-72991), 10475072⟩, ⟨2509205, 2618991⟩, ⟨(-36498), 224⟩, ⟨(-4564), (-4282)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-209495478), 0⟩, ⟨(-209516840), 3065654⟩, ⟨(-52395232), (-47775344)⟩, ⟨(-16023), 1532959⟩, ⟨171569, 191686⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4085471818, 4294967296⟩, ⟨(-209516840), 3065654⟩, ⟨(-52395232), (-47775344)⟩, ⟨(-16023), 1532959⟩, ⟨171569, 191686⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 774500366⟩, ⟨353248895, 387487106⟩, ⟨(-17001928), 118461⟩, ⟨(-2834941), (-2537172)⟩, ⟨(-483), 74048⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4515205317⟩, ⟨(-3388119), 231555032⟩, ⟨47610064, 69781393⟩, ⟨(-1790021), 6565976⟩, ⟨158109, 1052563⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 814215320⟩, ⟨352637924, 449112454⟩, ⟨(-18179429), 33598669⟩, ⟨(-303937), 4955866⟩, ⟨(-591078), 864189⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-739593369), 0⟩, ⟨(-369796685), (-369796684)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3555373927, 4294967296⟩, ⟨(-369796685), (-369796684)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 154354281⟩, ⟨0, 170280338⟩, ⟨22060600, 59701294⟩, ⟨(-3917180), 8905644⟩, ⟨(-429887), 1626936⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4449321577⟩, ⟨0, 170280338⟩, ⟨22060600, 59701294⟩, ⟨(-3917180), 8905644⟩, ⟨(-429887), 1626936⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4371463218⟩, ⟨0, 85140169⟩, ⟨10008171, 29850647⟩, ⟨(-2550327), 4452822⟩, ⟨(-406947), 852364⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3555373927, 4371463218⟩, ⟨(-376382984), (-284656515)⟩, ⟨954194, 29850647⟩, ⟨(-5120468), 3591119⟩, ⟨(-790335), 1071948⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4495137559⟩, ⟨2247568775, 2247568783⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4704636912⟩, ⟨0, 4704636920⟩, ⟨1176159223, 1176159232⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4704636912⟩, ⟨0, 4704636920⟩, ⟨1176159223, 1176159232⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4704636912), 0⟩, ⟨(-4704636920), 0⟩, ⟨(-1176159232), (-1176159223)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2352318456), 0⟩, ⟨(-2352318460), 0⟩, ⟨(-588079616), (-588079611)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2483706795, 4294967296⟩, ⟨(-2352318460), 0⟩, ⟨(-588079616), 304096319⟩, ⟨(-55517023), 322086396⟩, ⟨(-64919905), 47862355⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2056012484, 4371463218⟩, ⟨(-2770597635), (-164612038)⟩, ⟨(-598001870), 545504985⟩, ⟨(-104624262), 382949537⟩, ⟨(-101146125), 59569865⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨369796684, 369796685⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨369796684, 369796685⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4312561142, 4312561143⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar429 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1870
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar429 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 739593369⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4371463218⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1871
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(861 / 5000), prawitzNormalCorrection
      ((40519 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
