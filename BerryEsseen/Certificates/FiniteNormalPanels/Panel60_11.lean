...
namespace FiniteNormalPanel60_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (103659 / 800000)
def radius : Rat := (34553 / 800000)

def j0 : Jet := ⟨⟨556515018, 556515019⟩, ⟨185505006, 185505007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1748343492, 1748343496⟩, ⟨582781164, 582781168⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨711694584, 711694588⟩, ⟨474463056, 474463062⟩, ⟨79077176, 79077178⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨178, 179⟩, ⟨118, 119⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94509), (-94507)⟩, ⟨118, 119⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-15661), (-15660)⟩, ⟨(-10422), (-10420)⟩, ⟨(-1725), (-1722)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097395, 5097397⟩, ⟨(-10422), (-10420)⟩, ⟨(-1725), (-1722)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨844660, 844661⟩, ⟨561379, 561382⟩, ⟨92413, 92416⟩, ⟨(-383), (-380)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-142320917), (-142320915)⟩, ⟨561379, 561382⟩, ⟨92413, 92416⟩, ⟨(-383), (-380)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-23583190), (-23583188)⟩, ⟨(-15629105), (-15629101)⟩, ⟨(-2543027), (-2543024)⟩, ⟨20479, 20484⟩, ⟨1652, 1657⟩⟩
...
def j19 : Jet := ⟨⟨1408072575, 1408072578⟩, ⟨(-15629105), (-15629101)⟩, ⟨(-2543027), (-2543024)⟩, ⟨20479, 20484⟩, ⟨1652, 1657⟩⟩
...
def j25 : Jet := ⟨⟨1958, 1959⟩, ⟨1303, 1305⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850219), (-850217)⟩, ⟨1303, 1305⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-140885), (-140884)⟩, ⟨(-93709), (-93706)⟩, ⟨(-15476), (-15472)⟩, ⟨45, 49⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35650509, 35650511⟩, ⟨(-93709), (-93706)⟩, ⟨(-15476), (-15472)⟩, ⟨45, 49⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5907442, 5907444⟩, ⟨3922767, 3922769⟩, ⟨643465, 643469⟩, ⟨(-3429), (-3425)⟩, ⟨(-281), (-277)⟩⟩
...
def j33 : Jet := ⟨⟨(-709920441), (-709920438)⟩, ⟨3922767, 3922769⟩, ⟨643465, 643469⟩, ⟨(-3429), (-3425)⟩, ⟨(-281), (-277)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-117636877), (-117636874)⟩, ⟨(-77774566), (-77774563)⟩, ⟨(-12530795), (-12530790)⟩, ⟨142738, 142742⟩, ⟨11421, 11425⟩⟩
...
def j36 : Jet := ⟨⟨4177330419, 4177330422⟩, ⟨(-77774566), (-77774563)⟩, ⟨(-12530795), (-12530790)⟩, ⟨142738, 142742⟩, ⟨11421, 11425⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨573181203, 573181206⟩, ⟨184698293, 184698298⟩, ⟨(-3155888), (-3155884)⟩, ⟨(-336726), (-336722)⟩, ⟨3450, 3455⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4415916915, 4415916920⟩, ⟨82216624, 82216629⟩, ⟨14777208, 14777217⟩, ⟨370856, 370864⟩, ⟨36343, 36352⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨589322431, 589322436⟩, ⟨200871689, 200871697⟩, ⟨2262914, 2262922⟩, ⟨278341, 278350⟩, ⟨7040, 7051⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-556515019), (-556515018)⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3738452277, 3738452278⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨80862298, 80862300⟩, ⟨55124140, 55124144⟩, ⟨10015583, 10015588⟩, ⟨288050, 288058⟩, ⟨29156, 29167⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4375829594, 4375829596⟩, ⟨55124140, 55124144⟩, ⟨10015583, 10015588⟩, ⟨288050, 288058⟩, ⟨29156, 29167⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4335209914, 4335209916⟩, ⟨27306218, 27306221⟩, ⟨4875308, 4875312⟩, ⟨111979, 111985⟩, ⟨10995, 11003⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3773480508, 3773480511⟩, ⟨(-163475089), (-163475082)⟩, ⟨3064206, 3064211⟩, ⟨(-113102), (-113095)⟩, ⟨4733, 4742⟩⟩
...
def j47 : Jet := ⟨⟨3377027697, 3377027705⟩, ⟨1125675899, 1125675906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2655274250, 2655274263⟩, ⟨1770182832, 1770182850⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2655274250, 2655274263⟩, ⟨1770182832, 1770182850⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2655274263), (-2655274250)⟩, ⟨(-1770182850), (-1770182832)⟩, ⟨(-295030476), (-295030472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1327637132), (-1327637125)⟩, ⟨(-885091425), (-885091416)⟩, ⟨(-147515238), (-147515236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3152921023, 3152921033⟩, ⟨(-649742636), (-649742626)⟩, ⟨(-41342129), (-41342123)⟩, ⟨17717281, 17717283⟩, ⟨(-202810), (-202808)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2770099328, 2770099340⟩, ⟨(-690858631), (-690858613)⟩, ⟨(-9342515), (-9342502)⟩, ⟨16593064, 16593075⟩, ⟨(-861455), (-861440)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨371010012, 742020025⟩, ⟨185505006, 185505007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1165562328, 2331124660⟩, ⟨582781164, 582781168⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨316308704, 1265234822⟩, ⟨316308704, 632617416⟩, ⟨79077176, 79077178⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨79, 317⟩, ⟨79, 159⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94608), (-94369)⟩, ⟨79, 159⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-27871), (-6949)⟩, ⟨(-13931), (-6902)⟩, ⟨(-1736), (-1707)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5085185, 5106108⟩, ⟨(-13931), (-6902)⟩, ⟨(-1736), (-1707)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨374505, 1504186⟩, ⟨370401, 751585⟩, ⟨91062, 93379⟩, ⟨(-513), (-250)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142791072), (-141661390)⟩, ⟨370401, 751585⟩, ⟨91062, 93379⟩, ⟨(-513), (-250)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-42064171), (-10432845)⟩, ⟨(-21004808), (-10211439)⟩, ⟨(-2595027), (-2469999)⟩, ⟨13373, 27575⟩, ⟨1590, 1700⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1389591594, 1421222921⟩, ⟨(-21004808), (-10211439)⟩, ⟨(-2595027), (-2469999)⟩, ⟨13373, 27575⟩, ⟨1590, 1700⟩⟩
...
def j72 : Jet := ⟨⟨869, 3485⟩, ⟨864, 1743⟩, ⟨213, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851308), (-848691)⟩, ⟨864, 1743⟩, ⟨213, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-250783), (-62503)⟩, ⟨(-125329), (-61989)⟩, ⟨(-15596), (-15303)⟩, ⟨29, 66⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35540611, 35728892⟩, ⟨(-125329), (-61989)⟩, ⟨(-15596), (-15303)⟩, ⟨29, 66⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2617436, 10525212⟩, ⟨2580515, 5258041⟩, ⟨631303, 652134⟩, ⟨(-4604), (-2248)⟩, ⟨(-286), (-269)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713210447), (-705302670)⟩, ⟨2580515, 5258041⟩, ⟨631303, 652134⟩, ⟨(-4604), (-2248)⟩, ⟨(-286), (-269)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-210101412), (-51942973)⟩, ⟨(-104860662), (-50394030)⟩, ⟨(-12894801), (-12019161)⟩, ⟨92647, 192699⟩, ⟨10859, 11823⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4084865884, 4243024323⟩, ⟨(-104860662), (-50394030)⟩, ⟨(-12894801), (-12019161)⟩, ⟨92647, 192699⟩, ⟨10859, 11823⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨377105458, 771379052⟩, ⟨177152217, 190073598⟩, ⟨(-4258598), (-2055887)⟩, ⟨(-348489), (-320185)⟩, ⟨2245, 4665⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4347546153, 4515875086⟩, ⟨51635426, 115924897⟩, ⟨12928507, 17231234⟩, ⟨94725, 709674⟩, ⟨19896, 59887⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨381721971, 811054242⟩, ⟨183854586, 220670055⟩, ⟨(-1212714), 6143939⟩, ⟨60214, 541206⟩, ⟨(-18568), 37031⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-742020025), (-371010012)⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3552947271, 3923957284⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨33926140, 153158090⟩, ⟨32680730, 83341908⟩, ⟨7412245, 13658174⟩, ⟨(-113914), 835738⟩, ⟨(-3595), 78389⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4328893436, 4448125386⟩, ⟨32680730, 83341908⟩, ⟨7412245, 13658174⟩, ⟨(-113914), 835738⟩, ⟨(-3595), 78389⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4311896999, 4370875549⟩, ⟨16056584, 41507343⟩, ⟨3444674, 6772379⟩, ⟨(-121927), 403402⟩, ⟨(-10993), 38840⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3566952113, 3993308393⟩, ⟨(-175501012), (-148314386)⟩, ⟨1056799, 5493861⟩, ⟨(-403903), 219777⟩, ⟨(-27468), 40752⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2251351798, 4502703604⟩, ⟨1125675899, 1125675906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1180121888, 4720487573⟩, ⟨1180121888, 2360243798⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1180121888, 4720487573⟩, ⟨1180121888, 2360243798⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4720487573), (-1180121888)⟩, ⟨(-2360243798), (-1180121888)⟩, ⟨(-295030476), (-295030472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2360243787), (-590060944)⟩, ⟨(-1180121899), (-590060944)⟩, ⟨(-147515238), (-147515236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2479127934, 3743644761⟩, ⟨(-1028635811), (-340593179)⟩, ⟨(-105183405), 56170087⟩, ⟨2654099, 33186761⟩, ⟨(-3244281), 1715161⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2058905228, 3480708237⟩, ⟨(-1109361990), (-368470766)⟩, ⟨(-85424392), 99045731⟩, ⟨(-1758832), 35261643⟩, ⟨(-4583621), 1707150⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨556515018, 556515019⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4335209914, 4335209916⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1192
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨371010012, 742020025⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4311896999, 4370875549⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1193
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (239048591 / 4294967296)

theorem envelope_integral : (∫ s in ((34553 / 400000) : ℝ)..(34553 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((34553 / 400000) : ℝ)..(34553 / 200000), prawitzNormalCorrection
