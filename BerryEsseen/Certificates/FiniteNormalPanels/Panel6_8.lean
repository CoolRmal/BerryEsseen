...
namespace FiniteNormalPanel6_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (60389 / 160000)
def radius : Rat := (8627 / 160000)

def j0 : Jet := ⟨⟨1621054875, 1621054876⟩, ⟨231579267, 231579268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5092694086, 5092694090⟩, ⟨727527723, 727527728⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨6038586854, 6038586864⟩, ⟨1725310520, 1725310536⟩, ⟨123236465, 123236467⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1511, 1513⟩, ⟨431, 433⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93176), (-93173)⟩, ⟨431, 433⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-131003), (-130998)⟩, ⟨(-36825), (-36819)⟩, ⟨(-2459), (-2455)⟩, ⟨24, 26⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4982053, 4982059⟩, ⟨(-36825), (-36819)⟩, ⟨(-2459), (-2455)⟩, ⟨24, 26⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨7004607, 7004616⟩, ⟨1949541, 1949553⟩, ⟨124700, 124711⟩, ⟨(-2012), (-2005)⟩, ⟨(-62), (-57)⟩⟩
...
def j16 : Jet := ⟨⟨(-136160970), (-136160960)⟩, ⟨1949541, 1949553⟩, ⟨124700, 124711⟩, ⟨(-2012), (-2005)⟩, ⟨(-62), (-57)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-191437976), (-191437961)⟩, ⟨(-51955573), (-51955550)⟩, ⟨(-2948434), (-2948411)⟩, ⟨103201, 103219⟩, ⟨2681, 2694⟩⟩
...
def j19 : Jet := ⟨⟨1240217789, 1240217805⟩, ⟨(-51955573), (-51955550)⟩, ⟨(-2948434), (-2948411)⟩, ⟨103201, 103219⟩, ⟨2681, 2694⟩⟩
...
def j22 : Jet := ⟨⟨(-152), (-150)⟩, ⟨(-44), (-42)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11683, 11686⟩, ⟨(-44), (-42)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨16425, 16431⟩, ⟨4631, 4636⟩, ⟨311, 316⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-835752), (-835745)⟩, ⟨4631, 4636⟩, ⟨311, 316⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1175041), (-1175030)⟩, ⟨(-329215), (-329204)⟩, ⟨(-21684), (-21672)⟩, ⟨250, 259⟩, ⟨4, 10⟩⟩
...
def j30 : Jet := ⟨⟨34616353, 34616365⟩, ⟨(-329215), (-329204)⟩, ⟨(-21684), (-21672)⟩, ⟨250, 259⟩, ⟨4, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨48669486, 48669504⟩, ⟨13442701, 13442723⟩, ⟨830518, 830544⟩, ⟨(-17807), (-17785)⟩, ⟨(-518), (-501)⟩⟩
...
def j33 : Jet := ⟨⟨(-667158397), (-667158378)⟩, ⟨13442701, 13442723⟩, ⟨830518, 830544⟩, ⟨(-17807), (-17785)⟩, ⟨(-518), (-501)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-938003402), (-938003373)⟩, ⟨(-249100965), (-249100922)⟩, ⟨(-12575244), (-12575194)⟩, ⟨694300, 694345⟩, ⟨15947, 15983⟩⟩
...
def j36 : Jet := ⟨⟨3356963894, 3356963923⟩, ⟨(-249100965), (-249100922)⟩, ⟨(-12575244), (-12575194)⟩, ⟨694300, 694345⟩, ⟨15947, 15983⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1470569940, 1470569961⟩, ⟨148475864, 148475898⟩, ⟨(-12296857), (-12296823)⟩, ⟨(-377069), (-377042)⟩, ⟨20659, 20680⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5495067715, 5495067763⟩, ⟨407757265, 407757345⟩, ⟨50841847, 50841944⟩, ⟨4163554, 4163646⟩, ⟨388902, 388981⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1881476817, 1881476861⟩, ⟨329576549, 329576625⟩, ⟨15771141, 15771226⟩, ⟨1533288, 1533365⟩, ⟨122156, 122222⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1621054876), (-1621054875)⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2673912420, 2673912421⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨824210004, 824210043⟩, ⟨288752202, 288752278⟩, ⟨39107811, 39107900⟩, ⟨3763772, 3763858⟩, ⟨400249, 400325⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5119177300, 5119177339⟩, ⟨288752202, 288752278⟩, ⟨39107811, 39107900⟩, ⟨3763772, 3763858⟩, ⟨400249, 400325⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4688997663, 4688997682⟩, ⟨132243748, 132243785⟩, ⟨16045897, 16045940⟩, ⟨1271201, 1271244⟩, ⟨119998, 120037⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2919223412, 2919223426⟩, ⟨(-170494070), (-170494043)⟩, ⟨2859254, 2859284⟩, ⟨(-73768), (-73737)⟩, ⟨6163, 6191⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨16567141424, 16567141429⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value89

def j47 : Jet := ⟨⟨6252956895, 6252956902⟩, ⟨893279553, 893279558⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9103554750, 9103554771⟩, ⟨2601015632, 2601015652⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9103554750, 9103554771⟩, ⟨2601015632, 2601015652⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9103554771), (-9103554750)⟩, ⟨(-2601015652), (-2601015632)⟩, ⟨(-185786833), (-185786830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4551777386), (-4551777375)⟩, ⟨(-1300507826), (-1300507816)⟩, ⟨(-92893417), (-92893415)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1488324035, 1488324049⟩, ⟨(-450661656), (-450661648)⟩, ⟨36039620, 36039624⟩, ⟨2860494, 2860495⟩, ⟨(-606279), (-606278)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1011591024, 1011591039⟩, ⟨(-365388694), (-365388675)⟩, ⟨43375957, 43375977⟩, ⟨188013, 188032⟩, ⟨(-491766), (-491747)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1389475607, 1852634144⟩, ⟨231579267, 231579268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4365166359, 5820221817⟩, ⟨727527723, 727527728⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4436512790, 7887133863⟩, ⟨1478837588, 1971783470⟩, ⟨123236465, 123236467⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1110, 1976⟩, ⟨370, 494⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93577), (-92710)⟩, ⟨370, 494⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-171842), (-95765)⟩, ⟨(-42579), (-31013)⟩, ⟨(-2529), (-2376)⟩, ⟨20, 30⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4941214, 5017292⟩, ⟨(-42579), (-31013)⟩, ⟨(-2529), (-2376)⟩, ⟨20, 30⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨5104057, 9213587⟩, ⟨1623161, 2271362⟩, ⟨117586, 130831⟩, ⟨(-2364), (-1651)⟩, ⟨(-67), (-52)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138061520), (-133951989)⟩, ⟨1623161, 2271362⟩, ⟨117586, 130831⟩, ⟨(-2364), (-1651)⟩, ⟨(-67), (-52)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-253531544), (-138366527)⟩, ⟨(-61706233), (-41951122)⟩, ⟨(-3281086), (-2560496)⟩, ⟨82718, 123532⟩, ⟨2163, 3133⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1178124221, 1293289239⟩, ⟨(-61706233), (-41951122)⟩, ⟨(-3281086), (-2560496)⟩, ⟨82718, 123532⟩, ⟨2163, 3133⟩⟩
...
def j70 : Jet := ⟨⟨(-199), (-110)⟩, ⟨(-50), (-36)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11636, 11726⟩, ⟨(-50), (-36)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨12019, 21534⟩, ⟨3914, 5347⟩, ⟨302, 322⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-840158), (-830642)⟩, ⟨3914, 5347⟩, ⟨302, 322⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1542838), (-858016)⟩, ⟨(-381668), (-276185)⟩, ⟨(-22449), (-20786)⟩, ⟨207, 300⟩, ⟨4, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34248556, 34933379⟩, ⟨(-381668), (-276185)⟩, ⟨(-22449), (-20786)⟩, ⟨207, 300⟩, ⟨4, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨35377255, 64150486⟩, ⟨11091535, 15752336⟩, ⟨766255, 885786⟩, ⟨(-21046), (-14530)⟩, ⟨(-570), (-439)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-680450628), (-651677396)⟩, ⟨11091535, 15752336⟩, ⟨766255, 885786⟩, ⟨(-21046), (-14530)⟩, ⟨(-570), (-439)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1249556707), (-673154159)⟩, ⟨(-300932109), (-195457656)⟩, ⟨(-14913795), (-9840332)⟩, ⟨543437, 843635⟩, ⟨11276, 19962⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3045410589, 3621813137⟩, ⟨(-300932109), (-195457656)⟩, ⟨(-14913795), (-9840332)⟩, ⟨543437, 843635⟩, ⟨11276, 19962⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1197380064, 1752569863⟩, ⟨115943622, 176434443⟩, ⟨(-14898751), (-9708477)⟩, ⟨(-471717), (-266322)⟩, ⟨16209, 25172⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5093234624, 6057227272⟩, ⟨274865561, 598544639⟩, ⟨28671742, 88808240⟩, ⟨883198, 10797881⟩, ⟨(-56186), 1433995⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1419926434, 2471663517⟩, ⟨214121912, 493064248⟩, ⟨(-5598470), 49313295⟩, ⟨(-1721327), 7117148⟩, ⟨(-353669), 982363⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1852634144), (-1389475607)⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2442333152, 2905491689⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨469431066, 1422390468⟩, ⟨141578428, 567496250⟩, ⟨4231260, 113361540⟩, ⟨(-3266590), 19513920⟩, ⟨(-866560), 3330962⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4764398362, 5717357764⟩, ⟨141578428, 567496250⟩, ⟨4231260, 113361540⟩, ⟨(-3266590), 19513920⟩, ⟨(-866560), 3330962⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4523597589, 4955387434⟩, ⟨61354911, 269407014⟩, ⟨(-6013689), 53399941⟩, ⟨(-4731029), 9621978⟩, ⟨(-1299615), 1898562⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2572343768, 3352257658⟩, ⟨(-232298827), (-61656248)⟩, ⟨(-18594276), 32816213⟩, ⟨(-6079741), 6833399⟩, ⟨(-1397980), 1539446⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5359677338, 7146236459⟩, ⟨893279553, 893279558⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6688325937, 11890357251⟩, ⟨2229441970, 2972589316⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6688325937, 11890357251⟩, ⟨2229441970, 2972589316⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11890357251), (-6688325937)⟩, ⟨(-2972589316), (-2229441970)⟩, ⟨(-185786833), (-185786830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5945178626), (-3344162968)⟩, ⟨(-1486294658), (-1114720985)⟩, ⟨(-92893417), (-92893415)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1075971709, 1971550576⟩, ⟨(-682264820), (-279258993)⟩, ⟨(-6401945), 94778974⟩, ⟨(-6906288), 10576022⟩, ⟨(-1939932), 666722⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨644421465, 1538811605⟩, ⟨(-639147209), (-182699996)⟩, ⟨(-9523348), 125940816⟩, ⟨(-18520415), 14691459⟩, ⟨(-4223708), 3290534⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1621054875, 1621054876⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4688997663, 4688997682⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar89 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified122
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar89 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1389475607, 1852634144⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4523597589, 4955387434⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified123
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((25881 / 80000) : ℝ)..(8627 / 20000), prawitzNormalCorrection
      ((54551 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
