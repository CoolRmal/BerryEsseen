...
namespace FiniteNormalPanel31_19
...
def j2 : Jet := ⟨⟨1908640781, 1908640785⟩, ⟨636213591, 636213595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨848180994, 848180998⟩, ⟨565453992, 565454000⟩, ⟨94242331, 94242334⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨212, 213⟩, ⟨141, 142⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94475), (-94473)⟩, ⟨141, 142⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-18658), (-18656)⟩, ⟨(-12412), (-12408)⟩, ⟨(-2052), (-2048)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5094398, 5094401⟩, ⟨(-12412), (-12408)⟩, ⟨(-2052), (-2048)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1006054, 1006056⟩, ⟨668251, 668254⟩, ⟨109742, 109747⟩, ⟨(-543), (-539)⟩, ⟨(-46), (-41)⟩⟩
...
def j16 : Jet := ⟨⟨(-142159523), (-142159520)⟩, ⟨668251, 668254⟩, ⟨109742, 109747⟩, ⟨(-543), (-539)⟩, ⟨(-46), (-41)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-28074022), (-28074021)⟩, ⟨(-18584048), (-18584045)⟩, ⟨(-3009686), (-3009682)⟩, ⟨29003, 29007⟩, ⟨2326, 2331⟩⟩
...
def j19 : Jet := ⟨⟨1403581743, 1403581745⟩, ⟨(-18584048), (-18584045)⟩, ⟨(-3009686), (-3009682)⟩, ⟨29003, 29007⟩, ⟨2326, 2331⟩⟩
...
def j25 : Jet := ⟨⟨2332, 2334⟩, ⟨1552, 1554⟩, ⟨256, 259⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849845), (-849842)⟩, ⟨1552, 1554⟩, ⟨256, 259⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-167830), (-167828)⟩, ⟨(-111581), (-111578)⟩, ⟨(-18394), (-18390)⟩, ⟨66, 70⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35623564, 35623567⟩, ⟨(-111581), (-111578)⟩, ⟨(-18394), (-18390)⟩, ⟨66, 70⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7035031, 7035033⟩, ⟨4667984, 4667988⟩, ⟨763346, 763351⟩, ⟨(-4858), (-4855)⟩, ⟨(-396), (-391)⟩⟩
...
def j33 : Jet := ⟨⟨(-708792852), (-708792849)⟩, ⟨4667984, 4667988⟩, ⟨763346, 763351⟩, ⟨(-4858), (-4855)⟩, ⟨(-396), (-391)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-139974205), (-139974202)⟩, ⟨(-92394292), (-92394287)⟩, ⟨(-14787380), (-14787374)⟩, ⟨201965, 201969⟩, ⟨16030, 16034⟩⟩
...
def j36 : Jet := ⟨⟨4154993091, 4154993094⟩, ⟨(-92394292), (-92394287)⟩, ⟨(-14787380), (-14787374)⟩, ⟨201965, 201969⟩, ⟨16030, 16034⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨623737777, 623737780⟩, ⟨199654024, 199654030⟩, ⟨(-4090331), (-4090326)⟩, ⟨(-432937), (-432933)⟩, ⟨5329, 5333⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4439656975, 4439656979⟩, ⟨98724337, 98724344⟩, ⟨17995800, 17995811⟩, ⟨535718, 535726⟩, ⟨54024, 54033⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨644750374, 644750379⟩, ⟨220717274, 220717284⟩, ⟨2974574, 2974585⟩, ⟨372801, 372810⟩, ⟨11165, 11175⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-607539231), (-607539230)⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3687428065, 3687428066⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨96788407, 96788409⟩, ⟨66267114, 66267120⟩, ⟨12235676, 12235682⟩, ⟨417652, 417660⟩, ⟨43728, 43735⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4391755703, 4391755705⟩, ⟨66267114, 66267120⟩, ⟨12235676, 12235682⟩, ⟨417652, 417660⟩, ⟨43728, 43735⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4343091884, 4343091886⟩, ⟨32766413, 32766417⟩, ⟨5926444, 5926449⟩, ⟨161799, 161805⟩, ⟨16356, 16362⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3728745249, 3728745253⟩, ⟨(-176650731), (-176650725)⟩, ⟨3543148, 3543154⟩, ⟨(-140529), (-140521)⟩, ⟨6412, 6419⟩⟩
...
def j47 : Jet := ⟨⟨3125461266, 3125461273⟩, ⟨1041820418, 1041820425⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2274408034, 2274408045⟩, ⟨1516272016, 1516272032⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2274408034, 2274408045⟩, ⟨1516272016, 1516272032⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2274408045), (-2274408034)⟩, ⟨(-1516272032), (-1516272016)⟩, ⟨(-252712006), (-252712001)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1137204023), (-1137204017)⟩, ⟨(-758136016), (-758136008)⟩, ⟨(-126356003), (-126356000)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3295862833, 3295862846⟩, ⟨(-581776800), (-581776791)⟩, ⟨(-45615968), (-45615963)⟩, ⟨14094409, 14094411⟩, ⟨49023, 49025⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2861356567, 2861356582⟩, ⟨(-640636791), (-640636776)⟩, ⟨(-12955001), (-12954989)⟩, ⟨13524679, 13524693⟩, ⟨(-550817), (-550805)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨405026153, 810052307⟩, ⟨202513076, 202513077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1272427186, 2544854377⟩, ⟨636213591, 636213595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨376969329, 1507877326⟩, ⟨376969328, 753938664⟩, ⟨94242331, 94242334⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨94, 378⟩, ⟨94, 189⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94593), (-94308)⟩, ⟨94, 189⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-33210), (-8277)⟩, ⟨(-16597), (-8210)⟩, ⟨(-2066), (-2026)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5079846, 5104780⟩, ⟨(-16597), (-8210)⟩, ⟨(-2066), (-2026)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨445858, 1792187⟩, ⟨440031, 895374⟩, ⟨107824, 111115⟩, ⟨(-728), (-353)⟩, ⟨(-46), (-41)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142719719), (-141373389)⟩, ⟨440031, 895374⟩, ⟨107824, 111115⟩, ⟨(-728), (-353)⟩, ⟨(-46), (-41)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-50106046), (-12408343)⟩, ⟨(-25014402), (-12093995)⟩, ⟨(-3083544), (-2905900)⟩, ⟨18862, 39123⟩, ⟨2220, 2406⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1381549719, 1419247423⟩, ⟨(-25014402), (-12093995)⟩, ⟨(-3083544), (-2905900)⟩, ⟨18862, 39123⟩, ⟨2220, 2406⟩⟩
...
def j70 : Jet := ⟨⟨(-38), (-9)⟩, ⟨(-19), (-9)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11797, 11827⟩, ⟨(-19), (-9)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1035, 4153⟩, ⟨1028, 2077⟩, ⟨252, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851142), (-848023)⟩, ⟨1028, 2077⟩, ⟨252, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-298819), (-74430)⟩, ⟨(-149320), (-73700)⟩, ⟨(-18565), (-18150)⟩, ⟨43, 92⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35492575, 35716965⟩, ⟨(-149320), (-73700)⟩, ⟨(-18565), (-18150)⟩, ⟨43, 92⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3115183, 12539514⟩, ⟨3062759, 6263289⟩, ⟨746065, 775659⟩, ⟨(-6533), (-3177)⟩, ⟨(-405), (-378)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712712700), (-703288368)⟩, ⟨3062759, 6263289⟩, ⟨746065, 775659⟩, ⟨(-6533), (-3177)⟩, ⟨(-405), (-378)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-250219210), (-61727628)⟩, ⟨(-124840787), (-59528711)⟩, ⟨(-15304401), (-14060129)⟩, ⟨130392, 273315⟩, ⟨15080, 16709⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4044748086, 4233239668⟩, ⟨(-124840787), (-59528711)⟩, ⟨(-15304401), (-14060129)⟩, ⟨130392, 273315⟩, ⟨15080, 16709⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨409297976, 840932601⟩, ⟨189827451, 206650184⟩, ⟨(-5532446), (-2652385)⟩, ⟨(-451178), (-407269)⟩, ⟨3451, 7222⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4357595014, 4560665753⟩, ⟨61277421, 140764541⟩, ⟨15334852, 21601202⟩, ⟨124709, 1058865⟩, ⟨25594, 96197⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨415266216, 892954999⟩, ⟨198435009, 246995109⟩, ⟨(-1705015), 8311159⟩, ⟨29235, 795603⟩, ⟨(-31163), 62171⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-810052307), (-405026153)⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3484914989, 3889941143⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨40150720, 185651852⟩, ⟨38372052, 102704168⟩, ⟨8459072, 17660105⟩, ⟨(-190454), 1286742⟩, ⟨(-13560), 133443⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4335118016, 4480619148⟩, ⟨38372052, 102704168⟩, ⟨8459072, 17660105⟩, ⟨(-190454), 1286742⟩, ⟨(-13560), 133443⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4314995956, 4386811224⟩, ⟨18784340, 51113727⟩, ⟨3843204, 8748181⟩, ⟨(-198413), 623655⟩, ⟨(-23006), 67052⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3501166143, 3973123959⟩, ⟨(-191602115), (-157163877)⟩, ⟨708279, 7037501⟩, ⟨(-592191), 383632⟩, ⟨(-50244), 70085⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2083640842, 4167281692⟩, ⟨1041820418, 1041820425⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1010848013, 4043392069⟩, ⟨1010848010, 2021696040⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1010848013, 4043392069⟩, ⟨1010848010, 2021696040⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4043392069), (-1010848013)⟩, ⟨(-2021696040), (-1010848010)⟩, ⟨(-252712006), (-252712001)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2021696035), (-505424006)⟩, ⟨(-1010848020), (-505424005)⟩, ⟨(-126356003), (-126356000)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2682451597, 3818148978⟩, ⟨(-898625780), (-315666065)⟩, ⟨(-93754717), 26832147⟩, ⟨4086129, 24980035⟩, ⟨(-1864498), 1258899⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2186677584, 3532036018⟩, ⟨(-1001618113), (-355482061)⟩, ⟨(-74735818), 71166149⟩, ⟨135032, 27579621⟩, ⟨(-3117719), 1245217⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4343091884, 4343091886⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified622
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4314995956, 4386811224⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified623
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (33681167 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((37721 / 400000) : ℝ)..(37721 / 200000), prawitzNormalCorrection
