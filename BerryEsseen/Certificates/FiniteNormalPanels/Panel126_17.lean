...
namespace FiniteNormalPanel126_17

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (14319 / 400000)
def radius : Rat := (14319 / 400000)

def j0 : Jet := ⟨⟨153749091, 153749092⟩, ⟨153749091, 153749092⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨483017014, 483017018⟩, ⟨483017014, 483017018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨54320654, 54320656⟩, ⟨108641308, 108641312⟩, ⟨54320654, 54320656⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1198), (-1197)⟩, ⟨(-2395), (-2393)⟩, ⟨(-1198), (-1195)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111858, 5111860⟩, ⟨(-2395), (-2393)⟩, ⟨(-1198), (-1195)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨64652, 64653⟩, ⟨129273, 129275⟩, ⟨64575, 64578⟩, ⟨(-62), (-59)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-143100925), (-143100923)⟩, ⟨129273, 129275⟩, ⟨64575, 64578⟩, ⟨(-62), (-59)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1809871), (-1809870)⟩, ⟨(-3618108), (-3618105)⟩, ⟨(-1805786), (-1805782)⟩, ⟨3266, 3270⟩, ⟨813, 816⟩⟩
...
def j19 : Jet := ⟨⟨1429845894, 1429845896⟩, ⟨(-3618108), (-3618105)⟩, ⟨(-1805786), (-1805782)⟩, ⟨3266, 3270⟩, ⟨813, 816⟩⟩
...
def j28 : Jet := ⟨⟨(-10777), (-10776)⟩, ⟨(-21550), (-21548)⟩, ⟨(-10769), (-10766)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780617, 35780619⟩, ⟨(-21550), (-21548)⟩, ⟨(-10769), (-10766)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨452535, 452536⟩, ⟨904798, 904800⟩, ⟨451852, 451855⟩, ⟨(-546), (-543)⟩, ⟨(-138), (-134)⟩⟩
...
def j33 : Jet := ⟨⟨(-715375348), (-715375346)⟩, ⟨904798, 904800⟩, ⟨451852, 451855⟩, ⟨(-546), (-543)⟩, ⟨(-138), (-134)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9047720), (-9047718)⟩, ⟨(-18083996), (-18083993)⟩, ⟨(-9019120), (-9019116)⟩, ⟨22865, 22868⟩, ⟨5698, 5701⟩⟩
...
def j36 : Jet := ⟨⟨4285919576, 4285919578⟩, ⟨(-18083996), (-18083993)⟩, ⟨(-9019120), (-9019116)⟩, ⟨22865, 22868⟩, ⟨5698, 5701⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨160802131, 160802133⟩, ⟨160395234, 160395237⟩, ⟨(-609978), (-609976)⟩, ⟨(-202714), (-202712)⟩, ⟨458, 460⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304034114, 4304034117⟩, ⟨18160424, 18160429⟩, ⟨9133860, 9133867⟩, ⟨53789, 53796⟩, ⟨13623, 13631⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨161141589, 161141592⟩, ⟨161413753, 161413758⟩, ⟨408901, 408906⟩, ⟨137394, 137401⟩, ⟨820, 828⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-153749092), (-153749091)⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4141218204, 4141218205⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6045822, 6045824⟩, ⟨12112068, 12112070⟩, ⟨6096944, 6096948⟩, ⟨41042, 41048⟩, ⟨10424, 10431⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301013118, 4301013120⟩, ⟨12112068, 12112070⟩, ⟨6096944, 6096948⟩, ⟨41042, 41048⟩, ⟨10424, 10431⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297989143, 4297989145⟩, ⟨6051776, 6051778⟩, ⟨3042067, 3042071⟩, ⟨16222, 16227⟩, ⟨4108, 4114⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4144131876, 4144131880⟩, ⟨(-148022130), (-148022125)⟩, ⟨2716529, 2716535⟩, ⟨(-93258), (-93251)⟩, ⟨3379, 3387⟩⟩
...
def j47 : Jet := ⟨⟨1323100957, 1323100967⟩, ⟨1323100957, 1323100967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨407592426, 407592433⟩, ⟨815184852, 815184866⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨407592426, 407592433⟩, ⟨815184852, 815184866⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-407592433), (-407592426)⟩, ⟨(-815184866), (-815184852)⟩, ⟨(-407592433), (-407592426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-203796217), (-203796213)⟩, ⟨(-407592433), (-407592426)⟩, ⟨(-203796217), (-203796213)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4095930568, 4095930573⟩, ⟨(-388703847), (-388703839)⟩, ⟨(-175907926), (-175907920)⟩, ⟨17860553, 17860555⟩, ⟨3749673, 3749675⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3952085140, 3952085149⟩, ⟨(-516215427), (-516215411)⟩, ⟨(-153743235), (-153743220)⟩, ⟨22961021, 22961036⟩, ⟨2902839, 2902855⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 307498184⟩, ⟨153749091, 153749092⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 966034036⟩, ⟨483017014, 483017018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 217282623⟩, ⟨0, 217282624⟩, ⟨54320654, 54320656⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4791), 0⟩, ⟨(-4791), 3⟩, ⟨(-1198), (-1192)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108265, 5113057⟩, ⟨(-4791), 3⟩, ⟨(-1198), (-1192)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 258670⟩, ⟨(-243), 258671⟩, ⟨64302, 64669⟩, ⟨(-122), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142906906)⟩, ⟨(-243), 258671⟩, ⟨64302, 64669⟩, ⟨(-122), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7242755), 0⟩, ⟨(-7242768), 13087⟩, ⟨(-1810702), (-1791057)⟩, ⟨(-11), 6545⟩, ⟨805, 819⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424413010, 1431655766⟩, ⟨(-7242768), 13087⟩, ⟨(-1810702), (-1791057)⟩, ⟨(-11), 6545⟩, ⟨805, 819⟩⟩
...
def j72 : Jet := ⟨⟨0, 599⟩, ⟨(-1), 599⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851577)⟩, ⟨(-1), 599⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-43112), 0⟩, ⟨(-43113), 31⟩, ⟨(-10779), (-10731)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35748282, 35791395⟩, ⟨(-43113), 31⟩, ⟨(-10779), (-10731)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1810689⟩, ⟨(-2182), 1810691⟩, ⟨449398, 452675⟩, ⟨(-1093), 2⟩, ⟨(-139), (-133)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714017193)⟩, ⟨(-2182), 1810691⟩, ⟨449398, 452675⟩, ⟨(-1093), 2⟩, ⟨(-139), (-133)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-36213771), 0⟩, ⟨(-36213882), 91603⟩, ⟨(-9053554), (-8916037)⟩, ⟨(-84), 45803⟩, ⟨5619, 5727⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4258753525, 4294967296⟩, ⟨(-36213882), 91603⟩, ⟨(-9053554), (-8916037)⟩, ⟨(-84), 45803⟩, ⟨5619, 5727⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 322011346⟩, ⟨158562081, 161008617⟩, ⟨(-1221799), 1472⟩, ⟨(-203637), (-199951)⟩, ⟨(-2), 922⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4331489007⟩, ⟨(-93168), 36832382⟩, ⟨8915251, 9521382⟩, ⟨(-46991), 159352⟩, ⟨11941, 15932⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 324749529⟩, ⟨158555095, 165139210⟩, ⟨(-1235682), 2096106⟩, ⟨109763, 168960⟩, ⟨(-6221), 8108⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-307498184), 0⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3987469112, 4294967296⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 24554846⟩, ⟨0, 24972894⟩, ⟨5666432, 6666497⟩, ⟨(-95024), 186742⟩, ⟨6558, 15245⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4319522142⟩, ⟨0, 24972894⟩, ⟨5666432, 6666497⟩, ⟨(-95024), 186742⟩, ⟨6558, 15245⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307227222⟩, ⟨0, 12486447⟩, ⟨2807052, 3333249⟩, ⟨(-57203), 93371⟩, ⟨1708, 6873⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3987469112, 4307227222⟩, ⟨(-154187967), (-141262644)⟩, ⟨2159097, 3333249⟩, ⟨(-176525), (-7114)⟩, ⟨(-1758), 8921⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2646201933⟩, ⟨1323100957, 1323100967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1630369730⟩, ⟨0, 1630369732⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1630369730⟩, ⟨0, 1630369732⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1630369730), 0⟩, ⟨(-1630369732), 0⟩, ⟨(-407592433), (-407592426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-815184865), 0⟩, ⟨(-815184866), 0⟩, ⟨(-203796217), (-203796213)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3552472797, 4294967296⟩, ⟨(-815184866), 0⟩, ⟨(-203796217), (-91203795)⟩, ⟨0, 38680526⟩, ⟨328418, 4835066⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3298133506, 4307227222⟩, ⟨(-971699768), (-116841797)⟩, ⟨(-202592109), (-52075931)⟩, ⟨2190541, 46101276⟩, ⟨(-1243636), 4845446⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨153749091, 153749092⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297989143, 4297989145⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2542
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 307498184⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307227222⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2543
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (279349837 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(14319 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (14319 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(14319 / 200000), prawitzNormalCorrection
