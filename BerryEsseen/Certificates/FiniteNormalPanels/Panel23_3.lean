...
namespace FiniteNormalPanel23_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (11599 / 100000)
def radius : Rat := (11599 / 100000)

def j0 : Jet := ⟨⟨498173256, 498173257⟩, ⟨498173256, 498173257⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1565057441, 1565057445⟩, ⟨1565057441, 1565057445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨570296494, 570296498⟩, ⟨1140592988, 1140592996⟩, ⟨570296494, 570296498⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨142, 143⟩, ⟨285, 286⟩, ⟨142, 143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94545), (-94543)⟩, ⟨285, 286⟩, ⟨142, 143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12554), (-12553)⟩, ⟨(-25071), (-25069)⟩, ⟨(-12461), (-12458)⟩, ⟨74, 76⟩, ⟨18, 19⟩⟩
...
def j13 : Jet := ⟨⟨5100502, 5100504⟩, ⟨(-25071), (-25069)⟩, ⟨(-12461), (-12458)⟩, ⟨74, 76⟩, ⟨18, 19⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨677257, 677258⟩, ⟨1351185, 1351188⟩, ⟨668944, 668947⟩, ⟨(-6630), (-6625)⟩, ⟨(-1634), (-1630)⟩⟩
...
def j16 : Jet := ⟨⟨(-142488320), (-142488318)⟩, ⟨1351185, 1351188⟩, ⟨668944, 668947⟩, ⟨(-6630), (-6625)⟩, ⟨(-1634), (-1630)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18919956), (-18919955)⟩, ⟨(-37660498), (-37660495)⟩, ⟨(-18472305), (-18472301)⟩, ⟨356180, 356185⟩, ⟨86846, 86850⟩⟩
...
def j19 : Jet := ⟨⟨1412735809, 1412735811⟩, ⟨(-37660498), (-37660495)⟩, ⟨(-18472305), (-18472301)⟩, ⟨356180, 356185⟩, ⟨86846, 86850⟩⟩
...
def j25 : Jet := ⟨⟨1569, 1570⟩, ⟨3134, 3137⟩, ⟨1559, 1562⟩, ⟨(-8), (-6)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850608), (-850606)⟩, ⟨3134, 3137⟩, ⟨1559, 1562⟩, ⟨(-8), (-6)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-112946), (-112945)⟩, ⟨(-225476), (-225474)⟩, ⟨(-111907), (-111903)⟩, ⟨828, 832⟩, ⟨203, 207⟩⟩
...
def j30 : Jet := ⟨⟨35678448, 35678450⟩, ⟨(-225476), (-225474)⟩, ⟨(-111907), (-111903)⟩, ⟨828, 832⟩, ⟨203, 207⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4737473, 4737474⟩, ⟨9445007, 9445009⟩, ⟨4662734, 4662738⟩, ⟨(-59550), (-59545)⟩, ⟨(-14615), (-14609)⟩⟩
...
def j33 : Jet := ⟨⟨(-711090410), (-711090408)⟩, ⟨9445007, 9445009⟩, ⟨4662734, 4662738⟩, ⟨(-59550), (-59545)⟩, ⟨(-14615), (-14609)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-94420363), (-94420361)⟩, ⟨(-187586595), (-187586591)⟩, ⟨(-91292971), (-91292966)⟩, ⟨2484481, 2484487⟩, ⟨601373, 601379⟩⟩
...
def j36 : Jet := ⟨⟨4200546933, 4200546935⟩, ⟨(-187586595), (-187586591)⟩, ⟨(-91292971), (-91292966)⟩, ⟨2484481, 2484487⟩, ⟨601373, 601379⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨514791507, 514791510⟩, ⟨501068272, 501068277⟩, ⟨(-20454420), (-20454416)⟩, ⟨(-6601396), (-6601391)⟩, ⟨161435, 161440⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4391510048, 4391510051⟩, ⟨196114556, 196114562⟩, ⟨104201296, 104201304⟩, ⟨6318222, 6318233⟩, ⟨1802109, 1802121⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨526363047, 526363052⟩, ⟨535837481, 535837489⟩, ⟨14454808, 14454816⟩, ⟨5230079, 5230091⟩, ⟨320491, 320503⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-498173257), (-498173256)⟩, ⟨(-498173257), (-498173256)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3796794039, 3796794040⟩, ⟨(-498173257), (-498173256)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨64507605, 64507608⟩, ⟨131337460, 131337464⟩, ⟨70393726, 70393733⟩, ⟨4888672, 4888680⟩, ⟨1432203, 1432213⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4359474901, 4359474904⟩, ⟨131337460, 131337464⟩, ⟨70393726, 70393733⟩, ⟨4888672, 4888680⟩, ⟨1432203, 1432213⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4327100891, 4327100894⟩, ⟨65181065, 65181068⟩, ⟨34444560, 34444565⟩, ⟨1907329, 1907335⟩, ⟨544958, 544967⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3825200458, 3825200462⟩, ⟨(-444279721), (-444279715)⟩, ⟨22888982, 22888989⟩, ⟨(-2309129), (-2309120)⟩, ⟨260516, 260526⟩⟩
...
def j47 : Jet := ⟨⟨1775026680, 1775026685⟩, ⟨1775026680, 1775026685⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨733584099, 733584104⟩, ⟨1467168198, 1467168208⟩, ⟨733584099, 733584104⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨733584099, 733584104⟩, ⟨1467168198, 1467168208⟩, ⟨733584099, 733584104⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-733584104), (-733584099)⟩, ⟨(-1467168208), (-1467168198)⟩, ⟨(-733584104), (-733584099)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-366792052), (-366792049)⟩, ⟨(-733584104), (-733584099)⟩, ⟨(-366792052), (-366792049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3943400852, 3943400855⟩, ⟨(-673536254), (-673536248)⟩, ⟨(-279247843), (-279247838)⟩, ⟨54245446, 54245448⟩, ⟨9607650, 9607651⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3512086985, 3512086993⟩, ⟨(-1007780485), (-1007780471)⟩, ⟨(-158017515), (-158017500)⟩, ⟨71488660, 71488677⟩, ⟨2058669, 2058687⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 996346514⟩, ⟨498173256, 498173257⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 3130114889⟩, ⟨1565057441, 1565057445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 2281185989⟩, ⟨0, 2281185990⟩, ⟨570296494, 570296498⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 572⟩, ⟨0, 572⟩, ⟨142, 143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94114)⟩, ⟨0, 572⟩, ⟨142, 143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-50292), 0⟩, ⟨(-50292), 304⟩, ⟨(-12573), (-12116)⟩, ⟨0, 152⟩, ⟨18, 19⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5062764, 5113057⟩, ⟨(-50292), 304⟩, ⟨(-12573), (-12116)⟩, ⟨0, 152⟩, ⟨18, 19⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2715698⟩, ⟨(-26712), 2715860⟩, ⟨638856, 679087⟩, ⟨(-13356), 122⟩, ⟨(-1670), (-1516)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-140449878)⟩, ⟨(-26712), 2715860⟩, ⟨638856, 679087⟩, ⟨(-13356), 122⟩, ⟨(-1670), (-1516)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-76039534), 0⟩, ⟨(-76053722), 1442475⟩, ⟨(-19024072), (-16846126)⟩, ⟨(-10641), 721368⟩, ⟨76847, 90236⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1355616231, 1431655766⟩, ⟨(-76053722), 1442475⟩, ⟨(-19024072), (-16846126)⟩, ⟨(-10641), 721368⟩, ⟨76847, 90236⟩⟩
...
def j72 : Jet := ⟨⟨0, 6287⟩, ⟨(-31), 6287⟩, ⟨1524, 1572⟩, ⟨(-16), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-845889)⟩, ⟨(-31), 6287⟩, ⟨1524, 1572⟩, ⟨(-16), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-452617), 0⟩, ⟨(-452634), 3340⟩, ⟨(-113172), (-108144)⟩, ⟨(-14), 1670⟩, ⟨191, 209⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35338777, 35791395⟩, ⟨(-452634), 3340⟩, ⟨(-113172), (-108144)⟩, ⟨(-14), 1670⟩, ⟨191, 209⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 19009884⟩, ⟨(-240408), 19011658⟩, ⟨4391853, 4754245⟩, ⟨(-120220), 1331⟩, ⟨(-15036), (-13360)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-696817998)⟩, ⟨(-240408), 19011658⟩, ⟨4391853, 4754245⟩, ⟨(-120220), 1331⟩, ⟨(-15036), (-13360)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-380197666), 0⟩, ⟨(-380325354), 10097662⟩, ⟨(-95177105), (-79902450)⟩, ⟨(-95775), 5050246⟩, ⟨511321, 631988⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3914769630, 4294967296⟩, ⟨(-380325354), 10097662⟩, ⟨(-95177105), (-79902450)⟩, ⟨(-95775), 5050246⟩, ⟨511321, 631988⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 1043371631⟩, ⟨438550575, 522737073⟩, ⟨(-41577960), 525629⟩, ⟨(-6940001), (-5612891)⟩, ⟨(-3878), 328625⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4712089297⟩, ⟨(-12154250), 457786077⟩, ⟨78826174, 159036350⟩, ⟨(-6784541), 26695726⟩, ⟨(-401519), 5914770⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 1144702616⟩, ⟨435597956, 684714125⟩, ⟨(-47095246), 94927984⟩, ⟨(-5645040), 20346123⟩, ⟨(-3206821), 5085630⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-996346514), 0⟩, ⟨(-498173257), (-498173256)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3298620782, 4294967296⟩, ⟨(-498173257), (-498173256)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 305088256⟩, ⟨0, 364982548⟩, ⟨19074761, 159759554⟩, ⟨(-18025132), 41112674⟩, ⟨(-4550174), 11296234⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4600055552⟩, ⟨0, 364982548⟩, ⟨19074761, 159759554⟩, ⟨(-18025132), 41112674⟩, ⟨(-4550174), 11296234⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4444894617⟩, ⟨0, 182491274⟩, ⟨5469466, 79879777⟩, ⟨(-12406623), 20556337⟩, ⟨(-3891338), 6171787⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3298620782, 4444894617⟩, ⟨(-515563327), (-315681982)⟩, ⟨(-16966504), 79879777⟩, ⟨(-21671879), 19921934⟩, ⟨(-6275668), 7610832⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3550053369⟩, ⟨1775026680, 1775026685⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2934336412⟩, ⟨0, 2934336414⟩, ⟨733584099, 733584104⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2934336412⟩, ⟨0, 2934336414⟩, ⟨733584099, 733584104⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2934336412), 0⟩, ⟨(-2934336414), 0⟩, ⟨(-733584104), (-733584099)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1467168206), 0⟩, ⟨(-1467168207), 0⟩, ⟨(-366792052), (-366792049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3052137675, 4294967296⟩, ⟨(-1467168207), 0⟩, ⟨(-366792052), (-10060275)⟩, ⟨0, 125296796⟩, ⟨(-10270825), 15662100⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2344102776, 4444894617⟩, ⟨(-2033946965), (-224333459)⟩, ⟨(-396562414), 248270604⟩, ⟨(-48219515), 199417667⟩, ⟨(-45572654), 32671759⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨498173256, 498173257⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨498173256, 498173257⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4327100891, 4327100894⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified448
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 996346514⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4444894617⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified449
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (402015407 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(11599 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(11599 / 50000), prawitzNormalCorrection
