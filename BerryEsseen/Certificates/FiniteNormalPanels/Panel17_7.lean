...
namespace FiniteNormalPanel17_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (7979 / 32000)
def radius : Rat := (7979 / 160000)

def j0 : Jet := ⟨⟨1070923251, 1070923252⟩, ⟨214184650, 214184651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3364404617, 3364404622⟩, ⟨672880922, 672880927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2635460911, 2635460920⟩, ⟨1054184362, 1054184374⟩, ⟨105418436, 105418438⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨659, 661⟩, ⟨263, 265⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94028), (-94025)⟩, ⟨263, 265⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-57698), (-57695)⟩, ⟨(-22918), (-22915)⟩, ⟨(-2229), (-2224)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5055358, 5055362⟩, ⟨(-22918), (-22915)⟩, ⟨(-2229), (-2224)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3102048, 3102052⟩, ⟨1226756, 1226760⟩, ⟨117087, 117095⟩, ⟨(-1104), (-1098)⟩, ⟨(-53), (-49)⟩⟩
...
def j16 : Jet := ⟨⟨(-140063529), (-140063524)⟩, ⟨1226756, 1226760⟩, ⟨117087, 117095⟩, ⟨(-1104), (-1098)⟩, ⟨(-53), (-49)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-85945232), (-85945227)⟩, ⟨(-33625336), (-33625331)⟩, ⟨(-3064862), (-3064853)⟩, ⟨58170, 58179⟩, ⟨2569, 2576⟩⟩
...
def j19 : Jet := ⟨⟨1345710533, 1345710539⟩, ⟨(-33625336), (-33625331)⟩, ⟨(-3064862), (-3064853)⟩, ⟨58170, 58179⟩, ⟨2569, 2576⟩⟩
...
def j22 : Jet := ⟨⟨(-67), (-65)⟩, ⟨(-27), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11768, 11771⟩, ⟨(-27), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7221, 7223⟩, ⟨2871, 2875⟩, ⟨279, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844956), (-844953)⟩, ⟨2871, 2875⟩, ⟨279, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-518479), (-518476)⟩, ⟨(-205631), (-205625)⟩, ⟨(-19865), (-19859)⟩, ⟨136, 141⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35272915, 35272919⟩, ⟨(-205631), (-205625)⟩, ⟨(-19865), (-19859)⟩, ⟨136, 141⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21644027, 21644030⟩, ⟨8531431, 8531438⟩, ⟨803099, 803108⟩, ⟨(-9841), (-9833)⟩, ⟨(-453), (-447)⟩⟩
...
def j33 : Jet := ⟨⟨(-694183856), (-694183852)⟩, ⟨8531431, 8531438⟩, ⟨803099, 803108⟩, ⟨(-9841), (-9833)⟩, ⟨(-453), (-447)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-425962365), (-425962360)⟩, ⟨(-165149924), (-165149915)⟩, ⟨(-14451692), (-14451683)⟩, ⟨400478, 400489⟩, ⟨17017, 17025⟩⟩
...
def j36 : Jet := ⟨⟨3869004931, 3869004936⟩, ⟨(-165149924), (-165149915)⟩, ⟨(-14451692), (-14451683)⟩, ⟨400478, 400489⟩, ⟨17017, 17025⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1054144168, 1054144176⟩, ⟨184488880, 184488888⟩, ⟨(-7668810), (-7668800)⟩, ⟨(-434598), (-434588)⟩, ⟨11125, 11133⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4767826451, 4767826458⟩, ⟨203516444, 203516459⟩, ⟨26496175, 26496191⟩, ⟨1397653, 1397671⟩, ⟨116580, 116597⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1170201331, 1170201342⟩, ⟨254750864, 254750879⟩, ⟨6732006, 6732026⟩, ⟨635337, 635358⟩, ⟨33093, 33113⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1070923252), (-1070923251)⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3224044044, 3224044045⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨318831567, 318831574⟩, ⟨138818192, 138818204⟩, ⟨18778629, 18778646⟩, ⟨1144806, 1144824⟩, ⟨103951, 103968⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4613798863, 4613798870⟩, ⟨138818192, 138818204⟩, ⟨18778629, 18778646⟩, ⟨1144806, 1144824⟩, ⟨103951, 103968⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4451529537, 4451529542⟩, ⟨66967947, 66967954⟩, ⟨8555361, 8555371⟩, ⟨423565, 423576⟩, ⟨35553, 35564⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3341568468, 3341568474⟩, ⟨(-171722308), (-171722299)⟩, ⟨3082526, 3082536⟩, ⟨(-108695), (-108685)⟩, ⟨5564, 5575⟩⟩
...
def j47 : Jet := ⟨⟨4871840631, 4871840638⟩, ⟨974368125, 974368131⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5526196009, 5526196026⟩, ⟨2210478400, 2210478420⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5526196009, 5526196026⟩, ⟨2210478400, 2210478420⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5526196026), (-5526196009)⟩, ⟨(-2210478420), (-2210478400)⟩, ⟨(-221047843), (-221047839)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2763098013), (-2763098004)⟩, ⟨(-1105239210), (-1105239200)⟩, ⟨(-110523922), (-110523919)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2257166011, 2257166028⟩, ⟨(-580844562), (-580844552)⟩, ⟨16650939, 16650945⟩, ⟨8536437, 8536439⟩, ⟨(-763421), (-763420)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1756119255, 1756119272⟩, ⟨(-542154918), (-542154902)⟩, ⟨37798187, 37798203⟩, ⟨5501770, 5501783⟩, ⟨(-905691), (-905679)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨856738601, 1285107903⟩, ⟨214184650, 214184651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2691523694, 4037285548⟩, ⟨672880922, 672880927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1686694984, 3795063728⟩, ⟨843347490, 1265021248⟩, ⟨105418436, 105418438⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨422, 951⟩, ⟨211, 317⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94265), (-93735)⟩, ⟨211, 317⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-83294), (-36811)⟩, ⟨(-27683), (-18124)⟩, ⟨(-2263), (-2182)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5029762, 5076246⟩, ⟨(-27683), (-18124)⟩, ⟨(-2263), (-2182)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1975259, 4485408⟩, ⟨963168, 1488019⟩, ⟨113299, 120181⟩, ⟨(-1344), (-857)⟩, ⟨(-55), (-47)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141190318), (-138680168)⟩, ⟨963168, 1488019⟩, ⟨113299, 120181⟩, ⟨(-1344), (-857)⟩, ⟨(-55), (-47)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-124756772), (-54461682)⟩, ⟨(-41207342), (-25916016)⟩, ⟨(-3231848), (-2859387)⟩, ⟨44699, 71585⟩, ⟨2335, 2764⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1306898993, 1377194084⟩, ⟨(-41207342), (-25916016)⟩, ⟨(-3231848), (-2859387)⟩, ⟨44699, 71585⟩, ⟨2335, 2764⟩⟩
...
def j70 : Jet := ⟨⟨(-96), (-42)⟩, ⟨(-32), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11739, 11794⟩, ⟨(-32), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4610, 10422⟩, ⟨2276, 3466⟩, ⟨275, 286⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847567), (-841754)⟩, ⟨2276, 3466⟩, ⟨275, 286⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-748917), (-330568)⟩, ⟨(-248746), (-162221)⟩, ⟨(-20251), (-19386)⟩, ⟨106, 171⟩, ⟨4, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35042477, 35460827⟩, ⟨(-248746), (-162221)⟩, ⟨(-20251), (-19386)⟩, ⟨106, 171⟩, ⟨4, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13761681, 31333440⟩, ⟨6661046, 10380774⟩, ⟨768946, 830908⟩, ⟨(-12030), (-7635)⟩, ⟨(-477), (-416)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702066202), (-684494442)⟩, ⟨6661046, 10380774⟩, ⟨768946, 830908⟩, ⟨(-12030), (-7635)⟩, ⟨(-477), (-416)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-620350703), (-268810741)⟩, ⟨(-204167682), (-125232844)⟩, ⟨(-15622046), (-13008965)⟩, ⟨303850, 496528⟩, ⟨14907, 18733⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3674616593, 4026156555⟩, ⟨(-204167682), (-125232844)⟩, ⟨(-15622046), (-13008965)⟩, ⟨303850, 496528⟩, ⟨14907, 18733⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨818993338, 1294567663⟩, ⟨166013276, 199520510⟩, ⟨(-9493793), (-5852081)⟩, ⟨(-478314), (-380681)⟩, ⟨8465, 13815⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4581725479, 5020045931⟩, ⟨142513710, 278921928⟩, ⟨19236931, 36839283⟩, ⟨439736, 2853788⟩, ⟨18076, 284809⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨873674322, 1513117256⟩, ⟨204272808, 317274928⟩, ⟨(-1919735), 17818289⟩, ⟨(-348191), 1971248⟩, ⟨(-83022), 195724⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1285107903), (-856738601)⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3009859393, 3438228695⟩, ⟨(-214184651), (-214184650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨177721218, 533071308⟩, ⟨83105594, 223551956⟩, ⟨8362766, 35992290⟩, ⟨(-528964), 4021464⟩, ⟨(-117907), 503068⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4472688514, 4828038604⟩, ⟨83105594, 223551956⟩, ⟨8362766, 35992290⟩, ⟨(-528964), 4021464⟩, ⟨(-117907), 503068⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4382927205, 4553709248⟩, ⟨39191765, 109532773⟩, ⟨2626471, 17459761⟩, ⟨(-695509), 1946895⟩, ⟨(-141202), 263082⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3071500597, 3645358097⟩, ⟨(-199622690), (-130887376)⟩, ⟨(-3621665), 12022532⟩, ⟨(-1427470), 1427561⟩, ⟨(-210126), 245289⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3897472505, 5846208768⟩, ⟨974368125, 974368131⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3536765446, 7957722284⟩, ⟨1768382720, 2652574104⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3536765446, 7957722284⟩, ⟨1768382720, 2652574104⟩, ⟨221047839, 221047843⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7957722284), (-3536765446)⟩, ⟨(-2652574104), (-1768382720)⟩, ⟨(-221047843), (-221047839)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3978861142), (-1768382723)⟩, ⟨(-1326287052), (-884191360)⟩, ⟨(-110523922), (-110523919)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1700705451, 2845418777⟩, ⟨(-878666081), (-350118862)⟩, ⟨(-37183243), 91901304⟩, ⟨(-3453228), 18901417⟩, ⟨(-2641656), 745015⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1216241579, 2415052238⟩, ⟨(-878018948), (-302212118)⟩, ⟨(-23288945), 126805155⟩, ⟨(-10607621), 19457495⟩, ⟨(-3655959), 1504624⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1070923251, 1070923252⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4451529537, 4451529542⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified342
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨856738601, 1285107903⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4382927205, 4553709248⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified343
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (176437593 / 4294967296)

theorem envelope_integral : (∫ s in ((7979 / 40000) : ℝ)..(23937 / 80000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((7979 / 40000) : ℝ)..(23937 / 80000), prawitzNormalCorrection
