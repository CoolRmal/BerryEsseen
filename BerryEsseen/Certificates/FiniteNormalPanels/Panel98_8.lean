...
namespace FiniteNormalPanel98_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (30209 / 160000)
def radius : Rat := (30209 / 800000)

def j0 : Jet := ⟨⟨810916669, 810916670⟩, ⟨162183333, 162183334⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2547569849, 2547569854⟩, ⟨509513967, 509513971⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1511096985, 1511096992⟩, ⟨604438790, 604438798⟩, ⟨60443878, 60443880⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨378, 379⟩, ⟨151, 152⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94309), (-94307)⟩, ⟨151, 152⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-33181), (-33180)⟩, ⟨(-13220), (-13218)⟩, ⟨(-1302), (-1299)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5079875, 5079877⟩, ⟨(-13220), (-13218)⟩, ⟨(-1302), (-1299)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1787250, 1787252⟩, ⟨710248, 710251⟩, ⟨69170, 69174⟩, ⟨(-370), (-365)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-141378327), (-141378324)⟩, ⟨710248, 710251⟩, ⟨69170, 69174⟩, ⟨(-370), (-365)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-49741093), (-49741091)⟩, ⟨(-19646551), (-19646548)⟩, ⟨(-1865354), (-1865350)⟩, ⟨19598, 19603⟩, ⟨913, 918⟩⟩
...
def j19 : Jet := ⟨⟨1381914672, 1381914675⟩, ⟨(-19646551), (-19646548)⟩, ⟨(-1865354), (-1865350)⟩, ⟨19598, 19603⟩, ⟨913, 918⟩⟩
...
def j22 : Jet := ⟨⟨(-38), (-37)⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11797, 11799⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4150, 4152⟩, ⟨1654, 1656⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848027), (-848024)⟩, ⟨1654, 1656⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-298362), (-298360)⟩, ⟨(-118764), (-118761)⟩, ⟨(-11647), (-11641)⟩, ⟨44, 48⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35493032, 35493035⟩, ⟨(-118764), (-118761)⟩, ⟨(-11647), (-11641)⟩, ⟨44, 48⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12487502, 12487504⟩, ⟨4953215, 4953219⟩, ⟨478688, 478693⟩, ⟨(-3297), (-3292)⟩, ⟨(-158), (-154)⟩⟩
...
def j33 : Jet := ⟨⟨(-703340381), (-703340378)⟩, ⟨4953215, 4953219⟩, ⟨478688, 478693⟩, ⟨(-3297), (-3292)⟩, ⟨(-158), (-154)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-247456025), (-247456022)⟩, ⟨(-97239723), (-97239718)⟩, ⟨(-9032751), (-9032745)⟩, ⟨135913, 135918⟩, ⟨6216, 6220⟩⟩
...
def j36 : Jet := ⟨⟨4047511271, 4047511274⟩, ⟨(-97239723), (-97239718)⟩, ⟨(-9032751), (-9032745)⟩, ⟨135913, 135918⟩, ⟨6216, 6220⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨819685904, 819685908⟩, ⟨152283781, 152283787⟩, ⟨(-3437120), (-3437115)⟩, ⟨(-209664), (-209659)⟩, ⟨2865, 2871⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4557552240, 4557552244⟩, ⟨109493232, 109493239⟩, ⟨12801519, 12801529⟩, ⟨398858, 398867⟩, ⟨27467, 27478⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨869799714, 869799720⟩, ⟨182490642, 182490653⟩, ⟨2678113, 2678124⟩, ⟨219908, 219919⟩, ⟨6833, 6847⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-810916670), (-810916669)⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3484050626, 3484050627⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨176148382, 176148386⟩, ⟨73914558, 73914566⟩, ⟨8838640, 8838650⟩, ⟨316650, 316660⟩, ⟨23121, 23134⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4471115678, 4471115682⟩, ⟨73914558, 73914566⟩, ⟨8838640, 8838650⟩, ⟨316650, 316660⟩, ⟨23121, 23134⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4382156502, 4382156505⟩, ⟨36221961, 36221966⟩, ⟨4181689, 4181696⟩, ⟨120609, 120616⟩, ⟨8337, 8346⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3554777964, 3554777969⟩, ⟨(-136092680), (-136092673)⟩, ⟨2024372, 2024380⟩, ⟨(-60070), (-60062)⟩, ⟨2207, 2217⟩⟩
...
def j47 : Jet := ⟨⟨6433143312, 6433143322⟩, ⟨1286628656, 1286628665⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9635773690, 9635773721⟩, ⟨3854309456, 3854309492⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9635773690, 9635773721⟩, ⟨3854309456, 3854309492⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9635773721), (-9635773690)⟩, ⟨(-3854309492), (-3854309456)⟩, ⟨(-385430950), (-385430943)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4817886861), (-4817886845)⟩, ⟨(-1927154746), (-1927154728)⟩, ⟨(-192715475), (-192715471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1398908431, 1398908441⟩, ⟨(-627691169), (-627691158)⟩, ⟨78053606, 78053613⟩, ⟨7102126, 7102129⟩, ⟨(-2547819), (-2547817)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1157822288, 1157822299⟩, ⟨(-563842231), (-563842217)⟩, ⟨85150662, 85150676⟩, ⟨3089483, 3089493⟩, ⟨(-2287490), (-2287478)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨648733335, 973100003⟩, ⟨162183333, 162183334⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2038055879, 3057083821⟩, ⟨509513967, 509513971⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨967102070, 2175979663⟩, ⟨483551032, 725326556⟩, ⟨60443878, 60443880⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨242, 546⟩, ⟨121, 182⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94445), (-94140)⟩, ⟨121, 182⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-47850), (-21197)⟩, ⟨(-15923), (-10505)⟩, ⟨(-1314), (-1284)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5065206, 5091860⟩, ⟨(-15923), (-10505)⟩, ⟨(-1314), (-1284)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1140537, 2579714⟩, ⟨562200, 857540⟩, ⟨67927, 70188⟩, ⟨(-447), (-287)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142025040), (-140585862)⟩, ⟨562200, 857540⟩, ⟨67927, 70188⟩, ⟨(-447), (-287)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-71954820), (-31655858)⟩, ⟨(-23858350), (-15393469)⟩, ⟨(-1920156), (-1798111)⟩, ⟨15331, 23859⟩, ⟨869, 953⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1359700945, 1399999908⟩, ⟨(-23858350), (-15393469)⟩, ⟨(-1920156), (-1798111)⟩, ⟨15331, 23859⟩, ⟨869, 953⟩⟩
...
def j70 : Jet := ⟨⟨(-55), (-24)⟩, ⟨(-19), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11780, 11812⟩, ⟨(-19), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2652, 5985⟩, ⟨1316, 1993⟩, ⟨159, 166⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849525), (-846191)⟩, ⟨1316, 1993⟩, ⟨159, 166⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-430399), (-190537)⟩, ⟨(-143171), (-94258)⟩, ⟨(-11773), (-11486)⟩, ⟨33, 58⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35360995, 35600858⟩, ⟨(-143171), (-94258)⟩, ⟨(-11773), (-11486)⟩, ⟨33, 58⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7962270, 18036632⟩, ⟨3908599, 5990987⟩, ⟨467497, 487820⟩, ⟨(-3997), (-2589)⟩, ⟨(-163), (-149)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707865613), (-697791250)⟩, ⟨3908599, 5990987⟩, ⟨467497, 487820⟩, ⟨(-3997), (-2589)⟩, ⟨(-163), (-149)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-358629315), (-157122351)⟩, ⟨(-118663003), (-75525932)⟩, ⟨(-9416609), (-8561251)⟩, ⟨105613, 166114⟩, ⟨5820, 6542⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3936337981, 4137844945⟩, ⟨(-118663003), (-75525932)⟩, ⟨(-9416609), (-8561251)⟩, ⟨105613, 166114⟩, ⟨5820, 6542⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨645207824, 996495846⟩, ⟨144319991, 158778105⟩, ⟨(-4197063), (-2679376)⟩, ⟨(-220516), (-196327)⟩, ⟨2230, 3510⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4458055900, 4686270377⟩, ⟨81370575, 141270115⟩, ⟨10708985, 15469281⟩, ⟨175689, 684671⟩, ⟨12281, 48876⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨669707671, 1087283941⟩, ⟨162023938, 206020712⟩, ⟨(-236476), 6030517⟩, ⟨7579, 476186⟩, ⟨(-12310), 30083⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-973100003), (-648733335)⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3321867293, 3646233961⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨104426491, 275249214⟩, ⟨50528288, 104309532⟩, ⟨5992483, 12935677⟩, ⟨(-20326), 819640⟩, ⟨(-5997), 69384⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4399393787, 4570216510⟩, ⟨50528288, 104309532⟩, ⟨5992483, 12935677⟩, ⟨(-20326), 819640⟩, ⟨(-5997), 69384⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4346866967, 4430454881⟩, ⟨24491542, 51532062⟩, ⟨2604920, 6321620⟩, ⟨(-84986), 390251⟩, ⟨(-12187), 34506⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3362008185, 3761256824⟩, ⟨(-148356961), (-120394727)⟩, ⟨68813, 4441940⟩, ⟨(-310863), 232941⟩, ⟨(-25084), 32505⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5146514648, 7719771978⟩, ⟨1286628656, 1286628665⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6166895158, 13875514128⟩, ⟨3083447564, 4625171384⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6166895158, 13875514128⟩, ⟨3083447564, 4625171384⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13875514128), (-6166895158)⟩, ⟨(-4625171384), (-3083447564)⟩, ⟨(-385430950), (-385430943)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6937757064), (-3083447579)⟩, ⟨(-2312585692), (-1541723782)⟩, ⟨(-192715475), (-192715471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨853953527, 2094935698⟩, ⟨(-1127998885), (-306535619)⟩, ⟨(-38982812), 265363368⟩, ⟨(-38457974), 40738904⟩, ⟨(-11437309), 6051417⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨668456486, 1834610289⟩, ⟨(-1060192427), (-263887169)⟩, ⟨(-25532287), 273518229⟩, ⟨(-44163449), 37131776⟩, ⟨(-11536999), 6999804⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨810916669, 810916670⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4382156502, 4382156505⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1978
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨648733335, 973100003⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4346866967, 4430454881⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1979
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (89690961 / 4294967296)

theorem envelope_integral : (∫ s in ((30209 / 200000) : ℝ)..(90627 / 400000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (30209 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (90627 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((30209 / 200000) : ℝ)..(90627 / 400000), prawitzNormalCorrection
