...
namespace FiniteNormalPanel56_17

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (99489 / 800000)
def radius : Rat := (33163 / 800000)

def j0 : Jet := ⟨⟨534127501, 534127502⟩, ⟨178042500, 178042501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1678011033, 1678011037⟩, ⟨559337010, 559337014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨655586139, 655586143⟩, ⟨437057424, 437057430⟩, ⟨72842904, 72842906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨164, 165⟩, ⟨109, 110⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94523), (-94521)⟩, ⟨109, 110⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-14429), (-14427)⟩, ⟨(-9603), (-9601)⟩, ⟨(-1591), (-1588)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098627, 5098630⟩, ⟨(-9603), (-9601)⟩, ⟨(-1591), (-1588)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨778257, 778258⟩, ⟨517372, 517374⟩, ⟨85252, 85255⟩, ⟨(-325), (-322)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-142387320), (-142387318)⟩, ⟨517372, 517374⟩, ⟨85252, 85255⟩, ⟨(-325), (-322)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-21734078), (-21734077)⟩, ⟨(-14410415), (-14410411)⟩, ⟨(-2349239), (-2349234)⟩, ⟨17399, 17402⟩, ⟨1406, 1411⟩⟩
...
def j19 : Jet := ⟨⟨1409921687, 1409921689⟩, ⟨(-14410415), (-14410411)⟩, ⟨(-2349239), (-2349234)⟩, ⟨17399, 17402⟩, ⟨1406, 1411⟩⟩
...
def j22 : Jet := ⟨⟨(-17), (-16)⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11818, 11820⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1803, 1805⟩, ⟨1200, 1202⟩, ⟨197, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850374), (-850371)⟩, ⟨1200, 1202⟩, ⟨197, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-129802), (-129801)⟩, ⟨(-86352), (-86350)⟩, ⟨(-14271), (-14268)⟩, ⟨39, 42⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35661592, 35661594⟩, ⟨(-86352), (-86350)⟩, ⟨(-14271), (-14268)⟩, ⟨39, 42⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5443404, 5443406⟩, ⟨3615755, 3615757⟩, ⟨593855, 593859⟩, ⟨(-2913), (-2908)⟩, ⟨(-240), (-235)⟩⟩
...
def j33 : Jet := ⟨⟨(-710384479), (-710384476)⟩, ⟨3615755, 3615757⟩, ⟨593855, 593859⟩, ⟨(-2913), (-2908)⟩, ⟨(-240), (-235)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-108433474), (-108433471)⟩, ⟨(-71737073), (-71737068)⟩, ⟨(-11589578), (-11589575)⟩, ⟨121308, 121313⟩, ⟨9737, 9742⟩⟩
...
def j36 : Jet := ⟨⟨4186533822, 4186533825⟩, ⟨(-71737073), (-71737068)⟩, ⟨(-11589578), (-11589575)⟩, ⟨121308, 121313⟩, ⟨9737, 9742⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨550845672, 550845675⟩, ⟨177985183, 177985189⟩, ⟨(-2794510), (-2794506)⟩, ⟨(-299147), (-299143)⟩, ⟨2814, 2819⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4406209252, 4406209256⟩, ⟨75501248, 75501255⟩, ⟨13491430, 13491436⟩, ⟨312507, 312518⟩, ⟨30259, 30270⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨565112870, 565112874⟩, ⟨192278412, 192278421⟩, ⟨1992238, 1992246⟩, ⟨243149, 243159⟩, ⟨5678, 5691⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-534127502), (-534127501)⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3760839794, 3760839795⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨74355061, 74355063⟩, ⟨50598292, 50598296⟩, ⟨9132236, 9132242⟩, ⟨242362, 242368⟩, ⟨24188, 24195⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4369322357, 4369322359⟩, ⟨50598292, 50598296⟩, ⟨9132236, 9132242⟩, ⟨242362, 242368⟩, ⟨24188, 24195⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4331985298, 4331985300⟩, ⟨25082957, 25082960⟩, ⟨4454481, 4454486⟩, ⟨94352, 94357⟩, ⟨9153, 9159⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3793254190, 3793254194⟩, ⟨(-157613428), (-157613422)⟩, ⟨2860733, 2860739⟩, ⟨(-102038), (-102031)⟩, ⟨4102, 4109⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨29375910838, 29375910845⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value316

def j47 : Jet := ⟨⟨3653224987, 3653224996⟩, ⟨1217741660, 1217741668⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3107370064, 3107370081⟩, ⟨2071580038, 2071580060⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3107370064, 3107370081⟩, ⟨2071580038, 2071580060⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3107370081), (-3107370064)⟩, ⟨(-2071580060), (-2071580038)⟩, ⟨(-345263344), (-345263339)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1553685041), (-1553685032)⟩, ⟨(-1035790030), (-1035790019)⟩, ⟨(-172631672), (-172631669)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2991271215, 2991271226⟩, ⟨(-721385916), (-721385904)⟩, ⟨(-33244956), (-33244949)⟩, ⟨22002720, 22002722⟩, ⟨(-658442), (-658441)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2641848304, 2641848318⟩, ⟨(-746889195), (-746889178)⟩, ⟨(-896223), (-896207)⟩, ⟨20100929, 20100940⟩, ⟨(-1391118), (-1391105)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨356085001, 712170003⟩, ⟨178042500, 178042501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1118674023, 2237348050⟩, ⟨559337010, 559337014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨291371617, 1165486476⟩, ⟨291371616, 582743240⟩, ⟨72842904, 72842906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨72, 292⟩, ⟨72, 146⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94615), (-94394)⟩, ⟨72, 146⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-25675), (-6403)⟩, ⟨(-12834), (-6363)⟩, ⟨(-1600), (-1574)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5087381, 5106654⟩, ⟨(-12834), (-6363)⟩, ⟨(-1600), (-1574)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨345129, 1385747⟩, ⟨341646, 692443⟩, ⟨84105, 86073⟩, ⟨(-436), (-211)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142820448), (-141779829)⟩, ⟨341646, 692443⟩, ⟨84105, 86073⟩, ⟨(-436), (-211)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-38755895), (-9618377)⟩, ⟨(-19354771), (-9430474)⟩, ⟨(-2393362), (-2287285)⟩, ⟨11380, 23409⟩, ⟨1358, 1445⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1392899870, 1422037389⟩, ⟨(-19354771), (-9430474)⟩, ⟨(-2393362), (-2287285)⟩, ⟨11380, 23409⟩, ⟨1358, 1445⟩⟩
...
def j70 : Jet := ⟨⟨(-30), (-7)⟩, ⟨(-15), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11805, 11829⟩, ⟨(-15), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨800, 3210⟩, ⟨795, 1605⟩, ⟨196, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851377), (-848966)⟩, ⟨795, 1605⟩, ⟨196, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-231031), (-57594)⟩, ⟨(-115463), (-57158)⟩, ⟨(-14374), (-14125)⟩, ⟨25, 56⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35560363, 35733801⟩, ⟨(-115463), (-57158)⟩, ⟨(-14374), (-14125)⟩, ⟨25, 56⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2412423, 9696759⟩, ⟨2381090, 4844503⟩, ⟨583537, 601213⟩, ⟨(-3909), (-1911)⟩, ⟨(-243), (-229)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713415460), (-706131123)⟩, ⟨2381090, 4844503⟩, ⟨583537, 601213⟩, ⟨(-3909), (-1911)⟩, ⟨(-243), (-229)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-193593109), (-47904105)⟩, ⟨(-96635022), (-46589495)⟩, ⟨(-11898450), (-11155575)⟩, ⟨78909, 163608⟩, ⟨9299, 10053⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4101374187, 4247063191⟩, ⟨(-96635022), (-46589495)⟩, ⟨(-11898450), (-11155575)⟩, ⟨78909, 163608⟩, ⟨9299, 10053⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨362796918, 740772249⟩, ⟨171316109, 182736787⟩, ⟨(-3767346), (-1823887)⟩, ⟨(-308726), (-285679)⟩, ⟨1835, 3802⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4343411728, 4497698390⟩, ⟨47646420, 105973064⟩, ⟨11931320, 15545120⟩, ⟨82770, 590141⟩, ⟨17516, 48241⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨366889030, 775738189⟩, ⟨177273147, 209639981⟩, ⟨(-1036829), 5345485⟩, ⟨66649, 454045⟩, ⟨(-14619), 29177⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-712170003), (-356085001)⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3582797293, 3938882295⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨31340764, 140110436⟩, ⟨30286410, 75728512⟩, ⟨6942345, 12163614⟩, ⟨(-89832), 685850⟩, ⟨(-1073), 61519⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4326308060, 4435077732⟩, ⟨30286410, 75728512⟩, ⟨6942345, 12163614⟩, ⟨(-89832), 685850⟩, ⟨(-1073), 61519⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310609194, 4364460312⟩, ⟨14902087, 37726859⟩, ⟨3252845, 6033980⟩, ⟨(-97564), 330436⟩, ⟨(-7651), 30275⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3595845529, 4002613819⟩, ⟨(-168492151), (-144091895)⟩, ⟨1149554, 4915971⟩, ⟨(-339608), 168199⟩, ⟨(-20715), 31810⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2435483327, 4870966663⟩, ⟨1217741660, 1217741668⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1381053364, 5524213480⟩, ⟨1381053360, 2762106746⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1381053364, 5524213480⟩, ⟨1381053360, 2762106746⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5524213480), (-1381053364)⟩, ⟨(-2762106746), (-1381053360)⟩, ⟨(-345263344), (-345263339)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2762106740), (-690526682)⟩, ⟨(-1381053373), (-690526680)⟩, ⟨(-172631672), (-172631669)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2257687025, 3657091536⟩, ⟨(-1175943437), (-362981372)⟩, ⟨(-117813625), 98317873⟩, ⟨(-811654), 44138254⟩, ⟨(-5524073), 2432945⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1890187569, 3408157528⟩, ⟨(-1239366521), (-379639524)⟩, ⟨(-97012250), 141943776⟩, ⟨(-6248573), 45801726⟩, ⟨(-7078147), 2531784⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨534127501, 534127502⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨178042500, 178042501⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4331985298, 4331985300⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar316 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1116
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar316 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨356085001, 712170003⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310609194, 4364460312⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1117
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((33163 / 400000) : ℝ)..(33163 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (33163 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (33163 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((33163 / 400000) : ℝ)..(33163 / 200000), prawitzNormalCorrection
      ((139613 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
