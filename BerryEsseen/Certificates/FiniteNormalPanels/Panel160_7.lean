...
namespace FiniteNormalPanel160_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (25629 / 800000)
def radius : Rat := (25629 / 800000)

def j0 : Jet := ⟨⟨137594646, 137594647⟩, ⟨137594646, 137594647⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨432266329, 432266333⟩, ⟨432266329, 432266333⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨43505378, 43505380⟩, ⟨87010756, 87010760⟩, ⟨43505378, 43505380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-960), (-958)⟩, ⟨(-1919), (-1916)⟩, ⟨(-960), (-956)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112096, 5112099⟩, ⟨(-1919), (-1916)⟩, ⟨(-960), (-956)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨51782, 51783⟩, ⟨103544, 103546⟩, ⟨51733, 51736⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143113795), (-143113793)⟩, ⟨103544, 103546⟩, ⟨51733, 51736⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1449655), (-1449654)⟩, ⟨(-2898262), (-2898260)⟩, ⟨(-1447034), (-1447031)⟩, ⟨2095, 2098⟩, ⟨522, 525⟩⟩
...
def j19 : Jet := ⟨⟨1430206110, 1430206112⟩, ⟨(-2898262), (-2898260)⟩, ⟨(-1447034), (-1447031)⟩, ⟨2095, 2098⟩, ⟨522, 525⟩⟩
...
def j25 : Jet := ⟨⟨119, 120⟩, ⟨238, 240⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852058), (-852056)⟩, ⟨238, 240⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8631), (-8630)⟩, ⟨(-17260), (-17258)⟩, ⟨(-8626), (-8623)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782763, 35782765⟩, ⟨(-17260), (-17258)⟩, ⟨(-8626), (-8623)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨362457, 362458⟩, ⟨724739, 724741⟩, ⟨362019, 362022⟩, ⟨(-350), (-347)⟩, ⟨(-89), (-85)⟩⟩
...
def j33 : Jet := ⟨⟨(-715465426), (-715465424)⟩, ⟨724739, 724741⟩, ⟨362019, 362022⟩, ⟨(-350), (-347)⟩, ⟨(-89), (-85)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7247226), (-7247224)⟩, ⟨(-14487110), (-14487107)⟩, ⟨(-7228877), (-7228873)⟩, ⟨14671, 14674⟩, ⟨3658, 3661⟩⟩
...
def j36 : Jet := ⟨⟨4287720070, 4287720072⟩, ⟨(-14487110), (-14487107)⟩, ⟨(-7228877), (-7228873)⟩, ⟨14671, 14674⟩, ⟨3658, 3661⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨143942875, 143942878⟩, ⟨143651179, 143651184⟩, ⟨(-437333), (-437330)⟩, ⟨(-145427), (-145424)⟩, ⟨262, 265⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302226769, 4302226772⟩, ⟨14536120, 14536125⟩, ⟨7302442, 7302449⟩, ⟨34455, 34462⟩, ⟨8702, 8710⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨144186171, 144186175⟩, ⟨144381150, 144381157⟩, ⟨292843, 292850⟩, ⟨98240, 98247⟩, ⟨468, 476⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-137594647), (-137594646)⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4157372649, 4157372650⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4840468, 4840469⟩, ⟨9694026, 9694030⟩, ⟨4873230, 4873233⟩, ⟨26284, 26288⟩, ⟨6653, 6658⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299807764, 4299807765⟩, ⟨9694026, 9694030⟩, ⟨4873230, 4873233⟩, ⟨26284, 26288⟩, ⟨6653, 6658⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297386848, 4297386849⟩, ⟨4844283, 4844286⟩, ⟨2432512, 2432515⟩, ⟨10392, 10396⟩, ⟨2624, 2629⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4159714687, 4159714690⟩, ⟨(-132983071), (-132983065)⟩, ⟨2199390, 2199395⟩, ⟨(-67870), (-67865)⟩, ⟨2205, 2213⟩⟩
...
def j47 : Jet := ⟨⟨1459917214, 1459917226⟩, ⟨1459917214, 1459917226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨496245518, 496245527⟩, ⟨992491036, 992491054⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨496245518, 496245527⟩, ⟨992491036, 992491054⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-496245527), (-496245518)⟩, ⟨(-992491054), (-992491036)⟩, ⟨(-496245527), (-496245518)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-248122764), (-248122759)⟩, ⟨(-496245527), (-496245518)⟩, ⟨(-248122764), (-248122759)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4053875585, 4053875590⟩, ⟨(-468389511), (-468389501)⟩, ⟨(-207135623), (-207135615)⟩, ⟨26016985, 26016988⟩, ⟨5231663, 5231665⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3926215183, 3926215192⟩, ⟨(-579157741), (-579157724)⟩, ⟨(-184034271), (-184034254)⟩, ⟨31307211, 31307223⟩, ⟨4164770, 4164784⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 275189293⟩, ⟨137594646, 137594647⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 864532662⟩, ⟨432266329, 432266333⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 174021517⟩, ⟨0, 174021518⟩, ⟨43505378, 43505380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3837), 0⟩, ⟨(-3837), 2⟩, ⟨(-960), (-955)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109219, 5113057⟩, ⟨(-3837), 2⟩, ⟨(-960), (-955)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 207169⟩, ⟨(-156), 207170⟩, ⟨51558, 51794⟩, ⟨(-78), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142958407)⟩, ⟨(-156), 207170⟩, ⟨51558, 51794⟩, ⟨(-78), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5800718), 0⟩, ⟨(-5800725), 8395⟩, ⟨(-1450187), (-1437586)⟩, ⟨(-6), 4199⟩, ⟨517, 526⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425855047, 1431655766⟩, ⟨(-5800725), 8395⟩, ⟨(-1450187), (-1437586)⟩, ⟨(-6), 4199⟩, ⟨517, 526⟩⟩
...
def j72 : Jet := ⟨⟨0, 480⟩, ⟨(-1), 480⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851696)⟩, ⟨(-1), 480⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-34529), 0⟩, ⟨(-34530), 20⟩, ⟨(-8634), (-8602)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35756865, 35791395⟩, ⟨(-34530), 20⟩, ⟨(-8634), (-8602)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1450180⟩, ⟨(-1400), 1450181⟩, ⟨360445, 362546⟩, ⟨(-701), 2⟩, ⟨(-90), (-85)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714377702)⟩, ⟨(-1400), 1450181⟩, ⟨360445, 362546⟩, ⟨(-701), 2⟩, ⟨(-90), (-85)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-29003587), 0⟩, ⟨(-29003644), 58758⟩, ⟨(-7250954), (-7162758)⟩, ⟨(-44), 29381⟩, ⟨3618, 3674⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4265963709, 4294967296⟩, ⟨(-29003644), 58758⟩, ⟨(-7250954), (-7162758)⟩, ⟨(-44), 29381⟩, ⟨3618, 3674⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 288177555⟩, ⟨142337336, 144090468⟩, ⟨(-875722), 845⟩, ⟨(-145956), (-143839)⟩, ⟨(-1), 529⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4324168074⟩, ⟨(-59561), 29399368⟩, ⟨7162355, 7549770⟩, ⟨(-29989), 101348⟩, ⟨7840, 9881⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 290136827⟩, ⟨142333339, 147042713⟩, ⟨(-883675), 1493725⟩, ⟨82406, 116260⟩, ⟨(-3549), 4602⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-275189293), 0⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4019778003, 4294967296⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19599539⟩, ⟨0, 19866278⟩, ⟨4597474, 5235974⟩, ⟨(-60508), 117988⟩, ⟨4672, 9104⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314566835⟩, ⟨0, 19866278⟩, ⟨4597474, 5235974⟩, ⟨(-60508), 117988⟩, ⟨4672, 9104⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304755911⟩, ⟨0, 9933139⟩, ⟨2282049, 2617987⟩, ⟨(-36309), 58994⟩, ⟨1397, 4030⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4019778003, 4304755911⟩, ⟨(-137908238), (-127661507)⟩, ⟨1817611, 2617987⟩, ⟨(-120180), (-14114)⟩, ⟨(-583), 5194⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2919834441⟩, ⟨1459917214, 1459917226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1984982091⟩, ⟨0, 1984982100⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1984982091⟩, ⟨0, 1984982100⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1984982091), 0⟩, ⟨(-1984982100), 0⟩, ⟨(-496245527), (-496245518)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-992491046), 0⟩, ⟨(-992491050), 0⟩, ⟨(-248122764), (-248122759)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3408804392, 4294967296⟩, ⟨(-992491050), 0⟩, ⟨(-248122764), (-82255040)⟩, ⟨0, 57336787⟩, ⟨(-936419), 7167099⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3190393771, 4304755911⟩, ⟨(-1132661264), (-101321634)⟩, ⟨(-247245668), (-42498609)⟩, ⟨1719757, 65423302⟩, ⟨(-2931423), 7181591⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨137594646, 137594647⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297386848, 4297386849⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3236
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 275189293⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304755911⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3237
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (61930985 / 1073741824)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(25629 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(25629 / 400000), prawitzNormalCorrection
