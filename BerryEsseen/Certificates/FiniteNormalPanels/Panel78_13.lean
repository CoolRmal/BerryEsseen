...
namespace FiniteNormalPanel78_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6211 / 160000)
def radius : Rat := (6211 / 160000)

def j0 : Jet := ⟨⟨166725261, 166725262⟩, ⟨166725261, 166725262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨523782855, 523782859⟩, ⟨523782855, 523782859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨63876732, 63876734⟩, ⟨127753464, 127753468⟩, ⟨63876732, 63876734⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨15, 17⟩, ⟨31, 33⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94672), (-94669)⟩, ⟨31, 33⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1409), (-1407)⟩, ⟨(-2817), (-2814)⟩, ⟨(-1409), (-1405)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111647, 5111650⟩, ⟨(-2817), (-2814)⟩, ⟨(-1409), (-1405)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨76022, 76023⟩, ⟨152003, 152005⟩, ⟨75917, 75920⟩, ⟨(-84), (-81)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-143089555), (-143089553)⟩, ⟨152003, 152005⟩, ⟨75917, 75920⟩, ⟨(-84), (-81)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2128094), (-2128093)⟩, ⟨(-4253928), (-4253926)⟩, ⟨(-2122444), (-2122441)⟩, ⟨4516, 4519⟩, ⟨1125, 1128⟩⟩
...
def j19 : Jet := ⟨⟨1429527671, 1429527673⟩, ⟨(-4253928), (-4253926)⟩, ⟨(-2122444), (-2122441)⟩, ⟨4516, 4519⟩, ⟨1125, 1128⟩⟩
...
def j22 : Jet := ⟨⟨(-2), (-1)⟩, ⟨(-4), (-3)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11833, 11835⟩, ⟨(-4), (-3)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨175, 177⟩, ⟨350, 353⟩, ⟨173, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852002), (-851999)⟩, ⟨350, 353⟩, ⟨173, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-12672), (-12671)⟩, ⟨(-25338), (-25336)⟩, ⟨(-12660), (-12657)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778722, 35778724⟩, ⟨(-25338), (-25336)⟩, ⟨(-12660), (-12657)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨532117, 532118⟩, ⟨1063858, 1063860⟩, ⟨531174, 531177⟩, ⟨(-754), (-751)⟩, ⟨(-189), (-186)⟩⟩
...
def j33 : Jet := ⟨⟨(-715295766), (-715295764)⟩, ⟨1063858, 1063860⟩, ⟨531174, 531177⟩, ⟨(-754), (-751)⟩, ⟨(-189), (-186)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10638209), (-10638208)⟩, ⟨(-21260595), (-21260593)⟩, ⟨(-10598666), (-10598663)⟩, ⟨31609, 31612⟩, ⟨7873, 7876⟩⟩
...
def j36 : Jet := ⟨⟨4284329087, 4284329088⟩, ⟨(-21260595), (-21260593)⟩, ⟨(-10598666), (-10598663)⟩, ⟨31609, 31612⟩, ⟨7873, 7876⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨174334758, 174334760⟩, ⟨173815979, 173815983⟩, ⟨(-777617), (-777614)⟩, ⟨(-258288), (-258285)⟩, ⟨687, 690⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305631919, 4305631921⟩, ⟨21366306, 21366310⟩, ⟨10757389, 10757396⟩, ⟨74468, 74475⟩, ⟨18905, 18913⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨174767640, 174767643⟩, ⟨175114840, 175114847⟩, ⟨521786, 521792⟩, ⟨175571, 175578⟩, ⟨1235, 1243⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-166725262), (-166725261)⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4128242034, 4128242035⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7111515, 7111517⟩, ⟨14251286, 14251290⟩, ⟨7182263, 7182267⟩, ⟨56836, 56840⟩, ⟨14479, 14484⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302078811, 4302078813⟩, ⟨14251286, 14251290⟩, ⟨7182263, 7182267⟩, ⟨56836, 56840⟩, ⟨14479, 14484⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298521582, 4298521584⟩, ⟨7119751, 7119754⟩, ⟨3582265, 3582269⟩, ⟨22460, 22464⟩, ⟨5702, 5707⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4131658347, 4131658350⟩, ⟨(-160019865), (-160019858)⟩, ⟨3166825, 3166831⟩, ⟨(-117472), (-117467)⟩, ⟨4607, 4615⟩⟩
...
def j47 : Jet := ⟨⟨1293861443, 1293861452⟩, ⟨1293861443, 1293861452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨389776526, 389776532⟩, ⟨779553052, 779553064⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨389776526, 389776532⟩, ⟨779553052, 779553064⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-389776532), (-389776526)⟩, ⟨(-779553064), (-779553052)⟩, ⟨(-389776532), (-389776526)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-194888266), (-194888263)⟩, ⟨(-389776532), (-389776526)⟩, ⟨(-194888266), (-194888263)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4104434524, 4104434528⟩, ⟨(-372485318), (-372485311)⟩, ⟨(-169340781), (-169340776)⟩, ⟨16390585, 16390587⟩, ⟨3470130, 3470132⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3948370265, 3948370272⟩, ⟨(-511243273), (-511243257)⟩, ⟨(-145997663), (-145997648)⟩, ⟨21689670, 21689681⟩, ⟨2617239, 2617254⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 333450524⟩, ⟨166725261, 166725262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1047565717⟩, ⟨523782855, 523782859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 255506936⟩, ⟨0, 255506936⟩, ⟨63876732, 63876734⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 65⟩, ⟨0, 65⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94621)⟩, ⟨0, 65⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5633), 0⟩, ⟨(-5633), 4⟩, ⟨(-1409), (-1401)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107423, 5113057⟩, ⟨(-5633), 4⟩, ⟨(-1409), (-1401)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 304175⟩, ⟨(-336), 304176⟩, ⟨75539, 76045⟩, ⟨(-168), 2⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142861401)⟩, ⟨(-336), 304176⟩, ⟨75539, 76045⟩, ⟨(-168), 2⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8516898), 0⟩, ⟨(-8516918), 18096⟩, ⟨(-2129245), (-2102080)⟩, ⟨(-15), 9049⟩, ⟨1111, 1132⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423138867, 1431655766⟩, ⟨(-8516918), 18096⟩, ⟨(-2129245), (-2102080)⟩, ⟨(-15), 9049⟩, ⟨1111, 1132⟩⟩
...
def j70 : Jet := ⟨⟨(-7), 0⟩, ⟨(-7), 0⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11828, 11836⟩, ⟨(-7), 0⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 705⟩, ⟨(-1), 705⟩, ⟨173, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851471)⟩, ⟨(-1), 705⟩, ⟨173, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-50696), 0⟩, ⟨(-50697), 42⟩, ⟨(-12675), (-12610)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35740698, 35791395⟩, ⟨(-50697), 42⟩, ⟨(-12675), (-12610)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2129225⟩, ⟨(-3016), 2129228⟩, ⟨527781, 532310⟩, ⟨(-1510), 3⟩, ⟨(-190), (-184)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713698657)⟩, ⟨(-3016), 2129228⟩, ⟨527781, 532310⟩, ⟨(-1510), 3⟩, ⟨(-190), (-184)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-42584490), 0⟩, ⟨(-42584670), 126668⟩, ⟨(-10646303), (-10456119)⟩, ⟨(-135), 63336⟩, ⟨7747, 7918⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4252382806, 4294967296⟩, ⟨(-42584670), 126668⟩, ⟨(-10646303), (-10456119)⟩, ⟨(-135), 63336⟩, ⟨7747, 7918⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 349188573⟩, ⟨171478303, 174598701⟩, ⟨(-1557997), 2207⟩, ⟨(-259672), (-254146)⟩, ⟨(-2), 1381⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4337978239⟩, ⟨(-129219), 43441850⟩, ⟨10454837, 11295641⟩, ⟨(-65274), 222020⟩, ⟨16165, 22682⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 352685441⟩, ⟨171467797, 179879080⟩, ⟨(-1578854), 2686581⟩, ⟨134074, 223142⟩, ⟨(-9382), 12280⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-333450524), 0⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3961516772, 4294967296⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 28961110⟩, ⟨0, 29541894⟩, ⟨6586201, 7974805⟩, ⟨(-132250), 261684⟩, ⟨8174, 22391⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4323928406⟩, ⟨0, 29541894⟩, ⟨6586201, 7974805⟩, ⟨(-132250), 261684⟩, ⟨8174, 22391⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309423523⟩, ⟨0, 14770947⟩, ⟨3256738, 3987403⟩, ⟨(-79839), 130842⟩, ⟨1780, 10236⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3961516772, 4309423523⟩, ⟨(-167286435), (-151954314)⟩, ⟨2430503, 3987403⟩, ⟨(-234626), 4420⟩, ⟨(-3439), 13336⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2587722904⟩, ⟨1293861443, 1293861452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1559106128⟩, ⟨0, 1559106128⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1559106128⟩, ⟨0, 1559106128⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1559106128), 0⟩, ⟨(-1559106128), 0⟩, ⟨(-389776532), (-389776526)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-779553064), 0⟩, ⟨(-779553064), 0⟩, ⟨(-194888266), (-194888263)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3582067325, 4294967296⟩, ⟨(-779553064), 0⟩, ⟨(-194888266), (-91793804)⟩, ⟨0, 35372969⟩, ⟨477533, 4421622⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3303964572, 4309423523⟩, ⟨(-949463360), (-126732183)⟩, ⟨(-193517156), (-50316628)⟩, ⟨2289274, 43087233⟩, ⟨(-1122474), 4440482⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨166725261, 166725262⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298521582, 4298521584⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1578
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 333450524⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309423523⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1579
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (151416125 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(6211 / 80000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (6211 / 80000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(6211 / 80000), prawitzNormalCorrection
