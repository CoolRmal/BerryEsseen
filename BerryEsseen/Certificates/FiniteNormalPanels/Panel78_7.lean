...
namespace FiniteNormalPanel78_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6211 / 32000)
def radius : Rat := (6211 / 160000)

def j0 : Jet := ⟨⟨833626308, 833626309⟩, ⟨166725261, 166725262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2618914284, 2618914289⟩, ⟨523782855, 523782859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1596918335, 1596918342⟩, ⟨638767332, 638767340⟩, ⟨63876732, 63876734⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨399, 401⟩, ⟨159, 161⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94288), (-94285)⟩, ⟨159, 161⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-35058), (-35056)⟩, ⟨(-13964), (-13962)⟩, ⟨(-1375), (-1371)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5077998, 5078001⟩, ⟨(-13964), (-13962)⟩, ⟨(-1375), (-1371)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1888058, 1888060⟩, ⟨750031, 750033⟩, ⟨72933, 72938⟩, ⟨(-412), (-407)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-141277519), (-141277516)⟩, ⟨750031, 750033⟩, ⟨72933, 72938⟩, ⟨(-412), (-407)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-52528610), (-52528608)⟩, ⟨(-20732575), (-20732572)⟩, ⟨(-1962480), (-1962475)⟩, ⟨21846, 21852⟩, ⟨1014, 1019⟩⟩
...
def j19 : Jet := ⟨⟨1379127155, 1379127158⟩, ⟨(-20732575), (-20732572)⟩, ⟨(-1962480), (-1962475)⟩, ⟨21846, 21852⟩, ⟨1014, 1019⟩⟩
...
def j25 : Jet := ⟨⟨4385, 4387⟩, ⟨1747, 1750⟩, ⟨171, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847792), (-847789)⟩, ⟨1747, 1750⟩, ⟨171, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-315219), (-315217)⟩, ⟨(-125439), (-125436)⟩, ⟨(-12287), (-12282)⟩, ⟨49, 53⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35476175, 35476178⟩, ⟨(-125439), (-125436)⟩, ⟨(-12287), (-12282)⟩, ⟨49, 53⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13190450, 13190452⟩, ⟨5229540, 5229543⟩, ⟨504393, 504398⟩, ⟨(-3676), (-3671)⟩, ⟨(-176), (-172)⟩⟩
...
def j33 : Jet := ⟨⟨(-702637433), (-702637430)⟩, ⟨5229540, 5229543⟩, ⟨504393, 504398⟩, ⟨(-3676), (-3671)⟩, ⟨(-176), (-172)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-261248696), (-261248693)⟩, ⟨(-102555076), (-102555072)⟩, ⟨(-9484648), (-9484644)⟩, ⟨151424, 151430⟩, ⟨6888, 6894⟩⟩
...
def j36 : Jet := ⟨⟨4033718600, 4033718603⟩, ⟨(-102555076), (-102555072)⟩, ⟨(-9484648), (-9484644)⟩, ⟨151424, 151430⟩, ⟨6888, 6894⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨840941398, 840941403⟩, ⟨155546311, 155546316⟩, ⟨(-3725043), (-3725038)⟩, ⟨(-226010), (-226004)⟩, ⟨3282, 3287⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4573136078, 4573136082⟩, ⟨116269463, 116269470⟩, ⟨13709083, 13709091⟩, ⟨450252, 450264⟩, ⟨31498, 31511⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨895405990, 895405997⟩, ⟨188385660, 188385669⟩, ⟨2928704, 2928714⟩, ⟨243155, 243168⟩, ⟨7958, 7970⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-833626309), (-833626308)⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3461340987, 3461340988⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨186672407, 186672411⟩, ⟨78548512, 78548518⟩, ⟨9484103, 9484111⟩, ⟨358300, 358312⟩, ⟨26645, 26654⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4481639703, 4481639707⟩, ⟨78548512, 78548518⟩, ⟨9484103, 9484111⟩, ⟨358300, 358312⟩, ⟨26645, 26654⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4387310788, 4387310791⟩, ⟨38447617, 38447621⟩, ⟨4473776, 4473781⟩, ⟨136173, 136181⟩, ⟨9566, 9574⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3535761184, 3535761188⟩, ⟨(-139324748), (-139324740)⟩, ⟨2112955, 2112961⟩, ⟨(-63925), (-63916)⟩, ⟨2422, 2430⟩⟩
...
def j47 : Jet := ⟨⟨6469307240, 6469307251⟩, ⟨1293861443, 1293861452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9744413235, 9744413269⟩, ⟨3897765278, 3897765314⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9744413235, 9744413269⟩, ⟨3897765278, 3897765314⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9744413269), (-9744413235)⟩, ⟨(-3897765314), (-3897765278)⟩, ⟨(-389776532), (-389776526)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4872206635), (-4872206617)⟩, ⟨(-1948882657), (-1948882639)⟩, ⟨(-194888266), (-194888263)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1381327413, 1381327432⟩, ⟨(-626790588), (-626790573)⟩, ⟨79527060, 79527068⟩, ⟨6932092, 6932095⟩, ⟨(-2590685), (-2590684)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1137155073, 1137155090⟩, ⟨(-560804022), (-560804004)⟩, ⟨86481404, 86481417⟩, ⟨2798027, 2798039⟩, ⟨(-2308381), (-2308371)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨666901046, 1000351571⟩, ⟨166725261, 166725262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2095131426, 3142697147⟩, ⟨523782855, 523782859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1022027733, 2299562413⟩, ⟨511013864, 766520806⟩, ⟨63876732, 63876734⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨255, 577⟩, ⟨127, 193⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94432), (-94109)⟩, ⟨127, 193⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-50560), (-22394)⟩, ⟨(-16824), (-11093)⟩, ⟨(-1387), (-1354)⟩, ⟨2, 7⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5062496, 5090663⟩, ⟨(-16824), (-11093)⟩, ⟨(-1387), (-1354)⟩, ⟨2, 7⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1204668, 2725585⟩, ⟨593326, 905890⟩, ⟨71545, 74070⟩, ⟨(-499), (-321)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141960909), (-140439991)⟩, ⟨593326, 905890⟩, ⟨71545, 74070⟩, ⟨(-499), (-321)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-76007092), (-33419012)⟩, ⟨(-25194511), (-16224484)⟩, ⟨(-2023692), (-1887356)⟩, ⟨17068, 26617⟩, ⟨962, 1060⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1355648673, 1398236754⟩, ⟨(-25194511), (-16224484)⟩, ⟨(-2023692), (-1887356)⟩, ⟨17068, 26617⟩, ⟨962, 1060⟩⟩
...
def j72 : Jet := ⟨⟨2802, 6324⟩, ⟨1390, 2106⟩, ⟨169, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849375), (-845852)⟩, ⟨1390, 2106⟩, ⟨169, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-454763), (-201278)⟩, ⟨(-151258), (-99511)⟩, ⟨(-12428), (-12109)⟩, ⟨38, 64⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35336631, 35590117⟩, ⟨(-151258), (-99511)⟩, ⟨(-12428), (-12109)⟩, ⟨38, 64⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8408682, 19055255⟩, ⟨4123356, 6328073⟩, ⟨491892, 514593⟩, ⟨(-4460), (-2884)⟩, ⟨(-181), (-166)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707419201), (-696772627)⟩, ⟨4123356, 6328073⟩, ⟨491892, 514593⟩, ⟨(-4460), (-2884)⟩, ⟨(-181), (-166)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-378758322), (-165803578)⟩, ⟨(-125271584), (-79513683)⟩, ⟨(-9913420), (-8957836)⟩, ⟨117461, 185269⟩, ⟨6422, 7272⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3916208974, 4129163718⟩, ⟨(-125271584), (-79513683)⟩, ⟨(-9913420), (-8957836)⟩, ⟨117461, 185269⟩, ⟨6422, 7272⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨661300061, 1023112484⟩, ⟨146889782, 162604270⟩, ⟨(-4553308), (-2899291)⟩, ⟨(-238470), (-210691)⟩, ⟨2550, 4023⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4467428596, 4710357440⟩, ⟨86027516, 150674784⟩, ⟨11348267, 16743494⟩, ⟨193809, 783014⟩, ⟨13293, 57529⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨687854085, 1122063376⟩, ⟨166033769, 214223166⟩, ⟨(-304202), 6677228⟩, ⟨(-3317), 543198⟩, ⟨(-14791), 35883⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1000351571), (-666901046)⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3294615725, 3628066250⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨110162245, 293139886⟩, ⟨53181780, 111931922⟩, ⟨6259545, 14173825⟩, ⟨(-32080), 949912⟩, ⟨(-8535), 83319⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4405129541, 4588107182⟩, ⟨53181780, 111931922⟩, ⟨6259545, 14173825⟩, ⟨(-32080), 949912⟩, ⟨(-8535), 83319⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4349699680, 4439118190⟩, ⟨25727407, 55261740⟩, ⟨2684167, 6921653⟩, ⟨(-103777), 453104⟩, ⟨(-15478), 41627⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3336600252, 3749834114⟩, ⟨(-152585848), (-122168929)⟩, ⟨(-86202), 4848189⟩, ⟨(-356354), 278553⟩, ⟨(-30664), 39193⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5175445789, 7763168702⟩, ⟨1293861443, 1293861452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6236424463, 14031955110⟩, ⟨3118212220, 4677318376⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6236424463, 14031955110⟩, ⟨3118212220, 4677318376⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14031955110), (-6236424463)⟩, ⟨(-4677318376), (-3118212220)⟩, ⟨(-389776532), (-389776526)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7015977555), (-3118212231)⟩, ⟨(-2338659188), (-1559106110)⟩, ⟨(-194888266), (-194888263)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨838541978, 2078047148⟩, ⟨(-1131520620), (-304397177)⟩, ⟨(-39044130), 270013362⟩, ⟨(-39800254), 41315883⟩, ⟨(-11750302), 6303757⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨651432055, 1814293696⟩, ⟨(-1061729903), (-260326888)⟩, ⟨(-25471736), 278287130⟩, ⟨(-45791018), 37616511⟩, ⟨(-11859024), 7335271⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨833626308, 833626309⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4387310788, 4387310791⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1570
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨666901046, 1000351571⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4349699680, 4439118190⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1571
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (22659461 / 1073741824)

theorem envelope_integral : (∫ s in ((6211 / 40000) : ℝ)..(18633 / 80000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((6211 / 40000) : ℝ)..(18633 / 80000), prawitzNormalCorrection
