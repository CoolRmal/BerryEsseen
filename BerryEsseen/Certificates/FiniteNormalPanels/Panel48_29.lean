...
namespace FiniteNormalPanel48_29

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (405273 / 1600000)
def radius : Rat := (36843 / 1600000)

def j0 : Jet := ⟨⟨1087896425, 1087896426⟩, ⟨98899675, 98899676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3417727416, 3417727420⟩, ⟨310702492, 310702496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2719662312, 2719662320⟩, ⟨494484056, 494484064⟩, ⟨22476547, 22476549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨680, 682⟩, ⟨123, 124⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94007), (-94004)⟩, ⟨123, 124⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-59528), (-59525)⟩, ⟨(-10747), (-10743)⟩, ⟨(-475), (-472)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5053528, 5053532⟩, ⟨(-10747), (-10743)⟩, ⟨(-475), (-472)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3199998, 3200002⟩, ⟨575011, 575017⟩, ⟨24907, 24913⟩, ⟨(-112), (-108)⟩, ⟨(-3), 0⟩⟩
...
def j16 : Jet := ⟨⟨(-139965579), (-139965574)⟩, ⟨575011, 575017⟩, ⟨24907, 24913⟩, ⟨(-112), (-108)⟩, ⟨(-3), 0⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-88629106), (-88629102)⟩, ⟨(-15750276), (-15750269)⟩, ⟨(-650500), (-650492)⟩, ⟨5805, 5811⟩, ⟨115, 119⟩⟩
...
def j19 : Jet := ⟨⟨1343026659, 1343026664⟩, ⟨(-15750276), (-15750269)⟩, ⟨(-650500), (-650492)⟩, ⟨5805, 5811⟩, ⟨115, 119⟩⟩
...
def j22 : Jet := ⟨⟨(-69), (-67)⟩, ⟨(-13), (-12)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11766, 11769⟩, ⟨(-13), (-12)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7450, 7453⟩, ⟨1345, 1348⟩, ⟨58, 61⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844727), (-844723)⟩, ⟨1345, 1348⟩, ⟨58, 61⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-534899), (-534896)⟩, ⟨(-96404), (-96399)⟩, ⟨(-4231), (-4225)⟩, ⟨11, 16⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35256495, 35256499⟩, ⟨(-96404), (-96399)⟩, ⟨(-4231), (-4225)⟩, ⟨11, 16⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22325143, 22325146⟩, ⟨3998070, 3998077⟩, ⟨170725, 170733⟩, ⟨(-987), (-979)⟩, ⟨(-24), (-19)⟩⟩
...
def j33 : Jet := ⟨⟨(-693502740), (-693502736)⟩, ⟨3998070, 3998077⟩, ⟨170725, 170733⟩, ⟨(-987), (-979)⟩, ⟨(-24), (-19)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-439140311), (-439140306)⟩, ⟨(-77312034), (-77312025)⟩, ⟨(-3060852), (-3060843)⟩, ⟨39952, 39961⟩, ⟨763, 770⟩⟩
...
def j36 : Jet := ⟨⟨3855826985, 3855826990⟩, ⟨(-77312034), (-77312025)⟩, ⟨(-3060852), (-3060843)⟩, ⟨39952, 39961⟩, ⟨763, 770⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1068715712, 1068715718⟩, ⟨84622664, 84622674⟩, ⟨(-1657029), (-1657021)⟩, ⟨(-42439), (-42432)⟩, ⟨510, 516⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4784121310, 4784121318⟩, ⟨95924973, 95924988⟩, ⟨5721105, 5721120⟩, ⟨141275, 141291⟩, ⟨5423, 5437⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1190431791, 1190431801⟩, ⟨118129330, 118129348⟩, ⟨1467817, 1467833⟩, ⟨63592, 63608⟩, ⟨1544, 1558⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1087896426), (-1087896425)⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3207070870, 3207070871⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨329950789, 329950795⟩, ⟨65483576, 65483588⟩, ⟨4062710, 4062722⟩, ⟨115992, 116006⟩, ⟨4853, 4866⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4624918085, 4624918091⟩, ⟨65483576, 65483588⟩, ⟨4062710, 4062722⟩, ⟨115992, 116006⟩, ⟨4853, 4866⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4456890387, 4456890390⟩, ⟨31552247, 31552254⟩, ⟨1845867, 1845874⟩, ⟨42820, 42829⟩, ⟨1652, 1660⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3327979550, 3327979554⟩, ⟨(-79068059), (-79068050)⟩, ⟨651766, 651774⟩, ⟨(-10532), (-10523)⟩, ⟨246, 254⟩⟩
...
def j47 : Jet := ⟨⟨5832742834, 5832742842⟩, ⟨530249348, 530249355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7921105475, 7921105498⟩, ⟨1440200994, 1440201016⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7921105475, 7921105498⟩, ⟨1440200994, 1440201016⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7921105498), (-7921105475)⟩, ⟨(-1440201016), (-1440200994)⟩, ⟨(-65463684), (-65463681)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3960552749), (-3960552737)⟩, ⟨(-720100508), (-720100497)⟩, ⟨(-32731842), (-32731840)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1707970618, 1707970632⟩, ⟨(-286360858), (-286360851)⟩, ⟨10989436, 10989439⟩, ⟨840730, 840732⟩, ⟨(-77115), (-77114)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1323430633, 1323430646⟩, ⟨(-253331151), (-253331139)⟩, ⟨14046162, 14046170⟩, ⟨401488, 401498⟩, ⟨(-72766), (-72756)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨988996750, 1186796101⟩, ⟨98899675, 98899676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3107024924, 3728429913⟩, ⟨310702492, 310702496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2247654804, 3236622926⟩, ⟨449530960, 539437160⟩, ⟨22476547, 22476549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨562, 811⟩, ⟨112, 136⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94125), (-93875)⟩, ⟨112, 136⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-70932), (-49126)⟩, ⟨(-11764), (-9722)⟩, ⟨(-480), (-468)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5042124, 5063931⟩, ⟨(-11764), (-9722)⟩, ⟨(-480), (-468)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2638659, 3816103⟩, ⟨518865, 630931⟩, ⟨24546, 25240⟩, ⟨(-123), (-96)⟩, ⟨(-3), 0⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140526918), (-139349473)⟩, ⟨518865, 630931⟩, ⟨24546, 25240⟩, ⟨(-123), (-96)⟩, ⟨(-3), 0⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-105898978), (-72924772)⟩, ⟨(-17378297), (-14109493)⟩, ⟨(-668259), (-630982)⟩, ⟨5191, 6423⟩, ⟨109, 123⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1325756787, 1358730994⟩, ⟨(-17378297), (-14109493)⟩, ⟨(-668259), (-630982)⟩, ⟨5191, 6423⟩, ⟨109, 123⟩⟩
...
def j70 : Jet := ⟨⟨(-82), (-55)⟩, ⟨(-14), (-11)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11753, 11781⟩, ⟨(-14), (-11)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6150, 8878⟩, ⟨1219, 1475⟩, ⟨58, 61⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846027), (-843298)⟩, ⟨1219, 1475⟩, ⟨58, 61⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-637554), (-441317)⟩, ⟨(-105622), (-87151)⟩, ⟨(-4271), (-4181)⟩, ⟨10, 16⟩, ⟨(-2), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35153840, 35350078⟩, ⟨(-105622), (-87151)⟩, ⟨(-4271), (-4181)⟩, ⟨10, 16⟩, ⟨(-2), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18396810, 26639289⟩, ⟨3599765, 4394274⟩, ⟨167483, 173687⟩, ⟨(-1085), (-880)⟩, ⟨(-24), (-17)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697431073), (-689188593)⟩, ⟨3599765, 4394274⟩, ⟨167483, 173687⟩, ⟨(-1085), (-880)⟩, ⟨(-24), (-17)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-525573595), (-360668183)⟩, ⟨(-85711762), (-68822177)⟩, ⟨(-3185403), (-2923883)⟩, ⟨35549, 44352⟩, ⟨720, 809⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3769393701, 3934299113⟩, ⟨(-85711762), (-68822177)⟩, ⟨(-3185403), (-2923883)⟩, ⟨35549, 44352⟩, ⟨720, 809⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨959066529, 1179504507⟩, ⟨80820678, 88085088⟩, ⟨(-1837276), (-1477154)⟩, ⟨(-44588), (-40069)⟩, ⟨453, 572⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4688698938, 4893822598⟩, ⟨82018793, 111280008⟩, ⟨4919278, 6666007⟩, ⟨91835, 201401⟩, ⟨2998, 8546⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1046986835, 1343965021⟩, ⟨106544537, 130927207⟩, ⟨548415, 2500315⟩, ⟨14666, 120073⟩, ⟨(-1117), 4674⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1186796101), (-988996750)⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3108171195, 3305970546⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨255224628, 420548483⟩, ⟨51944854, 81938500⟩, ⟨2910406, 5555948⟩, ⟨34358, 227586⟩, ⟨96, 11704⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4550191924, 4715515779⟩, ⟨51944854, 81938500⟩, ⟨2910406, 5555948⟩, ⟨34358, 227586⟩, ⟨96, 11704⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4420738117, 4500331772⟩, ⟨24787222, 39803668⟩, ⟨1212773, 2629450⟩, ⟨(-6986), 103756⟩, ⟨(-1671), 5583⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3199188708, 3464046001⟩, ⟨(-85690625), (-71157655)⟩, ⟨(-38899), 1453198⟩, ⟨(-65927), 51939⟩, ⟨(-3677), 4459⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5302493485, 6362992190⟩, ⟨530249348, 530249355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6546368160, 9426770176⟩, ⟨1309273630, 1571128380⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6546368160, 9426770176⟩, ⟨1309273630, 1571128380⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9426770176), (-6546368160)⟩, ⟨(-1571128380), (-1309273630)⟩, ⟨(-65463684), (-65463681)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4713385088), (-3273184080)⟩, ⟨(-785564190), (-654636815)⟩, ⟨(-32731842), (-32731840)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1433363032, 2004403253⟩, ⟨(-366612202), (-218472492)⟩, ⟨1374226, 22603689⟩, ⟨(-268116), 1792810⟩, ⟨(-168110), 7024⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1067667926, 1616623503⟩, ⟨(-335676619), (-186480925)⟩, ⟨4625046, 26223307⟩, ⟨(-822033), 1450760⟩, ⟨(-177713), 26373⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1087896425, 1087896426⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4456890387, 4456890390⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified958
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨988996750, 1186796101⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4420738117, 4500331772⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified959
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (30582407 / 2147483648)

theorem envelope_integral : (∫ s in ((36843 / 160000) : ℝ)..(110529 / 400000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (36843 / 160000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (110529 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((36843 / 160000) : ℝ)..(110529 / 400000), prawitzNormalCorrection
