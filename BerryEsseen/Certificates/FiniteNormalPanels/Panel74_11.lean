...
namespace FiniteNormalPanel74_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (36007 / 160000)
def radius : Rat := (36007 / 800000)

def j0 : Jet := ⟨⟨966555546, 966555547⟩, ⟨193311109, 193311110⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3036523802, 3036523806⟩, ⟨607304759, 607304764⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2146809548, 2146809554⟩, ⟨858723816, 858723826⟩, ⟨85872381, 85872383⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨537, 538⟩, ⟨214, 216⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94150), (-94148)⟩, ⟨214, 216⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-47061), (-47059)⟩, ⟨(-18719), (-18715)⟩, ⟨(-1831), (-1827)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5065995, 5065998⟩, ⟨(-18719), (-18715)⟩, ⟨(-1831), (-1827)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2532202, 2532204⟩, ⟨1003523, 1003528⟩, ⟨96629, 96635⟩, ⟨(-739), (-734)⟩, ⟨(-36), (-33)⟩⟩
...
def j16 : Jet := ⟨⟨(-140633375), (-140633372)⟩, ⟨1003523, 1003528⟩, ⟨96629, 96635⟩, ⟨(-739), (-734)⟩, ⟨(-36), (-33)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-70294616), (-70294613)⟩, ⟨(-27616244), (-27616238)⟩, ⟨(-2562845), (-2562838)⟩, ⟨39013, 39020⟩, ⟨1765, 1771⟩⟩
...
def j19 : Jet := ⟨⟨1361361149, 1361361153⟩, ⟨(-27616244), (-27616238)⟩, ⟨(-2562845), (-2562838)⟩, ⟨39013, 39020⟩, ⟨1765, 1771⟩⟩
...
def j22 : Jet := ⟨⟨(-54), (-53)⟩, ⟨(-22), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11781, 11783⟩, ⟨(-22), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5888, 5890⟩, ⟨2344, 2346⟩, ⟨228, 232⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846289), (-846286)⟩, ⟨2344, 2346⟩, ⟨228, 232⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-423012), (-423010)⟩, ⟨(-168034), (-168031)⟩, ⟨(-16340), (-16334)⟩, ⟨90, 94⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35368382, 35368385⟩, ⟨(-168034), (-168031)⟩, ⟨(-16340), (-16334)⟩, ⟨90, 94⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17678639, 17678642⟩, ⟨6987464, 6987468⟩, ⟨665380, 665387⟩, ⟨(-6583), (-6577)⟩, ⟨(-310), (-304)⟩⟩
...
def j33 : Jet := ⟨⟨(-698149244), (-698149240)⟩, ⟨6987464, 6987468⟩, ⟨665380, 665387⟩, ⟨(-6583), (-6577)⟩, ⟨(-310), (-304)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-348965048), (-348965044)⟩, ⟨(-136093385), (-136093379)⟩, ⟨(-12228964), (-12228956)⟩, ⟨269448, 269455⟩, ⟨11831, 11839⟩⟩
...
def j36 : Jet := ⟨⟨3946002248, 3946002252⟩, ⟨(-136093385), (-136093379)⟩, ⟨(-12228964), (-12228956)⟩, ⟨269448, 269455⟩, ⟨11831, 11839⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨962476602, 962476607⟩, ⟨172970751, 172970759⟩, ⟨(-5716835), (-5716827)⟩, ⟨(-334803), (-334796)⟩, ⟨6763, 6771⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4674793093, 4674793099⟩, ⟨161228591, 161228601⟩, ⟨20048132, 20048145⟩, ⟨871875, 871888⟩, ⟨67162, 67179⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1047593301, 1047593309⟩, ⟨224397801, 224397813⟩, ⟨4763404, 4763418⟩, ⟨423760, 423776⟩, ⟨18268, 18287⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-966555547), (-966555546)⟩, ⟨(-193311110), (-193311109)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3328411749, 3328411750⟩, ⟨(-193311110), (-193311109)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨255520391, 255520396⟩, ⟨109466552, 109466560⟩, ⟨14047741, 14047751⟩, ⟨704464, 704474⟩, ⟨58472, 58487⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4550487687, 4550487692⟩, ⟨109466552, 109466560⟩, ⟨14047741, 14047751⟩, ⟨704464, 704474⟩, ⟨58472, 58487⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4420881789, 4420881792⟩, ⟨53174375, 53174380⟩, ⟨6504027, 6504033⟩, ⟨263969, 263976⟩, ⟨20442, 20452⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3425989972, 3425989976⟩, ⟨(-157770551), (-157770543)⟩, ⟨2647023, 2647030⟩, ⟨(-88175), (-88168)⟩, ⟨3959, 3970⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨24116690037, 24116690043⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value371

def j47 : Jet := ⟨⟨5427310361, 5427310369⟩, ⟨1085462071, 1085462077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6858189067, 6858189088⟩, ⟨2743275622, 2743275644⟩, ⟨274327562, 274327566⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6858189067, 6858189088⟩, ⟨2743275622, 2743275644⟩, ⟨274327562, 274327566⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6858189088), (-6858189067)⟩, ⟨(-2743275644), (-2743275622)⟩, ⟨(-274327566), (-274327562)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3429094544), (-3429094533)⟩, ⟨(-1371637822), (-1371637811)⟩, ⟨(-137163783), (-137163781)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1932946744, 1932946757⟩, ⟨(-617304557), (-617304546)⟩, ⟨36840522, 36840527⟩, ⟨9221008, 9221010⟩, ⟨(-1324473), (-1324471)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1541864164, 1541864177⟩, ⟨(-563413209), (-563413193)⟩, ⟨53254021, 53254032⟩, ⟨5581942, 5581954⟩, ⟨(-1358065), (-1358053)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨773244437, 1159866656⟩, ⟨193311109, 193311110⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2429219042, 3643828566⟩, ⟨607304759, 607304764⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1373958111, 3091405756⟩, ⟨686979052, 1030468592⟩, ⟨85872381, 85872383⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨343, 775⟩, ⟨171, 259⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94344), (-93911)⟩, ⟨171, 259⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-67907), (-30042)⟩, ⟨(-22582), (-14834)⟩, ⟨(-1854), (-1798)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5045149, 5083015⟩, ⟨(-22582), (-14834)⟩, ⟨(-1854), (-1798)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1613940, 3658622⟩, ⟨790716, 1214796⟩, ⟨94118, 98682⟩, ⟨(-896), (-574)⟩, ⟨(-38), (-31)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141551637), (-139506954)⟩, ⟨790716, 1214796⟩, ⟨94118, 98682⟩, ⟨(-896), (-574)⟩, ⟨(-38), (-31)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-101885187), (-44628211)⟩, ⟨(-33708781), (-21439726)⟩, ⟨(-2673563), (-2426774)⟩, ⟨30218, 47783⟩, ⟨1638, 1874⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1329770578, 1387027555⟩, ⟨(-33708781), (-21439726)⟩, ⟨(-2673563), (-2426774)⟩, ⟨30218, 47783⟩, ⟨1638, 1874⟩⟩
...
def j70 : Jet := ⟨⟨(-78), (-34)⟩, ⟨(-26), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11757, 11802⟩, ⟨(-26), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3761, 8495⟩, ⟨1861, 2827⟩, ⟨225, 234⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848416), (-843681)⟩, ⟨1861, 2827⟩, ⟨225, 234⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-610668), (-269893)⟩, ⟨(-202961), (-132911)⟩, ⟨(-16595), (-16020)⟩, ⟨70, 114⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35180726, 35521502⟩, ⟨(-202961), (-132911)⟩, ⟨(-16595), (-16020)⟩, ⟨70, 114⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11254298, 25567454⟩, ⟨5481062, 8479967⟩, ⟨642752, 683825⟩, ⟨(-8018), (-5136)⟩, ⟨(-321), (-288)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704573585), (-690260428)⟩, ⟨5481062, 8479967⟩, ⟨642752, 683825⟩, ⟨(-8018), (-5136)⟩, ⟨(-321), (-288)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-507133742), (-220814001)⟩, ⟨(-167291193), (-104303340)⟩, ⟨(-13004739), (-11274120)⟩, ⟨206622, 331971⟩, ⟨10695, 12760⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3787833554, 4074153295⟩, ⟨(-167291193), (-104303340)⟩, ⟨(-13004739), (-11274120)⟩, ⟨206622, 331971⟩, ⟨10695, 12760⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨752113761, 1176747174⟩, ⟨159430079, 183998294⟩, ⟨(-7034632), (-4404134)⟩, ⟨(-360949), (-302604)⟩, ⟨5198, 8347⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4527749139, 4869998592⟩, ⟨115915951, 215085448⟩, ⟨15496914, 26219465⟩, ⟨320686, 1649463⟩, ⟨18312, 143763⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨792877383, 1334295860⟩, ⟨188369625, 267562603⟩, ⟨(-959896), 11755207⟩, ⟨(-130155), 1137313⟩, ⟨(-40433), 95462⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1159866656), (-773244437)⟩, ⟨(-193311110), (-193311109)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3135100640, 3521722859⟩, ⟨(-193311110), (-193311109)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨146370042, 414518976⟩, ⟨69548382, 166244654⟩, ⟨7665142, 23972149⟩, ⟨(-200468), 2171272⟩, ⟨(-43970), 233190⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4441337338, 4709486272⟩, ⟨69548382, 166244654⟩, ⟨7665142, 23972149⟩, ⟨(-200468), 2171272⟩, ⟨(-43970), 233190⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4367539194, 4497453671⟩, ⟨33208571, 81741150⟩, ⟨2917197, 11660662⟩, ⟨(-316805), 1045417⟩, ⟨(-56753), 119614⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3188074315, 3687754600⟩, ⟨(-178184256), (-129552596)⟩, ⟨(-1549667), 8066659⟩, ⟨(-784602), 725907⟩, ⟨(-93589), 112339⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4341848290, 6512772440⟩, ⟨1085462071, 1085462077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4389241005, 9875792278⟩, ⟨2194620498, 3291930772⟩, ⟨274327562, 274327566⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4389241005, 9875792278⟩, ⟨2194620498, 3291930772⟩, ⟨274327562, 274327566⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9875792278), (-4389241005)⟩, ⟨(-3291930772), (-2194620498)⟩, ⟨(-274327566), (-274327562)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4937896139), (-2194620502)⟩, ⟨(-1645965386), (-1097310249)⟩, ⟨(-137163783), (-137163781)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1360361399, 2576595720⟩, ⟨(-987431819), (-347555267)⟩, ⟨(-37887981), 145762923⟩, ⟨(-11220632), 25862989⟩, ⟨(-4805414), 1680019⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1009770956, 2212322485⟩, ⟨(-954725553), (-299017496)⟩, ⟨(-22977535), 170959908⟩, ⟨(-18006768), 24570145⟩, ⟨(-5493204), 2429555⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨966555546, 966555547⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4420881789, 4420881792⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar371 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1482
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar371 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨773244437, 1159866656⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4367539194, 4497453671⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1483
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((36007 / 200000) : ℝ)..(108021 / 400000), prawitzNormalCorrection
      ((212231 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
