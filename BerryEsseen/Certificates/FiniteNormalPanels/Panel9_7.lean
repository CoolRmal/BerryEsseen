...
namespace FiniteNormalPanel9_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (46593 / 160000)
def radius : Rat := (46593 / 800000)

def j0 : Jet := ⟨⟨1250721320, 1250721321⟩, ⟨250144264, 250144265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3929256910, 3929256914⟩, ⟨785851382, 785851386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3594686245, 3594686254⟩, ⟨1437874498, 1437874508⟩, ⟨143787449, 143787452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨899, 901⟩, ⟨359, 361⟩, ⟨35, 37⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93788), (-93785)⟩, ⟨359, 361⟩, ⟨35, 37⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-78497), (-78493)⟩, ⟨(-31099), (-31094)⟩, ⟨(-2991), (-2987)⟩, ⟨23, 26⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5034559, 5034564⟩, ⟨(-31099), (-31094)⟩, ⟨(-2991), (-2987)⟩, ⟨23, 26⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4213689, 4213695⟩, ⟨1659446, 1659454⟩, ⟨155631, 155640⟩, ⟨(-2025), (-2017)⟩, ⟨(-94), (-88)⟩⟩
...
def j16 : Jet := ⟨⟨(-138951888), (-138951881)⟩, ⟨1659446, 1659454⟩, ⟨155631, 155640⟩, ⟨(-2025), (-2017)⟩, ⟨(-94), (-88)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-116296216), (-116296209)⟩, ⟨(-45129609), (-45129597)⟩, ⟨(-3966043), (-3966029)⟩, ⟨105962, 105974⟩, ⟨4453, 4463⟩⟩
...
def j19 : Jet := ⟨⟨1315359549, 1315359557⟩, ⟨(-45129609), (-45129597)⟩, ⟨(-3966043), (-3966029)⟩, ⟨105962, 105974⟩, ⟨4453, 4463⟩⟩
...
def j22 : Jet := ⟨⟨(-91), (-89)⟩, ⟨(-37), (-35)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11744, 11747⟩, ⟨(-37), (-35)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9829, 9832⟩, ⟨3900, 3904⟩, ⟨376, 381⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842348), (-842344)⟩, ⟨3900, 3904⟩, ⟨376, 381⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-705006), (-705002)⟩, ⟨(-278739), (-278732)⟩, ⟨(-26582), (-26574)⟩, ⟨251, 258⟩, ⟨9, 13⟩⟩
...
def j30 : Jet := ⟨⟨35086388, 35086393⟩, ⟨(-278739), (-278732)⟩, ⟨(-26582), (-26574)⟩, ⟨251, 258⟩, ⟨9, 13⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29365661, 29365666⟩, ⟨11512972, 11512982⟩, ⟨1059061, 1059072⟩, ⟨(-18022), (-18011)⟩, ⟨(-799), (-791)⟩⟩
...
def j33 : Jet := ⟨⟨(-686462222), (-686462216)⟩, ⟨11512972, 11512982⟩, ⟨1059061, 1059072⟩, ⟨(-18022), (-18011)⟩, ⟨(-799), (-791)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-574536695), (-574536688)⟩, ⟨(-220178862), (-220178848)⟩, ⟨(-18240758), (-18240742)⟩, ⟨724901, 724918⟩, ⟨28752, 28765⟩⟩
...
def j36 : Jet := ⟨⟨3720430601, 3720430608⟩, ⟨(-220178862), (-220178848)⟩, ⟨(-18240758), (-18240742)⟩, ⟨724901, 724918⟩, ⟨28752, 28765⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1203358545, 1203358554⟩, ⟨199384822, 199384837⟩, ⟨(-11885719), (-11885702)⟩, ⟨(-628730), (-628714)⟩, ⟨23460, 23474⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4958228231, 4958228241⟩, ⟨293432963, 293432985⟩, ⟨41675145, 41675173⟩, ⟨2938934, 2938966⟩, ⟨282743, 282769⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1389190161, 1389190175⟩, ⟨312388994, 312389020⟩, ⟨11577296, 11577329⟩, ⟨1220247, 1220282⟩, ⟨84447, 84480⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1250721321), (-1250721320)⟩, ⟨(-250144265), (-250144264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3044245975, 3044245976⟩, ⟨(-250144265), (-250144264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨449328055, 449328065⟩, ⟨202081964, 202081986⟩, ⟨30210476, 30210505⟩, ⟨2473486, 2473518⟩, ⟨263341, 263370⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4744295351, 4744295361⟩, ⟨202081964, 202081986⟩, ⟨30210476, 30210505⟩, ⟨2473486, 2473518⟩, ⟨263341, 263370⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4514044015, 4514044021⟩, ⟨96137235, 96137247⟩, ⟨13348411, 13348427⟩, ⟨892433, 892452⟩, ⟨86536, 86553⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3199526184, 3199526190⟩, ⟨(-194762097), (-194762085)⟩, ⟨3862116, 3862130⟩, ⟨(-144880), (-144863)⟩, ⟨9358, 9373⟩⟩
...
def j47 : Jet := ⟨⟨4260247432, 4260247438⟩, ⟨852049486, 852049491⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4225808238, 4225808251⟩, ⟨1690323294, 1690323308⟩, ⟨169032329, 169032332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4225808238, 4225808251⟩, ⟨1690323294, 1690323308⟩, ⟨169032329, 169032332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4225808251), (-4225808238)⟩, ⟨(-1690323308), (-1690323294)⟩, ⟨(-169032332), (-169032329)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2112904126), (-2112904119)⟩, ⟨(-845161654), (-845161647)⟩, ⟨(-84516166), (-84516164)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2626087542, 2626087554⟩, ⟨(-516760280), (-516760272)⟩, ⟨(-832107), (-832103)⟩, ⟨6833769, 6833771⟩, ⟨(-328000), (-327999)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1956297981, 1956297995⟩, ⟨(-504043505), (-504043490)⟩, ⟨25174861, 25174878⟩, ⟨4575265, 4575283⟩, ⟨(-531831), (-531815)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1000577056, 1500865585⟩, ⟨250144264, 250144265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3143405528, 4715108297⟩, ⟨785851382, 785851386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2300599197, 5176348205⟩, ⟨1150299598, 1725449410⟩, ⟨143787449, 143787452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨575, 1297⟩, ⟨287, 433⟩, ⟨35, 37⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94112), (-93389)⟩, ⟨287, 433⟩, ⟨35, 37⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-113425), (-50023)⟩, ⟨(-37656), (-24489)⟩, ⟨(-3057), (-2907)⟩, ⟨18, 30⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4999631, 5063034⟩, ⟨(-37656), (-24489)⟩, ⟨(-3057), (-2907)⟩, ⟨18, 30⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2678052, 6102032⟩, ⟨1293642, 2020894⟩, ⟨148565, 161386⟩, ⟨(-2481), (-1560)⟩, ⟨(-99), (-81)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140487525), (-137063544)⟩, ⟨1293642, 2020894⟩, ⟨148565, 161386⟩, ⟨(-2481), (-1560)⟩, ⟨(-99), (-81)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-169317320), (-73418086)⟩, ⟨(-55746168), (-34273436)⟩, ⟨(-4277212), (-3582256)⟩, ⟨80106, 131656⟩, ⟨3856, 4943⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1262338445, 1358237680⟩, ⟨(-55746168), (-34273436)⟩, ⟨(-4277212), (-3582256)⟩, ⟨80106, 131656⟩, ⟨3856, 4943⟩⟩
...
def j70 : Jet := ⟨⟨(-131), (-57)⟩, ⟨(-44), (-28)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11704, 11779⟩, ⟨(-44), (-28)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6269, 14197⟩, ⟨3080, 4719⟩, ⟨368, 387⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845908), (-837979)⟩, ⟨3080, 4719⟩, ⟨368, 387⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1019499), (-448863)⟩, ⟨(-338184), (-218743)⟩, ⟨(-27299), (-25690)⟩, ⟨196, 314⟩, ⟨8, 13⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34771895, 35342532⟩, ⟨(-338184), (-218743)⟩, ⟨(-27299), (-25690)⟩, ⟨196, 314⟩, ⟨8, 13⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18625565, 42595261⟩, ⟨8905198, 14081252⟩, ⟨995333, 1110858⟩, ⟨(-22186), (-13824)⟩, ⟨(-858), (-717)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697202318), (-673232621)⟩, ⟨8905198, 14081252⟩, ⟨995333, 1110858⟩, ⟨(-22186), (-13824)⟩, ⟨(-858), (-717)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-840276938), (-360617047)⟩, ⟨(-275322245), (-163337622)⟩, ⟨(-20422843), (-15542778)⟩, ⟨537965, 910284⟩, ⟨23373, 33104⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3454690358, 3934350249⟩, ⟨(-275322245), (-163337622)⟩, ⟨(-20422843), (-15542778)⟩, ⟨537965, 910284⟩, ⟨23373, 33104⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨923881690, 1491102799⟩, ⟨169771069, 223433054⟩, ⟨(-14895510), (-8892805)⟩, ⟨(-723975), (-510911)⟩, ⟨17479, 29517⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4688637997, 5339622995⟩, ⟨194652466, 425542333⟩, ⟨26603763, 65479547⟩, ⟨638036, 7003940⟩, ⟨(-13439), 883241⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1008563394, 1853780541⟩, ⟨227203343, 425515613⟩, ⟨(-5101629), 35162508⟩, ⟨(-1187066), 4877200⟩, ⟨(-259188), 629458⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1500865585), (-1000577056)⟩, ⟨(-250144265), (-250144264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2794101711, 3294390240⟩, ⟨(-250144265), (-250144264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨236835358, 800123042⟩, ⟨106705806, 367319474⟩, ⟨7615134, 72510608⟩, ⟨(-2035586), 11177482⟩, ⟨(-500721), 1797643⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4531802654, 5095090338⟩, ⟨106705806, 367319474⟩, ⟨7615134, 72510608⟩, ⟨(-2035586), 11177482⟩, ⟨(-500721), 1797643⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4411796027, 4677953225⟩, ⟨48984879, 178796246⟩, ⟨78950, 35023285⟩, ⟨(-2410225), 5439870⟩, ⟨(-603210), 972699⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2870104934, 3588153853⟩, ⟨(-240582610), (-119805536)⟩, ⟨(-10361956), 24011146⟩, ⟨(-3888527), 4167973⟩, ⟨(-779509), 886470⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3408197945, 5112296925⟩, ⟨852049486, 852049491⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2704517271, 6085163879⟩, ⟨1352258634, 2028387968⟩, ⟨169032329, 169032332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2704517271, 6085163879⟩, ⟨1352258634, 2028387968⟩, ⟨169032329, 169032332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6085163879), (-2704517271)⟩, ⟨(-2028387968), (-1352258634)⟩, ⟨(-169032332), (-169032329)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3042581940), (-1352258635)⟩, ⟨(-1014193984), (-676129317)⟩, ⟨(-84516166), (-84516164)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2114963654, 3134898177⟩, ⟨(-740260555), (-332945243)⟩, ⟨(-35481658), 45782721⟩, ⟨764146, 12504035⟩, ⟨(-1188617), 319030⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1413321033, 2618994791⟩, ⟨(-794038817), (-281485760)⟩, ⟨(-27918408), 97239802⟩, ⟨(-9030569), 17261924⟩, ⟨(-3179122), 1818407⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1250721320, 1250721321⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4514044015, 4514044021⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified182
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1000577056, 1500865585⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4411796027, 4677953225⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified183
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (114447161 / 2147483648)

theorem envelope_integral : (∫ s in ((46593 / 200000) : ℝ)..(139779 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((46593 / 200000) : ℝ)..(139779 / 400000), prawitzNormalCorrection
