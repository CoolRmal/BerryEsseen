...
namespace FiniteNormalPanel47_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (36411 / 160000)
def radius : Rat := (36411 / 800000)

def j0 : Jet := ⟨⟨977400338, 977400339⟩, ⟨195480067, 195480068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3070593721, 3070593725⟩, ⟨614118742, 614118746⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2195254387, 2195254393⟩, ⟨878101750, 878101760⟩, ⟨87810174, 87810177⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨549, 550⟩, ⟨219, 220⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94138), (-94136)⟩, ⟨219, 220⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48117), (-48115)⟩, ⟨(-19136), (-19133)⟩, ⟨(-1871), (-1867)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064939, 5064942⟩, ⟨(-19136), (-19133)⟩, ⟨(-1871), (-1867)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2588804, 2588806⟩, ⟨1025740, 1025744⟩, ⟨98682, 98688⟩, ⟨(-771), (-766)⟩, ⟨(-38), (-34)⟩⟩
...
def j16 : Jet := ⟨⟨(-140576773), (-140576770)⟩, ⟨1025740, 1025744⟩, ⟨98682, 98688⟩, ⟨(-771), (-766)⟩, ⟨(-38), (-34)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-71851951), (-71851948)⟩, ⟨(-28216503), (-28216498)⟩, ⟨(-2613930), (-2613922)⟩, ⟨40751, 40758⟩, ⟨1839, 1845⟩⟩
...
def j19 : Jet := ⟨⟨1359803814, 1359803818⟩, ⟨(-28216503), (-28216498)⟩, ⟨(-2613930), (-2613922)⟩, ⟨40751, 40758⟩, ⟨1839, 1845⟩⟩
...
def j22 : Jet := ⟨⟨(-56), (-54)⟩, ⟨(-23), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11779, 11782⟩, ⟨(-23), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6020, 6023⟩, ⟨2396, 2399⟩, ⟨233, 236⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846157), (-846153)⟩, ⟨2396, 2399⟩, ⟨233, 236⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-432490), (-432487)⟩, ⟨(-171772), (-171768)⟩, ⟨(-16692), (-16687)⟩, ⟨93, 99⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35358904, 35358908⟩, ⟨(-171772), (-171768)⟩, ⟨(-16692), (-16687)⟩, ⟨93, 99⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18072731, 18072734⟩, ⟨7141295, 7141300⟩, ⟨679258, 679264⟩, ⟨(-6878), (-6871)⟩, ⟨(-322), (-317)⟩⟩
...
def j33 : Jet := ⟨⟨(-697755152), (-697755148)⟩, ⟨7141295, 7141300⟩, ⟨679258, 679264⟩, ⟨(-6878), (-6871)⟩, ⟨(-322), (-317)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-356638354), (-356638349)⟩, ⟨(-139005266), (-139005259)⟩, ⟨(-12458321), (-12458313)⟩, ⟨281360, 281368⟩, ⟨12315, 12322⟩⟩
...
def j36 : Jet := ⟨⟨3938328942, 3938328947⟩, ⟨(-139005266), (-139005259)⟩, ⟨(-12458321), (-12458313)⟩, ⟨281360, 281368⟩, ⟨12315, 12322⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨972162246, 972162251⟩, ⟨174259671, 174259678⟩, ⟨(-5903329), (-5903320)⟩, ⟨(-344621), (-344613)⟩, ⟨7140, 7148⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4683901299, 4683901306⟩, ⟨165320602, 165320612⟩, ⟨20651890, 20651903⟩, ⟨917248, 917265⟩, ⟨71236, 71249⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1060197131, 1060197139⟩, ⟨227460065, 227460078⟩, ⟨4944178, 4944195⟩, ⟨442467, 442486⟩, ⟨19473, 19492⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-977400339), (-977400338)⟩, ⟨(-195480068), (-195480067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3317566957, 3317566958⟩, ⟨(-195480068), (-195480067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨261705824, 261705829⟩, ⟨112295386, 112295396⟩, ⟨14487114, 14487127⟩, ⟨742126, 742140⟩, ⟨62167, 62184⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4556673120, 4556673125⟩, ⟨112295386, 112295396⟩, ⟨14487114, 14487127⟩, ⟨742126, 742140⟩, ⟨62167, 62184⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4423885399, 4423885403⟩, ⟨54511471, 54511477⟩, ⟨6696622, 6696629⟩, ⟨277732, 277741⟩, ⟨21685, 21697⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3417147328, 3417147333⟩, ⟨(-159241252), (-159241244)⟩, ⟨2691658, 2691665⟩, ⟨(-90261), (-90252)⟩, ⟨4108, 4120⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨23662226232, 23662226238⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value288

def j47 : Jet := ⟨⟨5384783241, 5384783249⟩, ⟨1076956644, 1076956651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6751131860, 6751131881⟩, ⟨2700452732, 2700452756⟩, ⟨270045272, 270045276⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6751131860, 6751131881⟩, ⟨2700452732, 2700452756⟩, ⟨270045272, 270045276⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6751131881), (-6751131860)⟩, ⟨(-2700452756), (-2700452732)⟩, ⟨(-270045276), (-270045272)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3375565941), (-3375565930)⟩, ⟨(-1350226378), (-1350226366)⟩, ⟨(-135022638), (-135022636)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1957187997, 1957188012⟩, ⟨(-615289175), (-615289163)⟩, ⟨35186562, 35186568⟩, ⟨9208148, 9208151⟩, ⟨(-1276789), (-1276787)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1557171282, 1557171298⟩, ⟨(-562099469), (-562099453)⟩, ⟨52034192, 52034205⟩, ⟨5594833, 5594844⟩, ⟨(-1320388), (-1320374)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨781920271, 1172880407⟩, ⟨195480067, 195480068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2456474978, 3684712471⟩, ⟨614118742, 614118746⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1404962809, 3161166328⟩, ⟨702481400, 1053722112⟩, ⟨87810174, 87810177⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨351, 792⟩, ⟨175, 264⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94336), (-93894)⟩, ⟨175, 264⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-69433), (-30714)⟩, ⟨(-23088), (-15162)⟩, ⟨(-1895), (-1837)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5043623, 5082343⟩, ⟨(-23088), (-15162)⟩, ⟨(-1895), (-1837)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1649861, 3740688⟩, ⟨807936, 1241937⟩, ⟨96056, 100829⟩, ⟨(-937), (-600)⟩, ⟨(-39), (-33)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141515716), (-139424888)⟩, ⟨807936, 1241937⟩, ⟨96056, 100829⟩, ⟨(-937), (-600)⟩, ⟨(-39), (-33)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-104157887), (-45608445)⟩, ⟨(-34455006), (-21890136)⟩, ⟨(-2729709), (-2471619)⟩, ⟨31538, 49934⟩, ⟨1704, 1954⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1327497878, 1386047321⟩, ⟨(-34455006), (-21890136)⟩, ⟨(-2729709), (-2471619)⟩, ⟨31538, 49934⟩, ⟨1704, 1954⟩⟩
...
def j70 : Jet := ⟨⟨(-80), (-35)⟩, ⟨(-27), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11755, 11801⟩, ⟨(-27), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3845, 8686⟩, ⟨1902, 2891⟩, ⟨230, 240⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848332), (-843490)⟩, ⟨1902, 2891⟩, ⟨230, 240⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-624387), (-275921)⟩, ⟨(-207507), (-135832)⟩, ⟨(-16959), (-16358)⟩, ⟨73, 119⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35167007, 35515474⟩, ⟨(-207507), (-135832)⟩, ⟨(-16959), (-16358)⟩, ⟨73, 119⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11503774, 26139971⟩, ⟨5599158, 8668891⟩, ⟨655592, 698544⟩, ⟨(-8381), (-5364)⟩, ⟨(-336), (-300)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704324109), (-689687911)⟩, ⟨5599158, 8668891⟩, ⟨655592, 698544⟩, ⟨(-8381), (-5364)⟩, ⟨(-336), (-300)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-518394089), (-225609602)⟩, ⟨(-170966444), (-106424354)⟩, ⟨(-13269587), (-11459643)⟩, ⟨215533, 346861⟩, ⟨11098, 13307⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3776573207, 4069357694⟩, ⟨(-170966444), (-106424354)⟩, ⟨(-13269587), (-11459643)⟩, ⟨215533, 346861⟩, ⟨11098, 13307⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨759252654, 1189109369⟩, ⟨160253730, 185664994⟩, ⟨(-7268428), (-4543599)⟩, ⟨(-372273), (-310566)⟩, ⟨5483, 8817⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4533084938, 4884519130⟩, ⟨118552034, 221123443⟩, ⟨15865982, 27172848⟩, ⟨332443, 1748368⟩, ⟨18551, 154540⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨801346444, 1352333339⟩, ⟨190095676, 272370916⟩, ⟨(-1037979), 12286439⟩, ⟨(-146826), 1205500⟩, ⟨(-43683), 103039⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1172880407), (-781920271)⟩, ⟨(-195480068), (-195480067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3122086889, 3513047025⟩, ⟨(-195480068), (-195480067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨149513623, 425801953⟩, ⟨70935344, 171519942⟩, ⟨7760007, 25009887⟩, ⟨(-224112), 2317462⟩, ⟨(-49104), 252934⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4444480919, 4720769249⟩, ⟨70935344, 171519942⟩, ⟨7760007, 25009887⟩, ⟨(-224112), 2317462⟩, ⟨(-49104), 252934⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4369084594, 4502837943⟩, ⟨33830329, 84305137⟩, ⟨2911676, 12161834⟩, ⟨(-344829), 1116530⟩, ⟨(-62609), 130007⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3175964049, 3683073782⟩, ⟨(-180349183), (-129896457)⟩, ⟨(-1720495), 8407967⟩, ⟨(-835583), 780740⟩, ⟨(-102029), 122034⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4307826596, 6461739899⟩, ⟨1076956644, 1076956651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4320724397, 9721629909⟩, ⟨2160362188, 3240543308⟩, ⟨270045272, 270045276⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4320724397, 9721629909⟩, ⟨2160362188, 3240543308⟩, ⟨270045272, 270045276⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9721629909), (-4320724397)⟩, ⟨(-3240543308), (-2160362188)⟩, ⟨(-270045276), (-270045272)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4860814955), (-2160362198)⟩, ⟨(-1620271654), (-1080181094)⟩, ⟨(-135022638), (-135022636)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1384996012, 2597229816⟩, ⟨(-979802071), (-348325471)⟩, ⟨(-37848375), 141273940⟩, ⟨(-10464847), 25294378⟩, ⟨(-4606213), 1581891⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1024151579, 2227208820⟩, ⟨(-949271861), (-299461010)⟩, ⟨(-22961907), 167374098⟩, ⟨(-17329538), 24144653⟩, ⟨(-5326012), 2336930⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨977400338, 977400339⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4423885399, 4423885403⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar288 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified922
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar288 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨781920271, 1172880407⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4369084594, 4502837943⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified923
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((36411 / 200000) : ℝ)..(109233 / 400000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (36411 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (109233 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((36411 / 200000) : ℝ)..(109233 / 400000), prawitzNormalCorrection
      ((246383 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
