...
namespace FiniteNormalPanel90_17

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (31731 / 800000)
def radius : Rat := (31731 / 800000)

def j0 : Jet := ⟨⟨170354509, 170354510⟩, ⟨170354509, 170354510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨535184473, 535184478⟩, ⟨535184473, 535184478⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨66687916, 66687918⟩, ⟨133375832, 133375836⟩, ⟨66687916, 66687918⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1470), (-1469)⟩, ⟨(-2940), (-2938)⟩, ⟨(-1469), (-1466)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111586, 5111588⟩, ⟨(-2940), (-2938)⟩, ⟨(-1469), (-1466)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨79367, 79368⟩, ⟨158689, 158691⟩, ⟨79252, 79255⟩, ⟨(-92), (-89)⟩, ⟨(-23), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-143086210), (-143086208)⟩, ⟨158689, 158691⟩, ⟨79252, 79255⟩, ⟨(-92), (-89)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2221699), (-2221698)⟩, ⟨(-4440934), (-4440932)⟩, ⟨(-2215542), (-2215539)⟩, ⟨4922, 4925⟩, ⟨1226, 1229⟩⟩
...
def j19 : Jet := ⟨⟨1429434066, 1429434068⟩, ⟨(-4440934), (-4440932)⟩, ⟨(-2215542), (-2215539)⟩, ⟨4922, 4925⟩, ⟨1226, 1229⟩⟩
...
def j25 : Jet := ⟨⟨183, 184⟩, ⟨366, 368⟩, ⟨181, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851994), (-851992)⟩, ⟨366, 368⟩, ⟨181, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13229), (-13228)⟩, ⟨(-26453), (-26451)⟩, ⟨(-13216), (-13213)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778165, 35778167⟩, ⟨(-26453), (-26451)⟩, ⟨(-13216), (-13213)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨555527, 555528⟩, ⟨1110643, 1110645⟩, ⟨554499, 554502⟩, ⟨(-822), (-819)⟩, ⟨(-206), (-203)⟩⟩
...
def j33 : Jet := ⟨⟨(-715272356), (-715272354)⟩, ⟨1110643, 1110645⟩, ⟨554499, 554502⟩, ⟨(-822), (-819)⟩, ⟨(-206), (-203)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11106028), (-11106026)⟩, ⟨(-22194811), (-22194808)⟩, ⟨(-11062930), (-11062926)⟩, ⟨34450, 34453⟩, ⟨8579, 8582⟩⟩
...
def j36 : Jet := ⟨⟨4283861268, 4283861270⟩, ⟨(-22194811), (-22194808)⟩, ⟨(-11062930), (-11062926)⟩, ⟨34450, 34453⟩, ⟨8579, 8582⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨178117984, 178117987⟩, ⟨177564610, 177564615⟩, ⟨(-829447), (-829444)⟩, ⟨(-275460), (-275458)⟩, ⟨765, 768⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306102114, 4306102117⟩, ⟨22310037, 22310042⟩, ⟨11235950, 11235957⟩, ⟨81194, 81201⟩, ⟨20629, 20637⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨178579759, 178579763⟩, ⟨178950177, 178950185⟩, ⟨556723, 556730⟩, ⟨187405, 187411⟩, ⟨1376, 1385⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-170354510), (-170354509)⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4124612786, 4124612787⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7425139, 7425140⟩, ⟨14881080, 14881084⟩, ⟨7502268, 7502273⟩, ⟨61974, 61980⟩, ⟨15802, 15807⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302392435, 4302392436⟩, ⟨14881080, 14881084⟩, ⟨7502268, 7502273⟩, ⟨61974, 61980⟩, ⟨15802, 15807⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298678262, 4298678263⟩, ⟨7434116, 7434119⟩, ⟨3741467, 3741471⟩, ⟨24488, 24493⟩, ⟨6222, 6227⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4128176561, 4128176564⟩, ⟨(-163362450), (-163362445)⟩, ⟨3298200, 3298207⟩, ⟨(-124885), (-124878)⟩, ⟨5003, 5010⟩⟩
...
def j47 : Jet := ⟨⟨1218002371, 1218002380⟩, ⟨1218002371, 1218002380⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨345411192, 345411198⟩, ⟨690822384, 690822396⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨345411192, 345411198⟩, ⟨690822384, 690822396⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-345411198), (-345411192)⟩, ⟨(-690822396), (-690822384)⟩, ⟨(-345411198), (-345411192)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-172705599), (-172705596)⟩, ⟨(-345411198), (-345411192)⟩, ⟨(-172705599), (-172705596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4125687964, 4125687968⟩, ⟨(-331797364), (-331797357)⟩, ⟨(-152556728), (-152556723)⟩, ⟨12984291, 12984292⟩, ⟨2806184, 2806185⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3965471021, 3965471029⟩, ⟨(-475836126), (-475836113)⟩, ⟨(-130843964), (-130843949)⟩, ⟨17907914, 17907926⟩, ⟨2100640, 2100653⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 340709019⟩, ⟨170354509, 170354510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1070368952⟩, ⟨535184473, 535184478⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 266751669⟩, ⟨0, 266751670⟩, ⟨66687916, 66687918⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 67⟩, ⟨0, 67⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94619)⟩, ⟨0, 67⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5881), 0⟩, ⟨(-5881), 5⟩, ⟨(-1471), (-1462)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107175, 5113057⟩, ⟨(-5881), 5⟩, ⟨(-1471), (-1462)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 317562⟩, ⟨(-366), 317563⟩, ⟨78841, 79392⟩, ⟨(-184), 2⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142848014)⟩, ⟨(-366), 317563⟩, ⟨78841, 79392⟩, ⟨(-184), 2⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8891723), 0⟩, ⟨(-8891746), 19724⟩, ⟨(-2222954), (-2193344)⟩, ⟨(-18), 9863⟩, ⟨1210, 1234⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422764042, 1431655766⟩, ⟨(-8891746), 19724⟩, ⟨(-2222954), (-2193344)⟩, ⟨(-18), 9863⟩, ⟨1210, 1234⟩⟩
...
def j72 : Jet := ⟨⟨0, 736⟩, ⟨(-1), 736⟩, ⟨181, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851440)⟩, ⟨(-1), 736⟩, ⟨181, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-52927), 0⟩, ⟨(-52928), 46⟩, ⟨(-13233), (-13162)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35738467, 35791395⟩, ⟨(-52928), 46⟩, ⟨(-13233), (-13162)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2222931⟩, ⟨(-3288), 2222934⟩, ⟨550800, 555736⟩, ⟨(-1645), 3⟩, ⟨(-207), (-201)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713604951)⟩, ⟨(-3288), 2222934⟩, ⟨550800, 555736⟩, ⟨(-1645), 3⟩, ⟨(-207), (-201)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-44458612), 0⟩, ⟨(-44458817), 138062⟩, ⟨(-11114859), (-10907559)⟩, ⟨(-155), 69033⟩, ⟨8436, 8630⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4250508684, 4294967296⟩, ⟨(-44458817), 138062⟩, ⟨(-11114859), (-10907559)⟩, ⟨(-155), 69033⟩, ⟨8436, 8630⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 356789651⟩, ⟨175070896, 178399743⟩, ⟨(-1661970), 2458⟩, ⟨(-277002), (-270847)⟩, ⟨(-3), 1538⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4339890928⟩, ⟨(-140967), 45393725⟩, ⟨10906099, 11823392⟩, ⟨(-71240), 242531⟩, ⟨17508, 24935⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 360521528⟩, ⟨175059185, 184036661⟩, ⟨(-1685210), 2870188⟩, ⟨141167, 240464⟩, ⟨(-10468), 13718⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-340709019), 0⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3954258277, 4294967296⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 30262343⟩, ⟨0, 30896244⟩, ⟨6852346, 8367706⟩, ⟨(-144422), 286342⟩, ⟨8621, 24831⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4325229639⟩, ⟨0, 30896244⟩, ⟨6852346, 8367706⟩, ⟨(-144422), 286342⟩, ⟨8621, 24831⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4310071908⟩, ⟨0, 15448122⟩, ⟨3386481, 4183853⟩, ⟨(-87260), 143171⟩, ⟨1751, 11395⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3954258277, 4310071908⟩, ⟨(-170953616), (-154906387)⟩, ⟨2505108, 4183853⟩, ⟨(-253208), 8851⟩, ⟨(-4067), 14857⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2436004752⟩, ⟨1218002371, 1218002380⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1381644782⟩, ⟨0, 1381644788⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1381644782⟩, ⟨0, 1381644788⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1381644782), 0⟩, ⟨(-1381644788), 0⟩, ⟨(-345411198), (-345411192)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-690822391), 0⟩, ⟨(-690822394), 0⟩, ⟨(-172705599), (-172705596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3656839752, 4294967296⟩, ⟨(-690822394), 0⟩, ⟨(-172705599), (-91488216)⟩, ⟨0, 27778767⟩, ⟨722406, 3472346⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3366751795, 4310071908⟩, ⟨(-864205506), (-131891070)⟩, ⟨(-171180064), (-52549861)⟩, ⟨2373542, 34759554⟩, ⟨(-614315), 3486782⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨170354509, 170354510⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298678262, 4298678263⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1826
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 340709019⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4310071908⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1827
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (155583191 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(31731 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (31731 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(31731 / 400000), prawitzNormalCorrection
