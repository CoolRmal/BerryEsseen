...
namespace FiniteNormalPanel160_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (76887 / 800000)
def radius : Rat := (25629 / 800000)

def j0 : Jet := ⟨⟨412783938, 412783939⟩, ⟨137594646, 137594647⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1296798987, 1296798991⟩, ⟨432266329, 432266333⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨391548409, 391548412⟩, ⟨261032272, 261032278⟩, ⟨43505378, 43505380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨98, 99⟩, ⟨65, 66⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94589), (-94587)⟩, ⟨65, 66⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8624), (-8622)⟩, ⟨(-5744), (-5741)⟩, ⟨(-956), (-951)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104432, 5104435⟩, ⟨(-5744), (-5741)⟩, ⟨(-956), (-951)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨465342, 465344⟩, ⟨309704, 309706⟩, ⟨51266, 51271⟩, ⟨(-118), (-114)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142700235), (-142700232)⟩, ⟨309704, 309706⟩, ⟨51266, 51271⟩, ⟨(-118), (-114)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13009192), (-13009190)⟩, ⟨(-8644561), (-8644558)⟩, ⟨(-1421971), (-1421967)⟩, ⟨6241, 6245⟩, ⟨510, 514⟩⟩
...
def j19 : Jet := ⟨⟨1418646573, 1418646576⟩, ⟨(-8644561), (-8644558)⟩, ⟨(-1421971), (-1421967)⟩, ⟨6241, 6245⟩, ⟨510, 514⟩⟩
...
def j25 : Jet := ⟨⟨1078, 1079⟩, ⟨717, 719⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851099), (-851097)⟩, ⟨717, 719⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-77590), (-77589)⟩, ⟨(-51662), (-51660)⟩, ⟨(-8569), (-8566)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35713804, 35713806⟩, ⟨(-51662), (-51660)⟩, ⟨(-8569), (-8566)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3255829, 3255831⟩, ⟨2165843, 2165845⟩, ⟨357836, 357840⟩, ⟨(-1044), (-1041)⟩, ⟨(-88), (-84)⟩⟩
...
def j33 : Jet := ⟨⟨(-712572054), (-712572051)⟩, ⟨2165843, 2165845⟩, ⟨357836, 357840⟩, ⟨(-1044), (-1041)⟩, ⟨(-88), (-84)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-64961253), (-64961252)⟩, ⟨(-43110056), (-43110052)⟩, ⟨(-7053666), (-7053660)⟩, ⟨43589, 43594⟩, ⟨3551, 3555⟩⟩
...
def j36 : Jet := ⟨⟨4230006043, 4230006044⟩, ⟨(-43110056), (-43110052)⟩, ⟨(-7053666), (-7053660)⟩, ⟨43589, 43594⟩, ⟨3551, 3555⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨428338404, 428338407⟩, ⟨140169376, 140169380⟩, ⟨(-1299374), (-1299370)⟩, ⟨(-141231), (-141227)⟩, ⟨781, 785⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4360926174, 4360926176⟩, ⟨44444322, 44444328⟩, ⟨7724925, 7724934⟩, ⟨107895, 107905⟩, ⟨9855, 9865⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨434916503, 434916507⟩, ⟨146754436, 146754443⟩, ⟨901552, 901560⟩, ⟨106022, 106031⟩, ⟨1495, 1506⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-412783939), (-412783938)⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3882183357, 3882183358⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨44040466, 44040468⟩, ⟨29721262, 29721266⟩, ⟨5197026, 5197031⟩, ⟨83080, 83086⟩, ⟨7735, 7742⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4339007762, 4339007764⟩, ⟨29721262, 29721266⟩, ⟨5197026, 5197031⟩, ⟨83080, 83086⟩, ⟨7735, 7742⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316931367, 4316931369⟩, ⟨14785021, 14785024⟩, ⟨2559973, 2559977⟩, ⟨32560, 32565⟩, ⟨2976, 2982⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3902036488, 3902036492⟩, ⟨(-124934243), (-124934238)⟩, ⟨1840280, 1840285⟩, ⟨(-52583), (-52575)⟩, ⟨1645, 1653⟩⟩
...
def j47 : Jet := ⟨⟨4379751643, 4379751656⟩, ⟨1459917214, 1459917226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4466209666, 4466209693⟩, ⟨2977473110, 2977473144⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4466209666, 4466209693⟩, ⟨2977473110, 2977473144⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4466209693), (-4466209666)⟩, ⟨(-2977473144), (-2977473110)⟩, ⟨(-496245527), (-496245518)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2233104847), (-2233104833)⟩, ⟨(-1488736572), (-1488736555)⟩, ⟨(-248122764), (-248122759)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2553611673, 2553611694⟩, ⟨(-885141809), (-885141791)⟩, ⟨5881832, 5881842⟩, ⟨33410509, 33410512⟩, ⟨(-3065116), (-3065115)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2319991105, 2319991127⟩, ⟨(-878444218), (-878444195)⟩, ⟨32185342, 32185359⟩, ⟨29772284, 29772297⟩, ⟨(-3742230), (-3742219)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨275189292, 550378585⟩, ⟨137594646, 137594647⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨864532658, 1729065320⟩, ⟨432266329, 432266333⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨174021515, 696086065⟩, ⟨174021514, 348043036⟩, ⟨43505378, 43505380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨43, 175⟩, ⟨43, 88⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94644), (-94511)⟩, ⟨43, 88⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-15339), (-3829)⟩, ⟨(-7669), (-3814)⟩, ⟨(-958), (-947)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097717, 5109228⟩, ⟨(-7669), (-3814)⟩, ⟨(-958), (-947)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨206546, 828054⟩, ⟨205303, 413873⟩, ⟨50858, 51562⟩, ⟨(-156), (-75)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142959031), (-142337522)⟩, ⟨205303, 413873⟩, ⟨50858, 51562⟩, ⟨(-156), (-75)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-23169394), (-5767166)⟩, ⟨(-11576380), (-5700089)⟩, ⟨(-1437710), (-1399895)⟩, ⟨4113, 8369⟩, ⟨500, 520⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408486371, 1425888600⟩, ⟨(-11576380), (-5700089)⟩, ⟨(-1437710), (-1399895)⟩, ⟨4113, 8369⟩, ⟨500, 520⟩⟩
...
def j72 : Jet := ⟨⟨478, 1918⟩, ⟨476, 959⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851699), (-850258)⟩, ⟨476, 959⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-138035), (-34450)⟩, ⟨(-68999), (-34294)⟩, ⟨(-8605), (-8514)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35653359, 35756945⟩, ⟨(-68999), (-34294)⟩, ⟨(-8605), (-8514)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1444586, 5795135⟩, ⟨1433403, 2896179⟩, ⟨354159, 360463⟩, ⟨(-1397), (-687)⟩, ⟨(-89), (-83)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714383297), (-710032747)⟩, ⟨1433403, 2896179⟩, ⟨354159, 360463⟩, ⟨(-1397), (-687)⟩, ⟨(-89), (-83)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-115780220), (-28768781)⟩, ⟨(-57832034), (-28299396)⟩, ⟨(-7163838), (-6899081)⟩, ⟨28641, 58521⟩, ⟨3458, 3622⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4179187076, 4266198515⟩, ⟨(-57832034), (-28299396)⟩, ⟨(-7163838), (-6899081)⟩, ⟨28641, 58521⟩, ⟨3458, 3622⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨283513792, 574033365⟩, ⟨137096483, 142360974⟩, ⟨(-1743897), (-855468)⟩, ⟨(-143872), (-137522)⟩, ⟨513, 1053⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4323930077, 4413955092⟩, ⟨28682351, 61080779⟩, ⟨7182702, 8411514⟩, ⟨33479, 191471⟩, ⟨7249, 13297⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨285425645, 589936389⟩, ⟨139914324, 154468547⟩, ⟨(-402527), 2287569⟩, ⟨58823, 160239⟩, ⟨(-3401), 6860⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-550378585), (-275189292)⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3744588711, 4019778004⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨18968200, 81030872⟩, ⟨18596246, 42434138⟩, ⟨4447316, 6183884⟩, ⟨(-21136), 208566⟩, ⟨2681, 14631⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4313935496, 4375998168⟩, ⟨18596246, 42434138⟩, ⟨4447316, 6183884⟩, ⟨(-21136), 208566⟩, ⟨2681, 14631⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304440947, 4335293418⟩, ⟨9211633, 21170373⟩, ⟨2151283, 3075281⟩, ⟨(-25671), 99451⟩, ⟨(-251), 6889⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3752848360, 4057520331⟩, ⟨(-130855337), (-118084211)⟩, ⟨1197386, 2583135⟩, ⟨(-122548), 24160⟩, ⟨(-3422), 7271⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2919834429, 5839668870⟩, ⟨1459917214, 1459917226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1984982074, 7939928331⟩, ⟨1984982072, 3969964190⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1984982074, 7939928331⟩, ⟨1984982072, 3969964190⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7939928331), (-1984982074)⟩, ⟨(-3969964190), (-1984982072)⟩, ⟨(-496245527), (-496245518)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3969964166), (-992491037)⟩, ⟨(-1984982095), (-992491036)⟩, ⟨(-248122764), (-248122759)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1704232098, 3408804402⟩, ⟨(-1575428924), (-393817918)⟩, ⟨(-151426438), 265599307⟩, ⟨(-25749478), 84003615⟩, ⟨(-17377790), 7349122⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1489120683, 3220348891⟩, ⟨(-1592187942), (-390964985)⟩, ⟨(-131752239), 300964638⟩, ⟨(-33462749), 83882397⟩, ⟨(-19079063), 7937804⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨412783938, 412783939⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316931367, 4316931369⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3238
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨275189292, 550378585⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304440947, 4335293418⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3239
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (74718375 / 2147483648)

theorem envelope_integral : (∫ s in ((25629 / 400000) : ℝ)..(25629 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (25629 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (25629 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((25629 / 400000) : ℝ)..(25629 / 200000), prawitzNormalCorrection
