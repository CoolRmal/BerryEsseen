...
namespace FiniteNormalPanel66_16
...
def j2 : Jet := ⟨⟨541593665, 541593669⟩, ⟨541593665, 541593669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨68294745, 68294747⟩, ⟨136589490, 136589494⟩, ⟨68294745, 68294747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1506), (-1505)⟩, ⟨(-3011), (-3009)⟩, ⟨(-1505), (-1502)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111550, 5111552⟩, ⟨(-3011), (-3009)⟩, ⟨(-1505), (-1502)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨81279, 81280⟩, ⟨162510, 162512⟩, ⟨81159, 81162⟩, ⟨(-96), (-93)⟩, ⟨(-24), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-143084298), (-143084296)⟩, ⟨162510, 162512⟩, ⟨81159, 81162⟩, ⟨(-96), (-93)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2275200), (-2275199)⟩, ⟨(-4547815), (-4547813)⟩, ⟨(-2268742), (-2268739)⟩, ⟨5163, 5166⟩, ⟨1285, 1289⟩⟩
...
def j19 : Jet := ⟨⟨1429380565, 1429380567⟩, ⟨(-4547815), (-4547813)⟩, ⟨(-2268742), (-2268739)⟩, ⟨5163, 5166⟩, ⟨1285, 1289⟩⟩
...
def j25 : Jet := ⟨⟨188, 189⟩, ⟨375, 377⟩, ⟨186, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851989), (-851987)⟩, ⟨375, 377⟩, ⟨186, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13548), (-13547)⟩, ⟨(-27091), (-27089)⟩, ⟨(-13535), (-13531)⟩, ⟨9, 13⟩, ⟨0, 4⟩⟩
...
def j30 : Jet := ⟨⟨35777846, 35777848⟩, ⟨(-27091), (-27089)⟩, ⟨(-13535), (-13531)⟩, ⟨9, 13⟩, ⟨0, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨568907, 568908⟩, ⟨1137383, 1137385⟩, ⟨567829, 567832⟩, ⟨(-862), (-859)⟩, ⟨(-216), (-213)⟩⟩
...
def j33 : Jet := ⟨⟨(-715258976), (-715258974)⟩, ⟨1137383, 1137385⟩, ⟨567829, 567832⟩, ⟨(-862), (-859)⟩, ⟨(-216), (-213)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11373412), (-11373411)⟩, ⟨(-22728739), (-22728736)⟩, ⟨(-11328212), (-11328209)⟩, ⟨36129, 36132⟩, ⟨8997, 9000⟩⟩
...
def j36 : Jet := ⟨⟨4283593884, 4283593885⟩, ⟨(-22728739), (-22728736)⟩, ⟨(-11328212), (-11328209)⟩, ⟨36129, 36132⟩, ⟨8997, 9000⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨180244319, 180244322⟩, ⟨179670841, 179670845⟩, ⟨(-859566), (-859564)⟩, ⟨(-285437), (-285435)⟩, ⟨813, 815⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306370904, 4306370906⟩, ⟨22849590, 22849595⟩, ⟨11509682, 11509688⟩, ⟨85172, 85179⟩, ⟨21647, 21655⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨180722887, 180722891⟩, ⟨181106801, 181106807⟩, ⟨577034, 577040⟩, ⟨194289, 194295⟩, ⟨1462, 1470⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-172394619), (-172394618)⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4122572677, 4122572678⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7604426, 7604427⟩, ⟨15241160, 15241162⟩, ⟨7685329, 7685332⟩, ⟨65012, 65018⟩, ⟨16583, 16588⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302571722, 4302571723⟩, ⟨15241160, 15241162⟩, ⟨7685329, 7685332⟩, ⟨65012, 65018⟩, ⟨16583, 16588⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298767827, 4298767828⟩, ⟨7613842, 7613844⟩, ⟨3832524, 3832527⟩, ⟨25688, 25693⟩, ⟨6529, 6534⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4126220659, 4126220662⟩, ⟨(-165238937), (-165238932)⟩, ⟨3373080, 3373085⟩, ⟨(-129177), (-129170)⟩, ⟨5234, 5241⟩⟩
...
def j47 : Jet := ⟨⟨1361657800, 1361657809⟩, ⟨1361657800, 1361657809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨431694082, 431694088⟩, ⟨863388164, 863388176⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨431694082, 431694088⟩, ⟨863388164, 863388176⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-431694088), (-431694082)⟩, ⟨(-863388176), (-863388164)⟩, ⟨(-431694088), (-431694082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-215847044), (-215847041)⟩, ⟨(-431694088), (-431694082)⟩, ⟨(-215847044), (-215847041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4084454306, 4084454310⟩, ⟨(-410535089), (-410535082)⟩, ⟨(-184635774), (-184635769)⟩, ⟨19940526, 19940528⟩, ⟨4138445, 4138447⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3923978595, 3923978603⟩, ⟨(-551545354), (-551545340)⟩, ⟨(-158379409), (-158379395)⟩, ⟨25815245, 25815258⟩, ⟨3080999, 3081014⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 344789238⟩, ⟨172394618, 172394619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1083187338⟩, ⟨541593665, 541593669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 273178986⟩, ⟨0, 273178986⟩, ⟨68294745, 68294747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 69⟩, ⟨0, 69⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94617)⟩, ⟨0, 69⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6023), 0⟩, ⟨(-6023), 5⟩, ⟨(-1506), (-1497)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107033, 5113057⟩, ⟨(-6023), 5⟩, ⟨(-1506), (-1497)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 325214⟩, ⟨(-384), 325215⟩, ⟨80727, 81305⟩, ⟨(-192), 2⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142840362)⟩, ⟨(-384), 325215⟩, ⟨80727, 81305⟩, ⟨(-192), 2⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9105967), 0⟩, ⟨(-9105992), 20686⟩, ⟨(-2276517), (-2245462)⟩, ⟨(-20), 10345⟩, ⟨1268, 1294⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422549798, 1431655766⟩, ⟨(-9105992), 20686⟩, ⟨(-2276517), (-2245462)⟩, ⟨(-20), 10345⟩, ⟨1268, 1294⟩⟩
...
def j72 : Jet := ⟨⟨0, 753⟩, ⟨(-1), 753⟩, ⟨186, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851423)⟩, ⟨(-1), 753⟩, ⟨186, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-54203), 0⟩, ⟨(-54204), 48⟩, ⟨(-13552), (-13477)⟩, ⟨(-2), 25⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35737191, 35791395⟩, ⟨(-54204), 48⟩, ⟨(-13552), (-13477)⟩, ⟨(-2), 25⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2276492⟩, ⟨(-3448), 2276496⟩, ⟨563950, 569127⟩, ⟨(-1725), 3⟩, ⟨(-217), (-211)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713551390)⟩, ⟨(-3448), 2276496⟩, ⟨563950, 569127⟩, ⟨(-1725), 3⟩, ⟨(-217), (-211)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-45529832), 0⟩, ⟨(-45530052), 144796⟩, ⟨(-11382678), (-11165262)⟩, ⟨(-165), 72400⟩, ⟨8843, 9051⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4249437464, 4294967296⟩, ⟨(-45530052), 144796⟩, ⟨(-11382678), (-11165262)⟩, ⟨(-165), 72400⟩, ⟨8843, 9051⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 361062447⟩, ⟨177086438, 180536441⟩, ⟨(-1722398), 2609⟩, ⟨(-287074), (-280541)⟩, ⟨(-3), 1632⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4340984950⟩, ⟨(-147917), 46510927⟩, ⟨11163693, 12126237⟩, ⟨(-74771), 254680⟩, ⟨18295, 26277⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 364930986⟩, ⟨177074003, 186380774⟩, ⟨(-1747071), 2977107⟩, ⟨145202, 250650⟩, ⟨(-11119), 14584⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-344789238), 0⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3950178058, 4294967296⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 31007134⟩, ⟨0, 31672474⟩, ⟨7003563, 8593937⟩, ⟨(-151630), 300982⟩, ⟨8870, 26298⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4325974430⟩, ⟨0, 31672474⟩, ⟨7003563, 8593937⟩, ⟨(-151630), 300982⟩, ⟨8870, 26298⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4310442982⟩, ⟨0, 15836237⟩, ⟨3460118, 4296969⟩, ⟨(-91659), 150491⟩, ⟨1724, 12094⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3950178058, 4310442982⟩, ⟨(-173015794), (-156558381)⟩, ⟨2546701, 4296969⟩, ⟨(-264134), 11607⟩, ⟨(-4456), 15774⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2723315617⟩, ⟨1361657800, 1361657809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1726776350⟩, ⟨0, 1726776352⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1726776350⟩, ⟨0, 1726776352⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1726776350), 0⟩, ⟨(-1726776352), 0⟩, ⟨(-431694088), (-431694082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-863388175), 0⟩, ⟨(-863388176), 0⟩, ⟨(-215847044), (-215847041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3512825558, 4294967296⟩, ⟨(-863388176), 0⟩, ⟨(-215847044), (-89759339)⟩, ⟨0, 43390269⟩, ⟨74850, 5423784⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3230824703, 4310442982⟩, ⟨(-1039514943), (-128048072)⟩, ⟨(-214541858), (-43476521)⟩, ⟨2143945, 52253270⟩, ⟨(-1901804), 5458978⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298767827, 4298767828⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1314
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4310442982⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1315
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (310856739 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(32111 / 400000), prawitzNormalCorrection
