...
namespace FiniteNormalPanel173_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (82851 / 800000)
def radius : Rat := (27617 / 800000)

def j0 : Jet := ⟨⟨444802919, 444802920⟩, ⟨148267639, 148267640⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1397389582, 1397389586⟩, ⟨465796525, 465796529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨454647849, 454647852⟩, ⟨303098564, 303098570⟩, ⟨50516427, 50516429⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-10012), (-10011)⟩, ⟨(-6668), (-6665)⟩, ⟨(-1107), (-1104)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103044, 5103046⟩, ⟨(-6668), (-6665)⟩, ⟨(-1107), (-1104)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨540187, 540188⟩, ⟨359419, 359421⟩, ⟨59431, 59435⟩, ⟨(-158), (-154)⟩, ⟨(-14), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-142625390), (-142625388)⟩, ⟨359419, 359421⟩, ⟨59431, 59435⟩, ⟨(-158), (-154)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15097747), (-15097746)⟩, ⟨(-10027119), (-10027117)⟩, ⟨(-1645873), (-1645870)⟩, ⟨8404, 8407⟩, ⟨685, 689⟩⟩
...
def j19 : Jet := ⟨⟨1416558018, 1416558020⟩, ⟨(-10027119), (-10027117)⟩, ⟨(-1645873), (-1645870)⟩, ⟨8404, 8407⟩, ⟨685, 689⟩⟩
...
def j25 : Jet := ⟨⟨1251, 1252⟩, ⟨833, 835⟩, ⟨137, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850926), (-850924)⟩, ⟨833, 835⟩, ⟨137, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-90076), (-90075)⟩, ⟨(-59963), (-59961)⟩, ⟨(-9937), (-9934)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35701318, 35701320⟩, ⟨(-59963), (-59961)⟩, ⟨(-9937), (-9934)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3779196, 3779198⟩, ⟨2513116, 2513118⟩, ⟨414626, 414629⟩, ⟨(-1407), (-1403)⟩, ⟨(-117), (-113)⟩⟩
...
def j33 : Jet := ⟨⟨(-712048687), (-712048684)⟩, ⟨2513116, 2513118⟩, ⟨414626, 414629⟩, ⟨(-1407), (-1403)⟩, ⟨(-117), (-113)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-75374592), (-75374590)⟩, ⟨(-49983701), (-49983697)⟩, ⟨(-8153713), (-8153710)⟩, ⟨58669, 58672⟩, ⟨4763, 4767⟩⟩
...
def j36 : Jet := ⟨⟨4219592704, 4219592706⟩, ⟨(-49983701), (-49983697)⟩, ⟨(-8153713), (-8153710)⟩, ⟨58669, 58672⟩, ⟨4763, 4767⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨460884398, 460884400⟩, ⟨150365756, 150365761⟩, ⟨(-1622953), (-1622949)⟩, ⟨(-175764), (-175761)⟩, ⟨1133, 1137⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4371688302, 4371688305⟩, ⟨51785362, 51785369⟩, ⟨9061039, 9061045⟩, ⟨146611, 146620⟩, ⟨13584, 13593⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨469117176, 469117179⟩, ⟨158608723, 158608730⟩, ⟨1133370, 1133378⟩, ⟨134483, 134491⟩, ⟨2198, 2209⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-444802920), (-444802919)⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3850164376, 3850164377⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨51239255, 51239256⟩, ⟨34648028, 34648032⟩, ⟨6104840, 6104846⟩, ⟨113084, 113090⟩, ⟨10711, 10718⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4346206551, 4346206552⟩, ⟨34648028, 34648032⟩, ⟨6104840, 6104846⟩, ⟨113084, 113090⟩, ⟨10711, 10718⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320510964, 4320510966⟩, ⟨17221591, 17221594⟩, ⟨3000050, 3000055⟩, ⟨44248, 44253⟩, ⟨4105, 4111⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3873062645, 3873062649⟩, ⟨(-133711382), (-133711376)⟩, ⟨2094842, 2094849⟩, ⟨(-63901), (-63895)⟩, ⟨2151, 2159⟩⟩
...
def j47 : Jet := ⟨⟨3991803327, 3991803337⟩, ⟨1330601103, 1330601113⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3710038448, 3710038467⟩, ⟨2473358954, 2473358980⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3710038448, 3710038467⟩, ⟨2473358954, 2473358980⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3710038467), (-3710038448)⟩, ⟨(-2473358980), (-2473358954)⟩, ⟨(-412226497), (-412226490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1855019234), (-1855019224)⟩, ⟨(-1236679490), (-1236679477)⟩, ⟨(-206113249), (-206113245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2788597045, 2788597057⟩, ⟨(-802939941), (-802939928)⟩, ⟨(-18225316), (-18225309)⟩, ⟨27437692, 27437695⟩, ⟨(-1537770), (-1537769)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2514666655, 2514666670⟩, ⟨(-810880183), (-810880164)⟩, ⟨9922328, 9922344⟩, ⟨24876695, 24876707⟩, ⟨(-2236455), (-2236443)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨296535279, 593070560⟩, ⟨148267639, 148267640⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨931593054, 1863186115⟩, ⟨465796525, 465796529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨202065710, 808262849⟩, ⟨202065708, 404131426⟩, ⟨50516427, 50516429⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-17810), (-4445)⟩, ⟨(-8903), (-4425)⟩, ⟨(-1112), (-1098)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095246, 5108612⟩, ⟨(-8903), (-4425)⟩, ⟨(-1112), (-1098)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨239716, 961382⟩, ⟨238040, 480483⟩, ⟨58881, 59828⟩, ⟨(-210), (-102)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142925861), (-142204194)⟩, ⟨238040, 480483⟩, ⟨58881, 59828⟩, ⟨(-210), (-102)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-26896984), (-6690293)⟩, ⟨(-13437293), (-6599871)⟩, ⟨(-1667093), (-1616103)⟩, ⟨5529, 11278⟩, ⟨669, 700⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1404758781, 1424965473⟩, ⟨(-13437293), (-6599871)⟩, ⟨(-1667093), (-1616103)⟩, ⟨5529, 11278⟩, ⟨669, 700⟩⟩
...
def j72 : Jet := ⟨⟨555, 2227⟩, ⟨552, 1114⟩, ⟨135, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851622), (-849949)⟩, ⟨552, 1114⟩, ⟨135, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-160266), (-39987)⟩, ⟨(-80108), (-39777)⟩, ⟨(-9986), (-9864)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35631128, 35751408⟩, ⟨(-80108), (-39777)⟩, ⟨(-9986), (-9864)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1676340, 6727999⟩, ⟨1661264, 3362129⟩, ⟨409667, 418165⟩, ⟨(-1883), (-925)⟩, ⟨(-119), (-112)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714151543), (-709099883)⟩, ⟨1661264, 3362129⟩, ⟨409667, 418165⟩, ⟨(-1883), (-925)⟩, ⟨(-119), (-112)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-134395008), (-33361085)⟩, ⟨(-67119347), (-32728371)⟩, ⟨(-8302259), (-7945220)⟩, ⟨38457, 78849⟩, ⟨4617, 4871⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4160572288, 4261606211⟩, ⟨(-67119347), (-32728371)⟩, ⟨(-8302259), (-7945220)⟩, ⟨38457, 78849⟩, ⟨4617, 4871⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨304696970, 618159744⟩, ⟨146519294, 153108403⟩, ⟨(-2180495), (-1066305)⟩, ⟨(-179601), (-170376)⟩, ⟨744, 1528⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4328589541, 4433703539⟩, ⟨33242790, 71525567⟩, ⟨8325399, 10001150⟩, ⟨43879, 264059⟩, ⟨9465, 19108⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨307082225, 638127571⟩, ⟨150024625, 168348546⟩, ⟨(-526253), 2914546⟩, ⟨65410, 214569⟩, ⟨(-5153), 10359⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-593070560), (-296535279)⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3701896736, 3998432017⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21955811, 94810221⟩, ⟨21452966, 50024992⟩, ⟨5084031, 7464770⟩, ⟨(-31904), 292242⟩, ⟨2678, 21880⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316923107, 4389777517⟩, ⟨21452966, 50024992⟩, ⟨5084031, 7464770⟩, ⟨(-31904), 292242⟩, ⟨2678, 21880⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305931207, 4342113642⟩, ⟨10610015, 24948809⟩, ⟨2442739, 3709810⟩, ⟨(-37407), 139731⟩, ⟨(-1073), 10437⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3711346695, 4042323262⟩, ⟨(-140750260), (-125419845)⟩, ⟨1244168, 3087406⟩, ⟨(-162893), 45758⟩, ⟨(-5823), 11009⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2661202215, 5322404449⟩, ⟨1330601103, 1330601113⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1648905973, 6595623940⟩, ⟨1648905966, 3297811972⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1648905973, 6595623940⟩, ⟨1648905966, 3297811972⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6595623940), (-1648905973)⟩, ⟨(-3297811972), (-1648905966)⟩, ⟨(-412226497), (-412226490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3297811970), (-824452986)⟩, ⟨(-1648905986), (-824452983)⟩, ⟨(-206113249), (-206113245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1992942632, 3544815176⟩, ⟨(-1360910704), (-382561119)⟩, ⟨(-133396021), 165597310⟩, ⟨(-8952538), 60610548⟩, ⟨(-9790802), 4060059⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1722132100, 3336297545⟩, ⟨(-1397024528), (-388773973)⟩, ⟨(-113800525), 203002869⟩, ⟨(-14965431), 61343702⟩, ⟨(-11316338), 4294359⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨444802919, 444802920⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320510964, 4320510966⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3504
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨296535279, 593070560⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305931207, 4342113642⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3505
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (173906527 / 4294967296)

theorem envelope_integral : (∫ s in ((27617 / 400000) : ℝ)..(27617 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((27617 / 400000) : ℝ)..(27617 / 200000), prawitzNormalCorrection
