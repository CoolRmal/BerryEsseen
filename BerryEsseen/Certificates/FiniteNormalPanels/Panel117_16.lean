...
namespace FiniteNormalPanel117_16
...
def j2 : Jet := ⟨⟨1480827154, 1480827158⟩, ⟨493609051, 493609055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨510562458, 510562461⟩, ⟨340374970, 340374976⟩, ⟨56729161, 56729163⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-11241), (-11240)⟩, ⟨(-7484), (-7482)⟩, ⟨(-1242), (-1239)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101815, 5101817⟩, ⟨(-7484), (-7482)⟩, ⟨(-1242), (-1239)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨606476, 606477⟩, ⟨403427, 403429⟩, ⟨66644, 66648⟩, ⟨(-198), (-195)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-142559101), (-142559099)⟩, ⟨403427, 403429⟩, ⟨66644, 66648⟩, ⟨(-198), (-195)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16946655), (-16946653)⟩, ⟨(-11249813), (-11249811)⟩, ⟨(-1843069), (-1843066)⟩, ⟨10585, 10588⟩, ⟨861, 865⟩⟩
...
def j19 : Jet := ⟨⟨1414709110, 1414709113⟩, ⟨(-11249813), (-11249811)⟩, ⟨(-1843069), (-1843066)⟩, ⟨10585, 10588⟩, ⟨861, 865⟩⟩
...
def j25 : Jet := ⟨⟨1405, 1406⟩, ⟨934, 938⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850772), (-850770)⟩, ⟨934, 938⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-101136), (-101134)⟩, ⟨(-67313), (-67311)⟩, ⟨(-11146), (-11143)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35690258, 35690261⟩, ⟨(-67313), (-67311)⟩, ⟨(-11146), (-11143)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4242664, 4242666⟩, ⟨2820441, 2820443⟩, ⟨464747, 464750⟩, ⟨(-1772), (-1768)⟩, ⟨(-147), (-143)⟩⟩
...
def j33 : Jet := ⟨⟨(-711585219), (-711585216)⟩, ⟨2820441, 2820443⟩, ⟨464747, 464750⟩, ⟨(-1772), (-1768)⟩, ⟨(-147), (-143)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-84589399), (-84589397)⟩, ⟨(-56057655), (-56057652)⟩, ⟨(-9120058), (-9120054)⟩, ⟨73873, 73876⟩, ⟨5979, 5983⟩⟩
...
def j36 : Jet := ⟨⟨4210377897, 4210377899⟩, ⟨(-56057655), (-56057652)⟩, ⟨(-9120058), (-9120054)⟩, ⟨73873, 73876⟩, ⟨5979, 5983⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨487766150, 487766153⟩, ⟨158709983, 158709988⟩, ⟨(-1928368), (-1928365)⟩, ⟨(-208170), (-208167)⟩, ⟨1512, 1516⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4381256152, 4381256155⟩, ⟨58332751, 58332757⟩, ⟨10266842, 10266849⟩, ⟨186172, 186179⟩, ⟨17464, 17474⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨497565708, 497565712⟩, ⟨168523246, 168523253⟩, ⟨1354405, 1354413⟩, ⟨161983, 161992⟩, ⟨2966, 2976⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-471361924), (-471361923)⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3823605372, 3823605373⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨57642262, 57642264⟩, ⟨39046344, 39046348⟩, ⟨6926219, 6926225⟩, ⟨143816, 143822⟩, ⟨13823, 13832⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4352609558, 4352609560⟩, ⟨39046344, 39046348⟩, ⟨6926219, 6926225⟩, ⟨143816, 143822⟩, ⟨13823, 13832⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4323692369, 4323692371⟩, ⟨19393466, 19393469⟩, ⟨3396607, 3396612⟩, ⟨56194, 56199⟩, ⟨5278, 5285⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3849177940, 3849177943⟩, ⟨(-140906397), (-140906390)⟩, ⟨2314375, 2314382⟩, ⟨(-74231), (-74224)⟩, ⟨2642, 2650⟩⟩
...
def j47 : Jet := ⟨⟨3890401594, 3890401604⟩, ⟨1296800531, 1296800541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3523944076, 3523944095⟩, ⟨2349296050, 2349296076⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3523944076, 3523944095⟩, ⟨2349296050, 2349296076⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3523944095), (-3523944076)⟩, ⟨(-2349296076), (-2349296050)⟩, ⟨(-391549348), (-391549341)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1761972048), (-1761972038)⟩, ⟨(-1174648038), (-1174648025)⟩, ⟨(-195774674), (-195774670)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2849669020, 2849669032⟩, ⟨(-779367550), (-779367537)⟩, ⟨(-23318399), (-23318391)⟩, ⟨25809412, 25809415⟩, ⟨(-1233228), (-1233226)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2553892118, 2553892132⟩, ⟨(-791964350), (-791964331)⟩, ⟨6206426, 6206442⟩, ⟨23426356, 23426370⟩, ⟨(-1949312), (-1949297)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨314241282, 628482565⟩, ⟨157120641, 157120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨987218102, 1974436210⟩, ⟨493609051, 493609055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨226916647, 907666597⟩, ⟨226916646, 453833302⟩, ⟨56729161, 56729163⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-19999), (-4990)⟩, ⟨(-9998), (-4965)⟩, ⟨(-1248), (-1230)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5093057, 5108067⟩, ⟨(-9998), (-4965)⟩, ⟨(-1248), (-1230)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨269082, 1079502⟩, ⟨266969, 539489⟩, ⟨65949, 67143⟩, ⟨(-265), (-128)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142896495), (-142086074)⟩, ⟨266969, 539489⟩, ⟨65949, 67143⟩, ⟨(-265), (-128)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-30198688), (-7506854)⟩, ⟨(-15085240), (-7392842)⟩, ⟨(-1869830), (-1805517)⟩, ⟨6953, 14215⟩, ⟨838, 881⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1401457077, 1424148912⟩, ⟨(-15085240), (-7392842)⟩, ⟨(-1869830), (-1805517)⟩, ⟨6953, 14215⟩, ⟨838, 881⟩⟩
...
def j72 : Jet := ⟨⟨624, 2501⟩, ⟨621, 1251⟩, ⟨153, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851553), (-849675)⟩, ⟨621, 1251⟩, ⟨153, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-179961), (-44891)⟩, ⟨(-89949), (-44626)⟩, ⟨(-11208), (-11055)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35611433, 35746504⟩, ⟨(-89949), (-44626)⟩, ⟨(-11208), (-11055)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1881464, 7554402⟩, ⟨1862454, 3774844⟩, ⟨458492, 469210⟩, ⟨(-2374), (-1165)⟩, ⟨(-149), (-141)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713946419), (-708273480)⟩, ⟨1862454, 3774844⟩, ⟨458492, 469210⟩, ⟨(-2374), (-1165)⟩, ⟨(-149), (-141)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-150880152), (-37420318)⟩, ⟨(-75341678), (-36622570)⟩, ⟨(-9307388), (-8857045)⟩, ⟨48320, 99379⟩, ⟨5772, 6130⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4144087144, 4257546978⟩, ⟨(-75341678), (-36622570)⟩, ⟨(-9307388), (-8857045)⟩, ⟨48320, 99379⟩, ⟨5772, 6130⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨322131392, 654694434⟩, ⟨154130871, 161974332⟩, ⟨(-2593286), (-1264645)⟩, ⟨(-213297), (-200968)⟩, ⟨991, 2040⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4332716507, 4451340774⟩, ⟨37269163, 80927711⟩, ⟨9334002, 11468772⟩, ⟨53916, 339751⟩, ⟨11580, 25468⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨324962660, 678530901⟩, ⟨158280816, 180207629⟩, ⟨(-650180), 3524453⟩, ⟨69079, 270601⟩, ⟨(-7144), 14320⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-628482565), (-314241282)⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3666484731, 3980726014⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨24587086, 107196203⟩, ⟨23951452, 56939408⟩, ⟨5627627, 8674733⟩, ⟨(-44110), 381260⟩, ⟨2298, 30127⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4319554382, 4402163499⟩, ⟨23951452, 56939408⟩, ⟨5627627, 8674733⟩, ⟨(-44110), 381260⟩, ⟨2298, 30127⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307243295, 4348235075⟩, ⟨11829018, 28388564⟩, ⟨2686671, 4308763⟩, ⟨(-50391), 182709⟩, ⟨(-2215), 14517⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3676964383, 4030096456⟩, ⟨(-148971234), (-131258212)⟩, ⟨1255005, 3560778⟩, ⟨(-204331), 71057⟩, ⟨(-8737), 15299⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2593601063, 5187202136⟩, ⟨1296800531, 1296800541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1566197367, 6264789496⟩, ⟨1566197366, 3132394766⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1566197367, 6264789496⟩, ⟨1566197366, 3132394766⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6264789496), (-1566197367)⟩, ⟨(-3132394766), (-1566197366)⟩, ⟨(-391549348), (-391549341)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3132394748), (-783098683)⟩, ⟨(-1566197383), (-783098683)⟩, ⟨(-195774674), (-195774670)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2071196486, 3579111448⟩, ⟨(-1305154289), (-377639951)⟩, ⟨(-128716860), 143557976⟩, ⟨(-5974082), 55307237⟩, ⟨(-8313922), 3478234⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1773171990, 3358387473⟩, ⟨(-1348807088), (-386599031)⟩, ⟨(-108632646), 182941407⟩, ⟨(-11837304), 56309859⟩, ⟨(-9855127), 3664805⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4323692369, 4323692371⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2364
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307243295, 4348235075⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2365
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (93530255 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((14633 / 200000) : ℝ)..(14633 / 100000), prawitzNormalCorrection
