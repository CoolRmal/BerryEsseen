...
namespace FiniteNormalPanel38_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (122017 / 400000)
def radius : Rat := (17431 / 400000)

def j0 : Jet := ⟨⟨1310147561, 1310147562⟩, ⟨187163937, 187163938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4115949952, 4115949957⟩, ⟨587992849, 587992853⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3944394180, 3944394190⟩, ⟨1126969762, 1126969774⟩, ⟨80497840, 80497842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨987, 989⟩, ⟨282, 283⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93700), (-93697)⟩, ⟨282, 283⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-86052), (-86049)⟩, ⟨(-24329), (-24325)⟩, ⟨(-1666), (-1661)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5027004, 5027008⟩, ⟨(-24329), (-24325)⟩, ⟨(-1666), (-1661)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4616678, 4616683⟩, ⟨1296707, 1296714⟩, ⟨86302, 86312⟩, ⟨(-885), (-878)⟩, ⟨(-30), (-26)⟩⟩
...
def j16 : Jet := ⟨⟨(-138548899), (-138548893)⟩, ⟨1296707, 1296714⟩, ⟨86302, 86312⟩, ⟨(-885), (-878)⟩, ⟨(-30), (-26)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-127239962), (-127239955)⟩, ⟨(-35163411), (-35163401)⟩, ⟨(-2177231), (-2177217)⟩, ⟨46135, 46146⟩, ⟨1356, 1365⟩⟩
...
def j19 : Jet := ⟨⟨1304415803, 1304415811⟩, ⟨(-35163411), (-35163401)⟩, ⟨(-2177231), (-2177217)⟩, ⟨46135, 46146⟩, ⟨1356, 1365⟩⟩
...
def j25 : Jet := ⟨⟨10777, 10780⟩, ⟨3052, 3055⟩, ⟨208, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841400), (-841396)⟩, ⟨3052, 3055⟩, ⟨208, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-772722), (-772717)⟩, ⟨(-217976), (-217970)⟩, ⟨(-14779), (-14772)⟩, ⟨109, 114⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35018672, 35018678⟩, ⟨(-217976), (-217970)⟩, ⟨(-14779), (-14772)⟩, ⟨109, 114⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨32160302, 32160308⟩, ⟨8988473, 8988482⟩, ⟨585563, 585574⟩, ⟨(-7864), (-7856)⟩, ⟨(-249), (-242)⟩⟩
...
def j33 : Jet := ⟨⟨(-683667581), (-683667574)⟩, ⟨8988473, 8988482⟩, ⟨585563, 585574⟩, ⟨(-7864), (-7856)⟩, ⟨(-249), (-242)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-627863788), (-627863779)⟩, ⟨(-171134859), (-171134845)⟩, ⟨(-9917268), (-9917252)⟩, ⟨314889, 314903⟩, ⟨8681, 8693⟩⟩
...
def j36 : Jet := ⟨⟨3667103508, 3667103517⟩, ⟨(-171134859), (-171134845)⟩, ⟨(-9917268), (-9917252)⟩, ⟨314889, 314903⟩, ⟨8681, 8693⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1250046808, 1250046818⟩, ⟨144880340, 144880353⟩, ⟨(-6900451), (-6900435)⟩, ⟨(-253857), (-253844)⟩, ⟨7615, 7627⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5030330883, 5030330896⟩, ⟨234753365, 234753388⟩, ⟨24559311, 24559337⟩, ⟨1349017, 1349044⟩, ⟨97288, 97311⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1464073793, 1464073810⟩, ⟨238010832, 238010857⟩, ⟨6984891, 6984921⟩, ⟨546592, 546622⟩, ⟨29404, 29432⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1310147562), (-1310147561)⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2984819734, 2984819735⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨499075295, 499075307⟩, ⟨162266856, 162266876⟩, ⟨17951695, 17951721⟩, ⟨1146796, 1146824⟩, ⟨91985, 92010⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4794042591, 4794042603⟩, ⟨162266856, 162266876⟩, ⟨17951695, 17951721⟩, ⟨1146796, 1146824⟩, ⟨91985, 92010⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4537648746, 4537648752⟩, ⟨76794269, 76794279⟩, ⟨7845977, 7845991⟩, ⟨409947, 409962⟩, ⟨29810, 29825⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3153473027, 3153473033⟩, ⟨(-144370637), (-144370626)⟩, ⟨2106117, 2106129⟩, ⟨(-57014), (-57001)⟩, ⟨2850, 2864⟩⟩
...
def j47 : Jet := ⟨⟨8946406961, 8946406971⟩, ⟨1278058135, 1278058143⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨18635345043, 18635345086⟩, ⟨5324384288, 5324384328⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨18635345043, 18635345086⟩, ⟨5324384288, 5324384328⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-18635345086), (-18635345043)⟩, ⟨(-5324384328), (-5324384288)⟩, ⟨(-380313168), (-380313162)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9317672543), (-9317672521)⟩, ⟨(-2662192164), (-2662192144)⟩, ⟨(-190156584), (-190156581)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨490663970, 490663981⟩, ⟨(-304133121), (-304133111)⟩, ⟨72533125, 72533131⟩, ⟨(-6009461), (-6009458)⟩, ⟨(-674451), (-674449)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨360257829, 360257839⟩, ⟨(-239795324), (-239795312)⟩, ⟨63719351, 63719361⟩, ⟨(-7006074), (-7006064)⟩, ⟨(-253270), (-253260)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1122983624, 1497311499⟩, ⟨187163937, 187163938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3527957103, 4703942806⟩, ⟨587992849, 587992853⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2897922257, 5151861795⟩, ⟨965974082, 1287965454⟩, ⟨80497840, 80497842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨725, 1291⟩, ⟨241, 323⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93962), (-93395)⟩, ⟨241, 323⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-112709), (-63015)⟩, ⟨(-28016), (-20617)⟩, ⟨(-1695), (-1627)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5000347, 5050042⟩, ⟨(-28016), (-20617)⟩, ⟨(-1695), (-1627)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3373859, 6057583⟩, ⟨1091013, 1500486⟩, ⟨83282, 88917⟩, ⟨(-1030), (-734)⟩, ⟨(-31), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139791718), (-137107993)⟩, ⟨1091013, 1500486⟩, ⟨83282, 88917⟩, ⟨(-1030), (-734)⟩, ⟨(-31), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-167681746), (-92510204)⟩, ⟨(-41184304), (-29036884)⟩, ⟨(-2318459), (-2013107)⟩, ⟨37942, 54293⟩, ⟨1213, 1487⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1263974019, 1339145562⟩, ⟨(-41184304), (-29036884)⟩, ⟨(-2318459), (-2013107)⟩, ⟨37942, 54293⟩, ⟨1213, 1487⟩⟩
...
def j72 : Jet := ⟨⟨7897, 14112⟩, ⟨2592, 3512⟩, ⟨205, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844280), (-838064)⟩, ⟨2592, 3512⟩, ⟨205, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1012724), (-565462)⟩, ⟨(-251433), (-184274)⟩, ⟨(-15104), (-14395)⟩, ⟨91, 131⟩, ⟨0, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34778670, 35225933⟩, ⟨(-251433), (-184274)⟩, ⟨(-15104), (-14395)⟩, ⟨91, 131⟩, ⟨0, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨23466041, 42253905⟩, ⟨7520416, 10439143⟩, ⟨558316, 609062⟩, ⟨(-9182), (-6532)⟩, ⟨(-264), (-223)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692361842), (-673573977)⟩, ⟨7520416, 10439143⟩, ⟨558316, 609062⟩, ⟨(-9182), (-6532)⟩, ⟨(-264), (-223)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-830495852), (-454477271)⟩, ⟨(-202549751), (-138970553)⟩, ⟨(-10908385), (-8763323)⟩, ⟨255505, 373893⟩, ⟨7393, 9797⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3464471444, 3840490025⟩, ⟨(-202549751), (-138970553)⟩, ⟨(-10908385), (-8763323)⟩, ⟨255505, 373893⟩, ⟨7393, 9797⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1038249143, 1466661723⟩, ⟨127935565, 159481341⟩, ⟨(-8177473), (-5628828)⟩, ⟨(-286238), (-216136)⟩, ⟨6190, 9062⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4803226659, 5324547878⟩, ⟨173807784, 311298813⟩, ⟨17249462, 34965138⟩, ⟨502405, 2670163⟩, ⟨13649, 243139⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1161113838, 1818246806⟩, ⟨185090885, 304015375⟩, ⟨(-790673), 17204287⟩, ⟨(-312294), 1740650⟩, ⟨(-62134), 162061⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1497311499), (-1122983624)⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2797655797, 3171983672⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨313898861, 769743102⟩, ⟨100076006, 257405912⟩, ⟨7307006, 36086104⟩, ⟨(-376352), 3909366⟩, ⟨(-99990), 452553⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4608866157, 5064710398⟩, ⟨100076006, 257405912⟩, ⟨7307006, 36086104⟩, ⟨(-376352), 3909366⟩, ⟨(-99990), 452553⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4449149291, 4663986013⟩, ⟨46078951, 124242850⟩, ⟨1709595, 17179169⟩, ⟨(-661386), 1869240⟩, ⟨(-133628), 236577⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2898086864, 3444516911⟩, ⟨(-173229945), (-102125108)⟩, ⟨(-4300598), 10679413⟩, ⟨(-1237083), 1306001⟩, ⟨(-180146), 203543⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7668348826, 10224465106⟩, ⟨1278058135, 1278058143⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13691273917, 24340042543⟩, ⟨4563757962, 6085010660⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13691273917, 24340042543⟩, ⟨4563757962, 6085010660⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-24340042543), (-13691273917)⟩, ⟨(-6085010660), (-4563757962)⟩, ⟨(-380313168), (-380313162)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12170021272), (-6845636958)⟩, ⟨(-3042505330), (-2281878981)⟩, ⟨(-190156584), (-190156581)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨252559111, 872467294⟩, ⟨(-618045776), (-134182471)⟩, ⟨(-2982869), 207726380⟩, ⟨(-45089770), 18946699⟩, ⟨(-7953874), 8051301⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨170417651, 699709251⟩, ⟨(-530855403), (-96546737)⟩, ⟨(-75270), 193691466⟩, ⟨(-46327848), 16199510⟩, ⟨(-7575631), 9011549⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1310147561, 1310147562⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4537648746, 4537648752⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified748
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1122983624, 1497311499⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4449149291, 4663986013⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified749
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (16703253 / 2147483648)

theorem envelope_integral : (∫ s in ((52293 / 200000) : ℝ)..(17431 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((52293 / 200000) : ℝ)..(17431 / 50000), prawitzNormalCorrection
