...
namespace FiniteNormalPanel171_17
...
def j2 : Jet := ⟨⟨1306665768, 1306665772⟩, ⟨435555256, 435555260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨397529320, 397529323⟩, ⟨265019546, 265019552⟩, ⟨44169924, 44169926⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-8755), (-8754)⟩, ⟨(-5831), (-5829)⟩, ⟨(-968), (-965)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104301, 5104303⟩, ⟨(-5831), (-5829)⟩, ⟨(-968), (-965)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨472438, 472440⟩, ⟨314419, 314421⟩, ⟨52043, 52046⟩, ⟨(-120), (-117)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142693139), (-142693136)⟩, ⟨314419, 314421⟩, ⟨52043, 52046⟩, ⟨(-120), (-117)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13207251), (-13207249)⟩, ⟨(-8775733), (-8775731)⟩, ⟨(-1443256), (-1443252)⟩, ⟨6432, 6436⟩, ⟨526, 529⟩⟩
...
def j19 : Jet := ⟨⟨1418448514, 1418448517⟩, ⟨(-8775733), (-8775731)⟩, ⟨(-1443256), (-1443252)⟩, ⟨6432, 6436⟩, ⟨526, 529⟩⟩
...
def j25 : Jet := ⟨⟨1094, 1095⟩, ⟨728, 730⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851083), (-851081)⟩, ⟨728, 730⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-78774), (-78773)⟩, ⟨(-52449), (-52447)⟩, ⟨(-8698), (-8694)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35712620, 35712622⟩, ⟨(-52449), (-52447)⟩, ⟨(-8698), (-8694)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3305453, 3305454⟩, ⟨2198780, 2198782⟩, ⟨363229, 363233⟩, ⟨(-1076), (-1073)⟩, ⟨(-91), (-87)⟩⟩
...
def j33 : Jet := ⟨⟨(-712522430), (-712522428)⟩, ⟨2198780, 2198782⟩, ⟨363229, 363233⟩, ⟨(-1076), (-1073)⟩, ⟨(-91), (-87)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-65948945), (-65948943)⟩, ⟨(-43762452), (-43762449)⟩, ⟨(-7158368), (-7158364)⟩, ⟨44924, 44928⟩, ⟨3659, 3662⟩⟩
...
def j36 : Jet := ⟨⟨4229018351, 4229018353⟩, ⟨(-43762452), (-43762449)⟩, ⟨(-7158368), (-7158364)⟩, ⟨44924, 44928⟩, ⟨3659, 3662⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨431537189, 431537192⟩, ⟨141175871, 141175876⟩, ⟨(-1329038), (-1329035)⟩, ⟨(-144406), (-144402)⟩, ⟨812, 814⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4361944672, 4361944675⟩, ⟨45137987, 45137992⟩, ⟨7850458, 7850465⟩, ⟨111300, 111308⟩, ⟨10181, 10189⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨438266746, 438266750⟩, ⟨147912663, 147912672⟩, ⟨922699, 922706⟩, ⟨108601, 108610⟩, ⟨1556, 1564⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-415924633), (-415924632)⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3879042663, 3879042664⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨44721583, 44721585⟩, ⟨30186586, 30186590⟩, ⟨5282211, 5282216⟩, ⟨85714, 85720⟩, ⟨7994, 8001⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4339688879, 4339688881⟩, ⟨30186586, 30186590⟩, ⟨5282211, 5282216⟩, ⟨85714, 85720⟩, ⟨7994, 8001⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317270180, 4317270182⟩, ⟨15015321, 15015324⟩, ⟨2601350, 2601354⟩, ⟨33587, 33592⟩, ⟨3075, 3081⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3899185735, 3899185739⟩, ⟨(-125800246), (-125800240)⟩, ⟨1864740, 1864745⟩, ⟨(-53638), (-53632)⟩, ⟨1692, 1699⟩⟩
...
def j47 : Jet := ⟨⟨4351625756, 4351625768⟩, ⟨1450541918, 1450541930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4409031644, 4409031669⟩, ⟨2939354428, 2939354462⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4409031644, 4409031669⟩, ⟨2939354428, 2939354462⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4409031669), (-4409031644)⟩, ⟨(-2939354462), (-2939354428)⟩, ⟨(-489892413), (-489892404)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2204515835), (-2204515822)⟩, ⟨(-1469677231), (-1469677214)⟩, ⟨(-244946207), (-244946202)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2570666227, 2570666250⟩, ⟨(-879645734), (-879645715)⟩, ⟨3893553, 3893564⟩, ⟨33000598, 33000602⟩, ⟨(-2934113), (-2934111)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2333779139, 2333779164⟩, ⟨(-873881520), (-873881496)⟩, ⟨30415818, 30415836⟩, ⟨29431526, 29431539⟩, ⟨(-3616642), (-3616630)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨277283088, 554566178⟩, ⟨138641544, 138641545⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨871110512, 1742221031⟩, ⟨435555256, 435555260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨176679697, 706718798⟩, ⟨176679696, 353359402⟩, ⟨44169924, 44169926⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨44, 178⟩, ⟨44, 89⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94643), (-94508)⟩, ⟨44, 89⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-15574), (-3887)⟩, ⟨(-7786), (-3872)⟩, ⟨(-973), (-961)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097482, 5109170⟩, ⟨(-7786), (-3872)⟩, ⟨(-973), (-961)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨209692, 840693⟩, ⟨208410, 420188⟩, ⟨51621, 52346⟩, ⟨(-162), (-77)⟩, ⟨(-11), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142955885), (-142324883)⟩, ⟨208410, 420188⟩, ⟨51621, 52346⟩, ⟨(-162), (-77)⟩, ⟨(-11), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-23522790), (-5854740)⟩, ⟨(-11752822), (-5785599)⟩, ⟨(-1459479), (-1420500)⟩, ⟨4239, 8626⟩, ⟨514, 536⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408132975, 1425801026⟩, ⟨(-11752822), (-5785599)⟩, ⟨(-1459479), (-1420500)⟩, ⟨4239, 8626⟩, ⟨514, 536⟩⟩
...
def j72 : Jet := ⟨⟨486, 1947⟩, ⟨484, 974⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851691), (-850229)⟩, ⟨484, 974⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-140143), (-34975)⟩, ⟨(-70053), (-34814)⟩, ⟨(-8736), (-8641)⟩, ⟨7, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35651251, 35756420⟩, ⟨(-70053), (-34814)⟩, ⟨(-8736), (-8641)⟩, ⟨7, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1466565, 5883569⟩, ⟨1455038, 2940353⟩, ⟨359439, 365937⟩, ⟨(-1440), (-709)⟩, ⟨(-91), (-85)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714361318), (-709944313)⟩, ⟨1455038, 2940353⟩, ⟨359439, 365937⟩, ⟨(-1440), (-709)⟩, ⟨(-91), (-85)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-117545150), (-29204587)⟩, ⟨(-58712721), (-28720763)⟩, ⟨(-7271932), (-6999020)⟩, ⟨29512, 60317⟩, ⟨3562, 3732⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4177422146, 4265762709⟩, ⟨(-58712721), (-28720763)⟩, ⟨(-7271932), (-6999020)⟩, ⟨29512, 60317⟩, ⟨3562, 3732⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨285599249, 578365413⟩, ⟨138032180, 143417912⟩, ⟨(-1783888), (-874828)⟩, ⟨(-147148), (-140553)⟩, ⟨533, 1093⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4324371825, 4415819956⟩, ⟨29115369, 62063349⟩, ⟨7291211, 8559216⟩, ⟨34421, 197788⟩, ⟨7451, 13788⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨287554540, 594639577⟩, ⟨140913249, 155810960⟩, ⟨(-413533), 2344203⟩, ⟨59546, 165001⟩, ⟨(-3546), 7149⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-554566178), (-277283088)⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3740401118, 4017684208⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19252210, 82328038⟩, ⟨18868708, 43144154⟩, ⟨4508703, 6301555⟩, ⟨(-22032), 215774⟩, ⟨2698, 15232⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314219506, 4377295334⟩, ⟨18868708, 43144154⟩, ⟨4508703, 6301555⟩, ⟨(-22032), 215774⟩, ⟨2698, 15232⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304582637, 4335935921⟩, ⟨9345212, 21523891⟩, ⟨2179627, 3133596⟩, ⟨(-26661), 102915⟩, ⟨(-310), 7181⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3748774926, 4056007899⟩, ⟨(-131825455), (-118817618)⟩, ⟨1203401, 2629629⟩, ⟨(-126093), 25913⟩, ⟨(-3613), 7579⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2901083837, 5802167697⟩, ⟨1450541918, 1450541930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1959569619, 7838278540⟩, ⟨1959569618, 3919139286⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1959569619, 7838278540⟩, ⟨1959569618, 3919139286⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7838278540), (-1959569619)⟩, ⟨(-3919139286), (-1959569618)⟩, ⟨(-489892413), (-489892404)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3919139270), (-979784809)⟩, ⟨(-1959569643), (-979784809)⟩, ⟨(-244946207), (-244946202)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1724519083, 3418903938⟩, ⟨(-1559867610), (-393404066)⟩, ⟨(-150111013), 257492114⟩, ⟨(-24202596), 82136466⟩, ⟨(-16711161), 7041086⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1505211437, 3228686140⟩, ⟨(-1578017585), (-391082499)⟩, ⟨(-130392807), 293136287⟩, ⟨(-31814658), 82084394⟩, ⟨(-18406613), 7601674⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317270180, 4317270182⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3472
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304582637, 4335935921⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3473
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (151421485 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((807 / 12500) : ℝ)..(807 / 6250), prawitzNormalCorrection
