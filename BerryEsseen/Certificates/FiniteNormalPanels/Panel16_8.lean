...
namespace FiniteNormalPanel16_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (276297 / 800000)
def radius : Rat := (39471 / 800000)

def j0 : Jet := ⟨⟨1483358223, 1483358224⟩, ⟨211908317, 211908318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4660107295, 4660107300⟩, ⟨665729611, 665729616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5056289956, 5056289968⟩, ⟨1444654266, 1444654282⟩, ⟨103189590, 103189592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1265, 1267⟩, ⟨361, 362⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93422), (-93419)⟩, ⟨361, 362⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-109982), (-109978)⟩, ⟨(-31000), (-30995)⟩, ⟨(-2095), (-2091)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5003074, 5003079⟩, ⟨(-31000), (-30995)⟩, ⟨(-2095), (-2091)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5889915, 5889922⟩, ⟨1646336, 1646346⟩, ⟨107307, 107317⟩, ⟨(-1432), (-1425)⟩, ⟨(-46), (-41)⟩⟩
...
def j16 : Jet := ⟨⟨(-137275662), (-137275654)⟩, ⟨1646336, 1646346⟩, ⟨107307, 107317⟩, ⟨(-1432), (-1425)⟩, ⟨(-46), (-41)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-161609043), (-161609032)⟩, ⟨(-44235849), (-44235832)⟩, ⟨(-2618055), (-2618038)⟩, ⟨73961, 73976⟩, ⟨2041, 2052⟩⟩
...
def j19 : Jet := ⟨⟨1270046722, 1270046734⟩, ⟨(-44235849), (-44235832)⟩, ⟨(-2618055), (-2618038)⟩, ⟨73961, 73976⟩, ⟨2041, 2052⟩⟩
...
def j22 : Jet := ⟨⟨(-128), (-125)⟩, ⟨(-37), (-35)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11707, 11711⟩, ⟨(-37), (-35)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨13782, 13787⟩, ⟨3893, 3899⟩, ⟨264, 269⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-838395), (-838389)⟩, ⟨3893, 3899⟩, ⟨264, 269⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-987009), (-987001)⟩, ⟨(-277420), (-277409)⟩, ⟨(-18525), (-18513)⟩, ⟨177, 185⟩, ⟨2, 7⟩⟩
...
def j30 : Jet := ⟨⟨34804385, 34804394⟩, ⟨(-277420), (-277409)⟩, ⟨(-18525), (-18513)⟩, ⟨177, 185⟩, ⟨2, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨40973784, 40973795⟩, ⟨11380199, 11380217⟩, ⟨721077, 721097⟩, ⟨(-12690), (-12673)⟩, ⟨(-385), (-372)⟩⟩
...
def j33 : Jet := ⟨⟨(-674854099), (-674854087)⟩, ⟨11380199, 11380217⟩, ⟨721077, 721097⟩, ⟨(-12690), (-12673)⟩, ⟨(-385), (-372)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-794478229), (-794478212)⟩, ⟨(-213596337), (-213596307)⟩, ⟨(-11537107), (-11537073)⟩, ⟨501018, 501048⟩, ⟨12601, 12626⟩⟩
...
def j36 : Jet := ⟨⟨3500489067, 3500489084⟩, ⟨(-213596337), (-213596307)⟩, ⟨(-11537107), (-11537073)⟩, ⟨501018, 501048⟩, ⟨12601, 12626⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1378020735, 1378020751⟩, ⟨148863509, 148863533⟩, ⟨(-9697288), (-9697265)⟩, ⟨(-325557), (-325535)⟩, ⟨13678, 13694⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5269761919, 5269761945⟩, ⟨321555546, 321555597⟩, ⟨36989317, 36989377⟩, ⟨2562551, 2562608⟩, ⟨213239, 213289⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1690779159, 1690779188⟩, ⟨285819512, 285819561⟩, ⟨11114759, 11114813⟩, ⟨978767, 978821⟩, ⟨66125, 66169⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1483358224), (-1483358223)⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2811609072, 2811609073⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨665600915, 665600939⟩, ⟨225034390, 225034434⟩, ⟨27771571, 27771625⟩, ⟨2249930, 2249984⟩, ⟨211093, 211140⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4960568211, 4960568235⟩, ⟨225034390, 225034434⟩, ⟨27771571, 27771625⟩, ⟨2249930, 2249984⟩, ⟨211093, 211140⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4615785765, 4615785777⟩, ⟨104696729, 104696750⟩, ⟨11733275, 11733303⟩, ⟨780635, 780663⟩, ⟨65590, 65614⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3021626065, 3021626075⟩, ⟨(-159199613), (-159199596)⟩, ⟨2515332, 2515353⟩, ⟨(-67881), (-67860)⟩, ⟨4420, 4438⟩⟩
...
def j47 : Jet := ⟨⟨6932560767, 6932560775⟩, ⟨990365821, 990365827⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11189933584, 11189933610⟩, ⟨3197123870, 3197123896⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11189933584, 11189933610⟩, ⟨3197123870, 3197123896⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11189933610), (-11189933584)⟩, ⟨(-3197123896), (-3197123870)⟩, ⟨(-228365993), (-228365990)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5594966805), (-5594966792)⟩, ⟨(-1598561948), (-1598561935)⟩, ⟨(-114182997), (-114182995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1167382675, 1167382691⟩, ⟨(-434493076), (-434493065)⟩, ⟨49822680, 49822685⟩, ⟨1519514, 1519516⟩, ⟨(-803665), (-803663)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨821285396, 821285411⟩, ⟨(-348948520), (-348948505)⟩, ⟨51840436, 51840451⟩, ⟨(-1050649), (-1050636)⟩, ⟨(-584482), (-584467)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1271449906, 1695266542⟩, ⟨211908317, 211908318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3994377683, 5325836915⟩, ⟨665729611, 665729616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3714825276, 6604133837⟩, ⟨1238275086, 1651033464⟩, ⟨103189590, 103189592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨929, 1655⟩, ⟨309, 414⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93758), (-93031)⟩, ⟨309, 414⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-144167), (-80464)⟩, ⟨(-35775), (-26184)⟩, ⟨(-2143), (-2035)⟩, ⟨14, 20⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4968889, 5032593⟩, ⟨(-35775), (-26184)⟩, ⟨(-2143), (-2035)⟩, ⟨14, 20⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4297717, 7738341⟩, ⟨1377562, 1911939⟩, ⟨102332, 111603⟩, ⟨(-1672), (-1184)⟩, ⟨(-48), (-38)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138867860), (-135427235)⟩, ⟨1377562, 1911939⟩, ⟨102332, 111603⟩, ⟨(-1672), (-1184)⟩, ⟨(-48), (-38)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-213529434), (-117134422)⟩, ⟨(-52190871), (-36104924)⟩, ⟨(-2850727), (-2347156)⟩, ⟨60028, 87814⟩, ⟨1741, 2309⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1218126331, 1314521344⟩, ⟨(-52190871), (-36104924)⟩, ⟨(-2850727), (-2347156)⟩, ⟨60028, 87814⟩, ⟨1741, 2309⟩⟩
...
def j70 : Jet := ⟨⟨(-167), (-92)⟩, ⟨(-42), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11668, 11744⟩, ⟨(-42), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨10091, 18059⟩, ⟨3298, 4490⟩, ⟨258, 274⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842086), (-834117)⟩, ⟨3298, 4490⟩, ⟨258, 274⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1294830), (-721448)⟩, ⟨(-320856), (-233577)⟩, ⟨(-19059), (-17891)⟩, ⟨146, 214⟩, ⟨2, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34496564, 35069947⟩, ⟨(-320856), (-233577)⟩, ⟨(-19059), (-17891)⟩, ⟨146, 214⟩, ⟨2, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨29836946, 53925120⟩, ⟨9452285, 13279254⟩, ⟨676157, 759764⟩, ⟨(-14910), (-10439)⟩, ⟨(-415), (-335)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-685990937), (-661902762)⟩, ⟨9452285, 13279254⟩, ⟨676157, 759764⟩, ⟨(-14910), (-10439)⟩, ⟨(-415), (-335)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1054810351), (-572496352)⟩, ⟨(-255527070), (-170413341)⟩, ⟨(-13171414), (-9629734)⟩, ⟨399111, 602078⟩, ⟨9874, 14956⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3240156945, 3722470944⟩, ⟨(-255527070), (-170413341)⟩, ⟨(-13171414), (-9629734)⟩, ⟨399111, 602078⟩, ⟨9874, 14956⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1132873965, 1630030177⟩, ⟨124094704, 170175706⟩, ⟨(-11624656), (-7779230)⟩, ⟨(-386044), (-254923)⟩, ⟨10923, 16476⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4955510560, 5693163754⟩, ⟨226861436, 448977467⟩, ⟨23205140, 58550534⟩, ⟨728372, 5832163⟩, ⟨(-2436), 654908⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1307103991, 2160675061⟩, ⟨203018549, 395971580⟩, ⟨(-2733496), 31034961⟩, ⟨(-864322), 3828297⟩, ⟨(-166107), 445980⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1695266542), (-1271449906)⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2599700754, 3023517390⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨397796007, 1086973753⟩, ⟨123570838, 398403928⟩, ⟨6846183, 67731932⟩, ⟨(-1373658), 9574310⟩, ⟨(-346252), 1378872⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4692763303, 5381941049⟩, ⟨123570838, 398403928⟩, ⟨6846183, 67731932⟩, ⟨(-1373658), 9574310⟩, ⟨(-346252), 1378872⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4489461539, 4807833275⟩, ⟨55194583, 190572058⟩, ⟨(-769979), 32059524⟩, ⟨(-2017962), 4612449⟩, ⟨(-475890), 747979⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2717426174, 3384558372⟩, ⟨(-203803756), (-87347883)⟩, ⟨(-9944629), 19845632⟩, ⟨(-3002357), 3285005⟩, ⟨(-562585), 626117⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5942194946, 7922926601⟩, ⟨990365821, 990365827⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8221175702, 14615423495⟩, ⟨2740391890, 3653855882⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8221175702, 14615423495⟩, ⟨2740391890, 3653855882⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14615423495), (-8221175702)⟩, ⟨(-3653855882), (-2740391890)⟩, ⟨(-228365993), (-228365990)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7307711748), (-4110587851)⟩, ⟨(-1826927941), (-1370195945)⟩, ⟨(-114182997), (-114182995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨783475649, 1649336571⟩, ⟨(-701569735), (-249947225)⟩, ⟨(-3978577), 128382603⟩, ⟨(-13773200), 12998411⟩, ⟨(-3088812), 1517545⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨495705109, 1299724891⟩, ⟨(-631121153), (-174075380)⟩, ⟨(-1870890), 142080964⟩, ⟨(-21340339), 13317835⟩, ⟨(-4100769), 3173513⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1483358223, 1483358224⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4615785765, 4615785777⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified324
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1271449906, 1695266542⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4489461539, 4807833275⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified325
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (82810185 / 4294967296)

theorem envelope_integral : (∫ s in ((118413 / 400000) : ℝ)..(39471 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((118413 / 400000) : ℝ)..(39471 / 100000), prawitzNormalCorrection
