...
namespace FiniteNormalPanel61_20

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (52401 / 400000)
def radius : Rat := (17467 / 400000)

def j0 : Jet := ⟨⟨562651453, 562651454⟩, ⟨187550484, 187550485⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1767621671, 1767621675⟩, ⟨589207222, 589207226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨727476173, 727476177⟩, ⟨484984112, 484984120⟩, ⟨80830685, 80830687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨182, 183⟩, ⟨121, 122⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94505), (-94503)⟩, ⟨121, 122⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-16008), (-16006)⟩, ⟨(-10652), (-10650)⟩, ⟨(-1763), (-1760)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097048, 5097051⟩, ⟨(-10652), (-10650)⟩, ⟨(-1763), (-1760)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨863331, 863333⟩, ⟨573749, 573752⟩, ⟨94423, 94426⟩, ⟨(-401), (-396)⟩, ⟨(-34), (-31)⟩⟩
...
def j16 : Jet := ⟨⟨(-142302246), (-142302243)⟩, ⟨573749, 573752⟩, ⟨94423, 94426⟩, ⟨(-401), (-396)⟩, ⟨(-34), (-31)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-24102977), (-24102975)⟩, ⟨(-15971471), (-15971468)⟩, ⟨(-2597329), (-2597326)⟩, ⟨21391, 21394⟩, ⟨1725, 1729⟩⟩
...
def j19 : Jet := ⟨⟨1407552788, 1407552791⟩, ⟨(-15971471), (-15971468)⟩, ⟨(-2597329), (-2597326)⟩, ⟨21391, 21394⟩, ⟨1725, 1729⟩⟩
...
def j25 : Jet := ⟨⟨2001, 2002⟩, ⟨1331, 1333⟩, ⟨219, 222⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850176), (-850174)⟩, ⟨1331, 1333⟩, ⟨219, 222⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-144002), (-144001)⟩, ⟨(-95777), (-95774)⟩, ⟨(-15814), (-15811)⟩, ⟨48, 52⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35647392, 35647394⟩, ⟨(-95777), (-95774)⟩, ⟨(-15814), (-15811)⟩, ⟨48, 52⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6037910, 6037911⟩, ⟨4009050, 4009052⟩, ⟨657383, 657387⟩, ⟨(-3581), (-3578)⟩, ⟨(-293), (-290)⟩⟩
...
def j33 : Jet := ⟨⟨(-709789973), (-709789971)⟩, ⟨4009050, 4009052⟩, ⟨657383, 657387⟩, ⟨(-3581), (-3578)⟩, ⟨(-293), (-290)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-120223336), (-120223334)⟩, ⟨(-79469844), (-79469840)⟩, ⟨(-12794105), (-12794101)⟩, ⟨149073, 149076⟩, ⟨11916, 11919⟩⟩
...
def j36 : Jet := ⟨⟨4174743960, 4174743962⟩, ⟨(-79469844), (-79469840)⟩, ⟨(-12794105), (-12794101)⟩, ⟨149073, 149076⟩, ⟨11916, 11919⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨579287486, 579287490⟩, ⟨186522665, 186522670⟩, ⟨(-3260003), (-3259999)⟩, ⟨(-347513), (-347510)⟩, ⟨3643, 3647⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4418652794, 4418652797⟩, ⟨84112853, 84112859⟩, ⟨15142754, 15142761⟩, ⟨388243, 388251⟩, ⟨38176, 38184⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨595969676, 595969681⟩, ⟨203238896, 203238904⟩, ⟨2341377, 2341385⟩, ⟨288620, 288629⟩, ⟨7456, 7468⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-562651454), (-562651453)⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3732315842, 3732315843⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨82696754, 82696756⟩, ⟨56402858, 56402864⟩, ⟨10267091, 10267097⟩, ⟨301684, 301692⟩, ⟨30658, 30667⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4377664050, 4377664052⟩, ⟨56402858, 56402864⟩, ⟨10267091, 10267097⟩, ⟨301684, 301692⟩, ⟨30658, 30667⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4336118532, 4336118534⟩, ⟨27933787, 27933791⟩, ⟨4994849, 4994854⟩, ⟨117232, 117238⟩, ⟨11550, 11557⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3768076163, 3768076166⟩, ⟨(-165073066), (-165073060)⟩, ⟨3120712, 3120718⟩, ⟨(-116239), (-116232)⟩, ⟨4916, 4925⟩⟩
...
def j47 : Jet := ⟨⟨3324102197, 3324102205⟩, ⟨1108034063, 1108034071⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2572698382, 2572698396⟩, ⟨1715132250, 1715132268⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2572698382, 2572698396⟩, ⟨1715132250, 1715132268⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2572698396), (-2572698382)⟩, ⟨(-1715132268), (-1715132250)⟩, ⟨(-285855379), (-285855374)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1286349198), (-1286349191)⟩, ⟨(-857566134), (-857566125)⟩, ⟨(-142927690), (-142927687)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3183376508, 3183376520⟩, ⟨(-635617389), (-635617379)⟩, ⟨(-42480112), (-42480105)⟩, ⟨16928661, 16928663⟩, ⟨(-138202), (-138201)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2792851332, 2792851346⟩, ⟨(-679992247), (-679992231)⟩, ⟨(-10526412), (-10526397)⟩, ⟨15936602, 15936614⟩, ⟨(-781908), (-781894)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨375100968, 750201938⟩, ⟨187550484, 187550485⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1178414445, 2356828898⟩, ⟨589207222, 589207226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨323322742, 1293290978⟩, ⟨323322742, 646645492⟩, ⟨80830685, 80830687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨80, 325⟩, ⟨80, 163⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94607), (-94361)⟩, ⟨80, 163⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-28488), (-7103)⟩, ⟨(-14238), (-7053)⟩, ⟨(-1774), (-1743)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5084568, 5105954⟩, ⟨(-14238), (-7053)⟩, ⟨(-1774), (-1743)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨382763, 1537494⟩, ⟨378475, 768217⟩, ⟨93011, 95433⟩, ⟨(-536), (-260)⟩, ⟨(-34), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142782814), (-141628082)⟩, ⟨378475, 768217⟩, ⟨93011, 95433⟩, ⟨(-536), (-260)⟩, ⟨(-34), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-42994443), (-10661683)⟩, ⟨(-21468731), (-10430359)⟩, ⟨(-2651661), (-2521021)⟩, ⟨13961, 28808⟩, ⟨1658, 1776⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1388661322, 1420994083⟩, ⟨(-21468731), (-10430359)⟩, ⟨(-2651661), (-2521021)⟩, ⟨13961, 28808⟩, ⟨1658, 1776⟩⟩
...
def j72 : Jet := ⟨⟨888, 3562⟩, ⟨882, 1781⟩, ⟨218, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851289), (-848614)⟩, ⟨882, 1781⟩, ⟨218, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-256339), (-63883)⟩, ⟨(-128104), (-63346)⟩, ⟨(-15940), (-15633)⟩, ⟨31, 68⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35535055, 35727512⟩, ⟨(-128104), (-63346)⟩, ⟨(-15940), (-15633)⟩, ⟨31, 68⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2675059, 10758189⟩, ⟨2636484, 5374327⟩, ⟨644676, 666443⟩, ⟨(-4809), (-2347)⟩, ⟨(-298), (-281)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713152824), (-705069693)⟩, ⟨2636484, 5374327⟩, ⟨644676, 666443⟩, ⟨(-4809), (-2347)⟩, ⟨(-298), (-281)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-214742989), (-53077253)⟩, ⟨(-107173022), (-51458947)⟩, ⟨(-13174434), (-12259482)⟩, ⟨96699, 201308⟩, ⟨11317, 12346⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4080224307, 4241890043⟩, ⟨(-107173022), (-51458947)⟩, ⟨(-13174434), (-12259482)⟩, ⟨96699, 201308⟩, ⟨11317, 12346⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨381008386, 779759120⟩, ⟨178723398, 192077994⟩, ⟨(-4400277), (-2122588)⟩, ⟨(-359940), (-330038)⟩, ⟨2369, 4928⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4348708685, 4521012250⟩, ⟨52754778, 118750959⟩, ⟨13208172, 17716840⟩, ⟨98141, 745729⟩, ⟨20568, 63484⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨385775807, 820797993⟩, ⟨185639597, 223746549⟩, ⟨(-1264917), 6378116⟩, ⟨57781, 567478⟩, ⟨(-19799), 39485⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-750201938), (-375100968)⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3544765358, 3919866328⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨34650548, 156860181⟩, ⟨33348456, 85519030⟩, ⟨7540353, 14093895⟩, ⟨(-121414), 881436⟩, ⟨(-4453), 83690⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4329617844, 4451827477⟩, ⟨33348456, 85519030⟩, ⟨7540353, 14093895⟩, ⟨(-121414), 881436⟩, ⟨(-4453), 83690⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4312257766, 4372694070⟩, ⟨16377835, 42588067⟩, ⟨3495765, 6987592⟩, ⟨(-129474), 425675⟩, ⟨(-12084), 41540⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3559035701, 3990804835⟩, ⟨(-177427501), (-149436876)⟩, ⟨1025444, 5662152⟩, ⟨(-423298), 235848⟩, ⟨(-29618), 43567⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2216068127, 4432136269⟩, ⟨1108034063, 1108034071⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1143421498, 4573686027⟩, ⟨1143421498, 2286843022⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1143421498, 4573686027⟩, ⟨1143421498, 2286843022⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4573686027), (-1143421498)⟩, ⟨(-2286843022), (-1143421498)⟩, ⟨(-285855379), (-285855374)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2286843014), (-571710749)⟩, ⟨(-1143421511), (-571710749)⟩, ⟨(-142927690), (-142927687)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2521860211, 3759673654⟩, ⟨(-1000913729), (-335689305)⟩, ⟨(-102772117), 49311086⟩, ⟨3071442, 31325689⟩, ⟨(-2905396), 1607812⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2089745952, 3493419801⟩, ⟨(-1085344901), (-365914108)⟩, ⟨(-83212061), 92123726⟩, ⟨(-1181981), 33479137⟩, ⟨(-4210100), 1588877⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨562651453, 562651454⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4336118532, 4336118534⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1214
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨375100968, 750201938⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4312257766, 4372694070⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1215
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (243634985 / 4294967296)

theorem envelope_integral : (∫ s in ((17467 / 200000) : ℝ)..(17467 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((17467 / 200000) : ℝ)..(17467 / 100000), prawitzNormalCorrection
