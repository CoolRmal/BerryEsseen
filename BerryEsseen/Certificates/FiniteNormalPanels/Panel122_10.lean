...
namespace FiniteNormalPanel122_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (82497 / 800000)
def radius : Rat := (27499 / 800000)

def j0 : Jet := ⟨⟨442902396, 442902397⟩, ⟨147634132, 147634133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1391418913, 1391418917⟩, ⟨463806304, 463806308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨450770974, 450770977⟩, ⟨300513982, 300513986⟩, ⟨50085663, 50085665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨112, 113⟩, ⟨75, 76⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94575), (-94573)⟩, ⟨75, 76⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9926), (-9925)⟩, ⟨(-6611), (-6609)⟩, ⟨(-1097), (-1094)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103130, 5103132⟩, ⟨(-6611), (-6609)⟩, ⟨(-1097), (-1094)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨535590, 535591⟩, ⟨356366, 356368⟩, ⟨58931, 58935⟩, ⟨(-155), (-152)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-142629987), (-142629985)⟩, ⟨356366, 356368⟩, ⟨58931, 58935⟩, ⟨(-155), (-152)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14969488), (-14969487)⟩, ⟨(-9942258), (-9942256)⟩, ⟨(-1632158), (-1632155)⟩, ⟨8261, 8265⟩, ⟨674, 677⟩⟩
...
def j19 : Jet := ⟨⟨1416686277, 1416686279⟩, ⟨(-9942258), (-9942256)⟩, ⟨(-1632158), (-1632155)⟩, ⟨8261, 8265⟩, ⟨674, 677⟩⟩
...
def j25 : Jet := ⟨⟨1240, 1242⟩, ⟨826, 828⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850937), (-850934)⟩, ⟨826, 828⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-89309), (-89308)⟩, ⟨(-59454), (-59451)⟩, ⟨(-9853), (-9850)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35702085, 35702087⟩, ⟨(-59454), (-59451)⟩, ⟨(-9853), (-9850)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3747051, 3747052⟩, ⟨2491794, 2491796⟩, ⟨411144, 411148⟩, ⟨(-1383), (-1379)⟩, ⟨(-115), (-111)⟩⟩
...
def j33 : Jet := ⟨⟨(-712080832), (-712080830)⟩, ⟨2491794, 2491796⟩, ⟨411144, 411148⟩, ⟨(-1383), (-1379)⟩, ⟨(-115), (-111)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-74735231), (-74735230)⟩, ⟨(-49561967), (-49561963)⟩, ⟨(-8086418), (-8086413)⟩, ⟨57678, 57683⟩, ⟨4684, 4688⟩⟩
...
def j36 : Jet := ⟨⟨4220232065, 4220232066⟩, ⟨(-49561967), (-49561963)⟩, ⟨(-8086418), (-8086413)⟩, ⟨57678, 57683⟩, ⟨4684, 4688⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨458956714, 458956717⟩, ⟨149764627, 149764631⟩, ⟨(-1602411), (-1602408)⟩, ⟨(-173579), (-173575)⟩, ⟨1110, 1113⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4371025996, 4371025999⟩, ⟨51332870, 51332876⟩, ⟨8978196, 8978205⟩, ⟨144052, 144061⟩, ⟨13335, 13345⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨467084284, 467084289⟩, ⟨157902166, 157902173⟩, ⟨1118580, 1118587⟩, ⟨132655, 132665⟩, ⟨2151, 2161⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-442902397), (-442902396)⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3852064899, 3852064900⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨50796132, 50796134⟩, ⟨34344204, 34344208⟩, ⟨6048482, 6048487⟩, ⟨111098, 111106⟩, ⟨10509, 10520⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4345763428, 4345763430⟩, ⟨34344204, 34344208⟩, ⟨6048482, 6048487⟩, ⟨111098, 111106⟩, ⟨10509, 10520⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320290707, 4320290709⟩, ⟨17071447, 17071450⟩, ⟨2972785, 2972789⟩, ⟨43475, 43481⟩, ⟨4028, 4036⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3874776928, 3874776931⟩, ⟨(-133193576), (-133193571)⟩, ⟨2079417, 2079423⟩, ⟨(-63195), (-63187)⟩, ⟨2117, 2126⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨44423279337, 44423279345⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value523

def j47 : Jet := ⟨⟨4580984091, 4580984103⟩, ⟨1526994697, 1526994708⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4886047738, 4886047764⟩, ⟨3257365158, 3257365192⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4886047738, 4886047764⟩, ⟨3257365158, 3257365192⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4886047764), (-4886047738)⟩, ⟨(-3257365192), (-3257365158)⟩, ⟨(-542894201), (-542894193)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2443023882), (-2443023869)⟩, ⟨(-1628682596), (-1628682579)⟩, ⟨(-271447101), (-271447096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2431803384, 2431803406⟩, ⟨(-922157403), (-922157384)⟩, ⟨21151464, 21151475⟩, ⟨36180706, 36180710⟩, ⟨(-4098397), (-4098394)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2193892292, 2193892314⟩, ⟨(-907353784), (-907353760)⟩, ⟨48857035, 48857052⟩, ⟨31502844, 31502857⟩, ⟨(-4794454), (-4794440)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨295268264, 590536529⟩, ⟨147634132, 147634133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨927612608, 1855225222⟩, ⟨463806304, 463806308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨200342654, 801370625⟩, ⟨200342654, 400685316⟩, ⟨50085663, 50085665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨50, 201⟩, ⟨50, 101⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94637), (-94485)⟩, ⟨50, 101⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-17658), (-4407)⟩, ⟨(-8827), (-4388)⟩, ⟨(-1102), (-1088)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095398, 5108650⟩, ⟨(-8827), (-4388)⟩, ⟨(-1102), (-1088)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨237679, 953191⟩, ⟨236032, 476392⟩, ⟨58389, 59321⟩, ⟨(-206), (-100)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142927898), (-142212385)⟩, ⟨236032, 476392⟩, ⟨58389, 59321⟩, ⟨(-206), (-100)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-26668008), (-6633625)⟩, ⟨(-13322995), (-6544738)⟩, ⟨(-1653019), (-1602893)⟩, ⟨5436, 11087⟩, ⟨657, 688⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1404987757, 1425022141⟩, ⟨(-13322995), (-6544738)⟩, ⟨(-1653019), (-1602893)⟩, ⟨5436, 11087⟩, ⟨657, 688⟩⟩
...
def j72 : Jet := ⟨⟨551, 2208⟩, ⟨548, 1104⟩, ⟨134, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851626), (-849968)⟩, ⟨548, 1104⟩, ⟨134, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-158900), (-39647)⟩, ⟨(-79425), (-39441)⟩, ⟨(-9901), (-9782)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35632494, 35751748⟩, ⟨(-79425), (-39441)⟩, ⟨(-9901), (-9782)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1662110, 6670692⟩, ⟨1647290, 3333507⟩, ⟨406269, 414624⟩, ⟨(-1851), (-910)⟩, ⟨(-117), (-110)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714165773), (-709157190)⟩, ⟨1647290, 3333507⟩, ⟨406269, 414624⟩, ⟨(-1851), (-910)⟩, ⟨(-117), (-110)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-133251649), (-33079281)⟩, ⟨(-66548986), (-32457303)⟩, ⟨(-8232440), (-7881468)⟩, ⟨37813, 77514⟩, ⟨4542, 4789⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4161715647, 4261888015⟩, ⟨(-66548986), (-32457303)⟩, ⟨(-8232440), (-7881468)⟩, ⟨37813, 77514⟩, ⟨4542, 4789⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨303444535, 615542992⟩, ⟨145967355, 152472239⟩, ⟨(-2152755), (-1052942)⟩, ⟨(-177333), (-168303)⟩, ⟨728, 1496⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4328303326, 4432485456⟩, ⟨32963102, 70878801⟩, ⟨8255325, 9901466⟩, ⟨43209, 259215⟩, ⟨9322, 18710⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨305799765, 635251720⟩, ⟨149429184, 167512320⟩, ⟨(-518162), 2874151⟩, ⟨65076, 210965⟩, ⟨(-5031), 10115⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-590536529), (-295268264)⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3704430767, 3999699032⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21772807, 93957584⟩, ⟨21278582, 49552178⟩, ⟨5045614, 7383526⟩, ⟨(-31154), 286604⟩, ⟨2691, 21376⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316740103, 4388924880⟩, ⟨21278582, 49552178⟩, ⟨5045614, 7383526⟩, ⟨(-31154), 286604⟩, ⟨2691, 21376⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305839937, 4341691932⟩, ⟨10524792, 24713528⟩, ⟨2425320, 3669579⟩, ⟨(-36601), 137013⟩, ⟨(-1009), 10189⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3713808474, 4043211467⟩, ⟨(-140162549), (-124993330)⟩, ⟨1242353, 3055529⟩, ⟨(-160223), 44227⟩, ⟨(-5650), 10748⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3053989394, 6107978801⟩, ⟨1526994697, 1526994708⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2171576772, 8686307127⟩, ⟨2171576772, 4343153586⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2171576772, 8686307127⟩, ⟨2171576772, 4343153586⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8686307127), (-2171576772)⟩, ⟨(-4343153586), (-2171576772)⟩, ⟨(-542894201), (-542894193)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4343153564), (-1085788386)⟩, ⟨(-2171576793), (-1085788386)⟩, ⟨(-271447101), (-271447096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1562402494, 3335555170⟩, ⟨(-1686488791), (-394982863)⟩, ⟨(-160884317), 327606765⟩, ⟨(-38571450), 98173634⟩, ⟨(-22761955), 9959566⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1350991339, 3140036695⟩, ⟨(-1696485732), (-387006576)⟩, ⟨(-139507009), 365813703⟩, ⟨(-48325929), 97589460⟩, ⟨(-24767754), 10938848⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨442902396, 442902397⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨147634132, 147634133⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320290707, 4320290709⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar523 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2458
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar523 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨295268264, 590536529⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305839937, 4341691932⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2459
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((27499 / 400000) : ℝ)..(27499 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (27499 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (27499 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((27499 / 400000) : ℝ)..(27499 / 200000), prawitzNormalCorrection
      ((143433 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
