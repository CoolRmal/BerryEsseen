...
namespace FiniteNormalPanel11_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38251 / 160000)
def radius : Rat := (38251 / 800000)

def j0 : Jet := ⟨⟨1026792462, 1026792463⟩, ⟨205358492, 205358493⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3225763655, 3225763659⟩, ⟨645152729, 645152733⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2422731173, 2422731180⟩, ⟨969092466, 969092474⟩, ⟨96909246, 96909248⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨606, 607⟩, ⟨242, 243⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94081), (-94079)⟩, ⟨242, 243⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-53070), (-53068)⟩, ⟨(-21092), (-21089)⟩, ⟨(-2056), (-2052)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5059986, 5059989⟩, ⟨(-21092), (-21089)⟩, ⟨(-2056), (-2052)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2854267, 2854270⟩, ⟨1129809, 1129812⟩, ⟨108250, 108256⟩, ⟨(-935), (-931)⟩, ⟨(-45), (-42)⟩⟩
...
def j16 : Jet := ⟨⟨(-140311310), (-140311306)⟩, ⟨1129809, 1129812⟩, ⟨108250, 108256⟩, ⟨(-935), (-931)⟩, ⟨(-45), (-42)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-79147655), (-79147651)⟩, ⟨(-31021753), (-31021748)⟩, ⟨(-2849922), (-2849915)⟩, ⟨49388, 49395⟩, ⟨2205, 2210⟩⟩
...
def j19 : Jet := ⟨⟨1352508110, 1352508115⟩, ⟨(-31021753), (-31021748)⟩, ⟨(-2849922), (-2849915)⟩, ⟨49388, 49395⟩, ⟨2205, 2210⟩⟩
...
def j22 : Jet := ⟨⟨(-61), (-60)⟩, ⟨(-25), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11774, 11776⟩, ⟨(-25), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6641, 6643⟩, ⟨2641, 2645⟩, ⟨257, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845536), (-845533)⟩, ⟨2641, 2645⟩, ⟨257, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-476956), (-476953)⟩, ⟨(-189294), (-189288)⟩, ⟨(-18340), (-18334)⟩, ⟨114, 119⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35314438, 35314442⟩, ⟨(-189294), (-189288)⟩, ⟨(-18340), (-18334)⟩, ⟨114, 119⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19920382, 19920385⟩, ⟨7861373, 7861380⟩, ⟨743757, 743766⟩, ⟨(-8347), (-8338)⟩, ⟨(-388), (-382)⟩⟩
...
def j33 : Jet := ⟨⟨(-695907501), (-695907497)⟩, ⟨7861373, 7861380⟩, ⟨743757, 743766⟩, ⟨(-8347), (-8338)⟩, ⟨(-388), (-382)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-392551721), (-392551717)⟩, ⟨(-152586199), (-152586191)⟩, ⟨(-13508731), (-13508721)⟩, ⟨340487, 340497⟩, ⟨14678, 14686⟩⟩
...
def j36 : Jet := ⟨⟨3902415575, 3902415579⟩, ⟨(-152586199), (-152586191)⟩, ⟨(-13508731), (-13508721)⟩, ⟨340487, 340497⟩, ⟨14678, 14686⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1015810180, 1015810186⟩, ⟨179862941, 179862949⟩, ⟨(-6800272), (-6800264)⟩, ⟨(-390998), (-390990)⟩, ⟨9074, 9080⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4727006568, 4727006574⟩, ⟨184828066, 184828078⟩, ⟨23590009, 23590025⟩, ⟨1149740, 1149756⟩, ⟨92697, 92713⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1117992539, 1117992548⟩, ⟨241669717, 241669731⟩, ⟨5835145, 5835160⟩, ⟨536849, 536865⟩, ⟨25879, 25897⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1026792463), (-1026792462)⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3268174833, 3268174834⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨291016725, 291016730⟩, ⟨125814666, 125814676⟩, ⟨16636109, 16636122⟩, ⟨936150, 936164⟩, ⟨81813, 81830⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4585984021, 4585984026⟩, ⟨125814666, 125814676⟩, ⟨16636109, 16636122⟩, ⟨936150, 936164⟩, ⟨81813, 81830⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4438090962, 4438090965⟩, ⟨60878639, 60878644⟩, ⟨7632260, 7632268⟩, ⟨348285, 348294⟩, ⟨28246, 28257⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3377082103, 3377082107⟩, ⟨(-165877315), (-165877308)⟩, ⟨2896788, 2896796⟩, ⟨(-99908), (-99898)⟩, ⟨4839, 4850⟩⟩
...
def j47 : Jet := ⟨⟨5392938782, 5392938789⟩, ⟨1078587754, 1078587760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6771597244, 6771597262⟩, ⟨2708638890, 2708638912⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6771597244, 6771597262⟩, ⟨2708638890, 2708638912⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6771597262), (-6771597244)⟩, ⟨(-2708638912), (-2708638890)⟩, ⟨(-270863892), (-270863888)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3385798631), (-3385798622)⟩, ⟨(-1354319456), (-1354319445)⟩, ⟨(-135431946), (-135431944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1952530579, 1952530591⟩, ⟨(-615685752), (-615685742)⟩, ⟨35502614, 35502619⟩, ⟨9211179, 9211181⟩, ⟨(-1285881), (-1285880)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1535251753, 1535251766⟩, ⟨(-559515756), (-559515742)⟩, ⟨53010787, 53010799⟩, ⟨5410804, 5410816⟩, ⟨(-1326358), (-1326346)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨821433970, 1232150956⟩, ⟨205358492, 205358493⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2580610925, 3870916392⟩, ⟨645152729, 645152733⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1550547952, 3488732901⟩, ⟨775273972, 1162910970⟩, ⟨96909246, 96909248⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨388, 875⟩, ⟨194, 292⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94299), (-93811)⟩, ⟨194, 292⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-76598), (-33867)⟩, ⟨(-25463), (-16695)⟩, ⟨(-2085), (-2015)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5036458, 5079190⟩, ⟨(-25463), (-16695)⟩, ⟨(-2085), (-2015)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1818237, 4125745⟩, ⟨888434, 1369222⟩, ⟨105050, 110865⟩, ⟨(-1138), (-727)⟩, ⟨(-47), (-40)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141347340), (-139039831)⟩, ⟨888434, 1369222⟩, ⟨105050, 110865⟩, ⟨(-1138), (-727)⟩, ⟨(-47), (-40)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-114814173), (-50195475)⟩, ⟨(-37950653), (-23985539)⟩, ⟨(-2990990), (-2676430)⟩, ⟨38083, 60651⟩, ⟨2022, 2357⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1316841592, 1381460291⟩, ⟨(-37950653), (-23985539)⟩, ⟨(-2990990), (-2676430)⟩, ⟨38083, 60651⟩, ⟨2022, 2357⟩⟩
...
def j70 : Jet := ⟨⟨(-88), (-38)⟩, ⟨(-30), (-19)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11747, 11798⟩, ⟨(-30), (-19)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4240, 9584⟩, ⟨2095, 3189⟩, ⟨253, 264⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847937), (-842592)⟩, ⟨2095, 3189⟩, ⟨253, 264⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-688766), (-304188)⟩, ⟨(-228833), (-149503)⟩, ⟨(-18664), (-17932)⟩, ⟨90, 144⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35102628, 35487207⟩, ⟨(-228833), (-149503)⟩, ⟨(-18664), (-17932)⟩, ⟨90, 144⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12672577, 28825688⟩, ⟨6150410, 9554591⟩, ⟨714915, 767255⟩, ⟨(-10186), (-6492)⟩, ⟨(-405), (-360)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703155306), (-687002194)⟩, ⟨6150410, 9554591⟩, ⟨714915, 767255⟩, ⟨(-10186), (-6492)⟩, ⟨(-405), (-360)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-571161754), (-248018150)⟩, ⟨(-188166862), (-116248033)⟩, ⟨(-14497315), (-12290891)⟩, ⟨259547, 420985⟩, ⟨13043, 16012⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3723805542, 4046949146⟩, ⟨(-188166862), (-116248033)⟩, ⟨(-14497315), (-12290891)⟩, ⟨259547, 420985⟩, ⟨13043, 16012⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨791218084, 1245065892⟩, ⟨163600812, 193099385⟩, ⟨(-8396302), (-5211019)⟩, ⟨(-426400), (-347367)⟩, ⟨6934, 11236⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4558185291, 4953734524⟩, ⟨130933217, 250316155⟩, ⟨17604590, 31934283⟩, ⟨388028, 2270481⟩, ⟨18971, 213965⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨839708054, 1436035590⟩, ⟨197747615, 295281224⟩, ⟨(-1453609), 14981115⟩, ⟨(-239087), 1566423⟩, ⟨(-61649), 145119⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1232150956), (-821433970)⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3062816340, 3473533326⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨164171125, 480142938⟩, ⟨77323180, 197456380⟩, ⟨8132599, 30318703⟩, ⟨(-359754), 3107398⟩, ⟨(-79173), 364684⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4459138421, 4775110234⟩, ⟨77323180, 197456380⟩, ⟨8132599, 30318703⟩, ⟨(-359754), 3107398⟩, ⟨(-79173), 364684⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4376283090, 4528679973⟩, ⟨36666372, 96893720⟩, ⟨2819900, 14724073⟩, ⟨(-502536), 1501204⟩, ⟨(-96859), 189173⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3120804055, 3662547285⟩, ⟨(-190385742), (-130884193)⟩, ⟨(-2621933), 10154865⟩, ⟨(-1110438), 1079263⟩, ⟨(-150114), 177022⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4314351027, 6471526549⟩, ⟨1078587754, 1078587760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4333822239, 9751100064⟩, ⟨2166911114, 3250366694⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4333822239, 9751100064⟩, ⟨2166911114, 3250366694⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9751100064), (-4333822239)⟩, ⟨(-3250366694), (-2166911114)⟩, ⟨(-270863892), (-270863888)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4875550032), (-2166911119)⟩, ⟨(-1625183347), (-1083455557)⟩, ⟨(-135431946), (-135431944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1380252543, 2593272607⟩, ⟨(-981274866), (-348184790)⟩, ⟨(-37856071), 142130419⟩, ⟨(-10607556), 25402987⟩, ⟨(-4643954), 1600308⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1002917469, 2211421623⟩, ⟨(-951738966), (-295059230)⟩, ⟨(-23254463), 170831210⟩, ⟨(-18336501), 24591239⟩, ⟨(-5512927), 2531513⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1026792462, 1026792463⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4438090962, 4438090965⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified216
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨821433970, 1232150956⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4376283090, 4528679973⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified217
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (148550469 / 4294967296)

theorem envelope_integral : (∫ s in ((38251 / 200000) : ℝ)..(114753 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((38251 / 200000) : ℝ)..(114753 / 400000), prawitzNormalCorrection
