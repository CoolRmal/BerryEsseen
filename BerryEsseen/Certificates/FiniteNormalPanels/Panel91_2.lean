...
namespace FiniteNormalPanel91_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (32439 / 400000)
def radius : Rat := (32439 / 400000)

def j0 : Jet := ⟨⟨348311110, 348311111⟩, ⟨348311110, 348311111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1094251624, 1094251628⟩, ⟨1094251624, 1094251628⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨278788296, 278788299⟩, ⟨557576592, 557576598⟩, ⟨278788296, 278788299⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨69, 70⟩, ⟨139, 140⟩, ⟨69, 70⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94618), (-94616)⟩, ⟨139, 140⟩, ⟨69, 70⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-6142), (-6141)⟩, ⟨(-12275), (-12273)⟩, ⟨(-6120), (-6117)⟩, ⟨17, 20⟩, ⟨4, 5⟩⟩
...
def j13 : Jet := ⟨⟨5106914, 5106916⟩, ⟨(-12275), (-12273)⟩, ⟨(-6120), (-6117)⟩, ⟨17, 20⟩, ⟨4, 5⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨331492, 331493⟩, ⟨662187, 662189⟩, ⟨329500, 329503⟩, ⟨(-1591), (-1588)⟩, ⟨(-396), (-393)⟩⟩
...
def j16 : Jet := ⟨⟨(-142834085), (-142834083)⟩, ⟨662187, 662189⟩, ⟨329500, 329503⟩, ⟨(-1591), (-1588)⟩, ⟨(-396), (-393)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-9271427), (-9271425)⟩, ⟨(-18499871), (-18499868)⟩, ⟨(-9164075), (-9164070)⟩, ⟨85653, 85657⟩, ⟨21154, 21158⟩⟩
...
def j19 : Jet := ⟨⟨1422384338, 1422384341⟩, ⟨(-18499871), (-18499868)⟩, ⟨(-9164075), (-9164070)⟩, ⟨85653, 85657⟩, ⟨21154, 21158⟩⟩
...
def j22 : Jet := ⟨⟨(-8), (-6)⟩, ⟨(-15), (-13)⟩, ⟨(-8), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11827, 11830⟩, ⟨(-15), (-13)⟩, ⟨(-8), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨767, 768⟩, ⟨1534, 1536⟩, ⟨764, 767⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851410), (-851408)⟩, ⟨1534, 1536⟩, ⟨764, 767⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-55266), (-55265)⟩, ⟨(-110432), (-110430)⟩, ⟨(-55018), (-55015)⟩, ⟨197, 200⟩, ⟨47, 50⟩⟩
...
def j30 : Jet := ⟨⟨35736128, 35736130⟩, ⟨(-110432), (-110430)⟩, ⟨(-55018), (-55015)⟩, ⟨197, 200⟩, ⟨47, 50⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2319648, 2319649⟩, ⟨4632127, 4632130⟩, ⟨2301739, 2301742⟩, ⟨(-14300), (-14297)⟩, ⟨(-3544), (-3541)⟩⟩
...
def j33 : Jet := ⟨⟨(-713508235), (-713508233)⟩, ⟨4632127, 4632130⟩, ⟨2301739, 2301742⟩, ⟨(-14300), (-14297)⟩, ⟨(-3544), (-3541)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-46314148), (-46314146)⟩, ⟨(-92327622), (-92327618)⟩, ⟨(-45563396), (-45563390)⟩, ⟨598557, 598561⟩, ⟨147318, 147323⟩⟩
...
def j36 : Jet := ⟨⟨4248653148, 4248653150⟩, ⟨(-92327622), (-92327618)⟩, ⟨(-45563396), (-45563390)⟩, ⟨598557, 598561⟩, ⟨147318, 147323⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨362388410, 362388413⟩, ⟨357675099, 357675104⟩, ⟨(-7048092), (-7048087)⟩, ⟨(-2312959), (-2312954)⟩, ⟨27211, 27215⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4341786307, 4341786310⟩, ⟨94351497, 94351503⟩, ⟨48612521, 48612532⟩, ⟨1456560, 1456569⟩, ⟨389136, 389146⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨366338769, 366338774⟩, ⟨369534998, 369535006⟩, ⟨4834141, 4834151⟩, ⟨1678232, 1678243⟩, ⟨51054, 51064⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-348311111), (-348311110)⟩, ⟨(-348311111), (-348311110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3946656185, 3946656186⟩, ⟨(-348311111), (-348311110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨31246825, 31246827⟩, ⟨63038894, 63038898⟩, ⟨32619102, 32619108⟩, ⟨1118138, 1118144⟩, ⟨302935, 302944⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4326214121, 4326214123⟩, ⟨63038894, 63038898⟩, ⟨32619102, 32619108⟩, ⟨1118138, 1118144⟩, ⟨302935, 302944⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4310562395, 4310562397⟩, ⟨31405413, 31405416⟩, ⟨16136139, 16136144⟩, ⟨439483, 439488⟩, ⟨117514, 117521⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3960986560, 3960986564⟩, ⟨(-320717323), (-320717317)⟩, ⟨12280637, 12280644⟩, ⟨(-904759), (-904753)⟩, ⟨72341, 72351⟩⟩
...
def j47 : Jet := ⟨⟨2362709201, 2362709209⟩, ⟨2362709201, 2362709209⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1299752567, 1299752576⟩, ⟨2599505134, 2599505152⟩, ⟨1299752567, 1299752576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1299752567, 1299752576⟩, ⟨2599505134, 2599505152⟩, ⟨1299752567, 1299752576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1299752576), (-1299752567)⟩, ⟨(-2599505152), (-2599505134)⟩, ⟨(-1299752576), (-1299752567)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-649876288), (-649876283)⟩, ⟨(-1299752576), (-1299752567)⟩, ⟨(-649876288), (-649876283)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3691868972, 3691868978⟩, ⟨(-1117241619), (-1117241609)⟩, ⟨(-389569738), (-389569729)⟩, ⟨151998200, 151998204⟩, ⟨17973605, 17973608⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3404785734, 3404785744⟩, ⟨(-1306046122), (-1306046104)⟩, ⟨(-265292654), (-265292633)⟩, ⟨165296690, 165296707⟩, ⟨4409457, 4409476⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 696622221⟩, ⟨348311110, 348311111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2188503252⟩, ⟨1094251624, 1094251628⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1115153191⟩, ⟨0, 1115153194⟩, ⟨278788296, 278788299⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 280⟩, ⟨0, 280⟩, ⟨69, 70⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94406)⟩, ⟨0, 280⟩, ⟨69, 70⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-24585), 0⟩, ⟨(-24585), 73⟩, ⟨(-6147), (-6035)⟩, ⟨0, 38⟩, ⟨4, 5⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5088471, 5113057⟩, ⟨(-24585), 73⟩, ⟨(-6147), (-6035)⟩, ⟨0, 38⟩, ⟨4, 5⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1327564⟩, ⟨(-6384), 1327583⟩, ⟨322313, 331910⟩, ⟨(-3193), 15⟩, ⟨(-400), (-379)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141838012)⟩, ⟨(-6384), 1327583⟩, ⟨322313, 331910⟩, ⟨(-3193), 15⟩, ⟨(-400), (-379)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-37171774), 0⟩, ⟨(-37173432), 344697⟩, ⟨(-9294602), (-8775895)⟩, ⟨(-1245), 172357⟩, ⟨19987, 21549⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1394483991, 1431655766⟩, ⟨(-37173432), 344697⟩, ⟨(-9294602), (-8775895)⟩, ⟨(-1245), 172357⟩, ⟨19987, 21549⟩⟩
...
def j70 : Jet := ⟨⟨(-29), 0⟩, ⟨(-29), 0⟩, ⟨(-8), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11806, 11836⟩, ⟨(-29), 0⟩, ⟨(-8), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 3074⟩, ⟨(-8), 3074⟩, ⟨755, 769⟩, ⟨(-5), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-849102)⟩, ⟨(-8), 3074⟩, ⟨755, 769⟩, ⟨(-5), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-221261), 0⟩, ⟨(-221264), 799⟩, ⟨(-55319), (-54116)⟩, ⟨(-3), 400⟩, ⟨46, 50⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35570133, 35791395⟩, ⟨(-221264), 799⟩, ⟨(-55319), (-54116)⟩, ⟨(-3), 400⟩, ⟨46, 50⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 9292944⟩, ⟨(-57450), 9293152⟩, ⟨2237059, 2323444⟩, ⟨(-28728), 156⟩, ⟨(-3592), (-3395)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-706534938)⟩, ⟨(-57450), 9293152⟩, ⟨2237059, 2323444⟩, ⟨(-28728), 156⟩, ⟨(-3592), (-3395)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-185858866), 0⟩, ⟨(-185873783), 2412892⟩, ⟨(-46479634), (-42845350)⟩, ⟨(-11189), 1206528⟩, ⟨136816, 150857⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4109108430, 4294967296⟩, ⟨(-185873783), 2412892⟩, ⟨(-46479634), (-42845350)⟩, ⟨(-11189), 1206528⟩, ⟨136816, 150857⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 729501085⟩, ⟨336338345, 364926184⟩, ⟨(-14206944), 87821⟩, ⟨(-2368671), (-2148056)⟩, ⟨(-318), 54894⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4489232735⟩, ⟨(-2636104), 203068547⟩, ⟨42731267, 59965081⟩, ⟨(-1383173), 5021705⟩, ⟨151687, 763214⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 762497111⟩, ⟨335890602, 415923376⟩, ⟨(-15073518), 27530798⟩, ⟨(-36175), 3808595⟩, ⟨(-428203), 616366⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-696622221), 0⟩, ⟨(-348311111), (-348311110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3598345075, 4294967296⟩, ⟨(-348311111), (-348311110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 135368166⟩, ⟨0, 147679996⟩, ⟨20916448, 50053133⟩, ⟨(-2932278), 6684452⟩, ⟨(-255672), 1132973⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4430335462⟩, ⟨0, 147679996⟩, ⟨20916448, 50053133⟩, ⟨(-2932278), 6684452⟩, ⟨(-255672), 1132973⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4362126308⟩, ⟨0, 73839998⟩, ⟨9672245, 25026567⟩, ⟨(-1896402), 3342226⟩, ⟨(-258212), 588200⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3598345075, 4362126308⟩, ⟨(-353757539), (-274471112)⟩, ⟨2115215, 25026567⟩, ⟨(-3925995), 2557832⟩, ⟨(-529259), 741994⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4725418411⟩, ⟨2362709201, 2362709209⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 5199010289⟩, ⟨0, 5199010296⟩, ⟨1299752567, 1299752576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 5199010289⟩, ⟨0, 5199010296⟩, ⟨1299752567, 1299752576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5199010289), 0⟩, ⟨(-5199010296), 0⟩, ⟨(-1299752576), (-1299752567)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2599505145), 0⟩, ⟨(-2599505148), 0⟩, ⟨(-649876288), (-649876283)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2344798530, 4294967296⟩, ⟨(-2599505148), 0⟩, ⟨(-649876288), 431873966⟩, ⟨(-87129775), 393334021⟩, ⟨(-92189475), 62350457⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1964483932, 4362126308⟩, ⟨(-2993910307), (-149845019)⟩, ⟨(-658883411), 677763397⟩, ⟨(-143136939), 455569738⟩, ⟨(-131892374), 76136597⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨348311110, 348311111⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨348311110, 348311111⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4310562395, 4310562397⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1830
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 696622221⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4362126308⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1831
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (540365973 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(32439 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(32439 / 200000), prawitzNormalCorrection
