...
namespace FiniteNormalPanel152_15
...
def j2 : Jet := ⟨⟨503071041, 503071045⟩, ⟨503071041, 503071045⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨58924889, 58924891⟩, ⟨117849778, 117849782⟩, ⟨58924889, 58924891⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1299), (-1298)⟩, ⟨(-2598), (-2596)⟩, ⟨(-1299), (-1296)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111757, 5111759⟩, ⟨(-2598), (-2596)⟩, ⟨(-1299), (-1296)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨70130, 70131⟩, ⟨140225, 140227⟩, ⟨70040, 70043⟩, ⟨(-72), (-69)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-143095447), (-143095445)⟩, ⟨140225, 140227⟩, ⟨70040, 70043⟩, ⟨(-72), (-69)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1963201), (-1963200)⟩, ⟨(-3924479), (-3924477)⟩, ⟨(-1958394), (-1958391)⟩, ⟨3843, 3846⟩, ⟨957, 960⟩⟩
...
def j19 : Jet := ⟨⟨1429692564, 1429692566⟩, ⟨(-3924479), (-3924477)⟩, ⟨(-1958394), (-1958391)⟩, ⟨3843, 3846⟩, ⟨957, 960⟩⟩
...
def j25 : Jet := ⟨⟨162, 163⟩, ⟨323, 325⟩, ⟨160, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852015), (-852013)⟩, ⟨323, 325⟩, ⟨160, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11690), (-11689)⟩, ⟨(-23375), (-23373)⟩, ⟨(-11680), (-11677)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779704, 35779706⟩, ⟨(-23375), (-23373)⟩, ⟨(-11680), (-11677)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨490880, 490881⟩, ⟨981439, 981441⟩, ⟨490077, 490080⟩, ⟨(-642), (-639)⟩, ⟨(-161), (-158)⟩⟩
...
def j33 : Jet := ⟨⟨(-715337003), (-715337001)⟩, ⟨981439, 981441⟩, ⟨490077, 490080⟩, ⟨(-642), (-639)⟩, ⟨(-161), (-158)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9814081), (-9814080)⟩, ⟨(-19614698), (-19614695)⟩, ⟨(-9780429), (-9780426)⟩, ⟨26902, 26905⟩, ⟨6702, 6705⟩⟩
...
def j36 : Jet := ⟨⟨4285153215, 4285153216⟩, ⟨(-19614698), (-19614695)⟩, ⟨(-9780429), (-9780426)⟩, ⟨26902, 26905⟩, ⟨6702, 6705⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨167460396, 167460399⟩, ⟨167000720, 167000724⟩, ⟨(-689064), (-689062)⟩, ⟨(-228938), (-228936)⟩, ⟨562, 564⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304803852, 4304803854⟩, ⟨19704642, 19704647⟩, ⟨9915471, 9915477⟩, ⟨63330, 63338⟩, ⟨16059, 16067⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨167843922, 167843926⟩, ⟨168151475, 168151481⟩, ⟨462133, 462138⟩, ⟨155386, 155392⟩, ⟨1009, 1016⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-160132487), (-160132486)⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4134834809, 4134834810⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6559207, 6559208⟩, ⟨13142452, 13142454⟩, ⟨6619385, 6619388⟩, ⟨48328, 48334⟩, ⟨12293, 12298⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301526503, 4301526504⟩, ⟨13142452, 13142454⟩, ⟨6619385, 6619388⟩, ⟨48328, 48334⟩, ⟨12293, 12298⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298245648, 4298245649⟩, ⟨6566213, 6566216⟩, ⟨3302152, 3302155⟩, ⟨19100, 19105⟩, ⟨4843, 4848⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4137990931, 4137990934⟩, ⟨(-153933318), (-153933312)⟩, ⟨2934221, 2934226⟩, ⟨(-104730), (-104723)⟩, ⟨3949, 3956⟩⟩
...
def j47 : Jet := ⟨⟨1201048424, 1201048433⟩, ⟨1201048424, 1201048433⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨335862235, 335862241⟩, ⟨671724470, 671724482⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨335862235, 335862241⟩, ⟨671724470, 671724482⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-335862241), (-335862235)⟩, ⟨(-671724482), (-671724470)⟩, ⟨(-335862241), (-335862235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-167931121), (-167931117)⟩, ⟨(-335862241), (-335862235)⟩, ⟨(-167931121), (-167931117)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4130276814, 4130276819⟩, ⟨(-322983607), (-322983600)⟩, ⟨(-148863304), (-148863298)⟩, ⟨12299321, 12299323⟩, ⟨2669792, 2669793⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3979319706, 3979319714⟩, ⟨(-459209657), (-459209642)⟩, ⟨(-129024947), (-129024933)⟩, ⟨16863741, 16863756⟩, ⟨2041372, 2041385⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 320264974⟩, ⟨160132486, 160132487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1006142090⟩, ⟨503071041, 503071045⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 235699561⟩, ⟨0, 235699562⟩, ⟨58924889, 58924891⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5197), 0⟩, ⟨(-5197), 4⟩, ⟨(-1300), (-1293)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107859, 5113057⟩, ⟨(-5197), 4⟩, ⟨(-1300), (-1293)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 280595⟩, ⟨(-286), 280596⟩, ⟨69719, 70150⟩, ⟨(-144), 2⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142884981)⟩, ⟨(-286), 280596⟩, ⟨69719, 70150⟩, ⟨(-144), 2⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7856653), 0⟩, ⟨(-7856669), 15399⟩, ⟨(-1964180), (-1941064)⟩, ⟨(-12), 7701⟩, ⟨947, 964⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423799112, 1431655766⟩, ⟨(-7856669), 15399⟩, ⟨(-1964180), (-1941064)⟩, ⟨(-12), 7701⟩, ⟨947, 964⟩⟩
...
def j72 : Jet := ⟨⟨0, 650⟩, ⟨(-1), 650⟩, ⟨160, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851526)⟩, ⟨(-1), 650⟩, ⟨160, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-46766), 0⟩, ⟨(-46767), 36⟩, ⟨(-11693), (-11637)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35744628, 35791395⟩, ⟨(-46767), 36⟩, ⟨(-11693), (-11637)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1964164⟩, ⟨(-2567), 1964166⟩, ⟨487190, 491043⟩, ⟨(-1285), 2⟩, ⟨(-162), (-157)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713863718)⟩, ⟨(-2567), 1964166⟩, ⟨487190, 491043⟩, ⟨(-1285), 2⟩, ⟨(-162), (-157)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-39283261), 0⟩, ⟨(-39283402), 107790⟩, ⟨(-9820957), (-9659129)⟩, ⟨(-107), 53897⟩, ⟨6604, 6738⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4255684035, 4294967296⟩, ⟨(-39283402), 107790⟩, ⟨(-9820957), (-9659129)⟩, ⟨(-107), 53897⟩, ⟨6604, 6738⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 335380697⟩, ⟨164929585, 167693957⟩, ⟨(-1380386), 1804⟩, ⟨(-230069), (-225552)⟩, ⟨(-2), 1129⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4334613172⟩, ⟨(-109790), 40011983⟩, ⟨9658124, 10372449⟩, ⟨(-55415), 188194⟩, ⟨13909, 19012⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 338476521⟩, ⟨164921011, 172366315⟩, ⟨(-1397416), 2374014⟩, ⟨121497, 194165⟩, ⟨(-7645), 9984⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-320264974), 0⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3974702322, 4294967296⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 26674559⟩, ⟨0, 27167588⟩, ⟨6112490, 7291615⟩, ⟨(-112164), 221154⟩, ⟨7351, 18473⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4321641855⟩, ⟨0, 27167588⟩, ⟨6112490, 7291615⟩, ⟨(-112164), 221154⟩, ⟨7351, 18473⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4308283932⟩, ⟨0, 13583794⟩, ⟨3025383, 3645808⟩, ⟨(-67613), 110577⟩, ⟨1772, 8385⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3974702322, 4308283932⟩, ⟨(-160628982), (-146548692)⟩, ⟨2293332, 3645808⟩, ⟨(-203543), (-2220)⟩, ⟨(-2484), 10906⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2402096865⟩, ⟨1201048424, 1201048433⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1343448961⟩, ⟨0, 1343448962⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1343448961⟩, ⟨0, 1343448962⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1343448961), 0⟩, ⟨(-1343448962), 0⟩, ⟨(-335862241), (-335862235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-671724481), 0⟩, ⟨(-671724481), 0⟩, ⟨(-167931121), (-167931117)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3673136382, 4294967296⟩, ⟨(-671724481), 0⟩, ⟨(-167931121), (-91089635)⟩, ⟨0, 26264099⟩, ⟨753866, 3283013⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3399239784, 4308283932⟩, ⟨(-834436159), (-125331183)⟩, ⟨(-166490495), (-55529441)⟩, ⟨2334330, 32624149⟩, ⟨(-429643), 3287295⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298245648, 4298245649⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3068
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4308283932⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3069
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (146784963 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(29827 / 400000), prawitzNormalCorrection
