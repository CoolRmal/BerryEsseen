...
namespace FiniteNormalPanel155_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38571 / 400000)
def radius : Rat := (12857 / 400000)

def j0 : Jet := ⟨⟨414152958, 414152959⟩, ⟨138050986, 138050987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1301099890, 1301099894⟩, ⟨433699963, 433699967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨394149898, 394149901⟩, ⟨262766598, 262766604⟩, ⟨43794433, 43794434⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-8681), (-8680)⟩, ⟨(-5782), (-5779)⟩, ⟨(-962), (-957)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104375, 5104377⟩, ⟨(-5782), (-5779)⟩, ⟨(-962), (-957)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨468429, 468430⟩, ⟨311755, 311757⟩, ⟨51604, 51608⟩, ⟨(-118), (-115)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142697148), (-142697146)⟩, ⟨311755, 311757⟩, ⟨51604, 51608⟩, ⟨(-118), (-115)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13095343), (-13095341)⟩, ⟨(-8701620), (-8701617)⟩, ⟨(-1431231), (-1431226)⟩, ⟨6324, 6327⟩, ⟨517, 520⟩⟩
...
def j19 : Jet := ⟨⟨1418560422, 1418560425⟩, ⟨(-8701620), (-8701617)⟩, ⟨(-1431231), (-1431226)⟩, ⟨6324, 6327⟩, ⟨517, 520⟩⟩
...
def j25 : Jet := ⟨⟨1085, 1086⟩, ⟨722, 724⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851092), (-851090)⟩, ⟨722, 724⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-78105), (-78104)⟩, ⟨(-52004), (-52002)⟩, ⟨(-8625), (-8621)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35713289, 35713291⟩, ⟨(-52004), (-52002)⟩, ⟨(-8625), (-8621)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3277414, 3277415⟩, ⟨2180170, 2180172⟩, ⟨360183, 360186⟩, ⟨(-1058), (-1055)⟩, ⟨(-89), (-85)⟩⟩
...
def j33 : Jet := ⟨⟨(-712550469), (-712550467)⟩, ⟨2180170, 2180172⟩, ⟨360183, 360186⟩, ⟨(-1058), (-1055)⟩, ⟨(-89), (-85)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-65390882), (-65390880)⟩, ⟨(-43393848), (-43393845)⟩, ⟨(-7099217), (-7099214)⟩, ⟨44168, 44172⟩, ⟨3598, 3602⟩⟩
...
def j36 : Jet := ⟨⟨4229576414, 4229576416⟩, ⟨(-43393848), (-43393845)⟩, ⟨(-7099217), (-7099214)⟩, ⟨44168, 44172⟩, ⟨3598, 3602⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨429732913, 429732916⟩, ⟨140608270, 140608274⟩, ⟨(-1312250), (-1312246)⟩, ⟨(-142609), (-142606)⟩, ⟨794, 797⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4361369144, 4361369147⟩, ⟨44745987, 44745992⟩, ⟨7779499, 7779505⟩, ⟨109370, 109378⟩, ⟨9996, 10005⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨436376749, 436376753⟩, ⟨147259186, 147259193⟩, ⟨910729, 910737⟩, ⟨107141, 107148⟩, ⟨1523, 1532⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-414152959), (-414152958)⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3880814337, 3880814338⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨44336697, 44336699⟩, ⟨29923620, 29923622⟩, ⟨5234056, 5234062⟩, ⟨84220, 84226⟩, ⟨7847, 7854⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4339303993, 4339303995⟩, ⟨29923620, 29923622⟩, ⟨5234056, 5234062⟩, ⟨84220, 84226⟩, ⟨7847, 7854⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317078727, 4317078729⟩, ⟨14885177, 14885179⟩, ⟨2577962, 2577966⟩, ⟨33005, 33010⟩, ⟨3018, 3024⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3900793617, 3900793621⟩, ⟨(-125311868), (-125311863)⟩, ⟨1850928, 1850934⟩, ⟨(-53041), (-53035)⟩, ⟨1664, 1673⟩⟩
...
def j47 : Jet := ⟨⟨5010121962, 5010121976⟩, ⟨1670040654, 1670040667⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5844356975, 5844357008⟩, ⟨3896237982, 3896238026⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5844356975, 5844357008⟩, ⟨3896237982, 3896238026⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5844357008), (-5844356975)⟩, ⟨(-3896238026), (-3896237982)⟩, ⟨(-649373008), (-649372997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2922178504), (-2922178487)⟩, ⟨(-1948119013), (-1948118991)⟩, ⟨(-324686504), (-324686498)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2175092599, 2175092616⟩, ⟨(-986582433), (-986582413)⟩, ⟨59317506, 59317519⟩, ⟨40753308, 40753314⟩, ⟨(-6863353), (-6863351)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1975471928, 1975471946⟩, ⟨(-959499596), (-959499572)⟩, ⟨83595925, 83595945⟩, ⟨34830435, 34830449⟩, ⟨(-7383914), (-7383902)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨276101972, 552203946⟩, ⟨138050986, 138050987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨867399926, 1734799861⟩, ⟨433699963, 433699967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨175177732, 700710937⟩, ⟨175177732, 350355470⟩, ⟨43794433, 43794434⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-15441), (-3854)⟩, ⟨(-7720), (-3839)⟩, ⟨(-965), (-953)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097615, 5109203⟩, ⟨(-7720), (-3839)⟩, ⟨(-965), (-953)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨207915, 833552⟩, ⟨206655, 416620⟩, ⟨51190, 51903⟩, ⟨(-158), (-76)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142957662), (-142332024)⟩, ⟨206655, 416620⟩, ⟨51190, 51903⟩, ⟨(-158), (-76)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-23323111), (-5805259)⟩, ⟨(-11653128), (-5737288)⟩, ⟨(-1447180), (-1408860)⟩, ⟨4168, 8480⟩, ⟨506, 527⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408332654, 1425850507⟩, ⟨(-11653128), (-5737288)⟩, ⟨(-1447180), (-1408860)⟩, ⟨4168, 8480⟩, ⟨506, 527⟩⟩
...
def j72 : Jet := ⟨⟨481, 1931⟩, ⟨479, 966⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851696), (-850245)⟩, ⟨479, 966⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-138952), (-34678)⟩, ⟨(-69457), (-34520)⟩, ⟨(-8662), (-8570)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35652442, 35756717⟩, ⟨(-69457), (-34520)⟩, ⟨(-8662), (-8570)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1454147, 5833601⟩, ⟨1442815, 2915394⟩, ⟨356456, 362845⟩, ⟨(-1416), (-696)⟩, ⟨(-90), (-84)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714373736), (-709994281)⟩, ⟨1442815, 2915394⟩, ⟨356456, 362845⟩, ⟨(-1416), (-696)⟩, ⟨(-90), (-84)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-116547917), (-28958355)⟩, ⟨(-58215112), (-28482717)⟩, ⟨(-7210860), (-6942571)⟩, ⟨29017, 59299⟩, ⟨3503, 3669⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4178419379, 4266008941⟩, ⟨(-58215112), (-28482717)⟩, ⟨(-7210860), (-6942571)⟩, ⟨29017, 59299⟩, ⟨3503, 3669⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨284423036, 575921792⟩, ⟨137504649, 142821762⟩, ⟨(-1761256), (-863872)⟩, ⟨(-145294), (-138838)⟩, ⟨522, 1070⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4324122224, 4414766064⟩, ⟨28870719, 61507972⟩, ⟨7229904, 8475684⟩, ⟨33887, 194206⟩, ⟨7337, 13509⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨286353745, 591985878⟩, ⟨140349940, 155053207⟩, ⟨(-407298), 2312130⟩, ⟨59141, 162301⟩, ⟨(-3463), 6983⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-552203946), (-276101972)⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3742763350, 4018865324⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19091755, 81594866⟩, ⟨18714800, 42742728⟩, ⟨4474044, 6234972⟩, ⟨(-21522), 211684⟩, ⟨2688, 14891⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314059051, 4376562162⟩, ⟨18714800, 42742728⟩, ⟨4474044, 6234972⟩, ⟨(-21522), 211684⟩, ⟨2688, 14891⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304502588, 4335572783⟩, ⟨9269761, 21324023⟩, ⟨2163630, 3100600⟩, ⟨(-26099), 100949⟩, ⟨(-277), 7016⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3751072689, 4056860488⟩, ⟨(-131278202), (-118404265)⟩, ⟨1200044, 2603325⟩, ⟨(-124084), 24916⟩, ⟨(-3505), 7404⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3340081308, 6680162642⟩, ⟨1670040654, 1670040667⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2597491988, 10389968037⟩, ⟨2597491988, 5194984040⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2597491988, 10389968037⟩, ⟨2597491988, 5194984040⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10389968037), (-2597491988)⟩, ⟨(-5194984040), (-2597491988)⟩, ⟨(-649373008), (-649372997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5194984019), (-1298745994)⟩, ⟨(-2597492020), (-1298745994)⟩, ⟨(-324686504), (-324686498)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1281322138, 3174201409⟩, ⟨(-1919680003), (-387456266)⟩, ⟨(-181378965), 483623880⟩, ⟨(-77967652), 133312525⟩, ⟨(-38436295), 18644087⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1119061484, 2998228250⟩, ⟨(-1910277040), (-373714282)⟩, ⟨(-160284118), 517412608⟩, ⟨(-89682776), 131375984⟩, ⟨(-40503887), 20347688⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨414152958, 414152959⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317078727, 4317078729⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3132
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨276101972, 552203946⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304502588, 4335572783⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3133
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (129046147 / 4294967296)

theorem envelope_integral : (∫ s in ((12857 / 200000) : ℝ)..(12857 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((12857 / 200000) : ℝ)..(12857 / 100000), prawitzNormalCorrection
