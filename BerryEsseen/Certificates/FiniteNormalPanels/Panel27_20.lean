...
namespace FiniteNormalPanel27_20
...
def j2 : Jet := ⟨⟨609716639, 609716643⟩, ⟨609716639, 609716643⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨86555811, 86555813⟩, ⟨173111622, 173111626⟩, ⟨86555811, 86555813⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1908), (-1907)⟩, ⟨(-3816), (-3814)⟩, ⟨(-1907), (-1904)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111148, 5111150⟩, ⟨(-3816), (-3814)⟩, ⟨(-1907), (-1904)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨103004, 103005⟩, ⟨205931, 205933⟩, ⟨102811, 102814⟩, ⟨(-154), (-151)⟩, ⟨(-39), (-36)⟩⟩
...
def j16 : Jet := ⟨⟨(-143062573), (-143062571)⟩, ⟨205931, 205933⟩, ⟨102811, 102814⟩, ⟨(-154), (-151)⟩, ⟨(-39), (-36)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2883118), (-2883117)⟩, ⟨(-5762086), (-5762084)⟩, ⟨(-2872747), (-2872744)⟩, ⟨8289, 8292⟩, ⟨2063, 2066⟩⟩
...
def j19 : Jet := ⟨⟨1428772647, 1428772649⟩, ⟨(-5762086), (-5762084)⟩, ⟨(-2872747), (-2872744)⟩, ⟨8289, 8292⟩, ⟨2063, 2066⟩⟩
...
def j25 : Jet := ⟨⟨238, 239⟩, ⟨475, 477⟩, ⟨236, 239⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851939), (-851937)⟩, ⟨475, 477⟩, ⟨236, 239⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-17169), (-17168)⟩, ⟨(-34329), (-34327)⟩, ⟨(-17146), (-17143)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35774225, 35774227⟩, ⟨(-34329), (-34327)⟩, ⟨(-17146), (-17143)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨720952, 720953⟩, ⟨1441212, 1441214⟩, ⟨719222, 719225⟩, ⟨(-1384), (-1380)⟩, ⟨(-346), (-343)⟩⟩
...
def j33 : Jet := ⟨⟨(-715106931), (-715106929)⟩, ⟨1441212, 1441214⟩, ⟨719222, 719225⟩, ⟨(-1384), (-1380)⟩, ⟨(-346), (-343)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-14411440), (-14411439)⟩, ⟨(-28793836), (-28793833)⟩, ⟨(-14338857), (-14338854)⟩, ⟨58004, 58007⟩, ⟨14431, 14434⟩⟩
...
def j36 : Jet := ⟨⟨4280555856, 4280555857⟩, ⟨(-28793836), (-28793833)⟩, ⟨(-14338857), (-14338854)⟩, ⟨58004, 58007⟩, ⟨14431, 14434⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨202829590, 202829592⟩, ⟨202011600, 202011603⟩, ⟨(-1225808), (-1225805)⟩, ⟨(-406642), (-406638)⟩, ⟨1468, 1472⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4309427254, 4309427256⟩, ⟨28988040, 28988045⟩, ⟨14630557, 14630563⟩, ⟨137118, 137125⟩, ⟨35005, 35013⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨203512460, 203512463⟩, ⟨204060674, 204060679⟩, ⟨824429, 824435⟩, ⟨278329, 278338⟩, ⟨2653, 2662⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-194078835), (-194078834)⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4100888461, 4100888462⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨9643221, 9643222⟩, ⟨19338396, 19338398⟩, ⟨9773372, 9773376⟩, ⟨104714, 104720⟩, ⟨26854, 26863⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4304610517, 4304610518⟩, ⟨19338396, 19338398⟩, ⟨9773372, 9773376⟩, ⟨104714, 104720⟩, ⟨26854, 26863⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299786203, 4299786204⟩, ⟨9658361, 9658363⟩, ⟨4870361, 4870365⟩, ⟨41357, 41362⟩, ⟨10559, 10566⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4105489613, 4105489616⟩, ⟨(-185074667), (-185074662)⟩, ⟨4213843, 4213849⟩, ⟨(-180592), (-180586)⟩, ⟨8211, 8221⟩⟩
...
def j47 : Jet := ⟨⟨1107277971, 1107277978⟩, ⟨1107277971, 1107277978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨285465387, 285465392⟩, ⟨570930774, 570930784⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨285465387, 285465392⟩, ⟨570930774, 570930784⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-285465392), (-285465387)⟩, ⟨(-570930784), (-570930774)⟩, ⟨(-285465392), (-285465387)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-142732696), (-142732693)⟩, ⟨(-285465392), (-285465387)⟩, ⟨(-142732696), (-142732693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4154580229, 4154580233⟩, ⟨(-276134554), (-276134547)⟩, ⟨(-128890624), (-128890619)⟩, ⟨8973344, 8973346⟩, ⟨1992577, 1992579⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3971295891, 3971295899⟩, ⟨(-442977785), (-442977772)⟩, ⟨(-107229424), (-107229410)⟩, ⟨13685896, 13685908⟩, ⟨1411096, 1411112⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 388157670⟩, ⟨194078834, 194078835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1219433285⟩, ⟨609716639, 609716643⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 346223251⟩, ⟨0, 346223252⟩, ⟨86555811, 86555813⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 87⟩, ⟨0, 87⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94599)⟩, ⟨0, 87⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-7633), 0⟩, ⟨(-7633), 8⟩, ⟨(-1909), (-1896)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5105423, 5113057⟩, ⟨(-7633), 8⟩, ⟨(-1909), (-1896)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 412171⟩, ⟨(-616), 412172⟩, ⟨102118, 103044⟩, ⟨(-308), 2⟩, ⟨(-39), (-36)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142753405)⟩, ⟨(-616), 412172⟩, ⟨102118, 103044⟩, ⟨(-308), 2⟩, ⟨(-39), (-36)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-11540776), 0⟩, ⟨(-11540826), 33226⟩, ⟨(-2885244), (-2835354)⟩, ⟨(-38), 16615⟩, ⟨2028, 2078⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1420114989, 1431655766⟩, ⟨(-11540826), 33226⟩, ⟨(-2885244), (-2835354)⟩, ⟨(-38), 16615⟩, ⟨2028, 2078⟩⟩
...
def j72 : Jet := ⟨⟨0, 955⟩, ⟨(-1), 955⟩, ⟨236, 239⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851221)⟩, ⟨(-1), 955⟩, ⟨236, 239⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-68696), 0⟩, ⟨(-68697), 77⟩, ⟨(-17175), (-17057)⟩, ⟨(-2), 40⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35722698, 35791395⟩, ⟨(-68697), 77⟩, ⟨(-17175), (-17057)⟩, ⟨(-2), 40⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2885194⟩, ⟨(-5538), 2885201⟩, ⟨712991, 721306⟩, ⟨(-2771), 6⟩, ⟨(-348), (-338)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712942688)⟩, ⟨(-5538), 2885201⟩, ⟨712991, 721306⟩, ⟨(-2771), 6⟩, ⟨(-348), (-338)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-57703876), 0⟩, ⟨(-57704323), 232581⟩, ⟨(-14426416), (-14077096)⟩, ⟨(-336), 116293⟩, ⟨14115, 14538⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4237263420, 4294967296⟩, ⟨(-57704323), 232581⟩, ⟨(-14426416), (-14077096)⟩, ⟨(-336), 116293⟩, ⟨14115, 14538⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 406477762⟩, ⟨198323854, 203248316⟩, ⟨(-2457527), 4717⟩, ⟨(-409603), (-397790)⟩, ⟨(-6), 2949⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4353456995⟩, ⟨(-238960), 59286683⟩, ⟨14073885, 15629400⟩, ⟨(-121155), 415044⟩, ⟨28158, 44566⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 412013256⟩, ⟨198301238, 211627113⟩, ⟨(-2502304), 4289547⟩, ⟨189300, 381249⟩, ⟨(-20339), 26890⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-388157670), 0⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3906809626, 4294967296⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 39524149⟩, ⟨0, 40602488⟩, ⟨8675598, 11250550⟩, ⟨(-246594), 495868⟩, ⟨11076, 47017⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4334491445⟩, ⟨0, 40602488⟩, ⟨8675598, 11250550⟩, ⟨(-246594), 495868⟩, ⟨11076, 47017⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4314684114⟩, ⟨0, 20301244⟩, ⟨4270216, 5625275⟩, ⟨(-149887), 247934⟩, ⟨678, 22095⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3906809626, 4314684114⟩, ⟨(-194969789), (-173777590)⟩, ⟨2966932, 5625275⟩, ⟨(-404080), 54974⟩, ⟨(-10588), 28869⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2214555955⟩, ⟨1107277971, 1107277978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1141861565⟩, ⟨0, 1141861566⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1141861565⟩, ⟨0, 1141861566⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1141861565), 0⟩, ⟨(-1141861566), 0⟩, ⟨(-285465392), (-285465387)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-570930783), 0⟩, ⟨(-570930783), 0⟩, ⟨(-142732696), (-142732693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3760356471, 4294967296⟩, ⟨(-570930783), 0⟩, ⟨(-142732696), (-87019248)⟩, ⟨0, 18973484⟩, ⟨815398, 2371686⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3420514254, 4314684114⟩, ⟨(-768521533), (-152146836)⟩, ⟨(-140790311), (-47612238)⟩, ⟨2369014, 25594903⟩, ⟨(-324434), 2405046⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299786203, 4299786204⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified544
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4314684114⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified545
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (355719053 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(723 / 8000), prawitzNormalCorrection
