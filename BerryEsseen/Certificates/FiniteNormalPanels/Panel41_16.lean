...
namespace FiniteNormalPanel41_16
...
def j47 : Jet := ⟨⟨3531921473, 3531921481⟩, ⟨1177307157, 1177307165⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2904438714, 2904438728⟩, ⟨1936292474, 1936292494⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2904438714, 2904438728⟩, ⟨1936292474, 1936292494⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2904438728), (-2904438714)⟩, ⟨(-1936292494), (-1936292474)⟩, ⟨(-322715417), (-322715412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1452219364), (-1452219357)⟩, ⟨(-968146247), (-968146237)⟩, ⟨(-161357709), (-161357706)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3062779298, 3062779307⟩, ⟨(-690393684), (-690393674)⟩, ⟨(-37253377), (-37253371)⟩, ⟨20090753, 20090755⟩, ⟨(-432399), (-432398)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2691843878, 2691843889⟩, ⟨(-723076586), (-723076570)⟩, ⟨(-4351306), (-4351294)⟩, ⟨18501636, 18501649⟩, ⟨(-1147958), (-1147945)⟩⟩
...
def j89 : Jet := ⟨⟨2354614315, 4709228646⟩, ⟨1177307157, 1177307165⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1290861650, 5163446637⟩, ⟨1290861648, 2581723328⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1290861650, 5163446637⟩, ⟨1290861648, 2581723328⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5163446637), (-1290861650)⟩, ⟨(-2581723328), (-1290861648)⟩, ⟨(-322715417), (-322715412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2581723319), (-645430825)⟩, ⟨(-1290861664), (-645430824)⟩, ⟨(-161357709), (-161357706)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2354526477, 3695692184⟩, ⟨(-1110748240), (-353828995)⟩, ⟨(-112257515), 78461639⟩, ⟨1001400, 39066228⟩, ⟨(-4409224), 2071081⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1956483688, 3436652133⟩, ⟨(-1183502305), (-375168034)⟩, ⟨(-91610087), 122920496⟩, ⟨(-4119337), 41000961⟩, ⟨(-5913820), 2128785⟩⟩
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified816
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified817
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (57953519 / 1073741824)
