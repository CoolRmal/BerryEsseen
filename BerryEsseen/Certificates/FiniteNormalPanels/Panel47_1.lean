...
namespace FiniteNormalPanel47_1

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (36411 / 400000)
def radius : Rat := (36411 / 400000)

def j0 : Jet := ⟨⟨390960135, 390960136⟩, ⟨390960135, 390960136⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1228237487, 1228237492⟩, ⟨1228237487, 1228237492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨351240701, 351240705⟩, ⟨702481402, 702481410⟩, ⟨351240701, 351240705⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨87, 88⟩, ⟨175, 176⟩, ⟨87, 88⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94600), (-94598)⟩, ⟨175, 176⟩, ⟨87, 88⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-7737), (-7736)⟩, ⟨(-15459), (-15457)⟩, ⟨(-7702), (-7699)⟩, ⟨28, 30⟩, ⟨7, 8⟩⟩
...
def j13 : Jet := ⟨⟨5105319, 5105321⟩, ⟨(-15459), (-15457)⟩, ⟨(-7702), (-7699)⟩, ⟨28, 30⟩, ⟨7, 8⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨417510, 417512⟩, ⟨833756, 833759⟩, ⟨414351, 414355⟩, ⟨(-2523), (-2520)⟩, ⟨(-626), (-623)⟩⟩
...
def j16 : Jet := ⟨⟨(-142748067), (-142748064)⟩, ⟨833756, 833759⟩, ⟨414351, 414355⟩, ⟨(-2523), (-2520)⟩, ⟨(-626), (-623)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-11673880), (-11673879)⟩, ⟨(-23279576), (-23279573)⟩, ⟨(-11503627), (-11503624)⟩, ⟨135747, 135751⟩, ⟨33420, 33424⟩⟩
...
def j19 : Jet := ⟨⟨1419981885, 1419981887⟩, ⟨(-23279576), (-23279573)⟩, ⟨(-11503627), (-11503624)⟩, ⟨135747, 135751⟩, ⟨33420, 33424⟩⟩
...
def j25 : Jet := ⟨⟨967, 968⟩, ⟨1932, 1934⟩, ⟨963, 966⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851210), (-851208)⟩, ⟨1932, 1934⟩, ⟨963, 966⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-69612), (-69611)⟩, ⟨(-139067), (-139063)⟩, ⟨(-69219), (-69215)⟩, ⟨313, 317⟩, ⟨76, 79⟩⟩
...
def j30 : Jet := ⟨⟨35721782, 35721784⟩, ⟨(-139067), (-139063)⟩, ⟨(-69219), (-69215)⟩, ⟨313, 317⟩, ⟨76, 79⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2921312, 2921314⟩, ⟨5831252, 5831255⟩, ⟨2892905, 2892909⟩, ⟨(-22670), (-22666)⟩, ⟨(-5604), (-5601)⟩⟩
...
def j33 : Jet := ⟨⟨(-712906571), (-712906568)⟩, ⟨5831252, 5831255⟩, ⟨2892905, 2892909⟩, ⟨(-22670), (-22666)⟩, ⟨(-5604), (-5601)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-58301214), (-58301212)⟩, ⟨(-116125551), (-116125547)⟩, ⟨(-57110880), (-57110875)⟩, ⟨948184, 948187⟩, ⟨232413, 232416⟩⟩
...
def j36 : Jet := ⟨⟨4236666082, 4236666084⟩, ⟨(-116125551), (-116125547)⟩, ⟨(-57110880), (-57110875)⟩, ⟨948184, 948187⟩, ⟨232413, 232416⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨406074100, 406074103⟩, ⟨399416808, 399416813⟩, ⟨(-9947000), (-9946996)⟩, ⟨(-3250889), (-3250885)⟩, ⟨48376, 48380⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4354070797, 4354070800⟩, ⟨119343568, 119343575⟩, ⟨61964671, 61964680⟩, ⟨2332734, 2332741⟩, ⟨633663, 633671⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨411662128, 411662133⟩, ⟨416196740, 416196748⟩, ⟨6873190, 6873199⟩, ⟨2411025, 2411035⟩, ⟨92046, 92056⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-390960136), (-390960135)⟩, ⟨(-390960136), (-390960135)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3904007160, 3904007161⟩, ⟨(-390960136), (-390960135)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨39456809, 39456811⟩, ⟨79782882, 79782886⟩, ⟨41648416, 41648422⟩, ⟨1794250, 1794258⟩, ⟨495915, 495924⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4334424105, 4334424107⟩, ⟨79782882, 79782886⟩, ⟨41648416, 41648422⟩, ⟨1794250, 1794258⟩, ⟨495915, 495924⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4314650597, 4314650599⟩, ⟨39709457, 39709460⟩, ⟨20546477, 20546482⟩, ⟨703933, 703939⟩, ⟨191425, 191432⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3921898739, 3921898743⟩, ⟨(-356657054), (-356657048)⟩, ⟨15061529, 15061536⟩, ⟨(-1230440), (-1230432)⟩, ⟨109922, 109930⟩⟩
...
def j47 : Jet := ⟨⟨2153913295, 2153913302⟩, ⟨2153913295, 2153913302⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1080181096, 1080181104⟩, ⟨2160362192, 2160362208⟩, ⟨1080181096, 1080181104⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1080181096, 1080181104⟩, ⟨2160362192, 2160362208⟩, ⟨1080181096, 1080181104⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1080181104), (-1080181096)⟩, ⟨(-2160362208), (-2160362192)⟩, ⟨(-1080181104), (-1080181096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-540090552), (-540090548)⟩, ⟨(-1080181104), (-1080181096)⟩, ⟨(-540090552), (-540090548)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3787455076, 3787455083⟩, ⟨(-952542158), (-952542148)⟩, ⟨(-356489257), (-356489249)⟩, ⟨109740142, 109740145⟩, ⟨15514304, 15514306⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3458469940, 3458469950⟩, ⟨(-1184315529), (-1184315512)⟩, ⟨(-233142413), (-233142394)⟩, ⟨125385620, 125385637⟩, ⟨4173492, 4173508⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 781920272⟩, ⟨390960135, 390960136⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2456474983⟩, ⟨1228237487, 1228237492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1404962815⟩, ⟨0, 1404962816⟩, ⟨351240701, 351240705⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 352⟩, ⟨0, 352⟩, ⟨87, 88⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94334)⟩, ⟨0, 352⟩, ⟨87, 88⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-30974), 0⟩, ⟨(-30974), 116⟩, ⟨(-7744), (-7569)⟩, ⟨0, 58⟩, ⟨7, 8⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5082082, 5113057⟩, ⟨(-30974), 116⟩, ⟨(-7744), (-7569)⟩, ⟨0, 58⟩, ⟨7, 8⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1672576⟩, ⟨(-10133), 1672614⟩, ⟨402943, 418182⟩, ⟨(-5068), 29⟩, ⟨(-634), (-596)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141493000)⟩, ⟨(-10133), 1672614⟩, ⟨402943, 418182⟩, ⟨(-5068), 29⟩, ⟨(-634), (-596)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-46832094), 0⟩, ⟨(-46835410), 547143⟩, ⟨(-11711339), (-10887301)⟩, ⟨(-2487), 273592⟩, ⟨31086, 34209⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1384823671, 1431655766⟩, ⟨(-46835410), 547143⟩, ⟨(-11711339), (-10887301)⟩, ⟨(-2487), 273592⟩, ⟨31086, 34209⟩⟩
...
def j72 : Jet := ⟨⟨0, 3872⟩, ⟨(-12), 3872⟩, ⟨949, 968⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848304)⟩, ⟨(-12), 3872⟩, ⟨949, 968⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-278763), 0⟩, ⟨(-278767), 1267⟩, ⟨(-69695), (-67789)⟩, ⟨(-3), 634⟩, ⟨74, 80⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35512631, 35791395⟩, ⟨(-278767), 1267⟩, ⟨(-69695), (-67789)⟩, ⟨(-3), 634⟩, ⟨74, 80⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 11708024⟩, ⟨(-91190), 11708439⟩, ⟨2790219, 2927421⟩, ⟨(-45598), 312⟩, ⟨(-5701), (-5308)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-704119858)⟩, ⟨(-91190), 11708439⟩, ⟨2790219, 2927421⟩, ⟨(-45598), 312⟩, ⟨(-5701), (-5308)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-234160470), 0⟩, ⟨(-234190300), 3830046⟩, ⟨(-58569948), (-52794979)⟩, ⟨(-22374), 1915229⟩, ⟨211401, 239507⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4060806826, 4294967296⟩, ⟨(-234190300), 3830046⟩, ⟨(-58569948), (-52794979)⟩, ⟨(-22374), 1915229⟩, ⟨211401, 239507⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 818824995⟩, ⟨369232690, 409725433⟩, ⟨(-20091800), 156468⟩, ⟨(-3350531), (-2956976)⟩, ⟨(-712), 97806⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4542630287⟩, ⟨(-4284490), 261977484⟩, ⟨52561359, 80627872⟩, ⟨(-2280320), 8453474⟩, ⟨151619, 1428865⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 866041338⟩, ⟨368415862, 483297016⟩, ⟨(-21659091), 40528769⟩, ⟨(-685371), 6366330⟩, ⟨(-799837), 1188570⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-781920272), 0⟩, ⟨(-390960136), (-390960135)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3513047024, 4294967296⟩, ⟨(-390960136), (-390960135)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 174629409⟩, ⟨0, 194904952⟩, ⟨22867440, 70728172⟩, ⟨(-5150836), 11688536⟩, ⟨(-681189), 2294534⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4469596705⟩, ⟨0, 194904952⟩, ⟨22867440, 70728172⟩, ⟨(-5150836), 11688536⟩, ⟨(-681189), 2294534⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4381412064⟩, ⟨0, 97452476⟩, ⟨10124352, 35364086⟩, ⟨(-3377827), 5844268⟩, ⟨(-618792), 1211978⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3513047024, 4381412064⟩, ⟨(-398828988), (-293507659)⟩, ⟨(-589693), 35364086⟩, ⟨(-6596932), 4922674⟩, ⟨(-1150782), 1519454⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4307826603⟩, ⟨2153913295, 2153913302⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4320724412⟩, ⟨0, 4320724414⟩, ⟨1080181096, 1080181104⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4320724412⟩, ⟨0, 4320724414⟩, ⟨1080181096, 1080181104⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4320724412), 0⟩, ⟨(-4320724414), 0⟩, ⟨(-1080181104), (-1080181096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2160362206), 0⟩, ⟨(-2160362207), 0⟩, ⟨(-540090552), (-540090548)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2597229799, 4294967296⟩, ⟨(-2160362207), 0⟩, ⟨(-540090552), 216728814⟩, ⟨(-36338092), 271664751⟩, ⟨(-47788527), 38527596⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2124391127, 4381412064⟩, ⟨(-2602672786), (-177488391)⟩, ⟨(-551550643), 457065391⟩, ⟨(-81579839), 332504433⟩, ⟨(-82050951), 49299597⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨390960135, 390960136⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨390960135, 390960136⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4314650597, 4314650599⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified912
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 781920272⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4381412064⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified913
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (617278549 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(36411 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(36411 / 200000), prawitzNormalCorrection
