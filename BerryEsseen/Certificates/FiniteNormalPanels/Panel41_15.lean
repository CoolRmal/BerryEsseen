...
namespace FiniteNormalPanel41_15
...
def j2 : Jet := ⟨⟨581212598, 581212602⟩, ⟨581212598, 581212602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨78652073, 78652075⟩, ⟨157304146, 157304150⟩, ⟨78652073, 78652075⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1734), (-1733)⟩, ⟨(-3468), (-3466)⟩, ⟨(-1733), (-1730)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111322, 5111324⟩, ⟨(-3468), (-3466)⟩, ⟨(-1733), (-1730)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨93601, 93602⟩, ⟨187139, 187141⟩, ⟨93441, 93445⟩, ⟨(-128), (-125)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-143071976), (-143071974)⟩, ⟨187139, 187141⟩, ⟨93441, 93445⟩, ⟨(-128), (-125)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2620022), (-2620021)⟩, ⟨(-5236617), (-5236615)⟩, ⟨(-2611457), (-2611454)⟩, ⟨6846, 6849⟩, ⟨1705, 1708⟩⟩
...
def j19 : Jet := ⟨⟨1429035743, 1429035745⟩, ⟨(-5236617), (-5236615)⟩, ⟨(-2611457), (-2611454)⟩, ⟨6846, 6849⟩, ⟨1705, 1708⟩⟩
...
def j25 : Jet := ⟨⟨216, 217⟩, ⟨432, 434⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851961), (-851959)⟩, ⟨432, 434⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-15602), (-15601)⟩, ⟨(-31197), (-31195)⟩, ⟨(-15584), (-15581)⟩, ⟨13, 16⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35775792, 35775794⟩, ⟨(-31197), (-31195)⟩, ⟨(-15584), (-15581)⟩, ⟨13, 16⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨655148, 655149⟩, ⟨1309724, 1309726⟩, ⟨653719, 653722⟩, ⟨(-1143), (-1140)⟩, ⟨(-286), (-283)⟩⟩
...
def j33 : Jet := ⟨⟨(-715172735), (-715172733)⟩, ⟨1309724, 1309726⟩, ⟨653719, 653722⟩, ⟨(-1143), (-1140)⟩, ⟨(-286), (-283)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-13096682), (-13096681)⟩, ⟨(-26169380), (-26169377)⟩, ⟨(-13036743), (-13036739)⟩, ⟨47905, 47908⟩, ⟨11923, 11926⟩⟩
...
def j36 : Jet := ⟨⟨4281870614, 4281870615⟩, ⟨(-26169380), (-26169377)⟩, ⟨(-13036743), (-13036739)⟩, ⟨47905, 47908⟩, ⟨11923, 11926⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨193382980, 193382983⟩, ⟨192674339, 192674343⟩, ⟨(-1062035), (-1062032)⟩, ⟨(-352468), (-352465)⟩, ⟨1156, 1159⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4308104034, 4308104036⟩, ⟨26329706, 26329711⟩, ⟨13277527, 13277534⟩, ⟨113108, 113115⟩, ⟨28820, 28829⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨193974467, 193974472⟩, ⟨194449166, 194449172⟩, ⟨713706, 713712⟩, ⟨240670, 240678⟩, ⟨2085, 2094⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-185005717), (-185005716)⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4109961579, 4109961580⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8760507, 8760509⟩, ⟨17563892, 17563896⟩, ⟨8867903, 8867907⟩, ⟨86362, 86366⟩, ⟨22098, 22103⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303727803, 4303727805⟩, ⟨17563892, 17563896⟩, ⟨8867903, 8867907⟩, ⟨86362, 86366⟩, ⟨22098, 22103⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299345318, 4299345320⟩, ⟨8773003, 8773006⟩, ⟨4420485, 4420489⟩, ⟨34116, 34120⟩, ⟨8695, 8700⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4114151017, 4114151021⟩, ⟨(-176799196), (-176799190)⟩, ⟨3852174, 3852180⟩, ⟨(-157767), (-157761)⟩, ⟨6850, 6857⟩⟩
...
def j47 : Jet := ⟨⟨1177307157, 1177307165⟩, ⟨1177307157, 1177307165⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨322715412, 322715417⟩, ⟨645430824, 645430834⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨322715412, 322715417⟩, ⟨645430824, 645430834⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-322715417), (-322715412)⟩, ⟨(-645430834), (-645430824)⟩, ⟨(-322715417), (-322715412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-161357709), (-161357706)⟩, ⟨(-322715417), (-322715412)⟩, ⟨(-161357709), (-161357706)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4136603008, 4136603012⟩, ⟨(-310816236), (-310816230)⟩, ⟨(-143731058), (-143731053)⟩, ⟨11384596, 11384598⟩, ⟨2486063, 2486064⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3962453797, 3962453806⟩, ⟨(-468011253), (-468011239)⟩, ⟨(-121175385), (-121175370)⟩, ⟨16391169, 16391181⟩, ⟨1801860, 1801875⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 370011433⟩, ⟨185005716, 185005717⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1162425200⟩, ⟨581212598, 581212602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 314608297⟩, ⟨0, 314608298⟩, ⟨78652073, 78652075⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 79⟩, ⟨0, 79⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94607)⟩, ⟨0, 79⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6936), 0⟩, ⟨(-6936), 6⟩, ⟨(-1734), (-1724)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106120, 5113057⟩, ⟨(-6936), 6⟩, ⟨(-1734), (-1724)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 374534⟩, ⟨(-509), 374535⟩, ⟨92869, 93635⟩, ⟨(-256), 2⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142791042)⟩, ⟨(-509), 374535⟩, ⟨92869, 93635⟩, ⟨(-256), 2⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-10486944), 0⟩, ⟨(-10486982), 27435⟩, ⟨(-2621774), (-2580583)⟩, ⟨(-29), 13719⟩, ⟨1678, 1716⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421168821, 1431655766⟩, ⟨(-10486982), 27435⟩, ⟨(-2621774), (-2580583)⟩, ⟨(-29), 13719⟩, ⟨1678, 1716⟩⟩
...
def j72 : Jet := ⟨⟨0, 867⟩, ⟨(-1), 867⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851309)⟩, ⟨(-1), 867⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-62423), 0⟩, ⟨(-62424), 64⟩, ⟨(-15607), (-15509)⟩, ⟨(-2), 32⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35728971, 35791395⟩, ⟨(-62424), 64⟩, ⟨(-15607), (-15509)⟩, ⟨(-2), 32⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2621736⟩, ⟨(-4573), 2621741⟩, ⟨648573, 655439⟩, ⟨(-2289), 5⟩, ⟨(-287), (-280)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713206146)⟩, ⟨(-4573), 2621741⟩, ⟨648573, 655439⟩, ⟨(-2289), 5⟩, ⟨(-287), (-280)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-52434717), 0⟩, ⟨(-52435052), 192044⟩, ⟨(-13109015), (-12820611)⟩, ⟨(-252), 96024⟩, ⟨11687, 12004⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4242532579, 4294967296⟩, ⟨(-52435052), 192044⟩, ⟨(-13109015), (-12820611)⟩, ⟨(-252), 96024⟩, ⟨11687, 12004⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 387475067⟩, ⟨189480113, 193744961⟩, ⟨(-2128721), 3713⟩, ⟨(-354798), (-345501)⟩, ⟨(-4), 2322⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4348050070⟩, ⟨(-196821), 53739183⟩, ⟨12818208, 14099239⟩, ⟨(-99660), 340567⟩, ⟨23690, 35949⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 392263987⟩, ⟨189462356, 200987651⟩, ⟨(-2163910), 3699899⟩, ⟨170688, 321336⟩, ⟨(-15930), 20988⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-370011433), 0⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3924955863, 4294967296⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 35825893⟩, ⟨0, 36712838⟩, ⟨7962419, 10081268⟩, ⟨(-202526), 404978⟩, ⟨10283, 37098⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4330793189⟩, ⟨0, 36712838⟩, ⟨7962419, 10081268⟩, ⟨(-202526), 404978⟩, ⟨10283, 37098⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4312843043⟩, ⟨0, 18356419⟩, ⟨3925643, 5040634⟩, ⟨(-122807), 202489⟩, ⟨1312, 17280⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3924955863, 4312843043⟩, ⟨(-185775715), (-166649297)⟩, ⟨2796745, 5040634⟩, ⟨(-339933), 33392⟩, ⟨(-7525), 22570⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2354614323⟩, ⟨1177307157, 1177307165⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1290861660⟩, ⟨0, 1290861664⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1290861660⟩, ⟨0, 1290861664⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1290861660), 0⟩, ⟨(-1290861664), 0⟩, ⟨(-322715417), (-322715412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-645430830), 0⟩, ⟨(-645430832), 0⟩, ⟨(-161357709), (-161357706)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3695692177, 4294967296⟩, ⟨(-645430832), 0⟩, ⟨(-161357709), (-90347121)⟩, ⟨0, 24248204⟩, ⟨786145, 3031026⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3377308295, 4312843043⟩, ⟨(-833892845), (-143396785)⟩, ⟨(-159622768), (-49605436)⟩, ⟨2408144, 31361930⟩, ⟨(-532337), 3058465⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299345318, 4299345320⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified814
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4312843043⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified815
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (337938341 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1723 / 20000), prawitzNormalCorrection
