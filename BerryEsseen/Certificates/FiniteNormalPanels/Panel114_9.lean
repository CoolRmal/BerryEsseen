...
namespace FiniteNormalPanel114_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1121 / 6400)
def radius : Rat := (1121 / 32000)

def j0 : Jet := ⟨⟨752290365, 752290366⟩, ⟨150458073, 150458074⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2363389883, 2363389888⟩, ⟨472677976, 472677980⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1300501576, 1300501582⟩, ⟨520200628, 520200636⟩, ⟨52020062, 52020064⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨325, 326⟩, ⟨130, 131⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94362), (-94360)⟩, ⟨130, 131⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-28573), (-28571)⟩, ⟨(-11390), (-11388)⟩, ⟨(-1125), (-1121)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5084483, 5084486⟩, ⟨(-11390), (-11388)⟩, ⟨(-1125), (-1121)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1539564, 1539566⟩, ⟨612376, 612379⟩, ⟨59861, 59865⟩, ⟨(-275), (-270)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-141626013), (-141626010)⟩, ⟨612376, 612379⟩, ⟨59861, 59865⟩, ⟨(-275), (-270)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-42883879), (-42883876)⟩, ⟨(-16968127), (-16968123)⟩, ⟨(-1623061), (-1623057)⟩, ⟨14583, 14588⟩, ⟨686, 691⟩⟩
...
def j19 : Jet := ⟨⟨1388771886, 1388771890⟩, ⟨(-16968127), (-16968123)⟩, ⟨(-1623061), (-1623057)⟩, ⟨14583, 14588⟩, ⟨686, 691⟩⟩
...
def j22 : Jet := ⟨⟨(-33), (-32)⟩, ⟨(-14), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11802, 11804⟩, ⟨(-14), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3573, 3575⟩, ⟨1424, 1427⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848604), (-848601)⟩, ⟨1424, 1427⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-256955), (-256953)⟩, ⟨(-102351), (-102348)⟩, ⟨(-10065), (-10062)⟩, ⟨32, 36⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35534439, 35534442⟩, ⟨(-102351), (-102348)⟩, ⟨(-10065), (-10062)⟩, ⟨32, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10759707, 10759709⟩, ⟨4272891, 4272894⟩, ⟨414943, 414947⟩, ⟨(-2451), (-2446)⟩, ⟨(-120), (-115)⟩⟩
...
def j33 : Jet := ⟨⟨(-705068176), (-705068173)⟩, ⟨4272891, 4272894⟩, ⟨414943, 414947⟩, ⟨(-2451), (-2446)⟩, ⟨(-120), (-115)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-213492261), (-213492258)⟩, ⟨(-84103089), (-84103085)⟩, ⟨(-7896522), (-7896517)⟩, ⟨101266, 101271⟩, ⟨4691, 4696⟩⟩
...
def j36 : Jet := ⟨⟨4081475035, 4081475038⟩, ⟨(-84103089), (-84103085)⟩, ⟨(-7896522), (-7896517)⟩, ⟨101266, 101271⟩, ⟨4691, 4696⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨764198933, 764198937⟩, ⟨143502741, 143502747⟩, ⟨(-2760531), (-2760526)⟩, ⟨(-170601), (-170595)⟩, ⟨1981, 1987⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4519626826, 4519626830⟩, ⟨93131662, 93131669⟩, ⟨10663294, 10663302⟩, ⟨287768, 287778⟩, ⟨19048, 19059⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨804172362, 804172368⟩, ⟨167579844, 167579854⟩, ⟨2104079, 2104089⟩, ⟨168097, 168110⟩, ⟨4533, 4547⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-752290366), (-752290365)⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3542676930, 3542676931⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨150569991, 150569994⟩, ⟨62753948, 62753954⟩, ⟨7326501, 7326509⟩, ⟨227138, 227148⟩, ⟨15842, 15855⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4445537287, 4445537290⟩, ⟨62753948, 62753954⟩, ⟨7326501, 7326509⟩, ⟨227138, 227148⟩, ⟨15842, 15855⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4369603787, 4369603790⟩, ⟨30841028, 30841032⟩, ⟨3491839, 3491844⟩, ⟨86982, 86990⟩, ⟨5776, 5784⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3604240373, 3604240377⟩, ⟨(-127633655), (-127633649)⟩, ⟨1799821, 1799827⟩, ⟨(-50578), (-50569)⟩, ⟨1716, 1724⟩⟩
...
def j47 : Jet := ⟨⟨7151439438, 7151439450⟩, ⟨1430287887, 1430287898⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11907677640, 11907677681⟩, ⟨4763071054, 4763071100⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11907677640, 11907677681⟩, ⟨4763071054, 4763071100⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11907677681), (-11907677640)⟩, ⟨(-4763071100), (-4763071054)⟩, ⟨(-476307113), (-476307105)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5953838841), (-5953838820)⟩, ⟨(-2381535550), (-2381535527)⟩, ⟨(-238153557), (-238153552)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1073804344, 1073804363⟩, ⟨(-595418566), (-595418548)⟩, ⟨105536282, 105536293⟩, ⟨2503988, 2503993⟩, ⟨(-3273078), (-3273075)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨901112558, 901112576⟩, ⟨(-531572201), (-531572181)⟩, ⟨106707732, 106707747⟩, ⟨(-1297095), (-1297083)⟩, ⟨(-2769442), (-2769432)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨601832292, 902748439⟩, ⟨150458073, 150458074⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1890711907, 2836067865⟩, ⟨472677976, 472677980⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨832321009, 1872722278⟩, ⟨416160504, 624240764⟩, ⟨52020062, 52020064⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨208, 470⟩, ⟨104, 157⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94479), (-94216)⟩, ⟨104, 157⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-41196), (-18258)⟩, ⟨(-13712), (-9060)⟩, ⟨(-1133), (-1111)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5071860, 5094799⟩, ⟨(-13712), (-9060)⟩, ⟨(-1133), (-1111)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨982874, 2221471⟩, ⟨485458, 738736⟩, ⟨58941, 60616⟩, ⟨(-332), (-213)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142182703), (-140944105)⟩, ⟨485458, 738736⟩, ⟨58941, 60616⟩, ⟨(-332), (-213)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-61995517), (-27313535)⟩, ⟨(-20571097), (-13334658)⟩, ⟨(-1663638), (-1573294)⟩, ⟨11445, 17718⟩, ⟨657, 713⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1369660248, 1404342231⟩, ⟨(-20571097), (-13334658)⟩, ⟨(-1663638), (-1573294)⟩, ⟨11445, 17718⟩, ⟨657, 713⟩⟩
...
def j72 : Jet := ⟨⟨2284, 5153⟩, ⟨1135, 1717⟩, ⟨138, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849893), (-847023)⟩, ⟨1135, 1717⟩, ⟨138, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-370577), (-164144)⟩, ⟨(-123307), (-81323)⟩, ⟨(-10159), (-9946)⟩, ⟨25, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35420817, 35627251⟩, ⟨(-123307), (-81323)⟩, ⟨(-10159), (-9946)⟩, ⟨25, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6864194, 15534449⟩, ⟨3378331, 5162391⟩, ⟨406660, 421707⟩, ⟨(-2967), (-1928)⟩, ⟨(-123), (-112)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708963689), (-700293433)⟩, ⟨3378331, 5162391⟩, ⟨406660, 421707⟩, ⟨(-2967), (-1928)⟩, ⟨(-123), (-112)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-309127405), (-135709749)⟩, ⟨(-102387784), (-65603931)⟩, ⟨(-8180724), (-7547668)⟩, ⟨79026, 123446⟩, ⟨4439, 4901⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3985839891, 4159257547⟩, ⟨(-102387784), (-65603931)⟩, ⟨(-8180724), (-7547668)⟩, ⟨79026, 123446⟩, ⟨4439, 4901⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨602945904, 927320187⟩, ⟨137152896, 148683241⟩, ⟨(-3362470), (-2160119)⟩, ⟨(-178052), (-161447)⟩, ⟨1548, 2421⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4435105031, 4628069511⟩, ⟨69954870, 118885304⟩, ⟨9151636, 12552779⟩, ⟨133930, 478528⟩, ⟨9734, 31732⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨622619039, 999239806⟩, ⟨151448533, 185882934⟩, ⟨(-104611), 4595227⟩, ⟨26107, 335975⟩, ⟨(-7517), 18796⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-902748439), (-601832292)⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3392218857, 3693135004⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨90257839, 232476786⟩, ⟨43909410, 86492686⟩, ⟨5291678, 10183067⟩, ⟨(-1488), 554088⟩, ⟨(-1770), 42745⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4385225135, 4527444082⟩, ⟨43909410, 86492686⟩, ⟨5291678, 10183067⟩, ⟨(-1488), 554088⟩, ⟨(-1770), 42745⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4339861580, 4409673942⟩, ⟨21383608, 42798976⟩, ⟨2369316, 4986183⟩, ⟨(-49910), 262505⟩, ⟨(-6330), 20998⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3427676923, 3791768382⟩, ⟨(-137587352), (-115229005)⟩, ⟨372013, 3538401⟩, ⟨(-217590), 142722⟩, ⟨(-14640), 19805⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5721151550, 8581727338⟩, ⟨1430287887, 1430287898⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7620913688, 17147055852⟩, ⟨3810456842, 5715685318⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7620913688, 17147055852⟩, ⟨3810456842, 5715685318⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17147055852), (-7620913688)⟩, ⟨(-5715685318), (-3810456842)⟩, ⟨(-476307113), (-476307105)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8573527926), (-3810456844)⟩, ⟨(-2857842659), (-1905228421)⟩, ⟨(-238153557), (-238153552)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨583485260, 1768714169⟩, ⟨(-1176890639), (-258831470)⟩, ⟨(-40665976), 359193667⟩, ⟨(-70100318), 52524913⟩, ⟨(-18695977), 12788525⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨465661045, 1561491393⟩, ⟨(-1095665949), (-222219405)⟩, ⟨(-28906859), 356268809⟩, ⟨(-74453151), 47710162⟩, ⟨(-18266808), 13899555⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨752290365, 752290366⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4369603787, 4369603790⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2294
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨601832292, 902748439⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4339861580, 4409673942⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2295
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (32910519 / 2147483648)

theorem envelope_integral : (∫ s in ((1121 / 8000) : ℝ)..(3363 / 16000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (1121 / 8000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (3363 / 16000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((1121 / 8000) : ℝ)..(3363 / 16000), prawitzNormalCorrection
