...
namespace FiniteNormalPanel37_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (45841 / 160000)
def radius : Rat := (45841 / 800000)

def j0 : Jet := ⟨⟨1230534973, 1230534974⟩, ⟨246106994, 246106995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3865839631, 3865839635⟩, ⟨773167924, 773167928⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3479587857, 3479587865⟩, ⟨1391835138, 1391835148⟩, ⟨139183513, 139183515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨870, 872⟩, ⟨348, 349⟩, ⟨34, 35⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93817), (-93814)⟩, ⟨348, 349⟩, ⟨34, 35⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-76007), (-76003)⟩, ⟨(-30122), (-30118)⟩, ⟨(-2902), (-2897)⟩, ⟨22, 24⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5037049, 5037054⟩, ⟨(-30122), (-30118)⟩, ⟨(-2902), (-2897)⟩, ⟨22, 24⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4080788, 4080793⟩, ⟨1607911, 1607918⟩, ⟨151117, 151125⟩, ⟨(-1901), (-1894)⟩, ⟨(-88), (-83)⟩⟩
...
def j16 : Jet := ⟨⟨(-139084789), (-139084783)⟩, ⟨1607911, 1607918⟩, ⟨151117, 151125⟩, ⟨(-1901), (-1894)⟩, ⟨(-88), (-83)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-112680194), (-112680187)⟩, ⟨(-43769422), (-43769412)⟩, ⟨(-3863718), (-3863707)⟩, ⟨99536, 99547⟩, ⟨4208, 4218⟩⟩
...
def j19 : Jet := ⟨⟨1318975571, 1318975579⟩, ⟨(-43769422), (-43769412)⟩, ⟨(-3863718), (-3863707)⟩, ⟨99536, 99547⟩, ⟨4208, 4218⟩⟩
...
def j22 : Jet := ⟨⟨(-88), (-86)⟩, ⟨(-35), (-34)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11747, 11750⟩, ⟨(-35), (-34)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9516, 9520⟩, ⟨3777, 3781⟩, ⟨364, 368⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842661), (-842656)⟩, ⟨3777, 3781⟩, ⟨364, 368⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-682686), (-682681)⟩, ⟨(-270016), (-270008)⟩, ⟨(-25791), (-25782)⟩, ⟨235, 243⟩, ⟨8, 12⟩⟩
...
def j30 : Jet := ⟨⟨35108708, 35108714⟩, ⟨(-270016), (-270008)⟩, ⟨(-25791), (-25782)⟩, ⟨235, 243⟩, ⟨8, 12⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨28443484, 28443490⟩, ⟨11158638, 11158648⟩, ⟨1029342, 1029354⟩, ⟨(-16919), (-16906)⟩, ⟨(-754), (-746)⟩⟩
...
def j33 : Jet := ⟨⟨(-687384399), (-687384392)⟩, ⟨11158638, 11158648⟩, ⟨1029342, 1029354⟩, ⟨(-16919), (-16906)⟩, ⟨(-754), (-746)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-556887690), (-556887682)⟩, ⟨(-213714855), (-213714841)⟩, ⟨(-17825493), (-17825478)⟩, ⟨681470, 681489⟩, ⟨27263, 27276⟩⟩
...
def j36 : Jet := ⟨⟨3738079606, 3738079614⟩, ⟨(-213714855), (-213714841)⟩, ⟨(-17825493), (-17825478)⟩, ⟨681470, 681489⟩, ⟨27263, 27276⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1187191352, 1187191362⟩, ⟨198042028, 198042042⟩, ⟨(-11356928), (-11356914)⟩, ⟨(-605946), (-605932)⟩, ⟨21705, 21718⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4934818403, 4934818415⟩, ⟨282135224, 282135245⟩, ⟨39662606, 39662631⟩, ⟨2713332, 2713364⟩, ⟨256817, 256843⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1364055492, 1364055508⟩, ⟨305531998, 305532022⟩, ⟨10923797, 10923825⟩, ⟨1136604, 1136636⟩, ⟨76354, 76384⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1230534974), (-1230534973)⟩, ⟨(-246106995), (-246106994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3064432322, 3064432323⟩, ⟨(-246106995), (-246106994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨433215728, 433215739⟩, ⟨194070208, 194070228⟩, ⟨28673356, 28673380⟩, ⟨2276132, 2276160⟩, ⟨237989, 238020⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4728183024, 4728183035⟩, ⟨194070208, 194070228⟩, ⟨28673356, 28673380⟩, ⟨2276132, 2276160⟩, ⟨237989, 238020⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4506372316, 4506372323⟩, ⟨92482948, 92482958⟩, ⟨12715108, 12715121⟩, ⟨823726, 823743⟩, ⟨78567, 78584⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3215268482, 3215268489⟩, ⟨(-192234763), (-192234752)⟩, ⟨3772760, 3772772⟩, ⟨(-140870), (-140855)⟩, ⟨8855, 8870⟩⟩
...
def j47 : Jet := ⟨⟨4553963827, 4553963833⟩, ⟨910792763, 910792768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4828578452, 4828578465⟩, ⟨1931431374, 1931431390⟩, ⟨193143137, 193143140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4828578452, 4828578465⟩, ⟨1931431374, 1931431390⟩, ⟨193143137, 193143140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4828578465), (-4828578452)⟩, ⟨(-1931431390), (-1931431374)⟩, ⟨(-193143140), (-193143137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2414289233), (-2414289226)⟩, ⟨(-965715695), (-965715687)⟩, ⟨(-96571570), (-96571568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2448127441, 2448127456⟩, ⟨(-550457069), (-550457060)⟩, ⟨6838933, 6838937⟩, ⟨7738711, 7738713⟩, ⟨(-511896), (-511894)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1832700101, 1832700118⟩, ⟨(-521652977), (-521652960)⟩, ⟨31907617, 31907632⟩, ⟨4923373, 4923389⟩, ⟨(-700478), (-700461)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨984427979, 1476641969⟩, ⟨246106994, 246106995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3092671706, 4639007562⟩, ⟨773167924, 773167928⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2226936230, 5010606526⟩, ⟨1113468110, 1670202178⟩, ⟨139183513, 139183515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨557, 1256⟩, ⟨278, 419⟩, ⟨34, 35⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94130), (-93430)⟩, ⟨278, 419⟩, ⟨34, 35⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-109815), (-48443)⟩, ⟨(-36461), (-23732)⟩, ⟨(-2962), (-2823)⟩, ⟨17, 28⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5003241, 5064614⟩, ⟨(-36461), (-23732)⟩, ⟨(-2962), (-2823)⟩, ⟨17, 28⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2594175, 5908494⟩, ⟨1254550, 1957193⟩, ⟨144500, 156510⟩, ⟨(-2326), (-1467)⟩, ⟨(-92), (-77)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140571402), (-137257082)⟩, ⟨1254550, 1957193⟩, ⟨144500, 156510⟩, ⟨(-2326), (-1467)⟩, ⟨(-92), (-77)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-163993795), (-71167659)⟩, ⟨(-54014117), (-33300523)⟩, ⟨(-4155220), (-3504287)⟩, ⟨75402, 123529⟩, ⟨3669, 4653⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1267661970, 1360488107⟩, ⟨(-54014117), (-33300523)⟩, ⟨(-4155220), (-3504287)⟩, ⟨75402, 123529⟩, ⟨3669, 4653⟩⟩
...
def j70 : Jet := ⟨⟨(-126), (-55)⟩, ⟨(-42), (-27)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11709, 11781⟩, ⟨(-42), (-27)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6071, 13744⟩, ⟨2986, 4569⟩, ⟨357, 375⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846106), (-838432)⟩, ⟨2986, 4569⟩, ⟨357, 375⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-987087), (-434726)⟩, ⟨(-327481), (-212032)⟩, ⟨(-26461), (-24955)⟩, ⟨183, 295⟩, ⟨7, 13⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34804307, 35356669⟩, ⟨(-327481), (-212032)⟩, ⟨(-26461), (-24955)⟩, ⟨183, 295⟩, ⟨7, 13⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18045998, 41247895⟩, ⟨8640952, 13639361⟩, ⟨969654, 1077867⟩, ⟨(-20810), (-12995)⟩, ⟨(-808), (-677)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697781885), (-674579987)⟩, ⟨8640952, 13639361⟩, ⟨969654, 1077867⟩, ⟨(-20810), (-12995)⟩, ⟨(-808), (-677)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-814048217), (-349769045)⟩, ⟨(-266869082), (-158972533)⟩, ⟨(-19869525), (-15299103)⟩, ⟨507124, 854418⟩, ⟨22386, 31211⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3480919079, 3945198251⟩, ⟨(-266869082), (-158972533)⟩, ⟨(-19869525), (-15299103)⟩, ⟨507124, 854418⟩, ⟨22386, 31211⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨912803762, 1469467445⟩, ⟨169860122, 220932577⟩, ⟨(-14211537), (-8517993)⟩, ⟨(-693718), (-497406)⟩, ⟨16214, 27264⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4675745780, 5299388942⟩, ⟨188410087, 406284385⟩, ⟨25724117, 61397890⟩, ⟨619495, 6345077⟩, ⟨(-5893), 779405⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨993730113, 1813117305⟩, ⟨224961941, 411604843⟩, ⟨(-4616576), 32632541⟩, ⟨(-1051285), 4414018⟩, ⟨(-228648), 553857⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1476641969), (-984427979)⟩, ⟨(-246106995), (-246106994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2818325327, 3310539317⟩, ⟨(-246106995), (-246106994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨229920152, 765406146⟩, ⟨104099258, 347517368⟩, ⟨7885294, 66997438⟩, ⟨(-1772452), 9981380⟩, ⟨(-429625), 1561588⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4524887448, 5060373442⟩, ⟨104099258, 347517368⟩, ⟨7885294, 66997438⟩, ⟨(-1772452), 9981380⟩, ⟨(-429625), 1561588⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4408428700, 4661988679⟩, ⟨47951951, 169286591⟩, ⟨558681, 32375756⟩, ⟨(-2106668), 4856167⟩, ⟨(-514650), 841562⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2892777849, 3593437564⟩, ⟨(-235672070), (-122123216)⟩, ⟨(-9333732), 22207365⟩, ⟨(-3478982), 3711097⟩, ⟨(-674955), 769387⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3643171064, 5464756600⟩, ⟨910792763, 910792768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3090290213, 6953152991⟩, ⟨1545145100, 2317717668⟩, ⟨193143137, 193143140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3090290213, 6953152991⟩, ⟨1545145100, 2317717668⟩, ⟨193143137, 193143140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6953152991), (-3090290213)⟩, ⟨(-2317717668), (-1545145100)⟩, ⟨(-193143140), (-193143137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3476576496), (-1545145106)⟩, ⟨(-1158858834), (-772572550)⟩, ⟨(-96571570), (-96571568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1911695215, 2997224854⟩, ⟨(-808704761), (-343872990)⟩, ⟨(-36464375), 66117367⟩, ⟨(-791934), 15401968⟩, ⟨(-1782251), 463367⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1287578971, 2507665283⟩, ⟨(-841075614), (-285965049)⟩, ⟨(-27244184), 115190220⟩, ⟨(-10899799), 19234345⟩, ⟨(-3694600), 1964977⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1230534973, 1230534974⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4506372316, 4506372323⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified728
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨984427979, 1476641969⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4408428700, 4661988679⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified729
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (13205997 / 268435456)

theorem envelope_integral : (∫ s in ((45841 / 200000) : ℝ)..(137523 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((45841 / 200000) : ℝ)..(137523 / 400000), prawitzNormalCorrection
