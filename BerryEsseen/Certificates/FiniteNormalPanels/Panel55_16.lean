...
namespace FiniteNormalPanel55_16
...
def j2 : Jet := ⟨⟨1669206826, 1669206830⟩, ⟨556402275, 556402279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨648724713, 648724717⟩, ⟨432483140, 432483148⟩, ⟨72080523, 72080525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨162, 163⟩, ⟨108, 109⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94525), (-94523)⟩, ⟨108, 109⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-14278), (-14277)⟩, ⟨(-9503), (-9501)⟩, ⟨(-1575), (-1572)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098778, 5098780⟩, ⟨(-9503), (-9501)⟩, ⟨(-1575), (-1572)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨770134, 770135⟩, ⟨511987, 511989⟩, ⟨84375, 84378⟩, ⟨(-319), (-316)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-142395443), (-142395441)⟩, ⟨511987, 511989⟩, ⟨84375, 84378⟩, ⟨(-319), (-316)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-21507834), (-21507833)⟩, ⟨(-14261225), (-14261222)⟩, ⟨(-2325462), (-2325459)⟩, ⟨17039, 17043⟩, ⟨1378, 1383⟩⟩
...
def j19 : Jet := ⟨⟨1410147931, 1410147933⟩, ⟨(-14261225), (-14261222)⟩, ⟨(-2325462), (-2325459)⟩, ⟨17039, 17043⟩, ⟨1378, 1383⟩⟩
...
def j25 : Jet := ⟨⟨1785, 1786⟩, ⟨1188, 1190⟩, ⟨195, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850392), (-850390)⟩, ⟨1188, 1190⟩, ⟨195, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-128446), (-128445)⟩, ⟨(-85452), (-85450)⟩, ⟨(-14124), (-14121)⟩, ⟨37, 40⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35662948, 35662950⟩, ⟨(-85452), (-85450)⟩, ⟨(-14124), (-14121)⟩, ⟨37, 40⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5386638, 5386639⟩, ⟨3578185, 3578187⟩, ⟨587776, 587780⟩, ⟨(-2853), (-2848)⟩, ⟨(-235), (-230)⟩⟩
...
def j33 : Jet := ⟨⟨(-710441245), (-710441243)⟩, ⟨3578185, 3578187⟩, ⟨587776, 587780⟩, ⟨(-2853), (-2848)⟩, ⟨(-235), (-230)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-107307173), (-107307171)⟩, ⟨(-70997657), (-70997652)⟩, ⟨(-11473935), (-11473930)⟩, ⟨118806, 118809⟩, ⟨9540, 9545⟩⟩
...
def j36 : Jet := ⟨⟨4187660123, 4187660125⟩, ⟨(-70997657), (-70997652)⟩, ⟨(-11473935), (-11473930)⟩, ⟨118806, 118809⟩, ⟨9540, 9545⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨548043416, 548043419⟩, ⟨177138619, 177138625⟩, ⟨(-2751281), (-2751277)⟩, ⟨(-294636), (-294633)⟩, ⟨2742, 2746⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4405024171, 4405024174⟩, ⟨74682844, 74682852⟩, ⟨13335667, 13335675⟩, ⟨305741, 305749⟩, ⟨29562, 29572⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨562086816, 562086820⟩, ⟨191207355, 191207364⟩, ⟨1960032, 1960041⟩, ⟨238991, 239000⟩, ⟨5526, 5537⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-531325036), (-531325035)⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3763642260, 3763642261⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨73560883, 73560885⟩, ⟨50047008, 50047012⟩, ⟨9025369, 9025374⟩, ⟨237068, 237076⟩, ⟨23618, 23627⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4368528179, 4368528181⟩, ⟨50047008, 50047012⟩, ⟨9025369, 9025374⟩, ⟨237068, 237076⟩, ⟨23618, 23627⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4331591585, 4331591587⟩, ⟨24811926, 24811929⟩, ⟨4403466, 4403469⟩, ⟨92307, 92313⟩, ⟨8941, 8948⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3795735803, 3795735807⟩, ⟨(-156876122), (-156876116)⟩, ⟨2835567, 2835572⟩, ⟨(-100696), (-100688)⟩, ⟨4027, 4036⟩⟩
...
def j47 : Jet := ⟨⟨3715490511, 3715490520⟩, ⟨1238496837, 1238496845⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3214196706, 3214196723⟩, ⟨2142797804, 2142797824⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3214196706, 3214196723⟩, ⟨2142797804, 2142797824⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3214196723), (-3214196706)⟩, ⟨(-2142797824), (-2142797804)⟩, ⟨(-357132973), (-357132967)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1607098362), (-1607098353)⟩, ⟨(-1071398912), (-1071398902)⟩, ⟨(-178566487), (-178566483)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2954301354, 2954301365⟩, ⟨(-736963765), (-736963755)⟩, ⟨(-30907835), (-30907828)⟩, ⟨22996578, 22996581⟩, ⟨(-791643), (-791641)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2610904030, 2610904043⟩, ⟨(-759209296), (-759209280)⟩, ⟨1553249, 1553262⟩, ⟨20896649, 20896663⟩, ⟨(-1539951), (-1539935)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨354216690, 708433381⟩, ⟨177108345, 177108346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1112804551, 2225609106⟩, ⟨556402275, 556402279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨288322094, 1153288385⟩, ⟨288322094, 576644196⟩, ⟨72080523, 72080525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨72, 289⟩, ⟨72, 145⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94615), (-94397)⟩, ⟨72, 145⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-25407), (-6336)⟩, ⟨(-12700), (-6297)⟩, ⟨(-1583), (-1558)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5087649, 5106721⟩, ⟨(-12700), (-6297)⟩, ⟨(-1583), (-1558)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨341534, 1371262⟩, ⟨338123, 685209⟩, ⟨83251, 85178⟩, ⟨(-427), (-207)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142824043), (-141794314)⟩, ⟨338123, 685209⟩, ⟨83251, 85178⟩, ⟨(-427), (-207)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-38351238), (-9518683)⟩, ⟨(-19152921), (-9334690)⟩, ⟨(-2368667), (-2264800)⟩, ⟨11147, 22924⟩, ⟨1331, 1416⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1393304527, 1422137083⟩, ⟨(-19152921), (-9334690)⟩, ⟨(-2368667), (-2264800)⟩, ⟨11147, 22924⟩, ⟨1331, 1416⟩⟩
...
def j72 : Jet := ⟨⟨792, 3177⟩, ⟨787, 1589⟩, ⟨194, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851385), (-848999)⟩, ⟨787, 1589⟩, ⟨194, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-228615), (-56993)⟩, ⟨(-114256), (-56566)⟩, ⟨(-14224), (-13980)⟩, ⟨25, 54⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35562779, 35734402⟩, ⟨(-114256), (-56566)⟩, ⟨(-14224), (-13980)⟩, ⟨25, 54⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2387337, 9595433⟩, ⟨2356656, 4793920⟩, ⟨577673, 594980⟩, ⟨(-3827), (-1872)⟩, ⟨(-238), (-224)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713440546), (-706232449)⟩, ⟨2356656, 4793920⟩, ⟨577673, 594980⟩, ⟨(-3827), (-1872)⟩, ⟨(-238), (-224)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-191573682), (-47409538)⟩, ⟨(-95628640), (-46122270)⟩, ⟨(-11776375), (-11048985)⟩, ⟨77301, 160213⟩, ⟨9116, 9846⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4103393614, 4247557758⟩, ⟨(-95628640), (-46122270)⟩, ⟨(-11776375), (-11048985)⟩, ⟨77301, 160213⟩, ⟨9116, 9846⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨360998236, 736937216⟩, ⟨170574264, 181815734⟩, ⟨(-3708634), (-1796083)⟩, ⟨(-303967), (-281520)⟩, ⟨1788, 3704⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4342906000, 4495484911⟩, ⟨47157612, 104766238⟩, ⟨11809072, 15343197⟩, ⟨81331, 576429⟩, ⟨17227, 46934⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨365027553, 771342343⟩, ⟨176441810, 208280057⟩, ⟨(-1016349), 5251474⟩, ⟨67208, 444036⟩, ⟨(-14180), 28304⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-708433381), (-354216690)⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3586533915, 3940750606⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨31023545, 138527018⟩, ⟨29991436, 74810920⟩, ⟨6883358, 11986577⟩, ⟨(-87152), 668822⟩, ⟨(-817), 59657⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4325990841, 4433494314⟩, ⟨29991436, 74810920⟩, ⟨6883358, 11986577⟩, ⟨(-87152), 668822⟩, ⟨(-817), 59657⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310451157, 4363681140⟩, ⟨14759584, 37271094⟩, ⟨3228313, 5946491⟩, ⟨(-94838), 322156⟩, ⟨(-7296), 29333⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3599463790, 4003797448⟩, ⟨(-167616784), (-143549587)⟩, ⟨1158897, 4847441⟩, ⟨(-332228), 162464⟩, ⟨(-19980), 30825⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2476993674, 4953987357⟩, ⟨1238496837, 1238496845⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1428531869, 5714127499⟩, ⟨1428531868, 2857063764⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1428531869, 5714127499⟩, ⟨1428531868, 2857063764⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5714127499), (-1428531869)⟩, ⟨(-2857063764), (-1428531868)⟩, ⟨(-357132973), (-357132967)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2857063750), (-714265934)⟩, ⟨(-1428531882), (-714265934)⟩, ⟨(-178566487), (-178566483)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2208319783, 3636933729⟩, ⟨(-1209665972), (-367250198)⟩, ⟨(-120670844), 109358530⟩, ⟨(-1945300), 46907130⟩, ⟨(-6173730), 2670246⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1850716559, 3390374124⟩, ⟨(-1269594923), (-381587813)⟩, ⟨(-99619803), 153258338⟩, ⟨(-7727881), 48474963⟩, ⟨(-7784677), 2808241⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4331591585, 4331591587⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1096
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310451157, 4363681140⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1097
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (215416805 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((32989 / 400000) : ℝ)..(32989 / 200000), prawitzNormalCorrection
