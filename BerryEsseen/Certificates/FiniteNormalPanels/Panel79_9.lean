...
namespace FiniteNormalPanel79_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (110131 / 400000)
def radius : Rat := (15733 / 400000)

def j0 : Jet := ⟨⟨1182522608, 1182522609⟩, ⟨168931801, 168931802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3715004337, 3715004342⟩, ⟨530714904, 530714909⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3213355602, 3213355612⟩, ⟨918101598, 918101610⟩, ⟨65578685, 65578687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨804, 806⟩, ⟨229, 231⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93883), (-93880)⟩, ⟨229, 231⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-70241), (-70237)⟩, ⟨(-19898), (-19894)⟩, ⟨(-1375), (-1370)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5042815, 5042820⟩, ⟨(-19898), (-19894)⟩, ⟨(-1375), (-1370)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3772871, 3772875⟩, ⟨1063075, 1063081⟩, ⟨71714, 71722⟩, ⟨(-594), (-589)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-139392706), (-139392701)⟩, ⟨1063075, 1063081⟩, ⟨71714, 71722⟩, ⟨(-594), (-589)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-104289115), (-104289109)⟩, ⟨(-29001532), (-29001525)⟩, ⟨(-1847451), (-1847441)⟩, ⟨31115, 31124⟩, ⟨952, 959⟩⟩
...
def j19 : Jet := ⟨⟨1327366650, 1327366657⟩, ⟨(-29001532), (-29001525)⟩, ⟨(-1847451), (-1847441)⟩, ⟨31115, 31124⟩, ⟨952, 959⟩⟩
...
def j22 : Jet := ⟨⟨(-81), (-80)⟩, ⟨(-24), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11754, 11756⟩, ⟨(-24), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8793, 8796⟩, ⟨2494, 2497⟩, ⟨171, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843384), (-843380)⟩, ⟨2494, 2497⟩, ⟨171, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-630993), (-630989)⟩, ⟨(-178419), (-178413)⟩, ⟨(-12218), (-12211)⟩, ⟨72, 77⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35160401, 35160406⟩, ⟨(-178419), (-178413)⟩, ⟨(-12218), (-12211)⟩, ⟨72, 77⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨26305874, 26305879⟩, ⟨7382476, 7382484⟩, ⟨489572, 489583⟩, ⟨(-5284), (-5276)⟩, ⟨(-172), (-166)⟩⟩
...
def j33 : Jet := ⟨⟨(-689522009), (-689522003)⟩, ⟨7382476, 7382484⟩, ⟨489572, 489583⟩, ⟨(-5284), (-5276)⟩, ⟨(-172), (-166)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-515878065), (-515878058)⟩, ⟨(-141870405), (-141870394)⟩, ⟨(-8583749), (-8583736)⟩, ⟨213418, 213430⟩, ⟨6216, 6225⟩⟩
...
def j36 : Jet := ⟨⟨3779089231, 3779089238⟩, ⟨(-141870405), (-141870394)⟩, ⟨(-8583749), (-8583736)⟩, ⟨213418, 213430⟩, ⟨6216, 6225⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1148128151, 1148128159⟩, ⟨138932942, 138932953⟩, ⟨(-5181608), (-5181597)⟩, ⟨(-201371), (-201360)⟩, ⟨4667, 4676⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4881267128, 4881267138⟩, ⟨183247138, 183247155⟩, ⟨17966458, 17966479⟩, ⟨815020, 815042⟩, ⟨53012, 53032⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1304857479, 1304857492⟩, ⟨206883995, 206884015⟩, ⟨4841491, 4841512⟩, ⟨349109, 349132⟩, ⟨15571, 15591⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1182522609), (-1182522608)⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3112444687, 3112444688⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨396429803, 396429812⟩, ⟨125707186, 125707202⟩, ⟨12907175, 12907192⟩, ⟨678544, 678564⟩, ⟨48549, 48568⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4691397099, 4691397108⟩, ⟨125707186, 125707202⟩, ⟨12907175, 12907192⟩, ⟨678544, 678564⟩, ⟨48549, 48568⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4488807983, 4488807988⟩, ⟨60139379, 60139388⟩, ⟨5772038, 5772048⟩, ⟨247289, 247300⟩, ⟨16201, 16212⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3252915702, 3252915707⟩, ⟨(-132974688), (-132974678)⟩, ⟨1817404, 1817413⟩, ⟨(-47827), (-47816)⟩, ⟨2013, 2023⟩⟩
...
def j47 : Jet := ⟨⟨8766938859, 8766938869⟩, ⟨1252419835, 1252419844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17895180954, 17895180996⟩, ⟨5112908836, 5112908880⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17895180954, 17895180996⟩, ⟨5112908836, 5112908880⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17895180996), (-17895180954)⟩, ⟨(-5112908880), (-5112908836)⟩, ⟨(-365207779), (-365207773)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8947590498), (-8947590477)⟩, ⟨(-2556454440), (-2556454418)⟩, ⟨(-182603890), (-182603886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨534817706, 534817720⟩, ⟨(-318334703), (-318334691)⟩, ⟨72001541, 72001548⟩, ⟨(-5262778), (-5262775)⟩, ⟨(-747473), (-747471)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨405059408, 405059420⟩, ⟨(-257658115), (-257658102)⟩, ⟨64614547, 64614558⟩, ⟨(-6355785), (-6355777)⟩, ⟨(-368921), (-368914)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1013590807, 1351454410⟩, ⟨168931801, 168931802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3184289432, 4245719247⟩, ⟨530714904, 530714909⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2360832688, 4197035899⟩, ⟨786944226, 1049258982⟩, ⟨65578685, 65578687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨590, 1052⟩, ⟨196, 263⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94097), (-93634)⟩, ⟨196, 263⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-91952), (-51468)⟩, ⟨(-22881), (-16898)⟩, ⟨(-1394), (-1347)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5021104, 5061589⟩, ⟨(-22881), (-16898)⟩, ⟨(-1394), (-1347)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2759971, 4946178⟩, ⟨897630, 1227257⟩, ⟨69712, 73449⟩, ⟨(-689), (-494)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140405606), (-138219398)⟩, ⟨897630, 1227257⟩, ⟨69712, 73449⟩, ⟨(-689), (-494)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-137204158), (-75975636)⟩, ⟨(-33807636), (-24125937)⟩, ⟨(-1941029), (-1738840)⟩, ⟨25803, 36412⟩, ⟨873, 1024⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1294451607, 1355680130⟩, ⟨(-33807636), (-24125937)⟩, ⟨(-1941029), (-1738840)⟩, ⟨25803, 36412⟩, ⟨873, 1024⟩⟩
...
def j70 : Jet := ⟨⟨(-106), (-58)⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11729, 11778⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6447, 11510⟩, ⟨2122, 2868⟩, ⟨170, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845730), (-840666)⟩, ⟨2122, 2868⟩, ⟨170, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-826447), (-462092)⟩, ⟨(-205446), (-151227)⟩, ⟨(-12433), (-11961)⟩, ⟨61, 88⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34964947, 35329303⟩, ⟨(-205446), (-151227)⟩, ⟨(-12433), (-11961)⟩, ⟨61, 88⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19219329, 34523745⟩, ⟨6205680, 8547812⟩, ⟨471529, 505152⟩, ⟨(-6142), (-4414)⟩, ⟨(-179), (-157)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696608554), (-681304137)⟩, ⟨6205680, 8547812⟩, ⟨471529, 505152⟩, ⟨(-6142), (-4414)⟩, ⟨(-179), (-157)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-680724883), (-374495302)⟩, ⟨(-166770120), (-116478856)⟩, ⟨(-9240106), (-7820785)⟩, ⟨175145, 251498⟩, ⟨5523, 6820⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3614242413, 3920471994⟩, ⟨(-166770120), (-116478856)⟩, ⟨(-9240106), (-7820785)⟩, ⟨175145, 251498⟩, ⟨5523, 6820⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨959706625, 1340135285⟩, ⟨126531120, 149629939⟩, ⟨(-6096271), (-4270338)⟩, ⟨(-220717), (-178867)⟩, ⟨3835, 5513⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4705235518, 5103903382⟩, ⟨139794506, 235506777⟩, ⟨13539628, 23915415⟩, ⟨353721, 1477597⟩, ⟨13529, 115360⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1051380694, 1592543213⟩, ⟨169854711, 251295906⟩, ⟨(-100666), 10988632⟩, ⟨(-118648), 959279⟩, ⟨(-28405), 74744⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1351454410), (-1013590807)⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2943512886, 3281376489⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨257371311, 590503655⟩, ⟨83158706, 186357458⟩, ⟨6642655, 22852184⟩, ⟨(-99768), 1997266⟩, ⟨(-35210), 195799⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4552338607, 4885470951⟩, ⟨83158706, 186357458⟩, ⟨6642655, 22852184⟩, ⟨(-99768), 1997266⟩, ⟨(-35210), 195799⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4421780799, 4580713696⟩, ⟨38985619, 90506430⟩, ⟨2220021, 10926538⟩, ⟨(-272102), 950420⟩, ⟨(-50055), 100105⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3030423252, 3499688168⟩, ⟨(-153452519), (-104772327)⟩, ⟨(-2038376), 6814529⟩, ⟨(-637657), 638808⟩, ⟨(-75626), 87184⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7514519023, 10019358705⟩, ⟨1252419835, 1252419844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13147479888, 23373297616⟩, ⟨4382493288, 5843324432⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13147479888, 23373297616⟩, ⟨4382493288, 5843324432⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23373297616), (-13147479888)⟩, ⟨(-5843324432), (-4382493288)⟩, ⟨(-365207779), (-365207773)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11686648808), (-6573739944)⟩, ⟨(-2921662216), (-2191246644)⟩, ⟨(-182603890), (-182603886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨282644308, 929485422⟩, ⟨(-632284777), (-144202120)⟩, ⟨(-2732605), 203039806⟩, ⟨(-41952202), 18541009⟩, ⟨(-7469340), 7192613⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨199426869, 757376928⟩, ⟨(-548416618), (-108640351)⟩, ⟨849943, 189509176⟩, ⟨(-42579607), 15643817⟩, ⟨(-6955492), 7794570⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1182522608, 1182522609⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4488807983, 4488807988⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1596
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1013590807, 1351454410⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4421780799, 4580713696⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1597
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (33680933 / 4294967296)

theorem envelope_integral : (∫ s in ((47199 / 200000) : ℝ)..(15733 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((47199 / 200000) : ℝ)..(15733 / 50000), prawitzNormalCorrection
