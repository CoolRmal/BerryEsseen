...
namespace FiniteNormalPanel8_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8451 / 50000)
def radius : Rat := (2817 / 50000)

def j0 : Jet := ⟨⟨725935372, 725935373⟩, ⟨241978457, 241978458⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2280593231, 2280593235⟩, ⟨760197742, 760197747⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1210976737, 1210976743⟩, ⟨807317822, 807317832⟩, ⟨134552970, 134552973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨303, 304⟩, ⟨202, 203⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94384), (-94382)⟩, ⟨202, 203⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-26612), (-26611)⟩, ⟨(-17686), (-17682)⟩, ⟨(-2911), (-2907)⟩, ⟨12, 14⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5086444, 5086446⟩, ⟨(-17686), (-17682)⟩, ⟨(-2911), (-2907)⟩, ⟨12, 14⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1434135, 1434137⟩, ⟨951103, 951106⟩, ⟨155202, 155207⟩, ⟨(-1100), (-1095)⟩, ⟨(-90), (-87)⟩⟩
...
def j16 : Jet := ⟨⟨(-141731442), (-141731439)⟩, ⟨951103, 951106⟩, ⟨155202, 155207⟩, ⟨(-1100), (-1095)⟩, ⟨(-90), (-87)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-39961534), (-39961532)⟩, ⟨(-26372858), (-26372854)⟩, ⟨(-4217635), (-4217630)⟩, ⟨58658, 58664⟩, ⟨4629, 4634⟩⟩
...
def j19 : Jet := ⟨⟨1391694231, 1391694234⟩, ⟨(-26372858), (-26372854)⟩, ⟨(-4217635), (-4217630)⟩, ⟨58658, 58664⟩, ⟨4629, 4634⟩⟩
...
def j22 : Jet := ⟨⟨(-31), (-30)⟩, ⟨(-21), (-20)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11804, 11806⟩, ⟨(-21), (-20)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3328, 3329⟩, ⟨2212, 2215⟩, ⟨363, 367⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848849), (-848847)⟩, ⟨2212, 2215⟩, ⟨363, 367⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-239336), (-239334)⟩, ⟨(-158934), (-158931)⟩, ⟨(-26076), (-26071)⟩, ⟨136, 139⟩, ⟨9, 12⟩⟩
...
def j30 : Jet := ⟨⟨35552058, 35552061⟩, ⟨(-158934), (-158931)⟩, ⟨(-26076), (-26071)⟩, ⟨136, 139⟩, ⟨9, 12⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10023991, 10023993⟩, ⟨6637848, 6637852⟩, ⟨1076548, 1076554⟩, ⟨(-9844), (-9838)⟩, ⟨(-790), (-785)⟩⟩
...
def j33 : Jet := ⟨⟨(-705803892), (-705803889)⟩, ⟨6637848, 6637852⟩, ⟨1076548, 1076554⟩, ⟨(-9844), (-9838)⟩, ⟨(-790), (-785)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-199003168), (-199003166)⟩, ⟨(-130797223), (-130797218)⟩, ⟨(-20560224), (-20560218)⟩, ⟨407530, 407537⟩, ⟨31652, 31657⟩⟩
...
def j36 : Jet := ⟨⟨4095964128, 4095964130⟩, ⟨(-130797223), (-130797218)⟩, ⟨(-20560224), (-20560218)⟩, ⟨407530, 407537⟩, ⟨31652, 31657⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨738978489, 738978492⟩, ⟨232322385, 232322391⟩, ⟨(-6907457), (-6907451)⟩, ⟨(-715365), (-715358)⟩, ⟨12839, 12845⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4503639067, 4503639070⟩, ⟨143815580, 143815588⟩, ⟨27199084, 27199094⟩, ⟨1142353, 1142366⟩, ⟨123888, 123900⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨774881893, 774881898⟩, ⟨268354263, 268354273⟩, ⟨5215969, 5215981⟩, ⟨686379, 686394⟩, ⟨28870, 28885⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-725935373), (-725935372)⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3569031923, 3569031924⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨139801285, 139801288⟩, ⟨96830938, 96830944⟩, ⟨18649158, 18649166⟩, ⟨899464, 899476⟩, ⟨102520, 102533⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4434768581, 4434768584⟩, ⟨96830938, 96830944⟩, ⟨18649158, 18649166⟩, ⟨899464, 899476⟩, ⟨102520, 102533⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4364308194, 4364308197⟩, ⟨47646235, 47646239⟩, ⟨8916345, 8916350⟩, ⟨345244, 345252⟩, ⟨37566, 37576⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3626652822, 3626652826⟩, ⟨(-206292057), (-206292051)⟩, ⟨4724914, 4724921⟩, ⟨(-215458), (-215448)⟩, ⟨11764, 11774⟩⟩
...
def j47 : Jet := ⟨⟨2610190529, 2610190534⟩, ⟨870063508, 870063513⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1586297200, 1586297207⟩, ⟨1057531464, 1057531474⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1586297200, 1586297207⟩, ⟨1057531464, 1057531474⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1586297207), (-1586297200)⟩, ⟨(-1057531474), (-1057531464)⟩, ⟨(-176255246), (-176255243)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-793148604), (-793148600)⟩, ⟨(-528765737), (-528765732)⟩, ⟨(-88127623), (-88127621)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3570746368, 3570746374⟩, ⟨(-439604824), (-439604818)⟩, ⟨(-46206967), (-46206963)⟩, ⟨7909669, 7909670⟩, ⟨230610, 230611⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3015123631, 3015123641⟩, ⟨(-542707438), (-542707425)⟩, ⟨(-13974073), (-13974060)⟩, ⟨8235522, 8235538⟩, ⟨(-204187), (-204173)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨483956914, 967913830⟩, ⟨241978457, 241978458⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1520395485, 3040790978⟩, ⟨760197742, 760197747⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨538211881, 2152847539⟩, ⟨538211880, 1076423774⟩, ⟨134552970, 134552973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨134, 540⟩, ⟨134, 270⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94553), (-94146)⟩, ⟨134, 270⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-47395), (-11797)⟩, ⟨(-23682), (-11661)⟩, ⟨(-2943), (-2863)⟩, ⟨8, 18⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5065661, 5101260⟩, ⟨(-23682), (-11661)⟩, ⟨(-2943), (-2863)⟩, ⟨8, 18⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨634789, 2557001⟩, ⟨622918, 1277040⟩, ⟨151285, 157994⟩, ⟨(-1479), (-713)⟩, ⟨(-92), (-82)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142530788), (-140608575)⟩, ⟨622918, 1277040⟩, ⟨151285, 157994⟩, ⟨(-1479), (-713)⟩, ⟨(-92), (-82)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-71443398), (-17619972)⟩, ⟨(-35643640), (-16979857)⟩, ⟨(-4368197), (-4005740)⟩, ⟨37729, 79517⟩, ⟨4321, 4851⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1360212367, 1414035794⟩, ⟨(-35643640), (-16979857)⟩, ⟨(-4368197), (-4005740)⟩, ⟨37729, 79517⟩, ⟨4321, 4851⟩⟩
...
def j70 : Jet := ⟨⟨(-55), (-13)⟩, ⟨(-28), (-13)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11780, 11823⟩, ⟨(-28), (-13)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1476, 5927⟩, ⟨1461, 2963⟩, ⟨358, 370⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850701), (-846249)⟩, ⟨1461, 2963⟩, ⟨358, 370⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-426413), (-106045)⟩, ⟨(-213024), (-104559)⟩, ⟨(-26424), (-25582)⟩, ⟨87, 186⟩, ⟨9, 12⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35364981, 35685350⟩, ⟨(-213024), (-104559)⟩, ⟨(-26424), (-25582)⟩, ⟨87, 186⟩, ⟨9, 12⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨4431664, 17887242⟩, ⟨4324885, 8930519⟩, ⟨1041280, 1101646⟩, ⟨(-13287), (-6386)⟩, ⟨(-817), (-747)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-711396219), (-697940640)⟩, ⟨4324885, 8930519⟩, ⟨1041280, 1101646⟩, ⟨(-13287), (-6386)⟩, ⟨(-817), (-747)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-356586557), (-87460490)⟩, ⟨(-177751320), (-82984076)⟩, ⟨(-21614216), (-19074716)⟩, ⟨259314, 555076⟩, ⟨28880, 33620⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3938380739, 4207506806⟩, ⟨(-177751320), (-82984076)⟩, ⟨(-21614216), (-19074716)⟩, ⟨259314, 555076⟩, ⟨28880, 33620⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨481507913, 1001122242⟩, ⟨215518639, 244269784⟩, ⟨(-9401467), (-4423399)⟩, ⟨(-759805), (-652707)⟩, ⟨8206, 17510⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4384245807, 4683839704⟩, ⟨86469874, 211396193⟩, ⟨21581393, 35246334⟩, ⟨199740, 2462271⟩, ⟨36461, 266725⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨491516908, 1091765265⟩, ⟨229692696, 315661064⟩, ⟨(-3494204), 15723130⟩, ⟨(-186003), 1823190⟩, ⟨(-92066), 185940⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-967913830), (-483956914)⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3327053466, 3811010382⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨56249292, 277522811⟩, ⟨52572154, 160479820⟩, ⟨10507420, 31193218⟩, ⟨(-608182), 3238060⟩, ⟨(-86940), 420086⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4351216588, 4572490107⟩, ⟨52572154, 160479820⟩, ⟨10507420, 31193218⟩, ⟨(-608182), 3238060⟩, ⟨(-86940), 420086⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4323000456, 4431556778⟩, ⟨25475887, 79719583⟩, ⟨4374739, 15420405⟩, ⟨(-586485), 1582751⟩, ⟨(-99879), 217284⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3348769073, 3932208962⟩, ⟨(-229939269), (-172821064)⟩, ⟨(-1102555), 12247523⟩, ⟨(-1389186), 1157935⟩, ⟨(-177798), 225844⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1740127017, 3480254043⟩, ⟨870063508, 870063513⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨705020976, 2820083919⟩, ⟨705020974, 1410041964⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨705020976, 2820083919⟩, ⟨705020974, 1410041964⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2820083919), (-705020976)⟩, ⟨(-1410041964), (-705020974)⟩, ⟨(-176255246), (-176255243)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1410041960), (-352510488)⟩, ⟨(-705020982), (-352510487)⟩, ⟨(-88127623), (-88127621)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3093004545, 3956535218⟩, ⟨(-649467191), (-253859101)⟩, ⟨(-70765626), (-10159595)⟩, ⟨3750541, 12756268⟩, ⟨(-419256), 649057⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2411603453, 3622361283⟩, ⟨(-806433039), (-322389379)⟩, ⟨(-55589558), 38131521⟩, ⟨201342, 16700848⟩, ⟨(-1607461), 879606⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨725935372, 725935373⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4364308194, 4364308197⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified166
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨483956914, 967913830⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4323000456, 4431556778⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified167
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (339239089 / 4294967296)

theorem envelope_integral : (∫ s in ((2817 / 25000) : ℝ)..(2817 / 12500),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((2817 / 25000) : ℝ)..(2817 / 12500), prawitzNormalCorrection
