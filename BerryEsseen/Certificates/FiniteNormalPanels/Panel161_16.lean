...
namespace FiniteNormalPanel161_16

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (12893 / 400000)
def radius : Rat := (12893 / 400000)

def j0 : Jet := ⟨⟨138437533, 138437534⟩, ⟨138437533, 138437534⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨434914336, 434914340⟩, ⟨434914336, 434914340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨44040027, 44040029⟩, ⟨88080054, 88080058⟩, ⟨44040027, 44040029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-971), (-970)⟩, ⟨(-1942), (-1940)⟩, ⟨(-971), (-968)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112085, 5112087⟩, ⟨(-1942), (-1940)⟩, ⟨(-971), (-968)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨52418, 52419⟩, ⟨104817, 104819⟩, ⟨52368, 52371⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143113159), (-143113157)⟩, ⟨104817, 104819⟩, ⟨52368, 52371⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1467464), (-1467463)⟩, ⟨(-2933853), (-2933851)⟩, ⟨(-1464779), (-1464775)⟩, ⟨2146, 2150⟩, ⟨534, 538⟩⟩
...
def j19 : Jet := ⟨⟨1430188301, 1430188303⟩, ⟨(-2933853), (-2933851)⟩, ⟨(-1464779), (-1464775)⟩, ⟨2146, 2150⟩, ⟨534, 538⟩⟩
...
def j25 : Jet := ⟨⟨121, 122⟩, ⟨241, 243⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852056), (-852054)⟩, ⟨241, 243⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8737), (-8736)⟩, ⟨(-17472), (-17470)⟩, ⟨(-8732), (-8729)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782657, 35782659⟩, ⟨(-17472), (-17470)⟩, ⟨(-8732), (-8729)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨366910, 366911⟩, ⟨733641, 733643⟩, ⟨366461, 366464⟩, ⟨(-360), (-357)⟩, ⟨(-91), (-87)⟩⟩
...
def j33 : Jet := ⟨⟨(-715460973), (-715460971)⟩, ⟨733641, 733643⟩, ⟨366461, 366464⟩, ⟨(-360), (-357)⟩, ⟨(-91), (-87)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7336243), (-7336242)⟩, ⟨(-14664964), (-14664961)⟩, ⟨(-7317441), (-7317438)⟩, ⟨15033, 15036⟩, ⟨3748, 3751⟩⟩
...
def j36 : Jet := ⟨⟨4287631053, 4287631054⟩, ⟨(-14664964), (-14664961)⟩, ⟨(-7317441), (-7317438)⟩, ⟨15033, 15036⟩, ⟨3748, 3751⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨144822847, 144822850⟩, ⟨144525760, 144525765⟩, ⟨(-445413), (-445410)⟩, ⟨(-148109), (-148107)⟩, ⟨271, 273⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302316090, 4302316092⟩, ⟨14715188, 14715193⟩, ⟨7392829, 7392835⟩, ⟨35310, 35317⟩, ⟨8920, 8928⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨145070642, 145070646⟩, ⟨145269231, 145269238⟩, ⟨298270, 298276⟩, ⟨100068, 100075⟩, ⟨484, 492⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-138437534), (-138437533)⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4156529762, 4156529763⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4900035, 4900036⟩, ⟨9813484, 9813488⟩, ⟨4933607, 4933611⟩, ⟨26934, 26940⟩, ⟨6820, 6825⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299867331, 4299867332⟩, ⟨9813484, 9813488⟩, ⟨4933607, 4933611⟩, ⟨26934, 26940⟩, ⟨6820, 6825⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297416615, 4297416616⟩, ⟨4903945, 4903948⟩, ⟨2462599, 2462602⟩, ⟨10648, 10653⟩, ⟨2689, 2694⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4158900133, 4158900136⟩, ⟨(-133770604), (-133770598)⟩, ⟨2225156, 2225161⟩, ⟨(-69072), (-69065)⟩, ⟨2258, 2265⟩⟩
...
def j47 : Jet := ⟨⟨1435720261, 1435720273⟩, ⟨1435720261, 1435720273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨479932098, 479932107⟩, ⟨959864196, 959864214⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨479932098, 479932107⟩, ⟨959864196, 959864214⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-479932107), (-479932098)⟩, ⟨(-959864214), (-959864196)⟩, ⟨(-479932107), (-479932098)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-239966054), (-239966049)⟩, ⟨(-479932107), (-479932098)⟩, ⟨(-239966054), (-239966049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4061581745, 4061581750⟩, ⟨(-453852929), (-453852919)⟩, ⟨(-201569045), (-201569037)⟩, ⟨24412916, 24412918⟩, ⟨4948984, 4948985⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3932908377, 3932908386⟩, ⟨(-565976197), (-565976179)⟩, ⟨(-178943319), (-178943302)⟩, ⟨29617093, 29617106⟩, ⟨3936836, 3936849⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 276875067⟩, ⟨138437533, 138437534⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 869828677⟩, ⟨434914336, 434914340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 176160114⟩, ⟨0, 176160116⟩, ⟨44040027, 44040029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 45⟩, ⟨0, 45⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94641)⟩, ⟨0, 45⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-3884), 0⟩, ⟨(-3884), 2⟩, ⟨(-971), (-967)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109172, 5113057⟩, ⟨(-3884), 2⟩, ⟨(-971), (-967)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 209715⟩, ⟨(-160), 209716⟩, ⟨52188, 52430⟩, ⟨(-80), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142955861)⟩, ⟨(-160), 209716⟩, ⟨52188, 52430⟩, ⟨(-80), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5872004), 0⟩, ⟨(-5872011), 8602⟩, ⟨(-1468008), (-1455097)⟩, ⟨(-6), 4303⟩, ⟨530, 539⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425783761, 1431655766⟩, ⟨(-5872011), 8602⟩, ⟨(-1468008), (-1455097)⟩, ⟨(-6), 4303⟩, ⟨530, 539⟩⟩
...
def j72 : Jet := ⟨⟨0, 486⟩, ⟨(-1), 486⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851690)⟩, ⟨(-1), 486⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-34953), 0⟩, ⟨(-34954), 20⟩, ⟨(-8740), (-8707)⟩, ⟨(-2), 11⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35756441, 35791395⟩, ⟨(-34954), 20⟩, ⟨(-8740), (-8707)⟩, ⟨(-2), 11⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1468001⟩, ⟨(-1434), 1468003⟩, ⟨364848, 367002⟩, ⟨(-719), 2⟩, ⟨(-92), (-87)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714359881)⟩, ⟨(-1434), 1468003⟩, ⟨364848, 367002⟩, ⟨(-719), 2⟩, ⟨(-92), (-87)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-29360020), 0⟩, ⟨(-29360079), 60211⟩, ⟨(-7340064), (-7249687)⟩, ⟨(-45), 30107⟩, ⟨3707, 3765⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4265607276, 4294967296⟩, ⟨(-29360079), 60211⟩, ⟨(-7340064), (-7249687)⟩, ⟨(-45), 30107⟩, ⟨3707, 3765⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 289942893⟩, ⟨143187622, 144973190⟩, ⟨(-891914), 872⟩, ⟨(-148655), (-146473)⟩, ⟨(-1), 546⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4324529400⟩, ⟨(-61044), 29765640⟩, ⟨7249269, 7646332⟩, ⟨(-30739), 103897⟩, ⟨8025, 10143⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 291938560⟩, ⟨143183501, 147980443⟩, ⟨(-900115), 1521781⟩, ⟨83742, 118650⟩, ⟨(-3659), 4747⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-276875067), 0⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4018092229, 4294967296⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19843719⟩, ⟨0, 20117126⟩, ⟨4651014, 5305453⟩, ⟨(-62026), 120996⟩, ⟨4765, 9364⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314811015⟩, ⟨0, 20117126⟩, ⟨4651014, 5305453⟩, ⟨(-62026), 120996⟩, ⟨4765, 9364⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304877722⟩, ⟨0, 10058563⟩, ⟨2308401, 2652727⟩, ⟨(-37226), 60498⟩, ⟨1417, 4150⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4018092229, 4304877722⟩, ⟨(-138756972), (-128378970)⟩, ⟨1835376, 2652727⟩, ⟨(-122731), (-13907)⟩, ⟨(-626), 5350⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2871440535⟩, ⟨1435720261, 1435720273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1919728412⟩, ⟨0, 1919728420⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1919728412⟩, ⟨0, 1919728420⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1919728412), 0⟩, ⟨(-1919728420), 0⟩, ⟨(-479932107), (-479932098)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-959864206), 0⟩, ⟨(-959864210), 0⟩, ⟨(-239966054), (-239966049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3434798076, 4294967296⟩, ⟨(-959864210), 0⟩, ⟨(-239966054), (-84649136)⟩, ⟨0, 53629006⟩, ⟨(-631596), 6703626⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3213373817, 4304877722⟩, ⟨(-1100836022), (-102668031)⟩, ⟨(-239051966), (-45529288)⟩, ⟨1814631, 61494186⟩, ⟨(-2514478), 6715701⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨138437533, 138437534⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297416615, 4297416616⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3266
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 276875067⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304877722⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3267
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (62444083 / 1073741824)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(12893 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (12893 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(12893 / 200000), prawitzNormalCorrection
