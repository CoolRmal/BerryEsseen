...
namespace FiniteNormalPanel52_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (117047 / 400000)
def radius : Rat := (16721 / 400000)

def j0 : Jet := ⟨⟨1256782592, 1256782593⟩, ⟨179540370, 179540371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3948298958, 3948298962⟩, ⟨564042707, 564042711⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3629611959, 3629611967⟩, ⟨1037031984, 1037031996⟩, ⟨74073713, 74073715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨908, 910⟩, ⟨259, 260⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93779), (-93776)⟩, ⟨259, 260⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-79252), (-79248)⟩, ⟨(-22426), (-22422)⟩, ⟨(-1541), (-1537)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5033804, 5033809⟩, ⟨(-22426), (-22422)⟩, ⟨(-1541), (-1537)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4253991, 4253996⟩, ⟨1196474, 1196480⟩, ⟨80098, 80106⟩, ⟨(-754), (-748)⟩, ⟨(-26), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-138911586), (-138911580)⟩, ⟨1196474, 1196480⟩, ⟨80098, 80106⟩, ⟨(-754), (-748)⟩, ⟨(-26), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-117392083), (-117392077)⟩, ⟨(-32529474), (-32529465)⟩, ⟨(-2039176), (-2039165)⟩, ⟨39336, 39346⟩, ⟨1176, 1184⟩⟩
...
def j19 : Jet := ⟨⟨1314263682, 1314263689⟩, ⟨(-32529474), (-32529465)⟩, ⟨(-2039176), (-2039165)⟩, ⟨39336, 39346⟩, ⟨1176, 1184⟩⟩
...
def j25 : Jet := ⟨⟨9923, 9927⟩, ⟨2812, 2816⟩, ⟨193, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842254), (-842249)⟩, ⟨2812, 2816⟩, ⟨193, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-711777), (-711771)⟩, ⟨(-200989), (-200983)⟩, ⟨(-13686), (-13678)⟩, ⟨92, 97⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35079617, 35079624⟩, ⟨(-200989), (-200983)⟩, ⟨(-13686), (-13678)⟩, ⟨92, 97⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29645254, 29645261⟩, ⟨8300219, 8300228⟩, ⟨544909, 544920⟩, ⟨(-6695), (-6686)⟩, ⟨(-215), (-207)⟩⟩
...
def j33 : Jet := ⟨⟨(-686182629), (-686182621)⟩, ⟨8300219, 8300228⟩, ⟨544909, 544920⟩, ⟨(-6695), (-6686)⟩, ⟨(-215), (-207)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-579882572), (-579882563)⟩, ⟨(-158666347), (-158666333)⟩, ⟨(-9369734), (-9369719)⟩, ⟨269061, 269074⟩, ⟨7598, 7611⟩⟩
...
def j36 : Jet := ⟨⟨3715084724, 3715084733⟩, ⟨(-158666347), (-158666333)⟩, ⟨(-9369734), (-9369719)⟩, ⟨269061, 269074⟩, ⟨7598, 7611⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1208182872, 1208182881⟩, ⟨142693694, 142693708⟩, ⟨(-6146564), (-6146551)⟩, ⟨(-231638), (-231625)⟩, ⟨6246, 6257⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4965362945, 4965362958⟩, ⟨212064053, 212064075⟩, ⟨21579985, 21580011⟩, ⟨1096863, 1096887⟩, ⟨75737, 75764⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1396766505, 1396766521⟩, ⟨224620601, 224620625⟩, ⟨6010021, 6010048⟩, ⟨454228, 454255⟩, ⟨22643, 22671⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1256782593), (-1256782592)⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3038184703, 3038184704⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨454242497, 454242508⟩, ⟨146097750, 146097770⟩, ⟨15656371, 15656393⟩, ⟨924068, 924092⟩, ⟨70645, 70671⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4749209793, 4749209804⟩, ⟨146097750, 146097770⟩, ⟨15656371, 15656393⟩, ⟨924068, 924092⟩, ⟨70645, 70671⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4516381377, 4516381383⟩, ⟨69467678, 69467688⟩, ⟨6910160, 6910172⟩, ⟨333095, 333108⟩, ⟨23180, 23195⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3194809149, 3194809155⟩, ⟨(-139655815), (-139655805)⟩, ⟨1984202, 1984213⟩, ⟨(-53238), (-53226)⟩, ⟨2472, 2484⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨31972259687, 31972259694⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value304

def j47 : Jet := ⟨⟨9355642693, 9355642703⟩, ⟨1336520382, 1336520391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20379212265, 20379212310⟩, ⟨5822632064, 5822632110⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20379212265, 20379212310⟩, ⟨5822632064, 5822632110⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20379212310), (-20379212265)⟩, ⟨(-5822632110), (-5822632064)⟩, ⟨(-415902296), (-415902289)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10189606155), (-10189606132)⟩, ⟨(-2911316055), (-2911316032)⟩, ⟨(-207951148), (-207951144)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨400513169, 400513180⟩, ⟨(-271485293), (-271485282)⟩, ⟨72620471, 72620478⟩, ⟨(-7645368), (-7645365)⟩, ⟨(-462458), (-462456)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨297921508, 297921518⟩, ⟨(-214967340), (-214967329)⟩, ⟨63031384, 63031395⟩, ⟨(-8178730), (-8178722)⟩, ⟨(-58260), (-58251)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1077242222, 1436322964⟩, ⟨179540370, 179540371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3384256250, 4512341673⟩, ⟨564042707, 564042711⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2666653684, 4740717676⟩, ⟨888884558, 1185179424⟩, ⟨74073713, 74073715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨667, 1188⟩, ⟨222, 297⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94020), (-93498)⟩, ⟨222, 297⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-103778), (-58050)⟩, ⟨(-25808), (-19022)⟩, ⟨(-1566), (-1509)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5009278, 5055007⟩, ⟨(-25808), (-19022)⟩, ⟨(-1566), (-1509)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3110153, 5579638⟩, ⟨1008230, 1383100⟩, ⟨77542, 82310⟩, ⟨(-876), (-626)⟩, ⟨(-27), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140055424), (-137585938)⟩, ⟨1008230, 1383100⟩, ⟨77542, 82310⟩, ⟨(-876), (-626)⟩, ⟨(-27), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-154590985), (-85424177)⟩, ⟨(-38021759), (-26948080)⟩, ⟨(-2158679), (-1900378)⟩, ⟨32469, 46180⟩, ⟨1065, 1279⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1277064780, 1346231589⟩, ⟨(-38021759), (-26948080)⟩, ⟨(-2158679), (-1900378)⟩, ⟨32469, 46180⟩, ⟨1065, 1279⟩⟩
...
def j72 : Jet := ⟨⟨7273, 12992⟩, ⟨2390, 3235⟩, ⟨190, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844904), (-839184)⟩, ⟨2390, 3235⟩, ⟨190, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-932592), (-521031)⟩, ⟨(-231665), (-170106)⟩, ⟨(-13961), (-13360)⟩, ⟨77, 111⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34858802, 35270364⟩, ⟨(-231665), (-170106)⟩, ⟨(-13961), (-13360)⟩, ⟨77, 111⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21643087, 38930876⟩, ⟨6958653, 9627104⟩, ⟨521858, 564796⟩, ⟨(-7802), (-5574)⟩, ⟨(-226), (-194)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694184796), (-676897006)⟩, ⟨6958653, 9627104⟩, ⟨521858, 564796⟩, ⟨(-7802), (-5574)⟩, ⟨(-226), (-194)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-766230313), (-420270928)⟩, ⟨(-187237100), (-129464062)⟩, ⟨(-10208180), (-8394217)⟩, ⟨219404, 318430⟩, ⟨6597, 8468⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3528736983, 3874696368⟩, ⟨(-187237100), (-129464062)⟩, ⟨(-10208180), (-8394217)⟩, ⟨219404, 318430⟩, ⟨6597, 8468⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1006274126, 1414366277⟩, ⟨127766258, 155561816⟩, ⟨(-7261195), (-5036414)⟩, ⟨(-257908), (-201051)⟩, ⟨5103, 7409⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4760823125, 5227576939⟩, ⟨159071947, 277378664⟩, ⟨15628961, 29840600⟩, ⟨437208, 2089775⟩, ⟨14244, 178421⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1115420164, 1721481917⟩, ⟨178893687, 280683486⟩, ⟨(-444105), 14290585⟩, ⟨(-215494), 1359604⟩, ⟨(-45108), 117692⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1436322964), (-1077242222)⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2858644332, 3217725074⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨289679072, 689993611⟩, ⟨92918810, 225003598⟩, ⟨7095259, 29798874⟩, ⟨(-230794), 2957726⟩, ⟨(-65804), 319601⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4584646368, 4984960907⟩, ⟨92918810, 225003598⟩, ⟨7095259, 29798874⟩, ⟨(-230794), 2957726⟩, ⟨(-65804), 319601⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4437443657, 4627120495⟩, ⟨43124363, 108889619⟩, ⟨2011721, 14211503⟩, ⟨(-460426), 1411830⟩, ⟨(-89248), 165513⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2953473748, 3466569269⟩, ⟨(-164722493), (-103917768)⟩, ⟨(-3212898), 8844339⟩, ⟨(-939022), 973628⟩, ⟨(-125883), 143247⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8019122310, 10692163094⟩, ⟨1336520382, 1336520391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14972482487, 26617746714⟩, ⟨4990827484, 6654436700⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14972482487, 26617746714⟩, ⟨4990827484, 6654436700⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-26617746714), (-14972482487)⟩, ⟨(-6654436700), (-4990827484)⟩, ⟨(-415902296), (-415902289)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13308873357), (-7486241243)⟩, ⟨(-3327218350), (-2495413742)⟩, ⟨(-207951148), (-207951144)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨193733917, 751576392⟩, ⟨(-582229990), (-112561108)⟩, ⟨(-3689879), 216140404⟩, ⟨(-52179823), 19746199⟩, ⟨(-9056717), 10194973⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨133222909, 606615009⟩, ⟨(-498756331), (-82091118)⟩, ⟨(-816972), 198329628⟩, ⟨(-51768346), 16685059⟩, ⟨(-8382907), 10827273⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1256782592, 1256782593⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4516381377, 4516381383⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar304 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1028
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar304 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1077242222, 1436322964⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4437443657, 4627120495⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1029
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((50163 / 200000) : ℝ)..(16721 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (50163 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (16721 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((50163 / 200000) : ℝ)..(16721 / 50000), prawitzNormalCorrection
      ((60781 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
