...
namespace FiniteNormalPanel143_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (78477 / 800000)
def radius : Rat := (26159 / 800000)

def j0 : Jet := ⟨⟨421320185, 421320186⟩, ⟨140440061, 140440062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1323616397, 1323616402⟩, ⟨441205463, 441205468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨407910059, 407910063⟩, ⟨271940038, 271940044⟩, ⟨45323339, 45323341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-8984), (-8982)⟩, ⟨(-5983), (-5981)⟩, ⟨(-994), (-991)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104072, 5104075⟩, ⟨(-5983), (-5981)⟩, ⟨(-994), (-991)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨484753, 484755⟩, ⟨322600, 322602⟩, ⟨53387, 53390⟩, ⟨(-127), (-124)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142680824), (-142680821)⟩, ⟨322600, 322602⟩, ⟨53387, 53390⟩, ⟨(-127), (-124)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13550964), (-13550962)⟩, ⟨(-9003338), (-9003336)⟩, ⟨(-1480168), (-1480165)⟩, ⟨6771, 6775⟩, ⟨552, 557⟩⟩
...
def j19 : Jet := ⟨⟨1418104801, 1418104804⟩, ⟨(-9003338), (-9003336)⟩, ⟨(-1480168), (-1480165)⟩, ⟨6771, 6775⟩, ⟨552, 557⟩⟩
...
def j25 : Jet := ⟨⟨1122, 1124⟩, ⟨747, 749⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851055), (-851052)⟩, ⟨747, 749⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-80829), (-80827)⟩, ⟨(-53816), (-53813)⟩, ⟨(-8923), (-8920)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35710565, 35710568⟩, ⟨(-53816), (-53813)⟩, ⟨(-8923), (-8920)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3391573, 3391575⟩, ⟨2255937, 2255940⟩, ⟨372585, 372588⟩, ⟨(-1132), (-1129)⟩, ⟨(-96), (-91)⟩⟩
...
def j33 : Jet := ⟨⟨(-712436310), (-712436307)⟩, ⟨2255937, 2255940⟩, ⟨372585, 372588⟩, ⟨(-1132), (-1129)⟩, ⟨(-96), (-91)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-67662900), (-67662898)⟩, ⟨(-44894345), (-44894342)⟩, ⟨(-7339880), (-7339874)⟩, ⟨47288, 47291⟩, ⟨3849, 3853⟩⟩
...
def j36 : Jet := ⟨⟨4227304396, 4227304398⟩, ⟨(-44894345), (-44894342)⟩, ⟨(-7339880), (-7339874)⟩, ⟨47288, 47291⟩, ⟨3849, 3853⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨437029350, 437029353⟩, ⟨142901814, 142901818⟩, ⟨(-1381035), (-1381032)⟩, ⟨(-149966), (-149963)⟩, ⟨865, 868⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4363713216, 4363713220⟩, ⟨46343014, 46343019⟩, ⟨8068887, 8068896⟩, ⟨117339, 117346⟩, ⟨10758, 10767⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨444024510, 444024514⟩, ⟨149904700, 149904708⟩, ⟨959820, 959827⟩, ⟨113137, 113145⟩, ⟨1662, 1671⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-421320186), (-421320185)⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3873647110, 3873647111⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨45904369, 45904371⟩, ⟨30995048, 30995052⟩, ⟨5430490, 5430496⟩, ⟨90392, 90398⟩, ⟨8452, 8461⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4340871665, 4340871667⟩, ⟨30995048, 30995052⟩, ⟨5430490, 5430496⟩, ⟨90392, 90398⟩, ⟨8452, 8461⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317858478, 4317858480⟩, ⟨15415363, 15415366⟩, ⟨2673332, 2673336⟩, ⟨35411, 35416⟩, ⟨3248, 3255⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3894292752, 3894292756⟩, ⟨(-127285403), (-127285397)⟩, ⟨1907024, 1907029⟩, ⟨(-55478), (-55472)⟩, ⟨1770, 1779⟩⟩
...
def j47 : Jet := ⟨⟨4586665946, 4586665959⟩, ⟨1528888641, 1528888653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4898175713, 4898175742⟩, ⟨3265450458, 3265450496⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4898175713, 4898175742⟩, ⟨3265450458, 3265450496⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4898175742), (-4898175713)⟩, ⟨(-3265450496), (-3265450458)⟩, ⟨(-544241750), (-544241740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2449087871), (-2449087856)⟩, ⟨(-1632725248), (-1632725229)⟩, ⟨(-272120875), (-272120870)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2428372386, 2428372406⟩, ⟨(-923142056), (-923142037)⟩, ⟨21608505, 21608516⟩, ⟨36254188, 36254192⟩, ⟨(-4130032), (-4130029)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2201831196, 2201831218⟩, ⟨(-908989875), (-908989851)⟩, ⟨48029074, 48029092⟩, ⟨31790413, 31790426⟩, ⟨(-4796657), (-4796641)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨280880123, 561760248⟩, ⟨140440061, 140440062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨882410930, 1764821869⟩, ⟨441205463, 441205468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨181293359, 725173445⟩, ⟨181293358, 362586724⟩, ⟨45323339, 45323341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨45, 182⟩, ⟨45, 91⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94642), (-94504)⟩, ⟨45, 91⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-15980), (-3989)⟩, ⟨(-7989), (-3973)⟩, ⟨(-998), (-986)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097076, 5109068⟩, ⟨(-7989), (-3973)⟩, ⟨(-998), (-986)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨215150, 862629⟩, ⟨213801, 431148⟩, ⟨52943, 53707⟩, ⟨(-170), (-81)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142950427), (-142302947)⟩, ⟨213801, 431148⟩, ⟨52943, 53707⟩, ⟨(-170), (-81)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-24136122), (-6006699)⟩, ⟨(-12059037), (-5933902)⟩, ⟨(-1497250), (-1456206)⟩, ⟨4461, 9082⟩, ⟨541, 564⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407519643, 1425649067⟩, ⟨(-12059037), (-5933902)⟩, ⟨(-1497250), (-1456206)⟩, ⟨4461, 9082⟩, ⟨541, 564⟩⟩
...
def j72 : Jet := ⟨⟨498, 1998⟩, ⟨496, 999⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851679), (-850178)⟩, ⟨496, 999⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-143800), (-35886)⟩, ⟨(-71880), (-35717)⟩, ⟨(-8963), (-8864)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35647594, 35755509⟩, ⟨(-71880), (-35717)⟩, ⟨(-8963), (-8864)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1504708, 6037054⟩, ⟨1492571, 3017020⟩, ⟨368594, 375435⟩, ⟨(-1516), (-746)⟩, ⟨(-96), (-90)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714323175), (-709790828)⟩, ⟨1492571, 3017020⟩, ⟨368594, 375435⟩, ⟨(-1516), (-746)⟩, ⟨(-96), (-90)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-120608183), (-29960731)⟩, ⟨(-60241090), (-29451329)⟩, ⟨(-7459452), (-7172091)⟩, ⟨31052, 63502⟩, ⟨3744, 3928⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4174359113, 4265006565⟩, ⟨(-60241090), (-29451329)⟩, ⟨(-7459452), (-7172091)⟩, ⟨31052, 63502⟩, ⟨3744, 3928⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨289178154, 585805777⟩, ⟨139633962, 145232312⟩, ⟨(-1854006), (-908746)⟩, ⟨(-152891), (-145858)⟩, ⟨569, 1165⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4325138494, 4419060166⟩, ⟨29866560, 63772426⟩, ⟨7479447, 8817041⟩, ⟨36074, 209028⟩, ⟨7805, 14674⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨291209566, 602731243⟩, ⟨142625760, 158126602⟩, ⟨(-432994), 2443894⟩, ⟨60754, 173455⟩, ⟨(-3809), 7674⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-561760248), (-280880123)⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3733207048, 4014087173⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19744739, 84583870⟩, ⟨19340768, 44381174⟩, ⟨4614737, 6507629⟩, ⟨(-23646), 228638⟩, ⟨2717, 16319⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314712035, 4379551166⟩, ⟨19340768, 44381174⟩, ⟨4614737, 6507629⟩, ⟨(-23646), 228638⟩, ⟨2717, 16319⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304828345, 4337053036⟩, ⟨9576544, 22139756⟩, ⟨2228468, 3235710⟩, ⟨(-28438), 109101⟩, ⟨(-423), 7711⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3741778321, 4053420611⟩, ⟨(-133492235), (-120070632)⟩, ⟨1213052, 2710962⟩, ⟨(-132383), 29099⟩, ⟨(-3964), 8137⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3057777294, 6115554612⟩, ⟨1528888641, 1528888653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2176966979, 8707867985⟩, ⟨2176966970, 4353933994⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2176966979, 8707867985⟩, ⟨2176966970, 4353933994⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8707867985), (-2176966979)⟩, ⟨(-4353933994), (-2176966970)⟩, ⟨(-544241750), (-544241740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4353933993), (-1088483489)⟩, ⟨(-2176966997), (-1088483485)⟩, ⟨(-272120875), (-272120870)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1558485758, 3333462758⟩, ⟨(-1689614358), (-394970646)⟩, ⟨(-161152634), 329460215⟩, ⟨(-38980857), 98594670⟩, ⟨(-22930521), 10044666⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1357753813, 3145990579⟩, ⟨(-1698198975), (-387667903)⟩, ⟨(-140607478), 365550659⟩, ⟨(-48197800), 97969590⟩, ⟨(-24821595), 10957677⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨421320185, 421320186⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317858478, 4317858480⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2882
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨280880123, 561760248⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304828345, 4337053036⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2883
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (145184573 / 4294967296)

theorem envelope_integral : (∫ s in ((26159 / 400000) : ℝ)..(26159 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26159 / 400000) : ℝ)..(26159 / 200000), prawitzNormalCorrection
