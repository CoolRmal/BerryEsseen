...
namespace FiniteNormalPanel165_14
...
def j2 : Jet := ⟨⟨1458108252, 1458108257⟩, ⟨486036082, 486036086⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨495016499, 495016503⟩, ⟨330010998, 330011002⟩, ⟨55001832, 55001834⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨123, 125⟩, ⟨82, 83⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94564), (-94561)⟩, ⟨82, 83⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10899), (-10898)⟩, ⟨(-7257), (-7255)⟩, ⟨(-1204), (-1201)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102157, 5102159⟩, ⟨(-7257), (-7255)⟩, ⟨(-1204), (-1201)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨588049, 588050⟩, ⟨391195, 391197⟩, ⟨64641, 64644⟩, ⟨(-186), (-183)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-142577528), (-142577526)⟩, ⟨391195, 391197⟩, ⟨64641, 64644⟩, ⟨(-186), (-183)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16432775), (-16432774)⟩, ⟨(-10910097), (-10910094)⟩, ⟨(-1788356), (-1788353)⟩, ⟨9953, 9957⟩, ⟨810, 813⟩⟩
...
def j19 : Jet := ⟨⟨1415222990, 1415222992⟩, ⟨(-10910097), (-10910094)⟩, ⟨(-1788356), (-1788353)⟩, ⟨9953, 9957⟩, ⟨810, 813⟩⟩
...
def j25 : Jet := ⟨⟨1362, 1363⟩, ⟨906, 909⟩, ⟨149, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850815), (-850813)⟩, ⟨906, 909⟩, ⟨149, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-98061), (-98060)⟩, ⟨(-65270), (-65268)⟩, ⟨(-10810), (-10807)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35693333, 35693335⟩, ⟨(-65270), (-65268)⟩, ⟨(-10810), (-10807)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4113835, 4113836⟩, ⟨2735033, 2735036⟩, ⟨450830, 450834⟩, ⟨(-1665), (-1662)⟩, ⟨(-139), (-135)⟩⟩
...
def j33 : Jet := ⟨⟨(-711714048), (-711714046)⟩, ⟨2735033, 2735036⟩, ⟨450830, 450834⟩, ⟨(-1665), (-1662)⟩, ⟨(-139), (-135)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-82028611), (-82028609)⟩, ⟨(-54370515), (-54370512)⟩, ⟨(-8852181), (-8852176)⟩, ⟨69473, 69476⟩, ⟨5628, 5632⟩⟩
...
def j36 : Jet := ⟨⟨4212938685, 4212938687⟩, ⟨(-54370515), (-54370512)⟩, ⟨(-8852181), (-8852176)⟩, ⟨69473, 69476⟩, ⟨5628, 5632⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨480457283, 480457286⟩, ⟨156448533, 156448537⟩, ⟨(-1841766), (-1841762)⟩, ⟨(-199000), (-198996)⟩, ⟨1400, 1404⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4378593054, 4378593057⟩, ⟨56508380, 56508385⟩, ⟨9929520, 9929528⟩, ⟨174672, 174680⟩, ⟨16330, 16340⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨489812093, 489812097⟩, ⟨165816005, 165816012⟩, ⟨1291514, 1291523⟩, ⟨154124, 154134⟩, ⟨2738, 2748⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-464130273), (-464130272)⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3830837023, 3830837024⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨55859770, 55859772⟩, ⟨37820396, 37820400⟩, ⟨6696242, 6696247⟩, ⟨134874, 134880⟩, ⟨12912, 12919⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4350827066, 4350827068⟩, ⟨37820396, 37820400⟩, ⟨6696242, 6696247⟩, ⟨134874, 134880⟩, ⟨12912, 12919⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4322806953, 4322806955⟩, ⟨18788412, 18788415⟩, ⟨3285727, 3285731⟩, ⟨52721, 52726⟩, ⟨4936, 4941⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3855668222, 3855668226⟩, ⟨(-138954846), (-138954840)⟩, ⟨2253876, 2253881⟩, ⟨(-71334), (-71326)⟩, ⟨2502, 2509⟩⟩
...
def j47 : Jet := ⟨⟨3720361917, 3720361926⟩, ⟨1240120633, 1240120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3222630543, 3222630560⟩, ⟨2148420352, 2148420374⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3222630543, 3222630560⟩, ⟨2148420352, 2148420374⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3222630560), (-3222630543)⟩, ⟨(-2148420374), (-2148420352)⟩, ⟨(-358070063), (-358070056)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1611315280), (-1611315271)⟩, ⟨(-1074210187), (-1074210176)⟩, ⟨(-179035032), (-179035028)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2951402160, 2951402172⟩, ⟨(-738172392), (-738172380)⟩, ⟨(-30716938), (-30716931)⟩, ⟨23074592, 23074595⟩, ⟨(-802577), (-802575)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2649525999, 2649526014⟩, ⟨(-758156989), (-758156972)⟩, ⟨(-2144279), (-2144266)⟩, ⟨21271859, 21271873⟩, ⟨(-1469163), (-1469149)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨309420181, 618840363⟩, ⟨154710090, 154710091⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨972072167, 1944144339⟩, ⟨486036082, 486036086⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨220007332, 880029335⟩, ⟨220007330, 440014670⟩, ⟨55001832, 55001834⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨55, 221⟩, ⟨55, 111⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94632), (-94465)⟩, ⟨55, 111⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-19390), (-4838)⟩, ⟨(-9693), (-4815)⟩, ⟨(-1210), (-1194)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5093666, 5108219⟩, ⟨(-9693), (-4815)⟩, ⟨(-1210), (-1194)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨260920, 1046663⟩, ⟨258933, 523086⟩, ⟨63988, 65110⟩, ⟨(-249), (-121)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142904657), (-142118913)⟩, ⟨258933, 523086⟩, ⟨63988, 65110⟩, ⟨(-249), (-121)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-29280850), (-7279962)⟩, ⟨(-14627162), (-7172782)⟩, ⟨(-1813514), (-1753059)⟩, ⟨6540, 13364⟩, ⟨789, 828⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1402374915, 1424375804⟩, ⟨(-14627162), (-7172782)⟩, ⟨(-1813514), (-1753059)⟩, ⟨6540, 13364⟩, ⟨789, 828⟩⟩
...
def j72 : Jet := ⟨⟨605, 2425⟩, ⟨602, 1213⟩, ⟨148, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851572), (-849751)⟩, ⟨602, 1213⟩, ⟨148, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-174486), (-43528)⟩, ⟨(-87213), (-43279)⟩, ⟨(-10869), (-10725)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35616908, 35747867⟩, ⟨(-87213), (-43279)⟩, ⟨(-10869), (-10725)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1824456, 7324660⟩, ⟨1806586, 3660114⟩, ⟨444951, 455027⟩, ⟨(-2231), (-1096)⟩, ⟨(-141), (-132)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714003427), (-708503222)⟩, ⟨1806586, 3660114⟩, ⟨444951, 455027⟩, ⟨(-2231), (-1096)⟩, ⟨(-141), (-132)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-146297729), (-36292686)⟩, ⟨(-73056324), (-35542736)⟩, ⟨(-9028276), (-8604961)⟩, ⟨45469, 93434⟩, ⟨5440, 5766⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4148669567, 4258674610⟩, ⟨(-73056324), (-35542736)⟩, ⟨(-9028276), (-8604961)⟩, ⟨45469, 93434⟩, ⟨5440, 5766⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨317396973, 644752793⟩, ⟨152077407, 159564797⟩, ⟨(-2476169), (-1208467)⟩, ⟨(-203745), (-192333)⟩, ⟨918, 1888⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4331569270, 4446424035⟩, ⟨36151111, 78299656⟩, ⟨9053965, 11055071⟩, ⟨51055, 317599⟩, ⟨10979, 23578⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨320101849, 667489208⟩, ⟨156044976, 176945859⟩, ⟨(-614356), 3349759⟩, ⟨68285, 254249⟩, ⟨(-6546), 13130⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-618840363), (-309420181)⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3676126933, 3985547115⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨23857037, 103735795⟩, ⟨23259914, 54999000⟩, ⟨5478476, 8331076⟩, ⟨(-40444), 355038⟩, ⟨2444, 27645⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4318824333, 4398703091⟩, ⟨23259914, 54999000⟩, ⟨5478476, 8331076⟩, ⟨(-40444), 355038⟩, ⟨2444, 27645⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306879295, 4346525730⟩, ⟨11492002, 27423442⟩, ⟨2620233, 4138685⟩, ⟨(-46519), 170038⟩, ⟨(-1854), 13285⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3686322591, 4033391151⟩, ⟨(-146731115), (-129691386)⟩, ⟨1254869, 3426568⟩, ⟨(-192249), 63405⟩, ⟨(-7846), 14004⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2480241275, 4960482560⟩, ⟨1240120633, 1240120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1432280238, 5729120977⟩, ⟨1432280232, 2864560494⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1432280238, 5729120977⟩, ⟨1432280232, 2864560494⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5729120977), (-1432280238)⟩, ⟨(-2864560494), (-1432280232)⟩, ⟨(-358070063), (-358070056)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2864560489), (-716140119)⟩, ⟨(-1432280247), (-716140116)⟩, ⟨(-179035032), (-179035028)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2204468590, 3635347033⟩, ⟨(-1212310919), (-367571690)⟩, ⟨(-120894532), 110247032⟩, ⟨(-2040236), 47128578⟩, ⟨(-6226910), 2689829⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1892070836, 3413943703⟩, ⟨(-1262673797), (-382049104)⟩, ⟨(-101788375), 147849766⟩, ⟨(-6812323), 48334764⟩, ⟨(-7578741), 2749789⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4322806953, 4322806955⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3344
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306879295, 4346525730⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3345
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (95433303 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((28817 / 400000) : ℝ)..(28817 / 200000), prawitzNormalCorrection
