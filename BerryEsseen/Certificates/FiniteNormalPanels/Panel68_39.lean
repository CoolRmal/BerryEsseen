...
namespace FiniteNormalPanel68_39

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (47889 / 160000)
def radius : Rat := (15963 / 800000)

def j0 : Jet := ⟨⟨1285510555, 1285510556⟩, ⟨85700703, 85700704⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4038550515, 4038550519⟩, ⟨269236698, 269236703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3797442247, 3797442256⟩, ⟨506325626, 506325638⟩, ⟨16877520, 16877522⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨950, 952⟩, ⟨126, 127⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93737), (-93734)⟩, ⟨126, 127⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-82879), (-82875)⟩, ⟨(-10940), (-10937)⟩, ⟨(-352), (-348)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5030177, 5030182⟩, ⟨(-10940), (-10937)⟩, ⟨(-352), (-348)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4447485, 4447491⟩, ⟨583325, 583329⟩, ⟨18164, 18171⟩, ⟨(-85), (-81)⟩, ⟨(-2), 1⟩⟩
...
def j16 : Jet := ⟨⟨(-138718092), (-138718085)⟩, ⟨583325, 583329⟩, ⟨18164, 18171⟩, ⟨(-85), (-81)⟩, ⟨(-2), 1⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-122649117), (-122649110)⟩, ⟨(-15837463), (-15837457)⟩, ⟨(-460282), (-460272)⟩, ⟨4357, 4365⟩, ⟨58, 64⟩⟩
...
def j19 : Jet := ⟨⟨1309006648, 1309006656⟩, ⟨(-15837463), (-15837457)⟩, ⟨(-460282), (-460272)⟩, ⟨4357, 4365⟩, ⟨58, 64⟩⟩
...
def j22 : Jet := ⟨⟨(-96), (-94)⟩, ⟨(-13), (-12)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11739, 11742⟩, ⟨(-13), (-12)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10379, 10382⟩, ⟨1371, 1375⟩, ⟨43, 46⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841798), (-841794)⟩, ⟨1371, 1375⟩, ⟨43, 46⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-744285), (-744281)⟩, ⟨(-98026), (-98021)⟩, ⟨(-3109), (-3103)⟩, ⟨8, 12⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35047109, 35047114⟩, ⟨(-98026), (-98021)⟩, ⟨(-3109), (-3103)⟩, ⟨8, 12⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨30987284, 30987289⟩, ⟨4044966, 4044973⟩, ⟨123415, 123424⟩, ⟨(-746), (-739)⟩, ⟨(-15), (-9)⟩⟩
...
def j33 : Jet := ⟨⟨(-684840599), (-684840593)⟩, ⟨4044966, 4044973⟩, ⟨123415, 123424⟩, ⟨(-746), (-739)⟩, ⟨(-15), (-9)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-605509298), (-605509290)⟩, ⟨(-77158174), (-77158162)⟩, ⟨(-2105182), (-2105170)⟩, ⟨29784, 29794⟩, ⟨382, 392⟩⟩
...
def j36 : Jet := ⟨⟨3689457998, 3689458006⟩, ⟨(-77158174), (-77158162)⟩, ⟨(-2105182), (-2105170)⟩, ⟨29784, 29794⟩, ⟨382, 392⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1230856746, 1230856756⟩, ⟨67165175, 67165184⟩, ⟨(-1425599), (-1425587)⟩, ⟨(-24758), (-24747)⟩, ⟨327, 335⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4999852022, 4999852034⟩, ⟨104562618, 104562637⟩, ⟨5039599, 5039620⟩, ⟨124679, 124696⟩, ⟨4104, 4125⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1432863434, 1432863450⟩, ⟨108153917, 108153935⟩, ⟨1419848, 1419872⟩, ⟨51010, 51033⟩, ⟨1229, 1250⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1285510556), (-1285510555)⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3009456740, 3009456741⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨478024040, 478024052⟩, ⟨72163432, 72163448⟩, ⟨3670844, 3670864⟩, ⟨105540, 105562⟩, ⟨3857, 3878⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4772991336, 4772991348⟩, ⟨72163432, 72163448⟩, ⟨3670844, 3670864⟩, ⟨105540, 105562⟩, ⟨3857, 3878⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4527675086, 4527675093⟩, ⟨34227232, 34227241⟩, ⟨1611715, 1611726⟩, ⟨37872, 37886⟩, ⟨1255, 1268⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3172513633, 3172513640⟩, ⟨(-66361291), (-66361282)⟩, ⟨446356, 446366⟩, ⟨(-5624), (-5612)⟩, ⟨123, 134⟩⟩
...
def j47 : Jet := ⟨⟨9519080079, 9519080090⟩, ⟨634605333, 634605342⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨21097456466, 21097456515⟩, ⟨2812994170, 2812994214⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨21097456466, 21097456515⟩, ⟨2812994170, 2812994214⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-21097456515), (-21097456466)⟩, ⟨(-2812994214), (-2812994170)⟩, ⟨(-93766475), (-93766471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10548728258), (-10548728233)⟩, ⟨(-1406497107), (-1406497085)⟩, ⟨(-46883238), (-46883235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨368386266, 368386275⟩, ⟨(-120637527), (-120637521)⟩, ⟨15731672, 15731675⟩, ⟨(-839340), (-839338)⟩, ⟨(-17147), (-17146)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨272111606, 272111614⟩, ⟨(-94801838), (-94801831)⟩, ⟨13522578, 13522584⟩, ⟨(-876077), (-876071)⟩, ⟨2103, 2109⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1199809851, 1371211259⟩, ⟨85700703, 85700704⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3769313813, 4307787218⟩, ⟨269236698, 269236703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3307994133, 4320645406⟩, ⟨472570584, 540080680⟩, ⟨16877520, 16877522⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨827, 1083⟩, ⟨118, 136⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93860), (-93603)⟩, ⟨118, 136⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-94422), (-72093)⟩, ⟨(-11713), (-10162)⟩, ⟨(-354), (-343)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5018634, 5040964⟩, ⟨(-11713), (-10162)⟩, ⟨(-354), (-343)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3865363, 5071103⟩, ⟨540410, 626062⟩, ⟨17891, 18427⟩, ⟨(-92), (-73)⟩, ⟨(-2), 2⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139300214), (-138094473)⟩, ⟨540410, 626062⟩, ⟨17891, 18427⟩, ⟨(-92), (-73)⟩, ⟨(-2), 2⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-140133042), (-106360694)⟩, ⟨(-17100406), (-14564578)⟩, ⟨(-474156), (-445392)⟩, ⟨3998, 4723⟩, ⟨55, 68⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1291522723, 1325295072⟩, ⟨(-17100406), (-14564578)⟩, ⟨(-474156), (-445392)⟩, ⟨3998, 4723⟩, ⟨55, 68⟩⟩
...
def j70 : Jet := ⟨⟨(-109), (-82)⟩, ⟨(-14), (-11)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11726, 11754⟩, ⟨(-14), (-11)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9031, 11825⟩, ⟨1275, 1471⟩, ⟨42, 46⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843146), (-840351)⟩, ⟨1275, 1471⟩, ⟨42, 46⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-848187), (-647240)⟩, ⟨(-105042), (-90982)⟩, ⟨(-3142), (-3070)⟩, ⟨6, 12⟩, ⟨(-3), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34943207, 35144155⟩, ⟨(-105042), (-90982)⟩, ⟨(-3142), (-3070)⟩, ⟨6, 12⟩, ⟨(-3), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨26913342, 35354270⟩, ⟨3739092, 4349210⟩, ⟨120942, 125729⟩, ⟨(-805), (-681)⟩, ⟨(-17), (-8)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-688914541), (-680473612)⟩, ⟨3739092, 4349210⟩, ⟨120942, 125729⟩, ⟨(-805), (-681)⟩, ⟨(-17), (-8)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-693033321), (-524102411)⟩, ⟨(-83749309), (-70496559)⟩, ⟨(-2202605), (-2000608)⟩, ⟨27190, 32378⟩, ⟨355, 415⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3601933975, 3770864885⟩, ⟨(-83749309), (-70496559)⟩, ⟨(-2202605), (-2000608)⟩, ⟨27190, 32378⟩, ⟨355, 415⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1133455531, 1329250907⟩, ⟨63809659, 70296139⟩, ⟨(-1547538), (-1303884)⟩, ⟨(-26216), (-23182)⟩, ⟨298, 366⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4891913297, 5121344312⟩, ⟨91454629, 119077433⟩, ⟨4305122, 5900430⟩, ⟨85029, 173082⟩, ⟨2285, 6462⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1290991479, 1585006615⟩, ⟨96813559, 120674847⟩, ⟨649568, 2289972⟩, ⟨12232, 95973⟩, ⟨(-649), 3471⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1371211259), (-1199809851)⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2923756037, 3095157445⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨388049287, 584927847⟩, ⟨58200898, 89067236⟩, ⟨2572786, 5080752⟩, ⟨36636, 199518⟩, ⟨168, 9177⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4683016583, 4879895143⟩, ⟨58200898, 89067236⟩, ⟨2572786, 5080752⟩, ⟨36636, 199518⟩, ⟨168, 9177⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4484796881, 4578098956⟩, ⟨27300737, 42648628⟩, ⟨1008183, 2349754⟩, ⟨(-4803), 89400⟩, ⟨(-1386), 4328⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3052980628, 3299195568⟩, ⟨(-72765540), (-58753887)⟩, ⟨(-164691), 1148593⟩, ⟨(-50349), 44309⟩, ⟨(-2783), 3215⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8884474738, 10153685424⟩, ⟨634605333, 634605342⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨18378228733, 24004217165⟩, ⟨2625461224, 3000527160⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨18378228733, 24004217165⟩, ⟨2625461224, 3000527160⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-24004217165), (-18378228733)⟩, ⟨(-3000527160), (-2625461224)⟩, ⟨(-93766475), (-93766471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12002108583), (-9189114366)⟩, ⟨(-1500263580), (-1312730612)⟩, ⟨(-46883238), (-46883235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨262628515, 505572685⟩, ⟨(-176600248), (-80270807)⟩, ⟨6748383, 27977067⟩, ⟨(-2673383), 597628⟩, ⟨(-204886), 196627⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨186683556, 388357594⟩, ⟨(-144221594), (-60651372)⟩, ⟨5875628, 24617867⟩, ⟨(-2580714), 378744⟩, ⟨(-170733), 206265⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1285510555, 1285510556⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨85700703, 85700704⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4527675086, 4527675093⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1366
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1199809851, 1371211259⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4484796881, 4578098956⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1367
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (11040825 / 4294967296)

theorem envelope_integral : (∫ s in ((111741 / 400000) : ℝ)..(15963 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (111741 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (15963 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((111741 / 400000) : ℝ)..(15963 / 50000), prawitzNormalCorrection
