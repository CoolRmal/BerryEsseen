...
namespace FiniteNormalPanel105_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1253 / 5000)
def radius : Rat := (179 / 5000)

def j0 : Jet := ⟨⟨1076318804, 1076318805⟩, ⟨153759829, 153759830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3381355247, 3381355251⟩, ⟨483050749, 483050753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2662083903, 2662083911⟩, ⟨760595400, 760595408⟩, ⟨54328242, 54328244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-58276), (-58274)⟩, ⟨(-16534), (-16530)⟩, ⟨(-1149), (-1146)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5054780, 5054783⟩, ⟨(-16534), (-16530)⟩, ⟨(-1149), (-1146)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3133026, 3133029⟩, ⟨884901, 884907⟩, ⟨60297, 60303⟩, ⟨(-412), (-407)⟩, ⟨(-15), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-140032551), (-140032547)⟩, ⟨884901, 884907⟩, ⟨60297, 60303⟩, ⟨(-412), (-407)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-86794236), (-86794232)⟩, ⟨(-24249880), (-24249873)⟩, ⟨(-1577232), (-1577224)⟩, ⟨21614, 21622⟩, ⟨679, 685⟩⟩
...
def j19 : Jet := ⟨⟨1344861529, 1344861534⟩, ⟨(-24249880), (-24249873)⟩, ⟨(-1577232), (-1577224)⟩, ⟨21614, 21622⟩, ⟨679, 685⟩⟩
...
def j25 : Jet := ⟨⟨7293, 7296⟩, ⟨2070, 2074⟩, ⟨142, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844884), (-844880)⟩, ⟨2070, 2074⟩, ⟨142, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-523672), (-523669)⟩, ⟨(-148338), (-148333)⟩, ⟨(-10234), (-10228)⟩, ⟨49, 53⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35267722, 35267726⟩, ⟨(-148338), (-148333)⟩, ⟨(-10234), (-10228)⟩, ⟨49, 53⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21859452, 21859456⟩, ⟨6153614, 6153621⟩, ⟨413497, 413505⟩, ⟨(-3660), (-3654)⟩, ⟨(-123), (-117)⟩⟩
...
def j33 : Jet := ⟨⟨(-693968431), (-693968426)⟩, ⟨6153614, 6153621⟩, ⟨413497, 413505⟩, ⟨(-3660), (-3654)⟩, ⟨(-123), (-117)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-430131843), (-430131837)⟩, ⟨(-119080713), (-119080705)⟩, ⟨(-7432169), (-7432158)⟩, ⟨148795, 148803⟩, ⟨4504, 4512⟩⟩
...
def j36 : Jet := ⟨⟨3864835453, 3864835459⟩, ⟨(-119080713), (-119080705)⟩, ⟨(-7432169), (-7432158)⟩, ⟨148795, 148803⟩, ⟨4504, 4512⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1058786778, 1058786784⟩, ⟨132163731, 132163741⟩, ⟨(-3969090), (-3969080)⟩, ⟨(-160374), (-160365)⟩, ⟨2964, 2972⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4772970096, 4772970104⟩, ⟨147061537, 147061549⟩, ⟨13709679, 13709696⟩, ⟨521446, 521462⟩, ⟨31192, 31209⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1176623075, 1176623085⟩, ⟨183126038, 183126054⟩, ⟨3494200, 3494218⟩, ⟨236289, 236307⟩, ⟨8865, 8885⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1076318805), (-1076318804)⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3218648491, 3218648492⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨322340489, 322340495⟩, ⟨100336186, 100336198⟩, ⟨9722507, 9722521⟩, ⟨427430, 427446⟩, ⟨27846, 27865⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4617307785, 4617307791⟩, ⟨100336186, 100336198⟩, ⟨9722507, 9722521⟩, ⟨427430, 427446⟩, ⟨27846, 27865⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4453221972, 4453221975⟩, ⟨48385263, 48385270⟩, ⟨4425639, 4425648⟩, ⟨158033, 158043⟩, ⟨9511, 9522⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3337244545, 3337244549⟩, ⟨(-123165432), (-123165424)⟩, ⟨1584380, 1584389⟩, ⟨(-40010), (-39999)⟩, ⟨1469, 1479⟩⟩
...
def j47 : Jet := ⟨⟨9784065907, 9784065919⟩, ⟨1397723699, 1397723710⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨22288399206, 22288399262⟩, ⟨6368114048, 6368114108⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨22288399206, 22288399262⟩, ⟨6368114048, 6368114108⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-22288399262), (-22288399206)⟩, ⟨(-6368114108), (-6368114048)⟩, ⟨(-454865296), (-454865288)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11144199631), (-11144199603)⟩, ⟨(-3184057054), (-3184057024)⟩, ⟨(-227432648), (-227432644)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨320694204, 320694213⟩, ⟨(-237745390), (-237745380)⟩, ⟨71143984, 71143991⟩, ⟨(-9187840), (-9187836)⟩, ⟨(-180813), (-180811)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨249183499, 249183508⟩, ⟨(-193927659), (-193927648)⟩, ⟨62215835, 62215846⟩, ⟨(-9269935), (-9269927)⟩, ⟨151548, 151556⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨922558975, 1230078634⟩, ⟨153759829, 153759830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2898304498, 3864406001⟩, ⟨483050749, 483050753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1955816746, 3477007556⟩, ⟨651938914, 869251896⟩, ⟨54328242, 54328244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-76259), (-42720)⟩, ⟨(-18991), (-14063)⟩, ⟨(-1163), (-1129)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5036797, 5070337⟩, ⟨(-18991), (-14063)⟩, ⟨(-1163), (-1129)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2293626, 4104712⟩, ⟨749167, 1019775⟩, ⟨58925, 61489⟩, ⟨(-476), (-343)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140871951), (-139060864)⟩, ⟨749167, 1019775⟩, ⟨58925, 61489⟩, ⟨(-476), (-343)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-114043439), (-63324711)⟩, ⟨(-28169709), (-20282674)⟩, ⟨(-1641380), (-1502849)⟩, ⟨18034, 25189⟩, ⟨635, 721⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1317612326, 1368331055⟩, ⟨(-28169709), (-20282674)⟩, ⟨(-1641380), (-1502849)⟩, ⟨18034, 25189⟩, ⟨635, 721⟩⟩
...
def j72 : Jet := ⟨⟨5349, 9544⟩, ⟨1765, 2379⟩, ⟨141, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846828), (-842632)⟩, ⟨1765, 2379⟩, ⟨141, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-685553), (-383712)⟩, ⟨(-170586), (-125978)⟩, ⟨(-10381), (-10056)⟩, ⟨41, 61⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35105841, 35407683⟩, ⟨(-170586), (-125978)⟩, ⟨(-10381), (-10056)⟩, ⟨41, 61⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15986289, 28664429⟩, ⟨5190664, 7108741⟩, ⟨401134, 424181⟩, ⟨(-4241), (-3069)⟩, ⟨(-127), (-112)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699841594), (-687163453)⟩, ⟨5190664, 7108741⟩, ⟨401134, 424181⟩, ⟨(-4241), (-3069)⟩, ⟨(-127), (-112)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-566559497), (-312916419)⟩, ⟨(-139276183), (-98550562)⟩, ⟨(-7881930), (-6909996)⟩, ⟨123112, 174374⟩, ⟨4112, 4850⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3728407799, 3982050877⟩, ⟨(-139276183), (-98550562)⟩, ⟨(-7881930), (-6909996)⟩, ⟨123112, 174374⟩, ⟨4112, 4850⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨889143378, 1231158791⟩, ⟨122844806, 140207816⟩, ⟨(-4645056), (-3295315)⟩, ⟨(-172436), (-146359)⟩, ⟨2456, 3482⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4632473226, 4947619754⟩, ⟨114647665, 184820340⟩, ⟨10876043, 17363410⟩, ⟨251456, 886368⟩, ⟨10975, 60924⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨959013796, 1418242593⟩, ⟨156232501, 214492472⟩, ⟨179804, 7456383⟩, ⟨(-35393), 575079⟩, ⟨(-14088), 38162⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1230078634), (-922558975)⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3064888662, 3372408321⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨214136080, 468318363⟩, ⟨69769622, 141655264⟩, ⟨5763364, 15636195⟩, ⟨(-10296), 1124546⟩, ⟨(-12835), 95589⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4509103376, 4763285659⟩, ⟨69769622, 141655264⟩, ⟨5763364, 15636195⟩, ⟨(-10296), 1124546⟩, ⟨(-12835), 95589⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4400733067, 4523069326⟩, ⟨33125541, 69125385⟩, ⟨2208139, 7505528⟩, ⟨(-122920), 532139⟩, ⟨(-21024), 48024⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3140363116, 3551514035⟩, ⟨(-138287497), (-103268990)⟩, ⟨(-898962), 4707447⟩, ⟨(-365215), 338785⟩, ⟨(-35560), 42110⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8386342207, 11181789619⟩, ⟨1397723699, 1397723710⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨16375150441, 29111378613⟩, ⟨5458383472, 7277844694⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨16375150441, 29111378613⟩, ⟨5458383472, 7277844694⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-29111378613), (-16375150441)⟩, ⟨(-7277844694), (-5458383472)⟩, ⟨(-454865296), (-454865288)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-14555689307), (-8187575220)⟩, ⟨(-3638922347), (-2729191736)⟩, ⟨(-227432648), (-227432644)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨144920989, 638346231⟩, ⟨(-540840525), (-92088516)⟩, ⟨(-4544195), 221440237⟩, ⟨(-59287682), 20376218⟩, ⟨(-10178946), 12678227⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨105962280, 527849328⟩, ⟨(-467774929), (-70817121)⟩, ⟨(-1677018), 201222622⟩, ⟨(-56801962), 17158990⟩, ⟨(-9167346), 12687519⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1076318804, 1076318805⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4453221972, 4453221975⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2116
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨922558975, 1230078634⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4400733067, 4523069326⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2117
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (9754055 / 2147483648)

theorem envelope_integral : (∫ s in ((537 / 2500) : ℝ)..(179 / 625),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((537 / 2500) : ℝ)..(179 / 625), prawitzNormalCorrection
