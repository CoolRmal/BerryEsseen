...
namespace FiniteNormalPanel32_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (266987 / 800000)
def radius : Rat := (38141 / 800000)

def j0 : Jet := ⟨⟨1433375541, 1433375542⟩, ⟨204767934, 204767935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4503082069, 4503082073⟩, ⟨643297437, 643297441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4721281146, 4721281156⟩, ⟨1348937466, 1348937478⟩, ⟨96352676, 96352678⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1181, 1183⟩, ⟨337, 338⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93506), (-93503)⟩, ⟨337, 338⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-102788), (-102784)⟩, ⟨(-28998), (-28994)⟩, ⟨(-1967), (-1962)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5010268, 5010273⟩, ⟨(-28998), (-28994)⟩, ⟨(-1967), (-1962)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5507581, 5507588⟩, ⟨1541717, 1541726⟩, ⟨101128, 101138⟩, ⟨(-1254), (-1248)⟩, ⟨(-41), (-36)⟩⟩
...
def j16 : Jet := ⟨⟨(-137657996), (-137657988)⟩, ⟨1541717, 1541726⟩, ⟨101128, 101138⟩, ⟨(-1254), (-1248)⟩, ⟨(-41), (-36)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-151321782), (-151321772)⟩, ⟨(-41540049), (-41540034)⟩, ⟨(-2492822), (-2492805)⟩, ⟨64968, 64981⟩, ⟨1828, 1839⟩⟩
...
def j19 : Jet := ⟨⟨1280333983, 1280333994⟩, ⟨(-41540049), (-41540034)⟩, ⟨(-2492822), (-2492805)⟩, ⟨64968, 64981⟩, ⟨1828, 1839⟩⟩
...
def j22 : Jet := ⟨⟨(-119), (-117)⟩, ⟨(-34), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11716, 11719⟩, ⟨(-34), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨12878, 12883⟩, ⟨3641, 3645⟩, ⟨247, 251⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-839299), (-839293)⟩, ⟨3641, 3645⟩, ⟨247, 251⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-922607), (-922600)⟩, ⟨(-259600), (-259593)⟩, ⟨(-17415), (-17407)⟩, ⟨155, 161⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34868787, 34868795⟩, ⟨(-259600), (-259593)⟩, ⟨(-17415), (-17407)⟩, ⟨155, 161⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨38329825, 38329835⟩, ⟨10666010, 10666023⟩, ⟨681563, 681577⟩, ⟨(-11124), (-11113)⟩, ⟨(-341), (-332)⟩⟩
...
def j33 : Jet := ⟨⟨(-677498058), (-677498047)⟩, ⟨10666010, 10666023⟩, ⟨681563, 681577⟩, ⟨(-11124), (-11113)⟩, ⟨(-341), (-332)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-744745791), (-744745776)⟩, ⟨(-201059807), (-201059785)⟩, ⟨(-11099764), (-11099742)⟩, ⟨441111, 441131⟩, ⟨11421, 11437⟩⟩
...
def j36 : Jet := ⟨⟨3550221505, 3550221520⟩, ⟨(-201059807), (-201059785)⟩, ⟨(-11099764), (-11099742)⟩, ⟨441111, 441131⟩, ⟨11421, 11437⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1342373201, 1342373215⟩, ⟨148214706, 148214727⟩, ⟨(-8835455), (-8835434)⟩, ⟨(-305258), (-305240)⟩, ⟨11646, 11662⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5195941709, 5195941732⟩, ⟨294261897, 294261934⟩, ⟨32910014, 32910053⟩, ⟨2138179, 2138219⟩, ⟨170679, 170714⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1623968804, 1623968829⟩, ⟨271276629, 271276671⟩, ⟨9751633, 9751676⟩, ⟨829327, 829368⟩, ⟨52602, 52640⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1433375542), (-1433375541)⟩, ⟨(-204767935), (-204767934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2861591754, 2861591755⟩, ⟨(-204767935), (-204767934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨614038360, 614038380⟩, ⟨205144650, 205144686⟩, ⟨24508616, 24508656⟩, ⟨1859006, 1859048⟩, ⟨166680, 166720⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4909005656, 4909005676⟩, ⟨205144650, 205144686⟩, ⟨24508616, 24508656⟩, ⟨1859006, 1859048⟩, ⟨166680, 166720⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4591733741, 4591733751⟩, ⟨95943015, 95943033⟩, ⟨10459952, 10459973⟩, ⟨650870, 650891⟩, ⟨52439, 52460⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3059317220, 3059317229⟩, ⟨(-154993055), (-154993040)⟩, ⟨2394907, 2394924⟩, ⟨(-65041), (-65024)⟩, ⟨3905, 3922⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨21513319386, 21513319388⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value234

def j47 : Jet := ⟨⟨7179720749, 7179720756⟩, ⟨1025674390, 1025674396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12002044830, 12002044855⟩, ⟨3429155656, 3429155682⟩, ⟨244939689, 244939692⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12002044830, 12002044855⟩, ⟨3429155656, 3429155682⟩, ⟨244939689, 244939692⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12002044855), (-12002044830)⟩, ⟨(-3429155682), (-3429155656)⟩, ⟨(-244939692), (-244939689)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6001022428), (-6001022415)⟩, ⟨(-1714577841), (-1714577828)⟩, ⟨(-122469846), (-122469844)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1062072326, 1062072336⟩, ⟨(-423985928), (-423985920)⟩, ⟨54344207, 54344211⟩, ⟨828380, 828382⟩, ⟨(-857480), (-857478)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨756517088, 756517099⟩, ⟨(-340333510), (-340333497)⟩, ⟨54602183, 54602195⟩, ⟨(-1623574), (-1623563)⟩, ⟨(-602995), (-602982)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1228607607, 1638143477⟩, ⟨204767934, 204767935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3859784632, 5146379514⟩, ⟨643297437, 643297441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3468696355, 6166571310⟩, ⟨1156232114, 1541642832⟩, ⟨96352676, 96352678⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨868, 1545⟩, ⟨289, 387⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93819), (-93141)⟩, ⟨289, 387⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-134703), (-75222)⟩, ⟨(-33443), (-24518)⟩, ⟨(-2009), (-1914)⟩, ⟨12, 18⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4978353, 5037835⟩, ⟨(-33443), (-24518)⟩, ⟨(-2009), (-1914)⟩, ⟨12, 18⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4020611, 7233157⟩, ⟨1292186, 1788489⟩, ⟨96793, 104874⟩, ⟨(-1464), (-1039)⟩, ⟨(-43), (-33)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139144966), (-135932419)⟩, ⟨1292186, 1788489⟩, ⟨96793, 104874⟩, ⟨(-1464), (-1039)⟩, ⟨(-43), (-33)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-199779719), (-109781577)⟩, ⟨(-48901337), (-34026005)⟩, ⟨(-2695524), (-2256949)⟩, ⟨52943, 76928⟩, ⟨1583, 2048⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1231876046, 1321874189⟩, ⟨(-48901337), (-34026005)⟩, ⟨(-2695524), (-2256949)⟩, ⟨52943, 76928⟩, ⟨1583, 2048⟩⟩
...
def j72 : Jet := ⟨⟨9432, 16871⟩, ⟨3088, 4196⟩, ⟨243, 256⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842745), (-835305)⟩, ⟨3088, 4196⟩, ⟨243, 256⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1209986), (-674608)⟩, ⟨(-300004), (-218844)⟩, ⟨(-17880), (-16864)⟩, ⟨129, 187⟩, ⟨1, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34581408, 35116787⟩, ⟨(-300004), (-218844)⟩, ⟨(-17880), (-16864)⟩, ⟨129, 187⟩, ⟨1, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨27928595, 50419516⟩, ⟨8878795, 12428137⟩, ⟨642438, 715272⟩, ⟨(-13045), (-9179)⟩, ⟨(-368), (-301)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-687899288), (-665408366)⟩, ⟨8878795, 12428137⟩, ⟨642438, 715272⟩, ⟨(-13045), (-9179)⟩, ⟨(-368), (-301)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-987662937), (-537396309)⟩, ⟨(-239745054), (-161288195)⟩, ⟨(-12523162), (-9439734)⟩, ⟨353403, 528140⟩, ⟨9200, 13333⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3307304359, 3757570987⟩, ⟨(-239745054), (-161288195)⟩, ⟨(-12523162), (-9439734)⟩, ⟨353403, 528140⟩, ⟨9200, 13333⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1107057610, 1583915727⟩, ⟨125914314, 167411109⟩, ⟨(-10554282), (-7124659)⟩, ⟨(-356156), (-245866)⟩, ⟨9351, 13977⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4909220381, 5577576804⟩, ⟨210721047, 404316117⟩, ⟨21377785, 50428286⟩, ⟨663032, 4661901⟩, ⟨5543, 492718⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1265385603, 2056921744⟩, ⟨198237005, 366510585⟩, ⟨(-2018197), 26213156⟩, ⟨(-658440), 3054271⟩, ⟨(-125896), 334048⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1638143477), (-1228607607)⟩, ⟨(-204767935), (-204767934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2656823819, 3066359689⟩, ⟨(-204767935), (-204767934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨372808595, 985089471⟩, ⟨116809388, 351054404⟩, ⟨7216669, 56383861⟩, ⟨(-975120), 7399264⟩, ⟨(-245282), 1001219⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4667775891, 5280056767⟩, ⟨116809388, 351054404⟩, ⟨7216669, 56383861⟩, ⟨(-975120), 7399264⟩, ⟨(-245282), 1001219⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4477493137, 4762107846⟩, ⟨52675466, 168371803⟩, ⟨277848, 26732832⟩, ⟨(-1472948), 3545548⟩, ⟨(-330773), 535584⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2769732478, 3399871182⟩, ⟨(-194454929), (-93262295)⟩, ⟨(-7855464), 16574337⟩, ⟨(-2326123), 2518072⟩, ⟨(-405192), 452602⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6154046358, 8205395151⟩, ⟨1025674390, 1025674396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8817828860, 15676140223⟩, ⟨2939276278, 3919035064⟩, ⟨244939689, 244939692⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8817828860, 15676140223⟩, ⟨2939276278, 3919035064⟩, ⟨244939689, 244939692⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15676140223), (-8817828860)⟩, ⟨(-3919035064), (-2939276278)⟩, ⟨(-244939692), (-244939689)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7838070112), (-4408914430)⟩, ⟨(-1959517532), (-1469638139)⟩, ⟨(-122469846), (-122469844)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨692464039, 1538662542⟩, ⟨(-701992826), (-236945124)⟩, ⟨(-3335991), 140391678⟩, ⟨(-16846283), 13852092⟩, ⟨(-3581571), 1969032⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨446555236, 1217996338⟩, ⟨(-625356496), (-167837223)⟩, ⟨(-309853), 148853730⟩, ⟨(-23233992), 13302308⟩, ⟨(-4275810), 3405505⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1433375541, 1433375542⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4591733741, 4591733751⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar234 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified636
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar234 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1228607607, 1638143477⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4477493137, 4762107846⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified637
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((114423 / 400000) : ℝ)..(38141 / 100000), prawitzNormalCorrection
      ((15653 / 6250) * sqrt n) s) ≤ (upper : ℝ) :=
