...
namespace FiniteNormalPanel157_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3177 / 20000)
def radius : Rat := (3177 / 100000)

def j0 : Jet := ⟨⟨682255554, 682255555⟩, ⟨136451110, 136451111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2143369036, 2143369040⟩, ⟨428673804, 428673808⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1069631153, 1069631158⟩, ⟨427852458, 427852464⟩, ⟨42785245, 42785247⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨267, 268⟩, ⟨107, 108⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94420), (-94418)⟩, ⟨107, 108⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23515), (-23514)⟩, ⟨(-9380), (-9378)⟩, ⟨(-929), (-926)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5089541, 5089543⟩, ⟨(-9380), (-9378)⟩, ⟨(-929), (-926)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1267514, 1267515⟩, ⟨504668, 504671⟩, ⟨49533, 49537⟩, ⟨(-187), (-184)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-141898063), (-141898061)⟩, ⟨504668, 504671⟩, ⟨49533, 49537⟩, ⟨(-187), (-184)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-35338707), (-35338706)⟩, ⟨(-14009800), (-14009797)⟩, ⟨(-1350941), (-1350937)⟩, ⟨9914, 9918⟩, ⟨471, 475⟩⟩
...
def j19 : Jet := ⟨⟨1396317058, 1396317060⟩, ⟨(-14009800), (-14009797)⟩, ⟨(-1350941), (-1350937)⟩, ⟨9914, 9918⟩, ⟨471, 475⟩⟩
...
def j25 : Jet := ⟨⟨2940, 2942⟩, ⟨1173, 1175⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849237), (-849234)⟩, ⟨1173, 1175⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-211497), (-211495)⟩, ⟨(-84307), (-84305)⟩, ⟨(-8316), (-8311)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35579897, 35579900⟩, ⟨(-84307), (-84305)⟩, ⟨(-8316), (-8311)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8860921, 8860922⟩, ⟨3523371, 3523374⟩, ⟨343965, 343970⟩, ⟨(-1664), (-1660)⟩, ⟨(-82), (-78)⟩⟩
...
def j33 : Jet := ⟨⟨(-706966962), (-706966960)⟩, ⟨3523371, 3523374⟩, ⟨343965, 343970⟩, ⟨(-1664), (-1660)⟩, ⟨(-82), (-78)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-176065111), (-176065108)⟩, ⟨(-69548575), (-69548571)⟩, ⟨(-6605955), (-6605951)⟩, ⟨68947, 68952⟩, ⟨3239, 3243⟩⟩
...
def j36 : Jet := ⟨⟨4118902185, 4118902188⟩, ⟨(-69548575), (-69548571)⟩, ⟨(-6605955), (-6605951)⟩, ⟨68947, 68952⟩, ⟨3239, 3243⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨696820846, 696820849⟩, ⟨132372689, 132372693⟩, ⟨(-2072473), (-2072469)⟩, ⟨(-129889), (-129884)⟩, ⟨1224, 1228⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4478558419, 4478558423⟩, ⟨75621445, 75621451⟩, ⟨8459655, 8459663⟩, ⟨189150, 189160⟩, ⟨11966, 11977⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨726606898, 726606903⟩, ⟨150299961, 150299968⟩, ⟨1542125, 1542134⟩, ⟨119484, 119497⟩, ⟨2676, 2687⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-682255555), (-682255554)⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3612711741, 3612711742⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨122924704, 122924706⟩, ⟨50854398, 50854402⟩, ⟨5781444, 5781449⟩, ⟨148356, 148368⟩, ⟨9819, 9828⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4417892000, 4417892002⟩, ⟨50854398, 50854402⟩, ⟨5781444, 5781449⟩, ⟨148356, 148368⟩, ⟨9819, 9828⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4355996057, 4355996059⟩, ⟨25070956, 25070959⟩, ⟨2778073, 2778077⟩, ⟨57148, 57156⟩, ⟨3625, 3632⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3664046083, 3664046087⟩, ⟨(-117301561), (-117301555)⟩, ⟨1540271, 1540276⟩, ⟨(-40190), (-40182)⟩, ⟨1233, 1241⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨49816073401, 49816073409⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value641

def j47 : Jet := ⟨⟨7913283248, 7913283262⟩, ⟨1582656640, 1582656653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14579866957, 14579867010⟩, ⟨5831946746, 5831946806⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14579866957, 14579867010⟩, ⟨5831946746, 5831946806⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14579867010), (-14579866957)⟩, ⟨(-5831946806), (-5831946746)⟩, ⟨(-583194681), (-583194671)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7289933505), (-7289933478)⟩, ⟨(-2915973403), (-2915973373)⟩, ⟨(-291597341), (-291597335)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨786725432, 786725442⟩, ⟨(-534129903), (-534129890)⟩, ⟨127904867, 127904876⟩, ⟨(-4770352), (-4770348)⟩, ⟨(-3532230), (-3532227)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨671157203, 671157213⟩, ⟨(-477153973), (-477153958)⟩, ⟨123985894, 123985907⟩, ⟨(-7761773), (-7761764)⟩, ⟨(-2831979), (-2831968)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨545804443, 818706666⟩, ⟨136451110, 136451111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1714695228, 2572042848⟩, ⟨428673804, 428673808⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨684563937, 1540268868⟩, ⟨342281966, 513422956⟩, ⟨42785245, 42785247⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨171, 386⟩, ⟨85, 129⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94516), (-94300)⟩, ⟨85, 129⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-33896), (-15030)⟩, ⟨(-11286), (-7468)⟩, ⟨(-935), (-919)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5079160, 5098027⟩, ⟨(-11286), (-7468)⟩, ⟨(-935), (-919)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨809554, 1828264⟩, ⟨400729, 608232⟩, ⟨48911, 50045⟩, ⟨(-225), (-145)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142356023), (-141337312)⟩, ⟨400729, 608232⟩, ⟨48911, 50045⟩, ⟨(-225), (-145)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-51051973), (-22527395)⟩, ⟨(-16953454), (-11045571)⟩, ⟨(-1378381), (-1317305)⟩, ⟨7807, 12020⟩, ⟨456, 487⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1380603792, 1409128371⟩, ⟨(-16953454), (-11045571)⟩, ⟨(-1378381), (-1317305)⟩, ⟨7807, 12020⟩, ⟨456, 487⟩⟩
...
def j70 : Jet := ⟨⟨(-39), (-17)⟩, ⟨(-13), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11796, 11819⟩, ⟨(-13), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1880, 4239⟩, ⟨935, 1412⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850297), (-847937)⟩, ⟨935, 1412⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-304936), (-135150)⟩, ⟨(-101497), (-67068)⟩, ⟨(-8379), (-8234)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35486458, 35656245⟩, ⟨(-101497), (-67068)⟩, ⟨(-8379), (-8234)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5656096, 12787107⟩, ⟨2791648, 4251680⟩, ⟨338367, 348542⟩, ⟨(-2012), (-1313)⟩, ⟨(-84), (-77)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710171787), (-703040775)⟩, ⟨2791648, 4251680⟩, ⟨338367, 348542⟩, ⟨(-2012), (-1313)⟩, ⟨(-84), (-77)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-254683079), (-112055884)⟩, ⟨(-84449407), (-54503196)⟩, ⟨(-6798124), (-6370248)⟩, ⟨54052, 83811⟩, ⟨3098, 3357⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4040284217, 4182911412⟩, ⟨(-84449407), (-54503196)⟩, ⟨(-6798124), (-6370248)⟩, ⟨54052, 83811⟩, ⟨3098, 3357⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨551183413, 843857078⟩, ⟨127643269, 136233084⟩, ⟨(-2517543), (-1628352)⟩, ⟨(-134459), (-124279)⟩, ⟨961, 1492⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4410025041, 4565704561⟩, ⟨57462478, 95431665⟩, ⟨7464857, 9676889⟩, ⟨93295, 303841⟩, ⟨7004, 18486⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨565949048, 897050396⟩, ⟨138436997, 163570676⟩, ⟨(-10515), 3256322⟩, ⟨34948, 217249⟩, ⟨(-4005), 10366⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-818706666), (-545804443)⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3476260630, 3749162853⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨74575265, 187358683⟩, ⟨36483764, 68327012⟩, ⟨4457759, 7589708⟩, ⟨8408, 338780⟩, ⟨570, 23349⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4369542561, 4482325979⟩, ⟨36483764, 68327012⟩, ⟨4457759, 7589708⟩, ⟨8408, 338780⟩, ⟨570, 23349⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4332094458, 4387646692⟩, ⟨17856562, 33870716⟩, ⟨2051065, 3725530⟩, ⟨(-24962), 159485⟩, ⟨(-2567), 11285⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3506310612, 3830064552⟩, ⟨(-124942792), (-108064213)⟩, ⟨584017, 2684788⟩, ⟨(-140151), 74056⟩, ⟨(-7308), 10645⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6330626596, 9495939914⟩, ⟨1582656640, 1582656653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9331114845, 20995008492⟩, ⟨4665557396, 6998336168⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9331114845, 20995008492⟩, ⟨4665557396, 6998336168⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20995008492), (-9331114845)⟩, ⟨(-6998336168), (-4665557396)⟩, ⟨(-583194681), (-583194671)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10497504246), (-4665557422)⟩, ⟨(-3499168084), (-2332778698)⟩, ⟨(-291597341), (-291597335)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨372806135, 1449413815⟩, ⟨(-1180857086), (-202486806)⟩, ⟨(-43415177), 455719289⟩, ⟨(-114595298), 65238105⟩, ⟨(-28757621), 24814375⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨304350188, 1292524039⟩, ⟨(-1095201047), (-174685529)⟩, ⟨(-33570368), 441648357⟩, ⟨(-116233649), 59436927⟩, ⟨(-27592570), 25789012⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨682255554, 682255555⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4355996057, 4355996059⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar641 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3170
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar641 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨545804443, 818706666⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4332094458, 4387646692⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3171
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((3177 / 25000) : ℝ)..(9531 / 50000), prawitzNormalCorrection
      ((28131 / 10000) * sqrt n) s) ≤ (upper : ℝ) :=
