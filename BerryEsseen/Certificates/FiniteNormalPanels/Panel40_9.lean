...
namespace FiniteNormalPanel40_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (34423 / 160000)
def radius : Rat := (34423 / 800000)

def j0 : Jet := ⟨⟨924035370, 924035371⟩, ⟨184807074, 184807075⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2902942729, 2902942734⟩, ⟨580588545, 580588550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1962081642, 1962081650⟩, ⟨784832656, 784832666⟩, ⟨78483265, 78483267⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨491, 492⟩, ⟨196, 197⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94196), (-94194)⟩, ⟨196, 197⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-43032), (-43030)⟩, ⟨(-17124), (-17122)⟩, ⟨(-1679), (-1675)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5070024, 5070027⟩, ⟨(-17124), (-17122)⟩, ⟨(-1679), (-1675)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2316152, 2316155⟩, ⟨918638, 918641⟩, ⟨88748, 88754⟩, ⟨(-618), (-614)⟩, ⟨(-30), (-27)⟩⟩
...
def j16 : Jet := ⟨⟨(-140849425), (-140849421)⟩, ⟨918638, 918641⟩, ⟨88748, 88754⟩, ⟨(-618), (-614)⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-64344628), (-64344625)⟩, ⟨(-25318189), (-25318184)⟩, ⟨(-2365379), (-2365372)⟩, ⟨32720, 32726⟩, ⟨1494, 1498⟩⟩
...
def j19 : Jet := ⟨⟨1367311137, 1367311141⟩, ⟨(-25318189), (-25318184)⟩, ⟨(-2365379), (-2365372)⟩, ⟨32720, 32726⟩, ⟨1494, 1498⟩⟩
...
def j22 : Jet := ⟨⟨(-50), (-48)⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11785, 11788⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5383, 5386⟩, ⟨2143, 2147⟩, ⟨210, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846794), (-846790)⟩, ⟨2143, 2147⟩, ⟨210, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-386844), (-386841)⟩, ⟨(-153760), (-153755)⟩, ⟨(-14988), (-14982)⟩, ⟨76, 79⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35404550, 35404554⟩, ⟨(-153760), (-153755)⟩, ⟨(-14988), (-14982)⟩, ⟨76, 79⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16173957, 16173960⟩, ⟨6399339, 6399344⟩, ⟨612012, 612019⟩, ⟨(-5515), (-5509)⟩, ⟨(-261), (-256)⟩⟩
...
def j33 : Jet := ⟨⟨(-699653926), (-699653922)⟩, ⟨6399339, 6399344⟩, ⟨612012, 612019⟩, ⟨(-5515), (-5509)⟩, ⟨(-261), (-256)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-319624816), (-319624812)⟩, ⟨(-124926501), (-124926494)⟩, ⟨(-11336035), (-11336029)⟩, ⟨226251, 226259⟩, ⟨10055, 10062⟩⟩
...
def j36 : Jet := ⟨⟨3975342480, 3975342484⟩, ⟨(-124926501), (-124926494)⟩, ⟨(-11336035), (-11336029)⟩, ⟨226251, 226259⟩, ⟨10055, 10062⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨924157426, 924157431⟩, ⟨167719072, 167719079⟩, ⟨(-5021229), (-5021221)⟩, ⟨(-297635), (-297628)⟩, ⟨5432, 5437⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4640290527, 4640290533⟩, ⟨145822712, 145822723⟩, ⟨17814712, 17814723⟩, ⟨711552, 711567⟩, ⟨53113, 53128⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨998461374, 998461382⟩, ⟨212580981, 212580993⟩, ⟨4102681, 4102695⟩, ⟨356725, 356741⟩, ⟨14148, 14162⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-924035371), (-924035370)⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3370931925, 3370931926⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨232114716, 232114721⟩, ⟨98838422, 98838430⟩, ⟨12429293, 12429303⟩, ⟨571982, 571996⟩, ⟨45809, 45822⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4527082012, 4527082017⟩, ⟨98838422, 98838430⟩, ⟨12429293, 12429303⟩, ⟨571982, 571996⟩, ⟨45809, 45822⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4409497611, 4409497615⟩, ⟨48135618, 48135623⟩, ⟨5790497, 5790503⟩, ⟨215351, 215360⟩, ⟨16156, 16164⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3460821758, 3460821763⟩, ⟨(-151955632), (-151955625)⟩, ⟨2473491, 2473498⟩, ⟨(-80140), (-80130)⟩, ⟨3413, 3421⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨27929980133, 27929980139⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value267

def j47 : Jet := ⟨⟨6008960662, 6008960670⟩, ⟨1201792132, 1201792140⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8406957666, 8406957690⟩, ⟨3362783064, 3362783094⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8406957666, 8406957690⟩, ⟨3362783064, 3362783094⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8406957690), (-8406957666)⟩, ⟨(-3362783094), (-3362783064)⟩, ⟨(-336278311), (-336278306)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4203478845), (-4203478833)⟩, ⟨(-1681391547), (-1681391532)⟩, ⟨(-168139156), (-168139153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1614047909, 1614047924⟩, ⟨(-631866636), (-631866624)⟩, ⟨60494741, 60494748⟩, ⟨8596703, 8596706⟩, ⟨(-2025482), (-2025480)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1300576171, 1300576186⟩, ⟨(-566253783), (-566253768)⟩, ⟨72030707, 72030720⟩, ⟨4392784, 4392795⟩, ⟨(-1888346), (-1888335)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨739228296, 1108842445⟩, ⟨184807074, 184807075⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2322354183, 3483531280⟩, ⟨580588545, 580588550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1255732251, 2825397575⟩, ⟨627866124, 941799198⟩, ⟨78483265, 78483267⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨314, 708⟩, ⟨157, 236⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94373), (-93978)⟩, ⟨157, 236⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-62083), (-27476)⟩, ⟨(-20650), (-13582)⟩, ⟨(-1698), (-1651)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5050973, 5085581⟩, ⟨(-20650), (-13582)⟩, ⟨(-1698), (-1651)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1476767, 3345495⟩, ⟨724798, 1111194⟩, ⟨86650, 90464⟩, ⟨(-750), (-482)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141688810), (-139820081)⟩, ⟨724798, 1111194⟩, ⟨86650, 90464⟩, ⟨(-750), (-482)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-93208445), (-40879609)⟩, ⟨(-30857571), (-19708817)⟩, ⟨(-2457835), (-2251801)⟩, ⟨25417, 40003⟩, ⟨1396, 1577⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1338447320, 1390776157⟩, ⟨(-30857571), (-19708817)⟩, ⟨(-2457835), (-2251801)⟩, ⟨25417, 40003⟩, ⟨1396, 1577⟩⟩
...
def j72 : Jet := ⟨⟨3439, 7766⟩, ⟨1703, 2585⟩, ⟨206, 214⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848738), (-844410)⟩, ⟨1703, 2585⟩, ⟨206, 214⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-558334), (-246882)⟩, ⟨(-185615), (-121740)⟩, ⟨(-15202), (-14722)⟩, ⟨59, 95⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35233060, 35544513⟩, ⟨(-185615), (-121740)⟩, ⟨(-15202), (-14722)⟩, ⟨59, 95⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10301193, 23382572⟩, ⟨5028491, 7758598⟩, ⟨593121, 627416⟩, ⟨(-6709), (-4313)⟩, ⟨(-270), (-245)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705526690), (-692445310)⟩, ⟨5028491, 7758598⟩, ⟨593121, 627416⟩, ⟨(-6709), (-4313)⟩, ⟨(-270), (-245)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-464123069), (-202452276)⟩, ⟨(-153237497), (-96122228)⟩, ⟨(-11983799), (-10539224)⟩, ⟨174179, 278095⟩, ⟨9188, 10764⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3830844227, 4092515020⟩, ⟨(-153237497), (-96122228)⟩, ⟨(-11983799), (-10539224)⟩, ⟨174179, 278095⟩, ⟨9188, 10764⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨723718836, 1128020754⟩, ⟨155901970, 177346604⟩, ⟨(-6164774), (-3881797)⟩, ⟨(-318505), (-271949)⟩, ⟨4189, 6688⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4507434666, 4815320849⟩, ⟨105867580, 192617521⟩, ⟨14094287, 22768369⟩, ⟨276458, 1308371⟩, ⟨17033, 107940⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨759520421, 1264685266⟩, ⟨181453373, 249421542⟩, ⟨(-693860), 9859520⟩, ⟨(-75379), 902689⟩, ⟨(-29665), 70433⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1108842445), (-739228296)⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3186124851, 3555739000⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨134313309, 372396043⟩, ⟨64176294, 146888080⟩, ⟨7257398, 20291072⟩, ⟨(-124982), 1676752⟩, ⟨(-27821), 168958⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4429280605, 4667363339⟩, ⟨64176294, 146888080⟩, ⟨7257398, 20291072⟩, ⟨(-124982), 1676752⟩, ⟨(-27821), 168958⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4361606967, 4477295267⟩, ⟨30781428, 72321911⟩, ⟨2896818, 9881908⟩, ⟨(-225394), 805123⟩, ⟨(-38244), 85965⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3235559991, 3706685593⟩, ⟨(-169817911), (-127800269)⟩, ⟨(-962983), 6856598⟩, ⟨(-611808), 541904⟩, ⟨(-66306), 80869⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4807168529, 7210752803⟩, ⟨1201792132, 1201792140⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5380452905, 12106019069⟩, ⟨2690226452, 4035339712⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5380452905, 12106019069⟩, ⟨2690226452, 4035339712⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12106019069), (-5380452905)⟩, ⟨(-4035339712), (-2690226452)⟩, ⟨(-336278311), (-336278306)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6053009535), (-2690226452)⟩, ⟨(-2017669856), (-1345113226)⟩, ⟨(-168139156), (-168139153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1049294288, 2295789489⟩, ⟨(-1078505360), (-328621739)⟩, ⟨(-38415982), 212249911⟩, ⟨(-24660017), 34163143⟩, ⟨(-8166826), 3648121⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨790472751, 1981335186⟩, ⟨(-1021555266), (-278785694)⟩, ⟨(-23890481), 229485922⟩, ⟨(-31723230), 31534220⟩, ⟨(-8631837), 4659166⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨924035370, 924035371⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨184807074, 184807075⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4409497611, 4409497615⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar267 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified786
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar267 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨739228296, 1108842445⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4361606967, 4477295267⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified787
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((34423 / 200000) : ℝ)..(103269 / 400000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (34423 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (103269 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((34423 / 200000) : ℝ)..(103269 / 400000), prawitzNormalCorrection
      ((290821 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
