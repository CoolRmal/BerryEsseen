...
namespace FiniteNormalPanel76_31

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (56277 / 320000)
def radius : Rat := (6253 / 320000)

def j0 : Jet := ⟨⟨755337107, 755337108⟩, ⟨83926345, 83926346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2372961506, 2372961510⟩, ⟨263662388, 263662393⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1311056853, 1311056858⟩, ⟨291345964, 291345972⟩, ⟨16185886, 16185888⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨328, 329⟩, ⟨72, 73⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94359), (-94357)⟩, ⟨72, 73⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-28804), (-28802)⟩, ⟨(-6380), (-6377)⟩, ⟨(-351), (-348)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5084252, 5084255⟩, ⟨(-6380), (-6377)⟩, ⟨(-351), (-348)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1551989, 1551991⟩, ⟨342938, 342941⟩, ⟨18619, 18623⟩, ⟨(-49), (-46)⟩, ⟨(-2), 1⟩⟩
...
def j16 : Jet := ⟨⟨(-141613588), (-141613585)⟩, ⟨342938, 342941⟩, ⟨18619, 18623⟩, ⟨(-49), (-46)⟩, ⟨(-2), 1⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-43228145), (-43228143)⟩, ⟨(-9501572), (-9501568)⟩, ⟨(-504736), (-504731)⟩, ⟨2540, 2543⟩, ⟨65, 69⟩⟩
...
def j19 : Jet := ⟨⟨1388427620, 1388427623⟩, ⟨(-9501572), (-9501568)⟩, ⟨(-504736), (-504731)⟩, ⟨2540, 2543⟩, ⟨65, 69⟩⟩
...
def j22 : Jet := ⟨⟨(-33), (-32)⟩, ⟨(-8), (-7)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11802, 11804⟩, ⟨(-8), (-7)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3602, 3604⟩, ⟨797, 799⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848575), (-848572)⟩, ⟨797, 799⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-259032), (-259030)⟩, ⟨(-57320), (-57318)⟩, ⟨(-3132), (-3128)⟩, ⟨4, 8⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35532362, 35532365⟩, ⟨(-57320), (-57318)⟩, ⟨(-3132), (-3128)⟩, ⟨4, 8⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10846403, 10846405⟩, ⟨2392813, 2392817⟩, ⟨129060, 129065⟩, ⟨(-429), (-425)⟩, ⟨(-13), (-9)⟩⟩
...
def j33 : Jet := ⟨⟨(-704981480), (-704981477)⟩, ⟨2392813, 2392817⟩, ⟨129060, 129065⟩, ⟨(-429), (-425)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-215198567), (-215198564)⟩, ⟨(-47091489), (-47091484)⟩, ⟨(-2455063), (-2455059)⟩, ⟨17640, 17645⟩, ⟨452, 457⟩⟩
...
def j36 : Jet := ⟨⟨4079768729, 4079768732⟩, ⟨(-47091489), (-47091484)⟩, ⟨(-2455063), (-2455059)⟩, ⟨17640, 17645⟩, ⟨452, 457⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨767103698, 767103702⟩, ⟨79984141, 79984148⟩, ⟨(-862156), (-862150)⟩, ⟨(-29583), (-29578)⟩, ⟨190, 196⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4521517097, 4521517101⟩, ⟨52190445, 52190453⟩, ⟨3323303, 3323311⟩, ⟨50208, 50218⟩, ⟨1844, 1855⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨807566681, 807566687⟩, ⟨93524610, 93524620⟩, ⟨657856, 657866⟩, ⟨29235, 29246⟩, ⟨436, 449⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-755337108), (-755337107)⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3539630188, 3539630189⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨151843750, 151843754⟩, ⟨35170166, 35170172⟩, ⟨2283923, 2283930⟩, ⟨39642, 39652⟩, ⟨1534, 1545⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4446811046, 4446811050⟩, ⟨35170166, 35170172⟩, ⟨2283923, 2283930⟩, ⟨39642, 39652⟩, ⟨1534, 1545⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4370229743, 4370229746⟩, ⟨17282239, 17282243⟩, ⟨1088123, 1088128⟩, ⟨15176, 15182⟩, ⟨557, 565⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3601656557, 3601656562⟩, ⟨(-71154135), (-71154129)⟩, ⟨559053, 559059⟩, ⟨(-8756), (-8749)⟩, ⟨162, 170⟩⟩
...
def j47 : Jet := ⟨⟨6386430962, 6386430972⟩, ⟨709603438, 709603447⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9496347148, 9496347178⟩, ⟨2110299358, 2110299390⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9496347148, 9496347178⟩, ⟨2110299358, 2110299390⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9496347178), (-9496347148)⟩, ⟨(-2110299390), (-2110299358)⟩, ⟨(-117238856), (-117238852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4748173589), (-4748173574)⟩, ⟨(-1055149695), (-1055149679)⟩, ⟨(-58619428), (-58619426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1421799928, 1421799948⟩, ⟨(-349295275), (-349295264)⟩, ⟨23500596, 23500600⟩, ⟨1253740, 1253742⟩, ⟨(-237376), (-237374)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1192287316, 1192287336⟩, ⟨(-316465406), (-316465392)⟩, ⟨25678830, 25678838⟩, ⟨613658, 613666⟩, ⟨(-216007), (-215997)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨671410762, 839263454⟩, ⟨83926345, 83926346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2109299117, 2636623902⟩, ⟨263662388, 263662393⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1035896773, 1618588716⟩, ⟨258974190, 323717748⟩, ⟨16185886, 16185888⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨259, 406⟩, ⟨64, 82⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94428), (-94280)⟩, ⟨64, 82⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-35586), (-22739)⟩, ⟨(-7103), (-5653)⟩, ⟨(-353), (-346)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5077470, 5090318⟩, ⟨(-7103), (-5653)⟩, ⟨(-353), (-346)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1224627, 1918323⟩, ⟨303479, 382302⟩, ⟨18464, 18761⟩, ⟨(-54), (-40)⟩, ⟨(-2), 1⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141940950), (-141247253)⟩, ⟨303479, 382302⟩, ⟨18464, 18761⟩, ⟨(-54), (-40)⟩, ⟨(-2), 1⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-53491449), (-34067214)⟩, ⟨(-10625095), (-8372729)⟩, ⟨(-512164), (-496414)⟩, ⟨2235, 2847⟩, ⟨63, 70⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1378164316, 1397588552⟩, ⟨(-10625095), (-8372729)⟩, ⟨(-512164), (-496414)⟩, ⟨2235, 2847⟩, ⟨63, 70⟩⟩
...
def j70 : Jet := ⟨⟨(-41), (-25)⟩, ⟨(-9), (-6)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11794, 11811⟩, ⟨(-9), (-6)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2844, 4452⟩, ⟨707, 890⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849333), (-847724)⟩, ⟨707, 890⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-320078), (-204461)⟩, ⟨(-63846), (-50779)⟩, ⟨(-3149), (-3109)⟩, ⟨3, 8⟩, ⟨(-2), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35471316, 35586934⟩, ⟨(-63846), (-50779)⟩, ⟨(-3149), (-3109)⟩, ⟨3, 8⟩, ⟨(-2), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8555273, 13411188⟩, ⟨2114757, 2669991⟩, ⟨127676, 130302⟩, ⟨(-479), (-374)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707272610), (-702416694)⟩, ⟨2114757, 2669991⟩, ⟨127676, 130302⟩, ⟨(-479), (-374)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-266540672), (-169414837)⟩, ⟨(-52798081), (-41347503)⟩, ⟨(-2507101), (-2396759)⟩, ⟨15486, 19795⟩, ⟨439, 468⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4028426624, 4125552459⟩, ⟨(-52798081), (-41347503)⟩, ⟨(-2507101), (-2396759)⟩, ⟨15486, 19795⟩, ⟨439, 468⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨676829548, 857961221⟩, ⟨78081087, 81684197⟩, ⟨(-966672), (-757783)⟩, ⟨(-30345), (-28726)⟩, ⟨167, 218⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4471339113, 4579143620⟩, ⟨44813078, 60015987⟩, ⟨3046773, 3636435⟩, ⟨34597, 67826⟩, ⟨1308, 2494⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨704623393, 914728188⟩, ⟨88349411, 99077603⟩, ⟨264184, 1078933⟩, ⟨14980, 44898⟩, ⟨(-237), 1186⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-839263454), (-671410762)⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3455703842, 3623556534⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨115599046, 194815840⟩, ⟨28988840, 42202454⟩, ⟨1904069, 2745129⟩, ⟨15782, 68906⟩, ⟨530, 2850⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4410566342, 4489783136⟩, ⟨28988840, 42202454⟩, ⟨1904069, 2745129⟩, ⟨15782, 68906⟩, ⟨530, 2850⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4352383047, 4391294996⟩, ⟨14176469, 20822864⟩, ⟨881780, 1331371⟩, ⟨1404, 31127⟩, ⟨(-92), 1313⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3501900196, 3704825807⟩, ⟨(-74402352), (-67480554)⟩, ⟨302582, 846228⟩, ⟨(-24887), 9032⟩, ⟨(-687), 1081⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5676827523, 7096034419⟩, ⟨709603438, 709603447⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7503286638, 11723885424⟩, ⟨1875821652, 2344777102⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7503286638, 11723885424⟩, ⟨1875821652, 2344777102⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11723885424), (-7503286638)⟩, ⟨(-2344777102), (-1875821652)⟩, ⟨(-117238856), (-117238852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5861942712), (-3751643319)⟩, ⟨(-1172388551), (-937910826)⟩, ⟨(-58619428), (-58619426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1097027271, 1793100802⟩, ⟨(-489459106), (-239562651)⟩, ⟨1684217, 51830667⟩, ⟨(-2536274), 4330960⟩, ⟨(-649257), 161588⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨894460830, 1546723332⟩, ⟨(-453268096), (-212563318)⟩, ⟨5214408, 53541241⟩, ⟨(-3192483), 3696307⟩, ⟨(-636273), 196825⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨755337107, 755337108⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨83926345, 83926346⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4370229743, 4370229746⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1530
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨671410762, 839263454⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4352383047, 4391294996⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1531
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (46932139 / 4294967296)

theorem envelope_integral : (∫ s in ((6253 / 40000) : ℝ)..(6253 / 32000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (6253 / 40000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (6253 / 32000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((6253 / 40000) : ℝ)..(6253 / 32000), prawitzNormalCorrection
