...
namespace FiniteNormalPanel63_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2351 / 10000)
def radius : Rat := (2351 / 50000)

def j0 : Jet := ⟨⟨1009746811, 1009746812⟩, ⟨201949362, 201949363⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3172213163, 3172213167⟩, ⟨634442632, 634442636⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2342959947, 2342959954⟩, ⟨937183978, 937183986⟩, ⟨93718397, 93718399⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨586, 587⟩, ⟨234, 235⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94101), (-94099)⟩, ⟨234, 235⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-51334), (-51332)⟩, ⟨(-20407), (-20403)⟩, ⟨(-1991), (-1987)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5061722, 5061725⟩, ⟨(-20407), (-20403)⟩, ⟨(-1991), (-1987)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2761234, 2761237⟩, ⟨1093360, 1093365⟩, ⟨104909, 104915⟩, ⟨(-876), (-871)⟩, ⟨(-42), (-39)⟩⟩
...
def j16 : Jet := ⟨⟨(-140404343), (-140404339)⟩, ⟨1093360, 1093365⟩, ⟨104909, 104915⟩, ⟨(-876), (-871)⟩, ⟨(-42), (-39)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-76592377), (-76592374)⟩, ⟨(-30040510), (-30040504)⟩, ⟨(-2767891), (-2767883)⟩, ⟨46270, 46276⟩, ⟨2074, 2079⟩⟩
...
def j19 : Jet := ⟨⟨1355063388, 1355063392⟩, ⟨(-30040510), (-30040504)⟩, ⟨(-2767891), (-2767883)⟩, ⟨46270, 46276⟩, ⟨2074, 2079⟩⟩
...
def j22 : Jet := ⟨⟨(-59), (-58)⟩, ⟨(-24), (-23)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11776, 11778⟩, ⟨(-24), (-23)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6423, 6426⟩, ⟨2555, 2559⟩, ⟨248, 252⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845754), (-845750)⟩, ⟨2555, 2559⟩, ⟨248, 252⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-461370), (-461367)⟩, ⟨(-183155), (-183151)⟩, ⟨(-17763), (-17757)⟩, ⟨107, 111⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35330024, 35330028⟩, ⟨(-183155), (-183151)⟩, ⟨(-17763), (-17757)⟩, ⟨107, 111⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19272982, 19272986⟩, ⟨7609279, 7609284⟩, ⟨721263, 721270⟩, ⟨(-7815), (-7809)⟩, ⟨(-364), (-358)⟩⟩
...
def j33 : Jet := ⟨⟨(-696554901), (-696554896)⟩, ⟨7609279, 7609284⟩, ⟨721263, 721270⟩, ⟨(-7815), (-7809)⟩, ⟨(-364), (-358)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-379979667), (-379979662)⟩, ⟨(-147840909), (-147840901)⟩, ⟨(-13145346), (-13145338)⟩, ⟨319157, 319165⟩, ⟨13833, 13841⟩⟩
...
def j36 : Jet := ⟨⟨3914987629, 3914987634⟩, ⟨(-147840909), (-147840901)⟩, ⟨(-13145346), (-13145338)⟩, ⟨319157, 319165⟩, ⟨13833, 13841⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1000834143, 1000834148⟩, ⟨177979254, 177979263⟩, ⟨(-6481848), (-6481839)⟩, ⟨(-374693), (-374686)⟩, ⟨8365, 8372⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4711826906, 4711826913⟩, ⟨177931783, 177931795⟩, ⟨22540083, 22540096⟩, ⟨1064489, 1064504⟩, ⟨84714, 84731⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1097972794, 1097972802⟩, ⟨236716037, 236716052⟩, ⟨5514756, 5514773⟩, ⟨502501, 502515⟩, ⟨23487, 23505⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1009746812), (-1009746811)⟩, ⟨(-201949363), (-201949362)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3285220484, 3285220485⟩, ⟨(-201949363), (-201949362)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨280687645, 280687650⟩, ⟨121028986, 121028996⟩, ⟨15866146, 15866161⟩, ⟨864808, 864820⟩, ⟨74478, 74492⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4575654941, 4575654946⟩, ⟨121028986, 121028996⟩, ⟨15866146, 15866161⟩, ⟨864808, 864820⟩, ⟨74478, 74492⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4433090155, 4433090159⟩, ⟨58629028, 58629034⟩, ⟨7298206, 7298215⟩, ⟨322409, 322417⟩, ⟨25806, 25815⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3390870658, 3390870663⟩, ⟨(-163598558), (-163598549)⟩, ⟨2825659, 2825669⟩, ⟨(-96553), (-96544)⟩, ⟨4578, 4587⟩⟩
...
def j47 : Jet := ⟨⟨5208608740, 5208608748⟩, ⟨1041721747, 1041721753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6316603395, 6316603416⟩, ⟨2526641354, 2526641376⟩, ⟨252664135, 252664139⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6316603395, 6316603416⟩, ⟨2526641354, 2526641376⟩, ⟨252664135, 252664139⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6316603416), (-6316603395)⟩, ⟨(-2526641376), (-2526641354)⟩, ⟨(-252664139), (-252664135)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3158301708), (-3158301697)⟩, ⟨(-1263320688), (-1263320677)⟩, ⟨(-126332070), (-126332067)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2058740768, 2058740786⟩, ⟨(-605557540), (-605557528)⟩, ⟨28503520, 28503525⟩, ⟨9079896, 9079898⟩, ⟨(-1086892), (-1086890)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1625372949, 1625372967⟩, ⟨(-556505827), (-556505810)⟩, ⟨46924077, 46924091⟩, ⟨5638164, 5638174⟩, ⟨(-1169404), (-1169392)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨807797449, 1211696174⟩, ⟨201949362, 201949363⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2537770531, 3806655799⟩, ⟨634442632, 634442636⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1499494367, 3373862331⟩, ⟨749747182, 1124620782⟩, ⟨93718397, 93718399⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨375, 846⟩, ⟨187, 282⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94312), (-93840)⟩, ⟨187, 282⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-74086), (-32762)⟩, ⟨(-24631), (-16159)⟩, ⟨(-2018), (-1954)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5038970, 5080295⟩, ⟨(-24631), (-16159)⟩, ⟨(-2018), (-1954)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1759246, 3990768⟩, ⟨860274, 1324615⟩, ⟨101916, 107353⟩, ⟨(-1065), (-682)⟩, ⟨(-44), (-37)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141406331), (-139174808)⟩, ⟨860274, 1324615⟩, ⟨101916, 107353⟩, ⟨(-1065), (-682)⟩, ⟨(-44), (-37)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-111080123), (-48589855)⟩, ⟨(-36726363), (-23254390)⟩, ⟨(-2899806), (-2605689)⟩, ⟨35724, 56776⟩, ⟨1909, 2212⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1320575642, 1383065911⟩, ⟨(-36726363), (-23254390)⟩, ⟨(-2899806), (-2605689)⟩, ⟨35724, 56776⟩, ⟨1909, 2212⟩⟩
...
def j70 : Jet := ⟨⟨(-85), (-37)⟩, ⟨(-29), (-18)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11750, 11799⟩, ⟨(-29), (-18)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4102, 9269⟩, ⟨2028, 3084⟩, ⟨245, 255⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848075), (-842907)⟩, ⟨2028, 3084⟩, ⟨245, 255⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-666196), (-294282)⟩, ⟨(-221358), (-144718)⟩, ⟨(-18067), (-17383)⟩, ⟨84, 135⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35125198, 35497113⟩, ⟨(-221358), (-144718)⟩, ⟨(-18067), (-17383)⟩, ⟨84, 135⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12263198, 27884351⟩, ⟨5957713, 9244259⟩, ⟨694294, 743236⟩, ⟨(-9533), (-6084)⟩, ⟨(-380), (-338)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703564685), (-687943531)⟩, ⟨5957713, 9244259⟩, ⟨694294, 743236⟩, ⟨(-9533), (-6084)⟩, ⟨(-380), (-338)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-552677175), (-240180513)⟩, ⟨(-182145721), (-112828534)⟩, ⟨(-14069745), (-12006866)⟩, ⟨243709, 394205⟩, ⟨12353, 15038⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3742290121, 4054786783⟩, ⟨(-182145721), (-112828534)⟩, ⟨(-14069745), (-12006866)⟩, ⟨243709, 394205⟩, ⟨12353, 15038⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨780289514, 1225819782⟩, ⟨162521577, 190562960⟩, ⟨(-7995250), (-4974709)⟩, ⟨(-407245), (-334585)⟩, ⟨6404, 10348⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4549374618, 4929266166⟩, ⟨126590939, 239918530⟩, ⟨16993938, 30209753⟩, ⟨368506, 2076123⟩, ⟨18967, 191370⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨826509043, 1406854014⟩, ⟨195146798, 287180867⟩, ⟨(-1298444), 13997659⟩, ⟨(-204009), 1431889⟩, ⟨(-54814), 129068⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1211696174), (-807797449)⟩, ⟨(-201949363), (-201949362)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3083271122, 3487169847⟩, ⟨(-201949363), (-201949362)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨159050616, 460827308⟩, ⟨75106784, 188137198⟩, ⟨8016086, 28372319⟩, ⟨(-307290), 2809950⟩, ⟨(-67424), 321662⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4454017912, 4755794604⟩, ⟨75106784, 188137198⟩, ⟨8016086, 28372319⟩, ⟨(-307290), 2809950⟩, ⟨(-67424), 321662⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4373769686, 4519511289⟩, ⟨35687617, 92373762⟩, ⟨2864901, 13784972⟩, ⟨(-442016), 1356287⟩, ⟨(-83474), 166332⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3139841781, 3669481606⟩, ⟨(-186887996), (-130654545)⟩, ⟨(-2286760), 9514264⟩, ⟨(-1007052), 966490⟩, ⟨(-131548), 155833⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4166886993, 6250330495⟩, ⟨1041721747, 1041721753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4042626175, 9095908911⟩, ⟨2021313084, 3031969648⟩, ⟨252664135, 252664139⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4042626175, 9095908911⟩, ⟨2021313084, 3031969648⟩, ⟨252664135, 252664139⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9095908911), (-4042626175)⟩, ⟨(-3031969648), (-2021313084)⟩, ⟨(-252664139), (-252664135)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4547954456), (-2021313087)⟩, ⟨(-1515984824), (-1010656542)⟩, ⟨(-126332070), (-126332067)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1489649377, 2682690784⟩, ⟨(-946903256), (-350532095)⟩, ⟨(-37666435), 123296632⟩, ⟨(-7632883), 22999806⟩, ⟨(-3842870), 1227501⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1089010237, 2292004528⟩, ⟨(-925736220), (-301572674)⟩, ⟨(-22946008), 152486239⟩, ⟨(-14612938), 22397123⟩, ⟨(-4662710), 1973358⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1009746811, 1009746812⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4433090155, 4433090159⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1250
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨807797449, 1211696174⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4373769686, 4519511289⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1251
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (154358103 / 4294967296)

theorem envelope_integral : (∫ s in ((2351 / 12500) : ℝ)..(7053 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((2351 / 12500) : ℝ)..(7053 / 25000), prawitzNormalCorrection
