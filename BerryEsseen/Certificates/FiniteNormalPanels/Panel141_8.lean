...
namespace FiniteNormalPanel141_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (184933 / 800000)
def radius : Rat := (26419 / 800000)

def j0 : Jet := ⟨⟨992851483, 992851484⟩, ⟨141835926, 141835927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3119134924, 3119134929⟩, ⟨445590703, 445590707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2265209954, 2265209962⟩, ⟨647202842, 647202852⟩, ⟨46228774, 46228776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨566, 568⟩, ⟨161, 163⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94121), (-94118)⟩, ⟨161, 163⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-49641), (-49638)⟩, ⟨(-14099), (-14096)⟩, ⟨(-985), (-981)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5063415, 5063419⟩, ⟨(-14099), (-14096)⟩, ⟨(-985), (-981)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2670497, 2670500⟩, ⟨755563, 755566⟩, ⟨51854, 51859⟩, ⟨(-300), (-295)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140495080), (-140495076)⟩, ⟨755563, 755566⟩, ⟨51854, 51859⟩, ⟨(-300), (-295)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-74098552), (-74098549)⟩, ⟨(-20772524), (-20772519)⟩, ⟨(-1371014), (-1371008)⟩, ⟨15786, 15793⟩, ⟨506, 511⟩⟩
...
def j19 : Jet := ⟨⟨1357557213, 1357557217⟩, ⟨(-20772524), (-20772519)⟩, ⟨(-1371014), (-1371008)⟩, ⟨15786, 15793⟩, ⟨506, 511⟩⟩
...
def j22 : Jet := ⟨⟨(-57), (-56)⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11778, 11780⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6211, 6213⟩, ⟨1765, 1768⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845966), (-845963)⟩, ⟨1765, 1768⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-446172), (-446169)⟩, ⟨(-126548), (-126544)⟩, ⟨(-8778), (-8772)⟩, ⟨34, 39⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35345222, 35345226⟩, ⟨(-126548), (-126544)⟩, ⟨(-8778), (-8772)⟩, ⟨34, 39⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18641433, 18641437⟩, ⟨5259380, 5259385⟩, ⟨356737, 356744⟩, ⟨(-2669), (-2662)⟩, ⟨(-91), (-86)⟩⟩
...
def j33 : Jet := ⟨⟨(-697186450), (-697186445)⟩, ⟨5259380, 5259385⟩, ⟨356737, 356744⟩, ⟨(-2669), (-2662)⟩, ⟨(-91), (-86)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-367703311), (-367703306)⟩, ⟨(-102284239), (-102284233)⟩, ⟨(-6523476), (-6523468)⟩, ⟨108957, 108965⟩, ⟨3388, 3394⟩⟩
...
def j36 : Jet := ⟨⟨3927263985, 3927263990⟩, ⟨(-102284239), (-102284233)⟩, ⟨(-6523476), (-6523468)⟩, ⟨108957, 108965⟩, ⟨3388, 3394⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨985899035, 985899040⟩, ⟨125757084, 125757091⟩, ⟨(-3150763), (-3150757)⟩, ⟨(-130775), (-130768)⟩, ⟨2004, 2011⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4697098061, 4697098068⟩, ⟨122334294, 122334304⟩, ⟨10988370, 10988384⟩, ⟨359067, 359082⟩, ⟨20149, 20160⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1078207149, 1078207157⟩, ⟨165613046, 165613058⟩, ⟨2658548, 2658562⟩, ⟨171398, 171415⟩, ⟨5542, 5558⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-992851484), (-992851483)⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3302115812, 3302115813⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨270672760, 270672765⟩, ⟨83150886, 83150894⟩, ⟨7720804, 7720816⟩, ⟨291080, 291092⟩, ⟨17645, 17658⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4565640056, 4565640061⟩, ⟨83150886, 83150894⟩, ⟨7720804, 7720816⟩, ⟨291080, 291092⟩, ⟨17645, 17658⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4428236073, 4428236077⟩, ⟨40324220, 40324225⟩, ⟨3560622, 3560630⟩, ⟨108736, 108743⟩, ⟨6135, 6143⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3404577345, 3404577350⟩, ⟨(-115234341), (-115234334)⟩, ⟨1405868, 1405877⟩, ⟨(-33987), (-33979)⟩, ⟨1124, 1133⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨48772540895, 48772540903⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value584

def j47 : Jet := ⟨⟨11274565373, 11274565388⟩, ⟨1610652194, 1610652207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨29596459202, 29596459281⟩, ⟨8456131188, 8456131270⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨29596459202, 29596459281⟩, ⟨8456131188, 8456131270⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-29596459281), (-29596459202)⟩, ⟨(-8456131270), (-8456131188)⟩, ⟨(-604009380), (-604009369)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-14798229641), (-14798229601)⟩, ⟨(-4228065635), (-4228065594)⟩, ⟨(-302004690), (-302004684)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨136963968, 136963972⟩, ⟨(-134830518), (-134830512)⟩, ⟨56734392, 56734398⟩, ⟨(-12296398), (-12296394)⟩, ⟨1031547, 1031549⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨108569958, 108569963⟩, ⟨(-110553551), (-110553543)⟩, ⟨48635126, 48635135⟩, ⟨(-11314639), (-11314631)⟩, ⟨1167280, 1167288⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨851015557, 1134687410⟩, ⟨141835926, 141835927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2673544221, 3564725632⟩, ⟨445590703, 445590707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1664235885, 2958641582⟩, ⟨554745294, 739660402⟩, ⟨46228774, 46228776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨416, 742⟩, ⟨138, 186⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94271), (-93944)⟩, ⟨138, 186⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-64940), (-36401)⟩, ⟨(-16182), (-12004)⟩, ⟨(-994), (-969)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5048116, 5076656⟩, ⟨(-16182), (-12004)⟩, ⟨(-994), (-969)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1956069, 3497118⟩, ⟨640875, 869629⟩, ⟨50863, 52718⟩, ⟨(-347), (-249)⟩, ⟨(-11), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141209508), (-139668458)⟩, ⟨640875, 869629⟩, ⟨50863, 52718⟩, ⟨(-347), (-249)⟩, ⟨(-11), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-97273924), (-54119448)⟩, ⟨(-24070153), (-17440761)⟩, ⟨(-1417422), (-1317237)⟩, ⟨13227, 18344⟩, ⟨479, 534⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1334381841, 1377536318⟩, ⟨(-24070153), (-17440761)⟩, ⟨(-1417422), (-1317237)⟩, ⟨13227, 18344⟩, ⟨479, 534⟩⟩
...
def j72 : Jet := ⟨⟨4556, 8126⟩, ⟨1504, 2027⟩, ⟨120, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847621), (-844050)⟩, ⟨1504, 2027⟩, ⟨120, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-583895), (-327056)⟩, ⟨(-145392), (-107621)⟩, ⟨(-8884), (-8647)⟩, ⟨29, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35207499, 35464339⟩, ⟨(-145392), (-107621)⟩, ⟨(-8884), (-8647)⟩, ⟨29, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13642381, 24430051⟩, ⟨4447304, 6065812⟩, ⟨347796, 364470⟩, ⟨(-3084), (-2243)⟩, ⟨(-94), (-83)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702185502), (-691397831)⟩, ⟨4447304, 6065812⟩, ⟨347796, 364470⟩, ⟨(-3084), (-2243)⟩, ⟨(-94), (-83)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-483709207), (-267906366)⟩, ⟨(-119204039), (-85123611)⟩, ⟨(-6848771), (-6146145)⟩, ⟨90664, 127189⟩, ⟨3146, 3602⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3811258089, 4027060930⟩, ⟨(-119204039), (-85123611)⟩, ⟨(-6848771), (-6146145)⟩, ⟨90664, 127189⟩, ⟨3146, 3602⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨830630040, 1143323962⟩, ⟨118460656, 132058920⟩, ⟨(-3673640), (-2629386)⟩, ⟨(-138821), (-121433)⟩, ⟨1670, 2348⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4580696541, 4840066887⟩, ⟨96826304, 151381909⟩, ⟨9037812, 13432270⟩, ⟨185948, 583184⟩, ⟨8612, 36296⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨885888969, 1288429939⟩, ⟨145067263, 189117290⟩, ⟨278585, 5425968⟩, ⟨(-688), 379464⟩, ⟨(-7809), 21972⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1134687410), (-851015557)⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3160279886, 3443951739⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨182725318, 386510908⟩, ⟨59843756, 113465070⟩, ⟨5014728, 11582700⟩, ⟨18404, 705504⟩, ⟨(-4730), 53457⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4477692614, 4681478204⟩, ⟨59843756, 113465070⟩, ⟨5014728, 11582700⟩, ⟨18404, 705504⟩, ⟨(-4730), 53457⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4385378357, 4484060190⟩, ⟨28660071, 55562910⟩, ⟨2057382, 5578301⟩, ⟨(-61666), 332035⟩, ⟨(-10072), 26477⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3226805248, 3595577295⟩, ⟨(-126992118), (-100268101)⟩, ⟨(-321054), 3526540⟩, ⟨(-233665), 198303⟩, ⟨(-19043), 23268⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9663913179, 12885217582⟩, ⟨1610652194, 1610652207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨21744337382, 38656599852⟩, ⟨7248112448, 9664150020⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨21744337382, 38656599852⟩, ⟨7248112448, 9664150020⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-38656599852), (-21744337382)⟩, ⟨(-9664150020), (-7248112448)⟩, ⟨(-604009380), (-604009369)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-19328299926), (-10872168691)⟩, ⟨(-4832075010), (-3624056224)⟩, ⟨(-302004690), (-302004684)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨47702255, 341663112⟩, ⟨(-384389839), (-40250749)⟩, ⟨(-7042749), 212875653⟩, ⟨(-77945437), 20660318⟩, ⟨(-13295276), 22170838⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨35838663, 286026888⟩, ⟨(-331898197), (-31353985)⟩, ⟨(-4981779), 189857147⟩, ⟨(-71881288), 17548751⟩, ⟨(-11776335), 21062770⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨992851483, 992851484⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4428236073, 4428236077⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar584 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2834
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar584 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨851015557, 1134687410⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4385378357, 4484060190⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2835
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((79257 / 400000) : ℝ)..(26419 / 100000), prawitzNormalCorrection
      ((73301 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
