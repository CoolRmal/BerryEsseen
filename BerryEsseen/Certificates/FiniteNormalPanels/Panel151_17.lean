...
namespace FiniteNormalPanel151_17
...
def j2 : Jet := ⟨⟨1427344125, 1427344129⟩, ⟨475781373, 475781378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨474348489, 474348493⟩, ⟨316232324, 316232330⟩, ⟨52705387, 52705389⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨118, 119⟩, ⟨79, 80⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94569), (-94567)⟩, ⟨79, 80⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10445), (-10444)⟩, ⟨(-6955), (-6953)⟩, ⟨(-1155), (-1152)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102611, 5102613⟩, ⟨(-6955), (-6953)⟩, ⟨(-1155), (-1152)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨563546, 563548⟩, ⟨374928, 374932⟩, ⟨61975, 61979⟩, ⟨(-172), (-168)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-142602031), (-142602028)⟩, ⟨374928, 374932⟩, ⟨61975, 61979⟩, ⟨(-172), (-168)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15749377), (-15749376)⟩, ⟨(-10458177), (-10458175)⟩, ⟨(-1715482), (-1715478)⟩, ⟨9144, 9147⟩, ⟨745, 748⟩⟩
...
def j19 : Jet := ⟨⟨1415906388, 1415906390⟩, ⟨(-10458177), (-10458175)⟩, ⟨(-1715482), (-1715478)⟩, ⟨9144, 9147⟩, ⟨745, 748⟩⟩
...
def j25 : Jet := ⟨⟨1305, 1306⟩, ⟨869, 871⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850872), (-850870)⟩, ⟨869, 871⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-93973), (-93972)⟩, ⟨(-62554), (-62551)⟩, ⟨(-10364), (-10359)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35697421, 35697423⟩, ⟨(-62554), (-62551)⟩, ⟨(-10364), (-10359)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3942525, 3942526⟩, ⟨2621441, 2621443⟩, ⟨432307, 432310⟩, ⟨(-1530), (-1526)⟩, ⟨(-128), (-124)⟩⟩
...
def j33 : Jet := ⟨⟨(-711885358), (-711885356)⟩, ⟨2621441, 2621443⟩, ⟨432307, 432310⟩, ⟨(-1530), (-1526)⟩, ⟨(-128), (-124)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-78622659), (-78622657)⟩, ⟨(-52125587), (-52125584)⟩, ⟨(-8495095), (-8495090)⟩, ⟨63829, 63832⟩, ⟨5177, 5181⟩⟩
...
def j36 : Jet := ⟨⟨4216344637, 4216344639⟩, ⟨(-52125587), (-52125584)⟩, ⟨(-8495095), (-8495090)⟩, ⟨63829, 63832⟩, ⟨5177, 5181⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨470547393, 470547396⟩, ⟨153373569, 153373574⟩, ⟨(-1728627), (-1728622)⟩, ⟨(-186998), (-186994)⟩, ⟨1259, 1263⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4375056038, 4375056041⟩, ⟨54087691, 54087696⟩, ⟨9483532, 9483541⟩, ⟨159981, 159989⟩, ⟨14888, 14897⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨479321743, 479321747⟩, ⟨162159274, 162159281⟩, ⟨1209609, 1209618⟩, ⟨143929, 143938⟩, ⟨2453, 2464⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-454337747), (-454337746)⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3840629549, 3840629550⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨53492685, 53492687⟩, ⟨36194206, 36194210⟩, ⟨6392414, 6392420⟩, ⟨123462, 123468⟩, ⟨11754, 11761⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4348459981, 4348459983⟩, ⟨36194206, 36194210⟩, ⟨6392414, 6392420⟩, ⟨123462, 123468⟩, ⟨11754, 11761⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4321630873, 4321630875⟩, ⟨17985447, 17985450⟩, ⟨3139061, 3139065⟩, ⟨48285, 48290⟩, ⟨4498, 4504⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3864472552, 3864472556⟩, ⟨(-136303230), (-136303224)⟩, ⟨2172809, 2172814⟩, ⟨(-67511), (-67505)⟩, ⟨2319, 2326⟩⟩
...
def j47 : Jet := ⟨⟨3802481914, 3802481924⟩, ⟨1267493968, 1267493978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3366467707, 3366467726⟩, ⟨2244311798, 2244311824⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3366467707, 3366467726⟩, ⟨2244311798, 2244311824⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3366467726), (-3366467707)⟩, ⟨(-2244311824), (-2244311798)⟩, ⟨(-374051972), (-374051965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1683233863), (-1683233853)⟩, ⟨(-1122155912), (-1122155899)⟩, ⟨(-187025986), (-187025982)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2902392845, 2902392858⟩, ⟨(-758314809), (-758314796)⟩, ⟨(-27322485), (-27322477)⟩, ⟨24393605, 24393608⟩, ⟨(-998460), (-998458)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2611479136, 2611479151⟩, ⟨(-774416210), (-774416191)⟩, ⟨949972, 949986⟩, ⟨22386418, 22386429⟩, ⟨(-1672866), (-1672854)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨302891831, 605783663⟩, ⟨151445915, 151445916⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨951562751, 1903125506⟩, ⟨475781373, 475781378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨210821551, 843286210⟩, ⟨210821550, 421643108⟩, ⟨52705387, 52705389⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨52, 212⟩, ⟨52, 106⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94635), (-94474)⟩, ⟨52, 106⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-18581), (-4637)⟩, ⟨(-9289), (-4616)⟩, ⟨(-1160), (-1145)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5094475, 5108420⟩, ⟨(-9289), (-4616)⟩, ⟨(-1160), (-1145)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨250065, 1003002⟩, ⟨248241, 501275⟩, ⟨61376, 62406⟩, ⟨(-228), (-111)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142915512), (-142162574)⟩, ⟨248241, 501275⟩, ⟨61376, 62406⟩, ⟨(-228), (-111)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-28060442), (-6978151)⟩, ⟨(-14018037), (-6879729)⟩, ⟨(-1738581), (-1683073)⟩, ⟨6013, 12274⟩, ⟨727, 761⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1403595323, 1424677615⟩, ⟨(-14018037), (-6879729)⟩, ⟨(-1738581), (-1683073)⟩, ⟨6013, 12274⟩, ⟨727, 761⟩⟩
...
def j72 : Jet := ⟨⟨579, 2323⟩, ⟨576, 1162⟩, ⟨141, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851598), (-849853)⟩, ⟨576, 1162⟩, ⟨141, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-167206), (-41715)⟩, ⟨(-83575), (-41486)⟩, ⟨(-10417), (-10284)⟩, ⟨12, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35624188, 35749680⟩, ⟨(-83575), (-41486)⟩, ⟨(-10417), (-10284)⟩, ⟨12, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1748638, 7019195⟩, ⟨1732228, 3507562⟩, ⟨426908, 436160⟩, ⟨(-2049), (-1007)⟩, ⟨(-129), (-122)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714079245), (-708808687)⟩, ⟨1732228, 3507562⟩, ⟨426908, 436160⟩, ⟨(-2049), (-1007)⟩, ⟨(-129), (-122)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-140204370), (-34792382)⟩, ⟨(-70017159), (-34103697)⟩, ⟨(-8656792), (-8268115)⟩, ⟨41808, 85813⟩, ⟨5010, 5299⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4154762926, 4260174914⟩, ⟨(-70017159), (-34103697)⟩, ⟨(-8656792), (-8268115)⟩, ⟨41808, 85813⟩, ⟨5010, 5299⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨310970709, 631283109⟩, ⟨149273877, 156296554⟩, ⟨(-2323245), (-1135001)⟩, ⟨(-191262), (-181005)⟩, ⟨827, 1698⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4330043823, 4439902927⟩, ⟨34663013, 74822414⟩, ⟨8681200, 10511833⟩, ⟨47334, 289477⟩, ⟨10195, 21214⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨313510372, 652586046⟩, ⟨153002703, 172568405⟩, ⟨(-568364), 3123616⟩, ⟨66955, 233438⟩, ⟨(-5803), 11656⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-605783663), (-302891831)⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3689183633, 3992075465⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨22884633, 99155249⟩, ⟨22336810, 52440788⟩, ⟨5277807, 7882881⟩, ⟨(-35900), 321950⟩, ⟨2592, 24576⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4317851929, 4394122545⟩, ⟨22336810, 52440788⟩, ⟨5277807, 7882881⟩, ⟨(-35900), 321950⟩, ⟨2592, 24576⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306394411, 4344262035⟩, ⟨11041676, 26150818⟩, ⟨2530250, 3916827⟩, ⟨(-41689), 154062⟩, ⟨(-1426), 11766⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3698999010, 4037893816⟩, ⟨(-143699809), (-127542252)⟩, ⟨1251259, 3251260⟩, ⟨(-176862), 53979⟩, ⟨(-6759), 12408⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2534987946, 5069975902⟩, ⟨1267493968, 1267493978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1496207873, 5984831520⟩, ⟨1496207866, 2992415766⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1496207873, 5984831520⟩, ⟨1496207866, 2992415766⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5984831520), (-1496207873)⟩, ⟨(-2992415766), (-1496207866)⟩, ⟨(-374051972), (-374051965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2992415760), (-748103936)⟩, ⟨(-1496207883), (-748103933)⟩, ⟨(-187025986), (-187025982)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2139811738, 3608392638⟩, ⟨(-1257030645), (-372715661)⟩, ⟨(-124668742), 125772597⟩, ⟨(-3784812), 50968580⟩, ⟨(-7177301), 3043997⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1842892146, 3392413799⟩, ⟨(-1302520187), (-384541057)⟩, ⟨(-105515284), 163033438⟩, ⟨(-8866493), 52025777⟩, ⟨(-8568852), 3145830⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4321630873, 4321630875⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3050
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306394411, 4344262035⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3051
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (184234741 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((28209 / 400000) : ℝ)..(28209 / 200000), prawitzNormalCorrection
