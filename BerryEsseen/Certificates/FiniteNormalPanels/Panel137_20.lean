...
namespace FiniteNormalPanel137_20
...
def j2 : Jet := ⟨⟨1487455610, 1487455614⟩, ⟨495818536, 495818540⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨515143431, 515143435⟩, ⟨343428952, 343428958⟩, ⟨57238158, 57238160⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨128, 130⟩, ⟨85, 87⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94559), (-94556)⟩, ⟨85, 87⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11342), (-11341)⟩, ⟨(-7552), (-7549)⟩, ⟨(-1254), (-1251)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101714, 5101716⟩, ⟨(-7552), (-7549)⟩, ⟨(-1254), (-1251)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨611905, 611906⟩, ⟨407031, 407033⟩, ⟨67234, 67237⟩, ⟨(-202), (-199)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-142553672), (-142553670)⟩, ⟨407031, 407033⟩, ⟨67234, 67237⟩, ⟨(-202), (-199)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17098056), (-17098054)⟩, ⟨(-11349885), (-11349882)⟩, ⟨(-1859174), (-1859171)⟩, ⟨10775, 10779⟩, ⟨876, 881⟩⟩
...
def j19 : Jet := ⟨⟨1414557709, 1414557712⟩, ⟨(-11349885), (-11349882)⟩, ⟨(-1859174), (-1859171)⟩, ⟨10775, 10779⟩, ⟨876, 881⟩⟩
...
def j25 : Jet := ⟨⟨1417, 1419⟩, ⟨943, 946⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850760), (-850757)⟩, ⟨943, 946⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-102042), (-102040)⟩, ⟨(-67915), (-67913)⟩, ⟨(-11245), (-11242)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35689352, 35689355⟩, ⟨(-67915), (-67913)⟩, ⟨(-11245), (-11242)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4280622, 4280624⟩, ⟨2845602, 2845604⟩, ⟨468844, 468847⟩, ⟨(-1804), (-1799)⟩, ⟨(-149), (-145)⟩⟩
...
def j33 : Jet := ⟨⟨(-711547261), (-711547258)⟩, ⟨2845602, 2845604⟩, ⟨468844, 468847⟩, ⟨(-1804), (-1799)⟩, ⟨(-149), (-145)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-85343817), (-85343815)⟩, ⟨(-56554574), (-56554570)⟩, ⟨(-9198878), (-9198873)⟩, ⟨75194, 75198⟩, ⟨6085, 6089⟩⟩
...
def j36 : Jet := ⟨⟨4209623479, 4209623481⟩, ⟨(-56554574), (-56554570)⟩, ⟨(-9198878), (-9198873)⟩, ⟨75194, 75198⟩, ⟨6085, 6089⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨489897048, 489897051⟩, ⟨159368263, 159368268⟩, ⟨(-1954130), (-1954127)⟩, ⟨(-210896), (-210891)⟩, ⟨1546, 1551⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4382041329, 4382041332⟩, ⟨58870933, 58870939⟩, ⟨10366547, 10366555⟩, ⟨189635, 189644⟩, ⟨17808, 17818⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨499828977, 499828981⟩, ⟨169314212, 169314221⟩, ⟨1373144, 1373153⟩, ⟨164331, 164341⟩, ⟨3036, 3047⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-473471827), (-473471826)⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3821495469, 3821495470⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨58167848, 58167850⟩, ⟨39408052, 39408056⟩, ⟨6994226, 6994232⟩, ⟨146510, 146516⟩, ⟨14101, 14108⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4353135144, 4353135146⟩, ⟨39408052, 39408056⟩, ⟨6994226, 6994232⟩, ⟨146510, 146516⟩, ⟨14101, 14108⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4323953408, 4323953410⟩, ⟨19571937, 19571940⟩, ⟨3429374, 3429378⟩, ⟨57240, 57245⟩, ⟨5383, 5389⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3847286188, 3847286192⟩, ⟨(-141474723), (-141474718)⟩, ⟨2332128, 2332133⟩, ⟨(-75088), (-75081)⟩, ⟨2685, 2692⟩⟩
...
def j47 : Jet := ⟨⟨3821239667, 3821239677⟩, ⟨1273746555, 1273746565⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3399763394, 3399763413⟩, ⟨2266508928, 2266508954⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3399763394, 3399763413⟩, ⟨2266508928, 2266508954⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3399763413), (-3399763394)⟩, ⟨(-2266508954), (-2266508928)⟩, ⟨(-377751494), (-377751487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1699881707), (-1699881697)⟩, ⟨(-1133254477), (-1133254464)⟩, ⟨(-188875747), (-188875743)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2891164574, 2891164585⟩, ⟨(-762852191), (-762852178)⟩, ⟨(-26500331), (-26500324)⟩, ⟨24695582, 24695585⟩, ⟨(-1046333), (-1046331)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2589807271, 2589807284⟩, ⟨(-778571100), (-778571083)⟩, ⟨2959859, 2959873⟩, ⟨22529607, 22529620⟩, ⟨(-1749982), (-1749969)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨315647884, 631295769⟩, ⟨157823942, 157823943⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨991637073, 1983274151⟩, ⟨495818536, 495818540⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨228952636, 915810550⟩, ⟨228952634, 457905278⟩, ⟨57238158, 57238160⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨57, 230⟩, ⟨57, 115⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94630), (-94456)⟩, ⟨57, 115⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-20178), (-5035)⟩, ⟨(-10086), (-5010)⟩, ⟨(-1259), (-1241)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092878, 5108022⟩, ⟨(-10086), (-5010)⟩, ⟨(-1259), (-1241)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨271487, 1089178⟩, ⟨269336, 544322⟩, ⟨66526, 67741⟩, ⟨(-270), (-131)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142894090), (-142076398)⟩, ⟨269336, 544322⟩, ⟨66526, 67741⟩, ⟨(-270), (-131)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-30469130), (-7573693)⟩, ⟨(-15220208), (-7457627)⟩, ⟨(-1886418), (-1820945)⟩, ⟨7077, 14472⟩, ⟨853, 897⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1401186635, 1424082073⟩, ⟨(-15220208), (-7457627)⟩, ⟨(-1886418), (-1820945)⟩, ⟨7077, 14472⟩, ⟨853, 897⟩⟩
...
def j72 : Jet := ⟨⟨629, 2523⟩, ⟨626, 1262⟩, ⟨154, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851548), (-849653)⟩, ⟨626, 1262⟩, ⟨154, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-181575), (-45292)⟩, ⟨(-90755), (-45022)⟩, ⟨(-11308), (-11154)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35609819, 35746103⟩, ⟨(-90755), (-45022)⟩, ⟨(-11308), (-11154)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1898259, 7622098⟩, ⟨1878907, 3808650⟩, ⟨462476, 473389⟩, ⟨(-2416), (-1185)⟩, ⟨(-151), (-143)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713929624), (-708205784)⟩, ⟨1878907, 3808650⟩, ⟨462476, 473389⟩, ⟨(-2416), (-1185)⟩, ⟨(-151), (-143)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-152230329), (-37752460)⟩, ⟨(-76015006), (-36940345)⟩, ⟨(-9389584), (-8931116)⟩, ⟨49176, 101166⟩, ⟨5872, 6239⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4142736967, 4257214836⟩, ⟨(-76015006), (-36940345)⟩, ⟨(-9389584), (-8931116)⟩, ⟨49176, 101166⟩, ⟨5872, 6239⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨323510871, 657594103⟩, ⟨154727245, 162676684⟩, ⟨(-2628134), (-1281347)⟩, ⟨(-216139), (-203530)⟩, ⟨1012, 2086⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4333054540, 4452791530⟩, ⟨37598414, 81704193⟩, ⟨9416464, 11591518⟩, ⟨54769, 346443⟩, ⟨11760, 26044⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨326379725, 681758266⟩, ⟨158931381, 181164025⟩, ⟨(-660939), 3576684⟩, ⟨69277, 275536⟩, ⟨(-7327), 14683⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-631295769), (-315647884)⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3663671527, 3979319412⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨24801987, 108218364⟩, ⟨24154772, 57513860⟩, ⟨5671284, 8777082⟩, ⟨(-45230), 389208⟩, ⟨2247, 30887⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4319769283, 4403185660⟩, ⟨24154772, 57513860⟩, ⟨5671284, 8777082⟩, ⟨(-45230), 389208⟩, ⟨2247, 30887⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307350438, 4348739865⟩, ⟨11928048, 28674258⟩, ⟨2706044, 4359410⟩, ⟨(-51572), 186552⟩, ⟨(-2329), 14894⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3674234532, 4029140101⟩, ⟨(-149625081), (-131712060)⟩, ⟨1254624, 3600716⟩, ⟨(-207974), 73406⟩, ⟨(-9014), 15696⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2547493111, 5094986233⟩, ⟨1273746555, 1273746565⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1511005952, 6044023837⟩, ⟨1511005952, 3022011936⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1511005952, 6044023837⟩, ⟨1511005952, 3022011936⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6044023837), (-1511005952)⟩, ⟨(-3022011936), (-1511005952)⟩, ⟨(-377751494), (-377751487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3022011919), (-755502976)⟩, ⟨(-1511005968), (-755502976)⟩, ⟨(-188875747), (-188875743)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2125117208, 3602181727⟩, ⟨(-1267278122), (-373817136)⟩, ⟨(-125531757), 129465320⟩, ⟨(-4222997), 51874314⟩, ⟨(-7409144), 3131618⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1817983349, 3379232914⟩, ⟨(-1314333136), (-384961113)⟩, ⟨(-105677777), 168620829⟩, ⟨(-9708708), 52989229⟩, ⟨(-8892196), 3267982⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4323953408, 4323953410⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2764
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307350438, 4348739865⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2765
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (47612989 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((29397 / 400000) : ℝ)..(29397 / 200000), prawitzNormalCorrection
