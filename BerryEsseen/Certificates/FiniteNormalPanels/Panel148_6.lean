...
namespace FiniteNormalPanel148_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (187649 / 800000)
def radius : Rat := (26807 / 800000)

def j0 : Jet := ⟨⟨1007432897, 1007432898⟩, ⟨143918985, 143918986⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3164943788, 3164943792⟩, ⟨452134825, 452134830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2332234098, 2332234105⟩, ⟨666352596, 666352606⟩, ⟨47596613, 47596615⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨583, 585⟩, ⟨166, 167⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94104), (-94101)⟩, ⟨166, 167⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-51100), (-51098)⟩, ⟨(-14510), (-14508)⟩, ⟨(-1013), (-1009)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5061956, 5061959⟩, ⟨(-14510), (-14508)⟩, ⟨(-1013), (-1009)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2748720, 2748723⟩, ⟨777468, 777472⟩, ⟨53293, 53300⟩, ⟨(-318), (-313)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-140416857), (-140416853)⟩, ⟨777468, 777472⟩, ⟨53293, 53300⟩, ⟨(-318), (-313)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-76248540), (-76248536)⟩, ⟨(-21363121), (-21363116)⟩, ⟨(-1406533), (-1406526)⟩, ⟨16710, 16717⟩, ⟨533, 539⟩⟩
...
def j19 : Jet := ⟨⟨1355407225, 1355407230⟩, ⟨(-21363121), (-21363116)⟩, ⟨(-1406533), (-1406526)⟩, ⟨16710, 16717⟩, ⟨533, 539⟩⟩
...
def j22 : Jet := ⟨⟨(-59), (-58)⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11776, 11778⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6394, 6396⟩, ⟨1817, 1820⟩, ⟨125, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845783), (-845780)⟩, ⟨1817, 1820⟩, ⟨125, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-459274), (-459271)⟩, ⟨(-130235), (-130231)⟩, ⟨(-9025), (-9018)⟩, ⟨37, 42⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35332120, 35332124⟩, ⟨(-130235), (-130231)⟩, ⟨(-9025), (-9018)⟩, ⟨37, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19185891, 19185894⟩, ⟨5410963, 5410967⟩, ⟨366441, 366449⟩, ⟨(-2825), (-2819)⟩, ⟨(-97), (-90)⟩⟩
...
def j33 : Jet := ⟨⟨(-696641992), (-696641988)⟩, ⟨5410963, 5410967⟩, ⟨366441, 366449⟩, ⟨(-2825), (-2819)⟩, ⟨(-97), (-90)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-378287447), (-378287443)⟩, ⟨(-105143892), (-105143886)⟩, ⟨(-6681674), (-6681666)⟩, ⟨115281, 115289⟩, ⟨3568, 3576⟩⟩
...
def j36 : Jet := ⟨⟨3916679849, 3916679853⟩, ⟨(-105143892), (-105143886)⟩, ⟨(-6681674), (-6681666)⟩, ⟨115281, 115289⟩, ⟨3568, 3576⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨998794025, 998794031⟩, ⟨126942463, 126942471⟩, ⟨(-3285383), (-3285376)⟩, ⟨(-135754), (-135747)⟩, ⟨2151, 2158⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4709791140, 4709791146⟩, ⟨126435082, 126435092⟩, ⟨11428844, 11428857⟩, ⟨383864, 383878⟩, ⟨21778, 21793⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1095261250, 1095261259⟩, ⟨168605496, 168605509⟩, ⟨2792005, 2792019⟩, ⟨181478, 181493⟩, ⟨6027, 6043⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1007432898), (-1007432897)⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3287534398, 3287534399⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨279302989, 279302995⟩, ⟨85992302, 85992312⟩, ⟨8042846, 8042856⟩, ⟨311764, 311776⟩, ⟨19134, 19150⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4574270285, 4574270291⟩, ⟨85992302, 85992312⟩, ⟨8042846, 8042856⟩, ⟨311764, 311776⟩, ⟨19134, 19150⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4432419348, 4432419351⟩, ⟨41662813, 41662819⟩, ⟨3700909, 3700915⟩, ⟨116260, 116268⟩, ⟨6631, 6641⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3392745524, 3392745529⟩, ⟨(-116634502), (-116634494)⟩, ⟨1436750, 1436756⟩, ⟨(-35025), (-35015)⟩, ⟨1179, 1189⟩⟩
...
def j47 : Jet := ⟨⟨9564840035, 9564840047⟩, ⟨1366405716, 1366405727⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨21300782657, 21300782712⟩, ⟨6085937886, 6085937946⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨21300782657, 21300782712⟩, ⟨6085937886, 6085937946⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-21300782712), (-21300782657)⟩, ⟨(-6085937946), (-6085937886)⟩, ⟨(-434709856), (-434709848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10650391356), (-10650391328)⟩, ⟨(-3042968973), (-3042968943)⟩, ⟨(-217354928), (-217354924)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨359768847, 359768857⟩, ⟨(-254894949), (-254894939)⟩, ⟨72089293, 72089300⟩, ⟨(-8425378), (-8425374)⟩, ⟨(-331771), (-331769)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨284194048, 284194058⟩, ⟨(-211120389), (-211120378)⟩, ⟨63988161, 63988172⟩, ⟨(-8701369), (-8701360)⟩, ⟨(-6987), (-6979)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨863513912, 1151351884⟩, ⟨143918985, 143918986⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2712808962, 3617078621⟩, ⟨452134825, 452134830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1713478114, 3046183324⟩, ⟨571159368, 761545836⟩, ⟨47596613, 47596615⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨428, 764⟩, ⟨142, 191⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94259), (-93922)⟩, ⟨142, 191⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-66853), (-37470)⟩, ⟨(-16658), (-12354)⟩, ⟨(-1023), (-997)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5046203, 5075587⟩, ⟨(-16658), (-12354)⟩, ⟨(-1023), (-997)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2013183, 3599834⟩, ⟨659246, 895031⟩, ⟨52241, 54209⟩, ⟨(-367), (-263)⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141152394), (-139565742)⟩, ⟨659246, 895031⟩, ⟨52241, 54209⟩, ⟨(-367), (-263)⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-100111605), (-55679782)⟩, ⟨(-24764896), (-17925130)⟩, ⟨(-1455735), (-1349512)⟩, ⟨13991, 19427⟩, ⟨503, 564⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1331544160, 1375975984⟩, ⟨(-24764896), (-17925130)⟩, ⟨(-1455735), (-1349512)⟩, ⟨13991, 19427⟩, ⟨503, 564⟩⟩
...
def j72 : Jet := ⟨⟨4690, 8365⟩, ⟨1548, 2087⟩, ⟨124, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847487), (-843811)⟩, ⟨1548, 2087⟩, ⟨124, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-601076), (-336638)⟩, ⟨(-149652), (-110731)⟩, ⟨(-9138), (-8887)⟩, ⟨31, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35190318, 35454757⟩, ⟨(-149652), (-110731)⟩, ⟨(-9138), (-8887)⟩, ⟨31, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14039184, 25146103⟩, ⟨4573588, 6242350⟩, ⟨356960, 374638⟩, ⟨(-3268), (-2373)⟩, ⟨(-99), (-87)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701788699), (-690681779)⟩, ⟨4573588, 6242350⟩, ⟨356960, 374638⟩, ⟨(-3268), (-2373)⟩, ⟨(-99), (-87)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-497740003), (-275547642)⟩, ⟨(-122610369), (-87421858)⟩, ⟨(-7026568), (-6281550)⟩, ⟨95835, 134660⟩, ⟨3304, 3803⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3797227293, 4019419654⟩, ⟨(-122610369), (-87421858)⟩, ⟨(-7026568), (-6281550)⟩, ⟨95835, 134660⟩, ⟨3304, 3803⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨841036655, 1158801214⟩, ⟨119316603, 133528192⟩, ⟨(-3832994), (-2739378)⟩, ⟨(-144410), (-125703)⟩, ⟨1789, 2521⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4589404854, 4857950987⟩, ⟨99818961, 156860552⟩, ⟨9343370, 14054323⟩, ⟨196459, 628243⟩, ⟨9020, 39782⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨898693154, 1310696710⟩, ⟨147042702, 193352722⟩, ⟨267213, 5741456⟩, ⟨(-5295), 408460⟩, ⟨(-8684), 24238⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1151351884), (-863513912)⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3143615412, 3431453384⟩, ⟨(-143918986), (-143918985)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨188045526, 399985786⟩, ⟨61535402, 118011040⟩, ⟨5145984, 12208684⟩, ⟨15064, 766244⟩, ⟨(-5764), 59248⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4483012822, 4694953082⟩, ⟨61535402, 118011040⟩, ⟨5145984, 12208684⟩, ⟨15064, 766244⟩, ⟨(-5764), 59248⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4387982846, 4490508874⟩, ⟨29427905, 57754734⟩, ⟨2089542, 5876265⟩, ⟨(-69972), 360989⟩, ⟨(-11508), 29420⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3211696283, 3587680839⟩, ⟨(-128932174), (-100892818)⟩, ⟨(-405891), 3708736⟩, ⟨(-252811), 218395⟩, ⟨(-21292), 25851⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8198434319, 10931245774⟩, ⟨1366405716, 1366405727⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15649554618, 27821430511⟩, ⟨5216518190, 6955357656⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15649554618, 27821430511⟩, ⟨5216518190, 6955357656⟩, ⟨434709848, 434709856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-27821430511), (-15649554618)⟩, ⟨(-6955357656), (-5216518190)⟩, ⟨(-434709856), (-434709848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13910715256), (-7824777309)⟩, ⟨(-3477678828), (-2608259095)⟩, ⟨(-217354928), (-217354924)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨168402748, 694610522⟩, ⟨(-562433225), (-102268066)⟩, ⟨(-4099267), 219181622⟩, ⟨(-55707553), 20081737⟩, ⟨(-9611147), 11380470⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨125928427, 580223478⟩, ⟨(-490664634), (-80430086)⟩, ⟨(-1087481), 200570929⟩, ⟨(-53639993), 16986250⟩, ⟨(-8684002), 11405217⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1007432897, 1007432898⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4432419348, 4432419351⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2980
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨863513912, 1151351884⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4387982846, 4490508874⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2981
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (322317 / 67108864)

theorem envelope_integral : (∫ s in ((80421 / 400000) : ℝ)..(26807 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((80421 / 400000) : ℝ)..(26807 / 100000), prawitzNormalCorrection
