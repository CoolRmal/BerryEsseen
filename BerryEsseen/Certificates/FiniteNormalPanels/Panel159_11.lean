...
namespace FiniteNormalPanel159_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (25427 / 160000)
def radius : Rat := (25427 / 800000)

def j0 : Jet := ⟨⟨682550833, 682550834⟩, ⟨136510166, 136510167⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2144296682, 2144296686⟩, ⟨428859334, 428859338⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1070557222, 1070557227⟩, ⟨428222886, 428222892⟩, ⟨42822288, 42822290⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨267, 269⟩, ⟨107, 108⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94420), (-94417)⟩, ⟨107, 108⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23535), (-23534)⟩, ⟨(-9388), (-9386)⟩, ⟨(-930), (-927)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5089521, 5089523⟩, ⟨(-9388), (-9386)⟩, ⟨(-930), (-927)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1268606, 1268608⟩, ⟨505101, 505104⟩, ⟨49575, 49579⟩, ⟨(-187), (-184)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-141896971), (-141896968)⟩, ⟨505101, 505104⟩, ⟨49575, 49579⟩, ⟨(-187), (-184)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-35369031), (-35369029)⟩, ⟨(-14021713), (-14021709)⟩, ⟨(-1352046), (-1352042)⟩, ⟨9931, 9936⟩, ⟨472, 476⟩⟩
...
def j19 : Jet := ⟨⟨1396286734, 1396286737⟩, ⟨(-14021713), (-14021709)⟩, ⟨(-1352046), (-1352042)⟩, ⟨9931, 9936⟩, ⟨472, 476⟩⟩
...
def j25 : Jet := ⟨⟨2943, 2944⟩, ⟨1174, 1176⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849234), (-849232)⟩, ⟨1174, 1176⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-211679), (-211678)⟩, ⟨(-84380), (-84377)⟩, ⟨(-8323), (-8319)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35579715, 35579717⟩, ⟨(-84380), (-84377)⟩, ⟨(-8323), (-8319)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8868547, 8868548⟩, ⟨3526385, 3526389⟩, ⟨344253, 344257⟩, ⟨(-1667), (-1664)⟩, ⟨(-82), (-78)⟩⟩
...
def j33 : Jet := ⟨⟨(-706959336), (-706959334)⟩, ⟨3526385, 3526389⟩, ⟨344253, 344257⟩, ⟨(-1667), (-1664)⟩, ⟨(-82), (-78)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-176215644), (-176215642)⟩, ⟨(-69607277), (-69607273)⟩, ⟨(-6611227), (-6611222)⟩, ⟨69066, 69070⟩, ⟨3244, 3249⟩⟩
...
def j36 : Jet := ⟨⟨4118751652, 4118751654⟩, ⟨(-69607277), (-69607273)⟩, ⟨(-6611227), (-6611222)⟩, ⟨69066, 69070⟩, ⟨3244, 3249⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨697107289, 697107293⟩, ⟨132421004, 132421009⟩, ⟨(-2075111), (-2075107)⟩, ⟨(-130046), (-130042)⟩, ⟨1226, 1231⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4478722104, 4478722107⟩, ⟨75690805, 75690812⟩, ⟨8468209, 8468218⟩, ⟨189499, 189509⟩, ⟨11990, 12002⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨726932153, 726932158⟩, ⟨150371689, 150371697⟩, ⟨1544237, 1544248⟩, ⟨119666, 119675⟩, ⟨2682, 2694⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-682550834), (-682550833)⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3612416462, 3612416463⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨123034779, 123034782⟩, ⟨50901442, 50901446⟩, ⟨5787413, 5787421⟩, ⟨148636, 148644⟩, ⟨9839, 9848⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4418002075, 4418002078⟩, ⟨50901442, 50901446⟩, ⟨5787413, 5787421⟩, ⟨148636, 148644⟩, ⟨9839, 9848⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4356050324, 4356050326⟩, ⟨25093836, 25093839⟩, ⟨2780850, 2780855⟩, ⟨57255, 57261⟩, ⟨3632, 3639⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3663792251, 3663792255⟩, ⟨(-117345661), (-117345655)⟩, ⟨1541343, 1541350⟩, ⟨(-40231), (-40223)⟩, ⟨1234, 1242⟩⟩
...
def j47 : Jet := ⟨⟨7578184475, 7578184489⟩, ⟨1515636888, 1515636900⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13371203080, 13371203130⟩, ⟨5348481206, 5348481260⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13371203080, 13371203130⟩, ⟨5348481206, 5348481260⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13371203130), (-13371203080)⟩, ⟨(-5348481260), (-5348481206)⟩, ⟨(-534848127), (-534848118)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6685601565), (-6685601540)⟩, ⟨(-2674240630), (-2674240603)⟩, ⟨(-267424064), (-267424059)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨905589670, 905589684⟩, ⟨(-563861041), (-563861025)⟩, ⟨119156564, 119156575⟩, ⟨(-1325067), (-1325062)⟩, ⟨(-3503353), (-3503351)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨772507026, 772507040⟩, ⟨(-505739995), (-505739978)⟩, ⟨117376296, 117376312⟩, ⟨(-4596735), (-4596723)⟩, ⟨(-2904009), (-2903998)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨546040667, 819061001⟩, ⟨136510166, 136510167⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1715437347, 2573156024⟩, ⟨428859334, 428859338⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨685156623, 1541602408⟩, ⟨342578308, 513867470⟩, ⟨42822288, 42822290⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨171, 387⟩, ⟨85, 129⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94516), (-94299)⟩, ⟨85, 129⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-33925), (-15043)⟩, ⟨(-11296), (-7474)⟩, ⟨(-936), (-920)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5079131, 5098014⟩, ⟨(-11296), (-7474)⟩, ⟨(-936), (-920)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨810250, 1829842⟩, ⟨401070, 608756⟩, ⟨48952, 50087⟩, ⟨(-225), (-145)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142355327), (-141335734)⟩, ⟨401070, 608756⟩, ⟨48952, 50087⟩, ⟨(-225), (-145)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-51095923), (-22546647)⟩, ⟨(-16967995), (-11054820)⟩, ⟨(-1379533), (-1318352)⟩, ⟨7821, 12040⟩, ⟨457, 488⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1380559842, 1409109119⟩, ⟨(-16967995), (-11054820)⟩, ⟨(-1379533), (-1318352)⟩, ⟨7821, 12040⟩, ⟨457, 488⟩⟩
...
def j72 : Jet := ⟨⟨1881, 4243⟩, ⟨935, 1414⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850296), (-847933)⟩, ⟨935, 1414⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-305199), (-135266)⟩, ⟨(-101584), (-67125)⟩, ⟨(-8386), (-8241)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35486195, 35656129⟩, ⟨(-101584), (-67125)⟩, ⟨(-8386), (-8241)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5660951, 12798136⟩, ⟨2794013, 4255338⟩, ⟨338644, 348836⟩, ⟨(-2015), (-1315)⟩, ⟨(-84), (-77)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710166932), (-703029746)⟩, ⟨2794013, 4255338⟩, ⟨338644, 348836⟩, ⟨(-2015), (-1315)⟩, ⟨(-84), (-77)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-254901837), (-112151141)⟩, ⟨(-84521564), (-54548191)⟩, ⟨(-6803727), (-6375110)⟩, ⟨54144, 83956⟩, ⟨3103, 3363⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4040065459, 4182816155⟩, ⟨(-84521564), (-54548191)⟩, ⟨(-6803727), (-6375110)⟩, ⟨54144, 83956⟩, ⟨3103, 3363⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨551404411, 844210764⟩, ⟨127685412, 136286430⟩, ⟨(-2520774), (-1630399)⟩, ⟨(-134626), (-124425)⟩, ⟨962, 1496⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4410125472, 4565951780⟩, ⟨57512536, 95523549⟩, ⟨7471577, 9687787⟩, ⟨93445, 304443⟩, ⟨7015, 18528⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨566188860, 897474969⟩, ⟨138492638, 163661148⟩, ⟨(-10796), 3261222⟩, ⟨34933, 217658⟩, ⟨(-4016), 10392⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-819061001), (-546040667)⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3475906295, 3748926629⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨74638478, 187536078⟩, ⟨36513892, 68397162⟩, ⟨4461228, 7599291⟩, ⟨8386, 339504⟩, ⟨563, 23409⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4369605774, 4482503374⟩, ⟨36513892, 68397162⟩, ⟨4461228, 7599291⟩, ⟨8386, 339504⟩, ⟨563, 23409⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4332125794, 4387733515⟩, ⟨17870954, 33905246⟩, ⟨2052455, 3730194⟩, ⟨(-25038), 159830⟩, ⟨(-2579), 11315⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3505978574, 3829899015⟩, ⟨(-124995708), (-108096499)⟩, ⟨583410, 2687951⟩, ⟨(-140415), 74277⟩, ⟨(-7332), 10673⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6062547587, 9093821388⟩, ⟨1515636888, 1515636900⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8557569991, 19254532512⟩, ⟨4278784970, 6418177514⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8557569991, 19254532512⟩, ⟨4278784970, 6418177514⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19254532512), (-8557569991)⟩, ⟨(-6418177514), (-4278784970)⟩, ⟨(-534848127), (-534848118)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9627266256), (-4278784995)⟩, ⟨(-3209088757), (-2139392485)⟩, ⟨(-267424064), (-267424059)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨456540134, 1585994537⟩, ⟨(-1185014201), (-227410004)⟩, ⟨(-42112889), 414279770⟩, ⟨(-93740004), 59678113⟩, ⟨(-24044952), 18821098⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨372673368, 1414259644⟩, ⟨(-1102855251), (-197124898)⟩, ⟨(-31767306), 404900511⟩, ⟨(-96439829), 54438183⟩, ⟨(-23227674), 19813166⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨682550833, 682550834⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4356050324, 4356050326⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3216
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨546040667, 819061001⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4332125794, 4387733515⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3217
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (51845343 / 4294967296)

theorem envelope_integral : (∫ s in ((25427 / 200000) : ℝ)..(76281 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((25427 / 200000) : ℝ)..(76281 / 400000), prawitzNormalCorrection
