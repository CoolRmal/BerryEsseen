...
namespace FiniteNormalPanel39_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (12061 / 40000)
def radius : Rat := (1723 / 40000)

def j0 : Jet := ⟨⟨1295040013, 1295040014⟩, ⟨185005716, 185005717⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4068488190, 4068488195⟩, ⟨581212598, 581212602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3853951616, 3853951626⟩, ⟨1101129032, 1101129042⟩, ⟨78652073, 78652075⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨964, 966⟩, ⟨275, 276⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93723), (-93720)⟩, ⟨275, 276⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-84100), (-84096)⟩, ⟨(-23783), (-23779)⟩, ⟨(-1630), (-1627)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5028956, 5028961⟩, ⟨(-23783), (-23779)⟩, ⟨(-1630), (-1627)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4512572, 4512578⟩, ⟨1267965, 1267971⟩, ⟨84532, 84539⟩, ⟨(-846), (-841)⟩, ⟨(-28), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-138653005), (-138652998)⟩, ⟨1267965, 1267971⟩, ⟨84532, 84539⟩, ⟨(-846), (-841)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-124415843), (-124415835)⟩, ⟨(-34409617), (-34409607)⟩, ⟨(-2138171), (-2138160)⟩, ⟨44131, 44140⟩, ⟨1305, 1313⟩⟩
...
def j19 : Jet := ⟨⟨1307239922, 1307239931⟩, ⟨(-34409617), (-34409607)⟩, ⟨(-2138171), (-2138160)⟩, ⟨44131, 44140⟩, ⟨1305, 1313⟩⟩
...
def j22 : Jet := ⟨⟨(-97), (-96)⟩, ⟨(-28), (-27)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11738, 11740⟩, ⟨(-28), (-27)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10532, 10535⟩, ⟨2983, 2986⟩, ⟨204, 209⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841645), (-841641)⟩, ⟨2983, 2986⟩, ⟨204, 209⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-755224), (-755219)⟩, ⟨(-213103), (-213097)⟩, ⟨(-14466), (-14458)⟩, ⟨104, 109⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35036170, 35036176⟩, ⟨(-213103), (-213097)⟩, ⟨(-14466), (-14458)⟩, ⟨104, 109⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨31438587, 31438593⟩, ⟨8791231, 8791241⟩, ⟨573987, 573998⟩, ⟨(-7519), (-7510)⟩, ⟨(-239), (-232)⟩⟩
...
def j33 : Jet := ⟨⟨(-684389296), (-684389289)⟩, ⟨8791231, 8791241⟩, ⟨573987, 573998⟩, ⟨(-7519), (-7510)⟩, ⟨(-239), (-232)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-614114861), (-614114852)⟩, ⟨(-167572860), (-167572846)⟩, ⟨(-9764044), (-9764028)⟩, ⟨301399, 301413⟩, ⟨8368, 8379⟩⟩
...
def j36 : Jet := ⟨⟨3680852435, 3680852444⟩, ⟨(-167572860), (-167572846)⟩, ⟨(-9764044), (-9764028)⟩, ⟨301399, 301413⟩, ⟨8368, 8379⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1238307492, 1238307503⟩, ⟨144305915, 144305929⟩, ⟨(-6681874), (-6681861)⟩, ⟨(-247544), (-247531)⟩, ⟨7207, 7218⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5011541308, 5011541321⟩, ⟨228153192, 228153215⟩, ⟨23680684, 23680710⟩, ⟨1272907, 1272932⟩, ⟨90672, 90694⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1444907194, 1444907212⟩, ⟨234162168, 234162195⟩, ⟨6696519, 6696545⟩, ⟨518848, 518876⟩, ⟨27327, 27352⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1295040014), (-1295040013)⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2999927282, 2999927283⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨486093759, 486093772⟩, ⟨157553050, 157553072⟩, ⟨17272219, 17272241⟩, ⟨1079290, 1079314⟩, ⟨85400, 85425⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4781061055, 4781061068⟩, ⟨157553050, 157553072⟩, ⟨17272219, 17272241⟩, ⟨1079290, 1079314⟩, ⟨85400, 85425⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4531500951, 4531500958⟩, ⟨74664576, 74664587⟩, ⟨7570208, 7570220⟩, ⟨386743, 386756⟩, ⟨27774, 27788⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3165140126, 3165140133⟩, ⟨(-143043066), (-143043055)⟩, ⟨2071423, 2071434⟩, ⟨(-55958), (-55946)⟩, ⟨2739, 2752⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨28536078402, 28536078408⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value264

def j47 : Jet := ⟨⟨8604341034, 8604341043⟩, ⟨1229191575, 1229191583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17237543274, 17237543312⟩, ⟨4925012358, 4925012398⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17237543274, 17237543312⟩, ⟨4925012358, 4925012398⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17237543312), (-17237543274)⟩, ⟨(-4925012398), (-4925012358)⟩, ⟨(-351786602), (-351786596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8618771656), (-8618771637)⟩, ⟨(-2462506199), (-2462506179)⟩, ⟨(-175893301), (-175893298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨577371012, 577371021⟩, ⟨(-331033887), (-331033879)⟩, ⟨71253345, 71253351⟩, ⟨(-4579666), (-4579663)⟩, ⟨(-802598), (-802597)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨425488724, 425488733⟩, ⟨(-263181880), (-263181869)⟩, ⟨63813033, 63813044⟩, ⟨(-5915206), (-5915196)⟩, ⟨(-399900), (-399893)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1110034297, 1480045731⟩, ⟨185005716, 185005717⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3487275592, 4649700796⟩, ⟨581212598, 581212602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2831474657, 5033732740⟩, ⟨943824884, 1258433192⟩, ⟨78652073, 78652075⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨708, 1262⟩, ⟨236, 316⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93979), (-93424)⟩, ⟨236, 316⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-110145), (-61590)⟩, ⟨(-27382), (-20159)⟩, ⟨(-1659), (-1593)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5002911, 5051467⟩, ⟨(-27382), (-20159)⟩, ⟨(-1659), (-1593)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3298189, 5920356⟩, ⟨1067304, 1466800⟩, ⟨81648, 87027⟩, ⟨(-984), (-704)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139867388), (-137245220)⟩, ⟨1067304, 1466800⟩, ⟨81648, 87027⟩, ⟨(-984), (-704)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-163925591), (-90479469)⟩, ⟨(-40277774), (-28440722)⟩, ⟨(-2272971), (-1981545)⟩, ⟨36333, 51897⟩, ⟨1170, 1425⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1267730174, 1341176297⟩, ⟨(-40277774), (-28440722)⟩, ⟨(-2272971), (-1981545)⟩, ⟨36333, 51897⟩, ⟨1170, 1425⟩⟩
...
def j72 : Jet := ⟨⟨7718, 13790⟩, ⟨2534, 3433⟩, ⟨201, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844459), (-838386)⟩, ⟨2534, 3433⟩, ⟨201, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-989713), (-552709)⟩, ⟨(-245759), (-180212)⟩, ⟨(-14777), (-14099)⟩, ⟨87, 125⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34801681, 35238686⟩, ⟨(-245759), (-180212)⟩, ⟨(-14777), (-14099)⟩, ⟨87, 125⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨22943149, 41299995⟩, ⟨7359684, 10206194⟩, ⟨547982, 596418⟩, ⟨(-8774), (-6251)⟩, ⟨(-252), (-216)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692884734), (-674527887)⟩, ⟨7359684, 10206194⟩, ⟨547982, 596418⟩, ⟨(-8774), (-6251)⟩, ⟨(-252), (-216)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-812065921), (-444685252)⟩, ⟨(-198164581), (-136266683)⟩, ⟨(-10709972), (-8662927)⟩, ⟨244910, 357535⟩, ⟨7167, 9407⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3482901375, 3850282044⟩, ⟨(-198164581), (-136266683)⟩, ⟨(-10709972), (-8662927)⟩, ⟨244910, 357535⟩, ⟨7167, 9407⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1029326695, 1451947842⟩, ⟨127950019, 158401190⟩, ⟨(-7911257), (-5457619)⟩, ⟨(-278088), (-211966)⟩, ⟨5865, 8566⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4791011116, 5296372791⟩, ⟨169560354, 301344593⟩, ⟨16780485, 33431849⟩, ⟨483565, 2491899⟩, ⟨13944, 222805⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1148207960, 1790480932⟩, ⟨183364134, 297205613⟩, ⟨(-682920), 16327746⟩, ⟨(-282207), 1623490⟩, ⟨(-56805), 148099⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1480045731), (-1110034297)⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2814921565, 3184932999⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨306959617, 746413593⟩, ⟨98040400, 247797456⟩, ⟨7258936, 34179589⟩, ⟨(-329810), 3613312⟩, ⟨(-89017), 410240⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4601926913, 5041380889⟩, ⟨98040400, 247797456⟩, ⟨7258936, 34179589⟩, ⟨(-329810), 3613312⟩, ⟨(-89017), 410240⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4445798644, 4653231786⟩, ⟨45246006, 119695252⟩, ⟨1810562, 16279755⟩, ⟨(-597614), 1726937⟩, ⟨(-119301), 213883⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2913776430, 3450604032⟩, ⟨(-170783728), (-102742761)⟩, ⟨(-3969232), 10123282⟩, ⟨(-1144412), 1202622⟩, ⟨(-162856), 184348⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7375149458, 9833532625⟩, ⟨1229191575, 1229191583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12664317509, 22514342305⟩, ⟨4221439164, 5628585600⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12664317509, 22514342305⟩, ⟨4221439164, 5628585600⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-22514342305), (-12664317509)⟩, ⟨(-5628585600), (-4221439164)⟩, ⟨(-351786602), (-351786596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11257171153), (-6332158754)⟩, ⟨(-2814292800), (-2110719582)⟩, ⟨(-175893301), (-175893298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨312368882, 983264960⟩, ⟨(-644287909), (-153510625)⟩, ⟨(-2547349), 198293436⟩, ⟨(-39119647), 18146886⟩, ⟨(-7033094), 6460484⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨211916185, 789961321⟩, ⟨(-556723242), (-111616514)⟩, ⟨716978, 187247036⟩, ⟨(-41094442), 15551363⟩, ⟨(-6772966), 7427194⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1295040013, 1295040014⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4531500951, 4531500958⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar264 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified768
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar264 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1110034297, 1480045731⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4445798644, 4653231786⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified769
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((5169 / 20000) : ℝ)..(1723 / 5000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (5169 / 20000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (1723 / 5000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((5169 / 20000) : ℝ)..(1723 / 5000), prawitzNormalCorrection
      ((74283 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
