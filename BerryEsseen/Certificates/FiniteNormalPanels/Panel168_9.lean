...
namespace FiniteNormalPanel168_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (87647 / 400000)
def radius : Rat := (12521 / 400000)

def j0 : Jet := ⟨⟨941102496, 941102497⟩, ⟨134443213, 134443214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2956560687, 2956560691⟩, ⟨422365810, 422365814⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2035231119, 2035231125⟩, ⟨581494602, 581494610⟩, ⟨41535328, 41535330⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨509, 510⟩, ⟨145, 146⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94178), (-94176)⟩, ⟨145, 146⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-44628), (-44626)⟩, ⟨(-12683), (-12680)⟩, ⟨(-888), (-884)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5068428, 5068431⟩, ⟨(-12683), (-12680)⟩, ⟨(-888), (-884)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2401746, 2401748⟩, ⟨680202, 680206⟩, ⟨46876, 46882⟩, ⟨(-244), (-239)⟩, ⟨(-9), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-140763831), (-140763828)⟩, ⟨680202, 680206⟩, ⟨46876, 46882⟩, ⟨(-244), (-239)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-66702937), (-66702934)⟩, ⟨(-18735659), (-18735655)⟩, ⟨(-1246981), (-1246975)⟩, ⟨12808, 12814⟩, ⟨414, 420⟩⟩
...
def j19 : Jet := ⟨⟨1364952828, 1364952832⟩, ⟨(-18735659), (-18735655)⟩, ⟨(-1246981), (-1246975)⟩, ⟨12808, 12814⟩, ⟨414, 420⟩⟩
...
def j22 : Jet := ⟨⟨(-52), (-50)⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11783, 11786⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5583, 5585⟩, ⟨1587, 1590⟩, ⟨109, 113⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846594), (-846591)⟩, ⟨1587, 1590⟩, ⟨109, 113⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-401171), (-401169)⟩, ⟨(-113869), (-113865)⟩, ⟨(-7923), (-7917)⟩, ⟨28, 32⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35390223, 35390226⟩, ⟨(-113869), (-113865)⟩, ⟨(-7923), (-7917)⟩, ⟨28, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16770158, 16770161⟩, ⟨4737514, 4737519⟩, ⟨323076, 323082⟩, ⟨(-2162), (-2156)⟩, ⟨(-75), (-70)⟩⟩
...
def j33 : Jet := ⟨⟨(-699057725), (-699057721)⟩, ⟨4737514, 4737519⟩, ⟨323076, 323082⟩, ⟨(-2162), (-2156)⟩, ⟨(-75), (-70)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-331258411), (-331258407)⟩, ⟨(-92400323), (-92400317)⟩, ⟨(-5965872), (-5965866)⟩, ⟨88531, 88537⟩, ⟨2795, 2801⟩⟩
...
def j36 : Jet := ⟨⟨3963708885, 3963708889⟩, ⟨(-92400323), (-92400317)⟩, ⟨(-5965872), (-5965866)⟩, ⟨88531, 88537⟩, ⟨2795, 2801⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨939603399, 939603404⟩, ⟨121331841, 121331847⟩, ⟨(-2700855), (-2700848)⟩, ⟨(-113812), (-113806)⟩, ⟨1543, 1551⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4653909908, 4653909914⟩, ⟨108489992, 108490002⟩, ⟨9533775, 9533785⟩, ⟨281582, 281594⟩, ⟨15198, 15212⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1018128722, 1018128730⟩, ⟨155206075, 155206087⟩, ⟨2223932, 2223945⟩, ⟨139379, 139393⟩, ⟨4078, 4095⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-941102497), (-941102496)⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3353864799, 3353864800⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨241349007, 241349012⟩, ⟨73583686, 73583694⟩, ⟨6663012, 6663021⟩, ⟨226810, 226822⟩, ⟨13155, 13170⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4536316303, 4536316308⟩, ⟨73583686, 73583694⟩, ⟨6663012, 6663021⟩, ⟨226810, 226822⟩, ⟨13155, 13170⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4413992542, 4413992545⟩, ⟨35799734, 35799739⟩, ⟨3096493, 3096499⟩, ⟨85231, 85239⟩, ⟨4621, 4631⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3446809530, 3446809535⟩, ⟨(-110213617), (-110213610)⟩, ⟨1297375, 1297381⟩, ⟨(-30374), (-30365)⟩, ⟨939, 950⟩⟩
...
def j47 : Jet := ⟨⟨11303818447, 11303818462⟩, ⟨1614831198, 1614831211⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨29750240846, 29750240926⟩, ⟨8500068766, 8500068848⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨29750240846, 29750240926⟩, ⟨8500068766, 8500068848⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-29750240926), (-29750240846)⟩, ⟨(-8500068848), (-8500068766)⟩, ⟨(-607147776), (-607147765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-14875120463), (-14875120423)⟩, ⟨(-4250034424), (-4250034383)⟩, ⟨(-303573888), (-303573882)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨134533781, 134533787⟩, ⟨(-133126329), (-133126320)⟩, ⟨56357768, 56357775⟩, ⟨(-12316364), (-12316360)⟩, ⟨1055156, 1055159⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨107966437, 107966443⟩, ⟨(-110289212), (-110289202)⟩, ⟨48685204, 48685214⟩, ⟨(-11371533), (-11371526)⟩, ⟨1180830, 1180838⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨806659282, 1075545711⟩, ⟨134443213, 134443214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2534194874, 3378926505⟩, ⟨422365810, 422365814⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1495271841, 2658261063⟩, ⟨498423944, 664565268⟩, ⟨41535328, 41535330⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨374, 666⟩, ⟨124, 167⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94313), (-94020)⟩, ⟨124, 167⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-58373), (-32732)⟩, ⟨(-14551), (-10806)⟩, ⟨(-896), (-876)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5054683, 5080325⟩, ⟨(-14551), (-10806)⟩, ⟨(-896), (-876)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1759763, 3144339⟩, ⟨577581, 782323⟩, ⟨46075, 47573⟩, ⟨(-280), (-202)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141405814), (-140021237)⟩, ⟨577581, 782323⟩, ⟨46075, 47573⟩, ⟨(-280), (-202)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-87519542), (-48747708)⟩, ⟨(-21678805), (-15765036)⟩, ⟨(-1284426), (-1203607)⟩, ⟨10757, 14858⟩, ⟨395, 436⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1344136223, 1382908058⟩, ⟨(-21678805), (-15765036)⟩, ⟨(-1284426), (-1203607)⟩, ⟨10757, 14858⟩, ⟨395, 436⟩⟩
...
def j70 : Jet := ⟨⟨(-67), (-37)⟩, ⟨(-17), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11768, 11799⟩, ⟨(-17), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4096, 7303⟩, ⟨1354, 1822⟩, ⟨108, 114⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848081), (-844873)⟩, ⟨1354, 1822⟩, ⟨108, 114⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-524899), (-294138)⟩, ⟨(-130754), (-96918)⟩, ⟨(-8008), (-7817)⟩, ⟨23, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35266495, 35497257⟩, ⟨(-130754), (-96918)⟩, ⟨(-8008), (-7817)⟩, ⟨23, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12277857, 21970127⟩, ⟨4011692, 5458791⟩, ⟨315862, 329316⟩, ⟨(-2497), (-1821)⟩, ⟨(-77), (-67)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703550026), (-693857755)⟩, ⟨4011692, 5458791⟩, ⟨315862, 329316⟩, ⟨(-2497), (-1821)⟩, ⟨(-77), (-67)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-435444443), (-241563181)⟩, ⟨(-107464462), (-77142478)⟩, ⟨(-6228305), (-5661620)⟩, ⟨73904, 103114⟩, ⟨2619, 2951⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3859522853, 4053404115⟩, ⟨(-107464462), (-77142478)⟩, ⟨(-6228305), (-5661620)⟩, ⟨73904, 103114⟩, ⟨2619, 2951⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨793091749, 1087958155⟩, ⟨115126858, 126692797⟩, ⟨(-3142369), (-2260502)⟩, ⟨(-119964), (-106672)⟩, ⟨1290, 1806⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4550926468, 4779540057⟩, ⟨86611088, 133081400⟩, ⟨8004878, 11418500⟩, ⟨151731, 445555⟩, ⟨7202, 26088⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨840356161, 1210705280⟩, ⟨137981121, 174697558⟩, ⟨302862, 4422836⟩, ⟨11722, 291074⟩, ⟨(-5311), 15398⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1075545711), (-806659282)⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3219421585, 3488308014⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨164424646, 341284852⟩, ⟨53994956, 98490742⟩, ⟨4551329, 9599316⟩, ⟨24044, 523900⟩, ⟨(-2223), 36917⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4459391942, 4636252148⟩, ⟨53994956, 98490742⟩, ⟨4551329, 9599316⟩, ⟨24044, 523900⟩, ⟨(-2223), 36917⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4376407493, 4462348189⟩, ⟨25984813, 48328969⟩, ⟨1928593, 4633200⟩, ⟨(-39367), 245625⟩, ⟨(-6257), 18125⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3280467527, 3624252265⟩, ⟨(-120204959), (-97740430)⟩, ⟨(-67184), 2949627⟩, ⟨(-177005), 139124⟩, ⟨(-12771), 15954⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9688987237, 12918649672⟩, ⟨1614831198, 1614831211⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨21857319790, 38857457542⟩, ⟨7285773226, 9714364398⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨21857319790, 38857457542⟩, ⟨7285773226, 9714364398⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-38857457542), (-21857319790)⟩, ⟨(-9714364398), (-7285773226)⟩, ⟨(-607147776), (-607147765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-19428728771), (-10928659895)⟩, ⟨(-4857182199), (-3642886613)⟩, ⟨(-303573888), (-303573882)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨46599777, 337198681⟩, ⟨(-381338278), (-39524795)⟩, ⟨(-7071659), 212334161⟩, ⟨(-78180520), 20634774⟩, ⟨(-13337999), 22353522⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨35592600, 284540720⟩, ⟨(-331224658), (-31249245)⟩, ⟨(-5073139), 190079662⟩, ⟨(-72190083), 17627193⟩, ⟨(-11850824), 21213592⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨941102496, 941102497⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4413992542, 4413992545⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3398
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨806659282, 1075545711⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4376407493, 4462348189⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3399
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (4020417 / 2147483648)

theorem envelope_integral : (∫ s in ((37563 / 200000) : ℝ)..(12521 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((37563 / 200000) : ℝ)..(12521 / 50000), prawitzNormalCorrection
