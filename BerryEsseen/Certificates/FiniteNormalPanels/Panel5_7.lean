...
namespace FiniteNormalPanel5_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (9289 / 25000)
def radius : Rat := (1327 / 25000)

def j0 : Jet := ⟨⟨1595838048, 1595838049⟩, ⟨227976864, 227976865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5013473087, 5013473092⟩, ⟨716210441, 716210445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5852177830, 5852177843⟩, ⟨1672050808, 1672050820⟩, ⟨119432200, 119432202⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1464, 1467⟩, ⟨418, 419⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93223), (-93219)⟩, ⟨418, 419⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-127023), (-127017)⟩, ⟨(-35724), (-35719)⟩, ⟨(-2392), (-2387)⟩, ⟨22, 24⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4986033, 4986040⟩, ⟨(-35724), (-35719)⟩, ⟨(-2392), (-2387)⟩, ⟨22, 24⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6793800, 6793811⟩, ⟨1892408, 1892420⟩, ⟨121480, 121493⟩, ⟨(-1897), (-1889)⟩, ⟨(-59), (-54)⟩⟩
...
def j16 : Jet := ⟨⟨(-136371777), (-136371765)⟩, ⟨1892408, 1892420⟩, ⟨121480, 121493⟩, ⟨(-1897), (-1889)⟩, ⟨(-59), (-54)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-185815593), (-185815575)⟩, ⟨(-50511639), (-50511616)⟩, ⟨(-2889908), (-2889883)⟩, ⟨97330, 97349⟩, ⟨2558, 2571⟩⟩
...
def j19 : Jet := ⟨⟨1245840172, 1245840191⟩, ⟨(-50511639), (-50511616)⟩, ⟨(-2889908), (-2889883)⟩, ⟨97330, 97349⟩, ⟨2558, 2571⟩⟩
...
def j22 : Jet := ⟨⟨(-148), (-145)⟩, ⟨(-43), (-41)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11687, 11691⟩, ⟨(-43), (-41)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨15924, 15930⟩, ⟨4490, 4497⟩, ⟨301, 309⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-836253), (-836246)⟩, ⟨4490, 4497⟩, ⟨301, 309⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1139451), (-1139440)⟩, ⟨(-319441), (-319426)⟩, ⟨(-21098), (-21080)⟩, ⟨235, 246⟩, ⟨4, 9⟩⟩
...
def j30 : Jet := ⟨⟨34651943, 34651955⟩, ⟨(-319441), (-319426)⟩, ⟨(-21098), (-21080)⟩, ⟨235, 246⟩, ⟨4, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨47215570, 47215588⟩, ⟨13054903, 13054929⟩, ⟨810475, 810508⟩, ⟨(-16777), (-16752)⟩, ⟨(-491), (-477)⟩⟩
...
def j33 : Jet := ⟨⟨(-668612313), (-668612294)⟩, ⟨13054903, 13054929⟩, ⟨810475, 810508⟩, ⟨(-16777), (-16752)⟩, ⟨(-491), (-477)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-911028629), (-911028600)⟩, ⟨(-242505724), (-242505678)⟩, ⟨(-12405763), (-12405704)⟩, ⟨655684, 655735⟩, ⟨15335, 15369⟩⟩
...
def j36 : Jet := ⟨⟨3383938667, 3383938696⟩, ⟨(-242505724), (-242505678)⟩, ⟨(-12405763), (-12405704)⟩, ⟨655684, 655735⟩, ⟨15335, 15369⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1454256980, 1454257005⟩, ⟨148789257, 148789290⟩, ⟨(-11796468), (-11796433)⟩, ⟨(-368297), (-368269)⟩, ⟨19215, 19236⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5451264260, 5451264308⟩, ⟨390657943, 390658027⟩, ⟨47980636, 47980747⟩, ⟨3814304, 3814405⟩, ⟨348785, 348859⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1845774031, 1845774080⟩, ⟨321121560, 321121635⟩, ⟨14807146, 14807238⟩, ⟨1413259, 1413341⟩, ⟨109339, 109402⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1595838049), (-1595838048)⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2699129247, 2699129248⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨793226476, 793226519⟩, ⟨276005750, 276005824⟩, ⟨36736098, 36736192⟩, ⟨3428870, 3428962⟩, ⟨356354, 356426⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5088193772, 5088193815⟩, ⟨276005750, 276005824⟩, ⟨36736098, 36736192⟩, ⟨3428870, 3428962⟩, ⟨356354, 356426⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4674786181, 4674786202⟩, ⟨126790361, 126790397⟩, ⟨15156258, 15156303⟩, ⟨1164067, 1164112⟩, ⟨107556, 107593⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2937822627, 2937822642⟩, ⟨(-168457519), (-168457492)⟩, ⟨2794763, 2794796⟩, ⟨(-72951), (-72919)⟩, ⟨5800, 5828⟩⟩
...
def j47 : Jet := ⟨⟨6372932005, 6372932013⟩, ⟨910418857, 910418863⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9456244842, 9456244866⟩, ⟨2701784238, 2701784260⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9456244842, 9456244866⟩, ⟨2701784238, 2701784260⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9456244866), (-9456244842)⟩, ⟨(-2701784260), (-2701784238)⟩, ⟨(-192984591), (-192984588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4728122433), (-4728122421)⟩, ⟨(-1350892130), (-1350892119)⟩, ⟨(-96492296), (-96492294)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1428453152, 1428453172⟩, ⟨(-449290068), (-449290057)⟩, ⟨38565245, 38565251⟩, ⟨2685977, 2685979⟩, ⟨(-644416), (-644414)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨977083573, 977083592⟩, ⟨(-363348102), (-363348082)⟩, ⟨44930798, 44930819⟩, ⟨8015, 8037⟩, ⟨(-511491), (-511471)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1367861184, 1823814913⟩, ⟨227976864, 227976865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4297262646, 5729683533⟩, ⟨716210441, 716210445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4299559222, 7643660854⟩, ⟨1433186406, 1910915224⟩, ⟨119432200, 119432202⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1076, 1915⟩, ⟨358, 479⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93611), (-92771)⟩, ⟨358, 479⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-166598), (-92870)⟩, ⟨(-41292), (-30103)⟩, ⟨(-2456), (-2311)⟩, ⟨18, 28⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4946458, 5020187⟩, ⟨(-41292), (-30103)⟩, ⟨(-2456), (-2311)⟩, ⟨18, 28⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4951746, 8934319⟩, ⟨1577095, 2203445⟩, ⟨114805, 127241⟩, ⟨(-2224), (-1558)⟩, ⟨(-63), (-49)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138213831), (-134231257)⟩, ⟨1577095, 2203445⟩, ⟨114805, 127241⟩, ⟨(-2224), (-1558)⟩, ⟨(-63), (-49)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-245976181), (-134374769)⟩, ⟨(-59915265), (-40870165)⟩, ⟨(-3202191), (-2525827)⟩, ⟨78205, 116327⟩, ⟨2089, 2971⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1185679584, 1297280997⟩, ⟨(-59915265), (-40870165)⟩, ⟨(-3202191), (-2525827)⟩, ⟨78205, 116327⟩, ⟨2089, 2971⟩⟩
...
def j70 : Jet := ⟨⟨(-193), (-107)⟩, ⟨(-49), (-35)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11642, 11729⟩, ⟨(-49), (-35)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨11654, 20874⟩, ⟨3796, 5184⟩, ⟨293, 314⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-840523), (-831302)⟩, ⟨3796, 5184⟩, ⟨293, 314⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1495861), (-832190)⟩, ⟨(-370166), (-268170)⟩, ⟨(-21814), (-20250)⟩, ⟨194, 285⟩, ⟨4, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34295533, 34959205⟩, ⟨(-370166), (-268170)⟩, ⟨(-21814), (-20250)⟩, ⟨194, 285⟩, ⟨4, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨34332199, 62216145⟩, ⟨10785289, 15285581⟩, ⟨750155, 862372⟩, ⟨(-19806), (-13706)⟩, ⟨(-539), (-419)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-681495684), (-653611737)⟩, ⟨10785289, 15285581⟩, ⟨750155, 862372⟩, ⟨(-19806), (-13706)⟩, ⟨(-539), (-419)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1212843201), (-654310540)⟩, ⟨(-292413983), (-190900093)⟩, ⟨(-14600780), (-9839692)⟩, ⟨514981, 795021⟩, ⟨11086, 18989⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3082124095, 3640656756⟩, ⟨(-292413983), (-190900093)⟩, ⟨(-14600780), (-9839692)⟩, ⟨514981, 795021⟩, ⟨11086, 18989⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1186313244, 1730632402⟩, ⟨117789160, 175437045⟩, ⟨(-14263085), (-9342510)⟩, ⟨(-455738), (-266010)⟩, ⟨15131, 23363⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5066872630, 5985075067⟩, ⟨265684605, 567829064⟩, ⟨27625696, 82225089⟩, ⟨859663, 9644381⟩, ⟨(-41907), 1241908⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1399521275, 2411651621⟩, ⟨212343370, 473276541⟩, ⟨(-4958861), 45304735⟩, ⟨(-1525691), 6353066⟩, ⟨(-308774), 850376⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1823814913), (-1367861184)⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2471152383, 2927106112⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨456036021, 1354157818⟩, ⟨138384784, 531495614⟩, ⟨4929399, 103029694⟩, ⟨(-2806240), 17119132⟩, ⟨(-735308), 2833006⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4751003317, 5649125114⟩, ⟨138384784, 531495614⟩, ⟨4929399, 103029694⟩, ⟨(-2806240), 17119132⟩, ⟨(-735308), 2833006⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4517234095, 4925729146⟩, ⟨60331993, 252671905⟩, ⟨(-4723188), 48577206⟩, ⟨(-4051252), 8402593⟩, ⟨(-1080758), 1598810⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2599035808, 3356982929⟩, ⟨(-226745090), (-67573828)⟩, ⟨(-16630773), 29903916⟩, ⟨(-5339489), 5977243⟩, ⟨(-1182569), 1304662⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5462513147, 7283350871⟩, ⟨910418857, 910418863⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6947445189, 12351013700⟩, ⟨2315815060, 3087753440⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6947445189, 12351013700⟩, ⟨2315815060, 3087753440⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12351013700), (-6947445189)⟩, ⟨(-3087753440), (-2315815060)⟩, ⟨(-192984591), (-192984588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6175506850), (-3473722594)⟩, ⟨(-1543876720), (-1157907530)⟩, ⟨(-96492296), (-96492294)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1019789979, 1912965922⟩, ⟨(-687638194), (-274931661)⟩, ⟨(-5917102), 100678864⟩, ⟨(-7945593), 11008145⟩, ⟨(-2120196), 780503⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨617110792, 1495190418⟩, ⟨(-638455458), (-182415438)⟩, ⟨(-7706586), 128313199⟩, ⟨(-18691410), 14241331⟩, ⟨(-4111854), 3166467⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1595838048, 1595838049⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4674786181, 4674786202⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified98
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1367861184, 1823814913⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4517234095, 4925729146⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified99
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (105384377 / 4294967296)

theorem envelope_integral : (∫ s in ((3981 / 12500) : ℝ)..(1327 / 3125),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((3981 / 12500) : ℝ)..(1327 / 3125), prawitzNormalCorrection
