...
namespace FiniteNormalPanel130_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (41181 / 400000)
def radius : Rat := (13727 / 400000)

def j0 : Jet := ⟨⟨442177620, 442177621⟩, ⟨147392540, 147392541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1389141962, 1389141966⟩, ⟨463047320, 463047325⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨449296876, 449296880⟩, ⟨299531250, 299531256⟩, ⟨49921875, 49921877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨112, 113⟩, ⟨74, 76⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94575), (-94573)⟩, ⟨74, 76⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9894), (-9893)⟩, ⟨(-6589), (-6587)⟩, ⟨(-1094), (-1091)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103162, 5103164⟩, ⟨(-6589), (-6587)⟩, ⟨(-1094), (-1091)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨533842, 533843⟩, ⟨355204, 355206⟩, ⟨58740, 58743⟩, ⟨(-154), (-151)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-142631735), (-142631733)⟩, ⟨355204, 355206⟩, ⟨58740, 58743⟩, ⟨(-154), (-151)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14920718), (-14920717)⟩, ⟨(-9909989), (-9909985)⟩, ⟨(-1626943), (-1626938)⟩, ⟨8207, 8211⟩, ⟨669, 672⟩⟩
...
def j19 : Jet := ⟨⟨1416735047, 1416735049⟩, ⟨(-9909989), (-9909985)⟩, ⟨(-1626943), (-1626938)⟩, ⟨8207, 8211⟩, ⟨669, 672⟩⟩
...
def j25 : Jet := ⟨⟨1236, 1238⟩, ⟨823, 825⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850941), (-850938)⟩, ⟨823, 825⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-89018), (-89016)⟩, ⟨(-59259), (-59257)⟩, ⟨(-9820), (-9817)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35702376, 35702379⟩, ⟨(-59259), (-59257)⟩, ⟨(-9820), (-9817)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3734828, 3734829⟩, ⟨2483685, 2483688⟩, ⟨409819, 409823⟩, ⟨(-1373), (-1369)⟩, ⟨(-115), (-111)⟩⟩
...
def j33 : Jet := ⟨⟨(-712093055), (-712093053)⟩, ⟨2483685, 2483688⟩, ⟨409819, 409823⟩, ⟨(-1373), (-1369)⟩, ⟨(-115), (-111)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-74492113), (-74492111)⟩, ⟨(-49401591), (-49401588)⟩, ⟨(-8060819), (-8060816)⟩, ⟨57304, 57308⟩, ⟨4654, 4658⟩⟩
...
def j36 : Jet := ⟨⟨4220475183, 4220475185⟩, ⟨(-49401591), (-49401588)⟩, ⟨(-8060819), (-8060816)⟩, ⟨57304, 57308⟩, ⟨4654, 4658⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨458221440, 458221443⟩, ⟨149535244, 149535248⟩, ⟨(-1594623), (-1594619)⟩, ⟨(-172750), (-172746)⟩, ⟨1100, 1104⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4370774205, 4370774208⟩, ⟨51160870, 51160875⟩, ⟨8946724, 8946730⟩, ⟨143086, 143095⟩, ⟨13241, 13250⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨466309126, 466309131⟩, ⟨157632816, 157632823⟩, ⟨1112975, 1112982⟩, ⟨131962, 131972⟩, ⟨2132, 2143⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-442177621), (-442177620)⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3852789675, 3852789676⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨50627673, 50627675⟩, ⟨34228720, 34228724⟩, ⟨6027072, 6027077⟩, ⟨110350, 110356⟩, ⟨10436, 10443⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4345594969, 4345594971⟩, ⟨34228720, 34228724⟩, ⟨6027072, 6027077⟩, ⟨110350, 110356⟩, ⟨10436, 10443⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320206971, 4320206973⟩, ⟨17014373, 17014376⟩, ⟨2962426, 2962430⟩, ⟨43185, 43190⟩, ⟨4000, 4006⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3875430862, 3875430866⟩, ⟨(-132996004), (-132995998)⟩, ⟨2073545, 2073551⟩, ⟨(-62926), (-62919)⟩, ⟨2105, 2112⟩⟩
...
def j47 : Jet := ⟨⟨4950311470, 4950311483⟩, ⟨1650103823, 1650103835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5705650814, 5705650845⟩, ⟨3803767208, 3803767248⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5705650814, 5705650845⟩, ⟨3803767208, 3803767248⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5705650845), (-5705650814)⟩, ⟨(-3803767248), (-3803767208)⟩, ⟨(-633961211), (-633961201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2852825423), (-2852825407)⟩, ⟨(-1901883624), (-1901883604)⟩, ⟨(-316980606), (-316980600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2210500056, 2210500074⟩, ⟨(-978846544), (-978846525)⟩, ⟨53583742, 53583755⟩, ⟨40251811, 40251817⟩, ⟨(-6433361), (-6433359)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1994576337, 1994576356⟩, ⟨(-951681237), (-951681214)⟩, ⟨79727340, 79727360⟩, ⟨34155764, 34155779⟩, ⟨(-7010074), (-7010062)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨294785080, 589570161⟩, ⟨147392540, 147392541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨926094641, 1852189287⟩, ⟨463047320, 463047325⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨199687500, 798750007⟩, ⟨199687500, 399375006⟩, ⟨49921875, 49921877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨49, 201⟩, ⟨49, 101⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94638), (-94485)⟩, ⟨49, 101⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-17601), (-4392)⟩, ⟨(-8799), (-4373)⟩, ⟨(-1099), (-1085)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095455, 5108665⟩, ⟨(-8799), (-4373)⟩, ⟨(-1099), (-1085)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨236904, 950077⟩, ⟨235267, 474836⟩, ⟨58202, 59127⟩, ⟨(-206), (-99)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142928673), (-142215499)⟩, ⟨235267, 474836⟩, ⟨58202, 59127⟩, ⟨(-206), (-99)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-26580943), (-6612077)⟩, ⟨(-13279534), (-6523770)⟩, ⟨(-1647665), (-1597868)⟩, ⟨5401, 11015⟩, ⟨653, 684⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1405074822, 1425043689⟩, ⟨(-13279534), (-6523770)⟩, ⟨(-1647665), (-1597868)⟩, ⟨5401, 11015⟩, ⟨653, 684⟩⟩
...
def j70 : Jet := ⟨⟨(-21), (-4)⟩, ⟨(-11), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11814, 11832⟩, ⟨(-11), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨549, 2201⟩, ⟨546, 1101⟩, ⟨134, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851628), (-849975)⟩, ⟨546, 1101⟩, ⟨134, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-158381), (-39518)⟩, ⟨(-79166), (-39313)⟩, ⟨(-9868), (-9750)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35633013, 35751877⟩, ⟨(-79166), (-39313)⟩, ⟨(-9868), (-9750)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1656698, 6648901⟩, ⟨1641975, 3322624⟩, ⟨404976, 413277⟩, ⟨(-1839), (-904)⟩, ⟨(-116), (-109)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714171185), (-709178981)⟩, ⟨1641975, 3322624⟩, ⟨404976, 413277⟩, ⟨(-1839), (-904)⟩, ⟨(-116), (-109)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-132816900), (-32972120)⟩, ⟨(-66332111), (-32354200)⟩, ⟨(-8205889), (-7857211)⟩, ⟨37570, 77008⟩, ⟨4513, 4757⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4162150396, 4261995176⟩, ⟨(-66332111), (-32354200)⟩, ⟨(-8205889), (-7857211)⟩, ⟨37570, 77008⟩, ⟨4513, 4757⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨302966745, 614544995⟩, ⟨145756620, 152229574⟩, ⟨(-2142238), (-1047875)⟩, ⟨(-176474), (-167517)⟩, ⟨722, 1483⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4328194498, 4432022469⟩, ⟨32856740, 70633058⟩, ⟨8228677, 9863635⟩, ⟨42958, 257387⟩, ⟨9271, 18563⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨305310589, 634155522⟩, ⟨149201950, 167193843⟩, ⟨(-515103), 2858855⟩, ⟨64946, 209605⟩, ⟨(-4986), 10023⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-589570161), (-294785080)⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3705397135, 4000182216⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21703205, 93633595⟩, ⟨21212238, 49372624⟩, ⟨5030982, 7352723⟩, ⟨(-30872), 284478⟩, ⟨2695, 21183⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316670501, 4388600891⟩, ⟨21212238, 49372624⟩, ⟨5030982, 7352723⟩, ⟨(-30872), 284478⟩, ⟨2695, 21183⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305805224, 4341531677⟩, ⟨10492364, 24624176⟩, ⟨2418680, 3654325⟩, ⟨(-36297), 135988⟩, ⟨(-986), 10095⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3714747340, 4043550651⟩, ⟨(-139938438), (-124830374)⟩, ⟨1241626, 3043440⟩, ⟨(-159214), 43652⟩, ⟨(-5586), 10649⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3300207646, 6600415307⟩, ⟨1650103823, 1650103835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2535844805, 10143379268⟩, ⟨2535844804, 5071689660⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2535844805, 10143379268⟩, ⟨2535844804, 5071689660⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10143379268), (-2535844805)⟩, ⟨(-5071689660), (-2535844804)⟩, ⟨(-633961211), (-633961201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5071689634), (-1267922402)⟩, ⟨(-2535844830), (-1267922402)⟩, ⟨(-316980606), (-316980600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1318637721, 3197063568⟩, ⟨(-1887617894), (-389276609)⟩, ⟨(-178492834), 459926777⟩, ⟨(-71363887), 128003044⟩, ⟨(-35865908), 17120345⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1140499014, 3009915462⟩, ⟨(-1881288050), (-375013399)⟩, ⟨(-156349041), 496771558⟩, ⟨(-83627832), 126245671⟩, ⟨(-38086824), 18847147⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨442177620, 442177621⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320206971, 4320206973⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2616
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨294785080, 589570161⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305805224, 4341531677⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2617
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (138980493 / 4294967296)

theorem envelope_integral : (∫ s in ((13727 / 200000) : ℝ)..(13727 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (13727 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (13727 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((13727 / 200000) : ℝ)..(13727 / 100000), prawitzNormalCorrection
