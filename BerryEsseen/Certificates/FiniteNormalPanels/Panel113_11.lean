...
namespace FiniteNormalPanel113_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (28007 / 800000)
def radius : Rat := (28007 / 800000)

def j0 : Jet := ⟨⟨150361436, 150361437⟩, ⟨150361436, 150361437⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨472374382, 472374386⟩, ⟨472374382, 472374386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨51953260, 51953262⟩, ⟨103906520, 103906524⟩, ⟨51953260, 51953262⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1146), (-1145)⟩, ⟨(-2291), (-2289)⟩, ⟨(-1146), (-1143)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111910, 5111912⟩, ⟨(-2291), (-2289)⟩, ⟨(-1146), (-1143)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨61835, 61836⟩, ⟨123642, 123644⟩, ⟨61765, 61768⟩, ⟨(-56), (-53)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-143103742), (-143103740)⟩, ⟨123642, 123644⟩, ⟨61765, 61768⟩, ⟨(-56), (-53)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1731028), (-1731027)⟩, ⟨(-3460560), (-3460558)⟩, ⟨(-1727290), (-1727287)⟩, ⟨2988, 2991⟩, ⟨744, 747⟩⟩
...
def j19 : Jet := ⟨⟨1429924737, 1429924739⟩, ⟨(-3460560), (-3460558)⟩, ⟨(-1727290), (-1727287)⟩, ⟨2988, 2991⟩, ⟨744, 747⟩⟩
...
def j25 : Jet := ⟨⟨143, 144⟩, ⟨285, 287⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852034), (-852032)⟩, ⟨285, 287⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10307), (-10306)⟩, ⟨(-20610), (-20608)⟩, ⟨(-10300), (-10297)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781087, 35781089⟩, ⟨(-20610), (-20608)⟩, ⟨(-10300), (-10297)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨432819, 432820⟩, ⟨865388, 865390⟩, ⟨432195, 432198⟩, ⟨(-500), (-497)⟩, ⟨(-126), (-122)⟩⟩
...
def j33 : Jet := ⟨⟨(-715395064), (-715395062)⟩, ⟨865388, 865390⟩, ⟨432195, 432198⟩, ⟨(-500), (-497)⟩, ⟨(-126), (-122)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8653642), (-8653641)⟩, ⟨(-17296815), (-17296813)⟩, ⟨(-8627479), (-8627475)⟩, ⟨20916, 20920⟩, ⟨5212, 5216⟩⟩
...
def j36 : Jet := ⟨⟨4286313654, 4286313655⟩, ⟨(-17296815), (-17296813)⟩, ⟨(-8627479), (-8627475)⟩, ⟨20916, 20920⟩, ⟨5212, 5216⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨157267743, 157267745⟩, ⟨156887139, 156887142⟩, ⟨(-570577), (-570575)⟩, ⟨(-189645), (-189643)⟩, ⟨409, 412⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303638407, 4303638409⟩, ⟨17366724, 17366728⟩, ⟨8732426, 8732433⟩, ⟨49188, 49196⟩, ⟨12452, 12461⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨157585250, 157585253⟩, ⟨157839790, 157839796⟩, ⟨382398, 382403⟩, ⟨128444, 128450⟩, ⟨732, 742⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-150361437), (-150361436)⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4144605859, 4144605860⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5781909, 5781910⟩, ⟨11582496, 11582498⟩, ⟨5828662, 5828666⟩, ⟨37530, 37534⟩, ⟨9526, 9533⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300749205, 4300749206⟩, ⟨11582496, 11582498⟩, ⟨5828662, 5828666⟩, ⟨37530, 37534⟩, ⟨9526, 9533⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297857278, 4297857279⟩, ⟨5787353, 5787355⟩, ⟨2908474, 2908477⟩, ⟨14835, 14839⟩, ⟨3755, 3761⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4147394666, 4147394669⟩, ⟨(-144877867), (-144877863)⟩, ⟨2604042, 2604048⟩, ⟨(-87508), (-87502)⟩, ⟨3103, 3111⟩⟩
...
def j47 : Jet := ⟨⟨1492857749, 1492857760⟩, ⟨1492857749, 1492857760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨518892020, 518892029⟩, ⟨1037784040, 1037784058⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨518892020, 518892029⟩, ⟨1037784040, 1037784058⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-518892029), (-518892020)⟩, ⟨(-1037784058), (-1037784040)⟩, ⟨(-518892029), (-518892020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-259446015), (-259446010)⟩, ⟨(-518892029), (-518892020)⟩, ⟨(-259446015), (-259446010)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4043202024, 4043202029⟩, ⟨(-488475269), (-488475259)⟩, ⟨(-214730320), (-214730312)⟩, ⟨28319016, 28319019⟩, ⟨5630271, 5630273⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3904279905, 3904279913⟩, ⟨(-608076858), (-608076842)⟩, ⟨(-188423663), (-188423645)⟩, ⟨34210731, 34210745⟩, ⟨4364240, 4364255⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 300722873⟩, ⟨150361436, 150361437⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 944748769⟩, ⟨472374382, 472374386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 207813047⟩, ⟨0, 207813048⟩, ⟨51953260, 51953262⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4582), 0⟩, ⟨(-4582), 3⟩, ⟨(-1146), (-1140)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108474, 5113057⟩, ⟨(-4582), 3⟩, ⟨(-1146), (-1140)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 247397⟩, ⟨(-222), 247398⟩, ⟨61515, 61851⟩, ⟨(-112), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142918179)⟩, ⟨(-222), 247398⟩, ⟨61515, 61851⟩, ⟨(-112), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6927102), 0⟩, ⟨(-6927113), 11971⟩, ⟨(-1731787), (-1713818)⟩, ⟨(-9), 5987⟩, ⟨737, 750⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424728663, 1431655766⟩, ⟨(-6927113), 11971⟩, ⟨(-1731787), (-1713818)⟩, ⟨(-9), 5987⟩, ⟨737, 750⟩⟩
...
def j72 : Jet := ⟨⟨0, 573⟩, ⟨(-1), 573⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851603)⟩, ⟨(-1), 573⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-41233), 0⟩, ⟨(-41234), 28⟩, ⟨(-10310), (-10266)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35750161, 35791395⟩, ⟨(-41234), 28⟩, ⟨(-10310), (-10266)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1731776⟩, ⟨(-1996), 1731778⟩, ⟨429950, 432946⟩, ⟨(-999), 2⟩, ⟨(-127), (-122)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714096106)⟩, ⟨(-1996), 1731778⟩, ⟨429950, 432946⟩, ⟨(-999), 2⟩, ⟨(-127), (-122)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-34635508), 0⟩, ⟨(-34635606), 83793⟩, ⟨(-8658975), (-8533186)⟩, ⟨(-74), 41899⟩, ⟨5144, 5239⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4260331788, 4294967296⟩, ⟨(-34635606), 83793⟩, ⟨(-8658975), (-8533186)⟩, ⟨(-74), 41899⟩, ⟨5144, 5239⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 314916257⟩, ⟨155172529, 157460763⟩, ⟨(-1142803), 1317⟩, ⟨(-190470), (-187174)⟩, ⟨(-1), 824⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4329884383⟩, ⟨(-85162), 35201055⟩, ⟨8532499, 9086517⟩, ⟨(-42937), 145493⟩, ⟨10979, 14468⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 317476454⟩, ⟨155166284, 161321901⟩, ⟨(-1155217), 1958103⟩, ⟨103734, 156645⟩, ⟨(-5557), 7234⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-300722873), 0⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3994244423, 4294967296⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 23467303⟩, ⟨0, 23849266⟩, ⟨5434980, 6348841⟩, ⟨(-86782), 170254⟩, ⟨6145, 13731⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4318434599⟩, ⟨0, 23849266⟩, ⟨5434980, 6348841⟩, ⟨(-86782), 170254⟩, ⟨6145, 13731⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306684964⟩, ⟨0, 11924633⟩, ⟨2693587, 3174421⟩, ⟨(-52205), 85127⟩, ⟨1657, 6166⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3994244423, 4306684964⟩, ⟨(-150771658), (-138436803)⟩, ⟨2087521, 3174421⟩, ⟨(-163338), (-9172)⟩, ⟨(-1441), 7994⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2985715510⟩, ⟨1492857749, 1492857760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2075568100⟩, ⟨0, 2075568108⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2075568100⟩, ⟨0, 2075568108⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2075568100), 0⟩, ⟨(-2075568108), 0⟩, ⟨(-518892029), (-518892020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1037784050), 0⟩, ⟨(-1037784054), 0⟩, ⟨(-259446015), (-259446010)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3373045388, 4294967296⟩, ⟨(-1037784054), 0⟩, ⟨(-259446015), (-78376684)⟩, ⟨0, 62689404⟩, ⟨(-1419629), 7836176⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3136873182, 4306684964⟩, ⟨(-1191387028), (-108721111)⟩, ⟨(-258514413), (-33283879)⟩, ⟨1595896, 71960894⟩, ⟨(-3817368), 7866923⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨150361436, 150361437⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297857278, 4297857279⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2276
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 300722873⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306684964⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2277
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (269080433 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(28007 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (28007 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(28007 / 400000), prawitzNormalCorrection
