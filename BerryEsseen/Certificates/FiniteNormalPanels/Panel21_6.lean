...
namespace FiniteNormalPanel21_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (43207 / 160000)
def radius : Rat := (43207 / 800000)

def j0 : Jet := ⟨⟨1159829074, 1159829075⟩, ⟨231965814, 231965815⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3643710498, 3643710502⟩, ⟨728742097, 728742101⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3091205422, 3091205429⟩, ⟨1236482164, 1236482174⟩, ⟨123648216, 123648218⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨773, 775⟩, ⟨309, 310⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93914), (-93911)⟩, ⟨309, 310⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-67593), (-67590)⟩, ⟨(-26815), (-26812)⟩, ⟨(-2595), (-2590)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5045463, 5045467⟩, ⟨(-26815), (-26812)⟩, ⟨(-2595), (-2590)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3631357, 3631361⟩, ⟨1433243, 1433248⟩, ⟨135666, 135673⟩, ⟨(-1509), (-1503)⟩, ⟨(-71), (-67)⟩⟩
...
def j16 : Jet := ⟨⟨(-139534220), (-139534215)⟩, ⟨1433243, 1433248⟩, ⟨135666, 135673⟩, ⟨(-1509), (-1503)⟩, ⟨(-71), (-67)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-100426595), (-100426590)⟩, ⟨(-39139094), (-39139088)⟩, ⟨(-3506805), (-3506795)⟩, ⟨79231, 79241⟩, ⟨3418, 3426⟩⟩
...
def j19 : Jet := ⟨⟨1331229170, 1331229176⟩, ⟨(-39139094), (-39139088)⟩, ⟨(-3506805), (-3506795)⟩, ⟨79231, 79241⟩, ⟨3418, 3426⟩⟩
...
def j22 : Jet := ⟨⟨(-78), (-77)⟩, ⟨(-32), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11757, 11759⟩, ⟨(-32), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8461, 8464⟩, ⟨3360, 3365⟩, ⟨325, 329⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843716), (-843712)⟩, ⟨3360, 3365⟩, ⟨325, 329⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-607246), (-607242)⟩, ⟨(-240481), (-240475)⟩, ⟨(-23090), (-23083)⟩, ⟨186, 192⟩, ⟨7, 10⟩⟩
...
def j30 : Jet := ⟨⟨35184148, 35184153⟩, ⟨(-240481), (-240475)⟩, ⟨(-23090), (-23083)⟩, ⟨186, 192⟩, ⟨7, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25322993, 25322998⟩, ⟨9956116, 9956123⟩, ⟨927067, 927077⟩, ⟨(-13439), (-13429)⟩, ⟨(-607), (-600)⟩⟩
...
def j33 : Jet := ⟨⟨(-690504890), (-690504884)⟩, ⟨9956116, 9956123⟩, ⟨927067, 927077⟩, ⟨(-13439), (-13429)⟩, ⟨(-607), (-600)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-496975255), (-496975248)⟩, ⟨(-191624415), (-191624403)⟩, ⟨(-16345501), (-16345488)⟩, ⟨543848, 543861⟩, ⟨22383, 22393⟩⟩
...
def j36 : Jet := ⟨⟨3797992041, 3797992048⟩, ⟨(-191624415), (-191624403)⟩, ⟨(-16345501), (-16345488)⟩, ⟨543848, 543861⟩, ⟨22383, 22393⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1129371510, 1129371517⟩, ⟨192669967, 192669976⟩, ⟨(-9615927), (-9615915)⟩, ⟨(-527795), (-527784)⟩, ⟨16342, 16353⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4856972800, 4856972810⟩, ⟨245054360, 245054378⟩, ⟨33267047, 33267068⟩, ⟨2037598, 2037622⟩, ⟨182246, 182268⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1277152147, 1277152158⟩, ⟨282318843, 282318861⟩, ⟨8866463, 8866486⟩, ⟨882626, 882650⟩, ⟨53211, 53235⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1159829075), (-1159829074)⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3135138221, 3135138222⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨379774162, 379774169⟩, ⟨167900750, 167900764⟩, ⟨23830581, 23830600⟩, ⟨1690542, 1690564⟩, ⟨165981, 166002⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4674741458, 4674741465⟩, ⟨167900750, 167900764⟩, ⟨23830581, 23830600⟩, ⟨1690542, 1690564⟩, ⟨165981, 166002⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4480832699, 4480832703⟩, ⟨80468104, 80468112⟩, ⟨10698507, 10698518⟩, ⟨618081, 618093⟩, ⟨55675, 55687⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3270811833, 3270811838⟩, ⟨(-183265979), (-183265970)⟩, ⟨3463459, 3463470⟩, ⟨(-126642), (-126631)⟩, ⟨7257, 7269⟩⟩
...
def j47 : Jet := ⟨⟨4626738525, 4626738531⟩, ⟨925347701, 925347707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4984137923, 4984137937⟩, ⟨1993655160, 1993655178⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4984137923, 4984137937⟩, ⟨1993655160, 1993655178⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4984137937), (-4984137923)⟩, ⟨(-1993655178), (-1993655160)⟩, ⟨(-199365518), (-199365515)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2492068969), (-2492068961)⟩, ⟨(-996827589), (-996827580)⟩, ⟨(-99682759), (-99682757)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2404192085, 2404192101⟩, ⟨(-557993776), (-557993766)⟩, ⟨8953568, 8953573⟩, ⟨7941041, 7941043⟩, ⟨(-564666), (-564665)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1830901000, 1830901016⟩, ⟨(-527524219), (-527524204)⟩, ⟨32566842, 32566856⟩, ⟨5144553, 5144567⟩, ⟨(-741130), (-741116)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨927863259, 1391794890⟩, ⟨231965814, 231965815⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2914968397, 4372452602⟩, ⟨728742097, 728742101⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1978371468, 4451335817⟩, ⟨989185730, 1483778608⟩, ⟨123648216, 123648218⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨495, 1116⟩, ⟨247, 372⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94192), (-93570)⟩, ⟨247, 372⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-97622), (-43100)⟩, ⟨(-32428), (-21164)⟩, ⟨(-2643), (-2531)⟩, ⟨13, 22⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5015434, 5069957⟩, ⟨(-32428), (-21164)⟩, ⟨(-2643), (-2531)⟩, ⟨13, 22⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2310236, 5254541⟩, ⟨1121509, 1741766⟩, ⟨130446, 139921⟩, ⟨(-1843), (-1168)⟩, ⟨(-75), (-62)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140855341), (-137911035)⟩, ⟨1121509, 1741766⟩, ⟨130446, 139921⟩, ⟨(-1843), (-1168)⟩, ⟨(-75), (-62)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-145983516), (-63525339)⟩, ⟨(-48144577), (-29957489)⟩, ⟨(-3736715), (-3223590)⟩, ⟨60419, 97945⟩, ⟨3040, 3732⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1285672249, 1368130427⟩, ⟨(-48144577), (-29957489)⟩, ⟨(-3736715), (-3223590)⟩, ⟨60419, 97945⟩, ⟨3040, 3732⟩⟩
...
def j72 : Jet := ⟨⟨5399, 12217⟩, ⟨2659, 4062⟩, ⟨318, 334⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846778), (-839959)⟩, ⟨2659, 4062⟩, ⟨318, 334⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-877607), (-386906)⟩, ⟨(-291312), (-189243)⟩, ⟨(-23620), (-22430)⟩, ⟨144, 233⟩, ⟨5, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34913787, 35404489⟩, ⟨(-291312), (-189243)⟩, ⟨(-23620), (-22430)⟩, ⟨144, 233⟩, ⟨5, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16082180, 36693474⟩, ⟨7739172, 12143988⟩, ⟨880016, 965348⟩, ⟨(-16481), (-10371)⟩, ⟨(-645), (-553)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699745703), (-679134408)⟩, ⟨7739172, 12143988⟩, ⟨880016, 965348⟩, ⟨(-16481), (-10371)⟩, ⟨(-645), (-553)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-725221614), (-312826627)⟩, ⟨(-238175680), (-143827194)⟩, ⟨(-17957259), (-14355797)⟩, ⟨408399, 678336⟩, ⟨18971, 25150⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3569745682, 3982140669⟩, ⟨(-238175680), (-143827194)⟩, ⟨(-17957259), (-14355797)⟩, ⟨408399, 678336⟩, ⟨18971, 25150⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨872578000, 1392812805⟩, ⟨169131347, 211803501⟩, ⟨(-11972988), (-7270822)⟩, ⟨(-593016), (-447244)⟩, ⟨12314, 20419⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4632368770, 5167523325⟩, ⟨167312170, 344780411⟩, ⟨22742888, 48998691⟩, ⟨544334, 4473641⟩, ⟨10279, 501210⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨941125461, 1675773566⟩, ⟨216409491, 366641699⟩, ⟨(-3196304), 25050385⟩, ⟨(-668450), 3101479⟩, ⟨(-147394), 351799⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1391794890), (-927863259)⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2903172406, 3367104037⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨206222090, 653838982⟩, ⟨94840526, 286106238⟩, ⟨8409959, 50846414⟩, ⟨(-1067330), 6697092⟩, ⟨(-247787), 950151⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4501189386, 4948806278⟩, ⟨94840526, 286106238⟩, ⟨8409959, 50846414⟩, ⟨(-1067330), 6697092⟩, ⟨(-247787), 950151⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4396869477, 4610310307⟩, ⟨44176739, 139737710⟩, ⟨1799647, 24612069⟩, ⟨(-1303499), 3252859⟩, ⟨(-293288), 505124⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2972052930, 3614321921⟩, ⟨(-219135941), (-127919949)⟩, ⟨(-6330594), 16909071⟩, ⟨(-2351166), 2452932⟩, ⟨(-405611), 466401⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3701390819, 5552086238⟩, ⟨925347701, 925347707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3189848269, 7177158631⟩, ⟨1594924128, 2392386212⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3189848269, 7177158631⟩, ⟨1594924128, 2392386212⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7177158631), (-3189848269)⟩, ⟨(-2392386212), (-1594924128)⟩, ⟨(-199365518), (-199365515)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3588579316), (-1594924134)⟩, ⟨(-1196193106), (-797462064)⟩, ⟨(-99682759), (-99682757)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1862487028, 2962687304⟩, ⟨(-825139259), (-345814681)⟩, ⟨(-36657276), 71678103⟩, ⟨(-1303645), 16170360⟩, ⟨(-1957700), 516163⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1288813079, 2493175135⟩, ⟨(-845536167), (-294770295)⟩, ⟨(-24915248), 114082756⟩, ⟨(-9624556), 18386337⟩, ⟨(-3367855), 1556501⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1159829074, 1159829075⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4480832699, 4480832703⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified418
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨927863259, 1391794890⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4396869477, 4610310307⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified419
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (99487787 / 2147483648)

theorem envelope_integral : (∫ s in ((43207 / 200000) : ℝ)..(129621 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((43207 / 200000) : ℝ)..(129621 / 400000), prawitzNormalCorrection
