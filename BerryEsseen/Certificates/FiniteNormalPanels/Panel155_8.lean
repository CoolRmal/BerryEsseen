...
namespace FiniteNormalPanel155_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (12857 / 80000)
def radius : Rat := (12857 / 400000)

def j0 : Jet := ⟨⟨690254931, 690254932⟩, ⟨138050986, 138050987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2168499820, 2168499824⟩, ⟨433699963, 433699967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1094860832, 1094860837⟩, ⟨437944330, 437944338⟩, ⟨43794433, 43794434⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨274, 275⟩, ⟨109, 110⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94413), (-94411)⟩, ⟨109, 110⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-24068), (-24066)⟩, ⟨(-9600), (-9597)⟩, ⟨(-950), (-947)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5088988, 5088991⟩, ⟨(-9600), (-9597)⟩, ⟨(-950), (-947)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1297270, 1297272⟩, ⟨516460, 516463⟩, ⟨50668, 50672⟩, ⟨(-195), (-191)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-141868307), (-141868304)⟩, ⟨516460, 516463⟩, ⟨50668, 50672⟩, ⟨(-195), (-191)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-36164665), (-36164664)⟩, ⟨(-14334213), (-14334209)⟩, ⟨(-1381010), (-1381005)⟩, ⟨10382, 10386⟩, ⟨493, 497⟩⟩
...
def j19 : Jet := ⟨⟨1395491100, 1395491102⟩, ⟨(-14334213), (-14334209)⟩, ⟨(-1381010), (-1381005)⟩, ⟨10382, 10386⟩, ⟨493, 497⟩⟩
...
def j25 : Jet := ⟨⟨3009, 3011⟩, ⟨1199, 1203⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849168), (-849165)⟩, ⟨1199, 1203⟩, ⟨117, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-216468), (-216466)⟩, ⟨(-86282), (-86279)⟩, ⟨(-8508), (-8504)⟩, ⟨22, 26⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35574926, 35574929⟩, ⟨(-86282), (-86279)⟩, ⟨(-8508), (-8504)⟩, ⟨22, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9068658, 9068660⟩, ⟨3605468, 3605471⟩, ⟨351779, 351783⟩, ⟨(-1743), (-1739)⟩, ⟨(-86), (-82)⟩⟩
...
def j33 : Jet := ⟨⟨(-706759225), (-706759222)⟩, ⟨3605468, 3605471⟩, ⟨351779, 351783⟩, ⟨(-1743), (-1739)⟩, ⟨(-86), (-82)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-180165050), (-180165048)⟩, ⟨(-71146926), (-71146921)⟩, ⟨(-6749291), (-6749286)⟩, ⟨72187, 72192⟩, ⟨3386, 3391⟩⟩
...
def j36 : Jet := ⟨⟨4114802246, 4114802248⟩, ⟨(-71146926), (-71146921)⟩, ⟨(-6749291), (-6749286)⟩, ⟨72187, 72192⟩, ⟨3386, 3391⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨704573979, 704573982⟩, ⟨133677548, 133677554⟩, ⟨(-2144713), (-2144708)⟩, ⟨(-134212), (-134208)⟩, ⟨1296, 1300⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4483020801, 4483020805⟩, ⟨77513597, 77513605⟩, ⟨8693500, 8693510⟩, ⟨198803, 198812⟩, ⟨12641, 12651⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨735423481, 735423486⟩, ⟨152246395, 152246404⟩, ⟨1600068, 1600079⟩, ⟨124394, 124404⟩, ⟨2847, 2858⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-690254932), (-690254931)⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3604712364, 3604712365⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨125925917, 125925919⟩, ⟨52138032, 52138038⟩, ⟨5944729, 5944736⟩, ⟨156034, 156044⟩, ⟨10388, 10397⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4420893213, 4420893215⟩, ⟨52138032, 52138038⟩, ⟨5944729, 5944736⟩, ⟨156034, 156044⟩, ⟨10388, 10397⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4357475389, 4357475391⟩, ⟨25695055, 25695059⟩, ⟨2853966, 2853971⟩, ⟨60067, 60074⟩, ⟨3829, 3836⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3657174625, 3657174628⟩, ⟨(-118494616), (-118494610)⟩, ⟨1569393, 1569400⟩, ⟨(-41321), (-41313)⟩, ⟨1282, 1290⟩⟩
...
def j47 : Jet := ⟨⟨8350203282, 8350203297⟩, ⟨1670040654, 1670040667⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16234324977, 16234325036⟩, ⟨6493729980, 6493730044⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16234324977, 16234325036⟩, ⟨6493729980, 6493730044⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16234325036), (-16234324977)⟩, ⟨(-6493730044), (-6493729980)⟩, ⟨(-649373008), (-649372997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8117162518), (-8117162488)⟩, ⟨(-3246865022), (-3246864990)⟩, ⟨(-324686504), (-324686498)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨648897677, 648897688⟩, ⟨(-490546973), (-490546959)⟩, ⟨136364612, 136364622⟩, ⟨(-9639932), (-9639927)⟩, ⟨(-3332503), (-3332501)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨552537878, 552537889⟩, ⟨(-435604441), (-435604426)⟩, ⟨129885678, 129885692⟩, ⟨(-12156105), (-12156095)⟩, ⟨(-2516939), (-2516930)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨552203945, 828305918⟩, ⟨138050986, 138050987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1734799856, 2602199788⟩, ⟨433699963, 433699967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨700710932, 1576599604⟩, ⟨350355464, 525533206⟩, ⟨43794433, 43794434⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨175, 395⟩, ⟨87, 132⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94512), (-94291)⟩, ⟨87, 132⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34694), (-15383)⟩, ⟨(-11551), (-7642)⟩, ⟨(-956), (-939)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078362, 5097674⟩, ⟨(-11551), (-7642)⟩, ⟨(-956), (-939)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨828519, 1871258⟩, ⟨410018, 622507⟩, ⟨50017, 51204⟩, ⟨(-235), (-151)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142337058), (-141294318)⟩, ⟨410018, 622507⟩, ⟨50017, 51204⟩, ⟨(-235), (-151)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-52249187), (-23051740)⟩, ⟨(-17349503), (-11297359)⟩, ⟨(-1409761), (-1345765)⟩, ⟨8173, 12590⟩, ⟨477, 510⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1379406578, 1408604026⟩, ⟨(-17349503), (-11297359)⟩, ⟨(-1409761), (-1345765)⟩, ⟨8173, 12590⟩, ⟨477, 510⟩⟩
...
def j72 : Jet := ⟨⟨1924, 4339⟩, ⟨956, 1446⟩, ⟨117, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850253), (-847837)⟩, ⟨956, 1446⟩, ⟨117, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-312112), (-138322)⟩, ⟨(-103883), (-68630)⟩, ⟨(-8574), (-8423)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35479282, 35653073⟩, ⟨(-103883), (-68630)⟩, ⟨(-8574), (-8423)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5788337, 13087556⟩, ⟨2856034, 4351323⟩, ⟨345911, 356572⟩, ⟨(-2108), (-1374)⟩, ⟨(-88), (-80)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710039546), (-702740326)⟩, ⟨2856034, 4351323⟩, ⟨345911, 356572⟩, ⟨(-2108), (-1374)⟩, ⟨(-88), (-80)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-260641814), (-114649960)⟩, ⟨(-86414653), (-55727692)⟩, ⟨(-6950641), (-6502302)⟩, ⟨56565, 87777⟩, ⟨3236, 3511⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4034325482, 4180317336⟩, ⟨(-86414653), (-55727692)⟩, ⟨(-6950641), (-6502302)⟩, ⟨56565, 87777⟩, ⟨3236, 3511⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨557162410, 853433530⟩, ⟨128779026, 137675756⟩, ⟨(-2606065), (-1684365)⟩, ⟨(-139055), (-128265)⟩, ⟨1017, 1581⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4412761661, 4572448147⟩, ⟨58826400, 97941161⟩, ⟨7648071, 9975647⟩, ⟨97446, 320548⟩, ⟨7296, 19691⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨572443223, 908570496⟩, ⟨139942161, 166031889⟩, ⟨(-18458), 3391174⟩, ⟨34491, 228614⟩, ⟨(-4313), 11118⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-828305918), (-552203945)⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3466661378, 3742763351⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨76296563, 192201777⟩, ⟨37303632, 70245786⟩, ⟨4551900, 7853107⟩, ⟨7766, 358912⟩, ⟨405, 25058⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4371263859, 4487169073⟩, ⟨37303632, 70245786⟩, ⟨4551900, 7853107⟩, ⟨7766, 358912⟩, ⟨405, 25058⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4332947647, 4390016449⟩, ⟨18247981, 34815025⟩, ⟨2088622, 3853711⟩, ⟨(-27117), 169088⟩, ⟨(-2873), 12135⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3497317028, 3825592035⟩, ⟨(-126377339), (-108932911)⟩, ⟨566778, 2771705⟩, ⟨(-147499), 80216⟩, ⟨(-7939), 11447⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6680162628, 10020243951⟩, ⟨1670040654, 1670040667⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10389967993, 23377428027⟩, ⟨5194983986, 7792476050⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10389967993, 23377428027⟩, ⟨5194983986, 7792476050⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23377428027), (-10389967993)⟩, ⟨(-7792476050), (-5194983986)⟩, ⟨(-649373008), (-649372997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11688714014), (-5194983996)⟩, ⟨(-3896238025), (-2597491993)⟩, ⟨(-324686504), (-324686498)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨282508434, 1281322156⟩, ⟨(-1162368830), (-170854245)⟩, ⟨(-45199820), 505872570⟩, ⟨(-144359021), 72248917⟩, ⟨(-35506614), 34447798⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨230041695, 1141292936⟩, ⟨(-1073041704), (-146288872)⟩, ⟨(-35889519), 485617343⟩, ⟨(-144261936), 65684567⟩, ⟨(-33805415), 35300661⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨690254931, 690254932⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4357475389, 4357475391⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3126
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨552203945, 828305918⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4332947647, 4390016449⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3127
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (38756993 / 4294967296)

theorem envelope_integral : (∫ s in ((12857 / 100000) : ℝ)..(38571 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((12857 / 100000) : ℝ)..(38571 / 200000), prawitzNormalCorrection
