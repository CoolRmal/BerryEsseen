...
namespace FiniteNormalPanel13_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (13419 / 40000)
def radius : Rat := (1917 / 40000)

def j0 : Jet := ⟨⟨1440854153, 1440854154⟩, ⟨205836307, 205836308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4526576821, 4526576826⟩, ⟨646653829, 646653834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4770676073, 4770676085⟩, ⟨1363050300, 1363050314⟩, ⟨97360735, 97360737⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1194, 1196⟩, ⟨341, 342⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93493), (-93490)⟩, ⟨341, 342⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-103849), (-103844)⟩, ⟨(-29293), (-29289)⟩, ⟨(-1986), (-1982)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5009207, 5009213⟩, ⟨(-29293), (-29289)⟩, ⟨(-1986), (-1982)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5564024, 5564032⟩, ⟨1557183, 1557191⟩, ⟨102048, 102056⟩, ⟨(-1281), (-1274)⟩, ⟨(-42), (-36)⟩⟩
...
def j16 : Jet := ⟨⟨(-137601553), (-137601544)⟩, ⟨1557183, 1557191⟩, ⟨102048, 102056⟩, ⟨(-1281), (-1274)⟩, ⟨(-42), (-36)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-152842244), (-152842233)⟩, ⟨(-41939558), (-41939544)⟩, ⟨(-2511693), (-2511679)⟩, ⟨66261, 66274⟩, ⟨1859, 1871⟩⟩
...
def j19 : Jet := ⟨⟨1278813521, 1278813533⟩, ⟨(-41939558), (-41939544)⟩, ⟨(-2511693), (-2511679)⟩, ⟨66261, 66274⟩, ⟨1859, 1871⟩⟩
...
def j25 : Jet := ⟨⟨13012, 13016⟩, ⟨3678, 3683⟩, ⟨249, 254⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-839165), (-839160)⟩, ⟨3678, 3683⟩, ⟨249, 254⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-932111), (-932105)⟩, ⟨(-262233), (-262224)⟩, ⟨(-17580), (-17570)⟩, ⟨159, 165⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34859283, 34859290⟩, ⟨(-262233), (-262224)⟩, ⟨(-17580), (-17570)⟩, ⟨159, 165⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨38720282, 38720291⟩, ⟨10771659, 10771674⟩, ⟨687458, 687476⟩, ⟨(-11349), (-11336)⟩, ⟨(-347), (-338)⟩⟩
...
def j33 : Jet := ⟨⟨(-677107601), (-677107591)⟩, ⟨10771659, 10771674⟩, ⟨687458, 687476⟩, ⟨(-11349), (-11336)⟩, ⟨(-347), (-338)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-752103757), (-752103743)⟩, ⟨(-202922066), (-202922041)⟩, ⟨(-11166965), (-11166936)⟩, ⟨449742, 449766⟩, ⟨11595, 11613⟩⟩
...
def j36 : Jet := ⟨⟨3542863539, 3542863553⟩, ⟨(-202922066), (-202922041)⟩, ⟨(-11166965), (-11166936)⟩, ⟨449742, 449766⟩, ⟨11595, 11613⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1347774556, 1347774571⟩, ⟨148338038, 148338058⟩, ⟨(-8961594), (-8961575)⟩, ⟨(-308329), (-308312)⟩, ⟨11935, 11951⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5206732858, 5206732879⟩, ⟨298222282, 298222324⟩, ⟨33492432, 33492484⟩, ⟨2197308, 2197353⟩, ⟨176492, 176529⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1633889522, 1633889548⟩, ⟨273411380, 273411421⟩, ⟨9945902, 9945947⟩, ⟨850236, 850278⟩, ⟨54447, 54488⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1440854154), (-1440854153)⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2854113142, 2854113143⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨621563515, 621563535⟩, ⟨208022066, 208022104⟩, ⟨24972201, 24972243⟩, ⟨1913174, 1913216⟩, ⟨172703, 172747⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4916530811, 4916530831⟩, ⟨208022066, 208022104⟩, ⟨24972201, 24972243⟩, ⟨1913174, 1913216⟩, ⟨172703, 172747⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4595251793, 4595251803⟩, ⟨97214255, 97214274⟩, ⟨10641872, 10641894⟩, ⟨668943, 668965⟩, ⟨54233, 54256⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3053659697, 3053659706⟩, ⟨(-155626142), (-155626125)⟩, ⟨2412794, 2412812⟩, ⟨(-65484), (-65467)⟩, ⟨3978, 3996⟩⟩
...
def j47 : Jet := ⟨⟨7232343271, 7232343279⟩, ⟨1033191893, 1033191899⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12178623394, 12178623422⟩, ⟨3479606674, 3479606700⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12178623394, 12178623422⟩, ⟨3479606674, 3479606700⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12178623422), (-12178623394)⟩, ⟨(-3479606700), (-3479606674)⟩, ⟨(-248543337), (-248543333)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6089311711), (-6089311697)⟩, ⟨(-1739803350), (-1739803337)⟩, ⟨(-124271669), (-124271666)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1040462753, 1040462769⟩, ⟨(-421470174), (-421470163)⟩, ⟨55259454, 55259460⟩, ⟨668456, 668459⟩, ⟨(-867141), (-867139)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨739753985, 739754000⟩, ⟨(-337359891), (-337359875)⟩, ⟨55144949, 55144962⟩, ⟨(-1779676), (-1779664)⟩, ⟨(-602317), (-602304)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1235017845, 1646690462⟩, ⟨205836307, 205836308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3879922988, 5173230659⟩, ⟨646653829, 646653834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3504986500, 6231087133⟩, ⟨1168328828, 1557771788⟩, ⟨97360735, 97360737⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨877, 1562⟩, ⟨292, 391⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93810), (-93124)⟩, ⟨292, 391⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-136099), (-75995)⟩, ⟨(-33787), (-24763)⟩, ⟨(-2029), (-1931)⟩, ⟨12, 19⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4976957, 5037062⟩, ⟨(-33787), (-24763)⟩, ⟨(-2029), (-1931)⟩, ⟨12, 19⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4061536, 7307710⟩, ⟨1304827, 1806720⟩, ⟨97621, 105872⟩, ⟨(-1493), (-1058)⟩, ⟨(-43), (-34)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139104041), (-135857866)⟩, ⟨1304827, 1806720⟩, ⟨97621, 105872⟩, ⟨(-1493), (-1058)⟩, ⟨(-43), (-34)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-201810478), (-110869292)⟩, ⟨(-49387793), (-34335262)⟩, ⟨(-2718682), (-2270812)⟩, ⟨53966, 78493⟩, ⟨1607, 2086⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1229845287, 1320786474⟩, ⟨(-49387793), (-34335262)⟩, ⟨(-2718682), (-2270812)⟩, ⟨53966, 78493⟩, ⟨1607, 2086⟩⟩
...
def j70 : Jet := ⟨⟨(-157), (-87)⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11678, 11749⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9530, 17046⟩, ⟨3117, 4239⟩, ⟨244, 259⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842647), (-835130)⟩, ⟨3117, 4239⟩, ⟨244, 259⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1222503), (-681523)⟩, ⟨(-303083), (-221024)⟩, ⟨(-18056), (-17017)⟩, ⟨131, 191⟩, ⟨1, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34568891, 35109872⟩, ⟨(-303083), (-221024)⟩, ⟨(-18056), (-17017)⟩, ⟨131, 191⟩, ⟨1, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨28210574, 50936982⟩, ⟨8963814, 12553876⟩, ⟨647503, 721881⟩, ⟨(-13314), (-9361)⟩, ⟨(-375), (-306)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-687617309), (-664890900)⟩, ⟨8963814, 12553876⟩, ⟨647503, 721881⟩, ⟨(-13314), (-9361)⟩, ⟨(-375), (-306)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-997586960), (-542596361)⟩, ⟨(-242081657), (-162652439)⟩, ⟨(-12620530), (-9471569)⟩, ⟨360015, 538765⟩, ⟨9303, 13570⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3297380336, 3752370935⟩, ⟨(-242081657), (-162652439)⟩, ⟨(-12620530), (-9471569)⟩, ⟨360015, 538765⟩, ⟨9303, 13570⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1110999146, 1590869642⟩, ⟨125679586, 167841434⟩, ⟨(-10710485), (-7220917)⟩, ⟨(-360578), (-247351)⟩, ⟨9576, 14331⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4916023600, 5594363463⟩, ⟨213092799, 410717794⟩, ⟨21645651, 51565505⟩, ⟨672905, 4821011⟩, ⟨4601, 514173⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1271650665, 2072170144⟩, ⟨198974676, 370751242⟩, ⟨(-2116113), 26885250⟩, ⟨(-686427), 3159448⟩, ⟨(-131233), 348855⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1646690462), (-1235017845)⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2648276834, 3059949451⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨376509366, 999748965⟩, ⟨117824542, 357748780⟩, ⟨7176079, 57946452⟩, ⟨(-1027690), 7690238⟩, ⟨(-258387), 1050378⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4671476662, 5294716261⟩, ⟨117824542, 357748780⟩, ⟨7176079, 57946452⟩, ⟨(-1027690), 7690238⟩, ⟨(-258387), 1050378⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4479267740, 4768713997⟩, ⟨53059646, 171514565⟩, ⟨147185, 27466855⟩, ⟨(-1544431), 3685168⟩, ⟨(-349200), 562716⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2761916487, 3397470289⟩, ⟨(-195824042), (-92473353)⟩, ⟨(-8129082), 17025878⟩, ⟨(-2416680), 2618445⟩, ⟨(-425400), 474925⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6199151373, 8265535177⟩, ⟨1033191893, 1033191899⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8947560038, 15906773453⟩, ⟨2982520004, 3976693372⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8947560038, 15906773453⟩, ⟨2982520004, 3976693372⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15906773453), (-8947560038)⟩, ⟨(-3976693372), (-2982520004)⟩, ⟨(-248543337), (-248543333)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7953386727), (-4473780019)⟩, ⟨(-1988346686), (-1491260002)⟩, ⟨(-124271669), (-124271666)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨674119275, 1515599188⟩, ⟨(-701643672), (-234061645)⟩, ⟨(-3218339), 142907145⟩, ⟨(-17537929), 14030999⟩, ⟨(-3691362), 2076348⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨433498327, 1198892298⟩, ⟨(-624126823), (-165029611)⟩, ⟨(-374900), 151043267⟩, ⟨(-24023019), 13497745⟩, ⟨(-4408083), 3570982⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1440854153, 1440854154⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4595251793, 4595251803⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified262
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1235017845, 1646690462⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4479267740, 4768713997⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified263
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (72735759 / 4294967296)

theorem envelope_integral : (∫ s in ((5751 / 20000) : ℝ)..(1917 / 5000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((5751 / 20000) : ℝ)..(1917 / 5000), prawitzNormalCorrection
