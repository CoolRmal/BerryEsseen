...
namespace FiniteNormalPanel127_17
...
def j2 : Jet := ⟨⟨493237991, 493237995⟩, ⟨493237991, 493237995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨56643904, 56643906⟩, ⟨113287808, 113287812⟩, ⟨56643904, 56643906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1249), (-1248)⟩, ⟨(-2498), (-2496)⟩, ⟨(-1249), (-1246)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111807, 5111809⟩, ⟨(-2498), (-2496)⟩, ⟨(-1249), (-1246)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨67416, 67417⟩, ⟨134800, 134802⟩, ⟨67333, 67336⟩, ⟨(-66), (-63)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-143098161), (-143098159)⟩, ⟨134800, 134802⟩, ⟨67333, 67336⟩, ⟨(-66), (-63)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1887242), (-1887241)⟩, ⟨(-3772706), (-3772704)⟩, ⟨(-1882799), (-1882796)⟩, ⟨3552, 3555⟩, ⟨885, 888⟩⟩
...
def j19 : Jet := ⟨⟨1429768523, 1429768525⟩, ⟨(-3772706), (-3772704)⟩, ⟨(-1882799), (-1882796)⟩, ⟨3552, 3555⟩, ⟨885, 888⟩⟩
...
def j25 : Jet := ⟨⟨156, 157⟩, ⟨311, 313⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852021), (-852019)⟩, ⟨311, 313⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11237), (-11236)⟩, ⟨(-22470), (-22468)⟩, ⟨(-11227), (-11224)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35780157, 35780159⟩, ⟨(-22470), (-22468)⟩, ⟨(-11227), (-11224)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨471884, 471885⟩, ⟨943471, 943473⟩, ⟨471142, 471145⟩, ⟨(-594), (-591)⟩, ⟨(-149), (-146)⟩⟩
...
def j33 : Jet := ⟨⟨(-715355999), (-715355997)⟩, ⟨943471, 943473⟩, ⟨471142, 471145⟩, ⟨(-594), (-591)⟩, ⟨(-149), (-146)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9434428), (-9434427)⟩, ⟨(-18856414), (-18856411)⟩, ⟨(-9403330), (-9403327)⟩, ⟨24861, 24864⟩, ⟨6195, 6198⟩⟩
...
def j36 : Jet := ⟨⟨4285532868, 4285532869⟩, ⟨(-18856414), (-18856411)⟩, ⟨(-9403330), (-9403327)⟩, ⟨24861, 24864⟩, ⟨6195, 6198⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨164195931, 164195933⟩, ⟨163762669, 163762673⟩, ⟨(-649485), (-649482)⟩, ⟨(-215816), (-215813)⟩, ⟨508, 511⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304422492, 4304422494⟩, ⟨18939525, 18939530⟩, ⟨9528108, 9528114⟩, ⟨58505, 58512⟩, ⟨14826, 14834⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨164557401, 164557404⟩, ⟨164847240, 164847246⟩, ⟨435487, 435493⟩, ⟨146375, 146383⟩, ⟨912, 922⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-157002530), (-157002529)⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4137964766, 4137964767⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6304853, 6304854⟩, ⟨12631916, 12631918⟩, ⟨6360452, 6360455⟩, ⟨44644, 44648⟩, ⟨11348, 11355⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301272149, 4301272150⟩, ⟨12631916, 12631918⟩, ⟨6360452, 6360455⟩, ⟨44644, 44648⟩, ⟨11348, 11355⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298118566, 4298118567⟩, ⟨6311327, 6311329⟩, ⟨3173260, 3173263⟩, ⟨17645, 17649⟩, ⟨4472, 4478⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4141000841, 4141000844⟩, ⟨(-151037109), (-151037104)⟩, ⟨2826550, 2826555⟩, ⟨(-99000), (-98994)⟩, ⟨3662, 3670⟩⟩
...
def j47 : Jet := ⟨⟨1284069084, 1284069094⟩, ⟨1284069084, 1284069094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨383898944, 383898951⟩, ⟨767797888, 767797902⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨383898944, 383898951⟩, ⟨767797888, 767797902⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-383898951), (-383898944)⟩, ⟨(-767797902), (-767797888)⟩, ⟨(-383898951), (-383898944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-191949476), (-191949472)⟩, ⟨(-383898951), (-383898944)⟩, ⟨(-191949476), (-191949472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4107243905, 4107243910⟩, ⟨(-367119590), (-367119581)⟩, ⟨(-167152590), (-167152584)⟩, ⟨15918360, 15918362⟩, ⟨3379458, 3379460⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3960006978, 3960006987⟩, ⟨(-498394664), (-498394648)⟩, ⟨(-145547328), (-145547313)⟩, ⟨20889536, 20889548⟩, ⟨2600480, 2600496⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 314005060⟩, ⟨157002529, 157002530⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 986475990⟩, ⟨493237991, 493237995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 226575621⟩, ⟨0, 226575622⟩, ⟨56643904, 56643906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 57⟩, ⟨0, 57⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94629)⟩, ⟨0, 57⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4996), 0⟩, ⟨(-4996), 4⟩, ⟨(-1249), (-1243)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108060, 5113057⟩, ⟨(-4996), 4⟩, ⟨(-1249), (-1243)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 269733⟩, ⟨(-264), 269734⟩, ⟨67037, 67435⟩, ⟨(-132), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142895843)⟩, ⟨(-264), 269734⟩, ⟨67037, 67435⟩, ⟨(-132), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7552521), 0⟩, ⟨(-7552535), 14230⟩, ⟨(-1888145), (-1866784)⟩, ⟨(-11), 7117⟩, ⟨876, 891⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424103244, 1431655766⟩, ⟨(-7552535), 14230⟩, ⟨(-1888145), (-1866784)⟩, ⟨(-11), 7117⟩, ⟨876, 891⟩⟩
...
def j72 : Jet := ⟨⟨0, 625⟩, ⟨(-1), 625⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851551)⟩, ⟨(-1), 625⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-44956), 0⟩, ⟨(-44957), 33⟩, ⟨(-11240), (-11188)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35746438, 35791395⟩, ⟨(-44957), 33⟩, ⟨(-11240), (-11188)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1888131⟩, ⟨(-2372), 1888133⟩, ⟨468474, 472035⟩, ⟨(-1187), 2⟩, ⟨(-150), (-145)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713939751)⟩, ⟨(-2372), 1888133⟩, ⟨468474, 472035⟩, ⟨(-1187), 2⟩, ⟨(-150), (-145)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-37762604), 0⟩, ⟨(-37762730), 99607⟩, ⟨(-9440778), (-9291240)⟩, ⟨(-95), 49805⟩, ⟨6107, 6227⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4257204692, 4294967296⟩, ⟨(-37762730), 99607⟩, ⟨(-9440778), (-9291240)⟩, ⟨(-95), 49805⟩, ⟨6107, 6227⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 328825331⟩, ⟨161810644, 164415935⟩, ⟨(-1301014), 1635⟩, ⟨(-216840), (-212748)⟩, ⟨(-2), 1023⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4333064865⟩, ⟨(-101383), 38435635⟩, ⟨9290348, 9949943⟩, ⟨(-51151), 173593⟩, ⟨12918, 17447⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 331742105⟩, ⟨161802882, 168817007⟩, ⟨(-1316437), 2234782⟩, ⟨115684, 181469⟩, ⟨(-6917), 9025⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-314005060), 0⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3980962236, 4294967296⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 25623670⟩, ⟨0, 26078760⟩, ⟨5892182, 6980711⟩, ⟨(-103488), 203714⟩, ⟨6961, 16825⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4320590966⟩, ⟨0, 26078760⟩, ⟨5892182, 6980711⟩, ⟨(-103488), 203714⟩, ⟨6961, 16825⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307760080⟩, ⟨0, 13039380⟩, ⟨2917606, 3490356⟩, ⟨(-62341), 101857⟩, ⟨1746, 7612⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3980962236, 4307760080⟩, ⟨(-157470171), (-143963149)⟩, ⟨2227644, 3490356⟩, ⟨(-189931), (-4796)⟩, ⟨(-2106), 9891⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2568138187⟩, ⟨1284069084, 1284069094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1535595802⟩, ⟨0, 1535595804⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1535595802⟩, ⟨0, 1535595804⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1535595802), 0⟩, ⟨(-1535595804), 0⟩, ⟨(-383898951), (-383898944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-767797901), 0⟩, ⟨(-767797902), 0⟩, ⟨(-191949476), (-191949472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3591884737, 4294967296⟩, ⟨(-767797902), 0⟩, ⟨(-191949476), (-91899085)⟩, ⟨0, 34314209⟩, ⟨520002, 4289277⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3329282043, 4307760080⟩, ⟨(-927555000), (-120396501)⟩, ⟨(-190658228), (-53539534)⟩, ⟨2266476, 41450019⟩, ⟨(-934206), 4298234⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298118566, 4298118567⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2562
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307760080⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2563
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (71507993 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(7311 / 100000), prawitzNormalCorrection
