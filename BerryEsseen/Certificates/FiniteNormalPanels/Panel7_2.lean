...
namespace FiniteNormalPanel7_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (5459 / 50000)
def radius : Rat := (5459 / 50000)

def j0 : Jet := ⟨⟨468924529, 468924530⟩, ⟨468924529, 468924530⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1473169855, 1473169859⟩, ⟨1473169855, 1473169859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨505295913, 505295916⟩, ⟨1010591826, 1010591832⟩, ⟨505295913, 505295916⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨126, 127⟩, ⟨252, 254⟩, ⟨126, 127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94561), (-94559)⟩, ⟨252, 254⟩, ⟨126, 127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11125), (-11124)⟩, ⟨(-22221), (-22219)⟩, ⟨(-11052), (-11049)⟩, ⟨58, 60⟩, ⟨14, 15⟩⟩
...
def j13 : Jet := ⟨⟨5101931, 5101933⟩, ⟨(-22221), (-22219)⟩, ⟨(-11052), (-11049)⟩, ⟨58, 60⟩, ⟨14, 15⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨600233, 600235⟩, ⟨1197852, 1197855⟩, ⟨593703, 593708⟩, ⟨(-5210), (-5205)⟩, ⟨(-1287), (-1282)⟩⟩
...
def j16 : Jet := ⟨⟨(-142565344), (-142565341)⟩, ⟨1197852, 1197855⟩, ⟨593703, 593708⟩, ⟨(-5210), (-5205)⟩, ⟨(-1287), (-1282)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16772581), (-16772580)⟩, ⟨(-33404237), (-33404234)⟩, ⟨(-16420883), (-16420879)⟩, ⟨280008, 280012⟩, ⟨68470, 68475⟩⟩
...
def j19 : Jet := ⟨⟨1414883184, 1414883186⟩, ⟨(-33404237), (-33404234)⟩, ⟨(-16420883), (-16420879)⟩, ⟨280008, 280012⟩, ⟨68470, 68475⟩⟩
...
def j22 : Jet := ⟨⟨(-13), (-12)⟩, ⟨(-26), (-25)⟩, ⟨(-13), (-12)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11822, 11824⟩, ⟨(-26), (-25)⟩, ⟨(-13), (-12)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1390, 1392⟩, ⟨2777, 2781⟩, ⟨1381, 1386⟩, ⟨(-8), (-4)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850787), (-850784)⟩, ⟨2777, 2781⟩, ⟨1381, 1386⟩, ⟨(-8), (-4)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-100094), (-100093)⟩, ⟨(-199862), (-199858)⟩, ⟨(-99279), (-99274)⟩, ⟨649, 655⟩, ⟨159, 164⟩⟩
...
def j30 : Jet := ⟨⟨35691300, 35691302⟩, ⟨(-199862), (-199858)⟩, ⟨(-99279), (-99274)⟩, ⟨649, 655⟩, ⟨159, 164⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4199023, 4199024⟩, ⟨8374532, 8374536⟩, ⟨4140315, 4140320⟩, ⟨(-46799), (-46792)⟩, ⟨(-11511), (-11504)⟩⟩
...
def j33 : Jet := ⟨⟨(-711628860), (-711628858)⟩, ⟨8374532, 8374536⟩, ⟨4140315, 4140320⟩, ⟨(-46799), (-46792)⟩, ⟨(-11511), (-11504)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-83721978), (-83721977)⟩, ⟨(-166458706), (-166458703)⟩, ⟨(-81264377), (-81264373)⟩, ⟨1953946, 1953950⟩, ⟨474734, 474739⟩⟩
...
def j36 : Jet := ⟨⟨4211245318, 4211245319⟩, ⟨(-166458706), (-166458703)⟩, ⟨(-81264377), (-81264373)⟩, ⟨1953946, 1953950⟩, ⟨474734, 474739⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨485303638, 485303641⟩, ⟨473846015, 473846020⟩, ⟨(-17089971), (-17089967)⟩, ⟨(-5536306), (-5536302)⟩, ⟨119527, 119531⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4380353714, 4380353716⟩, ⟨173143082, 173143087⟩, ⟨91371515, 91371522⟩, ⟨4920385, 4920394⟩, ⟨1383543, 1383555⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨494951753, 494951757⟩, ⟨502830398, 502830406⟩, ⟨11996823, 11996832⟩, ⟨4301293, 4301303⟩, ⟨234319, 234330⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-468924530), (-468924529)⟩, ⟨(-468924530), (-468924529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3826042766, 3826042767⟩, ⟨(-468924530), (-468924529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨57038207, 57038209⟩, ⟨115892284, 115892288⟩, ⟨61633555, 61633562⟩, ⟨3800398, 3800408⟩, ⟨1094653, 1094666⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4352005503, 4352005505⟩, ⟨115892284, 115892288⟩, ⟨61633555, 61633562⟩, ⟨3800398, 3800408⟩, ⟨1094653, 1094666⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4323392337, 4323392339⟩, ⟨57565163, 57565166⟩, ⟨30230931, 30230936⟩, ⟨1485185, 1485192⟩, ⟨418258, 418267⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3851364361, 3851364364⟩, ⟨(-420747779), (-420747772)⟩, ⟨20645352, 20645359⟩, ⟨(-1977582), (-1977574)⟩, ⟨210438, 210449⟩⟩
...
def j47 : Jet := ⟨⟨1777963585, 1777963591⟩, ⟨1777963585, 1777963591⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨736013639, 736013645⟩, ⟨1472027278, 1472027290⟩, ⟨736013639, 736013645⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨736013639, 736013645⟩, ⟨1472027278, 1472027290⟩, ⟨736013639, 736013645⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-736013645), (-736013639)⟩, ⟨(-1472027290), (-1472027278)⟩, ⟨(-736013645), (-736013639)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-368006823), (-368006819)⟩, ⟨(-736013645), (-736013639)⟩, ⟨(-368006823), (-368006819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3942285674, 3942285679⟩, ⟨(-675575820), (-675575813)⟩, ⟨(-279902370), (-279902363)⟩, ⟨54578992, 54578995⟩, ⟨9653220, 9653222⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3535109233, 3535109241⟩, ⟨(-991997446), (-991997430)⟩, ⟨(-165861361), (-165861345)⟩, ⟨71299303, 71299319⟩, ⟨2468236, 2468254⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 937849059⟩, ⟨468924529, 468924530⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2946339715⟩, ⟨1473169855, 1473169859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 2021183660⟩, ⟨0, 2021183662⟩, ⟨505295913, 505295916⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 507⟩, ⟨0, 507⟩, ⟨126, 127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94179)⟩, ⟨0, 507⟩, ⟨126, 127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-44560), 0⟩, ⟨(-44560), 239⟩, ⟨(-11140), (-10781)⟩, ⟨0, 120⟩, ⟨14, 15⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5068496, 5113057⟩, ⟨(-44560), 239⟩, ⟨(-11140), (-10781)⟩, ⟨0, 120⟩, ⟨14, 15⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2406172⟩, ⟨(-20970), 2406285⟩, ⟨570087, 601656⟩, ⟨(-10486), 86⟩, ⟨(-1311), (-1203)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-140759404)⟩, ⟨(-20970), 2406285⟩, ⟨570087, 601656⟩, ⟨(-10486), 86⟩, ⟨(-1311), (-1203)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-67372789), 0⟩, ⟨(-67382658), 1132383⟩, ⟨(-16853067), (-15144595)⟩, ⟨(-7403), 566273⟩, ⟨61517, 70825⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1364282976, 1431655766⟩, ⟨(-67382658), 1132383⟩, ⟨(-16853067), (-15144595)⟩, ⟨(-7403), 566273⟩, ⟨61517, 70825⟩⟩
...
def j70 : Jet := ⟨⟨(-51), 0⟩, ⟨(-51), 0⟩, ⟨(-13), (-12)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11784, 11836⟩, ⟨(-51), 0⟩, ⟨(-13), (-12)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 5570⟩, ⟨(-25), 5570⟩, ⟨1354, 1393⟩, ⟨(-14), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-846606)⟩, ⟨(-25), 5570⟩, ⟨1354, 1393⟩, ⟨(-14), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-401029), 0⟩, ⟨(-401041), 2622⟩, ⟨(-100270), (-96323)⟩, ⟨(-10), 1312⟩, ⟨151, 164⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35390365, 35791395⟩, ⟨(-401041), 2622⟩, ⟨(-100270), (-96323)⟩, ⟨(-10), 1312⟩, ⟨151, 164⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 16843198⟩, ⟨(-188728), 16844432⟩, ⟨3927703, 4212034⟩, ⟨(-94374), 927⟩, ⟨(-11802), (-10636)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-698984684)⟩, ⟨(-188728), 16844432⟩, ⟨3927703, 4212034⟩, ⟨(-94374), 927⟩, ⟨(-11802), (-10636)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-336863944), 0⟩, ⟨(-336952759), 7926881⟩, ⟨(-84304802), (-72325373)⟩, ⟨(-66616), 3964314⟩, ⟨412121, 495976⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3958103352, 4294967296⟩, ⟨(-336952759), 7926881⟩, ⟨(-84304802), (-72325373)⟩, ⟨(-66616), 3964314⟩, ⟨412121, 495976⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 982113239⟩, ⟨421723432, 491833433⟩, ⟨(-34673365), 388407⟩, ⟨(-5785666), (-4806119)⟩, ⟨(-2540), 242818⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4660500860⟩, ⟨(-9333571), 396747757⟩, ⟨71593127, 133040452⟩, ⟨(-5133054), 19854600⟩, ⟨(-110139), 4086042⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 1065698358⟩, ⟨419589161, 624414852⟩, ⟨(-38693150), 76276431⟩, ⟨(-3625041), 15044287⟩, ⟨(-2224241), 3496058⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-937849059), 0⟩, ⟨(-468924530), (-468924529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3357118237, 4294967296⟩, ⟨(-468924530), (-468924529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 264428787⟩, ⟨0, 309868662⟩, ⟨21789363, 128631770⟩, ⟨(-13049590), 29644376⟩, ⟨(-2845001), 7463933⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4559396083⟩, ⟨0, 309868662⟩, ⟨21789363, 128631770⟩, ⟨(-13049590), 29644376⟩, ⟨(-2845001), 7463933⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4425207009⟩, ⟨0, 154934331⟩, ⟨7861773, 64315885⟩, ⟨(-8844892), 14822188⟩, ⟨(-2438745), 4043838⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3357118237, 4425207009⟩, ⟨(-483144102), (-313990198)⟩, ⟨(-10770655), 64315885⟩, ⟨(-15866901), 13963840⟩, ⟨(-4057032), 5009524⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3555927177⟩, ⟨1777963585, 1777963591⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2944054569⟩, ⟨0, 2944054574⟩, ⟨736013639, 736013645⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2944054569⟩, ⟨0, 2944054574⟩, ⟨736013639, 736013645⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2944054569), 0⟩, ⟨(-2944054574), 0⟩, ⟨(-736013645), (-736013639)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1472027285), 0⟩, ⟨(-1472027287), 0⟩, ⟨(-368006823), (-368006819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3048686613, 4294967296⟩, ⟨(-1472027287), 0⟩, ⟨(-368006823), (-8965212)⟩, ⟨0, 126128105⟩, ⟨(-10422984), 15766014⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2382975404, 4425207009⟩, ⟨(-1999808845), (-222878929)⟩, ⟨(-389936842), 222897774⟩, ⟨(-37254667), 189005453⟩, ⟨(-39280993), 27614601⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨468924529, 468924530⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨468924529, 468924530⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4323392337, 4323392339⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified132
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 937849059⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4425207009⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified133
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (761059945 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(5459 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(5459 / 25000), prawitzNormalCorrection
