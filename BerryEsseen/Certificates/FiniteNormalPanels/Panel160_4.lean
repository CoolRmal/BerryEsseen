...
namespace FiniteNormalPanel160_4

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (179403 / 800000)
def radius : Rat := (25629 / 800000)

def j0 : Jet := ⟨⟨963162522, 963162523⟩, ⟨137594646, 137594647⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3025864303, 3025864307⟩, ⟨432266329, 432266333⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2131763561, 2131763568⟩, ⟨609075302, 609075310⟩, ⟨43505378, 43505380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨533, 535⟩, ⟨152, 153⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94154), (-94151)⟩, ⟨152, 153⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-46733), (-46730)⟩, ⟨(-13278), (-13275)⟩, ⟨(-929), (-925)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5066323, 5066327⟩, ⟨(-13278), (-13275)⟩, ⟨(-929), (-925)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2514618, 2514621⟩, ⟨711871, 711875⟩, ⟨48973, 48978⟩, ⟨(-267), (-263)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140650959), (-140650955)⟩, ⟨711871, 711875⟩, ⟨48973, 48978⟩, ⟨(-267), (-263)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-69810681), (-69810678)⟩, ⟨(-19592580), (-19592576)⟩, ⟨(-1299450), (-1299445)⟩, ⟨14021, 14027⟩, ⟨453, 457⟩⟩
...
def j19 : Jet := ⟨⟨1361845084, 1361845088⟩, ⟨(-19592580), (-19592576)⟩, ⟨(-1299450), (-1299445)⟩, ⟨14021, 14027⟩, ⟨453, 457⟩⟩
...
def j22 : Jet := ⟨⟨(-54), (-53)⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11781, 11783⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5847, 5849⟩, ⟨1662, 1664⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846330), (-846327)⟩, ⟨1662, 1664⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-420068), (-420065)⟩, ⟨(-119196), (-119192)⟩, ⟨(-8281), (-8277)⟩, ⟨31, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35371326, 35371330⟩, ⟨(-119196), (-119192)⟩, ⟨(-8281), (-8277)⟩, ⟨31, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17556199, 17556202⟩, ⟨4956895, 4956899⟩, ⟨337274, 337280⟩, ⟨(-2368), (-2363)⟩, ⟨(-81), (-77)⟩⟩
...
def j33 : Jet := ⟨⟨(-698271684), (-698271680)⟩, ⟨4956895, 4956899⟩, ⟨337274, 337280⟩, ⟨(-2368), (-2363)⟩, ⟨(-81), (-77)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-346580087), (-346580083)⟩, ⟨(-96562579), (-96562573)⟩, ⟨(-6202718), (-6202711)⟩, ⟨96863, 96870⟩, ⟨3039, 3044⟩⟩
...
def j36 : Jet := ⟨⟨3948387209, 3948387213⟩, ⟨(-96562579), (-96562573)⟩, ⟨(-6202718), (-6202711)⟩, ⟨96863, 96870⟩, ⟨3039, 3044⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨959438836, 959438841⟩, ⟨123259444, 123259451⟩, ⟨(-2887374), (-2887368)⟩, ⟨(-120906), (-120899)⟩, ⟨1730, 1734⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4671969358, 4671969364⟩, ⟨114258647, 114258656⟩, ⟨10133752, 10133764⟩, ⟨312703, 312716⟩, ⟨17158, 17172⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1043656105, 1043656113⟩, ⟨159602735, 159602746⟩, ⟨2401985, 2401996⟩, ⟨152345, 152359⟩, ⟨4657, 4670⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-963162523), (-963162522)⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3331804773, 3331804774⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨253603343, 253603348⟩, ⟨77565372, 77565380⟩, ⟨7098242, 7098252⟩, ⟨252554, 252566⟩, ⟨14927, 14938⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4548570639, 4548570644⟩, ⟨77565372, 77565380⟩, ⟨7098242, 7098252⟩, ⟨252554, 252566⟩, ⟨14927, 14938⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4419950467, 4419950471⟩, ⟨37686025, 37686030⟩, ⟨3288100, 3288106⟩, ⟨94670, 94677⟩, ⟨5221, 5229⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3428759999, 3428760004⟩, ⟨(-112363848), (-112363841)⟩, ⟨1343411, 1343418⟩, ⟨(-31900), (-31892)⟩, ⟨1016, 1025⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨45570789807, 45570789815⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value650

def j47 : Jet := ⟨⟨10219420501, 10219420515⟩, ⟨1459917214, 1459917226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨24316030409, 24316030476⟩, ⟨6947437256, 6947437326⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨24316030409, 24316030476⟩, ⟨6947437256, 6947437326⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-24316030476), (-24316030409)⟩, ⟨(-6947437326), (-6947437256)⟩, ⟨(-496245527), (-496245518)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12158015238), (-12158015204)⟩, ⟨(-3473718663), (-3473718628)⟩, ⟨(-248122764), (-248122759)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨253266096, 253266102⟩, ⟨(-204838623), (-204838615)⟩, ⟨68204191, 68204197⟩, ⟨(-10498486), (-10498482)⟩, ⟨152663, 152666⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨202187490, 202187496⟩, ⟨(-170152736), (-170152727)⟩, ⟨59886949, 59886958⟩, ⟨(-10231451), (-10231442)⟩, ⟨419444, 419453⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨825567876, 1100757169⟩, ⟨137594646, 137594647⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2593597974, 3458130636⟩, ⟨432266329, 432266333⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1566193637, 2784344251⟩, ⟨522064544, 696086070⟩, ⟨43505378, 43505380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨392, 698⟩, ⟨130, 175⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94295), (-93988)⟩, ⟨130, 175⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-61130), (-34273)⟩, ⟨(-15236), (-11310)⟩, ⟨(-938), (-915)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5051926, 5078784⟩, ⟨(-15236), (-11310)⟩, ⟨(-938), (-915)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1842224, 3292478⟩, ⟨604196, 818996⟩, ⟨48093, 49738⟩, ⟨(-308), (-222)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141323353), (-139873098)⟩, ⟨604196, 818996⟩, ⟨48093, 49738⟩, ⟨(-308), (-222)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-91617198), (-51005826)⟩, ⟨(-22683976), (-16471002)⟩, ⟨(-1340541), (-1251848)⟩, ⟨11765, 16278⟩, ⟨430, 476⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1340038567, 1380649940⟩, ⟨(-22683976), (-16471002)⟩, ⟨(-1340541), (-1251848)⟩, ⟨11765, 16278⟩, ⟨430, 476⟩⟩
...
def j72 : Jet := ⟨⟨4289, 7648⟩, ⟨1417, 1908⟩, ⟨114, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847888), (-844528)⟩, ⟨1417, 1908⟩, ⟨114, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-549670), (-307963)⟩, ⟨(-136902), (-101417)⟩, ⟨(-8376), (-8166)⟩, ⟨25, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35241724, 35483432⟩, ⟨(-136902), (-101417)⟩, ⟨(-8376), (-8166)⟩, ⟨25, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12851172, 23003223⟩, ⟨4194973, 5713824⟩, ⟨329358, 344122⟩, ⟨(-2736), (-1993)⟩, ⟨(-83), (-73)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702976711), (-692824659)⟩, ⟨4194973, 5713824⟩, ⟨329358, 344122⟩, ⟨(-2736), (-1993)⟩, ⟨(-83), (-73)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-455726210), (-252643966)⟩, ⟨(-112401825), (-80510493)⟩, ⟨(-6490712), (-5868758)⟩, ⟨80752, 112924⟩, ⟨2838, 3218⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3839241086, 4042323330⟩, ⟨(-112401825), (-80510493)⟩, ⟨(-6490712), (-5868758)⟩, ⟨80752, 112924⟩, ⟨2838, 3218⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨809207864, 1111642424⟩, ⟨116603774, 129008977⟩, ⟨(-3362375), (-2413673)⟩, ⟨(-127815), (-112885)⟩, ⟨1443, 2023⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4563401432, 4804789192⟩, ⟨90888746, 140670270⟩, ⟨8435493, 12241509⟩, ⟨165737, 500236⟩, ⟨7791, 30059⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨859783106, 1243596782⟩, ⟨141015676, 180731524⟩, ⟨295352, 4829224⟩, ⟨7127, 326159⟩, ⟨(-6272), 17943⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1100757169), (-825567876)⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3194210127, 3469399420⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨172114695, 360080264⟩, ⟨56458122, 104660700⟩, ⟨4748183, 10401734⟩, ⟨22246, 595304⟩, ⟨(-3148), 43272⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4467081991, 4655047560⟩, ⟨56458122, 104660700⟩, ⟨4748183, 10401734⟩, ⟨22246, 595304⟩, ⟨(-3148), 43272⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4380179341, 4471384242⟩, ⟨27115292, 51312315⟩, ⟨1985999, 5015762⟩, ⟨(-47852), 279568⟩, ⟨(-7692), 21326⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3257583176, 3611905942⟩, ⟨(-123080472), (-98875329)⟩, ⟨(-166848), 3182973⟩, ⟨(-199342), 162208⟩, ⟨(-15171), 18760⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8759503287, 11679337730⟩, ⟨1459917214, 1459917226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17864838669, 31759713267⟩, ⟨5954946220, 7939928370⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17864838669, 31759713267⟩, ⟨5954946220, 7939928370⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-31759713267), (-17864838669)⟩, ⟨(-7939928370), (-5954946220)⟩, ⟨(-496245527), (-496245518)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15879856634), (-8932419334)⟩, ⟨(-3969964185), (-2977473110)⟩, ⟨(-248122764), (-248122759)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨106471992, 536710202⟩, ⟨(-496096975), (-73811386)⟩, ⟨(-5421302), 223127541⟩, ⟨(-65905025), 20776898⟩, ⟨(-11246279), 15386083⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨80755299, 451353092⟩, ⟨(-432579350), (-58434479)⟩, ⟨(-2880735), 202256228⟩, ⟨(-62210359), 17667491⟩, ⟨(-10082401), 15018483⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨963162522, 963162523⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨137594646, 137594647⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4419950467, 4419950471⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar650 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3230
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar650 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨825567876, 1100757169⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4380179341, 4471384242⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3231
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((76887 / 400000) : ℝ)..(25629 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (76887 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (25629 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((76887 / 400000) : ℝ)..(25629 / 100000), prawitzNormalCorrection
      ((257337 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
