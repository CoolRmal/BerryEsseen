...
namespace FiniteNormalPanel72_22
...
def j2 : Jet := ⟨⟨1715909604, 1715909608⟩, ⟨571969866, 571969870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨685533920, 685533924⟩, ⟨457022612, 457022618⟩, ⟨76170435, 76170437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨171, 172⟩, ⟨114, 115⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94516), (-94514)⟩, ⟨114, 115⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-15087), (-15085)⟩, ⟨(-10040), (-10038)⟩, ⟨(-1662), (-1659)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097969, 5097972⟩, ⟨(-10040), (-10038)⟩, ⟨(-1662), (-1659)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨813703, 813705⟩, ⟨540866, 540868⟩, ⟨89076, 89080⟩, ⟨(-356), (-353)⟩, ⟨(-30), (-27)⟩⟩
...
def j16 : Jet := ⟨⟨(-142351874), (-142351871)⟩, ⟨540866, 540868⟩, ⟨89076, 89080⟩, ⟨(-356), (-353)⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-22721254), (-22721252)⟩, ⟨(-15061174), (-15061171)⟩, ⟨(-2452815), (-2452810)⟩, ⟨19013, 19016⟩, ⟨1536, 1539⟩⟩
...
def j19 : Jet := ⟨⟨1408934511, 1408934514⟩, ⟨(-15061174), (-15061171)⟩, ⟨(-2452815), (-2452810)⟩, ⟨19013, 19016⟩, ⟨1536, 1539⟩⟩
...
def j25 : Jet := ⟨⟨1886, 1887⟩, ⟨1255, 1257⟩, ⟨206, 209⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850291), (-850289)⟩, ⟨1255, 1257⟩, ⟨206, 209⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-135718), (-135717)⟩, ⟨(-90279), (-90277)⟩, ⟨(-14915), (-14911)⟩, ⟨42, 46⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35655676, 35655678⟩, ⟨(-90279), (-90277)⟩, ⟨(-14915), (-14911)⟩, ⟨42, 46⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5691120, 5691121⟩, ⟨3779670, 3779672⟩, ⟨620358, 620362⟩, ⟨(-3184), (-3179)⟩, ⟨(-261), (-258)⟩⟩
...
def j33 : Jet := ⟨⟨(-710136763), (-710136761)⟩, ⟨3779670, 3779672⟩, ⟨620358, 620362⟩, ⟨(-3184), (-3179)⟩, ⟨(-261), (-258)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-113347276), (-113347274)⟩, ⟨(-74961566), (-74961563)⟩, ⟨(-12092935), (-12092931)⟩, ⟨132533, 132538⟩, ⟨10620, 10624⟩⟩
...
def j36 : Jet := ⟨⟨4181620020, 4181620022⟩, ⟨(-74961566), (-74961563)⟩, ⟨(-12092935), (-12092931)⟩, ⟨132533, 132538⟩, ⟨10620, 10624⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨562892355, 562892359⟩, ⟨181613598, 181613604⟩, ⟨(-2985669), (-2985664)⟩, ⟨(-319051), (-319047)⟩, ⟨3145, 3148⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4411386968, 4411386971⟩, ⟨79080466, 79080471⟩, ⟨14175029, 14175037⟩, ⟨342980, 342989⟩, ⟨33426, 33435⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨578150152, 578150158⟩, ⟨196900602, 196900611⟩, ⟨2135094, 2135103⟩, ⟨261670, 261679⟩, ⟨6383, 6393⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-546190992), (-546190991)⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3748776304, 3748776305⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨77825411, 77825414⟩, ⟨53010002, 53010006⟩, ⟨9601622, 9601628⟩, ⟨266210, 266216⟩, ⟨26771, 26778⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4372792707, 4372792710⟩, ⟨53010002, 53010006⟩, ⟨9601622, 9601628⟩, ⟨266210, 266216⟩, ⟨26771, 26778⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4333705304, 4333705307⟩, ⟨26268078, 26268081⟩, ⟨4678287, 4678292⟩, ⟨103557, 103562⟩, ⟨10112, 10118⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3782587999, 3782588004⟩, ⟨(-160778203), (-160778197)⟩, ⟨2969845, 2969851⟩, ⟨(-107926), (-107919)⟩, ⟨4436, 4443⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨26864704774, 26864704780⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value365

def j47 : Jet := ⟨⟨3416384505, 3416384513⟩, ⟨1138794831, 1138794838⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2717525485, 2717525499⟩, ⟨1811683650, 1811683666⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2717525485, 2717525499⟩, ⟨1811683650, 1811683666⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2717525499), (-2717525485)⟩, ⟨(-1811683666), (-1811683650)⟩, ⟨(-301947278), (-301947274)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1358762750), (-1358762742)⟩, ⟨(-905841833), (-905841825)⟩, ⟨(-150973639), (-150973637)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3130154406, 3130154417⟩, ⟨(-660173785), (-660173776)⟩, ⟨(-40411087), (-40411082)⟩, ⟨18311642, 18311644⟩, ⟨(-255267), (-255265)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2756734492, 2756734507⟩, ⟨(-698591127), (-698591112)⟩, ⟨(-8712727), (-8712713)⟩, ⟨17104710, 17104722⟩, ⟨(-918419), (-918405)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨364127327, 728254655⟩, ⟨182063663, 182063664⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1143939735, 2287879475⟩, ⟨571969866, 571969870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨304681741, 1218726974⟩, ⟨304681740, 609363488⟩, ⟨76170435, 76170437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨76, 306⟩, ⟨76, 153⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94611), (-94380)⟩, ⟨76, 153⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-26847), (-6695)⟩, ⟨(-13419), (-6651)⟩, ⟨(-1672), (-1645)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5086209, 5106362⟩, ⟨(-13419), (-6651)⟩, ⟨(-1672), (-1645)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨360811, 1448966⟩, ⟨357003, 724012⟩, ⟨87823, 89974⟩, ⟨(-476), (-231)⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142804766), (-141716610)⟩, ⟨357003, 724012⟩, ⟨87823, 89974⟩, ⟨(-476), (-231)⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-40521850), (-10053269)⟩, ⟨(-20235601), (-9847825)⟩, ⟨(-2501061), (-2385064)⟩, ⟨12425, 25591⟩, ⟨1480, 1579⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1391133915, 1421602497⟩, ⟨(-20235601), (-9847825)⟩, ⟨(-2501061), (-2385064)⟩, ⟨12425, 25591⟩, ⟨1480, 1579⟩⟩
...
def j70 : Jet := ⟨⟨(-31), (-7)⟩, ⟨(-16), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11804, 11829⟩, ⟨(-16), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨837, 3357⟩, ⟨832, 1679⟩, ⟨205, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851340), (-848819)⟩, ⟨832, 1679⟩, ⟨205, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-241574), (-60214)⟩, ⟨(-120728), (-59737)⟩, ⟨(-15026), (-14754)⟩, ⟨27, 60⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35549820, 35731181⟩, ⟨(-120728), (-59737)⟩, ⟨(-15026), (-14754)⟩, ⟨27, 60⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2521877, 10138973⟩, ⟨2487619, 5065250⟩, ⟨609076, 628403⟩, ⟨(-4273), (-2087)⟩, ⟨(-266), (-250)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713306006), (-705688909)⟩, ⟨2487619, 5065250⟩, ⟨609076, 628403⟩, ⟨(-4273), (-2087)⟩, ⟨(-266), (-250)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-202405563), (-50061039)⟩, ⟨(-101026313), (-48623737)⟩, ⟨(-12430672), (-11618294)⟩, ⟨86111, 178841⟩, ⟨10118, 10980⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4092561733, 4244906257⟩, ⟨(-101026313), (-48623737)⟩, ⟨(-12430672), (-11618294)⟩, ⟨86111, 178841⟩, ⟨10118, 10980⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨370520484, 757271232⟩, ⟨174480970, 186694898⟩, ⟨(-4027105), (-1946703)⟩, ⟨(-329763), (-303991)⟩, ⟨2048, 4251⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4345618714, 4507383218⟩, ⟨49777358, 111266327⟩, ⟨12464122, 16437292⟩, ⟨89111, 652285⟩, ⟨18784, 54240⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨374890107, 794723547⟩, ⟨180832878, 215546284⟩, ⟨(-1128832), 5765055⟩, ⟨63634, 499374⟩, ⟨(-16644), 33208⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-728254655), (-364127327)⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3566712641, 3930839969⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨32722622, 147052463⟩, ⟨31568322, 79767644⟩, ⟨7195935, 12950845⟩, ⟨(-102196), 763454⟩, ⟨(-2318), 70153⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4327689918, 4442019759⟩, ⟨31568322, 79767644⟩, ⟨7195935, 12950845⟩, ⟨(-102196), 763454⟩, ⟨(-2318), 70153⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4311297561, 4367874723⟩, ⟨15520695, 39732751⟩, ⟨3357194, 6422958⟩, ⟨(-110099), 368197⟩, ⟨(-9334), 34652⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3580273946, 3997566305⟩, ⟨(-172265205), (-146391693)⟩, ⟨1103676, 5220498⟩, ⟨(-373035), 194671⟩, ⟨(-24151), 36383⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2277589668, 4555179345⟩, ⟨1138794831, 1138794838⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1207789102, 4831156430⟩, ⟨1207789098, 2415578220⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1207789102, 4831156430⟩, ⟨1207789098, 2415578220⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4831156430), (-1207789102)⟩, ⟨(-2415578220), (-1207789098)⟩, ⟨(-301947278), (-301947274)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2415578215), (-603894551)⟩, ⟨(-1207789110), (-603894549)⟩, ⟨(-150973639), (-150973637)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2447392835, 3731606300⟩, ⟨(-1049366187), (-344116052)⟩, ⟨(-106978529), 61517286⟩, ⟨2297649, 34618872⟩, ⟨(-3515002), 1799452⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2040140517, 3473214714⟩, ⟨(-1126373382), (-370272368)⟩, ⟨(-87212983), 103881947⟩, ⟨(-2151662), 36593193⟩, ⟨(-4858704), 1794064⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4333705304, 4333705307⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar365 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1450
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar365 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4311297561, 4367874723⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1451
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((4239 / 50000) : ℝ)..(4239 / 25000), prawitzNormalCorrection
      ((118207 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
