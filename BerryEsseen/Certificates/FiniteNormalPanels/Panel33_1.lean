...
namespace FiniteNormalPanel33_1

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (9647 / 100000)
def radius : Rat := (9647 / 100000)

def j0 : Jet := ⟨⟨414335495, 414335496⟩, ⟨414335495, 414335496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1301673347, 1301673351⟩, ⟨1301673347, 1301673351⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨394497416, 394497419⟩, ⟨788994832, 788994838⟩, ⟨394497416, 394497419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨98, 99⟩, ⟨197, 198⟩, ⟨98, 99⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94589), (-94587)⟩, ⟨197, 198⟩, ⟨98, 99⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8689), (-8687)⟩, ⟨(-17359), (-17356)⟩, ⟨(-8644), (-8640)⟩, ⟨36, 38⟩, ⟨9, 10⟩⟩
...
def j13 : Jet := ⟨⟨5104367, 5104370⟩, ⟨(-17359), (-17356)⟩, ⟨(-8644), (-8640)⟩, ⟨36, 38⟩, ⟨9, 10⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨468841, 468842⟩, ⟨936088, 936090⟩, ⟨464858, 464861⟩, ⟨(-3180), (-3177)⟩, ⟨(-788), (-785)⟩⟩
...
def j16 : Jet := ⟨⟨(-142696736), (-142696734)⟩, ⟨936088, 936090⟩, ⟨464858, 464861⟩, ⟨(-3180), (-3177)⟩, ⟨(-788), (-785)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13106851), (-13106850)⟩, ⟨(-26127721), (-26127719)⟩, ⟨(-12892193), (-12892190)⟩, ⟨171082, 171086⟩, ⟨42039, 42043⟩⟩
...
def j19 : Jet := ⟨⟨1418548914, 1418548916⟩, ⟨(-26127721), (-26127719)⟩, ⟨(-12892193), (-12892190)⟩, ⟨171082, 171086⟩, ⟨42039, 42043⟩⟩
...
def j22 : Jet := ⟨⟨(-10), (-9)⟩, ⟨(-20), (-19)⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11825, 11827⟩, ⟨(-20), (-19)⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1086, 1087⟩, ⟨2170, 2172⟩, ⟨1081, 1084⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851091), (-851089)⟩, ⟨2170, 2172⟩, ⟨1081, 1084⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-78174), (-78173)⟩, ⟨(-156149), (-156146)⟩, ⟨(-77677), (-77673)⟩, ⟨396, 400⟩, ⟨97, 100⟩⟩
...
def j30 : Jet := ⟨⟨35713220, 35713222⟩, ⟨(-156149), (-156146)⟩, ⟨(-77677), (-77673)⟩, ⟨396, 400⟩, ⟨97, 100⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3280298, 3280299⟩, ⟨6546253, 6546255⟩, ⟨3244478, 3244481⟩, ⟨(-28577), (-28573)⟩, ⟨(-7055), (-7050)⟩⟩
...
def j33 : Jet := ⟨⟨(-712547585), (-712547583)⟩, ⟨6546253, 6546255⟩, ⟨3244478, 3244481⟩, ⟨(-28577), (-28573)⟩, ⟨(-7055), (-7050)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-65448271), (-65448270)⟩, ⟨(-130295262), (-130295259)⟩, ⟨(-63947703), (-63947698)⟩, ⟨1194672, 1194676⟩, ⟨292109, 292115⟩⟩
...
def j36 : Jet := ⟨⟨4229519025, 4229519026⟩, ⟨(-130295262), (-130295259)⟩, ⟨(-63947703), (-63947698)⟩, ⟨1194672, 1194676⟩, ⟨292109, 292115⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨429918829, 429918832⟩, ⟨422000315, 422000319⟩, ⟨(-11825744), (-11825741)⟩, ⟨(-3855381), (-3855377)⟩, ⟨64589, 64593⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4361428323, 4361428325⟩, ⟨134358878, 134358883⟩, ⟨70081165, 70081174⟩, ⟨2958418, 2958426⟩, ⟨811542, 811553⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨436571463, 436571467⟩, ⟨441979508, 441979515⟩, ⟨8207643, 8207651⟩, ⟨2896945, 2896955⟩, ⟨123929, 123940⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-414335496), (-414335495)⟩, ⟨(-414335496), (-414335495)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3880631800, 3880631801⟩, ⟨(-414335496), (-414335495)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨44376273, 44376275⟩, ⟨89851970, 89851976⟩, ⟨47151076, 47151080⟩, ⟨2278168, 2278176⟩, ⟨637106, 637115⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4339343569, 4339343571⟩, ⟨89851970, 89851976⟩, ⟨47151076, 47151080⟩, ⟨2278168, 2278176⟩, ⟨637106, 637115⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317098413, 4317098415⟩, ⟨44695676, 44695681⟩, ⟨23223309, 23223312⟩, ⟨892809, 892815⟩, ⟨245211, 245218⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3900627928, 3900627931⟩, ⟨(-376086602), (-376086594)⟩, ⟨16671163, 16671169⟩, ⟨(-1433674), (-1433666)⟩, ⟨135425, 135433⟩⟩
...
def j47 : Jet := ⟨⟨2021377145, 2021377151⟩, ⟨2021377145, 2021377151⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨951337991, 951337998⟩, ⟨1902675982, 1902675996⟩, ⟨951337991, 951337998⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨951337991, 951337998⟩, ⟨1902675982, 1902675996⟩, ⟨951337991, 951337998⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-951337998), (-951337991)⟩, ⟨(-1902675996), (-1902675982)⟩, ⟨(-951337998), (-951337991)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-475668999), (-475668995)⟩, ⟨(-951337998), (-951337991)⟩, ⟨(-475668999), (-475668995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3844692484, 3844692489⟩, ⟨(-851601841), (-851601833)⟩, ⟨(-331485747), (-331485740)⟩, ⟨87351550, 87351553⟩, ⟨13518969, 13518971⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3491694777, 3491694785⟩, ⟨(-1110071146), (-1110071128)⟩, ⟨(-211557151), (-211557133)⟩, ⟨103768892, 103768908⟩, ⟨3747650, 3747667⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 828670991⟩, ⟨414335495, 414335496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2603346698⟩, ⟨1301673347, 1301673351⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1577989671⟩, ⟨0, 1577989674⟩, ⟨394497416, 394497419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 396⟩, ⟨0, 396⟩, ⟨98, 99⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94290)⟩, ⟨0, 396⟩, ⟨98, 99⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34789), 0⟩, ⟨(-34789), 146⟩, ⟨(-8698), (-8477)⟩, ⟨0, 74⟩, ⟨9, 10⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078267, 5113057⟩, ⟨(-34789), 146⟩, ⟨(-8698), (-8477)⟩, ⟨0, 74⟩, ⟨9, 10⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1878560⟩, ⟨(-12782), 1878614⟩, ⟨450466, 469694⟩, ⟨(-6392), 42⟩, ⟨(-799), (-746)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141287016)⟩, ⟨(-12782), 1878614⟩, ⟨450466, 469694⟩, ⟨(-6392), 42⟩, ⟨(-799), (-746)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-52599656), 0⟩, ⟨(-52604353), 690211⟩, ⟨(-13154612), (-12114587)⟩, ⟨(-3524), 345137⟩, ⟨38732, 43158⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1379056109, 1431655766⟩, ⟨(-52604353), 690211⟩, ⟨(-13154612), (-12114587)⟩, ⟨(-3524), 345137⟩, ⟨38732, 43158⟩⟩
...
def j70 : Jet := ⟨⟨(-40), 0⟩, ⟨(-40), 0⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11795, 11836⟩, ⟨(-40), 0⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 4349⟩, ⟨(-15), 4349⟩, ⟨1064, 1088⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-847827)⟩, ⟨(-15), 4349⟩, ⟨1064, 1088⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-313094), 0⟩, ⟨(-313100), 1598⟩, ⟨(-78280), (-75875)⟩, ⟨(-5), 800⟩, ⟨93, 100⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35478300, 35791395⟩, ⟨(-313100), 1598⟩, ⟨(-78280), (-75875)⟩, ⟨(-5), 800⟩, ⟨93, 100⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 13149915⟩, ⟨(-115035), 13150503⟩, ⟨3114924, 3288067⟩, ⟨(-57522), 441⟩, ⟨(-7193), (-6638)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-702677967)⟩, ⟨(-115035), 13150503⟩, ⟨3114924, 3288067⟩, ⟨(-57522), 441⟩, ⟨(-7193), (-6638)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-262998279), 0⟩, ⟨(-263040545), 4831553⟩, ⟨(-65791835), (-58502131)⟩, ⟨(-31701), 2416103⟩, ⟨262332, 302176⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4031969017, 4294967296⟩, ⟨(-263040545), 4831553⟩, ⟨(-65791835), (-58502131)⟩, ⟨(-31701), 2416103⟩, ⟨262332, 302176⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 867782234⟩, ⟨386064223, 434309482⟩, ⟨(-23916295), 209182⟩, ⟨(-3988898), (-3462360)⟩, ⟨(-1069), 130761⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4575120493⟩, ⟨(-5482418), 298475060⟩, ⟨58166366, 94126870⟩, ⟨(-2943834), 11047071⟩, ⟨122204, 1980460⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 924386150⟩, ⟨384956520, 522944511⟩, ⟨(-26030700), 49422778⟩, ⟨(-1277488), 8318351⟩, ⟨(-1100169), 1666199⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-828670991), 0⟩, ⟨(-414335496), (-414335495)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3466296305, 4294967296⟩, ⟨(-414335496), (-414335495)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 198951400⟩, ⟨0, 225101908⟩, ⟨23298589, 84946499⟩, ⟨(-6888764), 15615832⟩, ⟨(-1084197), 3311577⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4493918696⟩, ⟨0, 225101908⟩, ⟨23298589, 84946499⟩, ⟨(-6888764), 15615832⟩, ⟨(-1084197), 3311577⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4393316951⟩, ⟨0, 112550954⟩, ⟨9946807, 42473250⟩, ⟨(-4557407), 7807916⟩, ⟨(-956719), 1763700⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3466296305, 4393316951⟩, ⟨(-423823288), (-301784541)⟩, ⟨(-2830121), 42473250⟩, ⟨(-8654802), 6848348⟩, ⟨(-1709949), 2203354⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4042754298⟩, ⟨2021377145, 2021377151⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3805351983⟩, ⟨0, 3805351988⟩, ⟨951337991, 951337998⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3805351983⟩, ⟨0, 3805351988⟩, ⟨951337991, 951337998⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3805351983), 0⟩, ⟨(-3805351988), 0⟩, ⟨(-951337998), (-951337991)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1902675992), 0⟩, ⟨(-1902675994), 0⟩, ⟨(-475668999), (-475668995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2757825933, 4294967296⟩, ⟨(-1902675994), 0⟩, ⟨(-475668999), 116013848⟩, ⟨(-17131428), 210721974⟩, ⟨(-29761812), 28237558⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2225730996, 4393316951⟩, ⟨(-2370068305), (-193777781)⟩, ⟨(-489391376), 348897936⟩, ⟨(-56442361), 270587919⟩, ⟨(-60684869), 37759392⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨414335495, 414335496⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨414335495, 414335496⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317098413, 4317098415⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified642
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 828670991⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4393316951⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified643
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (661538707 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(9647 / 50000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (9647 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(9647 / 50000), prawitzNormalCorrection
