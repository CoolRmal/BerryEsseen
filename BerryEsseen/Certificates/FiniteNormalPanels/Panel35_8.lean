...
namespace FiniteNormalPanel35_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (287987 / 800000)
def radius : Rat := (41141 / 800000)

def j0 : Jet := ⟨⟨1546118433, 1546118434⟩, ⟨220874061, 220874062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4857274310, 4857274315⟩, ⟨693896327, 693896331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5493199853, 5493199866⟩, ⟨1569485664, 1569485678⟩, ⟨112106118, 112106120⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1374, 1377⟩, ⟨392, 394⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93313), (-93309)⟩, ⟨392, 394⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-119346), (-119340)⟩, ⟨(-33598), (-33593)⟩, ⟨(-2258), (-2253)⟩, ⟨20, 22⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4993710, 4993717⟩, ⟨(-33598), (-33593)⟩, ⟨(-2258), (-2253)⟩, ⟨20, 22⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6386881, 6386891⟩, ⟨1781851, 1781862⟩, ⟨115178, 115189⟩, ⟨(-1678), (-1670)⟩, ⟨(-52), (-47)⟩⟩
...
def j16 : Jet := ⟨⟨(-136778696), (-136778685)⟩, ⟨1781851, 1781862⟩, ⟨115178, 115189⟩, ⟨(-1678), (-1670)⟩, ⟨(-52), (-47)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-174937937), (-174937921)⟩, ⟨(-47703307), (-47703287)⟩, ⟨(-2771721), (-2771699)⟩, ⟨86450, 86468⟩, ⟨2325, 2337⟩⟩
...
def j19 : Jet := ⟨⟨1256717828, 1256717845⟩, ⟨(-47703307), (-47703287)⟩, ⟨(-2771721), (-2771699)⟩, ⟨86450, 86468⟩, ⟨2325, 2337⟩⟩
...
def j22 : Jet := ⟨⟨(-139), (-136)⟩, ⟨(-40), (-39)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11696, 11700⟩, ⟨(-40), (-39)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨14959, 14965⟩, ⟨4222, 4227⟩, ⟨286, 290⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-837218), (-837211)⟩, ⟨4222, 4227⟩, ⟨286, 290⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1070790), (-1070780)⟩, ⟨(-300541), (-300530)⟩, ⟨(-19946), (-19936)⟩, ⟨208, 216⟩, ⟨3, 8⟩⟩
...
def j30 : Jet := ⟨⟨34720604, 34720615⟩, ⟨(-300541), (-300530)⟩, ⟨(-19946), (-19936)⟩, ⟨208, 216⟩, ⟨3, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨44407140, 44407155⟩, ⟨12303366, 12303386⟩, ⟨770931, 770952⟩, ⟨(-14868), (-14852)⟩, ⟨(-442), (-430)⟩⟩
...
def j33 : Jet := ⟨⟨(-671420743), (-671420727)⟩, ⟨12303366, 12303386⟩, ⟨770931, 770952⟩, ⟨(-14868), (-14852)⟩, ⟨(-442), (-430)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-858737234), (-858737211)⟩, ⟨(-229617673), (-229617637)⟩, ⟨(-12043292), (-12043254)⟩, ⟨583839, 583870⟩, ⟨14122, 14148⟩⟩
...
def j36 : Jet := ⟨⟨3436230062, 3436230085⟩, ⟨(-229617673), (-229617637)⟩, ⟨(-12043292), (-12043254)⟩, ⟨583839, 583870⟩, ⟨14122, 14148⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1421250221, 1421250243⟩, ⟨149087011, 149087038⟩, ⟨(-10841564), (-10841534)⟩, ⟨(-350033), (-350007)⟩, ⟨16595, 16613⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5368308762, 5368308798⟩, ⟨358724049, 358724112⟩, ⟨42785630, 42785701⟩, ⟨3204133, 3204195⟩, ⟨281005, 281058⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1776430293, 1776430333⟩, ⟨305050457, 305050517⟩, ⟨13059311, 13059380⟩, ⟨1202438, 1202500⟩, ⟨87712, 87762⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1546118434), (-1546118433)⟩, ⟨(-220874062), (-220874061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2748848862, 2748848863⟩, ⟨(-220874062), (-220874061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨734744729, 734744764⟩, ⟨252342256, 252342314⟩, ⟨32469091, 32469160⟩, ⟨2849750, 2849814⟩, ⟨283070, 283125⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5029712025, 5029712060⟩, ⟨252342256, 252342314⟩, ⟨32469091, 32469160⟩, ⟨2849750, 2849814⟩, ⟨283070, 283125⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4647843441, 4647843458⟩, ⟨116591893, 116591921⟩, ⟨13539613, 13539647⟩, ⟨977050, 977082⟩, ⟨86556, 86585⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2974695328, 2974695341⟩, ⟨(-164400454), (-164400432)⟩, ⟨2669686, 2669712⟩, ⟨(-70967), (-70942)⟩, ⟨5149, 5170⟩⟩
...
def j47 : Jet := ⟨⟨6767545915, 6767545921⟩, ⟨966792269, 966792275⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10663568440, 10663568460⟩, ⟨3046733824, 3046733848⟩, ⟨217623843, 217623847⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10663568440, 10663568460⟩, ⟨3046733824, 3046733848⟩, ⟨217623843, 217623847⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10663568460), (-10663568440)⟩, ⟨(-3046733848), (-3046733824)⟩, ⟨(-217623847), (-217623843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5331784230), (-5331784220)⟩, ⟨(-1523366924), (-1523366912)⟩, ⟨(-108811924), (-108811921)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1241153493, 1241153504⟩, ⟨(-440220395), (-440220386)⟩, ⟨46625799, 46625804⟩, ⟨1922734, 1922736⟩, ⟨(-761119), (-761118)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨859623192, 859623204⟩, ⟨(-352404956), (-352404940)⟩, ⟨49915038, 49915054⟩, ⟨(-747177), (-747163)⟩, ⟨(-563011), (-562995)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1325244371, 1766992496⟩, ⟨220874061, 220874062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4163377979, 5551170645⟩, ⟨693896327, 693896331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4035820298, 7174791659⟩, ⟨1345273426, 1793697916⟩, ⟨112106118, 112106120⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1010, 1798⟩, ⟨336, 450⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93677), (-92888)⟩, ⟨336, 450⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-156489), (-87283)⟩, ⟨(-38808), (-28342)⟩, ⟨(-2315), (-2187)⟩, ⟨16, 25⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4956567, 5025774⟩, ⟨(-38808), (-28342)⟩, ⟨(-2315), (-2187)⟩, ⟨16, 25⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4657500, 8395613⟩, ⟨1487670, 2072273⟩, ⟨109299, 120250⟩, ⟨(-1965), (-1382)⟩, ⟨(-56), (-44)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138508077), (-134769963)⟩, ⟨1487670, 2072273⟩, ⟨109299, 120250⟩, ⟨(-1965), (-1382)⟩, ⟨(-56), (-44)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-231379317), (-126638298)⟩, ⟨(-56446923), (-38751010)⟩, ⟨(-3046629), (-2451412)⟩, ⟨69781, 103012⟩, ⟨1937, 2666⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1200276448, 1305017468⟩, ⟨(-56446923), (-38751010)⟩, ⟨(-3046629), (-2451412)⟩, ⟨69781, 103012⟩, ⟨1937, 2666⟩⟩
...
def j70 : Jet := ⟨⟨(-181), (-100)⟩, ⟨(-46), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11654, 11736⟩, ⟨(-46), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨10950, 19606⟩, ⟨3573, 4871⟩, ⟨278, 296⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-841227), (-832570)⟩, ⟨3573, 4871⟩, ⟨278, 296⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1405280), (-782334)⟩, ⟨(-347963), (-252640)⟩, ⟨(-20578), (-19201)⟩, ⟨173, 252⟩, ⟨3, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34386114, 35009061⟩, ⟨(-347963), (-252640)⟩, ⟨(-20578), (-19201)⟩, ⟨173, 252⟩, ⟨3, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨32311346, 58483035⟩, ⟨10189171, 14383363⟩, ⟨717841, 816624⟩, ⟨(-17515), (-12187)⟩, ⟨(-482), (-381)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-683516537), (-657344847)⟩, ⟨10189171, 14383363⟩, ⟨717841, 816624⟩, ⟨(-17515), (-12187)⟩, ⟨(-482), (-381)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1141822140), (-617682392)⟩, ⟨(-275881153), (-181866557)⟩, ⟨(-13974982), (-9786771)⟩, ⟨461537, 705025⟩, ⟨10615, 17141⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3153145156, 3677284904⟩, ⟨(-275881153), (-181866557)⟩, ⟨(-13974982), (-9786771)⟩, ⟨461537, 705025⟩, ⟨10615, 17141⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1163502347, 1686712415⟩, ⟨120960389, 173275297⟩, ⟨(-13057300), (-8636930)⟩, ⟨(-424572), (-262908)⟩, ⟨13150, 20089⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5016403285, 5850267959⟩, ⟨248094998, 511863106⟩, ⟨25620688, 70713770⟩, ⟨805759, 7721379⟩, ⟨(-20261), 935782⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1358938635, 2297507506⟩, ⟨208487082, 437040063⟩, ⟨(-3857844), 38333403⟩, ⟨(-1194614), 5079218⟩, ⟨(-235487), 639666⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1766992496), (-1325244371)⟩, ⟨(-220874062), (-220874061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2527974800, 2969722925⟩, ⟨(-220874062), (-220874061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨429971659, 1229006039⟩, ⟨131931690, 467571816⟩, ⟨5993061, 85482977⟩, ⟨(-2063194), 13235386⟩, ⟨(-529492), 2060173⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4724938955, 5523973335⟩, ⟨131931690, 467571816⟩, ⟨5993061, 85482977⟩, ⟨(-2063194), 13235386⟩, ⟨(-529492), 2060173⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4504826110, 4870860789⟩, ⟨58166545, 222894915⟩, ⟨(-2657389), 40374838⟩, ⟨(-2981253), 6440892⟩, ⟨(-752035), 1141519⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2651495599, 3367920162⟩, ⟨(-216253859), (-77547294)⟩, ⟨(-13300082), 24925592⟩, ⟨(-4137693), 4590167⟩, ⟨(-851220), 942610⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5800753640, 7734338195⟩, ⟨966792269, 966792275⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7834458442, 13927926150⟩, ⟨2611486134, 3481981540⟩, ⟨217623843, 217623847⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7834458442, 13927926150⟩, ⟨2611486134, 3481981540⟩, ⟨217623843, 217623847⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13927926150), (-7834458442)⟩, ⟨(-3481981540), (-2611486134)⟩, ⟨(-217623847), (-217623843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6963963075), (-3917229221)⟩, ⟨(-1740990770), (-1305743067)⟩, ⟨(-108811924), (-108811921)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨848758937, 1725286187⟩, ⟨(-699355111), (-258037144)⟩, ⟨(-4485856), 120240801⟩, ⟨(-11888573), 12418115⟩, ⟨(-2781575), 1261601⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨523980843, 1352891823⟩, ⟨(-635271887), (-174623752)⟩, ⟨(-4201284), 139512924⟩, ⟨(-21097450), 13973132⟩, ⟨(-4268149), 3338090⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1546118433, 1546118434⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4647843441, 4647843458⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified694
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1325244371, 1766992496⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4504826110, 4870860789⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified695
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (45097179 / 2147483648)

theorem envelope_integral : (∫ s in ((123423 / 400000) : ℝ)..(41141 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((123423 / 400000) : ℝ)..(41141 / 100000), prawitzNormalCorrection
