...
namespace FiniteNormalPanel74_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (36007 / 400000)
def radius : Rat := (36007 / 400000)

def j0 : Jet := ⟨⟨386622218, 386622219⟩, ⟨386622218, 386622219⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1214609519, 1214609523⟩, ⟨1214609519, 1214609523⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨343489526, 343489529⟩, ⟨686979052, 686979058⟩, ⟨343489526, 343489529⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨85, 87⟩, ⟨171, 173⟩, ⟨85, 87⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94602), (-94599)⟩, ⟨171, 173⟩, ⟨85, 87⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-7566), (-7565)⟩, ⟨(-15119), (-15117)⟩, ⟨(-7533), (-7530)⟩, ⟨26, 28⟩, ⟨6, 7⟩⟩
...
def j13 : Jet := ⟨⟨5105490, 5105492⟩, ⟨(-15119), (-15117)⟩, ⟨(-7533), (-7530)⟩, ⟨26, 28⟩, ⟨6, 7⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨408310, 408312⟩, ⟨815411, 815415⟩, ⟨405288, 405293⟩, ⟨(-2413), (-2409)⟩, ⟨(-599), (-596)⟩⟩
...
def j16 : Jet := ⟨⟨(-142757267), (-142757264)⟩, ⟨815411, 815415⟩, ⟨405288, 405293⟩, ⟨(-2413), (-2409)⟩, ⟨(-599), (-596)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-11416997), (-11416996)⟩, ⟨(-22768781), (-22768779)⟩, ⟨(-11254161), (-11254156)⟩, ⟨129844, 129848⟩, ⟨31978, 31982⟩⟩
...
def j19 : Jet := ⟨⟨1420238768, 1420238770⟩, ⟨(-22768781), (-22768779)⟩, ⟨(-11254161), (-11254156)⟩, ⟨129844, 129848⟩, ⟨31978, 31982⟩⟩
...
def j22 : Jet := ⟨⟨(-9), (-8)⟩, ⟨(-18), (-17)⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11826, 11828⟩, ⟨(-18), (-17)⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨945, 946⟩, ⟨1889, 1891⟩, ⟨941, 944⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851232), (-851230)⟩, ⟨1889, 1891⟩, ⟨941, 944⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-68078), (-68077)⟩, ⟨(-136004), (-136002)⟩, ⟨(-67701), (-67698)⟩, ⟨300, 303⟩, ⟨73, 76⟩⟩
...
def j30 : Jet := ⟨⟨35723316, 35723318⟩, ⟨(-136004), (-136002)⟩, ⟨(-67701), (-67698)⟩, ⟨300, 303⟩, ⟨73, 76⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2856968, 2856969⟩, ⟨5703059, 5703061⟩, ⟨2829799, 2829802⟩, ⟨(-21683), (-21679)⟩, ⟨(-5363), (-5358)⟩⟩
...
def j33 : Jet := ⟨⟨(-712970915), (-712970913)⟩, ⟨5703059, 5703061⟩, ⟨2829799, 2829802⟩, ⟨(-21683), (-21679)⟩, ⟨(-5363), (-5358)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-57019770), (-57019768)⟩, ⟨(-113583438), (-113583435)⟩, ⟨(-55881255), (-55881250)⟩, ⟨906991, 906996⟩, ⟨222414, 222419⟩⟩
...
def j36 : Jet := ⟨⟨4237947526, 4237947528⟩, ⟨(-113583438), (-113583435)⟩, ⟨(-55881255), (-55881250)⟩, ⟨906991, 906996⟩, ⟨222414, 222419⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨401641132, 401641134⟩, ⟨395202159, 395202162⟩, ⟨(-9621631), (-9621628)⟩, ⟨(-3145939), (-3145935)⟩, ⟨45762, 45766⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4352754240, 4352754243⟩, ⟨116660428, 116660434⟩, ⟨60521758, 60521766⟩, ⟨2228782, 2228791⟩, ⟨604356, 604366⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨407045041, 407045044⟩, ⟨411428859, 411428865⟩, ⟨6643096, 6643104⟩, ⟨2327732, 2327740⟩, ⟨86940, 86951⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-386622219), (-386622218)⟩, ⟨(-386622219), (-386622218)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3908345077, 3908345078⟩, ⟨(-386622219), (-386622218)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨38576700, 38576701⟩, ⟨77984330, 77984334⟩, ⟨40671271, 40671276⟩, ⟨1713936, 1713942⟩, ⟨472714, 472722⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4333543996, 4333543997⟩, ⟨77984330, 77984334⟩, ⟨40671271, 40671276⟩, ⟨1713936, 1713942⟩, ⟨472714, 472722⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4314212528, 4314212529⟩, ⟨38818225, 38818228⟩, ⟨20070281, 20070285⟩, ⟨672557, 672562⟩, ⟨182565, 182572⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3925857901, 3925857904⟩, ⟨(-353030722), (-353030716)⟩, ⟨14769284, 14769290⟩, ⟨(-1194662), (-1194656)⟩, ⟨105587, 105597⟩⟩
...
def j47 : Jet := ⟨⟨2170924142, 2170924149⟩, ⟨2170924142, 2170924149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1097310248, 1097310256⟩, ⟨2194620496, 2194620512⟩, ⟨1097310248, 1097310256⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1097310248, 1097310256⟩, ⟨2194620496, 2194620512⟩, ⟨1097310248, 1097310256⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1097310256), (-1097310248)⟩, ⟨(-2194620512), (-2194620496)⟩, ⟨(-1097310256), (-1097310248)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-548655128), (-548655124)⟩, ⟨(-1097310256), (-1097310248)⟩, ⟨(-548655128), (-548655124)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3779910053, 3779910059⟩, ⟨(-965719595), (-965719585)⟩, ⟨(-359495180), (-359495172)⟩, ⟨112858580, 112858583⟩, ⟨15753138, 15753140⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3455064666, 3455064675⟩, ⟨(-1193420562), (-1193420545)⟩, ⟨(-236223395), (-236223377)⟩, ⟨128336454, 128336467⟩, ⟨4248076, 4248093⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 773244438⟩, ⟨386622218, 386622219⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2429219046⟩, ⟨1214609519, 1214609523⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1373958116⟩, ⟨0, 1373958116⟩, ⟨343489526, 343489529⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 345⟩, ⟨0, 345⟩, ⟨85, 87⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94341)⟩, ⟨0, 345⟩, ⟨85, 87⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-30291), 0⟩, ⟨(-30291), 111⟩, ⟨(-7573), (-7405)⟩, ⟨0, 56⟩, ⟨6, 7⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5082765, 5113057⟩, ⟨(-30291), 111⟩, ⟨(-7573), (-7405)⟩, ⟨0, 56⟩, ⟨6, 7⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1635665⟩, ⟨(-9691), 1635701⟩, ⟨394379, 408953⟩, ⟨(-4846), 27⟩, ⟨(-606), (-571)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141529911)⟩, ⟨(-9691), 1635701⟩, ⟨394379, 408953⟩, ⟨(-4846), 27⟩, ⟨(-606), (-571)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-45798605), 0⟩, ⟨(-45801706), 523261⟩, ⟨(-11452753), (-10664753)⟩, ⟨(-2327), 261649⟩, ⟨29795, 32715⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1385857160, 1431655766⟩, ⟨(-45801706), 523261⟩, ⟨(-11452753), (-10664753)⟩, ⟨(-2327), 261649⟩, ⟨29795, 32715⟩⟩
...
def j70 : Jet := ⟨⟨(-35), 0⟩, ⟨(-35), 0⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11800, 11836⟩, ⟨(-35), 0⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 3787⟩, ⟨(-12), 3787⟩, ⟨928, 947⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848389)⟩, ⟨(-12), 3787⟩, ⟨928, 947⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-272612), 0⟩, ⟨(-272616), 1212⟩, ⟨(-68157), (-66334)⟩, ⟨(-3), 606⟩, ⟨71, 76⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35518782, 35791395⟩, ⟨(-272616), 1212⟩, ⟨(-68157), (-66334)⟩, ⟨(-3), 606⟩, ⟨71, 76⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 11449652⟩, ⟨(-87210), 11450040⟩, ⟨2731596, 2862801⟩, ⟨(-43608), 291⟩, ⟨(-5452), (-5086)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-704378230)⟩, ⟨(-87210), 11450040⟩, ⟨2731596, 2862801⟩, ⟨(-43608), 291⟩, ⟨(-5452), (-5086)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-228993020), 0⟩, ⟨(-229020919), 3662863⟩, ⟨(-57276154), (-51753897)⟩, ⟨(-20926), 1831619⟩, ⟨202763, 229047⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4065974276, 4294967296⟩, ⟨(-229020919), 3662863⟩, ⟨(-57276154), (-51753897)⟩, ⟨(-20926), 1831619⟩, ⟨202763, 229047⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 809739683⟩, ⟨366012780, 405165797⟩, ⟨(-19430285), 147978⟩, ⟨(-3240137), (-2867986)⟩, ⟨(-659), 92498⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4536857054⟩, ⟨(-4087063), 255543962⟩, ⟨51535962, 78303162⟩, ⟨(-2171855), 8033643⟩, ⟨154265, 1343198⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 855343695⟩, ⟨365242236, 476162740⟩, ⟨(-20910140), 39025726⟩, ⟨(-596316), 6051835⟩, ⟨(-752604), 1114581⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-773244438), 0⟩, ⟨(-386622219), (-386622218)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3521722858, 4294967296⟩, ⟨(-386622219), (-386622218)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 170341888⟩, ⟨0, 189655832⟩, ⟨22731528, 68333881⟩, ⟨(-4873932), 11063646⟩, ⟨(-621984), 2140421⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4465309184⟩, ⟨0, 189655832⟩, ⟨22731528, 68333881⟩, ⟨(-4873932), 11063646⟩, ⟨(-621984), 2140421⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4379310096⟩, ⟨0, 94827916⟩, ⟨10120182, 34166941⟩, ⟨(-3191333), 5531823⟩, ⟨(-569030), 1128749⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3521722858, 4379310096⟩, ⟨(-394214548), (-291794302)⟩, ⟨(-237977), 34166941⟩, ⟨(-6266956), 4620830⟩, ⟨(-1066991), 1416025⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4341848297⟩, ⟨2170924142, 2170924149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4389241020⟩, ⟨0, 4389241022⟩, ⟨1097310248, 1097310256⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4389241020⟩, ⟨0, 4389241022⟩, ⟨1097310248, 1097310256⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4389241020), 0⟩, ⟨(-4389241022), 0⟩, ⟨(-1097310256), (-1097310248)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2194620510), 0⟩, ⟨(-2194620511), 0⟩, ⟨(-548655128), (-548655124)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2576595707, 4294967296⟩, ⟨(-2194620511), 0⟩, ⟨(-548655128), 231554070⟩, ⟨(-39439440), 280349003⟩, ⟨(-50602617), 40081767⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2112718298, 4379310096⟩, ⟨(-2631932114), (-175050447)⟩, ⟨(-559667369), 471701917⟩, ⟨(-85192585), 340955249⟩, ⟨(-85120961), 50949157⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨386622218, 386622219⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨386622218, 386622219⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4314212528, 4314212529⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1472
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 773244438⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4379310096⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1473
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (609690937 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(36007 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(36007 / 200000), prawitzNormalCorrection
