...
namespace FiniteNormalPanel25_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3941 / 12500)
def radius : Rat := (563 / 12500)

def j0 : Jet := ⟨⟨1354117289, 1354117290⟩, ⟨193445327, 193445328⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4254084927, 4254084931⟩, ⟨607726418, 607726422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4213591703, 4213591712⟩, ⟨1203883342, 1203883354⟩, ⟨85991667, 85991669⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1054, 1056⟩, ⟨301, 302⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93633), (-93630)⟩, ⟨301, 302⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-91859), (-91856)⟩, ⟨(-25951), (-25947)⟩, ⟨(-1771), (-1767)⟩, ⟨11, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5021197, 5021201⟩, ⟨(-25951), (-25947)⟩, ⟨(-1771), (-1767)⟩, ⟨11, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4926061, 4926066⟩, ⟨1381986, 1381993⟩, ⟨91518, 91527⟩, ⟨(-1007), (-1000)⟩, ⟨(-33), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-138239516), (-138239510)⟩, ⟨1381986, 1381993⟩, ⟨91518, 91527⟩, ⟨(-1007), (-1000)⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-135620330), (-135620323)⟩, ⟨(-37392865), (-37392854)⟩, ⟨(-2290607), (-2290594)⟩, ⟨52333, 52345⟩, ⟨1516, 1524⟩⟩
...
def j19 : Jet := ⟨⟨1296035435, 1296035443⟩, ⟨(-37392865), (-37392854)⟩, ⟨(-2290607), (-2290594)⟩, ⟨52333, 52345⟩, ⟨1516, 1524⟩⟩
...
def j25 : Jet := ⟨⟨11506, 11510⟩, ⟨3256, 3261⟩, ⟨222, 226⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840671), (-840666)⟩, ⟨3256, 3261⟩, ⟨222, 226⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-824744), (-824738)⟩, ⟨(-232447), (-232439)⟩, ⟨(-15703), (-15694)⟩, ⟨125, 130⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨34966650, 34966657⟩, ⟨(-232447), (-232439)⟩, ⟨(-15703), (-15694)⟩, ⟨125, 130⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨34304146, 34304154⟩, ⟨9573141, 9573152⟩, ⟨619522, 619537⟩, ⟨(-8934), (-8924)⟩, ⟨(-279), (-272)⟩⟩
...
def j33 : Jet := ⟨⟨(-681523737), (-681523728)⟩, ⟨9573141, 9573152⟩, ⟨619522, 619537⟩, ⟨(-8934), (-8924)⟩, ⟨(-279), (-272)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-668611092), (-668611080)⟩, ⟨(-181639981), (-181639964)⟩, ⟨(-10353981), (-10353961)⟩, ⟨356555, 356572⟩, ⟨9624, 9638⟩⟩
...
def j36 : Jet := ⟨⟨3626356204, 3626356216⟩, ⟨(-181639981), (-181639964)⟩, ⟨(-10353981), (-10353961)⟩, ⟨356555, 356572⟩, ⟨9624, 9638⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1283698903, 1283698913⟩, ⟨146348622, 146348637⟩, ⟨(-7559795), (-7559779)⟩, ⟨(-272281), (-272265)⟩, ⟨8905, 8917⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5086853848, 5086853866⟩, ⟨254794591, 254794619⟩, ⟨27286333, 27286367⟩, ⟨1594047, 1594080⟩, ⟨119175, 119203⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1520381473, 1520381491⟩, ⟨249485854, 249485884⟩, ⟨7883807, 7883841⟩, ⟨635240, 635275⟩, ⟨36299, 36330⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1354117290), (-1354117289)⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2940850006, 2940850007⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨538201961, 538201975⟩, ⟨176631690, 176631716⟩, ⟨20073720, 20073750⟩, ⟨1365646, 1365678⟩, ⟨113967, 113998⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4833169257, 4833169271⟩, ⟨176631690, 176631716⟩, ⟨20073720, 20073750⟩, ⟨1365646, 1365678⟩, ⟨113967, 113998⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4556128169, 4556128176⟩, ⟨83253510, 83253524⟩, ⟨8700898, 8700914⟩, ⟨484691, 484709⟩, ⟨36551, 36568⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3119672078, 3119672085⟩, ⟨(-148202672), (-148202659)⟩, ⟨2207939, 2207952⟩, ⟨(-60013), (-59998)⟩, ⟨3195, 3209⟩⟩
...
def j47 : Jet := ⟨⟨8079476216, 8079476224⟩, ⟨1154210888, 1154210895⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15198703837, 15198703868⟩, ⟨4342486810, 4342486842⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15198703837, 15198703868⟩, ⟨4342486810, 4342486842⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15198703868), (-15198703837)⟩, ⟨(-4342486842), (-4342486810)⟩, ⟨(-310177634), (-310177629)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7599351934), (-7599351918)⟩, ⟨(-2171243421), (-2171243405)⟩, ⟨(-155088817), (-155088814)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨732041504, 732041516⟩, ⟨(-370070415), (-370070405)⟩, ⟨67107614, 67107620⟩, ⟨(-2399663), (-2399661)⟩, ⟨(-908333), (-908332)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨531722195, 531722206⟩, ⟨(-294062508), (-294062496)⟩, ⟨61889985, 61889997⟩, ⟨(-4259107), (-4259099)⟩, ⟨(-536760), (-536750)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1160671962, 1547562617⟩, ⟨193445327, 193445328⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3646358508, 4861811349⟩, ⟨607726418, 607726422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3095700025, 5503466724⟩, ⟨1031900008, 1375866690⟩, ⟨85991667, 85991669⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨774, 1379⟩, ⟨258, 345⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93913), (-93307)⟩, ⟨258, 345⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-120338), (-67253)⟩, ⟨(-29900), (-21974)⟩, ⟨(-1805), (-1728)⟩, ⟨10, 15⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4992718, 5045804⟩, ⟨(-29900), (-21974)⟩, ⟨(-1805), (-1728)⟩, ⟨10, 15⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3598620, 6465571⟩, ⟨1161226, 1600555⟩, ⟨88069, 94501⟩, ⟨(-1171), (-834)⟩, ⟨(-35), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139566957), (-136700005)⟩, ⟨1161226, 1600555⟩, ⟨88069, 94501⟩, ⟨(-1171), (-834)⟩, ⟨(-35), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-178837708), (-98529786)⟩, ⟨(-43872447), (-30792349)⟩, ⟨(-2451870), (-2103117)⟩, ⟨42907, 61718⟩, ⟨1342, 1674⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1252818057, 1333125980⟩, ⟨(-43872447), (-30792349)⟩, ⟨(-2451870), (-2103117)⟩, ⟨42907, 61718⟩, ⟨1342, 1674⟩⟩
...
def j72 : Jet := ⟨⟨8430, 15068⟩, ⟨2765, 3749⟩, ⟨218, 229⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843747), (-837108)⟩, ⟨2765, 3749⟩, ⟨218, 229⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1081157), (-603365)⟩, ⟨(-268298), (-196317)⟩, ⟨(-16073), (-15265)⟩, ⟨104, 150⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34710237, 35188030⟩, ⟨(-268298), (-196317)⟩, ⟨(-16073), (-15265)⟩, ⟨104, 150⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨25018230, 45089087⟩, ⟨7995619, 11130772⟩, ⟨588406, 646349⟩, ⟨(-10447), (-7404)⟩, ⟨(-298), (-249)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-690809653), (-670738795)⟩, ⟨7995619, 11130772⟩, ⟨588406, 646349⟩, ⟨(-10447), (-7404)⟩, ⟨(-298), (-249)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-885186703), (-483450969)⟩, ⟨(-215533646), (-146887622)⟩, ⟨(-11485926), (-9035301)⟩, ⟨288066, 424573⟩, ⟨8051, 10984⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3409780593, 3811516327⟩, ⟨(-215533646), (-146887622)⟩, ⟨(-11485926), (-9035301)⟩, ⟨288066, 424573⟩, ⟨8051, 10984⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1063622483, 1509070169⟩, ⟨127607738, 162491562⟩, ⟨(-8983300), (-6142547)⟩, ⟨(-310507), (-227721)⟩, ⟨7210, 10628⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4839738962, 5409950456⟩, ⟨186513105, 341965214⟩, ⟨18660541, 39839310⟩, ⟨558643, 3261307⟩, ⟨12079, 313167⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1198531866, 1900828176⟩, ⟨189982278, 324826876⟩, ⟨(-1152727), 20013764⟩, ⟨(-413600), 2129777⟩, ⟨(-80339), 210232⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1547562617), (-1160671962)⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2747404679, 3134295334⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨334456244, 841251518⟩, ⟨106030988, 287517942⟩, ⟨7383290, 42281570⟩, ⟨(-540458), 4912424⟩, ⟨(-139046), 601497⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4629423540, 5136218814⟩, ⟨106030988, 287517942⟩, ⟨7383290, 42281570⟩, ⟨(-540458), 4912424⟩, ⟨(-139046), 601497⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4459060742, 4696795912⟩, ⟨48479818, 138468641⟩, ⟨1334678, 20099263⟩, ⟨(-884435), 2351313⟩, ⟨(-185281), 316947⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2852371974, 3427533785⟩, ⟨(-180532120), (-99787219)⟩, ⟨(-5382862), 12484108⟩, ⟨(-1550697), 1655782⟩, ⟨(-241115), 271131⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6925265328, 9233687112⟩, ⟨1154210888, 1154210895⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11166394656, 19851368313⟩, ⟨3722131552, 4962842104⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11166394656, 19851368313⟩, ⟨3722131552, 4962842104⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19851368313), (-11166394656)⟩, ⟨(-4962842104), (-3722131552)⟩, ⟨(-310177634), (-310177629)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9925684157), (-5583197328)⟩, ⟨(-2481421052), (-1861065776)⟩, ⟨(-155088817), (-155088814)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨425896254, 1170586048⟩, ⟨(-676307097), (-184546444)⟩, ⟨(-2285995), 179989634⟩, ⟨(-30220478), 16720955⟩, ⟨(-5664799), 4406250⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨282846050, 934168517⟩, ⟨(-588920388), (-132455981)⟩, ⟨996269, 175468027⟩, ⟨(-34071027), 14738889⟩, ⟨(-5775572), 5627863⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1354117289, 1354117290⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4556128169, 4556128176⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified498
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1160671962, 1547562617⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4459060742, 4696795912⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified499
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (49857279 / 4294967296)

theorem envelope_integral : (∫ s in ((1689 / 6250) : ℝ)..(1126 / 3125),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((1689 / 6250) : ℝ)..(1126 / 3125), prawitzNormalCorrection
