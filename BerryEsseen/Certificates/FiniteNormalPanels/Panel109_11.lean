...
namespace FiniteNormalPanel109_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (107527 / 400000)
def radius : Rat := (15361 / 400000)

def j0 : Jet := ⟨⟨1154562371, 1154562372⟩, ⟨164937481, 164937482⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3627164662, 3627164667⟩, ⟨518166378, 518166382⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3063195265, 3063195274⟩, ⟨875198642, 875198652⟩, ⟨62514188, 62514190⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨766, 768⟩, ⟨219, 220⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93921), (-93918)⟩, ⟨219, 220⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-66985), (-66982)⟩, ⟨(-18983), (-18980)⟩, ⟨(-1314), (-1309)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5046071, 5046075⟩, ⟨(-18983), (-18980)⟩, ⟨(-1314), (-1309)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3598886, 3598890⟩, ⟨1014714, 1014719⟩, ⟨68639, 68647⟩, ⟨(-541), (-536)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-139566691), (-139566686)⟩, ⟨1014714, 1014719⟩, ⟨68639, 68647⟩, ⟨(-541), (-536)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-99539764), (-99539759)⟩, ⟨(-27716234), (-27716227)⟩, ⟨(-1775700), (-1775690)⟩, ⟨28369, 28377⟩, ⟨874, 880⟩⟩
...
def j19 : Jet := ⟨⟨1332116001, 1332116007⟩, ⟨(-27716234), (-27716227)⟩, ⟨(-1775700), (-1775690)⟩, ⟨28369, 28377⟩, ⟨874, 880⟩⟩
...
def j22 : Jet := ⟨⟨(-78), (-76)⟩, ⟨(-23), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11757, 11760⟩, ⟨(-23), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8385, 8388⟩, ⟨2378, 2383⟩, ⟨164, 168⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843792), (-843788)⟩, ⟨2378, 2383⟩, ⟨164, 168⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-601798), (-601794)⟩, ⟨(-170247), (-170241)⟩, ⟨(-11682), (-11675)⟩, ⟨65, 70⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35189596, 35189601⟩, ⟨(-170247), (-170241)⟩, ⟨(-11682), (-11675)⟩, ⟨65, 70⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25097421, 25097425⟩, ⟨7049269, 7049277⟩, ⟨469168, 469177⟩, ⟨(-4813), (-4806)⟩, ⟨(-158), (-151)⟩⟩
...
def j33 : Jet := ⟨⟨(-690730462), (-690730457)⟩, ⟨7049269, 7049277⟩, ⟨469168, 469177⟩, ⟨(-4813), (-4806)⟩, ⟨(-158), (-151)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-492632922), (-492632916)⟩, ⟨(-135724685), (-135724676)⟩, ⟨(-8282670), (-8282659)⟩, ⟨194773, 194783⟩, ⟨5734, 5743⟩⟩
...
def j36 : Jet := ⟨⟨3802334374, 3802334380⟩, ⟨(-135724685), (-135724676)⟩, ⟨(-8282670), (-8282659)⟩, ⟨194773, 194783⟩, ⟨5734, 5743⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1124992055, 1124992062⟩, ⟨137306372, 137306381⟩, ⟨(-4843432), (-4843420)⟩, ⟨(-190272), (-190263)⟩, ⟨4160, 4168⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4851426053, 4851426061⟩, ⟨173172099, 173172113⟩, ⟨16749297, 16749316⟩, ⟨726562, 726581⟩, ⟨46218, 46237⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1270746757, 1270746768⟩, ⟨200455296, 200455313⟩, ⟨4452397, 4452420⟩, ⟨315559, 315580⟩, ⟨13470, 13490⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1154562372), (-1154562371)⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3140404924, 3140404925⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨375974299, 375974306⟩, ⟨118616928, 118616942⟩, ⟨11990326, 11990345⟩, ⟨602332, 602350⟩, ⟨42039, 42058⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4670941595, 4670941602⟩, ⟨118616928, 118616942⟩, ⟨11990326, 11990345⟩, ⟨602332, 602350⟩, ⟨42039, 42058⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4479011206, 4479011211⟩, ⟨56871461, 56871469⟩, ⟨5387761, 5387772⟩, ⟨220380, 220391⟩, ⟨14116, 14127⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3274974610, 3274974615⟩, ⟨(-130421812), (-130421804)⟩, ⟨1755429, 1755439⟩, ⟨(-45767), (-45756)⟩, ⟨1857, 1867⟩⟩
...
def j47 : Jet := ⟨⟨8650965424, 8650965434⟩, ⟨1235852199, 1235852207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17424859750, 17424859792⟩, ⟨4978531338, 4978531378⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17424859750, 17424859792⟩, ⟨4978531338, 4978531378⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17424859792), (-17424859750)⟩, ⟨(-4978531378), (-4978531338)⟩, ⟨(-355609385), (-355609380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8712429896), (-8712429875)⟩, ⟨(-2489265689), (-2489265669)⟩, ⟨(-177804693), (-177804690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨564916849, 564916864⟩, ⟨(-327413010), (-327412997)⟩, ⟨71493930, 71493937⟩, ⟨(-4775844), (-4775840)⟩, ⟨(-787875), (-787873)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨430757258, 430757271⟩, ⟨(-266811527), (-266811513)⟩, ⟨64688331, 64688341⟩, ⟨(-5952491), (-5952481)⟩, ⟨(-422791), (-422782)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨989624889, 1319499853⟩, ⟨164937481, 164937482⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3108998280, 4145331045⟩, ⟨518166378, 518166382⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2250510804, 4000908107⟩, ⟨750170264, 1000227030⟩, ⟨62514188, 62514190⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨563, 1003⟩, ⟨187, 251⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94124), (-93683)⟩, ⟨187, 251⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-87680), (-49088)⟩, ⟨(-21823), (-16128)⟩, ⟨(-1331), (-1289)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5025376, 5063969⟩, ⟨(-21823), (-16128)⟩, ⟨(-1331), (-1289)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2633236, 4717260⟩, ⟨857416, 1170865⟩, ⟨66822, 70217⟩, ⟨(-626), (-451)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140532341), (-138448316)⟩, ⟨857416, 1170865⟩, ⟨66822, 70217⟩, ⟨(-626), (-451)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-130910656), (-72545239)⟩, ⟨(-32278389), (-23091045)⟩, ⟨(-1860709), (-1677059)⟩, ⟨23566, 33160⟩, ⟨807, 938⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1300745109, 1359110527⟩, ⟨(-32278389), (-23091045)⟩, ⟨(-1860709), (-1677059)⟩, ⟨23566, 33160⟩, ⟨807, 938⟩⟩
...
def j70 : Jet := ⟨⟨(-101), (-56)⟩, ⟨(-26), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11734, 11780⟩, ⟨(-26), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6148, 10974⟩, ⟨2024, 2735⟩, ⟨161, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846029), (-841202)⟩, ⟨2024, 2735⟩, ⟨161, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-788105), (-440779)⟩, ⟨(-195967), (-144378)⟩, ⟨(-11878), (-11448)⟩, ⟨55, 80⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35003289, 35350616⟩, ⟨(-195967), (-144378)⟩, ⟨(-11878), (-11448)⟩, ⟨55, 80⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18341299, 32930302⟩, ⟨5931216, 8156924⟩, ⟨452777, 483321⟩, ⟨(-5592), (-4025)⟩, ⟨(-164), (-144)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697486584), (-682897580)⟩, ⟨5931216, 8156924⟩, ⟨452777, 483321⟩, ⟨(-5592), (-4025)⟩, ⟨(-164), (-144)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-649732475), (-357830054)⟩, ⟨(-159325235), (-111678231)⟩, ⟨(-8878861), (-7589879)⟩, ⟨160203, 229175⟩, ⟨5134, 6257⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3645234821, 3937137242⟩, ⟨(-159325235), (-111678231)⟩, ⟨(-8878861), (-7589879)⟩, ⟨160203, 229175⟩, ⟨5134, 6257⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨941570453, 1311759246⟩, ⟨125774594, 147254991⟩, ⟨(-5690110), (-3999791)⟩, ⟨(-207428), (-170323)⟩, ⟨3427, 4907⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4685319037, 5060509125⟩, ⟨132900660, 221183778⟩, ⟨12801969, 21993568⟩, ⟨324767, 1294126⟩, ⟨12971, 97697⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1027145881, 1545569309⟩, ⟨166341064, 241055408⟩, ⟨(-5909), 9937303⟩, ⟨(-91341), 839742⟩, ⟨(-23730), 62799⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1319499853), (-989624889)⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2975467443, 3305342407⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨245643002, 556182231⟩, ⟨79561274, 173490422⟩, ⟨6438018, 20681252⟩, ⟨(-66404), 1719838⟩, ⟨(-27348), 162453⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4540610298, 4851149527⟩, ⟨79561274, 173490422⟩, ⟨6438018, 20681252⟩, ⟨(-66404), 1719838⟩, ⟨(-27348), 162453⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4416081151, 4564595116⟩, ⟨37430819, 84366169⟩, ⟨2249205, 9898396⟩, ⟨(-221394), 817272⟩, ⟨(-40007), 82657⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3059372699, 3512843933⟩, ⟨(-149360543), (-104661616)⟩, ⟨(-1681668), 6180221⟩, ⟨(-550506), 542586⟩, ⟨(-62175), 72115⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7415113217, 9886817633⟩, ⟨1235852199, 1235852207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12801937763, 22759000517⟩, ⟨4267312574, 5689750144⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12801937763, 22759000517⟩, ⟨4267312574, 5689750144⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-22759000517), (-12801937763)⟩, ⟨(-5689750144), (-4267312574)⟩, ⟨(-355609385), (-355609380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11379500259), (-6400968881)⟩, ⟨(-2844875072), (-2133656287)⟩, ⟨(-177804693), (-177804690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨303597509, 967637484⟩, ⟨(-640938002), (-150821342)⟩, ⟨(-2596070), 199701920⟩, ⟨(-39929954), 18262388⟩, ⟨(-7157802), 6665879⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨216257276, 791428487⟩, ⟨(-557872009), (-114830607)⟩, ⟨1173086, 187017196⟩, ⟨(-40649698), 15400246⟩, ⟨(-6662610), 7226363⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1154562371, 1154562372⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4479011206, 4479011211⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2200
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨989624889, 1319499853⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4416081151, 4564595116⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2201
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (17425723 / 2147483648)

theorem envelope_integral : (∫ s in ((46083 / 200000) : ℝ)..(15361 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((46083 / 200000) : ℝ)..(15361 / 50000), prawitzNormalCorrection
