...
namespace FiniteNormalPanel118_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (29897 / 160000)
def radius : Rat := (29897 / 800000)

def j0 : Jet := ⟨⟨802541482, 802541483⟩, ⟨160508296, 160508297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2521258423, 2521258428⟩, ⟨504251683, 504251687⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1480044805, 1480044812⟩, ⟨592017920, 592017928⟩, ⟨59201791, 59201793⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨370, 371⟩, ⟨148, 149⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94317), (-94315)⟩, ⟨148, 149⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-32502), (-32500)⟩, ⟨(-12950), (-12948)⟩, ⟨(-1277), (-1273)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5080554, 5080557⟩, ⟨(-12950), (-12948)⟩, ⟨(-1277), (-1273)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1750757, 1750759⟩, ⟨695840, 695843⟩, ⟨67803, 67809⟩, ⟨(-355), (-350)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-141414820), (-141414817)⟩, ⟨695840, 695843⟩, ⟨67803, 67809⟩, ⟨(-355), (-350)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-48731517), (-48731515)⟩, ⟨(-19252821), (-19252818)⟩, ⟨(-1829983), (-1829978)⟩, ⟨18813, 18819⟩, ⟨878, 882⟩⟩
...
def j19 : Jet := ⟨⟨1382924248, 1382924251⟩, ⟨(-19252821), (-19252818)⟩, ⟨(-1829983), (-1829978)⟩, ⟨18813, 18819⟩, ⟨878, 882⟩⟩
...
def j22 : Jet := ⟨⟨(-38), (-36)⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11797, 11800⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4065, 4067⟩, ⟨1620, 1623⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848112), (-848109)⟩, ⟨1620, 1623⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-292260), (-292258)⟩, ⟨(-116346), (-116343)⟩, ⟨(-11414), (-11410)⟩, ⟨42, 46⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35499134, 35499137⟩, ⟨(-116346), (-116343)⟩, ⟨(-11414), (-11410)⟩, ⟨42, 46⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12232993, 12232996⟩, ⟨4853104, 4853108⟩, ⟨469347, 469353⟩, ⟨(-3164), (-3159)⟩, ⟨(-153), (-148)⟩⟩
...
def j33 : Jet := ⟨⟨(-703594890), (-703594886)⟩, ⟨4853104, 4853108⟩, ⟨469347, 469353⟩, ⟨(-3164), (-3159)⟩, ⟨(-153), (-148)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-242458649), (-242458646)⟩, ⟨(-95311082), (-95311078)⟩, ⟨(-8867660), (-8867654)⟩, ⟨130498, 130504⟩, ⟨5979, 5984⟩⟩
...
def j36 : Jet := ⟨⟨4052508647, 4052508650⟩, ⟨(-95311082), (-95311078)⟩, ⟨(-8867660), (-8867654)⟩, ⟨130498, 130504⟩, ⟨5979, 5984⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨811812795, 811812800⟩, ⟨151060647, 151060652⟩, ⟨(-3334632), (-3334626)⟩, ⟨(-203807), (-203801)⟩, ⟨2723, 2728⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4551932066, 4551932070⟩, ⟨107057032, 107057038⟩, ⟨12478363, 12478373⟩, ⟨381151, 381162⟩, ⟨26098, 26109⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨860382964, 860382971⟩, ⟨180333868, 180333877⟩, ⟨2589816, 2589827⟩, ⟨211805, 211817⟩, ⟨6452, 6467⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-802541483), (-802541482)⟩, ⟨(-160508297), (-160508296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3492425813, 3492425814⟩, ⟨(-160508297), (-160508296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨172354943, 172354947⟩, ⟨72250230, 72250236⟩, ⟨8609325, 8609333⟩, ⟨302336, 302344⟩, ⟨21931, 21942⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4467322239, 4467322243⟩, ⟨72250230, 72250236⟩, ⟨8609325, 8609333⟩, ⟨302336, 302344⟩, ⟨21931, 21942⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4380297126, 4380297129⟩, ⟨35421384, 35421388⟩, ⟨4077587, 4077593⟩, ⟨115249, 115255⟩, ⟨7921, 7928⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3561811230, 3561811235⟩, ⟨(-134894503), (-134894497)⟩, ⟨1991922, 1991929⟩, ⟨(-58671), (-58665)⟩, ⟨2132, 2141⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨33675771346, 33675771353⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value509

def j47 : Jet := ⟨⟨6292528343, 6292528353⟩, ⟨1258505665, 1258505674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9219141897, 9219141927⟩, ⟨3687656748, 3687656782⟩, ⟨368765673, 368765680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9219141897, 9219141927⟩, ⟨3687656748, 3687656782⟩, ⟨368765673, 368765680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9219141927), (-9219141897)⟩, ⟨(-3687656782), (-3687656748)⟩, ⟨(-368765680), (-368765673)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4609570964), (-4609570948)⟩, ⟨(-1843828391), (-1843828374)⟩, ⟨(-184382840), (-184382836)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1468431114, 1468431130⟩, ⟨(-630397119), (-630397105)⟩, ⟨72274946, 72274954⟩, ⟨7699414, 7699417⟩, ⟨(-2377721), (-2377719)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1217768162, 1217768178⟩, ⟨(-568907436), (-568907419)⟩, ⟨80417797, 80417811⟩, ⟨3802706, 3802716⟩, ⟨(-2170806), (-2170794)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨642033186, 963049780⟩, ⟨160508296, 160508297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2017006740, 3025510114⟩, ⟨504251683, 504251687⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨947228676, 2131264529⟩, ⟨473614336, 710421512⟩, ⟨59201791, 59201793⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨237, 534⟩, ⟨118, 178⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94450), (-94152)⟩, ⟨118, 178⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-46869), (-20764)⟩, ⟨(-15597), (-10293)⟩, ⟨(-1286), (-1259)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5066187, 5092293⟩, ⟨(-15597), (-10293)⟩, ⟨(-1286), (-1259)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1117316, 2526917⟩, ⟨550918, 840036⟩, ⟨66613, 68781⟩, ⟨(-428), (-276)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142048261), (-140638659)⟩, ⟨550918, 840036⟩, ⟨66613, 68781⟩, ⟨(-428), (-276)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-70487713), (-31016993)⟩, ⟨(-23374404), (-15091650)⟩, ⟨(-1882552), (-1765482)⟩, ⟨14725, 22897⟩, ⟨838, 916⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1361168052, 1400638773⟩, ⟨(-23374404), (-15091650)⟩, ⟨(-1882552), (-1765482)⟩, ⟨14725, 22897⟩, ⟨838, 916⟩⟩
...
def j72 : Jet := ⟨⟨2598, 5862⟩, ⟨1290, 1952⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849579), (-846314)⟩, ⟨1290, 1952⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-421582), (-186649)⟩, ⟨(-140244), (-92355)⟩, ⟨(-11535), (-11261)⟩, ⟨33, 54⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35369812, 35604746⟩, ⟨(-140244), (-92355)⟩, ⟨(-11535), (-11261)⟩, ⟨33, 54⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7800594, 17667919⟩, ⟨3830704, 5868939⟩, ⟨458615, 478109⟩, ⟨(-3835), (-2487)⟩, ⟨(-156), (-144)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708027289), (-698159963)⟩, ⟨3830704, 5868939⟩, ⟨458615, 478109⟩, ⟨(-3835), (-2487)⟩, ⟨(-156), (-144)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-351339916), (-153974894)⟩, ⟨(-116268468), (-74075140)⟩, ⟨(-9235880), (-8415411)⟩, ⟨101470, 159434⟩, ⟨5608, 6286⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3943627380, 4140992402⟩, ⟨(-116268468), (-74075140)⟩, ⟨(-9235880), (-8415411)⟩, ⟨101470, 159434⟩, ⟨5608, 6286⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨639233071, 986654026⟩, ⟨143342601, 157354984⟩, ⟨(-4070407), (-2600945)⟩, ⟨(-214107), (-191146)⟩, ⟨2121, 3335⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4454667452, 4677608277⟩, ⟨79686239, 137908149⟩, ⟨10478314, 15020741⟩, ⟨169282, 651212⟩, ⟨11908, 45995⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨663001731, 1074555572⟩, ⟨160532466, 203054540⟩, ⟨(-214031), 5805509⟩, ⟨11023, 453406⟩, ⟨(-11491), 28168⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-963049780), (-642033186)⟩, ⟨(-160508297), (-160508296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3331917516, 3652934110⟩, ⟨(-160508297), (-160508296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨102345667, 268842485⟩, ⟨49561868, 101604214⟩, ⟨5893104, 12504831⟩, ⟨(-16836), 775814⟩, ⟨(-5216), 64816⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4397312963, 4563809781⟩, ⟨49561868, 101604214⟩, ⟨5893104, 12504831⟩, ⟨(-16836), 775814⟩, ⟨(-5216), 64816⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4345838856, 4427348389⟩, ⟨24039965, 50207428⟩, ⟨2573763, 6112735⟩, ⟨(-78940), 369130⟩, ⟨(-11143), 32179⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3371382273, 3765526216⟩, ⟨(-146806001), (-119707258)⟩, ⟨120339, 4300570⟩, ⟨(-295581), 217767⟩, ⟨(-23273), 30320⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5034022677, 7551034027⟩, ⟨1258505665, 1258505674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5900250820, 13275564387⟩, ⟨2950125400, 4425188140⟩, ⟨368765673, 368765680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5900250820, 13275564387⟩, ⟨2950125400, 4425188140⟩, ⟨368765673, 368765680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13275564387), (-5900250820)⟩, ⟨(-4425188140), (-2950125400)⟩, ⟨(-368765680), (-368765673)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6637782194), (-2950125410)⟩, ⟨(-2212594070), (-1475062700)⟩, ⟨(-184382840), (-184382836)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨915728676, 2160985454⟩, ⟨(-1113252622), (-314497671)⟩, ⟨(-38765545), 247439236⟩, ⟨(-33489324), 38518088⟩, ⟨(-10272022), 5145190⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨718811393, 1894600545⟩, ⟨(-1049886357), (-272391187)⟩, ⟨(-25195729), 257153197⟩, ⟨(-39082222), 35195761⟩, ⟨(-10429347), 5995273⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨802541482, 802541483⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4380297126, 4380297129⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar509 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2378
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar509 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨642033186, 963049780⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4345838856, 4427348389⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2379
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((29897 / 200000) : ℝ)..(89691 / 400000), prawitzNormalCorrection
      ((226343 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
