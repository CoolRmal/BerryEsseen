...
namespace FiniteNormalPanel159_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (177989 / 800000)
def radius : Rat := (25427 / 800000)

def j0 : Jet := ⟨⟨955571167, 955571168⟩, ⟨136510166, 136510167⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3002015358, 3002015362⟩, ⟨428859334, 428859338⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2098292161, 2098292167⟩, ⟨599512042, 599512050⟩, ⟨42822288, 42822290⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨525, 526⟩, ⟨150, 151⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94162), (-94160)⟩, ⟨150, 151⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-46003), (-46001)⟩, ⟨(-13071), (-13069)⟩, ⟨(-915), (-910)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5067053, 5067056⟩, ⟨(-13071), (-13069)⟩, ⟨(-915), (-910)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2475492, 2475494⟩, ⟨700897, 700900⟩, ⟨48247, 48253⟩, ⟨(-259), (-255)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140690085), (-140690082)⟩, ⟨700897, 700900⟩, ⟨48247, 48253⟩, ⟨(-259), (-255)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-68733679), (-68733677)⟩, ⟨(-19295775), (-19295770)⟩, ⟨(-1281325), (-1281319)⟩, ⟨13595, 13601⟩, ⟨439, 444⟩⟩
...
def j19 : Jet := ⟨⟨1362922086, 1362922089⟩, ⟨(-19295775), (-19295770)⟩, ⟨(-1281325), (-1281319)⟩, ⟨13595, 13601⟩, ⟨439, 444⟩⟩
...
def j22 : Jet := ⟨⟨(-53), (-52)⟩, ⟨(-16), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11782, 11784⟩, ⟨(-16), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5756, 5758⟩, ⟨1636, 1639⟩, ⟨113, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846421), (-846418)⟩, ⟨1636, 1639⟩, ⟨113, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-413517), (-413514)⟩, ⟨(-117349), (-117346)⟩, ⟨(-8157), (-8152)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35377877, 35377881⟩, ⟨(-117349), (-117346)⟩, ⟨(-8157), (-8152)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17283745, 17283748⟩, ⟨4880881, 4880885⟩, ⟨332362, 332369⟩, ⟨(-2296), (-2289)⟩, ⟨(-79), (-75)⟩⟩
...
def j33 : Jet := ⟨⟨(-698544138), (-698544134)⟩, ⟨4880881, 4880885⟩, ⟨332362, 332369⟩, ⟨(-2296), (-2289)⟩, ⟨(-79), (-75)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-341271445), (-341271441)⟩, ⟨(-95121590), (-95121584)⟩, ⟨(-6121054), (-6121047)⟩, ⟨93934, 93941⟩, ⟨2953, 2959⟩⟩
...
def j36 : Jet := ⟨⟨3953695851, 3953695855⟩, ⟨(-95121590), (-95121584)⟩, ⟨(-6121054), (-6121047)⟩, ⟨93934, 93941⟩, ⟨2953, 2959⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨952629613, 952629617⟩, ⟨122602945, 122602953⟩, ⟨(-2822311), (-2822305)⟩, ⟨(-118441), (-118434)⟩, ⟨1663, 1670⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4665696287, 4665696293⟩, ⟨112251532, 112251542⟩, ⟨9924001, 9924013⟩, ⟨301687, 301699⟩, ⟨16460, 16473⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1034857809, 1034857816⟩, ⟨158083214, 158083227⟩, ⟨2339532, 2339544⟩, ⟨147773, 147789⟩, ⟨4449, 4466⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-955571168), (-955571167)⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3339396128, 3339396129⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨249345480, 249345485⟩, ⟨76179228, 76179236⟩, ⟨6945912, 6945922⟩, ⟨243430, 243442⟩, ⟨14294, 14309⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4544312776, 4544312781⟩, ⟨76179228, 76179236⟩, ⟨6945912, 6945922⟩, ⟨243430, 243442⟩, ⟨14294, 14309⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4417881251, 4417881255⟩, ⟨37029887, 37029892⟩, ⟨3221142, 3221148⟩, ⟨91329, 91337⟩, ⟨5007, 5017⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3434963418, 3434963423⟩, ⟨(-111625588), (-111625581)⟩, ⟨1327533, 1327539⟩, ⟨(-31372), (-31363)⟩, ⟨989, 999⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨47685905448, 47685905456⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value647

def j47 : Jet := ⟨⟨10609458274, 10609458288⟩, ⟨1515636888, 1515636900⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨26207558081, 26207558151⟩, ⟨7487873696, 7487873766⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨26207558081, 26207558151⟩, ⟨7487873696, 7487873766⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-26207558151), (-26207558081)⟩, ⟨(-7487873766), (-7487873696)⟩, ⟨(-534848127), (-534848118)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-13103779076), (-13103779040)⟩, ⟨(-3743936883), (-3743936848)⟩, ⟨(-267424064), (-267424059)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨203209586, 203209593⟩, ⟨(-177138460), (-177138451)⟩, ⟨64553332, 64553339⟩, ⟨(-11404159), (-11404155)⟩, ⟨475568, 475570⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨162519862, 162519869⟩, ⟨(-146950485), (-146950474)⟩, ⟨56294091, 56294100⟩, ⟨(-10854616), (-10854606)⟩, ⟨698025, 698033⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨819061000, 1092081335⟩, ⟨136510166, 136510167⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2573156020, 3430874700⟩, ⟨428859334, 428859338⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1541602402, 2740626505⟩, ⟨513867464, 685156628⟩, ⟨42822288, 42822290⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨385, 687⟩, ⟨128, 172⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94302), (-93999)⟩, ⟨128, 172⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-60175), (-33739)⟩, ⟨(-14999), (-11136)⟩, ⟨(-923), (-901)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5052881, 5079318⟩, ⟨(-14999), (-11136)⟩, ⟨(-923), (-901)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1813642, 3241123⟩, ⟨594976, 806284⟩, ⟨47396, 48988⟩, ⟨(-298), (-215)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141351935), (-139924453)⟩, ⟨594976, 806284⟩, ⟨47396, 48988⟩, ⟨(-298), (-215)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-90196929), (-50223402)⟩, ⟨(-22335677), (-16226642)⟩, ⟨(-1321132), (-1235211)⟩, ⟨11411, 15777⟩, ⟨417, 462⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1341458836, 1381432364⟩, ⟨(-22335677), (-16226642)⟩, ⟨(-1321132), (-1235211)⟩, ⟨11411, 15777⟩, ⟨417, 462⟩⟩
...
def j70 : Jet := ⟨⟨(-69), (-38)⟩, ⟨(-18), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11766, 11798⟩, ⟨(-18), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4223, 7529⟩, ⟨1395, 1879⟩, ⟨112, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847954), (-844647)⟩, ⟨1395, 1879⟩, ⟨112, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-541082), (-303171)⟩, ⟨(-134771), (-99858)⟩, ⟨(-8249), (-8046)⟩, ⟨24, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35250312, 35488224⟩, ⟨(-134771), (-99858)⟩, ⟨(-8249), (-8046)⟩, ⟨24, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12652474, 22645101⟩, ⟨4131493, 5625434⟩, ⟨324693, 338996⟩, ⟨(-2652), (-1932)⟩, ⟨(-82), (-71)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703175409), (-693182781)⟩, ⟨4131493, 5625434⟩, ⟨324693, 338996⟩, ⟨(-2652), (-1932)⟩, ⟨(-82), (-71)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-448697518), (-248805675)⟩, ⟨(-110691454), (-79345624)⟩, ⟨(-6400049), (-5797554)⟩, ⟨78346, 109474⟩, ⟨2760, 3124⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3846269778, 4046161621⟩, ⟨(-110691454), (-79345624)⟩, ⟨(-6400049), (-5797554)⟩, ⟨78346, 109474⟩, ⟨2760, 3124⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨803680829, 1103505806⟩, ⟨116104780, 128216690⟩, ⟨(-3285591), (-2360282)⟩, ⟨(-125082), (-110734)⟩, ⟨1388, 1946⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4559072474, 4796008897⟩, ⟨89403855, 138023912⟩, ⟨8285696, 11952559⟩, ⟨160821, 480785⟩, ⟨7586, 28635⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨853100592, 1232238409⟩, ⟨139973654, 178636652⟩, ⟨298383, 4685949⟩, ⟨8817, 313673⟩, ⟨(-5925), 17027⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1092081335), (-819061000)⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3202885961, 3475906296⟩, ⟨(-136510167), (-136510166)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨169449630, 353532727⟩, ⟨55605362, 102502734⟩, ⟨4680297, 10118698⟩, ⟨22950, 569786⟩, ⟨(-2806), 40979⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4464416926, 4648500023⟩, ⟨55605362, 102502734⟩, ⟨4680297, 10118698⟩, ⟨22950, 569786⟩, ⟨(-2806), 40979⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4378872536, 4468238532⟩, ⟨26724536, 50269321⟩, ⟨1966626, 4880855⟩, ⟨(-44778), 267433⟩, ⟨(-7168), 20171⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3265456615, 3616134275⟩, ⟨(-122088089), (-98494153)⟩, ⟨(-131176), 3100659⟩, ⟨(-191371), 153927⟩, ⟨(-14303), 17749⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9093821375, 12125095188⟩, ⟨1515636888, 1515636900⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨19254532456, 34230280044⟩, ⟨6418177452, 8557570020⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨19254532456, 34230280044⟩, ⟨6418177452, 8557570020⟩, ⟨534848118, 534848127⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-34230280044), (-19254532456)⟩, ⟨(-8557570020), (-6418177452)⟩, ⟨(-534848127), (-534848118)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-17115140022), (-9627266228)⟩, ⟨(-4278785010), (-3209088726)⟩, ⟨(-267424064), (-267424059)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨79859603, 456540147⟩, ⟨(-454820027), (-59669034)⟩, ⟨(-6134671), 221580775⟩, ⟨(-71105131), 20916619⟩, ⟨(-12107763), 17900293⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨60717125, 384382549⟩, ⟨(-395911840), (-47197645)⟩, ⟨(-3810655), 199817477⟩, ⟨(-66514056), 17815320⟩, ⟨(-10813257), 17274439⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨955571167, 955571168⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨136510166, 136510167⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4417881251, 4417881255⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar647 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3218
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar647 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨819061000, 1092081335⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4378872536, 4468238532⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3219
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((76281 / 400000) : ℝ)..(25427 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (76281 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (25427 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((76281 / 400000) : ℝ)..(25427 / 100000), prawitzNormalCorrection
      ((269281 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
