...
namespace FiniteNormalPanel120_17

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (13839 / 50000)
def radius : Rat := (1977 / 50000)

def j0 : Jet := ⟨⟨1188761048, 1188761049⟩, ⟨169823006, 169823007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3734602975, 3734602979⟩, ⟨533514708, 533514712⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3247349378, 3247349386⟩, ⟨927814102, 927814112⟩, ⟨66272435, 66272437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨812, 814⟩, ⟨232, 233⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93875), (-93872)⟩, ⟨232, 233⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-70978), (-70974)⟩, ⟨(-20105), (-20101)⟩, ⟨(-1387), (-1384)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5042078, 5042083⟩, ⟨(-20105), (-20101)⟩, ⟨(-1387), (-1384)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3812226, 3812231⟩, ⟨1074005, 1074011⟩, ⟨72407, 72413⟩, ⟨(-607), (-601)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-139353351), (-139353345)⟩, ⟨1074005, 1074011⟩, ⟨72407, 72413⟩, ⟨(-607), (-601)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-105362623), (-105362617)⟩, ⟨(-29291571), (-29291563)⟩, ⟨(-1863503), (-1863494)⟩, ⟨31754, 31762⟩, ⟨969, 976⟩⟩
...
def j19 : Jet := ⟨⟨1326293142, 1326293149⟩, ⟨(-29291571), (-29291563)⟩, ⟨(-1863503), (-1863494)⟩, ⟨31754, 31762⟩, ⟨969, 976⟩⟩
...
def j22 : Jet := ⟨⟨(-82), (-80)⟩, ⟨(-24), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11753, 11756⟩, ⟨(-24), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8886, 8889⟩, ⟨2519, 2523⟩, ⟨173, 178⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843291), (-843287)⟩, ⟨2519, 2523⟩, ⟨173, 178⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-637598), (-637594)⟩, ⟨(-180267), (-180261)⟩, ⟨(-12339), (-12331)⟩, ⟨73, 78⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35153796, 35153801⟩, ⟨(-180267), (-180261)⟩, ⟨(-12339), (-12331)⟩, ⟨73, 78⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨26579168, 26579172⟩, ⟨7457750, 7457758⟩, ⟨494159, 494170⟩, ⟨(-5393), (-5385)⟩, ⟨(-176), (-170)⟩⟩
...
def j33 : Jet := ⟨⟨(-689248715), (-689248710)⟩, ⟨7457750, 7457758⟩, ⟨494159, 494170⟩, ⟨(-5393), (-5385)⟩, ⟨(-176), (-170)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-521128856), (-521128850)⟩, ⟨(-143255286), (-143255276)⟩, ⟨(-8650610), (-8650596)⟩, ⟨217745, 217758⟩, ⟨6324, 6335⟩⟩
...
def j36 : Jet := ⟨⟨3773838440, 3773838446⟩, ⟨(-143255286), (-143255276)⟩, ⟨(-8650610), (-8650596)⟩, ⟨217745, 217758⟩, ⟨6324, 6335⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1153251694, 1153251703⟩, ⟨139280340, 139280351⟩, ⟨(-5258930), (-5258919)⟩, ⟨(-203871), (-203861)⟩, ⟨4786, 4795⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4888058759, 4888058768⟩, ⟨185551187, 185551202⟩, ⟨18248211, 18248234⟩, ⟨835981, 836004⟩, ⟨54649, 54670⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1312504067, 1312504080⟩, ⟨208336325, 208336344⟩, ⟨4931923, 4931945⟩, ⟨357016, 357039⟩, ⟨16076, 16099⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1188761049), (-1188761048)⟩, ⟨(-169823007), (-169823006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3106206247, 3106206248⟩, ⟨(-169823007), (-169823006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨401089649, 401089658⟩, ⟨127331480, 127331496⟩, ⟨13120090, 13120107⟩, ⟨696666, 696686⟩, ⟨50121, 50142⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4696056945, 4696056954⟩, ⟨127331480, 127331496⟩, ⟨13120090, 13120107⟩, ⟨696666, 696686⟩, ⟨50121, 50142⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4491036739, 4491036745⟩, ⟨60886224, 60886233⟩, ⟨5860920, 5860930⟩, ⟨253666, 253678⟩, ⟨16702, 16714⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3248007589, 3248007595⟩, ⟨(-133541460), (-133541449)⟩, ⟨1831292, 1831301⟩, ⟨(-48286), (-48274)⟩, ⟨2048, 2059⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨30241733279, 30241733286⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value515

def j47 : Jet := ⟨⟨8370306935, 8370306945⟩, ⟨1195758127, 1195758135⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16312589446, 16312589486⟩, ⟨4660739816, 4660739854⟩, ⟨332909985, 332909990⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16312589446, 16312589486⟩, ⟨4660739816, 4660739854⟩, ⟨332909985, 332909990⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16312589486), (-16312589446)⟩, ⟨(-4660739854), (-4660739816)⟩, ⟨(-332909990), (-332909985)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8156294743), (-8156294723)⟩, ⟨(-2330369927), (-2330369908)⟩, ⟨(-166454995), (-166454992)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨643012304, 643012314⟩, ⟨(-348886606), (-348886596)⟩, ⟨69729238, 69729244⟩, ⟨(-3597009), (-3597006)⟩, ⟨(-863290), (-863289)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨486268858, 486268867⟩, ⟨(-283833396), (-283833384)⟩, ⟨63853676, 63853687⟩, ⟨(-5044237), (-5044228)⟩, ⟨(-507053), (-507044)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1018938041, 1358584056⟩, ⟨169823006, 169823007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3201088263, 4268117690⟩, ⟨533514708, 533514712⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2385807704, 4241435932⟩, ⟨795269230, 1060358986⟩, ⟨66272435, 66272437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨597, 1063⟩, ⟨199, 266⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94090), (-93623)⟩, ⟨199, 266⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-92918), (-52006)⟩, ⟨(-23120), (-17072)⟩, ⟨(-1408), (-1361)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5020138, 5061051⟩, ⟨(-23120), (-17072)⟩, ⟨(-1408), (-1361)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2788632, 4997972⟩, ⟨906712, 1240010⟩, ⟨70363, 74177⟩, ⟨(-703), (-505)⟩, ⟨(-22), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140376945), (-138167604)⟩, ⟨906712, 1240010⟩, ⟨70363, 74177⟩, ⟨(-703), (-505)⟩, ⟨(-22), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-138627323), (-76750603)⟩, ⟨(-34153163), (-24358979)⟩, ⟨(-1959078), (-1752569)⟩, ⟨26323, 37168⟩, ⟨889, 1043⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1293028442, 1354905163⟩, ⟨(-34153163), (-24358979)⟩, ⟨(-1959078), (-1752569)⟩, ⟨26323, 37168⟩, ⟨889, 1043⟩⟩
...
def j70 : Jet := ⟨⟨(-107), (-59)⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11728, 11777⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6514, 11631⟩, ⟨2144, 2898⟩, ⟨171, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845663), (-840545)⟩, ⟨2144, 2898⟩, ⟨171, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-835123), (-466913)⟩, ⟨(-207591), (-152775)⟩, ⟨(-12559), (-12076)⟩, ⟨62, 90⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34956271, 35324482⟩, ⟨(-207591), (-152775)⟩, ⟨(-12559), (-12076)⟩, ⟨62, 90⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19417829, 34884207⟩, ⟨6267605, 8636188⟩, ⟨475730, 510070⟩, ⟨(-6271), (-4504)⟩, ⟨(-183), (-160)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696410054), (-680943675)⟩, ⟨6267605, 8636188⟩, ⟨475730, 510070⟩, ⟨(-6271), (-4504)⟩, ⟨(-183), (-160)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-687730179), (-378256818)⟩, ⟨(-168450960), (-117557056)⟩, ⟨(-9320995), (-7871282)⟩, ⟨178604, 256687⟩, ⟨5610, 6950⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3607237117, 3916710478⟩, ⟨(-168450960), (-117557056)⟩, ⟨(-9320995), (-7871282)⟩, ⟨178604, 256687⟩, ⟨5610, 6950⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨963708890, 1346435094⟩, ⟨126678489, 150149362⟩, ⟨(-6189289), (-4332046)⟩, ⟨(-223736), (-180765)⟩, ⟨3931, 5654⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4709754314, 5113815221⟩, ⟨141359656, 238805230⟩, ⟨13707836, 24365690⟩, ⟨360372, 1521706⟩, ⟨13637, 119700⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1056779199, 1603136836⟩, ⟨170630895, 253639146⟩, ⟨(-124167), 11236503⟩, ⟨(-125357), 988050⟩, ⟨(-29555), 77680⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1358584056), (-1018938041)⟩, ⟨(-169823007), (-169823006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2936383240, 3276029255⟩, ⟨(-169823007), (-169823006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨260021136, 598385864⟩, ⟨83967660, 189346382⟩, ⟨6686147, 23366914⟩, ⟨(-108248), 2064742⟩, ⟨(-37195), 204087⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4554988432, 4893353160⟩, ⟨83967660, 189346382⟩, ⟨6686147, 23366914⟩, ⟨(-108248), 2064742⟩, ⟨(-37195), 204087⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4423067527, 4584407464⟩, ⟨39333147, 91931280⟩, ⟨2210255, 11170194⟩, ⟨(-284724), 982817⟩, ⟨(-52592), 104455⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3023962805, 3496802638⟩, ⟨(-154376187), (-104766585)⟩, ⟨(-2123856), 6964946⟩, ⟨(-658847), 662261⟩, ⟨(-78977), 90933⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7174548800, 9566065080⟩, ⟨1195758127, 1195758135⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11984759588, 21306239329⟩, ⟨3994919840, 5326559834⟩, ⟨332909985, 332909990⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11984759588, 21306239329⟩, ⟨3994919840, 5326559834⟩, ⟨332909985, 332909990⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21306239329), (-11984759588)⟩, ⟨(-5326559834), (-3994919840)⟩, ⟨(-332909990), (-332909985)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10653119665), (-5992379794)⟩, ⟨(-2663279917), (-1997459920)⟩, ⟨(-166454995), (-166454992)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨359540383, 1064211663⟩, ⟨(-659910392), (-167211402)⟩, ⟨(-2361907), 190668683⟩, ⟨(-35090507), 17538449⟩, ⟨(-6413630), 5485615⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨253142031, 866441557⟩, ⟨(-575525999), (-126498955)⟩, ⟨1629537, 180680627⟩, ⟨(-36656084), 14854470⟩, ⟨(-6067745), 6160422⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1188761048, 1188761049⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4491036739, 4491036745⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar515 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2422
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar515 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1018938041, 1358584056⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4423067527, 4584407464⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2423
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((5931 / 25000) : ℝ)..(1977 / 6250), prawitzNormalCorrection
      ((101631 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
