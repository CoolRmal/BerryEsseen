...
namespace FiniteNormalPanel28_21
...
def j2 : Jet := ⟨⟨615417448, 615417452⟩, ⟨615417448, 615417452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨88181960, 88181962⟩, ⟨176363920, 176363924⟩, ⟨88181960, 88181962⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨22, 23⟩, ⟨44, 45⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94665), (-94663)⟩, ⟨44, 45⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1944), (-1943)⟩, ⟨(-3888), (-3886)⟩, ⟨(-1943), (-1940)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111112, 5111114⟩, ⟨(-3888), (-3886)⟩, ⟨(-1943), (-1940)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨104938, 104939⟩, ⟨209797, 209799⟩, ⟨104738, 104741⟩, ⟨(-160), (-157)⟩, ⟨(-40), (-37)⟩⟩
...
def j16 : Jet := ⟨⟨(-143060639), (-143060637)⟩, ⟨209797, 209799⟩, ⟨104738, 104741⟩, ⟨(-160), (-157)⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2937245), (-2937244)⟩, ⟨(-5870182), (-5870180)⟩, ⟨(-2926481), (-2926478)⟩, ⟨8603, 8606⟩, ⟨2142, 2145⟩⟩
...
def j19 : Jet := ⟨⟨1428718520, 1428718522⟩, ⟨(-5870182), (-5870180)⟩, ⟨(-2926481), (-2926478)⟩, ⟨8603, 8606⟩, ⟨2142, 2145⟩⟩
...
def j25 : Jet := ⟨⟨242, 243⟩, ⟨484, 486⟩, ⟨240, 243⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851935), (-851933)⟩, ⟨484, 486⟩, ⟨240, 243⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-17492), (-17491)⟩, ⟨(-34974), (-34972)⟩, ⟨(-17469), (-17466)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35773902, 35773904⟩, ⟨(-34974), (-34972)⟩, ⟨(-17469), (-17466)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨734490, 734491⟩, ⟨1468262, 1468264⟩, ⟨732694, 732697⟩, ⟨(-1437), (-1434)⟩, ⟨(-359), (-356)⟩⟩
...
def j33 : Jet := ⟨⟨(-715093393), (-715093391)⟩, ⟨1468262, 1468264⟩, ⟨732694, 732697⟩, ⟨(-1437), (-1434)⟩, ⟨(-359), (-356)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-14681914), (-14681913)⟩, ⟨(-29333683), (-29333680)⟩, ⟨(-14606580), (-14606577)⟩, ⟨60201, 60204⟩, ⟨14975, 14979⟩⟩
...
def j36 : Jet := ⟨⟨4280285382, 4280285383⟩, ⟨(-29333683), (-29333680)⟩, ⟨(-14606580), (-14606577)⟩, ⟨60201, 60204⟩, ⟨14975, 14979⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨204718277, 204718279⟩, ⟨203877150, 203877153⟩, ⟨(-1260457), (-1260455)⟩, ⟨(-418098), (-418095)⟩, ⟨1538, 1542⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4309699569, 4309699571⟩, ⟨29535261, 29535266⟩, ⟨14909364, 14909370⟩, ⟨142347, 142354⟩, ⟨36354, 36364⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨205420486, 205420489⟩, ⟨205984263, 205984268⟩, ⟨847873, 847879⟩, ⟨286313, 286321⟩, ⟨2780, 2790⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-195893459), (-195893458)⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4099073837, 4099073838⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨9824888, 9824890⟩, ⟨19703706, 19703708⟩, ⟨9959995, 9959999⟩, ⟨108712, 108718⟩, ⟨27893, 27900⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4304792184, 4304792186⟩, ⟨19703706, 19703708⟩, ⟨9959995, 9959999⟩, ⟨108712, 108718⟩, ⟨27893, 27900⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299876933, 4299876935⟩, ⟨9840604, 9840606⟩, ⟨4963050, 4963054⟩, ⟨42934, 42939⟩, ⟨10966, 10972⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4103759545, 4103759549⟩, ⟨(-186725614), (-186725610)⟩, ⟨4287854, 4287861⟩, ⟨(-185390), (-185383)⟩, ⟨8506, 8514⟩⟩
...
def j47 : Jet := ⟨⟨1092670201, 1092670208⟩, ⟨1092670201, 1092670208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨277983063, 277983068⟩, ⟨555966126, 555966136⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨277983063, 277983068⟩, ⟨555966126, 555966136⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-277983068), (-277983063)⟩, ⟨(-555966136), (-555966126)⟩, ⟨(-277983068), (-277983063)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-138991534), (-138991531)⟩, ⟨(-277983068), (-277983063)⟩, ⟨(-138991534), (-138991531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4158200683, 4158200687⟩, ⟨(-269131126), (-269131120)⟩, ⟨(-125856080), (-125856075)⟩, ⟨8521581, 8521583⟩, ⟨1898559, 1898560⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3973081648, 3973081656⟩, ⟨(-437929297), (-437929285)⟩, ⟨(-104401184), (-104401168)⟩, ⟨13165683, 13165697⟩, ⟨1337760, 1337772⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 391786917⟩, ⟨195893458, 195893459⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1230834901⟩, ⟨615417448, 615417452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 352727844⟩, ⟨0, 352727846⟩, ⟨88181960, 88181962⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 89⟩, ⟨0, 89⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94597)⟩, ⟨0, 89⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-7777), 0⟩, ⟨(-7777), 8⟩, ⟨(-1945), (-1932)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5105279, 5113057⟩, ⟨(-7777), 8⟩, ⟨(-1945), (-1932)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 419915⟩, ⟨(-639), 419916⟩, ⟨104019, 104980⟩, ⟨(-320), 2⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142745661)⟩, ⟨(-639), 419916⟩, ⟨104019, 104980⟩, ⟨(-320), 2⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-11757595), 0⟩, ⟨(-11757648), 34486⟩, ⟨(-2939452), (-2887669)⟩, ⟨(-41), 17245⟩, ⟨2104, 2157⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1419898170, 1431655766⟩, ⟨(-11757648), 34486⟩, ⟨(-2939452), (-2887669)⟩, ⟨(-41), 17245⟩, ⟨2104, 2157⟩⟩
...
def j72 : Jet := ⟨⟨0, 973⟩, ⟨(-1), 973⟩, ⟨240, 244⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851203)⟩, ⟨(-1), 973⟩, ⟨240, 244⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-69986), 0⟩, ⟨(-69987), 80⟩, ⟨(-17498), (-17375)⟩, ⟨(-2), 41⟩, ⟨2, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35721408, 35791395⟩, ⟨(-69987), 80⟩, ⟨(-17498), (-17375)⟩, ⟨(-2), 41⟩, ⟨2, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2939399⟩, ⟨(-5748), 2939406⟩, ⟨726226, 734857⟩, ⟨(-2876), 6⟩, ⟨(-361), (-351)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712888483)⟩, ⟨(-5748), 2939406⟩, ⟨726226, 734857⟩, ⟨(-2876), 6⟩, ⟨(-361), (-351)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-58787975), 0⟩, ⟨(-58788448), 241402⟩, ⟨(-14697467), (-14334890)⟩, ⟨(-356), 120703⟩, ⟨14643, 15089⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4236179321, 4294967296⟩, ⟨(-58788448), 241402⟩, ⟨(-14697467), (-14334890)⟩, ⟨(-356), 120703⟩, ⟨14643, 15089⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 410278301⟩, ⟨200084965, 205149034⟩, ⟨(-2527108), 4942⟩, ⟨(-421201), (-408825)⟩, ⟨(-6), 3091⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4354571107⟩, ⟨(-248150), 60431456⟩, ⟨14331493, 15946880⟩, ⟨(-125849), 431341⟩, ⟨29111, 46477⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 415971977⟩, ⟨200061260, 213768746⟩, ⟨(-2574032), 4414851⟩, ⟨193018, 394230⟩, ⟨(-21329), 28221⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-391786917), 0⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3903180379, 4294967296⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 40287312⟩, ⟨0, 41407444⟩, ⟨8820335, 11494846⟩, ⟨(-256230), 515836⟩, ⟨11202, 49251⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4335254608⟩, ⟨0, 41407444⟩, ⟨8820335, 11494846⟩, ⟨(-256230), 515836⟩, ⟨11202, 49251⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4315063935⟩, ⟨0, 20703722⟩, ⟨4339959, 5747423⟩, ⟨(-155821), 257918⟩, ⟨508, 23185⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3903180379, 4315063935⟩, ⟨(-196810067), (-175189736)⟩, ⟨2999770, 5747423⟩, ⟨(-417961), 59973⟩, ⟨(-11303), 30292⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2185340409⟩, ⟨1092670201, 1092670208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1111932263⟩, ⟨0, 1111932268⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1111932263⟩, ⟨0, 1111932268⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1111932263), 0⟩, ⟨(-1111932268), 0⟩, ⟨(-277983068), (-277983063)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-555966132), 0⟩, ⟨(-555966134), 0⟩, ⟨(-138991534), (-138991531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3773481267, 4294967296⟩, ⟨(-555966134), 0⟩, ⟨(-138991534), (-86131684)⟩, ⟨0, 17991892⟩, ⟨811430, 2248987⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3429264305, 4315063935⟩, ⟨(-755377630), (-153918561)⟩, ⟨(-137006348), (-47051061)⟩, ⟨2351329, 24505119⟩, ⟨(-292102), 2283750⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299876933, 4299876935⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified564
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4315063935⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified565
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (179645841 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(4561 / 50000), prawitzNormalCorrection
