...
namespace FiniteNormalPanel89_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (217189 / 800000)
def radius : Rat := (31027 / 800000)

def j0 : Jet := ⟨⟨1166024565, 1166024566⟩, ⟨166574937, 166574938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3663174207, 3663174211⟩, ⟨523310598, 523310602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3124318381, 3124318389⟩, ⟨892662388, 892662398⟩, ⟨63761598, 63761600⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨781, 783⟩, ⟨223, 224⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93906), (-93903)⟩, ⟨223, 224⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-68311), (-68308)⟩, ⟨(-19356), (-19353)⟩, ⟨(-1339), (-1335)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5044745, 5044749⟩, ⟨(-19356), (-19353)⟩, ⟨(-1339), (-1335)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3669734, 3669738⟩, ⟨1034414, 1034419⟩, ⟨69894, 69900⟩, ⟨(-563), (-558)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-139495843), (-139495838)⟩, ⟨1034414, 1034419⟩, ⟨69894, 69900⟩, ⟨(-563), (-558)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-101474447), (-101474442)⟩, ⟨(-28240228), (-28240222)⟩, ⟨(-1805074), (-1805065)⟩, ⟨29472, 29480⟩, ⟨905, 912⟩⟩
...
def j19 : Jet := ⟨⟨1330181318, 1330181324⟩, ⟨(-28240228), (-28240222)⟩, ⟨(-1805074), (-1805065)⟩, ⟨29472, 29480⟩, ⟨905, 912⟩⟩
...
def j25 : Jet := ⟨⟨8551, 8554⟩, ⟨2426, 2428⟩, ⟨167, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843626), (-843622)⟩, ⟨2426, 2428⟩, ⟨167, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-613685), (-613681)⟩, ⟨(-173575), (-173570)⟩, ⟨(-11900), (-11894)⟩, ⟨68, 73⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35177709, 35177714⟩, ⟨(-173575), (-173570)⟩, ⟨(-11900), (-11894)⟩, ⟨68, 73⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25589569, 25589573⟩, ⟨7185040, 7185046⟩, ⟨477503, 477511⟩, ⟨(-5002), (-4994)⟩, ⟨(-163), (-157)⟩⟩
...
def j33 : Jet := ⟨⟨(-690238314), (-690238309)⟩, ⟨7185040, 7185046⟩, ⟨477503, 477511⟩, ⟨(-5002), (-4994)⟩, ⟨(-163), (-157)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-502104931), (-502104925)⟩, ⟨(-138231888), (-138231880)⟩, ⟨(-8406355), (-8406345)⟩, ⟨202270, 202281⟩, ⟨5929, 5938⟩⟩
...
def j36 : Jet := ⟨⟨3792862365, 3792862371⟩, ⟨(-138231888), (-138231880)⟩, ⟨(-8406355), (-8406345)⟩, ⟨202270, 202281⟩, ⟨5929, 5938⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1134510593, 1134510600⟩, ⟨137986871, 137986881⟩, ⟨(-4980414), (-4980404)⟩, ⟨(-194800), (-194790)⟩, ⟨4361, 4370⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4863541639, 4863541648⟩, ⟨177253070, 177253084⟩, ⟨17239388, 17239406⟩, ⟨761766, 761785⟩, ⟨48900, 48919⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1284698841, 1284698852⟩, ⟨203074975, 203074992⟩, ⟨4608745, 4608764⟩, ⟨328948, 328969⟩, ⟨14296, 14318⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1166024566), (-1166024565)⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3128942730, 3128942731⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨384275594, 384275602⟩, ⟨121486458, 121486472⟩, ⟨12358916, 12358931⟩, ⟨632610, 632626⟩, ⟨44603, 44622⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4679242890, 4679242898⟩, ⟨121486458, 121486472⟩, ⟨12358916, 12358931⟩, ⟨632610, 632626⟩, ⟨44603, 44622⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4482989536, 4482989541⟩, ⟨58195581, 58195589⟩, ⟨5542552, 5542561⟩, ⟨231087, 231098⟩, ⟨14939, 14950⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3265919517, 3265919522⟩, ⟨(-131470866), (-131470857)⟩, ⟨1780781, 1780790⟩, ⟨(-46612), (-46601)⟩, ⟨1920, 1930⟩⟩
...
def j47 : Jet := ⟨⟨8758162090, 8758162099⟩, ⟨1251166006, 1251166015⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17859368397, 17859368435⟩, ⟨5102676656, 5102676700⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17859368397, 17859368435⟩, ⟨5102676656, 5102676700⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17859368435), (-17859368397)⟩, ⟨(-5102676700), (-5102676656)⟩, ⟨(-364476908), (-364476902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8929684218), (-8929684198)⟩, ⟨(-2551338350), (-2551338328)⟩, ⟨(-182238454), (-182238451)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨537052087, 537052099⟩, ⟨(-319024925), (-319024914)⟩, ⟨71967649, 71967655⟩, ⟨(-5226011), (-5226008)⟩, ⟨(-750718), (-750716)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨408377706, 408377716⟩, ⟨(-259027919), (-259027906)⟩, ⟨64712808, 64712818⟩, ⟨(-6314958), (-6314950)⟩, ⟨(-377341), (-377333)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨999449627, 1332599503⟩, ⟨166574937, 166574938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3139863605, 4186484809⟩, ⟨523310598, 523310602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2295417584, 4080742378⟩, ⟨765139190, 1020185598⟩, ⟨63761598, 63761600⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨574, 1023⟩, ⟨191, 256⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94113), (-93663)⟩, ⟨191, 256⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-89419), (-50057)⟩, ⟨(-22253), (-16441)⟩, ⟨(-1356), (-1313)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5023637, 5063000⟩, ⟨(-22253), (-16441)⟩, ⟨(-1356), (-1313)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2684850, 4810468⟩, ⟨873806, 1193831⟩, ⟨68004, 71535⟩, ⟨(-652), (-469)⟩, ⟨(-21), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140480727), (-138355108)⟩, ⟨873806, 1193831⟩, ⟨68004, 71535⟩, ⟨(-652), (-469)⟩, ⟨(-21), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-133473812), (-73942995)⟩, ⟨(-32901455), (-23513380)⟩, ⟨(-1893519), (-1702433)⟩, ⟨24466, 34466⟩, ⟨834, 971⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1298181953, 1357712771⟩, ⟨(-32901455), (-23513380)⟩, ⟨(-1893519), (-1702433)⟩, ⟨24466, 34466⟩, ⟨834, 971⟩⟩
...
def j72 : Jet := ⟨⟨6270, 11192⟩, ⟨2065, 2788⟩, ⟨165, 172⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845907), (-840984)⟩, ⟨2065, 2788⟩, ⟨165, 172⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-803715), (-449458)⟩, ⟨(-199826), (-147170)⟩, ⟨(-12104), (-11657)⟩, ⟨57, 83⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34987679, 35341937⟩, ⟨(-199826), (-147170)⟩, ⟨(-12104), (-11657)⟩, ⟨57, 83⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18698939, 33579148⟩, ⟨6043119, 8316133⟩, ⟨460448, 492227⟩, ⟨(-5813), (-4181)⟩, ⟨(-170), (-150)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697128944), (-682248734)⟩, ⟨6043119, 8316133⟩, ⟨460448, 492227⟩, ⟨(-5813), (-4181)⟩, ⟨(-170), (-150)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-662357460), (-364623437)⟩, ⟨(-162359661), (-113639805)⟩, ⟨(-9026685), (-7685417)⟩, ⟨166217, 238144⟩, ⟨5292, 6484⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3632609836, 3930343859⟩, ⟨(-162359661), (-113639805)⟩, ⟨(-9026685), (-7685417)⟩, ⟨166217, 238144⟩, ⟨5292, 6484⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨949044308, 1323419598⟩, ⟨126103621, 148237842⟩, ⟨(-5854497), (-4109508)⟩, ⟨(-212826), (-173833)⟩, ⟨3590, 5147⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4693417353, 5078096715⟩, ⟨135702892, 226965763⟩, ⟨13101172, 22762827⟩, ⟨336464, 1366620⟩, ⟨13214, 104602⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1037088461, 1564727331⟩, ⟨167788234, 245202576⟩, ⟨(-42722), 10356786⟩, ⟨(-102004), 886943⟩, ⟨(-25556), 67459⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1332599503), (-999449627)⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2962367793, 3295517669⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨250421575, 570055941⟩, ⟨81030298, 178662676⟩, ⟨6523725, 21545077⟩, ⟨(-79204), 1828808⟩, ⟨(-30374), 175403⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4545388871, 4865023237⟩, ⟨81030298, 178662676⟩, ⟨6523725, 21545077⟩, ⟨(-79204), 1828808⟩, ⟨(-30374), 175403⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4418404298, 4571117555⟩, ⟨38067548, 86835688⟩, ⟨2240015, 10307598⟩, ⟨(-241074), 869560⟩, ⟨(-43877), 89423⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3047505996, 3507407073⟩, ⟨(-151028752), (-104733479)⟩, ⟨(-1822809), 6432593⟩, ⟨(-584744), 580336⟩, ⟨(-67392), 77965⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7506996076, 10009328106⟩, ⟨1251166006, 1251166015⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13121168614, 23326522004⟩, ⟨4373722848, 5831630510⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13121168614, 23326522004⟩, ⟨4373722848, 5831630510⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23326522004), (-13121168614)⟩, ⟨(-5831630510), (-4373722848)⟩, ⟨(-364476908), (-364476902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11663261002), (-6560584307)⟩, ⟨(-2915815255), (-2186861424)⟩, ⟨(-182238454), (-182238451)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨284187617, 932336831⟩, ⟨(-632955217), (-144699340)⟩, ⟨(-2721540), 202795568⟩, ⟨(-41798910), 18520364⟩, ⟨(-7445707), 7151966⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨201646114, 761375948⟩, ⟨(-549676194), (-109601780)⟩, ⟨910330, 189263001⟩, ⟨(-42340367), 15614629⟩, ⟨(-6917878), 7717174⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1166024565, 1166024566⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4482989536, 4482989541⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1800
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨999449627, 1332599503⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4418404298, 4571117555⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1801
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (33469763 / 4294967296)

theorem envelope_integral : (∫ s in ((93081 / 400000) : ℝ)..(31027 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((93081 / 400000) : ℝ)..(31027 / 100000), prawitzNormalCorrection
