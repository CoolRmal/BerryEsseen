...
namespace FiniteNormalPanel29_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1469 / 16000)
def radius : Rat := (1469 / 16000)

def j0 : Jet := ⟨⟨394331684, 394331685⟩, ⟨394331684, 394331685⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1238829521, 1238829525⟩, ⟨1238829521, 1238829525⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨357324858, 357324861⟩, ⟨714649716, 714649722⟩, ⟨357324858, 357324861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨89, 90⟩, ⟨178, 180⟩, ⟨89, 90⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94598), (-94596)⟩, ⟨178, 180⟩, ⟨89, 90⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-7871), (-7870)⟩, ⟨(-15727), (-15725)⟩, ⟨(-7835), (-7832)⟩, ⟨28, 30⟩, ⟨7, 8⟩⟩
...
def j13 : Jet := ⟨⟨5105185, 5105187⟩, ⟨(-15727), (-15725)⟩, ⟨(-7835), (-7832)⟩, ⟨28, 30⟩, ⟨7, 8⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨424731, 424733⟩, ⟨848154, 848157⟩, ⟨421462, 421466⟩, ⟨(-2611), (-2608)⟩, ⟨(-648), (-645)⟩⟩
...
def j16 : Jet := ⟨⟨(-142740846), (-142740843)⟩, ⟨848154, 848157⟩, ⟨421462, 421466⟩, ⟨(-2611), (-2608)⟩, ⟨(-648), (-645)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-11875493), (-11875492)⟩, ⟨(-23680423), (-23680420)⟩, ⟨(-11699303), (-11699300)⟩, ⟨140473, 140477⟩, ⟨34575, 34579⟩⟩
...
def j19 : Jet := ⟨⟨1419780272, 1419780274⟩, ⟨(-23680423), (-23680420)⟩, ⟨(-11699303), (-11699300)⟩, ⟨140473, 140477⟩, ⟨34575, 34579⟩⟩
...
def j25 : Jet := ⟨⟨983, 985⟩, ⟨1965, 1968⟩, ⟨979, 983⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851194), (-851191)⟩, ⟨1965, 1968⟩, ⟨979, 983⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-70817), (-70815)⟩, ⟨(-141470), (-141467)⟩, ⟨(-70410), (-70405)⟩, ⟨324, 328⟩, ⟨79, 82⟩⟩
...
def j30 : Jet := ⟨⟨35720577, 35720580⟩, ⟨(-141470), (-141467)⟩, ⟨(-70410), (-70405)⟩, ⟨324, 328⟩, ⟨79, 82⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2971815, 2971816⟩, ⟨5931860, 5931863⟩, ⟨2942417, 2942420⟩, ⟨(-23460), (-23455)⟩, ⟨(-5799), (-5795)⟩⟩
...
def j33 : Jet := ⟨⟨(-712856068), (-712856066)⟩, ⟨5931860, 5931863⟩, ⟨2942417, 2942420⟩, ⟨(-23460), (-23455)⟩, ⟨(-5799), (-5795)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-59306900), (-59306899)⟩, ⟨(-118120292), (-118120289)⟩, ⟨(-58075087), (-58075083)⟩, ⟨981151, 981155⟩, ⟨240410, 240415⟩⟩
...
def j36 : Jet := ⟨⟨4235660396, 4235660397⟩, ⟨(-118120292), (-118120289)⟩, ⟨(-58075087), (-58075083)⟩, ⟨981151, 981155⟩, ⟨240410, 240415⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨409517836, 409517839⟩, ⟨402687514, 402687519⟩, ⟨(-10204840), (-10204836)⟩, ⟨(-3334001), (-3333997)⟩, ⟨50489, 50493⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4355104598, 4355104600⟩, ⟨121451241, 121451246⟩, ⟨63099702, 63099711⟩, ⟨2416060, 2416068⟩, ⟨657206, 657216⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨415251825, 415251829⟩, ⟨419906035, 419906044⟩, ⟨7055746, 7055755⟩, ⟨2477215, 2477226⟩, ⟨96179, 96190⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-394331685), (-394331684)⟩, ⟨(-394331685), (-394331684)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3900635611, 3900635612⟩, ⟨(-394331685), (-394331684)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨40147937, 40147939⟩, ⟨81195844, 81195848⟩, ⟨42417296, 42417302⟩, ⟨1858648, 1858654⟩, ⟨514565, 514574⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4335115233, 4335115235⟩, ⟨81195844, 81195848⟩, ⟨42417296, 42417302⟩, ⟨1858648, 1858654⟩, ⟨514565, 514574⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4314994571, 4314994573⟩, ⟨40409493, 40409497⟩, ⟨20920996, 20921000⟩, ⟨729087, 729092⟩, ⟨198542, 198549⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3918824131, 3918824135⟩, ⟨(-359471044), (-359471037)⟩, ⟨15290090, 15290095⟩, ⟨(-1258663), (-1258655)⟩, ⟨113373, 113381⟩⟩
...
def j47 : Jet := ⟨⟨2147049266, 2147049272⟩, ⟨2147049266, 2147049272⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1073307485, 1073307492⟩, ⟨2146614970, 2146614984⟩, ⟨1073307485, 1073307492⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1073307485, 1073307492⟩, ⟨2146614970, 2146614984⟩, ⟨1073307485, 1073307492⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1073307492), (-1073307485)⟩, ⟨(-2146614984), (-2146614970)⟩, ⟨(-1073307492), (-1073307485)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-536653746), (-536653742)⟩, ⟨(-1073307492), (-1073307485)⟩, ⟨(-536653746), (-536653742)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3790486988, 3790486993⟩, ⟨(-947238433), (-947238424)⟩, ⟨(-355262310), (-355262302)⟩, ⟨108497820, 108497824⟩, ⟨15416540, 15416543⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3458525025, 3458525034⟩, ⟨(-1181529637), (-1181529620)⟩, ⟨(-231375186), (-231375168)⟩, ⟨124246828, 124246845⟩, ⟨4098486, 4098504⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 788663370⟩, ⟨394331684, 394331685⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2477659050⟩, ⟨1238829521, 1238829525⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1429299444⟩, ⟨0, 1429299444⟩, ⟨357324858, 357324861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 359⟩, ⟨0, 359⟩, ⟨89, 90⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94327)⟩, ⟨0, 359⟩, ⟨89, 90⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-31511), 0⟩, ⟨(-31511), 120⟩, ⟨(-7878), (-7697)⟩, ⟨0, 60⟩, ⟨7, 8⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5081545, 5113057⟩, ⟨(-31511), 120⟩, ⟨(-7878), (-7697)⟩, ⟨0, 60⟩, ⟨7, 8⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1701548⟩, ⟨(-10487), 1701588⟩, ⟨409656, 425427⟩, ⟨(-5244), 30⟩, ⟨(-656), (-617)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141464028)⟩, ⟨(-10487), 1701588⟩, ⟨409656, 425427⟩, ⟨(-5244), 30⟩, ⟨(-656), (-617)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-47643315), 0⟩, ⟨(-47646805), 566263⟩, ⟨(-11914319), (-11061427)⟩, ⟨(-2619), 283152⟩, ⟨32116, 35404⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1384012450, 1431655766⟩, ⟨(-47646805), 566263⟩, ⟨(-11914319), (-11061427)⟩, ⟨(-2619), 283152⟩, ⟨32116, 35404⟩⟩
...
def j70 : Jet := ⟨⟨(-36), 0⟩, ⟨(-36), 0⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11799, 11836⟩, ⟨(-36), 0⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 3939⟩, ⟨(-12), 3939⟩, ⟨966, 985⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848237)⟩, ⟨(-12), 3939⟩, ⟨966, 985⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-283592), 0⟩, ⟨(-283596), 1311⟩, ⟨(-70902), (-68931)⟩, ⟨(-3), 656⟩, ⟨77, 82⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35507802, 35791395⟩, ⟨(-283596), 1311⟩, ⟨(-70902), (-68931)⟩, ⟨(-3), 656⟩, ⟨77, 82⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 11910829⟩, ⟨(-94377), 11911266⟩, ⟨2836140, 2978145⟩, ⟨(-47192), 329⟩, ⟨(-5900), (-5487)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-703917053)⟩, ⟨(-94377), 11911266⟩, ⟨2836140, 2978145⟩, ⟨(-47192), 329⟩, ⟨(-5900), (-5487)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-238216575), 0⟩, ⟨(-238247983), 3963888⟩, ⟨(-59585552), (-53608237)⟩, ⟨(-23557), 1982164⟩, ⟨218287, 247881⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4056750721, 4294967296⟩, ⟨(-238247983), 3963888⟩, ⟨(-59585552), (-53608237)⟩, ⟨(-23557), 1982164⟩, ⟨218287, 247881⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 825886351⟩, ⟨371714807, 413269839⟩, ⟨(-20616198), 163332⟩, ⟨(-3438048), (-3027186)⟩, ⟨(-756), 102096⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4547172194⟩, ⟨(-4443084), 267049834⟩, ⟨53361772, 82472372⟩, ⟨(-2367634), 8792336⟩, ⟨149022, 1498785⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 874383248⟩, ⟨370860439, 488888924⟩, ⟨(-22254325), 41727711⟩, ⟨(-758794), 6620482⟩, ⟨(-838264), 1249006⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-788663370), 0⟩, ⟨(-394331685), (-394331684)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3506303926, 4294967296⟩, ⟨(-394331685), (-394331684)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 178009753⟩, ⟨0, 199059158⟩, ⟨22961720, 72639531⟩, ⟨(-5375302), 12195232⟩, ⟨(-730272), 2421158⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4472977049⟩, ⟨0, 199059158⟩, ⟨22961720, 72639531⟩, ⟨(-5375302), 12195232⟩, ⟨(-730272), 2421158⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4383068576⟩, ⟨0, 99529579⟩, ⟨10120044, 36319766⟩, ⟨(-3529309), 6097616⟩, ⟨(-660007), 1280444⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3506303926, 4383068576⟩, ⟨(-402420484), (-294802105)⟩, ⟨(-876310), 36319766⟩, ⟨(-6863918), 5168470⟩, ⟨(-1219845), 1604479⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4294098544⟩, ⟨2147049266, 2147049272⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4293229968⟩, ⟨0, 4293229968⟩, ⟨1073307485, 1073307492⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4293229968⟩, ⟨0, 4293229968⟩, ⟨1073307485, 1073307492⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4293229968), 0⟩, ⟨(-4293229968), 0⟩, ⟨(-1073307492), (-1073307485)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2146614984), 0⟩, ⟨(-2146614984), 0⟩, ⟨(-536653746), (-536653742)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2605556269, 4294967296⟩, ⟨(-2146614984), 0⟩, ⟨(-536653746), 210873882⟩, ⟨(-35131431), 268218334⟩, ⟨(-46688017), 37916945⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2127110998, 4383068576⟩, ⟨(-2593068290), (-178842682)⟩, ⟨(-548538262), 452648088⟩, ⟨(-80626529), 329608872⟩, ⟨(-81117821), 48804668⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨394331684, 394331685⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨394331684, 394331685⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4314994571, 4314994573⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified568
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 788663370⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4383068576⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified569
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (622701923 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(1469 / 8000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1469 / 8000), prawitzNormalCorrection
