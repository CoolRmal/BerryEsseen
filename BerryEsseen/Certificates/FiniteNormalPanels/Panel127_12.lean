...
namespace FiniteNormalPanel127_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (51177 / 200000)
def radius : Rat := (7311 / 200000)

def j0 : Jet := ⟨⟨1099017706, 1099017707⟩, ⟨157002529, 157002530⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3452665951, 3452665955⟩, ⟨493237991, 493237995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2775551324, 2775551332⟩, ⟨793014660, 793014670⟩, ⟨56643904, 56643906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨694, 696⟩, ⟨198, 199⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93993), (-93990)⟩, ⟨198, 199⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-60742), (-60739)⟩, ⟨(-17228), (-17225)⟩, ⟨(-1195), (-1192)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5052314, 5052318⟩, ⟨(-17228), (-17225)⟩, ⟨(-1195), (-1192)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3264974, 3264977⟩, ⟨921715, 921720⟩, ⟨62678, 62683⟩, ⟨(-447), (-443)⟩, ⟨(-16), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-139900603), (-139900599)⟩, ⟨921715, 921720⟩, ⟨62678, 62683⟩, ⟨(-447), (-443)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-90408443), (-90408439)⟩, ⟨(-25235341), (-25235335)⟩, ⟨(-1634384), (-1634377)⟩, ⟨23438, 23445⟩, ⟨732, 739⟩⟩
...
def j19 : Jet := ⟨⟨1341247322, 1341247327⟩, ⟨(-25235341), (-25235335)⟩, ⟨(-1634384), (-1634377)⟩, ⟨23438, 23445⟩, ⟨732, 739⟩⟩
...
def j22 : Jet := ⟨⟨(-70), (-69)⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11765, 11767⟩, ⟨(-20), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7602, 7605⟩, ⟨2159, 2161⟩, ⟨149, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844575), (-844571)⟩, ⟨2159, 2161⟩, ⟨149, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-545793), (-545789)⟩, ⟨(-154546), (-154542)⟩, ⟨(-10645), (-10639)⟩, ⟨53, 58⟩, ⟨(-1), 3⟩⟩
...
def j30 : Jet := ⟨⟨35245601, 35245606⟩, ⟨(-154546), (-154542)⟩, ⟨(-10645), (-10639)⟩, ⟨53, 58⟩, ⟨(-1), 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22776884, 22776888⟩, ⟨6407808, 6407813⟩, ⟨429418, 429426⟩, ⟨(-3971), (-3964)⟩, ⟨(-133), (-127)⟩⟩
...
def j33 : Jet := ⟨⟨(-693050999), (-693050994)⟩, ⟨6407808, 6407813⟩, ⟨429418, 429426⟩, ⟨(-3971), (-3964)⟩, ⟨(-133), (-127)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-447872706), (-447872701)⟩, ⟨(-123822692), (-123822685)⟩, ⟨(-7679631), (-7679622)⟩, ⟨161227, 161238⟩, ⟨4843, 4851⟩⟩
...
def j36 : Jet := ⟨⟨3847094590, 3847094595⟩, ⟨(-123822692), (-123822685)⟩, ⟨(-7679631), (-7679622)⟩, ⟨161227, 161238⟩, ⟨4843, 4851⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1078210529, 1078210535⟩, ⟨133743725, 133743734⟩, ⟨(-4211910), (-4211902)⟩, ⟨(-168854), (-168845)⟩, ⟨3279, 3288⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4794980632, 4794980639⟩, ⟨154331368, 154331380⟩, ⟨14539117, 14539132⟩, ⟨575067, 575087⟩, ⟨35016, 35031⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1203734102, 1203734112⟩, ⟨188057375, 188057390⟩, ⟨3753474, 3753490⟩, ⟨257248, 257268⟩, ⟨10031, 10051⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1099017707), (-1099017706)⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3195949589, 3195949590⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨337365965, 337365972⟩, ⟨105412246, 105412256⟩, ⟨10338131, 10338146⟩, ⟨472888, 472906⟩, ⟨31428, 31445⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4632333261, 4632333268⟩, ⟨105412246, 105412256⟩, ⟨10338131, 10338146⟩, ⟨472888, 472906⟩, ⟨31428, 31445⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4460461843, 4460461848⟩, ⟨50750590, 50750596⟩, ⟨4688562, 4688571⟩, ⟨174324, 174335⟩, ⟨10682, 10693⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3319096563, 3319096569⟩, ⟨(-125287909), (-125287902)⟩, ⟨1633640, 1633650⟩, ⟨(-41674), (-41664)⟩, ⟨1575, 1585⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨35127043874, 35127043880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value538

def j47 : Jet := ⟨⟨8988483617, 8988483628⟩, ⟨1284069084, 1284069094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨18811048412, 18811048459⟩, ⟨5374585242, 5374585292⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨18811048412, 18811048459⟩, ⟨5374585242, 5374585292⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-18811048459), (-18811048412)⟩, ⟨(-5374585292), (-5374585242)⟩, ⟨(-383898951), (-383898944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9405524230), (-9405524206)⟩, ⟨(-2687292646), (-2687292621)⟩, ⟨(-191949476), (-191949472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨480729598, 480729612⟩, ⟨(-300784864), (-300784851)⟩, ⟨72613511, 72613518⟩, ⟨(-6182646), (-6182643)⟩, ⟨(-655517), (-655515)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨371501770, 371501783⟩, ⟨(-246466050), (-246466036)⟩, ⟨65071809, 65071820⟩, ⟨(-7015144), (-7015135)⟩, ⟨(-295511), (-295502)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨942015177, 1256020237⟩, ⟨157002529, 157002530⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2959427959, 3945903950⟩, ⟨493237991, 493237995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2039180566, 3625209905⟩, ⟨679726852, 906302480⟩, ⟨56643904, 56643906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨510, 909⟩, ⟨170, 228⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94177), (-93777)⟩, ⟨170, 228⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-79492), (-44523)⟩, ⟨(-19793), (-14648)⟩, ⟨(-1211), (-1174)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5033564, 5068534⟩, ⟨(-19793), (-14648)⟩, ⟨(-1211), (-1174)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2389854, 4278147⟩, ⟨779911, 1062583⟩, ⟨61184, 63972⟩, ⟨(-517), (-371)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140775723), (-138887429)⟩, ⟨779911, 1062583⟩, ⟨61184, 63972⟩, ⟨(-517), (-371)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-118823151), (-65941490)⟩, ⟨(-29335499), (-21083612)⟩, ⟨(-1704134), (-1553490)⟩, ⟨19531, 27338⟩, ⟨682, 781⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1312832614, 1365714276⟩, ⟨(-29335499), (-21083612)⟩, ⟨(-1704134), (-1553490)⟩, ⟨19531, 27338⟩, ⟨682, 781⟩⟩
...
def j70 : Jet := ⟨⟨(-92), (-50)⟩, ⟨(-23), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11743, 11786⟩, ⟨(-23), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5575, 9949⟩, ⟨1838, 2481⟩, ⟨147, 154⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846602), (-842227)⟩, ⟨1838, 2481⟩, ⟨147, 154⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-714583), (-399875)⟩, ⟨(-177774), (-131196)⟩, ⟨(-10807), (-10453)⟩, ⟨45, 66⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35076811, 35391520⟩, ⟨(-177774), (-131196)⟩, ⟨(-10807), (-10453)⟩, ⟨45, 66⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16653898, 29872565⟩, ⟨5401247, 7405853⟩, ⟨415973, 441034⟩, ⟨(-4605), (-3328)⟩, ⟨(-137), (-120)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699173985), (-685955317)⟩, ⟨5401247, 7405853⟩, ⟨415973, 441034⟩, ⟨(-4605), (-3328)⟩, ⟨(-137), (-120)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-590144763), (-325680419)⟩, ⟨(-144971768), (-102309155)⟩, ⟨(-8168708), (-7111672)⟩, ⟨133179, 189157⟩, ⟨4398, 5235⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3704822533, 3969286877⟩, ⟨(-144971768), (-102309155)⟩, ⟨(-8168708), (-7111672)⟩, ⟨133179, 189157⟩, ⟨4398, 5235⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨904601426, 1254719067⟩, ⟨123815577, 142312316⟩, ⟨(-4934551), (-3491686)⟩, ⟨(-182248), (-153287)⟩, ⟨2711, 3858⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4647369828, 4979116789⟩, ⟨119786877, 194835613⟩, ⟨11414106, 18602408⟩, ⟨271537, 990453⟩, ⟨11596, 69953⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨978824071, 1454584481⟩, ⟨159204042, 221900084⟩, ⟨136668, 8112088⟩, ⟨(-48893), 642487⟩, ⟨(-16439), 44174⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1256020237), (-942015177)⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3038947059, 3352952119⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨223074239, 492626805⟩, ⟨72565278, 150302620⟩, ⟨5963600, 16959171⟩, ⟨(-22988), 1273412⟩, ⟨(-16186), 111634⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4518041535, 4787594101⟩, ⟨72565278, 150302620⟩, ⟨5963600, 16959171⟩, ⟨(-22988), 1273412⟩, ⟨(-16186), 111634⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4405092579, 4534595913⟩, ⟨34365299, 73272562⟩, ⟨2232238, 8133554⟩, ⟨(-146498), 603376⟩, ⟨(-25437), 56294⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3116867304, 3540022992⟩, ⟨(-141446645), (-103826467)⟩, ⟨(-1099037), 5093399⟩, ⟨(-411690), 389439⟩, ⟨(-41915), 49304⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7704414532, 10272552721⟩, ⟨1284069084, 1284069094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13820362109, 24569532696⟩, ⟨4606787352, 6142383194⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13820362109, 24569532696⟩, ⟨4606787352, 6142383194⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-24569532696), (-13820362109)⟩, ⟨(-6142383194), (-4606787352)⟩, ⟨(-383898951), (-383898944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12284766348), (-6910181054)⟩, ⟨(-3071191597), (-2303393676)⟩, ⟨(-191949476), (-191949472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨245901033, 859454015⟩, ⟨(-614567648), (-131876879)⟩, ⟨(-3047652), 208738942⟩, ⟨(-45824943), 19037150⟩, ⟨(-8067664), 8260085⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨178450925, 708384201⟩, ⟨(-534847028), (-101647750)⟩, ⟨456109, 193306882⟩, ⟨(-45455725), 16026472⟩, ⟨(-7394059), 8633655⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1099017706, 1099017707⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4460461843, 4460461848⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar538 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2560
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar538 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨942015177, 1256020237⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4405092579, 4534595913⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2561
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((21933 / 100000) : ℝ)..(7311 / 25000), prawitzNormalCorrection
      ((45367 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
