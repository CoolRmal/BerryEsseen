...
namespace FiniteNormalPanel23_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (11599 / 40000)
def radius : Rat := (11599 / 200000)

def j0 : Jet := ⟨⟨1245433141, 1245433142⟩, ⟨249086628, 249086629⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3912643606, 3912643610⟩, ⟨782528720, 782528724⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3564353098, 3564353106⟩, ⟨1425741236, 1425741246⟩, ⟨142574123, 142574125⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨892, 893⟩, ⟨356, 358⟩, ⟨35, 36⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93795), (-93793)⟩, ⟨356, 358⟩, ⟨35, 36⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-77840), (-77837)⟩, ⟨(-30841), (-30837)⟩, ⟨(-2967), (-2964)⟩, ⟨22, 24⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5035216, 5035220⟩, ⟨(-30841), (-30837)⟩, ⟨(-2967), (-2964)⟩, ⟨22, 24⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4178678, 4178682⟩, ⟨1645876, 1645882⟩, ⟨154446, 154453⟩, ⟨(-1991), (-1986)⟩, ⟨(-92), (-88)⟩⟩
...
def j16 : Jet := ⟨⟨(-138986899), (-138986894)⟩, ⟨1645876, 1645882⟩, ⟨154446, 154453⟩, ⟨(-1991), (-1986)⟩, ⟨(-92), (-88)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-115343925), (-115343920)⟩, ⟨(-44771674), (-44771665)⟩, ⟨(-3939227), (-3939215)⟩, ⟨104251, 104261⟩, ⟨4388, 4396⟩⟩
...
def j19 : Jet := ⟨⟨1316311840, 1316311846⟩, ⟨(-44771674), (-44771665)⟩, ⟨(-3939227), (-3939215)⟩, ⟨104251, 104261⟩, ⟨4388, 4396⟩⟩
...
def j22 : Jet := ⟨⟨(-90), (-88)⟩, ⟨(-36), (-35)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11745, 11748⟩, ⟨(-36), (-35)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9747, 9750⟩, ⟨3868, 3871⟩, ⟨373, 377⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842430), (-842426)⟩, ⟨3868, 3871⟩, ⟨373, 377⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-699125), (-699121)⟩, ⟨(-276440), (-276435)⟩, ⟨(-26372), (-26365)⟩, ⟨247, 255⟩, ⟨9, 13⟩⟩
...
def j30 : Jet := ⟨⟨35092269, 35092274⟩, ⟨(-276440), (-276435)⟩, ⟨(-26372), (-26365)⟩, ⟨247, 255⟩, ⟨9, 13⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29122745, 29122750⟩, ⟨11419683, 11419690⟩, ⟨1051257, 1051266⟩, ⟨(-17728), (-17716)⟩, ⟨(-788), (-779)⟩⟩
...
def j33 : Jet := ⟨⟨(-686705138), (-686705132)⟩, ⟨11419683, 11419690⟩, ⟨1051257, 1051266⟩, ⟨(-17728), (-17716)⟩, ⟨(-788), (-779)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-569890159), (-569890151)⟩, ⟨(-218478977), (-218478966)⟩, ⟨(-18132344), (-18132331)⟩, ⟨713341, 713357⟩, ⟨28358, 28372⟩⟩
...
def j36 : Jet := ⟨⟨3725077137, 3725077145⟩, ⟨(-218478977), (-218478966)⟩, ⟨(-18132344), (-18132331)⟩, ⟨713341, 713357⟩, ⟨28358, 28372⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1199138142, 1199138149⟩, ⟨199041379, 199041391⟩, ⟨(-11745821), (-11745807)⟩, ⟨(-622745), (-622730)⟩, ⟨22991, 23002⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4952043502, 4952043514⟩, ⟨290441593, 290441611⟩, ⟨41139407, 41139430⟩, ⟨2878301, 2878330⟩, ⟨275727, 275755⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1382591259, 1382591272⟩, ⟨310582378, 310582400⟩, ⟨11403092, 11403118⟩, ⟨1197816, 1197848⟩, ⟨82256, 82285⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1245433142), (-1245433141)⟩, ⟨(-249086629), (-249086628)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3049534154, 3049534155⟩, ⟨(-249086629), (-249086628)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨445069416, 445069426⟩, ⟨199958906, 199958924⟩, ⟨29800700, 29800725⟩, ⟨2420360, 2420388⟩, ⟨256465, 256496⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4740036712, 4740036722⟩, ⟨199958906, 199958924⟩, ⟨29800700, 29800725⟩, ⟨2420360, 2420388⟩, ⟨256465, 256496⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4512017581, 4512017587⟩, ⟨95169948, 95169958⟩, ⟨13179881, 13179894⟩, ⟨873966, 873981⟩, ⟨84378, 84396⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3203645282, 3203645288⟩, ⟨(-194101419), (-194101409)⟩, ⟨3838663, 3838674⟩, ⟨(-143831), (-143818)⟩, ⟨9223, 9239⟩⟩
...
def j47 : Jet := ⟨⟨4437566704, 4437566710⟩, ⟨887513340, 887513345⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4584900627, 4584900641⟩, ⟨1833960248, 1833960264⟩, ⟨183396024, 183396027⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4584900627, 4584900641⟩, ⟨1833960248, 1833960264⟩, ⟨183396024, 183396027⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4584900641), (-4584900627)⟩, ⟨(-1833960264), (-1833960248)⟩, ⟨(-183396027), (-183396024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2292450321), (-2292450313)⟩, ⟨(-916980132), (-916980124)⟩, ⟨(-91698014), (-91698012)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2518569940, 2518569953⟩, ⟨(-537717391), (-537717383)⟩, ⟨3629878, 3629883⟩, ⟨7395221, 7395223⟩, ⟨(-433472), (-433470)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1878618427, 1878618441⟩, ⟨(-514908180), (-514908164)⟩, ⟨29259472, 29259488⟩, ⟨4787166, 4787181⟩, ⟨(-630884), (-630867)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨996346513, 1494519770⟩, ⟨249086628, 249086629⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3130114885, 4695172331⟩, ⟨782528720, 782528724⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2281185983, 5132668470⟩, ⟨1140592988, 1710889496⟩, ⟨142574123, 142574125⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨570, 1286⟩, ⟨285, 429⟩, ⟨35, 36⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94117), (-93400)⟩, ⟨285, 429⟩, ⟨35, 36⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-112474), (-49607)⟩, ⟨(-37341), (-24290)⟩, ⟨(-3032), (-2885)⟩, ⟨18, 30⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5000582, 5063450⟩, ⟨(-37341), (-24290)⟩, ⟨(-3032), (-2885)⟩, ⟨18, 30⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2655959, 6051038⟩, ⟨1283354, 2004112⟩, ⟨147498, 160103⟩, ⟨(-2439), (-1536)⟩, ⟨(-97), (-80)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140509618), (-137114538)⟩, ⟨1283354, 2004112⟩, ⟨147498, 160103⟩, ⟨(-2439), (-1536)⟩, ⟨(-97), (-80)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-167914966), (-72825644)⟩, ⟨(-55290029), (-34017822)⟩, ⟨(-4245152), (-3561938)⟩, ⟨78856, 129490⟩, ⟨3808, 4866⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1263740799, 1358830122⟩, ⟨(-55290029), (-34017822)⟩, ⟨(-4245152), (-3561938)⟩, ⟨78856, 129490⟩, ⟨3808, 4866⟩⟩
...
def j70 : Jet := ⟨⟨(-130), (-56)⟩, ⟨(-44), (-28)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11705, 11780⟩, ⟨(-44), (-28)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6216, 14078⟩, ⟨3055, 4679⟩, ⟨365, 384⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845961), (-838098)⟩, ⟨3055, 4679⟩, ⟨365, 384⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1010960), (-445138)⟩, ⟨(-335365), (-216977)⟩, ⟨(-27079), (-25498)⟩, ⟨192, 309⟩, ⟨8, 13⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34780434, 35346257⟩, ⟨(-335365), (-216977)⟩, ⟨(-27079), (-25498)⟩, ⟨192, 309⟩, ⟨8, 13⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18472931, 42240280⟩, ⟨8835689, 13964852⟩, ⟨988605, 1102179⟩, ⟨(-21819), (-13603)⟩, ⟨(-845), (-706)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697354952), (-673587602)⟩, ⟨8835689, 13964852⟩, ⟨988605, 1102179⟩, ⟨(-21819), (-13603)⟩, ⟨(-845), (-706)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-833368808), (-357762583)⟩, ⟨(-273096705), (-162192699)⟩, ⟨(-20277608), (-15480146)⟩, ⟨529769, 895399⟩, ⟨23115, 32602⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3461598488, 3937204713⟩, ⟨(-273096705), (-162192699)⟩, ⟨(-20277608), (-15480146)⟩, ⟨529769, 895399⟩, ⟨23115, 32602⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨920997440, 1485445908⟩, ⟨169807405, 222782585⟩, ⟨(-14714375), (-8793825)⟩, ⟨(-715984), (-507417)⟩, ⟨17142, 28913⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4685238746, 5328966990⟩, ⟨193007874, 420419449⟩, ⟨26372172, 64384670⟩, ⟨633344, 6825245⟩, ⟨(-11330), 854803⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1004685855, 1843062279⟩, ⟨226625238, 421821930⟩, ⟨(-4970830), 34482431⟩, ⟨(-1150224), 4751532⟩, ⟨(-250846), 608746⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1494519770), (-996346513)⟩, ⟨(-249086629), (-249086628)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2800447526, 3298620783⟩, ⟨(-249086629), (-249086628)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨235017777, 790897423⟩, ⟨106025100, 362025616⟩, ⟨7691768, 71022726⟩, ⟨(-1963574), 10851220⟩, ⟨(-481133), 1732623⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4529985073, 5085864719⟩, ⟨106025100, 362025616⟩, ⟨7691768, 71022726⟩, ⟨(-1963574), 10851220⟩, ⟨(-481133), 1732623⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4410911214, 4673716149⟩, ⟨48716516, 176254759⟩, ⟨210768, 34308897⟩, ⟨(-2326924), 5280667⟩, ⟨(-578684), 936517⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2876046438, 3589507478⟩, ⟨(-239287540), (-120443614)⟩, ⟨(-10084468), 23524606⟩, ⟨(-3776870), 4043435⟩, ⟨(-750694), 854214⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3550053364, 5325080050⟩, ⟨887513340, 887513345⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2934336403, 6602256918⟩, ⟨1467168198, 2200752314⟩, ⟨183396024, 183396027⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2934336403, 6602256918⟩, ⟨1467168198, 2200752314⟩, ⟨183396024, 183396027⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6602256918), (-2934336403)⟩, ⟨(-2200752314), (-1467168198)⟩, ⟨(-183396027), (-183396024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3301128459), (-1467168201)⟩, ⟨(-1100376157), (-733584099)⟩, ⟨(-91698014), (-91698012)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1991404312, 3052137685⟩, ⟨(-781961609), (-340133565)⟩, ⟨(-36115917), 57653092⟩, ⟨(-82341), 14214292⟩, ⟨(-1525880), 390814⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1333507541, 2550815941⟩, ⟨(-823567520), (-283609111)⟩, ⟨(-27811767), 108466535⟩, ⟨(-10247832), 18601117⟩, ⟨(-3534629), 1941658⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1245433141, 1245433142⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4512017581, 4512017587⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified458
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨996346513, 1494519770⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4410911214, 4673716149⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified459
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (219077265 / 4294967296)

theorem envelope_integral : (∫ s in ((11599 / 50000) : ℝ)..(34797 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((11599 / 50000) : ℝ)..(34797 / 100000), prawitzNormalCorrection
