...
namespace FiniteNormalPanel39_16
...
def j47 : Jet := ⟨⟨1229191575, 1229191583⟩, ⟨1229191575, 1229191583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨351786596, 351786602⟩, ⟨703573192, 703573204⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨351786596, 351786602⟩, ⟨703573192, 703573204⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-351786602), (-351786596)⟩, ⟨(-703573204), (-703573192)⟩, ⟨(-351786602), (-351786596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-175893301), (-175893298)⟩, ⟨(-351786602), (-351786596)⟩, ⟨(-175893301), (-175893298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4122627036, 4122627040⟩, ⟨(-337670781), (-337670774)⟩, ⟨(-155006642), (-155006637)⟩, ⟨13451193, 13451195⟩, ⟨2898584, 2898586⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3949066207, 3949066216⟩, ⟨(-493159923), (-493159908)⟩, ⟨(-130883359), (-130883344)⟩, ⟨18811341, 18811354⟩, ⟨2102796, 2102809⟩⟩
...
def j89 : Jet := ⟨⟨0, 2458383158⟩, ⟨1229191575, 1229191583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1407146397⟩, ⟨0, 1407146402⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1407146397⟩, ⟨0, 1407146402⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1407146397), 0⟩, ⟨(-1407146402), 0⟩, ⟨(-351786602), (-351786596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-703573199), 0⟩, ⟨(-703573201), 0⟩, ⟨(-175893301), (-175893298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3645999502, 4294967296⟩, ⟨(-703573201), 0⟩, ⟨(-175893301), (-91688532)⟩, ⟨0, 28813680⟩, ⟨697459, 3601711⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3331896644, 4312843043⟩, ⟨(-892277203), (-141468656)⟩, ⟨(-174251216), (-48316378)⟩, ⟨2391955, 36575134⟩, ⟨(-828370), 3635254⟩⟩
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified774
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified775
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (336516157 / 4294967296)
