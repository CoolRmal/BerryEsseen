...
namespace FiniteNormalPanel130_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (13727 / 80000)
def radius : Rat := (13727 / 400000)

def j0 : Jet := ⟨⟨736962700, 736962701⟩, ⟨147392540, 147392541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2315236604, 2315236608⟩, ⟨463047320, 463047325⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1248046879, 1248046885⟩, ⟨499218750, 499218758⟩, ⟨49921875, 49921877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨312, 313⟩, ⟨124, 126⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94375), (-94373)⟩, ⟨124, 126⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-27424), (-27423)⟩, ⟨(-10934), (-10932)⟩, ⟨(-1080), (-1077)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5085632, 5085634⟩, ⟨(-10934), (-10932)⟩, ⟨(-1080), (-1077)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1477801, 1477802⟩, ⟨587942, 587945⟩, ⟨57527, 57531⟩, ⟨(-254), (-250)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-141687776), (-141687774)⟩, ⟨587942, 587945⟩, ⟨57527, 57531⟩, ⟨(-254), (-250)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-41172139), (-41172137)⟩, ⟨(-16298010), (-16298006)⟩, ⟨(-1561832), (-1561828)⟩, ⟨13445, 13450⟩, ⟨634, 638⟩⟩
...
def j19 : Jet := ⟨⟨1390483626, 1390483629⟩, ⟨(-16298010), (-16298006)⟩, ⟨(-1561832), (-1561828)⟩, ⟨13445, 13450⟩, ⟨634, 638⟩⟩
...
def j22 : Jet := ⟨⟨(-32), (-31)⟩, ⟨(-13), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11803, 11805⟩, ⟨(-13), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3429, 3431⟩, ⟨1367, 1370⟩, ⟨134, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848748), (-848745)⟩, ⟨1367, 1370⟩, ⟨134, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-246633), (-246631)⟩, ⟨(-98256), (-98253)⟩, ⟨(-9670), (-9665)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35544761, 35544764⟩, ⟨(-98256), (-98253)⟩, ⟨(-9670), (-9665)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10328723, 10328725⟩, ⟨4102937, 4102940⟩, ⟨398917, 398921⟩, ⟨(-2259), (-2255)⟩, ⟨(-111), (-107)⟩⟩
...
def j33 : Jet := ⟨⟨(-705499160), (-705499157)⟩, ⟨4102937, 4102940⟩, ⟨398917, 398921⟩, ⟨(-2259), (-2255)⟩, ⟨(-111), (-107)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-205006458), (-205006455)⟩, ⟨(-80810338), (-80810334)⟩, ⟨(-7607443), (-7607439)⟩, ⟨93399, 93403⟩, ⟨4340, 4344⟩⟩
...
def j36 : Jet := ⟨⟨4089960838, 4089960841⟩, ⟨(-80810338), (-80810334)⟩, ⟨(-7607443), (-7607439)⟩, ⟨93399, 93403⟩, ⟨4340, 4344⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨749551362, 749551366⟩, ⟨141124698, 141124705⟩, ⟨(-2599034), (-2599029)⟩, ⟨(-161137), (-161132)⟩, ⟨1790, 1795⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4510249557, 4510249561⟩, ⟨89114489, 89114495⟩, ⟨10149929, 10149937⟩, ⟨263297, 263306⟩, ⟨17254, 17265⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨787122104, 787122110⟩, ⟨163750604, 163750615⟩, ⟨1970178, 1970188⟩, ⟨156316, 156327⟩, ⟨4054, 4066⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-736962701), (-736962700)⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3558004595, 3558004596⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨144252834, 144252837⟩, ⟨60019884, 60019890⟩, ⟨6965313, 6965321⟩, ⟨207524, 207532⟩, ⟨14305, 14318⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4439220130, 4439220133⟩, ⟨60019884, 60019890⟩, ⟨6965313, 6965321⟩, ⟨207524, 207532⟩, ⟨14305, 14318⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4366498056, 4366498059⟩, ⟨29518327, 29518331⟩, ⟨3325829, 3325835⟩, ⟨79578, 79584⟩, ⟨5230, 5239⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3617261570, 3617261575⟩, ⟨(-125393947), (-125393941)⟩, ⟨1742162, 1742169⟩, ⟨(-48212), (-48205)⟩, ⟨1600, 1611⟩⟩
...
def j47 : Jet := ⟨⟨8250519117, 8250519130⟩, ⟨1650103823, 1650103835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15849030041, 15849030092⟩, ⟨6339612014, 6339612072⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15849030041, 15849030092⟩, ⟨6339612014, 6339612072⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15849030092), (-15849030041)⟩, ⟨(-6339612072), (-6339612014)⟩, ⟨(-633961211), (-633961201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7924515046), (-7924515020)⟩, ⟨(-3169806036), (-3169806007)⟩, ⟨(-316980606), (-316980600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨678666117, 678666125⟩, ⟨(-500874590), (-500874578)⟩, ⟨134742265, 134742274⟩, ⟨(-8503894), (-8503889)⟩, ⟨(-3403152), (-3403150)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨571578942, 571578950⟩, ⟨(-441655293), (-441655278)⟩, ⟨128379789, 128379801⟩, ⟨(-11306724), (-11306714)⟩, ⟨(-2557364), (-2557354)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨589570160, 884355242⟩, ⟨147392540, 147392541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1852189283, 2778283932⟩, ⟨463047320, 463047325⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨798750002, 1797187517⟩, ⟨399375000, 599062510⟩, ⟨49921875, 49921877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨199, 451⟩, ⟨99, 151⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94488), (-94235)⟩, ⟨99, 151⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-39538), (-17525)⟩, ⟨(-13162), (-8698)⟩, ⟨(-1088), (-1067)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073518, 5095532⟩, ⟨(-13162), (-8698)⟩, ⟨(-1088), (-1067)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨943539, 2132177⟩, ⟨466261, 709109⟩, ⟨56679, 58222⟩, ⟨(-305), (-198)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142222038), (-141033399)⟩, ⟨466261, 709109⟩, ⟨56679, 58222⟩, ⟨(-305), (-198)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-59511436), (-26228471)⟩, ⟨(-19750434), (-12817515)⟩, ⟨(-1599200), (-1516009)⟩, ⟨10561, 16328⟩, ⟨609, 658⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1372144329, 1405427295⟩, ⟨(-19750434), (-12817515)⟩, ⟨(-1599200), (-1516009)⟩, ⟨10561, 16328⟩, ⟨609, 658⟩⟩
...
def j70 : Jet := ⟨⟨(-46), (-19)⟩, ⟨(-16), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11789, 11817⟩, ⟨(-16), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2192, 4945⟩, ⟨1089, 1648⟩, ⟨133, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849985), (-847231)⟩, ⟨1089, 1648⟩, ⟨133, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-355669), (-157562)⟩, ⟨(-118355), (-78091)⟩, ⟨(-9755), (-9559)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35435725, 35633833⟩, ⟨(-118355), (-78091)⟩, ⟨(-9755), (-9559)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6590104, 14910633⟩, ⟨3245527, 4955689⟩, ⟨391290, 405147⟩, ⟨(-2733), (-1778)⟩, ⟨(-113), (-104)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709237779), (-700917249)⟩, ⟨3245527, 4955689⟩, ⟨391290, 405147⟩, ⟨(-2733), (-1778)⟩, ⟨(-113), (-104)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-296773688), (-130352017)⟩, ⟨(-98320983), (-63102347)⟩, ⟨(-7869155), (-7286250)⟩, ⟨72963, 113782⟩, ⟨4118, 4526⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3998193608, 4164615279⟩, ⟨(-98320983), (-63102347)⟩, ⟨(-7869155), (-7286250)⟩, ⟨72963, 113782⟩, ⟨4118, 4526⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨591732333, 909128243⟩, ⟨135157126, 145993868⟩, ⟨(-3163801), (-2035649)⟩, ⟨(-167859), (-152880)⟩, ⟨1400, 2187⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4429399317, 4613769588⟩, ⟨67114360, 113458829⟩, ⟨8766422, 11870826⟩, ⟨124194, 434397⟩, ⟨9103, 28262⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨610253492, 976610054⟩, ⟨148634103, 180846708⟩, ⟨(-78859), 4270045⟩, ⟨29081, 305989⟩, ⟨(-6575), 16557⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-884355242), (-589570160)⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3410612054, 3705397136⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨86708302, 222066231⟩, ⟨42237564, 82243568⟩, ⟨5107853, 9556739⟩, ⟨1620, 498752⟩, ⟨(-1059), 37546⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4381675598, 4517033527⟩, ⟨42237564, 82243568⟩, ⟨5107853, 9556739⟩, ⟨1620, 498752⟩, ⟨(-1059), 37546⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4338104816, 4404601149⟩, ⟨20593119, 40712875⟩, ⟨2302197, 4681976⟩, ⟨(-43139), 235968⟩, ⟨(-5266), 18381⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3444867342, 3799981551⟩, ⟨(-134802009), (-113748692)⟩, ⟨430998, 3332578⟩, ⟨(-197892), 124572⟩, ⟨(-12642), 17339⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6600415293, 9900622965⟩, ⟨1650103823, 1650103835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10143379224, 22822603373⟩, ⟨5071689610, 7607534494⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10143379224, 22822603373⟩, ⟨5071689610, 7607534494⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-22822603373), (-10143379224)⟩, ⟨(-7607534494), (-5071689610)⟩, ⟨(-633961211), (-633961201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11411301687), (-5071689612)⟩, ⟨(-3803767247), (-2535844805)⟩, ⟨(-316980606), (-316980600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨301357869, 1318637738⟩, ⟨(-1167829856), (-177928429)⟩, ⟨(-44792693), 494893613⟩, ⟨(-137343724), 70682713⟩, ⟨(-33912013), 32061967⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨241710311, 1166667575⟩, ⟨(-1074626792), (-150692392)⟩, ⟨(-34887903), 475534908⟩, ⟨(-138014814), 63962941⟩, ⟨(-32294688), 33120705⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨736962700, 736962701⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4366498056, 4366498059⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2610
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨589570160, 884355242⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4338104816, 4404601149⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2611
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (21311043 / 2147483648)

theorem envelope_integral : (∫ s in ((13727 / 100000) : ℝ)..(41181 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (13727 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (41181 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((13727 / 100000) : ℝ)..(41181 / 200000), prawitzNormalCorrection
