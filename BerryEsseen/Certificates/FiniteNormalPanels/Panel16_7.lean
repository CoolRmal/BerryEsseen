...
namespace FiniteNormalPanel16_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (39471 / 160000)
def radius : Rat := (39471 / 800000)

def j0 : Jet := ⟨⟨1059541588, 1059541589⟩, ⟨211908317, 211908318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3328648068, 3328648073⟩, ⟨665729611, 665729616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2579739773, 2579739782⟩, ⟨1031895904, 1031895916⟩, ⟨103189590, 103189592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨645, 647⟩, ⟨258, 259⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94042), (-94039)⟩, ⟨258, 259⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-56486), (-56483)⟩, ⟨(-22441), (-22437)⟩, ⟨(-2184), (-2180)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5056570, 5056574⟩, ⟨(-22441), (-22437)⟩, ⟨(-2184), (-2180)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3037190, 3037194⟩, ⟨1201396, 1201402⟩, ⟨114783, 114789⟩, ⟨(-1058), (-1053)⟩, ⟨(-51), (-47)⟩⟩
...
def j16 : Jet := ⟨⟨(-140128387), (-140128382)⟩, ⟨1201396, 1201402⟩, ⟨114783, 114789⟩, ⟨(-1058), (-1053)⟩, ⟨(-51), (-47)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-84167062), (-84167057)⟩, ⟨(-32945216), (-32945208)⟩, ⟨(-3009097), (-3009088)⟩, ⟨55805, 55812⟩, ⟨2471, 2478⟩⟩
...
def j19 : Jet := ⟨⟨1347488703, 1347488709⟩, ⟨(-32945216), (-32945208)⟩, ⟨(-3009097), (-3009088)⟩, ⟨55805, 55812⟩, ⟨2471, 2478⟩⟩
...
def j22 : Jet := ⟨⟨(-65), (-64)⟩, ⟨(-26), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11770, 11772⟩, ⟨(-26), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7069, 7071⟩, ⟨2811, 2814⟩, ⟨273, 276⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845108), (-845105)⟩, ⟨2811, 2814⟩, ⟨273, 276⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-507608), (-507605)⟩, ⟨(-201356), (-201351)⟩, ⟨(-19467), (-19461)⟩, ⟨130, 135⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35283786, 35283790⟩, ⟨(-201356), (-201351)⟩, ⟨(-19467), (-19461)⟩, ⟨130, 135⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21192940, 21192943⟩, ⟨8356233, 8356239⟩, ⟨787646, 787654⟩, ⟨(-9438), (-9430)⟩, ⟨(-435), (-429)⟩⟩
...
def j33 : Jet := ⟨⟨(-694634943), (-694634939)⟩, ⟨8356233, 8356239⟩, ⟨787646, 787654⟩, ⟨(-9438), (-9430)⟩, ⟨(-435), (-429)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-417227251), (-417227246)⟩, ⟨(-161871793), (-161871784)⟩, ⟨(-14208355), (-14208345)⟩, ⟨384332, 384341⟩, ⟨16393, 16402⟩⟩
...
def j36 : Jet := ⟨⟨3877740045, 3877740050⟩, ⟨(-161871793), (-161871784)⟩, ⟨(-14208355), (-14208345)⟩, ⟨384332, 384341⟩, ⟨16393, 16402⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1044318933, 1044318941⟩, ⟨183330871, 183330882⟩, ⟨(-7438668), (-7438658)⟩, ⟨(-423168), (-423160)⟩, ⟨10564, 10572⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4757086301, 4757086308⟩, ⟨198579077, 198579092⟩, ⟨25719792, 25719808⟩, ⟨1329753, 1329770⟩, ⟨109942, 109960⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1156682914, 1156682926⟩, ⟨251340834, 251340852⟩, ⟨6491074, 6491093⟩, ⟨608549, 608567⟩, ⟨31080, 31100⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1059541589), (-1059541588)⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3235425707, 3235425708⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨311507695, 311507702⟩, ⟨135377816, 135377830⟩, ⟨18204665, 18204680⟩, ⟨1087490, 1087504⟩, ⟨97774, 97791⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4606474991, 4606474998⟩, ⟨135377816, 135377830⟩, ⟨18204665, 18204680⟩, ⟨1087490, 1087504⟩, ⟨97774, 97791⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4447994990, 4447994994⟩, ⟨65360155, 65360163⟩, ⟨8308966, 8308976⟩, ⟨402943, 402952⟩, ⟨33522, 33533⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3350702425, 3350702430⟩, ⟨(-170222301), (-170222292)⟩, ⟨3034407, 3034416⟩, ⟨(-106416), (-106406)⟩, ⟨5370, 5381⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨20072778991, 20072778997⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value153

def j47 : Jet := ⟨⟨4951829120, 4951829127⟩, ⟨990365821, 990365827⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5709149789, 5709149806⟩, ⟨2283659908, 2283659926⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5709149789, 5709149806⟩, ⟨2283659908, 2283659926⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5709149806), (-5709149789)⟩, ⟨(-2283659926), (-2283659908)⟩, ⟨(-228365993), (-228365990)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2854574903), (-2854574894)⟩, ⟨(-1141829963), (-1141829954)⟩, ⟨(-114182997), (-114182995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2209599831, 2209599845⟩, ⟨(-587428760), (-587428750)⟩, ⟨19341972, 19341977⟩, ⟨8697272, 8697274⟩, ⟨(-835156), (-835154)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1723810916, 1723810931⟩, ⟨(-545853317), (-545853302)⟩, ⟨39932197, 39932210⟩, ⟨5548793, 5548806⟩, ⟨(-965263), (-965250)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨847633270, 1271449907⟩, ⟨211908317, 211908318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2662918453, 3994377688⟩, ⟨665729611, 665729616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1651033453, 3714825287⟩, ⟨825516722, 1238275098⟩, ⟨103189590, 103189592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨413, 931⟩, ⟨206, 311⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94274), (-93755)⟩, ⟨206, 311⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-81540), (-36040)⟩, ⟨(-27101), (-17751)⟩, ⟨(-2217), (-2139)⟩, ⟨8, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5031516, 5077017⟩, ⟨(-27101), (-17751)⟩, ⟨(-2217), (-2139)⟩, ⟨8, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1934171, 4391240⟩, ⟨943644, 1456924⟩, ⟨111153, 117746⟩, ⟨(-1289), (-823)⟩, ⟨(-53), (-45)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141231406), (-138774336)⟩, ⟨943644, 1456924⟩, ⟨111153, 117746⟩, ⟨(-1289), (-823)⟩, ⟨(-53), (-45)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-122154597), (-53346406)⟩, ⟨(-40355453), (-25413072)⟩, ⟨(-3169083), (-2812264)⟩, ⟨42920, 68636⟩, ⟨2252, 2654⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1309501168, 1378309360⟩, ⟨(-40355453), (-25413072)⟩, ⟨(-3169083), (-2812264)⟩, ⟨42920, 68636⟩, ⟨2252, 2654⟩⟩
...
def j70 : Jet := ⟨⟨(-94), (-41)⟩, ⟨(-32), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11741, 11795⟩, ⟨(-32), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4513, 10202⟩, ⟨2228, 3394⟩, ⟨269, 281⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847664), (-841974)⟩, ⟨2228, 3394⟩, ⟨269, 281⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-733166), (-323664)⟩, ⟨(-243533), (-158896)⟩, ⟨(-19835), (-19006)⟩, ⟨102, 164⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35058228, 35467731⟩, ⟨(-243533), (-158896)⟩, ⟨(-19835), (-19006)⟩, ⟨102, 164⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13476774, 30676934⟩, ⟨6527749, 10164564⟩, ⟨754929, 814292⟩, ⟨(-11532), (-7328)⟩, ⟨(-457), (-401)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702351109), (-685150948)⟩, ⟨6527749, 10164564⟩, ⟨754929, 814292⟩, ⟨(-11532), (-7328)⟩, ⟨(-457), (-401)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-607481148), (-263379685)⟩, ⟨(-199984378), (-122898254)⟩, ⟨(-15329605), (-12826398)⟩, ⟨291959, 476163⟩, ⟨14416, 18002⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3687486148, 4031587611⟩, ⟨(-199984378), (-122898254)⟩, ⟨(-15329605), (-12826398)⟩, ⟨291959, 476163⟩, ⟨14416, 18002⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨811902532, 1281846351⟩, ⟨165444514, 197884726⟩, ⟨(-9202478), (-5682712)⟩, ⟨(-464606), (-372074)⟩, ⟨8048, 13108⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4575553318, 5002525660⟩, ⟨139480414, 271303253⟩, ⟨18808909, 35510143⟩, ⟨426281, 2691422⟩, ⟨18451, 264659⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨864943332, 1493019346⟩, ⟨202619632, 311455807⟩, ⟨(-1790088), 17044081⟩, ⟨(-317335), 1858418⟩, ⟨(-76954), 181292⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1271449907), (-847633270)⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3023517389, 3447334026⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨174186883, 519004364⟩, ⟨81609234, 216536944⟩, ⟨8314251, 34435422⟩, ⟨(-480248), 3764004⟩, ⟨(-106632), 463212⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4469154179, 4813971660⟩, ⟨81609234, 216536944⟩, ⟨8314251, 34435422⟩, ⟨(-480248), 3764004⟩, ⟨(-106632), 463212⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4381195161, 4547070579⟩, ⟨38542286, 106137602⟩, ⟨2687911, 16709312⟩, ⟨(-640194), 1821317⟩, ⟨(-128254), 241733⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3084219003, 3649683466⟩, ⟨(-197214263), (-130971876)⟩, ⟨(-3344496), 11510018⟩, ⟨(-1338266), 1329253⟩, ⟨(-192805), 225613⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3961463294, 5942194953⟩, ⟨990365821, 990365827⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3653855861, 8221175722⟩, ⟨1826927926, 2740391912⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3653855861, 8221175722⟩, ⟨1826927926, 2740391912⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8221175722), (-3653855861)⟩, ⟨(-2740391912), (-1826927926)⟩, ⟨(-228365993), (-228365990)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4110587861), (-1826927930)⟩, ⟨(-1370195956), (-913463963)⟩, ⟨(-114182997), (-114182995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1649336556, 2806895691⟩, ⟨(-895465987), (-350784861)⟩, ⟨(-37319283), 98989287⟩, ⟨(-4309493), 19839400⟩, ⟨(-2898140), 839780⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1184389728, 2385182492⟩, ⟨(-889815221), (-302194159)⟩, ⟨(-23201172), 132756693⟩, ⟨(-11481715), 20138312⟩, ⟨(-3876852), 1603236⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1059541588, 1059541589⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4447994990, 4447994994⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar153 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified322
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar153 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨847633270, 1271449907⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4381195161, 4547070579⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified323
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((39471 / 200000) : ℝ)..(118413 / 400000), prawitzNormalCorrection
      ((67457 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
