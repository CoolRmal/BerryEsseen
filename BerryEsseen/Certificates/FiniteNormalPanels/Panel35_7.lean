...
namespace FiniteNormalPanel35_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (41141 / 160000)
def radius : Rat := (41141 / 800000)

def j0 : Jet := ⟨⟨1104370309, 1104370310⟩, ⟨220874061, 220874062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3469481649, 3469481653⟩, ⟨693896327, 693896331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2802652985, 2802652992⟩, ⟨1121061188, 1121061198⟩, ⟨112106118, 112106120⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨701, 703⟩, ⟨280, 281⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93986), (-93983)⟩, ⟨280, 281⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-61330), (-61327)⟩, ⟨(-24350), (-24347)⟩, ⟨(-2363), (-2360)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5051726, 5051730⟩, ⟨(-24350), (-24347)⟩, ⟨(-2363), (-2360)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3296470, 3296474⟩, ⟨1302698, 1302703⟩, ⟨123960, 123965⟩, ⟨(-1244), (-1240)⟩, ⟨(-59), (-55)⟩⟩
...
def j16 : Jet := ⟨⟨(-139869107), (-139869102)⟩, ⟨1302698, 1302703⟩, ⟨123960, 123965⟩, ⟨(-1244), (-1240)⟩, ⟨(-59), (-55)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-91270677), (-91270673)⟩, ⟨(-35658204), (-35658198)⟩, ⟨(-3229913), (-3229904)⟩, ⟨65545, 65552⟩, ⟨2871, 2878⟩⟩
...
def j19 : Jet := ⟨⟨1340385088, 1340385093⟩, ⟨(-35658204), (-35658198)⟩, ⟨(-3229913), (-3229904)⟩, ⟨65545, 65552⟩, ⟨2871, 2878⟩⟩
...
def j25 : Jet := ⟨⟨7676, 7679⟩, ⟨3051, 3055⟩, ⟨297, 300⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844501), (-844497)⟩, ⟨3051, 3055⟩, ⟨297, 300⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-551074), (-551071)⟩, ⟨(-218440), (-218434)⟩, ⟨(-21054), (-21048)⟩, ⟨154, 159⟩, ⟨5, 8⟩⟩
...
def j30 : Jet := ⟨⟨35240320, 35240324⟩, ⟨(-218440), (-218434)⟩, ⟨(-21054), (-21048)⟩, ⟨154, 159⟩, ⟨5, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22995841, 22995845⟩, ⟨9055794, 9055801⟩, ⟨849077, 849085⟩, ⟨(-11098), (-11090)⟩, ⟨(-507), (-501)⟩⟩
...
def j33 : Jet := ⟨⟨(-692832042), (-692832037)⟩, ⟨9055794, 9055801⟩, ⟨849077, 849085⟩, ⟨(-11098), (-11090)⟩, ⟨(-507), (-501)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-452103046), (-452103041)⟩, ⟨(-174931920), (-174931910)⟩, ⟨(-15166344), (-15166334)⟩, ⟨450752, 450763⟩, ⟨18934, 18943⟩⟩
...
def j36 : Jet := ⟨⟨3842864250, 3842864255⟩, ⟨(-174931920), (-174931910)⟩, ⟨(-15166344), (-15166334)⟩, ⟨450752, 450763⟩, ⟨18934, 18943⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1082765279, 1082765285⟩, ⟨187748299, 187748307⟩, ⟨(-8370082), (-8370071)⟩, ⟨(-468879), (-468870)⟩, ⟨12908, 12916⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4800259090, 4800259097⟩, ⟨218513700, 218513716⟩, ⟨28891820, 28891838⟩, ⟨1614515, 1614536⟩, ⟨138223, 138242⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1210149813, 1210149823⟩, ⟨264923908, 264923924⟩, ⟨7480864, 7480885⟩, ⟨720099, 720121⟩, ⟨39687, 39707⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1104370310), (-1104370309)⟩, ⟨(-220874062), (-220874061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3190596986, 3190596987⟩, ⟨(-220874062), (-220874061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨340971762, 340971769⟩, ⟨149289898, 149289910⟩, ⟨20556757, 20556774⟩, ⟨1328664, 1328682⟩, ⟨124227, 124245⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4635939058, 4635939065⟩, ⟨149289898, 149289910⟩, ⟨20556757, 20556774⟩, ⟨1328664, 1328682⟩, ⟨124227, 124245⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4462197512, 4462197516⟩, ⟨71847472, 71847479⟩, ⟨9314753, 9314762⟩, ⟨489453, 489465⟩, ⟨42182, 42193⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3314827087, 3314827092⟩, ⟨(-176100845), (-176100836)⟩, ⟨3224791, 3224800⟩, ⟨(-115425), (-115413)⟩, ⟨6163, 6174⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨18799587250, 18799587252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value243

def j47 : Jet := ⟨⟨4833961366, 4833961372⟩, ⟨966792269, 966792275⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5440596139, 5440596153⟩, ⟨2176238446, 2176238464⟩, ⟨217623843, 217623847⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5440596139, 5440596153⟩, ⟨2176238446, 2176238464⟩, ⟨217623843, 217623847⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5440596153), (-5440596139)⟩, ⟨(-2176238464), (-2176238446)⟩, ⟨(-217623847), (-217623843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2720298077), (-2720298069)⟩, ⟨(-1088119232), (-1088119223)⟩, ⟨(-108811924), (-108811921)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2279771427, 2279771441⟩, ⟨(-577574398), (-577574389)⟩, ⟨15406072, 15406078⟩, ⟨8454104, 8454106⟩, ⟨(-730612), (-730610)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1759512368, 1759512382⟩, ⟨(-539242510), (-539242494)⟩, ⟨37283539, 37283552⟩, ⟨5398216, 5398228⟩, ⟨(-880157), (-880142)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨883496247, 1325244372⟩, ⟨220874061, 220874062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2775585318, 4163377984⟩, ⟨693896327, 693896331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1793697908, 4035820309⟩, ⟨896848950, 1345273438⟩, ⟨112106118, 112106120⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨448, 1012⟩, ⟨224, 338⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94239), (-93674)⟩, ⟨224, 338⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-88553), (-39120)⟩, ⟨(-29425), (-19242)⟩, ⟨(-2403), (-2311)⟩, ⟨10, 19⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5024503, 5073937⟩, ⟨(-29425), (-19242)⟩, ⟨(-2403), (-2311)⟩, ⟨10, 19⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2098372, 4767790⟩, ⟨1021536, 1581229⟩, ⟨119672, 127457⟩, ⟨(-1518), (-966)⟩, ⟨(-61), (-53)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141067205), (-138397786)⟩, ⟨1021536, 1581229⟩, ⟨119672, 127457⟩, ⟨(-1518), (-966)⟩, ⟨(-61), (-53)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-132555583), (-57798768)⟩, ⟨(-43758574), (-27413561)⟩, ⟨(-3418812), (-2997381)⟩, ⟨50225, 80793⟩, ⟨2589, 3104⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1299100182, 1373856998⟩, ⟨(-43758574), (-27413561)⟩, ⟨(-3418812), (-2997381)⟩, ⟨50225, 80793⟩, ⟨2589, 3104⟩⟩
...
def j72 : Jet := ⟨⟨4900, 11081⟩, ⟨2418, 3685⟩, ⟨292, 304⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847277), (-841095)⟩, ⟨2418, 3685⟩, ⟨292, 304⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-796155), (-351264)⟩, ⟨(-264376), (-172169)⟩, ⟨(-21491), (-20513)⟩, ⟨121, 193⟩, ⟨5, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34995239, 35440131⟩, ⟨(-264376), (-172169)⟩, ⟨(-21491), (-20513)⟩, ⟨121, 193⟩, ⟨5, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14614986, 33301768⟩, ⟨7059067, 11028688⟩, ⟨810432, 880533⟩, ⟨(-13583), (-8594)⟩, ⟨(-534), (-466)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701212897), (-682526114)⟩, ⟨7059067, 11028688⟩, ⟨810432, 880533⟩, ⟨(-13583), (-8594)⟩, ⟨(-534), (-466)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-658903563), (-285041905)⟩, ⟨(-216686459), (-132157705)⟩, ⟨(-16490388), (-13533298)⟩, ⟨340718, 560081⟩, ⟨16396, 20996⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3636063733, 4009925391⟩, ⟨(-216686459), (-132157705)⟩, ⟨(-16490388), (-13533298)⟩, ⟨340718, 560081⟩, ⟨16396, 20996⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨839532211, 1331764735⟩, ⟨167465154, 204245015⟩, ⟨(-10383717), (-6365974)⟩, ⟨(-519888), (-405939)⟩, ⟨9787, 16062⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4600271145, 5073273031⟩, ⟨151614111, 302335067⟩, ⟨20522529, 41025728⟩, ⟨479459, 3384967⟩, ⟨16270, 352835⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨899209595, 1573098385⟩, ⟨209005094, 335003694⟩, ⟨(-2342284), 20279979⟩, ⟨(-451126), 2341039⟩, ⟨(-103427), 244603⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1325244372), (-883496247)⟩, ⟨(-220874062), (-220874061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2969722924, 3411471049⟩, ⟨(-220874062), (-220874061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨188261711, 576171682⟩, ⟨87516096, 245400598⟩, ⟨8454975, 40985710⟩, ⟨(-695858), 4878526⟩, ⟨(-157200), 640137⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4483229007, 4871138978⟩, ⟨87516096, 245400598⟩, ⟨8454975, 40985710⟩, ⟨(-695858), 4878526⟩, ⟨(-157200), 640137⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4388088646, 4573989791⟩, ⟨41088719, 120096428⟩, ⟨2392953, 19865598⟩, ⟨(-884243), 2365093⟩, ⟨(-186631), 336826⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3034110983, 3633097222⟩, ⟨(-206812657), (-130270949)⟩, ⟨(-4521520), 13666108⟩, ⟨(-1723964), 1755522⟩, ⟨(-269869), 313014⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3867169092, 5800753646⟩, ⟨966792269, 966792275⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3481981527, 7834458459⟩, ⟨1740990756, 2611486156⟩, ⟨217623843, 217623847⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3481981527, 7834458459⟩, ⟨1740990756, 2611486156⟩, ⟨217623843, 217623847⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7834458459), (-3481981527)⟩, ⟨(-2611486156), (-1740990756)⟩, ⟨(-217623847), (-217623843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3917229230), (-1740990763)⟩, ⟨(-1305743078), (-870495378)⟩, ⟨(-108811924), (-108811921)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1725286177, 2863623962⟩, ⟨(-870590370), (-349677550)⟩, ⟨(-37113226), 88627444⟩, ⟨(-3075422), 18465144⟩, ⟨(-2526107), 703873⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1218800837, 2422329100⟩, ⟨(-874319379), (-299353887)⟩, ⟨(-23802526), 126002316⟩, ⟨(-10788664), 19493677⟩, ⟨(-3679834), 1583643⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1104370309, 1104370310⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨220874061, 220874062⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4462197512, 4462197516⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar243 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified692
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar243 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨883496247, 1325244372⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4388088646, 4573989791⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified693
    (by decide +kernel) (by decide +kernel)
...
theorem whole_function_eq (t : ℝ) : f95 t =
    finiteNormalIntegrand 4 (27357 / 12500) ((center : ℝ) + (radius : ℝ) * t) := by
...
def upper : Rat := (45570265 / 1073741824)

theorem envelope_integral : (∫ s in ((41141 / 200000) : ℝ)..(123423 / 400000),
    finiteNormalIntegrand 4 (27357 / 12500) s) ≤ (upper : ℝ) := by
  have he : f95 = (fun t ↦ finiteNormalIntegrand 4 (27357 / 12500)
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (41141 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (123423 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((41141 / 200000) : ℝ)..(123423 / 400000), prawitzNormalCorrection
      ((27357 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
