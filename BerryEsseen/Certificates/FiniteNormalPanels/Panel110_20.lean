...
namespace FiniteNormalPanel110_20
...
def j2 : Jet := ⟨⟨1592954297, 1592954301⟩, ⟨530984764, 530984768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨590808548, 590808552⟩, ⟨393872364, 393872370⟩, ⟨65645393, 65645395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨147, 149⟩, ⟨98, 99⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94540), (-94537)⟩, ⟨98, 99⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-13005), (-13004)⟩, ⟨(-8657), (-8655)⟩, ⟨(-1435), (-1431)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100051, 5100053⟩, ⟨(-8657), (-8655)⟩, ⟨(-1435), (-1431)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨701554, 701555⟩, ⟨466512, 466514⟩, ⟨76958, 76962⟩, ⟨(-265), (-262)⟩, ⟨(-22), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-142464023), (-142464021)⟩, ⟨466512, 466514⟩, ⟨76958, 76962⟩, ⟨(-265), (-262)⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-19597114), (-19597113)⟩, ⟨(-13000571), (-13000569)⟩, ⟨(-2124091), (-2124088)⟩, ⟨14150, 14153⟩, ⟨1147, 1151⟩⟩
...
def j19 : Jet := ⟨⟨1412058651, 1412058653⟩, ⟨(-13000571), (-13000569)⟩, ⟨(-2124091), (-2124088)⟩, ⟨14150, 14153⟩, ⟨1147, 1151⟩⟩
...
def j25 : Jet := ⟨⟨1625, 1627⟩, ⟨1081, 1084⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850552), (-850549)⟩, ⟨1081, 1084⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-117001), (-117000)⟩, ⟨(-77853), (-77850)⟩, ⟨(-12878), (-12875)⟩, ⟨31, 34⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35674393, 35674395⟩, ⟨(-77853), (-77850)⟩, ⟨(-12878), (-12875)⟩, ⟨31, 34⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4907310, 4907311⟩, ⟨3260830, 3260833⟩, ⟨536344, 536347⟩, ⟨(-2367), (-2364)⟩, ⟨(-195), (-191)⟩⟩
...
def j33 : Jet := ⟨⟨(-710920573), (-710920571)⟩, ⟨3260830, 3260833⟩, ⟨536344, 536347⟩, ⟨(-2367), (-2364)⟩, ⟨(-195), (-191)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-97793051), (-97793049)⟩, ⟨(-64746814), (-64746811)⟩, ⟨(-10493081), (-10493077)⟩, ⟨98698, 98702⟩, ⟨7952, 7956⟩⟩
...
def j36 : Jet := ⟨⟨4197174245, 4197174247⟩, ⟨(-64746814), (-64746811)⟩, ⟨(-10493081), (-10493077)⟩, ⟨98698, 98702⟩, ⟨7952, 7956⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨523716419, 523716422⟩, ⟨169750375, 169750379⟩, ⟨(-2395057), (-2395053)⟩, ⟨(-257353), (-257349)⟩, ⟨2174, 2177⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4395038897, 4395038900⟩, ⟨67799127, 67799132⟩, ⟨12033632, 12033640⟩, ⟨251777, 251785⟩, ⟨24040, 24049⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨535918872, 535918877⟩, ⟨181972750, 181972758⟩, ⟨1696115, 1696124⟩, ⟨205148, 205157⟩, ⟨4332, 4341⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-507053102), (-507053101)⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3787914194, 3787914195⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨66871065, 66871067⟩, ⟨45412512, 45412518⟩, ⟨8133248, 8133254⟩, ⟨194920, 194926⟩, ⟨19131, 19140⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4361838361, 4361838363⟩, ⟨45412512, 45412518⟩, ⟨8133248, 8133254⟩, ⟨194920, 194926⟩, ⟨19131, 19140⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4328273687, 4328273689⟩, ⟨22531529, 22531533⟩, ⟨3976684, 3976689⟩, ⟨76008, 76013⟩, ⟨7269, 7276⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3817288515, 3817288519⟩, ⟨(-150456878), (-150456872)⟩, ⟨2620533, 2620541⟩, ⟨(-89459), (-89452)⟩, ⟨3418, 3427⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨30494687357, 30494687363⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value483

def j47 : Jet := ⟨⟨3600126548, 3600126557⟩, ⟨1200042180, 1200042188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3017697288, 3017697304⟩, ⟨2011798186, 2011798208⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3017697288, 3017697304⟩, ⟨2011798186, 2011798208⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3017697304), (-3017697288)⟩, ⟨(-2011798208), (-2011798186)⟩, ⟨(-335299702), (-335299697)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1508848652), (-1508848644)⟩, ⟨(-1005899104), (-1005899093)⟩, ⟨(-167649851), (-167649848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3022661510, 3022661518⟩, ⟨(-707919829), (-707919819)⟩, ⟨(-35087765), (-35087759)⟩, ⟨21161204, 21161206⟩, ⟨(-554203), (-554201)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2686486362, 2686486373⟩, ⟨(-735072991), (-735072974)⟩, ⟨(-4542000), (-4541985)⟩, ⟨19541958, 19541970⟩, ⟨(-1238125), (-1238110)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨338035401, 676070803⟩, ⟨169017700, 169017701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1061969532, 2123939069⟩, ⟨530984764, 530984768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨262581577, 1050326315⟩, ⟨262581576, 525163158⟩, ⟨65645393, 65645395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-23140), (-5772)⟩, ⟨(-11567), (-5739)⟩, ⟨(-1444), (-1421)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5089916, 5107285⟩, ⟨(-11567), (-5739)⟩, ⟨(-1444), (-1421)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨311182, 1248978⟩, ⟨308353, 624139⟩, ⟨76026, 77626⟩, ⟨(-354), (-171)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142854395), (-141916598)⟩, ⟨308353, 624139⟩, ⟨76026, 77626⟩, ⟨(-354), (-171)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-34934779), (-8676360)⟩, ⟨(-17448539), (-8523727)⟩, ⟨(-2159925), (-2073789)⟩, ⟨9273, 19022⟩, ⟨1112, 1176⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1396720986, 1422979406⟩, ⟨(-17448539), (-8523727)⟩, ⟨(-2159925), (-2073789)⟩, ⟨9273, 19022⟩, ⟨1112, 1176⟩⟩
...
def j72 : Jet := ⟨⟨721, 2894⟩, ⟨717, 1447⟩, ⟨177, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851456), (-849282)⟩, ⟨717, 1447⟩, ⟨177, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-208222), (-51922)⟩, ⟨(-104068), (-51568)⟩, ⟨(-12961), (-12758)⟩, ⟨19, 46⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35583172, 35739473⟩, ⟨(-104068), (-51568)⟩, ⟨(-12961), (-12758)⟩, ⟨19, 46⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2175449, 8740023⟩, ⟨2149999, 4366860⟩, ⟨527967, 542321⟩, ⟨(-3175), (-1555)⟩, ⟨(-198), (-187)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713652434), (-707087859)⟩, ⟨2149999, 4366860⟩, ⟨527967, 542321⟩, ⟨(-3175), (-1555)⟩, ⟨(-198), (-187)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-174522384), (-43229257)⟩, ⟨(-87129749), (-42161348)⟩, ⟨(-10743928), (-10140736)⟩, ⟨64362, 132962⟩, ⟨7631, 8183⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4120444912, 4251738039⟩, ⟨(-87129749), (-42161348)⟩, ⟨(-10743928), (-10140736)⟩, ⟨64362, 132962⟩, ⟨7631, 8183⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨345351903, 703689073⟩, ⟨164047332, 173814701⟩, ⟨(-3225278), (-1566547)⟩, ⟨(-264739), (-246974)⟩, ⟨1420, 2934⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4338636083, 4476881616⟩, ⟨43023051, 94666859⟩, ⟨10774621, 13675125⟩, ⟨69453, 468243⟩, ⟨14808, 36855⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨348863244, 733493985⟩, ⟨169174691, 196686918⟩, ⟨(-852239), 4489174⟩, ⟨70080, 364965⟩, ⟨(-10830), 21646⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-676070803), (-338035401)⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3618896493, 3956931895⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨28336784, 125266013⟩, ⟨27482784, 67180336⟩, ⟨6372538, 10540549⟩, ⟨(-66674), 535820⟩, ⟨929, 45515⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4323304080, 4420233309⟩, ⟨27482784, 67180336⟩, ⟨6372538, 10540549⟩, ⟨(-66674), 535820⟩, ⟨929, 45515⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4309112395, 4357150159⟩, ⟨13545282, 33479905⟩, ⟨3012168, 5231686⟩, ⟨(-73876), 257563⟩, ⟨(-4715), 22205⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3630815011, 4014220656⟩, ⟨(-160051634), (-138729475)⟩, ⟨1220504, 4286887⟩, ⟨(-273942), 118756⟩, ⟨(-14480), 23366⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2400084368, 4800168745⟩, ⟨1200042180, 1200042188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1341198797, 5364795211⟩, ⟨1341198792, 2682397610⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1341198797, 5364795211⟩, ⟨1341198792, 2682397610⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5364795211), (-1341198797)⟩, ⟨(-2682397610), (-1341198792)⟩, ⟨(-335299702), (-335299697)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2682397606), (-670599398)⟩, ⟨(-1341198805), (-670599396)⟩, ⟨(-167649851), (-167649848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2299978044, 3674098704⟩, ⟨(-1147318816), (-359109576)⟩, ⟨(-115379871), 89360482⟩, ⟨43396, 41866288⟩, ⟨(-5012470), 2250177⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1944320929, 3433936022⟩, ⟨(-1209237705), (-377869043)⟩, ⟨(-95584907), 129941245⟩, ⟨(-4672830), 43428803⟩, ⟨(-6404242), 2284051⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4328273687, 4328273689⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar483 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2226
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar483 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4309112395, 4357150159⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2227
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((15741 / 200000) : ℝ)..(15741 / 100000), prawitzNormalCorrection
      ((53519 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
