...
namespace FiniteNormalPanel36_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (21283 / 200000)
def radius : Rat := (21283 / 200000)

def j0 : Jet := ⟨⟨457048944, 457048945⟩, ⟨457048944, 457048945⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1435861604, 1435861608⟩, ⟨1435861604, 1435861608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨480026599, 480026603⟩, ⟨960053198, 960053206⟩, ⟨480026599, 480026603⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨120, 121⟩, ⟨240, 241⟩, ⟨120, 121⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94567), (-94565)⟩, ⟨240, 241⟩, ⟨120, 121⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10570), (-10569)⟩, ⟨(-21113), (-21111)⟩, ⟨(-10504), (-10501)⟩, ⟨52, 55⟩, ⟨13, 14⟩⟩
...
def j13 : Jet := ⟨⟨5102486, 5102488⟩, ⟨(-21113), (-21111)⟩, ⟨(-10504), (-10501)⟩, ⟨52, 55⟩, ⟨13, 14⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨570278, 570280⟩, ⟨1138197, 1138200⟩, ⟨564384, 564389⟩, ⟨(-4703), (-4699)⟩, ⟨(-1162), (-1158)⟩⟩
...
def j16 : Jet := ⟨⟨(-142595299), (-142595296)⟩, ⟨1138197, 1138200⟩, ⟨564384, 564389⟩, ⟨(-4703), (-4699)⟩, ⟨(-1162), (-1158)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15937150), (-15937149)⟩, ⟨(-31747090), (-31747087)⟩, ⟨(-15619652), (-15619648)⟩, ⟨252840, 252844⟩, ⟨61896, 61900⟩⟩
...
def j19 : Jet := ⟨⟨1415718615, 1415718617⟩, ⟨(-31747090), (-31747087)⟩, ⟨(-15619652), (-15619648)⟩, ⟨252840, 252844⟩, ⟨61896, 61900⟩⟩
...
def j22 : Jet := ⟨⟨(-13), (-11)⟩, ⟨(-25), (-23)⟩, ⟨(-13), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11822, 11825⟩, ⟨(-25), (-23)⟩, ⟨(-13), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1321, 1322⟩, ⟨2639, 2642⟩, ⟨1313, 1316⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850856), (-850854)⟩, ⟨2639, 2642⟩, ⟨1313, 1316⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-95096), (-95095)⟩, ⟨(-189898), (-189895)⟩, ⟨(-94361), (-94356)⟩, ⟨586, 591⟩, ⟨143, 148⟩⟩
...
def j30 : Jet := ⟨⟨35696298, 35696300⟩, ⟨(-189898), (-189895)⟩, ⟨(-94361), (-94356)⟩, ⟨586, 591⟩, ⟨143, 148⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3989593, 3989594⟩, ⟨7957962, 7957965⟩, ⟨3936598, 3936602⟩, ⟨(-42252), (-42247)⟩, ⟨(-10402), (-10395)⟩⟩
...
def j33 : Jet := ⟨⟨(-711838290), (-711838288)⟩, ⟨7957962, 7957965⟩, ⟨3936598, 3936602⟩, ⟨(-42252), (-42247)⟩, ⟨(-10402), (-10395)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-79558538), (-79558536)⟩, ⟨(-158227655), (-158227651)⟩, ⟨(-77339724), (-77339719)⟩, ⟨1764643, 1764649⟩, ⟨429365, 429370⟩⟩
...
def j36 : Jet := ⟨⟨4215408758, 4215408760⟩, ⟨(-158227655), (-158227651)⟩, ⟨(-77339724), (-77339719)⟩, ⟨1764643, 1764649⟩, ⟨429365, 429370⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨473292544, 473292547⟩, ⟨462679092, 462679097⟩, ⟨(-15835299), (-15835294)⟩, ⟨(-5137320), (-5137315)⟩, ⟨105219, 105223⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4376027361, 4376027364⟩, ⟨164256556, 164256562⟩, ⟨86452031, 86452040⟩, ⟨4426736, 4426746⟩, ⟨1237794, 1237805⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨482225120, 482225124⟩, ⟨489511938, 489511946⟩, ⟨11087272, 11087282⟩, ⟨3961049, 3961061⟩, ⟨205262, 205274⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-457048945), (-457048944)⟩, ⟨(-457048945), (-457048944)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3837918351, 3837918352⟩, ⟨(-457048945), (-457048944)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨54142686, 54142688⟩, ⟨109921652, 109921658⟩, ⟨58281015, 58281022⟩, ⟨3416772, 3416784⟩, ⟨977621, 977630⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4349109982, 4349109984⟩, ⟨109921652, 109921658⟩, ⟨58281015, 58281022⟩, ⟨3416772, 3416784⟩, ⟨977621, 977630⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4321953856, 4321953858⟩, ⟨54617646, 54617651⟩, ⟨28613443, 28613448⟩, ⟨1336122, 1336130⟩, ⟨374154, 374161⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3862033136, 3862033140⟩, ⟨(-411115211), (-411115204)⟩, ⟨19756405, 19756412⟩, ⟨(-1850963), (-1850953)⟩, ⟨192153, 192162⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨17753676814, 17753676816⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value248

def j47 : Jet := ⟨⟨1889257514, 1889257520⟩, ⟨1889257514, 1889257520⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨831041008, 831041015⟩, ⟨1662082016, 1662082030⟩, ⟨831041008, 831041015⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨831041008, 831041015⟩, ⟨1662082016, 1662082030⟩, ⟨831041008, 831041015⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-831041015), (-831041008)⟩, ⟨(-1662082030), (-1662082016)⟩, ⟨(-831041015), (-831041008)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-415520508), (-415520504)⟩, ⟨(-831041015), (-831041008)⟩, ⟨(-415520508), (-415520504)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3898913925, 3898913929⟩, ⟨(-754407931), (-754407923)⟩, ⟨(-304218088), (-304218081)⟩, ⟨68278487, 68278490⟩, ⟨11413094, 11413096⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3505902079, 3505902087⟩, ⟨(-1051568253), (-1051568237)⟩, ⟨(-183406112), (-183406095)⟩, ⟨85365332, 85365351⟩, ⟨2827195, 2827215⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 914097890⟩, ⟨457048944, 457048945⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2871723216⟩, ⟨1435861604, 1435861608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1920106409⟩, ⟨0, 1920106410⟩, ⟨480026599, 480026603⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 482⟩, ⟨0, 482⟩, ⟨120, 121⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94204)⟩, ⟨0, 482⟩, ⟨120, 121⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-42331), 0⟩, ⟨(-42331), 216⟩, ⟨(-10583), (-10257)⟩, ⟨0, 109⟩, ⟨13, 14⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5070725, 5113057⟩, ⟨(-42331), 216⟩, ⟨(-10583), (-10257)⟩, ⟨0, 109⟩, ⟨13, 14⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2285842⟩, ⟨(-18925), 2285939⟩, ⟨543072, 571558⟩, ⟨(-9464), 74⟩, ⟨(-1183), (-1090)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-140879734)⟩, ⟨(-18925), 2285939⟩, ⟨543072, 571558⟩, ⟨(-9464), 74⟩, ⟨(-1183), (-1090)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-64003548), 0⟩, ⟨(-64012009), 1021952⟩, ⟨(-16009348), (-14467936)⟩, ⟨(-6347), 511043⟩, ⟨55936, 63915⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1367652217, 1431655766⟩, ⟨(-64012009), 1021952⟩, ⟨(-16009348), (-14467936)⟩, ⟨(-6347), 511043⟩, ⟨55936, 63915⟩⟩
...
def j70 : Jet := ⟨⟨(-49), 0⟩, ⟨(-49), 0⟩, ⟨(-13), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11786, 11836⟩, ⟨(-49), 0⟩, ⟨(-13), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 5292⟩, ⟨(-22), 5292⟩, ⟨1289, 1323⟩, ⟨(-12), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-846884)⟩, ⟨(-22), 5292⟩, ⟨1289, 1323⟩, ⟨(-12), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-380974), 0⟩, ⟨(-380984), 2366⟩, ⟨(-95254), (-91693)⟩, ⟨(-9), 1184⟩, ⟨137, 148⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35410420, 35791395⟩, ⟨(-380984), 2366⟩, ⟨(-95254), (-91693)⟩, ⟨(-9), 1184⟩, ⟨137, 148⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 16000888⟩, ⟨(-170323), 16001946⟩, ⟨3744734, 4001280⟩, ⟨(-85171), 795⟩, ⟨(-10652), (-9651)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-699826994)⟩, ⟨(-170323), 16001946⟩, ⟨3744734, 4001280⟩, ⟨(-85171), 795⟩, ⟨(-10652), (-9651)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-320017735), 0⟩, ⟨(-320093881), 7153824⟩, ⟨(-80080579), (-69273460)⟩, ⟨(-57114), 3577623⟩, ⟨375689, 447559⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3974949561, 4294967296⟩, ⟨(-320093881), 7153824⟩, ⟨(-80080579), (-69273460)⟩, ⟨(-57114), 3577623⟩, ⟨375689, 447559⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 957241073⟩, ⟨414423302, 479303840⟩, ⟨(-32104274), 341652⟩, ⟨(-5356371), (-4495116)⟩, ⟨(-2122), 213585⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4640749220⟩, ⟨(-8352083), 373709254⟩, ⟨68650998, 123587967⟩, ⟨(-4567561), 17547812⟩, ⟨(-30282), 3504512⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 1034307239⟩, ⟨412561831, 601182406⟩, ⟨(-35621011), 69618524⟩, ⟨(-2974861), 13270285⟩, ⟨(-1908635), 2990376⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-914097890), 0⟩, ⟨(-457048945), (-457048944)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3380869406, 4294967296⟩, ⟨(-457048945), (-457048944)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 249080236⟩, ⟨0, 289551596⟩, ⟨22473074, 117680564⟩, ⟨(-11404814), 25880984⟩, ⟨(-2329469), 6283728⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4544047532⟩, ⟨0, 289551596⟩, ⟨22473074, 117680564⟩, ⟨(-11404814), 25880984⟩, ⟨(-2329469), 6283728⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4417752318⟩, ⟨0, 144775798⟩, ⟨8551982, 58840282⟩, ⟨(-7685810), 12940492⟩, ⟨(-2003988), 3392426⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3380869406, 4417752318⟩, ⟨(-470115114), (-312273146)⟩, ⟨(-8674454), 58840282⟩, ⟨(-13947299), 12030433⟩, ⟨(-3381051), 4210312⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3778515039⟩, ⟨1889257514, 1889257520⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3324164055⟩, ⟨0, 3324164056⟩, ⟨831041008, 831041015⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3324164055⟩, ⟨0, 3324164056⟩, ⟨831041008, 831041015⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3324164055), 0⟩, ⟨(-3324164056), 0⟩, ⟨(-831041015), (-831041008)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1662082028), 0⟩, ⟨(-1662082028), 0⟩, ⟨(-415520508), (-415520504)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2916721793, 4294967296⟩, ⟨(-1662082028), 0⟩, ⟨(-415520508), 39418374⟩, ⟨(-5084756), 160799634⟩, ⟨(-17463490), 20591884⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2295955893, 4417752318⟩, ⟨(-2179712936), (-212065384)⟩, ⟨(-436073911), 281312407⟩, ⟨(-46262271), 226265612⟩, ⟨(-49292607), 32184039⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨457048944, 457048945⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨457048944, 457048945⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4321953856, 4321953858⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar248 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified700
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar248 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 914097890⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4417752318⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified701
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(21283 / 100000), prawitzNormalCorrection
      ((5167 / 2500) * sqrt n) s) ≤ (upper : ℝ) :=
