...
namespace FiniteNormalPanel164_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (47761 / 200000)
def radius : Rat := (6823 / 200000)

def j0 : Jet := ⟨⟨1025659665, 1025659666⟩, ⟨146522809, 146522810⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3222204868, 3222204872⟩, ⟨460314980, 460314984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2417388421, 2417388428⟩, ⟨690682404, 690682412⟩, ⟨49334457, 49334459⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨605, 606⟩, ⟨172, 174⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94082), (-94080)⟩, ⟨172, 174⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-52954), (-52952)⟩, ⟨(-15034), (-15031)⟩, ⟨(-1048), (-1044)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5060102, 5060105⟩, ⟨(-15034), (-15031)⟩, ⟨(-1048), (-1044)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2848038, 2848041⟩, ⟨805263, 805266⟩, ⟨55115, 55120⟩, ⟨(-341), (-336)⟩, ⟨(-13), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-140317539), (-140317535)⟩, ⟨805263, 805266⟩, ⟨55115, 55120⟩, ⟨(-341), (-336)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-78976619), (-78976616)⟩, ⟨(-22111514), (-22111509)⟩, ⟨(-1451252), (-1451246)⟩, ⟨17920, 17925⟩, ⟨570, 575⟩⟩
...
def j19 : Jet := ⟨⟨1352679146, 1352679150⟩, ⟨(-22111514), (-22111509)⟩, ⟨(-1451252), (-1451246)⟩, ⟨17920, 17925⟩, ⟨570, 575⟩⟩
...
def j25 : Jet := ⟨⟨6626, 6629⟩, ⟨1882, 1885⟩, ⟨130, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845551), (-845547)⟩, ⟨1882, 1885⟩, ⟨130, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-475912), (-475909)⟩, ⟨(-134916), (-134913)⟩, ⟨(-9338), (-9332)⟩, ⟨39, 44⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35315482, 35315486⟩, ⟨(-134916), (-134913)⟩, ⟨(-9338), (-9332)⟩, ⟨39, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19877040, 19877043⟩, ⟨5603217, 5603222⟩, ⟨378700, 378707⟩, ⟨(-3031), (-3024)⟩, ⟨(-103), (-97)⟩⟩
...
def j33 : Jet := ⟨⟨(-695950843), (-695950839)⟩, ⟨5603217, 5603222⟩, ⟨378700, 378707⟩, ⟨(-3031), (-3024)⟩, ⟨(-103), (-97)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-391710437), (-391710433)⟩, ⟨(-108763543), (-108763536)⟩, ⟨(-6879879), (-6879871)⟩, ⟨123554, 123561⟩, ⟨3803, 3811⟩⟩
...
def j36 : Jet := ⟨⟨3903256859, 3903256863⟩, ⟨(-108763543), (-108763536)⟩, ⟨(-6879879), (-6879871)⟩, ⟨123554, 123561⟩, ⟨3803, 3811⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1014817815, 1014817820⟩, ⟨128385295, 128385302⟩, ⟨(-3458582), (-3458575)⟩, ⟨(-142095), (-142089)⟩, ⟨2347, 2354⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4725987738, 4725987744⟩, ⟨131688780, 131688791⟩, ⟨11999496, 11999510⟩, ⟨416871, 416884⟩, ⟨23981, 23996⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1116659620, 1116659628⟩, ⟨172384886, 172384898⟩, ⟨2966026, 2966040⟩, ⟨194787, 194800⟩, ⟨6689, 6705⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1025659666), (-1025659665)⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3269307630, 3269307631⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨290323213, 290323218⟩, ⟨89637580, 89637590⟩, ⟨8461211, 8461223⟩, ⟨339376, 339388⟩, ⟨21162, 21175⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4585290509, 4585290514⟩, ⟨89637580, 89637590⟩, ⟨8461211, 8461223⟩, ⟨339376, 339388⟩, ⟨21162, 21175⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4437755376, 4437755379⟩, ⟨43376712, 43376717⟩, ⟨3882489, 3882497⟩, ⟨126277, 126286⟩, ⟨7307, 7315⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3377997202, 3377997206⟩, ⟨(-118375890), (-118375883)⟩, ⟨1475534, 1475542⟩, ⟨(-36331), (-36322)⟩, ⟨1253, 1262⟩⟩
...
def j47 : Jet := ⟨⟨9163694780, 9163694791⟩, ⟨1309099251, 1309099261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨19551557959, 19551558007⟩, ⟨5586159402, 5586159454⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨19551557959, 19551558007⟩, ⟨5586159402, 5586159454⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-19551558007), (-19551557959)⟩, ⟨(-5586159454), (-5586159402)⟩, ⟨(-399011392), (-399011384)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9775779004), (-9775778979)⟩, ⟨(-2793079727), (-2793079701)⟩, ⟨(-199505696), (-199505692)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨441023558, 441023569⟩, ⟨(-286804045), (-286804034)⟩, ⟨72770413, 72770420⟩, ⟨(-6892991), (-6892988)⟩, ⟨(-569479), (-569477)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨346865585, 346865595⟩, ⟨(-237727031), (-237727019)⟩, ⟨65290292, 65290303⟩, ⟨(-7529275), (-7529267)⟩, ⟨(-230362), (-230354)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨879136855, 1172182475⟩, ⟨146522809, 146522810⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2761889885, 3682519853⟩, ⟨460314980, 460314984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1776040470, 3157405292⟩, ⟨592013488, 789351328⟩, ⟨49334457, 49334459⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨444, 792⟩, ⟨148, 198⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94243), (-93894)⟩, ⟨148, 198⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-69282), (-38826)⟩, ⟨(-17260), (-12796)⟩, ⟨(-1059), (-1031)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5043774, 5074231⟩, ⟨(-17260), (-12796)⟩, ⟨(-1059), (-1031)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2085684, 3730274⟩, ⟨682539, 927278⟩, ⟨53983, 56097⟩, ⟨(-394), (-283)⟩, ⟨(-13), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141079893), (-139435302)⟩, ⟨682539, 927278⟩, ⟨53983, 56097⟩, ⟨(-394), (-283)⟩, ⟨(-13), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-103713573), (-57658818)⟩, ⟨(-25646153), (-18537926)⟩, ⟨(-1504123), (-1389973)⟩, ⟨14990, 20845⟩, ⟨537, 603⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1327942192, 1373996948⟩, ⟨(-25646153), (-18537926)⟩, ⟨(-1504123), (-1389973)⟩, ⟨14990, 20845⟩, ⟨537, 603⟩⟩
...
def j72 : Jet := ⟨⟨4860, 8669⟩, ⟨1605, 2163⟩, ⟨129, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847317), (-843507)⟩, ⟨1605, 2163⟩, ⟨129, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-622898), (-348804)⟩, ⟨(-155062), (-114677)⟩, ⟨(-9459), (-9191)⟩, ⟨33, 50⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35168496, 35442591⟩, ⟨(-155062), (-114677)⟩, ⟨(-9459), (-9191)⟩, ⟨33, 50⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14542758, 26055292⟩, ⟨4733593, 6466403⟩, ⟨368512, 387508⟩, ⟨(-3508), (-2546)⟩, ⟨(-106), (-93)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701285125), (-689772590)⟩, ⟨4733593, 6466403⟩, ⟨368512, 387508⟩, ⟨(-3508), (-2546)⟩, ⟨(-106), (-93)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-515543243), (-285232447)⟩, ⟨(-126928393), (-90323765)⟩, ⟨(-7250506), (-6449820)⟩, ⟨102588, 144444⟩, ⟨3509, 4064⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3779424053, 4009734849⟩, ⟨(-126928393), (-90323765)⟩, ⟨(-7250506), (-6449820)⟩, ⟨102588, 144444⟩, ⟨3509, 4064⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨853936678, 1178069748⟩, ⟨120333678, 135337859⟩, ⟨(-4038279), (-2880635)⟩, ⟨(-151567), (-131097)⟩, ⟨1951, 2753⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4600489750, 4880834703⟩, ⟨103631180, 163918232⟩, ⟨9734480, 14868510⟩, ⟨210149, 688935⟩, ⟨9538, 44580⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨914681454, 1338767752⟩, ⟨149497835, 198760264⟩, ⟨249773, 6157942⟩, ⟨(-11848), 447561⟩, ⟨(-9893), 27375⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1172182475), (-879136855)⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3122784821, 3415830441⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨194795933, 417302152⟩, ⟨63675872, 123909598⟩, ⟨5310058, 13037063⟩, ⟨10000, 848966⟩, ⟨(-7252), 67319⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4489763229, 4712269448⟩, ⟨63675872, 123909598⟩, ⟨5310058, 13037063⟩, ⟨10000, 848966⟩, ⟨(-7252), 67319⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4391285260, 4498782410⟩, ⟨30395534, 60595890⟩, ⟨2126649, 6270360⟩, ⟨(-81636), 400453⟩, ⟨(-13550), 33533⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3192815686, 3577926640⟩, ⟨(-131375979), (-101616178)⟩, ⟨(-520986), 3949938⟩, ⟨(-278840), 245935⟩, ⟨(-24439), 29456⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7854595519, 10472794043⟩, ⟨1309099251, 1309099261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14364409904, 25536728806⟩, ⟨4788136626, 6384182230⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14364409904, 25536728806⟩, ⟨4788136626, 6384182230⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-25536728806), (-14364409904)⟩, ⟨(-6384182230), (-4788136626)⟩, ⟨(-399011392), (-399011384)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12768364403), (-7182204952)⟩, ⟨(-3192091115), (-2394068313)⟩, ⟨(-199505696), (-199505692)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨219715320, 806708043⟩, ⟨(-599558833), (-122472058)⟩, ⟨(-3338702), 212595043⟩, ⟨(-48875422), 19393881⟩, ⟨(-8541095), 9158800⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨163333145, 672028912⟩, ⟨(-524138934), (-96242254)⟩, ⟨18446, 196183927⟩, ⟨(-47822420), 16377140⟩, ⟨(-7773107), 9364742⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1025659665, 1025659666⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4437755376, 4437755379⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3316
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨879136855, 1172182475⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4391285260, 4498782410⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3317
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (12639675 / 2147483648)

theorem envelope_integral : (∫ s in ((20469 / 100000) : ℝ)..(6823 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((20469 / 100000) : ℝ)..(6823 / 25000), prawitzNormalCorrection
