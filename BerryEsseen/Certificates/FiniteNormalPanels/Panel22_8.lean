...
namespace FiniteNormalPanel22_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (44687 / 160000)
def radius : Rat := (44687 / 800000)

def j0 : Jet := ⟨⟨1199557522, 1199557523⟩, ⟨239911504, 239911505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3768521098, 3768521102⟩, ⟨753704218, 753704222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3306602888, 3306602896⟩, ⟨1322641152, 1322641162⟩, ⟨132264114, 132264117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨827, 829⟩, ⟨331, 332⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93860), (-93857)⟩, ⟨331, 332⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-72261), (-72258)⟩, ⟨(-28651), (-28647)⟩, ⟨(-2765), (-2760)⟩, ⟨20, 22⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5040795, 5040799⟩, ⟨(-28651), (-28647)⟩, ⟨(-2765), (-2760)⟩, ⟨20, 22⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3880799, 3880803⟩, ⟨1530261, 1530268⟩, ⟨144278, 144288⟩, ⟨(-1720), (-1714)⟩, ⟨(-80), (-75)⟩⟩
...
def j16 : Jet := ⟨⟨(-139284778), (-139284773)⟩, ⟨1530261, 1530268⟩, ⟨144278, 144288⟩, ⟨(-1720), (-1714)⟩, ⟨(-80), (-75)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-107232354), (-107232349)⟩, ⟨(-41714827), (-41714818)⟩, ⟨(-3706973), (-3706959)⟩, ⟨90229, 90240⟩, ⟨3851, 3860⟩⟩
...
def j19 : Jet := ⟨⟨1324423411, 1324423417⟩, ⟨(-41714827), (-41714818)⟩, ⟨(-3706973), (-3706959)⟩, ⟨90229, 90240⟩, ⟨3851, 3860⟩⟩
...
def j22 : Jet := ⟨⟨(-84), (-82)⟩, ⟨(-34), (-32)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11751, 11754⟩, ⟨(-34), (-32)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9046, 9050⟩, ⟨3591, 3596⟩, ⟨346, 351⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843131), (-843126)⟩, ⟨3591, 3596⟩, ⟨346, 351⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-649109), (-649104)⟩, ⟨(-256880), (-256872)⟩, ⟨(-24594), (-24585)⟩, ⟨212, 220⟩, ⟨7, 11⟩⟩
...
def j30 : Jet := ⟨⟨35142285, 35142291⟩, ⟨(-256880), (-256872)⟩, ⟨(-24594), (-24585)⟩, ⟨212, 220⟩, ⟨7, 11⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨27055288, 27055294⟩, ⟨10624348, 10624358⟩, ⟨984169, 984181⟩, ⟨(-15322), (-15310)⟩, ⟨(-688), (-680)⟩⟩
...
def j33 : Jet := ⟨⟨(-688772595), (-688772588)⟩, ⟨10624348, 10624358⟩, ⟨984169, 984181⟩, ⟨(-15322), (-15310)⟩, ⟨(-688), (-680)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-530271199), (-530271192)⟩, ⟨(-203929025), (-203929011)⟩, ⟨(-17181377), (-17181361)⟩, ⟨618457, 618473⟩, ⟨25058, 25071⟩⟩
...
def j36 : Jet := ⟨⟨3764696097, 3764696104⟩, ⟨(-203929025), (-203929011)⟩, ⟨(-17181377), (-17181361)⟩, ⟨618457, 618473⟩, ⟨25058, 25071⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1162085115, 1162085123⟩, ⟨195815298, 195815310⟩, ⟨(-10572944), (-10572929)⟩, ⟨(-571351), (-571337)⟩, ⟨19211, 19223⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4899929121, 4899929131⟩, ⟨265423202, 265423224⟩, ⟨36740000, 36740026⟩, ⟨2396529, 2396558⟩, ⟨221253, 221279⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1325769046, 1325769059⟩, ⟨295211894, 295211916⟩, ⟨9979645, 9979674⟩, ⟨1018246, 1018277⟩, ⟨65289, 65318⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1199557523), (-1199557522)⟩, ⟨(-239911505), (-239911504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3095409773, 3095409774⟩, ⟨(-239911505), (-239911504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨409237938, 409237947⟩, ⟨182251814, 182251830⟩, ⟨26452231, 26452255⟩, ⟨2000510, 2000538⟩, ⟨203470, 203497⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4704205234, 4704205243⟩, ⟨182251814, 182251830⟩, ⟨26452231, 26452255⟩, ⟨2000510, 2000538⟩, ⟨203470, 203497⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4494931326, 4494931332⟩, ⟨87072028, 87072037⟩, ⟨11794387, 11794400⟩, ⟨727285, 727300⟩, ⟨67646, 67661⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3239525099, 3239525105⟩, ⟨(-188327893), (-188327882)⟩, ⟨3636552, 3636564⟩, ⟨(-134663), (-134649)⟩, ⟨8125, 8139⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨16193659475, 16193659480⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value194

def j47 : Jet := ⟨⟨4522787880, 4522787886⟩, ⟨904557574, 904557579⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4762692890, 4762692904⟩, ⟨1905077152, 1905077166⟩, ⟨190507714, 190507717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4762692890, 4762692904⟩, ⟨1905077152, 1905077166⟩, ⟨190507714, 190507717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4762692904), (-4762692890)⟩, ⟨(-1905077166), (-1905077152)⟩, ⟨(-190507717), (-190507714)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2381346452), (-2381346445)⟩, ⟨(-952538583), (-952538576)⟩, ⟨(-95253859), (-95253857)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2466976994, 2466977010⟩, ⟨(-547126585), (-547126576)⟩, ⟨5958253, 5958257⟩, ⟨7648980, 7648982⟩, ⟨(-490170), (-490169)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1860743828, 1860743845⟩, ⟨(-520849343), (-520849326)⟩, ⟨30573547, 30573562⟩, ⟨4967460, 4967475⟩, ⟨(-678251), (-678236)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨959646017, 1439469027⟩, ⟨239911504, 239911505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3014816876, 4522225321⟩, ⟨753704218, 753704222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2116225845, 4761508167⟩, ⟨1058112920, 1587169394⟩, ⟨132264114, 132264117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨529, 1193⟩, ⟨264, 398⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94158), (-93493)⟩, ⟨264, 398⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-104386), (-46066)⟩, ⟨(-34666), (-22591)⟩, ⟨(-2819), (-2693)⟩, ⟨16, 26⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5008670, 5066991⟩, ⟨(-34666), (-22591)⟩, ⟨(-2819), (-2693)⟩, ⟨16, 26⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2467883, 5617393⟩, ⟨1195509, 1861334⟩, ⟨138305, 149148⟩, ⟨(-2103), (-1329)⟩, ⟨(-84), (-69)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140697694), (-137548183)⟩, ⟨1195509, 1861334⟩, ⟨138305, 149148⟩, ⟨(-2103), (-1329)⟩, ⟨(-84), (-69)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-155980983), (-67773046)⟩, ⟨(-51404609), (-31823001)⟩, ⟨(-3970135), (-3382624)⟩, ⟨68555, 111784⟩, ⟨3387, 4234⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1275674782, 1363882720⟩, ⟨(-51404609), (-31823001)⟩, ⟨(-3970135), (-3382624)⟩, ⟨68555, 111784⟩, ⟨3387, 4234⟩⟩
...
def j70 : Jet := ⟨⟨(-120), (-52)⟩, ⟨(-40), (-26)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11715, 11784⟩, ⟨(-40), (-26)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5772, 13065⟩, ⟨2841, 4343⟩, ⟨340, 356⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846405), (-839111)⟩, ⟨2841, 4343⟩, ⟨340, 356⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-938346), (-413448)⟩, ⟨(-311383), (-201909)⟩, ⟨(-25200), (-23840)⟩, ⟨165, 266⟩, ⟨6, 11⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34853048, 35377947⟩, ⟨(-311383), (-201909)⟩, ⟨(-25200), (-23840)⟩, ⟨165, 266⟩, ⟨6, 11⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17172871, 39220877⟩, ⟨8241228, 12974141⟩, ⟨930297, 1027981⟩, ⟨(-18822), (-11795)⟩, ⟨(-735), (-622)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698655012), (-676607005)⟩, ⟨8241228, 12974141⟩, ⟨930297, 1027981⟩, ⟨(-18822), (-11795)⟩, ⟨(-735), (-622)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-774546421), (-333379309)⟩, ⟨(-254121506), (-152306196)⟩, ⟨(-19026483), (-14902074)⟩, ⟨462111, 773612⟩, ⟨20877, 28446⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3520420875, 3961587987⟩, ⟨(-254121506), (-152306196)⟩, ⟨(-19026483), (-14902074)⟩, ⟨462111, 773612⟩, ⟨20877, 28446⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨895449393, 1436049345⟩, ⟨169737785, 217003666⟩, ⟨(-13200967), (-7958878)⟩, ⟨(-648580), (-475902)⟩, ⟨14407, 24076⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4656401456, 5239925773⟩, ⟨179018816, 378243931⟩, ⟨24398223, 55623260⟩, ⟨588167, 5448198⟩, ⟨2900, 642791⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨970804099, 1752002159⟩, ⟨221345005, 391216030⟩, ⟨(-3943793), 29080161⟩, ⟨(-866999), 3784327⟩, ⟨(-188616), 454520⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1439469027), (-959646017)⟩, ⟨(-239911505), (-239911504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2855498269, 3335321279⟩, ⟨(-239911505), (-239911504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨219433707, 714676354⟩, ⟨100062524, 319169522⟩, ⟨8189710, 59359474⟩, ⟨(-1425792), 8385058⟩, ⟨(-338531), 1257119⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4514401003, 5009643650⟩, ⟨100062524, 319169522⟩, ⟨8189710, 59359474⟩, ⟨(-1425792), 8385058⟩, ⟨(-338531), 1257119⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4403317461, 4638561808⟩, ⟨46325271, 155657941⟩, ⟨1179798, 28705740⟩, ⟨(-1710107), 4076954⟩, ⟨(-402790), 673388⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2927534605, 3602144752⟩, ⟨(-228305025), (-125085299)⟩, ⟨(-7910474), 19704202⟩, ⟨(-2931477), 3100118⟩, ⟨(-540527), 618455⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3618230301, 5427345461⟩, ⟨904557574, 904557579⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3048123445, 6858277776⟩, ⟨1524061720, 2286092598⟩, ⟨190507714, 190507717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3048123445, 6858277776⟩, ⟨1524061720, 2286092598⟩, ⟨190507714, 190507717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6858277776), (-3048123445)⟩, ⟨(-2286092598), (-1524061720)⟩, ⟨(-190507717), (-190507714)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3429138888), (-1524061722)⟩, ⟨(-1143046299), (-762030860)⟩, ⟨(-95253859), (-95253857)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1932926789, 3011973978⟩, ⟨(-801595326), (-342947864)⟩, ⟨(-36375997), 63798287⟩, ⟨(-589076), 15078854⟩, ⟨(-1710718), 442568⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1317521106, 2526111496⟩, ⟨(-832395441), (-290054003)⟩, ⟨(-26067723), 109935052⟩, ⟨(-9618639), 18230528⟩, ⟨(-3360839), 1676014⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1199557522, 1199557523⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4494931326, 4494931332⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar194 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified440
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar194 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨959646017, 1439469027⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4403317461, 4638561808⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified441
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((44687 / 200000) : ℝ)..(134061 / 400000), prawitzNormalCorrection
      ((217683 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
