...
namespace FiniteNormalPanel89_16
...
def j2 : Jet := ⟨⟨1569931801, 1569931805⟩, ⟨523310598, 523310602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨573854395, 573854399⟩, ⟨382569594, 382569600⟩, ⟨63761598, 63761600⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-12633), (-12631)⟩, ⟨(-8410), (-8408)⟩, ⟨(-1394), (-1391)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100423, 5100426⟩, ⟨(-8410), (-8408)⟩, ⟨(-1394), (-1391)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨681472, 681473⟩, ⟨453190, 453192⟩, ⟨74782, 74787⟩, ⟨(-250), (-246)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-142484105), (-142484103)⟩, ⟨453190, 453192⟩, ⟨74782, 74787⟩, ⟨(-250), (-246)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-19037428), (-19037427)⟩, ⟨(-12631068), (-12631066)⟩, ⟨(-2064912), (-2064908)⟩, ⟨13354, 13358⟩, ⟨1084, 1088⟩⟩
...
def j19 : Jet := ⟨⟨1412618337, 1412618339⟩, ⟨(-12631068), (-12631066)⟩, ⟨(-2064912), (-2064908)⟩, ⟨13354, 13358⟩, ⟨1084, 1088⟩⟩
...
def j25 : Jet := ⟨⟨1579, 1580⟩, ⟨1050, 1053⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850598), (-850596)⟩, ⟨1050, 1053⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-113650), (-113648)⟩, ⟨(-75627), (-75624)⟩, ⟨(-12512), (-12509)⟩, ⟨29, 32⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35677744, 35677747⟩, ⟨(-75627), (-75624)⟩, ⟨(-12512), (-12509)⟩, ⟨29, 32⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4766935, 4766936⟩, ⟨3167851, 3167854⟩, ⟨521250, 521253⟩, ⟨(-2235), (-2231)⟩, ⟨(-184), (-181)⟩⟩
...
def j33 : Jet := ⟨⟨(-711060948), (-711060946)⟩, ⟨3167851, 3167854⟩, ⟨521250, 521253⟩, ⟨(-2235), (-2231)⟩, ⟨(-184), (-181)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-95005486), (-95005484)⟩, ⟨(-62913732), (-62913729)⟩, ⟨(-10204350), (-10204344)⟩, ⟨93158, 93162⟩, ⟨7513, 7517⟩⟩
...
def j36 : Jet := ⟨⟨4199961810, 4199961812⟩, ⟨(-62913732), (-62913729)⟩, ⟨(-10204350), (-10204344)⟩, ⟨93158, 93162⟩, ⟨7513, 7517⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨516351882, 516351885⟩, ⟨167500281, 167500285⟩, ⟨(-2293788), (-2293785)⟩, ⟨(-246714), (-246711)⟩, ⟨2023, 2026⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4392121857, 4392121860⟩, ⟨65792208, 65792213⟩, ⟨11656760, 11656770⟩, ⟨237038, 237046⟩, ⟨22549, 22560⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨528032050, 528032054⟩, ⟨179198936, 179198944⟩, ⟨1621573, 1621580⟩, ⟨195668, 195676⟩, ⟨4016, 4026⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-499724814), (-499724813)⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3795242482, 3795242483⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨64917338, 64917340⟩, ⟨44062166, 44062170⟩, ⟨7875435, 7875441⟩, ⟨183422, 183430⟩, ⟨17924, 17933⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4359884634, 4359884636⟩, ⟨44062166, 44062170⟩, ⟨7875435, 7875441⟩, ⟨183422, 183430⟩, ⟨17924, 17933⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4327304232, 4327304234⟩, ⟨21866449, 21866452⟩, ⟨3853044, 3853048⟩, ⟨71555, 71561⟩, ⟨6817, 6824⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3823816975, 3823816978⟩, ⟨(-148506826), (-148506821)⟩, ⟨2556673, 2556680⟩, ⟨(-86207), (-86200)⟩, ⟨3247, 3256⟩⟩
...
def j47 : Jet := ⟨⟨3753498034, 3753498043⟩, ⟨1251166006, 1251166015⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3280292146, 3280292163⟩, ⟨2186861420, 2186861444⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3280292146, 3280292163⟩, ⟨2186861420, 2186861444⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3280292163), (-3280292146)⟩, ⟨(-2186861444), (-2186861420)⟩, ⟨(-364476908), (-364476902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1640146082), (-1640146073)⟩, ⟨(-1093430722), (-1093430710)⟩, ⟨(-182238454), (-182238451)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2931656649, 2931656660⟩, ⟨(-746353404), (-746353392)⟩, ⟨(-29387353), (-29387347)⟩, ⟨23606046, 23606049⟩, ⟨(-878969), (-878968)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2610059096, 2610059109⟩, ⟨(-765847473), (-765847456)⟩, ⟨1388134, 1388149⟩, ⟨21529499, 21529512⟩, ⟨(-1599072), (-1599059)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨333149875, 666299752⟩, ⟨166574937, 166574938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1046621199, 2093242407⟩, ⟨523310598, 523310602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨255046397, 1020185597⟩, ⟨255046396, 510092800⟩, ⟨63761598, 63761600⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨63, 256⟩, ⟨63, 128⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94624), (-94430)⟩, ⟨63, 128⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-22477), (-5607)⟩, ⟨(-11236), (-5576)⟩, ⟨(-1402), (-1381)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5090579, 5107450⟩, ⟨(-11236), (-5576)⟩, ⟨(-1402), (-1381)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨302291, 1213175⟩, ⟨299622, 606257⟩, ⟨73903, 75411⟩, ⟨(-334), (-163)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142863286), (-141952401)⟩, ⟨299622, 606257⟩, ⟨73903, 75411⟩, ⟨(-334), (-163)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-33934384), (-8429505)⟩, ⟨(-16949400), (-8285499)⟩, ⟨(-2098719), (-2017460)⟩, ⟨8756, 17949⟩, ⟨1052, 1110⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1397721381, 1423226261⟩, ⟨(-16949400), (-8285499)⟩, ⟨(-2098719), (-2017460)⟩, ⟨8756, 17949⟩, ⟨1052, 1110⟩⟩
...
def j72 : Jet := ⟨⟨701, 2810⟩, ⟨697, 1405⟩, ⟨172, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851476), (-849366)⟩, ⟨697, 1405⟩, ⟨172, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-202252), (-50437)⟩, ⟨(-101085), (-50103)⟩, ⟨(-12590), (-12400)⟩, ⟨19, 42⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35589142, 35740958⟩, ⟨(-101085), (-50103)⟩, ⟨(-12590), (-12400)⟩, ⟨19, 42⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2113376, 8489567⟩, ⟨2089365, 4241809⟩, ⟨513347, 526887⟩, ⟨(-2996), (-1469)⟩, ⟨(-186), (-178)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713714507), (-707338315)⟩, ⟨2089365, 4241809⟩, ⟨513347, 526887⟩, ⟨(-2996), (-1469)⟩, ⟨(-186), (-178)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-169528942), (-42003600)⟩, ⟨(-84640401), (-40996040)⟩, ⟨(-10441005), (-9871967)⟩, ⟨60788, 125462⟩, ⟨7219, 7725⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4125438354, 4252963696⟩, ⟨(-84640401), (-40996040)⟩, ⟨(-10441005), (-9871967)⟩, ⟨60788, 125462⟩, ⟨7219, 7725⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨340604416, 693639174⟩, ⟨162041561, 171390739⟩, ⟨(-3088017), (-1501152)⟩, ⟨(-253581), (-237064)⟩, ⟨1322, 2728⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4337385736, 4471462786⟩, ⟨41809817, 91739683⟩, ⟨10470947, 13198950⟩, ⟨66073, 439072⟩, ⟨14112, 34210⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨343968331, 722143277⟩, ⟨166957583, 193249796⟩, ⟨(-807126), 4276534⟩, ⟨70327, 343598⟩, ⟨(-9961), 19922⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-666299752), (-333149875)⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3628667544, 3961817421⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨27547174, 121419065⟩, ⟨26742052, 64984916⟩, ⟨6218699, 10133261⟩, ⟨(-61370), 500386⟩, ⟨1312, 41881⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4322514470, 4416386361⟩, ⟨26742052, 64984916⟩, ⟨6218699, 10133261⟩, ⟨(-61370), 500386⟩, ⟨1312, 41881⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308718868, 4355253723⟩, ⟨13185941, 32388757⟩, ⟨2945876, 5030284⟩, ⟨(-68400), 240380⟩, ⟨(-4090), 20382⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3640285765, 4017427581⟩, ⟨(-157772732), (-137231831)⟩, ⟨1232709, 4128698⟩, ⟨(-258189), 107483⟩, ⟨(-13096), 21455⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2502332020, 5004664057⟩, ⟨1251166006, 1251166015⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1457907617, 5831630511⟩, ⟨1457907612, 2915815258⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1457907617, 5831630511⟩, ⟨1457907612, 2915815258⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5831630511), (-1457907617)⟩, ⟨(-2915815258), (-1457907612)⟩, ⟨(-364476908), (-364476902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2915815256), (-728953808)⟩, ⟨(-1457907629), (-728953806)⟩, ⟨(-182238454), (-182238451)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2178317513, 3624517431⟩, ⟨(-1230326392), (-369710112)⟩, ⟨(-122416685), 116386896⟩, ⟨(-2710968), 48653672⟩, ⟨(-6598008), 2827170⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1846276743, 3390302019⟩, ⟨(-1283967216), (-382956340)⟩, ⟨(-102068052), 157545419⟩, ⟨(-8211765), 49991173⟩, ⟨(-8118427), 2948014⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4327304232, 4327304234⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1808
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308718868, 4355253723⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1809
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (101268693 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((31027 / 400000) : ℝ)..(31027 / 200000), prawitzNormalCorrection
