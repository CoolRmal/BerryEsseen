...
namespace FiniteNormalPanel122_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (192493 / 800000)
def radius : Rat := (27499 / 800000)

def j0 : Jet := ⟨⟨1033438924, 1033438925⟩, ⟨147634132, 147634133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3246644131, 3246644135⟩, ⟨463806304, 463806308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2454197526, 2454197533⟩, ⟨701199292, 701199300⟩, ⟨50085663, 50085665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨614, 615⟩, ⟨175, 176⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94073), (-94071)⟩, ⟨175, 176⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-53755), (-53753)⟩, ⟨(-15260), (-15257)⟩, ⟨(-1064), (-1060)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5059301, 5059304⟩, ⟨(-15260), (-15257)⟩, ⟨(-1064), (-1060)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2890947, 2890949⟩, ⟨817264, 817268⟩, ⟨55898, 55904⟩, ⟨(-351), (-346)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140274630), (-140274627)⟩, ⟨817264, 817268⟩, ⟨55898, 55904⟩, ⟨(-351), (-346)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-80154662), (-80154659)⟩, ⟨(-22434339), (-22434333)⟩, ⟨(-1470443), (-1470436)⟩, ⟨18454, 18461⟩, ⟨585, 591⟩⟩
...
def j19 : Jet := ⟨⟨1351501103, 1351501107⟩, ⟨(-22434339), (-22434333)⟩, ⟨(-1470443), (-1470436)⟩, ⟨18454, 18461⟩, ⟨585, 591⟩⟩
...
def j22 : Jet := ⟨⟨(-62), (-61)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11773, 11775⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6727, 6729⟩, ⟨1911, 1914⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845450), (-845447)⟩, ⟨1911, 1914⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-483101), (-483098)⟩, ⟨(-136938), (-136934)⟩, ⟨(-9474), (-9468)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35308293, 35308297⟩, ⟨(-136938), (-136934)⟩, ⟨(-9474), (-9468)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20175596, 20175599⟩, ⟨5686207, 5686212⟩, ⟨383975, 383982⟩, ⟨(-3121), (-3114)⟩, ⟨(-106), (-100)⟩⟩
...
def j33 : Jet := ⟨⟨(-695652287), (-695652283)⟩, ⟨5686207, 5686212⟩, ⟨383975, 383982⟩, ⟨(-3121), (-3114)⟩, ⟨(-106), (-100)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-397504337), (-397504333)⟩, ⟨(-110323500), (-110323494)⟩, ⟨(-6964592), (-6964585)⟩, ⟨127213, 127221⟩, ⟨3906, 3913⟩⟩
...
def j36 : Jet := ⟨⟨3897462959, 3897462963⟩, ⟨(-110323500), (-110323494)⟩, ⟨(-6964592), (-6964585)⟩, ⟨127213, 127221⟩, ⟨3906, 3913⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1021624338, 1021624344⟩, ⟨128987806, 128987815⟩, ⟨(-3534182), (-3534174)⟩, ⟨(-144842), (-144833)⟩, ⟨2434, 2441⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4733013308, 4733013314⟩, ⟨133974990, 133974999⟩, ⟨12250035, 12250047⟩, ⟨431665, 431680⟩, ⟨24982, 24996⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1125820350, 1125820359⟩, ⟨174011362, 174011376⟩, ⟨3042802, 3042817⟩, ⟨200715, 200733⟩, ⟨6987, 7004⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1033438925), (-1033438924)⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3261528371, 3261528372⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨295106195, 295106201⟩, ⟨91225622, 91225632⟩, ⟨8645291, 8645303⟩, ⟨351782, 351798⟩, ⟨22081, 22094⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4590073491, 4590073497⟩, ⟨91225622, 91225632⟩, ⟨8645291, 8645303⟩, ⟨351782, 351798⟩, ⟨22081, 22094⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4440069315, 4440069319⟩, ⟨44122178, 44122184⟩, ⟨3962153, 3962161⟩, ⟨130769, 130778⟩, ⟨7611, 7620⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3371716486, 3371716491⟩, ⟨(-119116170), (-119116162)⟩, ⟨1492149, 1492157⟩, ⟨(-36892), (-36883)⟩, ⟨1283, 1292⟩⟩
...
def j47 : Jet := ⟨⟨10688962880, 10688962893⟩, ⟨1526994697, 1526994708⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨26601815468, 26601815533⟩, ⟨7600518704, 7600518770⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨26601815468, 26601815533⟩, ⟨7600518704, 7600518770⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-26601815533), (-26601815468)⟩, ⟨(-7600518770), (-7600518704)⟩, ⟨(-542894201), (-542894193)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-13300907767), (-13300907734)⟩, ⟨(-3800259385), (-3800259352)⟩, ⟨(-271447101), (-271447096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨194093556, 194093562⟩, ⟨(-171737252), (-171737245)⟩, ⟨63711055, 63711061⟩, ⟨(-11554874), (-11554870)⟩, ⟨542677, 542680⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨152370995, 152371001⟩, ⟨(-140203398), (-140203390)⟩, ⟨54846030, 54846038⟩, ⟨(-10899315), (-10899307)⟩, ⟨770148, 770157⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨885804792, 1181073057⟩, ⟨147634132, 147634133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2782837826, 3710450440⟩, ⟨463806304, 463806308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1803083896, 3205482492⟩, ⟨601027964, 801370628⟩, ⟨50085663, 50085665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨451, 804⟩, ⟨150, 201⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94236), (-93882)⟩, ⟨150, 201⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-70332), (-39412)⟩, ⟨(-17521), (-12986)⟩, ⟨(-1074), (-1046)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5042724, 5073645⟩, ⟨(-17521), (-12986)⟩, ⟨(-1074), (-1046)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2117002, 3786637⟩, ⟨692590, 941209⟩, ⟨54733, 56911⟩, ⟨(-406), (-292)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141048575), (-139378939)⟩, ⟨692590, 941209⟩, ⟨54733, 56911⟩, ⟨(-406), (-292)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-105269426), (-58513116)⟩, ⟨(-26026599), (-18801915)⟩, ⟨(-1524939), (-1407274)⟩, ⟨15431, 21473⟩, ⟨552, 621⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1326386339, 1373142650⟩, ⟨(-26026599), (-18801915)⟩, ⟨(-1524939), (-1407274)⟩, ⟨15431, 21473⟩, ⟨552, 621⟩⟩
...
def j72 : Jet := ⟨⟨4934, 8801⟩, ⟨1628, 2196⟩, ⟨131, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847243), (-843375)⟩, ⟨1628, 2196⟩, ⟨131, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-632327), (-354059)⟩, ⟨(-157399), (-116380)⟩, ⟨(-9600), (-9321)⟩, ⟨34, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35159067, 35437336⟩, ⟨(-157399), (-116380)⟩, ⟨(-9600), (-9321)⟩, ⟨34, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14760239, 26448109⟩, ⟨4802606, 6563171⟩, ⟨373472, 393054⟩, ⟨(-3614), (-2622)⟩, ⟨(-109), (-96)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701067644), (-689379773)⟩, ⟨4802606, 6563171⟩, ⟨373472, 393054⟩, ⟨(-3614), (-2622)⟩, ⟨(-109), (-96)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-523231006), (-289410717)⟩, ⟨(-128791556), (-91571916)⟩, ⟨(-7346632), (-6521255)⟩, ⟨105569, 148775⟩, ⟨3598, 4178⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3771736290, 4005556579⟩, ⟨(-128791556), (-91571916)⟩, ⟨(-7346632), (-6521255)⟩, ⟨105569, 148775⟩, ⟨3598, 4178⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨859405397, 1186266949⟩, ⟨120749682, 136101047⟩, ⟨(-4127974), (-2942201)⟩, ⟨(-154678), (-133418)⟩, ⟨2023, 2856⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4605288605, 4890783092⟩, ⟨105282522, 167003078⟩, ⟨9904536, 15228895⟩, ⟨216180, 716407⟩, ⟨9761, 46790⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨921499422, 1350830854⟩, ⟨150540727, 201107686⟩, ⟨241169, 6343507⟩, ⟨(-14932), 465274⟩, ⟨(-10453), 28825⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1181073057), (-885804792)⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3113894239, 3409162504⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨197710745, 424856320⟩, ⟨64598020, 126502696⟩, ⟨5380012, 13406927⟩, ⟨7512, 886730⟩, ⟨(-7963), 71076⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4492678041, 4719823616⟩, ⟨64598020, 126502696⟩, ⟨5380012, 13406927⟩, ⟨7512, 886730⟩, ⟨(-7963), 71076⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4392710468, 4502386931⟩, ⟨30811032, 61843929⟩, ⟨2141342, 6446248⟩, ⟨(-87084), 418481⟩, ⟨(-14516), 35452⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3184759016, 3573803395⟩, ⟨(-132425618), (-101904848)⟩, ⟨(-573314), 4057668⟩, ⟨(-290706), 258568⟩, ⟨(-25908), 31135⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9161968183, 12215957590⟩, ⟨1526994697, 1526994708⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨19544190956, 34745228440⟩, ⟨6514730318, 8686307164⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨19544190956, 34745228440⟩, ⟨6514730318, 8686307164⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-34745228440), (-19544190956)⟩, ⟨(-8686307164), (-6514730318)⟩, ⟨(-542894201), (-542894193)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-17372614220), (-9772095478)⟩, ⟨(-4343153582), (-3257365159)⟩, ⟨(-271447101), (-271447096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨75212861, 441401970⟩, ⟨(-446354167), (-57042518)⟩, ⟨(-6266202), 220927419⟩, ⟨(-72065249), 20918916⟩, ⟨(-12269843), 18416458⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨55771050, 367286583⟩, ⟨(-385016895), (-44082111)⟩, ⟨(-3919548), 198011043⟩, ⟨(-67228211), 17685802⟩, ⟨(-10913640), 17788272⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1033438924, 1033438925⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4440069315, 4440069319⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2454
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨885804792, 1181073057⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4392710468, 4502386931⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2455
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (2994137 / 1073741824)

theorem envelope_integral : (∫ s in ((82497 / 400000) : ℝ)..(27499 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((82497 / 400000) : ℝ)..(27499 / 100000), prawitzNormalCorrection
