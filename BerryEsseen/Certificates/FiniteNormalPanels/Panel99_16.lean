...
namespace FiniteNormalPanel99_16
...
def j2 : Jet := ⟨⟨1556118303, 1556118307⟩, ⟨518706101, 518706105⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨563800375, 563800379⟩, ⟨375866916, 375866922⟩, ⟨62644486, 62644488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨141, 142⟩, ⟨94, 95⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94546), (-94544)⟩, ⟨94, 95⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12412), (-12410)⟩, ⟨(-8263), (-8260)⟩, ⟨(-1371), (-1366)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100644, 5100647⟩, ⟨(-8263), (-8260)⟩, ⟨(-1371), (-1366)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨669561, 669562⟩, ⟨445289, 445291⟩, ⟨73491, 73495⟩, ⟨(-241), (-238)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-142496016), (-142496014)⟩, ⟨445289, 445291⟩, ⟨73491, 73495⟩, ⟨(-241), (-238)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18705453), (-18705452)⟩, ⟨(-12411849), (-12411847)⟩, ⟨(-2029769), (-2029766)⟩, ⟨12893, 12896⟩, ⟨1046, 1050⟩⟩
...
def j19 : Jet := ⟨⟨1412950312, 1412950314⟩, ⟨(-12411849), (-12411847)⟩, ⟨(-2029769), (-2029766)⟩, ⟨12893, 12896⟩, ⟨1046, 1050⟩⟩
...
def j25 : Jet := ⟨⟨1551, 1552⟩, ⟨1032, 1034⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850626), (-850624)⟩, ⟨1032, 1034⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-111662), (-111661)⟩, ⟨(-74307), (-74304)⟩, ⟨(-12295), (-12292)⟩, ⟨28, 32⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35679732, 35679734⟩, ⟨(-74307), (-74304)⟩, ⟨(-12295), (-12292)⟩, ⟨28, 32⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4683678, 4683679⟩, ⟨3112697, 3112700⟩, ⟨512291, 512294⟩, ⟨(-2157), (-2153)⟩, ⟨(-178), (-175)⟩⟩
...
def j33 : Jet := ⟨⟨(-711144205), (-711144203)⟩, ⟨3112697, 3112700⟩, ⟨512291, 512294⟩, ⟨(-2157), (-2153)⟩, ⟨(-178), (-175)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-93351904), (-93351902)⟩, ⟨(-61826000), (-61825996)⟩, ⟨(-10032784), (-10032781)⟩, ⟨89948, 89952⟩, ⟨7259, 7263⟩⟩
...
def j36 : Jet := ⟨⟨4201615392, 4201615394⟩, ⟨(-61826000), (-61825996)⟩, ⟨(-10032784), (-10032781)⟩, ⟨89948, 89952⟩, ⟨7259, 7263⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨511928890, 511928893⟩, ⟨166146000, 166146004⟩, ⟨(-2234398), (-2234395)⟩, ⟨(-240466), (-240463)⟩, ⟨1935, 1939⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4390393299, 4390393302⟩, ⟨64603828, 64603834⟩, ⟨11434185, 11434191⟩, ⟨228519, 228529⟩, ⟨21690, 21700⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨523302976, 523302980⟩, ⟨177537754, 177537761⟩, ⟨1577954, 1577962⟩, ⟨190136, 190144⟩, ⟨3835, 3847⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-495327841), (-495327840)⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3799639455, 3799639456⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨63759741, 63759743⟩, ⟨43262742, 43262746⟩, ⟨7723259, 7723264⟩, ⟨176784, 176792⟩, ⟨17231, 17238⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4358727037, 4358727039⟩, ⟨43262742, 43262746⟩, ⟨7723259, 7723264⟩, ⟨176784, 176792⟩, ⟨17231, 17238⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4326729720, 4326729722⟩, ⟨21472575, 21472578⟩, ⟨3779999, 3780003⟩, ⟨68982, 68988⟩, ⟨6558, 6564⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3827738798, 3827738801⟩, ⟨(-147334113), (-147334106)⟩, ⟨2518601, 2518606⟩, ⟨(-84287), (-84280)⟩, ⟨3148, 3156⟩⟩
...
def j47 : Jet := ⟨⟨3739208865, 3739208875⟩, ⟨1246402955, 1246402964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3255364237, 3255364255⟩, ⟨2170242824, 2170242848⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3255364237, 3255364255⟩, ⟨2170242824, 2170242848⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3255364255), (-3255364237)⟩, ⟨(-2170242848), (-2170242824)⟩, ⟨(-361707143), (-361707137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1627682128), (-1627682118)⟩, ⟨(-1085121424), (-1085121412)⟩, ⟨(-180853572), (-180853568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2940176643, 2940176657⟩, ⟨(-742834220), (-742834208)⟩, ⟨(-29967353), (-29967346)⟩, ⟨23376712, 23376714⟩, ⟨(-845593), (-845592)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2620329197, 2620329213⟩, ⟨(-762884433), (-762884415)⟩, ⟨498895, 498911⟩, ⟨21368364, 21368376⟩, ⟨(-1556362), (-1556350)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨330218560, 660437122⟩, ⟨165109280, 165109281⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1037412202, 2074824411⟩, ⟨518706101, 518706105⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨250577944, 1002311785⟩, ⟨250577944, 501155896⟩, ⟨62644486, 62644488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨62, 252⟩, ⟨62, 126⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94625), (-94434)⟩, ⟨62, 126⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-22083), (-5509)⟩, ⟨(-11039), (-5479)⟩, ⟨(-1378), (-1358)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5090973, 5107548⟩, ⟨(-11039), (-5479)⟩, ⟨(-1378), (-1358)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨297018, 1191943⟩, ⟨294441, 595653⟩, ⟨72643, 74099⟩, ⟨(-323), (-157)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142868559), (-141973633)⟩, ⟨294441, 595653⟩, ⟨72643, 74099⟩, ⟨(-323), (-157)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-33341079), (-8283057)⟩, ⟨(-16653362), (-8144050)⟩, ⟨(-2062402), (-1983967)⟩, ⟨8456, 17326⟩, ⟨1016, 1072⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1398314686, 1423372709⟩, ⟨(-16653362), (-8144050)⟩, ⟨(-2062402), (-1983967)⟩, ⟨8456, 17326⟩, ⟨1016, 1072⟩⟩
...
def j72 : Jet := ⟨⟨688, 2761⟩, ⟨684, 1381⟩, ⟨169, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851489), (-849415)⟩, ⟨684, 1381⟩, ⟨169, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-198712), (-49556)⟩, ⟨(-99317), (-49233)⟩, ⟨(-12372), (-12186)⟩, ⟨17, 42⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35592682, 35741839⟩, ⟨(-99317), (-49233)⟩, ⟨(-12372), (-12186)⟩, ⟨17, 42⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2076556, 8341034⟩, ⟨2053378, 4167645⟩, ⟨504662, 517733⟩, ⟨(-2893), (-1418)⟩, ⟨(-181), (-171)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713751327), (-707486848)⟩, ⟨2053378, 4167645⟩, ⟨504662, 517733⟩, ⟨(-2893), (-1418)⟩, ⟨(-181), (-171)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-166567361), (-41276356)⟩, ⟨(-83163883), (-40303757)⟩, ⟨(-10261220), (-9711966)⟩, ⟨58716, 121118⟩, ⟨6979, 7461⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4128399935, 4253690940⟩, ⟨(-83163883), (-40303757)⟩, ⟨(-10261220), (-9711966)⟩, ⟨58716, 121118⟩, ⟨6979, 7461⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨337750817, 687606736⟩, ⟨160830456, 169934561⟩, ⟨(-3007549), (-1462772)⟩, ⟨(-247036), (-231235)⟩, ⟨1266, 2611⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4336644183, 4468255103⟩, ⟨41089738, 90010042⟩, ⟨10290688, 12919131⟩, ⟨64090, 422294⟩, ⟨13699, 32705⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨341028234, 715349407⟩, ⟨165622344, 191201103⟩, ⟨(-780992), 4152670⟩, ⟨70352, 331294⟩, ⟨(-9471), 18946⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-660437122), (-330218560)⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3634530174, 3964748736⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨27078263, 119145209⟩, ⟨26301432, 63691100⟩, ⟨6126563, 9895091⟩, ⟨(-58364), 480092⟩, ⟨1512, 39826⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4322045559, 4414112505⟩, ⟨26301432, 63691100⟩, ⟨6126563, 9895091⟩, ⟨(-58364), 480092⟩, ⟨1512, 39826⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308485154, 4354132388⟩, ⟨12972020, 31745635⟩, ⟨2905929, 4912495⟩, ⟨(-65288), 230545⟩, ⟨(-3747), 19353⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3645969390, 4019364920⟩, ⟨(-156406424), (-136324068)⟩, ⟨1238702, 4036122⟩, ⟨(-249118), 101109⟩, ⟨(-12322), 20376⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2492805910, 4985611838⟩, ⟨1246402955, 1246402964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1446828549, 5787314242⟩, ⟨1446828548, 2893657132⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1446828549, 5787314242⟩, ⟨1446828548, 2893657132⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5787314242), (-1446828549)⟩, ⟨(-2893657132), (-1446828548)⟩, ⟨(-361707143), (-361707137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2893657121), (-723414274)⟩, ⟨(-1446828566), (-723414274)⟩, ⟨(-180853572), (-180853568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2189584693, 3629195252⟩, ⟨(-1222552584), (-368798342)⟩, ⟨(-121760167), 113718631⟩, ⟨(-2416346), 47991991⟩, ⟨(-6435965), 2767051⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1858723994, 3396314589⟩, ⟨(-1276264532), (-382568816)⟩, ⟨(-101609671), 154352662⟩, ⟨(-7761870), 49325525⟩, ⟨(-7924281), 2872483⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4326729720, 4326729722⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2004
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308485154, 4354132388⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2005
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (25190121 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((15377 / 200000) : ℝ)..(15377 / 100000), prawitzNormalCorrection
