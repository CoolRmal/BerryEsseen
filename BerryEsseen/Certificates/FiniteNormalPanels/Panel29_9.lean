...
namespace FiniteNormalPanel29_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (10283 / 32000)
def radius : Rat := (1469 / 32000)

def j0 : Jet := ⟨⟨1380160897, 1380160898⟩, ⟨197165842, 197165843⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4335903334, 4335903339⟩, ⟨619414760, 619414764⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4377229540, 4377229551⟩, ⟨1250637006, 1250637018⟩, ⟨89331214, 89331216⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1095, 1097⟩, ⟨313, 314⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93592), (-93589)⟩, ⟨313, 314⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-95385), (-95381)⟩, ⟨(-26935), (-26930)⟩, ⟨(-1834), (-1830)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5017671, 5017676⟩, ⟨(-26935), (-26930)⟩, ⟨(-1834), (-1830)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5113775, 5113781⟩, ⟨1433627, 1433636⟩, ⟨94648, 94657⟩, ⟨(-1084), (-1077)⟩, ⟨(-36), (-31)⟩⟩
...
def j16 : Jet := ⟨⟨(-138051802), (-138051795)⟩, ⟨1433627, 1433636⟩, ⟨94648, 94657⟩, ⟨(-1084), (-1077)⟩, ⟨(-36), (-31)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-140695933), (-140695924)⟩, ⟨(-38737753), (-38737740)⟩, ⟨(-2357434), (-2357419)⟩, ⟨56273, 56285⟩, ⟨1615, 1625⟩⟩
...
def j19 : Jet := ⟨⟨1290959832, 1290959842⟩, ⟨(-38737753), (-38737740)⟩, ⟨(-2357434), (-2357419)⟩, ⟨56273, 56285⟩, ⟨1615, 1625⟩⟩
...
def j22 : Jet := ⟨⟨(-111), (-109)⟩, ⟨(-32), (-31)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11724, 11727⟩, ⟨(-32), (-31)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11948, 11952⟩, ⟨3380, 3384⟩, ⟨229, 233⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840229), (-840224)⟩, ⟨3380, 3384⟩, ⟨229, 233⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-856323), (-856316)⟩, ⟨(-241220), (-241212)⟩, ⟨(-16259), (-16251)⟩, ⟨133, 139⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨34935071, 34935079⟩, ⟨(-241220), (-241212)⟩, ⟨(-16259), (-16251)⟩, ⟨133, 139⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨35604188, 35604197⟩, ⟨9926784, 9926797⟩, ⟨639804, 639818⟩, ⟨(-9618), (-9606)⟩, ⟨(-300), (-291)⟩⟩
...
def j33 : Jet := ⟨⟨(-680223695), (-680223685)⟩, ⟨9926784, 9926797⟩, ⟨639804, 639818⟩, ⟨(-9618), (-9606)⟩, ⟨(-300), (-291)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-693252138), (-693252125)⟩, ⟨(-187955127), (-187955108)⟩, ⟨(-10605399), (-10605378)⟩, ⟨382966, 382986⟩, ⟨10200, 10215⟩⟩
...
def j36 : Jet := ⟨⟨3601715158, 3601715171⟩, ⟨(-187955127), (-187955108)⟩, ⟨(-10605399), (-10605378)⟩, ⟨382966, 382986⟩, ⟨10200, 10215⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1303264181, 1303264194⟩, ⟨147073627, 147073645⟩, ⟨(-7966614), (-7966594)⟩, ⟨(-283178), (-283161)⟩, ⟨9745, 9759⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5121655433, 5121655452⟩, ⟨267273021, 267273052⟩, ⟨29028508, 29028544⟩, ⟨1757234, 1757271⟩, ⟨134227, 134259⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1554114295, 1554114317⟩, ⟨256483395, 256483429⟩, ⟨8460686, 8460726⟩, ⟨693802, 693841⟩, ⟨41055, 41089⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1380160898), (-1380160897)⟩, ⟨(-197165843), (-197165842)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2914806398, 2914806399⟩, ⟨(-197165843), (-197165842)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨562349157, 562349174⟩, ⟨185614688, 185614718⟩, ⟨21439388, 21439425⟩, ⟨1512594, 1512630⟩, ⟨129238, 129273⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4857316453, 4857316470⟩, ⟨185614688, 185614718⟩, ⟨21439388, 21439425⟩, ⟨1512594, 1512630⟩, ⟨129238, 129273⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4567495518, 4567495527⟩, ⟨87269818, 87269834⟩, ⟨9246363, 9246382⟩, ⟨534502, 534522⟩, ⟨41190, 41210⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3099759379, 3099759387⟩, ⟨(-150450386), (-150450371)⟩, ⟨2268871, 2268885⟩, ⟨(-61724), (-61708)⟩, ⟨3415, 3432⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨23385152032, 23385152034⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value225

def j47 : Jet := ⟨⟨7514672448, 7514672455⟩, ⟨1073524633, 1073524639⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13148016762, 13148016787⟩, ⟨3756576208, 3756576234⟩, ⟨268326871, 268326875⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13148016762, 13148016787⟩, ⟨3756576208, 3756576234⟩, ⟨268326871, 268326875⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13148016787), (-13148016762)⟩, ⟨(-3756576234), (-3756576208)⟩, ⟨(-268326875), (-268326871)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6574008394), (-6574008381)⟩, ⟨(-1878288117), (-1878288104)⟩, ⟨(-134163438), (-134163435)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨929427320, 929427329⟩, ⟨(-406459977), (-406459970)⟩, ⟨59844296, 59844301⟩, ⟨(-259274), (-259271)⟩, ⟨(-906343), (-906342)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨670785329, 670785338⟩, ⟨(-325907216), (-325907205)⟩, ⟨57919815, 57919827⟩, ⟨(-2511514), (-2511503)⟩, ⟨(-606852), (-606842)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1182995054, 1577326740⟩, ⟨197165842, 197165843⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3716488570, 4955318099⟩, ⟨619414760, 619414764⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3215923740, 5717197774⟩, ⟨1071974576, 1429299448⟩, ⟨89331214, 89331216⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨804, 1433⟩, ⟨268, 359⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93883), (-93253)⟩, ⟨268, 359⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-124972), (-69824)⟩, ⟨(-31043), (-22796)⟩, ⟨(-1871), (-1788)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4988084, 5043233⟩, ⟨(-31043), (-22796)⟩, ⟨(-1871), (-1788)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3734905, 6713244⟩, ⟨1203645, 1661243⟩, ⟨90925, 97868⟩, ⟨(-1262), (-898)⟩, ⟨(-37), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139430672), (-136452332)⟩, ⟨1203645, 1661243⟩, ⟨90925, 97868⟩, ⟨(-1262), (-898)⟩, ⟨(-37), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-185601583), (-102170811)⟩, ⟨(-45499149), (-31845591)⟩, ⟨(-2531529), (-2154965)⟩, ⟨46047, 66450⟩, ⟨1421, 1791⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1246054182, 1329484955⟩, ⟨(-45499149), (-31845591)⟩, ⟨(-2531529), (-2154965)⟩, ⟨46047, 66450⟩, ⟨1421, 1791⟩⟩
...
def j70 : Jet := ⟨⟨(-144), (-80)⟩, ⟨(-36), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11691, 11756⟩, ⟨(-36), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8753, 15649⟩, ⟨2869, 3894⟩, ⟨227, 238⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843424), (-836527)⟩, ⟨2869, 3894⟩, ⟨227, 238⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1122715), (-626362)⟩, ⟨(-278531), (-203603)⟩, ⟨(-16658), (-15785)⟩, ⟨112, 161⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34668679, 35165033⟩, ⟨(-278531), (-203603)⟩, ⟨(-16658), (-15785)⟩, ⟨112, 161⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨25958714, 46809542⟩, ⟨8282140, 11549936⟩, ⟨606209, 668765⟩, ⟨(-11255), (-7958)⟩, ⟨(-320), (-267)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-689869169), (-669018340)⟩, ⟨8282140, 11549936⟩, ⟨606209, 668765⟩, ⟨(-11255), (-7958)⟩, ⟨(-320), (-267)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-918311644), (-500937914)⟩, ⟨(-223376531), (-151604735)⟩, ⟨(-11827585), (-9181078)⟩, ⟨308580, 456825⟩, ⟨8436, 11725⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3376655652, 3794029382⟩, ⟨(-223376531), (-151604735)⟩, ⟨(-11827585), (-9181078)⟩, ⟨308580, 456825⟩, ⟨8436, 11725⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1078226167, 1533893138⟩, ⟨127209721, 164180258⟩, ⟨(-9482582), (-6457447)⟩, ⟨(-325249), (-234119)⟩, ⟨7869, 11651⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4862045655, 5463021989⟩, ⟨194281347, 361396314⟩, ⟨19528786, 43043127⟩, ⟨592698, 3668999⟩, ⟨10541, 363587⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1220587838, 1951049069⟩, ⟨192778813, 337898659⟩, ⟨(-1404582), 21877071⟩, ⟨(-484406), 2398582⟩, ⟨(-93294), 244972⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1577326740), (-1182995054)⟩, ⟨(-197165843), (-197165842)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2717640556, 3111972242⟩, ⟨(-197165843), (-197165842)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨346879165, 886291375⟩, ⟨109571718, 306990400⟩, ⟨7376737, 46459491⟩, ⟨(-661104), 5621458⟩, ⟨(-168137), 711409⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4641846461, 5181258671⟩, ⟨109571718, 306990400⟩, ⟨7376737, 46459491⟩, ⟨(-661104), 5621458⟩, ⟨(-168137), 711409⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4465039612, 4717344226⟩, ⟨49880496, 147648604⟩, ⟨1047489, 22066315⟩, ⟨(-1047645), 2691968⟩, ⟨(-224411), 376678⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2825253813, 3418010727⟩, ⟨(-184993701), (-97992582)⟩, ⟨(-6115196), 13698599⟩, ⟨(-1772067), 1902414⟩, ⟨(-286179), 321021⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6441147809, 8588197088⟩, ⟨1073524633, 1073524639⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9659767406, 17172919871⟩, ⟨3219922462, 4293229980⟩, ⟨268326871, 268326875⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9659767406, 17172919871⟩, ⟨3219922462, 4293229980⟩, ⟨268326871, 268326875⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17172919871), (-9659767406)⟩, ⟨(-4293229980), (-3219922462)⟩, ⟨(-268326875), (-268326871)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8586459936), (-4829883703)⟩, ⟨(-2146614990), (-1609961231)⟩, ⟨(-134163438), (-134163435)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨581731046, 1395006418⟩, ⟨(-697221069), (-218060899)⟩, ⟨(-2706438), 156063020⟩, ⟨(-21458885), 14970455⟩, ⟨(-4308049), 2723547⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨382665976, 1110170712⟩, ⟨(-614946824), (-156714281)⟩, ⟨835156, 158677861⟩, ⟨(-26598661), 13640938⟩, ⟨(-4697217), 3981421⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1380160897, 1380160898⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4567495518, 4567495527⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar225 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified580
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar225 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1182995054, 1577326740⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4465039612, 4717344226⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified581
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((4407 / 16000) : ℝ)..(1469 / 4000), prawitzNormalCorrection
      ((272239 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
