...
namespace FiniteNormalPanel111_15
...
def j2 : Jet := ⟨⟨2828731022, 2828731027⟩, ⟨565746204, 565746208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1863045430, 1863045438⟩, ⟨745218170, 745218180⟩, ⟨74521817, 74521819⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨466, 467⟩, ⟨186, 187⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94221), (-94219)⟩, ⟨186, 187⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-40871), (-40869)⟩, ⟨(-16269), (-16265)⟩, ⟨(-1596), (-1592)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5072185, 5072188⟩, ⟨(-16269), (-16265)⟩, ⟨(-1596), (-1592)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2200182, 2200184⟩, ⟨873014, 873019⟩, ⟨84491, 84496⟩, ⟨(-558), (-554)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-140965395), (-140965392)⟩, ⟨873014, 873019⟩, ⟨84491, 84496⟩, ⟨(-558), (-554)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-61147133), (-61147131)⟩, ⟨(-24080164), (-24080158)⟩, ⟨(-2257760), (-2257754)⟩, ⟨29564, 29569⟩, ⟨1357, 1361⟩⟩
...
def j19 : Jet := ⟨⟨1370508632, 1370508635⟩, ⟨(-24080164), (-24080158)⟩, ⟨(-2257760), (-2257754)⟩, ⟨29564, 29569⟩, ⟨1357, 1361⟩⟩
...
def j25 : Jet := ⟨⟨5113, 5115⟩, ⟨2036, 2039⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847064), (-847061)⟩, ⟨2036, 2039⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-367435), (-367433)⟩, ⟨(-146091), (-146088)⟩, ⟨(-14259), (-14255)⟩, ⟨68, 72⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35423959, 35423962⟩, ⟨(-146091), (-146088)⟩, ⟨(-14259), (-14255)⟩, ⟨68, 72⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15365994, 15365997⟩, ⟨6083026, 6083030⟩, ⟨583104, 583110⟩, ⟨(-4981), (-4975)⟩, ⟨(-237), (-232)⟩⟩
...
def j33 : Jet := ⟨⟨(-700461889), (-700461885)⟩, ⟨6083026, 6083030⟩, ⟨583104, 583110⟩, ⟨(-4981), (-4975)⟩, ⟨(-237), (-232)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-303842204), (-303842200)⟩, ⟨(-118898225), (-118898218)⟩, ⟨(-10845291), (-10845284)⟩, ⟨204559, 204565⟩, ⟨9149, 9155⟩⟩
...
def j36 : Jet := ⟨⟨3991125092, 3991125096⟩, ⟨(-118898225), (-118898218)⟩, ⟨(-10845291), (-10845284)⟩, ⟨204559, 204565⟩, ⟨9149, 9155⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨902637905, 902637909⟩, ⟨164668016, 164668024⟩, ⟨(-4658909), (-4658902)⟩, ⟨(-277929), (-277923)⟩, ⟨4787, 4792⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4621940838, 4621940844⟩, ⟨137690629, 137690639⟩, ⟨16661323, 16661335⟩, ⟨633605, 633618⟩, ⟨46488, 46501⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨971355241, 971355248⟩, ⟨206141408, 206141421⟩, ⟨3767008, 3767022⟩, ⟨323503, 323517⟩, ⟨12228, 12241⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-900413051), (-900413050)⟩, ⟨(-180082611), (-180082610)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3394554245, 3394554246⟩, ⟨(-180082611), (-180082610)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨219682931, 219682935⟩, ⟨93242402, 93242412⟩, ⟨11597872, 11597882⟩, ⟨507928, 507942⟩, ⟨39885, 39898⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4514650227, 4514650231⟩, ⟨93242402, 93242412⟩, ⟨11597872, 11597882⟩, ⟨507928, 507942⟩, ⟨39885, 39898⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4403439005, 4403439008⟩, ⟨45472761, 45472767⟩, ⟨5421297, 5421304⟩, ⟨191723, 191732⟩, ⟨14133, 14142⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3480285538, 3480285542⟩, ⟨(-148691015), (-148691007)⟩, ⟨2378138, 2378146⟩, ⟨(-75780), (-75771)⟩, ⟨3130, 3140⟩⟩
...
def j47 : Jet := ⟨⟨5759410500, 5759410508⟩, ⟨1151882100, 1151882107⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7723180881, 7723180904⟩, ⟨3089272352, 3089272376⟩, ⟨308927235, 308927240⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7723180881, 7723180904⟩, ⟨3089272352, 3089272376⟩, ⟨308927235, 308927240⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7723180904), (-7723180881)⟩, ⟨(-3089272376), (-3089272352)⟩, ⟨(-308927240), (-308927235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3861590452), (-3861590440)⟩, ⟨(-1544636188), (-1544636176)⟩, ⟨(-154463620), (-154463617)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1747781636, 1747781649⟩, ⟨(-628569812), (-628569801)⟩, ⟨50172010, 50172016⟩, ⟨9055933, 9055936⟩, ⟨(-1716407), (-1716405)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1416257385, 1416257398⟩, ⟨(-569848777), (-569848762)⟩, ⟨63383965, 63383977⟩, ⟨5222349, 5222360⟩, ⟨(-1664207), (-1664196)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨720330440, 1080495661⟩, ⟨180082610, 180082611⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2262984818, 3394477231⟩, ⟨565746204, 565746208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1192349075, 2682785428⟩, ⟨596174536, 894261814⟩, ⟨74521817, 74521819⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨298, 673⟩, ⟨149, 225⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94389), (-94013)⟩, ⟨149, 225⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-58959), (-26099)⟩, ⟨(-19612), (-12908)⟩, ⟨(-1614), (-1572)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5054097, 5086958⟩, ⟨(-19612), (-12908)⟩, ⟨(-1614), (-1572)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1403095, 3177491⟩, ⟨689296, 1055581⟩, ⟨82600, 86037⟩, ⟨(-677), (-436)⟩, ⟨(-29), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141762482), (-139988085)⟩, ⟨689296, 1055581⟩, ⟨82600, 86037⟩, ⟨(-677), (-436)⟩, ⟨(-29), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-88549760), (-38862848)⟩, ⟨(-29325228), (-18772071)⟩, ⟨(-2341106), (-2155401)⟩, ⟨23001, 36109⟩, ⟨1273, 1427⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1343106005, 1392792918⟩, ⟨(-29325228), (-18772071)⟩, ⟨(-2341106), (-2155401)⟩, ⟨23001, 36109⟩, ⟨1273, 1427⟩⟩
...
def j72 : Jet := ⟨⟨3266, 7376⟩, ⟨1618, 2456⟩, ⟨197, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848911), (-844800)⟩, ⟨1618, 2456⟩, ⟨197, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-530260), (-234529)⟩, ⟨(-176305), (-115729)⟩, ⟨(-14452), (-14018)⟩, ⟨53, 86⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35261134, 35556866⟩, ⟨(-176305), (-115729)⟩, ⟨(-14452), (-14018)⟩, ⟨53, 86⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9789033, 22210051⟩, ⟨4784389, 7371223⟩, ⟨566077, 596991⟩, ⟨(-6056), (-3899)⟩, ⟨(-244), (-222)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706038850), (-693617831)⟩, ⟨4784389, 7371223⟩, ⟨566077, 596991⟩, ⟨(-6056), (-3899)⟩, ⟨(-244), (-222)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-441016336), (-192558993)⟩, ⟨(-145677226), (-91675174)⟩, ⟨(-11429194), (-10127261)⟩, ⟨157805, 251117⟩, ⟨8407, 9757⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3853950960, 4102408303⟩, ⟨(-145677226), (-91675174)⟩, ⟨(-11429194), (-10127261)⟩, ⟨157805, 251117⟩, ⟨8407, 9757⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨707672093, 1100777613⟩, ⟨153741171, 173572079⟩, ⟨(-5713075), (-3608378)⟩, ⟨(-296259), (-255376)⟩, ⟨3699, 5885⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4496564630, 4786450131⟩, ⟨100483255, 180925182⟩, ⟨13345745, 21033467⟩, ⟨253298, 1147485⟩, ⟨16144, 91831⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨740888831, 1226742089⟩, ⟨177513878, 239804503⟩, ⟨(-571024), 8924732⟩, ⟨(-51370), 792337⟩, ⟨(-24861), 59283⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1080495661), (-720330440)⟩, ⟨(-180082611), (-180082610)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3214471635, 3574636856⟩, ⟨(-180082611), (-180082610)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨127804526, 350385940⟩, ⟨61242864, 136987436⟩, ⟨7010571, 18487428⟩, ⟨(-93112), 1449226⟩, ⟨(-21127), 140892⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4422771822, 4645353236⟩, ⟨61242864, 136987436⟩, ⟨7010571, 18487428⟩, ⟨(-93112), 1449226⟩, ⟨(-21127), 140892⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4358401121, 4466725896⟩, ⟨29443948, 67496835⟩, ⟨2860523, 9009721⟩, ⟨(-185409), 694743⟩, ⟨(-30483), 71354⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3261947254, 3717588963⟩, ⟨(-165247575), (-126565706)⟩, ⟨(-689164), 6264109⟩, ⟨(-532081), 458287⟩, ⟨(-54501), 67161⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4607528400, 6911292609⟩, ⟨1151882100, 1151882107⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4942835764, 11121380499⟩, ⟨2471417882, 3707126852⟩, ⟨308927235, 308927240⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4942835764, 11121380499⟩, ⟨2471417882, 3707126852⟩, ⟨308927235, 308927240⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11121380499), (-4942835764)⟩, ⟨(-3707126852), (-2471417882)⟩, ⟨(-308927240), (-308927235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5560690250), (-2471417882)⟩, ⟨(-1853563426), (-1235708941)⟩, ⟨(-154463620), (-154463617)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1176736399, 2415779787⟩, ⟨(-1042569303), (-338559897)⟩, ⟨(-38177089), 182648936⟩, ⟨(-18157765), 30488530⟩, ⟨(-6573838), 2645569⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨893709265, 2091023204⟩, ⟨(-995361686), (-291806412)⟩, ⟨(-23455715), 201731090⟩, ⟨(-24563997), 28283831⟩, ⟨(-7060729), 3421862⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4403439005, 4403439008⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2240
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4358401121, 4466725896⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2241
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (15074117 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((33543 / 200000) : ℝ)..(100629 / 400000), prawitzNormalCorrection
