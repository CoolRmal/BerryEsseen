...
namespace FiniteNormalPanel43_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2173 / 10000)
def radius : Rat := (2173 / 50000)

def j0 : Jet := ⟨⟨933296393, 933296394⟩, ⟨186659278, 186659279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2932037091, 2932037096⟩, ⟨586407416, 586407420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2001608140, 2001608148⟩, ⟨800643252, 800643262⟩, ⟨80064325, 80064327⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨500, 502⟩, ⟨200, 201⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94187), (-94184)⟩, ⟨200, 201⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-43895), (-43893)⟩, ⟨(-17465), (-17463)⟩, ⟨(-1710), (-1707)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5069161, 5069164⟩, ⟨(-17465), (-17463)⟩, ⟨(-1710), (-1707)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2362410, 2362412⟩, ⟨936824, 936827⟩, ⟨90443, 90447⟩, ⟨(-643), (-639)⟩, ⟨(-31), (-28)⟩⟩
...
def j16 : Jet := ⟨⟨(-140803167), (-140803164)⟩, ⟨936824, 936827⟩, ⟨90443, 90447⟩, ⟨(-643), (-639)⟩, ⟨(-31), (-28)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-65619305), (-65619302)⟩, ⟨(-25811129), (-25811125)⟩, ⟨(-2407987), (-2407982)⟩, ⟨34022, 34028⟩, ⟨1550, 1555⟩⟩
...
def j19 : Jet := ⟨⟨1366036460, 1366036464⟩, ⟨(-25811129), (-25811125)⟩, ⟨(-2407987), (-2407982)⟩, ⟨34022, 34028⟩, ⟨1550, 1555⟩⟩
...
def j22 : Jet := ⟨⟨(-51), (-49)⟩, ⟨(-21), (-19)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11784, 11787⟩, ⟨(-21), (-19)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5491, 5494⟩, ⟨2186, 2190⟩, ⟨213, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846686), (-846682)⟩, ⟨2186, 2190⟩, ⟨213, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-394586), (-394584)⟩, ⟨(-156817), (-156812)⟩, ⟨(-15278), (-15272)⟩, ⟨78, 82⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨35396808, 35396811⟩, ⟨(-156817), (-156812)⟩, ⟨(-15278), (-15272)⟩, ⟨78, 82⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16496176, 16496179⟩, ⟨6525387, 6525393⟩, ⟨623493, 623500⟩, ⟨(-5737), (-5730)⟩, ⟨(-271), (-265)⟩⟩
...
def j33 : Jet := ⟨⟨(-699331707), (-699331703)⟩, ⟨6525387, 6525393⟩, ⟨623493, 623500⟩, ⟨(-5737), (-5730)⟩, ⟨(-271), (-265)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-325913552), (-325913547)⟩, ⟨(-127324358), (-127324351)⟩, ⟨(-11529548), (-11529540)⟩, ⟨235196, 235203⟩, ⟨10425, 10432⟩⟩
...
def j36 : Jet := ⟨⟨3969053744, 3969053749⟩, ⟨(-127324358), (-127324351)⟩, ⟨(-11529548), (-11529540)⟩, ⟨235196, 235203⟩, ⟨10425, 10432⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨932549491, 932549496⟩, ⟨168889463, 168889469⟩, ⟨(-5167943), (-5167938)⟩, ⟨(-305547), (-305540)⟩, ⟨5703, 5708⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4647642798, 4647642805⟩, ⟨149092991, 149093002⟩, ⟨18283538, 18283551⟩, ⟨744198, 744213⟩, ⟨55931, 55945⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1009124546, 1009124554⟩, ⟨215129574, 215129585⟩, ⟨4240261, 4240273⟩, ⟨370507, 370522⟩, ⟨14971, 14985⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-933296394), (-933296393)⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3361670902, 3361670903⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨237098976, 237098981⟩, ⟨101091588, 101091596⟩, ⟨12768114, 12768123⟩, ⟨598882, 598896⟩, ⟨48336, 48347⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4532066272, 4532066277⟩, ⟨101091588, 101091596⟩, ⟨12768114, 12768123⟩, ⟨598882, 598896⟩, ⟨48336, 48347⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4411924344, 4411924347⟩, ⟨49205860, 49205865⟩, ⟨5940425, 5940431⟩, ⟨225249, 225257⟩, ⟨17015, 17022⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3453213183, 3453213187⟩, ⟨(-153228807), (-153228800)⟩, ⟨2511083, 2511090⟩, ⟨(-81870), (-81861)⟩, ⟨3527, 3535⟩⟩
...
def j47 : Jet := ⟨⟨5668580634, 5668580643⟩, ⟨1133716123, 1133716130⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7481501997, 7481502022⟩, ⟨2992600788, 2992600814⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7481501997, 7481502022⟩, ⟨2992600788, 2992600814⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7481502022), (-7481501997)⟩, ⟨(-2992600814), (-2992600788)⟩, ⟨(-299260082), (-299260077)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3740751011), (-3740750998)⟩, ⟨(-1496300407), (-1496300394)⟩, ⟨(-149630041), (-149630038)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1797653984, 1797653998⟩, ⟨(-626274946), (-626274935)⟩, ⟨46464771, 46464777⟩, ⟨9149764, 9149767⟩, ⟨(-1606291), (-1606289)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1445338697, 1445338711⟩, ⟨(-567667485), (-567667470)⟩, ⟨60752540, 60752552⟩, ⟨5298416, 5298429⟩, ⟨(-1577335), (-1577323)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨746637114, 1119955673⟩, ⟨186659278, 186659279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2345629672, 3518444515⟩, ⟨586407416, 586407420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1281029209, 2882315732⟩, ⟨640514602, 960771912⟩, ⟨80064325, 80064327⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨320, 723⟩, ⟨160, 241⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94367), (-93963)⟩, ⟨160, 241⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-63329), (-28025)⟩, ⟨(-21063), (-13850)⟩, ⟨(-1732), (-1682)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5049727, 5085032⟩, ⟨(-21063), (-13850)⟩, ⟨(-1732), (-1682)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1506145, 3412522⟩, ⟨738936, 1133378⟩, ⟨88259, 92227⟩, ⟨(-780), (-501)⟩, ⟨(-33), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141659432), (-139753054)⟩, ⟨738936, 1133378⟩, ⟨88259, 92227⟩, ⟨(-780), (-501)⟩, ⟨(-33), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-95066431), (-41683144)⟩, ⟨(-31468414), (-20080971)⟩, ⟨(-2504213), (-2289769)⟩, ⟨26412, 41610⟩, ⟨1447, 1638⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1336589334, 1389972622⟩, ⟨(-31468414), (-20080971)⟩, ⟨(-2504213), (-2289769)⟩, ⟨26412, 41610⟩, ⟨1447, 1638⟩⟩
...
def j70 : Jet := ⟨⟨(-73), (-31)⟩, ⟨(-25), (-15)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11762, 11805⟩, ⟨(-25), (-15)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3508, 7923⟩, ⟨1737, 2637⟩, ⟨210, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848669), (-844253)⟩, ⟨1737, 2637⟩, ⟨210, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-569535), (-251809)⟩, ⟨(-189327), (-124134)⟩, ⟨(-15500), (-15001)⟩, ⟨61, 99⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35221859, 35539586⟩, ⟨(-189327), (-124134)⟩, ⟨(-15500), (-15001)⟩, ⟨61, 99⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10505372, 23850312⟩, ⟨5125630, 7913080⟩, ⟨603831, 639523⟩, ⟨(-6980), (-4484)⟩, ⟨(-280), (-252)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705322511), (-691977570)⟩, ⟨5125630, 7913080⟩, ⟨603831, 639523⟩, ⟨(-6980), (-4484)⟩, ⟨(-280), (-252)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-473335891), (-206391205)⟩, ⟨(-156249846), (-97885201)⟩, ⟨(-12203728), (-10700137)⟩, ⟨180914, 289235⟩, ⟨9506, 11179⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3821631405, 4088576091⟩, ⟨(-156249846), (-97885201)⟩, ⟨(-12203728), (-10700137)⟩, ⟨180914, 289235⟩, ⟨9506, 11179⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨729957502, 1138667937⟩, ⟨156710396, 178811080⟩, ⟨(-6347953), (-3992248)⟩, ⟨(-327486), (-278543)⟩, ⟨4396, 7024⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4511777123, 4826929162⟩, ⟨108017118, 197352089⟩, ⟨14393740, 23482844⟩, ⟨285824, 1376739⟩, ⟨17351, 114945⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨766805735, 1279699959⟩, ⟨182979340, 253279442⟩, ⟨(-746665), 10248222⟩, ⟨(-85973), 949646⟩, ⟨(-31763), 75302⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1119955673), (-746637114)⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3175011623, 3548330182⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨136902331, 381290910⟩, ⟨65336752, 150930926⟩, ⟨7350560, 21043183⟩, ⟨(-139296), 1774604⟩, ⟨(-30850), 181332⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4431869627, 4676258206⟩, ⟨65336752, 150930926⟩, ⟨7350560, 21043183⟩, ⟨(-139296), 1774604⟩, ⟨(-30850), 181332⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4362881514, 4481559557⟩, ⟨31308209, 74290740⟩, ⟨2906499, 10245475⟩, ⟨(-243024), 852634⟩, ⟨(-41735), 92426⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3225216529, 3702485245⟩, ⟨(-171624299), (-128234791)⟩, ⟨(-1080076), 7103748⟩, ⟨(-646046), 578097⟩, ⟨(-71536), 86921⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4534864505, 6802296772⟩, ⟨1133716123, 1133716130⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4788161273, 10773362912⟩, ⟨2394080630, 3591120976⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4788161273, 10773362912⟩, ⟨2394080630, 3591120976⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10773362912), (-4788161273)⟩, ⟨(-3591120976), (-2394080630)⟩, ⟨(-299260082), (-299260077)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5386681456), (-2394080636)⟩, ⟨(-1795560488), (-1197040315)⟩, ⟨(-149630041), (-149630038)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1225390323, 2459673476⟩, ⟨(-1028294794), (-341525678)⟩, ⟨(-38098321), 172254526⟩, ⟨(-16072177), 29191952⟩, ⟨(-6051550), 2343434⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨920181424, 2120366496⟩, ⟨(-984730675), (-293048082)⟩, ⟨(-23264353), 193650629⟩, ⟨(-22808992), 27277028⟩, ⟨(-6625634), 3151757⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨933296393, 933296394⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4411924344, 4411924347⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified846
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨746637114, 1119955673⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4362881514, 4481559557⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified847
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (127443835 / 4294967296)

theorem envelope_integral : (∫ s in ((2173 / 12500) : ℝ)..(6519 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((2173 / 12500) : ℝ)..(6519 / 25000), prawitzNormalCorrection
