...
namespace FiniteNormalPanel154_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (182497 / 800000)
def radius : Rat := (26071 / 800000)

def j0 : Jet := ⟨⟨979773308, 979773309⟩, ⟨139967615, 139967616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3078048626, 3078048630⟩, ⟨439721231, 439721235⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2205926772, 2205926778⟩, ⟨630264790, 630264798⟩, ⟨45018913, 45018915⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨552, 553⟩, ⟨157, 158⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94135), (-94133)⟩, ⟨157, 158⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48349), (-48347)⟩, ⟨(-13734), (-13731)⟩, ⟨(-959), (-955)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064707, 5064710⟩, ⟨(-13734), (-13731)⟩, ⟨(-959), (-955)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2601270, 2601273⟩, ⟨736166, 736169⟩, ⟨50578, 50584⟩, ⟨(-284), (-280)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140564307), (-140564303)⟩, ⟨736166, 736169⟩, ⟨50578, 50584⟩, ⟨(-284), (-280)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-72194862), (-72194859)⟩, ⟨(-20249004), (-20249000)⟩, ⟨(-1339360), (-1339353)⟩, ⟨14992, 14997⟩, ⟨482, 486⟩⟩
...
def j19 : Jet := ⟨⟨1359460903, 1359460907⟩, ⟨(-20249004), (-20249000)⟩, ⟨(-1339360), (-1339353)⟩, ⟨14992, 14997⟩, ⟨482, 486⟩⟩
...
def j22 : Jet := ⟨⟨(-56), (-54)⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11779, 11782⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6049, 6052⟩, ⟨1719, 1722⟩, ⟨118, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846128), (-846124)⟩, ⟨1719, 1722⟩, ⟨118, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-434578), (-434575)⟩, ⟨(-123284), (-123279)⟩, ⟨(-8557), (-8552)⟩, ⟨33, 37⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35356816, 35356820⟩, ⟨(-123284), (-123279)⟩, ⟨(-8557), (-8552)⟩, ⟨33, 37⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18159520, 18159523⟩, ⟨5125114, 5125119⟩, ⟨348115, 348121⟩, ⟨(-2533), (-2526)⟩, ⟨(-87), (-81)⟩⟩
...
def j33 : Jet := ⟨⟨(-697668363), (-697668359)⟩, ⟨5125114, 5125119⟩, ⟨348115, 348121⟩, ⟨(-2533), (-2526)⟩, ⟨(-87), (-81)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-358327601), (-358327597)⟩, ⟨(-99747020), (-99747014)⟩, ⟨(-6381931), (-6381923)⟩, ⟨103503, 103510⟩, ⟨3231, 3238⟩⟩
...
def j36 : Jet := ⟨⟨3936639695, 3936639699⟩, ⟨(-99747020), (-99747014)⟩, ⟨(-6381931), (-6381923)⟩, ⟨103503, 103510⟩, ⟨3231, 3238⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨974276746, 974276751⟩, ⟨124670657, 124670664⟩, ⟨(-3032977), (-3032970)⟩, ⟨(-126381), (-126375)⟩, ⟨1879, 1885⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4685911204, 4685911210⟩, ⟨118732138, 118732148⟩, ⟨10605059, 10605072⟩, ⟨337982, 337995⟩, ⟨18778, 18791⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1062959041, 1062959049⟩, ⟨162952018, 162952030⟩, ⟨2543072, 2543085⟩, ⟨162771, 162786⟩, ⟨5136, 5151⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-979773309), (-979773308)⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3315193987, 3315193988⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨263071135, 263071140⟩, ⟨80657806, 80657814⟩, ⟨7441201, 7441211⟩, ⟨273536, 273548⟩, ⟨16397, 16410⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4558038431, 4558038436⟩, ⟨80657806, 80657814⟩, ⟨7441201, 7441211⟩, ⟨273536, 273548⟩, ⟨16397, 16410⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4424548111, 4424548115⟩, ⟨39147798, 39147803⟩, ⟨3438448, 3438455⟩, ⟨102339, 102347⟩, ⟨5716, 5725⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3415214664, 3415214669⟩, ⟨(-113973140), (-113973133)⟩, ⟨1378286, 1378294⟩, ⟨(-33062), (-33054)⟩, ⟨1076, 1085⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨53050904061, 53050904069⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value632

def j47 : Jet := ⟨⟨12102038544, 12102038559⟩, ⟨1728862643, 1728862657⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨34100221684, 34100221769⟩, ⟨9742920446, 9742920538⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨34100221684, 34100221769⟩, ⟨9742920446, 9742920538⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-34100221769), (-34100221684)⟩, ⟨(-9742920538), (-9742920446)⟩, ⟨(-695922898), (-695922886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-17050110885), (-17050110842)⟩, ⟨(-4871460269), (-4871460223)⟩, ⟨(-347961449), (-347961443)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨81077940, 81077943⟩, ⟨(-91960649), (-91960644)⟩, ⟨45583422, 45583428⟩, ⟨(-12267098), (-12267093)⟩, ⟨1631915, 1631919⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨64470472, 64470475⟩, ⟨(-75275560), (-75275554)⟩, ⟨38712740, 38712749⟩, ⟨(-10994146), (-10994136)⟩, ⟨1638523, 1638532⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨839805692, 1119740924⟩, ⟨139967615, 139967616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2638327392, 3517769861⟩, ⟨439721231, 439721235⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1620680891, 2881210483⟩, ⟨540226962, 720302626⟩, ⟨45018913, 45018915⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨405, 722⟩, ⟨135, 181⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94282), (-93964)⟩, ⟨135, 181⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-63248), (-35456)⟩, ⟨(-15762), (-11696)⟩, ⟨(-969), (-944)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5049808, 5077601⟩, ⟨(-15762), (-11696)⟩, ⟨(-969), (-944)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1905515, 3406228⟩, ⟨624597, 847144⟩, ⟨49635, 51396⟩, ⟨(-329), (-236)⟩, ⟨(-11), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141260062), (-139759348)⟩, ⟨624597, 847144⟩, ⟨49635, 51396⟩, ⟨(-329), (-236)⟩, ⟨(-11), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-94762066), (-52737375)⟩, ⟨(-23454829), (-17010831)⟩, ⟨(-1383367), (-1288374)⟩, ⟨12568, 17411⟩, ⟨456, 508⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1336893699, 1378918391⟩, ⟨(-23454829), (-17010831)⟩, ⟨(-1383367), (-1288374)⟩, ⟨12568, 17411⟩, ⟨456, 508⟩⟩
...
def j72 : Jet := ⟨⟨4438, 7914⟩, ⟨1466, 1975⟩, ⟨117, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847739), (-844262)⟩, ⟨1466, 1975⟩, ⟨117, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-568693), (-318577)⟩, ⟨(-141621), (-104867)⟩, ⟨(-8658), (-8434)⟩, ⟨27, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35222701, 35472818⟩, ⟨(-141621), (-104867)⟩, ⟨(-8658), (-8434)⟩, ⟨27, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13291081, 23796376⟩, ⟨4335355, 5909524⟩, ⟨339635, 355447⟩, ⟨(-2928), (-2130)⟩, ⟨(-89), (-78)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702536802), (-692031506)⟩, ⟨4335355, 5909524⟩, ⟨339635, 355447⟩, ⟨(-2928), (-2130)⟩, ⟨(-89), (-78)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-471285638), (-261134057)⟩, ⟨(-116185491), (-83080374)⟩, ⟨(-6690374), (-6024199)⟩, ⟨86196, 120752⟩, ⟨3007, 3430⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3823681658, 4033833239⟩, ⟨(-116185491), (-83080374)⟩, ⟨(-6690374), (-6024199)⟩, ⟨86196, 120752⟩, ⟨3007, 3430⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨821231693, 1129395691⟩, ⟨117661396, 130724991⟩, ⟨(-3534359), (-2533004)⟩, ⟨(-133910), (-117643)⟩, ⟨1566, 2200⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4573006116, 4824340969⟩, ⟨94185117, 146591290⟩, ⟨8769234, 12895539⟩, ⟨176850, 545250⟩, ⟨8245, 33414⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨874394912, 1268598694⟩, ⟨143287257, 185384766⟩, ⟨286979, 5155773⟩, ⟨3002, 355073⟩, ⟨(-7096), 20105⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1119740924), (-839805692)⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3175226372, 3455161604⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨178014501, 374704285⟩, ⟨58342538, 109513698⟩, ⟨4897149, 11047518⟩, ⟨20370, 654836⟩, ⟨(-3973), 48722⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4472981797, 4669671581⟩, ⟨58342538, 109513698⟩, ⟨4897149, 11047518⟩, ⟨20370, 654836⟩, ⟨(-3973), 48722⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4383070902, 4478402252⟩, ⟨27976416, 53656188⟩, ⟨2026850, 5323443⟩, ⟨(-55188), 307900⟩, ⟨(-8950), 24080⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3240360486, 3602729065⟩, ⟨(-125262848), (-99674141)⟩, ⟨(-250160), 3370821⟩, ⟨(-217882), 181644⟩, ⟨(-17235), 21171⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨10373175888, 13830901204⟩, ⟨1728862643, 1728862657⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨25053224061, 44539065127⟩, ⟨8351074662, 11134766324⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨25053224061, 44539065127⟩, ⟨8351074662, 11134766324⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-44539065127), (-25053224061)⟩, ⟨(-11134766324), (-8351074662)⟩, ⟨(-695922898), (-695922886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-22269532564), (-12526612030)⟩, ⟨(-5567383162), (-4175537331)⟩, ⟨(-347961449), (-347961443)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨24050832, 232437202⟩, ⟨(-301298445), (-23382051)⟩, ⟨(-7465220), 193331667⟩, ⟨(-82272987), 19498964⟩, ⟨(-14150407), 26964144⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨18145275, 194974305⟩, ⟨(-259515926), (-18198862)⟩, ⟨(-5732927), 171141380⟩, ⟨(-74899484), 16601338⟩, ⟨(-12463351), 25185877⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨979773308, 979773309⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4424548111, 4424548115⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar632 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3106
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar632 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨839805692, 1119740924⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4383070902, 4478402252⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3107
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((78213 / 400000) : ℝ)..(26071 / 100000), prawitzNormalCorrection
      ((299577 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
