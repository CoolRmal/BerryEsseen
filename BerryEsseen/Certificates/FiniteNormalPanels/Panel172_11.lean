...
namespace FiniteNormalPanel172_11
...
def j2 : Jet := ⟨⟨2219014380, 2219014385⟩, ⟨443802876, 443802880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1146463867, 1146463874⟩, ⟨458585546, 458585554⟩, ⟨45858554, 45858556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨286, 288⟩, ⟨114, 115⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94401), (-94398)⟩, ⟨114, 115⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-25199), (-25197)⟩, ⟨(-10050), (-10048)⟩, ⟨(-994), (-990)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5087857, 5087860⟩, ⟨(-10050), (-10048)⟩, ⟨(-994), (-990)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1358111, 1358113⟩, ⟨540561, 540563⟩, ⟨52984, 52989⟩, ⟨(-215), (-210)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141807466), (-141807463)⟩, ⟨540561, 540563⟩, ⟨52984, 52989⟩, ⟨(-215), (-210)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-37852940), (-37852938)⟩, ⟨(-14996884), (-14996881)⟩, ⟨(-1442258), (-1442254)⟩, ⟨11370, 11374⟩, ⟨539, 542⟩⟩
...
def j19 : Jet := ⟨⟨1393802825, 1393802828⟩, ⟨(-14996884), (-14996881)⟩, ⟨(-1442258), (-1442254)⟩, ⟨11370, 11374⟩, ⟨539, 542⟩⟩
...
def j25 : Jet := ⟨⟨3151, 3152⟩, ⟨1256, 1259⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849026), (-849024)⟩, ⟨1256, 1259⟩, ⟨123, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-226633), (-226631)⟩, ⟨(-90318), (-90315)⟩, ⟨(-8900), (-8896)⟩, ⟨25, 28⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35564761, 35564764⟩, ⟨(-90318), (-90315)⟩, ⟨(-8900), (-8896)⟩, ⟨25, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9493369, 9493371⟩, ⟨3773238, 3773242⟩, ⟨367714, 367718⟩, ⟨(-1910), (-1905)⟩, ⟨(-95), (-90)⟩⟩
...
def j33 : Jet := ⟨⟨(-706334514), (-706334511)⟩, ⟨3773238, 3773242⟩, ⟨367714, 367718⟩, ⟨(-1910), (-1905)⟩, ⟨(-95), (-90)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-188543230), (-188543227)⟩, ⟨(-74410096), (-74410091)⟩, ⟨(-7040697), (-7040692)⟩, ⟨79038, 79043⟩, ⟨3696, 3700⟩⟩
...
def j36 : Jet := ⟨⟨4106424066, 4106424069⟩, ⟨(-74410096), (-74410091)⟩, ⟨(-7040697), (-7040692)⟩, ⟨79038, 79043⟩, ⟨3696, 3700⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨720114566, 720114570⟩, ⟨136274704, 136274709⟩, ⟨(-2294792), (-2294788)⟩, ⟨(-143156), (-143152)⟩, ⟨1452, 1457⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4492167336, 4492167341⟩, ⟨81399916, 81399925⟩, ⟨9177068, 9177078⟩, ⟨219386, 219398⟩, ⟨14092, 14104⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨753178059, 753178065⟩, ⟨156179544, 156179554⟩, ⟨1721245, 1721255⟩, ⟨134740, 134750⟩, ⟨3222, 3235⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-706334216), (-706334215)⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3588633080, 3588633081⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨132079512, 132079516⟩, ⟨54776204, 54776210⟩, ⟨6282900, 6282908⟩, ⟨172436, 172444⟩, ⟨11617, 11626⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4427046808, 4427046812⟩, ⟨54776204, 54776210⟩, ⟨6282900, 6282908⟩, ⟨172436, 172444⟩, ⟨11617, 11626⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4360506995, 4360506998⟩, ⟨26976450, 26976454⟩, ⟨3010787, 3010792⟩, ⟨66295, 66301⟩, ⟨4270, 4277⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3643394365, 3643394370⟩, ⟨(-120882523), (-120882517)⟩, ⟨1628354, 1628360⟩, ⟨(-43637), (-43630)⟩, ⟨1386, 1394⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨42768500322, 42768500329⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value688

def j47 : Jet := ⟨⟨7033547177, 7033547189⟩, ⟨1406709435, 1406709446⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11518314921, 11518314961⟩, ⟨4607325966, 4607326012⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11518314921, 11518314961⟩, ⟨4607325966, 4607326012⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11518314961), (-11518314921)⟩, ⟨(-4607326012), (-4607325966)⟩, ⟨(-460732604), (-460732596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5759157481), (-5759157460)⟩, ⟨(-2303663006), (-2303662983)⟩, ⟨(-230366302), (-230366298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1123597505, 1123597517⟩, ⟨(-602656518), (-602656505)⟩, ⟨101355773, 101355782⟩, ⟨3428348, 3428352⟩, ⟨(-3177888), (-3177886)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨953140859, 953140871⟩, ⟨(-542853649), (-542853634)⟩, ⟨103367329, 103367342⟩, ⟨(-184332), (-184321)⟩, ⟨(-2747364), (-2747355)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨565067372, 847601059⟩, ⟨141266843, 141266844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1775211504, 2662817261⟩, ⟨443802876, 443802880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨733736875, 1650907976⟩, ⟨366868436, 550302664⟩, ⟨45858554, 45858556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨183, 414⟩, ⟨91, 138⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94504), (-94272)⟩, ⟨91, 138⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-36326), (-16105)⟩, ⟨(-12094), (-7998)⟩, ⟨(-1002), (-983)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5076730, 5096952⟩, ⟨(-12094), (-7998)⟩, ⟨(-1002), (-983)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨867290, 1959177⟩, ⟨428996, 651693⟩, ⟨52269, 53572⟩, ⟨(-259), (-166)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142298287), (-141206399)⟩, ⟨428996, 651693⟩, ⟨52269, 53572⟩, ⟨(-259), (-166)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-54696896), (-24123196)⟩, ⟨(-18159011), (-11811098)⟩, ⟨(-1473786), (-1403606)⟩, ⟨8944, 13796⟩, ⟨519, 558⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1376958869, 1407532570⟩, ⟨(-18159011), (-11811098)⟩, ⟨(-1473786), (-1403606)⟩, ⟨8944, 13796⟩, ⟨519, 558⟩⟩
...
def j72 : Jet := ⟨⟨2014, 4543⟩, ⟨1001, 1514⟩, ⟨122, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850163), (-847633)⟩, ⟨1001, 1514⟩, ⟨122, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-326788), (-144806)⟩, ⟨(-108759), (-71821)⟩, ⟨(-8973), (-8807)⟩, ⟨19, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35464606, 35646589⟩, ⟨(-108759), (-71821)⟩, ⟨(-8973), (-8807)⟩, ⟨19, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6058646, 13701906⟩, ⟨2987518, 4555034⟩, ⟨361280, 372971⟩, ⟨(-2309), (-1504)⟩, ⟨(-96), (-88)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709769237), (-702125976)⟩, ⟨2987518, 4555034⟩, ⟨361280, 372971⟩, ⟨(-2309), (-1504)⟩, ⟨(-96), (-88)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-272822496), (-119948694)⟩, ⟨(-90430457), (-58223473)⟩, ⟨(-7261496), (-6769804)⟩, ⟨61869, 96168⟩, ⟨3524, 3840⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4022144800, 4175018602⟩, ⟨(-90430457), (-58223473)⟩, ⟨(-7261496), (-6769804)⟩, ⟨61869, 96168⟩, ⟨3524, 3840⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨569129647, 872649724⟩, ⟨131024088, 140559817⟩, ⟨(-2790114), (-1800594)⟩, ⟨(-148592), (-136481)⟩, ⟨1138, 1772⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4418362127, 4586295370⟩, ⟨61617063, 103114336⟩, ⟨8023677, 10598338⟩, ⟨106163, 356483⟩, ⟨7896, 22332⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨585480797, 931841645⟩, ⟨142953349, 171044734⟩, ⟨(-36428), 3675627⟩, ⟨33182, 253046⟩, ⟨(-4999), 12777⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-847601059), (-565067372)⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3447366237, 3729899924⟩, ⟨(-141266844), (-141266843)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨79811495, 202173566⟩, ⟨38974192, 74220174⟩, ⟨4742239, 8406702⟩, ⟨6144, 402564⟩, ⟨6, 28848⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4374778791, 4497140862⟩, ⟨38974192, 74220174⟩, ⟨4742239, 8406702⟩, ⟨6144, 402564⟩, ⟨6, 28848⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4334689358, 4394891686⟩, ⟨19044027, 36770019⟩, ⟨2163389, 4122999⟩, ⟨(-31931), 189934⟩, ⟨(-3570), 14024⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3479249249, 3816677762⟩, ⟨(-129267748), (-110640979)⟩, ⟨527037, 2954176⟩, ⟨(-163341), 93790⟩, ⟨(-9349), 13230⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5626837741, 8440256625⟩, ⟨1406709435, 1406709446⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7371721547, 16586373536⟩, ⟨3685860772, 5528791214⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7371721547, 16586373536⟩, ⟨3685860772, 5528791214⟩, ⟨460732596, 460732604⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16586373536), (-7371721547)⟩, ⟨(-5528791214), (-3685860772)⟩, ⟨(-460732604), (-460732596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8293186768), (-3685860773)⟩, ⟨(-2764395607), (-1842930386)⟩, ⟨(-230366302), (-230366298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨622840957, 1820775678⟩, ⟨(-1171916790), (-267255242)⟩, ⟨(-40321369), 343737018⟩, ⟨(-64190781), 50555643⟩, ⟨(-17353256), 11410220⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨504548412, 1618013261⟩, ⟨(-1096212382), (-232541778)⟩, ⟨(-28870076), 341982435⟩, ⟨(-68263407), 46146284⟩, ⟨(-16999679), 12358164⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4360506995, 4360506998⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar688 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3480
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar688 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4334689358, 4394891686⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3481
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((26313 / 200000) : ℝ)..(78939 / 400000), prawitzNormalCorrection
      ((7139 / 3125) * sqrt n) s) ≤ (upper : ℝ) :=
