...
namespace FiniteNormalPanel40_16
...
def j2 : Jet := ⟨⟨1741765637, 1741765642⟩, ⟨580588545, 580588550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨706349391, 706349396⟩, ⟨470899592, 470899600⟩, ⟨78483265, 78483267⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨176, 177⟩, ⟨117, 118⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94511), (-94509)⟩, ⟨117, 118⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-15544), (-15542)⟩, ⟨(-10344), (-10341)⟩, ⟨(-1713), (-1709)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097512, 5097515⟩, ⟨(-10344), (-10341)⟩, ⟨(-1713), (-1709)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨838335, 838337⟩, ⟨557188, 557191⟩, ⟨91731, 91735⟩, ⟨(-378), (-374)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-142327242), (-142327239)⟩, ⟨557188, 557191⟩, ⟨91731, 91735⟩, ⟨(-378), (-374)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-23407108), (-23407106)⟩, ⟨(-15513104), (-15513101)⟩, ⟨(-2524614), (-2524611)⟩, ⟨20175, 20179⟩, ⟨1628, 1632⟩⟩
...
def j19 : Jet := ⟨⟨1408248657, 1408248660⟩, ⟨(-15513104), (-15513101)⟩, ⟨(-2524614), (-2524611)⟩, ⟨20175, 20179⟩, ⟨1628, 1632⟩⟩
...
def j25 : Jet := ⟨⟨1943, 1944⟩, ⟨1293, 1295⟩, ⟨212, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850234), (-850232)⟩, ⟨1293, 1295⟩, ⟨212, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-139830), (-139828)⟩, ⟨(-93008), (-93006)⟩, ⟨(-15362), (-15358)⟩, ⟨45, 48⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35651564, 35651567⟩, ⟨(-93008), (-93006)⟩, ⟨(-15362), (-15358)⟩, ⟨45, 48⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5863248, 5863250⟩, ⟨3893535, 3893538⟩, ⟨638747, 638751⟩, ⟨(-3378), (-3374)⟩, ⟨(-277), (-273)⟩⟩
...
def j33 : Jet := ⟨⟨(-709964635), (-709964632)⟩, ⟨3893535, 3893538⟩, ⟨638747, 638751⟩, ⟨(-3378), (-3374)⟩, ⟨(-277), (-273)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-116760631), (-116760629)⟩, ⟨(-77200093), (-77200088)⟩, ⟨(-12441470), (-12441467)⟩, ⟨140623, 140627⟩, ⟨11255, 11260⟩⟩
...
def j36 : Jet := ⟨⟨4178206665, 4178206667⟩, ⟨(-77200093), (-77200088)⟩, ⟨(-12441470), (-12441467)⟩, ⟨140623, 140627⟩, ⟨11255, 11260⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨571096110, 571096114⟩, ⟨184074241, 184074246⟩, ⟨(-3120866), (-3120863)⟩, ⟨(-333094), (-333089)⟩, ⟨3387, 3390⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4414990818, 4414990821⟩, ⟨81575112, 81575119⟩, ⟨14653789, 14653796⟩, ⟨365065, 365073⟩, ⟨35734, 35745⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨587055478, 587055484⟩, ⟨200065157, 200065166⟩, ⟨2236570, 2236578⟩, ⟨274896, 274907⟩, ⟨6903, 6912⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-554421223), (-554421222)⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3740546073, 3740546074⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨80241387, 80241389⟩, ⟨54691612, 54691618⟩, ⟨9930702, 9930708⟩, ⟨283512, 283518⟩, ⟨28660, 28667⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4375208683, 4375208685⟩, ⟨54691612, 54691618⟩, ⟨9930702, 9930708⟩, ⟨283512, 283518⟩, ⟨28660, 28667⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4334902329, 4334902331⟩, ⟨27093884, 27093888⟩, ⟨4834936, 4834941⟩, ⟨110230, 110235⟩, ⟨10811, 10817⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3775326042, 3775326046⟩, ⟨(-162928994), (-162928988)⟩, ⟨3044995, 3045002⟩, ⟨(-112042), (-112035)⟩, ⟨4671, 4678⟩⟩
...
def j47 : Jet := ⟨⟨3605376397, 3605376405⟩, ⟨1201792132, 1201792140⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3026504759, 3026504774⟩, ⟨2017669838, 2017669858⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3026504759, 3026504774⟩, ⟨2017669838, 2017669858⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3026504774), (-3026504759)⟩, ⟨(-2017669858), (-2017669838)⟩, ⟨(-336278311), (-336278306)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1513252387), (-1513252379)⟩, ⟨(-1008834929), (-1008834919)⟩, ⟨(-168139156), (-168139153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3019563888, 3019563900⟩, ⟨(-709258377), (-709258366)⟩, ⟨(-34911704), (-34911698)⟩, ⟨21244115, 21244117⟩, ⟨(-564135), (-564134)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2654231661, 2654231675⟩, ⟨(-737993079), (-737993061)⟩, ⟨(-1641402), (-1641387)⟩, ⟨19416579, 19416591⟩, ⟨(-1304743), (-1304731)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨369614148, 739228297⟩, ⟨184807074, 184807075⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1161177091, 2322354188⟩, ⟨580588545, 580588550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨313933062, 1255732257⟩, ⟨313933062, 627866132⟩, ⟨78483265, 78483267⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨78, 315⟩, ⟨78, 158⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94609), (-94371)⟩, ⟨78, 158⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-27662), (-6897)⟩, ⟨(-13826), (-6850)⟩, ⟨(-1723), (-1694)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5085394, 5106160⟩, ⟨(-13826), (-6850)⟩, ⟨(-1723), (-1694)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨371707, 1492904⟩, ⟨367664, 745952⟩, ⟨90400, 92684⟩, ⟨(-505), (-246)⟩, ⟨(-32), (-28)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142793870), (-141672672)⟩, ⟨367664, 745952⟩, ⟨90400, 92684⟩, ⟨(-505), (-246)⟩, ⟨(-32), (-28)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-41749065), (-10355314)⟩, ⟨(-20847660), (-10137217)⟩, ⟨(-2575837), (-2452680)⟩, ⟨13177, 27165⟩, ⟨1567, 1675⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1389906700, 1421300452⟩, ⟨(-20847660), (-10137217)⟩, ⟨(-2575837), (-2452680)⟩, ⟨13177, 27165⟩, ⟨1567, 1675⟩⟩
...
def j72 : Jet := ⟨⟨862, 3459⟩, ⟨857, 1730⟩, ⟨211, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851315), (-848717)⟩, ⟨857, 1730⟩, ⟨211, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-248902), (-62035)⟩, ⟨(-124389), (-61529)⟩, ⟨(-15480), (-15191)⟩, ⟨29, 64⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35542492, 35729360⟩, ⟨(-124389), (-61529)⟩, ⟨(-15480), (-15191)⟩, ⟨29, 64⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2597915, 10446299⟩, ⟨2561547, 5218653⟩, ⟨626768, 647287⟩, ⟨(-4534), (-2215)⟩, ⟨(-281), (-265)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713229968), (-705381583)⟩, ⟨2561547, 5218653⟩, ⟨626768, 647287⟩, ⟨(-4534), (-2215)⟩, ⟨(-281), (-265)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-208529150), (-51558623)⟩, ⟨(-104077345), (-50032830)⟩, ⟨(-12800030), (-11937508)⟩, ⟨91293, 189827⟩, ⟨10707, 11649⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4086438146, 4243408673⟩, ⟨(-104077345), (-50032830)⟩, ⟨(-12800030), (-11937508)⟩, ⟨91293, 189827⟩, ⟨10707, 11649⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨375771852, 768518788⟩, ⟨176613278, 189389025⟩, ⟨(-4210957), (-2033436)⟩, ⟨(-344637), (-316861)⟩, ⟨2204, 4579⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4347152370, 4514137598⟩, ⟨51256042, 114970408⟩, ⟨12833703, 17067900⟩, ⟨93572, 697711⟩, ⟨19670, 58699⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨380337586, 807735966⟩, ⟨183243631, 219625664⟩, ⟨(-1195307), 6065584⟩, ⟨60974, 532488⟩, ⟨(-18164), 36226⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-739228297), (-369614148)⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3555738999, 3925353148⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨33680507, 151907418⟩, ⟨32454002, 82608102⟩, ⟨7368446, 13512145⟩, ⟨(-111448), 820622⟩, ⟨(-3321), 76653⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4328647803, 4446874714⟩, ⟨32454002, 82608102⟩, ⟨7368446, 13512145⟩, ⟨(-111448), 820622⟩, ⟨(-3321), 76653⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4311774663, 4370261030⟩, ⟨15947431, 41143048⟩, ⟨3427081, 6700247⟩, ⟨(-119442), 396038⟩, ⟨(-10640), 37956⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3569653566, 3994167292⟩, ⟨(-174844233), (-147927892)⟩, ⟨1066894, 5437443⟩, ⟨(-397468), 214493⟩, ⟨(-26767), 39830⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2403584264, 4807168538⟩, ⟨1201792132, 1201792140⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1345113225, 5380452926⟩, ⟨1345113224, 2690226476⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1345113225, 5380452926⟩, ⟨1345113224, 2690226476⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5380452926), (-1345113225)⟩, ⟨(-2690226476), (-1345113224)⟩, ⟨(-336278311), (-336278306)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2690226463), (-672556612)⟩, ⟨(-1345113238), (-672556612)⟩, ⟨(-168139156), (-168139153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2295789469, 3672424801⟩, ⟨(-1150143151), (-359501779)⟩, ⟨(-115620382), 90227531⟩, ⟨(-36757), 42087299⟩, ⟨(-5061375), 2266029⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1908087419, 3415224847⟩, ⟨(-1219093441), (-377862737)⟩, ⟨(-94570558), 135378996⟩, ⟨(-5503208), 43940599⟩, ⟨(-6646939), 2363548⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4334902329, 4334902331⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified796
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4311774663, 4370261030⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified797
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (228410139 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((34423 / 400000) : ℝ)..(34423 / 200000), prawitzNormalCorrection
