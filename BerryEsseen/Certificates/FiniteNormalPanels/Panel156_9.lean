...
namespace FiniteNormalPanel156_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (44653 / 200000)
def radius : Rat := (6379 / 200000)

def j0 : Jet := ⟨⟨958915873, 958915874⟩, ⟨136987981, 136987982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3012523061, 3012523066⟩, ⟨430360434, 430360438⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2113006821, 2113006829⟩, ⟨603716230, 603716238⟩, ⟨43122587, 43122589⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨528, 530⟩, ⟨151, 152⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94159), (-94156)⟩, ⟨151, 152⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-46324), (-46322)⟩, ⟨(-13162), (-13159)⟩, ⟨(-921), (-917)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5066732, 5066735⟩, ⟨(-13162), (-13159)⟩, ⟨(-921), (-917)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2492694, 2492696⟩, ⟨705722, 705726⟩, ⟨48566, 48572⟩, ⟨(-263), (-258)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140672883), (-140672880)⟩, ⟨705722, 705726⟩, ⟨48566, 48572⟩, ⟨(-263), (-258)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-69207224), (-69207221)⟩, ⟨(-19426298), (-19426293)⟩, ⟨(-1289302), (-1289295)⟩, ⟨13781, 13788⟩, ⟨445, 449⟩⟩
...
def j19 : Jet := ⟨⟨1362448541, 1362448545⟩, ⟨(-19426298), (-19426293)⟩, ⟨(-1289302), (-1289295)⟩, ⟨13781, 13788⟩, ⟨445, 449⟩⟩
...
def j22 : Jet := ⟨⟨(-54), (-52)⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11781, 11784⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5795, 5798⟩, ⟨1647, 1650⟩, ⟨114, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846382), (-846378)⟩, ⟨1647, 1650⟩, ⟨114, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-416397), (-416394)⟩, ⟨(-118161), (-118157)⟩, ⟨(-8211), (-8207)⟩, ⟨31, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35374997, 35375001⟩, ⟨(-118161), (-118157)⟩, ⟨(-8211), (-8207)⟩, ⟨31, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17403534, 17403537⟩, ⟨4914306, 4914309⟩, ⟨334524, 334530⟩, ⟨(-2327), (-2322)⟩, ⟨(-80), (-76)⟩⟩
...
def j33 : Jet := ⟨⟨(-698424349), (-698424345)⟩, ⟨4914306, 4914309⟩, ⟨334524, 334530⟩, ⟨(-2327), (-2322)⟩, ⟨(-80), (-76)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-343605741), (-343605737)⟩, ⟨(-95755365), (-95755360)⟩, ⟨(-6157015), (-6157007)⟩, ⟨95216, 95222⟩, ⟨2990, 2996⟩⟩
...
def j36 : Jet := ⟨⟨3951361555, 3951361559⟩, ⟨(-95755365), (-95755360)⟩, ⟨(-6157015), (-6157007)⟩, ⟨95216, 95222⟩, ⟨2990, 2996⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨955631874, 955631880⟩, ⟨122893083, 122893089⟩, ⟨(-2850864), (-2850856)⟩, ⟨(-119524), (-119516)⟩, ⟨1692, 1697⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4668452582, 4668452588⟩, ⟨113132992, 113133000⟩, ⟨10015986, 10015998⟩, ⟨306501, 306513⟩, ⟨16766, 16778⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1038732493, 1038732502⟩, ⟨158751854, 158751865⟩, ⟨2366893, 2366907⟩, ⟨149773, 149790⟩, ⟨4540, 4554⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-958915874), (-958915873)⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3336051422, 3336051423⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨251216160, 251216165⟩, ⟨76787876, 76787884⟩, ⟨7012693, 7012702⟩, ⟨247414, 247428⟩, ⟨14568, 14583⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4546183456, 4546183461⟩, ⟨76787876, 76787884⟩, ⟨7012693, 7012702⟩, ⟨247414, 247428⟩, ⟨14568, 14583⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4418790475, 4418790478⟩, ⟨37318064, 37318069⟩, ⟨3250510, 3250516⟩, ⟨92787, 92797⟩, ⟨5099, 5109⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3432229218, 3432229223⟩, ⟨(-111951077), (-111951070)⟩, ⟨1334524, 1334531⟩, ⟨(-31606), (-31596)⟩, ⟨1000, 1010⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨50906569224, 50906569232⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value638

def j47 : Jet := ⟨⟨11365655173, 11365655188⟩, ⟨1623665014, 1623665027⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨30076624246, 30076624326⟩, ⟨8593321156, 8593321238⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨30076624246, 30076624326⟩, ⟨8593321156, 8593321238⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-30076624326), (-30076624246)⟩, ⟨(-8593321238), (-8593321156)⟩, ⟨(-613808660), (-613808649)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-15038312163), (-15038312123)⟩, ⟨(-4296660619), (-4296660578)⟩, ⟨(-306904330), (-306904324)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨129517927, 129517932⟩, ⟨(-129568996), (-129568989)⟩, ⟨55555107, 55555113⟩, ⟨(-12353289), (-12353284)⟩, ⟨1104645, 1104647⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨103501419, 103501424⟩, ⟨(-106918199), (-106918191)⟩, ⟨47813190, 47813198⟩, ⟨(-11361155), (-11361146)⟩, ⟨1222992, 1223000⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨821927891, 1095903856⟩, ⟨136987981, 136987982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2582162624, 3442883504⟩, ⟨430360434, 430360438⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1552413175, 2759845654⟩, ⟨517471054, 689961414⟩, ⟨43122587, 43122589⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨388, 692⟩, ⟨129, 173⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94299), (-93994)⟩, ⟨129, 173⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-60595), (-33974)⟩, ⟨(-15103), (-11212)⟩, ⟨(-929), (-907)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5052461, 5079083⟩, ⟨(-15103), (-11212)⟩, ⟨(-929), (-907)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1826208, 3263701⟩, ⟨599031, 811874⟩, ⟨47704, 49319⟩, ⟨(-302), (-218)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141339369), (-139901875)⟩, ⟨599031, 811874⟩, ⟨47704, 49319⟩, ⟨(-302), (-218)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-90821377), (-50567443)⟩, ⟨(-22488826), (-16334122)⟩, ⟨(-1329670), (-1242536)⟩, ⟨11566, 15997⟩, ⟨422, 468⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1340834388, 1381088323⟩, ⟨(-22488826), (-16334122)⟩, ⟨(-1329670), (-1242536)⟩, ⟨11566, 15997⟩, ⟨422, 468⟩⟩
...
def j70 : Jet := ⟨⟨(-70), (-38)⟩, ⟨(-18), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11765, 11798⟩, ⟨(-18), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4252, 7582⟩, ⟨1405, 1892⟩, ⟨113, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847925), (-844594)⟩, ⟨1405, 1892⟩, ⟨113, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-544857), (-305277)⟩, ⟨(-135708), (-100543)⟩, ⟨(-8305), (-8099)⟩, ⟨25, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35246537, 35486118⟩, ⟨(-135708), (-100543)⟩, ⟨(-8305), (-8099)⟩, ⟨25, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12739838, 22802551⟩, ⟨4159409, 5664297⟩, ⟨326746, 341250⟩, ⟨(-2689), (-1959)⟩, ⟨(-82), (-72)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703088045), (-693025331)⟩, ⟨4159409, 5664297⟩, ⟨326746, 341250⟩, ⟨(-2689), (-1959)⟩, ⟨(-82), (-72)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-451787954), (-250493561)⟩, ⟨(-111443574), (-79858108)⟩, ⟨(-6439947), (-5828937)⟩, ⟨79400, 110984⟩, ⟨2795, 3165⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3843179342, 4044473735⟩, ⟨(-111443574), (-79858108)⟩, ⟨(-6439947), (-5828937)⟩, ⟨79400, 110984⟩, ⟨2795, 3165⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨806118464, 1107092529⟩, ⟨116325835, 128566386⟩, ⟨(-3319282), (-2383716)⟩, ⟨(-126282), (-111679)⟩, ⟨1411, 1979⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4560975118, 4799865537⟩, ⟨90056423, 139185327⟩, ⟨8351486, 12079113⟩, ⟨162976, 489270⟩, ⟨7676, 29254⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨856045227, 1237237658⟩, ⟨140433056, 179557225⟩, ⟨297106, 4748625⟩, ⟨8086, 319120⟩, ⟨(-6077), 17423⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1095903856), (-821927891)⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3199063440, 3473039405⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨170621422, 356407143⟩, ⟨55980424, 103448966⟩, ⟨4710190, 10242490⟩, ⟨22650, 580904⟩, ⟨(-2954), 41973⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4465588718, 4651374439⟩, ⟨55980424, 103448966⟩, ⟨4710190, 10242490⟩, ⟨22650, 580904⟩, ⟨(-2954), 41973⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4379447168, 4469619794⟩, ⟨26896481, 50726714⟩, ⟨1975214, 4939864⟩, ⟨(-46112), 272719⟩, ⟨(-7395), 20671⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3261987427, 3614268655⟩, ⟨(-122524950), (-98663323)⟩, ⟨(-146711), 3136660⟩, ⟨(-194845), 157530⟩, ⟨(-14679), 18187⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9741990147, 12989320215⟩, ⟨1623665014, 1623665027⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨22097111685, 39283754223⟩, ⟨7365703846, 9820938558⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨22097111685, 39283754223⟩, ⟨7365703846, 9820938558⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-39283754223), (-22097111685)⟩, ⟨(-9820938558), (-7365703846)⟩, ⟨(-613808660), (-613808649)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-19641877112), (-11048555842)⟩, ⟨(-4910469279), (-3682851923)⟩, ⟨(-306904330), (-306904324)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨44343596, 327915800⟩, ⟨(-374908667), (-38023781)⟩, ⟨(-7129462), 211149340⟩, ⟨(-78658188), 20576889⟩, ⟨(-13425451), 22737353⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨33678545, 275945244⟩, ⟨(-324844968), (-29897359)⟩, ⟨(-5137258), 188619521⟩, ⟨(-72504103), 17543932⟩, ⟨(-11906779), 21550297⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨958915873, 958915874⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4418790475, 4418790478⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar638 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3150
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar638 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨821927891, 1095903856⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4379447168, 4469619794⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3151
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((19137 / 100000) : ℝ)..(6379 / 25000), prawitzNormalCorrection
      ((71867 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
