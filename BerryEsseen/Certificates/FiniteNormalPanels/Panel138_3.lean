...
namespace FiniteNormalPanel138_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1949 / 25000)
def radius : Rat := (1949 / 25000)

def j0 : Jet := ⟨⟨334835650, 334835651⟩, ⟨334835650, 334835651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1051917218, 1051917222⟩, ⟨1051917218, 1051917222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨257634053, 257634056⟩, ⟨515268106, 515268112⟩, ⟨257634053, 257634056⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨64, 65⟩, ⟨128, 130⟩, ⟨64, 65⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94623), (-94621)⟩, ⟨128, 130⟩, ⟨64, 65⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-5676), (-5675)⟩, ⟨(-11345), (-11343)⟩, ⟨(-5658), (-5655)⟩, ⟨14, 16⟩, ⟨3, 4⟩⟩
...
def j13 : Jet := ⟨⟨5107380, 5107382⟩, ⟨(-11345), (-11343)⟩, ⟨(-5658), (-5655)⟩, ⟨14, 16⟩, ⟨3, 4⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨306366, 306367⟩, ⟨612052, 612054⟩, ⟨304664, 304668⟩, ⟨(-1360), (-1357)⟩, ⟨(-339), (-336)⟩⟩
...
def j16 : Jet := ⟨⟨(-142859211), (-142859209)⟩, ⟨612052, 612054⟩, ⟨304664, 304668⟩, ⟨(-1360), (-1357)⟩, ⟨(-339), (-336)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-8569425), (-8569424)⟩, ⟨(-17102135), (-17102133)⟩, ⟨(-8477722), (-8477719)⟩, ⟨73182, 73186⟩, ⟨18090, 18094⟩⟩
...
def j19 : Jet := ⟨⟨1423086340, 1423086342⟩, ⟨(-17102135), (-17102133)⟩, ⟨(-8477722), (-8477719)⟩, ⟨73182, 73186⟩, ⟨18090, 18094⟩⟩
...
def j22 : Jet := ⟨⟨(-7), (-6)⟩, ⟨(-13), (-12)⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11828, 11830⟩, ⟨(-13), (-12)⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨709, 710⟩, ⟨1418, 1420⟩, ⟨706, 709⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851468), (-851466)⟩, ⟨1418, 1420⟩, ⟨706, 709⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-51076), (-51075)⟩, ⟨(-102066), (-102064)⟩, ⟨(-50864), (-50861)⟩, ⟨168, 172⟩, ⟨40, 43⟩⟩
...
def j30 : Jet := ⟨⟨35740318, 35740320⟩, ⟨(-102066), (-102064)⟩, ⟨(-50864), (-50861)⟩, ⟨168, 172⟩, ⟨40, 43⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2143886, 2143887⟩, ⟨4281650, 4281652⟩, ⟨2128589, 2128593⟩, ⟨(-12216), (-12212)⟩, ⟨(-3030), (-3026)⟩⟩
...
def j33 : Jet := ⟨⟨(-713683997), (-713683995)⟩, ⟨4281650, 4281652⟩, ⟨2128589, 2128593⟩, ⟨(-12216), (-12212)⟩, ⟨(-3030), (-3026)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-42810409), (-42810407)⟩, ⟨(-85363982), (-85363979)⟩, ⟨(-42169056), (-42169052)⟩, ⟨511469, 511472⟩, ⟨126035, 126038⟩⟩
...
def j36 : Jet := ⟨⟨4252156887, 4252156889⟩, ⟨(-85363982), (-85363979)⟩, ⟨(-42169056), (-42169052)⟩, ⟨511469, 511472⟩, ⟨126035, 126038⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨348540261, 348540264⟩, ⟨344351630, 344351635⟩, ⟨(-6264983), (-6264979)⟩, ⟨(-2058429), (-2058425)⟩, ⟨22353, 22357⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4338208715, 4338208718⟩, ⟨87091508, 87091513⟩, ⟨44770836, 44770844⟩, ⟨1240665, 1240673⟩, ⟨329837, 329845⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨352049339, 352049343⟩, ⟨354886087, 354886094⟩, ⟨4287746, 4287755⟩, ⟨1484017, 1484025⟩, ⟨41768, 41778⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-334835651), (-334835650)⟩, ⟨(-334835651), (-334835650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3960131645, 3960131646⟩, ⟨(-334835651), (-334835650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨28856735, 28856737⟩, ⟨58178516, 58178520⟩, ⟨30026567, 30026574⟩, ⟨951860, 951868⟩, ⟨256368, 256377⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4323824031, 4323824033⟩, ⟨58178516, 58178520⟩, ⟨30026567, 30026574⟩, ⟨951860, 951868⟩, ⟨256368, 256377⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4309371509, 4309371511⟩, ⟨28992026, 28992029⟩, ⟨14865576, 14865581⟩, ⟨374327, 374333⟩, ⟨99596, 99603⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3973412905, 3973412909⟩, ⟨(-309226797), (-309226791)⟩, ⟨11446436, 11446443⟩, ⟨(-813777), (-813770)⟩, ⟨62647, 62656⟩⟩
...
def j47 : Jet := ⟨⟨2419986290, 2419986299⟩, ⟨2419986290, 2419986299⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1363533931, 1363533942⟩, ⟨2727067862, 2727067884⟩, ⟨1363533931, 1363533942⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1363533931, 1363533942⟩, ⟨2727067862, 2727067884⟩, ⟨1363533931, 1363533942⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1363533942), (-1363533931)⟩, ⟨(-2727067884), (-2727067862)⟩, ⟨(-1363533942), (-1363533931)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-681766971), (-681766965)⟩, ⟨(-1363533942), (-1363533931)⟩, ⟨(-681766971), (-681766965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3664557890, 3664557899⟩, ⟨(-1163396304), (-1163396291)⟩, ⟨(-397024998), (-397024986)⟩, ⟨165130272, 165130277⟩, ⟨18405046, 18405049⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3390200811, 3390200824⟩, ⟨(-1340134395), (-1340134374)⟩, ⟨(-273772709), (-273772686)⟩, ⟨177557260, 177557279⟩, ⟨4353914, 4353933⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 669671301⟩, ⟨334835650, 334835651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2103834440⟩, ⟨1051917218, 1051917222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1030536218⟩, ⟨0, 1030536220⟩, ⟨257634053, 257634056⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 259⟩, ⟨0, 259⟩, ⟨64, 65⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94427)⟩, ⟨0, 259⟩, ⟨64, 65⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-22720), 0⟩, ⟨(-22720), 63⟩, ⟨(-5680), (-5585)⟩, ⟨0, 32⟩, ⟨3, 4⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5090336, 5113057⟩, ⟨(-22720), 63⟩, ⟨(-5680), (-5585)⟩, ⟨0, 32⟩, ⟨3, 4⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1226829⟩, ⟨(-5452), 1226846⟩, ⟨298529, 306724⟩, ⟨(-2726), 12⟩, ⟨(-341), (-326)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141938747)⟩, ⟨(-5452), 1226846⟩, ⟨298529, 306724⟩, ⟨(-2726), 12⟩, ⟨(-341), (-326)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-34351208), 0⟩, ⟨(-34352517), 294370⟩, ⟨(-8589111), (-8146244)⟩, ⟨(-983), 147192⟩, ⟨17170, 18402⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1397304557, 1431655766⟩, ⟨(-34352517), 294370⟩, ⟨(-8589111), (-8146244)⟩, ⟨(-983), 147192⟩, ⟨17170, 18402⟩⟩
...
def j70 : Jet := ⟨⟨(-26), 0⟩, ⟨(-26), 0⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11809, 11836⟩, ⟨(-26), 0⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 2840⟩, ⟨(-7), 2840⟩, ⟨699, 710⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-849336)⟩, ⟨(-7), 2840⟩, ⟨699, 710⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-204472), 0⟩, ⟨(-204474), 682⟩, ⟨(-51120), (-50094)⟩, ⟨(-2), 342⟩, ⟨39, 43⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35586922, 35791395⟩, ⟨(-204474), 682⟩, ⟨(-51120), (-50094)⟩, ⟨(-2), 342⟩, ⟨39, 43⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 8587803⟩, ⟨(-49062), 8587967⟩, ⟨2073357, 2147115⟩, ⟨(-24533), 124⟩, ⟨(-3068), (-2910)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-707240079)⟩, ⟨(-49062), 8587967⟩, ⟨2073357, 2147115⟩, ⟨(-24533), 124⟩, ⟨(-3068), (-2910)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-171756037), 0⟩, ⟨(-171767809), 2060601⟩, ⟨(-42950782), (-39848087)⟩, ⟨(-8830), 1030361⟩, ⟨117746, 128825⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4123211259, 4294967296⟩, ⟨(-171767809), 2060601⟩, ⟨(-42950782), (-39848087)⟩, ⟨(-8830), 1030361⟩, ⟨117746, 128825⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 701278147⟩, ⟨325398685, 350783269⟩, ⟨(-12620836), 72097⟩, ⟨(-2104115), (-1923065)⟩, ⟨(-241), 45065⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4473877984⟩, ⟨(-2235850), 186376146⟩, ⟨39758669, 54367815⟩, ⟨(-1168454), 4215926⟩, ⟨143241, 619881⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 730490513⟩, ⟨325033617, 395826778⟩, ⟨(-13329178), 24174143⟩, ⟨82008, 3212267⟩, ⟨(-346752), 494494⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-669671301), 0⟩, ⟨(-334835651), (-334835650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3625295995, 4294967296⟩, ⟨(-334835651), (-334835650)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 124242248⟩, ⟨0, 134644894⟩, ⟨20063754, 44702741⟩, ⟨(-2456852), 5548498⟩, ⟨(-180564), 896362⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4419209544⟩, ⟨0, 134644894⟩, ⟨20063754, 44702741⟩, ⟨(-2456852), 5548498⟩, ⟨(-180564), 896362⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4356645552⟩, ⟨0, 67322447⟩, ⟨9369691, 22351371⟩, ⟨(-1578778), 2774249⟩, ⟨(-191928), 462708⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3625295995, 4356645552⟩, ⟨(-339644088), (-267513203)⟩, ⟨2660310, 22351371⟩, ⟨(-3321291), 2043788⟩, ⟨(-408209), 585790⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4839972590⟩, ⟨2419986290, 2419986299⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 5454135750⟩, ⟨0, 5454135760⟩, ⟨1363533931, 1363533942⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 5454135750⟩, ⟨0, 5454135760⟩, ⟨1363533931, 1363533942⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5454135750), 0⟩, ⟨(-5454135760), 0⟩, ⟨(-1363533942), (-1363533931)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2727067875), 0⟩, ⟨(-2727067880), 0⟩, ⟨(-681766971), (-681766965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2276180843, 4294967296⟩, ⟨(-2727067880), 0⟩, ⟨(-681766971), 504456626⟩, ⟨(-106767400), 432884509⟩, ⟨(-108752236), 71058420⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1921278725, 4356645552⟩, ⟨(-3105874267), (-141772541)⟩, ⟨(-690147676), 749707597⟩, ⟨(-165706029), 495058601⟩, ⟨(-149800171), 85841843⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨334835650, 334835651⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨334835650, 334835651⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4309371509, 4309371511⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2768
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 669671301⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4356645552⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2769
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (258524063 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(1949 / 12500),
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1949 / 12500), prawitzNormalCorrection
