...
namespace FiniteNormalPanel15_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (34237 / 100000)
def radius : Rat := (4891 / 100000)

def j0 : Jet := ⟨⟨1470467953, 1470467954⟩, ⟨210066850, 210066851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4619611318, 4619611322⟩, ⟨659944472, 659944476⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4968794232, 4968794242⟩, ⟨1419655490, 1419655502⟩, ⟨101403963, 101403965⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1243, 1245⟩, ⟨355, 356⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93444), (-93441)⟩, ⟨355, 356⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-108105), (-108100)⟩, ⟨(-30477), (-30473)⟩, ⟨(-2062), (-2057)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5004951, 5004957⟩, ⟨(-30477), (-30473)⟩, ⟨(-2062), (-2057)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5790165, 5790173⟩, ⟨1619074, 1619083⟩, ⟨105706, 105716⟩, ⟨(-1384), (-1377)⟩, ⟨(-44), (-40)⟩⟩
...
def j16 : Jet := ⟨⟨(-137375412), (-137375403)⟩, ⟨1619074, 1619083⟩, ⟨105706, 105716⟩, ⟨(-1384), (-1377)⟩, ⟨(-44), (-40)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-158927906), (-158927894)⟩, ⟨(-43534888), (-43534872)⟩, ⟨(-2585971), (-2585953)⟩, ⟨71563, 71578⟩, ⟨1986, 1995⟩⟩
...
def j19 : Jet := ⟨⟨1272727859, 1272727872⟩, ⟨(-43534888), (-43534872)⟩, ⟨(-2585971), (-2585953)⟩, ⟨71563, 71578⟩, ⟨1986, 1995⟩⟩
...
def j22 : Jet := ⟨⟨(-125), (-123)⟩, ⟨(-36), (-35)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11710, 11713⟩, ⟨(-36), (-35)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨13547, 13551⟩, ⟨3828, 3832⟩, ⟨260, 264⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-838630), (-838625)⟩, ⟨3828, 3832⟩, ⟨260, 264⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-970201), (-970194)⟩, ⟨(-272773), (-272764)⟩, ⟨(-18236), (-18226)⟩, ⟨172, 179⟩, ⟨3, 7⟩⟩
...
def j30 : Jet := ⟨⟨34821193, 34821201⟩, ⟨(-272773), (-272764)⟩, ⟨(-18236), (-18226)⟩, ⟨172, 179⟩, ⟨3, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨40284204, 40284215⟩, ⟨11194204, 11194219⟩, ⟨710865, 710883⟩, ⟨(-12271), (-12255)⟩, ⟨(-372), (-361)⟩⟩
...
def j33 : Jet := ⟨⟨(-675543679), (-675543667)⟩, ⟨11194204, 11194219⟩, ⟨710865, 710883⟩, ⟨(-12271), (-12255)⟩, ⟨(-372), (-361)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-781528080), (-781528064)⟩, ⟨(-210343303), (-210343278)⟩, ⟨(-11427039), (-11427010)⟩, ⟨485065, 485093⟩, ⟨12295, 12317⟩⟩
...
def j36 : Jet := ⟨⟨3513439216, 3513439232⟩, ⟨(-210343303), (-210343278)⟩, ⟨(-11427039), (-11427010)⟩, ⟨485065, 485093⟩, ⟨12295, 12317⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1368929637, 1368929653⟩, ⟨148735813, 148735835⟩, ⟨(-9470804), (-9470780)⟩, ⟨(-320377), (-320356)⟩, ⟨13132, 13145⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5250338160, 5250338185⟩, ⟨314328287, 314328330⟩, ⟨35894317, 35894369⟩, ⟨2446336, 2446387⟩, ⟨201392, 201438⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1673433815, 1673433844⟩, ⟨282006016, 282006061⟩, ⟨10748332, 10748385⟩, ⟨937980, 938030⟩, ⟨62361, 62399⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1470467954), (-1470467953)⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2824499342, 2824499343⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨652014448, 652014472⟩, ⟨219754130, 219754172⟩, ⟨26892086, 26892137⟩, ⟨2142386, 2142436⟩, ⟨198666, 198707⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4946981744, 4946981768⟩, ⟨219754130, 219754172⟩, ⟨26892086, 26892137⟩, ⟨2142386, 2142436⟩, ⟨198666, 198707⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4609460359, 4609460371⟩, ⟨102380400, 102380421⟩, ⟨11391667, 11391693⟩, ⟨745087, 745113⟩, ⟨61928, 61951⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3031319414, 3031319424⟩, ⟨(-158120286), (-158120268)⟩, ⟨2484074, 2484095⟩, ⟨(-67177), (-67157)⟩, ⟨4281, 4299⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨20585556263, 20585556269⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value150

def j47 : Jet := ⟨⟨7047876897, 7047876904⟩, ⟨1006839554, 1006839560⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11565296155, 11565296179⟩, ⟨3304370320, 3304370346⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11565296155, 11565296179⟩, ⟨3304370320, 3304370346⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11565296179), (-11565296155)⟩, ⟨(-3304370346), (-3304370320)⟩, ⟨(-236026454), (-236026450)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5782648090), (-5782648077)⟩, ⟨(-1652185173), (-1652185160)⟩, ⟨(-118013227), (-118013225)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1117468945, 1117468961⟩, ⟨(-429867220), (-429867209)⟩, ⟨51975714, 51975719⟩, ⟨1209672, 1209675⟩, ⟨(-830406), (-830404)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨788691758, 788691772⟩, ⟨(-344533326), (-344533310)⟩, ⟨53155603, 53155618⟩, ⟨(-1325835), (-1325821)⟩, ⟨(-592728), (-592714)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1260401102, 1680534804⟩, ⟨210066850, 210066851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3959666842, 5279555795⟩, ⟨659944472, 659944476⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3650542697, 6489853699⟩, ⟨1216847562, 1622463430⟩, ⟨101403963, 101403965⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨913, 1626⟩, ⟨304, 407⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93774), (-93060)⟩, ⟨304, 407⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-141696), (-79097)⟩, ⟨(-35166), (-25750)⟩, ⟨(-2107), (-2003)⟩, ⟨14, 20⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4971360, 5033960⟩, ⟨(-35166), (-25750)⟩, ⟨(-2107), (-2003)⟩, ⟨14, 20⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4225448, 7606499⟩, ⟨1355344, 1879739⟩, ⟨100904, 109855⟩, ⟨(-1616), (-1143)⟩, ⟨(-47), (-37)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138940129), (-135559077)⟩, ⟨1355344, 1879739⟩, ⟨100904, 109855⟩, ⟨(-1616), (-1143)⟩, ⟨(-47), (-37)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-209943650), (-115219549)⟩, ⟨(-51333928), (-35566161)⟩, ⟨(-2810611), (-2324459)⟩, ⟨58145, 84909⟩, ⟨1699, 2240⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1221712115, 1316436217⟩, ⟨(-51333928), (-35566161)⟩, ⟨(-2810611), (-2324459)⟩, ⟨58145, 84909⟩, ⟨1699, 2240⟩⟩
...
def j70 : Jet := ⟨⟨(-164), (-90)⟩, ⟨(-41), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11671, 11746⟩, ⟨(-41), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9919, 17749⟩, ⟨3244, 4413⟩, ⟨254, 269⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842258), (-834427)⟩, ⟨3244, 4413⟩, ⟨254, 269⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1272683), (-709228)⟩, ⟨(-315414), (-229740)⟩, ⟨(-18752), (-17625)⟩, ⟨142, 207⟩, ⟨1, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34518711, 35082167⟩, ⟨(-315414), (-229740)⟩, ⟨(-18752), (-17625)⟩, ⟨142, 207⟩, ⟨1, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨29339461, 53010446⟩, ⟨9303217, 13057343⟩, ⟨667499, 748220⟩, ⟨(-14411), (-10104)⟩, ⟨(-403), (-326)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-686488422), (-662817436)⟩, ⟨9303217, 13057343⟩, ⟨667499, 748220⟩, ⟨(-14411), (-10104)⟩, ⟨(-403), (-326)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1037309278), (-563367118)⟩, ⟨(-251419976), (-168058912)⟩, ⟨(-13004831), (-9585966)⟩, ⟨386987, 582344⟩, ⟨9706, 14527⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3257658018, 3731600178⟩, ⟨(-251419976), (-168058912)⟩, ⟨(-13004831), (-9585966)⟩, ⟨386987, 582344⟩, ⟨9706, 14527⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1126335224, 1618219181⟩, ⟨124620696, 169487825⟩, ⟨(-11342653), (-7607921)⟩, ⟨(-378261), (-252791)⟩, ⟨10500, 15801⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4943387070, 5662578445⟩, ⟨222633778, 437027255⟩, ⟨22725566, 56334416⟩, ⟨711709, 5505195⟩, ⟨184, 608600⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1296380297, 2133495420⟩, ⟨201819604, 388115643⟩, ⟨(-2534893), 29714625⟩, ⟨(-806825), 3611947⟩, ⟨(-154482), 414024⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1680534804), (-1260401102)⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2614432492, 3034566194⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨391295616, 1059799155⟩, ⟨121833270, 385587546⟩, ⟨6965078, 64593226⟩, ⟨(-1259704), 8958758⟩, ⟨(-316832), 1269698⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4686262912, 5354766451⟩, ⟨121833270, 385587546⟩, ⟨6965078, 64593226⟩, ⟨(-1259704), 8958758⟩, ⟨(-316832), 1269698⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4486351072, 4795680013⟩, ⟨54556382, 184569361⟩, ⟨(-462634), 30587152⟩, ⟨(-1861346), 4307326⟩, ⟨(-433133), 685921⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2730931624, 3388339758⟩, ⟨(-201347151), (-89021793)⟩, ⟨(-9354158), 18942695⟩, ⟨(-2811134), 3065927⟩, ⟨(-516698), 575670⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6041037337, 8054716459⟩, ⟨1006839554, 1006839560⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8496952268, 15105692958⟩, ⟨2832317416, 3776423250⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8496952268, 15105692958⟩, ⟨2832317416, 3776423250⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15105692958), (-8496952268)⟩, ⟨(-3776423250), (-2832317416)⟩, ⟨(-236026454), (-236026450)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7552846479), (-4248476134)⟩, ⟨(-1888211625), (-1416158708)⟩, ⟨(-118013227), (-118013225)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨740011043, 1597226215⟩, ⟨(-702194196), (-244000247)⟩, ⟨(-3660630), 134020703⟩, ⟨(-15170387), 13399284⟩, ⟨(-3313944), 1717645⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨470532001, 1260066658⟩, ⟨(-628845176), (-170484440)⟩, ⟨(-1309168), 145693369⟩, ⟨(-22393322), 13411932⟩, ⟨(-4227855), 3331025⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1470467953, 1470467954⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4609460359, 4609460371⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar150 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified304
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar150 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1260401102, 1680534804⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4486351072, 4795680013⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified305
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((14673 / 50000) : ℝ)..(4891 / 12500), prawitzNormalCorrection
      ((276721 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
