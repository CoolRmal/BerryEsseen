...
namespace FiniteNormalPanel119_18
...
def j2 : Jet := ⟨⟨518014583, 518014587⟩, ⟨518014583, 518014587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨62477567, 62477569⟩, ⟨124955134, 124955138⟩, ⟨62477567, 62477569⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1378), (-1377)⟩, ⟨(-2755), (-2753)⟩, ⟨(-1378), (-1375)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111678, 5111680⟩, ⟨(-2755), (-2753)⟩, ⟨(-1378), (-1375)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨74358, 74359⟩, ⟨148675, 148677⟩, ⟨74256, 74259⟩, ⟨(-82), (-79)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-143091219), (-143091217)⟩, ⟨148675, 148677⟩, ⟨74256, 74259⟩, ⟨(-82), (-79)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2081504), (-2081503)⟩, ⟨(-4160846), (-4160844)⟩, ⟨(-2076099), (-2076096)⟩, ⟨4320, 4323⟩, ⟨1076, 1079⟩⟩
...
def j19 : Jet := ⟨⟨1429574261, 1429574263⟩, ⟨(-4160846), (-4160844)⟩, ⟨(-2076099), (-2076096)⟩, ⟨4320, 4323⟩, ⟨1076, 1079⟩⟩
...
def j25 : Jet := ⟨⟨172, 173⟩, ⟨343, 345⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852005), (-852003)⟩, ⟨343, 345⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-12394), (-12393)⟩, ⟨(-24784), (-24781)⟩, ⟨(-12383), (-12379)⟩, ⟨7, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779000, 35779002⟩, ⟨(-24784), (-24781)⟩, ⟨(-12383), (-12379)⟩, ⟨7, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨520466, 520467⟩, ⟨1040571, 1040573⟩, ⟨519563, 519567⟩, ⟨(-722), (-719)⟩, ⟨(-181), (-178)⟩⟩
...
def j33 : Jet := ⟨⟨(-715307417), (-715307415)⟩, ⟨1040571, 1040573⟩, ⟨519563, 519567⟩, ⟨(-722), (-719)⟩, ⟨(-181), (-178)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10405358), (-10405356)⟩, ⟨(-20795579), (-20795576)⟩, ⟨(-10367528), (-10367524)⟩, ⟨30240, 30243⟩, ⟨7532, 7536⟩⟩
...
def j36 : Jet := ⟨⟨4284561938, 4284561940⟩, ⟨(-20795579), (-20795576)⟩, ⟨(-10367528), (-10367524)⟩, ⟨30240, 30243⟩, ⟨7532, 7536⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨172420478, 172420480⟩, ⟨171918639, 171918642⟩, ⟨(-752237), (-752235)⟩, ⟨(-249877), (-249875)⟩, ⟨650, 653⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305397922, 4305397925⟩, ⟨20896705, 20896710⟩, ⟨10519365, 10519372⟩, ⟨71230, 71237⟩, ⟨18076, 18085⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨172839213, 172839216⟩, ⟨173175048, 173175053⟩, ⟨504684, 504690⟩, ⟨169783, 169789⟩, ⟨1168, 1177⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-164889164), (-164889163)⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4130078132, 4130078133⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6955441, 6955442⟩, ⟨13937912, 13937914⟩, ⟨7023115, 7023118⟩, ⟨54362, 54366⟩, ⟨13843, 13848⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301922737, 4301922738⟩, ⟨13937912, 13937914⟩, ⟨7023115, 7023118⟩, ⟨54362, 54366⟩, ⟨13843, 13848⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298443609, 4298443611⟩, ⟨6963319, 6963321⟩, ⟨3503077, 3503080⟩, ⟨21483, 21487⟩, ⟨5453, 5458⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4133420984, 4133420988⟩, ⟨(-158326637), (-158326632)⟩, ⟨3101258, 3101263⟩, ⟨(-113830), (-113824)⟩, ⟨4418, 4425⟩⟩
...
def j47 : Jet := ⟨⟨1226430942, 1226430951⟩, ⟨1226430942, 1226430951⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨350208220, 350208227⟩, ⟨700416440, 700416454⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨350208220, 350208227⟩, ⟨700416440, 700416454⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-350208227), (-350208220)⟩, ⟨(-700416454), (-700416440)⟩, ⟨(-350208227), (-350208220)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-175104114), (-175104110)⟩, ⟨(-350208227), (-350208220)⟩, ⟨(-175104114), (-175104110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4123384626, 4123384631⟩, ⟨(-336217513), (-336217505)⟩, ⟨(-154401303), (-154401297)⟩, ⟨13334889, 13334890⟩, ⟨2875610, 2875611⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3968292041, 3968292050⟩, ⟨(-475572922), (-475572907)⟩, ⟨(-133222372), (-133222357)⟩, ⟨18173008, 18173020⟩, ⟨2177543, 2177556⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 329778327⟩, ⟨164889163, 164889164⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1036029170⟩, ⟨518014583, 518014587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 249910272⟩, ⟨0, 249910274⟩, ⟨62477567, 62477569⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 63⟩, ⟨0, 63⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94623)⟩, ⟨0, 63⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5510), 0⟩, ⟨(-5510), 4⟩, ⟨(-1378), (-1371)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107546, 5113057⟩, ⟨(-5510), 4⟩, ⟨(-1378), (-1371)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 297513⟩, ⟨(-321), 297514⟩, ⟨73895, 74380⟩, ⟨(-162), 2⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142868063)⟩, ⟨(-321), 297514⟩, ⟨73895, 74380⟩, ⟨(-162), 2⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8330343), 0⟩, ⟨(-8330362), 17312⟩, ⟨(-2082605), (-2056617)⟩, ⟨(-15), 8657⟩, ⟨1062, 1083⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423325422, 1431655766⟩, ⟨(-8330362), 17312⟩, ⟨(-2082605), (-2056617)⟩, ⟨(-15), 8657⟩, ⟨1062, 1083⟩⟩
...
def j72 : Jet := ⟨⟨0, 689⟩, ⟨(-1), 689⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851487)⟩, ⟨(-1), 689⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-49586), 0⟩, ⟨(-49587), 41⟩, ⟨(-12398), (-12334)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35741808, 35791395⟩, ⟨(-49587), 41⟩, ⟨(-12398), (-12334)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2082586⟩, ⟨(-2886), 2082589⟩, ⟨516317, 520650⟩, ⟨(-1445), 3⟩, ⟨(-182), (-176)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713745296)⟩, ⟨(-2886), 2082589⟩, ⟨516317, 520650⟩, ⟨(-1445), 3⟩, ⟨(-182), (-176)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-41651713), 0⟩, ⟨(-41651881), 121180⟩, ⟨(-10413097), (-10231158)⟩, ⟨(-127), 60591⟩, ⟨7414, 7575⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4253315583, 4294967296⟩, ⟨(-41651881), 121180⟩, ⟨(-10413097), (-10231158)⟩, ⟨(-127), 60591⟩, ⟨7414, 7575⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 345343057⟩, ⟨169657362, 172675706⟩, ⟨(-1507088), 2088⟩, ⟨(-251187), (-245958)⟩, ⟨(-2), 1307⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4337026895⟩, ⟨(-123566), 42471651⟩, ⟨10229959, 11033960⟩, ⟨(-62403), 212166⟩, ⟨15513, 21608⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 348724920⟩, ⟨169647426, 177781674⟩, ⟨(-1526815), 2596850⟩, ⟨130529, 214758⟩, ⟨(-8868), 11602⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-329778327), 0⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3965188969, 4294967296⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 28314319⟩, ⟨0, 28869558⟩, ⟨6452987, 7780619⟩, ⟨(-126400), 249860⟩, ⟨7944, 21237⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4323281615⟩, ⟨0, 28869558⟩, ⟨6452987, 7780619⟩, ⟨(-126400), 249860⟩, ⟨7944, 21237⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309101200⟩, ⟨0, 14434779⟩, ⟨3191733, 3890310⟩, ⟨(-76275), 124930⟩, ⟨1784, 9690⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3965188969, 4309101200⟩, ⟨(-165431783), (-150454384)⟩, ⟨2392493, 3890310⟩, ⟨(-225629), 2396⟩, ⟨(-3150), 12619⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2452861893⟩, ⟨1226430942, 1226430951⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1400832894⟩, ⟨0, 1400832900⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1400832894⟩, ⟨0, 1400832900⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1400832894), 0⟩, ⟨(-1400832900), 0⟩, ⟨(-350208227), (-350208220)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-700416447), 0⟩, ⟨(-700416450), 0⟩, ⟨(-175104114), (-175104110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3648680255, 4294967296⟩, ⟨(-700416450), 0⟩, ⟨(-175104114), (-91643842)⟩, ⟨0, 28555701⟩, ⟨703936, 3569463⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3368525462, 4309101200⟩, ⟨(-868153168), (-127814696)⟩, ⟨(-173647867), (-53738535)⟩, ⟨2350264, 35396658⟩, ⟨(-612159), 3579576⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298443609, 4298443611⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2404
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309101200⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2405
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (301340639 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(30713 / 400000), prawitzNormalCorrection
