...
namespace FiniteNormalPanel108_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (52437 / 200000)
def radius : Rat := (7491 / 200000)

def j0 : Jet := ⟨⟨1126076000, 1126076001⟩, ⟨160868000, 160868001⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3537672088, 3537672093⟩, ⟨505381726, 505381731⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2913904330, 2913904339⟩, ⟨832544092, 832544104⟩, ⟨59467435, 59467437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨729, 731⟩, ⟨208, 209⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93958), (-93955)⟩, ⟨208, 209⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-63746), (-63743)⟩, ⟨(-18072), (-18070)⟩, ⟨(-1252), (-1248)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5049310, 5049314⟩, ⟨(-18072), (-18070)⟩, ⟨(-1252), (-1248)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3425685, 3425689⟩, ⟨966506, 966510⟩, ⟨65557, 65565⟩, ⟨(-492), (-486)⟩, ⟨(-18), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-139739892), (-139739887)⟩, ⟨966506, 966510⟩, ⟨65557, 65565⟩, ⟨(-492), (-486)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-94806002), (-94805998)⟩, ⟨(-26431708), (-26431701)⟩, ⟨(-1702992), (-1702982)⟩, ⟨25755, 25764⟩, ⟨798, 805⟩⟩
...
def j19 : Jet := ⟨⟨1336849763, 1336849768⟩, ⟨(-26431708), (-26431701)⟩, ⟨(-1702992), (-1702982)⟩, ⟨25755, 25764⟩, ⟨798, 805⟩⟩
...
def j22 : Jet := ⟨⟨(-74), (-72)⟩, ⟨(-21), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11761, 11764⟩, ⟨(-21), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7979, 7982⟩, ⟨2264, 2268⟩, ⟨155, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844198), (-844194)⟩, ⟨2264, 2268⟩, ⟨155, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-572743), (-572740)⟩, ⟨(-162105), (-162101)⟩, ⟨(-11146), (-11139)⟩, ⟨59, 64⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35218651, 35218655⟩, ⟨(-162105), (-162101)⟩, ⟨(-11146), (-11139)⟩, ⟨59, 64⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23893960, 23893964⟩, ⟨6716865, 6716871⟩, ⟨448646, 448654⟩, ⟨(-4366), (-4359)⟩, ⟨(-144), (-138)⟩⟩
...
def j33 : Jet := ⟨⟨(-691933923), (-691933918)⟩, ⟨6716865, 6716871⟩, ⟨448646, 448654⟩, ⟨(-4366), (-4359)⟩, ⟨(-144), (-138)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-469439957), (-469439951)⟩, ⟨(-129568673), (-129568664)⟩, ⟨(-7974017), (-7974008)⟩, ⟨177003, 177012⟩, ⟨5266, 5275⟩⟩
...
def j36 : Jet := ⟨⟨3825527339, 3825527345⟩, ⟨(-129568673), (-129568664)⟩, ⟨(-7974017), (-7974008)⟩, ⟨177003, 177012⟩, ⟨5266, 5275⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1101134366, 1101134373⟩, ⟨135533680, 135533689⟩, ⟨(-4512894), (-4512883)⟩, ⟨(-179176), (-179165)⟩, ⟨3687, 3696⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4822013387, 4822013396⟩, ⟨163319138, 163319152⟩, ⟨15582639, 15582654⟩, ⟨645080, 645095⟩, ⟨40120, 40137⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1236257295, 1236257306⟩, ⟨194036759, 194036774⟩, ⟨4082123, 4082141⟩, ⟨284345, 284367⟩, ⟨11592, 11613⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1126076001), (-1126076000)⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3168891295, 3168891296⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨355842546, 355842553⟩, ⟨111702530, 111702542⟩, ⟨11116119, 11116133⟩, ⟨532530, 532548⟩, ⟨36243, 36262⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4650809842, 4650809849⟩, ⟨111702530, 111702542⟩, ⟨11116119, 11116133⟩, ⟨532530, 532548⟩, ⟨36243, 36262⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4469348517, 4469348521⟩, ⟨53672108, 53672114⟩, ⟨5018927, 5018935⟩, ⟨195603, 195613⟩, ⟨12246, 12258⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3297552375, 3297552380⟩, ⟨(-127799364), (-127799357)⟩, ⟨1692749, 1692758⟩, ⟨(-43667), (-43656)⟩, ⟨1708, 1719⟩⟩
...
def j47 : Jet := ⟨⟨8879307381, 8879307392⟩, ⟨1268472483, 1268472492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨18356856789, 18356856835⟩, ⟨5244816224, 5244816270⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨18356856789, 18356856835⟩, ⟨5244816224, 5244816270⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-18356856835), (-18356856789)⟩, ⟨(-5244816270), (-5244816224)⟩, ⟨(-374629736), (-374629730)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9178428418), (-9178428394)⟩, ⟨(-2622408135), (-2622408112)⟩, ⟨(-187314868), (-187314865)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨506832115, 506832129⟩, ⟨(-309460028), (-309460016)⟩, ⟨72370291, 72370298⟩, ⟨(-5731634), (-5731631)⟩, ⟨(-703230), (-703228)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨389131122, 389131134⟩, ⟨(-252675610), (-252675597)⟩, ⟨64971752, 64971762⟩, ⟨(-6681127), (-6681118)⟩, ⟨(-337504), (-337495)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨965208000, 1286944001⟩, ⟨160868000, 160868001⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3032290361, 4043053820⟩, ⟨505381726, 505381731⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2140827671, 3805915870⟩, ⟨713609222, 951478974⟩, ⟨59467435, 59467437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨535, 954⟩, ⟨178, 239⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94152), (-93732)⟩, ⟨178, 239⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-83432), (-46720)⟩, ⟨(-20770), (-15361)⟩, ⟨(-1269), (-1230)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5029624, 5066337⟩, ⟨(-20770), (-15361)⟩, ⟨(-1269), (-1230)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2507017, 4489453⟩, ⟨817267, 1114708⟩, ⟨63912, 66983⟩, ⟨(-569), (-408)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140658560), (-138676123)⟩, ⟨817267, 1114708⟩, ⟨63912, 66983⟩, ⟨(-569), (-408)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-124642311), (-69123152)⟩, ⟨(-30753212), (-22053269)⟩, ⟨(-1779893), (-1613785)⟩, ⟨21428, 30071⟩, ⟨741, 855⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1307013454, 1362532614⟩, ⟨(-30753212), (-22053269)⟩, ⟨(-1779893), (-1613785)⟩, ⟨21428, 30071⟩, ⟨741, 855⟩⟩
...
def j72 : Jet := ⟨⟨5851, 10442⟩, ⟨1928, 2603⟩, ⟨154, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846326), (-841734)⟩, ⟨1928, 2603⟩, ⟨154, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-749959), (-419562)⟩, ⟨(-186529), (-137547)⟩, ⟨(-11323), (-10933)⟩, ⟨49, 73⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35041435, 35371833⟩, ⟨(-186529), (-137547)⟩, ⟨(-11323), (-10933)⟩, ⟨49, 73⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17466413, 31344179⟩, ⟨5656847, 7767485⟩, ⟨433821, 461451⟩, ⟨(-5068), (-3655)⟩, ⟨(-149), (-131)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698361470), (-684483703)⟩, ⟨5656847, 7767485⟩, ⟨433821, 461451⟩, ⟨(-5068), (-3655)⟩, ⟨(-149), (-131)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-618841733), (-341181096)⟩, ⟨(-151890779), (-106843999)⟩, ⟨(-8513280), (-7347586)⟩, ⟨145911, 207954⟩, ⟨4750, 5718⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3676125563, 3953786200⟩, ⟨(-151890779), (-106843999)⟩, ⟨(-8513280), (-7347586)⟩, ⟨145911, 207954⟩, ⟨4750, 5718⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨922764720, 1282615748⟩, ⟨124844680, 144757139⟩, ⟨(-5294177), (-3734319)⟩, ⟨(-194310), (-161583)⟩, ⟨3044, 4344⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4665589675, 5017985311⟩, ⟨126079213, 207333968⟩, ⟨12077441, 20187460⟩, ⟨296744, 1129078⟩, ⟨12299, 82372⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1002392161, 1498532245⟩, ⟨162705661, 231042275⟩, ⟨74237, 8960029⟩, ⟨(-67774), 732430⟩, ⟨(-19693), 52487⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1286944001), (-965208000)⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3008023295, 3329759296⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨233945912, 522844235⟩, ⟨75946970, 161223254⟩, ⟨6198406, 18681008⟩, ⟨(-41670), 1475084⟩, ⟨(-21033), 134121⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4528913208, 4817811531⟩, ⟨75946970, 161223254⟩, ⟨6198406, 18681008⟩, ⟨(-41670), 1475084⟩, ⟨(-21033), 134121⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4410389338, 4548883706⟩, ⟨35853824, 78501982⟩, ⟨2248835, 8950324⟩, ⟨(-179601), 699960⟩, ⟨(-31783), 67930⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3088860276, 3526613072⟩, ⟨(-145267857), (-104330900)⟩, ⟨(-1365298), 5596014⟩, ⟨(-474475), 458428⟩, ⟨(-50859), 59392⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7610834898, 10147779875⟩, ⟨1268472483, 1268472492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13486670293, 23976302797⟩, ⟨4495556764, 5994075736⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13486670293, 23976302797⟩, ⟨4495556764, 5994075736⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23976302797), (-13486670293)⟩, ⟨(-5994075736), (-4495556764)⟩, ⟨(-374629736), (-374629730)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11988151399), (-6743335146)⟩, ⟨(-2997037868), (-2247778382)⟩, ⟨(-187314868), (-187314865)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨263483356, 893498059⟩, ⟨(-623484962), (-137894458)⟩, ⟨(-2884162), 206043402⟩, ⟨(-43916557), 18798743⟩, ⟨(-7772500), 7724162⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨189492309, 733654466⟩, ⟨(-542166356), (-105571506)⟩, ⟨697428, 191435151⟩, ⟨(-43940071), 15826832⟩, ⟨(-7160483), 8177413⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1126076000, 1126076001⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4469348517, 4469348521⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2180
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨965208000, 1286944001⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4410389338, 4548883706⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2181
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (30894673 / 4294967296)

theorem envelope_integral : (∫ s in ((22473 / 100000) : ℝ)..(7491 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((22473 / 100000) : ℝ)..(7491 / 25000), prawitzNormalCorrection
