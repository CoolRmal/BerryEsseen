...
namespace FiniteNormalPanel32_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38141 / 160000)
def radius : Rat := (38141 / 800000)

def j0 : Jet := ⟨⟨1023839672, 1023839673⟩, ⟨204767934, 204767935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3216487191, 3216487196⟩, ⟨643297437, 643297441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2408816909, 2408816918⟩, ⟨963526762, 963526770⟩, ⟨96352676, 96352678⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨602, 604⟩, ⟨241, 242⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94085), (-94082)⟩, ⟨241, 242⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-52768), (-52765)⟩, ⟨(-20972), (-20970)⟩, ⟨(-2044), (-2040)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5060288, 5060292⟩, ⟨(-20972), (-20970)⟩, ⟨(-2044), (-2040)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2838044, 2838047⟩, ⟨1123454, 1123459⟩, ⟨107669, 107674⟩, ⟨(-925), (-920)⟩, ⟨(-44), (-41)⟩⟩
...
def j16 : Jet := ⟨⟨(-140327533), (-140327529)⟩, ⟨1123454, 1123459⟩, ⟨107669, 107674⟩, ⟨(-925), (-920)⟩, ⟨(-44), (-41)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-78702191), (-78702188)⟩, ⟨(-30850792), (-30850787)⟩, ⟨(-2835669), (-2835662)⟩, ⟨48838, 48845⟩, ⟨2182, 2188⟩⟩
...
def j19 : Jet := ⟨⟨1352953574, 1352953578⟩, ⟨(-30850792), (-30850787)⟩, ⟨(-2835669), (-2835662)⟩, ⟨48838, 48845⟩, ⟨2182, 2188⟩⟩
...
def j25 : Jet := ⟨⟨6603, 6605⟩, ⟨2626, 2629⟩, ⟨256, 259⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845574), (-845571)⟩, ⟨2626, 2629⟩, ⟨256, 259⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-474238), (-474235)⟩, ⟨(-188223), (-188219)⟩, ⟨(-18238), (-18233)⟩, ⟨113, 118⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35317156, 35317160⟩, ⟨(-188223), (-188219)⟩, ⟨(-18238), (-18233)⟩, ⟨113, 118⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19807499, 19807502⟩, ⟨7817434, 7817440⟩, ⟨739844, 739852⟩, ⟨(-8252), (-8245)⟩, ⟨(-384), (-378)⟩⟩
...
def j33 : Jet := ⟨⟨(-696020384), (-696020380)⟩, ⟨7817434, 7817440⟩, ⟨739844, 739852⟩, ⟨(-8252), (-8245)⟩, ⟨(-384), (-378)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-390360523), (-390360518)⟩, ⟨(-151759831), (-151759823)⟩, ⟨(-13445733), (-13445722)⟩, ⟨336721, 336730⟩, ⟨14529, 14538⟩⟩
...
def j36 : Jet := ⟨⟨3904606773, 3904606778⟩, ⟨(-151759831), (-151759823)⟩, ⟨(-13445733), (-13445722)⟩, ⟨336721, 336730⟩, ⟨14529, 14538⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1013222579, 1013222584⟩, ⟨179540456, 179540463⟩, ⟨(-6744436), (-6744429)⟩, ⟨(-388151), (-388143)⟩, ⟨8948, 8955⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4724353852, 4724353859⟩, ⟨183620821, 183620833⟩, ⟨23405330, 23405346⟩, ⟨1134572, 1134590⟩, ⟨91267, 91284⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1114518845, 1114518854⟩, ⟨240807748, 240807762⟩, ⟨5778640, 5778655⟩, ⟨530758, 530776⟩, ⟨25450, 25468⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1023839673), (-1023839672)⟩, ⟨(-204767935), (-204767934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3271127623, 3271127624⟩, ⟨(-204767935), (-204767934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨289211109, 289211114⟩, ⟨124976398, 124976408⟩, ⟨16500515, 16500528⟩, ⟨923442, 923458⟩, ⟨80498, 80513⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4584178405, 4584178410⟩, ⟨124976398, 124976408⟩, ⟨16500515, 16500528⟩, ⟨923442, 923458⟩, ⟨80498, 80513⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4437217182, 4437217186⟩, ⟨60484930, 60484935⟩, ⟨7573524, 7573532⟩, ⟨343681, 343690⟩, ⟨27809, 27820⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3379467803, 3379467808⟩, ⟨(-165483421), (-165483414)⟩, ⟨2884442, 2884450⟩, ⟨(-99325), (-99316)⟩, ⟨4793, 4804⟩⟩
...
def j47 : Jet := ⟨⟨5128371963, 5128371969⟩, ⟨1025674390, 1025674396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6123492259, 6123492274⟩, ⟨2449396896, 2449396916⟩, ⟨244939689, 244939692⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6123492259, 6123492274⟩, ⟨2449396896, 2449396916⟩, ⟨244939689, 244939692⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6123492274), (-6123492259)⟩, ⟨(-2449396916), (-2449396896)⟩, ⟨(-244939692), (-244939689)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3061746137), (-3061746129)⟩, ⟨(-1224698458), (-1224698448)⟩, ⟨(-122469846), (-122469844)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2105547681, 2105547695⟩, ⟨(-600391304), (-600391295)⟩, ⟨25560856, 25560860⟩, ⟨8983794, 8983796⟩, ⟨(-1004858), (-1004856)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1656736851, 1656736866⟩, ⟨(-553540030), (-553540016)⟩, ⟨44659296, 44659307⟩, ⟨5632081, 5632092⟩, ⟨(-1103412), (-1103398)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨819071738, 1228607608⟩, ⟨204767934, 204767935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2573189754, 3859784636⟩, ⟨643297437, 643297441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1541642823, 3468696363⟩, ⟨770821410, 1156232124⟩, ⟨96352676, 96352678⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨385, 869⟩, ⟨192, 290⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94302), (-93817)⟩, ⟨192, 290⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-76161), (-33674)⟩, ⟨(-25319), (-16602)⟩, ⟨(-2074), (-2004)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5036895, 5079383⟩, ⟨(-25319), (-16602)⟩, ⟨(-2074), (-2004)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1807951, 4102206⟩, ⟨883526, 1361443⟩, ⟨104503, 110253⟩, ⟨(-1126), (-719)⟩, ⟨(-46), (-39)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141357626), (-139063370)⟩, ⟨883526, 1361443⟩, ⟨104503, 110253⟩, ⟨(-1126), (-719)⟩, ⟨(-46), (-39)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-114163078), (-49915641)⟩, ⟨(-37737226), (-23858293)⟩, ⟨(-2975120), (-2664175)⟩, ⟨37665, 59966⟩, ⟨2002, 2332⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1317492687, 1381740125⟩, ⟨(-37737226), (-23858293)⟩, ⟨(-2975120), (-2664175)⟩, ⟨37665, 59966⟩, ⟨2002, 2332⟩⟩
...
def j72 : Jet := ⟨⟨4216, 9529⟩, ⟨2083, 3171⟩, ⟨251, 262⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847961), (-842647)⟩, ⟨2083, 3171⟩, ⟨251, 262⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-684830), (-302461)⟩, ⟨(-227530), (-148669)⟩, ⟨(-18561), (-17837)⟩, ⟨89, 143⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35106564, 35488934⟩, ⟨(-227530), (-148669)⟩, ⟨(-18561), (-17837)⟩, ⟨89, 143⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12601209, 28661531⟩, ⟨6116846, 9500481⟩, ⟨711331, 763071⟩, ⟨(-10071), (-6420)⟩, ⟨(-401), (-356)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703226674), (-687166351)⟩, ⟨6116846, 9500481⟩, ⟨711331, 763071⟩, ⟨(-10071), (-6420)⟩, ⟨(-401), (-356)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-567939088), (-246652651)⟩, ⟨(-187117439), (-115653557)⟩, ⟨(-14422965), (-12241929)⟩, ⟨256753, 416253⟩, ⟨12921, 15840⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3727028208, 4048314645⟩, ⟨(-187117439), (-115653557)⟩, ⟨(-14422965), (-12241929)⟩, ⟨256753, 416253⟩, ⟨12921, 15840⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨789332828, 1241736884⟩, ⟨163419661, 192662229⟩, ⟨(-8325928), (-5169632)⟩, ⟨(-423047), (-345147)⟩, ⟨6840, 11078⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4556647813, 4949451157⟩, ⟨130175782, 248489836⟩, ⟨17498008, 31629100⟩, ⟨384623, 2235666⟩, ⟨18984, 209880⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨837424701, 1430957592⟩, ⟨197300188, 293862841⟩, ⟨(-1425796), 14806502⟩, ⟨(-232750), 1542312⟩, ⟨(-60412), 142212⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1228607608), (-819071738)⟩, ⟨(-204767935), (-204767934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3066359688, 3475895558⟩, ⟨(-204767935), (-204767934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨163279504, 476753254⟩, ⟨76938444, 195813024⟩, ⟨8113415, 29972365⟩, ⟨(-350200), 3053838⟩, ⟨(-77022), 356859⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4458246800, 4771720550⟩, ⟨76938444, 195813024⟩, ⟨8113415, 29972365⟩, ⟨(-350200), 3053838⟩, ⟨(-77022), 356859⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4375845541, 4527072311⟩, ⟨36496887, 96096918⟩, ⟨2828785, 14556994⟩, ⟨(-491547), 1475105⟩, ⟨(-94408), 185014⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3124102104, 3663736987⟩, ⟨(-189777154), (-130853149)⟩, ⟨(-2561952), 10040869⟩, ⟨(-1091830), 1058931⟩, ⟨(-146732), 173167⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4102697572, 6154046365⟩, ⟨1025674390, 1025674396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3919035048, 8817828881⟩, ⟨1959517518, 2939276300⟩, ⟨244939689, 244939692⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3919035048, 8817828881⟩, ⟨1959517518, 2939276300⟩, ⟨244939689, 244939692⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8817828881), (-3919035048)⟩, ⟨(-2939276300), (-1959517518)⟩, ⟨(-244939692), (-244939689)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4408914441), (-1959517524)⟩, ⟨(-1469638150), (-979758759)⟩, ⟨(-122469846), (-122469844)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1538662529, 2721568086⟩, ⟨(-931257449), (-350996407)⟩, ⟨(-37570513), 115452795⟩, ⟨(-6496044), 21988292⟩, ⟨(-3527024), 1091356⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1119202665, 2321579880⟩, ⟨(-914645803), (-302187970)⟩, ⟨(-22978527), 145995751⟩, ⟨(-13511681), 21643271⟩, ⟨(-4390650), 1834370⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1023839672, 1023839673⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4437217182, 4437217186⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified634
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨819071738, 1228607608⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4375845541, 4527072311⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified635
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (39857111 / 1073741824)

theorem envelope_integral : (∫ s in ((38141 / 200000) : ℝ)..(114423 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((38141 / 200000) : ℝ)..(114423 / 400000), prawitzNormalCorrection
