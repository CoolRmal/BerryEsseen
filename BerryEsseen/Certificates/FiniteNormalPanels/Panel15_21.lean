...
namespace FiniteNormalPanel15_21
...
def j2 : Jet := ⟨⟨1979833421, 1979833425⟩, ⟨659944472, 659944476⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨912635674, 912635679⟩, ⟨608423780, 608423788⟩, ⟨101403963, 101403965⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨228, 229⟩, ⟨152, 153⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94459), (-94457)⟩, ⟨152, 153⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-20072), (-20071)⟩, ⟨(-13350), (-13347)⟩, ⟨(-2205), (-2202)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5092984, 5092986⟩, ⟨(-13350), (-13347)⟩, ⟨(-2205), (-2202)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1082205, 1082207⟩, ⟨718633, 718635⟩, ⟨117884, 117889⟩, ⟨(-628), (-624)⟩, ⟨(-53), (-48)⟩⟩
...
def j16 : Jet := ⟨⟨(-142083372), (-142083369)⟩, ⟨718633, 718635⟩, ⟨117884, 117889⟩, ⟨(-628), (-624)⟩, ⟨(-53), (-48)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-30191233), (-30191231)⟩, ⟨(-19974787), (-19974784)⟩, ⟨(-3227732), (-3227728)⟩, ⟨33531, 33536⟩, ⟨2682, 2686⟩⟩
...
def j19 : Jet := ⟨⟨1401464532, 1401464535⟩, ⟨(-19974787), (-19974784)⟩, ⟨(-3227732), (-3227728)⟩, ⟨33531, 33536⟩, ⟨2682, 2686⟩⟩
...
def j22 : Jet := ⟨⟨(-23), (-22)⟩, ⟨(-16), (-15)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11812, 11814⟩, ⟨(-16), (-15)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2509, 2511⟩, ⟨1669, 1671⟩, ⟨274, 277⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849668), (-849665)⟩, ⟨1669, 1671⟩, ⟨274, 277⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-180546), (-180544)⟩, ⟨(-120010), (-120007)⟩, ⟨(-19767), (-19764)⟩, ⟨76, 80⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35610848, 35610851⟩, ⟨(-120010), (-120007)⟩, ⟨(-19767), (-19764)⟩, ⟨76, 80⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7566933, 7566934⟩, ⟨5019121, 5019123⟩, ⟨819568, 819572⟩, ⟨(-5619), (-5615)⟩, ⟨(-457), (-452)⟩⟩
...
def j33 : Jet := ⟨⟨(-708260950), (-708260948)⟩, ⟨5019121, 5019123⟩, ⟨819568, 819572⟩, ⟨(-5619), (-5615)⟩, ⟨(-457), (-452)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-150498053), (-150498051)⟩, ⟨(-99265526), (-99265521)⟩, ⟨(-15836850), (-15836846)⟩, ⟨233406, 233410⟩, ⟨18455, 18460⟩⟩
...
def j36 : Jet := ⟨⟨4144469243, 4144469245⟩, ⟨(-99265526), (-99265521)⟩, ⟨(-15836850), (-15836846)⟩, ⟨233406, 233410⟩, ⟨18455, 18460⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨646027344, 646027348⟩, ⟨206134751, 206134756⟩, ⟨(-4557107), (-4557103)⟩, ⟨(-480503), (-480498)⟩, ⟨6388, 6392⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4450930380, 4450930383⟩, ⟨106605670, 106605677⟩, ⟨19561241, 19561249⟩, ⟨625208, 625216⟩, ⟨63890, 63902⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨669486525, 669486530⟩, ⟨229655206, 229655214⟩, ⟨3336197, 3336205⟩, ⟨421806, 421817⟩, ⟨13552, 13563⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-630200552), (-630200551)⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3664766744, 3664766745⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨104357536, 104357539⟩, ⟨71595918, 71595924⟩, ⟨13319912, 13319918⟩, ⟨488276, 488284⟩, ⟨51923, 51932⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4399324832, 4399324835⟩, ⟨71595918, 71595924⟩, ⟨13319912, 13319918⟩, ⟨488276, 488284⟩, ⟨51923, 51932⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4346832902, 4346832904⟩, ⟨35370824, 35370828⟩, ⟨6436581, 6436585⟩, ⟨188849, 188855⟩, ⟨19348, 19355⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3709022109, 3709022113⟩, ⟨(-182422736), (-182422729)⟩, ⟨3762153, 3762159⟩, ⟨(-153675), (-153668)⟩, ⟨7272, 7280⟩⟩
...
def j47 : Jet := ⟨⟨3020518668, 3020518675⟩, ⟨1006839554, 1006839560⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2124238066, 2124238077⟩, ⟨1416158708, 1416158720⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2124238066, 2124238077⟩, ⟨1416158708, 1416158720⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2124238077), (-2124238066)⟩, ⟨(-1416158720), (-1416158708)⟩, ⟨(-236026454), (-236026450)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1062119039), (-1062119033)⟩, ⟨(-708079360), (-708079354)⟩, ⟨(-118013227), (-118013225)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3353987985, 3353987993⟩, ⟨(-552947091), (-552947084)⟩, ⟨(-46577710), (-46577706)⟩, ⟨12688559, 12688561⟩, ⟨116942, 116944⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2896416836, 2896416847⟩, ⟨(-619966690), (-619966675)⟩, ⟨(-13799739), (-13799727)⟩, ⟨12331472, 12331485⟩, ⟨(-453280), (-453266)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨420133700, 840267402⟩, ⟨210066850, 210066851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1319888945, 2639777898⟩, ⟨659944472, 659944476⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨405615853, 1622463426⟩, ⟨405615852, 811231716⟩, ⟨101403963, 101403965⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨101, 407⟩, ⟨101, 204⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94586), (-94279)⟩, ⟨101, 204⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-35731), (-8903)⟩, ⟨(-17857), (-8825)⟩, ⟨(-2223), (-2176)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5077325, 5104154⟩, ⟨(-17857), (-8825)⟩, ⟨(-2223), (-2176)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨479501, 1928142⟩, ⟨472755, 963238⟩, ⟨115662, 119471⟩, ⟨(-842), (-409)⟩, ⟨(-53), (-48)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142686076), (-141237434)⟩, ⟨472755, 963238⟩, ⟨115662, 119471⟩, ⟨(-842), (-409)⟩, ⟨(-53), (-48)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-53900979), (-13338435)⟩, ⟨(-26905844), (-12974562)⟩, ⟨(-3313243), (-3107539)⟩, ⟨21765, 45271⟩, ⟨2549, 2779⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1377754786, 1418317331⟩, ⟨(-26905844), (-12974562)⟩, ⟨(-3313243), (-3107539)⟩, ⟨21765, 45271⟩, ⟨2549, 2779⟩⟩
...
def j70 : Jet := ⟨⟨(-41), (-10)⟩, ⟨(-21), (-10)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11794, 11826⟩, ⟨(-21), (-10)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1113, 4468⟩, ⟨1105, 2234⟩, ⟨272, 280⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851064), (-847708)⟩, ⟨1105, 2234⟩, ⟨272, 280⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-321498), (-80057)⟩, ⟨(-160645), (-79213)⟩, ⟨(-19965), (-19486)⟩, ⟨50, 106⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35469896, 35711338⟩, ⟨(-160645), (-79213)⟩, ⟨(-19965), (-19486)⟩, ⟨50, 106⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3349769, 13490287⟩, ⟨3289083, 6737664⟩, ⟨799557, 833823⟩, ⟨(-7560), (-3669)⟩, ⟨(-468), (-436)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712478114), (-702337595)⟩, ⟨3289083, 6737664⟩, ⟨799557, 833823⟩, ⟨(-7560), (-3669)⟩, ⟨(-468), (-436)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-269145166), (-66328622)⟩, ⟨(-134261964), (-63783406)⟩, ⟨(-16435443), (-14994562)⟩, ⟨150309, 316223⟩, ⟨17272, 19300⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4025822130, 4228638674⟩, ⟨(-134261964), (-63783406)⟩, ⟨(-16435443), (-14994562)⟩, ⟨150309, 316223⟩, ⟨17272, 19300⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨423398639, 871727882⟩, ⟨195162417, 213944751⟩, ⟨(-6170616), (-2948589)⟩, ⟨(-502410), (-449664)⟩, ⟨4127, 8666⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4362336320, 4582106084⟩, ⟨65800057, 152814145⟩, ⟨16461153, 23802858⟩, ⟨138962, 1254824⟩, ⟨28123, 117855⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨430039889, 930006996⟩, ⟨204710232, 259263884⟩, ⟨(-1970468), 9448423⟩, ⟨6140, 938486⟩, ⟨(-38797), 77486⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-840267402), (-420133700)⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3454699894, 3874833596⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨43058373, 201378254⟩, ⟨40993822, 112278958⟩, ⟨8903717, 19742169⟩, ⟨(-236666), 1547132⟩, ⟨(-20553), 167648⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4338025669, 4496345550⟩, ⟨40993822, 112278958⟩, ⟨8903717, 19742169⟩, ⟨(-236666), 1547132⟩, ⟨(-20553), 167648⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4316442792, 4394503054⟩, ⟨20032654, 55860170⟩, ⟨3995993, 9775488⟩, ⟨(-244252), 751173⟩, ⟨(-31017), 84719⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3471973923, 3964632767⟩, ⟨(-198821680), (-160721287)⟩, ⟨482095, 7839453⟩, ⟨(-698480), 482250⟩, ⟨(-64723), 88379⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2013679109, 4027358230⟩, ⟨1006839554, 1006839560⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨944105804, 3776423241⟩, ⟨944105802, 1888211626⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨944105804, 3776423241⟩, ⟨944105802, 1888211626⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3776423241), (-944105804)⟩, ⟨(-1888211626), (-944105802)⟩, ⟨(-236026454), (-236026450)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1888211621), (-472052902)⟩, ⟨(-944105813), (-472052901)⟩, ⟨(-118013227), (-118013225)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2767129257, 3847930842⟩, ⟨(-845839707), (-304130696)⟩, ⟨(-89016708), 16932201⟩, ⟨4330424, 22016601⟩, ⟨(-1442529), 1103974⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2236897270, 3551978782⟩, ⟨(-958912050), (-349402059)⟩, ⟨(-70478829), 61808832⟩, ⟨547152, 24841922⟩, ⟨(-2666211), 1104662⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4346832902, 4346832904⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified312
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4316442792, 4394503054⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified313
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (282899145 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((4891 / 50000) : ℝ)..(4891 / 25000), prawitzNormalCorrection
