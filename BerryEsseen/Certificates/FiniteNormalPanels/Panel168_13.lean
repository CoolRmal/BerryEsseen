...
namespace FiniteNormalPanel168_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (37563 / 400000)
def radius : Rat := (12521 / 400000)

def j0 : Jet := ⟨⟨403329641, 403329642⟩, ⟨134443213, 134443214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1267097437, 1267097441⟩, ⟨422365810, 422365814⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨373817960, 373817963⟩, ⟨249211972, 249211976⟩, ⟨41535328, 41535330⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨93, 94⟩, ⟨62, 63⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94594), (-94592)⟩, ⟨62, 63⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8234), (-8232)⟩, ⟨(-5484), (-5482)⟩, ⟨(-912), (-909)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104822, 5104825⟩, ⟨(-5484), (-5482)⟩, ⟨(-912), (-909)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨444304, 444305⟩, ⟨295725, 295727⟩, ⟨48968, 48971⟩, ⟨(-107), (-104)⟩, ⟨(-9), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-142721273), (-142721271)⟩, ⟨295725, 295727⟩, ⟨48968, 48971⟩, ⟨(-107), (-104)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12421929), (-12421927)⟩, ⟨(-8255548), (-8255546)⟩, ⟨(-1358795), (-1358791)⟩, ⟨5690, 5693⟩, ⟨465, 468⟩⟩
...
def j19 : Jet := ⟨⟨1419233836, 1419233839⟩, ⟨(-8255548), (-8255546)⟩, ⟨(-1358795), (-1358791)⟩, ⟨5690, 5693⟩, ⟨465, 468⟩⟩
...
def j25 : Jet := ⟨⟨1029, 1030⟩, ⟨685, 687⟩, ⟨112, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851148), (-851146)⟩, ⟨685, 687⟩, ⟨112, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-74081), (-74080)⟩, ⟨(-49329), (-49327)⟩, ⟨(-8184), (-8180)⟩, ⟨11, 14⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35717313, 35717315⟩, ⟨(-49329), (-49327)⟩, ⟨(-8184), (-8180)⟩, ⟨11, 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3108701, 3108703⟩, ⟨2068173, 2068176⟩, ⟨341835, 341839⟩, ⟨(-953), (-949)⟩, ⟨(-81), (-77)⟩⟩
...
def j33 : Jet := ⟨⟨(-712719182), (-712719179)⟩, ⟨2068173, 2068176⟩, ⟨341835, 341839⟩, ⟨(-953), (-949)⟩, ⟨(-81), (-77)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-62032425), (-62032423)⟩, ⟨(-41174944), (-41174941)⟩, ⟨(-6742736), (-6742733)⟩, ⟨39751, 39754⟩, ⟨3241, 3245⟩⟩
...
def j36 : Jet := ⟨⟨4232934871, 4232934873⟩, ⟨(-41174944), (-41174941)⟩, ⟨(-6742736), (-6742733)⟩, ⟨39751, 39754⟩, ⟨3241, 3245⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨418701105, 418701108⟩, ⟨137131489, 137131494⟩, ⟨(-1212720), (-1212716)⟩, ⟨(-131946), (-131943)⟩, ⟨696, 699⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4357908786, 4357908789⟩, ⟨42390596, 42390601⟩, ⟨7354150, 7354156⟩, ⟨98131, 98138⟩, ⟨8927, 8937⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨424837047, 424837051⟩, ⟨143273618, 143273627⟩, ⟨839900, 839909⟩, ⟨98522, 98530⟩, ⟨1329, 1338⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-403329642), (-403329641)⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3891637654, 3891637655⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨42022791, 42022793⟩, ⟨28343842, 28343846⟩, ⟨4945547, 4945552⟩, ⟨75524, 75532⟩, ⟨6998, 7005⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4336990087, 4336990089⟩, ⟨28343842, 28343846⟩, ⟨4945547, 4945552⟩, ⟨75524, 75532⟩, ⟨6998, 7005⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4315927546, 4315927548⟩, ⟨14103095, 14103098⟩, ⟨2437721, 2437725⟩, ⟨29612, 29618⟩, ⟨2695, 2701⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3910629579, 3910629583⟩, ⟨(-122320615), (-122320609)⟩, ⟨1767337, 1767343⟩, ⟨(-49476), (-49469)⟩, ⟨1513, 1522⟩⟩
...
def j47 : Jet := ⟨⟨4844493618, 4844493632⟩, ⟨1614831198, 1614831211⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5464329946, 5464329979⟩, ⟨3642886612, 3642886654⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5464329946, 5464329979⟩, ⟨3642886612, 3642886654⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5464329979), (-5464329946)⟩, ⟨(-3642886654), (-3642886612)⟩, ⟨(-607147776), (-607147765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2732164990), (-2732164973)⟩, ⟨(-1821443327), (-1821443306)⟩, ⟨(-303573888), (-303573882)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2273481154, 2273481174⟩, ⟨(-964155680), (-964155660)⟩, ⟨43750721, 43750733⟩, ⟨39247133, 39247138⟩, ⟨(-5707238), (-5707236)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2070037333, 2070037354⟩, ⟨(-942626350), (-942626325)⟩, ⟨68230315, 68230334⟩, ⟨34066126, 34066141⟩, ⟨(-6284375), (-6284360)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨268886427, 537772856⟩, ⟨134443213, 134443214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨844731623, 1689463254⟩, ⟨422365810, 422365814⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨166141315, 664565267⟩, ⟨166141314, 332282634⟩, ⟨41535328, 41535330⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨41, 167⟩, ⟨41, 84⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94646), (-94519)⟩, ⟨41, 84⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-14645), (-3656)⟩, ⟨(-7322), (-3643)⟩, ⟨(-915), (-905)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5098411, 5109401⟩, ⟨(-7322), (-3643)⟩, ⟨(-915), (-905)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨197220, 790584⟩, ⟨196087, 395152⟩, ⟨48596, 49237⟩, ⟨(-142), (-69)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142968357), (-142374992)⟩, ⟨196087, 395152⟩, ⟨48596, 49237⟩, ⟨(-142), (-69)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-22121660), (-5507461)⟩, ⟨(-11053245), (-5446318)⟩, ⟨(-1373140), (-1338674)⟩, ⟨3753, 7630⟩, ⟨456, 475⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1409534105, 1426148305⟩, ⟨(-11053245), (-5446318)⟩, ⟨(-1373140), (-1338674)⟩, ⟨3753, 7630⟩, ⟨456, 475⟩⟩
...
def j72 : Jet := ⟨⟨457, 1831⟩, ⟨455, 916⟩, ⟨112, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851720), (-850345)⟩, ⟨455, 916⟩, ⟨112, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-131788), (-32893)⟩, ⟨(-65877), (-32751)⟩, ⟨(-8216), (-8134)⟩, ⟨7, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35659606, 35758502⟩, ⟨(-65877), (-32751)⟩, ⟨(-8216), (-8134)⟩, ⟨7, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1379413, 5532955⟩, ⟨1369219, 2765212⟩, ⟨338484, 344230⟩, ⟨(-1274), (-627)⟩, ⟨(-81), (-75)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714448470), (-710294927)⟩, ⟨1369219, 2765212⟩, ⟨338484, 344230⟩, ⟨(-1274), (-627)⟩, ⟨(-81), (-75)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-110547440), (-27476189)⟩, ⟨(-55220755), (-27048323)⟩, ⟨(-6843158), (-6601850)⟩, ⟨26136, 53350⟩, ⟨3161, 3303⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4184419856, 4267491107⟩, ⟨(-55220755), (-27048323)⟩, ⟨(-6843158), (-6601850)⟩, ⟨26136, 53350⟩, ⟨3161, 3303⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨277226332, 560988010⟩, ⟨134265273, 139175825⟩, ⟨(-1627110), (-798878)⟩, ⟨(-134297), (-128642)⟩, ⟨458, 938⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4322620390, 4408435270⟩, ⟨27397744, 58177032⟩, ⟨6860787, 7977260⟩, ⟨30756, 173419⟩, ⟨6666, 11901⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨279011250, 575808653⟩, ⟨136898174, 150451492⟩, ⟨(-370774), 2123123⟩, ⟨56575, 146585⟩, ⟨(-2992), 6042⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-537772856), (-268886427)⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3757194440, 4026080869⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨18125231, 77196305⟩, ⟨17786458, 40340830⟩, ⟨4264086, 5839552⟩, ⟨(-18628), 188052⟩, ⟨2618, 12942⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4313092527, 4372163601⟩, ⟨17786458, 40340830⟩, ⟨4264086, 5839552⟩, ⟨(-18628), 188052⟩, ⟨2618, 12942⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304020370, 4333393553⟩, ⟨8814368, 20127989⟩, ⟨2066390, 2904610⟩, ⟨(-22879), 89598⟩, ⟨(-94), 6070⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3765113978, 4062101451⟩, ⟨(-127935332), (-115858719)⟩, ⟨1177600, 2446856⟩, ⟨(-112369), 19306⟩, ⟨(-2894), 6407⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3229662408, 6459324842⟩, ⟨1614831198, 1614831211⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2428591081, 9714364404⟩, ⟨2428591072, 4857182204⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2428591081, 9714364404⟩, ⟨2428591072, 4857182204⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9714364404), (-2428591081)⟩, ⟨(-4857182204), (-2428591072)⟩, ⟨(-607147776), (-607147765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4857182202), (-1214295540)⟩, ⟨(-2428591102), (-1214295536)⟩, ⟨(-303573888), (-303573882)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1386167962, 3237232278⟩, ⟨(-1830494382), (-391904629)⟩, ⟨(-173411139), 419550761⟩, ⟨(-60611500), 118939621⟩, ⟨(-31640813), 14696663⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1215161841, 3061715033⟩, ⟨(-1827676379), (-380949405)⟩, ⟨(-153057214), 453173116⟩, ⟨(-70950053), 117563461⟩, ⟨(-33577393), 15997028⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨403329641, 403329642⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4315927546, 4315927548⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3406
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨268886427, 537772856⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304020370, 4333393553⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3407
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (131218841 / 4294967296)

theorem envelope_integral : (∫ s in ((12521 / 200000) : ℝ)..(12521 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((12521 / 200000) : ℝ)..(12521 / 100000), prawitzNormalCorrection
