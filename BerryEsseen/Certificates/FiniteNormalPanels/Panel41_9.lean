...
namespace FiniteNormalPanel41_9
...
def j46 : Jet := ⟨⟨27331564936, 27331564942⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value270

def j47 : Jet := ⟨⟨8241150111, 8241150120⟩, ⟨1177307157, 1177307165⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15813055250, 15813055286⟩, ⟨4518015778, 4518015816⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15813055250, 15813055286⟩, ⟨4518015778, 4518015816⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15813055286), (-15813055250)⟩, ⟨(-4518015816), (-4518015778)⟩, ⟨(-322715417), (-322715412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7906527643), (-7906527625)⟩, ⟨(-2259007908), (-2259007889)⟩, ⟨(-161357709), (-161357706)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨681514340, 681514349⟩, ⟨(-358453557), (-358453549)⟩, ⟨68663410, 68663415⟩, ⟨(-3060382), (-3060379)⟩, ⟨(-887395), (-887393)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨502236276, 502236285⟩, ⟨(-286857049), (-286857039)⟩, ⟨62867838, 62867846⟩, ⟨(-4723905), (-4723896)⟩, ⟨(-513816), (-513806)⟩⟩
...
def j89 : Jet := ⟨⟨7063842953, 9418457285⟩, ⟨1177307157, 1177307165⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11617754880, 20653786518⟩, ⟨3872584954, 5163446650⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11617754880, 20653786518⟩, ⟨3872584954, 5163446650⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20653786518), (-11617754880)⟩, ⟨(-5163446650), (-3872584954)⟩, ⟨(-322715417), (-322715412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10326893259), (-5808877440)⟩, ⟨(-2581723325), (-1936292477)⟩, ⟨(-161357709), (-161357706)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨387913357, 1110665377⟩, ⟨(-667625738), (-174882289)⟩, ⟨(-2305674), 186082829⟩, ⟨(-32904960), 17183347⟩, ⟨(-6077721), 4988140⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨263166799, 892315626⟩, ⟨(-580538912), (-127922552)⟩, ⟨1304649, 178665238⟩, ⟨(-35704938), 14824882⟩, ⟨(-5967181), 5980091⟩⟩
...
theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar270 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified808
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar270 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified809
    (by decide +kernel) (by decide +kernel)
