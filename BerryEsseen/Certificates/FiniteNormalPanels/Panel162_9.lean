...
namespace FiniteNormalPanel162_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3273 / 20000)
def radius : Rat := (3273 / 100000)

def j0 : Jet := ⟨⟨702871397, 702871398⟩, ⟨140574279, 140574280⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2208135617, 2208135621⟩, ⟨441627122, 441627126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1135250298, 1135250303⟩, ⟨454100116, 454100124⟩, ⟨45410011, 45410013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-24953), (-24952)⟩, ⟨(-9953), (-9949)⟩, ⟨(-986), (-981)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5088103, 5088105⟩, ⟨(-9953), (-9949)⟩, ⟨(-986), (-981)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1344892, 1344894⟩, ⟨535326, 535329⟩, ⟨52481, 52486⟩, ⟨(-211), (-206)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141820685), (-141820682)⟩, ⟨535326, 535329⟩, ⟨52481, 52486⟩, ⟨(-211), (-206)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-37486194), (-37486192)⟩, ⟨(-14852981), (-14852977)⟩, ⟨(-1428978), (-1428973)⟩, ⟨11151, 11156⟩, ⟨528, 532⟩⟩
...
def j19 : Jet := ⟨⟨1394169571, 1394169574⟩, ⟨(-14852981), (-14852977)⟩, ⟨(-1428978), (-1428973)⟩, ⟨11151, 11156⟩, ⟨528, 532⟩⟩
...
def j25 : Jet := ⟨⟨3120, 3122⟩, ⟨1244, 1247⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849057), (-849054)⟩, ⟨1244, 1247⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-224424), (-224422)⟩, ⟨(-89442), (-89439)⟩, ⟨(-8815), (-8811)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35566970, 35566973⟩, ⟨(-89442), (-89439)⟩, ⟨(-8815), (-8811)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9401099, 9401100⟩, ⟨3736797, 3736801⟩, ⟨364256, 364261⟩, ⟨(-1872), (-1868)⟩, ⟨(-93), (-89)⟩⟩
...
def j33 : Jet := ⟨⟨(-706426784), (-706426782)⟩, ⟨3736797, 3736801⟩, ⟨364256, 364261⟩, ⟨(-1872), (-1868)⟩, ⟨(-93), (-89)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-186723476), (-186723474)⟩, ⟨(-73701677), (-73701673)⟩, ⟨(-6977575), (-6977569)⟩, ⟨77525, 77529⟩, ⟨3628, 3632⟩⟩
...
def j36 : Jet := ⟨⟨4108243820, 4108243822⟩, ⟨(-73701677), (-73701673)⟩, ⟨(-6977575), (-6977569)⟩, ⟨77525, 77529⟩, ⟨3628, 3632⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨716772742, 716772745⟩, ⟨135718308, 135718314⟩, ⟨(-2261917), (-2261912)⟩, ⟨(-141202), (-141197)⟩, ⟨1417, 1422⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4490177524, 4490177527⟩, ⟨80553542, 80553549⟩, ⟨9071381, 9071392⟩, ⟨214816, 214825⟩, ⟨13768, 13778⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨749350724, 749350729⟩, ⟨155330141, 155330150⟩, ⟨1694610, 1694621⟩, ⟨132455, 132467⟩, ⟨3139, 3151⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-702871398), (-702871397)⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3592095898, 3592095899⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨130740578, 130740580⟩, ⟨54201462, 54201466⟩, ⟨6208932, 6208939⟩, ⟨168790, 168800⟩, ⟨11342, 11351⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4425707874, 4425707876⟩, ⟨54201462, 54201466⟩, ⟨6208932, 6208939⟩, ⟨168790, 168800⟩, ⟨11342, 11351⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4359847540, 4359847542⟩, ⟨26697436, 26697439⟩, ⟨2976526, 2976531⟩, ⟨64911, 64918⟩, ⟨4172, 4179⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3646358490, 3646358493⟩, ⟨(-120369411), (-120369405)⟩, ⟨1615609, 1615615⟩, ⟨(-43134), (-43126)⟩, ⟨1364, 1372⟩⟩
...
def j47 : Jet := ⟨⟨6948478855, 6948478867⟩, ⟨1389695767, 1389695778⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11241379752, 11241379792⟩, ⟨4496551888, 4496551932⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11241379752, 11241379792⟩, ⟨4496551888, 4496551932⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11241379792), (-11241379752)⟩, ⟨(-4496551932), (-4496551888)⟩, ⟨(-449655195), (-449655187)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5620689896), (-5620689876)⟩, ⟨(-2248275966), (-2248275944)⟩, ⟨(-224827598), (-224827593)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1160411973, 1160411988⟩, ⟨(-607438010), (-607437995)⟩, ⟨98243233, 98243242⟩, ⟨4055888, 4055892⟩, ⟨(-3102140), (-3102138)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨985171191, 985171206⟩, ⟨(-548226493), (-548226476)⟩, ⟨100867302, 100867316⟩, ⟨449897, 449908⟩, ⟨(-2703916), (-2703906)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨562297118, 843445678⟩, ⟨140574279, 140574280⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1766508494, 2649762746⟩, ⟨441627122, 441627126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨726560191, 1634760437⟩, ⟨363280094, 544920148⟩, ⟨45410011, 45410013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨181, 410⟩, ⟨90, 137⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94506), (-94276)⟩, ⟨90, 137⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-35972), (-15948)⟩, ⟨(-11976), (-7921)⟩, ⟨(-992), (-973)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5077084, 5097109⟩, ⟨(-11976), (-7921)⟩, ⟨(-992), (-973)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨858867, 1940074⟩, ⟨424874, 645353⟩, ⟨51781, 53058⟩, ⟨(-253), (-163)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142306710), (-141225502)⟩, ⟨424874, 645353⟩, ⟨51781, 53058⟩, ⟨(-253), (-163)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-54165111), (-23890479)⟩, ⟨(-17983164), (-11699603)⟩, ⟨(-1459891), (-1391079)⟩, ⟨8774, 13529⟩, ⟨509, 547⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1377490654, 1407765287⟩, ⟨(-17983164), (-11699603)⟩, ⟨(-1459891), (-1391079)⟩, ⟨8774, 13529⟩, ⟨509, 547⟩⟩
...
def j72 : Jet := ⟨⟨1994, 4499⟩, ⟨991, 1499⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850183), (-847677)⟩, ⟨991, 1499⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-323599), (-143397)⟩, ⟨(-107700), (-71127)⟩, ⟨(-8886), (-8723)⟩, ⟨19, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35467795, 35647998⟩, ⟨(-107700), (-71127)⟩, ⟨(-8886), (-8723)⟩, ⟨19, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5999926, 13568424⟩, ⟨2958969, 4510776⟩, ⟨357947, 369410⟩, ⟨(-2264), (-1476)⟩, ⟨(-94), (-86)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709827957), (-702259458)⟩, ⟨2958969, 4510776⟩, ⟨357947, 369410⟩, ⟨(-2264), (-1476)⟩, ⟨(-94), (-86)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-270176368), (-118798056)⟩, ⟨(-89558235), (-57682124)⟩, ⟨(-7194071), (-6711971)⟩, ⟨60698, 94312⟩, ⟨3460, 3768⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4024790928, 4176169240⟩, ⟨(-89558235), (-57682124)⟩, ⟨(-7194071), (-6711971)⟩, ⟨60698, 94312⟩, ⟨3460, 3768⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨566558200, 868515115⟩, ⟨130544908, 139940505⟩, ⟨(-2749781), (-1775150)⟩, ⟨(-146505), (-134689)⟩, ⟨1111, 1730⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4417144759, 4583280077⟩, ⟨61010527, 101985540⟩, ⟨7941958, 10461684⟩, ⟨104245, 348470⟩, ⟨7764, 21739⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨582674886, 926816842⟩, ⟨142306501, 169957643⟩, ⟨(-32323), 3612821⟩, ⟨33510, 247599⟩, ⟨(-4843), 12403⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-843445678), (-562297118)⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3451521618, 3732670178⟩, ⟨(-140574280), (-140574279)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨79048337, 199999069⟩, ⟨38611900, 73350784⟩, ⟨4701134, 8284685⟩, ⟨6532, 392790⟩, ⟨100, 27990⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4374015633, 4494966365⟩, ⟨38611900, 73350784⟩, ⟨4701134, 8284685⟩, ⟨6532, 392790⟩, ⟨100, 27990⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4334311259, 4393829029⟩, ⟨18871563, 36342478⟩, ⟨2147379, 4063658⟩, ⟨(-30838), 185263⟩, ⟨(-3410), 13595⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3483139213, 3818588933⟩, ⟨(-128644460), (-110277485)⟩, ⟨536186, 2913978⟩, ⟨(-159805), 90726⟩, ⟨(-9028), 12826⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5558783088, 8338174644⟩, ⟨1389695767, 1389695778⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7194483051, 16187586914⟩, ⟨3597241512, 5395862320⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7194483051, 16187586914⟩, ⟨3597241512, 5395862320⟩, ⟨449655187, 449655195⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16187586914), (-7194483051)⟩, ⟨(-5395862320), (-3597241512)⟩, ⟨(-449655195), (-449655187)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8093793457), (-3597241525)⟩, ⟨(-2697931160), (-1798620756)⟩, ⟨(-224827598), (-224827593)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨652437972, 1858734509⟩, ⟨(-1167584619), (-273224077)⟩, ⟨(-40089146), 332562581⟩, ⟨(-60099358), 49140324⟩, ⟨(-16421296), 10487288⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨529115154, 1652572078⟩, ⟨(-1093754919), (-238331666)⟩, ⟨(-28545895), 331909257⟩, ⟨(-64255771), 44895823⟩, ⟨(-16127563), 11398831⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨702871397, 702871398⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4359847540, 4359847542⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3274
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨562297118, 843445678⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4334311259, 4393829029⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3275
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (33419733 / 2147483648)

theorem envelope_integral : (∫ s in ((3273 / 25000) : ℝ)..(9819 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((3273 / 25000) : ℝ)..(9819 / 50000), prawitzNormalCorrection
