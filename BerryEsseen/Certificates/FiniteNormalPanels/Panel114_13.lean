...
namespace FiniteNormalPanel114_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1121 / 32000)
def radius : Rat := (1121 / 32000)

def j0 : Jet := ⟨⟨150458073, 150458074⟩, ⟨150458073, 150458074⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨472677976, 472677980⟩, ⟨472677976, 472677980⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨52020062, 52020064⟩, ⟨104040124, 104040128⟩, ⟨52020062, 52020064⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1147), (-1146)⟩, ⟨(-2294), (-2292)⟩, ⟨(-1147), (-1144)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111909, 5111911⟩, ⟨(-2294), (-2292)⟩, ⟨(-1147), (-1144)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨61914, 61915⟩, ⟨123801, 123803⟩, ⟨61844, 61847⟩, ⟨(-56), (-53)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-143103663), (-143103661)⟩, ⟨123801, 123803⟩, ⟨61844, 61847⟩, ⟨(-56), (-53)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1733253), (-1733252)⟩, ⟨(-3465006), (-3465004)⟩, ⟨(-1729506), (-1729503)⟩, ⟨2996, 2999⟩, ⟨746, 749⟩⟩
...
def j19 : Jet := ⟨⟨1429922512, 1429922514⟩, ⟨(-3465006), (-3465004)⟩, ⟨(-1729506), (-1729503)⟩, ⟨2996, 2999⟩, ⟨746, 749⟩⟩
...
def j28 : Jet := ⟨⟨(-10320), (-10319)⟩, ⟨(-20637), (-20635)⟩, ⟨(-10313), (-10310)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781074, 35781076⟩, ⟨(-20637), (-20635)⟩, ⟨(-10313), (-10310)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨433375, 433376⟩, ⟨866501, 866503⟩, ⟨432750, 432753⟩, ⟨(-500), (-497)⟩, ⟨(-126), (-122)⟩⟩
...
def j33 : Jet := ⟨⟨(-715394508), (-715394506)⟩, ⟨866501, 866503⟩, ⟨432750, 432753⟩, ⟨(-500), (-497)⟩, ⟨(-126), (-122)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8664762), (-8664761)⟩, ⟨(-17319030), (-17319027)⟩, ⟨(-8638532), (-8638529)⟩, ⟨20969, 20972⟩, ⟨5226, 5229⟩⟩
...
def j36 : Jet := ⟨⟨4286302534, 4286302535⟩, ⟨(-17319030), (-17319027)⟩, ⟨(-8638532), (-8638529)⟩, ⟨20969, 20972⟩, ⟨5226, 5229⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨157368574, 157368576⟩, ⟨156987236, 156987239⟩, ⟨(-571677), (-571675)⟩, ⟨(-190010), (-190007)⟩, ⟨411, 414⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303649572, 4303649574⟩, ⟨17389118, 17389123⟩, ⟨8743749, 8743755⟩, ⟨49316, 49324⟩, ⟨12484, 12492⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨157686694, 157686697⟩, ⟨157941726, 157941731⟩, ⟨383136, 383142⟩, ⟨128692, 128700⟩, ⟨736, 744⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-150458074), (-150458073)⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4144509222, 4144509223⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5789355, 5789356⟩, ⟨11597438, 11597440⟩, ⟨5836229, 5836232⟩, ⟨37626, 37632⟩, ⟨9552, 9557⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300756651, 4300756652⟩, ⟨11597438, 11597440⟩, ⟨5836229, 5836232⟩, ⟨37626, 37632⟩, ⟨9552, 9557⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297860998, 4297861000⟩, ⟨5794814, 5794816⟩, ⟨2912242, 2912245⟩, ⟨14872, 14877⟩, ⟨3764, 3769⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4147301554, 4147301557⟩, ⟨(-144967631), (-144967625)⟩, ⟨2607222, 2607227⟩, ⟨(-87669), (-87663)⟩, ⟨3110, 3117⟩⟩
...
def j47 : Jet := ⟨⟨1430287887, 1430287898⟩, ⟨1430287887, 1430287898⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨476307105, 476307113⟩, ⟨952614210, 952614226⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨476307105, 476307113⟩, ⟨952614210, 952614226⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-476307113), (-476307105)⟩, ⟨(-952614226), (-952614210)⟩, ⟨(-476307113), (-476307105)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-238153557), (-238153552)⟩, ⟨(-476307113), (-476307105)⟩, ⟨(-238153557), (-238153552)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4063296114, 4063296119⟩, ⟨(-450615037), (-450615028)⟩, ⟨(-200321166), (-200321159)⟩, ⟨24062700, 24062702⟩, ⟨4886716, 4886718⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3923595484, 3923595493⟩, ⟨(-572270449), (-572270432)⟩, ⟨(-175757749), (-175757734)⟩, ⟨29640334, 29640347⟩, ⟨3797053, 3797066⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 300916147⟩, ⟨150458073, 150458074⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 945355957⟩, ⟨472677976, 472677980⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 208080254⟩, ⟨0, 208080256⟩, ⟨52020062, 52020064⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4588), 0⟩, ⟨(-4588), 3⟩, ⟨(-1147), (-1142)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108468, 5113057⟩, ⟨(-4588), 3⟩, ⟨(-1147), (-1142)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 247715⟩, ⟨(-223), 247716⟩, ⟨61594, 61930⟩, ⟨(-112), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142917861)⟩, ⟨(-223), 247716⟩, ⟨61594, 61930⟩, ⟨(-112), 2⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6936009), 0⟩, ⟨(-6936020), 12002⟩, ⟨(-1734014), (-1715998)⟩, ⟨(-9), 6003⟩, ⟨739, 752⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424719756, 1431655766⟩, ⟨(-6936020), 12002⟩, ⟨(-1734014), (-1715998)⟩, ⟨(-9), 6003⟩, ⟨739, 752⟩⟩
...
def j72 : Jet := ⟨⟨0, 574⟩, ⟨(-1), 574⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851602)⟩, ⟨(-1), 574⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-41286), 0⟩, ⟨(-41287), 28⟩, ⟨(-10323), (-10279)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35750108, 35791395⟩, ⟨(-41287), 28⟩, ⟨(-10323), (-10279)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1734003⟩, ⟨(-2001), 1734005⟩, ⟨430498, 433503⟩, ⟨(-1003), 2⟩, ⟨(-128), (-122)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714093879)⟩, ⟨(-2001), 1734005⟩, ⟨430498, 433503⟩, ⟨(-1003), 2⟩, ⟨(-128), (-122)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-34680043), 0⟩, ⟨(-34680140), 84009⟩, ⟨(-8670108), (-8543996)⟩, ⟨(-74), 42007⟩, ⟨5158, 5252⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4260287253, 4294967296⟩, ⟨(-34680140), 84009⟩, ⟨(-8670108), (-8543996)⟩, ⟨(-74), 42007⟩, ⟨5158, 5252⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 315118653⟩, ⟨155269317, 157561969⟩, ⟨(-1145008), 1321⟩, ⟨(-190838), (-187530)⟩, ⟨(-1), 827⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4329929646⟩, ⟨(-85383), 35247053⟩, ⟨8543306, 9098761⟩, ⟨(-43048), 145875⟩, ⟨11007, 14507⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 317683816⟩, ⟨155263052, 161430623⟩, ⟨(-1157462), 1961950⟩, ⟨103904, 156987⟩, ⟨(-5575), 7258⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-300916147), 0⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3994051149, 4294967296⟩, ⟨(-150458074), (-150458073)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 23497969⟩, ⟨0, 23880926⟩, ⟨5441530, 6357769⟩, ⟨(-87010), 170708⟩, ⟨6157, 13773⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4318465265⟩, ⟨0, 23880926⟩, ⟨5441530, 6357769⟩, ⟨(-87010), 170708⟩, ⟨6157, 13773⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306700255⟩, ⟨0, 11940463⟩, ⟨2696799, 3178885⟩, ⟨(-52343), 85354⟩, ⟨1659, 6186⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3994051149, 4306700255⟩, ⟨(-150869095), (-138517610)⟩, ⟨2089564, 3178885⟩, ⟨(-163704), (-9118)⟩, ⟨(-1449), 8020⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2860575786⟩, ⟨1430287887, 1430287898⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1905228437⟩, ⟨0, 1905228444⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1905228437⟩, ⟨0, 1905228444⟩, ⟨476307105, 476307113⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1905228437), 0⟩, ⟨(-1905228444), 0⟩, ⟨(-476307113), (-476307105)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-952614219), 0⟩, ⟨(-952614222), 0⟩, ⟨(-238153557), (-238153552)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3440600977, 4294967296⟩, ⟨(-952614222), 0⟩, ⟨(-238153557), (-85135552)⟩, ⟨0, 52821931⟩, ⟨(-568588), 6602742⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3199543870, 4306700255⟩, ⟨(-1106085662), (-110963318)⟩, ⟨(-237130242), (-42529426)⟩, ⟨1876944, 61324534⟩, ⟨(-2603333), 6623691⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨150458073, 150458074⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297860998, 4297861000⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2298
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 300916147⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306700255⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2299
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (270885049 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(1121 / 16000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (1121 / 16000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1121 / 16000), prawitzNormalCorrection
