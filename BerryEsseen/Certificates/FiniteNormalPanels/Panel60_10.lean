...
namespace FiniteNormalPanel60_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (34553 / 800000)
def radius : Rat := (34553 / 800000)

def j0 : Jet := ⟨⟨185505006, 185505007⟩, ⟨185505006, 185505007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨582781164, 582781168⟩, ⟨582781164, 582781168⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨79077176, 79077178⟩, ⟨158154352, 158154356⟩, ⟨79077176, 79077178⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1743), (-1742)⟩, ⟨(-3486), (-3484)⟩, ⟨(-1742), (-1739)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111313, 5111315⟩, ⟨(-3486), (-3484)⟩, ⟨(-1742), (-1739)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨94107, 94108⟩, ⟨188149, 188151⟩, ⟨93945, 93948⟩, ⟨(-130), (-127)⟩, ⟨(-33), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-143071470), (-143071468)⟩, ⟨188149, 188151⟩, ⟨93945, 93948⟩, ⟨(-130), (-127)⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2634174), (-2634173)⟩, ⟨(-5264883), (-5264881)⟩, ⟨(-2625517), (-2625514)⟩, ⟨6920, 6923⟩, ⟨1723, 1726⟩⟩
...
def j19 : Jet := ⟨⟨1429021591, 1429021593⟩, ⟨(-5264883), (-5264881)⟩, ⟨(-2625517), (-2625514)⟩, ⟨6920, 6923⟩, ⟨1723, 1726⟩⟩
...
def j25 : Jet := ⟨⟨217, 218⟩, ⟨434, 436⟩, ⟨215, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851960), (-851958)⟩, ⟨434, 436⟩, ⟨215, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-15686), (-15685)⟩, ⟨(-31365), (-31362)⟩, ⟨(-15668), (-15663)⟩, ⟨13, 18⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨35775708, 35775710⟩, ⟨(-31365), (-31362)⟩, ⟨(-15668), (-15663)⟩, ⟨13, 18⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨658687, 658688⟩, ⟨1316797, 1316799⟩, ⟨657243, 657246⟩, ⟨(-1155), (-1152)⟩, ⟨(-289), (-286)⟩⟩
...
def j33 : Jet := ⟨⟨(-715169196), (-715169194)⟩, ⟨1316797, 1316799⟩, ⟨657243, 657246⟩, ⟨(-1155), (-1152)⟩, ⟨(-289), (-286)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-13167403), (-13167401)⟩, ⟨(-26310561), (-26310558)⟩, ⟨(-13106815), (-13106811)⟩, ⟨48423, 48426⟩, ⟨12051, 12054⟩⟩
...
def j36 : Jet := ⟨⟨4281799893, 4281799895⟩, ⟨(-26310561), (-26310558)⟩, ⟨(-13106815), (-13106811)⟩, ⟨48423, 48426⟩, ⟨12051, 12054⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨193902958, 193902961⟩, ⟨193188569, 193188573⟩, ⟨(-1070644), (-1070642)⟩, ⟨(-355317), (-355314)⟩, ⟨1171, 1175⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4308175189, 4308175192⟩, ⟨26472627, 26472632⟩, ⟨13350213, 13350220⟩, ⟨114342, 114349⟩, ⟨29138, 29146⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨194499248, 194499252⟩, ⟨194977809, 194977817⟩, ⟨719523, 719528⟩, ⟨242647, 242654⟩, ⟨2113, 2122⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-185505007), (-185505006)⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4109462289, 4109462290⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8807973, 8807974⟩, ⟨17659290, 17659292⟩, ⟨8916536, 8916542⟩, ⟨87304, 87308⟩, ⟨22340, 22347⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303775269, 4303775270⟩, ⟨17659290, 17659292⟩, ⟨8916536, 8916542⟩, ⟨87304, 87308⟩, ⟨22340, 22347⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299369026, 4299369028⟩, ⟨8820605, 8820607⟩, ⟨4444655, 4444659⟩, ⟨34487, 34491⟩, ⟨8789, 8795⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4113673902, 4113673906⟩, ⟨(-177255492), (-177255488)⟩, ⟨3871710, 3871717⟩, ⟨(-158974), (-158968)⟩, ⟨6919, 6927⟩⟩
...
def j47 : Jet := ⟨⟨1125675899, 1125675906⟩, ⟨1125675899, 1125675906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨295030472, 295030476⟩, ⟨590060944, 590060952⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨295030472, 295030476⟩, ⟨590060944, 590060952⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-295030476), (-295030472)⟩, ⟨(-590060952), (-590060944)⟩, ⟨(-295030476), (-295030472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-147515238), (-147515236)⟩, ⟨(-295030476), (-295030472)⟩, ⟨(-147515238), (-147515236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4149956586, 4149956589⟩, ⟨(-285069381), (-285069376)⟩, ⟨(-132743679), (-132743675)⟩, ⟨9566823, 9566824⟩, ⟨2115320, 2115321⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3974784189, 3974784197⟩, ⟨(-444307243), (-444307232)⟩, ⟨(-111634535), (-111634521)⟩, ⟨14230815, 14230827⟩, ⟨1528775, 1528789⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 371010013⟩, ⟨185505006, 185505007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1165562332⟩, ⟨582781164, 582781168⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 316308707⟩, ⟨0, 316308708⟩, ⟨79077176, 79077178⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6974), 0⟩, ⟨(-6974), 6⟩, ⟨(-1744), (-1733)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106082, 5113057⟩, ⟨(-6974), 6⟩, ⟨(-1744), (-1733)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 376559⟩, ⟨(-514), 376560⟩, ⟨93368, 94141⟩, ⟨(-258), 2⟩, ⟨(-33), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142789017)⟩, ⟨(-514), 376560⟩, ⟨93368, 94141⟩, ⟨(-258), 2⟩, ⟨(-33), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-10543624), 0⟩, ⟨(-10543662), 27733⟩, ⟨(-2635944), (-2594305)⟩, ⟨(-30), 13869⟩, ⟨1696, 1735⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421112141, 1431655766⟩, ⟨(-10543662), 27733⟩, ⟨(-2635944), (-2594305)⟩, ⟨(-30), 13869⟩, ⟨1696, 1735⟩⟩
...
def j72 : Jet := ⟨⟨0, 872⟩, ⟨(-1), 872⟩, ⟨215, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851304)⟩, ⟨(-1), 872⟩, ⟨215, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-62760), 0⟩, ⟨(-62761), 65⟩, ⟨(-15691), (-15591)⟩, ⟨(-2), 34⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35728634, 35791395⟩, ⟨(-62761), 65⟩, ⟨(-15691), (-15591)⟩, ⟨(-2), 34⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2635906⟩, ⟨(-4623), 2635911⟩, ⟨652041, 658982⟩, ⟨(-2313), 5⟩, ⟨(-290), (-283)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713191976)⟩, ⟨(-4623), 2635911⟩, ⟨652041, 658982⟩, ⟨(-2313), 5⟩, ⟨(-290), (-283)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-52718118), 0⟩, ⟨(-52718460), 194126⟩, ⟨(-13179871), (-12888340)⟩, ⟨(-257), 97065⟩, ⟨11812, 12134⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4242249178, 4294967296⟩, ⟨(-52718460), 194126⟩, ⟨(-13179871), (-12888340)⟩, ⟨(-257), 97065⟩, ⟨11812, 12134⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 388520778⟩, ⟨189968405, 194267917⟩, ⟨(-2146002), 3764⟩, ⟨(-357679), (-348255)⟩, ⟨(-5), 2353⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4348340539⟩, ⟨(-198982), 54036859⟩, ⟨12885897, 14180995⟩, ⟨(-100761), 344375⟩, ⟨23924, 36385⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 393348898⟩, ⟨189950405, 201570221⟩, ⟨(-2181672), 3730788⟩, ⟨171710, 324427⟩, ⟨(-16151), 21282⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-371010013), 0⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3923957283, 4294967296⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 36024339⟩, ⟨0, 36921086⟩, ⟨8001186, 10143399⟩, ⟨(-204780), 409612⟩, ⟨10332, 37593⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4330991635⟩, ⟨0, 36921086⟩, ⟨8001186, 10143399⟩, ⟨(-204780), 409612⟩, ⟨10332, 37593⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4312941854⟩, ⟨0, 18460543⟩, ⟨3944412, 5071700⟩, ⟨(-124190), 204806⟩, ⟨1285, 17520⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3923957283, 4312941854⟩, ⟨(-186281351), (-167044463)⟩, ⟨2806349, 5071700⟩, ⟨(-343244), 34442⟩, ⟨(-7673), 22884⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2251351805⟩, ⟨1125675899, 1125675906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1180121897⟩, ⟨0, 1180121900⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1180121897⟩, ⟨0, 1180121900⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1180121897), 0⟩, ⟨(-1180121900), 0⟩, ⟨(-295030476), (-295030472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-590060949), 0⟩, ⟨(-590060950), 0⟩, ⟨(-147515238), (-147515236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3743644754, 4294967296⟩, ⟨(-590060950), 0⟩, ⟨(-147515238), (-88046927)⟩, ⟨0, 20266274⟩, ⟨815965, 2533285⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3420259360, 4312941854⟩, ⟨(-778811723), (-145601836)⟩, ⟨(-145686482), (-49777385)⟩, ⟨2384399, 26783563⟩, ⟨(-320108), 2556398⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨185505006, 185505007⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299369026, 4299369028⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1190
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 371010013⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4312941854⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1191
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (340181539 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(34553 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (34553 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(34553 / 400000), prawitzNormalCorrection
