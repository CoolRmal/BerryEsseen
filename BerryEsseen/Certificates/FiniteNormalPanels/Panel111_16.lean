...
namespace FiniteNormalPanel111_16

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (234801 / 800000)
def radius : Rat := (33543 / 800000)

def j0 : Jet := ⟨⟨1260578270, 1260578271⟩, ⟨180082610, 180082611⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3960223432, 3960223436⟩, ⟨565746204, 565746208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3651569045, 3651569054⟩, ⟨1043305440, 1043305450⟩, ⟨74521817, 74521819⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨913, 915⟩, ⟨261, 262⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93774), (-93771)⟩, ⟨261, 262⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-79727), (-79723)⟩, ⟨(-22558), (-22555)⟩, ⟨(-1550), (-1546)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5033329, 5033334⟩, ⟨(-22558), (-22555)⟩, ⟨(-1550), (-1546)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4279322, 4279327⟩, ⟨1203484, 1203489⟩, ⟨80535, 80542⟩, ⟨(-763), (-757)⟩, ⟨(-26), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-138886255), (-138886249)⟩, ⟨1203484, 1203489⟩, ⟨80535, 80542⟩, ⟨(-763), (-757)⟩, ⟨(-26), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-118080702), (-118080696)⟩, ⟨(-32714146), (-32714138)⟩, ⟨(-2048999), (-2048989)⟩, ⟨39795, 39804⟩, ⟨1188, 1197⟩⟩
...
def j19 : Jet := ⟨⟨1313575063, 1313575070⟩, ⟨(-32714146), (-32714138)⟩, ⟨(-2048999), (-2048989)⟩, ⟨39795, 39804⟩, ⟨1188, 1197⟩⟩
...
def j22 : Jet := ⟨⟨(-92), (-90)⟩, ⟨(-27), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11743, 11746⟩, ⟨(-27), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9983, 9987⟩, ⟨2829, 2833⟩, ⟨194, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842194), (-842189)⟩, ⟨2829, 2833⟩, ⟨194, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-716031), (-716026)⟩, ⟨(-202176), (-202170)⟩, ⟨(-13762), (-13754)⟩, ⟨94, 99⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35075363, 35075369⟩, ⟨(-202176), (-202170)⟩, ⟨(-13762), (-13754)⟩, ⟨94, 99⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29820974, 29820980⟩, ⟨8348388, 8348396⟩, ⟨547778, 547790⟩, ⟨(-6772), (-6763)⟩, ⟨(-217), (-209)⟩⟩
...
def j33 : Jet := ⟨⟨(-686006909), (-686006902)⟩, ⟨8348388, 8348396⟩, ⟨547778, 547790⟩, ⟨(-6772), (-6763)⟩, ⟨(-217), (-209)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-583241135), (-583241127)⟩, ⟨(-159542551), (-159542538)⟩, ⟨(-9409227), (-9409212)⟩, ⟨272156, 272170⟩, ⟨7673, 7686⟩⟩
...
def j36 : Jet := ⟨⟨3711726161, 3711726169⟩, ⟨(-159542551), (-159542538)⟩, ⟨(-9409227), (-9409212)⟩, ⟨272156, 272170⟩, ⟨7673, 7686⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1211196823, 1211196831⟩, ⟨142863666, 142863678⟩, ⟨(-6198511), (-6198499)⟩, ⟨(-233208), (-233197)⟩, ⟨6336, 6348⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4969855865, 4969855877⟩, ⟨213621205, 213621225⟩, ⟨21780726, 21780751⟩, ⟨1113311, 1113337⟩, ⟨77110, 77135⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1401517920, 1401517934⟩, ⟨225554488, 225554510⟩, ⟨6075423, 6075448⟩, ⟨460297, 460323⟩, ⟨23073, 23101⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1260578271), (-1260578270)⟩, ⟨(-180082611), (-180082610)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3034389025, 3034389026⟩, ⟨(-180082611), (-180082610)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨457338169, 457338179⟩, ⟨147204220, 147204238⟩, ⟨15810236, 15810258⟩, ⟨938516, 938540⟩, ⟨71995, 72023⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4752305465, 4752305475⟩, ⟨147204220, 147204238⟩, ⟨15810236, 15810258⟩, ⟨938516, 938540⟩, ⟨71995, 72023⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4517853091, 4517853096⟩, ⟨69970990, 69970999⟩, ⟨6973279, 6973291⟩, ⟨338107, 338120⟩, ⟨23602, 23618⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3191857560, 3191857566⟩, ⟨(-139993519), (-139993508)⟩, ⟨1992815, 1992826⟩, ⟨(-53510), (-53498)⟩, ⟨2497, 2511⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨27472369201, 27472369207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value486

def j47 : Jet := ⟨⟨8063174700, 8063174709⟩, ⟨1151882100, 1151882107⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15137434527, 15137434562⟩, ⟨4324981292, 4324981326⟩, ⟨308927235, 308927240⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15137434527, 15137434562⟩, ⟨4324981292, 4324981326⟩, ⟨308927235, 308927240⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15137434562), (-15137434527)⟩, ⟨(-4324981326), (-4324981292)⟩, ⟨(-308927240), (-308927235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7568717281), (-7568717263)⟩, ⟨(-2162490663), (-2162490646)⟩, ⟨(-154463620), (-154463617)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨737281593, 737281604⟩, ⟨(-371216933), (-371216924)⟩, ⟨66937267, 66937273⟩, ⟨(-2333911), (-2333909)⟩, ⟨(-909885), (-909883)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨547919847, 547919857⟩, ⟨(-299905945), (-299905934)⟩, ⟨62187072, 62187082⟩, ⟨(-4097709), (-4097701)⟩, ⟨(-564011), (-564000)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1080495660, 1440660881⟩, ⟨180082610, 180082611⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3394477227, 4525969641⟩, ⟨565746204, 565746208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2682785420, 4769396315⟩, ⟨894261806, 1192349086⟩, ⟨74521817, 74521819⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨671, 1195⟩, ⟨223, 299⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94016), (-93491)⟩, ⟨223, 299⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-104402), (-58397)⟩, ⟨(-25962), (-19132)⟩, ⟨(-1575), (-1516)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5008654, 5054660⟩, ⟨(-25962), (-19132)⟩, ⟨(-1575), (-1516)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3128578, 5613006⟩, ⟨1014029, 1391302⟩, ⟨77947, 82775⟩, ⟨(-886), (-632)⟩, ⟨(-27), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140036999), (-137552570)⟩, ⟨1014029, 1391302⟩, ⟨77947, 82775⟩, ⟨(-886), (-632)⟩, ⟨(-27), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-155505712), (-85920102)⟩, ⟨(-38243032), (-27095046)⟩, ⟨(-2169957), (-1908503)⟩, ⟨32839, 46727⟩, ⟨1076, 1294⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1276150053, 1345735664⟩, ⟨(-38243032), (-27095046)⟩, ⟨(-2169957), (-1908503)⟩, ⟨32839, 46727⟩, ⟨1076, 1294⟩⟩
...
def j70 : Jet := ⟨⟨(-120), (-66)⟩, ⟨(-30), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11715, 11770⟩, ⟨(-30), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7317, 13071⟩, ⟨2405, 3255⟩, ⟨191, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844860), (-839105)⟩, ⟨2405, 3255⟩, ⟨191, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-938185), (-524134)⟩, ⟨(-233045), (-171096)⟩, ⟨(-14041), (-13431)⟩, ⟨77, 113⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34853209, 35267261⟩, ⟨(-233045), (-171096)⟩, ⟨(-14041), (-13431)⟩, ⟨77, 113⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21770522, 39162940⟩, ⟨6998052, 9683863⟩, ⟨524447, 567908⟩, ⟨(-7894), (-5638)⟩, ⟨(-228), (-196)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694057361), (-676664942)⟩, ⟨6998052, 9683863⟩, ⟨524447, 567908⟩, ⟨(-7894), (-5638)⟩, ⟨(-228), (-196)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-770724058), (-422668373)⟩, ⟨(-188309791), (-130135898)⟩, ⟨(-10257902), (-8421757)⟩, ⟨221851, 322165⟩, ⟨6653, 8559⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3524243238, 3872298923⟩, ⟨(-188309791), (-130135898)⟩, ⟨(-10257902), (-8421757)⟩, ⟨221851, 322165⟩, ⟨6653, 8559⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1008590285, 1418115283⟩, ⟨127798468, 155850159⟩, ⟨(-7324156), (-5077405)⟩, ⟨(-259881), (-202152)⟩, ⟨5175, 7520⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4763770680, 5234242596⟩, ⟨160095484, 279679655⟩, ⟨15740903, 30179179⟩, ⟨441714, 2126733⟩, ⟨14239, 182411⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1118679723, 1728245854⟩, ⟨179343238, 282278177⟩, ⟨(-465739), 14481621⟩, ⟨(-221546), 1383833⟩, ⟨(-46163), 120424⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1440660881), (-1080495660)⟩, ⟨(-180082611), (-180082610)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2854306415, 3214471636⟩, ⟨(-180082611), (-180082610)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨291374587, 695426421⟩, ⟨93424526, 227171038⟩, ⟨7113946, 30206652⟩, ⟨(-239516), 3017230⟩, ⟨(-67845), 327645⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4586341883, 4990393717⟩, ⟨93424526, 227171038⟩, ⟨7113946, 30206652⟩, ⟨(-239516), 3017230⟩, ⟨(-67845), 327645⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4438264119, 4629641219⟩, ⟨43335462, 109918220⟩, ⟨1994986, 14404125⟩, ⟨(-472626), 1440428⟩, ⟨(-91876), 169791⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2949537184, 3464950804⟩, ⟨(-165315624), (-103825047)⟩, ⟨(-3282927), 8963443⟩, ⟨(-957674), 994409⟩, ⟨(-129159), 146894⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6911292600, 9215056809⟩, ⟨1151882100, 1151882107⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11121380469, 19771343096⟩, ⟨3707126822, 4942835800⟩, ⟨308927235, 308927240⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11121380469, 19771343096⟩, ⟨3707126822, 4942835800⟩, ⟨308927235, 308927240⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19771343096), (-11121380469)⟩, ⟨(-4942835800), (-3707126822)⟩, ⟨(-308927240), (-308927235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9885671548), (-5560690234)⟩, ⟨(-2471417900), (-1853563411)⟩, ⟨(-154463620), (-154463617)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨429882512, 1176736415⟩, ⟨(-677119811), (-185522831)⟩, ⟨(-2287282), 179354522⟩, ⟨(-29953424), 16673281⟩, ⟨(-5623684), 4350094⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨295218651, 949328251⟩, ⟨(-591557415), (-137798268)⟩, ⟨1740048, 173212191⟩, ⟨(-32743789), 14329171⟩, ⟨(-5507907), 5227885⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1260578270, 1260578271⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4517853091, 4517853096⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar486 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2242
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar486 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1080495660, 1440660881⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4438264119, 4629641219⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2243
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((100629 / 400000) : ℝ)..(33543 / 100000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (33543 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((100629 / 400000) : ℝ)..(33543 / 100000), prawitzNormalCorrection
      ((192859 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
