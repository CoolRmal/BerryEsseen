...
namespace FiniteNormalPanel28_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (31927 / 100000)
def radius : Rat := (4561 / 100000)

def j0 : Jet := ⟨⟨1371254208, 1371254209⟩, ⟨195893458, 195893459⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4307922145, 4307922150⟩, ⟨615417448, 615417452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4320916069, 4320916080⟩, ⟨1234547444, 1234547456⟩, ⟨88181960, 88181962⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1081, 1083⟩, ⟨308, 310⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93606), (-93603)⟩, ⟨308, 310⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-94172), (-94168)⟩, ⟨(-26598), (-26593)⟩, ⟨(-1812), (-1807)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5018884, 5018889⟩, ⟨(-26598), (-26593)⟩, ⟨(-1812), (-1807)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5049206, 5049212⟩, ⟨1415871, 1415879⟩, ⟨93576, 93586⟩, ⟨(-1056), (-1049)⟩, ⟨(-35), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-138116371), (-138116364)⟩, ⟨1415871, 1415879⟩, ⟨93576, 93586⟩, ⟨(-1056), (-1049)⟩, ⟨(-35), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-138950825), (-138950817)⟩, ⟨(-38275811), (-38275799)⟩, ⟨(-2334613), (-2334597)⟩, ⟨54903, 54917⟩, ⟨1581, 1591⟩⟩
...
def j19 : Jet := ⟨⟨1292704940, 1292704949⟩, ⟨(-38275811), (-38275799)⟩, ⟨(-2334613), (-2334597)⟩, ⟨54903, 54917⟩, ⟨1581, 1591⟩⟩
...
def j22 : Jet := ⟨⟨(-109), (-107)⟩, ⟨(-32), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11726, 11729⟩, ⟨(-32), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11796, 11800⟩, ⟨3337, 3342⟩, ⟨226, 231⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840381), (-840376)⟩, ⟨3337, 3342⟩, ⟨226, 231⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-845459), (-845453)⟩, ⟨(-238203), (-238195)⟩, ⟨(-16069), (-16060)⟩, ⟨129, 136⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨34945935, 34945942⟩, ⟨(-238203), (-238195)⟩, ⟨(-16069), (-16060)⟩, ⟨129, 136⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨35157066, 35157074⟩, ⟨9805233, 9805245⟩, ⟨632854, 632869⟩, ⟨(-9381), (-9369)⟩, ⟨(-292), (-283)⟩⟩
...
def j33 : Jet := ⟨⟨(-680670817), (-680670808)⟩, ⟨9805233, 9805245⟩, ⟨632854, 632869⟩, ⟨(-9381), (-9369)⟩, ⟨(-292), (-283)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-684783207), (-684783196)⟩, ⟨(-185787874), (-185787855)⟩, ⟨(-10520071), (-10520049)⟩, ⟨373784, 373805⟩, ⟨10002, 10017⟩⟩
...
def j36 : Jet := ⟨⟨3610184089, 3610184100⟩, ⟨(-185787874), (-185787855)⟩, ⟨(-10520071), (-10520049)⟩, ⟨373784, 373805⟩, ⟨10002, 10017⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1296604107, 1296604119⟩, ⟨146837895, 146837912⟩, ⟨(-7826121), (-7826102)⟩, ⟨(-279455), (-279436)⟩, ⟨9451, 9465⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5109640827, 5109640844⟩, ⟨262953129, 262953160⟩, ⟨28421588, 28421625⟩, ⟨1699816, 1699855⟩, ⟨128890, 128919⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1542545222, 1542545242⟩, ⟨254072949, 254072982⟩, ⟨8259517, 8259556⟩, ⟨673237, 673277⟩, ⟨39367, 39401⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1371254209), (-1371254208)⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2923713087, 2923713088⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨554007888, 554007903⟩, ⟨182501512, 182501540⟩, ⟨20962771, 20962806⟩, ⟨1460786, 1460824⟩, ⟨123809, 123844⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4848975184, 4848975199⟩, ⟨182501512, 182501540⟩, ⟨20962771, 20962806⟩, ⟨1460786, 1460824⟩, ⟨123809, 123844⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4563572047, 4563572055⟩, ⟨85879878, 85879892⟩, ⟨9056399, 9056417⟩, ⟨516973, 516994⟩, ⟨39544, 39563⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3106560399, 3106560406⟩, ⟨(-149683514), (-149683501)⟩, ⟨2247980, 2247994⟩, ⟨(-61145), (-61128)⟩, ⟨3337, 3353⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨23956812180, 23956812182⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value222

def j47 : Jet := ⟨⟨7648691421, 7648691428⟩, ⟨1092670201, 1092670208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13621170179, 13621170205⟩, ⟨3891762900, 3891762930⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13621170179, 13621170205⟩, ⟨3891762900, 3891762930⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13621170205), (-13621170179)⟩, ⟨(-3891762930), (-3891762900)⟩, ⟨(-277983068), (-277983063)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6810585103), (-6810585089)⟩, ⟨(-1945881465), (-1945881450)⟩, ⟨(-138991534), (-138991531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨879616750, 879616763⟩, ⟨(-398519905), (-398519895)⟩, ⟨61811169, 61811174⟩, ⟨(-736944), (-736941)⟩, ⟨(-916682), (-916680)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨636228956, 636228968⟩, ⟨(-318905872), (-318905859)⟩, ⟨59057339, 59057350⟩, ⟨(-2908320), (-2908309)⟩, ⟨(-598651), (-598638)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1175360750, 1567147667⟩, ⟨195893458, 195893459⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3692504697, 4923339598⟩, ⟨615417448, 615417452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3174550583, 5643645488⟩, ⟨1058183524, 1410911378⟩, ⟨88181960, 88181962⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨794, 1414⟩, ⟨264, 354⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93893), (-93272)⟩, ⟨264, 354⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-123377), (-68940)⟩, ⟨(-30650), (-22514)⟩, ⟨(-1847), (-1767)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4989679, 5044117⟩, ⟨(-30650), (-22514)⟩, ⟨(-1847), (-1767)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3688034, 6628039⟩, ⟨1189069, 1640370⟩, ⟨89949, 96712⟩, ⟨(-1230), (-875)⟩, ⟨(-36), (-28)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139477543), (-136537537)⟩, ⟨1189069, 1640370⟩, ⟨89949, 96712⟩, ⟨(-1230), (-875)⟩, ⟨(-36), (-28)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-183275391), (-100919352)⟩, ⟨(-44939969), (-31484314)⟩, ⟨(-2504236), (-2137366)⟩, ⟨44957, 64805⟩, ⟨1393, 1751⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1248380374, 1330736414⟩, ⟨(-44939969), (-31484314)⟩, ⟨(-2504236), (-2137366)⟩, ⟨44957, 64805⟩, ⟨1393, 1751⟩⟩
...
def j70 : Jet := ⟨⟨(-142), (-79)⟩, ⟨(-36), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11693, 11757⟩, ⟨(-36), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8642, 15449⟩, ⟨2832, 3844⟩, ⟨224, 235⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843535), (-836727)⟩, ⟨2832, 3844⟩, ⟨224, 235⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1108417), (-618452)⟩, ⟨(-275012), (-201098)⟩, ⟨(-16458), (-15607)⟩, ⟨110, 157⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34682977, 35172943⟩, ⟨(-275012), (-201098)⟩, ⟨(-16458), (-15607)⟩, ⟨110, 157⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨25635320, 46217726⟩, ⟨8183736, 11405794⟩, ⟨600122, 661071⟩, ⟨(-10973), (-7766)⟩, ⟨(-311), (-261)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-690192563), (-669610156)⟩, ⟨8183736, 11405794⟩, ⟨600122, 661071⟩, ⟨(-10973), (-7766)⟩, ⟨(-311), (-261)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-906922423), (-494930732)⟩, ⟨(-220681741), (-149989541)⟩, ⟨(-11710807), (-9132575)⟩, ⟨301461, 445603⟩, ⟨8307, 11468⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3388044873, 3800036564⟩, ⟨(-220681741), (-149989541)⟩, ⟨(-11710807), (-9132575)⟩, ⟨301461, 445603⟩, ⟨8307, 11468⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1073267868, 1525428911⟩, ⟨127363096, 163610661⟩, ⟨(-9309978), (-6348878)⟩, ⟨(-320178), (-231971)⟩, ⟨7638, 11294⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4854359626, 5444657543⟩, ⟨191604254, 354640082⟩, ⟨19229139, 41919141⟩, ⟨581007, 3524309⟩, ⟨11127, 345505⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1213054220, 1933760482⟩, ⟨191831252, 333362785⟩, ⟨(-1315102), 21222009⟩, ⟨(-459212), 2303153⟩, ⟨(-88663), 232512⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1567147667), (-1175360750)⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2727819629, 3119606546⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨342610418, 870653802⟩, ⟨108360176, 300185654⟩, ⟨7383768, 44984584⟩, ⟨(-617662), 5368320⟩, ⟨(-157625), 671761⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4637577714, 5165621098⟩, ⟨108360176, 300185654⟩, ⟨7383768, 44984584⟩, ⟨(-617662), 5368320⟩, ⟨(-157625), 671761⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4462986064, 4710220131⟩, ⟨49403573, 144442258⟩, ⟨1151694, 21372082⟩, ⟨(-988902), 2570361⟩, ⟨(-210208), 355094⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2834531708, 3421221291⟩, ⟨(-183455944), (-98642603)⟩, ⟨(-5856549), 13270103⟩, ⟨(-1693061), 1814429⟩, ⟨(-269918), 303023⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6556021219, 8741361630⟩, ⟨1092670201, 1092670208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10007390338, 17790916178⟩, ⟨3335796772, 4447729062⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10007390338, 17790916178⟩, ⟨3335796772, 4447729062⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17790916178), (-10007390338)⟩, ⟨(-4447729062), (-3335796772)⟩, ⟨(-277983068), (-277983063)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8895458089), (-5003695169)⟩, ⟨(-2223864531), (-1667898386)⟩, ⟨(-138991534), (-138991531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨541348898, 1339679459⟩, ⟨(-693664335), (-210226269)⟩, ⟨(-2534613), 162065226⟩, ⟨(-23436094), 15402801⟩, ⟨(-4616167), 3074720⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨357271781, 1067141977⟩, ⟨(-609772130), (-151175327)⟩, ⟨982520, 162863996⟩, ⟨(-28262160), 13889423⟩, ⟨(-4933221), 4318960⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1371254208, 1371254209⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨195893458, 195893459⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4563572047, 4563572055⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar222 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified558
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar222 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1175360750, 1567147667⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4462986064, 4710220131⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified559
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((13683 / 50000) : ℝ)..(4561 / 12500),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (13683 / 50000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (4561 / 12500) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((13683 / 50000) : ℝ)..(4561 / 12500), prawitzNormalCorrection
      ((139447 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
