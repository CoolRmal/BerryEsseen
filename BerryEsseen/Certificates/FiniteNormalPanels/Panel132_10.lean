...
namespace FiniteNormalPanel132_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (189007 / 800000)
def radius : Rat := (27001 / 800000)

def j0 : Jet := ⟨⟨1014723604, 1014723605⟩, ⟨144960514, 144960515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3187848219, 3187848224⟩, ⟨455406885, 455406890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2366112607, 2366112615⟩, ⟨676032168, 676032178⟩, ⟨48288011, 48288013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨592, 593⟩, ⟨169, 170⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94095), (-94093)⟩, ⟨169, 170⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-51838), (-51836)⟩, ⟨(-14718), (-14716)⟩, ⟨(-1026), (-1022)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5061218, 5061221⟩, ⟨(-14718), (-14716)⟩, ⟨(-1026), (-1022)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2788242, 2788245⟩, ⟨788531, 788535⟩, ⟨54019, 54024⟩, ⟨(-327), (-322)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-140377335), (-140377331)⟩, ⟨788531, 788535⟩, ⟨54019, 54024⟩, ⟨(-327), (-322)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-77334369), (-77334365)⟩, ⟨(-21661130), (-21661125)⟩, ⟨(-1424379), (-1424372)⟩, ⟨17186, 17193⟩, ⟨548, 554⟩⟩
...
def j19 : Jet := ⟨⟨1354321396, 1354321401⟩, ⟨(-21661130), (-21661125)⟩, ⟨(-1424379), (-1424372)⟩, ⟨17186, 17193⟩, ⟨548, 554⟩⟩
...
def j22 : Jet := ⟨⟨(-60), (-58)⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11775, 11778⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6486, 6489⟩, ⟨1843, 1846⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845691), (-845687)⟩, ⟨1843, 1846⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-465895), (-465891)⟩, ⟨(-132098), (-132094)⟩, ⟨(-9150), (-9143)⟩, ⟨37, 42⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35325499, 35325504⟩, ⟨(-132098), (-132094)⟩, ⟨(-9150), (-9143)⟩, ⟨37, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19460941, 19460945⟩, ⟨5487495, 5487499⟩, ⟨371328, 371336⟩, ⟨(-2907), (-2900)⟩, ⟨(-99), (-93)⟩⟩
...
def j33 : Jet := ⟨⟨(-696366942), (-696366937)⟩, ⟨5487495, 5487499⟩, ⟨371328, 371336⟩, ⟨(-2907), (-2900)⟩, ⟨(-99), (-93)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-383631002), (-383630997)⟩, ⟨(-106585779), (-106585772)⟩, ⟨(-6760903), (-6760894)⟩, ⟨118540, 118548⟩, ⟨3661, 3668⟩⟩
...
def j36 : Jet := ⟨⟨3911336294, 3911336299⟩, ⟨(-106585779), (-106585772)⟩, ⟨(-6760903), (-6760894)⟩, ⟨118540, 118548⟩, ⟨3661, 3668⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1005216280, 1005216286⟩, ⟨127524810, 127524818⟩, ⟨(-3354004), (-3353996)⟩, ⟨(-138276), (-138267)⟩, ⟨2228, 2236⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4716225520, 4716225527⟩, ⟨128519384, 128519395⟩, ⟨11654388, 11654403⟩, ⟨396792, 396808⟩, ⟨22636, 22651⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1103809725, 1103809734⟩, ⟨170112013, 170112027⟩, ⟨2860638, 2860653⟩, ⟨186703, 186720⟩, ⟨6284, 6302⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1014723605), (-1014723604)⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3280243691, 3280243692⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨283679903, 283679909⟩, ⟨87437822, 87437832⟩, ⟨8208047, 8208057⟩, ⟨322568, 322582⟩, ⟨19921, 19938⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4578647199, 4578647205⟩, ⟨87437822, 87437832⟩, ⟨8208047, 8208057⟩, ⟨322568, 322582⟩, ⟨19921, 19938⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4434539432, 4434539436⟩, ⟨42342907, 42342913⟩, ⟨3772699, 3772705⟩, ⟨120183, 120192⟩, ⟨6894, 6905⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3386840688, 3386840693⟩, ⟨(-117332226), (-117332218)⟩, ⟨1452238, 1452245⟩, ⟨(-35546), (-35537)⟩, ⟨1208, 1218⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨44183190010, 44183190018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value555

def j47 : Jet := ⟨⟨10438665236, 10438665249⟩, ⟨1491237882, 1491237893⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨25370561496, 25370561560⟩, ⟨7248731812, 7248731876⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨25370561496, 25370561560⟩, ⟨7248731812, 7248731876⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-25370561560), (-25370561496)⟩, ⟨(-7248731876), (-7248731812)⟩, ⟨(-517766563), (-517766555)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12685280780), (-12685280748)⟩, ⟨(-3624365938), (-3624365906)⟩, ⟨(-258883282), (-258883277)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨224006959, 224006966⟩, ⟨(-189031293), (-189031284)⟩, ⟨66256059, 66256066⟩, ⟨(-11040997), (-11040993)⟩, ⟨332448, 332450⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨176642994, 176643000⟩, ⟨(-155182116), (-155182107)⟩, ⟨57486696, 57486706⟩, ⟨(-10582282), (-10582275)⟩, ⟨587807, 587813⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨869763089, 1159684120⟩, ⟨144960514, 144960515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2732441330, 3643255113⟩, ⟨455406885, 455406890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1738368445, 3090432803⟩, ⟨579456144, 772608204⟩, ⟨48288011, 48288013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨435, 775⟩, ⟨145, 194⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94252), (-93911)⟩, ⟨145, 194⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-67819), (-38010)⟩, ⟨(-16897), (-12530)⟩, ⟨(-1037), (-1010)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5045237, 5075047⟩, ⟨(-16897), (-12530)⟩, ⟨(-1037), (-1010)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2042036, 3651738⟩, ⟨668519, 907864⟩, ⟨52936, 54961⟩, ⟨(-377), (-271)⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141123541), (-139513838)⟩, ⟨668519, 907864⟩, ⟨52936, 54961⟩, ⟨(-377), (-271)⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-101545086), (-56467590)⟩, ⟨(-25115692), (-18169277)⟩, ⟨(-1475024), (-1365683)⟩, ⟨14385, 19986⟩, ⟨518, 579⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1330110679, 1375188176⟩, ⟨(-25115692), (-18169277)⟩, ⟨(-1475024), (-1365683)⟩, ⟨14385, 19986⟩, ⟨518, 579⟩⟩
...
def j70 : Jet := ⟨⟨(-78), (-43)⟩, ⟨(-20), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11757, 11793⟩, ⟨(-20), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4758, 8486⟩, ⟨1571, 2117⟩, ⟨126, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847419), (-843690)⟩, ⟨1571, 2117⟩, ⟨126, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-609759), (-341479)⟩, ⟨(-151805), (-112302)⟩, ⟨(-9267), (-9009)⟩, ⟨31, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35181635, 35449916⟩, ⟨(-151805), (-112302)⟩, ⟨(-9267), (-9009)⟩, ⟨31, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14239606, 25507897⟩, ⟨4637304, 6331522⟩, ⟨361567, 379764⟩, ⟨(-3363), (-2442)⟩, ⟨(-102), (-90)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701588277), (-690319985)⟩, ⟨4637304, 6331522⟩, ⟨361567, 379764⟩, ⟨(-3363), (-2442)⟩, ⟨(-102), (-90)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-504826062), (-279403868)⟩, ⟨(-124329589), (-88578791)⟩, ⟨(-7115924), (-6349001)⟩, ⟨98496, 138512⟩, ⟨3386, 3905⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3790141234, 4015563428⟩, ⟨(-124329589), (-88578791)⟩, ⟨(-7115924), (-6349001)⟩, ⟨98496, 138512⟩, ⟨3386, 3905⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨846211191, 1166519093⟩, ⟨119730524, 134255665⟩, ⟨(-3914291), (-2795379)⟩, ⟨(-147250), (-127853)⟩, ⟨1854, 2612⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4593812152, 4867033426⟩, ⟨101334303, 159655335⟩, ⟨9498589, 14375013⟩, ⟨201862, 651921⟩, ⟨9229, 41640⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨905090768, 1321893050⟩, ⟨148026681, 195500397⟩, ⟨260684, 5905032⟩, ⟨(-7806), 423708⟩, ⟨(-9147), 25451⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1159684120), (-869763089)⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3135283176, 3425204207⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨190732371, 406848555⟩, ⟨62388172, 120341134⟩, ⟨5211629, 12533752⟩, ⟨13162, 798394⟩, ⟨(-6329), 62361⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4485699667, 4701815851⟩, ⟨62388172, 120341134⟩, ⟨5211629, 12533752⟩, ⟨13162, 798394⟩, ⟨(-6329), 62361⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4389297594, 4493789639⟩, ⟨29813940, 58877443⟩, ⟨2104818, 6030941⟩, ⟨(-74459), 376322⟩, ⟨(-12289), 31006⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3204143350, 3583763535⟩, ⟨(-129907140), (-101189959)⟩, ⟨(-450692), 3803374⟩, ⟨(-262933), 229074⟩, ⟨(-22503), 27242⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8947427343, 11929903141⟩, ⟨1491237882, 1491237893⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨18639596192, 33137059993⟩, ⟨6213198694, 8284265002⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨18639596192, 33137059993⟩, ⟨6213198694, 8284265002⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-33137059993), (-18639596192)⟩, ⟨(-8284265002), (-6213198694)⟩, ⟨(-517766563), (-517766555)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-16568529997), (-9319798096)⟩, ⟨(-4142132501), (-3106599347)⟩, ⟨(-258883282), (-258883277)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨90698217, 490421215⟩, ⟨(-472969761), (-65603065)⟩, ⟨(-5834884), 222602734⟩, ⟨(-68924309), 20881556⟩, ⟨(-11743421), 16793768⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨67662934, 409212352⟩, ⟨(-409484144), (-51078240)⟩, ⟨(-3374533), 200481846⟩, ⟨(-64692914), 17676053⟩, ⟨(-10481576), 16326789⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1014723604, 1014723605⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4434539432, 4434539436⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar555 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2656
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar555 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨869763089, 1159684120⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4389297594, 4493789639⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2657
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((81003 / 400000) : ℝ)..(27001 / 100000), prawitzNormalCorrection
      ((274937 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
