...
namespace FiniteNormalPanel16_21
...
def j2 : Jet := ⟨⟨665729611, 665729616⟩, ⟨665729611, 665729616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨103189590, 103189592⟩, ⟨206379180, 206379184⟩, ⟨103189590, 103189592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-2275), (-2274)⟩, ⟨(-4548), (-4546)⟩, ⟨(-2273), (-2270)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110781, 5110783⟩, ⟨(-4548), (-4546)⟩, ⟨(-2273), (-2270)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨122790, 122791⟩, ⟨245470, 245472⟩, ⟨122516, 122519⟩, ⟨(-220), (-217)⟩, ⟨(-55), (-52)⟩⟩
...
def j16 : Jet := ⟨⟨(-143042787), (-143042785)⟩, ⟨245470, 245472⟩, ⟨122516, 122519⟩, ⟨(-220), (-217)⟩, ⟨(-55), (-52)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3436703), (-3436702)⟩, ⟨(-6867509), (-6867507)⟩, ⟨(-3421965), (-3421962)⟩, ⟨11778, 11781⟩, ⟨2930, 2933⟩⟩
...
def j19 : Jet := ⟨⟨1428219062, 1428219064⟩, ⟨(-6867509), (-6867507)⟩, ⟨(-3421965), (-3421962)⟩, ⟨11778, 11781⟩, ⟨2930, 2933⟩⟩
...
def j25 : Jet := ⟨⟨284, 285⟩, ⟨567, 569⟩, ⟨282, 285⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851893), (-851891)⟩, ⟨567, 569⟩, ⟨282, 285⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-20468), (-20467)⟩, ⟨(-40922), (-40920)⟩, ⟨(-20435), (-20432)⟩, ⟨25, 28⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35770926, 35770928⟩, ⟨(-40922), (-40920)⟩, ⟨(-20435), (-20432)⟩, ⟨25, 28⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨859421, 859422⟩, ⟨1717858, 1717861⟩, ⟨856963, 856966⟩, ⟨(-1966), (-1963)⟩, ⟨(-490), (-487)⟩⟩
...
def j33 : Jet := ⟨⟨(-714968462), (-714968460)⟩, ⟨1717858, 1717861⟩, ⟨856963, 856966⟩, ⟨(-1966), (-1963)⟩, ⟨(-490), (-487)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-17177618), (-17177616)⟩, ⟨(-34313963), (-34313960)⟩, ⟨(-17074484), (-17074480)⟩, ⟨82402, 82405⟩, ⟨20482, 20485⟩⟩
...
def j36 : Jet := ⟨⟨4277789678, 4277789680⟩, ⟨(-34313963), (-34313960)⟩, ⟨(-17074484), (-17074480)⟩, ⟨82402, 82405⟩, ⟨20482, 20485⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨221377173, 221377176⟩, ⟨220312693, 220312697⟩, ⟨(-1594893), (-1594890)⟩, ⟨(-528588), (-528584)⟩, ⟨2279, 2282⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4312213889, 4312213892⟩, ⟨34590090, 34590095⟩, ⟨17489343, 17489350⟩, ⟨195284, 195291⟩, ⟨50056, 50064⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨222266120, 222266125⟩, ⟨222980256, 222980262⟩, ⟨1074479, 1074485⟩, ⟨363634, 363642⟩, ⟨4132, 4140⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-211908318), (-211908317)⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4083058978, 4083058979⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨11502352, 11502354⟩, ⟨23078618, 23078620⟩, ⟨11687592, 11687596⟩, ⟨149202, 149206⟩, ⟨38450, 38459⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4306469648, 4306469650⟩, ⟨23078618, 23078620⟩, ⟨11687592, 11687596⟩, ⟨149202, 149206⟩, ⟨38450, 38459⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4300714626, 4300714628⟩, ⟨11523888, 11523890⟩, ⟨5820547, 5820550⟩, ⟨58904, 58908⟩, ⟨15101, 15108⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4088522741, 4088522745⟩, ⟨(-201236572), (-201236567)⟩, ⟨4964793, 4964798⟩, ⟨(-231182), (-231176)⟩, ⟨11448, 11457⟩⟩
...
def j47 : Jet := ⟨⟨990365821, 990365827⟩, ⟨990365821, 990365827⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨228365990, 228365993⟩, ⟨456731980, 456731986⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨228365990, 228365993⟩, ⟨456731980, 456731986⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-228365993), (-228365990)⟩, ⟨(-456731986), (-456731980)⟩, ⟨(-228365993), (-228365990)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-114182997), (-114182995)⟩, ⟨(-228365993), (-228365990)⟩, ⟨(-114182997), (-114182995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4182288732, 4182288735⟩, ⟨(-222374807), (-222374803)⟩, ⟨(-105275504), (-105275500)⟩, ⟨5807120, 5807122⟩, ⟨1322198, 1322199⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3981260254, 3981260262⟩, ⟨(-407643130), (-407643119)⟩, ⟨(-84961569), (-84961556)⟩, ⟨9978400, 9978411⟩, ⟨887978, 887993⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 423816636⟩, ⟨211908317, 211908318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1331459231⟩, ⟨665729611, 665729616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 412758367⟩, ⟨0, 412758368⟩, ⟨103189590, 103189592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 104⟩, ⟨0, 104⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94582)⟩, ⟨0, 104⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-9100), 0⟩, ⟨(-9100), 10⟩, ⟨(-2275), (-2259)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5103956, 5113057⟩, ⟨(-9100), 10⟩, ⟨(-2275), (-2259)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 491380⟩, ⟨(-875), 491381⟩, ⟨121532, 122846⟩, ⟨(-438), 2⟩, ⟨(-55), (-52)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142674196)⟩, ⟨(-875), 491381⟩, ⟨121532, 122846⟩, ⟨(-438), 2⟩, ⟨(-55), (-52)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-13758613), 0⟩, ⟨(-13758698), 47224⟩, ⟨(-3439739), (-3368817)⟩, ⟨(-65), 23613⟩, ⟨2870, 2953⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1417897152, 1431655766⟩, ⟨(-13758698), 47224⟩, ⟨(-3439739), (-3368817)⟩, ⟨(-65), 23613⟩, ⟨2870, 2953⟩⟩
...
def j72 : Jet := ⟨⟨0, 1138⟩, ⟨(-2), 1138⟩, ⟨281, 285⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851038)⟩, ⟨(-2), 1138⟩, ⟨281, 285⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-81897), 0⟩, ⟨(-81898), 110⟩, ⟨(-20476), (-20308)⟩, ⟨(-2), 56⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35709497, 35791395⟩, ⟨(-81898), 110⟩, ⟨(-20476), (-20308)⟩, ⟨(-2), 56⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3439654⟩, ⟨(-7871), 3439665⟩, ⟨848106, 859925⟩, ⟨(-3937), 9⟩, ⟨(-493), (-480)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712388228)⟩, ⟨(-7871), 3439665⟩, ⟨848106, 859925⟩, ⟨(-3937), 9⟩, ⟨(-493), (-480)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-68793062), 0⟩, ⟨(-68793819), 330562⟩, ⟨(-17199023), (-16702420)⟩, ⟨(-569), 165284⟩, ⟨19949, 20662⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4226174234, 4294967296⟩, ⟨(-68793819), 330562⟩, ⟨(-17199023), (-16702420)⟩, ⟨(-569), 165284⟩, ⟨19949, 20662⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 443819744⟩, ⟨215511995, 221924513⟩, ⟨(-3198965), 7320⟩, ⟨(-533189), (-514853)⟩, ⟨(-11), 4577⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4364880162⟩, ⟨(-341412), 71051680⟩, ⟨16696951, 18920090⟩, ⟨(-173581), 597726⟩, ⟨38416, 66469⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 451044179⟩, ⟨215476715, 232879083⟩, ⟨(-3268680), 5633845⟩, ⟨225089, 524785⟩, ⟨(-31896), 42482⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-423816636), 0⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3871150660, 4294967296⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 47367265⟩, ⟨0, 48912482⟩, ⟨10123842, 13810325⟩, ⟨(-354466), 721174⟩, ⟨11596, 73225⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4342334561⟩, ⟨0, 48912482⟩, ⟨10123842, 13810325⟩, ⟨(-354466), 721174⟩, ⟨11596, 73225⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4318585988⟩, ⟨0, 24456241⟩, ⟨4964988, 6905163⟩, ⟨(-216553), 360587⟩, ⟨(-1807), 34977⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3871150660, 4318585988⟩, ⟨(-213073635), (-187452076)⟩, ⟨3268414, 6905163⟩, ⟨(-557246), 115621⟩, ⟨(-19598), 45662⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1980731653⟩, ⟨990365821, 990365827⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 913463971⟩, ⟨0, 913463972⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 913463971⟩, ⟨0, 913463972⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-913463971), 0⟩, ⟨(-913463972), 0⟩, ⟨(-228365993), (-228365990)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-456731986), 0⟩, ⟨(-456731986), 0⟩, ⟨(-114182997), (-114182995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3861681609, 4294967296⟩, ⟨(-456731986), 0⟩, ⟨(-114182997), (-78379250)⟩, ⟨0, 12142358⟩, ⟨719059, 1517795⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3480620521, 4318585988⟩, ⟨(-672317262), (-168541500)⟩, ⟨(-111872219), (-41081311)⟩, ⟨2129280, 17989379⟩, ⟨(-169750), 1571418⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4300714626, 4300714628⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified330
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4318585988⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified331
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (390097225 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(39471 / 400000), prawitzNormalCorrection
