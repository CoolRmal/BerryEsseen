...
namespace FiniteNormalPanel59_12
...
def j0 : Jet := ⟨⟨1268770920, 1268770921⟩, ⟨181252988, 181252989⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3985961401, 3985961405⟩, ⟨569423055, 569423059⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3699187256, 3699187265⟩, ⟨1056910640, 1056910650⟩, ⟨75493616, 75493618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨925, 927⟩, ⟨264, 265⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93762), (-93759)⟩, ⟨264, 265⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-80756), (-80753)⟩, ⟨(-22847), (-22843)⟩, ⟨(-1570), (-1565)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5032300, 5032304⟩, ⟨(-22847), (-22843)⟩, ⟨(-1570), (-1565)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4334240, 4334244⟩, ⟨1218676, 1218682⟩, ⟨81477, 81486⟩, ⟨(-783), (-777)⟩, ⟨(-27), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-138831337), (-138831332)⟩, ⟨1218676, 1218682⟩, ⟨81477, 81486⟩, ⟨(-783), (-777)⟩, ⟨(-27), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-119573231), (-119573225)⟩, ⟨(-33114155), (-33114146)⟩, ⟨(-2070204), (-2070191)⟩, ⟨40794, 40806⟩, ⟨1215, 1223⟩⟩
...
def j19 : Jet := ⟨⟨1312082534, 1312082541⟩, ⟨(-33114155), (-33114146)⟩, ⟨(-2070204), (-2070191)⟩, ⟨40794, 40806⟩, ⟨1215, 1223⟩⟩
...
def j22 : Jet := ⟨⟨(-94), (-92)⟩, ⟨(-27), (-26)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11741, 11744⟩, ⟨(-27), (-26)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10112, 10115⟩, ⟨2865, 2868⟩, ⟨197, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842065), (-842061)⟩, ⟨2865, 2868⟩, ⟨197, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-725258), (-725253)⟩, ⟨(-204750), (-204744)⟩, ⟨(-13928), (-13921)⟩, ⟨96, 101⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35066136, 35066142⟩, ⟨(-204750), (-204744)⟩, ⟨(-13928), (-13921)⟩, ⟨96, 101⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨30201907, 30201913⟩, ⟨8452768, 8452776⟩, ⟨553983, 553994⟩, ⟨(-6945), (-6936)⟩, ⟨(-222), (-215)⟩⟩
...
def j33 : Jet := ⟨⟨(-685625976), (-685625969)⟩, ⟨8452768, 8452776⟩, ⟨553983, 553994⟩, ⟨(-6945), (-6936)⟩, ⟨(-222), (-215)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-590518788), (-590518779)⟩, ⟨(-161439419), (-161439407)⟩, ⟨(-9494201), (-9494186)⟩, ⟨278918, 278932⟩, ⟨7835, 7847⟩⟩
...
def j36 : Jet := ⟨⟨3704448508, 3704448517⟩, ⟨(-161439419), (-161439407)⟩, ⟨(-9494201), (-9494186)⟩, ⟨278918, 278932⟩, ⟨7835, 7847⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1217683389, 1217683398⟩, ⟨143223046, 143223058⟩, ⟨(-6311509), (-6311492)⟩, ⟨(-236607), (-236593)⟩, ⟨6535, 6547⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4979619500, 4979619513⟩, ⟨217011200, 217011219⟩, ⟨22219660, 22219685⟩, ⟨1149562, 1149587⟩, ⟨80154, 80178⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1411791878, 1411791894⟩, ⟨227579661, 227579683⟩, ⟨6218579, 6218610⟩, ⟨473642, 473673⟩, ⟨24025, 24053⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1268770921), (-1268770920)⟩, ⟨(-181252989), (-181252988)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3026196375, 3026196376⟩, ⟨(-181252989), (-181252988)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨464067865, 464067877⟩, ⟨149614696, 149614714⟩, ⟨16147079, 16147104⟩, ⟨970394, 970420⟩, ⟨74991, 75016⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4759035161, 4759035173⟩, ⟨149614696, 149614714⟩, ⟨16147079, 16147104⟩, ⟨970394, 970420⟩, ⟨74991, 75016⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4521050804, 4521050811⟩, ⟨71066468, 71066477⟩, ⟨7111259, 7111273⟩, ⟨349150, 349165⟩, ⟨24538, 24552⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3185492836, 3185492843⟩, ⟨(-140721185), (-140721176)⟩, ⟨2011435, 2011448⟩, ⟨(-54097), (-54085)⟩, ⟨2553, 2566⟩⟩
...
def j47 : Jet := ⟨⟨8085577615, 8085577624⟩, ⟨1155082512, 1155082520⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15221667794, 15221667829⟩, ⟨4349047924, 4349047960⟩, ⟨310646279, 310646284⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15221667794, 15221667829⟩, ⟨4349047924, 4349047960⟩, ⟨310646279, 310646284⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15221667829), (-15221667794)⟩, ⟨(-4349047960), (-4349047924)⟩, ⟨(-310646284), (-310646279)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7610833915), (-7610833897)⟩, ⟨(-2174523980), (-2174523962)⟩, ⟨(-155323142), (-155323139)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨730087111, 730087120⟩, ⟨(-369640056), (-369640047)⟩, ⟨67170742, 67170748⟩, ⟨(-2424318), (-2424316)⟩, ⟨(-907726), (-907725)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨541491262, 541491270⟩, ⟨(-298075490), (-298075479)⟩, ⟨62272097, 62272107⟩, ⟨(-4181176), (-4181166)⟩, ⟨(-557269), (-557259)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1087517931, 1450023909⟩, ⟨181252988, 181252989⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3416538342, 4555384461⟩, ⟨569423055, 569423059⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2717770226, 4831591526⟩, ⟨905923404, 1207897886⟩, ⟨75493616, 75493618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨680, 1211⟩, ⟨226, 303⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94007), (-93475)⟩, ⟨226, 303⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-105753), (-59149)⟩, ⟨(-26296), (-19375)⟩, ⟨(-1595), (-1535)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5007303, 5053908⟩, ⟨(-26296), (-19375)⟩, ⟨(-1595), (-1535)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3168522, 5685357⟩, ⟨1026592, 1409080⟩, ⟨78823, 83777⟩, ⟨(-909), (-649)⟩, ⟨(-28), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139997055), (-137480219)⟩, ⟨1026592, 1409080⟩, ⟨78823, 83777⟩, ⟨(-909), (-649)⟩, ⟨(-28), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-157488647), (-86994759)⟩, ⟨(-38722555), (-27413117)⟩, ⟨(-2194349), (-1925992)⟩, ⟨33646, 47920⟩, ⟨1097, 1325⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1274167118, 1344661007⟩, ⟨(-38722555), (-27413117)⟩, ⟨(-2194349), (-1925992)⟩, ⟨33646, 47920⟩, ⟨1097, 1325⟩⟩
...
def j70 : Jet := ⟨⟨(-122), (-67)⟩, ⟨(-31), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11713, 11769⟩, ⟨(-31), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7411, 13240⟩, ⟨2435, 3297⟩, ⟨193, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844766), (-838936)⟩, ⟨2435, 3297⟩, ⟨193, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-950314), (-530862)⟩, ⟨(-236039), (-173245)⟩, ⟨(-14214), (-13589)⟩, ⟨79, 116⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34841080, 35260533⟩, ⟨(-236039), (-173245)⟩, ⟨(-14214), (-13589)⟩, ⟨79, 116⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨22046745, 39666075⟩, ⟨7083384, 9806893⟩, ⟨530036, 574643⟩, ⟨(-8098), (-5780)⟩, ⟨(-234), (-200)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-693781138), (-676161807)⟩, ⟨7083384, 9806893⟩, ⟨530036, 574643⟩, ⟨(-8098), (-5780)⟩, ⟨(-234), (-200)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-780463933), (-427861797)⟩, ⟨(-190633759), (-131588406)⟩, ⟨(-10365279), (-8480560)⟩, ⟨227194, 330332⟩, ⟨6774, 8756⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3514503363, 3867105499⟩, ⟨(-190633759), (-131588406)⟩, ⟨(-10365279), (-8480560)⟩, ⟨227194, 330332⟩, ⟨6774, 8756⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1013567860, 1426191968⟩, ⟨127857552, 156467553⟩, ⟨(-7461203), (-5166485)⟩, ⟨(-264161), (-204520)⟩, ⟨5332, 7760⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4770168302, 5248748449⟩, ⟨162317485, 284702715⟩, ⟨15984252, 30922918⟩, ⟨451513, 2208627⟩, ⟨14211, 191315⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1125710382, 1742905677⟩, ⟨180309131, 285752946⟩, ⟨(-513937), 14902037⟩, ⟨(-235020), 1437534⟩, ⟨(-48516), 126519⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1450023909), (-1087517931)⟩, ⟨(-181252989), (-181252988)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2844943387, 3207449365⟩, ⟨(-181252989), (-181252988)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨295048547, 707274350⟩, ⟨94518000, 231918150⟩, ⟨7152532, 31106278⟩, ⟨(-259132), 3149634⟩, ⟨(-72434), 345675⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4590015843, 5002241646⟩, ⟨94518000, 231918150⟩, ⟨7152532, 31106278⟩, ⟨(-259132), 3149634⟩, ⟨(-72434), 345675⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4440041433, 4635133685⟩, ⟨43790723, 112170223⟩, ⟨1956548, 14829009⟩, ⟨(-499964), 1504066⟩, ⟨(-97796), 179391⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2941039044, 3461483074⟩, ⟨(-166601899), (-103607415)⟩, ⟨(-3437727), 9226170⟩, ⟨(-999173), 1040658⟩, ⟨(-136508), 155068⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6930495096, 9240660137⟩, ⟨1155082512, 1155082520⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11183266126, 19881362042⟩, ⟨3727755362, 4970340524⟩, ⟨310646279, 310646284⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11183266126, 19881362042⟩, ⟨3727755362, 4970340524⟩, ⟨310646279, 310646284⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19881362042), (-11183266126)⟩, ⟨(-4970340524), (-3727755362)⟩, ⟨(-310646284), (-310646279)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9940681021), (-5591633063)⟩, ⟨(-2485170262), (-1863877681)⟩, ⟨(-155323142), (-155323139)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨424411732, 1168289158⟩, ⟨(-675999903), (-184181042)⟩, ⟨(-2285671), 180226394⟩, ⟨(-30320613), 16738750⟩, ⟨(-5680213), 4427387⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨290621881, 941570184⟩, ⟨(-590132880), (-136358625)⟩, ⟨1665773, 173983238⟩, ⟨(-33151491), 14403229⟩, ⟨(-5572386), 5330940⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4521050804, 4521050811⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1170
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1087517931, 1450023909⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4440041433, 4635133685⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1171
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (11886295 / 1073741824)

theorem envelope_integral : (∫ s in ((101283 / 400000) : ℝ)..(33761 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((101283 / 400000) : ℝ)..(33761 / 100000), prawitzNormalCorrection
