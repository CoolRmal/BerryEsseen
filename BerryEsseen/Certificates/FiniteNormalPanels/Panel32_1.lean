...
namespace FiniteNormalPanel32_1

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38141 / 400000)
def radius : Rat := (38141 / 400000)

def j0 : Jet := ⟨⟨409535869, 409535870⟩, ⟨409535869, 409535870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1286594877, 1286594881⟩, ⟨1286594877, 1286594881⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨385410705, 385410709⟩, ⟨770821410, 770821418⟩, ⟨385410705, 385410709⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨96, 97⟩, ⟨192, 194⟩, ⟨96, 97⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94591), (-94589)⟩, ⟨192, 194⟩, ⟨96, 97⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8489), (-8487)⟩, ⟨(-16960), (-16957)⟩, ⟨(-8447), (-8443)⟩, ⟨34, 36⟩, ⟨8, 9⟩⟩
...
def j13 : Jet := ⟨⟨5104567, 5104570⟩, ⟨(-16960), (-16957)⟩, ⟨(-8447), (-8443)⟩, ⟨34, 36⟩, ⟨8, 9⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨458060, 458061⟩, ⟨914598, 914601⟩, ⟨454258, 454261⟩, ⟨(-3035), (-3032)⟩, ⟨(-752), (-749)⟩⟩
...
def j16 : Jet := ⟨⟨(-142707517), (-142707515)⟩, ⟨914598, 914601⟩, ⟨454258, 454261⟩, ⟨(-3035), (-3032)⟩, ⟨(-752), (-749)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12805920), (-12805919)⟩, ⟨(-25529768), (-25529765)⟩, ⟨(-12601014), (-12601010)⟩, ⟨163324, 163328⟩, ⟨40150, 40153⟩⟩
...
def j19 : Jet := ⟨⟨1418849845, 1418849847⟩, ⟨(-25529768), (-25529765)⟩, ⟨(-12601014), (-12601010)⟩, ⟨163324, 163328⟩, ⟨40150, 40153⟩⟩
...
def j25 : Jet := ⟨⟨1061, 1062⟩, ⟨2120, 2122⟩, ⟨1056, 1059⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851116), (-851114)⟩, ⟨2120, 2122⟩, ⟨1056, 1059⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-76376), (-76375)⟩, ⟨(-152561), (-152559)⟩, ⟨(-75902), (-75898)⟩, ⟨378, 382⟩, ⟨92, 96⟩⟩
...
def j30 : Jet := ⟨⟨35715018, 35715020⟩, ⟨(-152561), (-152559)⟩, ⟨(-75902), (-75898)⟩, ⟨378, 382⟩, ⟨92, 96⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3204902, 3204903⟩, ⟨6396113, 6396116⟩, ⟨3170709, 3170714⟩, ⟨(-27281), (-27275)⟩, ⟨(-6737), (-6732)⟩⟩
...
def j33 : Jet := ⟨⟨(-712622981), (-712622979)⟩, ⟨6396113, 6396116⟩, ⟨3170709, 3170714⟩, ⟨(-27281), (-27275)⟩, ⟨(-6737), (-6732)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-63947525), (-63947524)⟩, ⟨(-127321093), (-127321089)⟩, ⟨(-62515086), (-62515081)⟩, ⟨1140557, 1140563⟩, ⟨279022, 279027⟩⟩
...
def j36 : Jet := ⟨⟨4231019771, 4231019772⟩, ⟨(-127321093), (-127321089)⟩, ⟨(-62515086), (-62515081)⟩, ⟨1140557, 1140563⟩, ⟨279022, 279027⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨425028833, 425028836⟩, ⟨417381168, 417381173⟩, ⟨(-11422409), (-11422405)⟩, ⟨(-3725819), (-3725815)⟩, ⟨60952, 60956⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4359881321, 4359881323⟩, ⟨131198827, 131198834⟩, ⟨68367136, 68367145⟩, ⟨2820538, 2820549⟩, ⟨772134, 772146⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨431452707, 431452712⟩, ⟨436672857, 436672865⟩, ⟨7920332, 7920342⟩, ⟨2791924, 2791934⟩, ⟨116745, 116756⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-409535870), (-409535869)⟩, ⟨(-409535870), (-409535869)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3885431426, 3885431427⟩, ⟨(-409535870), (-409535869)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨43341759, 43341761⟩, ⟨87732302, 87732306⟩, ⟨45988168, 45988175⟩, ⟨2171458, 2171466⟩, ⟨605773, 605782⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4338309055, 4338309057⟩, ⟨87732302, 87732306⟩, ⟨45988168, 45988175⟩, ⟨2171458, 2171466⟩, ⟨605773, 605782⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316583777, 4316583779⟩, ⟨43646479, 43646482⟩, ⟨22658272, 22658277⟩, ⟨851185, 851191⟩, ⟨233293, 233301⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3904986721, 3904986725⟩, ⟨(-372112378), (-372112373)⟩, ⟨16335947, 16335954⟩, ⟨(-1390502), (-1390494)⟩, ⟨129883, 129894⟩⟩
...
def j47 : Jet := ⟨⟨2051348786, 2051348792⟩, ⟨2051348786, 2051348792⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨979758762, 979758768⟩, ⟨1959517524, 1959517536⟩, ⟨979758762, 979758768⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨979758762, 979758768⟩, ⟨1959517524, 1959517536⟩, ⟨979758762, 979758768⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-979758768), (-979758762)⟩, ⟨(-1959517536), (-1959517524)⟩, ⟨(-979758768), (-979758762)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-489879384), (-489879381)⟩, ⟨(-979758768), (-979758762)⟩, ⟨(-489879384), (-489879381)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3831992905, 3831992909⟩, ⟨(-874146040), (-874146033)⟩, ⟨(-337368858), (-337368852)⟩, ⟨92122728, 92122731⟩, ⟨13986255, 13986257⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3484050140, 3484050148⟩, ⟨(-1126774745), (-1126774731)⟩, ⟨(-216425660), (-216425644)⟩, ⟨108421953, 108421968⟩, ⟨3850573, 3850592⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 819071739⟩, ⟨409535869, 409535870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2573189759⟩, ⟨1286594877, 1286594881⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1541642830⟩, ⟨0, 1541642832⟩, ⟨385410705, 385410709⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 387⟩, ⟨0, 387⟩, ⟨96, 97⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94299)⟩, ⟨0, 387⟩, ⟨96, 97⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-33988), 0⟩, ⟨(-33988), 139⟩, ⟨(-8497), (-8287)⟩, ⟨0, 70⟩, ⟨8, 9⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5079068, 5113057⟩, ⟨(-33988), 139⟩, ⟨(-8497), (-8287)⟩, ⟨0, 70⟩, ⟨8, 9⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1835290⟩, ⟨(-12200), 1835340⟩, ⟨440522, 458873⟩, ⟨(-6100), 39⟩, ⟨(-763), (-713)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141330286)⟩, ⟨(-12200), 1835340⟩, ⟨440522, 458873⟩, ⟨(-6100), 39⟩, ⟨(-763), (-713)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-51388095), 0⟩, ⟨(-51392475), 658781⟩, ⟨(-12851404), (-11858842)⟩, ⟨(-3285), 329419⟩, ⟨37066, 41192⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1380267670, 1431655766⟩, ⟨(-51392475), 658781⟩, ⟨(-12851404), (-11858842)⟩, ⟨(-3285), 329419⟩, ⟨37066, 41192⟩⟩
...
def j70 : Jet := ⟨⟨(-39), 0⟩, ⟨(-39), 0⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11796, 11836⟩, ⟨(-39), 0⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 4249⟩, ⟨(-14), 4249⟩, ⟨1040, 1063⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-847927)⟩, ⟨(-14), 4249⟩, ⟨1040, 1063⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-305882), 0⟩, ⟨(-305888), 1526⟩, ⟨(-76477), (-74181)⟩, ⟨(-5), 764⟩, ⟨89, 96⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35485512, 35791395⟩, ⟨(-305888), 1526⟩, ⟨(-76477), (-74181)⟩, ⟨(-5), 764⟩, ⟨89, 96⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 12847024⟩, ⟨(-109796), 12847572⟩, ⟨3047060, 3212304⟩, ⟨(-54902), 412⟩, ⟨(-6865), (-6346)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-702980858)⟩, ⟨(-109796), 12847572⟩, ⟨3047060, 3212304⟩, ⟨(-54902), 412⟩, ⟨(-6865), (-6346)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-256940472), 0⟩, ⟨(-256979884), 4611530⟩, ⟨(-64274530), (-57317724)⟩, ⟨(-29560), 2306061⟩, ⟨251257, 288406⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4038026824, 4294967296⟩, ⟨(-256979884), 4611530⟩, ⟨(-64274530), (-57317724)⟩, ⟨(-29560), 2306061⟩, ⟨251257, 288406⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 857729921⟩, ⟨382681079, 429259649⟩, ⟨(-23094565), 197344⟩, ⟨(-3851720), (-3355058)⟩, ⟨(-985), 123360⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4568256943⟩, ⟨(-5217067), 290723711⟩, ⟨57005572, 91216016⟩, ⟨(-2796083), 10465966⟩, ⟨130605, 1853704⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 912307452⟩, ⟨381639200, 514632744⟩, ⟨(-25085496), 47482595⟩, ⟨(-1139269), 7879677⟩, ⟨(-1031703), 1556296⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-819071739), 0⟩, ⟨(-409535870), (-409535869)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3475895557, 4294967296⟩, ⟨(-409535870), (-409535869)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 193786083⟩, ⟨0, 218629506⟩, ⟨23254451, 81836320⟩, ⟨(-6495596), 14726440⟩, ⟨(-988647), 3074418⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4488753379⟩, ⟨0, 218629506⟩, ⟨23254451, 81836320⟩, ⟨(-6495596), 14726440⟩, ⟨(-988647), 3074418⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4390791383⟩, ⟨0, 109314753⟩, ⟨10012704, 40918160⟩, ⟨(-4289240), 7363220⟩, ⟨(-876646), 1634707⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3475895557, 4390791383⟩, ⟨(-418672937), (-300221116)⟩, ⟨(-2320205), 40918160⟩, ⟨(-8190889), 6408484⟩, ⟨(-1578748), 2043697⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4102697578⟩, ⟨2051348786, 2051348792⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3919035061⟩, ⟨0, 3919035068⟩, ⟨979758762, 979758768⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3919035061⟩, ⟨0, 3919035068⟩, ⟨979758762, 979758768⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3919035061), 0⟩, ⟨(-3919035068), 0⟩, ⟨(-979758768), (-979758762)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1959517531), 0⟩, ⟨(-1959517534), 0⟩, ⟨(-489879384), (-489879381)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2721568074, 4294967296⟩, ⟨(-1959517534), 0⟩, ⟨(-489879384), 136581809⟩, ⟨(-20771168), 223500478⟩, ⟨(-33281414), 30306697⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2202551433, 4390791383⟩, ⟨(-2421908844), (-190239447)⟩, ⟨(-503129183), 371560770⟩, ⟨(-61407786), 283707383⟩, ⟨(-64980361), 40089526⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨409535869, 409535870⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨409535869, 409535870⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316583777, 4316583779⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified624
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 819071739⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4390791383⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified625
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (652197021 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(38141 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(38141 / 200000), prawitzNormalCorrection
