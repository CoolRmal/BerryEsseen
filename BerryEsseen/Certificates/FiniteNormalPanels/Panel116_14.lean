...
namespace FiniteNormalPanel116_14
...
def j2 : Jet := ⟨⟨483809732, 483809737⟩, ⟨483809732, 483809737⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨54499101, 54499103⟩, ⟨108998202, 108998206⟩, ⟨54499101, 54499103⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1202), (-1201)⟩, ⟨(-2403), (-2401)⟩, ⟨(-1202), (-1199)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111854, 5111856⟩, ⟨(-2403), (-2401)⟩, ⟨(-1202), (-1199)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨64864, 64865⟩, ⟨129698, 129700⟩, ⟨64787, 64790⟩, ⟨(-62), (-59)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-143100713), (-143100711)⟩, ⟨129698, 129700⟩, ⟨64787, 64790⟩, ⟨(-62), (-59)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1815814), (-1815813)⟩, ⟨(-3629983), (-3629981)⟩, ⟨(-1811701), (-1811698)⟩, ⟨3288, 3291⟩, ⟨819, 822⟩⟩
...
def j19 : Jet := ⟨⟨1429839951, 1429839953⟩, ⟨(-3629983), (-3629981)⟩, ⟨(-1811701), (-1811698)⟩, ⟨3288, 3291⟩, ⟨819, 822⟩⟩
...
def j25 : Jet := ⟨⟨150, 151⟩, ⟨299, 301⟩, ⟨148, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852027), (-852025)⟩, ⟨299, 301⟩, ⟨148, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10812), (-10811)⟩, ⟨(-21620), (-21618)⟩, ⟨(-10804), (-10801)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780582, 35780584⟩, ⟨(-21620), (-21618)⟩, ⟨(-10804), (-10801)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨454021, 454023⟩, ⟨907768, 907771⟩, ⟨453334, 453338⟩, ⟨(-550), (-547)⟩, ⟨(-139), (-135)⟩⟩
...
def j33 : Jet := ⟨⟨(-715373862), (-715373859)⟩, ⟨907768, 907771⟩, ⟨453334, 453338⟩, ⟨(-550), (-547)⟩, ⟨(-139), (-135)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9077423), (-9077422)⟩, ⟨(-18143328), (-18143325)⟩, ⟨(-9048634), (-9048631)⟩, ⟨23015, 23018⟩, ⟨5736, 5739⟩⟩
...
def j36 : Jet := ⟨⟨4285889873, 4285889874⟩, ⟨(-18143328), (-18143325)⟩, ⟨(-9048634), (-9048631)⟩, ⟨23015, 23018⟩, ⟨5736, 5739⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨161065366, 161065369⟩, ⟨160656463, 160656468⟩, ⟨(-612984), (-612981)⟩, ⟨(-203711), (-203709)⟩, ⟨462, 464⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304063943, 4304063945⟩, ⟨18220260, 18220265⟩, ⟨9164131, 9164137⟩, ⟨54145, 54152⟩, ⟨13712, 13720⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨161406498, 161406503⟩, ⟨161680006, 161680013⟩, ⟨410922, 410928⟩, ⟨138077, 138083⟩, ⟨828, 835⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-154001422), (-154001421)⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4140965874, 4140965875⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6065717, 6065718⟩, ⟨12151990, 12151994⟩, ⟨6117175, 6117179⟩, ⟨41312, 41318⟩, ⟨10495, 10502⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301033013, 4301033014⟩, ⟨12151990, 12151994⟩, ⟨6117175, 6117179⟩, ⟨41312, 41318⟩, ⟨10495, 10502⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297999084, 4297999085⟩, ⟨6071709, 6071712⟩, ⟨3052141, 3052144⟩, ⟨16329, 16334⟩, ⟨4136, 4142⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4143888953, 4143888956⟩, ⟨(-148256131), (-148256125)⟩, ⟨2724993, 2724998⟩, ⟨(-93696), (-93689)⟩, ⟨3401, 3409⟩⟩
...
def j47 : Jet := ⟨⟨1334694363, 1334694373⟩, ⟨1334694363, 1334694373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨414766614, 414766621⟩, ⟨829533228, 829533242⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨414766614, 414766621⟩, ⟨829533228, 829533242⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-414766621), (-414766614)⟩, ⟨(-829533242), (-829533228)⟩, ⟨(-414766621), (-414766614)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-207383311), (-207383307)⟩, ⟨(-414766621), (-414766614)⟩, ⟨(-207383311), (-207383307)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4092511135, 4092511140⟩, ⟨(-395215354), (-395215346)⟩, ⟨(-178524630), (-178524624)⟩, ⟨18468761, 18468763⟩, ⟨3864163, 3864165⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3948554322, 3948554331⟩, ⟨(-522581025), (-522581010)⟩, ⟨(-156006098), (-156006083)⟩, ⟨23641493, 23641507⟩, ⟨2989315, 2989330⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 308002843⟩, ⟨154001421, 154001422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 967619469⟩, ⟨483809732, 483809737⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 217996407⟩, ⟨0, 217996408⟩, ⟨54499101, 54499103⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4806), 0⟩, ⟨(-4806), 3⟩, ⟨(-1202), (-1196)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108250, 5113057⟩, ⟨(-4806), 3⟩, ⟨(-1202), (-1196)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 259520⟩, ⟨(-244), 259521⟩, ⟨64512, 64881⟩, ⟨(-123), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142906056)⟩, ⟨(-244), 259521⟩, ⟨64512, 64881⟩, ⟨(-123), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7266547), 0⟩, ⟨(-7266560), 13173⟩, ⟨(-1816650), (-1796876)⟩, ⟨(-11), 6589⟩, ⟨810, 825⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424389218, 1431655766⟩, ⟨(-7266560), 13173⟩, ⟨(-1816650), (-1796876)⟩, ⟨(-11), 6589⟩, ⟨810, 825⟩⟩
...
def j72 : Jet := ⟨⟨0, 601⟩, ⟨(-1), 601⟩, ⟨148, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851575)⟩, ⟨(-1), 601⟩, ⟨148, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-43254), 0⟩, ⟨(-43255), 31⟩, ⟨(-10815), (-10766)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35748140, 35791395⟩, ⟨(-43255), 31⟩, ⟨(-10815), (-10766)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1816637⟩, ⟨(-2196), 1816639⟩, ⟨450865, 454162⟩, ⟨(-1099), 2⟩, ⟨(-140), (-134)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714011245)⟩, ⟨(-2196), 1816639⟩, ⟨450865, 454162⟩, ⟨(-1099), 2⟩, ⟨(-140), (-134)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-36332735), 0⟩, ⟨(-36332847), 92206⟩, ⟨(-9083296), (-8944874)⟩, ⟨(-84), 46105⟩, ⟨5657, 5764⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4258634561, 4294967296⟩, ⟨(-36332847), 92206⟩, ⟨(-9083296), (-8944874)⟩, ⟨(-84), 46105⟩, ⟨5657, 5764⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 322539824⟩, ⟨158814271, 161272881⟩, ⟨(-1227823), 1484⟩, ⟨(-204641), (-200925)⟩, ⟨(-2), 929⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4331610006⟩, ⟨(-93787), 36955443⟩, ⟨8944080, 9554235⟩, ⟨(-47305), 160423⟩, ⟨12015, 16045⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 325291588⟩, ⟨158807227, 165424037⟩, ⟨(-1241821), 2106643⟩, ⟨110218, 169905⟩, ⟨(-6273), 8175⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-308002843), 0⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3986964453, 4294967296⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 24636886⟩, ⟨0, 25057722⟩, ⟨5683821, 6690543⟩, ⟨(-95660), 188018⟩, ⟨6588, 15364⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4319604182⟩, ⟨0, 25057722⟩, ⟨5683821, 6690543⟩, ⟨(-95660), 188018⟩, ⟨6588, 15364⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307268125⟩, ⟨0, 12528861⟩, ⟨2815572, 3345272⟩, ⟨(-57589), 94009⟩, ⟨1711, 6928⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3986964453, 4307268125⟩, ⟨(-154442484), (-141472560)⟩, ⟨2164422, 3345272⟩, ⟨(-177538), (-6946)⟩, ⟨(-1783), 8993⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2669388737⟩, ⟨1334694363, 1334694373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1659066470⟩, ⟨0, 1659066476⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1659066470⟩, ⟨0, 1659066476⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1659066470), 0⟩, ⟨(-1659066476), 0⟩, ⟨(-414766621), (-414766614)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-829533235), 0⟩, ⟨(-829533238), 0⟩, ⟨(-207383311), (-207383307)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3540624712, 4294967296⟩, ⟨(-829533238), 0⟩, ⟨(-207383311), (-90851393)⟩, ⟨0, 40054170⟩, ⟨259365, 5006772⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3286717661, 4307268125⟩, ⟨(-986351514), (-116625158)⟩, ⟨(-206192984), (-51161801)⟩, ⟨2168920, 47620445⟩, ⟨(-1362852), 5018612⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297999084, 4297999085⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2342
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307268125⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2343
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (279503487 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(5737 / 80000), prawitzNormalCorrection
