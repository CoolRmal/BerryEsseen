...
namespace FiniteNormalPanel80_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (31963 / 800000)
def radius : Rat := (31963 / 800000)

def j0 : Jet := ⟨⟨171600049, 171600050⟩, ⟨171600049, 171600050⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨539097453, 539097457⟩, ⟨539097453, 539097457⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨67666653, 67666655⟩, ⟨135333306, 135333310⟩, ⟨67666653, 67666655⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨16, 17⟩, ⟨33, 34⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94671), (-94669)⟩, ⟨33, 34⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1492), (-1491)⟩, ⟨(-2984), (-2981)⟩, ⟨(-1491), (-1488)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111564, 5111566⟩, ⟨(-2984), (-2981)⟩, ⟨(-1491), (-1488)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨80532, 80533⟩, ⟨161016, 161019⟩, ⟨80413, 80417⟩, ⟨(-95), (-91)⟩, ⟨(-24), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-143085045), (-143085043)⟩, ⟨161016, 161019⟩, ⟨80413, 80417⟩, ⟨(-95), (-91)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2254287), (-2254286)⟩, ⟨(-4506037), (-4506035)⟩, ⟨(-2247948), (-2247945)⟩, ⟨5067, 5070⟩, ⟨1262, 1265⟩⟩
...
def j19 : Jet := ⟨⟨1429401478, 1429401480⟩, ⟨(-4506037), (-4506035)⟩, ⟨(-2247948), (-2247945)⟩, ⟨5067, 5070⟩, ⟨1262, 1265⟩⟩
...
def j25 : Jet := ⟨⟨186, 187⟩, ⟨371, 373⟩, ⟨184, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851991), (-851989)⟩, ⟨371, 373⟩, ⟨184, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13424), (-13422)⟩, ⟨(-26842), (-26839)⟩, ⟨(-13411), (-13407)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35777970, 35777973⟩, ⟨(-26842), (-26839)⟩, ⟨(-13411), (-13407)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨563677, 563678⟩, ⟨1126931, 1126933⟩, ⟨562619, 562622⟩, ⟨(-846), (-843)⟩, ⟨(-212), (-209)⟩⟩
...
def j33 : Jet := ⟨⟨(-715264206), (-715264204)⟩, ⟨1126931, 1126933⟩, ⟨562619, 562622⟩, ⟨(-846), (-843)⟩, ⟨(-212), (-209)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11268896), (-11268894)⟩, ⟨(-22520037), (-22520034)⟩, ⟨(-11224524), (-11224519)⟩, ⟨35467, 35471⟩, ⟨8832, 8836⟩⟩
...
def j36 : Jet := ⟨⟨4283698400, 4283698402⟩, ⟨(-22520037), (-22520034)⟩, ⟨(-11224524), (-11224519)⟩, ⟨35467, 35471⟩, ⟨8832, 8836⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨179416196, 179416199⟩, ⟨178850605, 178850609⟩, ⟨(-847750), (-847748)⟩, ⟨(-281523), (-281521)⟩, ⟨794, 796⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306265834, 4306265837⟩, ⟨22638674, 22638679⟩, ⟨11402665, 11402673⟩, ⟨83606, 83614⟩, ⟨21245, 21254⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨179888176, 179888180⟩, ⟨180266795, 180266801⟩, ⟨569066, 569071⟩, ⟨191587, 191593⟩, ⟨1429, 1436⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-171600050), (-171600049)⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4123367246, 4123367247⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7534342, 7534344⟩, ⟨15100400, 15100404⟩, ⟨7613759, 7613763⟩, ⟨63816, 63820⟩, ⟨16275, 16282⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302501638, 4302501640⟩, ⟨15100400, 15100404⟩, ⟨7613759, 7613763⟩, ⟨63816, 63820⟩, ⟨16275, 16282⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298732816, 4298732818⟩, ⟨7543586, 7543589⟩, ⟨3796925, 3796929⟩, ⟨25216, 25220⟩, ⟨6408, 6414⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4126982319, 4126982323⟩, ⟨(-164508306), (-164508300)⟩, ⟨3343828, 3343834⟩, ⟨(-127494), (-127488)⟩, ⟨5143, 5151⟩⟩
...
def j47 : Jet := ⟨⟨1211745364, 1211745373⟩, ⟨1211745364, 1211745373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨341871480, 341871486⟩, ⟨683742960, 683742972⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨341871480, 341871486⟩, ⟨683742960, 683742972⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-341871486), (-341871480)⟩, ⟨(-683742972), (-683742960)⟩, ⟨(-341871486), (-341871480)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-170935743), (-170935740)⟩, ⟨(-341871486), (-341871480)⟩, ⟨(-170935743), (-170935740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4127388414, 4127388418⟩, ⟨(-328532516), (-328532509)⟩, ⟨(-151190967), (-151190962)⟩, ⟨12728367, 12728369⟩, ⟨2755341, 2755343⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3965957790, 3965957799⟩, ⟨(-473772541), (-473772525)⟩, ⟨(-129480579), (-129480565)⟩, ⟨17643237, 17643251⟩, ⟨2057026, 2057042⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 343200100⟩, ⟨171600049, 171600050⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1078194913⟩, ⟨539097453, 539097457⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 270666618⟩, ⟨0, 270666618⟩, ⟨67666653, 67666655⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 68⟩, ⟨0, 68⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94618)⟩, ⟨0, 68⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5968), 0⟩, ⟨(-5968), 5⟩, ⟨(-1492), (-1483)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107088, 5113057⟩, ⟨(-5968), 5⟩, ⟨(-1492), (-1483)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 322223⟩, ⟨(-377), 322224⟩, ⟨79989, 80557⟩, ⟨(-190), 2⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142843353)⟩, ⟨(-377), 322224⟩, ⟨79989, 80557⟩, ⟨(-190), 2⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9022221), 0⟩, ⟨(-9022245), 20307⟩, ⟨(-2255580), (-2225094)⟩, ⟨(-18), 10155⟩, ⟨1246, 1271⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422633544, 1431655766⟩, ⟨(-9022245), 20307⟩, ⟨(-2255580), (-2225094)⟩, ⟨(-18), 10155⟩, ⟨1246, 1271⟩⟩
...
def j72 : Jet := ⟨⟨0, 746⟩, ⟨(-1), 746⟩, ⟨184, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851430)⟩, ⟨(-1), 746⟩, ⟨184, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-53704), 0⟩, ⟨(-53705), 48⟩, ⟨(-13427), (-13354)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35737690, 35791395⟩, ⟨(-53705), 48⟩, ⟨(-13427), (-13354)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2255556⟩, ⟨(-3385), 2255560⟩, ⟨558810, 563893⟩, ⟨(-1695), 3⟩, ⟨(-213), (-207)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713572326)⟩, ⟨(-3385), 2255560⟩, ⟨558810, 563893⟩, ⟨(-1695), 3⟩, ⟨(-213), (-207)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-45111104), 0⟩, ⟨(-45111318), 142145⟩, ⟨(-11277990), (-11064557)⟩, ⟨(-161), 71075⟩, ⟨8682, 8886⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4249856192, 4294967296⟩, ⟨(-45111318), 142145⟩, ⟨(-11277990), (-11064557)⟩, ⟨(-161), 71075⟩, ⟨8682, 8886⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 359398305⟩, ⟨176301780, 179704251⟩, ⟨(-1698692), 2549⟩, ⟨(-283122), (-276740)⟩, ⟨(-3), 1595⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4340557243⟩, ⟨(-145179), 46074091⟩, ⟨11063032, 12007754⟩, ⟨(-73381), 249895⟩, ⟨17985, 25748⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 363213224⟩, ⟨176289631, 185467197⟩, ⟨(-1722799), 2935145⟩, ⟨143628, 246642⟩, ⟨(-10863), 14241⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-343200100), 0⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3951767196, 4294967296⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 30715914⟩, ⟨0, 31368872⟩, ⟨6944532, 8505362⟩, ⟨(-148790), 295210⟩, ⟨8774, 25718⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4325683210⟩, ⟨0, 31368872⟩, ⟨6944532, 8505362⟩, ⟨(-148790), 295210⟩, ⟨8774, 25718⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4310297893⟩, ⟨0, 15684436⟩, ⟨3431379, 4252681⟩, ⟨(-89926), 147605⟩, ⟨1735, 11818⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3951767196, 4310297893⟩, ⟨(-172212565), (-155915613)⟩, ⟨2530533, 4252681⟩, ⟨(-259837), 10509⟩, ⟨(-4302), 15411⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2423490745⟩, ⟨1211745364, 1211745373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1367485941⟩, ⟨0, 1367485942⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1367485941⟩, ⟨0, 1367485942⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1367485941), 0⟩, ⟨(-1367485942), 0⟩, ⟨(-341871486), (-341871480)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-683742971), 0⟩, ⟨(-683742971), 0⟩, ⟨(-170935743), (-170935740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3662872314, 4294967296⟩, ⟨(-683742971), 0⟩, ⟨(-170935743), (-91354260)⟩, ⟨0, 27212341⟩, ⟨734881, 3401543⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3370181343, 4310297893⟩, ⟨(-858396111), (-132969343)⟩, ⟨(-169387776), (-52386082)⟩, ⟨2379487, 34173885⟩, ⟨(-590186), 3416638⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨171600049, 171600050⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298732816, 4298732818⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1622
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 343200100⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4310297893⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1623
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (156757777 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(31963 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (31963 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(31963 / 400000), prawitzNormalCorrection
