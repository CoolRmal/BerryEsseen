...
namespace FiniteNormalPanel135_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (196483 / 800000)
def radius : Rat := (28069 / 800000)

def j0 : Jet := ⟨⟨1054860074, 1054860075⟩, ⟨150694296, 150694297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3313940658, 3313940663⟩, ⟨473420093, 473420097⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2556993319, 2556993328⟩, ⟨730569518, 730569526⟩, ⟨52183536, 52183538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨639, 641⟩, ⟨182, 184⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94048), (-94045)⟩, ⟨182, 184⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-55992), (-55989)⟩, ⟨(-15890), (-15886)⟩, ⟨(-1106), (-1101)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5057064, 5057068⟩, ⟨(-15890), (-15886)⟩, ⟨(-1106), (-1101)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3010704, 3010708⟩, ⟨850740, 850746⟩, ⟨58080, 58087⟩, ⟨(-381), (-376)⟩, ⟨(-14), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140154873), (-140154868)⟩, ⟨850740, 850746⟩, ⟨58080, 58087⟩, ⟨(-381), (-376)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-83440700), (-83440696)⟩, ⟨(-23333716), (-23333709)⟩, ⟨(-1523586), (-1523577)⟩, ⟨19988, 19995⟩, ⟨631, 638⟩⟩
...
def j19 : Jet := ⟨⟨1348215065, 1348215070⟩, ⟨(-23333716), (-23333709)⟩, ⟨(-1523586), (-1523577)⟩, ⟨19988, 19995⟩, ⟨631, 638⟩⟩
...
def j25 : Jet := ⟨⟨7007, 7010⟩, ⟨1990, 1993⟩, ⟨137, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845170), (-845166)⟩, ⟨1990, 1993⟩, ⟨137, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-503169), (-503166)⟩, ⟨(-142579), (-142574)⟩, ⟨(-9850), (-9844)⟩, ⟨45, 49⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35288225, 35288229⟩, ⟨(-142579), (-142574)⟩, ⟨(-9850), (-9844)⟩, ⟨45, 49⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21008717, 21008721⟩, ⟨5917606, 5917612⟩, ⟨398631, 398639⟩, ⟨(-3383), (-3376)⟩, ⟨(-114), (-108)⟩⟩
...
def j33 : Jet := ⟨⟨(-694819166), (-694819161)⟩, ⟨5917606, 5917612⟩, ⟨398631, 398639⟩, ⟨(-3383), (-3376)⟩, ⟨(-114), (-108)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-413658091), (-413658086)⟩, ⟨(-114665002), (-114664994)⟩, ⟨(-7198101), (-7198092)⟩, ⟨137689, 137699⟩, ⟨4199, 4206⟩⟩
...
def j36 : Jet := ⟨⟨3881309205, 3881309210⟩, ⟨(-114665002), (-114664994)⟩, ⟨(-7198101), (-7198092)⟩, ⟨137689, 137699⟩, ⟨4199, 4206⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1040265131, 1040265138⟩, ⟨130605313, 130605322⟩, ⟨(-3747579), (-3747569)⟩, ⟨(-152518), (-152510)⟩, ⟨2689, 2697⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4752711797, 4752711805⟩, ⟨140408721, 140408735⟩, ⟨12962228, 12962243⟩, ⟨474721, 474738⟩, ⟨27928, 27944⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1151133412, 1151133423⟩, ⟨178532606, 178532622⟩, ⟨3262216, 3262234⟩, ⟨217860, 217876⟩, ⟨7876, 7896⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1054860075), (-1054860074)⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3240107221, 3240107222⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨308525779, 308525786⟩, ⟨95700308, 95700320⟩, ⟨9169890, 9169904⟩, ⟨387986, 388000⟩, ⟨24807, 24826⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4603493075, 4603493082⟩, ⟨95700308, 95700320⟩, ⟨9169890, 9169904⟩, ⟨387986, 388000⟩, ⟨24807, 24826⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4446555094, 4446555098⟩, ⟨46218891, 46218898⟩, ⟨4188432, 4188440⟩, ⟨143843, 143851⟩, ⟨8511, 8524⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3354464487, 3354464492⟩, ⟨(-121145587), (-121145579)⟩, ⟨1538089, 1538097⟩, ⟨(-38443), (-38435)⟩, ⟨1372, 1385⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨38411221756, 38411221763⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value564

def j47 : Jet := ⟨⟨9433940105, 9433940116⟩, ⟨1347705726, 1347705736⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20721747052, 20721747101⟩, ⟨5920499142, 5920499196⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20721747052, 20721747101⟩, ⟨5920499142, 5920499196⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20721747101), (-20721747052)⟩, ⟨(-5920499196), (-5920499142)⟩, ⟨(-422892802), (-422892794)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10360873551), (-10360873526)⟩, ⟨(-2960249598), (-2960249571)⟩, ⟨(-211446401), (-211446397)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨384856428, 384856438⟩, ⟨(-265257228), (-265257217)⟩, ⟨72465574, 72465581⟩, ⟨(-7942695), (-7942692)⟩, ⟨(-415186), (-415184)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨300581385, 300581394⟩, ⟨(-218027182), (-218027170)⟩, ⟨64216989, 64217000⟩, ⟨(-8345853), (-8345847)⟩, ⟨(-71791), (-71780)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨904165777, 1205554371⟩, ⟨150694296, 150694297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2840520562, 3787360756⟩, ⟨473420093, 473420097⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1878607334, 3339746384⟩, ⟨626202442, 834936602⟩, ⟨52183536, 52183538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨470, 837⟩, ⟨156, 210⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94217), (-93849)⟩, ⟨156, 210⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-73263), (-41049)⟩, ⟨(-18248), (-13519)⟩, ⟨(-1118), (-1088)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5039793, 5072008⟩, ⟨(-18248), (-13519)⟩, ⟨(-1118), (-1088)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2204392, 3943970⟩, ⟨720607, 980080⟩, ⟨56815, 59179⟩, ⟨(-440), (-317)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140961185), (-139221606)⟩, ⟨720607, 980080⟩, ⟨56815, 59179⟩, ⟨(-440), (-317)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-109610755), (-60895162)⟩, ⟨(-27087498), (-19536281)⟩, ⟨(-1582756), (-1454987)⟩, ⟨16695, 23275⟩, ⟨593, 670⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1322045010, 1370760604⟩, ⟨(-27087498), (-19536281)⟩, ⟨(-1582756), (-1454987)⟩, ⟨16695, 23275⟩, ⟨593, 670⟩⟩
...
def j70 : Jet := ⟨⟨(-84), (-46)⟩, ⟨(-21), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11751, 11790⟩, ⟨(-21), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5139, 9168⟩, ⟨1696, 2286⟩, ⟨135, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847038), (-843008)⟩, ⟨1696, 2286⟩, ⟨135, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-658653), (-368729)⟩, ⟨(-163923), (-121131)⟩, ⟨(-9986), (-9686)⟩, ⟨37, 56⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35132741, 35422666⟩, ⟨(-163923), (-121131)⟩, ⟨(-9986), (-9686)⟩, ⟨37, 56⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15366967, 27544499⟩, ⟨4994856, 6833143⟩, ⟨387227, 408487⟩, ⟨(-3918), (-2839)⟩, ⟨(-118), (-104)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700460916), (-688283383)⟩, ⟨4994856, 6833143⟩, ⟨387227, 408487⟩, ⟨(-3918), (-2839)⟩, ⟨(-118), (-104)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-544675117), (-301053331)⟩, ⟨(-133984045), (-95037689)⟩, ⟨(-7612932), (-6716599)⟩, ⟨114097, 161192⟩, ⟨3850, 4506⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3750292179, 3993913965⟩, ⟨(-133984045), (-95037689)⟩, ⟨(-7612932), (-6716599)⟩, ⟨114097, 161192⟩, ⟨3850, 4506⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨874347992, 1208755402⟩, ⟨121838539, 138173907⟩, ⟨(-4381462), (-3115689)⟩, ⟨(-163421), (-139853)⟩, ⟨2232, 3157⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4618713431, 4918748512⟩, ⟨109905183, 175728661⟩, ⟨10382590, 16262984⟩, ⟨233369, 797223⟩, ⟨10368, 53412⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨940254613, 1384309455⟩, ⟨153396434, 207697897⟩, ⟨213591, 6879823⟩, ⟨(-24386), 517444⟩, ⟨(-12148), 33188⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1205554371), (-904165777)⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3089412925, 3390801519⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨205840621, 446176312⟩, ⟨67163120, 133886078⟩, ⟨5572131, 14478814⟩, ⟨(-464), 998952⟩, ⟨(-10182), 82461⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4500807917, 4741143608⟩, ⟨67163120, 133886078⟩, ⟨5572131, 14478814⟩, ⟨(-464), 998952⟩, ⟨(-10182), 82461⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4396683159, 4512544376⟩, ⟨31962389, 65394334⟩, ⟨2177895, 6955749⟩, ⟨(-103684), 472089⟩, ⟨(-17498), 41280⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3162578162, 3562574817⟩, ⟨(-135337395), (-102635441)⟩, ⟨(-727861), 4370003⟩, ⟨(-325909), 296293⟩, ⟨(-30379), 36228⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8086234369, 10781645843⟩, ⟨1347705726, 1347705736⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15224140666, 27065139051⟩, ⟨5074713546, 6766284792⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15224140666, 27065139051⟩, ⟨5074713546, 6766284792⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-27065139051), (-15224140666)⟩, ⟨(-6766284792), (-5074713546)⟩, ⟨(-422892802), (-422892794)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13532569526), (-7612070333)⟩, ⟨(-3383142396), (-2537356773)⟩, ⟨(-211446401), (-211446397)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨183901876, 729876973⟩, ⟨(-574923524), (-108644522)⟩, ⟨(-3840519), 217379697⟩, ⟨(-53510807), 19877842⟩, ⟨(-9265373), 10632143⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨135415246, 605415862⟩, ⟨(-499884533), (-84394505)⟩, ⟨(-713071), 199170238⟩, ⟨(-51876100), 16757007⟩, ⟨(-8393439), 10776239⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1054860074, 1054860075⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4446555094, 4446555098⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar564 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2720
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar564 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨904165777, 1205554371⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4396683159, 4512544376⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2721
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((84207 / 400000) : ℝ)..(28069 / 100000), prawitzNormalCorrection
      ((11951 / 5000) * sqrt n) s) ≤ (upper : ℝ) :=
