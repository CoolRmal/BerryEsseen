...
namespace FiniteNormalPanel74_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (252049 / 800000)
def radius : Rat := (36007 / 800000)

def j0 : Jet := ⟨⟨1353177764, 1353177765⟩, ⟨193311109, 193311110⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4251133322, 4251133326⟩, ⟨607304759, 607304764⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4207746712, 4207746721⟩, ⟨1202213342, 1202213356⟩, ⟨85872381, 85872383⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1053, 1055⟩, ⟨300, 302⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93634), (-93631)⟩, ⟨300, 302⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-91733), (-91729)⟩, ⟨(-25917), (-25912)⟩, ⟨(-1770), (-1765)⟩, ⟨10, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5021323, 5021328⟩, ⟨(-25917), (-25912)⟩, ⟨(-1770), (-1765)⟩, ⟨10, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4919351, 4919357⟩, ⟨1380138, 1380146⟩, ⟨91404, 91414⟩, ⟨(-1006), (-998)⟩, ⟨(-34), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-138246226), (-138246219)⟩, ⟨1380138, 1380146⟩, ⟨91404, 91414⟩, ⟨(-1006), (-998)⟩, ⟨(-34), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-135438774), (-135438766)⟩, ⟨(-37344683), (-37344671)⟩, ⟨(-2288193), (-2288178)⟩, ⟨52193, 52206⟩, ⟨1511, 1520⟩⟩
...
def j19 : Jet := ⟨⟨1296216991, 1296217000⟩, ⟨(-37344683), (-37344671)⟩, ⟨(-2288193), (-2288178)⟩, ⟨52193, 52206⟩, ⟨1511, 1520⟩⟩
...
def j25 : Jet := ⟨⟨11490, 11494⟩, ⟨3252, 3256⟩, ⟨222, 226⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840687), (-840682)⟩, ⟨3252, 3256⟩, ⟨222, 226⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-823615), (-823609)⟩, ⟨(-232134), (-232127)⟩, ⟨(-15682), (-15674)⟩, ⟨125, 130⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨34967779, 34967786⟩, ⟨(-232134), (-232127)⟩, ⟨(-15682), (-15674)⟩, ⟨125, 130⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨34257666, 34257674⟩, ⟨9560484, 9560494⟩, ⟨618794, 618807⟩, ⟨(-8910), (-8900)⟩, ⟨(-279), (-271)⟩⟩
...
def j33 : Jet := ⟨⟨(-681570217), (-681570208)⟩, ⟨9560484, 9560494⟩, ⟨618794, 618807⟩, ⟨(-8910), (-8900)⟩, ⟨(-279), (-271)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-667729147), (-667729136)⟩, ⟨(-181413425), (-181413408)⟩, ⟨(-10344804), (-10344785)⟩, ⟨355626, 355643⟩, ⟨9602, 9617⟩⟩
...
def j36 : Jet := ⟨⟨3627238149, 3627238160⟩, ⟨(-181413425), (-181413408)⟩, ⟨(-10344804), (-10344785)⟩, ⟨355626, 355643⟩, ⟨9602, 9617⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1282987939, 1282987951⟩, ⟨146320443, 146320459⟩, ⟨(-7545347), (-7545330)⟩, ⟨(-271889), (-271872)⟩, ⟨8875, 8887⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5085617006, 5085617023⟩, ⟨254353056, 254353084⟩, ⟨27225305, 27225337⟩, ⟨1588423, 1588455⟩, ⟨118664, 118695⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1519169956, 1519169976⟩, ⟨249236271, 249236302⟩, ⟨7863632, 7863667⟩, ⟨633213, 633249⟩, ⟨36137, 36168⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1353177765), (-1353177764)⟩, ⟨(-193311110), (-193311109)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2941789531, 2941789532⟩, ⟨(-193311110), (-193311109)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨537344570, 537344585⟩, ⟨176314382, 176314408⟩, ⟨20026019, 20026051⟩, ⟨1360596, 1360630⟩, ⟨113449, 113480⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4832311866, 4832311881⟩, ⟨176314382, 176314408⟩, ⟨20026019, 20026051⟩, ⟨1360596, 1360630⟩, ⟨113449, 113480⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4555724029, 4555724037⟩, ⟨83111323, 83111336⟩, ⟨8681781, 8681798⟩, ⟨482974, 482993⟩, ⟨36393, 36410⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3120391921, 3120391929⟩, ⟨(-148121281), (-148121268)⟩, ⟨2205750, 2205764⟩, ⟨(-59950), (-59935)⟩, ⟨3187, 3201⟩⟩
...
def j47 : Jet := ⟨⟨7598234503, 7598234511⟩, ⟨1085462071, 1085462077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13442050563, 13442050593⟩, ⟨3840585872, 3840585898⟩, ⟨274327562, 274327566⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13442050563, 13442050593⟩, ⟨3840585872, 3840585898⟩, ⟨274327562, 274327566⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13442050593), (-13442050563)⟩, ⟨(-3840585898), (-3840585872)⟩, ⟨(-274327566), (-274327562)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6721025297), (-6721025281)⟩, ⟨(-1920292949), (-1920292936)⟩, ⟨(-137163783), (-137163781)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨898151327, 898151340⟩, ⟨(-401566198), (-401566188)⟩, ⟨61087431, 61087436⟩, ⟨(-554533), (-554531)⟩, ⟨(-913460), (-913458)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨652527470, 652527482⟩, ⟨(-322721725), (-322721712)⟩, ⟨58691556, 58691567⟩, ⟨(-2728384), (-2728374)⟩, ⟨(-606885), (-606874)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1159866655, 1546488875⟩, ⟨193311109, 193311110⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3643828562, 4858438089⟩, ⟨607304759, 607304764⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3091405748, 5495832457⟩, ⟨1030468580, 1373958122⟩, ⟨85872381, 85872383⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨773, 1377⟩, ⟨257, 345⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93914), (-93309)⟩, ⟨257, 345⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-120173), (-67161)⟩, ⟨(-29860), (-21945)⟩, ⟨(-1802), (-1725)⟩, ⟨10, 15⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4992883, 5045896⟩, ⟨(-29860), (-21945)⟩, ⟨(-1802), (-1725)⟩, ⟨10, 15⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3593747, 6456720⟩, ⟨1159706, 1598385⟩, ⟨87967, 94381⟩, ⟨(-1168), (-831)⟩, ⟨(-35), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139571830), (-136708856)⟩, ⟨1159706, 1598385⟩, ⟨87967, 94381⟩, ⟨(-1168), (-831)⟩, ⟨(-35), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-178595864), (-98399478)⟩, ⟨(-43814241), (-30754535)⟩, ⟨(-2449003), (-2101225)⟩, ⟨42796, 61553⟩, ⟨1339, 1670⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1253059901, 1333256288⟩, ⟨(-43814241), (-30754535)⟩, ⟨(-2449003), (-2101225)⟩, ⟨42796, 61553⟩, ⟨1339, 1670⟩⟩
...
def j70 : Jet := ⟨⟨(-139), (-77)⟩, ⟨(-35), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11696, 11759⟩, ⟨(-35), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8418, 15047⟩, ⟨2761, 3745⟩, ⟨217, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843759), (-837129)⟩, ⟨2761, 3745⟩, ⟨217, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1079673), (-602543)⟩, ⟨(-267932), (-196054)⟩, ⟨(-16052), (-15243)⟩, ⟨104, 149⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34711721, 35188852⟩, ⟨(-267932), (-196054)⟩, ⟨(-16052), (-15243)⟩, ⟨104, 149⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨24984593, 45027592⟩, ⟨7985351, 11115785⟩, ⟨587763, 645548⟩, ⟨(-10419), (-7385)⟩, ⟨(-297), (-249)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-690843290), (-670800290)⟩, ⟨7985351, 11115785⟩, ⟨587763, 645548⟩, ⟨(-10419), (-7385)⟩, ⟨(-297), (-249)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-884001837), (-482824601)⟩, ⟨(-215252814), (-146717794)⟩, ⟨(-11473591), (-9029816)⟩, ⟨287341, 423442⟩, ⟨8036, 10957⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3410965459, 3812142695⟩, ⟨(-215252814), (-146717794)⟩, ⟨(-11473591), (-9029816)⟩, ⟨287341, 423442⟩, ⟨8036, 10957⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1063089691, 1508170537⟩, ⟨127619239, 162429326⟩, ⟨(-8965593), (-6131333)⟩, ⟨(-309980), (-227482)⟩, ⟨7187, 10594⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4838943751, 5408071204⟩, ⟨186236247, 341282420⟩, ⟨18629664, 39728343⟩, ⟨557421, 3247456⟩, ⟨12126, 311485⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1197734665, 1899035101⟩, ⟨189879944, 324366022⟩, ⟨(-1144186), 19949446⟩, ⟨(-411205), 2120651⟩, ⟨(-79903), 209074⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1546488875), (-1159866655)⟩, ⟨(-193311110), (-193311109)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2748478421, 3135100641⟩, ⟨(-193311110), (-193311109)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨334011467, 839665140⟩, ⟨105903386, 286839186⟩, ⟨7382755, 42138323⟩, ⟨(-536456), 4888568⟩, ⟨(-138087), 597863⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4628978763, 5134632436⟩, ⟨105903386, 286839186⟩, ⟨7382755, 42138323⟩, ⟨(-536456), 4888568⟩, ⟨(-138087), 597863⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4458846532, 4696070527⟩, ⟨48428955, 138148389⟩, ⟨1344071, 20031791⟩, ⟨(-879016), 2339850⟩, ⟨(-184000), 314978⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2853349660, 3427884942⟩, ⟨(-180373125), (-99846036)⟩, ⟨(-5357776), 12442430⟩, ⟨(-1543242), 1647474⟩, ⟨(-239625), 269482⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6512772432, 8683696588⟩, ⟨1085462071, 1085462077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9875792253, 17556964055⟩, ⟨3291930748, 4389241028⟩, ⟨274327562, 274327566⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9875792253, 17556964055⟩, ⟨3291930748, 4389241028⟩, ⟨274327562, 274327566⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17556964055), (-9875792253)⟩, ⟨(-4389241028), (-3291930748)⟩, ⟨(-274327566), (-274327562)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8778482028), (-4937896126)⟩, ⟨(-2194620514), (-1645965374)⟩, ⟨(-137163783), (-137163781)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨556295480, 1360361418⟩, ⟨(-695110549), (-213189771)⟩, ⟨(-2593927), 159826211⟩, ⟨(-22683453), 15241147⟩, ⟨(-4499061), 2939089⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨369573365, 1085727108⟩, ⟨(-611909578), (-154564356)⟩, ⟨1188822, 160693036⟩, ⟨(-27318685), 13662080⟩, ⟨(-4772757), 4096492⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1353177764, 1353177765⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4555724029, 4555724037⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1484
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1159866655, 1546488875⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4458846532, 4696070527⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1485
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (30286867 / 2147483648)

theorem envelope_integral : (∫ s in ((108021 / 400000) : ℝ)..(36007 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((108021 / 400000) : ℝ)..(36007 / 100000), prawitzNormalCorrection
