...
namespace FiniteNormalPanel125_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (14047 / 80000)
def radius : Rat := (14047 / 400000)

def j0 : Jet := ⟨⟨754142570, 754142571⟩, ⟨150828514, 150828515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2369208757, 2369208761⟩, ⟨473841751, 473841755⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1306913358, 1306913364⟩, ⟨522765342, 522765350⟩, ⟨52276534, 52276536⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨327, 328⟩, ⟨130, 131⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94360), (-94358)⟩, ⟨130, 131⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-28713), (-28712)⟩, ⟨(-11447), (-11444)⟩, ⟨(-1131), (-1127)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5084343, 5084345⟩, ⟨(-11447), (-11444)⟩, ⟨(-1131), (-1127)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1547112, 1547113⟩, ⟨615360, 615364⟩, ⟨60145, 60151⟩, ⟨(-278), (-274)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-141618465), (-141618463)⟩, ⟨615360, 615364⟩, ⟨60145, 60151⟩, ⟨(-278), (-274)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-43093010), (-43093008)⟩, ⟨(-17049957), (-17049954)⟩, ⟨(-1630521), (-1630516)⟩, ⟨14724, 14729⟩, ⟨693, 697⟩⟩
...
def j19 : Jet := ⟨⟨1388562755, 1388562758⟩, ⟨(-17049957), (-17049954)⟩, ⟨(-1630521), (-1630516)⟩, ⟨14724, 14729⟩, ⟨693, 697⟩⟩
...
def j22 : Jet := ⟨⟨(-33), (-32)⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11802, 11804⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3591, 3592⟩, ⟨1431, 1434⟩, ⟨140, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848586), (-848584)⟩, ⟨1431, 1434⟩, ⟨140, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-258216), (-258215)⟩, ⟨(-102852), (-102849)⟩, ⟨(-10113), (-10109)⟩, ⟨33, 36⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35533178, 35533180⟩, ⟨(-102852), (-102849)⟩, ⟨(-10113), (-10109)⟩, ⟨33, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10812372, 10812373⟩, ⟨4293651, 4293655⟩, ⟨416897, 416901⟩, ⟨(-2473), (-2470)⟩, ⟨(-121), (-117)⟩⟩
...
def j33 : Jet := ⟨⟨(-705015511), (-705015509)⟩, ⟨4293651, 4293655⟩, ⟨416897, 416901⟩, ⟨(-2473), (-2470)⟩, ⟨(-121), (-117)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-214528804), (-214528801)⟩, ⟨(-84505010), (-84505005)⟩, ⟨(-7931691), (-7931687)⟩, ⟨102249, 102254⟩, ⟨4735, 4740⟩⟩
...
def j36 : Jet := ⟨⟨4080438492, 4080438495⟩, ⟨(-84505010), (-84505005)⟩, ⟨(-7931691), (-7931687)⟩, ⟨102249, 102254⟩, ⟨4735, 4740⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨765965096, 765965100⟩, ⟨143787846, 143787851⟩, ⟨(-2780471), (-2780466)⟩, ⟨(-171766), (-171761)⟩, ⟨2006, 2010⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4520774935, 4520774939⟩, ⟨93624277, 93624285⟩, ⟨10726563, 10726573⟩, ⟨290844, 290854⟩, ⟨19274, 19286⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨806235663, 806235669⟩, ⟨168044450, 168044458⟩, ⟨2120694, 2120706⟩, ⟨169567, 169577⟩, ⟨4594, 4606⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-754142571), (-754142570)⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3540824725, 3540824726⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨151343630, 151343633⟩, ⟨63089386, 63089392⟩, ⟨7371065, 7371075⟩, ⟨229608, 229616⟩, ⟨16039, 16048⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4446310926, 4446310929⟩, ⟨63089386, 63089392⟩, ⟨7371065, 7371075⟩, ⟨229608, 229616⟩, ⟨16039, 16048⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4369983983, 4369983985⟩, ⟨31003185, 31003189⟩, ⟨3512287, 3512294⟩, ⟨87914, 87920⟩, ⟨5845, 5852⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3602669419, 3602669423⟩, ⟨(-127903501), (-127903495)⟩, ⟨1806818, 1806826⟩, ⟨(-50866), (-50859)⟩, ⟨1730, 1738⟩⟩
...
def j47 : Jet := ⟨⟨6813166557, 6813166568⟩, ⟨1362633311, 1362633321⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10807821185, 10807821221⟩, ⟨4323128472, 4323128512⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10807821185, 10807821221⟩, ⟨4323128472, 4323128512⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10807821221), (-10807821185)⟩, ⟨(-4323128512), (-4323128472)⟩, ⟨(-432312854), (-432312847)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5403910611), (-5403910592)⟩, ⟨(-2161564256), (-2161564236)⟩, ⟨(-216156427), (-216156423)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1220484547, 1220484566⟩, ⟨(-614243516), (-614243500)⟩, ⟨93143388, 93143397⟩, ⟨4983345, 4983349⟩, ⟨(-2970856), (-2970854)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1023756888, 1023756906⟩, ⟨(-551580588), (-551580570)⟩, ⟨96935293, 96935307⟩, ⟨1133433, 1133444⟩, ⟨(-2593447), (-2593437)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨603314056, 904971085⟩, ⟨150828514, 150828515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1895367006, 2843050513⟩, ⟨473841751, 473841755⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨836424549, 1881955243⟩, ⟨418212274, 627318418⟩, ⟨52276534, 52276536⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨209, 472⟩, ⟨104, 158⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94478), (-94214)⟩, ⟨104, 158⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-41399), (-18347)⟩, ⟨(-13780), (-9103)⟩, ⟨(-1138), (-1115)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5071657, 5094710⟩, ⟨(-13780), (-9103)⟩, ⟨(-1138), (-1115)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨987681, 2232384⟩, ⟨487801, 742356⟩, ⟨59218, 60908⟩, ⟨(-335), (-215)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142177896), (-140933192)⟩, ⟨487801, 742356⟩, ⟨59218, 60908⟩, ⟨(-335), (-215)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-62299063), (-27446071)⟩, ⟨(-20671359), (-13397751)⟩, ⟨(-1671500), (-1580262)⟩, ⟨11556, 17892⟩, ⟨664, 720⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1369356702, 1404209695⟩, ⟨(-20671359), (-13397751)⟩, ⟨(-1671500), (-1580262)⟩, ⟨11556, 17892⟩, ⟨664, 720⟩⟩
...
def j70 : Jet := ⟨⟨(-48), (-20)⟩, ⟨(-16), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11787, 11816⟩, ⟨(-16), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2295, 5178⟩, ⟨1139, 1725⟩, ⟨139, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849882), (-846998)⟩, ⟨1139, 1725⟩, ⟨139, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-372399), (-164948)⟩, ⟨(-123912), (-81718)⟩, ⟨(-10208), (-9993)⟩, ⟨25, 43⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35418995, 35626447⟩, ⟨(-123912), (-81718)⟩, ⟨(-10208), (-9993)⟩, ⟨25, 43⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6897681, 15610685⟩, ⟨3394544, 5187648⟩, ⟨408533, 423728⟩, ⟨(-2996), (-1948)⟩, ⟨(-124), (-113)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708930202), (-700217197)⟩, ⟨3394544, 5187648⟩, ⟨408533, 423728⟩, ⟨(-2996), (-1948)⟩, ⟨(-124), (-113)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-310636804), (-136363984)⟩, ⟨(-102884531), (-65908884)⟩, ⟨(-8218707), (-7579377)⟩, ⟨79782, 124653⟩, ⟨4479, 4947⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3984330492, 4158603312⟩, ⟨(-102884531), (-65908884)⟩, ⟨(-8218707), (-7579377)⟩, ⟨79782, 124653⟩, ⟨4479, 4947⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨604296455, 929515598⟩, ⟨137390721, 149006847⟩, ⟨(-3387015), (-2175473)⟩, ⟨(-179310), (-162498)⟩, ⟨1567, 2451⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4435802765, 4629822780⟩, ⟨70302162, 119552620⟩, ⟨9198798, 12637325⟩, ⟨135142, 484111⟩, ⟨9814, 32178⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨624111826, 1001984927⟩, ⟨151787299, 186497653⟩, ⟨(-107945), 4635842⟩, ⟨25702, 339769⟩, ⟨(-7637), 19085⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-904971085), (-603314056)⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3389996211, 3691653240⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨90691161, 233755865⟩, ⟨44113140, 87017118⟩, ⟨5313908, 10261188⟩, ⟨(-1908), 561132⟩, ⟨(-1865), 43418⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4385658457, 4528723161⟩, ⟨44113140, 87017118⟩, ⟨5313908, 10261188⟩, ⟨(-1908), 561132⟩, ⟨(-1865), 43418⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4340075995, 4410296801⟩, ⟨21479789, 43056352⟩, ⟨2377301, 5024116⟩, ⟨(-50787), 265885⟩, ⟨(-6470), 21338⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3425600281, 3790782410⟩, ⟨(-137924709), (-115404391)⟩, ⟨364359, 3564063⟩, ⟨(-220088), 145053⟩, ⟨(-14900), 20125⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5450533246, 8175799880⟩, ⟨1362633311, 1362633321⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6917005559, 15563262552⟩, ⟨3458502778, 5187754214⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6917005559, 15563262552⟩, ⟨3458502778, 5187754214⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15563262552), (-6917005559)⟩, ⟨(-5187754214), (-3458502778)⟩, ⟨(-432312854), (-432312847)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7781631276), (-3458502779)⟩, ⟨(-2593877107), (-1729251389)⟩, ⟨(-216156427), (-216156423)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨701623542, 1919756810⟩, ⟨(-1159406556), (-282489574)⟩, ⟨(-39748855), 314791368⟩, ⟨(-53893019), 46902182⟩, ⟨(-15002842), 9137195⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨559604215, 1694397151⟩, ⟨(-1084953520), (-244161766)⟩, ⟨(-27432825), 316663304⟩, ⟨(-58735940), 42713681⟩, ⟨(-14826641), 10124885⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨754142570, 754142571⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4369983983, 4369983985⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2518
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨603314056, 904971085⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4340075995, 4410296801⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2519
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (9289401 / 536870912)

theorem envelope_integral : (∫ s in ((14047 / 100000) : ℝ)..(42141 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (14047 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (42141 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((14047 / 100000) : ℝ)..(42141 / 200000), prawitzNormalCorrection
