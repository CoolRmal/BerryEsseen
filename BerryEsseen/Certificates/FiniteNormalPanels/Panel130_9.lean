...
namespace FiniteNormalPanel130_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (13727 / 400000)
def radius : Rat := (13727 / 400000)

def j0 : Jet := ⟨⟨147392540, 147392541⟩, ⟨147392540, 147392541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨463047320, 463047325⟩, ⟨463047320, 463047325⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨49921875, 49921877⟩, ⟨99843750, 99843754⟩, ⟨49921875, 49921877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨12, 13⟩, ⟨24, 26⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94675), (-94673)⟩, ⟨24, 26⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1101), (-1100)⟩, ⟨(-2201), (-2199)⟩, ⟨(-1101), (-1098)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111955, 5111957⟩, ⟨(-2201), (-2199)⟩, ⟨(-1101), (-1098)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨59418, 59419⟩, ⟨118810, 118812⟩, ⟨59353, 59356⟩, ⟨(-52), (-49)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-143106159), (-143106157)⟩, ⟨118810, 118812⟩, ⟨59353, 59356⟩, ⟨(-52), (-49)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1663372), (-1663371)⟩, ⟨(-3325364), (-3325362)⟩, ⟨(-1659922), (-1659919)⟩, ⟨2758, 2761⟩, ⟨686, 689⟩⟩
...
def j19 : Jet := ⟨⟨1429992393, 1429992395⟩, ⟨(-3325364), (-3325362)⟩, ⟨(-1659922), (-1659919)⟩, ⟨2758, 2761⟩, ⟨686, 689⟩⟩
...
def j25 : Jet := ⟨⟨137, 138⟩, ⟨274, 276⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852040), (-852038)⟩, ⟨274, 276⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9904), (-9903)⟩, ⟨(-19805), (-19803)⟩, ⟨(-9897), (-9894)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781490, 35781492⟩, ⟨(-19805), (-19803)⟩, ⟨(-9897), (-9894)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨415900, 415901⟩, ⟨831570, 831572⟩, ⟨415323, 415326⟩, ⟨(-462), (-459)⟩, ⟨(-117), (-113)⟩⟩
...
def j33 : Jet := ⟨⟨(-715411983), (-715411981)⟩, ⟨831570, 831572⟩, ⟨415323, 415326⟩, ⟨(-462), (-459)⟩, ⟨(-117), (-113)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8315479), (-8315478)⟩, ⟨(-16621293), (-16621290)⟩, ⟨(-8291321), (-8291318)⟩, ⟨19313, 19316⟩, ⟨4814, 4817⟩⟩
...
def j36 : Jet := ⟨⟨4286651817, 4286651818⟩, ⟨(-16621293), (-16621290)⟩, ⟨(-8291321), (-8291318)⟩, ⟨19313, 19316⟩, ⟨4814, 4817⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨154169775, 154169778⟩, ⟨153811262, 153811266⟩, ⟨(-537472), (-537470)⟩, ⟨(-178662), (-178660)⟩, ⟨370, 373⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303298904, 4303298906⟩, ⟨16685837, 16685842⟩, ⟨8388214, 8388220⟩, ⟨45405, 45412⟩, ⟨11487, 11495⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨154468841, 154468845⟩, ⟨154708578, 154708584⟩, ⟨360135, 360140⟩, ⟨120929, 120936⟩, ⟨663, 671⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-147392541), (-147392540)⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4147574755, 4147574756⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5555484, 5555485⟩, ⟨11128212, 11128214⟩, ⟨5598645, 5598649⟩, ⟨34642, 34646⟩, ⟨8786, 8795⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300522780, 4300522781⟩, ⟨11128212, 11128214⟩, ⟨5598645, 5598649⟩, ⟨34642, 34646⟩, ⟨8786, 8795⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297744140, 4297744141⟩, ⟨5560510, 5560512⟩, ⟨2793916, 2793920⟩, ⟨13694, 13698⟩, ⟨3463, 3470⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4150256304, 4150256307⟩, ⟨(-142118149), (-142118144)⟩, ⟨2507212, 2507218⟩, ⟨(-82657), (-82652)⟩, ⟨2873, 2882⟩⟩
...
def j47 : Jet := ⟨⟨1650103823, 1650103835⟩, ⟨1650103823, 1650103835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨633961201, 633961211⟩, ⟨1267922402, 1267922422⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨633961201, 633961211⟩, ⟨1267922402, 1267922422⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-633961211), (-633961201)⟩, ⟨(-1267922422), (-1267922402)⟩, ⟨(-633961211), (-633961201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-316980606), (-316980600)⟩, ⟨(-633961211), (-633961201)⟩, ⟨(-316980606), (-316980600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3989401192, 3989401198⟩, ⟨(-588857945), (-588857934)⟩, ⟨(-250969611), (-250969602)⟩, ⟨41321080, 41321083⟩, ⟨7736323, 7736325⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3854985685, 3854985695⟩, ⟨(-701024597), (-701024579)⟩, ⟨(-220699828), (-220699810)⟩, ⟨47812762, 47812775⟩, ⟨5975861, 5975878⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 294785081⟩, ⟨147392540, 147392541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 926094645⟩, ⟨463047320, 463047325⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 199687503⟩, ⟨0, 199687504⟩, ⟨49921875, 49921877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 51⟩, ⟨0, 51⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94635)⟩, ⟨0, 51⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4403), 0⟩, ⟨(-4403), 3⟩, ⟨(-1101), (-1095)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108653, 5113057⟩, ⟨(-4403), 3⟩, ⟨(-1101), (-1095)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 237724⟩, ⟨(-205), 237725⟩, ⟨59122, 59432⟩, ⟨(-104), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142927852)⟩, ⟨(-205), 237725⟩, ⟨59122, 59432⟩, ⟨(-104), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6656251), 0⟩, ⟨(-6656261), 11053⟩, ⟨(-1664073), (-1647482)⟩, ⟨(-8), 5529⟩, ⟨681, 692⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424999514, 1431655766⟩, ⟨(-6656261), 11053⟩, ⟨(-1664073), (-1647482)⟩, ⟨(-8), 5529⟩, ⟨681, 692⟩⟩
...
def j72 : Jet := ⟨⟨0, 551⟩, ⟨(-1), 551⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851625)⟩, ⟨(-1), 551⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-39621), 0⟩, ⟨(-39622), 26⟩, ⟨(-9907), (-9865)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35751773, 35791395⟩, ⟨(-39622), 26⟩, ⟨(-9907), (-9865)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1664063⟩, ⟨(-1843), 1664065⟩, ⟨413251, 416018⟩, ⟨(-923), 2⟩, ⟨(-118), (-112)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714163819)⟩, ⟨(-1843), 1664065⟩, ⟨413251, 416018⟩, ⟨(-923), 2⟩, ⟨(-118), (-112)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-33281251), 0⟩, ⟨(-33281337), 77368⟩, ⟨(-8320399), (-8204259)⟩, ⟨(-65), 38686⟩, ⟨4754, 4837⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4261686045, 4294967296⟩, ⟨(-33281337), 77368⟩, ⟨(-8320399), (-8204259)⟩, ⟨(-65), 38686⟩, ⟨4754, 4837⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 308698216⟩, ⟨152196240, 154351493⟩, ⟨(-1076436), 1192⟩, ⟨(-179409), (-176424)⟩, ⟨(-1), 747⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4328508454⟩, ⟨(-78582), 33803183⟩, ⟨8203650, 8714846⟩, ⟨(-39606), 134123⟩, ⟨10183, 13273⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 311108967⟩, ⟨152190591, 157986472⟩, ⟨(-1087668), 1842388⟩, ⟨98573, 146430⟩, ⟨(-5024), 6535⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-294785081), 0⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4000182215, 4294967296⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22535397⟩, ⟨0, 22887722⟩, ⟨5235245, 6078299⟩, ⟨(-80018), 156756⟩, ⟨5789, 12513⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317502693⟩, ⟨0, 22887722⟩, ⟨5235245, 6078299⟩, ⟨(-80018), 156756⟩, ⟨5789, 12513⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306220253⟩, ⟨0, 11443861⟩, ⟨2595576, 3039150⟩, ⟨(-48107), 78378⟩, ⟨1605, 5602⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4000182215, 4306220253⟩, ⟨(-147778715), (-135948679)⟩, ⟨2024703, 3039150⟩, ⟨(-152404), (-10695)⟩, ⟨(-1196), 7253⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3300207659⟩, ⟨1650103823, 1650103835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2535844826⟩, ⟨0, 2535844834⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2535844826⟩, ⟨0, 2535844834⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2535844826), 0⟩, ⟨(-2535844834), 0⟩, ⟨(-633961211), (-633961201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1267922413), 0⟩, ⟨(-1267922417), 0⟩, ⟨(-316980606), (-316980600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3197063551, 4294967296⟩, ⟨(-1267922417), 0⟩, ⟨(-316980606), (-48799788)⟩, ⟨0, 93576223⟩, ⟨(-5105407), 11697028⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2977633093, 4306220253⟩, ⟨(-1419023131), (-101196711)⟩, ⟨(-316303969), 1214667⟩, ⟨495064, 104719918⟩, ⟨(-8563994), 11756916⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨147392540, 147392541⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297744140, 4297744141⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2614
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 294785081⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306220253⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2615
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (259699087 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(13727 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (13727 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(13727 / 200000), prawitzNormalCorrection
