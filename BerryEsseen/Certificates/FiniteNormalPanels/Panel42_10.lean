...
namespace FiniteNormalPanel42_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (242081 / 800000)
def radius : Rat := (34583 / 800000)

def j0 : Jet := ⟨⟨1299662472, 1299662473⟩, ⟨185666067, 185666068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4083010074, 4083010078⟩, ⟨583287152, 583287156⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3881512969, 3881512978⟩, ⟨1109003702, 1109003712⟩, ⟨79214550, 79214552⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨971, 973⟩, ⟨277, 278⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93716), (-93713)⟩, ⟨277, 278⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-84695), (-84691)⟩, ⟨(-23949), (-23945)⟩, ⟨(-1641), (-1637)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5028361, 5028366⟩, ⟨(-23949), (-23945)⟩, ⟨(-1641), (-1637)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4544306, 4544312⟩, ⟨1276729, 1276736⟩, ⟨85072, 85081⟩, ⟨(-858), (-852)⟩, ⟨(-29), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-138621271), (-138621264)⟩, ⟨1276729, 1276736⟩, ⟨85072, 85081⟩, ⟨(-858), (-852)⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-125276918), (-125276910)⟩, ⟨(-34639582), (-34639570)⟩, ⟨(-2150126), (-2150113)⟩, ⟨44737, 44748⟩, ⟨1320, 1329⟩⟩
...
def j19 : Jet := ⟨⟨1306378847, 1306378856⟩, ⟨(-34639582), (-34639570)⟩, ⟨(-2150126), (-2150113)⟩, ⟨44737, 44748⟩, ⟨1320, 1329⟩⟩
...
def j25 : Jet := ⟨⟨10607, 10610⟩, ⟨3004, 3008⟩, ⟨206, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841570), (-841566)⟩, ⟨3004, 3008⟩, ⟨206, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-760557), (-760552)⟩, ⟨(-214588), (-214581)⟩, ⟨(-14561), (-14553)⟩, ⟨106, 111⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35030837, 35030843⟩, ⟨(-214588), (-214581)⟩, ⟨(-14561), (-14553)⟩, ⟨106, 111⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨31658599, 31658605⟩, ⟨8851383, 8851392⟩, ⟨577524, 577536⟩, ⟨(-7623), (-7613)⟩, ⟨(-242), (-235)⟩⟩
...
def j33 : Jet := ⟨⟨(-684169284), (-684169277)⟩, ⟨8851383, 8851392⟩, ⟨577524, 577536⟩, ⟨(-7623), (-7613)⟩, ⟨(-242), (-235)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-618307841), (-618307833)⟩, ⟨(-168660078), (-168660065)⟩, ⟨(-9811084), (-9811068)⟩, ⟨305483, 305498⟩, ⟨8463, 8475⟩⟩
...
def j36 : Jet := ⟨⟨3676659455, 3676659463⟩, ⟨(-168660078), (-168660065)⟩, ⟨(-9811084), (-9811068)⟩, ⟨305483, 305498⟩, ⟨8463, 8475⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1241908872, 1241908883⟩, ⟨144485438, 144485454⟩, ⟨(-6748320), (-6748304)⟩, ⟨(-249474), (-249460)⟩, ⟨7329, 7342⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5017256631, 5017256643⟩, ⟨230157521, 230157541⟩, ⟨23946472, 23946499⟩, ⟨1295778, 1295805⟩, ⟨92651, 92674⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1450762041, 1450762058⟩, ⟨235334780, 235334807⟩, ⟨6783680, 6783712⟩, ⟨527196, 527227⟩, ⟨27946, 27976⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1299662473), (-1299662472)⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2995304823, 2995304824⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨490041100, 490041112⟩, ⟨158983638, 158983660⟩, ⟨17477541, 17477567⟩, ⟨1099552, 1099578⟩, ⟨87364, 87393⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4785008396, 4785008408⟩, ⟨158983638, 158983660⟩, ⟨17477541, 17477567⟩, ⟨1099552, 1099578⟩, ⟨87364, 87393⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4533371214, 4533371221⟩, ⟨75311450, 75311462⟩, ⟨7653647, 7653661⟩, ⟨393715, 393729⟩, ⟨28383, 28399⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3161567417, 3161567424⟩, ⟨(-143449861), (-143449850)⟩, ⟨2082022, 2082035⟩, ⟨(-56283), (-56270)⟩, ⟨2773, 2787⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨26700592725, 26700592731⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value273

def j47 : Jet := ⟨⟨8079632731, 8079632740⟩, ⟨1154233244, 1154233252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15199292699, 15199292734⟩, ⟨4342655044, 4342655080⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15199292699, 15199292734⟩, ⟨4342655044, 4342655080⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15199292734), (-15199292699)⟩, ⟨(-4342655080), (-4342655044)⟩, ⟨(-310189650), (-310189645)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7599646367), (-7599646349)⟩, ⟨(-2171327540), (-2171327522)⟩, ⟨(-155094825), (-155094822)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨731991320, 731991332⟩, ⟨(-370059381), (-370059371)⟩, ⟨67109237, 67109242⟩, ⟨(-2400295), (-2400293)⟩, ⟨(-908318), (-908316)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨538825967, 538825978⟩, ⟨(-296852491), (-296852479)⟩, ⟨62114409, 62114419⟩, ⟨(-4197282), (-4197274)⟩, ⟨(-550603), (-550594)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1113996404, 1485328540⟩, ⟨185666067, 185666068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3499722918, 4666297230⟩, ⟨583287152, 583287156⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2851723810, 5069731232⟩, ⟨950574600, 1267432814⟩, ⟨79214550, 79214552⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨713, 1271⟩, ⟨237, 318⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93974), (-93415)⟩, ⟨237, 318⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-110926), (-62024)⟩, ⟨(-27575), (-20298)⟩, ⟨(-1670), (-1604)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5002130, 5051033⟩, ⟨(-27575), (-20298)⟩, ⟨(-1670), (-1604)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3321257, 5962183⟩, ⟨1074535, 1477069⟩, ⟨82147, 87603⟩, ⟨(-997), (-714)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139844320), (-137203393)⟩, ⟨1074535, 1477069⟩, ⟨82147, 87603⟩, ⟨(-997), (-714)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-165070668), (-91098757)⟩, ⟨(-40554210), (-28622736)⟩, ⟨(-2286868), (-1991236)⟩, ⟨36822, 52621⟩, ⟨1184, 1443⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1266585097, 1340557009⟩, ⟨(-40554210), (-28622736)⟩, ⟨(-2286868), (-1991236)⟩, ⟨36822, 52621⟩, ⟨1184, 1443⟩⟩
...
def j70 : Jet := ⟨⟨(-128), (-71)⟩, ⟨(-32), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11707, 11765⟩, ⟨(-32), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7773, 13888⟩, ⟨2553, 3457⟩, ⟨202, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844404), (-838288)⟩, ⟨2553, 3457⟩, ⟨202, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-996726), (-556596)⟩, ⟨(-247487), (-181451)⟩, ⟨(-14875), (-14189)⟩, ⟨88, 127⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34794668, 35234799⟩, ⟨(-247487), (-181451)⟩, ⟨(-14875), (-14189)⟩, ⟨88, 127⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨23102570, 41590762⟩, ⟨7408725, 10277214⟩, ⟨551146, 600276⟩, ⟨(-8897), (-6336)⟩, ⟨(-256), (-218)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692725313), (-674237120)⟩, ⟨7408725, 10277214⟩, ⟨551146, 600276⟩, ⟨(-8897), (-6336)⟩, ⟨(-256), (-218)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-817685192), (-447672337)⟩, ⟨(-199502138), (-137093002)⟩, ⟨(-10770669), (-8694004)⟩, ⟨248122, 362483⟩, ⟨7236, 9526⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3477282104, 3847294959⟩, ⟨(-199502138), (-137093002)⟩, ⟨(-10770669), (-8694004)⟩, ⟨248122, 362483⟩, ⟨7236, 9526⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1032067670, 1456457530⟩, ⟨127950873, 158734164⟩, ⟨(-7992135), (-5509715)⟩, ⟨(-280569), (-213253)⟩, ⟨5964, 8715⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4794730913, 5304931703⟩, ⟨170853562, 304359897⟩, ⟨16923119, 33893746⟩, ⟨489300, 2545196⟩, ⟨13864, 228843⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1152159357, 1798944484⟩, ⟨183894866, 299271467⟩, ⟨(-715039), 16591400⟩, ⟨(-291172), 1658506⟩, ⟨(-58389), 152242⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1485328540), (-1113996404)⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2809638756, 3180970892⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨309075970, 753486822⟩, ⟨98662538, 250699352⟩, ⟨7274720, 34751703⟩, ⟨(-343564), 3701494⟩, ⟨(-92255), 422755⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4604043266, 5048454118⟩, ⟨98662538, 250699352⟩, ⟨7274720, 34751703⟩, ⟨(-343564), 3701494⟩, ⟨(-92255), 422755⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4446820803, 4656494963⟩, ⟨45501216, 121069138⟩, ⟨1781054, 16549697⟩, ⟨(-616499), 1769323⟩, ⟨(-123521), 220589⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2908976764, 3448728225⟩, ⟨(-171528928), (-102563370)⟩, ⟨(-4068556), 10290201⟩, ⟨(-1172020), 1233418⟩, ⟨(-167970), 190026⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6925399480, 9233865985⟩, ⟨1154233244, 1154233252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11166827277, 19852137433⟩, ⟨3722275750, 4963034376⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11166827277, 19852137433⟩, ⟨3722275750, 4963034376⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19852137433), (-11166827277)⟩, ⟨(-4963034376), (-3722275750)⟩, ⟨(-310189650), (-310189645)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9926068717), (-5583413638)⟩, ⟨(-2481517188), (-1861137875)⟩, ⟨(-155094825), (-155094822)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨425858121, 1170527091⟩, ⟨(-676299235), (-184537069)⟩, ⟨(-2285985), 179995713⟩, ⟨(-30223046), 16721411⟩, ⟨(-5665194), 4406792⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨288433250, 939897685⟩, ⟨(-589795299), (-135156206)⟩, ⟨1462325, 174345016⟩, ⟨(-33396456), 14494879⟩, ⟨(-5627290), 5413133⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1299662472, 1299662473⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨185666067, 185666068⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4533371214, 4533371221⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar273 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified828
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar273 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1113996404, 1485328540⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4446820803, 4656494963⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified829
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((103749 / 400000) : ℝ)..(34583 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (103749 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (34583 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((103749 / 400000) : ℝ)..(34583 / 100000), prawitzNormalCorrection
      ((13901 / 5000) * sqrt n) s) ≤ (upper : ℝ) :=
