...
namespace FiniteNormalPanel12_21

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38239 / 800000)
def radius : Rat := (38239 / 800000)

def j0 : Jet := ⟨⟨205294068, 205294069⟩, ⟨205294068, 205294069⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨644950335, 644950340⟩, ⟨644950335, 644950340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨96848452, 96848454⟩, ⟨193696904, 193696908⟩, ⟨96848452, 96848454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨24, 25⟩, ⟨48, 49⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94663), (-94661)⟩, ⟨48, 49⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2135), (-2134)⟩, ⟨(-4269), (-4267)⟩, ⟨(-2133), (-2130)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110921, 5110923⟩, ⟨(-4269), (-4267)⟩, ⟨(-2133), (-2130)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨115247, 115248⟩, ⟨230398, 230400⟩, ⟨115005, 115008⟩, ⟨(-194), (-191)⟩, ⟨(-49), (-46)⟩⟩
...
def j16 : Jet := ⟨⟨(-143050330), (-143050328)⟩, ⟨230398, 230400⟩, ⟨115005, 115008⟩, ⟨(-194), (-191)⟩, ⟨(-49), (-46)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3225684), (-3225682)⟩, ⟨(-6446172), (-6446169)⟩, ⟨(-3212701), (-3212697)⟩, ⟨10376, 10379⟩, ⟨2582, 2585⟩⟩
...
def j19 : Jet := ⟨⟨1428430081, 1428430084⟩, ⟨(-6446172), (-6446169)⟩, ⟨(-3212701), (-3212697)⟩, ⟨10376, 10379⟩, ⟨2582, 2585⟩⟩
...
def j25 : Jet := ⟨⟨266, 267⟩, ⟨532, 534⟩, ⟨264, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851911), (-851909)⟩, ⟨532, 534⟩, ⟨264, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-19210), (-19209)⟩, ⟨(-38409), (-38406)⟩, ⟨(-19182), (-19177)⟩, ⟨21, 26⟩, ⟨3, 7⟩⟩
...
def j30 : Jet := ⟨⟨35772184, 35772186⟩, ⟨(-38409), (-38406)⟩, ⟨(-19182), (-19177)⟩, ⟨21, 26⟩, ⟨3, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨806637, 806638⟩, ⟨1612407, 1612409⟩, ⟨804471, 804474⟩, ⟨(-1733), (-1729)⟩, ⟨(-433), (-429)⟩⟩
...
def j33 : Jet := ⟨⟨(-715021246), (-715021244)⟩, ⟨1612407, 1612409⟩, ⟨804471, 804474⟩, ⟨(-1733), (-1729)⟩, ⟨(-433), (-429)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-16123220), (-16123219)⟩, ⟨(-32210082), (-32210080)⟩, ⟨(-16032363), (-16032360)⟩, ⟨72598, 72602⟩, ⟨18051, 18055⟩⟩
...
def j36 : Jet := ⟨⟨4278844076, 4278844077⟩, ⟨(-32210082), (-32210080)⟩, ⟨(-16032363), (-16032360)⟩, ⟨72598, 72602⟩, ⟨18051, 18055⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨214499062, 214499065⟩, ⟨213531077, 213531082⟩, ⟨(-1450418), (-1450415)⟩, ⟨(-480875), (-480873)⟩, ⟨1945, 1948⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4311151269, 4311151271⟩, ⟨32453279, 32453283⟩, ⟨16397710, 16397716⟩, ⟨171885, 171893⟩, ⟨43990, 43999⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨215307321, 215307325⟩, ⟨215956468, 215956475⟩, ⟨976514, 976522⟩, ⟨330175, 330181⟩, ⟨3521, 3530⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-205294069), (-205294068)⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4089673227, 4089673228⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨10793386, 10793388⟩, ⟨21651856, 21651858⟩, ⟨10956472, 10956478⟩, ⟨131302, 131308⟩, ⟨33776, 33781⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4305760682, 4305760684⟩, ⟨21651856, 21651858⟩, ⟨10956472, 10956478⟩, ⟨131302, 131308⟩, ⟨33776, 33781⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4300360602, 4300360604⟩, ⟨10812350, 10812352⟩, ⟨5457772, 5457777⟩, ⟨51845, 51850⟩, ⟨13272, 13277⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4094808739, 4094808743⟩, ⟨(-195256330), (-195256325)⟩, ⟨4680080, 4680087⟩, ⟨(-211509), (-211502)⟩, ⟨10158, 10165⟩⟩
...
def j47 : Jet := ⟨⟨1055506504, 1055506510⟩, ⟨1055506504, 1055506510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨259395218, 259395222⟩, ⟨518790436, 518790444⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨259395218, 259395222⟩, ⟨518790436, 518790444⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-259395222), (-259395218)⟩, ⟨(-518790444), (-518790436)⟩, ⟨(-259395222), (-259395218)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-129697611), (-129697609)⟩, ⟨(-259395222), (-259395218)⟩, ⟨(-129697611), (-129697609)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4167208398, 4167208401⟩, ⟨(-251679204), (-251679199)⟩, ⟨(-118239500), (-118239497)⟩, ⟨7447098, 7447100⟩, ⟨1672830, 1672832⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3973003794, 3973003802⟩, ⟨(-429398386), (-429398374)⟩, ⟨(-96746562), (-96746549)⟩, ⟨11995938, 11995951⟩, ⟨1149719, 1149733⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 410588137⟩, ⟨205294068, 205294069⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1289900675⟩, ⟨644950335, 644950340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 387393812⟩, ⟨0, 387393814⟩, ⟨96848452, 96848454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 98⟩, ⟨0, 98⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94588)⟩, ⟨0, 98⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-8541), 0⟩, ⟨(-8541), 9⟩, ⟨(-2136), (-2120)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5104515, 5113057⟩, ⟨(-8541), 9⟩, ⟨(-2136), (-2120)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 461184⟩, ⟨(-771), 461185⟩, ⟨114139, 115297⟩, ⟨(-386), 2⟩, ⟨(-49), (-45)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142704392)⟩, ⟨(-771), 461185⟩, ⟨114139, 115297⟩, ⟨(-386), 2⟩, ⟨(-49), (-45)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-12913128), 0⟩, ⟨(-12913198), 41598⟩, ⟨(-3228352), (-3165884)⟩, ⟨(-53), 20801⟩, ⟨2533, 2601⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1418742637, 1431655766⟩, ⟨(-12913198), 41598⟩, ⟨(-3228352), (-3165884)⟩, ⟨(-53), 20801⟩, ⟨2533, 2601⟩⟩
...
def j72 : Jet := ⟨⟨0, 1068⟩, ⟨(-1), 1068⟩, ⟨264, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851108)⟩, ⟨(-1), 1068⟩, ⟨264, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-76864), 0⟩, ⟨(-76865), 97⟩, ⟨(-19217), (-19069)⟩, ⟨(-2), 50⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35714530, 35791395⟩, ⟨(-76865), 97⟩, ⟨(-19217), (-19069)⟩, ⟨(-2), 50⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3228282⟩, ⟨(-6934), 3228291⟩, ⟨796669, 807080⟩, ⟨(-3469), 8⟩, ⟨(-435), (-423)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712599600)⟩, ⟨(-6934), 3228291⟩, ⟨796669, 807080⟩, ⟨(-3469), 8⟩, ⟨(-435), (-423)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-64565636), 0⟩, ⟨(-64566262), 291183⟩, ⟨(-16142036), (-15704633)⟩, ⟨(-470), 145594⟩, ⟨17611, 18201⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4230401660, 4294967296⟩, ⟨(-64566262), 291183⟩, ⟨(-16142036), (-15704633)⟩, ⟨(-470), 145594⟩, ⟨17611, 18201⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 429966892⟩, ⟨209166154, 214995941⟩, ⟨(-2908667), 6247⟩, ⟨(-484799), (-469154)⟩, ⟨(-8), 3906⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4360518352⟩, ⟨(-300140), 66552162⟩, ⟨15700120, 17654275⟩, ⟨(-152435), 523879⟩, ⟨34379, 57493⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 436529174⟩, ⟨209136107, 224939775⟩, ⟨(-2968085), 5105149⟩, ⟨212069, 467228⟩, ⟨(-27109), 36007⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-410588137), 0⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3884379159, 4294967296⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 44367677⟩, ⟨0, 45724574⟩, ⟨9580188, 12818491⟩, ⟨(-310896), 629720⟩, ⟨11612, 62331⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4339334973⟩, ⟨0, 45724574⟩, ⟨9580188, 12818491⟩, ⟨(-310896), 629720⟩, ⟨11612, 62331⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4317094138⟩, ⟨0, 22862287⟩, ⟨4705006, 6409246⟩, ⟨(-189565), 314860⟩, ⟨(-654), 29599⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3884379159, 4317094138⟩, ⟨(-206351705), (-182431781)⟩, ⟨3162430, 6409246⟩, ⟨(-495919), 89967⟩, ⟨(-15704), 38660⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2111013015⟩, ⟨1055506504, 1055506510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1037580881⟩, ⟨0, 1037580884⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1037580881⟩, ⟨0, 1037580884⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1037580881), 0⟩, ⟨(-1037580884), 0⟩, ⟨(-259395222), (-259395218)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-518790441), 0⟩, ⟨(-518790442), 0⟩, ⟨(-129697611), (-129697609)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3806284927, 4294967296⟩, ⟨(-518790442), 0⟩, ⟨(-129697611), (-83608155)⟩, ⟨0, 15666215⟩, ⟨789299, 1958277⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3442413602, 4317094138⟩, ⟨(-727814856), (-161674650)⟩, ⟨(-127563182), (-44280891)⟩, ⟨2281221, 22068214⟩, ⟨(-258957), 2005368⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨205294068, 205294069⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4300360602, 4300360604⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified248
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 410588137⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4317094138⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified249
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (47095583 / 536870912)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(38239 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (38239 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(38239 / 400000), prawitzNormalCorrection
