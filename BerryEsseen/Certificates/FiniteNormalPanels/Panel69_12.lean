...
namespace FiniteNormalPanel69_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (32297 / 800000)
def radius : Rat := (32297 / 800000)

def j0 : Jet := ⟨⟨173393198, 173393199⟩, ⟨173393198, 173393199⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨544730796, 544730801⟩, ⟨544730796, 544730801⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨69088218, 69088221⟩, ⟨138176436, 138176442⟩, ⟨69088218, 69088221⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1523), (-1522)⟩, ⟨(-3046), (-3044)⟩, ⟨(-1522), (-1519)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111533, 5111535⟩, ⟨(-3046), (-3044)⟩, ⟨(-1522), (-1519)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨82223, 82224⟩, ⟨164397, 164399⟩, ⟨82100, 82103⟩, ⟨(-98), (-95)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-143083354), (-143083352)⟩, ⟨164397, 164399⟩, ⟨82100, 82103⟩, ⟨(-98), (-95)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2301619), (-2301617)⟩, ⟨(-4600593), (-4600590)⟩, ⟨(-2295011), (-2295007)⟩, ⟨5283, 5286⟩, ⟨1315, 1318⟩⟩
...
def j19 : Jet := ⟨⟨1429354146, 1429354149⟩, ⟨(-4600593), (-4600590)⟩, ⟨(-2295011), (-2295007)⟩, ⟨5283, 5286⟩, ⟨1315, 1318⟩⟩
...
def j25 : Jet := ⟨⟨190, 191⟩, ⟨379, 381⟩, ⟨188, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851987), (-851985)⟩, ⟨379, 381⟩, ⟨188, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13705), (-13704)⟩, ⟨(-27404), (-27402)⟩, ⟨(-13690), (-13687)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35777689, 35777691⟩, ⟨(-27404), (-27402)⟩, ⟨(-13690), (-13687)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨575514, 575515⟩, ⟨1150588, 1150590⟩, ⟨574411, 574414⟩, ⟨(-882), (-879)⟩, ⟨(-221), (-218)⟩⟩
...
def j33 : Jet := ⟨⟨(-715252369), (-715252367)⟩, ⟨1150588, 1150590⟩, ⟨574411, 574414⟩, ⟨(-882), (-879)⟩, ⟨(-221), (-218)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11505446), (-11505445)⟩, ⟨(-22992384), (-22992381)⟩, ⟨(-11459191), (-11459188)⟩, ⟨36972, 36975⟩, ⟨9206, 9209⟩⟩
...
def j36 : Jet := ⟨⟨4283461850, 4283461851⟩, ⟨(-22992384), (-22992381)⟩, ⟨(-11459191), (-11459188)⟩, ⟨36972, 36975⟩, ⟨9206, 9209⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨181285017, 181285020⟩, ⟨180701523, 180701528⟩, ⟨(-874571), (-874567)⟩, ⟨(-290407), (-290404)⟩, ⟨836, 839⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306503644, 4306503646⟩, ⟨23116061, 23116066⟩, ⟨11644908, 11644914⟩, ⟨87171, 87178⟩, ⟨22160, 22169⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨181771951, 181771955⟩, ⟨182162589, 182162596⟩, ⟨587153, 587160⟩, ⟨197717, 197724⟩, ⟨1504, 1513⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-173393199), (-173393198)⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4121574097, 4121574098⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7692967, 7692968⟩, ⟨15418998, 15419002⟩, ⟨7775765, 7775769⟩, ⟨66538, 66546⟩, ⟨16976, 16985⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302660263, 4302660264⟩, ⟨15418998, 15419002⟩, ⟨7775765, 7775769⟩, ⟨66538, 66546⟩, ⟨16976, 16985⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298812058, 4298812060⟩, ⟨7702603, 7702606⟩, ⟨3877504, 3877507⟩, ⟨26291, 26297⟩, ⟨6683, 6690⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4125263641, 4125263645⟩, ⟨(-166156778), (-166156772)⟩, ⟨3410000, 3410005⟩, ⟨(-131311), (-131303)⟩, ⟨5351, 5359⟩⟩
...
def j47 : Jet := ⟨⟨1227216251, 1227216260⟩, ⟨1227216251, 1227216260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨350656855, 350656861⟩, ⟨701313710, 701313722⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨350656855, 350656861⟩, ⟨701313710, 701313722⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-350656861), (-350656855)⟩, ⟨(-701313722), (-701313710)⟩, ⟨(-350656861), (-350656855)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-175328431), (-175328427)⟩, ⟨(-350656861), (-350656855)⟩, ⟨(-175328431), (-175328427)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4123169276, 4123169281⟩, ⟨(-336630642), (-336630635)⟩, ⟨(-154573443), (-154573437)⟩, ⟨13367899, 13367901⟩, ⟨2882134, 2882135⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3960253740, 3960253750⟩, ⟨(-482840156), (-482840141)⟩, ⟨(-132169282), (-132169267)⟩, ⟨18426261, 18426277⟩, ⟨2143800, 2143815⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 346786397⟩, ⟨173393198, 173393199⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1089461598⟩, ⟨544730796, 544730801⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 276352879⟩, ⟨0, 276352880⟩, ⟨69088218, 69088221⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6093), 0⟩, ⟨(-6093), 5⟩, ⟨(-1524), (-1514)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106963, 5113057⟩, ⟨(-6093), 5⟩, ⟨(-1524), (-1514)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 328992⟩, ⟨(-393), 328993⟩, ⟨81657, 82249⟩, ⟨(-198), 2⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142836584)⟩, ⟨(-393), 328993⟩, ⟨81657, 82249⟩, ⟨(-198), 2⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9211763), 0⟩, ⟨(-9211789), 21169⟩, ⟨(-2302967), (-2271186)⟩, ⟨(-20), 10587⟩, ⟨1298, 1325⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422444002, 1431655766⟩, ⟨(-9211789), 21169⟩, ⟨(-2302967), (-2271186)⟩, ⟨(-20), 10587⟩, ⟨1298, 1325⟩⟩
...
def j72 : Jet := ⟨⟨0, 762⟩, ⟨(-1), 762⟩, ⟨188, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851414)⟩, ⟨(-1), 762⟩, ⟨188, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-54832), 0⟩, ⟨(-54833), 50⟩, ⟨(-13709), (-13632)⟩, ⟨(-2), 26⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35736562, 35791395⟩, ⟨(-54833), 50⟩, ⟨(-13709), (-13632)⟩, ⟨(-2), 26⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2302941⟩, ⟨(-3529), 2302945⟩, ⟨570441, 575740⟩, ⟨(-1767), 3⟩, ⟨(-222), (-216)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713524941)⟩, ⟨(-3529), 2302945⟩, ⟨570441, 575740⟩, ⟨(-1767), 3⟩, ⟨(-222), (-216)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-46058814), 0⟩, ⟨(-46059042), 148180⟩, ⟨(-11514932), (-11292432)⟩, ⟨(-171), 74092⟩, ⟨9047, 9263⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4248908482, 4294967296⟩, ⟨(-46059042), 148180⟩, ⟨(-11514932), (-11292432)⟩, ⟨(-171), 74092⟩, ⟨9047, 9263⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 363153867⟩, ⟨178071940, 181582304⟩, ⟨(-1752503), 2685⟩, ⟨(-292092), (-285368)⟩, ⟨(-3), 1680⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4341525395⟩, ⟨(-151411), 47063030⟩, ⟨11290808, 12276106⟩, ⟨(-76547), 260797⟩, ⟨18689, 26956⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 367090511⟩, ⟨178059137, 187530021⟩, ⟨(-1777903), 3030429⟩, ⟨147187, 255755⟩, ⟨(-11452), 15024⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-346786397), 0⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3948180899, 4294967296⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 31375197⟩, ⟨0, 32056352⟩, ⟨7077992, 8706096⟩, ⟨(-155258), 308354⟩, ⟨8991, 27043⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4326342493⟩, ⟨0, 32056352⟩, ⟨7077992, 8706096⟩, ⟨(-155258), 308354⟩, ⟨8991, 27043⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4310626349⟩, ⟨0, 16028176⟩, ⟨3496341, 4353048⟩, ⟨(-93874), 154177⟩, ⟨1707, 12450⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3948180899, 4310626349⟩, ⟨(-174025375), (-157365022)⟩, ⟨2566959, 4353048⟩, ⟨(-269612), 13026⟩, ⟨(-4656), 16240⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2454432512⟩, ⟨1227216251, 1227216260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1402627434⟩, ⟨0, 1402627440⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1402627434⟩, ⟨0, 1402627440⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1402627434), 0⟩, ⟨(-1402627440), 0⟩, ⟨(-350656861), (-350656855)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-701313717), 0⟩, ⟨(-701313720), 0⟩, ⟨(-175328431), (-175328427)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3647918083, 4294967296⟩, ⟨(-701313720), 0⟩, ⟨(-175328431), (-91656872)⟩, ⟨0, 28628911⟩, ⟨702115, 3578614⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3353376057, 4310626349⟩, ⟨(-877896020), (-133657527)⟩, ⟨(-173787424), (-51487081)⟩, ⟨2377842, 35850351⟩, ⟨(-699058), 3597147⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨173393198, 173393199⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298812058, 4298812060⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1382
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 346786397⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4310626349⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1383
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (79065413 / 1073741824)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(32297 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (32297 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(32297 / 400000), prawitzNormalCorrection
