...
namespace FiniteNormalPanel58_19
...
def j2 : Jet := ⟨⟨565273947, 565273952⟩, ⟨565273947, 565273952⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨74397454, 74397457⟩, ⟨148794908, 148794914⟩, ⟨74397454, 74397457⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨18, 19⟩, ⟨37, 38⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94669), (-94667)⟩, ⟨37, 38⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1640), (-1639)⟩, ⟨(-3280), (-3278)⟩, ⟨(-1639), (-1636)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111416, 5111418⟩, ⟨(-3280), (-3278)⟩, ⟨(-1639), (-1636)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨88539, 88541⟩, ⟨177022, 177025⟩, ⟨88396, 88400⟩, ⟨(-114), (-111)⟩, ⟨(-29), (-26)⟩⟩
...
def j16 : Jet := ⟨⟨(-143077038), (-143077035)⟩, ⟨177022, 177025⟩, ⟨88396, 88400⟩, ⟨(-114), (-111)⟩, ⟨(-29), (-26)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2478382), (-2478381)⟩, ⟨(-4953698), (-4953695)⟩, ⟨(-2470719), (-2470716)⟩, ⟨6126, 6129⟩, ⟨1526, 1529⟩⟩
...
def j19 : Jet := ⟨⟨1429177383, 1429177385⟩, ⟨(-4953698), (-4953695)⟩, ⟨(-2470719), (-2470716)⟩, ⟨6126, 6129⟩, ⟨1526, 1529⟩⟩
...
def j25 : Jet := ⟨⟨204, 206⟩, ⟨408, 411⟩, ⟨202, 206⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851973), (-851970)⟩, ⟨408, 411⟩, ⟨202, 206⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14758), (-14757)⟩, ⟨(-29509), (-29507)⟩, ⟨(-14741), (-14738)⟩, ⟨12, 16⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35776636, 35776638⟩, ⟨(-29509), (-29507)⟩, ⟨(-14741), (-14738)⟩, ⟨12, 16⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨619723, 619724⟩, ⟨1238934, 1238936⟩, ⟨618444, 618447⟩, ⟨(-1023), (-1020)⟩, ⟨(-256), (-253)⟩⟩
...
def j33 : Jet := ⟨⟨(-715208160), (-715208158)⟩, ⟨1238934, 1238936⟩, ⟨618444, 618447⟩, ⟨(-1023), (-1020)⟩, ⟨(-256), (-253)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-12388842), (-12388840)⟩, ⟨(-24756223), (-24756220)⟩, ⟨(-12335209), (-12335205)⟩, ⟨42867, 42870⟩, ⟨10671, 10674⟩⟩
...
def j36 : Jet := ⟨⟨4282578454, 4282578456⟩, ⟨(-24756223), (-24756220)⟩, ⟨(-12335209), (-12335205)⟩, ⟨42867, 42870⟩, ⟨10671, 10674⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨188098461, 188098464⟩, ⟨187446489, 187446493⟩, ⟨(-977151), (-977149)⟩, ⟨(-324373), (-324371)⟩, ⟨1006, 1009⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4307391975, 4307391978⟩, ⟨24899658, 24899663⟩, ⟨12550611, 12550618⟩, ⟨101149, 101156⟩, ⟨25748, 25756⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨188642600, 188642605⟩, ⟨189079224, 189079230⟩, ⟨656379, 656385⟩, ⟨221201, 221209⟩, ⟨1812, 1820⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-179932287), (-179932286)⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4115035009, 4115035010⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8285518, 8285519⟩, ⟨16609390, 16609394⟩, ⟨8381575, 8381578⟩, ⟨77222, 77226⟩, ⟨19734, 19739⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303252814, 4303252815⟩, ⟨16609390, 16609394⟩, ⟨8381575, 8381578⟩, ⟨77222, 77226⟩, ⟨19734, 19739⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299108058, 4299108060⟩, ⟨8296696, 8296699⟩, ⟨4178745, 4178748⟩, ⟨30508, 30512⟩, ⟨7767, 7772⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4119002298, 4119002302⟩, ⟨(-172156644), (-172156638)⟩, ⟨3656101, 3656106⟩, ⟨(-145835), (-145829)⟩, ⟨6162, 6169⟩⟩
...
def j47 : Jet := ⟨⟨1174507681, 1174507689⟩, ⟨1174507681, 1174507689⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨321182490, 321182495⟩, ⟨642364980, 642364990⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨321182490, 321182495⟩, ⟨642364980, 642364990⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-321182495), (-321182490)⟩, ⟨(-642364990), (-642364980)⟩, ⟨(-321182495), (-321182490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-160591248), (-160591245)⟩, ⟨(-321182495), (-321182490)⟩, ⟨(-160591248), (-160591245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4137341274, 4137341278⟩, ⟨(-309395044), (-309395038)⟩, ⟨(-143129068), (-143129063)⟩, ⟨11280087, 11280089⟩, ⟨2464953, 2464955⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3967834221, 3967834229⟩, ⟨(-462557583), (-462557569)⟩, ⟨(-121341557), (-121341544)⟩, ⟨16151175, 16151186⟩, ⟨1806419, 1806434⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 359864573⟩, ⟨179932286, 179932287⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1130547899⟩, ⟨565273947, 565273952⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 297589822⟩, ⟨0, 297589824⟩, ⟨74397454, 74397457⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6561), 0⟩, ⟨(-6561), 6⟩, ⟨(-1641), (-1630)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106495, 5113057⟩, ⟨(-6561), 6⟩, ⟨(-1641), (-1630)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 354274⟩, ⟨(-455), 354275⟩, ⟨87885, 88570⟩, ⟨(-228), 2⟩, ⟨(-29), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142811302)⟩, ⟨(-455), 354275⟩, ⟨87885, 88570⟩, ⟨(-228), 2⟩, ⟨(-29), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9919661), 0⟩, ⟨(-9919693), 24548⟩, ⟨(-2479948), (-2443093)⟩, ⟨(-24), 12275⟩, ⟨1503, 1536⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421736104, 1431655766⟩, ⟨(-9919693), 24548⟩, ⟨(-2479948), (-2443093)⟩, ⟨(-24), 12275⟩, ⟨1503, 1536⟩⟩
...
def j72 : Jet := ⟨⟨0, 821⟩, ⟨(-1), 821⟩, ⟨202, 206⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851355)⟩, ⟨(-1), 821⟩, ⟨202, 206⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-59046), 0⟩, ⟨(-59047), 57⟩, ⟨(-14763), (-14675)⟩, ⟨(-2), 30⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35732348, 35791395⟩, ⟨(-59047), 57⟩, ⟨(-14763), (-14675)⟩, ⟨(-2), 30⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2479916⟩, ⟨(-4092), 2479920⟩, ⟨613840, 619983⟩, ⟨(-2047), 4⟩, ⟨(-257), (-250)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713347966)⟩, ⟨(-4092), 2479920⟩, ⟨613840, 619983⟩, ⟨(-2047), 4⟩, ⟨(-257), (-250)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-49598304), 0⟩, ⟨(-49598589), 171829⟩, ⟨(-12399861), (-12141831)⟩, ⟨(-213), 85917⟩, ⟨10472, 10741⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4245368992, 4294967296⟩, ⟨(-49598589), 171829⟩, ⟨(-12399861), (-12141831)⟩, ⟨(-213), 85917⟩, ⟨10472, 10741⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 376849300⟩, ⟨184507967, 188431113⟩, ⟨(-1958350), 3231⟩, ⟨(-326401), (-318311)⟩, ⟨(-4), 2021⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4345145053⟩, ⟨(-175868), 50764273⟩, ⟨12139800, 13284366⟩, ⟨(-88989), 303693⟩, ⟨21408, 31760⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 381252001⟩, ⟨184492535, 195086702⟩, ⟨(-1988946), 3396025⟩, ⟨160343, 291236⟩, ⟨(-13826), 18180⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-359864573), 0⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3935102723, 4294967296⟩, ⟨(-179932287), (-179932286)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 33842654⟩, ⟨0, 34634582⟩, ⟨7571863, 9464172⟩, ⟨(-180686), 360216⟩, ⟨9745, 32372⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4328809950⟩, ⟨0, 34634582⟩, ⟨7571863, 9464172⟩, ⟨(-180686), 360216⟩, ⟨9745, 32372⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311855421⟩, ⟨0, 17317291⟩, ⟨3736327, 4732086⟩, ⟨(-109423), 180108⟩, ⟨1532, 15003⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3935102723, 4311855421⟩, ⟨(-180639794), (-162614995)⟩, ⟨2697782, 4732086⟩, ⟨(-307668), 23580⟩, ⟨(-6143), 19588⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2349015370⟩, ⟨1174507681, 1174507689⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1284729971⟩, ⟨0, 1284729976⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1284729971⟩, ⟨0, 1284729976⟩, ⟨321182490, 321182495⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1284729971), 0⟩, ⟨(-1284729976), 0⟩, ⟨(-321182495), (-321182490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-642364986), 0⟩, ⟨(-642364988), 0⟩, ⟨(-160591248), (-160591245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3698331187, 4294967296⟩, ⟨(-642364988), 0⟩, ⟨(-160591248), (-90245907)⟩, ⟨0, 24018389⟩, ⟨789111, 3002299⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3388457262, 4311855421⟩, ⟨(-825530609), (-140025305)⟩, ⟨(-158899686), (-50935447)⟩, ⟨2401458, 30890636⟩, ⟨(-473790), 3023024⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299108058, 4299108060⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1154
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311855421⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1155
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (329116601 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(6703 / 80000), prawitzNormalCorrection
