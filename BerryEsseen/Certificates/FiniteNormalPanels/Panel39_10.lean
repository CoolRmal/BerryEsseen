...
namespace FiniteNormalPanel39_10
...
def j47 : Jet := ⟨⟨6145957883, 6145957892⟩, ⟨1229191575, 1229191583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8794664940, 8794664967⟩, ⟨3517865970, 3517866000⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8794664940, 8794664967⟩, ⟨3517865970, 3517866000⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8794664967), (-8794664940)⟩, ⟨(-3517866000), (-3517865970)⟩, ⟨(-351786602), (-351786596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4397332484), (-4397332470)⟩, ⟨(-1758933000), (-1758932985)⟩, ⟨(-175893301), (-175893298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1542817336, 1542817353⟩, ⟨(-631835395), (-631835381)⟩, ⟨66195337, 66195344⟩, ⟨8214112, 8214116⟩, ⟨(-2196450), (-2196448)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1242886288, 1242886305⟩, ⟨(-563637461), (-563637445)⟩, ⟨76591010, 76591022⟩, ⟨3879831, 3879842⟩, ⟨(-2009099), (-2009088)⟩⟩
...
def j89 : Jet := ⟨⟨4916766307, 7375149467⟩, ⟨1229191575, 1229191583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5628585563, 12664317541⟩, ⟨2814292776, 4221439198⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5628585563, 12664317541⟩, ⟨2814292776, 4221439198⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12664317541), (-5628585563)⟩, ⟨(-4221439198), (-2814292776)⟩, ⟨(-351786602), (-351786596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6332158771), (-2814292781)⟩, ⟨(-2110719599), (-1407146388)⟩, ⟨(-175893301), (-175893298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨983264947, 2230420971⟩, ⟨(-1096118535), (-322143947)⟩, ⟨(-38571717), 229070365⟩, ⟨(-28729547), 36245049⟩, ⟨(-9143669), 4319535⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨740476407, 1924685209⟩, ⟨(-1034156285), (-271868748)⟩, ⟨(-24201699), 244633280⟩, ⟨(-35935029), 33335845⟩, ⟨(-9560811), 5431125⟩⟩
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified766
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified767
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (109367673 / 4294967296)
