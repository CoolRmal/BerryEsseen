...
namespace FiniteNormalPanel144_12
...
def j2 : Jet := ⟨⟨441053668, 441053672⟩, ⟨441053668, 441053672⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨45292158, 45292159⟩, ⟨90584316, 90584318⟩, ⟨45292158, 45292159⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-999), (-998)⟩, ⟨(-1997), (-1995)⟩, ⟨(-999), (-996)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112057, 5112059⟩, ⟨(-1997), (-1995)⟩, ⟨(-999), (-996)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨53908, 53909⟩, ⟨107795, 107797⟩, ⟨53854, 53857⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143111669), (-143111667)⟩, ⟨107795, 107797⟩, ⟨53854, 53857⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1509171), (-1509170)⟩, ⟨(-3017205), (-3017203)⟩, ⟨(-1506331), (-1506328)⟩, ⟨2270, 2273⟩, ⟨565, 568⟩⟩
...
def j19 : Jet := ⟨⟨1430146594, 1430146596⟩, ⟨(-3017205), (-3017203)⟩, ⟨(-1506331), (-1506328)⟩, ⟨2270, 2273⟩, ⟨565, 568⟩⟩
...
def j28 : Jet := ⟨⟨(-8986), (-8985)⟩, ⟨(-17969), (-17967)⟩, ⟨(-8980), (-8977)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782408, 35782410⟩, ⟨(-17969), (-17967)⟩, ⟨(-8980), (-8977)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨377339, 377340⟩, ⟨754489, 754491⟩, ⟨376865, 376868⟩, ⟨(-380), (-377)⟩, ⟨(-96), (-92)⟩⟩
...
def j33 : Jet := ⟨⟨(-715450544), (-715450542)⟩, ⟨754489, 754491⟩, ⟨376865, 376868⟩, ⟨(-380), (-377)⟩, ⟨(-96), (-92)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7544714), (-7544713)⟩, ⟨(-15081472), (-15081470)⟩, ⟨(-7524828), (-7524825)⟩, ⟨15899, 15903⟩, ⟨3963, 3968⟩⟩
...
def j36 : Jet := ⟨⟨4287422582, 4287422583⟩, ⟨(-15081472), (-15081470)⟩, ⟨(-7524828), (-7524825)⟩, ⟨15899, 15903⟩, ⟨3963, 3968⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨146862911, 146862913⟩, ⟨146553071, 146553074⟩, ⟨(-464527), (-464525)⟩, ⟨(-154454), (-154452)⟩, ⟨291, 293⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302525285, 4302525287⟩, ⟨15134595, 15134599⟩, ⟨7604568, 7604574⟩, ⟨37351, 37359⟩, ⟨9438, 9448⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨147121350, 147121353⟩, ⟨147328480, 147328485⟩, ⟨311110, 311115⟩, ⟨104397, 104403⟩, ⟨519, 527⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-140391744), (-140391743)⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4154575552, 4154575553⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5039547, 5039548⟩, ⟨10093284, 10093286⟩, ⟨5075059, 5075065⟩, ⟨28494, 28500⟩, ⟨7218, 7225⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300006843, 4300006844⟩, ⟨10093284, 10093286⟩, ⟨5075059, 5075065⟩, ⟨28494, 28500⟩, ⟨7218, 7225⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297486330, 4297486332⟩, ⟨5043683, 5043685⟩, ⟨2533082, 2533086⟩, ⟨11265, 11270⟩, ⟨2846, 2852⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4157012245, 4157012249⟩, ⟨(-135595268), (-135595263)⟩, ⟨2285415, 2285421⟩, ⟨(-71905), (-71898)⟩, ⟨2383, 2391⟩⟩
...
def j47 : Jet := ⟨⟨1496140902, 1496140914⟩, ⟨1496140902, 1496140914⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨521176866, 521176876⟩, ⟨1042353732, 1042353752⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨521176866, 521176876⟩, ⟨1042353732, 1042353752⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-521176876), (-521176866)⟩, ⟨(-1042353752), (-1042353732)⟩, ⟨(-521176876), (-521176866)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-260588438), (-260588433)⟩, ⟨(-521176876), (-521176866)⟩, ⟨(-260588438), (-260588433)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4042126711, 4042126717⟩, ⟨(-490495697), (-490495686)⟩, ⟨(-215488018), (-215488010)⟩, ⟨28556086, 28556088⟩, ⟨5670857, 5670859⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3912292940, 3912292951⟩, ⟨(-602353802), (-602353784)⟩, ⟨(-190930326), (-190930309)⟩, ⟨34113299, 34113313⟩, ⟨4482958, 4482974⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 280783487⟩, ⟨140391743, 140391744⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 882107341⟩, ⟨441053668, 441053672⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 181168635⟩, ⟨0, 181168636⟩, ⟨45292158, 45292159⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3995), 0⟩, ⟨(-3995), 2⟩, ⟨(-999), (-995)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109061, 5113057⟩, ⟨(-3995), 2⟩, ⟨(-999), (-995)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 215677⟩, ⟨(-169), 215678⟩, ⟨53665, 53921⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142949899)⟩, ⟨(-169), 215678⟩, ⟨53665, 53921⟩, ⟨(-86), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6038955), 0⟩, ⟨(-6038963), 9098⟩, ⟨(-1509747), (-1496091)⟩, ⟨(-6), 4551⟩, ⟨560, 570⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425616810, 1431655766⟩, ⟨(-6038963), 9098⟩, ⟨(-1509747), (-1496091)⟩, ⟨(-6), 4551⟩, ⟨560, 570⟩⟩
...
def j74 : Jet := ⟨⟨(-35947), 0⟩, ⟨(-35948), 22⟩, ⟨(-8988), (-8953)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35755447, 35791395⟩, ⟨(-35948), 22⟩, ⟨(-8988), (-8953)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1509739⟩, ⟨(-1517), 1509740⟩, ⟨375158, 377436⟩, ⟨(-761), 2⟩, ⟨(-97), (-92)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714318143)⟩, ⟨(-1517), 1509740⟩, ⟨375158, 377436⟩, ⟨(-761), 2⟩, ⟨(-97), (-92)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30194773), 0⟩, ⟨(-30194837), 63684⟩, ⟨(-7548758), (-7453167)⟩, ⟨(-49), 31843⟩, ⟨3918, 3982⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264772523, 4294967296⟩, ⟨(-30194837), 63684⟩, ⟨(-7548758), (-7453167)⟩, ⟨(-49), 31843⟩, ⟨3918, 3982⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 294035781⟩, ⟨145157451, 147019760⟩, ⟨(-930222), 935⟩, ⟨(-155040), (-152699)⟩, ⟨(-1), 586⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4325375850⟩, ⟨(-64590), 30623913⟩, ⟨7452712, 7872848⟩, ⟨(-32529), 109998⟩, ⟨8464, 10771⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 296117568⟩, ⟨145153029, 150157197⟩, ⟨(-939020), 1588201⟩, ⟨86882, 124340⟩, ⟨(-3928), 5100⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-280783487), 0⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4014183809, 4294967296⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20415898⟩, ⟨0, 20705250⟩, ⟨4776120, 5468674⟩, ⟨(-65660), 128198⟩, ⟨4982, 9988⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315383194⟩, ⟨0, 20705250⟩, ⟨4776120, 5468674⟩, ⟨(-65660), 128198⟩, ⟨4982, 9988⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305163144⟩, ⟨0, 10352625⟩, ⟨2369956, 2734337⟩, ⟨(-39421), 64099⟩, ⟨1462, 4437⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4014183809, 4305163144⟩, ⟨(-140725021), (-130039118)⟩, ⟨1876618, 2734337⟩, ⟨(-128800), (-13368)⟩, ⟨(-730), 5726⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2992281817⟩, ⟨1496140902, 1496140914⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2084707486⟩, ⟨0, 2084707494⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2084707486⟩, ⟨0, 2084707494⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2084707486), 0⟩, ⟨(-2084707494), 0⟩, ⟨(-521176876), (-521176866)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1042353743), 0⟩, ⟨(-1042353747), 0⟩, ⟨(-260588438), (-260588433)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3369458495, 4294967296⟩, ⟨(-1042353747), 0⟩, ⟨(-260588438), (-77949660)⟩, ⟨0, 63242702⟩, ⟨(-1472405), 7905338⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3149180145, 4305163144⟩, ⟨(-1185553218), (-102017403)⟩, ⟨(-259734820), (-35966541)⟩, ⟨1567686, 71920554⟩, ⟨(-3714686), 7927032⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297486330, 4297486332⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2902
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305163144⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2903
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (62927277 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(523 / 8000), prawitzNormalCorrection
