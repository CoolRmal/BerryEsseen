...
namespace FiniteNormalPanel84_13
...
def j2 : Jet := ⟨⟨3005574147, 3005574152⟩, ⟨601114829, 601114833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2103270020, 2103270028⟩, ⟨841308006, 841308016⟩, ⟨84130800, 84130802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨526, 527⟩, ⟨210, 211⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94161), (-94159)⟩, ⟨210, 211⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-46112), (-46110)⟩, ⟨(-18343), (-18340)⟩, ⟨(-1794), (-1791)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5066944, 5066947⟩, ⟨(-18343), (-18340)⟩, ⟨(-1794), (-1791)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2481311, 2481313⟩, ⟨983541, 983545⟩, ⟨94779, 94784⟩, ⟨(-709), (-704)⟩, ⟨(-35), (-32)⟩⟩
...
def j16 : Jet := ⟨⟨(-140684266), (-140684263)⟩, ⟨983541, 983545⟩, ⟨94779, 94784⟩, ⟨(-709), (-704)⟩, ⟨(-35), (-32)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-68893889), (-68893887)⟩, ⟨(-27075911), (-27075906)⟩, ⟨(-2516685), (-2516678)⟩, ⟨37482, 37489⟩, ⟨1699, 1705⟩⟩
...
def j19 : Jet := ⟨⟨1362761876, 1362761879⟩, ⟨(-27075911), (-27075906)⟩, ⟨(-2516685), (-2516678)⟩, ⟨37482, 37489⟩, ⟨1699, 1705⟩⟩
...
def j22 : Jet := ⟨⟨(-53), (-52)⟩, ⟨(-22), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11782, 11784⟩, ⟨(-22), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5769, 5771⟩, ⟨2296, 2300⟩, ⟨223, 228⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846408), (-846405)⟩, ⟨2296, 2300⟩, ⟨223, 228⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-414491), (-414489)⟩, ⟨(-164673), (-164668)⟩, ⟨(-16022), (-16016)⟩, ⟨86, 91⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35376903, 35376906⟩, ⟨(-164673), (-164668)⟩, ⟨(-16022), (-16016)⟩, ⟨86, 91⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17324271, 17324274⟩, ⟨6849066, 6849072⟩, ⟨652866, 652873⟩, ⟨(-6323), (-6317)⟩, ⟨(-298), (-292)⟩⟩
...
def j33 : Jet := ⟨⟨(-698503612), (-698503608)⟩, ⟨6849066, 6849072⟩, ⟨652866, 652873⟩, ⟨(-6323), (-6317)⟩, ⟨(-298), (-292)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-342061211), (-342061207)⟩, ⟨(-133470459), (-133470452)⟩, ⟨(-12021127), (-12021120)⟩, ⟨258948, 258956⟩, ⟨11403, 11410⟩⟩
...
def j36 : Jet := ⟨⟨3952906085, 3952906089⟩, ⟨(-133470459), (-133470452)⟩, ⟨(-12021127), (-12021120)⟩, ⟨258948, 258956⟩, ⟨11403, 11410⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨953646810, 953646815⟩, ⟨171781915, 171781923⟩, ⟨(-5550641), (-5550633)⟩, ⟨(-326002), (-325994)⟩, ⟨6433, 6441⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4666628464, 4666628470⟩, ⟨157569391, 157569402⟩, ⟨19511962, 19511974⟩, ⟨832291, 832306⟩, ⟨63644, 63658⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1036169786, 1036169794⟩, ⟨221633333, 221633346⟩, ⟨4603599, 4603613⟩, ⟨407352, 407369⟩, ⟨17230, 17248⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-956703966), (-956703965)⟩, ⟨(-191340794), (-191340793)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3338263330, 3338263331⟩, ⟨(-191340794), (-191340793)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨249978114, 249978119⟩, ⟨106939004, 106939012⟩, ⟨13658205, 13658218⟩, ⟨671666, 671680⟩, ⟨55286, 55303⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4544945410, 4544945415⟩, ⟨106939004, 106939012⟩, ⟨13658205, 13658218⟩, ⟨671666, 671680⟩, ⟨55286, 55303⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4418188757, 4418188761⟩, ⟨51978259, 51978264⟩, ⟨6332889, 6332897⟩, ⟨251962, 251971⟩, ⟨19368, 19379⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3434037210, 3434037215⟩, ⟨(-156430210), (-156430203)⟩, ⟨2606605, 2606614⟩, ⟨(-86294), (-86285)⟩, ⟨3827, 3839⟩⟩
...
def j47 : Jet := ⟨⟨5451658490, 5451658498⟩, ⟨1090331698, 1090331705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6919861839, 6919861860⟩, ⟨2767944734, 2767944758⟩, ⟨276794473, 276794478⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6919861839, 6919861860⟩, ⟨2767944734, 2767944758⟩, ⟨276794473, 276794478⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6919861860), (-6919861839)⟩, ⟨(-2767944758), (-2767944734)⟩, ⟨(-276794478), (-276794473)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3459930930), (-3459930919)⟩, ⟨(-1383972379), (-1383972367)⟩, ⟨(-138397239), (-138397236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1919118552, 1919118566⟩, ⟨(-618399840), (-618399829)⟩, ⟨37793867, 37793873⟩, ⟨9225058, 9225061⟩, ⟨(-1352069), (-1352068)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1534429499, 1534429513⟩, ⟨(-564338683), (-564338668)⟩, ⟨53905960, 53905973⟩, ⟨5585501, 5585513⟩, ⟨(-1379969), (-1379957)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨765363172, 1148044759⟩, ⟨191340793, 191340794⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2404459318, 3606688981⟩, ⟨601114829, 601114833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1346092813, 3028708838⟩, ⟨673046406, 1009569618⟩, ⟨84130800, 84130802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨336, 759⟩, ⟨168, 253⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94351), (-93927)⟩, ⟨168, 253⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-66535), (-29437)⟩, ⟨(-22127), (-14539)⟩, ⟨(-1817), (-1763)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5046521, 5083620⟩, ⟨(-22127), (-14539)⟩, ⟨(-1817), (-1763)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1581638, 3584848⟩, ⟨775215, 1190394⟩, ⟨92368, 96750⟩, ⟨(-861), (-552)⟩, ⟨(-36), (-30)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141583939), (-139580728)⟩, ⟨775215, 1190394⟩, ⟨92368, 96750⟩, ⟨(-861), (-552)⟩, ⟨(-36), (-30)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-99841629), (-43746227)⟩, ⟨(-33037582), (-21033675)⟩, ⟨(-2622950), (-2386100)⟩, ⟨29051, 45887⟩, ⟨1580, 1801⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1331814136, 1387909539⟩, ⟨(-33037582), (-21033675)⟩, ⟨(-2622950), (-2386100)⟩, ⟨29051, 45887⟩, ⟨1580, 1801⟩⟩
...
def j70 : Jet := ⟨⟨(-77), (-33)⟩, ⟨(-26), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11758, 11803⟩, ⟨(-26), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3685, 8324⟩, ⟨1823, 2770⟩, ⟨220, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848492), (-843852)⟩, ⟨1823, 2770⟩, ⟨220, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-598337), (-264473)⟩, ⟨(-198875), (-130282)⟩, ⟨(-16268), (-15714)⟩, ⟨67, 110⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35193057, 35526922⟩, ⟨(-198875), (-130282)⟩, ⟨(-16268), (-15714)⟩, ⟨67, 110⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11029914, 25052741⟩, ⟨5374715, 8310083⟩, ⟨631149, 670571⟩, ⟨(-7700), (-4935)⟩, ⟨(-309), (-277)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704797969), (-690775141)⟩, ⟨5374715, 8310083⟩, ⟨631149, 670571⟩, ⟨(-7700), (-4935)⟩, ⟨(-309), (-277)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-497006774), (-216496980)⟩, ⟨(-163984428), (-102388417)⟩, ⟨(-12765686), (-11104832)⟩, ⟨198755, 318858⟩, ⟨10335, 12277⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3797960522, 4078470316⟩, ⟨(-163984428), (-102388417)⟩, ⟨(-12765686), (-11104832)⟩, ⟨198755, 318858⟩, ⟨10335, 12277⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨745591919, 1165493867⟩, ⟨158654744, 182473659⟩, ⟨(-6826490), (-4279644)⟩, ⟨(-350840), (-295419)⟩, ⟨4949, 7936⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4522956560, 4857013118⟩, ⟨113547071, 209711111⟩, ⟨15165629, 25380061⟩, ⟨310165, 1564020⟩, ⟨18062, 134590⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨785170090, 1318012132⟩, ⟨186787985, 263260205⟩, ⟨(-892720), 11290056⟩, ⟨(-116015), 1078460⟩, ⟨(-37668), 89026⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1148044759), (-765363172)⟩, ⟨(-191340794), (-191340793)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3146922537, 3529604124⟩, ⟨(-191340794), (-191340793)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨143538245, 404463145⟩, ⟨68294042, 161575222⟩, ⟨7575497, 23065788⟩, ⟨(-180644), 2045952⟩, ⟨(-39691), 216528⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4438505541, 4699430441⟩, ⟨68294042, 161575222⟩, ⟨7575497, 23065788⟩, ⟨(-180644), 2045952⟩, ⟨(-39691), 216528⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4366146601, 4492649559⟩, ⟨32644508, 79470568⟩, ⟨2918204, 11222842⟩, ⟨(-293124), 984481⟩, ⟨(-51866), 110860⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3199075613, 3692059408⟩, ⟨(-176228908), (-129202918)⟩, ⟨(-1402246), 7768620⟩, ⟨(-740868), 679042⟩, ⟨(-86483), 104164⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4361326792, 6541990197⟩, ⟨1090331698, 1090331705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4428711576, 9964601076⟩, ⟨2214355788, 3321533710⟩, ⟨276794473, 276794478⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4428711576, 9964601076⟩, ⟨2214355788, 3321533710⟩, ⟨276794473, 276794478⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9964601076), (-4428711576)⟩, ⟨(-3321533710), (-2214355788)⟩, ⟨(-276794478), (-276794473)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4982300538), (-2214355788)⟩, ⟨(-1660766855), (-1107177894)⟩, ⟨(-138397239), (-138397236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1346369479, 2564783475⟩, ⟨(-991743847), (-347073777)⟩, ⟨(-37910125), 148358253⟩, ⟨(-11666396), 26191050⟩, ⟨(-4922155), 1738575⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1002833658, 2204750888⟩, ⟨(-957764265), (-299017438)⟩, ⟨(-22985030), 172864239⟩, ⟨(-18352339), 24799268⟩, ⟨(-5582877), 2474835⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4418188757, 4418188761⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1696
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4366146601, 4492649559⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1697
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (138362779 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((891 / 5000) : ℝ)..(2673 / 10000), prawitzNormalCorrection
