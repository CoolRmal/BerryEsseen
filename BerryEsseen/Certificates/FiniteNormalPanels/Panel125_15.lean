...
namespace FiniteNormalPanel125_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (14047 / 400000)
def radius : Rat := (14047 / 400000)

def j0 : Jet := ⟨⟨150828514, 150828515⟩, ⟨150828514, 150828515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨473841751, 473841755⟩, ⟨473841751, 473841755⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨52276534, 52276536⟩, ⟨104553068, 104553072⟩, ⟨52276534, 52276536⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1153), (-1152)⟩, ⟨(-2305), (-2303)⟩, ⟨(-1153), (-1150)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111903, 5111905⟩, ⟨(-2305), (-2303)⟩, ⟨(-1153), (-1150)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨62219, 62220⟩, ⟨124410, 124412⟩, ⟨62147, 62151⟩, ⟨(-58), (-54)⟩, ⟨(-15), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-143103358), (-143103356)⟩, ⟨124410, 124412⟩, ⟨62147, 62151⟩, ⟨(-58), (-54)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1741794), (-1741793)⟩, ⟨(-3482074), (-3482072)⟩, ⟨(-1738010), (-1738007)⟩, ⟨3025, 3028⟩, ⟨753, 756⟩⟩
...
def j19 : Jet := ⟨⟨1429913971, 1429913973⟩, ⟨(-3482074), (-3482072)⟩, ⟨(-1738010), (-1738007)⟩, ⟨3025, 3028⟩, ⟨753, 756⟩⟩
...
def j25 : Jet := ⟨⟨144, 145⟩, ⟨287, 289⟩, ⟨142, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852033), (-852031)⟩, ⟨287, 289⟩, ⟨142, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10371), (-10370)⟩, ⟨(-20739), (-20737)⟩, ⟨(-10364), (-10360)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781023, 35781025⟩, ⟨(-20739), (-20737)⟩, ⟨(-10364), (-10360)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨435511, 435512⟩, ⟨870770, 870772⟩, ⟨434879, 434882⟩, ⟨(-506), (-503)⟩, ⟨(-128), (-124)⟩⟩
...
def j33 : Jet := ⟨⟨(-715392372), (-715392370)⟩, ⟨870770, 870772⟩, ⟨434879, 434882⟩, ⟨(-506), (-503)⟩, ⟨(-128), (-124)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8707456), (-8707454)⟩, ⟨(-17404313), (-17404310)⟩, ⟨(-8680966), (-8680962)⟩, ⟨21177, 21180⟩, ⟨5278, 5281⟩⟩
...
def j36 : Jet := ⟨⟨4286259840, 4286259842⟩, ⟨(-17404313), (-17404310)⟩, ⟨(-8680966), (-8680962)⟩, ⟨21177, 21180⟩, ⟨5278, 5281⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨157755087, 157755089⟩, ⟨157370927, 157370930⟩, ⟨(-575906), (-575904)⟩, ⟨(-191413), (-191410)⟩, ⟨416, 419⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303692439, 4303692442⟩, ⟨17475094, 17475099⟩, ⟨8787224, 8787231⟩, ⟨49804, 49811⟩, ⟨12607, 12615⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨158075563, 158075566⟩, ⟨158332486, 158332492⟩, ⟨385980, 385986⟩, ⟨129653, 129660⟩, ⟨745, 754⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-150828515), (-150828514)⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4144138781, 4144138782⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5817945, 5817946⟩, ⟨11654802, 11654804⟩, ⟨5865282, 5865287⟩, ⟨38000, 38006⟩, ⟨9646, 9651⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300785241, 4300785242⟩, ⟨11654802, 11654804⟩, ⟨5865282, 5865287⟩, ⟨38000, 38006⟩, ⟨9646, 9651⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297875284, 4297875285⟩, ⟨5823458, 5823460⟩, ⟨2926711, 2926715⟩, ⟨15020, 15025⟩, ⟨3801, 3806⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4146944647, 4146944650⟩, ⟨(-145311685), (-145311680)⟩, ⟨2619426, 2619432⟩, ⟨(-88287), (-88280)⟩, ⟨3139, 3146⟩⟩
...
def j47 : Jet := ⟨⟨1362633311, 1362633321⟩, ⟨1362633311, 1362633321⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨432312847, 432312854⟩, ⟨864625694, 864625708⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨432312847, 432312854⟩, ⟨864625694, 864625708⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-432312854), (-432312847)⟩, ⟨(-864625708), (-864625694)⟩, ⟨(-432312854), (-432312847)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-216156427), (-216156423)⟩, ⟨(-432312854), (-432312847)⟩, ⟨(-216156427), (-216156423)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4084160098, 4084160103⟩, ⟨(-411093913), (-411093905)⟩, ⟨(-184857489), (-184857483)⟩, ⟨19995296, 19995299⟩, ⟨4148578, 4148580⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3943402752, 3943402760⟩, ⟨(-535105330), (-535105315)⟩, ⟨(-162087120), (-162087105)⟩, ⟨25225784, 25225797⟩, ⟨3227789, 3227804⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 301657029⟩, ⟨150828514, 150828515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 947683507⟩, ⟨473841751, 473841755⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 209106140⟩, ⟨0, 209106140⟩, ⟨52276534, 52276536⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 53⟩, ⟨0, 53⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94633)⟩, ⟨0, 53⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4610), 0⟩, ⟨(-4610), 3⟩, ⟨(-1153), (-1147)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108446, 5113057⟩, ⟨(-4610), 3⟩, ⟨(-1153), (-1147)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 248936⟩, ⟨(-225), 248937⟩, ⟨61895, 62235⟩, ⟨(-114), 2⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142916640)⟩, ⟨(-225), 248937⟩, ⟨61895, 62235⟩, ⟨(-114), 2⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6970205), 0⟩, ⟨(-6970216), 12120⟩, ⟨(-1742563), (-1724371)⟩, ⟨(-9), 6061⟩, ⟨746, 759⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424685560, 1431655766⟩, ⟨(-6970216), 12120⟩, ⟨(-1742563), (-1724371)⟩, ⟨(-9), 6061⟩, ⟨746, 759⟩⟩
...
def j72 : Jet := ⟨⟨0, 577⟩, ⟨(-1), 577⟩, ⟨141, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851599)⟩, ⟨(-1), 577⟩, ⟨141, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-41490), 0⟩, ⟨(-41491), 29⟩, ⟨(-10374), (-10328)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35749904, 35791395⟩, ⟨(-41491), 29⟩, ⟨(-10374), (-10328)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1742552⟩, ⟨(-2021), 1742554⟩, ⟨432605, 435640⟩, ⟨(-1013), 2⟩, ⟨(-129), (-123)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714085330)⟩, ⟨(-2021), 1742554⟩, ⟨432605, 435640⟩, ⟨(-1013), 2⟩, ⟨(-129), (-123)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-34851024), 0⟩, ⟨(-34851123), 84839⟩, ⟨(-8712856), (-8585497)⟩, ⟨(-75), 42421⟩, ⟨5208, 5304⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4260116272, 4294967296⟩, ⟨(-34851123), 84839⟩, ⟨(-8712856), (-8585497)⟩, ⟨(-75), 42421⟩, ⟨5208, 5304⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 315894503⟩, ⟨155640286, 157949927⟩, ⟨(-1153486), 1338⟩, ⟨(-192251), (-188903)⟩, ⟨(-1), 837⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4330103429⟩, ⟨(-86234), 35423674⟩, ⟨8584797, 9145790⟩, ⟨(-43478), 147347⟩, ⟨11109, 14662⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 318478763⟩, ⟨155633943, 161847488⟩, ⟨(-1166095), 1976749⟩, ⟨104558, 158301⟩, ⟨(-5644), 7349⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-301657029), 0⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3993310267, 4294967296⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 23615715⟩, ⟨0, 24002506⟩, ⟨5466670, 6392068⟩, ⟨(-87886), 172458⟩, ⟨6201, 13932⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4318583011⟩, ⟨0, 24002506⟩, ⟨5466670, 6392068⟩, ⟨(-87886), 172458⟩, ⟨6201, 13932⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306758967⟩, ⟨0, 12001253⟩, ⟨2709129, 3196034⟩, ⟨(-52874), 86229⟩, ⟨1665, 6260⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3993310267, 4306758967⟩, ⟨(-151242610), (-138827261)⟩, ⟨2097398, 3196034⟩, ⟨(-165111), (-8908)⟩, ⟨(-1481), 8117⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2725266633⟩, ⟨1362633311, 1362633321⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1729251403⟩, ⟨0, 1729251410⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1729251403⟩, ⟨0, 1729251410⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1729251403), 0⟩, ⟨(-1729251410), 0⟩, ⟨(-432312854), (-432312847)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-864625702), 0⟩, ⟨(-864625705), 0⟩, ⟨(-216156427), (-216156423)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3511813538, 4294967296⟩, ⟨(-864625705), 0⟩, ⟨(-216156427), (-89712498)⟩, ⟨0, 43514745⟩, ⟨67514, 5439344⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3265161313, 4306758967⟩, ⟨(-1018242113), (-113513193)⟩, ⟨(-215034924), (-49768650)⟩, ⟨2091289, 51238645⟩, ⟨(-1631884), 5451824⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨150828514, 150828515⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297875284, 4297875285⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2522
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 301657029⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306758967⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2523
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (136623373 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(14047 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (14047 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(14047 / 200000), prawitzNormalCorrection
