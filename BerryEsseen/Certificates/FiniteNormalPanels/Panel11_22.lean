...
namespace FiniteNormalPanel11_22

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (114753 / 800000)
def radius : Rat := (38251 / 800000)

def j0 : Jet := ⟨⟨616075477, 616075478⟩, ⟨205358492, 205358493⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1935458192, 1935458196⟩, ⟨645152729, 645152733⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨872183221, 872183226⟩, ⟨581455478, 581455486⟩, ⟨96909246, 96909248⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-19184), (-19183)⟩, ⟨(-12761), (-12759)⟩, ⟨(-2109), (-2105)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5093872, 5093874⟩, ⟨(-12761), (-12759)⟩, ⟨(-2109), (-2105)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1034417, 1034418⟩, ⟨687019, 687022⟩, ⟨112778, 112782⟩, ⟨(-573), (-569)⟩, ⟨(-48), (-44)⟩⟩
...
def j16 : Jet := ⟨⟨(-142131160), (-142131158)⟩, ⟨687019, 687022⟩, ⟨112778, 112782⟩, ⟨(-573), (-569)⟩, ⟨(-48), (-44)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-28862715), (-28862713)⟩, ⟨(-19102297), (-19102294)⟩, ⟨(-3091059), (-3091055)⟩, ⟨30651, 30656⟩, ⟨2456, 2460⟩⟩
...
def j19 : Jet := ⟨⟨1402793050, 1402793053⟩, ⟨(-19102297), (-19102294)⟩, ⟨(-3091059), (-3091055)⟩, ⟨30651, 30656⟩, ⟨2456, 2460⟩⟩
...
def j25 : Jet := ⟨⟨2398, 2400⟩, ⟨1595, 1598⟩, ⟨262, 266⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849779), (-849776)⟩, ⟨1595, 1598⟩, ⟨262, 266⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-172566), (-172564)⟩, ⟨(-114721), (-114718)⟩, ⟨(-18906), (-18901)⟩, ⟨69, 74⟩, ⟨3, 7⟩⟩
...
def j30 : Jet := ⟨⟨35618828, 35618831⟩, ⟨(-114721), (-114718)⟩, ⟨(-18906), (-18901)⟩, ⟨69, 74⟩, ⟨3, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7233150, 7233151⟩, ⟨4798803, 4798806⟩, ⟨784311, 784316⟩, ⟨(-5135), (-5130)⟩, ⟨(-418), (-413)⟩⟩
...
def j33 : Jet := ⟨⟨(-708594733), (-708594731)⟩, ⟨4798803, 4798806⟩, ⟨784311, 784316⟩, ⟨(-5135), (-5130)⟩, ⟨(-418), (-413)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-143895029), (-143895026)⟩, ⟨(-94955523), (-94955518)⟩, ⟨(-15179402), (-15179398)⟩, ⟨213414, 213419⟩, ⟨16915, 16920⟩⟩
...
def j36 : Jet := ⟨⟨4151072267, 4151072270⟩, ⟨(-94955523), (-94955518)⟩, ⟨(-15179402), (-15179398)⟩, ⟨213414, 213419⟩, ⟨16915, 16920⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨632146210, 632146214⟩, ⟨202107257, 202107263⟩, ⟨(-4262319), (-4262314)⟩, ⟨(-450501), (-450496)⟩, ⟨5710, 5714⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4443850377, 4443850381⟩, ⟨101652798, 101652805⟩, ⟨18575311, 18575320⟩, ⟨568153, 568164⟩, ⟨57580, 57590⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨654059269, 654059275⟩, ⟨224074776, 224074786⟩, ⟨3107350, 3107360⟩, ⟨390717, 390729⟩, ⟨12018, 12030⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-616075478), (-616075477)⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3678891818, 3678891819⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨99603442, 99603445⟩, ⟨68246472, 68246478⟩, ⟨12636715, 12636723⟩, ⟨443230, 443238⟩, ⟨46676, 46683⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4394570738, 4394570741⟩, ⟨68246472, 68246478⟩, ⟨12636715, 12636723⟩, ⟨443230, 443238⟩, ⟨46676, 46683⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4344483582, 4344483585⟩, ⟨33734316, 33734320⟩, ⟨6115372, 6115377⟩, ⟨171603, 171609⟩, ⟨17434, 17440⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3721305426, 3721305430⟩, ⟨(-178830630), (-178830624)⟩, ⟨3625210, 3625216⟩, ⟨(-145412), (-145404)⟩, ⟨6727, 6735⟩⟩
...
def j47 : Jet := ⟨⟨3235763268, 3235763275⟩, ⟨1078587754, 1078587760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2437775006, 2437775017⟩, ⟨1625183334, 1625183348⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2437775006, 2437775017⟩, ⟨1625183334, 1625183348⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2437775017), (-2437775006)⟩, ⟨(-1625183348), (-1625183334)⟩, ⟨(-270863892), (-270863888)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1218887509), (-1218887503)⟩, ⟨(-812591674), (-812591667)⟩, ⟨(-135431946), (-135431944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3233773030, 3233773043⟩, ⟨(-611817709), (-611817701)⟩, ⟨(-44092814), (-44092810)⟩, ⟨15642243, 15642245⟩, ⟨(-44681), (-44680)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2801850699, 2801850714⟩, ⟨(-664745047), (-664745032)⟩, ⟨(-9999607), (-9999595)⟩, ⟨14762977, 14762989⟩, ⟨(-701457), (-701442)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨410716985, 821433971⟩, ⟨205358492, 205358493⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1290305462, 2580610929⟩, ⟨645152729, 645152733⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨387636987, 1550547958⟩, ⟨387636986, 775273980⟩, ⟨96909246, 96909248⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨97, 389⟩, ⟨97, 195⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94590), (-94297)⟩, ⟨97, 195⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34149), (-8510)⟩, ⟨(-17067), (-8439)⟩, ⟨(-2125), (-2081)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078907, 5104547⟩, ⟨(-17067), (-8439)⟩, ⟨(-2125), (-2081)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨458390, 1842819⟩, ⟨452228, 920649⟩, ⟨110748, 114229⟩, ⟨(-770), (-373)⟩, ⟨(-48), (-43)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142707187), (-141322757)⟩, ⟨452228, 920649⟩, ⟨110748, 114229⟩, ⟨(-770), (-373)⟩, ⟨(-48), (-43)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-51519447), (-12754911)⟩, ⟨(-25718909), (-12422542)⟩, ⟨(-3169156), (-2981303)⟩, ⟨19920, 41361⟩, ⟨2341, 2542⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1380136318, 1418900855⟩, ⟨(-25718909), (-12422542)⟩, ⟨(-3169156), (-2981303)⟩, ⟨19920, 41361⟩, ⟨2341, 2542⟩⟩
...
def j72 : Jet := ⟨⟨1064, 4270⟩, ⟨1056, 2135⟩, ⟨260, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851113), (-847906)⟩, ⟨1056, 2135⟩, ⟨260, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-307265), (-76526)⟩, ⟨(-153538), (-75755)⟩, ⟨(-19087), (-18648)⟩, ⟨45, 98⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35484129, 35714869⟩, ⟨(-153538), (-75755)⟩, ⟨(-19087), (-18648)⟩, ⟨45, 98⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3202576, 12893607⟩, ⟨3147146, 6439967⟩, ⟨766038, 797331⟩, ⟨(-6907), (-3356)⟩, ⟨(-427), (-399)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712625307), (-702934275)⟩, ⟨3147146, 6439967⟩, ⟨766038, 797331⟩, ⟨(-6907), (-3356)⟩, ⟨(-427), (-399)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-257268482), (-63442467)⟩, ⟨(-128350200), (-61117541)⟩, ⟨(-15726103), (-14410304)⟩, ⟨137653, 288931⟩, ⟨15882, 17653⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4037698814, 4231524829⟩, ⟨(-128350200), (-61117541)⟩, ⟨(-15726103), (-14410304)⟩, ⟨137653, 288931⟩, ⟨15882, 17653⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨414624211, 852539916⟩, ⟨191859019, 209402967⟩, ⟨(-5767445), (-2761656)⟩, ⟨(-470060), (-422973)⟩, ⟨3695, 7741⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4359360944, 4568628054⟩, ⟨62963926, 145227357⟩, ⟨15755056, 22410458⟩, ⟨130028, 1129399⟩, ⟨26554, 103895⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨420840594, 906860870⟩, ⟨200813887, 251572671⟩, ⟨(-1801339), 8725981⟩, ⟨21312, 847016⟩, ⟨(-33868), 67593⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-821433971), (-410716985)⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3473533325, 3884250311⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨41235891, 191479139⟩, ⟨39353330, 106236624⟩, ⟨8628491, 18420471⟩, ⟨(-206848), 1379918⟩, ⟨(-15972), 145499⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4336203187, 4486446435⟩, ⟨39353330, 106236624⟩, ⟨8628491, 18420471⟩, ⟨(-206848), 1379918⟩, ⟨(-15972), 145499⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4315535989, 4389662939⟩, ⟨19252191, 52865140⟩, ⟨3902846, 9123395⟩, ⟨(-214693), 669260⟩, ⟨(-25791), 73269⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3490168152, 3969890447⟩, ⟨(-194316134), (-158532179)⟩, ⟨628726, 7330429⟩, ⟨(-630387), 418652⟩, ⟨(-55325), 76529⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2157175513, 4314351035⟩, ⟨1078587754, 1078587760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1083455559, 4333822256⟩, ⟨1083455556, 2166911132⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1083455559, 4333822256⟩, ⟨1083455556, 2166911132⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4333822256), (-1083455559)⟩, ⟨(-2166911132), (-1083455556)⟩, ⟨(-270863892), (-270863888)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2166911128), (-541727779)⟩, ⟨(-1083455566), (-541727778)⟩, ⟨(-135431946), (-135431944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2593272591, 3786011589⟩, ⟨(-955065557), (-327091617)⟩, ⟨(-98755027), 38690307⟩, ⟨3622695, 28381238⟩, ⟨(-2399880), 1442774⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2107340238, 3499456505⟩, ⟨(-1054068275), (-361521238)⟩, ⟨(-78827525), 85433484⟩, ⟨(-992332), 31022235⟩, ⟨(-3812700), 1473532⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨616075477, 616075478⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4344483582, 4344483585⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified226
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨410716985, 821433971⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4315535989, 4389662939⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified227
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (33455427 / 536870912)

theorem envelope_integral : (∫ s in ((38251 / 400000) : ℝ)..(38251 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((38251 / 400000) : ℝ)..(38251 / 200000), prawitzNormalCorrection
