...
namespace FiniteNormalPanel109_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (15361 / 80000)
def radius : Rat := (15361 / 400000)

def j0 : Jet := ⟨⟨824687407, 824687408⟩, ⟨164937481, 164937482⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2590831899, 2590831903⟩, ⟨518166378, 518166382⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1562854724, 1562854730⟩, ⟨625141886, 625141894⟩, ⟨62514188, 62514190⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨391, 392⟩, ⟨156, 157⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94296), (-94294)⟩, ⟨156, 157⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-34313), (-34311)⟩, ⟨(-13669), (-13666)⟩, ⟨(-1346), (-1343)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5078743, 5078746⟩, ⟨(-13669), (-13666)⟩, ⟨(-1346), (-1343)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1848055, 1848057⟩, ⟨734248, 734251⟩, ⟨71442, 71446⟩, ⟨(-394), (-390)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-141317522), (-141317519)⟩, ⟨734248, 734251⟩, ⟨71442, 71446⟩, ⟨(-394), (-390)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-51422687), (-51422685)⟩, ⟨(-20301897), (-20301894)⟩, ⟨(-1924041), (-1924037)⟩, ⟨20941, 20947⟩, ⟨973, 978⟩⟩
...
def j19 : Jet := ⟨⟨1380233078, 1380233081⟩, ⟨(-20301897), (-20301894)⟩, ⟨(-1924041), (-1924037)⟩, ⟨20941, 20947⟩, ⟨973, 978⟩⟩
...
def j22 : Jet := ⟨⟨(-40), (-38)⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11795, 11798⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4291, 4294⟩, ⟨1710, 1713⟩, ⟨167, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847886), (-847882)⟩, ⟨1710, 1713⟩, ⟨167, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-308530), (-308527)⟩, ⟨(-122790), (-122787)⟩, ⟨(-12034), (-12029)⟩, ⟨47, 50⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35482864, 35482868⟩, ⟨(-122790), (-122787)⟩, ⟨(-12034), (-12029)⟩, ⟨47, 50⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12911521, 12911523⟩, ⟨5119927, 5119931⟩, ⟨494208, 494213⟩, ⟨(-3523), (-3518)⟩, ⟨(-170), (-165)⟩⟩
...
def j33 : Jet := ⟨⟨(-702916362), (-702916359)⟩, ⟨5119927, 5119931⟩, ⟨494208, 494213⟩, ⟨(-3523), (-3518)⟩, ⟨(-170), (-165)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-255777539), (-255777536)⟩, ⟨(-100447975), (-100447970)⟩, ⟨(-9306054), (-9306048)⟩, ⟨145172, 145176⟩, ⟨6618, 6622⟩⟩
...
def j36 : Jet := ⟨⟨4039189757, 4039189760⟩, ⟨(-100447975), (-100447970)⟩, ⟨(-9306054), (-9306048)⟩, ⟨145172, 145176⟩, ⟨6618, 6622⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨832591179, 832591183⟩, ⟨154271621, 154271626⟩, ⟨(-3609953), (-3609949)⟩, ⟨(-219494), (-219489)⟩, ⟨3112, 3118⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4566941681, 4566941685⟩, ⟨113572287, 113572294⟩, ⟨13346309, 13346320⟩, ⟨429418, 429428⟩, ⟨29856, 29866⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨885314158, 885314164⟩, ⟨186057011, 186057020⟩, ⟨2828089, 2828098⟩, ⟨233778, 233790⟩, ⟨7497, 7511⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-824687408), (-824687407)⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3470279888, 3470279889⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨182488271, 182488275⟩, ⟨76703216, 76703224⟩, ⟨9225845, 9225851⟩, ⟨341400, 341408⟩, ⟨25206, 25217⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4477455567, 4477455571⟩, ⟨76703216, 76703224⟩, ⟨9225845, 9225851⟩, ⟨341400, 341408⟩, ⟨25206, 25217⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4385262276, 4385262278⟩, ⟨37561927, 37561932⟩, ⟨4357071, 4357075⟩, ⟨129863, 129869⟩, ⟨9065, 9073⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3543237103, 3543237106⟩, ⟨(-138055469), (-138055461)⟩, ⟨2077985, 2077992⟩, ⟨(-62396), (-62389)⟩, ⟨2336, 2344⟩⟩
...
def j47 : Jet := ⟨⟨6179261010, 6179261020⟩, ⟨1235852199, 1235852207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8890234546, 8890234575⟩, ⟨3556093808, 3556093840⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8890234546, 8890234575⟩, ⟨3556093808, 3556093840⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8890234575), (-8890234546)⟩, ⟨(-3556093840), (-3556093808)⟩, ⟨(-355609385), (-355609380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4445117288), (-4445117273)⟩, ⟨(-1778046920), (-1778046904)⟩, ⟨(-177804693), (-177804690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1525747445, 1525747465⟩, ⟨(-631634747), (-631634732)⟩, ⟨67579799, 67579807⟩, ⟨8106787, 8106790⟩, ⟨(-2237868), (-2237866)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1258702240, 1258702258⟩, ⟨(-570125286), (-570125268)⟩, ⟨76792749, 76792764⟩, ⟨4187870, 4187880⟩, ⟨(-2064065), (-2064054)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨659749926, 989624890⟩, ⟨164937481, 164937482⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2072665520, 3108998285⟩, ⟨518166378, 518166382⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1000227024, 2250510812⟩, ⟨500113510, 750170274⟩, ⟨62514188, 62514190⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨250, 564⟩, ⟨125, 188⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94437), (-94122)⟩, ⟨125, 188⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-49484), (-21919)⟩, ⟨(-16466), (-10860)⟩, ⟨(-1358), (-1327)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5063572, 5091138⟩, ⟨(-16466), (-10860)⟩, ⟨(-1358), (-1327)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1179222, 2667695⟩, ⟨580983, 886703⟩, ⟨70113, 72530⟩, ⟨(-478), (-308)⟩, ⟨(-20), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141986355), (-140497881)⟩, ⟨580983, 886703⟩, ⟨70113, 72530⟩, ⟨(-478), (-308)⟩, ⟨(-20), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-74399130), (-32719638)⟩, ⟨(-24664409), (-15895197)⟩, ⟨(-1982665), (-1852098)⟩, ⟨16369, 25505⟩, ⟨925, 1018⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1357256635, 1398936128⟩, ⟨(-24664409), (-15895197)⟩, ⟨(-1982665), (-1852098)⟩, ⟨16369, 25505⟩, ⟨925, 1018⟩⟩
...
def j72 : Jet := ⟨⟨2742, 6190⟩, ⟨1361, 2062⟩, ⟨165, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849435), (-845986)⟩, ⟨1361, 2062⟩, ⟨165, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-445094), (-197016)⟩, ⟨(-148049), (-97427)⟩, ⟨(-12168), (-11862)⟩, ⟨36, 61⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35346300, 35594379⟩, ⟨(-148049), (-97427)⟩, ⟨(-12168), (-11862)⟩, ⟨36, 61⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8231570, 18651024⟩, ⟨4038209, 6194319⟩, ⟨482238, 503978⟩, ⟨(-4273), (-2767)⟩, ⟨(-174), (-159)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707596313), (-697176858)⟩, ⟨4038209, 6194319⟩, ⟨482238, 503978⟩, ⟨(-4273), (-2767)⟩, ⟨(-174), (-159)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-370771893), (-162360988)⟩, ⟨(-122650200), (-77934744)⟩, ⟨(-9716699), (-8801565)⟩, ⟨112689, 177543⟩, ⟨6180, 6977⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3924195403, 4132606308⟩, ⟨(-122650200), (-77934744)⟩, ⟨(-9716699), (-8801565)⟩, ⟨112689, 177543⟩, ⟨6180, 6977⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨654984970, 1012647996⟩, ⟨145892414, 161103963⟩, ⟨(-4410830), (-2811461)⟩, ⟨(-231300), (-204983)⟩, ⟨2420, 3815⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4463707089, 4700771032⟩, ⟨84178806, 146921968⟩, ⟨11094223, 16231606⟩, ⟨186550, 742930⟩, ⟨12896, 53967⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨680717884, 1108326569⟩, ⟨164461521, 210966236⟩, ⟨(-276302), 6416133⟩, ⟨1258, 515874⟩, ⟨(-13766), 33490⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-989624890), (-659749926)⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3305342406, 3635217370⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨107888327, 286006319⟩, ⟨52131664, 108880684⟩, ⟨6154906, 13673934⟩, ⟨(-26746), 896560⟩, ⟨(-7423), 77551⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4402855623, 4580973615⟩, ⟨52131664, 108880684⟩, ⟨6154906, 13673934⟩, ⟨(-26746), 896560⟩, ⟨(-7423), 77551⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4348576883, 4435665887⟩, ⟨25239028, 53769198⟩, ⟨2653941, 6679438⟩, ⟨(-95799), 427351⟩, ⟨(-14081), 38674⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3346599540, 3754303251⟩, ⟨(-150917083), (-121486511)⟩, ⟨(-22439), 4684169⟩, ⟨(-337592), 259789⟩, ⟨(-28331), 36413⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4943408811, 7415113227⟩, ⟨1235852199, 1235852207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5689750116, 12801937799⟩, ⟨2844875048, 4267312610⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5689750116, 12801937799⟩, ⟨2844875048, 4267312610⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12801937799), (-5689750116)⟩, ⟨(-4267312610), (-2844875048)⟩, ⟨(-355609385), (-355609380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6400968900), (-2844875058)⟩, ⟨(-2133656305), (-1422437524)⟩, ⟨(-177804693), (-177804690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨967637472, 2214595686⟩, ⟨(-1100168110), (-320468994)⟩, ⟨(-38613088), 233212447⟩, ⟨(-29773873), 36757530⟩, ⟨(-9392416), 4497031⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨753974336, 1935815389⟩, ⟨(-1039492208), (-277076914)⟩, ⟨(-24699206), 244928048⟩, ⟨(-35594428), 33626871⟩, ⟨(-9624929), 5336727⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨824687407, 824687408⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4385262276, 4385262278⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2198
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨659749926, 989624890⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4348576883, 4435665887⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2199
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (24680657 / 1073741824)

theorem envelope_integral : (∫ s in ((15361 / 100000) : ℝ)..(46083 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((15361 / 100000) : ℝ)..(46083 / 200000), prawitzNormalCorrection
