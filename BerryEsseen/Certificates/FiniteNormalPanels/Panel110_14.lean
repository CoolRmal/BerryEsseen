...
namespace FiniteNormalPanel110_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (110187 / 400000)
def radius : Rat := (15741 / 400000)

def j0 : Jet := ⟨⟨1183123903, 1183123904⟩, ⟨169017700, 169017701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3716893361, 3716893366⟩, ⟨530984764, 530984768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3216624319, 3216624329⟩, ⟨919035516, 919035526⟩, ⟨65645393, 65645395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨805, 806⟩, ⟨230, 231⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93882), (-93880)⟩, ⟨230, 231⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-70311), (-70309)⟩, ⟨(-19917), (-19914)⟩, ⟨(-1375), (-1371)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5042745, 5042748⟩, ⟨(-19917), (-19914)⟩, ⟨(-1375), (-1371)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3776656, 3776659⟩, ⟨1064127, 1064132⟩, ⟨71782, 71788⟩, ⟨(-596), (-591)⟩, ⟨(-21), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-139388921), (-139388917)⟩, ⟨1064127, 1064132⟩, ⟨71782, 71788⟩, ⟨(-596), (-591)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-104392366), (-104392361)⟩, ⟨(-29029436), (-29029428)⟩, ⟨(-1848997), (-1848988)⟩, ⟨31176, 31185⟩, ⟨953, 960⟩⟩
...
def j19 : Jet := ⟨⟨1327263399, 1327263405⟩, ⟨(-29029436), (-29029428)⟩, ⟨(-1848997), (-1848988)⟩, ⟨31176, 31185⟩, ⟨953, 960⟩⟩
...
def j25 : Jet := ⟨⟨8802, 8805⟩, ⟨2497, 2500⟩, ⟨171, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843375), (-843371)⟩, ⟨2497, 2500⟩, ⟨171, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-631628), (-631624)⟩, ⟨(-178596), (-178591)⟩, ⟨(-12229), (-12223)⟩, ⟨72, 77⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35159766, 35159771⟩, ⟨(-178596), (-178591)⟩, ⟨(-12229), (-12223)⟩, ⟨72, 77⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨26332158, 26332163⟩, ⟨7389717, 7389724⟩, ⟨490015, 490024⟩, ⟨(-5294), (-5286)⟩, ⟨(-172), (-166)⟩⟩
...
def j33 : Jet := ⟨⟨(-689495725), (-689495719)⟩, ⟨7389717, 7389724⟩, ⟨490015, 490024⟩, ⟨(-5294), (-5286)⟩, ⟨(-172), (-166)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-516383146), (-516383139)⟩, ⟨(-142003672), (-142003662)⟩, ⟨(-8590198), (-8590186)⟩, ⟨213834, 213845⟩, ⟨6227, 6235⟩⟩
...
def j36 : Jet := ⟨⟨3778584150, 3778584157⟩, ⟨(-142003672), (-142003662)⟩, ⟨(-8590198), (-8590186)⟩, ⟨213834, 213845⟩, ⟨6227, 6235⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1148622603, 1148622610⟩, ⟨138966674, 138966685⟩, ⟨(-5189031), (-5189020)⟩, ⟨(-201612), (-201601)⟩, ⟨4678, 4687⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4881919604, 4881919614⟩, ⟨183468312, 183468327⟩, ⟨17993449, 17993469⟩, ⟨817020, 817040⟩, ⟨53168, 53187⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1305593923, 1305593935⟩, ⟨207023689, 207023708⟩, ⟨4850147, 4850170⟩, ⟨349863, 349887⟩, ⟨15617, 15639⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1183123904), (-1183123903)⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3111843392, 3111843393⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨396877408, 396877417⟩, ⟨125863062, 125863076⟩, ⟨12927559, 12927578⟩, ⟨680272, 680292⟩, ⟨48697, 48718⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4691844704, 4691844713⟩, ⟨125863062, 125863076⟩, ⟨12927559, 12927578⟩, ⟨680272, 680292⟩, ⟨48697, 48718⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4489022116, 4489022121⟩, ⟨60211079, 60211087⟩, ⟨5780553, 5780564⟩, ⟨247897, 247909⟩, ⟨16247, 16260⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3252442415, 3252442421⟩, ⟨(-133029361), (-133029352)⟩, ⟨1818741, 1818751⟩, ⟨(-47871), (-47860)⟩, ⟨2015, 2026⟩⟩
...
def j47 : Jet := ⟨⟨8400295285, 8400295294⟩, ⟨1200042180, 1200042188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16429685259, 16429685296⟩, ⟨4694195774, 4694195812⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16429685259, 16429685296⟩, ⟨4694195774, 4694195812⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16429685296), (-16429685259)⟩, ⟨(-4694195812), (-4694195774)⟩, ⟨(-335299702), (-335299697)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8214842648), (-8214842629)⟩, ⟨(-2347097906), (-2347097887)⟩, ⟨(-167649851), (-167649848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨634306398, 634306406⟩, ⟨(-346633429), (-346633420)⟩, ⟨69953945, 69953951⟩, ⟨(-3722395), (-3722392)⟩, ⟨(-856743), (-856741)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨480340102, 480340110⟩, ⟨(-282141066), (-282141055)⟩, ⟨63978888, 63978898⟩, ⟨(-5139414), (-5139406)⟩, ⟨(-499710), (-499700)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1014106203, 1352141605⟩, ⟨169017700, 169017701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3185908597, 4247878134⟩, ⟨530984764, 530984768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2363234196, 4201305249⟩, ⟨787744728, 1050326316⟩, ⟨65645393, 65645395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨591, 1053⟩, ⟨197, 264⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94096), (-93633)⟩, ⟨197, 264⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-92045), (-51519)⟩, ⟨(-22904), (-16914)⟩, ⟨(-1395), (-1349)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5021011, 5061538⟩, ⟨(-22904), (-16914)⟩, ⟨(-1395), (-1349)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2762727, 4951160⟩, ⟨898504, 1228484⟩, ⟨69775, 73518⟩, ⟨(-691), (-495)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140402850), (-138214416)⟩, ⟨898504, 1228484⟩, ⟨69775, 73518⟩, ⟨(-691), (-495)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-137341030), (-76050179)⟩, ⟨(-33840872), (-24148365)⟩, ⟨(-1942767), (-1740165)⟩, ⟨25853, 36484⟩, ⟨875, 1026⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1294314735, 1355605587⟩, ⟨(-33840872), (-24148365)⟩, ⟨(-1942767), (-1740165)⟩, ⟨25853, 36484⟩, ⟨875, 1026⟩⟩
...
def j72 : Jet := ⟨⟨6453, 11522⟩, ⟨2124, 2871⟩, ⟨170, 178⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845724), (-840654)⟩, ⟨2124, 2871⟩, ⟨170, 178⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-827281), (-462555)⟩, ⟨(-205653), (-151376)⟩, ⟨(-12445), (-11970)⟩, ⟨61, 88⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34964113, 35328840⟩, ⟨(-205653), (-151376)⟩, ⟨(-12445), (-11970)⟩, ⟨61, 88⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19238420, 34558411⟩, ⟨6211637, 8556311⟩, ⟨471933, 505626⟩, ⟨(-6155), (-4421)⟩, ⟨(-180), (-157)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696589463), (-681269471)⟩, ⟨6211637, 8556311⟩, ⟨471933, 505626⟩, ⟨(-6155), (-4421)⟩, ⟨(-180), (-157)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-681398662), (-374857175)⟩, ⟨(-166931818), (-116582670)⟩, ⟨(-9247899), (-7825668)⟩, ⟨175476, 251995⟩, ⟨5530, 6833⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3613568634, 3920110121⟩, ⟨(-166931818), (-116582670)⟩, ⟨(-9247899), (-7825668)⟩, ⟨175476, 251995⟩, ⟨5530, 6833⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨960093094, 1340742999⟩, ⟨126545667, 149680171⟩, ⟨(-6105198), (-4276264)⟩, ⟨(-221007), (-179051)⟩, ⟨3845, 5526⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4705669867, 5104855046⟩, ⟨139944935, 235823039⟩, ⟨13555781, 23958465⟩, ⟨354359, 1481796⟩, ⟨13539, 115774⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1051901174, 1593562464⟩, ⟨169929651, 251520813⟩, ⟨(-102893), 11012306⟩, ⟨(-119284), 962016⟩, ⟨(-28514), 75021⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1352141605), (-1014106203)⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2942825691, 3280861093⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨257626194, 591259759⟩, ⟨83236582, 186643624⟩, ⟨6646883, 22901296⟩, ⟨(-100568), 2003674⟩, ⟨(-35396), 196584⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4552593490, 4886227055⟩, ⟨83236582, 186643624⟩, ⟨6646883, 22901296⟩, ⟨(-100568), 2003674⟩, ⟨(-35396), 196584⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4421904584, 4581068151⟩, ⟨39019109, 90642872⟩, ⟨2219134, 10949788⟩, ⟨(-273297), 953497⟩, ⟨(-50294), 100517⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3029800581, 3499409245⟩, ⟨(-153541372), (-104772268)⟩, ⟨(-2046518), 6828880⟩, ⟨(-639670), 641035⟩, ⟨(-75942), 87539⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7200253104, 9600337482⟩, ⟨1200042180, 1200042188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12070789179, 21459180808⟩, ⟨4023596378, 5364795216⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12070789179, 21459180808⟩, ⟨4023596378, 5364795216⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21459180808), (-12070789179)⟩, ⟨(-5364795216), (-4023596378)⟩, ⟨(-335299702), (-335299697)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10729590404), (-6035394589)⟩, ⟨(-2682397608), (-2011798189)⟩, ⟨(-167649851), (-167649848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨353195515, 1053606605⟩, ⟨(-658024065), (-165439699)⟩, ⟨(-2379844), 191695969⟩, ⟨(-35602362), 17618991⟩, ⟨(-6492293), 5605262⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨249154860, 858446745⟩, ⟨(-573803602), (-125322116)⟩, ⟨1594707, 181387068⟩, ⟨(-37063853), 14911297⟩, ⟨(-6127772), 6264022⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1183123903, 1183123904⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4489022116, 4489022121⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2222
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1014106203, 1352141605⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4421904584, 4581068151⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2223
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (39582257 / 4294967296)

theorem envelope_integral : (∫ s in ((47223 / 200000) : ℝ)..(15741 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((47223 / 200000) : ℝ)..(15741 / 50000), prawitzNormalCorrection
