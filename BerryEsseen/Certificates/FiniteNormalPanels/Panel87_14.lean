...
namespace FiniteNormalPanel87_14
...
def j2 : Jet := ⟨⟨509699497, 509699501⟩, ⟨509699497, 509699501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨60487905, 60487907⟩, ⟨120975810, 120975814⟩, ⟨60487905, 60487907⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1334), (-1333)⟩, ⟨(-2667), (-2665)⟩, ⟨(-1334), (-1331)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111722, 5111724⟩, ⟨(-2667), (-2665)⟩, ⟨(-1334), (-1331)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨71990, 71991⟩, ⟨143943, 143945⟩, ⟨71895, 71898⟩, ⟨(-76), (-73)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-143093587), (-143093585)⟩, ⟨143943, 143945⟩, ⟨71895, 71898⟩, ⟨(-76), (-73)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2015250), (-2015249)⟩, ⟨(-4028473), (-4028471)⟩, ⟨(-2010184), (-2010181)⟩, ⟨4050, 4053⟩, ⟨1008, 1011⟩⟩
...
def j19 : Jet := ⟨⟨1429640515, 1429640517⟩, ⟨(-4028473), (-4028471)⟩, ⟨(-2010184), (-2010181)⟩, ⟨4050, 4053⟩, ⟨1008, 1011⟩⟩
...
def j28 : Jet := ⟨⟨(-12000), (-11999)⟩, ⟨(-23995), (-23993)⟩, ⟨(-11989), (-11986)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779394, 35779396⟩, ⟨(-23995), (-23993)⟩, ⟨(-11989), (-11986)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨503896, 503897⟩, ⟨1007455, 1007457⟩, ⟨503051, 503054⟩, ⟨(-676), (-673)⟩, ⟨(-169), (-166)⟩⟩
...
def j33 : Jet := ⟨⟨(-715323987), (-715323985)⟩, ⟨1007455, 1007457⟩, ⟨503051, 503054⟩, ⟨(-676), (-673)⟩, ⟨(-169), (-166)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10074222), (-10074220)⟩, ⟨(-20134255), (-20134252)⟩, ⟨(-10038762), (-10038758)⟩, ⟨28347, 28350⟩, ⟨7061, 7065⟩⟩
...
def j36 : Jet := ⟨⟨4284893074, 4284893076⟩, ⟨(-20134255), (-20134252)⟩, ⟨(-10038762), (-10038758)⟩, ⟨28347, 28350⟩, ⟨7061, 7065⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨169660675, 169660677⟩, ⟨169182601, 169182604⟩, ⟨(-716630), (-716628)⟩, ⟨(-238076), (-238074)⟩, ⟨599, 601⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305065201, 4305065204⟩, ⟨20229037, 20229042⟩, ⟨10181071, 10181078⟩, ⟨66747, 66754⟩, ⟨16931, 16940⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨170059564, 170059567⟩, ⟨170379457, 170379462⟩, ⟨480698, 480705⟩, ⟨161665, 161671⟩, ⟨1076, 1084⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-162242390), (-162242389)⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4132724906, 4132724907⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6733521, 6733522⟩, ⟨13492374, 13492378⟩, ⟨6796943, 6796947⟩, ⟨50940, 50944⟩, ⟨12963, 12968⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301700817, 4301700818⟩, ⟨13492374, 13492378⟩, ⟨6796943, 6796947⟩, ⟨50940, 50944⟩, ⟨12963, 12968⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298332737, 4298332739⟩, ⟨6740904, 6740907⟩, ⟨3390524, 3390528⟩, ⟨20132, 20136⟩, ⟨5106, 5111⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4135963217, 4135963221⟩, ⟨(-155883254), (-155883248)⟩, ⟨3007808, 3007814⟩, ⟨(-108707), (-108701)⟩, ⟨4152, 4158⟩⟩
...
def j47 : Jet := ⟨⟨1337565192, 1337565202⟩, ⟨1337565192, 1337565202⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨416552797, 416552804⟩, ⟨833105594, 833105608⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨416552797, 416552804⟩, ⟨833105594, 833105608⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-416552804), (-416552797)⟩, ⟨(-833105608), (-833105594)⟩, ⟨(-416552804), (-416552797)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-208276402), (-208276398)⟩, ⟨(-416552804), (-416552797)⟩, ⟨(-208276402), (-208276398)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4091660231, 4091660236⟩, ⟨(-396834814), (-396834805)⟩, ⟨(-179173647), (-179173640)⟩, ⟨18621633, 18621636⟩, ⟨3892834, 3892835⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3940182787, 3940182796⟩, ⟨(-530647931), (-530647914)⟩, ⟨(-155272147), (-155272131)⟩, ⟨24053770, 24053783⟩, ⟨2961375, 2961389⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 324484780⟩, ⟨162242389, 162242390⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1019399002⟩, ⟨509699497, 509699501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 241951628⟩, ⟨0, 241951628⟩, ⟨60487905, 60487907⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5335), 0⟩, ⟨(-5335), 4⟩, ⟨(-1334), (-1327)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107721, 5113057⟩, ⟨(-5335), 4⟩, ⟨(-1334), (-1327)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 288038⟩, ⟨(-301), 288039⟩, ⟨71557, 72011⟩, ⟨(-152), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142877538)⟩, ⟨(-301), 288039⟩, ⟨71557, 72011⟩, ⟨(-152), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8065055), 0⟩, ⟨(-8065072), 16227⟩, ⟨(-2016281), (-1991922)⟩, ⟨(-14), 8115⟩, ⟨996, 1016⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423590710, 1431655766⟩, ⟨(-8065072), 16227⟩, ⟨(-2016281), (-1991922)⟩, ⟨(-14), 8115⟩, ⟨996, 1016⟩⟩
...
def j74 : Jet := ⟨⟨(-48007), 0⟩, ⟨(-48008), 38⟩, ⟨(-12003), (-11944)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35743387, 35791395⟩, ⟨(-48008), 38⟩, ⟨(-12003), (-11944)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2016264⟩, ⟨(-2705), 2016267⟩, ⟨500007, 504069⟩, ⟨(-1355), 3⟩, ⟨(-171), (-165)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713811618)⟩, ⟨(-2705), 2016267⟩, ⟨500007, 504069⟩, ⟨(-1355), 3⟩, ⟨(-171), (-165)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-40325272), 0⟩, ⟨(-40325425), 113584⟩, ⟨(-10081471), (-9910940)⟩, ⟨(-116), 56794⟩, ⟨6954, 7101⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4254642024, 4294967296⟩, ⟨(-40325425), 113584⟩, ⟨(-10081471), (-9910940)⟩, ⟨(-116), 56794⟩, ⟨6954, 7101⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 339799668⟩, ⟨167028498, 169903686⟩, ⟨(-1435671), 1926⟩, ⟨(-239284), (-234461)⟩, ⟨(-2), 1206⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4335674769⟩, ⟨(-115748), 41093453⟩, ⟨9909853, 10662965⟩, ⟨(-58436), 198556⟩, ⟨14605, 20132⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 343020272⟩, ⟨167019340, 174765166⟩, ⟨(-1453858), 2471162⟩, ⟨125474, 203101⟩, ⟨(-8170), 10678⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-324484780), 0⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3970482516, 4294967296⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 27395531⟩, ⟨0, 27915462⟩, ⟨6262689, 7506037⟩, ⟨(-118318), 233550⟩, ⟨7615, 19658⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4322362827⟩, ⟨0, 27915462⟩, ⟨6262689, 7506037⟩, ⟨(-118318), 233550⟩, ⟨7615, 19658⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4308643289⟩, ⟨0, 13957731⟩, ⟨3098797, 3753019⟩, ⟨(-71356), 116775⟩, ⟨1781, 8944⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3970482516, 4308643289⟩, ⟨(-162759001), (-148284658)⟩, ⟨2337428, 3753019⟩, ⟨(-213127), (-282)⟩, ⟨(-2766), 11640⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2675130403⟩, ⟨1337565192, 1337565202⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1666211215⟩, ⟨0, 1666211216⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1666211215⟩, ⟨0, 1666211216⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1666211215), 0⟩, ⟨(-1666211216), 0⟩, ⟨(-416552804), (-416552797)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-833105608), 0⟩, ⟨(-833105608), 0⟩, ⟨(-208276402), (-208276398)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3537680993, 4294967296⟩, ⟨(-833105608), 0⟩, ⟨(-208276402), (-90753421)⟩, ⟨0, 40399898⟩, ⟨241341, 5049988⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3270409193, 4308643289⟩, ⟨(-998517376), (-122139187)⟩, ⟨(-207014301), (-48573208)⟩, ⟨2192171, 48421001⟩, ⟨(-1492621), 5069660⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298332737, 4298332739⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1762
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4308643289⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1763
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (293847143 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1511 / 20000), prawitzNormalCorrection
