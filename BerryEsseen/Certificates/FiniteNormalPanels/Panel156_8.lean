...
namespace FiniteNormalPanel156_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6379 / 40000)
def radius : Rat := (6379 / 200000)

def j0 : Jet := ⟨⟨684939909, 684939910⟩, ⟨136987981, 136987982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2151802186, 2151802190⟩, ⟨430360434, 430360438⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1078064704, 1078064709⟩, ⟨431225878, 431225884⟩, ⟨43122587, 43122589⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨269, 271⟩, ⟨107, 109⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94418), (-94415)⟩, ⟨107, 109⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23700), (-23698)⟩, ⟨(-9454), (-9451)⟩, ⟨(-936), (-933)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5089356, 5089359⟩, ⟨(-9454), (-9451)⟩, ⟨(-936), (-933)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1277461, 1277463⟩, ⟨508610, 508613⟩, ⟨49913, 49917⟩, ⟨(-189), (-185)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-141888116), (-141888113)⟩, ⟨508610, 508613⟩, ⟨49913, 49917⟩, ⟨(-189), (-185)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-35614840), (-35614838)⟩, ⟨(-14118272), (-14118269)⟩, ⟨(-1361001), (-1360996)⟩, ⟨10069, 10073⟩, ⟨479, 483⟩⟩
...
def j19 : Jet := ⟨⟨1396040925, 1396040928⟩, ⟨(-14118272), (-14118269)⟩, ⟨(-1361001), (-1360996)⟩, ⟨10069, 10073⟩, ⟨479, 483⟩⟩
...
def j22 : Jet := ⟨⟨(-28), (-26)⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11807, 11810⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2963, 2965⟩, ⟨1182, 1184⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849214), (-849211)⟩, ⟨1182, 1184⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-213159), (-213157)⟩, ⟨(-84968), (-84964)⟩, ⟨(-8381), (-8377)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35578235, 35578238⟩, ⟨(-84968), (-84964)⟩, ⟨(-8381), (-8377)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8930368, 8930369⟩, ⟨3550819, 3550822⟩, ⟨346578, 346583⟩, ⟨(-1691), (-1687)⟩, ⟨(-84), (-80)⟩⟩
...
def j33 : Jet := ⟨⟨(-706897515), (-706897513)⟩, ⟨3550819, 3550822⟩, ⟨346578, 346583⟩, ⟨(-1691), (-1687)⟩, ⟨(-84), (-80)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-177435872), (-177435869)⟩, ⟨(-70083071), (-70083067)⟩, ⟨(-6653931), (-6653927)⟩, ⟨70023, 70027⟩, ⟨3287, 3291⟩⟩
...
def j36 : Jet := ⟨⟨4117531424, 4117531427⟩, ⟨(-70083071), (-70083067)⟩, ⟨(-6653931), (-6653927)⟩, ⟨70023, 70027⟩, ⟨3287, 3291⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨699424164, 699424168⟩, ⟨132811499, 132811504⟩, ⟨(-2096536), (-2096532)⟩, ⟨(-131330), (-131326)⟩, ⟨1247, 1252⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4480049369, 4480049373⟩, ⟨76253358, 76253364⟩, ⟨8537637, 8537644⟩, ⟨192347, 192355⟩, ⟨12190, 12199⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨729564294, 729564300⟩, ⟨150952374, 150952382⟩, ⟨1561400, 1561408⟩, ⟨121115, 121125⟩, ⟨2732, 2744⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-684939910), (-684939909)⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3610027386, 3610027387⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨123927383, 123927386⟩, ⟨51283026, 51283032⟩, ⟨5835877, 5835882⟩, ⟨150900, 150906⟩, ⟨10007, 10018⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4418894679, 4418894682⟩, ⟨51283026, 51283032⟩, ⟨5835877, 5835882⟩, ⟨150900, 150906⟩, ⟨10007, 10018⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4356490345, 4356490348⟩, ⟨25279399, 25279403⟩, ⟨2803386, 2803390⟩, ⟨58116, 58121⟩, ⟨3692, 3700⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3661739046, 3661739051⟩, ⟨(-117702294), (-117702287)⟩, ⟨1550029, 1550034⟩, ⟨(-40568), (-40560)⟩, ⟨1249, 1257⟩⟩
...
def j47 : Jet := ⟨⟨8118325120, 8118325134⟩, ⟨1623665014, 1623665027⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15345216438, 15345216492⟩, ⟨6138086536, 6138086598⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15345216438, 15345216492⟩, ⟨6138086536, 6138086598⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15345216492), (-15345216438)⟩, ⟨(-6138086598), (-6138086536)⟩, ⟨(-613808660), (-613808649)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7672608246), (-7672608219)⟩, ⟨(-3069043299), (-3069043268)⟩, ⟨(-306904330), (-306904324)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨719661453, 719661466⟩, ⟨(-514246570), (-514246555)⟩, ⟨132307233, 132307244⟩, ⟨(-7016560), (-7016554)⟩, ⟨(-3473672), (-3473669)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨613558209, 613558222⟩, ⟨(-458150766), (-458150749)⟩, ⟨127153016, 127153031⟩, ⟨(-9800303), (-9800291)⟩, ⟨(-2716433), (-2716422)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨547951927, 821927892⟩, ⟨136987981, 136987982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1721441748, 2582162628⟩, ⟨430360434, 430360438⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨689961410, 1552413180⟩, ⟨344980702, 517471060⟩, ⟨43122587, 43122589⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨172, 389⟩, ⟨86, 130⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94515), (-94297)⟩, ⟨86, 130⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34163), (-15148)⟩, ⟨(-11375), (-7527)⟩, ⟨(-942), (-926)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078893, 5097909⟩, ⟨(-11375), (-7527)⟩, ⟨(-942), (-926)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨815894, 1842636⟩, ⟨403835, 613003⟩, ⟨49281, 50433⟩, ⟨(-229), (-147)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142349683), (-141322940)⟩, ⟨403835, 613003⟩, ⟨49281, 50433⟩, ⟨(-229), (-147)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-51452202), (-22702704)⟩, ⟨(-17085861), (-11129782)⟩, ⟨(-1388876), (-1326833)⟩, ⟨7929, 12209⟩, ⟨462, 495⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1380203563, 1408953062⟩, ⟨(-17085861), (-11129782)⟩, ⟨(-1388876), (-1326833)⟩, ⟨7929, 12209⟩, ⟨462, 495⟩⟩
...
def j72 : Jet := ⟨⟨1894, 4272⟩, ⟨941, 1423⟩, ⟨115, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850283), (-847904)⟩, ⟨941, 1423⟩, ⟨115, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-307335), (-136210)⟩, ⟨(-102294), (-67590)⟩, ⟨(-8445), (-8297)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35484059, 35655185⟩, ⟨(-102294), (-67590)⟩, ⟨(-8445), (-8297)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5700306, 12887544⟩, ⟨2813178, 4284991⟩, ⟨340891, 351228⟩, ⟨(-2044), (-1333)⟩, ⟨(-85), (-78)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710127577), (-702940338)⟩, ⟨2813178, 4284991⟩, ⟨340891, 351228⟩, ⟨(-2044), (-1333)⟩, ⟨(-85), (-78)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-256675159), (-112923259)⟩, ⟨(-85106467), (-54912821)⟩, ⟨(-6849144), (-6414481)⟩, ⟨54887, 85127⟩, ⟨3144, 3408⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4038292137, 4182044037⟩, ⟨(-85106467), (-54912821)⟩, ⟨(-6849144), (-6414481)⟩, ⟨54887, 85127⟩, ⟨3144, 3408⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨553191647, 847071862⟩, ⟨128025777, 136717779⟩, ⟨(-2547025), (-1647016)⟩, ⟨(-135990), (-125609)⟩, ⟨979, 1522⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4410939700, 4567956812⟩, ⟨57918362, 96269080⟩, ⟨7526067, 9776341⟩, ⟨94674, 309363⟩, ⟨7102, 18883⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨568128888, 900912025⟩, ⟨138942603, 164394207⟩, ⟨(-13109), 3301090⟩, ⟨34808, 221006⟩, ⟨(-4106), 10613⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-821927892), (-547951927)⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3473039404, 3747015369⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨75150847, 188975241⟩, ⟨36758046, 68966634⟩, ⟨4489306, 7677229⟩, ⟨8204, 345424⟩, ⟨517, 23912⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4370118143, 4483942537⟩, ⟨36758046, 68966634⟩, ⟨4489306, 7677229⟩, ⟨8204, 345424⟩, ⟨517, 23912⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4332379773, 4388437827⟩, ⟨17987563, 34185535⟩, ⟨2063692, 3768126⟩, ⟨(-25668), 162654⟩, ⟨(-2667), 11565⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3503292255, 3828560930⟩, ⟨(-125423942), (-108357106)⟩, ⟨578415, 2713676⟩, ⟨(-142579), 76082⟩, ⟨(-7515), 10909⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6494660094, 9741990161⟩, ⟨1623665014, 1623665027⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9820938514, 22097111749⟩, ⟨4910469228, 7365703918⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9820938514, 22097111749⟩, ⟨4910469228, 7365703918⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-22097111749), (-9820938514)⟩, ⟨(-7365703918), (-4910469228)⟩, ⟨(-613808660), (-613808649)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11048555875), (-4910469257)⟩, ⟨(-3682851959), (-2455234614)⟩, ⟨(-306904330), (-306904324)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨327915790, 1369076229⟩, ⟨(-1173956570), (-187454325)⟩, ⟨(-44250221), 479890815⟩, ⟨(-128235804), 68572639⟩, ⟨(-31845646), 29070923⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨267472315, 1220403184⟩, ⟨(-1086452789), (-161174518)⟩, ⟨(-34671509), 462925230⟩, ⟨(-129111422), 62417311⟩, ⟨(-30441057), 30004474⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨684939909, 684939910⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4356490345, 4356490348⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3148
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨547951927, 821927892⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4332379773, 4388437827⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3149
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (21112687 / 2147483648)

theorem envelope_integral : (∫ s in ((6379 / 50000) : ℝ)..(19137 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((6379 / 50000) : ℝ)..(19137 / 100000), prawitzNormalCorrection
