...
namespace FiniteNormalPanel66_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (32111 / 160000)
def radius : Rat := (32111 / 800000)

def j0 : Jet := ⟨⟨861973092, 861973093⟩, ⟨172394618, 172394619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2707968333, 2707968337⟩, ⟨541593665, 541593669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1707368645, 1707368651⟩, ⟨682947454, 682947464⟩, ⟨68294745, 68294747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨427, 428⟩, ⟨170, 172⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94260), (-94258)⟩, ⟨170, 172⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-37471), (-37470)⟩, ⟨(-14922), (-14919)⟩, ⟨(-1466), (-1462)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5075585, 5075587⟩, ⟨(-14922), (-14919)⟩, ⟨(-1466), (-1462)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2017685, 2017687⟩, ⟨801142, 801145⟩, ⟨77751, 77755⟩, ⟨(-471), (-466)⟩, ⟨(-24), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-141147892), (-141147889)⟩, ⟨801142, 801145⟩, ⟨77751, 77755⟩, ⟨(-471), (-466)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-56110203), (-56110201)⟩, ⟨(-22125606), (-22125602)⟩, ⟨(-2086111), (-2086107)⟩, ⟨24914, 24919⟩, ⟨1151, 1155⟩⟩
...
def j19 : Jet := ⟨⟨1375545562, 1375545565⟩, ⟨(-22125606), (-22125602)⟩, ⟨(-2086111), (-2086107)⟩, ⟨24914, 24919⟩, ⟨1151, 1155⟩⟩
...
def j22 : Jet := ⟨⟨(-43), (-42)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11792, 11794⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4687, 4689⟩, ⟨1867, 1870⟩, ⟨183, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847490), (-847487)⟩, ⟨1867, 1870⟩, ⟨183, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-336901), (-336899)⟩, ⟨(-134019), (-134015)⟩, ⟨(-13109), (-13103)⟩, ⟨57, 60⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35454493, 35454496⟩, ⟨(-134019), (-134015)⟩, ⟨(-13109), (-13103)⟩, ⟨57, 60⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨14094144, 14094146⟩, ⟨5584380, 5584385⟩, ⟨537242, 537249⟩, ⟨(-4195), (-4189)⟩, ⟨(-200), (-196)⟩⟩
...
def j33 : Jet := ⟨⟨(-701733739), (-701733736)⟩, ⟨5584380, 5584385⟩, ⟨537242, 537249⟩, ⟨(-4195), (-4189)⟩, ⟨(-200), (-196)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-278958629), (-278958626)⟩, ⟨(-109363508), (-109363501)⟩, ⟨(-10056800), (-10056792)⟩, ⟨172556, 172562⟩, ⟨7794, 7800⟩⟩
...
def j36 : Jet := ⟨⟨4016008667, 4016008670⟩, ⟨(-109363508), (-109363501)⟩, ⟨(-10056800), (-10056792)⟩, ⟨172556, 172562⟩, ⟨7794, 7800⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨867278739, 867278743⟩, ⟨159505596, 159505602⟩, ⟨(-4105320), (-4105315)⟩, ⟨(-247350), (-247345)⟩, ⟨3866, 3872⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4593302851, 4593302855⟩, ⟨125084311, 125084321⟩, ⟨14908719, 14908732⟩, ⟨521856, 521867⟩, ⟨37248, 37259⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨927521359, 927521365⟩, ⟨195843277, 195843287⟩, ⟨3265374, 3265387⟩, ⟨274959, 274974⟩, ⟨9580, 9593⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-861973093), (-861973092)⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3432994203, 3432994204⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨200303241, 200303245⟩, ⟨84586824, 84586830⟩, ⟨10340473, 10340481⟩, ⟨416546, 416560⟩, ⟨31692, 31705⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4495270537, 4495270541⟩, ⟨84586824, 84586830⟩, ⟨10340473, 10340481⟩, ⟨416546, 416560⟩, ⟨31692, 31705⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4393977690, 4393977693⟩, ⟨41340405, 41340409⟩, ⟨4859260, 4859265⟩, ⟨157861, 157870⟩, ⟨11316, 11324⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3512133829, 3512133834⟩, ⟨(-143325129), (-143325123)⟩, ⟨2224683, 2224689⟩, ⟨(-68866), (-68857)⟩, ⟨2707, 2716⟩⟩
...
def j47 : Jet := ⟨⟨6808289016, 6808289026⟩, ⟨1361657800, 1361657809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10792352102, 10792352134⟩, ⟨4316940830, 4316940866⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10792352102, 10792352134⟩, ⟨4316940830, 4316940866⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10792352134), (-10792352102)⟩, ⟨(-4316940866), (-4316940830)⟩, ⟨(-431694088), (-431694082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5396176067), (-5396176051)⟩, ⟨(-2158470433), (-2158470415)⟩, ⟨(-215847044), (-215847041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1222684425, 1222684441⟩, ⟨(-614469921), (-614469907)⟩, ⟨92956408, 92956416⟩, ⟨5015121, 5015124⟩, ⟨(-2965898), (-2965896)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨999828644, 999828660⟩, ⟨(-543273522), (-543273505)⟩, ⟨97151939, 97151951⟩, ⟨661139, 661149⟩, ⟨(-2533899), (-2533888)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨689578474, 1034367712⟩, ⟨172394618, 172394619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2166374667, 3249562006⟩, ⟨541593665, 541593669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1092715933, 2458610859⟩, ⟨546357964, 819536956⟩, ⟨68294745, 68294747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨273, 616⟩, ⟨136, 206⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94414), (-94070)⟩, ⟨136, 206⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-54047), (-23933)⟩, ⟨(-17982), (-11848)⟩, ⟨(-1481), (-1444)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5059009, 5089124⟩, ⟨(-17982), (-11848)⟩, ⟨(-1481), (-1444)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1287101, 2913218⟩, ⟨633256, 968059⟩, ⟨76163, 79049⟩, ⟨(-568), (-366)⟩, ⟨(-24), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141878476), (-140252358)⟩, ⟨633256, 968059⟩, ⟨76163, 79049⟩, ⟨(-568), (-366)⟩, ⟨(-24), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-81216908), (-35682689)⟩, ⟨(-26911192), (-17287188)⟩, ⟨(-2156094), (-2000198)⟩, ⟨19431, 30385⟩, ⟨1088, 1207⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1350438857, 1395973077⟩, ⟨(-26911192), (-17287188)⟩, ⟨(-2156094), (-2000198)⟩, ⟨19431, 30385⟩, ⟨1088, 1207⟩⟩
...
def j70 : Jet := ⟨⟨(-62), (-27)⟩, ⟨(-21), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11773, 11809⟩, ⟨(-21), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2995, 6760⟩, ⟨1484, 2251⟩, ⟨180, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849182), (-845416)⟩, ⟨1484, 2251⟩, ⟨180, 187⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-486106), (-215088)⟩, ⟨(-161659), (-106255)⟩, ⟨(-13270), (-12905)⟩, ⟨43, 72⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35305288, 35576307⟩, ⟨(-161659), (-106255)⟩, ⟨(-13270), (-12905)⟩, ⟨43, 72⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8982292, 20365300⟩, ⟨4398605, 6761401⟩, ⟨522949, 548904⟩, ⟨(-5094), (-3288)⟩, ⟨(-207), (-189)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706845591), (-695462582)⟩, ⟨4398605, 6761401⟩, ⟨522949, 548904⟩, ⟨(-5094), (-3288)⟩, ⟨(-207), (-189)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-404626654), (-176938028)⟩, ⟨(-133756469), (-84598516)⟩, ⟨(-10547042), (-9454245)⟩, ⟨133548, 211417⟩, ⟨7223, 8263⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3890340642, 4118029268⟩, ⟨(-133756469), (-84598516)⟩, ⟨(-10547042), (-9454245)⟩, ⟨133548, 211417⟩, ⟨7223, 8263⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨681159209, 1056189899⟩, ⟨149928857, 167312021⟩, ⟨(-5024787), (-3188803)⟩, ⟨(-262083), (-229234)⟩, ⟨2998, 4746⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4479507762, 4741678370⟩, ⟨92024529, 163026896⟩, ⟨12174633, 18460232⟩, ⟨217943, 922903⟩, ⟨14542, 70305⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨710426355, 1166042127⟩, ⟨170965406, 224804310⟩, ⟨(-404179), 7564576⟩, ⟨(-20516), 638675⟩, ⟨(-18508), 44532⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1034367712), (-689578474)⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3260599584, 3605388822⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨117510931, 316569173⟩, ⟨56558442, 122064398⟩, ⟨6585984, 15873978⟩, ⟨(-53452), 1138670⟩, ⟨(-12910), 104366⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4412478227, 4611536469⟩, ⟨56558442, 122064398⟩, ⟨6585984, 15873978⟩, ⟨(-53452), 1138670⟩, ⟨(-12910), 104366⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4353326277, 4450437992⟩, ⟨27291320, 60214026⟩, ⟨2770610, 7745044⟩, ⟨(-133496), 544334⟩, ⟨(-20789), 52449⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3304903825, 3735897921⟩, ⟨(-157916336), (-124190710)⟩, ⟨(-313559), 5406100⟩, ⟨(-422940), 345731⟩, ⟨(-39301), 49388⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5446631215, 8169946834⟩, ⟨1361657800, 1361657809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6907105350, 15540987084⟩, ⟨3453552664, 5180329042⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6907105350, 15540987084⟩, ⟨3453552664, 5180329042⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15540987084), (-6907105350)⟩, ⟨(-5180329042), (-3453552664)⟩, ⟨(-431694088), (-431694082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7770493542), (-3453552675)⟩, ⟨(-2590164521), (-1726776332)⟩, ⟨(-215847044), (-215847041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨703445356, 1921970673⟩, ⟨(-1159082225), (-282817704)⟩, ⟨(-39737260), 314151457⟩, ⟨(-53676252), 46821854⟩, ⟨(-14953178), 9091145⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨541289161, 1671790668⟩, ⟨(-1078872812), (-237963787)⟩, ⟨(-26527251), 318294895⟩, ⟨(-59888150), 42427510⟩, ⟨(-14889189), 10412986⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨861973092, 861973093⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4393977690, 4393977693⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1306
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨689578474, 1034367712⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4353326277, 4450437992⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1307
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (83030637 / 4294967296)

theorem envelope_integral : (∫ s in ((32111 / 200000) : ℝ)..(96333 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((32111 / 200000) : ℝ)..(96333 / 400000), prawitzNormalCorrection
