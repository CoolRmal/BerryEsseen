...
namespace FiniteNormalPanel27_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (723 / 3200)
def radius : Rat := (723 / 16000)

def j0 : Jet := ⟨⟨970394173, 970394174⟩, ⟨194078834, 194078835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3048583204, 3048583209⟩, ⟨609716639, 609716643⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2163895301, 2163895309⟩, ⟨865558118, 865558126⟩, ⟨86555811, 86555813⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨541, 543⟩, ⟨216, 217⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94146), (-94143)⟩, ⟨216, 217⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-47433), (-47431)⟩, ⟨(-18866), (-18862)⟩, ⟨(-1845), (-1841)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5065623, 5065626⟩, ⟨(-18866), (-18862)⟩, ⟨(-1845), (-1841)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2552167, 2552170⟩, ⟨1011361, 1011365⟩, ⟨97353, 97359⟩, ⟨(-749), (-745)⟩, ⟨(-37), (-33)⟩⟩
...
def j16 : Jet := ⟨⟨(-140613410), (-140613406)⟩, ⟨1011361, 1011365⟩, ⟨97353, 97359⟩, ⟨(-749), (-745)⟩, ⟨(-37), (-33)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-70844009), (-70844005)⟩, ⟨(-27828059), (-27828054)⟩, ⟨(-2580895), (-2580889)⟩, ⟨39622, 39628⟩, ⟨1791, 1797⟩⟩
...
def j19 : Jet := ⟨⟨1360811756, 1360811761⟩, ⟨(-27828059), (-27828054)⟩, ⟨(-2580895), (-2580889)⟩, ⟨39622, 39628⟩, ⟨1791, 1797⟩⟩
...
def j25 : Jet := ⟨⟨5935, 5937⟩, ⟨2362, 2365⟩, ⟨230, 233⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846242), (-846239)⟩, ⟨2362, 2365⟩, ⟨230, 233⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-426355), (-426353)⟩, ⟨(-169352), (-169349)⟩, ⟨(-16464), (-16459)⟩, ⟨91, 95⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35365039, 35365042⟩, ⟨(-169352), (-169349)⟩, ⟨(-16464), (-16459)⟩, ⟨91, 95⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17817654, 17817656⟩, ⟨7041737, 7041742⟩, ⟨670281, 670287⟩, ⟨(-6686), (-6680)⟩, ⟨(-313), (-308)⟩⟩
...
def j33 : Jet := ⟨⟨(-698010229), (-698010226)⟩, ⟨7041737, 7041742⟩, ⟨670281, 670287⟩, ⟨(-6686), (-6680)⟩, ⟨(-313), (-308)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-351672308), (-351672304)⟩, ⟨(-137121149), (-137121142)⟩, ⟨(-12310082), (-12310075)⟩, ⟨273622, 273629⟩, ⟨12002, 12008⟩⟩
...
def j36 : Jet := ⟨⟨3943294988, 3943294992⟩, ⟨(-137121149), (-137121142)⟩, ⟨(-12310082), (-12310075)⟩, ⟨273622, 273629⟩, ⟨12002, 12008⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨965909069, 965909075⟩, ⟨173429356, 173429364⟩, ⟨(-5782421), (-5782414)⟩, ⟨(-338263), (-338255)⟩, ⟨6895, 6902⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4678002561, 4678002567⟩, ⟨162669304, 162669315⟩, ⟨20260203, 20260216⟩, ⟨887717, 887729⟩, ⟨68582, 68594⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1052051107, 1052051115⟩, ⟨225479418, 225479431⟩, ⟨4826803, 4826817⟩, ⟨430304, 430320⟩, ⟨18688, 18705⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-970394174), (-970394173)⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3324573122, 3324573123⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨257699641, 257699646⟩, ⟨110462248, 110462256⟩, ⟨14201983, 14201993⟩, ⟨717604, 717616⟩, ⟨59758, 59773⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4552666937, 4552666942⟩, ⟨110462248, 110462256⟩, ⟨14201983, 14201993⟩, ⟨717604, 717616⟩, ⟨59758, 59773⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4421940253, 4421940256⟩, ⟨53645200, 53645205⟩, ⟨6571690, 6571696⟩, ⟨268773, 268781⟩, ⟨20875, 20885⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3422858126, 3422858130⟩, ⟨(-158291689), (-158291682)⟩, ⟨2662805, 2662812⟩, ⟨(-88912), (-88904)⟩, ⟨4012, 4022⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨24504076912, 24504076914⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value219

def j47 : Jet := ⟨⟨5536389874, 5536389881⟩, ⟨1107277971, 1107277978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7136634745, 7136634764⟩, ⟨2854653888, 2854653912⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7136634745, 7136634764⟩, ⟨2854653888, 2854653912⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7136634764), (-7136634745)⟩, ⟨(-2854653912), (-2854653888)⟩, ⟨(-285465392), (-285465387)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3568317382), (-3568317372)⟩, ⟨(-1427326956), (-1427326944)⟩, ⟨(-142732696), (-142732693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1871294256, 1871294268⟩, ⟨(-621878717), (-621878707)⟩, ⟨41145188, 41145194⟩, ⟨9219875, 9219878⟩, ⟨(-1449681), (-1449679)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1491320959, 1491320972⟩, ⟨(-564570761), (-564570748)⟩, ⟨56870107, 56870120⟩, ⟨5407037, 5407049⟩, ⟨(-1454990), (-1454978)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨776315338, 1164473009⟩, ⟨194078834, 194078835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2438866562, 3658299851⟩, ⟨609716639, 609716643⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1384892991, 3116009245⟩, ⟨692446494, 1038669752⟩, ⟨86555811, 86555813⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨346, 781⟩, ⟨173, 261⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94341), (-93905)⟩, ⟨173, 261⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-68445), (-30279)⟩, ⟨(-22760), (-14949)⟩, ⟨(-1869), (-1812)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5044611, 5082778⟩, ⟨(-22760), (-14949)⟩, ⟨(-1869), (-1812)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1626612, 3687568⟩, ⟨796793, 1224370⟩, ⟨94802, 99439⟩, ⟨(-910), (-584)⟩, ⟨(-38), (-32)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141538965), (-139478008)⟩, ⟨796793, 1224370⟩, ⟨94802, 99439⟩, ⟨(-910), (-584)⟩, ⟨(-38), (-32)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-102686865), (-44974059)⟩, ⟨(-33972033), (-21598745)⟩, ⟨(-2693384), (-2442639)⟩, ⟨30680, 48535⟩, ⟨1661, 1900⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1328968900, 1386681707⟩, ⟨(-33972033), (-21598745)⟩, ⟨(-2693384), (-2442639)⟩, ⟨30680, 48535⟩, ⟨1661, 1900⟩⟩
...
def j70 : Jet := ⟨⟨(-79), (-34)⟩, ⟨(-27), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11756, 11802⟩, ⟨(-27), (-17)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3790, 8563⟩, ⟨1875, 2850⟩, ⟨226, 236⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848387), (-843613)⟩, ⟨1875, 2850⟩, ⟨226, 236⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-615507), (-272019)⟩, ⟨(-204565), (-133941)⟩, ⟨(-16724), (-16139)⟩, ⟨71, 116⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35175887, 35519376⟩, ⟨(-204565), (-133941)⟩, ⟨(-16724), (-16139)⟩, ⟨71, 116⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11342307, 25769394⟩, ⟨5522740, 8546610⟩, ⟨647289, 689020⟩, ⟨(-8146), (-5215)⟩, ⟨(-327), (-292)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704485576), (-690058488)⟩, ⟨5522740, 8546610⟩, ⟨647289, 689020⟩, ⟨(-8146), (-5215)⟩, ⟨(-327), (-292)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-511106004), (-222506272)⟩, ⟨(-168587887), (-105052548)⟩, ⟨(-13098284), (-11339892)⟩, ⟨209745, 337187⟩, ⟨10836, 12952⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3783861292, 4072461024⟩, ⟨(-168587887), (-105052548)⟩, ⟨(-13098284), (-11339892)⟩, ⟨209745, 337187⟩, ⟨10836, 12952⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨754645516, 1181125986⟩, ⟨159725212, 184589639⟩, ⟨(-7116824), (-4453208)⟩, ⟨(-364934), (-305417)⟩, ⟨5298, 8510⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4529630600, 4875111071⟩, ⟨116845619, 217207930⟩, ⟨15627023, 26553357⟩, ⟨324827, 1683880⟩, ⟨18402, 147496⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨795876938, 1340666873⟩, ⟨188982399, 269255817⟩, ⟨(-987030), 11940908⟩, ⟨(-135920), 1161031⟩, ⟨(-41557), 98083⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1164473009), (-776315338)⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3130494287, 3518651958⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨147479609, 418486927⟩, ⟨70038592, 168095508⟩, ⟨7699194, 24334588⟩, ⟨(-208612), 2222004⟩, ⟨(-45731), 240007⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4442446905, 4713454223⟩, ⟨70038592, 168095508⟩, ⟨7699194, 24334588⟩, ⟨(-208612), 2222004⟩, ⟨(-45731), 240007⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4368084725, 4499347924⟩, ⟨33428561, 82640878⟩, ⟨2915785, 11835714⟩, ⟨(-326483), 1070091⟩, ⟨(-58764), 123199⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3183787753, 3686090788⟩, ⟨(-178949043), (-129679287)⟩, ⟨(-1609093), 8185856⟩, ⟨(-802299), 744916⟩, ⟨(-96498), 115684⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4429111897, 6643667859⟩, ⟨1107277971, 1107277978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4567446232, 10276754066⟩, ⟨2283723108, 3425584694⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4567446232, 10276754066⟩, ⟨2283723108, 3425584694⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10276754066), (-4567446232)⟩, ⟨(-3425584694), (-2283723108)⟩, ⟨(-285465392), (-285465387)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5138377033), (-2283723116)⟩, ⟨(-1712792347), (-1141861554)⟩, ⟨(-142732696), (-142732693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1298321535, 2523692786⟩, ⟨(-1006424821), (-345172231)⟩, ⟨(-37984929), 157529823⟩, ⟨(-13293167), 27346717⟩, ⟨(-5343962), 1956466⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨962424139, 2165921203⟩, ⟨(-968898105), (-295071055)⟩, ⟨(-23123592), 181940053⟩, ⟨(-20361702), 25867305⟩, ⟨(-6029425), 2789181⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨970394173, 970394174⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4421940253, 4421940256⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar219 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified536
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar219 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨776315338, 1164473009⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4368084725, 4499347924⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified537
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((723 / 4000) : ℝ)..(2169 / 8000), prawitzNormalCorrection
      ((57053 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
