...
namespace FiniteNormalPanel167_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (75507 / 800000)
def radius : Rat := (25169 / 800000)

def j0 : Jet := ⟨⟨405375119, 405375120⟩, ⟨135125039, 135125040⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1273523495, 1273523499⟩, ⟨424507829, 424507833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨377619194, 377619198⟩, ⟨251746128, 251746132⟩, ⟨41957687, 41957689⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨94, 95⟩, ⟨63, 64⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94593), (-94591)⟩, ⟨63, 64⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8317), (-8316)⟩, ⟨(-5540), (-5538)⟩, ⟨(-922), (-919)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104739, 5104741⟩, ⟨(-5540), (-5538)⟩, ⟨(-922), (-919)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨448815, 448816⟩, ⟨298722, 298725⟩, ⟨49461, 49465⟩, ⟨(-110), (-106)⟩, ⟨(-10), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-142716762), (-142716760)⟩, ⟨298722, 298725⟩, ⟨49461, 49465⟩, ⟨(-110), (-106)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12547847), (-12547845)⟩, ⟨(-8338967), (-8338965)⟩, ⟨(-1372349), (-1372345)⟩, ⟨5807, 5810⟩, ⟨475, 478⟩⟩
...
def j19 : Jet := ⟨⟨1419107918, 1419107921⟩, ⟨(-8338967), (-8338965)⟩, ⟨(-1372349), (-1372345)⟩, ⟨5807, 5810⟩, ⟨475, 478⟩⟩
...
def j25 : Jet := ⟨⟨1039, 1040⟩, ⟨692, 694⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851138), (-851136)⟩, ⟨692, 694⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-74834), (-74833)⟩, ⟨(-49829), (-49826)⟩, ⟨(-8266), (-8262)⟩, ⟨11, 14⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35716560, 35716562⟩, ⟨(-49829), (-49826)⟩, ⟨(-8266), (-8262)⟩, ⟨11, 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3140247, 3140248⟩, ⟨2089116, 2089119⟩, ⟨345268, 345271⟩, ⟨(-972), (-968)⟩, ⟨(-82), (-78)⟩⟩
...
def j33 : Jet := ⟨⟨(-712687636), (-712687634)⟩, ⟨2089116, 2089119⟩, ⟨345268, 345271⟩, ⟨(-972), (-968)⟩, ⟨(-82), (-78)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-62660439), (-62660437)⟩, ⟨(-41589949), (-41589945)⟩, ⟨(-6809464), (-6809460)⟩, ⟨40559, 40562⟩, ⟨3307, 3311⟩⟩
...
def j36 : Jet := ⟨⟨4232306857, 4232306859⟩, ⟨(-41589949), (-41589945)⟩, ⟨(-6809464), (-6809460)⟩, ⟨40559, 40562⟩, ⟨3307, 3311⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨420787203, 420787206⟩, ⟨137789768, 137789772⟩, ⟨(-1231134), (-1231131)⟩, ⟨(-133920), (-133917)⟩, ⟨713, 717⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4358555437, 4358555440⟩, ⟨42830561, 42830567⟩, ⟨7433469, 7433476⟩, ⟨100184, 100191⟩, ⟨9122, 9132⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨427017070, 427017074⟩, ⟨144025984, 144025990⟩, ⟨852986, 852993⟩, ⟨100112, 100119⟩, ⟨1363, 1373⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-405375120), (-405375119)⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3889592176, 3889592177⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨42455172, 42455174⟩, ⟨28638892, 28638896⟩, ⟨4999330, 4999334⟩, ⟨77112, 77118⟩, ⟨7153, 7160⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4337422468, 4337422470⟩, ⟨28638892, 28638896⟩, ⟨4999330, 4999334⟩, ⟨77112, 77118⟩, ⟨7153, 7160⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316142681, 4316142683⟩, ⟨14249193, 14249196⟩, ⟨2463880, 2463883⟩, ⟨30231, 30236⟩, ⟨2754, 2760⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3908768948, 3908768952⟩, ⟨(-122886945), (-122886939)⟩, ⟨1783031, 1783036⟩, ⟨(-50140), (-50133)⟩, ⟨1542, 1549⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨53843102142, 53843102150⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value673

def j47 : Jet := ⟨⟨5081913885, 5081913899⟩, ⟨1693971286, 1693971300⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6013048983, 6013049017⟩, ⟨4008699300, 4008699346⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6013048983, 6013049017⟩, ⟨4008699300, 4008699346⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6013049017), (-6013048983)⟩, ⟨(-4008699346), (-4008699300)⟩, ⟨(-668116558), (-668116546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3006524509), (-3006524491)⟩, ⟨(-2004349673), (-2004349650)⟩, ⟨(-334058279), (-334058273)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2132794094, 2132794112⟩, ⟨(-995319612), (-995319591)⟩, ⟨66358294, 66358307⟩, ⟨41287410, 41287416⟩, ⟨(-7397583), (-7397581)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1941015787, 1941015806⟩, ⟨(-966844836), (-966844811)⟩, ⟨89754781, 89754800⟩, ⟨35238159, 35238172⟩, ⟨(-7873782), (-7873768)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨270250079, 540500160⟩, ⟨135125039, 135125040⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨849015662, 1698031332⟩, ⟨424507829, 424507833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨167830752, 671323018⟩, ⟨167830750, 335661510⟩, ⟨41957687, 41957689⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨42, 169⟩, ⟨42, 85⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94645), (-94517)⟩, ⟨42, 85⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-14794), (-3693)⟩, ⟨(-7396), (-3679)⟩, ⟨(-924), (-914)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5098262, 5109364⟩, ⟨(-7396), (-3679)⟩, ⟨(-924), (-914)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨199220, 798617⟩, ⟨198063, 399166⟩, ⟨49081, 49736⟩, ⟨(-146), (-69)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142966357), (-142366959)⟩, ⟨198063, 399166⟩, ⟨49081, 49736⟩, ⟨(-146), (-69)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-22346296), (-5563151)⟩, ⟨(-11165409), (-5500759)⟩, ⟨(-1386988), (-1351817)⟩, ⟨3828, 7785⟩, ⟨465, 484⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1409309469, 1426092615⟩, ⟨(-11165409), (-5500759)⟩, ⟨(-1386988), (-1351817)⟩, ⟨3828, 7785⟩, ⟨465, 484⟩⟩
...
def j72 : Jet := ⟨⟨461, 1850⟩, ⟨459, 925⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851716), (-850326)⟩, ⟨459, 925⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-133128), (-33227)⟩, ⟨(-66547), (-33082)⟩, ⟨(-8300), (-8214)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35658266, 35758168⟩, ⟨(-66547), (-33082)⟩, ⟨(-8300), (-8214)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1393387, 5589166⟩, ⟨1382985, 2793291⟩, ⟨341847, 347711⟩, ⟨(-1300), (-639)⟩, ⟨(-83), (-77)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714434496), (-710238716)⟩, ⟨1382985, 2793291⟩, ⟨341847, 347711⟩, ⟨(-1300), (-639)⟩, ⟨(-83), (-77)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-111669377), (-27753388)⟩, ⟨(-55780648), (-27316783)⟩, ⟨(-6911938), (-6665695)⟩, ⟨26664, 54439⟩, ⟨3224, 3370⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4183297919, 4267213908⟩, ⟨(-55780648), (-27316783)⟩, ⟨(-6911938), (-6665695)⟩, ⟨26664, 54439⟩, ⟨3224, 3370⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨278587874, 563811032⟩, ⟨134879649, 139865386⟩, ⟨(-1651923), (-810908)⟩, ⟨(-136332), (-130533)⟩, ⟨469, 962⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4322901188, 4409617587⟩, ⟨27673267, 58798426⟩, ⟨6929833, 8069906⟩, ⟨31332, 177204⟩, ⟨6790, 12191⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨280399772, 578861461⟩, ⟨137551881, 151317583⟩, ⟨(-377471), 2157943⟩, ⟨57070, 149455⟩, ⟨(-3076), 6211⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-540500160), (-270250079)⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3754467136, 4024717217⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨18306084, 78017030⟩, ⟨17960330, 40788166⟩, ⟨4303526, 5912808⟩, ⟨(-19148), 192344⟩, ⟨2634, 13293⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4313273380, 4372984326⟩, ⟨17960330, 40788166⟩, ⟨4303526, 5912808⟩, ⟨(-19148), 192344⟩, ⟨2634, 13293⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304110605, 4333800257⟩, ⟨8899698, 20350760⟩, ⟨2084700, 2940923⟩, ⟨(-23460), 91658⟩, ⟨(-125), 6240⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3762459805, 4061106712⟩, ⟨(-128567059), (-116342458)⟩, ⟨1182089, 2475878⟩, ⟨(-114510), 20304⟩, ⟨(-3002), 6587⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3387942585, 6775885199⟩, ⟨1693971286, 1693971300⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2672466207, 10689864920⟩, ⟨2672466196, 5344932462⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2672466207, 10689864920⟩, ⟨2672466196, 5344932462⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10689864920), (-2672466207)⟩, ⟨(-5344932462), (-2672466196)⟩, ⟨(-668116558), (-668116546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5344932460), (-1336233103)⟩, ⟨(-2672466231), (-1336233098)⟩, ⟨(-334058279), (-334058273)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1237359743, 3146617066⟩, ⟨(-1957925934), (-384962428)⟩, ⟨(-184856755), 512901511⟩, ⟨(-86419921), 139864952⟩, ⟨(-41703598), 20632299⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1083946856, 2975284050⟩, ⟨(-1945508984), (-370750933)⟩, ⟨(-164022872), 545397213⟩, ⟨(-98280300), 137691811⟩, ⟨(-43737627), 22448494⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨405375119, 405375120⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316142681, 4316142683⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar673 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3384
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar673 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨270250079, 540500160⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304110605, 4333800257⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3385
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((25169 / 400000) : ℝ)..(25169 / 200000), prawitzNormalCorrection
      ((287603 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
