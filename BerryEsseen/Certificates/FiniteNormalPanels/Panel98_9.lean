...
namespace FiniteNormalPanel98_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (211463 / 800000)
def radius : Rat := (30209 / 800000)

def j0 : Jet := ⟨⟨1135283336, 1135283337⟩, ⟨162183333, 162183334⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3566597787, 3566597792⟩, ⟨509513967, 509513971⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2961750089, 2961750099⟩, ⟨846214306, 846214316⟩, ⟨60443878, 60443880⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨741, 742⟩, ⟨211, 212⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93946), (-93944)⟩, ⟨211, 212⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-64784), (-64782)⟩, ⟨(-18365), (-18362)⟩, ⟨(-1272), (-1268)⟩, ⟨4, 7⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5048272, 5048275⟩, ⟨(-18365), (-18362)⟩, ⟨(-1272), (-1268)⟩, ⟨4, 7⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3481218, 3481221⟩, ⟨981968, 981973⟩, ⟨66548, 66555⟩, ⟨(-508), (-502)⟩, ⟨(-18), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-139684359), (-139684355)⟩, ⟨981968, 981973⟩, ⟨66548, 66555⟩, ⟨(-508), (-502)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-96324404), (-96324400)⟩, ⟨(-26844108), (-26844101)⟩, ⟨(-1726444), (-1726435)⟩, ⟨26579, 26587⟩, ⟨822, 830⟩⟩
...
def j19 : Jet := ⟨⟨1335331361, 1335331366⟩, ⟨(-26844108), (-26844101)⟩, ⟨(-1726444), (-1726435)⟩, ⟨26579, 26587⟩, ⟨822, 830⟩⟩
...
def j22 : Jet := ⟨⟨(-75), (-73)⟩, ⟨(-22), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11760, 11763⟩, ⟨(-22), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8109, 8112⟩, ⟨2301, 2304⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844068), (-844064)⟩, ⟨2301, 2304⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-582058), (-582054)⟩, ⟨(-164717), (-164712)⟩, ⟨(-11318), (-11312)⟩, ⟨61, 65⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35209336, 35209341⟩, ⟨(-164717), (-164712)⟩, ⟨(-11318), (-11312)⟩, ⟨61, 65⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨24279871, 24279876⟩, ⟨6823519, 6823525⟩, ⟨455248, 455256⟩, ⟨(-4507), (-4501)⟩, ⟨(-148), (-143)⟩⟩
...
def j33 : Jet := ⟨⟨(-691548012), (-691548006)⟩, ⟨6823519, 6823525⟩, ⟨455248, 455256⟩, ⟨(-4507), (-4501)⟩, ⟨(-148), (-143)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-476881954), (-476881947)⟩, ⟨(-131546583), (-131546575)⟩, ⟨(-8073952), (-8073942)⟩, ⟨182615, 182623⟩, ⟨5415, 5423⟩⟩
...
def j36 : Jet := ⟨⟨3818085342, 3818085349⟩, ⟨(-131546583), (-131546575)⟩, ⟨(-8073952), (-8073942)⟩, ⟨182615, 182623⟩, ⟨5415, 5423⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1108876866, 1108876873⟩, ⟨136119276, 136119285⟩, ⟨(-4618192), (-4618182)⟩, ⟨(-182738), (-182728)⟩, ⟨3835, 3845⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4831412183, 4831412193⟩, ⟨166459275, 166459288⟩, ⟨15951891, 15951908⟩, ⟨670510, 670526⟩, ⟨42008, 42023⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1247376482, 1247376494⟩, ⟨196097224, 196097240⟩, ⟨4199009, 4199028⟩, ⟨294121, 294141⟩, ⟨12172, 12194⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1135283337), (-1135283336)⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3159683959, 3159683960⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨362272394, 362272402⟩, ⟨113904040, 113904052⟩, ⟨11392311, 11392328⟩, ⟨554272, 554288⟩, ⟨38031, 38050⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4657239690, 4657239698⟩, ⟨113904040, 113904052⟩, ⟨11392311, 11392328⟩, ⟨554272, 554288⟩, ⟨38031, 38050⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4472436937, 4472436942⟩, ⟨54692121, 54692128⟩, ⟨5135720, 5135730⟩, ⟨203335, 203344⟩, ⟨12824, 12836⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3290243271, 3290243277⟩, ⟨(-128649389), (-128649381)⟩, ⟨1712957, 1712967⟩, ⟨(-44345), (-44336)⟩, ⟨1755, 1766⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨34072724354, 34072724361⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value445

def j47 : Jet := ⟨⟨9006400632, 9006400643⟩, ⟨1286628656, 1286628665⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨18886116413, 18886116460⟩, ⟨5396033236, 5396033282⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨18886116413, 18886116460⟩, ⟨5396033236, 5396033282⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-18886116460), (-18886116413)⟩, ⟨(-5396033282), (-5396033236)⟩, ⟨(-385430950), (-385430943)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9443058230), (-9443058206)⟩, ⟨(-2698016641), (-2698016618)⟩, ⟨(-192715475), (-192715471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨476546774, 476546787⟩, ⟨(-299357614), (-299357603)⟩, ⟨72642684, 72642690⟩, ⟨(-6256122), (-6256118)⟩, ⟨(-647248), (-647246)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨365067929, 365067940⟩, ⟨(-243602980), (-243602968)⟩, ⟨64806214, 64806224⟩, ⟨(-7092845), (-7092834)⟩, ⟨(-276189), (-276182)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨973100002, 1297466671⟩, ⟨162183333, 162183334⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3057083817, 4076111763⟩, ⟨509513967, 509513971⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2175979657, 3868408293⟩, ⟨725326548, 967102076⟩, ⟨60443878, 60443880⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨544, 970⟩, ⟨181, 243⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94143), (-93716)⟩, ⟨181, 243⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-84794), (-47479)⟩, ⟨(-21108), (-15607)⟩, ⟨(-1288), (-1248)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5028262, 5065578⟩, ⟨(-21108), (-15607)⟩, ⟨(-1288), (-1248)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2547492, 4562486⟩, ⟨830152, 1132715⟩, ⟨64849, 68022⟩, ⟨(-587), (-421)⟩, ⟨(-19), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140618085), (-138603090)⟩, ⟨830152, 1132715⟩, ⟨64849, 68022⟩, ⟨(-587), (-421)⟩, ⟨(-19), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-126652459), (-70221141)⟩, ⟨(-31242532), (-22386827)⟩, ⟨(-1805897), (-1634265)⟩, ⟨22104, 31045⟩, ⟨761, 880⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1305003306, 1361434625⟩, ⟨(-31242532), (-22386827)⟩, ⟨(-1805897), (-1634265)⟩, ⟨22104, 31045⟩, ⟨761, 880⟩⟩
...
def j70 : Jet := ⟨⟨(-98), (-54)⟩, ⟨(-25), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11737, 11782⟩, ⟨(-25), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5946, 10612⟩, ⟨1959, 2644⟩, ⟨157, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846231), (-841564)⟩, ⟨1959, 2644⟩, ⟨157, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-762187), (-426365)⟩, ⟨(-189555), (-139739)⟩, ⟨(-11501), (-11100)⟩, ⟨51, 75⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35029207, 35365030⟩, ⟨(-189555), (-139739)⟩, ⟨(-11501), (-11100)⟩, ⟨51, 75⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17747013, 31852717⟩, ⟨5744941, 7892384⟩, ⟨439930, 468478⟩, ⟨(-5233), (-3772)⟩, ⟨(-154), (-136)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698080870), (-683975165)⟩, ⟨5744941, 7892384⟩, ⟨439930, 468478⟩, ⟨(-5233), (-3772)⟩, ⟨(-154), (-136)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-628750266), (-346525582)⟩, ⟨(-154276981), (-108399982)⟩, ⟨(-8631145), (-7426623)⟩, ⟨150429, 214648⟩, ⟨4873, 5888⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3666217030, 3948441714⟩, ⟨(-154276981), (-108399982)⟩, ⟨(-8631145), (-7426623)⟩, ⟨150429, 214648⟩, ⟨4873, 5888⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨928878897, 1292060989⟩, ⟨125162619, 145573066⟩, ⟨(-5420193), (-3819000)⟩, ⟨(-198502), (-164409)⟩, ⟨3163, 4519⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4671904870, 5031547212⟩, ⟨128261840, 211731032⟩, ⟨12308666, 20755249⟩, ⟨305638, 1180169⟩, ⟨12526, 87056⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1010399740, 1513647351⟩, ⟨163886594, 234233953⟩, ⟨50032, 9266051⟩, ⟨(-74952), 765624⟩, ⟨(-20924), 55633⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1297466671), (-973100002)⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2997500625, 3321867294⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨237698581, 533444878⟩, ⟨77109304, 165099094⟩, ⟨6277095, 19305531⟩, ⟨(-49012), 1550332⟩, ⟨(-22926), 142715⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4532665877, 4828412174⟩, ⟨77109304, 165099094⟩, ⟨6277095, 19305531⟩, ⟨(-49012), 1550332⟩, ⟨(-22926), 142715⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4412216189, 4553885416⟩, ⟨36362568, 80355901⟩, ⟨2251137, 9246418⟩, ⟨(-192253), 736016⟩, ⟨(-34253), 72389⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3079329799, 3522122983⟩, ⟨(-146582607), (-104460931)⟩, ⟨(-1463249), 5778385⟩, ⟨(-497852), 484254⟩, ⟨(-54286), 63249⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7719771968, 10293029307⟩, ⟨1286628656, 1286628665⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13875514091, 24667580686⟩, ⟨4625171344, 6166895180⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13875514091, 24667580686⟩, ⟨4625171344, 6166895180⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-24667580686), (-13875514091)⟩, ⟨(-6166895180), (-4625171344)⟩, ⟨(-385430950), (-385430943)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12333790343), (-6937757045)⟩, ⟨(-3083447590), (-2312585672)⟩, ⟨(-192715475), (-192715471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨243110206, 853953539⟩, ⟨(-613071254), (-130900456)⟩, ⟨(-3075880), 209160020⟩, ⟨(-46137789), 19075113⟩, ⟨(-8116119), 8349831⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨174300861, 700291569⟩, ⟨(-531898601), (-99763551)⟩, ⟨370388, 193595741⟩, ⟨(-45897882), 16052830⟩, ⟨(-7457881), 8787024⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1135283336, 1135283337⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨162183333, 162183334⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4472436937, 4472436942⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar445 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1980
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar445 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨973100002, 1297466671⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4412216189, 4553885416⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1981
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((90627 / 400000) : ℝ)..(30209 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (90627 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (30209 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((90627 / 400000) : ℝ)..(30209 / 100000), prawitzNormalCorrection
      ((250869 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
