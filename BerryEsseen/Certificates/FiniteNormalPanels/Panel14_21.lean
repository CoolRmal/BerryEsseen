...
namespace FiniteNormalPanel14_21

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (28983 / 200000)
def radius : Rat := (9661 / 200000)

def j0 : Jet := ⟨⟨622405185, 622405186⟩, ⟨207468395, 207468396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1955343556, 1955343560⟩, ⟨651781185, 651781189⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨890197330, 890197335⟩, ⟨593464886, 593464892⟩, ⟨98910814, 98910816⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨222, 224⟩, ⟨148, 149⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94465), (-94462)⟩, ⟨148, 149⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-19580), (-19578)⟩, ⟨(-13023), (-13021)⟩, ⟨(-2152), (-2148)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5093476, 5093479⟩, ⟨(-13023), (-13021)⟩, ⟨(-2152), (-2148)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1055700, 1055702⟩, ⟨701100, 701103⟩, ⟨115053, 115057⟩, ⟨(-597), (-593)⟩, ⟨(-50), (-46)⟩⟩
...
def j16 : Jet := ⟨⟨(-142109877), (-142109874)⟩, ⟨701100, 701103⟩, ⟨115053, 115057⟩, ⟨(-597), (-593)⟩, ⟨(-50), (-46)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-29454435), (-29454433)⟩, ⟨(-19490977), (-19490974)⟩, ⟨(-3151995), (-3151989)⟩, ⟨31918, 31924⟩, ⟨2555, 2560⟩⟩
...
def j19 : Jet := ⟨⟨1402201330, 1402201333⟩, ⟨(-19490977), (-19490974)⟩, ⟨(-3151995), (-3151989)⟩, ⟨31918, 31924⟩, ⟨2555, 2560⟩⟩
...
def j22 : Jet := ⟨⟨(-23), (-22)⟩, ⟨(-15), (-14)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11812, 11814⟩, ⟨(-15), (-14)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2448, 2449⟩, ⟨1628, 1631⟩, ⟨268, 272⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849729), (-849727)⟩, ⟨1628, 1631⟩, ⟨268, 272⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-176120), (-176118)⟩, ⟨(-117076), (-117073)⟩, ⟨(-19290), (-19285)⟩, ⟨73, 76⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35615274, 35615277⟩, ⟨(-117076), (-117073)⟩, ⟨(-19290), (-19285)⟩, ⟨73, 76⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7381807, 7381809⟩, ⟨4896938, 4896941⟩, ⟨800023, 800028⟩, ⟨(-5348), (-5344)⟩, ⟨(-435), (-431)⟩⟩
...
def j33 : Jet := ⟨⟨(-708446076), (-708446073)⟩, ⟨4896938, 4896941⟩, ⟨800023, 800028⟩, ⟨(-5348), (-5344)⟩, ⟨(-435), (-431)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-146836231), (-146836229)⟩, ⟨(-96875857), (-96875853)⟩, ⟨(-15472678), (-15472674)⟩, ⟨222208, 222213⟩, ⟨17594, 17598⟩⟩
...
def j36 : Jet := ⟨⟨4148131065, 4148131067⟩, ⟨(-96875857), (-96875853)⟩, ⟨(-15472678), (-15472674)⟩, ⟨222208, 222213⟩, ⟨17594, 17598⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨638371644, 638371647⟩, ⟨203917008, 203917014⟩, ⟨(-4392837), (-4392831)⟩, ⟨(-463799), (-463794)⟩, ⟨6006, 6011⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4447001258, 4447001261⟩, ⟨103855695, 103855702⟩, ⟨19012925, 19012932⟩, ⟨593190, 593200⟩, ⟨60340, 60351⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨660968828, 660968833⟩, ⟨226571624, 226571634⟩, ⟨3208476, 3208486⟩, ⟨404425, 404435⟩, ⟨12686, 12700⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-622405186), (-622405185)⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3672562110, 3672562111⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨101719003, 101719005⟩, ⟨69735934, 69735940⟩, ⟨12939819, 12939827⟩, ⟨462988, 462996⟩, ⟨48968, 48979⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4396686299, 4396686301⟩, ⟨69735934, 69735940⟩, ⟨12939819, 12939827⟩, ⟨462988, 462996⟩, ⟨48968, 48979⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4345529181, 4345529183⟩, ⟨34462264, 34462268⟩, ⟨6257977, 6257983⟩, ⟨179170, 179176⟩, ⟨18271, 18279⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3715796819, 3715796823⟩, ⟨(-180442623), (-180442617)⟩, ⟨3686402, 3686409⟩, ⟨(-149087), (-149080)⟩, ⟨6967, 6977⟩⟩
...
def j47 : Jet := ⟨⟨3053734991, 3053734998⟩, ⟨1017911663, 1017911669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2171214994, 2171215005⟩, ⟨1447476662, 1447476676⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2171214994, 2171215005⟩, ⟨1447476662, 1447476676⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2171215005), (-2171214994)⟩, ⟨(-1447476676), (-1447476662)⟩, ⟨(-241246114), (-241246110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1085607503), (-1085607497)⟩, ⟨(-723738338), (-723738331)⟩, ⟨(-120623057), (-120623055)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3335695642, 3335695655⟩, ⟨(-562092949), (-562092940)⟩, ⟨(-46323451), (-46323447)⟩, ⟨13126121, 13126123⟩, ⟨97525, 97526⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2885881638, 2885881653⟩, ⟨(-626436638), (-626436622)⟩, ⟨(-13598776), (-13598764)⟩, ⟨12704009, 12704021⟩, ⟨(-481930), (-481915)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨414936790, 829873581⟩, ⟨207468395, 207468396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1303562371, 2607124746⟩, ⟨651781185, 651781189⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨395643258, 1582573038⟩, ⟨395643256, 791286522⟩, ⟨98910814, 98910816⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨99, 397⟩, ⟨99, 199⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94588), (-94289)⟩, ⟨99, 199⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34853), (-8685)⟩, ⟨(-17418), (-8611)⟩, ⟨(-2168), (-2124)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078203, 5104372⟩, ⟨(-17418), (-8611)⟩, ⟨(-2168), (-2124)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨467793, 1880816⟩, ⟨461374, 939615⟩, ⟨112939, 116563⟩, ⟨(-802), (-389)⟩, ⟨(-50), (-45)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142697784), (-141284760)⟩, ⟨461374, 939615⟩, ⟨112939, 116563⟩, ⟨(-802), (-389)⟩, ⟨(-50), (-45)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-52580067), (-13014851)⟩, ⟨(-26247534), (-12668629)⟩, ⟨(-3233352), (-3037650)⟩, ⟨20732, 43080⟩, ⟨2433, 2646⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1379075698, 1418640915⟩, ⟨(-26247534), (-12668629)⟩, ⟨(-3233352), (-3037650)⟩, ⟨20732, 43080⟩, ⟨2433, 2646⟩⟩
...
def j70 : Jet := ⟨⟨(-40), (-9)⟩, ⟨(-20), (-9)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11795, 11827⟩, ⟨(-20), (-9)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1086, 4358⟩, ⟨1078, 2179⟩, ⟨265, 273⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851091), (-847818)⟩, ⟨1078, 2179⟩, ⟨265, 273⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-313603), (-78099)⟩, ⟨(-156703), (-77296)⟩, ⟨(-19478), (-19021)⟩, ⟨47, 102⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35477791, 35713296⟩, ⟨(-156703), (-77296)⟩, ⟨(-19478), (-19021)⟩, ⟨47, 102⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3268138, 13159332⟩, ⟨3210397, 6572546⟩, ⟨780985, 813587⟩, ⟨(-7194), (-3494)⟩, ⟨(-445), (-416)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712559745), (-702668550)⟩, ⟨3210397, 6572546⟩, ⟨780985, 813587⟩, ⟨(-7194), (-3494)⟩, ⟨(-445), (-416)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-262557958), (-64728333)⟩, ⟨(-130983246), (-62306536)⟩, ⟨(-16042197), (-14671401)⟩, ⟨143224, 300934⟩, ⟨16495, 18378⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4032409338, 4230238963⟩, ⟨(-130983246), (-62306536)⟩, ⟨(-16042197), (-14671401)⟩, ⟨143224, 300934⟩, ⟨16495, 18378⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨418562252, 861141327⟩, ⟨193348386, 211440287⟩, ⟨(-5945890), (-2844477)⟩, ⟨(-484385), (-434826)⟩, ⟨3884, 8145⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4360686059, 4574620910⟩, ⟨64227870, 148595703⟩, ⟨16069822, 23026066⟩, ⟨134011, 1184226⟩, ⟨27260, 109956⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨424966816, 917211902⟩, ⟨202566145, 255001025⟩, ⟨(-1875596), 9044062⟩, ⟨14842, 886992⟩, ⟨(-36005), 71879⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-829873581), (-414936790)⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3465093715, 3880030506⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨42048467, 195875223⟩, ⟨40085934, 108913508⟩, ⟨8752663, 19002745⟩, ⟨(-219780), 1452774⟩, ⟨(-17930), 155073⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4337015763, 4490842519⟩, ⟨40085934, 108913508⟩, ⟨8752663, 19002745⟩, ⟨(-219780), 1452774⟩, ⟨(-17930), 155073⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4315940322, 4391813037⟩, ⟨19600990, 54192126⟩, ⟨3945479, 9410693⟩, ⟨(-227520), 704939⟩, ⟨(-28034), 78214⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3482014332, 3967519980⟩, ⟨(-196332844), (-159524872)⟩, ⟨565382, 7554701⟩, ⟨(-660124), 446249⟩, ⟨(-59379), 81649⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2035823327, 4071646662⟩, ⟨1017911663, 1017911669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨964984441, 3859937783⟩, ⟨964984440, 1929968898⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨964984441, 3859937783⟩, ⟨964984440, 1929968898⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3859937783), (-964984441)⟩, ⟨(-1929968898), (-964984440)⟩, ⟨(-241246114), (-241246110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1929968892), (-482492220)⟩, ⟨(-964984449), (-482492220)⟩, ⟨(-120623057), (-120623055)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2740356553, 3838589445⟩, ⟨(-862446409), (-307848843)⟩, ⟨(-90514091), 19924136⟩, ⟨4271732, 22926565⟩, ⟨(-1567556), 1151063⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2221660872, 3545936272⟩, ⟨(-972164456), (-351362188)⟩, ⟨(-71818376), 64581485⟩, ⟨445403, 25674565⟩, ⟨(-2797964), 1145222⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨622405185, 622405186⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4345529181, 4345529183⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified288
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨414936790, 829873581⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4315940322, 4391813037⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified289
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (278389229 / 4294967296)

theorem envelope_integral : (∫ s in ((9661 / 100000) : ℝ)..(9661 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((9661 / 100000) : ℝ)..(9661 / 50000), prawitzNormalCorrection
