...
namespace FiniteNormalPanel79_16

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (15733 / 400000)
def radius : Rat := (15733 / 400000)

def j0 : Jet := ⟨⟨168931801, 168931802⟩, ⟨168931801, 168931802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨530714904, 530714909⟩, ⟨530714904, 530714909⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨65578685, 65578687⟩, ⟨131157370, 131157374⟩, ⟨65578685, 65578687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨16, 17⟩, ⟨32, 33⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94671), (-94669)⟩, ⟨32, 33⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1446), (-1445)⟩, ⟨(-2892), (-2889)⟩, ⟨(-1446), (-1442)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111610, 5111612⟩, ⟨(-2892), (-2889)⟩, ⟨(-1446), (-1442)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨78047, 78048⟩, ⟨156050, 156052⟩, ⟨77935, 77938⟩, ⟨(-90), (-87)⟩, ⟨(-23), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-143087530), (-143087528)⟩, ⟨156050, 156052⟩, ⟨77935, 77938⟩, ⟨(-90), (-87)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2184765), (-2184764)⟩, ⟨(-4367148), (-4367145)⟩, ⟨(-2178811), (-2178807)⟩, ⟨4759, 4763⟩, ⟨1185, 1189⟩⟩
...
def j19 : Jet := ⟨⟨1429471000, 1429471002⟩, ⟨(-4367148), (-4367145)⟩, ⟨(-2178811), (-2178807)⟩, ⟨4759, 4763⟩, ⟨1185, 1189⟩⟩
...
def j25 : Jet := ⟨⟨180, 181⟩, ⟨360, 362⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851997), (-851995)⟩, ⟨360, 362⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13009), (-13008)⟩, ⟨(-26013), (-26011)⟩, ⟨(-12997), (-12993)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778385, 35778387⟩, ⟨(-26013), (-26011)⟩, ⟨(-12997), (-12993)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨546290, 546291⟩, ⟨1092182, 1092184⟩, ⟨545296, 545299⟩, ⟨(-795), (-792)⟩, ⟨(-199), (-196)⟩⟩
...
def j33 : Jet := ⟨⟨(-715281593), (-715281591)⟩, ⟨1092182, 1092184⟩, ⟨545296, 545299⟩, ⟨(-795), (-792)⟩, ⟨(-199), (-196)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10921441), (-10921439)⟩, ⟨(-21826205), (-21826202)⟩, ⟨(-10879764), (-10879759)⟩, ⟨33314, 33318⟩, ⟨8296, 8301⟩⟩
...
def j36 : Jet := ⟨⟨4284045855, 4284045857⟩, ⟨(-21826205), (-21826202)⟩, ⟨(-10879764), (-10879759)⟩, ⟨33314, 33318⟩, ⟨8296, 8301⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨176635003, 176635006⟩, ⟨176095368, 176095373⟩, ⟨(-808864), (-808860)⟩, ⟨(-268641), (-268638)⟩, ⟨734, 736⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305916577, 4305916580⟩, ⟨21937628, 21937633⟩, ⟨11047067, 11047076⟩, ⟨78506, 78514⟩, ⟨19937, 19947⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨177085303, 177085307⟩, ⟨177446499, 177446508⟩, ⟨542846, 542853⟩, ⟨182704, 182711⟩, ⟨1318, 1327⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-168931802), (-168931801)⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4126035494, 4126035495⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7301383, 7301385⟩, ⟨14632552, 14632554⟩, ⟨7375963, 7375966⟩, ⟨59920, 59924⟩, ⟨15272, 15277⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302268679, 4302268681⟩, ⟨14632552, 14632554⟩, ⟨7375963, 7375966⟩, ⟨59920, 59924⟩, ⟨15272, 15277⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298616437, 4298616439⟩, ⟨7310065, 7310067⟩, ⟨3678635, 3678638⟩, ⟨23677, 23681⟩, ⟨6014, 6019⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4129541105, 4129541109⟩, ⟨(-162052791), (-162052786)⟩, ⟨3246421, 3246425⟩, ⟨(-121946), (-121939)⟩, ⟨4845, 4852⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨31841856918, 31841856924⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value387

def j47 : Jet := ⟨⟨1252419835, 1252419844⟩, ⟨1252419835, 1252419844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨365207773, 365207779⟩, ⟨730415546, 730415558⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨365207773, 365207779⟩, ⟨730415546, 730415558⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-365207779), (-365207773)⟩, ⟨(-730415558), (-730415546)⟩, ⟨(-365207779), (-365207773)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-182603890), (-182603886)⟩, ⟨(-365207779), (-365207773)⟩, ⟨(-182603890), (-182603886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4116190747, 4116190751⟩, ⟨(-350006131), (-350006123)⟩, ⟨(-160122283), (-160122277)⟩, ⟨14459004, 14459006⟩, ⟨3096493, 3096495⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3957650364, 3957650373⟩, ⟨(-491832594), (-491832580)⟩, ⟨(-137637649), (-137637636)⟩, ⟨19562216, 19562230⟩, ⟨2325224, 2325238⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 337863603⟩, ⟨168931801, 168931802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1061429814⟩, ⟨530714904, 530714909⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 262314745⟩, ⟨0, 262314746⟩, ⟨65578685, 65578687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 66⟩, ⟨0, 66⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94620)⟩, ⟨0, 66⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5784), 0⟩, ⟨(-5784), 5⟩, ⟨(-1446), (-1437)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107272, 5113057⟩, ⟨(-5784), 5⟩, ⟨(-1446), (-1437)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 312280⟩, ⟨(-354), 312281⟩, ⟨77538, 78071⟩, ⟨(-178), 2⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142853296)⟩, ⟨(-354), 312281⟩, ⟨77538, 78071⟩, ⟨(-178), 2⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8743825), 0⟩, ⟨(-8743847), 19073⟩, ⟨(-2185979), (-2157346)⟩, ⟨(-17), 9539⟩, ⟨1170, 1194⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422911940, 1431655766⟩, ⟨(-8743847), 19073⟩, ⟨(-2185979), (-2157346)⟩, ⟨(-17), 9539⟩, ⟨1170, 1194⟩⟩
...
def j72 : Jet := ⟨⟨0, 723⟩, ⟨(-1), 723⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851453)⟩, ⟨(-1), 723⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-52047), 0⟩, ⟨(-52048), 45⟩, ⟨(-13013), (-12943)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35739347, 35791395⟩, ⟨(-52048), 45⟩, ⟨(-13013), (-12943)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2185957⟩, ⟨(-3179), 2185960⟩, ⟨541720, 546493⟩, ⟨(-1591), 3⟩, ⟨(-200), (-194)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713641925)⟩, ⟨(-3179), 2185960⟩, ⟨541720, 546493⟩, ⟨(-1591), 3⟩, ⟨(-200), (-194)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-43719125), 0⟩, ⟨(-43719320), 133508⟩, ⟨(-10929977), (-10729518)⟩, ⟨(-147), 66756⟩, ⟨8160, 8346⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4251248171, 4294967296⟩, ⟨(-43719320), 133508⟩, ⟨(-10929977), (-10729518)⟩, ⟨(-147), 66756⟩, ⟨8160, 8346⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 353809939⟩, ⟨173663625, 176909684⟩, ⟨(-1620678), 2357⟩, ⟨(-270120), (-264218)⟩, ⟨(-3), 1475⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4339136022⟩, ⟨(-136269), 44623149⟩, ⟨10728130, 11614838⟩, ⟨(-68853), 234324⟩, ⟨16973, 24032⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 357448462⟩, ⟨173652399, 182404951⟩, ⟨(-1642958), 2797215⟩, ⟨138374, 233554⟩, ⟨(-10031), 13139⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-337863603), 0⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3957103693, 4294967296⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 29748633⟩, ⟨0, 30361288⟩, ⟨6747572, 8212239⟩, ⟨(-139552), 276470⟩, ⟨8447, 23848⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4324715929⟩, ⟨0, 30361288⟩, ⟨6747572, 8212239⟩, ⟨(-139552), 276470⟩, ⟨8447, 23848⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309815945⟩, ⟨0, 15180644⟩, ⟨3335426, 4106120⟩, ⟨(-84290), 138235⟩, ⟨1765, 10927⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3957103693, 4309815945⟩, ⟨(-169515837), (-153751157)⟩, ⟨2475951, 4106120⟩, ⟨(-245794), 7045⟩, ⟨(-3812), 14243⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2504839680⟩, ⟨1252419835, 1252419844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1460831106⟩, ⟨0, 1460831112⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1460831106⟩, ⟨0, 1460831112⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1460831106), 0⟩, ⟨(-1460831112), 0⟩, ⟨(-365207779), (-365207773)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-730415553), 0⟩, ⟨(-730415556), 0⟩, ⟨(-182603890), (-182603886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3623284074, 4294967296⟩, ⟨(-730415556), 0⟩, ⟨(-182603890), (-91938373)⟩, ⟨0, 31054188⟩, ⟨634122, 3881774⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3338258431, 4309815945⟩, ⟨(-902456601), (-129706253)⟩, ⟨(-181146452), (-51771527)⟩, ⟨2347114, 38375694⟩, ⟨(-821010), 3898239⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨168931801, 168931802⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨168931801, 168931802⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298616437, 4298616439⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar387 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1602
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar387 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 337863603⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309815945⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1603
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(15733 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (15733 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(15733 / 200000), prawitzNormalCorrection
      ((65529 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
