...
namespace FiniteNormalPanel160_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (25629 / 160000)
def radius : Rat := (25629 / 800000)

def j0 : Jet := ⟨⟨687973230, 687973231⟩, ⟨137594646, 137594647⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2161331645, 2161331649⟩, ⟨432266329, 432266333⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1087634470, 1087634475⟩, ⟨435053788, 435053794⟩, ⟨43505378, 43505380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨272, 273⟩, ⟨108, 109⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94415), (-94413)⟩, ⟨108, 109⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23910), (-23908)⟩, ⟨(-9537), (-9535)⟩, ⟨(-945), (-941)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5089146, 5089149⟩, ⟨(-9537), (-9535)⟩, ⟨(-945), (-941)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1288748, 1288749⟩, ⟨513083, 513086⟩, ⟨50342, 50347⟩, ⟨(-193), (-189)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-141876829), (-141876827)⟩, ⟨513083, 513086⟩, ⟨50342, 50347⟩, ⟨(-193), (-189)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-35928127), (-35928126)⟩, ⟨(-14241321), (-14241318)⟩, ⟨(-1372406), (-1372402)⟩, ⟨10247, 10251⟩, ⟨486, 490⟩⟩
...
def j19 : Jet := ⟨⟨1395727638, 1395727640⟩, ⟨(-14241321), (-14241318)⟩, ⟨(-1372406), (-1372402)⟩, ⟨10247, 10251⟩, ⟨486, 490⟩⟩
...
def j22 : Jet := ⟨⟨(-28), (-27)⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11807, 11809⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2989, 2991⟩, ⟨1192, 1195⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849188), (-849185)⟩, ⟨1192, 1195⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-215044), (-215043)⟩, ⟨(-85717), (-85714)⟩, ⟨(-8453), (-8448)⟩, ⟨22, 26⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35576350, 35576352⟩, ⟨(-85717), (-85714)⟩, ⟨(-8453), (-8448)⟩, ⟨22, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9009163, 9009165⟩, ⟨3581958, 3581961⟩, ⟨349542, 349546⟩, ⟨(-1721), (-1716)⟩, ⟨(-85), (-81)⟩⟩
...
def j33 : Jet := ⟨⟨(-706818720), (-706818717)⟩, ⟨3581958, 3581961⟩, ⟨349542, 349546⟩, ⟨(-1721), (-1716)⟩, ⟨(-85), (-81)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-178990981), (-178990978)⟩, ⟨(-70689318), (-70689314)⟩, ⟨(-6708294), (-6708290)⟩, ⟨71253, 71257⟩, ⟨3343, 3348⟩⟩
...
def j36 : Jet := ⟨⟨4115976315, 4115976318⟩, ⟨(-70689318), (-70689314)⟩, ⟨(-6708294), (-6708290)⟩, ⟨71253, 71257⟩, ⟨3343, 3348⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨702363977, 702363980⟩, ⟨133306217, 133306221⟩, ⟨(-2123944), (-2123940)⟩, ⟨(-132970), (-132966)⟩, ⟨1275, 1279⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4481742033, 4481742037⟩, ⟨76971110, 76971117⟩, ⟨8626350, 8626357⟩, ⟨196009, 196018⟩, ⟨12445, 12457⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨732907596, 732907601⟩, ⟨151690516, 151690524⟩, ⟨1583386, 1583395⟩, ⟨122978, 122988⟩, ⟨2799, 2810⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-687973231), (-687973230)⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3606994065, 3606994066⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨125065805, 125065808⟩, ⟨51769954, 51769958⟩, ⟨5897824, 5897829⟩, ⟨153814, 153822⟩, ⟨10223, 10232⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4420033101, 4420033104⟩, ⟨51769954, 51769958⟩, ⟨5897824, 5897829⟩, ⟨153814, 153822⟩, ⟨10223, 10232⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4357051481, 4357051484⟩, ⟨25516138, 25516141⟩, ⟨2832177, 2832181⟩, ⟨59224, 59230⟩, ⟨3770, 3777⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3659133527, 3659133532⟩, ⟨(-118154661), (-118154656)⟩, ⟨1561073, 1561078⟩, ⟨(-40996), (-40989)⟩, ⟨1268, 1275⟩⟩
...
def j47 : Jet := ⟨⟨7299586072, 7299586085⟩, ⟨1459917214, 1459917226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12406137963, 12406138008⟩, ⟨4962455184, 4962455234⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12406137963, 12406138008⟩, ⟨4962455184, 4962455234⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12406138008), (-12406137963)⟩, ⟨(-4962455234), (-4962455184)⟩, ⟨(-496245527), (-496245518)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6203069004), (-6203068981)⟩, ⟨(-2481227617), (-2481227592)⟩, ⟨(-248122764), (-248122759)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1013266618, 1013266633⟩, ⟨(-585370035), (-585370019)⟩, ⟨110548828, 110548838⟩, ⟨1256541, 1256546⟩, ⟨(-3374714), (-3374712)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨863261021, 863261036⟩, ⟨(-526585920), (-526585902)⟩, ⟨110654834, 110654847⟩, ⟨(-2193117), (-2193106)⟩, ⟨(-2863619), (-2863611)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨550378584, 825567877⟩, ⟨137594646, 137594647⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1729065316, 2593597978⟩, ⟨432266329, 432266333⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨696086060, 1566193642⟩, ⟨348043030, 522064552⟩, ⟨43505378, 43505380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨174, 393⟩, ⟨87, 131⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94513), (-94293)⟩, ⟨87, 131⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34465), (-15282)⟩, ⟨(-11475), (-7593)⟩, ⟨(-950), (-934)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078591, 5097775⟩, ⟨(-11475), (-7593)⟩, ⟨(-950), (-934)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨823088, 1858944⟩, ⟨407359, 618418⟩, ⟨49701, 50872⟩, ⟨(-233), (-149)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142342489), (-141306632)⟩, ⟨407359, 618418⟩, ⟨49701, 50872⟩, ⟨(-233), (-149)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-51906310), (-22901589)⟩, ⟨(-17236084), (-11225283)⟩, ⟨(-1400777), (-1337627)⟩, ⟨8068, 12425⟩, ⟨470, 503⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1379749455, 1408754177⟩, ⟨(-17236084), (-11225283)⟩, ⟨(-1400777), (-1337627)⟩, ⟨8068, 12425⟩, ⟨470, 503⟩⟩
...
def j72 : Jet := ⟨⟨1911, 4310⟩, ⟨949, 1436⟩, ⟨116, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850266), (-847866)⟩, ⟨949, 1436⟩, ⟨116, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-310057), (-137413)⟩, ⟨(-103200), (-68182)⟩, ⟨(-8519), (-8369)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35481337, 35653982⟩, ⟨(-103200), (-68182)⟩, ⟨(-8519), (-8369)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5750466, 13001506⟩, ⟨2837600, 4322786⟩, ⟨343752, 354272⟩, ⟨(-2080), (-1357)⟩, ⟨(-87), (-79)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710077417), (-702826376)⟩, ⟨2837600, 4322786⟩, ⟨343752, 354272⟩, ⟨(-2080), (-1357)⟩, ⟨(-87), (-79)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-258935322), (-113907186)⟩, ⟨(-85851885), (-55377255)⟩, ⟨(-6906992), (-6464564)⟩, ⟨55839, 86632⟩, ⟨3196, 3468⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4036031974, 4181060110⟩, ⟨(-85851885), (-55377255)⟩, ⟨(-6906992), (-6464564)⟩, ⟨55839, 86632⟩, ⟨3196, 3468⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨555458694, 850703099⟩, ⟨128456334, 137264784⟩, ⟨(-2580610), (-1668267)⟩, ⟨(-137733), (-127121)⟩, ⟨1001, 1555⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4411977725, 4570514851⟩, ⟨58435709, 97221064⟩, ⟨7595566, 9889695⟩, ⟨96249, 315706⟩, ⟨7210, 19340⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨570591395, 905280735⟩, ⟨139513309, 165327684⟩, ⟨(-16127), 3352266⟩, ⟨34634, 225321⟩, ⟨(-4223), 10897⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-825567877), (-550378584)⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3469399419, 3744588712⟩, ⟨(-137594647), (-137594646)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨75803729, 190812445⟩, ⟨37069010, 69694580⟩, ⟨4525007, 7777179⟩, ⟨7960, 353066⟩, ⟨455, 24559⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4370771025, 4485779741⟩, ⟨37069010, 69694580⟩, ⟨4525007, 7777179⟩, ⟨7960, 353066⟩, ⟨455, 24559⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4332703383, 4389336771⟩, ⟨18136018, 34543785⟩, ⟨2077931, 3816765⟩, ⟨(-26486), 166298⟩, ⟨(-2783), 11887⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3499881969, 3826865211⟩, ⟨(-125967935), (-108686396)⟩, ⟨571862, 2746656⟩, ⟨(-145367), 78419⟩, ⟨(-7755), 11213⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5839668858, 8759503300⟩, ⟨1459917214, 1459917226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7939928297, 17864838723⟩, ⟨3969964146, 5954946280⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7939928297, 17864838723⟩, ⟨3969964146, 5954946280⟩, ⟨496245518, 496245527⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17864838723), (-7939928297)⟩, ⟨(-5954946280), (-3969964146)⟩, ⟨(-496245527), (-496245518)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8932419362), (-3969964148)⟩, ⟨(-2977473140), (-1984982073)⟩, ⟨(-248122764), (-248122759)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨536710188, 1704232114⟩, ⟨(-1181453780), (-248048478)⟩, ⟨(-41134864), 378513578⟩, ⟨(-77914530), 55007723⟩, ⟨(-20466960), 14691697⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨437354275, 1518490396⟩, ⟨(-1102672651), (-215711419)⟩, ⟨(-30303180), 373000904⟩, ⟨(-81337470), 50217058⟩, ⟨(-19900586), 15662142⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨687973230, 687973231⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4357051481, 4357051484⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3228
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨550378584, 825567877⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4332703383, 4389336771⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3229
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (57875307 / 4294967296)

theorem envelope_integral : (∫ s in ((25629 / 200000) : ℝ)..(76887 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((25629 / 200000) : ℝ)..(76887 / 400000), prawitzNormalCorrection
