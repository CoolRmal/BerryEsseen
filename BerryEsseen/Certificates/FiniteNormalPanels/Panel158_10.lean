...
namespace FiniteNormalPanel158_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1587 / 10000)
def radius : Rat := (1587 / 50000)

def j0 : Jet := ⟨⟨681611309, 681611310⟩, ⟨136322261, 136322262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2141345080, 2141345085⟩, ⟨428269013, 428269017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1067612029, 1067612035⟩, ⟨427044808, 427044814⟩, ⟨42704480, 42704482⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨267, 268⟩, ⟨106, 107⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94420), (-94418)⟩, ⟨106, 107⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23471), (-23469)⟩, ⟨(-9363), (-9360)⟩, ⟨(-927), (-924)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5089585, 5089588⟩, ⟨(-9363), (-9360)⟩, ⟨(-927), (-924)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1265132, 1265134⟩, ⟨503724, 503728⟩, ⟨49443, 49447⟩, ⟨(-187), (-183)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-141900445), (-141900442)⟩, ⟨503724, 503728⟩, ⟨49443, 49447⟩, ⟨(-187), (-183)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-35272591), (-35272589)⟩, ⟨(-13983825), (-13983821)⟩, ⟨(-1348530), (-1348525)⟩, ⟨9877, 9881⟩, ⟨469, 473⟩⟩
...
def j19 : Jet := ⟨⟨1396383174, 1396383177⟩, ⟨(-13983825), (-13983821)⟩, ⟨(-1348530), (-1348525)⟩, ⟨9877, 9881⟩, ⟨469, 473⟩⟩
...
def j25 : Jet := ⟨⟨2935, 2936⟩, ⟨1171, 1173⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849242), (-849240)⟩, ⟨1171, 1173⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-211099), (-211097)⟩, ⟨(-84149), (-84147)⟩, ⟨(-8300), (-8296)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35580295, 35580298⟩, ⟨(-84149), (-84147)⟩, ⟨(-8300), (-8296)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8844293, 8844295⟩, ⟨3516799, 3516802⟩, ⟨343340, 343344⟩, ⟨(-1658), (-1654)⟩, ⟨(-82), (-78)⟩⟩
...
def j33 : Jet := ⟨⟨(-706983590), (-706983587)⟩, ⟨3516799, 3516802⟩, ⟨343340, 343344⟩, ⟨(-1658), (-1654)⟩, ⟨(-82), (-78)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-175736889), (-175736886)⟩, ⟨(-69420576), (-69420572)⟩, ⟨(-6594460), (-6594456)⟩, ⟨68691, 68696⟩, ⟨3227, 3231⟩⟩
...
def j36 : Jet := ⟨⟨4119230407, 4119230410⟩, ⟨(-69420576), (-69420572)⟩, ⟨(-6594460), (-6594456)⟩, ⟨68691, 68696⟩, ⟨3227, 3231⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨696195810, 696195815⟩, ⟨132267234, 132267239⟩, ⟨(-2066724), (-2066719)⟩, ⟨(-129544), (-129540)⟩, ⟨1217, 1222⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4478201566, 4478201570⟩, ⟨75470240, 75470248⟩, ⟨8441015, 8441022⟩, ⟨188391, 188400⟩, ⟨11915, 11924⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨725897300, 725897307⟩, ⟨150143493, 150143503⟩, ⟨1537527, 1537536⟩, ⟨119097, 119107⟩, ⟨2661, 2673⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-681611310), (-681611309)⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3613355986, 3613355987⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨122684726, 122684730⟩, ⟨50751844, 50751850⟩, ⟨5768435, 5768440⟩, ⟨147752, 147762⟩, ⟨9774, 9783⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4417652022, 4417652026⟩, ⟨50751844, 50751850⟩, ⟨5768435, 5768440⟩, ⟨147752, 147762⟩, ⟨9774, 9783⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4355877748, 4355877751⟩, ⟨25021077, 25021081⟩, ⟨2772022, 2772026⟩, ⟨56919, 56926⟩, ⟨3608, 3615⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3664599949, 3664599953⟩, ⟨(-117205328), (-117205322)⟩, ⟨1537932, 1537938⟩, ⟨(-40100), (-40091)⟩, ⟨1228, 1236⟩⟩
...
def j47 : Jet := ⟨⟨7739775040, 7739775053⟩, ⟨1547954998, 1547955011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13947514274, 13947514322⟩, ⟨5579005672, 5579005732⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13947514274, 13947514322⟩, ⟨5579005672, 5579005732⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13947514322), (-13947514274)⟩, ⟨(-5579005732), (-5579005672)⟩, ⟨(-557900574), (-557900563)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6973757161), (-6973757137)⟩, ⟨(-2789502866), (-2789502836)⟩, ⟨(-278950287), (-278950281)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨846825663, 846825678⟩, ⟨(-549997822), (-549997805)⟩, ⟨123606983, 123606994⟩, ⟨(-2945928), (-2945922)⟩, ⟨(-3535694), (-3535692)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨722538046, 722538061⟩, ⟨(-492384303), (-492384284)⟩, ⟨120777443, 120777458⟩, ⟨(-6091519), (-6091506)⟩, ⟨(-2886739), (-2886728)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨545289047, 817933572⟩, ⟨136322261, 136322262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1713076064, 2569614102⟩, ⟨428269013, 428269017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨683271698, 1537361330⟩, ⟨341635846, 512453778⟩, ⟨42704480, 42704482⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-33832), (-15001)⟩, ⟨(-11265), (-7453)⟩, ⟨(-933), (-917)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5079224, 5098056⟩, ⟨(-11265), (-7453)⟩, ⟨(-933), (-917)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨808036, 1824823⟩, ⟨399985, 607090⟩, ⟨48823, 49953⟩, ⟨(-225), (-144)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142357541), (-141340753)⟩, ⟨399985, 607090⟩, ⟨48823, 49953⟩, ⟨(-225), (-144)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-50956146), (-22485418)⟩, ⟨(-16921750), (-11025404)⟩, ⟨(-1375866), (-1315022)⟩, ⟨7779, 11976⟩, ⟨454, 485⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1380699619, 1409170348⟩, ⟨(-16921750), (-11025404)⟩, ⟨(-1375866), (-1315022)⟩, ⟨7779, 11976⟩, ⟨454, 485⟩⟩
...
def j72 : Jet := ⟨⟨1876, 4231⟩, ⟨933, 1410⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850301), (-847945)⟩, ⟨933, 1410⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-304361), (-134896)⟩, ⟨(-101306), (-66943)⟩, ⟨(-8363), (-8219)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35487033, 35656499⟩, ⟨(-101306), (-66943)⟩, ⟨(-8363), (-8219)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5645511, 12763060⟩, ⟨2786493, 4243705⟩, ⟨337762, 347899⟩, ⟨(-2004), (-1307)⟩, ⟨(-84), (-76)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710182372), (-703064822)⟩, ⟨2786493, 4243705⟩, ⟨337762, 347899⟩, ⟨(-2004), (-1307)⟩, ⟨(-84), (-76)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-254206107), (-111848184)⟩, ⟨(-84292077), (-54405078)⟩, ⟨(-6785902), (-6359644)⟩, ⟨53853, 83498⟩, ⟨3087, 3345⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4040761189, 4183119112⟩, ⟨(-84292077), (-54405078)⟩, ⟨(-6785902), (-6359644)⟩, ⟨53853, 83498⟩, ⟨3087, 3345⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨550701159, 843085349⟩, ⟨127551260, 136116670⟩, ⟨(-2510498), (-1623893)⟩, ⟨(-134092), (-123960)⟩, ⟨956, 1486⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4409806075, 4565165624⟩, ⟨57353337, 95231388⟩, ⟨7450207, 9653139⟩, ⟨92967, 302528⟩, ⟨6981, 18391⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨565425799, 896124229⟩, ⟨138315573, 163373383⟩, ⟨(-9899), 3245648⟩, ⟨34982, 216357⟩, ⟨(-3981), 10308⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-817933572), (-545289047)⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3477033724, 3749678249⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨74437431, 186972002⟩, ⟨36418062, 68174140⟩, ⟨4450197, 7568829⟩, ⟨8456, 337204⟩, ⟨582, 23215⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4369404727, 4481939298⟩, ⟨36418062, 68174140⟩, ⟨4450197, 7568829⟩, ⟨8456, 337204⟩, ⟨582, 23215⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4332026131, 4387457431⟩, ⟨17825174, 33795469⟩, ⟨2048033, 3715368⟩, ⟨(-24794), 158734⟩, ⟨(-2545), 11219⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3507035074, 3830425837⟩, ⟨(-124827352), (-107993711)⟩, ⟨585336, 2677894⟩, ⟨(-139573), 73578⟩, ⟨(-7261), 10582⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6191820029, 9287730064⟩, ⟨1547954998, 1547955011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8926409127, 20084420625⟩, ⟨4463204536, 6694806878⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8926409127, 20084420625⟩, ⟨4463204536, 6694806878⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20084420625), (-8926409127)⟩, ⟨(-6694806878), (-4463204536)⟩, ⟨(-557900574), (-557900563)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10042210313), (-4463204563)⟩, ⟨(-3347403439), (-2231602268)⟩, ⟨(-278950287), (-278950281)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨414496663, 1519335630⟩, ⟨(-1184136913), (-215366411)⟩, ⟨(-42727456), 434524387⟩, ⟨(-103561160), 62371969⟩, ⟨(-26263620), 21565861⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨338455274, 1355005068⟩, ⟨(-1100218686), (-186278621)⟩, ⟨(-32634363), 422889074⟩, ⟨(-105776576), 56864343⟩, ⟨(-25285213), 22556323⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨681611309, 681611310⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4355877748, 4355877751⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3192
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨545289047, 817933572⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4332026131, 4387457431⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3193
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (48708743 / 4294967296)

theorem envelope_integral : (∫ s in ((1587 / 12500) : ℝ)..(4761 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((1587 / 12500) : ℝ)..(4761 / 25000), prawitzNormalCorrection
