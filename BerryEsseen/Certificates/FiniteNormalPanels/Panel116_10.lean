...
namespace FiniteNormalPanel116_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (5737 / 32000)
def radius : Rat := (5737 / 160000)

def j0 : Jet := ⟨⟨770007105, 770007106⟩, ⟨154001421, 154001422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2419048664, 2419048668⟩, ⟨483809732, 483809737⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1362477531, 1362477536⟩, ⟨544991010, 544991020⟩, ⟨54499101, 54499103⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨341, 342⟩, ⟨136, 137⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94346), (-94344)⟩, ⟨136, 137⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-29930), (-29928)⟩, ⟨(-11929), (-11927)⟩, ⟨(-1177), (-1174)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5083126, 5083129⟩, ⟨(-11929), (-11927)⟩, ⟨(-1177), (-1174)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1612502, 1612504⟩, ⟨641215, 641219⟩, ⟨62612, 62616⟩, ⟨(-302), (-297)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-141553075), (-141553072)⟩, ⟨641215, 641219⟩, ⟨62612, 62616⟩, ⟨(-302), (-297)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-44904390), (-44904388)⟩, ⟨(-17758347), (-17758343)⟩, ⟨(-1694950), (-1694946)⟩, ⟨15984, 15989⟩, ⟨750, 755⟩⟩
...
def j19 : Jet := ⟨⟨1386751375, 1386751378⟩, ⟨(-17758347), (-17758343)⟩, ⟨(-1694950), (-1694946)⟩, ⟨15984, 15989⟩, ⟨750, 755⟩⟩
...
def j25 : Jet := ⟨⟨3743, 3745⟩, ⟨1492, 1494⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848434), (-848431)⟩, ⟨1492, 1494⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-269146), (-269144)⟩, ⟨(-107186), (-107183)⟩, ⟨(-10531), (-10527)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35522248, 35522251⟩, ⟨(-107186), (-107183)⟩, ⟨(-10531), (-10527)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11268599, 11268601⟩, ⟨4473436, 4473440⟩, ⟨433801, 433806⟩, ⟨(-2687), (-2682)⟩, ⟨(-131), (-127)⟩⟩
...
def j33 : Jet := ⟨⟨(-704559284), (-704559281)⟩, ⟨4473436, 4473440⟩, ⟨433801, 433806⟩, ⟨(-2687), (-2682)⟩, ⟨(-131), (-127)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-223504891), (-223504889)⟩, ⟨(-87982866), (-87982861)⟩, ⟨(-8234946), (-8234942)⟩, ⟨110955, 110960⟩, ⟨5121, 5125⟩⟩
...
def j36 : Jet := ⟨⟨4071462405, 4071462407⟩, ⟨(-87982866), (-87982861)⟩, ⟨(-8234946), (-8234942)⟩, ⟨110955, 110960⟩, ⟨5121, 5125⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨781058115, 781058119⟩, ⟨146209612, 146209618⟩, ⟨(-2955048), (-2955043)⟩, ⟨(-181927), (-181922)⟩, ⟨2222, 2228⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4530741593, 4530741596⟩, ⟨97907721, 97907728⟩, ⟨11279631, 11279638⟩, ⟨318298, 318309⟩, ⟨21318, 21327⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨823934676, 823934681⟩, ⟨172040795, 172040804⟩, ⟨2266963, 2266973⟩, ⟨182587, 182599⟩, ⟨5145, 5159⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-770007106), (-770007105)⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3524960190, 3524960191⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨158061354, 158061357⟩, ⟨66007662, 66007668⟩, ⟨7761103, 7761111⟩, ⟨251664, 251674⟩, ⟨17796, 17807⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4453028650, 4453028653⟩, ⟨66007662, 66007668⟩, ⟨7761103, 7761111⟩, ⟨251664, 251674⟩, ⟨17796, 17807⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4373283940, 4373283942⟩, ⟨32412799, 32412803⟩, ⟨3690943, 3690949⟩, ⟨96222, 96229⟩, ⟨6467, 6474⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3589236128, 3589236131⟩, ⟨(-130207773), (-130207766)⟩, ⟨1867024, 1867031⟩, ⟨(-53373), (-53366)⟩, ⟨1856, 1864⟩⟩
...
def j47 : Jet := ⟨⟨6673471819, 6673471830⟩, ⟨1334694363, 1334694373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10369165362, 10369165397⟩, ⟨4147666142, 4147666182⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10369165362, 10369165397⟩, ⟨4147666142, 4147666182⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10369165397), (-10369165362)⟩, ⟨(-4147666182), (-4147666142)⟩, ⟨(-414766621), (-414766614)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5184582699), (-5184582681)⟩, ⟨(-2073833091), (-2073833071)⟩, ⟨(-207383311), (-207383307)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1284428931, 1284428949⟩, ⟨(-620188950), (-620188935)⟩, ⟨87710803, 87710811⟩, ⟨5846849, 5846853⟩, ⟨(-2823358), (-2823356)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1073376909, 1073376926⟩, ⟨(-557221291), (-557221274)⟩, ⟨92658738, 92658752⟩, ⟨1941486, 1941496⟩, ⟨(-2490305), (-2490293)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨616005684, 924008527⟩, ⟨154001421, 154001422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1935238931, 2902858401⟩, ⟨483809732, 483809737⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨871985619, 1961967651⟩, ⟨435992808, 653989222⟩, ⟨54499101, 54499103⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨218, 492⟩, ⟨109, 164⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94469), (-94194)⟩, ⟨109, 164⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-43155), (-19123)⟩, ⟨(-14363), (-9486)⟩, ⟨(-1186), (-1163)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5069901, 5093934⟩, ⟨(-14363), (-9486)⟩, ⟨(-1186), (-1163)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1029316, 2326941⟩, ⟨508096, 773722⟩, ⟨61602, 63440⟩, ⟨(-364), (-235)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142136261), (-140838635)⟩, ⟨508096, 773722⟩, ⟨61602, 63440⟩, ⟨(-364), (-235)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-64928724), (-28593760)⟩, ⟨(-21539753), (-13943438)⟩, ⟨(-1739492), (-1640315)⟩, ⟨12533, 19431⟩, ⟨717, 780⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1366727041, 1403062006⟩, ⟨(-21539753), (-13943438)⟩, ⟨(-1739492), (-1640315)⟩, ⟨12533, 19431⟩, ⟨717, 780⟩⟩
...
def j72 : Jet := ⟨⟨2392, 5398⟩, ⟨1188, 1798⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849785), (-846778)⟩, ⟨1188, 1798⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-388188), (-171917)⟩, ⟨(-129155), (-85136)⟩, ⟨(-10634), (-10401)⟩, ⟨28, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35403206, 35619478⟩, ⟨(-129155), (-85136)⟩, ⟨(-10634), (-10401)⟩, ⟨28, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7187734, 16271199⟩, ⟨3534868, 5406449⟩, ⟨424708, 441225⟩, ⟨(-3254), (-2113)⟩, ⟨(-134), (-122)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708640149), (-699556683)⟩, ⟨3534868, 5406449⟩, ⟨424708, 441225⟩, ⟨(-3254), (-2113)⟩, ⟨(-134), (-122)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-323711208), (-142027476)⟩, ⟨(-107186071), (-68544038)⟩, ⟨(-8546920), (-7851928)⟩, ⟨86480, 135360⟩, ⟨4831, 5361⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3971256088, 4152939820⟩, ⟨(-107186071), (-68544038)⟩, ⟨(-8546920), (-7851928)⟩, ⟨86480, 135360⟩, ⟨4831, 5361⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨615823869, 948293678⟩, ⟨139397799, 151766273⟩, ⟨(-3602041), (-2309765)⟩, ⟨(-190300), (-171641)⟩, ⟨1734, 2717⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4441852006, 4645065356⟩, ⟨73312516, 125372501⟩, ⟨9608189, 13380953⟩, ⟨145792, 534258⟩, ⟨10487, 36220⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨636884590, 1025592469⟩, ⟨154676844, 191818506⟩, ⟨(-138574), 4995792⟩, ⟨21789, 373852⟩, ⟨(-8751), 21720⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-924008527), (-616005684)⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3370958769, 3678961612⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨94441226, 244900564⟩, ⟨45872898, 91608436⟩, ⟨5504275, 10952734⟩, ⟨(-5916), 624782⟩, ⟨(-2774), 49579⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4389408522, 4539867860⟩, ⟨45872898, 91608436⟩, ⟨5504275, 10952734⟩, ⟨(-5916), 624782⟩, ⟨(-2774), 49579⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4341931143, 4415720099⟩, ⟨22309226, 45308784⟩, ⟨2444425, 5359820⟩, ⟨(-58858), 296453⟩, ⟨(-7775), 24448⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3407818931, 3782395445⟩, ⟨(-140821491), (-116874996)⟩, ⟨293933, 3791163⟩, ⟨(-242601), 166288⟩, ⟨(-17290), 23053⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5338777455, 8008166194⟩, ⟨1334694363, 1334694373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6636265831, 14931598164⟩, ⟨3318132912, 4977199416⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6636265831, 14931598164⟩, ⟨3318132912, 4977199416⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14931598164), (-6636265831)⟩, ⟨(-4977199416), (-3318132912)⟩, ⟨(-414766621), (-414766614)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7465799082), (-3318132915)⟩, ⟨(-2488599708), (-1659066456)⟩, ⟨(-207383311), (-207383307)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨755162086, 1983535622⟩, ⟨(-1149304717), (-291705151)⟩, ⟨(-39435241), 296503232⟩, ⟨(-47876834), 44612817⟩, ⟨(-13620773), 7887296⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨599179336, 1746815653⟩, ⟨(-1077179186), (-252001429)⟩, ⟨(-26739360), 300551576⟩, ⟨(-53011246), 40638435⟩, ⟨(-13545277), 8853062⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨770007105, 770007106⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4373283940, 4373283942⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2338
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨616005684, 924008527⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4341931143, 4415720099⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2339
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (79316449 / 4294967296)

theorem envelope_integral : (∫ s in ((5737 / 40000) : ℝ)..(17211 / 80000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((5737 / 40000) : ℝ)..(17211 / 80000), prawitzNormalCorrection
