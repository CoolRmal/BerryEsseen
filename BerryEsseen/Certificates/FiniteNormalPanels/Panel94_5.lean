...
namespace FiniteNormalPanel94_5
...
def j0 : Jet := ⟨⟨802326734, 802326735⟩, ⟨160465346, 160465347⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2520583773, 2520583777⟩, ⟨504116752, 504116756⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1479252836, 1479252842⟩, ⟨591701130, 591701138⟩, ⟨59170112, 59170114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-32485), (-32483)⟩, ⟨(-12944), (-12941)⟩, ⟨(-1276), (-1272)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5080571, 5080574⟩, ⟨(-12944), (-12941)⟩, ⟨(-1276), (-1272)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1749826, 1749828⟩, ⟨695471, 695475⟩, ⟨67769, 67774⟩, ⟨(-354), (-350)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-141415751), (-141415748)⟩, ⟨695471, 695475⟩, ⟨67769, 67774⟩, ⟨(-354), (-350)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-48705762), (-48705759)⟩, ⟨(-19242775), (-19242770)⟩, ⟨(-1829079), (-1829074)⟩, ⟨18795, 18799⟩, ⟨877, 881⟩⟩
...
def j19 : Jet := ⟨⟨1382950003, 1382950007⟩, ⟨(-19242775), (-19242770)⟩, ⟨(-1829079), (-1829074)⟩, ⟨18795, 18799⟩, ⟨877, 881⟩⟩
...
def j25 : Jet := ⟨⟨4063, 4065⟩, ⟨1619, 1622⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848114), (-848111)⟩, ⟨1619, 1622⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-292104), (-292102)⟩, ⟨(-116285), (-116281)⟩, ⟨(-11408), (-11404)⟩, ⟨42, 46⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35499290, 35499293⟩, ⟨(-116285), (-116281)⟩, ⟨(-11408), (-11404)⟩, ⟨42, 46⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12226501, 12226503⟩, ⟨4850549, 4850554⟩, ⟨469109, 469115⟩, ⟨(-3161), (-3156)⟩, ⟨(-153), (-148)⟩⟩
...
def j33 : Jet := ⟨⟨(-703601382), (-703601379)⟩, ⟨4850549, 4850554⟩, ⟨469109, 469115⟩, ⟨(-3161), (-3156)⟩, ⟨(-153), (-148)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-242331146), (-242331143)⟩, ⟨(-95261856), (-95261850)⟩, ⟨(-8863437), (-8863431)⟩, ⟨130362, 130368⟩, ⟨5973, 5979⟩⟩
...
def j36 : Jet := ⟨⟨4052636150, 4052636153⟩, ⟨(-95261856), (-95261850)⟩, ⟨(-8863437), (-8863431)⟩, ⟨130362, 130368⟩, ⟨5973, 5979⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨811610682, 811610686⟩, ⟨151029144, 151029151⟩, ⟨(-3332030), (-3332024)⟩, ⟨(-203657), (-203652)⟩, ⟨2720, 2725⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4551788854, 4551788859⟩, ⟨106995004, 106995014⟩, ⟨12470156, 12470166⟩, ⟨380705, 380715⟩, ⟨26062, 26075⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨860141696, 860141702⟩, ⟨180278685, 180278697⟩, ⟨2587581, 2587592⟩, ⟨211602, 211612⟩, ⟨6444, 6457⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-802326735), (-802326734)⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3492640561, 3492640562⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨172258293, 172258296⟩, ⟨72207866, 72207874⟩, ⟨8603504, 8603514⟩, ⟨301976, 301984⟩, ⟨21900, 21913⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4467225589, 4467225592⟩, ⟨72207866, 72207874⟩, ⟨8603504, 8603514⟩, ⟨301976, 301984⟩, ⟨21900, 21913⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4380249742, 4380249745⟩, ⟨35400997, 35401002⟩, ⟨4074942, 4074949⟩, ⟨115114, 115120⟩, ⟨7910, 7919⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3561991713, 3561991717⟩, ⟨(-134863737), (-134863730)⟩, ⟨1991091, 1991099⟩, ⟨(-58637), (-58629)⟩, ⟨2130, 2140⟩⟩
...
def j47 : Jet := ⟨⟨7594667474, 7594667486⟩, ⟨1518933487, 1518933498⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13429432651, 13429432694⟩, ⟨5371773032, 5371773082⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13429432651, 13429432694⟩, ⟨5371773032, 5371773082⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13429432694), (-13429432651)⟩, ⟨(-5371773082), (-5371773032)⟩, ⟨(-537177309), (-537177300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6714716347), (-6714716325)⟩, ⟨(-2685886541), (-2685886516)⟩, ⟨(-268588655), (-268588650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨899471604, 899471621⟩, ⟨(-562490598), (-562490581)⟩, ⟨119629562, 119629573⟩, ⟨(-1486569), (-1486564)⟩, ⟨(-3508150), (-3508148)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨745968520, 745968536⟩, ⟨(-494740196), (-494740177)⟩, ⟨117293096, 117293111⟩, ⟨(-5262337), (-5262326)⟩, ⟨(-2799193), (-2799183)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨641861387, 962792082⟩, ⟨160465346, 160465347⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2016467017, 3024700532⟩, ⟨504116752, 504116756⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨946721814, 2130124092⟩, ⟨473360904, 710041366⟩, ⟨59170112, 59170114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨236, 534⟩, ⟨118, 178⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94451), (-94152)⟩, ⟨118, 178⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-46844), (-20753)⟩, ⟨(-15589), (-10287)⟩, ⟨(-1286), (-1259)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5066212, 5092304⟩, ⟨(-15589), (-10287)⟩, ⟨(-1286), (-1259)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1116724, 2525570⟩, ⟨550630, 839590⟩, ⟨66579, 68745⟩, ⟨(-428), (-276)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142048853), (-140640006)⟩, ⟨550630, 839590⟩, ⟨66579, 68745⟩, ⟨(-428), (-276)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-70450289), (-31000692)⟩, ⟨(-23362057), (-15083944)⟩, ⟨(-1881592), (-1764647)⟩, ⟨14709, 22872⟩, ⟨837, 915⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1361205476, 1400655074⟩, ⟨(-23362057), (-15083944)⟩, ⟨(-1881592), (-1764647)⟩, ⟨14709, 22872⟩, ⟨837, 915⟩⟩
...
def j72 : Jet := ⟨⟨2596, 5859⟩, ⟨1289, 1951⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849581), (-846317)⟩, ⟨1289, 1951⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-421357), (-186550)⟩, ⟨(-140169), (-92307)⟩, ⟨(-11529), (-11255)⟩, ⟨33, 54⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35370037, 35604845⟩, ⟨(-140169), (-92307)⟩, ⟨(-11529), (-11255)⟩, ⟨33, 54⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7796470, 17658514⟩, ⟨3828717, 5865826⟩, ⟨458388, 477862⟩, ⟨(-3831), (-2484)⟩, ⟨(-156), (-144)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708031413), (-698169368)⟩, ⟨3828717, 5865826⟩, ⟨458388, 477862⟩, ⟨(-3831), (-2484)⟩, ⟨(-156), (-144)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-351153960), (-153894575)⟩, ⟨(-116207373), (-74038082)⟩, ⟨(-9231263), (-8411675)⟩, ⟨101365, 159265⟩, ⟨5603, 6280⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3943813336, 4141072721⟩, ⟨(-116207373), (-74038082)⟩, ⟨(-9231263), (-8411675)⟩, ⟨101365, 159265⟩, ⟨5603, 6280⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨639079591, 986401492⟩, ⟨143317332, 157318408⟩, ⟨(-4067193), (-2598953)⟩, ⟨(-213945), (-191015)⟩, ⟨2118, 3330⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4454581050, 4677387722⟩, ⟨79643285, 137822685⟩, ⟨10472435, 15009386⟩, ⟨169121, 650373⟩, ⟨11900, 45922⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨662829688, 1074229886⟩, ⟨160494136, 202978891⟩, ⟨(-213473), 5799832⟩, ⟨11106, 452834⟩, ⟨(-11471), 28118⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-962792082), (-641861387)⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3332175214, 3653105909⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨102292558, 268679543⟩, ⟨49537176, 101535578⟩, ⟨5890551, 12493959⟩, ⟨(-16752), 774718⟩, ⟨(-5199), 64700⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4397259854, 4563646839⟩, ⟨49537176, 101535578⟩, ⟨5890551, 12493959⟩, ⟨(-16752), 774718⟩, ⟨(-5199), 64700⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4345812612, 4427269353⟩, ⟨24028417, 50173814⟩, ⟨2572952, 6107464⟩, ⟨(-78792), 368602⟩, ⟨(-11118), 32121⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3371622662, 3765636086⟩, ⟨(-146766292), (-119689401)⟩, ⟨121622, 4297004⟩, ⟨(-295200), 217389⟩, ⟨(-23229), 30265⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6075733977, 9113600983⟩, ⟨1518933487, 1518933498⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8594836890, 19338383078⟩, ⟨4297418424, 6446127698⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8594836890, 19338383078⟩, ⟨4297418424, 6446127698⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19338383078), (-8594836890)⟩, ⟨(-6446127698), (-4297418424)⟩, ⟨(-537177309), (-537177300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9669191539), (-4297418445)⟩, ⟨(-3223063849), (-2148709212)⟩, ⟨(-268588655), (-268588650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨452105301, 1579128705⟩, ⟨(-1185022444), (-226181658)⟩, ⟨(-42174187), 416364323⟩, ⟨(-94720873), 59953679⟩, ⟨(-24266542), 19088996⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨354910380, 1384509736⟩, ⟨(-1092936412), (-190155444)⟩, ⟨(-30660563), 407123798⟩, ⟨(-98569039), 54079405⟩, ⟨(-23435259), 20482294⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4380249742, 4380249745⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1890
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨641861387, 962792082⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4345812612, 4427269353⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1891
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (29484105 / 2147483648)

theorem envelope_integral : (∫ s in ((29889 / 200000) : ℝ)..(89667 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((29889 / 200000) : ℝ)..(89667 / 400000), prawitzNormalCorrection
