...
namespace FiniteNormalPanel121_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (27877 / 160000)
def radius : Rat := (27877 / 800000)

def j0 : Jet := ⟨⟨748317520, 748317521⟩, ⟨149663504, 149663505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2350908823, 2350908827⟩, ⟨470181764, 470181768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1286801950, 1286801955⟩, ⟨514720778, 514720786⟩, ⟨51472077, 51472079⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨322, 323⟩, ⟨128, 129⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94365), (-94363)⟩, ⟨128, 129⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-28273), (-28271)⟩, ⟨(-11271), (-11269)⟩, ⟨(-1113), (-1110)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5084783, 5084786⟩, ⟨(-11271), (-11269)⟩, ⟨(-1113), (-1110)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1523436, 1523438⟩, ⟨605997, 605999⟩, ⟨59252, 59256⟩, ⟨(-270), (-266)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-141642141), (-141642138)⟩, ⟨605997, 605999⟩, ⟨59252, 59256⟩, ⟨(-270), (-266)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-42436967), (-42436965)⟩, ⟨(-16793227), (-16793224)⟩, ⟨(-1607103), (-1607099)⟩, ⟨14281, 14286⟩, ⟨672, 677⟩⟩
...
def j19 : Jet := ⟨⟨1389218798, 1389218801⟩, ⟨(-16793227), (-16793224)⟩, ⟨(-1607103), (-1607099)⟩, ⟨14281, 14286⟩, ⟨672, 677⟩⟩
...
def j22 : Jet := ⟨⟨(-33), (-32)⟩, ⟨(-13), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11802, 11804⟩, ⟨(-13), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3535, 3537⟩, ⟨1410, 1412⟩, ⟨138, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848642), (-848639)⟩, ⟨1410, 1412⟩, ⟨138, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-254260), (-254258)⟩, ⟨(-101282), (-101279)⟩, ⟨(-9962), (-9957)⟩, ⟨31, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35537134, 35537137⟩, ⟨(-101282), (-101279)⟩, ⟨(-9962), (-9957)⟩, ⟨31, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10647171, 10647173⟩, ⟨4228523, 4228527⟩, ⟨410763, 410767⟩, ⟨(-2399), (-2395)⟩, ⟨(-118), (-113)⟩⟩
...
def j33 : Jet := ⟨⟨(-705180712), (-705180709)⟩, ⟨4228523, 4228527⟩, ⟨410763, 410767⟩, ⟨(-2399), (-2395)⟩, ⟨(-118), (-113)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-211277027), (-211277024)⟩, ⟨(-83243918), (-83243913)⟩, ⟨(-7821258), (-7821252)⟩, ⟨99182, 99187⟩, ⟨4598, 4603⟩⟩
...
def j36 : Jet := ⟨⟨4083690269, 4083690272⟩, ⟨(-83243918), (-83243913)⟩, ⟨(-7821258), (-7821252)⟩, ⟨99182, 99187⟩, ⟨4598, 4603⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨760407822, 760407826⟩, ⟨142889562, 142889567⟩, ⟨(-2718071), (-2718066)⟩, ⟨(-168118), (-168113)⟩, ⟨1930, 1935⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4517175114, 4517175119⟩, ⟨92080276, 92080284⟩, ⟨10528487, 10528497⟩, ⟨281256, 281265⟩, ⟨18567, 18578⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨799748881, 799748887⟩, ⟨166584675, 166584684⟩, ⟨2068758, 2068767⟩, ⟨164977, 164989⟩, ⟨4405, 4418⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-748317521), (-748317520)⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3546649775, 3546649776⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨148918077, 148918080⟩, ⟨62038146, 62038152⟩, ⟨7231586, 7231591⟩, ⟨221914, 221924⟩, ⟨15432, 15443⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4443885373, 4443885376⟩, ⟨62038146, 62038152⟩, ⟨7231586, 7231591⟩, ⟨221914, 221924⟩, ⟨15432, 15443⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4368791863, 4368791865⟩, ⟨30494907, 30494911⟩, ⟨3448262, 3448266⟩, ⟨85011, 85018⟩, ⟨5630, 5638⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3607611795, 3607611799⟩, ⟨(-127054274), (-127054268)⟩, ⟨1784833, 1784838⟩, ⟨(-49961), (-49952)⟩, ⟨1686, 1694⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨46305259472, 46305259480⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value520

def j47 : Jet := ⟨⟨8067823231, 8067823245⟩, ⟨1613564646, 1613564658⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15154893437, 15154893490⟩, ⟨6061957374, 6061957430⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15154893437, 15154893490⟩, ⟨6061957374, 6061957430⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15154893490), (-15154893437)⟩, ⟨(-6061957430), (-6061957374)⟩, ⟨(-606195747), (-606195737)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7577446745), (-7577446718)⟩, ⟨(-3030978715), (-3030978687)⟩, ⟨(-303097874), (-303097868)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨735784598, 735784611⟩, ⟨(-519246677), (-519246662)⟩, ⟨131292741, 131292751⟩, ⟨(-6455651), (-6455646)⟩, ⟨(-3493752), (-3493749)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨618031526, 618031539⟩, ⟨(-457913853), (-457913836)⟩, ⟨125947173, 125947187⟩, ⟨(-9530766), (-9530756)⟩, ⟨(-2682763), (-2682753)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨598654016, 897981025⟩, ⟨149663504, 149663505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1880727058, 2821090592⟩, ⟨470181764, 470181768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨823553248, 1852994815⟩, ⟨411776622, 617664942⟩, ⟨51472077, 51472079⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨206, 465⟩, ⟨103, 155⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94481), (-94221)⟩, ⟨103, 155⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-40763), (-18066)⟩, ⟨(-13569), (-8966)⟩, ⟨(-1122), (-1100)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5072293, 5094991⟩, ⟨(-13569), (-8966)⟩, ⟨(-1122), (-1100)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨972604, 2198153⟩, ⟨480447, 730999⟩, ⟨58350, 59991⟩, ⟨(-325), (-210)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142192973), (-140967423)⟩, ⟨480447, 730999⟩, ⟨58350, 59991⟩, ⟨(-325), (-210)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-61346880), (-27030282)⟩, ⟨(-20356836), (-13199763)⟩, ⟨(-1646831), (-1558383)⟩, ⟨11210, 17349⟩, ⟨645, 697⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1370308885, 1404625484⟩, ⟨(-20356836), (-13199763)⟩, ⟨(-1646831), (-1558383)⟩, ⟨11210, 17349⟩, ⟨645, 697⟩⟩
...
def j72 : Jet := ⟨⟨2260, 5098⟩, ⟨1123, 1699⟩, ⟨137, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849917), (-847078)⟩, ⟨1123, 1699⟩, ⟨137, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-366684), (-162425)⟩, ⟨(-122013), (-80478)⟩, ⟨(-10053), (-9844)⟩, ⟨25, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35424710, 35628970⟩, ⟨(-122013), (-80478)⟩, ⟨(-10053), (-9844)⟩, ⟨25, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6792632, 15371549⟩, ⟨3343675, 5108419⟩, ⟨402654, 417386⟩, ⟨(-2905), (-1888)⟩, ⟨(-120), (-109)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709035251), (-700456333)⟩, ⟨3343675, 5108419⟩, ⟨402654, 417386⟩, ⟨(-2905), (-1888)⟩, ⟨(-120), (-109)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-305901898), (-134311404)⟩, ⟨(-101326156), (-64951755)⟩, ⟨(-8099496), (-7479738)⟩, ⟨77421, 120884⟩, ⟨4355, 4802⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3989065398, 4160655892⟩, ⟨(-101326156), (-64951755)⟩, ⟨(-8099496), (-7479738)⟩, ⟨77421, 120884⟩, ⟨4355, 4802⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨600045779, 922609060⟩, ⟨136640334, 147988123⟩, ⟨(-3310218), (-2127414)⟩, ⟨(-175376), (-159204)⟩, ⟨1509, 2358⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4433614447, 4624327314⟩, ⟨69212894, 117462430⟩, ⟨9050920, 12373009⟩, ⟨131361, 466737⟩, ⟨9569, 30798⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨619416040, 993359433⟩, ⟨150720929, 184568908⟩, ⟨(-97626), 4509084⟩, ⟨26942, 327962⟩, ⟨(-7262), 18189⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-897981025), (-598654016)⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3396986271, 3696313280⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨89331583, 229748656⟩, ⟨43473652, 85375862⟩, ⟨5244006, 10017299⟩, ⟨(-622), 539248⟩, ⟨(-1573), 41336⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4384298879, 4524715952⟩, ⟨43473652, 85375862⟩, ⟨5244006, 10017299⟩, ⟨(-622), 539248⟩, ⟨(-1573), 41336⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4339403219, 4408345159⟩, ⟨21177778, 42250803⟩, ⟨2352095, 4905684⟩, ⟨(-48073), 255385⟩, ⟨(-6040), 20288⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3432131642, 3793887970⟩, ⟨(-136864318), (-114850254)⟩, ⟨388041, 3483940⟩, ⟨(-212318), 137828⟩, ⟨(-14099), 19137⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6454258585, 9681387891⟩, ⟨1613564646, 1613564658⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9699131800, 21823046612⟩, ⟨4849565898, 7274348914⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9699131800, 21823046612⟩, ⟨4849565898, 7274348914⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21823046612), (-9699131800)⟩, ⟨(-7274348914), (-4849565898)⟩, ⟨(-606195747), (-606195737)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10911523306), (-4849565900)⟩, ⟨(-3637174457), (-2424782949)⟩, ⟨(-303097874), (-303097868)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨338546758, 1388628258⟩, ⟨(-1175953828), (-191131235)⟩, ⟨(-44043268), 474034300⟩, ⟨(-124819151), 67757696⟩, ⟨(-31071491), 27979717⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨270534549, 1226621690⟩, ⟨(-1083009584), (-161786968)⟩, ⟨(-33763328), 457329920⟩, ⟨(-126385142), 61283421⟩, ⟨(-29683691), 29141774⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨748317520, 748317521⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4368791863, 4368791865⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar520 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2430
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar520 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨598654016, 897981025⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4339403219, 4408345159⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2431
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((27877 / 200000) : ℝ)..(83631 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (83631 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((27877 / 200000) : ℝ)..(83631 / 400000), prawitzNormalCorrection
      ((299019 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
