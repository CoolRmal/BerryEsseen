...
namespace FiniteNormalPanel44_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (35189 / 160000)
def radius : Rat := (35189 / 800000)

def j0 : Jet := ⟨⟨944597526, 944597527⟩, ⟨188919505, 188919506⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2967540648, 2967540652⟩, ⟨593508129, 593508133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2050375914, 2050375921⟩, ⟨820150364, 820150372⟩, ⟨82015036, 82015038⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨513, 514⟩, ⟨205, 206⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94174), (-94172)⟩, ⟨205, 206⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-44958), (-44956)⟩, ⟨(-17887), (-17883)⟩, ⟨(-1751), (-1747)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5068098, 5068101⟩, ⟨(-17887), (-17883)⟩, ⟨(-1751), (-1747)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2419461, 2419463⟩, ⟨959244, 959248⟩, ⟨92526, 92531⟩, ⟨(-675), (-669)⟩, ⟨(-33), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-140746116), (-140746113)⟩, ⟨959244, 959248⟩, ⟨92526, 92531⟩, ⟨(-675), (-669)⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-67190837), (-67190835)⟩, ⟨(-26418402), (-26418398)⟩, ⟨(-2460290), (-2460284)⟩, ⟨35662, 35669⟩, ⟨1621, 1626⟩⟩
...
def j19 : Jet := ⟨⟨1364464928, 1364464931⟩, ⟨(-26418402), (-26418398)⟩, ⟨(-2460290), (-2460284)⟩, ⟨35662, 35669⟩, ⟨1621, 1626⟩⟩
...
def j22 : Jet := ⟨⟨(-52), (-51)⟩, ⟨(-21), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11783, 11785⟩, ⟨(-21), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5625, 5627⟩, ⟨2239, 2242⟩, ⟨218, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846552), (-846549)⟩, ⟨2239, 2242⟩, ⟨218, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-404136), (-404134)⟩, ⟨(-160587), (-160582)⟩, ⟨(-15635), (-15629)⟩, ⟨82, 86⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35387258, 35387261⟩, ⟨(-160587), (-160582)⟩, ⟨(-15635), (-15629)⟩, ⟨82, 86⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16893535, 16893537⟩, ⟨6680751, 6680755⟩, ⟨637611, 637617⟩, ⟨(-6014), (-6008)⟩, ⟨(-284), (-278)⟩⟩
...
def j33 : Jet := ⟨⟨(-698934348), (-698934345)⟩, ⟨6680751, 6680755⟩, ⟨637611, 637617⟩, ⟨(-6014), (-6008)⟩, ⟨(-284), (-278)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-333664510), (-333664507)⟩, ⟨(-130276479), (-130276474)⟩, ⟨(-11766462), (-11766455)⟩, ⟨246456, 246463⟩, ⟨10890, 10897⟩⟩
...
def j36 : Jet := ⟨⟨3961302786, 3961302789⟩, ⟨(-130276479), (-130276474)⟩, ⟨(-11766462), (-11766455)⟩, ⟨246456, 246463⟩, ⟨10890, 10897⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨942755755, 942755759⟩, ⟨170297767, 170297774⟩, ⟨(-5350576), (-5350569)⟩, ⟨(-315340), (-315333)⟩, ⟨6048, 6053⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4656736699, 4656736703⟩, ⟨153147403, 153147411⟩, ⟨18868737, 18868748⟩, ⟨785710, 785722⟩, ⟨59545, 59559⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1022165017, 1022165023⟩, ⟨218258344, 218258356⟩, ⟨4412849, 4412863⟩, ⟨387930, 387945⟩, ⟨16028, 16043⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-944597527), (-944597526)⟩, ⟨(-188919506), (-188919505)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3350369769, 3350369770⟩, ⟨(-188919506), (-188919505)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨243266420, 243266424⟩, ⟨103887190, 103887198⟩, ⟨13191722, 13191734⟩, ⟨633142, 633156⟩, ⟨51587, 51602⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4538233716, 4538233720⟩, ⟨103887190, 103887198⟩, ⟨13191722, 13191734⟩, ⟨633142, 633156⟩, ⟨51587, 51602⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4414925298, 4414925301⟩, ⟨50532234, 50532239⟩, ⟨6127454, 6127461⟩, ⟨237835, 237844⟩, ⟨18117, 18127⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3443945257, 3443945262⟩, ⟨(-154777393), (-154777386)⟩, ⟨2557111, 2557118⟩, ⟨(-83998), (-83988)⟩, ⟨3670, 3680⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨25486571458, 25486571464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value279

def j47 : Jet := ⟨⟨5605293518, 5605293526⟩, ⟨1121058702, 1121058709⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7315379433, 7315379454⟩, ⟨2926151768, 2926151792⟩, ⟨292615176, 292615181⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7315379433, 7315379454⟩, ⟨2926151768, 2926151792⟩, ⟨292615176, 292615181⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7315379454), (-7315379433)⟩, ⟨(-2926151792), (-2926151768)⟩, ⟨(-292615181), (-292615176)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3657689727), (-3657689716)⟩, ⟨(-1463075896), (-1463075884)⟩, ⟨(-146307591), (-146307588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1832757541, 1832757554⟩, ⟨(-624326850), (-624326839)⟩, ⟨43905439, 43905445⟩, ⟨9192969, 9192971⟩, ⟨(-1530712), (-1530710)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1469607614, 1469607627⟩, ⟨(-566667164), (-566667149)⟩, ⟨58795829, 58795841⟩, ⟨5381666, 5381677⟩, ⟨(-1518784), (-1518771)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨755678020, 1133517032⟩, ⟨188919505, 188919506⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2374032516, 3561048781⟩, ⟨593508129, 593508133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1312240582, 2952541323⟩, ⟨656120290, 984180446⟩, ⟨82015036, 82015038⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨328, 740⟩, ⟨164, 247⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94359), (-93946)⟩, ⟨164, 247⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-64867), (-28703)⟩, ⟨(-21573), (-14181)⟩, ⟨(-1771), (-1721)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5048189, 5084354⟩, ⟨(-21573), (-14181)⟩, ⟨(-1771), (-1721)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1542372, 3495199⟩, ⟨756355, 1160735⟩, ⟨90236, 94398⟩, ⟨(-817), (-525)⟩, ⟨(-34), (-28)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141623205), (-139670377)⟩, ⟨756355, 1160735⟩, ⟨90236, 94398⟩, ⟨(-817), (-525)⟩, ⟨(-34), (-28)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-97357753), (-42673465)⟩, ⟨(-32221496), (-20538793)⟩, ⟨(-2561270), (-2336217)⟩, ⟨27665, 43637⟩, ⟨1511, 1715⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1334298012, 1388982301⟩, ⟨(-32221496), (-20538793)⟩, ⟨(-2561270), (-2336217)⟩, ⟨27665, 43637⟩, ⟨1511, 1715⟩⟩
...
def j70 : Jet := ⟨⟨(-75), (-32)⟩, ⟨(-25), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11760, 11804⟩, ⟨(-25), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3593, 8115⟩, ⟨1778, 2701⟩, ⟨215, 224⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848584), (-844061)⟩, ⟨1778, 2701⟩, ⟨215, 224⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-583353), (-257885)⟩, ⟨(-193908), (-127085)⟩, ⟨(-15869), (-15344)⟩, ⟨63, 104⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35208041, 35533510⟩, ⟨(-193908), (-127085)⟩, ⟨(-15869), (-15344)⟩, ⟨63, 104⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10757106, 24427231⟩, ⟨5245252, 8103583⟩, ⟨616975, 654433⟩, ⟨(-7321), (-4698)⟩, ⟨(-295), (-265)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705070777), (-691400651)⟩, ⟨5245252, 8103583⟩, ⟨616975, 654433⟩, ⟨(-7321), (-4698)⟩, ⟨(-295), (-265)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-484695334), (-211243515)⟩, ⟨(-159962532), (-100051012)⟩, ⟨(-12473966), (-10895919)⟩, ⟨189380, 303270⟩, ⟨9900, 11700⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3810271962, 4083723781⟩, ⟨(-159962532), (-100051012)⟩, ⟨(-12473966), (-10895919)⟩, ⟨189380, 303270⟩, ⟨9900, 11700⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨737529915, 1151634783⟩, ⟨157666950, 180586366⟩, ⟨(-6576193), (-4129529)⟩, ⟨(-338643), (-286653)⟩, ⟨4657, 7453⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4517138049, 4841319533⟩, ⟨110669637, 203247889⟩, ⟨14763724, 24382120⟩, ⟨297459, 1464485⟩, ⟨17713, 124069⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨775680980, 1298131415⟩, ⟨184826912, 258056364⟩, ⟨(-814867), 10740349⟩, ⟨(-99872), 1009966⟩, ⟨(-34502), 81665⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1133517032), (-755678020)⟩, ⟨(-188919506), (-188919505)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3161450264, 3539289276⟩, ⟨(-188919506), (-188919505)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨140089770, 392353435⟩, ⟨66760330, 155992376⟩, ⟨7461144, 21997342⟩, ⟨(-158294), 1901150⟩, ⟨(-34898), 197591⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4435057066, 4687320731⟩, ⟨66760330, 155992376⟩, ⟨7461144, 21997342⟩, ⟨(-158294), 1901150⟩, ⟨(-34898), 197591⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4364450143, 4486857391⟩, ⟨31952590, 76754475⟩, ⟨2914525, 10706607⟩, ⟨(-266177), 914105⟩, ⟨(-46380), 100932⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3212595371, 3697417269⟩, ⟨(-173840290), (-128725885)⟩, ⟨(-1230812), 7417360⟩, ⟨(-690289), 625074⟩, ⟨(-78429), 94883⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4484234809, 6726352229⟩, ⟨1121058702, 1121058709⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4681842825, 10534146407⟩, ⟨2340921412, 3511382150⟩, ⟨292615176, 292615181⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4681842825, 10534146407⟩, ⟨2340921412, 3511382150⟩, ⟨292615176, 292615181⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10534146407), (-4681842825)⟩, ⟨(-3511382150), (-2340921412)⟩, ⟨(-292615181), (-292615176)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5267073204), (-2340921412)⟩, ⟨(-1755691075), (-1170460706)⟩, ⟨(-146307591), (-146307588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1259995177, 2490306272⟩, ⟨(-1017984119), (-343372776)⟩, ⟨(-38044188), 165143508⟩, ⟨(-14704412), 28302230⟩, ⟨(-5705136), 2150699⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨942464608, 2143835048⟩, ⟨(-977150078), (-294603357)⟩, ⟨(-23173488), 187671422⟩, ⟨(-21501151), 26558607⟩, ⟨(-6316267), 2950472⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨944597526, 944597527⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4414925298, 4414925301⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar279 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified868
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar279 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨755678020, 1133517032⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4364450143, 4486857391⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified869
    (by decide +kernel) (by decide +kernel)
...
theorem whole_function_eq (t : ℝ) : f95 t =
    finiteNormalIntegrand 5 (265379 / 100000) ((center : ℝ) + (radius : ℝ) * t) := by
...
def upper : Rat := (131061109 / 4294967296)

theorem envelope_integral : (∫ s in ((35189 / 200000) : ℝ)..(105567 / 400000),
    finiteNormalIntegrand 5 (265379 / 100000) s) ≤ (upper : ℝ) := by
  have he : f95 = (fun t ↦ finiteNormalIntegrand 5 (265379 / 100000)
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (35189 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (105567 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((35189 / 200000) : ℝ)..(105567 / 400000), prawitzNormalCorrection
      ((265379 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
