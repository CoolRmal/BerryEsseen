...
namespace FiniteNormalPanel36_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (148981 / 400000)
def radius : Rat := (21283 / 400000)

def j0 : Jet := ⟨⟨1599671306, 1599671307⟩, ⟨228524472, 228524473⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5025515622, 5025515627⟩, ⟨717930802, 717930806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5880325861, 5880325874⟩, ⟨1680093100, 1680093112⟩, ⟨120006649, 120006652⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1471, 1474⟩, ⟨420, 421⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93216), (-93212)⟩, ⟨420, 421⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-127624), (-127618)⟩, ⟨(-35889), (-35885)⟩, ⟨(-2400), (-2396)⟩, ⟨22, 25⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4985432, 4985439⟩, ⟨(-35889), (-35885)⟩, ⟨(-2400), (-2396)⟩, ⟨22, 25⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6825654, 6825665⟩, ⟨1901050, 1901060⟩, ⟨121974, 121983⟩, ⟨(-1912), (-1904)⟩, ⟨(-60), (-54)⟩⟩
...
def j16 : Jet := ⟨⟨(-136339923), (-136339911)⟩, ⟨1901050, 1901060⟩, ⟨121974, 121983⟩, ⟨(-1912), (-1904)⟩, ⟨(-60), (-54)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-186665724), (-186665706)⟩, ⟨(-50730299), (-50730278)⟩, ⟨(-2898861), (-2898842)⟩, ⟨98212, 98229⟩, ⟨2577, 2592⟩⟩
...
def j19 : Jet := ⟨⟨1244990041, 1244990060⟩, ⟨(-50730299), (-50730278)⟩, ⟨(-2898861), (-2898842)⟩, ⟨98212, 98229⟩, ⟨2577, 2592⟩⟩
...
def j22 : Jet := ⟨⟨(-148), (-146)⟩, ⟨(-43), (-41)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11687, 11690⟩, ⟨(-43), (-41)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨16000, 16006⟩, ⟨4512, 4517⟩, ⟨303, 309⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-836177), (-836170)⟩, ⟨4512, 4517⟩, ⟨303, 309⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1144827), (-1144817)⟩, ⟨(-320917), (-320905)⟩, ⟨(-21186), (-21172)⟩, ⟨238, 247⟩, ⟨4, 9⟩⟩
...
def j30 : Jet := ⟨⟨34646567, 34646578⟩, ⟨(-320917), (-320905)⟩, ⟨(-21186), (-21172)⟩, ⟨238, 247⟩, ⟨4, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨47435309, 47435325⟩, ⟨13113571, 13113594⟩, ⟨813524, 813551⟩, ⟨(-16930), (-16909)⟩, ⟨(-494), (-481)⟩⟩
...
def j33 : Jet := ⟨⟨(-668392574), (-668392557)⟩, ⟨13113571, 13113594⟩, ⟨813524, 813551⟩, ⟨(-16930), (-16909)⟩, ⟨(-494), (-481)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-915109680), (-915109654)⟩, ⟨(-243505857), (-243505815)⟩, ⟨(-12432167), (-12432119)⟩, ⟨661461, 661503⟩, ⟨15430, 15460⟩⟩
...
def j36 : Jet := ⟨⟨3379857616, 3379857642⟩, ⟨(-243505857), (-243505815)⟩, ⟨(-12432167), (-12432119)⟩, ⟨661461, 661503⟩, ⟨15430, 15460⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1456755423, 1456755447⟩, ⟨148748696, 148748727⟩, ⟨(-11871829), (-11871802)⟩, ⟨(-369646), (-369621)⟩, ⟨19431, 19453⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5457846462, 5457846505⟩, ⟨393216960, 393217037⟩, ⟨48405354, 48405446⟩, ⟨3865582, 3865667⟩, ⟨354622, 354688⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1851177641, 1851177688⟩, ⟨322393253, 322393325⟩, ⟨14950206, 14950280⟩, ⟨1430919, 1430991⟩, ⟨111206, 111267⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1599671307), (-1599671306)⟩, ⟨(-228524473), (-228524472)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2695295989, 2695295990⟩, ⟨(-228524473), (-228524472)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨797877707, 797877748⟩, ⟨277910000, 277910070⟩, ⟨37087215, 37087293⟩, ⟨3477896, 3477974⟩, ⟨362717, 362787⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5092845003, 5092845044⟩, ⟨277910000, 277910070⟩, ⟨37087215, 37087293⟩, ⟨3477896, 3477974⟩, ⟨362717, 362787⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4676922356, 4676922376⟩, ⟨127606817, 127606851⟩, ⟨15288351, 15288389⟩, ⟨1179796, 1179836⟩, ⟨109367, 109403⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2934990931, 2934990946⟩, ⟨(-168768010), (-168767984)⟩, ⟨2804524, 2804552⟩, ⟨(-73079), (-73050)⟩, ⟨5855, 5883⟩⟩
...
def j47 : Jet := ⟨⟨6612401310, 6612401316⟩, ⟨944628757, 944628762⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10180252391, 10180252410⟩, ⟨2908643534, 2908643554⟩, ⟨207760252, 207760255⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10180252391, 10180252410⟩, ⟨2908643534, 2908643554⟩, ⟨207760252, 207760255⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10180252410), (-10180252391)⟩, ⟨(-2908643554), (-2908643534)⟩, ⟨(-207760255), (-207760252)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5090126205), (-5090126195)⟩, ⟨(-1454321777), (-1454321767)⟩, ⟨(-103880128), (-103880126)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1312989474, 1312989484⟩, ⟨(-444592256), (-444592249)⟩, ⟨43515249, 43515254⟩, ⟨2257170, 2257172⟩, ⟨(-717317), (-717315)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨897239008, 897239021⟩, ⟨(-355407799), (-355407782)⟩, ⟨48063719, 48063738⟩, ⟨(-480109), (-480091)⟩, ⟨(-541114), (-541096)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1371146834, 1828195780⟩, ⟨228524472, 228524473⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4307584820, 5743446432⟩, ⟨717930802, 717930806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4320239411, 7680425634⟩, ⟨1440079800, 1920106414⟩, ⟨120006649, 120006652⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1081, 1925⟩, ⟨360, 482⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93606), (-92761)⟩, ⟨360, 482⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-167390), (-93306)⟩, ⟨(-41486), (-30240)⟩, ⟨(-2466), (-2319)⟩, ⟨20, 28⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4945666, 5019751⟩, ⟨(-41486), (-30240)⟩, ⟨(-2466), (-2319)⟩, ⟨20, 28⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4974766, 8976512⟩, ⟨1584068, 2213711⟩, ⟨115230, 127787⟩, ⟨(-2243), (-1570)⟩, ⟨(-63), (-49)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138190811), (-134189064)⟩, ⟨1584068, 2213711⟩, ⟨115230, 127787⟩, ⟨(-2243), (-1570)⟩, ⟨(-63), (-49)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-247118121), (-134978648)⟩, ⟨(-60186143), (-41034238)⟩, ⟨(-3214184), (-2531231)⟩, ⟨78884, 117404⟩, ⟨2103, 2996⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1184537644, 1296677118⟩, ⟨(-60186143), (-41034238)⟩, ⟨(-3214184), (-2531231)⟩, ⟨78884, 117404⟩, ⟨2103, 2996⟩⟩
...
def j70 : Jet := ⟨⟨(-194), (-107)⟩, ⟨(-49), (-35)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11641, 11729⟩, ⟨(-49), (-35)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨11709, 20975⟩, ⟨3815, 5209⟩, ⟨295, 315⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-840468), (-831201)⟩, ⟨3815, 5209⟩, ⟨295, 315⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1502958), (-836091)⟩, ⟨(-371903), (-269382)⟩, ⟨(-21909), (-20331)⟩, ⟨196, 287⟩, ⟨4, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34288436, 34955304⟩, ⟨(-371903), (-269382)⟩, ⟨(-21909), (-20331)⟩, ⟨196, 287⟩, ⟨4, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨34490193, 62508419⟩, ⟨10831679, 15356138⟩, ⟨752618, 865923⟩, ⟨(-19990), (-13828)⟩, ⟨(-544), (-422)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-681337690), (-653319463)⟩, ⟨10831679, 15356138⟩, ⟨752618, 865923⟩, ⟨(-19990), (-13828)⟩, ⟨(-544), (-422)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1218394251), (-657163674)⟩, ⟨(-293703151), (-191594120)⟩, ⟨(-14648561), (-9840959)⟩, ⟨519251, 802281⟩, ⟨11119, 19135⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3076573045, 3637803622⟩, ⟨(-293703151), (-191594120)⟩, ⟨(-14648561), (-9840959)⟩, ⟨519251, 802281⟩, ⟨11119, 19135⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1188017515, 1733981904⟩, ⟨117518978, 175592953⟩, ⟨(-14358662), (-9397798)⟩, ⟨(-458157), (-266112)⟩, ⟨15294, 23632⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5070846585, 5995873917⟩, ⟨267068948, 572392412⟩, ⟨27783475, 83191388⟩, ⟨863428, 9811327⟩, ⟨(-43918), 1269336⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1402631066, 2420678938⟩, ⟨212621711, 476220459⟩, ⟨(-5052381), 45892236⟩, ⟨(-1554143), 6463663⟩, ⟨(-315230), 869235⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1828195780), (-1371146834)⟩, ⟨(-228524473), (-228524472)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2466771516, 2923820462⟩, ⟨(-228524473), (-228524472)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨458064933, 1364314585⟩, ⟨138874080, 536803546⟩, ⟨4830677, 104533200⟩, ⟨(-2872260), 17462894⟩, ⟨(-753964), 2903548⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4753032229, 5659281881⟩, ⟨138874080, 536803546⟩, ⟨4830677, 104533200⟩, ⟨(-2872260), 17462894⟩, ⟨(-753964), 2903548⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4518198532, 4930155231⟩, ⟨60490958, 255140811⟩, ⟨(-4907845), 49279323⟩, ⟨(-4147959), 8577196⟩, ⟨(-1111449), 1641045⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2594982144, 3356227825⟩, ⟨(-227578860), (-66713664)⟩, ⟨(-16916446), 30328574⟩, ⟨(-5445774), 6100105⟩, ⟨(-1212997), 1337853⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5667772552, 7557030077⟩, ⟨944628757, 944628762⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7479369105, 13296656214⟩, ⟨2493123030, 3324164062⟩, ⟨207760252, 207760255⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7479369105, 13296656214⟩, ⟨2493123030, 3324164062⟩, ⟨207760252, 207760255⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13296656214), (-7479369105)⟩, ⟨(-3324164062), (-2493123030)⟩, ⟨(-207760255), (-207760252)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6648328107), (-3739684552)⟩, ⟨(-1662082031), (-1246561515)⟩, ⟨(-103880128), (-103880126)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨913482942, 1798100415⟩, ⟨(-695835425), (-265127206)⟩, ⟨(-5014757), 112544526⟩, ⟨(-10242635), 11866749⟩, ⟨(-2509088), 1051578⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨551918503, 1405094435⟩, ⟨(-639025090), (-174376684)⟩, ⟨(-6882598), 137513580⟩, ⟨(-21160842), 14833277⟩, ⟨(-4528863), 3601570⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1599671306, 1599671307⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4676922356, 4676922376⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified712
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1371146834, 1828195780⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4518198532, 4930155231⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified713
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (24315311 / 1073741824)

theorem envelope_integral : (∫ s in ((63849 / 200000) : ℝ)..(21283 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((63849 / 200000) : ℝ)..(21283 / 50000), prawitzNormalCorrection
