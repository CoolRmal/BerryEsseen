...
namespace FiniteNormalPanel126_18
...
def j2 : Jet := ⟨⟨1449051050, 1449051054⟩, ⟨483017014, 483017018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨488885898, 488885902⟩, ⟨325923930, 325923936⟩, ⟨54320654, 54320656⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-10765), (-10763)⟩, ⟨(-7168), (-7165)⟩, ⟨(-1190), (-1186)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102291, 5102294⟩, ⟨(-7168), (-7165)⟩, ⟨(-1190), (-1186)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨580781, 580782⟩, ⟨386371, 386373⟩, ⟨63851, 63855⟩, ⟨(-182), (-178)⟩, ⟨(-16), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-142584796), (-142584794)⟩, ⟨386371, 386373⟩, ⟨63851, 63855⟩, ⟨(-182), (-178)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16230088), (-16230087)⟩, ⟨(-10776080), (-10776078)⟩, ⟨(-1766757), (-1766754)⟩, ⟨9710, 9713⟩, ⟨791, 794⟩⟩
...
def j19 : Jet := ⟨⟨1415425677, 1415425679⟩, ⟨(-10776080), (-10776078)⟩, ⟨(-1766757), (-1766754)⟩, ⟨9710, 9713⟩, ⟨791, 794⟩⟩
...
def j25 : Jet := ⟨⟨1345, 1346⟩, ⟨895, 898⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850832), (-850830)⟩, ⟨895, 898⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-96849), (-96847)⟩, ⟨(-64465), (-64462)⟩, ⟨(-10678), (-10673)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35694545, 35694548⟩, ⟨(-64465), (-64462)⟩, ⟨(-10678), (-10673)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4063025, 4063026⟩, ⟨2701345, 2701347⟩, ⟨445339, 445343⟩, ⟨(-1625), (-1621)⟩, ⟨(-136), (-131)⟩⟩
...
def j33 : Jet := ⟨⟨(-711764858), (-711764856)⟩, ⟨2701345, 2701347⟩, ⟨445339, 445343⟩, ⟨(-1625), (-1621)⟩, ⟨(-136), (-131)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-81018500), (-81018498)⟩, ⟨(-53704847), (-53704843)⟩, ⟨(-8746374), (-8746370)⟩, ⟨67774, 67777⟩, ⟨5492, 5496⟩⟩
...
def j36 : Jet := ⟨⟨4213948796, 4213948798⟩, ⟨(-53704847), (-53704843)⟩, ⟨(-8746374), (-8746370)⟩, ⟨67774, 67777⟩, ⟨5492, 5496⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨477541252, 477541255⟩, ⟨155544744, 155544749⟩, ⟨(-1807966), (-1807963)⟩, ⟨(-195417), (-195413)⟩, ⟨1357, 1361⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4377543477, 4377543480⟩, ⟨55789781, 55789787⟩, ⟨9796937, 9796944⟩, ⟨170243, 170250⟩, ⟨15894, 15903⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨486722586, 486722591⟩, ⟨164738343, 164738351⟩, ⟨1267016, 1267023⟩, ⟨151069, 151079⟩, ⟨2651, 2661⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-461247276), (-461247275)⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3833720020, 3833720021⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨55157317, 55157319⟩, ⟨37337592, 37337598⟩, ⟨6605892, 6605897⟩, ⟨131432, 131440⟩, ⟨12561, 12568⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4350124613, 4350124615⟩, ⟨37337592, 37337598⟩, ⟨6605892, 6605897⟩, ⟨131432, 131440⟩, ⟨12561, 12568⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4322457975, 4322457977⟩, ⟨18550063, 18550067⟩, ⟨3242134, 3242138⟩, ⟨51384, 51390⟩, ⟨4803, 4809⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3858258406, 3858258410⟩, ⟨(-138175265), (-138175259)⟩, ⟨2229906, 2229912⟩, ⟨(-70196), (-70188)⟩, ⟨2447, 2454⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨36960708550, 36960708557⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value535

def j47 : Jet := ⟨⟨3969302890, 3969302900⟩, ⟨1323100957, 1323100967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3668331874, 3668331894⟩, ⟨2445554570, 2445554598⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3668331874, 3668331894⟩, ⟨2445554570, 2445554598⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3668331894), (-3668331874)⟩, ⟨(-2445554598), (-2445554570)⟩, ⟨(-407592433), (-407592426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1834165947), (-1834165937)⟩, ⟨(-1222777299), (-1222777285)⟩, ⟨(-203796217), (-203796213)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2802169397, 2802169408⟩, ⟨(-797777703), (-797777689)⟩, ⟨(-19399289), (-19399281)⟩, ⟨27077361, 27077364⟩, ⟨(-1466984), (-1466983)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2517247020, 2517247034⟩, ⟨(-806810110), (-806810091)⟩, ⟨9693726, 9693742⟩, ⟨24488259, 24488272⟩, ⟨(-2184380), (-2184368)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨307498183, 614996368⟩, ⟨153749091, 153749092⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨966034032, 1932068072⟩, ⟨483017014, 483017018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨217282620, 869130492⟩, ⟨217282620, 434565246⟩, ⟨54320654, 54320656⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-19150), (-4779)⟩, ⟨(-9573), (-4756)⟩, ⟨(-1195), (-1179)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5093906, 5108278⟩, ⟨(-9573), (-4756)⟩, ⟨(-1195), (-1179)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨257700, 1033713⟩, ⟨255762, 516617⟩, ⟨63214, 64309⟩, ⟨(-243), (-118)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142907877), (-142131863)⟩, ⟨255762, 516617⟩, ⟨63214, 64309⟩, ⟨(-243), (-118)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-28918869), (-7190458)⟩, ⟨(-14446496), (-7085915)⟩, ⟨(-1791294), (-1732328)⟩, ⟨6381, 13036⟩, ⟨770, 809⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1402736896, 1424465308⟩, ⟨(-14446496), (-7085915)⟩, ⟨(-1791294), (-1732328)⟩, ⟨6381, 13036⟩, ⟨770, 809⟩⟩
...
def j72 : Jet := ⟨⟨597, 2395⟩, ⟨594, 1198⟩, ⟨146, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851580), (-849781)⟩, ⟨594, 1198⟩, ⟨146, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-172326), (-42990)⟩, ⟨(-86133), (-42747)⟩, ⟨(-10734), (-10594)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35619068, 35748405⟩, ⟨(-86133), (-42747)⟩, ⟨(-10734), (-10594)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1801970, 7234055⟩, ⟨1784540, 3614866⟩, ⟨439604, 449432⟩, ⟨(-2177), (-1068)⟩, ⟨(-137), (-128)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714025913), (-708593827)⟩, ⟨1784540, 3614866⟩, ⟨439604, 449432⟩, ⟨(-2177), (-1068)⟩, ⟨(-137), (-128)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-144490436), (-35847798)⟩, ⟨(-72154939), (-35116292)⟩, ⟨(-8918135), (-8505248)⟩, ⟨44367, 91140⟩, ⟨5310, 5625⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4150476860, 4259119498⟩, ⟨(-72154939), (-35116292)⟩, ⟨(-8918135), (-8505248)⟩, ⟨44367, 91140⟩, ⟨5310, 5625⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨315506844, 640788102⟩, ⟨151254742, 158603246⟩, ⟨(-2430475), (-1186529)⟩, ⟨(-200017), (-188954)⟩, ⟨890, 1831⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4331116814, 4444487874⟩, ⟨35709906, 77266243⟩, ⟨8943449, 10893131⟩, ⟨49940, 309100⟩, ⟨10746, 22860⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨318162375, 663095841⟩, ⟨155151047, 175652443⟩, ⟨(-600520), 3281952⟩, ⟨67921, 247967⟩, ⟨(-6320), 12680⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-614996368), (-307498183)⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3679970928, 3987469113⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨23568816, 102374725⟩, ⟨22986542, 54237622⟩, ⟨5419235, 8197102⟩, ⟨(-39058), 345014⟩, ⟨2495, 26708⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4318536112, 4397342021⟩, ⟨22986542, 54237622⟩, ⟨5419235, 8197102⟩, ⟨(-39058), 345014⟩, ⟨2495, 26708⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306735581, 4345853216⟩, ⟨11358695, 27044709⟩, ⟨2593738, 4072374⟩, ⟨(-45050), 165196⟩, ⟨(-1720), 12820⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3690054112, 4034711856⟩, ⟨(-145838438), (-129061922)⟩, ⟨1254207, 3374201⟩, ⟨(-187606), 60520⟩, ⟨(-7511), 13516⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2646201923, 5292403866⟩, ⟨1323100957, 1323100967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1630369717, 6521478920⟩, ⟨1630369712, 3260739462⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1630369717, 6521478920⟩, ⟨1630369712, 3260739462⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6521478920), (-1630369717)⟩, ⟨(-3260739462), (-1630369712)⟩, ⟨(-407592433), (-407592426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3260739460), (-815184858)⟩, ⟨(-1630369731), (-815184856)⟩, ⟨(-203796217), (-203796213)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2010219401, 3552472806⟩, ⟨(-1348518798), (-381539671)⟩, ⟨(-132356733), 160563974⟩, ⟨(-8247325), 59405689⟩, ⟨(-9446982), 3922836⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1727095424, 3337209148⟩, ⟨(-1387431256), (-388208965)⟩, ⟨(-112284397), 199415258⟩, ⟨(-14414225), 60238878⟩, ⟨(-11020895), 4161401⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4322457975, 4322457977⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar535 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2544
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar535 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306735581, 4345853216⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2545
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((14319 / 200000) : ℝ)..(14319 / 100000), prawitzNormalCorrection
      ((59669 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
