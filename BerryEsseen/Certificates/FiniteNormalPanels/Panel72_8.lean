...
namespace FiniteNormalPanel72_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (4239 / 20000)
def radius : Rat := (4239 / 100000)

def j0 : Jet := ⟨⟨910318318, 910318319⟩, ⟨182063663, 182063664⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2859849340, 2859849344⟩, ⟨571969866, 571969870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1904260890, 1904260896⟩, ⟨761704352, 761704360⟩, ⟨76170435, 76170437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨476, 478⟩, ⟨190, 191⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94211), (-94208)⟩, ⟨190, 191⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-41771), (-41769)⟩, ⟨(-16625), (-16622)⟩, ⟨(-1630), (-1627)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5071285, 5071288⟩, ⟨(-16625), (-16622)⟩, ⟨(-1630), (-1627)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2248457, 2248459⟩, ⟨892010, 892015⟩, ⟨86266, 86271⟩, ⟨(-583), (-578)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-140917120), (-140917117)⟩, ⟨892010, 892015⟩, ⟨86266, 86271⟩, ⟨(-583), (-578)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-62478465), (-62478462)⟩, ⟨(-24595896), (-24595892)⟩, ⟨(-2302696), (-2302690)⟩, ⟨30859, 30864⟩, ⟨1412, 1417⟩⟩
...
def j19 : Jet := ⟨⟨1369177300, 1369177304⟩, ⟨(-24595896), (-24595892)⟩, ⟨(-2302696), (-2302690)⟩, ⟨30859, 30864⟩, ⟨1412, 1417⟩⟩
...
def j22 : Jet := ⟨⟨(-48), (-47)⟩, ⟨(-20), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11787, 11789⟩, ⟨(-20), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5226, 5227⟩, ⟨2081, 2084⟩, ⟨204, 207⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846951), (-846949)⟩, ⟨2081, 2084⟩, ⟨204, 207⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-375513), (-375512)⟩, ⟨(-149284), (-149280)⟩, ⟨(-14562), (-14558)⟩, ⟨71, 74⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35415881, 35415883⟩, ⟨(-149284), (-149280)⟩, ⟨(-14562), (-14558)⟩, ⟨71, 74⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15702349, 15702351⟩, ⟨6214750, 6214755⟩, ⟨595160, 595167⟩, ⟨(-5200), (-5195)⟩, ⟨(-247), (-242)⟩⟩
...
def j33 : Jet := ⟨⟨(-700125534), (-700125531)⟩, ⟨6214750, 6214755⟩, ⟨595160, 595167⟩, ⟨(-5200), (-5195)⟩, ⟨(-247), (-242)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-310414862), (-310414858)⟩, ⟨(-121410510), (-121410504)⟩, ⟨(-11050545), (-11050538)⟩, ⟨213461, 213467⟩, ⟨9522, 9528⟩⟩
...
def j36 : Jet := ⟨⟨3984552434, 3984552438⟩, ⟨(-121410510), (-121410504)⟩, ⟨(-11050545), (-11050538)⟩, ⟨213461, 213467⟩, ⟨9522, 9528⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨911681167, 911681172⟩, ⟨165958794, 165958801⟩, ⟨(-4808763), (-4808756)⟩, ⟨(-286108), (-286102)⟩, ⟨5049, 5055⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4629564891, 4629564896⟩, ⟨141064225, 141064235⟩, ⟨17137647, 17137660⟩, ⟨665384, 665395⟩, ⟨49172, 49186⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨982705299, 982705306⟩, ⟨208831066, 208831078⟩, ⟨3905136, 3905150⟩, ⟨337104, 337118⟩, ⟨13004, 13019⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-910318319), (-910318318)⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3384648977, 3384648978⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨224846812, 224846816⟩, ⟨95562726, 95562734⟩, ⟨11940860, 11940870⟩, ⟨534012, 534024⟩, ⟨42280, 42293⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4519814108, 4519814112⟩, ⟨95562726, 95562734⟩, ⟨11940860, 11940870⟩, ⟨534012, 534024⟩, ⟨42280, 42293⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4405956624, 4405956627⟩, ⟨46577714, 46577719⟩, ⟨5573831, 5573837⟩, ⟨201355, 201363⟩, ⟨14952, 14961⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3472114116, 3472114121⟩, ⟨(-150062935), (-150062928)⟩, ⟨2418027, 2418034⟩, ⟨(-77598), (-77589)⟩, ⟨3246, 3256⟩⟩
...
def j47 : Jet := ⟨⟨5693974174, 5693974182⟩, ⟨1138794831, 1138794838⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7548681901, 7548681923⟩, ⟨3019472750, 3019472774⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7548681901, 7548681923⟩, ⟨3019472750, 3019472774⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7548681923), (-7548681901)⟩, ⟨(-3019472774), (-3019472750)⟩, ⟨(-301947278), (-301947274)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3774340962), (-3774340950)⟩, ⟨(-1509736387), (-1509736375)⟩, ⟨(-150973639), (-150973637)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1783649779, 1783649794⟩, ⟨(-626975903), (-626975892)⟩, ⟨47497463, 47497469⟩, ⟨9127349, 9127352⟩, ⟨(-1636895), (-1636893)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1441928459, 1441928474⟩, ⟨(-569175839), (-569175824)⟩, ⟨61307884, 61307896⟩, ⟨5333946, 5333958⟩, ⟨(-1602779), (-1602768)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨728254654, 1092381983⟩, ⟨182063663, 182063664⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2287879470, 3431819213⟩, ⟨571969866, 571969870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1218726967, 2742135691⟩, ⟨609363482, 914045232⟩, ⟨76170435, 76170437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨305, 687⟩, ⟨152, 229⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94382), (-93999)⟩, ⟨152, 229⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-60259), (-26672)⟩, ⟨(-20044), (-13189)⟩, ⟨(-1648), (-1605)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5052797, 5086385⟩, ⟨(-20044), (-13189)⟩, ⟨(-1648), (-1605)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1433766, 3247419⟩, ⟨704085, 1078731⟩, ⟨84291, 87881⟩, ⟨(-706), (-453)⟩, ⟨(-30), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141731811), (-139918157)⟩, ⟨704085, 1078731⟩, ⟨84291, 87881⟩, ⟨(-706), (-453)⟩, ⟨(-30), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-90489131), (-39702754)⟩, ⟨(-29963255), (-19162657)⟩, ⟨(-2389776), (-2195740)⟩, ⟨23994, 37707⟩, ⟨1323, 1489⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1341166634, 1391953012⟩, ⟨(-29963255), (-19162657)⟩, ⟨(-2389776), (-2195740)⟩, ⟨23994, 37707⟩, ⟨1323, 1489⟩⟩
...
def j72 : Jet := ⟨⟨3338, 7538⟩, ⟨1654, 2509⟩, ⟨201, 208⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848839), (-844638)⟩, ⟨1654, 2509⟩, ⟨201, 208⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-541944), (-239671)⟩, ⟨(-180179), (-118233)⟩, ⟨(-14763), (-14312)⟩, ⟨55, 90⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35249450, 35551724⟩, ⟨(-180179), (-118233)⟩, ⟨(-14763), (-14312)⟩, ⟨55, 90⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10002277, 22698113⟩, ⟨4886102, 7532489⟩, ⟨577370, 609669⟩, ⟨(-6323), (-4068)⟩, ⟨(-255), (-230)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705825606), (-693129769)⟩, ⟨4886102, 7532489⟩, ⟨577370, 609669⟩, ⟨(-6323), (-4068)⟩, ⟨(-255), (-230)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-450636630), (-196680412)⟩, ⟨(-148825746), (-93531064)⟩, ⟨(-11660621), (-10300231)⟩, ⟨164533, 262183⟩, ⟨8730, 10171⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3844330666, 4098286884⟩, ⟨(-148825746), (-93531064)⟩, ⟨(-11660621), (-10300231)⟩, ⟨164533, 262183⟩, ⟨8730, 10171⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨714423974, 1112215941⟩, ⟨154664373, 175161598⟩, ⟨(-5899780), (-3721576)⟩, ⟨(-305471), (-262281)⟩, ⟨3899, 6212⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4501086574, 4798428043⟩, ⟨102723754, 185761762⟩, ⟨13656947, 21745993⟩, ⟨262879, 1212666⟩, ⟨16528, 98291⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨748709812, 1242591106⟩, ⟨179173901, 243798718⟩, ⟨(-620522), 9307041⟩, ⟨(-60930), 837020⟩, ⟨(-26783), 63746⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1092381983), (-728254654)⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3202585313, 3566712642⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨130517031, 359498118⟩, ⟨62468116, 141068418⟩, ⟨7115576, 19224247⟩, ⟨(-105704), 1540932⟩, ⟨(-23761), 152081⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4425484327, 4654465414⟩, ⟨62468116, 141068418⟩, ⟨7115576, 19224247⟩, ⟨(-105704), 1540932⟩, ⟨(-23761), 152081⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4359737429, 4471104644⟩, ⟨30003604, 69486323⟩, ⟨2877679, 9366081⟩, ⟨(-201346), 739217⟩, ⟨(-33548), 77171⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3250881810, 3712984142⟩, ⟨(-167157640), (-127105045)⟩, ⟨(-799756), 6506117⟩, ⟨(-564235), 491892⟩, ⟨(-59196), 72622⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4555179337, 6832769020⟩, ⟨1138794831, 1138794838⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4831156412, 10870101974⟩, ⟨2415578198, 3623367330⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4831156412, 10870101974⟩, ⟨2415578198, 3623367330⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10870101974), (-4831156412)⟩, ⟨(-3623367330), (-2415578198)⟩, ⟨(-301947278), (-301947274)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5435050987), (-2415578206)⟩, ⟨(-1811683665), (-1207789099)⟩, ⟨(-150973639), (-150973637)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1211667506, 2447392849⟩, ⟨(-1032348175), (-340733398)⟩, ⟨(-38120143), 175138543⟩, ⟨(-16640571), 29552136⟩, ⟨(-6194561), 2424799⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨917117077, 2115762522⟩, ⟨(-987712485), (-293760805)⟩, ⟨(-23326808), 195292418⟩, ⟨(-23087350), 27503858⟩, ⟨(-6715041), 3186181⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨910318318, 910318319⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4405956624, 4405956627⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1440
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨728254654, 1092381983⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4359737429, 4471104644⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1441
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (124033283 / 4294967296)

theorem envelope_integral : (∫ s in ((4239 / 25000) : ℝ)..(12717 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((4239 / 25000) : ℝ)..(12717 / 50000), prawitzNormalCorrection
