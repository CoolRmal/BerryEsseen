...
namespace FiniteNormalPanel1_18
...
def j2 : Jet := ⟨⟨6324861423, 6324861425⟩, ⟨421657428, 421657429⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨9314127271, 9314127277⟩, ⟨1241883634, 1241883640⟩, ⟨41396121, 41396122⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨2331, 2334⟩, ⟨310, 312⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-92356), (-92352)⟩, ⟨310, 312⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-200285), (-200275)⟩, ⟨(-26033), (-26026)⟩, ⟨(-781), (-775)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4912771, 4912782⟩, ⟨(-26033), (-26026)⟩, ⟨(-781), (-775)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨10653905, 10653930⟩, ⟨1364064, 1364084⟩, ⟨38128, 38146⟩, ⟨(-469), (-456)⟩, ⟨(-7), (-1)⟩⟩
...
def j16 : Jet := ⟨⟨(-132511672), (-132511646)⟩, ⟨1364064, 1364084⟩, ⟨38128, 38146⟩, ⟨(-469), (-456)⟩, ⟨(-7), (-1)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-287366701), (-287366643)⟩, ⟨(-35357433), (-35357380)⟩, ⟨(-800085), (-800038)⟩, ⟨23153, 23190⟩, ⟨215, 235⟩⟩
...
def j19 : Jet := ⟨⟨1144289064, 1144289123⟩, ⟨(-35357433), (-35357380)⟩, ⟨(-800085), (-800038)⟩, ⟨23153, 23190⟩, ⟨215, 235⟩⟩
...
def j22 : Jet := ⟨⟨(-235), (-232)⟩, ⟨(-32), (-30)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11600, 11604⟩, ⟨(-32), (-30)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨25155, 25165⟩, ⟨3284, 3291⟩, ⟨96, 102⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-827022), (-827011)⟩, ⟨3284, 3291⟩, ⟨96, 102⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1793492), (-1793467)⟩, ⟨(-232012), (-231992)⟩, ⟨(-6815), (-6796)⟩, ⟨53, 62⟩, ⟨(-4), 1⟩⟩
...
def j30 : Jet := ⟨⟨33997902, 33997928⟩, ⟨(-232012), (-231992)⟩, ⟨(-6815), (-6796)⟩, ⟨53, 62⟩, ⟨(-4), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨73728334, 73728392⟩, ⟨9327299, 9327352⟩, ⟨245815, 245865⟩, ⟨(-4094), (-4066)⟩, ⟨(-60), (-44)⟩⟩
...
def j33 : Jet := ⟨⟨(-642099549), (-642099490)⟩, ⟨9327299, 9327352⟩, ⟨245815, 245865⟩, ⟨(-4094), (-4066)⟩, ⟨(-60), (-44)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-1392466232), (-1392466102)⟩, ⟨(-165434852), (-165434717)⟩, ⟨(-2958687), (-2958560)⟩, ⟨152097, 152175⟩, ⟨1054, 1100⟩⟩
...
def j36 : Jet := ⟨⟨2902501064, 2902501194⟩, ⟨(-165434852), (-165434717)⟩, ⟨(-2958687), (-2958560)⟩, ⟨152097, 152175⟩, ⟨1054, 1100⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1685104742, 1685104830⟩, ⟨60272197, 60272284⟩, ⟨(-4649431), (-4649355)⟩, ⟨(-44454), (-44392)⟩, ⟨2589, 2624⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨6355464766, 6355465052⟩, ⟨362244300, 362244631⟩, ⟨27125158, 27125477⟩, ⟨1582089, 1582300⟩, ⟨96420, 96551⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨2493528606, 2493528849⟩, ⟨231311984, 231312256⟩, ⟨8845862, 8846116⟩, ⟨543454, 543644⟩, ⟨30746, 30863⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-2013265920), (-2013265920)⟩, ⟨(-134217728), (-134217728)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2281701376, 2281701376⟩, ⟨(-134217728), (-134217728)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨1447667579, 1447667862⟩, ⟨268585536, 268585880⟩, ⟨22728938, 22729266⟩, ⟨1583840, 1584092⟩, ⟨112454, 112616⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5742634875, 5742635158⟩, ⟨268585536, 268585880⟩, ⟨22728938, 22729266⟩, ⟨1583840, 1584092⟩, ⟨112454, 112616⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4966329528, 4966329651⟩, ⟨116138695, 116138848⟩, ⟨8470220, 8470367⟩, ⟨486783, 486898⟩, ⟨30015, 30091⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2638362561, 2638362628⟩, ⟨(-93499121), (-93499034)⟩, ⟨870465, 870549⟩, ⟨(-6096), (-6029)⟩, ⟨729, 775⟩⟩
...
def j47 : Jet := ⟨⟨5654599591, 5654599592⟩, ⟨376973306, 376973307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7444642608, 7444642612⟩, ⟨992619014, 992619018⟩, ⟨33087300, 33087301⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7444642608, 7444642612⟩, ⟨992619014, 992619018⟩, ⟨33087300, 33087301⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7444642612), (-7444642608)⟩, ⟨(-992619018), (-992619014)⟩, ⟨(-33087301), (-33087300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3722321306), (-3722321304)⟩, ⟨(-496309509), (-496309507)⟩, ⟨(-16543651), (-16543650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1805384290, 1805384302⟩, ⟨(-208623102), (-208623098)⟩, ⟨5099727, 5099730⟩, ⟨339290, 339292⟩, ⟨(-19624), (-19623)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1109032500, 1109032536⟩, ⟨(-167457677), (-167457632)⟩, ⟨8040225, 8040270⟩, ⟨52555, 52592⟩, ⟨(-17811), (-17783)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1879048192, 2147483648⟩, ⟨134217728, 134217728⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨5903203995, 6746518853⟩, ⟨421657428, 421657429⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨8113639756, 10597407035⟩, ⟨1159091392, 1324675882⟩, ⟨41396121, 41396122⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨2030, 2655⟩, ⟨290, 332⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-92657), (-92031)⟩, ⟨290, 332⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-228622), (-173856)⟩, ⟨(-28031), (-24016)⟩, ⟨(-798), (-756)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4884434, 4939201⟩, ⟨(-28031), (-24016)⟩, ⟨(-798), (-756)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨9227203, 12186990⟩, ⟨1249007, 1478006⟩, ⟨36462, 39697⟩, ⟨(-511), (-415)⟩, ⟨(-7), (-1)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-133938374), (-130978586)⟩, ⟨1249007, 1478006⟩, ⟨36462, 39697⟩, ⟨(-511), (-415)⟩, ⟨(-7), (-1)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-330479692), (-247432166)⟩, ⟨(-38950458), (-31700618)⟩, ⟨(-884985), (-708605)⟩, ⟨20617, 25707⟩, ⟨175, 271⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1101176073, 1184223600⟩, ⟨(-38950458), (-31700618)⟩, ⟨(-884985), (-708605)⟩, ⟨20617, 25707⟩, ⟨175, 271⟩⟩
...
def j70 : Jet := ⟨⟨(-267), (-202)⟩, ⟨(-34), (-28)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11568, 11634⟩, ⟨(-34), (-28)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨21853, 28706⟩, ⟨3037, 3537⟩, ⟨95, 105⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-830324), (-823470)⟩, ⟨3037, 3537⟩, ⟨95, 105⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-2048743), (-1555620)⟩, ⟨(-250356), (-213503)⟩, ⟨(-7005), (-6585)⟩, ⟨49, 68⟩, ⟨(-4), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨33742651, 34235775⟩, ⟨(-250356), (-213503)⟩, ⟨(-7005), (-6585)⟩, ⟨49, 68⟩, ⟨(-4), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨63743375, 84473389⟩, ⟨8488467, 10155845⟩, ⟨230719, 259918⟩, ⟨(-4483), (-3666)⟩, ⟨(-65), (-37)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-652084508), (-631354493)⟩, ⟨8488467, 10155845⟩, ⟨230719, 259918⟩, ⟨(-4483), (-3666)⟩, ⟨(-65), (-37)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1608954033), (-1192694277)⟩, ⟨(-185083659), (-145326352)⟩, ⟨(-3558326), (-2311534)⟩, ⟨133016, 171126⟩, ⟨679, 1448⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨2686013263, 3102273019⟩, ⟨(-185083659), (-145326352)⟩, ⟨(-3558326), (-2311534)⟩, ⟨133016, 171126⟩, ⟨679, 1448⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1513507914, 1860174082⟩, ⟨46924471, 72690069⟩, ⟨(-5214085), (-4086139)⟩, ⟨(-58548), (-29186)⟩, ⟨2264, 2950⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5946202658, 6867704017⟩, ⟨278550576, 473229156⟩, ⟨17479308, 41706613⟩, ⟨647536, 3206307⟩, ⟨14045, 260892⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨2095388430, 2974440581⟩, ⟨163123690, 321190453⟩, ⟨865457, 20415433⟩, ⟨(-248965), 1789121⟩, ⟨(-41926), 153457⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-2147483648), (-1879048192)⟩, ⟨(-134217728), (-134217728)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2147483648, 2415919104⟩, ⟨(-134217728), (-134217728)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨1022278487, 2059921802⟩, ⟨159166516, 444875062⟩, ⟨7039931, 52296626⟩, ⟨(-279098), 5531534⟩, ⟨(-95136), 577186⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨5317245783, 6354889098⟩, ⟨159166516, 444875062⟩, ⟨7039931, 52296626⟩, ⟨(-279098), 5531534⟩, ⟨(-95136), 577186⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4778848893, 5224369900⟩, ⟨65425591, 199914654⟩, ⟨(-1017986), 23052811⟩, ⟨(-1089794), 2528306⟩, ⟨(-204123), 307417⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2389424446, 2938708069⟩, ⟨(-130548765), (-36887034)⟩, ⟨(-6819951), 10922658⟩, ⟨(-1333411), 1453986⟩, ⟨(-193830), 206980⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5277626285, 6031572898⟩, ⟨376973306, 376973307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6485110894, 8470348927⟩, ⟨926444412, 1058793620⟩, ⟨33087300, 33087301⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6485110894, 8470348927⟩, ⟨926444412, 1058793620⟩, ⟨33087300, 33087301⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8470348927), (-6485110894)⟩, ⟨(-1058793620), (-926444412)⟩, ⟨(-33087301), (-33087300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4235174464), (-3242555447)⟩, ⟨(-529396810), (-463222206)⟩, ⟨(-16543651), (-16543650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1602180547, 2018748311⟩, ⟨(-248830514), (-172798896)⟩, ⟨1542427, 9164011⟩, ⟨67214, 583524⟩, ⟨(-35631), (-4782)⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨891343077, 1381270576⟩, ⟨(-231616511), (-109893640)⟩, ⟨(-863387), 18967542⟩, ⟨(-1500703), 1464542⟩, ⟨(-232013), 194608⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4966329528, 4966329651⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified18
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4778848893, 5224369900⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified19
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (8685559 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((7 / 16) : ℝ)..(1 / 2), prawitzNormalCorrection
