...
namespace FiniteNormalPanel105_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (537 / 5000)
def radius : Rat := (179 / 5000)

def j0 : Jet := ⟨⟨461279487, 461279488⟩, ⟨153759829, 153759830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1449152247, 1449152251⟩, ⟨483050749, 483050753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨488954185, 488954188⟩, ⟨325969456, 325969462⟩, ⟨54328242, 54328244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-10766), (-10765)⟩, ⟨(-7169), (-7166)⟩, ⟨(-1190), (-1187)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102290, 5102292⟩, ⟨(-7169), (-7166)⟩, ⟨(-1190), (-1187)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨580862, 580863⟩, ⟨386424, 386427⟩, ⟨63859, 63863⟩, ⟨(-182), (-179)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-142584715), (-142584713)⟩, ⟨386424, 386427⟩, ⟨63859, 63863⟩, ⟨(-182), (-179)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16232346), (-16232345)⟩, ⟨(-10777573), (-10777570)⟩, ⟨(-1766998), (-1766993)⟩, ⟨9712, 9716⟩, ⟨791, 794⟩⟩
...
def j19 : Jet := ⟨⟨1415423419, 1415423421⟩, ⟨(-10777573), (-10777570)⟩, ⟨(-1766998), (-1766993)⟩, ⟨9712, 9716⟩, ⟨791, 794⟩⟩
...
def j25 : Jet := ⟨⟨1345, 1347⟩, ⟨895, 898⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850832), (-850829)⟩, ⟨895, 898⟩, ⟨147, 150⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-96862), (-96861)⟩, ⟨(-64474), (-64471)⟩, ⟨(-10680), (-10675)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35694532, 35694534⟩, ⟨(-64474), (-64471)⟩, ⟨(-10680), (-10675)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4063591, 4063592⟩, ⟨2701720, 2701722⟩, ⟨445400, 445403⟩, ⟨(-1625), (-1622)⟩, ⟨(-136), (-132)⟩⟩
...
def j33 : Jet := ⟨⟨(-711764292), (-711764290)⟩, ⟨2701720, 2701722⟩, ⟨445400, 445403⟩, ⟨(-1625), (-1622)⟩, ⟨(-136), (-132)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-81029752), (-81029750)⟩, ⟨(-53712262), (-53712259)⟩, ⟨(-8747553), (-8747548)⟩, ⟨67792, 67796⟩, ⟨5493, 5497⟩⟩
...
def j36 : Jet := ⟨⟨4213937544, 4213937546⟩, ⟨(-53712262), (-53712259)⟩, ⟨(-8747553), (-8747548)⟩, ⟨67792, 67796⟩, ⟨5493, 5497⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨477573840, 477573843⟩, ⟨155554850, 155554854⟩, ⟨(-1808342), (-1808337)⟩, ⟨(-195457), (-195452)⟩, ⟨1358, 1361⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4377555166, 4377555169⟩, ⟨55797783, 55797788⟩, ⟨9798411, 9798420⟩, ⟨170292, 170300⟩, ⟨15900, 15910⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨486757101, 486757105⟩, ⟨164750380, 164750387⟩, ⟨1267287, 1267296⟩, ⟨151104, 151114⟩, ⟨2652, 2662⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-461279488), (-461279487)⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3833687808, 3833687809⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨55165140, 55165142⟩, ⟨37342968, 37342972⟩, ⟨6606897, 6606902⟩, ⟨131470, 131480⟩, ⟨12565, 12572⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4350132436, 4350132438⟩, ⟨37342968, 37342972⟩, ⟨6606897, 6606902⟩, ⟨131470, 131480⟩, ⟨12565, 12572⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4322461861, 4322461863⟩, ⟨18552717, 18552720⟩, ⟨3242619, 3242623⟩, ⟨51398, 51405⟩, ⟨4804, 4810⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3858229456, 3858229460⟩, ⟨(-138183981), (-138183976)⟩, ⟨2230173, 2230179⟩, ⟨(-70209), (-70200)⟩, ⟨2447, 2454⟩⟩
...
def j47 : Jet := ⟨⟨4193171099, 4193171110⟩, ⟨1397723699, 1397723710⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4093787601, 4093787624⟩, ⟨2729191732, 2729191762⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4093787601, 4093787624⟩, ⟨2729191732, 2729191762⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4093787624), (-4093787601)⟩, ⟨(-2729191762), (-2729191732)⟩, ⟨(-454865296), (-454865288)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2046893812), (-2046893800)⟩, ⟨(-1364595881), (-1364595866)⟩, ⟨(-227432648), (-227432644)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2666760222, 2666760236⟩, ⟨(-847282362), (-847282347)⟩, ⟨(-6614568), (-6614559)⟩, ⟨30611449, 30611452⟩, ⟨(-2256335), (-2256333)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2395588169, 2395588185⟩, ⟨(-846924567), (-846924548)⟩, ⟨22702770, 22702785⟩, ⟨27227958, 27227972⟩, ⟨(-2999843), (-2999830)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨307519658, 615039317⟩, ⟨153759829, 153759830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨966101498, 1932203001⟩, ⟨483050749, 483050753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨217312971, 869251890⟩, ⟨217312970, 434625948⟩, ⟨54328242, 54328244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-19153), (-4779)⟩, ⟨(-9575), (-4756)⟩, ⟨(-1196), (-1179)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5093903, 5108278⟩, ⟨(-9575), (-4756)⟩, ⟨(-1196), (-1179)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨257736, 1033857⟩, ⟨255798, 516689⟩, ⟨63222, 64318⟩, ⟨(-244), (-118)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142907841), (-142131719)⟩, ⟨255798, 516689⟩, ⟨63222, 64318⟩, ⟨(-244), (-118)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-28922901), (-7191455)⟩, ⟨(-14448509), (-7086883)⟩, ⟨(-1791542), (-1732559)⟩, ⟨6383, 13040⟩, ⟨770, 809⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1402732864, 1424464311⟩, ⟨(-14448509), (-7086883)⟩, ⟨(-1791542), (-1732559)⟩, ⟨6383, 13040⟩, ⟨770, 809⟩⟩
...
def j74 : Jet := ⟨⟨(-172350), (-42996)⟩, ⟨(-86145), (-42753)⟩, ⟨(-10735), (-10596)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35619044, 35748399⟩, ⟨(-86145), (-42753)⟩, ⟨(-10735), (-10596)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1802221, 7235065⟩, ⟨1784785, 3615370⟩, ⟨439664, 449493⟩, ⟨(-2177), (-1069)⟩, ⟨(-137), (-129)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714025662), (-708592817)⟩, ⟨1784785, 3615370⟩, ⟨439664, 449493⟩, ⟨(-2177), (-1069)⟩, ⟨(-137), (-129)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-144510567), (-35852755)⟩, ⟨(-72164980), (-35121044)⟩, ⟨(-8919362), (-8506360)⟩, ⟨44380, 91165⟩, ⟨5312, 5626⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4150456729, 4259114541⟩, ⟨(-72164980), (-35121044)⟩, ⟨(-8919362), (-8506360)⟩, ⟨44380, 91165⟩, ⟨5312, 5626⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨315527972, 640832404⟩, ⟨151263947, 158613993⟩, ⟨(-2430982), (-1186772)⟩, ⟨(-200058), (-188992)⟩, ⟨890, 1831⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4331121855, 4444509431⟩, ⟨35714822, 77277745⟩, ⟨8944680, 10894932⟩, ⟨49952, 309194⟩, ⟨10749, 22867⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨318184051, 663144902⟩, ⟨155161044, 175666873⟩, ⟨(-600671), 3282704⟩, ⟨67926, 248036⟩, ⟨(-6322), 12684⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-615039317), (-307519658)⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3679927979, 3987447638⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨23572028, 102389875⟩, ⟨22989590, 54246092⟩, ⟨5419898, 8198588⟩, ⟨(-39072), 345124⟩, ⟨2492, 26718⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4318539324, 4397357171⟩, ⟨22989590, 54246092⟩, ⟨5419898, 8198588⟩, ⟨(-39072), 345124⟩, ⟨2492, 26718⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306737182, 4345860702⟩, ⟨11360182, 27048922⟩, ⟨2594035, 4073109⟩, ⟨(-45065), 165249⟩, ⟨(-1722), 12825⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3690012417, 4034697077⟩, ⟨(-145848411), (-129068970)⟩, ⟨1254217, 3374781⟩, ⟨(-187657), 60552⟩, ⟨(-7515), 13521⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2795447399, 5590894810⟩, ⟨1397723699, 1397723710⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1819461155, 7277844655⟩, ⟨1819461154, 3638922348⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1819461155, 7277844655⟩, ⟨1819461154, 3638922348⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7277844655), (-1819461155)⟩, ⟨(-3638922348), (-1819461154)⟩, ⟨(-454865296), (-454865288)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3638922328), (-909730577)⟩, ⟨(-1819461174), (-909730577)⟩, ⟨(-227432648), (-227432644)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1840783525, 3475126168⟩, ⟨(-1472154898), (-389902167)⟩, ⟨(-142726160), 214346237⟩, ⟨(-16503168), 72124483⟩, ⟨(-13313627), 5526705⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1581505421, 3264537406⟩, ⟨(-1500952220), (-390301427)⟩, ⟨(-121822538), 254079090⟩, ⟨(-24090448), 72535648⟩, ⟨(-15095023), 5995895⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨461279487, 461279488⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4322461861, 4322461863⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2120
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨307519658, 615039317⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306737182, 4345860702⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2121
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (21518977 / 536870912)

theorem envelope_integral : (∫ s in ((179 / 2500) : ℝ)..(179 / 1250),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((179 / 2500) : ℝ)..(179 / 1250), prawitzNormalCorrection
