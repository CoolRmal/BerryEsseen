...
namespace FiniteNormalPanel45_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (17743 / 80000)
def radius : Rat := (17743 / 400000)

def j0 : Jet := ⟨⟨952570059, 952570060⟩, ⟨190514011, 190514012⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2992587099, 2992587103⟩, ⟨598517417, 598517421⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2085132884, 2085132890⟩, ⟨834053148, 834053158⟩, ⟨83405314, 83405316⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨521, 523⟩, ⟨208, 209⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94166), (-94163)⟩, ⟨208, 209⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-45716), (-45714)⟩, ⟨(-18187), (-18183)⟩, ⟨(-1780), (-1776)⟩, ⟨7, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5067340, 5067343⟩, ⟨(-18187), (-18183)⟩, ⟨(-1780), (-1776)⟩, ⟨7, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2460106, 2460109⟩, ⟨975212, 975217⟩, ⟨94007, 94012⟩, ⟨(-697), (-692)⟩, ⟨(-34), (-31)⟩⟩
...
def j16 : Jet := ⟨⟨(-140705471), (-140705467)⟩, ⟨975212, 975217⟩, ⟨94007, 94012⟩, ⟨(-697), (-692)⟩, ⟨(-34), (-31)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-68310091), (-68310088)⟩, ⟨(-26850589), (-26850583)⟩, ⟨(-2497387), (-2497380)⟩, ⟨36853, 36861⟩, ⟨1672, 1677⟩⟩
...
def j19 : Jet := ⟨⟨1363345674, 1363345678⟩, ⟨(-26850589), (-26850583)⟩, ⟨(-2497387), (-2497380)⟩, ⟨36853, 36861⟩, ⟨1672, 1677⟩⟩
...
def j22 : Jet := ⟨⟨(-53), (-51)⟩, ⟨(-21), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11782, 11785⟩, ⟨(-21), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5719, 5722⟩, ⟨2276, 2280⟩, ⟨221, 226⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846458), (-846454)⟩, ⟨2276, 2280⟩, ⟨221, 226⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-410941), (-410938)⟩, ⟨(-163273), (-163268)⟩, ⟨(-15890), (-15884)⟩, ⟨85, 89⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35380453, 35380457⟩, ⟨(-163273), (-163268)⟩, ⟨(-15890), (-15884)⟩, ⟨85, 89⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17176602, 17176605⟩, ⟨6791373, 6791379⟩, ⟨647642, 647649⟩, ⟨(-6216), (-6210)⟩, ⟨(-293), (-287)⟩⟩
...
def j33 : Jet := ⟨⟨(-698651281), (-698651277)⟩, ⟨6791373, 6791379⟩, ⟨647642, 647649⟩, ⟨(-6216), (-6210)⟩, ⟨(-293), (-287)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-339183204), (-339183200)⟩, ⟨(-132376188), (-132376181)⟩, ⟨(-11934073), (-11934064)⟩, ⟨254632, 254639⟩, ⟨11225, 11233⟩⟩
...
def j36 : Jet := ⟨⟨3955784092, 3955784096⟩, ⟨(-132376188), (-132376181)⟩, ⟨(-11934073), (-11934064)⟩, ⟨254632, 254639⟩, ⟨11225, 11233⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨949932885, 949932890⟩, ⟨171277999, 171278006⟩, ⟨(-5481811), (-5481803)⟩, ⟨(-322342), (-322333)⟩, ⟨6299, 6306⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4663233287, 4663233292⟩, ⟨156050228, 156050239⟩, ⟨19290399, 19290413⟩, ⟨816135, 816147⟩, ⟨62218, 62233⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1031383557, 1031383565⟩, ⟨220478164, 220478177⟩, ⟨4537772, 4537788⟩, ⟨400630, 400648⟩, ⟨16811, 16828⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-952570060), (-952570059)⟩, ⟨(-190514012), (-190514011)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3342397236, 3342397237⟩, ⟨(-190514012), (-190514011)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨247674072, 247674077⟩, ⟨105890236, 105890246⟩, ⟨13497422, 13497432⟩, ⟨658296, 658310⟩, ⟨53996, 54013⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4542641368, 4542641373⟩, ⟨105890236, 105890246⟩, ⟨13497422, 13497432⟩, ⟨658296, 658310⟩, ⟨53996, 54013⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4417068724, 4417068727⟩, ⟨51481551, 51481557⟩, ⟨6262143, 6262149⟩, ⟨247062, 247071⟩, ⟨18932, 18942⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3437418093, 3437418097⟩, ⟨(-155866541), (-155866533)⟩, ⟨2589683, 2589691⟩, ⟨(-85508), (-85499)⟩, ⟨3773, 3782⟩⟩
...
def j47 : Jet := ⟨⟨5516516537, 5516516545⟩, ⟨1103303302, 1103303309⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7085491601, 7085491622⟩, ⟨2834196626, 2834196650⟩, ⟨283419661, 283419665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7085491601, 7085491622⟩, ⟨2834196626, 2834196650⟩, ⟨283419661, 283419665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7085491622), (-7085491601)⟩, ⟨(-2834196650), (-2834196626)⟩, ⟨(-283419665), (-283419661)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3542745811), (-3542745800)⟩, ⟨(-1417098325), (-1417098313)⟩, ⟨(-141709833), (-141709830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1882468886, 1882468896⟩, ⟨(-621109158), (-621109149)⟩, ⟨40354675, 40354680⟩, ⟨9223818, 9223820⟩, ⟨(-1426576), (-1426574)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1506608121, 1506608131⟩, ⟨(-565411937), (-565411923)⟩, ⟨55972721, 55972734⟩, ⟨5505682, 5505692⟩, ⟨(-1438130), (-1438118)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨762056047, 1143084071⟩, ⟨190514011, 190514012⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2394069678, 3591104521⟩, ⟨598517417, 598517421⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1334485044, 3002591357⟩, ⟨667242518, 1000863788⟩, ⟨83405314, 83405316⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨334, 753⟩, ⟨167, 251⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94353), (-93933)⟩, ⟨167, 251⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-65962), (-29185)⟩, ⟨(-21937), (-14416)⟩, ⟨(-1802), (-1750)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5047094, 5083872⟩, ⟨(-21937), (-14416)⟩, ⟨(-1802), (-1750)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1568177, 3554111⟩, ⟨768751, 1180225⟩, ⟨91638, 95944⟩, ⟨(-846), (-543)⟩, ⟨(-35), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141597400), (-139611465)⟩, ⟨768751, 1180225⟩, ⟨91638, 95944⟩, ⟨(-846), (-543)⟩, ⟨(-35), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-98990074), (-43378540)⟩, ⟨(-32757835), (-20864180)⟩, ⟨(-2601825), (-2369054)⟩, ⟨28572, 45110⟩, ⟨1556, 1771⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1332665691, 1388277226⟩, ⟨(-32757835), (-20864180)⟩, ⟨(-2601825), (-2369054)⟩, ⟨28572, 45110⟩, ⟨1556, 1771⟩⟩
...
def j70 : Jet := ⟨⟨(-76), (-33)⟩, ⟨(-26), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11759, 11803⟩, ⟨(-26), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3653, 8252⟩, ⟨1807, 2747⟩, ⟨218, 228⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848524), (-843924)⟩, ⟨1807, 2747⟩, ⟨218, 228⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-593200), (-262214)⟩, ⟨(-197173), (-129186)⟩, ⟨(-16131), (-15587)⟩, ⟨66, 108⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35198194, 35529181⟩, ⟨(-197173), (-129186)⟩, ⟨(-16131), (-15587)⟩, ⟨66, 108⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10936396, 24838283⟩, ⟨5330355, 8239289⟩, ⟨626298, 665041⟩, ⟨(-7569), (-4853)⟩, ⟨(-304), (-272)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704891487), (-690989599)⟩, ⟨5330355, 8239289⟩, ⟨626298, 665041⟩, ⟨(-7569), (-4853)⟩, ⟨(-304), (-272)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-492786311), (-214696695)⟩, ⟨(-162605915), (-101588298)⟩, ⟨(-12665819), (-11033598)⟩, ⟨195517, 313471⟩, ⟨10185, 12078⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3802180985, 4080270601⟩, ⟨(-162605915), (-101588298)⟩, ⟨(-12665819), (-11033598)⟩, ⟨195517, 313471⟩, ⟨10185, 12078⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨742844893, 1160765212⟩, ⟨158321767, 181830909⟩, ⟨(-6740346), (-4228030)⟩, ⟨(-346647), (-292417)⟩, ⟨4848, 7768⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4520960955, 4851621779⟩, ⟨112560359, 207486810⟩, ⟨15027747, 25035197⟩, ⟨305799, 1529371⟩, ⟨17947, 130907⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨781932090, 1311207606⟩, ⟨186120489, 261473068⟩, ⟨(-865566), 11099677⟩, ⟨(-110352), 1054608⟩, ⟨(-36558), 86447⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1143084071), (-762056047)⟩, ⟨(-190514012), (-190514011)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3151883225, 3532911249⟩, ⟨(-190514012), (-190514011)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨142356798, 400297667⟩, ⟨67769354, 159649866⟩, ⟨7536950, 22695430⟩, ⟨(-172770), 1995396⟩, ⟨(-37997), 209878⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4437324094, 4695264963⟩, ⟨67769354, 159649866⟩, ⟨7536950, 22695430⟩, ⟨(-172770), 1995396⟩, ⟨(-37997), 209878⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4365565469, 4490658022⟩, ⟨32408074, 78534037⟩, ⟨2917540, 11043913⟩, ⟨(-283663), 959906⟩, ⟨(-49930), 107371⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3203692047, 3693880570⟩, ⟨(-175411537), (-129045826)⟩, ⟨(-1342523), 7646851⟩, ⟨(-723214), 660176⟩, ⟨(-83651), 100904⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4413213228, 6619819848⟩, ⟨1103303302, 1103303309⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4534714621, 10203107917⟩, ⟨2267357300, 3401035976⟩, ⟨283419661, 283419665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4534714621, 10203107917⟩, ⟨2267357300, 3401035976⟩, ⟨283419661, 283419665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10203107917), (-4534714621)⟩, ⟨(-3401035976), (-2267357300)⟩, ⟨(-283419665), (-283419661)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5101553959), (-2267357310)⟩, ⟨(-1700517988), (-1133678650)⟩, ⟨(-141709833), (-141709830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1309500601, 2533327561⟩, ⟨(-1003027216), (-345649401)⟩, ⟨(-37967636), 155359462⟩, ⟨(-12900970), 27073725⟩, ⟨(-5242839), 1903339⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨976779652, 2178784799⟩, ⟨(-966116234), (-297171021)⟩, ⟨(-23060561), 179091895⟩, ⟨(-19652915), 25538287⟩, ⟨(-5885935), 2668876⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨952570059, 952570060⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4417068724, 4417068727⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified886
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨762056047, 1143084071⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4365565469, 4490658022⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified887
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (67680651 / 2147483648)

theorem envelope_integral : (∫ s in ((17743 / 100000) : ℝ)..(53229 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (17743 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (53229 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((17743 / 100000) : ℝ)..(53229 / 200000), prawitzNormalCorrection
