...
namespace FiniteNormalPanel11_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (267757 / 800000)
def radius : Rat := (38251 / 800000)

def j0 : Jet := ⟨⟨1437509447, 1437509448⟩, ⟨205358492, 205358493⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4516069117, 4516069122⟩, ⟨645152729, 645152733⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4748553100, 4748553111⟩, ⟨1356729452, 1356729464⟩, ⟨96909246, 96909248⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1188, 1190⟩, ⟨339, 340⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93499), (-93496)⟩, ⟨339, 340⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-103374), (-103369)⟩, ⟨(-29162), (-29158)⟩, ⟨(-1977), (-1973)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5009682, 5009688⟩, ⟨(-29162), (-29158)⟩, ⟨(-1977), (-1973)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5538747, 5538755⟩, ⟨1550257, 1550265⟩, ⟨101637, 101645⟩, ⟨(-1268), (-1262)⟩, ⟨(-41), (-36)⟩⟩
...
def j16 : Jet := ⟨⟨(-137626830), (-137626821)⟩, ⟨1550257, 1550265⟩, ⟨101637, 101645⟩, ⟨(-1268), (-1262)⟩, ⟨(-41), (-36)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-152161418), (-152161407)⟩, ⟨(-41760714), (-41760700)⟩, ⟨(-2503259), (-2503243)⟩, ⟨65682, 65694⟩, ⟨1846, 1857⟩⟩
...
def j19 : Jet := ⟨⟨1279494347, 1279494359⟩, ⟨(-41760714), (-41760700)⟩, ⟨(-2503259), (-2503243)⟩, ⟨65682, 65694⟩, ⟨1846, 1857⟩⟩
...
def j22 : Jet := ⟨⟨(-120), (-118)⟩, ⟨(-35), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11715, 11718⟩, ⟨(-35), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨12952, 12956⟩, ⟨3661, 3666⟩, ⟨248, 253⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-839225), (-839220)⟩, ⟨3661, 3666⟩, ⟨248, 253⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-927855), (-927848)⟩, ⟨(-261055), (-261045)⟩, ⟨(-17506), (-17496)⟩, ⟨157, 163⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34863539, 34863547⟩, ⟨(-261055), (-261045)⟩, ⟨(-17506), (-17496)⟩, ⟨157, 163⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨38545431, 38545441⟩, ⟨10724355, 10724370⟩, ⟨684821, 684838⟩, ⟨(-11248), (-11235)⟩, ⟨(-344), (-335)⟩⟩
...
def j33 : Jet := ⟨⟨(-677282452), (-677282441)⟩, ⟨10724355, 10724370⟩, ⟨684821, 684838⟩, ⟨(-11248), (-11235)⟩, ⟨(-344), (-335)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-748809356), (-748809341)⟩, ⟨(-202088592), (-202088568)⟩, ⟨(-11136983), (-11136958)⟩, ⟨445868, 445891⟩, ⟨11516, 11534⟩⟩
...
def j36 : Jet := ⟨⟨3546157940, 3546157955⟩, ⟨(-202088592), (-202088568)⟩, ⟨(-11136983), (-11136958)⟩, ⟨445868, 445891⟩, ⟨11516, 11534⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1345361793, 1345361808⟩, ⟨148284015, 148284035⟩, ⟨(-8905058), (-8905038)⟩, ⟨(-306955), (-306939)⟩, ⟨11807, 11821⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5201895772, 5201895795⟩, ⟨296445809, 296445848⟩, ⟨33230781, 33230825⟩, ⟨2170682, 2170725⟩, ⟨173869, 173906⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1629449385, 1629449412⟩, ⟨272454892, 272454932⟩, ⟨9858611, 9858653⟩, ⟨840826, 840867⟩, ⟨53617, 53654⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1437509448), (-1437509447)⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2857457848, 2857457849⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨618189875, 618189897⟩, ⟨206731006, 206731042⟩, ⟨24763839, 24763879⟩, ⟨1888772, 1888812⟩, ⟨169987, 170026⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4913157171, 4913157193⟩, ⟨206731006, 206731042⟩, ⟨24763839, 24763879⟩, ⟨1888772, 1888812⟩, ⟨169987, 170026⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4593674930, 4593674942⟩, ⟨96644072, 96644090⟩, ⟨10560150, 10560170⟩, ⟨660806, 660826⟩, ⟨53425, 53445⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3056189157, 3056189167⟩, ⟨(-155343163), (-155343148)⟩, ⟨2404790, 2404806⟩, ⟨(-65286), (-65269)⟩, ⟨3946, 3963⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨22558108436, 22558108442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value138

def j47 : Jet := ⟨⟨7550114296, 7550114304⟩, ⟨1078587754, 1078587760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13272330603, 13272330632⟩, ⟨3792094448, 3792094476⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13272330603, 13272330632⟩, ⟨3792094448, 3792094476⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13272330632), (-13272330603)⟩, ⟨(-3792094476), (-3792094448)⟩, ⟨(-270863892), (-270863888)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6636165316), (-6636165301)⟩, ⟨(-1896047238), (-1896047224)⟩, ⟨(-135431946), (-135431944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨916073474, 916073487⟩, ⟨(-404407877), (-404407868)⟩, ⟨60378245, 60378250⟩, ⟨(-383436), (-383433)⟩, ⟨(-909628), (-909626)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨651854513, 651854526⟩, ⟨(-320899471), (-320899457)⟩, ⟨58103419, 58103432⟩, ⟨(-2697003), (-2696992)⟩, ⟨(-592609), (-592596)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1232150955, 1642867941⟩, ⟨205358492, 205358493⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3870916388, 5161221855⟩, ⟨645152729, 645152733⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3488732893, 6202191822⟩, ⟨1162910960, 1550547960⟩, ⟨96909246, 96909248⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨873, 1554⟩, ⟨291, 389⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93814), (-93132)⟩, ⟨291, 389⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-135474), (-75649)⟩, ⟨(-33633), (-24654)⟩, ⟨(-2020), (-1923)⟩, ⟨12, 19⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4977582, 5037408⟩, ⟨(-33633), (-24654)⟩, ⟨(-2020), (-1923)⟩, ⟨12, 19⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4043209, 7274321⟩, ⟨1299167, 1798555⟩, ⟨97250, 105425⟩, ⟨(-1480), (-1048)⟩, ⟨(-43), (-34)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139122368), (-135891255)⟩, ⟨1299167, 1798555⟩, ⟨97250, 105425⟩, ⟨(-1480), (-1048)⟩, ⟨(-43), (-34)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-200901091), (-110382281)⟩, ⟨(-49169981), (-34196871)⟩, ⟨(-2708322), (-2264627)⟩, ⟨53506, 77792⟩, ⟨1596, 2069⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1230754674, 1321273485⟩, ⟨(-49169981), (-34196871)⟩, ⟨(-2708322), (-2264627)⟩, ⟨53506, 77792⟩, ⟨1596, 2069⟩⟩
...
def j70 : Jet := ⟨⟨(-156), (-86)⟩, ⟨(-39), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11679, 11750⟩, ⟨(-39), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9486, 16968⟩, ⟨3105, 4220⟩, ⟨243, 258⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842691), (-835208)⟩, ⟨3105, 4220⟩, ⟨243, 258⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1216897), (-678426)⟩, ⟨(-301703), (-220048)⟩, ⟨(-17978), (-16948)⟩, ⟨130, 190⟩, ⟨1, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34574497, 35112969⟩, ⟨(-301703), (-220048)⟩, ⟨(-17978), (-16948)⟩, ⟨130, 190⟩, ⟨1, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨28084308, 50705246⟩, ⟨8925758, 12497571⟩, ⟨645237, 718924⟩, ⟨(-13194), (-9278)⟩, ⟨(-371), (-304)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-687743575), (-665122636)⟩, ⟨8925758, 12497571⟩, ⟨645237, 718924⟩, ⟨(-13194), (-9278)⟩, ⟨(-371), (-304)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-993143203), (-540268425)⟩, ⟨(-241035553), (-162042227)⟩, ⟨(-12576999), (-9457474)⟩, ⟨357047, 533996⟩, ⟨9258, 13464⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3301824093, 3754698871⟩, ⟨(-241035553), (-162042227)⟩, ⟨(-12576999), (-9457474)⟩, ⟨357047, 533996⟩, ⟨9258, 13464⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1109239747, 1587761936⟩, ⟨125786185, 167649700⟩, ⟨(-10640455), (-7177792)⟩, ⟨(-358598), (-246690)⟩, ⟨9475, 14173⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4912975635, 5586834294⟩, ⟨212030189, 407842955⟩, ⟨21525608, 51053680⟩, ⟨668488, 4749205⟩, ⟨5029, 504464⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1268849673, 2065338855⟩, ⟨198645697, 368847656⟩, ⟨(-2071945), 26582630⟩, ⟨(-673796), 3111982⟩, ⟨(-128821), 342158⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1642867941), (-1232150955)⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2652099355, 3062816341⟩, ⟨(-205358493), (-205358492)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨374852561, 993168118⟩, ⟨117370638, 354738626⟩, ⟨7194833, 57242084⟩, ⟨(-1003898), 7558726⟩, ⟨(-252448), 1028107⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4669819857, 5288135414⟩, ⟨117370638, 354738626⟩, ⟨7194833, 57242084⟩, ⟨(-1003898), 7558726⟩, ⟨(-252448), 1028107⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4478473351, 4765749539⟩, ⟨52888118, 170101582⟩, ⟨206370, 27136003⟩, ⟨(-1512063), 3622067⟩, ⟨(-340838), 550418⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2765412508, 3398539398⟩, ⟨(-195210475), (-92830189)⟩, ⟨(-8005764), 16822380⟩, ⟨(-2375754), 2573093⟩, ⟨(-416243), 464811⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6471526541, 8628702064⟩, ⟨1078587754, 1078587760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9751100039, 17335288998⟩, ⟨3250366670, 4333822258⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9751100039, 17335288998⟩, ⟨3250366670, 4333822258⟩, ⟨270863888, 270863892⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17335288998), (-9751100039)⟩, ⟨(-4333822258), (-3250366670)⟩, ⟨(-270863892), (-270863888)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8667644499), (-4875550019)⟩, ⟨(-2166911129), (-1625183335)⟩, ⟨(-135431946), (-135431944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨570838288, 1380252558⟩, ⟨(-696369594), (-216000916)⟩, ⟨(-2656539), 157667272⟩, ⟨(-21974876), 15085708⟩, ⟨(-4388611), 2813594⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨367547232, 1092171925⟩, ⟨(-613760032), (-151415043)⟩, ⟨(-6271), 161816415⟩, ⟨(-28045506), 14182752⟩, ⟨(-5003148), 4377250⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1437509447, 1437509448⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4593674930, 4593674942⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar138 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified218
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar138 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1232150955, 1642867941⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4478473351, 4765749539⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified219
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((114753 / 400000) : ℝ)..(38251 / 100000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (38251 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((114753 / 400000) : ℝ)..(38251 / 100000), prawitzNormalCorrection
      ((303237 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
