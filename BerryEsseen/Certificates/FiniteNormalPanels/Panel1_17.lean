...
namespace FiniteNormalPanel1_17
...
def j2 : Jet := ⟨⟨5481546567, 5481546568⟩, ⟨421657428, 421657429⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨6995944484, 6995944488⟩, ⟨1076299150, 1076299154⟩, ⟨41396121, 41396122⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1751, 1753⟩, ⟨269, 270⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-92936), (-92933)⟩, ⟨269, 270⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-151381), (-151375)⟩, ⟨(-22852), (-22848)⟩, ⟨(-813), (-809)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4961675, 4961682⟩, ⟨(-22852), (-22848)⟩, ⟨(-813), (-809)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨8081924, 8081937⟩, ⟨1206150, 1206159⟩, ⟨40770, 40781⟩, ⟨(-419), (-412)⟩, ⟨(-7), (-3)⟩⟩
...
def j16 : Jet := ⟨⟨(-135083653), (-135083639)⟩, ⟨1206150, 1206159⟩, ⟨40770, 40781⟩, ⟨(-419), (-412)⟩, ⟨(-7), (-3)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-220033745), (-220033721)⟩, ⟨(-31886685), (-31886664)⟩, ⟨(-933311), (-933289)⟩, ⟨21158, 21175⟩, ⟨275, 287⟩⟩
...
def j19 : Jet := ⟨⟨1211622020, 1211622045⟩, ⟨(-31886685), (-31886664)⟩, ⟨(-933311), (-933289)⟩, ⟨21158, 21175⟩, ⟨275, 287⟩⟩
...
def j22 : Jet := ⟨⟨(-176), (-174)⟩, ⟨(-28), (-26)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11659, 11662⟩, ⟨(-28), (-26)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨18990, 18996⟩, ⟨2875, 2881⟩, ⟨100, 106⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-833187), (-833180)⟩, ⟨2875, 2881⟩, ⟨100, 106⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1357154), (-1357142)⟩, ⟨(-204110), (-204098)⟩, ⟨(-7149), (-7135)⟩, ⟨48, 55⟩, ⟨(-3), 2⟩⟩
...
def j30 : Jet := ⟨⟨34434240, 34434253⟩, ⟨(-204110), (-204098)⟩, ⟨(-7149), (-7135)⟩, ⟨48, 55⟩, ⟨(-3), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨56088909, 56088931⟩, ⟨8296593, 8296618⟩, ⟨269092, 269121⟩, ⟨(-3682), (-3664)⟩, ⟨(-62), (-50)⟩⟩
...
def j33 : Jet := ⟨⟨(-659738974), (-659738951)⟩, ⟨8296593, 8296618⟩, ⟨269092, 269121⟩, ⟨(-3682), (-3664)⟩, ⟨(-62), (-50)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-1074629193), (-1074629154)⟩, ⟨(-151813496), (-151813447)⟩, ⟨(-3841350), (-3841293)⟩, ⟨141399, 141439⟩, ⟨1569, 1595⟩⟩
...
def j36 : Jet := ⟨⟨3220338103, 3220338142⟩, ⟨(-151813496), (-151813447)⟩, ⟨(-3841350), (-3841293)⟩, ⟨141399, 141439⟩, ⟨1569, 1595⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1546359277, 1546359310⟩, ⟨78254629, 78254661⟩, ⟨(-4321627), (-4321595)⟩, ⟨(-64625), (-64599)⟩, ⟨2427, 2446⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5728200971, 5728201041⟩, ⟨270039323, 270039419⟩, ⟨19562944, 19563058⟩, ⟨992758, 992846⟩, ⟨55435, 55494⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨2062380479, 2062380549⟩, ⟨201593164, 201593247⟩, ⟨6199816, 6199908⟩, ⟨355963, 356038⟩, ⟨17533, 17589⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1744830464), (-1744830464)⟩, ⟨(-134217728), (-134217728)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2550136832, 2550136832⟩, ⟨(-134217728), (-134217728)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨990324942, 990325010⟩, ⟨193604176, 193604266⟩, ⟨15416311, 15416412⟩, ⟨923858, 923942⟩, ⟨59201, 59266⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5285292238, 5285292306⟩, ⟨193604176, 193604266⟩, ⟨15416311, 15416412⟩, ⟨923858, 923942⟩, ⟨59201, 59266⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4764468208, 4764468240⟩, ⟨87263002, 87263044⟩, ⟨6149449, 6149496⟩, ⟨303778, 303819⟩, ⟨17150, 17181⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2828902998, 2828903018⟩, ⟨(-97077226), (-97077198)⟩, ⟨924264, 924296⟩, ⟨(-11804), (-11777)⟩, ⟨687, 709⟩⟩
...
def j47 : Jet := ⟨⟨4900652979, 4900652980⟩, ⟨376973306, 376973307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5591753781, 5591753785⟩, ⟨860269812, 860269816⟩, ⟨33087300, 33087301⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5591753781, 5591753785⟩, ⟨860269812, 860269816⟩, ⟨33087300, 33087301⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5591753785), (-5591753781)⟩, ⟨(-860269816), (-860269812)⟩, ⟨(-33087301), (-33087300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2795876893), (-2795876890)⟩, ⟨(-430134908), (-430134906)⟩, ⟨(-16543651), (-16543650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2240005053, 2240005067⟩, ⟨(-224333344), (-224333340)⟩, ⟨2605127, 2605129⟩, ⟨489101, 489103⟩, ⟨(-17264), (-17262)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1475391213, 1475391233⟩, ⟨(-198388183), (-198388162)⟩, ⟨7268426, 7268450⟩, ⟨208830, 208852⟩, ⟨(-20894), (-20875)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1610612736, 1879048192⟩, ⟨134217728, 134217728⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨5059889139, 5903203996⟩, ⟨421657428, 421657429⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨5961041454, 8113639760⟩, ⟨993506908, 1159091398⟩, ⟨41396121, 41396122⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1492, 2033⟩, ⟨248, 291⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93195), (-92653)⟩, ⟨248, 291⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-176056), (-128594)⟩, ⟨(-24807), (-20882)⟩, ⟨(-829), (-793)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4937000, 4984463⟩, ⟨(-24807), (-20882)⟩, ⟨(-829), (-793)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨6852127, 9416169⟩, ⟨1095157, 1316185⟩, ⟨39322, 42112⟩, ⟨(-459), (-372)⟩, ⟨(-8), (-3)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-136313450), (-133749407)⟩, ⟨1095157, 1316185⟩, ⟨39322, 42112⟩, ⟨(-459), (-372)⟩, ⟨(-8), (-3)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-257510280), (-185632556)⟩, ⟨(-35267201), (-28452348)⟩, ⟨(-1005923), (-854358)⟩, ⟨18782, 23535⟩, ⟨238, 316⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1174145485, 1246023210⟩, ⟨(-35267201), (-28452348)⟩, ⟨(-1005923), (-854358)⟩, ⟨18782, 23535⟩, ⟨238, 316⟩⟩
...
def j70 : Jet := ⟨⟨(-205), (-148)⟩, ⟨(-30), (-24)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11630, 11688⟩, ⟨(-30), (-24)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨16141, 22080⟩, ⟨2633, 3122⟩, ⟨99, 107⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-836036), (-830096)⟩, ⟨2633, 3122⟩, ⟨99, 107⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1579359), (-1152101)⟩, ⟨(-221969), (-186118)⟩, ⟨(-7312), (-6954)⟩, ⟨43, 60⟩, ⟨(-3), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34212035, 34639294⟩, ⟨(-221969), (-186118)⟩, ⟨(-7312), (-6954)⟩, ⟨43, 60⟩, ⟨(-3), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨47483332, 65437228⟩, ⟨7494565, 9089861⟩, ⟨256027, 281161⟩, ⟨(-4055), (-3287)⟩, ⟨(-68), (-46)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-668344551), (-650390654)⟩, ⟨7494565, 9089861⟩, ⟨256027, 281161⟩, ⟨(-4055), (-3287)⟩, ⟨(-68), (-46)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1262572344), (-902685720)⟩, ⟨(-169965674), (-133275926)⟩, ⟨(-4352719), (-3284408)⟩, ⟨123796, 158927⟩, ⟨1243, 1887⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3032394952, 3392281576⟩, ⟨(-169965674), (-133275926)⟩, ⟨(-4352719), (-3284408)⟩, ⟨123796, 158927⟩, ⟨1243, 1887⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1383257561, 1712592597⟩, ⟨66798571, 88808411⟩, ⟨(-4844938), (-3799818)⟩, ⟨(-76630), (-51528)⟩, ⟨2123, 2746⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5437857577, 6083226086⟩, ⟨213642495, 340964697⟩, ⟨13658518, 27842968⟩, ⟨458464, 1828025⟩, ⟨11876, 131480⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1751342231, 2425650126⟩, ⟨153380378, 261742450⟩, ⟨859472, 13341505⟩, ⟨(-133080), 1050382⟩, ⟨(-23852), 79470⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1879048192), (-1610612736)⟩, ⟨(-134217728), (-134217728)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2415919104, 2684354560⟩, ⟨(-134217728), (-134217728)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨714138059, 1369923944⟩, ⟨125086648, 295646306⟩, ⟨6178392, 31020671⟩, ⟨(-88934), 2812548⟩, ⟨(-42993), 259233⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨5009105355, 5664891240⟩, ⟨125086648, 295646306⟩, ⟨6178392, 31020671⟩, ⟨(-88934), 2812548⟩, ⟨(-42993), 259233⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4638312589, 4932597958⟩, ⟨54458428, 136880729⟩, ⟨790623, 14042505⟩, ⟨(-455584), 1292895⟩, ⟨(-79318), 133400⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2609050831, 3082873724⟩, ⟨(-123510822), (-59396812)⟩, ⟨(-3832798), 7074741⟩, ⟨(-723569), 783354⟩, ⟨(-89977), 97612⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4523679673, 5277626286⟩, ⟨376973306, 376973307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4764571269, 6485110898⟩, ⟨794095210, 926444418⟩, ⟨33087300, 33087301⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4764571269, 6485110898⟩, ⟨794095210, 926444418⟩, ⟨33087300, 33087301⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6485110898), (-4764571269)⟩, ⟨(-926444418), (-794095210)⟩, ⟨(-33087301), (-33087300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3242555449), (-2382285634)⟩, ⟨(-463222209), (-397047605)⟩, ⟨(-16543651), (-16543650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2018748302, 2466437604⟩, ⟨(-266011031), (-186622882)⟩, ⟨(-874233), 6569002⟩, ⟨243070, 714523⟩, ⟨(-31918), (-3933)⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1226322943, 1770378017⟩, ⟨(-261866990), (-141285312)⟩, ⟨(-247664), 16427612⟩, ⟨(-894947), 1225255⟩, ⟨(-149511), 105941⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4764468208, 4764468240⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified16
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4638312589, 4932597958⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified17
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (92364703 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((3 / 8) : ℝ)..(7 / 16), prawitzNormalCorrection
