...
namespace FiniteNormalPanel133_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (95207 / 400000)
def radius : Rat := (13601 / 400000)

def j0 : Jet := ⟨⟨1022277378, 1022277379⟩, ⟨146039625, 146039626⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3211579100, 3211579104⟩, ⟨458797013, 458797017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2401471211, 2401471218⟩, ⟨686134628, 686134638⟩, ⟨49009616, 49009618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨601, 602⟩, ⟨171, 172⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94086), (-94084)⟩, ⟨171, 172⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-52607), (-52605)⟩, ⟨(-14936), (-14933)⟩, ⟨(-1041), (-1037)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5060449, 5060452⟩, ⟨(-14936), (-14933)⟩, ⟨(-1041), (-1037)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2829479, 2829482⟩, ⟨800070, 800075⟩, ⟨54774, 54781⟩, ⟨(-337), (-332)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-140336098), (-140336094)⟩, ⟨800070, 800075⟩, ⟨54774, 54781⟩, ⟨(-337), (-332)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-78466978), (-78466974)⟩, ⟨(-21971789), (-21971784)⟩, ⟨(-1442928), (-1442920)⟩, ⟨17690, 17697⟩, ⟨564, 568⟩⟩
...
def j19 : Jet := ⟨⟨1353188787, 1353188792⟩, ⟨(-21971789), (-21971784)⟩, ⟨(-1442928), (-1442920)⟩, ⟨17690, 17697⟩, ⟨564, 568⟩⟩
...
def j22 : Jet := ⟨⟨(-61), (-59)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11774, 11777⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6583, 6585⟩, ⟨1869, 1873⟩, ⟨129, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845594), (-845591)⟩, ⟨1869, 1873⟩, ⟨129, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-472803), (-472800)⟩, ⟨(-134042), (-134037)⟩, ⟨(-9280), (-9273)⟩, ⟨39, 44⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35318591, 35318595⟩, ⟨(-134042), (-134037)⟩, ⟨(-9280), (-9273)⟩, ⟨39, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19747898, 19747902⟩, ⟨5567308, 5567314⟩, ⟨376415, 376423⟩, ⟨(-2992), (-2985)⟩, ⟨(-101), (-95)⟩⟩
...
def j33 : Jet := ⟨⟨(-696079985), (-696079980)⟩, ⟨5567308, 5567314⟩, ⟨376415, 376423⟩, ⟨(-2992), (-2985)⟩, ⟨(-101), (-95)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-389203441), (-389203436)⟩, ⟨(-108088102), (-108088094)⟩, ⟨(-6843066), (-6843058)⟩, ⟨121988, 121995⟩, ⟨3760, 3767⟩⟩
...
def j36 : Jet := ⟨⟨3905763855, 3905763860⟩, ⟨(-108088102), (-108088094)⟩, ⟨(-6843066), (-6843058)⟩, ⟨121988, 121995⟩, ⟨3760, 3767⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1011852367, 1011852373⟩, ⟨128120843, 128120850⟩, ⟨(-3426027), (-3426018)⟩, ⟨(-140910), (-140901)⟩, ⟨2310, 2316⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4722954263, 4722954270⟩, ⟨130703017, 130703029⟩, ⟨11891882, 11891896⟩, ⟨410571, 410585⟩, ⟨23557, 23571⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1112681918, 1112681927⟩, ⟨171680244, 171680257⟩, ⟨2933115, 2933132⟩, ⟨192254, 192271⟩, ⟨6561, 6577⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1022277379), (-1022277378)⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3272689917, 3272689918⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨288258551, 288258556⟩, ⟨88953180, 88953190⟩, ⟨8382217, 8382231⟩, ⟨334098, 334112⟩, ⟨20769, 20784⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4583225847, 4583225852⟩, ⟨88953180, 88953190⟩, ⟨8382217, 8382231⟩, ⟨334098, 334112⟩, ⟨20769, 20784⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4436756148, 4436756152⟩, ⟨43055217, 43055223⟩, ⟨3848261, 3848269⟩, ⟨124365, 124374⟩, ⟨7176, 7185⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3380730540, 3380730545⟩, ⟨(-118053481), (-118053473)⟩, ⟨1468321, 1468329⟩, ⟨(-36088), (-36079)⟩, ⟨1237, 1247⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨42244148082, 42244148089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value558

def j47 : Jet := ⟨⟨10054846512, 10054846524⟩, ⟨1436406640, 1436406651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨23539163726, 23539163783⟩, ⟨6725475328, 6725475390⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨23539163726, 23539163783⟩, ⟨6725475328, 6725475390⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-23539163783), (-23539163726)⟩, ⟨(-6725475390), (-6725475328)⟩, ⟨(-480391101), (-480391093)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11769581892), (-11769581863)⟩, ⟨(-3362737695), (-3362737664)⟩, ⟨(-240195551), (-240195546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨277238982, 277238990⟩, ⟨(-217063819), (-217063810)⟩, ⟨69470319, 69470326⟩, ⟨(-10037715), (-10037711)⟩, ⟨22192, 22194⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨218225245, 218225253⟩, ⟨(-178479430), (-178479420)⟩, ⟨60743800, 60743810⟩, ⟨(-9887097), (-9887088)⟩, ⟨319020, 319027⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨876237752, 1168317004⟩, ⟨146039625, 146039626⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2752782084, 3670376117⟩, ⟨458797013, 458797017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1764346193, 3136615465⟩, ⟨588115396, 784153872⟩, ⟨49009616, 49009618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨441, 786⟩, ⟨147, 197⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94246), (-93900)⟩, ⟨147, 197⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-68828), (-38573)⟩, ⟨(-17147), (-12713)⟩, ⟨(-1052), (-1025)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5044228, 5074484⟩, ⟨(-17147), (-12713)⟩, ⟨(-1052), (-1025)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2072137, 3705897⟩, ⟨678189, 921253⟩, ⟨53659, 55744⟩, ⟨(-389), (-280)⟩, ⟨(-13), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141093440), (-139459679)⟩, ⟨678189, 921253⟩, ⟨53659, 55744⟩, ⟨(-389), (-280)⟩, ⟨(-13), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-103040568), (-57289179)⟩, ⟨(-25481547), (-18423601)⟩, ⟨(-1495102), (-1382458)⟩, ⟨14800, 20576⟩, ⟨530, 596⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1328615197, 1374366587⟩, ⟨(-25481547), (-18423601)⟩, ⟨(-1495102), (-1382458)⟩, ⟨14800, 20576⟩, ⟨530, 596⟩⟩
...
def j70 : Jet := ⟨⟨(-79), (-43)⟩, ⟨(-20), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11756, 11793⟩, ⟨(-20), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4829, 8613⟩, ⟨1594, 2149⟩, ⟨128, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847348), (-843563)⟩, ⟨1594, 2149⟩, ⟨128, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-618819), (-346530)⟩, ⟨(-154051), (-113940)⟩, ⟨(-9400), (-9134)⟩, ⟨33, 50⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35172575, 35444865⟩, ⟨(-154051), (-113940)⟩, ⟨(-9400), (-9134)⟩, ⟨33, 50⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14448677, 25885392⟩, ⟨4703721, 6424544⟩, ⟨366361, 385107⟩, ⟨(-3462), (-2513)⟩, ⟨(-105), (-92)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701379206), (-689942490)⟩, ⟨4703721, 6424544⟩, ⟨366361, 385107⟩, ⟨(-3462), (-2513)⟩, ⟨(-105), (-92)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-512217373), (-283424138)⟩, ⟨(-126122086), (-89782866)⟩, ⟨(-7208813), (-6418686)⟩, ⟨101310, 142590⟩, ⟨3470, 4014⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3782749923, 4011543158⟩, ⟨(-126122086), (-89782866)⟩, ⟨(-7208813), (-6418686)⟩, ⟨101310, 142590⟩, ⟨3470, 4014⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨851552027, 1174500747⟩, ⟨120149417, 135004320⟩, ⟨(-3999669), (-2854106)⟩, ⟨(-150225), (-130092)⟩, ⟨1919, 2708⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4598415957, 4876543375⟩, ⟨102917741, 162590665⟩, ⟨9661128, 14714261⟩, ⟨207564, 677291⟩, ⟨9443, 43650⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨911716006, 1333538405⟩, ⟨149043464, 197747090⟩, ⟨253294, 6078741⟩, ⟨(-10562), 440054⟩, ⟨(-9658), 26765⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1168317004), (-876237752)⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3126650292, 3418729544⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨193534902, 414048480⟩, ⟨63276528, 122796438⟩, ⟨5279625, 12879349⟩, ⟨11018, 833014⟩, ⟨(-6958), 65748⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4488502198, 4709015776⟩, ⟨63276528, 122796438⟩, ⟨5279625, 12879349⟩, ⟨11018, 833014⟩, ⟨(-6958), 65748⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4390668530, 4497229009⟩, ⟨30215341, 60059953⟩, ⟨2120040, 6195346⟩, ⟨(-79358), 392840⟩, ⟨(-13149), 32732⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3196318876, 3579726834⟩, ⟨(-130920867), (-101486884)⟩, ⟨(-498843), 3904006⟩, ⟨(-273826), 240609⟩, ⟨(-23825), 28754⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8618439862, 11491253165⟩, ⟨1436406640, 1436406651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17294079450, 30745030219⟩, ⟨5764693134, 7686257584⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17294079450, 30745030219⟩, ⟨5764693134, 7686257584⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-30745030219), (-17294079450)⟩, ⟨(-7686257584), (-5764693134)⟩, ⟨(-480391101), (-480391093)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15372515110), (-8647039725)⟩, ⟨(-3843128792), (-2882346567)⟩, ⟨(-240195551), (-240195546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨119821917, 573583432⟩, ⟨(-513241394), (-80412321)⟩, ⟨(-5095290), 222922699⟩, ⟨(-63492240), 20655063⟩, ⟨(-10853992), 14345662⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨89171588, 478064643⟩, ⟨(-445255552), (-62674230)⟩, ⟨(-2413309), 201965602⟩, ⟨(-60217193), 17462439⟩, ⟨(-9733921), 14131271⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1022277378, 1022277379⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4436756148, 4436756152⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar558 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2680
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar558 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨876237752, 1168317004⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4390668530, 4497229009⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2681
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((40803 / 200000) : ℝ)..(13601 / 50000), prawitzNormalCorrection
      ((262871 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
