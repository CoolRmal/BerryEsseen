...
namespace FiniteNormalPanel10_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (12091 / 40000)
def radius : Rat := (12091 / 200000)

def j0 : Jet := ⟨⟨1298261239, 1298261240⟩, ⟨259652247, 259652248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4078607970, 4078607975⟩, ⟨815721591, 815721595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3873147762, 3873147773⟩, ⟨1549259098, 1549259110⟩, ⟨154925909, 154925911⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨969, 971⟩, ⟨387, 389⟩, ⟨38, 39⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93718), (-93715)⟩, ⟨387, 389⟩, ⟨38, 39⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-84514), (-84511)⟩, ⟨(-33458), (-33453)⟩, ⟨(-3208), (-3203)⟩, ⟨26, 30⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5028542, 5028546⟩, ⟨(-33458), (-33453)⟩, ⟨(-3208), (-3203)⟩, ⟨26, 30⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4534676, 4534680⟩, ⟨1783697, 1783705⟩, ⟨166425, 166434⟩, ⟨(-2342), (-2333)⟩, ⟨(-107), (-102)⟩⟩
...
def j16 : Jet := ⟨⟨(-138630901), (-138630896)⟩, ⟨1783697, 1783705⟩, ⟨166425, 166434⟩, ⟨(-2342), (-2333)⟩, ⟨(-107), (-102)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-125015613), (-125015607)⟩, ⟨(-48397730), (-48397719)⟩, ⟨(-4207140), (-4207125)⟩, ⟨122259, 122274⟩, ⟨5061, 5072⟩⟩
...
def j19 : Jet := ⟨⟨1306640152, 1306640159⟩, ⟨(-48397730), (-48397719)⟩, ⟨(-4207140), (-4207125)⟩, ⟨122259, 122274⟩, ⟨5061, 5072⟩⟩
...
def j22 : Jet := ⟨⟨(-98), (-96)⟩, ⟨(-39), (-38)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11737, 11740⟩, ⟨(-39), (-38)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10584, 10587⟩, ⟨4197, 4201⟩, ⟨404, 409⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841593), (-841589)⟩, ⟨4197, 4201⟩, ⟨404, 409⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-758939), (-758934)⟩, ⟨(-299792), (-299784)⟩, ⟨(-28481), (-28472)⟩, ⟨292, 299⟩, ⟨11, 15⟩⟩
...
def j30 : Jet := ⟨⟨35032455, 35032461⟩, ⟨(-299792), (-299784)⟩, ⟨(-28481), (-28472)⟩, ⟨292, 299⟩, ⟨11, 15⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨31591829, 31591836⟩, ⟨12366382, 12366394⟩, ⟨1129849, 1129863⟩, ⟨(-20825), (-20813)⟩, ⟨(-914), (-905)⟩⟩
...
def j33 : Jet := ⟨⟨(-684236054), (-684236046)⟩, ⟨12366382, 12366394⟩, ⟨1129849, 1129863⟩, ⟨(-20825), (-20813)⟩, ⟨(-914), (-905)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-617035513), (-617035504)⟩, ⟨(-235662358), (-235662340)⟩, ⟨(-19201799), (-19201778)⟩, ⟨834846, 834866⟩, ⟨32418, 32433⟩⟩
...
def j36 : Jet := ⟨⟨3677931783, 3677931792⟩, ⟨(-235662358), (-235662340)⟩, ⟨(-19201799), (-19201778)⟩, ⟨834846, 834866⟩, ⟨32418, 32433⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1240818048, 1240818057⟩, ⟨202203917, 202203933⟩, ⟨(-13187144), (-13187125)⟩, ⟨(-682941), (-682923)⟩, ⟨28026, 28040⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5015520982, 5015520995⟩, ⟨321367952, 321367980⟩, ⟨46776626, 46776661⟩, ⟨3536507, 3536543⟩, ⟨353633, 353665⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1448986342, 1448986358⟩, ⟨328970407, 328970437⟩, ⟨13244043, 13244082⟩, ⟨1439672, 1439710⟩, ⟨106664, 106697⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1298261240), (-1298261239)⟩, ⟨(-259652248), (-259652247)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2996706056, 2996706057⟩, ⟨(-259652248), (-259652247)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨488842236, 488842248⟩, ⟨221968454, 221968478⟩, ⟨34133530, 34133565⟩, ⟨3000236, 3000272⟩, ⟨333349, 333382⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4783809532, 4783809544⟩, ⟨221968454, 221968478⟩, ⟨34133530, 34133565⟩, ⟨3000236, 3000272⟩, ⟨333349, 333382⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4532803270, 4532803277⟩, ⟨105160889, 105160902⟩, ⟨14951407, 14951425⟩, ⟨1074534, 1074553⟩, ⟨108339, 108358⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3162650160, 3162650167⟩, ⟨(-200657242), (-200657229)⟩, ⟨4074467, 4074483⟩, ⟨(-154160), (-154144)⟩, ⟨10627, 10645⟩⟩
...
def j47 : Jet := ⟨⟨4191777462, 4191777468⟩, ⟨838355489, 838355494⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4091066841, 4091066854⟩, ⟨1636426730, 1636426744⟩, ⟨163642672, 163642675⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4091066841, 4091066854⟩, ⟨1636426730, 1636426744⟩, ⟨163642672, 163642675⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4091066854), (-4091066841)⟩, ⟨(-1636426744), (-1636426730)⟩, ⟨(-163642675), (-163642672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2045533427), (-2045533420)⟩, ⟨(-818213372), (-818213365)⟩, ⟨(-81821338), (-81821336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2667605026, 2667605035⟩, ⟨(-508192487), (-508192480)⟩, ⟨(-2412609), (-2412605)⟩, ⟨6607423, 6607424⟩, ⟨(-291707), (-291706)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1964322631, 1964322643⟩, ⟨(-498841826), (-498841810)⟩, ⟨24496419, 24496437⟩, ⟨4400314, 4400332⟩, ⟨(-500947), (-500929)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1038608991, 1557913488⟩, ⟨259652247, 259652248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3262886375, 4894329570⟩, ⟨815721591, 815721595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2478814566, 5577332792⟩, ⟨1239407278, 1859110932⟩, ⟨154925909, 154925911⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨620, 1398⟩, ⟨310, 466⟩, ⟨38, 39⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94067), (-93288)⟩, ⟨310, 466⟩, ⟨38, 39⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-122153), (-53840)⟩, ⟨(-40540), (-26314)⟩, ⟨(-3284), (-3112)⟩, ⟨21, 34⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4990903, 5059217⟩, ⟨(-40540), (-26314)⟩, ⟨(-3284), (-3112)⟩, ⟨21, 34⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2880469, 6569768⟩, ⟨1387589, 2174737⟩, ⟨158215, 173105⟩, ⟨(-2873), (-1802)⟩, ⟨(-113), (-94)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140285108), (-136595808)⟩, ⟨1387589, 2174737⟩, ⟨158215, 173105⟩, ⟨(-2873), (-1802)⟩, ⟨(-113), (-94)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-182170592), (-78835449)⟩, ⟨(-59922693), (-36593667)⟩, ⟨(-4568564), (-3761072)⟩, ⟨91977, 152337⟩, ⟨4316, 5671⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1249485173, 1352820317⟩, ⟨(-59922693), (-36593667)⟩, ⟨(-4568564), (-3761072)⟩, ⟨91977, 152337⟩, ⟨4316, 5671⟩⟩
...
def j70 : Jet := ⟨⟨(-141), (-61)⟩, ⟨(-47), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11694, 11775⟩, ⟨(-47), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6749, 15291⟩, ⟨3312, 5080⟩, ⟨394, 416⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845428), (-836885)⟩, ⟨3312, 5080⟩, ⟨394, 416⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1097851), (-483003)⟩, ⟨(-364040), (-234904)⟩, ⟨(-29314), (-27447)⟩, ⟨226, 365⟩, ⟨10, 16⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34693543, 35308392⟩, ⟨(-364040), (-234904)⟩, ⟨(-29314), (-27447)⟩, ⟨226, 365⟩, ⟨10, 16⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨20023169, 45850560⟩, ⟨9538851, 15147947⟩, ⟨1055803, 1190001⟩, ⟨(-25691), (-15919)⟩, ⟨(-988), (-811)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-695804714), (-669977322)⟩, ⟨9538851, 15147947⟩, ⟨1055803, 1190001⟩, ⟨(-25691), (-15919)⟩, ⟨(-988), (-811)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-903553900), (-386673385)⟩, ⟨(-295679344), (-173665961)⟩, ⟨(-21736725), (-16064871)⟩, ⟨615393, 1052325⟩, ⟨25680, 37865⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3391413396, 3908293911⟩, ⟨(-295679344), (-173665961)⟩, ⟨(-21736725), (-16064871)⟩, ⟨615393, 1052325⟩, ⟨25680, 37865⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨949233804, 1541606263⟩, ⟨169023550, 229134172⟩, ⟨(-16586924), (-9807337)⟩, ⟨(-797811), (-540725)⟩, ⟨20746, 35396⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4719896838, 5439249635⟩, ⟨209729727, 474219324⟩, ⟨28720318, 76206676⟩, ⟨673736, 8827038⟩, ⟨(-37332), 1184225⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1043147786, 1952327161⟩, ⟨232098685, 460394064⟩, ⟨(-6404907), 41874808⟩, ⟨(-1562619), 6160773⟩, ⟨(-346483), 848818⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1557913488), (-1038608991)⟩, ⟨(-259652248), (-259652247)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2737053808, 3256358305⟩, ⟨(-259652248), (-259652247)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨253356365, 887452938⟩, ⟨112742758, 418554916⟩, ⟨6719690, 87420771⟩, ⟨(-2793748), 14578346⟩, ⟨(-712451), 2500745⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4548323661, 5182420234⟩, ⟨112742758, 418554916⟩, ⟨6719690, 87420771⟩, ⟨(-2793748), 14578346⟩, ⟨(-712451), 2500745⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4419830469, 4717872977⟩, ⟨51318301, 203365230⟩, ⟨(-1413694), 42177612⟩, ⟨(-3298089), 7148296⟩, ⟨(-876317), 1373547⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2816625362, 3576996935⟩, ⟨(-252515398), (-113013399)⟩, ⟨(-13366280), 28875775⟩, ⟨(-5050394), 5505161⟩, ⟨(-1096558), 1240782⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3353421969, 5030132961⟩, ⟨838355489, 838355494⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2618282777, 5891136268⟩, ⟨1309141382, 1963712092⟩, ⟨163642672, 163642675⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2618282777, 5891136268⟩, ⟨1309141382, 1963712092⟩, ⟨163642672, 163642675⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5891136268), (-2618282777)⟩, ⟨(-1963712092), (-1309141382)⟩, ⟨(-163642675), (-163642672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2945568134), (-1309141388)⟩, ⟨(-981856046), (-654570691)⟩, ⟨(-81821338), (-81821336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2163279626, 3166527969⟩, ⟨(-723887848), (-329692717)⟩, ⟨(-35200725), 41531027⟩, ⟨1022460, 11875993⟩, ⟨(-1074326), 296340⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1418671631, 2637193734⟩, ⟨(-789049475), (-273133732)⟩, ⟨(-30495669), 98437336⟩, ⟨(-10361519), 18271864⟩, ⟨(-3565939), 2265115⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1298261239, 1298261240⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4532803270, 4532803277⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified200
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1038608991, 1557913488⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4419830469, 4717872977⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified201
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (119274157 / 2147483648)

theorem envelope_integral : (∫ s in ((12091 / 50000) : ℝ)..(36273 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((12091 / 50000) : ℝ)..(36273 / 100000), prawitzNormalCorrection
