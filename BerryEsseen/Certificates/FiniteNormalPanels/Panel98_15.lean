...
namespace FiniteNormalPanel98_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (90627 / 800000)
def radius : Rat := (30209 / 800000)

def j0 : Jet := ⟨⟨486550001, 486550002⟩, ⟨162183333, 162183334⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1528541908, 1528541912⟩, ⟨509513967, 509513971⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨543994913, 543994917⟩, ⟨362663274, 362663280⟩, ⟨60443878, 60443880⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨136, 137⟩, ⟨90, 91⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94551), (-94549)⟩, ⟨90, 91⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11976), (-11975)⟩, ⟨(-7973), (-7971)⟩, ⟨(-1323), (-1319)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101080, 5101082⟩, ⟨(-7973), (-7971)⟩, ⟨(-1323), (-1319)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨646096, 646097⟩, ⟨429720, 429722⟩, ⟨70946, 70949⟩, ⟨(-225), (-222)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-142519481), (-142519479)⟩, ⟨429720, 429722⟩, ⟨70946, 70949⟩, ⟨(-225), (-222)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18051331), (-18051329)⟩, ⟨(-11979794), (-11979790)⟩, ⟨(-1960434), (-1960430)⟩, ⟨12008, 12011⟩, ⟨976, 979⟩⟩
...
def j19 : Jet := ⟨⟨1413604434, 1413604437⟩, ⟨(-11979794), (-11979790)⟩, ⟨(-1960434), (-1960430)⟩, ⟨12008, 12011⟩, ⟨976, 979⟩⟩
...
def j22 : Jet := ⟨⟨(-14), (-13)⟩, ⟨(-10), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11821, 11823⟩, ⟨(-10), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1497, 1498⟩, ⟨996, 998⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850680), (-850678)⟩, ⟨996, 998⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-107747), (-107745)⟩, ⟨(-71705), (-71703)⟩, ⟨(-11868), (-11864)⟩, ⟨26, 30⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35683647, 35683650⟩, ⟨(-71705), (-71703)⟩, ⟨(-11868), (-11864)⟩, ⟨26, 30⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4519643, 4519645⟩, ⟨3004012, 3004016⟩, ⟨494623, 494627⟩, ⟨(-2010), (-2006)⟩, ⟨(-166), (-162)⟩⟩
...
def j33 : Jet := ⟨⟨(-711308240), (-711308237)⟩, ⟨3004012, 3004016⟩, ⟨494623, 494627⟩, ⟨(-2010), (-2006)⟩, ⟨(-166), (-162)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-90093368), (-90093366)⟩, ⟨(-59681762), (-59681759)⟩, ⟨(-9694071), (-9694067)⟩, ⟨83786, 83789⟩, ⟨6768, 6772⟩⟩
...
def j36 : Jet := ⟨⟨4204873928, 4204873930⟩, ⟨(-59681762), (-59681759)⟩, ⟨(-9694071), (-9694067)⟩, ⟨83786, 83789⟩, ⟨6768, 6772⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨503089655, 503089659⟩, ⟨163433045, 163433049⟩, ⟨(-2118871), (-2118868)⟩, ⟨(-228295), (-228291)⟩, ⟨1771, 1774⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4386990996, 4386990999⟩, ⟨62266631, 62266636⟩, ⟨10997705, 10997712⟩, ⟨212227, 212234⟩, ⟨20058, 20067⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨513868822, 513868827⟩, ⟨174228333, 174228340⟩, ⟨1493325, 1493332⟩, ⟨179440, 179448⟩, ⟨3496, 3506⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-486550002), (-486550001)⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3808417294, 3808417295⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨61481531, 61481533⟩, ⟨41690890, 41690894⟩, ⟨7425027, 7425032⟩, ⟨164090, 164098⟩, ⟨15913, 15920⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4356448827, 4356448829⟩, ⟨41690890, 41690894⟩, ⟨7425027, 7425032⟩, ⟨164090, 164098⟩, ⟨15913, 15920⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4325598830, 4325598832⟩, ⟨20697828, 20697831⟩, ⟨3636704, 3636708⟩, ⟨64062, 64068⟩, ⟨6064, 6070⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3835578772, 3835578776⟩, ⟨(-144986920), (-144986914)⟩, ⟨2443148, 2443154⟩, ⟨(-80523), (-80515)⟩, ⟨2957, 2964⟩⟩
...
def j47 : Jet := ⟨⟨3859885984, 3859885993⟩, ⟨1286628656, 1286628665⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3468878522, 3468878540⟩, ⟨2312585672, 2312585694⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3468878522, 3468878540⟩, ⟨2312585672, 2312585694⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3468878540), (-3468878522)⟩, ⟨(-2312585694), (-2312585672)⟩, ⟨(-385430950), (-385430943)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1734439270), (-1734439261)⟩, ⟨(-1156292847), (-1156292836)⟩, ⟨(-192715475), (-192715471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2867995428, 2867995440⟩, ⟨(-772122902), (-772122891)⟩, ⟨(-24751533), (-24751525)⟩, ⟨25318008, 25318011⟩, ⟨(-1148731), (-1148729)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2561235423, 2561235438⟩, ⟨(-786352913), (-786352896)⟩, ⟨5592171, 5592187⟩, ⟨22952561, 22952574⟩, ⟨(-1878167), (-1878154)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨324366667, 648733336⟩, ⟨162183333, 162183334⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1019027938, 2038055883⟩, ⟨509513967, 509513971⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨241775516, 967102075⟩, ⟨241775516, 483551038⟩, ⟨60443878, 60443880⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨60, 243⟩, ⟨60, 122⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94627), (-94443)⟩, ⟨60, 122⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-21308), (-5316)⟩, ⟨(-10651), (-5288)⟩, ⟨(-1329), (-1311)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5091748, 5107741⟩, ⟨(-10651), (-5288)⟩, ⟨(-1329), (-1311)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨286628, 1150116⟩, ⟨284229, 574761⟩, ⟨70157, 71513⟩, ⟨(-300), (-146)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142878949), (-142015460)⟩, ⟨284229, 574761⟩, ⟨70157, 71513⟩, ⟨(-300), (-146)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-32172196), (-7994440)⟩, ⟨(-16070098), (-7865020)⟩, ⟨(-1990814), (-1917797)⟩, ⟨7881, 16133⟩, ⟨948, 999⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1399483569, 1423661326⟩, ⟨(-16070098), (-7865020)⟩, ⟨(-1990814), (-1917797)⟩, ⟨7881, 16133⟩, ⟨948, 999⟩⟩
...
def j70 : Jet := ⟨⟨(-25), (-6)⟩, ⟨(-13), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11810, 11830⟩, ⟨(-13), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨664, 2664⟩, ⟨661, 1332⟩, ⟨163, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851513), (-849512)⟩, ⟨661, 1332⟩, ⟨163, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-191737), (-47821)⟩, ⟨(-95832), (-47521)⟩, ⟨(-11938), (-11767)⟩, ⟨17, 38⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35599657, 35743574⟩, ⟨(-95832), (-47521)⟩, ⟨(-11938), (-11767)⟩, ⟨17, 38⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2004002, 8048417⟩, ⟨1982423, 4021534⟩, ⟨487521, 499690⟩, ⟨(-2694), (-1321)⟩, ⟨(-169), (-159)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713823881), (-707779465)⟩, ⟨1982423, 4021534⟩, ⟨487521, 499690⟩, ⟨(-2694), (-1321)⟩, ⟨(-169), (-159)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-160732437), (-39842851)⟩, ⟨(-80254623), (-38937318)⟩, ⟨(-9906739), (-9395429)⟩, ⟨54735, 112780⟩, ⟨6517, 6951⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4134234859, 4255124445⟩, ⟨(-80254623), (-38937318)⟩, ⟨(-9906739), (-9395429)⟩, ⟨54735, 112780⟩, ⟨6517, 6951⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨332042774, 675558425⟩, ⟨158395773, 167023546⟩, ⟨(-2851089), (-1388048)⟩, ⟨(-234303), (-219853)⟩, ⟨1158, 2389⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4335183215, 4461948753⟩, ⟨39669910, 86616274⟩, ⟨9935207, 12373444⟩, ⟨60242, 390358⟩, ⟨12901, 29871⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨335151855, 701823056⟩, ⟨162945781, 187141090⟩, ⟨(-730845), 3913535⟩, ⟨70150, 307850⟩, ⟨(-8554), 17122⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-648733336), (-324366667)⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3646233960, 3970600629⟩, ⟨(-162183334), (-162183333)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨26153113, 114682038⟩, ⟨25430498, 61159922⟩, ⟨5943112, 9433136⟩, ⟨(-52742), 441654⟩, ⟨1860, 35990⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4321120409, 4409649334⟩, ⟨25430498, 61159922⟩, ⟨5943112, 9433136⟩, ⟨(-52742), 441654⟩, ⟨1860, 35990⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308024006, 4351930569⟩, ⟨12548816, 30487280⟩, ⟨2825871, 4683997⟩, ⟨(-59440), 211927⟩, ⟨(-3121), 17435⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3657318519, 4023261894⟩, ⟨(-153680959), (-134491565)⟩, ⟨1247799, 3856392⟩, ⟨(-231825), 89214⟩, ⟨(-10889), 18364⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2573257320, 5146514658⟩, ⟨1286628656, 1286628665⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1541723784, 6166895183⟩, ⟨1541723778, 3083447594⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1541723784, 6166895183⟩, ⟨1541723778, 3083447594⟩, ⟨385430943, 385430950⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6166895183), (-1541723784)⟩, ⟨(-3083447594), (-1541723778)⟩, ⟨(-385430950), (-385430943)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3083447592), (-770861892)⟩, ⟨(-1541723797), (-770861889)⟩, ⟨(-192715475), (-192715471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2094935679, 3589323235⟩, ⟨(-1288425421), (-375999620)⟩, ⟨(-127310922), 137247041⟩, ⟨(-5174673), 53774357⟩, ⟨(-7904861), 3320601⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1783912781, 3362257825⟩, ⟨(-1335349758), (-385777454)⟩, ⟨(-106874471), 177889384⟩, ⟨(-11108839), 54893233⟩, ⟨(-9479098), 3503820⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨486550001, 486550002⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4325598830, 4325598832⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1984
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨324366667, 648733336⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308024006, 4351930569⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1985
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (96812303 / 2147483648)

theorem envelope_integral : (∫ s in ((30209 / 400000) : ℝ)..(30209 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (30209 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (30209 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((30209 / 400000) : ℝ)..(30209 / 200000), prawitzNormalCorrection
