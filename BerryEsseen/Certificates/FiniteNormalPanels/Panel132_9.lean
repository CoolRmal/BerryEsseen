...
namespace FiniteNormalPanel132_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (27001 / 160000)
def radius : Rat := (27001 / 800000)

def j0 : Jet := ⟨⟨724802574, 724802575⟩, ⟨144960514, 144960515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2277034441, 2277034446⟩, ⟨455406885, 455406890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1207200308, 1207200314⟩, ⟨482880120, 482880128⟩, ⟨48288011, 48288013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨302, 303⟩, ⟨120, 121⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94385), (-94383)⟩, ⟨120, 121⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-26530), (-26528)⟩, ⟨(-10579), (-10576)⟩, ⟨(-1046), (-1043)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5086526, 5086529⟩, ⟨(-10579), (-10576)⟩, ⟨(-1046), (-1043)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1429686, 1429688⟩, ⟨568900, 568903⟩, ⟨55702, 55706⟩, ⟨(-237), (-233)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-141735891), (-141735888)⟩, ⟨568900, 568903⟩, ⟨55702, 55706⟩, ⟨(-237), (-233)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-39838165), (-39838163)⟩, ⟨(-15775364), (-15775361)⟩, ⟨(-1513910), (-1513906)⟩, ⟨12591, 12595⟩, ⟨595, 599⟩⟩
...
def j19 : Jet := ⟨⟨1391817600, 1391817603⟩, ⟨(-15775364), (-15775361)⟩, ⟨(-1513910), (-1513906)⟩, ⟨12591, 12595⟩, ⟨595, 599⟩⟩
...
def j25 : Jet := ⟨⟨3317, 3319⟩, ⟨1323, 1325⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848860), (-848857)⟩, ⟨1323, 1325⟩, ⟨129, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-238592), (-238590)⟩, ⟨(-95066), (-95063)⟩, ⟨(-9360), (-9356)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35552802, 35552805⟩, ⟨(-95066), (-95063)⟩, ⟨(-9360), (-9356)⟩, ⟨27, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9992940, 9992942⟩, ⟨3970455, 3970458⟩, ⟨386397, 386402⟩, ⟨(-2115), (-2110)⟩, ⟨(-104), (-100)⟩⟩
...
def j33 : Jet := ⟨⟨(-705834943), (-705834940)⟩, ⟨3970455, 3970458⟩, ⟨386397, 386402⟩, ⟨(-2115), (-2110)⟩, ⟨(-104), (-100)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-198391305), (-198391302)⟩, ⟨(-78240535), (-78240530)⟩, ⟨(-7380653), (-7380647)⟩, ⟨87486, 87490⟩, ⟨4076, 4080⟩⟩
...
def j36 : Jet := ⟨⟨4096575991, 4096575994⟩, ⟨(-78240535), (-78240530)⟩, ⟨(-7380653), (-7380647)⟩, ⟨87486, 87490⟩, ⟨4076, 4080⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨737890743, 737890747⟩, ⟨139214626, 139214632⟩, ⟨(-2475325), (-2475320)⟩, ⟨(-153849), (-153845)⟩, ⟨1650, 1654⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4502966404, 4502966408⟩, ⟨86002182, 86002190⟩, ⟨9755380, 9755390⟩, ⟨245093, 245102⟩, ⟨15934, 15943⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨773625733, 773625739⟩, ⟨160732072, 160732082⟩, ⟨1868432, 1868442⟩, ⟨147446, 147456⟩, ⟨3706, 3718⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-724802575), (-724802574)⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3570164721, 3570164722⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨139348389, 139348392⟩, ⟨57903334, 57903340⟩, ⟨6688230, 6688236⟩, ⟨192960, 192970⟩, ⟨13180, 13191⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4434315685, 4434315688⟩, ⟨57903334, 57903340⟩, ⟨6688230, 6688236⟩, ⟨192960, 192970⟩, ⟨13180, 13191⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4364085339, 4364085341⟩, ⟨28493132, 28493136⟩, ⟨3198135, 3198139⟩, ⟨74070, 74077⟩, ⟨4829, 4837⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3627618662, 3627618665⟩, ⟨(-123608599), (-123608592)⟩, ⟨1696750, 1696756⟩, ⟨(-46372), (-46364)⟩, ⟨1513, 1522⟩⟩
...
def j47 : Jet := ⟨⟨7456189451, 7456189464⟩, ⟨1491237882, 1491237893⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12944164017, 12944164063⟩, ⟨5177665578, 5177665626⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12944164017, 12944164063⟩, ⟨5177665578, 5177665626⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12944164063), (-12944164017)⟩, ⟨(-5177665626), (-5177665578)⟩, ⟨(-517766563), (-517766555)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6472082032), (-6472082008)⟩, ⟨(-2588832813), (-2588832789)⟩, ⟨(-258883282), (-258883277)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨951747900, 951747916⟩, ⟨(-573675203), (-573675187)⟩, ⟨115526593, 115526603⟩, ⟨(-159042), (-159038)⟩, ⟨(-3457774), (-3457771)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨803866061, 803866076⟩, ⟨(-511929184), (-511929166)⟩, ⟨114462451, 114462464⟩, ⟨(-3696083), (-3696073)⟩, ⟨(-2863765), (-2863755)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨579842059, 869763090⟩, ⟨144960514, 144960515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1821627552, 2732441335⟩, ⟨455406885, 455406890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨772608196, 1738368452⟩, ⟨386304094, 579456152⟩, ⟨48288011, 48288013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨193, 436⟩, ⟨96, 146⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94494), (-94250)⟩, ⟨96, 146⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-38247), (-16954)⟩, ⟨(-12732), (-8417)⟩, ⟨(-1053), (-1033)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5074809, 5096103⟩, ⟨(-12732), (-8417)⟩, ⟨(-1053), (-1033)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨912891, 2062625⟩, ⟨451291, 686028⟩, ⟨54910, 56354⟩, ⟨(-287), (-184)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142252686), (-141102951)⟩, ⟨451291, 686028⟩, ⟨54910, 56354⟩, ⟨(-287), (-184)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-57576127), (-25382567)⟩, ⟨(-19110862), (-12413616)⟩, ⟨(-1548870), (-1471044)⟩, ⟨9894, 15284⟩, ⟨573, 617⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1374079638, 1406273199⟩, ⟨(-19110862), (-12413616)⟩, ⟨(-1548870), (-1471044)⟩, ⟨9894, 15284⟩, ⟨573, 617⟩⟩
...
def j72 : Jet := ⟨⟨2121, 4783⟩, ⟨1053, 1594⟩, ⟨128, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850056), (-847393)⟩, ⟨1053, 1594⟩, ⟨128, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-344057), (-152434)⟩, ⟨(-114497), (-75571)⟩, ⟨(-9441), (-9257)⟩, ⟨21, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35447337, 35638961⟩, ⟨(-114497), (-75571)⟩, ⟨(-9441), (-9257)⟩, ⟨21, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6376510, 14424708⟩, ⟨3141912, 4794642⟩, ⟨379261, 392225⟩, ⟨(-2559), (-1666)⟩, ⟨(-107), (-98)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709451373), (-701403174)⟩, ⟨3141912, 4794642⟩, ⟨379261, 392225⟩, ⟨(-2559), (-1666)⟩, ⟨(-107), (-98)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-287147213), (-126173217)⟩, ⟨(-95150550), (-61145997)⟩, ⟨(-7625494), (-7080203)⟩, ⟨68400, 106525⟩, ⟨3874, 4244⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4007820083, 4168794079⟩, ⟨(-95150550), (-61145997)⟩, ⟨(-7625494), (-7080203)⟩, ⟨68400, 106525⟩, ⟨3874, 4244⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨582789379, 894665490⟩, ⟨133539088, 143845921⟩, ⟨(-3011762), (-1940162)⟩, ⟨(-160035), (-146254)⟩, ⟨1292, 2014⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4424959286, 4602687669⟩, ⟨64903313, 109273436⟩, ⟨8467241, 11351607⟩, ⟨116810, 401894⟩, ⟨8613, 25758⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨600428151, 958765350⟩, ⟨146387607, 176914275⟩, ⟨(-60642), 4025478⟩, ⟨30986, 283905⟩, ⟨(-5903), 14952⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-869763090), (-579842059)⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3425204206, 3715125237⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨83938698, 214025145⟩, ⟨40929410, 78985132⟩, ⟨4962329, 9084504⟩, ⟨3666, 458382⟩, ⟨(-581), 33839⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4378905994, 4508992441⟩, ⟨40929410, 78985132⟩, ⟨4962329, 9084504⟩, ⟨3666, 458382⟩, ⟨(-581), 33839⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4336733567, 4400678934⟩, ⟨19973108, 39112221⟩, ⟨2247752, 4452514⟩, ⟨(-38342), 216633⟩, ⟨(-4528), 16521⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3458512493, 3806565276⟩, ⟨(-132600012), (-112538301)⟩, ⟨472478, 3177286⟩, ⟨(-183444), 111523⟩, ⟨(-11229), 15586⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5964951559, 8947427356⟩, ⟨1491237882, 1491237893⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8284264966, 18639596247⟩, ⟨4142132460, 6213198752⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8284264966, 18639596247⟩, ⟨4142132460, 6213198752⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18639596247), (-8284264966)⟩, ⟨(-6213198752), (-4142132460)⟩, ⟨(-517766563), (-517766555)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9319798124), (-4142132483)⟩, ⟨(-3106599376), (-2071066230)⟩, ⟨(-258883282), (-258883277)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨490421200, 1637267301⟩, ⟨(-1184254321), (-236484870)⟩, ⟨(-41670450), 398731796⟩, ⟨(-86632868), 57634951⟩, ⟨(-22438978), 16921502⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨394910538, 1451085521⟩, ⟨(-1100134814), (-203279090)⟩, ⟨(-30681486), 391163123⟩, ⟨(-90037607), 52384002⟩, ⟨(-21732574), 18023416⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨724802574, 724802575⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4364085339, 4364085341⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2654
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨579842059, 869763090⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4336733567, 4400678934⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2655
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (14270449 / 1073741824)

theorem envelope_integral : (∫ s in ((27001 / 200000) : ℝ)..(81003 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((27001 / 200000) : ℝ)..(81003 / 400000), prawitzNormalCorrection
