...
namespace FiniteNormalPanel25_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (563 / 2500)
def radius : Rat := (563 / 12500)

def j0 : Jet := ⟨⟨967226635, 967226636⟩, ⟨193445327, 193445328⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3038632090, 3038632095⟩, ⟨607726418, 607726422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2149791684, 2149791692⟩, ⟨859916672, 859916682⟩, ⟨85991667, 85991669⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨538, 539⟩, ⟨215, 216⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94149), (-94147)⟩, ⟨215, 216⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-47126), (-47124)⟩, ⟨(-18744), (-18740)⟩, ⟨(-1833), (-1828)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5065930, 5065933⟩, ⟨(-18744), (-18740)⟩, ⟨(-1833), (-1828)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2535687, 2535689⟩, ⟨1004891, 1004896⟩, ⟨96756, 96762⟩, ⟨(-739), (-734)⟩, ⟨(-36), (-32)⟩⟩
...
def j16 : Jet := ⟨⟨(-140629890), (-140629887)⟩, ⟨1004891, 1004896⟩, ⟨96756, 96762⟩, ⟨(-739), (-734)⟩, ⟨(-36), (-32)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-70390518), (-70390515)⟩, ⟨(-27653223), (-27653217)⟩, ⟨(-2565998), (-2565991)⟩, ⟨39120, 39127⟩, ⟨1770, 1776⟩⟩
...
def j19 : Jet := ⟨⟨1361265247, 1361265251⟩, ⟨(-27653223), (-27653217)⟩, ⟨(-2565998), (-2565991)⟩, ⟨39120, 39127⟩, ⟨1770, 1776⟩⟩
...
def j22 : Jet := ⟨⟨(-55), (-53)⟩, ⟨(-22), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11780, 11783⟩, ⟨(-22), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5896, 5898⟩, ⟨2346, 2350⟩, ⟨228, 231⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846281), (-846278)⟩, ⟨2346, 2350⟩, ⟨228, 231⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-423596), (-423593)⟩, ⟨(-168265), (-168260)⟩, ⟨(-16361), (-16356)⟩, ⟨89, 95⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35367798, 35367802⟩, ⟨(-168265), (-168260)⟩, ⟨(-16361), (-16356)⟩, ⟨89, 95⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17702905, 17702908⟩, ⟨6996938, 6996943⟩, ⟨666236, 666243⟩, ⟨(-6601), (-6594)⟩, ⟨(-310), (-304)⟩⟩
...
def j33 : Jet := ⟨⟨(-698124978), (-698124974)⟩, ⟨6996938, 6996943⟩, ⟨666236, 666243⟩, ⟨(-6601), (-6594)⟩, ⟨(-310), (-304)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-349437650), (-349437646)⟩, ⟨(-136272832), (-136272826)⟩, ⟨(-12243140), (-12243132)⟩, ⟨270174, 270182⟩, ⟨11861, 11868⟩⟩
...
def j36 : Jet := ⟨⟨3945529646, 3945529650⟩, ⟨(-136272832), (-136272826)⟩, ⟨(-12243140), (-12243132)⟩, ⟨270174, 270182⟩, ⟨11861, 11868⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨963077010, 963077015⟩, ⟨173051115, 173051122⟩, ⟨(-5728268), (-5728260)⟩, ⟨(-335406), (-335398)⟩, ⟨6787, 6794⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4675353047, 4675353053⟩, ⟨161479858, 161479868⟩, ⟨20085079, 20085092⟩, ⟨874627, 874640⟩, ⟨67409, 67425⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1048372367, 1048372375⟩, ⟨224586714, 224586727⟩, ⟨4774441, 4774456⟩, ⟨424899, 424915⟩, ⟨18344, 18359⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-967226636), (-967226635)⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3327740660, 3327740661⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨255900579, 255900584⟩, ⟨109640184, 109640194⟩, ⟨14074605, 14074617⟩, ⟨706744, 706758⟩, ⟨58697, 58712⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4550867875, 4550867880⟩, ⟨109640184, 109640194⟩, ⟨14074605, 14074617⟩, ⟨706744, 706758⟩, ⟨58697, 58712⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4421066465, 4421066468⟩, ⟨53256494, 53256500⟩, ⟨6515815, 6515823⟩, ⟨264802, 264811⟩, ⟨20519, 20528⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3425442296, 3425442300⟩, ⟨(-157861704), (-157861696)⟩, ⟨2649780, 2649788⟩, ⟨(-88305), (-88296)⟩, ⟨3970, 3980⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨25626351868, 25626351870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value213

def j47 : Jet := ⟨⟨5771054440, 5771054447⟩, ⟨1154210888, 1154210895⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7754440733, 7754440753⟩, ⟨3101776292, 3101776318⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7754440733, 7754440753⟩, ⟨3101776292, 3101776318⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7754440753), (-7754440733)⟩, ⟨(-3101776318), (-3101776292)⟩, ⟨(-310177634), (-310177629)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3877220377), (-3877220366)⟩, ⟨(-1550888159), (-1550888146)⟩, ⟨(-155088817), (-155088814)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1741432802, 1741432813⟩, ⟨(-628821443), (-628821432)⟩, ⟨50649767, 50649773⟩, ⟨9041140, 9041142⟩, ⟨(-1730644), (-1730642)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1388876134, 1388876145⟩, ⟨(-565521681), (-565521666)⟩, ⟨64582350, 64582362⟩, ⟨4925349, 4925360⟩, ⟨(-1666796), (-1666784)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨773781308, 1160671963⟩, ⟨193445327, 193445328⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2430905672, 3646358513⟩, ⟨607726418, 607726422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1375866678, 3095700035⟩, ⟨687933338, 1031900018⟩, ⟨85991667, 85991669⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨344, 776⟩, ⟨172, 259⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94343), (-93910)⟩, ⟨172, 259⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-68000), (-30083)⟩, ⟨(-22612), (-14854)⟩, ⟨(-1856), (-1801)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5045056, 5082974⟩, ⟨(-22612), (-14854)⟩, ⟨(-1856), (-1801)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1616153, 3663675⟩, ⟨791777, 1216467⟩, ⟨94238, 98814⟩, ⟨(-898), (-576)⟩, ⟨(-38), (-32)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141549424), (-139501901)⟩, ⟨791777, 1216467⟩, ⟨94238, 98814⟩, ⟨(-898), (-576)⟩, ⟨(-38), (-32)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-102025121), (-44688586)⟩, ⟨(-33754734), (-21467495)⟩, ⟨(-2677024), (-2429547)⟩, ⟨30298, 47913⟩, ⟨1642, 1877⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1329630644, 1386967180⟩, ⟨(-33754734), (-21467495)⟩, ⟨(-2677024), (-2429547)⟩, ⟨30298, 47913⟩, ⟨1642, 1877⟩⟩
...
def j72 : Jet := ⟨⟨3766, 8507⟩, ⟨1864, 2831⟩, ⟨225, 235⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848411), (-843669)⟩, ⟨1864, 2831⟩, ⟨225, 235⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-611513), (-270264)⟩, ⟨(-203241), (-133091)⟩, ⟨(-16617), (-16040)⟩, ⟨71, 114⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35179881, 35521131⟩, ⟨(-203241), (-133091)⟩, ⟨(-16617), (-16040)⟩, ⟨71, 114⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11269661, 25602702⟩, ⟨5488339, 8491600⟩, ⟨643544, 684732⟩, ⟨(-8041), (-5150)⟩, ⟨(-322), (-289)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704558222), (-690225180)⟩, ⟨5488339, 8491600⟩, ⟨643544, 684732⟩, ⟨(-8041), (-5150)⟩, ⟨(-322), (-289)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-507827130), (-221109442)⟩, ⟨(-167517555), (-104434197)⟩, ⟨(-13021077), (-11285628)⟩, ⟨207165, 332879⟩, ⟨10719, 12794⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3787140166, 4073857854⟩, ⟨(-167517555), (-104434197)⟩, ⟨(-13021077), (-11285628)⟩, ⟨207165, 332879⟩, ⟨10719, 12794⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨752556760, 1177512944⟩, ⟨159481960, 184101786⟩, ⟨(-7048956), (-4412690)⟩, ⟨(-361644), (-303096)⟩, ⟨5216, 8374⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4528077496, 4870890241⟩, ⟨116078211, 215455355⟩, ⟨15519620, 26277558⟩, ⟨321408, 1655435⟩, ⟨18328, 144411⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨793401927, 1335408611⟩, ⟨188476897, 267857934⟩, ⟨(-964599), 11787491⟩, ⟨(-131153), 1141427⟩, ⟨(-40626), 95913⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1160671963), (-773781308)⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3134295333, 3521185988⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨146563774, 415210649⟩, ⟨69634026, 166566946⟩, ⟨7671132, 24035134⟩, ⟨(-201874), 2180064⟩, ⟨(-44272), 234367⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4441531070, 4710177945⟩, ⟨69634026, 166566946⟩, ⟨7671132, 24035134⟩, ⟨(-201874), 2180064⟩, ⟨(-44272), 234367⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4367634450, 4497783925⟩, ⟨33247024, 81897833⟩, ⟨2916992, 11691083⟩, ⟨(-318479), 1049693⟩, ⟨(-57098), 120232⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3187324915, 3687463174⟩, ⟨(-178317842), (-129575135)⟩, ⟨(-1559975), 8087373⟩, ⟨(-787669), 729200⟩, ⟨(-94091), 112917⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4616843552, 6925265335⟩, ⟨1154210888, 1154210895⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4962842069, 11166394679⟩, ⟨2481421034, 3722131580⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4962842069, 11166394679⟩, ⟨2481421034, 3722131580⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11166394679), (-4962842069)⟩, ⟨(-3722131580), (-2481421034)⟩, ⟨(-310177634), (-310177629)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5583197340), (-2481421034)⟩, ⟨(-1861065790), (-1240710517)⟩, ⟨(-155088817), (-155088814)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1170586032, 2410159884⟩, ⟨(-1044353962), (-338153541)⟩, ⟨(-38187374), 183996959⟩, ⟨(-18435747), 30656381⟩, ⟨(-6642966), 2686576⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨868699984, 2069253432⟩, ⟨(-996699391), (-286261561)⟩, ⟨(-23459559), 205869047⟩, ⟨(-25875768), 28694148⟩, ⟨(-7278155), 3673343⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨967226635, 967226636⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4421066465, 4421066468⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar213 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified496
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar213 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨773781308, 1160671963⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4367634450, 4497783925⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified497
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((563 / 3125) : ℝ)..(1689 / 6250), prawitzNormalCorrection
      ((29833 / 10000) * sqrt n) s) ≤ (upper : ℝ) :=
