...
namespace FiniteNormalPanel168_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (12521 / 80000)
def radius : Rat := (12521 / 400000)

def j0 : Jet := ⟨⟨672216068, 672216069⟩, ⟨134443213, 134443214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2111829060, 2111829065⟩, ⟨422365810, 422365814⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1038383221, 1038383227⟩, ⟨415353286, 415353292⟩, ⟨41535328, 41535330⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨259, 261⟩, ⟨103, 105⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94428), (-94425)⟩, ⟨103, 105⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-22830), (-22828)⟩, ⟨(-9108), (-9105)⟩, ⟨(-903), (-899)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5090226, 5090229⟩, ⟨(-9108), (-9105)⟩, ⟨(-903), (-899)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1230650, 1230652⟩, ⟨490057, 490060⟩, ⟨48126, 48130⟩, ⟨(-177), (-173)⟩, ⟨(-9), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-141934927), (-141934924)⟩, ⟨490057, 490060⟩, ⟨48126, 48130⟩, ⟨(-177), (-173)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-34315244), (-34315242)⟩, ⟨(-13607619), (-13607615)⟩, ⟨(-1313584), (-1313579)⟩, ⟨9350, 9354⟩, ⟨444, 449⟩⟩
...
def j19 : Jet := ⟨⟨1397340521, 1397340524⟩, ⟨(-13607619), (-13607615)⟩, ⟨(-1313584), (-1313579)⟩, ⟨9350, 9354⟩, ⟨444, 449⟩⟩
...
def j22 : Jet := ⟨⟨(-27), (-25)⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11808, 11811⟩, ⟨(-11), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2854, 2856⟩, ⟨1138, 1141⟩, ⟨111, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849323), (-849320)⟩, ⟨1138, 1141⟩, ⟨111, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-205339), (-205337)⟩, ⟨(-81861), (-81859)⟩, ⟨(-8078), (-8074)⟩, ⟨20, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35586055, 35586058⟩, ⟨(-81861), (-81859)⟩, ⟨(-8078), (-8074)⟩, ⟨20, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8603549, 8603550⟩, ⟨3421627, 3421630⟩, ⟨334271, 334275⟩, ⟨(-1570), (-1565)⟩, ⟨(-79), (-74)⟩⟩
...
def j33 : Jet := ⟨⟨(-707224334), (-707224332)⟩, ⟨3421627, 3421630⟩, ⟨334271, 334275⟩, ⟨(-1570), (-1565)⟩, ⟨(-79), (-74)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-170983814), (-170983811)⟩, ⟨(-67566289), (-67566285)⟩, ⟨(-6427643), (-6427639)⟩, ⟨65035, 65039⟩, ⟨3060, 3065⟩⟩
...
def j36 : Jet := ⟨⟨4123983482, 4123983485⟩, ⟨(-67566289), (-67566285)⟩, ⟨(-6427643), (-6427639)⟩, ⟨65035, 65039⟩, ⟨3060, 3065⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨687070265, 687070269⟩, ⟨130723205, 130723210⟩, ⟨(-1984058), (-1984052)⟩, ⟨(-124581), (-124576)⟩, ⟨1137, 1141⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4473040239, 4473040243⟩, ⟨73285140, 73285147⟩, ⟨8172362, 8172370⟩, ⟨177570, 177579⟩, ⟨11164, 11175⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨715556773, 715556779⟩, ⟨147866596, 147866604⟩, ⟨1471555, 1471565⟩, ⟨113541, 113552⟩, ⟨2471, 2482⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-672216069), (-672216068)⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3622751227, 3622751228⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨119214294, 119214297⟩, ⟨49270196, 49270202⟩, ⟨5581064, 5581070⟩, ⟨139156, 139164⟩, ⟨9142, 9153⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4414181590, 4414181593⟩, ⟨49270196, 49270202⟩, ⟨5581064, 5581070⟩, ⟨139156, 139164⟩, ⟨9142, 9153⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4354166460, 4354166463⟩, ⟨24300159, 24300163⟩, ⟨2684783, 2684788⟩, ⟨53647, 53653⟩, ⟨3380, 3388⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3672684981, 3672684986⟩, ⟨(-115799416), (-115799410)⟩, ⟨1503924, 1503931⟩, ⟨(-38791), (-38784)⟩, ⟨1170, 1179⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨51587930920, 51587930928⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value676

def j47 : Jet := ⟨⟨8074156027, 8074156041⟩, ⟨1614831198, 1614831211⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15178694284, 15178694338⟩, ⟨6071477686, 6071477746⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15178694284, 15178694338⟩, ⟨6071477686, 6071477746⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15178694338), (-15178694284)⟩, ⟨(-6071477746), (-6071477686)⟩, ⟨(-607147776), (-607147765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7589347169), (-7589347142)⟩, ⟨(-3035738873), (-3035738843)⟩, ⟨(-303573888), (-303573882)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨733748722, 733748734⟩, ⟨(-518623171), (-518623156)⟩, ⟨131422484, 131422494⟩, ⟨(-6525738), (-6525733)⟩, ⟨(-3491439), (-3491436)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨627438517, 627438529⟩, ⟨(-463264811), (-463264795)⟩, ⟨126621019, 126621033⟩, ⟨(-9311846), (-9311835)⟩, ⟨(-2758734), (-2758722)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨537772855, 806659283⟩, ⟨134443213, 134443214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1689463250, 2534194878⟩, ⟨422365810, 422365814⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨664565263, 1495271847⟩, ⟨332282628, 498423952⟩, ⟨41535328, 41535330⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨166, 375⟩, ⟨83, 125⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94521), (-94311)⟩, ⟨83, 125⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-32908), (-14592)⟩, ⟨(-10958), (-7252)⟩, ⟨(-908), (-893)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5080148, 5098465⟩, ⟨(-10958), (-7252)⟩, ⟨(-908), (-893)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨786057, 1775006⟩, ⟨389213, 590547⟩, ⟨47539, 48607⟩, ⟨(-212), (-137)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142379520), (-141390570)⟩, ⟨389213, 590547⟩, ⟨47539, 48607⟩, ⟨(-212), (-137)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-49568734), (-21877526)⟩, ⟨(-16462689), (-10733166)⟩, ⟨(-1339444), (-1281889)⟩, ⟨7366, 11332⟩, ⟨430, 461⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1382087031, 1409778240⟩, ⟨(-16462689), (-10733166)⟩, ⟨(-1339444), (-1281889)⟩, ⟨7366, 11332⟩, ⟨430, 461⟩⟩
...
def j70 : Jet := ⟨⟨(-38), (-16)⟩, ⟨(-13), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11797, 11820⟩, ⟨(-13), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1825, 4116⟩, ⟨907, 1371⟩, ⟨111, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850352), (-848060)⟩, ⟨907, 1371⟩, ⟨111, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-296046), (-131221)⟩, ⟨(-98542), (-65132)⟩, ⟨(-8137), (-8000)⟩, ⟨15, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35495348, 35660174⟩, ⟨(-98542), (-65132)⟩, ⟨(-8137), (-8000)⟩, ⟨15, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5492236, 12414916⟩, ⟨2711811, 4128229⟩, ⟨328995, 338584⟩, ⟨(-1896), (-1237)⟩, ⟨(-79), (-72)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710335647), (-703412966)⟩, ⟨2711811, 4128229⟩, ⟨328995, 338584⟩, ⟨(-1896), (-1237)⟩, ⟨(-79), (-72)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-247299880), (-108839902)⟩, ⟨(-82013693), (-52982727)⟩, ⟨(-6608737), (-6205541)⟩, ⟨51016, 79025⟩, ⟨2932, 3169⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4047667416, 4186127394⟩, ⟨(-82013693), (-52982727)⟩, ⟨(-6608737), (-6205541)⟩, ⟨51016, 79025⟩, ⟨2932, 3169⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨543656118, 831823050⟩, ⟨126200412, 134415191⟩, ⟨(-2409260), (-1559738)⟩, ⟨(-128824), (-119373)⟩, ⟨893, 1388⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4406637050, 4557376429⟩, ⟨55773660, 92341400⟩, ⟨7238337, 9311972⟩, ⟨88258, 283909⟩, ⟨6651, 17064⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨557791253, 882644850⟩, ⟨136541458, 160511660⟩, ⟨(-1417), 3093110⟩, ⟨35363, 203684⟩, ⟨(-3644), 9486⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-806659283), (-537772855)⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3488308013, 3757194441⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨72440850, 181389491⟩, ⟨35465522, 65972466⟩, ⟨4340210, 7269960⟩, ⟨9078, 314910⟩, ⟨748, 21354⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4367408146, 4476356787⟩, ⟨35465522, 65972466⟩, ⟨4340210, 7269960⟩, ⟨9078, 314910⟩, ⟨748, 21354⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4331036268, 4384724166⟩, ⟨17369765, 32711523⟩, ⟨2003662, 3569877⟩, ⟨(-22463), 148109⟩, ⟨(-2221), 10296⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3517602691, 3835712854⟩, ⟨(-123145367), (-106956547)⟩, ⟨603391, 2579176⟩, ⟨(-131398), 66846⟩, ⟨(-6580), 9711⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6459324828, 9688987251⟩, ⟨1614831198, 1614831211⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9714364361, 21857319854⟩, ⟨4857182152, 7285773296⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9714364361, 21857319854⟩, ⟨4857182152, 7285773296⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21857319854), (-9714364361)⟩, ⟨(-7285773296), (-4857182152)⟩, ⟨(-607147776), (-607147765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10928659927), (-4857182180)⟩, ⟨(-3642886648), (-2428591076)⟩, ⟨(-303573888), (-303573882)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨337198671, 1386167981⟩, ⟨(-1175713919), (-190669131)⟩, ⟨(-44069191), 474772314⟩, ⟨(-125245610), 67860134⟩, ⟨(-31168092), 28115003⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨276167633, 1237947108⟩, ⟨(-1089740815), (-164556282)⟩, ⟨(-34561380), 458548118⟩, ⟨(-126214401), 61862294⟩, ⟨(-29827910), 29023965⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨672216068, 672216069⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4354166460, 4354166463⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar676 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3396
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar676 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨537772855, 806659283⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4331036268, 4384724166⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3397
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((12521 / 100000) : ℝ)..(37563 / 200000), prawitzNormalCorrection
      ((275557 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
