...
namespace FiniteNormalPanel65_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8113 / 40000)
def radius : Rat := (8113 / 200000)

def j0 : Jet := ⟨⟨871126741, 871126742⟩, ⟨174225348, 174225349⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2736725369, 2736725374⟩, ⟨547345073, 547345077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1743823696, 1743823703⟩, ⟨697529476, 697529484⟩, ⟨69752947, 69752949⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-38268), (-38266)⟩, ⟨(-15237), (-15234)⟩, ⟨(-1497), (-1493)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5074788, 5074791⟩, ⟨(-15237), (-15234)⟩, ⟨(-1497), (-1493)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2060443, 2060445⟩, ⟨817990, 817993⟩, ⟨79334, 79338⟩, ⟨(-491), (-486)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-141105134), (-141105131)⟩, ⟨817990, 817993⟩, ⟨79334, 79338⟩, ⟨(-491), (-486)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-57290885), (-57290883)⟩, ⟨(-22584239), (-22584235)⟩, ⟨(-2126580), (-2126574)⟩, ⟨25968, 25973⟩, ⟨1197, 1203⟩⟩
...
def j19 : Jet := ⟨⟨1374364880, 1374364883⟩, ⟨(-22584239), (-22584235)⟩, ⟨(-2126580), (-2126574)⟩, ⟨25968, 25973⟩, ⟨1197, 1203⟩⟩
...
def j25 : Jet := ⟨⟨4787, 4789⟩, ⟨1906, 1910⟩, ⟨187, 190⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847390), (-847387)⟩, ⟨1906, 1910⟩, ⟨187, 190⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-344054), (-344052)⟩, ⟨(-136849), (-136844)⟩, ⟨(-13379), (-13373)⟩, ⟨59, 63⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35447340, 35447343⟩, ⟨(-136849), (-136844)⟩, ⟨(-13379), (-13373)⟩, ⟨59, 63⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨14392172, 14392175⟩, ⟨5701306, 5701310⟩, ⟨548027, 548034⟩, ⟨(-4373), (-4367)⟩, ⟨(-209), (-204)⟩⟩
...
def j33 : Jet := ⟨⟨(-701435711), (-701435707)⟩, ⟨5701306, 5701310⟩, ⟨548027, 548034⟩, ⟨(-4373), (-4367)⟩, ⟨(-209), (-204)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-284793838), (-284793834)⟩, ⟨(-111602717), (-111602712)⟩, ⟨(-10243320), (-10243313)⟩, ⟨179819, 179825⟩, ⟨8104, 8110⟩⟩
...
def j36 : Jet := ⟨⟨4010173458, 4010173462⟩, ⟨(-111602717), (-111602712)⟩, ⟨(-10243320), (-10243313)⟩, ⟨179819, 179825⟩, ⟨8104, 8110⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨875736408, 875736412⟩, ⟨160756750, 160756756⟩, ⟨(-4233151), (-4233144)⟩, ⟨(-254463), (-254457)⟩, ⟨4071, 4077⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4599986571, 4599986576⟩, ⟨128017148, 128017157⟩, ⟨15312593, 15312605⟩, ⟨546871, 546881⟩, ⟨39288, 39299⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨937929310, 937929317⟩, ⟨198275821, 198275831⟩, ⟨3379996, 3380009⟩, ⟨285932, 285946⟩, ⟨10160, 10174⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-871126742), (-871126741)⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3423840554, 3423840555⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨204823769, 204823773⟩, ⟨86598426, 86598432⟩, ⟨10629579, 10629587⟩, ⟨436954, 436966⟩, ⟨33493, 33506⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4499791065, 4499791069⟩, ⟨86598426, 86598432⟩, ⟨10629579, 10629587⟩, ⟨436954, 436966⟩, ⟨33493, 33506⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4396186468, 4396186471⟩, ⟨42302278, 42302282⟩, ⟨4988893, 4988898⟩, ⟨165441, 165448⟩, ⟨11937, 11946⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3504529947, 3504529951⟩, ⟨(-144608987), (-144608981)⟩, ⟨2261027, 2261034⟩, ⟨(-70490), (-70482)⟩, ⟨2803, 2813⟩⟩
...
def j47 : Jet := ⟨⟨7016894022, 7016894032⟩, ⟨1403378802, 1403378812⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11463836234, 11463836268⟩, ⟨4585534486, 4585534526⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11463836234, 11463836268⟩, ⟨4585534486, 4585534526⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11463836268), (-11463836234)⟩, ⟨(-4585534526), (-4585534486)⟩, ⟨(-458553455), (-458553447)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5731918134), (-5731918117)⟩, ⟨(-2292767263), (-2292767243)⟩, ⟨(-229276728), (-229276723)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1130746178, 1130746194⟩, ⟨(-603622258), (-603622243)⟩, ⟨100752539, 100752548⟩, ⟨3553842, 3553846⟩, ⟨(-3163504), (-3163502)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨922645871, 922645886⟩, ⟨(-530604354), (-530604337)⟩, ⟨103129104, 103129117⟩, ⟨(-828809), (-828796)⟩, ⟨(-2637274), (-2637264)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨696901393, 1045352091⟩, ⟨174225348, 174225349⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2189380296, 3284070450⟩, ⟨547345073, 547345077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1116047166, 2511106134⟩, ⟨558023582, 837035382⟩, ⟨69752947, 69752949⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨279, 630⟩, ⟨139, 210⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94408), (-94056)⟩, ⟨139, 210⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-55197), (-24440)⟩, ⟨(-18363), (-12097)⟩, ⟨(-1512), (-1475)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5057859, 5088617⟩, ⟨(-18363), (-12097)⟩, ⟨(-1512), (-1475)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1314284, 2975124⟩, ⟨646405, 988565⟩, ⟨77678, 80689⟩, ⟨(-593), (-382)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141851293), (-140190452)⟩, ⟨646405, 988565⟩, ⟨77678, 80689⟩, ⟨(-593), (-382)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-82935126), (-36428486)⟩, ⟨(-27477074), (-17636266)⟩, ⟨(-2199586), (-2036945)⟩, ⟨20243, 31682⟩, ⟨1130, 1257⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1348720639, 1395227280⟩, ⟨(-27477074), (-17636266)⟩, ⟨(-2199586), (-2036945)⟩, ⟨20243, 31682⟩, ⟨1130, 1257⟩⟩
...
def j72 : Jet := ⟨⟨3058, 6905⟩, ⟨1516, 2299⟩, ⟨184, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849119), (-845271)⟩, ⟨1516, 2299⟩, ⟨184, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-496449), (-219643)⟩, ⟨(-165090), (-108476)⟩, ⟨(-13548), (-13166)⟩, ⟨45, 76⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35294945, 35571752⟩, ⟨(-165090), (-108476)⟩, ⟨(-13548), (-13166)⟩, ⟨45, 76⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9171390, 20797468⟩, ⟨4489173, 6904303⟩, ⟨533115, 560194⟩, ⟨(-5312), (-3426)⟩, ⟨(-216), (-195)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706656493), (-695030414)⟩, ⟨4489173, 6904303⟩, ⟨533115, 560194⟩, ⟨(-5312), (-3426)⟩, ⟨(-216), (-195)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-413155522), (-180603639)⟩, ⟨(-136551997), (-86265132)⟩, ⟨(-10754759), (-9614639)⟩, ⟨139064, 220416⟩, ⟨7495, 8603⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3881811774, 4114363657⟩, ⟨(-136551997), (-86265132)⟩, ⟨(-10754759), (-9614639)⟩, ⟨139064, 220416⟩, ⟨7495, 8603⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨687516851, 1066835756⟩, ⟨150869355, 168815789⟩, ⟨(-5183518), (-3285884)⟩, ⟨(-269995), (-235359)⟩, ⟨3155, 5000⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4483498691, 4752096482⟩, ⟨94004720, 167166340⟩, ⟨12448230, 19046404⟩, ⟨226092, 972528⟩, ⟨14937, 74959⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨717696012, 1180383015⟩, ⟨172539703, 228306267⟩, ⟨(-440465), 7871411⟩, ⟨(-27023), 672590⟩, ⟨(-19871), 47705⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1045352091), (-696901393)⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3249615205, 3598065903⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨119928169, 324403882⟩, ⟨57663328, 125490522⟩, ⟨6689250, 16462597⟩, ⟨(-61682), 1206534⟩, ⟨(-14606), 112154⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4414895465, 4619371178⟩, ⟨57663328, 125490522⟩, ⟨6689250, 16462597⟩, ⟨(-61682), 1206534⟩, ⟨(-14606), 112154⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4354518531, 4454216894⟩, ⟨27800858, 61887174⟩, ⟨2795113, 8029985⟩, ⟨(-144543), 577173⟩, ⟨(-22811), 56468⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3294672264, 3731475662⟩, ⟨(-159650902), (-124795681)⟩, ⟨(-395644), 5599299⟩, ⟨(-446827), 370138⟩, ⟨(-42524), 53170⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5613515219, 8420272844⟩, ⟨1403378802, 1403378812⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7336855194, 16507924248⟩, ⟨3668427588, 5502641436⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7336855194, 16507924248⟩, ⟨3668427588, 5502641436⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16507924248), (-7336855194)⟩, ⟨(-5502641436), (-3668427588)⟩, ⟨(-458553455), (-458553447)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8253962124), (-3668427597)⟩, ⟨(-2751320718), (-1834213794)⟩, ⟨(-229276728), (-229276723)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨628555229, 1828181186⟩, ⟨(-1171117829), (-268431536)⟩, ⟨(-40274810), 341550283⟩, ⟨(-63378377), 50278152⟩, ⟨(-17168373), 11224905⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨482165133, 1588327252⟩, ⟨(-1085425833), (-224177472)⟩, ⟨(-27359624), 342655258⟩, ⟨(-69476201), 45444268⟩, ⟨(-16956370), 12697844⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨871126741, 871126742⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4396186468, 4396186471⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1282
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨696901393, 1045352091⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4354518531, 4454216894⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1283
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (19462313 / 1073741824)

theorem envelope_integral : (∫ s in ((8113 / 50000) : ℝ)..(24339 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((8113 / 50000) : ℝ)..(24339 / 100000), prawitzNormalCorrection
