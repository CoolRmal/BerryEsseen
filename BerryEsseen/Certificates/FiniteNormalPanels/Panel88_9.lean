...
namespace FiniteNormalPanel88_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (26747 / 100000)
def radius : Rat := (3821 / 100000)

def j0 : Jet := ⟨⟨1148774902, 1148774903⟩, ⟨164110700, 164110701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3608982792, 3608982797⟩, ⟨515568969, 515568973⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3032562507, 3032562516⟩, ⟨866446428, 866446438⟩, ⟨61889030, 61889032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨759, 760⟩, ⟨216, 218⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93928), (-93926)⟩, ⟨216, 218⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-66321), (-66318)⟩, ⟨(-18797), (-18794)⟩, ⟨(-1301), (-1297)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5046735, 5046739⟩, ⟨(-18797), (-18794)⟩, ⟨(-1301), (-1297)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3563365, 3563369⟩, ⟨1004831, 1004837⟩, ⟨68009, 68016⟩, ⟨(-530), (-525)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-139602212), (-139602207)⟩, ⟨1004831, 1004837⟩, ⟨68009, 68016⟩, ⟨(-530), (-525)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-98569420), (-98569416)⟩, ⟨(-27453208), (-27453201)⟩, ⟨(-1760893), (-1760883)⟩, ⟨27823, 27832⟩, ⟨859, 866⟩⟩
...
def j19 : Jet := ⟨⟨1333086345, 1333086350⟩, ⟨(-27453208), (-27453201)⟩, ⟨(-1760893), (-1760883)⟩, ⟨27823, 27832⟩, ⟨859, 866⟩⟩
...
def j25 : Jet := ⟨⟨8302, 8305⟩, ⟨2356, 2359⟩, ⟨162, 166⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843875), (-843871)⟩, ⟨2356, 2359⟩, ⟨162, 166⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-595838), (-595834)⟩, ⟨(-168577), (-168572)⟩, ⟨(-11571), (-11565)⟩, ⟨63, 68⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35195556, 35195561⟩, ⟨(-168577), (-168572)⟩, ⟨(-11571), (-11565)⟩, ⟨63, 68⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨24850648, 24850653⟩, ⟨6981157, 6981163⟩, ⟨464978, 464986⟩, ⟨(-4721), (-4713)⟩, ⟨(-155), (-149)⟩⟩
...
def j33 : Jet := ⟨⟨(-690977235), (-690977229)⟩, ⟨6981157, 6981163⟩, ⟨464978, 464986⟩, ⟨(-4721), (-4713)⟩, ⟨(-155), (-149)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-487880703), (-487880696)⟩, ⟨(-134465279), (-134465269)⟩, ⟨(-8220097), (-8220086)⟩, ⟨191064, 191075⟩, ⟨5637, 5646⟩⟩
...
def j36 : Jet := ⟨⟨3807086593, 3807086600⟩, ⟨(-134465279), (-134465269)⟩, ⟨(-8220097), (-8220086)⟩, ⟨191064, 191075⟩, ⟨5637, 5646⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1120168175, 1120168182⟩, ⟨136955593, 136955603⟩, ⟨(-4775138), (-4775126)⟩, ⟨(-188000), (-187989)⟩, ⟨4060, 4069⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4845370229, 4845370239⟩, ⟨171137165, 171137180⟩, ⟨16506416, 16506434⟩, ⟨709325, 709346⟩, ⟨44916, 44932⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1263718476, 1263718487⟩, ⟨199140737, 199140755⟩, ⟨4375082, 4375105⟩, ⟨308981, 309006⟩, ⟨13068, 13089⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1148774903), (-1148774902)⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3146192393, 3146192394⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨371826902, 371826910⟩, ⟨117187308, 117187322⟩, ⟨11807952, 11807971⟩, ⟨587534, 587554⟩, ⟨40798, 40817⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4666794198, 4666794206⟩, ⟨117187308, 117187322⟩, ⟨11807952, 11807971⟩, ⟨587534, 587554⟩, ⟨40798, 40817⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4477022275, 4477022280⟩, ⟨56210983, 56210991⟩, ⟨5311017, 5311028⟩, ⟨215138, 215150⟩, ⟨13717, 13729⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3279553126, 3279553132⟩, ⟨(-129890791), (-129890782)⟩, ⟨1742657, 1742667⟩, ⟨(-45340), (-45329)⟩, ⟨1827, 1837⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨33841292865, 33841292868⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value414

def j47 : Jet := ⟨⟨9051530597, 9051530607⟩, ⟨1293075797, 1293075806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨19075862632, 19075862675⟩, ⟨5450246454, 5450246500⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨19075862632, 19075862675⟩, ⟨5450246454, 5450246500⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-19075862675), (-19075862632)⟩, ⟨(-5450246500), (-5450246454)⟩, ⟨(-389303323), (-389303317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9537931338), (-9537931316)⟩, ⟨(-2725123250), (-2725123227)⟩, ⟨(-194651662), (-194651658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨466135573, 466135584⟩, ⟨(-295759393), (-295759382)⟩, ⟨72702838, 72702845⟩, ⟨(-6440415), (-6440411)⟩, ⟨(-625881), (-625879)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨355932017, 355932027⟩, ⟨(-239933228), (-239933216)⟩, ⟨64648116, 64648127⟩, ⟨(-7241421), (-7241412)⟩, ⟨(-250320), (-250311)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨984664202, 1312885604⟩, ⟨164110700, 164110701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3093413823, 4124551769⟩, ⟨515568969, 515568973⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2228005109, 3960897982⟩, ⟨742668366, 990224500⟩, ⟨61889030, 61889032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨557, 993⟩, ⟨185, 249⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94130), (-93693)⟩, ⟨185, 249⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-86809), (-48603)⟩, ⟨(-21608), (-15971)⟩, ⟨(-1319), (-1277)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5026247, 5064454⟩, ⟨(-21608), (-15971)⟩, ⟨(-1319), (-1277)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2607354, 4670533⟩, ⟨849190, 1159350⟩, ⟨66227, 69555⟩, ⟨(-615), (-442)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140558223), (-138495043)⟩, ⟨849190, 1159350⟩, ⟨66227, 69555⟩, ⟨(-615), (-442)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-129625384), (-71844007)⟩, ⟨(-31965831), (-22878828)⟩, ⟨(-1844204), (-1664227)⟩, ⟨23119, 32514⟩, ⟨793, 920⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1302030381, 1359811759⟩, ⟨(-31965831), (-22878828)⟩, ⟨(-1844204), (-1664227)⟩, ⟨23119, 32514⟩, ⟨793, 920⟩⟩
...
def j72 : Jet := ⟨⟨6087, 10865⟩, ⟨2005, 2708⟩, ⟨161, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846090), (-841311)⟩, ⟨2005, 2708⟩, ⟨161, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-780280), (-436428)⟩, ⟨(-194030), (-142978)⟩, ⟨(-11763), (-11343)⟩, ⟨53, 79⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35011114, 35354967⟩, ⟨(-194030), (-142978)⟩, ⟨(-11763), (-11343)⟩, ⟨53, 79⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18161940, 32605003⟩, ⟨5875041, 8077082⟩, ⟨448914, 478847⟩, ⟨(-5482), (-3948)⟩, ⟨(-161), (-141)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697665943), (-683222879)⟩, ⟨5875041, 8077082⟩, ⟨448914, 478847⟩, ⟨(-5482), (-3948)⟩, ⟨(-161), (-141)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-643400389), (-354420408)⟩, ⟨(-157802434), (-110691301)⟩, ⟨(-8804371), (-7541200)⟩, ⟨157225, 224742⟩, ⟨5055, 6146⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3651566907, 3940546888⟩, ⟨(-157802434), (-110691301)⟩, ⟨(-8804371), (-7541200)⟩, ⟨157225, 224742⟩, ⟨5055, 6146⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨937776355, 1305857207⟩, ⟨125598565, 146753870⟩, ⟨(-5608217), (-3945025)⟩, ⟨(-204728), (-168550)⟩, ⟨3346, 4787⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4681264960, 5051733830⟩, ⟨131498322, 218310637⟩, ⟨12652576, 21614638⟩, ⟨318950, 1258890⟩, ⟨12841, 94380⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1022121773, 1535947209⟩, ⟨165606889, 238987620⟩, ⟨11656, 9731357⟩, ⟨(-86223), 816812⟩, ⟨(-22855), 60561⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1312885604), (-984664202)⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2982081692, 3310303094⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨243245837, 549278648⟩, ⟨78822674, 170931392⟩, ⟨6391075, 20258312⟩, ⟨(-60772), 1667188⟩, ⟨(-25944), 156267⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4538213133, 4844245944⟩, ⟨78822674, 170931392⟩, ⟨6391075, 20258312⟩, ⟨(-60772), 1667188⟩, ⟨(-25944), 156267⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4414915286, 4561346063⟩, ⟨37109748, 83143695⟩, ⟨2251153, 9697996⟩, ⟨(-212198), 792025⟩, ⟨(-38188), 79434⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3065363980, 3515611865⟩, ⟨(-148522994), (-104611740)⟩, ⟨(-1613901), 6056671⟩, ⟨(-534111), 524430⟩, ⟨(-59698), 69332⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7758454800, 10344606412⟩, ⟨1293075797, 1293075806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14014919494, 24915412492⟩, ⟨4671639820, 6228853146⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14014919494, 24915412492⟩, ⟨4671639820, 6228853146⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-24915412492), (-14014919494)⟩, ⟨(-6228853146), (-4671639820)⟩, ⟨(-389303323), (-389303317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12457706246), (-7007459747)⟩, ⟨(-3114426573), (-2335819910)⟩, ⟨(-194651662), (-194651658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨236196349, 840206641⟩, ⟨(-609262356), (-128455491)⟩, ⟨(-3148610), 210193784⟩, ⟨(-46925073), 19169256⟩, ⟨(-8238153), 8578090⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨168575854, 687744570⟩, ⟨(-527761872), (-97433045)⟩, ⟨235775, 194306041⟩, ⟨(-46642457), 16131260⟩, ⟨(-7571219), 9029974⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1148774902, 1148774903⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4477022275, 4477022280⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar414 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1780
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar414 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨984664202, 1312885604⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4414915286, 4561346063⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1781
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((11463 / 50000) : ℝ)..(3821 / 12500), prawitzNormalCorrection
      ((262643 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
