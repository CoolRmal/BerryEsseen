...
namespace FiniteNormalPanel147_15
...
def j2 : Jet := ⟨⟨445877429, 445877434⟩, ⟨445877429, 445877434⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨46288287, 46288289⟩, ⟨92576574, 92576578⟩, ⟨46288287, 46288289⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1021), (-1020)⟩, ⟨(-2041), (-2039)⟩, ⟨(-1021), (-1018)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112035, 5112037⟩, ⟨(-2041), (-2039)⟩, ⟨(-1021), (-1018)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨55094, 55095⟩, ⟨110166, 110168⟩, ⟨55038, 55042⟩, ⟨(-45), (-41)⟩, ⟨(-12), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143110483), (-143110481)⟩, ⟨110166, 110168⟩, ⟨55038, 55042⟩, ⟨(-45), (-41)⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1542350), (-1542349)⟩, ⟨(-3083512), (-3083510)⟩, ⟨(-1539383), (-1539380)⟩, ⟨2372, 2375⟩, ⟨591, 594⟩⟩
...
def j19 : Jet := ⟨⟨1430113415, 1430113417⟩, ⟨(-3083512), (-3083510)⟩, ⟨(-1539383), (-1539380)⟩, ⟨2372, 2375⟩, ⟨591, 594⟩⟩
...
def j25 : Jet := ⟨⟨127, 128⟩, ⟨254, 256⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852050), (-852048)⟩, ⟨254, 256⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9183), (-9182)⟩, ⟨(-18364), (-18362)⟩, ⟨(-9177), (-9174)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782211, 35782213⟩, ⟨(-18364), (-18362)⟩, ⟨(-9177), (-9174)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨385636, 385637⟩, ⟨771075, 771077⟩, ⟨385141, 385144⟩, ⟨(-396), (-393)⟩, ⟨(-100), (-96)⟩⟩
...
def j33 : Jet := ⟨⟨(-715442247), (-715442245)⟩, ⟨771075, 771077⟩, ⟨385141, 385144⟩, ⟨(-396), (-393)⟩, ⟨(-100), (-96)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7710559), (-7710558)⟩, ⟨(-15412808), (-15412805)⟩, ⟨(-7689789), (-7689786)⟩, ⟨16606, 16609⟩, ⟨4139, 4142⟩⟩
...
def j36 : Jet := ⟨⟨4287256737, 4287256738⟩, ⟨(-15412808), (-15412805)⟩, ⟨(-7689789), (-7689786)⟩, ⟨16606, 16609⟩, ⟨4139, 4142⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨148465692, 148465695⟩, ⟨148145580, 148145584⟩, ⟨(-479922), (-479920)⟩, ⟨(-159564), (-159562)⟩, ⟨307, 309⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302691721, 4302691723⟩, ⟨15468293, 15468298⟩, ⟨7773078, 7773084⟩, ⟨39019, 39026⟩, ⟨9864, 9872⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨148732705, 148732709⟩, ⟨148946715, 148946721⟩, ⟨321453, 321459⟩, ⟨107883, 107890⟩, ⟨548, 557⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-141927195), (-141927194)⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4153040101, 4153040102⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5150543, 5150545⟩, ⟨10315908, 10315912⟩, ⟨5187638, 5187642⟩, ⟨29764, 29770⟩, ⟨7542, 7549⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300117839, 4300117841⟩, ⟨10315908, 10315912⟩, ⟨5187638, 5187642⟩, ⟨29764, 29770⟩, ⟨7542, 7549⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297541795, 4297541797⟩, ⟨5154864, 5154867⟩, ⟨2589173, 2589176⟩, ⟨11766, 11771⟩, ⟨2973, 2979⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4155529525, 4155529529⟩, ⟨(-137027749), (-137027743)⟩, ⟨2333270, 2333275⟩, ⟨(-74183), (-74176)⟩, ⟨2485, 2493⟩⟩
...
def j47 : Jet := ⟨⟨1412863257, 1412863268⟩, ⟨1412863257, 1412863268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨464772475, 464772483⟩, ⟨929544950, 929544966⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨464772475, 464772483⟩, ⟨929544950, 929544966⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-464772483), (-464772475)⟩, ⟨(-929544966), (-929544950)⟩, ⟨(-464772483), (-464772475)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-232386242), (-232386237)⟩, ⟨(-464772483), (-464772475)⟩, ⟨(-232386242), (-232386237)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4068756004, 4068756009⟩, ⟨(-440293419), (-440293410)⟩, ⟨(-196323915), (-196323907)⟩, ⟨22963481, 22963483⟩, ⟨4689974, 4689976⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3936662269, 3936662279⟩, ⟨(-555809770), (-555809753)⟩, ⟨(-173692571), (-173692555)⟩, ⟨28172061, 28172074⟩, ⟨3708382, 3708396⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 283854389⟩, ⟨141927194, 141927195⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 891754864⟩, ⟨445877429, 445877434⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 185153154⟩, ⟨0, 185153154⟩, ⟨46288287, 46288289⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4082), 0⟩, ⟨(-4082), 3⟩, ⟨(-1021), (-1015)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108974, 5113057⟩, ⟨(-4082), 3⟩, ⟨(-1021), (-1015)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 220421⟩, ⟨(-176), 220422⟩, ⟨54840, 55107⟩, ⟨(-89), 2⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142945155)⟩, ⟨(-176), 220422⟩, ⟨54840, 55107⟩, ⟨(-89), 2⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6171772), 0⟩, ⟨(-6171780), 9503⟩, ⟨(-1542951), (-1528688)⟩, ⟨(-6), 4753⟩, ⟨586, 595⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425483993, 1431655766⟩, ⟨(-6171780), 9503⟩, ⟨(-1542951), (-1528688)⟩, ⟨(-6), 4753⟩, ⟨586, 595⟩⟩
...
def j72 : Jet := ⟨⟨0, 511⟩, ⟨(-1), 511⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851665)⟩, ⟨(-1), 511⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-36737), 0⟩, ⟨(-36738), 23⟩, ⟨(-9186), (-9149)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35754657, 35791395⟩, ⟨(-36738), 23⟩, ⟨(-9186), (-9149)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1542943⟩, ⟨(-1584), 1542944⟩, ⟨383358, 385737⟩, ⟨(-794), 2⟩, ⟨(-102), (-96)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714284939)⟩, ⟨(-1584), 1542944⟩, ⟨383358, 385737⟩, ⟨(-794), 2⟩, ⟨(-102), (-96)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30858860), 0⟩, ⟨(-30858929), 66516⟩, ⟨(-7714784), (-7614940)⟩, ⟨(-53), 33259⟩, ⟨4091, 4159⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264108436, 4294967296⟩, ⟨(-30858929), 66516⟩, ⟨(-7714784), (-7614940)⟩, ⟨(-53), 33259⟩, ⟨4091, 4159⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 297251622⟩, ⟨146703659, 148627786⟩, ⟨(-961077), 987⟩, ⟨(-160182), (-157712)⟩, ⟨(-1), 618⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4326049479⟩, ⟨(-67483), 31307191⟩, ⟨7614455, 8053419⟩, ⟨(-33992), 114981⟩, ⟨8822, 11285⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 299402798⟩, ⟨146698988, 151870138⟩, ⟨(-970369), 1641756⟩, ⟨89386, 128952⟩, ⟨(-4150), 5389⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-283854389), 0⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4011112907, 4294967296⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20871413⟩, ⟨0, 21173780⟩, ⟨4875363, 5599028⟩, ⟨(-68626), 134086⟩, ⟨5155, 10500⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315838709⟩, ⟨0, 21173780⟩, ⟨4875363, 5599028⟩, ⟨(-68626), 134086⟩, ⟨5155, 10500⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305390356⟩, ⟨0, 10586890⟩, ⟨2418763, 2799514⟩, ⟨(-41214), 67043⟩, ⟨1495, 4671⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4011112907, 4305390356⟩, ⟨(-142271626), (-131340304)⟩, ⟨1909062, 2799514⟩, ⟨(-133724), (-12885)⟩, ⟨(-820), 6033⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2825726526⟩, ⟨1412863257, 1412863268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1859089919⟩, ⟨0, 1859089926⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1859089919⟩, ⟨0, 1859089926⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1859089919), 0⟩, ⟨(-1859089926), 0⟩, ⟨(-464772483), (-464772475)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-929544960), 0⟩, ⟨(-929544963), 0⟩, ⟨(-232386242), (-232386237)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3459130957, 4294967296⟩, ⟨(-929544963), 0⟩, ⟨(-232386242), (-86572837)⟩, ⟨0, 50294554⟩, ⟨(-379187), 6286820⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3230516991, 4305390356⟩, ⟨(-1074072416), (-105780389)⟩, ⟨(-231412657), (-47260366)⟩, ⟨1907787, 58104073⟩, ⟨(-2198418), 6298572⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297541795, 4297541797⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2966
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305390356⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2967
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (128215409 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(6609 / 100000), prawitzNormalCorrection
