...
namespace FiniteNormalPanel2_5

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8219 / 32000)
def radius : Rat := (8219 / 160000)

def j0 : Jet := ⟨⟨1103135506, 1103135507⟩, ⟨220627101, 220627102⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3465602401, 3465602405⟩, ⟨693120479, 693120483⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2796389162, 2796389170⟩, ⟨1118555662, 1118555672⟩, ⟨111855566, 111855568⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨699, 701⟩, ⟨279, 281⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93988), (-93985)⟩, ⟨279, 281⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-61195), (-61192)⟩, ⟨(-24297), (-24293)⟩, ⟨(-2359), (-2354)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5051861, 5051865⟩, ⟨(-24297), (-24293)⟩, ⟨(-2359), (-2354)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3289191, 3289194⟩, ⟨1299856, 1299862⟩, ⟨123703, 123710⟩, ⟨(-1239), (-1234)⟩, ⟨(-59), (-55)⟩⟩
...
def j16 : Jet := ⟨⟨(-139876386), (-139876382)⟩, ⟨1299856, 1299862⟩, ⟨123703, 123710⟩, ⟨(-1239), (-1234)⟩, ⟨(-59), (-55)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-91071430), (-91071426)⟩, ⟨(-35582256), (-35582249)⟩, ⟨(-3223791), (-3223782)⟩, ⟨65261, 65269⟩, ⟨2859, 2866⟩⟩
...
def j19 : Jet := ⟨⟨1340584335, 1340584340⟩, ⟨(-35582256), (-35582249)⟩, ⟨(-3223791), (-3223782)⟩, ⟨65261, 65269⟩, ⟨2859, 2866⟩⟩
...
def j25 : Jet := ⟨⟨7659, 7662⟩, ⟨3044, 3048⟩, ⟨296, 299⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844518), (-844514)⟩, ⟨3044, 3048⟩, ⟨296, 299⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-549854), (-549850)⟩, ⟨(-217961), (-217955)⟩, ⟨(-21011), (-21005)⟩, ⟨154, 158⟩, ⟨5, 8⟩⟩
...
def j30 : Jet := ⟨⟨35241540, 35241545⟩, ⟨(-217961), (-217955)⟩, ⟨(-21011), (-21005)⟩, ⟨154, 158⟩, ⟨5, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22945241, 22945245⟩, ⟨9036184, 9036191⟩, ⟨847364, 847372⟩, ⟨(-11049), (-11043)⟩, ⟨(-505), (-499)⟩⟩
...
def j33 : Jet := ⟨⟨(-692882642), (-692882637)⟩, ⟨9036184, 9036191⟩, ⟨847364, 847372⟩, ⟨(-11049), (-11043)⟩, ⟨(-505), (-499)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-451125558), (-451125553)⟩, ⟨(-174566900), (-174566890)⟩, ⟨(-15139988), (-15139978)⟩, ⟨448820, 448830⟩, ⟨18861, 18870⟩⟩
...
def j36 : Jet := ⟨⟨3843841738, 3843841743⟩, ⟨(-174566900), (-174566890)⟩, ⟨(-15139988), (-15139978)⟩, ⟨448820, 448830⟩, ⟨18861, 18870⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1081715405, 1081715411⟩, ⟨187631813, 187631822⟩, ⟨(-8343526), (-8343516)⟩, ⟨(-467597), (-467586)⟩, ⟨12837, 12847⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4799038385, 4799038393⟩, ⟨217946851, 217946866⟩, ⟨28800258, 28800275⟩, ⟨1606028, 1606048⟩, ⟨137365, 137383⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1208668982, 1208668991⟩, ⟨264544211, 264544227⟩, ⟨7452104, 7452123⟩, ⟨716802, 716824⟩, ⟨39422, 39444⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1103135507), (-1103135506)⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3191831789, 3191831790⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨340137795, 340137801⟩, ⟨148893510, 148893524⟩, ⟨20488605, 20488620⟩, ⟨1321444, 1321466⟩, ⟨123415, 123439⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4635105091, 4635105097⟩, ⟨148893510, 148893524⟩, ⟨20488605, 20488620⟩, ⟨1321444, 1321466⟩, ⟨123415, 123439⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4461796138, 4461796142⟩, ⟨71663152, 71663160⟩, ⟨9285753, 9285762⟩, ⟨486873, 486885⟩, ⟨41917, 41931⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3315811685, 3315811690⟩, ⟨(-175939973), (-175939964)⟩, ⟨3219518, 3219527⟩, ⟨(-115176), (-115165)⟩, ⟨6139, 6152⟩⟩
...
def j47 : Jet := ⟨⟨4731331047, 4731331054⟩, ⟨946266208, 946266214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5212028854, 5212028871⟩, ⟨2084811538, 2084811556⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5212028854, 5212028871⟩, ⟨2084811538, 2084811556⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5212028871), (-5212028854)⟩, ⟨(-2084811556), (-2084811538)⟩, ⟨(-208481157), (-208481153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2606014436), (-2606014427)⟩, ⟨(-1042405778), (-1042405769)⟩, ⟨(-104240579), (-104240576)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2341247533, 2341247549⟩, ⟨(-568230165), (-568230155)⟩, ⟨12132850, 12132855⟩, ⟨8212551, 8212553⟩, ⟨(-645540), (-645539)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1807495934, 1807495950⟩, ⟨(-534593887), (-534593870)⟩, ⟨34398940, 34398952⟩, ⟨5354528, 5354541⟩, ⟨(-807117), (-807103)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨882508405, 1323762608⟩, ⟨220627101, 220627102⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2772481921, 4158722885⟩, ⟨693120479, 693120483⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1789689064, 4026800403⟩, ⟨894844530, 1342266806⟩, ⟨111855566, 111855568⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨447, 1009⟩, ⟨223, 337⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94240), (-93677)⟩, ⟨223, 337⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-88356), (-39034)⟩, ⟨(-29360), (-19201)⟩, ⟨(-2398), (-2305)⟩, ⟨10, 19⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5024700, 5074023⟩, ⟨(-29360), (-19201)⟩, ⟨(-2398), (-2305)⟩, ⟨10, 19⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2093764, 4757214⟩, ⟨1019355, 1577738⟩, ⟨119435, 127185⟩, ⟨(-1511), (-962)⟩, ⟨(-61), (-53)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141071813), (-138408362)⟩, ⟨1019355, 1577738⟩, ⟨119435, 127185⟩, ⟨(-1511), (-962)⟩, ⟨(-61), (-53)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-132263646), (-57673997)⟩, ⟨(-43663124), (-27357769)⟩, ⟨(-3411845), (-2992303)⟩, ⟨50013, 80438⟩, ⟨2579, 3091⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1299392119, 1373981769⟩, ⟨(-43663124), (-27357769)⟩, ⟨(-3411845), (-2992303)⟩, ⟨50013, 80438⟩, ⟨2579, 3091⟩⟩
...
def j72 : Jet := ⟨⟨4889, 11056⟩, ⟨2412, 3677⟩, ⟨291, 304⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847288), (-841120)⟩, ⟨2412, 3677⟩, ⟨291, 304⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-794386), (-350490)⟩, ⟨(-263791), (-171797)⟩, ⟨(-21444), (-20469)⟩, ⟨120, 192⟩, ⟨5, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34997008, 35440905⟩, ⟨(-263791), (-171797)⟩, ⟨(-21444), (-20469)⟩, ⟨120, 192⟩, ⟨5, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14583059, 33228065⟩, ⟨7044208, 11004436⟩, ⟨808894, 878680⟩, ⟨(-13523), (-8557)⟩, ⟨(-532), (-464)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701244824), (-682599817)⟩, ⟨7044208, 11004436⟩, ⟨808894, 878680⟩, ⟨(-13523), (-8557)⟩, ⟨(-532), (-464)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-657460872), (-284435559)⟩, ⟨(-216218343), (-131900432)⟩, ⟨(-16458101), (-13514288)⟩, ⟨339306, 557634⟩, ⟨16340, 20909⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3637506424, 4010531737⟩, ⟨(-216218343), (-131900432)⟩, ⟨(-16458101), (-13514288)⟩, ⟨339306, 557634⟩, ⟨16340, 20909⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨838781976, 1330396493⟩, ⟨167417445, 204072798⟩, ⟨(-10349957), (-6346575)⟩, ⟨(-518319), (-405009)⟩, ⟨9735, 15975⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4599575638, 5071260893⟩, ⟨151273210, 301442665⟩, ⟨20474339, 40863368⟩, ⟨477994, 3363824⟩, ⟨16358, 350070⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨898270202, 1570858925⟩, ⟨208833823, 334331922⟩, ⟨(-2325526), 20183899⟩, ⟨(-446980), 2326303⟩, ⟨(-102601), 242613⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1323762608), (-882508405)⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2971204688, 3412458891⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨187868568, 574532376⟩, ⟨87353028, 244559854⟩, ⟨8453012, 40789590⟩, ⟨(-689014), 4844004⟩, ⟨(-155571), 634495⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4482835864, 4869499672⟩, ⟨87353028, 244559854⟩, ⟨8453012, 40789590⟩, ⟨(-689014), 4844004⟩, ⟨(-155571), 634495⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4387896241, 4573220074⟩, ⟨41019062, 119690225⟩, ⟨2403083, 19771137⟩, ⟨(-876517), 2348244⟩, ⟨(-184735), 333781⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3035491770, 3633537680⟩, ⟨(-206544126), (-130303867)⟩, ⟨(-4485916), 13601566⟩, ⟨(-1712034), 1742296⟩, ⟨(-267404), 310224⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3785064839, 5677597263⟩, ⟨946266208, 946266214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3335698469, 7505321569⟩, ⟨1667849230, 2501773866⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3335698469, 7505321569⟩, ⟨1667849230, 2501773866⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7505321569), (-3335698469)⟩, ⟨(-2501773866), (-1667849230)⟩, ⟨(-208481157), (-208481153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3752660785), (-1667849234)⟩, ⟨(-1250886933), (-833924615)⟩, ⟨(-104240579), (-104240576)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1792676066, 2912807904⟩, ⟨(-848340184), (-348071730)⟩, ⟨(-36903656), 80028373⟩, ⟨(-2137390), 17309038⟩, ⟨(-2231453), 603460⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1266983674, 2464232332⟩, ⟨(-857771232), (-300389130)⟩, ⟨(-23702707), 117724888⟩, ⟨(-9504441), 18485785⟩, ⟨(-3362554), 1415306⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1103135506, 1103135507⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4461796138, 4461796142⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified24
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨882508405, 1323762608⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4387896241, 4573220074⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified25
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (186904717 / 4294967296)

theorem envelope_integral : (∫ s in ((8219 / 40000) : ℝ)..(24657 / 80000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((8219 / 40000) : ℝ)..(24657 / 80000), prawitzNormalCorrection
