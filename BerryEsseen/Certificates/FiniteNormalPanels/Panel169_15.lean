...
namespace FiniteNormalPanel169_15
...
def j2 : Jet := ⟨⟨1272815110, 1272815114⟩, ⟨424271701, 424271705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨377199217, 377199221⟩, ⟨251466142, 251466148⟩, ⟨41911023, 41911025⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨94, 95⟩, ⟨62, 63⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94593), (-94591)⟩, ⟨62, 63⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8308), (-8307)⟩, ⟨(-5534), (-5532)⟩, ⟨(-921), (-918)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104748, 5104750⟩, ⟨(-5534), (-5532)⟩, ⟨(-921), (-918)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨448317, 448318⟩, ⟨298391, 298394⟩, ⟨49407, 49411⟩, ⟨(-109), (-105)⟩, ⟨(-9), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-142717260), (-142717258)⟩, ⟨298391, 298394⟩, ⟨49407, 49411⟩, ⟨(-109), (-105)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12533935), (-12533934)⟩, ⟨(-8329752), (-8329749)⟩, ⟨(-1370851), (-1370848)⟩, ⟨5793, 5796⟩, ⟨474, 477⟩⟩
...
def j19 : Jet := ⟨⟨1419121830, 1419121832⟩, ⟨(-8329752), (-8329749)⟩, ⟨(-1370851), (-1370848)⟩, ⟨5793, 5796⟩, ⟨474, 477⟩⟩
...
def j25 : Jet := ⟨⟨1038, 1039⟩, ⟨691, 693⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851139), (-851137)⟩, ⟨691, 693⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-74751), (-74749)⟩, ⟨(-49774), (-49772)⟩, ⟨(-8257), (-8253)⟩, ⟨11, 14⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35716643, 35716646⟩, ⟨(-49774), (-49772)⟩, ⟨(-8257), (-8253)⟩, ⟨11, 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3136761, 3136763⟩, ⟨2086802, 2086804⟩, ⟨344888, 344892⟩, ⟨(-970), (-966)⟩, ⟨(-82), (-78)⟩⟩
...
def j33 : Jet := ⟨⟨(-712691122), (-712691119)⟩, ⟨2086802, 2086804⟩, ⟨344888, 344892⟩, ⟨(-970), (-966)⟩, ⟨(-82), (-78)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-62591056), (-62591054)⟩, ⟨(-41544101), (-41544098)⟩, ⟨(-6802093), (-6802090)⟩, ⟨40469, 40474⟩, ⟨3300, 3304⟩⟩
...
def j36 : Jet := ⟨⟨4232376240, 4232376242⟩, ⟨(-41544101), (-41544098)⟩, ⟨(-6802093), (-6802090)⟩, ⟨40469, 40474⟩, ⟨3300, 3304⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨420557267, 420557269⟩, ⟨137717228, 137717233⟩, ⟨(-1229095), (-1229092)⟩, ⟨(-133702), (-133699)⟩, ⟨712, 715⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4358483986, 4358483989⟩, ⟨42781944, 42781949⟩, ⟨7424702, 7424708⟩, ⟨99955, 99964⟩, ⟨9099, 9108⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨426776733, 426776736⟩, ⟨143943025, 143943033⟩, ⟨851538, 851545⟩, ⟨99935, 99943⟩, ⟨1360, 1369⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-405149634), (-405149633)⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3889817662, 3889817663⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨42407396, 42407397⟩, ⟨28606286, 28606290⟩, ⟨4993384, 4993390⟩, ⟨76936, 76942⟩, ⟨7136, 7143⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4337374692, 4337374693⟩, ⟨28606286, 28606290⟩, ⟨4993384, 4993390⟩, ⟨76936, 76942⟩, ⟨7136, 7143⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316118910, 4316118912⟩, ⟨14233048, 14233051⟩, ⟨2460988, 2460993⟩, ⟨30163, 30168⟩, ⟨2748, 2754⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3908974017, 3908974021⟩, ⟨(-122824539), (-122824533)⟩, ⟨1781298, 1781305⟩, ⟨(-50066), (-50059)⟩, ⟨1539, 1547⟩⟩
...
def j47 : Jet := ⟨⟨4655051345, 4655051358⟩, ⟨1551683774, 1551683786⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5045324336, 5045324366⟩, ⟨3363549540, 3363549578⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5045324336, 5045324366⟩, ⟨3363549540, 3363549578⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5045324366), (-5045324336)⟩, ⟨(-3363549578), (-3363549540)⟩, ⟨(-560591597), (-560591587)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2522662183), (-2522662168)⟩, ⟨(-1681774789), (-1681774770)⟩, ⟨(-280295799), (-280295793)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2387127783, 2387127803⟩, ⟨(-934724547), (-934724527)⟩, ⟨27217009, 27217021⟩, ⟨37115207, 37115211⟩, ⟨(-4521401), (-4521398)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2172594070, 2172594091⟩, ⟨(-918985309), (-918985284)⟩, ⟨52491637, 52491657⟩, ⟨32585792, 32585805⟩, ⟨(-5153417), (-5153405)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨270099755, 540199512⟩, ⟨135049877, 135049878⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨848543406, 1697086819⟩, ⟨424271701, 424271705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨167644096, 670576392⟩, ⟨167644094, 335288196⟩, ⟨41911023, 41911025⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨41, 168⟩, ⟨41, 84⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94646), (-94518)⟩, ⟨41, 84⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-14778), (-3689)⟩, ⟨(-7388), (-3675)⟩, ⟨(-923), (-913)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5098278, 5109368⟩, ⟨(-7388), (-3675)⟩, ⟨(-923), (-913)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨198999, 797730⟩, ⟨197845, 398722⟩, ⟨49027, 49681⟩, ⟨(-146), (-69)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142966578), (-142367846)⟩, ⟨197845, 398722⟩, ⟨49027, 49681⟩, ⟨(-146), (-69)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-22321477), (-5556998)⟩, ⟨(-11153017), (-5494745)⟩, ⟨(-1385458), (-1350365)⟩, ⟨3820, 7768⟩, ⟨464, 483⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1409334288, 1426098768⟩, ⟨(-11153017), (-5494745)⟩, ⟨(-1385458), (-1350365)⟩, ⟨3820, 7768⟩, ⟨464, 483⟩⟩
...
def j70 : Jet := ⟨⟨(-17), (-4)⟩, ⟨(-9), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11818, 11832⟩, ⟨(-9), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨461, 1848⟩, ⟨459, 924⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851716), (-850328)⟩, ⟨459, 924⟩, ⟨113, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-132980), (-33190)⟩, ⟨(-66473), (-33045)⟩, ⟨(-8291), (-8205)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35658414, 35758205⟩, ⟨(-66473), (-33045)⟩, ⟨(-8291), (-8205)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1391843, 5582955⟩, ⟨1381464, 2790189⟩, ⟨341475, 347326⟩, ⟨(-1297), (-638)⟩, ⟨(-82), (-77)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714436040), (-710244927)⟩, ⟨1381464, 2790189⟩, ⟨341475, 347326⟩, ⟨(-1297), (-638)⟩, ⟨(-82), (-77)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-111545423), (-27722764)⟩, ⟨(-55718790), (-27287129)⟩, ⟨(-6904339), (-6658644)⟩, ⟨26605, 54319⟩, ⟨3217, 3363⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4183421873, 4267244532⟩, ⟨(-55718790), (-27287129)⟩, ⟨(-6904339), (-6658644)⟩, ⟨26605, 54319⟩, ⟨3217, 3363⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨278437816, 563499849⟩, ⟨134811972, 139789384⟩, ⟨(-1649176), (-809576)⟩, ⟨(-136107), (-130323)⟩, ⟨468, 959⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4322870164, 4409486931⟩, ⟨27642829, 58729741⟩, ⟨6922204, 8059658⟩, ⟨31266, 176785⟩, ⟨6776, 12159⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨280246727, 578524829⟩, ⟨137479849, 151222028⟩, ⟨(-376729), 2154085⟩, ⟨57014, 149136⟩, ⟨(-3066), 6193⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-540199512), (-270099755)⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3754767784, 4024867541⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨18286106, 77926316⟩, ⟨17941126, 40738704⟩, ⟨4299174, 5904699⟩, ⟨(-19090), 191866⟩, ⟨2633, 13253⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4313253402, 4372893612⟩, ⟨17941126, 40738704⟩, ⟨4299174, 5904699⟩, ⟨(-19090), 191866⟩, ⟨2633, 13253⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304100637, 4333755307⟩, ⟨8890274, 20326129⟩, ⟨2082680, 2936904⟩, ⟨(-23396), 91429⟩, ⟨(-121), 6220⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3762752379, 4061216271⟩, ⟨(-128497420), (-116289193)⟩, ⟨1181600, 2472667⟩, ⟨(-114273), 20193⟩, ⟨(-2989), 6565⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3103367559, 6206735144⟩, ⟨1551683774, 1551683786⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2242366365, 8969465538⟩, ⟨2242366356, 4484732770⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2242366365, 8969465538⟩, ⟨2242366356, 4484732770⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8969465538), (-2242366365)⟩, ⟨(-4484732770), (-2242366356)⟩, ⟨(-560591597), (-560591587)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4484732769), (-1121183182)⟩, ⟨(-2242366385), (-1121183178)⟩, ⟨(-280295799), (-280295793)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1511739114, 3308179836⟩, ⟨(-1727172933), (-394633147)⟩, ⟨(-164387955), 352212962⟩, ⟨(-44126257), 103753733⟩, ⟨(-25035204), 11123586⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1324410538, 3128134129⟩, ⟨(-1732147158), (-386663184)⟩, ⟨(-144340378), 386622341⟩, ⟨(-53344643), 102932167⟩, ⟨(-26881863), 12092153⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316118910, 4316118912⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3430
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304100637, 4333755307⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3431
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (137881457 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((5031 / 80000) : ℝ)..(5031 / 40000), prawitzNormalCorrection
