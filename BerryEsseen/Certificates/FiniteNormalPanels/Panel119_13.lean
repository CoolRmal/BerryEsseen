...
namespace FiniteNormalPanel119_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (214991 / 800000)
def radius : Rat := (30713 / 800000)

def j0 : Jet := ⟨⟨1154224142, 1154224143⟩, ⟨164889163, 164889164⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3626102084, 3626102089⟩, ⟨518014583, 518014587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3061400801, 3061400811⟩, ⟨874685942, 874685952⟩, ⟨62477567, 62477569⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨766, 767⟩, ⟨218, 220⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93921), (-93919)⟩, ⟨218, 220⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-66946), (-66944)⟩, ⟨(-18973), (-18969)⟩, ⟨(-1313), (-1309)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5046110, 5046113⟩, ⟨(-18973), (-18969)⟩, ⟨(-1313), (-1309)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3596806, 3596809⟩, ⟨1014134, 1014140⟩, ⟨68604, 68609⟩, ⟨(-540), (-535)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-139568771), (-139568767)⟩, ⟨1014134, 1014140⟩, ⟨68604, 68609⟩, ⟨(-540), (-535)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-99482935), (-99482930)⟩, ⟨(-27700834), (-27700827)⟩, ⟨(-1774833), (-1774825)⟩, ⟨28338, 28345⟩, ⟨873, 880⟩⟩
...
def j19 : Jet := ⟨⟨1332172830, 1332172836⟩, ⟨(-27700834), (-27700827)⟩, ⟨(-1774833), (-1774825)⟩, ⟨28338, 28345⟩, ⟨873, 880⟩⟩
...
def j22 : Jet := ⟨⟨(-77), (-76)⟩, ⟨(-22), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11758, 11760⟩, ⟨(-22), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8380, 8383⟩, ⟨2378, 2381⟩, ⟨164, 168⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843797), (-843793)⟩, ⟨2378, 2381⟩, ⟨164, 168⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-601449), (-601445)⟩, ⟨(-170148), (-170143)⟩, ⟨(-11675), (-11669)⟩, ⟨65, 70⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35189945, 35189950⟩, ⟨(-170148), (-170143)⟩, ⟨(-11675), (-11669)⟩, ⟨65, 70⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25082967, 25082972⟩, ⟨7045282, 7045289⟩, ⟨468923, 468931⟩, ⟨(-4808), (-4801)⟩, ⟨(-157), (-151)⟩⟩
...
def j33 : Jet := ⟨⟨(-690744916), (-690744910)⟩, ⟨7045282, 7045289⟩, ⟨468923, 468931⟩, ⟨(-4808), (-4801)⟩, ⟨(-157), (-151)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-492354633), (-492354626)⟩, ⟨(-135650963), (-135650953)⟩, ⟨(-8279015), (-8279004)⟩, ⟨194554, 194564⟩, ⟨5729, 5738⟩⟩
...
def j36 : Jet := ⟨⟨3802612663, 3802612670⟩, ⟨(-135650963), (-135650953)⟩, ⟨(-8279015), (-8279004)⟩, ⟨194554, 194564⟩, ⟨5729, 5738⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1124710467, 1124710475⟩, ⟨137286004, 137286013⟩, ⟨(-4839424), (-4839414)⟩, ⟨(-190139), (-190130)⟩, ⟨4154, 4162⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4851071006, 4851071016⟩, ⟨173052704, 173052718⟩, ⟨16735018, 16735038⟩, ⟨725547, 725565⟩, ⟨46141, 46160⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1270335711, 1270335724⟩, ⟨200378322, 200378338⟩, ⟨4447849, 4447870⟩, ⟨315172, 315192⟩, ⟨13445, 13466⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1154224143), (-1154224142)⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3140743153, 3140743154⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨375731107, 375731116⟩, ⟨118533026, 118533040⟩, ⟨11979601, 11979617⟩, ⟨601458, 601476⟩, ⟨41966, 41985⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4670698403, 4670698412⟩, ⟨118533026, 118533040⟩, ⟨11979601, 11979617⟩, ⟨601458, 601476⟩, ⟨41966, 41985⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4478894605, 4478894611⟩, ⟨56832713, 56832721⟩, ⟨5383251, 5383260⟩, ⟨220070, 220081⟩, ⟨14092, 14104⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3275242066, 3275242073⟩, ⟨(-130390804), (-130390795)⟩, ⟨1754682, 1754692⟩, ⟨(-45743), (-45732)⟩, ⟨1854, 1866⟩⟩
...
def j47 : Jet := ⟨⟨8585016604, 8585016615⟩, ⟨1226430942, 1226430951⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17160202863, 17160202908⟩, ⟨4902915098, 4902915142⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17160202863, 17160202908⟩, ⟨4902915098, 4902915142⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17160202908), (-17160202863)⟩, ⟨(-4902915142), (-4902915098)⟩, ⟨(-350208227), (-350208220)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8580101454), (-8580101431)⟩, ⟨(-2451457571), (-2451457549)⟩, ⟨(-175104114), (-175104110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨582592908, 582592917⟩, ⟨(-332529149), (-332529140)⟩, ⟨71147484, 71147490⟩, ⟨(-4498337), (-4498333)⟩, ⟨(-808445), (-808443)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨444271787, 444271796⟩, ⟨(-271265912), (-271265902)⟩, ⟨64588671, 64588682⟩, ⟨(-5732352), (-5732343)⟩, ⟨(-447081), (-447070)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨989334979, 1319113306⟩, ⟨164889163, 164889164⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3108087501, 4144116672⟩, ⟨518014583, 518014587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2249192426, 3998564322⟩, ⟨749730808, 999641088⟩, ⟨62477567, 62477569⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨562, 1002⟩, ⟨187, 251⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94125), (-93684)⟩, ⟨187, 251⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-87630), (-49060)⟩, ⟨(-21811), (-16119)⟩, ⟨(-1331), (-1288)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5025426, 5063997⟩, ⟨(-21811), (-16119)⟩, ⟨(-1331), (-1288)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2631719, 4714522⟩, ⟨856933, 1170190⟩, ⟨66786, 70178⟩, ⟨(-626), (-450)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140533858), (-138451054)⟩, ⟨856933, 1170190⟩, ⟨66786, 70178⟩, ⟨(-626), (-450)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-130835379), (-72504175)⟩, ⟨(-32260086), (-23078624)⟩, ⟨(-1859743), (-1676310)⟩, ⟨23540, 33122⟩, ⟨806, 936⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1300820386, 1359151591⟩, ⟨(-32260086), (-23078624)⟩, ⟨(-1859743), (-1676310)⟩, ⟨23540, 33122⟩, ⟨806, 936⟩⟩
...
def j72 : Jet := ⟨⟨6144, 10968⟩, ⟨2023, 2733⟩, ⟨161, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846033), (-841208)⟩, ⟨2023, 2733⟩, ⟨161, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-787647), (-440524)⟩, ⟨(-195853), (-144296)⟩, ⟨(-11870), (-11441)⟩, ⟨55, 80⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35003747, 35350871⟩, ⟨(-195853), (-144296)⟩, ⟨(-11870), (-11441)⟩, ⟨55, 80⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18330794, 32911248⟩, ⟨5927927, 8152247⟩, ⟨452552, 483060⟩, ⟨(-5585), (-4021)⟩, ⟨(-164), (-144)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697497089), (-682916634)⟩, ⟨5927927, 8152247⟩, ⟨452552, 483060⟩, ⟨(-5585), (-4021)⟩, ⟨(-164), (-144)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-649361633), (-357630411)⟩, ⟨(-159236068), (-111620490)⟩, ⟨(-8874504), (-7587042)⟩, ⟨160028, 228915⟩, ⟨5130, 6251⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3645605663, 3937336885⟩, ⟨(-159236068), (-111620490)⟩, ⟨(-8874504), (-7587042)⟩, ⟨160028, 228915⟩, ⟨5130, 6251⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨941349096, 1311414589⟩, ⟨125764488, 147225794⟩, ⟨(-5685303), (-3996580)⟩, ⟨(-207269), (-170220)⟩, ⟨3422, 4899⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4685081468, 5059994355⟩, ⟨132818476, 221015020⟩, ⟨12793208, 21971249⟩, ⟨324424, 1292042⟩, ⟨12964, 97501⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1026852336, 1545006041⟩, ⟨166298221, 240934084⟩, ⟨(-4863), 9925159⟩, ⟨(-91037), 838383⟩, ⟨(-23678), 62666⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1319113306), (-989334979)⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2975853990, 3305632317⟩, ⟨(-164889164), (-164889163)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨245502619, 555776914⟩, ⟨79518052, 173339908⟩, ⟨6435454, 20656293⟩, ⟨(-66044), 1716718⟩, ⟨(-27262), 162084⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4540469915, 4850744210⟩, ⟨79518052, 173339908⟩, ⟨6435454, 20656293⟩, ⟨(-66044), 1716718⟩, ⟨(-27262), 162084⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4416012884, 4564404424⟩, ⟨37412047, 84294279⟩, ⟨2249421, 9886571⟩, ⟨(-220836), 815775⟩, ⟨(-39897), 82464⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3059722846, 3513005277⟩, ⟨(-149311508), (-104658951)⟩, ⟨(-1677607), 6172930⟩, ⟨(-549525), 541506⟩, ⟨(-62026), 71948⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7358585662, 9811447558⟩, ⟨1226430942, 1226430951⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12607495986, 22413326238⟩, ⟨4202498656, 5603331588⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12607495986, 22413326238⟩, ⟨4202498656, 5603331588⟩, ⟨350208220, 350208227⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-22413326238), (-12607495986)⟩, ⟨(-5603331588), (-4202498656)⟩, ⟨(-350208227), (-350208220)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11206663119), (-6303747993)⟩, ⟨(-2801665794), (-2101249328)⟩, ⟨(-175104114), (-175104110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨316063967, 989790716⟩, ⟨(-645653995), (-154629628)⟩, ⟨(-2528245), 197698656⟩, ⟨(-38784386), 18098442⟩, ⟨(-6981514), 6376435⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨225163097, 809584747⟩, ⟨(-562512558), (-117859506)⟩, ⟨1313433, 185572986⟩, ⟨(-39650579), 15268233⟩, ⟨(-6512527), 6947157⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1154224142, 1154224143⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4478894605, 4478894611⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2402
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨989334979, 1319113306⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4416012884, 4564404424⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2403
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (35872077 / 4294967296)

theorem envelope_integral : (∫ s in ((92139 / 400000) : ℝ)..(30713 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((92139 / 400000) : ℝ)..(30713 / 100000), prawitzNormalCorrection
