...
namespace FiniteNormalPanel18_19

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (30417 / 200000)
def radius : Rat := (10139 / 200000)

def j0 : Jet := ⟨⟨653200101, 653200102⟩, ⟨217733367, 217733368⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2052088638, 2052088642⟩, ⟨684029546, 684029550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨980465621, 980465626⟩, ⟨653643746, 653643754⟩, ⟨108940624, 108940626⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨245, 246⟩, ⟨163, 164⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94442), (-94440)⟩, ⟨163, 164⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-21560), (-21558)⟩, ⟨(-14336), (-14334)⟩, ⟨(-2366), (-2363)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5091496, 5091499⟩, ⟨(-14336), (-14334)⟩, ⟨(-2366), (-2363)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1162299, 1162300⟩, ⟨771593, 771595⟩, ⟨126421, 126425⟩, ⟨(-724), (-719)⟩, ⟨(-60), (-56)⟩⟩
...
def j16 : Jet := ⟨⟨(-142003278), (-142003276)⟩, ⟨771593, 771595⟩, ⟨126421, 126425⟩, ⟨(-724), (-719)⟩, ⟨(-60), (-56)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-32416856), (-32416854)⟩, ⟨(-21435096), (-21435094)⟩, ⟨(-3455587), (-3455583)⟩, ⟨38644, 38649⟩, ⟨3081, 3086⟩⟩
...
def j19 : Jet := ⟨⟨1399238909, 1399238912⟩, ⟨(-21435096), (-21435094)⟩, ⟨(-3455587), (-3455583)⟩, ⟨38644, 38649⟩, ⟨3081, 3086⟩⟩
...
def j22 : Jet := ⟨⟨(-25), (-24)⟩, ⟨(-17), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11810, 11812⟩, ⟨(-17), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2696, 2697⟩, ⟨1793, 1795⟩, ⟨295, 298⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849481), (-849479)⟩, ⟨1793, 1795⟩, ⟨295, 298⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-193922), (-193921)⟩, ⟨(-128873), (-128870)⟩, ⟨(-21208), (-21203)⟩, ⟨88, 92⟩, ⟨5, 8⟩⟩
...
def j30 : Jet := ⟨⟨35597472, 35597474⟩, ⟨(-128873), (-128870)⟩, ⟨(-21208), (-21203)⟩, ⟨88, 92⟩, ⟨5, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8126277, 8126279⟩, ⟨5388098, 5388101⟩, ⟨878464, 878468⟩, ⟨(-6477), (-6472)⟩, ⟨(-524), (-520)⟩⟩
...
def j33 : Jet := ⟨⟨(-707701606), (-707701603)⟩, ⟨5388098, 5388101⟩, ⟨878464, 878468⟩, ⟨(-6477), (-6472)⟩, ⟨(-524), (-520)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-161555852), (-161555849)⟩, ⟨(-106473894), (-106473890)⟩, ⟨(-16930109), (-16930104)⟩, ⟨268879, 268884⟩, ⟨21175, 21181⟩⟩
...
def j36 : Jet := ⟨⟨4133411444, 4133411447⟩, ⟨(-106473894), (-106473890)⟩, ⟨(-16930109), (-16930104)⟩, ⟨268879, 268884⟩, ⟨21175, 21181⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨668541124, 668541128⟩, ⟨212605585, 212605590⟩, ⟨(-5064861), (-5064857)⟩, ⟨(-531885), (-531879)⟩, ⟨7626, 7631⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4462837612, 4462837616⟩, ⟨114959685, 114959691⟩, ⟨21240688, 21240698⟩, ⟨727695, 727705⟩, ⟨75396, 75408⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨694671290, 694671296⟩, ⟨238809612, 238809620⟩, ⟨3734065, 3734074⟩, ⟨476466, 476478⟩, ⟨16394, 16407⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-653200102), (-653200101)⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3641767194, 3641767195⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨112356664, 112356667⟩, ⟨77250496, 77250502⟩, ⟨14486238, 14486244⟩, ⟨569370, 569378⟩, ⟨61532, 61543⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4407323960, 4407323963⟩, ⟨77250496, 77250502⟩, ⟨14486238, 14486244⟩, ⟨569370, 569378⟩, ⟨61532, 61543⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4350782949, 4350782951⟩, ⟨38129729, 38129733⟩, ⟨6983115, 6983120⟩, ⟨219833, 219839⟩, ⟨22840, 22848⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3689094123, 3689094127⟩, ⟨(-188232174), (-188232168)⟩, ⟨3988100, 3988107⟩, ⟨(-167611), (-167604)⟩, ⟨8221, 8230⟩⟩
...
def j47 : Jet := ⟨⟨2901865692, 2901865698⟩, ⟨967288564, 967288569⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1960625987, 1960625996⟩, ⟨1307083990, 1307084002⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1960625987, 1960625996⟩, ⟨1307083990, 1307084002⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1960625996), (-1960625987)⟩, ⟨(-1307084002), (-1307083990)⟩, ⟨(-217847335), (-217847331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-980312998), (-980312993)⟩, ⟨(-653542001), (-653541995)⟩, ⟨(-108923668), (-108923665)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3418483508, 3418483516⟩, ⟨(-520172194), (-520172187)⟩, ⟨(-47119470), (-47119465)⟩, ⟨11184615, 11184617⟩, ⟨172017, 172018⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2936252257, 2936252268⟩, ⟨(-596612872), (-596612859)⟩, ⟨(-14501105), (-14501092)⟩, ⟨11055499, 11055513⟩, ⟨(-359341), (-359327)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨435466734, 870933469⟩, ⟨217733367, 217733368⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1368059092, 2736118189⟩, ⟨684029546, 684029550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨435762498, 1743050000⟩, ⟨435762498, 871525004⟩, ⟨108940624, 108940626⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨109, 437⟩, ⟨109, 219⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94578), (-94249)⟩, ⟨109, 219⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-38384), (-9562)⟩, ⟨(-19181), (-9473)⟩, ⟨(-2386), (-2333)⟩, ⟨4, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5074672, 5103495⟩, ⟨(-19181), (-9473)⟩, ⟨(-2386), (-2333)⟩, ⟨4, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨514870, 2071180⟩, ⟨507085, 1034629⟩, ⟨123855, 128252⟩, ⟨(-972), (-471)⟩, ⟨(-61), (-55)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142650707), (-141094396)⟩, ⟨507085, 1034629⟩, ⟨123855, 128252⟩, ⟨(-972), (-471)⟩, ⟨(-61), (-55)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-57892715), (-14315276)⟩, ⟨(-28894910), (-13895386)⟩, ⟨(-3554281), (-3316824)⟩, ⟨25033, 52222⟩, ⟨2918, 3202⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1373763050, 1417340490⟩, ⟨(-28894910), (-13895386)⟩, ⟨(-3554281), (-3316824)⟩, ⟨25033, 52222⟩, ⟨2918, 3202⟩⟩
...
def j70 : Jet := ⟨⟨(-44), (-10)⟩, ⟨(-22), (-10)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11791, 11826⟩, ⟨(-22), (-10)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1196, 4800⟩, ⟨1187, 2399⟩, ⟨292, 299⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850981), (-847376)⟩, ⟨1187, 2399⟩, ⟨292, 299⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-345359), (-85973)⟩, ⟨(-172560), (-84999)⟩, ⟨(-21436), (-20884)⟩, ⟨58, 122⟩, ⟨5, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35446035, 35705422⟩, ⟨(-172560), (-84999)⟩, ⟨(-21436), (-20884)⟩, ⟨58, 122⟩, ⟨5, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3596314, 14490527⟩, ⟨3526283, 7236641⟩, ⟨855362, 894917⟩, ⟨(-8722), (-4223)⟩, ⟨(-539), (-500)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712231569), (-701337355)⟩, ⟨3526283, 7236641⟩, ⟨855362, 894917⟩, ⟨(-8722), (-4223)⟩, ⟨(-539), (-500)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-289048822), (-71156890)⟩, ⟨(-144166640), (-68220004)⟩, ⟨(-17620996), (-15957589)⟩, ⟨172687, 364723⟩, ⟨19707, 22222⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4005918474, 4223810406⟩, ⟨(-144166640), (-68220004)⟩, ⟨(-17620996), (-15957589)⟩, ⟨172687, 364723⟩, ⟨19707, 22222⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨437579357, 902919820⟩, ⟨200382113, 221303914⟩, ⟨(-6866155), (-3269515)⟩, ⟨(-558093), (-494978)⟩, ⟨4915, 10358⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4367322938, 4604872564⟩, ⟨70537916, 165722047⟩, ⟨17639058, 26219714⟩, ⟨153757, 1484310⟩, ⟨30585, 144228⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨444951086, 968070400⟩, ⟨210944407, 272111512⟩, ⟨(-2273533), 10726558⟩, ⟨(-24679), 1106037⟩, ⟨(-48166), 96353⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-870933469), (-435466734)⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3424033827, 3859500562⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨46096152, 218199636⟩, ⟨43706940, 122665940⟩, ⟨9335497, 22075328⟩, ⟨(-299210), 1857776⟩, ⟨(-30521), 210374⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4341063448, 4513166932⟩, ⟨43706940, 122665940⟩, ⟨9335497, 22075328⟩, ⟨(-299210), 1857776⟩, ⟨(-30521), 210374⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4317953860, 4402715569⟩, ⟨21318646, 61006465⟩, ⟨4130844, 10926279⟩, ⟨(-303182), 903550⟩, ⟨(-41771), 106936⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3442359175, 3956324238⟩, ⟨(-206200017), (-164077650)⟩, ⟨200468, 8737716⟩, ⟨(-826351), 602527⟩, ⟨(-83342), 111464⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1934577128, 3869154263⟩, ⟨967288564, 967288569⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨871389327, 3485557324⟩, ⟨871389326, 1742778668⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨871389327, 3485557324⟩, ⟨871389326, 1742778668⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3485557324), (-871389327)⟩, ⟨(-1742778668), (-871389326)⟩, ⟨(-217847335), (-217847331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1742778662), (-435694663)⟩, ⟨(-871389334), (-435694663)⟩, ⟨(-108923668), (-108923665)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2862432140, 3880643042⟩, ⟨(-787328686), (-290373900)⟩, ⟨(-83687878), 7275565⟩, ⟨4417365, 18971211⟩, ⟨(-1054506), 949167⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2294201296, 3574667994⟩, ⟨(-911559032), (-342082324)⟩, ⟨(-65862828), 52396126⟩, ⟨842777, 22024077⟩, ⟨(-2238175), 972572⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨653200101, 653200102⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4350782949, 4350782951⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified372
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨435466734, 870933469⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4317953860, 4402715569⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified373
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (297236251 / 4294967296)

theorem envelope_integral : (∫ s in ((10139 / 100000) : ℝ)..(10139 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (10139 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (10139 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((10139 / 100000) : ℝ)..(10139 / 50000), prawitzNormalCorrection
