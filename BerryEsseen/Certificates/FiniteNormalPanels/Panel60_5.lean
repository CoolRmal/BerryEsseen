...
namespace FiniteNormalPanel60_5

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (241871 / 800000)
def radius : Rat := (34553 / 800000)

def j0 : Jet := ⟨⟨1298535043, 1298535044⟩, ⟨185505006, 185505007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4079468151, 4079468155⟩, ⟨582781164, 582781168⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3874781633, 3874781642⟩, ⟨1107080464, 1107080476⟩, ⟨79077176, 79077178⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨969, 971⟩, ⟨277, 278⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93718), (-93715)⟩, ⟨277, 278⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-84550), (-84546)⟩, ⟨(-23908), (-23905)⟩, ⟨(-1638), (-1634)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5028506, 5028511⟩, ⟨(-23908), (-23905)⟩, ⟨(-1638), (-1634)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4536556, 4536562⟩, ⟨1274589, 1274595⟩, ⟨84941, 84948⟩, ⟨(-856), (-850)⟩, ⟨(-29), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-138629021), (-138629014)⟩, ⟨1274589, 1274595⟩, ⟨84941, 84948⟩, ⟨(-856), (-850)⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-125066654), (-125066646)⟩, ⟨(-34583437), (-34583428)⟩, ⟨(-2147210), (-2147199)⟩, ⟨44588, 44599⟩, ⟨1315, 1324⟩⟩
...
def j19 : Jet := ⟨⟨1306589111, 1306589120⟩, ⟨(-34583437), (-34583428)⟩, ⟨(-2147210), (-2147199)⟩, ⟨44588, 44599⟩, ⟨1315, 1324⟩⟩
...
def j25 : Jet := ⟨⟨10588, 10592⟩, ⟨2999, 3003⟩, ⟨206, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841589), (-841584)⟩, ⟨2999, 3003⟩, ⟨206, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-759255), (-759250)⟩, ⟨(-214225), (-214218)⟩, ⟨(-14537), (-14528)⟩, ⟨106, 111⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35032139, 35032145⟩, ⟨(-214225), (-214218)⟩, ⟨(-14537), (-14528)⟩, ⟨106, 111⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨31604871, 31604877⟩, ⟨8836696, 8836705⟩, ⟨576662, 576675⟩, ⟨(-7598), (-7587)⟩, ⟨(-241), (-234)⟩⟩
...
def j33 : Jet := ⟨⟨(-684223012), (-684223005)⟩, ⟨8836696, 8836705⟩, ⟨576662, 576675⟩, ⟨(-7598), (-7587)⟩, ⟨(-241), (-234)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-617284041), (-617284032)⟩, ⟨(-168394687), (-168394674)⟩, ⟨(-9799623), (-9799605)⟩, ⟨304483, 304500⟩, ⟨8440, 8452⟩⟩
...
def j36 : Jet := ⟨⟨3677683255, 3677683264⟩, ⟨(-168394687), (-168394674)⟩, ⟨(-9799623), (-9799605)⟩, ⟨304483, 304500⟩, ⟨8440, 8452⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1241031257, 1241031268⟩, ⟨144441959, 144441971⟩, ⟨(-6732078), (-6732064)⟩, ⟨(-249004), (-248989)⟩, ⟨7299, 7310⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5015859917, 5015859930⟩, ⟨229667438, 229667459⟩, ⟨23881397, 23881426⟩, ⟨1290163, 1290193⟩, ⟨92162, 92189⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1449333256, 1449333274⟩, ⟨235048378, 235048402⟩, ⟨6762336, 6762364⟩, ⟨525147, 525180⟩, ⟨27793, 27820⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1298535044), (-1298535043)⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2996432252, 2996432253⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨489076340, 489076353⟩, ⟨158633770, 158633790⟩, ⟨17427254, 17427280⟩, ⟨1094576, 1094606⟩, ⟨86881, 86908⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4784043636, 4784043649⟩, ⟨158633770, 158633790⟩, ⟨17427254, 17427280⟩, ⟨1094576, 1094606⟩, ⟨86881, 86908⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4532914179, 4532914186⟩, ⟨75153292, 75153303⟩, ⟨7633220, 7633234⟩, ⟨392003, 392019⟩, ⟨28232, 28248⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3162438571, 3162438578⟩, ⟨(-143350692), (-143350681)⟩, ⟨2079435, 2079448⟩, ⟨(-56204), (-56191)⟩, ⟨2764, 2777⟩⟩
...
def j47 : Jet := ⟨⟨7879731299, 7879731308⟩, ⟨1125675899, 1125675906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14456493161, 14456493195⟩, ⟨4130426614, 4130426646⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14456493161, 14456493195⟩, ⟨4130426614, 4130426646⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14456493195), (-14456493161)⟩, ⟨(-4130426646), (-4130426614)⟩, ⟨(-295030476), (-295030472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7228246598), (-7228246580)⟩, ⟨(-2065213323), (-2065213307)⟩, ⟨(-147515238), (-147515236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨798106390, 798106400⟩, ⟨(-383765430), (-383765422)⟩, ⟨64854014, 64854019⟩, ⟨(-1607688), (-1607685)⟩, ⟨(-920479), (-920477)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨587655797, 587655807⟩, ⟨(-309209272), (-309209261)⟩, ⟨60947956, 60947965⟩, ⟨(-3544606), (-3544596)⟩, ⟨(-587171), (-587160)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1113030037, 1484040050⟩, ⟨185505006, 185505007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3496686987, 4662249319⟩, ⟨582781164, 582781168⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2846778343, 5060939285⟩, ⟨948926112, 1265234828⟩, ⟨79077176, 79077178⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨712, 1268⟩, ⟨237, 317⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93975), (-93418)⟩, ⟨237, 317⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-110735), (-61919)⟩, ⟨(-27527), (-20265)⟩, ⟨(-1667), (-1601)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5002321, 5051138⟩, ⟨(-27527), (-20265)⟩, ⟨(-1667), (-1601)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3315624, 5951967⟩, ⟨1072771, 1474561⟩, ⟨82025, 87462⟩, ⟨(-994), (-711)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139849953), (-137213609)⟩, ⟨1072771, 1474561⟩, ⟨82025, 87462⟩, ⟨(-994), (-711)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-164791039), (-90947544)⟩, ⟨(-40486709), (-28578311)⟩, ⟨(-2283477), (-1988874)⟩, ⟨36701, 52445⟩, ⟨1181, 1439⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1266864726, 1340708222⟩, ⟨(-40486709), (-28578311)⟩, ⟨(-2283477), (-1988874)⟩, ⟨36701, 52445⟩, ⟨1181, 1439⟩⟩
...
def j70 : Jet := ⟨⟨(-128), (-70)⟩, ⟨(-32), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11707, 11766⟩, ⟨(-32), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7759, 13865⟩, ⟨2548, 3452⟩, ⟨202, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844418), (-838311)⟩, ⟨2548, 3452⟩, ⟨202, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-995013), (-555646)⟩, ⟨(-247066), (-181147)⟩, ⟨(-14853), (-14167)⟩, ⟨87, 127⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34796381, 35235749⟩, ⟨(-247066), (-181147)⟩, ⟨(-14853), (-14167)⟩, ⟨87, 127⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨23063641, 41519755⟩, ⟨7396751, 10259872⟩, ⟨550371, 599335⟩, ⟨(-8868), (-6315)⟩, ⟨(-255), (-217)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692764242), (-674308127)⟩, ⟨7396751, 10259872⟩, ⟨550371, 599335⟩, ⟨(-8868), (-6315)⟩, ⟨(-255), (-217)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-816313031), (-446943047)⟩, ⟨(-199175565), (-136891379)⟩, ⟨(-10755866), (-8686453)⟩, ⟨247333, 361272⟩, ⟨7219, 9497⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3478654265, 3848024249⟩, ⟨(-199175565), (-136891379)⟩, ⟨(-10755866), (-8686453)⟩, ⟨247333, 361272⟩, ⟨7219, 9497⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1031400030, 1455358229⟩, ⟨127951093, 158653152⟩, ⟨(-7972362), (-5496984)⟩, ⟨(-279965), (-212938)⟩, ⟨5940, 8680⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4793822200, 5302839164⟩, ⟨170537627, 303622007⟩, ⟨16888260, 33780511⟩, ⟨487899, 2532103⟩, ⟨13884, 227358⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1151195811, 1796877621⟩, ⟨183765614, 298766172⟩, ⟨(-707138), 16526733⟩, ⟨(-288969), 1649903⟩, ⟨(-57999), 151225⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1484040050), (-1113030037)⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2810927246, 3181937259⟩, ⟨(-185505007), (-185505006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨308559228, 751756408⟩, ⟨98510740, 249988516⟩, ⟨7270954, 34611269⟩, ⟨(-340172), 3679798⟩, ⟨(-91456), 419672⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4603526524, 5046723704⟩, ⟨98510740, 249988516⟩, ⟨7270954, 34611269⟩, ⟨(-340172), 3679798⟩, ⟨(-91456), 419672⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4446571248, 4655696861⟩, ⟨45438998, 120732633⟩, ⟨1788361, 16483439⟩, ⟨(-611844), 1758894⟩, ⟨(-122479), 218936⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2910147484, 3449184660⟩, ⟨(-171346907), (-102607897)⟩, ⟨(-4044166), 10249230⟩, ⟨(-1165228), 1225841⟩, ⟨(-166708), 188627⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6754055400, 9005407207⟩, ⟨1125675899, 1125675906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10621097019, 18881950287⟩, ⟨3540365670, 4720487594⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10621097019, 18881950287⟩, ⟨3540365670, 4720487594⟩, ⟨295030472, 295030476⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18881950287), (-10621097019)⟩, ⟨(-4720487594), (-3540365670)⟩, ⟨(-295030476), (-295030472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9440975144), (-5310548509)⟩, ⟨(-2360243797), (-1770182835)⟩, ⟨(-147515238), (-147515236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨476777960, 1247305368⟩, ⟨(-685440553), (-196505375)⟩, ⟨(-2344914), 171962054⟩, ⟨(-27000385), 16124332⟩, ⟨(-5168340), 3749698⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨323051163, 1001680862⟩, ⟨(-600221791), (-144536794)⟩, ⟨1636951, 168420590⟩, ⟨(-30517839), 14044026⟩, ⟨(-5199817), 4739570⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1298535043, 1298535044⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4532914179, 4532914186⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1184
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1113030037, 1484040050⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4446571248, 4655696861⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1185
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (52600007 / 4294967296)

theorem envelope_integral : (∫ s in ((103659 / 400000) : ℝ)..(34553 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((103659 / 400000) : ℝ)..(34553 / 100000), prawitzNormalCorrection
