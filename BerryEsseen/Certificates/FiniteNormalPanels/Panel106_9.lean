...
namespace FiniteNormalPanel106_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (14459 / 80000)
def radius : Rat := (14459 / 400000)

def j0 : Jet := ⟨⟨776261651, 776261652⟩, ⟨155252330, 155252331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2438697899, 2438697904⟩, ⟨487739579, 487739583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1384701450, 1384701456⟩, ⟨553880578, 553880586⟩, ⟨55388057, 55388059⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨346, 347⟩, ⟨138, 139⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94341), (-94339)⟩, ⟨138, 139⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-30416), (-30414)⟩, ⟨(-12123), (-12120)⟩, ⟨(-1196), (-1193)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5082640, 5082643⟩, ⟨(-12123), (-12120)⟩, ⟨(-1196), (-1193)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1638647, 1638649⟩, ⟨651550, 651553⟩, ⟨63595, 63600⟩, ⟨(-312), (-307)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-141526930), (-141526927)⟩, ⟨651550, 651553⟩, ⟨63595, 63600⟩, ⟨(-312), (-307)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-45628415), (-45628412)⟩, ⟨(-18041306), (-18041303)⟩, ⟨(-1720610), (-1720606)⟩, ⟨16502, 16507⟩, ⟨773, 778⟩⟩
...
def j19 : Jet := ⟨⟨1386027350, 1386027354⟩, ⟨(-18041306), (-18041303)⟩, ⟨(-1720610), (-1720606)⟩, ⟨16502, 16507⟩, ⟨773, 778⟩⟩
...
def j25 : Jet := ⟨⟨3804, 3805⟩, ⟨1516, 1518⟩, ⟨149, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848373), (-848371)⟩, ⟨1516, 1518⟩, ⟨149, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-273517), (-273515)⟩, ⟨(-108919), (-108916)⟩, ⟨(-10698), (-10694)⟩, ⟨37, 40⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35517877, 35517880⟩, ⟨(-108919), (-108916)⟩, ⟨(-10698), (-10694)⟩, ⟨37, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11450996, 11450998⟩, ⟨4545282, 4545286⟩, ⟨440542, 440548⟩, ⟨(-2774), (-2770)⟩, ⟨(-135), (-130)⟩⟩
...
def j33 : Jet := ⟨⟨(-704376887), (-704376884)⟩, ⟨4545282, 4545286⟩, ⟨440542, 440548⟩, ⟨(-2774), (-2770)⟩, ⟨(-135), (-130)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-227091765), (-227091762)⟩, ⟨(-89371304), (-89371299)⟩, ⟨(-8355479), (-8355474)⟩, ⟨114533, 114538⟩, ⟨5279, 5284⟩⟩
...
def j36 : Jet := ⟨⟨4067875531, 4067875534⟩, ⟨(-89371304), (-89371299)⟩, ⟨(-8355479), (-8355474)⟩, ⟨114533, 114538⟩, ⟨5279, 5284⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨786991321, 786991325⟩, ⟨147154344, 147154350⟩, ⟨(-3025753), (-3025749)⟩, ⟨(-186025), (-186020)⟩, ⟨2311, 2317⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4534736601, 4534736605⟩, ⟨99628244, 99628252⟩, ⟨11503246, 11503255⟩, ⟨329678, 329689⟩, ⟨22174, 22184⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨830925616, 830925622⟩, ⟨173624779, 173624790⟩, ⟨2326603, 2326612⟩, ⟨187935, 187947⟩, ⟨5378, 5390⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-776261652), (-776261651)⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3518705644, 3518705645⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨160754979, 160754982⟩, ⟨67180616, 67180622⟩, ⟨7919043, 7919048⟩, ⟨260822, 260832⟩, ⟨18534, 18543⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4455722275, 4455722278⟩, ⟨67180616, 67180622⟩, ⟨7919043, 7919048⟩, ⟨260822, 260832⟩, ⟨18534, 18543⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4374606433, 4374606436⟩, ⟨32978800, 32978804⟩, ⟨3763130, 3763134⟩, ⟨99666, 99673⟩, ⟨6727, 6734⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3583951002, 3583951006⟩, ⟨(-131112793), (-131112787)⟩, ⟨1890889, 1890894⟩, ⟨(-54376), (-54368)⟩, ⟨1908, 1915⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨37305408747, 37305408754⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value471

def j47 : Jet := ⟨⟨6742486307, 6742486318⟩, ⟨1348497259, 1348497269⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10584742203, 10584742238⟩, ⟨4233896872, 4233896914⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10584742203, 10584742238⟩, ⟨4233896872, 4233896914⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10584742238), (-10584742203)⟩, ⟨(-4233896914), (-4233896872)⟩, ⟨(-423389693), (-423389686)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5292371119), (-5292371101)⟩, ⟨(-2116948457), (-2116948436)⟩, ⟨(-211694847), (-211694843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1252595453, 1252595470⟩, ⟨(-617392373), (-617392357)⟩, ⟨90414165, 90414174⟩, ⟨5432358, 5432362⟩, ⟨(-2897605), (-2897603)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1045232808, 1045232824⟩, ⟨(-553423379), (-553423360)⟩, ⟨94845072, 94845085⟩, ⟨1485298, 1485309⟩, ⟨(-2535576), (-2535566)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨621009321, 931513982⟩, ⟨155252330, 155252331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1950958320, 2926437483⟩, ⟨487739579, 487739583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨886208928, 1993970094⟩, ⟨443104462, 664656702⟩, ⟨55388057, 55388059⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨221, 500⟩, ⟨110, 167⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94466), (-94186)⟩, ⟨110, 167⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-43857), (-19434)⟩, ⟨(-14597), (-9639)⟩, ⟨(-1206), (-1181)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5069199, 5093623⟩, ⟨(-14597), (-9639)⟩, ⟨(-1206), (-1181)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1045961, 2364752⟩, ⟨516203, 786263⟩, ⟨62553, 64451⟩, ⟨(-376), (-242)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142119616), (-140800824)⟩, ⟨516203, 786263⟩, ⟨62553, 64451⟩, ⟨(-376), (-242)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-65980075), (-29052362)⟩, ⟨(-21886848), (-14161152)⟩, ⟨(-1766619), (-1664173)⟩, ⟨12934, 20065⟩, ⟨739, 806⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1365675690, 1402603404⟩, ⟨(-21886848), (-14161152)⟩, ⟨(-1766619), (-1664173)⟩, ⟨12934, 20065⟩, ⟨739, 806⟩⟩
...
def j70 : Jet := ⟨⟨(-51), (-22)⟩, ⟨(-17), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11784, 11814⟩, ⟨(-17), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2431, 5485⟩, ⟨1207, 1827⟩, ⟨147, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849746), (-846691)⟩, ⟨1207, 1827⟩, ⟨147, 152⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-394501), (-174703)⟩, ⟨(-131252), (-86502)⟩, ⟨(-10805), (-10564)⟩, ⟨29, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35396893, 35616692⟩, ⟨(-131252), (-86502)⟩, ⟨(-10805), (-10564)⟩, ⟨29, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7303674, 16535311⟩, ⟨3590902, 5493923⟩, ⟨431150, 448212⟩, ⟨(-3361), (-2181)⟩, ⟨(-139), (-127)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708524209), (-699292571)⟩, ⟨3590902, 5493923⟩, ⟨431150, 448212⟩, ⟨(-3361), (-2181)⟩, ⟨(-139), (-127)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-328937565), (-144289648)⟩, ⟨(-108904922), (-69594228)⟩, ⟨(-8677726), (-7959817)⟩, ⟨89228, 139762⟩, ⟨4974, 5530⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3966029731, 4150677648⟩, ⟨(-108904922), (-69594228)⟩, ⟨(-8677726), (-7959817)⟩, ⟨89228, 139762⟩, ⟨4974, 5530⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨620348460, 955683919⟩, ⟨140174196, 152848052⟩, ⟨(-3689199), (-2364088)⟩, ⟨(-194744), (-175312)⟩, ⟨1803, 2829⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4444272872, 4651186533⟩, ⟨74516925, 127718939⟩, ⟨9772269, 13683949⟩, ⟨150136, 555219⟩, ⟨10757, 37939⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨641913579, 1034947153⟩, ⟨155809995, 193944141⟩, ⟨(-151712), 5143805⟩, ⟨20019, 388103⟩, ⟨(-9229), 22846⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-931513982), (-621009321)⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3363453314, 3673957975⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨95938575, 249388537⟩, ⟨46573836, 93468436⟩, ⟨5579256, 11236749⟩, ⟨(-7720), 651592⟩, ⟨(-3178), 52225⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4390905871, 4544355833⟩, ⟨46573836, 93468436⟩, ⟨5579256, 11236749⟩, ⟨(-7720), 651592⟩, ⟨(-3178), 52225⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4342671656, 4417902182⟩, ⟨22638923, 46220842⟩, ⟨2470216, 5497647⟩, ⟨(-62332), 309341⟩, ⟨(-8346), 25788⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3400811313, 3779117706⟩, ⟨(-141967240), (-117438952)⟩, ⟨263695, 3884403⟩, ⟨(-252047), 175322⟩, ⟨(-18322), 24314⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5393989047, 8090983578⟩, ⟨1348497259, 1348497269⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6774235013, 15242028810⟩, ⟨3387117498, 5080676294⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6774235013, 15242028810⟩, ⟨3387117498, 5080676294⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15242028810), (-6774235013)⟩, ⟨(-5080676294), (-3387117498)⟩, ⟨(-423389693), (-423389686)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7621014405), (-3387117506)⟩, ⟨(-2540338147), (-1693558749)⟩, ⟨(-211694847), (-211694843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨728358613, 1951931106⟩, ⟨(-1154505892), (-287200813)⟩, ⟨(-39585408), 305526871⟩, ⟨(-50799278), 45740839⟩, ⟨(-14293132), 8487108⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨576723881, 1717493265⟩, ⟨(-1080363042), (-247325153)⟩, ⟨(-26933220), 308758141⟩, ⟨(-55955679), 41617624⟩, ⟨(-14179637), 9502018⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨776261651, 776261652⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4374606433, 4374606436⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar471 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2138
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar471 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨621009321, 931513982⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4342671656, 4417902182⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2139
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((14459 / 100000) : ℝ)..(43377 / 200000), prawitzNormalCorrection
      ((8184 / 3125) * sqrt n) s) ≤ (upper : ℝ) :=
