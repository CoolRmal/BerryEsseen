...
namespace FiniteNormalPanel70_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3251 / 16000)
def radius : Rat := (3251 / 80000)

def j0 : Jet := ⟨⟨872683667, 872683668⟩, ⟨174536733, 174536734⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2741616597, 2741616601⟩, ⟨548323318, 548323322⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1750062584, 1750062590⟩, ⟨700025030, 700025040⟩, ⟨70002503, 70002505⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨438, 439⟩, ⟨175, 176⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94249), (-94247)⟩, ⟨175, 176⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-38404), (-38402)⟩, ⟨(-15291), (-15289)⟩, ⟨(-1503), (-1499)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5074652, 5074655⟩, ⟨(-15291), (-15289)⟩, ⟨(-1503), (-1499)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2067759, 2067761⟩, ⟨820872, 820876⟩, ⟨79604, 79610⟩, ⟨(-494), (-490)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-141097818), (-141097815)⟩, ⟨820872, 820876⟩, ⟨79604, 79610⟩, ⟨(-494), (-490)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-57492874), (-57492872)⟩, ⟨(-22662671), (-22662667)⟩, ⟨(-2133488), (-2133482)⟩, ⟨26151, 26157⟩, ⟨1205, 1211⟩⟩
...
def j19 : Jet := ⟨⟨1374162891, 1374162894⟩, ⟨(-22662671), (-22662667)⟩, ⟨(-2133488), (-2133482)⟩, ⟨26151, 26157⟩, ⟨1205, 1211⟩⟩
...
def j22 : Jet := ⟨⟨(-45), (-43)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11790, 11793⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4804, 4806⟩, ⟨1913, 1917⟩, ⟨188, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847373), (-847370)⟩, ⟨1913, 1917⟩, ⟨188, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-345278), (-345276)⟩, ⟨(-137333), (-137328)⟩, ⟨(-13425), (-13420)⟩, ⟨60, 64⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35446116, 35446119⟩, ⟨(-137333), (-137328)⟩, ⟨(-13425), (-13420)⟩, ⟨60, 64⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨14443165, 14443167⟩, ⟨5721306, 5721311⟩, ⟨549871, 549877⟩, ⟨(-4404), (-4398)⟩, ⟨(-210), (-205)⟩⟩
...
def j33 : Jet := ⟨⟨(-701384718), (-701384715)⟩, ⟨5721306, 5721311⟩, ⟨549871, 549877⟩, ⟨(-4404), (-4398)⟩, ⟨(-210), (-205)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-285791969), (-285791965)⟩, ⟨(-111985538), (-111985532)⟩, ⟨(-10275125), (-10275119)⟩, ⟨181076, 181082⟩, ⟨8158, 8164⟩⟩
...
def j36 : Jet := ⟨⟨4009175327, 4009175331⟩, ⟨(-111985538), (-111985532)⟩, ⟨(-10275125), (-10275119)⟩, ⟨181076, 181082⟩, ⟨8158, 8164⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨877172637, 877172641⟩, ⟨160968209, 160968216⟩, ⟨(-4255139), (-4255132)⟩, ⟨(-255682), (-255677)⟩, ⟨4107, 4114⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4601131791, 4601131797⟩, ⟨128520243, 128520252⟩, ⟨15382111, 15382120⟩, ⟨551221, 551234⟩, ⟨39643, 39655⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨939701429, 939701435⟩, ⟨198690775, 198690787⟩, ⟨3399788, 3399801⟩, ⟨287834, 287847⟩, ⟨10262, 10278⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-872683668), (-872683667)⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3422283628, 3422283629⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨205598486, 205598490⟩, ⟨86943620, 86943628⟩, ⟨10679379, 10679389⟩, ⟨440506, 440518⟩, ⟨33811, 33824⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4500565782, 4500565786⟩, ⟨86943620, 86943628⟩, ⟨10679379, 10679389⟩, ⟨440506, 440518⟩, ⟨33811, 33824⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4396564891, 4396564894⟩, ⟨42467245, 42467250⟩, ⟨5011197, 5011204⟩, ⟨166758, 166766⟩, ⟨12048, 12056⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3503237861, 3503237866⟩, ⟨(-144826976), (-144826969)⟩, ⟨2267221, 2267228⟩, ⟨(-70769), (-70760)⟩, ⟨2822, 2831⟩⟩
...
def j47 : Jet := ⟨⟨6033904885, 6033904894⟩, ⟨1206780974, 1206780982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8476899974, 8476900000⟩, ⟨3390759980, 3390760010⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8476899974, 8476900000⟩, ⟨3390759980, 3390760010⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8476900000), (-8476899974)⟩, ⟨(-3390760010), (-3390759980)⟩, ⟨(-339076002), (-339075997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4238450000), (-4238449987)⟩, ⟨(-1695380005), (-1695379990)⟩, ⟨(-169538001), (-169537998)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1600959117, 1600959129⟩, ⟨(-631956872), (-631956861)⟩, ⟨61532505, 61532511⟩, ⟨8534051, 8534053⟩, ⟨(-2056632), (-2056631)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1305840116, 1305840128⟩, ⟨(-569447250), (-569447235)⟩, ⟨72344467, 72344479⟩, ⟨4526029, 4526040⟩, ⟨(-1921342), (-1921331)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨698146933, 1047220401⟩, ⟨174536733, 174536734⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2193293275, 3289939919⟩, ⟨548323318, 548323322⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1120040051, 2520090126⟩, ⟨560020024, 840030046⟩, ⟨70002503, 70002505⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨280, 632⟩, ⟨140, 211⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94407), (-94054)⟩, ⟨140, 211⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-55394), (-24527)⟩, ⟨(-18429), (-12139)⟩, ⟨(-1517), (-1479)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5057662, 5088530⟩, ⟨(-18429), (-12139)⟩, ⟨(-1517), (-1479)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1318935, 2985717⟩, ⟨648653, 992074⟩, ⟨77937, 80970⟩, ⟨(-597), (-384)⟩, ⟨(-25), (-21)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141846642), (-140179859)⟩, ⟨648653, 992074⟩, ⟨77937, 80970⟩, ⟨(-597), (-384)⟩, ⟨(-25), (-21)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-83229114), (-36556054)⟩, ⟨(-27573884), (-17695922)⟩, ⟨(-2207019), (-2043208)⟩, ⟨20383, 31907⟩, ⟨1138, 1265⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1348426651, 1395099712⟩, ⟨(-27573884), (-17695922)⟩, ⟨(-2207019), (-2043208)⟩, ⟨20383, 31907⟩, ⟨1138, 1265⟩⟩
...
def j72 : Jet := ⟨⟨3069, 6929⟩, ⟨1521, 2307⟩, ⟨184, 192⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849108), (-845247)⟩, ⟨1521, 2307⟩, ⟨184, 192⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-498218), (-220423)⟩, ⟨(-165677), (-108857)⟩, ⟨(-13595), (-13211)⟩, ⟨45, 76⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35293176, 35570972⟩, ⟨(-165677), (-108857)⟩, ⟨(-13595), (-13211)⟩, ⟨45, 76⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9203741, 20871418⟩, ⟨4504658, 6928753⟩, ⟨534852, 562124⟩, ⟨(-5349), (-3451)⟩, ⟨(-217), (-197)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706624142), (-694956464)⟩, ⟨4504658, 6928753⟩, ⟨534852, 562124⟩, ⟨(-5349), (-3451)⟩, ⟨(-217), (-197)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-414614688), (-181230500)⟩, ⟨(-137030174), (-86549775)⟩, ⟨(-10790236), (-9641918)⟩, ⟨140020, 221974⟩, ⟨7542, 8662⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3880352608, 4113736796⟩, ⟨(-137030174), (-86549775)⟩, ⟨(-10790236), (-9641918)⟩, ⟨140020, 221974⟩, ⟨7542, 8662⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨688595489, 1068644746⟩, ⟨151027309, 169070756⟩, ⟨(-5210835), (-3302571)⟩, ⟨(-271355), (-236408)⟩, ⟨3183, 5043⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4484181897, 4753883458⟩, ⟨94343646, 167877909⟩, ⟨12495095, 19147711⟩, ⟨227496, 981197⟩, ⟨15002, 75777⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨718931533, 1182829166⟩, ⟨172806561, 228906172⟩, ⟨(-446843), 7924630⟩, ⟨(-28180), 678516⟩, ⟨(-20111), 48263⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1047220401), (-698146933)⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3247746895, 3596820363⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨120341439, 325749823⟩, ⟨57851934, 126081006⟩, ⟨6706691, 16564739⟩, ⟨(-63154), 1218436⟩, ⟨(-14907), 113532⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4415308735, 4620717119⟩, ⟨57851934, 126081006⟩, ⟨6706691, 16564739⟩, ⟨(-63154), 1218436⟩, ⟨(-14907), 113532⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4354722335, 4454865757⟩, ⟨27887727, 62175468⟩, ⟨2799099, 8079424⟩, ⟨(-146500), 582934⟩, ⟨(-23170), 57180⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3292932161, 3730727330⟩, ⟨(-159946607), (-124896182)⟩, ⟨(-410048), 5632827⟩, ⟨(-451015), 374431⟩, ⟨(-43093), 53840⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4827123904, 7240685869⟩, ⟨1206780974, 1206780982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5425215974, 12206735987⟩, ⟨2712607982, 4068912010⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5425215974, 12206735987⟩, ⟨2712607982, 4068912010⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12206735987), (-5425215974)⟩, ⟨(-4068912010), (-2712607982)⟩, ⟨(-339076002), (-339075997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6103367994), (-2712607987)⟩, ⟨(-2034456005), (-1356303991)⟩, ⟨(-169538001), (-169537998)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1037063163, 2283856998⟩, ⟨(-1081825836), (-327493275)⟩, ⟨(-38442746), 215284974⟩, ⟨(-25374094), 34538972⟩, ⟨(-8339179), 3763562⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨795111675, 1983821327⟩, ⟨(-1024755741), (-281245066)⟩, ⟨(-24087084), 230285453⟩, ⟨(-31716592), 31735521⟩, ⟨(-8697536), 4638657⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨872683667, 872683668⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4396564891, 4396564894⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1398
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨698146933, 1047220401⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4354722335, 4454865757⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1399
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (108167491 / 4294967296)

theorem envelope_integral : (∫ s in ((3251 / 20000) : ℝ)..(9753 / 40000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((3251 / 20000) : ℝ)..(9753 / 40000), prawitzNormalCorrection
