...
namespace FiniteNormalPanel34_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (117879 / 800000)
def radius : Rat := (39293 / 800000)

def j0 : Jet := ⟨⟨632858062, 632858063⟩, ⟨210952687, 210952688⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1988182238, 1988182242⟩, ⟨662727411, 662727415⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨920348943, 920348947⟩, ⟨613565960, 613565966⟩, ⟨102260993, 102260995⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨230, 231⟩, ⟨153, 154⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94457), (-94455)⟩, ⟨153, 154⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-20241), (-20240)⟩, ⟨(-13462), (-13460)⟩, ⟨(-2223), (-2220)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5092815, 5092817⟩, ⟨(-13462), (-13460)⟩, ⟨(-2223), (-2220)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1091316, 1091317⟩, ⟨724659, 724661⟩, ⟨118856, 118861⟩, ⟨(-638), (-635)⟩, ⟨(-53), (-49)⟩⟩
...
def j16 : Jet := ⟨⟨(-142074261), (-142074259)⟩, ⟨724659, 724661⟩, ⟨118856, 118861⟩, ⟨(-638), (-635)⟩, ⟨(-53), (-49)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-30444446), (-30444444)⟩, ⟨(-20141014), (-20141011)⟩, ⟨(-3253726), (-3253722)⟩, ⟨34095, 34099⟩, ⟨2725, 2731⟩⟩
...
def j19 : Jet := ⟨⟨1401211319, 1401211322⟩, ⟨(-20141014), (-20141011)⟩, ⟨(-3253726), (-3253722)⟩, ⟨34095, 34099⟩, ⟨2725, 2731⟩⟩
...
def j22 : Jet := ⟨⟨(-24), (-22)⟩, ⟨(-16), (-15)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11811, 11814⟩, ⟨(-16), (-15)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2530, 2532⟩, ⟨1683, 1685⟩, ⟨277, 280⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849647), (-849644)⟩, ⟨1683, 1685⟩, ⟨277, 280⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-182067), (-182066)⟩, ⟨(-121018), (-121015)⟩, ⟨(-19931), (-19928)⟩, ⟨78, 81⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35609327, 35609329⟩, ⟨(-121018), (-121015)⟩, ⟨(-19931), (-19928)⟩, ⟨78, 81⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7630560, 7630561⟩, ⟨5061107, 5061110⟩, ⟨826280, 826284⟩, ⟨(-5714), (-5709)⟩, ⟨(-464), (-460)⟩⟩
...
def j33 : Jet := ⟨⟨(-708197323), (-708197321)⟩, ⟨5061107, 5061110⟩, ⟨826280, 826284⟩, ⟨(-5714), (-5709)⟩, ⟨(-464), (-460)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-151756374), (-151756372)⟩, ⟨(-100086395), (-100086391)⟩, ⟨(-15961747), (-15961743)⟩, ⟨237316, 237321⟩, ⟨18756, 18761⟩⟩
...
def j36 : Jet := ⟨⟨4143210922, 4143210924⟩, ⟨(-100086395), (-100086391)⟩, ⟨(-15961747), (-15961743)⟩, ⟨237316, 237321⟩, ⟨18756, 18761⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨648634381, 648634385⟩, ⟨206887987, 206887992⟩, ⟨(-4614006), (-4614002)⟩, ⟨(-486279), (-486274)⟩, ⟨6521, 6527⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4452282157, 4452282161⟩, ⟨107552538, 107552544⟩, ⟨19750558, 19750565⟩, ⟨636429, 636438⟩, ⟨65139, 65152⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨672392379, 672392385⟩, ⟨230708617, 230708625⟩, ⟨3380551, 3380560⟩, ⟨427862, 427874⟩, ⟨13856, 13871⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-632858063), (-632858062)⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3662109233, 3662109234⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨105265414, 105265417⟩, ⟨72236506, 72236510⟩, ⟨13451226, 13451232⟩, ⟨497144, 497154⟩, ⟨52964, 52973⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4400232710, 4400232713⟩, ⟨72236506, 72236510⟩, ⟨13451226, 13451232⟩, ⟨497144, 497154⟩, ⟨52964, 52973⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4347281401, 4347281404⟩, ⟨35683614, 35683617⟩, ⟨6498227, 6498232⟩, ⟨192241, 192248⟩, ⟨19727, 19734⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3706714920, 3706714924⟩, ⟨(-183096483), (-183096478)⟩, ⟨3788075, 3788081⟩, ⟨(-155255), (-155247)⟩, ⟨7377, 7385⟩⟩
...
def j47 : Jet := ⟨⟨3008835055, 3008835061⟩, ⟨1002945016, 1002945022⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2107836396, 2107836405⟩, ⟨1405224260, 1405224274⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2107836396, 2107836405⟩, ⟨1405224260, 1405224274⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2107836405), (-2107836396)⟩, ⟨(-1405224274), (-1405224260)⟩, ⟨(-234204046), (-234204042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1053918203), (-1053918198)⟩, ⟨(-702612137), (-702612130)⟩, ⟨(-117102023), (-117102021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3360398227, 3360398234⟩, ⟨(-549726325), (-549726317)⟩, ⟨(-46656291), (-46656287)⟩, ⟨12536330, 12536332⟩, ⟨123336, 123338⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2900147401, 2900147412⟩, ⟨(-617689424), (-617689410)⟩, ⟨(-13867204), (-13867191)⟩, ⟨12201971, 12201985⟩, ⟨(-443496), (-443481)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨421905374, 843810750⟩, ⟨210952687, 210952688⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1325454823, 2650909654⟩, ⟨662727411, 662727415⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨409043973, 1636175903⟩, ⟨409043972, 818087954⟩, ⟨102260993, 102260995⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨102, 410⟩, ⟨102, 205⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94585), (-94276)⟩, ⟨102, 205⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-36033), (-8978)⟩, ⟨(-18008), (-8899)⟩, ⟨(-2242), (-2194)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5077023, 5104079⟩, ⟨(-18008), (-8899)⟩, ⟨(-2242), (-2194)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨483525, 1944409⟩, ⟨476664, 971358⟩, ⟨116595, 120471⟩, ⟨(-857), (-415)⟩, ⟨(-54), (-49)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142682052), (-141221167)⟩, ⟨476664, 971358⟩, ⟨116595, 120471⟩, ⟨(-857), (-415)⟩, ⟨(-54), (-49)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-54354998), (-13449617)⟩, ⟨(-27132103), (-13079576)⟩, ⟨(-3340688), (-3131489)⟩, ⟨22126, 46036⟩, ⟨2591, 2826⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1377300767, 1418206149⟩, ⟨(-27132103), (-13079576)⟩, ⟨(-3340688), (-3131489)⟩, ⟨22126, 46036⟩, ⟨2591, 2826⟩⟩
...
def j70 : Jet := ⟨⟨(-42), (-10)⟩, ⟨(-21), (-10)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11793, 11826⟩, ⟨(-21), (-10)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1123, 4506⟩, ⟨1115, 2253⟩, ⟨274, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851054), (-847670)⟩, ⟨1115, 2253⟩, ⟨274, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-324211), (-80730)⟩, ⟨(-162000), (-79871)⟩, ⟨(-20132), (-19644)⟩, ⟨51, 108⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35467183, 35710665⟩, ⟨(-162000), (-79871)⟩, ⟨(-20132), (-19644)⟩, ⟨51, 108⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3377822, 13604046⟩, ⟨3316107, 6794417⟩, ⟨805927, 840777⟩, ⟨(-7689), (-3729)⟩, ⟨(-476), (-443)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712450061), (-702223836)⟩, ⟨3316107, 6794417⟩, ⟨805927, 840777⟩, ⟨(-7689), (-3729)⟩, ⟨(-476), (-443)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-271409197), (-66878373)⟩, ⟨(-135388780), (-64290027)⟩, ⟨(-16570502), (-15105124)⟩, ⟨152778, 321565⟩, ⟨17541, 19622⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4023558099, 4228088923⟩, ⟨(-135388780), (-64290027)⟩, ⟨(-16570502), (-15105124)⟩, ⟨152778, 321565⟩, ⟨17541, 19622⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨425043968, 875335274⟩, ⟨195775697, 214797377⟩, ⟨(-6248489), (-2984618)⟩, ⟨(-508652), (-454783)⟩, ⟨4213, 8849⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4362903526, 4584684407⟩, ⟨66339944, 154270131⟩, ⟨16595485, 24072468⟩, ⟨140658, 1279695⟩, ⟨28415, 120663⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨431767158, 934381034⟩, ⟨205437622, 260727544⟩, ⟨(-2003693), 9589528⟩, ⟨2981, 956632⟩, ⟨(-39791), 79482⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-843810750), (-421905374)⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3451156546, 3873061922⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨43404958, 203276965⟩, ⟨41304722, 113443878⟩, ⟨8954710, 20000014⟩, ⟨(-242672), 1580508⟩, ⟨(-21504), 172141⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4338372254, 4498244261⟩, ⟨41304722, 113443878⟩, ⟨8954710, 20000014⟩, ⟨(-242672), 1580508⟩, ⟨(-21504), 172141⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4316615218, 4395430809⟩, ⟨20180323, 56437478⟩, ⟨4012689, 9902686⟩, ⟨(-250201), 767532⟩, ⟨(-32093), 87046⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3468551409, 3963656653⟩, ⟨(-199671485), (-161122467)⟩, ⟨452338, 7938740⟩, ⟨(-712007), 495048⟩, ⟨(-66640), 90785⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2005890033, 4011780078⟩, ⟨1002945016, 1002945022⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨936816172, 3747264714⟩, ⟨936816172, 1873632362⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨936816172, 3747264714⟩, ⟨936816172, 1873632362⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3747264714), (-936816172)⟩, ⟨(-1873632362), (-936816172)⟩, ⟨(-234204046), (-234204042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1873632357), (-468408086)⟩, ⟨(-936816181), (-468408086)⟩, ⟨(-117102023), (-117102021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2776538233, 3851197677⟩, ⟨(-840021368), (-302808582)⟩, ⟨(-88490557), 15910382⟩, ⟨4347249, 21702594⟩, ⟨(-1400338), 1087818⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2242290787, 3554119099⟩, ⟨(-954263529), (-348703428)⟩, ⟨(-70012406), 60853844⟩, ⟨579983, 24554375⟩, ⟨(-2621406), 1090893⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨632858062, 632858063⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4347281401, 4347281404⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified676
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨421905374, 843810750⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4316615218, 4395430809⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified677
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (142228047 / 2147483648)

theorem envelope_integral : (∫ s in ((39293 / 400000) : ℝ)..(39293 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (39293 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (39293 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((39293 / 400000) : ℝ)..(39293 / 200000), prawitzNormalCorrection
