...
namespace FiniteNormalPanel30_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (18579 / 200000)
def radius : Rat := (18579 / 200000)

def j0 : Jet := ⟨⟨398980986, 398980987⟩, ⟨398980986, 398980987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1253435734, 1253435738⟩, ⟨1253435734, 1253435738⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨365800489, 365800492⟩, ⟨731600978, 731600984⟩, ⟨365800489, 365800492⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨91, 92⟩, ⟨183, 184⟩, ⟨91, 92⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94596), (-94594)⟩, ⟨183, 184⟩, ⟨91, 92⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8057), (-8056)⟩, ⟨(-16099), (-16097)⟩, ⟨(-8019), (-8016)⟩, ⟨30, 32⟩, ⟨7, 8⟩⟩
...
def j13 : Jet := ⟨⟨5104999, 5105001⟩, ⟨(-16099), (-16097)⟩, ⟨(-8019), (-8016)⟩, ⟨30, 32⟩, ⟨7, 8⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨434790, 434791⟩, ⟨868209, 868212⟩, ⟨431364, 431368⟩, ⟨(-2736), (-2732)⟩, ⟨(-678), (-675)⟩⟩
...
def j16 : Jet := ⟨⟨(-142730787), (-142730785)⟩, ⟨868209, 868212⟩, ⟨431364, 431368⟩, ⟨(-2736), (-2732)⟩, ⟨(-678), (-675)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12156319), (-12156318)⟩, ⟨(-24238694), (-24238691)⟩, ⟨(-11971691), (-11971687)⟩, ⟨147188, 147193⟩, ⟨36214, 36218⟩⟩
...
def j19 : Jet := ⟨⟨1419499446, 1419499448⟩, ⟨(-24238694), (-24238691)⟩, ⟨(-11971691), (-11971687)⟩, ⟨147188, 147193⟩, ⟨36214, 36218⟩⟩
...
def j22 : Jet := ⟨⟨(-10), (-9)⟩, ⟨(-19), (-18)⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11825, 11827⟩, ⟨(-19), (-18)⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1007, 1008⟩, ⟨2012, 2014⟩, ⟨1002, 1005⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851170), (-851168)⟩, ⟨2012, 2014⟩, ⟨1002, 1005⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-72494), (-72493)⟩, ⟨(-144817), (-144815)⟩, ⟨(-72067), (-72063)⟩, ⟨340, 344⟩, ⟨83, 86⟩⟩
...
def j30 : Jet := ⟨⟨35718900, 35718902⟩, ⟨(-144817), (-144815)⟩, ⟨(-72067), (-72063)⟩, ⟨340, 344⟩, ⟨83, 86⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3042163, 3042164⟩, ⟨6071991, 6071994⟩, ⟨3011356, 3011360⟩, ⟨(-24583), (-24578)⟩, ⟨(-6074), (-6070)⟩⟩
...
def j33 : Jet := ⟨⟨(-712785720), (-712785718)⟩, ⟨6071991, 6071994⟩, ⟨3011356, 3011360⟩, ⟨(-24583), (-24578)⟩, ⟨(-6074), (-6070)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-60707649), (-60707648)⟩, ⟨(-120898150), (-120898146)⟩, ⟨(-59416877), (-59416872)⟩, ⟨1028005, 1028010⟩, ⟨251769, 251775⟩⟩
...
def j36 : Jet := ⟨⟨4234259647, 4234259648⟩, ⟨(-120898150), (-120898146)⟩, ⟨(-59416877), (-59416872)⟩, ⟨1028005, 1028010⟩, ⟨251769, 251775⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨414264232, 414264235⟩, ⟨407190453, 407190458⟩, ⟨(-10567577), (-10567573)⟩, ⟨(-3450843), (-3450839)⟩, ⟨53523, 53527⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4356545324, 4356545326⟩, ⟨124389691, 124389697⟩, ⟨64684453, 64684462⟩, ⟨2534681, 2534690⟩, ⟨690803, 690814⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨420203642, 420203646⟩, ⟨425026254, 425026262⟩, ⟨7312887, 7312897⟩, ⟨2570604, 2570614⟩, ⟨102127, 102137⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-398980987), (-398980986)⟩, ⟨(-398980987), (-398980986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3895986309, 3895986310⟩, ⟨(-398980987), (-398980986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨41111163, 41111164⟩, ⟨83165978, 83165982⟩, ⟨43491160, 43491167⟩, ⟨1950348, 1950356⟩, ⟨541201, 541210⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4336078459, 4336078460⟩, ⟨83165978, 83165982⟩, ⟨43491160, 43491167⟩, ⟨1950348, 1950356⟩, ⟨541201, 541210⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4315473922, 4315473923⟩, ⟨41385391, 41385394⟩, ⟨21443804, 21443809⟩, ⟨764893, 764899⟩, ⟨208700, 208707⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3914587971, 3914587974⟩, ⟨(-363345056), (-363345051)⟩, ⟨15607284, 15607292⟩, ⟨(-1298185), (-1298178)⟩, ⟨118256, 118266⟩⟩
...
def j47 : Jet := ⟨⟨2100634891, 2100634897⟩, ⟨2100634891, 2100634897⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1027404085, 1027404091⟩, ⟨2054808170, 2054808182⟩, ⟨1027404085, 1027404091⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1027404085, 1027404091⟩, ⟨2054808170, 2054808182⟩, ⟨1027404085, 1027404091⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1027404091), (-1027404085)⟩, ⟨(-2054808182), (-2054808170)⟩, ⟨(-1027404091), (-1027404085)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-513702046), (-513702042)⟩, ⟨(-1027404091), (-1027404085)⟩, ⟨(-513702046), (-513702042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3810797035, 3810797040⟩, ⟨(-911585165), (-911585157)⟩, ⟨(-346761915), (-346761908)⟩, ⟨100336884, 100336887⟩, ⟨14736903, 14736905⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3473297747, 3473297755⟩, ⟨(-1153236858), (-1153236844)⟩, ⟨(-225085272), (-225085253)⟩, ⟨116321555, 116321572⟩, ⟨4063830, 4063848⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 797961974⟩, ⟨398980986, 398980987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2506871476⟩, ⟨1253435734, 1253435738⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1463201968⟩, ⟨0, 1463201968⟩, ⟨365800489, 365800492⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 367⟩, ⟨0, 367⟩, ⟨91, 92⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94319)⟩, ⟨0, 367⟩, ⟨91, 92⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-32258), 0⟩, ⟨(-32258), 126⟩, ⟨(-8065), (-7875)⟩, ⟨0, 64⟩, ⟨7, 8⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5080798, 5113057⟩, ⟨(-32258), 126⟩, ⟨(-8065), (-7875)⟩, ⟨0, 64⟩, ⟨7, 8⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1741908⟩, ⟨(-10990), 1741951⟩, ⟨418991, 435520⟩, ⟨(-5496), 33⟩, ⟨(-687), (-645)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141423668)⟩, ⟨(-10990), 1741951⟩, ⟨418991, 435520⟩, ⟨(-5496), 33⟩, ⟨(-687), (-645)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-48773400), 0⟩, ⟨(-48777145), 593445⟩, ⟨(-12197095), (-11303174)⟩, ⟨(-2810), 296747⟩, ⟨33577, 37106⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1382882365, 1431655766⟩, ⟨(-48777145), 593445⟩, ⟨(-12197095), (-11303174)⟩, ⟨(-2810), 296747⟩, ⟨33577, 37106⟩⟩
...
def j70 : Jet := ⟨⟨(-37), 0⟩, ⟨(-37), 0⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11798, 11836⟩, ⟨(-37), 0⟩, ⟨(-10), (-9)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 4033⟩, ⟨(-13), 4033⟩, ⟨987, 1009⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848143)⟩, ⟨(-13), 4033⟩, ⟨987, 1009⟩, ⟨(-8), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-290319), 0⟩, ⟨(-290324), 1374⟩, ⟨(-72585), (-70517)⟩, ⟨(-5), 688⟩, ⟨80, 86⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35501075, 35791395⟩, ⟨(-290324), 1374⟩, ⟨(-72585), (-70517)⟩, ⟨(-5), 688⟩, ⟨80, 86⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 12193351⟩, ⟨(-98908), 12193820⟩, ⟨2899974, 3048807⟩, ⟨(-49458), 353⟩, ⟨(-6185), (-5740)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-703634531)⟩, ⟨(-98908), 12193820⟩, ⟨2899974, 3048807⟩, ⟨(-49458), 353⟩, ⟨(-6185), (-5740)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-243866995), 0⟩, ⟨(-243900691), 4154170⟩, ⟨(-61000445), (-54735412)⟩, ⟨(-25274), 2077327⟩, ⟨228031, 259787⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4051100301, 4294967296⟩, ⟨(-243900691), 4154170⟩, ⟨(-61000445), (-54735412)⟩, ⟨(-25274), 2077327⟩, ⟨228031, 259787⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 835623826⟩, ⟨375107893, 418158293⟩, ⟨(-21354195), 173190⟩, ⟨(-3561220), (-3125493)⟩, ⟨(-821), 108261⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4553514528⟩, ⟨(-4669368), 274149062⟩, ⟨54470250, 85071101⟩, ⟨(-2492503), 9278271⟩, ⟨144606, 1600226⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 885926474⟩, ⟨374199426, 496668591⟩, ⟨(-23094279), 43426122⟩, ⟨(-866335), 6985421⟩, ⟨(-893822), 1336755⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-797961974), 0⟩, ⟨(-398980987), (-398980986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3497005322, 4294967296⟩, ⟨(-398980987), (-398980986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 182740791⟩, ⟨0, 204896488⟩, ⟨23074805, 75349677⟩, ⟨(-5698630), 12925344⟩, ⟨(-802611), 2606131⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4477708087⟩, ⟨0, 204896488⟩, ⟨23074805, 75349677⟩, ⟨(-5698630), 12925344⟩, ⟨(-802611), 2606131⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4385385935⟩, ⟨0, 102448244⟩, ⟨10102860, 37674839⟩, ⟨(-3747977), 6462672⟩, ⟨(-720700), 1380585⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3497005322, 4385385935⟩, ⟨(-407380427), (-296532742)⟩, ⟨(-1291081), 37674839⟩, ⟨(-7247782), 5524167⟩, ⟨(-1321050), 1728754⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4201269794⟩, ⟨2100634891, 2100634897⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4109616364⟩, ⟨0, 4109616364⟩, ⟨1027404085, 1027404091⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4109616364⟩, ⟨0, 4109616364⟩, ⟨1027404085, 1027404091⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4109616364), 0⟩, ⟨(-4109616364), 0⟩, ⟨(-1027404091), (-1027404085)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2054808182), 0⟩, ⟨(-2054808182), 0⟩, ⟨(-513702046), (-513702042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2661850690, 4294967296⟩, ⟨(-2054808182), 0⟩, ⟨(-513702046), 173160853⟩, ⟨(-27614672), 245766521⟩, ⟨(-39750549), 34023685⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2167305450, 4385385935⟩, ⟨(-2505446904), (-183779253)⟩, ⟨(-525807701), 409381001⟩, ⟨(-69892708), 305807276⟩, ⟨(-72368557), 44074428⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨398980986, 398980987⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨398980986, 398980987⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4315473922, 4315473923⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified586
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 797961974⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4385385935⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified587
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (316501089 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(18579 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(18579 / 100000), prawitzNormalCorrection
