...
namespace FiniteNormalPanel72_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (29673 / 100000)
def radius : Rat := (4239 / 100000)

def j0 : Jet := ⟨⟨1274445645, 1274445646⟩, ⟨182063663, 182063664⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4003789075, 4003789080⟩, ⟨571969866, 571969870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3732351343, 3732351353⟩, ⟨1066386094, 1066386104⟩, ⟨76170435, 76170437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨934, 936⟩, ⟨266, 268⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93753), (-93750)⟩, ⟨266, 268⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-81472), (-81469)⟩, ⟨(-23047), (-23043)⟩, ⟨(-1581), (-1577)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5031584, 5031588⟩, ⟨(-23047), (-23043)⟩, ⟨(-1581), (-1577)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4372475, 4372479⟩, ⟨1229250, 1229256⟩, ⟨82137, 82144⟩, ⟨(-796), (-790)⟩, ⟨(-28), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-138793102), (-138793097)⟩, ⟨1229250, 1229256⟩, ⟨82137, 82144⟩, ⟨(-796), (-790)⟩, ⟨(-28), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-120612007), (-120612001)⟩, ⟨(-33392349), (-33392340)⟩, ⟨(-2084886), (-2084876)⟩, ⟨41501, 41511⟩, ⟨1233, 1242⟩⟩
...
def j19 : Jet := ⟨⟨1311043758, 1311043765⟩, ⟨(-33392349), (-33392340)⟩, ⟨(-2084886), (-2084876)⟩, ⟨41501, 41511⟩, ⟨1233, 1242⟩⟩
...
def j25 : Jet := ⟨⟨10202, 10206⟩, ⟨2891, 2894⟩, ⟨199, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841975), (-841970)⟩, ⟨2891, 2894⟩, ⟨199, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-731682), (-731676)⟩, ⟨(-206540), (-206535)⟩, ⟨(-14044), (-14036)⟩, ⟨98, 103⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35059712, 35059719⟩, ⟨(-206540), (-206535)⟩, ⟨(-14044), (-14036)⟩, ⟨98, 103⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨30467091, 30467099⟩, ⟨8525398, 8525406⟩, ⟨558290, 558301⟩, ⟨(-7065), (-7056)⟩, ⟨(-226), (-218)⟩⟩
...
def j33 : Jet := ⟨⟨(-685360792), (-685360783)⟩, ⟨8525398, 8525406⟩, ⟨558290, 558301⟩, ⟨(-7065), (-7056)⟩, ⟨(-226), (-218)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-595582482), (-595582471)⟩, ⟨(-162757804), (-162757792)⟩, ⟨(-9552840), (-9552826)⟩, ⟨283672, 283686⟩, ⟨7949, 7962⟩⟩
...
def j36 : Jet := ⟨⟨3699384814, 3699384825⟩, ⟨(-162757804), (-162757792)⟩, ⟨(-9552840), (-9552826)⟩, ⟨283672, 283686⟩, ⟨7949, 7962⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1222161267, 1222161276⟩, ⟨143465958, 143465970⟩, ⟨(-6390471), (-6390459)⟩, ⟨(-238962), (-238950)⟩, ⟨6675, 6687⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4986435568, 4986435584⟩, ⟨219382756, 219382776⟩, ⟨22528286, 22528310⟩, ⟨1175274, 1175299⟩, ⟨82324, 82349⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1418923123, 1418923139⟩, ⟨228990069, 228990092⟩, ⟨6319368, 6319394⟩, ⟨483095, 483123⟩, ⟨24705, 24732⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1274445646), (-1274445645)⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3020521650, 3020521651⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨468767906, 468767918⟩, ⟨151302340, 151302360⟩, ⟨16384254, 16384278⟩, ⟨993042, 993068⟩, ⟨77131, 77159⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4763735202, 4763735214⟩, ⟨151302340, 151302360⟩, ⟨16384254, 16384278⟩, ⟨993042, 993068⟩, ⟨77131, 77159⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4523282756, 4523282763⟩, ⟨71832630, 71832641⟩, ⟨7208249, 7208262⟩, ⟨356986, 357001⟩, ⟨25205, 25221⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3181089063, 3181089070⟩, ⟨(-141224224), (-141224213)⟩, ⟨2024359, 2024370⟩, ⟨(-54502), (-54488)⟩, ⟨2591, 2606⟩⟩
...
def j47 : Jet := ⟨⟨7971563842, 7971563851⟩, ⟨1138794831, 1138794838⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14795416520, 14795416555⟩, ⟨4227261848, 4227261882⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14795416520, 14795416555⟩, ⟨4227261848, 4227261882⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14795416555), (-14795416520)⟩, ⟨(-4227261882), (-4227261848)⟩, ⟨(-301947278), (-301947274)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7397708278), (-7397708260)⟩, ⟨(-2113630941), (-2113630924)⟩, ⟨(-150973639), (-150973637)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨767229546, 767229558⟩, ⟨(-377567516), (-377567506)⟩, ⟨65934783, 65934788⟩, ⟨(-1967911), (-1967908)⟩, ⟨(-916736), (-916735)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨568252410, 568252421⟩, ⟨(-304874801), (-304874789)⟩, ⟨61611466, 61611476⟩, ⟨(-3813265), (-3813254)⟩, ⟨(-577950), (-577940)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1092381982, 1456509310⟩, ⟨182063663, 182063664⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3431819209, 4575758949⟩, ⟨571969866, 571969870⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2742135683, 4874907891⟩, ⟨914045224, 1218726976⟩, ⟨76170435, 76170437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨686, 1222⟩, ⟨228, 306⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94001), (-93464)⟩, ⟨228, 306⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-106694), (-59672)⟩, ⟨(-26529), (-19542)⟩, ⟨(-1608), (-1547)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5006362, 5053385⟩, ⟨(-26529), (-19542)⟩, ⟨(-1608), (-1547)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3196327, 5735734⟩, ⟨1035330, 1421458⟩, ⟨79432, 84476⟩, ⟨(-923), (-661)⟩, ⟨(-28), (-21)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139969250), (-137429842)⟩, ⟨1035330, 1421458⟩, ⟨79432, 84476⟩, ⟨(-923), (-661)⟩, ⟨(-28), (-21)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-158869010), (-87742524)⟩, ⟨(-39056244), (-27634113)⟩, ⟨(-2211280), (-1938060)⟩, ⟨34217, 48759⟩, ⟨1114, 1346⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1272786755, 1343913242⟩, ⟨(-39056244), (-27634113)⟩, ⟨(-2211280), (-1938060)⟩, ⟨34217, 48759⟩, ⟨1114, 1346⟩⟩
...
def j70 : Jet := ⟨⟨(-123), (-68)⟩, ⟨(-31), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11712, 11768⟩, ⟨(-31), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7477, 13358⟩, ⟨2456, 3326⟩, ⟨195, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844700), (-838818)⟩, ⟨2456, 3326⟩, ⟨195, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-958759), (-535546)⟩, ⟨(-238122), (-174739)⟩, ⟨(-14335), (-13699)⟩, ⟨81, 118⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34832635, 35255849⟩, ⟨(-238122), (-174739)⟩, ⟨(-14335), (-13699)⟩, ⟨81, 118⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨22239007, 40016374⟩, ⟨7142726, 9892532⟩, ⟨533910, 579323⟩, ⟨(-8241), (-5879)⟩, ⟨(-238), (-203)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-693588876), (-675811508)⟩, ⟨7142726, 9892532⟩, ⟨533910, 579323⟩, ⟨(-8241), (-5879)⟩, ⟨(-238), (-203)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-787242755), (-431474030)⟩, ⟨(-192250394), (-132596375)⟩, ⟨(-10439695), (-8520765)⟩, ⟨230945, 336077⟩, ⟨6858, 8895⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3507724541, 3863493266⟩, ⟨(-192250394), (-132596375)⟩, ⟨(-10439695), (-8520765)⟩, ⟨230945, 336077⟩, ⟨6858, 8895⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1016998205, 1431774126⟩, ⟨127890079, 156891208⟩, ⟨(-7557050), (-5228666)⟩, ⟨(-267141), (-206148)⟩, ⟨5446, 7928⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4774628245, 5258891871⟩, ⟨163866830, 288227888⟩, ⟨16154196, 31448639⟩, ⟨458356, 2267100⟩, ⟨14176, 197731⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1130576328, 1753108882⟩, ⟨180974568, 288186393⟩, ⟨(-548545), 15199845⟩, ⟨(-244685), 1475893⟩, ⟨(-50205), 130909⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1456509310), (-1092381982)⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2838457986, 3202585314⟩, ⟨(-182063664), (-182063663)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨297604788, 715579548⟩, ⟨95276888, 235262386⟩, ⟨7177813, 31745381⟩, ⟨(-273364), 3244632⟩, ⟨(-75766), 358725⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4592572084, 5010546844⟩, ⟨95276888, 235262386⟩, ⟨7177813, 31745381⟩, ⟨(-273364), 3244632⟩, ⟨(-75766), 358725⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4441277620, 4638979935⟩, ⟨44105721, 113756034⟩, ⟨1928013, 15130789⟩, ⟨(-519731), 1549725⟩, ⟨(-102104), 186348⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2935151552, 3459101779⟩, ⟨(-167497772), (-103442432)⟩, ⟨(-3547934), 9412784⟩, ⟨(-1028938), 1073840⟩, ⟨(-141828), 160985⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6832769011, 9110358689⟩, ⟨1138794831, 1138794838⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10870101944, 19324625713⟩, ⟨3623367300, 4831156438⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10870101944, 19324625713⟩, ⟨3623367300, 4831156438⟩, ⟨301947274, 301947278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19324625713), (-10870101944)⟩, ⟨(-4831156438), (-3623367300)⟩, ⟨(-301947278), (-301947274)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9662312857), (-5435050972)⟩, ⟨(-2415578219), (-1811683650)⟩, ⟨(-150973639), (-150973637)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨452829960, 1211667524⟩, ⟨(-681466815), (-191010682)⟩, ⟨(-2306046), 175717942⟩, ⟨(-28466285), 16401948⟩, ⟨(-5394555), 4043037⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨309460926, 975858720⟩, ⟨(-596096434), (-141441618)⟩, ⟨1742234, 170752311⟩, ⟨(-31562844), 14165698⟩, ⟨(-5339898), 4960123⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1274445645, 1274445646⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4523282756, 4523282763⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1442
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1092381982, 1456509310⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4441277620, 4638979935⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1443
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (50001685 / 4294967296)

theorem envelope_integral : (∫ s in ((12717 / 50000) : ℝ)..(4239 / 12500),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((12717 / 50000) : ℝ)..(4239 / 12500), prawitzNormalCorrection
