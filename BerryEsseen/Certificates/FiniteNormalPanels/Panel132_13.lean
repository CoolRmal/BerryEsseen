...
namespace FiniteNormalPanel132_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (81003 / 800000)
def radius : Rat := (27001 / 800000)

def j0 : Jet := ⟨⟨434881544, 434881545⟩, ⟨144960514, 144960515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1366220663, 1366220668⟩, ⟨455406885, 455406890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨434592110, 434592114⟩, ⟨289728070, 289728076⟩, ⟨48288011, 48288013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨108, 109⟩, ⟨72, 73⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94579), (-94577)⟩, ⟨72, 73⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9571), (-9569)⟩, ⟨(-6374), (-6371)⟩, ⟨(-1059), (-1056)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103485, 5103488⟩, ⟨(-6374), (-6371)⟩, ⟨(-1059), (-1056)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨516403, 516404⟩, ⟨343623, 343625⟩, ⟨56840, 56844⟩, ⟨(-144), (-141)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-142649174), (-142649172)⟩, ⟨343623, 343625⟩, ⟨56840, 56844⟩, ⟨(-144), (-141)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14434151), (-14434150)⟩, ⟨(-9587999), (-9587995)⟩, ⟨(-1574865), (-1574861)⟩, ⟨7682, 7685⟩, ⟨627, 631⟩⟩
...
def j19 : Jet := ⟨⟨1417221614, 1417221616⟩, ⟨(-9587999), (-9587995)⟩, ⟨(-1574865), (-1574861)⟩, ⟨7682, 7685⟩, ⟨627, 631⟩⟩
...
def j22 : Jet := ⟨⟨(-11), (-10)⟩, ⟨(-8), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11824, 11826⟩, ⟨(-8), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1196, 1197⟩, ⟨796, 798⟩, ⟨130, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850981), (-850979)⟩, ⟨796, 798⟩, ⟨130, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-86108), (-86107)⟩, ⟨(-57326), (-57323)⟩, ⟨(-9502), (-9499)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35705286, 35705288⟩, ⟨(-57326), (-57323)⟩, ⟨(-9502), (-9499)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3612887, 3612889⟩, ⟨2402790, 2402793⟩, ⟨396601, 396606⟩, ⟨(-1285), (-1282)⟩, ⟨(-107), (-103)⟩⟩
...
def j33 : Jet := ⟨⟨(-712214996), (-712214993)⟩, ⟨2402790, 2402793⟩, ⟨396601, 396606⟩, ⟨(-1285), (-1282)⟩, ⟨(-107), (-103)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-72066445), (-72066443)⟩, ⟨(-47801168), (-47801164)⟩, ⟨(-7805167), (-7805163)⟩, ⟨53636, 53641⟩, ⟨4360, 4364⟩⟩
...
def j36 : Jet := ⟨⟨4222900851, 4222900853⟩, ⟨(-47801168), (-47801164)⟩, ⟨(-7805167), (-7805163)⟩, ⟨53636, 53641⟩, ⟨4360, 4364⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨450815412, 450815415⟩, ⟨147221879, 147221884⟩, ⟨(-1517604), (-1517600)⟩, ⟨(-164545), (-164541)⟩, ⟨1013, 1016⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4368263597, 4368263600⟩, ⟨49446598, 49446604⟩, ⟨8633545, 8633553⟩, ⟨133630, 133639⟩, ⟨12325, 12334⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨458508858, 458508863⟩, ⟨154924407, 154924414⟩, ⟨1057623, 1057632⟩, ⟨125138, 125148⟩, ⟨1957, 1966⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-434881545), (-434881544)⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3860085751, 3860085752⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨48948073, 48948075⟩, ⟨33077882, 33077886⟩, ⟨5814113, 5814118⟩, ⟨103016, 103024⟩, ⟨9702, 9711⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4343915369, 4343915371⟩, ⟨33077882, 33077886⟩, ⟨5814113, 5814118⟩, ⟨103016, 103024⟩, ⟨9702, 9711⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4319371996, 4319371998⟩, ⟨16445495, 16445498⟩, ⟨2859323, 2859327⟩, ⟨40329, 40335⟩, ⟨3722, 3729⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3882019383, 3882019387⟩, ⟨(-131003879), (-131003873)⟩, ⟨2014748, 2014754⟩, ⟨(-60261), (-60254)⟩, ⟨1983, 1991⟩⟩
...
def j47 : Jet := ⟨⟨4473713666, 4473713678⟩, ⟨1491237882, 1491237893⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4659899036, 4659899062⟩, ⟨3106599342, 3106599376⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4659899036, 4659899062⟩, ⟨3106599342, 3106599376⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4659899062), (-4659899036)⟩, ⟨(-3106599376), (-3106599342)⟩, ⟨(-517766563), (-517766555)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2329949531), (-2329949518)⟩, ⟨(-1553299688), (-1553299671)⟩, ⟨(-258883282), (-258883277)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2496676107, 2496676123⟩, ⟨(-902937317), (-902937300)⟩, ⟨12786685, 12786695⟩, ⟨34742147, 34742151⟩, ⟨(-3526541), (-3526539)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2256628368, 2256628385⟩, ⟨(-892275579), (-892275557)⟩, ⟨40269599, 40269615⟩, ⟨30553184, 30553197⟩, ⟨(-4227354), (-4227342)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨289921029, 579842060⟩, ⟨144960514, 144960515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨910813774, 1821627557⟩, ⟨455406885, 455406890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨193152048, 772608202⟩, ⟨193152046, 386304102⟩, ⟨48288011, 48288013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨48, 194⟩, ⟨48, 97⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94639), (-94492)⟩, ⟨48, 97⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-17025), (-4249)⟩, ⟨(-8511), (-4231)⟩, ⟨(-1063), (-1050)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096031, 5108808⟩, ⟨(-8511), (-4231)⟩, ⟨(-1063), (-1050)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨229177, 919008⟩, ⟨227645, 459314⟩, ⟨56336, 57201⟩, ⟨(-192), (-93)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142936400), (-142246568)⟩, ⟨227645, 459314⟩, ⟨56336, 57201⟩, ⟨(-192), (-93)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-25712381), (-6397072)⟩, ⟨(-12845954), (-6314447)⟩, ⟨(-1594254), (-1547665)⟩, ⟨5057, 10306⟩, ⟨612, 640⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1405943384, 1425258694⟩, ⟨(-12845954), (-6314447)⟩, ⟨(-1594254), (-1547665)⟩, ⟨5057, 10306⟩, ⟨612, 640⟩⟩
...
def j72 : Jet := ⟨⟨531, 2129⟩, ⟨529, 1065⟩, ⟨130, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851646), (-850047)⟩, ⟨529, 1065⟩, ⟨130, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-153200), (-38228)⟩, ⟨(-76577), (-38036)⟩, ⟨(-9547), (-9436)⟩, ⟨9, 25⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35638194, 35753167⟩, ⟨(-76577), (-38036)⟩, ⟨(-9547), (-9436)⟩, ⟨9, 25⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1602710, 6431526⟩, ⟨1588934, 3214053⟩, ⟨392071, 399837⟩, ⟨(-1720), (-846)⟩, ⟨(-109), (-102)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714225173), (-709396356)⟩, ⟨1588934, 3214053⟩, ⟨392071, 399837⟩, ⟨(-1720), (-846)⟩, ⟨(-109), (-102)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-128479728), (-31902771)⟩, ⟨(-64168407), (-31324604)⟩, ⟨(-7940895), (-7614683)⟩, ⟨35186, 72061⟩, ⟨4233, 4454⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4166487568, 4263064525⟩, ⟨(-64168407), (-31324604)⟩, ⟨(-7940895), (-7614683)⟩, ⟨35186, 72061⟩, ⟨4233, 4454⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨298151886, 604495992⟩, ⟨143627578, 149784924⟩, ⟨(-2038264), (-997743)⟩, ⟨(-167972), (-159731)⟩, ⟨665, 1365⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4327108812, 4427408885⟩, ⟨31795194, 68186878⟩, ⟨7962705, 9488338⟩, ⟨40460, 239547⟩, ⟨8739, 17110⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨300383114, 623136509⟩, ⟨146909606, 164000737⟩, ⟨(-485096), 2708214⟩, ⟨63576, 196306⟩, ⟨(-4542), 9141⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-579842060), (-289921029)⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3715125236, 4005046267⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21008312, 90407932⟩, ⟨20549242, 47588184⟩, ⟨4884289, 7048114⟩, ⟨(-28156), 263788⟩, ⟨2724, 19354⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4315975608, 4385375228⟩, ⟨20549242, 47588184⟩, ⟨4884289, 7048114⟩, ⟨(-28156), 263788⟩, ⟨2724, 19354⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305458638, 4339935851⟩, ⟨10168159, 23736112⟩, ⟨2351930, 3503464⟩, ⟨(-33359), 126019⟩, ⟨(-763), 9197⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3724200194, 4046979333⟩, ⟨(-137682854), (-123180743)⟩, ⟨1233283, 2923784⟩, ⟨(-149355), 38133⟩, ⟨(-4966), 9703⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2982475774, 5964951571⟩, ⟨1491237882, 1491237893⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2071066233, 8284265000⟩, ⟨2071066226, 4142132502⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2071066233, 8284265000⟩, ⟨2071066226, 4142132502⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8284265000), (-2071066233)⟩, ⟨(-4142132502), (-2071066226)⟩, ⟨(-517766563), (-517766555)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4142132500), (-1035533116)⟩, ⟨(-2071066251), (-1035533113)⟩, ⟨(-258883282), (-258883277)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1637267285, 3374813621⟩, ⟨(-1627361075), (-394751431)⟩, ⟨(-155832092), 293675154⟩, ⟨(-31341459), 90441647⟩, ⟨(-19753691), 8474738⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1419687443, 3179954593⟩, ⟨(-1641584238), (-389249332)⟩, ⟨(-135042769), 331183949⟩, ⟨(-40171291), 90131709⟩, ⟨(-21636833), 9254256⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨434881544, 434881545⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4319371996, 4319371998⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2660
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨289921029, 579842060⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305458638, 4339935851⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2661
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (153359095 / 4294967296)

theorem envelope_integral : (∫ s in ((27001 / 400000) : ℝ)..(27001 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((27001 / 400000) : ℝ)..(27001 / 200000), prawitzNormalCorrection
