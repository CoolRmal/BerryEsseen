...
namespace FiniteNormalPanel93_13
...
def j2 : Jet := ⟨⟨2904376364, 2904376368⟩, ⟨580875272, 580875277⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1964020091, 1964020098⟩, ⟨785608034, 785608044⟩, ⟨78560803, 78560805⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨491, 493⟩, ⟨196, 197⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94196), (-94193)⟩, ⟨196, 197⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-43075), (-43072)⟩, ⟨(-17141), (-17138)⟩, ⟨(-1680), (-1675)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5069981, 5069985⟩, ⟨(-17141), (-17138)⟩, ⟨(-1680), (-1675)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2318421, 2318424⟩, ⟨919529, 919534⟩, ⟨88831, 88838⟩, ⟨(-620), (-615)⟩, ⟨(-30), (-27)⟩⟩
...
def j16 : Jet := ⟨⟨(-140847156), (-140847152)⟩, ⟨919529, 919534⟩, ⟨88831, 88838⟩, ⟨(-620), (-615)⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-64407160), (-64407157)⟩, ⟨(-25342380), (-25342374)⟩, ⟨(-2367472), (-2367465)⟩, ⟨32783, 32789⟩, ⟨1496, 1501⟩⟩
...
def j19 : Jet := ⟨⟨1367248605, 1367248609⟩, ⟨(-25342380), (-25342374)⟩, ⟨(-2367472), (-2367465)⟩, ⟨32783, 32789⟩, ⟨1496, 1501⟩⟩
...
def j25 : Jet := ⟨⟨5389, 5391⟩, ⟨2145, 2149⟩, ⟨210, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846788), (-846785)⟩, ⟨2145, 2149⟩, ⟨210, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-387223), (-387221)⟩, ⟨(-153910), (-153905)⟩, ⟨(-15001), (-14996)⟩, ⟨76, 79⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35404171, 35404174⟩, ⟨(-153910), (-153905)⟩, ⟨(-15001), (-14996)⟩, ⟨76, 79⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16189763, 16189765⟩, ⟨6405524, 6405528⟩, ⟨612577, 612583⟩, ⟨(-5526), (-5520)⟩, ⟨(-262), (-257)⟩⟩
...
def j33 : Jet := ⟨⟨(-699638120), (-699638117)⟩, ⟨6405524, 6405528⟩, ⟨612577, 612583⟩, ⟨(-5526), (-5520)⟩, ⟨(-262), (-257)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-319933363), (-319933360)⟩, ⟨(-125044202), (-125044197)⟩, ⟨(-11345557), (-11345550)⟩, ⟨226686, 226692⟩, ⟨10073, 10079⟩⟩
...
def j36 : Jet := ⟨⟨3975033933, 3975033936⟩, ⟨(-125044202), (-125044197)⟩, ⟨(-11345557), (-11345550)⟩, ⟨226686, 226692⟩, ⟨10073, 10079⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨924571541, 924571546⟩, ⟨167777084, 167777093⟩, ⟨(-5028396), (-5028388)⟩, ⟨(-298023), (-298016)⟩, ⟨5444, 5451⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4640650714, 4640650718⟩, ⟨145982763, 145982772⟩, ⟨17837590, 17837603⟩, ⟨713134, 713148⟩, ⟨53250, 53264⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨998986321, 998986329⟩, ⟨212706241, 212706255⟩, ⟨4109381, 4109395⟩, ⟨357394, 357408⟩, ⟨14188, 14204⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-924491711), (-924491710)⟩, ⟨(-184898343), (-184898342)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3370475585, 3370475586⟩, ⟨(-184898343), (-184898342)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨232358851, 232358856⟩, ⟨98948658, 98948666⟩, ⟨12445814, 12445827⟩, ⟨573284, 573296⟩, ⟨45929, 45942⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4527326147, 4527326152⟩, ⟨98948658, 98948666⟩, ⟨12445814, 12445827⟩, ⟨573284, 573296⟩, ⟨45929, 45942⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4409616507, 4409616510⟩, ⟨48188005, 48188010⟩, ⟨5797814, 5797822⟩, ⟨215830, 215838⟩, ⟨16196, 16205⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3460446553, 3460446557⟩, ⟨(-152018456), (-152018449)⟩, ⟨2475340, 2475348⟩, ⟨(-80225), (-80216)⟩, ⟨3417, 3426⟩⟩
...
def j47 : Jet := ⟨⟨5618921939, 5618921947⟩, ⟨1123784387, 1123784395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7350995148, 7350995170⟩, ⟨2940398056, 2940398084⟩, ⟨294039805, 294039810⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7350995148, 7350995170⟩, ⟨2940398056, 2940398084⟩, ⟨294039805, 294039810⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7350995170), (-7350995148)⟩, ⟨(-2940398084), (-2940398056)⟩, ⟨(-294039810), (-294039805)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3675497585), (-3675497574)⟩, ⟨(-1470199042), (-1470199028)⟩, ⟨(-147019905), (-147019902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1825174264, 1825174277⟩, ⟨(-624770642), (-624770631)⟩, ⟨44454735, 44454742⟩, ⟨9185177, 9185180⟩, ⟨(-1546899), (-1546897)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1470539250, 1470539264⟩, ⟨(-567977689), (-567977673)⟩, ⟨58982479, 58982492⟩, ⟨5432850, 5432862⟩, ⟨(-1532700), (-1532689)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨739593368, 1109390053⟩, ⟨184898342, 184898343⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2323501091, 3485251641⟩, ⟨580875272, 580875277⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1256972858, 2828188940⟩, ⟨628486428, 942729654⟩, ⟨78560803, 78560805⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨314, 709⟩, ⟨157, 237⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94373), (-93977)⟩, ⟨157, 237⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-62144), (-27503)⟩, ⟨(-20670), (-13594)⟩, ⟨(-1700), (-1651)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5050912, 5085554⟩, ⟨(-20670), (-13594)⟩, ⟨(-1700), (-1651)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1478208, 3348782⟩, ⟨725493, 1112283⟩, ⟨86731, 90550⟩, ⟨(-752), (-482)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141687369), (-139816794)⟩, ⟨725493, 1112283⟩, ⟨86731, 90550⟩, ⟨(-752), (-482)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-93299582), (-40919034)⟩, ⟨(-30887537), (-19727090)⟩, ⟨(-2460112), (-2253669)⟩, ⟨25465, 40081⟩, ⟨1398, 1580⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1338356183, 1390736732⟩, ⟨(-30887537), (-19727090)⟩, ⟨(-2460112), (-2253669)⟩, ⟨25465, 40081⟩, ⟨1398, 1580⟩⟩
...
def j72 : Jet := ⟨⟨3442, 7774⟩, ⟨1705, 2588⟩, ⟨207, 214⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848735), (-844402)⟩, ⟨1705, 2588⟩, ⟨207, 214⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-558883), (-247124)⟩, ⟨(-185797), (-121857)⟩, ⟨(-15216), (-14735)⟩, ⟨59, 95⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35232511, 35544271⟩, ⟨(-185797), (-121857)⟩, ⟨(-15216), (-14735)⟩, ⟨59, 95⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10311210, 23405514⟩, ⟨5033259, 7766176⟩, ⟨593648, 628011⟩, ⟨(-6722), (-4321)⟩, ⟨(-271), (-245)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705516673), (-692422368)⟩, ⟨5033259, 7766176⟩, ⟨593648, 628011⟩, ⟨(-6722), (-4321)⟩, ⟨(-271), (-245)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-464575005), (-202645576)⟩, ⟨(-153385295), (-96208845)⟩, ⟨(-11994603), (-10547161)⟩, ⟨174507, 278637⟩, ⟨9203, 10785⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3830392291, 4092321720⟩, ⟨(-153385295), (-96208845)⟩, ⟨(-11994603), (-10547161)⟩, ⟨174507, 278637⟩, ⟨9203, 10785⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨724026945, 1128545841⟩, ⟨155942321, 177418970⟩, ⟨(-6173719), (-3887195)⟩, ⟨(-318944), (-272273)⟩, ⟨4200, 6704⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4507647574, 4815888994⟩, ⟨105972989, 192848800⟩, ⟨14108963, 22803109⟩, ⟨276916, 1311666⟩, ⟨17048, 108276⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨759879663, 1265423255⟩, ⟨181528814, 249610464⟩, ⟨(-696398), 9878373⟩, ⟨(-75884), 904952⟩, ⟨(-29765), 70667⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1109390053), (-739593368)⟩, ⟨(-184898343), (-184898342)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3185577243, 3555373928⟩, ⟨(-184898343), (-184898342)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨134440395, 372830782⟩, ⟨64233342, 147085120⟩, ⟨7262040, 20327521⟩, ⟨(-125662), 1681456⟩, ⟨(-27964), 169551⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4429407691, 4667798078⟩, ⟨64233342, 147085120⟩, ⟨7262040, 20327521⟩, ⟨(-125662), 1681456⟩, ⟨(-27964), 169551⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4361669539, 4477503779⟩, ⟨30807355, 72417887⟩, ⟨2897358, 9899530⟩, ⟨(-226235), 807407⟩, ⟨(-38409), 86274⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3235050296, 3706477629⟩, ⟨(-169906724), (-127822346)⟩, ⟨(-968621), 6868575⟩, ⟨(-613453), 543641⟩, ⟨(-66554), 81158⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4495137551, 6742706335⟩, ⟨1123784387, 1123784395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4704636894, 10585433040⟩, ⟨2352318444, 3528477700⟩, ⟨294039805, 294039810⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4704636894, 10585433040⟩, ⟨2352318444, 3528477700⟩, ⟨294039805, 294039810⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10585433040), (-4704636894)⟩, ⟨(-3528477700), (-2352318444)⟩, ⟨(-294039810), (-294039805)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5292716520), (-2352318447)⟩, ⟨(-1764238850), (-1176159222)⟩, ⟨(-147019905), (-147019902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1252494728, 2483706808⟩, ⟨(-1020229432), (-342990556)⟩, ⟨(-38055840), 166665425⟩, ⟨(-14993110), 28492857⟩, ⟨(-5778536), 2191016⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨943402629, 2143393206⟩, ⟨(-978693380), (-295622393)⟩, ⟨(-23193900), 188160930⟩, ⟨(-21518294), 26638747⟩, ⟨(-6342419), 2943115⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4409616507, 4409616510⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1880
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4361669539, 4477503779⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1881
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (128356909 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((861 / 5000) : ℝ)..(2583 / 10000), prawitzNormalCorrection
