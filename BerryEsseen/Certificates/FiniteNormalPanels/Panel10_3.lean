...
namespace FiniteNormalPanel10_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (12091 / 100000)
def radius : Rat := (12091 / 100000)

def j0 : Jet := ⟨⟨519304495, 519304496⟩, ⟨519304495, 519304496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1631443186, 1631443190⟩, ⟨1631443186, 1631443190⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨619703640, 619703644⟩, ⟨1239407280, 1239407288⟩, ⟨619703640, 619703644⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨155, 156⟩, ⟨310, 311⟩, ⟨155, 156⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94532), (-94530)⟩, ⟨310, 311⟩, ⟨155, 156⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-13640), (-13639)⟩, ⟨(-27236), (-27233)⟩, ⟨(-13529), (-13526)⟩, ⟨88, 91⟩, ⟨22, 23⟩⟩
...
def j13 : Jet := ⟨⟨5099416, 5099418⟩, ⟨(-27236), (-27233)⟩, ⟨(-13529), (-13526)⟩, ⟨88, 91⟩, ⟨22, 23⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨735774, 735775⟩, ⟨1467618, 1467621⟩, ⟨725961, 725966⟩, ⟨(-7823), (-7818)⟩, ⟨(-1925), (-1920)⟩⟩
...
def j16 : Jet := ⟨⟨(-142429803), (-142429801)⟩, ⟨1467618, 1467621⟩, ⟨725961, 725966⟩, ⟨(-7823), (-7818)⟩, ⟨(-1925), (-1920)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-20550627), (-20550625)⟩, ⟨(-40889497), (-40889493)⟩, ⟨(-20022368), (-20022363)⟩, ⟨420119, 420124⟩, ⟨102210, 102214⟩⟩
...
def j19 : Jet := ⟨⟨1411105138, 1411105141⟩, ⟨(-40889497), (-40889493)⟩, ⟨(-20022368), (-20022363)⟩, ⟨420119, 420124⟩, ⟨102210, 102214⟩⟩
...
def j22 : Jet := ⟨⟨(-16), (-15)⟩, ⟨(-32), (-30)⟩, ⟨(-16), (-15)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11819, 11821⟩, ⟨(-32), (-30)⟩, ⟨(-16), (-15)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1705, 1706⟩, ⟨3405, 3408⟩, ⟨1692, 1696⟩, ⟨(-10), (-8)⟩, ⟨(-3), (-2)⟩⟩
...
def j27 : Jet := ⟨⟨(-850472), (-850470)⟩, ⟨3405, 3408⟩, ⟨1692, 1696⟩, ⟨(-10), (-8)⟩, ⟨(-3), (-2)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-122712), (-122710)⟩, ⟨(-244932), (-244929)⟩, ⟨(-121486), (-121481)⟩, ⟨977, 981⟩, ⟨240, 243⟩⟩
...
def j30 : Jet := ⟨⟨35668682, 35668685⟩, ⟨(-244932), (-244929)⟩, ⟨(-121486), (-121481)⟩, ⟨977, 981⟩, ⟨240, 243⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5146491, 5146492⟩, ⟨10257641, 10257645⟩, ⟨5058281, 5058285⟩, ⟨(-70259), (-70253)⟩, ⟨(-17214), (-17208)⟩⟩
...
def j33 : Jet := ⟨⟨(-710681392), (-710681390)⟩, ⟨10257641, 10257645⟩, ⟨5058281, 5058285⟩, ⟨(-70259), (-70253)⟩, ⟨(-17214), (-17208)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-102541375), (-102541373)⟩, ⟨(-203602716), (-203602711)⟩, ⟨(-98851469), (-98851463)⟩, ⟨2929573, 2929579⟩, ⟨707080, 707085⟩⟩
...
def j36 : Jet := ⟨⟨4192425921, 4192425923⟩, ⟨(-203602716), (-203602711)⟩, ⟨(-98851469), (-98851463)⟩, ⟨2929573, 2929579⟩, ⟨707080, 707085⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨536008240, 536008243⟩, ⟨520476365, 520476371⟩, ⟨(-23137371), (-23137365)⟩, ⟨(-7445914), (-7445908)⟩, ⟨198406, 198411⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4400016699, 4400016702⟩, ⟨213684234, 213684242⟩, ⟨114123608, 114123618⟩, ⟨7506076, 7506088⟩, ⟨2163983, 2163995⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨549118315, 549118319⟩, ⟨559874159, 559874169⟩, ⟨16434109, 16434121⟩, ⟨5987405, 5987420⟩, ⟨397682, 397696⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-519304496), (-519304495)⟩, ⟨(-519304496), (-519304495)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3775662800, 3775662801⟩, ⟨(-519304496), (-519304495)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨70205639, 70205641⟩, ⟨143161580, 143161586⟩, ⟨77185129, 77185139⟩, ⟨5815562, 5815574⟩, ⟨1725556, 1725569⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4365172935, 4365172937⟩, ⟨143161580, 143161586⟩, ⟨77185129, 77185139⟩, ⟨5815562, 5815574⟩, ⟨1725556, 1725569⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4329927828, 4329927830⟩, ⟨71002835, 71002839⟩, ⟨37698803, 37698810⟩, ⟨2266111, 2266120⟩, ⟨654537, 654546⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3806396254, 3806396257⟩, ⟨(-461113693), (-461113686)⟩, ⟨24555686, 24555695⟩, ⟨(-2566049), (-2566038)⟩, ⟨301399, 301410⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨13867430200, 13867430205⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value129

def j47 : Jet := ⟨⟨1676710983, 1676710987⟩, ⟨1676710983, 1676710987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨654570693, 654570697⟩, ⟨1309141386, 1309141394⟩, ⟨654570693, 654570697⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨654570693, 654570697⟩, ⟨1309141386, 1309141394⟩, ⟨654570693, 654570697⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-654570697), (-654570693)⟩, ⟨(-1309141394), (-1309141386)⟩, ⟨(-654570697), (-654570693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-327285349), (-327285346)⟩, ⟨(-654570697), (-654570693)⟩, ⟨(-327285349), (-327285346)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3979841054, 3979841058⟩, ⟨(-606544162), (-606544156)⟩, ⟨(-257052169), (-257052163)⟩, ⟨43871877, 43871879⟩, ⟨8122388, 8122389⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3527116980, 3527116987⟩, ⟨(-964828450), (-964828435)⟩, ⟨(-139937942), (-139937922)⟩, ⟨60633157, 60633176⟩, ⟨1660300, 1660319⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 1038608992⟩, ⟨519304495, 519304496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 3262886380⟩, ⟨1631443186, 1631443190⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 2478814575⟩, ⟨0, 2478814576⟩, ⟨619703640, 619703644⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 622⟩, ⟨0, 622⟩, ⟨155, 156⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94064)⟩, ⟨0, 622⟩, ⟨155, 156⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-54649), 0⟩, ⟨(-54649), 359⟩, ⟨(-13663), (-13122)⟩, ⟨0, 181⟩, ⟨22, 23⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5058407, 5113057⟩, ⟨(-54649), 359⟩, ⟨(-13663), (-13122)⟩, ⟨0, 181⟩, ⟨22, 23⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2950971⟩, ⟨(-31541), 2951179⟩, ⟨690430, 737951⟩, ⟨(-15772), 157⟩, ⟨(-1972), (-1774)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-140214605)⟩, ⟨(-31541), 2951179⟩, ⟨690430, 737951⟩, ⟨(-15772), 157⟩, ⟨(-1972), (-1774)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-82627153), 0⟩, ⟨(-82645357), 1703256⟩, ⟨(-20674993), (-18101844)⟩, ⟨(-13654), 851809⟩, ⟨89377, 106567⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1349028612, 1431655766⟩, ⟨(-82645357), 1703256⟩, ⟨(-20674993), (-18101844)⟩, ⟨(-13654), 851809⟩, ⟨89377, 106567⟩⟩
...
def j70 : Jet := ⟨⟨(-63), 0⟩, ⟨(-63), 0⟩, ⟨(-16), (-15)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11772, 11836⟩, ⟨(-63), 0⟩, ⟨(-16), (-15)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 6832⟩, ⟨(-37), 6832⟩, ⟨1651, 1708⟩, ⟨(-20), 0⟩, ⟨(-3), (-2)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-845344)⟩, ⟨(-37), 6832⟩, ⟨1651, 1708⟩, ⟨(-20), 0⟩, ⟨(-3), (-2)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-491829), 0⟩, ⟨(-491851), 3944⟩, ⟨(-122980), (-117041)⟩, ⟨(-18), 1972⟩, ⟨224, 247⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35299565, 35791395⟩, ⟨(-491851), 3944⟩, ⟨(-122980), (-117041)⟩, ⟨(-18), 1972⟩, ⟨224, 247⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 20656789⟩, ⟨(-283869), 20659066⟩, ⟨4738385, 5166475⟩, ⟨(-141957), 1709⟩, ⟨(-17756), (-15605)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-695171093)⟩, ⟨(-283869), 20659066⟩, ⟨4738385, 5166475⟩, ⟨(-141957), 1709⟩, ⟨(-17756), (-15605)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-413135763), 0⟩, ⟨(-413299597), 11923256⟩, ⟨(-103447775), (-85398397)⟩, ⟨(-122889), 5963602⟩, ⟨591504, 746438⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3881831533, 4294967296⟩, ⟨(-413299597), 11923256⟩, ⟨(-103447775), (-85398397)⟩, ⟨(-122889), 5963602⟩, ⟨591504, 746438⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 1087628794⟩, ⟨449642800, 545108361⟩, ⟨(-47099628), 646982⟩, ⟨(-7863769), (-6228864)⟩, ⟨(-5187), 404519⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4752072293⟩, ⟨(-14596248), 505954355⟩, ⟨83993817, 180508103⟩, ⟨(-8243962), 32852473⟩, ⟨(-720983), 7676181⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 1203383007⟩, ⟨445946543, 731247680⟩, ⟨(-53964876), 110641185⟩, ⟨(-7543393), 25160258⟩, ⟨(-4140485), 6614922⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1038608992), 0⟩, ⟨(-519304496), (-519304495)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3256358304, 4294967296⟩, ⟨(-519304496), (-519304495)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 337169195⟩, ⟨0, 409768444⟩, ⟨16062400, 186499818⟩, ⟨(-22602866), 51773870⟩, ⟨(-6279001), 15124402⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4632136491⟩, ⟨0, 409768444⟩, ⟨16062400, 186499818⟩, ⟨(-22602866), 51773870⟩, ⟨(-6279001), 15124402⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4460367109⟩, ⟨0, 204884222⟩, ⟨3027770, 93249909⟩, ⟨(-15749764), 25886935⟩, ⟨(-5386689), 8312451⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3256358304, 4460367109⟩, ⟨(-539302988), (-314420273)⟩, ⟨(-22476958), 93249909⟩, ⟨(-27024611), 25520848⟩, ⟨(-8516679), 10216755⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3353421974⟩, ⟨1676710983, 1676710987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2618282786⟩, ⟨0, 2618282786⟩, ⟨654570693, 654570697⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2618282786⟩, ⟨0, 2618282786⟩, ⟨654570693, 654570697⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2618282786), 0⟩, ⟨(-2618282786), 0⟩, ⟨(-654570697), (-654570693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1309141393), 0⟩, ⟨(-1309141393), 0⟩, ⟨(-327285349), (-327285346)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3166527960, 4294967296⟩, ⟨(-1309141393), 0⟩, ⟨(-327285349), (-41777409)⟩, ⟨0, 99759269⟩, ⟨(-6010100), 12469909⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2400798168, 4460367109⟩, ⟨(-1898859606), (-231810981)⟩, ⟨(-362366114), 225959105⟩, ⟨(-52389567), 177069021⟩, ⟨(-42169429), 33116998⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨519304495, 519304496⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨519304495, 519304496⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4329927828, 4329927830⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar129 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified190
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar129 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 1038608992⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4460367109⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified191
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(12091 / 50000), prawitzNormalCorrection
      ((57077 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
