...
namespace FiniteNormalPanel128_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (105077 / 400000)
def radius : Rat := (15011 / 400000)

def j0 : Jet := ⟨⟨1128255696, 1128255697⟩, ⟨161179385, 161179386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3544519805, 3544519810⟩, ⟨506359971, 506359975⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2925195882, 2925195891⟩, ⟨835770250, 835770258⟩, ⟨59697874, 59697876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨732, 733⟩, ⟨209, 210⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93955), (-93953)⟩, ⟨209, 210⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-63991), (-63989)⟩, ⟨(-18141), (-18138)⟩, ⟨(-1257), (-1253)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5049065, 5049068⟩, ⟨(-18141), (-18138)⟩, ⟨(-1257), (-1253)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3438793, 3438796⟩, ⟨970156, 970160⟩, ⟨65791, 65798⟩, ⟨(-496), (-490)⟩, ⟨(-18), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-139726784), (-139726780)⟩, ⟨970156, 970160⟩, ⟨65791, 65798⟩, ⟨(-496), (-490)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-95164454), (-95164450)⟩, ⟨(-26529095), (-26529090)⟩, ⟨(-1708539), (-1708530)⟩, ⟨25948, 25956⟩, ⟨804, 811⟩⟩
...
def j19 : Jet := ⟨⟨1336491311, 1336491316⟩, ⟨(-26529095), (-26529090)⟩, ⟨(-1708539), (-1708530)⟩, ⟨25948, 25956⟩, ⟨804, 811⟩⟩
...
def j22 : Jet := ⟨⟨(-74), (-72)⟩, ⟨(-22), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11761, 11764⟩, ⟨(-22), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8010, 8013⟩, ⟨2273, 2277⟩, ⟨156, 161⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844167), (-844163)⟩, ⟨2273, 2277⟩, ⟨156, 161⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-574942), (-574938)⟩, ⟨(-162721), (-162717)⟩, ⟨(-11186), (-11179)⟩, ⟨59, 64⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35216452, 35216457⟩, ⟨(-162721), (-162717)⟩, ⟨(-11186), (-11179)⟩, ⟨59, 64⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23985053, 23985057⟩, ⟨6742046, 6742052⟩, ⟨450206, 450215⟩, ⟨(-4399), (-4392)⟩, ⟨(-145), (-139)⟩⟩
...
def j33 : Jet := ⟨⟨(-691842830), (-691842825)⟩, ⟨6742046, 6742052⟩, ⟨450206, 450215⟩, ⟨(-4399), (-4392)⟩, ⟨(-145), (-139)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-471197023), (-471197018)⟩, ⟨(-130035882), (-130035874)⟩, ⟨(-7997688), (-7997678)⟩, ⟨178320, 178330⟩, ⟨5301, 5310⟩⟩
...
def j36 : Jet := ⟨⟨3823770273, 3823770278⟩, ⟨(-130035882), (-130035874)⟩, ⟨(-7997688), (-7997678)⟩, ⟨178320, 178330⟩, ⟨5301, 5310⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1102969963, 1102969970⟩, ⟨135673395, 135673403⟩, ⟨(-4537689), (-4537679)⟩, ⟨(-180017), (-180008)⟩, ⟨3722, 3731⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4824229159, 4824229166⟩, ⟨164058719, 164058731⟩, ⟨15669388, 15669406⟩, ⟨651022, 651039⟩, ⟨40560, 40578⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1238887164, 1238887175⟩, ⟨194523340, 194523354⟩, ⟨4109556, 4109577⟩, ⟨286632, 286652⟩, ⟨11729, 11749⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1128255697), (-1128255696)⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3166711599, 3166711600⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨357358112, 357358119⟩, ⟨112220862, 112220874⟩, ⟨11180965, 11180981⟩, ⟨537608, 537626⟩, ⟨36660, 36679⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4652325408, 4652325415⟩, ⟨112220862, 112220874⟩, ⟨11180965, 11180981⟩, ⟨537608, 537626⟩, ⟨36660, 36679⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4470076674, 4470076679⟩, ⟨53912378, 53912385⟩, ⟨5046371, 5046380⟩, ⟨197410, 197421⟩, ⟨12381, 12393⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3295821056, 3295821062⟩, ⟨(-128000804), (-128000796)⟩, ⟨1697529, 1697538⟩, ⟨(-43828), (-43817)⟩, ⟨1719, 1730⟩⟩
...
def j47 : Jet := ⟨⟨8756294370, 8756294380⟩, ⟨1250899194, 1250899203⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17851752018, 17851752059⟩, ⟨5100500568, 5100500614⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17851752018, 17851752059⟩, ⟨5100500568, 5100500614⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17851752059), (-17851752018)⟩, ⟨(-5100500614), (-5100500568)⟩, ⟨(-364321475), (-364321468)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8925876030), (-8925876009)⟩, ⟨(-2550250307), (-2550250284)⟩, ⟨(-182160738), (-182160734)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨537528482, 537528497⟩, ⟨(-319171747), (-319171735)⟩, ⟨71960341, 71960348⟩, ⟨(-5218184), (-5218181)⟩, ⟨(-751405), (-751403)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨412482230, 412482243⟩, ⟨(-260941929), (-260941915)⟩, ⟨64944641, 64944652⟩, ⟨(-6280504), (-6280494)⟩, ⟨(-389179), (-389171)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨967076311, 1289435082⟩, ⟨161179385, 161179386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3038159833, 4050879782⟩, ⟨506359971, 506359975⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2149123505, 3820664019⟩, ⟨716374500, 955166010⟩, ⟨59697874, 59697876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨537, 958⟩, ⟨179, 240⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94150), (-93728)⟩, ⟨179, 240⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-83753), (-46899)⟩, ⟨(-20850), (-15419)⟩, ⟨(-1273), (-1234)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5029303, 5066158⟩, ⟨(-20850), (-15419)⟩, ⟨(-1273), (-1234)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2516571, 4506691⟩, ⟨820309, 1118958⟩, ⟨64134, 67230⟩, ⟨(-572), (-411)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140649006), (-138658885)⟩, ⟨820309, 1118958⟩, ⟨64134, 67230⟩, ⟨(-572), (-411)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-125116808), (-69382383)⟩, ⟨(-30868736), (-22132072)⟩, ⟨(-1786038), (-1618634)⟩, ⟨21589, 30300⟩, ⟨746, 860⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1306538957, 1362273383⟩, ⟨(-30868736), (-22132072)⟩, ⟨(-1786038), (-1618634)⟩, ⟨21589, 30300⟩, ⟨746, 860⟩⟩
...
def j70 : Jet := ⟨⟨(-97), (-53)⟩, ⟨(-25), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11738, 11783⟩, ⟨(-25), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5873, 10482⟩, ⟨1934, 2613⟩, ⟨155, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846304), (-841694)⟩, ⟨1934, 2613⟩, ⟨155, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-752845), (-421168)⟩, ⟨(-187245), (-138064)⟩, ⟨(-11365), (-10972)⟩, ⟨49, 74⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35038549, 35370227⟩, ⟨(-187245), (-138064)⟩, ⟨(-11365), (-10972)⟩, ⟨49, 74⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17532652, 31464211⟩, ⟨5677649, 7796969⟩, ⟨435266, 463111⟩, ⟨(-5107), (-3683)⟩, ⟨(-150), (-132)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698295231), (-684363671)⟩, ⟨5677649, 7796969⟩, ⟨435266, 463111⟩, ⟨(-5107), (-3683)⟩, ⟨(-150), (-132)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-621180857), (-342443131)⟩, ⟨(-152454223), (-107211778)⟩, ⟨(-8541155), (-7366357)⟩, ⟨146971, 209525⟩, ⟨4779, 5758⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3673786439, 3952524165⟩, ⟨(-152454223), (-107211778)⟩, ⟨(-8541155), (-7366357)⟩, ⟨146971, 209525⟩, ⟨4779, 5758⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨924215228, 1284853953⟩, ⟨124921437, 144951033⟩, ⟨(-5323841), (-3754268)⟩, ⟨(-195296), (-162251)⟩, ⟨3072, 4385⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4667079391, 5021180295⟩, ⟨126594008, 208368167⟩, ⟨12131927, 20320532⟩, ⟨298835, 1140985⟩, ⟨12353, 83459⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1004288402, 1502103022⟩, ⟨162985727, 231794067⟩, ⟨68649, 9031649⟩, ⟨(-69435), 740165⟩, ⟨(-19977), 53217⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1289435082), (-967076311)⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3005532214, 3327890985⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨234831868, 525338922⟩, ⟨76221616, 162133282⟩, ⟨6217098, 18827019⟩, ⟨(-43358), 1492580⟩, ⟨(-21469), 136109⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4529799164, 4820306218⟩, ⟨76221616, 162133282⟩, ⟨6217098, 18827019⟩, ⟨(-43358), 1492580⟩, ⟨(-21469), 136109⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4410820702, 4550061271⟩, ⟨35974169, 78937367⟩, ⟨2249543, 9019557⟩, ⟨(-182527), 708343⟩, ⟨(-32352), 68961⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3086604110, 3525546726⟩, ⟨(-145578423), (-104363638)⟩, ⟨(-1388138), 5638649⟩, ⟨(-479911), 464430⟩, ⟨(-51651), 60284⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7505395175, 10007193575⟩, ⟨1250899194, 1250899203⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13115572913, 23316574108⟩, ⟨4371857630, 5829143556⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13115572913, 23316574108⟩, ⟨4371857630, 5829143556⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23316574108), (-13115572913)⟩, ⟨(-5829143556), (-4371857630)⟩, ⟨(-364321475), (-364321468)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11658287054), (-6557786456)⟩, ⟨(-2914571778), (-2185928815)⟩, ⟨(-182160738), (-182160734)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨284516921, 932944380⟩, ⟨(-633097571), (-144805232)⟩, ⟨(-2719200), 202743418⟩, ⟨(-41766294), 18515962⟩, ⟨(-7440679), 7143333⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨204469798, 765812352⟩, ⟨(-551303766), (-110978642)⟩, ⟨985031, 189106746⟩, ⟨(-42091507), 15596595⟩, ⟨(-6880529), 7629326⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1128255696, 1128255697⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4470076674, 4470076679⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2582
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨967076311, 1289435082⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4410820702, 4550061271⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2583
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (16349093 / 2147483648)

theorem envelope_integral : (∫ s in ((45033 / 200000) : ℝ)..(15011 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((45033 / 200000) : ℝ)..(15011 / 50000), prawitzNormalCorrection
