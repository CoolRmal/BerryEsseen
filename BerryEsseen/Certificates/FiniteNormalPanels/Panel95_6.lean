...
namespace FiniteNormalPanel95_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (29459 / 160000)
def radius : Rat := (29459 / 800000)

def j0 : Jet := ⟨⟨790784009, 790784010⟩, ⟨158156801, 158156802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2484321233, 2484321237⟩, ⟨496864244, 496864248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1436996271, 1436996276⟩, ⟨574798504, 574798512⟩, ⟨57479850, 57479852⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨359, 361⟩, ⟨143, 145⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94328), (-94325)⟩, ⟨143, 145⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-31560), (-31558)⟩, ⟨(-12577), (-12574)⟩, ⟨(-1240), (-1236)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5081496, 5081499⟩, ⟨(-12577), (-12574)⟩, ⟨(-1240), (-1236)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1700150, 1700152⟩, ⟨675852, 675855⟩, ⟨65907, 65912⟩, ⟨(-335), (-331)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-141465427), (-141465424)⟩, ⟨675852, 675855⟩, ⟨65907, 65912⟩, ⟨(-335), (-331)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-47331046), (-47331044)⟩, ⟨(-18706295), (-18706291)⟩, ⟨(-1780743), (-1780737)⟩, ⟨17751, 17758⟩, ⟨831, 835⟩⟩
...
def j19 : Jet := ⟨⟨1384324719, 1384324722⟩, ⟨(-18706295), (-18706291)⟩, ⟨(-1780743), (-1780737)⟩, ⟨17751, 17758⟩, ⟨831, 835⟩⟩
...
def j25 : Jet := ⟨⟨3947, 3949⟩, ⟨1572, 1576⟩, ⟨153, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848230), (-848227)⟩, ⟨1572, 1576⟩, ⟨153, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-283799), (-283797)⟩, ⟨(-112995), (-112990)⟩, ⟨(-11091), (-11087)⟩, ⟨40, 44⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35507595, 35507598⟩, ⟨(-112995), (-112990)⟩, ⟨(-11091), (-11087)⟩, ⟨40, 44⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11880016, 11880018⟩, ⟨4714200, 4714204⟩, ⟨456366, 456371⟩, ⟨(-2985), (-2980)⟩, ⟨(-144), (-140)⟩⟩
...
def j33 : Jet := ⟨⟨(-703947867), (-703947864)⟩, ⟨4714200, 4714204⟩, ⟨456366, 456371⟩, ⟨(-2985), (-2980)⟩, ⟨(-144), (-140)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-235524603), (-235524600)⟩, ⟨(-92632581), (-92632575)⟩, ⟨(-8637392), (-8637385)⟩, ⟨123166, 123171⟩, ⟨5658, 5664⟩⟩
...
def j36 : Jet := ⟨⟨4059442693, 4059442696⟩, ⟨(-92632581), (-92632575)⟩, ⟨(-8637392), (-8637385)⟩, ⟨123166, 123171⟩, ⟨5658, 5664⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨800729564, 800729568⟩, ⟨149325702, 149325707⟩, ⟨(-3194071), (-3194065)⟩, ⟨(-195739), (-195732)⟩, ⟨2533, 2538⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4544156785, 4544156790⟩, ⟨103693283, 103693292⟩, ⟨12034904, 12034915⟩, ⟨357376, 357387⟩, ⟨24273, 24285⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨847187051, 847187057⟩, ⟨177321414, 177321423⟩, ⟨2469497, 2469508⟩, ⟨200840, 200854⟩, ⟨5952, 5965⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-790784010), (-790784009)⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3504183286, 3504183287⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨167108583, 167108586⟩, ⟨69953690, 69953696⟩, ⟨8295088, 8295096⟩, ⟨283140, 283150⟩, ⟨20349, 20360⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4462075879, 4462075882⟩, ⟨69953690, 69953696⟩, ⟨8295088, 8295096⟩, ⟨283140, 283150⟩, ⟨20349, 20360⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4377724291, 4377724293⟩, ⟨34315638, 34315642⟩, ⟨3934643, 3934648⟩, ⟨108051, 108057⟩, ⟨7366, 7373⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3571703166, 3571703170⟩, ⟨(-133206740), (-133206734)⟩, ⟨1946570, 1946576⟩, ⟨(-56733), (-56726)⟩, ⟨2029, 2038⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨39008650869, 39008650876⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value436

def j47 : Jet := ⟨⟨7182224029, 7182224041⟩, ⟨1436444798, 1436444809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12010415550, 12010415592⟩, ⟨4804166194, 4804166240⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12010415550, 12010415592⟩, ⟨4804166194, 4804166240⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12010415592), (-12010415550)⟩, ⟨(-4804166240), (-4804166194)⟩, ⟨(-480416625), (-480416616)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6005207796), (-6005207775)⟩, ⟨(-2402083120), (-2402083097)⟩, ⟨(-240208313), (-240208308)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1061037860, 1061037873⟩, ⟨(-593415733), (-593415719)⟩, ⟨106600768, 106600777⟩, ⟨2252469, 2252473⟩, ⟨(-3295917), (-3295915)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨882361150, 882361163⟩, ⟨(-526393357), (-526393342)⟩, ⟨107534846, 107534860⟩, ⟨(-1715991), (-1715981)⟩, ⟨(-2754100), (-2754091)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨632627207, 948940812⟩, ⟨158156801, 158156802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1987456985, 2981185484⟩, ⟨496864244, 496864248⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨919677612, 2069274637⟩, ⟨459838804, 689758214⟩, ⟨57479850, 57479852⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨230, 519⟩, ⟨115, 173⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94457), (-94167)⟩, ⟨115, 173⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-45509), (-20163)⟩, ⟨(-15146), (-9997)⟩, ⟨(-1251), (-1224)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5067547, 5092894⟩, ⟨(-15146), (-9997)⟩, ⟨(-1251), (-1224)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1085109, 2453709⟩, ⟨535256, 815763⟩, ⟨64783, 66827⟩, ⟨(-404), (-261)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142080468), (-140711867)⟩, ⟨535256, 815763⟩, ⟨64783, 66827⟩, ⟨(-404), (-261)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-68453027), (-30130509)⟩, ⟨(-22703063), (-14672227)⟩, ⟨(-1830296), (-1719950)⟩, ⟨13903, 21596⟩, ⟨792, 866⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1363202738, 1401525257⟩, ⟨(-22703063), (-14672227)⟩, ⟨(-1830296), (-1719950)⟩, ⟨13903, 21596⟩, ⟨792, 866⟩⟩
...
def j72 : Jet := ⟨⟨2522, 5692⟩, ⟨1252, 1896⟩, ⟨153, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849655), (-846484)⟩, ⟨1252, 1896⟩, ⟨153, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-409356), (-181256)⟩, ⟨(-136184), (-89714)⟩, ⟨(-11205), (-10946)⟩, ⟨31, 52⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35382038, 35610139⟩, ⟨(-136184), (-89714)⟩, ⟨(-11205), (-10946)⟩, ⟨31, 52⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7576325, 17156629⟩, ⟨3722549, 5699667⟩, ⟨446250, 464626⟩, ⟨(-3617), (-2345)⟩, ⟨(-147), (-135)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708251558), (-698671253)⟩, ⟨3722549, 5699667⟩, ⟨446250, 464626⟩, ⟨(-3617), (-2345)⟩, ⟨(-147), (-135)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-341228905), (-149605867)⟩, ⟨(-112945863), (-72056887)⟩, ⟨(-8984473), (-8211164)⟩, ⟨95853, 150396⟩, ⟨5320, 5940⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3953738391, 4145361429⟩, ⟨(-112945863), (-72056887)⟩, ⟨(-8984473), (-8211164)⟩, ⟨95853, 150396⟩, ⟨5320, 5940⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨630809646, 972814568⟩, ⟨141943957, 155346323⟩, ⟨(-3896839), (-2493250)⟩, ⟨(-205306), (-183981)⟩, ⟨1974, 3101⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4449972430, 4665646093⟩, ⟨77351798, 133282826⟩, ⟨10159109, 14409684⟩, ⟨160535, 606630⟩, ⟨11390, 42214⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨653575531, 1056773702⟩, ⟨158427505, 198942246⟩, ⟨(-184680), 5501336⟩, ⟨15371, 423070⟩, ⟨(-10424), 25663⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-948940812), (-632627207)⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3346026484, 3662340089⟩, ⟨(-158156802), (-158156801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨99456164, 260018431⟩, ⟨48216590, 97899202⟩, ⟨5752998, 11922176⟩, ⟨(-12432), 717838⟩, ⟨(-4235), 58871⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4394423460, 4554985727⟩, ⟨48216590, 97899202⟩, ⟨5752998, 11922176⟩, ⟨(-12432), 717838⟩, ⟨(-4235), 58871⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4344410782, 4423066214⟩, ⟨23410081, 48392509⟩, ⟨2528461, 5830173⟩, ⟨(-71089), 341211⟩, ⟨(-9808), 29157⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3384545802, 3771570677⟩, ⟨(-144636086), (-118712960)⟩, ⟨187822, 4109372⟩, ⟨(-275307), 197846⟩, ⟨(-20929), 27481⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5745779221, 8618668849⟩, ⟨1436444798, 1436444809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7686665946, 17294998451⟩, ⟨3843332952, 5764999488⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7686665946, 17294998451⟩, ⟨3843332952, 5764999488⟩, ⟨480416616, 480416625⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17294998451), (-7686665946)⟩, ⟨(-5764999488), (-3843332952)⟩, ⟨(-480416625), (-480416616)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8647499226), (-3843332973)⟩, ⟨(-2882499744), (-1921666476)⟩, ⟨(-240208313), (-240208308)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨573522058, 1755227106⟩, ⟨(-1177993064), (-256606869)⟩, ⟨(-40760203), 363219900⟩, ⟨(-71688794), 53040275⟩, ⟨(-19056342), 13168018⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨451950280, 1541330266⟩, ⟨(-1093548090), (-218065036)⟩, ⟨(-28675355), 360306054⟩, ⟨(-76423889), 48018903⟩, ⟨(-18622071), 14411765⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨790784009, 790784010⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4377724291, 4377724293⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar436 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1912
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar436 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨632627207, 948940812⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4344410782, 4423066214⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1913
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((29459 / 200000) : ℝ)..(88377 / 400000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (29459 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (88377 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((29459 / 200000) : ℝ)..(88377 / 400000), prawitzNormalCorrection
      ((287211 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
