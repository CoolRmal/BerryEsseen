...
namespace FiniteNormalPanel8_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2817 / 50000)
def radius : Rat := (2817 / 50000)

def j0 : Jet := ⟨⟨241978457, 241978458⟩, ⟨241978457, 241978458⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨760197742, 760197747⟩, ⟨760197742, 760197747⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨134552970, 134552973⟩, ⟨269105940, 269105946⟩, ⟨134552970, 134552973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨33, 34⟩, ⟨67, 68⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94654), (-94652)⟩, ⟨67, 68⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2966), (-2965)⟩, ⟨(-5929), (-5927)⟩, ⟨(-2961), (-2958)⟩, ⟨4, 6⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5110090, 5110092⟩, ⟨(-5929), (-5927)⟩, ⟨(-2961), (-2958)⟩, ⟨4, 6⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨160089, 160090⟩, ⟨319992, 319994⟩, ⟨159624, 159627⟩, ⟨(-372), (-369)⟩, ⟨(-93), (-90)⟩⟩
...
def j16 : Jet := ⟨⟨(-143005488), (-143005486)⟩, ⟨319992, 319994⟩, ⟨159624, 159627⟩, ⟨(-372), (-369)⟩, ⟨(-93), (-90)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-4480084), (-4480083)⟩, ⟨(-8950144), (-8950142)⟩, ⟨(-4455035), (-4455032)⟩, ⟨20013, 20016⟩, ⟨4973, 4976⟩⟩
...
def j19 : Jet := ⟨⟨1427175681, 1427175683⟩, ⟨(-8950144), (-8950142)⟩, ⟨(-4455035), (-4455032)⟩, ⟨20013, 20016⟩, ⟨4973, 4976⟩⟩
...
def j22 : Jet := ⟨⟨(-4), (-3)⟩, ⟨(-7), (-6)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11831, 11833⟩, ⟨(-7), (-6)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨370, 371⟩, ⟨740, 742⟩, ⟨368, 371⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851807), (-851805)⟩, ⟨740, 742⟩, ⟨368, 371⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-26686), (-26685)⟩, ⟨(-53348), (-53346)⟩, ⟨(-26629), (-26626)⟩, ⟨45, 48⟩, ⟨9, 12⟩⟩
...
def j30 : Jet := ⟨⟨35764708, 35764710⟩, ⟨(-53348), (-53346)⟩, ⟨(-26629), (-26626)⟩, ⟨45, 48⟩, ⟨9, 12⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨1120438, 1120439⟩, ⟨2239205, 2239207⟩, ⟨1116260, 1116263⟩, ⟨(-3340), (-3337)⟩, ⟨(-833), (-829)⟩⟩
...
def j33 : Jet := ⟨⟨(-714707445), (-714707443)⟩, ⟨2239205, 2239207⟩, ⟨1116260, 1116263⟩, ⟨(-3340), (-3337)⟩, ⟨(-833), (-829)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-22390395), (-22390393)⟩, ⟨(-44710640), (-44710636)⟩, ⟨(-22215126), (-22215121)⟩, ⟨139984, 139988⟩, ⟨34733, 34737⟩⟩
...
def j36 : Jet := ⟨⟨4272576901, 4272576903⟩, ⟨(-44710640), (-44710636)⟩, ⟨(-22215126), (-22215121)⟩, ⟨139984, 139988⟩, ⟨34733, 34737⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨252606284, 252606287⟩, ⟨251022132, 251022136⟩, ⟨(-2372682), (-2372679)⟩, ⟨(-784988), (-784985)⟩, ⟨4422, 4424⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4317475025, 4317475028⟩, ⟨45180474, 45180480⟩, ⟨22921360, 22921368⟩, ⟨333315, 333323⟩, ⟨86081, 86090⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨253930064, 253930068⟩, ⟨254994876, 254994882⟩, ⟨1603591, 1603600⟩, ⟨545194, 545203⟩, ⟨8066, 8075⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-241978458), (-241978457)⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4052988838, 4052988839⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨15013031, 15013032⟩, ⟨30151970, 30151974⟩, ⟨15328820, 15328825⟩, ⟨254878, 254882⟩, ⟨66286, 66295⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4309980327, 4309980328⟩, ⟨30151970, 30151974⟩, ⟨15328820, 15328825⟩, ⟨254878, 254882⟩, ⟨66286, 66295⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4302467263, 4302467264⟩, ⟨15049704, 15049707⟩, ⟨7624728, 7624732⟩, ⟨100545, 100549⟩, ⟨25976, 25983⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4060066256, 4060066259⟩, ⟨(-228199204), (-228199198)⟩, ⟨6347249, 6347255⟩, ⟨(-334698), (-334692)⟩, ⟨18847, 18856⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨15443086799, 15443086804⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value109

def j47 : Jet := ⟨⟨870063508, 870063513⟩, ⟨870063508, 870063513⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨176255243, 176255246⟩, ⟨352510486, 352510492⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨176255243, 176255246⟩, ⟨352510486, 352510492⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-176255246), (-176255243)⟩, ⟨(-352510492), (-352510486)⟩, ⟨(-176255246), (-176255243)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-88127623), (-88127621)⟩, ⟨(-176255246), (-176255243)⟩, ⟨(-88127623), (-88127621)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4207737657, 4207737660⟩, ⟨(-172675550), (-172675546)⟩, ⟨(-82794679), (-82794675)⟩, ⟨3494629, 3494631⟩, ⟨813571, 813572⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3977607394, 3977607401⟩, ⟨(-386796092), (-386796080)⟩, ⟨(-62873566), (-62873553)⟩, ⟨7119439, 7119452⟩, ⟨492962, 492976⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 483956915⟩, ⟨241978457, 241978458⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1520395489⟩, ⟨760197742, 760197747⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 538211885⟩, ⟨0, 538211888⟩, ⟨134552970, 134552973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 135⟩, ⟨0, 135⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94551)⟩, ⟨0, 135⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-11866), 0⟩, ⟨(-11866), 17⟩, ⟨(-2967), (-2940)⟩, ⟨0, 10⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5101190, 5113057⟩, ⟨(-11866), 17⟩, ⟨(-2967), (-2940)⟩, ⟨0, 10⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 640729⟩, ⟨(-1487), 640732⟩, ⟨157951, 160186⟩, ⟨(-744), 3⟩, ⟨(-93), (-89)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142524847)⟩, ⟨(-1487), 640732⟩, ⟨157951, 160186⟩, ⟨(-744), 3⟩, ⟨(-93), (-89)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-17940397), 0⟩, ⟨(-17940584), 80292⟩, ⟨(-4485287), (-4364660)⟩, ⟨(-141), 40148⟩, ⟨4842, 5020⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1413715368, 1431655766⟩, ⟨(-17940584), 80292⟩, ⟨(-4485287), (-4364660)⟩, ⟨(-141), 40148⟩, ⟨4842, 5020⟩⟩
...
def j70 : Jet := ⟨⟨(-14), 0⟩, ⟨(-14), 0⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11821, 11836⟩, ⟨(-14), 0⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 1484⟩, ⟨(-2), 1484⟩, ⟨367, 371⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-850692)⟩, ⟨(-2), 1484⟩, ⟨367, 371⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-106789), 0⟩, ⟨(-106790), 186⟩, ⟨(-26699), (-26417)⟩, ⟨(-2), 94⟩, ⟨9, 12⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35684605, 35791395⟩, ⟨(-106790), 186⟩, ⟨(-26699), (-26417)⟩, ⟨(-2), 94⟩, ⟨9, 12⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 4485100⟩, ⟨(-13383), 4485124⟩, ⟨1101200, 1121299⟩, ⟨(-6693), 18⟩, ⟨(-838), (-813)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-711342782)⟩, ⟨(-13383), 4485124⟩, ⟨1101200, 1121299⟩, ⟨(-6693), 18⟩, ⟨(-838), (-813)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-89701981), 0⟩, ⟨(-89703660), 562041⟩, ⟨(-22427174), (-21582431)⟩, ⟨(-1259), 281027⟩, ⟨33553, 35132⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4205265315, 4294967296⟩, ⟨(-89703660), 562041⟩, ⟨(-22427174), (-21582431)⟩, ⟨(-1259), 281027⟩, ⟨33553, 35132⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 506798497⟩, ⟨243872973, 253427673⟩, ⟨(-4763204), 14212⟩, ⟨(-793934), (-758320)⟩, ⟨(-25), 8885⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4386582699⟩, ⟨(-586275), 93571392⟩, ⟨21570186, 25390159⟩, ⟨(-299666), 1041946⟩, ⟨60127, 123407⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 517608952⟩, ⟨243803793, 269874765⟩, ⟨(-4899402), 8531759⟩, ⟨274774, 863444⟩, ⟨(-63165), 85312⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-483956915), 0⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3811010381, 4294967296⟩, ⟨(-241978458), (-241978457)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 62379760⟩, ⟨0, 65048038⟩, ⟨12658614, 19014026⟩, ⟨(-615710), 1280308⟩, ⟨6235, 146022⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4357347056⟩, ⟨0, 65048038⟩, ⟨12658614, 19014026⟩, ⟨(-615710), 1280308⟩, ⟨6235, 146022⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4326044742⟩, ⟨0, 32524019⟩, ⟨6161577, 9507013⟩, ⟨(-379848), 640154⟩, ⟨(-12253), 71469⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3811010381, 4326044742⟩, ⟨(-243729362), (-209454438)⟩, ⟨3634886, 9507013⟩, ⟨(-915474), 293011⟩, ⟨(-48320), 92870⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1740127022⟩, ⟨870063508, 870063513⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 705020981⟩, ⟨0, 705020982⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 705020981⟩, ⟨0, 705020982⟩, ⟨176255243, 176255246⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-705020981), 0⟩, ⟨(-705020982), 0⟩, ⟨(-176255246), (-176255243)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-352510491), 0⟩, ⟨(-352510491), 0⟩, ⟨(-88127623), (-88127621)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3956535214, 4294967296⟩, ⟨(-352510491), 0⟩, ⟨(-88127623), (-66717204)⟩, ⟨0, 7233097⟩, ⟨536064, 904138⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3510712826, 4326044742⟩, ⟨(-598790542), (-192949981)⟩, ⟨(-85416830), (-29688349)⟩, ⟨1557860, 12579483⟩, ⟨(-202244), 1022226⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨241978457, 241978458⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨241978457, 241978458⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4302467263, 4302467264⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar109 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified164
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar109 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 483956915⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4326044742⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified165
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(2817 / 25000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (2817 / 25000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(2817 / 25000), prawitzNormalCorrection
      ((254249 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
