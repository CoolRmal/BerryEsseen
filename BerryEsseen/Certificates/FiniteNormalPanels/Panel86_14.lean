...
namespace FiniteNormalPanel86_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (90531 / 800000)
def radius : Rat := (30177 / 800000)

def j0 : Jet := ⟨⟨486034605, 486034606⟩, ⟨162011535, 162011536⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1526922744, 1526922748⟩, ⟨508974248, 508974252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨542843031, 542843035⟩, ⟨361895354, 361895358⟩, ⟨60315892, 60315894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨135, 136⟩, ⟨90, 91⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94552), (-94550)⟩, ⟨90, 91⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11951), (-11950)⟩, ⟨(-7956), (-7954)⟩, ⟨(-1320), (-1316)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101105, 5101107⟩, ⟨(-7956), (-7954)⟩, ⟨(-1320), (-1316)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨644731, 644732⟩, ⟨428814, 428816⟩, ⟨70798, 70801⟩, ⟨(-224), (-220)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-142520846), (-142520844)⟩, ⟨428814, 428816⟩, ⟨70798, 70801⟩, ⟨(-224), (-220)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18013281), (-18013279)⟩, ⟨(-11954656), (-11954654)⟩, ⟨(-1956396), (-1956393)⟩, ⟨11958, 11962⟩, ⟨972, 975⟩⟩
...
def j19 : Jet := ⟨⟨1413642484, 1413642487⟩, ⟨(-11954656), (-11954654)⟩, ⟨(-1956396), (-1956393)⟩, ⟨11958, 11962⟩, ⟨972, 975⟩⟩
...
def j25 : Jet := ⟨⟨1494, 1495⟩, ⟨994, 996⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850683), (-850681)⟩, ⟨994, 996⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-107519), (-107517)⟩, ⟨(-71554), (-71552)⟩, ⟨(-11844), (-11840)⟩, ⟨25, 29⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35683875, 35683878⟩, ⟨(-71554), (-71552)⟩, ⟨(-11844), (-11840)⟩, ⟨25, 29⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4510102, 4510103⟩, ⟨2997691, 2997693⟩, ⟨493595, 493599⟩, ⟨(-2000), (-1997)⟩, ⟨(-165), (-162)⟩⟩
...
def j33 : Jet := ⟨⟨(-711317781), (-711317779)⟩, ⟨2997691, 2997693⟩, ⟨493595, 493599⟩, ⟨(-2000), (-1997)⟩, ⟨(-165), (-162)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-89903806), (-89903804)⟩, ⟨(-59556992), (-59556989)⟩, ⟨(-9674341), (-9674337)⟩, ⟨83434, 83437⟩, ⟨6741, 6744⟩⟩
...
def j36 : Jet := ⟨⟨4205063490, 4205063492⟩, ⟨(-59556992), (-59556989)⟩, ⟨(-9674341), (-9674337)⟩, ⟨83434, 83437⟩, ⟨6741, 6744⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨502570266, 502570270⟩, ⟨163273369, 163273374⟩, ⟨(-2112212), (-2112208)⟩, ⟨(-227592), (-227588)⟩, ⟨1762, 1765⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4386793233, 4386793236⟩, ⟨62130855, 62130861⟩, ⟨10972400, 10972407⟩, ⟨211300, 211307⟩, ⟨19966, 19975⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨513315164, 513315169⟩, ⟨174034299, 174034308⟩, ⟨1488457, 1488465⟩, ⟨178827, 178835⟩, ⟨3477, 3486⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-486034606), (-486034605)⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3808932690, 3808932691⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨61349118, 61349120⟩, ⟨41599592, 41599596⟩, ⟨7407745, 7407751⟩, ⟨163370, 163376⟩, ⟨15837, 15844⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4356316414, 4356316416⟩, ⟨41599592, 41599596⟩, ⟨7407745, 7407751⟩, ⟨163370, 163376⟩, ⟨15837, 15844⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4325533091, 4325533093⟩, ⟨20652817, 20652820⟩, ⟨3628394, 3628398⟩, ⟨63783, 63788⟩, ⟨6035, 6041⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3836039545, 3836039548⟩, ⟨(-144848851), (-144848844)⟩, ⟨2438740, 2438745⟩, ⟨(-80303), (-80297)⟩, ⟨2945, 2953⟩⟩
...
def j47 : Jet := ⟨⟨4185312028, 4185312038⟩, ⟨1395104009, 1395104019⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4078456380, 4078456400⟩, ⟨2718970918, 2718970946⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4078456380, 4078456400⟩, ⟨2718970918, 2718970946⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4078456400), (-4078456380)⟩, ⟨(-2718970946), (-2718970918)⟩, ⟨(-453161827), (-453161819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2039228200), (-2039228190)⟩, ⟨(-1359485473), (-1359485459)⟩, ⟨(-226580914), (-226580909)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2671524079, 2671524090⟩, ⟨(-845617194), (-845617181)⟩, ⟨(-7104651), (-7104642)⟩, ⟨30489954, 30489958⟩, ⟨(-2225344), (-2225342)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2386065202, 2386065215⟩, ⟨(-845358754), (-845358734)⟩, ⟨23690075, 23690091⟩, ⟨26941528, 26941542⟩, ⟨(-3002238), (-3002225)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨324023070, 648046141⟩, ⟨162011535, 162011536⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1017948496, 2035896996⟩, ⟨508974248, 508974252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨241263569, 965054282⟩, ⟨241263568, 482527144⟩, ⟨60315892, 60315894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨60, 242⟩, ⟨60, 121⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94627), (-94444)⟩, ⟨60, 121⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-21263), (-5305)⟩, ⟨(-10629), (-5277)⟩, ⟨(-1326), (-1308)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5091793, 5107752⟩, ⟨(-10629), (-5277)⟩, ⟨(-1326), (-1308)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨286024, 1147683⟩, ⟨283635, 573546⟩, ⟨70013, 71362⟩, ⟨(-299), (-146)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142879553), (-142017893)⟩, ⟨283635, 573546⟩, ⟨70013, 71362⟩, ⟨(-299), (-146)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-32104209), (-7977649)⟩, ⟨(-16036173), (-7848776)⟩, ⟨(-1986650), (-1913940)⟩, ⟨7847, 16065⟩, ⟨944, 995⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1399551556, 1423678117⟩, ⟨(-16036173), (-7848776)⟩, ⟨(-1986650), (-1913940)⟩, ⟨7847, 16065⟩, ⟨944, 995⟩⟩
...
def j72 : Jet := ⟨⟨663, 2659⟩, ⟨660, 1330⟩, ⟨162, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851514), (-849517)⟩, ⟨660, 1330⟩, ⟨162, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-191331), (-47720)⟩, ⟨(-95629), (-47421)⟩, ⟨(-11913), (-11742)⟩, ⟨17, 38⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35600063, 35743675⟩, ⟨(-95629), (-47421)⟩, ⟨(-11913), (-11742)⟩, ⟨17, 38⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1999781, 8031397⟩, ⟨1978293, 4013036⟩, ⟨486524, 498641⟩, ⟨(-2682), (-1315)⟩, ⟨(-168), (-158)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713828102), (-707796485)⟩, ⟨1978293, 4013036⟩, ⟨486524, 498641⟩, ⟨(-2682), (-1315)⟩, ⟨(-168), (-158)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-160393042), (-39759442)⟩, ⟨(-80085395), (-38857736)⟩, ⟨(-9886110), (-9376965)⟩, ⟨54507, 112305⟩, ⟨6492, 6922⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4134574254, 4255207854⟩, ⟨(-80085395), (-38857736)⟩, ⟨(-9886110), (-9376965)⟩, ⟨54507, 112305⟩, ⟨6492, 6922⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨331707159, 674850774⟩, ⟨158252124, 166852460⟩, ⟨(-2842075), (-1383739)⟩, ⟨(-233569), (-219195)⟩, ⟨1152, 2376⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4335098238, 4461582485⟩, ⟨39587279, 86419442⟩, ⟨9914516, 12341933⟩, ⟨60020, 388547⟩, ⟨12856, 29710⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨334806535, 701030343⟩, ⟨162788174, 186903925⟩, ⟨(-727985), 3899825⟩, ⟨70128, 306518⟩, ⟨(-8502), 17019⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-648046141), (-324023070)⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3646921155, 3970944226⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨26099247, 114423117⟩, ⟨25379724, 61013422⟩, ⟨5932363, 9406561⟩, ⟨(-52428), 439480⟩, ⟨1876, 35776⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4321066543, 4409390413⟩, ⟨25379724, 61013422⟩, ⟨5932363, 9406561⟩, ⟨(-52428), 439480⟩, ⟨1876, 35776⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307997154, 4351802802⟩, ⟨12524129, 30414442⟩, ⟨2821159, 4670851⟩, ⟨(-59112), 210875⟩, ⟨(-3087), 17328⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3657985002, 4023491920⟩, ⟨(-153521018), (-134383136)⟩, ⟨1248217, 3846046⟩, ⟨(-230844), 88550⟩, ⟨(-10810), 18251⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2790208018, 5580416048⟩, ⟨1395104009, 1395104019⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1812647279, 7250589149⟩, ⟨1812647278, 3625294594⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1812647279, 7250589149⟩, ⟨1812647278, 3625294594⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7250589149), (-1812647279)⟩, ⟨(-3625294594), (-1812647278)⟩, ⟨(-453161827), (-453161819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3625294575), (-906323639)⟩, ⟨(-1812647297), (-906323639)⟩, ⟨(-226580914), (-226580909)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1846633534, 3477883869⟩, ⟨(-1467805541), (-389676453)⟩, ⟨(-142360949), 212317093⟩, ⟨(-16163842), 71650033⟩, ⟨(-13160185), 5460572⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1572761165, 3258054528⟩, ⟨(-1499343666), (-389662343)⟩, ⟨(-120633559), 254477192⟩, ⟨(-24232624), 72168257⟩, ⟨(-15055945), 5976985⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨486034605, 486034606⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4325533091, 4325533093⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1742
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨324023070, 648046141⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307997154, 4351802802⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1743
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (11293541 / 268435456)

theorem envelope_integral : (∫ s in ((30177 / 400000) : ℝ)..(30177 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((30177 / 400000) : ℝ)..(30177 / 200000), prawitzNormalCorrection
