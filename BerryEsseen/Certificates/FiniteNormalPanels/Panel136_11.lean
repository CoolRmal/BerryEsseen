...
namespace FiniteNormalPanel136_11
...
def j2 : Jet := ⟨⟨2416350058, 2416350062⟩, ⟨483270010, 483270014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1359439362, 1359439367⟩, ⟨543775742, 543775750⟩, ⟨54377574, 54377576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨340, 341⟩, ⟨136, 137⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94347), (-94345)⟩, ⟨136, 137⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-29863), (-29861)⟩, ⟨(-11903), (-11900)⟩, ⟨(-1174), (-1171)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5083193, 5083196⟩, ⟨(-11903), (-11900)⟩, ⟨(-1174), (-1171)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1608927, 1608929⟩, ⟨639803, 639806⟩, ⟨62477, 62482⟩, ⟨(-300), (-296)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-141556650), (-141556647)⟩, ⟨639803, 639806⟩, ⟨62477, 62482⟩, ⟨(-300), (-296)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-44805390), (-44805388)⟩, ⟨(-17719647), (-17719644)⟩, ⟨(-1691438), (-1691433)⟩, ⟨15915, 15919⟩, ⟨748, 752⟩⟩
...
def j19 : Jet := ⟨⟨1386850375, 1386850378⟩, ⟨(-17719647), (-17719644)⟩, ⟨(-1691438), (-1691433)⟩, ⟨15915, 15919⟩, ⟨748, 752⟩⟩
...
def j25 : Jet := ⟨⟨3734, 3736⟩, ⟨1488, 1491⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848443), (-848440)⟩, ⟨1488, 1491⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-268549), (-268547)⟩, ⟨(-106950), (-106946)⟩, ⟨(-10508), (-10504)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35522845, 35522848⟩, ⟨(-106950), (-106946)⟩, ⟨(-10508), (-10504)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11243660, 11243662⟩, ⟨4463612, 4463615⟩, ⟨432879, 432883⟩, ⟨(-2675), (-2670)⟩, ⟨(-131), (-126)⟩⟩
...
def j33 : Jet := ⟨⟨(-704584223), (-704584220)⟩, ⟨4463612, 4463615⟩, ⟨432879, 432883⟩, ⟨(-2675), (-2670)⟩, ⟨(-131), (-126)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-223014395), (-223014392)⟩, ⟨(-87792941), (-87792936)⟩, ⟨(-8218435), (-8218431)⟩, ⟨110470, 110475⟩, ⟨5099, 5104⟩⟩
...
def j36 : Jet := ⟨⟨4071952901, 4071952904⟩, ⟨(-87792941), (-87792936)⟩, ⟨(-8218435), (-8218431)⟩, ⟨110470, 110475⟩, ⟨5099, 5104⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨780242491, 780242495⟩, ⟨146079417, 146079423⟩, ⟨(-2945420), (-2945415)⟩, ⟨(-181368), (-181363)⟩, ⟨2210, 2216⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4530195831, 4530195836⟩, ⟨97672836, 97672843⟩, ⟨11249168, 11249175⟩, ⟨316760, 316771⟩, ⟨21202, 21214⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨822975132, 822975138⟩, ⟨171823627, 171823637⟩, ⟨2258861, 2258871⟩, ⟨181863, 181875⟩, ⟨5115, 5128⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-769148113), (-769148112)⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3525819183, 3525819184⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨157693416, 157693420⟩, ⟨65847566, 65847572⟩, ⟨7739600, 7739606⟩, ⟨250428, 250436⟩, ⟨17698, 17709⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4452660712, 4452660716⟩, ⟨65847566, 65847572⟩, ⟨7739600, 7739606⟩, ⟨250428, 250436⟩, ⟨17698, 17709⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4373103261, 4373103264⟩, ⟨32335520, 32335524⟩, ⟨3681109, 3681113⟩, ⟨95757, 95763⟩, ⟨6433, 6441⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3589962461, 3589962466⟩, ⟨(-130083327), (-130083321)⟩, ⟨1863753, 1863758⟩, ⟨(-53236), (-53229)⟩, ⟨1850, 1859⟩⟩
...
def j47 : Jet := ⟨⟨6539858209, 6539858219⟩, ⟨1307971638, 1307971648⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9958107348, 9958107380⟩, ⟨3983242928, 3983242966⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9958107348, 9958107380⟩, ⟨3983242928, 3983242966⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9958107380), (-9958107348)⟩, ⟨(-3983242966), (-3983242928)⟩, ⟨(-398324298), (-398324291)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4979053690), (-4979053674)⟩, ⟨(-1991621483), (-1991621464)⟩, ⟨(-199162149), (-199162145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1347387675, 1347387693⟩, ⟨(-624797837), (-624797822)⟩, ⟨82382873, 82382881⟩, ⟨6581084, 6581088⟩, ⟨(-2673021), (-2673019)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1126218394, 1126218412⟩, ⟨(-563048167), (-563048149)⟩, ⟨88368167, 88368180⟩, ⟨2717831, 2717841⟩, ⟨(-2389506), (-2389495)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨615318489, 922977735⟩, ⟨153829622, 153829623⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1933080044, 2899620072⟩, ⟨483270010, 483270014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨870041189, 1957592686⟩, ⟨435020594, 652530898⟩, ⟨54377574, 54377576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨217, 491⟩, ⟨108, 164⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94470), (-94195)⟩, ⟨108, 164⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-43059), (-19081)⟩, ⟨(-14332), (-9465)⟩, ⟨(-1185), (-1160)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5069997, 5093976⟩, ⟨(-14332), (-9465)⟩, ⟨(-1185), (-1160)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1027040, 2321771⟩, ⟨506987, 772007⟩, ⟨61471, 63302⟩, ⟨(-363), (-233)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142138537), (-140843805)⟩, ⟨506987, 772007⟩, ⟨61471, 63302⟩, ⟨(-363), (-233)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-64784978), (-28531046)⟩, ⟨(-21492292), (-13913651)⟩, ⟨(-1735781), (-1637046)⟩, ⟨12478, 19346⟩, ⟨714, 777⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1366870787, 1403124720⟩, ⟨(-21492292), (-13913651)⟩, ⟨(-1735781), (-1637046)⟩, ⟨12478, 19346⟩, ⟨714, 777⟩⟩
...
def j72 : Jet := ⟨⟨2387, 5386⟩, ⟨1185, 1794⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849790), (-846790)⟩, ⟨1185, 1794⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-387324), (-171536)⟩, ⟨(-128868), (-84950)⟩, ⟨(-10610), (-10380)⟩, ⟨28, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35404070, 35619859⟩, ⟨(-128868), (-84950)⟩, ⟨(-10610), (-10380)⟩, ⟨28, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7171882, 16235089⟩, ⟨3527204, 5394489⟩, ⟨423827, 440269⟩, ⟨(-3239), (-2105)⟩, ⟨(-134), (-123)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708656001), (-699592793)⟩, ⟨3527204, 5394489⟩, ⟨423827, 440269⟩, ⟨(-3239), (-2105)⟩, ⟨(-134), (-123)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-322996594), (-141718086)⟩, ⟨(-106951019), (-68400301)⟩, ⟨(-8529017), (-7837129)⟩, ⟨86107, 134763⟩, ⟨4810, 5338⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3971970702, 4153249210⟩, ⟨(-106951019), (-68400301)⟩, ⟨(-8529017), (-7837129)⟩, ⟨86107, 134763⟩, ⟨4810, 5338⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨615201574, 947278134⟩, ⟨139290508, 151617431⟩, ⟨(-3590177), (-2302366)⟩, ⟨(-189695), (-171139)⟩, ⟨1725, 2702⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4441521117, 4644229643⟩, ⟨73147881, 125052558⟩, ⟨9585774, 13339781⟩, ⟨145203, 531434⟩, ⟨10450, 35992⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨636193617, 1024309823⟩, ⟨154520948, 191527821⟩, ⟨(-136817), 4975738⟩, ⟨22022, 371933⟩, ⟨(-8687), 21570⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-922977735), (-615318489)⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3371989561, 3679648807⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨94236414, 244288383⟩, ⟨45776944, 91355216⟩, ⟨5493972, 10914241⟩, ⟨(-5680), 621178⟩, ⟨(-2719), 49227⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4389203710, 4539255679⟩, ⟨45776944, 91355216⟩, ⟨5493972, 10914241⟩, ⟨(-5680), 621178⟩, ⟨(-2719), 49227⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4341829843, 4415422369⟩, ⟨22264062, 45184598⟩, ⟨2440851, 5341138⟩, ⟨(-58394), 294722⟩, ⟨(-7699), 24271⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3408781463, 3782846884⟩, ⟨(-140664303), (-116796835)⟩, ⟨297975, 3778525⟩, ⟨(-241329), 165077⟩, ⟨(-17153), 22886⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5231886562, 7847829858⟩, ⟨1307971638, 1307971648⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6373188690, 14339674609⟩, ⟨3186594338, 4779891556⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6373188690, 14339674609⟩, ⟨3186594338, 4779891556⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14339674609), (-6373188690)⟩, ⟨(-4779891556), (-3186594338)⟩, ⟨(-398324298), (-398324291)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7169837305), (-3186594345)⟩, ⟨(-2389945778), (-1593297169)⟩, ⟨(-199162149), (-199162145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨809034352, 2045223613⟩, ⟨(-1138070026), (-300126183)⟩, ⟨(-39170504), 279125248⟩, ⟨(-42495214), 42447846⟩, ⟨(-12376720), 6819832⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨642105308, 1801356621⟩, ⟨(-1069352639), (-260201566)⟩, ⟨(-26282194), 284915287⟩, ⟨(-47685963), 38727138⟩, ⟨(-12377534), 7718823⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4373103261, 4373103264⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2740
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4341829843, 4415422369⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2741
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (20723609 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((28653 / 200000) : ℝ)..(85959 / 400000), prawitzNormalCorrection
