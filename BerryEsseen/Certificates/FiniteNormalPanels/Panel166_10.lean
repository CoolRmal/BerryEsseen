...
namespace FiniteNormalPanel166_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38601 / 400000)
def radius : Rat := (12867 / 400000)

def j0 : Jet := ⟨⟨414475081, 414475082⟩, ⟨138158360, 138158361⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1302111869, 1302111873⟩, ⟨434037288, 434037292⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨394763266, 394763269⟩, ⟨263175510, 263175514⟩, ⟨43862584, 43862586⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-8694), (-8693)⟩, ⟨(-5791), (-5788)⟩, ⟨(-963), (-958)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104362, 5104364⟩, ⟨(-5791), (-5788)⟩, ⟨(-963), (-958)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨469157, 469158⟩, ⟨312238, 312241⟩, ⟨51684, 51687⟩, ⟨(-120), (-116)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142696420), (-142696418)⟩, ⟨312238, 312241⟩, ⟨51684, 51687⟩, ⟨(-120), (-116)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13115655), (-13115653)⟩, ⟨(-8715072), (-8715069)⟩, ⟨(-1433413), (-1433410)⟩, ⟨6342, 6347⟩, ⟨518, 521⟩⟩
...
def j19 : Jet := ⟨⟨1418540110, 1418540113⟩, ⟨(-8715072), (-8715069)⟩, ⟨(-1433413), (-1433410)⟩, ⟨6342, 6347⟩, ⟨518, 521⟩⟩
...
def j25 : Jet := ⟨⟨1086, 1088⟩, ⟨723, 725⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851091), (-851088)⟩, ⟨723, 725⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-78227), (-78226)⟩, ⟨(-52085), (-52083)⟩, ⟨(-8638), (-8634)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35713167, 35713169⟩, ⟨(-52085), (-52083)⟩, ⟨(-8638), (-8634)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3282503, 3282505⟩, ⟨2183547, 2183550⟩, ⟨360736, 360739⟩, ⟨(-1061), (-1058)⟩, ⟨(-90), (-86)⟩⟩
...
def j33 : Jet := ⟨⟨(-712545380), (-712545377)⟩, ⟨2183547, 2183550⟩, ⟨360736, 360739⟩, ⟨(-1061), (-1058)⟩, ⟨(-90), (-86)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-65492174), (-65492172)⟩, ⟨(-43460754), (-43460751)⟩, ⟨(-7109956), (-7109952)⟩, ⟨44305, 44308⟩, ⟨3609, 3614⟩⟩
...
def j36 : Jet := ⟨⟨4229475122, 4229475124⟩, ⟨(-43460754), (-43460751)⟩, ⟨(-7109956), (-7109952)⟩, ⟨44305, 44308⟩, ⟨3609, 3614⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨430060996, 430060999⟩, ⟨140711502, 140711507⟩, ⟨(-1315292), (-1315289)⟩, ⟨(-142935), (-142931)⟩, ⟨797, 800⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4361473594, 4361473597⟩, ⟨44817124, 44817129⟩, ⟨7792373, 7792380⟩, ⟨109718, 109726⟩, ⟨10028, 10039⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨436720363, 436720367⟩, ⟨147377977, 147377985⟩, ⟨912898, 912904⟩, ⟨107405, 107414⟩, ⟨1528, 1537⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-414475082), (-414475081)⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3880492214, 3880492215⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨44406548, 44406550⟩, ⟨29971340, 29971344⟩, ⟨5242794, 5242797⟩, ⟨84492, 84498⟩, ⟨7874, 7881⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4339373844, 4339373846⟩, ⟨29971340, 29971344⟩, ⟨5242794, 5242797⟩, ⟨84492, 84498⟩, ⟨7874, 7881⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317113473, 4317113475⟩, ⟨14908795, 14908798⟩, ⟨2582206, 2582209⟩, ⟨33111, 33116⟩, ⟨3029, 3035⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3900501229, 3900501233⟩, ⟨(-125400690), (-125400685)⟩, ⟨1853437, 1853442⟩, ⟨(-53149), (-53142)⟩, ⟨1670, 1678⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨56108570091, 56108570099⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value670

def j47 : Jet := ⟨⟨5414617278, 5414617293⟩, ⟨1804872421, 1804872436⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6826147499, 6826147538⟩, ⟨4550764986, 4550765038⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6826147499, 6826147538⟩, ⟨4550764986, 4550765038⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6826147538), (-6826147499)⟩, ⟨(-4550765038), (-4550764986)⟩, ⟨(-758460842), (-758460829)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3413073769), (-3413073749)⟩, ⟨(-2275382519), (-2275382493)⟩, ⟨(-379230421), (-379230414)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1940170346, 1940170366⟩, ⟨(-1027861083), (-1027861060)⟩, ⟨100959303, 100959318⟩, ⟨42675628, 42675634⟩, ⟨(-10109337), (-10109334)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1761977751, 1761977772⟩, ⟨(-990105823), (-990105796)⟩, ⟨122534657, 122534677⟩, ⟨35340842, 35340857⟩, ⟨(-10369826), (-10369812)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨276316720, 552633442⟩, ⟨138158360, 138158361⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨868074577, 1736149162⟩, ⟨434037288, 434037292⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨175450339, 701801366⟩, ⟨175450338, 350900684⟩, ⟨43862584, 43862586⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨43, 176⟩, ⟨43, 88⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94644), (-94510)⟩, ⟨43, 88⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-15465), (-3860)⟩, ⟨(-7732), (-3845)⟩, ⟨(-966), (-955)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097591, 5109197⟩, ⟨(-7732), (-3845)⟩, ⟨(-966), (-955)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨208237, 834848⟩, ⟨206973, 417267⟩, ⟨51269, 51982⟩, ⟨(-158), (-77)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142957340), (-142330728)⟩, ⟨206973, 417267⟩, ⟨51269, 51982⟩, ⟨(-158), (-77)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-23359353), (-5814240)⟩, ⟨(-11671223), (-5746058)⟩, ⟨(-1449412), (-1410975)⟩, ⟨4181, 8506⟩, ⟨508, 528⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408296412, 1425841526⟩, ⟨(-11671223), (-5746058)⟩, ⟨(-1449412), (-1410975)⟩, ⟨4181, 8506⟩, ⟨508, 528⟩⟩
...
def j72 : Jet := ⟨⟨482, 1934⟩, ⟨480, 967⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851695), (-850242)⟩, ⟨480, 967⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-139168), (-34732)⟩, ⟨(-69565), (-34573)⟩, ⟨(-8675), (-8583)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35652226, 35756663⟩, ⟨(-69565), (-34573)⟩, ⟨(-8675), (-8583)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1456401, 5842670⟩, ⟨1445034, 2919923⟩, ⟨356998, 363405⟩, ⟨(-1420), (-699)⟩, ⟨(-90), (-84)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714371482), (-709985212)⟩, ⟨1445034, 2919923⟩, ⟨356998, 363405⟩, ⟨(-1420), (-699)⟩, ⟨(-90), (-84)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-116728918), (-29003048)⟩, ⟨(-58305430), (-28525930)⟩, ⟨(-7221946), (-6952822)⟩, ⟨29107, 59483⟩, ⟨3513, 3681⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4178238378, 4265964248⟩, ⟨(-58305430), (-28525930)⟩, ⟨(-7221946), (-6952822)⟩, ⟨29107, 59483⟩, ⟨3513, 3681⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨284636931, 576366105⟩, ⟨137600621, 142930167⟩, ⟨(-1765355), (-865858)⟩, ⟨(-145629), (-139150)⟩, ⟨524, 1074⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4324167527, 4414957311⟩, ⟨28915127, 61608737⟩, ⟨7241034, 8490831⟩, ⟨33984, 194853⟩, ⟨7358, 13562⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨286572094, 592468249⟩, ⟨140452396, 155190886⟩, ⟨(-408424), 2317937⟩, ⟨59216, 162787⟩, ⟨(-3477), 7015⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-552633442), (-276316720)⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3742333854, 4018650576⟩, ⟨(-138158361), (-138158360)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19120882, 81727893⟩, ⟨18742744, 42815542⟩, ⟨4480341, 6247039⟩, ⟨(-21614), 212422⟩, ⟨2691, 14953⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314088178, 4376695189⟩, ⟨18742744, 42815542⟩, ⟨4480341, 6247039⟩, ⟨(-21614), 212422⟩, ⟨2691, 14953⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304517120, 4335638673⟩, ⟨9283461, 21360277⟩, ⟨2166538, 3106580⟩, ⟨(-26200), 101304⟩, ⟨(-282), 7046⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3750654902, 4056705360⟩, ⟨(-131377700), (-118479489)⟩, ⟨1200662, 2608094⟩, ⟨(-124446), 25095⟩, ⟨(-3523), 7436⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3609744843, 7219489715⟩, ⟨1804872421, 1804872436⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3033843317, 12135373370⟩, ⟨3033843316, 6067686710⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3033843317, 12135373370⟩, ⟨3033843316, 6067686710⟩, ⟨758460829, 758460842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12135373370), (-3033843317)⟩, ⟨(-6067686710), (-3033843316)⟩, ⟨(-758460842), (-758460829)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6067686685), (-1516921658)⟩, ⟨(-3033843355), (-1516921658)⟩, ⟨(-379230421), (-379230414)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1045714663, 3016985323⟩, ⟨(-2131113055), (-369331617)⟩, ⟨(-201167784), 660346073⟩, ⟨(-133742810), 172812907⟩, ⟨(-59670649), 32499237⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨913188519, 2849619028⟩, ⟨(-2105176065), (-351371983)⟩, ⟨(-179527482), 690733727⟩, ⟨(-147904159), 169294021⟩, ⟨(-61783656), 35255344⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨414475081, 414475082⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317113473, 4317113475⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar670 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3362
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar670 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨276316720, 552633442⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304517120, 4335638673⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3363
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((12867 / 200000) : ℝ)..(12867 / 100000), prawitzNormalCorrection
      ((37463 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
