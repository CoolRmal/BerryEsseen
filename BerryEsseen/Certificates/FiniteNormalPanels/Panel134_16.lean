...
namespace FiniteNormalPanel134_16
...
def j2 : Jet := ⟨⟨1394303049, 1394303053⟩, ⟨464767682, 464767686⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨452641628, 452641632⟩, ⟨301761084, 301761090⟩, ⟨50293514, 50293515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨113, 114⟩, ⟨75, 76⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94574), (-94572)⟩, ⟨75, 76⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9968), (-9966)⟩, ⟨(-6638), (-6635)⟩, ⟨(-1102), (-1099)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103088, 5103091⟩, ⟨(-6638), (-6635)⟩, ⟨(-1102), (-1099)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨537808, 537809⟩, ⟨357839, 357841⟩, ⟨59172, 59176⟩, ⟨(-156), (-153)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-142627769), (-142627767)⟩, ⟨357839, 357841⟩, ⟨59172, 59176⟩, ⟨(-156), (-153)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15031376), (-15031375)⟩, ⟨(-9983206), (-9983203)⟩, ⟨(-1638776), (-1638773)⟩, ⟨8330, 8333⟩, ⟨679, 682⟩⟩
...
def j19 : Jet := ⟨⟨1416624389, 1416624391⟩, ⟨(-9983206), (-9983203)⟩, ⟨(-1638776), (-1638773)⟩, ⟨8330, 8333⟩, ⟨679, 682⟩⟩
...
def j25 : Jet := ⟨⟨1246, 1247⟩, ⟨829, 831⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850931), (-850929)⟩, ⟨829, 831⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-89679), (-89678)⟩, ⟨(-59699), (-59697)⟩, ⟨(-9893), (-9890)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35701715, 35701717⟩, ⟨(-59699), (-59697)⟩, ⟨(-9893), (-9890)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3762562, 3762563⟩, ⟨2502082, 2502085⟩, ⟨412824, 412827⟩, ⟨(-1395), (-1390)⟩, ⟨(-116), (-112)⟩⟩
...
def j33 : Jet := ⟨⟨(-712065321), (-712065319)⟩, ⟨2502082, 2502085⟩, ⟨412824, 412827⟩, ⟨(-1395), (-1390)⟩, ⟨(-116), (-112)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-75043740), (-75043739)⟩, ⟨(-49765470), (-49765467)⟩, ⟨(-8118893), (-8118890)⟩, ⟨58155, 58159⟩, ⟨4722, 4727⟩⟩
...
def j36 : Jet := ⟨⟨4219923556, 4219923557⟩, ⟨(-49765470), (-49765467)⟩, ⟨(-8118893), (-8118890)⟩, ⟨58155, 58159⟩, ⟨4722, 4727⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨459887949, 459887952⟩, ⟨150055069, 150055074⟩, ⟨(-1612312), (-1612308)⟩, ⟨(-174632), (-174629)⟩, ⟨1121, 1124⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4371345552, 4371345554⟩, ⟨51551183, 51551188⟩, ⟨9018157, 9018163⟩, ⟨145284, 145292⟩, ⟨13454, 13465⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨468066227, 468066231⟩, ⟨158243422, 158243430⟩, ⟨1125708, 1125716⟩, ⟨133536, 133544⟩, ⟨2172, 2182⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-443820446), (-443820445)⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3851146850, 3851146851⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨51009932, 51009934⟩, ⟨34490786, 34490790⟩, ⟨6075665, 6075671⟩, ⟨112054, 112060⟩, ⟨10605, 10614⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4345977228, 4345977230⟩, ⟨34490786, 34490790⟩, ⟨6075665, 6075671⟩, ⟨112054, 112060⟩, ⟨10605, 10614⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320396979, 4320396981⟩, ⟨17143887, 17143890⟩, ⟨2985937, 2985941⟩, ⟨43848, 43853⟩, ⟨4064, 4071⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3873948756, 3873948760⟩, ⟨(-133443752), (-133443746)⟩, ⟨2086863, 2086868⟩, ⟨(-63535), (-63528)⟩, ⟨2133, 2141⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨40316033955, 40316033962⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value561

def j47 : Jet := ⟨⟨4166057363, 4166057374⟩, ⟨1388685784, 1388685795⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4041016556, 4041016578⟩, ⟨2694011030, 2694011060⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4041016556, 4041016578⟩, ⟨2694011030, 2694011060⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4041016578), (-4041016556)⟩, ⟨(-2694011060), (-2694011030)⟩, ⟨(-449001845), (-449001837)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2020508289), (-2020508278)⟩, ⟨(-1347005530), (-1347005515)⟩, ⟨(-224500923), (-224500918)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2683193513, 2683193525⟩, ⟨(-841514328), (-841514314)⟩, ⟨(-8292779), (-8292770)⟩, ⟨30191295, 30191298⟩, ⟨(-2150446), (-2150445)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2420170738, 2420170752⟩, ⟨(-842390303), (-842390283)⟩, ⟨19969529, 19969545⟩, ⟨27040842, 27040855⟩, ⟨(-2867936), (-2867924)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨295880297, 591760595⟩, ⟨147940148, 147940149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨929535367, 1859070739⟩, ⟨464767682, 464767686⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨201174057, 804696236⟩, ⟨201174056, 402348120⟩, ⟨50293514, 50293515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨50, 202⟩, ⟨50, 101⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94637), (-94484)⟩, ⟨50, 101⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-17731), (-4425)⟩, ⟨(-8864), (-4406)⟩, ⟨(-1107), (-1093)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095325, 5108632⟩, ⟨(-8864), (-4406)⟩, ⟨(-1107), (-1093)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨238662, 957143⟩, ⟨237001, 478366⟩, ⟨58626, 59565⟩, ⟨(-208), (-101)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142926915), (-142208433)⟩, ⟨237001, 478366⟩, ⟨58626, 59565⟩, ⟨(-208), (-101)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-26778493), (-6660969)⟩, ⟨(-13378146), (-6571343)⟩, ⟨(-1659809), (-1609269)⟩, ⟨5482, 11178⟩, ⟨663, 694⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1404877272, 1424994797⟩, ⟨(-13378146), (-6571343)⟩, ⟨(-1659809), (-1609269)⟩, ⟨5482, 11178⟩, ⟨663, 694⟩⟩
...
def j72 : Jet := ⟨⟨553, 2217⟩, ⟨550, 1109⟩, ⟨135, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851624), (-849959)⟩, ⟨550, 1109⟩, ⟨135, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-159559), (-39811)⟩, ⟨(-79755), (-39603)⟩, ⟨(-9942), (-9821)⟩, ⟨11, 27⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35631835, 35751584⟩, ⟨(-79755), (-39603)⟩, ⟨(-9942), (-9821)⟩, ⟨11, 27⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1668976, 6698344⟩, ⟨1654033, 3347318⟩, ⟨407909, 416333⟩, ⟨(-1866), (-917)⟩, ⟨(-118), (-111)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714158907), (-709129538)⟩, ⟨1654033, 3347318⟩, ⟨407909, 416333⟩, ⟨(-1866), (-917)⟩, ⟨(-118), (-111)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-133803344), (-33215262)⟩, ⟨(-66824199), (-32588115)⟩, ⟨(-8266130), (-7912237)⟩, ⟨38124, 78157⟩, ⟨4578, 4829⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4161163952, 4261752034⟩, ⟨(-66824199), (-32588115)⟩, ⟨(-8266130), (-7912237)⟩, ⟨38124, 78157⟩, ⟨4578, 4829⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨304049605, 616807056⟩, ⟨146234089, 152779567⟩, ⟨(-2166126), (-1059383)⟩, ⟨(-178426), (-169303)⟩, ⟨736, 1511⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4328441431, 4433073123⟩, ⟨33098064, 71190794⟩, ⟨8289138, 9949531⟩, ⟨43531, 261545⟩, ⟨9391, 18902⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨306419308, 636640653⟩, ⟨149716888, 167916059⟩, ⟨(-522059), 2893612⟩, ⟨65238, 212699⟩, ⟨(-5089), 10231⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-591760595), (-295880297)⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3703206701, 3999086999⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21861119, 94368896⟩, ⟨21362744, 49780212⟩, ⟨5064162, 7422685⟩, ⟨(-31514), 289316⟩, ⟨2686, 21616⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316828415, 4389336192⟩, ⟨21362744, 49780212⟩, ⟨5064162, 7422685⟩, ⟨(-31514), 289316⟩, ⟨2686, 21616⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305883981, 4341895370⟩, ⟨10565925, 24827003⟩, ⟨2433732, 3688971⟩, ⟨(-36988), 138320⟩, ⟨(-1039), 10307⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3712619285, 4042782198⟩, ⟨(-140446436), (-125199502)⟩, ⟨1243245, 3070895⟩, ⟨(-161507), 44963⟩, ⟨(-5733), 10872⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2777371578, 5554743169⟩, ⟨1388685784, 1388685795⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1796007361, 7184029481⟩, ⟨1796007354, 3592014748⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1796007361, 7184029481⟩, ⟨1796007354, 3592014748⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7184029481), (-1796007361)⟩, ⟨(-3592014748), (-1796007354)⟩, ⟨(-449001845), (-449001837)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3592014741), (-898003680)⟩, ⟨(-1796007374), (-898003677)⟩, ⟨(-224500923), (-224500918)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1860997875, 3484627551⟩, ⟨(-1457151207), (-389102598)⟩, ⟨(-141466577), 207389572⟩, ⟨(-15348617), 70496354⟩, ⟨(-12789986), 5301844⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1608668034, 3280022701⟩, ⟨(-1485540644), (-390593385)⟩, ⟨(-121279024), 245353090⟩, ⟨(-22401987), 70906901⟩, ⟨(-14465308), 5704343⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320396979, 4320396981⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar561 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2704
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar561 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305883981, 4341895370⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2705
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((6889 / 100000) : ℝ)..(6889 / 50000), prawitzNormalCorrection
      ((250873 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
