...
namespace FiniteNormalPanel87_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (4533 / 40000)
def radius : Rat := (1511 / 40000)

def j0 : Jet := ⟨⟨486727168, 486727169⟩, ⟨162242389, 162242390⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1529098495, 1529098499⟩, ⟨509699497, 509699501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨544391155, 544391158⟩, ⟨362927434, 362927440⟩, ⟨60487905, 60487907⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-11985), (-11984)⟩, ⟨(-7979), (-7977)⟩, ⟨(-1324), (-1320)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101071, 5101073⟩, ⟨(-7979), (-7977)⟩, ⟨(-1324), (-1320)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨646565, 646566⟩, ⟨430031, 430033⟩, ⟨70997, 71000⟩, ⟨(-225), (-222)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-142519012), (-142519010)⟩, ⟨430031, 430033⟩, ⟨70997, 71000⟩, ⟨(-225), (-222)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18064420), (-18064418)⟩, ⟨(-11988441), (-11988437)⟩, ⟨(-1961823), (-1961818)⟩, ⟨12026, 12029⟩, ⟨976, 980⟩⟩
...
def j19 : Jet := ⟨⟨1413591345, 1413591348⟩, ⟨(-11988441), (-11988437)⟩, ⟨(-1961823), (-1961818)⟩, ⟨12026, 12029⟩, ⟨976, 980⟩⟩
...
def j25 : Jet := ⟨⟨1498, 1499⟩, ⟨996, 999⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850679), (-850677)⟩, ⟨996, 999⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-107825), (-107824)⟩, ⟨(-71757), (-71755)⟩, ⟨(-11877), (-11873)⟩, ⟨26, 30⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35683569, 35683571⟩, ⟨(-71757), (-71755)⟩, ⟨(-11877), (-11873)⟩, ⟨26, 30⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4522926, 4522927⟩, ⟨3006187, 3006190⟩, ⟨494977, 494981⟩, ⟨(-2012), (-2009)⟩, ⟨(-166), (-163)⟩⟩
...
def j33 : Jet := ⟨⟨(-711304957), (-711304955)⟩, ⟨3006187, 3006190⟩, ⟨494977, 494981⟩, ⟨(-2012), (-2009)⟩, ⟨(-166), (-163)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-90158575), (-90158573)⟩, ⟨(-59724680), (-59724677)⟩, ⟨(-9700858), (-9700854)⟩, ⟨83906, 83911⟩, ⟨6777, 6783⟩⟩
...
def j36 : Jet := ⟨⟨4204808721, 4204808723⟩, ⟨(-59724680), (-59724677)⟩, ⟨(-9700858), (-9700854)⟩, ⟨83906, 83911⟩, ⟨6777, 6783⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨503268185, 503268188⟩, ⟨163487924, 163487929⟩, ⟨(-2121164), (-2121159)⟩, ⟨(-228536), (-228533)⟩, ⟨1774, 1777⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4387059029, 4387059032⟩, ⟨62313341, 62313346⟩, ⟨11006412, 11006419⟩, ⟨212546, 212555⟩, ⟨20088, 20099⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨514059149, 514059153⟩, ⟨174295038, 174295046⟩, ⟨1495001, 1495009⟩, ⟨179652, 179660⟩, ⟨3503, 3513⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-486727169), (-486727168)⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3808240127, 3808240128⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨61527082, 61527084⟩, ⟨41722300, 41722304⟩, ⟨7430974, 7430979⟩, ⟨164340, 164348⟩, ⟨15938, 15945⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4356494378, 4356494380⟩, ⟨41722300, 41722304⟩, ⟨7430974, 7430979⟩, ⟨164340, 164348⟩, ⟨15938, 15945⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4325621444, 4325621446⟩, ⟨20713314, 20713317⟩, ⟨3639563, 3639567⟩, ⟨64159, 64165⟩, ⟨6073, 6079⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3835420393, 3835420397⟩, ⟨(-145034374), (-145034368)⟩, ⟨2444663, 2444669⟩, ⟨(-80597), (-80590)⟩, ⟨2960, 2968⟩⟩
...
def j47 : Jet := ⟨⟨4012695587, 4012695596⟩, ⟨1337565192, 1337565202⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3748975199, 3748975216⟩, ⟨2499316792, 2499316818⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3748975199, 3748975216⟩, ⟨2499316792, 2499316818⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3748975216), (-3748975199)⟩, ⟨(-2499316818), (-2499316792)⟩, ⟨(-416552804), (-416552797)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1874487608), (-1874487599)⟩, ⟨(-1249658409), (-1249658396)⟩, ⟨(-208276402), (-208276398)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2775985400, 2775985412⟩, ⟨(-807697306), (-807697293)⟩, ⟨(-17112914), (-17112906)⟩, ⟨27771562, 27771564⟩, ⟨(-1605167), (-1605165)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2478964397, 2478964411⟩, ⟨(-815017157), (-815017138)⟩, ⟨13572859, 13572875⟩, ⟨24866145, 24866156⟩, ⟨(-2363896), (-2363883)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨324484779, 648969559⟩, ⟨162242389, 162242390⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1019398997, 2038798000⟩, ⟨509699497, 509699501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨241951624, 967806505⟩, ⟨241951622, 483903254⟩, ⟨60487905, 60487907⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-21323), (-5320)⟩, ⟨(-10659), (-5292)⟩, ⟨(-1330), (-1312)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5091733, 5107737⟩, ⟨(-10659), (-5292)⟩, ⟨(-1330), (-1312)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨286836, 1150952⟩, ⟨284434, 575178⟩, ⟨70208, 71564⟩, ⟨(-301), (-146)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142878741), (-142014624)⟩, ⟨284434, 575178⟩, ⟨70208, 71564⟩, ⟨(-301), (-146)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-32195583), (-8000216)⟩, ⟨(-16081769), (-7870608)⟩, ⟨(-1992246), (-1919124)⟩, ⟨7892, 16156⟩, ⟨949, 1000⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1399460182, 1423655550⟩, ⟨(-16081769), (-7870608)⟩, ⟨(-1992246), (-1919124)⟩, ⟨7892, 16156⟩, ⟨949, 1000⟩⟩
...
def j72 : Jet := ⟨⟨665, 2666⟩, ⟨662, 1333⟩, ⟨163, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851512), (-849510)⟩, ⟨662, 1333⟩, ⟨163, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-191876), (-47856)⟩, ⟨(-95901), (-47555)⟩, ⟨(-11947), (-11775)⟩, ⟨17, 38⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35599518, 35743539⟩, ⟨(-95901), (-47555)⟩, ⟨(-11947), (-11775)⟩, ⟨17, 38⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2005454, 8054271⟩, ⟨1983844, 4024458⟩, ⟨487865, 500051⟩, ⟨(-2698), (-1323)⟩, ⟨(-169), (-159)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713822429), (-707773611)⟩, ⟨1983844, 4024458⟩, ⟨487865, 500051⟩, ⟨(-2698), (-1323)⟩, ⟨(-169), (-159)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-160849186), (-39871543)⟩, ⟨(-80312836), (-38964690)⟩, ⟨(-9913835), (-9401780)⟩, ⟨54814, 112945⟩, ⟨6527, 6961⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4134118110, 4255095753⟩, ⟨(-80312836), (-38964690)⟩, ⟨(-9913835), (-9401780)⟩, ⟨54814, 112945⟩, ⟨6527, 6961⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨332158130, 675801674⟩, ⟨158445134, 167082352⟩, ⟨(-2854192), (-1389531)⟩, ⟨(-234555), (-220079)⟩, ⟨1161, 2393⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4335212447, 4462074761⟩, ⟨39698333, 86683997⟩, ⟨9942324, 12384290⟩, ⟨60317, 390982⟩, ⟨12917, 29925⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨335270552, 702095589⟩, ⟨162999946, 187222646⟩, ⟨(-731832), 3918257⟩, ⟨70157, 308309⟩, ⟨(-8570), 17156⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-648969559), (-324484779)⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3645997737, 3970482517⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨26171641, 114771123⟩, ⟨25447960, 61210336⟩, ⟨5946807, 9442285⟩, ⟨(-52852), 442404⟩, ⟨1854, 36065⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4321138937, 4409738419⟩, ⟨25447960, 61210336⟩, ⟨5946807, 9442285⟩, ⟨(-52852), 442404⟩, ⟨1854, 36065⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308033242, 4351974529⟩, ⟨12557306, 30512345⟩, ⟨2827490, 4688523⟩, ⟨(-59554), 212291⟩, ⟨(-3132), 17473⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3657089418, 4023182854⟩, ⟨(-153735942), (-134528817)⟩, ⟨1247652, 3859954⟩, ⟨(-232164), 89445⟩, ⟨(-10916), 18403⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2675130394, 5350260798⟩, ⟨1337565192, 1337565202⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1666211202, 6664844837⟩, ⟨1666211196, 3332422426⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1666211202, 6664844837⟩, ⟨1666211196, 3332422426⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6664844837), (-1666211202)⟩, ⟨(-3332422426), (-1666211196)⟩, ⟨(-416552804), (-416552797)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3332422419), (-833105601)⟩, ⟨(-1666211213), (-833105598)⟩, ⟨(-208276402), (-208276398)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1976947289, 3537681001⟩, ⟨(-1372425760), (-383473432)⟩, ⟨(-134361568), 170344519⟩, ⟨(-9630886), 61743781⟩, ⟨(-10118568), 4191871⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1683335986, 3313817444⟩, ⟨(-1412208311), (-388443705)⟩, ⟨(-113273597), 211869742⟩, ⟨(-16543483), 62608328⟩, ⟨(-11846679), 4513782⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨486727168, 486727169⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4325621444, 4325621446⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1764
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨324484779, 648969559⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308033242, 4351974529⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1765
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (187695775 / 4294967296)

theorem envelope_integral : (∫ s in ((1511 / 20000) : ℝ)..(1511 / 10000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((1511 / 20000) : ℝ)..(1511 / 10000), prawitzNormalCorrection
