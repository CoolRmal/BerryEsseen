...
namespace FiniteNormalPanel132_12
...
def j2 : Jet := ⟨⟨455406885, 455406890⟩, ⟨455406885, 455406890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨48288011, 48288013⟩, ⟨96576022, 96576026⟩, ⟨48288011, 48288013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨12, 13⟩, ⟨24, 25⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94675), (-94673)⟩, ⟨24, 25⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1065), (-1064)⟩, ⟨(-2129), (-2127)⟩, ⟨(-1065), (-1062)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111991, 5111993⟩, ⟨(-2129), (-2127)⟩, ⟨(-1065), (-1062)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨57473, 57474⟩, ⟨114923, 114925⟩, ⟨57413, 57416⟩, ⟨(-48), (-45)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-143108104), (-143108102)⟩, ⟨114923, 114925⟩, ⟨57413, 57416⟩, ⟨(-48), (-45)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1608955), (-1608954)⟩, ⟨(-3216617), (-3216615)⟩, ⟨(-1605726), (-1605723)⟩, ⟨2581, 2585⟩, ⟨642, 645⟩⟩
...
def j19 : Jet := ⟨⟨1430046810, 1430046812⟩, ⟨(-3216617), (-3216615)⟩, ⟨(-1605726), (-1605723)⟩, ⟨2581, 2585⟩, ⟨642, 645⟩⟩
...
def j25 : Jet := ⟨⟨133, 134⟩, ⟨265, 267⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852044), (-852042)⟩, ⟨265, 267⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9580), (-9579)⟩, ⟨(-19157), (-19154)⟩, ⟨(-9574), (-9570)⟩, ⟨3, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781814, 35781816⟩, ⟨(-19157), (-19154)⟩, ⟨(-9574), (-9570)⟩, ⟨3, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨402292, 402293⟩, ⟨804368, 804370⟩, ⟨401753, 401756⟩, ⟨(-432), (-429)⟩, ⟨(-109), (-105)⟩⟩
...
def j33 : Jet := ⟨⟨(-715425591), (-715425589)⟩, ⟨804368, 804370⟩, ⟨401753, 401756⟩, ⟨(-432), (-429)⟩, ⟨(-109), (-105)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8043480), (-8043478)⟩, ⟨(-16077916), (-16077913)⟩, ⟨(-8020878), (-8020874)⟩, ⟨18071, 18074⟩, ⟨4504, 4507⟩⟩
...
def j36 : Jet := ⟨⟨4286923816, 4286923818⟩, ⟨(-16077916), (-16077913)⟩, ⟨(-8020878), (-8020874)⟩, ⟨18071, 18074⟩, ⟨4504, 4507⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨151631693, 151631696⟩, ⟨151290626, 151290630⟩, ⟨(-511327), (-511325)⟩, ⟨(-169987), (-169984)⟩, ⟨341, 344⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303025865, 4303025868⟩, ⟨16138302, 16138307⟩, ⟨8111526, 8111533⟩, ⟨42473, 42480⟩, ⟨10742, 10751⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨151916196, 151916200⟩, ⟨152144243, 152144249⟩, ⟨342559, 342564⟩, ⟨115000, 115007⟩, ⟨611, 619⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-144960515), (-144960514)⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4150006781, 4150006782⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5373389, 5373390⟩, ⟨10762910, 10762912⟩, ⟨5413765, 5413769⟩, ⟨32402, 32406⟩, ⟨8215, 8220⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300340685, 4300340686⟩, ⟨10762910, 10762912⟩, ⟨5413765, 5413769⟩, ⟨32402, 32406⟩, ⟨8215, 8220⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297653150, 4297653152⟩, ⟨5378091, 5378093⟩, ⟨2701825, 2701828⟩, ⟨12808, 12812⟩, ⟨3238, 3243⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4152601984, 4152601988⟩, ⟨(-139854593), (-139854588)⟩, ⟨2429117, 2429121⟩, ⟨(-78816), (-78809)⟩, ⟨2695, 2702⟩⟩
...
def j47 : Jet := ⟨⟨1491237882, 1491237893⟩, ⟨1491237882, 1491237893⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨517766555, 517766563⟩, ⟨1035533110, 1035533126⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨517766555, 517766563⟩, ⟨1035533110, 1035533126⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-517766563), (-517766555)⟩, ⟨(-1035533126), (-1035533110)⟩, ⟨(-517766563), (-517766555)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-258883282), (-258883277)⟩, ⟨(-517766563), (-517766555)⟩, ⟨(-258883282), (-258883277)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4043731805, 4043731811⟩, ⟨(-487479643), (-487479634)⟩, ⟨(-214356520), (-214356512)⟩, ⟨28202564, 28202567⟩, ⟨5610303, 5610305⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3909694197, 3909694208⟩, ⟨(-602994907), (-602994891)⟩, ⟨(-189090696), (-189090681)⟩, ⟨33897790, 33897804⟩, ⟨4396239, 4396253⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 289921030⟩, ⟨144960514, 144960515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 910813779⟩, ⟨455406885, 455406890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 193152051⟩, ⟨0, 193152052⟩, ⟨48288011, 48288013⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 49⟩, ⟨0, 49⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94637)⟩, ⟨0, 49⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4259), 0⟩, ⟨(-4259), 3⟩, ⟨(-1065), (-1059)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108797, 5113057⟩, ⟨(-4259), 3⟩, ⟨(-1065), (-1059)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 229943⟩, ⟨(-192), 229944⟩, ⟨57197, 57487⟩, ⟨(-96), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142935633)⟩, ⟨(-192), 229944⟩, ⟨57197, 57487⟩, ⟨(-96), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6438402), 0⟩, ⟨(-6438411), 10341⟩, ⟨(-1609610), (-1594088)⟩, ⟨(-8), 5173⟩, ⟨637, 648⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425217363, 1431655766⟩, ⟨(-6438411), 10341⟩, ⟨(-1609610), (-1594088)⟩, ⟨(-8), 5173⟩, ⟨637, 648⟩⟩
...
def j70 : Jet := ⟨⟨(-5), 0⟩, ⟨(-5), 0⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11830, 11836⟩, ⟨(-5), 0⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 533⟩, ⟨(-1), 533⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851643)⟩, ⟨(-1), 533⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-38324), 0⟩, ⟨(-38325), 24⟩, ⟨(-9582), (-9543)⟩, ⟨(-2), 13⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35753070, 35791395⟩, ⟨(-38325), 24⟩, ⟨(-9582), (-9543)⟩, ⟨(-2), 13⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1609601⟩, ⟨(-1724), 1609603⟩, ⟨399814, 402403⟩, ⟨(-863), 2⟩, ⟨(-110), (-105)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714218281)⟩, ⟨(-1724), 1609603⟩, ⟨399814, 402403⟩, ⟨(-863), 2⟩, ⟨(-110), (-105)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-32192009), 0⟩, ⟨(-32192087), 72387⟩, ⟨(-8048081), (-7939421)⟩, ⟨(-59), 36195⟩, ⟨4451, 4526⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4262775287, 4294967296⟩, ⟨(-32192087), 72387⟩, ⟨(-8048081), (-7939421)⟩, ⟨(-59), 36195⟩, ⟨4451, 4526⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 303604594⟩, ⟨149754249, 151804490⟩, ⟨(-1024025), 1097⟩, ⟨(-170674), (-167927)⟩, ⟨(-1), 687⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4327402416⟩, ⟨(-73485), 32680147⟩, ⟨7938870, 8416896⟩, ⟨(-37027), 125326⟩, ⟨9560, 12355⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 305897383⟩, ⟨149749054, 155261011⟩, ⟨(-1034357), 1751156⟩, ⟨94434, 138444⟩, ⟨(-4617), 6003⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-289921030), 0⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4005046266, 4294967296⟩, ⟨(-144960515), (-144960514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 21786711⟩, ⟨0, 22116088⟩, ⟨5073835, 5862056⟩, ⟨(-74784), 146330⟩, ⟨5504, 11580⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4316754007⟩, ⟨0, 22116088⟩, ⟨5073835, 5862056⟩, ⟨(-74784), 146330⟩, ⟨5504, 11580⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305846872⟩, ⟨0, 11058044⟩, ⟨2516307, 2931028⟩, ⟨(-44939), 73165⟩, ⟨1558, 5169⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4005046266, 4305846872⟩, ⟨(-145327715), (-133902470)⟩, ⟨1973226, 2931028⟩, ⟨(-143865), (-11763)⟩, ⟨(-1018), 6686⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2982475786⟩, ⟨1491237882, 1491237893⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2071066251⟩, ⟨0, 2071066252⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2071066251⟩, ⟨0, 2071066252⟩, ⟨517766555, 517766563⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2071066251), 0⟩, ⟨(-2071066252), 0⟩, ⟨(-517766563), (-517766555)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1035533126), 0⟩, ⟨(-1035533126), 0⟩, ⟨(-258883282), (-258883277)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3374813611, 4294967296⟩, ⟨(-1035533126), 0⟩, ⟨(-258883282), (-78584621)⟩, ⟨0, 62417755⟩, ⟨(-1393909), 7802220⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3147005255, 4305846872⟩, ⟨(-1183483949), (-105215208)⟩, ⟨(-257988577), (-35309863)⟩, ⟨1599453, 71326392⟩, ⟨(-3687143), 7827254⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297653150, 4297653152⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2658
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305846872⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2659
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (64941277 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(27001 / 400000), prawitzNormalCorrection
