...
namespace FiniteNormalPanel101_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (11347 / 40000)
def radius : Rat := (1621 / 40000)

def j0 : Jet := ⟨⟨1218374847, 1218374848⟩, ⟨174053549, 174053550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3827637468, 3827637472⟩, ⟨546805350, 546805355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3411157193, 3411157201⟩, ⟨974616336, 974616348⟩, ⟨69615452, 69615454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨853, 855⟩, ⟨243, 245⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93834), (-93831)⟩, ⟨243, 245⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-74526), (-74522)⟩, ⟨(-21101), (-21097)⟩, ⟨(-1453), (-1449)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5038530, 5038535⟩, ⟨(-21101), (-21097)⟩, ⟨(-1453), (-1449)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4001710, 4001715⟩, ⟨1126586, 1126593⟩, ⟨75723, 75731⟩, ⟨(-669), (-661)⟩, ⟨(-23), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-139163867), (-139163861)⟩, ⟨1126586, 1126593⟩, ⟨75723, 75731⟩, ⟨(-669), (-661)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-110526995), (-110526989)⟩, ⟨(-30684383), (-30684374)⟩, ⟨(-1939868), (-1939856)⟩, ⟨34911, 34922⟩, ⟨1056, 1064⟩⟩
...
def j19 : Jet := ⟨⟨1321128770, 1321128777⟩, ⟨(-30684383), (-30684374)⟩, ⟨(-1939868), (-1939856)⟩, ⟨34911, 34922⟩, ⟨1056, 1064⟩⟩
...
def j25 : Jet := ⟨⟨9331, 9334⟩, ⟨2646, 2648⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842846), (-842842)⟩, ⟨2646, 2648⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-669407), (-669403)⟩, ⟨(-189159), (-189154)⟩, ⟨(-12918), (-12912)⟩, ⟨81, 86⟩, ⟨0, 4⟩⟩
...
def j30 : Jet := ⟨⟨35121987, 35121992⟩, ⟨(-189159), (-189154)⟩, ⟨(-12918), (-12912)⟩, ⟨81, 86⟩, ⟨0, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨27894652, 27894657⟩, ⟨7819665, 7819672⟩, ⟨516093, 516103⟩, ⟨(-5935), (-5925)⟩, ⟨(-192), (-185)⟩⟩
...
def j33 : Jet := ⟨⟨(-687933231), (-687933225)⟩, ⟨7819665, 7819672⟩, ⟨516093, 516103⟩, ⟨(-5935), (-5925)⟩, ⟨(-192), (-185)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-546371657), (-546371650)⟩, ⟨(-149895640), (-149895629)⟩, ⟨(-8966109), (-8966095)⟩, ⟨239143, 239157⟩, ⟨6865, 6876⟩⟩
...
def j36 : Jet := ⟨⟨3748595639, 3748595646⟩, ⟨(-149895640), (-149895629)⟩, ⟨(-8966109), (-8966095)⟩, ⟨239143, 239157⟩, ⟨6865, 6876⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1177378459, 1177378468⟩, ⟨140851266, 140851278⟩, ⟨(-5635317), (-5635302)⟩, ⟨(-215859), (-215845)⟩, ⟨5385, 5396⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4920974630, 4920974640⟩, ⟨196775714, 196775732⟩, ⟨19638752, 19638774⟩, ⟨942000, 942027⟩, ⟨63057, 63080⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1348985714, 1348985728⟩, ⟨215322941, 215322962⟩, ⟨5380039, 5380066⟩, ⟨396765, 396794⟩, ⟨18688, 18714⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1218374848), (-1218374847)⟩, ⟨(-174053550), (-174053549)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3076592448, 3076592449⟩, ⟨(-174053550), (-174053549)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨423696464, 423696473⟩, ⟨135259502, 135259518⟩, ⟨14174532, 14174555⟩, ⟨788678, 788704⟩, ⟨58259, 58282⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4718663760, 4718663769⟩, ⟨135259502, 135259518⟩, ⟨14174532, 14174555⟩, ⟨788678, 788704⟩, ⟨58259, 58282⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4501833685, 4501833690⟩, ⟨64522056, 64522065⟩, ⟨6299216, 6299229⟩, ⟨285934, 285949⟩, ⟨19285, 19298⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3224776014, 3224776019⟩, ⟨(-136218050), (-136218040)⟩, ⟨1897528, 1897540⟩, ⟨(-50456), (-50442)⟩, ⟨2225, 2237⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨29216523473, 29216523479⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value454

def j47 : Jet := ⟨⟨8287997291, 8287997300⟩, ⟨1183999609, 1183999617⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15993346249, 15993346285⟩, ⟨4569527484, 4569527522⟩, ⟨326394819, 326394824⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15993346249, 15993346285⟩, ⟨4569527484, 4569527522⟩, ⟨326394819, 326394824⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15993346285), (-15993346249)⟩, ⟨(-4569527522), (-4569527484)⟩, ⟨(-326394824), (-326394819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7996673143), (-7996673124)⟩, ⟨(-2284763761), (-2284763742)⟩, ⟨(-163197412), (-163197409)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨667359351, 667359363⟩, ⟨(-355010501), (-355010490)⟩, ⟨69068331, 69068337⟩, ⟨(-3254294), (-3254291)⟩, ⟨(-879417), (-879415)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨501071202, 501071213⟩, ⟨(-287717149), (-287717136)⟩, ⟨63412604, 63412614⟩, ⟨(-4798651), (-4798641)⟩, ⟨(-522050), (-522041)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1044321298, 1392428398⟩, ⟨174053549, 174053550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3280832117, 4374442826⟩, ⟨546805350, 546805355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2506156307, 4455388999⟩, ⟨835385430, 1113847254⟩, ⟨69615452, 69615454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨627, 1117⟩, ⟨209, 280⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94060), (-93569)⟩, ⟨209, 280⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-97574), (-54598)⟩, ⟨(-24273), (-17908)⟩, ⟨(-1476), (-1424)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5015482, 5058459⟩, ⟨(-24273), (-17908)⟩, ⟨(-1476), (-1424)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2926583, 5247398⟩, ⟨950347, 1301401⟩, ⟨73466, 77678⟩, ⟨(-774), (-555)⟩, ⟨(-23), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140238994), (-137918178)⟩, ⟨950347, 1301401⟩, ⟨73466, 77678⟩, ⟨(-774), (-555)⟩, ⟨(-23), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-145477074), (-80476634)⟩, ⟨(-35814733), (-25475534)⟩, ⟨(-2045367), (-1817379)⟩, ⟨28889, 40916⟩, ⟨965, 1143⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1286178691, 1351179132⟩, ⟨(-35814733), (-25475534)⟩, ⟨(-2045367), (-1817379)⟩, ⟨28889, 40916⟩, ⟨965, 1143⟩⟩
...
def j72 : Jet := ⟨⟨6839, 12214⟩, ⟨2248, 3043⟩, ⟨178, 188⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845338), (-839962)⟩, ⟨2248, 3043⟩, ⟨178, 188⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-876913), (-490126)⟩, ⟨(-217918), (-160218)⟩, ⟨(-13162), (-12628)⟩, ⟨67, 99⟩, ⟨(-1), 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34914481, 35301269⟩, ⟨(-217918), (-160218)⟩, ⟨(-13162), (-12628)⟩, ⟨67, 99⟩, ⟨(-1), 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨20372948, 36619810⟩, ⟨6564924, 9061465⟩, ⟨495746, 533655⟩, ⟨(-6908), (-4949)⟩, ⟨(-203), (-173)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-695454935), (-679208072)⟩, ⟨6564924, 9061465⟩, ⟨495746, 533655⟩, ⟨(-6908), (-4949)⟩, ⟨(-203), (-173)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-721430934), (-396324692)⟩, ⟨(-176527037), (-122708308)⟩, ⟨(-9706188), (-8105450)⟩, ⟨195665, 282384⟩, ⟨6032, 7588⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3573536362, 3898642604⟩, ⟨(-176527037), (-122708308)⟩, ⟨(-9706188), (-8105450)⟩, ⟨195665, 282384⟩, ⟨6032, 7588⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨982483932, 1376181809⟩, ⟨127269860, 152562521⟩, ⟨(-6642899), (-4631623)⟩, ⟨(-238335), (-189702)⟩, ⟨4414, 6375⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4731581205, 5162041800⟩, ⟨148924736, 254996691⟩, ⟨14524514, 26617209⟩, ⟨392879, 1748382⟩, ⟨14043, 142526⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1082360396, 1654007478⟩, ⟨174274629, 265067425⟩, ⟨(-248477), 12483952⟩, ⟨(-160580), 1136105⟩, ⟨(-35605), 93195⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1392428398), (-1044321298)⟩, ⟨(-174053550), (-174053549)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2902538898, 3250645998⟩, ⟨(-174053550), (-174053549)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨272762036, 636964277⟩, ⟨87836736, 204156854⟩, ⟨6880069, 25974086⟩, ⟨(-154350), 2415954⟩, ⟨(-47969), 248299⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4567729332, 4931931573⟩, ⟨87836736, 204156854⟩, ⟨6880069, 25974086⟩, ⟨(-154350), 2415954⟩, ⟨(-47969), 248299⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4429249157, 4602443353⟩, ⟨40984307, 98983709⟩, ⟨2145805, 12403699⟩, ⟨(-352031), 1151500⟩, ⟨(-66359), 127734⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2993286579, 3483359252⟩, ⟨(-158816824), (-104579500)⟩, ⟨(-2561180), 7726851⟩, ⟨(-769095), 784555⟩, ⟨(-96889), 110943⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7103997682, 9471996917⟩, ⟨1183999609, 1183999617⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11750213584, 20889268629⟩, ⟨3916737846, 5222317168⟩, ⟨326394819, 326394824⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11750213584, 20889268629⟩, ⟨3916737846, 5222317168⟩, ⟨326394819, 326394824⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20889268629), (-11750213584)⟩, ⟨(-5222317168), (-3916737846)⟩, ⟨(-326394824), (-326394819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10444634315), (-5875106792)⟩, ⟨(-2611158584), (-1958368923)⟩, ⟨(-163197412), (-163197409)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨377423645, 1093670039⟩, ⟨(-664905159), (-172093216)⟩, ⟨(-2322048), 187776016⟩, ⟨(-33693903), 17313663⟩, ⟨(-6198991), 5165234⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨263037423, 887002249⟩, ⟨(-579700979), (-129126731)⟩, ⟨1654914, 178846549⟩, ⟨(-35662374), 14724091⟩, ⟨(-5925905), 5920223⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1218374847, 1218374848⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4501833685, 4501833690⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar454 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2042
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar454 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1044321298, 1392428398⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4429249157, 4602443353⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2043
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((4863 / 20000) : ℝ)..(1621 / 5000), prawitzNormalCorrection
      ((107557 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
