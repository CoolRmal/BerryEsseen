...
namespace FiniteNormalPanel67_20
...
def j2 : Jet := ⟨⟨1615217809, 1615217813⟩, ⟨538405935, 538405939⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨607438518, 607438522⟩, ⟨404959010, 404959016⟩, ⟨67493168, 67493170⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-13371), (-13369)⟩, ⟨(-8900), (-8898)⟩, ⟨(-1475), (-1472)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5099685, 5099688⟩, ⟨(-8900), (-8898)⟩, ⟨(-1475), (-1472)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨721249, 721251⟩, ⟨479574, 479576⟩, ⟨79089, 79093⟩, ⟨(-280), (-276)⟩, ⟨(-24), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-142444328), (-142444325)⟩, ⟨479574, 479576⟩, ⟨79089, 79093⟩, ⟨(-280), (-276)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-20145945), (-20145943)⟩, ⟨(-13362804), (-13362802)⟩, ⟨(-2182037), (-2182033)⟩, ⟨14953, 14956⟩, ⟨1211, 1215⟩⟩
...
def j19 : Jet := ⟨⟨1411509820, 1411509823⟩, ⟨(-13362804), (-13362802)⟩, ⟨(-2182037), (-2182033)⟩, ⟨14953, 14956⟩, ⟨1211, 1215⟩⟩
...
def j25 : Jet := ⟨⟨1671, 1672⟩, ⟨1112, 1114⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850506), (-850504)⟩, ⟨1112, 1114⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-120288), (-120287)⟩, ⟨(-80035), (-80033)⟩, ⟨(-13237), (-13232)⟩, ⟨33, 36⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35671106, 35671108⟩, ⟨(-80035), (-80033)⟩, ⟨(-13237), (-13232)⟩, ⟨33, 36⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5044975, 5044976⟩, ⟨3351996, 3351999⟩, ⟨551132, 551136⟩, ⟨(-2503), (-2498)⟩, ⟨(-206), (-202)⟩⟩
...
def j33 : Jet := ⟨⟨(-710782908), (-710782906)⟩, ⟨3351996, 3351999⟩, ⟨551132, 551136⟩, ⟨(-2503), (-2498)⟩, ⟨(-206), (-202)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-100526242), (-100526240)⟩, ⟨(-66543422), (-66543418)⟩, ⟨(-10775588), (-10775584)⟩, ⟨104283, 104287⟩, ⟨8393, 8398⟩⟩
...
def j36 : Jet := ⟨⟨4194441054, 4194441056⟩, ⟨(-66543422), (-66543418)⟩, ⟨(-10775588), (-10775584)⟩, ⟨104283, 104287⟩, ⟨8393, 8398⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨530829606, 530829609⟩, ⟨171917821, 171917826⟩, ⟨(-2495731), (-2495727)⟩, ⟨(-267912), (-267908)⟩, ⟨2329, 2332⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4397902802, 4397902805⟩, ⟨69771270, 69771276⟩, ⟨12405177, 12405184⟩, ⟨266700, 266708⟩, ⟨25558, 25568⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨543551755, 543551759⟩, ⟨184661364, 184661372⟩, ⟨1770437, 1770446⟩, ⟨214637, 214646⟩, ⟨4655, 4665⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-514139798), (-514139797)⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3780827498, 3780827499⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨68789466, 68789468⟩, ⟨46739824, 46739828⟩, ⟨8387598, 8387604⟩, ⟨206564, 206572⟩, ⟨20363, 20370⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4363756762, 4363756764⟩, ⟨46739824, 46739828⟩, ⟨8387598, 8387604⟩, ⟨206564, 206572⟩, ⟨20363, 20370⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4329225401, 4329225403⟩, ⟨23184980, 23184983⟩, ⟨4098529, 4098533⟩, ⟨80514, 80520⟩, ⟨7728, 7734⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3810984650, 3810984654⟩, ⟨(-152337354), (-152337349)⟩, ⟨2682765, 2682770⟩, ⟨(-92667), (-92659)⟩, ⟨3589, 3597⟩⟩
...
def j47 : Jet := ⟨⟨3975844043, 3975844052⟩, ⟨1325281345, 1325281354⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3680432181, 3680432199⟩, ⟨2453621448, 2453621472⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3680432181, 3680432199⟩, ⟨2453621448, 2453621472⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3680432199), (-3680432181)⟩, ⟨(-2453621472), (-2453621448)⟩, ⟨(-408936913), (-408936907)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1840216100), (-1840216090)⟩, ⟨(-1226810736), (-1226810724)⟩, ⟨(-204468457), (-204468453)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2798224869, 2798224879⟩, ⟨(-799282530), (-799282518)⟩, ⟨(-19060575), (-19060567)⟩, ⟨27182187, 27182191⟩, ⟨(-1487371), (-1487370)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2482904126, 2482904139⟩, ⟨(-808464278), (-808464261)⟩, ⟨13184732, 13184747⟩, ⟨24235559, 24235572⟩, ⟨(-2276211), (-2276198)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨342759865, 685519731⟩, ⟨171379932, 171379933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1076811873, 2153623751⟩, ⟨538405935, 538405939⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨269972674, 1079890705⟩, ⟨269972674, 539945354⟩, ⟨67493168, 67493170⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-23791), (-5934)⟩, ⟨(-11892), (-5899)⟩, ⟨(-1482), (-1460)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5089265, 5107123⟩, ⟨(-11892), (-5899)⟩, ⟨(-1482), (-1460)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨319900, 1284093⟩, ⟨316909, 641677⟩, ⟨78106, 79795⟩, ⟨(-374), (-181)⟩, ⟨(-24), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142845677), (-141881483)⟩, ⟨316909, 641677⟩, ⟨78106, 79795⟩, ⟨(-374), (-181)⟩, ⟨(-24), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-35915924), (-8918373)⟩, ⟨(-17938043), (-8757035)⟩, ⟨(-2219917), (-2128861)⟩, ⟨9794, 20105⟩, ⟨1172, 1242⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1395739841, 1422737393⟩, ⟨(-17938043), (-8757035)⟩, ⟨(-2219917), (-2128861)⟩, ⟨9794, 20105⟩, ⟨1172, 1242⟩⟩
...
def j72 : Jet := ⟨⟨742, 2975⟩, ⟨738, 1488⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851435), (-849201)⟩, ⟨738, 1488⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-214078), (-53379)⟩, ⟨(-106993), (-53004)⟩, ⟨(-13323), (-13109)⟩, ⟨21, 48⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35577316, 35738016⟩, ⟨(-106993), (-53004)⟩, ⟨(-13323), (-13109)⟩, ⟨21, 48⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2236315, 8985669⟩, ⟨2209413, 4489504⟩, ⟨542277, 557450⟩, ⟨(-3356), (-1643)⟩, ⟨(-209), (-198)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713591568), (-706842213)⟩, ⟨2209413, 4489504⟩, ⟨542277, 557450⟩, ⟨(-3356), (-1643)⟩, ⟨(-209), (-198)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-179419504), (-44430625)⟩, ⟨(-89570874), (-43301821)⟩, ⟨(-11040755), (-10403093)⟩, ⟨67961, 140529⟩, ⟨8046, 8646⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4115547792, 4250536671⟩, ⟨(-89570874), (-43301821)⟩, ⟨(-11040755), (-10403093)⟩, ⟨67961, 140529⟩, ⟨8046, 8646⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨349932637, 713402648⟩, ⟨165971652, 176155145⟩, ⟨(-3361800), (-1631495)⟩, ⟨(-275829), (-256786)⟩, ⟨1520, 3144⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4339862351, 4482208690⟩, ⟨44211814, 97550891⟩, ⟨11072116, 14147495⟩, ⟨72813, 497942⟩, ⟨15497, 39578⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨353590463, 744503818⟩, ⟨171308703, 200038121⟩, ⟨(-897770), 4702364⟩, ⟨69583, 386696⟩, ⟨(-11729), 23431⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-685519731), (-342759865)⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3609447565, 3952207431⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨29109934, 129054752⟩, ⟨28206558, 69350538⟩, ⟨6521558, 10947025⟩, ⟨(-72172), 572090⟩, ⟨499, 49295⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4324077230, 4424022048⟩, ⟨28206558, 69350538⟩, ⟨6521558, 10947025⟩, ⟨(-72172), 572090⟩, ⟨499, 49295⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4309497683, 4359017093⟩, ⟨13896050, 34558354⟩, ⟨3075876, 5432654⟩, ⟨(-79530), 275164⟩, ⟨(-5384), 24105⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3621658756, 4011145734⟩, ⟨(-162257580), (-140159305)⟩, ⟨1205970, 4444615⟩, ⟨(-289961), 130470⟩, ⟨(-15935), 25356⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2650562697, 5301125405⟩, ⟨1325281345, 1325281354⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1635747638, 6542990581⟩, ⟨1635747632, 3271495298⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1635747638, 6542990581⟩, ⟨1635747632, 3271495298⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6542990581), (-1635747638)⟩, ⟨(-3271495298), (-1635747632)⟩, ⟨(-408936913), (-408936907)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3271495291), (-817873819)⟩, ⟨(-1635747649), (-817873816)⟩, ⟨(-204468457), (-204468453)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2005191537, 3550249396⟩, ⟨(-1352120215), (-381840778)⟩, ⟨(-132658806), 162018771⟩, ⟨(-8449660), 59754293⟩, ⟨(-9545964), 3962231⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1690843954, 3315640549⟩, ⟨(-1396892153), (-387416976)⟩, ⟨(-110868614), 206067263⟩, ⟨(-15651036), 60817878⟩, ⟨(-11364102), 4299523⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4329225401, 4329225403⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1336
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4309497683, 4359017093⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1337
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (99283763 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((15961 / 200000) : ℝ)..(15961 / 100000), prawitzNormalCorrection
