...
namespace FiniteNormalPanel133_15
...
def j2 : Jet := ⟨⟨1376391042, 1376391046⟩, ⟨458797013, 458797017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨441086548, 441086552⟩, ⟨294057698, 294057702⟩, ⟨49009616, 49009618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨110, 111⟩, ⟨73, 74⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94577), (-94575)⟩, ⟨73, 74⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9713), (-9712)⟩, ⟨(-6469), (-6467)⟩, ⟨(-1075), (-1071)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103343, 5103345⟩, ⟨(-6469), (-6467)⟩, ⟨(-1075), (-1071)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨524105, 524106⟩, ⟨348738, 348740⟩, ⟨57679, 57683⟩, ⟨(-148), (-145)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-142641472), (-142641470)⟩, ⟨348738, 348740⟩, ⟨57679, 57683⟩, ⟨(-148), (-145)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14649061), (-14649059)⟩, ⟨(-9730227), (-9730223)⟩, ⟨(-1597875), (-1597872)⟩, ⟨7912, 7916⟩, ⟨645, 649⟩⟩
...
def j19 : Jet := ⟨⟨1417006704, 1417006707⟩, ⟨(-9730227), (-9730223)⟩, ⟨(-1597875), (-1597872)⟩, ⟨7912, 7916⟩, ⟨645, 649⟩⟩
...
def j22 : Jet := ⟨⟨(-12), (-10)⟩, ⟨(-8), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11823, 11826⟩, ⟨(-8), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1214, 1215⟩, ⟨808, 810⟩, ⟨132, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850963), (-850961)⟩, ⟨808, 810⟩, ⟨132, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-87393), (-87392)⟩, ⟨(-58180), (-58177)⟩, ⟨(-9643), (-9640)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35704001, 35704003⟩, ⟨(-58180), (-58177)⟩, ⟨(-9643), (-9640)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3666746, 3666747⟩, ⟨2438522, 2438524⟩, ⟨402441, 402444⟩, ⟨(-1324), (-1320)⟩, ⟨(-111), (-107)⟩⟩
...
def j33 : Jet := ⟨⟨(-712161137), (-712161135)⟩, ⟨2438522, 2438524⟩, ⟨402441, 402444⟩, ⟨(-1324), (-1320)⟩, ⟨(-111), (-107)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-73137857), (-73137855)⟩, ⟨(-48508139), (-48508137)⟩, ⟨(-7918145), (-7918141)⟩, ⟨55242, 55245⟩, ⟨4489, 4493⟩⟩
...
def j36 : Jet := ⟨⟨4221829439, 4221829441⟩, ⟨(-48508139), (-48508137)⟩, ⟨(-7918145), (-7918141)⟩, ⟨55242, 55245⟩, ⟨4489, 4493⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨454102487, 454102491⟩, ⟨148249287, 148249293⟩, ⟨(-1551468), (-1551464)⟩, ⟨(-168154), (-168150)⟩, ⟨1051, 1054⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4369372171, 4369372174⟩, ⟨50203378, 50203383⟩, ⟨8771688, 8771695⟩, ⟨137765, 137774⟩, ⟨12725, 12735⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨461969238, 461969243⟩, ⟨156125469, 156125478⟩, ⟨1081943, 1081952⟩, ⟨128134, 128144⟩, ⟨2034, 2043⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-438118877), (-438118876)⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3856848419, 3856848420⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨49689686, 49689688⟩, ⟨33585896, 33585900⟩, ⟨5908032, 5908038⟩, ⟨106222, 106228⟩, ⟨10022, 10031⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4344656982, 4344656984⟩, ⟨33585896, 33585900⟩, ⟨5908032, 5908038⟩, ⟨106222, 106228⟩, ⟨10022, 10031⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4319740692, 4319740694⟩, ⟨16696641, 16696644⟩, ⟨2904806, 2904811⟩, ⟨41578, 41583⟩, ⟨3844, 3851⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3879094742, 3879094746⟩, ⟨(-131888526), (-131888520)⟩, ⟨2040766, 2040772⟩, ⟨(-61435), (-61428)⟩, ⟨2037, 2046⟩⟩
...
def j47 : Jet := ⟨⟨4309219931, 4309219942⟩, ⟨1436406640, 1436406651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4323519862, 4323519885⟩, ⟨2882346566, 2882346598⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4323519862, 4323519885⟩, ⟨2882346566, 2882346598⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4323519885), (-4323519862)⟩, ⟨(-2882346598), (-2882346566)⟩, ⟨(-480391101), (-480391093)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2161759943), (-2161759931)⟩, ⟨(-1441173299), (-1441173283)⟩, ⟨(-240195551), (-240195546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2596384707, 2596384724⟩, ⟨(-871215095), (-871215079)⟩, ⟨965289, 965299⟩, ⟨32373765, 32373769⟩, ⟨(-2742742), (-2742740)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2344982294, 2344982313⟩, ⟨(-866586169), (-866586148)⟩, ⟨28858502, 28858520⟩, ⟨28758338, 28758351⟩, ⟨(-3457144), (-3457131)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨292079250, 584158502⟩, ⟨146039625, 146039626⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨917594026, 1835188059⟩, ⟨458797013, 458797017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨196038465, 784153867⟩, ⟨196038464, 392076936⟩, ⟨49009616, 49009618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨49, 197⟩, ⟨49, 99⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94638), (-94489)⟩, ⟨49, 99⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-17279), (-4312)⟩, ⟨(-8638), (-4293)⟩, ⟨(-1078), (-1065)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095777, 5108745⟩, ⟨(-8638), (-4293)⟩, ⟨(-1078), (-1065)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨232590, 932730⟩, ⟨231012, 466170⟩, ⟨57161, 58053⟩, ⟨(-198), (-95)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142932987), (-142232846)⟩, ⟨231012, 466170⟩, ⟨57161, 58053⟩, ⟨(-198), (-95)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-26095998), (-6492042)⟩, ⟨(-13037455), (-6406930)⟩, ⟨(-1617847), (-1569854)⟩, ⟨5208, 10616⟩, ⟨630, 659⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1405559767, 1425163724⟩, ⟨(-13037455), (-6406930)⟩, ⟨(-1617847), (-1569854)⟩, ⟨5208, 10616⟩, ⟨630, 659⟩⟩
...
def j72 : Jet := ⟨⟨539, 2161⟩, ⟨537, 1081⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851638), (-850015)⟩, ⟨537, 1081⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-155488), (-38797)⟩, ⟨(-77720), (-38599)⟩, ⟨(-9688), (-9575)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35635906, 35752598⟩, ⟨(-77720), (-38599)⟩, ⟨(-9688), (-9575)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1626556, 6527533⟩, ⟨1612366, 3262006⟩, ⟨397775, 405773⟩, ⟨(-1772), (-872)⟩, ⟨(-112), (-105)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714201327), (-709300349)⟩, ⟨1612366, 3262006⟩, ⟨397775, 405773⟩, ⟨(-1772), (-872)⟩, ⟨(-112), (-105)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-130395343), (-32375136)⟩, ⟨(-65124078), (-31779575)⟩, ⟨(-8057961), (-7721918)⟩, ⟨36229, 74227⟩, ⟨4355, 4588⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4164571953, 4262592160⟩, ⟨(-65124078), (-31779575)⟩, ⟨(-8057961), (-7721918)⟩, ⟨36229, 74227⟩, ⟨4355, 4588⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨300289421, 608955382⟩, ⟨144573961, 150870045⟩, ⟨(-2083975), (-1019790)⟩, ⟨(-171710), (-163157)⟩, ⟨690, 1417⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4327588326, 4429445399⟩, ⟨32264150, 69266075⟩, ⟨8080204, 9653620⟩, ⟨41555, 247336⟩, ⟨8971, 17742⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨302570171, 628022155⟩, ⟨147927823, 165414666⟩, ⟨(-498235), 2774311⟩, ⟨64198, 202118⟩, ⟨(-4735), 9524⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-584158502), (-292079250)⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3710808794, 4002888046⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21315344, 91831160⟩, ⟨20842322, 48374794⟩, ⟨4949241, 7182051⟩, ⟨(-29334), 272808⟩, ⟨2714, 20149⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316282640, 4386798456⟩, ⟨20842322, 48374794⟩, ⟨4949241, 7182051⟩, ⟨(-29334), 272808⟩, ⟨2714, 20149⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305611777, 4340640034⟩, ⟨10311508, 24127601⟩, ⟨2381524, 3569801⟩, ⟨(-34636), 130364⟩, ⟨(-858), 9586⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3720005519, 4045454810⟩, ⟨(-138683575), (-123914759)⟩, ⟨1237213, 2976420⟩, ⟨(-153664), 40522⟩, ⟨(-5233), 10113⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2872813280, 5745626583⟩, ⟨1436406640, 1436406651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1921564373, 7686257556⟩, ⟨1921564372, 3843128794⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1921564373, 7686257556⟩, ⟨1921564372, 3843128794⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7686257556), (-1921564373)⟩, ⟨(-3843128794), (-1921564372)⟩, ⟨(-480391101), (-480391093)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3843128778), (-960782186)⟩, ⟨(-1921564397), (-960782186)⟩, ⟨(-240195551), (-240195546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1755310548, 3434064025⟩, ⟨(-1536397070), (-392662152)⟩, ⟨(-148130465), 245525777⟩, ⟨(-21976279), 79373031⟩, ⟨(-15743356), 6600132⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1520329370, 3234564986⟩, ⟨(-1558026577), (-390739705)⟩, ⟨(-127690561), 283251912⟩, ⟨(-29815150), 79464315⟩, ⟨(-17513035), 7159518⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4319740692, 4319740694⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2684
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305611777, 4340640034⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2685
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (80111037 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((13601 / 200000) : ℝ)..(13601 / 100000), prawitzNormalCorrection
