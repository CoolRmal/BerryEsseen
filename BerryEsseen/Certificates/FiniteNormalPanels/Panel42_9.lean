...
namespace FiniteNormalPanel42_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (34583 / 160000)
def radius : Rat := (34583 / 800000)

def j0 : Jet := ⟨⟨928330337, 928330338⟩, ⟨185666067, 185666068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2916435766, 2916435771⟩, ⟨583287152, 583287156⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1980363758, 1980363766⟩, ⟨792145500, 792145510⟩, ⟨79214550, 79214552⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨495, 497⟩, ⟨198, 199⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94192), (-94189)⟩, ⟨198, 199⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-43431), (-43429)⟩, ⟨(-17282), (-17279)⟩, ⟨(-1694), (-1690)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5069625, 5069628⟩, ⟨(-17282), (-17279)⟩, ⟨(-1694), (-1690)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2337550, 2337552⟩, ⟨927051, 927054⟩, ⟨89532, 89538⟩, ⟨(-630), (-625)⟩, ⟨(-31), (-28)⟩⟩
...
def j16 : Jet := ⟨⟨(-140828027), (-140828024)⟩, ⟨927051, 927054⟩, ⟨89532, 89538⟩, ⟨(-630), (-625)⟩, ⟨(-31), (-28)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-64934307), (-64934304)⟩, ⟨(-25546270), (-25546266)⟩, ⟨(-2385110), (-2385104)⟩, ⟨33319, 33326⟩, ⟨1519, 1525⟩⟩
...
def j19 : Jet := ⟨⟨1366721458, 1366721462⟩, ⟨(-25546270), (-25546266)⟩, ⟨(-2385110), (-2385104)⟩, ⟨33319, 33326⟩, ⟨1519, 1525⟩⟩
...
def j25 : Jet := ⟨⟨5433, 5435⟩, ⟨2163, 2166⟩, ⟨212, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846744), (-846741)⟩, ⟨2163, 2166⟩, ⟨212, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-390425), (-390423)⟩, ⟨(-155173), (-155170)⟩, ⟨(-15122), (-15116)⟩, ⟨77, 80⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35400969, 35400972⟩, ⟨(-155173), (-155170)⟩, ⟨(-15122), (-15116)⟩, ⟨77, 80⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16323010, 16323012⟩, ⟨6457655, 6457658⟩, ⟨617327, 617334⟩, ⟨(-5617), (-5611)⟩, ⟨(-265), (-261)⟩⟩
...
def j33 : Jet := ⟨⟨(-699504873), (-699504870)⟩, ⟨6457655, 6457658⟩, ⟨617327, 617334⟩, ⟨(-5617), (-5611)⟩, ⟨(-265), (-261)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-322534262), (-322534258)⟩, ⟨(-126036150), (-126036144)⟩, ⟨(-11425707), (-11425700)⟩, ⟨230369, 230375⟩, ⟨10226, 10232⟩⟩
...
def j36 : Jet := ⟨⟨3972433034, 3972433038⟩, ⟨(-126036150), (-126036144)⟩, ⟨(-11425707), (-11425700)⟩, ⟨230369, 230375⟩, ⟨10226, 10232⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨928052547, 928052553⟩, ⟨168263681, 168263688⟩, ⟨(-5088941), (-5088934)⟩, ⟨(-301291), (-301284)⟩, ⟨5555, 5562⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4643689118, 4643689124⟩, ⟨147333551, 147333561⟩, ⟨18030951, 18030962⟩, ⟨726543, 726554⟩, ⟨54405, 54417⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1003404034, 1003404043⟩, ⟨213761231, 213761244⟩, ⟨4166059, 4166073⟩, ⟨363063, 363077⟩, ⟨14523, 14539⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-928330338), (-928330337)⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3366636958, 3366636959⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨234418468, 234418473⟩, ⟨99879168, 99879176⟩, ⟨12585507, 12585518⟩, ⟨584328, 584342⟩, ⟨46963, 46978⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4529385764, 4529385769⟩, ⟨99879168, 99879176⟩, ⟨12585507, 12585518⟩, ⟨584328, 584342⟩, ⟨46963, 46978⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4410619426, 4410619430⟩, ⟨48630103, 48630108⟩, ⟨5859658, 5859665⟩, ⟨219895, 219904⟩, ⟨16548, 16558⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3457291602, 3457291608⟩, ⟨(-152546556), (-152546549)⟩, ⟨2490910, 2490918⟩, ⟨(-80940), (-80931)⟩, ⟨3464, 3475⟩⟩
...
def j47 : Jet := ⟨⟨5771166235, 5771166244⟩, ⟨1154233244, 1154233252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7754741169, 7754741194⟩, ⟨3101896458, 3101896488⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7754741169, 7754741194⟩, ⟨3101896458, 3101896488⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7754741194), (-7754741169)⟩, ⟨(-3101896488), (-3101896458)⟩, ⟨(-310189650), (-310189645)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3877370597), (-3877370584)⟩, ⟨(-1550948244), (-1550948229)⟩, ⟨(-155094825), (-155094822)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1741371894, 1741371906⟩, ⟨(-628823811), (-628823799)⟩, ⟨50654356, 50654363⟩, ⟨9040995, 9040997⟩, ⟨(-1730781), (-1730779)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1401740690, 1401740704⟩, ⟨(-568029372), (-568029356)⟩, ⟨64119086, 64119098⟩, ⟨5081042, 5081051⟩, ⟨(-1671700), (-1671688)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨742664269, 1113996405⟩, ⟨185666067, 185666068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2333148611, 3499722923⟩, ⟨583287152, 583287156⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1267432803, 2851723819⟩, ⟨633716400, 950574610⟩, ⟨79214550, 79214552⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨317, 715⟩, ⟨158, 239⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94370), (-93971)⟩, ⟨158, 239⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-62659), (-27730)⟩, ⟨(-20841), (-13706)⟩, ⟨(-1713), (-1666)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5050397, 5085327⟩, ⟨(-20841), (-13706)⟩, ⟨(-1713), (-1666)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1490357, 3376498⟩, ⟨731340, 1121456⟩, ⟨87396, 91279⟩, ⟨(-764), (-490)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141675220), (-139789078)⟩, ⟨731340, 1121456⟩, ⟨87396, 91279⟩, ⟨(-764), (-490)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-94067911), (-41251364)⟩, ⟨(-31140155), (-19881070)⟩, ⟨(-2479300), (-2269399)⟩, ⟨25875, 40743⟩, ⟨1419, 1605⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1337587854, 1390404402⟩, ⟨(-31140155), (-19881070)⟩, ⟨(-2479300), (-2269399)⟩, ⟨25875, 40743⟩, ⟨1419, 1605⟩⟩
...
def j72 : Jet := ⟨⟨3471, 7839⟩, ⟨1719, 2609⟩, ⟨208, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848706), (-844337)⟩, ⟨1719, 2609⟩, ⟨208, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-563515), (-249161)⟩, ⟨(-187332), (-122847)⟩, ⟨(-15340), (-14850)⟩, ⟨59, 97⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35227879, 35542234⟩, ⟨(-187332), (-122847)⟩, ⟨(-15340), (-14850)⟩, ⟨59, 97⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10395648, 23598931⟩, ⟨5073441, 7830060⟩, ⟨598081, 633019⟩, ⟨(-6835), (-4391)⟩, ⟨(-275), (-248)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705432235), (-692228951)⟩, ⟨5073441, 7830060⟩, ⟨598081, 633019⟩, ⟨(-6835), (-4391)⟩, ⟨(-275), (-248)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-468384919), (-204274821)⟩, ⟨(-154631149), (-96938495)⟩, ⟨(-12085622), (-10613899)⟩, ⟨177279, 283222⟩, ⟨9334, 10956⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3826582377, 4090692475⟩, ⟨(-154631149), (-96938495)⟩, ⟨(-12085622), (-10613899)⟩, ⟨177279, 283222⟩, ⟨9334, 10956⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨726615833, 1132960934⟩, ⟨156279628, 178026860⟩, ⟨(-6249295), (-3932792)⟩, ⟨(-322651), (-275000)⟩, ⟨4284, 6842⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4509442884, 4820683905⟩, ⟨106861762, 194802521⟩, ⟨14232744, 23097244⟩, ⟨280781, 1339693⟩, ⟨17182, 111137⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨762900476, 1271638680⟩, ⟨182162388, 251204443⟩, ⟨(-718010), 10038182⟩, ⟨(-80205), 924197⟩, ⟨(-30624), 72654⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1113996405), (-742664269)⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3180970891, 3552303027⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨135511424, 376502270⟩, ⟨64713774, 148751442⟩, ⟨7300878, 20636609⟩, ⟨(-131486), 1721496⟩, ⟨(-29199), 174596⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4430478720, 4671469566⟩, ⟨64713774, 148751442⟩, ⟨7300878, 20636609⟩, ⟨(-131486), 1721496⟩, ⟨(-29199), 174596⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4362196832, 4479264339⟩, ⟨31025579, 73229454⟩, ⟨2901645, 10048948⟩, ⟨(-233426), 826846⟩, ⟨(-39831), 88907⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3230762934, 3704732347⟩, ⟨(-170654602), (-128005332)⟩, ⟨(-1016580), 6970139⟩, ⟨(-627468), 558438⟩, ⟨(-68688), 83625⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4616932984, 6925399489⟩, ⟨1154233244, 1154233252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4963034339, 11166827307⟩, ⟨2481517164, 3722275782⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4963034339, 11166827307⟩, ⟨2481517164, 3722275782⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11166827307), (-4963034339)⟩, ⟨(-3722275782), (-2481517164)⟩, ⟨(-310189650), (-310189645)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5583413654), (-2481517169)⟩, ⟨(-1861137891), (-1240758582)⟩, ⟨(-155094825), (-155094822)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1170527077, 2410105936⟩, ⟨(-1044371044), (-338149610)⟩, ⟨(-38187473), 184009917⟩, ⟨(-18438428), 30657995⟩, ⟨(-6643632), 2686972⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨880494595, 2078897651⟩, ⟨(-996610816), (-289248985)⟩, ⟨(-23431956), 204130309⟩, ⟨(-25262886), 28522714⟩, ⟨(-7185096), 3548468⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨928330337, 928330338⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4410619426, 4410619430⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified826
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨742664269, 1113996405⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4362196832, 4479264339⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified827
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (123100215 / 4294967296)

theorem envelope_integral : (∫ s in ((34583 / 200000) : ℝ)..(103749 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((34583 / 200000) : ℝ)..(103749 / 400000), prawitzNormalCorrection
