...
namespace FiniteNormalPanel102_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (69 / 800)
def radius : Rat := (69 / 800)

def j0 : Jet := ⟨⟨370440929, 370440930⟩, ⟨370440929, 370440930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1163774501, 1163774505⟩, ⟨1163774501, 1163774505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨315339092, 315339095⟩, ⟨630678184, 630678190⟩, ⟨315339092, 315339095⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨78, 80⟩, ⟨157, 159⟩, ⟨78, 80⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94609), (-94606)⟩, ⟨157, 159⟩, ⟨78, 80⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-6947), (-6946)⟩, ⟨(-13882), (-13880)⟩, ⟨(-6919), (-6916)⟩, ⟨22, 24⟩, ⟨5, 6⟩⟩
...
def j13 : Jet := ⟨⟨5106109, 5106111⟩, ⟨(-13882), (-13880)⟩, ⟨(-6919), (-6916)⟩, ⟨22, 24⟩, ⟨5, 6⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨374893, 374894⟩, ⟨748767, 748769⟩, ⟨372346, 372349⟩, ⟨(-2035), (-2032)⟩, ⟨(-505), (-502)⟩⟩
...
def j16 : Jet := ⟨⟨(-142790684), (-142790682)⟩, ⟨748767, 748769⟩, ⟨372346, 372349⟩, ⟨(-2035), (-2032)⟩, ⟨(-505), (-502)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-10483779), (-10483778)⟩, ⟨(-20912583), (-20912580)⟩, ⟨(-10346493), (-10346488)⟩, ⟨109499, 109504⟩, ⟨27000, 27005⟩⟩
...
def j19 : Jet := ⟨⟨1421171986, 1421171988⟩, ⟨(-20912583), (-20912580)⟩, ⟨(-10346493), (-10346488)⟩, ⟨109499, 109504⟩, ⟨27000, 27005⟩⟩
...
def j25 : Jet := ⟨⟨868, 869⟩, ⟨1734, 1736⟩, ⟨864, 867⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851309), (-851307)⟩, ⟨1734, 1736⟩, ⟨864, 867⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-62504), (-62503)⟩, ⟨(-124881), (-124878)⟩, ⟨(-62187), (-62184)⟩, ⟨252, 256⟩, ⟨61, 64⟩⟩
...
def j30 : Jet := ⟨⟨35728890, 35728892⟩, ⟨(-124881), (-124878)⟩, ⟨(-62187), (-62184)⟩, ⟨252, 256⟩, ⟨61, 64⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2623236, 2623237⟩, ⟨5237304, 5237306⟩, ⟨2600332, 2600335⟩, ⟨(-18283), (-18280)⟩, ⟨(-4525), (-4522)⟩⟩
...
def j33 : Jet := ⟨⟨(-713204647), (-713204645)⟩, ⟨5237304, 5237306⟩, ⟨2600332, 2600335⟩, ⟨(-18283), (-18280)⟩, ⟨(-4525), (-4522)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-52363917), (-52363915)⟩, ⟨(-104343307), (-104343304)⟩, ⟨(-51403948), (-51403943)⟩, ⟨765018, 765022⟩, ⟨187899, 187903⟩⟩
...
def j36 : Jet := ⟨⟨4242603379, 4242603381⟩, ⟨(-104343307), (-104343304)⟩, ⟨(-51403948), (-51403943)⟩, ⟨765018, 765022⟩, ⟨187899, 187903⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨385084124, 385084126⟩, ⟨379417601, 379417604⟩, ⟨(-8470034), (-8470030)⟩, ⟨(-2773841), (-2773836)⟩, ⟨36985, 36990⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4347977507, 4347977510⟩, ⟨106934892, 106934898⟩, ⟨55310644, 55310652⟩, ⟨1871931, 1871940⟩, ⟨504334, 504343⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨389836986, 389836990⟩, ⟨393688241, 393688247⟩, ⟨5831176, 5831184⟩, ⟨2035018, 2035028⟩, ⟨69884, 69896⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-370440930), (-370440929)⟩, ⟨(-370440930), (-370440929)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3924526366, 3924526367⟩, ⟨(-370440930), (-370440929)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨35383942, 35383944⟩, ⟨71467010, 71467014⟩, ⟨37145065, 37145071⟩, ⟨1438422, 1438428⟩, ⟨393672, 393681⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4330351238, 4330351240⟩, ⟨71467010, 71467014⟩, ⟨37145065, 37145071⟩, ⟨1438422, 1438428⟩, ⟨393672, 393681⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4312622977, 4312622979⟩, ⟨35587213, 35587216⟩, ⟨18349666, 18349670⟩, ⟨564847, 564852⟩, ⟨152330, 152337⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3940659244, 3940659248⟩, ⟨(-339445918), (-339445912)⟩, ⟨13697609, 13697614⟩, ⟨(-1066532), (-1066524)⟩, ⟨90472, 90480⟩⟩
...
def j47 : Jet := ⟨⟨2249850330, 2249850337⟩, ⟨2249850330, 2249850337⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1178548323, 1178548332⟩, ⟨2357096646, 2357096664⟩, ⟨1178548323, 1178548332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1178548323, 1178548332⟩, ⟨2357096646, 2357096664⟩, ⟨1178548323, 1178548332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1178548332), (-1178548323)⟩, ⟨(-2357096664), (-2357096646)⟩, ⟨(-1178548332), (-1178548323)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-589274166), (-589274161)⟩, ⟨(-1178548332), (-1178548323)⟩, ⟨(-589274166), (-589274161)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3744330604, 3744330612⟩, ⟨(-1027452433), (-1027452422)⟩, ⟨(-372758633), (-372758623)⟩, ⟨128073647, 128073651⟩, ⟨16785521, 16785523⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3435446649, 3435446661⟩, ⟨(-1238621231), (-1238621212)⟩, ⟨(-248863795), (-248863775)⟩, ⟨142762178, 142762195⟩, ⟨4423920, 4423935⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 740881859⟩, ⟨370440929, 370440930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2327549006⟩, ⟨1163774501, 1163774505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1261356375⟩, ⟨0, 1261356378⟩, ⟨315339092, 315339095⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 317⟩, ⟨0, 317⟩, ⟨78, 80⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94369)⟩, ⟨0, 317⟩, ⟨78, 80⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-27808), 0⟩, ⟨(-27808), 94⟩, ⟨(-6952), (-6810)⟩, ⟨0, 48⟩, ⟨5, 6⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5085248, 5113057⟩, ⟨(-27808), 94⟩, ⟨(-6952), (-6810)⟩, ⟨0, 48⟩, ⟨5, 6⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1501615⟩, ⟨(-8167), 1501643⟩, ⟨363152, 375432⟩, ⟨(-4084), 22⟩, ⟨(-511), (-482)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141663961)⟩, ⟨(-8167), 1501643⟩, ⟨363152, 375432⟩, ⟨(-4084), 22⟩, ⟨(-511), (-482)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-42045213), 0⟩, ⟨(-42047612), 441007⟩, ⟨(-10513703), (-9849788)⟩, ⟨(-1800), 220517⟩, ⟨25311, 27572⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1389610552, 1431655766⟩, ⟨(-42047612), 441007⟩, ⟨(-10513703), (-9849788)⟩, ⟨(-1800), 220517⟩, ⟨25311, 27572⟩⟩
...
def j72 : Jet := ⟨⟨0, 3477⟩, ⟨(-10), 3477⟩, ⟨853, 870⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848699)⟩, ⟨(-10), 3477⟩, ⟨853, 870⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-250270), 0⟩, ⟨(-250273), 1022⟩, ⟨(-62571), (-61033)⟩, ⟨(-3), 512⟩, ⟨59, 64⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35541124, 35791395⟩, ⟨(-250273), 1022⟩, ⟨(-62571), (-61033)⟩, ⟨(-3), 512⟩, ⟨59, 64⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 10511304⟩, ⟨(-73501), 10511605⟩, ⟨2517572, 2628127⟩, ⟨(-36754), 227⟩, ⟨(-4596), (-4311)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-705316578)⟩, ⟨(-73501), 10511605⟩, ⟨2517572, 2628127⟩, ⟨(-36754), 227⟩, ⟨(-4596), (-4311)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-210226063), 0⟩, ⟨(-210247650), 3087074⟩, ⟨(-52578102), (-47925859)⟩, ⟨(-16192), 1543671⟩, ⟨172696, 193026⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4084741233, 4294967296⟩, ⟨(-210247650), 3087074⟩, ⟨(-52578102), (-47925859)⟩, ⟨(-16192), 1543671⟩, ⟨172696, 193026⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 775849670⟩, ⟨353745522, 388163829⟩, ⟨(-17090957), 119497⟩, ⟨(-2849794), (-2549417)⟩, ⟨(-488), 74694⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4516012894⟩, ⟨(-3413011), 232445839⟩, ⟨47758784, 70093689⟩, ⟨(-1803560), 6617732⟩, ⟨158126, 1062566⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 815779696⟩, ⟨353128990, 450130526⟩, ⟨(-18279020), 33795110⟩, ⟨(-313686), 4994421⟩, ⟨(-596671), 872787⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-740881859), 0⟩, ⟨(-370440930), (-370440929)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3554085437, 4294967296⟩, ⟨(-370440930), (-370440929)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 154947982⟩, ⟨0, 170994246⟩, ⟨22090220, 60013547⟩, ⟨(-3950600), 8981004⟩, ⟨(-436244), 1644345⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4449915278⟩, ⟨0, 170994246⟩, ⟨22090220, 60013547⟩, ⟨(-3950600), 8981004⟩, ⟨(-436244), 1644345⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4371754864⟩, ⟨0, 85497123⟩, ⟨10015087, 30006774⟩, ⟨(-2572626), 4490502⟩, ⟨(-412334), 861708⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3554085437, 4371754864⟩, ⟨(-377063858), (-284943806)⟩, ⟨913357, 30006774⟩, ⟨(-5160711), 3626701⟩, ⟨(-799640), 1083597⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4499700668⟩, ⟨2249850330, 2249850337⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4714193312⟩, ⟨0, 4714193320⟩, ⟨1178548323, 1178548332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4714193312⟩, ⟨0, 4714193320⟩, ⟨1178548323, 1178548332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4714193312), 0⟩, ⟨(-4714193320), 0⟩, ⟨(-1178548332), (-1178548323)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2357096656), 0⟩, ⟨(-2357096660), 0⟩, ⟨(-589274166), (-589274161)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2480945177, 4294967296⟩, ⟨(-2357096660), 0⟩, ⟨(-589274166), 306404067⟩, ⟨(-56051960), 323396216⟩, ⟨(-65389797), 48114917⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2052982133, 4371754864⟩, ⟨(-2776301869), (-164594957)⟩, ⟨(-599281913), 548823165⟩, ⟨(-105582477), 384538326⟩, ⟨(-101857429), 59952564⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨370440929, 370440930⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨370440929, 370440930⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4312622977, 4312622979⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2050
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 740881859⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4371754864⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2051
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (290186623 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(69 / 400),
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(69 / 400), prawitzNormalCorrection
