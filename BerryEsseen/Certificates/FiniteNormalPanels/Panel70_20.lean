...
namespace FiniteNormalPanel70_20

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (9753 / 80000)
def radius : Rat := (3251 / 80000)

def j0 : Jet := ⟨⟨523610200, 523610201⟩, ⟨174536733, 174536734⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1644969957, 1644969961⟩, ⟨548323318, 548323322⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨630022529, 630022533⟩, ⟨420015018, 420015024⟩, ⟨70002503, 70002505⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨157, 158⟩, ⟨105, 106⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94530), (-94528)⟩, ⟨105, 106⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-13867), (-13866)⟩, ⟨(-9230), (-9228)⟩, ⟨(-1529), (-1526)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5099189, 5099191⟩, ⟨(-9230), (-9228)⟩, ⟨(-1529), (-1526)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨747992, 747993⟩, ⟨497307, 497309⟩, ⟨81982, 81986⟩, ⟨(-301), (-298)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-142417585), (-142417583)⟩, ⟨497307, 497309⟩, ⟨81982, 81986⟩, ⟨(-301), (-298)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-20891030), (-20891028)⟩, ⟨(-13854404), (-13854402)⟩, ⟨(-2260569), (-2260564)⟩, ⟨16077, 16081⟩, ⟨1302, 1305⟩⟩
...
def j19 : Jet := ⟨⟨1410764735, 1410764738⟩, ⟨(-13854404), (-13854402)⟩, ⟨(-2260569), (-2260564)⟩, ⟨16077, 16081⟩, ⟨1302, 1305⟩⟩
...
def j25 : Jet := ⟨⟨1733, 1735⟩, ⟨1153, 1156⟩, ⟨189, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850444), (-850441)⟩, ⟨1153, 1156⟩, ⟨189, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-124751), (-124749)⟩, ⟨(-82998), (-82996)⟩, ⟨(-13723), (-13718)⟩, ⟨35, 38⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35666643, 35666646⟩, ⟨(-82998), (-82996)⟩, ⟨(-13723), (-13718)⟩, ⟨35, 38⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5231888, 5231889⟩, ⟨3475750, 3475752⟩, ⟨571189, 571193⟩, ⟨(-2691), (-2687)⟩, ⟨(-221), (-218)⟩⟩
...
def j33 : Jet := ⟨⟨(-710595995), (-710595993)⟩, ⟨3475750, 3475752⟩, ⟨571189, 571193⟩, ⟨(-2691), (-2687)⟩, ⟨(-221), (-218)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-104236298), (-104236296)⟩, ⟨(-68981014), (-68981010)⟩, ⟨(-11158125), (-11158119)⟩, ⟨112112, 112116⟩, ⟨9012, 9017⟩⟩
...
def j36 : Jet := ⟨⟨4190730998, 4190731000⟩, ⟨(-68981014), (-68981010)⟩, ⟨(-11158125), (-11158119)⟩, ⟨112112, 112116⟩, ⟨9012, 9017⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨540322066, 540322070⟩, ⟨174801126, 174801130⟩, ⟨(-2634540), (-2634536)⟩, ⟨(-282442), (-282438)⟩, ⟨2550, 2554⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4401796267, 4401796270⟩, ⟨72455223, 72455229⟩, ⟨12912734, 12912743⟩, ⟨287702, 287710⟩, ⟨27704, 27714⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨553761528, 553761533⟩, ⟨188264087, 188264093⟩, ⟨1873256, 1873265⟩, ⟨227816, 227825⟩, ⟨5121, 5131⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-523610201), (-523610200)⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3771357095, 3771357096⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨71397942, 71397945⟩, ⟨48546776, 48546780⟩, ⟨8735347, 8735355⟩, ⟨222966, 222976⟩, ⟨22109, 22116⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4366365238, 4366365241⟩, ⟨48546776, 48546780⟩, ⟨8735347, 8735355⟩, ⟨222966, 222976⟩, ⟨22109, 22116⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4330519125, 4330519128⟩, ⟨24074113, 24074116⟩, ⟨4264900, 4264905⟩, ⟨86858, 86864⟩, ⟨8380, 8386⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3802574711, 3802574716⟩, ⟨(-154842295), (-154842289)⟩, ⟨2766643, 2766649⟩, ⟨(-97048), (-97039)⟩, ⟨3828, 3835⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨29696240610, 29696240616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value359

def j47 : Jet := ⟨⟨3620342930, 3620342938⟩, ⟨1206780974, 1206780982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3051683989, 3051684003⟩, ⟨2034455988, 2034456008⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3051683989, 3051684003⟩, ⟨2034455988, 2034456008⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3051684003), (-3051683989)⟩, ⟨(-2034456008), (-2034455988)⟩, ⟨(-339076002), (-339075997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1525842002), (-1525841994)⟩, ⟨(-1017228004), (-1017227994)⟩, ⟨(-169538001), (-169537998)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3010725756, 3010725767⟩, ⟨(-713065864), (-713065853)⟩, ⟨(-34402394), (-34402388)⟩, ⟨21480845, 21480847⟩, ⟨(-592898), (-592896)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2665563864, 2665563878⟩, ⟨(-739859864), (-739859846)⟩, ⟨(-2811507), (-2811492)⟩, ⟨19731109, 19731123⟩, ⟨(-1302723), (-1302709)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨349073466, 698146934⟩, ⟨174536733, 174536734⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1096646636, 2193293280⟩, ⟨548323318, 548323322⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨280010012, 1120040057⟩, ⟨280010012, 560020032⟩, ⟨70002503, 70002505⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨70, 281⟩, ⟨70, 141⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94617), (-94405)⟩, ⟨70, 141⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-24675), (-6154)⟩, ⟨(-12334), (-6117)⟩, ⟨(-1538), (-1514)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5088381, 5106903⟩, ⟨(-12334), (-6117)⟩, ⟨(-1538), (-1514)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨331736, 1331777⟩, ⟨328519, 665491⟩, ⟨80923, 82741⟩, ⟨(-403), (-195)⟩, ⟨(-26), (-22)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142833841), (-141833799)⟩, ⟨328519, 665491⟩, ⟨80923, 82741⟩, ⟨(-403), (-195)⟩, ⟨(-26), (-22)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-37248159), (-9246841)⟩, ⟨(-18602663), (-9073294)⟩, ⟨(-2301318), (-2203358)⟩, ⟨10523, 21624⟩, ⟨1258, 1336⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1394407606, 1422408925⟩, ⟨(-18602663), (-9073294)⟩, ⟨(-2301318), (-2203358)⟩, ⟨10523, 21624⟩, ⟨1258, 1336⟩⟩
...
def j70 : Jet := ⟨⟨(-29), (-6)⟩, ⟨(-15), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11806, 11830⟩, ⟨(-15), (-6)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨769, 3086⟩, ⟨765, 1543⟩, ⟨189, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851408), (-849090)⟩, ⟨765, 1543⟩, ⟨189, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-222030), (-55356)⟩, ⟨(-110966), (-54953)⟩, ⟨(-13816), (-13586)⟩, ⟨23, 52⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35569364, 35736039⟩, ⟨(-110966), (-54953)⟩, ⟨(-13816), (-13586)⟩, ⟨23, 52⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2318941, 9319232⟩, ⟨2290003, 4656034⟩, ⟨561663, 577985⟩, ⟨(-3610), (-1766)⟩, ⟨(-225), (-212)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713508942), (-706508650)⟩, ⟨2290003, 4656034⟩, ⟨561663, 577985⟩, ⟨(-3610), (-1766)⟩, ⟨(-225), (-212)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-186068611), (-46060768)⟩, ⟨(-92885010), (-44846569)⟩, ⟨(-11443376), (-10757365)⟩, ⟨72999, 151137⟩, ⟨8624, 9293⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4108898685, 4248906528⟩, ⟨(-92885010), (-44846569)⟩, ⟨(-11443376), (-10757365)⟩, ⟨72999, 151137⟩, ⟨8624, 9293⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨356038196, 726375715⟩, ⟨168519352, 179277220⟩, ⟨(-3550142), (-1720944)⟩, ⟨(-291116), (-270251)⟩, ⟨1664, 3444⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4341527391, 4489461895⟩, ⟨45824167, 101487953⟩, ⟨11475528, 14797473⟩, ⟨77444, 540026⟩, ⟨16440, 43495⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨359897869, 759269133⟩, ⟨174144872, 204559563⟩, ⟨(-961648), 4999220⟩, ⟨68490, 417455⟩, ⟨(-13029), 26017⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-698146934), (-349073466)⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3596820362, 3945893830⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨30157732, 134224449⟩, ⟨29185026, 72324538⟩, ⟨6720919, 11510245⟩, ⟨(-80126), 623802⟩, ⟨(-174), 54785⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4325125028, 4429191745⟩, ⟨29185026, 72324538⟩, ⟨6720919, 11510245⟩, ⟨(-80126), 623802⟩, ⟨(-174), 54785⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310019784, 4361563217⟩, ⟨14369702, 36035975⟩, ⟨3160281, 5711070⟩, ⟨(-87674), 300276⟩, ⟨(-6383), 26872⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3609426068, 4007077168⟩, ⟨(-165209120), (-142041276)⟩, ⟨1182165, 4662955⟩, ⟨(-312633), 147447⟩, ⟨(-18068), 28251⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2413561948, 4827123913⟩, ⟨1206780974, 1206780982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1356303989, 5425215995⟩, ⟨1356303988, 2712608006⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1356303989, 5425215995⟩, ⟨1356303988, 2712608006⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5425215995), (-1356303989)⟩, ⟨(-2712608006), (-1356303988)⟩, ⟨(-339076002), (-339075997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2712607998), (-678151994)⟩, ⟨(-1356304003), (-678151994)⟩, ⟨(-169538001), (-169537998)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2283856983, 3667643567⟩, ⟨(-1158201986), (-360608605)⟩, ⟨(-116306180), 92721651⟩, ⟨(-270474), 42721710⟩, ⟨(-5202794), 2316868⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1919319138, 3421802726⟩, ⟨(-1221646765), (-378580777)⟩, ⟨(-95955712), 135039539⟩, ⟨(-5343359), 44358549⟩, ⟨(-6678839), 2381072⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨523610200, 523610201⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨174536733, 174536734⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4330519125, 4330519128⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar359 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1408
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar359 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨349073466, 698146934⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310019784, 4361563217⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1409
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((3251 / 40000) : ℝ)..(3251 / 20000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (3251 / 40000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (3251 / 20000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((3251 / 40000) : ℝ)..(3251 / 20000), prawitzNormalCorrection
      ((65333 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
