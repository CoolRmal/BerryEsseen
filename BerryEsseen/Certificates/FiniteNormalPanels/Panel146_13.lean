...
namespace FiniteNormalPanel146_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (184023 / 800000)
def radius : Rat := (26289 / 800000)

def j0 : Jet := ⟨⟨987965958, 987965959⟩, ⟨141137994, 141137995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3103786595, 3103786599⟩, ⟨443398085, 443398089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2242971963, 2242971969⟩, ⟨640849132, 640849140⟩, ⟨45774938, 45774939⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨561, 562⟩, ⟨160, 161⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94126), (-94124)⟩, ⟨160, 161⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-49156), (-49154)⟩, ⟨(-13962), (-13959)⟩, ⟨(-976), (-971)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5063900, 5063903⟩, ⟨(-13962), (-13959)⟩, ⟨(-976), (-971)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2644533, 2644536⟩, ⟨748289, 748293⟩, ⟨51376, 51382⟩, ⟨(-294), (-289)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140521044), (-140521040)⟩, ⟨748289, 748293⟩, ⟨51376, 51382⟩, ⟨(-294), (-289)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-73384672), (-73384668)⟩, ⟨(-20576270), (-20576264)⟩, ⟨(-1359166), (-1359159)⟩, ⟨15486, 15493⟩, ⟨497, 501⟩⟩
...
def j19 : Jet := ⟨⟨1358271093, 1358271098⟩, ⟨(-20576270), (-20576264)⟩, ⟨(-1359166), (-1359159)⟩, ⟨15486, 15493⟩, ⟨497, 501⟩⟩
...
def j22 : Jet := ⟨⟨(-57), (-55)⟩, ⟨(-17), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11778, 11781⟩, ⟨(-17), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6150, 6153⟩, ⟨1748, 1751⟩, ⟨120, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846027), (-846023)⟩, ⟨1748, 1751⟩, ⟨120, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-441823), (-441820)⟩, ⟨(-125324), (-125319)⟩, ⟨(-8695), (-8689)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35349571, 35349575⟩, ⟨(-125324), (-125319)⟩, ⟨(-8695), (-8689)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18460698, 18460701⟩, ⟨5209036, 5209041⟩, ⟨353507, 353515⟩, ⟨(-2617), (-2611)⟩, ⟨(-90), (-84)⟩⟩
...
def j33 : Jet := ⟨⟨(-697367185), (-697367181)⟩, ⟨5209036, 5209041⟩, ⟨353507, 353515⟩, ⟨(-2617), (-2611)⟩, ⟨(-90), (-84)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-364187884), (-364187880)⟩, ⟨(-101333354), (-101333348)⟩, ⟨(-6470558), (-6470549)⟩, ⟨106895, 106902⟩, ⟨3328, 3336⟩⟩
...
def j36 : Jet := ⟨⟨3930779412, 3930779416⟩, ⟨(-101333354), (-101333348)⟩, ⟨(-6470558), (-6470549)⟩, ⟨106895, 106902⟩, ⟨3328, 3336⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨981563611, 981563617⟩, ⟨125353795, 125353802⟩, ⟨(-3106437), (-3106429)⟩, ⟨(-129125), (-129118)⟩, ⟨1957, 1963⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4692897291, 4692897296⟩, ⟨120980330, 120980339⟩, ⟨10843895, 10843909⟩, ⟨351067, 351081⟩, ⟨19623, 19640⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1072505770, 1072505779⟩, ⟨164616474, 164616486⟩, ⟨2614949, 2614965⟩, ⟨168133, 168148⟩, ⟨5386, 5402⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-987965959), (-987965958)⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3307001337, 3307001338⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨267817784, 267817790⟩, ⟨82213486, 82213494⟩, ⟨7615348, 7615360⟩, ⟨284418, 284430⟩, ⟨17168, 17181⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4562785080, 4562785086⟩, ⟨82213486, 82213494⟩, ⟨7615348, 7615360⟩, ⟨284418, 284430⟩, ⟨17168, 17181⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4426851329, 4426851333⟩, ⟨39882097, 39882102⟩, ⟨3514584, 3514591⟩, ⟨106308, 106316⟩, ⟨5974, 5983⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3408548250, 3408548255⟩, ⟨(-114763802), (-114763796)⟩, ⟨1395552, 1395560⟩, ⟨(-33640), (-33632)⟩, ⟨1105, 1114⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨43768433351, 43768433359⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value599

def j47 : Jet := ⟨⟨10067998009, 10067998022⟩, ⟨1438285429, 1438285441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨23600781315, 23600781377⟩, ⟨6743080370, 6743080438⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨23600781315, 23600781377⟩, ⟨6743080370, 6743080438⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-23600781377), (-23600781315)⟩, ⟨(-6743080438), (-6743080370)⟩, ⟨(-481648606), (-481648597)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11800390689), (-11800390657)⟩, ⟨(-3371540219), (-3371540185)⟩, ⟨(-240824303), (-240824298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨275257397, 275257405⟩, ⟨(-216076480), (-216076470)⟩, ⟨69375750, 69375756⟩, ⟨(-10076152), (-10076149)⟩, ⟨32445, 32447⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨218448256, 218448264⟩, ⟨(-178836449), (-178836439)⟩, ⟨60920714, 60920724⟩, ⟨(-9922704), (-9922697)⟩, ⟨319291, 319300⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨846827964, 1129103953⟩, ⟨141137994, 141137995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2660388510, 3547184685⟩, ⟨443398085, 443398089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1647897768, 2929596042⟩, ⟨549299256, 732399016⟩, ⟨45774938, 45774939⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨412, 734⟩, ⟨137, 184⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94275), (-93952)⟩, ⟨137, 184⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-64305), (-36047)⟩, ⟨(-16025), (-11889)⟩, ⟨(-984), (-960)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5048751, 5077010⟩, ⟨(-16025), (-11889)⟩, ⟨(-984), (-960)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1937110, 3463028⟩, ⟨634772, 861196⟩, ⟨50403, 52222⟩, ⟨(-339), (-244)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141228467), (-139702548)⟩, ⟨634772, 861196⟩, ⟨50403, 52222⟩, ⟨(-339), (-244)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-96331900), (-53601227)⟩, ⟨(-23839426), (-17279653)⟩, ⟨(-1404665), (-1306445)⟩, ⟨12979, 17992⟩, ⟨471, 523⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1335323865, 1378054539⟩, ⟨(-23839426), (-17279653)⟩, ⟨(-1404665), (-1306445)⟩, ⟨12979, 17992⟩, ⟨471, 523⟩⟩
...
def j70 : Jet := ⟨⟨(-74), (-41)⟩, ⟨(-19), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11761, 11795⟩, ⟨(-19), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4512, 8046⟩, ⟨1491, 2008⟩, ⟨119, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847665), (-844130)⟩, ⟨1491, 2008⟩, ⟨119, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-578193), (-323876)⟩, ⟨(-143977), (-106588)⟩, ⟨(-8800), (-8567)⟩, ⟨28, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35213201, 35467519⟩, ⟨(-143977), (-106588)⟩, ⟨(-8800), (-8567)⟩, ⟨28, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13510639, 24192386⟩, ⟨4405339, 6007202⟩, ⟨344740, 361090⟩, ⟨(-3026), (-2199)⟩, ⟨(-92), (-81)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702317244), (-691635496)⟩, ⟨4405339, 6007202⟩, ⟨344740, 361090⟩, ⟨(-3026), (-2199)⟩, ⟨(-92), (-81)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-479050404), (-265367466)⟩, ⟨(-118072357), (-84358311)⟩, ⟨(-6789478), (-6100640)⟩, ⟨88976, 124756⟩, ⟨3094, 3537⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3815916892, 4029599830⟩, ⟨(-118072357), (-84358311)⟩, ⟨(-6789478), (-6100640)⟩, ⟨88976, 124756⟩, ⟨3094, 3537⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨827126267, 1138126002⟩, ⟨118165554, 131562390⟩, ⟨(-3621207), (-2593131)⟩, ⟨(-136974), (-120013)⟩, ⟨1630, 2290⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4577810415, 4834157713⟩, ⟨95834914, 149578834⟩, ⟨8936877, 13229465⟩, ⟨182513, 568747⟩, ⟨8474, 35194⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨881596291, 1281006400⟩, ⟨144403212, 187715727⟩, ⟨281916, 5323647⟩, ⟨739, 370178⟩, ⟨(-7537), 21255⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1129103953), (-846827964)⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3165863343, 3448139332⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨180958774, 382069824⟩, ⟨59281166, 111975264⟩, ⟨4970783, 11379935⟩, ⟨19258, 686170⟩, ⟨(-4430), 51637⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4475926070, 4677037120⟩, ⟨59281166, 111975264⟩, ⟨4970783, 11379935⟩, ⟨19258, 686170⟩, ⟨(-4430), 51637⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4384513210, 4481932784⟩, ⟨28404115, 54844184⟩, ⟨2046155, 5481756⟩, ⟨(-59138), 322824⟩, ⟨(-9636), 25555⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3231868531, 3598241303⟩, ⟨(-126344958), (-100049890)⟩, ⟨(-294008), 3467538⟩, ⟨(-227616), 191935⟩, ⟨(-18346), 22461⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8629712579, 11506283452⟩, ⟨1438285429, 1438285441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17339349537, 30825510360⟩, ⟨5779783174, 7706377642⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17339349537, 30825510360⟩, ⟨5779783174, 7706377642⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-30825510360), (-17339349537)⟩, ⟨(-7706377642), (-5779783174)⟩, ⟨(-481648606), (-481648597)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15412755180), (-8669674768)⟩, ⟨(-3853188821), (-2889891587)⟩, ⟨(-240824303), (-240824298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨118704534, 570568525⟩, ⟨(-511880094), (-79870977)⟩, ⟨(-5121701), 222958251⟩, ⟨(-63689309), 20666143⟩, ⟨(-10885886), 14428154⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨89322553, 478011378⟩, ⟨(-445627737), (-62866339)⟩, ⟨(-2469353), 202308765⟩, ⟨(-60359945), 17524903⟩, ⟨(-9768500), 14171296⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨987965958, 987965959⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4426851329, 4426851333⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar599 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2944
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar599 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨846827964, 1129103953⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4384513210, 4481932784⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2945
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((78867 / 400000) : ℝ)..(26289 / 100000), prawitzNormalCorrection
      ((263121 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
