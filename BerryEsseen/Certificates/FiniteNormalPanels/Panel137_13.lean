...
namespace FiniteNormalPanel137_13
...
def j2 : Jet := ⟨⟨2479092683, 2479092687⟩, ⟨495818536, 495818540⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1430953976, 1430953982⟩, ⟨572381588, 572381596⟩, ⟨57238158, 57238160⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨358, 359⟩, ⟨143, 144⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94329), (-94327)⟩, ⟨143, 144⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-31428), (-31426)⟩, ⟨(-12525), (-12522)⟩, ⟨(-1235), (-1232)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5081628, 5081631⟩, ⟨(-12525), (-12522)⟩, ⟨(-1235), (-1232)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1693045, 1693047⟩, ⟨673045, 673048⟩, ⟨65639, 65644⟩, ⟨(-332), (-328)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-141472532), (-141472529)⟩, ⟨673045, 673048⟩, ⟨65639, 65644⟩, ⟨(-332), (-328)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-47134395), (-47134393)⟩, ⟨(-18629520), (-18629517)⟩, ⟨(-1773813), (-1773808)⟩, ⟨17605, 17610⟩, ⟨823, 828⟩⟩
...
def j19 : Jet := ⟨⟨1384521370, 1384521373⟩, ⟨(-18629520), (-18629517)⟩, ⟨(-1773813), (-1773808)⟩, ⟨17605, 17610⟩, ⟨823, 828⟩⟩
...
def j22 : Jet := ⟨⟨(-36), (-35)⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11799, 11801⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3931, 3932⟩, ⟨1567, 1569⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848246), (-848244)⟩, ⟨1567, 1569⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-282611), (-282609)⟩, ⟨(-112523), (-112520)⟩, ⟨(-11046), (-11041)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35508783, 35508786⟩, ⟨(-112523), (-112520)⟩, ⟨(-11046), (-11041)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11830458, 11830460⟩, ⟨4694693, 4694697⟩, ⟨454541, 454546⟩, ⟨(-2961), (-2956)⟩, ⟨(-143), (-140)⟩⟩
...
def j33 : Jet := ⟨⟨(-703997425), (-703997422)⟩, ⟨4694693, 4694697⟩, ⟨454541, 454546⟩, ⟨(-2961), (-2956)⟩, ⟨(-143), (-140)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-234550778), (-234550775)⟩, ⟨(-92256182), (-92256177)⟩, ⟨(-8604941), (-8604935)⟩, ⟨122153, 122159⟩, ⟨5614, 5619⟩⟩
...
def j36 : Jet := ⟨⟨4060416518, 4060416521⟩, ⟨(-92256182), (-92256177)⟩, ⟨(-8604941), (-8604935)⟩, ⟨122153, 122159⟩, ⟨5614, 5619⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨799157842, 799157846⟩, ⟨149078446, 149078450⟩, ⟨(-3174486), (-3174481)⟩, ⟨(-194612), (-194606)⟩, ⟨2507, 2511⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4543066943, 4543066947⟩, ⟨103222411, 103222419⟩, ⟨11973081, 11973091⟩, ⟨354109, 354119⟩, ⟨24025, 24036⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨845321354, 845321360⟩, ⟨176896424, 176896432⟩, ⟨2452804, 2452814⟩, ⟨199326, 199338⟩, ⟨5884, 5896⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-789119711), (-789119710)⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3505847585, 3505847586⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨166373371, 166373375⟩, ⟨69632346, 69632350⟩, ⟨8251320, 8251328⟩, ⟨280506, 280516⟩, ⟨20134, 20145⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4461340667, 4461340671⟩, ⟨69632346, 69632350⟩, ⟨8251320, 8251328⟩, ⟨280506, 280516⟩, ⟨20134, 20145⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4377363619, 4377363622⟩, ⟨34160818, 34160821⟩, ⟨3914706, 3914711⟩, ⟨107062, 107068⟩, ⟨7290, 7298⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3573105128, 3573105133⟩, ⟨(-132967292), (-132967286)⟩, ⟨1940169, 1940176⟩, ⟨(-56460), (-56453)⟩, ⟨2015, 2024⟩⟩
...
def j47 : Jet := ⟨⟨6368732779, 6368732789⟩, ⟨1273746555, 1273746565⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9443787208, 9443787239⟩, ⟨3777514880, 3777514918⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9443787208, 9443787239⟩, ⟨3777514880, 3777514918⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9443787239), (-9443787208)⟩, ⟨(-3777514918), (-3777514880)⟩, ⟨(-377751494), (-377751487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4721893620), (-4721893604)⟩, ⟨(-1888757459), (-1888757440)⟩, ⟨(-188875747), (-188875743)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1430526284, 1430526303⟩, ⟨(-629089127), (-629089111)⟩, ⟨75415392, 75415401⟩, ⟨7388332, 7388336⟩, ⟨(-2470512), (-2470510)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1190095395, 1190095413⟩, ⟨(-567644555), (-567644537)⟩, ⟨82862295, 82862311⟩, ⟨3508801, 3508813⟩, ⟨(-2241019), (-2241008)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨631295768, 946943653⟩, ⟨157823942, 157823943⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1983274146, 2974911224⟩, ⟨495818536, 495818540⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨915810544, 2060573733⟩, ⟨457905270, 686857916⟩, ⟨57238158, 57238160⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨229, 517⟩, ⟨114, 173⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94458), (-94169)⟩, ⟨114, 173⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-45318), (-20079)⟩, ⟨(-15082), (-9956)⟩, ⟨(-1245), (-1218)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5067738, 5092978⟩, ⟨(-15082), (-9956)⟩, ⟨(-1245), (-1218)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1080587, 2443432⟩, ⟨533057, 812356⟩, ⟨64526, 66554⟩, ⟨(-401), (-258)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142084990), (-140722144)⟩, ⟨533057, 812356⟩, ⟨64526, 66554⟩, ⟨(-401), (-258)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-68167364), (-30006008)⟩, ⟨(-22608792), (-14613263)⟩, ⟨(-1822949), (-1713530)⟩, ⟨13789, 21416⟩, ⟨785, 858⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1363488401, 1401649758⟩, ⟨(-22608792), (-14613263)⟩, ⟨(-1822949), (-1713530)⟩, ⟨13789, 21416⟩, ⟨785, 858⟩⟩
...
def j70 : Jet := ⟨⟨(-52), (-22)⟩, ⟨(-18), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11783, 11814⟩, ⟨(-18), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2512, 5668⟩, ⟨1247, 1888⟩, ⟨153, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849665), (-846508)⟩, ⟨1247, 1888⟩, ⟨153, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-407640), (-180499)⟩, ⟨(-135615), (-89343)⟩, ⟨(-11160), (-10903)⟩, ⟨31, 52⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35383754, 35610896⟩, ⟨(-135615), (-89343)⟩, ⟨(-11160), (-10903)⟩, ⟨31, 52⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7544833, 17084852⟩, ⟨3707352, 5675901⟩, ⟨444509, 462731⟩, ⟨(-3587), (-2327)⟩, ⟨(-146), (-134)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708283050), (-698743030)⟩, ⟨3707352, 5675901⟩, ⟨444509, 462731⟩, ⟨(-3587), (-2327)⟩, ⟨(-146), (-134)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-339809212), (-148992108)⟩, ⟨(-112479224), (-71772957)⟩, ⟨(-8949106), (-8182303)⟩, ⟨95077, 149147⟩, ⟨5278, 5891⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3955158084, 4145975188⟩, ⟨(-112479224), (-71772957)⟩, ⟨(-8949106), (-8182303)⟩, ⟨95077, 149147⟩, ⟨5278, 5891⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨629613942, 970853399⟩, ⟨141743494, 155060979⟩, ⟨(-3872666), (-2478231)⟩, ⟨(-204078), (-182978)⟩, ⟨1953, 3068⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4449313668, 4663971372⟩, ⟨77024193, 132636894⟩, ⟨10114358, 14324907⟩, ⟨159322, 600537⟩, ⟨11318, 41704⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨652240104, 1054264712⟩, ⟨158128507, 198364945⟩, ⟨(-180720), 5459359⟩, ⟨15943, 418925⟩, ⟨(-10281), 25324⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-946943653), (-631295768)⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3348023643, 3663671528⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨99050149, 258785227⟩, ⟨48027258, 97383356⟩, ⟨5733120, 11841738⟩, ⟨(-11852), 709950⟩, ⟨(-4106), 58072⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4394017445, 4553752523⟩, ⟨48027258, 97383356⟩, ⟨5733120, 11841738⟩, ⟨(-11852), 709950⟩, ⟨(-4106), 58072⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4344210080, 4422467429⟩, ⟨23321313, 48139745⟩, ⟨2521909, 5791157⟩, ⟨(-70034), 337414⟩, ⟨(-9630), 28752⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3386409501, 3772431054⟩, ⟨(-144329607), (-118569504)⟩, ⟨196928, 4082974⟩, ⟨(-272545), 195150⟩, ⟨(-20614), 27100⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5094986223, 7642479345⟩, ⟨1273746555, 1273746565⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6044023812, 13599053617⟩, ⟨3022011904, 4533017900⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6044023812, 13599053617⟩, ⟨3022011904, 4533017900⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13599053617), (-6044023812)⟩, ⟨(-4533017900), (-3022011904)⟩, ⟨(-377751494), (-377751487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6799526809), (-3022011906)⟩, ⟨(-2266508950), (-1511005952)⟩, ⟨(-188875747), (-188875743)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨881884426, 2125117226⟩, ⟨(-1121451430), (-310254426)⟩, ⟨(-38879217), 257120300⟩, ⟨(-36132708), 39717032⟩, ⟨(-10893366), 5621801⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨695330509, 1866570259⟩, ⟨(-1056426097), (-268969016)⟩, ⟨(-25543568), 265544293⟩, ⟨(-41578030), 36273807⟩, ⟨(-11000836), 6481059⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4377363619, 4377363622⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2758
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4344210080, 4422467429⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2759
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (89588269 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((29397 / 200000) : ℝ)..(88191 / 400000), prawitzNormalCorrection
