...
namespace FiniteNormalPanel163_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (5341 / 32000)
def radius : Rat := (5341 / 160000)

def j0 : Jet := ⟨⟨716856885, 716856886⟩, ⟨143371377, 143371378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2252072323, 2252072327⟩, ⟨450414464, 450414468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1180877384, 1180877389⟩, ⟨472350952, 472350960⟩, ⟨47235095, 47235097⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨295, 296⟩, ⟨118, 119⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94392), (-94390)⟩, ⟨118, 119⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-25953), (-25952)⟩, ⟨(-10350), (-10347)⟩, ⟨(-1024), (-1020)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5087103, 5087105⟩, ⟨(-10350), (-10347)⟩, ⟨(-1024), (-1020)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1398670, 1398672⟩, ⟨556622, 556625⟩, ⟨54525, 54530⟩, ⟨(-227), (-223)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-141766907), (-141766904)⟩, ⟨556622, 556625⟩, ⟨54525, 54530⟩, ⟨(-227), (-223)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-38978024), (-38978022)⟩, ⟨(-15438170), (-15438167)⟩, ⟨(-1482914), (-1482910)⟩, ⟨12054, 12059⟩, ⟨570, 574⟩⟩
...
def j19 : Jet := ⟨⟨1392677741, 1392677744⟩, ⟨(-15438170), (-15438167)⟩, ⟨(-1482914), (-1482910)⟩, ⟨12054, 12059⟩, ⟨570, 574⟩⟩
...
def j25 : Jet := ⟨⟨3245, 3247⟩, ⟨1294, 1296⟩, ⟨126, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848932), (-848929)⟩, ⟨1294, 1296⟩, ⟨126, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-233410), (-233408)⟩, ⟨(-93009), (-93006)⟩, ⟨(-9161), (-9157)⟩, ⟨26, 30⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35557984, 35557987⟩, ⟨(-93009), (-93006)⟩, ⟨(-9161), (-9157)⟩, ⟨26, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9776470, 9776471⟩, ⟨3885015, 3885018⟩, ⟨378310, 378314⟩, ⟨(-2024), (-2020)⟩, ⟨(-100), (-95)⟩⟩
...
def j33 : Jet := ⟨⟨(-706051413), (-706051411)⟩, ⟨3885015, 3885018⟩, ⟨378310, 378314⟩, ⟨(-2024), (-2020)⟩, ⟨(-100), (-95)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-194124913), (-194124910)⟩, ⟨(-76581803), (-76581799)⟩, ⟨(-7233718), (-7233714)⟩, ⟨83774, 83779⟩, ⟨3909, 3913⟩⟩
...
def j36 : Jet := ⟨⟨4100842383, 4100842386⟩, ⟨(-76581803), (-76581799)⟩, ⟨(-7233718), (-7233714)⟩, ⟨83774, 83779⟩, ⟨3909, 3913⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨730252590, 730252594⟩, ⟨137955490, 137955495⟩, ⟨(-2396575), (-2396571)⟩, ⟨(-149194), (-149189)⟩, ⟨1562, 1566⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4498281654, 4498281658⟩, ⟨84003837, 84003844⟩, ⟨9503521, 9503529⟩, ⟨233754, 233763⟩, ⟨15118, 15128⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨764821150, 764821156⟩, ⟨158768768, 158768776⟩, ⟨1804038, 1804047⟩, ⟨141868, 141878⟩, ⟨3491, 3504⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-716856886), (-716856885)⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3578110410, 3578110411⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨136194608, 136194612⟩, ⟨56545114, 56545120⟩, ⟨6511585, 6511593⟩, ⟨183900, 183908⟩, ⟨12487, 12496⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4431161904, 4431161908⟩, ⟨56545114, 56545120⟩, ⟨6511585, 6511593⟩, ⟨183900, 183908⟩, ⟨12487, 12496⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4362533147, 4362533150⟩, ⟨27834678, 27834682⟩, ⟨3116569, 3116574⟩, ⟨70640, 70646⟩, ⟨4582, 4589⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3634399098, 3634399102⟩, ⟨(-122437915), (-122437909)⟩, ⟨1667237, 1667243⟩, ⟨(-45187), (-45179)⟩, ⟨1458, 1466⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨40406075503, 40406075510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value659

def j47 : Jet := ⟨⟨6744026537, 6744026548⟩, ⟨1348805307, 1348805318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10589578638, 10589578674⟩, ⟨4235831454, 4235831496⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10589578638, 10589578674⟩, ⟨4235831454, 4235831496⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10589578674), (-10589578638)⟩, ⟨(-4235831496), (-4235831454)⟩, ⟨(-423583153), (-423583145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5294789337), (-5294789319)⟩, ⟨(-2117915748), (-2117915727)⟩, ⟨(-211791577), (-211791572)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1251890399, 1251890414⟩, ⟨(-617326802), (-617326787)⟩, ⟨90474078, 90474087⟩, ⟨5422837, 5422841⟩, ⟨(-2899232), (-2899230)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1059349006, 1059349021⟩, ⟨(-558069635), (-558069617)⟩, ⟨94643398, 94643412⟩, ⟨1756819, 1756831⟩, ⟨(-2565883), (-2565872)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨573485508, 860228263⟩, ⟨143371377, 143371378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1801657858, 2702486792⟩, ⟨450414464, 450414468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨755761525, 1700463440⟩, ⟨377880762, 566821150⟩, ⟨47235095, 47235097⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨189, 427⟩, ⟨94, 143⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94498), (-94259)⟩, ⟨94, 143⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-37414), (-16586)⟩, ⟨(-12456), (-8236)⟩, ⟨(-1031), (-1012)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5075642, 5096471⟩, ⟨(-12456), (-8236)⟩, ⟨(-1031), (-1012)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨893132, 2017795⟩, ⟨441634, 671150⟩, ⟨53767, 55148⟩, ⟨(-274), (-177)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142272445), (-141147781)⟩, ⟨441634, 671150⟩, ⟨53767, 55148⟩, ⟨(-274), (-177)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-56328507), (-24836990)⟩, ⟨(-18698458), (-12152773)⟩, ⟨(-1516365), (-1441902)⟩, ⟨9477, 14630⟩, ⟨549, 591⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1375327258, 1406818776⟩, ⟨(-18698458), (-12152773)⟩, ⟨(-1516365), (-1441902)⟩, ⟨9477, 14630⟩, ⟨549, 591⟩⟩
...
def j72 : Jet := ⟨⟨2074, 4679⟩, ⟨1031, 1559⟩, ⟨126, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850103), (-847497)⟩, ⟨1031, 1559⟩, ⟨126, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-336573), (-149129)⟩, ⟨(-112010), (-73946)⟩, ⟨(-9238), (-9062)⟩, ⟨21, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35454821, 35642266⟩, ⟨(-112010), (-73946)⟩, ⟨(-9238), (-9062)⟩, ⟨21, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6238787, 14111486⟩, ⟨3075046, 4690818⟩, ⟨371483, 383887⟩, ⟨(-2449), (-1595)⟩, ⟨(-102), (-93)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709589096), (-701716396)⟩, ⟨3075046, 4690818⟩, ⟨371483, 383887⟩, ⟨(-2449), (-1595)⟩, ⟨(-102), (-93)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-280940513), (-123477134)⟩, ⟨(-93105741), (-59881378)⟩, ⟨(-7467988), (-6946268)⟩, ⟨65531, 101972⟩, ⟨3720, 4066⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4014026783, 4171490162⟩, ⟨(-93105741), (-59881378)⟩, ⟨(-7467988), (-6946268)⟩, ⟨65531, 101972⟩, ⟨3720, 4066⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨576923871, 885200958⟩, ⟨132465490, 142435635⟩, ⟨(-2915043), (-1879314)⟩, ⟨(-155047), (-142006)⟩, ⟨1223, 1907⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4422099383, 4595570751⟩, ⟨63478851, 106594711⟩, ⟨8274809, 11022412⟩, ⟨112148, 381792⟩, ⟨8301, 24230⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨594000959, 947155904⟩, ⟨144913332, 174374036⟩, ⟨(-49732), 3871840⟩, ⟨32028, 270246⟩, ⟨(-5499), 13979⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-860228263), (-573485508)⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3434739033, 3721481788⟩, ⟨(-143371378), (-143371377)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨82151298, 208873374⟩, ⟨40083498, 76908338⟩, ⟨4867478, 8787210⟩, ⟨4818, 433586⟩, ⟨(-311), 31601⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4377118594, 4503840670⟩, ⟨40083498, 76908338⟩, ⟨4867478, 8787210⟩, ⟨4818, 433586⟩, ⟨(-311), 31601⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4335848384, 4398164207⟩, ⟨19571496, 38091600⟩, ⟨2211682, 4308008⟩, ⟨(-35462), 204766⟩, ⟨(-4095), 15400⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3467432150, 3810899332⟩, ⟨(-131164651), (-111730618)⟩, ⟨497163, 3079461⟩, ⟨(-174534), 103597⟩, ⟨(-10385), 14528⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5395221229, 8092831856⟩, ⟨1348805307, 1348805318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6777330327, 15248993284⟩, ⟨3388665162, 5082997794⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6777330327, 15248993284⟩, ⟨3388665162, 5082997794⟩, ⟨423583145, 423583153⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15248993284), (-6777330327)⟩, ⟨(-5082997794), (-3388665162)⟩, ⟨(-423583153), (-423583145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7624496642), (-3388665163)⟩, ⟨(-2541498897), (-1694332581)⟩, ⟨(-211791577), (-211791572)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨727768320, 1951227873⟩, ⟨(-1154617287), (-287099177)⟩, ⟨(-39588866), 305728541⟩, ⟨(-50865609), 45766084⟩, ⟨(-14308370), 8500884⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨587545165, 1731313067⟩, ⟨(-1084073999), (-250714578)⟩, ⟨(-27574040), 307931193⟩, ⟨(-55376593), 41830822⟩, ⟨(-14154345), 9368906⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨716856885, 716856886⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4362533147, 4362533150⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar659 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3294
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar659 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨573485508, 860228263⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4335848384, 4398164207⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3295
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((5341 / 40000) : ℝ)..(16023 / 80000), prawitzNormalCorrection
      ((57043 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
