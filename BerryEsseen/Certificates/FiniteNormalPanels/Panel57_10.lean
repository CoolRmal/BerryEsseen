...
namespace FiniteNormalPanel57_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8327 / 40000)
def radius : Rat := (8327 / 200000)

def j0 : Jet := ⟨⟨894104816, 894104817⟩, ⟨178820963, 178820964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2808913121, 2808913125⟩, ⟨561782623, 561782627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1837032130, 1837032136⟩, ⟨734812850, 734812858⟩, ⟨73481284, 73481286⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨459, 461⟩, ⟨183, 185⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94228), (-94225)⟩, ⟨183, 185⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-40303), (-40301)⟩, ⟨(-16044), (-16040)⟩, ⟨(-1575), (-1571)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5072753, 5072756⟩, ⟨(-16044), (-16040)⟩, ⟨(-1575), (-1571)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2169704, 2169706⟩, ⟨861018, 861023⟩, ⟨83369, 83374⟩, ⟨(-543), (-538)⟩, ⟨(-26), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-140995873), (-140995870)⟩, ⟨861018, 861023⟩, ⟨83369, 83374⟩, ⟨(-543), (-538)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-60306385), (-60306383)⟩, ⟨(-23754282), (-23754278)⟩, ⟨(-2229290), (-2229284)⟩, ⟨28760, 28766⟩, ⟨1321, 1326⟩⟩
...
def j19 : Jet := ⟨⟨1371349380, 1371349383⟩, ⟨(-23754282), (-23754278)⟩, ⟨(-2229290), (-2229284)⟩, ⟨28760, 28766⟩, ⟨1321, 1326⟩⟩
...
def j22 : Jet := ⟨⟨(-47), (-45)⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11788, 11791⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5041, 5044⟩, ⟨2007, 2011⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847136), (-847132)⟩, ⟨2007, 2011⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-362335), (-362333)⟩, ⟨(-144076), (-144072)⟩, ⟨(-14068), (-14062)⟩, ⟨66, 70⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35429059, 35429062⟩, ⟨(-144076), (-144072)⟩, ⟨(-14068), (-14062)⟩, ⟨66, 70⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15153624, 15153626⟩, ⟨5999825, 5999829⟩, ⟨575476, 575484⟩, ⟨(-4844), (-4839)⟩, ⟨(-230), (-226)⟩⟩
...
def j33 : Jet := ⟨⟨(-700674259), (-700674256)⟩, ⟨5999825, 5999829⟩, ⟨575476, 575484⟩, ⟨(-4844), (-4839)⟩, ⟨(-230), (-226)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-299690555), (-299690552)⟩, ⟨(-117309994), (-117309988)⟩, ⟨(-10714991), (-10714983)⟩, ⟨199033, 199039⟩, ⟨8917, 8923⟩⟩
...
def j36 : Jet := ⟨⟨3995276741, 3995276744⟩, ⟨(-117309994), (-117309988)⟩, ⟨(-10714991), (-10714983)⟩, ⟨199033, 199039⟩, ⟨8917, 8923⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨896863934, 896863938⟩, ⟨163837460, 163837467⟩, ⟨(-4565025), (-4565018)⟩, ⟨(-272783), (-272777)⟩, ⟨4624, 4631⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4617137999, 4617138004⟩, ⟨135569182, 135569191⟩, ⟨16363363, 16363377⟩, ⟨614027, 614039⟩, ⟨44846, 44859⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨964138784, 964138791⟩, ⟨204436311, 204436323⟩, ⟨3680974, 3680988⟩, ⟨315083, 315096⟩, ⟨11752, 11769⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-894104817), (-894104816)⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3400862479, 3400862480⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨216430890, 216430894⟩, ⟨91784156, 91784164⟩, ⟨11383587, 11383599⟩, ⟨491880, 491892⟩, ⟨38424, 38437⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4511398186, 4511398190⟩, ⟨91784156, 91784164⟩, ⟨11383587, 11383599⟩, ⟨491880, 491892⟩, ⟨38424, 38437⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4401852754, 4401852756⟩, ⟨44777729, 44777734⟩, ⟨5325835, 5325842⟩, ⟨185790, 185798⟩, ⟨13632, 13642⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3485497056, 3485497060⟩, ⟨(-147815016), (-147815009)⟩, ⟨2352808, 2352815⟩, ⟨(-74629), (-74621)⟩, ⟨3058, 3068⟩⟩
...
def j47 : Jet := ⟨⟨5979040274, 5979040283⟩, ⟨1195808053, 1195808061⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8323444658, 8323444684⟩, ⟨3329377858, 3329377886⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8323444658, 8323444684⟩, ⟨3329377858, 3329377886⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8323444684), (-8323444658)⟩, ⟨(-3329377886), (-3329377858)⟩, ⟨(-332937790), (-332937785)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4161722342), (-4161722329)⟩, ⟨(-1664688943), (-1664688929)⟩, ⟨(-166468895), (-166468892)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1629816526, 1629816539⟩, ⟨(-631701568), (-631701556)⟩, ⟨59250633, 59250640⟩, ⟨8667775, 8667777⟩, ⟨(-1988137), (-1988136)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1322645857, 1322645870⟩, ⟨(-568736652), (-568736637)⟩, ⟨70717073, 70717086⟩, ⟨4620629, 4620640⟩, ⟨(-1867152), (-1867141)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨715283853, 1072925781⟩, ⟨178820963, 178820964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2247130497, 3370695752⟩, ⟨561782623, 561782627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1175700563, 2645326279⟩, ⟨587850280, 881775430⟩, ⟨73481284, 73481286⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨294, 663⟩, ⟨147, 221⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94393), (-94023)⟩, ⟨147, 221⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-58138), (-25737)⟩, ⟨(-19340), (-12731)⟩, ⟨(-1591), (-1550)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5054918, 5087320⟩, ⟨(-19340), (-12731)⟩, ⟨(-1591), (-1550)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1383728, 3133347⟩, ⟨679952, 1040965⟩, ⟨81532, 84872⟩, ⟨(-657), (-424)⟩, ⟨(-28), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141781849), (-140032229)⟩, ⟨679952, 1040965⟩, ⟨81532, 84872⟩, ⟨(-657), (-424)⟩, ⟨(-28), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-87325287), (-38332298)⟩, ⟨(-28922301), (-18525005)⟩, ⟨(-2310321), (-2129779)⟩, ⟨22387, 35119⟩, ⟨1241, 1389⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1344330478, 1393323468⟩, ⟨(-28922301), (-18525005)⟩, ⟨(-2310321), (-2129779)⟩, ⟨22387, 35119⟩, ⟨1241, 1389⟩⟩
...
def j70 : Jet := ⟨⟨(-67), (-29)⟩, ⟨(-23), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11768, 11807⟩, ⟨(-23), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3221, 7273⟩, ⟨1595, 2422⟩, ⟨194, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848956), (-844903)⟩, ⟨1595, 2422⟩, ⟨194, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-522884), (-231283)⟩, ⟨(-173859), (-114149)⟩, ⟨(-14254), (-13832)⟩, ⟨51, 84⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35268510, 35560112⟩, ⟨(-173859), (-114149)⟩, ⟨(-14254), (-13832)⟩, ⟨51, 84⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9654370, 21901936⟩, ⟨4720102, 7269399⟩, ⟨558923, 588979⟩, ⟨(-5889), (-3793)⟩, ⟨(-238), (-215)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706173513), (-693925946)⟩, ⟨4720102, 7269399⟩, ⟨558923, 588979⟩, ⟨(-5889), (-3793)⟩, ⟨(-238), (-215)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-434941462), (-189954676)⟩, ⟨(-143688412), (-90500020)⟩, ⟨(-11282671), (-10016967)⟩, ⟨153625, 244252⟩, ⟨8205, 9500⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3860025834, 4105012620⟩, ⟨(-143688412), (-90500020)⟩, ⟨(-11282671), (-10016967)⟩, ⟨153625, 244252⟩, ⟨8205, 9500⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨703354835, 1093482016⟩, ⟨153140449, 172554706⟩, ⟨(-5596187), (-3537376)⟩, ⟨(-290479), (-251013)⟩, ⟨3577, 5685⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4493711903, 4778917258⟩, ⟨99069369, 177893896⟩, ⟨13149567, 20590600⟩, ⟨247294, 1107612⟩, ⟨15892, 87924⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨735901760, 1216693800⟩, ⟨176450697, 237288987⟩, ⟨(-540955), 8688294⟩, ⟨(-45645), 765021⟩, ⟨(-23700), 56593⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1072925781), (-715283853)⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3222041515, 3579683443⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨126089761, 344669401⟩, ⟨60466294, 134440158⟩, ⟨6942658, 18032281⟩, ⟨(-85636), 1393462⟩, ⟨(-19567), 134172⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4421057057, 4639636697⟩, ⟨60466294, 134440158⟩, ⟨6942658, 18032281⟩, ⟨(-85636), 1393462⟩, ⟨(-19567), 134172⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4357556135, 4463976689⟩, ⟨29088498, 66254578⟩, ⟨2848224, 8789551⟩, ⟨(-175845), 667711⟩, ⟨(-28661), 67867⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3268995036, 3720546012⟩, ⟨(-164035771), (-126206308)⟩, ⟨(-621801), 6114641⟩, ⟨(-512513), 437926⟩, ⟨(-51689), 63887⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4783232221, 7174848344⟩, ⟨1195808053, 1195808061⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5327004585, 11985760359⟩, ⟨2663502286, 3995253466⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5327004585, 11985760359⟩, ⟨2663502286, 3995253466⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11985760359), (-5327004585)⟩, ⟨(-3995253466), (-2663502286)⟩, ⟨(-332937790), (-332937785)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5992880180), (-2663502292)⟩, ⟨(-1997626733), (-1331751143)⟩, ⟨(-166468895), (-166468892)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1064087670, 2310118890⟩, ⟨(-1074456436), (-329944298)⟩, ⟨(-38384715), 208626491⟩, ⟨(-23819113), 33714303⟩, ⟨(-7963288), 3513498⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨809900767, 2001156943⟩, ⟨(-1018984882), (-282395828)⟩, ⟨(-23890167), 225049281⟩, ⟨(-30406798), 31062367⟩, ⟨(-8377896), 4412900⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨894104816, 894104817⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4401852754, 4401852756⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1126
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨715283853, 1072925781⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4357556135, 4463976689⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1127
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (112173085 / 4294967296)

theorem envelope_integral : (∫ s in ((8327 / 50000) : ℝ)..(24981 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((8327 / 50000) : ℝ)..(24981 / 100000), prawitzNormalCorrection
