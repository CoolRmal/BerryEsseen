...
namespace FiniteNormalPanel42_17

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (34583 / 800000)
def radius : Rat := (34583 / 800000)

def j0 : Jet := ⟨⟨185666067, 185666068⟩, ⟨185666067, 185666068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨583287152, 583287156⟩, ⟨583287152, 583287156⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨79214550, 79214552⟩, ⟨158429100, 158429104⟩, ⟨79214550, 79214552⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨19, 20⟩, ⟨39, 40⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94668), (-94666)⟩, ⟨39, 40⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1747), (-1745)⟩, ⟨(-3493), (-3490)⟩, ⟨(-1746), (-1742)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111309, 5111312⟩, ⟨(-3493), (-3490)⟩, ⟨(-1746), (-1742)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨94270, 94271⟩, ⟨188476, 188478⟩, ⟨94108, 94111⟩, ⟨(-130), (-127)⟩, ⟨(-33), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-143071307), (-143071305)⟩, ⟨188476, 188478⟩, ⟨94108, 94111⟩, ⟨(-130), (-127)⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2638747), (-2638746)⟩, ⟨(-5274017), (-5274015)⟩, ⟨(-2630060), (-2630057)⟩, ⟨6944, 6947⟩, ⟨1729, 1732⟩⟩
...
def j19 : Jet := ⟨⟨1429017018, 1429017020⟩, ⟨(-5274017), (-5274015)⟩, ⟨(-2630060), (-2630057)⟩, ⟨6944, 6947⟩, ⟨1729, 1732⟩⟩
...
def j25 : Jet := ⟨⟨218, 219⟩, ⟨435, 437⟩, ⟨216, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851959), (-851957)⟩, ⟨435, 437⟩, ⟨216, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-15714), (-15713)⟩, ⟨(-31419), (-31417)⟩, ⟨(-15695), (-15691)⟩, ⟨14, 18⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨35775680, 35775682⟩, ⟨(-31419), (-31417)⟩, ⟨(-15695), (-15691)⟩, ⟨14, 18⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨659831, 659832⟩, ⟨1319082, 1319084⟩, ⟨658382, 658385⟩, ⟨(-1159), (-1156)⟩, ⟨(-290), (-287)⟩⟩
...
def j33 : Jet := ⟨⟨(-715168052), (-715168050)⟩, ⟨1319082, 1319084⟩, ⟨658382, 658385⟩, ⟨(-1159), (-1156)⟩, ⟨(-290), (-287)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-13190256), (-13190255)⟩, ⟨(-26356184), (-26356181)⟩, ⟨(-13129457), (-13129454)⟩, ⟨48591, 48594⟩, ⟨12093, 12096⟩⟩
...
def j36 : Jet := ⟨⟨4281777040, 4281777041⟩, ⟨(-26356184), (-26356181)⟩, ⟨(-13129457), (-13129454)⟩, ⟨48591, 48594⟩, ⟨12093, 12096⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨194070689, 194070692⟩, ⟨193354439, 193354444⟩, ⟨(-1073431), (-1073428)⟩, ⟨(-356238), (-356236)⟩, ⟨1177, 1180⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4308198184, 4308198186⟩, ⟨26518813, 26518818⟩, ⟨13373704, 13373710⟩, ⟨114742, 114749⟩, ⟨29240, 29248⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨194668534, 194668538⟩, ⟨195148346, 195148353⟩, ⟨721406, 721413⟩, ⟨243288, 243295⟩, ⟨2123, 2131⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-185666068), (-185666067)⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4109301228, 4109301229⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8823312, 8823313⟩, ⟨17690118, 17690122⟩, ⟨8932254, 8932258⟩, ⟨87608, 87614⟩, ⟨22421, 22426⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303790608, 4303790609⟩, ⟨17690118, 17690122⟩, ⟨8932254, 8932258⟩, ⟨87608, 87614⟩, ⟨22421, 22426⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299376688, 4299376690⟩, ⟨8835987, 8835990⟩, ⟨4452466, 4452469⟩, ⟨34607, 34612⟩, ⟨8821, 8826⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4113520007, 4113520011⟩, ⟨(-177402663), (-177402657)⟩, ⟨3878022, 3878027⟩, ⟨(-159365), (-159358)⟩, ⟨6942, 6949⟩⟩
...
def j47 : Jet := ⟨⟨1154233244, 1154233252⟩, ⟨1154233244, 1154233252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨310189645, 310189650⟩, ⟨620379290, 620379300⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨310189645, 310189650⟩, ⟨620379290, 620379300⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-310189650), (-310189645)⟩, ⟨(-620379300), (-620379290)⟩, ⟨(-310189650), (-310189645)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-155094825), (-155094822)⟩, ⟨(-310189650), (-310189645)⟩, ⟨(-155094825), (-155094822)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4142639367, 4142639371⟩, ⟨(-299188276), (-299188269)⟩, ⟨(-138790203), (-138790197)⟩, ⟨10543842, 10543844⟩, ⟨2315540, 2315542⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3967627398, 3967627406⟩, ⟨(-457659416), (-457659401)⟩, ⟨(-116828420), (-116828406)⟩, ⟨15407240, 15407254⟩, ⟨1674682, 1674697⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 371332135⟩, ⟨185666067, 185666068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1166574308⟩, ⟨583287152, 583287156⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 316858203⟩, ⟨0, 316858204⟩, ⟨79214550, 79214552⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 80⟩, ⟨0, 80⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94606)⟩, ⟨0, 80⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6986), 0⟩, ⟨(-6986), 6⟩, ⟨(-1747), (-1736)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106070, 5113057⟩, ⟨(-6986), 6⟩, ⟨(-1747), (-1736)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 377213⟩, ⟨(-516), 377214⟩, ⟨93529, 94305⟩, ⟨(-258), 2⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142788363)⟩, ⟨(-516), 377214⟩, ⟨93529, 94305⟩, ⟨(-258), 2⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-10561941), 0⟩, ⟨(-10561980), 27829⟩, ⟨(-2640525), (-2598740)⟩, ⟨(-30), 13917⟩, ⟨1702, 1741⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421093824, 1431655766⟩, ⟨(-10561980), 27829⟩, ⟨(-2640525), (-2598740)⟩, ⟨(-30), 13917⟩, ⟨1702, 1741⟩⟩
...
def j72 : Jet := ⟨⟨0, 874⟩, ⟨(-1), 874⟩, ⟨216, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851302)⟩, ⟨(-1), 874⟩, ⟨216, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-62869), 0⟩, ⟨(-62870), 65⟩, ⟨(-15719), (-15619)⟩, ⟨(-2), 34⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35728525, 35791395⟩, ⟨(-62870), 65⟩, ⟨(-15719), (-15619)⟩, ⟨(-2), 34⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2640486⟩, ⟨(-4639), 2640491⟩, ⟨653162, 660127⟩, ⟨(-2321), 5⟩, ⟨(-291), (-284)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713187396)⟩, ⟨(-4639), 2640491⟩, ⟨653162, 660127⟩, ⟨(-2321), 5⟩, ⟨(-291), (-284)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-52809701), 0⟩, ⟨(-52810044), 194801⟩, ⟨(-13202769), (-12910222)⟩, ⟨(-258), 97403⟩, ⟨11852, 12177⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4242157595, 4294967296⟩, ⟨(-52810044), 194801⟩, ⟨(-13202769), (-12910222)⟩, ⟨(-258), 97403⟩, ⟨11852, 12177⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 388858103⟩, ⟨190125878, 194436612⟩, ⟨(-2151598), 3780⟩, ⟨(-358612), (-349146)⟩, ⟨(-5), 2364⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4348434414⟩, ⟨(-199683), 54133070⟩, ⟨12907766, 14207429⟩, ⟨(-101119), 345610⟩, ⟨23998, 36527⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 393698914⟩, ⟨190107799, 201758217⟩, ⟨(-2187423), 3740790⟩, ⟨172037, 325428⟩, ⟨(-16222), 21379⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-371332135), 0⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3923635161, 4294967296⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 36088479⟩, ⟨0, 36988404⟩, ⟨8013704, 10163495⟩, ⟨(-205512), 411114⟩, ⟨10348, 37755⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4331055775⟩, ⟨0, 36988404⟩, ⟨8013704, 10163495⟩, ⟨(-205512), 411114⟩, ⟨10348, 37755⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4312973790⟩, ⟨0, 18494202⟩, ⟨3950471, 5081748⟩, ⟨(-124639), 205557⟩, ⟨1276, 17598⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3923635161, 4312973790⟩, ⟨(-186444467), (-167171865)⟩, ⟨2809441, 5081748⟩, ⟨(-344317), 34784⟩, ⟨(-7721), 22986⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2308466497⟩, ⟨1154233244, 1154233252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1240758591⟩, ⟨0, 1240758596⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1240758591⟩, ⟨0, 1240758596⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1240758591), 0⟩, ⟨(-1240758596), 0⟩, ⟨(-310189650), (-310189645)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-620379296), 0⟩, ⟨(-620379298), 0⟩, ⟨(-155094825), (-155094822)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3717311269, 4294967296⟩, ⟨(-620379298), 0⟩, ⟨(-155094825), (-89430364)⟩, ⟨0, 22402411⟩, ⟨805732, 2800302⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3395921829, 4312973790⟩, ⟨(-809424683), (-144687913)⟩, ⟨(-153313473), (-49686033)⟩, ⟨2402532, 29263782⟩, ⟨(-432672), 2826266⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨185666067, 185666068⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299376688, 4299376690⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified834
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 371332135⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4312973790⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified835
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (10616035 / 134217728)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(34583 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (34583 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(34583 / 400000), prawitzNormalCorrection
