...
namespace FiniteNormalPanel141_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (79257 / 800000)
def radius : Rat := (26419 / 800000)

def j0 : Jet := ⟨⟨425507778, 425507779⟩, ⟨141835926, 141835927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1336772109, 1336772113⟩, ⟨445590703, 445590707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨416058970, 416058973⟩, ⟨277372646, 277372652⟩, ⟨46228774, 46228776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨104, 105⟩, ⟨69, 70⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94583), (-94581)⟩, ⟨69, 70⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9163), (-9162)⟩, ⟨(-6103), (-6101)⟩, ⟨(-1014), (-1011)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103893, 5103895⟩, ⟨(-6103), (-6101)⟩, ⟨(-1014), (-1011)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨494420, 494421⟩, ⟨329021, 329023⟩, ⟨54441, 54445⟩, ⟨(-132), (-129)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142671157), (-142671155)⟩, ⟨329021, 329023⟩, ⟨54441, 54445⟩, ⟨(-132), (-129)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13820738), (-13820737)⟩, ⟨(-9181954), (-9181951)⟩, ⟨(-1509117), (-1509113)⟩, ⟨7043, 7047⟩, ⟨574, 579⟩⟩
...
def j19 : Jet := ⟨⟨1417835027, 1417835029⟩, ⟨(-9181954), (-9181951)⟩, ⟨(-1509117), (-1509113)⟩, ⟨7043, 7047⟩, ⟨574, 579⟩⟩
...
def j25 : Jet := ⟨⟨1145, 1146⟩, ⟨762, 764⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851032), (-851030)⟩, ⟨762, 764⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-82441), (-82440)⟩, ⟨(-54888), (-54885)⟩, ⟨(-9100), (-9097)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35708953, 35708955⟩, ⟨(-54888), (-54885)⟩, ⟨(-9100), (-9097)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3459171, 3459173⟩, ⟨2300796, 2300799⟩, ⟨379925, 379928⟩, ⟨(-1178), (-1175)⟩, ⟨(-99), (-94)⟩⟩
...
def j33 : Jet := ⟨⟨(-712368712), (-712368709)⟩, ⟨2300796, 2300799⟩, ⟨379925, 379928⟩, ⟨(-1178), (-1175)⟩, ⟨(-99), (-94)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-69008068), (-69008067)⟩, ⟨(-45782499), (-45782495)⟩, ⟨(-7482174), (-7482169)⟩, ⟨49184, 49189⟩, ⟨4002, 4006⟩⟩
...
def j36 : Jet := ⟨⟨4225959228, 4225959229⟩, ⟨(-45782499), (-45782495)⟩, ⟨(-7482174), (-7482169)⟩, ⟨49184, 49189⟩, ⟨4002, 4006⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨441289115, 441289118⟩, ⟨144238565, 144238570⟩, ⟨(-1422302), (-1422299)⟩, ⟨(-154375), (-154372)⟩, ⟨908, 913⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4365102234, 4365102236⟩, ⟨47289919, 47289925⟩, ⟨8240846, 8240854⟩, ⟨122195, 122204⟩, ⟨11224, 11233⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨448495173, 448495177⟩, ⟨151452749, 151452757⟩, ⟨989326, 989334⟩, ⟨116751, 116758⟩, ⟨1748, 1760⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-425507779), (-425507778)⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3869459517, 3869459518⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨46833399, 46833401⟩, ⟨31630426, 31630430⟩, ⟨5547270, 5547275⟩, ⟨94154, 94160⟩, ⟨8823, 8832⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4341800695, 4341800697⟩, ⟨31630426, 31630430⟩, ⟨5547270, 5547275⟩, ⟨94154, 94160⟩, ⟨8823, 8832⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4318320505, 4318320507⟩, ⟨15729685, 15729688⟩, ⟨2729987, 2729991⟩, ⟨36877, 36882⟩, ⟨3389, 3396⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3890499094, 3890499098⟩, ⟨(-128435813), (-128435807)⟩, ⟨1940069, 1940075⟩, ⟨(-56932), (-56925)⟩, ⟨1835, 1843⟩⟩
...
def j47 : Jet := ⟨⟨4831956583, 4831956597⟩, ⟨1610652194, 1610652207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5436084331, 5436084363⟩, ⟨3624056218, 3624056260⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5436084331, 5436084363⟩, ⟨3624056218, 3624056260⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5436084363), (-5436084331)⟩, ⟨(-3624056260), (-3624056218)⟩, ⟨(-604009380), (-604009369)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2718042182), (-2718042165)⟩, ⟨(-1812028130), (-1812028109)⟩, ⟨(-302004690), (-302004684)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2280969172, 2280969191⟩, ⟨(-962331039), (-962331019)⟩, ⟨42613137, 42613150⟩, ⟨39118708, 39118713⟩, ⟨(-5624196), (-5624194)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2066164393, 2066164413⟩, ⟨(-939915463), (-939915438)⟩, ⟨68407823, 68407844⟩, ⟨33695572, 33695586⟩, ⟨(-6231373), (-6231361)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨283671852, 567343705⟩, ⟨141835926, 141835927⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨891181406, 1782362816⟩, ⟨445590703, 445590707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨184915097, 739660396⟩, ⟨184915096, 369830202⟩, ⟨46228774, 46228776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨46, 186⟩, ⟨46, 93⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94641), (-94500)⟩, ⟨46, 93⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-16299), (-4068)⟩, ⟨(-8149), (-4051)⟩, ⟨(-1018), (-1005)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096757, 5108989⟩, ⟨(-8149), (-4051)⟩, ⟨(-1018), (-1005)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨219435, 879848⟩, ⟨218031, 439750⟩, ⟨53980, 54774⟩, ⟨(-176), (-85)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142946142), (-142285728)⟩, ⟨218031, 439750⟩, ⟨53980, 54774⟩, ⟨(-176), (-85)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-24617557), (-6125955)⟩, ⟨(-12299392), (-6050223)⟩, ⟨(-1526887), (-1484189)⟩, ⟨4639, 9448⟩, ⟨563, 587⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407038208, 1425529811⟩, ⟨(-12299392), (-6050223)⟩, ⟨(-1526887), (-1484189)⟩, ⟨4639, 9448⟩, ⟨563, 587⟩⟩
...
def j72 : Jet := ⟨⟨508, 2038⟩, ⟨506, 1019⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851669), (-850138)⟩, ⟨506, 1019⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-146671), (-36601)⟩, ⟨(-73315), (-36425)⟩, ⟨(-9141), (-9039)⟩, ⟨9, 23⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35644723, 35754794⟩, ⟨(-73315), (-36425)⟩, ⟨(-9141), (-9039)⟩, ⟨9, 23⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1534644, 6157534⟩, ⟨1522018, 3077199⟩, ⟨375773, 382889⟩, ⟨(-1578), (-777)⟩, ⟨(-100), (-94)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714293239), (-709670348)⟩, ⟨1522018, 3077199⟩, ⟨375773, 382889⟩, ⟨(-1578), (-777)⟩, ⟨(-100), (-94)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-123012444), (-30554076)⟩, ⟨(-61440695), (-30024134)⟩, ⟨(-7606572), (-7307608)⟩, ⟨32288, 66059⟩, ⟨3890, 4085⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4171954852, 4264413220⟩, ⟨(-61440695), (-30024134)⟩, ⟨(-7606572), (-7307608)⟩, ⟨32288, 66059⟩, ⟨3890, 4085⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨291952464, 591578737⟩, ⟨140872123, 146639299⟩, ⟨(-1909669), (-935653)⟩, ⟨(-157449), (-150059)⟩, ⟨597, 1225⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4325740288, 4421606832⟩, ⟨30455914, 65117340⟩, ⟨7627127, 9020743⟩, ⟨37394, 218099⟩, ⟨8087, 15393⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨294044272, 609021771⟩, ⟨143951712, 159932152⟩, ⟨(-448586), 2523386⟩, ⟨61659, 180261⟩, ⟨(-4023), 8105⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-567343705), (-283671852)⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3727623591, 4011295444⟩, ⟨(-141835927), (-141835926)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨20131011, 86358637⟩, ⟨19710592, 45356418⟩, ⟨4697518, 6671039⟩, ⟨(-24968), 239050⟩, ⟨2726, 17209⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4315098307, 4381325933⟩, ⟨19710592, 45356418⟩, ⟨4697518, 6671039⟩, ⟨(-24968), 239050⟩, ⟨2726, 17209⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305021034, 4337931719⟩, ⟨9757685, 22625248⟩, ⟨2266492, 3316672⟩, ⟨(-29887), 114109⟩, ⟨(-519), 8146⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3736349280, 4051422175⟩, ⟨(-134786031), (-121037031)⟩, ⟨1219928, 2775380⟩, ⟨(-137443), 31725⟩, ⟨(-4254), 8595⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3221304389, 6442608791⟩, ⟨1610652194, 1610652207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2416037480, 9664149963⟩, ⟨2416037480, 4832075010⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2416037480, 9664149963⟩, ⟨2416037480, 4832075010⟩, ⟨604009369, 604009380⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9664149963), (-2416037480)⟩, ⟨(-4832075010), (-2416037480)⟩, ⟨(-604009380), (-604009369)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4832074982), (-1208018740)⟩, ⟨(-2416037505), (-1208018740)⟩, ⟨(-302004690), (-302004684)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1394294855, 3241966729⟩, ⟨(-1823695658), (-392164642)⟩, ⟨(-172811105), 414898382⟩, ⟨(-59413642), 117893595⟩, ⟨(-31166586), 14431142⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1212948136, 3058131761⟩, ⟨(-1822023853), (-380451182)⟩, ⟨(-151564220), 450698402⟩, ⟨(-70347287), 116544239⟩, ⟨(-33227420), 15810319⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨425507778, 425507779⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4318320505, 4318320507⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2838
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨283671852, 567343705⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305021034, 4337931719⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2839
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (138179897 / 4294967296)

theorem envelope_integral : (∫ s in ((26419 / 400000) : ℝ)..(26419 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26419 / 400000) : ℝ)..(26419 / 200000), prawitzNormalCorrection
