...
namespace FiniteNormalPanel150_15
...
def j2 : Jet := ⟨⟨1396124610, 1396124615⟩, ⟨465374870, 465374874⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨453825091, 453825095⟩, ⟨302550060, 302550066⟩, ⟨50425010, 50425012⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-9994), (-9992)⟩, ⟨(-6656), (-6652)⟩, ⟨(-1105), (-1102)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103062, 5103065⟩, ⟨(-6656), (-6652)⟩, ⟨(-1105), (-1102)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨539211, 539213⟩, ⟨358770, 358773⟩, ⟨59326, 59329⟩, ⟨(-157), (-154)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-142626366), (-142626363)⟩, ⟨358770, 358773⟩, ⟨59326, 59329⟩, ⟨(-157), (-154)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15070528), (-15070527)⟩, ⟨(-10009110), (-10009108)⟩, ⟨(-1642964), (-1642960)⟩, ⟨8374, 8377⟩, ⟨682, 686⟩⟩
...
def j19 : Jet := ⟨⟨1416585237, 1416585239⟩, ⟨(-10009110), (-10009108)⟩, ⟨(-1642964), (-1642960)⟩, ⟨8374, 8377⟩, ⟨682, 686⟩⟩
...
def j25 : Jet := ⟨⟨1249, 1250⟩, ⟨831, 833⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850928), (-850926)⟩, ⟨831, 833⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-89913), (-89912)⟩, ⟨(-59855), (-59852)⟩, ⟨(-9919), (-9916)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35701481, 35701483⟩, ⟨(-59855), (-59852)⟩, ⟨(-9919), (-9916)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3772375, 3772376⟩, ⟨2508591, 2508593⟩, ⟨413886, 413890⟩, ⟨(-1401), (-1397)⟩, ⟨(-117), (-113)⟩⟩
...
def j33 : Jet := ⟨⟨(-712055508), (-712055506)⟩, ⟨2508591, 2508593⟩, ⟨413886, 413890⟩, ⟨(-1401), (-1397)⟩, ⟨(-117), (-113)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-75238911), (-75238909)⟩, ⟨(-49894206), (-49894203)⟩, ⟨(-8139435), (-8139431)⟩, ⟨58458, 58462⟩, ⟨4747, 4751⟩⟩
...
def j36 : Jet := ⟨⟨4219728385, 4219728387⟩, ⟨(-49894206), (-49894203)⟩, ⟨(-8139435), (-8139431)⟩, ⟨58458, 58462⟩, ⟨4747, 4751⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨460476035, 460476038⟩, ⟨150238443, 150238448⟩, ⟨(-1618586), (-1618583)⟩, ⟨(-175299), (-175296)⟩, ⟨1128, 1131⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4371547735, 4371547738⟩, ⟨51689319, 51689324⟩, ⟨9043450, 9043457⟩, ⟨146065, 146073⟩, ⟨13531, 13540⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨468686448, 468686452⟩, ⟨158458998, 158459005⟩, ⟨1130226, 1130233⟩, ⟨134095, 134103⟩, ⟨2188, 2197⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-444400267), (-444400266)⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3850567029, 3850567030⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨51145205, 51145207⟩, ⟨34583538, 34583542⟩, ⟨6092873, 6092879⟩, ⟨112662, 112666⟩, ⟨10667, 10674⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4346112501, 4346112503⟩, ⟨34583538, 34583542⟩, ⟨6092873, 6092879⟩, ⟨112662, 112666⟩, ⟨10667, 10674⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320464217, 4320464219⟩, ⟨17189722, 17189725⟩, ⟨2994261, 2994266⟩, ⟨44085, 44089⟩, ⟨4088, 4094⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3873425783, 3873425787⟩, ⟨(-133601711), (-133601705)⟩, ⟨2091570, 2091577⟩, ⟨(-63750), (-63744)⟩, ⟨2144, 2151⟩⟩
...
def j47 : Jet := ⟨⟨3918794161, 3918794171⟩, ⟨1306264720, 1306264730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3575568012, 3575568031⟩, ⟨2383712006, 2383712032⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3575568012, 3575568031⟩, ⟨2383712006, 2383712032⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3575568031), (-3575568012)⟩, ⟨(-2383712032), (-2383712006)⟩, ⟨(-397285341), (-397285334)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1787784016), (-1787784006)⟩, ⟨(-1191856016), (-1191856003)⟩, ⟨(-198642671), (-198642667)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2832594389, 2832594400⟩, ⟨(-786046656), (-786046643)⟩, ⟨(-21943570), (-21943562)⟩, ⟨26266274, 26266277⟩, ⟨(-1314782), (-1314780)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2554581532, 2554581546⟩, ⟨(-797010225), (-797010206)⟩, ⟨6040778, 6040794⟩, ⟨23946048, 23946061⟩, ⟨(-2000402), (-2000389)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨296266844, 592533689⟩, ⟨148133422, 148133423⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨930749740, 1861499485⟩, ⟨465374870, 465374874⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨201700040, 806800168⟩, ⟨201700040, 403400086⟩, ⟨50425010, 50425012⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨50, 203⟩, ⟨50, 102⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94637), (-94483)⟩, ⟨50, 102⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-17778), (-4437)⟩, ⟨(-8887), (-4417)⟩, ⟨(-1110), (-1096)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095278, 5108620⟩, ⟨(-8887), (-4417)⟩, ⟨(-1110), (-1096)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨239284, 959644⟩, ⟨237614, 479615⟩, ⟨58777, 59720⟩, ⟨(-210), (-101)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142926293), (-142205932)⟩, ⟨237614, 479615⟩, ⟨58777, 59720⟩, ⟨(-210), (-101)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-26848391), (-6678267)⟩, ⟨(-13413038), (-6588172)⟩, ⟨(-1664107), (-1613299)⟩, ⟨5509, 11237⟩, ⟨667, 698⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1404807374, 1424977499⟩, ⟨(-13413038), (-6588172)⟩, ⟨(-1664107), (-1613299)⟩, ⟨5509, 11237⟩, ⟨667, 698⟩⟩
...
def j72 : Jet := ⟨⟨554, 2223⟩, ⟨551, 1112⟩, ⟨135, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851623), (-849953)⟩, ⟨551, 1112⟩, ⟨135, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-159976), (-39915)⟩, ⟨(-79963), (-39706)⟩, ⟨(-9968), (-9846)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35631418, 35751480⟩, ⟨(-79963), (-39706)⟩, ⟨(-9968), (-9846)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1673320, 6715837⟩, ⟨1658299, 3356055⟩, ⟨408946, 417414⟩, ⟨(-1876), (-922)⟩, ⟨(-119), (-111)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714154563), (-709112045)⟩, ⟨1658299, 3356055⟩, ⟨408946, 417414⟩, ⟨(-1876), (-922)⟩, ⟨(-119), (-111)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-134152366), (-33301284)⟩, ⟨(-66998307), (-32670856)⟩, ⟨(-8287444), (-7931696)⟩, ⟨38320, 78565⟩, ⟨4601, 4853⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4160814930, 4261666012⟩, ⟨(-66998307), (-32670856)⟩, ⟨(-8287444), (-7931696)⟩, ⟨38320, 78565⟩, ⟨4601, 4853⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨304431677, 617605374⟩, ⟨146402437, 152973642⟩, ⟨(-2174599), (-1063464)⟩, ⟨(-179119), (-169935)⟩, ⟨740, 1521⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4328528801, 4433444983⟩, ⟨33183439, 71388254⟩, ⟨8310530, 9979974⟩, ⟨43737, 263027⟩, ⟨9436, 19025⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨306810550, 637518114⟩, ⟨149898523, 168171246⟩, ⟨(-524532), 2905953⟩, ⟨65340, 213802⟩, ⟨(-5128), 10307⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-592533689), (-296266844)⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3702433607, 3998700452⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21916980, 94629207⟩, ⟨21415970, 49924580⟩, ⟨5075885, 7447500⟩, ⟨(-31744), 291040⟩, ⟨2681, 21771⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316884276, 4389596503⟩, ⟨21415970, 49924580⟩, ⟨5075885, 7447500⟩, ⟨(-31744), 291040⟩, ⟨2681, 21771⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305911841, 4342024116⟩, ⟨10591936, 24898843⟩, ⟨2439047, 3701258⟩, ⟨(-37235), 139151⟩, ⟨(-1059), 10383⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3711868242, 4042511293⟩, ⟨(-140625741), (-125329578)⟩, ⟨1243794, 3080631⟩, ⟨(-162324), 45431⟩, ⟨(-5786), 10952⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2612529440, 5225058892⟩, ⟨1306264720, 1306264730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1589141337, 6356565381⟩, ⟨1589141336, 3178282708⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1589141337, 6356565381⟩, ⟨1589141336, 3178282708⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6356565381), (-1589141337)⟩, ⟨(-3178282708), (-1589141336)⟩, ⟨(-397285341), (-397285334)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3178282691), (-794570668)⟩, ⟨(-1589141354), (-794570668)⟩, ⟨(-198642671), (-198642667)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2049185372, 3569564292⟩, ⟨(-1320741660), (-379100113)⟩, ⟨(-130025873), 149562711⟩, ⟨(-6757163), 56759517⟩, ⟨(-8708912), 3631894⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1770981146, 3359747111⟩, ⟨(-1359983744), (-387428608)⟩, ⟨(-110727234), 186575516⟩, ⟨(-12339193), 57608501⟩, ⟨(-10167471), 3805954⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320464217, 4320464219⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3030
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305911841, 4342024116⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3031
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (22050805 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((3449 / 50000) : ℝ)..(3449 / 25000), prawitzNormalCorrection
