...
namespace FiniteNormalPanel129_16
...
def j2 : Jet := ⟨⟨2686885463, 2686885467⟩, ⟨537377092, 537377096⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1680886720, 1680886726⟩, ⟨672354686, 672354694⟩, ⟨67235468, 67235470⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨420, 422⟩, ⟨168, 169⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94267), (-94264)⟩, ⟨168, 169⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-36893), (-36891)⟩, ⟨(-14693), (-14689)⟩, ⟨(-1444), (-1441)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5076163, 5076166⟩, ⟨(-14693), (-14689)⟩, ⟨(-1444), (-1441)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1986616, 1986619⟩, ⟨788895, 788900⟩, ⟨76597, 76603⟩, ⟨(-457), (-451)⟩, ⟨(-23), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-141178961), (-141178957)⟩, ⟨788895, 788900⟩, ⟨76597, 76603⟩, ⟨(-457), (-451)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-55252072), (-55252070)⟩, ⟨(-21792086), (-21792081)⟩, ⟨(-2056609), (-2056603)⟩, ⟨24160, 24166⟩, ⟨1117, 1123⟩⟩
...
def j19 : Jet := ⟨⟨1376403693, 1376403696⟩, ⟨(-21792086), (-21792081)⟩, ⟨(-2056609), (-2056603)⟩, ⟨24160, 24166⟩, ⟨1117, 1123⟩⟩
...
def j22 : Jet := ⟨⟨(-43), (-41)⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11792, 11795⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4614, 4617⟩, ⟨1838, 1841⟩, ⟨180, 183⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847563), (-847559)⟩, ⟨1838, 1841⟩, ⟨180, 183⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-331704), (-331702)⟩, ⟨(-131963), (-131959)⟩, ⟨(-12912), (-12907)⟩, ⟨55, 58⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35459690, 35459693⟩, ⟨(-131963), (-131959)⟩, ⟨(-12912), (-12907)⟩, ⟨55, 58⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13877572, 13877575⟩, ⟨5499383, 5499387⟩, ⟨529389, 529395⟩, ⟨(-4067), (-4062)⟩, ⟨(-195), (-190)⟩⟩
...
def j33 : Jet := ⟨⟨(-701950311), (-701950307)⟩, ⟨5499383, 5499387⟩, ⟨529389, 529395⟩, ⟨(-4067), (-4062)⟩, ⟨(-195), (-190)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-274716635), (-274716631)⟩, ⟨(-107734406), (-107734401)⟩, ⟨(-9920585), (-9920578)⟩, ⟨167370, 167377⟩, ⟨7573, 7579⟩⟩
...
def j36 : Jet := ⟨⟨4020250661, 4020250665⟩, ⟨(-107734406), (-107734401)⟩, ⟨(-9920585), (-9920578)⟩, ⟨167370, 167377⟩, ⟨7573, 7579⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨861063383, 861063388⟩, ⟨158579780, 158579787⟩, ⟨(-4013173), (-4013166)⟩, ⟨(-242205), (-242199)⟩, ⟨3720, 3727⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4588456196, 4588456201⟩, ⟨122961133, 122961140⟩, ⟨14617814, 14617825⟩, ⟨504117, 504130⟩, ⟨35810, 35822⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨919902607, 919902614⟩, ⟨194067531, 194067542⟩, ⟨3183200, 3183212⟩, ⟨267138, 267150⟩, ⟨9172, 9187⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-855262207), (-855262206)⟩, ⟨(-171052442), (-171052441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3439705089, 3439705090⟩, ⟨(-171052442), (-171052441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨197026135, 197026139⟩, ⟨83131356, 83131362⟩, ⟨10132479, 10132489⟩, ⟨402096, 402106⟩, ⟨30427, 30440⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4491993431, 4491993435⟩, ⟨83131356, 83131362⟩, ⟨10132479, 10132489⟩, ⟨402096, 402106⟩, ⟨30427, 30440⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4392375767, 4392375770⟩, ⟨40643887, 40643891⟩, ⟨4765842, 4765848⟩, ⟨152489, 152496⟩, ⟨10878, 10887⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3517716489, 3517716493⟩, ⟨(-142381439), (-142381432)⟩, ⟨2198119, 2198126⟩, ⟨(-67683), (-67675)⟩, ⟨2637, 2647⟩⟩
...
def j47 : Jet := ⟨⟨5940177067, 5940177076⟩, ⟨1188035412, 1188035420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8215593078, 8215593103⟩, ⟨3286237226, 3286237256⟩, ⟨328623722, 328623727⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8215593078, 8215593103⟩, ⟨3286237226, 3286237256⟩, ⟨328623722, 328623727⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8215593103), (-8215593078)⟩, ⟨(-3286237256), (-3286237226)⟩, ⟨(-328623727), (-328623722)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4107796552), (-4107796539)⟩, ⟨(-1643118628), (-1643118613)⟩, ⟨(-164311864), (-164311861)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1650408815, 1650408824⟩, ⟨(-631394210), (-631394200)⟩, ⟨57636301, 57636307⟩, ⟨8753487, 8753489⟩, ⟨(-1939694), (-1939693)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1351737953, 1351737963⟩, ⟨(-571844497), (-571844484)⟩, ⟨68981844, 68981857⟩, ⟨4909548, 4909558⟩, ⟨(-1838399), (-1838389)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨684209765, 1026314648⟩, ⟨171052441, 171052442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2149508371, 3224262559⟩, ⟨537377092, 537377096⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1075767501, 2420476883⟩, ⟨537883748, 806825632⟩, ⟨67235468, 67235470⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨269, 607⟩, ⟨134, 203⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94418), (-94079)⟩, ⟨134, 203⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-53211), (-23564)⟩, ⟨(-17704), (-11667)⟩, ⟨(-1459), (-1423)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5059845, 5089493⟩, ⟨(-17704), (-11667)⟩, ⟨(-1459), (-1423)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1267347, 2868241⟩, ⟨623695, 953159⟩, ⟨75060, 77857⟩, ⟨(-552), (-355)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141898230), (-140297335)⟩, ⟨623695, 953159⟩, ⟨75060, 77857⟩, ⟨(-552), (-355)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-79968336), (-35140503)⟩, ⟨(-26499895), (-17033087)⟩, ⟨(-2124435), (-1973348)⟩, ⟨18851, 29460⟩, ⟨1058, 1171⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1351687429, 1396515263⟩, ⟨(-26499895), (-17033087)⟩, ⟨(-2124435), (-1973348)⟩, ⟨18851, 29460⟩, ⟨1058, 1171⟩⟩
...
def j72 : Jet := ⟨⟨2949, 6656⟩, ⟨1462, 2216⟩, ⟨178, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849228), (-845520)⟩, ⟨1462, 2216⟩, ⟨178, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-478592), (-211778)⟩, ⟨(-159165), (-104640)⟩, ⟨(-13068), (-12715)⟩, ⟨42, 70⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35312802, 35579617⟩, ⟨(-159165), (-104640)⟩, ⟨(-13068), (-12715)⟩, ⟨42, 70⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8844855, 20051292⟩, ⟨4332727, 6657555⟩, ⟨515538, 540693⟩, ⟨(-4937), (-3190)⟩, ⟨(-200), (-183)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706983028), (-695776590)⟩, ⟨4332727, 6657555⟩, ⟨515538, 540693⟩, ⟨(-4937), (-3190)⟩, ⟨(-200), (-183)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-398428198), (-174272303)⟩, ⟨(-131724175), (-83384211)⟩, ⟨(-10395712), (-9336657)⟩, ⟨129606, 204994⟩, ⟨7029, 8021⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3896539098, 4120694993⟩, ⟨(-131724175), (-83384211)⟩, ⟨(-10395712), (-9336657)⟩, ⟨129606, 204994⟩, ⟨7029, 8021⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨676480923, 1048373961⟩, ⟨149226569, 166204422⟩, ⟨(-4910440), (-3118747)⟩, ⟨(-256371), (-224785)⟩, ⟨2887, 4566⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4476609917, 4734135501⟩, ⟨90586317, 160039482⟩, ⟨11976143, 18040569⟩, ⟨212079, 887946⟩, ⟨14248, 67063⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨705090632, 1155572103⟩, ⟨169805496, 222263737⟩, ⟨(-378857), 7346070⟩, ⟨(-16052), 614798⟩, ⟨(-17558), 42328⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1026314648), (-684209765)⟩, ⟨(-171052442), (-171052441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3268652648, 3610757531⟩, ⟨(-171052442), (-171052441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨115752406, 310909675⟩, ⟨55752816, 119601272⟩, ⟨6509551, 15455066⟩, ⟨(-47850), 1091142⟩, ⟨(-11760), 98975⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4410719702, 4605876971⟩, ⟨55752816, 119601272⟩, ⟨6509551, 15455066⟩, ⟨(-47850), 1091142⟩, ⟨(-11760), 98975⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4352458715, 4447706259⟩, ⟨26919102, 59010733⟩, ⟨2751535, 7542217⟩, ⟨(-125868), 521348⟩, ⟨(-19407), 49672⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3312406061, 3739164414⟩, ⟨(-156648883), (-123732079)⟩, ⟨(-256142), 5268619⟩, ⟨(-406196), 328712⟩, ⟨(-37080), 46773⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4752141655, 7128212489⟩, ⟨1188035412, 1188035420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5257979573, 11830454061⟩, ⟨2628989782, 3943484706⟩, ⟨328623722, 328623727⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5257979573, 11830454061⟩, ⟨2628989782, 3943484706⟩, ⟨328623722, 328623727⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11830454061), (-5257979573)⟩, ⟨(-3943484706), (-2628989782)⟩, ⟨(-328623727), (-328623722)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5915227031), (-2628989786)⟩, ⟨(-1971742353), (-1314494891)⟩, ⟨(-164311864), (-164311861)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1083501382, 2328756791⟩, ⟨(-1069090421), (-331610681)⟩, ⟨(-38345368), 203948772⟩, ⟨(-22752156), 33134569⟩, ⟨(-7704089), 3344763⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨835628375, 2027397166⟩, ⟨(-1015677585), (-286962163)⟩, ⟨(-23968810), 219405430⟩, ⟨(-28778093), 30487240⟩, ⟨(-8064592), 4118412⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4392375767, 4392375770⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2600
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4352458715, 4447706259⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2601
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (109566443 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((31861 / 200000) : ℝ)..(95583 / 400000), prawitzNormalCorrection
