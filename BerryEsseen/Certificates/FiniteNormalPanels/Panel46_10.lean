...
namespace FiniteNormalPanel46_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (28 / 125)
def radius : Rat := (28 / 625)

def j0 : Jet := ⟨⟨962072674, 962072675⟩, ⟨192414534, 192414535⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3022440444, 3022440449⟩, ⟨604488086, 604488090⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2126941978, 2126941986⟩, ⟨850776786, 850776796⟩, ⟨85077678, 85077680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨532, 533⟩, ⟨212, 214⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94155), (-94153)⟩, ⟨212, 214⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-46628), (-46626)⟩, ⟨(-18547), (-18544)⟩, ⟨(-1815), (-1811)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5066428, 5066431⟩, ⟨(-18547), (-18544)⟩, ⟨(-1815), (-1811)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2508982, 2508985⟩, ⟨994408, 994411⟩, ⟨95786, 95791⟩, ⟨(-725), (-720)⟩, ⟨(-35), (-32)⟩⟩
...
def j16 : Jet := ⟨⟨(-140656595), (-140656591)⟩, ⟨994408, 994411⟩, ⟨95786, 95791⟩, ⟨(-725), (-720)⟩, ⟨(-35), (-32)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-69655576), (-69655572)⟩, ⟨(-27369783), (-27369779)⟩, ⟨(-2541811), (-2541804)⟩, ⟨38310, 38317⟩, ⟨1735, 1741⟩⟩
...
def j19 : Jet := ⟨⟨1362000189, 1362000194⟩, ⟨(-27369783), (-27369779)⟩, ⟨(-2541811), (-2541804)⟩, ⟨38310, 38317⟩, ⟨1735, 1741⟩⟩
...
def j22 : Jet := ⟨⟨(-54), (-52)⟩, ⟨(-22), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11781, 11784⟩, ⟨(-22), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5834, 5836⟩, ⟨2322, 2325⟩, ⟨226, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846343), (-846340)⟩, ⟨2322, 2325⟩, ⟨226, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-419124), (-419122)⟩, ⟨(-166501), (-166496)⟩, ⟨(-16195), (-16189)⟩, ⟨88, 93⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35372270, 35372273⟩, ⟨(-166501), (-166496)⟩, ⟨(-16195), (-16189)⟩, ⟨88, 93⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17516958, 17516961⟩, ⟨6924328, 6924334⟩, ⟨659675, 659682⟩, ⟨(-6465), (-6457)⟩, ⟨(-304), (-298)⟩⟩
...
def j33 : Jet := ⟨⟨(-698310925), (-698310921)⟩, ⟨6924328, 6924334⟩, ⟨659675, 659682⟩, ⟨(-6465), (-6457)⟩, ⟨(-304), (-298)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-345815632), (-345815627)⟩, ⟨(-134897207), (-134897200)⟩, ⟨(-12134326), (-12134318)⟩, ⟨264631, 264640⟩, ⟨11635, 11642⟩⟩
...
def j36 : Jet := ⟨⟨3949151664, 3949151669⟩, ⟨(-134897207), (-134897200)⟩, ⟨(-12134326), (-12134318)⟩, ⟨264631, 264640⟩, ⟨11635, 11642⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨958462351, 958462358⟩, ⟨172431894, 172431900⟩, ⟨(-5640830), (-5640824)⟩, ⟨(-330784), (-330777)⟩, ⟨6611, 6619⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4671064983, 4671064989⟩, ⟨159556694, 159556704⟩, ⟨19802716, 19802731⟩, ⟨853673, 853690⟩, ⟨65542, 65557⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1042392087, 1042392097⟩, ⟨223137826, 223137836⟩, ⟨4690172, 4690184⟩, ⟨416227, 416242⟩, ⟨17789, 17807⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-962072675), (-962072674)⟩, ⟨(-192414535), (-192414534)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3332894621, 3332894622⟩, ⟨(-192414535), (-192414534)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨252989414, 252989420⟩, ⟨108311466, 108311474⟩, ⟨13869367, 13869377⟩, ⟨689376, 689388⟩, ⟨57003, 57018⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4547956710, 4547956716⟩, ⟨108311466, 108311474⟩, ⟨13869367, 13869377⟩, ⟨689376, 689388⟩, ⟨57003, 57018⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4419652173, 4419652177⟩, ⟨52627920, 52627925⟩, ⟨6425706, 6425713⟩, ⟨258448, 258455⟩, ⟨19948, 19958⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3429650085, 3429650090⟩, ⟨(-157161153), (-157161146)⟩, ⟨2628615, 2628624⟩, ⟨(-87317), (-87309)⟩, ⟨3900, 3910⟩⟩
...
def j47 : Jet := ⟨⟨5428123512, 5428123520⟩, ⟨1085624697, 1085624704⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6860244288, 6860244309⟩, ⟨2744097700, 2744097724⟩, ⟨274409768, 274409773⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6860244288, 6860244309⟩, ⟨2744097700, 2744097724⟩, ⟨274409768, 274409773⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6860244309), (-6860244288)⟩, ⟨(-2744097724), (-2744097700)⟩, ⟨(-274409773), (-274409768)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3430122155), (-3430122144)⟩, ⟨(-1372048862), (-1372048850)⟩, ⟨(-137204887), (-137204884)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1932484323, 1932484337⟩, ⟨(-617341822), (-617341812)⟩, ⟨36872286, 36872292⟩, ⟨9221182, 9221185⟩, ⟨(-1325391), (-1325389)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1543142139, 1543142154⟩, ⟨(-563677844), (-563677830)⟩, ⟨53215990, 53216004⟩, ⟨5597022, 5597035⟩, ⟨(-1358914), (-1358901)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨769658139, 1154487210⟩, ⟨192414534, 192414535⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2417952355, 3626928538⟩, ⟨604488086, 604488090⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1361242865, 3062796458⟩, ⟨680621428, 1020932154⟩, ⟨85077678, 85077680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨340, 768⟩, ⟨170, 256⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94347), (-93918)⟩, ⟨170, 256⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-67281), (-29766)⟩, ⟨(-22374), (-14700)⟩, ⟨(-1837), (-1783)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5045775, 5083291⟩, ⟨(-22374), (-14700)⟩, ⟨(-1837), (-1783)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1599203, 3624961⟩, ⟨783645, 1203662⟩, ⟨93321, 97800⟩, ⟨(-880), (-564)⟩, ⟨(-37), (-31)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141566374), (-139540615)⟩, ⟨783645, 1203662⟩, ⟨93321, 97800⟩, ⟨(-880), (-564)⟩, ⟨(-37), (-31)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-100952804), (-44225870)⟩, ⟨(-33402568), (-21254588)⟩, ⟨(-2650485), (-2408257)⟩, ⟨29682, 46913⟩, ⟨1611, 1840⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1330702961, 1387429896⟩, ⟨(-33402568), (-21254588)⟩, ⟨(-2650485), (-2408257)⟩, ⟨29682, 46913⟩, ⟨1611, 1840⟩⟩
...
def j70 : Jet := ⟨⟨(-78), (-33)⟩, ⟨(-26), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11757, 11803⟩, ⟨(-26), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3726, 8417⟩, ⟨1844, 2801⟩, ⟨222, 232⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848451), (-843759)⟩, ⟨1844, 2801⟩, ⟨222, 232⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-605042), (-267420)⟩, ⟨(-201097), (-131712)⟩, ⟨(-16445), (-15881)⟩, ⟨69, 112⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35186352, 35523975⟩, ⟨(-201097), (-131712)⟩, ⟨(-16445), (-15881)⟩, ⟨69, 112⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11151929, 25332604⟩, ⟨5432559, 8402458⟩, ⟨637465, 677779⟩, ⟨(-7873), (-5045)⟩, ⟨(-316), (-283)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704675954), (-690495278)⟩, ⟨5432559, 8402458⟩, ⟨637465, 677779⟩, ⟨(-7873), (-5045)⟩, ⟨(-316), (-283)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-502513493), (-218844919)⟩, ⟨(-165782708), (-103430557)⟩, ⟨(-12895777), (-11197173)⟩, ⟨203014, 325955⟩, ⟨10529, 12538⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3792453803, 4076122377⟩, ⟨(-165782708), (-103430557)⟩, ⟨(-12895777), (-11197173)⟩, ⟨203014, 325955⟩, ⟨10529, 12538⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨749150374, 1171629198⟩, ⟨159080455, 183305766⟩, ⟨(-6939419), (-4347225)⟩, ⟨(-356329), (-299329)⟩, ⟨5083, 8157⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4525561886, 4864065598⟩, ⟨114834968, 212626973⟩, ⟨15345697, 25834405⟩, ⟨315880, 1610077⟩, ⟨18202, 139519⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨789371873, 1326874196⟩, ⟨187651510, 265597189⟩, ⟨(-928893), 11541522⟩, ⟨(-123605), 1110176⟩, ⟨(-39154), 92480⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1154487210), (-769658139)⟩, ⟨(-192414535), (-192414534)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3140480086, 3525309157⟩, ⟨(-192414535), (-192414534)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨145078625, 409920498⟩, ⟨68976926, 164105584⟩, ⟨7624746, 23555515⟩, ⟨(-191258), 2113388⟩, ⟨(-41979), 225463⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4440045921, 4704887794⟩, ⟨68976926, 164105584⟩, ⟨7624746, 23555515⟩, ⟨(-191258), 2113388⟩, ⟨(-41979), 225463⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4366904169, 4495257413⟩, ⟨32951799, 80701121⟩, ⟨2918115, 11459417⟩, ⟨(-305826), 1017268⟩, ⟨(-54480), 115553⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3193080327, 3689707286⟩, ⟨(-177293178), (-129397824)⟩, ⟨(-1481686), 7929650⟩, ⟨(-764404), 704243⟩, ⟨(-90292), 108548⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4342498808, 6513748224⟩, ⟨1085624697, 1085624704⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4390556341, 9878751805⟩, ⟨2195278160, 3292917270⟩, ⟨274409768, 274409773⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4390556341, 9878751805⟩, ⟨2195278160, 3292917270⟩, ⟨274409768, 274409773⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9878751805), (-4390556341)⟩, ⟨(-3292917270), (-2195278160)⟩, ⟨(-274409773), (-274409768)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4939375903), (-2195278170)⟩, ⟨(-1646458635), (-1097639080)⟩, ⟨(-137204887), (-137204884)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1359892788, 2576201208⟩, ⟨(-987576490), (-347539658)⟩, ⟨(-37888727), 145849304⟩, ⟨(-11235365), 25873916⟩, ⟨(-4809281), 1681946⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1011008142, 2213155005⟩, ⟨(-954747916), (-299347845)⟩, ⟨(-22967477), 170818576⟩, ⟨(-17954431), 24554821⟩, ⟨(-5485645), 2418862⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨962072674, 962072675⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4419652173, 4419652177⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified904
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨769658139, 1154487210⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4366904169, 4495257413⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified905
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (34974567 / 1073741824)

theorem envelope_integral : (∫ s in ((112 / 625) : ℝ)..(168 / 625),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((112 / 625) : ℝ)..(168 / 625), prawitzNormalCorrection
