...
namespace FiniteNormalPanel145_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (91693 / 400000)
def radius : Rat := (13099 / 400000)

def j0 : Jet := ⟨⟨984546090, 984546091⟩, ⟨140649441, 140649442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3093042763, 3093042767⟩, ⟨441863250, 441863254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2227470635, 2227470642⟩, ⟨636420178, 636420186⟩, ⟨45458584, 45458585⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨557, 559⟩, ⟨159, 160⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94130), (-94127)⟩, ⟨159, 160⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48819), (-48816)⟩, ⟨(-13867), (-13864)⟩, ⟨(-969), (-965)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064237, 5064241⟩, ⟨(-13867), (-13864)⟩, ⟨(-969), (-965)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2626431, 2626435⟩, ⟨743217, 743220⟩, ⟨51042, 51047⟩, ⟨(-290), (-285)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140539146), (-140539141)⟩, ⟨743217, 743220⟩, ⟨51042, 51047⟩, ⟨(-290), (-285)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-72886894), (-72886890)⟩, ⟨(-20439378), (-20439373)⟩, ⟨(-1350889), (-1350883)⟩, ⟨15278, 15285⟩, ⟨491, 495⟩⟩
...
def j19 : Jet := ⟨⟨1358768871, 1358768876⟩, ⟨(-20439378), (-20439373)⟩, ⟨(-1350889), (-1350883)⟩, ⟨15278, 15285⟩, ⟨491, 495⟩⟩
...
def j25 : Jet := ⟨⟨6108, 6110⟩, ⟨1736, 1739⟩, ⟨119, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846069), (-846066)⟩, ⟨1736, 1739⟩, ⟨119, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-438792), (-438789)⟩, ⟨(-124469), (-124466)⟩, ⟨(-8637), (-8632)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35352602, 35352606⟩, ⟨(-124469), (-124466)⟩, ⟨(-8637), (-8632)⟩, ⟨33, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18334687, 18334690⟩, ⟨5173929, 5173933⟩, ⟨351253, 351259⟩, ⟨(-2581), (-2576)⟩, ⟨(-89), (-83)⟩⟩
...
def j33 : Jet := ⟨⟨(-697493196), (-697493192)⟩, ⟨5173929, 5173933⟩, ⟨351253, 351259⟩, ⟨(-2581), (-2576)⟩, ⟨(-89), (-83)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-361736310), (-361736305)⟩, ⟨(-100669912), (-100669906)⟩, ⟨(-6433543), (-6433537)⟩, ⟨105470, 105476⟩, ⟨3287, 3294⟩⟩
...
def j36 : Jet := ⟨⟨3933230986, 3933230991⟩, ⟨(-100669912), (-100669906)⟩, ⟨(-6433543), (-6433537)⟩, ⟨105470, 105476⟩, ⟨3287, 3294⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨978524382, 978524388⟩, ⟨125069672, 125069680⟩, ⟨(-3075640), (-3075633)⟩, ⟨(-127977), (-127969)⟩, ⟨1924, 1930⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4689972217, 4689972224⟩, ⟨120038477, 120038487⟩, ⟨10743677, 10743688⟩, ⟨345555, 345567⟩, ⟨19269, 19282⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1068518535, 1068518544⟩, ⟨163920656, 163920670⟩, ⟨2584757, 2584772⟩, ⟨165876, 165891⟩, ⟨5281, 5296⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-984546091), (-984546090)⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3310421205, 3310421206⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨265830163, 265830169⟩, ⟨81561626, 81561636⟩, ⟨7542245, 7542257⟩, ⟨279832, 279844⟩, ⟨16841, 16856⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4560797459, 4560797465⟩, ⟨81561626, 81561636⟩, ⟨7542245, 7542257⟩, ⟨279832, 279844⟩, ⟨16841, 16856⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4425887021, 4425887025⟩, ⟨39574498, 39574504⟩, ⟨3482641, 3482648⟩, ⟨104636, 104644⟩, ⟨5864, 5874⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3411329874, 3411329879⟩, ⟨(-114434000), (-114433992)⟩, ⟨1388339, 1388347⟩, ⟨(-33399), (-33390)⟩, ⟨1092, 1102⟩⟩
...
def j47 : Jet := ⟨⟨10257931441, 10257931454⟩, ⟨1465418772, 1465418784⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨24499641137, 24499641200⟩, ⟨6999897442, 6999897510⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨24499641137, 24499641200⟩, ⟨6999897442, 6999897510⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-24499641200), (-24499641137)⟩, ⟨(-6999897510), (-6999897442)⟩, ⟨(-499992681), (-499992672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12249820600), (-12249820568)⟩, ⟨(-3499948755), (-3499948721)⟩, ⟨(-249996341), (-249996336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨247909954, 247909961⟩, ⟨(-202020668), (-202020659)⟩, ⟨67882796, 67882802⟩, ⟨(-10599808), (-10599805)⟩, ⟨183812, 183814⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨196905488, 196905495⟩, ⟨(-167062617), (-167062606)⟩, ⟨59379455, 59379464⟩, ⟨(-10294911), (-10294903)⟩, ⟨451987, 451995⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨843896649, 1125195533⟩, ⟨140649441, 140649442⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2651179512, 3534906021⟩, ⟨441863250, 441863254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1636509039, 2909349413⟩, ⟨545503010, 727337356⟩, ⟨45458584, 45458585⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-63863), (-35800)⟩, ⟨(-15915), (-11809)⟩, ⟨(-977), (-954)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5049193, 5077257⟩, ⟨(-15915), (-11809)⟩, ⟨(-977), (-954)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1923891, 3439262⟩, ⟨630516, 855317⟩, ⟨50083, 51877⟩, ⟨(-335), (-241)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141241686), (-139726314)⟩, ⟨630516, 855317⟩, ⟨50083, 51877⟩, ⟨(-335), (-241)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-95675098), (-53239840)⟩, ⟨(-23678530), (-17167233)⟩, ⟨(-1395760), (-1298898)⟩, ⟨12807, 17748⟩, ⟨465, 517⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1335980667, 1378415926⟩, ⟨(-23678530), (-17167233)⟩, ⟨(-1395760), (-1298898)⟩, ⟨12807, 17748⟩, ⟨465, 517⟩⟩
...
def j72 : Jet := ⟨⟨4481, 7991⟩, ⟨1480, 1994⟩, ⟨118, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847696), (-844185)⟩, ⟨1480, 1994⟩, ⟨118, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-574218), (-321659)⟩, ⟨(-142992), (-105868)⟩, ⟨(-8742), (-8512)⟩, ⟨27, 43⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35217176, 35469736⟩, ⟨(-142992), (-105868)⟩, ⟨(-8742), (-8512)⟩, ⟨27, 43⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13418781, 24026692⟩, ⟨4376066, 5966335⟩, ⟨342605, 358729⟩, ⟨(-2985), (-2171)⟩, ⟨(-91), (-80)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702409102), (-691801190)⟩, ⟨4376066, 5966335⟩, ⟨342605, 358729⟩, ⟨(-2985), (-2171)⟩, ⟨(-91), (-80)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-475801879), (-263596628)⟩, ⟨(-117283061), (-83824032)⟩, ⟨(-6748060), (-6068752)⟩, ⟨87808, 123072⟩, ⟨3058, 3492⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3819165417, 4031370668⟩, ⟨(-117283061), (-83824032)⟩, ⟨(-6748060), (-6068752)⟩, ⟨87808, 123072⟩, ⟨3058, 3492⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨824668578, 1134483786⟩, ⟨117956516, 131213556⟩, ⟨(-3584790), (-2567930)⟩, ⟨(-135690), (-119021)⟩, ⟨1604, 2252⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4575799546, 4830045851⟩, ⟨95144305, 148326271⟩, ⟨8866653, 13089143⟩, ⟨180136, 558830⟩, ⟨8378, 34441⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨878590649, 1275820822⟩, ⟨143937740, 186739780⟩, ⟨284108, 5253012⟩, ⟨1703, 363803⟩, ⟨(-7349), 20767⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1125195533), (-843896649)⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3169771763, 3451070647⟩, ⟨(-140649442), (-140649441)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨179726986, 378982809⟩, ⟨58888620, 110942172⟩, ⟨4940036, 11240029⟩, ⟨19738, 672926⟩, ⟨(-4236), 50399⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4474694282, 4673950105⟩, ⟨58888620, 110942172⟩, ⟨4940036, 11240029⟩, ⟨19738, 672926⟩, ⟨(-4236), 50399⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4383909853, 4480453420⟩, ⟨28225346, 54345666⟩, ⟨2038168, 5415131⟩, ⟨(-57462), 316515⟩, ⟨(-9344), 24928⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3235413148, 3600111530⟩, ⟨(-125892780), (-99894529)⟩, ⟨(-275477), 3426830⟩, ⟨(-223505), 187581⟩, ⟨(-17875), 21913⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8792512668, 11723350238⟩, ⟨1465418772, 1465418784⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨17999736363, 31999531389⟩, ⟨5999912096, 7999882872⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨17999736363, 31999531389⟩, ⟨5999912096, 7999882872⟩, ⟨499992672, 499992681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-31999531389), (-17999736363)⟩, ⟨(-7999882872), (-5999912096)⟩, ⟨(-499992681), (-499992672)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-15999765695), (-8999868181)⟩, ⟨(-3999941436), (-2999956048)⟩, ⟨(-249996341), (-249996336)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨103540565, 528347456⟩, ⟨(-492054709), (-72321189)⟩, ⟨(-5495907), 223100710⟩, ⟨(-66452172), 20800086⟩, ⟨(-11335817), 15631826⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨77997451, 442869442⟩, ⟨(-427935032), (-56887991)⟩, ⟨(-2958565), 201851162⟩, ⟨(-62660846), 17650703⟩, ⟨(-10149553), 15256986⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨984546090, 984546091⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4425887021, 4425887025⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2924
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨843896649, 1125195533⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4383909853, 4480453420⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2925
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (7196265 / 2147483648)

theorem envelope_integral : (∫ s in ((39297 / 200000) : ℝ)..(13099 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((39297 / 200000) : ℝ)..(13099 / 50000), prawitzNormalCorrection
