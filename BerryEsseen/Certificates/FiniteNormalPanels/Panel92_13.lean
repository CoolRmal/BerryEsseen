...
namespace FiniteNormalPanel92_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2087 / 10000)
def radius : Rat := (2087 / 50000)

def j0 : Jet := ⟨⟨896359674, 896359675⟩, ⟨179271934, 179271935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2815996966, 2815996971⟩, ⟨563199390, 563199395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1846309498, 1846309505⟩, ⟨738523794, 738523804⟩, ⟨73852379, 73852381⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨462, 463⟩, ⟨184, 186⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94225), (-94223)⟩, ⟨184, 186⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-40506), (-40504)⟩, ⟨(-16124), (-16121)⟩, ⟨(-1583), (-1579)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5072550, 5072553⟩, ⟨(-16124), (-16121)⟩, ⟨(-1583), (-1579)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2180574, 2180577⟩, ⟨865297, 865301⟩, ⟨83768, 83774⟩, ⟨(-549), (-544)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-140985003), (-140984999)⟩, ⟨865297, 865301⟩, ⟨83768, 83774⟩, ⟨(-549), (-544)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-60606271), (-60606268)⟩, ⟨(-23870538), (-23870533)⟩, ⟨(-2239454), (-2239447)⟩, ⟨29044, 29052⟩, ⟨1333, 1338⟩⟩
...
def j19 : Jet := ⟨⟨1371049494, 1371049498⟩, ⟨(-23870538), (-23870533)⟩, ⟨(-2239454), (-2239447)⟩, ⟨29044, 29052⟩, ⟨1333, 1338⟩⟩
...
def j25 : Jet := ⟨⟨5067, 5069⟩, ⟨2017, 2021⟩, ⟨197, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847110), (-847107)⟩, ⟨2017, 2021⟩, ⟨197, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-364154), (-364152)⟩, ⟨(-144795), (-144791)⟩, ⟨(-14137), (-14132)⟩, ⟨66, 70⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35427240, 35427243⟩, ⟨(-144795), (-144791)⟩, ⟨(-14137), (-14132)⟩, ⟨66, 70⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15229370, 15229373⟩, ⟨6029503, 6029507⟩, ⟨578198, 578204⟩, ⟨(-4893), (-4888)⟩, ⟨(-233), (-228)⟩⟩
...
def j33 : Jet := ⟨⟨(-700598513), (-700598509)⟩, ⟨6029503, 6029507⟩, ⟨578198, 578204⟩, ⟨(-4893), (-4888)⟩, ⟨(-233), (-228)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-301171489), (-301171485)⟩, ⟨(-117876649), (-117876644)⟩, ⟨(-10761528), (-10761522)⟩, ⟨200994, 201000⟩, ⟨8999, 9005⟩⟩
...
def j36 : Jet := ⟨⟨3993795807, 3993795811⟩, ⟨(-117876649), (-117876644)⟩, ⟨(-10761528), (-10761522)⟩, ⟨200994, 201000⟩, ⟨8999, 9005⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨898929130, 898929135⟩, ⟨164135097, 164135104⟩, ⟨(-4598445), (-4598438)⟩, ⟨(-274618), (-274610)⟩, ⟨4681, 4688⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4618850073, 4618850078⟩, ⟨136325082, 136325090⟩, ⟨16469394, 16469404⟩, ⟨620969, 620981⟩, ⟨45427, 45441⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨966717227, 966717235⟩, ⟨205045097, 205045109⟩, ⟨3711557, 3711570⟩, ⟨318071, 318086⟩, ⟨11919, 11936⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-896359675), (-896359674)⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3398607621, 3398607622⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨217590061, 217590065⟩, ⟨92303672, 92303680⟩, ⟨11459817, 11459827⟩, ⟨497566, 497580⟩, ⟨38939, 38954⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4512557357, 4512557361⟩, ⟨92303672, 92303680⟩, ⟨11459817, 11459827⟩, ⟨497566, 497580⟩, ⟨38939, 38954⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4402418229, 4402418232⟩, ⟨45025396, 45025401⟩, ⟨5359809, 5359816⟩, ⟨187893, 187902⟩, ⟨13809, 13819⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3483633544, 3483633548⟩, ⟨(-148128343), (-148128335)⟩, ⟨2361855, 2361863⟩, ⟨(-75040), (-75031)⟩, ⟨3083, 3093⟩⟩
...
def j47 : Jet := ⟨⟨5762212309, 5762212317⟩, ⟨1152442456, 1152442464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7730696977, 7730697000⟩, ⟨3092278774, 3092278802⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7730696977, 7730697000⟩, ⟨3092278774, 3092278802⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7730697000), (-7730696977)⟩, ⟨(-3092278802), (-3092278774)⟩, ⟨(-309227881), (-309227875)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3865348500), (-3865348488)⟩, ⟨(-1546139401), (-1546139387)⟩, ⟨(-154613941), (-154613937)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1746253018, 1746253028⟩, ⟨(-628631239), (-628631229)⟩, ⟨50286922, 50286928⟩, ⟨9052431, 9052434⟩, ⟨(-1719830), (-1719828)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1416379956, 1416379966⟩, ⟨(-570106889), (-570106875)⟩, ⟨63428584, 63428598⟩, ⟨5231855, 5231866⟩, ⟨(-1667270), (-1667257)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨717087739, 1075631610⟩, ⟨179271934, 179271935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2252797572, 3379196365⟩, ⟨563199390, 563199395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1181638077, 2658685687⟩, ⟨590819034, 886228564⟩, ⟨73852379, 73852381⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨295, 667⟩, ⟨147, 223⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94392), (-94019)⟩, ⟨147, 223⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-58431), (-25866)⟩, ⟨(-19437), (-12794)⟩, ⟨(-1600), (-1557)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5054625, 5087191⟩, ⟨(-19437), (-12794)⟩, ⟨(-1600), (-1557)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1390636, 3149091⟩, ⟨683286, 1046178⟩, ⟨81912, 85288⟩, ⟨(-665), (-428)⟩, ⟨(-28), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141774941), (-140016485)⟩, ⟨683286, 1046178⟩, ⟨81912, 85288⟩, ⟨(-665), (-428)⟩, ⟨(-28), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-87762021), (-38521552)⟩, ⟨(-29066021), (-18613167)⟩, ⟨(-2321306), (-2138931)⟩, ⟨22604, 35472⟩, ⟨1252, 1403⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1343893744, 1393134214⟩, ⟨(-29066021), (-18613167)⟩, ⟨(-2321306), (-2138931)⟩, ⟨22604, 35472⟩, ⟨1252, 1403⟩⟩
...
def j72 : Jet := ⟨⟨3237, 7309⟩, ⟨1603, 2434⟩, ⟨195, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848940), (-844867)⟩, ⟨1603, 2434⟩, ⟨195, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-525514), (-232441)⟩, ⟨(-174731), (-114713)⟩, ⟨(-14325), (-13898)⟩, ⟨51, 84⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35265880, 35558954⟩, ⟨(-174731), (-114713)⟩, ⟨(-14325), (-13898)⟩, ⟨51, 84⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9702403, 22011829⟩, ⟨4743038, 7305717⟩, ⟨561477, 591837⟩, ⟨(-5947), (-3831)⟩, ⟨(-240), (-217)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706125480), (-693816053)⟩, ⟨4743038, 7305717⟩, ⟨561477, 591837⟩, ⟨(-5947), (-3831)⟩, ⟨(-240), (-217)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-437108266), (-190883750)⟩, ⟨(-144397845), (-90919463)⟩, ⟨(-11334968), (-10056401)⟩, ⟨155111, 246691⟩, ⟨8277, 9592⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3857859030, 4104083546⟩, ⟨(-144397845), (-90919463)⟩, ⟨(-11334968), (-10056401)⟩, ⟨155111, 246691⟩, ⟨8277, 9592⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨704899561, 1096090785⟩, ⟨153356311, 172918814⟩, ⟨(-5637789), (-3562658)⟩, ⟨(-292538), (-252569)⟩, ⟨3620, 5756⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4494729180, 4781601384⟩, ⟨99573596, 178973087⟩, ⟨13219510, 20747941⟩, ⟨249429, 1121719⟩, ⟨15983, 89302⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨737684924, 1220281519⟩, ⟨176831257, 238185655⟩, ⟨(-551576), 8772189⟩, ⟨(-47662), 774685⟩, ⟨(-24109), 57542⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1075631610), (-717087739)⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3219335686, 3577879557⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨126701557, 346705082⟩, ⟨60743536, 135346108⟩, ⟨6967021, 18193733⟩, ⟨(-88262), 1413164⟩, ⟨(-20115), 136539⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4421668853, 4641672378⟩, ⟨60743536, 135346108⟩, ⟨6967021, 18193733⟩, ⟨(-88262), 1413164⟩, ⟨(-20115), 136539⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4357857629, 4464955886⟩, ⟨29215462, 66696432⟩, ⟨2852739, 8867654⟩, ⟨(-179213), 677261⟩, ⟨(-29301), 69094⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3266475763, 3719486853⟩, ⟨(-164468518), (-126336180)⟩, ⟨(-645611), 6167658⟩, ⟨(-519428), 445113⟩, ⟨(-52678), 65040⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4609769846, 6914654781⟩, ⟨1152442456, 1152442464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4947646063, 11132203681⟩, ⟨2473823018, 3710734562⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4947646063, 11132203681⟩, ⟨2473823018, 3710734562⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11132203681), (-4947646063)⟩, ⟨(-3710734562), (-2473823018)⟩, ⟨(-309227881), (-309227875)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5566101841), (-2473823031)⟩, ⟨(-1855367281), (-1236911509)⟩, ⟨(-154613941), (-154613937)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1175254667, 2414427345⟩, ⟨(-1042999677), (-338462652)⟩, ⟨(-38179559), 182972986⟩, ⟨(-18224432), 30528885⟩, ⟨(-6590426), 2655388⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨893823077, 2090919476⟩, ⟨(-995705108), (-291982952)⟩, ⟨(-23470976), 201863608⟩, ⟨(-24578959), 28307362⟩, ⟨(-7068966), 3422924⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨896359674, 896359675⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4402418229, 4402418232⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1856
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨717087739, 1075631610⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4357857629, 4464955886⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1857
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (30015389 / 1073741824)

theorem envelope_integral : (∫ s in ((2087 / 12500) : ℝ)..(6261 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((2087 / 12500) : ℝ)..(6261 / 25000), prawitzNormalCorrection
