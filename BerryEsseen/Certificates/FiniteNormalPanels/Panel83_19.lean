...
namespace FiniteNormalPanel83_19
...
def j2 : Jet := ⟨⟨582106510, 582106514⟩, ⟨582106510, 582106514⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨78894195, 78894197⟩, ⟨157788390, 157788394⟩, ⟨78894195, 78894197⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1739), (-1738)⟩, ⟨(-3478), (-3476)⟩, ⟨(-1738), (-1735)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111317, 5111319⟩, ⟨(-3478), (-3476)⟩, ⟨(-1738), (-1735)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨93889, 93890⟩, ⟨187715, 187717⟩, ⟨93729, 93732⟩, ⟨(-128), (-125)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-143071688), (-143071686)⟩, ⟨187715, 187717⟩, ⟨93729, 93732⟩, ⟨(-128), (-125)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2628082), (-2628081)⟩, ⟨(-5252716), (-5252714)⟩, ⟨(-2619465), (-2619462)⟩, ⟨6888, 6891⟩, ⟨1715, 1718⟩⟩
...
def j19 : Jet := ⟨⟨1429027683, 1429027685⟩, ⟨(-5252716), (-5252714)⟩, ⟨(-2619465), (-2619462)⟩, ⟨6888, 6891⟩, ⟨1715, 1718⟩⟩
...
def j25 : Jet := ⟨⟨217, 218⟩, ⟨433, 435⟩, ⟨215, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851960), (-851958)⟩, ⟨433, 435⟩, ⟨215, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-15650), (-15649)⟩, ⟨(-31293), (-31291)⟩, ⟨(-15632), (-15628)⟩, ⟨13, 17⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨35775744, 35775746⟩, ⟨(-31293), (-31291)⟩, ⟨(-15632), (-15628)⟩, ⟨13, 17⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨657164, 657165⟩, ⟨1313753, 1313755⟩, ⟨655726, 655729⟩, ⟨(-1150), (-1147)⟩, ⟨(-288), (-285)⟩⟩
...
def j33 : Jet := ⟨⟨(-715170719), (-715170717)⟩, ⟨1313753, 1313755⟩, ⟨655726, 655729⟩, ⟨(-1150), (-1147)⟩, ⟨(-288), (-285)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-13136962), (-13136961)⟩, ⟨(-26249791), (-26249789)⟩, ⟨(-13076653), (-13076650)⟩, ⟨48200, 48203⟩, ⟨11996, 11999⟩⟩
...
def j36 : Jet := ⟨⟨4281830334, 4281830335⟩, ⟨(-26249791), (-26249789)⟩, ⟨(-13076653), (-13076650)⟩, ⟨48200, 48203⟩, ⟨11996, 11999⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨193679313, 193679316⟩, ⟨192967400, 192967404⟩, ⟨(-1066935), (-1066933)⟩, ⟨(-354089), (-354087)⟩, ⟨1165, 1167⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4308144562, 4308144564⟩, ⟨26411108, 26411112⟩, ⟨13318926, 13318932⟩, ⟨113811, 113818⟩, ⟨29001, 29009⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨194273534, 194273539⟩, ⟨194750432, 194750438⟩, ⟨717018, 717023⟩, ⟨241797, 241803⟩, ⟨2101, 2109⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-185290258), (-185290257)⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4109677038, 4109677039⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8787542, 8787543⟩, ⟨17618226, 17618230⟩, ⟨8895601, 8895605⟩, ⟨86898, 86902⟩, ⟨22237, 22242⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303754838, 4303754839⟩, ⟨17618226, 17618230⟩, ⟨8895601, 8895605⟩, ⟨86898, 86902⟩, ⟨22237, 22242⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299358821, 4299358823⟩, ⟨8800115, 8800118⟩, ⟨4434251, 4434254⟩, ⟨34327, 34331⟩, ⟨8749, 8754⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4113879107, 4113879111⟩, ⟨(-177059247), (-177059242)⟩, ⟨3863302, 3863308⟩, ⟨(-158454), (-158449)⟩, ⟨6889, 6897⟩⟩
...
def j47 : Jet := ⟨⟨1117438111, 1117438118⟩, ⟨1117438111, 1117438118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨290728158, 290728162⟩, ⟨581456316, 581456324⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨290728158, 290728162⟩, ⟨581456316, 581456324⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-290728162), (-290728158)⟩, ⟨(-581456324), (-581456316)⟩, ⟨(-290728162), (-290728158)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-145364081), (-145364079)⟩, ⟨(-290728162), (-290728158)⟩, ⟨(-145364081), (-145364079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4152035634, 4152035637⟩, ⟨(-281053058), (-281053053)⟩, ⟨(-131014229), (-131014226)⟩, ⟨9297669, 9297670⟩, ⟨2059761, 2059762⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3976973855, 3976973863⟩, ⟨(-440369969), (-440369956)⟩, ⟨(-110169197), (-110169184)⟩, ⟨13900701, 13900712⟩, ⟨1488800, 1488814⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 370580516⟩, ⟨185290257, 185290258⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1164213027⟩, ⟨582106510, 582106514⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 315576786⟩, ⟨0, 315576786⟩, ⟨78894195, 78894197⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6958), 0⟩, ⟨(-6958), 6⟩, ⟨(-1740), (-1729)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106098, 5113057⟩, ⟨(-6958), 6⟩, ⟨(-1740), (-1729)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 375687⟩, ⟨(-512), 375688⟩, ⟨93153, 93923⟩, ⟨(-256), 2⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142789889)⟩, ⟨(-512), 375688⟩, ⟨93153, 93923⟩, ⟨(-256), 2⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-10519227), 0⟩, ⟨(-10519265), 27605⟩, ⟨(-2629845), (-2588398)⟩, ⟨(-29), 13805⟩, ⟨1689, 1727⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421136538, 1431655766⟩, ⟨(-10519265), 27605⟩, ⟨(-2629845), (-2588398)⟩, ⟨(-29), 13805⟩, ⟨1689, 1727⟩⟩
...
def j72 : Jet := ⟨⟨0, 870⟩, ⟨(-1), 870⟩, ⟨215, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851306)⟩, ⟨(-1), 870⟩, ⟨215, 218⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-62615), 0⟩, ⟨(-62616), 64⟩, ⟨(-15655), (-15556)⟩, ⟨(-2), 33⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35728779, 35791395⟩, ⟨(-62616), 64⟩, ⟨(-15655), (-15556)⟩, ⟨(-2), 33⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2629807⟩, ⟨(-4601), 2629812⟩, ⟨650549, 657457⟩, ⟨(-2303), 5⟩, ⟨(-289), (-281)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713198075)⟩, ⟨(-4601), 2629812⟩, ⟨650549, 657457⟩, ⟨(-2303), 5⟩, ⟨(-289), (-281)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-52596132), 0⟩, ⟨(-52596471), 193228⟩, ⟨(-13149372), (-12859189)⟩, ⟨(-255), 96616⟩, ⟨11757, 12078⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4242371164, 4294967296⟩, ⟨(-52596471), 193228⟩, ⟨(-13149372), (-12859189)⟩, ⟨(-255), 96616⟩, ⟨11757, 12078⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 388071010⟩, ⟨189758409, 194042988⟩, ⟨(-2138558), 3742⟩, ⟨(-356437), (-347068)⟩, ⟨(-4), 2341⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4348215506⟩, ⟨(-198050), 53908719⟩, ⟨12856763, 14145796⟩, ⟨(-100287), 342734⟩, ⟨23823, 36199⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 392882243⟩, ⟨189740514, 201319611⟩, ⟨(-2174020), 3717481⟩, ⟨171270, 323095⟩, ⟨(-16054), 21157⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-370580516), 0⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3924386780, 4294967296⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 35938914⟩, ⟨0, 36831434⟩, ⟨7984505, 10116644⟩, ⟨(-203808), 407614⟩, ⟨10312, 37380⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4330906210⟩, ⟨0, 36831434⟩, ⟨7984505, 10116644⟩, ⟨(-203808), 407614⟩, ⟨10312, 37380⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4312899319⟩, ⟨0, 18415717⟩, ⟨3936336, 5058322⟩, ⟨(-123593), 203807⟩, ⟨1297, 17417⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3924386780, 4312899319⟩, ⟨(-186063868), (-166874540)⟩, ⟨2802221, 5058322⟩, ⟨(-341816), 33989⟩, ⟨(-7608), 22749⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2234876235⟩, ⟨1117438111, 1117438118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1162912647⟩, ⟨0, 1162912648⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1162912647⟩, ⟨0, 1162912648⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1162912647), 0⟩, ⟨(-1162912648), 0⟩, ⟨(-290728162), (-290728158)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-581456324), 0⟩, ⟨(-581456324), 0⟩, ⟨(-145364081), (-145364079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3751152367, 4294967296⟩, ⟨(-581456324), 0⟩, ⟨(-145364081), (-87599521)⟩, ⟨0, 19679513⟩, ⟨816354, 2459940⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3427493562, 4312899319⟩, ⟨(-769947845), (-145745423)⟩, ⟨(-143523583), (-49793408)⟩, ⟨2376932, 26093039⟩, ⟨(-290038), 2482083⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299358821, 4299358823⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1680
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4312899319⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1681
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (170008761 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(34513 / 400000), prawitzNormalCorrection
