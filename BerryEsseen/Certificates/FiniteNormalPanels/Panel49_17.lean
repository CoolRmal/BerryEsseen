...
namespace FiniteNormalPanel49_17
...
def j2 : Jet := ⟨⟨1947753723, 1947753727⟩, ⟨649251239, 649251243⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨883299989, 883299993⟩, ⟨588866656, 588866664⟩, ⟨98144442, 98144444⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨221, 222⟩, ⟨147, 148⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94466), (-94464)⟩, ⟨147, 148⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-19428), (-19427)⟩, ⟨(-12922), (-12920)⟩, ⟨(-2135), (-2131)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5093628, 5093630⟩, ⟨(-12922), (-12920)⟩, ⟨(-2135), (-2131)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1047551, 1047553⟩, ⟨695709, 695712⟩, ⟨114182, 114186⟩, ⟨(-588), (-585)⟩, ⟨(-49), (-45)⟩⟩
...
def j16 : Jet := ⟨⟨(-142118026), (-142118023)⟩, ⟨695709, 695712⟩, ⟨114182, 114186⟩, ⟨(-588), (-585)⟩, ⟨(-49), (-45)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-29227895), (-29227893)⟩, ⟨(-19342185), (-19342182)⟩, ⟨(-3128676), (-3128672)⟩, ⟨31431, 31434⟩, ⟨2517, 2521⟩⟩
...
def j19 : Jet := ⟨⟨1402427870, 1402427873⟩, ⟨(-19342185), (-19342182)⟩, ⟨(-3128676), (-3128672)⟩, ⟨31431, 31434⟩, ⟨2517, 2521⟩⟩
...
def j25 : Jet := ⟨⟨2429, 2430⟩, ⟨1615, 1618⟩, ⟨265, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849748), (-849746)⟩, ⟨1615, 1618⟩, ⟨265, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-174759), (-174758)⟩, ⟨(-116174), (-116172)⟩, ⟨(-19143), (-19139)⟩, ⟨71, 74⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35616635, 35616637⟩, ⟨(-116174), (-116172)⟩, ⟨(-19143), (-19139)⟩, ⟨71, 74⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7324892, 7324893⟩, ⟨4859368, 4859371⟩, ⟨794010, 794014⟩, ⟨(-5266), (-5262)⟩, ⟨(-429), (-424)⟩⟩
...
def j33 : Jet := ⟨⟨(-708502991), (-708502989)⟩, ⟨4859368, 4859371⟩, ⟨794010, 794014⟩, ⟨(-5266), (-5262)⟩, ⟨(-429), (-424)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-145710234), (-145710232)⟩, ⟨(-96140782), (-96140779)⟩, ⟨(-15360482), (-15360478)⟩, ⟨218820, 218825⟩, ⟨17331, 17337⟩⟩
...
def j36 : Jet := ⟨⟨4149257062, 4149257064⟩, ⟨(-96140782), (-96140779)⟩, ⟨(-15360482), (-15360478)⟩, ⟨218820, 218825⟩, ⟨17331, 17337⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨635996485, 635996489⟩, ⟨203227208, 203227214⟩, ⟨(-4342718), (-4342714)⟩, ⟨(-458696), (-458691)⟩, ⟨5892, 5896⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4445794461, 4445794464⟩, ⟨103011728, 103011733⟩, ⟨18845097, 18845104⟩, ⟨583534, 583544⟩, ⟨59274, 59286⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨658330891, 658330897⟩, ⟨225617897, 225617906⟩, ⟨3169607, 3169618⟩, ⟨399150, 399161⟩, ⟨12429, 12441⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-619989267), (-619989266)⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3674978029, 3674978030⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨100908698, 100908701⟩, ⟨69165244, 69165248⟩, ⟨12823551, 12823557⟩, ⟨455364, 455374⟩, ⟨48083, 48092⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4395875994, 4395875997⟩, ⟨69165244, 69165248⟩, ⟨12823551, 12823557⟩, ⟨455364, 455374⟩, ⟨48083, 48092⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4345128724, 4345128726⟩, ⟨34183390, 34183393⟩, ⟨6203294, 6203298⟩, ⟨176251, 176258⟩, ⟨17948, 17955⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3717898529, 3717898533⟩, ⟨(-179827800), (-179827795)⟩, ⟨3663013, 3663018⟩, ⟨(-147680), (-147671)⟩, ⟨6875, 6884⟩⟩
...
def j47 : Jet := ⟨⟨3064639100, 3064639107⟩, ⟨1021546363, 1021546369⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2186748388, 2186748399⟩, ⟨1457832252, 1457832266⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2186748388, 2186748399⟩, ⟨1457832252, 1457832266⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2186748399), (-2186748388)⟩, ⟨(-1457832266), (-1457832252)⟩, ⟨(-242972045), (-242972041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1093374200), (-1093374194)⟩, ⟨(-728916133), (-728916126)⟩, ⟨(-121486023), (-121486020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3329669073, 3329669083⟩, ⟨(-565091501), (-565091492)⟩, ⟨(-46229946), (-46229941)⟩, ⟨13271282, 13271285⟩, ⟨90741, 90742⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2882297092, 2882297105⟩, ⟨(-628577530), (-628577515)⟩, ⟨(-13518724), (-13518711)⟩, ⟨12827346, 12827362⟩, ⟨(-491783), (-491769)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨413326177, 826652356⟩, ⟨206663088, 206663089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1298502481, 2597004969⟩, ⟨649251239, 649251243⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨392577772, 1570311098⟩, ⟨392577770, 785155550⟩, ⟨98144442, 98144444⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨98, 394⟩, ⟨98, 197⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94589), (-94292)⟩, ⟨98, 197⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34584), (-8618)⟩, ⟨(-17284), (-8545)⟩, ⟨(-2152), (-2107)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078472, 5104439⟩, ⟨(-17284), (-8545)⟩, ⟨(-2152), (-2107)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨464193, 1866268⟩, ⟨457873, 932353⟩, ⟨112101, 115669⟩, ⟨(-789), (-383)⟩, ⟨(-50), (-45)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142701384), (-141299308)⟩, ⟨457873, 932353⟩, ⟨112101, 115669⟩, ⟨(-789), (-383)⟩, ⟨(-50), (-45)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-52173987), (-12915341)⟩, ⟨(-26045143), (-12574457)⟩, ⟨(-3208778), (-3016102)⟩, ⟨20419, 42417⟩, ⟨2397, 2605⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1379481778, 1418740425⟩, ⟨(-26045143), (-12574457)⟩, ⟨(-3208778), (-3016102)⟩, ⟨20419, 42417⟩, ⟨2397, 2605⟩⟩
...
def j72 : Jet := ⟨⟨1078, 4325⟩, ⟨1070, 2163⟩, ⟨263, 271⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851099), (-847851)⟩, ⟨1070, 2163⟩, ⟨263, 271⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-311176), (-77497)⟩, ⟨(-155491), (-76706)⟩, ⟨(-19328), (-18878)⟩, ⟨47, 100⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35480218, 35713898⟩, ⟨(-155491), (-76706)⟩, ⟨(-19328), (-18878)⟩, ⟨47, 100⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3243038, 13057592⟩, ⟨3186187, 6521785⟩, ⟨775266, 807364⟩, ⟨(-7084), (-3440)⟩, ⟨(-438), (-409)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712584845), (-702770290)⟩, ⟨3186187, 6521785⟩, ⟨775266, 807364⟩, ⟨(-7084), (-3440)⟩, ⟨(-438), (-409)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-260532809), (-64236110)⟩, ⟨(-129975175), (-61851637)⟩, ⟨(-15921209), (-14571604)⟩, ⟨141078, 296309⟩, ⟨16258, 18099⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4034434487, 4230731186⟩, ⟨(-129975175), (-61851637)⟩, ⟨(-15921209), (-14571604)⟩, ⟨141078, 296309⟩, ⟨16258, 18099⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨417060337, 857858904⟩, ⟨192781650, 210663077⟩, ⟨(-5877358), (-2812686)⟩, ⟨(-478884), (-430282)⟩, ⟨3810, 7988⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4360178716, 4572324606⟩, ⟨63744108, 147304089⟩, ⟨15949363, 22789518⟩, ⟨132488, 1163042⟩, ⟨26990, 107608⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨423392654, 913257100⟩, ⟨201898530, 253689033⟩, ⟨(-1846965), 8921585⟩, ⟨17373, 871542⟩, ⟨(-35178), 70214⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-826652356), (-413326177)⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3468314940, 3881641119⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨41737533, 194189728⟩, ⟨39805822, 107885950⟩, ⟨8705423, 18778614⟩, ⟨(-214764), 1424576⟩, ⟨(-17167), 151353⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4336704829, 4489157024⟩, ⟨39805822, 107885950⟩, ⟨8705423, 18778614⟩, ⟨(-214764), 1424576⟩, ⟨(-17167), 151353⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4315785607, 4390988796⟩, ⟨19467677, 53682768⟩, ⟨3929372, 9300109⟩, ⟨(-222547), 691129⟩, ⟨(-27160), 76292⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3485126350, 3968421990⟩, ⟨(-195562671), (-159148206)⟩, ⟨590004, 7468379⟩, ⟨(-648629), 435548⟩, ⟨(-57803), 79660⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2043092732, 4086185476⟩, ⟨1021546363, 1021546369⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨971888171, 3887552709⟩, ⟨971888168, 1943776356⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨971888171, 3887552709⟩, ⟨971888168, 1943776356⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3887552709), (-971888171)⟩, ⟨(-1943776356), (-971888168)⟩, ⟨(-242972045), (-242972041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1943776355), (-485944085)⟩, ⟨(-971888178), (-485944084)⟩, ⟨(-121486023), (-121486020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2731560997, 3835505610⟩, ⟨(-867918730), (-309056115)⟩, ⟨(-91006125), 20934619⟩, ⟨4248839, 23230893⟩, ⟨(-1610278), 1166904⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2216509358, 3543893063⟩, ⟨(-976573094), (-351998638)⟩, ⟨(-72259771), 65531332⟩, ⟨406042, 25954935⟩, ⟨(-2843504), 1159363⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4345128724, 4345128726⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified978
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4315785607, 4390988796⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified979
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (276966519 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((19247 / 200000) : ℝ)..(19247 / 100000), prawitzNormalCorrection
