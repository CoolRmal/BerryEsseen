...
namespace FiniteNormalPanel139_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (16359 / 160000)
def radius : Rat := (5453 / 160000)

def j0 : Jet := ⟨⟨439133562, 439133563⟩, ⟨146377854, 146377855⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1379578772, 1379578776⟩, ⟨459859590, 459859594⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨443132032, 443132036⟩, ⟨295421354, 295421360⟩, ⟨49236892, 49236894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨110, 112⟩, ⟨73, 75⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94577), (-94574)⟩, ⟨73, 75⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9758), (-9757)⟩, ⟨(-6499), (-6497)⟩, ⟨(-1079), (-1076)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103298, 5103300⟩, ⟨(-6499), (-6497)⟩, ⟨(-1079), (-1076)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨526531, 526532⟩, ⟨350349, 350352⟩, ⟨57943, 57947⟩, ⟨(-150), (-147)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-142639046), (-142639044)⟩, ⟨350349, 350352⟩, ⟨57943, 57947⟩, ⟨(-150), (-147)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14716744), (-14716742)⟩, ⟨(-9775016), (-9775013)⟩, ⟨(-1605118), (-1605115)⟩, ⟨7985, 7988⟩, ⟨651, 654⟩⟩
...
def j19 : Jet := ⟨⟨1416939021, 1416939024⟩, ⟨(-9775016), (-9775013)⟩, ⟨(-1605118), (-1605115)⟩, ⟨7985, 7988⟩, ⟨651, 654⟩⟩
...
def j25 : Jet := ⟨⟨1219, 1221⟩, ⟨812, 814⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850958), (-850955)⟩, ⟨812, 814⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-87798), (-87797)⟩, ⟨(-58449), (-58447)⟩, ⟨(-9688), (-9684)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35703596, 35703598⟩, ⟨(-58449), (-58447)⟩, ⟨(-9688), (-9684)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3683708, 3683709⟩, ⟨2449774, 2449776⟩, ⟨404279, 404282⟩, ⟨(-1337), (-1333)⟩, ⟨(-112), (-108)⟩⟩
...
def j33 : Jet := ⟨⟨(-712144175), (-712144173)⟩, ⟨2449774, 2449776⟩, ⟨404279, 404282⟩, ⟨(-1337), (-1333)⟩, ⟨(-112), (-108)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-73475274), (-73475272)⟩, ⟨(-48730763), (-48730760)⟩, ⟨(-7953706), (-7953703)⟩, ⟨55752, 55755⟩, ⟨4530, 4533⟩⟩
...
def j36 : Jet := ⟨⟨4221492022, 4221492024⟩, ⟨(-48730763), (-48730760)⟩, ⟨(-7953706), (-7953703)⟩, ⟨55752, 55755⟩, ⟨4530, 4533⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨455132451, 455132454⟩, ⟨148571000, 148571005⟩, ⟨(-1562184), (-1562180)⟩, ⟨(-169296), (-169292)⟩, ⟨1063, 1067⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4369721408, 4369721411⟩, ⟨50441844, 50441849⟩, ⟨8815255, 8815261⟩, ⟨139082, 139089⟩, ⟨12854, 12863⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨463054053, 463054057⟩, ⟨156502145, 156502153⟩, ⟨1089645, 1089653⟩, ⟨129084, 129093⟩, ⟨2058, 2068⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-439133563), (-439133562)⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3855833733, 3855833734⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨49923326, 49923328⟩, ⟨33745984, 33745988⟩, ⟨5937658, 5937662⟩, ⟨107242, 107248⟩, ⟨10124, 10131⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4344890622, 4344890624⟩, ⟨33745984, 33745988⟩, ⟨5937658, 5937662⟩, ⟨107242, 107248⟩, ⟨10124, 10131⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4319856840, 4319856842⟩, ⟨16775775, 16775778⟩, ⟨2919149, 2919153⟩, ⟨41975, 41980⟩, ⟨3882, 3888⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3878178476, 3878178480⟩, ⟨(-132165566), (-132165560)⟩, ⟨2048944, 2048949⟩, ⟨(-61806), (-61800)⟩, ⟨2054, 2061⟩⟩
...
def j47 : Jet := ⟨⟨5192700164, 5192700178⟩, ⟨1730900054, 1730900068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6278076906, 6278076940⟩, ⟨4185384602, 4185384648⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6278076906, 6278076940⟩, ⟨4185384602, 4185384648⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6278076940), (-6278076906)⟩, ⟨(-4185384648), (-4185384602)⟩, ⟨(-697564112), (-697564100)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3139038470), (-3139038453)⟩, ⟨(-2092692324), (-2092692301)⟩, ⟨(-348782056), (-348782050)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2067995108, 2067995127⟩, ⟨(-1007615945), (-1007615924)⟩, ⟨77540858, 77540871⟩, ⟨41956664, 41956670⟩, ⟨(-8259210), (-8259207)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1867314362, 1867314382⟩, ⟨(-973472424), (-973472399)⟩, ⟨102009301, 102009320⟩, ⟨34988583, 34988597⟩, ⟨(-8696349), (-8696336)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨292755708, 585511417⟩, ⟨146377854, 146377855⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨919719181, 1839438367⟩, ⟨459859590, 459859594⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨196947569, 787790285⟩, ⟨196947568, 393895144⟩, ⟨49236892, 49236894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨49, 198⟩, ⟨49, 99⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94638), (-94488)⟩, ⟨49, 99⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-17359), (-4332)⟩, ⟨(-8678), (-4313)⟩, ⟨(-1083), (-1070)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095697, 5108725⟩, ⟨(-8678), (-4313)⟩, ⟨(-1083), (-1070)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨233665, 937052⟩, ⟨232073, 468329⟩, ⟨57421, 58320⟩, ⟨(-200), (-97)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142931912), (-142228524)⟩, ⟨232073, 468329⟩, ⟨57421, 58320⟩, ⟨(-200), (-97)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-26216818), (-6521950)⟩, ⟨(-13097768), (-6436047)⟩, ⟨(-1625278), (-1576838)⟩, ⟨5256, 10714⟩, ⟨636, 665⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1405438947, 1425133816⟩, ⟨(-13097768), (-6436047)⟩, ⟨(-1625278), (-1576838)⟩, ⟨5256, 10714⟩, ⟨636, 665⟩⟩
...
def j70 : Jet := ⟨⟨(-20), (-4)⟩, ⟨(-10), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11815, 11832⟩, ⟨(-10), (-4)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨541, 2171⟩, ⟨539, 1086⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851636), (-850005)⟩, ⟨539, 1086⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-156209), (-38977)⟩, ⟨(-78081), (-38777)⟩, ⟨(-9734), (-9619)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35635185, 35752418⟩, ⟨(-78081), (-38777)⟩, ⟨(-9734), (-9619)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1634066, 6557770⟩, ⟨1619744, 3277107⟩, ⟨399569, 407642⟩, ⟨(-1789), (-880)⟩, ⟨(-113), (-106)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714193817), (-709270112)⟩, ⟨1619744, 3277107⟩, ⟨399569, 407642⟩, ⟨(-1789), (-880)⟩, ⟨(-113), (-106)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-130998658), (-32523885)⟩, ⟨(-65425056), (-31922792)⟩, ⟨(-8094821), (-7755653)⟩, ⟨36561, 74915⟩, ⟨4394, 4630⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4163968638, 4262443411⟩, ⟨(-65425056), (-31922792)⟩, ⟨(-8094821), (-7755653)⟩, ⟨36561, 74915⟩, ⟨4394, 4630⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨300959022, 610352918⟩, ⟨144870029, 151210024⟩, ⟨(-2098442), (-1026765)⟩, ⟨(-172893), (-164242)⟩, ⟨698, 1433⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4327739349, 4430087179⟩, ⟨32411813, 69606361⟩, ⟨8117202, 9705829⟩, ⟨41903, 249819⟩, ⟨9045, 17945⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨303255441, 629554651⟩, ⟨148246612, 165858780⟩, ⟨(-502412), 2795271⟩, ⟨64388, 203966⟩, ⟨(-4796), 9647⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-585511417), (-292755708)⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3709455879, 4002211588⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21412005, 92279879⟩, ⟨20934544, 48623034⟩, ⟨4969644, 7224430⟩, ⟨(-29712), 275686⟩, ⟨2711, 20404⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316379301, 4387247175⟩, ⟨20934544, 48623034⟩, ⟨4969644, 7224430⟩, ⟨(-29712), 275686⟩, ⟨2711, 20404⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305659988, 4340862027⟩, ⟨10356604, 24251142⟩, ⟨2390808, 3590789⟩, ⟨(-35045), 131750⟩, ⟨(-888), 9711⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3718690889, 4044978020⟩, ⟨(-138997266), (-124144150)⟩, ⟨1238371, 2993066⟩, ⟨(-155036), 41289⟩, ⟨(-5319), 10245⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3461800109, 6923600233⟩, ⟨1730900054, 1730900068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2790256402, 11161025657⟩, ⟨2790256400, 5580512860⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2790256402, 11161025657⟩, ⟨2790256400, 5580512860⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11161025657), (-2790256402)⟩, ⟨(-5580512860), (-2790256400)⟩, ⟨(-697564112), (-697564100)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5580512829), (-1395128201)⟩, ⟨(-2790256430), (-1395128200)⟩, ⟨(-348782056), (-348782050)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1171317919, 3103763307⟩, ⟨(-2016382182), (-380477556)⟩, ⟨(-190252780), 559859213⟩, ⟨(-100640525), 150362798⟩, ⟨(-47153355), 24070404⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1014156563, 2923108255⟩, ⟨(-1999464870), (-363283484)⟩, ⟨(-167843823), 594691279⟩, ⟨(-114418561), 147688160⟩, ⟨(-49430764), 26396739⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨439133562, 439133563⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4319856840, 4319856842⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2794
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨292755708, 585511417⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305659988, 4340862027⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2795
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (129958407 / 4294967296)

theorem envelope_integral : (∫ s in ((5453 / 80000) : ℝ)..(5453 / 40000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((5453 / 80000) : ℝ)..(5453 / 40000), prawitzNormalCorrection
