...
namespace FiniteNormalPanel67_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (111727 / 400000)
def radius : Rat := (15961 / 400000)

def j0 : Jet := ⟨⟨1199659527, 1199659528⟩, ⟨171379932, 171379933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3768841556, 3768841561⟩, ⟨538405935, 538405939⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3307165269, 3307165279⟩, ⟨944904358, 944904370⟩, ⟨67493168, 67493170⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨827, 829⟩, ⟨236, 237⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93860), (-93857)⟩, ⟨236, 237⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-72274), (-72270)⟩, ⟨(-20469), (-20465)⟩, ⟨(-1412), (-1407)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5040782, 5040787⟩, ⟨(-20469), (-20465)⟩, ⟨(-1412), (-1407)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3881449, 3881454⟩, ⟨1093223, 1093229⟩, ⟨73621, 73629⟩, ⟨(-629), (-623)⟩, ⟨(-22), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-139284128), (-139284122)⟩, ⟨1093223, 1093229⟩, ⟨73621, 73629⟩, ⟨(-629), (-623)⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-107250091), (-107250085)⟩, ⟨(-29801092), (-29801084)⟩, ⟨(-1891578), (-1891567)⟩, ⟨32890, 32900⟩, ⟨1000, 1007⟩⟩
...
def j19 : Jet := ⟨⟨1324405674, 1324405681⟩, ⟨(-29801092), (-29801084)⟩, ⟨(-1891578), (-1891567)⟩, ⟨32890, 32900⟩, ⟨1000, 1007⟩⟩
...
def j25 : Jet := ⟨⟨9048, 9051⟩, ⟨2566, 2569⟩, ⟨176, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843129), (-843125)⟩, ⟨2566, 2569⟩, ⟨176, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-649218), (-649214)⟩, ⟨(-183516), (-183510)⟩, ⟨(-12551), (-12544)⟩, ⟨76, 81⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35142176, 35142181⟩, ⟨(-183516), (-183510)⟩, ⟨(-12551), (-12544)⟩, ⟨76, 81⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨27059806, 27059811⟩, ⟨7590063, 7590071⟩, ⟨502200, 502212⟩, ⟨(-5588), (-5579)⟩, ⟨(-182), (-176)⟩⟩
...
def j33 : Jet := ⟨⟨(-688768077), (-688768071)⟩, ⟨7590063, 7590071⟩, ⟨502200, 502212⟩, ⟨(-5588), (-5579)⟩, ⟨(-182), (-176)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-530357908), (-530357901)⟩, ⟨(-145686413), (-145686401)⟩, ⟨(-8767099), (-8767085)⟩, ⟨225455, 225468⟩, ⟨6520, 6530⟩⟩
...
def j36 : Jet := ⟨⟨3764609388, 3764609395⟩, ⟨(-145686413), (-145686401)⟩, ⟨(-8767099), (-8767085)⟩, ⟨225455, 225468⟩, ⟨6520, 6530⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1162168369, 1162168378⟩, ⟨139873539, 139873550⟩, ⟨(-5395652), (-5395639)⟩, ⟨(-208263), (-208251)⟩, ⟨5000, 5009⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4900041979, 4900041990⟩, ⟨189626440, 189626458⟩, ⟨18749640, 18749664⟩, ⟨873724, 873746⟩, ⟨57617, 57637⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1325894565, 1325894579⟩, ⟨210889629, 210889649⟩, ⟨5093178, 5093203⟩, ⟨371208, 371233⟩, ⟨16998, 17019⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1199659528), (-1199659527)⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3095307768, 3095307769⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨409315432, 409315442⟩, ⟨130207004, 130207020⟩, ⟨13499629, 13499650⟩, ⟨729356, 729376⟩, ⟨52985, 53006⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4704282728, 4704282738⟩, ⟨130207004, 130207020⟩, ⟨13499629, 13499650⟩, ⟨729356, 729376⟩, ⟨52985, 53006⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4494968350, 4494968355⟩, ⟨62206758, 62206767⟩, ⟨6019039, 6019050⟩, ⟨265152, 265164⟩, ⟨17613, 17625⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3239445027, 3239445033⟩, ⟨(-134529155), (-134529145)⟩, ⟨1855610, 1855620⟩, ⟨(-49086), (-49074)⟩, ⟨2112, 2123⟩⟩
...
def j47 : Jet := ⟨⟨9276969438, 9276969449⟩, ⟨1325281345, 1325281354⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20037908561, 20037908610⟩, ⟨5725116716, 5725116764⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20037908561, 20037908610⟩, ⟨5725116716, 5725116764⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20037908610), (-20037908561)⟩, ⟨(-5725116764), (-5725116716)⟩, ⟨(-408936913), (-408936907)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10018954305), (-10018954280)⟩, ⟨(-2862558382), (-2862558358)⟩, ⟨(-204468457), (-204468453)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨416747127, 416747140⟩, ⟨(-277758348), (-277758336)⟩, ⟨72721875, 72721882⟩, ⟨(-7340763), (-7340759)⟩, ⟨(-507880), (-507879)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨314328216, 314328227⟩, ⟨(-222550599), (-222550586)⟩, ⟨63730036, 63730046⟩, ⟨(-7939313), (-7939304)⟩, ⟨(-118340), (-118330)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1028279595, 1371039461⟩, ⟨171379932, 171379933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3230435621, 4307247499⟩, ⟨538405935, 538405939⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2429754077, 4319562814⟩, ⟨809918022, 1079890708⟩, ⟨67493168, 67493170⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨608, 1083⟩, ⟨202, 271⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94079), (-93603)⟩, ⟨202, 271⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-94618), (-52953)⟩, ⟨(-23541), (-17378)⟩, ⟨(-1432), (-1383)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5018438, 5060104⟩, ⟨(-23541), (-17378)⟩, ⟨(-1432), (-1383)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2839036, 5089082⟩, ⟨922669, 1262440⟩, ⟨71502, 75458⟩, ⟨(-728), (-522)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140326541), (-138076494)⟩, ⟨922669, 1262440⟩, ⟨71502, 75458⟩, ⟨(-728), (-522)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-141130134), (-78112800)⟩, ⟨(-34760561), (-24767930)⟩, ⟨(-1990718), (-1776490)⟩, ⟨27249, 38517⟩, ⟨916, 1079⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1290525631, 1353542966⟩, ⟨(-34760561), (-24767930)⟩, ⟨(-1990718), (-1776490)⟩, ⟨27249, 38517⟩, ⟨916, 1079⟩⟩
...
def j72 : Jet := ⟨⟨6633, 11844⟩, ⟨2182, 2950⟩, ⟨173, 183⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845544), (-840332)⟩, ⟨2182, 2950⟩, ⟨173, 183⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-850387), (-475393)⟩, ⟨(-211363), (-155497)⟩, ⟨(-12780), (-12278)⟩, ⟨63, 94⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34941007, 35316002⟩, ⟨(-211363), (-155497)⟩, ⟨(-12780), (-12278)⟩, ⟨63, 94⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19766868, 35518243⟩, ⟨6376382, 8791594⟩, ⟨483081, 518706⟩, ⟨(-6501), (-4663)⟩, ⟨(-192), (-164)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696061015), (-680309639)⟩, ⟨6376382, 8791594⟩, ⟨483081, 518706⟩, ⟨(-6501), (-4663)⟩, ⟨(-192), (-164)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-700047072), (-384865589)⟩, ⟨(-171404515), (-119446589)⟩, ⟨(-9462529), (-7958548)⟩, ⟨184758, 265939⟩, ⟨5762, 7181⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3594920224, 3910101707⟩, ⟨(-171404515), (-119446589)⟩, ⟨(-9462529), (-7958548)⟩, ⟨184758, 265939⟩, ⟨5762, 7181⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨970661632, 1357413027⟩, ⟨126916989, 151047570⟩, ⟨(-6353904), (-4441020)⟩, ⟨(-229057), (-184068)⟩, ⟨4103, 5912⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4717714641, 5131336143⟩, ⟨144117713, 244660279⟩, ⟨14004884, 25171992⟩, ⟨372158, 1601724⟩, ⟨13807, 127661⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1066202435, 1621745184⟩, ⟨171979812, 257785644⟩, ⟨(-167413), 11681735⟩, ⟨(-137656), 1040280⟩, ⟨(-31666), 83085⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1371039461), (-1028279595)⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2923927835, 3266687701⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨264678996, 612357968⟩, ⟨85386118, 194675582⟩, ⟨6760016, 24294257⟩, ⟨(-124054), 2187890⟩, ⟨(-40896), 219397⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4559646292, 4907325264⟩, ⟨85386118, 194675582⟩, ⟨6760016, 24294257⟩, ⟨(-124054), 2187890⟩, ⟨(-40896), 219397⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4425328429, 4590947781⟩, ⟨39940618, 94470419⟩, ⟨2190112, 11609059⟩, ⟨(-308027), 1041954⟩, ⟨(-57317), 112502⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3012675087, 3491806019⟩, ⟨(-155999522), (-104728883)⟩, ⟨(-2278622), 7235947⟩, ⟨(-697512), 705105⟩, ⟨(-85172), 97860⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7951688093, 10602250802⟩, ⟨1325281345, 1325281354⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14721728751, 26171962281⟩, ⟨4907242902, 6542990590⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14721728751, 26171962281⟩, ⟨4907242902, 6542990590⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-26171962281), (-14721728751)⟩, ⟨(-6542990590), (-4907242902)⟩, ⟨(-408936913), (-408936907)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13085981141), (-7360864375)⟩, ⟨(-3271495295), (-2453621451)⟩, ⟨(-204468457), (-204468453)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨204053415, 773839459⟩, ⟨(-589436887), (-116571280)⟩, ⟨(-3542487), 214774049⟩, ⟨(-50831741), 19606803⟩, ⟨(-8845970), 9764013⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨143131855, 629131050⟩, ⟨(-507318848), (-86743774)⟩, ⟨(-448104), 197324124⟩, ⟨(-50245815), 16508747⟩, ⟨(-8129976), 10259621⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1199659527, 1199659528⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4494968350, 4494968355⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1328
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1028279595, 1371039461⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4425328429, 4590947781⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1329
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (6736011 / 1073741824)

theorem envelope_integral : (∫ s in ((47883 / 200000) : ℝ)..(15961 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((47883 / 200000) : ℝ)..(15961 / 50000), prawitzNormalCorrection
