...
namespace FiniteNormalPanel86_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (211239 / 800000)
def radius : Rat := (30177 / 800000)

def j0 : Jet := ⟨⟨1134080745, 1134080746⟩, ⟨162011535, 162011536⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3562819736, 3562819741⟩, ⟨508974248, 508974252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2955478725, 2955478735⟩, ⟨844422492, 844422502⟩, ⟨60315892, 60315894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨739, 741⟩, ⟨211, 212⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93948), (-93945)⟩, ⟨211, 212⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-64649), (-64645)⟩, ⟨(-18326), (-18324)⟩, ⟨(-1269), (-1265)⟩, ⟨4, 7⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5048407, 5048412⟩, ⟨(-18326), (-18324)⟩, ⟨(-1269), (-1265)⟩, ⟨4, 7⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3473940, 3473944⟩, ⟨979943, 979947⟩, ⟨66418, 66425⟩, ⟨(-506), (-500)⟩, ⟨(-18), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-139691637), (-139691632)⟩, ⟨979943, 979947⟩, ⟨66418, 66425⟩, ⟨(-506), (-500)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-96125450), (-96125445)⟩, ⟨(-26790091), (-26790085)⟩, ⟨(-1723377), (-1723369)⟩, ⟨26470, 26478⟩, ⟨819, 826⟩⟩
...
def j19 : Jet := ⟨⟨1335530315, 1335530321⟩, ⟨(-26790091), (-26790085)⟩, ⟨(-1723377), (-1723369)⟩, ⟨26470, 26478⟩, ⟨819, 826⟩⟩
...
def j25 : Jet := ⟨⟨8092, 8095⟩, ⟨2296, 2299⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844085), (-844081)⟩, ⟨2296, 2299⟩, ⟨158, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-580837), (-580834)⟩, ⟨(-164375), (-164369)⟩, ⟨(-11295), (-11288)⟩, ⟨61, 65⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35210557, 35210561⟩, ⟨(-164375), (-164369)⟩, ⟨(-11295), (-11288)⟩, ⟨61, 65⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨24229300, 24229304⟩, ⟨6809546, 6809553⟩, ⟨454384, 454393⟩, ⟨(-4489), (-4482)⟩, ⟨(-148), (-142)⟩⟩
...
def j33 : Jet := ⟨⟨(-691598583), (-691598578)⟩, ⟨6809546, 6809553⟩, ⟨454384, 454393⟩, ⟨(-4489), (-4482)⟩, ⟨(-148), (-142)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-475906978), (-475906972)⟩, ⟨(-131287599), (-131287589)⟩, ⟨(-8060908), (-8060898)⟩, ⟨181875, 181884⟩, ⟨5396, 5404⟩⟩
...
def j36 : Jet := ⟨⟨3819060318, 3819060324⟩, ⟨(-131287599), (-131287589)⟩, ⟨(-8060908), (-8060898)⟩, ⟨181875, 181884⟩, ⟨5396, 5404⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1107867286, 1107867294⟩, ⟨136043474, 136043483⟩, ⟨(-4604355), (-4604345)⟩, ⟨(-182272), (-182262)⟩, ⟨3815, 3824⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4830178763, 4830178772⟩, ⟨166046741, 166046756⟩, ⟨15903244, 15903262⟩, ⟨667138, 667155⟩, ⟨41755, 41772⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1245922650, 1245922662⟩, ⟨195827346, 195827363⟩, ⟨4183593, 4183613⟩, ⟨292827, 292847⟩, ⟨12095, 12115⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1134080746), (-1134080745)⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3160886550, 3160886551⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨361428421, 361428429⟩, ⟨113614706, 113614720⟩, ⟨11355898, 11355915⟩, ⟨551388, 551406⟩, ⟨37793, 37812⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4656395717, 4656395725⟩, ⟨113614706, 113614720⟩, ⟨11355898, 11355915⟩, ⟨551388, 551406⟩, ⟨37793, 37812⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4472031677, 4472031682⟩, ⟨54558138, 54558146⟩, ⟨5120336, 5120346⟩, ⟨202310, 202321⟩, ⟨12747, 12759⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3291197302, 3291197308⟩, ⟨(-128538498), (-128538488)⟩, ⟨1710315, 1710325⟩, ⟨(-44256), (-44246)⟩, ⟨1749, 1760⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨36984564681, 36984564684⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value408

def j47 : Jet := ⟨⟨9765728066, 9765728076⟩, ⟨1395104009, 1395104019⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨22204929184, 22204929231⟩, ⟨6344265478, 6344265532⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨22204929184, 22204929231⟩, ⟨6344265478, 6344265532⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-22204929231), (-22204929184)⟩, ⟨(-6344265532), (-6344265478)⟩, ⟨(-453161827), (-453161819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11102464616), (-11102464592)⟩, ⟨(-3172132766), (-3172132739)⟩, ⟨(-226580914), (-226580909)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨323825642, 323825651⟩, ⟨(-239167819), (-239167809)⟩, ⟨71237633, 71237640⟩, ⟨(-9126460), (-9126456)⟩, ⟨(-193940), (-193938)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨248144864, 248144873⟩, ⟨(-192963646), (-192963635)⟩, ⟨61875491, 61875502⟩, ⟨(-9224087), (-9224078)⟩, ⟨155479, 155487⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨972069210, 1296092281⟩, ⟨162011535, 162011536⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3053845488, 4071793989⟩, ⟨508974248, 508974252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2171372125, 3860217121⟩, ⟨723790708, 965054288⟩, ⟨60315892, 60315894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨543, 968⟩, ⟨181, 242⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94144), (-93718)⟩, ⟨181, 242⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-84615), (-47380)⟩, ⟨(-21063), (-15575)⟩, ⟨(-1286), (-1246)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5028441, 5065677⟩, ⟨(-21063), (-15575)⟩, ⟨(-1286), (-1246)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2542188, 4552914⟩, ⟨828465, 1130355⟩, ⟨64727, 67887⟩, ⟨(-583), (-419)⟩, ⟨(-19), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140623389), (-138612662)⟩, ⟨828465, 1130355⟩, ⟨64727, 67887⟩, ⟨(-583), (-419)⟩, ⟨(-19), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-126389045), (-70077290)⟩, ⟨(-31178422), (-22343159)⟩, ⟨(-1802493), (-1631590)⟩, ⟨22017, 30918⟩, ⟨759, 877⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1305266720, 1361578476⟩, ⟨(-31178422), (-22343159)⟩, ⟨(-1802493), (-1631590)⟩, ⟨22017, 30918⟩, ⟨759, 877⟩⟩
...
def j72 : Jet := ⟨⟨5933, 10590⟩, ⟨1954, 2639⟩, ⟨156, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846244), (-841586)⟩, ⟨1954, 2639⟩, ⟨156, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-760585), (-425473)⟩, ⟨(-189160), (-139452)⟩, ⟨(-11478), (-11078)⟩, ⟨51, 75⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35030809, 35365922⟩, ⟨(-189160), (-139452)⟩, ⟨(-11478), (-11078)⟩, ⟨51, 75⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17710244, 31786072⟩, ⟨5733401, 7876017⟩, ⟨439130, 467558⟩, ⟨(-5212), (-3756)⟩, ⟨(-154), (-135)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698117639), (-684041810)⟩, ⟨5733401, 7876017⟩, ⟨439130, 467558⟩, ⟨(-5212), (-3756)⟩, ⟨(-154), (-135)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-627451964), (-345825524)⟩, ⟨(-153964404), (-108196392)⟩, ⟨(-8615735), (-7416337)⟩, ⟨149833, 213766⟩, ⟨4855, 5867⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3667515332, 3949141772⟩, ⟨(-153964404), (-108196392)⟩, ⟨(-8615735), (-7416337)⟩, ⟨149833, 213766⟩, ⟨4855, 5867⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨928082243, 1290828701⟩, ⟨125122031, 145466960⟩, ⟨(-5403626), (-3807878)⟩, ⟨(-197951), (-164039)⟩, ⟨3148, 4496⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4671076689, 5029766042⟩, ⟨127975563, 211152474⟩, ⟨12278306, 20680242⟩, ⟨304466, 1173378⟩, ⟨12495, 86431⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1009354212, 1511668407⟩, ⟨163732666, 233814691⟩, ⟨53285, 9225559⟩, ⟨(-73992), 761212⟩, ⟨(-20760), 55213⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1296092281), (-972069210)⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2998875015, 3322898086⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨237206911, 532050937⟩, ⟨76957166, 164588114⟩, ⟨6266857, 19222797⟩, ⟨(-48024), 1540304⟩, ⟨(-22672), 141563⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4532174207, 4827018233⟩, ⟨76957166, 164588114⟩, ⟨6266857, 19222797⟩, ⟨(-48024), 1540304⟩, ⟨(-22672), 141563⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4411976881, 4553228026⟩, ⟨36296063, 80111545⟩, ⟨2250939, 9207197⟩, ⟨(-190558), 731210⟩, ⟨(-33920), 71792⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3080574617, 3522707311⟩, ⟨(-146410454), (-104445182)⟩, ⟨(-1450235), 5754224⟩, ⟨(-494737), 480810⟩, ⟨(-53826), 62733⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8370624056, 11160832086⟩, ⟨1395104009, 1395104019⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨16313825521, 29002356542⟩, ⟨5437941838, 7250589180⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨16313825521, 29002356542⟩, ⟨5437941838, 7250589180⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-29002356542), (-16313825521)⟩, ⟨(-7250589180), (-5437941838)⟩, ⟨(-453161827), (-453161819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-14501178271), (-8156912760)⟩, ⟨(-3625294590), (-2718970919)⟩, ⟨(-226580914), (-226580909)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨146772025, 642919792⟩, ⟨(-542675528), (-92915461)⟩, ⟨(-4506702), 221287737⟩, ⟨(-58993659), 20353897⟩, ⟨(-10132093), 12567713⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨105272553, 527319092⟩, ⟨(-467015718), (-70213023)⟩, ⟨(-1653938), 200859460⟩, ⟨(-56730814), 17102992⟩, ⟨(-9147656), 12687367⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1134080745, 1134080746⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4472031677, 4472031682⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar408 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1734
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar408 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨972069210, 1296092281⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4411976881, 4553228026⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1735
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((90531 / 400000) : ℝ)..(30177 / 100000), prawitzNormalCorrection
      ((143519 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
