...
namespace FiniteNormalPanel16_22
...
def j2 : Jet := ⟨⟨1997188841, 1997188846⟩, ⟨665729611, 665729616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨928706318, 928706324⟩, ⟨619137542, 619137550⟩, ⟨103189590, 103189592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨232, 233⟩, ⟨154, 156⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94455), (-94453)⟩, ⟨154, 156⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-20425), (-20423)⟩, ⟨(-13584), (-13581)⟩, ⟨(-2243), (-2240)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5092631, 5092634⟩, ⟨(-13584), (-13581)⟩, ⟨(-2243), (-2240)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1101186, 1101187⟩, ⟨731186, 731189⟩, ⟨119909, 119914⟩, ⟨(-650), (-646)⟩, ⟨(-54), (-50)⟩⟩
...
def j16 : Jet := ⟨⟨(-142064391), (-142064389)⟩, ⟨731186, 731189⟩, ⟨119909, 119914⟩, ⟨(-650), (-646)⟩, ⟨(-54), (-50)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-30718767), (-30718766)⟩, ⟨(-20321073), (-20321071)⟩, ⟨(-3281866), (-3281862)⟩, ⟨34711, 34716⟩, ⟨2774, 2779⟩⟩
...
def j19 : Jet := ⟨⟨1400936998, 1400937000⟩, ⟨(-20321073), (-20321071)⟩, ⟨(-3281866), (-3281862)⟩, ⟨34711, 34716⟩, ⟨2774, 2779⟩⟩
...
def j22 : Jet := ⟨⟨(-24), (-23)⟩, ⟨(-16), (-15)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11811, 11813⟩, ⟨(-16), (-15)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2553, 2555⟩, ⟨1698, 1700⟩, ⟨279, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849624), (-849621)⟩, ⟨1698, 1700⟩, ⟨279, 282⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-183716), (-183714)⟩, ⟨(-122110), (-122108)⟩, ⟨(-20109), (-20105)⟩, ⟨79, 82⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35607678, 35607681⟩, ⟨(-122110), (-122108)⟩, ⟨(-20109), (-20105)⟩, ⟨79, 82⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7699494, 7699495⟩, ⟨5106591, 5106594⟩, ⟨833547, 833551⟩, ⟨(-5816), (-5813)⟩, ⟨(-473), (-469)⟩⟩
...
def j33 : Jet := ⟨⟨(-708128389), (-708128387)⟩, ⟨5106591, 5106594⟩, ⟨833547, 833551⟩, ⟨(-5816), (-5813)⟩, ⟨(-473), (-469)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-153119516), (-153119514)⟩, ⟨(-100975474), (-100975469)⟩, ⟨(-16096906), (-16096902)⟩, ⟨241590, 241594⟩, ⟨19084, 19089⟩⟩
...
def j36 : Jet := ⟨⟨4141847780, 4141847782⟩, ⟨(-100975474), (-100975469)⟩, ⟨(-16096906), (-16096902)⟩, ⟨241590, 241594⟩, ⟨19084, 19089⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨651445179, 651445182⟩, ⟨207698955, 207698960⟩, ⟨(-4675903), (-4675899)⟩, ⟨(-492557), (-492552)⟩, ⟨6669, 6675⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4453747468, 4453747471⟩, ⟨108579372, 108579381⟩, ⟨19956161, 19956169⟩, ⟨648713, 648721⟩, ⟨66511, 66521⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨675528383, 675528388⟩, ⟨231846282, 231846291⟩, ⟨3428867, 3428875⟩, ⟨434470, 434481⟩, ⟨14193, 14206⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-635724954), (-635724953)⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3659242342, 3659242343⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨106249609, 106249611⟩, ⟨72931284, 72931290⟩, ⟨13593883, 13593891⟩, ⟨506856, 506862⟩, ⟨54107, 54116⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4401216905, 4401216907⟩, ⟨72931284, 72931290⟩, ⟨13593883, 13593891⟩, ⟨506856, 506862⟩, ⟨54107, 54116⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4347767550, 4347767552⟩, ⟨36022795, 36022799⟩, ⟨6565167, 6565172⟩, ⟨195955, 195959⟩, ⟨20143, 20150⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3704227300, 3704227304⟩, ⟨(-183822582), (-183822575)⟩, ⟨3816095, 3816101⟩, ⟨(-156968), (-156963)⟩, ⟨7492, 7500⟩⟩
...
def j47 : Jet := ⟨⟨2971097473, 2971097479⟩, ⟨990365821, 990365827⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2055293925, 2055293934⟩, ⟨1370195944, 1370195958⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2055293925, 2055293934⟩, ⟨1370195944, 1370195958⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2055293934), (-2055293925)⟩, ⟨(-1370195958), (-1370195944)⟩, ⟨(-228365993), (-228365990)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1027646967), (-1027646962)⟩, ⟨(-685097979), (-685097972)⟩, ⟨(-114182997), (-114182995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3381015932, 3381015938⟩, ⟨(-539311950), (-539311943)⟩, ⟨(-46872016), (-46872012)⟩, ⟨12050726, 12050727⟩, ⟨142494, 142496⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2915982975, 2915982985⟩, ⟨(-609839599), (-609839585)⟩, ⟨(-14338787), (-14338774)⟩, ⟨11796592, 11796602⟩, ⟨(-408912), (-408897)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨423816635, 847633271⟩, ⟨211908317, 211908318⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1331459226, 2662918458⟩, ⟨665729611, 665729616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨412758363, 1651033460⟩, ⟨412758360, 825516732⟩, ⟨103189590, 103189592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨103, 414⟩, ⟨103, 207⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94584), (-94272)⟩, ⟨103, 207⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-36360), (-9059)⟩, ⟨(-18171), (-8979)⟩, ⟨(-2262), (-2214)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5076696, 5103998⟩, ⟨(-18171), (-8979)⟩, ⟨(-2262), (-2214)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨487884, 1962034⟩, ⟨480898, 980155⟩, ⟨117608, 121554⟩, ⟨(-872), (-423)⟩, ⟨(-55), (-50)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142677693), (-141203542)⟩, ⟨480898, 980155⟩, ⟨117608, 121554⟩, ⟨(-872), (-423)⟩, ⟨(-55), (-50)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-54846901), (-13570055)⟩, ⟨(-27377236), (-13193271)⟩, ⟨(-3370415), (-3157394)⟩, ⟨22519, 46873⟩, ⟨2635, 2877⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1376808864, 1418085711⟩, ⟨(-27377236), (-13193271)⟩, ⟨(-3370415), (-3157394)⟩, ⟨22519, 46873⟩, ⟨2635, 2877⟩⟩
...
def j72 : Jet := ⟨⟨1133, 4547⟩, ⟨1124, 2274⟩, ⟨276, 285⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851044), (-847629)⟩, ⟨1124, 2274⟩, ⟨276, 285⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-327151), (-81459)⟩, ⟨(-163468), (-80584)⟩, ⟨(-20313), (-19816)⟩, ⟨52, 110⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35464243, 35709936⟩, ⟨(-163468), (-80584)⟩, ⟨(-20313), (-19816)⟩, ⟨52, 110⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3408212, 13727299⟩, ⟨3345373, 6855906⟩, ⟨812824, 848309⟩, ⟨(-7829), (-3797)⟩, ⟨(-485), (-451)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712419671), (-702100583)⟩, ⟨3345373, 6855906⟩, ⟨812824, 848309⟩, ⟨(-7829), (-3797)⟩, ⟨(-485), (-451)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-273862089), (-67473828)⟩, ⟨(-136609546), (-64838341)⟩, ⟨(-16716768), (-15224613)⟩, ⟨155478, 327404⟩, ⟨17836, 19975⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4021105207, 4227493468⟩, ⟨(-136609546), (-64838341)⟩, ⟨(-16716768), (-15224613)⟩, ⟨155478, 327404⟩, ⟨17836, 19975⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨426816955, 879225930⟩, ⟨196434343, 215716510⟩, ⟨(-6333222), (-3023792)⟩, ⟨(-515442), (-460341)⟩, ⟨4306, 9050⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4363518054, 4587481084⟩, ⟨66924590, 155851111⟩, ⟨16740924, 24366090⟩, ⟨142492, 1306990⟩, ⟨28727, 123760⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨433629259, 939106644⟩, ⟨206220277, 262312534⟩, ⟨(-2040049), 9743635⟩, ⟨(-540), 976547⟩, ⟨(-40889), 81689⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-847633271), (-423816635)⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3447334025, 3871150661⟩, ⟨(-211908318), (-211908317)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨43780155, 205338302⟩, ⟨41640896, 114710744⟩, ⟨9009416, 20281528⟩, ⟨(-249428), 1617224⟩, ⟨(-22577), 177115⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4338747451, 4500305598⟩, ⟨41640896, 114710744⟩, ⟨9009416, 20281528⟩, ⟨(-249428), 1617224⟩, ⟨(-22577), 177115⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4316801872, 4396437805⟩, ⟨20339908, 57065266⟩, ⟨4030387, 10041554⟩, ⟨(-256827), 785533⟩, ⟨(-33296), 89624⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3464859438, 3962608314⟩, ⟨(-200589022), (-161551398)⟩, ⟨419440, 8047134⟩, ⟨(-726922), 509165⟩, ⟨(-68769), 93453⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1980731647, 3961463301⟩, ⟨990365821, 990365827⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨913463965, 3653855875⟩, ⟨913463962, 1826927942⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨913463965, 3653855875⟩, ⟨913463962, 1826927942⟩, ⟨228365990, 228365993⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3653855875), (-913463965)⟩, ⟨(-1826927942), (-913463962)⟩, ⟨(-228365993), (-228365990)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1826927938), (-456731982)⟩, ⟨(-913463971), (-456731981)⟩, ⟨(-114182997), (-114182995)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2806895678, 3861681613⟩, ⟨(-821311731), (-298488657)⟩, ⟨(-86793146), 12717113⟩, ⟨4388704, 20709672⟩, ⟨(-1270190), 1037036⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2264394187, 3562851732⟩, ⟨(-938109038), (-346377296)⟩, ⟨(-68575299), 57326288⟩, ⟨754133, 23589264⟩, ⟨(-2460925), 1038571⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4347767550, 4347767552⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified332
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4316801872, 4396437805⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified333
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (143645385 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((39471 / 400000) : ℝ)..(39471 / 200000), prawitzNormalCorrection
