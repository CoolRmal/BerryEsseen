...
namespace FiniteNormalPanel12_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (267673 / 800000)
def radius : Rat := (38239 / 800000)

def j0 : Jet := ⟨⟨1437058476, 1437058477⟩, ⟨205294068, 205294069⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4514652350, 4514652355⟩, ⟨644950335, 644950340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4745574165, 4745574176⟩, ⟨1355878330, 1355878344⟩, ⟨96848452, 96848454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1187, 1189⟩, ⟨339, 340⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93500), (-93497)⟩, ⟨339, 340⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-103310), (-103306)⟩, ⟨(-29144), (-29140)⟩, ⟨(-1976), (-1972)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5009746, 5009751⟩, ⟨(-29144), (-29140)⟩, ⟨(-1976), (-1972)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5535343, 5535350⟩, ⟨1549324, 1549332⟩, ⟨101581, 101590⟩, ⟨(-1267), (-1261)⟩, ⟨(-41), (-36)⟩⟩
...
def j16 : Jet := ⟨⟨(-137630234), (-137630226)⟩, ⟨1549324, 1549332⟩, ⟨101581, 101590⟩, ⟨(-1267), (-1261)⟩, ⟨(-41), (-36)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-152069723), (-152069713)⟩, ⟨(-41736622), (-41736608)⟩, ⟨(-2502120), (-2502105)⟩, ⟨65604, 65615⟩, ⟨1844, 1854⟩⟩
...
def j19 : Jet := ⟨⟨1279586042, 1279586053⟩, ⟨(-41736622), (-41736608)⟩, ⟨(-2502120), (-2502105)⟩, ⟨65604, 65615⟩, ⟨1844, 1854⟩⟩
...
def j25 : Jet := ⟨⟨12944, 12948⟩, ⟨3659, 3664⟩, ⟨248, 253⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-839233), (-839228)⟩, ⟨3659, 3664⟩, ⟨248, 253⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-927282), (-927275)⟩, ⟨(-260896), (-260886)⟩, ⟨(-17496), (-17486)⟩, ⟨157, 163⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34864112, 34864120⟩, ⟨(-260896), (-260886)⟩, ⟨(-17496), (-17486)⟩, ⟨157, 163⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨38521883, 38521893⟩, ⟨10717984, 10718000⟩, ⟨684465, 684483⟩, ⟨(-11235), (-11221)⟩, ⟨(-344), (-335)⟩⟩
...
def j33 : Jet := ⟨⟨(-677306000), (-677305989)⟩, ⟨10717984, 10718000⟩, ⟨684465, 684483⟩, ⟨(-11235), (-11221)⟩, ⟨(-344), (-335)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-748365620), (-748365605)⟩, ⟨(-201976288), (-201976264)⟩, ⟨(-11132933), (-11132905)⟩, ⟨445346, 445371⟩, ⟨11506, 11523⟩⟩
...
def j36 : Jet := ⟨⟨3546601676, 3546601691⟩, ⟨(-201976288), (-201976264)⟩, ⟨(-11132933), (-11132905)⟩, ⟨445346, 445371⟩, ⟨11506, 11523⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1345036116, 1345036130⟩, ⟨148276590, 148276610⟩, ⟨(-8897449), (-8897430)⟩, ⟨(-306770), (-306754)⟩, ⟨11789, 11803⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5201244932, 5201244955⟩, ⟨296206934, 296206975⟩, ⟨33195645, 33195693⟩, ⟨2167113, 2167158⟩, ⟨173519, 173556⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1628851117, 1628851143⟩, ⟨272326144, 272326185⟩, ⟨9846891, 9846936⟩, ⟨839564, 839606⟩, ⟨53505, 53542⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1437058477), (-1437058476)⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2857908819, 2857908820⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨617736010, 617736030⟩, ⟨206557448, 206557484⟩, ⟨24735872, 24735914⟩, ⟨1885502, 1885544⟩, ⟨169623, 169660⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4912703306, 4912703326⟩, ⟨206557448, 206557484⟩, ⟨24735872, 24735914⟩, ⟨1885502, 1885544⟩, ⟨169623, 169660⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4593462749, 4593462760⟩, ⟨96567396, 96567415⟩, ⟨10549175, 10549197⟩, ⟨659714, 659736⟩, ⟨53316, 53337⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3056530305, 3056530314⟩, ⟨(-155304990), (-155304974)⟩, ⟨2403711, 2403728⟩, ⟨(-65260), (-65242)⟩, ⟨3941, 3958⟩⟩
...
def j47 : Jet := ⟨⟨7388545529, 7388545537⟩, ⟨1055506504, 1055506510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12710365707, 12710365736⟩, ⟨3631533058, 3631533084⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12710365707, 12710365736⟩, ⟨3631533058, 3631533084⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12710365736), (-12710365707)⟩, ⟨(-3631533084), (-3631533058)⟩, ⟨(-259395222), (-259395218)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6355182868), (-6355182853)⟩, ⟨(-1815766542), (-1815766529)⟩, ⟨(-129697611), (-129697609)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨978008045, 978008059⟩, ⟨(-413468646), (-413468636)⟩, ⟨57866784, 57866788⟩, ⟨169128, 169131⟩, ⟨(-891595), (-891593)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨696003257, 696003270⟩, ⟨(-329611121), (-329611107)⟩, ⟨56679397, 56679409⟩, ⟨(-2218354), (-2218341)⟩, ⟨(-601062), (-601049)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1231764408, 1642352545⟩, ⟨205294068, 205294069⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3869702014, 5159602691⟩, ⟨644950335, 644950340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3486544284, 6198300964⟩, ⟨1162181426, 1549575250⟩, ⟨96848452, 96848454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨872, 1553⟩, ⟨290, 389⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93815), (-93133)⟩, ⟨290, 389⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-135390), (-75602)⟩, ⟨(-33613), (-24638)⟩, ⟨(-2019), (-1922)⟩, ⟨12, 19⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4977666, 5037455⟩, ⟨(-33613), (-24638)⟩, ⟨(-2019), (-1922)⟩, ⟨12, 19⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4040741, 7269826⟩, ⟨1298404, 1797457⟩, ⟨97200, 105366⟩, ⟨(-1478), (-1047)⟩, ⟨(-43), (-34)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139124836), (-135895750)⟩, ⟨1298404, 1797457⟩, ⟨97200, 105366⟩, ⟨(-1478), (-1047)⟩, ⟨(-43), (-34)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-200778620), (-110316684)⟩, ⟨(-49140645), (-34178219)⟩, ⟨(-2706925), (-2263790)⟩, ⟨53446, 77698⟩, ⟨1594, 2066⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1230877145, 1321339082⟩, ⟨(-49140645), (-34178219)⟩, ⟨(-2706925), (-2263790)⟩, ⟨53446, 77698⟩, ⟨1594, 2066⟩⟩
...
def j72 : Jet := ⟨⟨9480, 16958⟩, ⟨3103, 4218⟩, ⟨243, 257⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842697), (-835218)⟩, ⟨3103, 4218⟩, ⟨243, 257⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1216142), (-678008)⟩, ⟨(-301518), (-219914)⟩, ⟨(-17967), (-16940)⟩, ⟨129, 189⟩, ⟨1, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34575252, 35113387⟩, ⟨(-301518), (-219914)⟩, ⟨(-17967), (-16940)⟩, ⟨129, 189⟩, ⟨1, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨28067302, 50674040⟩, ⟨8920629, 12489990⟩, ⟨644932, 718525⟩, ⟨(-13179), (-9268)⟩, ⟨(-372), (-303)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-687760581), (-665153842)⟩, ⟨8920629, 12489990⟩, ⟨644932, 718525⟩, ⟨(-13179), (-9268)⟩, ⟨(-372), (-303)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-992544711), (-539954827)⟩, ⟨(-240894643), (-161959957)⟩, ⟨(-12571128), (-9455555)⟩, ⟨356646, 533354⟩, ⟨9250, 13451⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3302422585, 3755012469⟩, ⟨(-240894643), (-161959957)⟩, ⟨(-12571128), (-9455555)⟩, ⟨356646, 533354⟩, ⟨9250, 13451⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1109002103, 1587342630⟩, ⟨125800357, 167623761⟩, ⟨(-10631032), (-7171985)⟩, ⟨(-358330), (-246600)⟩, ⟨9461, 14150⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4912565331, 5585821802⟩, ⟨211887144, 407456804⟩, ⟨21509451, 50985070⟩, ⟨667895, 4739607⟩, ⟨5084, 503172⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1268471889, 2064419229⟩, ⟨198601223, 368591868⟩, ⟨(-2066034), 26542084⟩, ⟨(-672106), 3105636⟩, ⟨(-128500), 341263⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1642352545), (-1231764408)⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2652614751, 3063202888⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨374629379, 992283867⟩, ⟨117309422, 354334778⟩, ⟨7197288, 57147804⟩, ⟨(-1000722), 7541168⟩, ⟨(-251658), 1025140⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4669596675, 5287251163⟩, ⟨117309422, 354334778⟩, ⟨7197288, 57147804⟩, ⟨(-1000722), 7541168⟩, ⟨(-251658), 1025140⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4478366332, 4765351072⟩, ⟨52864954, 169911992⟩, ⟨214258, 27091715⟩, ⟨(-1507747), 3613642⟩, ⟨(-339726), 548780⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2765883829, 3398684125⟩, ⟨(-195127902), (-92877804)⟩, ⟨(-7989254), 16795137⟩, ⟨(-2370288), 2567036⟩, ⟨(-415024), 463464⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6333039025, 8444052041⟩, ⟨1055506504, 1055506510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9338227867, 16601294017⟩, ⟨3112742620, 4150323524⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9338227867, 16601294017⟩, ⟨3112742620, 4150323524⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16601294017), (-9338227867)⟩, ⟨(-4150323524), (-3112742620)⟩, ⟨(-259395222), (-259395218)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8300647009), (-4669113933)⟩, ⟨(-2075161762), (-1556371310)⟩, ⟨(-129697611), (-129697609)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨621760040, 1448214102⟩, ⟨(-699720934), (-225307766)⟩, ⟨(-2910067), 150263374⟩, ⟨(-19664648), 14555263⟩, ⟨(-4026930), 2419238⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨400402592, 1145997616⟩, ⟨(-619496548), (-158539696)⟩, ⟨(-124439), 156358766⟩, ⟨(-25923156), 13817207⟩, ⟨(-4685521), 3937815⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1437058476, 1437058477⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4593462749, 4593462760⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified242
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1231764408, 1642352545⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4478366332, 4765351072⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified243
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (68417599 / 4294967296)

theorem envelope_integral : (∫ s in ((114717 / 400000) : ℝ)..(38239 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((114717 / 400000) : ℝ)..(38239 / 100000), prawitzNormalCorrection
