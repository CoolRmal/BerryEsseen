...
namespace FiniteNormalPanel90_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (222117 / 800000)
def radius : Rat := (31731 / 800000)

def j0 : Jet := ⟨⟨1192481563, 1192481564⟩, ⟨170354509, 170354510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3746291317, 3746291322⟩, ⟨535184473, 535184478⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3267707915, 3267707925⟩, ⟨933630830, 933630842⟩, ⟨66687916, 66687918⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨817, 819⟩, ⟨233, 234⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93870), (-93867)⟩, ⟨233, 234⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-71419), (-71416)⟩, ⟨(-20229), (-20225)⟩, ⟨(-1396), (-1393)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5041637, 5041641⟩, ⟨(-20229), (-20225)⟩, ⟨(-1396), (-1393)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3835791, 3835795⟩, ⟨1080549, 1080555⟩, ⟨72820, 72827⟩, ⟨(-615), (-609)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-139329786), (-139329781)⟩, ⟨1080549, 1080555⟩, ⟨72820, 72827⟩, ⟨(-615), (-609)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-106005242), (-106005237)⟩, ⟨(-29465107), (-29465099)⟩, ⟨(-1873083), (-1873074)⟩, ⟨32138, 32146⟩, ⟨980, 986⟩⟩
...
def j19 : Jet := ⟨⟨1325650523, 1325650529⟩, ⟨(-29465107), (-29465099)⟩, ⟨(-1873083), (-1873074)⟩, ⟨32138, 32146⟩, ⟨980, 986⟩⟩
...
def j22 : Jet := ⟨⟨(-83), (-81)⟩, ⟨(-24), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11752, 11755⟩, ⟨(-24), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8941, 8944⟩, ⟨2535, 2539⟩, ⟨174, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843236), (-843232)⟩, ⟨2535, 2539⟩, ⟨174, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-641553), (-641549)⟩, ⟨(-181373), (-181367)⟩, ⟨(-12410), (-12403)⟩, ⟨74, 79⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35149841, 35149846⟩, ⟨(-181373), (-181367)⟩, ⟨(-12410), (-12403)⟩, ⟨74, 79⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨26742791, 26742796⟩, ⟨7502804, 7502811⟩, ⟨496902, 496911⟩, ⟨(-5459), (-5451)⟩, ⟨(-177), (-171)⟩⟩
...
def j33 : Jet := ⟨⟨(-689085092), (-689085086)⟩, ⟨7502804, 7502811⟩, ⟨496902, 496911⟩, ⟨(-5459), (-5451)⟩, ⟨(-177), (-171)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-524271470), (-524271463)⟩, ⟨(-144083548), (-144083538)⟩, ⟨(-8690421), (-8690409)⟩, ⟨220356, 220368⟩, ⟨6393, 6402⟩⟩
...
def j36 : Jet := ⟨⟨3770695826, 3770695833⟩, ⟨(-144083548), (-144083538)⟩, ⟨(-8690421), (-8690409)⟩, ⟨220356, 220368⟩, ⟨6393, 6402⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1156300549, 1156300557⟩, ⟨139484810, 139484821⟩, ⟨(-5305369), (-5305358)⟩, ⟨(-205368), (-205358)⟩, ⟨4858, 4867⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4892132617, 4892132627⟩, ⟨186935198, 186935214⟩, ⟨18418062, 18418083⟩, ⟨848704, 848726⟩, ⟨55644, 55665⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1317070711, 1317070723⟩, ⟨209205657, 209205677⟩, ⟨4986502, 4986523⟩, ⟨361804, 361827⟩, ⟨16385, 16407⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1192481564), (-1192481563)⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3102485732, 3102485733⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨403885556, 403885565⟩, ⟨128307678, 128307694⟩, ⟨13248564, 13248583⟩, ⟨707674, 707696⟩, ⟨51083, 51104⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4698852852, 4698852861⟩, ⟨128307678, 128307694⟩, ⟨13248564, 13248583⟩, ⟨707674, 707696⟩, ⟨51083, 51104⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4492373462, 4492373467⟩, ⟨61334758, 61334766⟩, ⟨5914489, 5914500⟩, ⟨257537, 257549⟩, ⟨17009, 17021⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3245082816, 3245082821⟩, ⟨(-133878988), (-133878978)⟩, ⟨1839586, 1839596⟩, ⟨(-48560), (-48548)⟩, ⟨2070, 2082⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨30708200121, 30708200124⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value420

def j47 : Jet := ⟨⟨8526016603, 8526016612⟩, ⟨1218002371, 1218002380⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16925148459, 16925148496⟩, ⟨4835756698, 4835756742⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16925148459, 16925148496⟩, ⟨4835756698, 4835756742⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16925148496), (-16925148459)⟩, ⟨(-4835756742), (-4835756698)⟩, ⟨(-345411198), (-345411192)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8462574248), (-8462574229)⟩, ⟨(-2417878371), (-2417878349)⟩, ⟨(-172705599), (-172705596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨598755064, 598755072⟩, ⟨(-337072867), (-337072858)⟩, ⟨70801989, 70801994⟩, ⟨(-4250081), (-4250078)⟩, ⟨(-825364), (-825362)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨452392215, 452392222⟩, ⟨(-273340870), (-273340860)⟩, ⟨64258171, 64258180⟩, ⟨(-5569292), (-5569283)⟩, ⟨(-456706), (-456697)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1022127054, 1362836073⟩, ⟨170354509, 170354510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3211106843, 4281475796⟩, ⟨535184473, 535184478⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2400764999, 4268026676⟩, ⟨800254998, 1067006676⟩, ⟨66687916, 66687918⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨600, 1070⟩, ⟨200, 268⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94087), (-93616)⟩, ⟨200, 268⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-93497), (-52328)⟩, ⟨(-23264), (-17175)⟩, ⟨(-1416), (-1369)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5019559, 5060729⟩, ⟨(-23264), (-17175)⟩, ⟨(-1416), (-1369)⟩, ⟨5, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2805791, 5028986⟩, ⟨912144, 1247647⟩, ⟨70750, 74613⟩, ⟨(-712), (-511)⟩, ⟨(-22), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140359786), (-138136590)⟩, ⟨912144, 1247647⟩, ⟨70750, 74613⟩, ⟨(-712), (-511)⟩, ⟨(-22), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-139479365), (-77214439)⟩, ⟨(-34359980), (-24498324)⟩, ⟨(-1969865), (-1760744)⟩, ⟨26636, 37625⟩, ⟨899, 1055⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1292176400, 1354441327⟩, ⟨(-34359980), (-24498324)⟩, ⟨(-1969865), (-1760744)⟩, ⟨26636, 37625⟩, ⟨899, 1055⟩⟩
...
def j70 : Jet := ⟨⟨(-108), (-59)⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11727, 11777⟩, ⟨(-27), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6555, 11704⟩, ⟨2158, 2916⟩, ⟨173, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845622), (-840472)⟩, ⟨2158, 2916⟩, ⟨173, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-840318), (-469800)⟩, ⟨(-208874), (-153702)⟩, ⟨(-12632), (-12146)⟩, ⟨63, 91⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34951076, 35321595⟩, ⟨(-208874), (-153702)⟩, ⟨(-12632), (-12146)⟩, ⟨63, 91⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19536660, 35100037⟩, ⟨6304656, 8689095⟩, ⟨478241, 513012⟩, ⟨(-6348), (-4558)⟩, ⟨(-186), (-162)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696291223), (-680727845)⟩, ⟨6304656, 8689095⟩, ⟨478241, 513012⟩, ⟨(-6348), (-4558)⟩, ⟨(-186), (-162)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-691923666), (-380507573)⟩, ⟨(-169456794), (-118201265)⟩, ⟨(-9369277), (-7901211)⟩, ⟨180690, 259818⟩, ⟨5662, 7027⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3603043630, 3914459723⟩, ⟨(-169456794), (-118201265)⟩, ⟨(-9369277), (-7901211)⟩, ⟨180690, 259818⟩, ⟨5662, 7027⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨966088026, 1350186710⟩, ⟨126762622, 150457314⟩, ⟨(-6245184), (-4369080)⟩, ⟨(-225546), (-181894)⟩, ⟨3991, 5741⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4712462352, 5119767055⟩, ⟨142297800, 240790677⟩, ⟨13808786, 24638097⟩, ⟨364373, 1548590⟩, ⟨13699, 122362⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1059997233, 1609474755⟩, ⟨171092404, 255047058⟩, ⟨(-138616), 11386729⟩, ⟨(-129472), 1005594⟩, ⟨(-30258), 79487⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1362836073), (-1022127054)⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2932131223, 3272840242⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨261607145, 603126592⟩, ⟨84451154, 191150142⟩, ⟨6711670, 23679415⟩, ⟨(-113500), 2106016⟩, ⟨(-38424), 209193⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4556574441, 4898093888⟩, ⟨84451154, 191150142⟩, ⟨6711670, 23679415⟩, ⟨(-113500), 2106016⟩, ⟨(-38424), 209193⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4423837497, 4586627635⟩, ⟨39540483, 92790887⟩, ⟨2203825, 11318100⟩, ⟨(-292497), 1002636⟩, ⟨(-54162), 107137⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3020109620, 3495090525⟩, ⟨(-154928961), (-104757704)⟩, ⟨(-2175906), 7056268⟩, ⟨(-671807), 676616⟩, ⟨(-81042), 93243⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7308014231, 9744018984⟩, ⟨1218002371, 1218002380⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12434802949, 22106316398⟩, ⟨4144934312, 5526579132⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12434802949, 22106316398⟩, ⟨4144934312, 5526579132⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-22106316398), (-12434802949)⟩, ⟨(-5526579132), (-4144934312)⟩, ⟨(-345411198), (-345411192)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11053158199), (-6217401474)⟩, ⟨(-2763289566), (-2072467156)⟩, ⟨(-172705599), (-172705596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨327564593, 1009890955⟩, ⟨(-649742116), (-158061008)⟩, ⟨(-2473989), 195843300⟩, ⟨(-37763246), 17948492⟩, ⟨(-6824462), 6123757⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨230334926, 821813082⟩, ⟨(-565165858), (-119133964)⟩, ⟨1330362, 184467062⟩, ⟨(-39020315), 15183350⟩, ⟨(-6421578), 6790809⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1192481563, 1192481564⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨170354509, 170354510⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4492373462, 4492373467⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar420 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1820
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar420 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1022127054, 1362836073⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4423837497, 4586627635⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1821
    (by decide +kernel) (by decide +kernel)
...
theorem whole_function_eq (t : ℝ) : f95 t =
    finiteNormalIntegrand 9 (238327 / 100000) ((center : ℝ) + (radius : ℝ) * t) := by
...
def upper : Rat := (37694031 / 4294967296)

theorem envelope_integral : (∫ s in ((95193 / 400000) : ℝ)..(31731 / 100000),
    finiteNormalIntegrand 9 (238327 / 100000) s) ≤ (upper : ℝ) := by
  have he : f95 = (fun t ↦ finiteNormalIntegrand 9 (238327 / 100000)
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (95193 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (31731 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((95193 / 400000) : ℝ)..(31731 / 100000), prawitzNormalCorrection
      ((238327 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
