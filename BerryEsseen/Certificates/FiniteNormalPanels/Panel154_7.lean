...
namespace FiniteNormalPanel154_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (26071 / 160000)
def radius : Rat := (26071 / 800000)

def j0 : Jet := ⟨⟨699838077, 699838078⟩, ⟨139967615, 139967616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2198606161, 2198606165⟩, ⟨439721231, 439721235⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1125472842, 1125472847⟩, ⟨450189134, 450189142⟩, ⟨45018913, 45018915⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨281, 282⟩, ⟨112, 113⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94406), (-94404)⟩, ⟨112, 113⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-24739), (-24738)⟩, ⟨(-9867), (-9865)⟩, ⟨(-977), (-973)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5088317, 5088319⟩, ⟨(-9867), (-9865)⟩, ⟨(-977), (-973)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1333365, 1333367⟩, ⟨530760, 530762⟩, ⟨52042, 52047⟩, ⟨(-207), (-202)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141832212), (-141832209)⟩, ⟨530760, 530762⟩, ⟨52042, 52047⟩, ⟨(-207), (-202)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-37166361), (-37166359)⟩, ⟨(-14727463), (-14727459)⟩, ⟨(-1417385), (-1417381)⟩, ⟨10962, 10968⟩, ⟨520, 523⟩⟩
...
def j19 : Jet := ⟨⟨1394489404, 1394489407⟩, ⟨(-14727463), (-14727459)⟩, ⟨(-1417385), (-1417381)⟩, ⟨10962, 10968⟩, ⟨520, 523⟩⟩
...
def j25 : Jet := ⟨⟨3093, 3095⟩, ⟨1233, 1236⟩, ⟨120, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849084), (-849081)⟩, ⟨1233, 1236⟩, ⟨120, 123⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-222498), (-222497)⟩, ⟨(-88677), (-88674)⟩, ⟨(-8740), (-8736)⟩, ⟨23, 26⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35568896, 35568898⟩, ⟨(-88677), (-88674)⟩, ⟨(-8740), (-8736)⟩, ⟨23, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9320635, 9320637⟩, ⟨3705016, 3705019⟩, ⟨361239, 361243⟩, ⟨(-1841), (-1837)⟩, ⟨(-91), (-87)⟩⟩
...
def j33 : Jet := ⟨⟨(-706507248), (-706507245)⟩, ⟨3705016, 3705019⟩, ⟨361239, 361243⟩, ⟨(-1841), (-1837)⟩, ⟨(-91), (-87)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-185136387), (-185136384)⟩, ⟨(-73083676), (-73083672)⟩, ⟨(-6922445), (-6922440)⟩, ⟨76216, 76220⟩, ⟨3569, 3573⟩⟩
...
def j36 : Jet := ⟨⟨4109830909, 4109830912⟩, ⟨(-73083676), (-73083672)⟩, ⟨(-6922445), (-6922440)⟩, ⟨76216, 76220⟩, ⟨3569, 3573⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨713843152, 713843156⟩, ⟨135229599, 135229604⟩, ⟨(-2233371), (-2233366)⟩, ⟨(-139502), (-139497)⟩, ⟨1388, 1391⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4488443556, 4488443560⟩, ⟨79816405, 79816413⟩, ⟨8979506, 8979514⟩, ⟨210875, 210884⟩, ⟨13490, 13499⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨745999788, 745999794⟩, ⟨154587164, 154587172⟩, ⟨1671521, 1671533⟩, ⟨130481, 130492⟩, ⟨3068, 3077⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-699838078), (-699838077)⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3595129218, 3595129219⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨129573904, 129573907⟩, ⟨53700986, 53700992⟩, ⟨6144656, 6144664⟩, ⟨165650, 165658⟩, ⟨11106, 11115⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4424541200, 4424541203⟩, ⟨53700986, 53700992⟩, ⟨6144656, 6144664⟩, ⟨165650, 165658⟩, ⟨11106, 11115⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4359272846, 4359272849⟩, ⟨26454409, 26454413⟩, ⟨2946736, 2946742⟩, ⟨63719, 63725⟩, ⟨4087, 4094⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3648956580, 3648956585⟩, ⟨(-119919426), (-119919420)⟩, ⟨1604466, 1604473⟩, ⟨(-42695), (-42688)⟩, ⟨1344, 1351⟩⟩
...
def j47 : Jet := ⟨⟨8644313244, 8644313259⟩, ⟨1728862643, 1728862657⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17398072281, 17398072342⟩, ⟨6959228888, 6959228958⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17398072281, 17398072342⟩, ⟨6959228888, 6959228958⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17398072342), (-17398072281)⟩, ⟨(-6959228958), (-6959228888)⟩, ⟨(-695922898), (-695922886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8699036171), (-8699036140)⟩, ⟨(-3479614479), (-3479614444)⟩, ⟨(-347961449), (-347961443)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨566681275, 566681291⟩, ⟨(-459103013), (-459102995)⟩, ⟨140063339, 140063352⟩, ⟨(-13028131), (-13028125)⟩, ⟨(-3034974), (-3034971)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨481446126, 481446141⟩, ⟨(-405871091), (-405871072)⟩, ⟨132026529, 132026545⟩, ⟨(-15156396), (-15156384)⟩, ⟨(-2157661), (-2157652)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨559870461, 839805693⟩, ⟨139967615, 139967616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1758884927, 2638327396⟩, ⟨439721231, 439721235⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨720302617, 1620680897⟩, ⟨360151308, 540226970⟩, ⟨45018913, 45018915⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨180, 407⟩, ⟨90, 136⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94507), (-94279)⟩, ⟨90, 136⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-35662), (-15811)⟩, ⟨(-11873), (-7853)⟩, ⟨(-983), (-965)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5077394, 5097246⟩, ⟨(-11873), (-7853)⟩, ⟨(-983), (-965)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨851522, 1923417⟩, ⟨421280, 639822⟩, ⟨51355, 52610⟩, ⟨(-249), (-160)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142314055), (-141242159)⟩, ⟨421280, 639822⟩, ⟨51355, 52610⟩, ⟨(-249), (-160)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-53701380), (-23687513)⟩, ⟨(-17829809), (-11602322)⟩, ⟨(-1447768), (-1380138)⟩, ⟨8627, 13299⟩, ⟨501, 538⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1377954385, 1407968253⟩, ⟨(-17829809), (-11602322)⟩, ⟨(-1447768), (-1380138)⟩, ⟨8627, 13299⟩, ⟨501, 538⟩⟩
...
def j70 : Jet := ⟨⟨(-41), (-17)⟩, ⟨(-14), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11794, 11819⟩, ⟨(-14), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1977, 4460⟩, ⟨982, 1486⟩, ⟨120, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850200), (-847716)⟩, ⟨982, 1486⟩, ⟨120, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-320819), (-142169)⟩, ⟨(-106776), (-70523)⟩, ⟨(-8810), (-8651)⟩, ⟨19, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35470575, 35649226⟩, ⟨(-106776), (-70523)⟩, ⟨(-8810), (-8651)⟩, ⟨19, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5948717, 13452028⟩, ⟨2934066, 4472183⟩, ⟨355038, 366305⟩, ⟨(-2226), (-1451)⟩, ⟨(-93), (-84)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709879166), (-702375854)⟩, ⟨2934066, 4472183⟩, ⟨355038, 366305⟩, ⟨(-2226), (-1451)⟩, ⟨(-93), (-84)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-267868770), (-117794416)⟩, ⟨(-88797524), (-57209655)⟩, ⟨(-7135225), (-6661408)⟩, ⟨59685, 92709⟩, ⟨3405, 3705⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4027098526, 4177172880⟩, ⟨(-88797524), (-57209655)⟩, ⟨(-7135225), (-6661408)⟩, ⟨59685, 92709⟩, ⟨3405, 3705⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨564303062, 864891619⟩, ⟨130123208, 139397195⟩, ⟨(-2714767), (-1753049)⟩, ⟨(-144692), (-133129)⟩, ⟨1088, 1693⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4416083462, 4580653778⟩, ⟨60481721, 101003419⟩, ⟨7870746, 10343142⟩, ⟨102581, 341576⟩, ⟨7649, 21231⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨580216157, 922421241⟩, ⟨141739138, 169008808⟩, ⟨(-28836), 3558510⟩, ⟨33774, 242913⟩, ⟨(-4712), 12083⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-839805693), (-559870461)⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3455161603, 3735096835⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨78382619, 198106502⟩, ⟨38295674, 72595346⟩, ⟨4665175, 8179078⟩, ⟨6854, 384398⟩, ⟨180, 27259⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4373349915, 4493073798⟩, ⟨38295674, 72595346⟩, ⟨4665175, 8179078⟩, ⟨6854, 384398⟩, ⟨180, 27259⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4333981409, 4392903940⟩, ⟨18720949, 35970925⟩, ⟨2133311, 4012293⟩, ⟨(-29906), 181255⟩, ⟨(-3274), 13231⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3486547188, 3820266948⟩, ⟨(-128098854), (-109957100)⟩, ⟨543931, 2879179⟩, ⟨(-156764), 88107⟩, ⟨(-8755), 12482⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6915450588, 10373175903⟩, ⟨1728862643, 1728862657⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11134766236, 25053224134⟩, ⟨5567383104, 8351074744⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11134766236, 25053224134⟩, ⟨5567383104, 8351074744⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-25053224134), (-11134766236)⟩, ⟨(-8351074744), (-5567383104)⟩, ⟨(-695922898), (-695922886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12526612067), (-5567383118)⟩, ⟨(-4175537372), (-2783691552)⟩, ⟨(-347961449), (-347961443)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨232437194, 1174904127⟩, ⟨(-1142233632), (-150649215)⟩, ⟨(-46366097), 536404650⟩, ⟨(-165692952), 76718467⟩, ⟨(-40374994), 42149585⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨188686709, 1045048098⟩, ⟨(-1051030417), (-128243983)⟩, ⟨(-37355230), 511973757⟩, ⟨(-164186818), 69627084⟩, ⟨(-38257622), 42837552⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨699838077, 699838078⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4359272846, 4359272849⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3104
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨559870461, 839805693⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4333981409, 4392903940⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3105
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (8701563 / 1073741824)

theorem envelope_integral : (∫ s in ((26071 / 200000) : ℝ)..(78213 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((26071 / 200000) : ℝ)..(78213 / 400000), prawitzNormalCorrection
