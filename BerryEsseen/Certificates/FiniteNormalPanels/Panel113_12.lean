...
namespace FiniteNormalPanel113_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (84021 / 800000)
def radius : Rat := (28007 / 800000)

def j0 : Jet := ⟨⟨451084308, 451084309⟩, ⟨150361436, 150361437⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1417123148, 1417123152⟩, ⟨472374382, 472374386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨467579350, 467579353⟩, ⟨311719566, 311719570⟩, ⟨51953260, 51953262⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-10296), (-10295)⟩, ⟨(-6856), (-6854)⟩, ⟨(-1138), (-1135)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102760, 5102762⟩, ⟨(-6856), (-6854)⟩, ⟨(-1138), (-1135)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨555521, 555522⟩, ⟨369600, 369602⟩, ⟨61102, 61105⟩, ⟨(-166), (-163)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-142610056), (-142610054)⟩, ⟨369600, 369602⟩, ⟨61102, 61105⟩, ⟨(-166), (-163)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15525501), (-15525500)⟩, ⟨(-10310097), (-10310095)⟩, ⟨(-1691581), (-1691577)⟩, ⟨8885, 8889⟩, ⟨724, 728⟩⟩
...
def j19 : Jet := ⟨⟨1416130264, 1416130266⟩, ⟨(-10310097), (-10310095)⟩, ⟨(-1691581), (-1691577)⟩, ⟨8885, 8889⟩, ⟨724, 728⟩⟩
...
def j25 : Jet := ⟨⟨1287, 1288⟩, ⟨857, 859⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850890), (-850888)⟩, ⟨857, 859⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-92634), (-92633)⟩, ⟨(-61663), (-61661)⟩, ⟨(-10216), (-10213)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35698760, 35698762⟩, ⟨(-61663), (-61661)⟩, ⟨(-10216), (-10213)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3886409, 3886411⟩, ⟨2584225, 2584229⟩, ⟨426234, 426238⟩, ⟨(-1486), (-1483)⟩, ⟨(-124), (-120)⟩⟩
...
def j33 : Jet := ⟨⟨(-711941474), (-711941471)⟩, ⟨2584225, 2584229⟩, ⟨426234, 426238⟩, ⟨(-1486), (-1483)⟩, ⟨(-124), (-120)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-77506792), (-77506790)⟩, ⟨(-51389859), (-51389856)⟩, ⟨(-8377907), (-8377903)⟩, ⟨62032, 62035⟩, ⟨5033, 5036⟩⟩
...
def j36 : Jet := ⟨⟨4217460504, 4217460506⟩, ⟨(-51389859), (-51389856)⟩, ⟨(-8377907), (-8377903)⟩, ⟨62032, 62035⟩, ⟨5033, 5036⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨467251748, 467251751⟩, ⟨152348768, 152348773⟩, ⟨(-1692075), (-1692072)⟩, ⟨(-183115), (-183112)⟩, ⟨1215, 1219⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4373898474, 4373898477⟩, ⟨53296056, 53296061⟩, ⟨9338076, 9338083⟩, ⟨155318, 155327⟩, ⟨14434, 14442⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨475838712, 475838716⟩, ⟨160946677, 160946685⟩, ⟨1183211, 1183217⟩, ⟨140654, 140662⟩, ⟨2364, 2374⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-451084309), (-451084308)⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3843882987, 3843882988⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨52718091, 52718093⟩, ⟨35662510, 35662514⟩, ⟨6293380, 6293385⟩, ⟨119842, 119848⟩, ⟨11387, 11398⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4347685387, 4347685389⟩, ⟨35662510, 35662514⟩, ⟨6293380, 6293385⟩, ⟨119842, 119848⟩, ⟨11387, 11398⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4321245948, 4321245950⟩, ⟨17722818, 17722821⟩, ⟨3091210, 3091214⟩, ⟨46878, 46883⟩, ⟨4360, 4368⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3867401690, 3867401694⟩, ⟨(-135419964), (-135419958)⟩, ⟨2146097, 2146103⟩, ⟨(-66266), (-66259)⟩, ⟨2260, 2269⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨42642418039, 42642418046⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value494

def j47 : Jet := ⟨⟨4478573247, 4478573259⟩, ⟨1492857749, 1492857760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4670028185, 4670028211⟩, ⟨3113352122, 3113352156⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4670028185, 4670028211⟩, ⟨3113352122, 3113352156⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4670028211), (-4670028185)⟩, ⟨(-3113352156), (-3113352122)⟩, ⟨(-518892029), (-518892020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2335014106), (-2335014092)⟩, ⟨(-1556676078), (-1556676061)⟩, ⟨(-259446015), (-259446010)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2493733789, 2493733810⟩, ⟨(-903833604), (-903833585)⟩, ⟨13154640, 13154651⟩, ⟨34809306, 34809310⟩, ⟨(-3551405), (-3551403)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2245481654, 2245481676⟩, ⟨(-892483853), (-892483828)⟩, ⟨41588947, 41588966⟩, ⟨30439157, 30439172⟩, ⟨(-4273569), (-4273555)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨300722872, 601445746⟩, ⟨150361436, 150361437⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨944748765, 1889497538⟩, ⟨472374382, 472374386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨207813044, 831252185⟩, ⟨207813044, 415626094⟩, ⟨51953260, 51953262⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨52, 209⟩, ⟨52, 105⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94635), (-94477)⟩, ⟨52, 105⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-18316), (-4571)⟩, ⟨(-9156), (-4550)⟩, ⟨(-1143), (-1128)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5094740, 5108486⟩, ⟨(-9156), (-4550)⟩, ⟨(-1143), (-1128)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨246510, 988702⟩, ⟨244737, 494131⟩, ⟨60518, 61520⟩, ⟨(-222), (-108)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142919067), (-142176874)⟩, ⟨244737, 494131⟩, ⟨60518, 61520⟩, ⟨(-222), (-108)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-27660697), (-6879262)⟩, ⟨(-13818508), (-6783627)⟩, ⟨(-1714025), (-1660090)⟩, ⟨5845, 11927⟩, ⟨707, 740⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1403995068, 1424776504⟩, ⟨(-13818508), (-6783627)⟩, ⟨(-1714025), (-1660090)⟩, ⟨5845, 11927⟩, ⟨707, 740⟩⟩
...
def j70 : Jet := ⟨⟨(-21), (-5)⟩, ⟨(-11), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11814, 11831⟩, ⟨(-11), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨571, 2290⟩, ⟨568, 1145⟩, ⟨139, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851606), (-849886)⟩, ⟨568, 1145⟩, ⟨139, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-164821), (-41121)⟩, ⟨(-82384), (-40899)⟩, ⟨(-10269), (-10141)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35626573, 35750274⟩, ⟨(-82384), (-40899)⟩, ⟨(-10269), (-10141)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1723800, 6919144⟩, ⟨1707855, 3457594⟩, ⟨420989, 429979⟩, ⟨(-1991), (-978)⟩, ⟨(-126), (-118)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714104083), (-708908738)⟩, ⟨1707855, 3457594⟩, ⟨420989, 429979⟩, ⟨(-1991), (-978)⟩, ⟨(-126), (-118)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-138208405), (-34300722)⟩, ⟨(-69021569), (-33631535)⟩, ⟨(-8535023), (-8157367)⟩, ⟨40641, 83388⟩, ⟨4874, 5150⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4156758891, 4260666574⟩, ⟨(-69021569), (-33631535)⟩, ⟨(-8535023), (-8157367)⟩, ⟨40641, 83388⟩, ⟨4874, 5150⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨308831829, 626806100⟩, ⟨148336697, 155209356⟩, ⟨(-2273862), (-1111249)⟩, ⟨(-187230), (-177334)⟩, ⟨797, 1638⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4329544157, 4437771004⟩, ⟨34175219, 73687681⟩, ⟨8558999, 10335582⟩, ⟨46135, 280593⟩, ⟨9942, 20473⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨311318095, 647646826⟩, ⟨151988275, 171123881⟩, ⟨(-553707), 3051066⟩, ⟨66452, 226850⟩, ⟨(-5575), 11196⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-601445746), (-300722872)⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3693521550, 3994244424⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨22565702, 97659978⟩, ⟨22033554, 51608234⟩, ⟨5211499, 7738223⟩, ⟨(-34492), 311544⟩, ⟨2626, 23624⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4317532998, 4392627274⟩, ⟨22033554, 51608234⟩, ⟨5211499, 7738223⟩, ⟨(-34492), 311544⟩, ⟨2626, 23624⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306235365, 4343522820⟩, ⟨10893622, 25736596⟩, ⟨2500371, 3845209⟩, ⟨(-40183), 149040⟩, ⟨(-1300), 11296⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3703211694, 4039400212⟩, ⟨(-142693173), (-126821333)⟩, ⟨1249224, 3194606⟩, ⟨(-171986), 51071⟩, ⟨(-6427), 11913⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2985715498, 5971431019⟩, ⟨1492857749, 1492857760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2075568082, 8302272394⟩, ⟨2075568082, 4151136212⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2075568082, 8302272394⟩, ⟨2075568082, 4151136212⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8302272394), (-2075568082)⟩, ⟨(-4151136212), (-2075568082)⟩, ⟨(-518892029), (-518892020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4151136197), (-1037784041)⟩, ⟨(-2075568106), (-1037784041)⟩, ⟨(-259446015), (-259446010)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1633838616, 3373045398⟩, ⟨(-1630043949), (-394781036)⟩, ⟨(-156060434), 295168885⟩, ⟨(-31649011), 90783065⟩, ⟨(-19882993), 8537213⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1408730230, 3172336216⟩, ⟨(-1645113907), (-388632374)⟩, ⟨(-134641972), 334269590⟩, ⟨(-40919772), 90491258⟩, ⟨(-21856506), 9374879⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨451084308, 451084309⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨150361436, 150361437⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4321245948, 4321245950⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar494 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2278
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar494 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨300722872, 601445746⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306235365, 4343522820⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2279
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((28007 / 400000) : ℝ)..(28007 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (28007 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (28007 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((28007 / 400000) : ℝ)..(28007 / 200000), prawitzNormalCorrection
      ((28661 / 10000) * sqrt n) s) ≤ (upper : ℝ) :=
