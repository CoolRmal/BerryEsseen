...
namespace FiniteNormalPanel137_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (205779 / 800000)
def radius : Rat := (29397 / 800000)

def j0 : Jet := ⟨⟨1104767594, 1104767595⟩, ⟨157823942, 157823943⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3470729757, 3470729761⟩, ⟨495818536, 495818540⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2804669795, 2804669802⟩, ⟨801334226, 801334234⟩, ⟨57238158, 57238160⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨701, 703⟩, ⟨200, 201⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93986), (-93983)⟩, ⟨200, 201⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-61375), (-61372)⟩, ⟨(-17406), (-17402)⟩, ⟨(-1207), (-1204)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5051681, 5051685⟩, ⟨(-17406), (-17402)⟩, ⟨(-1207), (-1204)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3298813, 3298817⟩, ⟨931151, 931156⟩, ⟨63285, 63291⟩, ⟨(-456), (-451)⟩, ⟨(-17), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-139866764), (-139866759)⟩, ⟨931151, 931156⟩, ⟨63285, 63291⟩, ⟨(-456), (-451)⟩, ⟨(-17), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-91334826), (-91334822)⟩, ⟨(-25487612), (-25487605)⟩, ⟨(-1648923), (-1648914)⟩, ⟨23918, 23925⟩, ⟨745, 752⟩⟩
...
def j19 : Jet := ⟨⟨1340320939, 1340320944⟩, ⟨(-25487612), (-25487605)⟩, ⟨(-1648923), (-1648914)⟩, ⟨23918, 23925⟩, ⟨745, 752⟩⟩
...
def j22 : Jet := ⟨⟨(-71), (-69)⟩, ⟨(-21), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11764, 11767⟩, ⟨(-21), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7682, 7685⟩, ⟨2180, 2184⟩, ⟨150, 154⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844495), (-844491)⟩, ⟨2180, 2184⟩, ⟨150, 154⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-551467), (-551463)⟩, ⟨(-156139), (-156134)⟩, ⟨(-10752), (-10745)⟩, ⟨54, 59⟩, ⟨(-1), 3⟩⟩
...
def j30 : Jet := ⟨⟨35239927, 35239932⟩, ⟨(-156139), (-156134)⟩, ⟨(-10752), (-10745)⟩, ⟨54, 59⟩, ⟨(-1), 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23012133, 23012137⟩, ⟨6472934, 6472940⟩, ⟨433481, 433490⟩, ⟨(-4053), (-4045)⟩, ⟨(-135), (-129)⟩⟩
...
def j33 : Jet := ⟨⟨(-692815750), (-692815745)⟩, ⟨6472934, 6472940⟩, ⟨433481, 433490⟩, ⟨(-4053), (-4045)⟩, ⟨(-135), (-129)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-452417744), (-452417739)⟩, ⟨(-125035304), (-125035295)⟩, ⟨(-7742260), (-7742249)⟩, ⟨164492, 164502⟩, ⟨4930, 4940⟩⟩
...
def j36 : Jet := ⟨⟨3842549552, 3842549557⟩, ⟨(-125035304), (-125035295)⟩, ⟨(-7742260), (-7742249)⟩, ⟨164492, 164502⟩, ⟨4930, 4940⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1083102954, 1083102960⟩, ⟨134132651, 134132661⟩, ⟨(-4274817), (-4274807)⟩, ⟨(-171028), (-171019)⟩, ⟨3363, 3370⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4800652223, 4800652230⟩, ⟨156211638, 156211653⟩, ⟨14755778, 14755795⟩, ⟨589373, 589391⟩, ⟨36047, 36067⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1210626355, 1210626364⟩, ⟨189318669, 189318686⟩, ⟨3821494, 3821513⟩, ⟨262808, 262828⟩, ⟨10346, 10364⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1104767595), (-1104767594)⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3190199701, 3190199702⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨341240356, 341240362⟩, ⟨106726852, 106726864⟩, ⟨10499349, 10499363⟩, ⟨485050, 485068⟩, ⟨32400, 32417⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4636207652, 4636207658⟩, ⟨106726852, 106726864⟩, ⟨10499349, 10499363⟩, ⟨485050, 485068⟩, ⟨32400, 32417⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4462326774, 4462326778⟩, ⟨51362031, 51362038⟩, ⟨4757193, 4757201⟩, ⟨178672, 178683⟩, ⟨10999, 11010⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3314510346, 3314510351⟩, ⟨(-125823281), (-125823273)⟩, ⟨1646166, 1646174⟩, ⟨(-42097), (-42087)⟩, ⟨1603, 1613⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨34663307300, 34663307307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value570

def j47 : Jet := ⟨⟨8916225891, 8916225901⟩, ⟨1273746555, 1273746565⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨18509822930, 18509822972⟩, ⟨5288520832, 5288520882⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨18509822930, 18509822972⟩, ⟨5288520832, 5288520882⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-18509822972), (-18509822930)⟩, ⟨(-5288520882), (-5288520832)⟩, ⟨(-377751494), (-377751487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9254911486), (-9254911465)⟩, ⟨(-2644260441), (-2644260416)⟩, ⟨(-188875747), (-188875743)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨497886535, 497886549⟩, ⟨(-306531253), (-306531241)⟩, ⟨72465165, 72465173⟩, ⟨(-5884730), (-5884726)⟩, ⟨(-687612), (-687610)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨384228786, 384228798⟩, ⟨(-251142014), (-251142000)⟩, ⟨65093604, 65093615⟩, ⟨(-6786636), (-6786626)⟩, ⟨(-327286), (-327278)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨946943652, 1262591537⟩, ⟨157823942, 157823943⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2974911220, 3966548298⟩, ⟨495818536, 495818540⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2060573726, 3663242190⟩, ⟨686857906, 915810554⟩, ⟨57238158, 57238160⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨515, 918⟩, ⟨171, 230⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94172), (-93768)⟩, ⟨171, 230⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-80321), (-44986)⟩, ⟨(-19999), (-14798)⟩, ⟨(-1223), (-1186)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5032735, 5068071⟩, ⟨(-19999), (-14798)⟩, ⟨(-1223), (-1186)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2414528, 4322634⟩, ⟨787784, 1073560⟩, ⟨61761, 64607⟩, ⟨(-527), (-379)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140751049), (-138842942)⟩, ⟨787784, 1073560⟩, ⟨61761, 64607⟩, ⟨(-527), (-379)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-120048687), (-66611943)⟩, ⟨(-29634222), (-21288325)⟩, ⟨(-1720148), (-1566312)⟩, ⟨19924, 27904⟩, ⟨695, 797⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1311607078, 1365043823⟩, ⟨(-29634222), (-21288325)⟩, ⟨(-1720148), (-1566312)⟩, ⟨19924, 27904⟩, ⟨695, 797⟩⟩
...
def j70 : Jet := ⟨⟨(-93), (-51)⟩, ⟨(-24), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11742, 11785⟩, ⟨(-24), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5633, 10052⟩, ⟨1856, 2505⟩, ⟨148, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846544), (-842124)⟩, ⟨1856, 2505⟩, ⟨148, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-722031), (-404021)⟩, ⟨(-179618), (-132536)⟩, ⟨(-10915), (-10553)⟩, ⟨45, 68⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35069363, 35387374⟩, ⟨(-179618), (-132536)⟩, ⟨(-10915), (-10553)⟩, ⟨45, 68⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16825042, 30182424⟩, ⟨5455148, 7482020⟩, ⟨419752, 445344⟩, ⟨(-4701), (-3395)⟩, ⟨(-140), (-122)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699002841), (-685645458)⟩, ⟨5455148, 7482020⟩, ⟨419752, 445344⟩, ⟨(-4701), (-3395)⟩, ⟨(-140), (-122)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-596190034), (-328948492)⟩, ⟨(-146430323), (-103267968)⟩, ⟨(-8241693), (-7162234)⟩, ⟨135816, 193045⟩, ⟨4470, 5336⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3698777262, 3966018804⟩, ⟨(-146430323), (-103267968)⟩, ⟨(-8241693), (-7162234)⟩, ⟨135816, 193045⟩, ⟨4470, 5336⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨908485290, 1260664373⟩, ⟨124046002, 142837680⟩, ⟨(-5009643), (-3542467)⟩, ⟨(-184777), (-155046)⟩, ⟨2781, 3959⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4651199347, 4987254644⟩, ⟨121108831, 197439657⟩, ⟨11553056, 18929116⟩, ⟨276776, 1018536⟩, ⟨11746, 72436⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨983836638, 1463865454⟩, ⟨159951921, 223813818⟩, ⟨124443, 8286063⟩, ⟨(-52639), 660695⟩, ⟨(-17086), 45835⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1262591537), (-946943652)⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3032375759, 3348023644⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨225364819, 498933268⟩, ⟨73279514, 152566152⟩, ⟨6013892, 17311423⟩, ⟨(-26616), 1313960⟩, ⟨(-17133), 116092⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4520332115, 4793900564⟩, ⟨73279514, 152566152⟩, ⟨6013892, 17311423⟩, ⟨(-26616), 1313960⟩, ⟨(-17133), 116092⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4406209096, 4537581531⟩, ⟨34680711, 74357188⟩, ⟨2236926, 8300701⟩, ⟨(-153051), 622788⟩, ⟨(-26680), 58596⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3110915807, 3537146900⟩, ⟨(-142253485), (-103948558)⟩, ⟨(-1153012), 5196198⟩, ⟨(-424327), 403280⟩, ⟨(-43684), 51302⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7642479335, 10189972458⟩, ⟨1273746555, 1273746565⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13599053580, 24176095309⟩, ⟨4533017856, 6044023864⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13599053580, 24176095309⟩, ⟨4533017856, 6044023864⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-24176095309), (-13599053580)⟩, ⟨(-6044023864), (-4533017856)⟩, ⟨(-377751494), (-377751487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12088047655), (-6799526790)⟩, ⟨(-3022011932), (-2266508928)⟩, ⟨(-188875747), (-188875743)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨257425740, 881884436⟩, ⟨(-620508867), (-135846840)⟩, ⟨(-2937751), 206979720⟩, ⟨(-44562144), 18880709⟩, ⟨(-7872274), 7903266⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨186457718, 726281386⟩, ⟨(-540232788), (-104626434)⟩, ⟨631668, 192078220⟩, ⟨(-44392640), 15896013⟩, ⟨(-7231408), 8306976⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1104767594, 1104767595⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4462326774, 4462326778⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar570 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2760
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar570 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨946943652, 1262591537⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4406209096, 4537581531⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2761
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((88191 / 400000) : ℝ)..(29397 / 100000), prawitzNormalCorrection
      ((107849 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
