...
namespace FiniteNormalPanel20_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (292733 / 800000)
def radius : Rat := (41819 / 800000)

def j0 : Jet := ⟨⟨1571598326, 1571598327⟩, ⟨224514046, 224514047⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4937321755, 4937321759⟩, ⟨705331677, 705331681⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5675746619, 5675746629⟩, ⟨1621641886, 1621641898⟩, ⟨115831562, 115831565⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1420, 1422⟩, ⟨405, 407⟩, ⟨28, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93267), (-93264)⟩, ⟨405, 407⟩, ⟨28, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-123252), (-123247)⟩, ⟨(-34680), (-34675)⟩, ⟨(-2327), (-2321)⟩, ⟨20, 23⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4989804, 4989810⟩, ⟨(-34680), (-34675)⟩, ⟨(-2327), (-2321)⟩, ⟨20, 23⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6593964, 6593973⟩, ⟨1838159, 1838171⟩, ⟨118399, 118412⟩, ⟨(-1789), (-1780)⟩, ⟨(-56), (-51)⟩⟩
...
def j16 : Jet := ⟨⟨(-136571613), (-136571603)⟩, ⟨1838159, 1838171⟩, ⟨118399, 118412⟩, ⟨(-1789), (-1780)⟩, ⟨(-56), (-51)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-180477713), (-180477698)⟩, ⟨(-49135957), (-49135935)⟩, ⟨(-2832728), (-2832702)⟩, ⟨91911, 91931⟩, ⟨2442, 2455⟩⟩
...
def j19 : Jet := ⟨⟨1251178052, 1251178068⟩, ⟨(-49135957), (-49135935)⟩, ⟨(-2832728), (-2832702)⟩, ⟨91911, 91931⟩, ⟨2442, 2455⟩⟩
...
def j22 : Jet := ⟨⟨(-143), (-141)⟩, ⟨(-41), (-40)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11692, 11695⟩, ⟨(-41), (-40)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨15450, 15455⟩, ⟨4359, 4364⟩, ⟨295, 299⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-836727), (-836721)⟩, ⟨4359, 4364⟩, ⟨295, 299⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1105725), (-1105716)⟩, ⟨(-310162), (-310152)⟩, ⟨(-20532), (-20521)⟩, ⟨222, 230⟩, ⟨3, 9⟩⟩
...
def j30 : Jet := ⟨⟨34685669, 34685679⟩, ⟨(-310162), (-310152)⟩, ⟨(-20532), (-20521)⟩, ⟨222, 230⟩, ⟨3, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨45836686, 45836700⟩, ⟨12686320, 12686338⟩, ⟨791201, 791222⟩, ⟨(-15825), (-15808)⟩, ⟨(-468), (-454)⟩⟩
...
def j33 : Jet := ⟨⟨(-669991197), (-669991182)⟩, ⟨12686320, 12686338⟩, ⟨791201, 791222⟩, ⟨(-15825), (-15808)⟩, ⟨(-468), (-454)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-885385154), (-885385131)⟩, ⟨(-236202372), (-236202338)⟩, ⟨(-12233576), (-12233538)⟩, ⟨619958, 619991⟩, ⟨14743, 14772⟩⟩
...
def j36 : Jet := ⟨⟨3409582142, 3409582165⟩, ⟨(-236202372), (-236202338)⟩, ⟨(-12233576), (-12233538)⟩, ⟨619958, 619991⟩, ⟨14743, 14772⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1438303993, 1438304014⟩, ⟨148987276, 148987308⟩, ⟨(-11325637), (-11325602)⟩, ⟨(-359542), (-359513)⟩, ⟨17900, 17921⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5410265299, 5410265337⟩, ⟨374801734, 374801796⟩, ⟨45376740, 45376813⟩, ⟨3504511, 3504579⟩, ⟨313995, 314055⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1811796376, 1811796416⟩, ⟨313189700, 313189765⟩, ⟨13930613, 13930690⟩, ⟨1306416, 1306485⟩, ⟨98233, 98288⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1571598327), (-1571598326)⟩, ⟨(-224514047), (-224514046)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2723368969, 2723368970⟩, ⟨(-224514047), (-224514046)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨764291293, 764291327⟩, ⟨264232960, 264233022⟩, ⟨34590868, 34590947⟩, ⟨3133844, 3133918⟩, ⟨318587, 318649⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5059258589, 5059258623⟩, ⟨264232960, 264233022⟩, ⟨34590868, 34590947⟩, ⟨3133844, 3133918⟩, ⟨318587, 318649⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4661475107, 4661475124⟩, ⟨121728840, 121728870⟩, ⟨14346180, 14346219⟩, ⟨1069088, 1069125⟩, ⟨96773, 96805⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2955765616, 2955765629⟩, ⟨(-166486507), (-166486484)⟩, ⟨2733454, 2733483⟩, ⟨(-72040), (-72013)⟩, ⟨5474, 5498⟩⟩
...
def j47 : Jet := ⟨⟨6622513816, 6622513823⟩, ⟨946073400, 946073405⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10211414015, 10211414038⟩, ⟨2917546854, 2917546874⟩, ⟨208396203, 208396206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10211414015, 10211414038⟩, ⟨2917546854, 2917546874⟩, ⟨208396203, 208396206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10211414038), (-10211414015)⟩, ⟨(-2917546874), (-2917546854)⟩, ⟨(-208396206), (-208396203)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5105707019), (-5105707007)⟩, ⟨(-1458773437), (-1458773427)⟩, ⟨(-104198103), (-104198101)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1308234980, 1308234995⟩, ⟨(-444338299), (-444338290)⟩, ⟨43720668, 43720672⟩, ⟨2236714, 2236717⟩, ⟨(-720267), (-720266)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨900317908, 900317923⟩, ⟨(-356501749), (-356501731)⟩, ⟨48144805, 48144822⟩, ⟨(-460201), (-460183)⟩, ⟨(-545444), (-545429)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1347084280, 1796112374⟩, ⟨224514046, 224514047⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4231990077, 5642653440⟩, ⟨705331677, 705331681⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4169936294, 7413220090⟩, ⟨1389978758, 1853305026⟩, ⟨115831562, 115831565⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1043, 1858⟩, ⟨347, 465⟩, ⟨28, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93644), (-92828)⟩, ⟨347, 465⟩, ⟨28, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-161632), (-90125)⟩, ⟨(-40072), (-29238)⟩, ⟨(-2387), (-2250)⟩, ⟨18, 26⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4951424, 5022932⟩, ⟨(-40072), (-29238)⟩, ⟨(-2387), (-2250)⟩, ⟨18, 26⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4807282, 8669706⟩, ⟨1533261, 2139041⟩, ⟨112122, 123819⟩, ⟨(-2095), (-1471)⟩, ⟨(-60), (-46)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138358295), (-134495870)⟩, ⟨1533261, 2139041⟩, ⟨112122, 123819⟩, ⟨(-2095), (-1471)⟩, ⟨(-60), (-46)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-238809850), (-130580554)⟩, ⟨(-58213837), (-39834813)⟩, ⟨(-3126338), (-2490512)⟩, ⟨74019, 109690⟩, ⟨2014, 2820⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1192845915, 1301075212⟩, ⟨(-58213837), (-39834813)⟩, ⟨(-3126338), (-2490512)⟩, ⟨74019, 109690⟩, ⟨2014, 2820⟩⟩
...
def j70 : Jet := ⟨⟨(-187), (-103)⟩, ⟨(-47), (-34)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11648, 11733⟩, ⟨(-47), (-34)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨11308, 20252⟩, ⟨3687, 5030⟩, ⟨287, 305⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-840869), (-831924)⟩, ⟨3687, 5030⟩, ⟨287, 305⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1451361), (-807705)⟩, ⟨(-359262), (-260553)⟩, ⟨(-21207), (-19738)⟩, ⟨184, 268⟩, ⟨3, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34340033, 34983690⟩, ⟨(-359262), (-260553)⟩, ⟨(-21207), (-19738)⟩, ⟨184, 268⟩, ⟨3, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨33340358, 60382717⟩, ⟨10493356, 14842712⟩, ⟨734493, 839995⟩, ⟨(-18662), (-12950)⟩, ⟨(-511), (-400)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-682487525), (-655445165)⟩, ⟨10493356, 14842712⟩, ⟨734493, 839995⟩, ⟨(-18662), (-12950)⟩, ⟨(-511), (-400)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1177990398), (-636364468)⟩, ⟨(-284309717), (-186502598)⟩, ⟨(-14297029), (-9822214)⟩, ⟨488487, 750187⟩, ⟨10873, 18075⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3116976898, 3658602828⟩, ⟨(-284309717), (-186502598)⟩, ⟨(-14297029), (-9822214)⟩, ⟨488487, 750187⟩, ⟨10873, 18075⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1175355183, 1709330017⟩, ⟨119412200, 174415539⟩, ⟨(-13667371), (-8995778)⟩, ⟨(-440484), (-264889)⟩, ⟨14139, 21719⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5042018754, 5918152325⟩, ⟨257024234, 539814144⟩, ⟨26638439, 76383757⟩, ⟨834458, 8653075⟩, ⟨(-30371), 1081770⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1379792316, 2355332350⟩, ⟨210519254, 455169531⟩, ⟨(-4396805), 41760539⟩, ⟨(-1355764), 5696382⟩, ⟨(-270721), 740207⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1796112374), (-1347084280)⟩, ⟨(-224514047), (-224514046)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2498854922, 2947883016⟩, ⟨(-224514047), (-224514046)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨443269227, 1291649062⟩, ⟨135261960, 499224068⟩, ⟨5496311, 94040113⟩, ⟨(-2418912), 15099068⟩, ⟨(-627037), 2425270⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4738236523, 5586616358⟩, ⟨135261960, 499224068⟩, ⟨5496311, 94040113⟩, ⟨(-2418912), 15099068⟩, ⟨(-627037), 2425270⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4511160705, 4898401225⟩, ⟨59299521, 237649597⟩, ⟨(-3643282), 44376914⟩, ⟨(-3489287), 7379660⟩, ⟨(-905529), 1356258⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2624638409, 3362054419⟩, ⟨(-221556748), (-72702702)⟩, ⟨(-14923430), 27358620⟩, ⟨(-4714647), 5255534⟩, ⟨(-1007280), 1113277⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5676440416, 7568587228⟩, ⟨946073400, 946073405⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7502263364, 13337357116⟩, ⟨2500754446, 3334339286⟩, ⟨208396203, 208396206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7502263364, 13337357116⟩, ⟨2500754446, 3334339286⟩, ⟨208396203, 208396206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13337357116), (-7502263364)⟩, ⟨(-3334339286), (-2500754446)⟩, ⟨(-208396206), (-208396203)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6668678558), (-3751131682)⟩, ⟨(-1667169643), (-1250377223)⟩, ⟨(-104198103), (-104198101)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨909164907, 1793314419⟩, ⟨(-696107597), (-264681664)⟩, ⟨(-4978851), 113046605⟩, ⟨(-10346158), 11902829⟩, ⟨(-2526360), 1064408⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨555587265, 1403787329⟩, ⟨(-637414059), (-177135785)⟩, ⟨(-5648124), 135823802⟩, ⟨(-20333095), 14187351⟩, ⟨(-4256785), 3315981⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1571598326, 1571598327⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4661475107, 4661475124⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified404
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1347084280, 1796112374⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4511160705, 4898401225⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified405
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (95873131 / 4294967296)

theorem envelope_integral : (∫ s in ((125457 / 400000) : ℝ)..(41819 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((125457 / 400000) : ℝ)..(41819 / 100000), prawitzNormalCorrection
