...
namespace FiniteNormalPanel64_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (40417 / 160000)
def radius : Rat := (40417 / 800000)

def j0 : Jet := ⟨⟨1084935582, 1084935583⟩, ⟨216987116, 216987117⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3408425653, 3408425658⟩, ⟨681685129, 681685133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2704878671, 2704878680⟩, ⟨1081951464, 1081951474⟩, ⟨108195146, 108195148⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨677, 678⟩, ⟨270, 272⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94010), (-94008)⟩, ⟨270, 272⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-59206), (-59204)⟩, ⟨(-23513), (-23509)⟩, ⟨(-2284), (-2281)⟩, ⟨12, 15⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5053850, 5053853⟩, ⟨(-23513), (-23509)⟩, ⟨(-2284), (-2281)⟩, ⟨12, 15⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3182806, 3182809⟩, ⟨1258314, 1258319⟩, ⟨119949, 119955⟩, ⟨(-1162), (-1156)⟩, ⟨(-55), (-52)⟩⟩
...
def j16 : Jet := ⟨⟨(-139982771), (-139982767)⟩, ⟨1258314, 1258319⟩, ⟨119949, 119955⟩, ⟨(-1162), (-1156)⟩, ⟨(-55), (-52)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-88158160), (-88158156)⟩, ⟨(-34470805), (-34470799)⟩, ⟨(-3133803), (-3133795)⟩, ⟨61182, 61190⟩, ⟨2693, 2699⟩⟩
...
def j19 : Jet := ⟨⟨1343497605, 1343497610⟩, ⟨(-34470805), (-34470799)⟩, ⟨(-3133803), (-3133795)⟩, ⟨61182, 61190⟩, ⟨2693, 2699⟩⟩
...
def j22 : Jet := ⟨⟨(-69), (-67)⟩, ⟨(-28), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11766, 11769⟩, ⟨(-28), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7409, 7412⟩, ⟨2945, 2949⟩, ⟨286, 290⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844768), (-844764)⟩, ⟨2945, 2949⟩, ⟨286, 290⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-532017), (-532014)⟩, ⟨(-210953), (-210947)⟩, ⟨(-20360), (-20354)⟩, ⟨144, 149⟩, ⟨5, 8⟩⟩
...
def j30 : Jet := ⟨⟨35259377, 35259381⟩, ⟨(-210953), (-210947)⟩, ⟨(-20360), (-20354)⟩, ⟨144, 149⟩, ⟨5, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22205602, 22205606⟩, ⟨8749386, 8749394⟩, ⟨822259, 822268⟩, ⟨(-10354), (-10346)⟩, ⟨(-474), (-468)⟩⟩
...
def j33 : Jet := ⟨⟨(-693622281), (-693622276)⟩, ⟨8749386, 8749394⟩, ⟨822259, 822268⟩, ⟨(-10354), (-10346)⟩, ⟨(-474), (-468)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-436828500), (-436828495)⟩, ⟨(-169221225), (-169221215)⟩, ⟨(-14751230), (-14751219)⟩, ⟨421022, 421032⟩, ⟨17805, 17814⟩⟩
...
def j36 : Jet := ⟨⟨3858138796, 3858138801⟩, ⟨(-169221225), (-169221215)⟩, ⟨(-14751230), (-14751219)⟩, ⟨421022, 421032⟩, ⟨17805, 17814⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1066180807, 1066180814⟩, ⟨185880614, 185880623⟩, ⟨(-7958052), (-7958043)⟩, ⟨(-448836), (-448827)⟩, ⟨11847, 11854⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4781254647, 4781254654⟩, ⟨209709852, 209709867⟩, ⟨27478711, 27478730⟩, ⟨1485272, 1485290⟩, ⟨125244, 125261⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1186896566, 1186896577⟩, ⟨258984781, 258984798⟩, ⟨7038189, 7038207⟩, ⟨669723, 669742⟩, ⟨35727, 35746⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1084935583), (-1084935582)⟩, ⟨(-216987117), (-216987116)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3210031713, 3210031714⟩, ⟨(-216987117), (-216987116)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨327993989, 327993996⟩, ⟨143138760, 143138772⟩, ⟨19506624, 19506640⟩, ⟨1218948, 1218966⟩, ⟨112047, 112064⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4622961285, 4622961292⟩, ⟨143138760, 143138772⟩, ⟨19506624, 19506640⟩, ⟨1218948, 1218966⟩, ⟨112047, 112064⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4455947433, 4455947437⟩, ⟨68983790, 68983797⟩, ⟨8866974, 8866984⟩, ⟨450182, 450193⟩, ⟨38207, 38218⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3330347261, 3330347266⟩, ⟨(-173561982), (-173561974)⟩, ⟨3141972, 3141982⟩, ⟨(-111509), (-111498)⟩, ⟨5810, 5821⟩⟩
...
def j47 : Jet := ⟨⟨4979376885, 4979376892⟩, ⟨995875375, 995875381⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5772848185, 5772848203⟩, ⟨2309139268, 2309139288⟩, ⟨230913926, 230913930⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5772848185, 5772848203⟩, ⟨2309139268, 2309139288⟩, ⟨230913926, 230913930⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5772848203), (-5772848185)⟩, ⟨(-2309139288), (-2309139268)⟩, ⟨(-230913930), (-230913926)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2886424102), (-2886424092)⟩, ⟨(-1154569644), (-1154569634)⟩, ⟨(-115456965), (-115456963)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2193275212, 2193275228⟩, ⟨(-589594478), (-589594468)⟩, ⟨20287705, 20287710⟩, ⟨8748378, 8748380⟩, ⟨(-860620), (-860618)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1700680725, 1700680740⟩, ⟨(-545807079), (-545807065)⟩, ⟨41161544, 41161557⟩, ⟨5475452, 5475465⟩, ⟨(-987746), (-987732)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨867948466, 1301922700⟩, ⟨216987116, 216987117⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2726740524, 4090110791⟩, ⟨681685129, 681685133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1731122351, 3895025301⟩, ⟨865561172, 1298341770⟩, ⟨108195146, 108195148⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨433, 976⟩, ⟨216, 326⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94254), (-93710)⟩, ⟨216, 326⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-85478), (-37770)⟩, ⟨(-28406), (-18589)⟩, ⟨(-2322), (-2235)⟩, ⟨10, 18⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5027578, 5075287⟩, ⟨(-28406), (-18589)⟩, ⟨(-2322), (-2235)⟩, ⟨10, 18⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2026407, 4602683⟩, ⟨987442, 1526736⟩, ⟨115957, 123207⟩, ⟨(-1414), (-901)⟩, ⟨(-57), (-49)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141139170), (-138562893)⟩, ⟨987442, 1526736⟩, ⟨115957, 123207⟩, ⟨(-1414), (-901)⟩, ⟨(-57), (-49)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-127996467), (-55848928)⟩, ⟨(-42267493), (-26539895)⟩, ⟨(-3309723), (-2917299)⟩, ⟨46959, 75343⟩, ⟨2441, 2904⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1303659298, 1375806838⟩, ⟨(-42267493), (-26539895)⟩, ⟨(-3309723), (-2917299)⟩, ⟨46959, 75343⟩, ⟨2441, 2904⟩⟩
...
def j70 : Jet := ⟨⟨(-98), (-43)⟩, ⟨(-33), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11737, 11793⟩, ⟨(-33), (-21)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4730, 10695⟩, ⟨2335, 3557⟩, ⟨282, 294⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847447), (-841481)⟩, ⟨2335, 3557⟩, ⟨282, 294⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-768534), (-339165)⟩, ⟨(-255237), (-166356)⟩, ⟨(-20766), (-19854)⟩, ⟨112, 179⟩, ⟨5, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35022860, 35452230⟩, ⟨(-255237), (-166356)⟩, ⟨(-20766), (-19854)⟩, ⟨112, 179⟩, ⟨5, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14116255, 32150963⟩, ⟨6826657, 10649937⟩, ⟨786275, 851556⟩, ⟨(-12663), (-8028)⟩, ⟨(-500), (-437)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701711628), (-683676919)⟩, ⟨6826657, 10649937⟩, ⟨786275, 851556⟩, ⟨(-12663), (-8028)⟩, ⟨(-500), (-437)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-636369117), (-275561678)⟩, ⟨(-209371500), (-128122609)⟩, ⟨(-15984237), (-13230933)⟩, ⟨318944, 522471⟩, ⟨15525, 19659⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3658598179, 4019405618⟩, ⟨(-209371500), (-128122609)⟩, ⟨(-15984237), (-13230933)⟩, ⟨318944, 522471⟩, ⟨15525, 19659⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨827652550, 1310185156⟩, ⟨166661671, 201514844⟩, ⟨(-9860438), (-6064438)⟩, ⟨(-495498), (-391275)⟩, ⟨9002, 14725⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4589420881, 5042025162⟩, ⟨146292420, 288541218⟩, ⟨19770505, 38540783⟩, ⟨456365, 3066116⟩, ⟨17457, 311624⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨884394602, 1538076095⟩, ⟨206278601, 324585787⟩, ⟨(-2088988), 18814730⟩, ⟨(-389006), 2118951⟩, ⟨(-91081), 214966⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1301922700), (-867948466)⟩, ⟨(-216987117), (-216987116)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2993044596, 3427018830⟩, ⟨(-216987117), (-216987116)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨182109375, 550802349⟩, ⟨84951370, 232475644⟩, ⟨8410962, 38005624⟩, ⟨(-594362), 4361434⟩, ⟨(-133186), 556659⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4477076671, 4845769645⟩, ⟨84951370, 232475644⟩, ⟨8410962, 38005624⟩, ⟨(-594362), 4361434⟩, ⟨(-133186), 556659⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4385076724, 4562063366⟩, ⟨39988852, 113849239⟩, ⟨2538670, 18429987⟩, ⟨(-769571), 2112755⟩, ⟨(-158809), 291857⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3055839378, 3640138791⟩, ⟨(-202614014), (-130697540)⟩, ⟨(-3982677), 12685278⟩, ⟨(-1545159), 1557543⟩, ⟨(-233457), 271758⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3983501510, 5975252272⟩, ⟨995875375, 995875381⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3694622842, 8312901416⟩, ⟨1847311416, 2770967146⟩, ⟨230913926, 230913930⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3694622842, 8312901416⟩, ⟨1847311416, 2770967146⟩, ⟨230913926, 230913930⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8312901416), (-3694622842)⟩, ⟨(-2770967146), (-1847311416)⟩, ⟨(-230913930), (-230913926)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4156450708), (-1847311421)⟩, ⟨(-1385483573), (-923655708)⟩, ⟨(-115456965), (-115456963)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1631818188, 2793606000⟩, ⟨(-901169894), (-350931236)⟩, ⟨(-37362672), 101484655⟩, ⟨(-4623273), 20167640⟩, ⟨(-2990486), 875038⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1161027298, 2367681258⟩, ⟨(-895561469), (-299342002)⟩, ⟨(-23577711), 136775327⟩, ⟨(-12372558), 20704104⟩, ⟨(-4074955), 1760435⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1084935582, 1084935583⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4455947433, 4455947437⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1268
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨867948466, 1301922700⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4385076724, 4562063366⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1269
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (173262965 / 4294967296)

theorem envelope_integral : (∫ s in ((40417 / 200000) : ℝ)..(121251 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((40417 / 200000) : ℝ)..(121251 / 400000), prawitzNormalCorrection
