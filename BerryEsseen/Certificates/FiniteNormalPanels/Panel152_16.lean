...
namespace FiniteNormalPanel152_16
...
def j2 : Jet := ⟨⟨1509213131, 1509213135⟩, ⟨503071041, 503071045⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨530324008, 530324012⟩, ⟨353549336, 353549342⟩, ⟨58924889, 58924891⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨132, 133⟩, ⟨88, 89⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94555), (-94553)⟩, ⟨88, 89⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11676), (-11674)⟩, ⟨(-7774), (-7772)⟩, ⟨(-1290), (-1287)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101380, 5101383⟩, ⟨(-7774), (-7772)⟩, ⟨(-1290), (-1287)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨629896, 629897⟩, ⟨418970, 418973⟩, ⟨69188, 69192⟩, ⟨(-214), (-210)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-142535681), (-142535679)⟩, ⟨418970, 418973⟩, ⟨69188, 69192⟩, ⟨(-214), (-210)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17599691), (-17599689)⟩, ⟨(-11681395), (-11681393)⟩, ⟨(-1912491), (-1912488)⟩, ⟨11416, 11420⟩, ⟨928, 932⟩⟩
...
def j19 : Jet := ⟨⟨1414056074, 1414056077⟩, ⟨(-11681395), (-11681393)⟩, ⟨(-1912491), (-1912488)⟩, ⟨11416, 11420⟩, ⟨928, 932⟩⟩
...
def j25 : Jet := ⟨⟨1459, 1460⟩, ⟨971, 974⟩, ⟨160, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850718), (-850716)⟩, ⟨971, 974⟩, ⟨160, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-105043), (-105042)⟩, ⟨(-69910), (-69907)⟩, ⟨(-11574), (-11569)⟩, ⟨25, 28⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35686351, 35686353⟩, ⟨(-69910), (-69907)⟩, ⟨(-11574), (-11569)⟩, ⟨25, 28⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4406396, 4406397⟩, ⟨2928964, 2928967⟩, ⟨482414, 482418⟩, ⟨(-1910), (-1907)⟩, ⟨(-157), (-154)⟩⟩
...
def j33 : Jet := ⟨⟨(-711421487), (-711421485)⟩, ⟨2928964, 2928967⟩, ⟨482414, 482418⟩, ⟨(-1910), (-1907)⟩, ⟨(-157), (-154)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-87843253), (-87843251)⟩, ⟨(-58200514), (-58200510)⟩, ⟨(-9459693), (-9459689)⟩, ⟨79657, 79662⟩, ⟨6440, 6444⟩⟩
...
def j36 : Jet := ⟨⟨4207124043, 4207124045⟩, ⟨(-58200514), (-58200510)⟩, ⟨(-9459693), (-9459689)⟩, ⟨79657, 79662⟩, ⟨6440, 6444⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨496886669, 496886672⟩, ⟨161524150, 161524154⟩, ⟨(-2040279), (-2040276)⟩, ⟨(-220000), (-219997)⟩, ⟨1663, 1666⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4384644682, 4384644685⟩, ⟨60656293, 60656301⟩, ⟨10697948, 10697957⟩, ⟨201353, 201362⟩, ⟨18973, 18983⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨507261485, 507261489⟩, ⟨171914069, 171914076⟩, ⟨1435918, 1435925⟩, ⟨172210, 172219⟩, ⟨3274, 3284⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-480397461), (-480397460)⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3814569835, 3814569836⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨59910634, 59910636⟩, ⟨40608172, 40608176⟩, ⟨7220360, 7220366⟩, ⟨155628, 155634⟩, ⟨15038, 15045⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4354877930, 4354877932⟩, ⟨40608172, 40608176⟩, ⟨7220360, 7220366⟩, ⟨155628, 155634⟩, ⟨15038, 15045⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4324818873, 4324818875⟩, ⟨20163939, 20163942⟩, ⟨3538254, 3538259⟩, ⟨60779, 60784⟩, ⟨5735, 5741⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3841082475, 3841082479⟩, ⟨(-143336889), (-143336884)⟩, ⟨2390707, 2390714⟩, ⟨(-77940), (-77933)⟩, ⟨2826, 2833⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨32213723977, 32213723984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value624

def j47 : Jet := ⟨⟨3603145288, 3603145297⟩, ⟨1201048424, 1201048433⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3022760145, 3022760161⟩, ⟨2015173420, 2015173442⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3022760145, 3022760161⟩, ⟨2015173420, 2015173442⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3022760161), (-3022760145)⟩, ⟨(-2015173442), (-2015173420)⟩, ⟨(-335862241), (-335862235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1511380081), (-1511380072)⟩, ⟨(-1007586721), (-1007586710)⟩, ⟨(-167931121), (-167931117)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3020880493, 3020880506⟩, ⟨(-708689700), (-708689688)⟩, ⟨(-34986692), (-34986685)⟩, ⟨21208870, 21208873⟩, ⟨(-559904), (-559903)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2701638993, 2701639008⟩, ⟨(-734613093), (-734613076)⟩, ⟨(-5956591), (-5956575)⟩, ⟨19685871, 19685884⟩, ⟨(-1213173), (-1213161)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨320264973, 640529948⟩, ⟨160132486, 160132487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1006142086, 2012284180⟩, ⟨503071041, 503071045⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨235699558, 942798244⟩, ⟨235699556, 471399122⟩, ⟨58924889, 58924891⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨58, 237⟩, ⟨58, 119⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94629), (-94449)⟩, ⟨58, 119⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-20773), (-5183)⟩, ⟨(-10384), (-5156)⟩, ⟨(-1296), (-1277)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092283, 5107874⟩, ⟨(-10384), (-5156)⟩, ⟨(-1296), (-1277)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨279454, 1121242⟩, ⟨277174, 560339⟩, ⟨68438, 69726⟩, ⟨(-286), (-139)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142886123), (-142044334)⟩, ⟨277174, 560339⟩, ⟨68438, 69726⟩, ⟨(-286), (-139)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-31365265), (-7795120)⟩, ⟨(-15667423), (-7672118)⟩, ⟨(-1941365), (-1871973)⟩, ⟨7494, 15334⟩, ⟨902, 950⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1400290500, 1423860646⟩, ⟨(-15667423), (-7672118)⟩, ⟨(-1941365), (-1871973)⟩, ⟨7494, 15334⟩, ⟨902, 950⟩⟩
...
def j72 : Jet := ⟨⟨648, 2598⟩, ⟨645, 1299⟩, ⟨159, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851529), (-849578)⟩, ⟨645, 1299⟩, ⟨159, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-186922), (-46623)⟩, ⟨(-93426), (-46337)⟩, ⟨(-11640), (-11476)⟩, ⟨15, 36⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35604472, 35744772⟩, ⟨(-93426), (-46337)⟩, ⟨(-11640), (-11476)⟩, ⟨15, 36⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1953905, 7846418⟩, ⟨1933396, 3920667⟩, ⟨475665, 487231⟩, ⟨(-2560), (-1256)⟩, ⟨(-160), (-152)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713873978), (-707981464)⟩, ⟨1933396, 3920667⟩, ⟨475665, 487231⟩, ⟨(-2560), (-1256)⟩, ⟨(-160), (-152)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-156704135), (-38852663)⟩, ⟨(-78245967), (-37992027)⟩, ⟨(-9661805), (-9175893)⟩, ⟨52066, 107199⟩, ⟨6208, 6609⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4138263161, 4256114633⟩, ⟨(-78245967), (-37992027)⟩, ⟨(-9661805), (-9175893)⟩, ⟨52066, 107199⟩, ⟨6208, 6609⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨328033046, 667109213⟩, ⟨156675998, 164980029⟩, ⟨(-2744703), (-1337166)⟩, ⟨(-225638), (-212079)⟩, ⟨1088, 2243⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4334174632, 4457605367⟩, ⟨38688825, 84284066⟩, ⟨9689538, 12001027⟩, ⟨57627, 369168⟩, ⟨12357, 28014⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨331027551, 692370723⟩, ⟨161061144, 184318643⟩, ⟨(-697261), 3752224⟩, ⟨69820, 292271⟩, ⟨(-7956), 15935⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-640529948), (-320264973)⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3654437348, 3974702323⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨25513404, 111613707⟩, ⟨24827046, 59426220⟩, ⟨5814982, 9119796⟩, ⟨(-49084), 416286⟩, ⟨2060, 33503⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4320480700, 4406581003⟩, ⟨24827046, 59426220⟩, ⟨5814982, 9119796⟩, ⟨(-49084), 416286⟩, ⟨2060, 33503⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307705109, 4350416221⟩, ⟨12255304, 29625249⟩, ⟨2769562, 4528982⟩, ⟨(-55618), 199649⟩, ⟨(-2728), 16195⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3665275507, 4026016561⟩, ⟨(-151772222), (-133191230)⟩, ⟨1251982, 3734345⟩, ⟨(-220329), 81503⟩, ⟨(-9969), 17062⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2402096856, 4804193729⟩, ⟨1201048424, 1201048433⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1343448950, 5373795840⟩, ⟨1343448944, 2686897922⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1343448950, 5373795840⟩, ⟨1343448944, 2686897922⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5373795840), (-1343448950)⟩, ⟨(-2686897922), (-1343448944)⟩, ⟨(-335862241), (-335862235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2686897920), (-671724475)⟩, ⟨(-1343448961), (-671724472)⟩, ⟨(-167931121), (-167931117)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2297569367, 3673136390⟩, ⟨(-1148942688), (-359335348)⟩, ⟨(-115518165), 89858552⟩, ⟨(-2578), 41993275⟩, ⟨(-5040546), 2258554⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1960719173, 3443124690⟩, ⟨(-1206794373), (-377902560)⟩, ⟨(-96471333), 128025740⟩, ⟨(-4365171), 43410707⟩, ⟨(-6339603), 2268879⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4324818873, 4324818875⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar624 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3070
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar624 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307705109, 4350416221⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3071
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((29827 / 400000) : ℝ)..(29827 / 200000), prawitzNormalCorrection
      ((96829 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
