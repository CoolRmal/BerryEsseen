...
namespace FiniteNormalPanel94_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (209223 / 800000)
def radius : Rat := (29889 / 800000)

def j0 : Jet := ⟨⟨1123257428, 1123257429⟩, ⟨160465346, 160465347⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3528817283, 3528817288⟩, ⟨504116752, 504116756⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2899335561, 2899335570⟩, ⟨828381584, 828381594⟩, ⟨59170112, 59170114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨725, 727⟩, ⟨207, 208⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93962), (-93959)⟩, ⟨207, 208⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-63430), (-63427)⟩, ⟨(-17984), (-17981)⟩, ⟨(-1247), (-1242)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5049626, 5049630⟩, ⟨(-17984), (-17981)⟩, ⟨(-1247), (-1242)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3408771, 3408774⟩, ⟨961793, 961798⟩, ⟨65255, 65261⟩, ⟨(-487), (-481)⟩, ⟨(-18), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-139756806), (-139756802)⟩, ⟨961793, 961798⟩, ⟨65255, 65261⟩, ⟨(-487), (-481)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-94343415), (-94343411)⟩, ⟨(-26306000), (-26305994)⟩, ⟨(-1695823), (-1695815)⟩, ⟨25506, 25515⟩, ⟨791, 799⟩⟩
...
def j19 : Jet := ⟨⟨1337312350, 1337312355⟩, ⟨(-26306000), (-26305994)⟩, ⟨(-1695823), (-1695815)⟩, ⟨25506, 25515⟩, ⟨791, 799⟩⟩
...
def j22 : Jet := ⟨⟨(-73), (-72)⟩, ⟨(-21), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11762, 11764⟩, ⟨(-21), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7939, 7942⟩, ⟨2253, 2256⟩, ⟨155, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844238), (-844234)⟩, ⟨2253, 2256⟩, ⟨155, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-569907), (-569903)⟩, ⟨(-161311), (-161306)⟩, ⟨(-11093), (-11085)⟩, ⟨58, 63⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35221487, 35221492⟩, ⟨(-161311), (-161306)⟩, ⟨(-11093), (-11085)⟩, ⟨58, 63⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23776411, 23776415⟩, ⟨6684366, 6684372⟩, ⟨446630, 446640⟩, ⟨(-4324), (-4316)⟩, ⟨(-142), (-136)⟩⟩
...
def j33 : Jet := ⟨⟨(-692051472), (-692051467)⟩, ⟨6684366, 6684372⟩, ⟨446630, 446640⟩, ⟨(-4324), (-4316)⟩, ⟨(-142), (-136)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-467172230), (-467172225)⟩, ⟨(-128965472), (-128965463)⟩, ⟨(-7943398), (-7943386)⟩, ⟨175310, 175321⟩, ⟨5223, 5231⟩⟩
...
def j36 : Jet := ⟨⟨3827795066, 3827795071⟩, ⟨(-128965472), (-128965463)⟩, ⟨(-7943398), (-7943386)⟩, ⟨175310, 175321⟩, ⟨5223, 5231⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1098758292, 1098758299⟩, ⟨135352017, 135352026⟩, ⟨(-4480953), (-4480945)⟩, ⟨(-178090), (-178080)⟩, ⟨3642, 3652⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4819156650, 4819156657⟩, ⟨162366259, 162366272⟩, ⟨15471062, 15471081⟩, ⟨637459, 637477⟩, ⟨39558, 39574⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1232858823, 1232858834⟩, ⟨193408654, 193408669⟩, ⟨4046862, 4046879⟩, ⟨281409, 281431⟩, ⟨11418, 11441⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1123257429), (-1123257428)⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3171709867, 3171709868⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨353888812, 353888820⟩, ⟨111034868, 111034880⟩, ⟨11032754, 11032768⟩, ⟨526026, 526044⟩, ⟨35711, 35732⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4648856108, 4648856116⟩, ⟨111034868, 111034880⟩, ⟨11032754, 11032768⟩, ⟨526026, 526044⟩, ⟨35711, 35732⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4468409666, 4468409671⟩, ⟨53362511, 53362518⟩, ⟨4983625, 4983633⟩, ⟨193288, 193299⟩, ⟨12074, 12086⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3299792070, 3299792076⟩, ⟨(-127538691), (-127538683)⟩, ⟨1686572, 1686580⟩, ⟨(-43458), (-43448)⟩, ⟨1694, 1705⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨40655317895, 40655317902⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value433

def j47 : Jet := ⟨⟨10632534467, 10632534480⟩, ⟨1518933487, 1518933498⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨26321688013, 26321688078⟩, ⟨7520482248, 7520482314⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨26321688013, 26321688078⟩, ⟨7520482248, 7520482314⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-26321688078), (-26321688013)⟩, ⟨(-7520482314), (-7520482248)⟩, ⟨(-537177309), (-537177300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-13160844039), (-13160844006)⟩, ⟨(-3760241157), (-3760241124)⟩, ⟨(-268588655), (-268588650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨200527504, 200527511⟩, ⟨(-175561710), (-175561701)⟩, ⟨64311956, 64311963⟩, ⟨(-11449116), (-11449112)⟩, ⟨495026, 495028⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨154063819, 154063826⟩, ⟨(-140837431), (-140837421)⟩, ⟨54702440, 54702449⟩, ⟨(-10776983), (-10776974)⟩, ⟨747412, 747420⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨962792081, 1283722776⟩, ⟨160465346, 160465347⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3024700528, 4032934043⟩, ⟨504116752, 504116756⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2130124085, 3786887274⟩, ⟨710041358, 946721820⟩, ⟨59170112, 59170114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨533, 949⟩, ⟨177, 238⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94154), (-93737)⟩, ⟨177, 238⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-83016), (-46489)⟩, ⟨(-20667), (-15286)⟩, ⟨(-1263), (-1224)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5030040, 5066568⟩, ⟨(-20667), (-15286)⟩, ⟨(-1263), (-1224)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2494689, 4467211⟩, ⟨813340, 1109222⟩, ⟨63626, 66667⟩, ⟨(-563), (-404)⟩, ⟨(-18), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140670888), (-138698365)⟩, ⟨813340, 1109222⟩, ⟨63626, 66667⟩, ⟨(-563), (-404)⟩, ⟨(-18), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-124030001), (-68788586)⟩, ⟨(-30604119), (-21951523)⟩, ⟨(-1771954), (-1607511)⟩, ⟨21226, 29778⟩, ⟨735, 847⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1307625764, 1362867180⟩, ⟨(-30604119), (-21951523)⟩, ⟨(-1771954), (-1607511)⟩, ⟨21226, 29778⟩, ⟨735, 847⟩⟩
...
def j70 : Jet := ⟨⟨(-96), (-53)⟩, ⟨(-24), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11739, 11783⟩, ⟨(-24), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5822, 10390⟩, ⟨1918, 2590⟩, ⟨153, 161⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846355), (-841786)⟩, ⟨1918, 2590⟩, ⟨153, 161⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-746235), (-417490)⟩, ⟨(-185608), (-136879)⟩, ⟨(-11268), (-10883)⟩, ⟨49, 72⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35045159, 35373905⟩, ⟨(-185608), (-136879)⟩, ⟨(-11268), (-10883)⟩, ⟨49, 72⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17380932, 31189293⟩, ⟨5629992, 7729438⟩, ⟨431954, 459308⟩, ⟨(-5018), (-3620)⟩, ⟨(-148), (-130)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698446951), (-684638589)⟩, ⟨5629992, 7729438⟩, ⟨431954, 459308⟩, ⟨(-5018), (-3620)⟩, ⟨(-148), (-130)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-615823053), (-339552096)⟩, ⟨(-151163524), (-106368959)⟩, ⟨(-8477259), (-7323260)⟩, ⟨144547, 205935⟩, ⟨4712, 5666⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3679144243, 3955415200⟩, ⟨(-151163524), (-106368959)⟩, ⟨(-8477259), (-7323260)⟩, ⟨144547, 205935⟩, ⟨4712, 5666⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨920886252, 1279719511⟩, ⟨124744060, 144505735⟩, ⟨(-5255972), (-3708612)⟩, ⟨(-193034), (-160717)⟩, ⟨3008, 4292⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4663668196, 5013868133⟩, ⟨125415286, 206002790⟩, ⟨12007221, 20016604⟩, ⟨294055, 1113849⟩, ⟨12228, 80989⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨999939610, 1493921708⟩, ⟨162343056, 230073578⟩, ⟨81337, 8868168⟩, ⟨(-65654), 722541⟩, ⟨(-19328), 51559⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1283722776), (-962792081)⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3011244520, 3332175215⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨232802523, 519631913⟩, ⟨75592310, 160053332⟩, ⟨6174185, 18493867⟩, ⟨(-39526), 1452748⟩, ⟨(-20479), 131591⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4527769819, 4814599209⟩, ⟨75592310, 160053332⟩, ⟨6174185, 18493867⟩, ⟨(-39526), 1452748⟩, ⟨(-20479), 131591⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4409832570, 4547366947⟩, ⟨35698295, 77942169⟩, ⟨2247777, 8861583⟩, ⟨(-175875), 689259⟩, ⟨(-31060), 66618⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3091777712, 3527995068⟩, ⟨(-144866883), (-104286788)⟩, ⟨(-1336079), 5541373⟩, ⟨(-467530), 450771⟩, ⟨(-49850), 58256⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9113600971, 12151467977⟩, ⟨1518933487, 1518933498⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨19338383027, 34379347693⟩, ⟨6446127640, 8594836930⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨19338383027, 34379347693⟩, ⟨6446127640, 8594836930⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-34379347693), (-19338383027)⟩, ⟨(-8594836930), (-6446127640)⟩, ⟨(-537177309), (-537177300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-17189673847), (-9669191513)⟩, ⟨(-4297418465), (-3223063820)⟩, ⟨(-268588655), (-268588650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨78485694, 452105313⟩, ⟨(-452363333), (-58897864)⟩, ⟨(-6173405), 221402596⟩, ⟨(-71387507), 20918206⟩, ⟨(-12155317), 18050092⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨56498758, 371370771⟩, ⟨(-386831979), (-44303974)⟩, ⟨(-3781525), 197706982⟩, ⟨(-66740152), 17579143⟩, ⟨(-10811846), 17575696⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1123257428, 1123257429⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4468409666, 4468409671⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar433 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1892
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar433 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨962792081, 1283722776⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4409832570, 4547366947⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1893
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((89667 / 400000) : ℝ)..(29889 / 100000), prawitzNormalCorrection
      ((59867 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
