...
namespace FiniteNormalPanel12_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38239 / 160000)
def radius : Rat := (38239 / 800000)

def j0 : Jet := ⟨⟨1026470340, 1026470341⟩, ⟨205294068, 205294069⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3224751679, 3224751683⟩, ⟨644950335, 644950340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2421211309, 2421211316⟩, ⟨968484522, 968484532⟩, ⟨96848452, 96848454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-53037), (-53035)⟩, ⟨(-21079), (-21077)⟩, ⟨(-2055), (-2051)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5060019, 5060022⟩, ⟨(-21079), (-21077)⟩, ⟨(-2055), (-2051)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2852495, 2852498⟩, ⟨1129115, 1129118⟩, ⟨108186, 108192⟩, ⟨(-935), (-930)⟩, ⟨(-45), (-42)⟩⟩
...
def j16 : Jet := ⟨⟨(-140313082), (-140313078)⟩, ⟨1129115, 1129118⟩, ⟨108186, 108192⟩, ⟨(-935), (-930)⟩, ⟨(-45), (-42)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-79099001), (-79098998)⟩, ⟨(-31003083), (-31003078)⟩, ⟨(-2848367), (-2848358)⟩, ⟨49327, 49334⟩, ⟨2202, 2208⟩⟩
...
def j19 : Jet := ⟨⟨1352556764, 1352556768⟩, ⟨(-31003083), (-31003078)⟩, ⟨(-2848367), (-2848358)⟩, ⟨49327, 49334⟩, ⟨2202, 2208⟩⟩
...
def j25 : Jet := ⟨⟨6637, 6639⟩, ⟨2639, 2643⟩, ⟨257, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845540), (-845537)⟩, ⟨2639, 2643⟩, ⟨257, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-476659), (-476656)⟩, ⟨(-189177), (-189172)⟩, ⟨(-18328), (-18323)⟩, ⟨114, 119⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35314735, 35314739⟩, ⟨(-189177), (-189172)⟩, ⟨(-18328), (-18323)⟩, ⟨114, 119⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19908052, 19908056⟩, ⟨7856575, 7856581⟩, ⟨743330, 743338⟩, ⟨(-8335), (-8328)⟩, ⟨(-388), (-382)⟩⟩
...
def j33 : Jet := ⟨⟨(-695919831), (-695919826)⟩, ⟨7856575, 7856581⟩, ⟨743330, 743338⟩, ⟨(-8335), (-8328)⟩, ⟨(-388), (-382)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-392312410), (-392312405)⟩, ⟨(-152495961), (-152495954)⟩, ⟨(-13501857), (-13501848)⟩, ⟨340076, 340085⟩, ⟨14662, 14670⟩⟩
...
def j36 : Jet := ⟨⟨3902654886, 3902654891⟩, ⟨(-152495961), (-152495954)⟩, ⟨(-13501857), (-13501848)⟩, ⟨340076, 340085⟩, ⟨14662, 14670⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1015528034, 1015528039⟩, ⟨179827839, 179827847⟩, ⟨(-6794168), (-6794159)⟩, ⟨(-390688), (-390679)⟩, ⟨9060, 9067⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4726716706, 4726716713⟩, ⟨184696108, 184696119⟩, ⟨23569805, 23569820⟩, ⟨1148077, 1148093⟩, ⟨92540, 92556⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1117613474, 1117613482⟩, ⟨241575605, 241575619⟩, ⟨5828959, 5828975⟩, ⟨536180, 536200⟩, ⟨25833, 25851⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1026470341), (-1026470340)⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3268496955, 3268496956⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨290819415, 290819420⟩, ⟨125723030, 125723040⟩, ⟨16621270, 16621283⟩, ⟨934754, 934772⟩, ⟨81670, 81685⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4585786711, 4585786716⟩, ⟨125723030, 125723040⟩, ⟨16621270, 16621283⟩, ⟨934754, 934772⟩, ⟨81670, 81685⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4437995487, 4437995491⟩, ⟨60835607, 60835613⟩, ⟨7625834, 7625842⟩, ⟨347779, 347790⟩, ⟨28198, 28208⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3377342302, 3377342307⟩, ⟨(-165834361), (-165834354)⟩, ⟨2895440, 2895449⟩, ⟨(-99845), (-99834)⟩, ⟨4834, 4844⟩⟩
...
def j47 : Jet := ⟨⟨5277532521, 5277532528⟩, ⟨1055506504, 1055506510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6484880463, 6484880481⟩, ⟨2593952184, 2593952204⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6484880463, 6484880481⟩, ⟨2593952184, 2593952204⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6484880481), (-6484880463)⟩, ⟨(-2593952204), (-2593952184)⟩, ⟨(-259395222), (-259395218)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3242440241), (-3242440231)⟩, ⟨(-1296976102), (-1296976092)⟩, ⟨(-129697611), (-129697609)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2018802453, 2018802465⟩, ⟨(-609629451), (-609629441)⟩, ⟨31083716, 31083721⟩, ⟨9144044, 9144046⟩, ⟨(-1159647), (-1159646)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1587482850, 1587482862⟩, ⟨(-557330008), (-557329994)⟩, ⟨49342208, 49342221⟩, ⟨5532309, 5532323⟩, ⟨(-1227556), (-1227543)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨821176272, 1231764409⟩, ⟨205294068, 205294069⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2579801343, 3869702019⟩, ⟨644950335, 644950340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1549575237, 3486544294⟩, ⟨774787618, 1162181438⟩, ⟨96848452, 96848454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨387, 874⟩, ⟨193, 292⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94300), (-93812)⟩, ⟨193, 292⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-76551), (-33846)⟩, ⟨(-25448), (-16685)⟩, ⟨(-2085), (-2014)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5036505, 5079211⟩, ⟨(-25448), (-16685)⟩, ⟨(-2085), (-2014)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1817113, 4123174⟩, ⟨887897, 1368373⟩, ⟨104989, 110798⟩, ⟨(-1137), (-727)⟩, ⟨(-47), (-40)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141348464), (-139042402)⟩, ⟨887897, 1368373⟩, ⟨104989, 110798⟩, ⟨(-1137), (-727)⟩, ⟨(-47), (-40)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-114743058), (-50164913)⟩, ⟨(-37927344), (-23971645)⟩, ⟨(-2989259), (-2675093)⟩, ⟨38037, 60575⟩, ⟨2020, 2354⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1316912707, 1381490853⟩, ⟨(-37927344), (-23971645)⟩, ⟨(-2989259), (-2675093)⟩, ⟨38037, 60575⟩, ⟨2020, 2354⟩⟩
...
def j72 : Jet := ⟨⟨4238, 9578⟩, ⟨2094, 3187⟩, ⟨252, 264⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847939), (-842598)⟩, ⟨2094, 3187⟩, ⟨252, 264⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-688336), (-303999)⟩, ⟨(-228691), (-149411)⟩, ⟨(-18654), (-17921)⟩, ⟨90, 144⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35103058, 35487396⟩, ⟨(-228691), (-149411)⟩, ⟨(-18654), (-17921)⟩, ⟨90, 144⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12664783, 28807758⟩, ⟨6146745, 9548682⟩, ⟨714523, 766799⟩, ⟨(-10173), (-6484)⟩, ⟨(-404), (-360)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703163100), (-687020124)⟩, ⟨6146745, 9548682⟩, ⟨714523, 766799⟩, ⟨(-10173), (-6484)⟩, ⟨(-404), (-360)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-570809770), (-247869028)⟩, ⟨(-188052250), (-116183138)⟩, ⟨(-14489200), (-12285554)⟩, ⟨259240, 420467⟩, ⟨13030, 15993⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3724157526, 4047098268⟩, ⟨(-188052250), (-116183138)⟩, ⟨(-14489200), (-12285554)⟩, ⟨259240, 420467⟩, ⟨13030, 15993⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨791012581, 1244702829⟩, ⟨163581168, 193051742⟩, ⟨(-8388609), (-5206494)⟩, ⟨(-426033), (-347125)⟩, ⟨6924, 11218⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4558017337, 4953266329⟩, ⟨130850481, 250116402⟩, ⟨17592946, 31900860⟩, ⟨387656, 2266661⟩, ⟨18972, 213515⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨839459024, 1435481155⟩, ⟨197698868, 295126180⟩, ⟨(-1450559), 14961980⟩, ⟨(-238390), 1563776⟩, ⟨(-61511), 144798⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1231764409), (-821176272)⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3063202887, 3473791024⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨164073764, 479772256⟩, ⟨77281192, 197276506⟩, ⟨8130525, 30280730⟩, ⟨(-358702), 3101512⟩, ⟨(-78934), 363820⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4459041060, 4774739552⟩, ⟨77281192, 197276506⟩, ⟨8130525, 30280730⟩, ⟨(-358702), 3101512⟩, ⟨(-78934), 363820⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4376235314, 4528504193⟩, ⟨36647883, 96806511⟩, ⟨2820891, 14705754⟩, ⟨(-501327), 1498336⟩, ⟨(-96588), 188714⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3121163846, 3662676834⟩, ⟨(-190319296), (-130880986)⟩, ⟨(-2615351), 10142366⟩, ⟨(-1108393), 1077027⟩, ⟨(-149740), 176596⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4222026016, 6333039032⟩, ⟨1055506504, 1055506510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4150323495, 9338227888⟩, ⟨2075161746, 3112742644⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4150323495, 9338227888⟩, ⟨2075161746, 3112742644⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9338227888), (-4150323495)⟩, ⟨(-3112742644), (-2075161746)⟩, ⟨(-259395222), (-259395218)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4669113944), (-2075161747)⟩, ⟨(-1556371322), (-1037580873)⟩, ⟨(-129697611), (-129697609)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1448214085, 2649266201⟩, ⟨(-960017075), (-349860460)⟩, ⟨(-37741670), 130208587⟩, ⟨(-8684644), 23885623⟩, ⟨(-4129856), 1356620⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1052420922, 2259250251⟩, ⟨(-936081349), (-298376079)⟩, ⟨(-23137364), 159836278⟩, ⟨(-16126673), 23290609⟩, ⟨(-5002527), 2205902⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1026470340, 1026470341⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4437995487, 4437995491⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified240
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨821176272, 1231764409⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4376235314, 4528504193⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified241
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (38343475 / 1073741824)

theorem envelope_integral : (∫ s in ((38239 / 200000) : ℝ)..(114717 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((38239 / 200000) : ℝ)..(114717 / 400000), prawitzNormalCorrection
