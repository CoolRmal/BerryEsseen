...
namespace FiniteNormalPanel153_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (13321 / 80000)
def radius : Rat := (13321 / 400000)

def j0 : Jet := ⟨⟨715165741, 715165742⟩, ⟨143033148, 143033149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2246759437, 2246759442⟩, ⟨449351886, 449351891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1175312317, 1175312324⟩, ⟨470124924, 470124932⟩, ⟨47012492, 47012494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨294, 295⟩, ⟨117, 118⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94393), (-94391)⟩, ⟨117, 118⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-25831), (-25829)⟩, ⟨(-10301), (-10298)⟩, ⟨(-1019), (-1016)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5087225, 5087228⟩, ⟨(-10301), (-10298)⟩, ⟨(-1019), (-1016)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1392112, 1392114⟩, ⟨554026, 554028⟩, ⟨54277, 54280⟩, ⟨(-225), (-221)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-141773465), (-141773462)⟩, ⟨554026, 554028⟩, ⟨54277, 54280⟩, ⟨(-225), (-221)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-38796128), (-38796126)⟩, ⟨(-15366844), (-15366840)⟩, ⟨(-1476351), (-1476347)⟩, ⟨11943, 11947⟩, ⟨565, 569⟩⟩
...
def j19 : Jet := ⟨⟨1392859637, 1392859640⟩, ⟨(-15366844), (-15366840)⟩, ⟨(-1476351), (-1476347)⟩, ⟨11943, 11947⟩, ⟨565, 569⟩⟩
...
def j25 : Jet := ⟨⟨3230, 3231⟩, ⟨1288, 1290⟩, ⟨126, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848947), (-848945)⟩, ⟨1288, 1290⟩, ⟨126, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-232314), (-232312)⟩, ⟨(-92574), (-92571)⟩, ⟨(-9119), (-9114)⟩, ⟨26, 30⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35559080, 35559083⟩, ⟨(-92574), (-92571)⟩, ⟨(-9119), (-9114)⟩, ⟨26, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9730696, 9730698⟩, ⟨3866945, 3866949⟩, ⟨376597, 376602⟩, ⟨(-2006), (-2001)⟩, ⟨(-99), (-94)⟩⟩
...
def j33 : Jet := ⟨⟨(-706097187), (-706097184)⟩, ⟨3866945, 3866949⟩, ⟨376597, 376602⟩, ⟨(-2006), (-2001)⟩, ⟨(-99), (-94)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-193222595), (-193222592)⟩, ⟨(-76230855), (-76230850)⟩, ⟨(-7202576), (-7202571)⟩, ⟨83000, 83004⟩, ⟨3874, 3879⟩⟩
...
def j36 : Jet := ⟨⟨4101744701, 4101744704⟩, ⟨(-76230855), (-76230850)⟩, ⟨(-7202576), (-7202571)⟩, ⟨83000, 83004⟩, ⟨3874, 3879⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨728624997, 728625001⟩, ⟨137686379, 137686386⟩, ⟨(-2380025), (-2380021)⟩, ⟨(-148214), (-148209)⟩, ⟨1544, 1548⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4497292104, 4497292109⟩, ⟨83582090, 83582098⟩, ⟨9450514, 9450522⟩, ⟨231396, 231405⟩, ⟨14949, 14959⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨762948637, 762948643⟩, ⟨158351814, 158351824⟩, ⟨1790543, 1790552⟩, ⟨140702, 140713⟩, ⟨3448, 3458⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-715165742), (-715165741)⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3579801554, 3579801555⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨135528534, 135528537⟩, ⟨56258542, 56258548⟩, ⟨6474433, 6474439⟩, ⟨182016, 182026⟩, ⟨12344, 12353⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4430495830, 4430495833⟩, ⟨56258542, 56258548⟩, ⟨6474433, 6474439⟩, ⟨182016, 182026⟩, ⟨12344, 12353⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4362205255, 4362205258⟩, ⟨27695693, 27695697⟩, ⟨3099398, 3099402⟩, ⟨69926, 69933⟩, ⟨4531, 4538⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3635843552, 3635843556⟩, ⟨(-122188329), (-122188322)⟩, ⟨1660973, 1660978⟩, ⟨(-44936), (-44928)⟩, ⟨1447, 1455⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨54102263868, 54102263876⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value629

def j47 : Jet := ⟨⟨9008703201, 9008703216⟩, ⟨1801740637, 1801740651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨18895774465, 18895774529⟩, ⟨7558309772, 7558309846⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨18895774465, 18895774529⟩, ⟨7558309772, 7558309846⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-18895774529), (-18895774465)⟩, ⟨(-7558309846), (-7558309772)⟩, ⟨(-755830988), (-755830975)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9447887265), (-9447887232)⟩, ⟨(-3779154923), (-3779154886)⟩, ⟨(-377915494), (-377915487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨476011272, 476011287⟩, ⟨(-418843795), (-418843777)⟩, ⟨142386581, 142386594⟩, ⟨(-17192673), (-17192666)⟩, ⟨(-2482351), (-2482347)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨402960580, 402960594⟩, ⟨(-368108401), (-368108382)⟩, ⟨132635186, 132635202⟩, ⟨(-18771957), (-18771945)⟩, ⟨(-1552677), (-1552667)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨572132593, 858198891⟩, ⟨143033148, 143033149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1797407550, 2696111332⟩, ⟨449351886, 449351891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨752199883, 1692449748⟩, ⟨376099940, 564149920⟩, ⟨47012492, 47012494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨188, 425⟩, ⟨94, 142⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94499), (-94261)⟩, ⟨94, 142⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-37238), (-16508)⟩, ⟨(-12397), (-8198)⟩, ⟨(-1026), (-1007)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5075818, 5096549⟩, ⟨(-12397), (-8198)⟩, ⟨(-1026), (-1007)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨888954, 2008317⟩, ⟨439591, 668004⟩, ⟨53525, 54894⟩, ⟨(-271), (-175)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142276623), (-141157259)⟩, ⟨439591, 668004⟩, ⟨53525, 54894⟩, ⟨(-271), (-175)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-56064696), (-24721602)⟩, ⟨(-18611246), (-12097571)⟩, ⟨(-1509486), (-1435724)⟩, ⟨9391, 14493⟩, ⟨544, 585⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1375591069, 1406934164⟩, ⟨(-18611246), (-12097571)⟩, ⟨(-1509486), (-1435724)⟩, ⟨9391, 14493⟩, ⟨544, 585⟩⟩
...
def j70 : Jet := ⟨⟨(-43), (-18)⟩, ⟨(-15), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11792, 11818⟩, ⟨(-15), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2065, 4657⟩, ⟨1026, 1552⟩, ⟨126, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850112), (-847519)⟩, ⟨1026, 1552⟩, ⟨126, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-334991), (-148430)⟩, ⟨(-111485), (-73603)⟩, ⟨(-9195), (-9020)⟩, ⟨21, 35⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35456403, 35642965⟩, ⟨(-111485), (-73603)⟩, ⟨(-9195), (-9020)⟩, ⟨21, 35⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6209663, 14045259⟩, ⟨3060899, 4668863⟩, ⟨369835, 382123⟩, ⟨(-2426), (-1580)⟩, ⟨(-101), (-92)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709618220), (-701782623)⟩, ⟨3060899, 4668863⟩, ⟨369835, 382123⟩, ⟨(-2426), (-1580)⟩, ⟨(-101), (-92)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-279628015), (-122906828)⟩, ⟨(-92673268), (-59613628)⟩, ⟨(-7434640), (-6917836)⟩, ⟨64933, 101023⟩, ⟨3689, 4029⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4015339281, 4172060468⟩, ⟨(-92673268), (-59613628)⟩, ⟨(-7434640), (-6917836)⟩, ⟨64933, 101023⟩, ⟨3689, 4029⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨575673247, 883185106⟩, ⟨132235337, 142134788⟩, ⟨(-2894724), (-1866520)⟩, ⟨(-153997), (-141111)⟩, ⟨1209, 1885⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4421494898, 4594068592⟩, ⟨63177739, 106030232⟩, ⟨8234163, 10953351⟩, ⟨111170, 377624⟩, ⟨8236, 23916⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨592632294, 944690071⟩, ⟨144598912, 173836316⟩, ⟨(-47510), 3839754⟩, ⟨32232, 267412⟩, ⟨(-5416), 13779⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-858198891), (-572132593)⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3436768405, 3722834703⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨81773157, 207787224⟩, ⟨39904370, 76471568⟩, ⟨4847319, 8725055⟩, ⟨5048, 428462⟩, ⟨(-257), 31143⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4376740453, 4502754520⟩, ⟨39904370, 76471568⟩, ⟨4847319, 8725055⟩, ⟨5048, 428462⟩, ⟨(-257), 31143⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4335661092, 4397633842⟩, ⟨19486384, 37876910⟩, ⟨2203959, 4277792⟩, ⟨(-34872), 202316⟩, ⟨(-4007), 15171⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3469330970, 3811825039⟩, ⟨(-130859490), (-111557026)⟩, ⟨502178, 3059003⟩, ⟨(-172689), 101969⟩, ⟨(-10212), 14313⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7206962563, 10810443866⟩, ⟨1801740637, 1801740651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12093295665, 27209915356⟩, ⟨6046647820, 9069971820⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12093295665, 27209915356⟩, ⟨6046647820, 9069971820⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-27209915356), (-12093295665)⟩, ⟨(-9069971820), (-6046647820)⟩, ⟨(-755830988), (-755830975)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13604957678), (-6046647832)⟩, ⟨(-4534985910), (-3023323910)⟩, ⟨(-377915494), (-377915487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨180828335, 1050849665⟩, ⟨(-1109575021), (-127289124)⟩, ⟨(-47663750), 569879943⟩, ⟨(-193108840), 81863691⟩, ⟨(-46681590), 53072093⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨146067082, 932639248⟩, ⟨(-1016775961), (-107516714)⟩, ⟨(-38974704), 540329054⟩, ⟨(-189581649), 74117109⟩, ⟨(-43987385), 53439659⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨715165741, 715165742⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4362205255, 4362205258⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar629 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3082
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar629 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨572132593, 858198891⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4335661092, 4397633842⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3083
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((13321 / 100000) : ℝ)..(39963 / 200000), prawitzNormalCorrection
      ((152757 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
