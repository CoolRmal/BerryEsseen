...
namespace FiniteNormalPanel57_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (58289 / 200000)
def radius : Rat := (8327 / 200000)

def j0 : Jet := ⟨⟨1251746743, 1251746744⟩, ⟨178820963, 178820964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3932478371, 3932478376⟩, ⟨561782623, 561782627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3600582978, 3600582988⟩, ⟨1028737990, 1028738000⟩, ⟨73481284, 73481286⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨901, 903⟩, ⟨257, 258⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93786), (-93783)⟩, ⟨257, 258⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-78624), (-78620)⟩, ⟨(-22249), (-22246)⟩, ⟨(-1529), (-1526)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5034432, 5034437⟩, ⟨(-22249), (-22246)⟩, ⟨(-1529), (-1526)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4220495, 4220500⟩, ⟨1187203, 1187209⟩, ⟨79520, 79526⟩, ⟨(-742), (-736)⟩, ⟨(-26), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-138945082), (-138945076)⟩, ⟨1187203, 1187209⟩, ⟨79520, 79526⟩, ⟨(-742), (-736)⟩, ⟨(-26), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-116481283), (-116481277)⟩, ⟨(-32285104), (-32285095)⟩, ⟨(-2026147), (-2026136)⟩, ⟨38734, 38744⟩, ⟨1160, 1167⟩⟩
...
def j19 : Jet := ⟨⟨1315174482, 1315174489⟩, ⟨(-32285104), (-32285095)⟩, ⟨(-2026147), (-2026136)⟩, ⟨38734, 38744⟩, ⟨1160, 1167⟩⟩
...
def j22 : Jet := ⟨⟨(-91), (-89)⟩, ⟨(-26), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11744, 11747⟩, ⟨(-26), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9845, 9848⟩, ⟨2790, 2794⟩, ⟨191, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842332), (-842328)⟩, ⟨2790, 2794⟩, ⟨191, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-706149), (-706145)⟩, ⟨(-199419), (-199412)⟩, ⟨(-13584), (-13576)⟩, ⟨90, 95⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35085245, 35085250⟩, ⟨(-199419), (-199412)⟩, ⟨(-13584), (-13576)⟩, ⟨90, 95⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29412874, 29412880⟩, ⟨8236499, 8236508⟩, ⟨541108, 541119⟩, ⟨(-6591), (-6582)⟩, ⟨(-212), (-205)⟩⟩
...
def j33 : Jet := ⟨⟨(-686415009), (-686415002)⟩, ⟨8236499, 8236508⟩, ⟨541108, 541119⟩, ⟨(-6591), (-6582)⟩, ⟨(-212), (-205)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-575439587), (-575439578)⟩, ⟨(-157506440), (-157506427)⟩, ⟨(-9317222), (-9317206)⟩, ⟨264996, 265009⟩, ⟨7500, 7511⟩⟩
...
def j36 : Jet := ⟨⟨3719527709, 3719527718⟩, ⟨(-157506440), (-157506427)⟩, ⟨(-9317222), (-9317206)⟩, ⟨264996, 265009⟩, ⟨7500, 7511⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1204175689, 1204175698⟩, ⟨142464809, 142464821⟩, ⟨(-6078043), (-6078030)⟩, ⟨(-229557), (-229544)⟩, ⟨6128, 6137⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4959431807, 4959431820⟩, ⟨210011174, 210011194⟩, ⟨21316188, 21316214⟩, ⟨1075366, 1075390⟩, ⟨73952, 73976⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1390470939, 1390470955⟩, ⟨223385833, 223385857⟩, ⟨5924141, 5924167⟩, ⟨446289, 446317⟩, ⟨22088, 22110⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1251746744), (-1251746743)⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3043220552, 3043220553⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨450156962, 450156973⟩, ⟨144639754, 144639774⟩, ⟨15454347, 15454369⟩, ⟨905206, 905232⟩, ⟨68893, 68916⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4745124258, 4745124269⟩, ⟨144639754, 144639774⟩, ⟨15454347, 15454369⟩, ⟨905206, 905232⟩, ⟨68893, 68916⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4514438337, 4514438343⟩, ⟨68804020, 68804030⟩, ⟨6827197, 6827209⟩, ⟨326546, 326560⟩, ⟨22631, 22644⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3198727855, 3198727861⟩, ⟨(-139207210), (-139207199)⟩, ⟨1972788, 1972799⟩, ⟨(-52876), (-52864)⟩, ⟨2438, 2450⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨28721221474, 28721221480⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value319

def j47 : Jet := ⟨⟨8370656388, 8370656398⟩, ⟨1195808053, 1195808061⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16313951547, 16313951587⟩, ⟨4661129004, 4661129042⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16313951547, 16313951587⟩, ⟨4661129004, 4661129042⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16313951587), (-16313951547)⟩, ⟨(-4661129042), (-4661129004)⟩, ⟨(-332937790), (-332937785)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8156975794), (-8156975773)⟩, ⟨(-2330564521), (-2330564502)⟩, ⟨(-166468895), (-166468892)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨642910351, 642910361⟩, ⟨(-348860416), (-348860407)⟩, ⟨69731907, 69731913⟩, ⟨(-3598469), (-3598466)⟩, ⟨(-863216), (-863215)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨478815112, 478815121⟩, ⟨(-280655756), (-280655745)⟩, ⟨63536129, 63536138⟩, ⟨(-5108291), (-5108282)⟩, ⟨(-489573), (-489564)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1072925780, 1430567707⟩, ⟨178820963, 178820964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3370695748, 4494260999⟩, ⟨561782623, 561782627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2645326272, 4702802265⟩, ⟨881775420, 1175700572⟩, ⟨73481284, 73481286⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨662, 1179⟩, ⟨220, 295⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94025), (-93507)⟩, ⟨220, 295⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-102954), (-57592)⟩, ⟨(-25604), (-18873)⟩, ⟨(-1553), (-1497)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5010102, 5055465⟩, ⟨(-25604), (-18873)⟩, ⟨(-1553), (-1497)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3085787, 5535515⟩, ⟨1000559, 1372255⟩, ⟨77006, 81697⟩, ⟨(-862), (-615)⟩, ⟨(-26), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140079790), (-137630061)⟩, ⟨1000559, 1372255⟩, ⟨77006, 81697⟩, ⟨(-862), (-615)⟩, ⟨(-26), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-153381274), (-84768146)⟩, ⟨(-37729062), (-26753488)⟩, ⟨(-2143736), (-1889575)⟩, ⟨31983, 45464⟩, ⟨1052, 1261⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1278274491, 1346887620⟩, ⟨(-37729062), (-26753488)⟩, ⟨(-2143736), (-1889575)⟩, ⟨31983, 45464⟩, ⟨1052, 1261⟩⟩
...
def j70 : Jet := ⟨⟨(-119), (-65)⟩, ⟨(-30), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11716, 11771⟩, ⟨(-30), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7216, 12889⟩, ⟨2372, 3211⟩, ⟨188, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844961), (-839287)⟩, ⟨2372, 3211⟩, ⟨188, 198⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-925196), (-516927)⟩, ⟨(-229839), (-168793)⟩, ⟨(-13856), (-13263)⟩, ⟨75, 110⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34866198, 35274468⟩, ⟨(-229839), (-168793)⟩, ⟨(-13856), (-13263)⟩, ⟨75, 110⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21474545, 38624008⟩, ⟨6906517, 9552041⟩, ⟨518427, 560680⟩, ⟨(-7680), (-5488)⟩, ⟨(-223), (-190)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694353338), (-677203874)⟩, ⟨6906517, 9552041⟩, ⟨518427, 560680⟩, ⟨(-7680), (-5488)⟩, ⟨(-223), (-190)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-760286686), (-417098682)⟩, ⟨(-185817860), (-128573823)⟩, ⟨(-10142238), (-8357385)⟩, ⟨216186, 313524⟩, ⟨6521, 8350⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3534680610, 3877868614⟩, ⟨(-185817860), (-128573823)⟩, ⟨(-10142238), (-8357385)⟩, ⟨216186, 313524⟩, ⟨6521, 8350⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1003191431, 1409385470⟩, ⟨127718817, 155177014⟩, ⟨(-7178179), (-4982301)⟩, ⟨(-255302), (-199582)⟩, ⟨5008, 7267⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4756928588, 5218786677⟩, ⟨157719756, 274351174⟩, ⟨15481212, 29397149⟩, ⟨431263, 2041677⟩, ⟨14242, 173263⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1111093442, 1712535069⟩, ⟨178295280, 278582400⟩, ⟨(-416066), 14040728⟩, ⟨(-207647), 1328083⟩, ⟨(-43745), 114166⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1430567707), (-1072925780)⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2864399589, 3222041516⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨287436097, 682840209⟩, ⟨92248764, 222158680⟩, ⟨7069703, 29266495⟩, ⟨(-219568), 2880530⟩, ⟨(-63185), 309231⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4582403393, 4977807505⟩, ⟨92248764, 222158680⟩, ⟨7069703, 29266495⟩, ⟨(-219568), 2880530⟩, ⟨(-63185), 309231⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4436358045, 4623799352⟩, ⟨42844141, 107539141⟩, ⟨2032903, 13959990⟩, ⟨(-444682), 1374730⟩, ⟨(-85875), 160003⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2958695907, 3468728037⟩, ⟨(-163938273), (-104032977)⟩, ⟨(-3121610), 8688830⟩, ⟨(-914821), 946670⟩, ⟨(-121660), 138548⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7174848334, 9566464451⟩, ⟨1195808053, 1195808061⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11985760325, 21308018382⟩, ⟨3995253432, 5327004618⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11985760325, 21308018382⟩, ⟨3995253432, 5327004618⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21308018382), (-11985760325)⟩, ⟨(-5327004618), (-3995253432)⟩, ⟨(-332937790), (-332937785)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10654009191), (-5992880162)⟩, ⟨(-2663502309), (-1997626716)⟩, ⟨(-166468895), (-166468892)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨359465925, 1064087687⟩, ⟨(-659888613), (-167190734)⟩, ⟨(-2362105), 190680737⟩, ⟨(-35096463), 17539391⟩, ⟨(-6414545), 5487001⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨247627115, 859385076⟩, ⟨(-573559393), (-123880534)⟩, ⟨1368620, 181339285⟩, ⟨(-37184700), 14969586⟩, ⟨(-6164210), 6331708⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1251746743, 1251746744⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4514438337, 4514438343⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar319 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1128
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar319 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1072925780, 1430567707⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4436358045, 4623799352⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1129
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((24981 / 100000) : ℝ)..(8327 / 25000), prawitzNormalCorrection
      ((273003 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
