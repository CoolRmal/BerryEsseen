...
namespace FiniteNormalPanel56_16

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (33163 / 800000)
def radius : Rat := (33163 / 800000)

def j0 : Jet := ⟨⟨178042500, 178042501⟩, ⟨178042500, 178042501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨559337010, 559337014⟩, ⟨559337010, 559337014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨72842904, 72842906⟩, ⟨145685808, 145685812⟩, ⟨72842904, 72842906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨18, 19⟩, ⟨36, 37⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94669), (-94667)⟩, ⟨36, 37⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1606), (-1605)⟩, ⟨(-3212), (-3210)⟩, ⟨(-1605), (-1602)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111450, 5111452⟩, ⟨(-3212), (-3210)⟩, ⟨(-1605), (-1602)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨86690, 86691⟩, ⟨173325, 173328⟩, ⟨86553, 86556⟩, ⟨(-110), (-107)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-143078887), (-143078885)⟩, ⟨173325, 173328⟩, ⟨86553, 86556⟩, ⟨(-110), (-107)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2426627), (-2426626)⟩, ⟨(-4850315), (-4850313)⟩, ⟨(-2419281), (-2419278)⟩, ⟨5872, 5875⟩, ⟨1462, 1465⟩⟩
...
def j19 : Jet := ⟨⟨1429229138, 1429229140⟩, ⟨(-4850315), (-4850313)⟩, ⟨(-2419281), (-2419278)⟩, ⟨5872, 5875⟩, ⟨1462, 1465⟩⟩
...
def j25 : Jet := ⟨⟨200, 201⟩, ⟨400, 402⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851977), (-851975)⟩, ⟨400, 402⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14450), (-14449)⟩, ⟨(-28894), (-28892)⟩, ⟨(-14434), (-14431)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35776944, 35776946⟩, ⟨(-28894), (-28892)⟩, ⟨(-14434), (-14431)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨606779, 606780⟩, ⟨1213067, 1213069⟩, ⟨605553, 605556⟩, ⟨(-981), (-978)⟩, ⟨(-245), (-242)⟩⟩
...
def j33 : Jet := ⟨⟨(-715221104), (-715221102)⟩, ⟨1213067, 1213069⟩, ⟨605553, 605556⟩, ⟨(-981), (-978)⟩, ⟨(-245), (-242)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-12130194), (-12130192)⟩, ⟨(-24239814), (-24239811)⟩, ⟨(-12078777), (-12078773)⟩, ⟨41096, 41099⟩, ⟨10231, 10234⟩⟩
...
def j36 : Jet := ⟨⟨4282837102, 4282837104⟩, ⟨(-24239814), (-24239811)⟩, ⟨(-12078777), (-12078773)⟩, ⟨41096, 41099⟩, ⟨10231, 10234⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨186129648, 186129650⟩, ⟨185497987, 185497990⟩, ⟨(-946726), (-946724)⟩, ⟨(-314301), (-314298)⟩, ⟨954, 957⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4307131844, 4307131847⟩, ⟨24377312, 24377317⟩, ⟨12285259, 12285267⟩, ⟨96948, 96955⟩, ⟨24668, 24676⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨186656819, 186656822⟩, ⟨187079800, 187079806⟩, ⟨635840, 635845⟩, ⟨214230, 214237⟩, ⟨1719, 1728⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-178042501), (-178042500)⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4116924795, 4116924796⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8111998, 8111999⟩, ⟨16260760, 16260764⟩, ⟨8204071, 8204074⟩, ⟨74010, 74016⟩, ⟨18904, 18911⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303079294, 4303079295⟩, ⟨16260760, 16260764⟩, ⟨8204071, 8204074⟩, ⟨74010, 74016⟩, ⟨18904, 18911⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299021381, 4299021383⟩, ⟨8122712, 8122715⟩, ⟨4090493, 4090496⟩, ⟨29240, 29245⟩, ⟨7440, 7446⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4120810822, 4120810826⟩, ⟨(-170424564), (-170424558)⟩, ⟨3584209, 3584214⟩, ⟨(-141540), (-141533)⟩, ⟨5918, 5926⟩⟩
...
def j47 : Jet := ⟨⟨1217741660, 1217741668⟩, ⟨1217741660, 1217741668⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨345263339, 345263344⟩, ⟨690526678, 690526688⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨345263339, 345263344⟩, ⟨690526678, 690526688⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-345263344), (-345263339)⟩, ⟨(-690526688), (-690526678)⟩, ⟨(-345263344), (-345263339)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-172631672), (-172631669)⟩, ⟨(-345263344), (-345263339)⟩, ⟨(-172631672), (-172631669)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4125758978, 4125758982⟩, ⟨(-331661046), (-331661040)⟩, ⟨(-152499759), (-152499754)⟩, ⟨12973553, 12973555⟩, ⟨2804053, 2804055⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3958463725, 3958463734⟩, ⟨(-481922903), (-481922889)⟩, ⟨(-129712721), (-129712707)⟩, ⟨18085946, 18085959⟩, ⟨2064908, 2064923⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 356085002⟩, ⟨178042500, 178042501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1118674027⟩, ⟨559337010, 559337014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 291371620⟩, ⟨0, 291371622⟩, ⟨72842904, 72842906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 73⟩, ⟨0, 73⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94613)⟩, ⟨0, 73⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6424), 0⟩, ⟨(-6424), 5⟩, ⟨(-1606), (-1597)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106632, 5113057⟩, ⟨(-6424), 5⟩, ⟨(-1606), (-1597)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 346872⟩, ⟨(-436), 346873⟩, ⟨86063, 86719⟩, ⟨(-218), 2⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142818704)⟩, ⟨(-436), 346873⟩, ⟨86063, 86719⟩, ⟨(-218), 2⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9712388), 0⟩, ⟨(-9712418), 23532⟩, ⟨(-2428127), (-2392797)⟩, ⟨(-23), 11768⟩, ⟨1442, 1472⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421943377, 1431655766⟩, ⟨(-9712418), 23532⟩, ⟨(-2428127), (-2392797)⟩, ⟨(-23), 11768⟩, ⟨1442, 1472⟩⟩
...
def j72 : Jet := ⟨⟨0, 803⟩, ⟨(-1), 803⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851373)⟩, ⟨(-1), 803⟩, ⟨198, 201⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-57812), 0⟩, ⟨(-57813), 55⟩, ⟨(-14454), (-14370)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35733582, 35791395⟩, ⟨(-57813), 55⟩, ⟨(-14454), (-14370)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2428097⟩, ⟨(-3923), 2428101⟩, ⟨601139, 607029⟩, ⟨(-1963), 3⟩, ⟨(-247), (-240)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713399785)⟩, ⟨(-3923), 2428101⟩, ⟨601139, 607029⟩, ⟨(-1963), 3⟩, ⟨(-247), (-240)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-48561937), 0⟩, ⟨(-48562205), 164723⟩, ⟨(-12140752), (-11893399)⟩, ⟨(-201), 82363⟩, ⟨10044, 10297⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4246405359, 4294967296⟩, ⟨(-48562205), 164723⟩, ⟨(-12140752), (-11893399)⟩, ⟨(-201), 82363⟩, ⟨10044, 10297⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 372891343⟩, ⟨182651105, 186451802⟩, ⟨(-1897290), 3065⟩, ⟨(-316223), (-308549)⟩, ⟨(-3), 1917⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4344084588⟩, ⟨(-168513), 49679272⟩, ⟨11891493, 12988161⟩, ⟨(-85245), 290778⟩, ⟨20597, 30306⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 377155733⟩, ⟨182636474, 192897248⟩, ⟨(-1926304), 3287403⟩, ⟨156518, 280611⟩, ⟨(-13101), 17218⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-356085002), 0⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3938882294, 4294967296⟩, ⟨(-178042501), (-178042500)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 33119332⟩, ⟨0, 33877932⟩, ⟨7428005, 9240835⟩, ⟨(-173030), 344576⟩, ⟨9533, 30747⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4328086628⟩, ⟨0, 33877932⟩, ⟨7428005, 9240835⟩, ⟨(-173030), 344576⟩, ⟨9533, 30747⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311495161⟩, ⟨0, 16938966⟩, ⟨3666490, 4620418⟩, ⟨(-104738), 172288⟩, ⟨1594, 14223⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3938882294, 4311495161⟩, ⟨(-178727643), (-161103534)⟩, ⟨2660326, 4620418⟩, ⟨(-296272), 20299⟩, ⟨(-5681), 18565⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2435483335⟩, ⟨1217741660, 1217741668⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1381053374⟩, ⟨0, 1381053376⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1381053374⟩, ⟨0, 1381053376⟩, ⟨345263339, 345263344⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1381053374), 0⟩, ⟨(-1381053376), 0⟩, ⟨(-345263344), (-345263339)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-690526687), 0⟩, ⟨(-690526688), 0⟩, ⟨(-172631672), (-172631669)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3657091530, 4294967296⟩, ⟨(-690526688), 0⟩, ⟨(-172631672), (-91482945)⟩, ⟨0, 27754991⟩, ⟨722947, 3469374⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3353891213, 4311495161⟩, ⟨(-871911612), (-137176916)⟩, ⟨(-171030771), (-50542828)⟩, ⟨2392386, 35065866⟩, ⟨(-686625), 3492259⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨178042500, 178042501⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299021381, 4299021383⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1114
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 356085002⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311495161⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1115
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (324659521 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(33163 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (33163 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(33163 / 400000), prawitzNormalCorrection
