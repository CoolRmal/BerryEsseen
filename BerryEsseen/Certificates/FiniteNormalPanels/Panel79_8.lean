...
namespace FiniteNormalPanel79_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (15733 / 80000)
def radius : Rat := (15733 / 400000)

def j0 : Jet := ⟨⟨844659005, 844659006⟩, ⟨168931801, 168931802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2653574524, 2653574529⟩, ⟨530714904, 530714909⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1639467141, 1639467148⟩, ⟨655786854, 655786864⟩, ⟨65578685, 65578687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨410, 411⟩, ⟨164, 165⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94277), (-94275)⟩, ⟨164, 165⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-35988), (-35986)⟩, ⟨(-14333), (-14331)⟩, ⟨(-1409), (-1406)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5077068, 5077071⟩, ⟨(-14333), (-14331)⟩, ⟨(-1409), (-1406)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1938009, 1938011⟩, ⟨769731, 769735⟩, ⟨74793, 74797⟩, ⟨(-434), (-429)⟩, ⟨(-22), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-141227568), (-141227565)⟩, ⟨769731, 769735⟩, ⟨74793, 74797⟩, ⟨(-434), (-429)⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-53909132), (-53909130)⟩, ⟨(-21269833), (-21269830)⟩, ⟨(-2010289), (-2010284)⟩, ⟨23005, 23011⟩, ⟨1065, 1071⟩⟩
...
def j19 : Jet := ⟨⟨1377746633, 1377746636⟩, ⟨(-21269833), (-21269830)⟩, ⟨(-2010289), (-2010284)⟩, ⟨23005, 23011⟩, ⟨1065, 1071⟩⟩
...
def j22 : Jet := ⟨⟨(-42), (-40)⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11793, 11796⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4501, 4503⟩, ⟨1793, 1796⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847676), (-847673)⟩, ⟨1793, 1796⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-323574), (-323572)⟩, ⟨(-128746), (-128742)⟩, ⟨(-12603), (-12598)⟩, ⟨52, 56⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35467820, 35467823⟩, ⟨(-128746), (-128742)⟩, ⟨(-12603), (-12598)⟩, ⟨52, 56⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13538712, 13538714⟩, ⟨5366339, 5366343⟩, ⟨517079, 517084⟩, ⟨(-3872), (-3866)⟩, ⟨(-186), (-181)⟩⟩
...
def j33 : Jet := ⟨⟨(-702289171), (-702289168)⟩, ⟨5366339, 5366343⟩, ⟨517079, 517084⟩, ⟨(-3872), (-3866)⟩, ⟨(-186), (-181)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-268076553), (-268076549)⟩, ⟨(-105182193), (-105182188)⟩, ⟨(-9706314), (-9706307)⟩, ⟨159409, 159416⟩, ⟨7232, 7237⟩⟩
...
def j36 : Jet := ⟨⟨4026890743, 4026890747⟩, ⟨(-105182193), (-105182188)⟩, ⟨(-9706314), (-9706307)⟩, ⟨159409, 159416⟩, ⟨7232, 7237⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨851217975, 851217979⟩, ⟨157102379, 157102385⟩, ⟨(-3870267), (-3870262)⟩, ⟨(-234192), (-234187)⟩, ⟨3499, 3506⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4580890129, 4580890134⟩, ⟨119652624, 119652631⟩, ⟨14166971, 14166982⟩, ⟨477098, 477111⟩, ⟨33637, 33650⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨907884915, 907884921⟩, ⟨191274844, 191274853⟩, ⟨3056512, 3056522⟩, ⟨255153, 255166⟩, ⟨8556, 8572⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-844659006), (-844659005)⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3450308290, 3450308291⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨191911826, 191911830⟩, ⟨80864664, 80864670⟩, ⟨9810547, 9810557⟩, ⟨380110, 380120⟩, ⟨28517, 28528⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4486879122, 4486879126⟩, ⟨80864664, 80864670⟩, ⟨9810547, 9810557⟩, ⟨380110, 380120⟩, ⟨28517, 28528⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4389874609, 4389874612⟩, ⟨39558201, 39558205⟩, ⟨4620988, 4620995⟩, ⟨144304, 144312⟩, ⟨10216, 10224⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3526550893, 3526550897⟩, ⟨(-140886159), (-140886152)⟩, ⟨2156288, 2156297⟩, ⟨(-65832), (-65823)⟩, ⟨2529, 2539⟩⟩
...
def j47 : Jet := ⟨⟨6262099179, 6262099189⟩, ⟨1252419835, 1252419844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9130194347, 9130194377⟩, ⟨3652077736, 3652077770⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9130194347, 9130194377⟩, ⟨3652077736, 3652077770⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9130194377), (-9130194347)⟩, ⟨(-3652077770), (-3652077736)⟩, ⟨(-365207779), (-365207773)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4565097189), (-4565097173)⟩, ⟨(-1826038885), (-1826038868)⟩, ⟨(-182603890), (-182603886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1483715512, 1483715528⟩, ⟨(-630813243), (-630813230)⟩, ⟨71016259, 71016266⟩, ⟨7815304, 7815307⟩, ⟨(-2340341), (-2340340)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1218262655, 1218262671⟩, ⟨(-566623638), (-566623622)⟩, ⟨79747898, 79747911⟩, ⟨3748097, 3748109⟩, ⟨(-2131799), (-2131788)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨675727204, 1013590808⟩, ⟨168931801, 168931802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2122859619, 3184289437⟩, ⟨530714904, 530714909⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1049258970, 2360832696⟩, ⟨524629484, 786944238⟩, ⟨65578685, 65578687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨262, 592⟩, ⟨131, 198⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94425), (-94094)⟩, ⟨131, 198⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-51903), (-22987)⟩, ⟨(-17269), (-11384)⟩, ⟨(-1423), (-1389)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5061153, 5090070⟩, ⟨(-17269), (-11384)⟩, ⟨(-1423), (-1389)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1236437, 2797881⟩, ⟨608725, 929846⟩, ⟨73329, 75990⟩, ⟨(-525), (-337)⟩, ⟨(-22), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141929140), (-140367695)⟩, ⟨608725, 929846⟩, ⟨73329, 75990⟩, ⟨(-525), (-337)⟩, ⟨(-22), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-78014786), (-34291777)⟩, ⟨(-25856218), (-16634775)⟩, ⟨(-2074809), (-1931095)⟩, ⟨17962, 28040⟩, ⟨1009, 1116⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1353640979, 1397363989⟩, ⟨(-25856218), (-16634775)⟩, ⟨(-2074809), (-1931095)⟩, ⟨17962, 28040⟩, ⟨1009, 1116⟩⟩
...
def j70 : Jet := ⟨⟨(-60), (-26)⟩, ⟨(-20), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11775, 11810⟩, ⟨(-20), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2876, 6492⟩, ⟨1427, 2161⟩, ⟨173, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849301), (-845684)⟩, ⟨1427, 2161⟩, ⟨173, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-466839), (-206600)⟩, ⟨(-155265), (-102112)⟩, ⟨(-12752), (-12417)⟩, ⟨40, 66⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35324555, 35584795⟩, ⟨(-155265), (-102112)⟩, ⟨(-12752), (-12417)⟩, ⟨40, 66⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8629776, 19560044⟩, ⟨4229542, 6495070⟩, ⟨503902, 527830⟩, ⟨(-4699), (-3038)⟩, ⟨(-191), (-174)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707198107), (-696267838)⟩, ⟨4229542, 6495070⟩, ⟨503902, 527830⟩, ⟨(-4699), (-3038)⟩, ⟨(-191), (-174)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-388728551), (-170097983)⟩, ⟨(-128542910), (-81478818)⟩, ⟨(-10158276), (-9150930)⟩, ⟨123547, 195142⟩, ⟨6727, 7647⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3906238745, 4124869313⟩, ⟨(-128542910), (-81478818)⟩, ⟨(-10158276), (-9150930)⟩, ⟨123547, 195142⟩, ⟨6727, 7647⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨669059756, 1036005884⟩, ⟨148095133, 164445633⟩, ⟨(-4733232), (-3009980)⟩, ⟨(-247500), (-217830)⟩, ⟨2717, 4293⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4472079640, 4722380090⟩, ⟨88337285, 155399739⟩, ⟨11666139, 17394426⟩, ⟨203004, 835080⟩, ⟨13783, 62221⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨696649894, 1139103799⟩, ⟨167963129, 218294987⟩, ⟨(-340971), 7011618⟩, ⟨(-9503), 578711⟩, ⟨(-16151), 39049⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1013590808), (-675727204)⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3281376488, 3619240092⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨112997618, 302111140⟩, ⟨54487722, 115791638⟩, ⟨6387663, 14814230⟩, ⟨(-39704), 1019712⟩, ⟨(-10091), 90989⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4407964914, 4597078436⟩, ⟨54487722, 115791638⟩, ⟨6387663, 14814230⟩, ⟨(-39704), 1019712⟩, ⟨(-10091), 90989⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4351099303, 4443456036⟩, ⟨26333442, 57148926⟩, ⟨2719595, 7231872⟩, ⟨(-114583), 486820⟩, ⟨(-17386), 45564⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3324261621, 3744367099⟩, ⟨(-154653355), (-122981927)⟩, ⟨(-170027), 5058322⟩, ⟨(-381004), 303261⟩, ⟨(-33799), 42903⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5009679343, 7514519033⟩, ⟨1252419835, 1252419844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5843324381, 13147479924⟩, ⟨2921662188, 4382493326⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5843324381, 13147479924⟩, ⟨2921662188, 4382493326⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13147479924), (-5843324381)⟩, ⟨(-4382493326), (-2921662188)⟩, ⟨(-365207779), (-365207773)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6573739962), (-2921662190)⟩, ⟨(-2191246663), (-1460831094)⟩, ⟨(-182603890), (-182603886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨929485408, 2175354097⟩, ⟨(-1109842539), (-316142380)⟩, ⟨(-38722719), 243597137⟩, ⟨(-32466198), 38042522⟩, ⟨(-10030585), 4964141⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨719412385, 1896481102⟩, ⟨(-1045894739), (-271305881)⟩, ⟨(-24792308), 254894053⟩, ⟨(-38575671), 34757466⟩, ⟨(-10255625), 5903878⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨844659005, 844659006⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4389874609, 4389874612⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1594
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨675727204, 1013590808⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4351099303, 4443456036⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1595
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (49009321 / 2147483648)

theorem envelope_integral : (∫ s in ((15733 / 100000) : ℝ)..(47199 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((15733 / 100000) : ℝ)..(47199 / 200000), prawitzNormalCorrection
