...
namespace FiniteNormalPanel69_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (32297 / 160000)
def radius : Rat := (32297 / 800000)

def j0 : Jet := ⟨⟨866965992, 866965993⟩, ⟨173393198, 173393199⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2723653991, 2723653995⟩, ⟨544730796, 544730801⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1727205482, 1727205489⟩, ⟨690882190, 690882198⟩, ⟨69088218, 69088221⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨432, 433⟩, ⟨172, 174⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94255), (-94253)⟩, ⟨172, 174⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-37905), (-37903)⟩, ⟨(-15093), (-15091)⟩, ⟨(-1484), (-1480)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5075151, 5075154⟩, ⟨(-15093), (-15091)⟩, ⟨(-1484), (-1480)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2040953, 2040955⟩, ⟨810311, 810314⟩, ⟨78613, 78617⟩, ⟨(-481), (-477)⟩, ⟨(-24), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-141124624), (-141124621)⟩, ⟨810311, 810314⟩, ⟨78613, 78617⟩, ⟨(-481), (-477)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-56752755), (-56752753)⟩, ⟨(-22375239), (-22375236)⟩, ⟨(-2108153), (-2108148)⟩, ⟨25485, 25491⟩, ⟨1176, 1181⟩⟩
...
def j19 : Jet := ⟨⟨1374903010, 1374903013⟩, ⟨(-22375239), (-22375236)⟩, ⟨(-2108153), (-2108148)⟩, ⟨25485, 25491⟩, ⟨1176, 1181⟩⟩
...
def j25 : Jet := ⟨⟨4741, 4743⟩, ⟨1888, 1892⟩, ⟨185, 188⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847436), (-847433)⟩, ⟨1888, 1892⟩, ⟨185, 188⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-340794), (-340792)⟩, ⟨(-135559), (-135555)⟩, ⟨(-13255), (-13250)⟩, ⟨58, 62⟩, ⟨0, 4⟩⟩
...
def j30 : Jet := ⟨⟨35450600, 35450603⟩, ⟨(-135559), (-135555)⟩, ⟨(-13255), (-13250)⟩, ⟨58, 62⟩, ⟨0, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨14256329, 14256332⟩, ⟨5648016, 5648021⟩, ⟨543116, 543121⟩, ⟨(-4291), (-4286)⟩, ⟨(-205), (-201)⟩⟩
...
def j33 : Jet := ⟨⟨(-701571554), (-701571550)⟩, ⟨5648016, 5648021⟩, ⟨543116, 543121⟩, ⟨(-4291), (-4286)⟩, ⟨(-205), (-201)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-282134451), (-282134447)⟩, ⟨(-110582452), (-110582446)⟩, ⟨(-10158436), (-10158429)⟩, ⟨176491, 176497⟩, ⟨7962, 7968⟩⟩
...
def j36 : Jet := ⟨⟨4012832845, 4012832849⟩, ⟨(-110582452), (-110582446)⟩, ⟨(-10158436), (-10158429)⟩, ⟨176491, 176497⟩, ⟨7962, 7968⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨871894897, 871894901⟩, ⟨160189717, 160189723⟩, ⟨(-4174739), (-4174733)⟩, ⟨(-251217), (-251210)⟩, ⟨3977, 3983⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4596938065, 4596938070⟩, ⟨126678750, 126678760⟩, ⟨15127994, 15128004⟩, ⟨535380, 535392⟩, ⟨38348, 38360⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨933196125, 933196132⟩, ⟨197168616, 197168628⟩, ⟨3327530, 3327542⟩, ⟨280900, 280914⟩, ⟨9893, 9908⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-866965993), (-866965992)⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3428001303, 3428001304⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨202761731, 202761736⟩, ⟨85680274, 85680282⟩, ⟨10497387, 10497397⟩, ⟨427578, 427590⟩, ⟨32666, 32677⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4497729027, 4497729032⟩, ⟨85680274, 85680282⟩, ⟨10497387, 10497397⟩, ⟨427578, 427590⟩, ⟨32666, 32677⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4395179072, 4395179075⟩, ⟨41863365, 41863370⟩, ⟨4929650, 4929656⟩, ⟨161960, 161967⟩, ⟨11652, 11660⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3507984705, 3507984710⟩, ⟨(-144025891), (-144025884)⟩, ⟨2244492, 2244499⟩, ⟨(-69750), (-69743)⟩, ⟨2760, 2769⟩⟩
...
def j47 : Jet := ⟨⟨6136081273, 6136081283⟩, ⟨1227216251, 1227216260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8766421440, 8766421469⟩, ⟨3506568564, 3506568598⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8766421440, 8766421469⟩, ⟨3506568564, 3506568598⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8766421469), (-8766421440)⟩, ⟨(-3506568598), (-3506568564)⟩, ⟨(-350656861), (-350656855)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4383210735), (-4383210720)⟩, ⟨(-1753284299), (-1753284282)⟩, ⟨(-175328431), (-175328427)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1547898432, 1547898451⟩, ⟨(-631880493), (-631880478)⟩, ⟨65784539, 65784548⟩, ⟨8244859, 8244862⟩, ⟨(-2184149), (-2184148)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1264271332, 1264271350⟩, ⟨(-568005388), (-568005370)⟩, ⟨75728758, 75728773⟩, ⟨4172775, 4172784⟩, ⟨(-2014789), (-2014779)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨693572793, 1040359191⟩, ⟨173393198, 173393199⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2178923191, 3268384792⟩, ⟨544730796, 544730801⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1105411507, 2487175900⟩, ⟨552705750, 829058638⟩, ⟨69088218, 69088221⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨276, 624⟩, ⟨138, 208⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94411), (-94062)⟩, ⟨138, 208⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-54673), (-24209)⟩, ⟨(-18190), (-11983)⟩, ⟨(-1498), (-1461)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5058383, 5088848⟩, ⟨(-18190), (-11983)⟩, ⟨(-1498), (-1461)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1301894, 2946905⟩, ⟨640413, 979218⟩, ⟨76988, 79941⟩, ⟨(-582), (-375)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141863683), (-140218671)⟩, ⟨640413, 979218⟩, ⟨76988, 79941⟩, ⟨(-582), (-375)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-82151949), (-36088594)⟩, ⟨(-27219159), (-17477240)⟩, ⟨(-2179773), (-2020224)⟩, ⟨19870, 31088⟩, ⟨1110, 1233⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1349503816, 1395567172⟩, ⟨(-27219159), (-17477240)⟩, ⟨(-2179773), (-2020224)⟩, ⟨19870, 31088⟩, ⟨1110, 1233⟩⟩
...
def j70 : Jet := ⟨⟨(-63), (-27)⟩, ⟨(-21), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11772, 11809⟩, ⟨(-21), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3029, 6839⟩, ⟨1501, 2277⟩, ⟨182, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849148), (-845337)⟩, ⟨1501, 2277⟩, ⟨182, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-491734), (-217567)⟩, ⟨(-163526), (-107464)⟩, ⟨(-13421), (-13047)⟩, ⟨45, 74⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35299660, 35573828⟩, ⟨(-163526), (-107464)⟩, ⟨(-13421), (-13047)⟩, ⟨45, 74⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9085203, 20600476⟩, ⟨4447904, 6839168⟩, ⟨528487, 555050⟩, ⟨(-5211), (-3363)⟩, ⟨(-211), (-191)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706742680), (-695227406)⟩, ⟨4447904, 6839168⟩, ⟨528487, 555050⟩, ⟨(-5211), (-3363)⟩, ⟨(-211), (-191)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-409268160), (-178933230)⟩, ⟨(-135277948), (-85506114)⟩, ⟨(-10660157), (-9541734)⟩, ⟨136539, 216291⟩, ⟨7372, 8448⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3885699136, 4116034066⟩, ⟨(-135277948), (-85506114)⟩, ⟨(-10660157), (-9541734)⟩, ⟨136539, 216291⟩, ⟨7372, 8448⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨684630396, 1061998895⟩, ⟨150444358, 168133263⟩, ⟨(-5110971), (-3241538)⟩, ⟨(-266381), (-232567)⟩, ⟨3083, 4882⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4481679154, 4747342352⟩, ⟨93101990, 165275467⟩, ⟨12323458, 18777970⟩, ⟨222367, 949685⟩, ⟨14755, 72808⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨714392814, 1173855815⟩, ⟨171825241, 226709183⟩, ⟨(-423718), 7730667⟩, ⟨(-24005), 656976⟩, ⟨(-19240), 46236⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1040359191), (-693572793)⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3254608105, 3601394503⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨118826770, 320826070⟩, ⟨57160256, 123923596⟩, ⟨6642457, 16192542⟩, ⟨(-57854), 1175242⟩, ⟨(-13817), 108547⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4413794066, 4615793366⟩, ⟨57160256, 123923596⟩, ⟨6642457, 16192542⟩, ⟨(-57854), 1175242⟩, ⟨(-13817), 108547⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4353975328, 4452491612⟩, ⟨27568994, 61122050⟩, ⟨2784196, 7899263⟩, ⟨(-139428), 562029⟩, ⟨(-21872), 54607⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3299322768, 3733481005⟩, ⟨(-158861628), (-124523670)⟩, ⟨(-357787), 5510657⟩, ⟨(-435817), 358869⟩, ⟨(-41031), 51418⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4908865014, 7363297535⟩, ⟨1227216251, 1227216260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5610509711, 12623646900⟩, ⟨2805254850, 4207882316⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5610509711, 12623646900⟩, ⟨2805254850, 4207882316⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12623646900), (-5610509711)⟩, ⟨(-4207882316), (-2805254850)⟩, ⟨(-350656861), (-350656855)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6311823450), (-2805254855)⟩, ⟨(-2103941158), (-1402627425)⟩, ⟨(-175328431), (-175328427)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨987931436, 2235119398⟩, ⟨(-1094900001), (-322633359)⟩, ⟨(-38559730), 227845769⟩, ⟨(-28424004), 36093531⟩, ⟨(-9070754), 4268000⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨758912572, 1942919525⟩, ⟨(-1034434668), (-276484627)⟩, ⟨(-24350879), 241424988⟩, ⟨(-34767241), 33079189⟩, ⟨(-9382261), 5191582⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨866965992, 866965993⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4395179072, 4395179075⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1374
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨693572793, 1040359191⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4353975328, 4452491612⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1375
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (104202443 / 4294967296)

theorem envelope_integral : (∫ s in ((32297 / 200000) : ℝ)..(96891 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((32297 / 200000) : ℝ)..(96891 / 400000), prawitzNormalCorrection
