...
namespace FiniteNormalPanel43_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (15211 / 50000)
def radius : Rat := (2173 / 50000)

def j0 : Jet := ⟨⟨1306614950, 1306614951⟩, ⟨186659278, 186659279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4104851927, 4104851932⟩, ⟨586407416, 586407420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3923151954, 3923151965⟩, ⟨1120900554, 1120900564⟩, ⟨80064325, 80064327⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨981, 983⟩, ⟨280, 281⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93706), (-93703)⟩, ⟨280, 281⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-85594), (-85591)⟩, ⟨(-24201), (-24197)⟩, ⟨(-1656), (-1652)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5027462, 5027466⟩, ⟨(-24201), (-24197)⟩, ⟨(-1656), (-1652)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4592234, 4592239⟩, ⟨1289961, 1289967⟩, ⟨85890, 85898⟩, ⟨(-876), (-871)⟩, ⟨(-29), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-138573343), (-138573337)⟩, ⟨1289961, 1289967⟩, ⟨85890, 85898⟩, ⟨(-876), (-871)⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-126577049), (-126577042)⟩, ⟨(-34986583), (-34986574)⟩, ⟨(-2168098), (-2168086)⟩, ⟨45660, 45670⟩, ⟨1345, 1353⟩⟩
...
def j19 : Jet := ⟨⟨1305078716, 1305078724⟩, ⟨(-34986583), (-34986574)⟩, ⟨(-2168098), (-2168086)⟩, ⟨45660, 45670⟩, ⟨1345, 1353⟩⟩
...
def j22 : Jet := ⟨⟨(-99), (-97)⟩, ⟨(-29), (-27)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11736, 11739⟩, ⟨(-29), (-27)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10720, 10723⟩, ⟨3035, 3040⟩, ⟨207, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841457), (-841453)⟩, ⟨3035, 3040⟩, ⟨207, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-768613), (-768608)⟩, ⟨(-216832), (-216825)⟩, ⟨(-14705), (-14697)⟩, ⟨108, 113⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35022781, 35022787⟩, ⟨(-216832), (-216825)⟩, ⟨(-14705), (-14697)⟩, ⟨108, 113⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨31990858, 31990865⟩, ⟨8942184, 8942193⟩, ⟨582853, 582865⟩, ⟨(-7783), (-7772)⟩, ⟨(-247), (-239)⟩⟩
...
def j33 : Jet := ⟨⟨(-683837025), (-683837017)⟩, ⟨8942184, 8942193⟩, ⟨582853, 582865⟩, ⟨(-7783), (-7772)⟩, ⟨(-247), (-239)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-624637252), (-624637242)⟩, ⟨(-170299728), (-170299714)⟩, ⟨(-9881574), (-9881557)⟩, ⟨311697, 311714⟩, ⟨8607, 8620⟩⟩
...
def j36 : Jet := ⟨⟨3670330044, 3670330054⟩, ⟨(-170299728), (-170299714)⟩, ⟨(-9881574), (-9881557)⟩, ⟨311697, 311714⟩, ⟨8607, 8620⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1247309819, 1247309829⟩, ⟨144749202, 144749215⟩, ⟨(-6848973), (-6848959)⟩, ⟨(-252381), (-252367)⟩, ⟨7519, 7530⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5025908788, 5025908802⟩, ⟨233197237, 233197259⟩, ⟨24351276, 24351305⟩, ⟨1330864, 1330895⟩, ⟨95701, 95726⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1459583961, 1459583978⟩, ⟨237106691, 237106716⟩, ⟨6916555, 6916584⟩, ⟨539983, 540014⟩, ⟨28906, 28933⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1306614951), (-1306614950)⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2988352345, 2988352346⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨496018989, 496019002⟩, ⟨161154718, 161154738⟩, ⟨17790627, 17790653⟩, ⟨1130676, 1130704⟩, ⟨90404, 90429⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4790986285, 4790986298⟩, ⟨161154718, 161154738⟩, ⟨17790627, 17790653⟩, ⟨1130676, 1130704⟩, ⟨90404, 90429⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4536202090, 4536202098⟩, ⟨76292262, 76292273⟩, ⟨7780699, 7780713⟩, ⟨404412, 404428⟩, ⟨29323, 29337⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3156198689, 3156198697⟩, ⟨(-144060714), (-144060704)⟩, ⟨2097991, 2098004⟩, ⟨(-56769), (-56756)⟩, ⟨2825, 2838⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨26086427231, 26086427237⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value276

def j47 : Jet := ⟨⟨7936012887, 7936012896⟩, ⟨1133716123, 1133716130⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14663743912, 14663743947⟩, ⟨4189641104, 4189641136⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14663743912, 14663743947⟩, ⟨4189641104, 4189641136⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14663743947), (-14663743912)⟩, ⟨(-4189641136), (-4189641104)⟩, ⟨(-299260082), (-299260077)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7331871974), (-7331871956)⟩, ⟨(-2094820568), (-2094820552)⟩, ⟨(-149630041), (-149630038)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨779080784, 779080794⟩, ⟨(-379987637), (-379987628)⟩, ⟨65525307, 65525313⟩, ⟨(-1827616), (-1827613)⟩, ⟨(-918552), (-918550)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨572515127, 572515137⟩, ⟨(-305369363), (-305369351)⟩, ⟨61277922, 61277933⟩, ⟨(-3736791), (-3736782)⟩, ⟨(-576166), (-576157)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1119955672, 1493274230⟩, ⟨186659278, 186659279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3518444511, 4691259351⟩, ⟨586407416, 586407420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2882315725, 5124116852⟩, ⟨960771904, 1281029216⟩, ⟨80064325, 80064327⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨721, 1284⟩, ⟨240, 321⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93966), (-93402)⟩, ⟨240, 321⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-112107), (-62681)⟩, ⟨(-27866), (-20510)⟩, ⟨(-1686), (-1619)⟩, ⟨8, 13⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5000949, 5050376⟩, ⟨(-27866), (-20510)⟩, ⟨(-1686), (-1619)⟩, ⟨8, 13⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3356093, 6025359⟩, ⟨1085451, 1492576⟩, ⟨82900, 88473⟩, ⟨(-1018), (-728)⟩, ⟨(-31), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139809484), (-137140217)⟩, ⟨1085451, 1492576⟩, ⟨82900, 88473⟩, ⟨(-1018), (-728)⟩, ⟨(-31), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-166799905), (-92033623)⟩, ⟨(-40971541), (-28897154)⟩, ⟨(-2307804), (-2005756)⟩, ⟨37563, 53725⟩, ⟨1204, 1472⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1264855860, 1339622143⟩, ⟨(-40971541), (-28897154)⟩, ⟨(-2307804), (-2005756)⟩, ⟨37563, 53725⟩, ⟨1204, 1472⟩⟩
...
def j70 : Jet := ⟨⟨(-129), (-71)⟩, ⟨(-33), (-23)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11706, 11765⟩, ⟨(-33), (-23)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7855, 14037⟩, ⟨2578, 3495⟩, ⟨204, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844322), (-838139)⟩, ⟨2578, 3495⟩, ⟨204, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1007320), (-562467)⟩, ⟨(-250100), (-183319)⟩, ⟨(-15028), (-14324)⟩, ⟨90, 131⟩, ⟨0, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34784074, 35228928⟩, ⟨(-250100), (-183319)⟩, ⟨(-15028), (-14324)⟩, ⟨90, 131⟩, ⟨0, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨23343293, 42029923⟩, ⟨7482714, 10384458⟩, ⟨555898, 606099⟩, ⟨(-9086), (-6464)⟩, ⟨(-261), (-221)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692484590), (-673797959)⟩, ⟨7482714, 10384458⟩, ⟨555898, 606099⟩, ⟨(-9086), (-6464)⟩, ⟨(-261), (-221)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-826169727), (-452180032)⟩, ⟨(-201520848), (-138337483)⟩, ⟨(-10861984), (-8740149)⟩, ⟨252999, 370022⟩, ⟨7339, 9706⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3468797569, 3842787264⟩, ⟨(-201520848), (-138337483)⟩, ⟨(-10861984), (-8740149)⟩, ⟨252999, 370022⟩, ⟨7339, 9706⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1036172070, 1463227651⟩, ⟨127943402, 159230860⟩, ⟨(-8114736), (-5588550)⟩, ⟨(-284322), (-215170)⟩, ⟨6114, 8944⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4800355264, 5317907346⟩, ⟨172809217, 308945444⟩, ⟨17139071, 34600456⟩, ⟨497973, 2627422⟩, ⟨13726, 238230⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1158098236, 1811727201⟩, ⟨184689151, 302408002⟩, ⟨(-764755), 16995466⟩, ⟨(-305054), 1712549⟩, ⟨(-60847), 158688⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1493274230), (-1119955672)⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2801693066, 3175011624⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨312270485, 764232933⟩, ⟨99599444, 255126882⟩, ⟨7296684, 35630748⟩, ⟨(-365054), 3838094⟩, ⟨(-97319), 442293⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4607237781, 5059200229⟩, ⟨99599444, 255126882⟩, ⟨7296684, 35630748⟩, ⟨(-365054), 3838094⟩, ⟨(-97319), 442293⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4448363248, 4661448223⟩, ⟨45884490, 123164584⟩, ⟨1734386, 16964388⟩, ⟨(-645938), 1834983⟩, ⟨(-130137), 231068⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2901756313, 3445928985⟩, ⟨(-172655171), (-102277678)⟩, ⟨(-4221359), 10546616⟩, ⟨(-1214777), 1281117⟩, ⟨(-175952), 198888⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6802296764, 9069729025⟩, ⟨1133716123, 1133716130⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10773362886, 19152645159⟩, ⟨3591120948, 4788161298⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10773362886, 19152645159⟩, ⟨3591120948, 4788161298⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19152645159), (-10773362886)⟩, ⟨(-4788161298), (-3591120948)⟩, ⟨(-299260082), (-299260077)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9576322580), (-5386681443)⟩, ⟨(-2394080649), (-1795560474)⟩, ⟨(-149630041), (-149630038)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨461987514, 1225390341⟩, ⟨(-683051372), (-193139193)⟩, ⟨(-2318681), 174276724⟩, ⟨(-27895726), 16295128⟩, ⟨(-5306555), 3927767⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨312126983, 983152561⟩, ⟨(-597284293), (-141489757)⟩, ⟨1534586, 170292634⟩, ⟨(-31410935), 14203943⟩, ⟨(-5337833), 4950598⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1306614950, 1306614951⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4536202090, 4536202098⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar276 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified848
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar276 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1119955672, 1493274230⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4448363248, 4661448223⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified849
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((6519 / 25000) : ℝ)..(2173 / 6250), prawitzNormalCorrection
      ((2173 / 800) * sqrt n) s) ≤ (upper : ℝ) :=
