...
namespace FiniteNormalPanel27_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (5061 / 16000)
def radius : Rat := (723 / 16000)

def j0 : Jet := ⟨⟨1358551842, 1358551843⟩, ⟨194078834, 194078835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4268016486, 4268016490⟩, ⟨609716639, 609716643⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4241234791, 4241234800⟩, ⟨1211781364, 1211781376⟩, ⟨86555811, 86555813⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1061, 1063⟩, ⟨303, 304⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93626), (-93623)⟩, ⟨303, 304⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-92455), (-92451)⟩, ⟨(-26117), (-26113)⟩, ⟨(-1782), (-1778)⟩, ⟨11, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5020601, 5020606⟩, ⟨(-26117), (-26113)⟩, ⟨(-1782), (-1778)⟩, ⟨11, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4957790, 4957796⟩, ⟨1390720, 1390727⟩, ⟨92050, 92058⟩, ⟨(-1020), (-1013)⟩, ⟨(-33), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-138207787), (-138207780)⟩, ⟨1390720, 1390727⟩, ⟨92050, 92058⟩, ⟨(-1020), (-1013)⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-136478729), (-136478721)⟩, ⟨(-37620602), (-37620591)⟩, ⟨(-2302006), (-2301992)⟩, ⟨52988, 53002⟩, ⟨1534, 1542⟩⟩
...
def j19 : Jet := ⟨⟨1295177036, 1295177045⟩, ⟨(-37620602), (-37620591)⟩, ⟨(-2302006), (-2301992)⟩, ⟨52988, 53002⟩, ⟨1534, 1542⟩⟩
...
def j22 : Jet := ⟨⟨(-107), (-105)⟩, ⟨(-31), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11728, 11731⟩, ⟨(-31), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11581, 11585⟩, ⟨3277, 3281⟩, ⟨224, 228⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840596), (-840591)⟩, ⟨3277, 3281⟩, ⟨224, 228⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-830080), (-830074)⟩, ⟨(-233930), (-233924)⟩, ⟨(-15796), (-15788)⟩, ⟨127, 132⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨34961314, 34961321⟩, ⟨(-233930), (-233924)⟩, ⟨(-15796), (-15788)⟩, ⟨127, 132⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨34523927, 34523935⟩, ⟨9632975, 9632985⟩, ⟨622969, 622982⟩, ⟨(-9047), (-9037)⟩, ⟨(-283), (-275)⟩⟩
...
def j33 : Jet := ⟨⟨(-681303956), (-681303947)⟩, ⟨9632975, 9632985⟩, ⟨622969, 622982⟩, ⟨(-9047), (-9037)⟩, ⟨(-283), (-275)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-672780455), (-672780443)⟩, ⟨(-182710528), (-182710512)⟩, ⟨(-10397194), (-10397174)⟩, ⟨360961, 360979⟩, ⟨9721, 9735⟩⟩
...
def j36 : Jet := ⟨⟨3622186841, 3622186853⟩, ⟨(-182710528), (-182710512)⟩, ⟨(-10397194), (-10397174)⟩, ⟨360961, 360979⟩, ⟨9721, 9735⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1287049833, 1287049844⟩, ⟨146479727, 146479742⟩, ⟨(-7628209), (-7628193)⟩, ⟨(-274140), (-274122)⟩, ⟨9046, 9058⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5092709134, 5092709152⟩, ⟨256886662, 256886689⟩, ⟨27576069, 27576102⟩, ⟨1620834, 1620867⟩, ⟨121622, 121650⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1526104854, 1526104873⟩, ⟨250666536, 250666566⟩, ⟨7979619, 7979654⟩, ⟨644875, 644913⟩, ⟨37074, 37104⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1358551843), (-1358551842)⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2936415453, 2936415454⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨542261643, 542261658⟩, ⟨178135660, 178135684⟩, ⟨20300311, 20300344⟩, ⟨1389704, 1389740⟩, ⟨116443, 116472⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4837228939, 4837228954⟩, ⟨178135660, 178135684⟩, ⟨20300311, 20300344⟩, ⟨1389704, 1389740⟩, ⟨116443, 116472⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4558041256, 4558041264⟩, ⟨83927150, 83927163⟩, ⟨8791649, 8791666⟩, ⟨492866, 492885⟩, ⟨37305, 37322⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3116275831, 3116275838⟩, ⟨(-148586547), (-148586535)⟩, ⟨2218281, 2218295⟩, ⟨(-60308), (-60292)⟩, ⟨3231, 3246⟩⟩
...
def j47 : Jet := ⟨⟨7750945823, 7750945830⟩, ⟨1107277971, 1107277978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13987804099, 13987804125⟩, ⟨3996515442, 3996515474⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13987804099, 13987804125⟩, ⟨3996515442, 3996515474⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13987804125), (-13987804099)⟩, ⟨(-3996515474), (-3996515442)⟩, ⟨(-285465392), (-285465387)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6993902063), (-6993902049)⟩, ⟨(-1998257737), (-1998257721)⟩, ⟨(-142732696), (-142732693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨842863054, 842863065⟩, ⟨(-392146791), (-392146782)⟩, ⟨63213763, 63213769⟩, ⟨(-1115498), (-1115495)⟩, ⟨(-920630), (-920629)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨611551516, 611551527⟩, ⟨(-313687065), (-313687053)⟩, ⟨59867500, 59867511⟩, ⟨(-3210654), (-3210642)⟩, ⟨(-590600), (-590588)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1164473008, 1552630678⟩, ⟨194078834, 194078835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3658299847, 4877733132⟩, ⟨609716639, 609716643⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3116009237, 5539571985⟩, ⟨1038669742, 1384893000⟩, ⟨86555811, 86555813⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨779, 1388⟩, ⟨259, 347⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93908), (-93298)⟩, ⟨259, 347⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-121121), (-67687)⟩, ⟨(-30094), (-22114)⟩, ⟨(-1816), (-1739)⟩, ⟨10, 15⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4991935, 5045370⟩, ⟨(-30094), (-22114)⟩, ⟨(-1816), (-1739)⟩, ⟨10, 15⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3621661, 6507428⟩, ⟨1168405, 1610814⟩, ⟨88554, 95071⟩, ⟨(-1186), (-845)⟩, ⟨(-35), (-28)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139543916), (-136658148)⟩, ⟨1168405, 1610814⟩, ⟨88554, 95071⟩, ⟨(-1186), (-845)⟩, ⟨(-35), (-28)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-179981247), (-99145819)⟩, ⟨(-44147632), (-30971006)⟩, ⟨(-2465402), (-2112029)⟩, ⟨43431, 62506⟩, ⟨1355, 1692⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1251674518, 1332509947⟩, ⟨(-44147632), (-30971006)⟩, ⟨(-2465402), (-2112029)⟩, ⟨43431, 62506⟩, ⟨1355, 1692⟩⟩
...
def j70 : Jet := ⟨⟨(-140), (-77)⟩, ⟨(-35), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11695, 11759⟩, ⟨(-35), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8484, 15167⟩, ⟨2782, 3774⟩, ⟨219, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843693), (-837009)⟩, ⟨2782, 3774⟩, ⟨219, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1088181), (-607252)⟩, ⟨(-270028), (-197549)⟩, ⟨(-16173), (-15354)⟩, ⟨105, 152⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34703213, 35184143⟩, ⟨(-270028), (-197549)⟩, ⟨(-16173), (-15354)⟩, ⟨105, 152⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨25177265, 45379879⟩, ⟨8044143, 11201648⟩, ⟨591438, 650148⟩, ⟨(-10581), (-7497)⟩, ⟨(-301), (-252)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-690650618), (-670448003)⟩, ⟨8044143, 11201648⟩, ⟨591438, 650148⟩, ⟨(-10581), (-7497)⟩, ⟨(-301), (-252)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-890788812), (-486411659)⟩, ⟨(-216861159), (-147689533)⟩, ⟨(-11544139), (-9060962)⟩, ⟨291493, 429945⟩, ⟨8118, 11108⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3404178484, 3808555637⟩, ⟨(-216861159), (-147689533)⟩, ⟨(-11544139), (-9060962)⟩, ⟨291493, 429945⟩, ⟨8118, 11108⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1066131679, 1513312552⟩, ⟨127550775, 162784073⟩, ⟨(-9067152), (-6195616)⟩, ⟨(-312999), (-228837)⟩, ⟨7319, 10796⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4843501272, 5418853377⟩, ⟨187823024, 345204822⟩, ⟨18806676, 40367307⟩, ⟨564411, 3327484⟩, ⟨11853, 321238⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1202293239, 1909308796⟩, ⟨190463945, 327011993⟩, ⟨(-1193539), 20319999⟩, ⟨(-425053), 2173389⟩, ⟨(-82422), 215789⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1552630678), (-1164473008)⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2742336618, 3130494288⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨336558798, 848774817⟩, ⟨106633414, 290743484⟩, ⟨7385118, 42964509⟩, ⟨(-559662), 5026608⟩, ⟨(-143655), 618953⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4631526094, 5143742113⟩, ⟨106633414, 290743484⟩, ⟨7385118, 42964509⟩, ⟨(-559662), 5026608⟩, ⟨(-143655), 618953⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4460073217, 4700234479⟩, ⟨48719593, 139990276⟩, ⟨1289463, 20420917⟩, ⟨(-910433), 2406181⟩, ⟨(-191444), 326411⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2847756748, 3425883407⟩, ⟨(-181284386), (-99504144)⟩, ⟨(-5502489), 12682780⟩, ⟨(-1586363), 1695539⟩, ⟨(-248269), 279054⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6643667852, 8858223808⟩, ⟨1107277971, 1107277978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10276754043, 18269784989⟩, ⟨3425584666, 4567446256⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10276754043, 18269784989⟩, ⟨3425584666, 4567446256⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18269784989), (-10276754043)⟩, ⟨(-4567446256), (-3425584666)⟩, ⟨(-285465392), (-285465387)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9134892495), (-5138377021)⟩, ⟨(-2283723128), (-1712792333)⟩, ⟨(-142732696), (-142732693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨511995743, 1298321554⟩, ⟨(-690344480), (-204179059)⟩, ⟨(-2434192), 166520313⟩, ⟨(-24990508), 15726040⟩, ⟨(-4857413), 3362441⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨339476236, 1035607017⟩, ⟨(-605454000), (-147241630)⟩, ⟨1125363, 165797348⟩, ⟨(-29480365), 14043607⟩, ⟨(-5099210), 4567930⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1358551842, 1358551843⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4558041256, 4558041264⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified538
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1164473008, 1552630678⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4460073217, 4700234479⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified539
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (14288761 / 1073741824)

theorem envelope_integral : (∫ s in ((2169 / 8000) : ℝ)..(723 / 2000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((2169 / 8000) : ℝ)..(723 / 2000), prawitzNormalCorrection
