...
namespace FiniteNormalPanel156_10
...
def j2 : Jet := ⟨⟨430360434, 430360438⟩, ⟨430360434, 430360438⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨43122587, 43122589⟩, ⟨86245174, 86245178⟩, ⟨43122587, 43122589⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-951), (-950)⟩, ⟨(-1902), (-1900)⟩, ⟨(-951), (-948)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112105, 5112107⟩, ⟨(-1902), (-1900)⟩, ⟨(-951), (-948)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨51326, 51327⟩, ⟨102633, 102635⟩, ⟨51277, 51280⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143114251), (-143114249)⟩, ⟨102633, 102635⟩, ⟨51277, 51280⟩, ⟨(-40), (-37)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1436905), (-1436904)⟩, ⟨(-2872779), (-2872777)⟩, ⟨(-1434331), (-1434328)⟩, ⟨2058, 2061⟩, ⟨512, 515⟩⟩
...
def j19 : Jet := ⟨⟨1430218860, 1430218862⟩, ⟨(-2872779), (-2872777)⟩, ⟨(-1434331), (-1434328)⟩, ⟨2058, 2061⟩, ⟨512, 515⟩⟩
...
def j25 : Jet := ⟨⟨118, 119⟩, ⟨236, 238⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852059), (-852057)⟩, ⟨236, 238⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8555), (-8554)⟩, ⟨(-17108), (-17106)⟩, ⟨(-8550), (-8547)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782839, 35782841⟩, ⟨(-17108), (-17106)⟩, ⟨(-8550), (-8547)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨359268, 359270⟩, ⟨718365, 718368⟩, ⟨358838, 358842⟩, ⟨(-344), (-341)⟩, ⟨(-87), (-83)⟩⟩
...
def j33 : Jet := ⟨⟨(-715468615), (-715468612)⟩, ⟨718365, 718368⟩, ⟨358838, 358842⟩, ⟨(-344), (-341)⟩, ⟨(-87), (-83)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7183492), (-7183490)⟩, ⟨(-14359771), (-14359768)⟩, ⟨(-7165465), (-7165461)⟩, ⟨14413, 14416⟩, ⟨3594, 3597⟩⟩
...
def j36 : Jet := ⟨⟨4287783804, 4287783806⟩, ⟨(-14359771), (-14359768)⟩, ⟨(-7165465), (-7165461)⟩, ⟨14413, 14416⟩, ⟨3594, 3597⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨143309498, 143309501⟩, ⟨143021642, 143021646⟩, ⟨(-431578), (-431576)⟩, ⟨(-143516), (-143514)⟩, ⟨257, 259⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302162820, 4302162823⟩, ⟨14407922, 14407927⟩, ⟨7237741, 7237748⟩, ⟨33850, 33857⟩, ⟨8549, 8557⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨143549589, 143549594⟩, ⟨143741997, 143742004⟩, ⟨288979, 288984⟩, ⟨96939, 96945⟩, ⟨459, 466⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-136987982), (-136987981)⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4157979314, 4157979315⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4797821, 4797822⟩, ⟨9608502, 9608506⟩, ⟨4830007, 4830010⟩, ⟨25820, 25826⟩, ⟨6537, 6542⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299765117, 4299765118⟩, ⟨9608502, 9608506⟩, ⟨4830007, 4830010⟩, ⟨25820, 25826⟩, ⟨6537, 6542⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297365536, 4297365538⟩, ⟨4801569, 4801572⟩, ⟨2410973, 2410976⟩, ⟨10208, 10213⟩, ⟨2578, 2583⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4160301062, 4160301066⟩, ⟨(-132416052), (-132416046)⟩, ⟨2180928, 2180932⟩, ⟨(-67017), (-67009)⟩, ⟨2169, 2176⟩⟩
...
def j47 : Jet := ⟨⟨1623665014, 1623665027⟩, ⟨1623665014, 1623665027⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨613808649, 613808660⟩, ⟨1227617298, 1227617320⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨613808649, 613808660⟩, ⟨1227617298, 1227617320⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-613808660), (-613808649)⟩, ⟨(-1227617320), (-1227617298)⟩, ⟨(-613808660), (-613808649)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-306904330), (-306904324)⟩, ⟨(-613808660), (-613808649)⟩, ⟨(-306904330), (-306904324)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3998771577, 3998771583⟩, ⟨(-571478305), (-571478293)⟩, ⟨(-244903182), (-244903173)⟩, ⟨38890633, 38890636⟩, ⟨7360491, 7360492⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3873392389, 3873392400⟩, ⟨(-676844118), (-676844098)⟩, ⟨(-217574892), (-217574875)⟩, ⟨44869143, 44869159⟩, ⟨5817264, 5817277⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 273975964⟩, ⟨136987981, 136987982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 860720876⟩, ⟨430360434, 430360438⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 172490354⟩, ⟨0, 172490354⟩, ⟨43122587, 43122589⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 44⟩, ⟨0, 44⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94642)⟩, ⟨0, 44⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-3803), 0⟩, ⟨(-3803), 2⟩, ⟨(-951), (-947)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109253, 5113057⟩, ⟨(-3803), 2⟩, ⟨(-951), (-947)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 205346⟩, ⟨(-153), 205347⟩, ⟨51106, 51338⟩, ⟨(-78), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142960230)⟩, ⟨(-153), 205347⟩, ⟨51106, 51338⟩, ⟨(-78), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5749679), 0⟩, ⟨(-5749686), 8247⟩, ⟨(-1437427), (-1425048)⟩, ⟨(-6), 4125⟩, ⟨508, 517⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425906086, 1431655766⟩, ⟨(-5749686), 8247⟩, ⟨(-1437427), (-1425048)⟩, ⟨(-6), 4125⟩, ⟨508, 517⟩⟩
...
def j72 : Jet := ⟨⟨0, 476⟩, ⟨(-1), 476⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851700)⟩, ⟨(-1), 476⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-34225), 0⟩, ⟨(-34226), 20⟩, ⟨(-8558), (-8526)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35757169, 35791395⟩, ⟨(-34226), 20⟩, ⟨(-8558), (-8526)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1437420⟩, ⟨(-1375), 1437421⟩, ⟨357292, 359356⟩, ⟨(-689), 2⟩, ⟨(-88), (-83)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714390462)⟩, ⟨(-1375), 1437421⟩, ⟨357292, 359356⟩, ⟨(-689), 2⟩, ⟨(-88), (-83)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-28748393), 0⟩, ⟨(-28748449), 57729⟩, ⟨(-7187155), (-7100503)⟩, ⟨(-42), 28867⟩, ⟨3555, 3610⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4266218903, 4294967296⟩, ⟨(-28748449), 57729⟩, ⟨(-7187155), (-7100503)⟩, ⟨(-42), 28867⟩, ⟨3555, 3610⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 286906959⟩, ⟨141725103, 143455133⟩, ⟨(-864189), 827⟩, ⟨(-144034), (-141964)⟩, ⟨(-1), 518⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4323909414⟩, ⟨(-58511), 29137205⟩, ⟨7100111, 7480691⟩, ⟨(-29459), 99541⟩, ⟨7709, 9697⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 288840314⟩, ⟨141721194, 146368209⟩, ⟨(-871968), 1473754⟩, ⟨81453, 114559⟩, ⟨(-3470), 4499⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-273975964), 0⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4020991332, 4294967296⟩, ⟨(-136987982), (-136987981)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19424765⟩, ⟨0, 19686782⟩, ⟨4559097, 5186307⟩, ⟨(-59432), 115860⟩, ⟨4606, 8922⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314392061⟩, ⟨0, 19686782⟩, ⟨4559097, 5186307⟩, ⟨(-59432), 115860⟩, ⟨4606, 8922⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304668722⟩, ⟨0, 9843391⟩, ⟨2263156, 2593154⟩, ⟨(-35660), 57930⟩, ⟨1383, 3947⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4020991332, 4304668722⟩, ⟨(-137297409), (-127144590)⟩, ⟨1804834, 2593154⟩, ⟨(-118369), (-14253)⟩, ⟨(-554), 5085⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3247330054⟩, ⟨1623665014, 1623665027⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2455234640⟩, ⟨0, 2455234640⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2455234640⟩, ⟨0, 2455234640⟩, ⟨613808649, 613808660⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2455234640), 0⟩, ⟨(-2455234640), 0⟩, ⟨(-613808660), (-613808649)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1227617320), 0⟩, ⟨(-1227617320), 0⟩, ⟨(-306904330), (-306904324)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3227206845, 4294967296⟩, ⟨(-1227617320), 0⟩, ⟨(-306904330), (-55162606)⟩, ⟨0, 87721523⟩, ⟨(-4297424), 10965191⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3021343320, 4304668722⟩, ⟨(-1367687658), (-95535510)⟩, ⟨(-306241425), (-9807331)⟩, ⟨773424, 97719784⟩, ⟨(-7297182), 11005699⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297365536, 4297365538⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3152
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304668722⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3153
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (242597745 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(6379 / 100000), prawitzNormalCorrection
