...
namespace FiniteNormalPanel54_16
...
def j2 : Jet := ⟨⟨555913151, 555913155⟩, ⟨555913151, 555913155⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨71953849, 71953851⟩, ⟨143907698, 143907702⟩, ⟨71953849, 71953851⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1586), (-1585)⟩, ⟨(-3172), (-3170)⟩, ⟨(-1585), (-1582)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111470, 5111472⟩, ⟨(-3172), (-3170)⟩, ⟨(-1585), (-1582)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨85632, 85633⟩, ⟨171211, 171213⟩, ⟨85498, 85501⟩, ⟨(-108), (-105)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-143079945), (-143079943)⟩, ⟨171211, 171213⟩, ⟨85498, 85501⟩, ⟨(-108), (-105)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2397028), (-2397027)⟩, ⟨(-4791187), (-4791185)⟩, ⟨(-2389860), (-2389857)⟩, ⟨5730, 5733⟩, ⟨1427, 1430⟩⟩
...
def j19 : Jet := ⟨⟨1429258737, 1429258739⟩, ⟨(-4791187), (-4791185)⟩, ⟨(-2389860), (-2389857)⟩, ⟨5730, 5733⟩, ⟨1427, 1430⟩⟩
...
def j25 : Jet := ⟨⟨198, 199⟩, ⟨395, 397⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851979), (-851977)⟩, ⟨395, 397⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14274), (-14273)⟩, ⟨(-28541), (-28539)⟩, ⟨(-14258), (-14255)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35777120, 35777122⟩, ⟨(-28541), (-28539)⟩, ⟨(-14258), (-14255)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨599376, 599377⟩, ⟨1198273, 1198275⟩, ⟨598180, 598183⟩, ⟨(-957), (-954)⟩, ⟨(-239), (-236)⟩⟩
...
def j33 : Jet := ⟨⟨(-715228507), (-715228505)⟩, ⟨1198273, 1198275⟩, ⟨598180, 598183⟩, ⟨(-957), (-954)⟩, ⟨(-239), (-236)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11982268), (-11982266)⟩, ⟨(-23944461), (-23944458)⟩, ⟨(-11932098), (-11932094)⟩, ⟨40099, 40103⟩, ⟨9983, 9988⟩⟩
...
def j36 : Jet := ⟨⟨4282985028, 4282985030⟩, ⟨(-23944461), (-23944458)⟩, ⟨(-11932098), (-11932094)⟩, ⟨40099, 40103⟩, ⟨9983, 9988⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨184994127, 184994130⟩, ⟨184373986, 184373990⟩, ⟨(-929470), (-929467)⟩, ⟨(-308588), (-308584)⟩, ⟨925, 929⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306983084, 4306983087⟩, ⟨24078621, 24078626⟩, ⟨12133563, 12133570⟩, ⟨94585, 94593⟩, ⟨24061, 24071⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨185511674, 185511678⟩, ⟨185926919, 185926925⟩, ⟨624193, 624200⟩, ⟨210278, 210287⟩, ⟨1666, 1676⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-176952653), (-176952652)⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4118014643, 4118014644⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8012769, 8012770⟩, ⟨16061408, 16061412⟩, ⟨8102600, 8102603⟩, ⟨72204, 72210⟩, ⟨18436, 18445⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302980065, 4302980066⟩, ⟨16061408, 16061412⟩, ⟨8102600, 8102603⟩, ⟨72204, 72210⟩, ⟨18436, 18445⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298971813, 4298971815⟩, ⟨8023223, 8023226⟩, ⟨4040039, 4040042⟩, ⟨28527, 28532⟩, ⟨7256, 7263⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4121854173, 4121854177⟩, ⟨(-169424974), (-169424968)⟩, ⟨3543032, 3543037⟩, ⟨(-139099), (-139092)⟩, ⟨5781, 5789⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨30674348276, 30674348282⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value310

def j47 : Jet := ⟨⟨1263783144, 1263783153⟩, ⟨1263783144, 1263783153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨371864958, 371864964⟩, ⟨743729916, 743729928⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨371864958, 371864964⟩, ⟨743729916, 743729928⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-371864964), (-371864958)⟩, ⟨(-743729928), (-743729916)⟩, ⟨(-371864964), (-371864958)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-185932482), (-185932479)⟩, ⟨(-371864964), (-371864958)⟩, ⟨(-185932482), (-185932479)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4113001942, 4113001946⟩, ⟨(-356110121), (-356110114)⟩, ⟨(-162638777), (-162638772)⟩, ⟨14971362, 14971363⟩, ⟨3196318, 3196319⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3947223121, 3947223130⟩, ⟨(-504003661), (-504003646)⟩, ⟨(-138642939), (-138642926)⟩, ⟨20356617, 20356629⟩, ⟨2359808, 2359822⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 353905306⟩, ⟨176952652, 176952653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1111826310⟩, ⟨555913151, 555913155⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 287815404⟩, ⟨0, 287815404⟩, ⟨71953849, 71953851⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6346), 0⟩, ⟨(-6346), 5⟩, ⟨(-1587), (-1578)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106710, 5113057⟩, ⟨(-6346), 5⟩, ⟨(-1587), (-1578)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 342638⟩, ⟨(-426), 342639⟩, ⟨85020, 85661⟩, ⟨(-214), 2⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142822938)⟩, ⟨(-426), 342639⟩, ⟨85020, 85661⟩, ⟨(-214), 2⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9593847), 0⟩, ⟨(-9593876), 22962⟩, ⟨(-2398491), (-2364018)⟩, ⟨(-23), 11483⟩, ⟨1407, 1437⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422061918, 1431655766⟩, ⟨(-9593876), 22962⟩, ⟨(-2398491), (-2364018)⟩, ⟨(-23), 11483⟩, ⟨1407, 1437⟩⟩
...
def j72 : Jet := ⟨⟨0, 794⟩, ⟨(-1), 794⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851382)⟩, ⟨(-1), 794⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-57107), 0⟩, ⟨(-57108), 54⟩, ⟨(-14278), (-14195)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35734287, 35791395⟩, ⟨(-57108), 54⟩, ⟨(-14278), (-14195)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2398462⟩, ⟨(-3827), 2398466⟩, ⟨593874, 599620⟩, ⟨(-1915), 3⟩, ⟨(-241), (-234)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713429420)⟩, ⟨(-3827), 2398466⟩, ⟨593874, 599620⟩, ⟨(-1915), 3⟩, ⟨(-241), (-234)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-47969235), 0⟩, ⟨(-47969492), 160727⟩, ⟨(-11992566), (-11751217)⟩, ⟨(-194), 80365⟩, ⟨9803, 10047⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4246998061, 4294967296⟩, ⟨(-47969492), 160727⟩, ⟨(-11992566), (-11751217)⟩, ⟨(-194), 80365⟩, ⟨9803, 10047⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 370608771⟩, ⟨181579076, 185310331⟩, ⟨(-1862662), 2973⟩, ⟨(-310452), (-303010)⟩, ⟨(-3), 1859⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4343478337⟩, ⟨(-164379), 49059230⟩, ⟨11749381, 12819127⟩, ⟨(-83141), 283523⟩, ⟨20138, 29493⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 374794745⟩, ⟨181564891, 191636661⟩, ⟨(-1890794), 3225864⟩, ⟨154319, 274621⟩, ⟨(-12699), 16679⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-353905306), 0⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3941061990, 4294967296⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 32705977⟩, ⟨0, 33445850⟩, ⟨7345454, 9113617⟩, ⟨(-168732), 335800⟩, ⟨9407, 29843⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4327673273⟩, ⟨0, 33445850⟩, ⟨7345454, 9113617⟩, ⟨(-168732), 335800⟩, ⟨9407, 29843⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311289271⟩, ⟨0, 16722925⟩, ⟨3626389, 4556809⟩, ⟨(-102109), 167900⟩, ⟨1625, 13789⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3941061990, 4311289271⟩, ⟨(-177625119), (-160229727)⟩, ⟨2638589, 4556809⟩, ⟨(-289850), 18493⟩, ⟨(-5427), 17996⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2527566305⟩, ⟨1263783144, 1263783153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1487459854⟩, ⟨0, 1487459856⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1487459854⟩, ⟨0, 1487459856⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1487459854), 0⟩, ⟨(-1487459856), 0⟩, ⟨(-371864964), (-371864958)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-743729927), 0⟩, ⟨(-743729928), 0⟩, ⟨(-185932482), (-185932479)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3612069306, 4294967296⟩, ⟨(-743729928), 0⟩, ⟨(-185932482), (-91975996)⟩, ⟨0, 32196649⟩, ⟨597037, 4024582⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3314434794, 4311289271⟩, ⟨(-924181412), (-134753267)⟩, ⟨(-184420020), (-49082244)⟩, ⟨2352370, 40027028⟩, ⟨(-989600), 4051561⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298971813, 4298971815⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar310 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1074
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar310 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311289271⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1075
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(103 / 1250), prawitzNormalCorrection
      ((18223 / 6250) * sqrt n) s) ≤ (upper : ℝ) :=
