...
namespace FiniteNormalPanel139_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38171 / 160000)
def radius : Rat := (5453 / 160000)

def j0 : Jet := ⟨⟨1024644979, 1024644980⟩, ⟨146377854, 146377855⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3219017138, 3219017142⟩, ⟨459859590, 459859594⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2412607738, 2412607745⟩, ⟨689316494, 689316502⟩, ⟨49236892, 49236894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨603, 605⟩, ⟨172, 173⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94084), (-94081)⟩, ⟨172, 173⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-52850), (-52848)⟩, ⟨(-15004), (-15001)⟩, ⟨(-1046), (-1042)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5060206, 5060209⟩, ⟨(-15004), (-15001)⟩, ⟨(-1046), (-1042)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2842464, 2842467⟩, ⟨803703, 803708⟩, ⟨55012, 55018⟩, ⟨(-340), (-335)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-140323113), (-140323109)⟩, ⟨803703, 803708⟩, ⟨55012, 55018⟩, ⟨(-340), (-335)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-78823564), (-78823561)⟩, ⟨(-22069556), (-22069550)⟩, ⟨(-1448755), (-1448747)⟩, ⟨17851, 17857⟩, ⟨568, 573⟩⟩
...
def j19 : Jet := ⟨⟨1352832201, 1352832205⟩, ⟨(-22069556), (-22069550)⟩, ⟨(-1448755), (-1448747)⟩, ⟨17851, 17857⟩, ⟨568, 573⟩⟩
...
def j22 : Jet := ⟨⟨(-61), (-60)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11774, 11776⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6613, 6615⟩, ⟨1878, 1881⟩, ⟨129, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845564), (-845561)⟩, ⟨1878, 1881⟩, ⟨129, 133⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-474978), (-474976)⟩, ⟨(-134654), (-134650)⟩, ⟨(-9321), (-9316)⟩, ⟨39, 44⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35316416, 35316419⟩, ⟨(-134654), (-134650)⟩, ⟨(-9321), (-9316)⟩, ⟨39, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19838255, 19838258⟩, ⟨5592432, 5592438⟩, ⟨378014, 378020⟩, ⟨(-3019), (-3013)⟩, ⟨(-102), (-96)⟩⟩
...
def j33 : Jet := ⟨⟨(-695989628), (-695989624)⟩, ⟨5592432, 5592438⟩, ⟨378014, 378020⟩, ⟨(-3019), (-3013)⟩, ⟨(-102), (-96)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-390957568), (-390957564)⟩, ⟨(-108560732), (-108560725)⟩, ⟨(-6868835), (-6868827)⟩, ⟨123082, 123089⟩, ⟨3790, 3798⟩⟩
...
def j36 : Jet := ⟨⟨3904009728, 3904009732⟩, ⟨(-108560732), (-108560725)⟩, ⟨(-6868835), (-6868827)⟩, ⟨123082, 123089⟩, ⟨3790, 3798⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1013928567, 1013928573⟩, ⟨128306117, 128306125⟩, ⟨(-3448797), (-3448788)⟩, ⟨(-141739), (-141732)⟩, ⟨2336, 2342⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4725076354, 4725076360⟩, ⟨131392528, 131392539⟩, ⟨11967130, 11967143⟩, ⟨414973, 414986⟩, ⟨23852, 23868⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1115465978, 1115465987⟩, ⟨172173333, 172173347⟩, ⟨2956121, 2956138⟩, ⟨194024, 194039⟩, ⟨6648, 6666⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1024644980), (-1024644979)⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3270322316, 3270322317⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨289702869, 289702874⟩, ⟨89431876, 89431886⟩, ⟨8437445, 8437459⟩, ⟨337784, 337798⟩, ⟨21040, 21057⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4584670165, 4584670170⟩, ⟨89431876, 89431886⟩, ⟨8437445, 8437459⟩, ⟨337784, 337798⟩, ⟨21040, 21057⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4437455174, 4437455177⟩, ⟨43280097, 43280103⟩, ⟨3872194, 3872203⟩, ⟨125701, 125710⟩, ⟨7265, 7276⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3378817039, 3378817043⟩, ⟨(-118279203), (-118279195)⟩, ⟨1473368, 1473378⟩, ⟨(-36258), (-36249)⟩, ⟨1246, 1257⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨50787458114, 50787458122⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value578

def j47 : Jet := ⟨⟨12116300396, 12116300411⟩, ⟨1730900054, 1730900068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨34180641008, 34180641093⟩, ⟨9765897416, 9765897508⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨34180641008, 34180641093⟩, ⟨9765897416, 9765897508⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-34180641093), (-34180641008)⟩, ⟨(-9765897508), (-9765897416)⟩, ⟨(-697564112), (-697564100)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-17090320547), (-17090320504)⟩, ⟨(-4882948754), (-4882948708)⟩, ⟨(-348782056), (-348782050)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨80322426, 80322430⟩, ⟨(-91318579), (-91318573)⟩, ⟨45387290, 45387296⟩, ⟨(-12256461), (-12256456)⟩, ⟨1640704, 1640707⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨63189021, 63189025⟩, ⟨(-74051611), (-74051604)⟩, ⟨38248202, 38248210⟩, ⟨(-10923990), (-10923981)⟩, ⟨1644620, 1644629⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨878267124, 1171022834⟩, ⟨146377854, 146377855⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2759157544, 3678876733⟩, ⟨459859590, 459859594⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1772528130, 3151161135⟩, ⟨590842708, 787790288⟩, ⟨49236892, 49236894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨443, 790⟩, ⟨147, 198⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94244), (-93896)⟩, ⟨147, 198⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-69146), (-38750)⟩, ⟨(-17227), (-12770)⟩, ⟨(-1057), (-1029)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5043910, 5074307⟩, ⟨(-17227), (-12770)⟩, ⟨(-1057), (-1029)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2081615, 3722953⟩, ⟨681231, 925469⟩, ⟨53886, 55992⟩, ⟨(-392), (-282)⟩, ⟨(-13), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141083962), (-139442623)⟩, ⟨681231, 925469⟩, ⟨53886, 55992⟩, ⟨(-392), (-282)⟩, ⟨(-13), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-103511452), (-57547812)⟩, ⟨(-25596720), (-18503599)⟩, ⟨(-1501415), (-1387717)⟩, ⟨14933, 20765⟩, ⟨535, 601⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1328144313, 1374107954⟩, ⟨(-25596720), (-18503599)⟩, ⟨(-1501415), (-1387717)⟩, ⟨14933, 20765⟩, ⟨535, 601⟩⟩
...
def j70 : Jet := ⟨⟨(-80), (-44)⟩, ⟨(-20), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11755, 11792⟩, ⟨(-20), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4851, 8652⟩, ⟨1602, 2158⟩, ⟨128, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847326), (-843524)⟩, ⟨1602, 2158⟩, ⟨128, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-621672), (-348121)⟩, ⟨(-154757), (-114456)⟩, ⟨(-9442), (-9174)⟩, ⟨33, 50⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35169722, 35443274⟩, ⟨(-154757), (-114456)⟩, ⟨(-9442), (-9174)⟩, ⟨33, 50⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14514504, 26004265⟩, ⟨4724624, 6453832⟩, ⟨367866, 386786⟩, ⟨(-3494), (-2537)⟩, ⟨(-106), (-93)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701313379), (-689823617)⟩, ⟨4724624, 6453832⟩, ⟨367866, 386786⟩, ⟨(-3494), (-2537)⟩, ⟨(-106), (-93)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-514544422), (-284689424)⟩, ⟨(-126686261), (-90161382)⟩, ⟨(-7237992), (-6440486)⟩, ⟨102203, 143884⟩, ⟨3498, 4048⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3780422874, 4010277872⟩, ⟨(-126686261), (-90161382)⟩, ⟨(-7237992), (-6440486)⟩, ⟨102203, 143884⟩, ⟨3498, 4048⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨853221723, 1176999366⟩, ⟨120278615, 135237907⟩, ⟨(-4026671), (-2872661)⟩, ⟨(-151163), (-130795)⟩, ⟨1941, 2739⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4599866807, 4879545144⟩, ⟨103416859, 163519097⟩, ⟨9712439, 14822081⟩, ⟨209373, 685423⟩, ⟨9512, 44298⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨913791889, 1337197969⟩, ⟨149361583, 198455841⟩, ⟨250845, 6134088⟩, ⟨(-11458), 445297⟩, ⟨(-9823), 27190⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1171022834), (-878267124)⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3123944462, 3416700172⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨194417223, 416324104⟩, ⟨63555968, 123574748⟩, ⟨5300929, 12989554⟩, ⟨10310, 844152⟩, ⟨(-7164), 66845⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4489384519, 4711291400⟩, ⟨63555968, 123574748⟩, ⟨5300929, 12989554⟩, ⟨10310, 844152⟩, ⟨(-7164), 66845⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4391100054, 4498315517⟩, ⟨30341447, 60434686⟩, ⟨2124680, 6247764⟩, ⟨(-80947), 398156⟩, ⟨(-13429), 33292⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3193866623, 3578466224⟩, ⟨(-131239366), (-101577629)⟩, ⟨(-514305), 3936101⟩, ⟨(-277327), 244328⟩, ⟨(-24253), 29244⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨10385400329, 13847200466⟩, ⟨1730900054, 1730900068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨25112307628, 44644102628⟩, ⟨8370769204, 11161025720⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨25112307628, 44644102628⟩, ⟨8370769204, 11161025720⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-44644102628), (-25112307628)⟩, ⟨(-11161025720), (-8370769204)⟩, ⟨(-697564112), (-697564100)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-22322051314), (-12556153814)⟩, ⟨(-5580512860), (-4185384602)⟩, ⟨(-348782056), (-348782050)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨23758529, 230843931⟩, ⟨(-299938844), (-23152348)⟩, ⟨(-7465361), 192928068⟩, ⟨(-82304649), 19471404⟩, ⟨(-14158439), 27038025⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨17667555, 192333761⟩, ⟨(-256955819), (-17778679)⟩, ⟨(-5700047), 170119803⟩, ⟨(-74759308), 16500285⟩, ⟨(-12432929), 25240144⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1024644979, 1024644980⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4437455174, 4437455177⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar578 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2790
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar578 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨878267124, 1171022834⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4391100054, 4498315517⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2791
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((16359 / 80000) : ℝ)..(5453 / 20000), prawitzNormalCorrection
      ((305317 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
