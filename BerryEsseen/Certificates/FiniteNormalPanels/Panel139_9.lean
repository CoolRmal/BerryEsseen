...
namespace FiniteNormalPanel139_9
...
def j2 : Jet := ⟨⟨459859590, 459859594⟩, ⟨459859590, 459859594⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨49236892, 49236894⟩, ⟨98473784, 98473788⟩, ⟨49236892, 49236894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1086), (-1085)⟩, ⟨(-2171), (-2169)⟩, ⟨(-1086), (-1083)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111970, 5111972⟩, ⟨(-2171), (-2169)⟩, ⟨(-1086), (-1083)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨58602, 58603⟩, ⟨117180, 117182⟩, ⟨58539, 58542⟩, ⟨(-50), (-47)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-143106975), (-143106973)⟩, ⟨117180, 117182⟩, ⟨58539, 58542⟩, ⟨(-50), (-47)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1640559), (-1640557)⟩, ⟨(-3279774), (-3279771)⟩, ⟨(-1637202), (-1637198)⟩, ⟨2684, 2687⟩, ⟨668, 671⟩⟩
...
def j19 : Jet := ⟨⟨1430015206, 1430015209⟩, ⟨(-3279774), (-3279771)⟩, ⟨(-1637202), (-1637198)⟩, ⟨2684, 2687⟩, ⟨668, 671⟩⟩
...
def j25 : Jet := ⟨⟨135, 136⟩, ⟨270, 272⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852042), (-852040)⟩, ⟨270, 272⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9768), (-9767)⟩, ⟨(-19533), (-19531)⟩, ⟨(-9761), (-9758)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781626, 35781628⟩, ⟨(-19533), (-19531)⟩, ⟨(-9761), (-9758)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨410195, 410196⟩, ⟨820166, 820168⟩, ⟨409635, 409638⟩, ⟨(-448), (-445)⟩, ⟨(-113), (-109)⟩⟩
...
def j33 : Jet := ⟨⟨(-715417688), (-715417686)⟩, ⟨820166, 820168⟩, ⟨409635, 409638⟩, ⟨(-448), (-445)⟩, ⟨(-113), (-109)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8201447), (-8201446)⟩, ⟨(-16393492), (-16393489)⟩, ⟨(-8177948), (-8177944)⟩, ⟨18787, 18791⟩, ⟨4682, 4686⟩⟩
...
def j36 : Jet := ⟨⟨4286765849, 4286765850⟩, ⟨(-16393492), (-16393489)⟩, ⟨(-8177948), (-8177944)⟩, ⟨18787, 18791⟩, ⟨4682, 4686⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨153110876, 153110878⟩, ⟨152759712, 152759715⟩, ⟨(-526459), (-526456)⟩, ⟨(-175008), (-175005)⟩, ⟨358, 360⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303184433, 4303184435⟩, ⟨16456277, 16456282⟩, ⟨8272198, 8272205⟩, ⟨44165, 44173⟩, ⟨11172, 11181⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨153403807, 153403811⟩, ⟨153638620, 153638625⟩, ⟨352729, 352736⟩, ⟨118431, 118438⟩, ⟨641, 649⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-146377855), (-146377854)⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4148589441, 4148589442⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5479140, 5479141⟩, ⟨10975054, 10975056⟩, ⟨5521122, 5521126⟩, ⟨33694, 33698⟩, ⟨8544, 8551⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300446436, 4300446437⟩, ⟨10975054, 10975056⟩, ⟨5521122, 5521126⟩, ⟨33694, 33698⟩, ⟨8544, 8551⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297705992, 4297705994⟩, ⟨5484030, 5484032⟩, ⟨2755302, 2755306⟩, ⟨13319, 13323⟩, ⟨3367, 3373⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4151234798, 4151234802⟩, ⟨(-141174067), (-141174062)⟩, ⟨2474494, 2474500⟩, ⟨(-81040), (-81035)⟩, ⟨2797, 2806⟩⟩
...
def j47 : Jet := ⟨⟨1730900054, 1730900068⟩, ⟨1730900054, 1730900068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨697564100, 697564112⟩, ⟨1395128200, 1395128224⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨697564100, 697564112⟩, ⟨1395128200, 1395128224⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-697564112), (-697564100)⟩, ⟨(-1395128224), (-1395128200)⟩, ⟨(-697564112), (-697564100)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-348782056), (-348782050)⟩, ⟨(-697564112), (-697564100)⟩, ⟨(-348782056), (-348782050)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3959971349, 3959971356⟩, ⟨(-643155981), (-643155968)⟩, ⟨(-269349128), (-269349119)⟩, ⟨49401291, 49401294⟩, ⟨8930667, 8930669⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3827449600, 3827449612⟩, ⟨(-751795424), (-751795404)⟩, ⟨(-236913471), (-236913453)⟩, ⟨56156202, 56156216⟩, ⟨6867524, 6867541⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 292755709⟩, ⟨146377854, 146377855⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 919719185⟩, ⟨459859590, 459859594⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 196947572⟩, ⟨0, 196947574⟩, ⟨49236892, 49236894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 50⟩, ⟨0, 50⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94636)⟩, ⟨0, 50⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-4342), 0⟩, ⟨(-4342), 3⟩, ⟨(-1086), (-1080)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108714, 5113057⟩, ⟨(-4342), 3⟩, ⟨(-1086), (-1080)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 234462⟩, ⟨(-200), 234463⟩, ⟨58315, 58617⟩, ⟨(-100), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142931114)⟩, ⟨(-200), 234463⟩, ⟨58315, 58617⟩, ⟨(-100), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6564920), 0⟩, ⟨(-6564930), 10752⟩, ⟨(-1641240), (-1625101)⟩, ⟨(-8), 5377⟩, ⟨662, 673⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425090845, 1431655766⟩, ⟨(-6564930), 10752⟩, ⟨(-1641240), (-1625101)⟩, ⟨(-8), 5377⟩, ⟨662, 673⟩⟩
...
def j72 : Jet := ⟨⟨0, 543⟩, ⟨(-1), 543⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851633)⟩, ⟨(-1), 543⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-39077), 0⟩, ⟨(-39078), 25⟩, ⟨(-9771), (-9730)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35752317, 35791395⟩, ⟨(-39078), 25⟩, ⟨(-9771), (-9730)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1641230⟩, ⟨(-1792), 1641232⟩, ⟨407618, 410310⟩, ⟨(-898), 2⟩, ⟨(-115), (-109)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714186652)⟩, ⟨(-1792), 1641232⟩, ⟨407618, 410310⟩, ⟨(-898), 2⟩, ⟨(-115), (-109)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-32824596), 0⟩, ⟨(-32824679), 75260⟩, ⟨(-8206233), (-8093258)⟩, ⟨(-63), 37631⟩, ⟨4624, 4705⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4262142700, 4294967296⟩, ⟨(-32824679), 75260⟩, ⟨(-8206233), (-8093258)⟩, ⟨(-63), 37631⟩, ⟨4624, 4705⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 306573062⟩, ⟨151177820, 153288835⟩, ⟨(-1054358), 1152⟩, ⟨(-175729), (-172846)⟩, ⟨(-1), 721⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4328044689⟩, ⟨(-76425), 33332220⟩, ⟨8092673, 8589827⟩, ⟨(-38514), 130397⟩, ⟨9919, 12886⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 308934114⟩, ⟨151172364, 156848620⟩, ⟨(-1065207), 1803939⟩, ⟨96836, 143055⟩, ⟨(-4850), 6308⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-292755709), 0⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4002211587, 4294967296⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22221424⟩, ⟨0, 22564032⟩, ⟨5167658, 5987495⟩, ⟨(-77802), 152338⟩, ⟨5670, 12116⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317188720⟩, ⟨0, 22564032⟩, ⟨5167658, 5987495⟩, ⟨(-77802), 152338⟩, ⟨5670, 12116⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306063674⟩, ⟨0, 11282016⟩, ⟨2562390, 2993748⟩, ⟨(-46765), 76169⟩, ⟨1586, 5417⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4002211587, 4306063674⟩, ⟨(-146756034), (-135095838)⟩, ⟨2003225, 2993748⟩, ⟨(-148796), (-11160)⟩, ⟨(-1119), 7011⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3461800123⟩, ⟨1730900054, 1730900068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2790256425⟩, ⟨0, 2790256436⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2790256425⟩, ⟨0, 2790256436⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2790256425), 0⟩, ⟨(-2790256436), 0⟩, ⟨(-697564112), (-697564100)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1395128213), 0⟩, ⟨(-1395128218), 0⟩, ⟨(-348782056), (-348782050)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3103763292, 4294967296⟩, ⟨(-1395128218), 0⟩, ⟨(-348782056), (-25458994)⟩, ⟨0, 113294388⟩, ⟨(-8166589), 14161799⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2892203026, 4306063674⟩, ⟨(-1545488673), (-97627170)⟩, ⟨(-348235530), 26940661⟩, ⟨(-320453), 125496669⟩, ⟨(-12303113), 14241859⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297705992, 4297705994⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2792
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306063674⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2793
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (31962477 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(5453 / 80000), prawitzNormalCorrection
