...
namespace FiniteNormalPanel94_10
...
def j2 : Jet := ⟨⟨504116752, 504116756⟩, ⟨504116752, 504116756⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨59170112, 59170114⟩, ⟨118340224, 118340228⟩, ⟨59170112, 59170114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1305), (-1304)⟩, ⟨(-2609), (-2607)⟩, ⟨(-1305), (-1302)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111751, 5111753⟩, ⟨(-2609), (-2607)⟩, ⟨(-1305), (-1302)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨70422, 70423⟩, ⟨140809, 140811⟩, ⟨70332, 70335⟩, ⟨(-72), (-69)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-143095155), (-143095153)⟩, ⟨140809, 140811⟩, ⟨70332, 70335⟩, ⟨(-72), (-69)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1971367), (-1971366)⟩, ⟨(-3940795), (-3940793)⟩, ⟨(-1966520), (-1966517)⟩, ⟨3875, 3878⟩, ⟨965, 968⟩⟩
...
def j19 : Jet := ⟨⟨1429684398, 1429684400⟩, ⟨(-3940795), (-3940793)⟩, ⟨(-1966520), (-1966517)⟩, ⟨3875, 3878⟩, ⟨965, 968⟩⟩
...
def j25 : Jet := ⟨⟨163, 164⟩, ⟨325, 327⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852014), (-852012)⟩, ⟨325, 327⟩, ⟨161, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11738), (-11737)⟩, ⟨(-23472), (-23470)⟩, ⟨(-11728), (-11724)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779656, 35779658⟩, ⟨(-23472), (-23470)⟩, ⟨(-11728), (-11724)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨492922, 492923⟩, ⟨985521, 985523⟩, ⟨492113, 492116⟩, ⟨(-648), (-645)⟩, ⟨(-162), (-159)⟩⟩
...
def j33 : Jet := ⟨⟨(-715334961), (-715334959)⟩, ⟨985521, 985523⟩, ⟨492113, 492116⟩, ⟨(-648), (-645)⟩, ⟨(-162), (-159)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9854895), (-9854894)⟩, ⟨(-19696213), (-19696211)⟩, ⟨(-9820962), (-9820959)⟩, ⟨27127, 27130⟩, ⟨6758, 6761⟩⟩
...
def j36 : Jet := ⟨⟨4285112401, 4285112402⟩, ⟨(-19696213), (-19696211)⟩, ⟨(-9820962), (-9820959)⟩, ⟨27127, 27130⟩, ⟨6758, 6761⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨167807530, 167807532⟩, ⟨167344983, 167344987⟩, ⟨(-693365), (-693362)⟩, ⟨(-230364), (-230361)⟩, ⟨567, 570⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304844854, 4304844856⟩, ⟨19786909, 19786913⟩, ⟨9957131, 9957137⟩, ⟨63860, 63867⟩, ⟨16195, 16203⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨168193453, 168193456⟩, ⟨168502931, 168502937⟩, ⟨465030, 465036⟩, ⟨156366, 156373⟩, ⟨1018, 1027⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-160465347), (-160465346)⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4134501949, 4134501950⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6586554, 6586556⟩, ⟨13197348, 13197350⟩, ⟨6647235, 6647241⟩, ⟨48734, 48738⟩, ⟨12396, 12403⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301553850, 4301553852⟩, ⟨13197348, 13197350⟩, ⟨6647235, 6647241⟩, ⟨48734, 48738⟩, ⟨12396, 12403⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298259311, 4298259313⟩, ⟨6593620, 6593622⟩, ⟨3316014, 3316018⟩, ⟨19261, 19265⟩, ⟨4883, 4889⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4137670970, 4137670974⟩, ⟨(-154241067), (-154241062)⟩, ⟨2945777, 2945783⟩, ⟨(-105350), (-105344)⟩, ⟨3980, 3988⟩⟩
...
def j47 : Jet := ⟨⟨1518933487, 1518933498⟩, ⟨1518933487, 1518933498⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨537177300, 537177309⟩, ⟨1074354600, 1074354618⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨537177300, 537177309⟩, ⟨1074354600, 1074354618⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-537177309), (-537177300)⟩, ⟨(-1074354618), (-1074354600)⟩, ⟨(-537177309), (-537177300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-268588655), (-268588650)⟩, ⟨(-537177309), (-537177300)⟩, ⟨(-268588655), (-268588650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4034604467, 4034604473⟩, ⟨(-504613383), (-504613372)⟩, ⟨(-220750358), (-220750350)⟩, ⟨30240736, 30240739⟩, ⟨5956822, 5956824⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3886843514, 3886843524⟩, ⟨(-631023630), (-631023612)⟩, ⟨(-191776829), (-191776811)⟩, ⟨36615750, 36615765⟩, ⟨4517363, 4517379⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 320930694⟩, ⟨160465346, 160465347⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1008233511⟩, ⟨504116752, 504116756⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 236680455⟩, ⟨0, 236680456⟩, ⟨59170112, 59170114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5218), 0⟩, ⟨(-5218), 4⟩, ⟨(-1305), (-1298)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107838, 5113057⟩, ⟨(-5218), 4⟩, ⟨(-1305), (-1298)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 281763⟩, ⟨(-288), 281764⟩, ⟨70008, 70442⟩, ⟨(-144), 2⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142883813)⟩, ⟨(-288), 281764⟩, ⟨70008, 70442⟩, ⟨(-144), 2⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7889349), 0⟩, ⟨(-7889365), 15528⟩, ⟨(-1972354), (-1949045)⟩, ⟨(-12), 7765⟩, ⟨955, 972⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423766416, 1431655766⟩, ⟨(-7889365), 15528⟩, ⟨(-1972354), (-1949045)⟩, ⟨(-12), 7765⟩, ⟨955, 972⟩⟩
...
def j72 : Jet := ⟨⟨0, 653⟩, ⟨(-1), 653⟩, ⟨160, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851523)⟩, ⟨(-1), 653⟩, ⟨160, 164⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-46961), 0⟩, ⟨(-46962), 36⟩, ⟨(-11742), (-11685)⟩, ⟨(-2), 19⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35744433, 35791395⟩, ⟨(-46962), 36⟩, ⟨(-11742), (-11685)⟩, ⟨(-2), 19⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1972338⟩, ⟨(-2588), 1972340⟩, ⟨489201, 493087⟩, ⟨(-1296), 3⟩, ⟨(-163), (-157)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713855544)⟩, ⟨(-2588), 1972340⟩, ⟨489201, 493087⟩, ⟨(-1296), 3⟩, ⟨(-163), (-157)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-39446743), 0⟩, ⟨(-39446886), 108689⟩, ⟨(-9861829), (-9698651)⟩, ⟨(-108), 54347⟩, ⟨6658, 6795⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4255520553, 4294967296⟩, ⟨(-39446886), 108689⟩, ⟨(-9861829), (-9698651)⟩, ⟨(-108), 54347⟩, ⟨6658, 6795⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 336077838⟩, ⟨165260904, 168042565⟩, ⟨(-1389011), 1823⟩, ⟨(-231506), (-226943)⟩, ⟨(-2), 1141⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4334779693⟩, ⟨(-110714), 40181586⟩, ⟨9697634, 10417973⟩, ⟨(-55884), 189801⟩, ⟨14017, 19187⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 339193127⟩, ⟨165252240, 172744422⟩, ⟨(-1406219), 2389162⟩, ⟨122123, 195553⟩, ⟨(-7726), 10092⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-320930694), 0⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3974036602, 4294967296⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 26787626⟩, ⟨0, 27284828⟩, ⟨6136097, 7325183⟩, ⟨(-113118), 223074⟩, ⟨7391, 18658⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4321754922⟩, ⟨0, 27284828⟩, ⟨6136097, 7325183⟩, ⟨(-113118), 223074⟩, ⟨7391, 18658⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4308340290⟩, ⟨0, 13642414⟩, ⟨3036925, 3662592⟩, ⟨(-68193), 111537⟩, ⟨1772, 8473⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3974036602, 4308340290⟩, ⟨(-160964979), (-146822932)⟩, ⟨2300300, 3662592⟩, ⟨(-205033), (-1926)⟩, ⟨(-2529), 11021⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3037866995⟩, ⟨1518933487, 1518933498⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2148709232⟩, ⟨0, 2148709234⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2148709232⟩, ⟨0, 2148709234⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2148709232), 0⟩, ⟨(-2148709234), 0⟩, ⟨(-537177309), (-537177300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1074354616), 0⟩, ⟨(-1074354617), 0⟩, ⟨(-268588655), (-268588650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3344446681, 4294967296⟩, ⟨(-1074354617), 0⟩, ⟨(-268588655), (-74776238)⟩, ⟨0, 67185486⟩, ⟨(-1863399), 8398186⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3094541263, 4308340290⟩, ⟨(-1238664753), (-114329500)⟩, ⟨(-267633726), (-25261967)⟩, ⟨1435012, 77459232⟩, ⟨(-4618723), 8446596⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298259311, 4298259313⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1898
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4308340290⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1899
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (285784215 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(29889 / 400000), prawitzNormalCorrection
