...
namespace FiniteNormalPanel13_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1917 / 8000)
def radius : Rat := (1917 / 40000)

def j0 : Jet := ⟨⟨1029181538, 1029181539⟩, ⟨205836307, 205836308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3233269158, 3233269163⟩, ⟨646653829, 646653834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2434018405, 2434018413⟩, ⟨973607358, 973607368⟩, ⟨97360735, 97360737⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨609, 610⟩, ⟨243, 244⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94078), (-94076)⟩, ⟨243, 244⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-53316), (-53314)⟩, ⟨(-21190), (-21186)⟩, ⟨(-2065), (-2061)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5059740, 5059743⟩, ⟨(-21190), (-21186)⟩, ⟨(-2065), (-2061)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2867425, 2867428⟩, ⟨1134961, 1134966⟩, ⟨108722, 108729⟩, ⟨(-945), (-940)⟩, ⟨(-45), (-42)⟩⟩
...
def j16 : Jet := ⟨⟨(-140298152), (-140298148)⟩, ⟨1134961, 1134966⟩, ⟨108722, 108729⟩, ⟨(-945), (-940)⟩, ⟨(-45), (-42)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-79508938), (-79508934)⟩, ⟨(-31160377), (-31160371)⟩, ⟨(-2861465), (-2861457)⟩, ⟨49836, 49845⟩, ⟨2223, 2229⟩⟩
...
def j19 : Jet := ⟨⟨1352146827, 1352146832⟩, ⟨(-31160377), (-31160371)⟩, ⟨(-2861465), (-2861457)⟩, ⟨49836, 49845⟩, ⟨2223, 2229⟩⟩
...
def j22 : Jet := ⟨⟨(-62), (-60)⟩, ⟨(-25), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11773, 11776⟩, ⟨(-25), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6671, 6674⟩, ⟨2653, 2657⟩, ⟨258, 261⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845506), (-845502)⟩, ⟨2653, 2657⟩, ⟨258, 261⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-479161), (-479157)⟩, ⟨(-190162), (-190157)⟩, ⟨(-18420), (-18415)⟩, ⟨116, 121⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35312233, 35312238⟩, ⟨(-190162), (-190157)⟩, ⟨(-18420), (-18415)⟩, ⟨116, 121⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20011939, 20011943⟩, ⟨7897007, 7897013⟩, ⟨746931, 746937⟩, ⟨(-8422), (-8415)⟩, ⟨(-391), (-385)⟩⟩
...
def j33 : Jet := ⟨⟨(-695815944), (-695815939)⟩, ⟨7897007, 7897013⟩, ⟨746931, 746937⟩, ⟨(-8422), (-8415)⟩, ⟨(-391), (-385)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-394328689), (-394328684)⟩, ⟨(-153256132), (-153256123)⟩, ⟨(-13559715), (-13559707)⟩, ⟨343558, 343566⟩, ⟨14799, 14807⟩⟩
...
def j36 : Jet := ⟨⟨3900638607, 3900638612⟩, ⟨(-153256132), (-153256123)⟩, ⟨(-13559715), (-13559707)⟩, ⟨343558, 343566⟩, ⟨14799, 14807⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1017901728, 1017901734⟩, ⟨180122683, 180122692⟩, ⟨(-6845656), (-6845647)⟩, ⟨(-393309), (-393299)⟩, ⟨9176, 9184⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4729159993, 4729160000⟩, ⟨185808734, 185808747⟩, ⟨23740304, 23740318⟩, ⟨1162135, 1162151⟩, ⟨93868, 93883⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1120804839, 1120804848⟩, ⟨242368322, 242368337⟩, ⟨5881175, 5881192⟩, ⟨541819, 541839⟩, ⟨26230, 26250⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1029181539), (-1029181538)⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3265785757, 3265785758⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨292482666, 292482672⟩, ⟨126495764, 126495776⟩, ⟨16746505, 16746520⟩, ⟨946540, 946558⟩, ⟨82891, 82910⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4587449962, 4587449968⟩, ⟨126495764, 126495776⟩, ⟨16746505, 16746520⟩, ⟨946540, 946558⟩, ⟨82891, 82910⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4438800238, 4438800242⟩, ⟨61198425, 61198432⟩, ⟨7680052, 7680061⟩, ⟨352047, 352058⟩, ⟨28603, 28615⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3375152730, 3375152735⟩, ⟨(-166195750), (-166195742)⟩, ⟨2906784, 2906793⟩, ⟨(-100380), (-100369)⟩, ⟨4876, 4888⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨21558516357, 21558516362⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value144

def j47 : Jet := ⟨⟨5165959480, 5165959487⟩, ⟨1033191893, 1033191899⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6213583366, 6213583384⟩, ⟨2485433338, 2485433358⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6213583366, 6213583384⟩, ⟨2485433338, 2485433358⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6213583384), (-6213583366)⟩, ⟨(-2485433358), (-2485433338)⟩, ⟨(-248543337), (-248543333)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3106791692), (-3106791683)⟩, ⟨(-1242716679), (-1242716669)⟩, ⟨(-124271669), (-124271666)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2083580126, 2083580138⟩, ⟨(-602868337), (-602868328)⟩, ⟨26930886, 26930892⟩, ⟨9031611, 9031614⟩, ⟨(-1042921), (-1042919)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1637358486, 1637358499⟩, ⟨(-554382542), (-554382527)⟩, ⟨45901750, 45901763⟩, ⟨5598574, 5598587⟩, ⟨(-1134372), (-1134359)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨823345230, 1235017846⟩, ⟨205836307, 205836308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2586615325, 3879922993⟩, ⟨646653829, 646653834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1557771777, 3504986510⟩, ⟨778885886, 1168328840⟩, ⟨97360735, 97360737⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨389, 879⟩, ⟨194, 293⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94298), (-93807)⟩, ⟨194, 293⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-76954), (-34023)⟩, ⟨(-25582), (-16771)⟩, ⟨(-2095), (-2025)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5036102, 5079034⟩, ⟨(-25582), (-16771)⟩, ⟨(-2095), (-2025)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1826579, 4144839⟩, ⟨892412, 1375531⟩, ⟨105492, 111360⟩, ⟨(-1148), (-735)⟩, ⟨(-47), (-40)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141338998), (-139020737)⟩, ⟨892412, 1375531⟩, ⟨105492, 111360⟩, ⟨(-1148), (-735)⟩, ⟨(-47), (-40)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-115342271), (-50422405)⟩, ⟨(-38123749), (-24088674)⟩, ⟨(-3003854), (-2686346)⟩, ⟨38422, 61209⟩, ⟨2039, 2378⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1316313494, 1381233361⟩, ⟨(-38123749), (-24088674)⟩, ⟨(-3003854), (-2686346)⟩, ⟨38422, 61209⟩, ⟨2039, 2378⟩⟩
...
def j70 : Jet := ⟨⟨(-89), (-38)⟩, ⟨(-30), (-19)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11746, 11798⟩, ⟨(-30), (-19)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4260, 9628⟩, ⟨2105, 3204⟩, ⟨254, 265⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847917), (-842548)⟩, ⟨2105, 3204⟩, ⟨254, 265⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-691959), (-305589)⟩, ⟨(-229890), (-150179)⟩, ⟨(-18749), (-18010)⟩, ⟨91, 146⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35099435, 35485806⟩, ⟨(-229890), (-150179)⟩, ⟨(-18749), (-18010)⟩, ⟨91, 146⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12730459, 28958841⟩, ⟨6177623, 9598478⟩, ⟨717816, 770647⟩, ⟨(-10280), (-6550)⟩, ⟨(-409), (-362)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703097424), (-686869041)⟩, ⟨6177623, 9598478⟩, ⟨717816, 770647⟩, ⟨(-10280), (-6550)⟩, ⟨(-409), (-362)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-573775496), (-249125344)⟩, ⟨(-189017894), (-116729657)⟩, ⟨(-14557558), (-12330427)⟩, ⟨261821, 424843⟩, ⟨13140, 16152⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3721191800, 4045841952⟩, ⟨(-189017894), (-116729657)⟩, ⟨(-14557558), (-12330427)⟩, ⟨261821, 424843⟩, ⟨13140, 16152⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨792740996, 1247757831⟩, ⟨163745588, 193452398⟩, ⟨(-8453521), (-5244643)⟩, ⟨(-429124), (-349163)⟩, ⟨7011, 11365⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4559432694, 4957213997⟩, ⟨131547652, 251801628⟩, ⟨17691066, 32183224⟩, ⟨390788, 2299015⟩, ⟨18957, 217328⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨841554537, 1440151266⟩, ⟨198108656, 296433547⟩, ⟨(-1476411), 15123725⟩, ⟨(-244298), 1586192⟩, ⟨(-62666), 147512⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1235017846), (-823345230)⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3059949450, 3471622066⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨164893930, 482899060⟩, ⟨77634694, 198795064⟩, ⟨8147797, 30601806⟩, ⟨(-367634), 3151382⟩, ⟨(-80949), 371137⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4459861226, 4777866356⟩, ⟨77634694, 198795064⟩, ⟨8147797, 30601806⟩, ⟨(-367634), 3151382⟩, ⟨(-80949), 371137⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4376637763, 4529986727⟩, ⟨36803471, 97542720⟩, ⟨2812363, 14860639⟩, ⟨(-511588), 1522639⟩, ⟨(-98885), 192605⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3118135574, 3661588273⟩, ⟨(-190878983), (-130906583)⟩, ⟨(-2671067), 10248049⟩, ⟨(-1125714), 1095968⟩, ⟨(-152902), 180201⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4132767582, 6199151381⟩, ⟨1033191893, 1033191899⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3976693350, 8947560062⟩, ⟨1988346670, 2982520028⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3976693350, 8947560062⟩, ⟨1988346670, 2982520028⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8947560062), (-3976693350)⟩, ⟨(-2982520028), (-1988346670)⟩, ⟨(-248543337), (-248543333)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4473780031), (-1988346675)⟩, ⟨(-1491260014), (-994173335)⟩, ⟨(-124271669), (-124271666)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1515599168, 2703361250⟩, ⟨(-938636842), (-350821828)⟩, ⟨(-37616669), 119099804⟩, ⟨(-7017078), 22459479⟩, ⟨(-3672577), 1153307⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1100321226, 2304696444⟩, ⟨(-920360094), (-300889818)⟩, ⟨(-23057856), 149701879⟩, ⟨(-14223558), 22092733⟩, ⟨(-4554651), 1938708⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1029181538, 1029181539⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4438800238, 4438800242⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar144 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified260
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar144 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨823345230, 1235017846⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4376637763, 4529986727⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified261
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((1917 / 10000) : ℝ)..(5751 / 20000), prawitzNormalCorrection
      ((1449 / 500) * sqrt n) s) ≤ (upper : ℝ) :=
