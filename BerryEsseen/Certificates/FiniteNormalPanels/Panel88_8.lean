...
namespace FiniteNormalPanel88_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3821 / 20000)
def radius : Rat := (3821 / 100000)

def j0 : Jet := ⟨⟨820553501, 820553502⟩, ⟨164110700, 164110701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2577844850, 2577844854⟩, ⟨515568969, 515568973⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1547225767, 1547225773⟩, ⟨618890304, 618890312⟩, ⟨61889030, 61889032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨387, 388⟩, ⟨154, 156⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94300), (-94298)⟩, ⟨154, 156⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-33971), (-33970)⟩, ⟨(-13534), (-13531)⟩, ⟨(-1332), (-1329)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5079085, 5079087⟩, ⟨(-13534), (-13531)⟩, ⟨(-1332), (-1329)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1829697, 1829699⟩, ⟨727003, 727006⟩, ⟨70756, 70761⟩, ⟨(-387), (-382)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-141335880), (-141335877)⟩, ⟨727003, 727006⟩, ⟨70756, 70761⟩, ⟨(-387), (-382)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-50915060), (-50915058)⟩, ⟨(-20104128), (-20104125)⟩, ⟨(-1906356), (-1906350)⟩, ⟨20530, 20536⟩, ⟨955, 959⟩⟩
...
def j19 : Jet := ⟨⟨1380740705, 1380740708⟩, ⟨(-20104128), (-20104125)⟩, ⟨(-1906356), (-1906350)⟩, ⟨20530, 20536⟩, ⟨955, 959⟩⟩
...
def j22 : Jet := ⟨⟨(-39), (-38)⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11796, 11798⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4249, 4251⟩, ⟨1693, 1696⟩, ⟨165, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847928), (-847925)⟩, ⟨1693, 1696⟩, ⟨165, 169⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-305459), (-305457)⟩, ⟨(-121575), (-121572)⟩, ⟨(-11917), (-11912)⟩, ⟨46, 50⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35485935, 35485938⟩, ⟨(-121575), (-121572)⟩, ⟨(-11917), (-11912)⟩, ⟨46, 50⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12783508, 12783511⟩, ⟨5069606, 5069610⟩, ⟨489528, 489532⟩, ⟨(-3454), (-3448)⟩, ⟨(-166), (-161)⟩⟩
...
def j33 : Jet := ⟨⟨(-703044375), (-703044371)⟩, ⟨5069606, 5069610⟩, ⟨489528, 489532⟩, ⟨(-3454), (-3448)⟩, ⟨(-166), (-161)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-253265812), (-253265808)⟩, ⟨(-99480043), (-99480038)⟩, ⟨(-9223772), (-9223768)⟩, ⟨142345, 142350⟩, ⟨6495, 6501⟩⟩
...
def j36 : Jet := ⟨⟨4041701484, 4041701488⟩, ⟨(-99480043), (-99480038)⟩, ⟨(-9223772), (-9223768)⟩, ⟨142345, 142350⟩, ⟨6495, 6501⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨828722332, 828722336⟩, ⟨153677942, 153677947⟩, ⟨(-3557503), (-3557497)⟩, ⟨(-216518), (-216512)⟩, ⟨3037, 3042⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4564103541, 4564103546⟩, ⟨112338131, 112338139⟩, ⟨13180990, 13180998⟩, ⟨420050, 420061⟩, ⟨29120, 29132⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨880652696, 880652702⟩, ⟨184983749, 184983758⟩, ⟨2782432, 2782443⟩, ⟨229541, 229553⟩, ⟨7292, 7306⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-820553502), (-820553501)⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3474413794, 3474413795⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨180571612, 180571616⟩, ⟨75859220, 75859226⟩, ⟨9108264, 9108272⟩, ⟨333808, 333818⟩, ⟨24564, 24575⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4475538908, 4475538912⟩, ⟨75859220, 75859226⟩, ⟨9108264, 9108272⟩, ⟨333808, 333818⟩, ⟨24564, 24575⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4384323578, 4384323581⟩, ⟨37156571, 37156575⟩, ⟨4303866, 4303871⟩, ⟨127027, 127034⟩, ⟨8842, 8850⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3546698558, 3546698562⟩, ⟨(-137467197), (-137467191)⟩, ⟨2061859, 2061865⟩, ⟨(-61693), (-61685)⟩, ⟨2298, 2307⟩⟩
...
def j47 : Jet := ⟨⟨6465378994, 6465379004⟩, ⟨1293075797, 1293075806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9732582964, 9732582995⟩, ⟨3893033180, 3893033214⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9732582964, 9732582995⟩, ⟨3893033180, 3893033214⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9732582995), (-9732582964)⟩, ⟨(-3893033214), (-3893033180)⟩, ⟨(-389303323), (-389303317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4866291498), (-4866291482)⟩, ⟨(-1946516607), (-1946516590)⟩, ⟨(-194651662), (-194651658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1383231123, 1383231142⟩, ⟨(-626892408), (-626892393)⟩, ⟨79367305, 79367313⟩, ⟨6950886, 6950890⟩, ⟨(-2586049), (-2586048)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1142244746, 1142244764⟩, ⟨(-561947775), (-561947758)⟩, ⟨86268658, 86268671⟩, ⟨2878808, 2878818⟩, ⟨(-2310139), (-2310130)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨656442801, 984664203⟩, ⟨164110700, 164110701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2062275881, 3093413827⟩, ⟨515568969, 515568973⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨990224492, 2228005116⟩, ⟨495112244, 742668376⟩, ⟨61889030, 61889032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨247, 559⟩, ⟨123, 187⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94440), (-94127)⟩, ⟨123, 187⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-48991), (-21701)⟩, ⟨(-16303), (-10752)⟩, ⟨(-1344), (-1314)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5064065, 5091356⟩, ⟨(-16303), (-10752)⟩, ⟨(-1344), (-1314)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1167543, 2641131⟩, ⟨575313, 877899⟩, ⟨69453, 71824⟩, ⟨(-468), (-301)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141998034), (-140524445)⟩, ⟨575313, 877899⟩, ⟨69453, 71824⟩, ⟨(-468), (-301)⟩, ⟨(-20), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-73661178), (-32398558)⟩, ⟨(-24421085), (-15743869)⟩, ⟨(-1963812), (-1835847)⟩, ⟨16053, 25002⟩, ⟨908, 998⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1357994587, 1399257208⟩, ⟨(-24421085), (-15743869)⟩, ⟨(-1963812), (-1835847)⟩, ⟨16053, 25002⟩, ⟨908, 998⟩⟩
...
def j72 : Jet := ⟨⟨2715, 6128⟩, ⟨1347, 2041⟩, ⟨163, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849462), (-846048)⟩, ⟨1347, 2041⟩, ⟨163, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-440657), (-195060)⟩, ⟨(-146576), (-96471)⟩, ⟨(-12049), (-11749)⟩, ⟨35, 60⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35350737, 35596335⟩, ⟨(-146576), (-96471)⟩, ⟨(-12049), (-11749)⟩, ⟨35, 60⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8150275, 18465523⟩, ⟨3999101, 6132934⟩, ⟨477795, 499104⟩, ⟨(-4189), (-2712)⟩, ⟨(-170), (-156)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707677608), (-697362359)⟩, ⟨3999101, 6132934⟩, ⟨477795, 499104⟩, ⟨(-4189), (-2712)⟩, ⟨(-170), (-156)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-367106249), (-160780103)⟩, ⟨(-121446740), (-77208604)⟩, ⟨(-9626234), (-8729363)⟩, ⟨110529, 174053⟩, ⟨6070, 6845⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3927861047, 4134187193⟩, ⟨(-121446740), (-77208604)⟩, ⟨(-9626234), (-8729363)⟩, ⟨110529, 174053⟩, ⟨6070, 6845⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨652056067, 1007803156⟩, ⟨145424936, 160407602⟩, ⟨(-4345933), (-2771400)⟩, ⟨(-228029), (-202367)⟩, ⟨2362, 3721⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4462000197, 4696384076⟩, ⟨83330721, 145208940⟩, ⟨10977796, 15999459⟩, ⟨183246, 725007⟩, ⟨12710, 52389⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨677414773, 1101994583⟩, ⟨163731722, 209472547⟩, ⟨(-263955), 6298289⟩, ⟨3246, 503660⟩, ⟨(-13314), 32431⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-984664203), (-656442801)⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3310303093, 3638524495⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨106843834, 282747686⟩, ⟨51648488, 107492140⟩, ⟨6106289, 13448326⟩, ⟨(-24726), 872814⟩, ⟨(-6976), 75011⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4401811130, 4577714982⟩, ⟨51648488, 107492140⟩, ⟨6106289, 13448326⟩, ⟨(-24726), 872814⟩, ⟨(-6976), 75011⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4348061044, 4434087972⟩, ⟨25014001, 53089783⟩, ⟨2639526, 6570104⟩, ⟨(-92434), 415894⟩, ⟨(-13488), 37376⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3351224568, 3756381967⟩, ⟨(-150147212), (-121163871)⟩, ⟨5827, 4610146⟩, ⟨(-329351), 251473⟩, ⟨(-27319), 35196⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5172303197, 7758454809⟩, ⟨1293075797, 1293075806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6228853101, 14014919527⟩, ⟨3114426544, 4671639860⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6228853101, 14014919527⟩, ⟨3114426544, 4671639860⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14014919527), (-6228853101)⟩, ⟨(-4671639860), (-3114426544)⟩, ⟨(-389303323), (-389303317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7007459764), (-3114426550)⟩, ⟨(-2335819930), (-1557213272)⟩, ⟨(-194651662), (-194651658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨840206630, 2079879594⟩, ⟨(-1131143470), (-304631170)⟩, ⟨(-39037357), 269507551⟩, ⟨(-39653169), 41253101⟩, ⟨(-11716039), 6275953⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨655586156, 1819064422⟩, ⟨(-1062009265), (-261396669)⟩, ⟨(-25547120), 277487537⟩, ⟨(-45476018), 37566065⟩, ⟨(-11810383), 7268255⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨820553501, 820553502⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4384323578, 4384323581⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1778
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨656442801, 984664203⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4348061044, 4434087972⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1779
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (11199873 / 536870912)

theorem envelope_integral : (∫ s in ((3821 / 25000) : ℝ)..(11463 / 50000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (11463 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((3821 / 25000) : ℝ)..(11463 / 50000), prawitzNormalCorrection
