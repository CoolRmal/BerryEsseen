...
namespace FiniteNormalPanel50_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (39799 / 400000)
def radius : Rat := (39799 / 400000)

def j0 : Jet := ⟨⟨427338508, 427338509⟩, ⟨427338508, 427338509⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1342523517, 1342523521⟩, ⟨1342523517, 1342523521⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨419646826, 419646829⟩, ⟨839293652, 839293658⟩, ⟨419646826, 419646829⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨105, 106⟩, ⟨210, 211⟩, ⟨105, 106⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94582), (-94580)⟩, ⟨210, 211⟩, ⟨105, 106⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9242), (-9241)⟩, ⟨(-18463), (-18461)⟩, ⟨(-9191), (-9188)⟩, ⟨40, 42⟩, ⟨10, 11⟩⟩
...
def j13 : Jet := ⟨⟨5103814, 5103816⟩, ⟨(-18463), (-18461)⟩, ⟨(-9191), (-9188)⟩, ⟨40, 42⟩, ⟨10, 11⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨498676, 498677⟩, ⟨995549, 995551⟩, ⟨494169, 494173⟩, ⟨(-3598), (-3593)⟩, ⟨(-892), (-886)⟩⟩
...
def j16 : Jet := ⟨⟨(-142666901), (-142666899)⟩, ⟨995549, 995551⟩, ⟨494169, 494173⟩, ⟨(-3598), (-3593)⟩, ⟨(-892), (-886)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13939504), (-13939503)⟩, ⟨(-27781737), (-27781734)⟩, ⟨(-13696678), (-13696675)⟩, ⟨193486, 193489⟩, ⟨47491, 47496⟩⟩
...
def j19 : Jet := ⟨⟨1417716261, 1417716263⟩, ⟨(-27781737), (-27781734)⟩, ⟨(-13696678), (-13696675)⟩, ⟨193486, 193489⟩, ⟨47491, 47496⟩⟩
...
def j22 : Jet := ⟨⟨(-11), (-10)⟩, ⟨(-22), (-20)⟩, ⟨(-11), (-10)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11824, 11826⟩, ⟨(-22), (-20)⟩, ⟨(-11), (-10)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1155, 1156⟩, ⟨2307, 2310⟩, ⟨1148, 1153⟩, ⟨(-6), (-2)⟩, ⟨(-2), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851022), (-851020)⟩, ⟨2307, 2310⟩, ⟨1148, 1153⟩, ⟨(-6), (-2)⟩, ⟨(-2), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-83151), (-83150)⟩, ⟨(-166077), (-166074)⟩, ⟨(-82589), (-82585)⟩, ⟨448, 452⟩, ⟨109, 113⟩⟩
...
def j30 : Jet := ⟨⟨35708243, 35708245⟩, ⟨(-166077), (-166074)⟩, ⟨(-82589), (-82585)⟩, ⟨448, 452⟩, ⟨109, 113⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3488932, 3488933⟩, ⟨6961637, 6961640⟩, ⟨3448408, 3448411⟩, ⟨(-32323), (-32319)⟩, ⟨(-7973), (-7968)⟩⟩
...
def j33 : Jet := ⟨⟨(-712338951), (-712338949)⟩, ⟨6961637, 6961640⟩, ⟨3448408, 3448411⟩, ⟨(-32323), (-32319)⟩, ⟨(-7973), (-7968)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-69600247), (-69600245)⟩, ⟨(-138520295), (-138520292)⟩, ⟨(-67902919), (-67902915)⟩, ⟨1350903, 1350908⟩, ⟨329835, 329840⟩⟩
...
def j36 : Jet := ⟨⟨4225367049, 4225367051⟩, ⟨(-138520295), (-138520292)⟩, ⟨(-67902919), (-67902915)⟩, ⟨1350903, 1350908⟩, ⟨329835, 329840⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨443150620, 443150623⟩, ⟨434466587, 434466592⟩, ⟨(-12965350), (-12965346)⟩, ⟨(-4220838), (-4220834)⟩, ⟨75323, 75328⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4365713996, 4365713999⟩, ⟨143121288, 143121293⟩, ⟨74850278, 74850286⟩, ⟨3358039, 3358049⟩, ⟨926396, 926408⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨450450196, 450450201⟩, ⟨456390237, 456390245⟩, ⟨9021803, 9021812⟩, ⟨3195709, 3195719⟩, ⟨145231, 145244⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-427338509), (-427338508)⟩, ⟨(-427338509), (-427338508)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3867628787, 3867628788⟩, ⟨(-427338509), (-427338508)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨47242590, 47242592⟩, ⟨95731146, 95731150⟩, ⟨50389159, 50389166⟩, ⟨2587664, 2587672⟩, ⟨728574, 728583⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4342209886, 4342209888⟩, ⟨95731146, 95731150⟩, ⟨50389159, 50389166⟩, ⟨2587664, 2587672⟩, ⟨728574, 728583⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4318523990, 4318523992⟩, ⟨47604475, 47604478⟩, ⟨24794768, 24794773⟩, ⟨1013453, 1013459⟩, ⟨279948, 279955⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3888841648, 3888841652⟩, ⟨(-386814394), (-386814388)⟩, ⟨17591223, 17591230⟩, ⟨(-1554402), (-1554394)⟩, ⟨151256, 151265⟩⟩
...
def j47 : Jet := ⟨⟨1996017230, 1996017236⟩, ⟨1996017230, 1996017236⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨927617024, 927617030⟩, ⟨1855234048, 1855234060⟩, ⟨927617024, 927617030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨927617024, 927617030⟩, ⟨1855234048, 1855234060⟩, ⟨927617024, 927617030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-927617030), (-927617024)⟩, ⟨(-1855234060), (-1855234048)⟩, ⟨(-927617030), (-927617024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-463808515), (-463808512)⟩, ⟨(-927617030), (-927617024)⟩, ⟨(-463808515), (-463808512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3855324214, 3855324218⟩, ⟨(-832663943), (-832663936)⟩, ⟨(-326413564), (-326413558)⟩, ⟨83444951, 83444954⟩, ⟨13118948, 13118950⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3490770554, 3490770562⟩, ⟨(-1101147646), (-1101147631)⟩, ⟨(-204766265), (-204766248)⟩, ⟨100146361, 100146378⟩, ⟨3463404, 3463421⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 854677018⟩, ⟨427338508, 427338509⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2685047042⟩, ⟨1342523517, 1342523521⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1678587315⟩, ⟨0, 1678587316⟩, ⟨419646826, 419646829⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 421⟩, ⟨0, 421⟩, ⟨105, 106⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94265)⟩, ⟨0, 421⟩, ⟨105, 106⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-37007), 0⟩, ⟨(-37007), 165⟩, ⟨(-9252), (-9003)⟩, ⟨0, 84⟩, ⟨10, 11⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5076049, 5113057⟩, ⟨(-37007), 165⟩, ⟨(-9252), (-9003)⟩, ⟨0, 84⟩, ⟨10, 11⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1998319⟩, ⟨(-14464), 1998384⟩, ⟨477883, 499645⟩, ⟨(-7232), 50⟩, ⟨(-904), (-841)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141167257)⟩, ⟨(-14464), 1998384⟩, ⟨477883, 499645⟩, ⟨(-7232), 50⟩, ⟨(-904), (-841)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-55952911), 0⟩, ⟨(-55958564), 781022⟩, ⟨(-13993881), (-12816681)⟩, ⟨(-4241), 390551⟩, ⟨43511, 48839⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1375702854, 1431655766⟩, ⟨(-55958564), 781022⟩, ⟨(-13993881), (-12816681)⟩, ⟨(-4241), 390551⟩, ⟨43511, 48839⟩⟩
...
def j70 : Jet := ⟨⟨(-43), 0⟩, ⟨(-43), 0⟩, ⟨(-11), (-10)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11792, 11836⟩, ⟨(-43), 0⟩, ⟨(-11), (-10)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 4626⟩, ⟨(-17), 4626⟩, ⟨1130, 1157⟩, ⟨(-10), 0⟩, ⟨(-2), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-847550)⟩, ⟨(-17), 4626⟩, ⟨1130, 1157⟩, ⟨(-10), 0⟩, ⟨(-2), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-333054), 0⟩, ⟨(-333061), 1808⟩, ⟨(-83271), (-80550)⟩, ⟨(-6), 905⟩, ⟨105, 114⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35458340, 35791395⟩, ⟨(-333061), 1808⟩, ⟨(-83271), (-80550)⟩, ⟨(-6), 905⟩, ⟨105, 114⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 13988228⟩, ⟨(-130170), 13988935⟩, ⟨3301800, 3497764⟩, ⟨(-65091), 531⟩, ⟨(-8140), (-7471)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-701839654)⟩, ⟨(-130170), 13988935⟩, ⟨3301800, 3497764⟩, ⟨(-65091), 531⟩, ⟨(-8140), (-7471)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-279764553), 0⟩, ⟨(-279815427), 5467248⟩, ⟨(-69992013), (-61740126)⟩, ⟨(-38159), 2734040⟩, ⟨293985, 341963⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4015202743, 4294967296⟩, ⟨(-279815427), 5467248⟩, ⟨(-69992013), (-61740126)⟩, ⟨(-38159), 2734040⟩, ⟨293985, 341963⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 895015682⟩, ⟨395034918, 447996106⟩, ⟨(-26239995), 244133⟩, ⟨(-4376868), (-3762088)⟩, ⟨(-1326), 152612⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4594224814⟩, ⟨(-6255667), 320166892⟩, ⟨61332571, 102397490⟩, ⟨(-3376787), 12760712⟩, ⟨92059, 2364042⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 957377082⟩, ⟨393731317, 545929470⟩, ⟨(-28720814), 54995177⟩, ⟨(-1700426), 9616097⟩, ⟨(-1305511), 1999113⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-854677018), 0⟩, ⟨(-427338509), (-427338508)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3440290278, 4294967296⟩, ⟨(-427338509), (-427338508)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 213405788⟩, ⟨0, 243382698⟩, ⟨23290293, 93910199⟩, ⟨(-8059430), 18267762⟩, ⟨(-1382054), 4040010⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4508373084⟩, ⟨0, 243382698⟩, ⟨23290293, 93910199⟩, ⟨(-8059430), 18267762⟩, ⟨(-1382054), 4040010⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4400376684⟩, ⟨0, 121691349⟩, ⟨9683518, 46955100⟩, ⟨(-5360117), 9133881⟩, ⟨(-1206493), 2160960⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3440290278, 4400376684⟩, ⟨(-437826480), (-305647159)⟩, ⟨(-4351440), 46955100⟩, ⟨(-10032033), 8170396⟩, ⟨(-2115292), 2694279⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3992034472⟩, ⟨1996017230, 1996017236⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3710468120⟩, ⟨0, 3710468120⟩, ⟨927617024, 927617030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3710468120⟩, ⟨0, 3710468120⟩, ⟨927617024, 927617030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3710468120), 0⟩, ⟨(-3710468120), 0⟩, ⟨(-927617030), (-927617024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1855234060), 0⟩, ⟨(-1855234060), 0⟩, ⟨(-463808515), (-463808512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2788457566, 4294967296⟩, ⟨(-1855234060), 0⟩, ⟨(-463808515), 99566848⟩, ⟨(-14336144), 200344565⟩, ⟨(-27011031), 26591215⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2233568452, 4400376684⟩, ⟨(-2338592689), (-198437863)⟩, ⟨(-479542993), 338087058⟩, ⟨(-55152317), 262591925⟩, ⟨(-58812126), 36821444⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨427338508, 427338509⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨427338508, 427338509⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4318523990, 4318523992⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified980
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 854677018⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4400376684⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified981
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (682528859 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(39799 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(39799 / 200000), prawitzNormalCorrection
