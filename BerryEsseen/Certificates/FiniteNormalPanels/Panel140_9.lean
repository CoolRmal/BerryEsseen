...
namespace FiniteNormalPanel140_9
...
def j2 : Jet := ⟨⟨451089115, 451089119⟩, ⟨451089115, 451089119⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨47376702, 47376704⟩, ⟨94753404, 94753408⟩, ⟨47376702, 47376704⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1045), (-1044)⟩, ⟨(-2089), (-2087)⟩, ⟨(-1045), (-1042)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112011, 5112013⟩, ⟨(-2089), (-2087)⟩, ⟨(-1045), (-1042)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨56389, 56390⟩, ⟨112754, 112756⟩, ⟨56330, 56333⟩, ⟨(-48), (-44)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-143109188), (-143109186)⟩, ⟨112754, 112756⟩, ⟨56330, 56333⟩, ⟨(-48), (-44)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1578602), (-1578601)⟩, ⟨(-3155960), (-3155958)⟩, ⟨(-1575494), (-1575491)⟩, ⟨2484, 2487⟩, ⟨618, 622⟩⟩
...
def j19 : Jet := ⟨⟨1430077163, 1430077165⟩, ⟨(-3155960), (-3155958)⟩, ⟨(-1575494), (-1575491)⟩, ⟨2484, 2487⟩, ⟨618, 622⟩⟩
...
def j25 : Jet := ⟨⟨130, 131⟩, ⟨260, 262⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852047), (-852045)⟩, ⟨260, 262⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9399), (-9398)⟩, ⟨(-18796), (-18794)⟩, ⟨(-9393), (-9390)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781995, 35781997⟩, ⟨(-18796), (-18794)⟩, ⟨(-9393), (-9390)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨394702, 394703⟩, ⟨789196, 789198⟩, ⟨394183, 394186⟩, ⟨(-416), (-413)⟩, ⟨(-105), (-101)⟩⟩
...
def j33 : Jet := ⟨⟨(-715433181), (-715433179)⟩, ⟨789196, 789198⟩, ⟨394183, 394186⟩, ⟨(-416), (-413)⟩, ⟨(-105), (-101)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7891764), (-7891763)⟩, ⟨(-15774822), (-15774820)⟩, ⟨(-7870006), (-7870003)⟩, ⟨17396, 17399⟩, ⟨4336, 4339⟩⟩
...
def j36 : Jet := ⟨⟨4287075532, 4287075533⟩, ⟨(-15774822), (-15774820)⟩, ⟨(-7870006), (-7870003)⟩, ⟨17396, 17399⟩, ⟨4336, 4339⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨150197241, 150197244⟩, ⟨149865778, 149865783⟩, ⟨(-496933), (-496930)⟩, ⟨(-165210), (-165207)⟩, ⟨324, 328⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302873586, 4302873588⟩, ⟨15832950, 15832954⟩, ⟨7957263, 7957269⟩, ⟨40879, 40886⟩, ⟨10336, 10345⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨150473728, 150473732⟩, ⟨150695340, 150695347⟩, ⟨332885, 332891⟩, ⟨111737, 111744⟩, ⟨580, 589⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-143586126), (-143586125)⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4151381170, 4151381171⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5271831, 5271832⟩, ⟨10559190, 10559192⟩, ⟨5310694, 5310698⟩, ⟨31186, 31190⟩, ⟨7905, 7910⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300239127, 4300239128⟩, ⟨10559190, 10559192⟩, ⟨5310694, 5310698⟩, ⟨31186, 31190⟩, ⟨7905, 7910⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297602403, 4297602404⟩, ⟨5276357, 5276359⟩, ⟨2650479, 2650483⟩, ⟨12328, 12332⟩, ⟨3116, 3121⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4153928182, 4153928185⟩, ⟨(-138574260), (-138574255)⟩, ⟨2385474, 2385480⟩, ⟨(-76694), (-76688)⟩, ⟨2598, 2605⟩⟩
...
def j47 : Jet := ⟨⟨1664883273, 1664883286⟩, ⟨1664883273, 1664883286⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨645368432, 645368443⟩, ⟨1290736864, 1290736886⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨645368432, 645368443⟩, ⟨1290736864, 1290736886⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-645368443), (-645368432)⟩, ⟨(-1290736886), (-1290736864)⟩, ⟨(-645368443), (-645368432)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-322684222), (-322684216)⟩, ⟨(-645368443), (-645368432)⟩, ⟨(-322684222), (-322684216)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3984106876, 3984106883⟩, ⟨(-598658076), (-598658064)⟩, ⟨(-254351395), (-254351386)⟩, ⟨42724839, 42724842⟩, ⟨7949832, 7949834⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3853275867, 3853275877⟩, ⟨(-707543763), (-707543744)⟩, ⟨(-224470826), (-224470807)⟩, ⟨49124661, 49124675⟩, ⟨6182111, 6182127⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 287172251⟩, ⟨143586125, 143586126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 902178235⟩, ⟨451089115, 451089119⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 189506814⟩, ⟨0, 189506816⟩, ⟨47376702, 47376704⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4178), 0⟩, ⟨(-4178), 3⟩, ⟨(-1045), (-1039)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108878, 5113057⟩, ⟨(-4178), 3⟩, ⟨(-1045), (-1039)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 225604⟩, ⟨(-185), 225605⟩, ⟨56122, 56402⟩, ⟨(-94), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142939972)⟩, ⟨(-185), 225605⟩, ⟨56122, 56402⟩, ⟨(-94), 2⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6316894), 0⟩, ⟨(-6316903), 9955⟩, ⟨(-1579233), (-1564290)⟩, ⟨(-8), 4979⟩, ⟨613, 624⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425338871, 1431655766⟩, ⟨(-6316903), 9955⟩, ⟨(-1579233), (-1564290)⟩, ⟨(-8), 4979⟩, ⟨613, 624⟩⟩
...
def j72 : Jet := ⟨⟨0, 523⟩, ⟨(-1), 523⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851653)⟩, ⟨(-1), 523⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-37601), 0⟩, ⟨(-37602), 24⟩, ⟨(-9402), (-9364)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35753793, 35791395⟩, ⟨(-37602), 24⟩, ⟨(-9402), (-9364)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1579224⟩, ⟨(-1660), 1579226⟩, ⟨392316, 394808⟩, ⟨(-831), 2⟩, ⟨(-106), (-101)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714248658)⟩, ⟨(-1660), 1579226⟩, ⟨392316, 394808⟩, ⟨(-831), 2⟩, ⟨(-106), (-101)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-31584470), 0⟩, ⟨(-31584544), 69681⟩, ⟨(-7896192), (-7791594)⟩, ⟨(-56), 34843⟩, ⟨4285, 4357⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4263382826, 4294967296⟩, ⟨(-31584544), 69681⟩, ⟨(-7896192), (-7791594)⟩, ⟨(-56), 34843⟩, ⟨4285, 4357⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 300726079⟩, ⟨148372695, 150365132⟩, ⟨(-995174), 1046⟩, ⟨(-165865), (-163247)⟩, ⟨(-1), 655⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4326785754⟩, ⟨(-70719), 32054255⟩, ⟨7791073, 8251091⟩, ⟨(-35630), 120553⟩, ⟨9219, 11861⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 302953952⟩, ⟨148367743, 153723467⟩, ⟨(-1005023), 1700988⟩, ⟨92131, 134079⟩, ⟨(-4400), 5718⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-287172251), 0⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4007795045, 4294967296⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 21369452⟩, ⟨0, 21686374⟩, ⟨4983513, 5741965⟩, ⟨(-71944), 140678⟩, ⟨5343, 11080⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4316336748⟩, ⟨0, 21686374⟩, ⟨4983513, 5741965⟩, ⟨(-71944), 140678⟩, ⟨5343, 11080⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305638765⟩, ⟨0, 10843187⟩, ⟨2471927, 2870983⟩, ⟨(-43221), 70339⟩, ⟨1529, 4939⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4007795045, 4305638765⟩, ⟨(-143942887), (-132742938)⟩, ⟨1944145, 2870983⟩, ⟨(-139202), (-12300)⟩, ⟨(-926), 6384⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3329766559⟩, ⟨1664883273, 1664883286⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2581473752⟩, ⟨0, 2581473762⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2581473752⟩, ⟨0, 2581473762⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2581473752), 0⟩, ⟨(-2581473762), 0⟩, ⟨(-645368443), (-645368432)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1290736876), 0⟩, ⟨(-1290736881), 0⟩, ⟨(-322684222), (-322684216)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3180126075, 4294967296⟩, ⟨(-1290736881), 0⟩, ⟨(-322684222), (-44977208)⟩, ⟨0, 96974063⟩, ⟨(-5596151), 12121758⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2967494895, 4305638765⟩, ⟨(-1437886791), (-98286959)⟩, ⟨(-322046474), 4159227⟩, ⟨388094, 108020444⟩, ⟨(-9076702), 12179736⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297602403, 4297602404⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2814
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305638765⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2815
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (252799639 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(5349 / 80000), prawitzNormalCorrection
