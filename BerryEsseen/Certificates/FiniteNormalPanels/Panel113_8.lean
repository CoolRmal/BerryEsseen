...
namespace FiniteNormalPanel113_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (28007 / 160000)
def radius : Rat := (28007 / 800000)

def j0 : Jet := ⟨⟨751807181, 751807182⟩, ⟨150361436, 150361437⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2361871916, 2361871920⟩, ⟨472374382, 472374386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1298831530, 1298831536⟩, ⟨519532610, 519532618⟩, ⟨51953260, 51953262⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-28536), (-28535)⟩, ⟨(-11376), (-11374)⟩, ⟨(-1124), (-1120)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5084520, 5084522⟩, ⟨(-11376), (-11374)⟩, ⟨(-1124), (-1120)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1537598, 1537600⟩, ⟨611598, 611601⟩, ⟨59786, 59791⟩, ⟨(-274), (-270)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-141627979), (-141627976)⟩, ⟨611598, 611601⟩, ⟨59786, 59791⟩, ⟨(-274), (-270)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-42829404), (-42829401)⟩, ⟨(-16946811), (-16946807)⟩, ⟨(-1621118), (-1621112)⟩, ⟨14546, 14551⟩, ⟨684, 689⟩⟩
...
def j19 : Jet := ⟨⟨1388826361, 1388826365⟩, ⟨(-16946811), (-16946807)⟩, ⟨(-1621118), (-1621112)⟩, ⟨14546, 14551⟩, ⟨684, 689⟩⟩
...
def j25 : Jet := ⟨⟨3569, 3570⟩, ⟨1422, 1425⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848608), (-848606)⟩, ⟨1422, 1425⟩, ⟨139, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-256626), (-256625)⟩, ⟨(-102221), (-102219)⟩, ⟨(-10052), (-10049)⟩, ⟨32, 36⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35534768, 35534770⟩, ⟨(-102221), (-102219)⟩, ⟨(-10052), (-10049)⟩, ⟨32, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10745990, 10745991⟩, ⟨4267483, 4267486⟩, ⟨414434, 414438⟩, ⟨(-2444), (-2440)⟩, ⟨(-120), (-115)⟩⟩
...
def j33 : Jet := ⟨⟨(-705081893), (-705081891)⟩, ⟨4267483, 4267486⟩, ⟨414434, 414438⟩, ⟨(-2444), (-2440)⟩, ⟨(-120), (-115)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-213222252), (-213222250)⟩, ⟨(-83998382), (-83998378)⟩, ⟨(-7887355), (-7887350)⟩, ⟨101011, 101016⟩, ⟨4680, 4685⟩⟩
...
def j36 : Jet := ⟨⟨4081745044, 4081745046⟩, ⟨(-83998382), (-83998378)⟩, ⟨(-7887355), (-7887350)⟩, ⟨101011, 101016⟩, ⟨4680, 4685⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨763738057, 763738061⟩, ⟨143428285, 143428290⟩, ⟨(-2755345), (-2755339)⟩, ⟨(-170297), (-170293)⟩, ⟨1975, 1980⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4519327852, 4519327855⟩, ⟨93003409, 93003416⟩, ⟨10646831, 10646839⟩, ⟨286970, 286979⟩, ⟨18988, 18999⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨803634215, 803634221⟩, ⟨167458710, 167458718⟩, ⟨2099759, 2099770⟩, ⟨167716, 167726⟩, ⟨4518, 4530⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-751807182), (-751807181)⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3543160114, 3543160115⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨150368537, 150368540⟩, ⟨62666622, 62666628⟩, ⟨7314908, 7314916⟩, ⟨226498, 226508⟩, ⟨15794, 15803⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4445335833, 4445335836⟩, ⟨62666622, 62666628⟩, ⟨7314908, 7314916⟩, ⟨226498, 226508⟩, ⟨15794, 15803⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4369504780, 4369504782⟩, ⟨30798809, 30798813⟩, ⟨3486518, 3486524⟩, ⟨86741, 86748⟩, ⟨5758, 5765⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3604650277, 3604650280⟩, ⟨(-127563233), (-127563226)⟩, ⟨1797996, 1798003⟩, ⟨(-50502), (-50494)⟩, ⟨1713, 1720⟩⟩
...
def j47 : Jet := ⟨⟨7464288756, 7464288768⟩, ⟨1492857749, 1492857760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12972300553, 12972300596⟩, ⟨5188920212, 5188920262⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12972300553, 12972300596⟩, ⟨5188920212, 5188920262⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12972300596), (-12972300553)⟩, ⟨(-5188920262), (-5188920212)⟩, ⟨(-518892029), (-518892020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6486150298), (-6486150276)⟩, ⟨(-2594460131), (-2594460106)⟩, ⟨(-259446015), (-259446010)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨948635528, 948635541⟩, ⟨(-573042103), (-573042089)⟩, ⟨115774503, 115774513⟩, ⟨(-234802), (-234797)⟩, ⟨(-3461337), (-3461334)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨796164227, 796164239⟩, ⟨(-509113864), (-509113848)⟩, ⟨114583253, 114583269⟩, ⟨(-3886687), (-3886676)⟩, ⟨(-2842454), (-2842444)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨601445745, 902168618⟩, ⟨150361436, 150361437⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1889497533, 2834246303⟩, ⟨472374382, 472374386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨831252179, 1870317410⟩, ⟨415626088, 623439140⟩, ⟨51953260, 51953262⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨208, 469⟩, ⟨104, 157⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94479), (-94217)⟩, ⟨104, 157⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-41143), (-18234)⟩, ⟨(-13695), (-9048)⟩, ⟨(-1131), (-1109)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5071913, 5094823⟩, ⟨(-13695), (-9048)⟩, ⟨(-1131), (-1109)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨981623, 2218629⟩, ⟨484847, 737792⟩, ⟨58870, 60540⟩, ⟨(-331), (-213)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142183954), (-140946947)⟩, ⟨484847, 737792⟩, ⟨58870, 60540⟩, ⟨(-331), (-213)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-61916450), (-27279010)⟩, ⟨(-20544980), (-13318220)⟩, ⟨(-1661591), (-1571479)⟩, ⟨11415, 17672⟩, ⟨656, 711⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1369739315, 1404376756⟩, ⟨(-20544980), (-13318220)⟩, ⟨(-1661591), (-1571479)⟩, ⟨11415, 17672⟩, ⟨656, 711⟩⟩
...
def j72 : Jet := ⟨⟨2281, 5146⟩, ⟨1133, 1715⟩, ⟨138, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849896), (-847030)⟩, ⟨1133, 1715⟩, ⟨138, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-370102), (-163935)⟩, ⟨(-123149), (-81220)⟩, ⟨(-10146), (-9933)⟩, ⟨25, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35421292, 35627460⟩, ⟨(-123149), (-81220)⟩, ⟨(-10146), (-9933)⟩, ⟨25, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6855471, 15514591⟩, ⟨3374107, 5155812⟩, ⟨406171, 421180⟩, ⟨(-2959), (-1924)⟩, ⟨(-122), (-112)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708972412), (-700313291)⟩, ⟨3374107, 5155812⟩, ⟨406171, 421180⟩, ⟨(-2959), (-1924)⟩, ⟨(-122), (-112)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-308734236), (-135539320)⟩, ⟨(-102258386), (-65524472)⟩, ⟨(-8170829), (-7539400)⟩, ⟨78830, 123132⟩, ⟨4429, 4888⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3986233060, 4159427976⟩, ⟨(-102258386), (-65524472)⟩, ⟨(-8170829), (-7539400)⟩, ⟨78830, 123132⟩, ⟨4429, 4888⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨602593425, 926747367⟩, ⟨137090736, 148598773⟩, ⟨(-3356087), (-2156125)⟩, ⟨(-177727), (-161174)⟩, ⟨1543, 2414⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4434923306, 4627613037⟩, ⟨69864415, 118711635⟩, ⟨9139354, 12530803⟩, ⟨133617, 477081⟩, ⟨9716, 31616⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨622229563, 998524064⟩, ⟨151360113, 185722793⟩, ⟨(-103750), 4584680⟩, ⟨26210, 334991⟩, ⟨(-7485), 18721⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-902168618), (-601445745)⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3392798678, 3693521551⟩, ⟨(-150361437), (-150361436)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨90144953, 232143865⟩, ⟨43856322, 86356272⟩, ⟨5285880, 10162776⟩, ⟨(-1380), 552266⟩, ⟨(-1747), 42572⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4385112249, 4527111161⟩, ⟨43856322, 86356272⟩, ⟨5285880, 10162776⟩, ⟨(-1380), 552266⟩, ⟨(-1747), 42572⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4339805721, 4409511808⟩, ⟨21358540, 42732024⟩, ⟨2367229, 4976330⟩, ⟨(-49684), 261630⟩, ⟨(-6295), 20911⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3428218679, 3792025823⟩, ⟨(-137499373), (-115183127)⟩, ⟨373991, 3531735⟩, ⟨(-216943), 142120⟩, ⟨(-14574), 19723⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5971431007, 8957146518⟩, ⟨1492857749, 1492857760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8302272360, 18680112843⟩, ⟨4151136172, 6226704312⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8302272360, 18680112843⟩, ⟨4151136172, 6226704312⟩, ⟨518892020, 518892029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18680112843), (-8302272360)⟩, ⟨(-6226704312), (-4151136172)⟩, ⟨(-518892029), (-518892020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9340056422), (-4151136180)⟩, ⟨(-3113352156), (-2075568086)⟩, ⟨(-259446015), (-259446010)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨488113450, 1633838630⟩, ⟨(-1184343133), (-235883681)⟩, ⟨(-41699178), 399770108⟩, ⟨(-87096276), 57770750⟩, ⟨(-22543724), 17043131⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨389609403, 1442515822⟩, ⟨(-1097962152), (-201371329)⟩, ⟨(-30447728), 392216096⟩, ⟨(-90751962), 52374271⟩, ⟨(-21832352), 18231741⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨751807181, 751807182⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4369504780, 4369504782⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2272
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨601445745, 902168618⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4339805721, 4409511808⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2273
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (7334377 / 536870912)

theorem envelope_integral : (∫ s in ((28007 / 200000) : ℝ)..(84021 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((28007 / 200000) : ℝ)..(84021 / 400000), prawitzNormalCorrection
