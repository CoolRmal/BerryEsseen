...
namespace FiniteNormalPanel73_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (244321 / 800000)
def radius : Rat := (34903 / 800000)

def j0 : Jet := ⟨⟨1311688380, 1311688381⟩, ⟨187384054, 187384055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4120790578, 4120790582⟩, ⟨588684367, 588684371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3953677366, 3953677375⟩, ⟨1129622102, 1129622112⟩, ⟨80687292, 80687294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨989, 991⟩, ⟨282, 283⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93698), (-93695)⟩, ⟨282, 283⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-86253), (-86249)⟩, ⟨(-24385), (-24381)⟩, ⟨(-1669), (-1665)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5026803, 5026808⟩, ⟨(-24385), (-24381)⟩, ⟨(-1669), (-1665)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4627359, 4627365⟩, ⟨1299654, 1299662⟩, ⟨86484, 86493⟩, ⟨(-889), (-883)⟩, ⟨(-30), (-26)⟩⟩
...
def j16 : Jet := ⟨⟨(-138538218), (-138538211)⟩, ⟨1299654, 1299662⟩, ⟨86484, 86493⟩, ⟨(-889), (-883)⟩, ⟨(-30), (-26)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-127529590), (-127529583)⟩, ⟨(-35240647), (-35240635)⟩, ⟨(-2181212), (-2181198)⟩, ⟨46342, 46354⟩, ⟨1362, 1370⟩⟩
...
def j19 : Jet := ⟨⟨1304126175, 1304126183⟩, ⟨(-35240647), (-35240635)⟩, ⟨(-2181212), (-2181198)⟩, ⟨46342, 46354⟩, ⟨1362, 1370⟩⟩
...
def j22 : Jet := ⟨⟨(-100), (-98)⟩, ⟨(-29), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11735, 11738⟩, ⟨(-29), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10802, 10806⟩, ⟨3059, 3063⟩, ⟨209, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841375), (-841370)⟩, ⟨3059, 3063⟩, ⟨209, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-774518), (-774512)⟩, ⟨(-218476), (-218469)⟩, ⟨(-14811), (-14803)⟩, ⟨109, 115⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨35016876, 35016883⟩, ⟨(-218476), (-218469)⟩, ⟨(-14811), (-14803)⟩, ⟨109, 115⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨32234338, 32234346⟩, ⟨9008695, 9008705⟩, ⟨586746, 586759⟩, ⟨(-7901), (-7891)⟩, ⟨(-251), (-242)⟩⟩
...
def j33 : Jet := ⟨⟨(-683593545), (-683593536)⟩, ⟨9008695, 9008705⟩, ⟨586746, 586759⟩, ⟨(-7901), (-7891)⟩, ⟨(-251), (-242)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-629273321), (-629273310)⟩, ⟨(-171499540), (-171499525)⟩, ⟨(-9932810), (-9932792)⟩, ⟨316287, 316303⟩, ⟨8711, 8727⟩⟩
...
def j36 : Jet := ⟨⟨3665693975, 3665693986⟩, ⟨(-171499540), (-171499525)⟩, ⟨(-9932810), (-9932792)⟩, ⟨316287, 316303⟩, ⟨8711, 8727⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1251239062, 1251239072⟩, ⟨144936927, 144936943⟩, ⟨(-6922972), (-6922955)⟩, ⟨(-254504), (-254488)⟩, ⟨7657, 7669⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5032265143, 5032265159⟩, ⟨235434568, 235434592⟩, ⟨24650545, 24650576⟩, ⟨1357000, 1357031⟩, ⟨97984, 98014⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1466033681, 1466033698⟩, ⟨238405999, 238406028⟩, ⟨7014873, 7014907⟩, ⟨549494, 549528⟩, ⟨29623, 29653⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1311688381), (-1311688380)⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2983278915, 2983278916⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨500412367, 500412380⟩, ⟨162753846, 162753870⟩, ⟨18022371, 18022401⟩, ⟨1153890, 1153922⟩, ⟨92681, 92710⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4795379663, 4795379676⟩, ⟨162753846, 162753870⟩, ⟨18022371, 18022401⟩, ⟨1153890, 1153922⟩, ⟨92681, 92710⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4538281483, 4538281490⟩, ⟨77014002, 77014015⟩, ⟨7874603, 7874619⟩, ⟨412381, 412398⟩, ⟨30025, 30041⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3152284645, 3152284652⟩, ⟨(-144505721), (-144505708)⟩, ⟨2109663, 2109677⟩, ⟨(-57121), (-57107)⟩, ⟨2862, 2876⟩⟩
...
def j47 : Jet := ⟨⟨7782895365, 7782895373⟩, ⟨1111842193, 1111842200⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14103357741, 14103357771⟩, ⟨4029530774, 4029530806⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14103357741, 14103357771⟩, ⟨4029530774, 4029530806⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14103357771), (-14103357741)⟩, ⟨(-4029530806), (-4029530774)⟩, ⟨(-287823630), (-287823626)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7051678886), (-7051678870)⟩, ⟨(-2014765403), (-2014765387)⟩, ⟨(-143911815), (-143911813)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨831600603, 831600614⟩, ⟨(-390103121), (-390103112)⟩, ⟨63634004, 63634009⟩, ⟨(-1236076), (-1236073)⟩, ⟨(-921135), (-921134)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨610351984, 610351994⟩, ⟨(-314295090), (-314295078)⟩, ⟨60237714, 60237725⟩, ⟨(-3250885), (-3250874)⟩, ⟨(-597482), (-597472)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1124304326, 1499072436⟩, ⟨187384054, 187384055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3532106210, 4709474953⟩, ⟨588684367, 588684371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2904742555, 5163986780⟩, ⟨968247516, 1290996700⟩, ⟨80687292, 80687294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨727, 1294⟩, ⟨242, 324⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93960), (-93392)⟩, ⟨242, 324⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-112972), (-63162)⟩, ⟨(-28080), (-20664)⟩, ⟨(-1699), (-1630)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5000084, 5049895⟩, ⟨(-28080), (-20664)⟩, ⟨(-1699), (-1630)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3381622, 6071663⟩, ⟨1093445, 1503941⟩, ⟨83449, 89110⟩, ⟨(-1034), (-738)⟩, ⟨(-31), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139783955), (-137093913)⟩, ⟨1093445, 1503941⟩, ⟨83449, 89110⟩, ⟨(-1034), (-738)⟩, ⟨(-31), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-168067053), (-92718406)⟩, ⟨(-41277253), (-29097895)⟩, ⟨(-2323108), (-2016310)⟩, ⟨38109, 54541⟩, ⟨1218, 1494⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1263588712, 1338937360⟩, ⟨(-41277253), (-29097895)⟩, ⟨(-2323108), (-2016310)⟩, ⟨38109, 54541⟩, ⟨1218, 1494⟩⟩
...
def j70 : Jet := ⟨⟨(-130), (-72)⟩, ⟨(-33), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11705, 11764⟩, ⟨(-33), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7916, 14145⟩, ⟨2598, 3521⟩, ⟨205, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844261), (-838031)⟩, ⟨2598, 3521⟩, ⟨205, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1015085), (-566771)⟩, ⟨(-252015), (-184689)⟩, ⟨(-15138), (-14424)⟩, ⟨91, 132⟩, ⟨0, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34776309, 35224624⟩, ⟨(-252015), (-184689)⟩, ⟨(-15138), (-14424)⟩, ⟨91, 132⟩, ⟨0, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨23519672, 42351776⟩, ⟨7536883, 10463038⟩, ⟨559371, 610357⟩, ⟨(-9225), (-6561)⟩, ⟨(-265), (-223)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692308211), (-673476106)⟩, ⟨7536883, 10463038⟩, ⟨559371, 610357⟩, ⟨(-9225), (-6561)⟩, ⟨(-265), (-223)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-832385954), (-455480698)⟩, ⟨(-202999198), (-139246828)⟩, ⟨(-10928625), (-8773369)⟩, ⟨256602, 375591⟩, ⟨7416, 9838⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3462581342, 3839486598⟩, ⟨(-202999198), (-139246828)⟩, ⟨(-10928625), (-8773369)⟩, ⟨256602, 375591⟩, ⟨7416, 9838⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1039153322, 1468158318⟩, ⟨127931295, 159590190⟩, ⟨(-8204928), (-5646444)⟩, ⟨(-287074), (-216558)⟩, ⟨6224, 9115⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4804481954, 5327454362⟩, ⟨174244356, 312330270⟩, ⟨17297745, 35125399⟩, ⟨504341, 2689017⟩, ⟨13611, 245311⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1162428730, 1821095691⟩, ⟨185265717, 304719373⟩, ⟨(-802118), 17296118⟩, ⟨(-315490), 1753045⟩, ⟨(-62703), 163556⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1499072436), (-1124304326)⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2795894860, 3170662970⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨314610207, 772157106⟩, ⟨100283972, 258406224⟩, ⟨7311328, 36286581⟩, ⟨(-381358), 3940860⟩, ⟨(-101173), 457103⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4609577503, 5067124402⟩, ⟨100283972, 258406224⟩, ⟨7311328, 36286581⟩, ⟨(-381358), 3940860⟩, ⟨(-101173), 457103⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4449492625, 4665097383⟩, ⟨46163707, 124716050⟩, ⟨1698551, 17273722⟩, ⟨(-668228), 1884378⟩, ⟨(-135179), 239021⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2896486213, 3443903179⟩, ⟨(-173481181), (-102056982)⟩, ⟨(-4335501), 10737873⟩, ⟨(-1246936), 1316995⟩, ⟨(-182007), 205606⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6671053171, 8894737573⟩, ⟨1111842193, 1111842200⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10361650588, 18420712206⟩, ⟨3453883522, 4605178066⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10361650588, 18420712206⟩, ⟨3453883522, 4605178066⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18420712206), (-10361650588)⟩, ⟨(-4605178066), (-3453883522)⟩, ⟨(-287823630), (-287823626)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9210356103), (-5180825294)⟩, ⟨(-2302589033), (-1726941761)⟩, ⟨(-143911815), (-143911813)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨503078424, 1285553103⟩, ⟨(-689202100), (-202280268)⟩, ⟨(-2408205), 167888513⟩, ⟨(-25483874), 15825791⟩, ⟨(-4933832), 3455907⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨339271435, 1030815863⟩, ⟨(-604559802), (-148370086)⟩, ⟨1577885, 165672854⟩, ⟨(-29311765), 13877028⟩, ⟨(-5030693), 4481819⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1311688380, 1311688381⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4538281483, 4538281490⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1462
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1124304326, 1499072436⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4449492625, 4665097383⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1463
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (55088069 / 4294967296)

theorem envelope_integral : (∫ s in ((104709 / 400000) : ℝ)..(34903 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((104709 / 400000) : ℝ)..(34903 / 100000), prawitzNormalCorrection
