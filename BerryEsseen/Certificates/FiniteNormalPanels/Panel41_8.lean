...
namespace FiniteNormalPanel41_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1723 / 8000)
def radius : Rat := (1723 / 40000)

def j0 : Jet := ⟨⟨925028581, 925028582⟩, ⟨185005716, 185005717⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2906062994, 2906062998⟩, ⟨581212598, 581212602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1966301846, 1966301852⟩, ⟨786520736, 786520746⟩, ⟨78652073, 78652075⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨492, 493⟩, ⟨196, 198⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94195), (-94193)⟩, ⟨196, 198⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-43124), (-43122)⟩, ⟨(-17161), (-17158)⟩, ⟨(-1682), (-1677)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5069932, 5069935⟩, ⟨(-17161), (-17158)⟩, ⟨(-1682), (-1677)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2321092, 2321094⟩, ⟨920580, 920583⟩, ⟨88929, 88935⟩, ⟨(-622), (-617)⟩, ⟨(-30), (-27)⟩⟩
...
def j16 : Jet := ⟨⟨(-140844485), (-140844482)⟩, ⟨920580, 920583⟩, ⟨88929, 88935⟩, ⟨(-622), (-617)⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-64480764), (-64480762)⟩, ⟨(-25370851), (-25370846)⟩, ⟨(-2369936), (-2369931)⟩, ⟨32858, 32864⟩, ⟨1500, 1505⟩⟩
...
def j19 : Jet := ⟨⟨1367175001, 1367175004⟩, ⟨(-25370851), (-25370846)⟩, ⟨(-2369936), (-2369931)⟩, ⟨32858, 32864⟩, ⟨1500, 1505⟩⟩
...
def j25 : Jet := ⟨⟨5395, 5397⟩, ⟨2148, 2151⟩, ⟨210, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846782), (-846779)⟩, ⟨2148, 2151⟩, ⟨210, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-387670), (-387668)⟩, ⟨(-154085), (-154082)⟩, ⟨(-15018), (-15014)⟩, ⟨76, 80⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35403724, 35403727⟩, ⟨(-154085), (-154082)⟩, ⟨(-15018), (-15014)⟩, ⟨76, 80⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16208367, 16208369⟩, ⟨6412803, 6412807⟩, ⟨613241, 613246⟩, ⟨(-5539), (-5533)⟩, ⟨(-263), (-257)⟩⟩
...
def j33 : Jet := ⟨⟨(-699619516), (-699619513)⟩, ⟨6412803, 6412807⟩, ⟨613241, 613246⟩, ⟨(-5539), (-5533)⟩, ⟨(-263), (-257)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-320296537), (-320296534)⟩, ⟨(-125182737), (-125182731)⟩, ⟨(-11356760), (-11356754)⟩, ⟨227199, 227205⟩, ⟨10094, 10101⟩⟩
...
def j36 : Jet := ⟨⟨3974670759, 3974670762⟩, ⟨(-125182737), (-125182731)⟩, ⟨(-11356760), (-11356754)⟩, ⟨227199, 227205⟩, ⟨10094, 10101⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨925058656, 925058660⟩, ⟨167845292, 167845299⟩, ⟨(-5036836), (-5036829)⟩, ⟨(-298478), (-298471)⟩, ⟨5460, 5467⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4641074740, 4641074744⟩, ⟨146171203, 146171213⟩, ⟨17864536, 17864546⟩, ⟨714996, 715009⟩, ⟨53411, 53424⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨999603970, 999603976⟩, ⟨212853653, 212853665⟩, ⟨4117273, 4117287⟩, ⟨358183, 358198⟩, ⟨14233, 14251⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-925028582), (-925028581)⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3369938714, 3369938715⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨232646264, 232646268⟩, ⟨99078452, 99078460⟩, ⟨12465276, 12465287⟩, ⟨574818, 574832⟩, ⟨46072, 46085⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4527613560, 4527613564⟩, ⟨99078452, 99078460⟩, ⟨12465276, 12465287⟩, ⟨574818, 574832⟩, ⟨46072, 46085⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4409756475, 4409756477⟩, ⟨48249683, 48249688⟩, ⟨5806433, 5806440⟩, ⟨216395, 216404⟩, ⟨16244, 16254⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3460005173, 3460005177⟩, ⟨(-152092354), (-152092347)⟩, ⟨2477516, 2477523⟩, ⟨(-80325), (-80316)⟩, ⟨3423, 3433⟩⟩
...
def j47 : Jet := ⟨⟨5886535795, 5886535804⟩, ⟨1177307157, 1177307165⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8067885335, 8067885361⟩, ⟨3227154128, 3227154156⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8067885335, 8067885361⟩, ⟨3227154128, 3227154156⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8067885361), (-8067885335)⟩, ⟨(-3227154156), (-3227154128)⟩, ⟨(-322715417), (-322715412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4033942681), (-4033942667)⟩, ⟨(-1613577078), (-1613577064)⟩, ⟨(-161357709), (-161357706)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1679033730, 1679033744⟩, ⟨(-630796506), (-630796494)⟩, ⟨55412374, 55412381⟩, ⟨8859640, 8859643⟩, ⟨(-1873015), (-1873014)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1352621566, 1352621580⟩, ⟨(-567624200), (-567624184)⟩, ⟨67946093, 67946105⟩, ⟨4779760, 4779772⟩, ⟨(-1777531), (-1777520)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨740022865, 1110034298⟩, ⟨185005716, 185005717⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2324850396, 3487275596⟩, ⟨581212598, 581212602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1258433182, 2831474665⟩, ⟨629216590, 943824894⟩, ⟨78652073, 78652075⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨314, 710⟩, ⟨157, 237⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94373), (-93976)⟩, ⟨157, 237⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-62216), (-27535)⟩, ⟨(-20693), (-13610)⟩, ⟨(-1701), (-1653)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5050840, 5085522⟩, ⟨(-20693), (-13610)⟩, ⟨(-1701), (-1653)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1479905, 3352652⟩, ⟨726310, 1113564⟩, ⟨86824, 90653⟩, ⟨(-752), (-484)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141685672), (-139812924)⟩, ⟨726310, 1113564⟩, ⟨86824, 90653⟩, ⟨(-752), (-484)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-93406856), (-40965439)⟩, ⟨(-30922809), (-19748597)⟩, ⟨(-2462791), (-2255867)⟩, ⟨25523, 40174⟩, ⟨1401, 1584⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1338248909, 1390690327⟩, ⟨(-30922809), (-19748597)⟩, ⟨(-2462791), (-2255867)⟩, ⟨25523, 40174⟩, ⟨1401, 1584⟩⟩
...
def j72 : Jet := ⟨⟨3446, 7783⟩, ⟨1707, 2591⟩, ⟨207, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848731), (-844393)⟩, ⟨1707, 2591⟩, ⟨207, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-559530), (-247408)⟩, ⟨(-186010), (-121995)⟩, ⟨(-15233), (-14751)⟩, ⟨59, 96⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35231864, 35543987⟩, ⟨(-186010), (-121995)⟩, ⟨(-15233), (-14751)⟩, ⟨59, 96⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10322999, 23432519⟩, ⟨5038871, 7775096⟩, ⟨594268, 628710⟩, ⟨(-6738), (-4331)⟩, ⟨(-271), (-245)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705504884), (-692395363)⟩, ⟨5038871, 7775096⟩, ⟨594268, 628710⟩, ⟨(-6738), (-4331)⟩, ⟨(-271), (-245)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-465106966), (-202873093)⟩, ⟨(-153559259), (-96310782)⟩, ⟨(-12007319), (-10556500)⟩, ⟨174891, 279275⟩, ⟨9222, 10809⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3829860330, 4092094203⟩, ⟨(-153559259), (-96310782)⟩, ⟨(-12007319), (-10556500)⟩, ⟨174891, 279275⟩, ⟨9222, 10809⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨724389335, 1129163532⟩, ⟨155989724, 177504079⟩, ⟨(-6184252), (-3893553)⟩, ⟨(-319460), (-272653)⟩, ⟨4211, 6724⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4507898195, 4816557912⟩, ⟨106097068, 193121160⟩, ⟨14126242, 22844043⟩, ⟨277455, 1315557⟩, ⟨17067, 108670⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨760302267, 1266291725⟩, ⟨181617536, 249832880⟩, ⟨(-699391), 9900592⟩, ⟨(-76480), 907623⟩, ⟨(-29885), 70941⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1110034298), (-740022865)⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3184932998, 3554944431⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨134589974, 373342711⟩, ⟨64300476, 147317216⟩, ⟨7267496, 20370481⟩, ⟨(-126464), 1687004⟩, ⟨(-28135), 170247⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4429557270, 4668310007⟩, ⟨64300476, 147317216⟩, ⟨7267496, 20370481⟩, ⟨(-126464), 1687004⟩, ⟨(-28135), 170247⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4361743184, 4477749302⟩, ⟨30837863, 72530936⟩, ⟨2897987, 9920298⟩, ⟨(-227229), 810100⟩, ⟨(-38606), 86638⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3234450657, 3706233098⟩, ⟨(-170011235), (-127848231)⟩, ⟨(-975269), 6882691⟩, ⟨(-615395), 545690⟩, ⟨(-66851), 81499⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4709228637, 7063842962⟩, ⟨1177307157, 1177307165⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5163446617, 11617754911⟩, ⟨2581723302, 3872584986⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5163446617, 11617754911⟩, ⟨2581723302, 3872584986⟩, ⟨322715412, 322715417⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11617754911), (-5163446617)⟩, ⟨(-3872584986), (-2581723302)⟩, ⟨(-322715417), (-322715412)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5808877456), (-2581723308)⟩, ⟨(-1936292493), (-1290861651)⟩, ⟨(-161357709), (-161357706)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1110665361, 2354526497⟩, ⟨(-1061487008), (-333812861)⟩, ⟨(-38293166), 197547546⟩, ⟨(-21325989), 32340565⟩, ⟨(-7355844), 3122908⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨836419013, 2031778925⟩, ⟨(-1009184458), (-284448691)⟩, ⟨(-23642164), 216259494⟩, ⟨(-28260809), 29963447⟩, ⟨(-7860584), 4052343⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨925028581, 925028582⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4409756475, 4409756477⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified806
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨740022865, 1110034298⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4361743184, 4477749302⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified807
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (118549357 / 4294967296)

theorem envelope_integral : (∫ s in ((1723 / 10000) : ℝ)..(5169 / 20000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (1723 / 10000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (5169 / 20000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((1723 / 10000) : ℝ)..(5169 / 20000), prawitzNormalCorrection
