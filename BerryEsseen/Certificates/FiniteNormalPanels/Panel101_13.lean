...
namespace FiniteNormalPanel101_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1621 / 8000)
def radius : Rat := (1621 / 40000)

def j0 : Jet := ⟨⟨870267748, 870267749⟩, ⟨174053549, 174053550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2734026763, 2734026768⟩, ⟨546805350, 546805355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1740386323, 1740386330⟩, ⟨696154524, 696154534⟩, ⟨69615452, 69615454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨435, 437⟩, ⟨174, 175⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94252), (-94249)⟩, ⟨174, 175⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-38193), (-38191)⟩, ⟨(-15207), (-15205)⟩, ⟨(-1494), (-1490)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5074863, 5074866⟩, ⟨(-15207), (-15205)⟩, ⟨(-1494), (-1490)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2056411, 2056414⟩, ⟨816401, 816405⟩, ⟨79185, 79190⟩, ⟨(-489), (-484)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-141109166), (-141109162)⟩, ⟨816401, 816405⟩, ⟨79185, 79190⟩, ⟨(-489), (-484)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-57179589), (-57179586)⟩, ⟨(-22541018), (-22541014)⟩, ⟨(-2122771), (-2122766)⟩, ⟨25867, 25873⟩, ⟨1192, 1198⟩⟩
...
def j19 : Jet := ⟨⟨1374476176, 1374476180⟩, ⟨(-22541018), (-22541014)⟩, ⟨(-2122771), (-2122766)⟩, ⟨25867, 25873⟩, ⟨1192, 1198⟩⟩
...
def j25 : Jet := ⟨⟨4777, 4779⟩, ⟨1903, 1906⟩, ⟨187, 190⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847400), (-847397)⟩, ⟨1903, 1906⟩, ⟨187, 190⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-343380), (-343378)⟩, ⟨(-136581), (-136578)⟩, ⟨(-13353), (-13349)⟩, ⟨59, 62⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35448014, 35448017⟩, ⟨(-136581), (-136578)⟩, ⟨(-13353), (-13349)⟩, ⟨59, 62⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨14364076, 14364078⟩, ⟨5690285, 5690289⟩, ⟨547014, 547018⟩, ⟨(-4356), (-4350)⟩, ⟨(-208), (-203)⟩⟩
...
def j33 : Jet := ⟨⟨(-701463807), (-701463804)⟩, ⟨5690285, 5690289⟩, ⟨547014, 547018⟩, ⟨(-4356), (-4350)⟩, ⟨(-208), (-203)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-284243846), (-284243843)⟩, ⟨(-111391749), (-111391744)⟩, ⟨(-10225780), (-10225775)⟩, ⟨179128, 179135⟩, ⟨8074, 8080⟩⟩
...
def j36 : Jet := ⟨⟨4010723450, 4010723453⟩, ⟨(-111391749), (-111391744)⟩, ⟨(-10225780), (-10225775)⟩, ⟨179128, 179135⟩, ⟨8074, 8080⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨874943716, 874943722⟩, ⟨160639914, 160639920⟩, ⟨(-4221049), (-4221043)⟩, ⟨(-253791), (-253785)⟩, ⟨4051, 4057⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4599355774, 4599355778⟩, ⟨127740111, 127740118⟩, ⟨15274343, 15274351⟩, ⟨544482, 544494⟩, ⟨39093, 39104⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨936951821, 936951829⟩, ⟨198047030, 198047041⟩, ⟨3369116, 3369126⟩, ⟨284887, 284900⟩, ⟨10104, 10119⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-870267749), (-870267748)⟩, ⟨(-174053550), (-174053549)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3424699547, 3424699548⟩, ⟨(-174053550), (-174053549)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨204397066, 204397070⟩, ⟨86408352, 86408360⟩, ⟨10602181, 10602189⟩, ⟨435004, 435016⟩, ⟨33322, 33335⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4499364362, 4499364366⟩, ⟨86408352, 86408360⟩, ⟨10602181, 10602189⟩, ⟨435004, 435016⟩, ⟨33322, 33335⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4395978024, 4395978026⟩, ⟨42211430, 42211435⟩, ⟨4976618, 4976624⟩, ⟨164717, 164724⟩, ⟨11879, 11887⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3505242976, 3505242979⟩, ⟨(-144488672), (-144488665)⟩, ⟨2257611, 2257618⟩, ⟨(-70337), (-70330)⟩, ⟨2796, 2804⟩⟩
...
def j47 : Jet := ⟨⟨5919998066, 5919998075⟩, ⟨1183999609, 1183999617⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8159870538, 8159870564⟩, ⟨3263948202, 3263948232⟩, ⟨326394819, 326394824⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8159870538, 8159870564⟩, ⟨3263948202, 3263948232⟩, ⟨326394819, 326394824⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8159870564), (-8159870538)⟩, ⟨(-3263948232), (-3263948202)⟩, ⟨(-326394824), (-326394819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4079935282), (-4079935269)⟩, ⟨(-1631974116), (-1631974101)⟩, ⟨(-163197412), (-163197409)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1661149747, 1661149759⟩, ⟨(-631193028), (-631193016)⟩, ⟨56799032, 56799038⟩, ⟨8795066, 8795069⟩, ⟨(-1914581), (-1914579)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1355710784, 1355710796⟩, ⟨(-571017679), (-571017664)⟩, ⟨68462656, 68462669⟩, ⟨4908113, 4908123⟩, ⟨(-1817152), (-1817141)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨696214198, 1044321299⟩, ⟨174053549, 174053550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2187221409, 3280832122⟩, ⟨546805350, 546805355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1113847245, 2506156316⟩, ⟨556923620, 835385442⟩, ⟨69615452, 69615454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨278, 628⟩, ⟨139, 210⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94409), (-94058)⟩, ⟨139, 210⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-55089), (-24392)⟩, ⟨(-18327), (-12073)⟩, ⟨(-1509), (-1472)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5057967, 5088665⟩, ⟨(-18327), (-12073)⟩, ⟨(-1509), (-1472)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1311721, 2969287⟩, ⟨645166, 986633⟩, ⟨77536, 80535⟩, ⟨(-591), (-380)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141853856), (-140196289)⟩, ⟨645166, 986633⟩, ⟨77536, 80535⟩, ⟨(-591), (-380)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-82773142), (-36358193)⟩, ⟨(-27423733), (-17603385)⟩, ⟨(-2195489), (-2033490)⟩, ⟨20166, 31559⟩, ⟨1126, 1252⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1348882623, 1395297573⟩, ⟨(-27423733), (-17603385)⟩, ⟨(-2195489), (-2033490)⟩, ⟨20166, 31559⟩, ⟨1126, 1252⟩⟩
...
def j72 : Jet := ⟨⟨3052, 6891⟩, ⟨1513, 2294⟩, ⟨183, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849125), (-845285)⟩, ⟨1513, 2294⟩, ⟨183, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-495473), (-219214)⟩, ⟨(-164766), (-108268)⟩, ⟨(-13521), (-13141)⟩, ⟨45, 76⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35295921, 35572181⟩, ⟨(-164766), (-108268)⟩, ⟨(-13521), (-13141)⟩, ⟨45, 76⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9153565, 20756723⟩, ⟨4480639, 6890831⟩, ⟨532159, 559131⟩, ⟨(-5290), (-3412)⟩, ⟨(-215), (-194)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706674318), (-695071159)⟩, ⟨4480639, 6890831⟩, ⟨532159, 559131⟩, ⟨(-5290), (-3412)⟩, ⟨(-215), (-194)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-412351523), (-180258205)⟩, ⟨(-136288511), (-86108233)⟩, ⟨(-10735203), (-9599588)⟩, ⟨138541, 219560⟩, ⟨7470, 8571⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3882615773, 4114709091⟩, ⟨(-136288511), (-86108233)⟩, ⟨(-10735203), (-9599588)⟩, ⟨138541, 219560⟩, ⟨7470, 8571⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨686921400, 1065837475⟩, ⟨150781955, 168675019⟩, ⟨(-5168486), (-3276699)⟩, ⟨(-269246), (-234781)⟩, ⟨3140, 4975⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4483122297, 4751112434⟩, ⟨93817989, 166774691⟩, ⟨12422415, 18990712⟩, ⟨225319, 967771⟩, ⟨14899, 74508⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨717014224, 1179034282⟩, ⟨172392354, 227975822⟩, ⟨(-436972), 7842178⟩, ⟨(-26391), 669338⟩, ⟨(-19740), 47396⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1044321299), (-696214198)⟩, ⟨(-174053550), (-174053549)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3250645997, 3598753098⟩, ⟨(-174053550), (-174053549)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨119700421, 323662963⟩, ⟨57559352, 125165708⟩, ⟨6679610, 16406498⟩, ⟨(-60880), 1200010⟩, ⟨(-14438), 111400⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4414667717, 4618630259⟩, ⟨57559352, 125165708⟩, ⟨6679610, 16406498⟩, ⟨(-60880), 1200010⟩, ⟨(-14438), 111400⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4354406212, 4453859665⟩, ⟨27752955, 61728580⟩, ⟨2792890, 8002831⟩, ⟨(-143475), 574016⟩, ⟨(-22613), 56079⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3295632340, 3731889015⟩, ⟨(-159487841), (-124739933)⟩, ⟨(-387753), 5580885⟩, ⟨(-444533), 367788⟩, ⟨(-42210), 52804⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4735998450, 7103997691⟩, ⟨1183999609, 1183999617⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5222317138, 11750213615⟩, ⟨2611158560, 3916737878⟩, ⟨326394819, 326394824⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5222317138, 11750213615⟩, ⟨2611158560, 3916737878⟩, ⟨326394819, 326394824⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11750213615), (-5222317138)⟩, ⟨(-3916737878), (-2611158560)⟩, ⟨(-326394824), (-326394819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5875106808), (-2611158569)⟩, ⟨(-1958368939), (-1305579280)⟩, ⟨(-163197412), (-163197409)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1093670023, 2338445081⟩, ⟨(-1066256830), (-332452571)⟩, ⟨(-38325460), 201533087⟩, ⟨(-22209354), 32835027⟩, ⟨(-7571796), 3259824⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨839199474, 2031870538⟩, ⟨(-1013303574), (-286862665)⟩, ⟨(-23856526), 217744315⟩, ⟨(-28408855), 30249969⟩, ⟨(-7962495), 4058152⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨870267748, 870267749⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4395978024, 4395978026⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2040
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨696214198, 1044321299⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4354406212, 4453859665⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2041
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (1746809 / 67108864)

theorem envelope_integral : (∫ s in ((1621 / 10000) : ℝ)..(4863 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((1621 / 10000) : ℝ)..(4863 / 20000), prawitzNormalCorrection
