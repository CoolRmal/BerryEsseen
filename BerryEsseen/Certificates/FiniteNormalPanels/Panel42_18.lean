...
namespace FiniteNormalPanel42_18
...
def j2 : Jet := ⟨⟨1749861459, 1749861463⟩, ⟨583287152, 583287156⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨712930952, 712930956⟩, ⟨475287300, 475287306⟩, ⟨79214550, 79214552⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨178, 179⟩, ⟨118, 120⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94509), (-94507)⟩, ⟨118, 120⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-15688), (-15687)⟩, ⟨(-10440), (-10438)⟩, ⟨(-1728), (-1725)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097368, 5097370⟩, ⟨(-10440), (-10438)⟩, ⟨(-1728), (-1725)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨846123, 846124⟩, ⟨562349, 562351⟩, ⟨92570, 92573⟩, ⟨(-385), (-381)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-142319454), (-142319452)⟩, ⟨562349, 562351⟩, ⟨92570, 92573⟩, ⟨(-385), (-381)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-23623916), (-23623915)⟩, ⟨(-15655933), (-15655930)⟩, ⟨(-2547285), (-2547281)⟩, ⟨20550, 20554⟩, ⟨1658, 1662⟩⟩
...
def j19 : Jet := ⟨⟨1408031849, 1408031851⟩, ⟨(-15655933), (-15655930)⟩, ⟨(-2547285), (-2547281)⟩, ⟨20550, 20554⟩, ⟨1658, 1662⟩⟩
...
def j25 : Jet := ⟨⟨1961, 1962⟩, ⟨1305, 1307⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850216), (-850214)⟩, ⟨1305, 1307⟩, ⟨214, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-141130), (-141128)⟩, ⟨(-93871), (-93868)⟩, ⟨(-15503), (-15498)⟩, ⟨46, 50⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨35650264, 35650267⟩, ⟨(-93871), (-93868)⟩, ⟨(-15503), (-15498)⟩, ⟨46, 50⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5917664, 5917666⟩, ⟨3929527, 3929530⟩, ⟨644556, 644560⟩, ⟨(-3441), (-3437)⟩, ⟨(-281), (-278)⟩⟩
...
def j33 : Jet := ⟨⟨(-709910219), (-709910216)⟩, ⟨3929527, 3929530⟩, ⟨644556, 644560⟩, ⟨(-3441), (-3437)⟩, ⟨(-281), (-278)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-117839541), (-117839538)⟩, ⟨(-77907424), (-77907420)⟩, ⟨(-12551445), (-12551442)⟩, ⟨143229, 143233⟩, ⟨11459, 11462⟩⟩
...
def j36 : Jet := ⟨⟨4177127755, 4177127758⟩, ⟨(-77907424), (-77907420)⟩, ⟨(-12551445), (-12551442)⟩, ⟨143229, 143233⟩, ⟨11459, 11462⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨573662264, 573662267⟩, ⟨184842192, 184842197⟩, ⟨(-3164007), (-3164002)⟩, ⟨(-337568), (-337563)⟩, ⟨3465, 3470⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4416131165, 4416131169⟩, ⟨82365060, 82365068⟩, ⟨14805786, 14805792⟩, ⟨372203, 372211⟩, ⟨36486, 36494⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨589845656, 589845660⟩, ⟨201057896, 201057904⟩, ⟨2269024, 2269033⟩, ⟨279139, 279150⟩, ⟨7071, 7082⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-556998203), (-556998202)⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3737969093, 3737969094⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨81005948, 81005950⟩, ⟨55224226, 55224232⟩, ⟨10035238, 10035244⟩, ⟨289106, 289112⟩, ⟨29274, 29281⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4375973244, 4375973246⟩, ⟨55224226, 55224232⟩, ⟨10035238, 10035244⟩, ⟨289106, 289112⟩, ⟨29274, 29281⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4335281071, 4335281073⟩, ⟨27355347, 27355351⟩, ⟨4884654, 4884659⟩, ⟨112386, 112391⟩, ⟨11039, 11045⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3773054725, 3773054729⟩, ⟨(-163601049), (-163601042)⟩, ⟨3068643, 3068649⟩, ⟨(-113347), (-113341)⟩, ⟨4748, 4755⟩⟩
...
def j47 : Jet := ⟨⟨3462699740, 3462699748⟩, ⟨1154233244, 1154233252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2791706819, 2791706833⟩, ⟨1861137874, 1861137894⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2791706819, 2791706833⟩, ⟨1861137874, 1861137894⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2791706833), (-2791706819)⟩, ⟨(-1861137894), (-1861137874)⟩, ⟨(-310189650), (-310189645)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1395853417), (-1395853409)⟩, ⟨(-930568947), (-930568937)⟩, ⟨(-155094825), (-155094822)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3103239265, 3103239276⟩, ⟨(-672363235), (-672363225)⟩, ⟨(-39221763), (-39221757)⟩, ⟨19019054, 19019057⟩, ⟨(-322026), (-322025)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2726142194, 2726142208⟩, ⟨(-708866047), (-708866030)⟩, ⟨(-6627246), (-6627233)⟩, ⟨17639635, 17639646⟩, ⟨(-1014207), (-1014195)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨371332134, 742664270⟩, ⟨185666067, 185666068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1166574304, 2333148615⟩, ⟨583287152, 583287156⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨316858200, 1267432808⟩, ⟨316858200, 633716408⟩, ⟨79214550, 79214552⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨79, 318⟩, ⟨79, 159⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94608), (-94368)⟩, ⟨79, 159⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-27919), (-6961)⟩, ⟨(-13955), (-6914)⟩, ⟨(-1739), (-1710)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5085137, 5106096⟩, ⟨(-13955), (-6914)⟩, ⟨(-1739), (-1710)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨375152, 1506795⟩, ⟨371033, 752888⟩, ⟨91214, 93539⟩, ⟨(-515), (-251)⟩, ⟨(-33), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142790425), (-141658781)⟩, ⟨371033, 752888⟩, ⟨91214, 93539⟩, ⟨(-515), (-251)⟩, ⟨(-33), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-42137055), (-10450777)⟩, ⟨(-21041156), (-10228601)⟩, ⟨(-2599465), (-2474002)⟩, ⟨13420, 27670⟩, ⟨1596, 1706⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1389518710, 1421204989⟩, ⟨(-21041156), (-10228601)⟩, ⟨(-2599465), (-2474002)⟩, ⟨13420, 27670⟩, ⟨1596, 1706⟩⟩
...
def j72 : Jet := ⟨⟨870, 3491⟩, ⟨865, 1746⟩, ⟨213, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851307), (-848685)⟩, ⟨865, 1746⟩, ⟨213, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-251219), (-62611)⟩, ⟨(-125547), (-62095)⟩, ⟨(-15624), (-15329)⟩, ⟨29, 66⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35540175, 35728784⟩, ⟨(-125547), (-62095)⟩, ⟨(-15624), (-15329)⟩, ⟨29, 66⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2621951, 10543464⟩, ⟨2584902, 5267152⟩, ⟨632351, 653256⟩, ⟨(-4620), (-2255)⟩, ⟨(-287), (-270)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713205932), (-705284418)⟩, ⟨2584902, 5267152⟩, ⟨632351, 653256⟩, ⟨(-4620), (-2255)⟩, ⟨(-287), (-270)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-210465072), (-52031863)⟩, ⟨(-105041838), (-50477541)⟩, ⟨(-12916718), (-12038029)⟩, ⟨92961, 193368⟩, ⟨10895, 11864⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4084502224, 4242935433⟩, ⟨(-105041838), (-50477541)⟩, ⟨(-12916718), (-12038029)⟩, ⟨92961, 193368⟩, ⟨10895, 11864⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨377413076, 772039046⟩, ⟨177276382, 190231530⟩, ⟨(-4269643), (-2061090)⟩, ⟨(-349381), (-320955)⟩, ⟨2255, 4685⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4347637234, 4516277153⟩, ⟨51723161, 116145869⟩, ⟨12950429, 17269095⟩, ⟨94990, 712461⟩, ⟨19948, 60163⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨382041358, 811820456⟩, ⟨183995439, 220911452⟩, ⟨(-1216759), 6162132⟩, ⟨60034, 543236⟩, ⟨(-18663), 37220⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-742664270), (-371332134)⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3552303026, 3923635162⟩, ⟨(-185666068), (-185666067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨33982936, 153447607⟩, ⟨32733132, 83511900⟩, ⟨7422347, 13692063⟩, ⟨(-114488), 839260⟩, ⟨(-3660), 78798⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4328950232, 4448414903⟩, ⟨32733132, 83511900⟩, ⟨7422347, 13692063⟩, ⟨(-114488), 839260⟩, ⟨(-3660), 78798⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4311925286, 4371017791⟩, ⟨16081807, 41591732⟩, ⟨3448723, 6789119⟩, ⟨(-122506), 405118⟩, ⟨(-11077), 39048⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3566328725, 3993110522⟩, ⟨(-175652615), (-148403324)⟩, ⟨1054428, 5506953⟩, ⟨(-405401), 221010⟩, ⟨(-27633), 40969⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2308466489, 4616932993⟩, ⟨1154233244, 1154233252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1240758581, 4963034360⟩, ⟨1240758580, 2481517188⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1240758581, 4963034360⟩, ⟨1240758580, 2481517188⟩, ⟨310189645, 310189650⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4963034360), (-1240758581)⟩, ⟨(-2481517188), (-1240758580)⟩, ⟨(-310189650), (-310189645)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2481517180), (-620379290)⟩, ⟨(-1240758594), (-620379290)⟩, ⟨(-155094825), (-155094822)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2410105920, 3717311277⟩, ⟨(-1073881498), (-348123675)⟩, ⟨(-109093121), 68084082⟩, ⟨1824495, 36357682⟩, ⟨(-3855099), 1903838⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2001232926, 3456053039⟩, ⟨(-1150435526), (-372340713)⟩, ⟨(-88805543), 111984188⟩, ⟨(-2997281), 38369847⟩, ⟨(-5290144), 1931113⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4335281071, 4335281073⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified836
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4311925286, 4371017791⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified837
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (235537841 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((34583 / 400000) : ℝ)..(34583 / 200000), prawitzNormalCorrection
