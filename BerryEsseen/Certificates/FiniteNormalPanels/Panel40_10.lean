...
namespace FiniteNormalPanel40_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (240961 / 800000)
def radius : Rat := (34423 / 800000)

def j0 : Jet := ⟨⟨1293649518, 1293649519⟩, ⟨184807074, 184807075⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4064119821, 4064119826⟩, ⟨580588545, 580588550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3845680020, 3845680031⟩, ⟨1098765718, 1098765730⟩, ⟨78483265, 78483267⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨962, 964⟩, ⟨275, 276⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93725), (-93722)⟩, ⟨275, 276⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-83921), (-83917)⟩, ⟨(-23732), (-23728)⟩, ⟨(-1626), (-1623)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5029135, 5029140⟩, ⟨(-23732), (-23728)⟩, ⟨(-1626), (-1623)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4503048, 4503053⟩, ⟨1265335, 1265342⟩, ⟨84370, 84377⟩, ⟨(-842), (-837)⟩, ⟨(-28), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-138662529), (-138662523)⟩, ⟨1265335, 1265342⟩, ⟨84370, 84377⟩, ⟨(-842), (-837)⟩, ⟨(-28), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-124157341), (-124157335)⟩, ⟨(-34340556), (-34340546)⟩, ⟨(-2134574), (-2134564)⟩, ⟨43951, 43959⟩, ⟨1299, 1307⟩⟩
...
def j19 : Jet := ⟨⟨1307498424, 1307498431⟩, ⟨(-34340556), (-34340546)⟩, ⟨(-2134574), (-2134564)⟩, ⟨43951, 43959⟩, ⟨1299, 1307⟩⟩
...
def j22 : Jet := ⟨⟨(-97), (-95)⟩, ⟨(-28), (-27)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11738, 11741⟩, ⟨(-28), (-27)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10510, 10513⟩, ⟨2976, 2980⟩, ⟨204, 209⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841667), (-841663)⟩, ⟨2976, 2980⟩, ⟨204, 209⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-753623), (-753618)⟩, ⟨(-212657), (-212650)⟩, ⟨(-14438), (-14428)⟩, ⟨104, 109⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35037771, 35037777⟩, ⟨(-212657), (-212650)⟩, ⟨(-14438), (-14428)⟩, ⟨104, 109⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨31372545, 31372551⟩, ⟨8773172, 8773181⟩, ⟨572924, 572938⟩, ⟨(-7487), (-7478)⟩, ⟨(-238), (-231)⟩⟩
...
def j33 : Jet := ⟨⟨(-684455338), (-684455331)⟩, ⟨8773172, 8773181⟩, ⟨572924, 572938⟩, ⟨(-7487), (-7478)⟩, ⟨(-238), (-231)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-612855942), (-612855933)⟩, ⟨(-167246270), (-167246256)⟩, ⟨(-9749866), (-9749847)⟩, ⟨300179, 300194⟩, ⟨8339, 8351⟩⟩
...
def j36 : Jet := ⟨⟨3682111354, 3682111363⟩, ⟨(-167246270), (-167246256)⟩, ⟨(-9749866), (-9749847)⟩, ⟨300179, 300194⟩, ⟨8339, 8351⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1237222519, 1237222529⟩, ⟨144251266, 144251280⟩, ⟨(-6661961), (-6661947)⟩, ⟨(-246962), (-246950)⟩, ⟨7170, 7180⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5009827855, 5009827868⟩, ⟨227552854, 227552876⟩, ⟨23601245, 23601275⟩, ⟨1266094, 1266120⟩, ⟨90085, 90109⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1443147621, 1443147638⟩, ⟨233810284, 233810309⟩, ⟨6670480, 6670509⟩, ⟨516362, 516389⟩, ⟨27142, 27168⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1293649519), (-1293649518)⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3001317777, 3001317778⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨484910573, 484910586⟩, ⟨157124714, 157124734⟩, ⟨17210892, 17210918⟩, ⟨1073260, 1073286⟩, ⟨84815, 84842⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4779877869, 4779877882⟩, ⟨157124714, 157124734⟩, ⟨17210892, 17210918⟩, ⟨1073260, 1073286⟩, ⟨84815, 84842⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4530940203, 4530940210⟩, ⟨74470802, 74470813⟩, ⟨7545267, 7545281⟩, ⟨384666, 384681⟩, ⟨27592, 27608⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3166215349, 3166215356⟩, ⟨(-142920592), (-142920581)⟩, ⟨2068236, 2068248⟩, ⟨(-55861), (-55848)⟩, ⟨2728, 2742⟩⟩
...
def j47 : Jet := ⟨⟨8412544926, 8412544936⟩, ⟨1201792132, 1201792140⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16477637023, 16477637063⟩, ⟨4707896290, 4707896330⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16477637023, 16477637063⟩, ⟨4707896290, 4707896330⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16477637063), (-16477637023)⟩, ⟨(-4707896330), (-4707896290)⟩, ⟨(-336278311), (-336278306)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8238818532), (-8238818511)⟩, ⟨(-2353948165), (-2353948145)⟩, ⟨(-168139156), (-168139153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨630775359, 630775372⟩, ⟨(-345709857), (-345709846)⟩, ⟨70043254, 70043260⟩, ⟨(-3773680), (-3773677)⟩, ⟨(-853965), (-853963)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨465002521, 465002533⟩, ⟨(-275844394), (-275844382)⟩, ⟨63443013, 63443023⟩, ⟨(-5287390), (-5287381)⟩, ⟨(-465340), (-465329)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1108842444, 1478456593⟩, ⟨184807074, 184807075⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3483531275, 4644708372⟩, ⟨580588545, 580588550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2825397565, 5022929018⟩, ⟨941799186, 1255732262⟩, ⟨78483265, 78483267⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨707, 1259⟩, ⟨235, 315⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93980), (-93427)⟩, ⟨235, 315⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-109909), (-61459)⟩, ⟨(-27324), (-20117)⟩, ⟨(-1655), (-1590)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5003147, 5051598⟩, ⟨(-27324), (-20117)⟩, ⟨(-1655), (-1590)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3291265, 5907803⟩, ⟨1065132, 1463718⟩, ⟨81499, 86854⟩, ⟨(-979), (-700)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139874312), (-137257773)⟩, ⟨1065132, 1463718⟩, ⟨81499, 86854⟩, ⟨(-979), (-700)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-163581861), (-90293534)⟩, ⟨(-40194781), (-28386037)⟩, ⟨(-2268793), (-1978625)⟩, ⟨36189, 51681⟩, ⟨1166, 1420⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1268073904, 1341362232⟩, ⟨(-40194781), (-28386037)⟩, ⟨(-2268793), (-1978625)⟩, ⟨36189, 51681⟩, ⟨1166, 1420⟩⟩
...
def j72 : Jet := ⟨⟨7701, 13761⟩, ⟨2529, 3426⟩, ⟨200, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844476), (-838415)⟩, ⟨2529, 3426⟩, ⟨200, 211⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-987608), (-551542)⟩, ⟨(-245239), (-179840)⟩, ⟨(-14747), (-14071)⟩, ⟨86, 125⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34803786, 35239853⟩, ⟨(-245239), (-179840)⟩, ⟨(-14747), (-14071)⟩, ⟨86, 125⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨22895292, 41212719⟩, ⟨7344959, 10184875⟩, ⟨547031, 595258⟩, ⟨(-8738), (-6224)⟩, ⟨(-252), (-215)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692932591), (-674615163)⟩, ⟨7344959, 10184875⟩, ⟨547031, 595258⟩, ⟨(-8738), (-6224)⟩, ⟨(-252), (-215)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-810378981), (-443788254)⟩, ⟨(-197762946), (-136018289)⟩, ⟨(-10691714), (-8653519)⟩, ⟨243948, 356056⟩, ⟨7146, 9373⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3484588315, 3851179042⟩, ⟨(-197762946), (-136018289)⟩, ⟨(-10691714), (-8653519)⟩, ⟨243948, 356056⟩, ⟨7146, 9373⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1028500288, 1450589949⟩, ⟨127948854, 158300602⟩, ⟨(-7887025), (-5441998)⟩, ⟨(-277342), (-211578)⟩, ⟨5836, 8523⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4789895217, 5293808739⟩, ⟨169172439, 300442726⟩, ⟨16737728, 33294129⟩, ⟨481845, 2476079⟩, ⟨13964, 221020⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1147018887, 1787940448⟩, ⟨183204073, 296587197⟩, ⟨(-673399), 16249203⟩, ⟨(-279549), 1613095⟩, ⟨(-56336), 146876⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1478456593), (-1108842444)⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2816510703, 3186124852⟩, ⟨(-184807075), (-184807074)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨306324178, 744296947⟩, ⟨97853378, 246930982⟩, ⟨7254009, 34009383⟩, ⟨(-325750), 3587190⟩, ⟨(-88062), 406546⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4601291474, 5039264243⟩, ⟨97853378, 246930982⟩, ⟨7254009, 34009383⟩, ⟨(-325750), 3587190⟩, ⟨(-88062), 406546⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4445491693, 4652254843⟩, ⟨45169178, 119284949⟩, ⟨1819207, 16199439⟩, ⟨(-592038), 1714380⟩, ⟨(-118058), 211905⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2915220086, 3451170580⟩, ⟨(-170560121), (-102795094)⟩, ⟨(-3939702), 10073617⟩, ⟨(-1136233), 1193497⟩, ⟨(-161347), 182672⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7210752794, 9614337068⟩, ⟨1201792132, 1201792140⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12106019038, 21521811667⟩, ⟨4035339678, 5380452946⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12106019038, 21521811667⟩, ⟨4035339678, 5380452946⟩, ⟨336278306, 336278311⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21521811667), (-12106019038)⟩, ⟨(-5380452946), (-4035339678)⟩, ⟨(-336278311), (-336278306)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10760905834), (-6053009519)⟩, ⟨(-2690226473), (-2017669839)⟩, ⟨(-168139156), (-168139153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨350629665, 1049294299⟩, ⟨(-657243492), (-164717179)⟩, ⟨(-2387683), 192111439⟩, ⟨(-35811873), 17651679⟩, ⟨(-6524493), 5654582⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨237990785, 843148124⟩, ⟨(-569789477), (-120194125)⟩, ⟨1061219, 182930163⟩, ⟨(-38224389), 15173079⟩, ⟨(-6341934), 6634913⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1293649518, 1293649519⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4530940203, 4530940210⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified788
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1108842444, 1478456593⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4445491693, 4652254843⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified789
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (41951069 / 4294967296)

theorem envelope_integral : (∫ s in ((103269 / 400000) : ℝ)..(34423 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((103269 / 400000) : ℝ)..(34423 / 100000), prawitzNormalCorrection
