...
namespace FiniteNormalPanel94_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (89667 / 800000)
def radius : Rat := (29889 / 800000)

def j0 : Jet := ⟨⟨481396040, 481396041⟩, ⟨160465346, 160465347⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1512350262, 1512350266⟩, ⟨504116752, 504116756⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨532531019, 532531023⟩, ⟨355020678, 355020684⟩, ⟨59170112, 59170114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨133, 134⟩, ⟨88, 89⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94554), (-94552)⟩, ⟨88, 89⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11724), (-11723)⟩, ⟨(-7806), (-7803)⟩, ⟨(-1295), (-1292)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101332, 5101334⟩, ⟨(-7806), (-7803)⟩, ⟨(-1295), (-1292)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨632511, 632513⟩, ⟨420706, 420708⟩, ⟨69472, 69476⟩, ⟨(-216), (-212)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-142533066), (-142533063)⟩, ⟨420706, 420708⟩, ⟨69472, 69476⟩, ⟨(-216), (-212)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17672610), (-17672608)⟩, ⟨(-11729577), (-11729575)⟩, ⟨(-1920236), (-1920232)⟩, ⟨11510, 11513⟩, ⟨936, 940⟩⟩
...
def j19 : Jet := ⟨⟨1413983155, 1413983158⟩, ⟨(-11729577), (-11729575)⟩, ⟨(-1920236), (-1920232)⟩, ⟨11510, 11513⟩, ⟨936, 940⟩⟩
...
def j25 : Jet := ⟨⟨1465, 1466⟩, ⟨975, 978⟩, ⟨160, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850712), (-850710)⟩, ⟨975, 978⟩, ⟨160, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-105480), (-105479)⟩, ⟨(-70200), (-70197)⟩, ⟨(-11621), (-11617)⟩, ⟨25, 28⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35685914, 35685916⟩, ⟨(-70200), (-70197)⟩, ⟨(-11621), (-11617)⟩, ⟨25, 28⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4424680, 4424681⟩, ⟨2941081, 2941084⟩, ⟨484387, 484390⟩, ⟨(-1926), (-1923)⟩, ⟨(-159), (-156)⟩⟩
...
def j33 : Jet := ⟨⟨(-711403203), (-711403201)⟩, ⟨2941081, 2941084⟩, ⟨484387, 484390⟩, ⟨(-1926), (-1923)⟩, ⟨(-159), (-156)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-88206557), (-88206555)⟩, ⟨(-58439709), (-58439706)⟩, ⟨(-9497563), (-9497558)⟩, ⟨80318, 80321⟩, ⟨6493, 6497⟩⟩
...
def j36 : Jet := ⟨⟨4206760739, 4206760741⟩, ⟨(-58439709), (-58439706)⟩, ⟨(-9497563), (-9497558)⟩, ⟨80318, 80321⟩, ⟨6493, 6497⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨497893848, 497893851⟩, ⟨161834378, 161834383⟩, ⟨(-2052903), (-2052899)⟩, ⟨(-221334), (-221330)⟩, ⟨1679, 1683⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4385023349, 4385023352⟩, ⟨60916103, 60916108⟩, ⟨10746255, 10746265⟩, ⟨203088, 203096⟩, ⟨19145, 19154⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨508333591, 508333595⟩, ⟨172289385, 172289393⟩, ⟨1445129, 1445138⟩, ⟨173368, 173378⟩, ⟨3308, 3318⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-481396041), (-481396040)⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3813571255, 3813571256⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨60164146, 60164148⟩, ⟨40782838, 40782844⟩, ⟨7253337, 7253342⟩, ⟨156978, 156984⟩, ⟨15176, 15183⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4355131442, 4355131444⟩, ⟨40782838, 40782844⟩, ⟨7253337, 7253342⟩, ⟨156978, 156984⟩, ⟨15176, 15183⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4324944752, 4324944754⟩, ⟨20250080, 20250084⟩, ⟨3554123, 3554127⟩, ⟨61303, 61308⟩, ⟨5786, 5792⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3840188725, 3840188729⟩, ⟨(-143604968), (-143604962)⟩, ⟨2399194, 2399200⟩, ⟨(-78356), (-78349)⟩, ⟨2846, 2853⟩⟩
...
def j47 : Jet := ⟨⟨4556800480, 4556800492⟩, ⟨1518933487, 1518933498⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4834595745, 4834595771⟩, ⟨3223063816, 3223063850⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4834595745, 4834595771⟩, ⟨3223063816, 3223063850⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4834595771), (-4834595745)⟩, ⟨(-3223063850), (-3223063816)⟩, ⟨(-537177309), (-537177300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2417297886), (-2417297872)⟩, ⟨(-1611531925), (-1611531908)⟩, ⟨(-268588655), (-268588650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2446413114, 2446413131⟩, ⟨(-917928495), (-917928478)⟩, ⟨19221730, 19221740⟩, ⟨35864758, 35864762⟩, ⟨(-3965263), (-3965261)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2187371267, 2187371285⟩, ⟨(-902529746), (-902529724)⟩, ⟨49244512, 49244530⟩, ⟨30867082, 30867095⟩, ⟨(-4715456), (-4715442)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨320930693, 641861388⟩, ⟨160465346, 160465347⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1008233507, 2016467022⟩, ⟨504116752, 504116756⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨236680452, 946721819⟩, ⟨236680452, 473360910⟩, ⟨59170112, 59170114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨59, 238⟩, ⟨59, 119⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94628), (-94448)⟩, ⟨59, 119⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-20859), (-5204)⟩, ⟨(-10427), (-5177)⟩, ⟨(-1301), (-1283)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092197, 5107853⟩, ⟨(-10427), (-5177)⟩, ⟨(-1301), (-1283)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨280612, 1125903⟩, ⟨278313, 562667⟩, ⟨68716, 70014⟩, ⟨(-288), (-140)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142884965), (-142039673)⟩, ⟨278313, 562667⟩, ⟨68716, 70014⟩, ⟨(-288), (-140)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-31495540), (-7827303)⟩, ⟨(-15732434), (-7703276)⟩, ⟨(-1949350), (-1879378)⟩, ⟨7556, 15462⟩, ⟨910, 958⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1400160225, 1423828463⟩, ⟨(-15732434), (-7703276)⟩, ⟨(-1949350), (-1879378)⟩, ⟨7556, 15462⟩, ⟨910, 958⟩⟩
...
def j72 : Jet := ⟨⟨650, 2608⟩, ⟨647, 1304⟩, ⟨159, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851527), (-849568)⟩, ⟨647, 1304⟩, ⟨159, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-187699), (-46816)⟩, ⟨(-93815), (-46528)⟩, ⟨(-11689), (-11524)⟩, ⟨15, 36⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35603695, 35744579⟩, ⟨(-93815), (-46528)⟩, ⟨(-11689), (-11524)⟩, ⟨15, 36⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1961993, 7879030⟩, ⟨1941313, 3936952⟩, ⟨477581, 489242⟩, ⟨(-2582), (-1267)⟩, ⟨(-162), (-153)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713865890), (-707948852)⟩, ⟨1941313, 3936952⟩, ⟨477581, 489242⟩, ⟨(-2582), (-1267)⟩, ⟨(-162), (-153)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-157354496), (-39012556)⟩, ⟨(-78570271), (-38144750)⟩, ⟨(-9701362), (-9211393)⟩, ⟨52491, 108090⟩, ⟨6258, 6664⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4137612800, 4255954740⟩, ⟨(-78570271), (-38144750)⟩, ⟨(-9701362), (-9211393)⟩, ⟨52491, 108090⟩, ⟨6258, 6664⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨328684331, 668480793⟩, ⟨156955860, 165311874⟩, ⟨(-2761788), (-1345341)⟩, ⟨(-227030), (-213329)⟩, ⟨1099, 2265⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4334337463, 4458306025⟩, ⟨38847268, 84660004⟩, ⟨9729214, 12060918⟩, ⟨58048, 372543⟩, ⟨12445, 28308⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨331697242, 693903293⟩, ⟨161367503, 184775450⟩, ⟨(-702626), 3778059⟩, ⟨69883, 294753⟩, ⟨(-8050), 16122⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-641861388), (-320930693)⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3653105908, 3974036603⟩, ⟨(-160465347), (-160465346)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨25616739, 112108370⟩, ⟨24924592, 59705366⟩, ⟨5835750, 9170079⟩, ⟨(-49662), 420318⟩, ⟨2029, 33896⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4320584035, 4407075666⟩, ⟨24924592, 59705366⟩, ⟨5835750, 9170079⟩, ⟨(-49662), 420318⟩, ⟨2029, 33896⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307756623, 4350660394⟩, ⟨12302765, 29764054⟩, ⟨2778710, 4553860⟩, ⟨(-56223), 201600⟩, ⟨(-2790), 16391⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3663983934, 4025568174⟩, ⟨(-152081933), (-133403161)⟩, ⟨1251422, 3753939⟩, ⟨(-222160), 82720⟩, ⟨(-10115), 17268⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3037866984, 6075733989⟩, ⟨1518933487, 1518933498⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2148709216, 8594836925⟩, ⟨2148709208, 4297418466⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2148709216, 8594836925⟩, ⟨2148709208, 4297418466⟩, ⟨537177300, 537177309⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8594836925), (-2148709216)⟩, ⟨(-4297418466), (-2148709208)⟩, ⟨(-537177309), (-537177300)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4297418463), (-1074354608)⟩, ⟨(-2148709233), (-1074354604)⟩, ⟨(-268588655), (-268588650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1579128684, 3344446695⟩, ⟨(-1673177698), (-395007471)⟩, ⟨(-159743101), 319781281⟩, ⟨(-36859260), 96394570⟩, ⟨(-22055067), 9604858⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1347135316, 3134668380⟩, ⟨(-1686653312), (-386024308)⟩, ⟨(-136994140), 361892465⟩, ⟨(-47505935), 95954000⟩, ⟨(-24264668), 10687056⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨481396040, 481396041⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4324944752, 4324944754⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1900
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨320930693, 641861388⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307756623, 4350660394⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1901
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (82416061 / 2147483648)

theorem envelope_integral : (∫ s in ((29889 / 400000) : ℝ)..(29889 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((29889 / 400000) : ℝ)..(29889 / 200000), prawitzNormalCorrection
