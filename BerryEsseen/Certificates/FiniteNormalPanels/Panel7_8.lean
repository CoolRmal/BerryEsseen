...
namespace FiniteNormalPanel7_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38213 / 100000)
def radius : Rat := (5459 / 100000)

def j0 : Jet := ⟨⟨1641235852, 1641235853⟩, ⟨234462264, 234462265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5156094495, 5156094499⟩, ⟨736584926, 736584930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨6189874941, 6189874952⟩, ⟨1768535692, 1768535706⟩, ⟨126323977, 126323980⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1549, 1551⟩, ⟨442, 444⟩, ⟨31, 32⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93138), (-93135)⟩, ⟨442, 444⟩, ⟨31, 32⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-134230), (-134225)⟩, ⟨(-37715), (-37710)⟩, ⟨(-2514), (-2509)⟩, ⟨25, 28⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4978826, 4978832⟩, ⟨(-37715), (-37710)⟩, ⟨(-2514), (-2509)⟩, ⟨25, 28⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨7175447, 7175456⟩, ⟨1995772, 1995784⟩, ⟨127283, 127296⟩, ⟨(-2110), (-2101)⟩, ⟨(-64), (-59)⟩⟩
...
def j16 : Jet := ⟨⟨(-135990130), (-135990120)⟩, ⟨1995772, 1995784⟩, ⟨127283, 127296⟩, ⟨(-2110), (-2101)⟩, ⟨(-64), (-59)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-195987965), (-195987950)⟩, ⟨(-53120271), (-53120246)⟩, ⟨(-2994519), (-2994492)⟩, ⟨108069, 108091⟩, ⟨2781, 2795⟩⟩
...
def j19 : Jet := ⟨⟨1235667800, 1235667816⟩, ⟨(-53120271), (-53120246)⟩, ⟨(-2994519), (-2994492)⟩, ⟨108069, 108091⟩, ⟨2781, 2795⟩⟩
...
def j22 : Jet := ⟨⟨(-156), (-154)⟩, ⟨(-45), (-44)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11679, 11682⟩, ⟨(-45), (-44)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨16831, 16837⟩, ⟨4744, 4748⟩, ⟨318, 322⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-835346), (-835339)⟩, ⟨4744, 4748⟩, ⟨318, 322⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1203895), (-1203884)⟩, ⟨(-337133), (-337123)⟩, ⟨(-22159), (-22148)⟩, ⟨263, 271⟩, ⟨5, 10⟩⟩
...
def j30 : Jet := ⟨⟨34587499, 34587511⟩, ⟨(-337133), (-337123)⟩, ⟨(-22159), (-22148)⟩, ⟨263, 271⟩, ⟨5, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨49847246, 49847264⟩, ⟨13756196, 13756217⟩, ⟨846532, 846557⟩, ⟨(-18662), (-18643)⟩, ⟨(-537), (-524)⟩⟩
...
def j33 : Jet := ⟨⟨(-665980637), (-665980618)⟩, ⟨13756196, 13756217⟩, ⟨846532, 846557⟩, ⟨(-18662), (-18643)⟩, ⟨(-537), (-524)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-959806346), (-959806316)⟩, ⟨(-254405059), (-254405017)⟩, ⟨(-12703491), (-12703443)⟩, ⟨726277, 726319⟩, ⟨16439, 16469⟩⟩
...
def j36 : Jet := ⟨⟨3335160950, 3335160980⟩, ⟨(-254405059), (-254405017)⟩, ⟨(-12703491), (-12703443)⟩, ⟨726277, 726319⟩, ⟨16439, 16469⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1483415239, 1483415261⟩, ⟨148145746, 148145782⟩, ⟨(-12705014), (-12704975)⟩, ⟨(-383823), (-383791)⟩, ⟨21871, 21894⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5530990613, 5530990663⟩, ⟨421902200, 421902281⟩, ⟨53249799, 53249894⟩, ⟨4464358, 4464448⟩, ⟨424170, 424239⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1910318565, 1910318611⟩, ⟨336498226, 336498307⟩, ⟨16582957, 16583050⟩, ⟨1636339, 1636424⟩, ⟨133430, 133495⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1641235853), (-1641235852)⟩, ⟨(-234462265), (-234462264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2653731443, 2653731444⟩, ⟨(-234462265), (-234462264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨849672830, 849672872⟩, ⟨299335832, 299335914⟩, ⟨41115217, 41115315⟩, ⟨4054076, 4054170⟩, ⟨439125, 439202⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5144640126, 5144640168⟩, ⟨299335832, 299335914⟩, ⟨41115217, 41115315⟩, ⟨4054076, 4054170⟩, ⟨439125, 439202⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4700644752, 4700644772⟩, ⟨136751198, 136751237⟩, ⟨16794250, 16794297⟩, ⟨1363518, 1363565⟩, ⟨130943, 130981⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2904387372, 2904387387⟩, ⟨(-172113737), (-172113709)⟩, ⟨2911412, 2911446⟩, ⟨(-74325), (-74292)⟩, ⟨6467, 6496⟩⟩
...
def j47 : Jet := ⟨⟨6222872551, 6222872558⟩, ⟨888981790, 888981796⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9016167089, 9016167111⟩, ⟨2576047730, 2576047752⟩, ⟨184003408, 184003412⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9016167089, 9016167111⟩, ⟨2576047730, 2576047752⟩, ⟨184003408, 184003412⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9016167111), (-9016167089)⟩, ⟨(-2576047752), (-2576047730)⟩, ⟨(-184003412), (-184003408)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4508083556), (-4508083544)⟩, ⟨(-1288023876), (-1288023865)⟩, ⟨(-92001706), (-92001704)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1503542426, 1503542445⟩, ⟨(-450899492), (-450899481)⟩, ⟨35403337, 35403341⟩, ⟨2900036, 2900038⟩, ⟨(-596609), (-596607)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1016741067, 1016741087⟩, ⟨(-365163923), (-365163902)⟩, ⟨43029062, 43029083⟩, ⟨210688, 210708⟩, ⟨(-485601), (-485580)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1406773588, 1875698118⟩, ⟨234462264, 234462265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4419509569, 5892679429⟩, ⟨736584926, 736584930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4547663226, 8084734635⟩, ⟨1515887736, 2021183664⟩, ⟨126323977, 126323980⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1138, 2026⟩, ⟨379, 507⟩, ⟨31, 32⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93549), (-92660)⟩, ⟨379, 507⟩, ⟨31, 32⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-176095), (-98111)⟩, ⟨(-43623), (-31748)⟩, ⟨(-2587), (-2425)⟩, ⟨21, 31⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4936961, 5014946⟩, ⟨(-43623), (-31748)⟩, ⟨(-2587), (-2425)⟩, ⟨21, 31⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨5227428, 9440004⟩, ⟨1660361, 2326386⟩, ⟨119807, 133729⟩, ⟨(-2480), (-1729)⟩, ⟨(-70), (-54)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-137938149), (-133725572)⟩, ⟨1660361, 2326386⟩, ⟨119807, 133729⟩, ⟨(-2480), (-1729)⟩, ⟨(-70), (-54)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-259651181), (-141593363)⟩, ⟨(-63154748), (-42818658)⟩, ⟨(-3344179), (-2586637)⟩, ⟨86450, 129526⟩, ⟨2223, 3267⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1172004584, 1290062403⟩, ⟨(-63154748), (-42818658)⟩, ⟨(-3344179), (-2586637)⟩, ⟨86450, 129526⟩, ⟨2223, 3267⟩⟩
...
def j70 : Jet := ⟨⟨(-204), (-113)⟩, ⟨(-51), (-37)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11631, 11723⟩, ⟨(-51), (-37)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨12315, 22068⟩, ⟨4008, 5478⟩, ⟨309, 329⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-839862), (-830108)⟩, ⟨4008, 5478⟩, ⟨309, 329⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1580935), (-878947)⟩, ⟨(-390991), (-282670)⟩, ⟨(-22962), (-21217)⟩, ⟨218, 315⟩, ⟨5, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34210459, 34912448⟩, ⟨(-390991), (-282670)⟩, ⟨(-22962), (-21217)⟩, ⟨218, 315⟩, ⟨5, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨36223243, 65718284⟩, ⟨11338422, 16130271⟩, ⟨778979, 904618⟩, ⟨(-22076), (-15208)⟩, ⟨(-595), (-456)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-679604640), (-650109598)⟩, ⟨11338422, 16130271⟩, ⟨778979, 904618⟩, ⟨(-22076), (-15208)⟩, ⟨(-595), (-456)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1279270084), (-688359027)⟩, ⟨(-307812000), (-199089805)⟩, ⟨(-15161946), (-9827452)⟩, ⟨566866, 884032⟩, ⟨11401, 20758⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3015697212, 3606608269⟩, ⟨(-307812000), (-199089805)⟩, ⟨(-15161946), (-9827452)⟩, ⟨566866, 884032⟩, ⟨11401, 20758⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1205989502, 1769960901⟩, ⟨114350165, 177184833⟩, ⟨(-15419213), (-10005022)⟩, ⟨(-484570), (-265897)⟩, ⟨17113, 26697⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5114706865, 6116908555⟩, ⟨282338950, 624352422⟩, ⟨29522291, 94481438⟩, ⟨899656, 11821336⟩, ⟨(-69534), 1609220⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1436165251, 2520784964⟩, ⟨215453417, 509643648⟩, ⟨(-6153445), 52778395⟩, ⟨(-1892970), 7794982⟩, ⟨(-393962), 1102613⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1875698118), (-1406773588)⟩, ⟨(-234462265), (-234462264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2419269178, 2888193708⟩, ⟨(-234462265), (-234462264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨480229646, 1479488992⟩, ⟨144088040, 598236010⟩, ⟨3584927, 122427619⟩, ⟨(-3682374), 21675440⟩, ⟨(-987307), 3792764⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4775196942, 5774456288⟩, ⟨144088040, 598236010⟩, ⟨3584927, 122427619⟩, ⟨(-3682374), 21675440⟩, ⟨(-987307), 3792764⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4528721088, 4980070372⟩, ⟨62132999, 283678775⟩, ⟨(-7184866), 57627982⟩, ⟨(-5355967), 10728383⟩, ⟨(-1506858), 2179711⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2550938013, 3348898123⟩, ⟨(-236863767), (-56460253)⟩, ⟨(-20317560), 35360673⟩, ⟨(-6747586), 7606631⟩, ⟨(-1598965), 1758152⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5333890760, 7111854353⟩, ⟨888981790, 888981796⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6624122764, 11776218270⟩, ⟨2208040912, 2944054574⟩, ⟨184003408, 184003412⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6624122764, 11776218270⟩, ⟨2208040912, 2944054574⟩, ⟨184003408, 184003412⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11776218270), (-6624122764)⟩, ⟨(-2944054574), (-2208040912)⟩, ⟨(-184003412), (-184003408)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5888109135), (-3312061382)⟩, ⟨(-1472027287), (-1104020456)⟩, ⟨(-92001706), (-92001704)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1090364122, 1986341609⟩, ⟨(-680784940), (-280277872)⟩, ⟨(-6526375), 93307265⟩, ⟨(-6657308), 10467582⟩, ⟨(-1896256), 640321⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨647607093, 1548802407⟩, ⟨(-640370829), (-180800843)⟩, ⟨(-10800833), 126652465⟩, ⟨(-19062261), 15260183⟩, ⟨(-4442436), 3517281⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1641235852, 1641235853⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4700644752, 4700644772⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified144
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1406773588, 1875698118⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4528721088, 4980070372⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified145
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (112650567 / 4294967296)

theorem envelope_integral : (∫ s in ((16377 / 50000) : ℝ)..(5459 / 12500),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((16377 / 50000) : ℝ)..(5459 / 12500), prawitzNormalCorrection
