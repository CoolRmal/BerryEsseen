...
namespace FiniteNormalPanel14_20
...
def j2 : Jet := ⟨⟨651781185, 651781189⟩, ⟨651781185, 651781189⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨98910814, 98910816⟩, ⟨197821628, 197821632⟩, ⟨98910814, 98910816⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-2181), (-2179)⟩, ⟨(-4360), (-4357)⟩, ⟨(-2179), (-2175)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110875, 5110878⟩, ⟨(-4360), (-4357)⟩, ⟨(-2179), (-2175)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨117700, 117701⟩, ⟨235300, 235302⟩, ⟨117448, 117451⟩, ⟨(-202), (-199)⟩, ⟨(-51), (-48)⟩⟩
...
def j16 : Jet := ⟨⟨(-143047877), (-143047875)⟩, ⟨235300, 235302⟩, ⟨117448, 117451⟩, ⟨(-202), (-199)⟩, ⟨(-51), (-48)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3294317), (-3294316)⟩, ⟨(-6583216), (-6583214)⟩, ⟨(-3280776), (-3280773)⟩, ⟨10822, 10825⟩, ⟨2692, 2695⟩⟩
...
def j19 : Jet := ⟨⟨1428361448, 1428361450⟩, ⟨(-6583216), (-6583214)⟩, ⟨(-3280776), (-3280773)⟩, ⟨10822, 10825⟩, ⟨2692, 2695⟩⟩
...
def j25 : Jet := ⟨⟨272, 273⟩, ⟨543, 546⟩, ⟨270, 273⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851905), (-851903)⟩, ⟨543, 546⟩, ⟨270, 273⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-19619), (-19618)⟩, ⟨(-39226), (-39224)⟩, ⟨(-19588), (-19585)⟩, ⟨23, 26⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35771775, 35771777⟩, ⟨(-39226), (-39224)⟩, ⟨(-19588), (-19585)⟩, ⟨23, 26⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨823804, 823806⟩, ⟨1646705, 1646708⟩, ⟨821545, 821549⟩, ⟨(-1807), (-1804)⟩, ⟨(-451), (-448)⟩⟩
...
def j33 : Jet := ⟨⟨(-715004079), (-715004076)⟩, ⟨1646705, 1646708⟩, ⟨821545, 821549⟩, ⟨(-1807), (-1804)⟩, ⟨(-451), (-448)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-16466165), (-16466163)⟩, ⟨(-32894407), (-32894404)⟩, ⟨(-16371401), (-16371397)⟩, ⟨75719, 75722⟩, ⟨18824, 18827⟩⟩
...
def j36 : Jet := ⟨⟨4278501131, 4278501133⟩, ⟨(-32894407), (-32894404)⟩, ⟨(-16371401), (-16371397)⟩, ⟨75719, 75722⟩, ⟨18824, 18827⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨216760467, 216760469⟩, ⟨215761433, 215761436⟩, ⟨(-1496907), (-1496905)⟩, ⟨(-496231), (-496229)⟩, ⟨2050, 2052⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4311496830, 4311496833⟩, ⟨33148084, 33148089⟩, ⟨16752504, 16752511⟩, ⟨179329, 179336⟩, ⟨45920, 45928⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨217594687, 217594690⟩, ⟨218264741, 218264746⟩, ⟨1008027, 1008033⟩, ⟨340932, 340939⟩, ⟨3713, 3721⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-207468396), (-207468395)⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4087498900, 4087498901⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨11023936, 11023938⟩, ⟨22115766, 22115768⟩, ⟨11194072, 11194076⟩, ⟨136996, 137000⟩, ⟨35262, 35269⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4305991232, 4305991234⟩, ⟨22115766, 22115768⟩, ⟨11194072, 11194076⟩, ⟨136996, 137000⟩, ⟨35262, 35269⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4300475731, 4300475733⟩, ⟨11043719, 11043721⟩, ⟨5575686, 5575689⟩, ⟨54091, 54095⟩, ⟨13853, 13859⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4092741250, 4092741253⟩, ⟨(-197224230), (-197224224)⟩, ⟨4772885, 4772890⟩, ⟨(-217856), (-217851)⟩, ⟨10569, 10578⟩⟩
...
def j47 : Jet := ⟨⟨1017911663, 1017911669⟩, ⟨1017911663, 1017911669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨241246110, 241246114⟩, ⟨482492220, 482492228⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨241246110, 241246114⟩, ⟨482492220, 482492228⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-241246114), (-241246110)⟩, ⟨(-482492228), (-482492220)⟩, ⟨(-241246114), (-241246110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-120623057), (-120623055)⟩, ⟨(-241246114), (-241246110)⟩, ⟨(-120623057), (-120623055)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4176022326, 4176022329⟩, ⟨(-234565037), (-234565032)⟩, ⟨(-110694820), (-110694816)⟩, ⟨6464356, 6464357⟩, ⟨1463642, 1463644⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3979396734, 3979396741⟩, ⟨(-415282975), (-415282962)⟩, ⟨(-90070926), (-90070913)⟩, ⟨10770583, 10770594⟩, ⟨997044, 997060⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 414936791⟩, ⟨207468395, 207468396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1303562375⟩, ⟨651781185, 651781189⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 395643261⟩, ⟨0, 395643262⟩, ⟨98910814, 98910816⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 100⟩, ⟨0, 100⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94586)⟩, ⟨0, 100⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-8723), 0⟩, ⟨(-8723), 10⟩, ⟨(-2181), (-2165)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5104333, 5113057⟩, ⟨(-8723), 10⟩, ⟨(-2181), (-2165)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 471004⟩, ⟨(-804), 471005⟩, ⟨116545, 117752⟩, ⟨(-402), 2⟩, ⟨(-51), (-47)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142694572)⟩, ⟨(-804), 471005⟩, ⟨116545, 117752⟩, ⟨(-402), 2⟩, ⟨(-51), (-47)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-13188109), 0⟩, ⟨(-13188184), 43388⟩, ⟨(-3297103), (-3231944)⟩, ⟨(-57), 21696⟩, ⟨2640, 2713⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1418467656, 1431655766⟩, ⟨(-13188184), 43388⟩, ⟨(-3297103), (-3231944)⟩, ⟨(-57), 21696⟩, ⟨2640, 2713⟩⟩
...
def j72 : Jet := ⟨⟨0, 1091⟩, ⟨(-1), 1091⟩, ⟨270, 273⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851085)⟩, ⟨(-1), 1091⟩, ⟨270, 273⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-78501), 0⟩, ⟨(-78502), 101⟩, ⟨(-19627), (-19473)⟩, ⟨(-2), 52⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35712893, 35791395⟩, ⟨(-78502), 101⟩, ⟨(-19627), (-19473)⟩, ⟨(-2), 52⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3297028⟩, ⟨(-7232), 3297038⟩, ⟨813408, 824267⟩, ⟨(-3617), 8⟩, ⟨(-453), (-442)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712530854)⟩, ⟨(-7232), 3297038⟩, ⟨813408, 824267⟩, ⟨(-3617), 8⟩, ⟨(-453), (-442)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-65940544), 0⟩, ⟨(-65941211), 303717⟩, ⟨(-16485804), (-16029559)⟩, ⟨(-501), 151861⟩, ⟨18356, 18984⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4229026752, 4294967296⟩, ⟨(-65941211), 303717⟩, ⟨(-16485804), (-16029559)⟩, ⟨(-501), 151861⟩, ⟨18356, 18984⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 434520792⟩, ⟨211256301, 217273566⟩, ⟨(-3002071), 6585⟩, ⟨(-500369), (-483877)⟩, ⟨(-9), 4117⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4361936010⟩, ⟨(-313263), 68013603⟩, ⟨16024749, 18064423⟩, ⟨(-159154), 547323⟩, ⟨35677, 60326⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 441296001⟩, ⟨211224608, 227542296⟩, ⟨(-3064729), 5274931⟩, ⟨216395, 485558⟩, ⟨(-28613), 38039⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-414936791), 0⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3880030505, 4294967296⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 45341943⟩, ⟨0, 46758684⟩, ⟨9758147, 13138893⟩, ⟨(-324732), 658700⟩, ⟨11640, 65747⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4340309239⟩, ⟨0, 46758684⟩, ⟨9758147, 13138893⟩, ⟨(-324732), 658700⟩, ⟨11640, 65747⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4317578747⟩, ⟨0, 23379342⟩, ⟨4790222, 6569447⟩, ⟨(-198127), 329350⟩, ⟨(-998), 31282⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3880030505, 4317578747⟩, ⟨(-208560643), (-184089053)⟩, ⟨3198098, 6569447⟩, ⟨(-515465), 97959⟩, ⟨(-16908), 40853⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2035823334⟩, ⟨1017911663, 1017911669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 964984449⟩, ⟨0, 964984452⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 964984449⟩, ⟨0, 964984452⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-964984449), 0⟩, ⟨(-964984452), 0⟩, ⟨(-241246114), (-241246110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-482492225), 0⟩, ⟨(-482492226), 0⟩, ⟨(-120623057), (-120623055)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3838589439, 4294967296⟩, ⟨(-482492226), 0⟩, ⟨(-120623057), (-80704458)⟩, ⟨0, 13550671⟩, ⟨752714, 1693834⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3467743312, 4317578747⟩, ⟨(-693593017), (-164527980)⟩, ⟨(-118399822), (-42908664)⟩, ⟨2205649, 19577343⟩, ⟨(-190433), 1741419⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4300475731, 4300475733⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified286
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4317578747⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified287
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (47697823 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(9661 / 100000), prawitzNormalCorrection
