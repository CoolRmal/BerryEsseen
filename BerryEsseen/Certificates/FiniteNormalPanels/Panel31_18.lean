...
namespace FiniteNormalPanel31_18
...
def j2 : Jet := ⟨⟨636213591, 636213595⟩, ⟨636213591, 636213595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨94242331, 94242334⟩, ⟨188484662, 188484668⟩, ⟨94242331, 94242334⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨23, 24⟩, ⟨47, 48⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94664), (-94662)⟩, ⟨47, 48⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2078), (-2077)⟩, ⟨(-4154), (-4152)⟩, ⟨(-2076), (-2073)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110978, 5110980⟩, ⟨(-4154), (-4152)⟩, ⟨(-2076), (-2073)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨112147, 112148⟩, ⟨224203, 224205⟩, ⟨111918, 111921⟩, ⟨(-184), (-180)⟩, ⟨(-46), (-43)⟩⟩
...
def j16 : Jet := ⟨⟨(-143053430), (-143053428)⟩, ⟨224203, 224205⟩, ⟨111918, 111921⟩, ⟨(-184), (-180)⟩, ⟨(-46), (-43)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3138951), (-3138950)⟩, ⟨(-6272982), (-6272980)⟩, ⟨(-3126657), (-3126654)⟩, ⟨9825, 9829⟩, ⟨2444, 2449⟩⟩
...
def j19 : Jet := ⟨⟨1428516814, 1428516816⟩, ⟨(-6272982), (-6272980)⟩, ⟨(-3126657), (-3126654)⟩, ⟨9825, 9829⟩, ⟨2444, 2449⟩⟩
...
def j25 : Jet := ⟨⟨259, 260⟩, ⟨518, 520⟩, ⟨257, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851918), (-851916)⟩, ⟨518, 520⟩, ⟨257, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-18694), (-18693)⟩, ⟨(-37376), (-37374)⟩, ⟨(-18667), (-18664)⟩, ⟨21, 24⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35772700, 35772702⟩, ⟨(-37376), (-37374)⟩, ⟨(-18667), (-18664)⟩, ⟨21, 24⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨784942, 784943⟩, ⟨1569064, 1569066⟩, ⟨782891, 782894⟩, ⟨(-1641), (-1638)⟩, ⟨(-410), (-406)⟩⟩
...
def j33 : Jet := ⟨⟨(-715042941), (-715042939)⟩, ⟨1569064, 1569066⟩, ⟨782891, 782894⟩, ⟨(-1641), (-1638)⟩, ⟨(-410), (-406)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-15689833), (-15689831)⟩, ⟨(-31345236), (-31345233)⟩, ⟨(-15603797), (-15603793)⟩, ⟨68749, 68753⟩, ⟨17096, 17100⟩⟩
...
def j36 : Jet := ⟨⟨4279277463, 4279277465⟩, ⟨(-31345236), (-31345233)⟩, ⟨(-15603797), (-15603793)⟩, ⟨68749, 68753⟩, ⟨17096, 17100⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨211606224, 211606226⟩, ⟨210677007, 210677010⟩, ⟨(-1392369), (-1392367)⟩, ⟨(-461697), (-461695)⟩, ⟨1817, 1819⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4310714653, 4310714656⟩, ⟨31575506, 31575511⟩, ⟨15949710, 15949717⟩, ⟨162706, 162714⟩, ⟨41615, 41624⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨212382071, 212382074⟩, ⟨213005122, 213005127⟩, ⟨937184, 937190⟩, ⟨316755, 316761⟩, ⟨3288, 3295⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-202513077), (-202513076)⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4092454219, 4092454220⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨10502092, 10502093⟩, ⟨21065802, 21065806⟩, ⟨10656485, 10656491⟩, ⟨124282, 124288⟩, ⟨31946, 31951⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4305469388, 4305469389⟩, ⟨21065802, 21065806⟩, ⟨10656485, 10656491⟩, ⟨124282, 124288⟩, ⟨31946, 31951⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4300215135, 4300215137⟩, ⟨10520046, 10520049⟩, ⟨5308871, 5308876⟩, ⟨49077, 49082⟩, ⟨12555, 12560⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4097454615, 4097454619⟩, ⟨(-192736508), (-192736502)⟩, ⟨4562517, 4562523⟩, ⟨(-203559), (-203551)⟩, ⟨9648, 9654⟩⟩
...
def j47 : Jet := ⟨⟨1041820418, 1041820425⟩, ⟨1041820418, 1041820425⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨252712001, 252712006⟩, ⟨505424002, 505424012⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨252712001, 252712006⟩, ⟨505424002, 505424012⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-252712006), (-252712001)⟩, ⟨(-505424012), (-505424002)⟩, ⟨(-252712006), (-252712001)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-126356003), (-126356000)⟩, ⟨(-252712006), (-252712001)⟩, ⟨(-126356003), (-126356000)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4170451867, 4170451871⟩, ⟨(-245385631), (-245385625)⟩, ⟨(-115473682), (-115473677)⟩, ⟨7077544, 7077546⟩, ⟨1594482, 1594483⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3978665277, 3978665286⟩, ⟨(-421249965), (-421249951)⟩, ⟨(-94721478), (-94721465)⟩, ⟨11475615, 11475629⟩, ⟨1101880, 1101893⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 405026154⟩, ⟨202513076, 202513077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1272427190⟩, ⟨636213591, 636213595⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 376969333⟩, ⟨0, 376969334⟩, ⟨94242331, 94242334⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 95⟩, ⟨0, 95⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94591)⟩, ⟨0, 95⟩, ⟨23, 24⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-8311), 0⟩, ⟨(-8311), 9⟩, ⟨(-2078), (-2063)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5104745, 5113057⟩, ⟨(-8311), 9⟩, ⟨(-2078), (-2063)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 448774⟩, ⟨(-730), 448775⟩, ⟨111097, 112195⟩, ⟨(-366), 2⟩, ⟨(-46), (-43)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142716802)⟩, ⟨(-730), 448775⟩, ⟨111097, 112195⟩, ⟨(-366), 2⟩, ⟨(-46), (-43)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-12565645), 0⟩, ⟨(-12565710), 39389⟩, ⟨(-3141477), (-3082326)⟩, ⟨(-50), 19697⟩, ⟨2399, 2463⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1419090120, 1431655766⟩, ⟨(-12565710), 39389⟩, ⟨(-3141477), (-3082326)⟩, ⟨(-50), 19697⟩, ⟨2399, 2463⟩⟩
...
def j72 : Jet := ⟨⟨0, 1039⟩, ⟨(-1), 1039⟩, ⟨257, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851137)⟩, ⟨(-1), 1039⟩, ⟨257, 260⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-74796), 0⟩, ⟨(-74797), 92⟩, ⟨(-18700), (-18561)⟩, ⟨(-2), 46⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35716598, 35791395⟩, ⟨(-74797), 92⟩, ⟨(-18700), (-18561)⟩, ⟨(-2), 46⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3141412⟩, ⟨(-6565), 3141421⟩, ⟨775504, 785362⟩, ⟨(-3285), 8⟩, ⟨(-412), (-401)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712686470)⟩, ⟨(-6565), 3141421⟩, ⟨775504, 785362⟩, ⟨(-3285), 8⟩, ⟨(-412), (-401)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-62828223), 0⟩, ⟨(-62828800), 275723⟩, ⟨(-15707633), (-15293469)⟩, ⟨(-434), 137864⟩, ⟨16690, 17234⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4232139073, 4294967296⟩, ⟨(-62828800), 275723⟩, ⟨(-15707633), (-15293469)⟩, ⟨(-434), 137864⟩, ⟨16690, 17234⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 424142397⟩, ⟨206487129, 212082869⟩, ⟨(-2792054), 5835⟩, ⟨(-465363), (-450749)⟩, ⟨(-8), 3648⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4358728236⟩, ⟨(-283972), 64708097⟩, ⟨15289314, 17138104⟩, ⟨(-144160), 495040⟩, ⟨32765, 54031⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 430439004⟩, ⟨206459085, 221621488⟩, ⟨(-2847527), 4893615⟩, ⟨206482, 444593⟩, ⟨(-25282), 33539⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-405026154), 0⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3889941142, 4294967296⟩, ⟨(-202513077), (-202513076)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 43138335⟩, ⟨0, 44421542⟩, ⟨9353732, 12416602⟩, ⟨(-293868), 594138⟩, ⟨11537, 58184⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4338105631⟩, ⟨0, 44421542⟩, ⟨9353732, 12416602⟩, ⟨(-293868), 594138⟩, ⟨11537, 58184⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4316482575⟩, ⟨0, 22210771⟩, ⟨4596410, 6208301⟩, ⟨(-179040), 297069⟩, ⟨(-256), 27559⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3889941142, 4316482575⟩, ⟨(-203527550), (-180302305)⟩, ⟨3115691, 6208301⟩, ⟨(-471770), 80343⟩, ⟨(-14264), 36001⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2083640849⟩, ⟨1041820418, 1041820425⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1010848021⟩, ⟨0, 1010848022⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1010848021⟩, ⟨0, 1010848022⟩, ⟨252712001, 252712006⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1010848021), 0⟩, ⟨(-1010848022), 0⟩, ⟨(-252712006), (-252712001)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-505424011), 0⟩, ⟨(-505424011), 0⟩, ⟨(-126356003), (-126356000)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3818148973, 4294967296⟩, ⟨(-505424011), 0⟩, ⟨(-126356003), (-82589526)⟩, ⟨0, 14869347⟩, ⟨777423, 1858669⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3458087978, 4316482575⟩, ⟨(-711483441), (-160285518)⟩, ⟨(-124219180), (-44642070)⟩, ⟨2264748, 21011866⟩, ⟨(-206876), 1899587⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4300215135, 4300215137⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified620
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4316482575⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified621
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (93064105 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(37721 / 400000), prawitzNormalCorrection
