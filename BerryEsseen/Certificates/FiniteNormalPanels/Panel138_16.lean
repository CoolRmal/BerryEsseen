...
namespace FiniteNormalPanel138_16
...
def j2 : Jet := ⟨⟨2629793045, 2629793049⟩, ⟨525958609, 525958613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1610212833, 1610212839⟩, ⟨644085132, 644085140⟩, ⟨64408513, 64408515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨403, 404⟩, ⟨161, 162⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94284), (-94282)⟩, ⟨161, 162⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-35348), (-35346)⟩, ⟨(-14080), (-14077)⟩, ⟨(-1385), (-1381)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5077708, 5077711⟩, ⟨(-14080), (-14077)⟩, ⟨(-1385), (-1381)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1903667, 1903669⟩, ⟨756188, 756191⟩, ⟨73514, 73519⟩, ⟨(-419), (-415)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-141261910), (-141261907)⟩, ⟨756188, 756191⟩, ⟨73514, 73519⟩, ⟨(-419), (-415)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-52960064), (-52960062)⟩, ⟨(-20900526), (-20900522)⟩, ⟨(-1977443), (-1977438)⟩, ⟨22206, 22212⟩, ⟨1031, 1035⟩⟩
...
def j19 : Jet := ⟨⟨1378695701, 1378695704⟩, ⟨(-20900526), (-20900522)⟩, ⟨(-1977443), (-1977438)⟩, ⟨22206, 22212⟩, ⟨1031, 1035⟩⟩
...
def j22 : Jet := ⟨⟨(-41), (-40)⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11794, 11796⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4421, 4423⟩, ⟨1761, 1764⟩, ⟨172, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847756), (-847753)⟩, ⟨1761, 1764⟩, ⟨172, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-317830), (-317828)⟩, ⟨(-126472), (-126469)⟩, ⟨(-12386), (-12382)⟩, ⟨50, 54⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35473564, 35473567⟩, ⟨(-126472), (-126469)⟩, ⟨(-12386), (-12382)⟩, ⟨50, 54⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13299283, 13299285⟩, ⟨5272297, 5272300⟩, ⟨508360, 508365⟩, ⟨(-3737), (-3731)⟩, ⟨(-179), (-174)⟩⟩
...
def j33 : Jet := ⟨⟨(-702528600), (-702528597)⟩, ⟨5272297, 5272300⟩, ⟨508360, 508365⟩, ⟨(-3737), (-3731)⟩, ⟨(-179), (-174)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-263382814), (-263382811)⟩, ⟨(-103376507), (-103376502)⟩, ⟨(-9554078), (-9554073)⟩, ⟨153897, 153903⟩, ⟨6994, 7000⟩⟩
...
def j36 : Jet := ⟨⟨4031584482, 4031584485⟩, ⟨(-103376507), (-103376502)⟩, ⟨(-9554078), (-9554073)⟩, ⟨153897, 153903⟩, ⟨6994, 7000⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨844170424, 844170428⟩, ⟨156036766, 156036773⟩, ⟨(-3770246), (-3770240)⟩, ⟨(-228561), (-228554)⟩, ⟨3350, 3355⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4575556866, 4575556871⟩, ⟨117324854, 117324861⟩, ⟨13851584, 13851593⟩, ⟨458543, 458556⟩, ⟨32156, 32171⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨899319951, 899319957⟩, ⟨189290676, 189290688⟩, ⟨2968383, 2968394⟩, ⟨246870, 246885⟩, ⟨8142, 8157⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-837089126), (-837089125)⟩, ⟨(-167417826), (-167417825)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3457878170, 3457878171⟩, ⟨(-167417826), (-167417825)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨188307923, 188307927⟩, ⟨79270862, 79270870⟩, ⟨9585639, 9585647⟩, ⟨365030, 365044⟩, ⟨27219, 27230⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4483275219, 4483275223⟩, ⟨79270862, 79270870⟩, ⟨9585639, 9585647⟩, ⟨365030, 365044⟩, ⟨27219, 27230⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4388111261, 4388111264⟩, ⟨38794112, 38794116⟩, ⟨4519600, 4519605⟩, ⟨138683, 138692⟩, ⟨9766, 9774⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3532868376, 3532868380⟩, ⟨(-139815439), (-139815433)⟩, ⟨2126534, 2126540⟩, ⟨(-64522), (-64513)⟩, ⟨2455, 2465⟩⟩
...
def j47 : Jet := ⟨⟨6049965726, 6049965736⟩, ⟨1209993145, 1209993153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8522087076, 8522087105⟩, ⟨3408834828, 3408834860⟩, ⟨340883482, 340883488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8522087076, 8522087105⟩, ⟨3408834828, 3408834860⟩, ⟨340883482, 340883488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8522087105), (-8522087076)⟩, ⟨(-3408834860), (-3408834828)⟩, ⟨(-340883488), (-340883482)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4261043553), (-4261043538)⟩, ⟨(-1704417430), (-1704417414)⟩, ⟨(-170441744), (-170441741)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1592559429, 1592559440⟩, ⟨(-631992256), (-631992245)⟩, ⟨62200865, 62200872⟩, ⟨8492068, 8492071⟩, ⟨(-2076692), (-2076690)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1309975712, 1309975724⟩, ⟨(-571694658), (-571694644)⟩, ⟨72525899, 72525911⟩, ⟨4623550, 4623561⟩, ⟨(-1943451), (-1943438)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨669671300, 1004506952⟩, ⟨167417825, 167417826⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2103834436, 3155751661⟩, ⟨525958609, 525958613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1030536213, 2318706491⟩, ⟨515268106, 772902168⟩, ⟨64408513, 64408515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨257, 581⟩, ⟨128, 194⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94430), (-94105)⟩, ⟨128, 194⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-50980), (-22579)⟩, ⟨(-16964), (-11184)⟩, ⟨(-1399), (-1366)⟩, ⟨2, 7⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5062076, 5090478⟩, ⟨(-16964), (-11184)⟩, ⟨(-1399), (-1366)⟩, ⟨2, 7⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1214596, 2748176⟩, ⟨598139, 913376⟩, ⟨72103, 74671⟩, ⟨(-507), (-326)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141950981), (-140417400)⟩, ⟨598139, 913376⟩, ⟨72103, 74671⟩, ⟨(-507), (-326)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-76634498), (-33691808)⟩, ⟨(-25401316), (-16352803)⟩, ⟨(-2039679), (-1901058)⟩, ⟨17345, 27058⟩, ⟨977, 1077⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1355021267, 1397963958⟩, ⟨(-25401316), (-16352803)⟩, ⟨(-2039679), (-1901058)⟩, ⟨17345, 27058⟩, ⟨977, 1077⟩⟩
...
def j70 : Jet := ⟨⟨(-59), (-25)⟩, ⟨(-20), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11776, 11811⟩, ⟨(-20), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2825, 6377⟩, ⟨1401, 2124⟩, ⟨170, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849352), (-845799)⟩, ⟨1401, 2124⟩, ⟨170, 177⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-458537), (-202941)⟩, ⟨(-152510), (-100323)⟩, ⟨(-12530), (-12204)⟩, ⟨39, 64⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35332857, 35588454⟩, ⟨(-152510), (-100323)⟩, ⟨(-12530), (-12204)⟩, ⟨39, 64⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8477780, 19212994⟩, ⟨4156555, 6380261⟩, ⟨495651, 518732⟩, ⟨(-4534), (-2933)⟩, ⟨(-184), (-169)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707350103), (-696614888)⟩, ⟨4156555, 6380261⟩, ⟨495651, 518732⟩, ⟨(-4534), (-2933)⟩, ⟨(-184), (-169)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-381874218), (-167146061)⟩, ⟨(-126294082), (-80128544)⟩, ⟨(-9990030), (-9018420)⟩, ⟨119347, 188327⟩, ⟨6516, 7389⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3913093078, 4127821235⟩, ⟨(-126294082), (-80128544)⟩, ⟨(-9990030), (-9018420)⟩, ⟨119347, 188327⟩, ⟨6516, 7389⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨663739722, 1027161974⟩, ⟨147271168, 163183454⟩, ⟨(-4609293), (-2933760)⟩, ⟨(-241282), (-212920)⟩, ⟨2602, 4106⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4468881529, 4714108177⟩, ⟨86749146, 152146642⟩, ⟨11447523, 16945498⟩, ⟨196668, 799042⟩, ⟨13446, 58965⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨690616244, 1127401521⟩, ⟨166640676, 215494937⟩, ⟨(-315459), 6780719⟩, ⟨(-5193), 554129⟩, ⟨(-15207), 36849⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1004506952), (-669671300)⟩, ⟨(-167417826), (-167417825)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3290460344, 3625295996⟩, ⟨(-167417826), (-167417825)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨111048760, 295935709⟩, ⟨53590516, 113132094⟩, ⟨6299888, 14371998⟩, ⟨(-34384), 971342⟩, ⟨(-9005), 85658⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4406016056, 4590903005⟩, ⟨53590516, 113132094⟩, ⟨6299888, 14371998⟩, ⟨(-34384), 971342⟩, ⟨(-9005), 85658⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4350137338, 4440470501⟩, ⟨25917243, 55848656⟩, ⟨2695518, 7017659⟩, ⟨(-107070), 463453⟩, ⟨(-16057), 42827⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3332727216, 3748112342⟩, ⟨(-153233823), (-122427619)⟩, ⟨(-111891), 4913212⟩, ⟨(-363925), 286121⟩, ⟨(-31620), 40324⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4839972581, 7259958889⟩, ⟨1209993145, 1209993153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5454135729, 12271805450⟩, ⟨2727067864, 4090601834⟩, ⟨340883482, 340883488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5454135729, 12271805450⟩, ⟨2727067864, 4090601834⟩, ⟨340883482, 340883488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12271805450), (-5454135729)⟩, ⟨(-4090601834), (-2727067864)⟩, ⟨(-340883488), (-340883482)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6135902725), (-2727067864)⟩, ⟨(-2045300917), (-1363533932)⟩, ⟨(-170441744), (-170441741)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1029237006, 2276180858⟩, ⟨(-1083937194), (-326754427)⟩, ⟨(-38460331), 217245874⟩, ⟨(-25840166), 34781736⟩, ⟨(-8451442), 3839460⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨798647799, 1986367062⟩, ⟨(-1027133846), (-282886998)⟩, ⟨(-24308583), 230861163⟩, ⟨(-31733709), 31905210⟩, ⟨(-8749258), 4634252⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4388111261, 4388111264⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2778
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4350137338, 4440470501⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2779
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (6505167 / 268435456)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((1949 / 12500) : ℝ)..(5847 / 25000), prawitzNormalCorrection
