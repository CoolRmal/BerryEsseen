...
namespace FiniteNormalPanel66_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (224777 / 800000)
def radius : Rat := (32111 / 800000)

def j0 : Jet := ⟨⟨1206762329, 1206762330⟩, ⟨172394618, 172394619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3791155667, 3791155671⟩, ⟨541593665, 541593669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3346442545, 3346442553⟩, ⟨956126438, 956126448⟩, ⟨68294745, 68294747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨837, 839⟩, ⟨239, 240⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93850), (-93847)⟩, ⟨239, 240⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-73124), (-73121)⟩, ⟨(-20707), (-20704)⟩, ⟨(-1427), (-1423)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5039932, 5039936⟩, ⟨(-20707), (-20704)⟩, ⟨(-1427), (-1423)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3926885, 3926889⟩, ⟨1105833, 1105838⟩, ⟨74418, 74424⟩, ⟨(-644), (-637)⟩, ⟨(-22), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-139238692), (-139238687)⟩, ⟨1105833, 1105838⟩, ⟨74418, 74424⟩, ⟨(-644), (-637)⟩, ⟨(-22), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-108488436), (-108488431)⟩, ⟨(-30135083), (-30135075)⟩, ⟨(-1909892), (-1909884)⟩, ⟨33647, 33657⟩, ⟨1021, 1029⟩⟩
...
def j19 : Jet := ⟨⟨1323167329, 1323167335⟩, ⟨(-30135083), (-30135075)⟩, ⟨(-1909892), (-1909884)⟩, ⟨33647, 33657⟩, ⟨1021, 1029⟩⟩
...
def j22 : Jet := ⟨⟨(-85), (-83)⟩, ⟨(-25), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11750, 11753⟩, ⟨(-25), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9155, 9158⟩, ⟨2595, 2600⟩, ⟨178, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843022), (-843018)⟩, ⟨2595, 2600⟩, ⟨178, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-656845), (-656841)⟩, ⟨(-185649), (-185642)⟩, ⟨(-12690), (-12683)⟩, ⟨78, 83⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35134549, 35134554⟩, ⟨(-185649), (-185642)⟩, ⟨(-12690), (-12683)⟩, ⟨78, 83⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨27375237, 27375242⟩, ⟨7676846, 7676855⟩, ⟨507461, 507471⟩, ⟨(-5718), (-5709)⟩, ⟨(-185), (-179)⟩⟩
...
def j33 : Jet := ⟨⟨(-688452646), (-688452640)⟩, ⟨7676846, 7676855⟩, ⟨507461, 507471⟩, ⟨(-5718), (-5709)⟩, ⟨(-185), (-179)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-536410891), (-536410884)⟩, ⟨(-147278808), (-147278796)⟩, ⟨(-8842787), (-8842773)⟩, ⟨230582, 230594⟩, ⟨6651, 6661⟩⟩
...
def j36 : Jet := ⟨⟨3758556405, 3758556412⟩, ⟨(-147278808), (-147278796)⟩, ⟨(-8842787), (-8842773)⟩, ⟨230582, 230594⟩, ⟨6651, 6661⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1167956115, 1167956122⟩, ⟨140250719, 140250730⟩, ⟨(-5485879), (-5485869)⟩, ⟨(-211137), (-211126)⟩, ⟨5143, 5154⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4907933273, 4907933283⟩, ⟨192317055, 192317073⟩, ⟨19082848, 19082870⟩, ⟨899113, 899135⟩, ⟨59629, 59649⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1334643614, 1334643626⟩, ⟨212564842, 212564862⟩, ⟨5200552, 5200573⟩, ⟨380732, 380754⟩, ⟨17621, 17645⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1206762330), (-1206762329)⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3088204966, 3088204967⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨414735073, 414735081⟩, ⟨132107318, 132107334⟩, ⟨13752276, 13752293⟩, ⟨751386, 751406⟩, ⟨54933, 54956⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4709702369, 4709702377⟩, ⟨132107318, 132107334⟩, ⟨13752276, 13752293⟩, ⟨751386, 751406⟩, ⟨54933, 54956⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4497556853, 4497556858⟩, ⟨63078314, 63078323⟩, ⟨6124069, 6124079⟩, ⟨272879, 272891⟩, ⟨18232, 18245⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3233872681, 3233872687⟩, ⟨(-135171190), (-135171181)⟩, ⟨1871495, 1871505⟩, ⟨(-49606), (-49595)⟩, ⟨2155, 2166⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨33923772026, 33923772033⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value347

def j47 : Jet := ⟨⟨9531604624, 9531604634⟩, ⟨1361657800, 1361657809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨21153010127, 21153010172⟩, ⟨6043717162, 6043717212⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨21153010127, 21153010172⟩, ⟨6043717162, 6043717212⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-21153010172), (-21153010127)⟩, ⟨(-6043717212), (-6043717162)⟩, ⟨(-431694088), (-431694082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10576505086), (-10576505063)⟩, ⟨(-3021858606), (-3021858581)⟩, ⟨(-215847044), (-215847041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨366011488, 366011500⟩, ⟨(-257518842), (-257518830)⟩, ⟨72198510, 72198517⟩, ⟨(-8304632), (-8304628)⟩, ⟨(-353453), (-353451)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨275586394, 275586405⟩, ⟨(-205416550), (-205416538)⟩, ⟨62625598, 62625608⟩, ⟨(-8641602), (-8641593)⟩, ⟨29847, 29856⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1034367711, 1379156949⟩, ⟨172394618, 172394619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3249562001, 4332749340⟩, ⟨541593665, 541593669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2458610850, 4370863746⟩, ⟨819536946, 1092715940⟩, ⟨68294745, 68294747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨615, 1096⟩, ⟨205, 274⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94072), (-93590)⟩, ⟨205, 274⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-95735), (-53574)⟩, ⟨(-23817), (-17579)⟩, ⟨(-1448), (-1399)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5017321, 5059483⟩, ⟨(-23817), (-17579)⟩, ⟨(-1448), (-1399)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2872114, 5148890⟩, ⟨933133, 1277161⟩, ⟨72246, 76298⟩, ⟨(-745), (-534)⟩, ⟨(-23), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140293463), (-138016686)⟩, ⟨933133, 1277161⟩, ⟨72246, 76298⟩, ⟨(-745), (-534)⟩, ⟨(-23), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-142772592), (-79006264)⟩, ⟨(-35158986), (-25035691)⟩, ⟨(-2011412), (-1792038)⟩, ⟨27863, 39416⟩, ⟨934, 1104⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1288883173, 1352649502⟩, ⟨(-35158986), (-25035691)⟩, ⟨(-2011412), (-1792038)⟩, ⟨27863, 39416⟩, ⟨934, 1104⟩⟩
...
def j70 : Jet := ⟨⟨(-110), (-61)⟩, ⟨(-28), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11725, 11775⟩, ⟨(-28), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6711, 11984⟩, ⟨2208, 2985⟩, ⟨175, 185⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845466), (-840192)⟩, ⟨2208, 2985⟩, ⟨175, 185⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-860407), (-480959)⟩, ⟨(-213839), (-157281)⟩, ⟨(-12923), (-12410)⟩, ⟨65, 96⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34930987, 35310436⟩, ⟨(-213839), (-157281)⟩, ⟨(-12923), (-12410)⟩, ⟨65, 96⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19995892, 35934408⟩, ⟨6447679, 8893569⟩, ⟨487884, 524362⟩, ⟨(-6652), (-4769)⟩, ⟨(-196), (-168)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-695831991), (-679893474)⟩, ⟨6447679, 8893569⟩, ⟨487884, 524362⟩, ⟨(-6652), (-4769)⟩, ⟨(-196), (-168)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-708128052), (-389198184)⟩, ⟨(-173341105), (-120681999)⟩, ⟨(-9554914), (-8014749)⟩, ⟨188849, 272097⟩, ⟨5864, 7333⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3586839244, 3905769112⟩, ⟨(-173341105), (-120681999)⟩, ⟨(-9554914), (-8014749)⟩, ⟨188849, 272097⟩, ⟨5864, 7333⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨975165931, 1364548513⟩, ⟨127059380, 151626621⟩, ⟨(-6462642), (-4512841)⟩, ⟨(-232558), (-186212)⟩, ⟨4219, 6085⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4722947912, 5142896802⟩, ⟨145931512, 248540667⟩, ⟨14200670, 25711288⟩, ⟨379950, 1655967⟩, ⟨13908, 133118⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1072338292, 1633943102⟩, ⟨172853998, 260524886⟩, ⟨(-197145), 11980481⟩, ⟨(-146082), 1075709⟩, ⟨(-33110), 86795⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1379156949), (-1034367711)⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2915810347, 3260599585⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨267734148, 621604282⟩, ⟨86314026, 198224020⟩, ⟨6806629, 24918483⟩, ⟨(-135068), 2271900⟩, ⟨(-43468), 229961⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4562701444, 4916571578⟩, ⟨86314026, 198224020⟩, ⟨6806629, 24918483⟩, ⟨(-135068), 2271900⟩, ⟨(-43468), 229961⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4426810757, 4595270845⟩, ⟨40336677, 96160163⟩, ⟨2174786, 11904397⟩, ⟨(-324113), 1082303⟩, ⟨(-60604), 118063⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3005317554, 3488580280⟩, ⟨(-157064263), (-104684978)⟩, ⟨(-2383309), 7418369⟩, ⟨(-723885), 734357⟩, ⟨(-89452), 102640⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8169946823, 10893262443⟩, ⟨1361657800, 1361657809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15540987041, 27628421470⟩, ⟨5180328998, 6907105386⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15540987041, 27628421470⟩, ⟨5180328998, 6907105386⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-27628421470), (-15540987041)⟩, ⟨(-6907105386), (-5180328998)⟩, ⟨(-431694088), (-431694082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13814210735), (-7770493520)⟩, ⟨(-3453552693), (-2590164499)⟩, ⟨(-215847044), (-215847041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨172229456, 703445368⟩, ⟨(-565635424), (-103866360)⟩, ⟨(-4032889), 218756184⟩, ⟨(-55153507), 20031916⟩, ⟨(-9523765), 11188475⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨120514120, 571372370⟩, ⟨(-485161021), (-76876308)⟩, ⟨(-1134431), 199584301⟩, ⟨(-53893665), 16852525⟩, ⟨(-8700972), 11594737⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1206762329, 1206762330⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4497556853, 4497556858⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar347 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1308
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar347 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1034367711, 1379156949⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4426810757, 4595270845⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1309
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((96333 / 400000) : ℝ)..(32111 / 100000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (32111 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((96333 / 400000) : ℝ)..(32111 / 100000), prawitzNormalCorrection
      ((59707 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
