...
namespace FiniteNormalPanel153_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (93247 / 400000)
def radius : Rat := (13321 / 400000)

def j0 : Jet := ⟨⟨1001232038, 1001232039⟩, ⟨143033148, 143033149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3145463214, 3145463219⟩, ⟨449351886, 449351891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2303612146, 2303612154⟩, ⟨658174896, 658174906⟩, ⟨47012492, 47012494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨576, 578⟩, ⟨164, 165⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94111), (-94108)⟩, ⟨164, 165⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-50477), (-50474)⟩, ⟨(-14335), (-14332)⟩, ⟨(-1001), (-997)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5062579, 5062583⟩, ⟨(-14335), (-14332)⟩, ⟨(-1001), (-997)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2715321, 2715324⟩, ⟨768117, 768121⟩, ⟨52680, 52685⟩, ⟨(-310), (-305)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-140450256), (-140450252)⟩, ⟨768117, 768121⟩, ⟨52680, 52685⟩, ⟨(-310), (-305)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-75330706), (-75330703)⟩, ⟨(-21111079), (-21111074)⟩, ⟨(-1391400), (-1391393)⟩, ⟨16312, 16319⟩, ⟨522, 527⟩⟩
...
def j19 : Jet := ⟨⟨1356325059, 1356325063⟩, ⟨(-21111079), (-21111074)⟩, ⟨(-1391400), (-1391393)⟩, ⟨16312, 16319⟩, ⟨522, 527⟩⟩
...
def j22 : Jet := ⟨⟨(-58), (-57)⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11777, 11779⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6316, 6318⟩, ⟨1794, 1798⟩, ⟨123, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845861), (-845858)⟩, ⟨1794, 1798⟩, ⟨123, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-453679), (-453677)⟩, ⟨(-128661), (-128657)⟩, ⟨(-8920), (-8913)⟩, ⟨35, 40⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35337715, 35337718⟩, ⟨(-128661), (-128657)⟩, ⟨(-8920), (-8913)⟩, ⟨35, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18953436, 18953439⟩, ⟨5346259, 5346264⟩, ⟨362302, 362310⟩, ⟨(-2758), (-2751)⟩, ⟨(-94), (-88)⟩⟩
...
def j33 : Jet := ⟨⟨(-696874447), (-696874443)⟩, ⟨5346259, 5346264⟩, ⟨362302, 362310⟩, ⟨(-2758), (-2751)⟩, ⟨(-94), (-88)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-373769656), (-373769651)⟩, ⟨(-103923857), (-103923851)⟩, ⟨(-6614354), (-6614345)⟩, ⟨112559, 112567⟩, ⟨3491, 3498⟩⟩
...
def j36 : Jet := ⟨⟨3921197640, 3921197645⟩, ⟨(-103923857), (-103923851)⟩, ⟨(-6614354), (-6614345)⟩, ⟨112559, 112567⟩, ⟨3491, 3498⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨993318524, 993318530⟩, ⟨126441730, 126441738⟩, ⟨(-3227710), (-3227701)⟩, ⟨(-133627), (-133619)⟩, ⟨2088, 2094⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4704364774, 4704364781⟩, ⟨124680198, 124680208⟩, ⟨11239815, 11239829⟩, ⟨373151, 373165⟩, ⟨21071, 21085⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1088001922, 1088001931⟩, ⟨167329601, 167329615⟩, ⟨2734634, 2734651⟩, ⟨177130, 177147⟩, ⟨5818, 5833⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1001232039), (-1001232038)⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3293735257, 3293735258⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨275612851, 275612856⟩, ⟨84775930, 84775940⟩, ⟨7904544, 7904558⟩, ⟨302818, 302832⟩, ⟨18487, 18502⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4570580147, 4570580152⟩, ⟨84775930, 84775940⟩, ⟨7904544, 7904558⟩, ⟨302818, 302832⟩, ⟨18487, 18502⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4430631135, 4430631138⟩, ⟨41090065, 41090071⟩, ⟨3640718, 3640726⟩, ⟨113008, 113017⟩, ⟨6415, 6425⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3397773481, 3397773485⟩, ⟨(-116039844), (-116039835)⟩, ⟨1423599, 1423609⟩, ⟨(-34583), (-34574)⟩, ⟨1155, 1165⟩⟩
...
def j47 : Jet := ⟨⟨12612184489, 12612184504⟩, ⟨1801740637, 1801740651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨37035717997, 37035718086⟩, ⟨10581633688, 10581633784⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨37035717997, 37035718086⟩, ⟨10581633688, 10581633784⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-37035718086), (-37035717997)⟩, ⟨(-10581633784), (-10581633688)⟩, ⟨(-755830988), (-755830975)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-18517859043), (-18517858998)⟩, ⟨(-5290816892), (-5290816844)⟩, ⟨(-377915494), (-377915487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨57608732, 57608736⟩, ⟨(-70966146), (-70966139)⟩, ⟨38641315, 38641322⟩, ⟨(-11704068), (-11704063)⟩, ⟨1904423, 1904426⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨45574601, 45574605⟩, ⟨(-57698181), (-57698174)⟩, ⟨32505797, 32505807⟩, ⟨(-10327141), (-10327132)⟩, ⟨1836209, 1836217⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨858198890, 1144265188⟩, ⟨143033148, 143033149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2696111328, 3594815109⟩, ⟨449351886, 449351891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1692449742, 3008799551⟩, ⟨564149910, 752199892⟩, ⟨47012492, 47012494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨423, 754⟩, ⟨141, 189⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94264), (-93932)⟩, ⟨141, 189⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-66036), (-37014)⟩, ⟨(-16454), (-12205)⟩, ⟨(-1010), (-985)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5047020, 5076043⟩, ⟨(-16454), (-12205)⟩, ⟨(-1010), (-985)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1988799, 3555975⟩, ⟨651406, 884185⟩, ⟨51654, 53572⟩, ⟨(-358), (-257)⟩, ⟨(-12), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141176778), (-139609601)⟩, ⟨651406, 884185⟩, ⟨51654, 53572⟩, ⟨(-358), (-257)⟩, ⟨(-12), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-98900084), (-55013744)⟩, ⟨(-24468333), (-17718506)⟩, ⟨(-1439397), (-1335777)⟩, ⟨13663, 18961⟩, ⟨493, 552⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1332755681, 1376642022⟩, ⟨(-24468333), (-17718506)⟩, ⟨(-1439397), (-1335777)⟩, ⟨13663, 18961⟩, ⟨493, 552⟩⟩
...
def j70 : Jet := ⟨⟨(-76), (-42)⟩, ⟨(-19), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11759, 11794⟩, ⟨(-19), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4633, 8263⟩, ⟨1530, 2061⟩, ⟨122, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847544), (-843913)⟩, ⟨1530, 2061⟩, ⟨122, 129⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-593740), (-332547)⟩, ⟨(-147833), (-109405)⟩, ⟨(-9030), (-8785)⟩, ⟨30, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35197654, 35458848⟩, ⟨(-147833), (-109405)⟩, ⟨(-9030), (-8785)⟩, ⟨30, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13869782, 24840368⟩, ⟨4519696, 6166981⟩, ⟨353054, 370300⟩, ⟨(-3190), (-2317)⟩, ⟨(-97), (-85)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701958101), (-690987514)⟩, ⟨4519696, 6166981⟩, ⟨353054, 370300⟩, ⟨(-3190), (-2317)⟩, ⟨(-97), (-85)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-491750245), (-272286506)⟩, ⟨(-121156557), (-86441946)⟩, ⟨(-6950808), (-6224046)⟩, ⟨93611, 131444⟩, ⟨3237, 3717⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3803217051, 4022680790⟩, ⟨(-121156557), (-86441946)⟩, ⟨(-6950808), (-6224046)⟩, ⟨93611, 131444⟩, ⟨3237, 3717⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨836620500, 1152226129⟩, ⟨118957167, 132905700⟩, ⟨(-3764699), (-2692278)⟩, ⟨(-142018), (-123881)⟩, ⟨1738, 2447⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4585684282, 4850300109⟩, ⟨98540126, 154512787⟩, ⟨9212639, 13786683⟩, ⟨191943, 608714⟩, ⟨8846, 38262⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨893249520, 1301207235⟩, ⟨146203836, 191541903⟩, ⟨272322, 5605415⟩, ⟨(-3269), 395890⟩, ⟨(-8301), 23250⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1144265188), (-858198890)⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3150702108, 3436768406⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨185774337, 394214939⟩, ⟨60813736, 116059422⟩, ⟨5090157, 11938605⟩, ⟨16558, 739848⟩, ⟨(-5305), 56716⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4480741633, 4689182235⟩, ⟨60813736, 116059422⟩, ⟨5090157, 11938605⟩, ⟨16558, 739848⟩, ⟨(-5305), 56716⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4386871182, 4487748249⟩, ⟨29100675, 56814003⟩, ⟨2076122, 5747727⟩, ⟨(-66334), 348403⟩, ⟨(-10875), 28133⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3218120960, 3591028833⟩, ⟨(-128105564), (-100632064)⟩, ⟨(-369048), 3630120⟩, ⟨(-244494), 209647⟩, ⟨(-20306), 24722⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨10810443851, 14413925155⟩, ⟨1801740637, 1801740651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨27209915280, 48373182857⟩, ⟨9069971734, 12093295760⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨27209915280, 48373182857⟩, ⟨9069971734, 12093295760⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-48373182857), (-27209915280)⟩, ⟨(-12093295760), (-9069971734)⟩, ⟨(-755830988), (-755830975)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-24186591429), (-13604957640)⟩, ⟨(-6046647880), (-4534985867)⟩, ⟨(-377915494), (-377915487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨15391563, 180828341⟩, ⟨(-254578261), (-16251700)⟩, ⟨(-7331190), 177849048⟩, ⟨(-82507965), 18374007⟩, ⟨(-14291435), 29362142⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨11532546, 151190858⟩, ⟨(-218246830), (-12537654)⟩, ⟨(-5764377), 156445984⟩, ⟨(-74515189), 15611905⟩, ⟨(-12525696), 27176543⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1001232038, 1001232039⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4430631135, 4430631138⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3084
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨858198890, 1144265188⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4386871182, 4487748249⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3085
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (4119199 / 4294967296)

theorem envelope_integral : (∫ s in ((39963 / 200000) : ℝ)..(13321 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((39963 / 200000) : ℝ)..(13321 / 50000), prawitzNormalCorrection
