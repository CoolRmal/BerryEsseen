...
namespace FiniteNormalPanel34_5

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (275051 / 800000)
def radius : Rat := (39293 / 800000)

def j0 : Jet := ⟨⟨1476668812, 1476668813⟩, ⟨210952687, 210952688⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4639091891, 4639091895⟩, ⟨662727411, 662727415⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5010788695, 5010788704⟩, ⟨1431653908, 1431653920⟩, ⟨102260993, 102260995⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1254, 1256⟩, ⟨358, 359⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93433), (-93430)⟩, ⟨358, 359⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-109006), (-109001)⟩, ⟨(-30728), (-30724)⟩, ⟨(-2077), (-2073)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5004050, 5004056⟩, ⟨(-30728), (-30724)⟩, ⟨(-2077), (-2073)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5838050, 5838058⟩, ⟨1632164, 1632173⟩, ⟨106476, 106486⟩, ⟨(-1407), (-1400)⟩, ⟨(-45), (-41)⟩⟩
...
def j16 : Jet := ⟨⟨(-137327527), (-137327518)⟩, ⟨1632164, 1632173⟩, ⟨106476, 106486⟩, ⟨(-1407), (-1400)⟩, ⟨(-45), (-41)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-160215242), (-160215230)⟩, ⟨(-43871596), (-43871579)⟩, ⟨(-2601425), (-2601407)⟩, ⟨72709, 72725⟩, ⟨2013, 2023⟩⟩
...
def j19 : Jet := ⟨⟨1271440523, 1271440536⟩, ⟨(-43871596), (-43871579)⟩, ⟨(-2601425), (-2601407)⟩, ⟨72709, 72725⟩, ⟨2013, 2023⟩⟩
...
def j22 : Jet := ⟨⟨(-126), (-124)⟩, ⟨(-36), (-35)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11709, 11712⟩, ⟨(-36), (-35)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨13660, 13664⟩, ⟨3860, 3864⟩, ⟨262, 266⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-838517), (-838512)⟩, ⟨3860, 3864⟩, ⟨262, 266⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-978269), (-978262)⟩, ⟨(-275003), (-274995)⟩, ⟨(-18374), (-18365)⟩, ⟨175, 181⟩, ⟨3, 7⟩⟩
...
def j30 : Jet := ⟨⟨34813125, 34813133⟩, ⟨(-275003), (-274995)⟩, ⟨(-18374), (-18365)⟩, ⟨175, 181⟩, ⟨3, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨40615259, 40615270⟩, ⟨11283522, 11283536⟩, ⟨715777, 715795⟩, ⟨(-12469), (-12456)⟩, ⟨(-377), (-367)⟩⟩
...
def j33 : Jet := ⟨⟨(-675212624), (-675212612)⟩, ⟨11283522, 11283536⟩, ⟨715777, 715795⟩, ⟨(-12469), (-12456)⟩, ⟨(-377), (-367)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-787747044), (-787747028)⟩, ⟨(-211906494), (-211906469)⟩, ⟨(-11480230), (-11480201)⟩, ⟨492698, 492724⟩, ⟨12445, 12464⟩⟩
...
def j36 : Jet := ⟨⟨3507220252, 3507220268⟩, ⟨(-211906494), (-211906469)⟩, ⟨(-11480230), (-11480201)⟩, ⟨492698, 492724⟩, ⟨12445, 12464⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1373311835, 1373311851⟩, ⟨148800694, 148800718⟩, ⟨(-9579389), (-9579365)⟩, ⟨(-322875), (-322853)⟩, ⟨13393, 13408⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5259648001, 5259648026⟩, ⟨317788261, 317788304⟩, ⟨36417216, 36417268⟩, ⟨2501626, 2501677⟩, ⟨207013, 207052⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1681767601, 1681767630⟩, ⟨283834908, 283834955⟩, ⟨10923270, 10923323⟩, ⟨957395, 957446⟩, ⟨64147, 64186⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1476668813), (-1476668812)⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2818298483, 2818298484⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨658524749, 658524773⟩, ⟨222280784, 222280828⟩, ⟨27311745, 27311796⟩, ⟨2193506, 2193556⟩, ⟨204552, 204598⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4953492045, 4953492069⟩, ⟨222280784, 222280828⟩, ⟨27311745, 27311796⟩, ⟨2193506, 2193556⟩, ⟨204552, 204598⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4612492421, 4612492433⟩, ⟨103489459, 103489481⟩, ⟨11554813, 11554838⟩, ⟨761998, 762023⟩, ⟨63663, 63688⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3026654103, 3026654113⟩, ⟨(-158639974), (-158639955)⟩, ⟨2499093, 2499112⟩, ⟨(-67519), (-67499)⟩, ⟨4346, 4366⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨20419820712, 20419820714⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value240

def j47 : Jet := ⟨⟨7020615132, 7020615138⟩, ⟨1002945016, 1002945022⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11475998170, 11475998191⟩, ⟨3278856610, 3278856634⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11475998170, 11475998191⟩, ⟨3278856610, 3278856634⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11475998191), (-11475998170)⟩, ⟨(-3278856634), (-3278856610)⟩, ⟨(-234204046), (-234204042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5737999096), (-5737999085)⟩, ⟨(-1639428317), (-1639428305)⟩, ⟨(-117102023), (-117102021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1129146362, 1129146371⟩, ⟨(-431005502), (-431005495)⟩, ⟨51473262, 51473266⟩, ⟨1284953, 1284955⟩, ⟨(-824328), (-824327)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨795706983, 795706993⟩, ⟨(-345435070), (-345435057)⟩, ⟨52849829, 52849842⟩, ⟨(-1264268), (-1264255)⟩, ⟨(-590500), (-590487)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1265716124, 1687621500⟩, ⟨210952687, 210952688⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3976364476, 5301819307⟩, ⟨662727411, 662727415⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3681395772, 6544703610⟩, ⟨1227131920, 1636175908⟩, ⟨102260993, 102260995⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨921, 1640⟩, ⟨307, 410⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93766), (-93046)⟩, ⟨307, 410⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-142882), (-79753)⟩, ⟨(-35458), (-25959)⟩, ⟨(-2125), (-2018)⟩, ⟨14, 20⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4970174, 5033304⟩, ⟨(-35458), (-25959)⟩, ⟨(-2125), (-2018)⟩, ⟨14, 20⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4260143, 7669787⟩, ⟨1366015, 1895197⟩, ⟨101590, 110696⟩, ⟨(-1644), (-1163)⟩, ⟨(-48), (-38)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138905434), (-135495789)⟩, ⟨1366015, 1895197⟩, ⟨101590, 110696⟩, ⟨(-1644), (-1163)⟩, ⟨(-48), (-38)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-211665150), (-116139097)⟩, ⟨(-51745420), (-35825116)⟩, ⟨(-2829902), (-2335427)⟩, ⟨59043, 86298⟩, ⟨1717, 2272⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1219990615, 1315516669⟩, ⟨(-51745420), (-35825116)⟩, ⟨(-2829902), (-2335427)⟩, ⟨59043, 86298⟩, ⟨1717, 2272⟩⟩
...
def j70 : Jet := ⟨⟨(-165), (-91)⟩, ⟨(-42), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11670, 11745⟩, ⟨(-42), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨10002, 17898⟩, ⟨3270, 4450⟩, ⟨256, 271⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842175), (-834278)⟩, ⟨3270, 4450⟩, ⟨256, 271⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1283313), (-715094)⟩, ⟨(-318027), (-231583)⟩, ⟨(-18899), (-17754)⟩, ⟨145, 210⟩, ⟨2, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34508081, 35076301⟩, ⟨(-318027), (-231583)⟩, ⟨(-18899), (-17754)⟩, ⟨145, 210⟩, ⟨2, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨29578316, 53449533⟩, ⟨9374826, 13163885⟩, ⟨671667, 753766⟩, ⟨(-14649), (-10265)⟩, ⟨(-408), (-331)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-686249567), (-662378349)⟩, ⟨9374826, 13163885⟩, ⟨671667, 753766⟩, ⟨(-14649), (-10265)⟩, ⟨(-408), (-331)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1045712275), (-567752135)⟩, ⟨(-253392516), (-169191483)⟩, ⟨(-13085024), (-9607490)⟩, ⟨392790, 591777⟩, ⟨9789, 14732⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3249255021, 3727215161⟩, ⟨(-253392516), (-169191483)⟩, ⟨(-13085024), (-9607490)⟩, ⟨392790, 591777⟩, ⟨9789, 14732⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1129491101, 1623907982⟩, ⟨124372624, 169820909⟩, ⟨(-11477792), (-7690114)⟩, ⟨(-382001), (-253834)⟩, ⟨10699, 16122⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4949202897, 5677222611⟩, ⟨224661829, 442737093⟩, ⟨22955551, 57389421⟩, ⟨719750, 5660154⟩, ⟨(-1025), 630452⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1301542070, 2146532553⟩, ⟨202399419, 391871530⟩, ⟨(-2629150), 30342775⟩, ⟨(-834084), 3714475⟩, ⟨(-159963), 429105⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1687621500), (-1265716124)⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2607345796, 3029251172⟩, ⟨(-210952688), (-210952687)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨394417848, 1072790940⟩, ⟨122669784, 391697976⟩, ⟨6910043, 66083580⟩, ⟨(-1313482), 9249762⟩, ⟨(-330673), 1321096⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4689385144, 5367758236⟩, ⟨122669784, 391697976⟩, ⟨6910043, 66083580⟩, ⟨(-1313482), 9249762⟩, ⟨(-330673), 1321096⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4487845344, 4801494151⟩, ⟨54864454, 187431816⟩, ⟨(-607450), 31286363⟩, ⟨(-1935170), 4451485⟩, ⟨(-453200), 715098⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2724436272, 3386505830⟩, ⟨(-202524824), (-88230004)⟩, ⟨(-9634385), 19371615⟩, ⟨(-2901550), 3169480⟩, ⟨(-538285), 599410⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6017670110, 8023560155⟩, ⟨1002945016, 1002945022⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8431345585, 14989058851⟩, ⟨2810448522, 3747264724⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8431345585, 14989058851⟩, ⟨2810448522, 3747264724⟩, ⟨234204042, 234204046⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14989058851), (-8431345585)⟩, ⟨(-3747264724), (-2810448522)⟩, ⟨(-234204046), (-234204042)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7494529426), (-4215672792)⟩, ⟨(-1873632362), (-1405224261)⟩, ⟨(-117102023), (-117102021)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨750127436, 1609471934⟩, ⟨(-702114474), (-245426146)⟩, ⟨(-3732982), 132692690⟩, ⟨(-14834225), 13304897⟩, ⟨(-3259959), 1668707⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨475830024, 1269040185⟩, ⟨(-629497874), (-171091323)⟩, ⟨(-1512024), 144992549⟩, ⟨(-22207577), 13429386⟩, ⟨(-4215295), 3312672⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1476668812, 1476668813⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨210952687, 210952688⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4612492421, 4612492433⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar240 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified668
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar240 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1265716124, 1687621500⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4487845344, 4801494151⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified669
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((117879 / 400000) : ℝ)..(39293 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (117879 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (39293 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((117879 / 400000) : ℝ)..(39293 / 100000), prawitzNormalCorrection
      ((118859 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
