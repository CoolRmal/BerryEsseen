...
namespace FiniteNormalPanel48_28

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (331587 / 1600000)
def radius : Rat := (36843 / 1600000)

def j0 : Jet := ⟨⟨890097075, 890097076⟩, ⟨98899675, 98899676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2796322431, 2796322436⟩, ⟨310702492, 310702496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1820600390, 1820600398⟩, ⟨404577864, 404577872⟩, ⟨22476547, 22476549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨455, 457⟩, ⟨101, 102⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94232), (-94229)⟩, ⟨101, 102⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-39945), (-39942)⟩, ⟨(-8835), (-8832)⟩, ⟨(-483), (-480)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5073111, 5073115⟩, ⟨(-8835), (-8832)⟩, ⟨(-483), (-480)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2150448, 2150451⟩, ⟨474131, 474135⟩, ⟨25510, 25515⟩, ⟨(-93), (-90)⟩, ⟨(-3), 0⟩⟩
...
def j16 : Jet := ⟨⟨(-141015129), (-141015125)⟩, ⟨474131, 474135⟩, ⟨25510, 25515⟩, ⟨(-93), (-90)⟩, ⟨(-3), 0⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-59775124), (-59775121)⟩, ⟨(-13082381), (-13082378)⟩, ⟨(-682490), (-682485)⟩, ⟨4843, 4848⟩, ⟨122, 126⟩⟩
...
def j19 : Jet := ⟨⟨1371880641, 1371880645⟩, ⟨(-13082381), (-13082378)⟩, ⟨(-682490), (-682485)⟩, ⟨4843, 4848⟩, ⟨122, 126⟩⟩
...
def j22 : Jet := ⟨⟨(-46), (-45)⟩, ⟨(-11), (-10)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11789, 11791⟩, ⟨(-11), (-10)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4997, 4999⟩, ⟨1105, 1107⟩, ⟨58, 62⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847180), (-847177)⟩, ⟨1105, 1107⟩, ⟨58, 62⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-359113), (-359111)⟩, ⟨(-79335), (-79332)⟩, ⟨(-4306), (-4301)⟩, ⟨9, 12⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35432281, 35432284⟩, ⟨(-79335), (-79332)⟩, ⟨(-4306), (-4301)⟩, ⟨9, 12⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨15019444, 15019447⟩, ⟨3304024, 3304027⟩, ⟨176125, 176131⟩, ⟨(-819), (-814)⟩, ⟨(-24), (-19)⟩⟩
...
def j33 : Jet := ⟨⟨(-700808439), (-700808435)⟩, ⟨3304024, 3304027⟩, ⟨176125, 176131⟩, ⟨(-819), (-814)⟩, ⟨(-24), (-19)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-297066785), (-297066781)⟩, ⟨(-64614295), (-64614290)⟩, ⟨(-3281603), (-3281595)⟩, ⟨33532, 33538⟩, ⟨832, 838⟩⟩
...
def j36 : Jet := ⟨⟨3997900511, 3997900515⟩, ⟨(-64614295), (-64614290)⟩, ⟨(-3281603), (-3281595)⟩, ⟨33532, 33538⟩, ⟨832, 838⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨893189713, 893189718⟩, ⟨90725761, 90725766⟩, ⟨(-1390743), (-1390738)⟩, ⟨(-46220), (-46214)⟩, ⟨429, 434⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4614107830, 4614107836⟩, ⟨74573465, 74573474⟩, ⟨4992656, 4992668⟩, ⟨103194, 103206⟩, ⟨4170, 4183⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨959558796, 959558803⟩, ⟨112975643, 112975653⟩, ⟨1119468, 1119479⟩, ⟨53120, 53133⟩, ⟨1086, 1100⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-890097076), (-890097075)⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3404870220, 3404870221⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨214379532, 214379537⟩, ⟨50480836, 50480842⟩, ⟨3471942, 3471952⟩, ⟨82626, 82636⟩, ⟨3569, 3580⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4509346828, 4509346833⟩, ⟨50480836, 50480842⟩, ⟨3471942, 3471952⟩, ⟨82626, 82636⟩, ⟨3569, 3580⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4400851866, 4400851870⟩, ⟨24633133, 24633137⟩, ⟨1625263, 1625269⟩, ⟨31221, 31228⟩, ⟨1265, 1273⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3488811073, 3488811078⟩, ⟨(-81809751), (-81809745)⟩, ⟨721215, 721222⟩, ⟨(-12675), (-12667)⟩, ⟨282, 292⟩⟩
...
def j47 : Jet := ⟨⟨4772244137, 4772244144⟩, ⟨530249348, 530249355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5302558211, 5302558227⟩, ⟨1178346266, 1178346286⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5302558211, 5302558227⟩, ⟨1178346266, 1178346286⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5302558227), (-5302558211)⟩, ⟨(-1178346286), (-1178346266)⟩, ⟨(-65463684), (-65463681)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2651279114), (-2651279105)⟩, ⟨(-589173143), (-589173133)⟩, ⟨(-32731842), (-32731840)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2316702679, 2316702693⟩, ⟨(-317799628), (-317799620)⟩, ⟨4141952, 4141956⟩, ⟨1425234, 1425235⟩, ⟨(-64661), (-64660)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1881862515, 1881862530⟩, ⟨(-302277444), (-302277432)⟩, ⟨9806926, 9806937⟩, ⟨1018621, 1018630⟩, ⟨(-77889), (-77878)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨791197400, 988996751⟩, ⟨98899675, 98899676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2485619939, 3107024928⟩, ⟨310702492, 310702496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1438499074, 2247654811⟩, ⟨359624768, 449530968⟩, ⟨22476547, 22476549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨360, 564⟩, ⟨90, 113⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94327), (-94122)⟩, ⟨90, 113⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-49364), (-31523)⟩, ⟨(-9843), (-7820)⟩, ⟨(-486), (-476)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5063692, 5081534⟩, ⟨(-9843), (-7820)⟩, ⟨(-486), (-476)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1695965, 2659284⟩, ⟨418839, 529238⟩, ⟨25213, 25780⟩, ⟨(-103), (-77)⟩, ⟨(-3), 0⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141469612), (-140506292)⟩, ⟨418839, 529238⟩, ⟨25213, 25780⟩, ⟨(-103), (-77)⟩, ⟨(-3), 0⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-74034290), (-47059303)⟩, ⟨(-14666579), (-11487862)⟩, ⟨(-696829), (-666416)⟩, ⟨4248, 5444⟩, ⟨118, 129⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1357621475, 1384596463⟩, ⟨(-14666579), (-11487862)⟩, ⟨(-696829), (-666416)⟩, ⟨4248, 5444⟩, ⟨118, 129⟩⟩
...
def j70 : Jet := ⟨⟨(-57), (-35)⟩, ⟨(-12), (-8)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11778, 11801⟩, ⟨(-12), (-8)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3944, 6176⟩, ⟨979, 1234⟩, ⟨58, 62⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848233), (-846000)⟩, ⟨979, 1234⟩, ⟨58, 62⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-443900), (-283347)⟩, ⟨(-88453), (-70190)⟩, ⟨(-4339), (-4264)⟩, ⟨7, 14⟩, ⟨(-2), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35347494, 35508048⟩, ⟨(-88453), (-70190)⟩, ⟨(-4339), (-4264)⟩, ⟨7, 14⟩, ⟨(-2), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11838818, 18582176⟩, ⟨2913414, 3692928⟩, ⟨173452, 178517⟩, ⟨(-916), (-716)⟩, ⟨(-25), (-19)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703989065), (-697245706)⟩, ⟨2913414, 3692928⟩, ⟨173452, 178517⟩, ⟨(-916), (-716)⟩, ⟨(-25), (-19)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-368413611), (-233526179)⟩, ⟨(-72706944), (-56448950)⟩, ⟨(-3382099), (-3168904)⟩, ⟨29289, 37772⟩, ⟨797, 870⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3926553685, 4061441117⟩, ⟨(-72706944), (-56448950)⟩, ⟨(-3382099), (-3168904)⟩, ⟨29289, 37772⟩, ⟨797, 870⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨785694226, 1001631778⟩, ⟨87601819, 93514826⟩, ⟨(-1565090), (-1216717)⟩, ⟨(-47952), (-44270)⟩, ⟨375, 488⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4541920845, 4697947757⟩, ⟨63127016, 86990643⟩, ⟨4421179, 5657316⟩, ⟨67009, 145806⟩, ⟨2563, 6183⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨830870350, 1095611082⟩, ⟨104186837, 122576105⟩, ⟨384408, 1926728⟩, ⟨18282, 92484⟩, ⟨(-804), 3249⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-988996751), (-791197400)⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3305970545, 3503769896⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨160733596, 279481440⟩, ⟨40310320, 62536328⟩, ⟨2676080, 4481244⟩, ⟨25720, 157160⟩, ⟨508, 7803⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4455700892, 4574448736⟩, ⟨40310320, 62536328⟩, ⟨2676080, 4481244⟩, ⟨25720, 157160⟩, ⟨508, 7803⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4374595936, 4432505806⟩, ⟨19529755, 30699005⟩, ⟨1190212, 2156244⟩, ⟨(-2507), 71837⟩, ⟨(-787), 3687⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3367263197, 3615971750⟩, ⟨(-87034097), (-75689485)⟩, ⟨209240, 1309323⟩, ⟨(-51698), 31198⟩, ⟨(-2298), 3066⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4241994788, 5302493493⟩, ⟨530249348, 530249355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4189675622, 6546368181⟩, ⟨1047418904, 1309273652⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4189675622, 6546368181⟩, ⟨1047418904, 1309273652⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6546368181), (-4189675622)⟩, ⟨(-1309273652), (-1047418904)⟩, ⟨(-65463684), (-65463681)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3273184091), (-2094837811)⟩, ⟨(-654636826), (-523709452)⟩, ⟨(-32731842), (-32731840)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2004403240, 2637157168⟩, ⟨(-401954213), (-244408129)⟩, ⟨(-5196685), 15357326⟩, ⟨461499, 2306215⟩, ⟨(-146398), 5734⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1571456264, 2220246434⟩, ⟨(-391848776), (-226939736)⟩, ⟨29675, 21878694⟩, ⟨(-103668), 2054181⟩, ⟨(-175904), 8100⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨890097075, 890097076⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4400851866, 4400851870⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified956
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨791197400, 988996751⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4374595936, 4432505806⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified957
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (43408725 / 2147483648)

theorem envelope_integral : (∫ s in ((36843 / 200000) : ℝ)..(36843 / 160000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (36843 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (36843 / 160000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((36843 / 200000) : ℝ)..(36843 / 160000), prawitzNormalCorrection
