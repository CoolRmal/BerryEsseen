...
namespace FiniteNormalPanel55_15
...
def j2 : Jet := ⟨⟨556402275, 556402279⟩, ⟨556402275, 556402279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨72080523, 72080525⟩, ⟨144161046, 144161050⟩, ⟨72080523, 72080525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1589), (-1588)⟩, ⟨(-3178), (-3176)⟩, ⟨(-1588), (-1585)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111467, 5111469⟩, ⟨(-3178), (-3176)⟩, ⟨(-1588), (-1585)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨85783, 85784⟩, ⟨171512, 171515⟩, ⟨85649, 85652⟩, ⟨(-108), (-105)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-143079794), (-143079792)⟩, ⟨171512, 171515⟩, ⟨85649, 85652⟩, ⟨(-108), (-105)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2401245), (-2401244)⟩, ⟨(-4799612), (-4799609)⟩, ⟨(-2394052), (-2394049)⟩, ⟨5750, 5753⟩, ⟨1432, 1435⟩⟩
...
def j19 : Jet := ⟨⟨1429254520, 1429254522⟩, ⟨(-4799612), (-4799609)⟩, ⟨(-2394052), (-2394049)⟩, ⟨5750, 5753⟩, ⟨1432, 1435⟩⟩
...
def j25 : Jet := ⟨⟨198, 199⟩, ⟨396, 398⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851979), (-851977)⟩, ⟨396, 398⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14299), (-14298)⟩, ⟨(-28591), (-28589)⟩, ⟨(-14283), (-14280)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35777095, 35777097⟩, ⟨(-28591), (-28589)⟩, ⟨(-14283), (-14280)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨600431, 600432⟩, ⟨1200382, 1200384⟩, ⟨599231, 599234⟩, ⟨(-960), (-957)⟩, ⟨(-240), (-237)⟩⟩
...
def j33 : Jet := ⟨⟨(-715227452), (-715227450)⟩, ⟨1200382, 1200384⟩, ⟨599231, 599234⟩, ⟨(-960), (-957)⟩, ⟨(-240), (-237)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-12003345), (-12003343)⟩, ⟨(-23986544), (-23986541)⟩, ⟨(-11952999), (-11952994)⟩, ⟨40241, 40244⟩, ⟨10018, 10022⟩⟩
...
def j36 : Jet := ⟨⟨4282963951, 4282963953⟩, ⟨(-23986544), (-23986541)⟩, ⟨(-11952999), (-11952994)⟩, ⟨40241, 40244⟩, ⟨10018, 10022⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨185156349, 185156352⟩, ⟨184534571, 184534575⟩, ⟨(-931922), (-931920)⟩, ⟨(-309400), (-309397)⟩, ⟨929, 932⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4307004279, 4307004282⟩, ⟨24121177, 24121182⟩, ⟨12155174, 12155183⟩, ⟨94921, 94928⟩, ⟨24147, 24157⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨185675264, 185675268⟩, ⟨186091608, 186091614⟩, ⟨625849, 625854⟩, ⟨210840, 210848⟩, ⟨1673, 1682⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-177108346), (-177108345)⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4117858950, 4117858951⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8026907, 8026908⟩, ⟨16089812, 16089814⟩, ⟨8117057, 8117060⟩, ⟨72460, 72466⟩, ⟨18505, 18510⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302994203, 4302994204⟩, ⟨16089812, 16089814⟩, ⟨8117057, 8117060⟩, ⟨72460, 72466⟩, ⟨18505, 18510⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298978876, 4298978877⟩, ⟨8037398, 8037400⟩, ⟨4047227, 4047230⟩, ⟨28629, 28634⟩, ⟨7284, 7289⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4121705107, 4121705110⟩, ⟨(-169567804), (-169567799)⟩, ⟨3548901, 3548906⟩, ⟨(-139445), (-139438)⟩, ⟨5802, 5809⟩⟩
...
def j47 : Jet := ⟨⟨1238496837, 1238496845⟩, ⟨1238496837, 1238496845⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨357132967, 357132973⟩, ⟨714265934, 714265946⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨357132967, 357132973⟩, ⟨714265934, 714265946⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-357132973), (-357132967)⟩, ⟨(-714265946), (-714265934)⟩, ⟨(-357132973), (-357132967)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-178566487), (-178566483)⟩, ⟨(-357132973), (-357132967)⟩, ⟨(-178566487), (-178566483)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4120061913, 4120061918⟩, ⟨(-342589329), (-342589322)⟩, ⟨(-157051258), (-157051252)⟩, ⟨13848620, 13848622⟩, ⟨2976878, 2976879⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3953855537, 3953855546⟩, ⟨(-491431459), (-491431445)⟩, ⟨(-133785692), (-133785678)⟩, ⟨19073583, 19073596⟩, ⟨2196952, 2196965⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 354216691⟩, ⟨177108345, 177108346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1112804555⟩, ⟨556402275, 556402279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 288322098⟩, ⟨0, 288322098⟩, ⟨72080523, 72080525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6357), 0⟩, ⟨(-6357), 5⟩, ⟨(-1590), (-1580)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106699, 5113057⟩, ⟨(-6357), 5⟩, ⟨(-1590), (-1580)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 343241⟩, ⟨(-427), 343242⟩, ⟨85169, 85812⟩, ⟨(-214), 2⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142822335)⟩, ⟨(-427), 343242⟩, ⟨85169, 85812⟩, ⟨(-214), 2⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9610737), 0⟩, ⟨(-9610766), 23042⟩, ⟨(-2402714), (-2368120)⟩, ⟨(-23), 11523⟩, ⟨1412, 1442⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422045028, 1431655766⟩, ⟨(-9610766), 23042⟩, ⟨(-2402714), (-2368120)⟩, ⟨(-23), 11523⟩, ⟨1412, 1442⟩⟩
...
def j72 : Jet := ⟨⟨0, 795⟩, ⟨(-1), 795⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851381)⟩, ⟨(-1), 795⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-57207), 0⟩, ⟨(-57208), 54⟩, ⟨(-14303), (-14220)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35734187, 35791395⟩, ⟨(-57208), 54⟩, ⟨(-14303), (-14220)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2402685⟩, ⟨(-3841), 2402689⟩, ⟨594908, 600676⟩, ⟨(-1923), 3⟩, ⟨(-242), (-235)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713425197)⟩, ⟨(-3841), 2402689⟩, ⟨594908, 600676⟩, ⟨(-1923), 3⟩, ⟨(-242), (-235)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-48053684), 0⟩, ⟨(-48053942), 161294⟩, ⟨(-12013679), (-11771479)⟩, ⟨(-195), 80649⟩, ⟨9837, 10082⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4246913612, 4294967296⟩, ⟨(-48053942), 161294⟩, ⟨(-12013679), (-11771479)⟩, ⟨(-195), 80649⟩, ⟨9837, 10082⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 370934852⟩, ⟨181732276, 185473398⟩, ⟨(-1867583), 2986⟩, ⟨(-311272), (-303798)⟩, ⟨(-3), 1867⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4343564706⟩, ⟨(-164966), 49147553⟩, ⟨11769633, 12843193⟩, ⟨(-83441), 284552⟩, ⟨20203, 29608⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 375131968⟩, ⟨181718028, 191816653⟩, ⟨(-1895839), 3234606⟩, ⟨154633, 275470⟩, ⟨(-12755), 16757⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-354216691), 0⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3940750605, 4294967296⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 32764858⟩, ⟨0, 33507384⟩, ⟨7357229, 9131721⟩, ⟨(-169340), 337044⟩, ⟨9426, 29971⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4327732154⟩, ⟨0, 33507384⟩, ⟨7357229, 9131721⟩, ⟨(-169340), 337044⟩, ⟨9426, 29971⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311318600⟩, ⟨0, 16753692⟩, ⟨3632110, 4565861⟩, ⟨(-102481), 168522⟩, ⟨1621, 13850⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3940750605, 4311318600⟩, ⟨(-177782613), (-160354653)⟩, ⟨2641700, 4565861⟩, ⟨(-290760), 18748⟩, ⟨(-5463), 18076⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2476993682⟩, ⟨1238496837, 1238496845⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1428531879⟩, ⟨0, 1428531884⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1428531879⟩, ⟨0, 1428531884⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1428531879), 0⟩, ⟨(-1428531884), 0⟩, ⟨(-357132973), (-357132967)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-714265940), 0⟩, ⟨(-714265942), 0⟩, ⟨(-178566487), (-178566483)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3636933720, 4294967296⟩, ⟨(-714265942), 0⟩, ⟨(-178566487), (-91815959)⟩, ⟨0, 29696143⟩, ⟨674019, 3712018⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3336986703, 4311318600⟩, ⟨(-894767826), (-135786655)⟩, ⟨(-177009341), (-50112024)⟩, ⟨2377915, 37219393⟩, ⟨(-809201), 3736108⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298978876, 4298978877⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1094
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311318600⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1095
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (322468097 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(32989 / 400000), prawitzNormalCorrection
