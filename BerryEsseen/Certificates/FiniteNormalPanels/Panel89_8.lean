...
namespace FiniteNormalPanel89_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (31027 / 160000)
def radius : Rat := (31027 / 800000)

def j0 : Jet := ⟨⟨832874689, 832874690⟩, ⟨166574937, 166574938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2616553004, 2616553008⟩, ⟨523310598, 523310602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1594039989, 1594039995⟩, ⟨637615992, 637616000⟩, ⟨63761598, 63761600⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨398, 400⟩, ⟨159, 160⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94289), (-94286)⟩, ⟨159, 160⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-34995), (-34993)⟩, ⟨(-13939), (-13937)⟩, ⟨(-1372), (-1369)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5078061, 5078064⟩, ⟨(-13939), (-13937)⟩, ⟨(-1372), (-1369)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1884678, 1884680⟩, ⟨748697, 748700⟩, ⟨72807, 72811⟩, ⟨(-410), (-406)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-141280899), (-141280896)⟩, ⟨748697, 748700⟩, ⟨72807, 72811⟩, ⟨(-410), (-406)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-52435185), (-52435183)⟩, ⟨(-20696202), (-20696199)⟩, ⟨(-1959239), (-1959233)⟩, ⟨21769, 21775⟩, ⟨1011, 1015⟩⟩
...
def j19 : Jet := ⟨⟨1379220580, 1379220583⟩, ⟨(-20696202), (-20696199)⟩, ⟨(-1959239), (-1959233)⟩, ⟨21769, 21775⟩, ⟨1011, 1015⟩⟩
...
def j22 : Jet := ⟨⟨(-41), (-39)⟩, ⟨(-17), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11794, 11797⟩, ⟨(-17), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4377, 4379⟩, ⟨1743, 1747⟩, ⟨171, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847800), (-847797)⟩, ⟨1743, 1747⟩, ⟨171, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-314654), (-314652)⟩, ⟨(-125216), (-125212)⟩, ⟨(-12266), (-12261)⟩, ⟨49, 52⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35476740, 35476743⟩, ⟨(-125216), (-125212)⟩, ⟨(-12266), (-12261)⟩, ⟨49, 52⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13166885, 13166887⟩, ⟨5220281, 5220284⟩, ⟨503532, 503538⟩, ⟨(-3662), (-3658)⟩, ⟨(-176), (-172)⟩⟩
...
def j33 : Jet := ⟨⟨(-702660998), (-702660995)⟩, ⟨5220281, 5220284⟩, ⟨503532, 503538⟩, ⟨(-3662), (-3658)⟩, ⟨(-176), (-172)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-260786558), (-260786554)⟩, ⟨(-102377162), (-102377157)⟩, ⟨(-9469598), (-9469591)⟩, ⟨150890, 150896⟩, ⟨6865, 6870⟩⟩
...
def j36 : Jet := ⟨⟨4034180738, 4034180742⟩, ⟨(-102377162), (-102377157)⟩, ⟨(-9469598), (-9469591)⟩, ⟨150890, 150896⟩, ⟨6865, 6870⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨840240100, 840240104⟩, ⟨155439608, 155439613⟩, ⟨(-3715279), (-3715272)⟩, ⟨(-225459), (-225452)⟩, ⟨3267, 3273⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4572612198, 4572612204⟩, ⟨116041165, 116041173⟩, ⟨13678297, 13678309⟩, ⟨448470, 448482⟩, ⟨31359, 31371⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨894556783, 894556790⟩, ⟨188189438, 188189448⟩, ⟨2920141, 2920155⟩, ⟨242353, 242369⟩, ⟨7917, 7932⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-832874690), (-832874689)⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3462092606, 3462092607⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨186318493, 186318497⟩, ⟨78392278, 78392286⟩, ⟨9462172, 9462182⟩, ⟨356852, 356864⟩, ⟨26519, 26532⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4481285789, 4481285793⟩, ⟨78392278, 78392286⟩, ⟨9462172, 9462182⟩, ⟨356852, 356864⟩, ⟨26519, 26532⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4387137552, 4387137555⟩, ⟨38372659, 38372664⟩, ⟨4463873, 4463879⟩, ⟨135633, 135641⟩, ⟨9523, 9531⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3536389321, 3536389325⟩, ⟨(-139218167), (-139218160)⟩, ⟨2110008, 2110015⟩, ⟨(-63795), (-63787)⟩, ⟨2415, 2423⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨32260057704, 32260057707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value417

def j47 : Jet := ⟨⟨6255830062, 6255830071⟩, ⟨1251166006, 1251166015⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9111922645, 9111922672⟩, ⟨3644769038, 3644769072⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9111922645, 9111922672⟩, ⟨3644769038, 3644769072⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9111922672), (-9111922645)⟩, ⟨(-3644769072), (-3644769038)⟩, ⟨(-364476908), (-364476902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4555961336), (-4555961322)⟩, ⟨(-1822384536), (-1822384519)⟩, ⟨(-182238454), (-182238451)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1486874887, 1486874908⟩, ⟨(-630891379), (-630891364)⟩, ⟨70756660, 70756667⟩, ⟨7838590, 7838593⟩, ⟨(-2332620), (-2332619)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1224262749, 1224262769⟩, ⟨(-567659164), (-567659145)⟩, ⟨79439939, 79439953⟩, ⟨3828583, 3828594⟩, ⟨(-2129751), (-2129741)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨666299751, 999449628⟩, ⟨166574937, 166574938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2093242402, 3139863610⟩, ⟨523310598, 523310602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1020185592, 2295417593⟩, ⟨510092792, 765139198⟩, ⟨63761598, 63761600⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨255, 576⟩, ⟨127, 192⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94432), (-94110)⟩, ⟨127, 192⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-50469), (-22353)⟩, ⟨(-16793), (-11073)⟩, ⟨(-1384), (-1353)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5062587, 5090704⟩, ⟨(-16793), (-11073)⟩, ⟨(-1384), (-1353)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1202518, 2720694⟩, ⟨592284, 904268⟩, ⟨71425, 73939⟩, ⟨(-497), (-320)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141963059), (-140444882)⟩, ⟨592284, 904268⟩, ⟨71425, 73939⟩, ⟨(-497), (-320)⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-75871243), (-33359938)⟩, ⟨(-25149730), (-16196688)⟩, ⟨(-2020228), (-1884385)⟩, ⟨17008, 26522⟩, ⟨959, 1056⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1355784522, 1398295828⟩, ⟨(-25149730), (-16196688)⟩, ⟨(-2020228), (-1884385)⟩, ⟨17008, 26522⟩, ⟨959, 1056⟩⟩
...
def j70 : Jet := ⟨⟨(-58), (-25)⟩, ⟨(-20), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11777, 11811⟩, ⟨(-20), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2797, 6313⟩, ⟨1387, 2103⟩, ⟨168, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849380), (-845863)⟩, ⟨1387, 2103⟩, ⟨168, 175⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-453946), (-200918)⟩, ⟨(-150987), (-99335)⟩, ⟨(-12407), (-12088)⟩, ⟨37, 64⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35337448, 35590477⟩, ⟨(-150987), (-99335)⟩, ⟨(-12407), (-12088)⟩, ⟨37, 64⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8393720, 19021102⟩, ⟨4116165, 6316773⟩, ⟨491077, 513696⟩, ⟨(-4445), (-2874)⟩, ⟨(-181), (-165)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707434163), (-696806780)⟩, ⟨4116165, 6316773⟩, ⟨491077, 513696⟩, ⟨(-4445), (-2874)⟩, ⟨(-181), (-165)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-378083630), (-165512840)⟩, ⟨(-125050163), (-79380460)⟩, ⟨(-9896822), (-8944690)⟩, ⟨117053, 184609⟩, ⟨6401, 7247⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3916883666, 4129454456⟩, ⟨(-125050163), (-79380460)⟩, ⟨(-9896822), (-8944690)⟩, ⟨117053, 184609⟩, ⟨6401, 7247⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨660770025, 1022233206⟩, ⟨146806632, 162478407⟩, ⟨(-4541214), (-2891842)⟩, ⟨(-237862), (-210208)⟩, ⟨2539, 4004⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4467114063, 4709546070⟩, ⟨85871286, 150356650⟩, ⟨11326786, 16699927⟩, ⟨193194, 779574⟩, ⟨13259, 57221⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨687254376, 1120905946⟩, ⟨165901877, 213947871⟩, ⟨(-301793), 6654939⟩, ⟨(-2918), 540853⟩, ⟨(-14703), 35675⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-999449628), (-666299751)⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3295517668, 3628667545⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨109970238, 292535439⟩, ⟨53093204, 111672768⟩, ⟨6250772, 14131149⟩, ⟨(-31592), 945320⟩, ⟨(-8436), 82818⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4404937534, 4587502735⟩, ⟨53093204, 111672768⟩, ⟨6250772, 14131149⟩, ⟨(-31592), 945320⟩, ⟨(-8436), 82818⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4349604884, 4438825771⟩, ⟨25686249, 55134995⟩, ⟨2681676, 6900977⟩, ⟨(-103074), 450888⟩, ⟨(-15357), 41370⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3337440952, 3750208536⟩, ⟨(-152445316), (-122112359)⟩, ⟨(-80699), 4834185⟩, ⟨(-354730), 276935⟩, ⟨(-30463), 38951⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5004664048, 7506996085⟩, ⟨1251166006, 1251166015⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5831630489, 13121168647⟩, ⟨2915815230, 4373722886⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5831630489, 13121168647⟩, ⟨2915815230, 4373722886⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13121168647), (-5831630489)⟩, ⟨(-4373722886), (-2915815230)⟩, ⟨(-364476908), (-364476902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6560584324), (-2915815244)⟩, ⟨(-2186861443), (-1457907615)⟩, ⟨(-182238454), (-182238451)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨932336821, 2178317529⟩, ⟨(-1109130359), (-316477602)⟩, ⟨(-38714071), 242807342⟩, ⟨(-32257696), 37944776⟩, ⟨(-9981313), 4927483⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨724480274, 1902027287⟩, ⟨(-1045769184), (-272429351)⟩, ⟨(-24846710), 253829707⟩, ⟨(-38212722), 34667404⟩, ⟨(-10192670), 5832105⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨832874689, 832874690⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨166574937, 166574938⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4387137552, 4387137555⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar417 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1798
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar417 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨666299751, 999449628⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4349604884, 4438825771⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1799
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((31027 / 200000) : ℝ)..(93081 / 400000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (31027 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (93081 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((31027 / 200000) : ℝ)..(93081 / 400000), prawitzNormalCorrection
      ((250371 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
