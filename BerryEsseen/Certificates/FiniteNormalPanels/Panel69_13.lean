...
namespace FiniteNormalPanel69_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (96891 / 800000)
def radius : Rat := (32297 / 800000)

def j0 : Jet := ⟨⟨520179595, 520179596⟩, ⟨173393198, 173393199⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1634192394, 1634192398⟩, ⟨544730796, 544730801⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨621793973, 621793977⟩, ⟨414529314, 414529320⟩, ⟨69088218, 69088221⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨155, 156⟩, ⟨103, 104⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94532), (-94530)⟩, ⟨103, 104⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-13686), (-13685)⟩, ⟨(-9110), (-9107)⟩, ⟨(-1510), (-1506)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5099370, 5099372⟩, ⟨(-9110), (-9107)⟩, ⟨(-1510), (-1506)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨738249, 738250⟩, ⟨490847, 490849⟩, ⟨80928, 80932⟩, ⟨(-293), (-290)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-142427328), (-142427326)⟩, ⟨490847, 490849⟩, ⟨80928, 80932⟩, ⟨(-293), (-290)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-20619588), (-20619587)⟩, ⟨(-13675331), (-13675329)⟩, ⟨(-2231976), (-2231973)⟩, ⟨15662, 15667⟩, ⟨1268, 1272⟩⟩
...
def j19 : Jet := ⟨⟨1411036177, 1411036179⟩, ⟨(-13675331), (-13675329)⟩, ⟨(-2231976), (-2231973)⟩, ⟨15662, 15667⟩, ⟨1268, 1272⟩⟩
...
def j25 : Jet := ⟨⟨1711, 1712⟩, ⟨1138, 1140⟩, ⟨187, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850466), (-850464)⟩, ⟨1138, 1140⟩, ⟨187, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-123125), (-123123)⟩, ⟨(-81919), (-81916)⟩, ⟨(-13545), (-13541)⟩, ⟨35, 38⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35668269, 35668272⟩, ⟨(-81919), (-81916)⟩, ⟨(-13545), (-13541)⟩, ⟨35, 38⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5163791, 5163792⟩, ⟨3430667, 3430669⟩, ⟨563886, 563889⟩, ⟨(-2621), (-2617)⟩, ⟨(-215), (-212)⟩⟩
...
def j33 : Jet := ⟨⟨(-710664092), (-710664090)⟩, ⟨3430667, 3430669⟩, ⟨563886, 563889⟩, ⟨(-2621), (-2617)⟩, ⟨(-215), (-212)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-102884754), (-102884752)⟩, ⟨(-68093171), (-68093166)⟩, ⟨(-11018894), (-11018890)⟩, ⟨109228, 109232⟩, ⟨8785, 8789⟩⟩
...
def j36 : Jet := ⟨⟨4192082542, 4192082544⟩, ⟨(-68093171), (-68093166)⟩, ⟨(-11018894), (-11018890)⟩, ⟨109228, 109232⟩, ⟨8785, 8789⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨536885249, 536885252⟩, ⟨173758421, 173758426⟩, ⟨(-2583688), (-2583685)⟩, ⟨(-277123), (-277119)⟩, ⟨2468, 2472⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4400377110, 4400377114⟩, ⟨71476551, 71476559⟩, ⟨12727404, 12727412⟩, ⟨279950, 279958⟩, ⟨26911, 26920⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨550061827, 550061832⟩, ⟨186957717, 186957725⟩, ⟨1835543, 1835551⟩, ⟨222974, 222983⟩, ⟨4947, 4959⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-520179596), (-520179595)⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3774787700, 3774787701⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨70447105, 70447107⟩, ⟨47887816, 47887820⟩, ⟨8608333, 8608338⟩, ⟨216912, 216918⟩, ⟨21460, 21471⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4365414401, 4365414403⟩, ⟨47887816, 47887820⟩, ⟨8608333, 8608338⟩, ⟨216912, 216918⟩, ⟨21460, 21471⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4330047584, 4330047586⟩, ⟨23749924, 23749927⟩, ⟨4204162, 4204166⟩, ⟨84517, 84522⟩, ⟨8137, 8145⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3805619282, 3805619286⟩, ⟨(-153935954), (-153935948)⟩, ⟨2736165, 2736170⟩, ⟨(-95448), (-95441)⟩, ⟨3738, 3747⟩⟩
...
def j47 : Jet := ⟨⟨3681648762, 3681648771⟩, ⟨1227216251, 1227216260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3155911715, 3155911731⟩, ⟨2103941138, 2103941160⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3155911715, 3155911731⟩, ⟨2103941138, 2103941160⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3155911731), (-3155911715)⟩, ⟨(-2103941160), (-2103941138)⟩, ⟨(-350656861), (-350656855)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1577955866), (-1577955857)⟩, ⟨(-1051970580), (-1051970569)⟩, ⟨(-175328431), (-175328427)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2974415237, 2974415248⟩, ⟨(-728526464), (-728526452)⟩, ⟨(-32201728), (-32201721)⟩, ⟨22455588, 22455591⟩, ⟨(-717752), (-717750)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2635524603, 2635524616⟩, ⟨(-752127686), (-752127668)⟩, ⟨(-526808), (-526794)⟩, ⟨20521026, 20521039⟩, ⟨(-1442544), (-1442531)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨346786396, 693572794⟩, ⟨173393198, 173393199⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1089461593, 2178923195⟩, ⟨544730796, 544730801⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨276352875, 1105411512⟩, ⟨276352874, 552705758⟩, ⟨69088218, 69088221⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨69, 277⟩, ⟨69, 139⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94618), (-94409)⟩, ⟨69, 139⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-24353), (-6074)⟩, ⟨(-12173), (-6038)⟩, ⟨(-1518), (-1495)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5088703, 5106983⟩, ⟨(-12173), (-6038)⟩, ⟨(-1518), (-1495)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨327424, 1314403⟩, ⟨324290, 656814⟩, ⟨79898, 81667⟩, ⟨(-392), (-191)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142838153), (-141851173)⟩, ⟨324290, 656814⟩, ⟨79898, 81667⟩, ⟨(-392), (-191)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-36762781), (-9127189)⟩, ⟨(-18360526), (-8958142)⟩, ⟨(-2271669), (-2176254)⟩, ⟨10255, 21064⟩, ⟨1227, 1301⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1394892984, 1422528577⟩, ⟨(-18360526), (-8958142)⟩, ⟨(-2271669), (-2176254)⟩, ⟨10255, 21064⟩, ⟨1227, 1301⟩⟩
...
def j72 : Jet := ⟨⟨759, 3045⟩, ⟨755, 1523⟩, ⟨186, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851418), (-849131)⟩, ⟨755, 1523⟩, ⟨186, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-219133), (-54635)⟩, ⟨(-109519), (-54243)⟩, ⟨(-13637), (-13412)⟩, ⟨22, 50⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35572261, 35736760⟩, ⟨(-109519), (-54243)⟩, ⟨(-13637), (-13412)⟩, ⟨22, 50⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2288840, 9197702⟩, ⟨2260652, 4595361⟩, ⟨554606, 570505⟩, ⟨(-3516), (-1721)⟩, ⟨(-219), (-206)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713539043), (-706630180)⟩, ⟨2260652, 4595361⟩, ⟨554606, 570505⟩, ⟨(-3516), (-1721)⟩, ⟨(-219), (-206)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-183646165), (-45467000)⟩, ⟨(-91677625), (-44284275)⟩, ⟨(-11296743), (-10628554)⟩, ⟨71144, 147228⟩, ⟨8411, 9055⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4111321131, 4249500296⟩, ⟨(-91677625), (-44284275)⟩, ⟨(-11296743), (-10628554)⟩, ⟨71144, 147228⟩, ⟨8411, 9055⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨353828615, 721677326⟩, ⟨167599643, 178147011⟩, ⟨(-3481130), (-1688189)⟩, ⟨(-285515), (-265327)⟩, ⟨1611, 3333⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4340920764, 4486816643⟩, ⟨45236972, 100050734⟩, ⟨11328624, 14559513⟩, ⟨75747, 524456⟩, ⟨16095, 42039⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨357614360, 753913503⟩, ⟨173119572, 202915940⟩, ⟨(-938099), 4890077⟩, ⟨68947, 406080⟩, ⟨(-12545), 25054⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-693572794), (-346786396)⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3601394502, 3948180900⟩, ⟨(-173393199), (-173393198)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨29776252, 132337579⟩, ⟨28829110, 71237362⟩, ⟨6648686, 11303526⟩, ⟨(-77162), 604626⟩, ⟨83, 52736⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4324743548, 4427304875⟩, ⟨28829110, 71237362⟩, ⟨6648686, 11303526⟩, ⟨(-77162), 604626⟩, ⟨83, 52736⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4309829706, 4360634088⟩, ⟨14197486, 35495851⟩, ⟨3129812, 5608889⟩, ⟨(-84644), 290962⟩, ⟨(-6006), 25839⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3613856855, 4008545592⟩, ⟨(-164139446), (-141363384)⟩, ⟨1191382, 4582844⟩, ⟨(-304248), 141116⟩, ⟨(-17269), 27171⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2454432503, 4908865023⟩, ⟨1227216251, 1227216260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1402627423, 5610509733⟩, ⟨1402627422, 2805254876⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1402627423, 5610509733⟩, ⟨1402627422, 2805254876⟩, ⟨350656855, 350656861⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5610509733), (-1402627423)⟩, ⟨(-2805254876), (-1402627422)⟩, ⟨(-350656861), (-350656855)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2805254867), (-701313711)⟩, ⟨(-1402627438), (-701313711)⟩, ⟨(-175328431), (-175328427)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2235119386, 3647918091⟩, ⟨(-1191317571), (-364966660)⟩, ⟨(-119117484), 103285395⟩, ⟨(-1311060), 45388094⟩, ⟨(-5813800), 2538337⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1880666593, 3404646643⟩, ⟨(-1251282650), (-380655122)⟩, ⟨(-98541395), 145818169⟩, ⟨(-6700437), 46932161⟩, ⟨(-7341587), 2636845⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨520179595, 520179596⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4330047584, 4330047586⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1384
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨346786396, 693572794⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4309829706, 4360634088⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1385
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (106413625 / 2147483648)

theorem envelope_integral : (∫ s in ((32297 / 400000) : ℝ)..(32297 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (32297 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (32297 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((32297 / 400000) : ℝ)..(32297 / 200000), prawitzNormalCorrection
