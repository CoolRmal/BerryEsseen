...
namespace FiniteNormalPanel117_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (102431 / 400000)
def radius : Rat := (14633 / 400000)

def j0 : Jet := ⟨⟨1099844487, 1099844488⟩, ⟨157120641, 157120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3455263360, 3455263364⟩, ⟨493609051, 493609055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2779728939, 2779728946⟩, ⟨794208266, 794208276⟩, ⟨56729161, 56729163⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨695, 697⟩, ⟨198, 199⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93992), (-93989)⟩, ⟨198, 199⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-60833), (-60830)⟩, ⟨(-17253), (-17251)⟩, ⟨(-1197), (-1194)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5052223, 5052227⟩, ⟨(-17253), (-17251)⟩, ⟨(-1197), (-1194)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3269829, 3269833⟩, ⟨923069, 923074⟩, ⟨62765, 62771⟩, ⟨(-448), (-443)⟩, ⟨(-16), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-139895748), (-139895743)⟩, ⟨923069, 923074⟩, ⟨62765, 62771⟩, ⟨(-448), (-443)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-90541379), (-90541375)⟩, ⟨(-25271551), (-25271544)⟩, ⟨(-1636473), (-1636465)⟩, ⟨23508, 23515⟩, ⟨735, 742⟩⟩
...
def j19 : Jet := ⟨⟨1341114386, 1341114391⟩, ⟨(-25271551), (-25271544)⟩, ⟨(-1636473), (-1636465)⟩, ⟨23508, 23515⟩, ⟨735, 742⟩⟩
...
def j25 : Jet := ⟨⟨7614, 7616⟩, ⟨2162, 2164⟩, ⟨149, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844563), (-844560)⟩, ⟨2162, 2164⟩, ⟨149, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-546607), (-546604)⟩, ⟨(-154775), (-154771)⟩, ⟨(-10661), (-10654)⟩, ⟨53, 58⟩, ⟨(-1), 3⟩⟩
...
def j30 : Jet := ⟨⟨35244787, 35244791⟩, ⟨(-154775), (-154771)⟩, ⟨(-10661), (-10654)⟩, ⟨53, 58⟩, ⟨(-1), 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22810640, 22810644⟩, ⟨6417153, 6417159⟩, ⟨430002, 430010⟩, ⟨(-3983), (-3976)⟩, ⟨(-133), (-127)⟩⟩
...
def j33 : Jet := ⟨⟨(-693017243), (-693017238)⟩, ⟨6417153, 6417159⟩, ⟨430002, 430010⟩, ⟨(-3983), (-3976)⟩, ⟨(-133), (-127)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-448524973), (-448524968)⟩, ⟨(-123996774), (-123996765)⟩, ⟨(-7688639), (-7688628)⟩, ⟨161695, 161703⟩, ⟨4855, 4863⟩⟩
...
def j36 : Jet := ⟨⟨3846442323, 3846442328⟩, ⟨(-123996774), (-123996765)⟩, ⟨(-7688639), (-7688628)⟩, ⟨161695, 161703⟩, ⟨4855, 4863⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1078914711, 1078914717⟩, ⟨133799931, 133799941⟩, ⟨(-4220921), (-4220911)⟩, ⟨(-169165), (-169156)⟩, ⟨3292, 3300⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4795793749, 4795793756⟩, ⟨154600760, 154600774⟩, ⟨14570104, 14570120⟩, ⟨577108, 577123⟩, ⟨35163, 35178⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1204724522, 1204724532⟩, ⟨188238431, 188238447⟩, ⟨3763194, 3763214⟩, ⟨258043, 258060⟩, ⟨10077, 10095⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1099844488), (-1099844487)⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3195122808, 3195122809⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨337921356, 337921362⟩, ⟨105600548, 105600560⟩, ⟨10361178, 10361195⟩, ⟨474624, 474638⟩, ⟨31567, 31584⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4632888652, 4632888658⟩, ⟨105600548, 105600560⟩, ⟨10361178, 10361195⟩, ⟨474624, 474638⟩, ⟨31567, 31584⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4460729228, 4460729231⟩, ⟨50838201, 50838207⟩, ⟨4698379, 4698388⟩, ⟨174946, 174954⟩, ⟨10728, 10739⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3318436838, 3318436843⟩, ⟨(-125364948), (-125364939)⟩, ⟨1635440, 1635449⟩, ⟨(-41733), (-41725)⟩, ⟨1579, 1590⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨35448658033, 35448658040⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value506

def j47 : Jet := ⟨⟨9077603721, 9077603732⟩, ⟨1296800531, 1296800541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨19185917758, 19185917805⟩, ⟨5481690784, 5481690836⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨19185917758, 19185917805⟩, ⟨5481690784, 5481690836⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-19185917805), (-19185917758)⟩, ⟨(-5481690836), (-5481690784)⟩, ⟨(-391549348), (-391549341)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9592958903), (-9592958879)⟩, ⟨(-2740845418), (-2740845392)⟩, ⟨(-195774674), (-195774670)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨460201490, 460201505⟩, ⟨(-293678881), (-293678867)⟩, ⟨72728931, 72728940⟩, ⟨(-6546346), (-6546342)⟩, ⟨(-613187), (-613185)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨355567219, 355567232⟩, ⟨(-240338957), (-240338942)⟩, ⟨64940197, 64940209⟩, ⟨(-7297100), (-7297091)⟩, ⟨(-251975), (-251968)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨942723846, 1256965129⟩, ⟨157120641, 157120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2961654308, 3948872416⟩, ⟨493609051, 493609055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2042249832, 3630666379⟩, ⟨680749942, 907666602⟩, ⟨56729161, 56729163⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨511, 910⟩, ⟨170, 228⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94176), (-93776)⟩, ⟨170, 228⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-79610), (-44590)⟩, ⟨(-19823), (-14670)⟩, ⟨(-1212), (-1176)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5033446, 5068467⟩, ⟨(-19823), (-14670)⟩, ⟨(-1212), (-1176)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2393395, 4284530⟩, ⟨781041, 1064158⟩, ⟨61268, 64062⟩, ⟨(-518), (-372)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140772182), (-138881046)⟩, ⟨781041, 1064158⟩, ⟨61268, 64062⟩, ⟨(-518), (-372)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-118999004), (-66037707)⟩, ⟨(-29378369), (-21113003)⟩, ⟨(-1706434), (-1555334)⟩, ⟨19588, 27419⟩, ⟨684, 784⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1312656761, 1365618059⟩, ⟨(-29378369), (-21113003)⟩, ⟨(-1706434), (-1555334)⟩, ⟨19588, 27419⟩, ⟨684, 784⟩⟩
...
def j72 : Jet := ⟨⟨5583, 9964⟩, ⟨1841, 2484⟩, ⟨148, 154⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846594), (-842212)⟩, ⟨1841, 2484⟩, ⟨148, 154⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-715652), (-400470)⟩, ⟨(-178038), (-131390)⟩, ⟨(-10822), (-10468)⟩, ⟨45, 66⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35075742, 35390925⟩, ⟨(-178038), (-131390)⟩, ⟨(-10822), (-10468)⟩, ⟨45, 66⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16678457, 29917025⟩, ⟨5408984, 7416782⟩, ⟨416515, 441652⟩, ⟨(-4619), (-3338)⟩, ⟨(-137), (-121)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699149426), (-685910857)⟩, ⟨5408984, 7416782⟩, ⟨416515, 441652⟩, ⟨(-4619), (-3338)⟩, ⟨(-137), (-121)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-591012257), (-326149475)⟩, ⟨(-145181104), (-102446859)⟩, ⟨(-8179195), (-7118957)⟩, ⟨133555, 189712⟩, ⟨4408, 5248⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3703955039, 3968817821⟩, ⟨(-145181104), (-102446859)⟩, ⟨(-8179195), (-7118957)⟩, ⟨133555, 189712⟩, ⟨4408, 5248⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨905160687, 1255574517⟩, ⟨123849097, 142388052⟩, ⟨(-4945305), (-3498962)⟩, ⟨(-182609), (-153540)⟩, ⟨2722, 3873⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4647919079, 4980282936⟩, ⟨119976459, 195208358⟩, ⟨11434019, 18649058⟩, ⟨272288, 994448⟩, ⟨11619, 70305⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨979544973, 1455917103⟩, ⟨159311702, 222174318⟩, ⟨134942, 8136904⟩, ⟨(-49421), 645077⟩, ⟨(-16529), 44410⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1256965129), (-942723846)⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3038002167, 3352243450⟩, ⟨(-157120642), (-157120641)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨223402947, 493529861⟩, ⟨72667830, 150626242⟩, ⟨5970842, 17009383⟩, ⟨(-23496), 1279168⟩, ⟨(-16318), 112266⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4518370243, 4788497157⟩, ⟨72667830, 150626242⟩, ⟨5970842, 17009383⟩, ⟨(-23496), 1279168⟩, ⟨(-16318), 112266⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4405252821, 4535023560⟩, ⟨34410620, 73427657⟩, ⟨2232948, 8157382⟩, ⟨(-147424), 606130⟩, ⟨(-25612), 56621⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3116011530, 3539608565⟩, ⟨(-141562494), (-103844507)⟩, ⟨(-1106715), 5108052⟩, ⟨(-413484), 391402⟩, ⟨(-42165), 49587⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7780803189, 10374404264⟩, ⟨1296800531, 1296800541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14095776310, 25059157944⟩, ⟨4698592100, 6264789526⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14095776310, 25059157944⟩, ⟨4698592100, 6264789526⟩, ⟨391549341, 391549348⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-25059157944), (-14095776310)⟩, ⟨(-6264789526), (-4698592100)⟩, ⟨(-391549348), (-391549341)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12529578972), (-7047888155)⟩, ⟨(-3132394763), (-2349296050)⟩, ⟨(-195774674), (-195774670)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨232276686, 832334906⟩, ⟨(-607036404), (-127052585)⟩, ⟨(-3191649), 210773418⟩, ⟨(-47379344), 19222670⟩, ⟨(-8308631), 8711388⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨168517425, 685951618⟩, ⟨(-527710343), (-97793055)⟩, ⟨227094, 194702437⟩, ⟨(-46795906), 16179436⟩, ⟨(-7598772), 9059666⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1099844487, 1099844488⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4460729228, 4460729231⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar506 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2360
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar506 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨942723846, 1256965129⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4405252821, 4535023560⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2361
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((43899 / 200000) : ℝ)..(14633 / 50000), prawitzNormalCorrection
      ((238259 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
