...
namespace FiniteNormalPanel107_17
...
def j2 : Jet := ⟨⟨494890887, 494890891⟩, ⟨494890887, 494890891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨57024180, 57024182⟩, ⟨114048360, 114048364⟩, ⟨57024180, 57024182⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1257), (-1256)⟩, ⟨(-2514), (-2512)⟩, ⟨(-1257), (-1254)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111799, 5111801⟩, ⟨(-2514), (-2512)⟩, ⟨(-1257), (-1254)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨67869, 67870⟩, ⟨135704, 135706⟩, ⟨67785, 67788⟩, ⟨(-68), (-65)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-143097708), (-143097706)⟩, ⟨135704, 135706⟩, ⟨67785, 67788⟩, ⟨(-68), (-65)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1899905), (-1899904)⟩, ⟨(-3798009), (-3798007)⟩, ⟨(-1895403), (-1895399)⟩, ⟨3599, 3603⟩, ⟨896, 900⟩⟩
...
def j19 : Jet := ⟨⟨1429755860, 1429755862⟩, ⟨(-3798009), (-3798007)⟩, ⟨(-1895403), (-1895399)⟩, ⟨3599, 3603⟩, ⟨896, 900⟩⟩
...
def j25 : Jet := ⟨⟨157, 158⟩, ⟨313, 315⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852020), (-852018)⟩, ⟨313, 315⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11313), (-11312)⟩, ⟨(-22621), (-22619)⟩, ⟨(-11303), (-11300)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35780081, 35780083⟩, ⟨(-22621), (-22619)⟩, ⟨(-11303), (-11300)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨475051, 475052⟩, ⟨949801, 949803⟩, ⟨474299, 474302⟩, ⟨(-602), (-599)⟩, ⟨(-151), (-148)⟩⟩
...
def j33 : Jet := ⟨⟨(-715352832), (-715352830)⟩, ⟨949801, 949803⟩, ⟨474299, 474302⟩, ⟨(-602), (-599)⟩, ⟨(-151), (-148)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9497724), (-9497722)⟩, ⟨(-18982837), (-18982834)⟩, ⟨(-9466207), (-9466202)⟩, ⟨25196, 25199⟩, ⟨6278, 6282⟩⟩
...
def j36 : Jet := ⟨⟨4285469572, 4285469574⟩, ⟨(-18982837), (-18982834)⟩, ⟨(-9466207), (-9466202)⟩, ⟨25196, 25199⟩, ⟨6278, 6282⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨164744710, 164744713⟩, ⟨164307081, 164307085⟩, ⟨(-656029), (-656026)⟩, ⟨(-217986), (-217982)⟩, ⟨517, 520⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304486067, 4304486070⟩, ⟨19067068, 19067073⟩, ⟨9592665, 9592673⟩, ⟨59297, 59304⟩, ⟨15029, 15038⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨165109827, 165109831⟩, ⟨165402595, 165402601⟩, ⟨439892, 439899⟩, ⟨147865, 147873⟩, ⟨928, 936⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-157528663), (-157528662)⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4137438633, 4137438634⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6347255, 6347256⟩, ⟨12717020, 12717022⟩, ⟨6403605, 6403608⟩, ⟨45248, 45252⟩, ⟨11503, 11508⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301314551, 4301314552⟩, ⟨12717020, 12717022⟩, ⟨6403605, 6403608⟩, ⟨45248, 45252⟩, ⟨11503, 11508⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298139751, 4298139753⟩, ⟨6353816, 6353818⟩, ⟨3194742, 3194745⟩, ⟨17883, 17887⟩, ⟨4532, 4537⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4140494730, 4140494734⟩, ⟨(-151524248), (-151524243)⟩, ⟨2844523, 2844528⟩, ⟨(-99949), (-99944)⟩, ⟨3708, 3716⟩⟩
...
def j47 : Jet := ⟨⟨1304674867, 1304674877⟩, ⟨1304674867, 1304674877⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨396318852, 396318859⟩, ⟨792637704, 792637718⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨396318852, 396318859⟩, ⟨792637704, 792637718⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-396318859), (-396318852)⟩, ⟨(-792637718), (-792637704)⟩, ⟨(-396318859), (-396318852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-198159430), (-198159426)⟩, ⟨(-396318859), (-396318852)⟩, ⟨(-198159430), (-198159426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4101309665, 4101309670⟩, ⟨(-378449068), (-378449060)⟩, ⟨(-171763809), (-171763803)⟩, ⟨16923662, 16923664⟩, ⟨3571974, 3571976⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3953802179, 3953802188⟩, ⟨(-509529897), (-509529882)⟩, ⟨(-149518409), (-149518395)⟩, ⟨22028636, 22028649⟩, ⟨2745032, 2745048⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 315057326⟩, ⟨157528662, 157528663⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 989781781⟩, ⟨494890887, 494890891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 228096725⟩, ⟨0, 228096726⟩, ⟨57024180, 57024182⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5029), 0⟩, ⟨(-5029), 4⟩, ⟨(-1258), (-1251)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108027, 5113057⟩, ⟨(-5029), 4⟩, ⟨(-1258), (-1251)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 271544⟩, ⟨(-268), 271545⟩, ⟨67484, 67887⟩, ⟨(-134), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142894032)⟩, ⟨(-268), 271545⟩, ⟨67484, 67887⟩, ⟨(-134), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7603225), 0⟩, ⟨(-7603240), 14422⟩, ⟨(-1900822), (-1879172)⟩, ⟨(-12), 7213⟩, ⟨886, 903⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424052540, 1431655766⟩, ⟨(-7603240), 14422⟩, ⟨(-1900822), (-1879172)⟩, ⟨(-12), 7213⟩, ⟨886, 903⟩⟩
...
def j72 : Jet := ⟨⟨0, 629⟩, ⟨(-1), 629⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851547)⟩, ⟨(-1), 629⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-45258), 0⟩, ⟨(-45259), 34⟩, ⟨(-11316), (-11262)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35746136, 35791395⟩, ⟨(-45259), 34⟩, ⟨(-11316), (-11262)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1900807⟩, ⟨(-2404), 1900809⟩, ⟨471595, 475204⟩, ⟨(-1203), 2⟩, ⟨(-152), (-147)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713927075)⟩, ⟨(-2404), 1900809⟩, ⟨471595, 475204⟩, ⟨(-1203), 2⟩, ⟨(-152), (-147)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-38016121), 0⟩, ⟨(-38016250), 100948⟩, ⟨(-9504159), (-9352607)⟩, ⟨(-96), 50476⟩, ⟨6188, 6311⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4256951175, 4294967296⟩, ⟨(-38016250), 100948⟩, ⟨(-9504159), (-9352607)⟩, ⟨(-96), 50476⟩, ⟨6188, 6311⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 329927261⟩, ⟨162335362, 164966955⟩, ⟨(-1314138), 1662⟩, ⟨(-219027), (-214866)⟩, ⟨(-2), 1041⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4333322915⟩, ⟨(-102760), 38698280⟩, ⟨9351697, 10020260⟩, ⟨(-51850), 175982⟩, ⟨13082, 17703⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 332873632⟩, ⟨162327468, 169412863⟩, ⟨(-1329821), 2257783⟩, ⟨116655, 183557⟩, ⟨(-7035), 9181⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-315057326), 0⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3979909970, 4294967296⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 25798766⟩, ⟨0, 26260072⟩, ⟨5929003, 7032379⟩, ⟨(-104910), 206570⟩, ⟨7024, 17093⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4320766062⟩, ⟨0, 26260072⟩, ⟨5929003, 7032379⟩, ⟨(-104910), 206570⟩, ⟨7024, 17093⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307847367⟩, ⟨0, 13130036⟩, ⟨2935627, 3516190⟩, ⟨(-63205), 103285⟩, ⟨1751, 7738⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3979909970, 4307847367⟩, ⟨(-158001072), (-144398626)⟩, ⟨2238707, 3516190⟩, ⟨(-192171), (-4386)⟩, ⟨(-2167), 10057⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2609349753⟩, ⟨1304674867, 1304674877⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1585275432⟩, ⟨0, 1585275434⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1585275432⟩, ⟨0, 1585275434⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1585275432), 0⟩, ⟨(-1585275434), 0⟩, ⟨(-396318859), (-396318852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-792637716), 0⟩, ⟨(-792637717), 0⟩, ⟨(-198159430), (-198159426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3571171135, 4294967296⟩, ⟨(-792637717), 0⟩, ⟨(-198159430), (-91624433)⟩, ⟨0, 36570393⟩, ⟨426395, 4571300⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3309207876, 4307847367⟩, ⟨(-953015811), (-120064291)⟩, ⟨(-196892251), (-52227978)⟩, ⟨2239366, 43966207⟩, ⟨(-1114614), 4582774⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298139751, 4298139753⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2162
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307847367⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2163
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (71610605 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(14671 / 200000), prawitzNormalCorrection
