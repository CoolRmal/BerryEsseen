...
namespace FiniteNormalPanel3_24
...
def j2 : Jet := ⟨⟨2095047096, 2095047101⟩, ⟨698349032, 698349036⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1021945461, 1021945467⟩, ⟨681296974, 681296980⟩, ⟨113549495, 113549497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨255, 257⟩, ⟨170, 171⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94432), (-94429)⟩, ⟨170, 171⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-22470), (-22468)⟩, ⟨(-14940), (-14937)⟩, ⟨(-2465), (-2461)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5090586, 5090589⟩, ⟨(-14940), (-14937)⟩, ⟨(-2465), (-2461)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1211255, 1211256⟩, ⟨803948, 803950⟩, ⟨131626, 131630⟩, ⟨(-786), (-781)⟩, ⟨(-65), (-62)⟩⟩
...
def j16 : Jet := ⟨⟨(-141954322), (-141954320)⟩, ⟨803948, 803950⟩, ⟨131626, 131630⟩, ⟨(-786), (-781)⟩, ⟨(-65), (-62)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-33776643), (-33776642)⟩, ⟨(-22326471), (-22326468)⟩, ⟨(-3594115), (-3594110)⟩, ⟨41945, 41951⟩, ⟨3338, 3344⟩⟩
...
def j19 : Jet := ⟨⟨1397879122, 1397879124⟩, ⟨(-22326471), (-22326468)⟩, ⟨(-3594115), (-3594110)⟩, ⟨41945, 41951⟩, ⟨3338, 3344⟩⟩
...
def j22 : Jet := ⟨⟨(-26), (-25)⟩, ⟨(-18), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11809, 11811⟩, ⟨(-18), (-16)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2809, 2811⟩, ⟨1868, 1871⟩, ⟨308, 311⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849368), (-849365)⟩, ⟨1868, 1871⟩, ⟨308, 311⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-202099), (-202098)⟩, ⟨(-134289), (-134286)⟩, ⟨(-22087), (-22084)⟩, ⟨96, 100⟩, ⟨6, 9⟩⟩
...
def j30 : Jet := ⟨⟨35589295, 35589297⟩, ⟨(-134289), (-134286)⟩, ⟨(-22087), (-22084)⟩, ⟨96, 100⟩, ⟨6, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8468124, 8468126⟩, ⟨5613463, 5613465⟩, ⟨914344, 914348⟩, ⟨(-7033), (-7029)⟩, ⟨(-568), (-564)⟩⟩
...
def j33 : Jet := ⟨⟨(-707359759), (-707359756)⟩, ⟨5613463, 5613465⟩, ⟨914344, 914348⟩, ⟨(-7033), (-7029)⟩, ⟨(-568), (-564)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-168309338), (-168309335)⟩, ⟨(-110870558), (-110870553)⟩, ⟨(-17593034), (-17593029)⟩, ⟨291772, 291777⟩, ⟨22921, 22926⟩⟩
...
def j36 : Jet := ⟨⟨4126657958, 4126657961⟩, ⟨(-110870558), (-110870553)⟩, ⟨(-17593034), (-17593029)⟩, ⟨291772, 291777⟩, ⟨22921, 22926⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨681873083, 681873087⟩, ⟨216400371, 216400377⟩, ⟨(-5383397), (-5383392)⟩, ⟨(-563933), (-563927)⟩, ⟨8448, 8454⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4470141273, 4470141277⟩, ⟨120098887, 120098896⟩, ⟨22284073, 22284083⟩, ⟨794652, 794661⟩, ⟨83024, 83036⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨709683869, 709683875⟩, ⟨244293461, 244293470⟩, ⟨3986014, 3986025⟩, ⟨511464, 511477⟩, ⟨18308, 18322⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-666874204), (-666874203)⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3628093092, 3628093093⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨117265431, 117265434⟩, ⟨80732222, 80732228⟩, ⟨15212434, 15212442⟩, ⟨622464, 622474⟩, ⟨67931, 67942⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4412232727, 4412232730⟩, ⟨80732222, 80732228⟩, ⟨15212434, 15212442⟩, ⟨622464, 622474⟩, ⟨67931, 67942⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4353205171, 4353205173⟩, ⟨39826086, 39826090⟩, ⟨7322281, 7322287⟩, ⟨240078, 240085⟩, ⟨25155, 25163⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3677288444, 3677288448⟩, ⟨(-191663238), (-191663232)⟩, ⟨4124109, 4124117⟩, ⟨(-176174), (-176165)⟩, ⟨8823, 8831⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨17993134638, 17993134644⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value64

def j47 : Jet := ⟨⟨2793771522, 2793771528⟩, ⟨931257174, 931257179⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1817280267, 1817280276⟩, ⟨1211520178, 1211520188⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1817280267, 1817280276⟩, ⟨1211520178, 1211520188⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1817280276), (-1817280267)⟩, ⟨(-1211520188), (-1211520178)⟩, ⟨(-201920032), (-201920029)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-908640138), (-908640133)⟩, ⟨(-605760094), (-605760089)⟩, ⟨(-100960016), (-100960014)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3476008568, 3476008576⟩, ⟨(-490254556), (-490254550)⟩, ⟨(-47136462), (-47136459)⟩, ⟨9898841, 9898842⟩, ⟨204976, 204977⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2976107908, 2976107920⟩, ⟨(-574865955), (-574865943)⟩, ⟨(-15142179), (-15142166)⟩, ⟨9965375, 9965389⟩, ⟨(-284254), (-284240)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨444582802, 889165605⟩, ⟨222291401, 222291402⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1396698064, 2793396133⟩, ⟨698349032, 698349036⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨454197982, 1816791938⟩, ⟨454197982, 908395974⟩, ⟨113549495, 113549497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨113, 456⟩, ⟨113, 228⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94574), (-94230)⟩, ⟨113, 228⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-40006), (-9964)⟩, ⟨(-19992), (-9867)⟩, ⟨(-2488), (-2429)⟩, ⟨4, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073050, 5103093⟩, ⟨(-19992), (-9867)⟩, ⟨(-2488), (-2429)⟩, ⟨4, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨536481, 2158634⟩, ⟨528024, 1078274⟩, ⟨128838, 133616⟩, ⟨(-1056), (-510)⟩, ⟨(-66), (-60)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142629096), (-141006942)⟩, ⟨528024, 1078274⟩, ⟨128838, 133616⟩, ⟨(-1056), (-510)⟩, ⟨(-66), (-60)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-60332798), (-14911654)⟩, ⟨(-30110560), (-14455538)⟩, ⟨(-3701337), (-3443334)⟩, ⟨27136, 56716⟩, ⟨3154, 3474⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1371322967, 1416744112⟩, ⟨(-30110560), (-14455538)⟩, ⟨(-3701337), (-3443334)⟩, ⟨27136, 56716⟩, ⟨3154, 3474⟩⟩
...
def j70 : Jet := ⟨⟨(-46), (-11)⟩, ⟨(-23), (-11)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11789, 11825⟩, ⟨(-23), (-11)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1246, 5003⟩, ⟨1236, 2501⟩, ⟨304, 312⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850931), (-847173)⟩, ⟨1236, 2501⟩, ⟨304, 312⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-359948), (-89589)⟩, ⟨(-179844), (-88531)⟩, ⟨(-22335), (-21736)⟩, ⟨63, 133⟩, ⟨6, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35431446, 35701806⟩, ⟨(-179844), (-88531)⟩, ⟨(-22335), (-21736)⟩, ⟨63, 133⟩, ⟨6, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3746918, 15102037⟩, ⟨3670843, 7541657⟩, ⟨889243, 932218⟩, ⟨(-9473), (-4581)⟩, ⟨(-585), (-541)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712080965), (-700725845)⟩, ⟨3670843, 7541657⟩, ⟨889243, 932218⟩, ⟨(-9473), (-4581)⟩, ⟨(-585), (-541)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-301213693), (-74102604)⟩, ⟨(-150218651), (-70912446)⟩, ⟨(-18343622), (-16536239)⟩, ⟨187079, 396068⟩, ⟨21257, 24105⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3993753603, 4220864692⟩, ⟨(-150218651), (-70912446)⟩, ⟨(-18343622), (-16536239)⟩, ⟨187079, 396068⟩, ⟨21257, 24105⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨445946150, 921433681⟩, ⟨203389521, 225657567⟩, ⟨(-7303195), (-3470178)⟩, ⟨(-593003), (-522987)⟩, ⟨5437, 11482⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4370370864, 4618898888⟩, ⟨73424217, 173732492⟩, ⟨18355524, 27749635⟩, ⟨162618, 1637007⟩, ⟨31960, 162331⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨453775297, 990929316⟩, ⟨214583911, 279949153⟩, ⟨(-2471133), 11550156⟩, ⟨(-47030), 1217675⟩, ⟨(-54624), 109414⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-889165605), (-444582802)⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3405801691, 3850384494⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨47942628, 228625934⟩, ⟨45342778, 129179016⟩, ⟨9580705, 23576970⟩, ⟨(-343844), 2067578⟩, ⟨(-37984), 240288⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4342909924, 4523593230⟩, ⟨45342778, 129179016⟩, ⟨9580705, 23576970⟩, ⟨(-343844), 2067578⟩, ⟨(-37984), 240288⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4318872085, 4407798202⟩, ⟨22091046, 64232008⟩, ⟨4199722, 11666739⟩, ⟨(-344484), 1006586⟩, ⟨(-49616), 122561⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3424757591, 3951535991⟩, ⟨(-210613460), (-165945430)⟩, ⟨5866, 9315737⟩, ⟨(-912653), 685031⟩, ⟨(-96579), 127705⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨1862514348, 3725028702⟩, ⟨931257174, 931257179⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨807680118, 3230720487⟩, ⟨807680118, 1615360250⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨807680118, 3230720487⟩, ⟨807680118, 1615360250⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3230720487), (-807680118)⟩, ⟨(-1615360250), (-807680118)⟩, ⟨(-201920032), (-201920029)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1615360244), (-403840059)⟩, ⟨(-807680125), (-403840059)⟩, ⟨(-100960016), (-100960014)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2948623865, 3909531713⟩, ⟨(-735197930), (-277248312)⟩, ⟨(-78865420), (-184105)⟩, ⟨4350544, 16464947⟩, ⟨(-771906), 824663⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2351198802, 3596920351⟩, ⟨(-868123278), (-335001133)⟩, ⟨(-61843116), 44385027⟩, ⟨1050798, 19638911⟩, ⟨(-1893814), 863100⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4353205171, 4353205173⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar64 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified64
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar64 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4318872085, 4407798202⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified65
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((8281 / 80000) : ℝ)..(8281 / 40000), prawitzNormalCorrection
      ((37029 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
