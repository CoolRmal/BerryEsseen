...
namespace FiniteNormalPanel144_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1569 / 16000)
def radius : Rat := (523 / 16000)

def j0 : Jet := ⟨⟨421175230, 421175231⟩, ⟨140391743, 140391744⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1323161008, 1323161012⟩, ⟨441053668, 441053672⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨407629425, 407629429⟩, ⟨271752948, 271752954⟩, ⟨45292158, 45292159⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-8977), (-8976)⟩, ⟨(-5979), (-5977)⟩, ⟨(-993), (-990)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104079, 5104081⟩, ⟨(-5979), (-5977)⟩, ⟨(-993), (-990)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨484421, 484422⟩, ⟨322379, 322381⟩, ⟨53350, 53354⟩, ⟨(-127), (-124)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142681156), (-142681154)⟩, ⟨322379, 322381⟩, ⟨53350, 53354⟩, ⟨(-127), (-124)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13541672), (-13541671)⟩, ⟨(-8997186), (-8997184)⟩, ⟨(-1479171), (-1479168)⟩, ⟨6761, 6765⟩, ⟨551, 556⟩⟩
...
def j19 : Jet := ⟨⟨1418114093, 1418114095⟩, ⟨(-8997186), (-8997184)⟩, ⟨(-1479171), (-1479168)⟩, ⟨6761, 6765⟩, ⟨551, 556⟩⟩
...
def j25 : Jet := ⟨⟨1122, 1123⟩, ⟨747, 749⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851055), (-851053)⟩, ⟨747, 749⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-80773), (-80772)⟩, ⟨(-53779), (-53776)⟩, ⟨(-8917), (-8914)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35710621, 35710623⟩, ⟨(-53779), (-53776)⟩, ⟨(-8917), (-8914)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3389245, 3389247⟩, ⟨2254392, 2254395⟩, ⟨372332, 372335⟩, ⟨(-1132), (-1129)⟩, ⟨(-96), (-91)⟩⟩
...
def j33 : Jet := ⟨⟨(-712438638), (-712438635)⟩, ⟨2254392, 2254395⟩, ⟨372332, 372335⟩, ⟨(-1132), (-1129)⟩, ⟨(-96), (-91)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-67616570), (-67616568)⟩, ⟨(-44863753), (-44863750)⟩, ⟨(-7334976), (-7334972)⟩, ⟨47223, 47226⟩, ⟨3844, 3848⟩⟩
...
def j36 : Jet := ⟨⟨4227350726, 4227350728⟩, ⟨(-44863753), (-44863750)⟩, ⟨(-7334976), (-7334972)⟩, ⟨47223, 47226⟩, ⟨3844, 3848⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨436881853, 436881856⟩, ⟨142855499, 142855502⟩, ⟨(-1379621), (-1379618)⟩, ⟨(-149816), (-149811)⟩, ⟨863, 867⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4363665392, 4363665395⟩, ⟨46310420, 46310425⟩, ⟨8062974, 8062981⟩, ⟨117174, 117181⟩, ⟨10741, 10752⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨443869787, 443869792⟩, ⟨149851146, 149851152⟩, ⟨958809, 958816⟩, ⟨113012, 113022⟩, ⟨1659, 1669⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-421175231), (-421175230)⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3873792065, 3873792066⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨45872383, 45872385⟩, ⟨30973178, 30973182⟩, ⟨5426475, 5426480⟩, ⟨90262, 90270⟩, ⟨8440, 8449⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4340839679, 4340839681⟩, ⟨30973178, 30973182⟩, ⟨5426475, 5426480⟩, ⟨90262, 90270⟩, ⟨8440, 8449⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317842569, 4317842571⟩, ⟨15404543, 15404546⟩, ⟨2671384, 2671388⟩, ⟨35360, 35366⟩, ⟨3244, 3251⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3894424131, 3894424135⟩, ⟨(-127245545), (-127245540)⟩, ⟨1905884, 1905891⟩, ⟨(-55429), (-55422)⟩, ⟨1768, 1778⟩⟩
...
def j47 : Jet := ⟨⟨4488422718, 4488422731⟩, ⟨1496140902, 1496140914⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4690591826, 4690591855⟩, ⟨3127061208, 3127061244⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4690591826, 4690591855⟩, ⟨3127061208, 3127061244⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4690591855), (-4690591826)⟩, ⟨(-3127061244), (-3127061208)⟩, ⟨(-521176876), (-521176866)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2345295928), (-2345295913)⟩, ⟨(-1563530622), (-1563530604)⟩, ⟨(-260588438), (-260588433)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2487771125, 2487771146⟩, ⟨(-905642838), (-905642819)⟩, ⟨13903652, 13903663⟩, ⟨34944874, 34944878⟩, ⟨(-3602103), (-3602101)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2255764766, 2255764789⟩, ⟨(-894888101), (-894888077)⟩, ⟨40542130, 40542150⟩, ⟨30840053, 30840067⟩, ⟨(-4282598), (-4282584)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨280783486, 561566974⟩, ⟨140391743, 140391744⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨882107336, 1764214681⟩, ⟨441053668, 441053672⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨181168632, 724674538⟩, ⟨181168632, 362337272⟩, ⟨45292158, 45292159⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-15969), (-3986)⟩, ⟨(-7984), (-3970)⟩, ⟨(-998), (-985)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097087, 5109071⟩, ⟨(-7984), (-3970)⟩, ⟨(-998), (-985)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨215003, 862036⟩, ⟨213655, 430851⟩, ⟨52907, 53670⟩, ⟨(-170), (-81)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142950574), (-142303540)⟩, ⟨213655, 430851⟩, ⟨52907, 53670⟩, ⟨(-170), (-81)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-24119542), (-6002592)⟩, ⟨(-12050759), (-5929896)⟩, ⟨(-1496229), (-1455244)⟩, ⟨4455, 9069⟩, ⟨540, 563⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407536223, 1425653174⟩, ⟨(-12050759), (-5929896)⟩, ⟨(-1496229), (-1455244)⟩, ⟨4455, 9069⟩, ⟨540, 563⟩⟩
...
def j72 : Jet := ⟨⟨498, 1997⟩, ⟨496, 999⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851679), (-850179)⟩, ⟨496, 999⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-143701), (-35861)⟩, ⟨(-71831), (-35692)⟩, ⟨(-8957), (-8858)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35647693, 35755534⟩, ⟨(-71831), (-35692)⟩, ⟨(-8957), (-8858)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1503677, 6032904⟩, ⟨1491557, 3014947⟩, ⟨368347, 375179⟩, ⟨(-1514), (-745)⟩, ⟨(-96), (-90)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714324206), (-709794978)⟩, ⟨1491557, 3014947⟩, ⟨368347, 375179⟩, ⟨(-1514), (-745)⟩, ⟨(-96), (-90)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-120525380), (-29940294)⟩, ⟨(-60199775), (-29431592)⟩, ⟨(-7454384), (-7167419)⟩, ⟨31010, 63415⟩, ⟨3739, 3923⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4174441916, 4265027002⟩, ⟨(-60199775), (-29431592)⟩, ⟨(-7454384), (-7167419)⟩, ⟨31010, 63415⟩, ⟨3739, 3923⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨289082068, 585605917⟩, ⟨139591025, 145183589⟩, ⟨(-1852099), (-907825)⟩, ⟨(-152735), (-145714)⟩, ⟨567, 1164⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4325117769, 4418972511⟩, ⟨29846258, 63726160⟩, ⟨7474359, 8810046⟩, ⟨36030, 208720⟩, ⟨7795, 14649⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨291111410, 602513657⟩, ⟨142579813, 158064232⟩, ⟨(-432462), 2441175⟩, ⟨60723, 173223⟩, ⟨(-3802), 7661⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-561566974), (-280783486)⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3733400322, 4014183810⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19731431, 84522811⟩, ⟨19328020, 44347654⟩, ⟨4611878, 6502025⟩, ⟨(-23602), 228284⟩, ⟨2716, 16288⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314698727, 4379490107⟩, ⟨19328020, 44347654⟩, ⟨4611878, 6502025⟩, ⟨(-23602), 228284⟩, ⟨2716, 16288⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304821706, 4337022802⟩, ⟨9570299, 22123068⟩, ⟨2227153, 3232933⟩, ⟨(-28389), 108931⟩, ⟨(-421), 7697⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3741966267, 4053489938⟩, ⟨(-133447452), (-120037086)⟩, ⟨1212804, 2708752⟩, ⟨(-132211), 29010⟩, ⟨(-3955), 8122⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2992281805, 5984563634⟩, ⟨1496140902, 1496140914⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2084707468, 8338829943⟩, ⟨2084707468, 4169414988⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2084707468, 8338829943⟩, ⟨2084707468, 4169414988⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8338829943), (-2084707468)⟩, ⟨(-4169414988), (-2084707468)⟩, ⟨(-521176876), (-521176866)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4169414972), (-1042353734)⟩, ⟨(-2084707494), (-1042353734)⟩, ⟨(-260588438), (-260588433)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1626900005, 3369458505⟩, ⟨(-1635480532), (-394835438)⟩, ⟨(-156523388), 298209009⟩, ⟨(-32278047), 91477617⟩, ⟨(-20147052), 8665180⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1417427542, 3180016332⟩, ⟨(-1648219660), (-389467277)⟩, ⟨(-136228739), 334383212⟩, ⟨(-40864006), 91108993⟩, ⟨(-21969455), 9425688⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨421175230, 421175231⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317842569, 4317842571⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2904
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨280783486, 561566974⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304821706, 4337022802⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2905
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (148477345 / 4294967296)

theorem envelope_integral : (∫ s in ((523 / 8000) : ℝ)..(523 / 4000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((523 / 8000) : ℝ)..(523 / 4000), prawitzNormalCorrection
