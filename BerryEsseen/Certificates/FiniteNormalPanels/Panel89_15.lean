...
namespace FiniteNormalPanel89_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (31027 / 800000)
def radius : Rat := (31027 / 800000)

def j0 : Jet := ⟨⟨166574937, 166574938⟩, ⟨166574937, 166574938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨523310598, 523310602⟩, ⟨523310598, 523310602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨63761598, 63761600⟩, ⟨127523196, 127523200⟩, ⟨63761598, 63761600⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1406), (-1405)⟩, ⟨(-2811), (-2809)⟩, ⟨(-1406), (-1403)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111650, 5111652⟩, ⟨(-2811), (-2809)⟩, ⟨(-1406), (-1403)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨75885, 75886⟩, ⟨151729, 151731⟩, ⟨75780, 75783⟩, ⟨(-84), (-81)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-143089692), (-143089690)⟩, ⟨151729, 151731⟩, ⟨75780, 75783⟩, ⟨(-84), (-81)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2124261), (-2124260)⟩, ⟨(-4246269), (-4246267)⟩, ⟨(-2118631), (-2118628)⟩, ⟨4500, 4503⟩, ⟨1121, 1124⟩⟩
...
def j19 : Jet := ⟨⟨1429531504, 1429531506⟩, ⟨(-4246269), (-4246267)⟩, ⟨(-2118631), (-2118628)⟩, ⟨4500, 4503⟩, ⟨1121, 1124⟩⟩
...
def j25 : Jet := ⟨⟨175, 176⟩, ⟨350, 352⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852002), (-852000)⟩, ⟨350, 352⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-12649), (-12648)⟩, ⟨(-25293), (-25290)⟩, ⟨(-12637), (-12634)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778745, 35778747⟩, ⟨(-25293), (-25290)⟩, ⟨(-12637), (-12634)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨531158, 531159⟩, ⟨1061941, 1061943⟩, ⟨530219, 530222⟩, ⟨(-752), (-749)⟩, ⟨(-188), (-185)⟩⟩
...
def j33 : Jet := ⟨⟨(-715296725), (-715296723)⟩, ⟨1061941, 1061943⟩, ⟨530219, 530222⟩, ⟨(-752), (-749)⟩, ⟨(-188), (-185)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10619048), (-10619047)⟩, ⟨(-21222331), (-21222329)⟩, ⟨(-10579647), (-10579644)⟩, ⟨31495, 31498⟩, ⟨7845, 7848⟩⟩
...
def j36 : Jet := ⟨⟨4284348248, 4284348249⟩, ⟨(-21222331), (-21222329)⟩, ⟨(-10579647), (-10579644)⟩, ⟨31495, 31498⟩, ⟨7845, 7848⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨174178040, 174178042⟩, ⟨173660662, 173660666⟩, ⟨(-775518), (-775515)⟩, ⟨(-257592), (-257590)⟩, ⟨684, 686⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305612663, 4305612665⟩, ⟨21327660, 21327664⟩, ⟨10737798, 10737804⟩, ⟨74198, 74205⟩, ⟨18837, 18845⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨174609752, 174609755⟩, ⟨174956012, 174956018⟩, ⟨520371, 520377⟩, ⟨175093, 175099⟩, ⟨1229, 1237⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-166574938), (-166574937)⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4128392358, 4128392359⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7098672, 7098673⟩, ⟨14225498, 14225500⟩, ⟨7169164, 7169167⟩, ⟨56630, 56634⟩, ⟨14425, 14432⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302065968, 4302065969⟩, ⟨14225498, 14225500⟩, ⟨7169164, 7169167⟩, ⟨56630, 56634⟩, ⟨14425, 14432⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298515166, 4298515168⟩, ⟨7106878, 7106880⟩, ⟨3575748, 3575751⟩, ⟨22379, 22383⟩, ⟨5681, 5687⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4131802628, 4131802632⟩, ⟨(-159881292), (-159881287)⟩, ⟨3161435, 3161439⟩, ⟨(-117171), (-117165)⟩, ⟨4591, 4600⟩⟩
...
def j47 : Jet := ⟨⟨1251166006, 1251166015⟩, ⟨1251166006, 1251166015⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨364476902, 364476908⟩, ⟨728953804, 728953816⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨364476902, 364476908⟩, ⟨728953804, 728953816⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-364476908), (-364476902)⟩, ⟨(-728953816), (-728953804)⟩, ⟨(-364476908), (-364476902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-182238454), (-182238451)⟩, ⟨(-364476908), (-364476902)⟩, ⟨(-182238454), (-182238451)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4116540986, 4116540990⟩, ⟨(-349335404), (-349335397)⟩, ⟨(-159845159), (-159845153)⟩, ⟨14403256, 14403258⟩, ⟨3085600, 3085601⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3960154686, 3960154694⟩, ⟨(-489303572), (-489303557)⟩, ⟨(-137738483), (-137738472)⟩, ⟨19436914, 19436927⟩, ⟨2328482, 2328498⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 333149876⟩, ⟨166574937, 166574938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1046621204⟩, ⟨523310598, 523310602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 255046400⟩, ⟨0, 255046400⟩, ⟨63761598, 63761600⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5623), 0⟩, ⟨(-5623), 4⟩, ⟨(-1406), (-1399)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107433, 5113057⟩, ⟨(-5623), 4⟩, ⟨(-1406), (-1399)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 303627⟩, ⟨(-334), 303628⟩, ⟨75405, 75908⟩, ⟨(-168), 2⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142861949)⟩, ⟨(-334), 303628⟩, ⟨75405, 75908⟩, ⟨(-168), 2⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8501547), 0⟩, ⟨(-8501567), 18031⟩, ⟨(-2125407), (-2098340)⟩, ⟨(-15), 9017⟩, ⟨1107, 1128⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423154218, 1431655766⟩, ⟨(-8501567), 18031⟩, ⟨(-2125407), (-2098340)⟩, ⟨(-15), 9017⟩, ⟨1107, 1128⟩⟩
...
def j72 : Jet := ⟨⟨0, 703⟩, ⟨(-1), 703⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851473)⟩, ⟨(-1), 703⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-50605), 0⟩, ⟨(-50606), 42⟩, ⟨(-12653), (-12587)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35740789, 35791395⟩, ⟨(-50606), 42⟩, ⟨(-12653), (-12587)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2125387⟩, ⟨(-3006), 2125390⟩, ⟨526837, 531350⟩, ⟨(-1505), 3⟩, ⟨(-189), (-183)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713702495)⟩, ⟨(-3006), 2125390⟩, ⟨526837, 531350⟩, ⟨(-1505), 3⟩, ⟨(-189), (-183)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-42507734), 0⟩, ⟨(-42507913), 126212⟩, ⟨(-10627113), (-10437615)⟩, ⟨(-135), 63107⟩, ⟨7719, 7890⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4252459562, 4294967296⟩, ⟨(-42507913), 126212⟩, ⟨(-10627113), (-10437615)⟩, ⟨(-135), 63107⟩, ⟨7719, 7890⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 348873735⟩, ⟨171329305, 174441262⟩, ⟨(-1553786), 2197⟩, ⟨(-258970), (-253469)⟩, ⟨(-2), 1374⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4337899939⟩, ⟨(-128749), 43361983⟩, ⟨10436340, 11274083⟩, ⟨(-65033), 221201⟩, ⟨16111, 22593⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 352361090⟩, ⟨171318846, 179707212⟩, ⟨(-1574548), 2679155⟩, ⟨133783, 222446⟩, ⟨(-9339), 12223⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-333149876), 0⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3961817420, 4294967296⟩, ⟨(-166574938), (-166574937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 28907866⟩, ⟨0, 29486526⟩, ⟨6575259, 7958792⟩, ⟨(-131764), 260700⟩, ⟨8155, 22294⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4323875162⟩, ⟨0, 29486526⟩, ⟨6575259, 7958792⟩, ⟨(-131764), 260700⟩, ⟨8155, 22294⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309396990⟩, ⟨0, 14743263⟩, ⟨3251401, 3979396⟩, ⟨(-79543), 130350⟩, ⟨1779, 10191⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3961817420, 4309396990⟩, ⟨(-167134576), (-151831674)⟩, ⟨2427397, 3979396⟩, ⟨(-233879), 4249⟩, ⟨(-3415), 13276⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2502332029⟩, ⟨1251166006, 1251166015⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1457907629⟩, ⟨0, 1457907630⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1457907629⟩, ⟨0, 1457907630⟩, ⟨364476902, 364476908⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1457907629), 0⟩, ⟨(-1457907630), 0⟩, ⟨(-364476908), (-364476902)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-728953815), 0⟩, ⟨(-728953815), 0⟩, ⟨(-182238454), (-182238451)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3624517423, 4294967296⟩, ⟨(-728953815), 0⟩, ⟨(-182238454), (-91930759)⟩, ⟨0, 30930019⟩, ⟨637960, 3866253⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3343372667, 4309396990⟩, ⟨(-898537439), (-128130556)⟩, ⟨(-180802239), (-52453977)⟩, ⟨2340576, 38129820⟩, ⟨(-788124), 3880258⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨166574937, 166574938⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298515166, 4298515168⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1806
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 333149876⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309396990⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1807
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (303678153 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(31027 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (31027 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(31027 / 400000), prawitzNormalCorrection
