...
namespace FiniteNormalPanel152_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (29827 / 160000)
def radius : Rat := (29827 / 800000)

def j0 : Jet := ⟨⟨800662434, 800662435⟩, ⟨160132486, 160132487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2515355220, 2515355224⟩, ⟨503071041, 503071045⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1473122249, 1473122254⟩, ⟨589248896, 589248902⟩, ⟨58924889, 58924891⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨368, 370⟩, ⟨147, 148⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94319), (-94316)⟩, ⟨147, 148⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-32351), (-32349)⟩, ⟨(-12891), (-12888)⟩, ⟨(-1271), (-1266)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5080705, 5080708⟩, ⟨(-12891), (-12888)⟩, ⟨(-1271), (-1266)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1742620, 1742622⟩, ⟨692626, 692629⟩, ⟨67499, 67503⟩, ⟨(-351), (-346)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-141422957), (-141422954)⟩, ⟨692626, 692629⟩, ⟨67499, 67503⟩, ⟨(-351), (-346)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-48506378), (-48506376)⟩, ⟨(-19164990), (-19164986)⟩, ⟨(-1822081), (-1822076)⟩, ⟨18641, 18647⟩, ⟨870, 875⟩⟩
...
def j19 : Jet := ⟨⟨1383149387, 1383149390⟩, ⟨(-19164990), (-19164986)⟩, ⟨(-1822081), (-1822076)⟩, ⟨18641, 18647⟩, ⟨870, 875⟩⟩
...
def j25 : Jet := ⟨⟨4046, 4048⟩, ⟨1612, 1615⟩, ⟨157, 161⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848131), (-848128)⟩, ⟨1612, 1615⟩, ⟨157, 161⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-290899), (-290897)⟩, ⟨(-115808), (-115805)⟩, ⟨(-11362), (-11357)⟩, ⟨42, 46⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35500495, 35500498⟩, ⟨(-115808), (-115805)⟩, ⟨(-11362), (-11357)⟩, ⟨42, 46⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12176243, 12176245⟩, ⟨4830776, 4830779⟩, ⟨467262, 467268⟩, ⟨(-3134), (-3130)⟩, ⟨(-151), (-146)⟩⟩
...
def j33 : Jet := ⟨⟨(-703651640), (-703651637)⟩, ⟨4830776, 4830779⟩, ⟨467262, 467268⟩, ⟨(-3134), (-3130)⟩, ⟨(-151), (-146)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-241344071), (-241344068)⟩, ⟨(-94880731), (-94880726)⟩, ⟨(-8830739), (-8830734)⟩, ⟨129306, 129310⟩, ⟨5928, 5932⟩⟩
...
def j36 : Jet := ⟨⟨4053623225, 4053623228⟩, ⟨(-94880731), (-94880726)⟩, ⟨(-8830739), (-8830734)⟩, ⟨129306, 129310⟩, ⟨5928, 5932⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨810043893, 810043897⟩, ⟨150784766, 150784772⟩, ⟨(-3311908), (-3311903)⟩, ⟨(-202504), (-202499)⟩, ⟨2692, 2698⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4550680474, 4550680478⟩, ⟨106515045, 106515054⟩, ⟨12406695, 12406705⟩, ⟨377269, 377279⟩, ⟨25798, 25810⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨858272175, 858272181⟩, ⟨179851229, 179851240⟩, ⟨2570305, 2570315⟩, ⟨210022, 210033⟩, ⟨6371, 6386⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-800662435), (-800662434)⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3494304861, 3494304862⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨171510299, 171510302⟩, ⟨71880084, 71880090⟩, ⟨8558506, 8558514⟩, ⟨299200, 299208⟩, ⟨21672, 21685⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4466477595, 4466477598⟩, ⟨71880084, 71880090⟩, ⟨8558506, 8558514⟩, ⟨299200, 299208⟩, ⟨21672, 21685⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4379883012, 4379883014⟩, ⟨35243248, 35243252⟩, ⟨4054493, 4054499⟩, ⟨114073, 114080⟩, ⟨7830, 7839⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3563390695, 3563390699⟩, ⟨(-134625219), (-134625212)⟩, ⟨1984658, 1984665⟩, ⟨(-58360), (-58352)⟩, ⟨2116, 2125⟩⟩
...
def j47 : Jet := ⟨⟨6005242152, 6005242161⟩, ⟨1201048424, 1201048433⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8396555973, 8396555999⟩, ⟨3358622370, 3358622402⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8396555973, 8396555999⟩, ⟨3358622370, 3358622402⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8396555999), (-8396555973)⟩, ⟨(-3358622402), (-3358622370)⟩, ⟨(-335862241), (-335862235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4198278000), (-4198277986)⟩, ⟨(-1679311201), (-1679311185)⟩, ⟨(-167931121), (-167931117)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1616003571, 1616003583⟩, ⟨(-631849496), (-631849484)⟩, ⟨60340077, 60340084⟩, ⟨8605777, 8605780⟩, ⟨(-2020839), (-2020837)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1340744106, 1340744118⟩, ⟨(-574877825), (-574877809)⟩, ⟨70614122, 70614136⟩, ⟨4934641, 4934651⟩, ⟨(-1909109), (-1909098)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨640529947, 960794922⟩, ⟨160132486, 160132487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2012284175, 3018426269⟩, ⟨503071041, 503071045⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨942798238, 2121296046⟩, ⟨471399116, 707098684⟩, ⟨58924889, 58924891⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨235, 532⟩, ⟨117, 178⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94452), (-94154)⟩, ⟨117, 178⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-46651), (-20667)⟩, ⟨(-15526), (-10245)⟩, ⟨(-1281), (-1253)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5066405, 5092390⟩, ⟨(-15526), (-10245)⟩, ⟨(-1281), (-1253)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1112138, 2515146⟩, ⟨548400, 836134⟩, ⟨66318, 68467⟩, ⟨(-425), (-274)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142053439), (-140650430)⟩, ⟨548400, 836134⟩, ⟨66318, 68467⟩, ⟨(-425), (-274)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-70160581), (-30874502)⟩, ⟨(-23266481), (-15024282)⟩, ⟨(-1874159), (-1758182)⟩, ⟨14591, 22685⟩, ⟨830, 907⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1361495184, 1400781264⟩, ⟨(-23266481), (-15024282)⟩, ⟨(-1874159), (-1758182)⟩, ⟨14591, 22685⟩, ⟨830, 907⟩⟩
...
def j72 : Jet := ⟨⟨2586, 5835⟩, ⟨1284, 1943⟩, ⟨157, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849591), (-846341)⟩, ⟨1284, 1943⟩, ⟨157, 162⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-419616), (-185782)⟩, ⟨(-139591), (-91931)⟩, ⟨(-11482), (-11210)⟩, ⟨33, 54⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35371778, 35605613⟩, ⟨(-139591), (-91931)⟩, ⟨(-11482), (-11210)⟩, ⟨33, 54⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7764541, 17585710⟩, ⟨3813325, 5841725⟩, ⟨456630, 475943⟩, ⟨(-3800), (-2464)⟩, ⟨(-155), (-142)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708063342), (-698242172)⟩, ⟨3813325, 5841725⟩, ⟨456630, 475943⟩, ⟨(-3800), (-2464)⟩, ⟨(-155), (-142)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-349714414), (-153272759)⟩, ⟨(-115734401), (-73751135)⟩, ⟨(-9195520), (-8382729)⟩, ⟨100556, 157963⟩, ⟨5561, 6229⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3945252882, 4141694537⟩, ⟨(-115734401), (-73751135)⟩, ⟨(-9195520), (-8382729)⟩, ⟨100556, 157963⟩, ⟨5561, 6229⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨637889656, 984444042⟩, ⟨143121145, 157034811⟩, ⟨(-4042338), (-2583544)⟩, ⟨(-212685), (-189993)⟩, ⟨2097, 3296⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4453912259, 4675681034⟩, ⟨79310794, 137161587⟩, ⟨10426938, 14921638⟩, ⟨167865, 643903⟩, ⟨11827, 45372⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨661496203, 1071706959⟩, ⟨160196925, 202393299⟩, ⟨(-209176), 5755990⟩, ⟨11755, 448431⟩, ⟨(-11314), 27752⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-960794922), (-640529947)⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3334172374, 3654437349⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨101881387, 267418988⟩, ⟨49345966, 101004872⟩, ⟨5870755, 12409995⟩, ⟨(-16096), 766276⟩, ⟨(-5053), 63829⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4396848683, 4562386284⟩, ⟨49345966, 101004872⟩, ⟨5870755, 12409995⟩, ⟨(-16096), 766276⟩, ⟨(-5053), 63829⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4345609427, 4426657869⟩, ⟨23938975, 49913900⟩, ⟨2566643, 6066750⟩, ⟨(-77638), 364535⟩, ⟨(-10920), 31678⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3373485733, 3766488249⟩, ⟨(-146458640), (-119550623)⟩, ⟨131500, 4269452⟩, ⟨(-292252), 214477⟩, ⟨(-22884), 29849⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4804193720, 7206290594⟩, ⟨1201048424, 1201048433⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5373795819, 12091040641⟩, ⟨2686897896, 4030346884⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5373795819, 12091040641⟩, ⟨2686897896, 4030346884⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12091040641), (-5373795819)⟩, ⟨(-4030346884), (-2686897896)⟩, ⟨(-335862241), (-335862235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6045520321), (-2686897909)⟩, ⟨(-2015173442), (-1343448948)⟩, ⟨(-167931121), (-167931117)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1051125555, 2297569380⟩, ⟨(-1078006066), (-328787956)⟩, ⟨(-38412048), 211798565⟩, ⟨(-24554583), 34107243⟩, ⟨(-8141340), 3631163⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨825607465, 2014862391⟩, ⟨(-1023708859), (-287504911)⟩, ⟨(-24501585), 224781567⟩, ⟨(-29983522), 31325002⟩, ⟨(-8406899), 4321539⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨800662434, 800662435⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4379883012, 4379883014⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3060
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨640529947, 960794922⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4345609427, 4426657869⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3061
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (12724445 / 536870912)

theorem envelope_integral : (∫ s in ((29827 / 200000) : ℝ)..(89481 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((29827 / 200000) : ℝ)..(89481 / 400000), prawitzNormalCorrection
