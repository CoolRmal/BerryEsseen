...
namespace FiniteNormalPanel21_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (302449 / 800000)
def radius : Rat := (43207 / 800000)

def j0 : Jet := ⟨⟨1623760704, 1623760705⟩, ⟨231965814, 231965815⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5101194698, 5101194703⟩, ⟨728742097, 728742101⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨6058762629, 6058762642⟩, ⟨1731075030, 1731075042⟩, ⟨123648216, 123648218⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1516, 1518⟩, ⟨433, 434⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93171), (-93168)⟩, ⟨433, 434⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-131434), (-131428)⟩, ⟨(-36943), (-36938)⟩, ⟨(-2467), (-2463)⟩, ⟨24, 26⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4981622, 4981629⟩, ⟨(-36943), (-36938)⟩, ⟨(-2467), (-2463)⟩, ⟨24, 26⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨7027402, 7027413⟩, ⟨1955714, 1955726⟩, ⟨125045, 125056⟩, ⟨(-2026), (-2018)⟩, ⟨(-63), (-57)⟩⟩
...
def j16 : Jet := ⟨⟨(-136138175), (-136138163)⟩, ⟨1955714, 1955726⟩, ⟨125045, 125056⟩, ⟨(-2026), (-2018)⟩, ⟨(-63), (-57)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-192045442), (-192045423)⟩, ⟨(-52111269), (-52111244)⟩, ⟨(-2954654), (-2954630)⟩, ⟨103843, 103862⟩, ⟨2693, 2708⟩⟩
...
def j19 : Jet := ⟨⟨1239610323, 1239610343⟩, ⟨(-52111269), (-52111244)⟩, ⟨(-2954654), (-2954630)⟩, ⟨103843, 103862⟩, ⟨2693, 2708⟩⟩
...
def j22 : Jet := ⟨⟨(-153), (-150)⟩, ⟨(-44), (-43)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11682, 11686⟩, ⟨(-44), (-43)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨16479, 16486⟩, ⟨4645, 4651⟩, ⟨312, 316⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-835698), (-835690)⟩, ⟨4645, 4651⟩, ⟨312, 316⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1178891), (-1178879)⟩, ⟨(-330274), (-330260)⟩, ⟨(-21747), (-21737)⟩, ⟨252, 260⟩, ⟨4, 10⟩⟩
...
def j30 : Jet := ⟨⟨34612503, 34612516⟩, ⟨(-330274), (-330260)⟩, ⟨(-21747), (-21737)⟩, ⟨252, 260⟩, ⟨4, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨48826667, 48826686⟩, ⟨13484569, 13484596⟩, ⟨832667, 832690⟩, ⟨(-17920), (-17901)⟩, ⟨(-521), (-505)⟩⟩
...
def j33 : Jet := ⟨⟨(-667001216), (-667001196)⟩, ⟨13484569, 13484596⟩, ⟨832667, 832690⟩, ⟨(-17920), (-17901)⟩, ⟨(-521), (-505)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-940915675), (-940915644)⟩, ⟨(-249810834), (-249810784)⟩, ⟨(-12592828), (-12592780)⟩, ⟨698532, 698572⟩, ⟨16013, 16047⟩⟩
...
def j36 : Jet := ⟨⟨3354051621, 3354051652⟩, ⟨(-249810834), (-249810784)⟩, ⟨(-12592828), (-12592780)⟩, ⟨698532, 698572⟩, ⟨16013, 16047⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1472303086, 1472303112⟩, ⟨148435704, 148435740⟩, ⟨(-12351188), (-12351152)⟩, ⟨(-377992), (-377963)⟩, ⟨20817, 20840⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5499838997, 5499839048⟩, ⟨409629675, 409629767⟩, ⟨51158474, 51158570⟩, ⟨4202760, 4202844⟩, ⟨393464, 393537⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1885329822, 1885329873⟩, ⟨330496464, 330496548⟩, ⟨15877862, 15877951⟩, ⟨1546732, 1546810⟩, ⟨123612, 123679⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1623760705), (-1623760704)⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2671206591, 2671206592⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨827589197, 827589243⟩, ⟨290151144, 290151228⟩, ⟨39371177, 39371273⟩, ⟨3801506, 3801592⟩, ⟨405260, 405335⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5122556493, 5122556539⟩, ⟨290151144, 290151228⟩, ⟨39371177, 39371273⟩, ⟨3801506, 3801592⟩, ⟨405260, 405335⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4690545022, 4690545044⟩, ⟨132840604, 132840644⟩, ⟨16144315, 16144362⟩, ⟨1283229, 1283271⟩, ⟨121413, 121451⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2917231707, 2917231723⟩, ⟨(-170711756), (-170711727)⟩, ⟨2866217, 2866251⟩, ⟨(-73848), (-73818)⟩, ⟨6203, 6231⟩⟩
...
def j47 : Jet := ⟨⟨6477433937, 6477433944⟩, ⟨925347701, 925347707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9768910335, 9768910357⟩, ⟨2791117224, 2791117248⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9768910335, 9768910357⟩, ⟨2791117224, 2791117248⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9768910357), (-9768910335)⟩, ⟨(-2791117248), (-2791117224)⟩, ⟨(-199365518), (-199365515)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4884455179), (-4884455167)⟩, ⟨(-1395558624), (-1395558612)⟩, ⟨(-99682759), (-99682757)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1377393703, 1377393722⟩, ⟨(-447554907), (-447554896)⟩, ⟨40743531, 40743536⟩, ⟨2512011, 2512013⟩, ⟨(-676869), (-676868)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨935554640, 935554659⟩, ⟨(-358735835), (-358735814)⟩, ⟨46381982, 46382002⟩, ⟨(-235582), (-235562)⟩, ⟨(-522719), (-522700)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1391794889, 1855726520⟩, ⟨231965814, 231965815⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4372452598, 5829936803⟩, ⟨728742097, 728742101⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4451335808, 7913485898⟩, ⟨1483778596, 1978371478⟩, ⟨123648216, 123648218⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1114, 1983⟩, ⟨371, 496⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93573), (-92703)⟩, ⟨371, 496⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-172409), (-96078)⟩, ⟨(-42719), (-31112)⟩, ⟨(-2535), (-2381)⟩, ⟨20, 30⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4940647, 5016979⟩, ⟨(-42719), (-31112)⟩, ⟨(-2535), (-2381)⟩, ⟨20, 30⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨5120523, 9243794⟩, ⟨1628130, 2278705⟩, ⟨117887, 131220⟩, ⟨(-2378), (-1661)⟩, ⟨(-67), (-52)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138045054), (-133921782)⟩, ⟨1628130, 2278705⟩, ⟨117887, 131220⟩, ⟨(-2378), (-1661)⟩, ⟨(-67), (-52)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-254348291), (-138797523)⟩, ⟨(-61899668), (-42067321)⟩, ⟨(-3289547), (-2564082)⟩, ⟨83216, 124325⟩, ⟨2173, 3152⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1177307474, 1292858243⟩, ⟨(-61899668), (-42067321)⟩, ⟨(-3289547), (-2564082)⟩, ⟨83216, 124325⟩, ⟨2173, 3152⟩⟩
...
def j72 : Jet := ⟨⟨12059, 21606⟩, ⟨3926, 5365⟩, ⟨302, 323⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-840118), (-830570)⟩, ⟨3926, 5365⟩, ⟨302, 323⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1547920), (-860808)⟩, ⟨(-382912), (-277050)⟩, ⟨(-22519), (-20843)⟩, ⟨209, 302⟩, ⟨4, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34243474, 34930587⟩, ⟨(-382912), (-277050)⟩, ⟨(-22519), (-20843)⟩, ⟨209, 302⟩, ⟨4, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨35490189, 64359677⟩, ⟨11124546, 15802784⟩, ⟨767966, 888307⟩, ⟨(-21181), (-14619)⟩, ⟨(-573), (-441)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-680337694), (-651468205)⟩, ⟨11124546, 15802784⟩, ⟨767966, 888307⟩, ⟨(-21181), (-14619)⟩, ⟨(-573), (-441)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1253523573), (-675186456)⟩, ⟨(-301851333), (-195945489)⟩, ⟨(-14947194), (-9839305)⟩, ⟨546546, 848974⟩, ⟨11296, 20067⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3041443723, 3619780840⟩, ⟨(-301851333), (-195945489)⟩, ⟨(-14947194), (-9839305)⟩, ⟨546546, 848974⟩, ⟨11296, 20067⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1198547222, 1754910185⟩, ⟨115736006, 176537519⟩, ⟨(-14967925), (-9748049)⟩, ⟨(-473432), (-266298)⟩, ⟨16331, 25374⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5096094180, 6065127537⟩, ⟨275861083, 601940066⟩, ⟨28785099, 89547294⟩, ⟨885537, 10929692⟩, ⟨(-57869), 1456313⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1422108505, 2478192116⟩, ⟨214305268, 495247851⟩, ⟨(-5670595), 49764172⟩, ⟨(-1743529), 7204457⟩, ⟨(-358831), 997689⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1855726520), (-1391794889)⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2439240776, 2903172407⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨470874970, 1429914535⟩, ⟨141917422, 571515096⟩, ⟨4149296, 114534235⟩, ⟨(-3319770), 19790432⟩, ⟨(-881886), 3389407⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4765842266, 5724881831⟩, ⟨141917422, 571515096⟩, ⟨4149296, 114534235⟩, ⟨(-3319770), 19790432⟩, ⟨(-881886), 3389407⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4524283000, 4958647017⟩, ⟨61461390, 271273774⟩, ⟨(-6163228), 53947034⟩, ⟨(-4810391), 9763217⟩, ⟨(-1325622), 1933981⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2569476043, 3351785056⟩, ⟨(-232904561), (-60984038)⟩, ⟨(-18817177), 33145911⟩, ⟨(-6165184), 6932292⟩, ⟨(-1423351), 1567074⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5552086231, 7402781650⟩, ⟨925347701, 925347707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7177158611, 12759393118⟩, ⟨2392386192, 3189848284⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7177158611, 12759393118⟩, ⟨2392386192, 3189848284⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12759393118), (-7177158611)⟩, ⟨(-3189848284), (-2392386192)⟩, ⟨(-199365518), (-199365515)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6379696559), (-3588579305)⟩, ⟨(-1594924142), (-1196193096)⟩, ⟨(-99682759), (-99682757)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨972441929, 1862487040⟩, ⟨(-691629375), (-270835198)⟩, ⟨(-5511626), 105847722⟩, ⟨(-8911507), 11383686⟩, ⟨(-2285146), 891277⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨581766068, 1453481668⟩, ⟨(-640744049), (-175835561)⟩, ⟨(-8615645), 134482115⟩, ⟨(-20705430), 15219016⟩, ⟨(-4597926), 3668017⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1623760704, 1623760705⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4690545022, 4690545044⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified420
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1391794889, 1855726520⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4524283000, 4958647017⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified421
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (102805541 / 4294967296)

theorem envelope_integral : (∫ s in ((129621 / 400000) : ℝ)..(43207 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (129621 / 400000) := by norm_num [center, radius]
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((129621 / 400000) : ℝ)..(43207 / 100000), prawitzNormalCorrection
