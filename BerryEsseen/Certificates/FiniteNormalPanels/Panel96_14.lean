...
namespace FiniteNormalPanel96_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (22113 / 200000)
def radius : Rat := (7371 / 200000)

def j0 : Jet := ⟨⟨474873059, 474873060⟩, ⟨158291019, 158291020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1491857713, 1491857717⟩, ⟨497285902, 497285906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨518197062, 518197066⟩, ⟨345464706, 345464712⟩, ⟨57577450, 57577452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨129, 130⟩, ⟨86, 87⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94558), (-94556)⟩, ⟨86, 87⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11409), (-11408)⟩, ⟨(-7596), (-7594)⟩, ⟨(-1261), (-1258)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101647, 5101649⟩, ⟨(-7596), (-7594)⟩, ⟨(-1261), (-1258)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨615524, 615525⟩, ⟨409432, 409434⟩, ⟨67627, 67631⟩, ⟨(-204), (-201)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-142550053), (-142550051)⟩, ⟨409432, 409434⟩, ⟨67627, 67631⟩, ⟨(-204), (-201)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17198972), (-17198970)⟩, ⟨(-11416583), (-11416580)⟩, ⟨(-1869906), (-1869903)⟩, ⟨10902, 10905⟩, ⟨886, 890⟩⟩
...
def j19 : Jet := ⟨⟨1414456793, 1414456796⟩, ⟨(-11416583), (-11416580)⟩, ⟨(-1869906), (-1869903)⟩, ⟨10902, 10905⟩, ⟨886, 890⟩⟩
...
def j22 : Jet := ⟨⟨(-14), (-12)⟩, ⟨(-9), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11821, 11824⟩, ⟨(-9), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1426, 1427⟩, ⟨948, 952⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850751), (-850749)⟩, ⟨948, 952⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-102645), (-102644)⟩, ⟨(-68316), (-68314)⟩, ⟨(-11311), (-11307)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35688749, 35688751⟩, ⟨(-68316), (-68314)⟩, ⟨(-11311), (-11307)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4305924, 4305925⟩, ⟨2862373, 2862375⟩, ⟨471576, 471579⟩, ⟨(-1824), (-1820)⟩, ⟨(-151), (-147)⟩⟩
...
def j33 : Jet := ⟨⟨(-711521959), (-711521957)⟩, ⟨2862373, 2862375⟩, ⟨471576, 471579⟩, ⟨(-1824), (-1820)⟩, ⟨(-151), (-147)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-85846659), (-85846657)⟩, ⟨(-56885756), (-56885752)⟩, ⟨(-9251388), (-9251384)⟩, ⟨76082, 76086⟩, ⟨6155, 6159⟩⟩
...
def j36 : Jet := ⟨⟨4209120637, 4209120639⟩, ⟨(-56885756), (-56885752)⟩, ⟨(-9251388), (-9251384)⟩, ⟨76082, 76086⟩, ⟨6155, 6159⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨491311837, 491311841⟩, ⟨159805058, 159805063⟩, ⟨(-1971364), (-1971361)⟩, ⟨(-212719), (-212715)⟩, ⟨1569, 1573⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4382564829, 4382564832⟩, ⟨59229828, 59229835⟩, ⟨10433086, 10433093⟩, ⟨191962, 191971⟩, ⟨18039, 18048⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨501332333, 501332338⟩, ⟨169839789, 169839797⟩, ⟨1385689, 1385697⟩, ⟨165903, 165912⟩, ⟨3083, 3093⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-474873060), (-474873059)⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3820094236, 3820094237⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨58518282, 58518284⟩, ⟨39649278, 39649282⟩, ⟨7039618, 7039624⟩, ⟨148320, 148326⟩, ⟨14285, 14294⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4353485578, 4353485580⟩, ⟨39649278, 39649282⟩, ⟨7039618, 7039624⟩, ⟨148320, 148326⟩, ⟨14285, 14294⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4324127447, 4324127449⟩, ⟨19690949, 19690952⟩, ⟨3451238, 3451243⟩, ⟨57943, 57948⟩, ⟨5452, 5459⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3846030294, 3846030298⟩, ⟨(-141851899), (-141851894)⟩, ⟨2343940, 2343948⟩, ⟨(-75660), (-75654)⟩, ⟨2713, 2721⟩⟩
...
def j47 : Jet := ⟨⟨4130852658, 4130852669⟩, ⟨1376950880, 1376950890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3973008990, 3973009012⟩, ⟨2648672648, 2648672676⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3973008990, 3973009012⟩, ⟨2648672648, 2648672676⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3973009012), (-3973008990)⟩, ⟨(-2648672676), (-2648672648)⟩, ⟨(-441445446), (-441445439)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1986504506), (-1986504495)⟩, ⟨(-1324336338), (-1324336324)⟩, ⟨(-220722723), (-220722719)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2704520999, 2704521013⟩, ⟨(-833928459), (-833928444)⟩, ⟨(-10418794), (-10418786)⟩, ⟨29641815, 29641818⟩, ⟨(-2017269), (-2017268)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2421827449, 2421827465⟩, ⟨(-836084495), (-836084476)⟩, ⟨19688755, 19688773⟩, ⟨26384818, 26384830⟩, ⟨(-2774696), (-2774684)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨316582039, 633164079⟩, ⟨158291019, 158291020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨994571807, 1989143620⟩, ⟨497285902, 497285906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨230309804, 921239225⟩, ⟨230309804, 460619614⟩, ⟨57577450, 57577452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨57, 231⟩, ⟨57, 116⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94630), (-94455)⟩, ⟨57, 116⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-20298), (-5064)⟩, ⟨(-10146), (-5039)⟩, ⟨(-1266), (-1249)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092758, 5107993⟩, ⟨(-10146), (-5039)⟩, ⟨(-1266), (-1249)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨273089, 1095628⟩, ⟨270912, 547544⟩, ⟨66911, 68141⟩, ⟨(-273), (-132)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142892488), (-142069948)⟩, ⟨270912, 547544⟩, ⟨66911, 68141⟩, ⟨(-273), (-132)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-30649399), (-7618242)⟩, ⟨(-15310173), (-7500797)⟩, ⟨(-1897474), (-1831221)⟩, ⟨7159, 14642⟩, ⟨862, 907⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1401006366, 1424037524⟩, ⟨(-15310173), (-7500797)⟩, ⟨(-1897474), (-1831221)⟩, ⟨7159, 14642⟩, ⟨862, 907⟩⟩
...
def j72 : Jet := ⟨⟨633, 2538⟩, ⟨630, 1269⟩, ⟨155, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851544), (-849638)⟩, ⟨630, 1269⟩, ⟨155, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-182650), (-45560)⟩, ⟨(-91292), (-45287)⟩, ⟨(-11375), (-11218)⟩, ⟨15, 36⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35608744, 35745835⟩, ⟨(-91292), (-45287)⟩, ⟨(-11375), (-11218)⟩, ⟨15, 36⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1909454, 7667222⟩, ⟨1889872, 3831183⟩, ⟨465132, 476173⟩, ⟨(-2444), (-1200)⟩, ⟨(-153), (-145)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713918429), (-708160660)⟩, ⟨1889872, 3831183⟩, ⟨465132, 476173⟩, ⟨(-2444), (-1200)⟩, ⟨(-153), (-145)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-153130307), (-37973826)⟩, ⟨(-76463814), (-37152065)⟩, ⟨(-9444364), (-8980439)⟩, ⟨49751, 102365⟩, ⟨5939, 6313⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4141836989, 4256993470⟩, ⟨(-76463814), (-37152065)⟩, ⟨(-9444364), (-8980439)⟩, ⟨49751, 102365⟩, ⟨5939, 6313⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨324426552, 659519610⟩, ⟨155122619, 163142968⟩, ⟨(-2651448), (-1292516)⟩, ⟨(-218039), (-205242)⟩, ⟨1027, 2117⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4333279861, 4453759075⟩, ⟨37817839, 82222311⟩, ⟨9471417, 11673555⟩, ⟨55342, 350947⟩, ⟨11879, 26432⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨327320546, 683903101⟩, ⟨159362990, 181800385⟩, ⟨(-668162), 3611693⟩, ⟨69402, 278856⟩, ⟨(-7451), 14929⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-633164079), (-316582039)⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3661803217, 3978385257⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨24945181, 108900353⟩, ⟨24290186, 57897460⟩, ⟨5700310, 8845581⟩, ⟨(-45988), 394566⟩, ⟨2214, 31402⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4319912477, 4403867649⟩, ⟨24290186, 57897460⟩, ⟨5700310, 8845581⟩, ⟨(-45988), 394566⟩, ⟨2214, 31402⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307421828, 4349076630⟩, ⟨11993988, 28865028⟩, ⟨2718904, 4393304⟩, ⟨(-52369), 189143⟩, ⟨(-2406), 15149⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3672421701, 4028506192⟩, ⟨(-150059386), (-132012643)⟩, ⟨1254262, 3627436⟩, ⟨(-210425), 74997⟩, ⟨(-9200), 15964⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2753901769, 5507803550⟩, ⟨1376950880, 1376950890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1765781769, 7063127111⟩, ⟨1765781764, 3531563562⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1765781769, 7063127111⟩, ⟨1765781764, 3531563562⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7063127111), (-1765781769)⟩, ⟨(-3531563562), (-1765781764)⟩, ⟨(-441445446), (-441445439)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3531563556), (-882890884)⟩, ⟨(-1765781781), (-882890882)⟩, ⟨(-220722723), (-220722719)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1887376413, 3496910584⟩, ⟨(-1437678235), (-387976743)⟩, ⟨(-139832745), 198540782⟩, ⟨(-13916221), 68418886⟩, ⟨(-12133839), 5023411⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1613805558, 3279961167⟩, ⟨(-1470660775), (-389751921)⟩, ⟨(-118681227), 239406877⟩, ⟨(-21375115), 69007455⟩, ⟨(-13922197), 5449088⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨474873059, 474873060⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4324127447, 4324127449⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1940
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨316582039, 633164079⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307421828, 4349076630⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1941
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (179076987 / 4294967296)

theorem envelope_integral : (∫ s in ((7371 / 100000) : ℝ)..(7371 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (7371 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (7371 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((7371 / 100000) : ℝ)..(7371 / 50000), prawitzNormalCorrection
