...
namespace FiniteNormalPanel158_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (4761 / 50000)
def radius : Rat := (1587 / 50000)

def j0 : Jet := ⟨⟨408966785, 408966786⟩, ⟨136322261, 136322262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1284807047, 1284807051⟩, ⟨428269013, 428269017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨384340330, 384340333⟩, ⟨256226884, 256226890⟩, ⟨42704480, 42704482⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-8465), (-8464)⟩, ⟨(-5639), (-5636)⟩, ⟨(-938), (-935)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104591, 5104593⟩, ⟨(-5639), (-5636)⟩, ⟨(-938), (-935)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨456790, 456791⟩, ⟨304021, 304024⟩, ⟨50333, 50336⟩, ⟨(-113), (-110)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142708787), (-142708785)⟩, ⟨304021, 304024⟩, ⟨50333, 50336⟩, ⟨(-113), (-110)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12770469), (-12770467)⟩, ⟨(-8486441), (-8486439)⟩, ⟨(-1396300), (-1396297)⟩, ⟨6013, 6017⟩, ⟨492, 495⟩⟩
...
def j19 : Jet := ⟨⟨1418885296, 1418885299⟩, ⟨(-8486441), (-8486439)⟩, ⟨(-1396300), (-1396297)⟩, ⟨6013, 6017⟩, ⟨492, 495⟩⟩
...
def j25 : Jet := ⟨⟨1058, 1059⟩, ⟨704, 706⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851119), (-851117)⟩, ⟨704, 706⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-76164), (-76163)⟩, ⟨(-50714), (-50711)⟩, ⟨(-8412), (-8408)⟩, ⟨11, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35715230, 35715232⟩, ⟨(-50714), (-50711)⟩, ⟨(-8412), (-8408)⟩, ⟨11, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3196020, 3196021⟩, ⟨2126141, 2126144⟩, ⟨351334, 351337⟩, ⟨(-1007), (-1003)⟩, ⟨(-85), (-81)⟩⟩
...
def j33 : Jet := ⟨⟨(-712631863), (-712631861)⟩, ⟨2126141, 2126144⟩, ⟨351334, 351337⟩, ⟨(-1007), (-1003)⟩, ⟨(-85), (-81)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-63770723), (-63770721)⟩, ⟨(-42323556), (-42323553)⟩, ⟨(-6927357), (-6927354)⟩, ⟨42008, 42012⟩, ⟨3424, 3428⟩⟩
...
def j36 : Jet := ⟨⟨4231196573, 4231196575⟩, ⟨(-42323556), (-42323553)⟩, ⟨(-6927357), (-6927354)⟩, ⟨42008, 42012⟩, ⟨3424, 3428⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨424448826, 424448829⟩, ⟨138944286, 138944289⟩, ⟨(-1263912), (-1263909)⟩, ⟨(-137433), (-137430)⟩, ⟨746, 749⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4359699141, 4359699144⟩, ⟨43608929, 43608934⟩, ⟨7573947, 7573954⟩, ⟨103867, 103875⟩, ⟨9472, 9481⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨430845930, 430845935⟩, ⟨145348031, 145348036⟩, ⟨876300, 876307⟩, ⟨102945, 102954⟩, ⟨1428, 1436⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-408966786), (-408966785)⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3886000510, 3886000511⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨43219936, 43219938⟩, ⟨29160924, 29160926⟩, ⟨5094601, 5094605⟩, ⟨79962, 79968⟩, ⟨7430, 7439⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4338187232, 4338187234⟩, ⟨29160924, 29160926⟩, ⟨5094601, 5094605⟩, ⟨79962, 79968⟩, ⟨7430, 7439⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316523170, 4316523172⟩, ⟨14507650, 14507652⟩, ⟨2510199, 2510203⟩, ⟨31343, 31348⟩, ⟨2860, 2867⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3905503833, 3905503837⟩, ⟨(-123880215), (-123880210)⟩, ⟨1810704, 1810710⟩, ⟨(-51316), (-51309)⟩, ⟨1592, 1601⟩⟩
...
def j47 : Jet := ⟨⟨4643865019, 4643865032⟩, ⟨1547954998, 1547955011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5021105128, 5021105157⟩, ⟨3347403400, 3347403440⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5021105128, 5021105157⟩, ⟨3347403400, 3347403440⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5021105157), (-5021105128)⟩, ⟨(-3347403440), (-3347403400)⟩, ⟨(-557900574), (-557900563)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2510552579), (-2510552564)⟩, ⟨(-1673701720), (-1673701700)⟩, ⟨(-278950287), (-278950281)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2393867754, 2393867773⟩, ⟨(-932864056), (-932864036)⟩, ⟨26286104, 26286116⟩, ⟨36977406, 36977410⟩, ⟨(-4456041), (-4456039)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2176794151, 2176794171⟩, ⟨(-917319443), (-917319419)⟩, ⟨51818428, 51818446⟩, ⟨32444268, 32444283⟩, ⟨(-5095404), (-5095391)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨272644523, 545289048⟩, ⟨136322261, 136322262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨856538030, 1713076068⟩, ⟨428269013, 428269017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨170817923, 683271703⟩, ⟨170817922, 341635852⟩, ⟨42704480, 42704482⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-15057), (-3758)⟩, ⟨(-7528), (-3744)⟩, ⟨(-941), (-930)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097999, 5109299⟩, ⟨(-7528), (-3744)⟩, ⟨(-941), (-930)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨202755, 812821⟩, ⟨201557, 406263⟩, ⟨49939, 50618⟩, ⟨(-150), (-72)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142962822), (-142352755)⟩, ⟨201557, 406263⟩, ⟨49939, 50618⟩, ⟨(-150), (-72)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-22743468), (-5661603)⟩, ⟨(-11363718), (-5596972)⟩, ⟨(-1411465), (-1375031)⟩, ⟨3966, 8065⟩, ⟨482, 502⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408912297, 1425994163⟩, ⟨(-11363718), (-5596972)⟩, ⟨(-1411465), (-1375031)⟩, ⟨3966, 8065⟩, ⟨482, 502⟩⟩
...
def j72 : Jet := ⟨⟨469, 1883⟩, ⟨467, 942⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851708), (-850293)⟩, ⟨467, 942⟩, ⟨115, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-135496), (-33817)⟩, ⟨(-67730), (-33667)⟩, ⟨(-8447), (-8360)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35655898, 35757578⟩, ⟨(-67730), (-33667)⟩, ⟨(-8447), (-8360)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1418093, 5688552⟩, ⟨1407318, 2842938⟩, ⟨347791, 353865⟩, ⟨(-1346), (-662)⟩, ⟨(-85), (-80)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714409790), (-710139330)⟩, ⟨1407318, 2842938⟩, ⟨347791, 353865⟩, ⟨(-1346), (-662)⟩, ⟨(-85), (-80)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-113653018), (-28243410)⟩, ⟨(-56770538), (-27791136)⟩, ⟨(-7033511), (-6778419)⟩, ⟨27609, 56390⟩, ⟨3336, 3490⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4181314278, 4266723886⟩, ⟨(-56770538), (-27791136)⟩, ⟨(-7033511), (-6778419)⟩, ⟨27609, 56390⟩, ⟨3336, 3490⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨280976985, 568767189⟩, ⟨135955998, 141075604⟩, ⟨(-1696097), (-832317)⟩, ⟨(-139954), (-133893)⟩, ⟨491, 1006⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4323397662, 4411709537⟩, ⟨28160278, 59898661⟩, ⟨7051874, 8234323⟩, ⟨32362, 184012⟩, ⟨7012, 12716⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨282836901, 584226948⟩, ⟨138698199, 152842371⟩, ⟨(-389461), 2220092⟩, ⟨57928, 154604⟩, ⟨(-3228), 6520⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-545289048), (-272644523)⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3749678248, 4022322773⟩, ⟨(-136322262), (-136322261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨18625686, 79470018⟩, ⟨18267412, 41581054⟩, ⟨4373053, 6043090⟩, ⟨(-20092), 200074⟩, ⟨2658, 13926⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4313592982, 4374437314⟩, ⟨18267412, 41581054⟩, ⟨4373053, 6043090⟩, ⟨(-20092), 200074⟩, ⟨2658, 13926⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304270064, 4334520182⟩, ⟨9050360, 20745593⟩, ⟨2116928, 3005501⟩, ⟨(-24511), 95371⟩, ⟨(-184), 6547⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3757799936, 4059364842⟩, ⟨(-129676345), (-117188867)⟩, ⟨1189696, 2527454⟩, ⟨(-118351), 22126⟩, ⟨(-3201), 6910⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3095910009, 6191820043⟩, ⟨1547954998, 1547955011⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2231602273, 8926409168⟩, ⟨2231602264, 4463204586⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2231602273, 8926409168⟩, ⟨2231602264, 4463204586⟩, ⟨557900563, 557900574⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8926409168), (-2231602273)⟩, ⟨(-4463204586), (-2231602264)⟩, ⟨(-557900574), (-557900563)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4463204584), (-1115801136)⟩, ⟨(-2231602293), (-1115801132)⟩, ⟨(-278950287), (-278950281)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1519335609, 3312327933⟩, ⟨(-1721037229), (-394712293)⟩, ⟨(-163857969), 348434835⟩, ⟨(-43256657), 102898221⟩, ⟨(-24681207), 10940021⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1329313790, 3130628625⟩, ⟨(-1726636804), (-386801326)⟩, ⟨(-143678824), 383233116⟩, ⟨(-52508007), 102108724⟩, ⟨(-26541838), 11903733⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨408966785, 408966786⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316523170, 4316523172⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3198
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨272644523, 545289048⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304270064, 4334520182⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3199
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (139430503 / 4294967296)

theorem envelope_integral : (∫ s in ((1587 / 25000) : ℝ)..(1587 / 12500),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((1587 / 25000) : ℝ)..(1587 / 12500), prawitzNormalCorrection
