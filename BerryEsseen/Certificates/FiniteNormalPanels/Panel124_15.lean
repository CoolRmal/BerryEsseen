...
namespace FiniteNormalPanel124_15
...
def j2 : Jet := ⟨⟨1402500071, 1402500075⟩, ⟨467500022, 467500026⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨457979377, 457979381⟩, ⟨305319582, 305319588⟩, ⟨50886597, 50886599⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨114, 115⟩, ⟨76, 77⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94573), (-94571)⟩, ⟨76, 77⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10085), (-10084)⟩, ⟨(-6715), (-6713)⟩, ⟨(-1115), (-1112)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102971, 5102973⟩, ⟨(-6715), (-6713)⟩, ⟨(-1115), (-1112)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨544138, 544139⟩, ⟨362041, 362044⟩, ⟨59862, 59865⟩, ⟨(-160), (-157)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-142621439), (-142621437)⟩, ⟨362041, 362044⟩, ⟨59862, 59865⟩, ⟨(-160), (-157)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15207958), (-15207956)⟩, ⟨(-10100034), (-10100031)⟩, ⟨(-1657655), (-1657651)⟩, ⟨8526, 8530⟩, ⟨695, 698⟩⟩
...
def j19 : Jet := ⟨⟨1416447807, 1416447810⟩, ⟨(-10100034), (-10100031)⟩, ⟨(-1657655), (-1657651)⟩, ⟨8526, 8530⟩, ⟨695, 698⟩⟩
...
def j25 : Jet := ⟨⟨1260, 1261⟩, ⟨839, 841⟩, ⟨138, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850917), (-850915)⟩, ⟨839, 841⟩, ⟨138, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-90735), (-90734)⟩, ⟨(-60401), (-60399)⟩, ⟨(-10009), (-10005)⟩, ⟨17, 21⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35700659, 35700661⟩, ⟨(-60401), (-60399)⟩, ⟨(-10009), (-10005)⟩, ⟨17, 21⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3806819, 3806820⟩, ⟨2531438, 2531440⟩, ⟨417617, 417621⟩, ⟨(-1427), (-1423)⟩, ⟨(-119), (-115)⟩⟩
...
def j33 : Jet := ⟨⟨(-712021064), (-712021062)⟩, ⟨2531438, 2531440⟩, ⟨417617, 417621⟩, ⟨(-1427), (-1423)⟩, ⟨(-119), (-115)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-75923970), (-75923968)⟩, ⟨(-50346049), (-50346046)⟩, ⟨(-8211512), (-8211509)⟩, ⟨59526, 59530⟩, ⟨4832, 4835⟩⟩
...
def j36 : Jet := ⟨⟨4219043326, 4219043328⟩, ⟨(-50346049), (-50346046)⟩, ⟨(-8211512), (-8211509)⟩, ⟨59526, 59530⟩, ⟨4832, 4835⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨462533941, 462533944⟩, ⟨150879863, 150879868⟩, ⟨(-1640671), (-1640668)⟩, ⟨(-177649), (-177646)⟩, ⟨1154, 1157⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4372257556, 4372257559⟩, ⟨52174358, 52174363⟩, ⟨9132307, 9132313⟩, ⟨148828, 148837⟩, ⟨13799, 13809⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨470857489, 470857493⟩, ⟨159213791, 159213799⟩, ⟨1146137, 1146144⟩, ⟨136062, 136071⟩, ⟨2240, 2249⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-446429639), (-446429638)⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3848537657, 3848537658⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨51620131, 51620132⟩, ⟨34909232, 34909236⟩, ⟨6153333, 6153336⟩, ⟨114806, 114812⟩, ⟨10881, 10890⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4346587427, 4346587428⟩, ⟨34909232, 34909236⟩, ⟨6153333, 6153336⟩, ⟨114806, 114812⟩, ⟨10881, 10890⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320700272, 4320700274⟩, ⟨17350660, 17350663⟩, ⟨3023504, 3023507⟩, ⟨44918, 44923⟩, ⟨4169, 4175⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3871595883, 3871595886⟩, ⟨(-134154275), (-134154270)⟩, ⟨2108075, 2108081⟩, ⟨(-64508), (-64502)⟩, ⟨2178, 2186⟩⟩
...
def j47 : Jet := ⟨⟨4227036082, 4227036094⟩, ⟨1409012024, 1409012035⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4160179299, 4160179324⟩, ⟨2773452860, 2773452890⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4160179299, 4160179324⟩, ⟨2773452860, 2773452890⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4160179324), (-4160179299)⟩, ⟨(-2773452890), (-2773452860)⟩, ⟨(-462242150), (-462242142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2080089662), (-2080089649)⟩, ⟨(-1386726445), (-1386726430)⟩, ⟨(-231121075), (-231121071)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2646228253, 2646228267⟩, ⟨(-854394100), (-854394086)⟩, ⟨(-4468880), (-4468872)⟩, ⟨31132099, 31132103⟩, ⟨(-2392685), (-2392683)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2385379376, 2385379391⟩, ⟨(-852828734), (-852828715)⟩, ⟨23957658, 23957673⟩, ⟨27743770, 27743782⟩, ⟨(-3117270), (-3117258)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨297619758, 595239518⟩, ⟨148809879, 148809880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨935000045, 1870000097⟩, ⟨467500022, 467500026⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨203546389, 814185563⟩, ⟨203546388, 407092784⟩, ⟨50886597, 50886599⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨50, 204⟩, ⟨50, 102⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94637), (-94482)⟩, ⟨50, 102⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-17941), (-4477)⟩, ⟨(-8969), (-4457)⟩, ⟨(-1120), (-1106)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095115, 5108580⟩, ⟨(-8969), (-4457)⟩, ⟨(-1120), (-1106)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨241466, 968420⟩, ⟨239765, 483999⟩, ⟨59302, 60264⟩, ⟨(-214), (-103)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142924111), (-142197156)⟩, ⟨239765, 483999⟩, ⟨59302, 60264⟩, ⟨(-214), (-103)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-27093745), (-6738984)⟩, ⟨(-13535511), (-6647233)⟩, ⟨(-1679188), (-1627445)⟩, ⟨5609, 11444⟩, ⟨678, 711⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1404562020, 1424916782⟩, ⟨(-13535511), (-6647233)⟩, ⟨(-1679188), (-1627445)⟩, ⟨5609, 11444⟩, ⟨678, 711⟩⟩
...
def j72 : Jet := ⟨⟨559, 2243⟩, ⟨556, 1122⟩, ⟨136, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851618), (-849933)⟩, ⟨556, 1122⟩, ⟨136, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-161439), (-40279)⟩, ⟨(-80694), (-40066)⟩, ⟨(-10058), (-9935)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35629955, 35751116⟩, ⟨(-80694), (-40066)⟩, ⟨(-10058), (-9935)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1688569, 6777245⟩, ⟨1673272, 3386725⟩, ⟨412586, 421210⟩, ⟨(-1911), (-938)⟩, ⟨(-121), (-113)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714139314), (-709050637)⟩, ⟨1673272, 3386725⟩, ⟨412586, 421210⟩, ⟨(-1911), (-938)⟩, ⟨(-121), (-113)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-135377497), (-33603212)⟩, ⟨(-67609450), (-32961198)⟩, ⟨(-8362242), (-7999947)⟩, ⟨39014, 80006⟩, ⟨4683, 4942⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4159589799, 4261364084⟩, ⟨(-67609450), (-32961198)⟩, ⟨(-8362242), (-7999947)⟩, ⟨39014, 80006⟩, ⟨4683, 4942⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨305768463, 620399258⟩, ⟨146990959, 153652735⟩, ⟨(-2204426), (-1077829)⟩, ⟨(-181556), (-172161)⟩, ⟨757, 1556⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4328835487, 4434750773⟩, ⟨33483081, 72081883⟩, ⟨8385599, 10087024⟩, ⟨44457, 268264⟩, ⟨9589, 19454⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨308179616, 640590696⟩, ⟨150533799, 169065580⟩, ⟨(-533258), 2949458⟩, ⟨65690, 217695⟩, ⟨(-5261), 10570⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-595239518), (-297619758)⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3699727778, 3997347538⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨22113014, 95543555⟩, ⟨21602700, 50431974⟩, ⟨5116971, 7534858⟩, ⟨(-32556), 297144⟩, ⟨2667, 22320⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4317080310, 4390510851⟩, ⟨21602700, 50431974⟩, ⟨5116971, 7534858⟩, ⟨(-32556), 297144⟩, ⟨2667, 22320⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306009608, 4342476312⟩, ⟨10683177, 25151324⟩, ⟨2457656, 3744516⟩, ⟨(-38109), 142094⟩, ⟨(-1130), 10654⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3709239735, 4041564417⟩, ⟨(-141253354), (-125784003)⟩, ⟨1245618, 3114895⟩, ⟨(-165208), 47097⟩, ⟨(-5976), 11237⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2818024048, 5636048118⟩, ⟨1409012024, 1409012035⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1848968568, 7395874334⟩, ⟨1848968568, 3697937182⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1848968568, 7395874334⟩, ⟨1848968568, 3697937182⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7395874334), (-1848968568)⟩, ⟨(-3697937182), (-1848968568)⟩, ⟨(-462242150), (-462242142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3697937167), (-924484284)⟩, ⟨(-1848968591), (-924484284)⟩, ⟨(-231121075), (-231121071)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1815663288, 3463209189⟩, ⟨(-1490899598), (-390818383)⟩, ⟨(-144300961), 223208970⟩, ⟨(-18009734), 74192617⟩, ⟨(-13990585), 5820849⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1568051616, 3258880002⟩, ⟨(-1516834992), (-390694585)⟩, ⟨(-123814985), 261584189⟩, ⟨(-25502563), 74485675⟩, ⟨(-15731019), 6298018⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320700272, 4320700274⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2504
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306009608, 4342476312⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2505
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (41483883 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((13859 / 200000) : ℝ)..(13859 / 100000), prawitzNormalCorrection
