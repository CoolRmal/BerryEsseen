...
namespace FiniteNormalPanel67_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (15961 / 80000)
def radius : Rat := (15961 / 400000)

def j0 : Jet := ⟨⟨856899662, 856899663⟩, ⟨171379932, 171379933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2692029682, 2692029687⟩, ⟨538405935, 538405939⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1687329217, 1687329225⟩, ⟨674931684, 674931692⟩, ⟨67493168, 67493170⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨422, 423⟩, ⟨168, 170⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94265), (-94263)⟩, ⟨168, 170⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-37034), (-37032)⟩, ⟨(-14748), (-14745)⟩, ⟨(-1450), (-1447)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5076022, 5076025⟩, ⟨(-14748), (-14745)⟩, ⟨(-1450), (-1447)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1994175, 1994178⟩, ⟨791876, 791879⟩, ⟨76879, 76883⟩, ⟨(-459), (-455)⟩, ⟨(-23), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-141171402), (-141171398)⟩, ⟨791876, 791879⟩, ⟨76879, 76883⟩, ⟨(-459), (-455)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-55460873), (-55460870)⟩, ⟨(-21873252), (-21873248)⟩, ⟨(-2063794), (-2063789)⟩, ⟨24343, 24348⟩, ⟨1125, 1131⟩⟩
...
def j19 : Jet := ⟨⟨1376194892, 1376194896⟩, ⟨(-21873252), (-21873248)⟩, ⟨(-2063794), (-2063789)⟩, ⟨24343, 24348⟩, ⟨1125, 1131⟩⟩
...
def j22 : Jet := ⟨⟨(-43), (-42)⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11792, 11794⟩, ⟨(-17), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4632, 4634⟩, ⟨1846, 1848⟩, ⟨181, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847545), (-847542)⟩, ⟨1846, 1848⟩, ⟨181, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-332969), (-332967)⟩, ⟨(-132463), (-132459)⟩, ⟨(-12958), (-12954)⟩, ⟨56, 59⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35458425, 35458428⟩, ⟨(-132463), (-132459)⟩, ⟨(-12958), (-12954)⟩, ⟨56, 59⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13930265, 13930268⟩, ⟨5520066, 5520069⟩, ⟨531303, 531307⟩, ⟨(-4097), (-4092)⟩, ⟨(-196), (-191)⟩⟩
...
def j33 : Jet := ⟨⟨(-701897618), (-701897614)⟩, ⟨5520066, 5520069⟩, ⟨531303, 531307⟩, ⟨(-4097), (-4092)⟩, ⟨(-196), (-191)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-275748867), (-275748863)⟩, ⟨(-108130924), (-108130919)⟩, ⟨(-9953778), (-9953772)⟩, ⟨168625, 168632⟩, ⟨7627, 7632⟩⟩
...
def j36 : Jet := ⟨⟨4019218429, 4019218433⟩, ⟨(-108130924), (-108130919)⟩, ⟨(-9953778), (-9953772)⟩, ⟨168625, 168632⟩, ⟨7627, 7632⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨862581072, 862581077⟩, ⟨158806343, 158806349⟩, ⟨(-4035535), (-4035529)⟩, ⟨(-243455), (-243449)⟩, ⟨3756, 3762⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4589634622, 4589634627⟩, ⟨123477093, 123477100⟩, ⟨14688393, 14688404⟩, ⟨508398, 508412⟩, ⟨36155, 36168⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨921760674, 921760681⟩, ⟨194500221, 194500231⟩, ⟨3203106, 3203119⟩, ⟨269030, 269043⟩, ⟨9270, 9285⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-856899663), (-856899662)⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3438067633, 3438067634⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨197822866, 197822870⟩, ⟨83484990, 83484998⟩, ⟨10182923, 10182933⟩, ⟨405582, 405594⟩, ⟨30732, 30743⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4492790162, 4492790166⟩, ⟨83484990, 83484998⟩, ⟨10182923, 10182933⟩, ⟨405582, 405594⟩, ⟨30732, 30743⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4392765280, 4392765283⟩, ⟨40813164, 40813169⟩, ⟨4788510, 4788516⟩, ⟨153785, 153793⟩, ⟨10984, 10992⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3516353696, 3516353701⟩, ⟨(-142611891), (-142611884)⟩, ⟨2204594, 2204601⟩, ⟨(-67972), (-67963)⟩, ⟨2655, 2663⟩⟩
...
def j47 : Jet := ⟨⟨6626406741, 6626406751⟩, ⟨1325281345, 1325281354⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10223422734, 10223422766⟩, ⟨4089369082, 4089369118⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10223422734, 10223422766⟩, ⟨4089369082, 4089369118⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10223422766), (-10223422734)⟩, ⟨(-4089369118), (-4089369082)⟩, ⟨(-408936913), (-408936907)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5111711383), (-5111711367)⟩, ⟨(-2044684559), (-2044684541)⟩, ⟨(-204468457), (-204468453)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1306407346, 1306407362⟩, ⟨(-621935111), (-621935097)⟩, ⟨85847322, 85847330⟩, ⟨6115801, 6115804⟩, ⟨(-2771327), (-2771326)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1069575152, 1069575167⟩, ⟨(-552566037), (-552566020)⟩, ⟨91606048, 91606060⟩, ⟨1816671, 1816681⟩, ⟨(-2417286), (-2417276)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨685519730, 1028279596⟩, ⟨171379932, 171379933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2153623747, 3230435625⟩, ⟨538405935, 538405939⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1079890700, 2429754084⟩, ⟨539945348, 809918032⟩, ⟨67493168, 67493170⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨270, 609⟩, ⟨135, 203⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94417), (-94077)⟩, ⟨135, 203⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-53414), (-23653)⟩, ⟨(-17772), (-11711)⟩, ⟨(-1464), (-1429)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5059642, 5089404⟩, ⟨(-17772), (-11711)⟩, ⟨(-1464), (-1429)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1272154, 2879184⟩, ⟨626023, 956784⟩, ⟨75328, 78147⟩, ⟨(-556), (-358)⟩, ⟨(-24), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141893423), (-140286392)⟩, ⟨626023, 956784⟩, ⟨75328, 78147⟩, ⟨(-556), (-358)⟩, ⟨(-24), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-80272119), (-35272438)⟩, ⟨(-26599972), (-17094946)⟩, ⟨(-2132143), (-1979892)⟩, ⟨18991, 29683⟩, ⟨1064, 1180⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1351383646, 1396383328⟩, ⟨(-26599972), (-17094946)⟩, ⟨(-2132143), (-1979892)⟩, ⟨18991, 29683⟩, ⟨1064, 1180⟩⟩
...
def j72 : Jet := ⟨⟨2960, 6682⟩, ⟨1468, 2225⟩, ⟨179, 185⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849217), (-845494)⟩, ⟨1468, 2225⟩, ⟨179, 185⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-480421), (-212583)⟩, ⟨(-159772), (-105032)⟩, ⟨(-13117), (-12761)⟩, ⟨43, 70⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35310973, 35578812⟩, ⟨(-159772), (-105032)⟩, ⟨(-13117), (-12761)⟩, ⟨43, 70⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8878296, 20127689⟩, ⟨4348761, 6682822⟩, ⟨517343, 542691⟩, ⟨(-4975), (-3214)⟩, ⟨(-202), (-184)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706949587), (-695700193)⟩, ⟨4348761, 6682822⟩, ⟨517343, 542691⟩, ⟨(-4975), (-3214)⟩, ⟨(-202), (-184)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-399936374), (-174921045)⟩, ⟨(-132218710), (-83679907)⟩, ⟨(-10432560), (-9365348)⟩, ⟨130561, 206548⟩, ⟨7075, 8079⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3895030922, 4120046251⟩, ⟨(-132218710), (-83679907)⟩, ⟨(-10432560), (-9365348)⟩, ⟨130561, 206548⟩, ⟨7075, 8079⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨677623765, 1050281909⟩, ⟨149398919, 166475075⟩, ⟨(-4938184), (-3135753)⟩, ⟨(-257758), (-225868)⟩, ⟨2913, 4609⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4477314804, 4735968583⟩, ⟨90936184, 160764747⟩, ⟨12024414, 18142190⟩, ⟨213501, 896365⟩, ⟨14320, 67842⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨706393018, 1158123400⟩, ⟨170088957, 222881565⟩, ⟨(-384937), 7398890⟩, ⟨(-17118), 620548⟩, ⟨(-17788), 42856⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1028279596), (-685519730)⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3266687700, 3609447566⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨116180418, 312284057⟩, ⟨55949040, 120198520⟩, ⟨6528255, 15556312⟩, ⟨(-49184), 1102570⟩, ⟨(-12036), 100264⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4411147714, 4607251353⟩, ⟨55949040, 120198520⟩, ⟨6528255, 15556312⟩, ⟨(-49184), 1102570⟩, ⟨(-12036), 100264⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4352669889, 4448369801⟩, ⟨27009815, 59302535⟩, ⟨2756273, 7591241⟩, ⟨(-127693), 526874⟩, ⟨(-19737), 50336⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3310575426, 3738365498⟩, ⟨(-156957817), (-123845151)⟩, ⟨(-269941), 5301845⟩, ⟨(-410222), 332798⟩, ⟨(-37611), 47398⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5301125395, 7951688104⟩, ⟨1325281345, 1325281354⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6542990555, 14721728793⟩, ⟨3271495268, 4907242944⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6542990555, 14721728793⟩, ⟨3271495268, 4907242944⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14721728793), (-6542990555)⟩, ⟨(-4907242944), (-3271495268)⟩, ⟨(-408936913), (-408936907)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7360864397), (-3271495277)⟩, ⟨(-2453621472), (-1635747634)⟩, ⟨(-204468457), (-204468453)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨773839446, 2005191549⟩, ⟨(-1145522353), (-294718435)⟩, ⟨(-39338119), 290366209⟩, ⟨(-45939622), 43847229⟩, ⟨(-13173905), 7497453⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨596478081, 1745330846⟩, ⟨(-1070348484), (-249483591)⟩, ⟨(-25867975), 297074422⟩, ⟨(-52203030), 39829861⟩, ⟨(-13223909), 8694653⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨856899662, 856899663⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4392765280, 4392765283⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1326
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨685519730, 1028279596⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4352669889, 4448369801⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1327
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (10991637 / 536870912)

theorem envelope_integral : (∫ s in ((15961 / 100000) : ℝ)..(47883 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((15961 / 100000) : ℝ)..(47883 / 200000), prawitzNormalCorrection
