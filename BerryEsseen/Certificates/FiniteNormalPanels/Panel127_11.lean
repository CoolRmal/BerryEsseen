...
namespace FiniteNormalPanel127_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (7311 / 40000)
def radius : Rat := (7311 / 200000)

def j0 : Jet := ⟨⟨785012647, 785012648⟩, ⟨157002529, 157002530⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2466189964, 2466189969⟩, ⟨493237991, 493237995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1416097613, 1416097620⟩, ⟨566439042, 566439050⟩, ⟨56643904, 56643906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨354, 355⟩, ⟨141, 142⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94333), (-94331)⟩, ⟨141, 142⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-31103), (-31101)⟩, ⟨(-12396), (-12393)⟩, ⟨(-1223), (-1220)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5081953, 5081956⟩, ⟨(-12396), (-12393)⟩, ⟨(-1223), (-1220)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1675575, 1675577⟩, ⟨666142, 666145⟩, ⟨64984, 64988⟩, ⟨(-326), (-321)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-141490002), (-141489999)⟩, ⟨666142, 666145⟩, ⟨64984, 64988⟩, ⟨(-326), (-321)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-46650799), (-46650797)⟩, ⟨(-18440686), (-18440682)⟩, ⟨(-1756754), (-1756748)⟩, ⟨17247, 17252⟩, ⟨808, 812⟩⟩
...
def j19 : Jet := ⟨⟨1385004966, 1385004969⟩, ⟨(-18440686), (-18440682)⟩, ⟨(-1756754), (-1756748)⟩, ⟨17247, 17252⟩, ⟨808, 812⟩⟩
...
def j25 : Jet := ⟨⟨3890, 3891⟩, ⟨1551, 1553⟩, ⟨152, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848287), (-848285)⟩, ⟨1551, 1553⟩, ⟨152, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-279690), (-279688)⟩, ⟨(-111365), (-111362)⟩, ⟨(-10934), (-10930)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35511704, 35511707⟩, ⟨(-111365), (-111362)⟩, ⟨(-10934), (-10930)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11708596, 11708598⟩, ⟨4646719, 4646723⟩, ⟨450049, 450055⟩, ⟨(-2900), (-2895)⟩, ⟨(-140), (-137)⟩⟩
...
def j33 : Jet := ⟨⟨(-704119287), (-704119284)⟩, ⟨4646719, 4646723⟩, ⟨450049, 450055⟩, ⟨(-2900), (-2895)⟩, ⟨(-140), (-137)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-232155819), (-232155816)⟩, ⟨(-91330255), (-91330249)⟩, ⟨(-8525018), (-8525012)⟩, ⟨119679, 119686⟩, ⟨5505, 5510⟩⟩
...
def j36 : Jet := ⟨⟨4062811477, 4062811480⟩, ⟨(-91330255), (-91330249)⟩, ⟨(-8525018), (-8525012)⟩, ⟨119679, 119686⟩, ⟨5505, 5510⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨795276217, 795276222⟩, ⟨148466516, 148466521⟩, ⟨(-3126483), (-3126476)⟩, ⟨(-191845), (-191839)⟩, ⟨2443, 2449⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4540388882, 4540388886⟩, ⟨102065982, 102065990⟩, ⟨11821513, 11821522⟩, ⟨346151, 346164⟩, ⟨23419, 23430⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨840719624, 840719631⟩, ⟨175849154, 175849162⟩, ⟨2411961, 2411973⟩, ⟨195627, 195642⟩, ⟨5717, 5732⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-785012648), (-785012647)⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3509954648, 3509954649⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨164566907, 164566911⟩, ⟨68843286, 68843292⟩, ⟨8144064, 8144072⟩, ⟨274092, 274102⟩, ⟨19610, 19623⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4459534203, 4459534207⟩, ⟨68843286, 68843292⟩, ⟨8144064, 8144072⟩, ⟨274092, 274102⟩, ⟨19610, 19623⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4376477299, 4376477302⟩, ⟨33780554, 33780558⟩, ⟨3865821, 3865826⟩, ⟨104653, 104660⟩, ⟨7106, 7114⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3576566660, 3576566664⟩, ⟨(-132375816), (-132375810)⟩, ⟨1924396, 1924402⟩, ⟨(-55791), (-55784)⟩, ⟨1981, 1989⟩⟩
...
def j47 : Jet := ⟨⟨6420345439, 6420345450⟩, ⟨1284069084, 1284069094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9597473674, 9597473708⟩, ⟨3838989458, 3838989496⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9597473674, 9597473708⟩, ⟨3838989458, 3838989496⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9597473708), (-9597473674)⟩, ⟨(-3838989496), (-3838989458)⟩, ⟨(-383898951), (-383898944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4798736854), (-4798736837)⟩, ⟨(-1919494748), (-1919494729)⟩, ⟨(-191949476), (-191949472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1405159677, 1405159694⟩, ⟨(-627990033), (-627990018)⟩, ⟨77530764, 77530772⟩, ⟨7160690, 7160693⟩, ⟨(-2532552), (-2532550)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1170124684, 1170124701⟩, ⟨(-566257486), (-566257469)⟩, ⟨84547491, 84547504⟩, ⟨3273733, 3273743⟩, ⟨(-2286102), (-2286093)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨628010118, 942015178⟩, ⟨157002529, 157002530⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1972951973, 2959427963⟩, ⟨493237991, 493237995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨906302474, 2039180573⟩, ⟨453151234, 679726860⟩, ⟨56643904, 56643906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨226, 511⟩, ⟨113, 171⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94461), (-94175)⟩, ⟨113, 171⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-44849), (-19872)⟩, ⟨(-14927), (-9854)⟩, ⟨(-1233), (-1206)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5068207, 5093185⟩, ⟨(-14927), (-9854)⟩, ⟨(-1233), (-1206)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1069467, 2418162⟩, ⟨527645, 803975⟩, ⟨63892, 65879⟩, ⟨(-393), (-253)⟩, ⟨(-17), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142096110), (-140747414)⟩, ⟨527645, 803975⟩, ⟨63892, 65879⟩, ⟨(-393), (-253)⟩, ⟨(-17), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-67464921), (-29699813)⟩, ⟨(-22376966), (-14468191)⟩, ⟨(-1804874), (-1697720)⟩, ⟨13512, 20978⟩, ⟨770, 841⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1364190844, 1401955953⟩, ⟨(-22376966), (-14468191)⟩, ⟨(-1804874), (-1697720)⟩, ⟨13512, 20978⟩, ⟨770, 841⟩⟩
...
def j72 : Jet := ⟨⟨2486, 5610⟩, ⟨1234, 1868⟩, ⟨151, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849691), (-846566)⟩, ⟨1234, 1868⟩, ⟨151, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-403420), (-178638)⟩, ⟨(-134214), (-88432)⟩, ⟨(-11046), (-10794)⟩, ⟨30, 50⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35387974, 35612757⟩, ⟨(-134214), (-88432)⟩, ⟨(-11046), (-10794)⟩, ⟨30, 50⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7467392, 16908358⟩, ⟨3669973, 5617460⟩, ⟨440226, 458070⟩, ⟨(-3514), (-2280)⟩, ⟨(-144), (-132)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708360491), (-698919524)⟩, ⟨3669973, 5617460⟩, ⟨440226, 458070⟩, ⟨(-3514), (-2280)⟩, ⟨(-144), (-132)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-336318033), (-147482495)⟩, ⟨(-111331593), (-71074168)⟩, ⟨(-8862065), (-8111143)⟩, ⟨93179, 146100⟩, ⟨5179, 5775⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3958649263, 4147484801⟩, ⟨(-111331593), (-71074168)⟩, ⟨(-8862065), (-8111143)⟩, ⟨93179, 146100⟩, ⟨5179, 5775⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨626659723, 966011466⟩, ⟨141246181, 154355751⟩, ⟨(-3813433), (-2441410)⟩, ⟨(-201068), (-180512)⟩, ⟨1904, 2990⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4447694195, 4659858161⟩, ⟨76218763, 131052135⟩, ⟨10004392, 14117496⟩, ⟨156350, 585728⟩, ⟨11138, 40466⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨648943430, 1048081651⟩, ⟨157389567, 196945336⟩, ⟨(-171155), 5356891⟩, ⟨17309, 408852⟩, ⟨(-9934), 24509⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-942015178), (-628010118)⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3352952118, 3666957178⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨98051404, 255758676⟩, ⟨47561212, 96119380⟩, ⟨5684024, 11645349⟩, ⟨(-10468), 690822⟩, ⟨(-3796), 56140⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4393018700, 4550725972⟩, ⟨47561212, 96119380⟩, ⟨5684024, 11645349⟩, ⟨(-10468), 690822⟩, ⟨(-3796), 56140⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4343716340, 4420997538⟩, ⟨23102687, 47520322⟩, ⟨2505601, 5695891⟩, ⟨(-67489), 328209⟩, ⟨(-9203), 27772⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3391009034, 3774559279⟩, ⟨(-143573992), (-118212649)⟩, ⟨218941, 4018520⟩, ⟨(-265835), 188627⟩, ⟨(-19856), 26180⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5136276355, 7704414543⟩, ⟨1284069084, 1284069094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6142383160, 13820362150⟩, ⟨3071191568, 4606787396⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6142383160, 13820362150⟩, ⟨3071191568, 4606787396⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13820362150), (-6142383160)⟩, ⟨(-4606787396), (-3071191568)⟩, ⟨(-383898951), (-383898944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6910181075), (-3071191580)⟩, ⟨(-2303393698), (-1535595784)⟩, ⟨(-191949476), (-191949472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨859454002, 2100922284⟩, ⟨(-1126725960), (-307283816)⟩, ⟨(-38961663), 263721449⟩, ⟨(-37989300), 40535270⟩, ⟨(-11327856), 5964054⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨678565419, 1846359974⟩, ⟨(-1060434554), (-266265246)⟩, ⟨(-25739453), 271397501⟩, ⟨(-43386287), 37002769⟩, ⟨(-11405977), 6840624⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨785012647, 785012648⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4376477299, 4376477302⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2558
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨628010118, 942015178⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4343716340, 4420997538⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2559
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (10963533 / 536870912)

theorem envelope_integral : (∫ s in ((7311 / 50000) : ℝ)..(21933 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((7311 / 50000) : ℝ)..(21933 / 100000), prawitzNormalCorrection
