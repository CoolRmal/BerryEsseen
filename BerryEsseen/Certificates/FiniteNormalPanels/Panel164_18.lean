...
namespace FiniteNormalPanel164_18
...
def j2 : Jet := ⟨⟨460314980, 460314984⟩, ⟨460314980, 460314984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨49334457, 49334459⟩, ⟨98668914, 98668918⟩, ⟨49334457, 49334459⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1088), (-1087)⟩, ⟨(-2175), (-2173)⟩, ⟨(-1088), (-1085)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111968, 5111970⟩, ⟨(-2175), (-2173)⟩, ⟨(-1088), (-1085)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨58718, 58720⟩, ⟨117412, 117415⟩, ⟨58655, 58659⟩, ⟨(-50), (-47)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-143106859), (-143106856)⟩, ⟨117412, 117415⟩, ⟨58655, 58659⟩, ⟨(-50), (-47)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1643808), (-1643807)⟩, ⟨(-3286268), (-3286265)⟩, ⟨(-1640438), (-1640435)⟩, ⟨2694, 2697⟩, ⟨670, 673⟩⟩
...
def j19 : Jet := ⟨⟨1430011957, 1430011959⟩, ⟨(-3286268), (-3286265)⟩, ⟨(-1640438), (-1640435)⟩, ⟨2694, 2697⟩, ⟨670, 673⟩⟩
...
def j28 : Jet := ⟨⟨(-9788), (-9787)⟩, ⟨(-19572), (-19570)⟩, ⟨(-9781), (-9778)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781606, 35781608⟩, ⟨(-19572), (-19570)⟩, ⟨(-9781), (-9778)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨411008, 411009⟩, ⟨821791, 821793⟩, ⟨410445, 410448⟩, ⟨(-450), (-447)⟩, ⟨(-114), (-110)⟩⟩
...
def j33 : Jet := ⟨⟨(-715416875), (-715416873)⟩, ⟨821791, 821793⟩, ⟨410445, 410448⟩, ⟨(-450), (-447)⟩, ⟨(-114), (-110)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8217689), (-8217688)⟩, ⟨(-16425939), (-16425936)⟩, ⟨(-8194096), (-8194093)⟩, ⟨18862, 18865⟩, ⟨4701, 4704⟩⟩
...
def j36 : Jet := ⟨⟨4286749607, 4286749608⟩, ⟨(-16425939), (-16425936)⟩, ⟨(-8194096), (-8194093)⟩, ⟨18862, 18865⟩, ⟨4701, 4704⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨153262150, 153262153⟩, ⟨152909942, 152909947⟩, ⟨(-528023), (-528020)⟩, ⟨(-175527), (-175524)⟩, ⟨359, 363⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303200737, 4303200739⟩, ⟨16488972, 16488977⟩, ⟨8288721, 8288727⟩, ⟨44339, 44346⟩, ⟨11216, 11224⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨153555953, 153555957⟩, ⟨153791463, 153791471⟩, ⟨353781, 353787⟩, ⟨118786, 118793⟩, ⟨643, 652⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-146522810), (-146522809)⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4148444486, 4148444487⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5490014, 5490015⟩, ⟨10996868, 10996870⟩, ⟨5532163, 5532166⟩, ⟨33826, 33834⟩, ⟨8579, 8586⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300457310, 4300457311⟩, ⟨10996868, 10996870⟩, ⟨5532163, 5532166⟩, ⟨33826, 33834⟩, ⟨8579, 8586⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297711426, 4297711427⟩, ⟨5494923, 5494925⟩, ⟨2760802, 2760805⟩, ⟨13371, 13377⟩, ⟨3381, 3387⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4151095000, 4151095002⟩, ⟨(-141308964), (-141308958)⟩, ⟨2479157, 2479162⟩, ⟨(-81271), (-81263)⟩, ⟨2808, 2816⟩⟩
...
def j47 : Jet := ⟨⟨1309099251, 1309099261⟩, ⟨1309099251, 1309099261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨399011384, 399011392⟩, ⟨798022768, 798022784⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨399011384, 399011392⟩, ⟨798022768, 798022784⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-399011392), (-399011384)⟩, ⟨(-798022784), (-798022768)⟩, ⟨(-399011392), (-399011384)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-199505696), (-199505692)⟩, ⟨(-399011392), (-399011384)⟩, ⟨(-199505696), (-199505692)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4100024303, 4100024308⟩, ⟨(-380900784), (-380900774)⟩, ⟨(-172757156), (-172757149)⟩, ⟨17145323, 17145325⟩, ⟨3614165, 3614166⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3962682183, 3962682191⟩, ⟨(-503036550), (-503036532)⟩, ⟨(-152071490), (-152071474)⟩, ⟨21957434, 21957449⟩, ⟨2839164, 2839179⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 293045619⟩, ⟨146522809, 146522810⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 920629964⟩, ⟨460314980, 460314984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 197337832⟩, ⟨0, 197337832⟩, ⟨49334457, 49334459⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4351), 0⟩, ⟨(-4351), 3⟩, ⟨(-1088), (-1083)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108705, 5113057⟩, ⟨(-4351), 3⟩, ⟨(-1088), (-1083)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 234927⟩, ⟨(-200), 234928⟩, ⟨58431, 58733⟩, ⟨(-100), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142930649)⟩, ⟨(-200), 234928⟩, ⟨58431, 58733⟩, ⟨(-100), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6577928), 0⟩, ⟨(-6577938), 10795⟩, ⟨(-1644492), (-1628289)⟩, ⟨(-8), 5399⟩, ⟨665, 676⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425077837, 1431655766⟩, ⟨(-6577938), 10795⟩, ⟨(-1644492), (-1628289)⟩, ⟨(-8), 5399⟩, ⟨665, 676⟩⟩
...
def j72 : Jet := ⟨⟨0, 544⟩, ⟨(-1), 544⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851632)⟩, ⟨(-1), 544⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-39155), 0⟩, ⟨(-39156), 25⟩, ⟨(-9790), (-9750)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35752239, 35791395⟩, ⟨(-39156), 25⟩, ⟨(-9790), (-9750)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1644482⟩, ⟨(-1800), 1644484⟩, ⟨408420, 411123⟩, ⟨(-901), 2⟩, ⟨(-115), (-109)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714183400)⟩, ⟨(-1800), 1644484⟩, ⟨408420, 411123⟩, ⟨(-901), 2⟩, ⟨(-115), (-109)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-32889639), 0⟩, ⟨(-32889722), 75558⟩, ⟨(-8222493), (-8109072)⟩, ⟨(-63), 37781⟩, ⟨4643, 4724⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4262077657, 4294967296⟩, ⟨(-32889722), 75558⟩, ⟨(-8222493), (-8109072)⟩, ⟨(-63), 37781⟩, ⟨4643, 4724⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 306876655⟩, ⟨151323347, 153440643⟩, ⟨(-1057493), 1157⟩, ⟨(-176252), (-173354)⟩, ⟨(-1), 724⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4328110739⟩, ⟨(-76730), 33399289⟩, ⟨8108484, 8607623⟩, ⟨(-38669), 130924⟩, ⟨9957, 12940⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 309244764⟩, ⟨151317864, 157011105⟩, ⟨(-1068396), 1809397⟩, ⟨97083, 143534⟩, ⟨(-4875), 6340⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-293045619), 0⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4001921677, 4294967296⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22266136⟩, ⟨0, 22610120⟩, ⟨5177291, 6000415⟩, ⟨(-78116), 152964⟩, ⟨5685, 12173⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317233432⟩, ⟨0, 22610120⟩, ⟨5177291, 6000415⟩, ⟨(-78116), 152964⟩, ⟨5685, 12173⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306085973⟩, ⟨0, 11305060⟩, ⟨2567121, 3000208⟩, ⟨(-46956), 76482⟩, ⟨1588, 5444⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4001921677, 4306085973⟩, ⟨(-146902124), (-135217749)⟩, ⟨2006293, 3000208⟩, ⟨(-149309), (-11095)⟩, ⟨(-1131), 7046⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2618198513⟩, ⟨1309099251, 1309099261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1596045554⟩, ⟨0, 1596045560⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1596045554⟩, ⟨0, 1596045560⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1596045554), 0⟩, ⟨(-1596045560), 0⟩, ⟨(-399011392), (-399011384)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-798022777), 0⟩, ⟨(-798022780), 0⟩, ⟨(-199505696), (-199505692)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3566696380, 4294967296⟩, ⟨(-798022780), 0⟩, ⟨(-199505696), (-91538776)⟩, ⟨0, 37068988⟩, ⟨404142, 4633624⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3323340685, 4306085973⟩, ⟨(-946990801), (-112289715)⟩, ⟨(-198356073), (-54997851)⟩, ⟨2175139, 43979496⟩, ⟨(-1031810), 4637649⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297711426, 4297711427⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3322
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306085973⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3323
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (16686155 / 268435456)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(6823 / 100000), prawitzNormalCorrection
