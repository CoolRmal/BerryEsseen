...
namespace FiniteNormalPanel139_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (5453 / 32000)
def radius : Rat := (5453 / 160000)

def j0 : Jet := ⟨⟨731889270, 731889271⟩, ⟨146377854, 146377855⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2299297953, 2299297958⟩, ⟨459859590, 459859594⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1230922312, 1230922318⟩, ⟨492368924, 492368930⟩, ⟨49236892, 49236894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨308, 309⟩, ⟨123, 124⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94379), (-94377)⟩, ⟨123, 124⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-27049), (-27048)⟩, ⟨(-10785), (-10783)⟩, ⟨(-1065), (-1062)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5086007, 5086009⟩, ⟨(-10785), (-10783)⟩, ⟨(-1065), (-1062)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1457631, 1457633⟩, ⟨579961, 579963⟩, ⟨56762, 56766⟩, ⟨(-247), (-242)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-141707946), (-141707943)⟩, ⟨579961, 579963⟩, ⟨56762, 56766⟩, ⟨(-247), (-242)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-40612993), (-40612991)⟩, ⟨(-16078983), (-16078980)⟩, ⟨(-1541768), (-1541763)⟩, ⟨13084, 13088⟩, ⟨617, 622⟩⟩
...
def j19 : Jet := ⟨⟨1391042772, 1391042775⟩, ⟨(-16078983), (-16078980)⟩, ⟨(-1541768), (-1541763)⟩, ⟨13084, 13088⟩, ⟨617, 622⟩⟩
...
def j25 : Jet := ⟨⟨3382, 3384⟩, ⟨1349, 1351⟩, ⟨132, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848795), (-848792)⟩, ⟨1349, 1351⟩, ⟨132, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-243262), (-243260)⟩, ⟨(-96919), (-96916)⟩, ⟨(-9540), (-9536)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35548132, 35548135⟩, ⟨(-96919), (-96916)⟩, ⟨(-9540), (-9536)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10187967, 10187969⟩, ⟨4047410, 4047413⟩, ⟨393672, 393677⟩, ⟨(-2198), (-2194)⟩, ⟨(-108), (-104)⟩⟩
...
def j33 : Jet := ⟨⟨(-705639916), (-705639913)⟩, ⟨4047410, 4047413⟩, ⟨393672, 393677⟩, ⟨(-2198), (-2194)⟩, ⟨(-108), (-104)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-202233885), (-202233882)⟩, ⟨(-79733582), (-79733578)⟩, ⟨(-7512543), (-7512538)⟩, ⟨90897, 90902⟩, ⟨4229, 4234⟩⟩
...
def j36 : Jet := ⟨⟨4092733411, 4092733414⟩, ⟨(-79733582), (-79733578)⟩, ⟨(-7512543), (-7512538)⟩, ⟨90897, 90902⟩, ⟨4229, 4234⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨744690605, 744690610⟩, ⟨140330284, 140330289⟩, ⟨(-2546949), (-2546944)⟩, ⟨(-158073), (-158068)⟩, ⟨1730, 1735⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4507194143, 4507194147⟩, ⟨87807994, 87808001⟩, ⟨9983965, 9983973⟩, ⟨255575, 255584⟩, ⟨16689, 16701⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨781487937, 781487944⟩, ⟨162489158, 162489166⟩, ⟨1927252, 1927263⟩, ⟨152565, 152576⟩, ⟨3905, 3917⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-731889271), (-731889270)⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3563078025, 3563078026⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨142195121, 142195124⟩, ⟨59131214, 59131220⟩, ⟨6848705, 6848713⟩, ⟨201342, 201352⟩, ⟨13826, 13837⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4437162417, 4437162420⟩, ⟨59131214, 59131220⟩, ⟨6848705, 6848713⟩, ⟨201342, 201352⟩, ⟨13826, 13837⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4365485937, 4365485939⟩, ⟨29088013, 29088017⟩, ⟨3272127, 3272132⟩, ⟨77241, 77248⟩, ⟨5059, 5067⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3621579848, 3621579852⟩, ⟨(-124649986), (-124649979)⟩, ⟨1723180, 1723186⟩, ⟨(-47441), (-47433)⟩, ⟨1563, 1572⟩⟩
...
def j47 : Jet := ⟨⟨8654500274, 8654500289⟩, ⟨1730900054, 1730900068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17439102519, 17439102580⟩, ⟨6975641004, 6975641074⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17439102519, 17439102580⟩, ⟨6975641004, 6975641074⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17439102580), (-17439102519)⟩, ⟨(-6975641074), (-6975641004)⟩, ⟨(-697564112), (-697564100)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8719551290), (-8719551259)⟩, ⟨(-3487820537), (-3487820502)⟩, ⟨(-348782056), (-348782050)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨563980944, 563980961⟩, ⟨(-457992866), (-457992846)⟩, ⟨140162179, 140162193⟩, ⟨(-13145713), (-13145705)⟩, ⟨(-3022274), (-3022270)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨475557060, 475557076⟩, ⟨(-402554395), (-402554373)⟩, ⟨131705114, 131705132⟩, ⟨(-15342477), (-15342463)⟩, ⟨(-2105411), (-2105401)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨585511416, 878267125⟩, ⟨146377854, 146377855⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1839438363, 2759157548⟩, ⟨459859590, 459859594⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨787790280, 1772528136⟩, ⟨393895138, 590842716⟩, ⟨49236892, 49236894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨197, 445⟩, ⟨98, 149⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94490), (-94241)⟩, ⟨98, 149⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-38996), (-17285)⟩, ⟨(-12982), (-8580)⟩, ⟨(-1074), (-1053)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5074060, 5095772⟩, ⟨(-12982), (-8580)⟩, ⟨(-1074), (-1053)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨930692, 2103020⟩, ⟨459988, 699434⟩, ⟨55938, 57439⟩, ⟨(-297), (-192)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142234885), (-141062556)⟩, ⟨459988, 699434⟩, ⟨55938, 57439⟩, ⟨(-297), (-192)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-58700176), (-25873936)⟩, ⟨(-19482355), (-12648312)⟩, ⟨(-1578116), (-1497196)⟩, ⟨10280, 15886⟩, ⟨594, 641⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1372955589, 1405781830⟩, ⟨(-19482355), (-12648312)⟩, ⟨(-1578116), (-1497196)⟩, ⟨10280, 15886⟩, ⟨594, 641⟩⟩
...
def j70 : Jet := ⟨⟨(-45), (-19)⟩, ⟨(-15), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11790, 11817⟩, ⟨(-15), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2162, 4877⟩, ⟨1074, 1625⟩, ⟨131, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850015), (-847299)⟩, ⟨1074, 1625⟩, ⟨131, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-350801), (-155413)⟩, ⟨(-116738), (-77035)⟩, ⟨(-9623), (-9432)⟩, ⟨23, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35440593, 35635982⟩, ⟨(-116738), (-77035)⟩, ⟨(-9623), (-9432)⟩, ⟨23, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6500574, 14706930⟩, ⟨3202109, 4888181⟩, ⟨386253, 399732⟩, ⟨(-2659), (-1732)⟩, ⟨(-110), (-101)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709327309), (-701120952)⟩, ⟨3202109, 4888181⟩, ⟨386253, 399732⟩, ⟨(-2659), (-1732)⟩, ⟨(-110), (-101)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-292738577), (-128600809)⟩, ⟨(-96992191), (-62283057)⟩, ⟨(-7767113), (-7200132)⟩, ⟨71033, 110711⟩, ⟨4015, 4407⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4002228719, 4166366487⟩, ⟨(-96992191), (-62283057)⟩, ⟨(-7767113), (-7200132)⟩, ⟨71033, 110711⟩, ⟨4015, 4407⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨588006149, 903097342⟩, ⟨134485752, 145099237⟩, ⟨(-3099773), (-1995462)⟩, ⟨(-164566), (-150097)⟩, ⟨1354, 2113⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4427537551, 4609117912⟩, ⟨66187305, 111699876⟩, ⟨8640909, 11651897⟩, ⟨121078, 420574⟩, ⟨8896, 27192⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨606155792, 969153395⟩, ⟨147698274, 179199352⟩, ⟨(-71030), 4166595⟩, ⟨29923, 296598⟩, ⟨(-6287), 15868⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-878267125), (-585511416)⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3416700171, 3709455880⟩, ⟨(-146377855), (-146377854)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨85547762, 218688116⟩, ⟨41689800, 80872170⟩, ⟨5047093, 9357127⟩, ⟨2518, 481542⟩, ⟨(-849), 35955⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4380515058, 4513655412⟩, ⟨41689800, 80872170⟩, ⟨5047093, 9357127⟩, ⟨2518, 481542⟩, ⟨(-849), 35955⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4337530278, 4402953825⟩, ⟨20333659, 40039297⟩, ⟨2279600, 4584994⟩, ⟨(-41078), 227723⟩, ⟨(-4946), 17582⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3450559555, 3802721146⟩, ⟨(-133882492), (-113247513)⟩, ⟨448860, 3266949⟩, ⟨(-191742), 118988⟩, ⟨(-12034), 16586⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6923600219, 10385400344⟩, ⟨1730900054, 1730900068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11161025611, 25112307702⟩, ⟨5580512802, 8370769286⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11161025611, 25112307702⟩, ⟨5580512802, 8370769286⟩, ⟨697564100, 697564112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-25112307702), (-11161025611)⟩, ⟨(-8370769286), (-5580512802)⟩, ⟨(-697564112), (-697564100)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12556153851), (-5580512805)⟩, ⟨(-4185384643), (-2790256401)⟩, ⟨(-348782056), (-348782050)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨230843923, 1171317939⟩, ⟨(-1141432700), (-149969415)⟩, ⟨(-46405038), 537408803⟩, ⟨(-166446691), 76868682⟩, ⟨(-40547579), 42434195⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨185459084, 1037073205⟩, ⟨(-1047125374), (-126571603)⟩, ⟨(-37108116), 512288026⟩, ⟨(-165042836), 69522078⟩, ⟨(-38366772), 43223541⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨731889270, 731889271⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4365485937, 4365485939⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2788
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨585511416, 878267125⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4337530278, 4402953825⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2789
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (35996855 / 4294967296)

theorem envelope_integral : (∫ s in ((5453 / 40000) : ℝ)..(16359 / 80000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((5453 / 40000) : ℝ)..(16359 / 80000), prawitzNormalCorrection
