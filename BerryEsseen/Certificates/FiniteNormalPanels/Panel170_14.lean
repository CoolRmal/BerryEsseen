...
namespace FiniteNormalPanel170_14
...
def j2 : Jet := ⟨⟨428909933, 428909937⟩, ⟨428909933, 428909937⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨42832393, 42832395⟩, ⟨85664786, 85664790⟩, ⟨42832393, 42832395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-945), (-944)⟩, ⟨(-1889), (-1887)⟩, ⟨(-945), (-942)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112111, 5112113⟩, ⟨(-1889), (-1887)⟩, ⟨(-945), (-942)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨50981, 50982⟩, ⟨101944, 101946⟩, ⟨50933, 50936⟩, ⟨(-38), (-35)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143114596), (-143114594)⟩, ⟨101944, 101946⟩, ⟨50933, 50936⟩, ⟨(-38), (-35)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1427239), (-1427238)⟩, ⟨(-2853461), (-2853459)⟩, ⟨(-1424699), (-1424696)⟩, ⟨2030, 2033⟩, ⟨505, 508⟩⟩
...
def j19 : Jet := ⟨⟨1430228526, 1430228528⟩, ⟨(-2853461), (-2853459)⟩, ⟨(-1424699), (-1424696)⟩, ⟨2030, 2033⟩, ⟨505, 508⟩⟩
...
def j25 : Jet := ⟨⟨118, 119⟩, ⟨235, 237⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852059), (-852057)⟩, ⟨235, 237⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8498), (-8497)⟩, ⟨(-16993), (-16991)⟩, ⟨(-8493), (-8490)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782896, 35782898⟩, ⟨(-16993), (-16991)⟩, ⟨(-8493), (-8490)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨356851, 356852⟩, ⟨713533, 713535⟩, ⟨356427, 356430⟩, ⟨(-340), (-337)⟩, ⟨(-86), (-82)⟩⟩
...
def j33 : Jet := ⟨⟨(-715471032), (-715471030)⟩, ⟨713533, 713535⟩, ⟨356427, 356430⟩, ⟨(-340), (-337)⟩, ⟨(-86), (-82)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7135174), (-7135173)⟩, ⟨(-14263233), (-14263230)⟩, ⟨(-7117389), (-7117386)⟩, ⟨14220, 14223⟩, ⟨3546, 3549⟩⟩
...
def j36 : Jet := ⟨⟨4287832122, 4287832123⟩, ⟨(-14263233), (-14263230)⟩, ⟨(-7117389), (-7117386)⟩, ⟨14220, 14223⟩, ⟨3546, 3549⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨142827448, 142827451⟩, ⟨142542491, 142542495⟩, ⟨(-427233), (-427230)⟩, ⟨(-142074), (-142070)⟩, ⟨252, 255⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302114342, 4302114344⟩, ⟨14310738, 14310743⟩, ⟨7188695, 7188701⟩, ⟨33395, 33402⟩, ⟨8433, 8441⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨143065120, 143065124⟩, ⟨143255586, 143255593⟩, ⟨286061, 286067⟩, ⟨95955, 95963⟩, ⟨450, 458⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-136526273), (-136526272)⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4158441023, 4158441024⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4765491, 4765492⟩, ⟨9543670, 9543672⟩, ⟨4797244, 4797247⟩, ⟨25474, 25478⟩, ⟨6447, 6454⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299732787, 4299732788⟩, ⟨9543670, 9543672⟩, ⟨4797244, 4797247⟩, ⟨25474, 25478⟩, ⟨6447, 6454⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297349380, 4297349382⟩, ⟨4769189, 4769191⟩, ⟨2394645, 2394648⟩, ⟨10071, 10075⟩, ⟨2542, 2548⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4160747386, 4160747390⟩, ⟨(-131984406), (-131984401)⟩, ⟨2166924, 2166929⟩, ⟨(-66370), (-66364)⟩, ⟨2140, 2148⟩⟩
...
def j47 : Jet := ⟨⟨1498151076, 1498151088⟩, ⟨1498151076, 1498151088⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨522578285, 522578295⟩, ⟨1045156570, 1045156590⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨522578285, 522578295⟩, ⟨1045156570, 1045156590⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-522578295), (-522578285)⟩, ⟨(-1045156590), (-1045156570)⟩, ⟨(-522578295), (-522578285)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-261289148), (-261289142)⟩, ⟨(-522578295), (-522578285)⟩, ⟨(-261289148), (-261289142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4041467305, 4041467312⟩, ⟨(-491734384), (-491734373)⟩, ⟨(-215951982), (-215951973)⟩, ⟨28701926, 28701929⟩, ⟨5695782, 5695784⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3915169398, 3915169410⟩, ⟨(-600561784), (-600561766)⟩, ⟨(-192053345), (-192053327)⟩, ⟨34130635, 34130649⟩, ⟨4536431, 4536446⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 273052546⟩, ⟨136526272, 136526273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 857819873⟩, ⟨428909933, 428909937⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 171329579⟩, ⟨0, 171329580⟩, ⟨42832393, 42832395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3778), 0⟩, ⟨(-3778), 2⟩, ⟨(-945), (-940)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109278, 5113057⟩, ⟨(-3778), 2⟩, ⟨(-945), (-940)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 203964⟩, ⟨(-151), 203965⟩, ⟨50764, 50992⟩, ⟨(-76), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142961612)⟩, ⟨(-151), 203965⟩, ⟨50764, 50992⟩, ⟨(-76), 2⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5710986), 0⟩, ⟨(-5710994), 8137⟩, ⟨(-1427754), (-1415540)⟩, ⟨(-6), 4071⟩, ⟨501, 510⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425944779, 1431655766⟩, ⟨(-5710994), 8137⟩, ⟨(-1427754), (-1415540)⟩, ⟨(-6), 4071⟩, ⟨501, 510⟩⟩
...
def j74 : Jet := ⟨⟨(-33995), 0⟩, ⟨(-33996), 19⟩, ⟨(-8500), (-8469)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35757399, 35791395⟩, ⟨(-33996), 19⟩, ⟨(-8500), (-8469)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1427747⟩, ⟨(-1357), 1427748⟩, ⟨354900, 356938⟩, ⟨(-681), 2⟩, ⟨(-87), (-82)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714400135)⟩, ⟨(-1357), 1427748⟩, ⟨354900, 356938⟩, ⟨(-681), 2⟩, ⟨(-87), (-82)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-28554930), 0⟩, ⟨(-28554986), 56954⟩, ⟨(-7138788), (-7053300)⟩, ⟨(-42), 28479⟩, ⟨3507, 3561⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4266412366, 4294967296⟩, ⟨(-28554986), 56954⟩, ⟨(-7138788), (-7053300)⟩, ⟨(-42), 28479⟩, ⟨3507, 3561⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 285939958⟩, ⟨141259020, 142971606⟩, ⟨(-855481), 813⟩, ⟨(-142583), (-140546)⟩, ⟨(-1), 509⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4323713344⟩, ⟨(-57720), 28938501⟩, ⟨7052916, 7428353⟩, ⟨(-29059), 98184⟩, ⟨7611, 9558⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 287853743⟩, ⟨141255177, 145855108⟩, ⟨(-863129), 1458676⟩, ⟨80728, 113280⟩, ⟨(-3411), 4423⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-273052546), 0⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4021914750, 4294967296⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19292296⟩, ⟨0, 19550762⟩, ⟨4529979, 5148699⟩, ⟨(-58624), 114258⟩, ⟨4558, 8784⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314259592⟩, ⟨0, 19550762⟩, ⟨4529979, 5148699⟩, ⟨(-58624), 114258⟩, ⟨4558, 8784⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304602637⟩, ⟨0, 9775381⟩, ⟨2248819, 2574350⟩, ⟨(-35172), 57129⟩, ⟨1372, 3885⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4021914750, 4304602637⟩, ⟨(-136832557), (-126750891)⟩, ⟨1795115, 2574350⟩, ⟨(-117005), (-14355)⟩, ⟨(-532), 5004⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2996302176⟩, ⟨1498151076, 1498151088⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2090313177⟩, ⟨0, 2090313178⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2090313177⟩, ⟨0, 2090313178⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2090313177), 0⟩, ⟨(-2090313178), 0⟩, ⟨(-522578295), (-522578285)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1045156589), 0⟩, ⟨(-1045156589), 0⟩, ⟨(-261289148), (-261289142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3367260344, 4294967296⟩, ⟨(-1045156589), 0⟩, ⟨(-261289148), (-77684506)⟩, ⟨0, 63583273⟩, ⟨(-1505148), 7947910⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3153186767, 4304602637⟩, ⟨(-1184333854), (-99372875)⟩, ⟨(-260467953), (-36873915)⟩, ⟨1549126, 72039024⟩, ⟨(-3691359), 7966750⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297349380, 4297349382⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3448
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304602637⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3449
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (244938263 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(2543 / 40000), prawitzNormalCorrection
