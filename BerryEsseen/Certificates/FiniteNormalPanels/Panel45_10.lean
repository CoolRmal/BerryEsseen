...
namespace FiniteNormalPanel45_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (124201 / 400000)
def radius : Rat := (17743 / 400000)

def j0 : Jet := ⟨⟨1333598082, 1333598083⟩, ⟨190514011, 190514012⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4189621937, 4189621941⟩, ⟨598517417, 598517421⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4086860449, 4086860458⟩, ⟨1167674408, 1167674420⟩, ⟨83405314, 83405316⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1022, 1024⟩, ⟨292, 293⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93665), (-93662)⟩, ⟨292, 293⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-89127), (-89123)⟩, ⟨(-25188), (-25184)⟩, ⟨(-1721), (-1718)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5023929, 5023934⟩, ⟨(-25188), (-25184)⟩, ⟨(-1721), (-1718)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4780501, 4780507⟩, ⟨1341889, 1341896⟩, ⟨89075, 89082⟩, ⟨(-949), (-944)⟩, ⟨(-32), (-28)⟩⟩
...
def j16 : Jet := ⟨⟨(-138385076), (-138385069)⟩, ⟨1341889, 1341896⟩, ⟨89075, 89082⟩, ⟨(-949), (-944)⟩, ⟨(-32), (-28)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-131679815), (-131679807)⟩, ⟨(-36345936), (-36345924)⟩, ⟨(-2237767), (-2237754)⟩, ⟨49370, 49380⟩, ⟨1439, 1448⟩⟩
...
def j19 : Jet := ⟨⟨1299975950, 1299975959⟩, ⟨(-36345936), (-36345924)⟩, ⟨(-2237767), (-2237754)⟩, ⟨49370, 49380⟩, ⟨1439, 1448⟩⟩
...
def j22 : Jet := ⟨⟨(-103), (-101)⟩, ⟨(-30), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11732, 11735⟩, ⟨(-30), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11163, 11167⟩, ⟨3160, 3164⟩, ⟨215, 220⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841014), (-841009)⟩, ⟨3160, 3164⟩, ⟨215, 220⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-800264), (-800259)⟩, ⟨(-225641), (-225634)⟩, ⟨(-15269), (-15260)⟩, ⟨117, 122⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨34991130, 34991136⟩, ⟨(-225641), (-225634)⟩, ⟨(-15269), (-15260)⟩, ⟨117, 122⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨33295681, 33295688⟩, ⟨9298343, 9298353⟩, ⟨603627, 603641⟩, ⟨(-8423), (-8412)⟩, ⟨(-265), (-257)⟩⟩
...
def j33 : Jet := ⟨⟨(-682532202), (-682532194)⟩, ⟨9298343, 9298353⟩, ⟨603627, 603641⟩, ⟨(-8423), (-8412)⟩, ⟨(-265), (-257)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-649461027), (-649461017)⟩, ⟨(-176712490), (-176712475)⟩, ⟨(-10151984), (-10151966)⟩, ⟨336660, 336677⟩, ⟨9179, 9193⟩⟩
...
def j36 : Jet := ⟨⟨3645506269, 3645506279⟩, ⟨(-176712490), (-176712475)⟩, ⟨(-10151984), (-10151966)⟩, ⟨336660, 336677⟩, ⟨9179, 9193⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1268090623, 1268090634⟩, ⟨145701345, 145701362⟩, ⟨(-7247803), (-7247787)⟩, ⟨(-263681), (-263669)⟩, ⟨8282, 8295⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5060132300, 5060132315⟩, ⟨245285135, 245285159⟩, ⟨25981365, 25981395⟩, ⟨1475164, 1475194⟩, ⟨108444, 108472⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1494005862, 1494005881⟩, ⟨244079125, 244079155⟩, ⟨7452967, 7453000⟩, ⟨592348, 592377⟩, ⟨32915, 32944⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1333598083), (-1333598082)⟩, ⟨(-190514012), (-190514011)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2961369213, 2961369214⟩, ⟨(-190514012), (-190514011)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨519690456, 519690470⟩, ⟨169806016, 169806040⟩, ⟨19055830, 19055859⟩, ⟨1259186, 1259214⟩, ⟨103154, 103184⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4814657752, 4814657766⟩, ⟨169806016, 169806040⟩, ⟨19055830, 19055859⟩, ⟨1259186, 1259214⟩, ⟨103154, 103184⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4547394593, 4547394600⟩, ⟨80190015, 80190027⟩, ⟨8291970, 8291985⟩, ⟨448420, 448436⟩, ⟨33245, 33262⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3135417203, 3135417210⟩, ⟨(-146420243), (-146420230)⟩, ⟨2160262, 2160275⟩, ⟨(-58628), (-58615)⟩, ⟨3030, 3045⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨24872982194, 24872982199⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value282

def j47 : Jet := ⟨⟨7723123148, 7723123157⟩, ⟨1103303302, 1103303309⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13887563524, 13887563557⟩, ⟨3967875274, 3967875306⟩, ⟨283419661, 283419665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13887563524, 13887563557⟩, ⟨3967875274, 3967875306⟩, ⟨283419661, 283419665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13887563557), (-13887563524)⟩, ⟨(-3967875306), (-3967875274)⟩, ⟨(-283419665), (-283419661)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6943781779), (-6943781762)⟩, ⟨(-1983937653), (-1983937637)⟩, ⟨(-141709833), (-141709830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨852756492, 852756502⟩, ⟨(-393906547), (-393906538)⟩, ⟨62840762, 62840767⟩, ⟨(-1011363), (-1011361)⟩, ⟨(-919905), (-919903)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨622530322, 622530331⟩, ⟨(-316631557), (-316631545)⟩, ⟨59732716, 59732727⟩, ⟨(-3090398), (-3090387)⟩, ⟨(-599490), (-599479)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1143084070, 1524112095⟩, ⟨190514011, 190514012⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3591104516, 4788139362⟩, ⟨598517417, 598517421⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3002591348, 5337940192⟩, ⟨1000863778, 1334485050⟩, ⟨83405314, 83405316⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨751, 1338⟩, ⟨250, 335⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93936), (-93348)⟩, ⟨250, 335⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-116748), (-65259)⟩, ⟨(-29013), (-21336)⟩, ⟨(-1754), (-1680)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4996308, 5047798⟩, ⟨(-29013), (-21336)⟩, ⟨(-1754), (-1680)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3492895, 6273586⟩, ⟨1128239, 1553482⟩, ⟨85829, 91880⟩, ⟨(-1104), (-787)⟩, ⟨(-34), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139672682), (-136891990)⟩, ⟨1128239, 1553482⟩, ⟨85829, 91880⟩, ⟨(-1104), (-787)⟩, ⟨(-34), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-173590245), (-95700543)⟩, ⟨(-42608816), (-29969457)⟩, ⟨(-2389431), (-2061475)⟩, ⟨40536, 58166⟩, ⟨1279, 1585⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1258065520, 1335955223⟩, ⟨(-42608816), (-29969457)⟩, ⟨(-2389431), (-2061475)⟩, ⟨40536, 58166⟩, ⟨1279, 1585⟩⟩
...
def j70 : Jet := ⟨⟨(-135), (-74)⟩, ⟨(-34), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11700, 11762⟩, ⟨(-34), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8179, 14619⟩, ⟨2683, 3639⟩, ⟨212, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843998), (-837557)⟩, ⟨2683, 3639⟩, ⟨212, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1048952), (-585532)⟩, ⟨(-260363), (-190654)⟩, ⟨(-15617), (-14855)⟩, ⟨98, 141⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34742442, 35205863⟩, ⟨(-260363), (-190654)⟩, ⟨(-15617), (-14855)⟩, ⟨98, 141⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨24288277, 43755116⟩, ⟨7772503, 10805494⟩, ⟨574366, 628861⟩, ⟨(-9842), (-6987)⟩, ⟨(-282), (-237)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-691539606), (-672072766)⟩, ⟨7772503, 10805494⟩, ⟨574366, 628861⟩, ⟨(-9842), (-6987)⟩, ⟨(-282), (-237)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-859470353), (-469842895)⟩, ⟨(-209433869), (-143184839)⟩, ⟨(-11216449), (-8912254)⟩, ⟨272549, 400345⟩, ⟨7744, 10420⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3435496943, 3825124401⟩, ⟨(-209433869), (-143184839)⟩, ⟨(-11216449), (-8912254)⟩, ⟨272549, 400345⟩, ⟨7744, 10420⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1051892705, 1489357043⟩, ⟨127814052, 161111594⟩, ⟨(-8601474), (-5899977)⟩, ⟨(-299083), (-222428)⟩, ⟨6717, 9873⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4822521345, 5369454370⟩, ⟨180520125, 327331278⟩, ⟨17993473, 37485253⟩, ⟨532164, 2971277⟩, ⟨12956, 278329⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1181097473, 1861954733⟩, ⟨187725246, 314925449⟩, ⟨(-974401), 18652768⟩, ⟨(-363648), 1938754⟩, ⟨(-71315), 186252⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1524112095), (-1143084070)⟩, ⟨(-190514012), (-190514011)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2770855201, 3151883226⟩, ⟨(-190514012), (-190514011)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨324796708, 807194838⟩, ⟨103247264, 273053038⟩, ⟨7360284, 39264389⟩, ⟨(-458194), 4416382⟩, ⟨(-119396), 526812⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4619764004, 5102162134⟩, ⟨103247264, 273053038⟩, ⟨7360284, 39264389⟩, ⟨(-458194), 4416382⟩, ⟨(-119396), 526812⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4454406280, 4681198512⟩, ⟨47364325, 131639752⟩, ⟨1525587, 18677674⟩, ⟨(-772874), 2112932⟩, ⟨(-159164), 276559⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2873715667, 3435320936⟩, ⟨(-177089644), (-100981834)⟩, ⟨(-4854994), 11605742⟩, ⟨(-1395673), 1482915⟩, ⟨(-210529), 237238⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6619819840, 8826426466⟩, ⟨1103303302, 1103303309⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10203107892, 18138858527⟩, ⟨3401035948, 4534714636⟩, ⟨283419661, 283419665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10203107892, 18138858527⟩, ⟨3401035948, 4534714636⟩, ⟨283419661, 283419665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18138858527), (-10203107892)⟩, ⟨(-4534714636), (-3401035948)⟩, ⟨(-283419665), (-283419661)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9069429264), (-5101553946)⟩, ⟨(-2267357318), (-1700517974)⟩, ⟨(-141709833), (-141709830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨519859280, 1309500616⟩, ⟨(-691298816), (-205829285)⟩, ⟨(-2458905), 165319431⟩, ⟨(-24563801), 15638684⟩, ⟨(-4791263), 3282436⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨347832161, 1047401429⟩, ⟨(-606927158), (-149940881)⟩, ⟨1392389, 164272472⟩, ⟨(-28757280), 13843524⟩, ⟨(-4966845), 4381959⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1333598082, 1333598083⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨190514011, 190514012⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4547394593, 4547394600⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar282 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified888
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar282 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1143084070, 1524112095⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4454406280, 4681198512⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified889
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((53229 / 200000) : ℝ)..(17743 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (53229 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (17743 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((53229 / 200000) : ℝ)..(17743 / 50000), prawitzNormalCorrection
      ((25899 / 10000) * sqrt n) s) ≤ (upper : ℝ) :=
