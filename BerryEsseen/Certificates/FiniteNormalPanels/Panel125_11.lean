...
namespace FiniteNormalPanel125_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (98329 / 400000)
def radius : Rat := (14047 / 400000)

def j0 : Jet := ⟨⟨1055799598, 1055799599⟩, ⟨150828514, 150828515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3316892260, 3316892264⟩, ⟨473841751, 473841755⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2561550183, 2561550190⟩, ⟨731871480, 731871488⟩, ⟨52276534, 52276536⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨641, 642⟩, ⟨183, 184⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94046), (-94044)⟩, ⟨183, 184⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-56090), (-56088)⟩, ⟨(-15917), (-15915)⟩, ⟨(-1107), (-1103)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5056966, 5056969⟩, ⟨(-15917), (-15915)⟩, ⟨(-1107), (-1103)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3016011, 3016014⟩, ⟨852223, 852228⟩, ⟨58177, 58184⟩, ⟨(-381), (-376)⟩, ⟨(-14), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140149566), (-140149562)⟩, ⟨852223, 852228⟩, ⟨58177, 58184⟩, ⟨(-381), (-376)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-83586236), (-83586232)⟩, ⟨(-23373510), (-23373504)⟩, ⟨(-1525925), (-1525917)⟩, ⟨20057, 20064⟩, ⟨634, 640⟩⟩
...
def j19 : Jet := ⟨⟨1348069529, 1348069534⟩, ⟨(-23373510), (-23373504)⟩, ⟨(-1525925), (-1525917)⟩, ⟨20057, 20064⟩, ⟨634, 640⟩⟩
...
def j22 : Jet := ⟨⟨(-65), (-63)⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11770, 11773⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7019, 7022⟩, ⟨1993, 1997⟩, ⟨137, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845158), (-845154)⟩, ⟨1993, 1997⟩, ⟨137, 141⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-504059), (-504056)⟩, ⟨(-142829), (-142824)⟩, ⟨(-9867), (-9860)⟩, ⟨45, 50⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35287335, 35287339⟩, ⟨(-142829), (-142824)⟩, ⟨(-9867), (-9860)⟩, ⟨45, 50⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21045626, 21045630⟩, ⟨5927851, 5927857⟩, ⟨399278, 399286⟩, ⟨(-3395), (-3388)⟩, ⟨(-115), (-109)⟩⟩
...
def j33 : Jet := ⟨⟨(-694782257), (-694782252)⟩, ⟨5927851, 5927857⟩, ⟨399278, 399286⟩, ⟨(-3395), (-3388)⟩, ⟨(-115), (-109)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-414373266), (-414373261)⟩, ⟨(-114856949), (-114856942)⟩, ⟨(-7208348), (-7208339)⟩, ⟨138163, 138172⟩, ⟨4211, 4218⟩⟩
...
def j36 : Jet := ⟨⟨3880594030, 3880594035⟩, ⟨(-114856949), (-114856942)⟩, ⟨(-7208348), (-7208339)⟩, ⟨138163, 138172⟩, ⟨4211, 4218⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1041079262, 1041079269⟩, ⟨130674850, 130674858⟩, ⟨(-3757113), (-3757105)⟩, ⟨(-152859), (-152851)⟩, ⟨2701, 2709⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4753587700, 4753587707⟩, ⟨140695609, 140695620⟩, ⟨12994230, 12994244⟩, ⟨476689, 476704⟩, ⟨28066, 28083⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1152246625, 1152246636⟩, ⟨178732358, 178732373⟩, ⟨3272116, 3272131⟩, ⟨218638, 218655⟩, ⟨7920, 7938⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1055799599), (-1055799598)⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3239167697, 3239167698⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨309122792, 309122799⟩, ⟨95900034, 95900044⟩, ⟨9193508, 9193520⟩, ⟨389644, 389658⟩, ⟨24936, 24953⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4604090088, 4604090095⟩, ⟨95900034, 95900044⟩, ⟨9193508, 9193520⟩, ⟨389644, 389658⟩, ⟨24936, 24953⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4446843414, 4446843419⟩, ⟨46312346, 46312352⟩, ⟨4198593, 4198601⟩, ⟨144440, 144449⟩, ⟨8554, 8565⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3353709247, 3353709253⟩, ⟨(-121234296), (-121234289)⟩, ⟨1540109, 1540118⟩, ⟨(-38512), (-38503)⟩, ⟨1378, 1388⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨38802116087, 38802116094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value532

def j47 : Jet := ⟨⟨9538433180, 9538433192⟩, ⟨1362633311, 1362633321⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨21183329524, 21183329579⟩, ⟨6052379862, 6052379916⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨21183329524, 21183329579⟩, ⟨6052379862, 6052379916⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-21183329579), (-21183329524)⟩, ⟨(-6052379916), (-6052379862)⟩, ⟨(-432312854), (-432312847)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10591664790), (-10591664762)⟩, ⟨(-3026189958), (-3026189931)⟩, ⟨(-216156427), (-216156423)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨364721874, 364721885⟩, ⟨(-256979304), (-256979293)⟩, ⟨72176822, 72176830⟩, ⟨(-8329544), (-8329540)⟩, ⟨(-349025), (-349023)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨284791719, 284791729⟩, ⟨(-210956362), (-210956350)⟩, ⟨63743555, 63743566⟩, ⟨(-8636855), (-8636846)⟩, ⟨(-9116), (-9109)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨904971084, 1206628113⟩, ⟨150828514, 150828515⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2843050509, 3790734016⟩, ⟨473841751, 473841755⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1881955237, 3345698207⟩, ⟨627318410, 836424558⟩, ⟨52276534, 52276536⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨471, 839⟩, ⟨157, 210⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94216), (-93847)⟩, ⟨157, 210⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-73393), (-41121)⟩, ⟨(-18281), (-13543)⟩, ⟨(-1120), (-1090)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5039663, 5071936⟩, ⟨(-18281), (-13543)⟩, ⟨(-1120), (-1090)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2208263, 3950943⟩, ⟨721846, 981802⟩, ⟨56906, 59279⟩, ⟨(-442), (-318)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140957314), (-139214633)⟩, ⟨721846, 981802⟩, ⟨56906, 59279⟩, ⟨(-442), (-318)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-109803079), (-61000629)⟩, ⟨(-27134474), (-19568737)⟩, ⟨(-1585308), (-1457081)⟩, ⟨16752, 23357⟩, ⟨594, 672⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1321852686, 1370655137⟩, ⟨(-27134474), (-19568737)⟩, ⟨(-1585308), (-1457081)⟩, ⟨16752, 23357⟩, ⟨594, 672⟩⟩
...
def j70 : Jet := ⟨⟨(-85), (-46)⟩, ⟨(-22), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11750, 11790⟩, ⟨(-22), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5148, 9185⟩, ⟨1698, 2291⟩, ⟨136, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847029), (-842991)⟩, ⟨1698, 2291⟩, ⟨136, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-659820), (-369379)⟩, ⟨(-164211), (-121341)⟩, ⟨(-10003), (-9702)⟩, ⟨37, 56⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35131574, 35422016⟩, ⟨(-164211), (-121341)⟩, ⟨(-10003), (-9702)⟩, ⟨37, 56⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15393842, 27593080⟩, ⟨5003362, 6845103⟩, ⟨387833, 409169⟩, ⟨(-3932), (-2849)⟩, ⟨(-118), (-105)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700434041), (-688234802)⟩, ⟨5003362, 6845103⟩, ⟨387833, 409169⟩, ⟨(-3932), (-2849)⟩, ⟨(-118), (-105)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-545624857), (-301568557)⟩, ⟨(-134213859), (-95190645)⟩, ⟨(-7624665), (-6725117)⟩, ⟨114481, 161752⟩, ⟨3862, 4519⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3749342439, 3993398739⟩, ⟨(-134213859), (-95190645)⟩, ⟨(-7624665), (-6725117)⟩, ⟨114481, 161752⟩, ⟨3862, 4519⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨874999433, 1209738910⟩, ⟨121884377, 138263854⟩, ⟨(-4392800), (-3123431)⟩, ⟨(-163811), (-140137)⟩, ⟨2241, 3171⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4619309335, 4919994473⟩, ⟨110110475, 176119269⟩, ⟨10403889, 16309784⟩, ⟨234144, 800950⟩, ⟨10399, 53722⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨941076560, 1385786746⟩, ⟨153521131, 207991277⟩, ⟨212245, 6904225⟩, ⟨(-24835), 519852⟩, ⟨(-12228), 33392⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1206628113), (-904971084)⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3088339183, 3389996212⟩, ⟨(-150828515), (-150828514)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨206200660, 447129111⟩, ⟨67276478, 134218278⟩, ⟨5580534, 14527689⟩, ⟨(-856), 1004166⟩, ⟨(-10288), 82999⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4501167956, 4742096407⟩, ⟨67276478, 134218278⟩, ⟨5580534, 14527689⟩, ⟨(-856), 1004166⟩, ⟨(-10288), 82999⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4396859011, 4512997783⟩, ⟨32013119, 65553969⟩, ⟨2179359, 6978972⟩, ⟨(-104470), 474581⟩, ⟨(-17641), 41557⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3161605439, 3562086586⟩, ⟨(-135465848), (-102665276)⟩, ⟨(-735003), 4384248⟩, ⟨(-327543), 298052⟩, ⟨(-30591), 36470⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8175799869, 10901066504⟩, ⟨1362633311, 1362633321⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15563262509, 27668022301⟩, ⟨5187754166, 6917005616⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15563262509, 27668022301⟩, ⟨5187754166, 6917005616⟩, ⟨432312847, 432312854⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-27668022301), (-15563262509)⟩, ⟨(-6917005616), (-5187754166)⟩, ⟨(-432312854), (-432312847)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13834011151), (-7781631254)⟩, ⟨(-3458502808), (-2593877083)⟩, ⟨(-216156427), (-216156423)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨171437281, 701623554⟩, ⟨(-564979164), (-103536815)⟩, ⟨(-4046493), 218845379⟩, ⟨(-55267559), 20042261⟩, ⟨(-9541743), 11227814⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨126198176, 581900555⟩, ⟨(-490702394), (-80313350)⟩, ⟨(-1001178), 200038233⟩, ⟨(-53369611), 16895313⟩, ⟨(-8627371), 11327546⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1055799598, 1055799599⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨150828514, 150828515⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4446843414, 4446843419⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar532 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2520
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar532 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨904971084, 1206628113⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4396859011, 4512997783⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2521
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((42141 / 200000) : ℝ)..(14047 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (42141 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (14047 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((42141 / 200000) : ℝ)..(14047 / 50000), prawitzNormalCorrection
      ((250567 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
