...
namespace FiniteNormalPanel130_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (96089 / 400000)
def radius : Rat := (13727 / 400000)

def j0 : Jet := ⟨⟨1031747781, 1031747782⟩, ⟨147392540, 147392541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3241331249, 3241331253⟩, ⟨463047320, 463047325⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2446171889, 2446171896⟩, ⟨698906252, 698906262⟩, ⟨49921875, 49921877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨612, 613⟩, ⟨174, 176⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94075), (-94073)⟩, ⟨174, 176⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-53580), (-53578)⟩, ⟨(-15210), (-15207)⟩, ⟨(-1060), (-1056)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5059476, 5059479⟩, ⟨(-15210), (-15207)⟩, ⟨(-1060), (-1056)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2881593, 2881595⟩, ⟨814649, 814652⟩, ⟨55728, 55734⟩, ⟨(-349), (-343)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140283984), (-140283981)⟩, ⟨814649, 814652⟩, ⟨55728, 55734⟩, ⟨(-349), (-343)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-79897871), (-79897868)⟩, ⟨(-22363986), (-22363982)⟩, ⟨(-1466265), (-1466259)⟩, ⟨18337, 18344⟩, ⟨582, 588⟩⟩
...
def j19 : Jet := ⟨⟨1351757894, 1351757898⟩, ⟨(-22363986), (-22363982)⟩, ⟨(-1466265), (-1466259)⟩, ⟨18337, 18344⟩, ⟨582, 588⟩⟩
...
def j22 : Jet := ⟨⟨(-62), (-60)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11773, 11776⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6705, 6707⟩, ⟨1904, 1908⟩, ⟨131, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845472), (-845469)⟩, ⟨1904, 1908⟩, ⟨131, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-481534), (-481531)⟩, ⟨(-136497), (-136493)⟩, ⟨(-9445), (-9439)⟩, ⟨41, 45⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35309860, 35309864⟩, ⟨(-136497), (-136493)⟩, ⟨(-9445), (-9439)⟩, ⟨41, 45⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20110510, 20110514⟩, ⟨5668118, 5668123⟩, ⟨382826, 382833⟩, ⟨(-3101), (-3095)⟩, ⟨(-105), (-99)⟩⟩
...
def j33 : Jet := ⟨⟨(-695717373), (-695717368)⟩, ⟨5668118, 5668123⟩, ⟨382826, 382833⟩, ⟨(-3101), (-3095)⟩, ⟨(-105), (-99)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-396241501), (-396241496)⟩, ⟨(-109983618), (-109983610)⟩, ⟨(-6946172), (-6946164)⟩, ⟨126411, 126419⟩, ⟨3884, 3891⟩⟩
...
def j36 : Jet := ⟨⟨3898725795, 3898725800⟩, ⟨(-109983618), (-109983610)⟩, ⟨(-6946172), (-6946164)⟩, ⟨126411, 126419⟩, ⟨3884, 3891⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1020146324, 1020146330⟩, ⟨128857507, 128857514⟩, ⟨(-3517661), (-3517654)⟩, ⟨(-144243), (-144235)⟩, ⟨2415, 2422⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4731480237, 4731480244⟩, ⟨133475731, 133475743⟩, ⟨12195209, 12195222⟩, ⟨428412, 428426⟩, ⟨24761, 24775⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1123827456, 1123827465⟩, ⟨173657089, 173657102⟩, ⟨3025983, 3025998⟩, ⟨199413, 199430⟩, ⟨6922, 6938⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1031747782), (-1031747781)⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3263219514, 3263219515⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨294062344, 294062349⟩, ⟨90878738, 90878746⟩, ⟨8604989, 8605001⟩, ⟨349052, 349068⟩, ⟨21877, 21892⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4589029640, 4589029645⟩, ⟨90878738, 90878746⟩, ⟨8604989, 8605001⟩, ⟨349052, 349068⟩, ⟨21877, 21892⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4439564418, 4439564421⟩, ⟨43959403, 43959408⟩, ⟨3944724, 3944731⟩, ⟨129781, 129791⟩, ⟨7543, 7553⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3373081153, 3373081158⟩, ⟨(-118955388), (-118955381)⟩, ⟨1488535, 1488542⟩, ⟨(-36770), (-36760)⟩, ⟨1276, 1286⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨48083450877, 48083450885⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value549

def j47 : Jet := ⟨⟨11550726775, 11550726789⟩, ⟨1650103823, 1650103835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨31064098940, 31064099017⟩, ⟨8875456828, 8875456906⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨31064098940, 31064099017⟩, ⟨8875456828, 8875456906⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-31064099017), (-31064098940)⟩, ⟨(-8875456906), (-8875456828)⟩, ⟨(-633961211), (-633961201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-15532049509), (-15532049470)⟩, ⟨(-4437728453), (-4437728414)⟩, ⟨(-316980606), (-316980600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨115452838, 115452843⟩, ⟨(-119290400), (-119290393)⟩, ⟨53107009, 53107016⟩, ⟨(-12421441), (-12421436)⟩, ⟨1248855, 1248858⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨90671654, 90671659⟩, ⟨(-96883145), (-96883138)⟩, ⟨45051876, 45051885⟩, ⟨(-11268472), (-11268464)⟩, ⟨1344284, 1344292⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨884355241, 1179140322⟩, ⟨147392540, 147392541⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2778283928, 3704378574⟩, ⟨463047320, 463047325⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1797187511, 3195000026⟩, ⟨599062500, 798750012⟩, ⟨49921875, 49921877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨449, 801⟩, ⟨149, 201⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94238), (-93885)⟩, ⟨149, 201⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-70104), (-39285)⟩, ⟨(-17464), (-12945)⟩, ⟨(-1071), (-1043)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5042952, 5073772⟩, ⟨(-17464), (-12945)⟩, ⟨(-1071), (-1043)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2110174, 3774349⟩, ⟨690399, 938172⟩, ⟨54570, 56734⟩, ⟨(-403), (-290)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141055403), (-139391227)⟩, ⟨690399, 938172⟩, ⟨54570, 56734⟩, ⟨(-403), (-290)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-104930256), (-58326910)⟩, ⟨(-25943675), (-18744402)⟩, ⟨(-1520406), (-1403510)⟩, ⟨15335, 21336⟩, ⟨549, 617⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1326725509, 1373328856⟩, ⟨(-25943675), (-18744402)⟩, ⟨(-1520406), (-1403510)⟩, ⟨15335, 21336⟩, ⟨549, 617⟩⟩
...
def j70 : Jet := ⟨⟨(-81), (-44)⟩, ⟨(-21), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11754, 11792⟩, ⟨(-21), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4918, 8772⟩, ⟨1623, 2188⟩, ⟨130, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847259), (-843404)⟩, ⟨1623, 2188⟩, ⟨130, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-630271), (-352914)⟩, ⟨(-156889), (-116010)⟩, ⟨(-9568), (-9294)⟩, ⟨34, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35161123, 35438481⟩, ⟨(-156889), (-116010)⟩, ⟨(-9568), (-9294)⟩, ⟨34, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14712831, 26362471⟩, ⟨4787568, 6542075⟩, ⟨372393, 391845⟩, ⟨(-3590), (-2605)⟩, ⟨(-109), (-96)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701115052), (-689465411)⟩, ⟨4787568, 6542075⟩, ⟨372393, 391845⟩, ⟨(-3590), (-2605)⟩, ⟨(-109), (-96)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-521555220), (-288500130)⟩, ⟨(-128385495), (-91300099)⟩, ⟨(-7325707), (-6505747)⟩, ⟨104917, 147824⟩, ⟨3578, 4152⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3773412076, 4006467166⟩, ⟨(-128385495), (-91300099)⟩, ⟨(-7325707), (-6505747)⟩, ⟨104917, 147824⟩, ⟨3578, 4152⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨858218446, 1184486316⟩, ⟨120660172, 135935607⟩, ⟨(-4108370), (-2928752)⟩, ⟨(-153999), (-132911)⟩, ⟨2008, 2834⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4604241919, 4888611078⟩, ⟨104922298, 166328708⟩, ⟨9867407, 15149877⟩, ⟨214860, 710351⟩, ⟨9714, 46300⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨920017562, 1348204196⟩, ⟨150314269, 200595333⟩, ⟨243099, 6302758⟩, ⟨(-14247), 461371⟩, ⟨(-10327), 28504⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1179140322), (-884355241)⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3115826974, 3410612055⟩, ⟨(-147392541), (-147392540)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨197075380, 423205680⟩, ⟨64397122, 125935056⟩, ⟨5364809, 13325667⟩, ⟨8068, 878390⟩, ⟨(-7803), 70244⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4492042676, 4718172976⟩, ⟨64397122, 125935056⟩, ⟨5364809, 13325667⟩, ⟨8068, 878390⟩, ⟨(-7803), 70244⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4392399843, 4501599564⟩, ⟨30720583, 61570778⟩, ⟨2138208, 6407609⟩, ⟨(-85875), 414499⟩, ⟨(-14301), 35028⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3186510389, 3574697706⟩, ⟨(-132197090), (-101843134)⟩, ⟨(-561772), 4033998⟩, ⟨(-288087), 255775⟩, ⟨(-25582), 30764⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9900622951, 13200830613⟩, ⟨1650103823, 1650103835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨22822603308, 40573517064⟩, ⟨7607534426, 10143379318⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨22822603308, 40573517064⟩, ⟨7607534426, 10143379318⟩, ⟨633961201, 633961211⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-40573517064), (-22822603308)⟩, ⟨(-10143379318), (-7607534426)⟩, ⟨(-633961211), (-633961201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-20286758532), (-11411301654)⟩, ⟨(-5071689659), (-3803767213)⟩, ⟨(-316980606), (-316980600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨38161232, 301357879⟩, ⟨(-355856875), (-33796868)⟩, ⟨(-7275235), 207289459⟩, ⟨(-79929356), 20372464⟩, ⟨(-13663451), 23864507⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨28312476, 250819912⟩, ⟨(-305455036), (-25979365)⟩, ⟨(-5293192), 183763001⟩, ⟨(-73259859), 17244407⟩, ⟨(-12049235), 22543323⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1031747781, 1031747782⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨147392540, 147392541⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4439564418, 4439564421⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar549 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2612
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar549 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨884355241, 1179140322⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4392399843, 4501599564⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2613
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((41181 / 200000) : ℝ)..(13727 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (41181 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (13727 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((41181 / 200000) : ℝ)..(13727 / 50000), prawitzNormalCorrection
      ((299207 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
