...
namespace FiniteNormalPanel65_16

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (24339 / 200000)
def radius : Rat := (8113 / 200000)

def j0 : Jet := ⟨⟨522676045, 522676046⟩, ⟨174225348, 174225349⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1642035223, 1642035227⟩, ⟨547345073, 547345077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨627776531, 627776535⟩, ⟨418517686, 418517692⟩, ⟨69752947, 69752949⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨157, 158⟩, ⟨104, 105⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94530), (-94528)⟩, ⟨104, 105⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-13818), (-13816)⟩, ⟨(-9197), (-9195)⟩, ⟨(-1524), (-1521)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5099238, 5099241⟩, ⟨(-9197), (-9195)⟩, ⟨(-1524), (-1521)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨745333, 745334⟩, ⟨495543, 495547⟩, ⟨81694, 81698⟩, ⟨(-299), (-296)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-142420244), (-142420242)⟩, ⟨495543, 495547⟩, ⟨81694, 81698⟩, ⟨(-299), (-296)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-20816943), (-20816942)⟩, ⟨(-13805531), (-13805529)⟩, ⟨(-2252767), (-2252763)⟩, ⟨15963, 15966⟩, ⟨1292, 1296⟩⟩
...
def j19 : Jet := ⟨⟨1410838822, 1410838824⟩, ⟨(-13805531), (-13805529)⟩, ⟨(-2252767), (-2252763)⟩, ⟨15963, 15966⟩, ⟨1292, 1296⟩⟩
...
def j25 : Jet := ⟨⟨1727, 1728⟩, ⟨1149, 1151⟩, ⟨188, 192⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850450), (-850448)⟩, ⟨1149, 1151⟩, ⟨188, 192⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-124307), (-124306)⟩, ⟨(-82705), (-82701)⟩, ⟨(-13674), (-13669)⟩, ⟨35, 38⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35667087, 35667089⟩, ⟨(-82705), (-82701)⟩, ⟨(-13674), (-13669)⟩, ⟨35, 38⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5213301, 5213302⟩, ⟨3463445, 3463447⟩, ⟨569196, 569201⟩, ⟨(-2672), (-2668)⟩, ⟨(-220), (-216)⟩⟩
...
def j33 : Jet := ⟨⟨(-710614582), (-710614580)⟩, ⟨3463445, 3463447⟩, ⟨569196, 569201⟩, ⟨(-2672), (-2668)⟩, ⟨(-220), (-216)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-103867418), (-103867416)⟩, ⟨(-68738710), (-68738706)⟩, ⟨(-11120138), (-11120133)⟩, ⟨111321, 111326⟩, ⟨8950, 8955⟩⟩
...
def j36 : Jet := ⟨⟨4191099878, 4191099880⟩, ⟨(-68738710), (-68738706)⟩, ⟨(-11120138), (-11120133)⟩, ⟨111321, 111326⟩, ⟨8950, 8955⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨539386421, 539386424⟩, ⟨174517395, 174517399⟩, ⟨(-2620630), (-2620625)⟩, ⟨(-280988), (-280984)⟩, ⟨2527, 2531⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4401408842, 4401408846⟩, ⟨72188006, 72188013⟩, ⟨12862102, 12862111⟩, ⟨285574, 285583⟩, ⟨27486, 27496⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨552753955, 552753960⟩, ⟨187908214, 187908221⟩, ⟨1862933, 1862943⟩, ⟨226490, 226500⟩, ⟨5072, 5084⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-522676046), (-522676045)⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3772291250, 3772291251⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨71138361, 71138363⟩, ⟨48366844, 48366848⟩, ⟨8700642, 8700650⟩, ⟨221304, 221314⟩, ⟨21930, 21939⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4366105657, 4366105659⟩, ⟨48366844, 48366848⟩, ⟨8700642, 8700650⟩, ⟨221304, 221314⟩, ⟨21930, 21939⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4330390398, 4330390400⟩, ⟨23985598, 23985601⟩, ⟨4248307, 4248313⟩, ⟨86214, 86221⟩, ⟨8312, 8319⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3803403537, 3803403541⟩, ⟨(-154595618), (-154595612)⟩, ⟨2758333, 2758340⟩, ⟨(-96611), (-96603)⟩, ⟨3802, 3810⟩⟩
...
def j47 : Jet := ⟨⟨4210136416, 4210136426⟩, ⟨1403378802, 1403378812⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4126981050, 4126981070⟩, ⟨2751320692, 2751320720⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4126981050, 4126981070⟩, ⟨2751320692, 2751320720⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4126981070), (-4126981050)⟩, ⟨(-2751320720), (-2751320692)⟩, ⟨(-458553455), (-458553447)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2063490535), (-2063490525)⟩, ⟨(-1375660360), (-1375660346)⟩, ⟨(-229276728), (-229276723)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2656475146, 2656475157⟩, ⟨(-850858067), (-850858054)⟩, ⟨(-5546513), (-5546504)⟩, ⟨30872877, 30872880⟩, ⟨(-2324071), (-2324069)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2352438626, 2352438639⟩, ⟨(-849095175), (-849095157)⟩, ⟨27420635, 27420652⟩, ⟨26932887, 26932900⟩, ⟨(-3151411), (-3151397)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨348450696, 696901394⟩, ⟨174225348, 174225349⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1094690146, 2189380300⟩, ⟨547345073, 547345077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨279011790, 1116047171⟩, ⟨279011790, 558023588⟩, ⟨69752947, 69752949⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨69, 280⟩, ⟨69, 140⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94618), (-94406)⟩, ⟨69, 140⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-24587), (-6132)⟩, ⟨(-12290), (-6095)⟩, ⟨(-1532), (-1509)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5088469, 5106925⟩, ⟨(-12290), (-6095)⟩, ⟨(-1532), (-1509)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨330559, 1327035⟩, ⟨327365, 663123⟩, ⟨80643, 82447⟩, ⟨(-400), (-194)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142835018), (-141838541)⟩, ⟨327365, 663123⟩, ⟨80643, 82447⟩, ⟨(-400), (-194)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-37115677), (-9214185)⟩, ⟨(-18536573), (-9041872)⟩, ⟨(-2293226), (-2195965)⟩, ⟨10450, 21470⟩, ⟨1250, 1326⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1394540088, 1422441581⟩, ⟨(-18536573), (-9041872)⟩, ⟨(-2293226), (-2195965)⟩, ⟨10450, 21470⟩, ⟨1250, 1326⟩⟩
...
def j72 : Jet := ⟨⟨766, 3075⟩, ⟨762, 1538⟩, ⟨188, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851411), (-849101)⟩, ⟨762, 1538⟩, ⟨188, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-221240), (-55159)⟩, ⟨(-110571), (-54759)⟩, ⟨(-13767), (-13538)⟩, ⟨23, 51⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35570154, 35736236⟩, ⟨(-110571), (-54759)⟩, ⟨(-13767), (-13538)⟩, ⟨23, 51⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2310725, 9286061⟩, ⟨2281993, 4639474⟩, ⟨559737, 575943⟩, ⟨(-3584), (-1754)⟩, ⟨(-223), (-210)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713517158), (-706541821)⟩, ⟨2281993, 4639474⟩, ⟨559737, 575943⟩, ⟨(-3584), (-1754)⟩, ⟨(-223), (-210)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-185407421), (-45898719)⟩, ⟨(-92555468), (-44693151)⟩, ⟨(-11403360), (-10722236)⟩, ⟨72489, 150065⟩, ⟨8566, 9228⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4109559875, 4249068577⟩, ⟨(-92555468), (-44693151)⟩, ⟨(-11403360), (-10722236)⟩, ⟨72489, 150065⟩, ⟨8566, 9228⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨355436767, 725096459⟩, ⟨168269275, 178969548⟩, ⟨(-3531261), (-1711985)⟩, ⟨(-289583), (-268905)⟩, ⟨1649, 3413⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4341361815, 4488739582⟩, ⟨45663922, 101095351⟩, ⟨11435439, 14732392⟩, ⟨76980, 535750⟩, ⟨16345, 43095⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨359276218, 757810003⟩, ⟨173865919, 204111351⟩, ⟨(-955189), 4969318⟩, ⟨68622, 414331⟩, ⟨(-12897), 25752⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-696901394), (-348450696)⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3598065902, 3946516600⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨30053639, 133709051⟩, ⟨29087946, 72027382⟩, ⟨6701250, 11453649⟩, ⟨(-79308), 618530⟩, ⟨(-104), 54220⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4325020935, 4428676347⟩, ⟨29087946, 72027382⟩, ⟨6701250, 11453649⟩, ⟨(-79308), 618530⟩, ⟨(-104), 54220⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4309967919, 4361309445⟩, ⟨14322737, 35888348⟩, ⟨3151997, 5683095⟩, ⟨(-86839), 297715⟩, ⟨(-6279), 26587⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3610632523, 4007476411⟩, ⟨(-164917790), (-141857121)⟩, ⟨1184742, 4641025⟩, ⟨(-310329), 145702⟩, ⟨(-17847), 27953⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2806757605, 5613515229⟩, ⟨1403378802, 1403378812⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1834213792, 7336855221⟩, ⟨1834213790, 3668427624⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1834213792, 7336855221⟩, ⟨1834213790, 3668427624⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7336855221), (-1834213792)⟩, ⟨(-3668427624), (-1834213790)⟩, ⟨(-458553455), (-458553447)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3668427611), (-917106896)⟩, ⟨(-1834213812), (-917106895)⟩, ⟨(-229276728), (-229276723)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1828181172, 3469162993⟩, ⟨(-1481544850), (-390372601)⟩, ⟨(-143514862), 218761998⟩, ⟨(-17248838), 73155734⟩, ⟨(-13649542), 5672180⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1536889559, 3236948713⟩, ⟨(-1515583772), (-388555350)⟩, ⟨(-120510667), 264755713⟩, ⟨(-26345843), 73779610⟩, ⟨(-15764670), 6320840⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨522676045, 522676046⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4330390398, 4330390400⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1292
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨348450696, 696901394⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4309967919, 4361309445⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1293
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (191697455 / 4294967296)

theorem envelope_integral : (∫ s in ((8113 / 100000) : ℝ)..(8113 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((8113 / 100000) : ℝ)..(8113 / 50000), prawitzNormalCorrection
