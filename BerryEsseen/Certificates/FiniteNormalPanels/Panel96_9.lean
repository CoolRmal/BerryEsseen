...
namespace FiniteNormalPanel96_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (51597 / 200000)
def radius : Rat := (7371 / 200000)

def j0 : Jet := ⟨⟨1108037137, 1108037138⟩, ⟨158291019, 158291020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3481001329, 3481001333⟩, ⟨497285902, 497285906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2821295115, 2821295122⟩, ⟨806084314, 806084324⟩, ⟨57577450, 57577452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨706, 707⟩, ⟨201, 202⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93981), (-93979)⟩, ⟨201, 202⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-61735), (-61733)⟩, ⟨(-17507), (-17505)⟩, ⟨(-1214), (-1211)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5051321, 5051324⟩, ⟨(-17507), (-17505)⟩, ⟨(-1214), (-1211)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3318131, 3318134⟩, ⟨936536, 936541⟩, ⟨63632, 63638⟩, ⟨(-461), (-457)⟩, ⟨(-17), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-139847446), (-139847442)⟩, ⟨936536, 936541⟩, ⟨63632, 63638⟩, ⟨(-461), (-457)⟩, ⟨(-17), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-91863545), (-91863541)⟩, ⟨(-25631532), (-25631526)⟩, ⟨(-1657199), (-1657191)⟩, ⟨24194, 24200⟩, ⟨754, 761⟩⟩
...
def j19 : Jet := ⟨⟨1339792220, 1339792225⟩, ⟨(-25631532), (-25631526)⟩, ⟨(-1657199), (-1657191)⟩, ⟨24194, 24200⟩, ⟨754, 761⟩⟩
...
def j22 : Jet := ⟨⟨(-71), (-70)⟩, ⟨(-21), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11764, 11766⟩, ⟨(-21), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7727, 7729⟩, ⟨2193, 2196⟩, ⟨151, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844450), (-844447)⟩, ⟨2193, 2196⟩, ⟨151, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-554706), (-554703)⟩, ⟨(-157048), (-157043)⟩, ⟨(-10811), (-10805)⟩, ⟨55, 60⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35236688, 35236692⟩, ⟨(-157048), (-157043)⟩, ⟨(-10811), (-10805)⟩, ⟨55, 60⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23146415, 23146418⟩, ⟨6510098, 6510104⟩, ⟨435798, 435805⟩, ⟨(-4100), (-4092)⟩, ⟨(-135), (-130)⟩⟩
...
def j33 : Jet := ⟨⟨(-692681468), (-692681464)⟩, ⟨6510098, 6510104⟩, ⟨435798, 435805⟩, ⟨(-4100), (-4092)⟩, ⟨(-135), (-130)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-455011346), (-455011341)⟩, ⟨(-125726865), (-125726856)⟩, ⟨(-7777856), (-7777847)⟩, ⟨166370, 166380⟩, ⟨4983, 4991⟩⟩
...
def j36 : Jet := ⟨⟨3839955950, 3839955955⟩, ⟨(-125726865), (-125726856)⟩, ⟨(-7777856), (-7777847)⟩, ⟨166370, 166380⟩, ⟨4983, 4991⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1085879862, 1085879869⟩, ⟨134351753, 134351760⟩, ⟨(-4310839), (-4310831)⟩, ⟨(-172269), (-172261)⟩, ⟨3412, 3419⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4803894703, 4803894710⟩, ⟨157287890, 157287905⟩, ⟨14880187, 14880203⟩, ⟨597641, 597661⟩, ⟨36645, 36662⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1214549997, 1214550007⟩, ⟨190038099, 190038113⟩, ⟨3860605, 3860622⟩, ⟨266017, 266036⟩, ⟨10529, 10548⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1108037138), (-1108037137)⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3186930158, 3186930159⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨343455862, 343455868⟩, ⟨107479640, 107479652⟩, ⟨10591995, 10592007⟩, ⟨492088, 492102⟩, ⟨32964, 32981⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4638423158, 4638423164⟩, ⟨107479640, 107479652⟩, ⟨10591995, 10592007⟩, ⟨492088, 492102⟩, ⟨32964, 32981⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4463392853, 4463392857⟩, ⟨51711954, 51711961⟩, ⟨4796591, 4796598⟩, ⟨181186, 181195⟩, ⟨11182, 11193⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3311904447, 3311904452⟩, ⟨(-126127300), (-126127291)⟩, ⟨1653297, 1653304⟩, ⟨(-42337), (-42328)⟩, ⟨1619, 1629⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨37361304750, 37361304757⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value439

def j47 : Jet := ⟨⟨9638656198, 9638656209⟩, ⟨1376950880, 1376950890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨21630826709, 21630826759⟩, ⟨6180236178, 6180236232⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨21630826709, 21630826759⟩, ⟨6180236178, 6180236232⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-21630826759), (-21630826709)⟩, ⟨(-6180236232), (-6180236178)⟩, ⟨(-441445446), (-441445439)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10815413380), (-10815413354)⟩, ⟨(-3090118116), (-3090118089)⟩, ⟨(-220722723), (-220722719)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨346207932, 346207942⟩, ⟨(-249087679), (-249087669)⟩, ⟨71814096, 71814103⟩, ⟨(-8688887), (-8688883)⟩, ⟨(-282444), (-282442)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨266965383, 266965392⟩, ⟨(-202241556), (-202241545)⟩, ⟨62824821, 62824832⟩, ⟨(-8908325), (-8908317)⟩, ⟨67590, 67600⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨949746118, 1266328158⟩, ⟨158291019, 158291020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2983715426, 3978287239⟩, ⟨497285902, 497285906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2072788249, 3684956897⟩, ⟨690929412, 921239228⟩, ⟨57577450, 57577452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨518, 924⟩, ⟨172, 231⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94169), (-93762)⟩, ⟨172, 231⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-80795), (-45250)⟩, ⟨(-20116), (-14884)⟩, ⟨(-1230), (-1193)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5032261, 5067807⟩, ⟨(-20116), (-14884)⟩, ⟨(-1230), (-1193)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2428612, 4348031⟩, ⟨792278, 1079825⟩, ⟨62090, 64969⟩, ⟨(-533), (-383)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140736965), (-138817545)⟩, ⟨792278, 1079825⟩, ⟨62090, 64969⟩, ⟨(-533), (-383)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-120748219), (-66994544)⟩, ⟨(-29804695), (-21405055)⟩, ⟨(-1729273), (-1573602)⟩, ⟨20151, 28228⟩, ⟨702, 805⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1310907546, 1364661222⟩, ⟨(-29804695), (-21405055)⟩, ⟨(-1729273), (-1573602)⟩, ⟨20151, 28228⟩, ⟨702, 805⟩⟩
...
def j72 : Jet := ⟨⟨5666, 10112⟩, ⟨1867, 2520⟩, ⟨149, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846511), (-842064)⟩, ⟨1867, 2520⟩, ⟨149, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-726282), (-406387)⟩, ⟨(-180670), (-133299)⟩, ⟨(-10978), (-10613)⟩, ⟨46, 68⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35065112, 35385008⟩, ⟨(-180670), (-133299)⟩, ⟨(-10978), (-10613)⟩, ⟨46, 68⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16922725, 30359307⟩, ⟨5485898, 7525496⟩, ⟨421903, 447801⟩, ⟨(-4756), (-3434)⟩, ⟨(-142), (-124)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698905158), (-685468575)⟩, ⟨5485898, 7525496⟩, ⟨421903, 447801⟩, ⟨(-4756), (-3434)⟩, ⟨(-142), (-124)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-599640278), (-330813044)⟩, ⟨(-147262530), (-103814357)⟩, ⟨(-8283253), (-7190885)⟩, ⟨137332, 195280⟩, ⟨4512, 5393⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3695327018, 3964154252⟩, ⟨(-147262530), (-103814357)⟩, ⟨(-8283253), (-7190885)⟩, ⟨137332, 195280⟩, ⟨4512, 5393⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨910687974, 1264040900⟩, ⟨124174217, 143135014⟩, ⟨(-5052658), (-3571530)⟩, ⟨(-186224), (-156049)⟩, ⟨2820, 4015⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4653387053, 4991911131⟩, ⟨121864173, 198932723⟩, ⟨11632548, 19117281⟩, ⟨279784, 1034825⟩, ⟨11834, 73884⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨986685889, 1469156668⟩, ⟨160376291, 224908900⟩, ⟨117249, 8386457⟩, ⟨(-54832), 671256⟩, ⟨(-17464), 46799⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1266328158), (-949746118)⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3028639138, 3345221178⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨226672050, 502546625⟩, ⟨73686718, 153866788⟩, ⟨6042403, 17514931⟩, ⟨(-28758), 1337552⟩, ⟨(-17689), 118696⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4521639346, 4797513921⟩, ⟨73686718, 153866788⟩, ⟨6042403, 17514931⟩, ⟨(-28758), 1337552⟩, ⟨(-17689), 118696⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4406846164, 4539291288⟩, ⟨34860292, 74980247⟩, ⟨2239323, 8397255⟩, ⟨(-156890), 634084⟩, ⟨(-27410), 59943⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3107531640, 3535517806⟩, ⟨(-142713498), (-104014449)⟩, ⟨(-1184317), 5255595⟩, ⟨(-431678), 411340⟩, ⟨(-44719), 52471⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8261705317, 11015607099⟩, ⟨1376950880, 1376950890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15892035966, 28252508436⟩, ⟨5297345298, 7063127124⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15892035966, 28252508436⟩, ⟨5297345298, 7063127124⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-28252508436), (-15892035966)⟩, ⟨(-7063127124), (-5297345298)⟩, ⟨(-441445446), (-441445439)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-14126254218), (-7946017983)⟩, ⟨(-3531563562), (-2648672649)⟩, ⟨(-220722723), (-220722719)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨160160165, 675276844⟩, ⟨(-555250584), (-98769517)⟩, ⟨(-4247969), 220048330⟩, ⟨(-56928126), 20187567⟩, ⟨(-9804092), 11811531⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨115880458, 555872290⟩, ⟨(-479507598), (-75341288)⟩, ⟨(-1291060), 200414921⟩, ⟨(-54921012), 16976872⟩, ⟨(-8862184), 11947917⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1108037137, 1108037138⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨158291019, 158291020⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4463392853, 4463392857⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar439 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1936
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar439 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨949746118, 1266328158⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4406846164, 4539291288⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1937
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((22113 / 100000) : ℝ)..(7371 / 25000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (22113 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (7371 / 25000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((22113 / 100000) : ℝ)..(7371 / 25000), prawitzNormalCorrection
      ((137541 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
