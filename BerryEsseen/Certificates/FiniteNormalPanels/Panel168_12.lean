...
namespace FiniteNormalPanel168_12
...
def j2 : Jet := ⟨⟨422365810, 422365814⟩, ⟨422365810, 422365814⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨41535328, 41535330⟩, ⟨83070656, 83070660⟩, ⟨41535328, 41535330⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨10, 11⟩, ⟨20, 21⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94677), (-94675)⟩, ⟨20, 21⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-916), (-915)⟩, ⟨(-1832), (-1830)⟩, ⟨(-916), (-913)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112140, 5112142⟩, ⟨(-1832), (-1830)⟩, ⟨(-916), (-913)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨49437, 49438⟩, ⟨98857, 98859⟩, ⟨49392, 49395⟩, ⟨(-36), (-33)⟩, ⟨(-9), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-143116140), (-143116138)⟩, ⟨98857, 98859⟩, ⟨49392, 49395⟩, ⟨(-36), (-33)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1384033), (-1384032)⟩, ⟨(-2767110), (-2767108)⟩, ⟨(-1381644), (-1381641)⟩, ⟨1910, 1913⟩, ⟨475, 478⟩⟩
...
def j19 : Jet := ⟨⟨1430271732, 1430271734⟩, ⟨(-2767110), (-2767108)⟩, ⟨(-1381644), (-1381641)⟩, ⟨1910, 1913⟩, ⟨475, 478⟩⟩
...
def j25 : Jet := ⟨⟨114, 115⟩, ⟨227, 229⟩, ⟨112, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852063), (-852061)⟩, ⟨227, 229⟩, ⟨112, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8241), (-8240)⟩, ⟨(-16479), (-16477)⟩, ⟨(-8236), (-8233)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35783153, 35783155⟩, ⟨(-16479), (-16477)⟩, ⟨(-8236), (-8233)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨346048, 346049⟩, ⟨691936, 691938⟩, ⟨345649, 345652⟩, ⟨(-320), (-317)⟩, ⟨(-81), (-77)⟩⟩
...
def j33 : Jet := ⟨⟨(-715481835), (-715481833)⟩, ⟨691936, 691938⟩, ⟨345649, 345652⟩, ⟨(-320), (-317)⟩, ⟨(-81), (-77)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-6919209), (-6919208)⟩, ⟨(-13831726), (-13831724)⟩, ⟨(-6902484), (-6902481)⟩, ⟨13372, 13375⟩, ⟨3334, 3337⟩⟩
...
def j36 : Jet := ⟨⟨4288048087, 4288048088⟩, ⟨(-13831726), (-13831724)⟩, ⟨(-6902484), (-6902481)⟩, ⟨13372, 13375⟩, ⟨3334, 3337⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨140652497, 140652500⟩, ⟨140380380, 140380384⟩, ⟨(-407988), (-407986)⟩, ⟨(-135684), (-135681)⟩, ⟨233, 237⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4301897668, 4301897670⟩, ⟨13876396, 13876400⟩, ⟨6969533, 6969539⟩, ⟨31398, 31405⟩, ⟨7926, 7934⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨140879454, 140879458⟩, ⟨141061325, 141061331⟩, ⟨273139, 273145⟩, ⟨91604, 91611⟩, ⟨416, 425⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-134443214), (-134443213)⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4160524082, 4160524083⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4620994, 4620995⟩, ⟨9253920, 9253922⟩, ⟨4650851, 4650854⟩, ⟨23948, 23954⟩, ⟨6059, 6064⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299588290, 4299588291⟩, ⟨9253920, 9253922⟩, ⟨4650851, 4650854⟩, ⟨23948, 23954⟩, ⟨6059, 6064⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297277171, 4297277173⟩, ⟨4624472, 4624474⟩, ⟨2321686, 2321689⟩, ⟨9468, 9473⟩, ⟨2389, 2394⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4162761652, 4162761656⟩, ⟨(-130035805), (-130035800)⟩, ⟨2104253, 2104258⟩, ⟨(-63504), (-63497)⟩, ⟨2017, 2024⟩⟩
...
def j47 : Jet := ⟨⟨1614831198, 1614831211⟩, ⟨1614831198, 1614831211⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨607147765, 607147776⟩, ⟨1214295530, 1214295552⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨607147765, 607147776⟩, ⟨1214295530, 1214295552⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-607147776), (-607147765)⟩, ⟨(-1214295552), (-1214295530)⟩, ⟨(-607147776), (-607147765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-303573888), (-303573882)⟩, ⟨(-607147776), (-607147765)⟩, ⟨(-303573888), (-303573882)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4001873543, 4001873549⟩, ⟨(-565715280), (-565715268)⟩, ⟨(-242872149), (-242872139)⟩, ⟨38101340, 38101343⟩, ⟨7236733, 7236735⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3878689771, 3878689782⟩, ⟨(-669463707), (-669463689)⟩, ⟨(-216307744), (-216307726)⟩, ⟨43945460, 43945475⟩, ⟨5751656, 5751670⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 268886428⟩, ⟨134443213, 134443214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 844731627⟩, ⟨422365810, 422365814⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 166141317⟩, ⟨0, 166141318⟩, ⟨41535328, 41535330⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 42⟩, ⟨0, 42⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94644)⟩, ⟨0, 42⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-3663), 0⟩, ⟨(-3663), 2⟩, ⟨(-916), (-912)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109393, 5113057⟩, ⟨(-3663), 2⟩, ⟨(-916), (-912)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 197788⟩, ⟨(-142), 197789⟩, ⟨49233, 49448⟩, ⟨(-72), 2⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142967788)⟩, ⟨(-142), 197789⟩, ⟨49233, 49448⟩, ⟨(-72), 2⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5538044), 0⟩, ⟨(-5538050), 7652⟩, ⟨(-1384518), (-1373033)⟩, ⟨(-5), 3827⟩, ⟨472, 480⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1426117721, 1431655766⟩, ⟨(-5538050), 7652⟩, ⟨(-1384518), (-1373033)⟩, ⟨(-5), 3827⟩, ⟨472, 480⟩⟩
...
def j72 : Jet := ⟨⟨0, 458⟩, ⟨(-1), 458⟩, ⟨112, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851718)⟩, ⟨(-1), 458⟩, ⟨112, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-32965), 0⟩, ⟨(-32966), 18⟩, ⟨(-8243), (-8213)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35758429, 35791395⟩, ⟨(-32966), 18⟩, ⟨(-8243), (-8213)⟩, ⟨(-2), 10⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1384512⟩, ⟨(-1276), 1384513⟩, ⟨344213, 346129⟩, ⟨(-639), 2⟩, ⟨(-82), (-77)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714443370)⟩, ⟨(-1276), 1384513⟩, ⟨344213, 346129⟩, ⟨(-639), 2⟩, ⟨(-82), (-77)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-27690220), 0⟩, ⟨(-27690270), 53557⟩, ⟨(-6922606), (-6842218)⟩, ⟨(-38), 26781⟩, ⟨3299, 3349⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4267277076, 4294967296⟩, ⟨(-27690270), 53557⟩, ⟨(-6922606), (-6842218)⟩, ⟨(-38), 26781⟩, ⟨3299, 3349⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 281577210⟩, ⟨139154772, 140790110⟩, ⟨(-816918), 753⟩, ⟨(-136155), (-134270)⟩, ⟨(-1), 472⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4322837197⟩, ⟨(-54255), 28050800⟩, ⟨6841868, 7194761⟩, ⟨(-27310), 92233⟩, ⟨7176, 8952⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 283404356⟩, ⟨139151215, 143542698⟩, ⟨(-823998), 1391959⟩, ⟨77507, 107635⟩, ⟨(-3157), 4091⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-268886428), 0⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4026080868, 4294967296⟩, ⟨(-134443214), (-134443213)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 18700499⟩, ⟨0, 18943394⟩, ⟨4399569, 4981059⟩, ⟨(-55078), 107248⟩, ⟨4336, 8188⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4313667795⟩, ⟨0, 18943394⟩, ⟨4399569, 4981059⟩, ⟨(-55078), 107248⟩, ⟨4336, 8188⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304307390⟩, ⟨0, 9471697⟩, ⟨2184589, 2490530⟩, ⟨(-33032), 53624⟩, ⟨1323, 3612⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4026080868, 4304307390⟩, ⟨(-134735583), (-124971516)⟩, ⟨1751334, 2490530⟩, ⟨(-110992), (-14759)⟩, ⟨(-439), 4646⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3229662421⟩, ⟨1614831198, 1614831211⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2428591101⟩, ⟨0, 2428591102⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2428591101⟩, ⟨0, 2428591102⟩, ⟨607147765, 607147776⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2428591101), 0⟩, ⟨(-2428591102), 0⟩, ⟨(-607147776), (-607147765)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1214295551), 0⟩, ⟨(-1214295551), 0⟩, ⟨(-303573888), (-303573882)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3237232265, 4294967296⟩, ⟨(-1214295551), 0⟩, ⟨(-303573888), (-57155806)⟩, ⟨0, 85827993⟩, ⟨(-4046512), 10728500⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3034565338, 4304307390⟩, ⟨(-1351671815), (-94194389)⟩, ⟨(-302914032), (-12993889)⟩, ⟨847945, 95526803⟩, ⟨(-6924259), 10764552⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297277171, 4297277173⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3404
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304307390⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3405
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (7451443 / 134217728)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(12521 / 200000), prawitzNormalCorrection
