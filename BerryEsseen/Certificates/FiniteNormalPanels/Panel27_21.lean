...
namespace FiniteNormalPanel27_21
...
def j2 : Jet := ⟨⟨1829149923, 1829149927⟩, ⟨609716639, 609716643⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨779002309, 779002313⟩, ⟨519334870, 519334876⟩, ⟨86555811, 86555813⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨194, 196⟩, ⟨129, 131⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94493), (-94490)⟩, ⟨129, 131⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-17139), (-17138)⟩, ⟨(-11403), (-11401)⟩, ⟨(-1887), (-1884)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5095917, 5095919⟩, ⟨(-11403), (-11401)⟩, ⟨(-1887), (-1884)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨924275, 924276⟩, ⟨614114, 614117⟩, ⟨100975, 100979⟩, ⟨(-459), (-454)⟩, ⟨(-39), (-35)⟩⟩
...
def j16 : Jet := ⟨⟨(-142241302), (-142241300)⟩, ⟨614114, 614117⟩, ⟨100975, 100979⟩, ⟨(-459), (-454)⟩, ⟨(-39), (-35)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-25799103), (-25799102)⟩, ⟨(-17088017), (-17088015)⟩, ⟨(-2773998), (-2773992)⟩, ⟨24501, 24506⟩, ⟨1970, 1976⟩⟩
...
def j19 : Jet := ⟨⟨1405856662, 1405856664⟩, ⟨(-17088017), (-17088015)⟩, ⟨(-2773998), (-2773992)⟩, ⟨24501, 24506⟩, ⟨1970, 1976⟩⟩
...
def j22 : Jet := ⟨⟨(-20), (-19)⟩, ⟨(-14), (-12)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11815, 11817⟩, ⟨(-14), (-12)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2142, 2144⟩, ⟨1425, 1427⟩, ⟨235, 238⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850035), (-850032)⟩, ⟨1425, 1427⟩, ⟨235, 238⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-154176), (-154175)⟩, ⟨(-102526), (-102524)⟩, ⟨(-16917), (-16913)⟩, ⟨55, 58⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35637218, 35637220⟩, ⟨(-102526), (-102524)⟩, ⟨(-16917), (-16913)⟩, ⟨55, 58⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6463722, 6463723⟩, ⟨4290552, 4290554⟩, ⟨702724, 702729⟩, ⟨(-4104), (-4100)⟩, ⟨(-335), (-331)⟩⟩
...
def j33 : Jet := ⟨⟨(-709364161), (-709364159)⟩, ⟨4290552, 4290554⟩, ⟨702724, 702729⟩, ⟨(-4104), (-4100)⟩, ⟨(-335), (-331)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-128661358), (-128661356)⟩, ⟨(-84996038), (-84996035)⟩, ⟨(-13649451), (-13649446)⟩, ⟨170692, 170696⟩, ⟨13603, 13607⟩⟩
...
def j36 : Jet := ⟨⟨4166305938, 4166305940⟩, ⟨(-84996038), (-84996035)⟩, ⟨(-13649451), (-13649446)⟩, ⟨170692, 170696⟩, ⟨13603, 13607⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨598729263, 598729266⟩, ⟨192298938, 192298943⟩, ⟨(-3607225), (-3607219)⟩, ⟨(-383365), (-383360)⟩, ⟨4316, 4321⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4427601894, 4427601897⟩, ⟨90326684, 90326690⟩, ⟨16348227, 16348236⟩, ⟨448038, 448046⟩, ⟨44536, 44545⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨617218860, 617218864⟩, ⟨210829165, 210829173⟩, ⟨2604566, 2604577⟩, ⟨323350, 323360⟩, ⟨8923, 8934⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-582236505), (-582236504)⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3712730791, 3712730792⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨88698957, 88698959⟩, ⟨60595448, 60595454⟩, ⟨11097664, 11097672⟩, ⟨348636, 348646⟩, ⟨35887, 35894⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4383666253, 4383666255⟩, ⟨60595448, 60595454⟩, ⟨11097664, 11097672⟩, ⟨348636, 348646⟩, ⟨35887, 35894⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4339090134, 4339090136⟩, ⟨29989635, 29989639⟩, ⟨5388770, 5388776⟩, ⟨135300, 135306⟩, ⟨13479, 13484⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3750872226, 3750872230⟩, ⟨(-170148471), (-170148465)⟩, ⟨3303097, 3303105⟩, ⟨(-126548), (-126541)⟩, ⟨5536, 5544⟩⟩
...
def j47 : Jet := ⟨⟨3321833926, 3321833932⟩, ⟨1107277971, 1107277978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2569188510, 2569188521⟩, ⟨1712792332, 1712792348⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2569188510, 2569188521⟩, ⟨1712792332, 1712792348⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2569188521), (-2569188510)⟩, ⟨(-1712792348), (-1712792332)⟩, ⟨(-285465392), (-285465387)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1284594261), (-1284594255)⟩, ⟨(-856396174), (-856396166)⟩, ⟨(-142732696), (-142732693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3184677511, 3184677522⟩, ⟨(-635009643), (-635009633)⟩, ⟨(-42525983), (-42525977)⟩, ⟨16895150, 16895152⟩, ⟨(-135581), (-135579)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2781236177, 2781236191⟩, ⟨(-680728827), (-680728811)⟩, ⟨(-9533093), (-9533076)⟩, ⟨15857338, 15857352⟩, ⟨(-797614), (-797600)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨388157669, 776315339⟩, ⟨194078834, 194078835⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1219433281, 2438866566⟩, ⟨609716639, 609716643⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨346223247, 1384892997⟩, ⟨346223246, 692446500⟩, ⟨86555811, 86555813⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨86, 347⟩, ⟨86, 174⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94601), (-94339)⟩, ⟨86, 174⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-30504), (-7604)⟩, ⟨(-15246), (-7547)⟩, ⟨(-1900), (-1864)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5082552, 5105453⟩, ⟨(-15246), (-7547)⟩, ⟨(-1900), (-1864)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨409711, 1646231⟩, ⟨404794, 822508⟩, ⟨99355, 102132⟩, ⟨(-615), (-299)⟩, ⟨(-39), (-34)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142755866), (-141519345)⟩, ⟨404794, 822508⟩, ⟨99355, 102132⟩, ⟨(-615), (-299)⟩, ⟨(-39), (-34)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-46030991), (-11408069)⟩, ⟨(-22982865), (-11142854)⟩, ⟨(-2836297), (-2686476)⟩, ⟨15967, 33019⟩, ⟨1889, 2033⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1385624774, 1420247697⟩, ⟨(-22982865), (-11142854)⟩, ⟨(-2836297), (-2686476)⟩, ⟨15967, 33019⟩, ⟨1889, 2033⟩⟩
...
def j72 : Jet := ⟨⟨951, 3814⟩, ⟨945, 1907⟩, ⟨233, 239⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851226), (-848362)⟩, ⟨945, 1907⟩, ⟨233, 239⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-274475), (-68387)⟩, ⟨(-137162), (-67772)⟩, ⟨(-17061), (-16710)⟩, ⟨36, 78⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35516919, 35723008⟩, ⟨(-137162), (-67772)⟩, ⟨(-17061), (-16710)⟩, ⟨36, 78⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2863067, 11518725⟩, ⟨2818839, 5753900⟩, ⟨688150, 713111⟩, ⟨(-5514), (-2686)⟩, ⟨(-342), (-321)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712964816), (-704309157)⟩, ⟨2818839, 5753900⟩, ⟨688150, 713111⟩, ⟨(-5514), (-2686)⟩, ⟨(-342), (-321)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-229892317), (-56775334)⟩, ⟨(-114718929), (-54920013)⟩, ⟨(-14085568), (-13036233)⟩, ⟨110501, 230712⟩, ⟨12868, 14131⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4065074979, 4238191962⟩, ⟨(-114718929), (-54920013)⟩, ⟨(-14085568), (-13036233)⟩, ⟨110501, 230712⟩, ⟨12868, 14131⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨393408575, 806477532⟩, ⟨183653630, 198455689⟩, ⟨(-4873237), (-2344595)⟩, ⟨(-398110), (-362624)⟩, ⟨2802, 5843⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4352503199, 4537860721⟩, ⟨56401298, 128061236⟩, ⟨14118708, 19337749⟩, ⟨109413, 871145⟩, ⟨22741, 76282⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨398678724, 852086283⟩, ⟨191280097, 233725363⟩, ⟨(-1443865), 7172369⟩, ⟨47810, 658839⟩, ⟨(-24213), 48283⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-776315339), (-388157669)⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3518651957, 3906809627⟩, ⟨(-194078835), (-194078834)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨37007202, 169046930⟩, ⟨35511006, 92738390⟩, ⟨7945923, 15564847⟩, ⟨(-148272), 1042038⟩, ⟨(-7762), 102842⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4331974498, 4464014226⟩, ⟨35511006, 92738390⟩, ⟨7945923, 15564847⟩, ⟨(-148272), 1042038⟩, ⟨(-7762), 102842⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4313431209, 4378675041⟩, ⟨17416068, 46170709⟩, ⟨3653587, 7713951⟩, ⟨(-156389), 504038⟩, ⟨(-16159), 51329⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3533778517, 3982952285⟩, ⟨(-183593266), (-152915140)⟩, ⟨906862, 6229815⟩, ⟨(-490831), 293390⟩, ⟨(-37476), 53758⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2214555948, 4429111904⟩, ⟨1107277971, 1107277978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1141861557, 4567446248⟩, ⟨1141861554, 2283723128⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1141861557, 4567446248⟩, ⟨1141861554, 2283723128⟩, ⟨285465387, 285465392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4567446248), (-1141861557)⟩, ⟨(-2283723128), (-1141861554)⟩, ⟨(-285465392), (-285465387)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2283723124), (-570930778)⟩, ⟨(-1141861564), (-570930777)⟩, ⟨(-142732696), (-142732693)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2523692770, 3760356477⟩, ⟨(-999729738), (-335474934)⟩, ⟨(-102668847), 49025523⟩, ⟨3087809, 31247569⟩, ⟨(-2891495), 1603358⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2076423562, 3487179155⟩, ⟨(-1087843434), (-365871224)⟩, ⟨(-82733410), 93652936⟩, ⟨(-1434926), 33552273⟩, ⟨(-4267176), 1609373⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4339090134, 4339090136⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified546
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4313431209, 4378675041⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified547
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (251096127 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((723 / 8000) : ℝ)..(723 / 4000), prawitzNormalCorrection
