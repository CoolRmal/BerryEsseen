...
namespace FiniteNormalPanel173_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (27617 / 160000)
def radius : Rat := (27617 / 800000)

def j0 : Jet := ⟨⟨741338198, 741338199⟩, ⟨148267639, 148267640⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2328982636, 2328982640⟩, ⟨465796525, 465796529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1262910691, 1262910697⟩, ⟨505164274, 505164280⟩, ⟨50516427, 50516429⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨316, 317⟩, ⟨126, 127⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94371), (-94369)⟩, ⟨126, 127⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-27750), (-27748)⟩, ⟨(-11063), (-11061)⟩, ⟨(-1093), (-1090)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5085306, 5085309⟩, ⟨(-11063), (-11061)⟩, ⟨(-1093), (-1090)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1495305, 1495307⟩, ⟨594868, 594871⟩, ⟨58188, 58193⟩, ⟨(-260), (-256)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-141670272), (-141670269)⟩, ⟨594868, 594871⟩, ⟨58188, 58193⟩, ⟨(-260), (-256)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-41657338), (-41657336)⟩, ⟨(-16488019), (-16488015)⟩, ⟨(-1579218), (-1579213)⟩, ⟨13762, 13767⟩, ⟨649, 653⟩⟩
...
def j19 : Jet := ⟨⟨1389998427, 1389998430⟩, ⟨(-16488019), (-16488015)⟩, ⟨(-1579218), (-1579213)⟩, ⟨13762, 13767⟩, ⟨649, 653⟩⟩
...
def j25 : Jet := ⟨⟨3470, 3472⟩, ⟨1384, 1386⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848707), (-848704)⟩, ⟨1384, 1386⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-249558), (-249556)⟩, ⟨(-99417), (-99414)⟩, ⟨(-9782), (-9777)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35541836, 35541839⟩, ⟨(-99417), (-99414)⟩, ⟨(-9782), (-9777)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10450874, 10450876⟩, ⟨4151115, 4151119⟩, ⟨403463, 403470⟩, ⟨(-2313), (-2308)⟩, ⟨(-114), (-109)⟩⟩
...
def j33 : Jet := ⟨⟨(-705377009), (-705377006)⟩, ⟨4151115, 4151119⟩, ⟨403463, 403470⟩, ⟨(-2313), (-2308)⟩, ⟨(-114), (-109)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-207412097), (-207412094)⟩, ⟨(-81744228), (-81744224)⟩, ⟨(-7689606), (-7689598)⟩, ⟨95597, 95603⟩, ⟨4438, 4443⟩⟩
...
def j36 : Jet := ⟨⟨4087555199, 4087555202⟩, ⟨(-81744228), (-81744224)⟩, ⟨(-7689606), (-7689598)⟩, ⟨95597, 95603⟩, ⟨4438, 4443⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨753738498, 753738502⟩, ⟨141806929, 141806935⟩, ⟨(-2644499), (-2644494)⟩, ⟨(-163807), (-163802)⟩, ⟨1843, 1849⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4512903963, 4512903968⟩, ⟨90250482, 90250489⟩, ⟨10294630, 10294641⟩, ⟨270103, 270115⟩, ⟨17750, 17760⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨791984948, 791984955⟩, ⟨164840908, 164840919⟩, ⟨2007751, 2007762⟩, ⟨159609, 159622⟩, ⟨4186, 4200⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-741338199), (-741338198)⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3553629097, 3553629098⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨146040729, 146040733⟩, ⟨60792786, 60792794⟩, ⟨7067048, 7067056⟩, ⟨212976, 212986⟩, ⟨14730, 14743⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4441008025, 4441008029⟩, ⟨60792786, 60792794⟩, ⟨7067048, 7067056⟩, ⟨212976, 212986⟩, ⟨14730, 14743⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4367377271, 4367377274⟩, ⟨29892428, 29892433⟩, ⟨3372639, 3372645⟩, ⟨81637, 81644⟩, ⟨5380, 5389⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3613540657, 3613540662⟩, ⟨(-126034515), (-126034508)⟩, ⟨1758575, 1758583⟩, ⟨(-48883), (-48875)⟩, ⟨1632, 1641⟩⟩
...
def j47 : Jet := ⟨⟨6653005542, 6653005553⟩, ⟨1330601103, 1330601113⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10305662346, 10305662381⟩, ⟨4122264920, 4122264960⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10305662346, 10305662381⟩, ⟨4122264920, 4122264960⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10305662381), (-10305662346)⟩, ⟨(-4122264960), (-4122264920)⟩, ⟨(-412226497), (-412226490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5152831191), (-5152831173)⟩, ⟨(-2061132480), (-2061132460)⟩, ⟨(-206113249), (-206113245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1293959545, 1293959564⟩, ⟨(-620964469), (-620964453)⟩, ⟨86902357, 86902366⟩, ⟨5965175, 5965179⟩, ⟨(-2800865), (-2800863)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1088663801, 1088663820⟩, ⟨(-560414961), (-560414941)⟩, ⟨91866512, 91866528⟩, ⟨2199650, 2199662⟩, ⟨(-2488397), (-2488386)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨593070559, 889605839⟩, ⟨148267639, 148267640⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1863186111, 2794779169⟩, ⟨465796525, 465796529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨808262844, 1818591404⟩, ⟨404131418, 606197136⟩, ⟨50516427, 50516429⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨202, 456⟩, ⟨101, 152⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94485), (-94230)⟩, ⟨101, 152⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-40008), (-17732)⟩, ⟨(-13317), (-8801)⟩, ⟨(-1101), (-1080)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073048, 5095325⟩, ⟨(-13317), (-8801)⟩, ⟨(-1101), (-1080)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨954688, 2157482⟩, ⟨471705, 717505⟩, ⟨57321, 58900⟩, ⟨(-313), (-202)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142210889), (-141008094)⟩, ⟨471705, 717505⟩, ⟨57321, 58900⟩, ⟨(-313), (-202)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-60215477), (-26536081)⟩, ⟨(-19983057), (-12964231)⟩, ⟨(-1617482), (-1532295)⟩, ⟨10808, 16716⟩, ⟨623, 673⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1371440288, 1405119685⟩, ⟨(-19983057), (-12964231)⟩, ⟨(-1617482), (-1532295)⟩, ⟨10808, 16716⟩, ⟨623, 673⟩⟩
...
def j72 : Jet := ⟨⟨2218, 5004⟩, ⟨1102, 1667⟩, ⟨134, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849959), (-847172)⟩, ⟨1102, 1667⟩, ⟨134, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-359893), (-159427)⟩, ⟨(-119758), (-79007)⟩, ⟨(-9870), (-9669)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35431501, 35631968⟩, ⟨(-119758), (-79007)⟩, ⟨(-9870), (-9669)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6667796, 15087424⟩, ⟨3283188, 5014274⟩, ⟨395654, 409843⟩, ⟨(-2799), (-1821)⟩, ⟨(-116), (-106)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709160087), (-700740458)⟩, ⟨3283188, 5014274⟩, ⟨395654, 409843⟩, ⟨(-2799), (-1821)⟩, ⟨(-116), (-106)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-300275264), (-131871196)⟩, ⟨(-99473898), (-63812434)⟩, ⟨(-7957595), (-7360690)⟩, ⟨74658, 116481⟩, ⟨4207, 4631⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3994692032, 4163096100⟩, ⟨(-99473898), (-63812434)⟩, ⟨(-7957595), (-7360690)⟩, ⟨74658, 116481⟩, ⟨4207, 4631⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨594940152, 914325758⟩, ⟨135731857, 146763656⟩, ⟨(-3219710), (-2070712)⟩, ⟨(-170731), (-155302)⟩, ⟨1442, 2251⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4431015674, 4617813821⟩, ⟨67919136, 114990578⟩, ⟨8875464, 12062321⟩, ⟨126926, 446627⟩, ⟨9280, 29217⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨613785613, 983054313⟩, ⟨149439508, 182275216⟩, ⟨(-85884), 4360912⟩, ⟨28300, 314297⟩, ⟨(-6832), 17169⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-889605839), (-593070559)⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3405361457, 3701896737⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨87714935, 225006553⟩, ⟨42712232, 83440188⟩, ⟨5160296, 9731923⟩, ⟨798, 514024⟩, ⟨(-1248), 38966⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4382682231, 4519973849⟩, ⟨42712232, 83440188⟩, ⟨5160296, 9731923⟩, ⟨798, 514024⟩, ⟨(-1248), 38966⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4338603099, 4406034483⟩, ⟨20817771, 41300492⟩, ⟨2321539, 4767078⟩, ⟨(-44985), 243289⟩, ⟨(-5554), 19095⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3439959085, 3797627212⟩, ⟨(-135595981), (-114176487)⟩, ⟨414939, 3390162⟩, ⟨(-203340), 129553⟩, ⟨(-13187), 18012⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5322404439, 7983606665⟩, ⟨1330601103, 1330601113⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6595623915, 14840153834⟩, ⟨3297811940, 4946717954⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6595623915, 14840153834⟩, ⟨3297811940, 4946717954⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14840153834), (-6595623915)⟩, ⟨(-4946717954), (-3297811940)⟩, ⟨(-412226497), (-412226490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7420076917), (-3297811957)⟩, ⟨(-2473358977), (-1648905970)⟩, ⟨(-206113249), (-206113245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨763244123, 1992942645⟩, ⟨(-1147683380), (-293021507)⟩, ⟨(-39392484), 293832686⟩, ⟨(-47028879), 44279519⟩, ⟨(-13425293), 7715887⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨611303503, 1762167835⟩, ⟨(-1077705215), (-254979013)⟩, ⟨(-26967635), 297614527⟩, ⟨(-51859946), 40427592⟩, ⟨(-13340476), 8601791⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨741338198, 741338199⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4367377271, 4367377274⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3494
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨593070559, 889605839⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4338603099, 4406034483⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3495
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (38698541 / 2147483648)

theorem envelope_integral : (∫ s in ((27617 / 200000) : ℝ)..(82851 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((27617 / 200000) : ℝ)..(82851 / 400000), prawitzNormalCorrection
