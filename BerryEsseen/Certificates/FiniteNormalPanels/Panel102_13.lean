...
namespace FiniteNormalPanel102_13
...
def j2 : Jet := ⟨⟨2909436254, 2909436258⟩, ⟨581887248, 581887253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1970869329, 1970869336⟩, ⟨788347728, 788347736⟩, ⟨78834772, 78834774⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨493, 494⟩, ⟨197, 198⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94194), (-94192)⟩, ⟨197, 198⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-43224), (-43222)⟩, ⟨(-17200), (-17198)⟩, ⟨(-1685), (-1681)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5069832, 5069835⟩, ⟨(-17200), (-17198)⟩, ⟨(-1685), (-1681)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2326438, 2326440⟩, ⟨922682, 922685⟩, ⟨89125, 89131⟩, ⟨(-624), (-619)⟩, ⟨(-30), (-27)⟩⟩
...
def j16 : Jet := ⟨⟨(-140839139), (-140839136)⟩, ⟨922682, 922685⟩, ⟨89125, 89131⟩, ⟨(-624), (-619)⟩, ⟨(-30), (-27)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-64628092), (-64628090)⟩, ⟨(-25427838), (-25427834)⟩, ⟨(-2374868), (-2374861)⟩, ⟨33007, 33014⟩, ⟨1506, 1512⟩⟩
...
def j19 : Jet := ⟨⟨1367027673, 1367027676⟩, ⟨(-25427838), (-25427834)⟩, ⟨(-2374868), (-2374861)⟩, ⟨33007, 33014⟩, ⟨1506, 1512⟩⟩
...
def j25 : Jet := ⟨⟨5407, 5409⟩, ⟨2153, 2156⟩, ⟨211, 214⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846770), (-846767)⟩, ⟨2153, 2156⟩, ⟨211, 214⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-388565), (-388563)⟩, ⟨(-154439), (-154435)⟩, ⟨(-15052), (-15047)⟩, ⟨76, 80⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35402829, 35402832⟩, ⟨(-154439), (-154435)⟩, ⟨(-15052), (-15047)⟩, ⟨76, 80⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16245606, 16245609⟩, ⟨6427373, 6427378⟩, ⟨614568, 614575⟩, ⟨(-5564), (-5558)⟩, ⟨(-264), (-259)⟩⟩
...
def j33 : Jet := ⟨⟨(-699582277), (-699582273)⟩, ⟨6427373, 6427378⟩, ⟨614568, 614575⟩, ⟨(-5564), (-5558)⟩, ⟨(-264), (-259)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-321023460), (-321023456)⟩, ⟨(-125459999), (-125459993)⟩, ⟨(-11379173), (-11379167)⟩, ⟨228225, 228233⟩, ⟨10136, 10143⟩⟩
...
def j36 : Jet := ⟨⟨3973943836, 3973943840⟩, ⟨(-125459999), (-125459993)⟩, ⟨(-11379173), (-11379167)⟩, ⟨228225, 228233⟩, ⟨10136, 10143⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨926032632, 926032636⟩, ⟨167981557, 167981563⟩, ⟨(-5053744), (-5053737)⟩, ⟨(-299391), (-299384)⟩, ⟨5491, 5498⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4641923695, 4641923700⟩, ⟨146548551, 146548561⟩, ⟨17918521, 17918533⟩, ⟨718734, 718749⟩, ⟨53732, 53747⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1000839475, 1000839482⟩, ⟨213148609, 213148620⟩, ⟨4133091, 4133104⟩, ⟨359764, 359780⟩, ⟨14328, 14345⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-926102324), (-926102323)⟩, ⟨(-185220465), (-185220464)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3368864972, 3368864973⟩, ⟨(-185220465), (-185220464)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨233221718, 233221723⟩, ⟨99338376, 99338384⟩, ⟨12504274, 12504284⟩, ⟨577898, 577910⟩, ⟨46361, 46374⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4528189014, 4528189019⟩, ⟨99338376, 99338384⟩, ⟨12504274, 12504284⟩, ⟨577898, 577910⟩, ⟨46361, 46374⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4410036703, 4410036706⟩, ⟨48373188, 48373193⟩, ⟨5823702, 5823708⟩, ⟨217529, 217537⟩, ⟨16343, 16352⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3459122538, 3459122542⟩, ⟨(-152240115), (-152240108)⟩, ⟨2481872, 2481878⟩, ⟨(-80524), (-80516)⟩, ⟨3437, 3447⟩⟩
...
def j47 : Jet := ⟨⟨5624625828, 5624625837⟩, ⟨1124925162, 1124925169⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7365927031, 7365927056⟩, ⟨2946370802, 2946370828⟩, ⟨294637079, 294637084⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7365927031, 7365927056⟩, ⟨2946370802, 2946370828⟩, ⟨294637079, 294637084⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7365927056), (-7365927031)⟩, ⟨(-2946370828), (-2946370802)⟩, ⟨(-294637084), (-294637079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3682963528), (-3682963515)⟩, ⟨(-1473185414), (-1473185401)⟩, ⟨(-147318542), (-147318539)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1822004319, 1822004334⟩, ⟨(-624952421), (-624952410)⟩, ⟨44684941, 44684946⟩, ⟨9181671, 9181674⟩, ⟨(-1553688), (-1553687)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1467423561, 1467423575⟩, ⟨(-567913326), (-567913310)⟩, ⟨59193811, 59193822⟩, ⟨5415619, 5415629⟩, ⟨(-1537787), (-1537776)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨740881858, 1111322788⟩, ⟨185220464, 185220465⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2327549002, 3491323507⟩, ⟨581887248, 581887253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1261356369, 2838051839⟩, ⟨630678182, 946017284⟩, ⟨78834772, 78834774⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-62360), (-27598)⟩, ⟨(-20741), (-13641)⟩, ⟨(-1705), (-1657)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5050696, 5085459⟩, ⟨(-20741), (-13641)⟩, ⟨(-1705), (-1657)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1483300, 3360398⟩, ⟨727944, 1116127⟩, ⟨87010, 90856⟩, ⟨(-756), (-486)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141682277), (-139805178)⟩, ⟨727944, 1116127⟩, ⟨87010, 90856⟩, ⟨(-756), (-486)⟩, ⟨(-32), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-93621586), (-41058322)⟩, ⟨(-30993412), (-19791640)⟩, ⟨(-2468155), (-2260267)⟩, ⟨25637, 40358⟩, ⟨1408, 1590⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1338034179, 1390597444⟩, ⟨(-30993412), (-19791640)⟩, ⟨(-2468155), (-2260267)⟩, ⟨25637, 40358⟩, ⟨1408, 1590⟩⟩
...
def j72 : Jet := ⟨⟨3454, 7801⟩, ⟨1711, 2597⟩, ⟨207, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848723), (-844375)⟩, ⟨1711, 2597⟩, ⟨207, 215⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-560824), (-247978)⟩, ⟨(-186440), (-122272)⟩, ⟨(-15268), (-14782)⟩, ⟨59, 96⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35230570, 35543417⟩, ⟨(-186440), (-122272)⟩, ⟨(-15268), (-14782)⟩, ⟨59, 96⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10346598, 23486573⟩, ⟨5050102, 7792949⟩, ⟨595507, 630110⟩, ⟨(-6769), (-4350)⟩, ⟨(-273), (-246)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705481285), (-692341309)⟩, ⟨5050102, 7792949⟩, ⟨595507, 630110⟩, ⟨(-6769), (-4350)⟩, ⟨(-273), (-246)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-466171759), (-203328467)⟩, ⟨(-153907461), (-96514765)⟩, ⟨(-12032764), (-10575171)⟩, ⟨175666, 280554⟩, ⟨9258, 10856⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3828795537, 4091638829⟩, ⟨(-153907461), (-96514765)⟩, ⟨(-12032764), (-10575171)⟩, ⟨175666, 280554⟩, ⟨9258, 10856⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨725113814, 1130398723⟩, ⟨156084307, 177674209⟩, ⟨(-6205357), (-3906288)⟩, ⟨(-320496), (-273416)⟩, ⟨4236, 6761⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4508399896, 4817897403⟩, ⟨106345445, 193666743⟩, ⟨14160829, 22926109⟩, ⟨278535, 1323362⟩, ⟨17106, 109467⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨761147365, 1268029463⟩, ⟨181794869, 250278216⟩, ⟨(-705409), 9945158⟩, ⟨(-77683), 912982⟩, ⟨(-30121), 71493⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1111322788), (-740881858)⟩, ⟨(-185220465), (-185220464)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3183644508, 3554085438⟩, ⟨(-185220465), (-185220464)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨134889341, 374368094⟩, ⟨64434802, 147782338⟩, ⟨7278381, 20456662⟩, ⟨(-128082), 1698150⟩, ⟨(-28474), 171649⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4429856637, 4669335390⟩, ⟨64434802, 147782338⟩, ⟨7278381, 20456662⟩, ⟨(-128082), 1698150⟩, ⟨(-28474), 171649⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4361890574, 4478241038⟩, ⟨30898891, 72757478⟩, ⟨2899213, 9961960⟩, ⟨(-229228), 815511⟩, ⟨(-38998), 87369⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3233251387, 3705744460⟩, ⟨(-170220344), (-127899716)⟩, ⟨(-988626), 6911008⟩, ⟨(-619297), 549808⟩, ⟨(-67440), 82184⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4499700660, 6749550999⟩, ⟨1124925162, 1124925169⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4714193295, 10606934943⟩, ⟨2357096640, 3535644990⟩, ⟨294637079, 294637084⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4714193295, 10606934943⟩, ⟨2357096640, 3535644990⟩, ⟨294637079, 294637084⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10606934943), (-4714193295)⟩, ⟨(-3535644990), (-2357096640)⟩, ⟨(-294637084), (-294637079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5303467472), (-2357096647)⟩, ⟨(-1767822495), (-1178548320)⟩, ⟨(-147318542), (-147318539)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1249363460, 2480945190⟩, ⟨(-1021165102), (-342828036)⟩, ⟨(-38060716), 167303934⟩, ⟨(-15114885), 28572799⟩, ⟨(-5809450), 2208081⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨940520814, 2140586473⟩, ⟨(-979398439), (-295285706)⟩, ⟨(-23201204), 188815068⟩, ⟨(-21672847), 26714011⟩, ⟨(-6375792), 2968123⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4410036703, 4410036706⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2060
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4361890574, 4478241038⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2061
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (64159153 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((69 / 400) : ℝ)..(207 / 800), prawitzNormalCorrection
