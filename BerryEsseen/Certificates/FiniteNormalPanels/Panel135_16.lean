...
namespace FiniteNormalPanel135_16
...
def j2 : Jet := ⟨⟨1420260279, 1420260283⟩, ⟨473420093, 473420097⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨469651832, 469651835⟩, ⟨313101220, 313101226⟩, ⟨52183536, 52183538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-10342), (-10340)⟩, ⟨(-6887), (-6884)⟩, ⟨(-1144), (-1140)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102714, 5102717⟩, ⟨(-6887), (-6884)⟩, ⟨(-1144), (-1140)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨557978, 557979⟩, ⟨371231, 371234⟩, ⟨61368, 61373⟩, ⟨(-168), (-165)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-142607599), (-142607597)⟩, ⟨371231, 371234⟩, ⟨61368, 61373⟩, ⟨(-168), (-165)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15594047), (-15594046)⟩, ⟨(-10355439), (-10355435)⟩, ⟨(-1698900), (-1698896)⟩, ⟨8964, 8968⟩, ⟨730, 733⟩⟩
...
def j19 : Jet := ⟨⟨1416061718, 1416061720⟩, ⟨(-10355439), (-10355435)⟩, ⟨(-1698900), (-1698896)⟩, ⟨8964, 8968⟩, ⟨730, 733⟩⟩
...
def j25 : Jet := ⟨⟨1292, 1294⟩, ⟨860, 863⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850885), (-850882)⟩, ⟨860, 863⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-93044), (-93043)⟩, ⟨(-61936), (-61933)⟩, ⟨(-10262), (-10259)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35698350, 35698352⟩, ⟨(-61936), (-61933)⟩, ⟨(-10262), (-10259)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3903590, 3903592⟩, ⟨2595620, 2595623⟩, ⟨428093, 428098⟩, ⟨(-1500), (-1496)⟩, ⟨(-125), (-121)⟩⟩
...
def j33 : Jet := ⟨⟨(-711924293), (-711924290)⟩, ⟨2595620, 2595623⟩, ⟨428093, 428098⟩, ⟨(-1500), (-1496)⟩, ⟨(-125), (-121)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-77848451), (-77848450)⟩, ⟨(-51615139), (-51615136)⟩, ⟨(-8413799), (-8413794)⟩, ⟨62578, 62583⟩, ⟨5077, 5080⟩⟩
...
def j36 : Jet := ⟨⟨4217118845, 4217118846⟩, ⟨(-51615139), (-51615136)⟩, ⟨(-8413799), (-8413794)⟩, ⟨62578, 62583⟩, ⟨5077, 5080⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨468263451, 468263454⟩, ⟨152663479, 152663483⟩, ⟨(-1703239), (-1703236)⟩, ⟨(-184301), (-184297)⟩, ⟨1229, 1232⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4374252836, 4374252838⟩, ⟨53538365, 53538370⟩, ⟨9382577, 9382586⟩, ⟨156737, 156748⟩, ⟨14572, 14580⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨476907642, 476907646⟩, ⟨161318740, 161318746⟩, ⟨1191271, 1191278⟩, ⟨141653, 141662⟩, ⟨2391, 2400⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-452082889), (-452082888)⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3842884407, 3842884408⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨52955210, 52955212⟩, ⟨35825250, 35825254⟩, ⟨6323677, 6323680⟩, ⟨120944, 120950⟩, ⟨11500, 11507⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4347922506, 4347922508⟩, ⟨35825250, 35825254⟩, ⟨6323677, 6323680⟩, ⟨120944, 120950⟩, ⟨11500, 11507⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4321363785, 4321363787⟩, ⟨17803208, 17803211⟩, ⟨3105851, 3105854⟩, ⟨47306, 47311⟩, ⟨4402, 4408⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3866502434, 3866502438⟩, ⟨(-135691187), (-135691181)⟩, ⟨2154285, 2154289⟩, ⟨(-66647), (-66640)⟩, ⟨2278, 2286⟩⟩
...
def j47 : Jet := ⟨⟨4043117180, 4043117190⟩, ⟨1347705726, 1347705736⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3806035158, 3806035177⟩, ⟨2537356770, 2537356796⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3806035158, 3806035177⟩, ⟨2537356770, 2537356796⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3806035177), (-3806035158)⟩, ⟨(-2537356796), (-2537356770)⟩, ⟨(-422892802), (-422892794)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1903017589), (-1903017579)⟩, ⟨(-1268678398), (-1268678385)⟩, ⟨(-211446401), (-211446397)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2757606601, 2757606613⟩, ⟨(-814561719), (-814561706)⟩, ⟨(-15454735), (-15454728)⟩, ⟨28256276, 28256279⟩, ⟨(-1706209), (-1706207)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2482508456, 2482508471⟩, ⟨(-820422496), (-820422478)⟩, ⟨13204695, 13204708⟩, ⟨25474334, 25474347⟩, ⟨(-2422354), (-2422341)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨301388592, 602777186⟩, ⟨150694296, 150694297⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨946840186, 1893680380⟩, ⟨473420093, 473420097⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨208734147, 834936598⟩, ⟨208734146, 417468302⟩, ⟨52183536, 52183538⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-18397), (-4591)⟩, ⟨(-9197), (-4570)⟩, ⟨(-1148), (-1133)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5094659, 5108466⟩, ⟨(-9197), (-4570)⟩, ⟨(-1148), (-1133)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨247598, 993080⟩, ⟨245810, 496318⟩, ⟨60781, 61791⟩, ⟨(-224), (-109)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142917979), (-142172496)⟩, ⟨245810, 496318⟩, ⟨60781, 61791⟩, ⟨(-224), (-109)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-27783088), (-6909541)⟩, ⟨(-13879598), (-6813057)⟩, ⟨(-1721544), (-1667130)⟩, ⟨5895, 12033⟩, ⟨713, 746⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1403872677, 1424746225⟩, ⟨(-13879598), (-6813057)⟩, ⟨(-1721544), (-1667130)⟩, ⟨5895, 12033⟩, ⟨713, 746⟩⟩
...
def j72 : Jet := ⟨⟨574, 2300⟩, ⟨571, 1150⟩, ⟨140, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851603), (-849876)⟩, ⟨571, 1150⟩, ⟨140, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-165551), (-41303)⟩, ⟨(-82749), (-41079)⟩, ⟨(-10314), (-10185)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35625843, 35750092⟩, ⟨(-82749), (-41079)⟩, ⟨(-10314), (-10185)⟩, ⟨11, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1731405, 6949776⟩, ⟨1715318, 3472892⟩, ⟨422801, 431871⟩, ⟨(-2009), (-987)⟩, ⟨(-127), (-119)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714096478), (-708878106)⟩, ⟨1715318, 3472892⟩, ⟨422801, 431871⟩, ⟨(-2009), (-987)⟩, ⟨(-127), (-119)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-138819517), (-34451267)⟩, ⟨(-69326396), (-33776140)⟩, ⟨(-8572309), (-8191296)⟩, ⟨40997, 84127⟩, ⟨4916, 5196⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4156147779, 4260516029⟩, ⟨(-69326396), (-33776140)⟩, ⟨(-8572309), (-8191296)⟩, ⟨40997, 84127⟩, ⟨4916, 5196⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨309488518, 628180330⟩, ⟨148624649, 155543123⟩, ⟨(-2288944), (-1118504)⟩, ⟨(-188462), (-178456)⟩, ⟨806, 1656⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4329697141, 4438423525⟩, ⟨34324587, 74034882⟩, ⟨8596418, 10389456⟩, ⟨46502, 283295⟩, ⟨10018, 20697⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨311991095, 649162186⟩, ⟨152299828, 171566735⟩, ⟨(-558174), 3073199⟩, ⟨66610, 228855⟩, ⟨(-5644), 11336⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-602777186), (-301388592)⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3692190110, 3993578704⟩, ⟨(-150694297), (-150694296)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨22663372, 98117521⟩, ⟨22126450, 51862858⟩, ⟨5231830, 7782402⟩, ⟨(-34918), 314706⟩, ⟨2614, 23911⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4317630668, 4393084817⟩, ⟨22126450, 51862858⟩, ⟨5231830, 7782402⟩, ⟨(-34918), 314706⟩, ⟨2614, 23911⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306284072, 4343749028⟩, ⟨10938981, 25863283⟩, ⟨2509540, 3867082⟩, ⟨(-40639), 150566⟩, ⟨(-1338), 11438⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3701918633, 4038937300⟩, ⟨(-143002117), (-127042967)⟩, ⟨1249892, 3211913⟩, ⟨(-173470), 51951⟩, ⟨(-6528), 12062⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2695411453, 5390822926⟩, ⟨1347705726, 1347705736⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1691571180, 6766284774⟩, ⟨1691571180, 3383142400⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1691571180, 6766284774⟩, ⟨1691571180, 3383142400⟩, ⟨422892794, 422892802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6766284774), (-1691571180)⟩, ⟨(-3383142400), (-1691571180)⟩, ⟨(-422892802), (-422892794)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3383142387), (-845785590)⟩, ⟨(-1691571200), (-845785590)⟩, ⟨(-211446401), (-211446397)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1953738507, 3527252144⟩, ⟨(-1389206886), (-384739571)⟩, ⟨(-135768480), 177384404⟩, ⟨(-10660133), 63419005⟩, ⟨(-10610812), 4391646⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1683966485, 3316986899⟩, ⟨(-1423834831), (-389405367)⟩, ⟨(-115726135), 215702049⟩, ⟨(-17112086), 64089645⟩, ⟨(-12213537), 4683455⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4321363785, 4321363787⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2724
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306284072, 4343749028⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2725
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (174578425 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((28069 / 400000) : ℝ)..(28069 / 200000), prawitzNormalCorrection
