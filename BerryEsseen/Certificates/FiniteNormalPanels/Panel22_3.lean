...
namespace FiniteNormalPanel22_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (44687 / 400000)
def radius : Rat := (44687 / 400000)

def j0 : Jet := ⟨⟨479823008, 479823009⟩, ⟨479823008, 479823009⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1507408436, 1507408441⟩, ⟨1507408436, 1507408441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨529056459, 529056464⟩, ⟨1058112918, 1058112928⟩, ⟨529056459, 529056464⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨132, 133⟩, ⟨264, 266⟩, ⟨132, 133⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94555), (-94553)⟩, ⟨264, 266⟩, ⟨132, 133⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11648), (-11647)⟩, ⟨(-23263), (-23261)⟩, ⟨(-11567), (-11564)⟩, ⟨64, 66⟩, ⟨16, 17⟩⟩
...
def j13 : Jet := ⟨⟨5101408, 5101410⟩, ⟨(-23263), (-23261)⟩, ⟨(-11567), (-11564)⟩, ⟨64, 66⟩, ⟨16, 17⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨628394, 628395⟩, ⟨1253922, 1253925⟩, ⟨621237, 621241⟩, ⟨(-5709), (-5704)⟩, ⟨(-1409), (-1404)⟩⟩
...
def j16 : Jet := ⟨⟨(-142537183), (-142537181)⟩, ⟨1253922, 1253925⟩, ⟨621237, 621241⟩, ⟨(-5709), (-5704)⟩, ⟨(-1409), (-1404)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17557810), (-17557809)⟩, ⟨(-34961162), (-34961158)⟩, ⟨(-17172369), (-17172365)⟩, ⟨306802, 306808⟩, ⟨74943, 74948⟩⟩
...
def j19 : Jet := ⟨⟨1414097955, 1414097957⟩, ⟨(-34961162), (-34961158)⟩, ⟨(-17172369), (-17172365)⟩, ⟨306802, 306808⟩, ⟨74943, 74948⟩⟩
...
def j22 : Jet := ⟨⟨(-14), (-13)⟩, ⟨(-27), (-26)⟩, ⟨(-14), (-13)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11821, 11823⟩, ⟨(-27), (-26)⟩, ⟨(-14), (-13)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1456, 1457⟩, ⟨2908, 2910⟩, ⟨1447, 1450⟩, ⟨(-8), (-6)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850721), (-850719)⟩, ⟨2908, 2910⟩, ⟨1447, 1450⟩, ⟨(-8), (-6)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-104793), (-104792)⟩, ⟨(-209227), (-209225)⟩, ⟨(-103899), (-103896)⟩, ⟨713, 717⟩, ⟨175, 178⟩⟩
...
def j30 : Jet := ⟨⟨35686601, 35686603⟩, ⟨(-209227), (-209225)⟩, ⟨(-103899), (-103896)⟩, ⟨713, 717⟩, ⟨175, 178⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4395895, 4395896⟩, ⟨8766017, 8766020⟩, ⟨4331550, 4331555⟩, ⟨(-51283), (-51278)⟩, ⟨(-12603), (-12598)⟩⟩
...
def j33 : Jet := ⟨⟨(-711431988), (-711431986)⟩, ⟨8766017, 8766020⟩, ⟨4331550, 4331555⟩, ⟨(-51283), (-51278)⟩, ⟨(-12603), (-12598)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-87634589), (-87634587)⟩, ⟨(-174189376), (-174189371)⟩, ⟨(-84941422), (-84941416)⟩, ⟨2140609, 2140615⟩, ⟨519374, 519381⟩⟩
...
def j36 : Jet := ⟨⟨4207332707, 4207332709⟩, ⟨(-174189376), (-174189371)⟩, ⟨(-84941422), (-84941416)⟩, ⟨2140609, 2140615⟩, ⟨519374, 519381⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨496307198, 496307201⟩, ⟨484036848, 484036853⟩, ⟨(-18297352), (-18297347)⟩, ⟨(-5919324), (-5919318)⟩, ⟨133980, 133986⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4384427224, 4384427228⟩, ⟨181521327, 181521334⟩, ⟨96031991, 96032001⟩, ⟨5409853, 5409864⟩, ⟨1529155, 1529168⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨506644786, 506644791⟩, ⟨515094649, 515094658⟩, ⟨12875760, 12875770⟩, ⟨4631876, 4631889⟩, ⟨263866, 263881⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-479823009), (-479823008)⟩, ⟨(-479823009), (-479823008)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3815144287, 3815144288⟩, ⟨(-479823009), (-479823008)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨59765050, 59765053⟩, ⟨121523634, 121523638⟩, ⟨64812917, 64812927⟩, ⟨4181148, 4181156⟩, ⟨1211851, 1211862⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4354732346, 4354732349⟩, ⟨121523634, 121523638⟩, ⟨64812917, 64812927⟩, ⟨4181148, 4181156⟩, ⟨1211851, 1211862⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4324746583, 4324746585⟩, ⟨60343423, 60343427⟩, ⟨31762326, 31762333⟩, ⟨1632996, 1633002⟩, ⟨462330, 462338⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3841596706, 3841596710⟩, ⟨(-429547871), (-429547864)⟩, ⟨21472501, 21472509⟩, ⟨(-2097848), (-2097839)⟩, ⟨228244, 228253⟩⟩
...
def j47 : Jet := ⟨⟨1809115149, 1809115154⟩, ⟨1809115149, 1809115154⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨762030860, 762030865⟩, ⟨1524061720, 1524061730⟩, ⟨762030860, 762030865⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨762030860, 762030865⟩, ⟨1524061720, 1524061730⟩, ⟨762030860, 762030865⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-762030865), (-762030860)⟩, ⟨(-1524061730), (-1524061720)⟩, ⟨(-762030865), (-762030860)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-381015433), (-381015430)⟩, ⟨(-762030865), (-762030860)⟩, ⟨(-381015433), (-381015430)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3930363331, 3930363335⟩, ⟨(-697341322), (-697341316)⟩, ⟨(-286808072), (-286808066)⟩, ⟨58203951, 58203953⟩, ⟨10139971, 10139973⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3515479812, 3515479821⟩, ⟨(-1016814107), (-1016814092)⟩, ⟨(-167140912), (-167140894)⟩, ⟨75338157, 75338173⟩, ⟨2364114, 2364129⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 959646018⟩, ⟨479823008, 479823009⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 3014816881⟩, ⟨1507408436, 1507408441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 2116225853⟩, ⟨0, 2116225854⟩, ⟨529056459, 529056464⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 531⟩, ⟨0, 531⟩, ⟨132, 133⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94155)⟩, ⟨0, 531⟩, ⟨132, 133⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-46655), 0⟩, ⟨(-46655), 262⟩, ⟨(-11664), (-11270)⟩, ⟨0, 132⟩, ⟨16, 17⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5066401, 5113057⟩, ⟨(-46655), 262⟩, ⟨(-11664), (-11270)⟩, ⟨0, 132⟩, ⟨16, 17⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2519317⟩, ⟨(-22988), 2519447⟩, ⟨595346, 629960⟩, ⟨(-11495), 99⟩, ⟨(-1437), (-1313)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-140646259)⟩, ⟨(-22988), 2519447⟩, ⟨595346, 629960⟩, ⟨(-11495), 99⟩, ⟨(-1437), (-1313)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-70540862), 0⟩, ⟨(-70552190), 1241388⟩, ⟨(-17646543), (-15773100)⟩, ⟨(-8496), 620792⟩, ⟨66962, 77648⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1361114903, 1431655766⟩, ⟨(-70552190), 1241388⟩, ⟨(-17646543), (-15773100)⟩, ⟨(-8496), 620792⟩, ⟨66962, 77648⟩⟩
...
def j70 : Jet := ⟨⟨(-54), 0⟩, ⟨(-54), 0⟩, ⟨(-14), (-13)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11781, 11836⟩, ⟨(-54), 0⟩, ⟨(-14), (-13)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 5832⟩, ⟨(-27), 5832⟩, ⟨1417, 1458⟩, ⟨(-14), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-846344)⟩, ⟨(-27), 5832⟩, ⟨1417, 1458⟩, ⟨(-14), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-419887), 0⟩, ⟨(-419901), 2874⟩, ⟨(-104986), (-100660)⟩, ⟨(-11), 1438⟩, ⟨166, 180⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35371507, 35791395⟩, ⟨(-419901), 2874⟩, ⟨(-104986), (-100660)⟩, ⟨(-11), 1438⟩, ⟨166, 180⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 17635216⟩, ⟨(-206895), 17636633⟩, ⟨4098457, 4410221⟩, ⟨(-103459), 1064⟩, ⟨(-12939), (-11601)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-698192666)⟩, ⟨(-206895), 17636633⟩, ⟨4098457, 4410221⟩, ⟨(-103459), 1064⟩, ⟨(-12939), (-11601)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-352704309), 0⟩, ⟨(-352806252), 8689962⟩, ⟨(-88278020), (-75140784)⟩, ⟨(-76463), 4346030⟩, ⟨447497, 543779⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3942262987, 4294967296⟩, ⟨(-352806252), 8689962⟩, ⟨(-88278020), (-75140784)⟩, ⟨(-76463), 4346030⟩, ⟨447497, 543779⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 1004938961⟩, ⟨428188161, 503340864⟩, ⟨(-37148611), 435692⟩, ⟨(-6199387), (-5100138)⟩, ⟨(-2982), 272385⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4679227169⟩, ⟨(-10314459), 418759634⟩, ⟨74293511, 142256855⟩, ⟨(-5703023), 22198969⟩, ⟨(-201409), 4696018⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 1094848311⟩, ⟨425774777, 646355125⟩, ⟨(-41680989), 82835789⟩, ⟨(-4303706), 16854737⟩, ⟨(-2553600), 4026420⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-959646018), 0⟩, ⟨(-479823009), (-479823008)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3335321278, 4294967296⟩, ⟨(-479823009), (-479823008)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 279092422⟩, ⟨0, 329530248⟩, ⟨20958351, 139502854⟩, ⟨(-14739404), 33525154⟩, ⟨(-3401130), 8723396⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4574059718⟩, ⟨0, 329530248⟩, ⟨20958351, 139502854⟩, ⟨(-14739404), 33525154⟩, ⟨(-3401130), 8723396⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4432317329⟩, ⟨0, 164765124⟩, ⟨7091988, 69751427⟩, ⟨(-10045533), 16762577⟩, ⟨(-2910009), 4741214⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3335321278, 4432317329⟩, ⟨(-495167412), (-315057884)⟩, ⟨(-12899759), 69751427⟩, ⟨(-17837989), 15970278⟩, ⟨(-4782683), 5863476⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3618230307⟩, ⟨1809115149, 1809115154⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3048123456⟩, ⟨0, 3048123458⟩, ⟨762030860, 762030865⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3048123456⟩, ⟨0, 3048123458⟩, ⟨762030860, 762030865⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3048123456), 0⟩, ⟨(-3048123458), 0⟩, ⟨(-762030865), (-762030860)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1524061728), 0⟩, ⟨(-1524061729), 0⟩, ⟨(-381015433), (-381015430)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3011973967, 4294967296⟩, ⟨(-1524061729), 0⟩, ⟨(-381015433), 3206898⟩, ⟨(-379321), 135202669⟩, ⟨(-12136354), 16933985⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2338993563, 4432317329⟩, ⟨(-2067967564), (-220943741)⟩, ⟨(-406099798), 248770182⟩, ⟨(-43350339), 204001418⟩, ⟨(-44749506), 30856875⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨479823008, 479823009⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨479823008, 479823009⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4324746583, 4324746585⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified430
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 959646018⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4432317329⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified431
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (48400735 / 268435456)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(44687 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(44687 / 200000), prawitzNormalCorrection
