...
namespace FiniteNormalPanel15_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (4891 / 20000)
def radius : Rat := (4891 / 100000)

def j0 : Jet := ⟨⟨1050334252, 1050334253⟩, ⟨210066850, 210066851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3299722369, 3299722374⟩, ⟨659944472, 659944476⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2535099096, 2535099105⟩, ⟨1014039634, 1014039644⟩, ⟨101403963, 101403965⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨634, 636⟩, ⟨253, 255⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94053), (-94050)⟩, ⟨253, 255⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-55515), (-55512)⟩, ⟨(-22057), (-22054)⟩, ⟨(-2148), (-2143)⟩, ⟨10, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5057541, 5057545⟩, ⟨(-22057), (-22054)⟩, ⟨(-2148), (-2143)⟩, ⟨10, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2985207, 2985210⟩, ⟨1181062, 1181067⟩, ⟨112932, 112939⟩, ⟨(-1024), (-1016)⟩, ⟨(-49), (-45)⟩⟩
...
def j16 : Jet := ⟨⟨(-140180370), (-140180366)⟩, ⟨1181062, 1181067⟩, ⟨112932, 112939⟩, ⟨(-1024), (-1016)⟩, ⟨(-49), (-45)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-82741290), (-82741286)⟩, ⟨(-32399396), (-32399390)⟩, ⟨(-2964147), (-2964138)⟩, ⟨53942, 53951⟩, ⟨2395, 2402⟩⟩
...
def j19 : Jet := ⟨⟨1348914475, 1348914480⟩, ⟨(-32399396), (-32399390)⟩, ⟨(-2964147), (-2964138)⟩, ⟨53942, 53951⟩, ⟨2395, 2402⟩⟩
...
def j22 : Jet := ⟨⟨(-64), (-63)⟩, ⟨(-26), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11771, 11773⟩, ⟨(-26), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6947, 6949⟩, ⟨2763, 2766⟩, ⟨268, 272⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845230), (-845227)⟩, ⟨2763, 2766⟩, ⟨268, 272⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-498896), (-498894)⟩, ⟨(-197929), (-197924)⟩, ⟨(-19146), (-19140)⟩, ⟨126, 131⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35292498, 35292501⟩, ⟨(-197929), (-197924)⟩, ⟨(-19146), (-19140)⟩, ⟨126, 131⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20831352, 20831355⟩, ⟨8215713, 8215718⟩, ⟨775222, 775229⟩, ⟨(-9121), (-9112)⟩, ⟨(-422), (-415)⟩⟩
...
def j33 : Jet := ⟨⟨(-694996531), (-694996527)⟩, ⟨8215713, 8215718⟩, ⟨775222, 775229⟩, ⟨(-9121), (-9112)⟩, ⟨(-422), (-415)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-410220839), (-410220834)⟩, ⟨(-159239022), (-159239014)⟩, ⟨(-14011536), (-14011528)⟩, ⟨371617, 371627⟩, ⟨15898, 15909⟩⟩
...
def j36 : Jet := ⟨⟨3884746457, 3884746462⟩, ⟨(-159239022), (-159239014)⟩, ⟨(-14011536), (-14011528)⟩, ⟨371617, 371627⟩, ⟨15898, 15909⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1036339268, 1036339275⟩, ⟨182376158, 182376167⟩, ⟨(-7255624), (-7255614)⟩, ⟨(-414015), (-414005)⟩, ⟨10128, 10136⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4748506563, 4748506570⟩, ⟨194645263, 194645276⟩, ⟨25105615, 25105628⟩, ⟨1276888, 1276907⟩, ⟨104823, 104843⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1145774455, 1145774466⟩, ⟨248600941, 248600956⟩, ⟨6301143, 6301161⟩, ⟨587599, 587620⟩, ⟨29534, 29553⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1050334253), (-1050334252)⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3244633043, 3244633044⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨305659859, 305659866⟩, ⟨132639244, 132639254⟩, ⟨17751427, 17751441⟩, ⟨1042952, 1042970⟩, ⟨93022, 93039⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4600627155, 4600627162⟩, ⟨132639244, 132639254⟩, ⟨17751427, 17751441⟩, ⟨1042952, 1042970⟩, ⟨93022, 93039⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4445170769, 4445170774⟩, ⟨64078664, 64078670⟩, ⟨8113942, 8113950⟩, ⟨386889, 386900⟩, ⟨31955, 31966⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3358104256, 3358104262⟩, ⟨(-169005078), (-169005069)⟩, ⟨2995589, 2995597⟩, ⟨(-104579), (-104568)⟩, ⟨5216, 5227⟩⟩
...
def j47 : Jet := ⟨⟨5034197782, 5034197790⟩, ⟨1006839554, 1006839560⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5900661300, 5900661319⟩, ⟨2360264514, 2360264534⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5900661300, 5900661319⟩, ⟨2360264514, 2360264534⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5900661319), (-5900661300)⟩, ⟨(-2360264534), (-2360264514)⟩, ⟨(-236026454), (-236026450)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2950330660), (-2950330650)⟩, ⟨(-1180132267), (-1180132257)⟩, ⟨(-118013227), (-118013225)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2160882174, 2160882186⟩, ⟨(-593747663), (-593747654)⟩, ⟨22197537, 22197542⟩, ⟨8843227, 8843229⟩, ⟨(-912428), (-912427)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1689528027, 1689528041⟩, ⟨(-549263000), (-549262986)⟩, ⟨42226425, 42226437⟩, ⟨5574050, 5574061⟩, ⟨(-1028817), (-1028804)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨840267401, 1260401103⟩, ⟨210066850, 210066851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2639777893, 3959666846⟩, ⟨659944472, 659944476⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1622463419, 3650542706⟩, ⟨811231708, 1216847572⟩, ⟨101403963, 101403965⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨406, 915⟩, ⟨203, 305⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94281), (-93771)⟩, ⟨203, 305⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-80135), (-35422)⟩, ⟨(-26636), (-17451)⟩, ⟨(-2179), (-2103)⟩, ⟨8, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5032921, 5077635⟩, ⟨(-26636), (-17451)⟩, ⟨(-2179), (-2103)⟩, ⟨8, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1901232, 4315778⟩, ⟨927976, 1432001⟩, ⟨109427, 115793⟩, ⟨(-1244), (-795)⟩, ⟨(-51), (-43)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141264345), (-138849798)⟩, ⟨927976, 1432001⟩, ⟨109427, 115793⟩, ⟨(-1244), (-795)⟩, ⟨(-51), (-43)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-120068790), (-52451788)⟩, ⟨(-39672379), (-25008752)⟩, ⟨(-3118633), (-2774102)⟩, ⟨41519, 66317⟩, ⟨2186, 2568⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1311586975, 1379203978⟩, ⟨(-39672379), (-25008752)⟩, ⟨(-3118633), (-2774102)⟩, ⟨41519, 66317⟩, ⟨2186, 2568⟩⟩
...
def j70 : Jet := ⟨⟨(-92), (-40)⟩, ⟨(-31), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11743, 11796⟩, ⟨(-31), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4436, 10027⟩, ⟨2191, 3336⟩, ⟨265, 276⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847741), (-842149)⟩, ⟨2191, 3336⟩, ⟨265, 276⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-720545), (-318129)⟩, ⟨(-239355), (-156228)⟩, ⟨(-19503), (-18702)⟩, ⟨99, 158⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35070849, 35473266⟩, ⟨(-239355), (-156228)⟩, ⟨(-19503), (-18702)⟩, ⟨99, 158⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13248335, 30150794⟩, ⟨6420725, 9991249⟩, ⟨743629, 800951⟩, ⟨(-11141), (-7085)⟩, ⟨(-442), (-390)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702579548), (-685677088)⟩, ⟨6420725, 9991249⟩, ⟨743629, 800951⟩, ⟨(-11141), (-7085)⟩, ⟨(-442), (-390)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-597163254), (-259020829)⟩, ⟨(-196628932), (-121018269)⟩, ⟨(-15094214), (-12677311)⟩, ⟨282578, 460142⟩, ⟨14024, 17426⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3697804042, 4035946467⟩, ⟨(-196628932), (-121018269)⟩, ⟨(-15094214), (-12677311)⟩, ⟨282578, 460142⟩, ⟨14024, 17426⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨806129142, 1271531979⟩, ⟨164957057, 196551090⟩, ⟨(-8971039), (-5547748)⟩, ⟨(-453677), (-365115)⟩, ⟨7722, 12558⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4570611682, 4988567232⟩, ⟨137050260, 265264638⟩, ⟨18466213, 34468352⟩, ⟨415447, 2566357⟩, ⟨18676, 249359⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨857865268, 1476873357⟩, ⟨201266924, 306824408⟩, ⟨(-1690135), 16439956⟩, ⟨(-293802), 1771583⟩, ⟨(-72338), 170354⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1260401103), (-840267401)⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3034566193, 3454699895⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨171347711, 507839703⟩, ⟨80401032, 211010126⟩, ⟨8269244, 33225093⟩, ⟨(-443538), 3567238⟩, ⟨(-98198), 433204⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4466315007, 4802806999⟩, ⟨80401032, 211010126⟩, ⟨8269244, 33225093⟩, ⟨(-443538), 3567238⟩, ⟨(-98198), 433204⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4379803293, 4541794689⟩, ⟨38015787, 103461450⟩, ⟨2731503, 16125781⟩, ⟨(-598404), 1725362⟩, ⟨(-118593), 225691⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3094506218, 3653237977⟩, ⟨(-195279505), (-130995926)⟩, ⟨(-3130384), 11111582⟩, ⟨(-1270045), 1254216⟩, ⟨(-179780), 210805⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4027358223, 6041037345⟩, ⟨1006839554, 1006839560⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3776423227, 8496952291⟩, ⟨1888211610, 2832317438⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3776423227, 8496952291⟩, ⟨1888211610, 2832317438⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8496952291), (-3776423227)⟩, ⟨(-2832317438), (-1888211610)⟩, ⟨(-236026454), (-236026450)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4248476146), (-1888211613)⟩, ⟨(-1416158719), (-944105805)⟩, ⟨(-118013227), (-118013225)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1597226205, 2767129267⟩, ⟨(-912392102), (-351097092)⟩, ⟨(-37444163), 106532174⟩, ⟨(-5277361), 20828685⟩, ⟨(-3180533), 949449⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1150794891, 2353680722⟩, ⟨(-901880934), (-301679190)⟩, ⟨(-23157879), 139257417⟩, ⟨(-12511274), 20892113⟩, ⟨(-4131474), 1728763⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1050334252, 1050334253⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4445170769, 4445170774⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified302
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨840267401, 1260401103⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4379803293, 4541794689⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified303
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (83340159 / 2147483648)

theorem envelope_integral : (∫ s in ((4891 / 25000) : ℝ)..(14673 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((4891 / 25000) : ℝ)..(14673 / 50000), prawitzNormalCorrection
