...
namespace FiniteNormalPanel23_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (81193 / 200000)
def radius : Rat := (11599 / 200000)

def j0 : Jet := ⟨⟨1743606398, 1743606399⟩, ⟨249086628, 249086629⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5477701050, 5477701055⟩, ⟨782528720, 782528724⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨6986132076, 6986132090⟩, ⟨1996037732, 1996037746⟩, ⟨142574123, 142574125⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1748, 1751⟩, ⟨499, 501⟩, ⟨35, 36⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-92939), (-92935)⟩, ⟨499, 501⟩, ⟨35, 36⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-151174), (-151166)⟩, ⟨(-42382), (-42375)⟩, ⟨(-2799), (-2793)⟩, ⟨32, 34⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨4961882, 4961891⟩, ⟨(-42382), (-42375)⟩, ⟨(-2799), (-2793)⟩, ⟨32, 34⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨8070925, 8070941⟩, ⟨2237040, 2237058⟩, ⟨140462, 140478⟩, ⟨(-2656), (-2648)⟩, ⟨(-78), (-72)⟩⟩
...
def j16 : Jet := ⟨⟨(-135094652), (-135094635)⟩, ⟨2237040, 2237058⟩, ⟨140462, 140478⟩, ⟨(-2656), (-2648)⟩, ⟨(-78), (-72)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-219743020), (-219742991)⟩, ⟨(-59144984), (-59144944)⟩, ⟨(-3216440), (-3216402)⟩, ⟨135216, 135240⟩, ⟨3300, 3317⟩⟩
...
def j19 : Jet := ⟨⟨1211912745, 1211912775⟩, ⟨(-59144984), (-59144944)⟩, ⟨(-3216440), (-3216402)⟩, ⟨135216, 135240⟩, ⟨3300, 3317⟩⟩
...
def j22 : Jet := ⟨⟨(-176), (-174)⟩, ⟨(-51), (-49)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11659, 11662⟩, ⟨(-51), (-49)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨18964, 18970⟩, ⟨5335, 5341⟩, ⟨356, 362⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-833213), (-833206)⟩, ⟨5335, 5341⟩, ⟨356, 362⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1355293), (-1355280)⟩, ⟨(-378550), (-378535)⟩, ⟨(-24602), (-24586)⟩, ⟨335, 344⟩, ⟨7, 13⟩⟩
...
def j30 : Jet := ⟨⟨34436101, 34436115⟩, ⟨(-378550), (-378535)⟩, ⟨(-24602), (-24586)⟩, ⟨335, 344⟩, ⟨7, 13⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨56013266, 56013290⟩, ⟨15388046, 15388079⟩, ⟨927182, 927219⟩, ⟨(-23457), (-23431)⟩, ⟨(-651), (-634)⟩⟩
...
def j33 : Jet := ⟨⟨(-659814617), (-659814592)⟩, ⟨15388046, 15388079⟩, ⟨927182, 927219⟩, ⟨(-23457), (-23431)⟩, ⟨(-651), (-634)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-1073244976), (-1073244932)⟩, ⟨(-281611449), (-281611379)⟩, ⟨(-13243398), (-13243318)⟩, ⟨903557, 903620⟩, ⟨18817, 18860⟩⟩
...
def j36 : Jet := ⟨⟨3221722320, 3221722364⟩, ⟨(-281611449), (-281611379)⟩, ⟨(-13243398), (-13243318)⟩, ⟨903557, 903620⟩, ⟨18817, 18860⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1545645230, 1545645271⟩, ⟨145374328, 145374387⟩, ⟨(-14878192), (-14878135)⟩, ⟨(-413574), (-413535)⟩, ⟨28843, 28872⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5725739834, 5725739913⟩, ⟨500488032, 500488172⟩, ⟨67284169, 67284338⟩, ⟨6332703, 6332849⟩, ⟨656228, 656334⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨2060542456, 2060542540⟩, ⟨373914958, 373915096⟩, ⟨21319580, 21319733⟩, ⟨2271291, 2271414⟩, ⟨207682, 207775⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1743606399), (-1743606398)⟩, ⟨(-249086629), (-249086628)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2551360897, 2551360898⟩, ⟨(-249086629), (-249086628)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨988560545, 988560627⟩, ⟨358776954, 358777104⟩, ⟨53009062, 53009237⟩, ⟨5891452, 5891602⟩, ⟨700571, 700687⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5283527841, 5283527923⟩, ⟨358776954, 358777104⟩, ⟨53009062, 53009237⟩, ⟨5891452, 5891602⟩, ⟨700571, 700687⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4763672877, 4763672915⟩, ⟨161738149, 161738219⟩, ⟨21151004, 21151087⟩, ⟨1937760, 1937833⟩, ⟨203068, 203126⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2829788416, 2829788441⟩, ⟨(-180191091), (-180191045)⟩, ⟨3184427, 3184483⟩, ⟨(-75561), (-75511)⟩, ⟨8244, 8284⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨15303273409, 15303273414⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value203

def j47 : Jet := ⟨⟨6212593388, 6212593394⟩, ⟨887513340, 887513345⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8986405237, 8986405256⟩, ⟨2567544350, 2567544368⟩, ⟨183396024, 183396027⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8986405237, 8986405256⟩, ⟨2567544350, 2567544368⟩, ⟨183396024, 183396027⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8986405256), (-8986405237)⟩, ⟨(-2567544368), (-2567544350)⟩, ⟨(-183396027), (-183396024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4493202628), (-4493202618)⟩, ⟨(-1283772184), (-1283772175)⟩, ⟨(-91698014), (-91698012)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1508760836, 1508760852⟩, ⟨(-450970888), (-450970879)⟩, ⟨35185729, 35185733⟩, ⟨2913161, 2913163⟩, ⟨(-593297), (-593296)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨994064364, 994064384⟩, ⟨(-360425905), (-360425877)⟩, ⟨43221193, 43221225⟩, ⟨82271, 82301⟩, ⟨(-476210), (-476183)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1494519769, 1992693027⟩, ⟨249086628, 249086629⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4695172326, 6260229775⟩, ⟨782528720, 782528724⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨5132668458, 9124743947⟩, ⟨1710889484, 2281185994⟩, ⟨142574123, 142574125⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1284, 2286⟩, ⟨428, 572⟩, ⟨35, 36⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93403), (-92400)⟩, ⟨428, 572⟩, ⟨35, 36⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-198437), (-110421)⟩, ⟨(-49099), (-35591)⟩, ⟨(-2890), (-2686)⟩, ⟨27, 39⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4914619, 5002636⟩, ⟨(-49099), (-35591)⟩, ⟨(-2890), (-2686)⟩, ⟨27, 39⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨5873178, 10628201⟩, ⟨1853414, 2614519⟩, ⟨130925, 148680⟩, ⟨(-3133), (-2167)⟩, ⟨(-85), (-63)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-137292399), (-132537375)⟩, ⟨1853414, 2614519⟩, ⟨130925, 148680⟩, ⟨(-3133), (-2167)⟩, ⟨(-85), (-63)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-291680449), (-158387796)⟩, ⟨(-70705205), (-47241333)⟩, ⟨(-3662746), (-2695136)⟩, ⟨107021, 163171⟩, ⟨2500, 3998⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1139975316, 1273267970⟩, ⟨(-70705205), (-47241333)⟩, ⟨(-3662746), (-2695136)⟩, ⟨107021, 163171⟩, ⟨2500, 3998⟩⟩
...
def j70 : Jet := ⟨⟨(-230), (-127)⟩, ⟨(-58), (-42)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11605, 11709⟩, ⟨(-58), (-42)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨13868, 24877⟩, ⟨4498, 6170⟩, ⟨345, 370⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-838309), (-827299)⟩, ⟨4498, 6170⟩, ⟨345, 370⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1781005), (-988657)⟩, ⟨(-439877), (-316443)⟩, ⟨(-25626), (-23397)⟩, ⟨275, 400⟩, ⟨5, 13⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34010389, 34802738⟩, ⟨(-439877), (-316443)⟩, ⟨(-25626), (-23397)⟩, ⟨275, 400⟩, ⟨5, 13⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨40643860, 73939114⟩, ⟨12613425, 18106617⟩, ⟨840921, 1001285⟩, ⟨(-27885), (-18974)⟩, ⟨(-737), (-535)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-675184023), (-641888768)⟩, ⟨12613425, 18106617⟩, ⟨840921, 1001285⟩, ⟨(-27885), (-18974)⟩, ⟨(-737), (-535)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1434441965), (-767084358)⟩, ⟨(-343536915), (-217226914)⟩, ⟨(-16383694), (-9563679)⟩, ⟨694445, 1110200⟩, ⟨11537, 25042⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨2860525331, 3527882938⟩, ⟨(-343536915), (-217226914)⟩, ⟨(-16383694), (-9563679)⟩, ⟨694445, 1110200⟩, ⟨11537, 25042⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1246198209, 1855881433⟩, ⟨104641680, 180341900⟩, ⟨(-18220974), (-11553481)⟩, ⟨(-550348), (-253210)⟩, ⟨22230, 35558⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5228842452, 6448726000⟩, ⟨321962300, 774464542⟩, ⟨33999383, 129945053⟩, ⟨936919, 18772208⟩, ⟨(-172215), 2899476⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1517165009, 2786533640⟩, ⟨220812786, 605427164⟩, ⟨(-9648835), 74603523⟩, ⟨(-3011715), 12393518⟩, ⟨(-675046), 1984061⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1992693027), (-1494519769)⟩, ⟨(-249086629), (-249086628)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2302274269, 2800447527⟩, ⟨(-249086629), (-249086628)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨535927169, 1807876334⟩, ⟨156000922, 785590690⟩, ⟨(-1167721), 182146326⟩, ⟨(-6628184), 37114116⟩, ⟨(-1892605), 7364375⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4830894465, 6102843630⟩, ⟨156000922, 785590690⟩, ⟨(-1167721), 182146326⟩, ⟨(-6628184), 37114116⟩, ⟨(-1892605), 7364375⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4555055843, 5119718138⟩, ⟨65435131, 370367175⟩, ⟨(-15607621), 85402988⟩, ⟨(-10068897), 18766513⟩, ⟨(-3218770), 4436946⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2441692133, 3338209819⟩, ⟨(-261842208), (-22679953)⟩, ⟨(-31656083), 51890401⟩, ⟨(-11518170), 13141494⟩, ⟨(-3187099), 3476968⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5325080044, 7100106735⟩, ⟨887513340, 887513345⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6602256902, 11737345636⟩, ⟨2200752298, 2934336420⟩, ⟨183396024, 183396027⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6602256902, 11737345636⟩, ⟨2200752298, 2934336420⟩, ⟨183396024, 183396027⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11737345636), (-6602256902)⟩, ⟨(-2934336420), (-2200752298)⟩, ⟨(-183396027), (-183396024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5868672818), (-3301128451)⟩, ⟨(-1467168210), (-1100376149)⟩, ⟨(-91698014), (-91698012)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1095309602, 1991404326⟩, ⟨(-680267141), (-280619729)⟩, ⟨(-6569130), 92805236⟩, ⟨(-6573303), 10430527⟩, ⟨(-1881473), 631489⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨622684331, 1547794202⟩, ⟨(-650134906), (-165316404)⟩, ⟨(-18301596), 137663627⟩, ⟨(-24326161), 19614584⟩, ⟨(-6341444), 5449261⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1743606398, 1743606399⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4763672877, 4763672915⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar203 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified460
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar203 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1494519769, 1992693027⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4555055843, 5119718138⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified461
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((34797 / 100000) : ℝ)..(11599 / 25000), prawitzNormalCorrection
      ((102857 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
