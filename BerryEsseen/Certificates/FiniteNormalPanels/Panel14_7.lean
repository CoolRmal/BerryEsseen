...
namespace FiniteNormalPanel14_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (67627 / 200000)
def radius : Rat := (9661 / 200000)

def j0 : Jet := ⟨⟨1452278766, 1452278767⟩, ⟨207468395, 207468396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4562468302, 4562468306⟩, ⟨651781185, 651781189⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4846629921, 4846629930⟩, ⟨1384751402, 1384751414⟩, ⟨98910814, 98910816⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1213, 1215⟩, ⟨346, 347⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93474), (-93471)⟩, ⟨346, 347⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-105481), (-105476)⟩, ⟨(-29748), (-29744)⟩, ⟨(-2015), (-2011)⟩, ⟨14, 17⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5007575, 5007581⟩, ⟨(-29748), (-29744)⟩, ⟨(-2015), (-2011)⟩, ⟨14, 17⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5650767, 5650775⟩, ⟨1580936, 1580944⟩, ⟨103455, 103464⟩, ⟨(-1321), (-1312)⟩, ⟨(-43), (-38)⟩⟩
...
def j16 : Jet := ⟨⟨(-137514810), (-137514801)⟩, ⟨1580936, 1580944⟩, ⟨103455, 103464⟩, ⟨(-1321), (-1312)⟩, ⟨(-43), (-38)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-155177758), (-155177747)⟩, ⟨(-42552506), (-42552492)⟩, ⟨(-2540438), (-2540421)⟩, ⟨68272, 68288⟩, ⟨1907, 1918⟩⟩
...
def j19 : Jet := ⟨⟨1276478007, 1276478019⟩, ⟨(-42552506), (-42552492)⟩, ⟨(-2540438), (-2540421)⟩, ⟨68272, 68288⟩, ⟨1907, 1918⟩⟩
...
def j25 : Jet := ⟨⟨13217, 13221⟩, ⟨3736, 3740⟩, ⟨253, 258⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-838960), (-838955)⟩, ⟨3736, 3740⟩, ⟨253, 258⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-946720), (-946713)⟩, ⟨(-266277), (-266268)⟩, ⟨(-17832), (-17822)⟩, ⟨164, 171⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34844674, 34844682⟩, ⟨(-266277), (-266268)⟩, ⟨(-17832), (-17822)⟩, ⟨164, 171⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨39320262, 39320272⟩, ⟨10933881, 10933896⟩, ⟨696479, 696496⟩, ⟨(-11698), (-11685)⟩, ⟨(-357), (-347)⟩⟩
...
def j33 : Jet := ⟨⟨(-676507621), (-676507610)⟩, ⟨10933881, 10933896⟩, ⟨696479, 696496⟩, ⟨(-11698), (-11685)⟩, ⟨(-357), (-347)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-763400943), (-763400929)⟩, ⟨(-205776284), (-205776261)⟩, ⟨(-11268455), (-11268427)⟩, ⟨463153, 463177⟩, ⟨11864, 11882⟩⟩
...
def j36 : Jet := ⟨⟨3531566353, 3531566367⟩, ⟨(-205776284), (-205776261)⟩, ⟨(-11268455), (-11268427)⟩, ⟨463153, 463177⟩, ⟨11864, 11882⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1355980160, 1355980175⟩, ⟨148508671, 148508691⟩, ⟨(-9156203), (-9156181)⟩, ⟨(-313000), (-312978)⟩, ⟨12385, 12402⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5223388762, 5223388783⟩, ⟨304354865, 304354903⟩, ⟨34400706, 34400755⟩, ⟨2290510, 2290556⟩, ⟨185732, 185771⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1649095567, 1649095593⟩, ⟨276700053, 276700093⟩, ⟨10249111, 10249159⟩, ⟨883132, 883181⟩, ⟨57380, 57422⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1452278767), (-1452278766)⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2842688529, 2842688530⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨633186704, 633186725⟩, ⟨212483494, 212483530⟩, ⟨25696689, 25696733⟩, ⟨1998756, 1998804⟩, ⟨182309, 182352⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4928154000, 4928154021⟩, ⟨212483494, 212483530⟩, ⟨25696689, 25696733⟩, ⟨1998756, 1998804⟩, ⟨182309, 182352⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4600680412, 4600680423⟩, ⟨99182031, 99182049⟩, ⟨10925487, 10925510⟩, ⟨697435, 697460⟩, ⟨57087, 57110⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3045029340, 3045029349⟩, ⟨(-156590755), (-156590740)⟩, ⟨2440208, 2440225⟩, ⟨(-66150), (-66130)⟩, ⟨4092, 4111⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨21072594243, 21072594249⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value147

def j47 : Jet := ⟨⟨7125381651, 7125381659⟩, ⟨1017911663, 1017911669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11821059433, 11821059461⟩, ⟨3377445546, 3377445572⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11821059433, 11821059461⟩, ⟨3377445546, 3377445572⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11821059461), (-11821059433)⟩, ⟨(-3377445572), (-3377445546)⟩, ⟨(-241246114), (-241246110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5910529731), (-5910529716)⟩, ⟨(-1688722786), (-1688722773)⟩, ⟨(-120623057), (-120623055)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1084687031, 1084687046⟩, ⟨(-426484210), (-426484199)⟩, ⟨53380737, 53380742⟩, ⟨988938, 988940⟩, ⟨(-846802), (-846801)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨769017225, 769017239⟩, ⟨(-341913873), (-341913858)⟩, ⟨54011177, 54011190⟩, ⟨(-1504101), (-1504089)⟩, ⟨(-598492), (-598479)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1244810371, 1659747162⟩, ⟨207468395, 207468396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3910687116, 5214249492⟩, ⟨651781185, 651781189⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3560789329, 6330292152⟩, ⟨1186929774, 1582573044⟩, ⟨98910814, 98910816⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨891, 1586⟩, ⟨297, 397⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93796), (-93100)⟩, ⟨297, 397⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-138245), (-77185)⟩, ⟨(-34316), (-25142)⟩, ⟨(-2060), (-1960)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4974811, 5035872⟩, ⟨(-34316), (-25142)⟩, ⟨(-2060), (-1960)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4124421, 7422302⟩, ⟨1324229, 1834732⟩, ⟨98885, 107402⟩, ⟨(-1542), (-1090)⟩, ⟨(-45), (-35)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139041156), (-135743274)⟩, ⟨1324229, 1834732⟩, ⟨98885, 107402⟩, ⟨(-1542), (-1090)⟩, ⟨(-45), (-35)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-204930813), (-112539437)⟩, ⟨(-50134838), (-34808959)⟩, ⟨(-2754108), (-2291749)⟩, ⟨55550, 80925⟩, ⟨1641, 2144⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1226724952, 1319116329⟩, ⟨(-50134838), (-34808959)⟩, ⟨(-2754108), (-2291749)⟩, ⟨55550, 80925⟩, ⟨1641, 2144⟩⟩
...
def j70 : Jet := ⟨⟨(-160), (-88)⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11675, 11748⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9679, 17316⟩, ⟨3167, 4305⟩, ⟨248, 262⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842498), (-834860)⟩, ⟨3167, 4305⟩, ⟨248, 262⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1241747), (-692149)⟩, ⟨(-307812), (-224370)⟩, ⟨(-18323), (-17252)⟩, ⟨135, 197⟩, ⟨1, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34549647, 35099246⟩, ⟨(-307812), (-224370)⟩, ⟨(-18323), (-17252)⟩, ⟨135, 197⟩, ⟨1, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨28643760, 51732288⟩, ⟨9094240, 12747056⟩, ⟨655233, 732010⟩, ⟨(-13730), (-9643)⟩, ⟨(-385), (-313)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-687184123), (-664095594)⟩, ⟨9094240, 12747056⟩, ⟨655233, 732010⟩, ⟨(-13730), (-9643)⟩, ⟨(-385), (-313)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1012831056), (-550575671)⟩, ⟨(-245668087), (-164737515)⟩, ⟨(-12769032), (-9517941)⟩, ⟨370274, 555289⟩, ⟨9461, 13935⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3282136240, 3744391625⟩, ⟨(-245668087), (-164737515)⟩, ⟨(-12769032), (-9517941)⟩, ⟨370274, 555289⟩, ⟨9461, 13935⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1116967169, 1601456117⟩, ⟨125295642, 168487492⟩, ⟨(-10951784), (-7369121)⟩, ⟨(-367370), (-249537)⟩, ⟨9923, 14884⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4926499661, 5620346849⟩, ⟨216745306, 420683288⟩, ⟨22058646, 53353926⟩, ⟨687944, 5074417⟩, ⟨3031, 548742⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1281206118, 2095647818⟩, ⟨200086815, 377340236⟩, ⟨(-2271683), 27944305⟩, ⟨(-731024), 3327003⟩, ⟨(-139793), 372713⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1659747162), (-1244810371)⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2635220134, 3050156925⟩, ⟨(-207468396), (-207468395)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨382188967, 1022531600⟩, ⟨119373412, 368232022⟩, ⟨7104462, 60421532⟩, ⟨(-1112544), 8156870⟩, ⟨(-279653), 1130130⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4677156263, 5317498896⟩, ⟨119373412, 368232022⟩, ⟨7104462, 60421532⟩, ⟨(-1112544), 8156870⟩, ⟨(-279653), 1130130⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4481989869, 4778962634⟩, ⟨53641861, 176433297⟩, ⟨(-68640), 28629143⟩, ⟨(-1660046), 3910955⟩, ⟨(-379383), 607055⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2749969703, 3393875895⟩, ⟨(-197935291), (-91204885)⟩, ⟨(-8571358), 17740389⟩, ⟨(-2561846), 2780759⟩, ⟨(-458346), 511302⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6107469987, 8143293323⟩, ⟨1017911663, 1017911669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8684859993, 15439751126⟩, ⟨2894953326, 3859937796⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8684859993, 15439751126⟩, ⟨2894953326, 3859937796⟩, ⟨241246110, 241246114⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15439751126), (-8684859993)⟩, ⟨(-3859937796), (-2894953326)⟩, ⟨(-241246114), (-241246110)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7719875563), (-4342429996)⟩, ⟨(-1929968898), (-1447476663)⟩, ⟨(-120623057), (-120623055)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨711784800, 1562665745⟩, ⟨(-702193074), (-239883523)⟩, ⟨(-3464665), 137777008⟩, ⟨(-16145593), 13666232⟩, ⟨(-3469967), 1862432⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨455739590, 1234815830⟩, ⟨(-626887858), (-168706912)⟩, ⟨(-762350), 147686610⟩, ⟨(-22940237), 13371797⟩, ⟨(-4268132), 3389730⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1452278766, 1452278767⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4600680412, 4600680423⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar147 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified280
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar147 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1244810371, 1659747162⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4481989869, 4778962634⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified281
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((28983 / 100000) : ℝ)..(9661 / 25000), prawitzNormalCorrection
      ((70817 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
