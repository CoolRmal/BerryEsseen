...
namespace FiniteNormalPanel88_15
...
def j2 : Jet := ⟨⟨515568969, 515568973⟩, ⟨515568969, 515568973⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨61889030, 61889032⟩, ⟨123778060, 123778064⟩, ⟨61889030, 61889032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨15, 16⟩, ⟨30, 32⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94672), (-94670)⟩, ⟨30, 32⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1365), (-1364)⟩, ⟨(-2729), (-2727)⟩, ⟨(-1365), (-1362)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111691, 5111693⟩, ⟨(-2729), (-2727)⟩, ⟨(-1365), (-1362)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨73657, 73658⟩, ⟨147275, 147277⟩, ⟨73558, 73561⟩, ⟨(-80), (-77)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-143091920), (-143091918)⟩, ⟨147275, 147277⟩, ⟨73558, 73561⟩, ⟨(-80), (-77)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2061907), (-2061906)⟩, ⟨(-4121691), (-4121689)⟩, ⟨(-2056604), (-2056601)⟩, ⟨4239, 4242⟩, ⟨1055, 1058⟩⟩
...
def j19 : Jet := ⟨⟨1429593858, 1429593860⟩, ⟨(-4121691), (-4121689)⟩, ⟨(-2056604), (-2056601)⟩, ⟨4239, 4242⟩, ⟨1055, 1058⟩⟩
...
def j25 : Jet := ⟨⟨170, 171⟩, ⟨340, 342⟩, ⟨168, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852007), (-852005)⟩, ⟨340, 342⟩, ⟨168, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-12278), (-12277)⟩, ⟨(-24551), (-24549)⟩, ⟨(-12267), (-12264)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779116, 35779118⟩, ⟨(-24551), (-24549)⟩, ⟨(-12267), (-12264)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨515564, 515566⟩, ⟨1030775, 1030778⟩, ⟨514679, 514683⟩, ⟨(-708), (-705)⟩, ⟨(-177), (-174)⟩⟩
...
def j33 : Jet := ⟨⟨(-715312319), (-715312316)⟩, ⟨1030775, 1030778⟩, ⟨514679, 514683⟩, ⟨(-708), (-705)⟩, ⟨(-177), (-174)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10307410), (-10307409)⟩, ⟨(-20599967), (-20599964)⟩, ⟨(-10270288), (-10270285)⟩, ⟨29674, 29677⟩, ⟨7392, 7395⟩⟩
...
def j36 : Jet := ⟨⟨4284659886, 4284659887⟩, ⟨(-20599967), (-20599964)⟩, ⟨(-10270288), (-10270285)⟩, ⟨29674, 29677⟩, ⟨7392, 7395⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨171608811, 171608813⟩, ⟨171114042, 171114045⟩, ⟨(-741645), (-741642)⟩, ⟨(-246368), (-246364)⟩, ⟨634, 638⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305299501, 4305299503⟩, ⟨20699195, 20699200⟩, ⟨10419275, 10419281⟩, ⟨69887, 69895⟩, ⟨17734, 17742⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨172021642, 172021645⟩, ⟨172352735, 172352740⟩, ⟨497548, 497554⟩, ⟨167366, 167374⟩, ⟨1139, 1148⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-164110701), (-164110700)⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4130856595, 4130856596⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6889795, 6889796⟩, ⟨13806112, 13806114⟩, ⟨6956196, 6956199⟩, ⟨53338, 53342⟩, ⟨13579, 13584⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301857091, 4301857092⟩, ⟨13806112, 13806114⟩, ⟨6956196, 6956199⟩, ⟨53338, 53342⟩, ⟨13579, 13584⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298410813, 4298410814⟩, ⟨6897525, 6897527⟩, ⟨3469777, 3469780⟩, ⟨21079, 21083⟩, ⟨5349, 5354⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4134168535, 4134168538⟩, ⟨(-157608308), (-157608303)⟩, ⟨3073641, 3073646⟩, ⟨(-112308), (-112302)⟩, ⟨4338, 4345⟩⟩
...
def j47 : Jet := ⟨⟨1293075797, 1293075806⟩, ⟨1293075797, 1293075806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨389303317, 389303323⟩, ⟨778606634, 778606646⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨389303317, 389303323⟩, ⟨778606634, 778606646⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-389303323), (-389303317)⟩, ⟨(-778606646), (-778606634)⟩, ⟨(-389303323), (-389303317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-194651662), (-194651658)⟩, ⟨(-389303323), (-389303317)⟩, ⟨(-194651662), (-194651658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4104660638, 4104660643⟩, ⟨(-372053597), (-372053590)⟩, ⟨(-169165007), (-169165001)⟩, ⟨16352331, 16352333⟩, ⟨3462801, 3462803⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3950986744, 3950986753⟩, ⟨(-508749135), (-508749121)⟩, ⟨(-146241315), (-146241300)⟩, ⟨21574215, 21574227⟩, ⟨2625902, 2625917⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 328221401⟩, ⟨164110700, 164110701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1031137943⟩, ⟨515568969, 515568973⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 247556125⟩, ⟨0, 247556126⟩, ⟨61889030, 61889032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5458), 0⟩, ⟨(-5458), 4⟩, ⟨(-1365), (-1358)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107598, 5113057⟩, ⟨(-5458), 4⟩, ⟨(-1365), (-1358)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 294710⟩, ⟨(-315), 294711⟩, ⟨73204, 73679⟩, ⟨(-158), 2⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142870866)⟩, ⟨(-315), 294711⟩, ⟨73204, 73679⟩, ⟨(-158), 2⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8251871), 0⟩, ⟨(-8251890), 16987⟩, ⟨(-2062987), (-2037486)⟩, ⟨(-15), 8495⟩, ⟨1042, 1063⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423403894, 1431655766⟩, ⟨(-8251890), 16987⟩, ⟨(-2062987), (-2037486)⟩, ⟨(-15), 8495⟩, ⟨1042, 1063⟩⟩
...
def j72 : Jet := ⟨⟨0, 683⟩, ⟨(-1), 683⟩, ⟨168, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851493)⟩, ⟨(-1), 683⟩, ⟨168, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-49119), 0⟩, ⟨(-49120), 40⟩, ⟨(-12281), (-12219)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35742275, 35791395⟩, ⟨(-49120), 40⟩, ⟨(-12281), (-12219)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2062968⟩, ⟨(-2832), 2062971⟩, ⟨511494, 515745⟩, ⟨(-1417), 3⟩, ⟨(-178), (-173)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713764914)⟩, ⟨(-2832), 2062971⟩, ⟨511494, 515745⟩, ⟨(-1417), 3⟩, ⟨(-178), (-173)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-41259355), 0⟩, ⟨(-41259519), 118907⟩, ⟨(-10315003), (-10136477)⟩, ⟨(-123), 59455⟩, ⟨7277, 7433⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4253707941, 4294967296⟩, ⟨(-41259519), 118907⟩, ⟨(-10315003), (-10136477)⟩, ⟨(-123), 59455⟩, ⟨7277, 7433⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 343712648⟩, ⟨168884648, 171860404⟩, ⟨(-1485842), 2040⟩, ⟨(-247646), (-242540)⟩, ⟨(-2), 1276⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4336626852⟩, ⟨(-121226), 42063805⟩, ⟨10135312, 10924083⟩, ⟨(-61216), 208089⟩, ⟨15242, 21165⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 347046531⟩, ⟨168874946, 176893619⟩, ⟨(-1505106), 2559437⟩, ⟨129035, 211276⟩, ⟨(-8659), 11323⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-328221401), 0⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3966745895, 4294967296⟩, ⟨(-164110701), (-164110700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 28042425⟩, ⟨0, 28587094⟩, ⟨6396802, 7699208⟩, ⟨(-123980), 244972⟩, ⟨7849, 20760⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4323009721⟩, ⟨0, 28587094⟩, ⟨6396802, 7699208⟩, ⟨(-123980), 244972⟩, ⟨7849, 20760⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4308965697⟩, ⟨0, 14293547⟩, ⟨3164303, 3849604⟩, ⟨(-74802), 122486⟩, ⟨1785, 9464⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3966745895, 4308965697⟩, ⟨(-164645580), (-149817153)⟩, ⟨2376329, 3849604⟩, ⟨(-221896), 1578⟩, ⟨(-3033), 12323⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2586151603⟩, ⟨1293075797, 1293075806⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1557213281⟩, ⟨0, 1557213288⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1557213281⟩, ⟨0, 1557213288⟩, ⟨389303317, 389303323⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1557213281), 0⟩, ⟨(-1557213288), 0⟩, ⟨(-389303323), (-389303317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-778606641), 0⟩, ⟨(-778606644), 0⟩, ⟨(-194651662), (-194651658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3582856744, 4294967296⟩, ⟨(-778606644), 0⟩, ⟨(-194651662), (-91803924)⟩, ⟨0, 35287132⟩, ⟨481073, 4410892⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3309054831, 4308965697⟩, ⟨(-945789903), (-124977295)⟩, ⟨(-193303752), (-51091139)⟩, ⟨2282540, 42865602⟩, ⟨(-1086195), 4427026⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298410813, 4298410814⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1786
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4308965697⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1787
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (298276817 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(3821 / 50000), prawitzNormalCorrection
