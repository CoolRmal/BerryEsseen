...
namespace FiniteNormalPanel164_19
...
def j2 : Jet := ⟨⟨1380944940, 1380944945⟩, ⟨460314980, 460314984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨444010115, 444010120⟩, ⟨296006742, 296006748⟩, ⟨49334457, 49334459⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨111, 112⟩, ⟨74, 75⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94576), (-94574)⟩, ⟨74, 75⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9778), (-9776)⟩, ⟨(-6512), (-6509)⟩, ⟨(-1081), (-1078)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103278, 5103281⟩, ⟨(-6512), (-6509)⟩, ⟨(-1081), (-1078)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨527572, 527573⟩, ⟨351041, 351044⟩, ⟨58058, 58061⟩, ⟨(-150), (-147)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-142638005), (-142638003)⟩, ⟨351041, 351044⟩, ⟨58058, 58061⟩, ⟨(-150), (-147)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14745798), (-14745797)⟩, ⟨(-9794242), (-9794240)⟩, ⟨(-1608228), (-1608224)⟩, ⟨8017, 8020⟩, ⟨653, 656⟩⟩
...
def j19 : Jet := ⟨⟨1416909967, 1416909969⟩, ⟨(-9794242), (-9794240)⟩, ⟨(-1608228), (-1608224)⟩, ⟨8017, 8020⟩, ⟨653, 656⟩⟩
...
def j25 : Jet := ⟨⟨1222, 1223⟩, ⟨813, 815⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850955), (-850953)⟩, ⟨813, 815⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-87972), (-87970)⟩, ⟨(-58564), (-58562)⟩, ⟨(-9706), (-9702)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35703422, 35703425⟩, ⟨(-58564), (-58562)⟩, ⟨(-9706), (-9702)⟩, ⟨17, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3690989, 3690991⟩, ⟨2454604, 2454607⟩, ⟨405068, 405073⟩, ⟨(-1341), (-1337)⟩, ⟨(-112), (-108)⟩⟩
...
def j33 : Jet := ⟨⟨(-712136894), (-712136891)⟩, ⟨2454604, 2454607⟩, ⟨405068, 405073⟩, ⟨(-1341), (-1337)⟩, ⟨(-112), (-108)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-73620116), (-73620114)⟩, ⟨(-48826324), (-48826319)⟩, ⟨(-7968970), (-7968964)⟩, ⟨55972, 55976⟩, ⟨4547, 4550⟩⟩
...
def j36 : Jet := ⟨⟨4221347180, 4221347182⟩, ⟨(-48826324), (-48826319)⟩, ⟨(-7968970), (-7968964)⟩, ⟨55972, 55976⟩, ⟨4547, 4550⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨455573818, 455573821⟩, ⟨148708832, 148708836⟩, ⟨(-1566791), (-1566787)⟩, ⟨(-169786), (-169783)⟩, ⟨1068, 1071⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4369871341, 4369871344⟩, ⟨50544226, 50544234⟩, ⟨8833965, 8833974⟩, ⟨139646, 139654⟩, ⟨12909, 12917⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨463519005, 463519010⟩, ⟨156663611, 156663618⟩, ⟨1092957, 1092966⟩, ⟨129491, 129500⟩, ⟨2068, 2077⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-439568428), (-439568427)⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3855398868, 3855398869⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨50023633, 50023635⟩, ⟨33814720, 33814724⟩, ⟨5950381, 5950387⟩, ⟨107680, 107688⟩, ⟨10170, 10177⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4344990929, 4344990931⟩, ⟨33814720, 33814724⟩, ⟨5950381, 5950387⟩, ⟨107680, 107688⟩, ⟨10170, 10177⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4319906705, 4319906707⟩, ⟨16809751, 16809754⟩, ⟨2925308, 2925313⟩, ⟨42145, 42151⟩, ⟨3900, 3906⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3877785853, 3877785856⟩, ⟨(-132284262), (-132284256)⟩, ⟨2052452, 2052458⟩, ⟨(-61967), (-61958)⟩, ⟨2062, 2070⟩⟩
...
def j47 : Jet := ⟨⟨3927297755, 3927297765⟩, ⟨1309099251, 1309099261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3591102467, 3591102487⟩, ⟨2394068310, 2394068336⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3591102467, 3591102487⟩, ⟨2394068310, 2394068336⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3591102487), (-3591102467)⟩, ⟨(-2394068336), (-2394068310)⟩, ⟨(-399011392), (-399011384)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1795551244), (-1795551233)⟩, ⟨(-1197034168), (-1197034155)⟩, ⟨(-199505696), (-199505692)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2827476418, 2827476428⟩, ⟨(-788035313), (-788035300)⟩, ⟨(-21524046), (-21524038)⟩, ⟨26402999, 26403002⟩, ⟨(-1339764), (-1339762)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2552836214, 2552836226⟩, ⟨(-798577169), (-798577151)⟩, ⟨6189169, 6189184⟩, ⟨24083964, 24083978⟩, ⟨(-2020400), (-2020386)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨293045618, 586091238⟩, ⟨146522809, 146522810⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨920629960, 1841259928⟩, ⟨460314980, 460314984⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨197337829, 789351325⟩, ⟨197337828, 394675664⟩, ⟨49334457, 49334459⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-17394), (-4341)⟩, ⟨(-8695), (-4322)⟩, ⟨(-1086), (-1072)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5095662, 5108716⟩, ⟨(-8695), (-4322)⟩, ⟨(-1086), (-1072)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨234126, 938907⟩, ⟨232527, 469256⟩, ⟨57531, 58435⟩, ⟨(-200), (-97)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142931451), (-142226669)⟩, ⟨232527, 469256⟩, ⟨57531, 58435⟩, ⟨(-200), (-97)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-26268683), (-6534788)⟩, ⟨(-13123659), (-6448545)⟩, ⟨(-1628467), (-1579835)⟩, ⟨5276, 10757⟩, ⟨638, 668⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1405387082, 1425120978⟩, ⟨(-13123659), (-6448545)⟩, ⟨(-1628467), (-1579835)⟩, ⟨5276, 10757⟩, ⟨638, 668⟩⟩
...
def j72 : Jet := ⟨⟨542, 2175⟩, ⟨540, 1088⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851635), (-850001)⟩, ⟨540, 1088⟩, ⟨133, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-156518), (-39054)⟩, ⟨(-78235), (-38854)⟩, ⟨(-9753), (-9638)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35634876, 35752341⟩, ⟨(-78235), (-38854)⟩, ⟨(-9753), (-9638)⟩, ⟨11, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1637290, 6570751⟩, ⟨1622911, 3283591⟩, ⟨400339, 408445⟩, ⟨(-1796), (-883)⟩, ⟨(-114), (-106)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714190593), (-709257131)⟩, ⟨1622911, 3283591⟩, ⟨400339, 408445⟩, ⟨(-1796), (-883)⟩, ⟨(-114), (-106)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-131257645), (-32587736)⟩, ⟨(-65554257), (-31984260)⟩, ⟨(-8110643), (-7770129)⟩, ⟨36704, 75212⟩, ⟨4411, 4648⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4163709651, 4262379560⟩, ⟨(-65554257), (-31984260)⟩, ⟨(-8110643), (-7770129)⟩, ⟨36704, 75212⟩, ⟨4411, 4648⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨301245938, 610951835⟩, ⟨144996833, 151355709⟩, ⟨(-2104661), (-1029764)⟩, ⟨(-173402), (-164707)⟩, ⟨701, 1440⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4327804179, 4430362735⟩, ⟨32475196, 69752496⟩, ⟨8133083, 9728265⟩, ⟨42053, 250889⟩, ⟨9077, 18032⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨303549093, 630211608⟩, ⟨148383183, 166049253⟩, ⟨(-504208), 2804290⟩, ⟨64469, 204764⟩, ⟨(-4824), 9700⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-586091238), (-293045618)⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3708876058, 4001921678⟩, ⟨(-146522810), (-146522809)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨21453493, 92472572⟩, ⟨20974120, 48729670⟩, ⟨4978396, 7242652⟩, ⟨(-29876), 276928⟩, ⟨2708, 20513⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4316420789, 4387439868⟩, ⟨20974120, 48729670⟩, ⟨4978396, 7242652⟩, ⟨(-29876), 276928⟩, ⟨2708, 20513⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305680680, 4340957354⟩, ⟨10375955, 24304211⟩, ⟨2394788, 3599814⟩, ⟨(-35222), 132349⟩, ⟨(-902), 9765⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3718127493, 4044773835⟩, ⟨(-139131709), (-124242361)⟩, ⟨1238856, 3000224⟩, ⟨(-155627), 41621⟩, ⟨(-5357), 10301⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2618198503, 5236397026⟩, ⟨1309099251, 1309099261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1596045540, 6384182213⟩, ⟨1596045540, 3192091118⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1596045540, 6384182213⟩, ⟨1596045540, 3192091118⟩, ⟨399011384, 399011392⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6384182213), (-1596045540)⟩, ⟨(-3192091118), (-1596045540)⟩, ⟨(-399011392), (-399011384)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3192091107), (-798022770)⟩, ⟨(-1596045559), (-798022770)⟩, ⟨(-199505696), (-199505692)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2042607771, 3566696389⟩, ⟨(-1325414035), (-379525011)⟩, ⟨(-130418094), 151386186⟩, ⟨(-6999235), 57199390⟩, ⟨(-8829966), 3679272⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1768273327, 3358926678⟩, ⟨(-1363745093), (-387639922)⟩, ⟨(-111253029), 187994656⟩, ⟨(-12550635), 58017245⟩, ⟨(-10276919), 3854012⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4319906705, 4319906707⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3324
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305680680, 4340957354⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3325
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (174373371 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((6823 / 100000) : ℝ)..(6823 / 50000), prawitzNormalCorrection
