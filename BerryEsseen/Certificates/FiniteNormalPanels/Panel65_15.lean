...
namespace FiniteNormalPanel65_15
...
def j2 : Jet := ⟨⟨547345073, 547345077⟩, ⟨547345073, 547345077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨69752947, 69752949⟩, ⟨139505894, 139505898⟩, ⟨69752947, 69752949⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨17, 18⟩, ⟨34, 35⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94670), (-94668)⟩, ⟨34, 35⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1538), (-1537)⟩, ⟨(-3075), (-3073)⟩, ⟨(-1537), (-1534)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111518, 5111520⟩, ⟨(-3075), (-3073)⟩, ⟨(-1537), (-1534)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨83014, 83015⟩, ⟨165978, 165980⟩, ⟨82889, 82892⟩, ⟨(-100), (-97)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-143082563), (-143082561)⟩, ⟨165978, 165980⟩, ⟨82889, 82892⟩, ⟨(-100), (-97)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2323751), (-2323750)⟩, ⟨(-4644806), (-4644804)⟩, ⟨(-2317014), (-2317011)⟩, ⟨5385, 5388⟩, ⟨1341, 1344⟩⟩
...
def j19 : Jet := ⟨⟨1429332014, 1429332016⟩, ⟨(-4644806), (-4644804)⟩, ⟨(-2317014), (-2317011)⟩, ⟨5385, 5388⟩, ⟨1341, 1344⟩⟩
...
def j25 : Jet := ⟨⟨192, 193⟩, ⟨383, 385⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851985), (-851983)⟩, ⟨383, 385⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13837), (-13836)⟩, ⟨(-27668), (-27666)⟩, ⟨(-13822), (-13819)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35777557, 35777559⟩, ⟨(-27668), (-27666)⟩, ⟨(-13822), (-13819)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨581049, 581050⟩, ⟨1161649, 1161651⟩, ⟨579925, 579928⟩, ⟨(-899), (-896)⟩, ⟨(-225), (-222)⟩⟩
...
def j33 : Jet := ⟨⟨(-715246834), (-715246832)⟩, ⟨1161649, 1161651⟩, ⟨579925, 579928⟩, ⟨(-899), (-896)⟩, ⟨(-225), (-222)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11616055), (-11616054)⟩, ⟨(-23213245), (-23213243)⟩, ⟨(-11568906), (-11568903)⟩, ⟨37686, 37689⟩, ⟨9384, 9387⟩⟩
...
def j36 : Jet := ⟨⟨4283351241, 4283351242⟩, ⟨(-23213245), (-23213243)⟩, ⟨(-11568906), (-11568903)⟩, ⟨37686, 37689⟩, ⟨9384, 9387⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨182152221, 182152224⟩, ⟨181560292, 181560297⟩, ⟨(-887207), (-887203)⟩, ⟨(-294592), (-294589)⟩, ⟨856, 859⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306614851, 4306614853⟩, ⟨23339317, 23339321⟩, ⟨11758219, 11758225⟩, ⟨88864, 88871⟩, ⟨22594, 22602⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨182646201, 182646205⟩, ⟨183042500, 183042508⟩, ⟨595677, 595684⟩, ⟨200607, 200616⟩, ⟨1542, 1550⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-174225349), (-174225348)⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4120741947, 4120741948⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7767145, 7767146⟩, ⟨15567996, 15567998⟩, ⟨7851549, 7851553⟩, ⟨67832, 67838⟩, ⟨17310, 17315⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302734441, 4302734442⟩, ⟨15567996, 15567998⟩, ⟨7851549, 7851553⟩, ⟨67832, 67838⟩, ⟨17310, 17315⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298849114, 4298849115⟩, ⟨7776969, 7776971⟩, ⟨3915194, 3915198⟩, ⟨26801, 26806⟩, ⟨6814, 6819⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4124466299, 4124466302⟩, ⟨(-166921319), (-166921314)⟩, ⟨3440901, 3440906⟩, ⟨(-133108), (-133100)⟩, ⟨5449, 5456⟩⟩
...
def j47 : Jet := ⟨⟨1403378802, 1403378812⟩, ⟨1403378802, 1403378812⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨458553447, 458553455⟩, ⟨917106894, 917106910⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨458553447, 458553455⟩, ⟨917106894, 917106910⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-458553455), (-458553447)⟩, ⟨(-917106910), (-917106894)⟩, ⟨(-458553455), (-458553447)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-229276728), (-229276723)⟩, ⟨(-458553455), (-458553447)⟩, ⟨(-229276728), (-229276723)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4071702810, 4071702815⟩, ⟨(-434716557), (-434716548)⟩, ⟨(-194151959), (-194151952)⟩, ⟨22380443, 22380445⟩, ⟨4584808, 4584810⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3910064934, 3910064943⟩, ⟨(-575703522), (-575703506)⟩, ⟨(-166287514), (-166287498)⟩, ⟨28563123, 28563138⟩, ⟨3396088, 3396103⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 348450697⟩, ⟨174225348, 174225349⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1094690150⟩, ⟨547345073, 547345077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 279011793⟩, ⟨0, 279011794⟩, ⟨69752947, 69752949⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 70⟩, ⟨0, 70⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94616)⟩, ⟨0, 70⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6152), 0⟩, ⟨(-6152), 5⟩, ⟨(-1538), (-1529)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106904, 5113057⟩, ⟨(-6152), 5⟩, ⟨(-1538), (-1529)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 332157⟩, ⟨(-400), 332158⟩, ⟨82439, 83041⟩, ⟨(-200), 2⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142833419)⟩, ⟨(-400), 332158⟩, ⟨82439, 83041⟩, ⟨(-200), 2⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9300394), 0⟩, ⟨(-9300420), 21578⟩, ⟨(-2325125), (-2292730)⟩, ⟨(-20), 10791⟩, ⟨1323, 1350⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422355371, 1431655766⟩, ⟨(-9300420), 21578⟩, ⟨(-2325125), (-2292730)⟩, ⟨(-20), 10791⟩, ⟨1323, 1350⟩⟩
...
def j72 : Jet := ⟨⟨0, 769⟩, ⟨(-1), 769⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851407)⟩, ⟨(-1), 769⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-55360), 0⟩, ⟨(-55361), 50⟩, ⟨(-13841), (-13764)⟩, ⟨(-2), 26⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35736034, 35791395⟩, ⟨(-55361), 50⟩, ⟨(-13841), (-13764)⟩, ⟨(-2), 26⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2325099⟩, ⟨(-3597), 2325103⟩, ⟨575878, 581279⟩, ⟨(-1801), 3⟩, ⟨(-226), (-220)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713502783)⟩, ⟨(-3597), 2325103⟩, ⟨575878, 581279⟩, ⟨(-1801), 3⟩, ⟨(-226), (-220)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-46501966), 0⟩, ⟨(-46502200), 151045⟩, ⟨(-11625726), (-11398923)⟩, ⟨(-176), 75525⟩, ⟨9220, 9442⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4248465330, 4294967296⟩, ⟨(-46502200), 151045⟩, ⟨(-11625726), (-11398923)⟩, ⟨(-176), 75525⟩, ⟨9220, 9442⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 364896717⟩, ⟨178892660, 182453860⟩, ⟨(-1777856), 2750⟩, ⟨(-296317), (-289431)⟩, ⟨(-3), 1721⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4341978254⟩, ⟨(-154371), 47525761⟩, ⟨11397251, 12401821⟩, ⟨(-78053), 265979⟩, ⟨19020, 27532⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 368890728⟩, ⟨178879544, 188488674⟩, ⟨(-1803874), 3075365⟩, ⟨148848, 260071⟩, ⟨(-11733), 15399⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-348450697), 0⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3946516599, 4294967296⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 31683680⟩, ⟨0, 32378234⟩, ⟨7140221, 8800285⟩, ⟨(-158330), 314608⟩, ⟨9090, 27677⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4326650976⟩, ⟨0, 32378234⟩, ⟨7140221, 8800285⟩, ⟨(-158330), 314608⟩, ⟨9090, 27677⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4310780028⟩, ⟨0, 16189117⟩, ⟨3526615, 4400143⟩, ⟨(-95751), 157304⟩, ⟨1691, 12752⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3946516599, 4310780028⟩, ⟨(-174866793), (-158036231)⟩, ⟨2583788, 4400143⟩, ⟨(-274243), 14247⟩, ⟨(-4829), 16637⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2806757615⟩, ⟨1403378802, 1403378812⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1834213806⟩, ⟨0, 1834213812⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1834213806⟩, ⟨0, 1834213812⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1834213806), 0⟩, ⟨(-1834213812), 0⟩, ⟨(-458553455), (-458553447)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-917106903), 0⟩, ⟨(-917106906), 0⟩, ⟨(-229276728), (-229276723)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3469162985, 4294967296⟩, ⟨(-917106906), 0⟩, ⟨(-229276728), (-87277912)⟩, ⟨0, 48957596⟩, ⟨(-283924), 6119700⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3187709791, 4310780028⟩, ⟨(-1095350202), (-127650201)⟩, ⟨(-228033858), (-38457501)⟩, ⟨1997640, 58486943⟩, ⟨(-2521011), 6164923⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298849114, 4298849115⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1290
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4310780028⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1291
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (312826633 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(8113 / 100000), prawitzNormalCorrection
