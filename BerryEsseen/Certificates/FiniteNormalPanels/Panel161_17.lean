...
namespace FiniteNormalPanel161_17

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38679 / 400000)
def radius : Rat := (12893 / 400000)

def j0 : Jet := ⟨⟨415312600, 415312601⟩, ⟨138437533, 138437534⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1304743013, 1304743017⟩, ⟨434914336, 434914340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨396360254, 396360257⟩, ⟨264240168, 264240172⟩, ⟨44040027, 44040029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨99, 100⟩, ⟨66, 67⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94588), (-94586)⟩, ⟨66, 67⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8730), (-8728)⟩, ⟨(-5814), (-5812)⟩, ⟨(-965), (-962)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104326, 5104329⟩, ⟨(-5814), (-5812)⟩, ⟨(-965), (-962)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨471051, 471053⟩, ⟨313497, 313499⟩, ⟨51891, 51895⟩, ⟨(-120), (-117)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142694526), (-142694523)⟩, ⟨313497, 313499⟩, ⟨51891, 51895⟩, ⟨(-120), (-117)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13168538), (-13168537)⟩, ⟨(-8750095), (-8750092)⟩, ⟨(-1439096), (-1439092)⟩, ⟨6394, 6398⟩, ⟨523, 526⟩⟩
...
def j19 : Jet := ⟨⟨1418487227, 1418487229⟩, ⟨(-8750095), (-8750092)⟩, ⟨(-1439096), (-1439092)⟩, ⟨6394, 6398⟩, ⟨523, 526⟩⟩
...
def j25 : Jet := ⟨⟨1091, 1092⟩, ⟨726, 728⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851086), (-851084)⟩, ⟨726, 728⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-78543), (-78542)⟩, ⟨(-52296), (-52293)⟩, ⟨(-8673), (-8669)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35712851, 35712853⟩, ⟨(-52296), (-52293)⟩, ⟨(-8673), (-8669)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3295753, 3295754⟩, ⟨2192342, 2192345⟩, ⟨362175, 362178⟩, ⟨(-1070), (-1067)⟩, ⟨(-90), (-86)⟩⟩
...
def j33 : Jet := ⟨⟨(-712532130), (-712532128)⟩, ⟨2192342, 2192345⟩, ⟨362175, 362178⟩, ⟨(-1070), (-1067)⟩, ⟨(-90), (-86)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-65755895), (-65755894)⟩, ⟨(-43634945), (-43634941)⟩, ⟨(-7137909), (-7137905)⟩, ⟨44662, 44666⟩, ⟨3638, 3642⟩⟩
...
def j36 : Jet := ⟨⟨4229211401, 4229211402⟩, ⟨(-43634945), (-43634941)⟩, ⟨(-7137909), (-7137905)⟩, ⟨44662, 44666⟩, ⟨3638, 3642⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨430913944, 430913947⟩, ⟨140979839, 140979844⟩, ⟨(-1323222), (-1323219)⟩, ⟨(-143783), (-143780)⟩, ⟨805, 808⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4361745564, 4361745566⟩, ⟨45002363, 45002369⟩, ⟨7825902, 7825909⟩, ⟨110629, 110637⟩, ⟨10115, 10127⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨437613805, 437613809⟩, ⟨147686882, 147686890⟩, ⟨918552, 918560⟩, ⟨108095, 108103⟩, ⟨1543, 1553⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-415312601), (-415312600)⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3879654695, 3879654696⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨44588428, 44588430⟩, ⟨30095604, 30095608⟩, ⟨5265547, 5265551⟩, ⟨85196, 85202⟩, ⟨7942, 7951⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4339555724, 4339555726⟩, ⟨30095604, 30095608⟩, ⟨5265547, 5265551⟩, ⟨85196, 85202⟩, ⟨7942, 7951⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317203946, 4317203948⟩, ⟨14970295, 14970298⟩, ⟨2593257, 2593260⟩, ⟨33386, 33391⟩, ⟨3055, 3062⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3899741116, 3899741120⟩, ⟨(-125631573), (-125631567)⟩, ⟨1859964, 1859969⟩, ⟨(-53431), (-53424)⟩, ⟨1682, 1690⟩⟩
...
def j47 : Jet := ⟨⟨4307160796, 4307160808⟩, ⟨1435720261, 1435720273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4319388913, 4319388938⟩, ⟨2879592600, 2879592634⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4319388913, 4319388938⟩, ⟨2879592600, 2879592634⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4319388938), (-4319388913)⟩, ⟨(-2879592634), (-2879592600)⟩, ⟨(-479932107), (-479932098)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2159694469), (-2159694456)⟩, ⟨(-1439796317), (-1439796300)⟩, ⟨(-239966054), (-239966049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2597633622, 2597633638⟩, ⟨(-870801356), (-870801340)⟩, ⟨825239, 825249⟩, ⟨32343072, 32343076⟩, ⟨(-2733636), (-2733634)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2358597386, 2358597404⟩, ⟨(-866652620), (-866652598)⟩, ⟨27345925, 27345941⟩, ⟨28933273, 28933287⟩, ⟨(-3415944), (-3415930)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨276875066, 553750134⟩, ⟨138437533, 138437534⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨869828673, 1739657353⟩, ⟨434914336, 434914340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨176160112, 704640455⟩, ⟨176160110, 352320230⟩, ⟨44040027, 44040029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨44, 177⟩, ⟨44, 89⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94643), (-94509)⟩, ⟨44, 89⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-15528), (-3876)⟩, ⟨(-7763), (-3861)⟩, ⟨(-970), (-959)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097528, 5109181⟩, ⟨(-7763), (-3861)⟩, ⟨(-970), (-959)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨209077, 838222⟩, ⟨207803, 418953⟩, ⟨51472, 52192⟩, ⟨(-160), (-77)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142956500), (-142327354)⟩, ⟨207803, 418953⟩, ⟨51472, 52192⟩, ⟨(-160), (-77)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-23453714), (-5837623)⟩, ⟨(-11718334), (-5768888)⟩, ⟨(-1455224), (-1416474)⟩, ⟨4214, 8575⟩, ⟨511, 533⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408202051, 1425818143⟩, ⟨(-11718334), (-5768888)⟩, ⟨(-1455224), (-1416474)⟩, ⟨4214, 8575⟩, ⟨511, 533⟩⟩
...
def j72 : Jet := ⟨⟨484, 1942⟩, ⟨482, 971⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851693), (-850234)⟩, ⟨482, 971⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-139731), (-34872)⟩, ⟨(-69847), (-34712)⟩, ⟨(-8711), (-8617)⟩, ⟨7, 21⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35651663, 35756523⟩, ⟨(-69847), (-34712)⟩, ⟨(-8711), (-8617)⟩, ⟨7, 21⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1462269, 5866283⟩, ⟨1450809, 2931719⟩, ⟨358407, 364867⟩, ⟨(-1432), (-704)⟩, ⟨(-91), (-85)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714365614), (-709961599)⟩, ⟨1450809, 2931719⟩, ⟨358407, 364867⟩, ⟨(-1432), (-704)⟩, ⟨(-91), (-85)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-117200174), (-29119410)⟩, ⟨(-58540583), (-28638425)⟩, ⟨(-7250806), (-6979499)⟩, ⟨29341, 59965⟩, ⟨3542, 3711⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4177767122, 4265847886⟩, ⟨(-58540583), (-28638425)⟩, ⟨(-7250806), (-6979499)⟩, ⟨29341, 59965⟩, ⟨3542, 3711⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨285192979, 577521282⟩, ⟨137850030, 143211990⟩, ⟨(-1776047), (-871033)⟩, ⟨(-146505), (-139960)⟩, ⟨529, 1085⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4324285480, 4415455323⟩, ⟨29030740, 61871168⟩, ⟨7270005, 8530296⟩, ⟨34235, 196544⟩, ⟨7412, 13690⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨287139755, 593722663⟩, ⟨140718706, 155549046⟩, ⟨(-411369), 2333087⟩, ⟨59408, 164063⟩, ⟨(-3517), 7091⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-553750134), (-276875066)⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3741217162, 4018092230⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19196709, 82074339⟩, ⟨18815478, 43005214⟩, ⟨4496721, 6278494⟩, ⟨(-21856), 214354⟩, ⟨2694, 15114⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314164005, 4377041635⟩, ⟨18815478, 43005214⟩, ⟨4496721, 6278494⟩, ⟨(-21856), 214354⟩, ⟨2694, 15114⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304554949, 4335810268⟩, ⟨9319118, 21454714⟩, ⟨2174098, 3122168⟩, ⟨(-26466), 102232⟩, ⟨(-299), 7125⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3749568678, 4056302260⟩, ⟨(-131636402), (-118674931)⟩, ⟨1202251, 2620520⟩, ⟨(-125396), 25566⟩, ⟨(-3576), 7520⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2871440523, 5742881070⟩, ⟨1435720261, 1435720273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1919728395, 7678913648⟩, ⟨1919728394, 3839456840⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1919728395, 7678913648⟩, ⟨1919728394, 3839456840⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7678913648), (-1919728395)⟩, ⟨(-3839456840), (-1919728394)⟩, ⟨(-479932107), (-479932098)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3839456824), (-959864197)⟩, ⟨(-1919728420), (-959864197)⟩, ⟨(-239966054), (-239966049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1756811881, 3434798086⟩, ⟨(-1535257209), (-392622506)⟩, ⟨(-148034376), 244952562⟩, ⟨(-21871355), 79240420⟩, ⟨(-15697483), 6579417⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1533722226, 3243931392⟩, ⟨(-1555218304), (-391307887)⟩, ⟨(-128467940), 280490688⟩, ⟨(-29200546), 79284794⟩, ⟨(-17356157), 7084437⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨415312600, 415312601⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317203946, 4317203948⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3268
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨276875066, 553750134⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304554949, 4335810268⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3269
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (38181485 / 1073741824)

theorem envelope_integral : (∫ s in ((12893 / 200000) : ℝ)..(12893 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (12893 / 200000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (12893 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((12893 / 200000) : ℝ)..(12893 / 100000), prawitzNormalCorrection
