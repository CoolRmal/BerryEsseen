...
namespace FiniteNormalPanel99_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (15377 / 400000)
def radius : Rat := (15377 / 400000)

def j0 : Jet := ⟨⟨165109280, 165109281⟩, ⟨165109280, 165109281⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨518706101, 518706105⟩, ⟨518706101, 518706105⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨62644486, 62644488⟩, ⟨125288972, 125288976⟩, ⟨62644486, 62644488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1381), (-1380)⟩, ⟨(-2762), (-2760)⟩, ⟨(-1381), (-1378)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111675, 5111677⟩, ⟨(-2762), (-2760)⟩, ⟨(-1381), (-1378)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨74556, 74557⟩, ⟨149072, 149074⟩, ⟨74454, 74457⟩, ⟨(-82), (-79)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-143091021), (-143091019)⟩, ⟨149072, 149074⟩, ⟨74454, 74457⟩, ⟨(-82), (-79)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2087063), (-2087062)⟩, ⟨(-4171951), (-4171949)⟩, ⟨(-2081630), (-2081627)⟩, ⟨4343, 4346⟩, ⟨1081, 1084⟩⟩
...
def j19 : Jet := ⟨⟨1429568702, 1429568704⟩, ⟨(-4171951), (-4171949)⟩, ⟨(-2081630), (-2081627)⟩, ⟨4343, 4346⟩, ⟨1081, 1084⟩⟩
...
def j25 : Jet := ⟨⟨172, 173⟩, ⟨344, 346⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852005), (-852003)⟩, ⟨344, 346⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-12427), (-12426)⟩, ⟨(-24849), (-24847)⟩, ⟨(-12415), (-12412)⟩, ⟨8, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778967, 35778969⟩, ⟨(-24849), (-24847)⟩, ⟨(-12415), (-12412)⟩, ⟨8, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨521856, 521857⟩, ⟨1043349, 1043351⟩, ⟨520949, 520952⟩, ⟨(-726), (-723)⟩, ⟨(-182), (-179)⟩⟩
...
def j33 : Jet := ⟨⟨(-715306027), (-715306025)⟩, ⟨1043349, 1043351⟩, ⟨520949, 520952⟩, ⟨(-726), (-723)⟩, ⟨(-182), (-179)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10433137), (-10433136)⟩, ⟨(-20851056), (-20851054)⟩, ⟨(-10395104), (-10395101)⟩, ⟨30402, 30405⟩, ⟨7573, 7576⟩⟩
...
def j36 : Jet := ⟨⟨4284534159, 4284534160⟩, ⟨(-20851056), (-20851054)⟩, ⟨(-10395104), (-10395101)⟩, ⟨30402, 30405⟩, ⟨7573, 7576⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨172649977, 172649980⟩, ⟨172146127, 172146131⟩, ⟨(-755250), (-755248)⟩, ⟨(-250876), (-250874)⟩, ⟨654, 656⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305425837, 4305425839⟩, ⟨20952724, 20952728⟩, ⟨10547755, 10547761⟩, ⟨71610, 71617⟩, ⟨18175, 18183⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨173070391, 173070395⟩, ⟨173407575, 173407582⟩, ⟨506713, 506720⟩, ⟨170469, 170475⟩, ⟨1176, 1183⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-165109281), (-165109280)⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4129858015, 4129858016⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6974060, 6974061⟩, ⟨13975294, 13975296⟩, ⟨7042097, 7042100⟩, ⟨54654, 54658⟩, ⟨13917, 13922⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301941356, 4301941357⟩, ⟨13975294, 13975296⟩, ⟨7042097, 7042100⟩, ⟨54654, 54658⟩, ⟨13917, 13922⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298452911, 4298452913⟩, ⟨6981980, 6981982⟩, ⟨3512522, 3512525⟩, ⟨21598, 21602⟩, ⟨5481, 5486⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4133209634, 4133209638⟩, ⟨(-158529702), (-158529697)⟩, ⟨3109086, 3109091⟩, ⟨(-114264), (-114258)⟩, ⟨4439, 4446⟩⟩
...
def j47 : Jet := ⟨⟨1246402955, 1246402964⟩, ⟨1246402955, 1246402964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨361707137, 361707143⟩, ⟨723414274, 723414286⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨361707137, 361707143⟩, ⟨723414274, 723414286⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-361707143), (-361707137)⟩, ⟨(-723414286), (-723414274)⟩, ⟨(-361707143), (-361707137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-180853572), (-180853568)⟩, ⟨(-361707143), (-361707137)⟩, ⟨(-180853572), (-180853568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4117868550, 4117868555⟩, ⟨(-346792506), (-346792499)⟩, ⟨(-158793428), (-158793422)⟩, ⟨14192893, 14192894⟩, ⟨3044437, 3044439⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3962780805, 3962780815⟩, ⟨(-485724446), (-485724432)⟩, ⟨(-137031734), (-137031720)⟩, ⟨19158919, 19158932⟩, ⟨2304438, 2304453⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 330218561⟩, ⟨165109280, 165109281⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1037412206⟩, ⟨518706101, 518706105⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 250577947⟩, ⟨0, 250577948⟩, ⟨62644486, 62644488⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5525), 0⟩, ⟨(-5525), 4⟩, ⟨(-1382), (-1375)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107531, 5113057⟩, ⟨(-5525), 4⟩, ⟨(-1382), (-1375)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 298308⟩, ⟨(-323), 298309⟩, ⟨74092, 74578⟩, ⟨(-162), 2⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142867268)⟩, ⟨(-323), 298309⟩, ⟨74092, 74578⟩, ⟨(-162), 2⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8352599), 0⟩, ⟨(-8352618), 17405⟩, ⟨(-2088169), (-2062041)⟩, ⟨(-15), 8705⟩, ⟨1068, 1089⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423303166, 1431655766⟩, ⟨(-8352618), 17405⟩, ⟨(-2088169), (-2062041)⟩, ⟨(-15), 8705⟩, ⟨1068, 1089⟩⟩
...
def j72 : Jet := ⟨⟨0, 691⟩, ⟨(-1), 691⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851485)⟩, ⟨(-1), 691⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-49718), 0⟩, ⟨(-49719), 41⟩, ⟨(-12431), (-12367)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35741676, 35791395⟩, ⟨(-49719), 41⟩, ⟨(-12431), (-12367)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2088150⟩, ⟨(-2901), 2088153⟩, ⟨517685, 522041⟩, ⟨(-1453), 3⟩, ⟨(-183), (-177)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713739732)⟩, ⟨(-2901), 2088153⟩, ⟨517685, 522041⟩, ⟨(-1453), 3⟩, ⟨(-183), (-177)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-41762992), 0⟩, ⟨(-41763162), 121828⟩, ⟨(-10440919), (-10258004)⟩, ⟨(-128), 60916⟩, ⟨7454, 7616⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4253204304, 4294967296⟩, ⟨(-41763162), 121828⟩, ⟨(-10440919), (-10258004)⟩, ⟨(-128), 60916⟩, ⟨7454, 7616⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 345804069⟩, ⟨169875781, 172906241⟩, ⟨(-1513132), 2103⟩, ⟨(-252194), (-246931)⟩, ⟨(-2), 1316⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4337140367⟩, ⟨(-124234), 42587350⟩, ⟨10256795, 11065145⟩, ⟨(-62743), 213329⟩, ⟨15590, 21734⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 349199583⟩, ⟨169865778, 178032909⟩, ⟨(-1532992), 2607498⟩, ⟨130952, 215749⟩, ⟨(-8929), 11682⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-330218561), 0⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3964748735, 4294967296⟩, ⟨(-165109281), (-165109280)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 28391450⟩, ⟨0, 28949706⟩, ⟨6468906, 7803737⟩, ⟨(-127090), 251254⟩, ⟨7975, 21372⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4323358746⟩, ⟨0, 28949706⟩, ⟨6468906, 7803737⟩, ⟨(-127090), 251254⟩, ⟨7975, 21372⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309139639⟩, ⟨0, 14474853⟩, ⟨3199503, 3901869⟩, ⟨(-76696), 125627⟩, ⟨1785, 9754⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3964748735, 4309139639⟩, ⟨(-165654102), (-150634427)⟩, ⟨2397059, 3901869⟩, ⟨(-226694), 2631⟩, ⟨(-3183), 12703⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2492805919⟩, ⟨1246402955, 1246402964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1446828561⟩, ⟨0, 1446828566⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1446828561⟩, ⟨0, 1446828566⟩, ⟨361707137, 361707143⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1446828561), 0⟩, ⟨(-1446828566), 0⟩, ⟨(-361707143), (-361707137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-723414281), 0⟩, ⟨(-723414283), 0⟩, ⟨(-180853572), (-180853568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3629195244, 4294967296⟩, ⟨(-723414283), 0⟩, ⟨(-180853572), (-91895646)⟩, ⟨0, 30461713⟩, ⟨652092, 3807715⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3350164567, 4309139639⟩, ⟨(-891455476), (-127284262)⟩, ⟨(-179424860), (-53026760)⟩, ⟨2339094, 37540266⟩, ⟨(-740862), 3819879⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨165109280, 165109281⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298452911, 4298452913⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2002
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 330218561⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309139639⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2003
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (301225247 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(15377 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (15377 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(15377 / 200000), prawitzNormalCorrection
