...
namespace FiniteNormalPanel64_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (40417 / 400000)
def radius : Rat := (40417 / 400000)

def j0 : Jet := ⟨⟨433974233, 433974234⟩, ⟨433974233, 433974234⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1363370262, 1363370266⟩, ⟨1363370262, 1363370266⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨432780587, 432780591⟩, ⟨865561174, 865561182⟩, ⟨432780587, 432780591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨108, 109⟩, ⟨216, 217⟩, ⟨108, 109⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94579), (-94577)⟩, ⟨216, 217⟩, ⟨108, 109⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9531), (-9530)⟩, ⟨(-19040), (-19038)⟩, ⟨(-9478), (-9475)⟩, ⟨42, 44⟩, ⟨10, 11⟩⟩
...
def j13 : Jet := ⟨⟨5103525, 5103527⟩, ⟨(-19040), (-19038)⟩, ⟨(-9478), (-9475)⟩, ⟨42, 44⟩, ⟨10, 11⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨514254, 514255⟩, ⟨1026590, 1026592⟩, ⟨509460, 509465⟩, ⟨(-3826), (-3822)⟩, ⟨(-947), (-943)⟩⟩
...
def j16 : Jet := ⟨⟨(-142651323), (-142651321)⟩, ⟨1026590, 1026592⟩, ⟨509460, 509465⟩, ⟨(-3826), (-3822)⟩, ⟨(-947), (-943)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14374202), (-14374200)⟩, ⟨(-28644960), (-28644956)⟩, ⟨(-14115980), (-14115974)⟩, ⟨205728, 205733⟩, ⟨50467, 50472⟩⟩
...
def j19 : Jet := ⟨⟨1417281563, 1417281566⟩, ⟨(-28644960), (-28644956)⟩, ⟨(-14115980), (-14115974)⟩, ⟨205728, 205733⟩, ⟨50467, 50472⟩⟩
...
def j22 : Jet := ⟨⟨(-11), (-10)⟩, ⟨(-22), (-21)⟩, ⟨(-11), (-10)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11824, 11826⟩, ⟨(-22), (-21)⟩, ⟨(-11), (-10)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1191, 1192⟩, ⟨2379, 2382⟩, ⟨1184, 1187⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850986), (-850984)⟩, ⟨2379, 2382⟩, ⟨1184, 1187⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-85750), (-85749)⟩, ⟨(-171260), (-171257)⟩, ⟨(-85152), (-85148)⟩, ⟨476, 481⟩, ⟨116, 120⟩⟩
...
def j30 : Jet := ⟨⟨35705644, 35705646⟩, ⟨(-171260), (-171257)⟩, ⟨(-85152), (-85148)⟩, ⟨476, 481⟩, ⟨116, 120⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3597864, 3597865⟩, ⟨7178471, 7178474⟩, ⟨3554769, 3554773⟩, ⟨(-34371), (-34366)⟩, ⟨(-8475), (-8469)⟩⟩
...
def j33 : Jet := ⟨⟨(-712230019), (-712230017)⟩, ⟨7178471, 7178474⟩, ⟨3554769, 3554773⟩, ⟨(-34371), (-34366)⟩, ⟨(-8475), (-8469)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-71767562), (-71767560)⟩, ⟨(-142811788), (-142811784)⟩, ⟨(-69962697), (-69962692)⟩, ⟨1436260, 1436265⟩, ⟨350413, 350418⟩⟩
...
def j36 : Jet := ⟨⟨4223199734, 4223199736⟩, ⟨(-142811788), (-142811784)⟩, ⟨(-69962697), (-69962692)⟩, ⟨1436260, 1436265⟩, ⟨350413, 350418⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨449893888, 449893891⟩, ⟨440800992, 440800998⟩, ⟨(-13573794), (-13573788)⟩, ⟨(-4415593), (-4415588)⟩, ⟨81324, 81329⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4367954448, 4367954451⟩, ⟨147706810, 147706817⟩, ⟨77355593, 77355601⟩, ⟨3577312, 3577323⟩, ⟨989800, 989811⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨457539225, 457539229⟩, ⟨463763959, 463763969⟩, ⟨9457906, 9457917⟩, ⟨3356434, 3356446⟩, ⟨157200, 157213⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-433974234), (-433974233)⟩, ⟨(-433974234), (-433974233)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3860993062, 3860993063⟩, ⟨(-433974234), (-433974233)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨48741265, 48741267⟩, ⟨98808762, 98808766⟩, ⟨52091602, 52091609⟩, ⟨2757616, 2757624⟩, ⟨779163, 779172⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4343708561, 4343708563⟩, ⟨98808762, 98808766⟩, ⟨52091602, 52091609⟩, ⟨2757616, 2757624⟩, ⟨779163, 779172⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4319269175, 4319269177⟩, ⟨49126412, 49126415⟩, ⟨25619880, 25619885⟩, ⟨1079655, 1079661⟩, ⟨299125, 299133⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3882839418, 3882839422⟩, ⟨(-392267201), (-392267195)⟩, ⟨18067327, 18067333⟩, ⟨(-1618135), (-1618126)⟩, ⟨159808, 159817⟩⟩
...
def j47 : Jet := ⟨⟨1991750755, 1991750761⟩, ⟨1991750755, 1991750761⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨923655710, 923655717⟩, ⟨1847311420, 1847311434⟩, ⟨923655710, 923655717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨923655710, 923655717⟩, ⟨1847311420, 1847311434⟩, ⟨923655710, 923655717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-923655717), (-923655710)⟩, ⟨(-1847311434), (-1847311420)⟩, ⟨(-923655717), (-923655710)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-461827859), (-461827855)⟩, ⟨(-923655717), (-923655710)⟩, ⟨(-461827859), (-461827855)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3857102536, 3857102540⟩, ⟨(-829490557), (-829490549)⟩, ⟨(-325552088), (-325552081)⟩, ⟨82799366, 82799369⟩, ⟨13051317, 13051319⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3486990408, 3486990416⟩, ⟨(-1102172177), (-1102172162)⟩, ⟨(-202329136), (-202329119)⟩, ⟨99645007, 99645023⟩, ⟨3323293, 3323310⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 867948467⟩, ⟨433974233, 433974234⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2726740528⟩, ⟨1363370262, 1363370266⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1731122357⟩, ⟨0, 1731122360⟩, ⟨432780587, 432780591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 434⟩, ⟨0, 434⟩, ⟨108, 109⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94252)⟩, ⟨0, 434⟩, ⟨108, 109⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-38165), 0⟩, ⟨(-38165), 175⟩, ⟨(-9542), (-9278)⟩, ⟨0, 88⟩, ⟨10, 11⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5074891, 5113057⟩, ⟨(-38165), 175⟩, ⟨(-9542), (-9278)⟩, ⟨0, 88⟩, ⟨10, 11⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2060861⟩, ⟨(-15383), 2060932⟩, ⟨492140, 515287⟩, ⟨(-7692), 54⟩, ⟨(-962), (-893)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141104715)⟩, ⟨(-15383), 2060932⟩, ⟨492140, 515287⟩, ⟨(-7692), 54⟩, ⟨(-962), (-893)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-57704079), 0⟩, ⟨(-57710280), 830676⟩, ⟨(-14432221), (-13179990)⟩, ⟨(-4652), 415382⟩, ⟨46101, 51945⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1373951686, 1431655766⟩, ⟨(-57710280), 830676⟩, ⟨(-14432221), (-13179990)⟩, ⟨(-4652), 415382⟩, ⟨46101, 51945⟩⟩
...
def j70 : Jet := ⟨⟨(-44), 0⟩, ⟨(-44), 0⟩, ⟨(-11), (-10)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11791, 11836⟩, ⟨(-44), 0⟩, ⟨(-11), (-10)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 4771⟩, ⟨(-18), 4771⟩, ⟨1165, 1193⟩, ⟨(-10), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-847405)⟩, ⟨(-18), 4771⟩, ⟨1165, 1193⟩, ⟨(-10), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-343478), 0⟩, ⟨(-343486), 1923⟩, ⟨(-85878), (-82984)⟩, ⟨(-7), 962⟩, ⟨111, 121⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35447916, 35791395⟩, ⟨(-343486), 1923⟩, ⟨(-85878), (-82984)⟩, ⟨(-7), 962⟩, ⟨111, 121⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 14426020⟩, ⟨(-138445), 14426797⟩, ⟨3398835, 3607282⟩, ⟨(-69229), 582⟩, ⟨(-8657), (-7924)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-701401862)⟩, ⟨(-138445), 14426797⟩, ⟨3398835, 3607282⟩, ⟨(-69229), 582⟩, ⟨(-8657), (-7924)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-288520393), 0⟩, ⟨(-288576196), 5814841⟩, ⟨(-72185901), (-63407678)⟩, ⟨(-41855), 2907892⟩, ⟨311088, 363722⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4006446903, 4294967296⟩, ⟨(-288576196), 5814841⟩, ⟨(-72185901), (-63407678)⟩, ⟨(-41855), 2907892⟩, ⟨311088, 363722⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 908913510⟩, ⟨399501041, 454984127⟩, ⟨(-27481794), 263686⟩, ⟨(-4584238), (-3920067)⟩, ⟨(-1477), 164836⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4604265206⟩, ⟨(-6682499), 331635830⟩, ⟨62958685, 106844108⟩, ⟨(-3617265), 13719094⟩, ⟨71983, 2584577⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 974368037⟩, ⟨398086871, 557931111⟩, ⟨(-30168775), 58024930⟩, ⟨(-1945702), 10344418⟩, ⟨(-1422403), 2190678⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-867948467), 0⟩, ⟨(-433974234), (-433974233)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3427018829, 4294967296⟩, ⟨(-433974234), (-433974233)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 221047800⟩, ⟨0, 253147560⟩, ⟨23209065, 98804572⟩, ⟨(-8720874), 19768806⟩, ⟨(-1558470), 4465436⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4516015096⟩, ⟨0, 253147560⟩, ⟨23209065, 98804572⟩, ⟨(-8720874), 19768806⟩, ⟨(-1558470), 4465436⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4404104580⟩, ⟨0, 126573780⟩, ⟨9498099, 49402286⟩, ⟨(-5816335), 9884403⟩, ⟨(-1354653), 2393625⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3427018829, 4404104580⟩, ⟨(-445001739), (-307400453)⟩, ⟨(-5210657), 49402286⟩, ⟨(-10808066), 8924692⟩, ⟨(-2353398), 2981323⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3983501517⟩, ⟨1991750755, 1991750761⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3694622856⟩, ⟨0, 3694622862⟩, ⟨923655710, 923655717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3694622856⟩, ⟨0, 3694622862⟩, ⟨923655710, 923655717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3694622856), 0⟩, ⟨(-3694622862), 0⟩, ⟨(-923655717), (-923655710)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1847311428), 0⟩, ⟨(-1847311431), 0⟩, ⟨(-461827859), (-461827855)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2793605990, 4294967296⟩, ⟨(-1847311431), 0⟩, ⟨(-461827859), 96884254⟩, ⟨(-13890319), 198637109⟩, ⟨(-26567857), 26323233⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2229060122, 4404104580⟩, ⟨(-2339254285), (-199944653)⟩, ⟨(-478773795), 340148432⟩, ⟨(-56337981), 262700435⟩, ⟨(-59327878), 37175684⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨433974233, 433974234⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨433974233, 433974234⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4319269175, 4319269177⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1258
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 867948467⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4404104580⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1259
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (346270881 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(40417 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(40417 / 200000), prawitzNormalCorrection
