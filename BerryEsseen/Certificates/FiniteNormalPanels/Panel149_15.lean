...
namespace FiniteNormalPanel149_15

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (47299 / 200000)
def radius : Rat := (6757 / 200000)

def j0 : Jet := ⟨⟨1015738290, 1015738291⟩, ⟨145105470, 145105471⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3191035949, 3191035954⟩, ⟨455862278, 455862282⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2370847023, 2370847031⟩, ⟨677384862, 677384872⟩, ⟨48384633, 48384634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨593, 594⟩, ⟨169, 170⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94094), (-94092)⟩, ⟨169, 170⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-51941), (-51939)⟩, ⟨(-14748), (-14745)⟩, ⟨(-1029), (-1024)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5061115, 5061118⟩, ⟨(-14748), (-14745)⟩, ⟨(-1029), (-1024)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2793765, 2793767⟩, ⟨790077, 790081⟩, ⟨54120, 54126⟩, ⟨(-329), (-324)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-140371812), (-140371809)⟩, ⟨790077, 790081⟩, ⟨54120, 54126⟩, ⟨(-329), (-324)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-77486061), (-77486058)⟩, ⟨(-21702748), (-21702743)⟩, ⟨(-1426868), (-1426861)⟩, ⟨17253, 17260⟩, ⟨550, 555⟩⟩
...
def j19 : Jet := ⟨⟨1354169704, 1354169708⟩, ⟨(-21702748), (-21702743)⟩, ⟨(-1426868), (-1426861)⟩, ⟨17253, 17260⟩, ⟨550, 555⟩⟩
...
def j25 : Jet := ⟨⟨6499, 6501⟩, ⟨1847, 1850⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845678), (-845675)⟩, ⟨1847, 1850⟩, ⟨127, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-466820), (-466817)⟩, ⟨(-132358), (-132354)⟩, ⟨(-9166), (-9161)⟩, ⟨38, 42⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35324574, 35324578⟩, ⟨(-132358), (-132354)⟩, ⟨(-9166), (-9161)⟩, ⟨38, 42⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨19499371, 19499374⟩, ⟨5498185, 5498190⟩, ⟨372011, 372017⟩, ⟨(-2918), (-2911)⟩, ⟨(-100), (-94)⟩⟩
...
def j33 : Jet := ⟨⟨(-696328512), (-696328508)⟩, ⟨5498185, 5498190⟩, ⟨372011, 372017⟩, ⟨(-2918), (-2911)⟩, ⟨(-100), (-94)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-384377406), (-384377401)⟩, ⟨(-106787087), (-106787081)⟩, ⟨(-6771934), (-6771927)⟩, ⟨119000, 119008⟩, ⟨3673, 3681⟩⟩
...
def j36 : Jet := ⟨⟨3910589890, 3910589895⟩, ⟨(-106787087), (-106787081)⟩, ⟨(-6771934), (-6771927)⟩, ⟨119000, 119008⟩, ⟨3673, 3681⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1006108756, 1006108762⟩, ⟨127605310, 127605317⟩, ⟨(-3363624), (-3363617)⟩, ⟨(-138628), (-138621)⟩, ⟨2239, 2245⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4717125694, 4717125701⟩, ⟨128811277, 128811287⟩, ⟨11686065, 11686076⟩, ⟨398620, 398634⟩, ⟨22759, 22775⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1105000605, 1105000615⟩, ⟨170322237, 170322249⟩, ⟨2870292, 2870306⟩, ⟨187440, 187457⟩, ⟨6322, 6338⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1015738291), (-1015738290)⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3279229005, 3279229006⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨284292347, 284292354⟩, ⟨87640328, 87640338⟩, ⟨8231262, 8231274⟩, ⟨324096, 324110⟩, ⟨20036, 20049⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4579259643, 4579259650⟩, ⟨87640328, 87640338⟩, ⟨8231262, 8231274⟩, ⟨324096, 324110⟩, ⟨20036, 20049⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4434836006, 4434836011⟩, ⟨42438135, 42438141⟩, ⟨3782778, 3782785⟩, ⟨120738, 120746⟩, ⟨6932, 6941⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3386019464, 3386019470⟩, ⟨(-117429208), (-117429201)⟩, ⟨1454396, 1454404⟩, ⟨(-35618), (-35610)⟩, ⟨1212, 1221⟩⟩
...
def j47 : Jet := ⟨⟨9415564645, 9415564657⟩, ⟨1345080663, 1345080674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20641101893, 20641101946⟩, ⟨5897457680, 5897457738⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20641101893, 20641101946⟩, ⟨5897457680, 5897457738⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20641101946), (-20641101893)⟩, ⟨(-5897457738), (-5897457680)⟩, ⟨(-421246984), (-421246977)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10320550973), (-10320550946)⟩, ⟨(-2948728869), (-2948728840)⟩, ⟨(-210623492), (-210623488)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨388486604, 388486612⟩, ⟨(-266717209), (-266717200)⟩, ⟨72506708, 72506714⟩, ⟨(-7873466), (-7873462)⟩, ⟨(-426461), (-426459)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨306270830, 306270838⟩, ⟨(-220893264), (-220893253)⟩, ⟨64585945, 64585954⟩, ⟨(-8283154), (-8283145)⟩, ⟨(-94068), (-94061)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨870632820, 1160843761⟩, ⟨145105470, 145105471⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2735173671, 3646898232⟩, ⟨455862278, 455862282⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1741846792, 3096616528⟩, ⟨580615596, 774154138⟩, ⟨48384633, 48384634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨435, 776⟩, ⟨145, 194⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94252), (-93910)⟩, ⟨145, 194⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-67955), (-38085)⟩, ⟨(-16931), (-12555)⟩, ⟨(-1039), (-1012)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5045101, 5074972⟩, ⟨(-16931), (-12555)⟩, ⟨(-1039), (-1012)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2046067, 3658990⟩, ⟨669814, 909657⟩, ⟨53033, 55065⟩, ⟨(-379), (-272)⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141119510), (-139506586)⟩, ⟨669814, 909657⟩, ⟨53033, 55065⟩, ⟨(-379), (-272)⟩, ⟨(-12), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-101745364), (-56577636)⟩, ⟨(-25164695), (-18203360)⟩, ⟨(-1477717), (-1367936)⟩, ⟨14440, 20064⟩, ⟨519, 582⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1329910401, 1375078130⟩, ⟨(-25164695), (-18203360)⟩, ⟨(-1477717), (-1367936)⟩, ⟨14440, 20064⟩, ⟨519, 582⟩⟩
...
def j72 : Jet := ⟨⟨4768, 8503⟩, ⟨1574, 2121⟩, ⟨126, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847409), (-843673)⟩, ⟨1574, 2121⟩, ⟨126, 132⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-610972), (-342156)⟩, ⟨(-152105), (-112522)⟩, ⟨(-9284), (-9025)⟩, ⟨32, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35180422, 35449239⟩, ⟨(-152105), (-112522)⟩, ⟨(-9284), (-9025)⟩, ⟨32, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14267606, 25558449⟩, ⟨4646202, 6343980⟩, ⟨362211, 380480⟩, ⟨(-3376), (-2452)⟩, ⟨(-102), (-90)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701560277), (-690269433)⟩, ⟨4646202, 6343980⟩, ⟨362211, 380480⟩, ⟨(-3376), (-2452)⟩, ⟨(-102), (-90)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-505815994), (-279942433)⟩, ⟨(-124569709), (-88740215)⟩, ⟨(-7128383), (-6358373)⟩, ⟨98871, 139055⟩, ⟨3397, 3920⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3789151302, 4015024863⟩, ⟨(-124569709), (-88740215)⟩, ⟨(-7128383), (-6358373)⟩, ⟨98871, 139055⟩, ⟨3397, 3920⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨846929828, 1167592128⟩, ⟨119787385, 134356531⟩, ⟨(-3925693), (-2803226)⟩, ⟨(-147648), (-128153)⟩, ⟨1862, 2625⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4594428354, 4868304959⟩, ⟨101546210, 160047274⟩, ⟨9520319, 14420166⟩, ⟨202622, 655278⟩, ⟨9257, 41906⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨905980918, 1323454675⟩, ⟨148163425, 195800910⟩, ⟨259727, 5928113⟩, ⟨(-8167), 425872⟩, ⟨(-9216), 25626⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1160843761), (-870632820)⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3134123535, 3424334476⟩, ⟨(-145105471), (-145105470)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨191107723, 407810388⟩, ⟨62507220, 120668500⟩, ⟨5220763, 12579649⟩, ⟨12884, 802966⟩, ⟨(-6411), 62807⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4486075019, 4702777684⟩, ⟨62507220, 120668500⟩, ⟨5220763, 12579649⟩, ⟨12884, 802966⟩, ⟨(-6411), 62807⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4389481232, 4494249254⟩, ⟨29867776, 59035139⟩, ⟨2106898, 6052777⟩, ⟨(-75103), 378503⟩, ⟨(-12402), 31233⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3203092244, 3583219989⟩, ⟨(-130043099), (-101230497)⟩, ⟨(-457058), 3816737⟩, ⟨(-264373), 230596⟩, ⟨(-22676), 27440⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8070483981, 10760645321⟩, ⟨1345080663, 1345080674⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15164891185, 26959806617⟩, ⟨5054963726, 6739951700⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15164891185, 26959806617⟩, ⟨5054963726, 6739951700⟩, ⟨421246977, 421246984⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-26959806617), (-15164891185)⟩, ⟨(-6739951700), (-5054963726)⟩, ⟨(-421246984), (-421246977)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13479903309), (-7582445592)⟩, ⟨(-3369975850), (-2527481863)⟩, ⟨(-210623492), (-210623488)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨186170820, 734928738⟩, ⟨(-576649816), (-109556915)⟩, ⟨(-3804849), 217099682⟩, ⟨(-53199487), 19847590⟩, ⟨(-9216513), 10528822⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨138842107, 613138859⟩, ⟨(-503341565), (-86093104)⟩, ⟨(-670324), 199235576⟩, ⟨(-51514479), 16774545⟩, ⟨(-8348076), 10627917⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1015738290, 1015738291⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4434836006, 4434836011⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3010
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨870632820, 1160843761⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4389481232, 4494249254⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3011
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (11146519 / 2147483648)

theorem envelope_integral : (∫ s in ((20271 / 100000) : ℝ)..(6757 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((20271 / 100000) : ℝ)..(6757 / 25000), prawitzNormalCorrection
