...
namespace FiniteNormalPanel120_16
...
def j2 : Jet := ⟨⟨2667573552, 2667573557⟩, ⟨533514708, 533514712⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1656810905, 1656810912⟩, ⟨662724358, 662724366⟩, ⟨66272435, 66272437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨414, 416⟩, ⟨165, 167⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94273), (-94270)⟩, ⟨165, 167⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-36367), (-36365)⟩, ⟨(-14484), (-14481)⟩, ⟨(-1424), (-1421)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5076689, 5076692⟩, ⟨(-14484), (-14481)⟩, ⟨(-1424), (-1421)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1958365, 1958367⟩, ⟨777758, 777761⟩, ⟨75549, 75553⟩, ⟨(-443), (-439)⟩, ⟨(-22), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-141207212), (-141207209)⟩, ⟨777758, 777761⟩, ⟨75549, 75553⟩, ⟨(-443), (-439)⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-54471579), (-54471577)⟩, ⟨(-21488607), (-21488603)⟩, ⟨(-2029711), (-2029706)⟩, ⟨23487, 23492⟩, ⟨1087, 1092⟩⟩
...
def j19 : Jet := ⟨⟨1377184186, 1377184189⟩, ⟨(-21488607), (-21488603)⟩, ⟨(-2029711), (-2029706)⟩, ⟨23487, 23492⟩, ⟨1087, 1092⟩⟩
...
def j25 : Jet := ⟨⟨4549, 4550⟩, ⟨1812, 1814⟩, ⟨177, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847628), (-847626)⟩, ⟨1812, 1814⟩, ⟨177, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-326978), (-326977)⟩, ⟨(-130094), (-130090)⟩, ⟨(-12733), (-12729)⟩, ⟨53, 56⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35464416, 35464418⟩, ⟨(-130094), (-130090)⟩, ⟨(-12733), (-12729)⟩, ⟨53, 56⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13680623, 13680625⟩, ⟨5422064, 5422067⟩, ⟨522238, 522242⟩, ⟨(-3953), (-3949)⟩, ⟨(-189), (-185)⟩⟩
...
def j33 : Jet := ⟨⟨(-702147260), (-702147257)⟩, ⟨5422064, 5422067⟩, ⟨522238, 522242⟩, ⟨(-3953), (-3949)⟩, ⟨(-189), (-185)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-270857765), (-270857762)⟩, ⟨(-106251512), (-106251507)⟩, ⟨(-9796217), (-9796212)⟩, ⟨162720, 162725⟩, ⟨7375, 7379⟩⟩
...
def j36 : Jet := ⟨⟨4024109531, 4024109534⟩, ⟨(-106251512), (-106251507)⟩, ⟨(-9796217), (-9796212)⟩, ⟨162720, 162725⟩, ⟨7375, 7379⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨855359274, 855359279⟩, ⟨157725433, 157725438⟩, ⟨(-3929925), (-3929918)⟩, ⟨(-237541), (-237536)⟩, ⟨3592, 3598⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4584056154, 4584056158⟩, ⟨121036186, 121036195⟩, ⟨14355140, 14355149⟩, ⟨488308, 488318⟩, ⟨34538, 34547⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨912932433, 912932440⟩, ⟨192446555, 192446565⟩, ⟨3109286, 3109300⟩, ⟨260137, 260148⟩, ⟨8812, 8827⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-849115035), (-849115034)⟩, ⟨(-169823007), (-169823006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3445852261, 3445852262⟩, ⟨(-169823007), (-169823006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨194051681, 194051685⟩, ⟨81812358, 81812364⟩, ⟨9944850, 9944860⟩, ⟨389226, 389234⟩, ⟨29308, 29319⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4489018977, 4489018981⟩, ⟨81812358, 81812364⟩, ⟨9944850, 9944860⟩, ⟨389226, 389234⟩, ⟨29308, 29319⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4390921281, 4390921284⟩, ⟨40012263, 40012267⟩, ⟨4681457, 4681463⟩, ⟨147700, 147706⟩, ⟨10491, 10499⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3522836143, 3522836147⟩, ⟨(-141515190), (-141515184)⟩, ⟨2173846, 2173854⟩, ⟨(-66607), (-66599)⟩, ⟨2575, 2584⟩⟩
...
def j47 : Jet := ⟨⟨5978790666, 5978790675⟩, ⟨1195758127, 1195758135⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8322749712, 8322749738⟩, ⟨3329099866, 3329099896⟩, ⟨332909985, 332909990⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8322749712, 8322749738⟩, ⟨3329099866, 3329099896⟩, ⟨332909985, 332909990⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8322749738), (-8322749712)⟩, ⟨(-3329099896), (-3329099866)⟩, ⟨(-332909990), (-332909985)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4161374869), (-4161374856)⟩, ⟨(-1664549948), (-1664549933)⟩, ⟨(-166454995), (-166454992)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1629948387, 1629948398⟩, ⟨(-631699926), (-631699915)⟩, ⟨59240258, 59240264⟩, ⟨8668349, 8668351⟩, ⟨(-1987826), (-1987824)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1336923122, 1336923134⟩, ⟨(-571840861), (-571840846)⟩, ⟨70229196, 70229208⟩, ⟨4813070, 4813080⟩, ⟨(-1875324), (-1875313)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨679292027, 1018938042⟩, ⟨169823006, 169823007⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2134058841, 3201088268⟩, ⟨533514708, 533514712⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1060358979, 2385807713⟩, ⟨530179486, 795269240⟩, ⟨66272435, 66272437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨265, 598⟩, ⟨132, 200⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94422), (-94088)⟩, ⟨132, 200⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-52451), (-23228)⟩, ⟨(-17452), (-11502)⟩, ⟨(-1438), (-1403)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5060605, 5089829⟩, ⟨(-17452), (-11502)⟩, ⟨(-1438), (-1403)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1249382, 2827345⟩, ⟨614996, 939610⟩, ⟨74055, 76773⟩, ⟨(-537), (-345)⟩, ⟨(-23), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141916195), (-140338231)⟩, ⟨614996, 939610⟩, ⟨74055, 76773⟩, ⟨(-537), (-345)⟩, ⟨(-23), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-78832906), (-34647272)⟩, ⟨(-26125804), (-16801692)⟩, ⟨(-2095605), (-1948825)⟩, ⟨18331, 28630⟩, ⟨1029, 1139⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1352822859, 1397008494⟩, ⟨(-26125804), (-16801692)⟩, ⟨(-2095605), (-1948825)⟩, ⟨18331, 28630⟩, ⟨1029, 1139⟩⟩
...
def j72 : Jet := ⟨⟨2907, 6561⟩, ⟨1441, 2184⟩, ⟨175, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849270), (-845615)⟩, ⟨1441, 2184⟩, ⟨175, 182⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-471761), (-208768)⟩, ⟨(-156899), (-103170)⟩, ⟨(-12885), (-12541)⟩, ⟨41, 68⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35319633, 35582627⟩, ⟨(-156899), (-103170)⟩, ⟨(-12885), (-12541)⟩, ⟨41, 68⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8719854, 19765764⟩, ⟨4272771, 6563117⟩, ⟨508780, 533218⟩, ⟨(-4797), (-3101)⟩, ⟨(-194), (-178)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707108029), (-696062118)⟩, ⟨4272771, 6563117⟩, ⟨508780, 533218⟩, ⟨(-4797), (-3101)⟩, ⟨(-194), (-178)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-392790835), (-171846644)⟩, ⟨(-129875400), (-82277580)⟩, ⟨(-10257809), (-9228971)⟩, ⟨126068, 199239⟩, ⟨6853, 7803⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3902176461, 4123120652⟩, ⟨(-129875400), (-82277580)⟩, ⟨(-10257809), (-9228971)⟩, ⟨126068, 199239⟩, ⟨6853, 7803⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨672182902, 1041206415⟩, ⟨148573863, 165186075⟩, ⟨(-4807190), (-3055403)⟩, ⟨(-251206), (-220741)⟩, ⟨2788, 4406⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4473976298, 4727296231⟩, ⟨89278964, 157337706⟩, ⟨11795884, 17663478⟩, ⟨206789, 856951⟩, ⟨13978, 64216⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨700198666, 1146013654⟩, ⟨168738824, 219956167⟩, ⟨(-356581), 7150585⟩, ⟨(-12183), 593639⟩, ⟨(-16730), 40398⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1018938042), (-679292027)⟩, ⟨(-169823007), (-169823006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3276029254, 3615675269⟩, ⟨(-169823007), (-169823006)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨114151782, 305787497⟩, ⟨55018206, 117380532⟩, ⟨6439046, 15080454⟩, ⟨(-43026), 1049198⟩, ⟨(-10772), 94269⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4409119078, 4600754793⟩, ⟨55018206, 117380532⟩, ⟨6439046, 15080454⟩, ⟨(-43026), 1049198⟩, ⟨(-10772), 94269⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4351668903, 4445232432⟩, ⟨26579194, 57925541⟩, ⟨2733279, 7360809⟩, ⟨(-119215), 501070⟩, ⟨(-18212), 47250⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3319278971, 3742174472⟩, ⟨(-155490945), (-123300949)⟩, ⟨(-205541), 5145683⟩, ⟨(-391407), 313748⟩, ⟨(-35145), 44491⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4783032531, 7174548810⟩, ⟨1195758127, 1195758135⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5326559811, 11984759623⟩, ⟨2663279892, 3994919876⟩, ⟨332909985, 332909990⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5326559811, 11984759623⟩, ⟨2663279892, 3994919876⟩, ⟨332909985, 332909990⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11984759623), (-5326559811)⟩, ⟨(-3994919876), (-2663279892)⟩, ⟨(-332909990), (-332909985)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5992379812), (-2663279905)⟩, ⟨(-1997459938), (-1331639946)⟩, ⟨(-166454995), (-166454992)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1064211649, 2310238506⟩, ⟨(-1074422352), (-329955188)⟩, ⟨(-38384457), 208596341⟩, ⟨(-23812169), 33710568⟩, ⟨(-7961605), 3512392⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨822454538, 2012894387⟩, ⟨(-1019774254), (-285550863)⟩, ⟨(-24082233), 223413717⟩, ⟨(-29796973), 30981596⟩, ⟨(-8300696), 4294157⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4390921281, 4390921284⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2420
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4351668903, 4445232432⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2421
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (3363845 / 134217728)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((1977 / 12500) : ℝ)..(5931 / 25000), prawitzNormalCorrection
