...
namespace FiniteNormalPanel4_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (58779 / 160000)
def radius : Rat := (8397 / 160000)

def j0 : Jet := ⟨⟨1577836766, 1577836767⟩, ⟨225405252, 225405253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4956920392, 4956920396⟩, ⟨708131483, 708131487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5720895662, 5720895672⟩, ⟨1634541614, 1634541626⟩, ⟨116752972, 116752974⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1431, 1434⟩, ⟨409, 410⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93256), (-93252)⟩, ⟨409, 410⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-124217), (-124211)⟩, ⟨(-34947), (-34942)⟩, ⟨(-2343), (-2337)⟩, ⟨22, 24⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4988839, 4988846⟩, ⟨(-34947), (-34942)⟩, ⟨(-2343), (-2337)⟩, ⟨22, 24⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6645132, 6645142⟩, ⟨1852059, 1852071⟩, ⟨119193, 119207⟩, ⟨(-1813), (-1806)⟩, ⟨(-56), (-51)⟩⟩
...
def j16 : Jet := ⟨⟨(-136520445), (-136520434)⟩, ⟨1852059, 1852071⟩, ⟨119193, 119207⟩, ⟨(-1813), (-1806)⟩, ⟨(-56), (-51)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-181845209), (-181845193)⟩, ⟨(-49488832), (-49488810)⟩, ⟨(-2847522), (-2847496)⟩, ⟨93291, 93309⟩, ⟨2475, 2487⟩⟩
...
def j19 : Jet := ⟨⟨1249810556, 1249810573⟩, ⟨(-49488832), (-49488810)⟩, ⟨(-2847522), (-2847496)⟩, ⟨93291, 93309⟩, ⟨2475, 2487⟩⟩
...
def j22 : Jet := ⟨⟨(-144), (-142)⟩, ⟨(-42), (-40)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11691, 11694⟩, ⟨(-42), (-40)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨15572, 15577⟩, ⟨4393, 4398⟩, ⟨297, 301⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-836605), (-836599)⟩, ⟨4393, 4398⟩, ⟨297, 301⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1114358), (-1114349)⟩, ⟨(-312537), (-312526)⟩, ⟨(-20676), (-20666)⟩, ⟨226, 234⟩, ⟨4, 9⟩⟩
...
def j30 : Jet := ⟨⟨34677036, 34677046⟩, ⟨(-312537), (-312526)⟩, ⟨(-20676), (-20666)⟩, ⟨226, 234⟩, ⟨4, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨46189805, 46189820⟩, ⟨12780787, 12780808⟩, ⟨796165, 796185⟩, ⟨(-16064), (-16047)⟩, ⟨(-472), (-459)⟩⟩
...
def j33 : Jet := ⟨⟨(-669638078), (-669638062)⟩, ⟨12780787, 12780808⟩, ⟨796165, 796185⟩, ⟨(-16064), (-16047)⟩, ⟨(-472), (-459)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-891957801), (-891957777)⟩, ⟨(-237821082), (-237821044)⟩, ⟨(-12278729), (-12278690)⟩, ⟨629027, 629062⟩, ⟨14899, 14926⟩⟩
...
def j36 : Jet := ⟨⟨3403009495, 3403009519⟩, ⟨(-237821082), (-237821044)⟩, ⟨(-12278729), (-12278690)⟩, ⟨629027, 629062⟩, ⟨14899, 14926⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1442435065, 1442435086⟩, ⟨148945953, 148945984⟩, ⟨(-11445848), (-11445813)⟩, ⟨(-361816), (-361789)⟩, ⟨18237, 18256⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5420714802, 5420714842⟩, ⟨378829399, 378829467⟩, ⟨46033628, 46033703⟩, ⟨3581924, 3581994⟩, ⟨322615, 322674⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1820509579, 1820509620⟩, ⟨315213188, 315213256⟩, ⟨14151665, 14151743⟩, ⟨1333160, 1333228⟩, ⟨100991, 101045⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1577836767), (-1577836766)⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2717130529, 2717130530⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨771660154, 771660190⟩, ⟨267219090, 267219156⟩, ⟨35130846, 35130925⟩, ⟨3207390, 3207462⟩, ⟨327926, 327986⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5066627450, 5066627486⟩, ⟨267219090, 267219156⟩, ⟨35130846, 35130925⟩, ⟨3207390, 3207462⟩, ⟨327926, 327986⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4664868615, 4664868632⟩, ⟨123014959, 123014991⟩, ⟨14550586, 14550624⟩, ⟨1092821, 1092858⟩, ⟨99448, 99479⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2951141662, 2951141675⟩, ⟨(-166995031), (-166995007)⟩, ⟨2749174, 2749202⟩, ⟨(-72283), (-72255)⟩, ⟨5558, 5582⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨17587512852, 17587512857⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value69

def j47 : Jet := ⟨⟨6461102608, 6461102615⟩, ⟨923014657, 923014662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9719712406, 9719712428⟩, ⟨2777060682, 2777060702⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9719712406, 9719712428⟩, ⟨2777060682, 2777060702⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9719712428), (-9719712406)⟩, ⟨(-2777060702), (-2777060682)⟩, ⟨(-198361480), (-198361477)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4859856214), (-4859856203)⟩, ⟨(-1388530351), (-1388530341)⟩, ⟨(-99180740), (-99180738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1385305211, 1385305231⟩, ⟨(-447858675), (-447858664)⟩, ⟨40404748, 40404753⟩, ⟨2540545, 2540547⟩, ⟨(-671855), (-671854)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨951865669, 951865688⟩, ⟨(-361593788), (-361593769)⟩, ⟨46062920, 46062938⟩, ⟨(-135340), (-135322)⟩, ⟨(-525236), (-525218)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1352431514, 1803242020⟩, ⟨225405252, 225405253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4248788908, 5665051883⟩, ⟨708131483, 708131487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4203107018, 7472190270⟩, ⟨1401035668, 1868047572⟩, ⟨116752972, 116752974⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1052, 1872⟩, ⟨350, 468⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93635), (-92814)⟩, ⟨350, 468⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-162902), (-90828)⟩, ⟨(-40384), (-29461)⟩, ⟨(-2404), (-2266)⟩, ⟨18, 27⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4950154, 5022229⟩, ⟨(-40384), (-29461)⟩, ⟨(-2404), (-2266)⟩, ⟨18, 27⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4844280, 8737448⟩, ⟨1544501, 2155532⟩, ⟨112815, 124696⟩, ⟨(-2127), (-1492)⟩, ⟨(-61), (-47)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138321297), (-134428128)⟩, ⟨1544501, 2155532⟩, ⟨112815, 124696⟩, ⟨(-2127), (-1492)⟩, ⟨(-61), (-47)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-240645151), (-131552994)⟩, ⟨(-58649821), (-40100899)⟩, ⟨(-3145857), (-2499783)⟩, ⟨75084, 111372⟩, ⟨2033, 2859⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1191010614, 1300102772⟩, ⟨(-58649821), (-40100899)⟩, ⟨(-3145857), (-2499783)⟩, ⟨75084, 111372⟩, ⟨2033, 2859⟩⟩
...
def j70 : Jet := ⟨⟨(-188), (-104)⟩, ⟨(-47), (-34)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11647, 11732⟩, ⟨(-47), (-34)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨11397, 20411⟩, ⟨3717, 5070⟩, ⟨289, 307⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-840780), (-831765)⟩, ⟨3717, 5070⟩, ⟨289, 307⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1462752), (-813975)⟩, ⟨(-362051), (-262504)⟩, ⟨(-21362), (-19869)⟩, ⟨188, 272⟩, ⟨3, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34328642, 34977420⟩, ⟨(-362051), (-262504)⟩, ⟨(-21362), (-19869)⟩, ⟨188, 272⟩, ⟨3, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨33594424, 60852137⟩, ⟨10568261, 14956146⟩, ⟨738543, 845742⟩, ⟨(-18951), (-13142)⟩, ⟨(-518), (-405)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-682233459), (-654975745)⟩, ⟨10568261, 14956146⟩, ⟨738543, 845742⟩, ⟨(-18951), (-13142)⟩, ⟨(-518), (-405)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1186918983), (-640967197)⟩, ⟨(-286387519), (-187635703)⟩, ⟨(-14375454), (-9828253)⟩, ⟨495228, 761549⟩, ⟨10931, 18309⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3108048313, 3654000099⟩, ⟨(-286387519), (-187635703)⟩, ⟨(-14375454), (-9828253)⟩, ⟨495228, 761549⟩, ⟨10931, 18309⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1178205173, 1714832536⟩, ⟨119008550, 174684324⟩, ⟨(-13819252), (-9084529)⟩, ⟨(-444397), (-265250)⟩, ⟨14390, 22135⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5048369888, 5935153581⟩, ⟨259237658, 546887867⟩, ⟨26890775, 77843833⟩, ⟨841162, 8897923⟩, ⟨(-33151), 1120876⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1384880281, 2369702437⟩, ⟨210999121, 459747250⟩, ⟨(-4536714), 42645218⟩, ⟨(-1397882), 5858583⟩, ⟨(-280070), 767125⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1803242020), (-1352431514)⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2491725276, 2942535782⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨446544353, 1307458068⟩, ⟨136070196, 507321292⟩, ⟨5359598, 96270929⟩, ⟨(-2513784), 15594588⟩, ⟨(-653366), 2524182⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4741511649, 5602425364⟩, ⟨136070196, 507321292⟩, ⟨5359598, 96270929⟩, ⟨(-2513784), 15594588⟩, ⟨(-653366), 2524182⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4512719519, 4905327076⟩, ⟨59569630, 241420761⟩, ⟨(-3907255), 45419614⟩, ⟨(-3626096), 7630082⟩, ⟨(-947684), 1414844⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2618054228, 3360700897⟩, ⟨(-222878378), (-71432778)⟩, ⟨(-15346974), 27991258⟩, ⟨(-4867963), 5432523⟩, ⟨(-1049708), 1159631⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5538087951, 7384117277⟩, ⟨923014657, 923014662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7141013199, 12695134609⟩, ⟨2380337728, 3173783662⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7141013199, 12695134609⟩, ⟨2380337728, 3173783662⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12695134609), (-7141013199)⟩, ⟨(-3173783662), (-2380337728)⟩, ⟨(-198361480), (-198361477)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6347567305), (-3570506599)⟩, ⟨(-1586891831), (-1190168864)⟩, ⟨(-99180740), (-99180738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨979743726, 1870340675⟩, ⟨(-691047949), (-271494611)⟩, ⟨(-5573863), 105038628⟩, ⟨(-8756829), 11325070⟩, ⟨(-2258882), 873219⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨597215770, 1463493236⟩, ⟨(-637784591), (-181787979)⟩, ⟨(-6529165), 130239933⟩, ⟨(-18926333), 13985821⟩, ⟨(-4061735), 3110481⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1577836766, 1577836767⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4664868615, 4664868632⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar69 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified72
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar69 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1352431514, 1803242020⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4512719519, 4905327076⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified73
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((25191 / 80000) : ℝ)..(8397 / 20000), prawitzNormalCorrection
      ((144777 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
