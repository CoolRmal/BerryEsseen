...
namespace FiniteNormalPanel22_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (312809 / 800000)
def radius : Rat := (44687 / 800000)

def j0 : Jet := ⟨⟨1679380531, 1679380532⟩, ⟨239911504, 239911505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5275929538, 5275929543⟩, ⟨753704218, 753704222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨6480941663, 6480941676⟩, ⟨1851697612, 1851697626⟩, ⟨132264114, 132264117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1622, 1624⟩, ⟨463, 464⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93065), (-93062)⟩, ⟨463, 464⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-140432), (-140427)⟩, ⟨(-39426), (-39421)⟩, ⟨(-2618), (-2612)⟩, ⟨28, 30⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨4972624, 4972630⟩, ⟨(-39426), (-39421)⟩, ⟨(-2618), (-2612)⟩, ⟨28, 30⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨7503499, 7503509⟩, ⟨2084364, 2084376⟩, ⟨132183, 132197⟩, ⟨(-2302), (-2293)⟩, ⟨(-68), (-63)⟩⟩
...
def j16 : Jet := ⟨⟨(-135662078), (-135662067)⟩, ⟨2084364, 2084376⟩, ⟨132183, 132197⟩, ⟨(-2302), (-2293)⟩, ⟨(-68), (-63)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-204708897), (-204708879)⟩, ⟨(-55343032), (-55343007)⟩, ⟨(-3079639), (-3079609)⟩, ⟨117702, 117724⟩, ⟨2974, 2989⟩⟩
...
def j19 : Jet := ⟨⟨1226946868, 1226946887⟩, ⟨(-55343032), (-55343007)⟩, ⟨(-3079639), (-3079609)⟩, ⟨117702, 117724⟩, ⟨2974, 2989⟩⟩
...
def j22 : Jet := ⟨⟨(-163), (-161)⟩, ⟨(-47), (-46)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11672, 11675⟩, ⟨(-47), (-46)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨17612, 17618⟩, ⟨4961, 4965⟩, ⟨331, 337⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-834565), (-834558)⟩, ⟨4961, 4965⟩, ⟨331, 337⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1259327), (-1259316)⟩, ⟨(-352323), (-352312)⟩, ⟨(-23064), (-23050)⟩, ⟨287, 296⟩, ⟨6, 11⟩⟩
...
def j30 : Jet := ⟨⟨34532067, 34532079⟩, ⟨(-352323), (-352312)⟩, ⟨(-23064), (-23050)⟩, ⟨287, 296⟩, ⟨6, 11⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨52107570, 52107589⟩, ⟨14356235, 14356258⟩, ⟨876718, 876748⟩, ⟨(-20361), (-20339)⟩, ⟨(-579), (-564)⟩⟩
...
def j33 : Jet := ⟨⟨(-663720313), (-663720293)⟩, ⟨14356235, 14356258⟩, ⟨876718, 876748⟩, ⟨(-20361), (-20339)⟩, ⟨(-579), (-564)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-1001528613), (-1001528580)⟩, ⟨(-264488023), (-264487976)⟩, ⟨(-12926996), (-12926936)⟩, ⟨789359, 789408⟩, ⟨17345, 17381⟩⟩
...
def j36 : Jet := ⟨⟨3293438683, 3293438716⟩, ⟨(-264488023), (-264487976)⟩, ⟨(-12926996), (-12926936)⟩, ⟨789359, 789408⟩, ⟨17345, 17381⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1507179164, 1507179190⟩, ⟨147328034, 147328072⟩, ⟨(-13494920), (-13494876)⟩, ⟨(-395848), (-395814)⟩, ⟨24307, 24331⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5601058851, 5601058909⟩, ⟨449807281, 449807373⟩, ⟨58107394, 58107514⟩, ⟨5089455, 5089562⟩, ⟨499420, 499504⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1965509540, 1965509595⟩, ⟨349975458, 349975547⟩, ⟨18221705, 18221815⟩, ⟨1849671, 1849767⟩, ⟨157500, 157574⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1679380532), (-1679380531)⟩, ⟨(-239911505), (-239911504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2615586764, 2615586765⟩, ⟨(-239911505), (-239911504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨899477804, 899477855⟩, ⟨320319132, 320319224⟩, ⟨45195382, 45195499⟩, ⟨4662522, 4662634⟩, ⟨522898, 522988⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5194445100, 5194445151⟩, ⟨320319132, 320319224⟩, ⟨45195382, 45195499⟩, ⟨4662522, 4662634⟩, ⟨522898, 522988⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4723343288, 4723343313⟩, ⟨145634152, 145634195⟩, ⟨18303069, 18303126⟩, ⟨1555492, 1555547⟩, ⟨154312, 154357⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2876462923, 2876462941⟩, ⟨(-175150494), (-175150464)⟩, ⟨3011418, 3011457⟩, ⟨(-75113), (-75075)⟩, ⟨7083, 7115⟩⟩
...
def j47 : Jet := ⟨⟨6331903032, 6331903039⟩, ⟨904557574, 904557579⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9334878066, 9334878087⟩, ⟨2667108012, 2667108032⟩, ⟨190507714, 190507717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9334878066, 9334878087⟩, ⟨2667108012, 2667108032⟩, ⟨190507714, 190507717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9334878087), (-9334878066)⟩, ⟨(-2667108032), (-2667108012)⟩, ⟨(-190507717), (-190507714)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4667439044), (-4667439033)⟩, ⟨(-1333554016), (-1333554006)⟩, ⟨(-95253859), (-95253857)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1448778952, 1448778968⟩, ⟨(-449834627), (-449834618)⟩, ⟨37704033, 37704037⟩, ⟨2748689, 2748691⟩, ⟨(-631463), (-631461)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨970288864, 970288881⟩, ⟨(-360348959), (-360348938)⟩, ⟨44611717, 44611741⟩, ⟨(-37455), (-37432)⟩, ⟨(-498314), (-498294)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1439469026, 1919292036⟩, ⟨239911504, 239911505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4522225316, 6029633761⟩, ⟨753704218, 753704222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4761508155, 8464903406⟩, ⟨1587169382, 2116225858⟩, ⟨132264114, 132264117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1191, 2121⟩, ⟨397, 531⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93496), (-92565)⟩, ⟨397, 531⟩, ⟨33, 34⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-184271), (-102619)⟩, ⟨(-45628), (-33159)⟩, ⟨(-2698), (-2520)⟩, ⟨24, 34⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4928785, 5010438⟩, ⟨(-45628), (-33159)⟩, ⟨(-2698), (-2520)⟩, ⟨24, 34⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨5464174, 9875017⟩, ⟨1731463, 2431995⟩, ⟨123982, 139252⟩, ⟨(-2710), (-1884)⟩, ⟨(-75), (-56)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-137701403), (-133290559)⟩, ⟨1731463, 2431995⟩, ⟨123982, 139252⟩, ⟨(-2710), (-1884)⟩, ⟨(-75), (-56)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-271394168), (-147769247)⟩, ⟨(-65929000), (-44463223)⟩, ⟨(-3463238), (-2631952)⟩, ⟨93794, 141419⟩, ⟨2334, 3531⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1160261597, 1283886519⟩, ⟨(-65929000), (-44463223)⟩, ⟨(-3463238), (-2631952)⟩, ⟨93794, 141419⟩, ⟨2334, 3531⟩⟩
...
def j70 : Jet := ⟨⟨(-213), (-118)⟩, ⟨(-54), (-39)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11622, 11718⟩, ⟨(-54), (-39)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨12884, 23095⟩, ⟨4187, 5731⟩, ⟨322, 344⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-839293), (-829081)⟩, ⟨4187, 5731⟩, ⟨322, 344⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1654154), (-919139)⟩, ⟨(-408898), (-295083)⟩, ⟨(-23944), (-22029)⟩, ⟨238, 345⟩, ⟨5, 11⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34137240, 34872256⟩, ⟨(-408898), (-295083)⟩, ⟨(-23944), (-22029)⟩, ⟨238, 345⟩, ⟨5, 11⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨37845397, 68729343⟩, ⟨11809239, 16855200⟩, ⟨802596, 940430⟩, ⟨(-24128), (-16547)⟩, ⟨(-646), (-486)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-677982486), (-647098539)⟩, ⟨11809239, 16855200⟩, ⟨802596, 940430⟩, ⟨(-24128), (-16547)⟩, ⟨(-646), (-486)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1336228162), (-717389623)⟩, ⟨(-320965025), (-205910146)⟩, ⟨(-15624784), (-9769073)⟩, ⟨612705, 964086⟩, ⟨11553, 22309⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨2958739134, 3577577673⟩, ⟨(-320965025), (-205910146)⟩, ⟨(-15624784), (-9769073)⟩, ⟨612705, 964086⟩, ⟨11553, 22309⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1221654090, 1802427113⟩, ⟨111052378, 178487501⟩, ⟨(-16431563), (-10573863)⟩, ⟨(-508992), (-263333)⟩, ⟨18916, 29775⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5156210643, 6234663902⟩, ⟨296769540, 676338457⟩, ⟨31160541, 106294018⟩, ⟨923719, 14034720⟩, ⟨(-100223), 2002233⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1466624862, 2616440705⟩, ⟨217733712, 542928547⟩, ⟨(-7315752), 60020043⟩, ⟨(-2257941), 9260355⟩, ⟨(-482277), 1371818⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1919292036), (-1439469026)⟩, ⟨(-239911505), (-239911504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2375675260, 2855498270⟩, ⟨(-239911505), (-239911504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨500816033, 1593903165⟩, ⟨148701330, 661490650⟩, ⟨2124696, 141758747⟩, ⟨(-4600596), 26456904⟩, ⟨(-1260687), 4851353⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4795783329, 5888870461⟩, ⟨148701330, 661490650⟩, ⟨2124696, 141758747⟩, ⟨(-4600596), 26456904⟩, ⟨(-1260687), 4851353⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4538472491, 5029165542⟩, ⟨63496353, 312999662⟩, ⟨(-9787797), 66632265⟩, ⟨(-6772232), 13193723⟩, ⟨(-1995577), 2834435⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2510365288, 3343628139⟩, ⟨(-245801165), (-45416356)⟩, ⟨(-23991163), 40753469⟩, ⟨(-8224498), 9318549⟩, ⟨(-2063740), 2262757⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5427345454, 7236460614⟩, ⟨904557574, 904557579⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6858277757, 12192493822⟩, ⟨2286092580, 3048123464⟩, ⟨190507714, 190507717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6858277757, 12192493822⟩, ⟨2286092580, 3048123464⟩, ⟨190507714, 190507717⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12192493822), (-6858277757)⟩, ⟨(-3048123464), (-2286092580)⟩, ⟨(-190507717), (-190507714)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6096246911), (-3429138878)⟩, ⟨(-1524061732), (-1143046290)⟩, ⟨(-95253859), (-95253857)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1038784046, 1932926800⟩, ⟨(-685895739), (-276458042)⟩, ⟨(-6080738), 98656290⟩, ⟨(-7581811), 10860452⟩, ⟨(-2057454), 740028⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨607158851, 1504781759⟩, ⟨(-644590695), (-172571385)⟩, ⟨(-12607589), 134398555⟩, ⟨(-21758158), 16827947⟩, ⟨(-5191280), 4277911⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1679380531, 1679380532⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4723343288, 4723343313⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified442
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1439469026, 1919292036⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4538472491, 5029165542⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified443
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (860587 / 33554432)

theorem envelope_integral : (∫ s in ((134061 / 400000) : ℝ)..(44687 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((134061 / 400000) : ℝ)..(44687 / 100000), prawitzNormalCorrection
