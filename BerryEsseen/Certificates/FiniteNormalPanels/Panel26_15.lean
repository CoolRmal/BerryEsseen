...
namespace FiniteNormalPanel26_15
...
def j2 : Jet := ⟨⟨1820699906, 1820699910⟩, ⟨606899968, 606899972⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨771821510, 771821515⟩, ⟨514547672, 514547678⟩, ⟨85757945, 85757947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨193, 194⟩, ⟨128, 129⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94494), (-94492)⟩, ⟨128, 129⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-16981), (-16980)⟩, ⟨(-11298), (-11296)⟩, ⟨(-1869), (-1866)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5096075, 5096077⟩, ⟨(-11298), (-11296)⟩, ⟨(-1869), (-1866)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨915783, 915784⟩, ⟨608491, 608494⟩, ⟨100063, 100066⟩, ⟨(-450), (-446)⟩, ⟨(-38), (-35)⟩⟩
...
def j16 : Jet := ⟨⟨(-142249794), (-142249792)⟩, ⟨608491, 608494⟩, ⟨100063, 100066⟩, ⟨(-450), (-446)⟩, ⟨(-38), (-35)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-25562815), (-25562813)⟩, ⟨(-16932529), (-16932526)⟩, ⟨(-2749434), (-2749429)⟩, ⟨24055, 24059⟩, ⟨1936, 1940⟩⟩
...
def j19 : Jet := ⟨⟨1406092950, 1406092953⟩, ⟨(-16932529), (-16932526)⟩, ⟨(-2749434), (-2749429)⟩, ⟨24055, 24059⟩, ⟨1936, 1940⟩⟩
...
def j22 : Jet := ⟨⟨(-20), (-19)⟩, ⟨(-13), (-12)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11815, 11817⟩, ⟨(-13), (-12)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2123, 2124⟩, ⟨1412, 1414⟩, ⟨232, 235⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850054), (-850052)⟩, ⟨1412, 1414⟩, ⟨232, 235⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-152758), (-152757)⟩, ⟨(-101586), (-101583)⟩, ⟨(-16764), (-16760)⟩, ⟨54, 58⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35638636, 35638638⟩, ⟨(-101586), (-101583)⟩, ⟨(-16764), (-16760)⟩, ⟨54, 58⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6404394, 6404396⟩, ⟨4251340, 4251343⟩, ⟨696415, 696420⟩, ⟨(-4029), (-4024)⟩, ⟨(-329), (-326)⟩⟩
...
def j33 : Jet := ⟨⟨(-709423489), (-709423486)⟩, ⟨4251340, 4251343⟩, ⟨696415, 696420⟩, ⟨(-4029), (-4024)⟩, ⟨(-329), (-326)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-127486026), (-127486024)⟩, ⟨(-84226704), (-84226699)⟩, ⟨(-13530646), (-13530641)⟩, ⟨167593, 167597⟩, ⟨13362, 13366⟩⟩
...
def j36 : Jet := ⟨⟨4167481270, 4167481272⟩, ⟨(-84226704), (-84226699)⟩, ⟨(-13530646), (-13530641)⟩, ⟨167593, 167597⟩, ⟨13362, 13366⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨596063514, 596063518⟩, ⟨191509889, 191509893⟩, ⟨(-3558176), (-3558172)⟩, ⟨(-378312), (-378308)⟩, ⟨4219, 4223⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4426353202, 4426353205⟩, ⟨89458618, 89458625⟩, ⟨16179124, 16179132⟩, ⟨439425, 439433⟩, ⟨43614, 43623⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨614297493, 614297498⟩, ⟨209783535, 209783543⟩, ⟨2567248, 2567256⟩, ⟨318402, 318412⟩, ⟨8709, 8721⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-579546781), (-579546780)⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3715420515, 3715420516⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨87861299, 87861302⟩, ⟨60009536, 60009540⟩, ⟨10981046, 10981052⟩, ⟨341868, 341876⟩, ⟨35128, 35137⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4382828595, 4382828598⟩, ⟨60009536, 60009540⟩, ⟨10981046, 10981052⟩, ⟨341868, 341876⟩, ⟨35128, 35137⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4338675544, 4338675546⟩, ⟨29702496, 29702499⟩, ⟨5333539, 5333543⟩, ⟨132698, 132704⟩, ⟨13199, 13206⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3753230935, 3753230939⟩, ⟨(-169453652), (-169453646)⟩, ⟨3277869, 3277874⟩, ⟨(-125105), (-125097)⟩, ⟨5448, 5457⟩⟩
...
def j47 : Jet := ⟨⟨3379638638, 3379638645⟩, ⟨1126546212, 1126546219⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2659381675, 2659381687⟩, ⟨1772921114, 1772921132⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2659381675, 2659381687⟩, ⟨1772921114, 1772921132⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2659381687), (-2659381675)⟩, ⟨(-1772921132), (-1772921114)⟩, ⟨(-295486857), (-295486852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1329690844), (-1329690837)⟩, ⟨(-886460566), (-886460557)⟩, ⟨(-147743429), (-147743426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3151413761, 3151413771⟩, ⟨(-650436626), (-650436616)⟩, ⟨(-41282614), (-41282608)⟩, ⟨17756508, 17756510⟩, ⟨(-206171), (-206169)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2753917038, 2753917051⟩, ⟨(-692731106), (-692731090)⟩, ⟨(-8008073), (-8008061)⟩, ⟨16557390, 16557403⟩, ⟨(-889299), (-889283)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨386364520, 772729042⟩, ⟨193182260, 193182261⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1213799937, 2427599882⟩, ⟨606899968, 606899972⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨343031782, 1372127139⟩, ⟨343031782, 686063572⟩, ⟨85757945, 85757947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨85, 344⟩, ⟨85, 172⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94602), (-94342)⟩, ⟨85, 172⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-30223), (-7534)⟩, ⟨(-15106), (-7479)⟩, ⟨(-1882), (-1847)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5082833, 5105523⟩, ⟨(-15106), (-7479)⟩, ⟨(-1882), (-1847)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨405957, 1631078⟩, ⟨401131, 814943⟩, ⟨98474, 101199⟩, ⟨(-603), (-293)⟩, ⟨(-38), (-33)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142759620), (-141534498)⟩, ⟨401131, 814943⟩, ⟨98474, 101199⟩, ⟨(-603), (-293)⟩, ⟨(-38), (-33)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-45607880), (-11304121)⟩, ⟨(-22771903), (-11043768)⟩, ⟨(-2810592), (-2663522)⟩, ⟨15680, 32416⟩, ⟨1856, 1996⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1386047885, 1420351645⟩, ⟨(-22771903), (-11043768)⟩, ⟨(-2810592), (-2663522)⟩, ⟨15680, 32416⟩, ⟨1856, 1996⟩⟩
...
def j70 : Jet := ⟨⟨(-35), (-8)⟩, ⟨(-18), (-8)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11800, 11828⟩, ⟨(-18), (-8)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨942, 3779⟩, ⟨936, 1890⟩, ⟨231, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851235), (-848397)⟩, ⟨936, 1890⟩, ⟨231, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-271947), (-67760)⟩, ⟨(-135900), (-67156)⟩, ⟨(-16905), (-16562)⟩, ⟨35, 76⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35519447, 35723635⟩, ⟨(-135900), (-67156)⟩, ⟨(-16905), (-16562)⟩, ⟨35, 76⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2836878, 11412746⟩, ⟨2793461, 5701010⟩, ⟨682109, 706612⟩, ⟨(-5413), (-2637)⟩, ⟨(-336), (-315)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712991005), (-704415136)⟩, ⟨2793461, 5701010⟩, ⟨682109, 706612⟩, ⟨(-5413), (-2637)⟩, ⟨(-336), (-315)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-227781550), (-56260446)⟩, ⟨(-113667667), (-54439125)⟩, ⟨(-13958761), (-12928706)⟩, ⟨108525, 226495⟩, ⟨12646, 13874⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4067185746, 4238706850⟩, ⟨(-113667667), (-54439125)⟩, ⟨(-13958761), (-12928706)⟩, ⟨108525, 226495⟩, ⟨12646, 13874⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨391710744, 802810650⟩, ⟨182984244, 197581586⟩, ⟨(-4806384), (-2313275)⟩, ⟨(-392720), (-358045)⟩, ⟨2739, 5710⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4351974488, 4535505686⟩, ⟨55893858, 126756039⟩, ⟨13992052, 19108571⟩, ⟨107833, 852947⟩, ⟨22440, 74399⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨396909929, 847771827⟩, ⟨190510643, 232340188⟩, ⟨(-1418139), 7058940⟩, ⟨49391, 645584⟩, ⟨(-23560), 46981⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-772729042), (-386364520)⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3522238254, 3908602776⟩, ⟨(-193182261), (-193182260)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨36679555, 167339359⟩, ⟨35211240, 91721988⟩, ⟨7890580, 15355346⟩, ⟨(-144304), 1018582⟩, ⟨(-7253), 99998⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4331646851, 4462306655⟩, ⟨35211240, 91721988⟩, ⟨7890580, 15355346⟩, ⟨(-144304), 1018582⟩, ⟨(-7253), 99998⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4313268083, 4377837497⟩, ⟨17272354, 45666411⟩, ⟨3632428, 7610515⟩, ⟨(-152423), 492586⟩, ⟨(-15542), 49872⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3537246454, 3984018181⟩, ⟨(-182744862), (-152447031)⟩, ⟨924880, 6149005⟩, ⟨(-481024), 284893⟩, ⟨(-36300), 52242⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2253092425, 4506184864⟩, ⟨1126546212, 1126546219⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1181947410, 4727789674⟩, ⟨1181947410, 2363894844⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1181947410, 4727789674⟩, ⟨1181947410, 2363894844⟩, ⟨295486852, 295486857⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4727789674), (-1181947410)⟩, ⟨(-2363894844), (-1181947410)⟩, ⟨(-295486857), (-295486852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2363894837), (-590973705)⟩, ⟨(-1181947422), (-590973705)⟩, ⟨(-147743429), (-147743426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2477021383, 3742849252⟩, ⟨(-1030008082), (-340830186)⟩, ⟨(-105302443), 56518260⟩, ⟨2631702, 33280487⟩, ⟨(-3261736), 1720632⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2040023706, 3471872646⟩, ⟨(-1114690071), (-368620949)⟩, ⟨(-85047762), 101610381⟩, ⟨(-2131187), 35526380⟩, ⟨(-4692348), 1744452⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4338675544, 4338675546⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified526
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4313268083, 4377837497⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified527
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (247526751 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((35983 / 400000) : ℝ)..(35983 / 200000), prawitzNormalCorrection
