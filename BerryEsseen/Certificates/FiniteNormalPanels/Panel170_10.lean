...
namespace FiniteNormalPanel170_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (17801 / 80000)
def radius : Rat := (2543 / 80000)

def j0 : Jet := ⟨⟨955683910, 955683911⟩, ⟨136526272, 136526273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3002369550, 3002369555⟩, ⟨428909933, 428909937⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2098787323, 2098787331⟩, ⟨599653516, 599653524⟩, ⟨42832393, 42832395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-46014), (-46012)⟩, ⟨(-13074), (-13072)⟩, ⟨(-916), (-911)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5067042, 5067045⟩, ⟨(-13074), (-13072)⟩, ⟨(-916), (-911)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2476070, 2476073⟩, ⟨701059, 701063⟩, ⟨48258, 48263⟩, ⟨(-259), (-255)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140689507), (-140689503)⟩, ⟨701059, 701063⟩, ⟨48258, 48263⟩, ⟨(-259), (-255)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-68749617), (-68749614)⟩, ⟨(-19300168), (-19300163)⟩, ⟨(-1281593), (-1281587)⟩, ⟨13601, 13607⟩, ⟨439, 444⟩⟩
...
def j19 : Jet := ⟨⟨1362906148, 1362906152⟩, ⟨(-19300168), (-19300163)⟩, ⟨(-1281593), (-1281587)⟩, ⟨13601, 13607⟩, ⟨439, 444⟩⟩
...
def j25 : Jet := ⟨⟨5757, 5759⟩, ⟨1636, 1640⟩, ⟨113, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846420), (-846417)⟩, ⟨1636, 1640⟩, ⟨113, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-413614), (-413611)⟩, ⟨(-117377), (-117372)⟩, ⟨(-8159), (-8154)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35377780, 35377784⟩, ⟨(-117377), (-117372)⟩, ⟨(-8159), (-8154)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17287776, 17287779⟩, ⟨4882006, 4882011⟩, ⟨332436, 332441⟩, ⟨(-2297), (-2291)⟩, ⟨(-79), (-75)⟩⟩
...
def j33 : Jet := ⟨⟨(-698540107), (-698540103)⟩, ⟨4882006, 4882011⟩, ⟨332436, 332441⟩, ⟨(-2297), (-2291)⟩, ⟨(-79), (-75)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-341350010), (-341350006)⟩, ⟨(-95142925), (-95142918)⟩, ⟨(-6122265), (-6122258)⟩, ⟨93976, 93983⟩, ⟨2955, 2961⟩⟩
...
def j36 : Jet := ⟨⟨3953617286, 3953617290⟩, ⟨(-95142925), (-95142918)⟩, ⟨(-6122265), (-6122258)⟩, ⟨93976, 93983⟩, ⟨2955, 2961⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨952730867, 952730872⟩, ⟨122612748, 122612755⟩, ⟨(-2823270), (-2823264)⟩, ⟨(-118478), (-118471)⟩, ⟨1664, 1670⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4665789002, 4665789008⟩, ⟨112281170, 112281181⟩, ⟨9927090, 9927102⟩, ⟨301848, 301863⟩, ⟨16471, 16482⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1034988370, 1034988377⟩, ⟨158105730, 158105743⟩, ⟨2340451, 2340463⟩, ⟨147839, 147854⟩, ⟨4453, 4468⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-955683911), (-955683910)⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3339283385, 3339283386⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨249408401, 249408405⟩, ⟨76199690, 76199700⟩, ⟨6948153, 6948163⟩, ⟨243562, 243574⟩, ⟨14305, 14316⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4544375697, 4544375701⟩, ⟨76199690, 76199700⟩, ⟨6948153, 6948163⟩, ⟨243562, 243574⟩, ⟨14305, 14316⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4417911836, 4417911839⟩, ⟨37039577, 37039583⟩, ⟨3222128, 3222134⟩, ⟨91377, 91385⟩, ⟨5011, 5018⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3434871228, 3434871232⟩, ⟨(-111636565), (-111636558)⟩, ⟨1327768, 1327774⟩, ⟨(-31380), (-31372)⟩, ⟨990, 998⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨47130195412, 47130195420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value682

def j47 : Jet := ⟨⟨10487057601, 10487057615⟩, ⟨1498151076, 1498151088⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨25606336334, 25606336403⟩, ⟨7316096046, 7316096116⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨25606336334, 25606336403⟩, ⟨7316096046, 7316096116⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-25606336403), (-25606336334)⟩, ⟨(-7316096116), (-7316096046)⟩, ⟨(-522578295), (-522578285)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12803168202), (-12803168167)⟩, ⟨(-3658048058), (-3658048023)⟩, ⟨(-261289148), (-261289142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨217942075, 217942081⟩, ⟨(-185622510), (-185622502)⟩, ⟨65789118, 65789124⟩, ⟨(-11149289), (-11149286)⟩, ⟨372799, 372801⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨174297709, 174297715⟩, ⟨(-154115196), (-154115188)⟩, ⟨57506555, 57506564⟩, ⟨(-10685566), (-10685558)⟩, ⟨609682, 609690⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨819157637, 1092210184⟩, ⟨136526272, 136526273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2573459614, 3431279491⟩, ⟨428909933, 428909937⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1541966196, 2741273248⟩, ⟨513988728, 685318314⟩, ⟨42832393, 42832395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-60189), (-33747)⟩, ⟨(-15003), (-11139)⟩, ⟨(-923), (-901)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5052867, 5079310⟩, ⟨(-15003), (-11139)⟩, ⟨(-923), (-901)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1814065, 3241882⟩, ⟨595112, 806472⟩, ⟨47406, 48999⟩, ⟨(-298), (-215)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141351512), (-139923694)⟩, ⟨595112, 806472⟩, ⟨47406, 48999⟩, ⟨(-298), (-215)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-90217944), (-50234982)⟩, ⟨(-22340832), (-16230260)⟩, ⟨(-1321419), (-1235458)⟩, ⟨11416, 15785⟩, ⟨417, 462⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1341437821, 1381420784⟩, ⟨(-22340832), (-16230260)⟩, ⟨(-1321419), (-1235458)⟩, ⟨11416, 15785⟩, ⟨417, 462⟩⟩
...
def j72 : Jet := ⟨⟨4224, 7531⟩, ⟨1396, 1879⟩, ⟨112, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847953), (-844645)⟩, ⟨1396, 1879⟩, ⟨112, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-541209), (-303241)⟩, ⟨(-134802), (-99880)⟩, ⟨(-8250), (-8048)⟩, ⟨24, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35250185, 35488154⟩, ⟨(-134802), (-99880)⟩, ⟨(-8250), (-8048)⟩, ⟨24, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12655415, 22650400⟩, ⟨4132433, 5626743⟩, ⟨324763, 339072⟩, ⟨(-2654), (-1934)⟩, ⟨(-82), (-71)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703172468), (-693177482)⟩, ⟨4132433, 5626743⟩, ⟨324763, 339072⟩, ⟨(-2654), (-1934)⟩, ⟨(-82), (-71)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-448801526), (-248862487)⟩, ⟨(-110716769), (-79362878)⟩, ⟨(-6401392), (-5798611)⟩, ⟨78382, 109524⟩, ⟨2761, 3126⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3846165770, 4046104809⟩, ⟨(-110716769), (-79362878)⟩, ⟨(-6401392), (-5798611)⟩, ⟨78382, 109524⟩, ⟨2761, 3126⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨803763060, 1103626752⟩, ⟨116112261, 128228494⟩, ⟨(-3286722), (-2361070)⟩, ⟨(-125122), (-110766)⟩, ⟨1389, 1947⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4559136489, 4796138591⟩, ⟨89425807, 138062945⟩, ⟨8287907, 11956805⟩, ⟨160894, 481067⟩, ⟨7589, 28657⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨853199859, 1232406790⟩, ⟨139989146, 178667622⟩, ⟨298341, 4688050⟩, ⟨8792, 313855⟩, ⟨(-5930), 17040⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1092210184), (-819157637)⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3202757112, 3475809659⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨169489066, 353629351⟩, ⟨55617986, 102534514⟩, ⟨4681303, 10122846⟩, ⟨22940, 570158⟩, ⟨(-2812), 41012⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4464456362, 4648596647⟩, ⟨55617986, 102534514⟩, ⟨4681303, 10122846⟩, ⟨22940, 570158⟩, ⟨(-2812), 41012⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4378891876, 4468284970⟩, ⟨26730326, 50284684⟩, ⟨1966917, 4882832⟩, ⟨(-44823), 267609⟩, ⟨(-7176), 20187⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3265339671, 3616071320⟩, ⟨(-122102805), (-98499886)⟩, ⟨(-131695), 3101864⟩, ⟨(-191489), 154047⟩, ⟨(-14315), 17762⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8988906514, 11985208703⟩, ⟨1498151076, 1498151088⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨18812818526, 33445010813⟩, ⟨6270939468, 8361252704⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨18812818526, 33445010813⟩, ⟨6270939468, 8361252704⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-33445010813), (-18812818526)⟩, ⟨(-8361252704), (-6270939468)⟩, ⟨(-522578295), (-522578285)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-16722505407), (-9406409263)⟩, ⟨(-4180626352), (-3135469734)⟩, ⟨(-261289148), (-261289142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨87504263, 480630560⟩, ⟨(-467835177), (-63881037)⟩, ⟨(-5922053), 222366798⟩, ⟨(-69558129), 20895651⟩, ⟨(-11848809), 17106725⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨66526965, 404658351⟩, ⟨(-407549485), (-50573712)⟩, ⟨(-3535672), 200865102⟩, ⟨(-65244261), 17792667⟩, ⟨(-10595144), 16563634⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨955683910, 955683911⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4417911836, 4417911839⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar682 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3442
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar682 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨819157637, 1092210184⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4378891876, 4468284970⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3443
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((7629 / 40000) : ℝ)..(2543 / 10000), prawitzNormalCorrection
      ((125873 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
