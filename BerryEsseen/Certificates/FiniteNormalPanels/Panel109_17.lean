...
namespace FiniteNormalPanel109_17
...
def j2 : Jet := ⟨⟨518166378, 518166382⟩, ⟨518166378, 518166382⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨62514188, 62514190⟩, ⟨125028376, 125028380⟩, ⟨62514188, 62514190⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1378), (-1377)⟩, ⟨(-2756), (-2754)⟩, ⟨(-1378), (-1375)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111678, 5111680⟩, ⟨(-2756), (-2754)⟩, ⟨(-1378), (-1375)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨74401, 74402⟩, ⟨148762, 148764⟩, ⟨74299, 74302⟩, ⟨(-82), (-79)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-143091176), (-143091174)⟩, ⟨148762, 148764⟩, ⟨74299, 74302⟩, ⟨(-82), (-79)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2082724), (-2082723)⟩, ⟨(-4163282), (-4163280)⟩, ⟨(-2077313), (-2077310)⟩, ⟨4325, 4328⟩, ⟨1077, 1080⟩⟩
...
def j19 : Jet := ⟨⟨1429573041, 1429573043⟩, ⟨(-4163282), (-4163280)⟩, ⟨(-2077313), (-2077310)⟩, ⟨4325, 4328⟩, ⟨1077, 1080⟩⟩
...
def j28 : Jet := ⟨⟨(-12402), (-12401)⟩, ⟨(-24799), (-24796)⟩, ⟨(-12391), (-12387)⟩, ⟨7, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778992, 35778994⟩, ⟨(-24799), (-24796)⟩, ⟨(-12391), (-12387)⟩, ⟨7, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨520771, 520772⟩, ⟨1041181, 1041183⟩, ⟨519868, 519871⟩, ⟨(-722), (-719)⟩, ⟨(-181), (-178)⟩⟩
...
def j33 : Jet := ⟨⟨(-715307112), (-715307110)⟩, ⟨1041181, 1041183⟩, ⟨519868, 519871⟩, ⟨(-722), (-719)⟩, ⟨(-181), (-178)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10411452), (-10411451)⟩, ⟨(-20807750), (-20807747)⟩, ⟨(-10373577), (-10373574)⟩, ⟨30276, 30279⟩, ⟨7541, 7545⟩⟩
...
def j36 : Jet := ⟨⟨4284555844, 4284555845⟩, ⟨(-20807750), (-20807747)⟩, ⟨(-10373577), (-10373574)⟩, ⟨30276, 30279⟩, ⟨7541, 7545⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨172470855, 172470858⟩, ⟨171968575, 171968580⟩, ⟨(-752898), (-752895)⟩, ⟨(-250097), (-250094)⟩, ⟨650, 654⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305404046, 4305404048⟩, ⟨20908994, 20908999⟩, ⟨10525593, 10525599⟩, ⟨71313, 71320⟩, ⟨18098, 18107⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨172889958, 172889962⟩, ⟨173226089, 173226096⟩, ⟨505128, 505136⟩, ⟨169932, 169939⟩, ⟨1168, 1178⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-164937482), (-164937481)⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4130029814, 4130029815⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6959526, 6959527⟩, ⟨13946112, 13946116⟩, ⟨7027279, 7027283⟩, ⟨54424, 54430⟩, ⟨13859, 13866⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301926822, 4301926823⟩, ⟨13946112, 13946116⟩, ⟨7027279, 7027283⟩, ⟨54424, 54430⟩, ⟨13859, 13866⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298445650, 4298445651⟩, ⟨6967413, 6967416⟩, ⟨3505149, 3505152⟩, ⟨21507, 21512⟩, ⟨5459, 5465⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4133374590, 4133374593⟩, ⟨(-158371214), (-158371208)⟩, ⟨3102975, 3102980⟩, ⟨(-113926), (-113920)⟩, ⟨4422, 4431⟩⟩
...
def j47 : Jet := ⟨⟨1235852199, 1235852207⟩, ⟨1235852199, 1235852207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨355609380, 355609385⟩, ⟨711218760, 711218770⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨355609380, 355609385⟩, ⟨711218760, 711218770⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-355609385), (-355609380)⟩, ⟨(-711218770), (-711218760)⟩, ⟨(-355609385), (-355609380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-177804693), (-177804690)⟩, ⟨(-355609385), (-355609380)⟩, ⟨(-177804693), (-177804690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4120792749, 4120792753⟩, ⟨(-341188297), (-341188291)⟩, ⟨(-156469507), (-156469502)⟩, ⟨13734817, 13734819⟩, ⟨2954492, 2954493⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3965753139, 3965753147⟩, ⟨(-480300280), (-480300266)⟩, ⟨(-135024538), (-135024524)⟩, ⟨18631861, 18631873⟩, ⟨2237124, 2237140⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 329874964⟩, ⟨164937481, 164937482⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1036332764⟩, ⟨518166378, 518166382⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 250056758⟩, ⟨0, 250056758⟩, ⟨62514188, 62514190⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5513), 0⟩, ⟨(-5513), 4⟩, ⟨(-1379), (-1372)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107543, 5113057⟩, ⟨(-5513), 4⟩, ⟨(-1379), (-1372)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 297687⟩, ⟨(-321), 297688⟩, ⟨73939, 74423⟩, ⟨(-162), 2⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142867889)⟩, ⟨(-321), 297688⟩, ⟨73939, 74423⟩, ⟨(-162), 2⟩, ⟨(-21), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8335226), 0⟩, ⟨(-8335245), 17332⟩, ⟨(-2083826), (-2057808)⟩, ⟨(-15), 8667⟩, ⟨1064, 1085⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423320539, 1431655766⟩, ⟨(-8335245), 17332⟩, ⟨(-2083826), (-2057808)⟩, ⟨(-15), 8667⟩, ⟨1064, 1085⟩⟩
...
def j72 : Jet := ⟨⟨0, 690⟩, ⟨(-1), 690⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851486)⟩, ⟨(-1), 690⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-49615), 0⟩, ⟨(-49616), 41⟩, ⟨(-12405), (-12341)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35741779, 35791395⟩, ⟨(-49616), 41⟩, ⟨(-12405), (-12341)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2083807⟩, ⟨(-2889), 2083810⟩, ⟨516617, 520955⟩, ⟨(-1447), 3⟩, ⟨(-182), (-176)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713744075)⟩, ⟨(-2889), 2083810⟩, ⟨516617, 520955⟩, ⟨(-1447), 3⟩, ⟨(-182), (-176)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-41676127), 0⟩, ⟨(-41676296), 121322⟩, ⟨(-10419201), (-10237048)⟩, ⟨(-128), 60663⟩, ⟨7423, 7584⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4253291169, 4294967296⟩, ⟨(-41676296), 121322⟩, ⟨(-10419201), (-10237048)⟩, ⟨(-128), 60663⟩, ⟨7423, 7584⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 345444255⟩, ⟨169705310, 172726311⟩, ⟨(-1508413), 2092⟩, ⟨(-251408), (-246172)⟩, ⟨(-2), 1308⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4337051790⟩, ⟨(-123712), 42497034⟩, ⟨10235847, 11040801⟩, ⟨(-62478), 212421⟩, ⟨15530, 21635⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 348829112⟩, ⟨169695359, 177836818⟩, ⟨(-1528170), 2599185⟩, ⟨130620, 214975⟩, ⟨(-8882), 11619⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-329874964), 0⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3965092332, 4294967296⟩, ⟨(-164937482), (-164937481)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 28331241⟩, ⟨0, 28887140⟩, ⟨6456479, 7785689⟩, ⟨(-126552), 250164⟩, ⟨7951, 21265⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4323298537⟩, ⟨0, 28887140⟩, ⟨6456479, 7785689⟩, ⟨(-126552), 250164⟩, ⟨7951, 21265⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309109633⟩, ⟨0, 14443570⟩, ⟨3193437, 3892845⟩, ⟨(-76368), 125082⟩, ⟨1784, 9703⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3965092332, 4309109633⟩, ⟨(-165480584), (-150493911)⟩, ⟨2393495, 3892845⟩, ⟨(-225863), 2447⟩, ⟨(-3158), 12636⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2471704414⟩, ⟨1235852199, 1235852207⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1422437539⟩, ⟨0, 1422437540⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1422437539⟩, ⟨0, 1422437540⟩, ⟨355609380, 355609385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1422437539), 0⟩, ⟨(-1422437540), 0⟩, ⟨(-355609385), (-355609380)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-711218770), 0⟩, ⟨(-711218770), 0⟩, ⟨(-177804693), (-177804690)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3639514947, 4294967296⟩, ⟨(-711218770), 0⟩, ⟨(-177804693), (-91783412)⟩, ⟨0, 29443306⟩, ⟨680937, 3680414⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3359982000, 4309109633⟩, ⟨(-879041234), (-127527126)⟩, ⟨(-176361938), (-53438628)⟩, ⟨2345560, 36393333⟩, ⟨(-670505), 3691423⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298445650, 4298445651⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2202
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309109633⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2203
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (150594761 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(15361 / 200000), prawitzNormalCorrection
