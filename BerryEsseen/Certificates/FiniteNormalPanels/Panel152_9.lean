...
namespace FiniteNormalPanel152_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (208789 / 800000)
def radius : Rat := (29827 / 800000)

def j0 : Jet := ⟨⟨1120927408, 1120927409⟩, ⟨160132486, 160132487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3521497310, 3521497314⟩, ⟨503071041, 503071045⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2887319611, 2887319619⟩, ⟨824948454, 824948464⟩, ⟨58924889, 58924891⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨722, 724⟩, ⟨206, 207⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93965), (-93962)⟩, ⟨206, 207⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-63169), (-63166)⟩, ⟨(-17911), (-17907)⟩, ⟨(-1242), (-1238)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5049887, 5049891⟩, ⟨(-17911), (-17907)⟩, ⟨(-1242), (-1238)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3394819, 3394822⟩, ⟨957907, 957912⟩, ⟨65006, 65012⟩, ⟨(-483), (-477)⟩, ⟨(-18), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-139770758), (-139770754)⟩, ⟨957907, 957912⟩, ⟨65006, 65012⟩, ⟨(-483), (-477)⟩, ⟨(-18), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-93961799), (-93961795)⟩, ⟨(-26202270), (-26202264)⟩, ⟨(-1689900), (-1689892)⟩, ⟨25302, 25311⟩, ⟨785, 793⟩⟩
...
def j19 : Jet := ⟨⟨1337693966, 1337693971⟩, ⟨(-26202270), (-26202264)⟩, ⟨(-1689900), (-1689892)⟩, ⟨25302, 25311⟩, ⟨785, 793⟩⟩
...
def j25 : Jet := ⟨⟨7907, 7910⟩, ⟨2244, 2247⟩, ⟨154, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844270), (-844266)⟩, ⟨2244, 2247⟩, ⟨154, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-567566), (-567563)⟩, ⟨(-160654), (-160649)⟩, ⟨(-11049), (-11043)⟩, ⟨57, 62⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35223828, 35223832⟩, ⟨(-160654), (-160649)⟩, ⟨(-11049), (-11043)⟩, ⟨57, 62⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23679446, 23679450⟩, ⟨6657555, 6657561⟩, ⟨444968, 444976⟩, ⟨(-4290), (-4283)⟩, ⟨(-142), (-136)⟩⟩
...
def j33 : Jet := ⟨⟨(-692148437), (-692148432)⟩, ⟨6657555, 6657561⟩, ⟨444968, 444976⟩, ⟨(-4290), (-4283)⟩, ⟨(-142), (-136)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-465301276), (-465301270)⟩, ⟨(-128467638), (-128467630)⟩, ⟨(-7918075), (-7918065)⟩, ⟨173920, 173929⟩, ⟨5184, 5192⟩⟩
...
def j36 : Jet := ⟨⟨3829666020, 3829666026⟩, ⟨(-128467638), (-128467630)⟩, ⟨(-7918075), (-7918065)⟩, ⟨173920, 173929⟩, ⟨5184, 5192⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1096791984, 1096791990⟩, ⟨135200999, 135201007⟩, ⟨(-4454653), (-4454643)⟩, ⟨(-177194), (-177184)⟩, ⟨3606, 3616⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4816802287, 4816802295⟩, ⟨161581497, 161581510⟩, ⟨15379341, 15379358⟩, ⟨631222, 631239⟩, ⟨39101, 39117⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1230051307, 1230051316⟩, ⟨192890356, 192890370⟩, ⟨4017895, 4017915⟩, ⟨279005, 279025⟩, ⟨11280, 11301⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1120927409), (-1120927408)⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3174039887, 3174039888⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨352278868, 352278874⟩, ⟨110485140, 110485152⟩, ⟨10964255, 10964271⟩, ⟨520702, 520718⟩, ⟨35278, 35297⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4647246164, 4647246170⟩, ⟨110485140, 110485152⟩, ⟨10964255, 10964271⟩, ⟨520702, 520718⟩, ⟨35278, 35297⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4467635872, 4467635876⟩, ⟨53107513, 53107520⟩, ⟨4954600, 4954610⟩, ⟨191391, 191402⟩, ⟨11934, 11945⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3301644338, 3301644343⟩, ⟨(-127323038), (-127323029)⟩, ⟨1681469, 1681478⟩, ⟨(-43287), (-43277)⟩, ⟨1682, 1693⟩⟩
...
def j47 : Jet := ⟨⟨8407339015, 8407339026⟩, ⟨1201048424, 1201048433⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16457249716, 16457249760⟩, ⟨4702071320, 4702071364⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16457249716, 16457249760⟩, ⟨4702071320, 4702071364⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16457249760), (-16457249716)⟩, ⟨(-4702071364), (-4702071320)⟩, ⟨(-335862241), (-335862235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8228624880), (-8228624858)⟩, ⟨(-2351035682), (-2351035660)⟩, ⟨(-167931121), (-167931117)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨632274216, 632274226⟩, ⟨(-346102581), (-346102572)⟩, ⟨70005474, 70005480⟩, ⟨(-3751880), (-3751877)⟩, ⟨(-855153), (-855151)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨486044349, 486044358⟩, ⟨(-284800936), (-284800926)⟩, ⟨64322526, 64322537⟩, ⟨(-5101326), (-5101316)⟩, ⟨(-515014), (-515004)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨960794921, 1281059896⟩, ⟨160132486, 160132487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3018426265, 4024568359⟩, ⟨503071041, 503071045⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2121296040, 3771192971⟩, ⟨707098674, 942798244⟩, ⟨58924889, 58924891⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨530, 945⟩, ⟨176, 237⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94157), (-93741)⟩, ⟨176, 237⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-82675), (-46298)⟩, ⟨(-20583), (-15223)⟩, ⟨(-1258), (-1219)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5030381, 5066759⟩, ⟨(-20583), (-15223)⟩, ⟨(-1258), (-1219)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2484518, 4448865⟩, ⟨810099, 1104699⟩, ⟨63390, 66406⟩, ⟨(-559), (-400)⟩, ⟨(-18), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140681059), (-138716711)⟩, ⟨810099, 1104699⟩, ⟨63390, 66406⟩, ⟨(-559), (-400)⟩, ⟨(-18), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-123524904), (-68512561)⟩, ⟨(-30481116), (-21867539)⟩, ⟨(-1765399), (-1602322)⟩, ⟨21059, 29536⟩, ⟨730, 841⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1308130861, 1363143205⟩, ⟨(-30481116), (-21867539)⟩, ⟨(-1765399), (-1602322)⟩, ⟨21059, 29536⟩, ⟨730, 841⟩⟩
...
def j72 : Jet := ⟨⟨5798, 10347⟩, ⟨1910, 2579⟩, ⟨153, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846379), (-841829)⟩, ⟨1910, 2579⟩, ⟨153, 160⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-743163), (-415781)⟩, ⟨(-184848), (-136328)⟩, ⟨(-11223), (-10841)⟩, ⟨49, 72⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35048231, 35375614⟩, ⟨(-184848), (-136328)⟩, ⟨(-11223), (-10841)⟩, ⟨49, 72⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨17310416, 31061533⟩, ⟨5607832, 7698052⟩, ⟨430412, 457539⟩, ⟨(-4977), (-3590)⟩, ⟨(-146), (-129)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-698517467), (-684766349)⟩, ⟨5607832, 7698052⟩, ⟨430412, 457539⟩, ⟨(-4977), (-3590)⟩, ⟨(-146), (-129)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-613332764), (-338207963)⟩, ⟨(-150563469), (-105976717)⟩, ⟨(-8447503), (-7303105)⟩, ⟨143425, 204277⟩, ⟨4683, 5624⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3681634532, 3956759333⟩, ⟨(-150563469), (-105976717)⟩, ⟨(-8447503), (-7303105)⟩, ⟨143425, 204277⟩, ⟨4683, 5624⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨919330992, 1277323583⟩, ⟨124659719, 144297333⟩, ⟨(-5224519), (-3687435)⟩, ⟨(-191983), (-160003)⟩, ⟨2979, 4249⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4662083923, 5010476710⟩, ⟨124867929, 204907563⟩, ⟨11949369, 19876393⟩, ⟨291841, 1101403⟩, ⟨12170, 79857⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨997911728, 1490116135⟩, ⟨162042916, 229275713⟩, ⟨87100, 8792866⟩, ⟨(-63929), 714459⟩, ⟨(-19032), 50801⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1281059896), (-960794921)⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3013907400, 3334172375⟩, ⟨(-160132487), (-160132486)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨231859231, 516987894⟩, ⟨75299536, 159091988⟩, ⟨6154119, 18340569⟩, ⟨(-37788), 1434526⟩, ⟨(-20033), 129534⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4526826527, 4811955190⟩, ⟨75299536, 159091988⟩, ⟨6154119, 18340569⟩, ⟨(-37788), 1434526⟩, ⟨(-20033), 129534⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4409373185, 4546118144⟩, ⟨35569801, 77482089⟩, ⟨2246781, 8788884⟩, ⟨(-172844), 680529⟩, ⟨(-30475), 65553⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3094189444, 3529140151⟩, ⟨(-144535937), (-104248814)⟩, ⟨(-1312190), 5496614⟩, ⟨(-461862), 444525⟩, ⟨(-49031), 57334⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7206290583, 9608387458⟩, ⟨1201048424, 1201048433⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12091040603, 21495183358⟩, ⟨4030346846, 5373795844⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12091040603, 21495183358⟩, ⟨4030346846, 5373795844⟩, ⟨335862235, 335862241⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21495183358), (-12091040603)⟩, ⟨(-5373795844), (-4030346846)⟩, ⟨(-335862241), (-335862235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10747591679), (-6045520301)⟩, ⟨(-2686897922), (-2015173423)⟩, ⟨(-167931121), (-167931117)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨351718283, 1051125571⟩, ⟨(-657575930), (-165024152)⟩, ⟨(-2384315), 191935165⟩, ⟨(-35722804), 17637802⟩, ⟨(-6510804), 5633590⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨253385631, 863701445⟩, ⟨(-575697758), (-127424067)⟩, ⟨1725207, 181185801⟩, ⟨(-36766808), 14882772⟩, ⟨(-6082130), 6161614⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1120927408, 1120927409⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4467635872, 4467635876⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3062
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨960794921, 1281059896⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4409373185, 4546118144⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3063
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (37933795 / 4294967296)

theorem envelope_integral : (∫ s in ((89481 / 400000) : ℝ)..(29827 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((89481 / 400000) : ℝ)..(29827 / 100000), prawitzNormalCorrection
