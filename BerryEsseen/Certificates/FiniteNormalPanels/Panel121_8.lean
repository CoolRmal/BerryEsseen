...
namespace FiniteNormalPanel121_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (195139 / 800000)
def radius : Rat := (27877 / 800000)

def j0 : Jet := ⟨⟨1047644528, 1047644529⟩, ⟨149663504, 149663505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3291272352, 3291272356⟩, ⟨470181764, 470181768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2522131822, 2522131829⟩, ⟨720609090, 720609100⟩, ⟨51472077, 51472079⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨631, 632⟩, ⟨180, 181⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94056), (-94054)⟩, ⟨180, 181⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-55233), (-55231)⟩, ⟨(-15676), (-15673)⟩, ⟨(-1091), (-1088)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5057823, 5057826⟩, ⟨(-15676), (-15673)⟩, ⟨(-1091), (-1088)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2970103, 2970106⟩, ⟨839394, 839399⟩, ⟨57342, 57348⟩, ⟨(-370), (-365)⟩, ⟨(-14), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140195474), (-140195470)⟩, ⟨839394, 839399⟩, ⟨57342, 57348⟩, ⟨(-370), (-365)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-82326929), (-82326926)⟩, ⟨(-23029064), (-23029058)⟩, ⟨(-1505637), (-1505629)⟩, ⟨19461, 19468⟩, ⟨615, 622⟩⟩
...
def j19 : Jet := ⟨⟨1349328836, 1349328840⟩, ⟨(-23029064), (-23029058)⟩, ⟨(-1505637), (-1505629)⟩, ⟨19461, 19468⟩, ⟨615, 622⟩⟩
...
def j22 : Jet := ⟨⟨(-64), (-62)⟩, ⟨(-19), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11771, 11774⟩, ⟨(-19), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6912, 6915⟩, ⟨1962, 1967⟩, ⟨135, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845265), (-845261)⟩, ⟨1962, 1967⟩, ⟨135, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-496365), (-496362)⟩, ⟨(-140667), (-140661)⟩, ⟨(-9722), (-9715)⟩, ⟨43, 48⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35295029, 35295033⟩, ⟨(-140667), (-140661)⟩, ⟨(-9722), (-9715)⟩, ⟨43, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20726284, 20726288⟩, ⟨5839191, 5839197⟩, ⟨393673, 393682⟩, ⟨(-3293), (-3285)⟩, ⟨(-111), (-105)⟩⟩
...
def j33 : Jet := ⟨⟨(-695101599), (-695101594)⟩, ⟨5839191, 5839197⟩, ⟨393673, 393682⟩, ⟨(-3293), (-3285)⟩, ⟨(-111), (-105)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-408184219), (-408184213)⟩, ⟨(-113195119), (-113195110)⟩, ⟨(-7119417), (-7119407)⟩, ⟨134094, 134102⟩, ⟨4098, 4106⟩⟩
...
def j36 : Jet := ⟨⟨3886783077, 3886783083⟩, ⟨(-113195119), (-113195110)⟩, ⟨(-7119417), (-7119407)⟩, ⟨134094, 134102⟩, ⟨4098, 4106⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1034002912, 1034002917⟩, ⟨130067320, 130067329⟩, ⟨(-3674839), (-3674830)⟩, ⟨(-149914), (-149906)⟩, ⟨2601, 2609⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4746018411, 4746018419⟩, ⟨138218692, 138218705⟩, ⟨12718618, 12718634⟩, ⟨459830, 459845⟩, ⟨26902, 26919⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1142592368, 1142592377⟩, ⟨177002610, 177002625⟩, ⟨3186977, 3186995⟩, ⟨211947, 211965⟩, ⟨7567, 7584⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1047644529), (-1047644528)⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3247322767, 3247322768⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨303964437, 303964443⟩, ⟨94176190, 94176202⟩, ⟨8990232, 8990244⟩, ⟨375448, 375464⟩, ⟨23858, 23873⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4598931733, 4598931739⟩, ⟨94176190, 94176202⟩, ⟨8990232, 8990244⟩, ⟨375448, 375464⟩, ⟨23858, 23873⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4444351627, 4444351631⟩, ⟨45505361, 45505368⟩, ⟨4111062, 4111069⟩, ⟨139321, 139330⟩, ⟨8198, 8208⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3360268711, 3360268716⟩, ⟨(-120463467), (-120463458)⟩, ⟨1522584, 1522591⟩, ⟨(-37919), (-37910)⟩, ⟨1342, 1352⟩⟩
...
def j47 : Jet := ⟨⟨11294952524, 11294952538⟩, ⟨1613564646, 1613564658⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨29703591139, 29703591214⟩, ⟨8486740324, 8486740398⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨29703591139, 29703591214⟩, ⟨8486740324, 8486740398⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-29703591214), (-29703591139)⟩, ⟨(-8486740398), (-8486740324)⟩, ⟨(-606195747), (-606195737)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-14851795607), (-14851795569)⟩, ⟨(-4243370199), (-4243370162)⟩, ⟨(-303097874), (-303097868)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨135266388, 135266392⟩, ⟨(-133641385), (-133641379)⟩, ⟨56472132, 56472138⟩, ⟨(-12310483), (-12310479)⟩, ⟨1048014, 1048016⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨105828841, 105828845⟩, ⟨(-108351378), (-108351372)⟩, ⟨47978570, 47978578⟩, ⟨(-11263877), (-11263867)⟩, ⟨1186457, 1186463⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨897981024, 1197308034⟩, ⟨149663504, 149663505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2821090587, 3761454124⟩, ⟨470181764, 470181768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1852994808, 3294213007⟩, ⟨617664934, 823553256⟩, ⟨51472077, 51472079⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨463, 826⟩, ⟨154, 207⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94224), (-93860)⟩, ⟨154, 207⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-72270), (-40494)⟩, ⟨(-18002), (-13339)⟩, ⟨(-1103), (-1074)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5040786, 5072563⟩, ⟨(-18002), (-13339)⟩, ⟨(-1103), (-1074)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2174766, 3890625⟩, ⟨711114, 966903⟩, ⟨56112, 58411⟩, ⟨(-428), (-308)⟩, ⟨(-14), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140990811), (-139274951)⟩, ⟨711114, 966903⟩, ⟨56112, 58411⟩, ⟨(-428), (-308)⟩, ⟨(-14), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-108139069), (-60087945)⟩, ⟨(-26727970), (-19287706)⟩, ⟨(-1563199), (-1438905)⟩, ⟨16262, 22657⟩, ⟨578, 654⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1323516696, 1371567821⟩, ⟨(-26727970), (-19287706)⟩, ⟨(-1563199), (-1438905)⟩, ⟨16262, 22657⟩, ⟨578, 654⟩⟩
...
def j70 : Jet := ⟨⟨(-83), (-46)⟩, ⟨(-21), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11752, 11790⟩, ⟨(-21), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5070, 9043⟩, ⟨1673, 2255⟩, ⟨133, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847107), (-843133)⟩, ⟨1673, 2255⟩, ⟨133, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-649726), (-363756)⟩, ⟨(-161711), (-119522)⟩, ⟨(-9855), (-9563)⟩, ⟨37, 55⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35141668, 35427639⟩, ⟨(-161711), (-119522)⟩, ⟨(-9855), (-9563)⟩, ⟨37, 55⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15161309, 27172778⟩, ⟨4929737, 6741630⟩, ⟨382580, 403262⟩, ⟨(-3813), (-2764)⟩, ⟨(-115), (-101)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700666574), (-688655104)⟩, ⟨4929737, 6741630⟩, ⟨382580, 403262⟩, ⟨(-3813), (-2764)⟩, ⟨(-115), (-101)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-537406873), (-297109208)⟩, ⟨(-132224863), (-93865614)⟩, ⟨(-7522973), (-6651036)⟩, ⟨111173, 156927⟩, ⟨3763, 4393⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3757560423, 3997858088⟩, ⟨(-132224863), (-93865614)⟩, ⟨(-7522973), (-6651036)⟩, ⟨111173, 156927⟩, ⟨3763, 4393⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨869333858, 1201194115⟩, ⟨121481106, 137480400⟩, ⟨(-4295006), (-3056602)⟩, ⟨(-160447), (-137677)⟩, ⟨2159, 3054⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4614156797, 4909234184⟩, ⟨108335675, 172751133⟩, ⟨10219950, 15907671⟩, ⟨227483, 769124⟩, ⟨10166, 51090⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨933940226, 1372989084⟩, ⟨152437188, 205457008⟩, ⟨223539, 6694920⟩, ⟨(-21038), 499297⟩, ⟨(-11552), 31655⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1197308034), (-897981024)⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3097659262, 3396986272⟩, ⟨(-149663505), (-149663504)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨203085212, 438908820⟩, ⟨66294902, 131358500⟩, ⟨5507524, 14108767⟩, ⟨2414, 959752⟩, ⟨(-9389), 78446⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4498052508, 4733876116⟩, ⟨66294902, 131358500⟩, ⟨5507524, 14108767⟩, ⟨2414, 959752⟩, ⟨(-9389), 78446⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4395337122, 4509084509⟩, ⟨31573419, 64179430⟩, ⟨2166252, 6779892⟩, ⟨(-97820), 453358⟩, ⟨(-16437), 39223⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3170048991, 3566336394⟩, ⟨(-134352991), (-102400060)⟩, ⟨(-674048), 4262155⟩, ⟨(-313623), 283087⟩, ⟨(-28799), 34432⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9681387878, 12908517195⟩, ⟨1613564646, 1613564658⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨21823046553, 38796527352⟩, ⟨7274348848, 9699131890⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨21823046553, 38796527352⟩, ⟨7274348848, 9699131890⟩, ⟨606195737, 606195747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-38796527352), (-21823046553)⟩, ⟨(-9699131890), (-7274348848)⟩, ⟨(-606195747), (-606195737)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-19398263676), (-10911523276)⟩, ⟨(-4849565945), (-3637174424)⟩, ⟨(-303097874), (-303097868)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨46931494, 338546768⟩, ⟨(-382262487), (-39743732)⟩, ⟨(-7063003), 212499578⟩, ⟨(-78109888), 20642641⟩, ⟨(-13325142), 22298227⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨34639410, 281113121⟩, ⟨(-328002822), (-30453168)⟩, ⟨(-4970350), 188743238⟩, ⟨(-71910103), 17443916⟩, ⟨(-11771114), 21200287⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1047644528, 1047644529⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4444351627, 4444351631⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2432
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨897981024, 1197308034⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4395337122, 4509084509⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2433
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (1098195 / 536870912)

theorem envelope_integral : (∫ s in ((83631 / 400000) : ℝ)..(27877 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((83631 / 400000) : ℝ)..(27877 / 100000), prawitzNormalCorrection
