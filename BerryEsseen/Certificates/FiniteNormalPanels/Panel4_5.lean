...
namespace FiniteNormalPanel4_5

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8397 / 32000)
def radius : Rat := (8397 / 160000)

def j0 : Jet := ⟨⟨1127026262, 1127026263⟩, ⟨225405252, 225405253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3540657424, 3540657429⟩, ⟨708131483, 708131487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2918824319, 2918824328⟩, ⟨1167529724, 1167529734⟩, ⟨116752972, 116752974⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨730, 732⟩, ⟨292, 293⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93957), (-93954)⟩, ⟨292, 293⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-63853), (-63850)⟩, ⟨(-25343), (-25340)⟩, ⟨(-2457), (-2453)⟩, ⟨14, 17⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5049203, 5049207⟩, ⟨(-25343), (-25340)⟩, ⟨(-2457), (-2453)⟩, ⟨14, 17⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3431396, 3431400⟩, ⟨1355335, 1355340⟩, ⟨128695, 128701⟩, ⟨(-1348), (-1342)⟩, ⟨(-64), (-60)⟩⟩
...
def j16 : Jet := ⟨⟨(-139734181), (-139734176)⟩, ⟨1355335, 1355340⟩, ⟨128695, 128701⟩, ⟨(-1348), (-1342)⟩, ⟨(-64), (-60)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-94962197), (-94962192)⟩, ⟨(-37063805), (-37063798)⟩, ⟨(-3342599), (-3342590)⟩, ⟨70909, 70918⟩, ⟨3087, 3095⟩⟩
...
def j19 : Jet := ⟨⟨1336693568, 1336693574⟩, ⟨(-37063805), (-37063798)⟩, ⟨(-3342599), (-3342590)⟩, ⟨70909, 70918⟩, ⟨3087, 3095⟩⟩
...
def j22 : Jet := ⟨⟨(-74), (-72)⟩, ⟨(-30), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11761, 11764⟩, ⟨(-30), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7992, 7995⟩, ⟨3176, 3179⟩, ⟨307, 312⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844185), (-844181)⟩, ⟨3176, 3179⟩, ⟨307, 312⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-573702), (-573698)⟩, ⟨(-227323), (-227318)⟩, ⟨(-21878), (-21869)⟩, ⟨167, 172⟩, ⟨6, 9⟩⟩
...
def j30 : Jet := ⟨⟨35217692, 35217697⟩, ⟨(-227323), (-227318)⟩, ⟨(-21878), (-21869)⟩, ⟨167, 172⟩, ⟨6, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23933652, 23933657⟩, ⟨9418974, 9418980⟩, ⟨880682, 880693⟩, ⟨(-12015), (-12006)⟩, ⟨(-546), (-540)⟩⟩
...
def j33 : Jet := ⟨⟨(-691894231), (-691894225)⟩, ⟨9418974, 9418980⟩, ⟨880682, 880693⟩, ⟨(-12015), (-12006)⟩, ⟨(-546), (-540)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-470205610), (-470205603)⟩, ⟨(-181681189), (-181681178)⟩, ⟨(-15649299), (-15649287)⟩, ⟨487277, 487289⟩, ⟨20301, 20312⟩⟩
...
def j36 : Jet := ⟨⟨3824761686, 3824761693⟩, ⟨(-181681189), (-181681178)⟩, ⟨(-15649299), (-15649287)⟩, ⟨487277, 487289⟩, ⟨20301, 20312⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1101934817, 1101934825⟩, ⟨189832542, 189832552⟩, ⟨(-8866436), (-8866424)⟩, ⟨(-492656), (-492645)⟩, ⟨14235, 14245⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4822978672, 4822978682⟩, ⟨229097788, 229097805⟩, ⟨30616006, 30616026⟩, ⟨1777204, 1777224⟩, ⟨154883, 154905⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1237403629, 1237403641⟩, ⟨271948317, 271948335⟩, ⟨8024372, 8024397⟩, ⟨782990, 783014⟩, ⟨44789, 44813⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1127026263), (-1127026262)⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3167941033, 3167941034⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨356502770, 356502778⟩, ⟨156699602, 156699616⟩, ⟨21842926, 21842946⟩, ⟨1467338, 1467360⟩, ⟨139952, 139973⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4651470066, 4651470074⟩, ⟨156699602, 156699616⟩, ⟨21842926, 21842946⟩, ⟨1467338, 1467360⟩, ⟨139952, 139973⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4469665738, 4469665743⟩, ⟨75287471, 75287479⟩, ⟨9860518, 9860529⟩, ⟨538901, 538913⟩, ⟨47286, 47298⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3296797511, 3296797517⟩, ⟨(-179042078), (-179042070)⟩, ⟨3321874, 3321885⟩, ⟨(-120003), (-119993)⟩, ⟨6594, 6605⟩⟩
...
def j47 : Jet := ⟨⟨4615073294, 4615073300⟩, ⟨923014657, 923014662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4959036947, 4959036961⟩, ⟨1983614774, 1983614790⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4959036947, 4959036961⟩, ⟨1983614774, 1983614790⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4959036961), (-4959036947)⟩, ⟨(-1983614790), (-1983614774)⟩, ⟨(-198361480), (-198361477)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2479518481), (-2479518473)⟩, ⟨(-991807395), (-991807387)⟩, ⟨(-99180740), (-99180738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2411227742, 2411227758⟩, ⟨(-556808320), (-556808311)⟩, ⟨8609132, 8609137⟩, ⟨7909311, 7909314⟩, ⟨(-556014), (-556013)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1850847531, 1850847548⟩, ⟨(-527919159), (-527919144)⟩, ⟨31684633, 31684648⟩, ⟨5214239, 5214252⟩, ⟨(-730591), (-730578)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨901621009, 1352431515⟩, ⟨225405252, 225405253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2832525938, 4248788913⟩, ⟨708131483, 708131487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1868047562, 4203107029⟩, ⟨934023778, 1401035680⟩, ⟨116752972, 116752974⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨467, 1053⟩, ⟨233, 351⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94220), (-93633)⟩, ⟨233, 351⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-92205), (-40724)⟩, ⟨(-30634), (-20018)⟩, ⟨(-2500), (-2400)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5020851, 5072333⟩, ⟨(-30634), (-20018)⟩, ⟨(-2500), (-2400)⟩, ⟨12, 20⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2183762, 4963847⟩, ⟨1061902, 1645910⟩, ⟨124045, 132489⟩, ⟨(-1644), (-1045)⟩, ⟨(-66), (-57)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140981815), (-138201729)⟩, ⟨1061902, 1645910⟩, ⟨124045, 132489⟩, ⟨(-1644), (-1045)⟩, ⟨(-66), (-57)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-137966513), (-60109282)⟩, ⟨(-45526976), (-28443933)⟩, ⟨(-3547522), (-3090271)⟩, ⟨54232, 87507⟩, ⟨2769, 3351⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1293689252, 1371546484⟩, ⟨(-45526976), (-28443933)⟩, ⟨(-3547522), (-3090271)⟩, ⟨54232, 87507⟩, ⟨2769, 3351⟩⟩
...
def j70 : Jet := ⟨⟨(-106), (-46)⟩, ⟨(-36), (-23)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11729, 11790⟩, ⟨(-36), (-23)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5101, 11538⟩, ⟨2514, 3836⟩, ⟨303, 316⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847076), (-840638)⟩, ⟨2514, 3836⟩, ⟨303, 316⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-828959), (-365626)⟩, ⟨(-275227), (-179059)⟩, ⟨(-22350), (-21289)⟩, ⟨131, 209⟩, ⟨6, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34962435, 35425769⟩, ⟨(-275227), (-179059)⟩, ⟨(-22350), (-21289)⟩, ⟨131, 209⟩, ⟨6, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15206516, 34668087⟩, ⟨7333917, 11478150⟩, ⟨838754, 914805⟩, ⟨(-14717), (-9291)⟩, ⟨(-578), (-500)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700621367), (-681159795)⟩, ⟨7333917, 11478150⟩, ⟨838754, 914805⟩, ⟨(-14717), (-9291)⟩, ⟨(-578), (-500)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-685636558), (-296262766)⟩, ⟨(-225355716), (-136898725)⟩, ⟨(-17085753), (-13876963)⟩, ⟨367362, 606392⟩, ⟨17433, 22631⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3609330738, 3998704530⟩, ⟨(-225355716), (-136898725)⟩, ⟨(-17085753), (-13876963)⟩, ⟨367362, 606392⟩, ⟨17433, 22631⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨853186557, 1356799970⟩, ⟨168259156, 207374589⟩, ⟨(-11015627), (-6727715)⟩, ⟨(-549132), (-422940)⟩, ⟨10767, 17743⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4613180077, 5110848912⟩, ⟨157935767, 319105980⟩, ⟨21416468, 44117615⟩, ⟨506257, 3795614⟩, ⟨14335, 407476⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨916398881, 1614540734⟩, ⟨212099044, 347574982⟩, ⟨(-2666570), 22118234⟩, ⟨(-532308), 2627522⟩, ⟨(-119708), 284004⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1352431515), (-901621009)⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2942535781, 3393346287⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨195528126, 606929367⟩, ⟨90509338, 261316992⟩, ⟨8469314, 44757025⟩, ⟨(-831798), 5555334⟩, ⟨(-189889), 752701⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4490495422, 4901896663⟩, ⟨90509338, 261316992⟩, ⟨8469314, 44757025⟩, ⟨(-831798), 5555334⟩, ⟨(-189889), 752701⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4391643312, 4588407770⟩, ⟨42360516, 127782229⟩, ⟨2184540, 21681582⟩, ⟨(-1037607), 2695450⟩, ⟨(-224806), 397714⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3008769727, 3625186270⟩, ⟨(-211783657), (-129521385)⟩, ⟨(-5209517), 14906944⟩, ⟨(-1957665), 2014961⟩, ⟨(-319075), 368679⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3692058632, 5538087958⟩, ⟨923014657, 923014662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3173783640, 7141013218⟩, ⟨1586891818, 2380337746⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3173783640, 7141013218⟩, ⟨1586891818, 2380337746⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7141013218), (-3173783640)⟩, ⟨(-2380337746), (-1586891818)⟩, ⟨(-198361480), (-198361477)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3570506609), (-1586891820)⟩, ⟨(-1190168873), (-793445909)⟩, ⟨(-99180740), (-99180738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1870340665, 2968233214⟩, ⟨(-822520531), (-345523969)⟩, ⟨(-36627585), 70772926⟩, ⟨(-1217945), 16045866⟩, ⟨(-1928765), 507284⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1310236838, 2505350461⟩, ⟨(-840614882), (-298454232)⟩, ⟨(-24096143), 110596591⟩, ⟨(-8725539), 17739878⟩, ⟨(-3152722), 1363574⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1127026262, 1127026263⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4469665738, 4469665743⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified70
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨901621009, 1352431515⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4391643312, 4588407770⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified71
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (97703389 / 2147483648)

theorem envelope_integral : (∫ s in ((8397 / 40000) : ℝ)..(25191 / 80000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((8397 / 40000) : ℝ)..(25191 / 80000), prawitzNormalCorrection
