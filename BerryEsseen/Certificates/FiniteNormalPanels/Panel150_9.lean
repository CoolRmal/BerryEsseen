...
namespace FiniteNormalPanel150_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (24143 / 100000)
def radius : Rat := (3449 / 100000)

def j0 : Jet := ⟨⟨1036933954, 1036933955⟩, ⟨148133422, 148133423⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3257624092, 3257624096⟩, ⟨465374870, 465374874⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2470825501, 2470825508⟩, ⟨705950142, 705950150⟩, ⟨50425010, 50425012⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨618, 620⟩, ⟨176, 177⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94069), (-94066)⟩, ⟨176, 177⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-54117), (-54114)⟩, ⟨(-15361), (-15359)⟩, ⟨(-1071), (-1066)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5058939, 5058943⟩, ⟨(-15361), (-15359)⟩, ⟨(-1071), (-1066)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2910326, 2910329⟩, ⟨822684, 822688⟩, ⟨56252, 56258⟩, ⟨(-357), (-351)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140255251), (-140255247)⟩, ⟨822684, 822688⟩, ⟨56252, 56258⟩, ⟨(-357), (-351)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-80686587), (-80686584)⟩, ⟨(-22580035), (-22580029)⟩, ⟨(-1479085), (-1479076)⟩, ⟨18697, 18705⟩, ⟨593, 599⟩⟩
...
def j19 : Jet := ⟨⟨1350969178, 1350969182⟩, ⟨(-22580035), (-22580029)⟩, ⟨(-1479085), (-1479076)⟩, ⟨18697, 18705⟩, ⟨593, 599⟩⟩
...
def j22 : Jet := ⟨⟨(-63), (-61)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11772, 11775⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6772, 6774⟩, ⟨1923, 1927⟩, ⟨133, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845405), (-845402)⟩, ⟨1923, 1927⟩, ⟨133, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-486348), (-486346)⟩, ⟨(-137851), (-137847)⟩, ⟨(-9534), (-9529)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35305046, 35305049⟩, ⟨(-137851), (-137847)⟩, ⟨(-9534), (-9529)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20310424, 20310427⟩, ⟨5723674, 5723678⟩, ⟨386354, 386361⟩, ⟨(-3164), (-3157)⟩, ⟨(-107), (-101)⟩⟩
...
def j33 : Jet := ⟨⟨(-695517459), (-695517455)⟩, ⟨5723674, 5723678⟩, ⟨386354, 386361⟩, ⟨(-3164), (-3157)⟩, ⟨(-107), (-101)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-400119992), (-400119988)⟩, ⟨(-111027262), (-111027256)⟩, ⟨(-7002670), (-7002663)⟩, ⟨128880, 128888⟩, ⟨3952, 3961⟩⟩
...
def j36 : Jet := ⟨⟨3894847304, 3894847308⟩, ⟨(-111027262), (-111027256)⟩, ⟨(-7002670), (-7002663)⟩, ⟨128880, 128888⟩, ⟨3952, 3961⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1024675961, 1024675966⟩, ⟨129255894, 129255901⟩, ⟨(-3568476), (-3568466)⟩, ⟨(-146084), (-146075)⟩, ⟨2474, 2482⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4736191849, 4736191854⟩, ⟨135010782, 135010792⟩, ⟨12363983, 12363996⟩, ⟨438458, 438474⟩, ⟨25442, 25458⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1129941533, 1129941541⟩, ⟨174744756, 174744767⟩, ⟨3077794, 3077811⟩, ⟨203429, 203448⟩, ⟨7126, 7144⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1036933955), (-1036933954)⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3258033341, 3258033342⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨297270684, 297270689⟩, ⟨91945452, 91945460⟩, ⟨8729095, 8729107⟩, ⟨357482, 357498⟩, ⟨22505, 22522⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4592237980, 4592237985⟩, ⟨91945452, 91945460⟩, ⟨8729095, 8729107⟩, ⟨357482, 357498⟩, ⟨22505, 22522⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4441116069, 4441116072⟩, ⟨44459850, 44459854⟩, ⟨3998375, 3998382⟩, ⟨132831, 132840⟩, ⟨7751, 7761⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3368897415, 3368897420⟩, ⟨(-119448187), (-119448181)⟩, ⟨1499626, 1499633⟩, ⟨(-37144), (-37134)⟩, ⟨1297, 1307⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨37873723419, 37873723426⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value618

def j47 : Jet := ⟨⟨9143853042, 9143853054⟩, ⟨1306264720, 1306264730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨19466981397, 19466981449⟩, ⟨5561994682, 5561994734⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨19466981397, 19466981449⟩, ⟨5561994682, 5561994734⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-19466981449), (-19466981397)⟩, ⟨(-5561994734), (-5561994682)⟩, ⟨(-397285341), (-397285334)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9733490725), (-9733490698)⟩, ⟨(-2780997367), (-2780997341)⟩, ⟨(-198642671), (-198642667)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨445387327, 445387339⟩, ⟨(-288388929), (-288388918)⟩, ⟨72766904, 72766911⟩, ⟨(-6813549), (-6813545)⟩, ⟨(-579794), (-579792)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨349354048, 349354059⟩, ⟨(-238594001), (-238593989)⟩, ⟨65253039, 65253050⟩, ⟨(-7472711), (-7472702)⟩, ⟨(-237255), (-237246)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨888800532, 1185067377⟩, ⟨148133422, 148133423⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2792249221, 3722998966⟩, ⟨465374870, 465374874⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1815300367, 3227200662⟩, ⟨605100122, 806800172⟩, ⟨50425010, 50425012⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨454, 809⟩, ⟨151, 203⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94233), (-93877)⟩, ⟨151, 203⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-70806), (-39677)⟩, ⟨(-17639), (-13072)⟩, ⟨(-1081), (-1053)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5042250, 5073380⟩, ⟨(-17639), (-13072)⟩, ⟨(-1081), (-1053)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2131145, 3812094⟩, ⟨697127, 947500⟩, ⟨55071, 57278⟩, ⟨(-412), (-296)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141034432), (-139353482)⟩, ⟨697127, 947500⟩, ⟨55071, 57278⟩, ⟨(-412), (-296)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-105972033), (-58898801)⟩, ⟨(-26198364), (-18920989)⟩, ⟨(-1534323), (-1415052)⟩, ⟨15632, 21760⟩, ⟨558, 629⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1325683732, 1372756965⟩, ⟨(-26198364), (-18920989)⟩, ⟨(-1534323), (-1415052)⟩, ⟨15632, 21760⟩, ⟨558, 629⟩⟩
...
def j70 : Jet := ⟨⟨(-82), (-45)⟩, ⟨(-21), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11753, 11791⟩, ⟨(-21), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4967, 8860⟩, ⟨1639, 2209⟩, ⟨131, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847210), (-843316)⟩, ⟨1639, 2209⟩, ⟨131, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-636587), (-356433)⟩, ⟨(-158455), (-117151)⟩, ⟨(-9662), (-9382)⟩, ⟨35, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35154807, 35434962⟩, ⟨(-158455), (-117151)⟩, ⟨(-9662), (-9382)⟩, ⟨35, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14858444, 26625519⟩, ⟨4833752, 6606866⟩, ⟨375708, 395555⟩, ⟨(-3662), (-2656)⟩, ⟨(-111), (-98)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700969439), (-689202363)⟩, ⟨4833752, 6606866⟩, ⟨375708, 395555⟩, ⟨(-3662), (-2656)⟩, ⟨(-111), (-98)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-526702274), (-291296584)⟩, ⟨(-129632549), (-92134519)⟩, ⟨(-7389922), (-6553268)⟩, ⟨106929, 150751⟩, ⟨3638, 4230⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3768265022, 4003670712⟩, ⟨(-129632549), (-92134519)⟩, ⟨(-7389922), (-6553268)⟩, ⟨106929, 150751⟩, ⟨3638, 4230⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨861855076, 1189944512⟩, ⟨120933030, 136442130⟩, ⟨(-4168681), (-2970110)⟩, ⟨(-156088), (-134462)⟩, ⟨2055, 2904⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4607457855, 4895288407⟩, ⟨106029177, 168403420⟩, ⟨9981552, 15393389⟩, ⟨218926, 729064⟩, ⟨9860, 47814⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨924561391, 1356266806⟩, ⟨151008279, 202170179⟩, ⟨237063, 6428442⟩, ⟨(-16377), 473441⟩, ⟨(-10716), 29498⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1185067377), (-888800532)⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3109899919, 3406166764⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨199026839, 428282575⟩, ⟨65013962, 127682790⟩, ⟨5411415, 13576390⟩, ⟨6324, 904200⟩, ⟨(-8297), 72824⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4493994135, 4723249871⟩, ⟨65013962, 127682790⟩, ⟨5411415, 13576390⟩, ⟨6324, 904200⟩, ⟨(-8297), 72824⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4393353825, 4504020840⟩, ⟨30998173, 62411706⟩, ⟨2147706, 6526822⟩, ⟨(-89629), 426823⟩, ⟨(-14969), 36346⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3181139636, 3571958768⟩, ⟨(-132898523), (-102030545)⟩, ⟨(-597470), 4107036⟩, ⟨(-296193), 264423⟩, ⟨(-26594), 31917⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7837588322, 10450117774⟩, ⟨1306264720, 1306264730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14302272048, 25426261475⟩, ⟨4767424014, 6356565410⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14302272048, 25426261475⟩, ⟨4767424014, 6356565410⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-25426261475), (-14302272048)⟩, ⟨(-6356565410), (-4767424014)⟩, ⟨(-397285341), (-397285334)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12713130738), (-7151136024)⟩, ⟨(-3178282705), (-2383712007)⟩, ⟨(-198642671), (-198642667)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨222559124, 812564764⟩, ⟨(-601299232), (-123520581)⟩, ⟨(-3304168), 212187818⟩, ⟨(-48531217), 19355131⟩, ⟨(-8487562), 9054704⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨164842151, 675778798⟩, ⟨(-525220466), (-96774670)⟩, ⟨73348, 195851354⟩, ⟨(-47558265), 16332832⟩, ⟨(-7729252), 9282555⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1036933954, 1036933955⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4441116069, 4441116072⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar618 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3026
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar618 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨888800532, 1185067377⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4393353825, 4504020840⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3027
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((10347 / 50000) : ℝ)..(3449 / 12500), prawitzNormalCorrection
      ((56921 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
