...
namespace FiniteNormalPanel85_4

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (106827 / 400000)
def radius : Rat := (15261 / 400000)

def j0 : Jet := ⟨⟨1147046178, 1147046179⟩, ⟨163863739, 163863740⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3603551845, 3603551850⟩, ⟨514793118, 514793122⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3023442323, 3023442332⟩, ⟨863840658, 863840668⟩, ⟨61702903, 61702905⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨756, 758⟩, ⟨216, 217⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93931), (-93928)⟩, ⟨216, 217⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-66123), (-66120)⟩, ⟨(-18741), (-18738)⟩, ⟨(-1297), (-1293)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5046933, 5046937⟩, ⟨(-18741), (-18738)⟩, ⟨(-1297), (-1293)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3552788, 3552792⟩, ⟨1001889, 1001894⟩, ⟨67821, 67828⟩, ⟨(-527), (-523)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-139612789), (-139612784)⟩, ⟨1001889, 1001894⟩, ⟨67821, 67828⟩, ⟨(-527), (-523)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-98280427), (-98280422)⟩, ⟨(-27374843), (-27374836)⟩, ⟨(-1756473), (-1756464)⟩, ⟨27662, 27669⟩, ⟨855, 860⟩⟩
...
def j19 : Jet := ⟨⟨1333375338, 1333375344⟩, ⟨(-27374843), (-27374836)⟩, ⟨(-1756473), (-1756464)⟩, ⟨27662, 27669⟩, ⟨855, 860⟩⟩
...
def j22 : Jet := ⟨⟨(-77), (-75)⟩, ⟨(-22), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11758, 11761⟩, ⟨(-22), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8277, 8280⟩, ⟨2348, 2352⟩, ⟨161, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843900), (-843896)⟩, ⟨2348, 2352⟩, ⟨161, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-594064), (-594060)⟩, ⟨(-168081), (-168075)⟩, ⟨(-11539), (-11532)⟩, ⟨63, 68⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35197330, 35197335⟩, ⟨(-168081), (-168075)⟩, ⟨(-11539), (-11532)⟩, ⟨63, 68⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨24777161, 24777165⟩, ⟨6960867, 6960874⟩, ⟨463727, 463736⟩, ⟨(-4692), (-4685)⟩, ⟨(-154), (-148)⟩⟩
...
def j33 : Jet := ⟨⟨(-691050722), (-691050717)⟩, ⟨6960867, 6960874⟩, ⟨463727, 463736⟩, ⟨(-4692), (-4685)⟩, ⟨(-154), (-148)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-486465173), (-486465167)⟩, ⟨(-134089948), (-134089938)⟩, ⟨(-8201392), (-8201382)⟩, ⟨189967, 189976⟩, ⟨5609, 5617⟩⟩
...
def j36 : Jet := ⟨⟨3808502123, 3808502129⟩, ⟨(-134089948), (-134089938)⟩, ⟨(-8201392), (-8201382)⟩, ⟨189967, 189976⟩, ⟨5609, 5617⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1118724969, 1118724977⟩, ⟨136849885, 136849894⟩, ⟨(-4754851), (-4754840)⟩, ⟨(-187323), (-187314)⟩, ⟨4032, 4039⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4843569321, 4843569330⟩, ⟨170532636, 170532652⟩, ⟨16434457, 16434474⟩, ⟨704247, 704265⟩, ⟨44532, 44550⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1261621233, 1261621246⟩, ⟨198749131, 198749148⟩, ⟨4352199, 4352220⟩, ⟨307041, 307063⟩, ⟨12952, 12969⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1147046179), (-1147046178)⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3147921117, 3147921118⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨370593773, 370593781⟩, ⟨116762762, 116762774⟩, ⟨11753957, 11753974⟩, ⟨583176, 583194⟩, ⟨40434, 40451⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4665561069, 4665561077⟩, ⟨116762762, 116762774⟩, ⟨11753957, 11753974⟩, ⟨583176, 583194⟩, ⟨40434, 40451⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4476430744, 4476430749⟩, ⟨56014743, 56014750⟩, ⟨5288276, 5288286⟩, ⟨213593, 213604⟩, ⟨13600, 13610⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3280921575, 3280921581⟩, ⟨(-129732000), (-129731992)⟩, ⟨1738846, 1738855⟩, ⟨(-45213), (-45202)⟩, ⟨1817, 1827⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨38548018674, 38548018677⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value405

def j47 : Jet := ⟨⟨10294922974, 10294922985⟩, ⟨1470703275, 1470703285⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨24676657989, 24676658043⟩, ⟨7050473676, 7050473734⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨24676657989, 24676658043⟩, ⟨7050473676, 7050473734⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-24676658043), (-24676657989)⟩, ⟨(-7050473734), (-7050473676)⟩, ⟨(-503605268), (-503605260)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-12338329022), (-12338328994)⟩, ⟨(-3525236867), (-3525236838)⟩, ⟨(-251802634), (-251802630)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨242853436, 242853444⟩, ⟨(-199330020), (-199330011)⟩, ⟨67565499, 67565506⟩, ⟨(-10694748), (-10694744)⟩, ⟨213922, 213924⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨185515516, 185515524⟩, ⟨(-159603551), (-159603541)⟩, ⟨57732421, 57732431⟩, ⟨(-10293823), (-10293815)⟩, ⟨516007, 516017⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨983182438, 1310909919⟩, ⟨163863739, 163863740⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3088758724, 4118344972⟩, ⟨514793118, 514793122⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2221304563, 3948985904⟩, ⟨740434850, 987246478⟩, ⟨61702903, 61702905⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨555, 990⟩, ⟨185, 248⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94132), (-93696)⟩, ⟨185, 248⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-86550), (-48458)⟩, ⟨(-21543), (-15923)⟩, ⟨(-1315), (-1273)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5026506, 5064599⟩, ⟨(-21543), (-15923)⟩, ⟨(-1315), (-1273)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2599647, 4656620⟩, ⟨846741, 1155920⟩, ⟨66050, 69357⟩, ⟨(-611), (-439)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140565930), (-138508956)⟩, ⟨846741, 1155920⟩, ⟨66050, 69357⟩, ⟨(-611), (-439)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-129242632), (-71635138)⟩, ⟨(-31872734), (-22815574)⟩, ⟨(-1839283), (-1660392)⟩, ⟨22988, 32323⟩, ⟨789, 915⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1302413133, 1360020628⟩, ⟨(-31872734), (-22815574)⟩, ⟨(-1839283), (-1660392)⟩, ⟨22988, 32323⟩, ⟨789, 915⟩⟩
...
def j70 : Jet := ⟨⟨(-100), (-55)⟩, ⟨(-25), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11735, 11781⟩, ⟨(-25), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6069, 10832⟩, ⟨2000, 2699⟩, ⟨160, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846108), (-841344)⟩, ⟨2000, 2699⟩, ⟨160, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-777950), (-435132)⟩, ⟨(-193454), (-142562)⟩, ⟨(-11730), (-11312)⟩, ⟨53, 78⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35013444, 35356263⟩, ⟨(-193454), (-142562)⟩, ⟨(-11730), (-11312)⟩, ⟨53, 78⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18108525, 32508137⟩, ⟨5858303, 8053304⟩, ⟨447760, 477513⟩, ⟨(-5450), (-3926)⟩, ⟨(-160), (-141)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697719358), (-683319745)⟩, ⟨5858303, 8053304⟩, ⟨447760, 477513⟩, ⟨(-5450), (-3926)⟩, ⟨(-160), (-141)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-641514527), (-353404615)⟩, ⟨(-157348790), (-110396967)⟩, ⟨(-8782143), (-7526604)⟩, ⟨156342, 223429⟩, ⟨5031, 6113⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3653452769, 3941562681⟩, ⟨(-157348790), (-110396967)⟩, ⟨(-8782143), (-7526604)⟩, ⟨156342, 223429⟩, ⟨5031, 6113⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨936640409, 1304092379⟩, ⟨125544705, 146603553⟩, ⟨(-5583901), (-3928748)⟩, ⟨(-203925), (-168019)⟩, ⟨3322, 4753⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4680058536, 5049126194⟩, ⟨131081073, 217458374⟩, ⟨12608171, 21502663⟩, ⟨317226, 1248542⟩, ⟨12800, 93409⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1020620563, 1533079658⟩, ⟨165387148, 238373329⟩, ⟨16771, 9670589⟩, ⟨(-84727), 810080⟩, ⟨(-22599), 59909⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1310909919), (-983182438)⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2984057377, 3311784858⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨242531842, 547229601⟩, ⟨78602472, 170173730⟩, ⟨6376565, 20133661⟩, ⟨(-59198), 1651762⟩, ⟨(-25540), 154465⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4537499138, 4842196897⟩, ⟨78602472, 170173730⟩, ⟨6376565, 20133661⟩, ⟨(-59198), 1651762⟩, ⟨(-25540), 154465⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4414567974, 4560381269⟩, ⟨37013905, 82781669⟩, ⟨2251383, 9638927⟩, ⟨(-209546), 784630⟩, ⟨(-37662), 78496⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3067153536, 3516441592⟩, ⟨(-148273427), (-104595099)⟩, ⟨(-1594113), 6020260⟩, ⟨(-529328), 519122⟩, ⟨(-58977), 68523⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8824219689, 11765626269⟩, ⟨1470703275, 1470703285⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨18129789531, 32230737038⟩, ⟨6043263150, 8057684268⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨18129789531, 32230737038⟩, ⟨6043263150, 8057684268⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-32230737038), (-18129789531)⟩, ⟨(-8057684268), (-6043263150)⟩, ⟨(-503605268), (-503605260)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-16115368519), (-9064894765)⟩, ⟨(-4028842134), (-3021631575)⟩, ⟨(-251802634), (-251802630)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨100790850, 520408431⟩, ⟨(-488162836), (-70909227)⟩, ⟨(-5566850), 223048521⟩, ⟨(-66971176), 20820441⟩, ⟨(-11420965), 15868561⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨71977500, 426076784⟩, ⟨(-417642026), (-53092770)⟩, ⟨(-3024083), 200199819⟩, ⟨(-63280282), 17482702⟩, ⟨(-10218462), 15685286⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1147046178, 1147046179⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨163863739, 163863740⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4476430744, 4476430749⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar405 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1704
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar405 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨983182438, 1310909919⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4414567974, 4560381269⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1705
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((45783 / 200000) : ℝ)..(15261 / 50000), prawitzNormalCorrection
      ((74793 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
