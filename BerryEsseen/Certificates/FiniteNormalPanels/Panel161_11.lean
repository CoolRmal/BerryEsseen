...
namespace FiniteNormalPanel161_11
...
def j2 : Jet := ⟨⟨2174571686, 2174571690⟩, ⟨434914336, 434914340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1101000704, 1101000709⟩, ⟨440400280, 440400286⟩, ⟨44040027, 44040029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨275, 276⟩, ⟨110, 111⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94412), (-94410)⟩, ⟨110, 111⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-24203), (-24201)⟩, ⟨(-9653), (-9651)⟩, ⟨(-956), (-952)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5088853, 5088856⟩, ⟨(-9653), (-9651)⟩, ⟨(-956), (-952)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1304510, 1304512⟩, ⟨519329, 519331⟩, ⟨50944, 50948⟩, ⟨(-198), (-193)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-141861067), (-141861064)⟩, ⟨519329, 519331⟩, ⟨50944, 50948⟩, ⟨(-198), (-193)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-36365617), (-36365615)⟩, ⟨(-14413119), (-14413117)⟩, ⟨(-1388315), (-1388311)⟩, ⟨10497, 10502⟩, ⟨498, 503⟩⟩
...
def j19 : Jet := ⟨⟨1395290148, 1395290151⟩, ⟨(-14413119), (-14413117)⟩, ⟨(-1388315), (-1388311)⟩, ⟨10497, 10502⟩, ⟨498, 503⟩⟩
...
def j22 : Jet := ⟨⟨(-28), (-27)⟩, ⟨(-12), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11807, 11809⟩, ⟨(-12), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3026, 3028⟩, ⟨1206, 1209⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849151), (-849148)⟩, ⟨1206, 1209⟩, ⟨118, 121⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-217678), (-217676)⟩, ⟨(-86762), (-86760)⟩, ⟨(-8555), (-8551)⟩, ⟨23, 26⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35573716, 35573719⟩, ⟨(-86762), (-86760)⟩, ⟨(-8555), (-8551)⟩, ⟨23, 26⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9119204, 9119206⟩, ⟨3625439, 3625443⟩, ⟨353677, 353681⟩, ⟨(-1763), (-1758)⟩, ⟨(-87), (-83)⟩⟩
...
def j33 : Jet := ⟨⟨(-706708679), (-706708676)⟩, ⟨3625439, 3625443⟩, ⟨353677, 353681⟩, ⟨(-1763), (-1758)⟩, ⟨(-87), (-83)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-181162441), (-181162438)⟩, ⟨(-71535608), (-71535604)⟩, ⟨(-6784088), (-6784083)⟩, ⟨72987, 72991⟩, ⟨3422, 3426⟩⟩
...
def j36 : Jet := ⟨⟨4113804855, 4113804858⟩, ⟨(-71535608), (-71535604)⟩, ⟨(-6784088), (-6784083)⟩, ⟨72987, 72991⟩, ⟨3422, 3426⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨706445064, 706445068⟩, ⟨133991550, 133991555⟩, ⟨(-2162407), (-2162403)⟩, ⟨(-135269), (-135264)⟩, ⟨1314, 1319⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4484107708, 4484107712⟩, ⟨77974858, 77974864⟩, ⟨8750666, 8750674⟩, ⟨201192, 201200⟩, ⟨12809, 12819⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨737555268, 737555274⟩, ⟨152717692, 152717700⟩, ⟨1614300, 1614308⟩, ⟨125604, 125614⟩, ⟨2891, 2904⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-692187667), (-692187666)⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3602779629, 3602779630⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨126657023, 126657026⟩, ⟨52451034, 52451038⟩, ⟨5984669, 5984675⟩, ⟨157938, 157946⟩, ⟨10530, 10539⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4421624319, 4421624322⟩, ⟨52451034, 52451038⟩, ⟨5984669, 5984675⟩, ⟨157938, 157946⟩, ⟨10530, 10539⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4357835683, 4357835686⟩, ⟨25847174, 25847177⟩, ⟨2872513, 2872517⟩, ⟨60792, 60798⟩, ⟨3881, 3888⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3655515989, 3655515994⟩, ⟨(-118782362), (-118782356)⟩, ⟨1576451, 1576456⟩, ⟨(-41595), (-41588)⟩, ⟨1295, 1303⟩⟩
...
def j47 : Jet := ⟨⟨7178601319, 7178601332⟩, ⟨1435720261, 1435720273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11998302512, 11998302556⟩, ⟨4799320994, 4799321046⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11998302512, 11998302556⟩, ⟨4799320994, 4799321046⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11998302556), (-11998302512)⟩, ⟨(-4799321046), (-4799320994)⟩, ⟨(-479932107), (-479932098)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5999151278), (-5999151256)⟩, ⟨(-2399660523), (-2399660497)⟩, ⟨(-239966054), (-239966049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1062535128, 1062535144⟩, ⟨(-593653797), (-593653780)⟩, ⟨106476106, 106476116⟩, ⟨2282281, 2282285⟩, ⟨(-3293275), (-3293272)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨904340797, 904340813⟩, ⟨(-534653987), (-534653968)⟩, ⟨107431722, 107431736⟩, ⟨(-1230427), (-1230417)⟩, ⟨(-2820931), (-2820920)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨553750133, 830625201⟩, ⟨138437533, 138437534⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1739657349, 2609486030⟩, ⟨434914336, 434914340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨704640450, 1585441023⟩, ⟨352320224, 528480344⟩, ⟨44040027, 44040029⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨176, 398⟩, ⟨88, 133⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94511), (-94288)⟩, ⟨88, 133⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34888), (-15469)⟩, ⟨(-11616), (-7684)⟩, ⟨(-962), (-944)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078168, 5097588⟩, ⟨(-11616), (-7684)⟩, ⟨(-962), (-944)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨833133, 1881720⟩, ⟨412278, 625980⟩, ⟨50284, 51486⟩, ⟨(-239), (-153)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142332444), (-141283856)⟩, ⟨412278, 625980⟩, ⟨50284, 51486⟩, ⟨(-239), (-153)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-52540493), (-23179296)⟩, ⟨(-17445859), (-11358574)⟩, ⟨(-1417391), (-1352674)⟩, ⟨8262, 12730⟩, ⟨481, 515⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1379115272, 1408476470⟩, ⟨(-17445859), (-11358574)⟩, ⟨(-1417391), (-1352674)⟩, ⟨8262, 12730⟩, ⟨481, 515⟩⟩
...
def j70 : Jet := ⟨⟨(-40), (-17)⟩, ⟨(-14), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11795, 11819⟩, ⟨(-14), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1935, 4363⟩, ⟨961, 1454⟩, ⟨117, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850242), (-847813)⟩, ⟨961, 1454⟩, ⟨117, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-313858), (-139093)⟩, ⟨(-104463), (-69009)⟩, ⟨(-8622), (-8468)⟩, ⟨17, 31⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35477536, 35652302⟩, ⟨(-104463), (-69009)⟩, ⟨(-8622), (-8468)⟩, ⟨17, 31⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5820511, 13160665⟩, ⟨2871693, 4375568⟩, ⟨347744, 358526⟩, ⟨(-2131), (-1389)⟩, ⟨(-89), (-81)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710007372), (-702667217)⟩, ⟨2871693, 4375568⟩, ⟨347744, 358526⟩, ⟨(-2131), (-1389)⟩, ⟨(-89), (-81)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-262091592), (-115280911)⟩, ⟨(-86892730), (-56025261)⟩, ⟨(-6987705), (-6534311)⟩, ⟨57183, 88756⟩, ⟨3269, 3551⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4032875704, 4179686385⟩, ⟨(-86892730), (-56025261)⟩, ⟨(-6987705), (-6534311)⟩, ⟨57183, 88756⟩, ⟨3269, 3551⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨558604490, 855745672⟩, ⟨129051570, 138023541⟩, ⟨(-2627754), (-1698078)⟩, ⟨(-140181), (-129238)⟩, ⟨1030, 1603⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4413427796, 4574091896⟩, ⟨59158371, 98553827⟩, ⟨7692699, 10048915⟩, ⟨98465, 324701⟩, ⟨7365, 19995⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨574011491, 911359523⟩, ⟨140305123, 166629761⟩, ⟨(-20474), 3424409⟩, ⟨34359, 231438⟩, ⟨(-4393), 11306⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-830625201), (-553750133)⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3464342095, 3741217163⟩, ⟨(-138437534), (-138437533)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨76715180, 193383587⟩, ⟨37502848, 70715146⟩, ⟨4574704, 7917922⟩, ⟨7592, 363932⟩, ⟨361, 25489⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4371682476, 4488350883⟩, ⟨37502848, 70715146⟩, ⟨4574704, 7917922⟩, ⟨7592, 363932⟩, ⟨361, 25489⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4333155116, 4390594522⟩, ⟨18343017, 35045969⟩, ⟨2097663, 3885247⟩, ⟨(-27662), 171484⟩, ⟨(-2951), 12349⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3495144581, 3824515171⟩, ⟨(-126724270), (-109140928)⟩, ⟨562365, 2793082⟩, ⟨(-149328), 81763⟩, ⟨(-8099), 11649⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5742881057, 8614321605⟩, ⟨1435720261, 1435720273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7678913612, 17277555707⟩, ⟨3839456796, 5759185258⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7678913612, 17277555707⟩, ⟨3839456796, 5759185258⟩, ⟨479932098, 479932107⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17277555707), (-7678913612)⟩, ⟨(-5759185258), (-3839456796)⟩, ⟨(-479932107), (-479932098)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8638777854), (-3839456806)⟩, ⟨(-2879592629), (-1919728398)⟩, ⟨(-239966054), (-239966049)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨574687839, 1756811898⟩, ⟨(-1177867547), (-256869142)⟩, ⟨(-40749025), 362746368⟩, ⟨(-71500896), 52979608⟩, ⟨(-19013726), 13122931⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨467667609, 1564378328⟩, ⟨(-1100684286), (-223637733)⟩, ⟨(-29682915), 358908512⟩, ⟨(-75199004), 48378576⟩, ⟨(-18546460), 14076775⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4357835683, 4357835686⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3258
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4333155116, 4390594522⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3259
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((12893 / 100000) : ℝ)..(38679 / 200000), prawitzNormalCorrection
