...
namespace FiniteNormalPanel136_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (200571 / 800000)
def radius : Rat := (28653 / 800000)

def j0 : Jet := ⟨⟨1076807356, 1076807357⟩, ⟨153829622, 153829623⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3382890078, 3382890083⟩, ⟨483270010, 483270014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2664501145, 2664501154⟩, ⟨761286038, 761286048⟩, ⟨54377574, 54377576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨666, 668⟩, ⟨190, 191⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94021), (-94018)⟩, ⟨190, 191⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-58329), (-58326)⟩, ⟨(-16549), (-16545)⟩, ⟨(-1150), (-1147)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5054727, 5054731⟩, ⟨(-16549), (-16545)⟩, ⟨(-1150), (-1147)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3135838, 3135842⟩, ⟨885686, 885691⟩, ⟨60348, 60354⟩, ⟨(-412), (-408)⟩, ⟨(-15), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-140029739), (-140029734)⟩, ⟨885686, 885691⟩, ⟨60348, 60354⟩, ⟨(-412), (-408)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-86871303), (-86871298)⟩, ⟨(-24270914), (-24270907)⟩, ⟨(-1578458), (-1578450)⟩, ⟨21653, 21659⟩, ⟨680, 687⟩⟩
...
def j19 : Jet := ⟨⟨1344784462, 1344784468⟩, ⟨(-24270914), (-24270907)⟩, ⟨(-1578458), (-1578450)⟩, ⟨21653, 21659⟩, ⟨680, 687⟩⟩
...
def j22 : Jet := ⟨⟨(-68), (-66)⟩, ⟨(-20), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11767, 11770⟩, ⟨(-20), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7299, 7302⟩, ⟨2072, 2076⟩, ⟨142, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844878), (-844874)⟩, ⟨2072, 2076⟩, ⟨142, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-524144), (-524140)⟩, ⟨(-148471), (-148466)⟩, ⟨(-10242), (-10236)⟩, ⟨49, 54⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35267250, 35267255⟩, ⟨(-148471), (-148466)⟩, ⟨(-10242), (-10236)⟩, ⟨49, 54⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21879008, 21879013⟩, ⟨6159036, 6159043⟩, ⟨413839, 413846⟩, ⟨(-3666), (-3659)⟩, ⟨(-123), (-117)⟩⟩
...
def j33 : Jet := ⟨⟨(-693948875), (-693948869)⟩, ⟨6159036, 6159043⟩, ⟨413839, 413846⟩, ⟨(-3666), (-3659)⟩, ⟨(-123), (-117)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-430510282), (-430510276)⟩, ⟨(-119182012), (-119182003)⟩, ⟨(-7437496), (-7437487)⟩, ⟨149056, 149065⟩, ⟨4512, 4520⟩⟩
...
def j36 : Jet := ⟨⟨3864457014, 3864457020⟩, ⟨(-119182012), (-119182003)⟩, ⟨(-7437496), (-7437487)⟩, ⟨149056, 149065⟩, ⟨4512, 4520⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1059206671, 1059206678⟩, ⟨132198483, 132198493⟩, ⟨(-3974223), (-3974215)⟩, ⟨(-160555), (-160547)⟩, ⟨2971, 2980⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4773437504, 4773437512⟩, ⟨147215466, 147215479⟩, ⟨13727104, 13727120⟩, ⟨522551, 522566⟩, ⟨31270, 31285⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1177204970, 1177204980⟩, ⟨183231383, 183231400⟩, ⟨3499629, 3499645⟩, ⟨236723, 236740⟩, ⟨8890, 8910⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1076807357), (-1076807356)⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3218159939, 3218159940⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨322659393, 322659399⟩, ⟨100443556, 100443568⟩, ⟨9735417, 9735429⟩, ⟨428366, 428380⟩, ⟨27921, 27938⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4617626689, 4617626695⟩, ⟨100443556, 100443568⟩, ⟨9735417, 9735429⟩, ⟨428366, 428380⟩, ⟨27921, 27938⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4453375754, 4453375758⟩, ⟨48435368, 48435374⟩, ⟨4431167, 4431174⟩, ⟨158369, 158378⟩, ⟨9535, 9547⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3336853218, 3336853223⟩, ⟨(-123211266), (-123211258)⟩, ⟨1585438, 1585445⟩, ⟨(-40046), (-40036)⟩, ⟨1471, 1482⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨36518944389, 36518944396⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value567

def j47 : Jet := ⟨⟨9155801486, 9155801497⟩, ⟨1307971638, 1307971648⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨19517890375, 19517890423⟩, ⟨5576540094, 5576540146⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨19517890375, 19517890423⟩, ⟨5576540094, 5576540146⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-19517890423), (-19517890375)⟩, ⟨(-5576540146), (-5576540094)⟩, ⟨(-398324298), (-398324291)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9758945212), (-9758945187)⟩, ⟨(-2788270073), (-2788270047)⟩, ⟨(-199162149), (-199162145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨442755506, 442755517⟩, ⟨(-287434543), (-287434532)⟩, ⟨72769449, 72769456⟩, ⟨(-6861422), (-6861419)⟩, ⟨(-573600), (-573598)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨343986352, 343986362⟩, ⟨(-236015617), (-236015605)⟩, ⟨64945336, 64945346⟩, ⟨(-7528585), (-7528578)⟩, ⟨(-219116), (-219106)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨922977734, 1230636980⟩, ⟨153829622, 153829623⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2899620068, 3866160096⟩, ⟨483270010, 483270014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1957592679, 3480164774⟩, ⟨652530890, 870041198⟩, ⟨54377574, 54377576⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨489, 872⟩, ⟨163, 218⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94198), (-93814)⟩, ⟨163, 218⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-76328), (-42759)⟩, ⟨(-19008), (-14076)⟩, ⟨(-1164), (-1130)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5036728, 5070298⟩, ⟨(-19008), (-14076)⟩, ⟨(-1164), (-1130)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2295677, 4108407⟩, ⟨749823, 1020687⟩, ⟨58973, 61541⟩, ⟨(-476), (-344)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140869900), (-139057169)⟩, ⟨749823, 1020687⟩, ⟨58973, 61541⟩, ⟨(-476), (-344)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-114145332), (-63380528)⟩, ⟨(-28194574), (-20299790)⟩, ⟨(-1642723), (-1503941)⟩, ⟨18066, 25234⟩, ⟨636, 723⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1317510433, 1368275238⟩, ⟨(-28194574), (-20299790)⟩, ⟨(-1642723), (-1503941)⟩, ⟨18066, 25234⟩, ⟨636, 723⟩⟩
...
def j70 : Jet := ⟨⟨(-88), (-48)⟩, ⟨(-22), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11747, 11788⟩, ⟨(-22), (-16)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5354, 9552⟩, ⟨1766, 2381⟩, ⟨141, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846823), (-842624)⟩, ⟨1766, 2381⟩, ⟨141, 148⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-686172), (-384057)⟩, ⟨(-170739), (-126089)⟩, ⟨(-10390), (-10065)⟩, ⟨41, 61⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35105222, 35407338⟩, ⟨(-170739), (-126089)⟩, ⟨(-10390), (-10065)⟩, ⟨41, 61⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16000523, 28690177⟩, ⟨5195159, 7115076⟩, ⟨401452, 424542⟩, ⟨(-4249), (-3075)⟩, ⟨(-127), (-112)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699827360), (-687137705)⟩, ⟨5195159, 7115076⟩, ⟨401452, 424542⟩, ⟨(-4249), (-3075)⟩, ⟨(-127), (-112)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-567062415), (-313188820)⟩, ⟨(-139397717), (-98631004)⟩, ⟨(-7888079), (-6914370)⟩, ⟨123323, 174683⟩, ⟨4118, 4858⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3727904881, 3981778476⟩, ⟨(-139397717), (-98631004)⟩, ⟨(-7888079), (-6914370)⟩, ⟨123323, 174683⟩, ⟨4118, 4858⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨889478179, 1231667383⟩, ⟨122866718, 140253622⟩, ⟨(-4651171), (-3299474)⟩, ⟨(-172644), (-146508)⟩, ⟨2461, 3491⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4632790142, 4948287219⟩, ⟨114756946, 185031530⟩, ⟨10887450, 17389247⟩, ⟨251877, 888500⟩, ⟨10989, 61107⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨959440539, 1419019879⟩, ⟨156296770, 214649483⟩, ⟨178958, 7469986⟩, ⟨(-35663), 576459⟩, ⟨(-14136), 38285⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1230636980), (-922977734)⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3064330316, 3371989562⟩, ⟨(-153829623), (-153829622)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨214326695, 468831840⟩, ⟨69829382, 141836650⟩, ⟨5767697, 15663571⟩, ⟨(-10542), 1127572⟩, ⟨(-12901), 95913⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4509293991, 4763799136⟩, ⟨69829382, 141836650⟩, ⟨5767697, 15663571⟩, ⟨(-10542), 1127572⟩, ⟨(-12901), 95913⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4400826083, 4523313111⟩, ⟨33152128, 69212435⟩, ⟨2208746, 7518528⟩, ⟨(-123390), 533587⟩, ⟨(-21111), 48191⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3139857384, 3551264433⟩, ⟨(-138355066), (-103282230)⟩, ⟨(-903056), 4715432⟩, ⟨(-366160), 339813⟩, ⟨(-35687), 42255⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7847829847, 10463773144⟩, ⟨1307971638, 1307971648⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14339674568, 25492754861⟩, ⟨4779891510, 6373188740⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14339674568, 25492754861⟩, ⟨4779891510, 6373188740⟩, ⟨398324291, 398324298⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-25492754861), (-14339674568)⟩, ⟨(-6373188740), (-4779891510)⟩, ⟨(-398324298), (-398324291)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12746377431), (-7169837284)⟩, ⟨(-3186594370), (-2389945755)⟩, ⟨(-199162149), (-199162145)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨220842979, 809034366⟩, ⟨(-600252384), (-122888651)⟩, ⟨(-3324920), 212433952⟩, ⟨(-48738540), 19378517⟩, ⟨(-8519802), 9117320⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨161448367, 668944551⟩, ⟨(-522376259), (-95149034)⟩, ⟨35841, 195873913⟩, ⟨(-47870318), 16320321⟩, ⟨(-7767669), 9400989⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1076807356, 1076807357⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4453375754, 4453375758⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar567 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2742
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar567 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨922977734, 1230636980⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4400826083, 4523313111⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2743
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((85959 / 400000) : ℝ)..(28653 / 100000), prawitzNormalCorrection
      ((45449 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
