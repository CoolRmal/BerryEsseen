...
namespace FiniteNormalPanel144_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (523 / 3200)
def radius : Rat := (523 / 16000)

def j0 : Jet := ⟨⟨701958717, 701958718⟩, ⟨140391743, 140391744⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2205268348, 2205268352⟩, ⟨441053668, 441053672⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1132303962, 1132303967⟩, ⟨452921582, 452921590⟩, ⟨45292158, 45292159⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-24889), (-24887)⟩, ⟨(-9927), (-9924)⟩, ⟨(-983), (-978)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5088167, 5088170⟩, ⟨(-9927), (-9924)⟩, ⟨(-983), (-978)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1341419, 1341421⟩, ⟨533949, 533953⟩, ⟨52349, 52354⟩, ⟨(-209), (-205)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141824158), (-141824155)⟩, ⟨533949, 533953⟩, ⟨52349, 52354⟩, ⟨(-209), (-205)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-37389821), (-37389819)⟩, ⟨(-14815162), (-14815158)⟩, ⟨(-1425485), (-1425481)⟩, ⟨11094, 11098⟩, ⟨526, 530⟩⟩
...
def j19 : Jet := ⟨⟨1394265944, 1394265947⟩, ⟨(-14815162), (-14815158)⟩, ⟨(-1425485), (-1425481)⟩, ⟨11094, 11098⟩, ⟨526, 530⟩⟩
...
def j25 : Jet := ⟨⟨3112, 3114⟩, ⟨1240, 1244⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849065), (-849062)⟩, ⟨1240, 1244⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-223844), (-223842)⟩, ⟨(-89212), (-89209)⟩, ⟨(-8793), (-8788)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35567550, 35567553⟩, ⟨(-89212), (-89209)⟩, ⟨(-8793), (-8788)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9376853, 9376855⟩, ⟨3727221, 3727224⟩, ⟨363347, 363352⟩, ⟨(-1863), (-1858)⟩, ⟨(-92), (-88)⟩⟩
...
def j33 : Jet := ⟨⟨(-706451030), (-706451027)⟩, ⟨3727221, 3727224⟩, ⟨363347, 363352⟩, ⟨(-1863), (-1858)⟩, ⟨(-92), (-88)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-186245261), (-186245259)⟩, ⟨(-73515479), (-73515476)⟩, ⟨(-6960970), (-6960966)⟩, ⟨77129, 77134⟩, ⟨3609, 3614⟩⟩
...
def j36 : Jet := ⟨⟨4108722035, 4108722037⟩, ⟨(-73515479), (-73515476)⟩, ⟨(-6960970), (-6960966)⟩, ⟨77129, 77134⟩, ⟨3609, 3614⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨715891494, 715891498⟩, ⟨135571393, 135571398⟩, ⟨(-2253303), (-2253298)⟩, ⟨(-140689), (-140684)⟩, ⟨1409, 1413⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4489654911, 4489654914⟩, ⟨80331332, 80331338⟩, ⟨9043670, 9043677⟩, ⟨213624, 213633⟩, ⟨13685, 13695⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨748342313, 748342318⟩, ⟨155106486, 155106494⟩, ⟨1687640, 1687649⟩, ⟨131860, 131870⟩, ⟨3119, 3130⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-701958718), (-701958717)⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3593008578, 3593008579⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨130388936, 130388939⟩, ⟨54050584, 54050588⟩, ⟨6189542, 6189548⟩, ⟨167840, 167848⟩, ⟨11271, 11282⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4425356232, 4425356235⟩, ⟨54050584, 54050588⟩, ⟨6189542, 6189548⟩, ⟨167840, 167848⟩, ⟨11271, 11282⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4359674332, 4359674335⟩, ⟨26624177, 26624180⟩, ⟨2967541, 2967546⟩, ⟨64551, 64557⟩, ⟨4146, 4154⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3647140057, 3647140062⟩, ⟨(-120234068), (-120234063)⟩, ⟨1612255, 1612261⟩, ⟨(-43002), (-42995)⟩, ⟨1357, 1366⟩⟩
...
def j47 : Jet := ⟨⟨7480704535, 7480704547⟩, ⟨1496140902, 1496140914⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13029421758, 13029421801⟩, ⟨5211768686, 5211768738⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13029421758, 13029421801⟩, ⟨5211768686, 5211768738⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13029421801), (-13029421758)⟩, ⟨(-5211768738), (-5211768686)⟩, ⟨(-521176876), (-521176866)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6514710901), (-6514710879)⟩, ⟨(-2605884369), (-2605884343)⟩, ⟨(-260588438), (-260588433)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨942348238, 942348251⟩, ⟨(-571750705), (-571750690)⟩, ⟨116273999, 116274009⟩, ⟨(-389091), (-389086)⟩, ⟨(-3468328), (-3468326)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨800210052, 800210065⟩, ⟨(-511891504), (-511891487)⟩, ⟨115095350, 115095365⟩, ⟨(-3809460), (-3809450)⟩, ⟨(-2884628), (-2884618)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨561566973, 842350461⟩, ⟨140391743, 140391744⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1764214676, 2646322021⟩, ⟨441053668, 441053672⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨724674533, 1630517710⟩, ⟨362337266, 543505906⟩, ⟨45292158, 45292159⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-35878), (-15907)⟩, ⟨(-11945), (-7900)⟩, ⟨(-989), (-971)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5077178, 5097150⟩, ⟨(-11945), (-7900)⟩, ⟨(-989), (-971)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨856654, 1935054⟩, ⟨423792, 643686⟩, ⟨51652, 52923⟩, ⟨(-252), (-162)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142308923), (-141230522)⟩, ⟨423792, 643686⟩, ⟨51652, 52923⟩, ⟨(-252), (-162)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-54025376), (-23829322)⟩, ⟨(-17936955), (-11670295)⟩, ⟨(-1456238), (-1387784)⟩, ⟨8730, 13459⟩, ⟨507, 545⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1377630389, 1407826444⟩, ⟨(-17936955), (-11670295)⟩, ⟨(-1456238), (-1387784)⟩, ⟨8730, 13459⟩, ⟨507, 545⟩⟩
...
def j72 : Jet := ⟨⟨1989, 4487⟩, ⟨988, 1495⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850188), (-847689)⟩, ⟨988, 1495⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-322761), (-143027)⟩, ⟨(-107421), (-70945)⟩, ⟨(-8863), (-8701)⟩, ⟨19, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35468633, 35648368⟩, ⟨(-107421), (-70945)⟩, ⟨(-8863), (-8701)⟩, ⟨19, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5984496, 13533350⟩, ⟨2951467, 4499147⟩, ⟨357072, 368474⟩, ⟨(-2252), (-1469)⟩, ⟨(-94), (-85)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709843387), (-702294532)⟩, ⟨2951467, 4499147⟩, ⟨357072, 368474⟩, ⟨(-2252), (-1469)⟩, ⟨(-94), (-85)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-269481031), (-118495654)⟩, ⟨(-89329021), (-57539795)⟩, ⟨(-7176343), (-6696748)⟩, ⟨60392, 93828⟩, ⟨3444, 3749⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4025486265, 4176471642⟩, ⟨(-89329021), (-57539795)⟩, ⟨(-7176343), (-6696748)⟩, ⟨60392, 93828⟩, ⟨3444, 3749⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨565879920, 867425027⟩, ⟨130418216, 139777111⟩, ⟨(-2739215), (-1768482)⟩, ⟨(-145958), (-134219)⟩, ⟨1104, 1719⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4416824931, 4582488391⟩, ⟨60851173, 101689381⟩, ⟨7920494, 10425902⟩, ⟨103742, 346383⟩, ⟨7729, 21585⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨581935173, 925493687⟩, ⟨142135862, 169671818⟩, ⟨(-31264), 3596411⟩, ⟨33592, 246180⟩, ⟨(-4803), 12306⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-842350461), (-561566973)⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3452616835, 3733400323⟩, ⟨(-140391744), (-140391743)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨78847758, 199428426⟩, ⟨38516640, 73122884⟩, ⟨4690311, 8252785⟩, ⟨6630, 390248⟩, ⟨125, 27768⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4373815054, 4494395722⟩, ⟨38516640, 73122884⟩, ⟨4690311, 8252785⟩, ⟨6630, 390248⟩, ⟨125, 27768⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4334211879, 4393550119⟩, ⟨18826200, 36230393⟩, ⟨2143151, 4048143⟩, ⟨(-30555), 184049⟩, ⟨(-3368), 13485⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3484164574, 3819093442⟩, ⟨(-128480260), (-110181280)⟩, ⟨538544, 2903468⟩, ⟨(-158884), 89931⟩, ⟨(-8945), 12721⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5984563621, 8976845450⟩, ⟨1496140902, 1496140914⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8338829906, 18762367367⟩, ⟨4169414944, 6254122480⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8338829906, 18762367367⟩, ⟨4169414944, 6254122480⟩, ⟨521176866, 521176876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18762367367), (-8338829906)⟩, ⟨(-6254122480), (-4169414944)⟩, ⟨(-521176876), (-521176866)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9381183684), (-4169414953)⟩, ⟨(-3127061240), (-2084707472)⟩, ⟨(-260588438), (-260588433)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨483461739, 1626900020⟩, ⟨(-1184506341), (-234664487)⟩, ⟨(-41757695), 401872071⟩, ⟨(-88039233), 58045936⟩, ⟨(-22756846), 17291589⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨392193967, 1446642727⟩, ⟨(-1101932707), (-202767113)⟩, ⟨(-31050422), 393878745⟩, ⟨(-91167251), 52868350⟩, ⟨(-22028249), 18329646⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨701958717, 701958718⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4359674332, 4359674335⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2898
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨561566973, 842350461⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4334211879, 4393550119⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2899
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (55061513 / 4294967296)

theorem envelope_integral : (∫ s in ((523 / 4000) : ℝ)..(1569 / 8000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((523 / 4000) : ℝ)..(1569 / 8000), prawitzNormalCorrection
