...
namespace FiniteNormalPanel25_16
...
def j2 : Jet := ⟨⟨1823179254, 1823179258⟩, ⟨607726418, 607726422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨773925006, 773925010⟩, ⟨515950004, 515950010⟩, ⟨85991667, 85991669⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨193, 194⟩, ⟨129, 130⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94494), (-94492)⟩, ⟨129, 130⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-17028), (-17026)⟩, ⟨(-11329), (-11327)⟩, ⟨(-1874), (-1871)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5096028, 5096031⟩, ⟨(-11329), (-11327)⟩, ⟨(-1874), (-1871)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨918270, 918272⟩, ⟨610138, 610140⟩, ⟨100331, 100334⟩, ⟨(-453), (-448)⟩, ⟨(-38), (-35)⟩⟩
...
def j16 : Jet := ⟨⟨(-142247307), (-142247304)⟩, ⟨610138, 610140⟩, ⟨100331, 100334⟩, ⟨(-453), (-448)⟩, ⟨(-38), (-35)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-25632035), (-25632033)⟩, ⟨(-16978081), (-16978078)⟩, ⟨(-2756631), (-2756627)⟩, ⟨24185, 24190⟩, ⟨1946, 1950⟩⟩
...
def j19 : Jet := ⟨⟨1406023730, 1406023733⟩, ⟨(-16978081), (-16978078)⟩, ⟨(-2756631), (-2756627)⟩, ⟨24185, 24190⟩, ⟨1946, 1950⟩⟩
...
def j25 : Jet := ⟨⟨2128, 2130⟩, ⟨1416, 1418⟩, ⟨233, 236⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850049), (-850046)⟩, ⟨1416, 1418⟩, ⟨233, 236⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-153174), (-153172)⟩, ⟨(-101861), (-101859)⟩, ⟨(-16809), (-16805)⟩, ⟨54, 58⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35638220, 35638223⟩, ⟨(-101861), (-101859)⟩, ⟨(-16809), (-16805)⟩, ⟨54, 58⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6421774, 6421775⟩, ⟨4262827, 4262830⟩, ⟨698264, 698267⟩, ⟨(-4051), (-4046)⟩, ⟨(-331), (-328)⟩⟩
...
def j33 : Jet := ⟨⟨(-709406109), (-709406107)⟩, ⟨4262827, 4262830⟩, ⟨698264, 698267⟩, ⟨(-4051), (-4046)⟩, ⟨(-331), (-328)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-127830341), (-127830339)⟩, ⟨(-84452095), (-84452091)⟩, ⟨(-13565461), (-13565456)⟩, ⟨168499, 168503⟩, ⟨13433, 13436⟩⟩
...
def j36 : Jet := ⟨⟨4167136955, 4167136957⟩, ⟨(-84452095), (-84452091)⟩, ⟨(-13565461), (-13565456)⟩, ⟨168499, 168503⟩, ⟨13433, 13436⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨596845824, 596845827⟩, ⟨191741548, 191741552⟩, ⟨(-3572522), (-3572518)⟩, ⟨(-379790), (-379786)⟩, ⟨4248, 4251⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4426718935, 4426718938⟩, ⟨89712834, 89712841⟩, ⟨16228622, 16228630⟩, ⟨441937, 441946⟩, ⟨43883, 43891⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨615154558, 615154562⟩, ⟨210090231, 210090238⟩, ⟨2578158, 2578168⟩, ⟨319848, 319857⟩, ⟨8772, 8782⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-580335982), (-580335981)⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3714631314, 3714631315⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨88106638, 88106640⟩, ⟨60181116, 60181120⟩, ⟨11015178, 11015184⟩, ⟨343842, 343852⟩, ⟨35349, 35356⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4383073934, 4383073936⟩, ⟨60181116, 60181120⟩, ⟨11015178, 11015184⟩, ⟨343842, 343852⟩, ⟨35349, 35356⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4338796976, 4338796978⟩, ⟨29786589, 29786592⟩, ⟨5349707, 5349711⟩, ⟨133457, 133464⟩, ⟨13280, 13286⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3752538727, 3752538731⟩, ⟨(-169657592), (-169657587)⟩, ⟨3285265, 3285272⟩, ⟨(-125527), (-125519)⟩, ⟨5473, 5481⟩⟩
...
def j47 : Jet := ⟨⟨3462632664, 3462632671⟩, ⟨1154210888, 1154210895⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2791598664, 2791598676⟩, ⟨1861065776, 1861065792⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2791598664, 2791598676⟩, ⟨1861065776, 1861065792⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2791598676), (-2791598664)⟩, ⟨(-1861065792), (-1861065776)⟩, ⟨(-310177634), (-310177629)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1395799338), (-1395799332)⟩, ⟨(-930532896), (-930532888)⟩, ⟨(-155088817), (-155088814)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3103278339, 3103278351⟩, ⟨(-672345653), (-672345644)⟩, ⟨(-39223560), (-39223553)⟩, ⟨19018024, 19018027⟩, ⟨(-321926), (-321924)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2711352926, 2711352940⟩, ⟨(-710016545), (-710016531)⟩, ⟨(-5337481), (-5337465)⟩, ⟨17560564, 17560578⟩, ⟨(-1038910), (-1038896)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨386890654, 773781309⟩, ⟨193445327, 193445328⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1215452836, 2430905676⟩, ⟨607726418, 607726422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨343966669, 1375866683⟩, ⟨343966668, 687933346⟩, ⟨85991667, 85991669⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨86, 345⟩, ⟨86, 173⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94601), (-94341)⟩, ⟨86, 173⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-30305), (-7555)⟩, ⟨(-15147), (-7499)⟩, ⟨(-1888), (-1852)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5082751, 5105502⟩, ⟨(-15147), (-7499)⟩, ⟨(-1888), (-1852)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨407057, 1635517⟩, ⟨402204, 817159⟩, ⟨98732, 101472⟩, ⟨(-607), (-295)⟩, ⟨(-38), (-34)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142758520), (-141530059)⟩, ⟨402204, 817159⟩, ⟨98732, 101472⟩, ⟨(-607), (-295)⟩, ⟨(-38), (-34)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-45731825), (-11334573)⟩, ⟨(-22833703), (-11072801)⟩, ⟨(-2818123), (-2670251)⟩, ⟨15764, 32591⟩, ⟨1865, 2007⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1385923940, 1420321193⟩, ⟨(-22833703), (-11072801)⟩, ⟨(-2818123), (-2670251)⟩, ⟨15764, 32591⟩, ⟨1865, 2007⟩⟩
...
def j72 : Jet := ⟨⟨945, 3790⟩, ⟨939, 1895⟩, ⟨232, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851232), (-848386)⟩, ⟨939, 1895⟩, ⟨232, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-272688), (-67943)⟩, ⟨(-136269), (-67335)⟩, ⟨(-16950), (-16605)⟩, ⟨35, 76⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35518706, 35723452⟩, ⟨(-136269), (-67335)⟩, ⟨(-16950), (-16605)⟩, ⟨35, 76⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2844550, 11443791⟩, ⟨2800897, 5716504⟩, ⟨683880, 708516⟩, ⟨(-5442), (-2652)⟩, ⟨(-338), (-317)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712983333), (-704384091)⟩, ⟨2800897, 5716504⟩, ⟨683880, 708516⟩, ⟨(-5442), (-2652)⟩, ⟨(-338), (-317)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-228399880), (-56411290)⟩, ⟨(-113975629), (-54580042)⟩, ⟨(-13995912), (-12960229)⟩, ⟨109103, 227726⟩, ⟨12711, 13949⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4066567416, 4238556006⟩, ⟨(-113975629), (-54580042)⟩, ⟨(-13995912), (-12960229)⟩, ⟨109103, 227726⟩, ⟨12711, 13949⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨392209082, 803886645⟩, ⟨183180908, 197838120⟩, ⟨(-4825937), (-2322437)⟩, ⟨(-394296), (-359386)⟩, ⟨2757, 5748⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4352129368, 4536195319⟩, ⟨56042530, 127138116⟩, ⟨14029162, 19175594⟩, ⟨108296, 858253⟩, ⟨22529, 74947⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨397429024, 849037161⟩, ⟨190736585, 232746124⟩, ⟨(-1425648), 7092075⟩, ⟨48936, 649448⟩, ⟨(-23751), 47358⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-773781309), (-386890654)⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3521185987, 3908076642⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨36775560, 167839253⟩, ⟨35299106, 92019378⟩, ⟨7906832, 15416563⟩, ⟨(-145458), 1025416⟩, ⟨(-7401), 100823⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4331742856, 4462806549⟩, ⟨35299106, 92019378⟩, ⟨7906832, 15416563⟩, ⟨(-145458), 1025416⟩, ⟨(-7401), 100823⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4313315882, 4378082706⟩, ⟨17314486, 45813967⟩, ⟨3638654, 7640740⟩, ⟨(-153576), 495922⟩, ⟨(-15720), 50295⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3536228891, 3983705016⟩, ⟨(-182993739), (-152584702)⟩, ⟨919652, 6172619⟩, ⟨(-483881), 287366⟩, ⟨(-36641), 52683⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2308421776, 4616843559⟩, ⟨1154210888, 1154210895⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1240710517, 4962842085⟩, ⟨1240710516, 2481421054⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1240710517, 4962842085⟩, ⟨1240710516, 2481421054⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4962842085), (-1240710517)⟩, ⟨(-2481421054), (-1240710516)⟩, ⟨(-310177634), (-310177629)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2481421043), (-620355258)⟩, ⟨(-1240710527), (-620355258)⟩, ⟨(-155088817), (-155088814)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2410159865, 3717332077⟩, ⟨(-1073845905), (-348117981)⟩, ⟨(-109090057), 68074355⟩, ⟨1825224, 36355122⟩, ⟨(-3854589), 1903683⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1984386925, 3447931829⟩, ⟨(-1154405489), (-372244599)⟩, ⟨(-88300702), 114236239⟩, ⟨(-3359739), 38542545⟩, ⟨(-5384554), 1965293⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4338796976, 4338796978⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified506
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4313315882, 4378082706⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified507
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (122056907 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((563 / 6250) : ℝ)..(563 / 3125), prawitzNormalCorrection
