...
namespace FiniteNormalPanel150_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3449 / 20000)
def radius : Rat := (3449 / 100000)

def j0 : Jet := ⟨⟨740667110, 740667111⟩, ⟨148133422, 148133423⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2326874351, 2326874355⟩, ⟨465374870, 465374874⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1260625255, 1260625260⟩, ⟨504250102, 504250108⟩, ⟨50425010, 50425012⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨315, 316⟩, ⟨126, 127⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94372), (-94370)⟩, ⟨126, 127⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-27700), (-27698)⟩, ⟨(-11044), (-11041)⟩, ⟨(-1091), (-1088)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5085356, 5085359⟩, ⟨(-11044), (-11041)⟩, ⟨(-1091), (-1088)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1492613, 1492615⟩, ⟨593803, 593806⟩, ⟨58086, 58090⟩, ⟨(-259), (-254)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-141672964), (-141672961)⟩, ⟨593803, 593806⟩, ⟨58086, 58090⟩, ⟨(-259), (-254)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-41582743), (-41582740)⟩, ⟨(-16458809), (-16458806)⟩, ⟨(-1576547), (-1576542)⟩, ⟨13713, 13719⟩, ⟨646, 652⟩⟩
...
def j19 : Jet := ⟨⟨1390073022, 1390073026⟩, ⟨(-16458809), (-16458806)⟩, ⟨(-1576547), (-1576542)⟩, ⟨13713, 13719⟩, ⟨646, 652⟩⟩
...
def j25 : Jet := ⟨⟨3464, 3465⟩, ⟨1381, 1383⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848713), (-848711)⟩, ⟨1381, 1383⟩, ⟨135, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-249108), (-249107)⟩, ⟨(-99239), (-99236)⟩, ⟨(-9764), (-9760)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35542286, 35542288⟩, ⟨(-99239), (-99236)⟩, ⟨(-9764), (-9760)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10432094, 10432095⟩, ⟨4143709, 4143712⟩, ⟨402765, 402770⟩, ⟨(-2305), (-2300)⟩, ⟨(-113), (-109)⟩⟩
...
def j33 : Jet := ⟨⟨(-705395789), (-705395787)⟩, ⟨4143709, 4143712⟩, ⟨402765, 402770⟩, ⟨(-2305), (-2300)⟩, ⟨(-113), (-109)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-207042264), (-207042261)⟩, ⟨(-81600677), (-81600674)⟩, ⟨(-7676984), (-7676980)⟩, ⟨95258, 95263⟩, ⟨4423, 4428⟩⟩
...
def j36 : Jet := ⟨⟨4087925032, 4087925035⟩, ⟨(-81600677), (-81600674)⟩, ⟨(-7676984), (-7676980)⟩, ⟨95258, 95263⟩, ⟨4423, 4428⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨753096598, 753096602⟩, ⟨141702468, 141702474⟩, ⟨(-2637494), (-2637488)⟩, ⟨(-163396), (-163390)⟩, ⟨1834, 1841⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4512495683, 4512495687⟩, ⟨90075694, 90075699⟩, ⟨10272344, 10272351⟩, ⟨269050, 269060⟩, ⟨17672, 17683⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨791238888, 791238893⟩, ⟨164673540, 164673550⟩, ⟨2001955, 2001965⟩, ⟨159101, 159113⟩, ⟨4164, 4180⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-740667111), (-740667110)⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3554300185, 3554300186⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨145765714, 145765717⟩, ⟨60673852, 60673858⟩, ⟨7051373, 7051381⟩, ⟨212134, 212142⟩, ⟨14667, 14678⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4440733010, 4440733013⟩, ⟨60673852, 60673858⟩, ⟨7051373, 7051381⟩, ⟨212134, 212142⟩, ⟨14667, 14678⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4367242041, 4367242043⟩, ⟨29834871, 29834875⟩, ⟨3365429, 3365435⟩, ⟨81320, 81326⟩, ⟨5359, 5367⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3614111150, 3614111153⟩, ⟨(-125936333), (-125936326)⟩, ⟨1756055, 1756062⟩, ⟨(-48778), (-48771)⟩, ⟨1629, 1638⟩⟩
...
def j47 : Jet := ⟨⟨6531323601, 6531323612⟩, ⟨1306264720, 1306264730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9932133364, 9932133399⟩, ⟨3972853344, 3972853384⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9932133364, 9932133399⟩, ⟨3972853344, 3972853384⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9932133399), (-9932133364)⟩, ⟨(-3972853384), (-3972853344)⟩, ⟨(-397285341), (-397285334)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4966066700), (-4966066682)⟩, ⟨(-1986426692), (-1986426672)⟩, ⟨(-198642671), (-198642667)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1351468027, 1351468046⟩, ⟨(-625055330), (-625055314)⟩, ⟨82038820, 82038829⟩, ⟨6624900, 6624903⟩, ⟨(-2663159), (-2663157)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1137227673, 1137227691⟩, ⟨(-565596478), (-565596459)⟩, ⟨87914017, 87914032⟩, ⟨2898250, 2898260⟩, ⟨(-2394088), (-2394078)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨592533688, 888800533⟩, ⟨148133422, 148133423⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1861499481, 2792249226⟩, ⟨465374870, 465374874⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨806800163, 1815300375⟩, ⟨403400080, 605100130⟩, ⟨50425010, 50425012⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨201, 455⟩, ⟨100, 152⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94486), (-94231)⟩, ⟨100, 152⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-39936), (-17701)⟩, ⟨(-13294), (-8785)⟩, ⟨(-1099), (-1078)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073120, 5095356⟩, ⟨(-13294), (-8785)⟩, ⟨(-1099), (-1078)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨952974, 2153591⟩, ⟨470868, 716214⟩, ⟨57222, 58795⟩, ⟨(-312), (-202)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142212603), (-141011985)⟩, ⟨470868, 716214⟩, ⟨57222, 58795⟩, ⟨(-312), (-202)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-60107232), (-26488791)⟩, ⟨(-19947293), (-12941681)⟩, ⟨(-1614672), (-1529793)⟩, ⟨10770, 16656⟩, ⟨621, 672⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1371548533, 1405166975⟩, ⟨(-19947293), (-12941681)⟩, ⟨(-1614672), (-1529793)⟩, ⟨10770, 16656⟩, ⟨621, 672⟩⟩
...
def j72 : Jet := ⟨⟨2214, 4995⟩, ⟨1100, 1664⟩, ⟨134, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849963), (-847181)⟩, ⟨1100, 1664⟩, ⟨134, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-359244), (-159141)⟩, ⟨(-119542), (-78866)⟩, ⟨(-9851), (-9652)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35432150, 35632254⟩, ⟨(-119542), (-78866)⟩, ⟨(-9851), (-9652)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6655851, 15060242⟩, ⟨3277399, 5005267⟩, ⟨394984, 409121⟩, ⟨(-2788), (-1814)⟩, ⟨(-115), (-106)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709172032), (-700767640)⟩, ⟨3277399, 5005267⟩, ⟨394984, 409121⟩, ⟨(-2788), (-1814)⟩, ⟨(-115), (-106)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-299736917), (-131637660)⟩, ⟨(-99296655), (-63703315)⟩, ⟨(-7944004), (-7349262)⟩, ⟨74397, 116065⟩, ⟨4195, 4615⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3995230379, 4163329636⟩, ⟨(-99296655), (-63703315)⟩, ⟨(-7944004), (-7349262)⟩, ⟨74397, 116065⟩, ⟨4195, 4615⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨594448503, 913528819⟩, ⟨135643967, 146645698⟩, ⟨(-3211093), (-2065309)⟩, ⟨(-170289), (-154929)⟩, ⟨1435, 2242⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4430767123, 4617191582⟩, ⟨67795388, 114754755⟩, ⟨8858691, 12032788⟩, ⟨126502, 444730⟩, ⟨9253, 29066⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨613243990, 982065121⟩, ⟨149316082, 182055650⟩, ⟨(-84790), 4346876⟩, ⟨28422, 313009⟩, ⟨(-6792), 17075⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-888800533), (-592533688)⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3406166763, 3702433608⟩, ⟨(-148133423), (-148133422)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨87560199, 224553958⟩, ⟨42639294, 83255818⟩, ⟨5152251, 9704870⟩, ⟨926, 511656⟩, ⟨(-1218), 38746⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4382527495, 4519521254⟩, ⟨42639294, 83255818⟩, ⟨5152251, 9704870⟩, ⟨926, 511656⟩, ⟨(-1218), 38746⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4338526508, 4405813884⟩, ⟨20783262, 41209961⟩, ⟨2318582, 4753937⟩, ⟨(-44698), 242154⟩, ⟨(-5509), 18984⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3440711831, 3797987801⟩, ⟨(-135474149), (-114111144)⟩, ⟨417442, 3381270⟩, ⟨(-202496), 128780⟩, ⟨(-13101), 17907⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5225058881, 7837588333⟩, ⟨1306264720, 1306264730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6356565353, 14302272089⟩, ⟨3178282676, 4767424060⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6356565353, 14302272089⟩, ⟨3178282676, 4767424060⟩, ⟨397285334, 397285341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14302272089), (-6356565353)⟩, ⟨(-4767424060), (-3178282676)⟩, ⟨(-397285341), (-397285334)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7151136045), (-3178282676)⟩, ⟨(-2383712030), (-1589141338)⟩, ⟨(-198642671), (-198642667)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨812564752, 2049185387⟩, ⟨(-1137300362), (-300649608)⟩, ⟨(-39154734), 278020336⟩, ⟨(-42163825), 42310480⟩, ⟨(-12299827), 6755699⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨650948182, 1812069934⟩, ⟨(-1070337499), (-262440032)⟩, ⟨(-26557255), 283336616⟩, ⟨(-47046398), 38681910⟩, ⟨(-12282347), 7584979⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨740667110, 740667111⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4367242041, 4367242043⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3024
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨592533688, 888800533⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4338526508, 4405813884⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3025
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (40286023 / 2147483648)

theorem envelope_integral : (∫ s in ((3449 / 25000) : ℝ)..(10347 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((3449 / 25000) : ℝ)..(10347 / 50000), prawitzNormalCorrection
