...
namespace FiniteNormalPanel110_13
...
def j2 : Jet := ⟨⟨2654923829, 2654923833⟩, ⟨530984764, 530984768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1641134856, 1641134862⟩, ⟨656453940, 656453948⟩, ⟨65645393, 65645395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨410, 412⟩, ⟨164, 165⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94277), (-94274)⟩, ⟨164, 165⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-36024), (-36022)⟩, ⟨(-14348), (-14345)⟩, ⟨(-1410), (-1407)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5077032, 5077035⟩, ⟨(-14348), (-14345)⟩, ⟨(-1410), (-1407)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1939966, 1939969⟩, ⟨770503, 770507⟩, ⟨74866, 74870⟩, ⟨(-435), (-431)⟩, ⟨(-22), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-141225611), (-141225607)⟩, ⟨770503, 770507⟩, ⟨74866, 74870⟩, ⟨(-435), (-431)⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-53963222), (-53963220)⟩, ⟨(-21290875), (-21290872)⟩, ⟨(-2012158), (-2012152)⟩, ⟨23051, 23057⟩, ⟨1068, 1073⟩⟩
...
def j19 : Jet := ⟨⟨1377692543, 1377692546⟩, ⟨(-21290875), (-21290872)⟩, ⟨(-2012158), (-2012152)⟩, ⟨23051, 23057⟩, ⟨1068, 1073⟩⟩
...
def j25 : Jet := ⟨⟨4506, 4508⟩, ⟨1795, 1797⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847671), (-847668)⟩, ⟨1795, 1797⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-323901), (-323899)⟩, ⟨(-128876), (-128872)⟩, ⟨(-12616), (-12611)⟩, ⟨52, 56⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35467493, 35467496⟩, ⟨(-128876), (-128872)⟩, ⟨(-12616), (-12611)⟩, ⟨52, 56⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13552359, 13552361⟩, ⟨5371698, 5371703⟩, ⟨517575, 517580⟩, ⟨(-3880), (-3874)⟩, ⟨(-186), (-181)⟩⟩
...
def j33 : Jet := ⟨⟨(-702275524), (-702275521)⟩, ⟨5371698, 5371703⟩, ⟨517575, 517580⟩, ⟨(-3880), (-3874)⟩, ⟨(-186), (-181)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-268344033), (-268344030)⟩, ⟨(-105285054), (-105285048)⟩, ⟨(-9714970), (-9714964)⟩, ⟨159726, 159732⟩, ⟨7244, 7250⟩⟩
...
def j36 : Jet := ⟨⟨4026623263, 4026623266⟩, ⟨(-105285054), (-105285048)⟩, ⟨(-9714970), (-9714964)⟩, ⟨159726, 159732⟩, ⟨7244, 7250⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨851617372, 851617376⟩, ⟨157162569, 157162575⟩, ⟨(-3875992), (-3875986)⟩, ⟨(-234515), (-234508)⟩, ⟨3509, 3515⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4581194428, 4581194433⟩, ⟨119785547, 119785556⟩, ⟨14185027, 14185037⟩, ⟨478170, 478183⟩, ⟨33724, 33736⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨908371237, 908371244⟩, ⟨191387659, 191387669⟩, ⟨3061570, 3061581⟩, ⟨255629, 255643⟩, ⟨8582, 8597⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-845088503), (-845088502)⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3449878793, 3449878794⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨192117482, 192117486⟩, ⟨80955700, 80955708⟩, ⟨9823430, 9823440⟩, ⟨380980, 380990⟩, ⟨28594, 28605⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4487084778, 4487084782⟩, ⟨80955700, 80955708⟩, ⟨9823430, 9823440⟩, ⟨380980, 380990⟩, ⟨28594, 28605⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4389975213, 4389975216⟩, ⟨39601827, 39601832⟩, ⟨4626791, 4626798⟩, ⟨144628, 144635⟩, ⟨10243, 10251⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3526192714, 3526192719⟩, ⟨(-140946829), (-140946822)⟩, ⟨2157980, 2157988⟩, ⟨(-65907), (-65898)⟩, ⟨2535, 2543⟩⟩
...
def j47 : Jet := ⟨⟨6000210916, 6000210926⟩, ⟨1200042180, 1200042188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8382492474, 8382492503⟩, ⟨3352996980, 3352997010⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8382492474, 8382492503⟩, ⟨3352996980, 3352997010⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8382492503), (-8382492474)⟩, ⟨(-3352997010), (-3352996980)⟩, ⟨(-335299702), (-335299697)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4191246252), (-4191246237)⟩, ⟨(-1676498505), (-1676498490)⟩, ⟨(-167649851), (-167649848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1618651469, 1618651482⟩, ⟨(-631824786), (-631824774)⟩, ⟨60130832, 60130838⟩, ⟨8617946, 8617949⟩, ⟨(-2014558), (-2014556)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1328922113, 1328922127⟩, ⟨(-571850631), (-571850616)⟩, ⟨70915465, 70915478⟩, ⟨4759786, 4759798⟩, ⟨(-1895916), (-1895905)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨676070802, 1014106204⟩, ⟨169017700, 169017701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2123939064, 3185908601⟩, ⟨530984764, 530984768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1050326309, 2363234203⟩, ⟨525163152, 787744738⟩, ⟨65645393, 65645395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨262, 593⟩, ⟨131, 198⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94425), (-94093)⟩, ⟨131, 198⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-51956), (-23010)⟩, ⟨(-17287), (-11396)⟩, ⟨(-1425), (-1391)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5061100, 5090047⟩, ⟨(-17287), (-11396)⟩, ⟨(-1425), (-1391)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1237682, 2800714⟩, ⟨609329, 930786⟩, ⟨73399, 76065⟩, ⟨(-527), (-339)⟩, ⟨(-22), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141927895), (-140364862)⟩, ⟨609329, 930786⟩, ⟨73399, 76065⟩, ⟨(-527), (-339)⟩, ⟨(-22), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-78093460), (-34325967)⟩, ⟨(-25882144), (-16650833)⟩, ⟨(-2076809), (-1932801)⟩, ⟨17997, 28097⟩, ⟨1011, 1118⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1353562305, 1397329799⟩, ⟨(-25882144), (-16650833)⟩, ⟨(-2076809), (-1932801)⟩, ⟨17997, 28097⟩, ⟨1011, 1118⟩⟩
...
def j72 : Jet := ⟨⟨2879, 6499⟩, ⟨1427, 2164⟩, ⟨173, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849298), (-845677)⟩, ⟨1427, 2164⟩, ⟨173, 180⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-467313), (-206808)⟩, ⟨(-155423), (-102213)⟩, ⟨(-12765), (-12428)⟩, ⟨40, 68⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35324081, 35584587⟩, ⟨(-155423), (-102213)⟩, ⟨(-12765), (-12428)⟩, ⟨40, 68⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8638438, 19579827⟩, ⟨4233700, 6501613⟩, ⟨504371, 528349⟩, ⟨(-4709), (-3043)⟩, ⟨(-192), (-174)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707189445), (-696248055)⟩, ⟨4233700, 6501613⟩, ⟨504371, 528349⟩, ⟨(-4709), (-3043)⟩, ⟨(-192), (-174)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-389119211), (-170266174)⟩, ⟨(-128671062), (-81555681)⟩, ⟨(-10167855), (-9158450)⟩, ⟨123787, 195535⟩, ⟨6738, 7662⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3905848085, 4124701122⟩, ⟨(-128671062), (-81555681)⟩, ⟨(-10167855), (-9158450)⟩, ⟨123787, 195535⟩, ⟨6738, 7662⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨669361058, 1036507317⟩, ⟨148141479, 164517082⟩, ⟨(-4740328), (-3014339)⟩, ⟨(-247856), (-218109)⟩, ⟨2723, 4304⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4472261996, 4722852419⟩, ⟨88427830, 155585785⟩, ⟨11678610, 17420206⟩, ⟨203367, 837168⟩, ⟨13801, 62413⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨696992040, 1139769119⟩, ⟨168037984, 218454681⟩, ⟨(-342457), 7024916⟩, ⟨(-9758), 580137⟩, ⟨(-16207), 39178⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1014106204), (-676070802)⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3280861092, 3618896494⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨113108638, 302464153⟩, ⟨54538778, 115944026⟩, ⟨6392625, 14839699⟩, ⟨(-40018), 1022522⟩, ⟨(-10157), 91301⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4408075934, 4597431449⟩, ⟨54538778, 115944026⟩, ⟨6392625, 14839699⟩, ⟨(-40018), 1022522⟩, ⟨(-10157), 91301⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4351154096, 4443626641⟩, ⟨26357104, 57223416⟩, ⟨2720929, 7244208⟩, ⟨(-115023), 488178⟩, ⟨(-17465), 45724⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3323781345, 3744155372⟩, ⟨(-154734022), (-123012912)⟩, ⟨(-173409), 5066681⟩, ⟨(-381996), 304259⟩, ⟨(-33928), 43054⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4800168736, 7200253114⟩, ⟨1200042180, 1200042188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5364795190, 12070789213⟩, ⟨2682397586, 4023596414⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5364795190, 12070789213⟩, ⟨2682397586, 4023596414⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12070789213), (-5364795190)⟩, ⟨(-4023596414), (-2682397586)⟩, ⟨(-335299702), (-335299697)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6035394607), (-2682397595)⟩, ⟨(-2011798207), (-1341198793)⟩, ⟨(-167649851), (-167649848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1053606592, 2299978064⟩, ⟨(-1077328750), (-329012025)⟩, ⟨(-38406746), 211188347⟩, ⟨(-24412348), 34031663⟩, ⟨(-8106944), 3608322⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨815363120, 2005015320⟩, ⟨(-1022026662), (-284791748)⟩, ⟨(-24150810), 225630276⟩, ⟨(-30365473), 31257346⟩, ⟨(-8433111), 4393080⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4389975213, 4389975216⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2220
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4351154096, 4443626641⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2221
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (26630609 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((15741 / 100000) : ℝ)..(47223 / 200000), prawitzNormalCorrection
