...
namespace FiniteNormalPanel54_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (721 / 2500)
def radius : Rat := (103 / 2500)

def j0 : Jet := ⟨⟨1238668568, 1238668569⟩, ⟨176952652, 176952653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3891392073, 3891392077⟩, ⟨555913151, 555913155⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3525738666, 3525738674⟩, ⟨1007353900, 1007353910⟩, ⟨71953849, 71953851⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨882, 884⟩, ⟨252, 253⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93805), (-93802)⟩, ⟨252, 253⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-77005), (-77002)⟩, ⟨(-21796), (-21792)⟩, ⟨(-1499), (-1495)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5036051, 5036055⟩, ⟨(-21796), (-21792)⟩, ⟨(-1499), (-1495)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4134094, 4134098⟩, ⟨1163276, 1163282⟩, ⟨78025, 78032⟩, ⟨(-712), (-706)⟩, ⟨(-25), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-139031483), (-139031478)⟩, ⟨1163276, 1163282⟩, ⟨78025, 78032⟩, ⟨(-712), (-706)⟩, ⟨(-25), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-114130946), (-114130940)⟩, ⟨(-31653909), (-31653901)⟩, ⟨(-1992315), (-1992305)⟩, ⟨37203, 37212⟩, ⟨1119, 1126⟩⟩
...
def j19 : Jet := ⟨⟨1317524819, 1317524826⟩, ⟨(-31653909), (-31653901)⟩, ⟨(-1992315), (-1992305)⟩, ⟨37203, 37212⟩, ⟨1119, 1126⟩⟩
...
def j25 : Jet := ⟨⟨9642, 9645⟩, ⟨2732, 2736⟩, ⟨187, 192⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842535), (-842531)⟩, ⟨2732, 2736⟩, ⟨187, 192⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-691637), (-691633)⟩, ⟨(-195369), (-195363)⟩, ⟨(-13323), (-13314)⟩, ⟨86, 92⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35099757, 35099762⟩, ⟨(-195369), (-195363)⟩, ⟨(-13323), (-13314)⟩, ⟨86, 92⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨28813390, 28813395⟩, ⟨8072018, 8072026⟩, ⟨531268, 531280⟩, ⟨(-6329), (-6318)⟩, ⟨(-204), (-197)⟩⟩
...
def j33 : Jet := ⟨⟨(-687014493), (-687014487)⟩, ⟨8072018, 8072026⟩, ⟨531268, 531280⟩, ⟨(-6329), (-6318)⟩, ⟨(-204), (-197)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-563970201), (-563970194)⟩, ⟨(-154508025), (-154508013)⟩, ⟨(-9180246), (-9180230)⟩, ⟨254640, 254654⟩, ⟨7247, 7259⟩⟩
...
def j36 : Jet := ⟨⟨3730997095, 3730997102⟩, ⟨(-154508025), (-154508013)⟩, ⟨(-9180246), (-9180230)⟩, ⟨254640, 254654⟩, ⟨7247, 7259⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1193724022, 1193724030⟩, ⟨141852442, 141852453⟩, ⟨(-5902188), (-5902176)⟩, ⟨(-224166), (-224155)⟩, ⟨5828, 5838⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4944186116, 4944186127⟩, ⟨204748582, 204748601⟩, ⟨20644362, 20644388⟩, ⟨1021254, 1021279⟩, ⟨69491, 69514⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1374165000, 1374165013⟩, ⟨220201484, 220201504⟩, ⟨5705802, 5705828⟩, ⟨426256, 426281⟩, ⟨20694, 20719⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1238668569), (-1238668568)⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3056298727, 3056298728⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨439660960, 439660969⟩, ⟨140905926, 140905942⟩, ⟨14940769, 14940790⟩, ⟨857826, 857848⟩, ⟨64526, 64551⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4734628256, 4734628265⟩, ⟨140905926, 140905942⟩, ⟨14940769, 14940790⟩, ⟨857826, 857848⟩, ⟨64526, 64551⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4509442705, 4509442711⟩, ⟨67102121, 67102130⟩, ⟨6615830, 6615841⟩, ⟨310066, 310079⟩, ⟨21260, 21275⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3208919428, 3208919434⟩, ⟨(-138039172), (-138039162)⟩, ⟨1943216, 1943226⟩, ⟨(-51931), (-51919)⟩, ⟨2352, 2366⟩⟩
...
def j47 : Jet := ⟨⟨8846482041, 8846482051⟩, ⟨1263783144, 1263783153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨18221383099, 18221383142⟩, ⟨5206109436, 5206109482⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨18221383099, 18221383142⟩, ⟨5206109436, 5206109482⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-18221383142), (-18221383099)⟩, ⟨(-5206109482), (-5206109436)⟩, ⟨(-371864964), (-371864958)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9110691571), (-9110691549)⟩, ⟨(-2603054741), (-2603054718)⟩, ⟨(-185932482), (-185932479)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨514888836, 514888851⟩, ⟨(-312059155), (-312059143)⟩, ⟨72275043, 72275050⟩, ⟨(-5595080), (-5595077)⟩, ⟨(-716669), (-716667)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨384691355, 384691368⟩, ⟨(-249698647), (-249698633)⟩, ⟨64261655, 64261665⟩, ⟨(-6650596), (-6650589)⟩, ⟨(-318872), (-318862)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1061715915, 1415621221⟩, ⟨176952652, 176952653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3335478918, 4447305229⟩, ⟨555913151, 555913155⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2590338609, 4605046427⟩, ⟨863446198, 1151261610⟩, ⟨71953849, 71953851⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨648, 1154⟩, ⟨216, 289⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94039), (-93532)⟩, ⟨216, 289⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-100829), (-56410)⟩, ⟨(-25078), (-18493)⟩, ⟨(-1523), (-1467)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5012227, 5056647⟩, ⟨(-25078), (-18493)⟩, ⟨(-1523), (-1467)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3022925, 5421717⟩, ⟨980752, 1344277⟩, ⟨75614, 80114⟩, ⟨(-827), (-591)⟩, ⟨(-25), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140142652), (-137743859)⟩, ⟨980752, 1344277⟩, ⟨75614, 80114⟩, ⟨(-827), (-591)⟩, ⟨(-25), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-150260381), (-83074727)⟩, ⟨(-36973595), (-26250246)⟩, ⟨(-2105049), (-1861400)⟩, ⟨30744, 43640⟩, ⟨1017, 1214⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1281395384, 1348581039⟩, ⟨(-36973595), (-26250246)⟩, ⟨(-2105049), (-1861400)⟩, ⟨30744, 43640⟩, ⟨1017, 1214⟩⟩
...
def j70 : Jet := ⟨⟨(-116), (-64)⟩, ⟨(-29), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11719, 11772⟩, ⟨(-29), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7067, 12622⟩, ⟨2323, 3144⟩, ⟨185, 194⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845110), (-839554)⟩, ⟨2323, 3144⟩, ⟨185, 194⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-906124), (-506343)⟩, ⟨(-225130), (-165410)⟩, ⟨(-13581), (-13013)⟩, ⟨72, 106⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34885270, 35285052⟩, ⟨(-225130), (-165410)⟩, ⟨(-13581), (-13013)⟩, ⟨72, 106⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21039662, 37832489⟩, ⟨6771836, 9358363⟩, ⟨509527, 550032⟩, ⟨(-7370), (-5273)⟩, ⟨(-214), (-184)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694788221), (-677995393)⟩, ⟨6771836, 9358363⟩, ⟨509527, 550032⟩, ⟨(-7370), (-5273)⟩, ⟨(-214), (-184)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-744949099), (-408905940)⟩, ⟨(-182153113), (-126267980)⟩, ⟨(-9971143), (-8260255)⟩, ⟨207978, 301038⟩, ⟨6330, 8045⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3550018197, 3886061356⟩, ⟨(-182153113), (-126267980)⟩, ⟨(-9971143), (-8260255)⟩, ⟨207978, 301038⟩, ⟨6330, 8045⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨995133837, 1396413778⟩, ⟨127570629, 154165738⟩, ⟨(-6965340), (-4843230)⟩, ⟨(-248590), (-195739)⟩, ⟨4768, 6907⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4746899851, 5196239301⟩, ⟨154238803, 266621497⟩, ⟨15101671, 28275457⟩, ⟨416009, 1921607⟩, ⟨14204, 160519⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1099845548, 1689442470⟩, ⟨176730856, 273202547⟩, ⟨(-346698), 13410537⟩, ⟨(-188205), 1249441⟩, ⟨(-40372), 105465⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1415621221), (-1061715915)⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2879346075, 3233251381⟩, ⟨(-176952653), (-176952652)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨281645969, 664548916⟩, ⟨90513678, 214930618⟩, ⟨6999432, 27928572⟩, ⟨(-192172), 2689034⟩, ⟨(-56789), 283799⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4576613265, 4959516212⟩, ⟨90513678, 214930618⟩, ⟨6999432, 27928572⟩, ⟨(-192172), 2689034⟩, ⟨(-56789), 283799⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4433554364, 4615296300⟩, ⟨42115745, 104106086⟩, ⟨2082667, 13327746⟩, ⟨(-406038), 1282706⟩, ⟨(-77660), 146510⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2972254845, 3474395056⟩, ⟨(-161915813), (-104291377)⟩, ⟨(-2892952), 8297960⟩, ⟨(-854770), 879817⟩, ⟨(-111311), 127022⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7582698889, 10110265196⟩, ⟨1263783144, 1263783153⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13387138592, 23799357548⟩, ⟨4462379516, 5949839404⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13387138592, 23799357548⟩, ⟨4462379516, 5949839404⟩, ⟨371864958, 371864964⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23799357548), (-13387138592)⟩, ⟨(-5949839404), (-4462379516)⟩, ⟨(-371864964), (-371864958)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11899678774), (-6693569296)⟩, ⟨(-2974919702), (-2231189758)⟩, ⟨(-185932482), (-185932479)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨268967174, 903911245⟩, ⟨(-626096356), (-139725581)⟩, ⟨(-2838048), 205189796⟩, ⟨(-43342521), 18724727⟩, ⟨(-7683846), 7566757⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨186133893, 731215059⟩, ⟨(-540554433), (-103225696)⟩, ⟨488175, 191336950⟩, ⟨(-44186712), 15861163⟩, ⟨(-7211609), 8302833⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1238668568, 1238668569⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4509442705, 4509442711⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1068
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1061715915, 1415621221⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4433554364, 4615296300⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1069
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (16800227 / 2147483648)

theorem envelope_integral : (∫ s in ((309 / 1250) : ℝ)..(206 / 625),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((309 / 1250) : ℝ)..(206 / 625), prawitzNormalCorrection
