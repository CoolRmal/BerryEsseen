...
namespace FiniteNormalPanel6_17
...
def j2 : Jet := ⟨⟨727527723, 727527728⟩, ⟨727527723, 727527728⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨123236465, 123236467⟩, ⟨246472930, 246472934⟩, ⟨123236465, 123236467⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨30, 31⟩, ⟨61, 62⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94657), (-94655)⟩, ⟨61, 62⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2717), (-2715)⟩, ⟨(-5432), (-5429)⟩, ⟨(-2714), (-2710)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110339, 5110342⟩, ⟨(-5432), (-5429)⟩, ⟨(-2714), (-2710)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨146632, 146633⟩, ⟨293108, 293110⟩, ⟨146242, 146245⟩, ⟨(-312), (-309)⟩, ⟨(-78), (-75)⟩⟩
...
def j16 : Jet := ⟨⟨(-143018945), (-143018943)⟩, ⟨293108, 293110⟩, ⟨146242, 146245⟩, ⟨(-312), (-309)⟩, ⟨(-78), (-75)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-4103675), (-4103674)⟩, ⟨(-8198940), (-8198938)⟩, ⟨(-4082659), (-4082656)⟩, ⟨16793, 16796⟩, ⟨4175, 4178⟩⟩
...
def j19 : Jet := ⟨⟨1427552090, 1427552092⟩, ⟨(-8198940), (-8198938)⟩, ⟨(-4082659), (-4082656)⟩, ⟨16793, 16796⟩, ⟨4175, 4178⟩⟩
...
def j25 : Jet := ⟨⟨339, 340⟩, ⟨677, 680⟩, ⟨337, 340⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851838), (-851836)⟩, ⟨677, 680⟩, ⟨337, 340⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-24442), (-24441)⟩, ⟨(-48865), (-48863)⟩, ⟨(-24395), (-24391)⟩, ⟨37, 40⟩, ⟨7, 10⟩⟩
...
def j30 : Jet := ⟨⟨35766952, 35766954⟩, ⟨(-48865), (-48863)⟩, ⟨(-24395), (-24391)⟩, ⟨37, 40⟩, ⟨7, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨1026269, 1026270⟩, ⟨2051135, 2051137⟩, ⟨1022764, 1022767⟩, ⟨(-2802), (-2799)⟩, ⟨(-698), (-695)⟩⟩
...
def j33 : Jet := ⟨⟨(-714801614), (-714801612)⟩, ⟨2051135, 2051137⟩, ⟨1022764, 1022767⟩, ⟨(-2802), (-2799)⟩, ⟨(-698), (-695)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-20509965), (-20509963)⟩, ⟨(-40961076), (-40961073)⟩, ⟨(-20362912), (-20362908)⟩, ⟨117464, 117467⟩, ⟨29164, 29168⟩⟩
...
def j36 : Jet := ⟨⟨4274457331, 4274457333⟩, ⟨(-40961076), (-40961073)⟩, ⟨(-20362912), (-20362908)⟩, ⟨117464, 117467⟩, ⟨29164, 29168⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨241814116, 241814119⟩, ⟨240425291, 240425295⟩, ⟨(-2080390), (-2080388)⟩, ⟨(-688721), (-688718)⟩, ⟨3551, 3554⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4315575671, 4315575674⟩, ⟨41355098, 41355104⟩, ⟨20955084, 20955091⟩, ⟨279219, 279226⟩, ⟨71915, 71924⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨242974403, 242974407⟩, ⟨243907277, 243907284⟩, ⟨1404425, 1404431⟩, ⟨476693, 476700⟩, ⟨6463, 6472⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-231579268), (-231579267)⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4063388028, 4063388029⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨13745520, 13745521⟩, ⟨27596588, 27596592⟩, ⟨14010171, 14010177⟩, ⟨213446, 213450⟩, ⟨55329, 55338⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4308712816, 4308712817⟩, ⟨27596588, 27596592⟩, ⟨14010171, 14010177⟩, ⟨213446, 213450⟩, ⟨55329, 55338⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4301834565, 4301834567⟩, ⟨13776266, 13776269⟩, ⟨6971844, 6971848⟩, ⟨84225, 84229⟩, ⟨21699, 21706⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4069885022, 4069885026⟩, ⟨(-218916077), (-218916071)⟩, ⟨5853130, 5853136⟩, ⟨(-296231), (-296225)⟩, ⟨15987, 15995⟩⟩
...
def j47 : Jet := ⟨⟨893279553, 893279558⟩, ⟨893279553, 893279558⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨185786830, 185786833⟩, ⟨371573660, 371573666⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨185786830, 185786833⟩, ⟨371573660, 371573666⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-185786833), (-185786830)⟩, ⟨(-371573666), (-371573660)⟩, ⟨(-185786833), (-185786830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-92893417), (-92893415)⟩, ⟨(-185786833), (-185786830)⟩, ⟨(-92893417), (-92893415)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4203071245, 4203071248⟩, ⟨(-181811698), (-181811694)⟩, ⟨(-86973548), (-86973544)⟩, ⟨3875602, 3875603⟩, ⟨898639, 898640⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3982804880, 3982804887⟩, ⟨(-386515768), (-386515756)⟩, ⟨(-67420704), (-67420692)⟩, ⟨7567905, 7567917⟩, ⟨563659, 563673⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 463158536⟩, ⟨231579267, 231579268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1455055455⟩, ⟨727527723, 727527728⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 492945867⟩, ⟨0, 492945868⟩, ⟨123236465, 123236467⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 124⟩, ⟨0, 124⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94562)⟩, ⟨0, 124⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-10868), 0⟩, ⟨(-10868), 15⟩, ⟨(-2717), (-2694)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5102188, 5113057⟩, ⟨(-10868), 15⟩, ⟨(-2717), (-2694)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 586841⟩, ⟨(-1248), 586843⟩, ⟨144838, 146713⟩, ⟨(-624), 2⟩, ⟨(-78), (-75)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142578735)⟩, ⟨(-1248), 586843⟩, ⟨144838, 146713⟩, ⟨(-624), 2⟩, ⟨(-78), (-75)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-16431529), 0⟩, ⟨(-16431673), 67354⟩, ⟨(-4108027), (-4006850)⟩, ⟨(-108), 33679⟩, ⟨4074, 4211⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1415224236, 1431655766⟩, ⟨(-16431673), 67354⟩, ⟨(-4108027), (-4006850)⟩, ⟨(-108), 33679⟩, ⟨4074, 4211⟩⟩
...
def j70 : Jet := ⟨⟨(-13), 0⟩, ⟨(-13), 0⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11822, 11836⟩, ⟨(-13), 0⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 1359⟩, ⟨(-2), 1359⟩, ⟨336, 340⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-850817)⟩, ⟨(-2), 1359⟩, ⟨336, 340⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-97807), 0⟩, ⟨(-97808), 156⟩, ⟨(-24453), (-24216)⟩, ⟨(-2), 79⟩, ⟨7, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35693587, 35791395⟩, ⟨(-97808), 156⟩, ⟨(-24453), (-24216)⟩, ⟨(-2), 79⟩, ⟨7, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 4107883⟩, ⟨(-11226), 4107901⟩, ⟨1010131, 1026989⟩, ⟨(-5615), 15⟩, ⟨(-703), (-682)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-711719999)⟩, ⟨(-11226), 4107901⟩, ⟨1010131, 1026989⟩, ⟨(-5615), 15⟩, ⟨(-703), (-682)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-82157645), 0⟩, ⟨(-82158934), 471476⟩, ⟨(-20540701), (-19832195)⟩, ⟨(-968), 235742⟩, ⟨28257, 29470⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4212809651, 4294967296⟩, ⟨(-82158934), 471476⟩, ⟨(-20540701), (-19832195)⟩, ⟨(-968), 235742⟩, ⟨28257, 29470⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 485018486⟩, ⟨234159144, 242532062⟩, ⟨(-4175098), 11410⟩, ⟨(-695899), (-667313)⟩, ⟨(-19), 7132⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4378727169⟩, ⟨(-490045), 85394687⟩, ⟨19822820, 23015060⟩, ⟨(-249994), 866216⟩, ⟨52016, 100330⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 494477252⟩, ⟨234103804, 256905271⟩, ⟨(-4284194), 7432803⟩, ⟨260013, 730620⟩, ⟨(-50347), 67659⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-463158536), 0⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3831808760, 4294967296⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 56928898⟩, ⟨0, 59154730⟩, ⟨11773714, 17078367⟩, ⟨(-512522), 1057426⟩, ⟨9335, 115850⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4351896194⟩, ⟨0, 59154730⟩, ⟨11773714, 17078367⟩, ⟨(-512522), 1057426⟩, ⟨9335, 115850⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4323338043⟩, ⟨0, 29577365⟩, ⟨5747051, 8539184⟩, ⟨(-315067), 528713⟩, ⟨(-7463), 56250⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3831808760, 4323338043⟩, ⟨(-233108984), (-202001902)⟩, ⟨3532528, 8539184⟩, ⟨(-775490), 218840⟩, ⟨(-35971), 73239⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1786559115⟩, ⟨893279553, 893279558⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 743147329⟩, ⟨0, 743147330⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 743147329⟩, ⟨0, 743147330⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-743147329), 0⟩, ⟨(-743147330), 0⟩, ⟨(-185786833), (-185786830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-371573665), 0⟩, ⟨(-371573665), 0⟩, ⟨(-92893417), (-92893415)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3939013082, 4294967296⟩, ⟨(-371573665), 0⟩, ⟨(-92893417), (-69121569)⟩, ⟨0, 8036557⟩, ⟨573677, 1004570⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3514239758, 4323338043⟩, ⟨(-607137109), (-185260580)⟩, ⟨(-90267270), (-32961357)⟩, ⟨1736694, 13350267⟩, ⟨(-163965), 1094685⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4301834565, 4301834567⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified128
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4323338043⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified129
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (427095839 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(8627 / 80000), prawitzNormalCorrection
