...
namespace FiniteNormalPanel47_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (254877 / 800000)
def radius : Rat := (36411 / 800000)

def j0 : Jet := ⟨⟨1368360474, 1368360475⟩, ⟨195480067, 195480068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4298831212, 4298831216⟩, ⟨614118742, 614118746⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4302698604, 4302698613⟩, ⟨1229342452, 1229342464⟩, ⟨87810174, 87810177⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1076, 1078⟩, ⟨307, 308⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93611), (-93608)⟩, ⟨307, 308⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-93780), (-93776)⟩, ⟨(-26488), (-26484)⟩, ⟨(-1806), (-1801)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5019276, 5019281⟩, ⟨(-26488), (-26484)⟩, ⟨(-1806), (-1801)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5028311, 5028317⟩, ⟨1410124, 1410131⟩, ⟨93226, 93235⟩, ⟨(-1047), (-1041)⟩, ⟨(-34), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-138137266), (-138137259)⟩, ⟨1410124, 1410131⟩, ⟨93226, 93235⟩, ⟨(-1047), (-1041)⟩, ⟨(-34), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-138385926), (-138385917)⟩, ⟨(-38126174), (-38126163)⟩, ⟨(-2327193), (-2327179)⟩, ⟨54463, 54475⟩, ⟨1570, 1581⟩⟩
...
def j19 : Jet := ⟨⟨1293269839, 1293269849⟩, ⟨(-38126174), (-38126163)⟩, ⟨(-2327193), (-2327179)⟩, ⟨54463, 54475⟩, ⟨1570, 1581⟩⟩
...
def j22 : Jet := ⟨⟨(-109), (-107)⟩, ⟨(-31), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11726, 11729⟩, ⟨(-31), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11747, 11751⟩, ⟨3324, 3328⟩, ⟨226, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840430), (-840425)⟩, ⟨3324, 3328⟩, ⟨226, 230⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-841943), (-841937)⟩, ⟨(-237227), (-237219)⟩, ⟨(-16006), (-15998)⟩, ⟨128, 135⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨34949451, 34949458⟩, ⟨(-237227), (-237219)⟩, ⟨(-16006), (-15998)⟩, ⟨128, 135⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨35012362, 35012371⟩, ⟨9765877, 9765889⟩, ⟨630601, 630615⟩, ⟨(-9305), (-9292)⟩, ⟨(-291), (-282)⟩⟩
...
def j33 : Jet := ⟨⟨(-680815521), (-680815511)⟩, ⟨9765877, 9765889⟩, ⟨630601, 630615⟩, ⟨(-9305), (-9292)⟩, ⟨(-291), (-282)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-682041049), (-682041037)⟩, ⟨(-185085416), (-185085397)⟩, ⟨(-10492197), (-10492176)⟩, ⟨370836, 370856⟩, ⟨9936, 9952⟩⟩
...
def j36 : Jet := ⟨⟨3612926247, 3612926259⟩, ⟨(-185085416), (-185085397)⟩, ⟨(-10492197), (-10492176)⟩, ⟨370836, 370856⟩, ⟨9936, 9952⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1294433313, 1294433325⟩, ⟨146758570, 146758585⟩, ⟨(-7780784), (-7780766)⟩, ⟨(-278245), (-278228)⟩, ⟨9358, 9373⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5105762684, 5105762702⟩, ⟨261561417, 261561447⟩, ⟨28226913, 28226950⟩, ⟨1681525, 1681561⟩, ⟨127200, 127232⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1538793860, 1538793881⟩, ⟨253293719, 253293749⟩, ⟨8195032, 8195069⟩, ⟨666675, 666713⟩, ⟨38835, 38870⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1368360475), (-1368360474)⟩, ⟨(-195480068), (-195480067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2926606821, 2926606822⟩, ⟨(-195480068), (-195480067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨551316548, 551316564⟩, ⟨181499318, 181499344⟩, ⟨20810084, 20810117⟩, ⟨1444306, 1444340⟩, ⟨122094, 122131⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4846283844, 4846283860⟩, ⟨181499318, 181499344⟩, ⟨20810084, 20810117⟩, ⟨1444306, 1444340⟩, ⟨122094, 122131⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4562305405, 4562305414⟩, ⟨85431987, 85432000⟩, ⟨8995452, 8995469⟩, ⟨511390, 511408⟩, ⟨39024, 39044⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3108772010, 3108772019⟩, ⟨(-149433953), (-149433940)⟩, ⟨2241203, 2241217⟩, ⟨(-60955), (-60940)⟩, ⟨3314, 3330⟩⟩
...
def j47 : Jet := ⟨⟨7538696542, 7538696550⟩, ⟨1076956644, 1076956651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13232218463, 13232218492⟩, ⟨3780633828, 3780633860⟩, ⟨270045272, 270045276⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13232218463, 13232218492⟩, ⟨3780633828, 3780633860⟩, ⟨270045272, 270045276⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13232218492), (-13232218463)⟩, ⟨(-3780633860), (-3780633828)⟩, ⟨(-270045276), (-270045272)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6616109246), (-6616109231)⟩, ⟨(-1890316930), (-1890316914)⟩, ⟨(-135022638), (-135022636)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨920361235, 920361249⟩, ⟨(-405072806), (-405072795)⟩, ⟨60207297, 60207303⟩, ⟨(-343262), (-343260)⟩, ⟨(-908612), (-908611)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨666173465, 666173478⟩, ⟨(-325220691), (-325220676)⟩, ⟨58152967, 58152979⟩, ⟨(-2567680), (-2567670)⟩, ⟨(-607854), (-607843)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1172880406, 1563840543⟩, ⟨195480067, 195480068⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3684712466, 4912949962⟩, ⟨614118742, 614118746⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3161166318, 5619851251⟩, ⟨1053722102, 1404962816⟩, ⟨87810174, 87810177⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨791, 1408⟩, ⟨263, 352⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93896), (-93278)⟩, ⟨263, 352⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-122861), (-68654)⟩, ⟨(-30523), (-22423)⟩, ⟨(-1841), (-1762)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4990195, 5044403⟩, ⟨(-30523), (-22423)⟩, ⟨(-1841), (-1762)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3672865, 6600469⟩, ⟨1184349, 1633615⟩, ⟨89630, 96336⟩, ⟨(-1221), (-869)⟩, ⟨(-36), (-28)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139492712), (-136565107)⟩, ⟨1184349, 1633615⟩, ⟨89630, 96336⟩, ⟨(-1221), (-869)⟩, ⟨(-36), (-28)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-182522529), (-100514156)⟩, ⟨(-44758933), (-31367175)⟩, ⟨(-2495380), (-2131619)⟩, ⟨44604, 64275⟩, ⟨1384, 1737⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1249133236, 1331141610⟩, ⟨(-44758933), (-31367175)⟩, ⟨(-2495380), (-2131619)⟩, ⟨44604, 64275⟩, ⟨1384, 1737⟩⟩
...
def j70 : Jet := ⟨⟨(-142), (-78)⟩, ⟨(-36), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11693, 11758⟩, ⟨(-36), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8606, 15386⟩, ⟨2820, 3828⟩, ⟨223, 234⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843571), (-836790)⟩, ⟨2820, 3828⟩, ⟨223, 234⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1103791), (-615891)⟩, ⟨(-273873), (-200288)⟩, ⟨(-16392), (-15548)⟩, ⟨108, 156⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34687603, 35175504⟩, ⟨(-273873), (-200288)⟩, ⟨(-16392), (-15548)⟩, ⟨108, 156⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨25530644, 46026218⟩, ⟨8151858, 11359140⟩, ⟨598146, 658579⟩, ⟨(-10884), (-7703)⟩, ⟨(-310), (-258)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-690297239), (-669801664)⟩, ⟨8151858, 11359140⟩, ⟨598146, 658579⟩, ⟨(-10884), (-7703)⟩, ⟨(-310), (-258)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-903235703), (-492985001)⟩, ⟨(-219809026), (-149465198)⟩, ⟨(-11672847), (-9116509)⟩, ⟨299169, 442002⟩, ⟨8262, 11387⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3391731593, 3801982295⟩, ⟨(-219809026), (-149465198)⟩, ⟨(-11672847), (-9116509)⟩, ⟨299169, 442002⟩, ⟨8262, 11387⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1071648859, 1522673323⟩, ⟨127409056, 163423829⟩, ⟨(-9254315), (-6313801)⟩, ⟨(-318538), (-231266)⟩, ⟨7564, 11178⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4851875322, 5438739349⟩, ⟨190739052, 352470108⟩, ⟨19132390, 41560390⟩, ⟨577214, 3478507⟩, ⟨11300, 339824⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1210604480, 1928169122⟩, ⟨191521397, 331903911⟩, ⟨(-1286792), 21013232⟩, ⟨(-451252), 2272946⟩, ⟨(-87207), 228595⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1563840543), (-1172880406)⟩, ⟨(-195480068), (-195480067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2731126753, 3122086890⟩, ⟨(-195480068), (-195480067)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨341228024, 865626187⟩, ⟨107966670, 298007798⟩, ⟨7384953, 44515902⟩, ⟨(-604048), 5288516⟩, ⟨(-154342), 659354⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4636195320, 5160593483⟩, ⟨107966670, 298007798⟩, ⟨7384953, 44515902⟩, ⟨(-604048), 5288516⟩, ⟨(-154342), 659354⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4462320839, 4707927383⟩, ⟨49248138, 143415702⟩, ⟨1184179, 21151434⟩, ⟨(-970489), 2532020⟩, ⟨(-205785), 348348⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2837545197, 3422274805⟩, ⟨(-182959033), (-98845570)⟩, ⟨(-5774380), 13133881⟩, ⟨(-1668148), 1786674⟩, ⟨(-264831), 297392⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6461739891, 8615653201⟩, ⟨1076956644, 1076956651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9721629884, 17282897626⟩, ⟨3240543280, 4320724410⟩, ⟨270045272, 270045276⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9721629884, 17282897626⟩, ⟨3240543280, 4320724410⟩, ⟨270045272, 270045276⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17282897626), (-9721629884)⟩, ⟨(-4320724410), (-3240543280)⟩, ⟨(-270045276), (-270045272)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8641448813), (-4860814942)⟩, ⟨(-2160362205), (-1620271640)⟩, ⟨(-135022638), (-135022636)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨574330562, 1384996030⟩, ⟨(-696650958), (-216665566)⟩, ⟨(-2672263), 157151738⟩, ⟨(-21808096), 15048649⟩, ⟨(-4362584), 2784365⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨379441521, 1103579304⟩, ⟨(-614097473), (-156361695)⟩, ⟨995051, 159131689⟩, ⟨(-26739608), 13617519⟩, ⟨(-4703689), 3994647⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1368360474, 1368360475⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4562305405, 4562305414⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified924
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1172880406, 1563840543⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4462320839, 4707927383⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified925
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (31238669 / 2147483648)

theorem envelope_integral : (∫ s in ((109233 / 400000) : ℝ)..(36411 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((109233 / 400000) : ℝ)..(36411 / 100000), prawitzNormalCorrection
