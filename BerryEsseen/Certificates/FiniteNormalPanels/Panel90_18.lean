...
namespace FiniteNormalPanel90_18

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (95193 / 800000)
def radius : Rat := (31731 / 800000)

def j0 : Jet := ⟨⟨511063527, 511063528⟩, ⟨170354509, 170354510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1605553421, 1605553426⟩, ⟨535184473, 535184478⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨600191249, 600191254⟩, ⟨400127498, 400127506⟩, ⟨66687916, 66687918⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨150, 151⟩, ⟨100, 101⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94537), (-94535)⟩, ⟨100, 101⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-13211), (-13210)⟩, ⟨(-8795), (-8792)⟩, ⟨(-1457), (-1454)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5099845, 5099847⟩, ⟨(-8795), (-8792)⟩, ⟨(-1457), (-1454)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨712667, 712668⟩, ⟨473881, 473884⟩, ⟨78161, 78164⟩, ⟨(-273), (-270)⟩, ⟨(-23), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-142452910), (-142452908)⟩, ⟨473881, 473884⟩, ⟨78161, 78164⟩, ⟨(-273), (-270)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-19906786), (-19906784)⟩, ⟨(-13204970), (-13204967)⟩, ⟨(-2156797), (-2156793)⟩, ⟨14599, 14603⟩, ⟨1183, 1187⟩⟩
...
def j19 : Jet := ⟨⟨1411748979, 1411748982⟩, ⟨(-13204970), (-13204967)⟩, ⟨(-2156797), (-2156793)⟩, ⟨14599, 14603⟩, ⟨1183, 1187⟩⟩
...
def j22 : Jet := ⟨⟨(-16), (-14)⟩, ⟨(-11), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11819, 11822⟩, ⟨(-11), (-9)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1651, 1653⟩, ⟨1099, 1101⟩, ⟨180, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850526), (-850523)⟩, ⟨1099, 1101⟩, ⟨180, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-118855), (-118854)⟩, ⟨(-79084), (-79082)⟩, ⟨(-13080), (-13077)⟩, ⟨32, 36⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35672539, 35672541⟩, ⟨(-79084), (-79082)⟩, ⟨(-13080), (-13077)⟩, ⟨32, 36⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4984984, 4984985⟩, ⟨3312271, 3312273⟩, ⟨544691, 544694⟩, ⟨(-2443), (-2439)⟩, ⟨(-202), (-198)⟩⟩
...
def j33 : Jet := ⟨⟨(-710842899), (-710842897)⟩, ⟨3312271, 3312273⟩, ⟨544691, 544694⟩, ⟨(-2443), (-2439)⟩, ⟨(-202), (-198)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-99335260), (-99335258)⟩, ⟨(-65760641), (-65760638)⟩, ⟨(-10652559), (-10652554)⟩, ⟨101831, 101835⟩, ⟨8200, 8204⟩⟩
...
def j36 : Jet := ⟨⟨4195632036, 4195632038⟩, ⟨(-65760641), (-65760638)⟩, ⟨(-10652559), (-10652554)⟩, ⟨101831, 101835⟩, ⟨8200, 8204⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨527742878, 527742882⟩, ⟨170977983, 170977988⟩, ⟨(-2451696), (-2451691)⟩, ⟨(-263296), (-263293)⟩, ⟨2261, 2264⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4396654403, 4396654406⟩, ⟨68911380, 68911385⟩, ⟨12243030, 12243038⟩, ⟨260139, 260148⟩, ⟨24890, 24899⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨540237652, 540237657⟩, ⟨183493502, 183493509⟩, ⟨1737902, 1737912⟩, ⟨210478, 210487⟩, ⟨4513, 4523⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-511063528), (-511063527)⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3783903768, 3783903769⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨67953188, 67953190⟩, ⟨46161048, 46161052⟩, ⟨8276576, 8276582⟩, ⟨201444, 201450⟩, ⟨19821, 19828⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4362920484, 4362920486⟩, ⟨46161048, 46161052⟩, ⟨8276576, 8276582⟩, ⟨201444, 201450⟩, ⟨19821, 19828⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4328810551, 4328810553⟩, ⟨22900077, 22900080⟩, ⟨4045361, 4045366⟩, ⟨78533, 78538⟩, ⟨7526, 7532⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3813719971, 3813719975⟩, ⟨(-151521693), (-151521688)⟩, ⟨2655694, 2655701⟩, ⟨(-91267), (-91261)⟩, ⟨3514, 3522⟩⟩
...
def j47 : Jet := ⟨⟨3654007115, 3654007124⟩, ⟨1218002371, 1218002380⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3108700736, 3108700752⟩, ⟨2072467156, 2072467178⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3108700736, 3108700752⟩, ⟨2072467156, 2072467178⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3108700752), (-3108700736)⟩, ⟨(-2072467178), (-2072467156)⟩, ⟨(-345411198), (-345411192)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1554350376), (-1554350368)⟩, ⟨(-1036233589), (-1036233578)⟩, ⟨(-172705599), (-172705596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2990807869, 2990807881⟩, ⟨(-721583047), (-721583035)⟩, ⟨(-33216780), (-33216774)⟩, ⟨22015161, 22015163⟩, ⟨(-660041), (-660039)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2655690465, 2655690480⟩, ⟨(-746242693), (-746242675)⟩, ⟨(-2188922), (-2188909)⟩, ⟨20210501, 20210513⟩, ⟨(-1365516), (-1365503)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨340709018, 681418037⟩, ⟨170354509, 170354510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1070368947, 2140737900⟩, ⟨535184473, 535184478⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨266751666, 1067006671⟩, ⟨266751666, 533503340⟩, ⟨66687916, 66687918⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨66, 268⟩, ⟨66, 134⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94621), (-94418)⟩, ⟨66, 134⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-23507), (-5864)⟩, ⟨(-11750), (-5830)⟩, ⟨(-1466), (-1444)⟩, ⟨1, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5089549, 5107193⟩, ⟨(-11750), (-5830)⟩, ⟨(-1466), (-1444)⟩, ⟨1, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨316101, 1268790⟩, ⟨313181, 634033⟩, ⟨77200, 78849⟩, ⟨(-366), (-177)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142849476), (-141896786)⟩, ⟨313181, 634033⟩, ⟨77200, 78849⟩, ⟨(-366), (-177)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-35488360), (-8812920)⟩, ⟨(-17724729), (-8655406)⟩, ⟨(-2193778), (-2104884)⟩, ⟨9565, 19630⟩, ⟨1146, 1214⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1396167405, 1422842846⟩, ⟨(-17724729), (-8655406)⟩, ⟨(-2193778), (-2104884)⟩, ⟨9565, 19630⟩, ⟨1146, 1214⟩⟩
...
def j72 : Jet := ⟨⟨733, 2939⟩, ⟨729, 1470⟩, ⟨180, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851444), (-849237)⟩, ⟨729, 1470⟩, ⟨180, 184⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-211526), (-52744)⟩, ⟨(-105718), (-52378)⟩, ⟨(-13165), (-12957)⟩, ⟨21, 46⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35579868, 35738651⟩, ⟨(-105718), (-52378)⟩, ⟨(-13165), (-12957)⟩, ⟨21, 46⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2209793, 8878620⟩, ⟨2183529, 4436057⟩, ⟨536045, 550857⟩, ⟨(-3277), (-1605)⟩, ⟨(-204), (-194)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713618090), (-706949262)⟩, ⟨2183529, 4436057⟩, ⟨536045, 550857⟩, ⟨(-3277), (-1605)⟩, ⟨(-204), (-194)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-177285463), (-43907177)⟩, ⟨(-88507118), (-42805119)⟩, ⟨(-10911436), (-10288914)⟩, ⟨66380, 137206⟩, ⟨7864, 8443⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4117681833, 4251060119⟩, ⟨(-88507118), (-42805119)⟩, ⟨(-10911436), (-10288914)⟩, ⟨66380, 137206⟩, ⟨7864, 8443⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨347945428, 709186683⟩, ⟨165138187, 175139618⟩, ⟨(-3302076), (-1603095)⟩, ⟨(-270978), (-252499)⟩, ⟨1476, 3053⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4339327969, 4479885728⟩, ⟨43693912, 96292476⟩, ⟨10942515, 13940991⟩, ⟨71343, 484868⟩, ⟨15195, 38374⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨351539190, 739720487⟩, ⟨170383566, 198580050⟩, ⟨(-877771), 4608893⟩, ⟨69832, 377132⟩, ⟨(-11331), 22642⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-681418037), (-340709018)⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3613549259, 3954258278⟩, ⟨(-170354510), (-170354509)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨28773164, 127401762⟩, ⟨27891480, 68402726⟩, ⟨6456845, 10769029⟩, ⟨(-69740), 556098⟩, ⟨694, 47620⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4323740460, 4422369058⟩, ⟨27891480, 68402726⟩, ⟨6456845, 10769029⟩, ⟨(-69740), 556098⟩, ⟨694, 47620⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4309329863, 4358202666⟩, ⟨13743394, 34087374⟩, ⟨3048273, 5344654⟩, ⟨(-77032), 267401⟩, ⟨(-5085), 23263⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3625633132, 4012477345⟩, ⟨(-161299727), (-139540874)⟩, ⟨1212615, 4375562⟩, ⟨(-282912), 125284⟩, ⟨(-15289), 24474⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2436004743, 4872009496⟩, ⟨1218002371, 1218002380⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1381644771, 5526579109⟩, ⟨1381644770, 2763289568⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1381644771, 5526579109⟩, ⟨1381644770, 2763289568⟩, ⟨345411192, 345411198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5526579109), (-1381644771)⟩, ⟨(-2763289568), (-1381644770)⟩, ⟨(-345411198), (-345411192)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2763289555), (-690822385)⟩, ⟨(-1381644784), (-690822385)⟩, ⟨(-172705599), (-172705596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2257065353, 3656839761⟩, ⟨(-1176366020), (-363036820)⟩, ⟨(-117849494), 98452944⟩, ⟨(-824999), 44172330⟩, ⟨(-5531895), 2435781⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1905320893, 3416320937⟩, ⟨(-1236328219), (-379791294)⟩, ⟨(-97666169), 139881964⟩, ⟨(-5907509), 45697086⟩, ⟨(-6994359), 2505186⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨511063527, 511063528⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4328810551, 4328810553⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1828
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨340709018, 681418037⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4309329863, 4358202666⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1829
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (210651153 / 4294967296)

theorem envelope_integral : (∫ s in ((31731 / 400000) : ℝ)..(31731 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (31731 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (31731 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((31731 / 400000) : ℝ)..(31731 / 200000), prawitzNormalCorrection
