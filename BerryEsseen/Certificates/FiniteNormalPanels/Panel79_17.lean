...
namespace FiniteNormalPanel79_17
...
def j2 : Jet := ⟨⟨1592144714, 1592144719⟩, ⟨530714904, 530714909⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨590208170, 590208175⟩, ⟨393472112, 393472120⟩, ⟨65578685, 65578687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨147, 148⟩, ⟨98, 99⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94540), (-94538)⟩, ⟨98, 99⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12992), (-12991)⟩, ⟨(-8649), (-8646)⟩, ⟨(-1434), (-1430)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100064, 5100066⟩, ⟨(-8649), (-8646)⟩, ⟨(-1434), (-1430)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨700843, 700844⟩, ⟨466039, 466042⟩, ⟨76880, 76884⟩, ⟨(-265), (-262)⟩, ⟨(-22), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-142464734), (-142464732)⟩, ⟨466039, 466042⟩, ⟨76880, 76884⟩, ⟨(-265), (-262)⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-19577298), (-19577296)⟩, ⟨(-12987490), (-12987488)⟩, ⟨(-2121998), (-2121993)⟩, ⟨14121, 14124⟩, ⟨1144, 1148⟩⟩
...
def j19 : Jet := ⟨⟨1412078467, 1412078470⟩, ⟨(-12987490), (-12987488)⟩, ⟨(-2121998), (-2121993)⟩, ⟨14121, 14124⟩, ⟨1144, 1148⟩⟩
...
def j25 : Jet := ⟨⟨1624, 1625⟩, ⟨1080, 1083⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850553), (-850551)⟩, ⟨1080, 1083⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-116882), (-116881)⟩, ⟨(-77774), (-77771)⟩, ⟨(-12865), (-12861)⟩, ⟨31, 34⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35674512, 35674514⟩, ⟨(-77774), (-77771)⟩, ⟨(-12865), (-12861)⟩, ⟨31, 34⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4902339, 4902340⟩, ⟨3257538, 3257540⟩, ⟨535810, 535814⟩, ⟨(-2363), (-2360)⟩, ⟨(-195), (-191)⟩⟩
...
def j33 : Jet := ⟨⟨(-710925544), (-710925542)⟩, ⟨3257538, 3257540⟩, ⟨535810, 535814⟩, ⟨(-2363), (-2360)⟩, ⟨(-195), (-191)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-97694357), (-97694355)⟩, ⟨(-64681926), (-64681923)⟩, ⟨(-10482869), (-10482866)⟩, ⟨98499, 98503⟩, ⟨7937, 7940⟩⟩
...
def j36 : Jet := ⟨⟨4197272939, 4197272941⟩, ⟨(-64681926), (-64681923)⟩, ⟨(-10482869), (-10482866)⟩, ⟨98499, 98503⟩, ⟨7937, 7940⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨523457598, 523457602⟩, ⟨169671401, 169671407⟩, ⟨(-2391447), (-2391442)⟩, ⟨(-256975), (-256971)⟩, ⟨2168, 2172⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4394935552, 4394935556⟩, ⟨67727995, 67728000⟩, ⟨12020255, 12020261⟩, ⟨251247, 251256⟩, ⟨23987, 23995⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨535641426, 535641431⟩, ⟨181875099, 181875108⟩, ⟨1693456, 1693464⟩, ⟨204808, 204817⟩, ⟨4320, 4330⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-506795404), (-506795403)⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3788171892, 3788171893⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨66801844, 66801846⟩, ⟨45364646, 45364650⟩, ⟨8124094, 8124100⟩, ⟨194506, 194512⟩, ⟨19087, 19098⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4361769140, 4361769142⟩, ⟨45364646, 45364650⟩, ⟨8124094, 8124100⟩, ⟨194506, 194512⟩, ⟨19087, 19098⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4328239342, 4328239344⟩, ⟨22507959, 22507962⟩, ⟨3972297, 3972302⟩, ⟨75847, 75853⟩, ⟨7252, 7260⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3817517919, 3817517923⟩, ⟨(-150388399), (-150388394)⟩, ⟨2618280, 2618287⟩, ⟨(-89344), (-89337)⟩, ⟨3412, 3421⟩⟩
...
def j47 : Jet := ⟨⟨3757259507, 3757259517⟩, ⟨1252419835, 1252419844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3286869964, 3286869982⟩, ⟨2191246640, 2191246664⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3286869964, 3286869982⟩, ⟨2191246640, 2191246664⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3286869982), (-3286869964)⟩, ⟨(-2191246664), (-2191246640)⟩, ⟨(-365207779), (-365207773)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1643434991), (-1643434982)⟩, ⟨(-1095623332), (-1095623320)⟩, ⟨(-182603890), (-182603886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2929412565, 2929412578⟩, ⟨(-747277581), (-747277569)⟩, ⟨(-29232998), (-29232991)⟩, ⟨23666452, 23666455⟩, ⟨(-887866), (-887864)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2603764869, 2603764884⟩, ⟨(-766780048), (-766780031)⟩, ⟨1968442, 1968458⟩, ⟨21542675, 21542689⟩, ⟨(-1617800), (-1617786)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨337863602, 675727205⟩, ⟨168931801, 168931802⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1061429809, 2122859624⟩, ⟨530714904, 530714909⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨262314742, 1049258976⟩, ⟨262314742, 524629492⟩, ⟨65578685, 65578687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨65, 263⟩, ⟨65, 132⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94622), (-94423)⟩, ⟨65, 132⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-23117), (-5766)⟩, ⟨(-11556), (-5733)⟩, ⟨(-1442), (-1419)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5089939, 5107291⟩, ⟨(-11556), (-5733)⟩, ⟨(-1442), (-1419)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨310867, 1247710⟩, ⟨308043, 623505⟩, ⟨75951, 77546⟩, ⟨(-354), (-171)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142854710), (-141917866)⟩, ⟨308043, 623505⟩, ⟨75951, 77546⟩, ⟨(-354), (-171)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-34899355), (-8667620)⟩, ⟨(-17430865), (-8515297)⟩, ⟨(-2157759), (-2071798)⟩, ⟨9254, 18984⟩, ⟨1109, 1174⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1396756410, 1422988146⟩, ⟨(-17430865), (-8515297)⟩, ⟨(-2157759), (-2071798)⟩, ⟨9254, 18984⟩, ⟨1109, 1174⟩⟩
...
def j72 : Jet := ⟨⟨721, 2891⟩, ⟨717, 1446⟩, ⟨177, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851456), (-849285)⟩, ⟨717, 1446⟩, ⟨177, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-208011), (-51870)⟩, ⟨(-103963), (-51516)⟩, ⟨(-12948), (-12745)⟩, ⟨19, 46⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35583383, 35739525⟩, ⟨(-103963), (-51516)⟩, ⟨(-12948), (-12745)⟩, ⟨19, 46⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2173251, 8731154⟩, ⟨2147852, 4362431⟩, ⟨527448, 541774⟩, ⟨(-3169), (-1552)⟩, ⟨(-197), (-187)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713654632), (-707096728)⟩, ⟨2147852, 4362431⟩, ⟨527448, 541774⟩, ⟨(-3169), (-1552)⟩, ⟨(-197), (-187)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-174345572), (-43185869)⟩, ⟨(-87041608), (-42120128)⟩, ⟨(-10733207), (-10131240)⟩, ⟨64232, 132693⟩, ⟨7616, 8168⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4120621724, 4251781427⟩, ⟨(-87041608), (-42120128)⟩, ⟨(-10733207), (-10131240)⟩, ⟨64232, 132693⟩, ⟨7616, 8168⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨345185140, 703335759⟩, ⟨163977072, 173729527⟩, ⟨(-3220384), (-1564217)⟩, ⟨(-264342), (-246621)⟩, ⟨1417, 2927⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4338591809, 4476689517⟩, ⟨42980111, 94562978⟩, ⟨10763873, 13658170⟩, ⟨69332, 467192⟩, ⟨14781, 36760⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨348691228, 733094248⟩, ⟨169096904, 196565567⟩, ⟨(-850620), 4481564⟩, ⟨70093, 364196⟩, ⟨(-10797), 21582⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-675727205), (-337863602)⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3619240091, 3957103694⟩, ⟨(-168931802), (-168931801)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨28308847, 125129516⟩, ⟨27456602, 67102298⟩, ⟨6367124, 10526004⟩, ⟨(-66480), 534540⟩, ⟨944, 45381⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4323276143, 4420096812⟩, ⟨27456602, 67102298⟩, ⟨6367124, 10526004⟩, ⟨(-66480), 534540⟩, ⟨944, 45381⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4309098472, 4357082884⟩, ⟨13532587, 33441123⟩, ⟨3009843, 5224494⟩, ⟨(-73677), 256942⟩, ⟨(-4692), 22138⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3631148009, 4014332960⟩, ⟨(-159971459), (-138677137)⟩, ⟨1220981, 4281240⟩, ⟨(-273375), 118346⟩, ⟨(-14430), 23295⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2504839671, 5009679353⟩, ⟨1252419835, 1252419844⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1460831094, 5843324406⟩, ⟨1460831094, 2921662216⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1460831094, 5843324406⟩, ⟨1460831094, 2921662216⟩, ⟨365207773, 365207779⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5843324406), (-1460831094)⟩, ⟨(-2921662216), (-1460831094)⟩, ⟨(-365207779), (-365207773)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2921662203), (-730415547)⟩, ⟨(-1460831108), (-730415547)⟩, ⟨(-182603890), (-182603886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2175354083, 3623284082⟩, ⟨(-1232374018), (-369947506)⟩, ⟨(-122589540), 117094499⟩, ⟨(-2789900), 48828870⟩, ⟨(-6641178), 2843225⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1839136855, 3386537711⟩, ⟨(-1286804137), (-383007811)⟩, ⟨(-102016122), 158956538⟩, ⟨(-8427999), 50199051⟩, ⟨(-8194265), 2976176⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4328239342, 4328239344⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1604
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4309098472, 4357082884⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1605
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (102461803 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((15733 / 200000) : ℝ)..(15733 / 100000), prawitzNormalCorrection
