...
namespace FiniteNormalPanel87_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1511 / 8000)
def radius : Rat := (1511 / 40000)

def j0 : Jet := ⟨⟨811211948, 811211949⟩, ⟨162242389, 162242390⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2548497496, 2548497500⟩, ⟨509699497, 509699501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1512197658, 1512197663⟩, ⟨604879060, 604879068⟩, ⟨60487905, 60487907⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-33205), (-33204)⟩, ⟨(-13229), (-13227)⟩, ⟨(-1303), (-1300)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5079851, 5079853⟩, ⟨(-13229), (-13227)⟩, ⟨(-1303), (-1300)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1788544, 1788545⟩, ⟨710759, 710761⟩, ⟨69218, 69223⟩, ⟨(-370), (-366)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-141377033), (-141377031)⟩, ⟨710759, 710761⟩, ⟨69218, 69223⟩, ⟨(-370), (-366)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-49776868), (-49776866)⟩, ⟨(-19660500), (-19660497)⟩, ⟨(-1866606), (-1866601)⟩, ⟨19626, 19631⟩, ⟨914, 919⟩⟩
...
def j19 : Jet := ⟨⟨1381878897, 1381878900⟩, ⟨(-19660500), (-19660497)⟩, ⟨(-1866606), (-1866601)⟩, ⟨19626, 19631⟩, ⟨914, 919⟩⟩
...
def j22 : Jet := ⟨⟨(-39), (-37)⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11796, 11799⟩, ⟨(-16), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4153, 4155⟩, ⟨1655, 1657⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848024), (-848021)⟩, ⟨1655, 1657⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-298578), (-298576)⟩, ⟨(-118849), (-118846)⟩, ⟨(-11654), (-11650)⟩, ⟨44, 48⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35492816, 35492819⟩, ⟨(-118849), (-118846)⟩, ⟨(-11654), (-11650)⟩, ⟨44, 48⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12496521, 12496524⟩, ⟨4956762, 4956766⟩, ⟨479017, 479023⟩, ⟨(-3301), (-3296)⟩, ⟨(-159), (-155)⟩⟩
...
def j33 : Jet := ⟨⟨(-703331362), (-703331358)⟩, ⟨4956762, 4956766⟩, ⟨479017, 479023⟩, ⟨(-3301), (-3296)⟩, ⟨(-159), (-155)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-247633095), (-247633092)⟩, ⟨(-97308033), (-97308028)⟩, ⟨(-9038587), (-9038581)⟩, ⟨136107, 136112⟩, ⟨6225, 6229⟩⟩
...
def j36 : Jet := ⟨⟨4047334201, 4047334204⟩, ⟨(-97308033), (-97308028)⟩, ⟨(-9038587), (-9038581)⟩, ⟨136107, 136112⟩, ⟨6225, 6229⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨819963148, 819963153⟩, ⟨152326711, 152326716⟩, ⟨(-3440769), (-3440764)⟩, ⟨(-209872), (-209867)⟩, ⟨2871, 2876⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4557751632, 4557751636⟩, ⟨109579738, 109579745⟩, ⟨12813024, 12813034⟩, ⟨399494, 399503⟩, ⟨27517, 27528⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨870131975, 870131982⟩, ⟨182566851, 182566861⟩, ⟨2681267, 2681277⟩, ⟨220198, 220210⟩, ⟨6847, 6859⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-811211949), (-811211948)⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3483755347, 3483755348⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨176282984, 176282988⟩, ⟨73973672, 73973680⟩, ⟨8846809, 8846817⟩, ⟨317166, 317176⟩, ⟨23165, 23176⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4471250280, 4471250284⟩, ⟨73973672, 73973680⟩, ⟨8846809, 8846817⟩, ⟨317166, 317176⟩, ⟨23165, 23176⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4382222464, 4382222467⟩, ⟨36250384, 36250389⟩, ⟨4185394, 4185400⟩, ⟨120802, 120809⟩, ⟨8353, 8361⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3554530195, 3554530199⟩, ⟨(-136134863), (-136134855)⟩, ⟨2025518, 2025525⟩, ⟨(-60119), (-60111)⟩, ⟨2211, 2219⟩⟩
...
def j47 : Jet := ⟨⟨6687825989, 6687825999⟩, ⟨1337565192, 1337565202⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10413820030, 10413820063⟩, ⟨4165527994, 4165528032⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10413820030, 10413820063⟩, ⟨4165527994, 4165528032⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10413820063), (-10413820030)⟩, ⟨(-4165528032), (-4165527994)⟩, ⟨(-416552804), (-416552797)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5206910032), (-5206910015)⟩, ⟨(-2082764016), (-2082763997)⟩, ⟨(-208276402), (-208276398)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1277769172, 1277769189⟩, ⟨(-619630257), (-619630242)⟩, ⟨88276017, 88276026⟩, ⟨5762603, 5762606⟩, ⟨(-2839008), (-2839006)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1057486306, 1057486323⟩, ⟨(-553308846), (-553308828)⟩, ⟨93300170, 93300184⟩, ⟨1661013, 1661024⟩, ⟨(-2481268), (-2481257)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨648969558, 973454338⟩, ⟨162242389, 162242390⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2038797995, 3058196997⟩, ⟨509699497, 509699501⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨967806499, 2177564631⟩, ⟨483903248, 725854880⟩, ⟨60487905, 60487907⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-47884), (-21213)⟩, ⟨(-15935), (-10513)⟩, ⟨(-1315), (-1285)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5065172, 5091844⟩, ⟨(-15935), (-10513)⟩, ⟨(-1315), (-1285)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1141360, 2581585⟩, ⟨562600, 858161⟩, ⟨67974, 70238⟩, ⟨(-448), (-288)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142024217), (-140583991)⟩, ⟨562600, 858161⟩, ⟨67974, 70238⟩, ⟨(-448), (-288)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-72006815), (-31678495)⟩, ⟨(-23875499), (-15404156)⟩, ⟨(-1921488), (-1799263)⟩, ⟨15353, 23893⟩, ⟨871, 955⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1359648950, 1399977271⟩, ⟨(-23875499), (-15404156)⟩, ⟨(-1921488), (-1799263)⟩, ⟨15353, 23893⟩, ⟨871, 955⟩⟩
...
def j72 : Jet := ⟨⟨2654, 5989⟩, ⟨1317, 1995⟩, ⟨159, 166⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849523), (-846187)⟩, ⟨1317, 1995⟩, ⟨159, 166⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-430712), (-190675)⟩, ⟨(-143275), (-94325)⟩, ⟨(-11782), (-11494)⟩, ⟨33, 58⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35360682, 35600720⟩, ⟨(-143275), (-94325)⟩, ⟨(-11782), (-11494)⟩, ⟨33, 58⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7967999, 18049700⟩, ⟨3911358, 5995313⟩, ⟨467811, 488164⟩, ⟨(-4003), (-2593)⟩, ⟨(-163), (-149)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707859884), (-697778182)⟩, ⟨3911358, 5995313⟩, ⟨467811, 488164⟩, ⟨(-4003), (-2593)⟩, ⟨(-163), (-149)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-358887634), (-157233853)⟩, ⟨(-118747847), (-75577279)⟩, ⟨(-9423006), (-8566398)⟩, ⟨105762, 166352⟩, ⟨5828, 6551⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3936079662, 4137733443⟩, ⟨(-118747847), (-75577279)⟩, ⟨(-9423006), (-8566398)⟩, ⟨105762, 166352⟩, ⟨5828, 6551⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨645418081, 996842582⟩, ⟨144354161, 158828161⟩, ⟨(-4201574), (-2682167)⟩, ⟨(-220744), (-196512)⟩, ⟨2234, 3517⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4458176034, 4686577930⟩, ⟨81430284, 141389680⟩, ⟨10717168, 15485301⟩, ⟨175920, 685876⟩, ⟨12294, 48978⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨669943965, 1087733648⟩, ⟨162076399, 206125856⟩, ⟨(-237291), 6038580⟩, ⟨7452, 477006⟩, ⟨(-12339), 30153⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-973454338), (-648969558)⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3321512958, 3645997738⟩, ⟨(-162242390), (-162242389)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨104500194, 275476950⟩, ⟨50562482, 104405932⟩, ⟨5995980, 12951114⟩, ⟨(-20454), 821226⟩, ⟨(-6022), 69551⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4399467490, 4570444246⟩, ⟨50562482, 104405932⟩, ⟨5995980, 12951114⟩, ⟨(-20454), 821226⟩, ⟨(-6022), 69551⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4346903379, 4430565265⟩, ⟨24507505, 51579254⟩, ⟨2606000, 6329103⟩, ⟨(-85205), 391015⟩, ⟨(-12223), 34591⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3361677727, 3761106854⟩, ⟨(-148411726), (-120418645)⟩, ⟨66943, 4447006⟩, ⟨(-311413), 233492⟩, ⟨(-25148), 32584⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5350260788, 8025391192⟩, ⟨1337565192, 1337565202⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6664844811, 14995900864⟩, ⟨3332422392, 4998633634⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6664844811, 14995900864⟩, ⟨3332422392, 4998633634⟩, ⟨416552797, 416552804⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14995900864), (-6664844811)⟩, ⟨(-4998633634), (-3332422392)⟩, ⟨(-416552804), (-416552797)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7497950432), (-3332422405)⟩, ⟨(-2499316817), (-1666211196)⟩, ⟨(-208276402), (-208276398)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨749530184, 1976947305⟩, ⟨(-1150420319), (-290776506)⟩, ⟨(-39465712), 298377820⟩, ⟨(-48476655), 44846918⟩, ⟨(-13758940), 8009262⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨586658465, 1731214593⟩, ⟨(-1075737158), (-248605923)⟩, ⟨(-26395935), 303089207⟩, ⟨(-54095925), 40739161⟩, ⟨(-13713375), 9096174⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨811211948, 811211949⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4382222464, 4382222467⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1754
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨648969558, 973454338⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4346903379, 4430565265⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1755
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (82380145 / 4294967296)

theorem envelope_integral : (∫ s in ((1511 / 10000) : ℝ)..(4533 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((1511 / 10000) : ℝ)..(4533 / 20000), prawitzNormalCorrection
