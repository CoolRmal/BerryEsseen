...
namespace FiniteNormalPanel19_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (143759 / 400000)
def radius : Rat := (20537 / 400000)

def j0 : Jet := ⟨⟨1543600508, 1543600509⟩, ⟨220514358, 220514359⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4849364015, 4849364020⟩, ⟨692766287, 692766291⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5475322564, 5475322576⟩, ⟨1564377872, 1564377886⟩, ⟨111741276, 111741278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1370, 1372⟩, ⟨391, 392⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93317), (-93314)⟩, ⟨391, 392⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-118963), (-118958)⟩, ⟨(-33492), (-33488)⟩, ⟨(-2252), (-2248)⟩, ⟨19, 22⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4994093, 4994099⟩, ⟨(-33492), (-33488)⟩, ⟨(-2252), (-2248)⟩, ⟨19, 22⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6366584, 6366592⟩, ⟨1776326, 1776336⟩, ⟨114860, 114869⟩, ⟨(-1669), (-1660)⟩, ⟨(-53), (-47)⟩⟩
...
def j16 : Jet := ⟨⟨(-136798993), (-136798984)⟩, ⟨1776326, 1776336⟩, ⟨114860, 114869⟩, ⟨(-1669), (-1660)⟩, ⟨(-53), (-47)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-174394487), (-174394474)⟩, ⟨(-47562496), (-47562478)⟩, ⟨(-2765646), (-2765628)⟩, ⟨85922, 85939⟩, ⟨2312, 2326⟩⟩
...
def j19 : Jet := ⟨⟨1257261278, 1257261292⟩, ⟨(-47562496), (-47562478)⟩, ⟨(-2765646), (-2765628)⟩, ⟨85922, 85939⟩, ⟨2312, 2326⟩⟩
...
def j22 : Jet := ⟨⟨(-138), (-136)⟩, ⟨(-40), (-38)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11697, 11700⟩, ⟨(-40), (-38)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨14911, 14916⟩, ⟨4209, 4214⟩, ⟨285, 290⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-837266), (-837260)⟩, ⟨4209, 4214⟩, ⟨285, 290⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1067366), (-1067358)⟩, ⟨(-299597), (-299586)⟩, ⟨(-19887), (-19877)⟩, ⟨206, 216⟩, ⟨3, 8⟩⟩
...
def j30 : Jet := ⟨⟨34724028, 34724037⟩, ⟨(-299597), (-299586)⟩, ⟨(-19887), (-19877)⟩, ⟨206, 216⟩, ⟨3, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨44266985, 44266997⟩, ⟨12265776, 12265795⟩, ⟨768930, 768951⟩, ⟨(-14777), (-14757)⟩, ⟨(-440), (-427)⟩⟩
...
def j33 : Jet := ⟨⟨(-671560898), (-671560885)⟩, ⟨12265776, 12265795⟩, ⟨768930, 768951⟩, ⟨(-14777), (-14757)⟩, ⟨(-440), (-427)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-856121198), (-856121179)⟩, ⟨(-228969367), (-228969333)⟩, ⟨(-12023987), (-12023949)⟩, ⟨580348, 580384⟩, ⟨14061, 14087⟩⟩
...
def j36 : Jet := ⟨⟨3438846098, 3438846117⟩, ⟨(-228969367), (-228969333)⟩, ⟨(-12023987), (-12023949)⟩, ⟨580348, 580384⟩, ⟨14061, 14087⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1419549248, 1419549267⟩, ⟨149090860, 149090886⟩, ⟨(-10794337), (-10794311)⟩, ⟨(-349080), (-349055)⟩, ⟨16468, 16489⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5364224930, 5364224961⟩, ⟨357167189, 357167248⟩, ⟨42537377, 42537448⟩, ⟨3175773, 3175843⟩, ⟨277927, 277983⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1772954469, 1772954504⟩, ⟨304256873, 304256930⟩, ⟨12975886, 12975950⟩, ⟨1192597, 1192660⟩, ⟨86727, 86783⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1543600509), (-1543600508)⟩, ⟨(-220514359), (-220514358)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2751366787, 2751366788⟩, ⟨(-220514359), (-220514358)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨731872289, 731872319⟩, ⟨251193336, 251193390⟩, ⟨32266497, 32266562⟩, ⟨2823032, 2823098⟩, ⟨279768, 279829⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5026839585, 5026839615⟩, ⟨251193336, 251193390⟩, ⟨32266497, 32266562⟩, ⟨2823032, 2823098⟩, ⟨279768, 279829⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4646516073, 4646516088⟩, ⟨116094202, 116094229⟩, ⟨13462309, 13462342⟩, ⟨968362, 968395⟩, ⟨85601, 85633⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2976569812, 2976569824⟩, ⟨(-164193517), (-164193497)⟩, ⟨2663420, 2663444⟩, ⟨(-70856), (-70831)⟩, ⟨5116, 5139⟩⟩
...
def j47 : Jet := ⟨⟨6668933928, 6668933935⟩, ⟨952704845, 952704851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10355068309, 10355068331⟩, ⟨2958590938, 2958590962⟩, ⟨211327923, 211327927⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10355068309, 10355068331⟩, ⟨2958590938, 2958590962⟩, ⟨211327923, 211327927⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10355068331), (-10355068309)⟩, ⟨(-2958590962), (-2958590938)⟩, ⟨(-211327927), (-211327923)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5177534166), (-5177534154)⟩, ⟨(-1479295481), (-1479295469)⟩, ⟨(-105663964), (-105663961)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1286538560, 1286538576⟩, ⟨(-443116460), (-443116450)⟩, ⟨44659085, 44659090⟩, ⟨2140403, 2140405⟩, ⟨(-733650), (-733649)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨891618393, 891618408⟩, ⟨(-356279402), (-356279385)⟩, ⟨48688219, 48688235⟩, ⟨(-519924), (-519908)⟩, ⟨(-553741), (-553725)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1323086150, 1764114868⟩, ⟨220514358, 220514359⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4156597728, 5542130310⟩, ⟨692766287, 692766291⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4022685967, 7151441736⟩, ⟨1340895320, 1787860440⟩, ⟨111741276, 111741278⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1006, 1792⟩, ⟨335, 448⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93681), (-92894)⟩, ⟨335, 448⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-155986), (-87004)⟩, ⟨(-38684), (-28255)⟩, ⟨(-2309), (-2182)⟩, ⟨16, 24⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4957070, 5026053⟩, ⟨(-38684), (-28255)⟩, ⟨(-2309), (-2182)⟩, ⟨16, 24⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4642814, 8368755⟩, ⟨1483192, 2065726⟩, ⟨109019, 119898⟩, ⟨(-1955), (-1376)⟩, ⟨(-57), (-44)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138522763), (-134796821)⟩, ⟨1483192, 2065726⟩, ⟨109019, 119898⟩, ⟨(-1955), (-1376)⟩, ⟨(-57), (-44)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-230650760), (-126251317)⟩, ⟨(-56273527), (-38644183)⟩, ⟨(-3038758), (-2447443)⟩, ⟨69366, 102366⟩, ⟨1927, 2650⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1201005005, 1305404449⟩, ⟨(-56273527), (-38644183)⟩, ⟨(-3038758), (-2447443)⟩, ⟨69366, 102366⟩, ⟨1927, 2650⟩⟩
...
def j70 : Jet := ⟨⟨(-180), (-100)⟩, ⟨(-45), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11655, 11736⟩, ⟨(-45), (-33)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨10916, 19542⟩, ⟨3563, 4856⟩, ⟨279, 295⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-841261), (-832634)⟩, ⟨3563, 4856⟩, ⟨279, 295⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1400763), (-779848)⟩, ⟨(-346854), (-251863)⟩, ⟨(-20514), (-19148)⟩, ⟨172, 250⟩, ⟨3, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34390631, 35011547⟩, ⟨(-346854), (-251863)⟩, ⟨(-20514), (-19148)⟩, ⟨172, 250⟩, ⟨3, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨32210421, 58296845⟩, ⟨10159269, 14338316⟩, ⟨716190, 814323⟩, ⟨(-17404), (-12113)⟩, ⟨(-479), (-379)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-683617462), (-657531037)⟩, ⟨10159269, 14338316⟩, ⟨716190, 814323⟩, ⟨(-17404), (-12113)⟩, ⟨(-479), (-379)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1138274197), (-615846569)⟩, ⟨(-275053334), (-181407820)⟩, ⟨(-13943010), (-9782347)⟩, ⟨458927, 700671⟩, ⟨10589, 17052⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3156693099, 3679120727⟩, ⟨(-275053334), (-181407820)⟩, ⟨(-13943010), (-9782347)⟩, ⟨458927, 700671⟩, ⟨10589, 17052⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1162312616, 1684464879⟩, ⟨121104660, 173158916⟩, ⟨(-12997910), (-8601793)⟩, ⟨(-423013), (-262674)⟩, ⟨13052, 19932⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5013900179, 5843692591⟩, ⟨247222302, 509180679⟩, ⟨25521252, 70178032⟩, ⟨802814, 7634954⟩, ⟨(-19366), 922476⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1356871666, 2291867262⟩, ⟨208280113, 435296550⟩, ⟨(-3807328), 38010320⟩, ⟨(-1179610), 5021970⟩, ⟨(-232255), 630497⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1764114868), (-1323086150)⟩, ⟨(-220514359), (-220514358)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2530852428, 2971881146⟩, ⟨(-220514359), (-220514358)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨428664665, 1222979172⟩, ⟨131600248, 464563218⟩, ⟨6037024, 84683371⟩, ⟨(-2030670), 13064340⟩, ⟨(-520675), 2027237⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4723631961, 5517946468⟩, ⟨131600248, 464563218⟩, ⟨6037024, 84683371⟩, ⟨(-2030670), 13064340⟩, ⟨(-520675), 2027237⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4504203013, 4868202915⟩, ⟨58052095, 221491330⟩, ⟨(-2567557), 40000669⟩, ⟨(-2935178), 6354987⟩, ⟨(-738365), 1122270⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2654146666, 3368528667⟩, ⟨(-215737932), (-77997223)⟩, ⟨(-13148528), 24697724⟩, ⟨(-4084717), 4529127⟩, ⟨(-837189), 927250⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5716229082, 7621638785⟩, ⟨952704845, 952704851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7607805290, 13524987216⟩, ⟨2535935090, 3381246816⟩, ⟨211327923, 211327927⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7607805290, 13524987216⟩, ⟨2535935090, 3381246816⟩, ⟨211327923, 211327927⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13524987216), (-7607805290)⟩, ⟨(-3381246816), (-2535935090)⟩, ⟨(-211327927), (-211327923)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6762493608), (-3803902645)⟩, ⟨(-1690623408), (-1267967545)⟩, ⟨(-105663964), (-105663961)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨889521322, 1771415321⟩, ⟨(-697280329), (-262605996)⟩, ⟨(-4816527), 115351025⟩, ⟨(-10828113), 12068214⟩, ⟨(-2606522), 1124813⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨549694535, 1389315187⟩, ⟨(-635853563), (-178435588)⟩, ⟨(-4431601), 135680423⟩, ⟨(-19980915), 13709632⟩, ⟨(-4084200), 3134985⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1543600508, 1543600509⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4646516073, 4646516088⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified386
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1323086150, 1764114868⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4504203013, 4868202915⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified387
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (93286737 / 4294967296)

theorem envelope_integral : (∫ s in ((61611 / 200000) : ℝ)..(20537 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((61611 / 200000) : ℝ)..(20537 / 50000), prawitzNormalCorrection
