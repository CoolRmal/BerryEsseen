...
namespace FiniteNormalPanel155_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (89999 / 400000)
def radius : Rat := (12857 / 400000)

def j0 : Jet := ⟨⟨966356904, 966356905⟩, ⟨138050986, 138050987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3035899750, 3035899754⟩, ⟨433699963, 433699967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2145927234, 2145927241⟩, ⟨613122064, 613122072⟩, ⟨43794433, 43794434⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨537, 538⟩, ⟨153, 154⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94150), (-94148)⟩, ⟨153, 154⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-47041), (-47039)⟩, ⟨(-13365), (-13362)⟩, ⟨(-936), (-931)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5066015, 5066018⟩, ⟨(-13365), (-13362)⟩, ⟨(-936), (-931)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2531171, 2531174⟩, ⟨716513, 716517⟩, ⟨49280, 49285⟩, ⟨(-271), (-266)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140634406), (-140634402)⟩, ⟨716513, 716517⟩, ⟨49280, 49285⟩, ⟨(-271), (-266)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-70266241), (-70266237)⟩, ⟨(-19718073), (-19718068)⟩, ⟨(-1307099), (-1307093)⟩, ⟨14204, 14211⟩, ⟨458, 463⟩⟩
...
def j19 : Jet := ⟨⟨1361389524, 1361389529⟩, ⟨(-19718073), (-19718068)⟩, ⟨(-1307099), (-1307093)⟩, ⟨14204, 14211⟩, ⟨458, 463⟩⟩
...
def j25 : Jet := ⟨⟨5886, 5888⟩, ⟨1673, 1676⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846291), (-846288)⟩, ⟨1673, 1676⟩, ⟨116, 119⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-422839), (-422837)⟩, ⟨(-119977), (-119972)⟩, ⟨(-8335), (-8329)⟩, ⟨32, 35⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35368555, 35368558⟩, ⟨(-119977), (-119972)⟩, ⟨(-8335), (-8329)⟩, ⟨32, 35⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17671460, 17671463⟩, ⟨4989042, 4989048⟩, ⟨339349, 339356⟩, ⟨(-2399), (-2393)⟩, ⟨(-82), (-78)⟩⟩
...
def j33 : Jet := ⟨⟨(-698156423), (-698156419)⟩, ⟨4989042, 4989048⟩, ⟨339349, 339356⟩, ⟨(-2399), (-2393)⟩, ⟨(-82), (-78)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-348825215), (-348825210)⟩, ⟨(-97171635), (-97171628)⟩, ⟨(-6237129), (-6237120)⟩, ⟨98115, 98122⟩, ⟨3076, 3082⟩⟩
...
def j36 : Jet := ⟨⟨3946142081, 3946142086⟩, ⟨(-97171635), (-97171628)⟩, ⟨(-6237129), (-6237120)⟩, ⟨98115, 98122⟩, ⟨3076, 3082⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨962298856, 962298861⟩, ⟨123533534, 123533541⟩, ⟨(-2915029), (-2915022)⟩, ⟨(-121950), (-121942)⟩, ⟨1757, 1764⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4674627439, 4674627445⟩, ⟨115110187, 115110198⟩, ⟨10223061, 10223075⟩, ⟨317438, 317451⟩, ⟨17458, 17473⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1047362721, 1047362729⟩, ⟨160244210, 160244223⟩, ⟨2428640, 2428654⟩, ⟨154304, 154320⟩, ⟨4745, 4760⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-966356905), (-966356904)⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3328610391, 3328610392⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨255407921, 255407926⟩, ⟨78153708, 78153716⟩, ⟨7163159, 7163171⟩, ⟨256478, 256492⟩, ⟨15201, 15212⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4550375217, 4550375222⟩, ⟨78153708, 78153716⟩, ⟨7163159, 7163171⟩, ⟨256478, 256492⟩, ⟨15201, 15212⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4420827155, 4420827159⟩, ⟨37964345, 37964350⟩, ⟨3316601, 3316608⟩, ⟨96105, 96114⟩, ⟨5313, 5321⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3426152096, 3426152101⟩, ⟨(-112673976), (-112673969)⟩, ⟨1350104, 1350112⟩, ⟨(-32124), (-32114)⟩, ⟨1027, 1035⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨51957397773, 51957397781⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value635

def j47 : Jet := ⟨⟨11690284603, 11690284618⟩, ⟨1670040654, 1670040667⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨31819277000, 31819277083⟩, ⟨9091221980, 9091222064⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨31819277000, 31819277083⟩, ⟨9091221980, 9091222064⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-31819277083), (-31819277000)⟩, ⟨(-9091222064), (-9091221980)⟩, ⟨(-649373008), (-649372997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-15909638542), (-15909638500)⟩, ⟨(-4545611032), (-4545610990)⟩, ⟨(-324686504), (-324686498)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨105736254, 105736259⟩, ⟨(-111906768), (-111906760)⟩, ⟨51225340, 51225346⟩, ⟨(-12431703), (-12431699)⟩, ⟨1353055, 1353057⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨84347205, 84347210⟩, ⟨(-92043387), (-92043378)⟩, ⟨43832122, 43832131⟩, ⟨(-11296747), (-11296740)⟩, ⟨1422444, 1422452⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨828305917, 1104407891⟩, ⟨138050986, 138050987⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2602199783, 3469599718⟩, ⟨433699963, 433699967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1576599597, 2802843741⟩, ⟨525533198, 700710940⟩, ⟨43794433, 43794434⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨394, 703⟩, ⟨131, 176⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94293), (-93983)⟩, ⟨131, 176⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-61535), (-34499)⟩, ⟨(-15336), (-11384)⟩, ⟨(-943), (-921)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5051521, 5078558⟩, ⟨(-15336), (-11384)⟩, ⟨(-943), (-921)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1854315, 3314206⟩, ⟨608096, 824374⟩, ⟨48389, 50055⟩, ⟨(-311), (-225)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141311262), (-139851370)⟩, ⟨608096, 824374⟩, ⟨48389, 50055⟩, ⟨(-311), (-225)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-92218022), (-51336738)⟩, ⟨(-22831286), (-16574269)⟩, ⟨(-1348739), (-1258859)⟩, ⟨11917, 16491⟩, ⟨435, 482⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1339437743, 1380319028⟩, ⟨(-22831286), (-16574269)⟩, ⟨(-1348739), (-1258859)⟩, ⟨11917, 16491⟩, ⟨435, 482⟩⟩
...
def j72 : Jet := ⟨⟨4318, 7699⟩, ⟨1427, 1921⟩, ⟨114, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847859), (-844477)⟩, ⟨1427, 1921⟩, ⟨114, 120⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-553303), (-309991)⟩, ⟨(-137803), (-102076)⟩, ⟨(-8431), (-8217)⟩, ⟨25, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35238091, 35481404⟩, ⟨(-137803), (-102076)⟩, ⟨(-8431), (-8217)⟩, ⟨25, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12935223, 23154736⟩, ⟨4221812, 5751214⟩, ⟨331326, 346287⟩, ⟨(-2773), (-2018)⟩, ⟨(-84), (-74)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702892660), (-692673146)⟩, ⟨4221812, 5751214⟩, ⟨331326, 346287⟩, ⟨(-2773), (-2018)⟩, ⟨(-84), (-74)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-458699254), (-254266942)⟩, ⟨(-113125070), (-81002474)⟩, ⟨(-6528972), (-5898693)⟩, ⟨81779, 114400⟩, ⟨2870, 3258⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3836268042, 4040700354⟩, ⟨(-113125070), (-81002474)⟩, ⟨(-6528972), (-5898693)⟩, ⟨81779, 114400⟩, ⟨2870, 3258⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨811527623, 1115061928⟩, ⟨116810824, 129340859⟩, ⟨(-3395024), (-2436354)⟩, ⟨(-128974), (-113795)⟩, ⟨1466, 2056⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4565234354, 4808512824⟩, ⟨91517618, 141794928⟩, ⟨8499037, 12364937⟩, ⟨167836, 508625⟩, ⟨7878, 30679⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨862594177, 1248388920⟩, ⟨141453430, 181618917⟩, ⟨293932, 4890614⟩, ⟨6380, 331546⟩, ⟨(-6423), 18339⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1104407891), (-828305917)⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3190559405, 3466661379⟩, ⟨(-138050987), (-138050986)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨173241997, 362860714⟩, ⟨56818548, 105579870⟩, ⟨4776789, 10523064⟩, ⟨21922, 606352⟩, ⟨(-3294), 44271⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4468209293, 4657828010⟩, ⟨56818548, 105579870⟩, ⟨4776789, 10523064⟩, ⟨21922, 606352⟩, ⟨(-3294), 44271⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4380731991, 4472719416⟩, ⟨27280249, 51756430⟩, ⟨1994024, 5073582⟩, ⟨(-49197), 284824⟩, ⟨(-7919), 21831⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3254270566, 3610133114⟩, ⟨(-123498980), (-99032733)⟩, ⟨(-182302), 3218262⟩, ⟨(-202788), 165803⟩, ⟨(-15547), 19203⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨10020243936, 13360325272⟩, ⟨1670040654, 1670040667⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨23377427956, 41559872072⟩, ⟨7792475976, 10389968068⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨23377427956, 41559872072⟩, ⟨7792475976, 10389968068⟩, ⟨649372997, 649373008⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-41559872072), (-23377427956)⟩, ⟨(-10389968068), (-7792475976)⟩, ⟨(-649373008), (-649372997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-20779936036), (-11688713978)⟩, ⟨(-5194984034), (-3896237988)⟩, ⟨(-324686504), (-324686498)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨34021521, 282508442⟩, ⟨(-341708504), (-30863085)⟩, ⟨(-7357849), 204085090⟩, ⟨(-80728371), 20187984⟩, ⟨(-13818709), 24689396⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨25777899, 237462363⟩, ⟨(-295346299), (-24169234)⟩, ⟨(-5484994), 181580937⟩, ⟨(-73993921), 17205984⟩, ⟨(-12218682), 23244277⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨966356904, 966356905⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4420827155, 4420827159⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar635 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3128
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar635 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨828305917, 1104407891⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4380731991, 4472719416⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3129
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((38571 / 200000) : ℝ)..(12857 / 50000), prawitzNormalCorrection
      ((146701 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
