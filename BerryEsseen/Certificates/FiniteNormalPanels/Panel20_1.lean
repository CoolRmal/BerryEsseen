...
namespace FiniteNormalPanel20_1

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (41819 / 400000)
def radius : Rat := (41819 / 400000)

def j0 : Jet := ⟨⟨449028093, 449028094⟩, ⟨449028093, 449028094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1410663358, 1410663362⟩, ⟨1410663358, 1410663362⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨463326254, 463326257⟩, ⟨926652508, 926652514⟩, ⟨463326254, 463326257⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨115, 117⟩, ⟨231, 233⟩, ⟨115, 117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94572), (-94569)⟩, ⟨231, 233⟩, ⟨115, 117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10203), (-10201)⟩, ⟨(-20381), (-20377)⟩, ⟨(-10142), (-10137)⟩, ⟨48, 52⟩, ⟨12, 13⟩⟩
...
def j13 : Jet := ⟨⟨5102853, 5102856⟩, ⟨(-20381), (-20377)⟩, ⟨(-10142), (-10137)⟩, ⟨48, 52⟩, ⟨12, 13⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨550478, 550479⟩, ⟨1098757, 1098760⟩, ⟨544985, 544990⟩, ⟨(-4383), (-4379)⟩, ⟨(-1084), (-1079)⟩⟩
...
def j16 : Jet := ⟨⟨(-142615099), (-142615097)⟩, ⟨1098757, 1098760⟩, ⟨544985, 544990⟩, ⟨(-4383), (-4379)⟩, ⟨(-1084), (-1079)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15384825), (-15384824)⟩, ⟨(-30651120), (-30651118)⟩, ⟨(-15088974), (-15088971)⟩, ⟨235639, 235643⟩, ⟨57728, 57732⟩⟩
...
def j19 : Jet := ⟨⟨1416270940, 1416270942⟩, ⟨(-30651120), (-30651118)⟩, ⟨(-15088974), (-15088971)⟩, ⟨235639, 235643⟩, ⟨57728, 57732⟩⟩
...
def j22 : Jet := ⟨⟨(-12), (-11)⟩, ⟨(-24), (-23)⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11823, 11825⟩, ⟨(-24), (-23)⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1275, 1276⟩, ⟨2547, 2550⟩, ⟨1267, 1271⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850902), (-850900)⟩, ⟨2547, 2550⟩, ⟨1267, 1271⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-91793), (-91792)⟩, ⟨(-183311), (-183308)⟩, ⟨(-91108), (-91103)⟩, ⟨546, 551⟩, ⟨133, 138⟩⟩
...
def j30 : Jet := ⟨⟨35699601, 35699603⟩, ⟨(-183311), (-183308)⟩, ⟨(-91108), (-91103)⟩, ⟨546, 551⟩, ⟨133, 138⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3851149, 3851151⟩, ⟨7682524, 7682527⟩, ⟨3801770, 3801775⟩, ⟨(-39374), (-39369)⟩, ⟨(-9698), (-9693)⟩⟩
...
def j33 : Jet := ⟨⟨(-711976734), (-711976731)⟩, ⟨7682524, 7682527⟩, ⟨3801770, 3801775⟩, ⟨(-39374), (-39369)⟩, ⟨(-9698), (-9693)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-76805595), (-76805593)⟩, ⟨(-152782425), (-152782421)⟩, ⟨(-74737946), (-74737940)⟩, ⟨1644759, 1644764⟩, ⟨400578, 400585⟩⟩
...
def j36 : Jet := ⟨⟨4218161701, 4218161703⟩, ⟨(-152782425), (-152782421)⟩, ⟨(-74737946), (-74737940)⟩, ⟨1644759, 1644764⟩, ⟨400578, 400585⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨465168040, 465168043⟩, ⟨455100812, 455100817⟩, ⟨(-15023137), (-15023133)⟩, ⟨(-4878515), (-4878511)⟩, ⟨96354, 96358⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4373171388, 4373171392⟩, ⟨158396893, 158396899⟩, ⟨83221579, 83221588⟩, ⟨4115586, 4115596⟩, ⟨1146528, 1146540⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨473637963, 473637967⟩, ⟨480542662, 480542670⟩, ⟨10500619, 10500628⟩, ⟨3742622, 3742633⟩, ⟨187361, 187372⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-449028094), (-449028093)⟩, ⟨(-449028094), (-449028093)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3845939202, 3845939203⟩, ⟨(-449028094), (-449028093)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨52231578, 52231580⟩, ⟨105986020, 105986024⟩, ⟨56081505, 56081512⟩, ⟨3175176, 3175184⟩, ⟨904480, 904489⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4347198874, 4347198876⟩, ⟨105986020, 105986024⟩, ⟨56081505, 56081512⟩, ⟨3175176, 3175184⟩, ⟨904480, 904489⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4321004164, 4321004166⟩, ⟨52673692, 52673695⟩, ⟨27550738, 27550743⟩, ⟨1242173, 1242179⟩, ⟨346539, 346546⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3869253980, 3869253984⟩, ⟨(-404583395), (-404583390)⟩, ⟨19163473, 19163480⟩, ⟨(-1768056), (-1768047)⟩, ⟨180442, 180450⟩⟩
...
def j47 : Jet := ⟨⟨1892146804, 1892146809⟩, ⟨1892146804, 1892146809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨833584817, 833584822⟩, ⟨1667169634, 1667169644⟩, ⟨833584817, 833584822⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨833584817, 833584822⟩, ⟨1667169634, 1667169644⟩, ⟨833584817, 833584822⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-833584822), (-833584817)⟩, ⟨(-1667169644), (-1667169634)⟩, ⟨(-833584822), (-833584817)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-416792411), (-416792408)⟩, ⟨(-833584822), (-833584817)⟩, ⟨(-416792411), (-416792408)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3897759479, 3897759483⟩, ⟨(-756493105), (-756493099)⟩, ⟨(-304834916), (-304834910)⟩, ⟨68662293, 68662295⟩, ⟨11459336, 11459338⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3511417046, 3511417054⟩, ⟨(-1048676839), (-1048676826)⟩, ⟨(-185967556), (-185967539)⟩, ⟨85591917, 85591932⟩, ⟨2970589, 2970606⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 898056187⟩, ⟨449028093, 449028094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2821326720⟩, ⟨1410663358, 1410663362⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1853305023⟩, ⟨0, 1853305026⟩, ⟨463326254, 463326257⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 465⟩, ⟨0, 465⟩, ⟨115, 117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94221)⟩, ⟨0, 465⟩, ⟨115, 117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-40859), 0⟩, ⟨(-40859), 201⟩, ⟨(-10215), (-9912)⟩, ⟨0, 102⟩, ⟨12, 13⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5072197, 5113057⟩, ⟨(-40859), 201⟩, ⟨(-10215), (-9912)⟩, ⟨0, 102⟩, ⟨12, 13⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2206316⟩, ⟨(-17631), 2206403⟩, ⟨525132, 551666⟩, ⟨(-8816), 67⟩, ⟨(-1102), (-1018)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-140959260)⟩, ⟨(-17631), 2206403⟩, ⟨525132, 551666⟩, ⟨(-8816), 67⟩, ⟨(-1102), (-1018)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-61776835), 0⟩, ⟨(-61784443), 952077⟩, ⟨(-15451817), (-14016073)⟩, ⟨(-5707), 476097⟩, ⟨52368, 59541⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1369878930, 1431655766⟩, ⟨(-61784443), 952077⟩, ⟨(-15451817), (-14016073)⟩, ⟨(-5707), 476097⟩, ⟨52368, 59541⟩⟩
...
def j70 : Jet := ⟨⟨(-47), 0⟩, ⟨(-47), 0⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11788, 11836⟩, ⟨(-47), 0⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 5108⟩, ⟨(-21), 5108⟩, ⟨1244, 1277⟩, ⟨(-12), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-847068)⟩, ⟨(-21), 5108⟩, ⟨1244, 1277⟩, ⟨(-12), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-367720), 0⟩, ⟨(-367730), 2205⟩, ⟨(-91940), (-88621)⟩, ⟨(-9), 1104⟩, ⟨127, 138⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35423674, 35791395⟩, ⟨(-367730), 2205⟩, ⟨(-91940), (-88621)⟩, ⟨(-9), 1104⟩, ⟨127, 138⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 15444209⟩, ⟨(-158678), 15445161⟩, ⟨3623032, 3862005⟩, ⟨(-79347), 715⟩, ⟨(-9923), (-9023)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-700383673)⟩, ⟨(-158678), 15445161⟩, ⟨3623032, 3862005⟩, ⟨(-79347), 715⟩, ⟨(-9923), (-9023)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-308884171), 0⟩, ⟨(-308952643), 6664683⟩, ⟨(-77289514), (-67223811)⟩, ⟨(-51357), 3332960⟩, ⟨352319, 416929⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3986083125, 4294967296⟩, ⟨(-308952643), 6664683⟩, ⟨(-77289514), (-67223811)⟩, ⟨(-51357), 3332960⟩, ⟨352319, 416929⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 940442241⟩, ⟨409345121, 470846533⟩, ⟨(-30442998), 312706⟩, ⟨(-5078832), (-4290774)⟩, ⟨(-1875), 195484⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4627787103⟩, ⟨(-7737605), 358689726⟩, ⟨66667216, 117533314⟩, ⟨(-4216068), 16124315⟩, ⟨12594, 3155564⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 1013317722⟩, ⟨407650865, 585872793⟩, ⟨(-33650301), 65394735⟩, ⟨(-2584053), 12179596⟩, ⟨(-1721457), 2686965⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-898056187), 0⟩, ⟨(-449028094), (-449028093)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3396911109, 4294967296⟩, ⟨(-449028094), (-449028093)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 239073487⟩, ⟨0, 276451598⟩, ⟨22813288, 110775750⟩, ⟨(-10399738), 23587980⟩, ⟨(-2029627), 5586392⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4534040783⟩, ⟨0, 276451598⟩, ⟨22813288, 110775750⟩, ⟨(-10399738), 23587980⟩, ⟨(-2029627), 5586392⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4412885324⟩, ⟨0, 138225799⟩, ⟨8937004, 55387875⟩, ⟨(-6982429), 11793990⟩, ⟨(-1751524), 3008615⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3396911109, 4412885324⟩, ⟨(-461356130), (-310802294)⟩, ⟨(-7382841), 55387875⟩, ⟨(-12773093), 10859649⟩, ⟨(-2984557), 3738611⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3784293614⟩, ⟨1892146804, 1892146809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3334339279⟩, ⟨0, 3334339284⟩, ⟨833584817, 833584822⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3334339279⟩, ⟨0, 3334339284⟩, ⟨833584817, 833584822⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3334339279), 0⟩, ⟨(-3334339284), 0⟩, ⟨(-833584822), (-833584817)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1667169640), 0⟩, ⟨(-1667169642), 0⟩, ⟨(-416792411), (-416792408)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2913268829, 4294967296⟩, ⟨(-1667169642), 0⟩, ⟨(-416792411), 40861541⟩, ⟨(-5287051), 161785552⟩, ⟨(-17682645), 20736261⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2304118883, 4412885324⟩, ⟨(-2174297799), (-210816654)⟩, ⟨(-435618259), 276455037⟩, ⟨(-44094370), 224723740⟩, ⟨(-48121658), 31286664⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨449028093, 449028094⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨449028093, 449028094⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4321004164, 4321004166⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified392
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 898056187⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4412885324⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified393
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (722566499 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(41819 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(41819 / 200000), prawitzNormalCorrection
