...
namespace FiniteNormalPanel126_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (14319 / 80000)
def radius : Rat := (14319 / 400000)

def j0 : Jet := ⟨⟨768745458, 768745459⟩, ⟨153749091, 153749092⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2415085083, 2415085087⟩, ⟨483017014, 483017018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1358016384, 1358016389⟩, ⟨543206550, 543206558⟩, ⟨54320654, 54320656⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-29832), (-29830)⟩, ⟨(-11891), (-11888)⟩, ⟨(-1173), (-1170)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5083224, 5083227⟩, ⟨(-11891), (-11888)⟩, ⟨(-1173), (-1170)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1607253, 1607255⟩, ⟨639141, 639144⟩, ⟨62415, 62419⟩, ⟨(-300), (-295)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-141558324), (-141558321)⟩, ⟨639141, 639144⟩, ⟨62415, 62419⟩, ⟨(-300), (-295)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-44759020), (-44759018)⟩, ⟨(-17701520), (-17701517)⟩, ⟨(-1689792), (-1689787)⟩, ⟨15881, 15886⟩, ⟨746, 750⟩⟩
...
def j19 : Jet := ⟨⟨1386896745, 1386896748⟩, ⟨(-17701520), (-17701517)⟩, ⟨(-1689792), (-1689787)⟩, ⟨15881, 15886⟩, ⟨746, 750⟩⟩
...
def j25 : Jet := ⟨⟨3731, 3732⟩, ⟨1487, 1489⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848446), (-848444)⟩, ⟨1487, 1489⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-268269), (-268267)⟩, ⟨(-106838), (-106836)⟩, ⟨(-10497), (-10493)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35523125, 35523128⟩, ⟨(-106838), (-106836)⟩, ⟨(-10497), (-10493)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11231979, 11231981⟩, ⟨4459010, 4459013⟩, ⟨432446, 432451⟩, ⟨(-2669), (-2665)⟩, ⟨(-130), (-126)⟩⟩
...
def j33 : Jet := ⟨⟨(-704595904), (-704595901)⟩, ⟨4459010, 4459013⟩, ⟨432446, 432451⟩, ⟨(-2669), (-2665)⟩, ⟨(-130), (-126)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-222784650), (-222784648)⟩, ⟨(-87703977), (-87703972)⟩, ⟨(-8210700), (-8210694)⟩, ⟨110244, 110249⟩, ⟨5089, 5094⟩⟩
...
def j36 : Jet := ⟨⟨4072182646, 4072182648⟩, ⟨(-87703977), (-87703972)⟩, ⟨(-8210700), (-8210694)⟩, ⟨110244, 110249⟩, ⟨5089, 5094⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨779860103, 779860107⟩, ⟨146018351, 146018357⟩, ⟨(-2940914), (-2940910)⟩, ⟨(-181107), (-181102)⟩, ⟨2204, 2209⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4529940247, 4529940251⟩, ⟨97562851, 97562859⟩, ⟨11234909, 11234918⟩, ⟨316041, 316050⟩, ⟨21149, 21159⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨822525394, 822525400⟩, ⟨171721860, 171721871⟩, ⟨2255070, 2255079⟩, ⟨181523, 181534⟩, ⟨5101, 5112⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-768745459), (-768745458)⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3526221837, 3526221838⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨157521111, 157521115⟩, ⟨65772602, 65772610⟩, ⟨7729534, 7729542⟩, ⟨249850, 249858⟩, ⟨17650, 17661⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4452488407, 4452488411⟩, ⟨65772602, 65772610⟩, ⟨7729534, 7729542⟩, ⟨249850, 249858⟩, ⟨17650, 17661⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4373018647, 4373018650⟩, ⟨32299333, 32299338⟩, ⟨3676504, 3676510⟩, ⟨95539, 95545⟩, ⟨6415, 6423⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3590302971, 3590302976⟩, ⟨(-130024980), (-130024973)⟩, ⟨1862219, 1862226⟩, ⟨(-53172), (-53165)⟩, ⟨1845, 1854⟩⟩
...
def j47 : Jet := ⟨⟨6615504813, 6615504824⟩, ⟨1323100957, 1323100967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10189810751, 10189810786⟩, ⟨4075924282, 4075924322⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10189810751, 10189810786⟩, ⟨4075924282, 4075924322⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10189810786), (-10189810751)⟩, ⟨(-4075924322), (-4075924282)⟩, ⟨(-407592433), (-407592426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5094905393), (-5094905375)⟩, ⟨(-2037962161), (-2037962141)⟩, ⟨(-203796217), (-203796213)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1311529264, 1311529281⟩, ⟨(-622320699), (-622320684)⟩, ⟨85413523, 85413531⟩, ⟨6176504, 6176507⟩, ⟨(-2759125), (-2759123)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1096350004, 1096350020⟩, ⟨(-559923106), (-559923089)⟩, ⟨90808609, 90808623⟩, ⟨2291282, 2291293⟩, ⟨(-2448131), (-2448120)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨614996367, 922494551⟩, ⟨153749091, 153749092⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1932068068, 2898102105⟩, ⟨483017014, 483017018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨869130487, 1955543601⟩, ⟨434565240, 651847868⟩, ⟨54320654, 54320656⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-43014), (-19061)⟩, ⟨(-14317), (-9455)⟩, ⟨(-1183), (-1159)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5070042, 5093996⟩, ⟨(-14317), (-9455)⟩, ⟨(-1183), (-1159)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1025974, 2319350⟩, ⟨506468, 771204⟩, ⟨61411, 63237⟩, ⟨(-362), (-233)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142139603), (-140846226)⟩, ⟨506468, 771204⟩, ⟨61411, 63237⟩, ⟨(-362), (-233)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-64717651), (-28501671)⟩, ⟨(-21470063), (-13899697)⟩, ⟨(-1734042), (-1635515)⟩, ⟨12453, 19305⟩, ⟨714, 775⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1366938114, 1403154095⟩, ⟨(-21470063), (-13899697)⟩, ⟨(-1734042), (-1635515)⟩, ⟨12453, 19305⟩, ⟨714, 775⟩⟩
...
def j72 : Jet := ⟨⟨2384, 5380⟩, ⟨1184, 1792⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849793), (-846796)⟩, ⟨1184, 1792⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-386920), (-171357)⟩, ⟨(-128735), (-84862)⟩, ⟨(-10600), (-10369)⟩, ⟨27, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35404474, 35620038⟩, ⟨(-128735), (-84862)⟩, ⟨(-10600), (-10369)⟩, ⟨27, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7164456, 16218177⟩, ⟨3523613, 5388887⟩, ⟨423412, 439821⟩, ⟨(-3233), (-2101)⟩, ⟨(-134), (-123)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708663427), (-699609705)⟩, ⟨3523613, 5388887⟩, ⟨423412, 439821⟩, ⟨(-3233), (-2101)⟩, ⟨(-134), (-123)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-322661882), (-141573167)⟩, ⟨(-106840922), (-68332966)⟩, ⟨(-8520631), (-7830193)⟩, ⟨85931, 134484⟩, ⟨4802, 5327⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3972305414, 4153394129⟩, ⟨(-106840922), (-68332966)⟩, ⟨(-8520631), (-7830193)⟩, ⟨85931, 134484⟩, ⟨4802, 5327⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨614909800, 946802050⟩, ⟨139240159, 151547638⟩, ⟨(-3584624), (-2298903)⟩, ⟨(-189412), (-170904)⟩, ⟨1721, 2695⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4441366145, 4643838314⟩, ⟨73070772, 124902775⟩, ⟨9575275, 13320518⟩, ⟨144926, 530117⟩, ⟨10433, 35885⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨635869700, 1023708758⟩, ⟨154447849, 191391663⟩, ⟨(-135998), 4966360⟩, ⟨22129, 371036⟩, ⟨(-8657), 21499⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-922494551), (-614996367)⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3372472745, 3679970929⟩, ⟨(-153749092), (-153749091)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨94140478, 244001770⟩, ⟨45731992, 91236702⟩, ⟨5489142, 10896238⟩, ⟨(-5570), 619496⟩, ⟨(-2696), 49063⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4389107774, 4538969066⟩, ⟨45731992, 91236702⟩, ⟨5489142, 10896238⟩, ⟨(-5570), 619496⟩, ⟨(-2696), 49063⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4341782392, 4415282969⟩, ⟨22242901, 45126473⟩, ⟨2439173, 5332400⟩, ⟨(-58178), 293913⟩, ⟨(-7664), 24188⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3409232660, 3783058601⟩, ⟨(-140590634), (-116760140)⟩, ⟨299860, 3772614⟩, ⟨(-240735), 164512⟩, ⟨(-17089), 22808⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5292403856, 7938605791⟩, ⟨1323100957, 1323100967⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6521478894, 14673327540⟩, ⟨3260739430, 4891109188⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6521478894, 14673327540⟩, ⟨3260739430, 4891109188⟩, ⟨407592426, 407592433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14673327540), (-6521478894)⟩, ⟨(-4891109188), (-3260739430)⟩, ⟨(-407592433), (-407592426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7336663770), (-3260739447)⟩, ⟨(-2445554594), (-1630369715)⟩, ⟨(-203796217), (-203796213)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨778212067, 2010219419⟩, ⟨(-1144619039), (-295409324)⟩, ⟨(-39316227), 288946905⟩, ⟨(-45497346), 43670340⟩, ⟨(-13071740), 7409326⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨617724376, 1770625325⟩, ⟨(-1073996287), (-255644149)⟩, ⟨(-26545070), 293741370⟩, ⟨(-50651025), 39808704⟩, ⟨(-13029620), 8344165⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨768745458, 768745459⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4373018647, 4373018650⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2538
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨614996367, 922494551⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4341782392, 4415282969⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2539
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (2524369 / 134217728)

theorem envelope_integral : (∫ s in ((14319 / 100000) : ℝ)..(42957 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((14319 / 100000) : ℝ)..(42957 / 200000), prawitzNormalCorrection
