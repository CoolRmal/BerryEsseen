...
namespace FiniteNormalPanel92_19

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2087 / 50000)
def radius : Rat := (2087 / 50000)

def j0 : Jet := ⟨⟨179271934, 179271935⟩, ⟨179271934, 179271935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨563199390, 563199395⟩, ⟨563199390, 563199395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨73852379, 73852381⟩, ⟨147704758, 147704762⟩, ⟨73852379, 73852381⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨18, 19⟩, ⟨36, 38⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94669), (-94667)⟩, ⟨36, 38⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1628), (-1627)⟩, ⟨(-3256), (-3254)⟩, ⟨(-1627), (-1624)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111428, 5111430⟩, ⟨(-3256), (-3254)⟩, ⟨(-1627), (-1624)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨87891, 87892⟩, ⟨175726, 175729⟩, ⟨87751, 87754⟩, ⟨(-112), (-109)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-143077686), (-143077684)⟩, ⟨175726, 175729⟩, ⟨87751, 87754⟩, ⟨(-112), (-109)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2460235), (-2460234)⟩, ⟨(-4917449), (-4917447)⟩, ⟨(-2452684), (-2452681)⟩, ⟨6036, 6039⟩, ⟨1503, 1506⟩⟩
...
def j19 : Jet := ⟨⟨1429195530, 1429195532⟩, ⟨(-4917449), (-4917447)⟩, ⟨(-2452684), (-2452681)⟩, ⟨6036, 6039⟩, ⟨1503, 1506⟩⟩
...
def j25 : Jet := ⟨⟨203, 204⟩, ⟨405, 408⟩, ⟨201, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851974), (-851972)⟩, ⟨405, 408⟩, ⟨201, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14650), (-14649)⟩, ⟨(-29294), (-29291)⟩, ⟨(-14634), (-14630)⟩, ⟨11, 16⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35776744, 35776746⟩, ⟨(-29294), (-29291)⟩, ⟨(-14634), (-14630)⟩, ⟨11, 16⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨615184, 615185⟩, ⟨1229865, 1229867⟩, ⟨613924, 613927⟩, ⟨(-1008), (-1005)⟩, ⟨(-252), (-249)⟩⟩
...
def j33 : Jet := ⟨⟨(-715212699), (-715212697)⟩, ⟨1229865, 1229867⟩, ⟨613924, 613927⟩, ⟨(-1008), (-1005)⟩, ⟨(-252), (-249)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-12298153), (-12298151)⟩, ⟨(-24575158), (-24575155)⟩, ⟨(-12245302), (-12245298)⟩, ⟨42241, 42245⟩, ⟨10516, 10519⟩⟩
...
def j36 : Jet := ⟨⟨4282669143, 4282669145⟩, ⟨(-24575158), (-24575155)⟩, ⟨(-12245302), (-12245298)⟩, ⟨42241, 42245⟩, ⟨10516, 10519⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨187410519, 187410522⟩, ⟨186765693, 186765697⟩, ⟨(-966447), (-966445)⟩, ⟨(-320830), (-320828)⟩, ⟨988, 990⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4307300762, 4307300765⟩, ⟨24716497, 24716502⟩, ⟨12457555, 12457562⟩, ⟨99666, 99674⟩, ⟨25365, 25373⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨187948688, 187948692⟩, ⟨188380513, 188380519⟩, ⟨649152, 649157⟩, ⟨218747, 218755⟩, ⟨1778, 1787⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-179271935), (-179271934)⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4115695361, 4115695362⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8224674, 8224676⟩, ⟨16487142, 16487146⟩, ⟨8319325, 8319329⟩, ⟨76088, 76092⟩, ⟨19440, 19447⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303191970, 4303191972⟩, ⟨16487142, 16487146⟩, ⟨8319325, 8319329⟩, ⟨76088, 76092⟩, ⟨19440, 19447⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299077666, 4299077668⟩, ⟨8235689, 8235692⟩, ⟨4147796, 4147799⟩, ⟨30061, 30065⟩, ⟨7651, 7657⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4119634164, 4119634168⟩, ⟨(-171551571), (-171551565)⟩, ⟨3630908, 3630913⟩, ⟨(-144324), (-144318)⟩, ⟨6076, 6084⟩⟩
...
def j47 : Jet := ⟨⟨1152442456, 1152442464⟩, ⟨1152442456, 1152442464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨309227875, 309227881⟩, ⟨618455750, 618455762⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨309227875, 309227881⟩, ⟨618455750, 618455762⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-309227881), (-309227875)⟩, ⟨(-618455762), (-618455750)⟩, ⟨(-309227881), (-309227875)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-154613941), (-154613937)⟩, ⟨(-309227881), (-309227875)⟩, ⟨(-154613941), (-154613937)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4143103221, 4143103226⟩, ⟨(-298294014), (-298294007)⟩, ⟨(-138408763), (-138408757)⟩, ⟨10480534, 10480536⟩, ⟨2302635, 2302636⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3973969624, 3973969634⟩, ⟨(-451602527), (-451602512)⟩, ⟨(-117341393), (-117341379)⟩, ⟨15189677, 15189689⟩, ⟨1688889, 1688903⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 358543870⟩, ⟨179271934, 179271935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1126398789⟩, ⟨563199390, 563199395⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 295409522⟩, ⟨0, 295409522⟩, ⟨73852379, 73852381⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 75⟩, ⟨0, 75⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94611)⟩, ⟨0, 75⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6513), 0⟩, ⟨(-6513), 6⟩, ⟨(-1629), (-1618)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106543, 5113057⟩, ⟨(-6513), 6⟩, ⟨(-1629), (-1618)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 351679⟩, ⟨(-448), 351680⟩, ⟨87246, 87921⟩, ⟨(-225), 2⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142813897)⟩, ⟨(-448), 351680⟩, ⟨87246, 87921⟩, ⟨(-225), 2⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9846985), 0⟩, ⟨(-9847016), 24189⟩, ⟨(-2461778), (-2425461)⟩, ⟨(-24), 12097⟩, ⟨1482, 1513⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421808780, 1431655766⟩, ⟨(-9847016), 24189⟩, ⟨(-2461778), (-2425461)⟩, ⟨(-24), 12097⟩, ⟨1482, 1513⟩⟩
...
def j72 : Jet := ⟨⟨0, 815⟩, ⟨(-1), 815⟩, ⟨201, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851361)⟩, ⟨(-1), 815⟩, ⟨201, 204⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-58614), 0⟩, ⟨(-58615), 57⟩, ⟨(-14655), (-14567)⟩, ⟨(-2), 30⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35732780, 35791395⟩, ⟨(-58615), 57⟩, ⟨(-14655), (-14567)⟩, ⟨(-2), 30⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2461747⟩, ⟨(-4032), 2461751⟩, ⟨609388, 615441⟩, ⟨(-2017), 4⟩, ⟨(-253), (-246)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713366135)⟩, ⟨(-4032), 2461751⟩, ⟨609388, 615441⟩, ⟨(-2017), 4⟩, ⟨(-253), (-246)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-49234921), 0⟩, ⟨(-49235199), 169321⟩, ⟨(-12309009), (-12054747)⟩, ⟨(-209), 84663⟩, ⟨10321, 10584⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4245732375, 4294967296⟩, ⟨(-49235199), 169321⟩, ⟨(-12309009), (-12054747)⟩, ⟨(-209), 84663⟩, ⟨10321, 10584⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 375466264⟩, ⟨183859414, 187739476⟩, ⟨(-1936867), 3172⟩, ⟨(-322821), (-314877)⟩, ⟨(-4), 1984⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4344773162⟩, ⟨(-173272), 50383716⟩, ⟨12052760, 13180414⟩, ⟨(-87667), 299132⟩, ⟨21122, 31246⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 379820296⟩, ⟨183844266, 194321114⟩, ⟨(-1966902), 3357790⟩, ⟨159004, 287489⟩, ⟨(-13569), 17840⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-358543870), 0⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3936423426, 4294967296⟩, ⟨(-179271935), (-179271934)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 33588954⟩, ⟨0, 34369112⟩, ⟨7521494, 9385734⟩, ⟨(-177982), 354688⟩, ⟨9674, 31798⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4328556250⟩, ⟨0, 34369112⟩, ⟨7521494, 9385734⟩, ⟨(-177982), 354688⟩, ⟨9674, 31798⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311729066⟩, ⟨0, 17184556⟩, ⟨3711882, 4692867⟩, ⟨(-107768), 177344⟩, ⟨1556, 14728⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3936423426, 4311729066⟩, ⟨(-179971572), (-162087378)⟩, ⟨2684730, 4692867⟩, ⟨(-303649), 22411⟩, ⟨(-5977), 19227⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2304884927⟩, ⟨1152442456, 1152442464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1236911521⟩, ⟨0, 1236911522⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1236911521⟩, ⟨0, 1236911522⟩, ⟨309227875, 309227881⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1236911521), 0⟩, ⟨(-1236911522), 0⟩, ⟨(-309227881), (-309227875)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-618455761), 0⟩, ⟨(-618455761), 0⟩, ⟨(-154613941), (-154613937)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3718976468, 4294967296⟩, ⟨(-618455761), 0⟩, ⟨(-154613941), (-89351513)⟩, ⟨0, 22263705⟩, ⟨806808, 2782964⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3408516312, 4311729066⟩, ⟨(-800840952), (-140350112)⟩, ⟨(-152892661), (-51284492)⟩, ⟨2392627, 28851777⟩, ⟨(-371602), 2800925⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨179271934, 179271935⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299077666, 4299077668⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1864
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 358543870⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311729066⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1865
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (164264265 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(2087 / 25000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (2087 / 25000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(2087 / 25000), prawitzNormalCorrection
