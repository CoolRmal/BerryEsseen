...
namespace FiniteNormalPanel103_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2931 / 16000)
def radius : Rat := (2931 / 80000)

def j0 : Jet := ⟨⟨786784321, 786784322⟩, ⟨157356864, 157356865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2471755842, 2471755847⟩, ⟨494351167, 494351172⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1422496731, 1422496738⟩, ⟨568998690, 568998700⟩, ⟨56899868, 56899871⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨356, 357⟩, ⟨142, 143⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94331), (-94329)⟩, ⟨142, 143⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-31243), (-31241)⟩, ⟨(-12451), (-12448)⟩, ⟨(-1228), (-1225)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5081813, 5081816⟩, ⟨(-12451), (-12448)⟩, ⟨(-1228), (-1225)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1683100, 1683102⟩, ⟨669116, 669119⟩, ⟨65267, 65271⟩, ⟨(-328), (-324)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-141482477), (-141482474)⟩, ⟨669116, 669119⟩, ⟨65267, 65271⟩, ⟨(-328), (-324)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-46859114), (-46859112)⟩, ⟨(-18522035), (-18522032)⟩, ⟨(-1764105), (-1764100)⟩, ⟨17401, 17406⟩, ⟨814, 819⟩⟩
...
def j19 : Jet := ⟨⟨1384796651, 1384796654⟩, ⟨(-18522035), (-18522032)⟩, ⟨(-1764105), (-1764100)⟩, ⟨17401, 17406⟩, ⟨814, 819⟩⟩
...
def j25 : Jet := ⟨⟨3907, 3909⟩, ⟨1558, 1560⟩, ⟨153, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848270), (-848267)⟩, ⟨1558, 1560⟩, ⟨153, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-280948), (-280946)⟩, ⟨(-111864), (-111861)⟩, ⟨(-10982), (-10978)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35510446, 35510449⟩, ⟨(-111864), (-111861)⟩, ⟨(-10982), (-10978)⟩, ⟨39, 42⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11761089, 11761091⟩, ⟨4667385, 4667389⟩, ⟨451985, 451990⟩, ⟨(-2925), (-2921)⟩, ⟨(-141), (-138)⟩⟩
...
def j33 : Jet := ⟨⟨(-704066794), (-704066791)⟩, ⟨4667385, 4667389⟩, ⟨451985, 451990⟩, ⟨(-2925), (-2921)⟩, ⟨(-141), (-138)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-233187508), (-233187505)⟩, ⟨(-91729163), (-91729157)⟩, ⟨(-8559468), (-8559462)⟩, ⟨120743, 120747⟩, ⟨5552, 5557⟩⟩
...
def j36 : Jet := ⟨⟨4061779788, 4061779791⟩, ⟨(-91729163), (-91729157)⟩, ⟨(-8559468), (-8559462)⟩, ⟨120743, 120747⟩, ⟨5552, 5557⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨796951170, 796951174⟩, ⟨148730792, 148730798⟩, ⟨(-3147133), (-3147127)⟩, ⟨(-193035), (-193030)⟩, ⟨2470, 2476⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4541542137, 4541542141⟩, ⟨102563864, 102563872⟩, ⟨11886723, 11886732⟩, ⟨349568, 349577⟩, ⟨23678, 23691⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨842704279, 842704285⟩, ⟨176300655, 176300664⟩, ⟨2429517, 2429529⟩, ⟨197217, 197229⟩, ⟨5789, 5803⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-786784322), (-786784321)⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3508182974, 3508182975⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨165344798, 165344801⟩, ⟨69182978, 69182984⟩, ⟨8190201, 8190209⟩, ⟨276844, 276852⟩, ⟨19834, 19845⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4460312094, 4460312097⟩, ⟨69182978, 69182984⟩, ⟨8190201, 8190209⟩, ⟨276844, 276852⟩, ⟨19834, 19845⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4376858984, 4376858987⟩, ⟨33944277, 33944280⟩, ⟨3886854, 3886860⟩, ⟨105687, 105693⟩, ⟨7185, 7192⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3575073128, 3575073132⟩, ⟨(-132631063), (-132631057)⟩, ⟨1931196, 1931203⟩, ⟨(-56079), (-56072)⟩, ⟨1995, 2003⟩⟩
...
def j47 : Jet := ⟨⟨7813557275, 7813557287⟩, ⟨1562711453, 1562711464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14214701319, 14214701364⟩, ⟨5685880520, 5685880570⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14214701319, 14214701364⟩, ⟨5685880520, 5685880570⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14214701364), (-14214701319)⟩, ⟨(-5685880570), (-5685880520)⟩, ⟨(-568588060), (-568588051)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7107350682), (-7107350659)⟩, ⟨(-2842940285), (-2842940260)⟩, ⟨(-284294030), (-284294025)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨820890873, 820890884⟩, ⟨(-543367063), (-543367050)⟩, ⟨125497032, 125497042⟩, ⟨(-3711987), (-3711983)⟩, ⟨(-3539211), (-3539209)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨683298544, 683298555⟩, ⟨(-477641035), (-477641020)⟩, ⟨121610636, 121610651⟩, ⟨(-7220271), (-7220260)⟩, ⟨(-2767462), (-2767454)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨629427457, 944141186⟩, ⟨157356864, 157356865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1977404674, 2966107014⟩, ⟨494351167, 494351172⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨910397908, 2048395300⟩, ⟨455198952, 682798438⟩, ⟨56899868, 56899871⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨227, 514⟩, ⟨113, 172⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94460), (-94172)⟩, ⟨113, 172⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-45051), (-19961)⟩, ⟨(-14994), (-9897)⟩, ⟨(-1239), (-1211)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5068005, 5093096⟩, ⟨(-14994), (-9897)⟩, ⟨(-1239), (-1211)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1074257, 2429047⟩, ⟨529976, 807586⟩, ⟨64166, 66170⟩, ⟨(-396), (-256)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142091320), (-140736529)⟩, ⟨529976, 807586⟩, ⟨64166, 66170⟩, ⟨(-396), (-256)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-67767500), (-29831715)⟩, ⟨(-22476829), (-14530695)⟩, ⟨(-1812661), (-1704535)⟩, ⟨13632, 21165⟩, ⟨778, 848⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1363888265, 1401824051⟩, ⟨(-22476829), (-14530695)⟩, ⟨(-1812661), (-1704535)⟩, ⟨13632, 21165⟩, ⟨778, 848⟩⟩
...
def j72 : Jet := ⟨⟨2497, 5635⟩, ⟨1239, 1877⟩, ⟨152, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849680), (-846541)⟩, ⟨1239, 1877⟩, ⟨152, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-405238), (-179440)⟩, ⟨(-134818), (-88824)⟩, ⟨(-11094), (-10841)⟩, ⟨31, 50⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35386156, 35611955⟩, ⟨(-134818), (-88824)⟩, ⟨(-11094), (-10841)⟩, ⟨31, 50⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7500751, 16984382⟩, ⟨3686076, 5642634⟩, ⟨442071, 460079⟩, ⟨(-3545), (-2300)⟩, ⟨(-144), (-133)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708327132), (-698843500)⟩, ⟨3686076, 5642634⟩, ⟨442071, 460079⟩, ⟨(-3545), (-2300)⟩, ⟨(-144), (-133)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-337821890), (-148132830)⟩, ⟨(-111825966), (-71375277)⟩, ⟨(-8899571), (-8141829)⟩, ⟨93994, 147409⟩, ⟨5223, 5825⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3957145406, 4146834466⟩, ⟨(-111825966), (-71375277)⟩, ⟨(-8899571), (-8141829)⟩, ⟨93994, 147409⟩, ⟨5223, 5825⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨627934706, 968100539⟩, ⟨141461164, 154660154⟩, ⟨(-3838911), (-2457252)⟩, ⟨(-202362), (-181575)⟩, ⟨1927, 3023⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4448391712, 4661629074⟩, ⟨76565676, 131734148⟩, ⟨10051748, 14206656⟩, ⟨157628, 592077⟩, ⟨11214, 40995⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨650365730, 1050747377⟩, ⟨157708514, 197556842⟩, ⟨(-175246), 5400899⟩, ⟨16729, 413168⟩, ⟨(-10081), 24858⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-944141186), (-629427457)⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3350826110, 3665539839⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨98481677, 257061341⟩, ⟨47762046, 96663058⟩, ⟨5705210, 11729699⟩, ⟨(-11056), 699014⟩, ⟨(-3927), 56966⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4393448973, 4552028637⟩, ⟨47762046, 96663058⟩, ⟨5705210, 11729699⟩, ⟨(-11056), 699014⟩, ⟨(-3927), 56966⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4343929057, 4421630257⟩, ⟨23196922, 47786770⟩, ⟨2512660, 5736809⟩, ⟨(-68577), 332151⟩, ⟨(-9385), 28192⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3389024851, 3773640344⟩, ⟨(-143899822), (-118367081)⟩, ⟨209526, 4046203⟩, ⟨(-268711), 191418⟩, ⟨(-20180), 26574⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6250845822, 9376268741⟩, ⟨1562711453, 1562711464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9097408850, 20469169949⟩, ⟨4548704416, 6823056682⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9097408850, 20469169949⟩, ⟨4548704416, 6823056682⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20469169949), (-9097408850)⟩, ⟨(-6823056682), (-4548704416)⟩, ⟨(-568588060), (-568588051)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10234584975), (-4548704425)⟩, ⟨(-3411528341), (-2274352208)⟩, ⟨(-284294030), (-284294025)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨396340702, 1489389295⟩, ⟨(-1183034338), (-209877814)⟩, ⟨(-43016964), 443612294⟩, ⟨(-108193444), 63594803⟩, ⟨(-27310344), 22908436⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨312740096, 1308605898⟩, ⟨(-1089337507), (-176530987)⟩, ⟨(-31992068), 430806088⟩, ⟨(-111131440), 57373005⟩, ⟨(-26226340), 24253886⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨786784321, 786784322⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4376858984, 4376858987⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2070
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨629427457, 944141186⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4343929057, 4421630257⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2071
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (53394483 / 4294967296)

theorem envelope_integral : (∫ s in ((2931 / 20000) : ℝ)..(8793 / 40000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((2931 / 20000) : ℝ)..(8793 / 40000), prawitzNormalCorrection
