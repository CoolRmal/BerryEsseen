...
namespace FiniteNormalPanel24_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (127253 / 400000)
def radius : Rat := (18179 / 400000)

def j0 : Jet := ⟨⟨1366368683, 1366368684⟩, ⟨195195526, 195195527⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4292573816, 4292573820⟩, ⟨613224830, 613224834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4290181669, 4290181678⟩, ⟨1225766188, 1225766200⟩, ⟨87554727, 87554729⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1073, 1075⟩, ⟨306, 308⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93614), (-93611)⟩, ⟨306, 308⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-93510), (-93506)⟩, ⟨(-26413), (-26408)⟩, ⟨(-1802), (-1798)⟩, ⟨11, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5019546, 5019551⟩, ⟨(-26413), (-26408)⟩, ⟨(-1802), (-1798)⟩, ⟨11, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5013953, 5013959⟩, ⟨1406174, 1406182⟩, ⟨92986, 92995⟩, ⟨(-1044), (-1037)⟩, ⟨(-34), (-31)⟩⟩
...
def j16 : Jet := ⟨⟨(-138151624), (-138151617)⟩, ⟨1406174, 1406182⟩, ⟨92986, 92995⟩, ⟨(-1044), (-1037)⟩, ⟨(-34), (-31)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-137997691), (-137997682)⟩, ⟨(-38023305), (-38023293)⟩, ⟨(-2322082), (-2322068)⟩, ⟨54159, 54172⟩, ⟨1563, 1571⟩⟩
...
def j19 : Jet := ⟨⟨1293658074, 1293658084⟩, ⟨(-38023305), (-38023293)⟩, ⟨(-2322082), (-2322068)⟩, ⟨54159, 54172⟩, ⟨1563, 1571⟩⟩
...
def j22 : Jet := ⟨⟨(-108), (-106)⟩, ⟨(-31), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11727, 11730⟩, ⟨(-31), (-30)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11713, 11717⟩, ⟨3315, 3319⟩, ⟨227, 231⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840464), (-840459)⟩, ⟨3315, 3319⟩, ⟨227, 231⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-839528), (-839522)⟩, ⟨(-236555), (-236547)⟩, ⟨(-15962), (-15954)⟩, ⟨129, 134⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨34951866, 34951873⟩, ⟨(-236555), (-236547)⟩, ⟨(-15962), (-15954)⟩, ⟨129, 134⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨34912921, 34912929⟩, ⟨9738828, 9738840⟩, ⟨629051, 629064⟩, ⟨(-9251), (-9241)⟩, ⟨(-289), (-281)⟩⟩
...
def j33 : Jet := ⟨⟨(-680914962), (-680914953)⟩, ⟨9738828, 9738840⟩, ⟨629051, 629064⟩, ⟨(-9251), (-9241)⟩, ⟨(-289), (-281)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-680156261), (-680156249)⟩, ⟨(-184602386), (-184602367)⟩, ⟨(-10472970), (-10472949)⟩, ⟨368817, 368834⟩, ⟨9893, 9907⟩⟩
...
def j36 : Jet := ⟨⟨3614811035, 3614811047⟩, ⟨(-184602386), (-184602367)⟩, ⟨(-10472970), (-10472949)⟩, ⟨368817, 368834⟩, ⟨9893, 9907⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1292937150, 1292937162⟩, ⟨146703190, 146703207⟩, ⟨(-7749662), (-7749644)⟩, ⟨(-277414), (-277397)⟩, ⟨9294, 9306⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5103100503, 5103100521⟩, ⟨260606825, 260606855⟩, ⟨28093623, 28093660⟩, ⟨1669040, 1669074⟩, ⟨126050, 126078⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1536213844, 1536213864⟩, ⟨252758470, 252758503⟩, ⟨8150895, 8150933⟩, ⟨662192, 662229⟩, ⟨38471, 38502⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1366368684), (-1366368683)⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2928598612, 2928598613⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨549469370, 549469385⟩, ⟨180812114, 180812142⟩, ⟨20705601, 20705633⟩, ⟨1433060, 1433094⟩, ⟨120926, 120959⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4844436666, 4844436681⟩, ⟨180812114, 180812142⟩, ⟨20705601, 20705633⟩, ⟨1433060, 1433094⟩, ⟨120926, 120959⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4561435853, 4561435861⟩, ⟨85124743, 85124757⟩, ⟨8953721, 8953738⟩, ⟨507578, 507596⟩, ⟨38669, 38687⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3110294860, 3110294868⟩, ⟨(-149262063), (-149262049)⟩, ⟨2236543, 2236557⟩, ⟨(-60826), (-60810)⟩, ⟨3298, 3312⟩⟩
...
def j47 : Jet := ⟨⟨8328672979, 8328672987⟩, ⟨1189810424, 1189810431⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16150715200, 16150715232⟩, ⟨4614490050, 4614490084⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16150715200, 16150715232⟩, ⟨4614490050, 4614490084⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16150715232), (-16150715200)⟩, ⟨(-4614490084), (-4614490050)⟩, ⟨(-329606436), (-329606431)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8075357616), (-8075357600)⟩, ⟨(-2307245042), (-2307245025)⟩, ⟨(-164803218), (-164803215)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨655244537, 655244545⟩, ⟨(-351995632), (-351995625)⟩, ⟨69403011, 69403017⟩, ⟨(-3423367), (-3423365)⟩, ⟨(-871785), (-871783)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨474509716, 474509724⟩, ⟨(-277676937), (-277676927)⟩, ⟨62833749, 62833759⟩, ⟨(-5083633), (-5083624)⟩, ⟨(-470726), (-470715)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1171173157, 1561564210⟩, ⟨195195526, 195195527⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3679348985, 4905798651⟩, ⟨613224830, 613224834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3151970206, 5603502599⟩, ⟨1050656732, 1400875656⟩, ⟨87554727, 87554729⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨788, 1404⟩, ⟨262, 351⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93899), (-93282)⟩, ⟨262, 351⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-122507), (-68457)⟩, ⟨(-30435), (-22361)⟩, ⟨(-1836), (-1757)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4990549, 5044600⟩, ⟨(-30435), (-22361)⟩, ⟨(-1836), (-1757)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3662440, 6581524⟩, ⟨1181105, 1628971⟩, ⟨89411, 96078⟩, ⟨(-1213), (-863)⟩, ⟨(-36), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139503137), (-136584052)⟩, ⟨1181105, 1628971⟩, ⟨89411, 96078⟩, ⟨(-1213), (-863)⟩, ⟨(-36), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-182005156), (-100235655)⟩, ⟨(-44634507), (-31286620)⟩, ⟨(-2489288), (-2127656)⟩, ⟨44366, 63913⟩, ⟨1379, 1729⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1249650609, 1331420111⟩, ⟨(-44634507), (-31286620)⟩, ⟨(-2489288), (-2127656)⟩, ⟨44366, 63913⟩, ⟨1379, 1729⟩⟩
...
def j70 : Jet := ⟨⟨(-141), (-78)⟩, ⟨(-36), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11694, 11758⟩, ⟨(-36), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8581, 15341⟩, ⟨2813, 3817⟩, ⟨222, 233⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843596), (-836835)⟩, ⟨2813, 3817⟩, ⟨222, 233⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1100612), (-614132)⟩, ⟨(-273089), (-199730)⟩, ⟨(-16348), (-15510)⟩, ⟨108, 154⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34690782, 35177263⟩, ⟨(-273089), (-199730)⟩, ⟨(-16348), (-15510)⟩, ⟨108, 154⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨25458706, 45894619⟩, ⟨8129944, 11327079⟩, ⟨596784, 656864⟩, ⟨(-10822), (-7664)⟩, ⟨(-308), (-258)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-690369177), (-669933263)⟩, ⟨8129944, 11327079⟩, ⟨596784, 656864⟩, ⟨(-10822), (-7664)⟩, ⟨(-308), (-258)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-900701964), (-491647442)⟩, ⟨(-219209128), (-149104412)⟩, ⟨(-11646716), (-9105367)⟩, ⟨297600, 439532⟩, ⟨8233, 11328⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3394265332, 3803319854⟩, ⟨(-219209128), (-149104412)⟩, ⟨(-11646716), (-9105367)⟩, ⟨297600, 439532⟩, ⟨8233, 11328⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1070532179, 1520775023⟩, ⟨127439590, 163294721⟩, ⟨(-9216121), (-6289714)⟩, ⟨(-317409), (-230778)⟩, ⟨7515, 11101⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4850169005, 5434679458⟩, ⟨190144826, 350983565⟩, ⟨19065974, 41315266⟩, ⟨574612, 3447310⟩, ⟨11422, 335966⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1208917701, 1924327756⟩, ⟨191307557, 330903919⟩, ⟨(-1267519), 20870664⟩, ⟨(-445831), 2252377⟩, ⟨(-86213), 225938⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1561564210), (-1171173157)⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2733403086, 3123794139⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨340277796, 862180561⟩, ⟨107695856, 296518020⟩, ⟨7385465, 44196239⟩, ⟨(-594816), 5234266⟩, ⟨(-152114), 650946⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4635245092, 5157147857⟩, ⟨107695856, 296518020⟩, ⟨7385465, 44196239⟩, ⟨(-594816), 5234266⟩, ⟨(-152114), 650946⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4461863520, 4706355426⟩, ⟨49141016, 142713375⟩, ⟨1206158, 21000930⟩, ⟨(-958002), 2505956⟩, ⟨(-202790), 343779⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2839619180, 3423002897⟩, ⟨(-182617765), (-98982963)⟩, ⟨(-5718344), 13040956⟩, ⟨(-1651210), 1767804⟩, ⟨(-261383), 293575⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7138862554, 9518483411⟩, ⟨1189810424, 1189810431⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11865831577, 21094811719⟩, ⟨3955277186, 5273702952⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11865831577, 21094811719⟩, ⟨3955277186, 5273702952⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21094811719), (-11865831577)⟩, ⟨(-5273702952), (-3955277186)⟩, ⟨(-329606436), (-329606431)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10547405860), (-5932915788)⟩, ⟨(-2636851476), (-1977638593)⟩, ⟨(-164803218), (-164803215)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨368499707, 1079048187⟩, ⟨(-662470657), (-169677483)⟩, ⟨(-2340006), 189218771⟩, ⟨(-34382490), 17425422⟩, ⟨(-6304820), 5322090⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨243633714, 859979790⟩, ⟨(-573855906), (-120674871)⟩, ⟨608843, 182247520⟩, ⟨(-37873878), 15313362⟩, ⟨(-6355997), 6606488⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1366368683, 1366368684⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4561435853, 4561435861⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified478
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1171173157, 1561564210⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4461863520, 4706355426⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified479
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (45154419 / 4294967296)

theorem envelope_integral : (∫ s in ((54537 / 200000) : ℝ)..(18179 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((54537 / 200000) : ℝ)..(18179 / 50000), prawitzNormalCorrection
