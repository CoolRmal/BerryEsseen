...
namespace FiniteNormalPanel100_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (3941 / 20000)
def radius : Rat := (3941 / 100000)

def j0 : Jet := ⟨⟨846323305, 846323306⟩, ⟨169264661, 169264662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2658803077, 2658803081⟩, ⟨531760615, 531760619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1645934256, 1645934262⟩, ⟨658373702, 658373708⟩, ⟨65837370, 65837372⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨411, 413⟩, ⟨164, 165⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94276), (-94273)⟩, ⟨164, 165⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-36129), (-36127)⟩, ⟨(-14390), (-14387)⟩, ⟨(-1415), (-1412)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5076927, 5076930⟩, ⟨(-14390), (-14387)⟩, ⟨(-1415), (-1412)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1945599, 1945602⟩, ⟨772724, 772728⟩, ⟨75074, 75079⟩, ⟨(-437), (-433)⟩, ⟨(-22), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-141219978), (-141219974)⟩, ⟨772724, 772728⟩, ⟨75074, 75079⟩, ⟨(-437), (-433)⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-54118876), (-54118873)⟩, ⟨(-21351425), (-21351421)⟩, ⟨(-2017536), (-2017529)⟩, ⟨23185, 23190⟩, ⟨1074, 1078⟩⟩
...
def j19 : Jet := ⟨⟨1377536889, 1377536893⟩, ⟨(-21351425), (-21351421)⟩, ⟨(-2017536), (-2017529)⟩, ⟨23185, 23190⟩, ⟨1074, 1078⟩⟩
...
def j25 : Jet := ⟨⟨4519, 4521⟩, ⟨1800, 1803⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847658), (-847655)⟩, ⟨1800, 1803⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-324843), (-324841)⟩, ⟨(-129249), (-129245)⟩, ⟨(-12652), (-12647)⟩, ⟨52, 56⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35466551, 35466554⟩, ⟨(-129249), (-129245)⟩, ⟨(-12652), (-12647)⟩, ⟨52, 56⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13591631, 13591633⟩, ⟨5387120, 5387124⟩, ⟨519003, 519009⟩, ⟨(-3903), (-3897)⟩, ⟨(-187), (-182)⟩⟩
...
def j33 : Jet := ⟨⟨(-702236252), (-702236249)⟩, ⟨5387120, 5387124⟩, ⟨519003, 519009⟩, ⟨(-3903), (-3897)⟩, ⟨(-187), (-182)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-269113739), (-269113736)⟩, ⟨(-105581024), (-105581019)⟩, ⟨(-9739867), (-9739862)⟩, ⟨160639, 160645⟩, ⟨7284, 7290⟩⟩
...
def j36 : Jet := ⟨⟨4025853557, 4025853560⟩, ⟨(-105581024), (-105581019)⟩, ⟨(-9739867), (-9739862)⟩, ⟨160639, 160645⟩, ⟨7284, 7290⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨852765356, 852765361⟩, ⟨157335453, 157335460⟩, ⟨(-3892482), (-3892475)⟩, ⟨(-235440), (-235434)⟩, ⟨3534, 3540⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4582070310, 4582070315⟩, ⟨120168218, 120168226⟩, ⟨14237032, 14237042⟩, ⟨481261, 481273⟩, ⟨33970, 33983⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨909769632, 909769639⟩, ⟨191712146, 191712158⟩, ⟨3076144, 3076157⟩, ⟨257005, 257019⟩, ⟨8652, 8667⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-846323306), (-846323305)⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3448643990, 3448643991⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨192709449, 192709453⟩, ⟨81217794, 81217802⟩, ⟨9860541, 9860552⟩, ⟨383494, 383504⟩, ⟨28809, 28822⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4487676745, 4487676749⟩, ⟨81217794, 81217802⟩, ⟨9860541, 9860552⟩, ⟨383494, 383504⟩, ⟨28809, 28822⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4390264781, 4390264784⟩, ⟨39727418, 39727423⟩, ⟨4643504, 4643511⟩, ⟨145565, 145572⟩, ⟨10318, 10326⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3525163105, 3525163110⟩, ⟨(-141121207), (-141121199)⟩, ⟨2162843, 2162851⟩, ⟨(-66120), (-66112)⟩, ⟨2547, 2556⟩⟩
...
def j47 : Jet := ⟨⟨6071528760, 6071528769⟩, ⟨1214305752, 1214305760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8582943464, 8582943490⟩, ⟨3433177384, 3433177414⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8582943464, 8582943490⟩, ⟨3433177384, 3433177414⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8582943490), (-8582943464)⟩, ⟨(-3433177414), (-3433177384)⟩, ⟨(-343317744), (-343317738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4291471745), (-4291471732)⟩, ⟨(-1716588707), (-1716588692)⟩, ⟨(-171658872), (-171658869)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1581316629, 1581316644⟩, ⟨(-632011866), (-632011854)⟩, ⟨63098307, 63098314⟩, ⟨8433670, 8433673⟩, ⟨(-2103621), (-2103619)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1297890915, 1297890931⟩, ⟨(-570691710), (-570691695)⟩, ⟨73351485, 73351498⟩, ⟨4506214, 4506224⟩, ⟨(-1961251), (-1961238)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨677058644, 1015587967⟩, ⟨169264661, 169264662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2127042461, 3190563697⟩, ⟨531760615, 531760619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1053397923, 2370145336⟩, ⟨526698960, 790048450⟩, ⟨65837370, 65837372⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨263, 594⟩, ⟨131, 198⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94424), (-94092)⟩, ⟨131, 198⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-52108), (-23077)⟩, ⟨(-17338), (-11428)⟩, ⟨(-1429), (-1395)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5060948, 5089980⟩, ⟨(-17338), (-11428)⟩, ⟨(-1429), (-1395)⟩, ⟨3, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1241264, 2808868⟩, ⟨611064, 933488⟩, ⟨73600, 76282⟩, ⟨(-529), (-341)⟩, ⟨(-22), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141924313), (-140356708)⟩, ⟨611064, 933488⟩, ⟨73600, 76282⟩, ⟨(-529), (-341)⟩, ⟨(-22), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-78319863), (-34424351)⟩, ⟨(-25956751), (-16697036)⟩, ⟨(-2082566), (-1937712)⟩, ⟨18099, 28259⟩, ⟨1017, 1125⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1353335902, 1397231415⟩, ⟨(-25956751), (-16697036)⟩, ⟨(-2082566), (-1937712)⟩, ⟨18099, 28259⟩, ⟨1017, 1125⟩⟩
...
def j72 : Jet := ⟨⟨2887, 6518⟩, ⟨1431, 2170⟩, ⟨174, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849290), (-845658)⟩, ⟨1431, 2170⟩, ⟨174, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-468675), (-207408)⟩, ⟨(-155875), (-102506)⟩, ⟨(-12802), (-12463)⟩, ⟨40, 68⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35322719, 35583987⟩, ⟨(-155875), (-102506)⟩, ⟨(-12802), (-12463)⟩, ⟨40, 68⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8663367, 19636756⟩, ⟨4245664, 6520446⟩, ⟨505722, 529840⟩, ⟨(-4736), (-3061)⟩, ⟨(-193), (-176)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707164516), (-696191126)⟩, ⟨4245664, 6520446⟩, ⟨505722, 529840⟩, ⟨(-4736), (-3061)⟩, ⟨(-193), (-176)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-390243410), (-170750144)⟩, ⟨(-129039833), (-81776812)⟩, ⟨(-10195408), (-9180074)⟩, ⟨124484, 196665⟩, ⟨6773, 7704⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3904723886, 4124217152⟩, ⟨(-129039833), (-81776812)⟩, ⟨(-10195408), (-9180074)⟩, ⟨124484, 196665⟩, ⟨6773, 7704⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨670226972, 1037948726⟩, ⟨148274485, 164722405⟩, ⟨(-4760768), (-3026895)⟩, ⟨(-248880), (-218915)⟩, ⟨2743, 4335⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4472786808, 4724212163⟩, ⟨88688405, 156121552⟩, ⟨11714505, 17494495⟩, ⟨204413, 843191⟩, ⟨13857, 62961⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨697975596, 1141682732⟩, ⟨168253090, 218914300⟩, ⟨(-346750), 7063257⟩, ⟨(-10492), 584247⟩, ⟨(-16365), 39549⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1015587967), (-677058644)⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3279379329, 3617908652⟩, ⟨(-169264662), (-169264661)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨113428088, 303480649⟩, ⟨54685654, 116383042⟩, ⟨6406880, 14913145⟩, ⟨(-40926), 1030636⟩, ⟨(-10343), 92202⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4408395384, 4598447945⟩, ⟨54685654, 116383042⟩, ⟨6406880, 14913145⟩, ⟨(-40926), 1030636⟩, ⟨(-10343), 92202⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4351311756, 4444117859⟩, ⟨26425165, 57438009⟩, ⟨2724749, 7279780⟩, ⟨(-116293), 492099⟩, ⟨(-17691), 46188⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3322400577, 3743547121⟩, ⟨(-154966016), (-123101714)⟩, ⟨(-183178), 5090781⟩, ⟨(-384858), 307143⟩, ⟨(-34297), 43491⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4857223008, 7285834521⟩, ⟨1214305752, 1214305760⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5493083817, 12359438620⟩, ⟨2746541908, 4119812896⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5493083817, 12359438620⟩, ⟨2746541908, 4119812896⟩, ⟨343317738, 343317744⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12359438620), (-5493083817)⟩, ⟨(-4119812896), (-2746541908)⟩, ⟨(-343317744), (-343317738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6179719310), (-2746541908)⟩, ⟨(-2059906448), (-1373270954)⟩, ⟨(-171658872), (-171658869)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1018790269, 2265883667⟩, ⟨(-1086738980), (-325747552)⟩, ⟨(-38484394), 219886641⟩, ⟨(-26473698), 35108613⟩, ⟨(-8603759), 3943320⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨788092002, 1974972496⟩, ⟨(-1028970244), (-281184604)⟩, ⟨(-24303591), 233552124⟩, ⟨(-32499641), 32198044⟩, ⟨(-8907319), 4773196⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨846323305, 846323306⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4390264781, 4390264784⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2018
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨677058644, 1015587967⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4351311756, 4444117859⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2019
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (104302197 / 4294967296)

theorem envelope_integral : (∫ s in ((3941 / 25000) : ℝ)..(11823 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((3941 / 25000) : ℝ)..(11823 / 50000), prawitzNormalCorrection
