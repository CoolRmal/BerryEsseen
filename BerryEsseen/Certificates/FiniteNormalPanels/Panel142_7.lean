...
namespace FiniteNormalPanel142_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (26243 / 160000)
def radius : Rat := (26243 / 800000)

def j0 : Jet := ⟨⟨704455167, 704455168⟩, ⟨140891033, 140891034⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2213111177, 2213111181⟩, ⟨442622234, 442622238⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1140372148, 1140372153⟩, ⟨456148856, 456148864⟩, ⟨45614885, 45614887⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨285, 286⟩, ⟨114, 115⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94402), (-94400)⟩, ⟨114, 115⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-25066), (-25064)⟩, ⟨(-9997), (-9994)⟩, ⟨(-989), (-985)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5087990, 5087993⟩, ⟨(-9997), (-9994)⟩, ⟨(-989), (-985)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1350930, 1350932⟩, ⟨537717, 537720⟩, ⟨52712, 52716⟩, ⟨(-213), (-208)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141814647), (-141814644)⟩, ⟨537717, 537720⟩, ⟨52712, 52716⟩, ⟨(-213), (-208)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-37653715), (-37653713)⟩, ⟨(-14918716), (-14918713)⟩, ⟨(-1435046), (-1435042)⟩, ⟨11251, 11255⟩, ⟨533, 536⟩⟩
...
def j19 : Jet := ⟨⟨1394002050, 1394002053⟩, ⟨(-14918716), (-14918713)⟩, ⟨(-1435046), (-1435042)⟩, ⟨11251, 11255⟩, ⟨533, 536⟩⟩
...
def j25 : Jet := ⟨⟨3134, 3136⟩, ⟨1249, 1253⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849043), (-849040)⟩, ⟨1249, 1253⟩, ⟨122, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-225433), (-225431)⟩, ⟨(-89842), (-89839)⟩, ⟨(-8854), (-8849)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35565961, 35565964⟩, ⟨(-89842), (-89839)⟩, ⟨(-8854), (-8849)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9443245, 9443247⟩, ⟨3753443, 3753446⟩, ⟨365836, 365840⟩, ⟨(-1890), (-1885)⟩, ⟨(-94), (-89)⟩⟩
...
def j33 : Jet := ⟨⟨(-706384638), (-706384635)⟩, ⟨3753443, 3753446⟩, ⟨365836, 365840⟩, ⟨(-1890), (-1885)⟩, ⟨(-94), (-89)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-187554716), (-187554714)⟩, ⟨(-74025297), (-74025294)⟩, ⟨(-7006419), (-7006415)⟩, ⟨78214, 78219⟩, ⟨3659, 3663⟩⟩
...
def j36 : Jet := ⟨⟨4107412580, 4107412582⟩, ⟨(-74025297), (-74025294)⟩, ⟨(-7006419), (-7006415)⟩, ⟨78214, 78219⟩, ⟨3659, 3663⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨718301515, 718301519⟩, ⟨135972984, 135972990⟩, ⟨(-2276915), (-2276911)⟩, ⟨(-142094), (-142089)⟩, ⟨1433, 1437⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4491086226, 4491086229⟩, ⟨80940000, 80940005⟩, ⟨9119613, 9119620⟩, ⟨216897, 216906⟩, ⟨13915, 13926⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨751100955, 751100961⟩, ⟨155718465, 155718475⟩, ⟨1706755, 1706764⟩, ⟨133495, 133506⟩, ⟨3178, 3189⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-704455168), (-704455167)⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3590512128, 3590512129⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨131352023, 131352026⟩, ⟨54463878, 54463884⟩, ⟨6242685, 6242691⟩, ⟨170450, 170458⟩, ⟨11466, 11477⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4426319319, 4426319322⟩, ⟨54463878, 54463884⟩, ⟨6242685, 6242691⟩, ⟨170450, 170458⟩, ⟨11466, 11477⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4360148703, 4360148705⟩, ⟨26824839, 26824843⟩, ⟨2992163, 2992167⟩, ⟨65541, 65548⟩, ⟨4216, 4224⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3645002562, 3645002565⟩, ⟨(-120604167), (-120604161)⟩, ⟨1621436, 1621441⟩, ⟨(-43364), (-43357)⟩, ⟨1373, 1383⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨47783629571, 47783629578⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value587

def j47 : Jet := ⟨⟨7837411190, 7837411203⟩, ⟨1567482233, 1567482246⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14301625583, 14301625632⟩, ⟨5720650214, 5720650274⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14301625583, 14301625632⟩, ⟨5720650214, 5720650274⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14301625632), (-14301625583)⟩, ⟨(-5720650274), (-5720650214)⟩, ⟨(-572065030), (-572065019)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7150812816), (-7150812791)⟩, ⟨(-2860325137), (-2860325107)⟩, ⟨(-286032515), (-286032509)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨812625906, 812625919⟩, ⟨(-541185575), (-541185560)⟩, ⟨126088477, 126088487⟩, ⟨(-3962836), (-3962831)⟩, ⟨(-3538784), (-3538781)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨689649840, 689649852⟩, ⟨(-482105856), (-482105840)⟩, ⟨122510750, 122510765⟩, ⟨(-7116258), (-7116247)⟩, ⟨(-2838655), (-2838644)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨563564133, 845346201⟩, ⟨140891033, 140891034⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1770488939, 2655733415⟩, ⟨442622234, 442622238⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨729838172, 1642135897⟩, ⟨364919084, 547378636⟩, ⟨45614885, 45614887⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨182, 412⟩, ⟨91, 138⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94505), (-94274)⟩, ⟨91, 138⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-36133), (-16019)⟩, ⟨(-12030), (-7956)⟩, ⟨(-996), (-978)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5076923, 5097038⟩, ⟨(-12030), (-7956)⟩, ⟨(-996), (-978)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨862714, 1948800⟩, ⟨426757, 648249⟩, ⟨52004, 53293⟩, ⟨(-255), (-165)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142302863), (-141216776)⟩, ⟨426757, 648249⟩, ⟨52004, 53293⟩, ⟨(-255), (-165)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-54408014), (-23996781)⟩, ⟨(-18063487), (-11750538)⟩, ⟨(-1466239), (-1396803)⟩, ⟨8852, 13650⟩, ⟨514, 552⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1377247751, 1407658985⟩, ⟨(-18063487), (-11750538)⟩, ⟨(-1466239), (-1396803)⟩, ⟨8852, 13650⟩, ⟨514, 552⟩⟩
...
def j72 : Jet := ⟨⟨2003, 4519⟩, ⟨995, 1506⟩, ⟨122, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850174), (-847657)⟩, ⟨995, 1506⟩, ⟨122, 126⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-325056), (-144041)⟩, ⟨(-108183), (-71444)⟩, ⟨(-8926), (-8761)⟩, ⟨19, 33⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35466338, 35647354⟩, ⟨(-108183), (-71444)⟩, ⟨(-8926), (-8761)⟩, ⟨19, 33⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6026748, 13629394⟩, ⟨2972011, 4530992⟩, ⟨359470, 371037⟩, ⟨(-2284), (-1489)⟩, ⟨(-95), (-87)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709801135), (-702198488)⟩, ⟨2972011, 4530992⟩, ⟨359470, 371037⟩, ⟨(-2284), (-1489)⟩, ⟨(-95), (-87)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-271385053), (-119323670)⟩, ⟨(-89956656), (-57929456)⟩, ⟨(-7224876), (-6738406)⟩, ⟨61232, 95157⟩, ⟨3488, 3801⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4023582243, 4175643626⟩, ⟨(-89956656), (-57929456)⟩, ⟨(-7224876), (-6738406)⟩, ⟨61232, 95157⟩, ⟨3488, 3801⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨567734686, 870406396⟩, ⟨130764364, 140223880⟩, ⟨(-2768181), (-1786758)⟩, ⟨(-147456), (-135507)⟩, ⟨1123, 1749⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4417700772, 4584656896⟩, ⟨61287557, 102500802⟩, ⟨7979275, 10524008⟩, ⟨105120, 352116⟩, ⟨7823, 22010⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨583958337, 929114103⟩, ⟨142602459, 170454321⟩, ⟨(-34186), 3641440⟩, ⟨33365, 250077⟩, ⟨(-4914), 12573⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-845346201), (-563564133)⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3449621095, 3731403163⟩, ⟨(-140891034), (-140891033)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨79396958, 200991756⟩, ⟨38777428, 73747484⟩, ⟨4719926, 8340299⟩, ⟨6358, 397234⟩, ⟨57, 28378⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4374364254, 4495959052⟩, ⟨38777428, 73747484⟩, ⟨4719926, 8340299⟩, ⟨6358, 397234⟩, ⟨57, 28378⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4334483984, 4394314178⟩, ⟨18950372, 36537571⟩, ⟨2154708, 4090706⟩, ⟨(-31333), 187386⟩, ⟨(-3483), 13790⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3481360009, 3817714244⟩, ⟨(-128929473), (-110444034)⟩, ⟨532042, 2932302⟩, ⟨(-161413), 92117⟩, ⟨(-9173), 13009⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6269928945, 9404893437⟩, ⟨1567482233, 1567482246⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9153040353, 20594340880⟩, ⟨4576520166, 6864780322⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9153040353, 20594340880⟩, ⟨4576520166, 6864780322⟩, ⟨572065019, 572065030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20594340880), (-9153040353)⟩, ⟨(-6864780322), (-4576520166)⟩, ⟨(-572065030), (-572065019)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10297170440), (-4576520176)⟩, ⟨(-3432390161), (-2288260083)⟩, ⟨(-286032515), (-286032509)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨390607174, 1479774643⟩, ⟨(-1182585006), (-208106544)⟩, ⟨(-43111555), 446527317⟩, ⟨(-109710226), 63988940⟩, ⟨(-27653161), 23354714⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨316613399, 1315343365⟩, ⟨(-1095598142), (-178728724)⟩, ⟨(-32921243), 433419578⟩, ⟨(-111786504), 58178659⟩, ⟨(-26559192), 24406706⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨704455167, 704455168⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4360148703, 4360148705⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar587 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2854
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar587 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨563564133, 845346201⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4334483984, 4394314178⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2855
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26243 / 200000) : ℝ)..(78729 / 400000), prawitzNormalCorrection
      ((287259 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
