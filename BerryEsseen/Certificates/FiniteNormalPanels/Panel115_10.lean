...
namespace FiniteNormalPanel115_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (99001 / 400000)
def radius : Rat := (14143 / 400000)

def j0 : Jet := ⟨⟨1063015143, 1063015144⟩, ⟨151859306, 151859307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3339560563, 3339560568⟩, ⟨477080080, 477080084⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2596682113, 2596682121⟩, ⟨741909174, 741909182⟩, ⟨52993512, 52993514⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨649, 651⟩, ⟨185, 186⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94038), (-94035)⟩, ⟨185, 186⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-56855), (-56852)⟩, ⟨(-16134), (-16130)⟩, ⟨(-1123), (-1118)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5056201, 5056205⟩, ⟨(-16134), (-16130)⟩, ⟨(-1123), (-1118)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3056914, 3056917⟩, ⟨863649, 863654⟩, ⟨58920, 58926⟩, ⟨(-392), (-388)⟩, ⟨(-14), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140108663), (-140108659)⟩, ⟨863649, 863654⟩, ⟨58920, 58926⟩, ⟨(-392), (-388)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-84707900), (-84707897)⟩, ⟨(-23680107), (-23680101)⟩, ⟨(-1543925), (-1543919)⟩, ⟨20596, 20602⟩, ⟨649, 655⟩⟩
...
def j19 : Jet := ⟨⟨1346947865, 1346947869⟩, ⟨(-23680107), (-23680101)⟩, ⟨(-1543925), (-1543919)⟩, ⟨20596, 20602⟩, ⟨649, 655⟩⟩
...
def j25 : Jet := ⟨⟨7115, 7118⟩, ⟨2020, 2024⟩, ⟨139, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845062), (-845058)⟩, ⟨2020, 2024⟩, ⟨139, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-510914), (-510911)⟩, ⟨(-144755), (-144750)⟩, ⟨(-9995), (-9989)⟩, ⟨46, 50⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35280480, 35280484⟩, ⟨(-144755), (-144750)⟩, ⟨(-9995), (-9989)⟩, ⟨46, 50⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21330125, 21330128⟩, ⟨6006803, 6006810⟩, ⟨404260, 404267⟩, ⟨(-3487), (-3479)⟩, ⟨(-118), (-112)⟩⟩
...
def j33 : Jet := ⟨⟨(-694497758), (-694497754)⟩, ⟨6006803, 6006810⟩, ⟨404260, 404267⟩, ⟨(-3487), (-3479)⟩, ⟨(-118), (-112)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-419884434), (-419884430)⟩, ⟨(-116335346), (-116335338)⟩, ⟨(-7287051), (-7287042)⟩, ⟨141837, 141846⟩, ⟨4312, 4322⟩⟩
...
def j36 : Jet := ⟨⟨3875082862, 3875082866⟩, ⟨(-116335346), (-116335338)⟩, ⟨(-7287051), (-7287042)⟩, ⟨141837, 141846⟩, ⟨4312, 4322⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1047322054, 1047322059⟩, ⟨131204920, 131204928⟩, ⟨(-3830843), (-3830835)⟩, ⟨(-155484), (-155476)⟩, ⟨2791, 2799⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4760348284, 4760348290⟩, ⟨142912227, 142912240⟩, ⟨13242193, 13242208⟩, ⟨492040, 492057⟩, ⟨29130, 29149⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1160804588, 1160804596⟩, ⟨180270579, 180270593⟩, ⟨3348914, 3348930⟩, ⟨224711, 224728⟩, ⟨8241, 8259⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1063015144), (-1063015143)⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3231952152, 3231952153⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨313731676, 313731682⟩, ⟨97443774, 97443786⟩, ⟨9376635, 9376649⟩, ⟨402588, 402604⟩, ⟨25927, 25944⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4608698972, 4608698978⟩, ⟨97443774, 97443786⟩, ⟨9376635, 9376649⟩, ⟨402588, 402604⟩, ⟨25927, 25944⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4449068594, 4449068598⟩, ⟨47034318, 47034325⟩, ⟨4277312, 4277320⟩, ⟨149102, 149112⟩, ⟨8881, 8892⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3347912993, 3347912998⟩, ⟨(-121914738), (-121914730)⟩, ⟨1555649, 1555658⟩, ⟨(-39038), (-39028)⟩, ⟨1409, 1421⟩⟩
...
def j47 : Jet := ⟨⟨9658547218, 9658547230⟩, ⟨1379792458, 1379792468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨21720196670, 21720196725⟩, ⟨6205770468, 6205770524⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨21720196670, 21720196725⟩, ⟨6205770468, 6205770524⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-21720196725), (-21720196670)⟩, ⟨(-6205770524), (-6205770468)⟩, ⟨(-443269326), (-443269318)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10860098363), (-10860098335)⟩, ⟨(-3102885262), (-3102885234)⟩, ⟨(-221634663), (-221634659)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨342624643, 342624654⟩, ⟨(-247528076), (-247528065)⟩, ⟨71732348, 71732354⟩, ⟨(-8758753), (-8758750)⟩, ⟨(-268883), (-268881)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨267074791, 267074801⟩, ⟨(-202672896), (-202672884)⟩, ⟨63065434, 63065442⟩, ⟨(-8956349), (-8956342)⟩, ⟨67369, 67377⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨911155837, 1214874450⟩, ⟨151859306, 151859307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2862480483, 3816640648⟩, ⟨477080080, 477080084⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1907766451, 3391584809⟩, ⟨635922148, 847896208⟩, ⟨52993512, 52993514⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨477, 850⟩, ⟨159, 213⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94210), (-93836)⟩, ⟨159, 213⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-74395), (-41680)⟩, ⟨(-18529), (-13724)⟩, ⟨(-1135), (-1102)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5038661, 5071377⟩, ⟨(-18529), (-13724)⟩, ⟨(-1135), (-1102)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2238105, 4004689⟩, ⟨731403, 995077⟩, ⟨57614, 60053⟩, ⟨(-454), (-327)⟩, ⟨(-15), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140927472), (-139160887)⟩, ⟨731403, 995077⟩, ⟨57614, 60053⟩, ⟨(-454), (-327)⟩, ⟨(-15), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-111285475), (-61813386)⟩, ⟨(-27496490), (-19818683)⟩, ⟨(-1604952), (-1473171)⟩, ⟨17195, 23989⟩, ⟨608, 689⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1320370290, 1369842380⟩, ⟨(-27496490), (-19818683)⟩, ⟨(-1604952), (-1473171)⟩, ⟨17195, 23989⟩, ⟨608, 689⟩⟩
...
def j72 : Jet := ⟨⟨5218, 9310⟩, ⟨1721, 2322⟩, ⟨137, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846959), (-842866)⟩, ⟨1721, 2322⟩, ⟨137, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-668814), (-374389)⟩, ⟨(-166440), (-122962)⟩, ⟨(-10137), (-9826)⟩, ⟨39, 58⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35122580, 35417006⟩, ⟨(-166440), (-122962)⟩, ⟨(-10137), (-9826)⟩, ⟨39, 58⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15600975, 27967566⟩, ⟨5068893, 6937274⟩, ⟨392497, 414424⟩, ⟨(-4039), (-2925)⟩, ⟨(-122), (-107)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700226908), (-687860316)⟩, ⟨5068893, 6937274⟩, ⟨392497, 414424⟩, ⟨(-4039), (-2925)⟩, ⟨(-122), (-107)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-552944594), (-305538259)⟩, ⟨(-135984617), (-96367964)⟩, ⟨(-7714908), (-6790385)⟩, ⟨117465, 166112⟩, ⟨3947, 4634⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3742022702, 3989429037⟩, ⟨(-135984617), (-96367964)⟩, ⟨(-7714908), (-6790385)⟩, ⟨117465, 166112⟩, ⟨3947, 4634⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨879991377, 1217284266⟩, ⟨122230998, 138951915⟩, ⟨(-4480489), (-3183264)⟩, ⟨(-166817), (-142320)⟩, ⟨2315, 3278⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4623905802, 4929618430⟩, ⟨111694275, 179141692⟩, ⟨10568390, 16673355⟩, ⟨240141, 830097⟩, ⟨10602, 56161⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨947387244, 1397157776⟩, ⟨154477222, 210256848⟩, ⟨201512, 7094161⟩, ⟨(-28378), 538686⟩, ⟨(-12854), 35004⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1214874450), (-911155837)⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3080092846, 3383811459⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨208975418, 454497024⟩, ⟨68149412, 136793588⟩, ⟨5644985, 14908442⟩, ⟨(-3970), 1045052⟩, ⟨(-11135), 87234⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4503942714, 4749464320⟩, ⟨68149412, 136793588⟩, ⟨5644985, 14908442⟩, ⟨(-3970), 1045052⟩, ⟨(-11135), 87234⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4398214030, 4516502400⟩, ⟨32403336, 66791201⟩, ⟨2190185, 7159872⟩, ⟨(-110669), 494125⟩, ⟨(-18770), 43730⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3154135208, 3558348999⟩, ⟨(-136454507), (-102888070)⟩, ⟨(-790901), 4495241⟩, ⟨(-340348), 311860⟩, ⟨(-32261), 38366⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8278754760, 11038339689⟩, ⟨1379792458, 1379792468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15957695519, 28369236526⟩, ⟨5319231832, 7092309168⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15957695519, 28369236526⟩, ⟨5319231832, 7092309168⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-28369236526), (-15957695519)⟩, ⟨(-7092309168), (-5319231832)⟩, ⟨(-443269326), (-443269318)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-14184618263), (-7978847759)⟩, ⟨(-3546154584), (-2659615916)⟩, ⟨(-221634663), (-221634659)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨157998479, 670134853⟩, ⟨(-553299157), (-97838991)⟩, ⟨(-4288285), 220263432⟩, ⟨(-57254543), 20214937⟩, ⟨(-9855798), 11928748⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨116030817, 555201826⟩, ⟨(-479695021), (-75635863)⟩, ⟨(-1332435), 200766779⟩, ⟨(-55065119), 17034718⟩, ⟨(-8893473), 11982272⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1063015143, 1063015144⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4449068594, 4449068598⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2320
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨911155837, 1214874450⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4398214030, 4516502400⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2321
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (10271109 / 2147483648)

theorem envelope_integral : (∫ s in ((42429 / 200000) : ℝ)..(14143 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((42429 / 200000) : ℝ)..(14143 / 50000), prawitzNormalCorrection
