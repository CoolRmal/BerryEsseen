...
namespace FiniteNormalPanel170_15
...
def j2 : Jet := ⟨⟨1286729805, 1286729809⟩, ⟨428909933, 428909937⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨385491547, 385491551⟩, ⟨256994364, 256994368⟩, ⟨42832393, 42832395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-8490), (-8489)⟩, ⟨(-5655), (-5653)⟩, ⟨(-941), (-938)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104566, 5104568⟩, ⟨(-5655), (-5653)⟩, ⟨(-941), (-938)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨458156, 458157⟩, ⟨304929, 304931⟩, ⟨50482, 50485⟩, ⟨(-114), (-111)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-142707421), (-142707419)⟩, ⟨304929, 304931⟩, ⟨50482, 50485⟩, ⟨(-114), (-111)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-12808597), (-12808596)⟩, ⟨(-8511697), (-8511695)⟩, ⟨(-1400403), (-1400399)⟩, ⟨6049, 6053⟩, ⟨495, 498⟩⟩
...
def j19 : Jet := ⟨⟨1418847168, 1418847170⟩, ⟨(-8511697), (-8511695)⟩, ⟨(-1400403), (-1400399)⟩, ⟨6049, 6053⟩, ⟨495, 498⟩⟩
...
def j28 : Jet := ⟨⟨(-76392), (-76391)⟩, ⟨(-50865), (-50863)⟩, ⟨(-8436), (-8433)⟩, ⟨12, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35715002, 35715004⟩, ⟨(-50865), (-50863)⟩, ⟨(-8436), (-8433)⟩, ⟨12, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3205573, 3205574⟩, ⟨2132482, 2132484⟩, ⟨352372, 352376⟩, ⟨(-1012), (-1009)⟩, ⟨(-86), (-82)⟩⟩
...
def j33 : Jet := ⟨⟨(-712622310), (-712622308)⟩, ⟨2132482, 2132484⟩, ⟨352372, 352376⟩, ⟨(-1012), (-1009)⟩, ⟨(-86), (-82)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-63960879), (-63960877)⟩, ⟨(-42449187), (-42449184)⟩, ⟨(-6947540), (-6947535)⟩, ⟨42259, 42262⟩, ⟨3445, 3448⟩⟩
...
def j36 : Jet := ⟨⟨4231006417, 4231006419⟩, ⟨(-42449187), (-42449184)⟩, ⟨(-6947540), (-6947535)⟩, ⟨42259, 42262⟩, ⟨3445, 3448⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨425072605, 425072608⟩, ⟨139140846, 139140851⟩, ⟨(-1269554), (-1269551)⟩, ⟨(-138037), (-138034)⟩, ⟨752, 755⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4359895080, 4359895084⟩, ⟨43742307, 43742312⟩, ⟨7598037, 7598045⟩, ⟨104506, 104514⟩, ⟨9531, 9540⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨431498503, 431498507⟩, ⟨145573434, 145573443⟩, ⟨880316, 880323⟩, ⟨103435, 103444⟩, ⟨1439, 1448⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-409578819), (-409578818)⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3885388477, 3885388478⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨43350960, 43350962⟩, ⟨29250382, 29250386⟩, ⟨5110941, 5110947⟩, ⟨80456, 80462⟩, ⟨7478, 7487⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4338318256, 4338318258⟩, ⟨29250382, 29250386⟩, ⟨5110941, 5110947⟩, ⟨80456, 80462⟩, ⟨7478, 7487⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4316588355, 4316588357⟩, ⟨14551935, 14551938⟩, ⟨2518142, 2518146⟩, ⟨31537, 31542⟩, ⟨2879, 2885⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3904947697, 3904947701⟩, ⟨(-124049327), (-124049322)⟩, ⟨1815435, 1815441⟩, ⟨(-51517), (-51510)⟩, ⟨1601, 1608⟩⟩
...
def j47 : Jet := ⟨⟨4494453251, 4494453264⟩, ⟨1498151076, 1498151088⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4703204619, 4703204647⟩, ⟨3135469730, 3135469766⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4703204619, 4703204647⟩, ⟨3135469730, 3135469766⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4703204647), (-4703204619)⟩, ⟨(-3135469766), (-3135469730)⟩, ⟨(-522578295), (-522578285)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2351602324), (-2351602309)⟩, ⟨(-1567734883), (-1567734865)⟩, ⟨(-261289148), (-261289142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2484120956, 2484120971⟩, ⟨(-906745694), (-906745677)⟩, ⟨14364382, 14364393⟩, ⟨35027510, 35027514⟩, ⟨(-3633345), (-3633343)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2258541622, 2258541639⟩, ⟨(-896153052), (-896153031)⟩, ⟨40299050, 40299067⟩, ⟨31018763, 31018776⟩, ⟨(-4297219), (-4297205)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨273052545, 546105092⟩, ⟨136526272, 136526273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨857819869, 1715639746⟩, ⟨428909933, 428909937⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨171329576, 685318313⟩, ⟨171329574, 342659158⟩, ⟨42832393, 42832395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-15102), (-3770)⟩, ⟨(-7550), (-3756)⟩, ⟨(-943), (-933)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097954, 5109287⟩, ⟨(-7550), (-3756)⟩, ⟨(-943), (-933)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨203361, 815254⟩, ⟨202156, 407478⟩, ⟨50086, 50768⟩, ⟨(-152), (-73)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142962216), (-142350322)⟩, ⟨202156, 407478⟩, ⟨50086, 50768⟩, ⟨(-152), (-73)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-22811495), (-5678464)⟩, ⟨(-11397684), (-5613445)⟩, ⟨(-1415658), (-1379005)⟩, ⟨3988, 8113⟩, ⟨484, 505⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1408844270, 1425977302⟩, ⟨(-11397684), (-5613445)⟩, ⟨(-1415658), (-1379005)⟩, ⟨3988, 8113⟩, ⟨484, 505⟩⟩
...
def j74 : Jet := ⟨⟨(-135901), (-33918)⟩, ⟨(-67933), (-33767)⟩, ⟨(-8472), (-8384)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35655493, 35757477⟩, ⟨(-67933), (-33767)⟩, ⟨(-8472), (-8384)⟩, ⟨7, 20⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1422325, 5705575⟩, ⟨1411485, 2851442⟩, ⟨348809, 354919⟩, ⟨(-1354), (-666)⟩, ⟨(-86), (-80)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714405558), (-710122307)⟩, ⟨1411485, 2851442⟩, ⟨348809, 354919⟩, ⟨(-1354), (-666)⟩, ⟨(-86), (-80)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-113992769), (-28327329)⟩, ⟨(-56940080), (-27872344)⟩, ⟨(-7054330), (-6797707)⟩, ⟨27773, 56727⟩, ⟨3355, 3511⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4180974527, 4266639967⟩, ⟨(-56940080), (-27872344)⟩, ⟨(-7054330), (-6797707)⟩, ⟨27773, 56727⟩, ⟨3355, 3511⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨281383890, 569611634⟩, ⟨136139099, 141281754⟩, ⟨(-1703702), (-836001)⟩, ⟨(-140577), (-134471)⟩, ⟨494, 1013⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4323482697, 4412068037⟩, ⟨28243675, 60087309⟩, ⟨7072774, 8262563⟩, ⟨32540, 185192⟩, ⟨7050, 12808⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨283252070, 585141891⟩, ⟨138893339, 153102713⟩, ⟨(-391533), 2230812⟩, ⟨58073, 155496⟩, ⟨(-3256), 6572⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-546105092), (-273052545)⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3748862204, 4021914751⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨18680406, 79719125⟩, ⟨18319964, 41717110⟩, ⟨4384933, 6065501⟩, ⟨(-20256), 201414⟩, ⟨2664, 14037⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4313647702, 4374686421⟩, ⟨18319964, 41717110⟩, ⟨4384933, 6065501⟩, ⟨(-20256), 201414⟩, ⟨2664, 14037⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304297365, 4334643597⟩, ⟨9076137, 20813342⟩, ⟨2122428, 3016608⟩, ⟨(-24694), 96014⟩, ⟨(-194), 6601⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3757005954, 4059068632⟩, ⟨(-129865378), (-117332717)⟩, ⟨1190956, 2536321⟩, ⟨(-119016), 22444⟩, ⟨(-3235), 6967⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2996302164, 5992604352⟩, ⟨1498151076, 1498151088⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2090313159, 8361252705⟩, ⟨2090313150, 4180626354⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2090313159, 8361252705⟩, ⟨2090313150, 4180626354⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8361252705), (-2090313159)⟩, ⟨(-4180626354), (-2090313150)⟩, ⟨(-522578295), (-522578285)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4180626353), (-1045156579)⟩, ⟨(-2090313177), (-1045156575)⟩, ⟨(-261289148), (-261289142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1622658761, 3367260354⟩, ⟨(-1638808448), (-394865049)⟩, ⟨(-156806943), 300078731⟩, ⟨(-32666965), 91904569⟩, ⟨(-20310048), 8744427⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1419414446, 3182315473⟩, ⟨(-1650612454), (-389735517)⟩, ⟨(-136957282), 335137617⟩, ⟨(-41007204), 91506184⟩, ⟨(-22077118), 9479968⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4316588355, 4316588357⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3450
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304297365, 4334643597⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3451
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (144561327 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((2543 / 40000) : ℝ)..(2543 / 20000), prawitzNormalCorrection
