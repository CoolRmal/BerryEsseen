...
namespace FiniteNormalPanel13_19
...
def j2 : Jet := ⟨⟨1939961492, 1939961497⟩, ⟨646653829, 646653834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨876246623, 876246628⟩, ⟨584164414, 584164422⟩, ⟨97360735, 97360737⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨219, 220⟩, ⟨146, 147⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94468), (-94466)⟩, ⟨146, 147⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-19274), (-19272)⟩, ⟨(-12820), (-12818)⟩, ⟨(-2119), (-2115)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5093782, 5093785⟩, ⟨(-12820), (-12818)⟩, ⟨(-2119), (-2115)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1039218, 1039220⟩, ⟨690196, 690198⟩, ⟨113291, 113295⟩, ⟨(-579), (-575)⟩, ⟨(-49), (-44)⟩⟩
...
def j16 : Jet := ⟨⟨(-142126359), (-142126356)⟩, ⟨690196, 690198⟩, ⟨113291, 113295⟩, ⟨(-579), (-575)⟩, ⟨(-49), (-44)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-28996203), (-28996202)⟩, ⟨(-19189991), (-19189988)⟩, ⟨(-3104814), (-3104810)⟩, ⟨30934, 30939⟩, ⟨2479, 2483⟩⟩
...
def j19 : Jet := ⟨⟨1402659562, 1402659564⟩, ⟨(-19189991), (-19189988)⟩, ⟨(-3104814), (-3104810)⟩, ⟨30934, 30939⟩, ⟨2479, 2483⟩⟩
...
def j22 : Jet := ⟨⟨(-23), (-21)⟩, ⟨(-15), (-14)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11812, 11815⟩, ⟨(-15), (-14)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2409, 2411⟩, ⟨1602, 1605⟩, ⟨263, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849768), (-849765)⟩, ⟨1602, 1605⟩, ⟨263, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-173368), (-173366)⟩, ⟨(-115253), (-115249)⟩, ⟨(-18994), (-18988)⟩, ⟨70, 74⟩, ⟨3, 7⟩⟩
...
def j30 : Jet := ⟨⟨35618026, 35618029⟩, ⟨(-115253), (-115249)⟩, ⟨(-18994), (-18988)⟩, ⟨70, 74⟩, ⟨3, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7266685, 7266686⟩, ⟨4820942, 4820946⟩, ⟨787857, 787862⟩, ⟨(-5183), (-5178)⟩, ⟨(-422), (-417)⟩⟩
...
def j33 : Jet := ⟨⟨(-708561198), (-708561196)⟩, ⟨4820942, 4820946⟩, ⟨787857, 787862⟩, ⟨(-5183), (-5178)⟩, ⟨(-422), (-417)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-144558577), (-144558575)⟩, ⟨(-95388832), (-95388827)⟩, ⟨(-15245627), (-15245621)⟩, ⟨215382, 215387⟩, ⟨17067, 17071⟩⟩
...
def j36 : Jet := ⟨⟨4150408719, 4150408721⟩, ⟨(-95388832), (-95388827)⟩, ⟨(-15245627), (-15245621)⟩, ⟨215382, 215387⟩, ⟨17067, 17071⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨633556753, 633556757⟩, ⟨202517800, 202517805⟩, ⟨(-4291652), (-4291648)⟩, ⟨(-453492), (-453487)⟩, ⟨5776, 5781⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4444560840, 4444560843⟩, ⟨102149323, 102149331⟩, ⟨18673821, 18673830⟩, ⟨573751, 573760⟩, ⟨58196, 58206⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨655623510, 655623515⟩, ⟨224639679, 224639687⟩, ⟨3130050, 3130061⟩, ⟨393789, 393801⟩, ⟨12168, 12181⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-617508923), (-617508922)⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3677458373, 3677458374⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨100080433, 100080435⟩, ⟨68582154, 68582158⟩, ⟨12704927, 12704935⟩, ⟨447644, 447652⟩, ⟨47187, 47196⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4395047729, 4395047731⟩, ⟨68582154, 68582158⟩, ⟨12704927, 12704935⟩, ⟨447644, 447652⟩, ⟨47187, 47196⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4344719353, 4344719355⟩, ⟨33898404, 33898407⟩, ⟨6147478, 6147484⟩, ⟨173294, 173300⟩, ⟨17621, 17628⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3720057328, 3720057331⟩, ⟨(-179196016), (-179196010)⟩, ⟨3639042, 3639049⟩, ⟨(-146241), (-146233)⟩, ⟨6781, 6789⟩⟩
...
def j47 : Jet := ⟨⟨3099575684, 3099575691⟩, ⟨1033191893, 1033191899⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2236890006, 2236890017⟩, ⟨1491260000, 1491260014⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2236890006, 2236890017⟩, ⟨1491260000, 1491260014⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2236890017), (-2236890006)⟩, ⟨(-1491260014), (-1491260000)⟩, ⟨(-248543337), (-248543333)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1118445009), (-1118445003)⟩, ⟨(-745630007), (-745630000)⟩, ⟨(-124271669), (-124271666)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3310289569, 3310289579⟩, ⟨(-574684526), (-574684518)⟩, ⟨(-45896556), (-45896551)⟩, ⟨13741342, 13741344⟩, ⟨67597, 67599⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2867185270, 2867185282⟩, ⟨(-635872151), (-635872137)⟩, ⟨(-12971082), (-12971068)⟩, ⟨13217247, 13217260⟩, ⟨(-528869), (-528855)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨411672615, 823345231⟩, ⟨205836307, 205836308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1293307662, 2586615330⟩, ⟨646653829, 646653834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨389442944, 1557771784⟩, ⟨389442942, 778885894⟩, ⟨97360735, 97360737⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨97, 391⟩, ⟨97, 196⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94590), (-94295)⟩, ⟨97, 196⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34308), (-8550)⟩, ⟨(-17146), (-8478)⟩, ⟨(-2135), (-2091)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078748, 5104507⟩, ⟨(-17146), (-8478)⟩, ⟨(-2135), (-2091)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨460511, 1851390⟩, ⟨454292, 924927⟩, ⟨111242, 114755⟩, ⟨(-777), (-377)⟩, ⟨(-49), (-44)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142705066), (-141314186)⟩, ⟨454292, 924927⟩, ⟨111242, 114755⟩, ⟨(-777), (-377)⟩, ⟨(-49), (-44)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-51758701), (-12813558)⟩, ⟨(-25838159), (-12478088)⟩, ⟨(-3183641), (-2994032)⟩, ⟨20102, 41744⟩, ⟨2362, 2565⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1379897064, 1418842208⟩, ⟨(-25838159), (-12478088)⟩, ⟨(-3183641), (-2994032)⟩, ⟨20102, 41744⟩, ⟨2362, 2565⟩⟩
...
def j72 : Jet := ⟨⟨1069, 4290⟩, ⟨1061, 2145⟩, ⟨261, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851108), (-847886)⟩, ⟨1061, 2145⟩, ⟨261, 269⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-308695), (-76881)⟩, ⟨(-154252), (-76103)⟩, ⟨(-19175), (-18733)⟩, ⟨46, 98⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35482699, 35714514⟩, ⟨(-154252), (-76103)⟩, ⟨(-19175), (-18733)⟩, ⟨46, 98⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3217367, 12953548⟩, ⟨3161420, 6469874⟩, ⟨769412, 800999⟩, ⟨(-6971), (-3387)⟩, ⟨(-431), (-403)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712610516), (-702874334)⟩, ⟨3161420, 6469874⟩, ⟨769412, 800999⟩, ⟨(-6971), (-3387)⟩, ⟨(-431), (-403)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-258461702), (-63732604)⟩, ⟨(-128944193), (-61385999)⟩, ⟨(-15797433), (-14469328)⟩, ⟨138900, 291616⟩, ⟨16019, 17815⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4036505594, 4231234692⟩, ⟨(-128944193), (-61385999)⟩, ⟨(-15797433), (-14469328)⟩, ⟨138900, 291616⟩, ⟨16019, 17815⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨415516888, 854488231⟩, ⟨192197584, 209864637⟩, ⟨(-5807542), (-2780278)⟩, ⟨(-473279), (-425642)⟩, ⟨3737, 7831⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4359659866, 4569978573⟩, ⟨63249168, 145985727⟩, ⟨15826103, 22548699⟩, ⟨130928, 1141624⟩, ⟨26714, 105241⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨421775574, 909202012⟩, ⟨201211587, 252346504⟩, ⟨(-1817942), 8797222⟩, ⟨19892, 855928⟩, ⟨(-34342), 68543⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-823345231), (-411672615)⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3471622065, 3883294681⟩, ⟨(-205836308), (-205836307)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨41419322, 192469056⟩, ⟨39518872, 106838510⟩, ⟨8656723, 18550937⟩, ⟨(-209718), 1396128⟩, ⟨(-16402), 147620⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4336386618, 4487436352⟩, ⟨39518872, 106838510⟩, ⟨8656723, 18550937⟩, ⟨(-209718), 1396128⟩, ⟨(-16402), 147620⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4315627266, 4390147193⟩, ⟨19331044, 53163524⟩, ⟨3912622, 9187770⟩, ⟨(-217541), 677197⟩, ⟨(-26286), 74364⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3488321518, 3969351585⟩, ⟨(-194772523), (-158758635)⟩, ⟨614710, 7380683⟩, ⟨(-637014), 424776⟩, ⟨(-56222), 77663⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2066383791, 4132767589⟩, ⟨1033191893, 1033191899⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨994173337, 3976693365⟩, ⟨994173334, 1988346686⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨994173337, 3976693365⟩, ⟨994173334, 1988346686⟩, ⟨248543333, 248543337⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3976693365), (-994173337)⟩, ⟨(-1988346686), (-994173334)⟩, ⟨(-248543337), (-248543333)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1988346683), (-497086668)⟩, ⟨(-994173343), (-497086667)⟩, ⟨(-124271669), (-124271666)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2703361238, 3825567921⟩, ⟨(-885519583), (-312878942)⟩, ⟨(-92584113), 24267654⟩, ⟨4162834, 24224838⟩, ⟨(-1752939), 1218978⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2195637947, 3535538933⟩, ⟨(-991871134), (-354043274)⟩, ⟨(-73612873), 69159327⟩, ⟨191373, 26920444⟩, ⟨(-3015375), 1214907⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4344719353, 4344719355⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified270
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4315627266, 4390147193⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified271
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (137214287 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((1917 / 20000) : ℝ)..(1917 / 10000), prawitzNormalCorrection
