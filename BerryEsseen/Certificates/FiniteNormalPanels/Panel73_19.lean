...
namespace FiniteNormalPanel73_19
...
def j2 : Jet := ⟨⟨1766053105, 1766053109⟩, ⟨588684367, 588684371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨726185638, 726185643⟩, ⟨484123758, 484123764⟩, ⟨80687292, 80687294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨181, 182⟩, ⟨121, 122⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94506), (-94504)⟩, ⟨121, 122⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-15979), (-15978)⟩, ⟨(-10633), (-10631)⟩, ⟨(-1760), (-1757)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097077, 5097079⟩, ⟨(-10633), (-10631)⟩, ⟨(-1760), (-1757)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨861804, 861806⟩, ⟨572738, 572740⟩, ⟨94259, 94262⟩, ⟨(-399), (-395)⟩, ⟨(-34), (-31)⟩⟩
...
def j16 : Jet := ⟨⟨(-142303773), (-142303770)⟩, ⟨572738, 572740⟩, ⟨94259, 94262⟩, ⟨(-399), (-395)⟩, ⟨(-34), (-31)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-24060476), (-24060475)⟩, ⟨(-15943481), (-15943478)⟩, ⟨(-2592892), (-2592889)⟩, ⟨21315, 21320⟩, ⟨1719, 1722⟩⟩
...
def j19 : Jet := ⟨⟨1407595289, 1407595291⟩, ⟨(-15943481), (-15943478)⟩, ⟨(-2592892), (-2592889)⟩, ⟨21315, 21320⟩, ⟨1719, 1722⟩⟩
...
def j25 : Jet := ⟨⟨1997, 1999⟩, ⟨1328, 1331⟩, ⟨218, 222⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850180), (-850177)⟩, ⟨1328, 1331⟩, ⟨218, 222⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-143747), (-143746)⟩, ⟨(-95608), (-95604)⟩, ⟨(-15787), (-15782)⟩, ⟨47, 52⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35647647, 35647649⟩, ⟨(-95608), (-95604)⟩, ⟨(-15787), (-15782)⟩, ⟨47, 52⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6027242, 6027243⟩, ⟨4001995, 4001998⟩, ⟨656246, 656250⟩, ⟨(-3570), (-3565)⟩, ⟨(-292), (-289)⟩⟩
...
def j33 : Jet := ⟨⟨(-709800641), (-709800639)⟩, ⟨4001995, 4001998⟩, ⟨656246, 656250⟩, ⟨(-3570), (-3565)⟩, ⟨(-292), (-289)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-120011865), (-120011863)⟩, ⟨(-79331261), (-79331258)⟩, ⟨(-12772596), (-12772592)⟩, ⟨148550, 148554⟩, ⟨11875, 11880⟩⟩
...
def j36 : Jet := ⟨⟨4174955431, 4174955433⟩, ⟨(-79331261), (-79331258)⟩, ⟨(-12772596), (-12772592)⟩, ⟨148550, 148554⟩, ⟨11875, 11880⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨578790910, 578790913⟩, ⟨186374481, 186374486⟩, ⟨(-3251449), (-3251446)⟩, ⟨(-346628), (-346624)⟩, ⟨3627, 3632⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4418428979, 4418428982⟩, ⟨83957669, 83957674⟩, ⟨15112796, 15112804⟩, ⟨386804, 386812⟩, ⟨38023, 38033⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨595428638, 595428643⟩, ⟨203046096, 203046104⟩, ⟨2334922, 2334930⟩, ⟨287771, 287782⟩, ⟨7421, 7434⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-562152164), (-562152163)⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3732815132, 3732815133⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨82546673, 82546675⟩, ⟨56298198, 56298202⟩, ⟨10246473, 10246479⟩, ⟨300556, 300564⟩, ⟨30533, 30542⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4377513969, 4377513971⟩, ⟨56298198, 56298202⟩, ⟨10246473, 10246479⟩, ⟨300556, 300564⟩, ⟨30533, 30542⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4336044203, 4336044205⟩, ⟨27882432, 27882435⟩, ⟨4985054, 4985059⟩, ⟨116797, 116803⟩, ⟨11503, 11510⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3768515636, 3768515640⟩, ⟨(-164943185), (-164943180)⟩, ⟨3116102, 3116109⟩, ⟨(-115983), (-115975)⟩, ⟨4901, 4909⟩⟩
...
def j47 : Jet := ⟨⟨3335526585, 3335526593⟩, ⟨1111842193, 1111842200⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2590412646, 2590412659⟩, ⟨1726941760, 1726941778⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2590412646, 2590412659⟩, ⟨1726941760, 1726941778⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2590412659), (-2590412646)⟩, ⟨(-1726941778), (-1726941760)⟩, ⟨(-287823630), (-287823626)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1295206330), (-1295206323)⟩, ⟨(-863470889), (-863470880)⟩, ⟨(-143911815), (-143911813)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3176818477, 3176818485⟩, ⟨(-638675476), (-638675467)⟩, ⟨(-42245463), (-42245459)⟩, ⟨17097810, 17097812⟩, ⟨(-151586), (-151585)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2787422878, 2787422889⟩, ⟨(-682392410), (-682392395)⟩, ⟨(-10234826), (-10234812)⟩, ⟨16075283, 16075296⟩, ⟨(-799409), (-799396)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨374768108, 749536218⟩, ⟨187384054, 187384055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1177368734, 2354737477⟩, ⟨588684367, 588684371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨322749171, 1290996696⟩, ⟨322749170, 645498350⟩, ⟨80687292, 80687294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨80, 324⟩, ⟨80, 162⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94607), (-94362)⟩, ⟨80, 162⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-28438), (-7090)⟩, ⟨(-14213), (-7041)⟩, ⟨(-1771), (-1740)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5084618, 5105967⟩, ⟨(-14213), (-7041)⟩, ⟨(-1771), (-1740)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨382088, 1534770⟩, ⟨377815, 766856⟩, ⟨92852, 95265⟩, ⟨(-535), (-259)⟩, ⟨(-34), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142783489), (-141630806)⟩, ⟨377815, 766856⟩, ⟨92852, 95265⟩, ⟨(-535), (-259)⟩, ⟨(-34), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-42918374), (-10642973)⟩, ⟨(-21430797), (-10412468)⟩, ⟨(-2647031), (-2516854)⟩, ⟨13913, 28706⟩, ⟨1652, 1769⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1388737391, 1421012793⟩, ⟨(-21430797), (-10412468)⟩, ⟨(-2647031), (-2516854)⟩, ⟨13913, 28706⟩, ⟨1652, 1769⟩⟩
...
def j72 : Jet := ⟨⟨886, 3556⟩, ⟨880, 1778⟩, ⟨217, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851291), (-848620)⟩, ⟨880, 1778⟩, ⟨217, 223⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-255885), (-63770)⟩, ⟨(-127877), (-63235)⟩, ⟨(-15911), (-15606)⟩, ⟨31, 68⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35535509, 35727625⟩, ⟨(-127877), (-63235)⟩, ⟨(-15911), (-15606)⟩, ⟨31, 68⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2670347, 10739138⟩, ⟨2631909, 5364818⟩, ⟨643584, 665274⟩, ⟨(-4793), (-2338)⟩, ⟨(-297), (-280)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713157536), (-705088744)⟩, ⟨2631909, 5364818⟩, ⟨643584, 665274⟩, ⟨(-4793), (-2338)⟩, ⟨(-297), (-280)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-214363454), (-52984526)⟩, ⟨(-106983951), (-51371949)⟩, ⟨(-13151577), (-12239871)⟩, ⟨96365, 200598⟩, ⟨11279, 12303⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4080603842, 4241982770⟩, ⟨(-106983951), (-51371949)⟩, ⟨(-13151577), (-12239871)⟩, ⟨96365, 200598⟩, ⟨11279, 12303⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨380691137, 779077430⟩, ⟨178596025, 191915014⟩, ⟨(-4388635), (-2117110)⟩, ⟨(-359000), (-329230)⟩, ⟨2358, 4905⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4348613625, 4520591753⟩, ⟨52663286, 118519413⟩, ⟨13185315, 17676940⟩, ⟨97860, 742739⟩, ⟨20512, 63184⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨385446163, 820004150⟩, ⟨185494672, 223495353⟩, ⟨(-1260604), 6358808⟩, ⟨57988, 565299⟩, ⟨(-19696), 39279⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-749536218), (-374768108)⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3545431078, 3920199188⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨34591356, 156556910⟩, ⟨33293948, 85340402⟩, ⟨7529944, 14058005⟩, ⟨(-120788), 877640⟩, ⟨(-4381), 83249⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4329558652, 4451524206⟩, ⟨33293948, 85340402⟩, ⟨7529944, 14058005⟩, ⟨(-120788), 877640⟩, ⟨(-4381), 83249⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4312228289, 4372545127⟩, ⟨16351622, 42499401⟩, ⟨3491634, 6969865⟩, ⟨(-128845), 423824⟩, ⟨(-11992), 41315⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3559679768, 3991007772⟩, ⟨(-177270661), (-149346119)⟩, ⟨1028095, 5648293⟩, ⟨(-421690), 234508⟩, ⟨(-29437), 43332⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2223684386, 4447368787⟩, ⟨1111842193, 1111842200⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1151294505, 4605178053⟩, ⟨1151294504, 2302589034⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1151294505, 4605178053⟩, ⟨1151294504, 2302589034⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4605178053), (-1151294505)⟩, ⟨(-2302589034), (-1151294504)⟩, ⟨(-287823630), (-287823626)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2302589027), (-575647252)⟩, ⟨(-1151294517), (-575647252)⟩, ⟨(-143911815), (-143911813)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2512631610, 3756229347⟩, ⟨(-1006882231), (-336763793)⟩, ⟨(-103292337), 50759788⟩, ⟨2987147, 31721189⟩, ⟨(-2976176), 1630422⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2082475439, 3490396896⟩, ⟨(-1090658846), (-366480797)⟩, ⟨(-83670704), 93665365⟩, ⟨(-1312251), 33864021⟩, ⟨(-4291373), 1614676⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4336044203, 4336044205⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1470
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4312228289, 4372545127⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1471
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (60738511 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((34903 / 400000) : ℝ)..(34903 / 200000), prawitzNormalCorrection
