...
namespace FiniteNormalPanel146_15
...
def j2 : Jet := ⟨⟨443398085, 443398089⟩, ⟨443398085, 443398089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨45774938, 45774939⟩, ⟨91549876, 91549878⟩, ⟨45774938, 45774939⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1010), (-1009)⟩, ⟨(-2019), (-2017)⟩, ⟨(-1010), (-1007)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112046, 5112048⟩, ⟨(-2019), (-2017)⟩, ⟨(-1010), (-1007)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨54483, 54484⟩, ⟨108944, 108946⟩, ⟨54428, 54432⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-143111094), (-143111092)⟩, ⟨108944, 108946⟩, ⟨54428, 54432⟩, ⟨(-44), (-41)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1525251), (-1525250)⟩, ⟨(-3049341), (-3049339)⟩, ⟨(-1522349), (-1522346)⟩, ⟨2320, 2323⟩, ⟨578, 581⟩⟩
...
def j19 : Jet := ⟨⟨1430130514, 1430130516⟩, ⟨(-3049341), (-3049339)⟩, ⟨(-1522349), (-1522346)⟩, ⟨2320, 2323⟩, ⟨578, 581⟩⟩
...
def j25 : Jet := ⟨⟨126, 127⟩, ⟨251, 253⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852051), (-852049)⟩, ⟨251, 253⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9081), (-9080)⟩, ⟨(-18160), (-18158)⟩, ⟨(-9075), (-9072)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782313, 35782315⟩, ⟨(-18160), (-18158)⟩, ⟨(-9075), (-9072)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨381361, 381362⟩, ⟨762528, 762530⟩, ⟨380876, 380879⟩, ⟨(-388), (-385)⟩, ⟨(-98), (-94)⟩⟩
...
def j33 : Jet := ⟨⟨(-715446522), (-715446520)⟩, ⟨762528, 762530⟩, ⟨380876, 380879⟩, ⟨(-388), (-385)⟩, ⟨(-98), (-94)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7625093), (-7625091)⟩, ⟨(-15242059), (-15242056)⟩, ⟨(-7604781), (-7604777)⟩, ⟨16239, 16242⟩, ⟨4048, 4051⟩⟩
...
def j36 : Jet := ⟨⟨4287342203, 4287342205⟩, ⟨(-15242059), (-15242056)⟩, ⟨(-7604781), (-7604777)⟩, ⟨16239, 16242⟩, ⟨4048, 4051⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨147641899, 147641902⟩, ⟨147327095, 147327099⟩, ⟨(-471967), (-471964)⟩, ⟨(-156924), (-156921)⟩, ⟨298, 300⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302605948, 4302605951⟩, ⟨15296320, 15296325⟩, ⟨7686230, 7686237⟩, ⟨38157, 38164⟩, ⟨9644, 9652⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨147904481, 147904486⟩, ⟨148114937, 148114943⟩, ⟨316109, 316115⟩, ⟨106081, 106088⟩, ⟨533, 541⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-141137995), (-141137994)⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4153829301, 4153829302⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5093341, 5093342⟩, ⟨10201176, 10201180⟩, ⟨5129616, 5129620⟩, ⟨29108, 29112⟩, ⟨7375, 7380⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300060637, 4300060638⟩, ⟨10201176, 10201180⟩, ⟨5129616, 5129620⟩, ⟨29108, 29112⟩, ⟨7375, 7380⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297513211, 4297513213⟩, ⟨5097566, 5097569⟩, ⟨2560264, 2560268⟩, ⟨11508, 11512⟩, ⟨2908, 2913⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4156291554, 4156291557⟩, ⟨(-136291605), (-136291598)⟩, ⟨2308617, 2308623⟩, ⟨(-73005), (-72999)⟩, ⟨2433, 2440⟩⟩
...
def j47 : Jet := ⟨⟨1438285429, 1438285441⟩, ⟨1438285429, 1438285441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨481648597, 481648606⟩, ⟨963297194, 963297212⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨481648597, 481648606⟩, ⟨963297194, 963297212⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-481648606), (-481648597)⟩, ⟨(-963297212), (-963297194)⟩, ⟨(-481648606), (-481648597)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-240824303), (-240824298)⟩, ⟨(-481648606), (-481648597)⟩, ⟨(-240824303), (-240824298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4060770213, 4060770219⟩, ⟨(-455385148), (-455385138)⟩, ⟨(-202158549), (-202158541)⟩, ⟨24579541, 24579544⟩, ⟨4978540, 4978542⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3929656217, 3929656227⟩, ⟨(-569541552), (-569541533)⟩, ⟨(-178997857), (-178997840)⟩, ⟨29887182, 29887196⟩, ⟨3939188, 3939202⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 282275989⟩, ⟨141137994, 141137995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 886796174⟩, ⟨443398085, 443398089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 183099754⟩, ⟨0, 183099756⟩, ⟨45774938, 45774939⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4037), 0⟩, ⟨(-4037), 2⟩, ⟨(-1010), (-1005)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109019, 5113057⟩, ⟨(-4037), 2⟩, ⟨(-1010), (-1005)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 217976⟩, ⟨(-173), 217977⟩, ⟨54233, 54495⟩, ⟨(-88), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142947600)⟩, ⟨(-173), 217977⟩, ⟨54233, 54495⟩, ⟨(-88), 2⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6103326), 0⟩, ⟨(-6103334), 9293⟩, ⟨(-1525840), (-1511891)⟩, ⟨(-6), 4649⟩, ⟨573, 582⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425552439, 1431655766⟩, ⟨(-6103334), 9293⟩, ⟨(-1525840), (-1511891)⟩, ⟨(-6), 4649⟩, ⟨573, 582⟩⟩
...
def j72 : Jet := ⟨⟨0, 505⟩, ⟨(-1), 505⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851671)⟩, ⟨(-1), 505⟩, ⟨124, 127⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-36330), 0⟩, ⟨(-36331), 22⟩, ⟨(-9084), (-9048)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35755064, 35791395⟩, ⟨(-36331), 22⟩, ⟨(-9084), (-9048)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1525832⟩, ⟨(-1549), 1525833⟩, ⟨379133, 381459⟩, ⟨(-777), 2⟩, ⟨(-99), (-94)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714302050)⟩, ⟨(-1549), 1525833⟩, ⟨379133, 381459⟩, ⟨(-777), 2⟩, ⟨(-99), (-94)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-30516626), 0⟩, ⟨(-30516694), 65049⟩, ⟨(-7629224), (-7531582)⟩, ⟨(-51), 32527⟩, ⟨4001, 4067⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4264450670, 4294967296⟩, ⟨(-30516694), 65049⟩, ⟨(-7629224), (-7531582)⟩, ⟨(-51), 32527⟩, ⟨4001, 4067⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 295598725⟩, ⟨145909098, 147801283⟩, ⟨(-945134), 960⟩, ⟨(-157525), (-155122)⟩, ⟨(-1), 601⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4325702301⟩, ⟨(-65984), 30955016⟩, ⟨7531113, 7960323⟩, ⟨(-33236), 112397⟩, ⟨8637, 11019⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 297714045⟩, ⟨145904556, 150989419⟩, ⟨(-954169), 1614077⟩, ⟨88094, 126565⟩, ⟨(-4034), 5238⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-282275989), 0⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4012691307, 4294967296⟩, ⟨(-141137995), (-141137994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 20636631⟩, ⟨0, 20932254⟩, ⟨4824249, 5531794⟩, ⟨(-67088), 131034⟩, ⟨5065, 10235⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4315603927⟩, ⟨0, 20932254⟩, ⟨4824249, 5531794⟩, ⟨(-67088), 131034⟩, ⟨5065, 10235⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4305273247⟩, ⟨0, 10466127⟩, ⟨2393628, 2765897⟩, ⟨(-40285), 65517⟩, ⟨1477, 4550⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4012691307, 4305273247⟩, ⟨(-141476662), (-130671867)⟩, ⟨1892381, 2765897⟩, ⟨(-131176), (-13140)⟩, ⟨(-774), 5874⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2876570871⟩, ⟨1438285429, 1438285441⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1926594409⟩, ⟨0, 1926594416⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1926594409⟩, ⟨0, 1926594416⟩, ⟨481648597, 481648606⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1926594409), 0⟩, ⟨(-1926594416), 0⟩, ⟨(-481648606), (-481648597)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-963297205), 0⟩, ⟨(-963297208), 0⟩, ⟨(-240824303), (-240824298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3432053713, 4294967296⟩, ⟨(-963297208), 0⟩, ⟨(-240824303), (-84413022)⟩, ⟨0, 54013306⟩, ⟨(-662023), 6751664⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3206490562, 4305273247⟩, ⟨(-1107085342), (-104418226)⟩, ⟨(-239889994), (-44368181)⟩, ⟨1816690, 62065192⟩, ⟨(-2598678), 6765968⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297513211, 4297513213⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2946
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4305273247⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2947
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (63608593 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(26289 / 400000), prawitzNormalCorrection
