...
namespace FiniteNormalPanel103_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (20517 / 80000)
def radius : Rat := (2931 / 80000)

def j0 : Jet := ⟨⟨1101498050, 1101498051⟩, ⟨157356864, 157356865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3460458181, 3460458186⟩, ⟨494351167, 494351172⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2788093598, 2788093607⟩, ⟨796598168, 796598178⟩, ⟨56899868, 56899871⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨697, 699⟩, ⟨199, 200⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93990), (-93987)⟩, ⟨199, 200⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-61014), (-61012)⟩, ⟨(-17304), (-17302)⟩, ⟨(-1201), (-1197)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5052042, 5052045⟩, ⟨(-17304), (-17302)⟩, ⟨(-1201), (-1197)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3279551, 3279554⟩, ⟨925781, 925785⟩, ⟨62939, 62944⟩, ⟨(-451), (-447)⟩, ⟨(-16), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-139886026), (-139886022)⟩, ⟨925781, 925785⟩, ⟨62939, 62944⟩, ⟨(-451), (-447)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-90807522), (-90807518)⟩, ⟨(-25344033), (-25344028)⟩, ⟨(-1640652), (-1640645)⟩, ⟨23644, 23650⟩, ⟨738, 745⟩⟩
...
def j19 : Jet := ⟨⟨1340848243, 1340848248⟩, ⟨(-25344033), (-25344028)⟩, ⟨(-1640652), (-1640645)⟩, ⟨23644, 23650⟩, ⟨738, 745⟩⟩
...
def j25 : Jet := ⟨⟨7636, 7639⟩, ⟨2167, 2171⟩, ⟨149, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844541), (-844537)⟩, ⟨2167, 2171⟩, ⟨149, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-548237), (-548234)⟩, ⟨(-155234), (-155228)⟩, ⟨(-10692), (-10685)⟩, ⟨53, 58⟩, ⟨(-1), 3⟩⟩
...
def j30 : Jet := ⟨⟨35243157, 35243161⟩, ⟨(-155234), (-155228)⟩, ⟨(-10692), (-10685)⟩, ⟨53, 58⟩, ⟨(-1), 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨22878223, 22878226⟩, ⟨6435864, 6435870⟩, ⟨431169, 431177⟩, ⟨(-4007), (-3999)⟩, ⟨(-134), (-128)⟩⟩
...
def j33 : Jet := ⟨⟨(-692949660), (-692949656)⟩, ⟨6435864, 6435870⟩, ⟨431169, 431177⟩, ⟨(-4007), (-3999)⟩, ⟨(-134), (-128)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-449830787), (-449830782)⟩, ⟨(-124345219), (-124345211)⟩, ⟨(-7706652), (-7706641)⟩, ⟨162629, 162640⟩, ⟨4881, 4889⟩⟩
...
def j36 : Jet := ⟨⟨3845136509, 3845136514⟩, ⟨(-124345219), (-124345211)⟩, ⟨(-7706652), (-7706641)⟩, ⟨162629, 162640⟩, ⟨4881, 4889⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1080322375, 1080322382⟩, ⟨133912061, 133912069⟩, ⟨(-4238976), (-4238968)⟩, ⟨(-169791), (-169783)⟩, ⟨3315, 3324⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4797422407, 4797422415⟩, ⟨155140525, 155140537⟩, ⟨14632247, 14632265⟩, ⟨581202, 581221⟩, ⟨35458, 35474⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1206705991, 1206706002⟩, ⟨188600854, 188600868⟩, ⟨3782699, 3782716⟩, ⟨259632, 259651⟩, ⟨10165, 10185⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1101498051), (-1101498050)⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3193469245, 3193469246⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨339033861, 339033868⟩, ⟨105977886, 105977898⟩, ⟨10407411, 10407423⟩, ⟨478102, 478118⟩, ⟨31841, 31860⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4634001157, 4634001164⟩, ⟨105977886, 105977898⟩, ⟨10407411, 10407423⟩, ⟨478102, 478118⟩, ⟨31841, 31860⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4461264777, 4461264782⟩, ⟨51013734, 51013741⟩, ⟨4718066, 4718073⟩, ⟨176189, 176198⟩, ⟨10817, 10828⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3317117658, 3317117664⟩, ⟨(-125518966), (-125518957)⟩, ⟨1639042, 1639050⟩, ⟨(-41856), (-41848)⟩, ⟨1586, 1597⟩⟩
...
def j47 : Jet := ⟨⟨10938980191, 10938980204⟩, ⟨1562711453, 1562711464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨27860814616, 27860814684⟩, ⟨7960232732, 7960232800⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨27860814616, 27860814684⟩, ⟨7960232732, 7960232800⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-27860814684), (-27860814616)⟩, ⟨(-7960232800), (-7960232732)⟩, ⟨(-568588060), (-568588051)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-13930407342), (-13930407308)⟩, ⟨(-3980116400), (-3980116366)⟩, ⟨(-284294030), (-284294025)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨167632402, 167632407⟩, ⟨(-155343789), (-155343782)⟩, ⟨60882016, 60882022⟩, ⟨(-11951269), (-11951265)⟩, ⟨753826, 753828⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨129466969, 129466974⟩, ⟨(-124875148), (-124875140)⟩, ⟨51624642, 51624651⟩, ⟨(-11070458), (-11070451)⟩, ⟨956277, 956285⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨944141185, 1258854915⟩, ⟨157356864, 157356865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2966107010, 3954809354⟩, ⟨494351167, 494351172⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2048395293, 3641591647⟩, ⟨682798428, 910397918⟩, ⟨56899868, 56899871⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨512, 913⟩, ⟨170, 229⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94175), (-93773)⟩, ⟨170, 229⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-79849), (-44723)⟩, ⟨(-19882), (-14712)⟩, ⟨(-1215), (-1180)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5033207, 5068334⟩, ⟨(-19882), (-14712)⟩, ⟨(-1215), (-1180)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2400483, 4297310⟩, ⟨783303, 1067312⟩, ⟨61434, 64246⟩, ⟨(-521), (-374)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140765094), (-138868266)⟩, ⟨783303, 1067312⟩, ⟨61434, 64246⟩, ⟨(-521), (-374)⟩, ⟨(-17), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-119351082), (-66230330)⟩, ⟨(-29464191), (-21171829)⟩, ⟨(-1711036), (-1559021)⟩, ⟨19701, 27581⟩, ⟨687, 788⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1312304683, 1365425436⟩, ⟨(-29464191), (-21171829)⟩, ⟨(-1711036), (-1559021)⟩, ⟨19701, 27581⟩, ⟨687, 788⟩⟩
...
def j72 : Jet := ⟨⟨5600, 9993⟩, ⟨1846, 2491⟩, ⟨148, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846577), (-842183)⟩, ⟨1846, 2491⟩, ⟨148, 155⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-717791), (-401661)⟩, ⟨(-178568), (-131774)⟩, ⟨(-10853), (-10496)⟩, ⟨45, 67⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35073603, 35389734⟩, ⟨(-178568), (-131774)⟩, ⟨(-10853), (-10496)⟩, ⟨45, 67⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16727625, 30006040⟩, ⟨5424471, 7438665⟩, ⟨417603, 442892⟩, ⟨(-4646), (-3356)⟩, ⟨(-138), (-121)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699100258), (-685821842)⟩, ⟨5424471, 7438665⟩, ⟨417603, 442892⟩, ⟨(-4646), (-3356)⟩, ⟨(-138), (-121)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-592749022), (-327088458)⟩, ⟨(-145600169), (-102722433)⟩, ⟨(-8200175), (-7133510)⟩, ⟨134312, 190828⟩, ⟨4429, 5278⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3702218274, 3967878838⟩, ⟨(-145600169), (-102722433)⟩, ⟨(-8200175), (-7133510)⟩, ⟨134312, 190828⟩, ⟨4429, 5278⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨906278407, 1257284844⟩, ⟨123915749, 142539330⟩, ⟨(-4966856), (-3513539)⟩, ⟨(-183336), (-154046)⟩, ⟨2741, 3901⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4649018991, 4982619260⟩, ⟨120356129, 195955548⟩, ⟨11473912, 18742686⟩, ⟨273788, 1002480⟩, ⟨11662, 71014⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨980986637, 1458584257⟩, ⟨159526902, 222723735⟩, ⟨131461, 8186736⟩, ⟨(-50492), 650283⟩, ⟨(-16715), 44883⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1258854915), (-944141185)⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3036112381, 3350826111⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨224061026, 495339752⟩, ⟨72873084, 151275348⟩, ⟨5985320, 17110249⟩, ⟨(-24532), 1290756⟩, ⟨(-16588), 113535⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4519028322, 4790307048⟩, ⟨72873084, 151275348⟩, ⟨5985320, 17110249⟩, ⟨(-24532), 1290756⟩, ⟨(-16588), 113535⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4405573612, 4535880522⟩, ⟨34501295, 73738715⟩, ⟨2234335, 8205246⟩, ⟨(-149295), 611678⟩, ⟨(-25966), 57276⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3114299985, 3538780588⟩, ⟨(-141794359), (-103880100)⟩, ⟨(-1122152), 5137487⟩, ⟨(-417097), 395356⟩, ⟨(-42670), 50156⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9376268728, 12501691657⟩, ⟨1562711453, 1562711464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨20469169891, 36389635477⟩, ⟨6823056622, 9097408910⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨20469169891, 36389635477⟩, ⟨6823056622, 9097408910⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-36389635477), (-20469169891)⟩, ⟨(-9097408910), (-6823056622)⟩, ⟨(-568588060), (-568588051)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-18194817739), (-10234584945)⟩, ⟨(-4548704455), (-3411528311)⟩, ⟨(-284294030), (-284294025)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨62108824, 396340712⟩, ⟨(-419755644), (-49333556)⟩, ⟨(-6641701), 218165810⟩, ⟨(-74841185), 20867772⟩, ⟨(-12745604), 20035475⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨45035385, 326559604⟩, ⟨(-358936844), (-37274174)⟩, ⟨(-4382690), 194086720⟩, ⟨(-69407518), 17559146⟩, ⟨(-11290079), 19285130⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1101498050, 1101498051⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4461264777, 4461264782⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2072
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨944141185, 1258854915⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4405573612, 4535880522⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2073
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (11030249 / 4294967296)

theorem envelope_integral : (∫ s in ((8793 / 40000) : ℝ)..(2931 / 10000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((8793 / 40000) : ℝ)..(2931 / 10000), prawitzNormalCorrection
