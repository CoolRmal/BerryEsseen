...
namespace FiniteNormalPanel51_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (300433 / 800000)
def radius : Rat := (42919 / 800000)

def j0 : Jet := ⟨⟨1612937387, 1612937388⟩, ⟨230419626, 230419627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5067192245, 5067192250⟩, ⟨723884604, 723884608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5978261411, 5978261423⟩, ⟨1708074682, 1708074696⟩, ⟨122005334, 122005336⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1496, 1498⟩, ⟨427, 428⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93191), (-93188)⟩, ⟨427, 428⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-129715), (-129710)⟩, ⟨(-36468), (-36464)⟩, ⟨(-2438), (-2432)⟩, ⟨23, 26⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4983341, 4983347⟩, ⟨(-36468), (-36464)⟩, ⟨(-2438), (-2432)⟩, ⟨23, 26⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6936424, 6936433⟩, ⟨1931074, 1931083⟩, ⟨123661, 123674⟩, ⟨(-1974), (-1965)⟩, ⟨(-61), (-56)⟩⟩
...
def j16 : Jet := ⟨⟨(-136229153), (-136229143)⟩, ⟨1931074, 1931083⟩, ⟨123661, 123674⟩, ⟨(-1974), (-1965)⟩, ⟨(-61), (-56)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-189620418), (-189620402)⟩, ⟨(-51489358), (-51489339)⟩, ⟨(-2929707), (-2929682)⟩, ⟨101286, 101306⟩, ⟨2641, 2656⟩⟩
...
def j19 : Jet := ⟨⟨1242035347, 1242035364⟩, ⟨(-51489358), (-51489339)⟩, ⟨(-2929707), (-2929682)⟩, ⟨101286, 101306⟩, ⟨2641, 2656⟩⟩
...
def j22 : Jet := ⟨⟨(-151), (-148)⟩, ⟨(-43), (-42)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11684, 11688⟩, ⟨(-43), (-42)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨16263, 16269⟩, ⟨4586, 4591⟩, ⟨307, 313⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-835914), (-835907)⟩, ⟨4586, 4591⟩, ⟨307, 313⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1163528), (-1163517)⟩, ⟨(-326054), (-326042)⟩, ⟨(-21496), (-21483)⟩, ⟨246, 254⟩, ⟨4, 9⟩⟩
...
def j30 : Jet := ⟨⟨34627866, 34627878⟩, ⟨(-326054), (-326042)⟩, ⟨(-21496), (-21483)⟩, ⟨246, 254⟩, ⟨4, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨48199304, 48199321⟩, ⟨13317387, 13317410⟩, ⟨824068, 824094⟩, ⟨(-17470), (-17450)⟩, ⟨(-509), (-495)⟩⟩
...
def j33 : Jet := ⟨⟨(-667628579), (-667628561)⟩, ⟨13317387, 13317410⟩, ⟨824068, 824094⟩, ⟨(-17470), (-17450)⟩, ⟨(-509), (-495)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-929287211), (-929287183)⟩, ⟨(-246973864), (-246973819)⟩, ⟨(-12521789), (-12521739)⟩, ⟨681709, 681750⟩, ⟨15751, 15782⟩⟩
...
def j36 : Jet := ⟨⟨3365680085, 3365680113⟩, ⟨(-246973864), (-246973819)⟩, ⟨(-12521789), (-12521739)⟩, ⟨681709, 681750⟩, ⟨15751, 15782⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1465350361, 1465350383⟩, ⟨148588742, 148588770⟩, ⟨(-12134609), (-12134573)⟩, ⟨(-374285), (-374254)⟩, ⟨20185, 20209⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5480836994, 5480837040⟩, ⟨402184164, 402184246⟩, ⟨49903306, 49903403⟩, ⟨4048004, 4048090⟩, ⟨375535, 375605⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1869943567, 1869943612⟩, ⟨326831680, 326831750⟩, ⟨15454843, 15454930⟩, ⟨1493623, 1493703⟩, ⟨117884, 117950⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1612937388), (-1612937387)⟩, ⟨(-230419627), (-230419626)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2682029908, 2682029909⟩, ⟨(-230419627), (-230419626)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨814136337, 814136377⟩, ⟨284592060, 284592130⟩, ⟨38328188, 38328277⟩, ⟨3652702, 3652790⟩, ⟨385578, 385653⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5109103633, 5109103673⟩, ⟨284592060, 284592130⟩, ⟨38328188, 38328277⟩, ⟨3652702, 3652790⟩, ⟨385578, 385653⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4684381817, 4684381837⟩, ⟨130466903, 130466937⟩, ⟨15754126, 15754169⟩, ⟨1235748, 1235791⟩, ⟨115851, 115890⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2925203212, 2925203227⟩, ⟨(-169840032), (-169840007)⟩, ⟨2838412, 2838443⟩, ⟨(-73519), (-73488)⟩, ⟨6045, 6073⟩⟩
...
def j47 : Jet := ⟨⟨6700880270, 6700880277⟩, ⟨957268607, 957268612⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10454514155, 10454514178⟩, ⟨2987004034, 2987004054⟩, ⟨213357430, 213357433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10454514155, 10454514178⟩, ⟨2987004034, 2987004054⟩, ⟨213357430, 213357433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10454514178), (-10454514155)⟩, ⟨(-2987004054), (-2987004034)⟩, ⟨(-213357433), (-213357430)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5227257089), (-5227257077)⟩, ⟨(-1493502027), (-1493502017)⟩, ⟨(-106678717), (-106678715)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1271730161, 1271730176⟩, ⟨(-442222598), (-442222589)⟩, ⟨45300372, 45300377⟩, ⟨2071825, 2071827⟩, ⟨(-742698), (-742697)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨866146095, 866146110⟩, ⟨(-351476872), (-351476854)⟩, ⟨49180717, 49180735⟩, ⟨(-694309), (-694292)⟩, ⟨(-548472), (-548454)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1382517760, 1843357014⟩, ⟨230419626, 230419627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4343307638, 5791076854⟩, ⟨723884604, 723884608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4392192056, 7808341442⟩, ⟨1464064012, 1952085364⟩, ⟨122005334, 122005336⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1099, 1957⟩, ⟨366, 490⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93588), (-92729)⟩, ⟨366, 490⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-170145), (-94828)⟩, ⟨(-42163), (-30718)⟩, ⟨(-2505), (-2354)⟩, ⟨20, 29⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4942911, 5018229⟩, ⟨(-42163), (-30718)⟩, ⟨(-2505), (-2354)⟩, ⟨20, 29⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨5054803, 9123247⟩, ⟨1608280, 2249399⟩, ⟨116692, 129673⟩, ⟨(-2317), (-1621)⟩, ⟨(-66), (-50)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138110774), (-134042329)⟩, ⟨1608280, 2249399⟩, ⟨116692, 129673⟩, ⟨(-2317), (-1621)⟩, ⟨(-66), (-50)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-251088311), (-137076632)⟩, ⟨(-61127392), (-41602755)⟩, ⟨(-3255694), (-2549571)⟩, ⟨81249, 121179⟩, ⟨2140, 3081⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1180567454, 1294579134⟩, ⟨(-61127392), (-41602755)⟩, ⟨(-3255694), (-2549571)⟩, ⟨81249, 121179⟩, ⟨2140, 3081⟩⟩
...
def j70 : Jet := ⟨⟨(-197), (-109)⟩, ⟨(-50), (-36)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11638, 11727⟩, ⟨(-50), (-36)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨11901, 21320⟩, ⟨3876, 5294⟩, ⟨299, 319⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-840276), (-830856)⟩, ⟨3876, 5294⟩, ⟨299, 319⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1527640), (-849664)⟩, ⟨(-377947), (-273596)⟩, ⟨(-22244), (-20614)⟩, ⟨203, 294⟩, ⟨4, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34263754, 34941731⟩, ⟨(-377947), (-273596)⟩, ⟨(-22244), (-20614)⟩, ⟨203, 294⟩, ⟨4, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨35039379, 63524807⟩, ⟨10992677, 15601413⟩, ⟨761096, 878233⟩, ⟨(-20641), (-14262)⟩, ⟨(-559), (-432)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-680788504), (-652303075)⟩, ⟨10992677, 15601413⟩, ⟨761096, 878233⟩, ⟨(-20641), (-14262)⟩, ⟨(-559), (-432)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1237687909), (-667069196)⟩, ⟨(-298180461), (-193992697)⟩, ⟨(-14813378), (-9842127)⟩, ⟨534179, 827761⟩, ⟨11221, 19646⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3057279387, 3627898100⟩, ⟨(-298180461), (-193992697)⟩, ⟨(-14813378), (-9842127)⟩, ⟨534179, 827761⟩, ⟨11221, 19646⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1193854874, 1745533026⟩, ⟨116555294, 176120631⟩, ⟨(-14692348), (-9590099)⟩, ⟨(-466560), (-266320)⟩, ⟨15857, 24579⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5084691897, 6033712245⟩, ⟨271891069, 588475856⟩, ⟨28332951, 86629854⟩, ⟨875958, 10412042⟩, ⟨(-51313), 1369082⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1413371461, 2452182582⟩, ⟨213563031, 486584673⟩, ⟨(-5386217), 47985305⟩, ⟨(-1656140), 6861580⟩, ⟨(-338584), 937782⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1843357014), (-1382517760)⟩, ⟨(-230419627), (-230419626)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2451610282, 2912449536⟩, ⟨(-230419627), (-230419626)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨465106891, 1400057091⟩, ⟨140557014, 555624470⟩, ⟨4468761, 109919837⟩, ⟨(-3111554), 18707832⟩, ⟨(-822060), 3161678⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4760074187, 5695024387⟩, ⟨140557014, 555624470⟩, ⟨4468761, 109919837⟩, ⟨(-3111554), 18707832⟩, ⟨(-822060), 3161678⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4521544311, 4945699495⟩, ⟨61031587, 263890915⟩, ⟨(-5578319), 51793947⟩, ⟨(-4500668), 9210755⟩, ⟨(-1224650), 1796246⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2580942707, 3353715921⟩, ⟨(-230493157), (-63628790)⟩, ⟨(-17940118), 31847596⟩, ⟨(-5830618), 6545153⟩, ⟨(-1324591), 1459504⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5743611659, 7658148885⟩, ⟨957268607, 957268612⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7680867540, 13654875650⟩, ⟨2560289172, 3413718918⟩, ⟨213357430, 213357433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7680867540, 13654875650⟩, ⟨2560289172, 3413718918⟩, ⟨213357430, 213357433⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13654875650), (-7680867540)⟩, ⟨(-3413718918), (-2560289172)⟩, ⟨(-213357433), (-213357430)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6827437825), (-3840433770)⟩, ⟨(-1706859459), (-1280144586)⟩, ⟨(-106678717), (-106678715)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨876172050, 1756412325⟩, ⟨(-698014394), (-261149114)⟩, ⟨(-4707254), 116936241⟩, ⟨(-11166219), 12181791⟩, ⟨(-2662525), 1167850⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨526511544, 1371490765⟩, ⟨(-639302426), (-169910645)⟩, ⟨(-7143347), 141792928⟩, ⟨(-22554860), 15356977⟩, ⟨(-4826619), 3922701⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1612937387, 1612937388⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4684381817, 4684381837⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1010
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1382517760, 1843357014⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4521544311, 4945699495⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1011
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (47389241 / 2147483648)

theorem envelope_integral : (∫ s in ((128757 / 400000) : ℝ)..(42919 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((128757 / 400000) : ℝ)..(42919 / 100000), prawitzNormalCorrection
