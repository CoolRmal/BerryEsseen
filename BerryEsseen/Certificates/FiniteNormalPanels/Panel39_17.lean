...
namespace FiniteNormalPanel39_17
...
def j2 : Jet := ⟨⟨1743637794, 1743637798⟩, ⟨581212598, 581212602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨707868662, 707868667⟩, ⟨471912440, 471912448⟩, ⟨78652073, 78652075⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-15577), (-15576)⟩, ⟨(-10366), (-10364)⟩, ⟨(-1716), (-1712)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097479, 5097481⟩, ⟨(-10366), (-10364)⟩, ⟨(-1716), (-1712)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨840133, 840134⟩, ⟨558379, 558382⟩, ⟨91926, 91929⟩, ⟨(-379), (-376)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-142325444), (-142325442)⟩, ⟨558379, 558382⟩, ⟨91926, 91929⟩, ⟨(-379), (-376)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-23457158), (-23457156)⟩, ⟨(-15546077), (-15546075)⟩, ⟨(-2529849), (-2529845)⟩, ⟨20262, 20266⟩, ⟨1635, 1639⟩⟩
...
def j19 : Jet := ⟨⟨1408198607, 1408198610⟩, ⟨(-15546077), (-15546075)⟩, ⟨(-2529849), (-2529845)⟩, ⟨20262, 20266⟩, ⟨1635, 1639⟩⟩
...
def j25 : Jet := ⟨⟨1947, 1948⟩, ⟨1296, 1298⟩, ⟨213, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850230), (-850228)⟩, ⟨1296, 1298⟩, ⟨213, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-140130), (-140129)⟩, ⟨(-93207), (-93205)⟩, ⟨(-15393), (-15390)⟩, ⟨45, 48⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35651264, 35651266⟩, ⟨(-93207), (-93205)⟩, ⟨(-15393), (-15390)⟩, ⟨45, 48⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5875810, 5875811⟩, ⟨3901844, 3901847⟩, ⟨640088, 640092⟩, ⟨(-3392), (-3388)⟩, ⟨(-278), (-274)⟩⟩
...
def j33 : Jet := ⟨⟨(-709952073), (-709952071)⟩, ⟨3901844, 3901847⟩, ⟨640088, 640092⟩, ⟨(-3392), (-3388)⟩, ⟨(-278), (-274)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-117009699), (-117009697)⟩, ⟨(-77363391), (-77363386)⟩, ⟨(-12466866), (-12466862)⟩, ⟨141222, 141227⟩, ⟨11302, 11305⟩⟩
...
def j36 : Jet := ⟨⟨4177957597, 4177957599⟩, ⟨(-77363391), (-77363386)⟩, ⟨(-12466866), (-12466862)⟩, ⟨141222, 141227⟩, ⟨11302, 11305⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨571689641, 571689644⟩, ⟨184251936, 184251941⟩, ⟨(-3130808), (-3130805)⟩, ⟨(-334125), (-334121)⟩, ⟨3404, 3409⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4415254017, 4415254020⟩, ⟨81757411, 81757418⟩, ⟨14688848, 14688857⟩, ⟨366704, 366714⟩, ⟨35908, 35916⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨587700629, 587700634⟩, ⟨200294647, 200294656⟩, ⟨2244046, 2244054⟩, ⟨275874, 275884⟩, ⟨6940, 6951⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-555017149), (-555017148)⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3739950147, 3739950148⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨80417848, 80417850⟩, ⟨54814522, 54814526⟩, ⟨9954813, 9954818⟩, ⟨284798, 284804⟩, ⟨28800, 28809⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4375385144, 4375385146⟩, ⟨54814522, 54814526⟩, ⟨9954813, 9954818⟩, ⟨284798, 284804⟩, ⟨28800, 28809⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4334989746, 4334989748⟩, ⟨27154225, 27154228⟩, ⟨4846405, 4846409⟩, ⟨110726, 110731⟩, ⟨10863, 10870⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3774800695, 3774800699⟩, ⟨(-163084465), (-163084460)⟩, ⟨3050459, 3050464⟩, ⟨(-112343), (-112336)⟩, ⟨4689, 4697⟩⟩
...
def j47 : Jet := ⟨⟨3687574726, 3687574734⟩, ⟨1229191575, 1229191583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3166079372, 3166079386⟩, ⟨2110719580, 2110719600⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3166079372, 3166079386⟩, ⟨2110719580, 2110719600⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3166079386), (-3166079372)⟩, ⟨(-2110719600), (-2110719580)⟩, ⟨(-351786602), (-351786596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1583039693), (-1583039686)⟩, ⟨(-1055359800), (-1055359790)⟩, ⟨(-175893301), (-175893298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2970896590, 2970896601⟩, ⟨(-730009015), (-730009004)⟩, ⟨(-31979228), (-31979222)⟩, ⟨22550188, 22550191⟩, ⟨(-730431), (-730430)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2611089151, 2611089164⟩, ⟨(-754405191), (-754405176)⟩, ⟨1723064, 1723077⟩, ⟨20437209, 20437223⟩, ⟨(-1498600), (-1498589)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨370011432, 740022866⟩, ⟨185005716, 185005717⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1162425196, 2324850400⟩, ⟨581212598, 581212602⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨314608294, 1258433188⟩, ⟨314608294, 629216596⟩, ⟨78652073, 78652075⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨78, 316⟩, ⟨78, 158⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94609), (-94370)⟩, ⟨78, 158⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-27721), (-6912)⟩, ⟨(-13856), (-6865)⟩, ⟨(-1727), (-1698)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5085335, 5106145⟩, ⟨(-13856), (-6865)⟩, ⟨(-1727), (-1698)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨372503, 1496110⟩, ⟨368443, 747553⟩, ⟨90588, 92881⟩, ⟨(-508), (-247)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142793074), (-141669466)⟩, ⟨368443, 747553⟩, ⟨90588, 92881⟩, ⟨(-508), (-247)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-41838630), (-10377352)⟩, ⟨(-20892327), (-10158317)⟩, ⟨(-2581292), (-2457605)⟩, ⟨13233, 27280⟩, ⟨1573, 1681⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1389817135, 1421278414⟩, ⟨(-20892327), (-10158317)⟩, ⟨(-2581292), (-2457605)⟩, ⟨13233, 27280⟩, ⟨1573, 1681⟩⟩
...
def j72 : Jet := ⟨⟨864, 3466⟩, ⟨859, 1733⟩, ⟨212, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851313), (-848710)⟩, ⟨859, 1733⟩, ⟨212, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-249437), (-62168)⟩, ⟨(-124657), (-61660)⟩, ⟨(-15513), (-15224)⟩, ⟨29, 64⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35541957, 35729227⟩, ⟨(-124657), (-61660)⟩, ⟨(-15513), (-15224)⟩, ⟨29, 64⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2603464, 10468729⟩, ⟨2566939, 5229849⟩, ⟨628057, 648665⟩, ⟨(-4554), (-2225)⟩, ⟨(-283), (-266)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713224419), (-705359153)⟩, ⟨2566939, 5229849⟩, ⟨628057, 648665⟩, ⟨(-4554), (-2225)⟩, ⟨(-283), (-266)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-208976046), (-51667876)⟩, ⟨(-104299994), (-50135520)⟩, ⟨(-12826969), (-11960730)⟩, ⟨91677, 190642⟩, ⟨10750, 11698⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4085991250, 4243299420⟩, ⟨(-104299994), (-50135520)⟩, ⟨(-12826969), (-11960730)⟩, ⟨91677, 190642⟩, ⟨10750, 11698⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨376151515, 769332911⟩, ⟨176766815, 189583899⟩, ⟨(-4224481), (-2039811)⟩, ⟨(-345731), (-317806)⟩, ⟨2215, 4602⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4347264297, 4514631321⟩, ⟨51363887, 115241564⟩, ⟨12860653, 17114266⟩, ⟨93898, 701098⟩, ⟨19734, 59035⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨380731665, 808680071⟩, ⟨183417616, 219922638⟩, ⟨(-1200242), 6087805⟩, ⟨60760, 534955⟩, ⟨(-18278), 36454⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-740022866), (-370011432)⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3554944430, 3924955864⟩, ⟨(-185005717), (-185005716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨33750338, 152262733⟩, ⟨32518474, 82816490⟩, ⟨7380915, 13553572⟩, ⟨(-112146), 824900⟩, ⟨(-3398), 77144⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4328717634, 4447230029⟩, ⟨32518474, 82816490⟩, ⟨7380915, 13553572⟩, ⟨(-112146), 824900⟩, ⟨(-3398), 77144⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4311809442, 4370435623⟩, ⟨15978473, 41246503⟩, ⟨3432096, 6720710⟩, ⟨(-120145), 398121⟩, ⟨(-10740), 38206⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3568884674, 3993922595⟩, ⟨(-175031134), (-148038074)⟩, ⟨1064051, 5453449⟩, ⟨(-399290), 215986⟩, ⟨(-26965), 40091⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2458383150, 4916766316⟩, ⟨1229191575, 1229191583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1407146386, 5628585585⟩, ⟨1407146386, 2814292802⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1407146386, 5628585585⟩, ⟨1407146386, 2814292802⟩, ⟨351786596, 351786602⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5628585585), (-1407146386)⟩, ⟨(-2814292802), (-1407146386)⟩, ⟨(-351786602), (-351786596)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2814292793), (-703573193)⟩, ⟨(-1407146401), (-703573193)⟩, ⟨(-175893301), (-175893298)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2230420952, 3645999511⟩, ⟨(-1194527161), (-365372838)⟩, ⟨(-119389413), 104336348⟩, ⟨(-1418968), 45651651⟩, ⟨(-5875638), 2560922⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1853358734, 3390442541⟩, ⟨(-1259383850), (-380482697)⟩, ⟨(-97874950), 150332698⟩, ⟨(-7427175), 47410080⟩, ⟨(-7558781), 2716813⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4334989746, 4334989748⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified776
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4311809442, 4370435623⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified777
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (28130203 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((1723 / 20000) : ℝ)..(1723 / 10000), prawitzNormalCorrection
