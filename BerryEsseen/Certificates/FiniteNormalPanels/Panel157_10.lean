...
namespace FiniteNormalPanel157_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (22239 / 100000)
def radius : Rat := (3177 / 100000)

def j0 : Jet := ⟨⟨955157776, 955157777⟩, ⟨136451110, 136451111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3000716651, 3000716656⟩, ⟨428673804, 428673808⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2096477062, 2096477070⟩, ⟨598993440, 598993450⟩, ⟨42785245, 42785247⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨524, 526⟩, ⟨149, 151⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94163), (-94160)⟩, ⟨149, 151⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-45964), (-45961)⟩, ⟨(-13061), (-13057)⟩, ⟨(-915), (-909)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5067092, 5067096⟩, ⟨(-13061), (-13057)⟩, ⟨(-915), (-909)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2473369, 2473372⟩, ⟨700301, 700305⟩, ⟨48207, 48214⟩, ⟨(-259), (-254)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-140692208), (-140692204)⟩, ⟨700301, 700305⟩, ⟨48207, 48214⟩, ⟨(-259), (-254)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-68675259), (-68675255)⟩, ⟨(-19279670), (-19279665)⟩, ⟨(-1280340), (-1280332)⟩, ⟨13572, 13579⟩, ⟨438, 443⟩⟩
...
def j19 : Jet := ⟨⟨1362980506, 1362980511⟩, ⟨(-19279670), (-19279665)⟩, ⟨(-1280340), (-1280332)⟩, ⟨13572, 13579⟩, ⟨438, 443⟩⟩
...
def j25 : Jet := ⟨⟨5751, 5753⟩, ⟨1635, 1638⟩, ⟨113, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846426), (-846423)⟩, ⟨1635, 1638⟩, ⟨113, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-413161), (-413159)⟩, ⟨(-117248), (-117245)⟩, ⟨(-8149), (-8144)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35378233, 35378236⟩, ⟨(-117248), (-117245)⟩, ⟨(-8149), (-8144)⟩, ⟨30, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨17268968, 17268970⟩, ⟨4876758, 4876762⟩, ⟨332097, 332102⟩, ⟨(-2291), (-2285)⟩, ⟨(-79), (-75)⟩⟩
...
def j33 : Jet := ⟨⟨(-698558915), (-698558912)⟩, ⟨4876758, 4876762⟩, ⟨332097, 332102⟩, ⟨(-2291), (-2285)⟩, ⟨(-79), (-75)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-340983446), (-340983442)⟩, ⟨(-95043379), (-95043373)⟩, ⟨(-6116610), (-6116605)⟩, ⟨93776, 93783⟩, ⟨2949, 2955⟩⟩
...
def j36 : Jet := ⟨⟨3953983850, 3953983854⟩, ⟨(-95043379), (-95043373)⟩, ⟨(-6116610), (-6116605)⟩, ⟨93776, 93783⟩, ⟨2949, 2955⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨952258310, 952258316⟩, ⟨122566989, 122566996⟩, ⟨(-2818794), (-2818787)⟩, ⟨(-118307), (-118299)⟩, ⟨1660, 1666⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4665356449, 4665356455⟩, ⟨112142899, 112142907⟩, ⟨9912680, 9912689⟩, ⟨301096, 301109⟩, ⟨16422, 16435⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1034379109, 1034379118⟩, ⟨158000667, 158000679⟩, ⟨2336168, 2336181⟩, ⟨147528, 147544⟩, ⟨4440, 4454⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-955157777), (-955157776)⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3339809519, 3339809520⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨249114851, 249114857⟩, ⟨76104228, 76104238⟩, ⟨6937695, 6937705⟩, ⟨242940, 242954⟩, ⟨14262, 14273⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4544082147, 4544082153⟩, ⟨76104228, 76104238⟩, ⟨6937695, 6937705⟩, ⟨242940, 242954⟩, ⟨14262, 14273⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4417769144, 4417769148⟩, ⟨36994369, 36994375⟩, ⟨3217527, 3217533⟩, ⟨91149, 91158⟩, ⟨4996, 5004⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3435301464, 3435301469⟩, ⟨(-111585335), (-111585328)⟩, ⟨1326669, 1326675⟩, ⟨(-31344), (-31334)⟩, ⟨987, 997⟩⟩
...
def j47 : Jet := ⟨⟨11078596552, 11078596566⟩, ⟨1582656640, 1582656653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨28576539261, 28576539334⟩, ⟨8164725450, 8164725528⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨28576539261, 28576539334⟩, ⟨8164725450, 8164725528⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-28576539334), (-28576539261)⟩, ⟨(-8164725528), (-8164725450)⟩, ⟨(-583194681), (-583194671)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-14288269667), (-14288269630)⟩, ⟨(-4082362764), (-4082362725)⟩, ⟨(-291597341), (-291597335)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨154231109, 154231114⟩, ⟨(-146596543), (-146596536)⟩, ⟨59198758, 59198764⟩, ⟨(-12120893), (-12120889)⟩, ⟨870638, 870641⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨123360742, 123360747⟩, ⟨(-121261286), (-121261277)⟩, ⟨51206026, 51206035⟩, ⟨(-11279239), (-11279232)⟩, ⟨1030669, 1030676⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨818706665, 1091608888⟩, ⟨136451110, 136451111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2572042844, 3429390464⟩, ⟨428673804, 428673808⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1540268862, 2738255765⟩, ⟨513422950, 684563942⟩, ⟨42785245, 42785247⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-60123), (-33710)⟩, ⟨(-14986), (-11126)⟩, ⟨(-922), (-900)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5052933, 5079347⟩, ⟨(-14986), (-11126)⟩, ⟨(-922), (-900)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1812091, 3238337⟩, ⟨594475, 805595⟩, ⟨47358, 48948⟩, ⟨(-297), (-214)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141353486), (-139927239)⟩, ⟨594475, 805595⟩, ⟨47358, 48948⟩, ⟨(-297), (-214)⟩, ⟨(-10), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-90119895), (-50180956)⟩, ⟨(-22316783), (-16213378)⟩, ⟨(-1320078), (-1234306)⟩, ⟨11392, 15752⟩, ⟨416, 461⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1341535870, 1381474810⟩, ⟨(-22316783), (-16213378)⟩, ⟨(-1320078), (-1234306)⟩, ⟨11392, 15752⟩, ⟨416, 461⟩⟩
...
def j72 : Jet := ⟨⟨4219, 7522⟩, ⟨1394, 1877⟩, ⟨112, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847958), (-844654)⟩, ⟨1394, 1877⟩, ⟨112, 117⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-540616), (-302911)⟩, ⟨(-134655), (-99773)⟩, ⟨(-8242), (-8039)⟩, ⟨24, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35250778, 35488484⟩, ⟨(-134655), (-99773)⟩, ⟨(-8242), (-8039)⟩, ⟨24, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12641697, 22625678⟩, ⟨4128049, 5620640⟩, ⟨324440, 338719⟩, ⟨(-2648), (-1928)⟩, ⟨(-82), (-71)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703186186), (-693202204)⟩, ⟨4128049, 5620640⟩, ⟨324440, 338719⟩, ⟨(-2648), (-1928)⟩, ⟨(-82), (-71)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-448316249), (-248597415)⟩, ⟨(-110598655), (-79282365)⟩, ⟨(-6395122), (-5793672)⟩, ⟨78216, 109289⟩, ⟨2755, 3120⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3846651047, 4046369881⟩, ⟨(-110598655), (-79282365)⟩, ⟨(-6395122), (-5793672)⟩, ⟨78216, 109289⟩, ⟨2755, 3120⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨803379280, 1103062309⟩, ⟨116077326, 128173402⟩, ⟨(-3281442), (-2357395)⟩, ⟨(-124933), (-110616)⟩, ⟨1386, 1942⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4558837826, 4795533530⟩, ⟨89323382, 137880862⟩, ⟨8277585, 11936998⟩, ⟨160556, 479745⟩, ⟨7574, 28560⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨852736609, 1231621087⟩, ⟨139916841, 178523136⟩, ⟨298533, 4678251⟩, ⟨8906, 313007⟩, ⟨(-5906), 16978⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1091608888), (-818706665)⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3203358408, 3476260631⟩, ⟨(-136451111), (-136451110)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨169305066, 353178592⟩, ⟨55559078, 102386280⟩, ⟨4676602, 10103496⟩, ⟨22986, 568426⟩, ⟨(-2788), 40856⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4464272362, 4648145888⟩, ⟨55559078, 102386280⟩, ⟨4676602, 10103496⟩, ⟨22986, 568426⟩, ⟨(-2788), 40856⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4378801639, 4468068328⟩, ⟨26703309, 50213022⟩, ⟨1965559, 4873608⟩, ⟨(-44615), 266786⟩, ⟨(-7141), 20109⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3265885414, 3616365145⟩, ⟨(-122034136), (-98473111)⟩, ⟨(-129276), 3096237⟩, ⟨(-190946), 153487⟩, ⟨(-14256), 17694⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9495939900, 12661253219⟩, ⟨1582656640, 1582656653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨20995008429, 37324459543⟩, ⟨6998336098, 9331114890⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨20995008429, 37324459543⟩, ⟨6998336098, 9331114890⟩, ⟨583194671, 583194681⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-37324459543), (-20995008429)⟩, ⟨(-9331114890), (-6998336098)⟩, ⟨(-583194681), (-583194671)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-18662229772), (-10497504214)⟩, ⟨(-4665557445), (-3499168049)⟩, ⟨(-291597341), (-291597335)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨55704461, 372806147⟩, ⟨(-404973630), (-45383179)⟩, ⟨(-6823707), 216176407⟩, ⟨(-76222251), 20800692⟩, ⟨(-12987280), 20931408⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨42357572, 313903009⟩, ⟨(-351580698), (-35786454)⟩, ⟨(-4716263), 193796058⟩, ⟨(-70629987), 17733593⟩, ⟨(-11548533), 19965367⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨955157776, 955157777⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4417769144, 4417769148⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3172
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨818706665, 1091608888⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4378801639, 4468068328⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3173
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (4588303 / 2147483648)

theorem envelope_integral : (∫ s in ((9531 / 50000) : ℝ)..(3177 / 12500),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((9531 / 50000) : ℝ)..(3177 / 12500), prawitzNormalCorrection
