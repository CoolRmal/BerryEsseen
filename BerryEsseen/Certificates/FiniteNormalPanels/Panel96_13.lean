...
namespace FiniteNormalPanel96_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (7371 / 200000)
def radius : Rat := (7371 / 200000)

def j0 : Jet := ⟨⟨158291019, 158291020⟩, ⟨158291019, 158291020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨497285902, 497285906⟩, ⟨497285902, 497285906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨57577450, 57577452⟩, ⟨115154900, 115154904⟩, ⟨57577450, 57577452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨14, 15⟩, ⟨28, 29⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94673), (-94671)⟩, ⟨28, 29⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1270), (-1269)⟩, ⟨(-2539), (-2537)⟩, ⟨(-1270), (-1267)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111786, 5111788⟩, ⟨(-2539), (-2537)⟩, ⟨(-1270), (-1267)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨68527, 68528⟩, ⟨137020, 137022⟩, ⟨68440, 68444⟩, ⟨(-70), (-66)⟩, ⟨(-18), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-143097050), (-143097048)⟩, ⟨137020, 137022⟩, ⟨68440, 68444⟩, ⟨(-70), (-66)⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1918330), (-1918329)⟩, ⟨(-3834824), (-3834822)⟩, ⟨(-1913740), (-1913737)⟩, ⟨3669, 3673⟩, ⟨914, 917⟩⟩
...
def j19 : Jet := ⟨⟨1429737435, 1429737437⟩, ⟨(-3834824), (-3834822)⟩, ⟨(-1913740), (-1913737)⟩, ⟨3669, 3673⟩, ⟨914, 917⟩⟩
...
def j25 : Jet := ⟨⟨158, 159⟩, ⟨316, 318⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852019), (-852017)⟩, ⟨316, 318⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11422), (-11421)⟩, ⟨(-22840), (-22838)⟩, ⟨(-11412), (-11409)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779972, 35779974⟩, ⟨(-22840), (-22838)⟩, ⟨(-11412), (-11409)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨479658, 479660⟩, ⟨959010, 959013⟩, ⟨478892, 478896⟩, ⟨(-613), (-610)⟩, ⟨(-153), (-150)⟩⟩
...
def j33 : Jet := ⟨⟨(-715348225), (-715348222)⟩, ⟨959010, 959013⟩, ⟨478892, 478896⟩, ⟨(-613), (-610)⟩, ⟨(-153), (-150)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9589812), (-9589811)⟩, ⟨(-19166768), (-19166765)⟩, ⟨(-9557681), (-9557678)⟩, ⟨25686, 25689⟩, ⟨6399, 6402⟩⟩
...
def j36 : Jet := ⟨⟨4285377484, 4285377485⟩, ⟨(-19166768), (-19166765)⟩, ⟨(-9557681), (-9557678)⟩, ⟨25686, 25689⟩, ⟨6399, 6402⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨165539856, 165539859⟩, ⟨165095847, 165095851⟩, ⟨(-665589), (-665586)⟩, ⟨(-221156), (-221152)⟩, ⟨529, 533⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304578567, 4304578569⟩, ⟨19252643, 19252648⟩, ⟨9686611, 9686617⟩, ⟨60457, 60465⟩, ⟨15325, 15333⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨165910300, 165910304⟩, ⟨166207347, 166207354⟩, ⟨446328, 446334⟩, ⟨150042, 150050⟩, ⟨949, 959⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-158291020), (-158291019)⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4136676276, 4136676277⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6408949, 6408950⟩, ⟨12840846, 12840850⟩, ⟨6466401, 6466404⟩, ⟨46134, 46140⟩, ⟨11730, 11737⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301376245, 4301376246⟩, ⟨12840846, 12840850⟩, ⟨6466401, 6466404⟩, ⟨46134, 46140⟩, ⟨11730, 11737⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298170575, 4298170577⟩, ⟨6415638, 6415641⟩, ⟨3226002, 3226005⟩, ⟨18234, 18239⟩, ⟨4621, 4627⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4139761498, 4139761502⟩, ⟨(-152229888), (-152229882)⟩, ⟨2870658, 2870663⟩, ⟨(-101334), (-101327)⟩, ⟨3777, 3785⟩⟩
...
def j47 : Jet := ⟨⟨1376950880, 1376950890⟩, ⟨1376950880, 1376950890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨441445439, 441445446⟩, ⟨882890878, 882890892⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨441445439, 441445446⟩, ⟨882890878, 882890892⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-441445446), (-441445439)⟩, ⟨(-882890892), (-882890878)⟩, ⟨(-441445446), (-441445439)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-220722723), (-220722719)⟩, ⟨(-441445446), (-441445439)⟩, ⟨(-220722723), (-220722719)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4079820234, 4079820239⟩, ⟨(-419332196), (-419332188)⟩, ⟨(-188116193), (-188116186)⟩, ⟨20811591, 20811593⟩, ⟨4298976, 4298977⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3932389133, 3932389143⟩, ⟨(-548783192), (-548783176)⟩, ⟨(-163728726), (-163728710)⟩, ⟨26350546, 26350559⟩, ⟨3293729, 3293744⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 316582040⟩, ⟨158291019, 158291020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 994571812⟩, ⟨497285902, 497285906⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 230309808⟩, ⟨0, 230309808⟩, ⟨57577450, 57577452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 58⟩, ⟨0, 58⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94628)⟩, ⟨0, 58⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5078), 0⟩, ⟨(-5078), 4⟩, ⟨(-1270), (-1263)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107978, 5113057⟩, ⟨(-5078), 4⟩, ⟨(-1270), (-1263)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 274179⟩, ⟨(-273), 274180⟩, ⟨68134, 68546⟩, ⟨(-138), 2⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142891397)⟩, ⟨(-273), 274180⟩, ⟨68134, 68546⟩, ⟨(-138), 2⟩, ⟨(-18), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7676994), 0⟩, ⟨(-7677009), 14703⟩, ⟨(-1919264), (-1897193)⟩, ⟨(-12), 7353⟩, ⟨904, 920⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423978771, 1431655766⟩, ⟨(-7677009), 14703⟩, ⟨(-1919264), (-1897193)⟩, ⟨(-12), 7353⟩, ⟨904, 920⟩⟩
...
def j72 : Jet := ⟨⟨0, 635⟩, ⟨(-1), 635⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851541)⟩, ⟨(-1), 635⟩, ⟨156, 159⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-45697), 0⟩, ⟨(-45698), 35⟩, ⟨(-11426), (-11371)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35745697, 35791395⟩, ⟨(-45698), 35⟩, ⟨(-11426), (-11371)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1919249⟩, ⟨(-2451), 1919251⟩, ⟨476135, 479815⟩, ⟨(-1227), 2⟩, ⟨(-155), (-150)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713908633)⟩, ⟨(-2451), 1919251⟩, ⟨476135, 479815⟩, ⟨(-1227), 2⟩, ⟨(-155), (-150)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-38384969), 0⟩, ⟨(-38385101), 102917⟩, ⟨(-9596375), (-9441865)⟩, ⟨(-99), 51461⟩, ⟨6307, 6434⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4256582327, 4294967296⟩, ⟨(-38385101), 102917⟩, ⟨(-9596375), (-9441865)⟩, ⟨(-99), 51461⟩, ⟨6307, 6434⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 331523938⟩, ⟨163095357, 165765374⟩, ⟨(-1333309), 1703⟩, ⟨(-222222), (-217960)⟩, ⟨(-2), 1066⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4333698413⟩, ⟨(-104783), 39080521⟩, ⟨9440928, 10122655⟩, ⟨(-52877), 179493⟩, ⟨13319, 18080⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 334513552⟩, ⟨163087268, 170276796⟩, ⟨(-1349378), 2291399⟩, ⟨118065, 186615⟩, ⟨(-7210), 9411⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-316582040), 0⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3978385256, 4294967296⟩, ⟨(-158291020), (-158291019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 26053590⟩, ⟨0, 26524020⟩, ⟨5982509, 7107668⟩, ⟨(-106994), 210760⟩, ⟨7122, 17487⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4321020886⟩, ⟨0, 26524020⟩, ⟨5982509, 7107668⟩, ⟨(-106994), 210760⟩, ⟨7122, 17487⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307974396⟩, ⟨0, 13262010⟩, ⟨2961809, 3553834⟩, ⟨(-64471), 105380⟩, ⟨1759, 7923⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3978385256, 4307974396⟩, ⟨(-158770397), (-145029009)⟩, ⟨2254722, 3553834⟩, ⟨(-195448), (-3777)⟩, ⟨(-2255), 10300⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2753901779⟩, ⟨1376950880, 1376950890⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1765781783⟩, ⟨0, 1765781784⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1765781783⟩, ⟨0, 1765781784⟩, ⟨441445439, 441445446⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1765781783), 0⟩, ⟨(-1765781784), 0⟩, ⟨(-441445446), (-441445439)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-882890892), 0⟩, ⟨(-882890892), 0⟩, ⟨(-220722723), (-220722719)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3496910576, 4294967296⟩, ⟨(-882890892), 0⟩, ⟨(-220722723), (-88964459)⟩, ⟨0, 45372658⟩, ⟨(-45761), 5671583⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3239153296, 4307974396⟩, ⟨(-1044335082), (-118080870)⟩, ⟨(-219555405), (-46215567)⟩, ⟨2078091, 53666364⟩, ⟨(-1908065), 5692535⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨158291019, 158291020⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298170575, 4298170577⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1938
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 316582040⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307974396⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1939
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (285917509 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(7371 / 100000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (7371 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 10 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(7371 / 100000), prawitzNormalCorrection
