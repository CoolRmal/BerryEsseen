...
namespace FiniteNormalPanel9_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (46593 / 400000)
def radius : Rat := (46593 / 400000)

def j0 : Jet := ⟨⟨500288528, 500288529⟩, ⟨500288528, 500288529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1571702764, 1571702768⟩, ⟨1571702764, 1571702768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨575149799, 575149803⟩, ⟨1150299598, 1150299606⟩, ⟨575149799, 575149803⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨143, 145⟩, ⟨287, 289⟩, ⟨143, 145⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94544), (-94541)⟩, ⟨287, 289⟩, ⟨143, 145⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12661), (-12660)⟩, ⟨(-25284), (-25281)⟩, ⟨(-12566), (-12562)⟩, ⟨76, 78⟩, ⟨19, 20⟩⟩
...
def j13 : Jet := ⟨⟨5100395, 5100397⟩, ⟨(-25284), (-25281)⟩, ⟨(-12566), (-12562)⟩, ⟨76, 78⟩, ⟨19, 20⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨683006, 683007⟩, ⟨1362627, 1362629⟩, ⟨674551, 674555⟩, ⟨(-6742), (-6738)⟩, ⟨(-1661), (-1658)⟩⟩
...
def j16 : Jet := ⟨⟨(-142482571), (-142482569)⟩, ⟨1362627, 1362629⟩, ⟨674551, 674555⟩, ⟨(-6742), (-6738)⟩, ⟨(-1661), (-1658)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-19080198), (-19080196)⟩, ⟨(-37977923), (-37977919)⟩, ⟨(-18624923), (-18624917)⟩, ⟨362230, 362235⟩, ⟨88301, 88306⟩⟩
...
def j19 : Jet := ⟨⟨1412575567, 1412575570⟩, ⟨(-37977923), (-37977919)⟩, ⟨(-18624923), (-18624917)⟩, ⟨362230, 362235⟩, ⟨88301, 88306⟩⟩
...
def j22 : Jet := ⟨⟨(-15), (-14)⟩, ⟨(-29), (-28)⟩, ⟨(-15), (-14)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11820, 11822⟩, ⟨(-29), (-28)⟩, ⟨(-15), (-14)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1582, 1584⟩, ⟨3161, 3164⟩, ⟨1571, 1576⟩, ⟨(-9), (-6)⟩, ⟨(-3), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850595), (-850592)⟩, ⟨3161, 3164⟩, ⟨1571, 1576⟩, ⟨(-9), (-6)⟩, ⟨(-3), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-113906), (-113904)⟩, ⟨(-227388), (-227385)⟩, ⟨(-112850), (-112844)⟩, ⟨841, 847⟩, ⟨206, 211⟩⟩
...
def j30 : Jet := ⟨⟨35677488, 35677491⟩, ⟨(-227388), (-227385)⟩, ⟨(-112850), (-112844)⟩, ⟨841, 847⟩, ⟨206, 211⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4777661, 4777662⟩, ⟨9524872, 9524875⟩, ⟨4701647, 4701652⟩, ⟨(-60564), (-60557)⟩, ⟨(-14861), (-14855)⟩⟩
...
def j33 : Jet := ⟨⟨(-711050222), (-711050220)⟩, ⟨9524872, 9524875⟩, ⟨4701647, 4701652⟩, ⟨(-60564), (-60557)⟩, ⟨(-14861), (-14855)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-95218513), (-95218511)⟩, ⟨(-189161526), (-189161522)⟩, ⟨(-92037906), (-92037901)⟩, ⟨2526606, 2526611⟩, ⟨611397, 611403⟩⟩
...
def j36 : Jet := ⟨⟨4199748783, 4199748785⟩, ⟨(-189161526), (-189161522)⟩, ⟨(-92037906), (-92037901)⟩, ⟨2526606, 2526611⟩, ⟨611397, 611403⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨516918702, 516918706⟩, ⟨503021039, 503021045⟩, ⟨(-20713278), (-20713273)⟩, ⟨(-6683061), (-6683055)⟩, ⟨164866, 164872⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4392344642, 4392344645⟩, ⟨197836260, 197836267⟩, ⟨105169429, 105169439⟩, ⟨6430072, 6430082⟩, ⟨1835953, 1835964⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨528638505, 528638510⟩, ⟨538236234, 538236243⟩, ⟨14645044, 14645054⟩, ⟨5302510, 5302523⟩, ⟨327611, 327626⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-500288529), (-500288528)⟩, ⟨(-500288529), (-500288528)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3794678767, 3794678768⟩, ⟨(-500288529), (-500288528)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨65066541, 65066544⟩, ⟨132495722, 132495728⟩, ⟨71055746, 71055753⟩, ⟨4975870, 4975880⟩, ⟨1459580, 1459591⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4360033837, 4360033840⟩, ⟨132495722, 132495728⟩, ⟨71055746, 71055753⟩, ⟨4975870, 4975880⟩, ⟨1459580, 1459591⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4327378275, 4327378278⟩, ⟨65751681, 65751685⟩, ⟨34762250, 34762256⟩, ⟨1941110, 1941117⟩, ⟨555205, 555213⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3823314434, 3823314438⟩, ⟨(-445971082), (-445971074)⟩, ⟨23054135, 23054142⟩, ⟨(-2334191), (-2334182)⟩, ⟨264426, 264436⟩⟩
...
def j47 : Jet := ⟨⟨1704098972, 1704098977⟩, ⟨1704098972, 1704098977⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨676129317, 676129322⟩, ⟨1352258634, 1352258644⟩, ⟨676129317, 676129322⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨676129317, 676129322⟩, ⟨1352258634, 1352258644⟩, ⟨676129317, 676129322⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-676129322), (-676129317)⟩, ⟨(-1352258644), (-1352258634)⟩, ⟨(-676129322), (-676129317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-338064661), (-338064658)⟩, ⟨(-676129322), (-676129317)⟩, ⟨(-338064661), (-338064658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3969865155, 3969865159⟩, ⟨(-624950566), (-624950559)⟩, ⟨(-263284293), (-263284287)⟩, ⟨46609715, 46609718⟩, ⟨8527423, 8527425⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3533913462, 3533913470⟩, ⟨(-968535334), (-968535318)⟩, ⟨(-148170387), (-148170370)⟩, ⟨63317511, 63317528⟩, ⟨1922044, 1922061⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 1000577057⟩, ⟨500288528, 500288529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 3143405532⟩, ⟨1571702764, 1571702768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 2300599204⟩, ⟨0, 2300599208⟩, ⟨575149799, 575149803⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 577⟩, ⟨0, 577⟩, ⟨143, 145⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94109)⟩, ⟨0, 577⟩, ⟨143, 145⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-50720), 0⟩, ⟨(-50720), 310⟩, ⟨(-12680), (-12214)⟩, ⟨0, 156⟩, ⟨19, 20⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5062336, 5113057⟩, ⟨(-50720), 310⟩, ⟨(-12680), (-12214)⟩, ⟨0, 156⟩, ⟨19, 20⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2738809⟩, ⟨(-27169), 2738976⟩, ⟨643948, 684870⟩, ⟨(-13586), 126⟩, ⟨(-1699), (-1540)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-140426767)⟩, ⟨(-27169), 2738976⟩, ⟨643948, 684870⟩, ⟨(-13586), 126⟩, ⟨(-1699), (-1540)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-76686641), 0⟩, ⟨(-76701195), 1467133⟩, ⟨(-19186215), (-16970915)⟩, ⟨(-10917), 733703⟩, ⟨78043, 91781⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1354969124, 1431655766⟩, ⟨(-76701195), 1467133⟩, ⟨(-19186215), (-16970915)⟩, ⟨(-10917), 733703⟩, ⟨78043, 91781⟩⟩
...
def j70 : Jet := ⟨⟨(-58), 0⟩, ⟨(-58), 0⟩, ⟨(-15), (-14)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11777, 11836⟩, ⟨(-58), 0⟩, ⟨(-15), (-14)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 6340⟩, ⟨(-32), 6340⟩, ⟨1536, 1585⟩, ⟨(-17), 0⟩, ⟨(-3), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-845836)⟩, ⟨(-32), 6340⟩, ⟨1536, 1585⟩, ⟨(-17), 0⟩, ⟨(-3), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-456469), 0⟩, ⟨(-456487), 3397⟩, ⟨(-114136), (-109021)⟩, ⟨(-15), 1700⟩, ⟨193, 213⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35334925, 35791395⟩, ⟨(-456487), 3397⟩, ⟨(-114136), (-109021)⟩, ⟨(-15), 1700⟩, ⟨193, 213⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 19171661⟩, ⟨(-244518), 19173481⟩, ⟨4426133, 4794736⟩, ⟨(-122276), 1366⟩, ⟨(-15294), (-13573)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-696656221)⟩, ⟨(-244518), 19173481⟩, ⟨4426133, 4794736⟩, ⟨(-122276), 1366⟩, ⟨(-15294), (-13573)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-383433201), 0⟩, ⟨(-383564179), 10270275⟩, ⟨(-95989278), (-80452398)⟩, ⟨(-98243), 5136602⟩, ⟨519023, 642808⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3911534095, 4294967296⟩, ⟨(-383564179), 10270275⟩, ⟨(-95989278), (-80452398)⟩, ⟨(-98243), 5136602⟩, ⟨519023, 642808⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 1047801845⟩, ⟨439702010, 524974690⟩, ⟨(-42110108), 536884⟩, ⟨(-7029005), (-5673362)⟩, ⟨(-3995), 335665⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4715987034⟩, ⟨(-12382479), 462448659⟩, ⟨79346574, 161078217⟩, ⟨(-6919807), 27262262⟩, ⟨(-428852), 6072561⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 1150513980⟩, ⟨436681175, 689255165⟩, ⟨(-47751519), 96411406⟩, ⟨(-5817089), 20787577⟩, ⟨(-3290945), 5222707⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1000577057), 0⟩, ⟨(-500288529), (-500288528)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3294390239, 4294967296⟩, ⟨(-500288529), (-500288528)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 308193830⟩, ⟨0, 369268332⟩, ⟨18815711, 162263873⟩, ⟨(-18442808), 42081094⟩, ⟨(-4702078), 11634234⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4603161126⟩, ⟨0, 369268332⟩, ⟨18815711, 162263873⟩, ⟨(-18442808), 42081094⟩, ⟨(-4702078), 11634234⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4446394775⟩, ⟨0, 184634166⟩, ⟨5254041, 81131937⟩, ⟨(-12709144), 21040547⟩, ⟨(-4021833), 6360251⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3294390239, 4446394775⟩, ⟨(-517927181), (-315654362)⟩, ⟨(-17476617), 81131937⟩, ⟨(-22159595), 20428544⟩, ⟨(-6472689), 7840644⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3408197951⟩, ⟨1704098972, 1704098977⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2704517281⟩, ⟨0, 2704517284⟩, ⟨676129317, 676129322⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2704517281⟩, ⟨0, 2704517284⟩, ⟨676129317, 676129322⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2704517281), 0⟩, ⟨(-2704517284), 0⟩, ⟨(-676129322), (-676129317)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1352258641), 0⟩, ⟨(-1352258642), 0⟩, ⟨(-338064661), (-338064658)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3134898165, 4294967296⟩, ⟨(-1352258642), 0⟩, ⟨(-338064661), (-33876057)⟩, ⟨0, 106438729⟩, ⟨(-7044763), 13304842⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2404576613, 4446394775⟩, ⟨(-1917862349), (-230396231)⟩, ⟨(-367460410), 218215765⟩, ⟨(-45214076), 176889432⟩, ⟨(-39419116), 29967080⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨500288528, 500288529⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨500288528, 500288529⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4327378275, 4327378278⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified172
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 1000577057⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4446394775⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified173
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (406584119 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(46593 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(46593 / 200000), prawitzNormalCorrection
