...
namespace FiniteNormalPanel151_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (28209 / 160000)
def radius : Rat := (28209 / 800000)

def j0 : Jet := ⟨⟨757229577, 757229578⟩, ⟨151445915, 151445916⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2378906876, 2378906880⟩, ⟨475781373, 475781378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1317634695, 1317634700⟩, ⟨527053874, 527053884⟩, ⟨52705387, 52705389⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨329, 331⟩, ⟨131, 133⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94358), (-94355)⟩, ⟨131, 133⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-28948), (-28946)⟩, ⟨(-11540), (-11537)⟩, ⟨(-1139), (-1135)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5084108, 5084111⟩, ⟨(-11540), (-11537)⟩, ⟨(-1139), (-1135)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1559731, 1559733⟩, ⟨620351, 620355⟩, ⟨60622, 60627⟩, ⟨(-282), (-278)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-141605846), (-141605843)⟩, ⟨620351, 620355⟩, ⟨60622, 60627⟩, ⟨(-282), (-278)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-43442654), (-43442652)⟩, ⟨(-17186748), (-17186743)⟩, ⟨(-1642985), (-1642979)⟩, ⟨14964, 14968⟩, ⟨703, 707⟩⟩
...
def j19 : Jet := ⟨⟨1388213111, 1388213114⟩, ⟨(-17186748), (-17186743)⟩, ⟨(-1642985), (-1642979)⟩, ⟨14964, 14968⟩, ⟨703, 707⟩⟩
...
def j22 : Jet := ⟨⟨(-34), (-32)⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11801, 11804⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3620, 3622⟩, ⟨1443, 1446⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848557), (-848554)⟩, ⟨1443, 1446⟩, ⟨141, 144⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-260326), (-260324)⟩, ⟨(-103689), (-103685)⟩, ⟨(-10194), (-10189)⟩, ⟨33, 36⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35531068, 35531071⟩, ⟨(-103689), (-103685)⟩, ⟨(-10194), (-10189)⟩, ⟨33, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10900424, 10900426⟩, ⟨4328358, 4328362⟩, ⟨420163, 420170⟩, ⟨(-2514), (-2510)⟩, ⟨(-123), (-119)⟩⟩
...
def j33 : Jet := ⟨⟨(-704927459), (-704927456)⟩, ⟨4328358, 4328362⟩, ⟨420163, 420170⟩, ⟨(-2514), (-2510)⟩, ⟨(-123), (-119)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-216261689), (-216261687)⟩, ⟨(-85176799), (-85176794)⟩, ⟨(-7990417), (-7990412)⟩, ⟨103903, 103907⟩, ⟨4809, 4813⟩⟩
...
def j36 : Jet := ⟨⟨4078705607, 4078705609⟩, ⟨(-85176799), (-85176794)⟩, ⟨(-7990417), (-7990412)⟩, ⟨103903, 103907⟩, ⟨4809, 4813⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨768906836, 768906840⟩, ⟨144261928, 144261935⟩, ⟨(-2813909), (-2813903)⟩, ⟨(-173717), (-173712)⟩, ⟨2046, 2051⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4522695639, 4522695642⟩, ⟨94448766, 94448773⟩, ⟨10832612, 10832621⟩, ⟨296030, 296040⟩, ⟨19658, 19669⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨809675919, 809675925⟩, ⟨168819700, 168819711⟩, ⟨2148601, 2148611⟩, ⟨172040, 172051⟩, ⟨4697, 4709⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-757229578), (-757229577)⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3537737718, 3537737719⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨152637971, 152637974⟩, ⟨63650890, 63650896⟩, ⟨7445790, 7445798⟩, ⟨233770, 233780⟩, ⟨16368, 16377⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4447605267, 4447605270⟩, ⟨63650890, 63650896⟩, ⟨7445790, 7445798⟩, ⟨233770, 233780⟩, ⟨16368, 16377⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4370619998, 4370620000⟩, ⟨31274566, 31274570⟩, ⟨3546558, 3546564⟩, ⟨89483, 89490⟩, ⟨5962, 5969⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3600052375, 3600052379⟩, ⟨(-128352861), (-128352855)⟩, ⟨1818496, 1818503⟩, ⟨(-51351), (-51343)⟩, ⟨1754, 1762⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨35945803781, 35945803788⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value621

def j47 : Jet := ⟨⟨6337469860, 6337469871⟩, ⟨1267493968, 1267493978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9351299197, 9351299230⟩, ⟨3740519666, 3740519704⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9351299197, 9351299230⟩, ⟨3740519666, 3740519704⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9351299230), (-9351299197)⟩, ⟨(-3740519704), (-3740519666)⟩, ⟨(-374051972), (-374051965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4675649615), (-4675649598)⟩, ⟨(-1870259852), (-1870259833)⟩, ⟨(-187025986), (-187025982)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1446012007, 1446012027⟩, ⟨(-629671440), (-629671424)⟩, ⟨74129262, 74129271⟩, ⟨7519562, 7519566⟩, ⟨(-2432600), (-2432598)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1212050896, 1212050915⟩, ⟨(-571005501), (-571005482)⟩, ⟨81564977, 81564993⟩, ⟨3803706, 3803718⟩, ⟨(-2224228), (-2224217)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨605783662, 908675494⟩, ⟨151445915, 151445916⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1903125502, 2854688257⟩, ⟨475781373, 475781378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨843286206, 1897393970⟩, ⟨421643100, 632464660⟩, ⟨52705387, 52705389⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨211, 476⟩, ⟨105, 159⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94476), (-94210)⟩, ⟨105, 159⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-41737), (-18497)⟩, ⟨(-13893), (-9177)⟩, ⟨(-1148), (-1125)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5071319, 5094560⟩, ⟨(-13893), (-9177)⟩, ⟨(-1148), (-1125)⟩, ⟨2, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨995717, 2250632⟩, ⟨491720, 748410⟩, ⟨59678, 61398⟩, ⟨(-341), (-219)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142169860), (-140914944)⟩, ⟨491720, 748410⟩, ⟨59678, 61398⟩, ⟨(-341), (-219)⟩, ⟨(-15), (-11)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-62806587), (-27667644)⟩, ⟨(-20838984), (-13503195)⟩, ⟨(-1684639), (-1591894)⟩, ⟨11741, 18185⟩, ⟨674, 731⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1368849178, 1403988122⟩, ⟨(-20838984), (-13503195)⟩, ⟨(-1684639), (-1591894)⟩, ⟨11741, 18185⟩, ⟨674, 731⟩⟩
...
def j70 : Jet := ⟨⟨(-48), (-21)⟩, ⟨(-16), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11787, 11815⟩, ⟨(-16), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2314, 5220⟩, ⟨1149, 1739⟩, ⟨140, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849863), (-846956)⟩, ⟨1149, 1739⟩, ⟨140, 145⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-375446), (-166293)⟩, ⟨(-124924), (-82377)⟩, ⟨(-10291), (-10071)⟩, ⟨26, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35415948, 35625102⟩, ⟨(-124924), (-82377)⟩, ⟨(-10291), (-10071)⟩, ⟨26, 44⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6953668, 15738154⟩, ⟨3421646, 5229878⟩, ⟨411661, 427107⟩, ⟨(-3044), (-1978)⟩, ⟨(-126), (-115)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708874215), (-700089728)⟩, ⟨3421646, 5229878⟩, ⟨411661, 427107⟩, ⟨(-3044), (-1978)⟩, ⟨(-126), (-115)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-313160397), (-137457626)⟩, ⟨(-103714985), (-66418401)⟩, ⟨(-8282168), (-7632280)⟩, ⟨81056, 126686⟩, ⟨4546, 5026⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3981806899, 4157509670⟩, ⟨(-103714985), (-66418401)⟩, ⟨(-8282168), (-7632280)⟩, ⟨81056, 126686⟩, ⟨4546, 5026⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨606545195, 933173207⟩, ⟨137785481, 149545524⟩, ⟨(-3428181), (-2201213)⟩, ⟨(-181417), (-164257)⟩, ⟨1598, 2501⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4436969613, 4632757073⟩, ⟨70882919, 120670426⟩, ⟨9277698, 12779276⟩, ⟨137172, 493540⟩, ⟨9943, 32931⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨626599089, 1006565238⟩, ⟨152351261, 187525176⟩, ⟨(-113611), 4704179⟩, ⟨25001, 346177⟩, ⟨(-7845), 19574⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-908675494), (-605783662)⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3386291802, 3689183634⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨91415461, 235897857⟩, ⟨44453498, 87896514⟩, ⟨5350958, 10392587⟩, ⟨(-2628), 573046⟩, ⟨(-2031), 44559⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4386382757, 4530865153⟩, ⟨44453498, 87896514⟩, ⟨5350958, 10392587⟩, ⟨(-2628), 573046⟩, ⟨(-2031), 44559⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4340434366, 4411339667⟩, ⟨21640401, 43487889⟩, ⟨2390542, 5087915⟩, ⟨(-52278), 271604⟩, ⟨(-6710), 21913⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3422139517, 3789142264⟩, ⟨(-138487357), (-115695000)⟩, ⟨351343, 3607224⟩, ⟨(-224312), 149003⟩, ⟨(-15342), 20667⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5069975892, 7604963848⟩, ⟨1267493968, 1267493978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5984831495, 13465870901⟩, ⟨2992415734, 4488623646⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5984831495, 13465870901⟩, ⟨2992415734, 4488623646⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13465870901), (-5984831495)⟩, ⟨(-4488623646), (-2992415734)⟩, ⟨(-374051972), (-374051965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6732935451), (-2992415747)⟩, ⟨(-2244311823), (-1496207867)⟩, ⟨(-187025986), (-187025982)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨895664157, 2139811749⟩, ⟨(-1118147003), (-312016289)⟩, ⟨(-38831446), 253138785⟩, ⟨(-35034188), 39223812⟩, ⟨(-10635560), 5422197⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨713646343, 1887802765⟩, ⟨(-1055457384), (-272734821)⟩, ⟨(-25780049), 261177048⟩, ⟨(-40121247), 35905162⟩, ⟨(-10726781), 6194563⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨757229577, 757229578⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4370619998, 4370620000⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar621 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3044
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar621 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨605783662, 908675494⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4340434366, 4411339667⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3045
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((28209 / 200000) : ℝ)..(84627 / 400000), prawitzNormalCorrection
      ((108047 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
