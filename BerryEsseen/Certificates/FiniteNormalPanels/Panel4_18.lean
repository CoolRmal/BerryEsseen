...
namespace FiniteNormalPanel4_18
...
def j2 : Jet := ⟨⟨708131483, 708131487⟩, ⟨708131483, 708131487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨116752972, 116752974⟩, ⟨233505944, 233505948⟩, ⟨116752972, 116752974⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨29, 30⟩, ⟨58, 59⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94658), (-94656)⟩, ⟨58, 59⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2574), (-2573)⟩, ⟨(-5146), (-5144)⟩, ⟨(-2571), (-2568)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110482, 5110484⟩, ⟨(-5146), (-5144)⟩, ⟨(-2571), (-2568)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨138921, 138922⟩, ⟨277703, 277705⟩, ⟨138571, 138574⟩, ⟨(-280), (-277)⟩, ⟨(-70), (-67)⟩⟩
...
def j16 : Jet := ⟨⟨(-143026656), (-143026654)⟩, ⟨277703, 277705⟩, ⟨138571, 138574⟩, ⟨(-280), (-277)⟩, ⟨(-70), (-67)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3887990), (-3887989)⟩, ⟨(-7768431), (-7768428)⟩, ⟨(-3869127), (-3869123)⟩, ⟨15073, 15077⟩, ⟨3748, 3751⟩⟩
...
def j19 : Jet := ⟨⟨1427767775, 1427767777⟩, ⟨(-7768431), (-7768428)⟩, ⟨(-3869127), (-3869123)⟩, ⟨15073, 15077⟩, ⟨3748, 3751⟩⟩
...
def j25 : Jet := ⟨⟨321, 322⟩, ⟨642, 644⟩, ⟨319, 322⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851856), (-851854)⟩, ⟨642, 644⟩, ⟨319, 322⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-23157), (-23156)⟩, ⟨(-46297), (-46295)⟩, ⟨(-23115), (-23111)⟩, ⟨33, 36⟩, ⟨6, 9⟩⟩
...
def j30 : Jet := ⟨⟨35768237, 35768239⟩, ⟨(-46297), (-46295)⟩, ⟨(-23115), (-23111)⟩, ⟨33, 36⟩, ⟨6, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨972311, 972313⟩, ⟨1943364, 1943367⟩, ⟨969164, 969169⟩, ⟨(-2516), (-2513)⟩, ⟨(-628), (-625)⟩⟩
...
def j33 : Jet := ⟨⟨(-714855572), (-714855569)⟩, ⟨1943364, 1943367⟩, ⟨969164, 969169⟩, ⟨(-2516), (-2513)⟩, ⟨(-628), (-625)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-19432399), (-19432397)⟩, ⟨(-38811970), (-38811967)⟩, ⟨(-19300399), (-19300395)⟩, ⟨105448, 105452⟩, ⟨26190, 26194⟩⟩
...
def j36 : Jet := ⟨⟨4275534897, 4275534899⟩, ⟨(-38811970), (-38811967)⟩, ⟨(-19300399), (-19300395)⟩, ⟨105448, 105452⟩, ⟨26190, 26194⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨235402796, 235402799⟩, ⟨234121978, 234121982⟩, ⟨(-1918740), (-1918737)⟩, ⟨(-635437), (-635434)⟩, ⟨3102, 3105⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4314488013, 4314488016⟩, ⟨39165570, 39165576⟩, ⟨19831766, 19831774⟩, ⟨250411, 250420⟩, ⟨64395, 64404⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨236472706, 236472710⟩, ⟨237332692, 237332698⟩, ⟨1294442, 1294449⟩, ⟨438945, 438954⟩, ⟨5640, 5648⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-225405253), (-225405252)⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4069562043, 4069562044⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨13019736, 13019737⟩, ⟨26134170, 26134172⟩, ⟨13257144, 13257148⟩, ⟨191390, 191396⟩, ⟨49520, 49525⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4307987032, 4307987033⟩, ⟨26134170, 26134172⟩, ⟨13257144, 13257148⟩, ⟨191390, 191396⟩, ⟨49520, 49525⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4301472237, 4301472239⟩, ⟨13047324, 13047326⟩, ⟨6598759, 6598763⟩, ⟨75534, 75539⟩, ⟨19431, 19436⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4075725596, 4075725600⟩, ⟨(-213384057), (-213384052)⟩, ⟨5567707, 5567713⟩, ⟨(-274743), (-274736)⟩, ⟨14446, 14452⟩⟩
...
def j47 : Jet := ⟨⟨923014657, 923014662⟩, ⟨923014657, 923014662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨198361477, 198361480⟩, ⟨396722954, 396722960⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨198361477, 198361480⟩, ⟨396722954, 396722960⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-198361480), (-198361477)⟩, ⟨(-396722960), (-396722954)⟩, ⟨(-198361480), (-198361477)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-99180740), (-99180738)⟩, ⟨(-198361480), (-198361477)⟩, ⟨(-99180740), (-99180738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4196922948, 4196922951⟩, ⟨(-193833339), (-193833335)⟩, ⟨(-92440610), (-92440606)⟩, ⟨4407151, 4407153⟩, ⟨1016448, 1016449⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3982686038, 3982686045⟩, ⟨(-392451871), (-392451860)⟩, ⟨(-72651168), (-72651154)⟩, ⟨8255103, 8255116⟩, ⟨652284, 652297⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 450810505⟩, ⟨225405252, 225405253⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1416262971⟩, ⟨708131483, 708131487⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 467011893⟩, ⟨0, 467011894⟩, ⟨116752972, 116752974⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 117⟩, ⟨0, 117⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94569)⟩, ⟨0, 117⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-10296), 0⟩, ⟨(-10296), 13⟩, ⟨(-2574), (-2553)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5102760, 5113057⟩, ⟨(-10296), 13⟩, ⟨(-2574), (-2553)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 555967⟩, ⟨(-1120), 555969⟩, ⟨137311, 138994⟩, ⟨(-560), 2⟩, ⟨(-70), (-67)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142609609)⟩, ⟨(-1120), 555969⟩, ⟨137311, 138994⟩, ⟨(-560), 2⟩, ⟨(-70), (-67)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-15567064), 0⟩, ⟨(-15567186), 60454⟩, ⟨(-3891888), (-3801084)⟩, ⟨(-92), 30229⟩, ⟨3663, 3780⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1416088701, 1431655766⟩, ⟨(-15567186), 60454⟩, ⟨(-3891888), (-3801084)⟩, ⟨(-92), 30229⟩, ⟨3663, 3780⟩⟩
...
def j72 : Jet := ⟨⟨0, 1287⟩, ⟨(-2), 1287⟩, ⟨318, 322⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-850889)⟩, ⟨(-2), 1287⟩, ⟨318, 322⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-92662), 0⟩, ⟨(-92663), 140⟩, ⟨(-23167), (-22954)⟩, ⟨(-2), 71⟩, ⟨6, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35698732, 35791395⟩, ⟨(-92663), 140⟩, ⟨(-23167), (-22954)⟩, ⟨(-2), 71⟩, ⟨6, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3891766⟩, ⟨(-10076), 3891782⟩, ⟨957826, 972958⟩, ⟨(-5040), 12⟩, ⟨(-631), (-614)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-711936116)⟩, ⟨(-10076), 3891782⟩, ⟨957826, 972958⟩, ⟨(-5040), 12⟩, ⟨(-631), (-614)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-77835316), 0⟩, ⟨(-77836412), 423172⟩, ⟨(-19459926), (-18824069)⟩, ⟨(-823), 211590⟩, ⟨25419, 26451⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4217131980, 4294967296⟩, ⟨(-77836412), 423172⟩, ⟨(-19459926), (-18824069)⟩, ⟨(-823), 211590⟩, ⟨25419, 26451⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 472087658⟩, ⟨228343941, 236063765⟩, ⟨(-3849984), 9968⟩, ⟨(-641705), (-616734)⟩, ⟨(-16), 6231⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4374239214⟩, ⟨(-438938), 80736171⟩, ⟨18816114, 21675061⟩, ⟨(-223675), 773473⟩, ⟨47495, 88431⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 480800948⟩, ⟨228295694, 249295014⟩, ⟨(-3945169), 6830092⟩, ⟨249860, 660002⟩, ⟨(-43804), 58698⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-450810505), 0⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3844156791, 4294967296⟩, ⟨(-225405253), (-225405252)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 53823356⟩, ⟨0, 55814758⟩, ⟨11251596, 15999152⟩, ⟨(-457984), 940656⟩, ⟨10480, 100622⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4348790652⟩, ⟨0, 55814758⟩, ⟨11251596, 15999152⟩, ⟨(-457984), 940656⟩, ⟨10480, 100622⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4321795186⟩, ⟨0, 27907379⟩, ⟨5500771, 7999576⟩, ⟨(-280971), 470328⟩, ⟨(-5267), 48615⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3844156791, 4321795186⟩, ⟨(-226813215), (-197497873)⟩, ⟨3458781, 7999576⟩, ⟨(-700799), 181641⟩, ⟨(-29951), 63361⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1846029320⟩, ⟨923014657, 923014662⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 793445914⟩, ⟨0, 793445916⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 793445914⟩, ⟨0, 793445916⟩, ⟨198361477, 198361480⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-793445914), 0⟩, ⟨(-793445916), 0⟩, ⟨(-198361480), (-198361477)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-396722957), 0⟩, ⟨(-396722958), 0⟩, ⟨(-99180740), (-99180738)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3916015487, 4294967296⟩, ⟨(-396722958), 0⟩, ⟨(-99180740), (-72107359)⟩, ⟨0, 9161252⟩, ⟨621008, 1145157⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3504980711, 4321795186⟩, ⟨(-626014246), (-180072320)⟩, ⟨(-96646652), (-35588644)⟩, ⟨1876038, 14637761⟩, ⟨(-159432), 1222337⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4301472237, 4301472239⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified82
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4321795186⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified83
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (207758231 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(8397 / 80000), prawitzNormalCorrection
