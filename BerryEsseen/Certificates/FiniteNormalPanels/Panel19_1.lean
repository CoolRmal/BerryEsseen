...
namespace FiniteNormalPanel19_1

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (20537 / 200000)
def radius : Rat := (20537 / 200000)

def j0 : Jet := ⟨⟨441028716, 441028717⟩, ⟨441028716, 441028717⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1385532574, 1385532578⟩, ⟨1385532574, 1385532578⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨446965106, 446965109⟩, ⟨893930212, 893930218⟩, ⟨446965106, 446965109⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨111, 112⟩, ⟨223, 224⟩, ⟨111, 112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94576), (-94574)⟩, ⟨223, 224⟩, ⟨111, 112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9843), (-9842)⟩, ⟨(-19662), (-19660)⟩, ⟨(-9786), (-9783)⟩, ⟨46, 48⟩, ⟨11, 12⟩⟩
...
def j13 : Jet := ⟨⟨5103213, 5103215⟩, ⟨(-19662), (-19660)⟩, ⟨(-9786), (-9783)⟩, ⟨46, 48⟩, ⟨11, 12⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨531076, 531078⟩, ⟨1060106, 1060110⟩, ⟨525964, 525969⟩, ⟨(-4080), (-4076)⟩, ⟨(-1009), (-1006)⟩⟩
...
def j16 : Jet := ⟨⟨(-142634501), (-142634498)⟩, ⟨1060106, 1060110⟩, ⟨525964, 525969⟩, ⟨(-4080), (-4076)⟩, ⟨(-1009), (-1006)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14843570), (-14843569)⟩, ⟨(-29576817), (-29576815)⟩, ⟨(-14568191), (-14568186)⟩, ⟨219368, 219372⟩, ⟨53779, 53785⟩⟩
...
def j19 : Jet := ⟨⟨1416812195, 1416812197⟩, ⟨(-29576817), (-29576815)⟩, ⟨(-14568191), (-14568186)⟩, ⟨219368, 219372⟩, ⟨53779, 53785⟩⟩
...
def j22 : Jet := ⟨⟨(-12), (-11)⟩, ⟨(-23), (-22)⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11823, 11825⟩, ⟨(-23), (-22)⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1230, 1231⟩, ⟨2457, 2460⟩, ⟨1223, 1226⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850947), (-850945)⟩, ⟨2457, 2460⟩, ⟨1223, 1226⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-88556), (-88555)⟩, ⟨(-176857), (-176853)⟩, ⟨(-87918), (-87914)⟩, ⟨508, 513⟩, ⟨124, 128⟩⟩
...
def j30 : Jet := ⟨⟨35702838, 35702840⟩, ⟨(-176857), (-176853)⟩, ⟨(-87918), (-87914)⟩, ⟨508, 513⟩, ⟨124, 128⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3715493, 3715494⟩, ⟨7412580, 7412584⟩, ⟨3669532, 3669537⟩, ⟨(-36653), (-36647)⟩, ⟨(-9033), (-9027)⟩⟩
...
def j33 : Jet := ⟨⟨(-712112390), (-712112388)⟩, ⟨7412580, 7412584⟩, ⟨3669532, 3669537⟩, ⟨(-36653), (-36647)⟩, ⟨(-9033), (-9027)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-74107525), (-74107523)⟩, ⟨(-147443643), (-147443639)⟩, ⟨(-72182836), (-72182830)⟩, ⟨1531346, 1531351⟩, ⟨373307, 373313⟩⟩
...
def j36 : Jet := ⟨⟨4220859771, 4220859773⟩, ⟨(-147443643), (-147443639)⟩, ⟨(-72182836), (-72182830)⟩, ⟨1531346, 1531351⟩, ⟨373307, 373313⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨457055738, 457055741⟩, ⟨447514421, 447514425⟩, ⟨(-14240935), (-14240931)⟩, ⟨(-4628852), (-4628846)⟩, ⟨88114, 88120⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4370375957, 4370375961⟩, ⟨152666557, 152666564⟩, ⟨80072741, 80072751⟩, ⟨3822333, 3822343⟩, ⟨1060955, 1060966⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨465080469, 465080474⟩, ⟨471617884, 471617891⟩, ⟨9937199, 9937208⟩, ⟨3533619, 3533632⟩, ⟨170797, 170810⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-441028717), (-441028716)⟩, ⟨(-441028717), (-441028716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3853938579, 3853938580⟩, ⟨(-441028717), (-441028716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨50361231, 50361233⟩, ⟨102138270, 102138274⟩, ⟨53939088, 53939094⟩, ⟨2947622, 2947632⟩, ⟨836011, 836022⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4345328527, 4345328529⟩, ⟨102138270, 102138274⟩, ⟨53939088, 53939094⟩, ⟨2947622, 2947632⟩, ⟨836011, 836022⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4320074526, 4320074528⟩, ⟨50772333, 50772336⟩, ⟨26514448, 26514453⟩, ⟨1153630, 1153637⟩, ⟨320651, 320659⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3876467673, 3876467676⟩, ⟨(-398048079), (-398048072)⟩, ⟨18578253, 18578260⟩, ⟨(-1687468), (-1687460)⟩, ⟨169262, 169273⟩⟩
...
def j47 : Jet := ⟨⟨1905409691, 1905409697⟩, ⟨1905409691, 1905409697⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨845311696, 845311702⟩, ⟨1690623392, 1690623404⟩, ⟨845311696, 845311702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨845311696, 845311702⟩, ⟨1690623392, 1690623404⟩, ⟨845311696, 845311702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-845311702), (-845311696)⟩, ⟨(-1690623404), (-1690623392)⟩, ⟨(-845311702), (-845311696)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-422655851), (-422655848)⟩, ⟨(-845311702), (-845311696)⟩, ⟨(-422655851), (-422655848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3892441933, 3892441937⟩, ⟨(-766088888), (-766088881)⟩, ⟨(-307655757), (-307655752)⟩, ⟨70442825, 70442828⟩, ⟨11671733, 11671735⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3513164194, 3513164202⟩, ⟨(-1052184462), (-1052184446)⟩, ⟨(-189841406), (-189841390)⟩, ⟨87248657, 87248675⟩, ⟨3129553, 3129572⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 882057434⟩, ⟨441028716, 441028717⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2771065155⟩, ⟨1385532574, 1385532578⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1787860434⟩, ⟨0, 1787860436⟩, ⟨446965106, 446965109⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 448⟩, ⟨0, 448⟩, ⟨111, 112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94238)⟩, ⟨0, 448⟩, ⟨111, 112⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-39416), 0⟩, ⟨(-39416), 187⟩, ⟨(-9854), (-9573)⟩, ⟨0, 94⟩, ⟨11, 12⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073640, 5113057⟩, ⟨(-39416), 187⟩, ⟨(-9854), (-9573)⟩, ⟨0, 94⟩, ⟨11, 12⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2128406⟩, ⟨(-16408), 2128484⟩, ⟨507489, 532180⟩, ⟨(-8204), 60⟩, ⟨(-1026), (-951)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141037170)⟩, ⟨(-16408), 2128484⟩, ⟨507489, 532180⟩, ⟨(-8204), 60⟩, ⟨(-1026), (-951)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-59595348), 0⟩, ⟨(-59602180), 886022⟩, ⟨(-14905669), (-13569787)⟩, ⟨(-5124), 443061⟩, ⟨48968, 55408⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1372060417, 1431655766⟩, ⟨(-59602180), 886022⟩, ⟨(-14905669), (-13569787)⟩, ⟨(-5124), 443061⟩, ⟨48968, 55408⟩⟩
...
def j70 : Jet := ⟨⟨(-45), 0⟩, ⟨(-45), 0⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11790, 11836⟩, ⟨(-45), 0⟩, ⟨(-12), (-11)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 4927⟩, ⟨(-19), 4927⟩, ⟨1202, 1232⟩, ⟨(-10), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-847249)⟩, ⟨(-19), 4927⟩, ⟨1202, 1232⟩, ⟨(-10), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-354735), 0⟩, ⟨(-354743), 2051⟩, ⟨(-88692), (-85606)⟩, ⟨(-7), 1026⟩, ⟨119, 129⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35436659, 35791395⟩, ⟨(-354743), 2051⟩, ⟨(-88692), (-85606)⟩, ⟨(-7), 1026⟩, ⟨119, 129⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 14898838⟩, ⟨(-147669), 14899692⟩, ⟨3503203, 3725564⟩, ⟨(-73841), 642⟩, ⟨(-9233), (-8426)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-700929044)⟩, ⟨(-147669), 14899692⟩, ⟨3503203, 3725564⟩, ⟨(-73841), 642⟩, ⟨(-9233), (-8426)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-297976740), 0⟩, ⟨(-298038210), 6202276⟩, ⟨(-74555655), (-65190592)⟩, ⟨(-46106), 3101673⟩, ⟨329986, 387977⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3996990556, 4294967296⟩, ⟨(-298038210), 6202276⟩, ⟨(-74555655), (-65190592)⟩, ⟨(-46106), 3101673⟩, ⟨329986, 387977⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 923688386⟩, ⟨404164399, 462415845⟩, ⟨(-28844304), 285826⟩, ⟨(-4811792), (-4091678)⟩, ⟨(-1653), 178679⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4615158284⟩, ⟨(-7161511), 344132292⟩, ⟨64693637, 111746756⟩, ⟨(-3888360), 14804790⟩, ⟨46698, 2839308⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 992549609⟩, ⟨402624223, 570899183⟩, ⟨(-31765697), 61390583⟩, ⟨(-2230102), 11171548⟩, ⟨(-1556433), 2412043⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-882057434), 0⟩, ⟨(-441028717), (-441028716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3412909862, 4294967296⟩, ⟨(-441028717), (-441028716)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 229374210⟩, ⟨0, 263864996⟩, ⟨23061456, 104259764⟩, ⟨(-9475510), 21483820⟩, ⟨(-1766283), 4962229⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4524341506⟩, ⟨0, 263864996⟩, ⟨23061456, 104259764⟩, ⟨(-9475510), 21483820⟩, ⟨(-1766283), 4962229⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4408162748⟩, ⟨0, 131932498⟩, ⟨9260321, 52129882⟩, ⟨(-6339077), 10741910⟩, ⟨(-1529474), 2665856⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3412909862, 4408162748⟩, ⟨(-452652192), (-309096218)⟩, ⟨(-6188961), 52129882⟩, ⟨(-11692034), 9791014⟩, ⟨(-2632508), 3316785⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3810819393⟩, ⟨1905409691, 1905409697⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3381246805⟩, ⟨0, 3381246806⟩, ⟨845311696, 845311702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3381246805⟩, ⟨0, 3381246806⟩, ⟨845311696, 845311702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3381246805), 0⟩, ⟨(-3381246806), 0⟩, ⟨(-845311702), (-845311696)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1690623403), 0⟩, ⟨(-1690623403), 0⟩, ⟨(-422655851), (-422655848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2897403539, 4294967296⟩, ⟨(-1690623403), 0⟩, ⟨(-422655851), 47613680⟩, ⟨(-6247375), 166369573⟩, ⟨(-18714735), 21410984⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2302363773, 4408162748⟩, ⟨(-2187832601), (-208517647)⟩, ⟨(-439984064), 279175440⟩, ⟨(-43641959), 227525725⟩, ⟨(-48358368), 31161845⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨441028716, 441028717⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨441028716, 441028717⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4320074526, 4320074528⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified374
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 882057434⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4408162748⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified375
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (354891283 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(20537 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(20537 / 100000), prawitzNormalCorrection
