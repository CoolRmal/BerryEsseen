...
namespace FiniteNormalPanel37_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (320887 / 800000)
def radius : Rat := (45841 / 800000)

def j0 : Jet := ⟨⟨1722748963, 1722748964⟩, ⟨246106994, 246106995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5412175485, 5412175490⟩, ⟨773167924, 773167928⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨6819992205, 6819992218⟩, ⟨1948569194, 1948569208⟩, ⟨139183513, 139183515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1706, 1709⟩, ⟨487, 489⟩, ⟨34, 35⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-92981), (-92977)⟩, ⟨487, 489⟩, ⟨34, 35⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-147645), (-147638)⟩, ⟨(-41412), (-41405)⟩, ⟨(-2741), (-2735)⟩, ⟨30, 32⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨4965411, 4965419⟩, ⟨(-41412), (-41405)⟩, ⟨(-2741), (-2735)⟩, ⟨30, 32⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨7884591, 7884605⟩, ⟨2186981, 2186998⟩, ⟨137768, 137785⟩, ⟨(-2540), (-2530)⟩, ⟨(-75), (-69)⟩⟩
...
def j16 : Jet := ⟨⟨(-135280986), (-135280971)⟩, ⟨2186981, 2186998⟩, ⟨137768, 137785⟩, ⟨(-2540), (-2530)⟩, ⟨(-75), (-69)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-214813108), (-214813083)⟩, ⟨(-57902460), (-57902424)⟩, ⟨(-3172975), (-3172938)⟩, ⟨129340, 129368⟩, ⟨3191, 3210⟩⟩
...
def j19 : Jet := ⟨⟨1216842657, 1216842683⟩, ⟨(-57902460), (-57902424)⟩, ⟨(-3172975), (-3172938)⟩, ⟨129340, 129368⟩, ⟨3191, 3210⟩⟩
...
def j22 : Jet := ⟨⟨(-172), (-169)⟩, ⟨(-49), (-48)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11663, 11667⟩, ⟨(-49), (-48)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨18519, 18527⟩, ⟨5213, 5218⟩, ⟨347, 354⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-833658), (-833649)⟩, ⟨5213, 5218⟩, ⟨347, 354⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1323769), (-1323753)⟩, ⟨(-369943), (-369929)⟩, ⟨(-24100), (-24084)⟩, ⟨318, 328⟩, ⟨7, 12⟩⟩
...
def j30 : Jet := ⟨⟨34467625, 34467642⟩, ⟨(-369943), (-369929)⟩, ⟨(-24100), (-24084)⟩, ⟨318, 328⟩, ⟨7, 12⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨54731251, 54731279⟩, ⟨15050066, 15050098⟩, ⟨910856, 910891⟩, ⟨(-22419), (-22392)⟩, ⟨(-626), (-611)⟩⟩
...
def j33 : Jet := ⟨⟨(-661096632), (-661096603)⟩, ⟨15050066, 15050098⟩, ⟨910856, 910891⟩, ⟨(-22419), (-22392)⟩, ⟨(-626), (-611)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-1049757443), (-1049757394)⟩, ⟨(-276032652), (-276032584)⟩, ⟨(-13149258), (-13149184)⟩, ⟨865358, 865421⟩, ⟨18350, 18391⟩⟩
...
def j36 : Jet := ⟨⟨3245209853, 3245209902⟩, ⟨(-276032652), (-276032584)⟩, ⟨(-13149258), (-13149184)⟩, ⟨865358, 865421⟩, ⟨18350, 18391⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1533368136, 1533368171⟩, ⟨146088524, 146088576⟩, ⟨(-14421769), (-14421714)⟩, ⟨(-408208), (-408163)⟩, ⟨27304, 27334⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5684299207, 5684299294⟩, ⟨483497784, 483497919⟩, ⟨64157647, 64157804⟩, ⟨5900352, 5900494⟩, ⟨600678, 600782⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨2029380593, 2029380671⟩, ⟨365961103, 365961230⟩, ⟨20263976, 20264118⟩, ⟨2125005, 2125131⟩, ⟨189895, 189987⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1722748964), (-1722748963)⟩, ⟨(-246106995), (-246106994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2572218332, 2572218333⟩, ⟨(-246106995), (-246106994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨958886368, 958886442⟩, ⟨345834698, 345834832⟩, ⟨50331968, 50332129⟩, ⟨5461400, 5461548⟩, ⟨637186, 637303⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5253853664, 5253853738⟩, ⟨345834698, 345834832⟩, ⟨50331968, 50332129⟩, ⟨5461400, 5461548⟩, ⟨637186, 637303⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4750276798, 4750276833⟩, ⟨156343384, 156343447⟩, ⟨20181021, 20181098⟩, ⟨1804754, 1804825⟩, ⟨185785, 185843⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2844899208, 2844899231⟩, ⟨(-178564117), (-178564074)⟩, ⟨3127561, 3127613⟩, ⟨(-75552), (-75503)⟩, ⟨7846, 7886⟩⟩
...
def j47 : Jet := ⟨⟨6375549361, 6375549367⟩, ⟨910792763, 910792768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9464013775, 9464013794⟩, ⟨2704003926, 2704003946⟩, ⟨193143137, 193143140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9464013775, 9464013794⟩, ⟨2704003926, 2704003946⟩, ⟨193143137, 193143140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9464013794), (-9464013775)⟩, ⟨(-2704003946), (-2704003926)⟩, ⟨(-193143140), (-193143137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4732006897), (-4732006887)⟩, ⟨(-1352001973), (-1352001963)⟩, ⟨(-96571570), (-96571568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1427161814, 1427161827⟩, ⟨(-449252689), (-449252681)⟩, ⟨38620083, 38620087⟩, ⟨2681870, 2681872⟩, ⟨(-645238), (-645237)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨945323033, 945323051⟩, ⟨(-356910406), (-356910383)⟩, ⟨45298170, 45298199⟩, ⟨(-181475), (-181449)⟩, ⟨(-500267), (-500242)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1476641968, 1968855959⟩, ⟨246106994, 246106995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4639007558, 6185343417⟩, ⟨773167924, 773167928⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨5010606516, 8907744938⟩, ⟨1670202166, 2226936238⟩, ⟨139183513, 139183515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1254, 2232⟩, ⟨418, 558⟩, ⟨34, 35⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93433), (-92454)⟩, ⟨418, 558⟩, ⟨34, 35⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-193780), (-107858)⟩, ⟨(-47958), (-34794)⟩, ⟨(-2827), (-2633)⟩, ⟨26, 38⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4919276, 5005199⟩, ⟨(-47958), (-34794)⟩, ⟨(-2827), (-2633)⟩, ⟨26, 38⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨5738939, 10380763⟩, ⟨1813514, 2554600⟩, ⟨128683, 145599⟩, ⟨(-2991), (-2071)⟩, ⟨(-81), (-60)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-137426638), (-132784813)⟩, ⟨1813514, 2554600⟩, ⟨128683, 145599⟩, ⟨(-2991), (-2071)⟩, ⟨(-81), (-60)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-285022296), (-154909782)⟩, ⟨(-69139889), (-46338362)⟩, ⟨(-3598122), (-2676519)⟩, ⟨102606, 155862⟩, ⟨2451, 3845⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1146633469, 1276745984⟩, ⟨(-69139889), (-46338362)⟩, ⟨(-3598122), (-2676519)⟩, ⟨102606, 155862⟩, ⟨2451, 3845⟩⟩
...
def j70 : Jet := ⟨⟨(-224), (-124)⟩, ⟨(-56), (-41)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11611, 11712⟩, ⟨(-56), (-41)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨13545, 24291⟩, ⟨4398, 6026⟩, ⟨337, 362⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-838632), (-827885)⟩, ⟨4398, 6026⟩, ⟨337, 362⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1739320), (-965829)⟩, ⟨(-429700), (-309445)⟩, ⟨(-25074), (-22952)⟩, ⟨262, 382⟩, ⟨4, 12⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34052074, 34825566⟩, ⟨(-429700), (-309445)⟩, ⟨(-25074), (-22952)⟩, ⟨262, 382⟩, ⟨4, 12⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨39725923, 72228085⟩, ⟨12350777, 17696017⟩, ⟨828693, 981453⟩, ⟨(-26621), (-18159)⟩, ⟨(-708), (-519)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-676101960), (-643599797)⟩, ⟨12350777, 17696017⟩, ⟨828693, 981453⟩, ⟨(-26621), (-18159)⟩, ⟨(-708), (-519)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1402232753), (-750838158)⟩, ⟨(-336149492), (-213577916)⟩, ⟨(-16140216), (-9645717)⟩, ⟨667286, 1061160⟩, ⟨11582, 24140⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨2892734543, 3544129138⟩, ⟨(-336149492), (-213577916)⟩, ⟨(-16140216), (-9645717)⟩, ⟨667286, 1061160⟩, ⟨11582, 24140⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1238482382, 1838689756⟩, ⟨106842782, 179786011⟩, ⟨(-17628160), (-11232617)⟩, ⟨(-536899), (-257356)⟩, ⟨21117, 33596⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5204873568, 6376922528⟩, ⟨313658448, 741028684⟩, ⟨33067432, 121691542⟩, ⟨937040, 17075118⟩, ⟨(-145609), 2570007⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1500859906, 2729981702⟩, ⟨219923358, 584172858⟩, ⟨(-8835421), 69503495⟩, ⟨(-2745824), 11271699⟩, ⟨(-605538), 1759596⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1968855959), (-1476641968)⟩, ⟨(-246106995), (-246106994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2326111337, 2818325328⟩, ⟨(-246106995), (-246106994)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨524469757, 1735240243⟩, ⟨153702752, 742627874⟩, ⟨29150, 167811400⟩, ⟨(-5894092), 33235918⟩, ⟨(-1659708), 6427830⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4819437053, 6030207539⟩, ⟨153702752, 742627874⟩, ⟨29150, 167811400⟩, ⟨(-5894092), 33235918⟩, ⟨(-1659708), 6427830⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4549651033, 5089159476⟩, ⟨64858283, 350528251⟩, ⟨(-13489481), 78746467⟩, ⟨(-8849103), 16727006⟩, ⟨(-2753617), 3832525⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2464045502, 3339468281⟩, ⟨(-256488603), (-30686680)⟩, ⟨(-28937404), 47956382⟩, ⟨(-10318987), 11749101⟩, ⟨(-2765382), 3021940⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5464756594, 7286342134⟩, ⟨910792763, 910792768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6953152974, 12361160874⟩, ⟨2317717650, 3090290224⟩, ⟨193143137, 193143140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6953152974, 12361160874⟩, ⟨2317717650, 3090290224⟩, ⟨193143137, 193143140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12361160874), (-6953152974)⟩, ⟨(-3090290224), (-2317717650)⟩, ⟨(-193143140), (-193143137)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6180580437), (-3476576487)⟩, ⟨(-1545145112), (-1158858825)⟩, ⟨(-96571570), (-96571568)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1018586025, 1911695228⟩, ⟨(-687745991), (-274832687)⟩, ⟨(-5906744), 100808039⟩, ⟨(-7969095), 11017562⟩, ⟨(-2124238), 783141⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨584368201, 1486401441⟩, ⟨(-648906912), (-164950561)⟩, ⟨(-15509125), 140797870⟩, ⟨(-24488481), 18782473⟩, ⟨(-6101048), 5207846⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1722748963, 1722748964⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4750276798, 4750276833⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified730
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1476641968, 1968855959⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4549651033, 5089159476⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified731
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (110186181 / 4294967296)

theorem envelope_integral : (∫ s in ((137523 / 400000) : ℝ)..(45841 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((137523 / 400000) : ℝ)..(45841 / 100000), prawitzNormalCorrection
