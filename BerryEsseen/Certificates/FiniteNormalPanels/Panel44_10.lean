...
namespace FiniteNormalPanel44_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (246323 / 800000)
def radius : Rat := (35189 / 800000)

def j0 : Jet := ⟨⟨1322436536, 1322436537⟩, ⟨188919505, 188919506⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4154556906, 4154556910⟩, ⟨593508129, 593508133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4018736790, 4018736798⟩, ⟨1148210510, 1148210520⟩, ⟨82015036, 82015038⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1005, 1007⟩, ⟨287, 288⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93682), (-93679)⟩, ⟨287, 288⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-87657), (-87654)⟩, ⟨(-24777), (-24774)⟩, ⟨(-1695), (-1691)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5025399, 5025403⟩, ⟨(-24777), (-24774)⟩, ⟨(-1695), (-1691)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4702190, 4702195⟩, ⟨1320299, 1320305⟩, ⟨87753, 87759⟩, ⟨(-919), (-913)⟩, ⟨(-31), (-27)⟩⟩
...
def j16 : Jet := ⟨⟨(-138463387), (-138463381)⟩, ⟨1320299, 1320305⟩, ⟨87753, 87759⟩, ⟨(-919), (-913)⟩, ⟨(-31), (-27)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-129558125), (-129558118)⟩, ⟨(-35781224), (-35781215)⟩, ⟨(-2208969), (-2208959)⟩, ⟨47810, 47821⟩, ⟨1399, 1407⟩⟩
...
def j19 : Jet := ⟨⟨1302097640, 1302097648⟩, ⟨(-35781224), (-35781215)⟩, ⟨(-2208969), (-2208959)⟩, ⟨47810, 47821⟩, ⟨1399, 1407⟩⟩
...
def j22 : Jet := ⟨⟨(-102), (-100)⟩, ⟨(-29), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11733, 11736⟩, ⟨(-29), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10978, 10982⟩, ⟨3108, 3112⟩, ⟨213, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841199), (-841194)⟩, ⟨3108, 3112⟩, ⟨213, 217⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-787098), (-787092)⟩, ⟨(-221977), (-221971)⟩, ⟨(-15035), (-15027)⟩, ⟨113, 119⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35004296, 35004303⟩, ⟨(-221977), (-221971)⟩, ⟨(-15035), (-15027)⟩, ⟨113, 119⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨32752997, 32753004⟩, ⟨9150298, 9150308⟩, ⟨595015, 595028⟩, ⟨(-8154), (-8143)⟩, ⟨(-257), (-249)⟩⟩
...
def j33 : Jet := ⟨⟨(-683074886), (-683074878)⟩, ⟨9150298, 9150308⟩, ⟨595015, 595028⟩, ⟨(-8154), (-8143)⟩, ⟨(-257), (-249)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-639142977), (-639142967)⟩, ⟨(-174050483), (-174050469)⟩, ⟨(-10040762), (-10040743)⟩, ⟨326170, 326186⟩, ⟨8941, 8955⟩⟩
...
def j36 : Jet := ⟨⟨3655824319, 3655824329⟩, ⟨(-174050483), (-174050469)⟩, ⟨(-10040762), (-10040743)⟩, ⟨326170, 326186⟩, ⟨8941, 8955⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1259529670, 1259529680⟩, ⟨145321339, 145321352⟩, ⟨(-7081250), (-7081238)⟩, ⟨(-259004), (-258991)⟩, ⟨7959, 7971⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5045850788, 5045850803⟩, ⟨240228362, 240228385⟩, ⟨25295511, 25295542⟩, ⟨1413874, 1413903⟩, ⟨102991, 103018⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1479731588, 1479731605⟩, ⟨241176350, 241176375⟩, ⟨7227021, 7227048⟩, ⟨570149, 570179⟩, ⟨31197, 31225⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1322436537), (-1322436536)⟩, ⟨(-188919506), (-188919505)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2972530759, 2972530760⟩, ⟨(-188919506), (-188919505)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨509807274, 509807287⟩, ⟨166183460, 166183480⟩, ⟨18522638, 18522664⟩, ⟨1204502, 1204530⟩, ⟨97686, 97713⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4804774570, 4804774583⟩, ⟨166183460, 166183480⟩, ⟨18522638, 18522664⟩, ⟨1204502, 1204530⟩, ⟨97686, 97713⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4542724913, 4542724920⟩, ⟨78559954, 78559965⟩, ⟨8076920, 8076934⟩, ⟨429725, 429740⟩, ⟨31566, 31581⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3144002876, 3144002883⟩, ⟨(-145446386), (-145446375)⟩, ⟨2134447, 2134459⟩, ⟨(-57864), (-57851)⟩, ⟨2943, 2957⟩⟩
...
def j47 : Jet := ⟨⟨7847410923, 7847410931⟩, ⟨1121058702, 1121058709⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14338143680, 14338143711⟩, ⟨4096612474, 4096612506⟩, ⟨292615176, 292615181⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14338143680, 14338143711⟩, ⟨4096612474, 4096612506⟩, ⟨292615176, 292615181⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14338143711), (-14338143680)⟩, ⟨(-4096612506), (-4096612474)⟩, ⟨(-292615181), (-292615176)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7169071856), (-7169071840)⟩, ⟨(-2048306253), (-2048306237)⟩, ⟨(-146307591), (-146307588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨809178550, 809178563⟩, ⟨(-385904106), (-385904095)⟩, ⟨64455884, 64455890⟩, ⟨(-1482667), (-1482664)⟩, ⟨(-921068), (-921067)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨592335054, 592335066⟩, ⟨(-309891934), (-309891921)⟩, ⟨60653542, 60653553⟩, ⟨(-3470786), (-3470777)⟩, ⟨(-586249), (-586238)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1133517031, 1511356042⟩, ⟨188919505, 188919506⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3561048777, 4748065039⟩, ⟨593508129, 593508133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2952541315, 5248962347⟩, ⟨984180436, 1312240594⟩, ⟨82015036, 82015038⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨739, 1316⟩, ⟨246, 329⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93948), (-93370)⟩, ⟨246, 329⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-114816), (-64186)⟩, ⟨(-28535), (-20992)⟩, ⟨(-1725), (-1655)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4998240, 5048871⟩, ⟨(-28535), (-20992)⟩, ⟨(-1725), (-1655)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3436000, 6170323⟩, ⟨1110459, 1528151⟩, ⟨84616, 90465⟩, ⟨(-1068), (-761)⟩, ⟨(-32), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139729577), (-136995253)⟩, ⟨1110459, 1528151⟩, ⟨84616, 90465⟩, ⟨(-1068), (-761)⟩, ⟨(-32), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-170766211), (-94176303)⟩, ⟨(-41928177), (-29524518)⟩, ⟨(-2355597), (-2038552)⟩, ⟨39287, 56298⟩, ⟨1248, 1538⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1260889554, 1337479463⟩, ⟨(-41928177), (-29524518)⟩, ⟨(-2355597), (-2038552)⟩, ⟨39287, 56298⟩, ⟨1248, 1538⟩⟩
...
def j70 : Jet := ⟨⟨(-132), (-73)⟩, ⟨(-33), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11703, 11763⟩, ⟨(-33), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8045, 14376⟩, ⟨2640, 3578⟩, ⟨208, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844132), (-837800)⟩, ⟨2640, 3578⟩, ⟨208, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1031630), (-575938)⟩, ⟨(-256094), (-187606)⟩, ⟨(-15374), (-14636)⟩, ⟨94, 136⟩, ⟨0, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34759764, 35215457⟩, ⟨(-256094), (-187606)⟩, ⟨(-15374), (-14636)⟩, ⟨94, 136⟩, ⟨0, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨23895324, 43037490⟩, ⟨7652130, 10630405⟩, ⟨566725, 619411⟩, ⟨(-9525), (-6768)⟩, ⟨(-273), (-230)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-691932559), (-672790392)⟩, ⟨7652130, 10630405⟩, ⟨566725, 619411⟩, ⟨(-9525), (-6768)⟩, ⟨(-273), (-230)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-845624123), (-462504436)⟩, ⟨(-206145636), (-141176522)⟩, ⟨(-11069823), (-8842444)⟩, ⟨264344, 387592⟩, ⟨7576, 10121⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3449343173, 3832462860⟩, ⟨(-206145636), (-141176522)⟩, ⟨(-11069823), (-8842444)⟩, ⟨264344, 387592⟩, ⟨7576, 10121⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1045430359, 1478576912⟩, ⟨127887001, 160342709⟩, ⟨(-8398025), (-5770107)⟩, ⟨(-292940), (-219463)⟩, ⟨6462, 9481⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4813287107, 5347900499⟩, ⟨177307166, 319610517⟩, ⟨17636915, 36263898⟩, ⟨517927, 2824109⟩, ⟨13322, 261002⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1171593663, 1841057606⟩, ⟨186478520, 309680027⟩, ⟨(-884374), 17949614⟩, ⟨(-338473), 1841902⟩, ⟨(-66804), 174338⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1511356042), (-1133517031)⟩, ⟨(-188919506), (-188919505)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2783611254, 3161450265⟩, ⟨(-188919506), (-188919505)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨319590724, 789177863⟩, ⟨101736304, 265491554⟩, ⟨7338324, 37717231⟩, ⟨(-417712), 4167524⟩, ⟨(-109778), 490092⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4614558020, 5084145159⟩, ⟨101736304, 265491554⟩, ⟨7338324, 37717231⟩, ⟨(-417712), 4167524⟩, ⟨(-109778), 490092⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4451895751, 4672925977⟩, ⟨46753800, 128066515⟩, ⟨1617490, 17948350⟩, ⟨(-717810), 1993324⟩, ⟨(-146477), 256764⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2885318154, 3439659036⟩, ⟨(-175242887), (-101554678)⟩, ⟨(-4584855), 11154943⟩, ⟨(-1317849), 1396104⟩, ⟨(-195499), 220574⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6726352220, 8968469634⟩, ⟨1121058702, 1121058709⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10534146378, 18727371371⟩, ⟨3511382122, 4681842864⟩, ⟨292615176, 292615181⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10534146378, 18727371371⟩, ⟨3511382122, 4681842864⟩, ⟨292615176, 292615181⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18727371371), (-10534146378)⟩, ⟨(-4681842864), (-3511382122)⟩, ⟨(-292615181), (-292615176)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9363685686), (-5267073189)⟩, ⟨(-2340921432), (-1755691061)⟩, ⟨(-146307591), (-146307588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨485435411, 1259995195⟩, ⟨(-686745569), (-198435646)⟩, ⟨(-2363468), 170614996⟩, ⟨(-26490774), 16025336⟩, ⟨(-5089596), 3649877⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨326110889, 1009077267⟩, ⟨(-601395918), (-144785318)⟩, ⟨1454176, 167931400⟩, ⟨(-30347006), 14073121⟩, ⟨(-5192624), 4722461⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1322436536, 1322436537⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4542724913, 4542724920⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified870
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1133517031, 1511356042⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4451895751, 4672925977⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified871
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (53970901 / 4294967296)

theorem envelope_integral : (∫ s in ((105567 / 400000) : ℝ)..(35189 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((105567 / 400000) : ℝ)..(35189 / 100000), prawitzNormalCorrection
