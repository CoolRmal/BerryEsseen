...
namespace FiniteNormalPanel53_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8277 / 40000)
def radius : Rat := (8277 / 200000)

def j0 : Jet := ⟨⟨888736107, 888736108⟩, ⟨177747221, 177747222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2792046824, 2792046828⟩, ⟨558409363, 558409367⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1815037212, 1815037218⟩, ⟨726014882, 726014890⟩, ⟨72601488, 72601490⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨454, 455⟩, ⟨181, 182⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94233), (-94231)⟩, ⟨181, 182⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-39823), (-39821)⟩, ⟨(-15854), (-15851)⟩, ⟨(-1556), (-1552)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5073233, 5073236⟩, ⟨(-15854), (-15851)⟩, ⟨(-1556), (-1552)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2143929, 2143931⟩, ⟨850871, 850875⟩, ⟨82419, 82424⟩, ⟨(-530), (-525)⟩, ⟨(-26), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-141021648), (-141021645)⟩, ⟨850871, 850875⟩, ⟨82419, 82424⟩, ⟨(-530), (-525)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-59595225), (-59595222)⟩, ⟨(-23478516), (-23478512)⟩, ⟨(-2205152), (-2205144)⟩, ⟨28089, 28096⟩, ⟨1292, 1297⟩⟩
...
def j19 : Jet := ⟨⟨1372060540, 1372060544⟩, ⟨(-23478516), (-23478512)⟩, ⟨(-2205152), (-2205144)⟩, ⟨28089, 28096⟩, ⟨1292, 1297⟩⟩
...
def j22 : Jet := ⟨⟨(-46), (-45)⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11789, 11791⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4981, 4983⟩, ⟨1983, 1987⟩, ⟨194, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847196), (-847193)⟩, ⟨1983, 1987⟩, ⟨194, 197⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-358022), (-358020)⟩, ⟨(-142371), (-142368)⟩, ⟨(-13905), (-13900)⟩, ⟨64, 68⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35433372, 35433375⟩, ⟨(-142371), (-142368)⟩, ⟨(-13905), (-13900)⟩, ⟨64, 68⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨14974011, 14974013⟩, ⟨5929438, 5929442⟩, ⟨569016, 569022⟩, ⟨(-4731), (-4726)⟩, ⟨(-226), (-220)⟩⟩
...
def j33 : Jet := ⟨⟨(-700853872), (-700853869)⟩, ⟨5929438, 5929442⟩, ⟨569016, 569022⟩, ⟨(-4731), (-4726)⟩, ⟨(-226), (-220)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-296178242), (-296178239)⟩, ⟨(-115965540), (-115965534)⟩, ⟨(-10604363), (-10604357)⟩, ⟨194415, 194421⟩, ⟨8722, 8729⟩⟩
...
def j36 : Jet := ⟨⟨3998789054, 3998789057⟩, ⟨(-115965540), (-115965534)⟩, ⟨(-10604363), (-10604357)⟩, ⟨194415, 194421⟩, ⟨8722, 8729⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨891940964, 891940969⟩, ⟨163125417, 163125424⟩, ⟨(-4486068), (-4486060)⟩, ⟨(-268444), (-268436)⟩, ⟨4490, 4497⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4613082563, 4613082567⟩, ⟨133780145, 133780154⟩, ⟨16113042, 16113052⟩, ⟨597761, 597772⟩, ⟨43488, 43502⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨958004339, 958004346⟩, ⟨202989905, 202989917⟩, ⟨3608925, 3608940⟩, ⟨308059, 308075⟩, ⟨11364, 11380⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-888736108), (-888736107)⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3406231188, 3406231189⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨213685518, 213685522⟩, ⟨90554918, 90554926⟩, ⟨11203723, 11203735⟩, ⟨478556, 478568⟩, ⟨37218, 37233⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4508652814, 4508652818⟩, ⟨90554918, 90554926⟩, ⟨11203723, 11203735⟩, ⟨478556, 478568⟩, ⟨37218, 37233⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4400513195, 4400513198⟩, ⟨44191483, 44191488⟩, ⟨5245607, 5245615⟩, ⟨180860, 180868⟩, ⟨13219, 13229⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3489937001, 3489937006⟩, ⟨(-147068080), (-147068073)⟩, ⟨2331294, 2331303⟩, ⟨(-73655), (-73647)⟩, ⟨2997, 3008⟩⟩
...
def j47 : Jet := ⟨⟨6485308140, 6485308150⟩, ⟨1297061625, 1297061633⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9792675653, 9792675684⟩, ⟨3917070252, 3917070284⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9792675653, 9792675684⟩, ⟨3917070252, 3917070284⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9792675684), (-9792675653)⟩, ⟨(-3917070284), (-3917070252)⟩, ⟨(-391707030), (-391707024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4896337842), (-4896337826)⟩, ⟨(-1958535142), (-1958535126)⟩, ⟨(-195853515), (-195853512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1373588209, 1373588229⟩, ⟨(-626365845), (-626365830)⟩, ⟨80177014, 80177022⟩, ⟨6854718, 6854721⟩, ⟨(-2609515), (-2609513)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1116128711, 1116128730⟩, ⟨(-555996860), (-555996842)⟩, ⟨87342545, 87342560⟩, ⟨2460932, 2460943⟩, ⟨(-2299902), (-2299891)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨710988886, 1066483330⟩, ⟨177747221, 177747222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2233637460, 3350456195⟩, ⟨558409363, 558409367⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1161623816, 2613653596⟩, ⟨580811906, 871217868⟩, ⟨72601488, 72601490⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨290, 655⟩, ⟨145, 219⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94397), (-94031)⟩, ⟨145, 219⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-57445), (-25431)⟩, ⟨(-19110), (-12581)⟩, ⟨(-1573), (-1532)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5055611, 5087626⟩, ⟨(-19110), (-12581)⟩, ⟨(-1573), (-1532)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1367348, 3096018⟩, ⟨672044, 1028604⟩, ⟨80624, 83886⟩, ⟨(-643), (-414)⟩, ⟨(-27), (-22)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141798229), (-140069558)⟩, ⟨672044, 1028604⟩, ⟨80624, 83886⟩, ⟨(-643), (-414)⟩, ⟨(-27), (-22)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-86289703), (-37883439)⟩, ⟨(-28581473), (-18315773)⟩, ⟨(-2284251), (-2108017)⟩, ⟨21870, 34293⟩, ⟨1214, 1358⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1345366062, 1393772327⟩, ⟨(-28581473), (-18315773)⟩, ⟨(-2284251), (-2108017)⟩, ⟨21870, 34293⟩, ⟨1214, 1358⟩⟩
...
def j72 : Jet := ⟨⟨3183, 7186⟩, ⟨1577, 2393⟩, ⟨191, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848994), (-844990)⟩, ⟨1577, 2393⟩, ⟨191, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-516646), (-228537)⟩, ⟨(-171790), (-112811)⟩, ⟨(-14088), (-13675)⟩, ⟨49, 82⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35274748, 35562858⟩, ⟨(-171790), (-112811)⟩, ⟨(-14088), (-13675)⟩, ⟨49, 82⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9540465, 21641374⟩, ⟨4665691, 7183281⟩, ⟨552858, 582197⟩, ⟨(-5749), (-3705)⟩, ⟨(-233), (-211)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706287418), (-694186508)⟩, ⟨4665691, 7183281⟩, ⟨552858, 582197⟩, ⟨(-5749), (-3705)⟩, ⟨(-233), (-211)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-429803192), (-187750808)⟩, ⟨(-142005841), (-89504098)⟩, ⟨(-11158507), (-9923033)⟩, ⟨150132, 238521⟩, ⟨8036, 9284⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3865164104, 4107216488⟩, ⟨(-142005841), (-89504098)⟩, ⟨(-11158507), (-9923033)⟩, ⟨150132, 238521⟩, ⟨8036, 9284⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨699670061, 1087266283⟩, ⟨152621424, 171685761⟩, ⟨(-5497934), (-3477614)⟩, ⟨(-285614), (-247321)⟩, ⟨3474, 5519⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4491300647, 4772564264⟩, ⟨97874024, 175343657⟩, ⟨12983840, 20220234⟩, ⟨242244, 1074647⟩, ⟨15675, 84721⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨731653673, 1208169435⟩, ⟨175542249, 235165138⟩, ⟨(-516226), 8491283⟩, ⟨(-40989), 742450⟩, ⟨(-22752), 54392⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1066483330), (-710988886)⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3228483966, 3583978410⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨124638224, 339856694⟩, ⟨59807734, 132303374⟩, ⟨6884267, 17653328⟩, ⟨(-79594), 1347560⟩, ⟨(-18313), 128694⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4419605520, 4634823990⟩, ⟨59807734, 132303374⟩, ⟨6884267, 17653328⟩, ⟨(-79594), 1347560⟩, ⟨(-18313), 128694⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4356840732, 4461660841⟩, ⟨28786619, 65212238⟩, ⟨2836955, 8606214⟩, ⟨(-168049), 645468⟩, ⟨(-27189), 65026⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3274993609, 3723077506⟩, ⟨(-163007222), (-125890848)⟩, ⟨(-566299), 5990208⟩, ⟨(-496400), 421211⟩, ⟨(-49402), 61217⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5188246515, 7782369783⟩, ⟨1297061625, 1297061633⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6267312425, 14101452995⟩, ⟨3133656202, 4700484342⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6267312425, 14101452995⟩, ⟨3133656202, 4700484342⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14101452995), (-6267312425)⟩, ⟨(-4700484342), (-3133656202)⟩, ⟨(-391707030), (-391707024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7050726498), (-3133656212)⟩, ⟨(-2350242171), (-1566828101)⟩, ⟨(-195853515), (-195853512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨831785028, 2070588259⟩, ⟨(-1133043283), (-303439832)⟩, ⟨(-39072000), 272075422⟩, ⟨(-40402607), 41571887⟩, ⟨(-11890537), 6418017⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨634251779, 1794882252⟩, ⟨(-1060759836), (-255759253)⟩, ⟨(-25248240), 281737974⟩, ⟨(-47168533), 37871809⟩, ⟨(-12074483), 7636772⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨888736107, 888736108⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4400513195, 4400513198⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1046
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨710988886, 1066483330⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4356840732, 4461660841⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1047
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (2966193 / 134217728)

theorem envelope_integral : (∫ s in ((8277 / 50000) : ℝ)..(24831 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((8277 / 50000) : ℝ)..(24831 / 100000), prawitzNormalCorrection
