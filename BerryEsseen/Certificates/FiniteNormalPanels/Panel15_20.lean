...
namespace FiniteNormalPanel15_20
...
def j2 : Jet := ⟨⟨659944472, 659944476⟩, ⟨659944472, 659944476⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨101403963, 101403965⟩, ⟨202807926, 202807930⟩, ⟨101403963, 101403965⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨25, 26⟩, ⟨50, 51⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94662), (-94660)⟩, ⟨50, 51⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2235), (-2234)⟩, ⟨(-4469), (-4467)⟩, ⟨(-2233), (-2230)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110821, 5110823⟩, ⟨(-4469), (-4467)⟩, ⟨(-2233), (-2230)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨120666, 120667⟩, ⟨241226, 241228⟩, ⟨120401, 120405⟩, ⟨(-212), (-209)⟩, ⟨(-53), (-50)⟩⟩
...
def j16 : Jet := ⟨⟨(-143044911), (-143044909)⟩, ⟨241226, 241228⟩, ⟨120401, 120405⟩, ⟨(-212), (-209)⟩, ⟨(-53), (-50)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3377284), (-3377283)⟩, ⟨(-6748872), (-6748870)⟩, ⟨(-3363052), (-3363049)⟩, ⟨11374, 11378⟩, ⟨2829, 2833⟩⟩
...
def j19 : Jet := ⟨⟨1428278481, 1428278483⟩, ⟨(-6748872), (-6748870)⟩, ⟨(-3363052), (-3363049)⟩, ⟨11374, 11378⟩, ⟨2829, 2833⟩⟩
...
def j25 : Jet := ⟨⟨279, 280⟩, ⟨557, 559⟩, ⟨277, 280⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851898), (-851896)⟩, ⟨557, 559⟩, ⟨277, 280⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-20114), (-20113)⟩, ⟨(-40214), (-40212)⟩, ⟨(-20082), (-20079)⟩, ⟨25, 28⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35771280, 35771282⟩, ⟨(-40214), (-40212)⟩, ⟨(-20082), (-20079)⟩, ⟨25, 28⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨844558, 844559⟩, ⟨1688166, 1688168⟩, ⟨842184, 842187⟩, ⟨(-1899), (-1896)⟩, ⟨(-474), (-471)⟩⟩
...
def j33 : Jet := ⟨⟨(-714983325), (-714983323)⟩, ⟨1688166, 1688168⟩, ⟨842184, 842187⟩, ⟨(-1899), (-1896)⟩, ⟨(-474), (-471)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-16880721), (-16880720)⟩, ⟨(-33721585), (-33721582)⟩, ⟨(-16781123), (-16781120)⟩, ⟨79579, 79582⟩, ⟨19781, 19784⟩⟩
...
def j36 : Jet := ⟨⟨4278086575, 4278086576⟩, ⟨(-33721585), (-33721582)⟩, ⟨(-16781123), (-16781120)⟩, ⟨79579, 79582⟩, ⟨19781, 19784⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨219462553, 219462555⟩, ⟨218425553, 218425556⟩, ⟨(-1553751), (-1553749)⟩, ⟨(-515004), (-515001)⟩, ⟨2181, 2185⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4311914624, 4311914626⟩, ⟨33988227, 33988232⟩, ⟨17181720, 17181726⟩, ⟨188541, 188548⟩, ⟨48307, 48315⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨220328520, 220328524⟩, ⟨221024146, 221024151⟩, ⟨1046572, 1046579⟩, ⟨354096, 354104⟩, ⟨3953, 3962⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-210066851), (-210066850)⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4084900445, 4084900446⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨11302683, 11302685⟩, ⟨22676736, 22676740⟩, ⟨11481542, 11481546⟩, ⟨144042, 144050⟩, ⟨37103, 37110⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4306269979, 4306269981⟩, ⟨22676736, 22676740⟩, ⟨11481542, 11481546⟩, ⟨144042, 144050⟩, ⟨37103, 37110⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4300614924, 4300614926⟩, ⟨11323478, 11323481⟩, ⟨5718324, 5718328⟩, ⟨56869, 56875⟩, ⟨14575, 14581⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4090271847, 4090271851⟩, ⟨(-199573431), (-199573425)⟩, ⟨4884808, 4884814⟩, ⟨(-225597), (-225589)⟩, ⟨11080, 11087⟩⟩
...
def j47 : Jet := ⟨⟨1006839554, 1006839560⟩, ⟨1006839554, 1006839560⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨236026450, 236026454⟩, ⟨472052900, 472052908⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨236026450, 236026454⟩, ⟨472052900, 472052908⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-236026454), (-236026450)⟩, ⟨(-472052908), (-472052900)⟩, ⟨(-236026454), (-236026450)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-118013227), (-118013225)⟩, ⟨(-236026454), (-236026450)⟩, ⟨(-118013227), (-118013225)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4178560650, 4178560653⟩, ⟨(-229629422), (-229629417)⟩, ⟨(-108505162), (-108505158)⟩, ⟨6193970, 6193972⟩, ⟨1405607, 1405608⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3979413068, 3979413076⟩, ⟨(-412849814), (-412849801)⟩, ⟨(-87911315), (-87911302)⟩, ⟨10460008, 10460022⟩, ⟨950234, 950247⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 420133701⟩, ⟨210066850, 210066851⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1319888949⟩, ⟨659944472, 659944476⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 405615857⟩, ⟨0, 405615858⟩, ⟨101403963, 101403965⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 102⟩, ⟨0, 102⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94584)⟩, ⟨0, 102⟩, ⟨25, 26⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-8943), 0⟩, ⟨(-8943), 10⟩, ⟨(-2236), (-2220)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5104113, 5113057⟩, ⟨(-8943), 10⟩, ⟨(-2236), (-2220)⟩, ⟨0, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 482877⟩, ⟨(-845), 482878⟩, ⟨119450, 120721⟩, ⟨(-424), 2⟩, ⟨(-53), (-50)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142682699)⟩, ⟨(-845), 482878⟩, ⟨119450, 120721⟩, ⟨(-424), 2⟩, ⟨(-53), (-50)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-13520529), 0⟩, ⟨(-13520609), 45603⟩, ⟨(-3380213), (-3311727)⟩, ⟨(-61), 22803⟩, ⟨2773, 2852⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1418135236, 1431655766⟩, ⟨(-13520609), 45603⟩, ⟨(-3380213), (-3311727)⟩, ⟨(-61), 22803⟩, ⟨2773, 2852⟩⟩
...
def j72 : Jet := ⟨⟨0, 1118⟩, ⟨(-2), 1118⟩, ⟨276, 280⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851058)⟩, ⟨(-2), 1118⟩, ⟨276, 280⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-80480), 0⟩, ⟨(-80481), 106⟩, ⟨(-20121), (-19960)⟩, ⟨(-2), 54⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35710914, 35791395⟩, ⟨(-80481), 106⟩, ⟨(-20121), (-19960)⟩, ⟨(-2), 54⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3380133⟩, ⟨(-7601), 3380144⟩, ⟨833630, 845045⟩, ⟨(-3803), 9⟩, ⟨(-477), (-464)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712447749)⟩, ⟨(-7601), 3380144⟩, ⟨833630, 845045⟩, ⟨(-3803), 9⟩, ⟨(-477), (-464)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-67602643), 0⟩, ⟨(-67603362), 319221⟩, ⟨(-16901379), (-16421828)⟩, ⟨(-540), 159613⟩, ⟨19275, 19953⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4227364653, 4294967296⟩, ⟨(-67603362), 319221⟩, ⟨(-16901379), (-16421828)⟩, ⟨(-540), 159613⟩, ⟨19275, 19953⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 439962984⟩, ⟨213748962, 219995508⟩, ⟨(-3116290), 7008⟩, ⟨(-519407), (-501856)⟩, ⟨(-10), 4381⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4363651019⟩, ⟨(-329513), 69782834⟩, ⟨16416641, 18562222⟩, ⟨(-167480), 576401⟩, ⟨37265, 63863⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 446998730⟩, ⟨213715207, 230661940⟩, ⟨(-3183004), 5482973⟩, ⟨221508, 508218⟩, ⟨(-30499), 40590⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-420133701), 0⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3874833595, 4294967296⟩, ⟨(-210066851), (-210066850)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 46521394⟩, ⟨0, 48012284⟩, ⟨9971806, 13529021⟩, ⟨(-341888), 694714⟩, ⟨11630, 70038⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4341488690⟩, ⟨0, 48012284⟩, ⟨9971806, 13529021⟩, ⟨(-341888), 694714⟩, ⟨11630, 70038⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4318165345⟩, ⟨0, 24006142⟩, ⟨4892388, 6764511⟩, ⟨(-208754), 347357⟩, ⟨(-1455), 33400⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3874833595, 4318165345⟩, ⟨(-211201468), (-186060708)⟩, ⟨3239673, 6764511⟩, ⟨(-539607), 108071⟩, ⟨(-18445), 43611⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2013679115⟩, ⟨1006839554, 1006839560⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 944105811⟩, ⟨0, 944105814⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 944105811⟩, ⟨0, 944105814⟩, ⟨236026450, 236026454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-944105811), 0⟩, ⟨(-944105814), 0⟩, ⟨(-236026454), (-236026450)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-472052906), 0⟩, ⟨(-472052907), 0⟩, ⟨(-118013227), (-118013225)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3847930837, 4294967296⟩, ⟨(-472052907), 0⟩, ⟨(-118013227), (-79788675)⟩, ⟨0, 12970643⟩, ⟨739784, 1621331⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3471526242, 4318165345⟩, ⟨(-685804036), (-166694804)⟩, ⟨(-115748168), (-42006423)⟩, ⟨2173412, 18951975⟩, ⟨(-186596), 1672824⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4300614924, 4300614926⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified310
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4318165345⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified311
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (96608105 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(4891 / 50000), prawitzNormalCorrection
