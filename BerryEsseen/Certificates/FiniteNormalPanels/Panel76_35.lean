...
namespace FiniteNormalPanel76_35
...
def j2 : Jet := ⟨⟨1318311947, 1318311951⟩, ⟨263662388, 263662393⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨404647176, 404647179⟩, ⟨161858868, 161858874⟩, ⟨16185886, 16185888⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨101, 102⟩, ⟨40, 41⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94586), (-94584)⟩, ⟨40, 41⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8912), (-8911)⟩, ⟨(-3562), (-3560)⟩, ⟨(-356), (-353)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104144, 5104146⟩, ⟨(-3562), (-3560)⟩, ⟨(-356), (-353)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨480883, 480884⟩, ⟨192017, 192019⟩, ⟨19066, 19069⟩, ⟨(-28), (-25)⟩, ⟨(-2), 1⟩⟩
...
def j16 : Jet := ⟨⟨(-142684694), (-142684692)⟩, ⟨192017, 192019⟩, ⟨19066, 19069⟩, ⟨(-28), (-25)⟩, ⟨(-2), 1⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13442934), (-13442933)⟩, ⟨(-5359084), (-5359082)⟩, ⟨(-528686), (-528683)⟩, ⟨1438, 1441⟩, ⟨68, 73⟩⟩
...
def j19 : Jet := ⟨⟨1418212831, 1418212833⟩, ⟨(-5359084), (-5359082)⟩, ⟨(-528686), (-528683)⟩, ⟨1438, 1441⟩, ⟨68, 73⟩⟩
...
def j22 : Jet := ⟨⟨(-11), (-10)⟩, ⟨(-5), (-4)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11824, 11826⟩, ⟨(-5), (-4)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1113, 1115⟩, ⟨444, 446⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851064), (-851061)⟩, ⟨444, 446⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-80183), (-80182)⟩, ⟨(-32032), (-32029)⟩, ⟨(-3189), (-3185)⟩, ⟨1, 4⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35711211, 35711213⟩, ⟨(-32032), (-32029)⟩, ⟨(-3189), (-3185)⟩, ⟨1, 4⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3364505, 3364506⟩, ⟨1342784, 1342786⟩, ⟨133071, 133074⟩, ⟨(-242), (-239)⟩, ⟨(-14), (-10)⟩⟩
...
def j33 : Jet := ⟨⟨(-712463378), (-712463376)⟩, ⟨1342784, 1342786⟩, ⟨133071, 133074⟩, ⟨(-242), (-239)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-67124213), (-67124211)⟩, ⟨(-26723177), (-26723174)⟩, ⟨(-2621829), (-2621826)⟩, ⟨10051, 10054⟩, ⟨489, 493⟩⟩
...
def j36 : Jet := ⟨⟨4227843083, 4227843085⟩, ⟨(-26723177), (-26723174)⟩, ⟨(-2621829), (-2621826)⟩, ⟨10051, 10054⟩, ⟨489, 493⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨435311095, 435311098⟩, ⟨85417282, 85417287⟩, ⟨(-491265), (-491261)⟩, ⟨(-32015), (-32012)⟩, ⟨108, 112⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4363157218, 4363157221⟩, ⟨27578460, 27578466⟩, ⟨2880054, 2880061⟩, ⟨24929, 24936⟩, ⟨1368, 1377⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨442222400, 442222404⟩, ⟨89568606, 89568614⟩, ⟨341312, 341320⟩, ⟨24124, 24132⟩, ⟨206, 216⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-419631727), (-419631726)⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3875335569, 3875335570⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨45532512, 45532514⟩, ⟨18444490, 18444494⟩, ⟨1938176, 1938181⟩, ⟨19200, 19206⟩, ⟨1075, 1082⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4340499808, 4340499810⟩, ⟨18444490, 18444494⟩, ⟨1938176, 1938181⟩, ⟨19200, 19206⟩, ⟨1075, 1082⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317673531, 4317673533⟩, ⟨9173746, 9173749⟩, ⟨954245, 954249⟩, ⟨7521, 7526⟩, ⟨411, 417⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3895823333, 3895823337⟩, ⟨(-76092599), (-76092593)⟩, ⟨681751, 681756⟩, ⟨(-11861), (-11855)⟩, ⟨222, 231⟩⟩
...
def j47 : Jet := ⟨⟨3548017200, 3548017210⟩, ⟨709603438, 709603447⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2930971340, 2930971357⟩, ⟨1172388532, 1172388552⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2930971340, 2930971357⟩, ⟨1172388532, 1172388552⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2930971357), (-2930971340)⟩, ⟨(-1172388552), (-1172388532)⟩, ⟨(-117238856), (-117238852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1465485679), (-1465485670)⟩, ⟨(-586194276), (-586194266)⟩, ⟨(-58619428), (-58619426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3053333566, 3053333579⟩, ⟨(-416731152), (-416731142)⟩, ⟨(-13234552), (-13234548)⟩, ⟨4393909, 4393911⟩, ⟨(-59610), (-59609)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2769578283, 2769578298⟩, ⟨(-432098060), (-432098045)⟩, ⟨(-4136869), (-4136858)⟩, ⟨4145459, 4145470⟩, ⟨(-132711), (-132698)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨335705381, 503558072⟩, ⟨83926345, 83926346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1054649558, 1581974340⟩, ⟨263662388, 263662393⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨258974193, 582691937⟩, ⟨129487094, 194230648⟩, ⟨16185886, 16185888⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨64, 146⟩, ⟨32, 49⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94623), (-94540)⟩, ⟨32, 49⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-12838), (-5700)⟩, ⟨(-4279), (-2843)⟩, ⟨(-357), (-352)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5100218, 5107357⟩, ⟨(-4279), (-2843)⟩, ⟨(-357), (-352)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨307528, 692908⟩, ⟨153183, 230799⟩, ⟨18977, 19142⟩, ⟨(-34), (-19)⟩, ⟨(-2), 1⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142858049), (-142472668)⟩, ⟨153183, 230799⟩, ⟨18977, 19142⟩, ⟨(-34), (-19)⟩, ⟨(-2), 1⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-19381343), (-8590692)⟩, ⟨(-6451212), (-4264033)⟩, ⟨(-532609), (-523883)⟩, ⟨1144, 1735⟩, ⟨68, 74⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1412274422, 1423065074⟩, ⟨(-6451212), (-4264033)⟩, ⟨(-532609), (-523883)⟩, ⟨1144, 1735⟩, ⟨68, 74⟩⟩
...
def j70 : Jet := ⟨⟨(-15), (-6)⟩, ⟨(-5), (-3)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11820, 11830⟩, ⟨(-5), (-3)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨712, 1605⟩, ⟨355, 535⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851465), (-850571)⟩, ⟨355, 535⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-115518), (-51286)⟩, ⟨(-38485), (-25570)⟩, ⟨(-3197), (-3173)⟩, ⟨1, 6⟩, ⟨(-2), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35675876, 35740109⟩, ⟨(-38485), (-25570)⟩, ⟨(-3197), (-3173)⟩, ⟨1, 6⟩, ⟨(-2), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2151152, 4848809⟩, ⟨1070354, 1614729⟩, ⟨132272, 133729⟩, ⟨(-291), (-190)⟩, ⟨(-14), (-9)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713676731), (-710979073)⟩, ⟨1070354, 1614729⟩, ⟨132272, 133729⟩, ⟨(-291), (-190)⟩, ⟨(-14), (-9)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-96823480), (-42869996)⟩, ⟨(-32209955), (-21215929)⟩, ⟨(-2649298), (-2588208)⟩, ⟨7980, 12123⟩, ⟨482, 499⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4198143816, 4252097300⟩, ⟨(-32209955), (-21215929)⟩, ⟨(-2649298), (-2588208)⟩, ⟨7980, 12123⟩, ⟨482, 499⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨346790672, 524160553⟩, ⟨84321478, 86313041⟩, ⟨(-592209), (-390404)⟩, ⟨(-32417), (-31520)⟩, ⟨86, 135⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4338269510, 4394023855⟩, ⟨21645886, 33712832⟩, ⟨2748661, 3031572⟩, ⟨14361, 36291⟩, ⟨1130, 1655⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨350287044, 536249479⟩, ⟨86919378, 92418050⟩, ⟨41033, 653139⟩, ⟨17308, 31549⟩, ⟨(-216), 664⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-503558072), (-335705381)⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3791409224, 3959261915⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨28568555, 66953596⟩, ⟨14177864, 23077770⟩, ⟨1765722, 2151725⟩, ⟨4482, 35990⟩, ⟨646, 1624⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4323535851, 4361920892⟩, ⟨14177864, 23077770⟩, ⟨1765722, 2151725⟩, ⟨4482, 35990⟩, ⟨646, 1624⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4309227898, 4328314635⟩, ⟨7034315, 11500700⟩, ⟨860779, 1066562⟩, ⟨(-613), 16532⟩, ⟨144, 726⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3803997859, 3990002743⟩, ⟨(-78368389), (-73603229)⟩, ⟨535127, 845743⟩, ⟨(-21408), (-1580)⟩, ⟨(-197), 682⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2838413761, 4257620648⟩, ⟨709603438, 709603447⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1875821659, 4220598746⟩, ⟨937910826, 1406866260⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1875821659, 4220598746⟩, ⟨937910826, 1406866260⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4220598746), (-1875821659)⟩, ⟨(-1406866260), (-937910826)⟩, ⟨(-117238856), (-117238852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2110299373), (-937910829)⟩, ⟨(-703433130), (-468955413)⟩, ⟨(-58619428), (-58619426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2627680659, 3452399717⟩, ⟨(-565436748), (-286909069)⟩, ⟨(-31456332), 10440206⟩, ⟨2040597, 6862186⟩, ⟨(-352220), 158963⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2327303309, 3207261754⟩, ⟨(-588282288), (-299142502)⟩, ⟨(-23978595), 20696005⟩, ⟨1488280, 6912193⟩, ⟨(-458672), 118131⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317673531, 4317673533⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1534
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4309227898, 4328314635⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1535
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (108185615 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((6253 / 80000) : ℝ)..(18759 / 160000), prawitzNormalCorrection
