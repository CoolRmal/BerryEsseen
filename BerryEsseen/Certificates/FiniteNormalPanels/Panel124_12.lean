...
namespace FiniteNormalPanel124_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (97013 / 400000)
def radius : Rat := (13859 / 400000)

def j0 : Jet := ⟨⟨1041669155, 1041669156⟩, ⟨148809879, 148809880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3272500164, 3272500169⟩, ⟨467500022, 467500026⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2493443275, 2493443284⟩, ⟨712412362, 712412370⟩, ⟨50886597, 50886599⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨624, 625⟩, ⟨178, 179⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94063), (-94061)⟩, ⟨178, 179⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-54609), (-54607)⟩, ⟨(-15500), (-15498)⟩, ⟨(-1080), (-1076)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5058447, 5058450⟩, ⟨(-15500), (-15498)⟩, ⟨(-1080), (-1076)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2936681, 2936684⟩, ⟨830052, 830056⟩, ⟨56733, 56739⟩, ⟨(-363), (-357)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140228896), (-140228892)⟩, ⟨830052, 830056⟩, ⟨56733, 56739⟩, ⟨(-363), (-357)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-81409887), (-81409883)⟩, ⟨(-22778082), (-22778076)⟩, ⟨(-1490810), (-1490803)⟩, ⟨19033, 19040⟩, ⟨603, 609⟩⟩
...
def j19 : Jet := ⟨⟨1350245878, 1350245883⟩, ⟨(-22778082), (-22778076)⟩, ⟨(-1490810), (-1490803)⟩, ⟨19033, 19040⟩, ⟨603, 609⟩⟩
...
def j22 : Jet := ⟨⟨(-63), (-62)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11772, 11774⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨6834, 6836⟩, ⟨1941, 1944⟩, ⟨134, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845343), (-845340)⟩, ⟨1941, 1944⟩, ⟨134, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-490764), (-490762)⟩, ⟨(-139093), (-139088)⟩, ⟨(-9618), (-9611)⟩, ⟨42, 47⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35300630, 35300633⟩, ⟨(-139093), (-139088)⟩, ⟨(-9618), (-9611)⟩, ⟨42, 47⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20493780, 20493783⟩, ⟨5774614, 5774620⟩, ⟨389584, 389592⟩, ⟨(-3220), (-3213)⟩, ⟨(-109), (-103)⟩⟩
...
def j33 : Jet := ⟨⟨(-695334103), (-695334099)⟩, ⟨5774614, 5774620⟩, ⟨389584, 389592⟩, ⟨(-3220), (-3213)⟩, ⟨(-109), (-103)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-403676217), (-403676213)⟩, ⟨(-111983611), (-111983604)⟩, ⟨(-7054276), (-7054266)⟩, ⟨131167, 131176⟩, ⟨4016, 4025⟩⟩
...
def j36 : Jet := ⟨⟨3891291079, 3891291083⟩, ⟨(-111983611), (-111983604)⟩, ⟨(-7054276), (-7054266)⟩, ⟨131167, 131176⟩, ⟨4016, 4025⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1028804075, 1028804081⟩, ⟨129616516, 129616525⟩, ⟨(-3615263), (-3615254)⟩, ⟨(-147772), (-147763)⟩, ⟨2530, 2538⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4740520223, 4740520229⟩, ⟨136422726, 136422736⟩, ⟨12519751, 12519767⟩, ⟨447801, 447815⟩, ⟨26079, 26095⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1135530537, 1135530546⟩, ⟨175741028, 175741042⟩, ⟨3125700, 3125716⟩, ⟨207157, 207177⟩, ⟨7319, 7337⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1041669156), (-1041669155)⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3253298140, 3253298141⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨300218723, 300218729⟩, ⟨92927042, 92927052⟩, ⟨8843737, 8843749⟩, ⟨365332, 365346⟩, ⟨23096, 23111⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4595186019, 4595186025⟩, ⟨92927042, 92927052⟩, ⟨8843737, 8843749⟩, ⟨365332, 365346⟩, ⟨23096, 23111⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4442541352, 4442541356⟩, ⟨44920077, 44920083⟩, ⟨4047879, 4047887⟩, ⟨135668, 135677⟩, ⟨7946, 7957⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3365080691, 3365080696⟩, ⟨(-119897455), (-119897448)⟩, ⟨1509767, 1509775⟩, ⟨(-37486), (-37477)⟩, ⟨1317, 1328⟩⟩
...
def j47 : Jet := ⟨⟨9863084190, 9863084202⟩, ⟨1409012024, 1409012035⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨22649865071, 22649865127⟩, ⟨6471390004, 6471390066⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨22649865071, 22649865127⟩, ⟨6471390004, 6471390066⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-22649865127), (-22649865071)⟩, ⟨(-6471390066), (-6471390004)⟩, ⟨(-462242150), (-462242142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11324932564), (-11324932535)⟩, ⟨(-3235695033), (-3235695002)⟩, ⟨(-231121075), (-231121071)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨307479331, 307479341⟩, ⟨(-231645391), (-231645380)⟩, ⟨70711118, 70711125⟩, ⟨(-9446978), (-9446974)⟩, ⟨(-123292), (-123290)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨240908181, 240908190⟩, ⟨(-190076285), (-190076273)⟩, ⟨61976380, 61976389⟩, ⟨(-9459721), (-9459713)⟩, ⟨194091, 194099⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨892859276, 1190479036⟩, ⟨148809879, 148809880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2805000142, 3740000194⟩, ⟨467500022, 467500026⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1831917510, 3256742250⟩, ⟨610639166, 814185566⟩, ⟨50886597, 50886599⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨458, 816⟩, ⟨152, 204⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94229), (-93870)⟩, ⟨152, 204⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-71451), (-40038)⟩, ⟨(-17799), (-13191)⟩, ⟨(-1091), (-1063)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5041605, 5073019⟩, ⟨(-17799), (-13191)⟩, ⟨(-1091), (-1063)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2150378, 3846716⟩, ⟨703295, 956053⟩, ⟨55529, 57777⟩, ⟨(-418), (-302)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141015199), (-139318860)⟩, ⟨703295, 956053⟩, ⟨55529, 57777⟩, ⟨(-418), (-302)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-106927510), (-59423190)⟩, ⟨(-26431905), (-19082783)⟩, ⟨(-1547068), (-1425596)⟩, ⟨15909, 22153⟩, ⟨567, 640⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1324728255, 1372232576⟩, ⟨(-26431905), (-19082783)⟩, ⟨(-1547068), (-1425596)⟩, ⟨15909, 22153⟩, ⟨567, 640⟩⟩
...
def j72 : Jet := ⟨⟨5012, 8941⟩, ⟨1654, 2230⟩, ⟨133, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847165), (-843235)⟩, ⟨1654, 2230⟩, ⟨133, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-642380), (-359662)⟩, ⟨(-159890), (-118196)⟩, ⟨(-9747), (-9462)⟩, ⟨35, 54⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35149014, 35431733⟩, ⟨(-159890), (-118196)⟩, ⟨(-9747), (-9462)⟩, ⟨35, 54⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14991987, 26866799⟩, ⟨4876088, 6666287⟩, ⟨378743, 398955⟩, ⟨(-3729), (-2704)⟩, ⟨(-113), (-99)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700835896), (-688961083)⟩, ⟨4876088, 6666287⟩, ⟨378743, 398955⟩, ⟨(-3729), (-2704)⟩, ⟨(-113), (-99)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-531422411), (-293860182)⟩, ⟨(-130775824), (-92898551)⟩, ⟨(-7448673), (-6596555)⟩, ⟨108790, 153458⟩, ⟨3694, 4301⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3763544885, 4001107114⟩, ⟨(-130775824), (-92898551)⟩, ⟨(-7448673), (-6596555)⟩, ⟨108790, 153458⟩, ⟨3694, 4301⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨865166760, 1194921812⟩, ⟨121177908, 136902453⟩, ⟨(-4224236), (-3008171)⟩, ⟨(-158006), (-135882)⟩, ⟨2101, 2970⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4610409956, 4901427946⟩, ⟨107045472, 170315036⟩, ⟨10086505, 15618847⟩, ⟨222685, 746538⟩, ⟨9995, 49237⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨928708688, 1363647907⟩, ⟨151640739, 203617538⟩, ⟨231261, 6545091⟩, ⟨(-18392), 484716⟩, ⟨(-11078), 30435⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1190479036), (-892859276)⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3104488260, 3402108020⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨200816389, 432956874⟩, ⟨65579112, 129296738⟩, ⟨5453930, 13809303⟩, ⟨4650, 928380⟩, ⟨(-8768), 75263⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4495783685, 4727924170⟩, ⟨65579112, 129296738⟩, ⟨5453930, 13809303⟩, ⟨4650, 928380⟩, ⟨(-8768), 75263⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4394228475, 4506248960⟩, ⟨31252172, 63188028⟩, ⟨2156085, 6637549⟩, ⟨(-93175), 438371⟩, ⟨(-15603), 37593⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3176236225, 3569467396⟩, ⟨(-133540568), (-102196845)⟩, ⟨(-630847), 4174894⟩, ⟨(-303781), 272539⟩, ⟨(-27549), 33007⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8454072165, 11272096236⟩, ⟨1409012024, 1409012035⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨16640717203, 29583497335⟩, ⟨5546905720, 7395874364⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨16640717203, 29583497335⟩, ⟨5546905720, 7395874364⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-29583497335), (-16640717203)⟩, ⟨(-7395874364), (-5546905720)⟩, ⟨(-462242150), (-462242142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-14791748668), (-8320358601)⟩, ⟨(-3697937182), (-2773452860)⟩, ⟨(-231121075), (-231121071)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨137170798, 618913041⟩, ⟨(-532879855), (-88577331)⟩, ⟨(-4705816), 222021494⟩, ⟨(-60541972), 20467471⟩, ⟨(-10379306), 13158170⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨101441251, 514367112⟩, ⟨(-462109985), (-68769079)⟩, ⟨(-1894166), 201688024⟩, ⟨(-57780233), 17273994⟩, ⟨(-9332827), 13076166⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1041669155, 1041669156⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4442541352, 4442541356⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2500
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨892859276, 1190479036⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4394228475, 4506248960⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2501
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (18306507 / 4294967296)

theorem envelope_integral : (∫ s in ((41577 / 200000) : ℝ)..(13859 / 50000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (13859 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((41577 / 200000) : ℝ)..(13859 / 50000), prawitzNormalCorrection
