...
namespace FiniteNormalPanel151_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (197463 / 800000)
def radius : Rat := (28209 / 800000)

def j0 : Jet := ⟨⟨1060121408, 1060121409⟩, ⟨151445915, 151445916⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3330469627, 3330469631⟩, ⟨475781373, 475781378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2582564003, 2582564011⟩, ⟨737875426, 737875436⟩, ⟨52705387, 52705389⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨646, 647⟩, ⟨184, 185⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94041), (-94039)⟩, ⟨184, 185⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-56547), (-56545)⟩, ⟨(-16047), (-16043)⟩, ⟨(-1117), (-1112)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5056509, 5056512⟩, ⟨(-16047), (-16043)⟩, ⟨(-1117), (-1112)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3040479, 3040481⟩, ⟨859058, 859063⟩, ⟨58621, 58627⟩, ⟨(-387), (-383)⟩, ⟨(-14), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140125098), (-140125095)⟩, ⟨859058, 859063⟩, ⟨58621, 58627⟩, ⟨(-387), (-383)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-84257228), (-84257225)⟩, ⟨(-23556943), (-23556937)⟩, ⟨(-1536702), (-1536694)⟩, ⟨20379, 20385⟩, ⟨643, 649⟩⟩
...
def j19 : Jet := ⟨⟨1347398537, 1347398541⟩, ⟨(-23556943), (-23556937)⟩, ⟨(-1536702), (-1536694)⟩, ⟨20379, 20385⟩, ⟨643, 649⟩⟩
...
def j22 : Jet := ⟨⟨(-65), (-64)⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11770, 11772⟩, ⟨(-19), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7077, 7079⟩, ⟨2010, 2013⟩, ⟨138, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845100), (-845097)⟩, ⟨2010, 2013⟩, ⟨138, 142⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-508159), (-508156)⟩, ⟨(-143981), (-143976)⟩, ⟨(-9944), (-9938)⟩, ⟨45, 50⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35283235, 35283239⟩, ⟨(-143981), (-143976)⟩, ⟨(-9944), (-9938)⟩, ⟨45, 50⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21215810, 21215814⟩, ⟨5975084, 5975089⟩, ⟨402259, 402266⟩, ⟨(-3449), (-3442)⟩, ⟨(-117), (-110)⟩⟩
...
def j33 : Jet := ⟨⟨(-694612073), (-694612068)⟩, ⟨5975084, 5975089⟩, ⟨402259, 402266⟩, ⟨(-3449), (-3442)⟩, ⟨(-117), (-110)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-417670268), (-417670263)⟩, ⟨(-115741545), (-115741538)⟩, ⟨(-7255487), (-7255478)⟩, ⟨140356, 140364⟩, ⟨4272, 4280⟩⟩
...
def j36 : Jet := ⟨⟨3877297028, 3877297033⟩, ⟨(-115741545), (-115741538)⟩, ⟨(-7255487), (-7255478)⟩, ⟨140356, 140364⟩, ⟨4272, 4280⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1044820505, 1044820511⟩, ⟨130993183, 130993192⟩, ⟨(-3801170), (-3801160)⟩, ⟨(-154429), (-154421)⟩, ⟨2755, 2763⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4757629842, 4757629849⟩, ⟨142020430, 142020441⟩, ⟨13142283, 13142298⟩, ⟨485834, 485850⟩, ⟨28699, 28715⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1157370678, 1157370687⟩, ⟨179652807, 179652822⟩, ⟨3317946, 3317964⟩, ⟨222258, 222275⟩, ⟨8110, 8129⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1060121409), (-1060121408)⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3234845887, 3234845888⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨311878250, 311878256⟩, ⟨96822572, 96822582⟩, ⟨9302821, 9302835⟩, ⟨397354, 397368⟩, ⟨25525, 25542⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4606845546, 4606845552⟩, ⟨96822572, 96822582⟩, ⟨9302821, 9302835⟩, ⟨397354, 397368⟩, ⟨25525, 25542⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4448173890, 4448173894⟩, ⟨46743876, 46743882⟩, ⟨4245598, 4245606⟩, ⟨147218, 147227⟩, ⟨8748, 8759⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3350236688, 3350236693⟩, ⟨(-121642030), (-121642021)⟩, ⟨1549414, 1549422⟩, ⟨(-38826), (-38817)⟩, ⟨1396, 1407⟩⟩
...
def j47 : Jet := ⟨⟨8872457806, 8872457818⟩, ⟨1267493968, 1267493978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨18328546434, 18328546485⟩, ⟨5236727534, 5236727584⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨18328546434, 18328546485⟩, ⟨5236727534, 5236727584⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-18328546485), (-18328546434)⟩, ⟨(-5236727584), (-5236727534)⟩, ⟨(-374051972), (-374051965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9164273243), (-9164273217)⟩, ⟨(-2618363792), (-2618363767)⟩, ⟨(-187025986), (-187025982)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨508505264, 508505279⟩, ⟨(-310002783), (-310002769)⟩, ⟨72351262, 72351270⟩, ⟨(-5703172), (-5703168)⟩, ⟨(-706069), (-706067)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨396653309, 396653322⟩, ⟨(-256215762), (-256215747)⟩, ⟨65400054, 65400065⟩, ⟨(-6614255), (-6614245)⟩, ⟨(-360170), (-360161)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨908675493, 1211567325⟩, ⟨151445915, 151445916⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2854688253, 3806251008⟩, ⟨475781373, 475781378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1897393963, 3373144832⟩, ⟨632464650, 843286212⟩, ⟨52705387, 52705389⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨474, 846⟩, ⟨158, 212⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94213), (-93840)⟩, ⟨158, 212⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-73993), (-41455)⟩, ⟨(-18430), (-13651)⟩, ⟨(-1129), (-1098)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5039063, 5071602⟩, ⟨(-18430), (-13651)⟩, ⟨(-1129), (-1098)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2226114, 3983092⟩, ⟨727563, 989743⟩, ⟨57330, 59741⟩, ⟨(-449), (-323)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140939463), (-139182484)⟩, ⟨727563, 989743⟩, ⟨57330, 59741⟩, ⟨(-449), (-323)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-110689835), (-61486848)⟩, ⟨(-27351043), (-19718300)⟩, ⟨(-1597065), (-1466719)⟩, ⟨17017, 23734⟩, ⟨603, 683⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1320965930, 1370168918⟩, ⟨(-27351043), (-19718300)⟩, ⟨(-1597065), (-1466719)⟩, ⟨17017, 23734⟩, ⟨603, 683⟩⟩
...
def j70 : Jet := ⟨⟨(-85), (-47)⟩, ⟨(-22), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11750, 11789⟩, ⟨(-22), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5190, 9259⟩, ⟨1712, 2309⟩, ⟨137, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846987), (-842917)⟩, ⟨1712, 2309⟩, ⟨137, 143⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-665200), (-372376)⟩, ⟨(-165544), (-122311)⟩, ⟨(-10082), (-9776)⟩, ⟨39, 58⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35126194, 35419019⟩, ⟨(-165544), (-122311)⟩, ⟨(-10082), (-9776)⟩, ⟨39, 58⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨15517749, 27817088⟩, ⟨5042569, 6900239⟩, ⟨390625, 412313⟩, ⟨(-3995), (-2893)⟩, ⟨(-120), (-105)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700310134), (-688010794)⟩, ⟨5042569, 6900239⟩, ⟨390625, 412313⟩, ⟨(-3995), (-2893)⟩, ⟨(-120), (-105)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-550003609), (-303943531)⟩, ⟨(-135273240), (-95895258)⟩, ⟨(-7678687), (-6764243)⟩, ⟨116263, 164353⟩, ⟨3913, 4588⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3744963687, 3991023765⟩, ⟨(-135273240), (-95895258)⟩, ⟨(-7678687), (-6764243)⟩, ⟨116263, 164353⟩, ⟨3913, 4588⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨877991766, 1214259962⟩, ⟨122093140, 138676553⟩, ⟨(-4445191), (-3159190)⟩, ⟨(-165608), (-141443)⟩, ⟨2285, 3236⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4622058188, 4925747115⟩, ⟨111057584, 177924762⟩, ⟨10502221, 16526658⟩, ⟨237725, 818292⟩, ⟨10520, 55168⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨944856794, 1392592095⟩, ⟨154094127, 209345611⟩, ⟨205901, 7017445⟩, ⟨(-26936), 531059⟩, ⟨(-12600), 34350⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1211567325), (-908675493)⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3083399971, 3386291803⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨207860572, 451531435⟩, ⟨67798830, 135755654⟩, ⟨5619155, 14754588⟩, ⟨(-2694), 1028470⟩, ⟨(-10789), 85512⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4502827868, 4746498731⟩, ⟨67798830, 135755654⟩, ⟨5619155, 14754588⟩, ⟨(-2694), 1028470⟩, ⟨(-10789), 85512⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4397669659, 4515092117⟩, ⟨32246712, 66292621⟩, ⟨2185932, 7086779⟩, ⟨(-108146), 486197⟩, ⟨(-18309), 42846⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3157131024, 3559845366⟩, ⟨(-136057556), (-102800071)⟩, ⟨(-768259), 4450388⟩, ⟨(-335155), 306256⟩, ⟨(-31580), 37596⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7604963838, 10139951795⟩, ⟨1267493968, 1267493978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨13465870864, 23939326035⟩, ⟨4488623602, 5984831526⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨13465870864, 23939326035⟩, ⟨4488623602, 5984831526⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-23939326035), (-13465870864)⟩, ⟨(-5984831526), (-4488623602)⟩, ⟨(-374051972), (-374051965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11969663018), (-6732935432)⟩, ⟨(-2992415763), (-2244311801)⟩, ⟨(-187025986), (-187025982)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨264620007, 895664170⟩, ⟨(-624032594), (-138275745)⟩, ⟨(-2874419), 205866916⟩, ⟨(-43796771), 18783386⟩, ⟨(-7753996), 7691173⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨194516040, 742363266⟩, ⟨(-545597035), (-107976979)⟩, ⟨766981, 191327370⟩, ⟨(-43538600), 15834991⟩, ⟨(-7109768), 8032026⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1060121408, 1060121409⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4448173890, 4448173894⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3046
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨908675493, 1211567325⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4397669659, 4515092117⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3047
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (1851479 / 268435456)

theorem envelope_integral : (∫ s in ((84627 / 400000) : ℝ)..(28209 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((84627 / 400000) : ℝ)..(28209 / 100000), prawitzNormalCorrection
