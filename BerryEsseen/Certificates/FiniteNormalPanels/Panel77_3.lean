...
namespace FiniteNormalPanel77_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (30973 / 160000)
def radius : Rat := (30973 / 800000)

def j0 : Jet := ⟨⟨831425137, 831425138⟩, ⟨166285027, 166285028⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2611999102, 2611999106⟩, ⟨522399819, 522399823⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1588496218, 1588496224⟩, ⟨635398484, 635398492⟩, ⟨63539848, 63539850⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨397, 398⟩, ⟨159, 160⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94290), (-94288)⟩, ⟨159, 160⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-34874), (-34872)⟩, ⟨(-13892), (-13888)⟩, ⟨(-1367), (-1364)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5078182, 5078185⟩, ⟨(-13892), (-13888)⟩, ⟨(-1367), (-1364)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1878168, 1878170⟩, ⟨746129, 746132⟩, ⟨72564, 72569⟩, ⟨(-408), (-403)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-141287409), (-141287406)⟩, ⟨746129, 746132⟩, ⟨72564, 72569⟩, ⟨(-408), (-403)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-52255233), (-52255231)⟩, ⟨(-20626138), (-20626134)⟩, ⟨(-1952991), (-1952986)⟩, ⟨21622, 21626⟩, ⟨1004, 1009⟩⟩
...
def j19 : Jet := ⟨⟨1379400532, 1379400535⟩, ⟨(-20626138), (-20626134)⟩, ⟨(-1952991), (-1952986)⟩, ⟨21622, 21626⟩, ⟨1004, 1009⟩⟩
...
def j25 : Jet := ⟨⟨4362, 4364⟩, ⟨1738, 1741⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847815), (-847812)⟩, ⟨1738, 1741⟩, ⟨170, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-313565), (-313563)⟩, ⟨(-124784), (-124781)⟩, ⟨(-12224), (-12220)⟩, ⟨49, 52⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35477829, 35477832⟩, ⟨(-124784), (-124781)⟩, ⟨(-12224), (-12220)⟩, ⟨49, 52⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨13121496, 13121498⟩, ⟨5202446, 5202449⟩, ⟨501876, 501881⟩, ⟨(-3638), (-3633)⟩, ⟨(-174), (-170)⟩⟩
...
def j33 : Jet := ⟨⟨(-702706387), (-702706384)⟩, ⟨5202446, 5202449⟩, ⟨501876, 501881⟩, ⟨(-3638), (-3633)⟩, ⟨(-174), (-170)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-259896378), (-259896375)⟩, ⟨(-102034425), (-102034420)⟩, ⟨(-9440586), (-9440581)⟩, ⟨149866, 149872⟩, ⟨6820, 6826⟩⟩
...
def j36 : Jet := ⟨⟨4035070918, 4035070921⟩, ⟨(-102034425), (-102034420)⟩, ⟨(-9440586), (-9440581)⟩, ⟨149866, 149872⟩, ⟨6820, 6826⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨838887167, 838887171⟩, ⟨155233576, 155233581⟩, ⟨(-3696491), (-3696485)⟩, ⟨(-224395), (-224391)⟩, ⟨3239, 3245⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4571603432, 4571603437⟩, ⟨115601661, 115601669⟩, ⟨13619075, 13619084⟩, ⟨445046, 445060⟩, ⟨31088, 31100⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨892919360, 892919366⟩, ⟨187811231, 187811240⟩, ⟨2903685, 2903695⟩, ⟨240818, 240830⟩, ⟨7842, 7856⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-831425138), (-831425137)⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3463542158, 3463542159⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨185637032, 185637035⟩, ⟨78091530, 78091536⟩, ⟨9419994, 9420002⟩, ⟨354074, 354086⟩, ⟨26283, 26296⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4480604328, 4480604331⟩, ⟨78091530, 78091536⟩, ⟨9419994, 9420002⟩, ⟨354074, 354086⟩, ⟨26283, 26296⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4386803968, 4386803970⟩, ⟨38228351, 38228355⟩, ⟨4444825, 4444830⟩, ⟨134596, 134603⟩, ⟨9440, 9449⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3537600972, 3537600975⟩, ⟨(-139012541), (-139012535)⟩, ⟨2104331, 2104337⟩, ⟨(-63548), (-63539)⟩, ⟨2400, 2409⟩⟩
...
def j47 : Jet := ⟨⟨6742862569, 6742862579⟩, ⟨1348572510, 1348572519⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10585923591, 10585923624⟩, ⟨4234369424, 4234369460⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10585923591, 10585923624⟩, ⟨4234369424, 4234369460⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10585923624), (-10585923591)⟩, ⟨(-4234369460), (-4234369424)⟩, ⟨(-423436947), (-423436941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5292961812), (-5292961795)⟩, ⟨(-2117184730), (-2117184712)⟩, ⟨(-211718474), (-211718470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1252423192, 1252423215⟩, ⟨(-617376368), (-617376350)⟩, ⟨90428802, 90428812⟩, ⟨5430033, 5430037⟩, ⟨(-2898002), (-2898000)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1031573280, 1031573300⟩, ⟨(-549045805), (-549045786)⟩, ⟨95078623, 95078637⟩, ⟨1224639, 1224650⟩, ⟨(-2508588), (-2508578)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨665140110, 997710166⟩, ⟨166285027, 166285028⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2089599283, 3134398929⟩, ⟨522399819, 522399823⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1016637581, 2287434565⟩, ⟨508318788, 762478192⟩, ⟨63539848, 63539850⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨254, 574⟩, ⟨127, 192⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94433), (-94112)⟩, ⟨127, 192⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-50294), (-22276)⟩, ⟨(-16735), (-11035)⟩, ⟨(-1380), (-1348)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5062762, 5090781⟩, ⟨(-16735), (-11035)⟩, ⟨(-1380), (-1348)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1198377, 2711273⟩, ⟨590275, 901146⟩, ⟨71192, 73689⟩, ⟨(-493), (-318)⟩, ⟨(-21), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141967200), (-140454303)⟩, ⟨590275, 901146⟩, ⟨71192, 73689⟩, ⟨(-493), (-318)⟩, ⟨(-21), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-75609582), (-33246149)⟩, ⟨(-25063474), (-16143137)⟩, ⟨(-2013556), (-1878659)⟩, ⟨16894, 26339⟩, ⟨953, 1051⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1356046183, 1398409617⟩, ⟨(-25063474), (-16143137)⟩, ⟨(-2013556), (-1878659)⟩, ⟨16894, 26339⟩, ⟨953, 1051⟩⟩
...
def j72 : Jet := ⟨⟨2787, 6291⟩, ⟨1382, 2095⟩, ⟨168, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849390), (-845885)⟩, ⟨1382, 2095⟩, ⟨168, 174⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-452373), (-200224)⟩, ⟨(-150464), (-98996)⟩, ⟨(-12364), (-12049)⟩, ⟨37, 62⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35339021, 35591171⟩, ⟨(-150464), (-98996)⟩, ⟨(-12364), (-12049)⟩, ⟨37, 62⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨8364901, 18955319⟩, ⟨4102315, 6295008⟩, ⟨489509, 511969⟩, ⟨(-4413), (-2856)⟩, ⟨(-179), (-164)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707462982), (-696872563)⟩, ⟨4102315, 6295008⟩, ⟨489509, 511969⟩, ⟨(-4413), (-2856)⟩, ⟨(-179), (-164)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-376784075), (-164952789)⟩, ⟨(-124623658), (-79123768)⟩, ⟨(-9864840), (-8919340)⟩, ⟨116272, 183342⟩, ⟨6361, 7199⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3918183221, 4130014507⟩, ⟨(-124623658), (-79123768)⟩, ⟨(-9864840), (-8919340)⟩, ⟨116272, 183342⟩, ⟨6361, 7199⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨659747312, 1020537132⟩, ⟨146645901, 162235520⟩, ⟨(-4517950), (-2877510)⟩, ⟨(-236692), (-209280)⟩, ⟨2517, 3972⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4466508299, 4707984041⟩, ⟨85570392, 149744452⟩, ⟨11285421, 16616175⟩, ⟨192008, 772974⟩, ⟨13194, 56632⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨686097621, 1118674998⟩, ⟨165647353, 213417694⟩, ⟨(-297178), 6612129⟩, ⟨(-2154), 536352⟩, ⟨(-14534), 35280⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-997710166), (-665140110)⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3297257130, 3629827186⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨109600356, 291372126⟩, ⟨52922522, 111174322⟩, ⟨6233842, 14049180⟩, ⟨(-30658), 936516⟩, ⟨(-8246), 81864⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4404567652, 4586339422⟩, ⟨52922522, 111174322⟩, ⟨6233842, 14049180⟩, ⟨(-30658), 936516⟩, ⟨(-8246), 81864⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4349422262, 4438262929⟩, ⟨25606921, 54891208⟩, ⟨2676846, 6861263⟩, ⟨(-101730), 446637⟩, ⟨(-15121), 40881⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3339062343, 3750931341⟩, ⟨(-152174401), (-122002837)⟩, ⟨(-70161), 4807291⟩, ⟨(-351619), 273832⟩, ⟨(-30073), 38489⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5394290058, 8091435098⟩, ⟨1348572510, 1348572519⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6774991105, 15243730030⟩, ⟨3387495540, 5081243354⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6774991105, 15243730030⟩, ⟨3387495540, 5081243354⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15243730030), (-6774991105)⟩, ⟨(-5081243354), (-3387495540)⟩, ⟨(-423436947), (-423436941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7621865015), (-3387495552)⟩, ⟨(-2540621677), (-1693747770)⟩, ⟨(-211718474), (-211718470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨728214374, 1951759305⟩, ⟨(-1154533122), (-287175986)⟩, ⟨(-39586253), 305576135⟩, ⟨(-50815477), 45747006⟩, ⟨(-14296853), 8490472⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨566140095, 1704533386⟩, ⟨(-1077442960), (-243946615)⟩, ⟨(-26446296), 309960025⟩, ⟨(-56657636), 41498189⟩, ⟨(-14238337), 9669473⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨831425137, 831425138⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4386803968, 4386803970⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1540
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨665140110, 997710166⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4349422262, 4438262929⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1541
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (82481105 / 4294967296)

theorem envelope_integral : (∫ s in ((30973 / 200000) : ℝ)..(92919 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((30973 / 200000) : ℝ)..(92919 / 400000), prawitzNormalCorrection
