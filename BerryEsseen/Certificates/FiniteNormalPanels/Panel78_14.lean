...
namespace FiniteNormalPanel78_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (18633 / 160000)
def radius : Rat := (6211 / 160000)

def j0 : Jet := ⟨⟨500175785, 500175786⟩, ⟨166725261, 166725262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1571348571, 1571348575⟩, ⟨523782855, 523782859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨574890601, 574890605⟩, ⟨383260398, 383260404⟩, ⟨63876732, 63876734⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨143, 145⟩, ⟨95, 97⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94544), (-94541)⟩, ⟨95, 97⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12655), (-12654)⟩, ⟨(-8425), (-8423)⟩, ⟨(-1397), (-1394)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100401, 5100403⟩, ⟨(-8425), (-8423)⟩, ⟨(-1397), (-1394)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨682699, 682700⟩, ⟨454005, 454007⟩, ⟨74916, 74919⟩, ⟨(-251), (-248)⟩, ⟨(-21), (-18)⟩⟩
...
def j16 : Jet := ⟨⟨(-142482878), (-142482876)⟩, ⟨454005, 454007⟩, ⟨74916, 74919⟩, ⟨(-251), (-248)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-19071640), (-19071639)⟩, ⟨(-12653658), (-12653655)⟩, ⟨(-2068532), (-2068527)⟩, ⟨13403, 13406⟩, ⟨1088, 1091⟩⟩
...
def j19 : Jet := ⟨⟨1412584125, 1412584127⟩, ⟨(-12653658), (-12653655)⟩, ⟨(-2068532), (-2068527)⟩, ⟨13403, 13406⟩, ⟨1088, 1091⟩⟩
...
def j25 : Jet := ⟨⟨1582, 1583⟩, ⟨1052, 1054⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850595), (-850593)⟩, ⟨1052, 1054⟩, ⟨173, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-113854), (-113853)⟩, ⟨(-75763), (-75760)⟩, ⟨(-12535), (-12531)⟩, ⟨29, 32⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35677540, 35677542⟩, ⟨(-75763), (-75760)⟩, ⟨(-12535), (-12531)⟩, ⟨29, 32⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4775515, 4775516⟩, ⟨3173534, 3173538⟩, ⟨522173, 522176⟩, ⟨(-2243), (-2239)⟩, ⟨(-185), (-182)⟩⟩
...
def j33 : Jet := ⟨⟨(-711052368), (-711052366)⟩, ⟨3173534, 3173538⟩, ⟨522173, 522176⟩, ⟨(-2243), (-2239)⟩, ⟨(-185), (-182)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-95175888), (-95175886)⟩, ⟨(-63025809), (-63025805)⟩, ⟨(-10222017), (-10222013)⟩, ⟨93492, 93497⟩, ⟨7539, 7544⟩⟩
...
def j36 : Jet := ⟨⟨4199791408, 4199791410⟩, ⟨(-63025809), (-63025805)⟩, ⟨(-10222017), (-10222013)⟩, ⟨93492, 93497⟩, ⟨7539, 7544⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨516805342, 516805345⟩, ⟨167639002, 167639007⟩, ⟨(-2299938), (-2299934)⟩, ⟨(-247361), (-247357)⟩, ⟨2032, 2035⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4392300062, 4392300065⟩, ⟨65914760, 65914767⟩, ⟨11679740, 11679747⟩, ⟨237924, 237934⟩, ⟨22639, 22649⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨528517210, 528517215⟩, ⟨179369444, 179369452⟩, ⟨1626092, 1626101⟩, ⟨196240, 196251⟩, ⟨4036, 4045⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-500175786), (-500175785)⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3794791510, 3794791511⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨65036686, 65036688⟩, ⟨44144614, 44144618⟩, ⟨7891148, 7891154⟩, ⟨184114, 184122⟩, ⟨17997, 18004⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4360003982, 4360003984⟩, ⟨44144614, 44144618⟩, ⟨7891148, 7891154⟩, ⟨184114, 184122⟩, ⟨17997, 18004⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4327363459, 4327363461⟩, ⟨21907065, 21907068⟩, ⟨3860584, 3860588⟩, ⟨71823, 71829⟩, ⟨6844, 6850⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3823414937, 3823414941⟩, ⟨(-148626991), (-148626985)⟩, ⟨2560589, 2560595⟩, ⟨(-86406), (-86398)⟩, ⟨3257, 3265⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨33330837524, 33330837531⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value384

def j47 : Jet := ⟨⟨3881584346, 3881584355⟩, ⟨1293861443, 1293861452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3507988768, 3507988785⟩, ⟨2338659168, 2338659192⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3507988768, 3507988785⟩, ⟨2338659168, 2338659192⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3507988785), (-3507988768)⟩, ⟨(-2338659192), (-2338659168)⟩, ⟨(-389776532), (-389776526)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1753994393), (-1753994384)⟩, ⟨(-1169329596), (-1169329584)⟩, ⟨(-194888266), (-194888263)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2854967033, 2854967046⟩, ⟨(-777281230), (-777281218)⟩, ⟨(-23737228), (-23737222)⟩, ⟨25667452, 25667455⟩, ⟨(-1208479), (-1208477)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2541514951, 2541514966⟩, ⟨(-790737996), (-790737979)⟩, ⟨7468760, 7468775⟩, ⟨23149958, 23149971⟩, ⟨(-1960371), (-1960358)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨333450523, 666901047⟩, ⟨166725261, 166725262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1047565713, 2095131431⟩, ⟨523782855, 523782859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨255506933, 1022027739⟩, ⟨255506932, 511013872⟩, ⟨63876732, 63876734⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨63, 257⟩, ⟨63, 129⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94624), (-94429)⟩, ⟨63, 129⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-22517), (-5617)⟩, ⟨(-11256), (-5586)⟩, ⟨(-1405), (-1383)⟩, ⟨0, 5⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5090539, 5107440⟩, ⟨(-11256), (-5586)⟩, ⟨(-1405), (-1383)⟩, ⟨0, 5⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨302835, 1215364⟩, ⟨300156, 607350⟩, ⟨74033, 75547⟩, ⟨(-336), (-163)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142862742), (-141950212)⟩, ⟨300156, 607350⟩, ⟨74033, 75547⟩, ⟨(-336), (-163)⟩, ⟨(-21), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-33995529), (-8444595)⟩, ⟨(-16979909), (-8300070)⟩, ⟨(-2102461), (-2020907)⟩, ⟨8788, 18013⟩, ⟨1056, 1114⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1397660236, 1423211171⟩, ⟨(-16979909), (-8300070)⟩, ⟨(-2102461), (-2020907)⟩, ⟨8788, 18013⟩, ⟨1056, 1114⟩⟩
...
def j72 : Jet := ⟨⟨702, 2816⟩, ⟨698, 1408⟩, ⟨172, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851475), (-849360)⟩, ⟨698, 1408⟩, ⟨172, 176⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-202617), (-50528)⟩, ⟨(-101268), (-50192)⟩, ⟨(-12613), (-12422)⟩, ⟨19, 42⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35588777, 35740867⟩, ⟨(-101268), (-50192)⟩, ⟨(-12613), (-12422)⟩, ⟨19, 42⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2117170, 8504875⟩, ⟨2093072, 4249453⟩, ⟨514241, 527832⟩, ⟨(-3007), (-1474)⟩, ⟨(-187), (-178)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713710713), (-707323007)⟩, ⟨2093072, 4249453⟩, ⟨514241, 527832⟩, ⟨(-3007), (-1474)⟩, ⟨(-187), (-178)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-169834157), (-42078535)⟩, ⟨(-84792563), (-41067336)⟩, ⟨(-10459527), (-9888431)⟩, ⟨61005, 125915⟩, ⟨7245, 7754⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4125133139, 4252888761⟩, ⟨(-84792563), (-41067336)⟩, ⟨(-10459527), (-9888431)⟩, ⟨61005, 125915⟩, ⟨7245, 7754⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨340896877, 694257780⟩, ⟨162165455, 171540015⟩, ⟨(-3096350), (-1505125)⟩, ⟨(-254258), (-237668)⟩, ⟨1328, 2741⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4337462160, 4471793626⟩, ⟨41884004, 91918208⟩, ⟨10489518, 13227896⟩, ⟨66277, 440823⟩, ⟨14152, 34366⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨344269747, 722840782⟩, ⟨167094322, 193460491⟩, ⟨(-809846), 4289394⟩, ⟨70320, 344881⟩, ⟨(-10013), 20025⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-666901047), (-333450523)⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3628066249, 3961516773⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨27595474, 121653732⟩, ⟨26787406, 65118602⟩, ⟨6228156, 10157950⟩, ⟨(-61686), 502508⟩, ⟨1289, 42096⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4322562770, 4416621028⟩, ⟨26787406, 65118602⟩, ⟨6228156, 10157950⟩, ⟨(-61686), 502508⟩, ⟨1289, 42096⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308742941, 4355369431⟩, ⟨13207953, 32455205⟩, ⟨2949966, 5042494⟩, ⟨(-68727), 241409⟩, ⟨(-4128), 20490⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3639702880, 4017229438⟩, ⟨(-157912910), (-137324549)⟩, ⟨1232039, 4138292⟩, ⟨(-259136), 108154⟩, ⟨(-13180), 21568⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2587722894, 5175445799⟩, ⟨1293861443, 1293861452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1559106115, 6236424488⟩, ⟨1559106110, 3118212250⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1559106115, 6236424488⟩, ⟨1559106110, 3118212250⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6236424488), (-1559106115)⟩, ⟨(-3118212250), (-1559106110)⟩, ⟨(-389776532), (-389776526)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3118212244), (-779553057)⟩, ⟨(-1559106125), (-779553055)⟩, ⟨(-194888266), (-194888263)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2078047137, 3582067333⟩, ⟨(-1300317962), (-377173534)⟩, ⟨(-128310524), 141719323⟩, ⟨(-5738661), 54861353⟩, ⟨(-8194099), 3431902⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1761008554, 3350429782⟩, ⟨(-1347933495), (-386071969)⟩, ⟨(-107357604), 183815061⟩, ⟨(-12047164), 56013294⟩, ⟨(-9848675), 3653964⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨500175785, 500175786⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨166725261, 166725262⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4327363459, 4327363461⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar384 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1580
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar384 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨333450523, 666901047⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308742941, 4355369431⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1581
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((6211 / 80000) : ℝ)..(6211 / 40000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (6211 / 80000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (6211 / 40000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((6211 / 80000) : ℝ)..(6211 / 40000), prawitzNormalCorrection
      ((274373 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
