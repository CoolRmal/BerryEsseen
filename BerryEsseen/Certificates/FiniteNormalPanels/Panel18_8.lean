...
namespace FiniteNormalPanel18_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (70973 / 200000)
def radius : Rat := (10139 / 200000)

def j0 : Jet := ⟨⟨1524133569, 1524133570⟩, ⟨217733367, 217733368⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4788206823, 4788206827⟩, ⟨684029546, 684029550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5338090606, 5338090616⟩, ⟨1525168744, 1525168756⟩, ⟨108940624, 108940626⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1336, 1338⟩, ⟨381, 383⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93351), (-93348)⟩, ⟨381, 383⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-116024), (-116019)⟩, ⟨(-32677), (-32671)⟩, ⟨(-2200), (-2195)⟩, ⟨18, 20⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4997032, 4997038⟩, ⟨(-32677), (-32671)⟩, ⟨(-2200), (-2195)⟩, ⟨18, 20⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6210666, 6210674⟩, ⟨1733862, 1733874⟩, ⟨112409, 112420⟩, ⟨(-1589), (-1582)⟩, ⟨(-50), (-45)⟩⟩
...
def j16 : Jet := ⟨⟨(-136954911), (-136954902)⟩, ⟨1733862, 1733874⟩, ⟨112409, 112420⟩, ⟨(-1589), (-1582)⟩, ⟨(-50), (-45)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-170217298), (-170217285)⟩, ⟨(-46478548), (-46478528)⟩, ⟨(-2718410), (-2718388)⟩, ⟨81920, 81936⟩, ⟨2223, 2236⟩⟩
...
def j19 : Jet := ⟨⟨1261438467, 1261438481⟩, ⟨(-46478548), (-46478528)⟩, ⟨(-2718410), (-2718388)⟩, ⟨81920, 81936⟩, ⟨2223, 2236⟩⟩
...
def j22 : Jet := ⟨⟨(-135), (-132)⟩, ⟨(-39), (-37)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11700, 11704⟩, ⟨(-39), (-37)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨14541, 14547⟩, ⟨4105, 4112⟩, ⟨278, 282⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-837636), (-837629)⟩, ⟨4105, 4112⟩, ⟨278, 282⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1041074), (-1041064)⟩, ⟨(-292349), (-292336)⟩, ⟨(-19445), (-19434)⟩, ⟨198, 206⟩, ⟨3, 8⟩⟩
...
def j30 : Jet := ⟨⟨34750320, 34750331⟩, ⟨(-292349), (-292336)⟩, ⟨(-19445), (-19434)⟩, ⟨198, 206⟩, ⟨3, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨43190167, 43190182⟩, ⟨11976694, 11976717⟩, ⟨753448, 753470⟩, ⟨(-14076), (-14059)⟩, ⟨(-421), (-408)⟩⟩
...
def j33 : Jet := ⟨⟨(-672637716), (-672637700)⟩, ⟨11976694, 11976717⟩, ⟨753448, 753470⟩, ⟨(-14076), (-14059)⟩, ⟨(-421), (-408)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-836001961), (-836001939)⟩, ⟨(-223972219), (-223972180)⟩, ⟨(-11871831), (-11871791)⟩, ⟨553843, 553876⟩, ⟨13587, 13613⟩⟩
...
def j36 : Jet := ⟨⟨3458965335, 3458965357⟩, ⟨(-223972219), (-223972180)⟩, ⟨(-11871831), (-11871791)⟩, ⟨553843, 553876⟩, ⟨13587, 13613⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1406303670, 1406303688⟩, ⟨149084320, 149084347⟩, ⟨(-10432911), (-10432882)⟩, ⟨(-341616), (-341592)⟩, ⟨15524, 15543⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5333023655, 5333023690⟩, ⟨345319715, 345319782⟩, ⟨40663761, 40663836⟩, ⟨2964261, 2964325⟩, ⟨255218, 255272⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1746195074, 1746195109⟩, ⟨298184944, 298185004⟩, ⟨12346633, 12346700⟩, ⟨1119085, 1119145⟩, ⟨79491, 79540⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1524133570), (-1524133569)⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2770833726, 2770833727⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨709946555, 709946584⟩, ⟨242464746, 242464802⟩, ⟨30741448, 30741513⟩, ⟨2624334, 2624398⟩, ⟨255516, 255569⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5004913851, 5004913880⟩, ⟨242464746, 242464802⟩, ⟨30741448, 30741513⟩, ⟨2624334, 2624398⟩, ⟨255516, 255569⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4636371567, 4636371581⟩, ⟨112305294, 112305322⟩, ⟨12878715, 12878748⟩, ⟨903585, 903618⟩, ⟨78575, 78602⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2991085570, 2991085581⟩, ⟨(-162588784), (-162588762)⟩, ⟨2615190, 2615216⟩, ⟨(-69955), (-69930)⟩, ⟨4882, 4902⟩⟩
...
def j47 : Jet := ⟨⟨6771019949, 6771019957⟩, ⟨967288564, 967288569⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10674519266, 10674519292⟩, ⟨3049862646, 3049862668⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10674519266, 10674519292⟩, ⟨3049862646, 3049862668⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10674519292), (-10674519266)⟩, ⟨(-3049862668), (-3049862646)⟩, ⟨(-217847335), (-217847331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5337259646), (-5337259633)⟩, ⟨(-1524931334), (-1524931323)⟩, ⟨(-108923668), (-108923665)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1239572222, 1239572234⟩, ⟨(-440111044), (-440111036)⟩, ⟨46694370, 46694375⟩, ⟨1914744, 1914746⟩, ⟨(-762061), (-762060)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨863258397, 863258410⟩, ⟨(-353425356), (-353425340)⟩, ⟨49934182, 49934198⟩, ⟨(-722362), (-722348)⟩, ⟨(-566191), (-566177)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1306400202, 1741866937⟩, ⟨217733367, 217733368⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4104177277, 5472236374⟩, ⟨684029546, 684029550⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3921862486, 6972199989⟩, ⟨1307287494, 1743050006⟩, ⟨108940624, 108940626⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨981, 1747⟩, ⟨327, 437⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93706), (-92939)⟩, ⟨327, 437⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-152117), (-84865)⟩, ⟨(-37732), (-27578)⟩, ⟨(-2254), (-2133)⟩, ⟨16, 24⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4960939, 5028192⟩, ⟨(-37732), (-27578)⟩, ⟨(-2254), (-2133)⟩, ⟨16, 24⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4529981, 8162475⟩, ⟨1448741, 2015437⟩, ⟨106859, 117198⟩, ⟨(-1859), (-1309)⟩, ⟨(-54), (-42)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138635596), (-135003101)⟩, ⟨1448741, 2015437⟩, ⟨106859, 117198⟩, ⟨(-1859), (-1309)⟩, ⟨(-54), (-42)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-225052960), (-123275350)⟩, ⟨(-54940353), (-37820039)⟩, ⟨(-2977915), (-2416126)⟩, ⟨66253, 97490⟩, ⟨1867, 2537⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1206602805, 1308380416⟩, ⟨(-54940353), (-37820039)⟩, ⟨(-2977915), (-2416126)⟩, ⟨66253, 97490⟩, ⟨1867, 2537⟩⟩
...
def j70 : Jet := ⟨⟨(-176), (-97)⟩, ⟨(-44), (-32)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11659, 11739⟩, ⟨(-44), (-32)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨10646, 19057⟩, ⟨3476, 4736⟩, ⟨272, 288⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-841531), (-833119)⟩, ⟨3476, 4736⟩, ⟨272, 288⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1366093), (-760745)⟩, ⟨(-338350), (-245892)⟩, ⟨(-20040), (-18740)⟩, ⟨163, 238⟩, ⟨2, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34425301, 35030650⟩, ⟨(-338350), (-245892)⟩, ⟨(-20040), (-18740)⟩, ⟨163, 238⟩, ⟨2, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨31434767, 56866719⟩, ⟨9928997, 13992149⟩, ⟨703340, 796588⟩, ⟨(-16568), (-11553)⟩, ⟨(-459), (-365)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-684393116), (-658961163)⟩, ⟨9928997, 13992149⟩, ⟨703340, 796588⟩, ⟨(-16568), (-11553)⟩, ⟨(-459), (-365)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1111003961), (-601717053)⟩, ⟨(-268684530), (-177858309)⟩, ⟨(-13695044), (-9742716)⟩, ⟨439030, 667642⟩, ⟨10370, 16357⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3183963335, 3693250243⟩, ⟨(-268684530), (-177858309)⟩, ⟨(-13695044), (-9742716)⟩, ⟨439030, 667642⟩, ⟨10370, 16357⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1153003381, 1667013137⟩, ⟨122167489, 172236638⟩, ⟨(-12544143), (-8332131)⟩, ⟨(-410963), (-260586)⟩, ⟨12335, 18760⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4994718164, 5793642117⟩, ⟨240533965, 488907016⟩, ⟨24759513, 66177252⟩, ⟨779543, 6998694⟩, ⟨(-12977), 825812⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1340854663, 2248696406⟩, ⟨206643866, 422096779⟩, ⟨(-3432633), 35601997⟩, ⟨(-1068758), 4600584⟩, ⟨(-208583), 563868⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1741866937), (-1306400202)⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2553100359, 2988567094⟩, ⟨(-217733368), (-217733367)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨418604171, 1177339705⟩, ⟨129025146, 441990566⟩, ⟨6347845, 78762383⟩, ⟨(-1793830), 11815134⟩, ⟨(-456938), 1789822⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4713571467, 5472307001⟩, ⟨129025146, 441990566⟩, ⟨6347845, 78762383⟩, ⟨(-1793830), 11815134⟩, ⟨(-456938), 1789822⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4499403882, 4848028425⟩, ⟨57153004, 210954060⟩, ⟨(-1915569), 37228865⟩, ⟨(-2601635), 5728961⟩, ⟨(-640710), 984153⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2674625643, 3373403620⟩, ⟨(-211796772), (-81309115)⟩, ⟨(-12027228), 23007591⟩, ⟨(-3697614), 4083493⟩, ⟨(-736256), 816694⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5803731385, 7738308521⟩, ⟨967288564, 967288569⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7842503951, 13942229275⟩, ⟨2614167982, 3485557334⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7842503951, 13942229275⟩, ⟨2614167982, 3485557334⟩, ⟨217847331, 217847335⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13942229275), (-7842503951)⟩, ⟨(-3485557334), (-2614167982)⟩, ⟨(-217847335), (-217847331)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6971114638), (-3921251975)⟩, ⟨(-1742778667), (-1307083991)⟩, ⟨(-108923668), (-108923665)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨847346842, 1723671006⟩, ⟨(-699417912), (-257872392)⟩, ⟨(-4474571), 120412835⟩, ⟨(-11926836), 12430403⟩, ⟨(-2787860), 1266635⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨527672374, 1353825911⟩, ⟨(-634344032), (-176627452)⟩, ⟨(-3459433), 138299790⟩, ⟨(-20536241), 13581276⟩, ⟨(-4100303), 3157940⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1524133569, 1524133570⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4636371567, 4636371581⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified364
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1306400202, 1741866937⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4499403882, 4848028425⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified365
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (89277417 / 4294967296)

theorem envelope_integral : (∫ s in ((30417 / 100000) : ℝ)..(10139 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((30417 / 100000) : ℝ)..(10139 / 25000), prawitzNormalCorrection
