...
namespace FiniteNormalPanel170_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (2543 / 16000)
def radius : Rat := (2543 / 80000)

def j0 : Jet := ⟨⟨682631364, 682631365⟩, ⟨136526272, 136526273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2144549678, 2144549682⟩, ⟨428909933, 428909937⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1070809858, 1070809863⟩, ⟨428323940, 428323946⟩, ⟨42832393, 42832395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨268, 269⟩, ⟨107, 108⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94419), (-94417)⟩, ⟨107, 108⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23541), (-23539)⟩, ⟨(-9391), (-9388)⟩, ⟨(-930), (-927)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5089515, 5089518⟩, ⟨(-9391), (-9388)⟩, ⟨(-930), (-927)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1268904, 1268906⟩, ⟨505219, 505223⟩, ⟨49587, 49590⟩, ⟨(-187), (-184)⟩, ⟨(-10), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-141896673), (-141896670)⟩, ⟨505219, 505223⟩, ⟨49587, 49590⟩, ⟨(-187), (-184)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-35377303), (-35377301)⟩, ⟨(-14024963), (-14024959)⟩, ⟨(-1352348), (-1352343)⟩, ⟨9936, 9940⟩, ⟨472, 476⟩⟩
...
def j19 : Jet := ⟨⟨1396278462, 1396278465⟩, ⟨(-14024963), (-14024959)⟩, ⟨(-1352348), (-1352343)⟩, ⟨9936, 9940⟩, ⟨472, 476⟩⟩
...
def j25 : Jet := ⟨⟨2943, 2945⟩, ⟨1174, 1176⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849234), (-849231)⟩, ⟨1174, 1176⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-211729), (-211728)⟩, ⟨(-84400), (-84397)⟩, ⟨(-8325), (-8321)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35579665, 35579667⟩, ⟨(-84400), (-84397)⟩, ⟨(-8325), (-8321)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8870627, 8870629⟩, ⟨3527208, 3527211⟩, ⟨344332, 344336⟩, ⟨(-1668), (-1664)⟩, ⟨(-83), (-78)⟩⟩
...
def j33 : Jet := ⟨⟨(-706957256), (-706957253)⟩, ⟨3527208, 3527211⟩, ⟨344332, 344336⟩, ⟨(-1668), (-1664)⟩, ⟨(-83), (-78)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-176256710), (-176256707)⟩, ⟨(-69623290), (-69623287)⟩, ⟨(-6612665), (-6612661)⟩, ⟨69098, 69102⟩, ⟨3245, 3250⟩⟩
...
def j36 : Jet := ⟨⟨4118710586, 4118710589⟩, ⟨(-69623290), (-69623287)⟩, ⟨(-6612665), (-6612661)⟩, ⟨69098, 69102⟩, ⟨3245, 3250⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨697185407, 697185411⟩, ⟨132434179, 132434185⟩, ⟨(-2075832), (-2075826)⟩, ⟨(-130090), (-130085)⟩, ⟨1227, 1231⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4478766758, 4478766762⟩, ⟨75709729, 75709734⟩, ⟨8470544, 8470552⟩, ⟨189595, 189606⟩, ⟨11997, 12008⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨727020861, 727020867⟩, ⟨150391253, 150391262⟩, ⟨1544813, 1544823⟩, ⟨119712, 119725⟩, ⟨2684, 2695⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-682631365), (-682631364)⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3612335931, 3612335932⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨123064809, 123064812⟩, ⟨50914276, 50914282⟩, ⟨5789041, 5789049⟩, ⟨148710, 148722⟩, ⟨9845, 9856⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4418032105, 4418032108⟩, ⟨50914276, 50914282⟩, ⟨5789041, 5789049⟩, ⟨148710, 148722⟩, ⟨9845, 9856⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4356065128, 4356065130⟩, ⟨25100078, 25100082⟩, ⟨2781607, 2781612⟩, ⟨57284, 57292⟩, ⟨3634, 3642⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3663723026, 3663723030⟩, ⟨(-117357687), (-117357681)⟩, ⟨1541636, 1541642⟩, ⟨(-40242), (-40233)⟩, ⟨1234, 1244⟩⟩
...
def j47 : Jet := ⟨⟨7490755426, 7490755439⟩, ⟨1498151076, 1498151088⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13064457302, 13064457348⟩, ⟨5225782888, 5225782940⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13064457302, 13064457348⟩, ⟨5225782888, 5225782940⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13064457348), (-13064457302)⟩, ⟨(-5225782940), (-5225782888)⟩, ⟨(-522578295), (-522578285)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6532228674), (-6532228651)⟩, ⟨(-2612891470), (-2612891444)⟩, ⟨(-261289148), (-261289142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨938512530, 938512545⟩, ⟨(-570954621), (-570954605)⟩, ⟨116577850, 116577860⟩, ⟨(-484042), (-484037)⟩, ⟨(-3472456), (-3472453)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨800576518, 800576533⟩, ⟨(-512684057), (-512684040)⟩, ⟨115381949, 115381965⟩, ⟨(-3812063), (-3812052)⟩, ⟨(-2901412), (-2901402)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨546105091, 819157638⟩, ⟨136526272, 136526273⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1715639741, 2573459618⟩, ⟨428909933, 428909937⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨685318308, 1541966202⟩, ⟨342659152, 513988736⟩, ⟨42832393, 42832395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-33933), (-15046)⟩, ⟨(-11298), (-7476)⟩, ⟨(-936), (-920)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5079123, 5098011⟩, ⟨(-11298), (-7476)⟩, ⟨(-936), (-920)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨810440, 1830273⟩, ⟨401163, 608899⟩, ⟨48962, 50099⟩, ⟨(-226), (-145)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142355137), (-141335303)⟩, ⟨401163, 608899⟩, ⟨48962, 50099⟩, ⟨(-226), (-145)⟩, ⟨(-10), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-51107912), (-22551899)⟩, ⟨(-16971961), (-11057343)⟩, ⟨(-1379848), (-1318637)⟩, ⟨7824, 12046⟩, ⟨456, 488⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1380547853, 1409103867⟩, ⟨(-16971961), (-11057343)⟩, ⟨(-1379848), (-1318637)⟩, ⟨7824, 12046⟩, ⟨456, 488⟩⟩
...
def j72 : Jet := ⟨⟨1882, 4244⟩, ⟨936, 1414⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850295), (-847932)⟩, ⟨936, 1414⟩, ⟨114, 118⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-305271), (-135298)⟩, ⟨(-101608), (-67141)⟩, ⟨(-8388), (-8243)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35486123, 35656097⟩, ⟨(-101608), (-67141)⟩, ⟨(-8388), (-8243)⟩, ⟨17, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5662275, 12801145⟩, ⟨2794658, 4256336⟩, ⟨338720, 348917⟩, ⟨(-2016), (-1315)⟩, ⟨(-84), (-77)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710165608), (-703026737)⟩, ⟨2794658, 4256336⟩, ⟨338720, 348917⟩, ⟨(-2016), (-1315)⟩, ⟨(-84), (-77)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-254961515), (-112177127)⟩, ⟨(-84541248), (-54560466)⟩, ⟨(-6805256), (-6376436)⟩, ⟨54169, 83995⟩, ⟨3104, 3364⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4040005781, 4182790169⟩, ⟨(-84541248), (-54560466)⟩, ⟨(-6805256), (-6376436)⟩, ⟨54169, 83995⟩, ⟨3104, 3364⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨551464678, 844307221⟩, ⟨127696905, 136300977⟩, ⟨(-2521656), (-1630957)⟩, ⟨(-134672), (-124465)⟩, ⟨963, 1496⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4410152871, 4566019228⟩, ⟨57526192, 95548618⟩, ⟨7473410, 9690763⟩, ⟨93487, 304608⟩, ⟨7019, 18540⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨566254261, 897590771⟩, ⟨138507814, 163685828⟩, ⟨(-10873), 3262559⟩, ⟨34929, 217772⟩, ⟨(-4019), 10399⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-819157638), (-546105091)⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3475809658, 3748862205⟩, ⟨(-136526273), (-136526272)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨74655722, 187584477⟩, ⟨36522112, 68416302⟩, ⟨4462173, 7601908⟩, ⟨8380, 339704⟩, ⟨563, 23427⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4369623018, 4482551773⟩, ⟨36522112, 68416302⟩, ⟨4462173, 7601908⟩, ⟨8380, 339704⟩, ⟨563, 23427⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4332134342, 4387757203⟩, ⟨17874881, 33914667⟩, ⟨2052834, 3731468⟩, ⟨(-25060), 159926⟩, ⟨(-2581), 11324⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3505888019, 3829853876⟩, ⟨(-125010139), (-108105301)⟩, ⟨583244, 2688815⟩, ⟨(-140489), 74338⟩, ⟨(-7337), 10682⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5992604339, 8988906527⟩, ⟨1498151076, 1498151088⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8361252668, 18812818582⟩, ⟨4180626308, 6270939528⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8361252668, 18812818582⟩, ⟨4180626308, 6270939528⟩, ⟨522578285, 522578295⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18812818582), (-8361252668)⟩, ⟨(-6270939528), (-4180626308)⟩, ⟨(-522578295), (-522578285)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9406409291), (-4180626334)⟩, ⟨(-3135469764), (-2090313154)⟩, ⟨(-261289148), (-261289142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨480630547, 1622658774⟩, ⟨(-1184595173), (-233917579)⟩, ⟨(-41793714), 403157350⟩, ⟨(-88619025), 58214387⟩, ⟨(-22887878), 17444997⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨392328220, 1446936745⟩, ⟨(-1103541632), (-203039390)⟩, ⟨(-31314736), 394993271⟩, ⟨(-91551292), 53122974⟩, ⟨(-22153130), 18430373⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨682631364, 682631365⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4356065128, 4356065130⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3440
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨546105091, 819157638⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4332134342, 4387757203⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3441
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (13394033 / 1073741824)

theorem envelope_integral : (∫ s in ((2543 / 20000) : ℝ)..(7629 / 40000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((2543 / 20000) : ℝ)..(7629 / 40000), prawitzNormalCorrection
