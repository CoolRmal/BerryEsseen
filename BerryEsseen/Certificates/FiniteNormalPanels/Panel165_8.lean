...
namespace FiniteNormalPanel165_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (28817 / 160000)
def radius : Rat := (28817 / 800000)

def j0 : Jet := ⟨⟨773550453, 773550454⟩, ⟨154710090, 154710091⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2430180420, 2430180424⟩, ⟨486036082, 486036086⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1375045830, 1375045836⟩, ⟨550018330, 550018336⟩, ⟨55001832, 55001834⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨344, 345⟩, ⟨137, 138⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94343), (-94341)⟩, ⟨137, 138⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-30205), (-30203)⟩, ⟨(-12039), (-12036)⟩, ⟨(-1188), (-1185)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5082851, 5082854⟩, ⟨(-12039), (-12036)⟩, ⟨(-1188), (-1185)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1627289, 1627290⟩, ⟨647060, 647063⟩, ⟨63168, 63172⟩, ⟨(-308), (-303)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-141538288), (-141538286)⟩, ⟨647060, 647063⟩, ⟨63168, 63172⟩, ⟨(-308), (-303)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-45313881), (-45313879)⟩, ⟨(-17918395), (-17918391)⟩, ⟨(-1709470), (-1709466)⟩, ⟨16276, 16280⟩, ⟨762, 767⟩⟩
...
def j19 : Jet := ⟨⟨1386341884, 1386341887⟩, ⟨(-17918395), (-17918391)⟩, ⟨(-1709470), (-1709466)⟩, ⟨16276, 16280⟩, ⟨762, 767⟩⟩
...
def j22 : Jet := ⟨⟨(-35), (-34)⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11800, 11802⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3777, 3779⟩, ⟨1506, 1508⟩, ⟨148, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848400), (-848397)⟩, ⟨1506, 1508⟩, ⟨148, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-271618), (-271616)⟩, ⟨(-108166), (-108163)⟩, ⟨(-10626), (-10621)⟩, ⟨36, 40⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35519776, 35519779⟩, ⟨(-108166), (-108163)⟩, ⟨(-10626), (-10621)⟩, ⟨36, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11371755, 11371757⟩, ⟨4514072, 4514075⟩, ⟨437616, 437620⟩, ⟨(-2736), (-2732)⟩, ⟨(-134), (-129)⟩⟩
...
def j33 : Jet := ⟨⟨(-704456128), (-704456125)⟩, ⟨4514072, 4514075⟩, ⟨437616, 437620⟩, ⟨(-2736), (-2732)⟩, ⟨(-134), (-129)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-225533607), (-225533604)⟩, ⟨(-88768251), (-88768247)⟩, ⟨(-8303165), (-8303159)⟩, ⟨112972, 112977⟩, ⟨5210, 5215⟩⟩
...
def j36 : Jet := ⟨⟨4069433689, 4069433692⟩, ⟨(-88768251), (-88768247)⟩, ⟨(-8303165), (-8303159)⟩, ⟨112972, 112977⟩, ⟨5210, 5215⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨784420618, 784420622⟩, ⟨146745528, 146745533⟩, ⟨(-2994973), (-2994968)⟩, ⟨(-184242), (-184238)⟩, ⟨2272, 2277⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4533000282, 4533000286⟩, ⟨98880217, 98880223⟩, ⟨11405921, 11405931⟩, ⟨324706, 324716⟩, ⟨21799, 21811⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨827894285, 827894291⟩, ⟨172937567, 172937576⟩, ⟨2300611, 2300621⟩, ⟨185602, 185612⟩, ⟨5276, 5289⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-773550454), (-773550453)⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3521416842, 3521416843⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨159584206, 159584209⟩, ⟨66670600, 66670604⟩, ⟨7850285, 7850293⟩, ⟨256820, 256828⟩, ⟨18210, 18221⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4454551502, 4454551505⟩, ⟨66670600, 66670604⟩, ⟨7850285, 7850293⟩, ⟨256820, 256828⟩, ⟨18210, 18221⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4374031666, 4374031668⟩, ⟨32732735, 32732738⟩, ⟨3731715, 3731720⟩, ⟨98161, 98167⟩, ⟨6612, 6620⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3586241224, 3586241228⟩, ⟨(-130720725), (-130720719)⟩, ⟨1880534, 1880540⟩, ⟨(-53941), (-53934)⟩, ⟨1884, 1893⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨34427473767, 34427473774⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value665

def j47 : Jet := ⟨⟨6200603192, 6200603202⟩, ⟨1240120633, 1240120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8951751502, 8951751532⟩, ⟨3580700584, 3580700618⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8951751502, 8951751532⟩, ⟨3580700584, 3580700618⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8951751532), (-8951751502)⟩, ⟨(-3580700618), (-3580700584)⟩, ⟨(-358070063), (-358070056)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4475875766), (-4475875751)⟩, ⟨(-1790350309), (-1790350292)⟩, ⟨(-179035032), (-179035028)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1514859809, 1514859829⟩, ⟨(-631466919), (-631466904)⟩, ⟨68466295, 68466303⟩, ⟨8035041, 8035044⟩, ⟨(-2264353), (-2264351)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1264888023, 1264888042⟩, ⟨(-573372533), (-573372515)⟩, ⟨77050924, 77050936⟩, ⟨4329813, 4329825⟩, ⟨(-2096688), (-2096678)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨618840362, 928260545⟩, ⟨154710090, 154710091⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1944144334, 2916216509⟩, ⟨486036082, 486036086⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨880029329, 1980066004⟩, ⟨440014662, 660022004⟩, ⟨55001832, 55001834⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨220, 497⟩, ⟨110, 166⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94467), (-94189)⟩, ⟨110, 166⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-43552), (-19299)⟩, ⟨(-14496), (-9572)⟩, ⟨(-1197), (-1173)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5069504, 5093758⟩, ⟨(-14496), (-9572)⟩, ⟨(-1197), (-1173)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1038730, 2348325⟩, ⟨512682, 780814⟩, ⟨62140, 64012⟩, ⟨(-370), (-239)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142126847), (-140817251)⟩, ⟨512682, 780814⟩, ⟨62140, 64012⟩, ⟨(-370), (-239)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-65523326), (-28853144)⟩, ⟨(-21736062), (-14066601)⟩, ⟨(-1754838), (-1653819)⟩, ⟨12760, 19789⟩, ⟨730, 794⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1366132439, 1402802622⟩, ⟨(-21736062), (-14066601)⟩, ⟨(-1754838), (-1653819)⟩, ⟨12760, 19789⟩, ⟨730, 794⟩⟩
...
def j70 : Jet := ⟨⟨(-50), (-21)⟩, ⟨(-17), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11785, 11815⟩, ⟨(-17), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2414, 5447⟩, ⟨1199, 1814⟩, ⟨146, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849763), (-846729)⟩, ⟨1199, 1814⟩, ⟨146, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-391758), (-173492)⟩, ⟨(-130341), (-85909)⟩, ⟨(-10732), (-10494)⟩, ⟨28, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35399636, 35617903⟩, ⟨(-130341), (-85909)⟩, ⟨(-10732), (-10494)⟩, ⟨28, 48⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7253307, 16420568⟩, ⟨3566563, 5455921⟩, ⟨428353, 445176⟩, ⟨(-3315), (-2152)⟩, ⟨(-137), (-125)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708574576), (-699407314)⟩, ⟨3566563, 5455921⟩, ⟨428353, 445176⟩, ⟨(-3315), (-2152)⟩, ⟨(-137), (-125)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-326667081), (-143307016)⟩, ⟨(-108158248), (-69138218)⟩, ⟨(-8620928), (-7913022)⟩, ⟨88028, 137842⟩, ⟨4911, 5456⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3968300215, 4151660280⟩, ⟨(-108158248), (-69138218)⟩, ⟨(-8620928), (-7913022)⟩, ⟨88028, 137842⟩, ⟨4911, 5456⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨618388559, 952481331⟩, ⟨139838688, 152379553⟩, ⟨(-3651250), (-2340445)⟩, ⟨(-192810), (-173715)⟩, ⟨1773, 2780⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4443220983, 4648525332⟩, ⟨73993621, 126698166⟩, ⟨9700959, 13551913⟩, ⟨148242, 546049⟩, ⟨10640, 37186⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨639734096, 1030888780⟩, ⟨155319227, 193020761⟩, ⟨(-145938), 5079211⟩, ⟨20801, 381868⟩, ⟨(-9018), 22352⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-928260545), (-618840362)⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3366706751, 3676126934⟩, ⟨(-154710091), (-154710090)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨95288202, 247436501⟩, ⟨46269504, 92658652⟩, ⟨5546762, 11112825⟩, ⟨(-6922), 639846⟩, ⟨(-2999), 51061⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4390255498, 4542403797⟩, ⟨46269504, 92658652⟩, ⟨5546762, 11112825⟩, ⟨(-6922), 639846⟩, ⟨(-2999), 51061⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4342350030, 4416953221⟩, ⟨22495824, 45823791⟩, ⟨2459086, 5437513⟩, ⟨(-60805), 303694⟩, ⟨(-8094), 25199⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3403848773, 3780536518⟩, ⟨(-141470320), (-117195604)⟩, ⟨276978, 3843722⟩, ⟨(-247911), 171358⟩, ⟨(-17868), 23760⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4960482550, 7440723844⟩, ⟨1240120633, 1240120642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5729120953, 12890522211⟩, ⟨2864560466, 4296840742⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5729120953, 12890522211⟩, ⟨2864560466, 4296840742⟩, ⟨358070056, 358070063⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12890522211), (-5729120953)⟩, ⟨(-4296840742), (-2864560466)⟩, ⟨(-358070063), (-358070056)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6445261106), (-2864560476)⟩, ⟨(-2148420371), (-1432280233)⟩, ⟨(-179035032), (-179035028)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨957709909, 2204468601⟩, ⟨(-1102715091), (-319375882)⟩, ⟨(-38640394), 235877038⟩, ⟨(-30454567), 37087212⟩, ⟨(-9554173), 4613841⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨759004545, 1940427826⟩, ⟨(-1043249284), (-279244639)⟩, ⟨(-25235749), 245919587⟩, ⟨(-35690435), 33985201⟩, ⟨(-9719171), 5351292⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨773550453, 773550454⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4374031666, 4374031668⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar665 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3334
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar665 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨618840362, 928260545⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4342350030, 4416953221⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3335
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((28817 / 200000) : ℝ)..(86451 / 400000), prawitzNormalCorrection
      ((194411 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
