...
namespace FiniteNormalPanel85_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (45783 / 400000)
def radius : Rat := (15261 / 400000)

def j0 : Jet := ⟨⟨491591219, 491591220⟩, ⟨163863739, 163863740⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1544379362, 1544379366⟩, ⟨514793118, 514793122⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨555326140, 555326144⟩, ⟨370217424, 370217430⟩, ⟨61702903, 61702905⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨138, 140⟩, ⟨92, 93⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94549), (-94546)⟩, ⟨92, 93⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12225), (-12224)⟩, ⟨(-8139), (-8136)⟩, ⟨(-1351), (-1346)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5100831, 5100833⟩, ⟨(-8139), (-8136)⟩, ⟨(-1351), (-1346)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨659521, 659523⟩, ⟨438628, 438631⟩, ⟨72403, 72406⟩, ⟨(-234), (-231)⟩, ⟨(-20), (-17)⟩⟩
...
def j16 : Jet := ⟨⟨(-142506056), (-142506053)⟩, ⟨438628, 438631⟩, ⟨72403, 72406⟩, ⟨(-234), (-231)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18425598), (-18425596)⟩, ⟨(-12227019), (-12227017)⟩, ⟨(-2000120), (-2000116)⟩, ⟨12510, 12515⟩, ⟨1016, 1020⟩⟩
...
def j19 : Jet := ⟨⟨1413230167, 1413230170⟩, ⟨(-12227019), (-12227017)⟩, ⟨(-2000120), (-2000116)⟩, ⟨12510, 12515⟩, ⟨1016, 1020⟩⟩
...
def j25 : Jet := ⟨⟨1528, 1529⟩, ⟨1016, 1019⟩, ⟨167, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850649), (-850647)⟩, ⟨1016, 1019⟩, ⟨167, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-109987), (-109986)⟩, ⟨(-73194), (-73192)⟩, ⟨(-12113), (-12110)⟩, ⟨27, 30⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35681407, 35681409⟩, ⟨(-73194), (-73192)⟩, ⟨(-12113), (-12110)⟩, ⟨27, 30⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4613496, 4613498⟩, ⟨3066200, 3066202⟩, ⟨504733, 504737⟩, ⟨(-2094), (-2090)⟩, ⟨(-173), (-169)⟩⟩
...
def j33 : Jet := ⟨⟨(-711214387), (-711214384)⟩, ⟨3066200, 3066202⟩, ⟨504733, 504737⟩, ⟨(-2094), (-2090)⟩, ⟨(-173), (-169)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-91957847), (-91957845)⟩, ⟨(-60908782), (-60908778)⟩, ⟨(-9887979), (-9887976)⟩, ⟨87285, 87289⟩, ⟨7047, 7051⟩⟩
...
def j36 : Jet := ⟨⟨4203009449, 4203009451⟩, ⟨(-60908782), (-60908778)⟩, ⟨(-9887979), (-9887976)⟩, ⟨87285, 87289⟩, ⟨7047, 7051⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨508167665, 508167668⟩, ⟨164992642, 164992647⟩, ⟨(-2184727), (-2184724)⟩, ⟨(-235236), (-235232)⟩, ⟨1864, 1868⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4388937091, 4388937094⟩, ⟨63603186, 63603192⟩, ⟨11247106, 11247112⟩, ⟨221470, 221478⟩, ⟨20983, 20992⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨519285889, 519285894⟩, ⟨176127861, 176127870⟩, ⟨1541534, 1541541⟩, ⟨185527, 185536⟩, ⟨3687, 3698⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-491591220), (-491591219)⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3803376076, 3803376077⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨62784607, 62784609⟩, ⟨42589712, 42589716⟩, ⟨7595404, 7595410⟩, ⟨171292, 171298⟩, ⟨16659, 16668⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4357751903, 4357751905⟩, ⟨42589712, 42589716⟩, ⟨7595404, 7595410⟩, ⟨171292, 171298⟩, ⟨16659, 16668⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4326245705, 4326245707⟩, ⟨21140895, 21140898⟩, ⟨3718590, 3718595⟩, ⟨66855, 66860⟩, ⟨6343, 6350⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3831074436, 3831074440⟩, ⟨(-146335929), (-146335924)⟩, ⟨2486390, 2486397⟩, ⟨(-82672), (-82665)⟩, ⟨3065, 3074⟩⟩
...
def j47 : Jet := ⟨⟨4412109844, 4412109855⟩, ⟨1470703275, 1470703285⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4532447381, 4532447405⟩, ⟨3021631574, 3021631604⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4532447381, 4532447405⟩, ⟨3021631574, 3021631604⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4532447405), (-4532447381)⟩, ⟨(-3021631604), (-3021631574)⟩, ⟨(-503605268), (-503605260)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2266223703), (-2266223690)⟩, ⟨(-1510815802), (-1510815787)⟩, ⟨(-251802634), (-251802630)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2533996286, 2533996302⟩, ⟨(-891369222), (-891369207)⟩, ⟨8214355, 8214365⟩, ⟨33875913, 33875917⟩, ⟨(-3219878), (-3219876)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2260303216, 2260303233⟩, ⟨(-881430821), (-881430801)⟩, ⟨39164359, 39164376⟩, ⟨29372352, 29372365⟩, ⟨(-4002588), (-4002576)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨327727479, 655454960⟩, ⟨163863739, 163863740⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1029586240, 2059172488⟩, ⟨514793118, 514793122⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨246811617, 987246478⟩, ⟨246811616, 493623240⟩, ⟨61702903, 61702905⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨61, 248⟩, ⟨61, 124⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94626), (-94438)⟩, ⟨61, 124⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-21751), (-5426)⟩, ⟨(-10873), (-5397)⟩, ⟨(-1357), (-1337)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5091305, 5107631⟩, ⟨(-10873), (-5397)⟩, ⟨(-1357), (-1337)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨292573, 1174047⟩, ⟨290073, 586714⟩, ⟨71581, 72992⟩, ⟨(-313), (-152)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142873004), (-141991529)⟩, ⟨290073, 586714⟩, ⟨71581, 72992⟩, ⟨(-313), (-152)⟩, ⟨(-20), (-17)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-32840965), (-8159586)⟩, ⟨(-16403814), (-8024723)⟩, ⟨(-2031779), (-1955685)⟩, ⟨8208, 16811⟩, ⟨987, 1041⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1398814800, 1423496180⟩, ⟨(-16403814), (-8024723)⟩, ⟨(-2031779), (-1955685)⟩, ⟨8208, 16811⟩, ⟨987, 1041⟩⟩
...
def j72 : Jet := ⟨⟨678, 2720⟩, ⟨675, 1360⟩, ⟨166, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851499), (-849456)⟩, ⟨675, 1360⟩, ⟨166, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-195727), (-48814)⟩, ⟨(-97826), (-48501)⟩, ⟨(-12186), (-12006)⟩, ⟨17, 40⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35595667, 35742581⟩, ⟨(-97826), (-48501)⟩, ⟨(-12186), (-12006)⟩, ⟨17, 40⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2045515, 8215834⟩, ⟨2023028, 4105130⟩, ⟨497332, 510014⟩, ⟨(-2807), (-1375)⟩, ⟨(-176), (-166)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713782368), (-707612048)⟩, ⟨2023028, 4105130⟩, ⟨497332, 510014⟩, ⟨(-2807), (-1375)⟩, ⟨(-176), (-166)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-164070896), (-40663144)⟩, ⟨(-81919195), (-39719532)⟩, ⟨(-10109599), (-9576746)⟩, ⟨56996, 117514⟩, ⟨6780, 7240⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4130896400, 4254304152⟩, ⟨(-81919195), (-39719532)⟩, ⟨(-10109599), (-9576746)⟩, ⟨56996, 117514⟩, ⟨6780, 7240⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨335322802, 682478811⟩, ⟨159796780, 168696023⟩, ⟨(-2940268), (-1430655)⟩, ⟨(-241562), (-226347)⟩, ⟨1219, 2515⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4336019103, 4465554758⟩, ⟨40482447, 88555756⟩, ⟨10138647, 12684750⟩, ⟨62436, 408450⟩, ⟨13358, 31471⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨338527857, 709585497⟩, ⟨164484739, 189467976⟩, ⟨(-759319), 4049561⟩, ⟨70307, 321137⟩, ⟨(-9071), 18149⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-655454960), (-327727479)⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3639512336, 3967239817⟩, ⟨(-163863740), (-163863739)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨26682650, 117232925⟩, ⟨25929262, 62605240⟩, ⟨6048386, 9696265⟩, ⟨(-55912), 463400⟩, ⟨1670, 38151⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4321649946, 4412200221⟩, ⟨25929262, 62605240⟩, ⟨6048386, 9696265⟩, ⟨(-55912), 463400⟩, ⟨1670, 38151⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4308287964, 4353189136⟩, ⟨12791235, 31205837⟩, ⟨2871896, 4814155⟩, ⟨(-62741), 222458⟩, ⟨(-3470), 18515⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3650800136, 4021019040⟩, ⟨(-155245885), (-135547279)⟩, ⟨1243034, 3958794⟩, ⟨(-241627), 95914⟩, ⟨(-11694), 19497⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2941406560, 5882813139⟩, ⟨1470703275, 1470703285⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2014421054, 8057684272⟩, ⟨2014421048, 4028842138⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2014421054, 8057684272⟩, ⟨2014421048, 4028842138⟩, ⟨503605260, 503605268⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8057684272), (-2014421054)⟩, ⟨(-4028842138), (-2014421048)⟩, ⟨(-503605268), (-503605260)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4028842136), (-1007210527)⟩, ⟨(-2014421069), (-1007210524)⟩, ⟨(-251802634), (-251802630)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1681028874, 3397141919⟩, ⟨(-1593323950), (-394217198)⟩, ⟨(-152941661), 275095268⟩, ⟨(-27600354), 86185774⟩, ⟨(-18169747), 7719557⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1428905046, 3180460152⟩, ⟨(-1614489185), (-388144302)⟩, ⟨(-130258662), 318272246⟩, ⟨(-37443230), 86178543⟩, ⟨(-20311891), 8583444⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨491591219, 491591220⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4326245705, 4326245707⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1712
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨327727479, 655454960⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4308287964, 4353189136⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1713
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (173599577 / 4294967296)

theorem envelope_integral : (∫ s in ((15261 / 200000) : ℝ)..(15261 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((15261 / 200000) : ℝ)..(15261 / 100000), prawitzNormalCorrection
