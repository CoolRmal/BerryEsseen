...
namespace FiniteNormalPanel38_16

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (52293 / 400000)
def radius : Rat := (17431 / 400000)

def j0 : Jet := ⟨⟨561491812, 561491813⟩, ⟨187163937, 187163938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1763978551, 1763978555⟩, ⟨587992849, 587992853⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨724480563, 724480568⟩, ⟨482987040, 482987046⟩, ⟨80497840, 80497842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨181, 182⟩, ⟨120, 122⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94506), (-94504)⟩, ⟨120, 122⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-15942), (-15941)⟩, ⟨(-10608), (-10606)⟩, ⟨(-1756), (-1753)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097114, 5097116⟩, ⟨(-10608), (-10606)⟩, ⟨(-1756), (-1753)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨859787, 859789⟩, ⟨571401, 571404⟩, ⟨94041, 94046⟩, ⟨(-397), (-393)⟩, ⟨(-33), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-142305790), (-142305787)⟩, ⟨571401, 571404⟩, ⟨94041, 94046⟩, ⟨(-397), (-393)⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-24004323), (-24004321)⟩, ⟨(-15906498), (-15906495)⟩, ⟨(-2587029), (-2587025)⟩, ⟨21217, 21220⟩, ⟨1711, 1714⟩⟩
...
def j19 : Jet := ⟨⟨1407651442, 1407651445⟩, ⟨(-15906498), (-15906495)⟩, ⟨(-2587029), (-2587025)⟩, ⟨21217, 21220⟩, ⟨1711, 1714⟩⟩
...
def j22 : Jet := ⟨⟨(-19), (-18)⟩, ⟨(-13), (-12)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11816, 11818⟩, ⟨(-13), (-12)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1993, 1994⟩, ⟨1325, 1327⟩, ⟨218, 221⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850184), (-850182)⟩, ⟨1325, 1327⟩, ⟨218, 221⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-143411), (-143409)⟩, ⟨(-95384), (-95382)⟩, ⟨(-15750), (-15746)⟩, ⟨47, 50⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35647983, 35647986⟩, ⟨(-95384), (-95382)⟩, ⟨(-15750), (-15746)⟩, ⟨47, 50⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6013147, 6013148⟩, ⟨3992674, 3992677⟩, ⟨654743, 654746⟩, ⟨(-3553), (-3548)⟩, ⟨(-291), (-288)⟩⟩
...
def j33 : Jet := ⟨⟨(-709814736), (-709814734)⟩, ⟨3992674, 3992677⟩, ⟨654743, 654746⟩, ⟨(-3553), (-3548)⟩, ⟨(-291), (-288)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-119732457), (-119732454)⟩, ⟨(-79148149), (-79148146)⟩, ⟨(-12744173), (-12744168)⟩, ⟨147860, 147864⟩, ⟨11821, 11826⟩⟩
...
def j36 : Jet := ⟨⟨4175234839, 4175234842⟩, ⟨(-79148149), (-79148146)⟩, ⟨(-12744173), (-12744168)⟩, ⟨147860, 147864⟩, ⟨11821, 11826⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨578134076, 578134079⟩, ⟨186178427, 186178433⟩, ⟨(-3240159), (-3240154)⟩, ⟨(-345459), (-345454)⟩, ⟨3606, 3610⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4418133295, 4418133300⟩, ⟨83752668, 83752673⟩, ⟨15073235, 15073243⟩, ⟨384909, 384917⟩, ⟨37822, 37833⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨594713122, 594713126⟩, ⟨202791154, 202791163⟩, ⟨2326404, 2326413⟩, ⟨286656, 286666⟩, ⟨7376, 7386⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-561491813), (-561491812)⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3733475483, 3733475484⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨82348402, 82348405⟩, ⟨56159942, 56159948⟩, ⟨10219248, 10219253⟩, ⟨299070, 299076⟩, ⟨30370, 30379⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4377315698, 4377315701⟩, ⟨56159942, 56159948⟩, ⟨10219248, 10219253⟩, ⟨299070, 299076⟩, ⟨30370, 30379⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4335946006, 4335946008⟩, ⟨27814589, 27814593⟩, ⟨4972119, 4972123⟩, ⟨116226, 116231⟩, ⟨11444, 11451⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3769096943, 3769096947⟩, ⟨(-164771370), (-164771364)⟩, ⟨3110010, 3110015⟩, ⟨(-115642), (-115636)⟩, ⟨4881, 4890⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨29328395106, 29328395112⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value261

def j47 : Jet := ⟨⟨3834174413, 3834174421⟩, ⟨1278058135, 1278058143⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3422818479, 3422818494⟩, ⟨2281878980, 2281879002⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3422818479, 3422818494⟩, ⟨2281878980, 2281879002⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3422818494), (-3422818479)⟩, ⟨(-2281879002), (-2281878980)⟩, ⟨(-380313168), (-380313162)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1711409247), (-1711409239)⟩, ⟨(-1140939501), (-1140939490)⟩, ⟨(-190156584), (-190156581)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2883415197, 2883415208⟩, ⟨(-765966790), (-765966778)⟩, ⟨(-25923251), (-25923245)⟩, ⟨24903883, 24903886⟩, ⟨(-1080037), (-1080035)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2530373494, 2530373507⟩, ⟨(-782801622), (-782801605)⟩, ⟨8724068, 8724082⟩, ⟨22216919, 22216931⟩, ⟨(-1898082), (-1898068)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨374327874, 748655750⟩, ⟨187163937, 187163938⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1175985698, 2351971405⟩, ⟨587992849, 587992853⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨321991360, 1287965451⟩, ⟨321991360, 643982728⟩, ⟨80497840, 80497842⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨80, 323⟩, ⟨80, 162⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94607), (-94363)⟩, ⟨80, 162⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-28371), (-7074)⟩, ⟨(-14181), (-7025)⟩, ⟨(-1768), (-1736)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5084685, 5105983⟩, ⟨(-14181), (-7025)⟩, ⟨(-1768), (-1736)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨381196, 1531172⟩, ⟨376943, 765060⟩, ⟨92641, 95043⟩, ⟨(-532), (-258)⟩, ⟨(-34), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142784381), (-141634404)⟩, ⟨376943, 765060⟩, ⟨92641, 95043⟩, ⟨(-532), (-258)⟩, ⟨(-34), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-42817870), (-10618254)⟩, ⟨(-21380676), (-10388829)⟩, ⟨(-2640913), (-2511348)⟩, ⟨13849, 28572⟩, ⟨1645, 1761⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1388837895, 1421037512⟩, ⟨(-21380676), (-10388829)⟩, ⟨(-2640913), (-2511348)⟩, ⟨13849, 28572⟩, ⟨1645, 1761⟩⟩
...
def j70 : Jet := ⟨⟨(-33), (-8)⟩, ⟨(-17), (-8)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11802, 11828⟩, ⟨(-17), (-8)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨884, 3547⟩, ⟨878, 1774⟩, ⟨217, 222⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851293), (-848629)⟩, ⟨878, 1774⟩, ⟨217, 222⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-255284), (-63621)⟩, ⟨(-127577), (-63089)⟩, ⟨(-15875), (-15572)⟩, ⟨31, 68⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35536110, 35727774⟩, ⟨(-127577), (-63089)⟩, ⟨(-15875), (-15572)⟩, ⟨31, 68⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2664122, 10713968⟩, ⟨2625864, 5352255⟩, ⟨642140, 663727⟩, ⟨(-4771), (-2328)⟩, ⟨(-296), (-278)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713163761), (-705113914)⟩, ⟨2625864, 5352255⟩, ⟨642140, 663727⟩, ⟨(-4771), (-2328)⟩, ⟨(-296), (-278)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-213861998), (-52862006)⟩, ⟨(-106734141), (-51256983)⟩, ⟨(-13121377), (-12213951)⟩, ⟨95923, 199659⟩, ⟨11230, 12246⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4081105298, 4242105290⟩, ⟨(-106734141), (-51256983)⟩, ⟨(-13121377), (-12213951)⟩, ⟨95923, 199659⟩, ⟨11230, 12246⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨380271463, 778175796⟩, ⟨178427437, 191699432⟩, ⟨(-4373268), (-2109879)⟩, ⟨(-357758), (-328163)⟩, ⟨2345, 4877⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4348488029, 4520036296⟩, ⟨52542395, 118213611⟩, ⟨13155114, 17624277⟩, ⟨97491, 738801⟩, ⟨20440, 62789⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨385010127, 818954512⟩, ⟨185302911, 223163367⟩, ⟨(-1254915), 6333341⟩, ⟨58263, 562430⟩, ⟨(-19560), 39010⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-748655750), (-374327874)⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3546311546, 3920639422⟩, ⟨(-187163938), (-187163937)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨34513137, 156156368⟩, ⟨33221904, 85104558⟩, ⟨7516175, 14010660⟩, ⟨(-119966), 872638⟩, ⟨(-4285), 82666⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4329480433, 4451123664⟩, ⟨33221904, 85104558⟩, ⟨7516175, 14010660⟩, ⟨(-119966), 872638⟩, ⟨(-4285), 82666⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4312189335, 4372348405⟩, ⟨16316974, 42382334⟩, ⟨3486165, 6946482⟩, ⟨(-128018), 421386⟩, ⟨(-11872), 41019⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3560531611, 3991276381⟩, ⟨(-177063252), (-149225928)⟩, ⟨1031574, 5630010⟩, ⟨(-419572), 232743⟩, ⟨(-29201), 43023⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2556116270, 5112232557⟩, ⟨1278058135, 1278058143⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1521252651, 6085010646⟩, ⟨1521252650, 3042505332⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1521252651, 6085010646⟩, ⟨1521252650, 3042505332⟩, ⟨380313162, 380313168⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6085010646), (-1521252651)⟩, ⟨(-3042505332), (-1521252650)⟩, ⟨(-380313168), (-380313162)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3042505323), (-760626325)⟩, ⟨(-1521252666), (-760626325)⟩, ⟨(-190156584), (-190156581)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2115001382, 3597887345⟩, ⟨(-1274350965), (-374560646)⟩, ⟨(-126127067), 132043723⟩, ⟨(-4534107), 52505142⟩, ⟨(-7572326), 3193582⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1753337978, 3343485944⟩, ⟨(-1332569063), (-383995488)⟩, ⟨(-103686947), 179959430⟩, ⟨(-11679053), 54097271⟩, ⟨(-9460314), 3488312⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨561491812, 561491813⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4335946006, 4335946008⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar261 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified752
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar261 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨374327874, 748655750⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4312189335, 4372348405⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified753
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((17431 / 200000) : ℝ)..(17431 / 100000), prawitzNormalCorrection
      ((152691 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
