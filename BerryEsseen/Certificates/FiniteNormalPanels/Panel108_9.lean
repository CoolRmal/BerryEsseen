...
namespace FiniteNormalPanel108_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (7491 / 40000)
def radius : Rat := (7491 / 200000)

def j0 : Jet := ⟨⟨804340000, 804340001⟩, ⟨160868000, 160868001⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2526908634, 2526908639⟩, ⟨505381726, 505381731⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1486685882, 1486685889⟩, ⟨594674352, 594674360⟩, ⟨59467435, 59467437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨372, 373⟩, ⟨148, 149⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94315), (-94313)⟩, ⟨148, 149⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-32647), (-32646)⟩, ⟨(-13008), (-13006)⟩, ⟨(-1282), (-1278)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5080409, 5080411⟩, ⟨(-13008), (-13006)⟩, ⟨(-1282), (-1278)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1758563, 1758565⟩, ⟨698922, 698925⟩, ⟨68096, 68101⟩, ⟨(-358), (-353)⟩, ⟨(-18), (-15)⟩⟩
...
def j16 : Jet := ⟨⟨(-141407014), (-141407011)⟩, ⟨698922, 698925⟩, ⟨68096, 68101⟩, ⟨(-358), (-353)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-48947477), (-48947475)⟩, ⟨(-19337062), (-19337059)⟩, ⟨(-1837558), (-1837553)⟩, ⟨18981, 18986⟩, ⟨885, 890⟩⟩
...
def j19 : Jet := ⟨⟨1382708288, 1382708291⟩, ⟨(-19337062), (-19337059)⟩, ⟨(-1837558), (-1837553)⟩, ⟨18981, 18986⟩, ⟨885, 890⟩⟩
...
def j22 : Jet := ⟨⟨(-38), (-37)⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11797, 11799⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4083, 4085⟩, ⟨1627, 1630⟩, ⟨159, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848094), (-848091)⟩, ⟨1627, 1630⟩, ⟨159, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-293565), (-293563)⟩, ⟨(-116863), (-116860)⟩, ⟨(-11463), (-11459)⟩, ⟨43, 46⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35497829, 35497832⟩, ⟨(-116863), (-116860)⟩, ⟨(-11463), (-11459)⟩, ⟨43, 46⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨12287432, 12287434⟩, ⟨4874521, 4874524⟩, ⟨471348, 471352⟩, ⟨(-3193), (-3188)⟩, ⟨(-154), (-149)⟩⟩
...
def j33 : Jet := ⟨⟨(-703540451), (-703540448)⟩, ⟨4874521, 4874524⟩, ⟨471348, 471352⟩, ⟨(-3193), (-3188)⟩, ⟨(-154), (-149)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-243527736), (-243527733)⟩, ⟨(-95723800), (-95723795)⟩, ⟨(-8903037), (-8903033)⟩, ⟨131647, 131652⟩, ⟨6029, 6035⟩⟩
...
def j36 : Jet := ⟨⟨4051439560, 4051439563⟩, ⟨(-95723800), (-95723795)⟩, ⟨(-8903037), (-8903033)⟩, ⟨131647, 131652⟩, ⟨6029, 6035⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨813505032, 813505037⟩, ⟨151324204, 151324210⟩, ⟨(-3356474), (-3356468)⟩, ⟨(-205056), (-205050)⟩, ⟨2753, 2759⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4553133222, 4553133226⟩, ⟨107577363, 107577372⟩, ⟨12547244, 12547253⟩, ⟨384899, 384910⟩, ⟨26387, 26398⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨862403956, 862403963⟩, ⟨180796251, 180796260⟩, ⟨2608593, 2608606⟩, ⟨213525, 213538⟩, ⟨6533, 6548⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-804340001), (-804340000)⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3490627295, 3490627296⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨173165598, 173165602⟩, ⟨72605628, 72605634⟩, ⟨8658181, 8658189⟩, ⟨305364, 305376⟩, ⟨22182, 22193⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4468132894, 4468132898⟩, ⟨72605628, 72605634⟩, ⟨8658181, 8658189⟩, ⟨305364, 305376⟩, ⟨22182, 22193⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4380694540, 4380694543⟩, ⟨35592392, 35592396⟩, ⟨4099781, 4099787⟩, ⟨116383, 116391⟩, ⟨8009, 8017⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3560299969, 3560299973⟩, ⟨(-135152090), (-135152082)⟩, ⟨1998880, 1998887⟩, ⟨(-58971), (-58963)⟩, ⟨2149, 2157⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨33866572784, 33866572791⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value477

def j47 : Jet := ⟨⟨6342362415, 6342362425⟩, ⟨1268472483, 1268472492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨9365743259, 9365743290⟩, ⟨3746297302, 3746297338⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨9365743259, 9365743290⟩, ⟨3746297302, 3746297338⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-9365743290), (-9365743259)⟩, ⟨(-3746297338), (-3746297302)⟩, ⟨(-374629736), (-374629730)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4682871645), (-4682871629)⟩, ⟨(-1873148669), (-1873148651)⟩, ⟨(-187314868), (-187314865)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1443582565, 1443582585⟩, ⟨(-629584491), (-629584475)⟩, ⟨74330757, 74330765⟩, ⟨7499357, 7499361⟩, ⟨(-2438548), (-2438547)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1196653340, 1196653359⟩, ⟨(-567318139), (-567318120)⟩, ⟨82099575, 82099588⟩, ⟨3564730, 3564741⟩, ⟨(-2213456), (-2213448)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨643472000, 965208001⟩, ⟨160868000, 160868001⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2021526907, 3032290366⟩, ⟨505381726, 505381731⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨951478964, 2140827679⟩, ⟨475739480, 713609232⟩, ⟨59467435, 59467437⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨238, 537⟩, ⟨119, 179⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94449), (-94149)⟩, ⟨119, 179⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-47079), (-20857)⟩, ⟨(-15667), (-10338)⟩, ⟨(-1292), (-1265)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5065977, 5092200⟩, ⟨(-15667), (-10338)⟩, ⟨(-1292), (-1265)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1122283, 2538209⟩, ⟨553331, 843780⟩, ⟨66894, 69081⟩, ⟨(-432), (-280)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142043294), (-140627367)⟩, ⟨553331, 843780⟩, ⟨66894, 69081⟩, ⟨(-432), (-280)⟩, ⟨(-18), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-70801521), (-31153667)⟩, ⟨(-23477927), (-15156250)⟩, ⟨(-1890600), (-1772475)⟩, ⟨14854, 23099⟩, ⟨845, 923⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1360854244, 1400502099⟩, ⟨(-23477927), (-15156250)⟩, ⟨(-1890600), (-1772475)⟩, ⟨14854, 23099⟩, ⟨845, 923⟩⟩
...
def j70 : Jet := ⟨⟨(-54), (-23)⟩, ⟨(-18), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11781, 11813⟩, ⟨(-18), (-11)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2609, 5889⟩, ⟨1295, 1961⟩, ⟨159, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849568), (-846287)⟩, ⟨1295, 1961⟩, ⟨159, 163⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-423468), (-187480)⟩, ⟨(-140870), (-92762)⟩, ⟨(-11585), (-11309)⟩, ⟨33, 56⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35367926, 35603915⟩, ⟨(-140870), (-92762)⟩, ⟨(-11585), (-11309)⟩, ⟨33, 56⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7835179, 17746782⟩, ⟨3847372, 5895045⟩, ⟨460517, 480188⟩, ⟨(-3869), (-2508)⟩, ⟨(-158), (-144)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-707992704), (-698081100)⟩, ⟨3847372, 5895045⟩, ⟨460517, 480188⟩, ⟨(-3869), (-2508)⟩, ⟨(-158), (-144)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-352899167), (-154648321)⟩, ⟨(-116780736), (-74385773)⟩, ⟨(-9274576), (-8446707)⟩, ⟨102350, 160851⟩, ⟨5654, 6341⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3942068129, 4140318975⟩, ⟨(-116780736), (-74385773)⟩, ⟨(-9274576), (-8446707)⟩, ⟨102350, 160851⟩, ⟨5654, 6341⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨640517908, 988768652⟩, ⟨143553821, 157661134⟩, ⟨(-4097393), (-2617666)⟩, ⟨(-215473), (-192255)⟩, ⟨2144, 3371⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4455392008, 4679458465⟩, ⟨80046435, 138625359⟩, ⟨10527619, 15116120⟩, ⟨170646, 658275⟩, ⟨11989, 46598⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨664442397, 1077284534⟩, ⟨160853313, 203688894⟩, ⟨(-218742), 5853236⟩, ⟨10308, 458212⟩, ⟨(-11662), 28567⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-965208001), (-643472000)⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3329759295, 3651495296⟩, ⟨(-160868001), (-160868000)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨102790933, 270209734⟩, ⟨49768834, 102180474⟩, ⟨5914478, 12596226⟩, ⟨(-17560), 785042⟩, ⟨(-5379), 65771⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4397758229, 4565177030⟩, ⟨49768834, 102180474⟩, ⟨5914478, 12596226⟩, ⟨(-17560), 785042⟩, ⟨(-5379), 65771⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4346058877, 4428011523⟩, ⟨24136738, 50489629⟩, ⟨2580535, 6157050⟩, ⟨(-80206), 373576⟩, ⟨(-11360), 32665⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3369369064, 3764606837⟩, ⟨(-147138685), (-119856362)⟩, ⟨109521, 4330560⟩, ⟨(-298803), 220954⟩, ⟨(-23652), 30777⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5073889932, 7610834908⟩, ⟨1268472483, 1268472492⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5994075686, 13486670330⟩, ⟨2997037842, 4495556804⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5994075686, 13486670330⟩, ⟨2997037842, 4495556804⟩, ⟨374629730, 374629736⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13486670330), (-5994075686)⟩, ⟨(-4495556804), (-2997037842)⟩, ⟨(-374629736), (-374629730)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6743335165), (-2997037843)⟩, ⟨(-2247778402), (-1498518921)⟩, ⟨(-187314868), (-187314865)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨893498047, 2137510200⟩, ⟨(-1118669581), (-311742473)⟩, ⟨(-38838817), 253761001⟩, ⟨(-35204809), 39300878⟩, ⟨(-10675640), 5453056⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨700942398, 1873561534⟩, ⟨(-1053759269), (-269493755)⟩, ⟨(-25320497), 262904585⟩, ⟨(-40827667), 35880413⟩, ⟨(-10812236), 6334760⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨804340000, 804340001⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4380694540, 4380694543⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar477 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2178
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar477 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨643472000, 965208001⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4346058877, 4428011523⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2179
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((7491 / 50000) : ℝ)..(22473 / 100000), prawitzNormalCorrection
      ((237747 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
