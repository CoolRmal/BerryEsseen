...
namespace FiniteNormalPanel105_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (179 / 1000)
def radius : Rat := (179 / 5000)

def j0 : Jet := ⟨⟨768799145, 768799146⟩, ⟨153759829, 153759830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2415253745, 2415253750⟩, ⟨483050749, 483050753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1358206070, 1358206076⟩, ⟨543282428, 543282434⟩, ⟨54328242, 54328244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨339, 341⟩, ⟨135, 137⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94348), (-94345)⟩, ⟨135, 137⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-29836), (-29834)⟩, ⟨(-11893), (-11889)⟩, ⟨(-1173), (-1170)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5083220, 5083223⟩, ⟨(-11893), (-11889)⟩, ⟨(-1173), (-1170)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1607476, 1607478⟩, ⟨639229, 639233⟩, ⟨62423, 62428⟩, ⟨(-300), (-295)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-141558101), (-141558098)⟩, ⟨639229, 639233⟩, ⟨62423, 62428⟩, ⟨(-300), (-295)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-44765201), (-44765199)⟩, ⟨(-17703937), (-17703933)⟩, ⟨(-1690012), (-1690006)⟩, ⟨15886, 15890⟩, ⟨746, 750⟩⟩
...
def j19 : Jet := ⟨⟨1386890564, 1386890567⟩, ⟨(-17703937), (-17703933)⟩, ⟨(-1690012), (-1690006)⟩, ⟨15886, 15890⟩, ⟨746, 750⟩⟩
...
def j22 : Jet := ⟨⟨(-35), (-33)⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11800, 11803⟩, ⟨(-14), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨3731, 3733⟩, ⟨1487, 1489⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848446), (-848443)⟩, ⟨1487, 1489⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-268306), (-268304)⟩, ⟨(-106853), (-106850)⟩, ⟨(-10499), (-10495)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35523088, 35523091⟩, ⟨(-106853), (-106850)⟩, ⟨(-10499), (-10495)⟩, ⟨35, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨11233536, 11233538⟩, ⟨4459623, 4459627⟩, ⟨432503, 432509⟩, ⟨(-2670), (-2665)⟩, ⟨(-130), (-126)⟩⟩
...
def j33 : Jet := ⟨⟨(-704594347), (-704594344)⟩, ⟨4459623, 4459627⟩, ⟨432503, 432509⟩, ⟨(-2670), (-2665)⟩, ⟨(-130), (-126)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-222815276), (-222815274)⟩, ⟨(-87715836), (-87715832)⟩, ⟨(-8211731), (-8211725)⟩, ⟨110274, 110280⟩, ⟨5090, 5095⟩⟩
...
def j36 : Jet := ⟨⟨4072152020, 4072152022⟩, ⟨(-87715836), (-87715832)⟩, ⟨(-8211731), (-8211725)⟩, ⟨110274, 110280⟩, ⟨5090, 5095⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨779911090, 779911095⟩, ⟨146026496, 146026501⟩, ⟨(-2941515), (-2941509)⟩, ⟨(-181141), (-181137)⟩, ⟨2205, 2210⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4529974316, 4529974320⟩, ⟨97577511, 97577519⟩, ⟨11236808, 11236818⟩, ⟨316135, 316147⟩, ⟨21157, 21168⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨822585356, 822585363⟩, ⟨171735430, 171735439⟩, ⟨2255575, 2255586⟩, ⟨181569, 181579⟩, ⟨5102, 5114⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-768799146), (-768799145)⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3526168150, 3526168151⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨157544079, 157544082⟩, ⟨65782596, 65782602⟩, ⟨7730875, 7730883⟩, ⟨249926, 249936⟩, ⟨17658, 17667⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4452511375, 4452511378⟩, ⟨65782596, 65782602⟩, ⟨7730875, 7730883⟩, ⟨249926, 249936⟩, ⟨17658, 17667⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4373029926, 4373029929⟩, ⟨32304157, 32304161⟩, ⟨3677118, 3677123⟩, ⟨95568, 95574⟩, ⟨6418, 6425⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3590257569, 3590257573⟩, ⟨(-130032761), (-130032754)⟩, ⟨1862424, 1862430⟩, ⟨(-53181), (-53173)⟩, ⟨1847, 1854⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨39042561496, 39042561503⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value468

def j47 : Jet := ⟨⟨6988618498, 6988618510⟩, ⟨1397723699, 1397723710⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11371632225, 11371632265⟩, ⟨4548652888, 4548652932⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11371632225, 11371632265⟩, ⟨4548652888, 4548652932⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11371632265), (-11371632225)⟩, ⟨(-4548652932), (-4548652888)⟩, ⟨(-454865296), (-454865288)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5685816133), (-5685816112)⟩, ⟨(-2274326466), (-2274326444)⟩, ⟨(-227432648), (-227432644)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1142948935, 1142948951⟩, ⟨(-605229067), (-605229052)⟩, ⟨99721436, 99721445⟩, ⟨3763983, 3763987⟩, ⟨(-3138579), (-3138577)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨955416137, 955416152⟩, ⟨(-540527761), (-540527742)⟩, ⟨102178634, 102178647⟩, ⟨(-149331), (-149322)⟩, ⟨(-2686341), (-2686329)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨615039316, 922558976⟩, ⟨153759829, 153759830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1932202996, 2898304502⟩, ⟨483050749, 483050753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨869251884, 1955816752⟩, ⟨434625942, 651938922⟩, ⟨54328242, 54328244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨217, 490⟩, ⟨108, 164⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94470), (-94196)⟩, ⟨108, 164⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-43020), (-19064)⟩, ⟨(-14319), (-9457)⟩, ⟨(-1183), (-1159)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5070036, 5093993⟩, ⟨(-14319), (-9457)⟩, ⟨(-1183), (-1159)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1026116, 2319673⟩, ⟨506537, 771312⟩, ⟨61419, 63246⟩, ⟨(-362), (-233)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142139461), (-140845903)⟩, ⟨506537, 771312⟩, ⟨61419, 63246⟩, ⟨(-362), (-233)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-64726626), (-28505587)⟩, ⟨(-21473025), (-13901557)⟩, ⟨(-1734274), (-1635719)⟩, ⟨12457, 19311⟩, ⟨714, 776⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1366929139, 1403150179⟩, ⟨(-21473025), (-13901557)⟩, ⟨(-1734274), (-1635719)⟩, ⟨12457, 19311⟩, ⟨714, 776⟩⟩
...
def j72 : Jet := ⟨⟨2385, 5381⟩, ⟨1184, 1792⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849792), (-846795)⟩, ⟨1184, 1792⟩, ⟨145, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-386974), (-171381)⟩, ⟨(-128753), (-84873)⟩, ⟨(-10602), (-10370)⟩, ⟨27, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35404420, 35620014⟩, ⟨(-128753), (-84873)⟩, ⟨(-10602), (-10370)⟩, ⟨27, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨7165446, 16220431⟩, ⟨3524092, 5389634⟩, ⟨423468, 439882⟩, ⟨(-3234), (-2101)⟩, ⟨(-134), (-123)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-708662437), (-699607451)⟩, ⟨3524092, 5389634⟩, ⟨423468, 439882⟩, ⟨(-3234), (-2101)⟩, ⟨(-134), (-123)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-322706501), (-141592485)⟩, ⟨(-106855600), (-68341942)⟩, ⟨(-8521748), (-7831119)⟩, ⟨85956, 134521⟩, ⟨4803, 5329⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3972260795, 4153374811⟩, ⟨(-106855600), (-68341942)⟩, ⟨(-8521748), (-7831119)⟩, ⟨85956, 134521⟩, ⟨4803, 5329⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨614948705, 946865530⟩, ⟨139246875, 151556946⟩, ⟨(-3585364), (-2299364)⟩, ⟨(-189449), (-170935)⟩, ⟨1722, 2696⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4441386803, 4643890476⟩, ⟨73081051, 124922741⟩, ⟨9576675, 13323084⟩, ⟨144963, 530290⟩, ⟨10436, 35899⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨635912889, 1023788894⟩, ⟨154457596, 191409816⟩, ⟨(-136107), 4967609⟩, ⟨22115, 371156⟩, ⟨(-8660), 21510⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-922558976), (-615039316)⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3372408320, 3679927980⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨94153266, 244039973⟩, ⟨45737984, 91252498⟩, ⟨5489787, 10898638⟩, ⟨(-5584), 619720⟩, ⟨(-2698), 49084⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4389120562, 4539007269⟩, ⟨45737984, 91252498⟩, ⟨5489787, 10898638⟩, ⟨(-5584), 619720⟩, ⟨(-2698), 49084⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4341788718, 4415301550⟩, ⟨22245722, 45134221⟩, ⟨2439398, 5333565⟩, ⟨(-58207), 294021⟩, ⟨(-7668), 24198⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3409172500, 3783030369⟩, ⟨(-140600457), (-116765034)⟩, ⟨299609, 3773403⟩, ⟨(-240814), 164588⟩, ⟨(-17096), 22817⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5590894799, 8386342219⟩, ⟨1397723699, 1397723710⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7277844625, 16375150489⟩, ⟨3638922310, 5458383524⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7277844625, 16375150489⟩, ⟨3638922310, 5458383524⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16375150489), (-7277844625)⟩, ⟨(-5458383524), (-3638922310)⟩, ⟨(-454865296), (-454865288)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8187575245), (-3638922312)⟩, ⟨(-2729191762), (-1819461155)⟩, ⟨(-227432648), (-227432644)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨638346221, 1840783543⟩, ⟨(-1169706528), (-270420255)⟩, ⟨(-40196977), 337836320⟩, ⟨(-62011751), 49807455⟩, ⟨(-16857179), 10915460⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨506693586, 1621372078⟩, ⟨(-1090543887), (-232003119)⟩, ⟨(-28009412), 337476924⟩, ⟨(-66810600), 45238246⟩, ⟨(-16565866), 12016596⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨768799145, 768799146⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4373029926, 4373029929⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar468 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2114
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar468 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨615039316, 922558976⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4341788718, 4415301550⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2115
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((179 / 1250) : ℝ)..(537 / 2500), prawitzNormalCorrection
      ((274083 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
