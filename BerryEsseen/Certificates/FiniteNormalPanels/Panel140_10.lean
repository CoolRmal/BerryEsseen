...
namespace FiniteNormalPanel140_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (16047 / 160000)
def radius : Rat := (5349 / 160000)

def j0 : Jet := ⟨⟨430758376, 430758377⟩, ⟨143586125, 143586126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1353267349, 1353267353⟩, ⟨451089115, 451089119⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨426390328, 426390332⟩, ⟨284260218, 284260222⟩, ⟨47376702, 47376704⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨106, 107⟩, ⟨71, 72⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94581), (-94579)⟩, ⟨71, 72⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9390), (-9389)⟩, ⟨(-6253), (-6251)⟩, ⟨(-1039), (-1036)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103666, 5103668⟩, ⟨(-6253), (-6251)⟩, ⟨(-1039), (-1036)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨506675, 506676⟩, ⟨337162, 337164⟩, ⟨55779, 55783⟩, ⟨(-138), (-135)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-142658902), (-142658900)⟩, ⟨337162, 337164⟩, ⟨55779, 55783⟩, ⟨(-138), (-135)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14162711), (-14162709)⟩, ⟨(-9408335), (-9408333)⟩, ⟨(-1545784), (-1545780)⟩, ⟨7396, 7399⟩, ⟨603, 608⟩⟩
...
def j19 : Jet := ⟨⟨1417493054, 1417493057⟩, ⟨(-9408335), (-9408333)⟩, ⟨(-1545784), (-1545780)⟩, ⟨7396, 7399⟩, ⟨603, 608⟩⟩
...
def j25 : Jet := ⟨⟨1173, 1175⟩, ⟨781, 783⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851004), (-851001)⟩, ⟨781, 783⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-84485), (-84484)⟩, ⟨(-56247), (-56245)⟩, ⟨(-9325), (-9321)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35706909, 35706911⟩, ⟨(-56247), (-56245)⟩, ⟨(-9325), (-9321)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3544865, 3544866⟩, ⟨2357658, 2357661⟩, ⟨389224, 389227⟩, ⟨(-1238), (-1234)⟩, ⟨(-104), (-99)⟩⟩
...
def j33 : Jet := ⟨⟨(-712283018), (-712283016)⟩, ⟨2357658, 2357661⟩, ⟨389224, 389227⟩, ⟨(-1238), (-1234)⟩, ⟨(-104), (-99)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-70713133), (-70713131)⟩, ⟨(-46908029), (-46908026)⟩, ⟨(-7662335), (-7662331)⟩, ⟨51643, 51646⟩, ⟨4200, 4204⟩⟩
...
def j36 : Jet := ⟨⟨4224254163, 4224254165⟩, ⟨(-46908029), (-46908026)⟩, ⟨(-7662335), (-7662331)⟩, ⟨51643, 51646⟩, ⟨4200, 4204⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨446626699, 446626702⟩, ⟨145911167, 145911171⟩, ⟨(-1475182), (-1475179)⟩, ⟨(-160020), (-160017)⟩, ⟨965, 970⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4366864150, 4366864153⟩, ⟨48491631, 48491636⟩, ⟨8459481, 8459488⟩, ⟨128505, 128512⟩, ⟨11829, 11838⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨454103136, 454103140⟩, ⟨153396255, 153396261⟩, ⟨1027196, 1027203⟩, ⟨121398, 121405⟩, ⟨1863, 1874⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-430758377), (-430758376)⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3864208919, 3864208920⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨48011927, 48011929⟩, ⟨32436902, 32436906⟩, ⟨5695808, 5695814⟩, ⟨99042, 99048⟩, ⟨9307, 9318⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4342979223, 4342979225⟩, ⟨32436902, 32436906⟩, ⟨5695808, 5695814⟩, ⟨99042, 99048⟩, ⟨9307, 9318⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4318906543, 4318906545⟩, ⟨16128553, 16128556⟩, ⟨2802002, 2802007⟩, ⟨38781, 38786⟩, ⟨3573, 3581⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3885747209, 3885747212⟩, ⟨(-129875487), (-129875480)⟩, ⟨1981780, 1981787⟩, ⟨(-58784), (-58777)⟩, ⟨1917, 1926⟩⟩
...
def j47 : Jet := ⟨⟨4994649831, 4994649844⟩, ⟨1664883273, 1664883286⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5808315923, 5808315954⟩, ⟨3872210606, 3872210648⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5808315923, 5808315954⟩, ⟨3872210606, 3872210648⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5808315954), (-5808315923)⟩, ⟨(-3872210648), (-3872210606)⟩, ⟨(-645368443), (-645368432)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2904157977), (-2904157961)⟩, ⟨(-1936105324), (-1936105303)⟩, ⟨(-322684222), (-322684216)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2184237871, 2184237889⟩, ⟨(-984620910), (-984620890)⟩, ⟨57822502, 57822515⟩, ⟨40628385, 40628390⟩, ⟨(-6750789), (-6750787)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1976125922, 1976125941⟩, ⟨(-956856394), (-956856369)⟩, ⟨83095024, 83095045⟩, ⟨34524638, 34524652⟩, ⟨(-7295015), (-7295001)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨287172250, 574344502⟩, ⟨143586125, 143586126⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨902178230, 1804356469⟩, ⟨451089115, 451089119⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨189506811, 758027255⟩, ⟨189506810, 379013630⟩, ⟨47376702, 47376704⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-16704), (-4169)⟩, ⟨(-8350), (-4152)⟩, ⟨(-1042), (-1030)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096352, 5108888⟩, ⟨(-8350), (-4152)⟩, ⟨(-1042), (-1030)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨224866, 901678⟩, ⟨223392, 450656⟩, ⟨55295, 56127⟩, ⟨(-185), (-89)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142940711), (-142263898)⟩, ⟨223392, 450656⟩, ⟨55295, 56127⟩, ⟨(-185), (-89)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-25227889), (-6277108)⟩, ⟨(-12604089), (-6197570)⟩, ⟨(-1564449), (-1519602)⟩, ⟨4870, 9922⟩, ⟨589, 617⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1406427876, 1425378658⟩, ⟨(-12604089), (-6197570)⟩, ⟨(-1564449), (-1519602)⟩, ⟨4870, 9922⟩, ⟨589, 617⟩⟩
...
def j72 : Jet := ⟨⟨521, 2089⟩, ⟨519, 1045⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851656), (-850087)⟩, ⟨519, 1045⟩, ⟨128, 131⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-150311), (-37508)⟩, ⟨(-75134), (-37323)⟩, ⟨(-9368), (-9260)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35641083, 35753887⟩, ⟨(-75134), (-37323)⟩, ⟨(-9368), (-9260)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1572591, 6310275⟩, ⟨1559330, 3153492⟩, ⟨384862, 392339⟩, ⟨(-1656), (-814)⟩, ⟨(-105), (-98)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714255292), (-709517607)⟩, ⟨1559330, 3153492⟩, ⟨384862, 392339⟩, ⟨(-1656), (-814)⟩, ⟨(-105), (-98)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-126060327), (-31306040)⟩, ⟨(-62961362), (-30749473)⟩, ⟨(-7792988), (-7478980)⟩, ⟨33888, 69374⟩, ⟨4079, 4289⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4168906969, 4263661256⟩, ⟨(-62961362), (-30749473)⟩, ⟨(-7792988), (-7478980)⟩, ⟨33888, 69374⟩, ⟨4079, 4289⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨295426838, 598815085⟩, ⟨142418321, 148401944⟩, ⟨(-1981015), (-970113)⟩, ⟨(-163288), (-155430)⟩, ⟨634, 1303⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4326503201, 4424839463⟩, ⟨31202687, 66826611⟩, ⟨7814245, 9280664⟩, ⟨39091, 229916⟩, ⟨8448, 16337⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨297596016, 616922188⟩, ⟨145610289, 162206489⟩, ⟨(-468760), 2625726⟩, ⟨62753, 189109⟩, ⟨(-4307), 8672⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-574344502), (-287172250)⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3720622794, 4007795046⟩, ⟨(-143586126), (-143586125)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨20620270, 88613710⟩, ⟨20178520, 46598158⟩, ⟨4801894, 6880307⟩, ⟨(-26712), 252658⟩, ⟨2729, 18384⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4315587566, 4383581006⟩, ⟨20178520, 46598158⟩, ⟨4801894, 6880307⟩, ⟨(-26712), 252658⟩, ⟨2729, 18384⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305265085, 4339047944⟩, ⟨9986762, 23243350⟩, ⟨2314300, 3420343⟩, ⟨(-31791), 120659⟩, ⟨(-649), 8721⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3729543511, 4048928352⟩, ⟨(-136408516), (-122241150)⟩, ⟨1227765, 2857782⟩, ⟨(-144013), 35223⟩, ⟨(-4640), 9201⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3329766546, 6659533118⟩, ⟨1664883273, 1664883286⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2581473731, 10325895006⟩, ⟨2581473730, 5162947524⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2581473731, 10325895006⟩, ⟨2581473730, 5162947524⟩, ⟨645368432, 645368443⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10325895006), (-2581473731)⟩, ⟨(-5162947524), (-2581473730)⟩, ⟨(-645368443), (-645368432)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5162947503), (-1290736865)⟩, ⟨(-2581473762), (-1290736865)⟩, ⟨(-322684222), (-322684216)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1290915356, 3180126091⟩, ⟨(-1911402695), (-387949878)⟩, ⟨(-180631390), 477433192⟩, ⟨(-76221819), 131926048⟩, ⟨(-37758376), 18238697⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1120968952, 2997951278⟩, ⟨(-1902908285), (-373618426)⟩, ⟨(-158873197), 512905536⟩, ⟨(-88397180), 130020661⟩, ⟨(-39924657), 20003277⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨430758376, 430758377⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4318906543, 4318906545⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2816
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨287172250, 574344502⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305265085, 4339047944⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2817
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (33562049 / 1073741824)

theorem envelope_integral : (∫ s in ((5349 / 80000) : ℝ)..(5349 / 40000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((5349 / 80000) : ℝ)..(5349 / 40000), prawitzNormalCorrection
