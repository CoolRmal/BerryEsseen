...
namespace FiniteNormalPanel5_16
...
def j2 : Jet := ⟨⟨716210441, 716210445⟩, ⟨716210441, 716210445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨119432200, 119432202⟩, ⟨238864400, 238864404⟩, ⟨119432200, 119432202⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨29, 30⟩, ⟨59, 60⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94658), (-94656)⟩, ⟨59, 60⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-2633), (-2632)⟩, ⟨(-5264), (-5262)⟩, ⟨(-2630), (-2627)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110423, 5110425⟩, ⟨(-5264), (-5262)⟩, ⟨(-2630), (-2627)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨142107, 142109⟩, ⟨284068, 284071⟩, ⟨141740, 141744⟩, ⟨(-294), (-291)⟩, ⟨(-74), (-71)⟩⟩
...
def j16 : Jet := ⟨⟨(-143023470), (-143023467)⟩, ⟨284068, 284071⟩, ⟨141740, 141744⟩, ⟨(-294), (-291)⟩, ⟨(-74), (-71)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-3977122), (-3977121)⟩, ⟨(-7946345), (-7946343)⟩, ⟨(-3957383), (-3957380)⟩, ⟨15772, 15776⟩, ⟨3921, 3925⟩⟩
...
def j19 : Jet := ⟨⟨1427678643, 1427678645⟩, ⟨(-7946345), (-7946343)⟩, ⟨(-3957383), (-3957380)⟩, ⟨15772, 15776⟩, ⟨3921, 3925⟩⟩
...
def j22 : Jet := ⟨⟨(-4), (-2)⟩, ⟨(-7), (-5)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11831, 11834⟩, ⟨(-7), (-5)⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨328, 330⟩, ⟨656, 659⟩, ⟨326, 330⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851849), (-851846)⟩, ⟨656, 659⟩, ⟨326, 330⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-23688), (-23687)⟩, ⟨(-47358), (-47356)⟩, ⟨(-23643), (-23640)⟩, ⟨35, 38⟩, ⟨7, 10⟩⟩
...
def j30 : Jet := ⟨⟨35767706, 35767708⟩, ⟨(-47358), (-47356)⟩, ⟨(-23643), (-23640)⟩, ⟨35, 38⟩, ⟨7, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨994609, 994610⟩, ⟨1987902, 1987904⟩, ⟨991317, 991320⟩, ⟨(-2632), (-2628)⟩, ⟨(-657), (-653)⟩⟩
...
def j33 : Jet := ⟨⟨(-714833274), (-714833272)⟩, ⟨1987902, 1987904⟩, ⟨991317, 991320⟩, ⟨(-2632), (-2628)⟩, ⟨(-657), (-653)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-19877710), (-19877709)⟩, ⟨(-39700141), (-39700139)⟩, ⟨(-19739587), (-19739584)⟩, ⟨110336, 110339⟩, ⟨27400, 27403⟩⟩
...
def j36 : Jet := ⟨⟨4275089586, 4275089587⟩, ⟨(-39700141), (-39700139)⟩, ⟨(-19739587), (-19739584)⟩, ⟨110336, 110339⟩, ⟨27400, 27403⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨238073605, 238073608⟩, ⟨236748506, 236748510⟩, ⟨(-1985016), (-1985013)⟩, ⟨(-657287), (-657284)⟩, ⟨3283, 3286⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4314937429, 4314937431⟩, ⟨40070181, 40070185⟩, ⟨20295682, 20295688⟩, ⟨262122, 262129⟩, ⟨67451, 67459⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨239180566, 239180570⟩, ⟨240070428, 240070434⟩, ⟨1339520, 1339527⟩, ⟨454409, 454418⟩, ⟨5970, 5980⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-227976865), (-227976864)⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4066990431, 4066990432⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨13319622, 13319623⟩, ⟨26738354, 26738358⟩, ⟨13568107, 13568112⟩, ⟨200356, 200360⟩, ⟨51879, 51888⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4308286918, 4308286919⟩, ⟨26738354, 26738358⟩, ⟨13568107, 13568112⟩, ⟨200356, 200360⟩, ⟨51879, 51888⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4301621951, 4301621953⟩, ⟨13348494, 13348497⟩, ⟨6752847, 6752851⟩, ⟨79067, 79071⟩, ⟨20352, 20359⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4073291856, 4073291860⟩, ⟨(-215690140), (-215690134)⟩, ⟨5685866, 5685872⟩, ⟨(-283572), (-283567)⟩, ⟨15073, 15083⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨17151824760, 17151824766⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value79

def j47 : Jet := ⟨⟨910418857, 910418863⟩, ⟨910418857, 910418863⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨192984588, 192984591⟩, ⟨385969176, 385969182⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨192984588, 192984591⟩, ⟨385969176, 385969182⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-192984591), (-192984588)⟩, ⟨(-385969182), (-385969176)⟩, ⟨(-192984591), (-192984588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-96492296), (-96492294)⟩, ⟨(-192984591), (-192984588)⟩, ⟨(-96492296), (-96492294)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4199550843, 4199550846⟩, ⟨(-188697270), (-188697266)⟩, ⟨(-90109295), (-90109291)⟩, ⟨4175846, 4175847⟩, ⟨965305, 965307⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3982800116, 3982800124⟩, ⟨(-389856466), (-389856454)⟩, ⟨(-70422711), (-70422698)⟩, ⟨7958462, 7958472⟩, ⟨613678, 613695⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 455953729⟩, ⟨227976864, 227976865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1432420886⟩, ⟨716210441, 716210445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 477728806⟩, ⟨0, 477728808⟩, ⟨119432200, 119432202⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 120⟩, ⟨0, 120⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94566)⟩, ⟨0, 120⟩, ⟨29, 30⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-10533), 0⟩, ⟨(-10533), 14⟩, ⟨(-2634), (-2611)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5102523, 5113057⟩, ⟨(-10533), 14⟩, ⟨(-2634), (-2611)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 568725⟩, ⟨(-1172), 568727⟩, ⟨140423, 142184⟩, ⟨(-586), 2⟩, ⟨(-74), (-70)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142596851)⟩, ⟨(-1172), 568727⟩, ⟨140423, 142184⟩, ⟨(-586), 2⟩, ⟨(-74), (-70)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-15924294), 0⟩, ⟨(-15924425), 63260⟩, ⟨(-3981205), (-3886182)⟩, ⟨(-99), 31632⟩, ⟨3829, 3955⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1415731471, 1431655766⟩, ⟨(-15924425), 63260⟩, ⟨(-3981205), (-3886182)⟩, ⟨(-99), 31632⟩, ⟨3829, 3955⟩⟩
...
def j70 : Jet := ⟨⟨(-13), 0⟩, ⟨(-13), 0⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11822, 11836⟩, ⟨(-13), 0⟩, ⟨(-4), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 1317⟩, ⟨(-2), 1317⟩, ⟨325, 330⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-850859)⟩, ⟨(-2), 1317⟩, ⟨325, 330⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-94788), 0⟩, ⟨(-94789), 147⟩, ⟨(-23698), (-23476)⟩, ⟨(-2), 74⟩, ⟨7, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35696606, 35791395⟩, ⟨(-94789), 147⟩, ⟨(-23698), (-23476)⟩, ⟨(-2), 74⟩, ⟨7, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 3981074⟩, ⟨(-10544), 3981091⟩, ⟨979452, 995286⟩, ⟨(-5273), 14⟩, ⟨(-660), (-641)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-711846808)⟩, ⟨(-10544), 3981091⟩, ⟨979452, 995286⟩, ⟨(-5273), 14⟩, ⟨(-660), (-641)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-79621468), 0⟩, ⟨(-79622642), 442817⟩, ⟨(-19906541), (-19241140)⟩, ⟨(-881), 221413⟩, ⟨26575, 27679⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4215345828, 4294967296⟩, ⟨(-79622642), 442817⟩, ⟨(-19906541), (-19241140)⟩, ⟨(-881), 221413⟩, ⟨26575, 27679⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 477473629⟩, ⟨230770367, 238757914⟩, ⟨(-3983268), 10549⟩, ⟨(-663923), (-637493)⟩, ⟨(-17), 6595⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4376092693⟩, ⟨(-459705), 82658951⟩, ⟨19232617, 22226978⟩, ⟨(-234364), 811105⟩, ⟨49351, 93234⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 486492380⟩, ⟨230719261, 252456925⟩, ⟨(-4084062), 7076759⟩, ⟨254196, 688707⟩, ⟨(-46439), 62302⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-455953729), 0⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3839013567, 4294967296⟩, ⟨(-227976865), (-227976864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 55105155⟩, ⟨0, 57191762⟩, ⟨11468687, 16442519⟩, ⟨(-480120), 987962⟩, ⟨10058, 106739⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4350072451⟩, ⟨0, 57191762⟩, ⟨11468687, 16442519⟩, ⟨(-480120), 987962⟩, ⟨10058, 106739⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4322432060⟩, ⟨0, 28595881⟩, ⟨5603316, 8221260⟩, ⟨(-294798), 493981⟩, ⟨(-6129), 51678⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3839013567, 4322432060⟩, ⟨(-229434695), (-199380983)⟩, ⟨3490597, 8221260⟩, ⟨(-731183), 196557⟩, ⟨(-32350), 67326⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1820837721⟩, ⟨910418857, 910418863⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 771938359⟩, ⟨0, 771938362⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 771938359⟩, ⟨0, 771938362⟩, ⟨192984588, 192984591⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-771938359), 0⟩, ⟨(-771938362), 0⟩, ⟨(-192984591), (-192984588)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-385969180), 0⟩, ⟨(-385969181), 0⟩, ⟨(-96492296), (-96492294)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3925832726, 4294967296⟩, ⟨(-385969181), 0⟩, ⟨(-96492296), (-70856534)⟩, ⟨0, 8671324⟩, ⟨601131, 1083916⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3509066323, 4322432060⟩, ⟨(-617872010), (-182245017)⟩, ⟨(-93918736), (-34494891)⟩, ⟨1819311, 14077895⟩, ⟨(-160620), 1166297⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4301621951, 4301621953⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar79 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified104
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar79 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4322432060⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified105
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1327 / 12500), prawitzNormalCorrection
      ((282381 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
