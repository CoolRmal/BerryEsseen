...
namespace FiniteNormalPanel128_18
...
def j2 : Jet := ⟨⟨1519079915, 1519079919⟩, ⟨506359971, 506359975⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨537280875, 537280879⟩, ⟨358187248, 358187254⟩, ⟨59697874, 59697876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨134, 135⟩, ⟨89, 90⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94553), (-94551)⟩, ⟨89, 90⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11829), (-11827)⟩, ⟨(-7875), (-7873)⟩, ⟨(-1307), (-1304)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101227, 5101230⟩, ⟨(-7875), (-7873)⟩, ⟨(-1307), (-1304)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨638140, 638141⟩, ⟨424440, 424444⟩, ⟨70083, 70086⟩, ⟨(-219), (-216)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-142527437), (-142527435)⟩, ⟨424440, 424444⟩, ⟨70083, 70086⟩, ⟨(-219), (-216)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17829535), (-17829533)⟩, ⟨(-11833262), (-11833258)⟩, ⟨(-1936896), (-1936893)⟩, ⟨11715, 11718⟩, ⟨952, 955⟩⟩
...
def j19 : Jet := ⟨⟨1413826230, 1413826233⟩, ⟨(-11833262), (-11833258)⟩, ⟨(-1936896), (-1936893)⟩, ⟨11715, 11718⟩, ⟨952, 955⟩⟩
...
def j22 : Jet := ⟨⟨(-14), (-13)⟩, ⟨(-10), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11821, 11823⟩, ⟨(-10), (-8)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1478, 1480⟩, ⟨983, 986⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850699), (-850696)⟩, ⟨983, 986⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-106419), (-106418)⟩, ⟨(-70824), (-70821)⟩, ⟨(-11724), (-11720)⟩, ⟨25, 28⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35684975, 35684977⟩, ⟨(-70824), (-70821)⟩, ⟨(-11724), (-11720)⟩, ⟨25, 28⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4464028, 4464029⟩, ⟨2967158, 2967160⟩, ⟨488629, 488632⟩, ⟨(-1960), (-1957)⟩, ⟨(-161), (-158)⟩⟩
...
def j33 : Jet := ⟨⟨(-711363855), (-711363853)⟩, ⟨2967158, 2967160⟩, ⟨488629, 488632⟩, ⟨(-1960), (-1957)⟩, ⟨(-161), (-158)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-88988384), (-88988382)⟩, ⟨(-58954413), (-58954409)⟩, ⟨(-9579023), (-9579018)⟩, ⟨81745, 81750⟩, ⟨6606, 6610⟩⟩
...
def j36 : Jet := ⟨⟨4205978912, 4205978914⟩, ⟨(-58954413), (-58954409)⟩, ⟨(-9579023), (-9579018)⟩, ⟨81745, 81750⟩, ⟨6606, 6610⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨500053872, 500053876⟩, ⟨162499336, 162499341⟩, ⟨(-2080154), (-2080151)⟩, ⟨(-224210), (-224207)⟩, ⟨1717, 1720⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4385838457, 4385838460⟩, ⟨61475465, 61475471⟩, ⟨10850332, 10850341⟩, ⟨206848, 206858⟩, ⟨19521, 19530⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨510633807, 510633812⟩, ⟨173094887, 173094894⟩, ⟨1465027, 1465036⟩, ⟨175873, 175883⟩, ⟨3385, 3394⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-483538156), (-483538155)⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3811429140, 3811429141⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨60709865, 60709867⟩, ⟨41158916, 41158920⟩, ⟨7324390, 7324396⟩, ⟨159904, 159910⟩, ⟨15477, 15486⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4355677161, 4355677163⟩, ⟨41158916, 41158920⟩, ⟨7324390, 7324396⟩, ⟨159904, 159910⟩, ⟨15477, 15486⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4325215712, 4325215714⟩, ⟨20435535, 20435538⟩, ⟨3588306, 3588311⟩, ⟨62438, 62443⟩, ⟨5899, 5906⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3838272113, 3838272117⟩, ⟨(-144179683), (-144179677)⟩, ⟨2417430, 2417436⟩, ⟨(-79253), (-79246)⟩, ⟨2890, 2899⟩⟩
...
def j47 : Jet := ⟨⟨3752697584, 3752697593⟩, ⟨1250899194, 1250899203⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3278893222, 3278893239⟩, ⟨2185928812, 2185928836⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3278893222, 3278893239⟩, ⟨2185928812, 2185928836⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3278893239), (-3278893222)⟩, ⟨(-2185928836), (-2185928812)⟩, ⟨(-364321475), (-364321468)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1639446620), (-1639446611)⟩, ⟨(-1092964418), (-1092964406)⟩, ⟨(-182160738), (-182160734)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2932134126, 2932134139⟩, ⟨(-746156621), (-746156608)⟩, ⟨(-29420111), (-29420104)⟩, ⟨23593194, 23593197⟩, ⟨(-877082), (-877081)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2620352582, 2620352598⟩, ⟨(-765245950), (-765245931)⟩, ⟨406626, 406643⟩, ⟨21598000, 21598013⟩, ⟨(-1576652), (-1576638)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨322358770, 644717541⟩, ⟨161179385, 161179386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1012719943, 2025439891⟩, ⟨506359971, 506359975⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨238791499, 955166005⟩, ⟨238791498, 477583006⟩, ⟨59697874, 59697876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨59, 240⟩, ⟨59, 120⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94628), (-94446)⟩, ⟨59, 120⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-21045), (-5251)⟩, ⟨(-10520), (-5224)⟩, ⟨(-1313), (-1294)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092011, 5107806⟩, ⟨(-10520), (-5224)⟩, ⟨(-1313), (-1294)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨283105, 1135935⟩, ⟨280765, 567678⟩, ⟨69313, 70635⟩, ⟨(-294), (-142)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142882472), (-142029641)⟩, ⟨280765, 567678⟩, ⟨69313, 70635⟩, ⟨(-294), (-142)⟩, ⟨(-19), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-31775907), (-7896560)⟩, ⟨(-15872345), (-7770313)⟩, ⟨(-1966533), (-1895307)⟩, ⟨7689, 15739⟩, ⟨925, 975⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1399879858, 1423759206⟩, ⟨(-15872345), (-7770313)⟩, ⟨(-1966533), (-1895307)⟩, ⟨7689, 15739⟩, ⟨925, 975⟩⟩
...
def j70 : Jet := ⟨⟨(-25), (-5)⟩, ⟨(-13), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11810, 11831⟩, ⟨(-13), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨656, 2632⟩, ⟨653, 1316⟩, ⟨161, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851521), (-849544)⟩, ⟨653, 1316⟩, ⟨161, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-189372), (-47232)⟩, ⟨(-94650), (-46939)⟩, ⟨(-11792), (-11624)⟩, ⟨16, 38⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35602022, 35744163⟩, ⟨(-94650), (-46939)⟩, ⟨(-11792), (-11624)⟩, ⟨16, 38⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1979400, 7949213⟩, ⟨1958350, 3971998⟩, ⟨481702, 493571⟩, ⟨(-2628), (-1289)⟩, ⟨(-164), (-155)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713848483), (-707878669)⟩, ⟨1958350, 3971998⟩, ⟨481702, 493571⟩, ⟨(-2628), (-1289)⟩, ⟨(-164), (-155)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-158754132), (-39356622)⟩, ⟨(-79268187), (-38473281)⟩, ⟨(-9786473), (-9287717)⟩, ⟨53416, 110022⟩, ⟨6365, 6782⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4136213164, 4255610674⟩, ⟨(-79268187), (-38473281)⟩, ⟨(-9786473), (-9287717)⟩, ⟨53416, 110022⟩, ⟨6365, 6782⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨330080802, 671422736⟩, ⟨157555248, 166023506⟩, ⟨(-2798675), (-1362987)⟩, ⟨(-230034), (-216026)⟩, ⟨1124, 2316⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4334687894, 4459814653⟩, ⟨39188186, 85469828⟩, ⟨9814584, 12190111⟩, ⟨58954, 379864⟩, ⟨12633, 28948⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨333133446, 697192959⟩, ⟨162024072, 185757050⟩, ⟨(-714247), 3833929⟩, ⟨70007, 300139⟩, ⟨(-8256), 16530⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-644717541), (-322358770)⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3650249755, 3972608526⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨25839054, 113173859⟩, ⟨25134364, 60307100⟩, ⟨5880337, 9278689⟩, ⟨(-50924), 429078⟩, ⟨1960, 34753⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4320806350, 4408141155⟩, ⟨25134364, 60307100⟩, ⟨5880337, 9278689⟩, ⟨(-50924), 429078⟩, ⟨1960, 34753⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307867449, 4351186287⟩, ⟨12404809, 30063254⟩, ⟨2798323, 4607592⟩, ⟨(-57542), 205839⟩, ⟨(-2924), 16818⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3661213466, 4024608001⟩, ⟨(-152746422), (-133856638)⟩, ⟨1250067, 3796249⟩, ⟨(-226136), 85376⟩, ⟨(-10430), 17716⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2501798389, 5003596788⟩, ⟨1250899194, 1250899203⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1457285876, 5829143529⟩, ⟨1457285874, 2914571780⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1457285876, 5829143529⟩, ⟨1457285874, 2914571780⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5829143529), (-1457285876)⟩, ⟨(-2914571780), (-1457285874)⟩, ⟨(-364321475), (-364321468)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2914571765), (-728642938)⟩, ⟨(-1457285890), (-728642937)⟩, ⟨(-182160738), (-182160734)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2178948277, 3624779783⟩, ⟨(-1229890723), (-369659455)⟩, ⟨(-122379905), 116236597⟩, ⟨(-2694245), 48616445⟩, ⟨(-6588849), 2823766⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1857428525, 3396607404⟩, ⟨(-1281383492), (-383022442)⟩, ⟨(-102521374), 155863519⟩, ⟨(-7936422), 49872930⟩, ⟨(-8044514), 2924283⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4325215712, 4325215714⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2586
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307867449, 4351186287⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2587
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (196724635 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((15011 / 200000) : ℝ)..(15011 / 100000), prawitzNormalCorrection
