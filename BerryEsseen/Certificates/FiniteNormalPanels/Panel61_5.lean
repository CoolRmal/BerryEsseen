...
namespace FiniteNormalPanel61_5

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (122269 / 400000)
def radius : Rat := (17467 / 400000)

def j0 : Jet := ⟨⟨1312853390, 1312853391⟩, ⟨187550484, 187550485⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4124450565, 4124450569⟩, ⟨589207222, 589207226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3960703607, 3960703616⟩, ⟨1131629598, 1131629608⟩, ⟨80830685, 80830687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨991, 993⟩, ⟨283, 284⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93696), (-93693)⟩, ⟨283, 284⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-86404), (-86401)⟩, ⟨(-24427), (-24424)⟩, ⟨(-1672), (-1668)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5026652, 5026656⟩, ⟨(-24427), (-24424)⟩, ⟨(-1672), (-1668)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4635443, 4635448⟩, ⟨1301886, 1301891⟩, ⟨86622, 86628⟩, ⟨(-892), (-886)⟩, ⟨(-30), (-26)⟩⟩
...
def j16 : Jet := ⟨⟨(-138530134), (-138530128)⟩, ⟨1301886, 1301891⟩, ⟨86622, 86628⟩, ⟨(-892), (-886)⟩, ⟨(-30), (-26)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-127748774), (-127748767)⟩, ⟨(-35299086), (-35299078)⟩, ⟨(-2184220), (-2184210)⟩, ⟨46500, 46510⟩, ⟨1366, 1375⟩⟩
...
def j19 : Jet := ⟨⟨1303906991, 1303906999⟩, ⟨(-35299086), (-35299078)⟩, ⟨(-2184220), (-2184210)⟩, ⟨46500, 46510⟩, ⟨1366, 1375⟩⟩
...
def j25 : Jet := ⟨⟨10821, 10825⟩, ⟨3064, 3068⟩, ⟨209, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841356), (-841351)⟩, ⟨3064, 3068⟩, ⟨209, 213⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-775876), (-775871)⟩, ⟨(-218854), (-218847)⟩, ⟨(-14836), (-14828)⟩, ⟨110, 115⟩, ⟨1, 5⟩⟩
...
def j30 : Jet := ⟨⟨35015518, 35015524⟩, ⟨(-218854), (-218847)⟩, ⟨(-14836), (-14828)⟩, ⟨110, 115⟩, ⟨1, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨32290371, 32290377⟩, ⟨9023998, 9024008⟩, ⟨587641, 587654⟩, ⟨(-7927), (-7917)⟩, ⟨(-252), (-243)⟩⟩
...
def j33 : Jet := ⟨⟨(-683537512), (-683537505)⟩, ⟨9023998, 9024008⟩, ⟨587641, 587654⟩, ⟨(-7927), (-7917)⟩, ⟨(-252), (-243)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-630339956), (-630339947)⟩, ⟨(-171775443), (-171775428)⟩, ⟨(-9944550), (-9944532)⟩, ⟨317349, 317365⟩, ⟨8737, 8751⟩⟩
...
def j36 : Jet := ⟨⟨3664627340, 3664627349⟩, ⟨(-171775443), (-171775428)⟩, ⟨(-9944550), (-9944532)⟩, ⟨317349, 317365⟩, ⟨8737, 8751⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1252139901, 1252139911⟩, ⟨144979469, 144979481⟩, ⟨(-6940027), (-6940014)⟩, ⟨(-254991), (-254977)⟩, ⟨7690, 7702⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5033729849, 5033729862⟩, ⟨235950620, 235950644⟩, ⟨24719730, 24719760⟩, ⟨1363065, 1363093⟩, ⟨98516, 98544⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1467516178, 1467516195⟩, ⟨238705115, 238705139⟩, ⟨7037615, 7037645⟩, ⟨551699, 551730⟩, ⟨29791, 29820⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1312853391), (-1312853390)⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2982113905, 2982113906⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨501424943, 501424955⟩, ⟨163122832, 163122854⟩, ⟨18075982, 18076008⟩, ⟨1159282, 1159310⟩, ⟨93213, 93238⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4796392239, 4796392251⟩, ⟨163122832, 163122854⟩, ⟨18075982, 18076008⟩, ⟨1159282, 1159310⟩, ⟨93213, 93238⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4538760602, 4538760609⟩, ⟨77180456, 77180467⟩, ⟨7896310, 7896324⟩, ⟨414231, 414246⟩, ⟨30189, 30204⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3151386301, 3151386308⟩, ⟨(-144607817), (-144607807)⟩, ⟨2112346, 2112358⟩, ⟨(-57202), (-57189)⟩, ⟨2871, 2884⟩⟩
...
def j47 : Jet := ⟨⟨7756238458, 7756238467⟩, ⟨1108034063, 1108034071⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14006913410, 14006913444⟩, ⟨4001975250, 4001975286⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14006913410, 14006913444⟩, ⟨4001975250, 4001975286⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14006913444), (-14006913410)⟩, ⟨(-4001975286), (-4001975250)⟩, ⟨(-285855379), (-285855374)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7003456722), (-7003456705)⟩, ⟨(-2000987643), (-2000987625)⟩, ⟨(-142927690), (-142927687)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨840990094, 840990104⟩, ⟨(-391809924), (-391809914)⟩, ⟨63283979, 63283984⟩, ⟨(-1135399), (-1135397)⟩, ⟨(-920738), (-920737)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨617067483, 617067493⟩, ⟨(-315801748), (-315801735)⟩, ⟨60039454, 60039465⟩, ⟨(-3167706), (-3167698)⟩, ⟨(-600452), (-600443)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1125302906, 1500403876⟩, ⟨187550484, 187550485⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3535243342, 4713657795⟩, ⟨589207222, 589207226⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2909904692, 5173163910⟩, ⟨969968226, 1293290982⟩, ⟨80830685, 80830687⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨728, 1297⟩, ⟨242, 325⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93959), (-93389)⟩, ⟨242, 325⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-113171), (-63272)⟩, ⟨(-28130), (-20698)⟩, ⟨(-1702), (-1633)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4999885, 5049785⟩, ⟨(-28130), (-20698)⟩, ⟨(-1702), (-1633)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3387496, 6082321⟩, ⟨1095283, 1506558⟩, ⟨83575, 89257⟩, ⟨(-1038), (-740)⟩, ⟨(-32), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139778081), (-137083255)⟩, ⟨1095283, 1506558⟩, ⟨83575, 89257⟩, ⟨(-1038), (-740)⟩, ⟨(-32), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-168358657), (-92875959)⟩, ⟨(-41347595), (-29144046)⟩, ⟨(-2326626), (-2018727)⟩, ⟨38236, 54730⟩, ⟨1220, 1498⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1263297108, 1338779807⟩, ⟨(-41347595), (-29144046)⟩, ⟨(-2326626), (-2018727)⟩, ⟨38236, 54730⟩, ⟨1220, 1498⟩⟩
...
def j70 : Jet := ⟨⟨(-131), (-72)⟩, ⟨(-33), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11704, 11764⟩, ⟨(-33), (-24)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7929, 14170⟩, ⟨2603, 3527⟩, ⟨206, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844248), (-838006)⟩, ⟨2603, 3527⟩, ⟨206, 216⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1016873), (-567761)⟩, ⟨(-252456), (-185004)⟩, ⟨(-15163), (-14447)⟩, ⟨91, 133⟩, ⟨0, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34774521, 35223634⟩, ⟨(-252456), (-185004)⟩, ⟨(-15163), (-14447)⟩, ⟨91, 133⟩, ⟨0, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨23560258, 42425849⟩, ⟨7549343, 10481121⟩, ⟨560168, 611336⟩, ⟨(-9257), (-6582)⟩, ⟨(-266), (-223)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692267625), (-673402033)⟩, ⟨7549343, 10481121⟩, ⟨560168, 611336⟩, ⟨(-9257), (-6582)⟩, ⟨(-266), (-223)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-833816336), (-456239966)⟩, ⟨(-203339293), (-139455780)⟩, ⟨(-10943929), (-8780943)⟩, ⟨257434, 376880⟩, ⟨7433, 9869⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3461150960, 3838727330⟩, ⟨(-203339293), (-139455780)⟩, ⟨(-10943929), (-8780943)⟩, ⟨257434, 376880⟩, ⟨7433, 9869⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1039836250, 1469289389⟩, ⟨127927717, 159672333⟩, ⟨(-8225726), (-5659780)⟩, ⟨(-287708), (-216874)⟩, ⟨6249, 9154⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4805432240, 5329656027⟩, ⟨174574862, 313112171⟩, ⟨17334311, 35247059⟩, ⟨505806, 2703354⟩, ⟨13581, 246967⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1163422744, 1823251846⟩, ⟨185397742, 305252850⟩, ⟨(-810829), 17365859⟩, ⟨(-317924), 1762475⟩, ⟨(-63137), 164692⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1500403876), (-1125302906)⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2794563420, 3169664390⟩, ⟨(-187550485), (-187550484)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨315148495, 773986638⟩, ⟨100441252, 259165104⟩, ⟨7314520, 36438921⟩, ⟨(-385180), 3964836⟩, ⟨(-102077), 460572⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4610115791, 5068953934⟩, ⟨100441252, 259165104⟩, ⟨7314520, 36438921⟩, ⟨(-385180), 3964836⟩, ⟨(-102077), 460572⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4449752414, 4665939496⟩, ⟨46227763, 125075009⟩, ⟨1690105, 17345569⟩, ⟨(-673446), 1895902⟩, ⟨(-136363), 240885⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2895275904, 3443440019⟩, ⟨(-173671358), (-102004831)⟩, ⟨(-4362030), 10782294⟩, ⟨(-1254438), 1325365⟩, ⟨(-183426), 207180⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6648204394, 8864272537⟩, ⟨1108034063, 1108034071⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10290793530, 18294744103⟩, ⟨3430264500, 4573686042⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10290793530, 18294744103⟩, ⟨3430264500, 4573686042⟩, ⟨285855374, 285855379⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18294744103), (-10290793530)⟩, ⟨(-4573686042), (-3430264500)⟩, ⟨(-285855379), (-285855374)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9147372052), (-5145396765)⟩, ⟨(-2286843021), (-1715132250)⟩, ⟨(-142927690), (-142927687)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨510510235, 1296201290⟩, ⟨(-690158661), (-203864781)⟩, ⟨(-2429711), 166747769⟩, ⟨(-25071990), 15742607⟩, ⟨(-4870039), 3377806⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨344139519, 1039214292⟩, ⟨(-605739885), (-149551614)⟩, ⟨1577324, 164849396⟩, ⟨(-28954985), 13820625⟩, ⟨(-4978751), 4404643⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1312853390, 1312853391⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4538760602, 4538760609⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1206
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1125302906, 1500403876⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4449752414, 4665939496⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1207
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (55716375 / 4294967296)

theorem envelope_integral : (∫ s in ((52401 / 200000) : ℝ)..(17467 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((52401 / 200000) : ℝ)..(17467 / 50000), prawitzNormalCorrection
