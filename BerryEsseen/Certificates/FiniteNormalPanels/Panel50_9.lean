...
namespace FiniteNormalPanel50_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (39799 / 160000)
def radius : Rat := (39799 / 800000)

def j0 : Jet := ⟨⟨1068346271, 1068346272⟩, ⟨213669254, 213669255⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3356308796, 3356308800⟩, ⟨671261758, 671261762⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2622792668, 2622792675⟩, ⟨1049117064, 1049117074⟩, ⟨104911706, 104911708⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨656, 658⟩, ⟨262, 263⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94031), (-94028)⟩, ⟨262, 263⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-57422), (-57419)⟩, ⟨(-22810), (-22806)⟩, ⟨(-2219), (-2214)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5055634, 5055638⟩, ⟨(-22810), (-22806)⟩, ⟨(-2219), (-2214)⟩, ⟨12, 14⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3087306, 3087309⟩, ⟨1220992, 1220998⟩, ⟨116564, 116571⟩, ⟨(-1094), (-1088)⟩, ⟨(-53), (-49)⟩⟩
...
def j16 : Jet := ⟨⟨(-140078271), (-140078267)⟩, ⟨1220992, 1220998⟩, ⟨116564, 116571⟩, ⟨(-1094), (-1088)⟩, ⟨(-53), (-49)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-85541109), (-85541105)⟩, ⟨(-33470826), (-33470819)⟩, ⟨(-3052217), (-3052207)⟩, ⟨57627, 57636⟩, ⟨2546, 2554⟩⟩
...
def j19 : Jet := ⟨⟨1346114656, 1346114661⟩, ⟨(-33470826), (-33470819)⟩, ⟨(-3052217), (-3052207)⟩, ⟨57627, 57636⟩, ⟨2546, 2554⟩⟩
...
def j22 : Jet := ⟨⟨(-66), (-65)⟩, ⟨(-27), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11769, 11771⟩, ⟨(-27), (-26)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7186, 7189⟩, ⟨2857, 2861⟩, ⟨278, 281⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844991), (-844987)⟩, ⟨2857, 2861⟩, ⟨278, 281⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-516008), (-516005)⟩, ⟨(-204660), (-204654)⟩, ⟨(-19775), (-19769)⟩, ⟨134, 139⟩, ⟨4, 7⟩⟩
...
def j30 : Jet := ⟨⟨35275386, 35275390⟩, ⟨(-204660), (-204654)⟩, ⟨(-19775), (-19769)⟩, ⟨134, 139⟩, ⟨4, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨21541496, 21541500⟩, ⟨8491618, 8491625⟩, ⟨799591, 799598⟩, ⟨(-9750), (-9742)⟩, ⟨(-450), (-443)⟩⟩
...
def j33 : Jet := ⟨⟨(-694286387), (-694286382)⟩, ⟨8491618, 8491625⟩, ⟨799591, 799598⟩, ⟨(-9750), (-9742)⟩, ⟨(-450), (-443)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-423977443), (-423977438)⟩, ⟨(-164405432), (-164405423)⟩, ⟨(-14396597), (-14396588)⟩, ⟨396780, 396790⟩, ⟨16874, 16883⟩⟩
...
def j36 : Jet := ⟨⟨3870989853, 3870989858⟩, ⟨(-164405432), (-164405423)⟩, ⟨(-14396597), (-14396588)⟩, ⟨396780, 396790⟩, ⟨16874, 16883⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1051923367, 1051923373⟩, ⟨184228844, 184228854⟩, ⟨(-7616326), (-7616315)⟩, ⟨(-432000), (-431990)⟩, ⟨10995, 11004⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4765381659, 4765381666⟩, ⟨202391277, 202391292⟩, ⟨26318708, 26318724⟩, ⟨1382027, 1382046⟩, ⟨115046, 115063⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1167137250, 1167137259⟩, ⟨253976524, 253976541⟩, ⟨6676853, 6676873⟩, ⟨629183, 629204⟩, ⟨32626, 32647⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1068346272), (-1068346271)⟩, ⟨(-213669255), (-213669254)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3226621024, 3226621025⟩, ⟨(-213669255), (-213669254)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨317164082, 317164088⟩, ⟨138033862, 138033874⟩, ⟨18647331, 18647346⟩, ⟨1131604, 1131624⟩, ⟨102519, 102540⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4612131378, 4612131384⟩, ⟨138033862, 138033874⟩, ⟨18647331, 18647346⟩, ⟨1131604, 1131624⟩, ⟨102519, 102540⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4450725045, 4450725049⟩, ⟨66601611, 66601618⟩, ⟨8499053, 8499062⟩, ⟨418818, 418831⟩, ⟨35082, 35095⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3343635006, 3343635011⟩, ⟨(-171383133), (-171383125)⟩, ⟨3071618, 3071628⟩, ⟨(-108179), (-108167)⟩, ⟨5518, 5531⟩⟩
...
def j47 : Jet := ⟨⟨4990043080, 4990043087⟩, ⟨998008615, 998008621⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5797606413, 5797606430⟩, ⟨2319042562, 2319042582⟩, ⟨231904256, 231904259⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5797606413, 5797606430⟩, ⟨2319042562, 2319042582⟩, ⟨231904256, 231904259⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5797606430), (-5797606413)⟩, ⟨(-2319042582), (-2319042562)⟩, ⟨(-231904259), (-231904256)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2898803215), (-2898803206)⟩, ⟨(-1159521291), (-1159521281)⟩, ⟨(-115952130), (-115952128)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2186962776, 2186962789⟩, ⟨(-590418912), (-590418903)⟩, ⟨20656419, 20656424⟩, ⟨8767555, 8767557⟩, ⟨(-870582), (-870581)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1702552031, 1702552045⟩, ⟨(-546908445), (-546908430)⟩, ⟨41204708, 41204721⟩, ⟨5523954, 5523968⟩, ⟨(-995153), (-995138)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨854677017, 1282015526⟩, ⟨213669254, 213669255⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2685047037, 4027570559⟩, ⟨671261758, 671261762⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1678587307, 3776821450⟩, ⟨839293652, 1258940488⟩, ⟨104911706, 104911708⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨420, 947⟩, ⟨210, 316⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94267), (-93739)⟩, ⟨210, 316⟩, ⟨26, 27⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-82895), (-36635)⟩, ⟨(-27550), (-18039)⟩, ⟨(-2252), (-2172)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5030161, 5076422⟩, ⟨(-27550), (-18039)⟩, ⟨(-2252), (-2172)⟩, ⟨10, 16⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1965920, 4464002⟩, ⟨958733, 1480951⟩, ⟨112813, 119628⟩, ⟨(-1331), (-849)⟩, ⟨(-55), (-47)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141199657), (-138701574)⟩, ⟨958733, 1480951⟩, ⟨112813, 119628⟩, ⟨(-1331), (-849)⟩, ⟨(-55), (-47)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-124165298), (-54208259)⟩, ⟨(-41013735), (-25801840)⟩, ⟨(-3217598), (-2848722)⟩, ⟨44292, 70910⟩, ⟨2315, 2740⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1307490467, 1377447507⟩, ⟨(-41013735), (-25801840)⟩, ⟨(-3217598), (-2848722)⟩, ⟨44292, 70910⟩, ⟨2315, 2740⟩⟩
...
def j70 : Jet := ⟨⟨(-95), (-41)⟩, ⟨(-32), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11740, 11795⟩, ⟨(-32), (-20)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4588, 10373⟩, ⟨2265, 3451⟩, ⟨273, 286⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847589), (-841803)⟩, ⟨2265, 3451⟩, ⟨273, 286⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-745336), (-328998)⟩, ⟨(-247561), (-161464)⟩, ⟨(-20156), (-19298)⟩, ⟨106, 169⟩, ⟨4, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35046058, 35462397⟩, ⟨(-247561), (-161464)⟩, ⟨(-20156), (-19298)⟩, ⟨106, 169⟩, ⟨4, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13696930, 31184206⟩, ⟨6630769, 10331632⟩, ⟨765767, 827134⟩, ⟨(-11916), (-7566)⟩, ⟨(-472), (-414)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702130953), (-684643676)⟩, ⟨6630769, 10331632⟩, ⟨765767, 827134⟩, ⟨(-11916), (-7566)⟩, ⟨(-472), (-414)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-617425713), (-267576934)⟩, ⟨(-203217092), (-124703245)⟩, ⟨(-15555693), (-12967801)⟩, ⟨301129, 491862⟩, ⟨14796, 18566⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3677541583, 4027390362⟩, ⟨(-203217092), (-124703245)⟩, ⟨(-15555693), (-12967801)⟩, ⟨301129, 491862⟩, ⟨14796, 18566⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨817392348, 1291690168⟩, ⟨165887790, 199151386⟩, ⟨(-9427327), (-5813487)⟩, ⟨(-475191), (-378731)⟩, ⟨8369, 13653⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4580321850, 5016053159⟩, ⟨141824095, 277181839⟩, ⟨19139595, 36534264⟩, ⟨436685, 2816251⟩, ⟨18171, 280121⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨871699310, 1508553175⟩, ⟨203900364, 315948156⟩, ⟨(-1889779), 17640289⟩, ⟨(-341028), 1945155⟩, ⟨(-81611), 192366⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1282015526), (-854677017)⟩, ⟨(-213669255), (-213669254)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3012951770, 3440290279⟩, ⟨(-213669255), (-213669254)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨176918620, 529860306⟩, ⟨82766546, 221945622⟩, ⟨8352493, 35633769⟩, ⟨(-517598), 3961750⟩, ⟨(-115266), 493769⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4471885916, 4824827602⟩, ⟨82766546, 221945622⟩, ⟨8352493, 35633769⟩, ⟨(-517598), 3961750⟩, ⟨(-115266), 493769⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4382533942, 4552194719⟩, ⟨39044859, 108755483⟩, ⟨2641135, 17286960⟩, ⟨(-682616), 1917766⟩, ⟨(-138167), 258096⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3074380428, 3646330731⟩, ⟨(-199075737), (-130911899)⟩, ⟨(-3557674), 11904510⟩, ⟨(-1406784), 1404748⟩, ⟨(-206080), 240697⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3992034465, 5988051703⟩, ⟨998008615, 998008621⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3710468106, 8348553255⟩, ⟨1855234050, 2782851096⟩, ⟨231904256, 231904259⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3710468106, 8348553255⟩, ⟨1855234050, 2782851096⟩, ⟨231904256, 231904259⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8348553255), (-3710468106)⟩, ⟨(-2782851096), (-1855234050)⟩, ⟨(-231904259), (-231904256)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4174276628), (-1855234053)⟩, ⟨(-1391425548), (-927617025)⟩, ⟨(-115952130), (-115952128)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1625059490, 2788457578⟩, ⟨(-903366859), (-350976560)⟩, ⟨(-37379023), 102458233⟩, ⟨(-4747421), 20295440⟩, ⟨(-3026804), 889067⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1163233791, 2367337831⟩, ⟨(-896185774), (-300764825)⟩, ⟨(-23345859), 136585499⟩, ⟨(-12196722), 20623234⟩, ⟨(-4043266), 1710995⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1068346271, 1068346272⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4450725045, 4450725049⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified990
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨854677017, 1282015526⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4382533942, 4552194719⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified991
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (170800309 / 4294967296)

theorem envelope_integral : (∫ s in ((39799 / 200000) : ℝ)..(119397 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((39799 / 200000) : ℝ)..(119397 / 400000), prawitzNormalCorrection
