...
namespace FiniteNormalPanel124_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (13859 / 80000)
def radius : Rat := (13859 / 400000)

def j0 : Jet := ⟨⟨744049396, 744049397⟩, ⟨148809879, 148809880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2337500116, 2337500120⟩, ⟨467500022, 467500026⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1272164935, 1272164940⟩, ⟨508865972, 508865980⟩, ⟨50886597, 50886599⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨318, 319⟩, ⟨127, 128⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94369), (-94367)⟩, ⟨127, 128⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-27953), (-27951)⟩, ⟨(-11144), (-11142)⟩, ⟨(-1101), (-1098)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5085103, 5085106⟩, ⟨(-11144), (-11142)⟩, ⟨(-1101), (-1098)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1506202, 1506204⟩, ⟨599179, 599182⟩, ⟨58600, 58604⟩, ⟨(-264), (-260)⟩, ⟨(-14), (-11)⟩⟩
...
def j16 : Jet := ⟨⟨(-141659375), (-141659372)⟩, ⟨599179, 599182⟩, ⟨58600, 58604⟩, ⟨(-264), (-260)⟩, ⟨(-14), (-11)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-41959363), (-41959361)⟩, ⟨(-16606270), (-16606266)⟩, ⟨(-1590028), (-1590024)⟩, ⟨13962, 13967⟩, ⟨657, 662⟩⟩
...
def j19 : Jet := ⟨⟨1389696402, 1389696405⟩, ⟨(-16606270), (-16606266)⟩, ⟨(-1590028), (-1590024)⟩, ⟨13962, 13967⟩, ⟨657, 662⟩⟩
...
def j25 : Jet := ⟨⟨3496, 3497⟩, ⟨1394, 1396⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848681), (-848679)⟩, ⟨1394, 1396⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-251379), (-251377)⟩, ⟨(-100140), (-100137)⟩, ⟨(-9851), (-9847)⟩, ⟨31, 34⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35540015, 35540018⟩, ⟨(-100140), (-100137)⟩, ⟨(-9851), (-9847)⟩, ⟨31, 34⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10526916, 10526918⟩, ⟨4181104, 4181107⟩, ⟨406293, 406297⟩, ⟨(-2346), (-2341)⟩, ⟨(-115), (-110)⟩⟩
...
def j33 : Jet := ⟨⟨(-705300967), (-705300964)⟩, ⟨4181104, 4181107⟩, ⟨406293, 406297⟩, ⟨(-2346), (-2341)⟩, ⟨(-115), (-110)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-208909429), (-208909426)⟩, ⟨(-82325334), (-82325330)⟩, ⟨(-7740660), (-7740655)⟩, ⟨96979, 96983⟩, ⟨4500, 4505⟩⟩
...
def j36 : Jet := ⟨⟨4086057867, 4086057870⟩, ⟨(-82325334), (-82325330)⟩, ⟨(-7740660), (-7740655)⟩, ⟨96979, 96983⟩, ⟨4500, 4505⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨756330671, 756330675⟩, ⟨142228309, 142228315⟩, ⟨(-2672925), (-2672921)⟩, ⟨(-165474), (-165469)⟩, ⟨1876, 1882⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4514557713, 4514557717⟩, ⟨90958685, 90958691⟩, ⟨10385030, 10385038⟩, ⟨274393, 274402⟩, ⟨18063, 18074⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨794999875, 794999881⟩, ⟨165517616, 165517625⟩, ⟨2031293, 2031302⟩, ⟨161677, 161689⟩, ⟨4268, 4283⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-744049397), (-744049396)⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3550917899, 3550917900⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨147154741, 147154744⟩, ⟨61274730, 61274736⟩, ⟨7130633, 7130638⟩, ⟨216414, 216422⟩, ⟨15000, 15011⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4442122037, 4442122040⟩, ⟨61274730, 61274736⟩, ⟨7130633, 7130638⟩, ⟨216414, 216422⟩, ⟨15000, 15011⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4367925007, 4367925010⟩, ⟨30125627, 30125631⟩, ⟨3401876, 3401879⟩, ⟨82936, 82942⟩, ⟨5477, 5485⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3611236598, 3611236603⟩, ⟨(-126430945), (-126430938)⟩, ⟨1768765, 1768769⟩, ⟨(-49299), (-49292)⟩, ⟨1654, 1662⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨40667061928, 40667061935⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value529

def j47 : Jet := ⟨⟨7045060131, 7045060143⟩, ⟨1409012024, 1409012035⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11556053592, 11556053632⟩, ⟨4622421428, 4622421474⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11556053592, 11556053632⟩, ⟨4622421428, 4622421474⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11556053632), (-11556053592)⟩, ⟨(-4622421474), (-4622421428)⟩, ⟨(-462242150), (-462242142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5778026816), (-5778026796)⟩, ⟨(-2311210737), (-2311210714)⟩, ⟨(-231121075), (-231121071)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1118671963, 1118671978⟩, ⟨(-601980530), (-601980515)⟩, ⟨101771027, 101771037⟩, ⟨3340844, 3340848⟩, ⟨(-3187701), (-3187698)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨940586704, 940586719⟩, ⟨(-539079515), (-539079496)⟩, ⟨103750937, 103750950⟩, ⟨(-447582), (-447573)⟩, ⟨(-2729336), (-2729326)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨595239517, 892859277⟩, ⟨148809879, 148809880⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1870000093, 2805000146⟩, ⟨467500022, 467500026⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨814185558, 1831917516⟩, ⟨407092778, 610639176⟩, ⟨50886597, 50886599⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨203, 459⟩, ⟨101, 153⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94484), (-94227)⟩, ⟨101, 153⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-40300), (-17862)⟩, ⟨(-13415), (-8865)⟩, ⟨(-1109), (-1088)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5072756, 5095195⟩, ⟨(-13415), (-8865)⟩, ⟨(-1109), (-1088)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨961628, 2173236⟩, ⟨475092, 722732⟩, ⟨57719, 59322⟩, ⟨(-317), (-206)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142203949), (-140992340)⟩, ⟨475092, 722732⟩, ⟨57719, 59322⟩, ⟨(-317), (-206)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-60653758), (-26727543)⟩, ⟨(-20127859), (-13055506)⟩, ⟨(-1628856), (-1542413)⟩, ⟨10962, 16959⟩, ⟨631, 683⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1371002007, 1404928223⟩, ⟨(-20127859), (-13055506)⟩, ⟨(-1628856), (-1542413)⟩, ⟨10962, 16959⟩, ⟨631, 683⟩⟩
...
def j70 : Jet := ⟨⟨(-47), (-20)⟩, ⟨(-16), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11788, 11816⟩, ⟨(-16), (-10)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨2234, 5040⟩, ⟨1110, 1679⟩, ⟨135, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849943), (-847136)⟩, ⟨1110, 1679⟩, ⟨135, 140⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-362524), (-160589)⟩, ⟨(-120632), (-79577)⟩, ⟨(-9941), (-9737)⟩, ⟨24, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35428870, 35630806⟩, ⟨(-120632), (-79577)⟩, ⟨(-9941), (-9737)⟩, ⟨24, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6716156, 15197485⟩, ⟨3306625, 5050744⟩, ⟨398367, 412766⟩, ⟨(-2840), (-1846)⟩, ⟨(-117), (-108)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709111727), (-700630397)⟩, ⟨3306625, 5050744⟩, ⟨398367, 412766⟩, ⟨(-2840), (-1846)⟩, ⟨(-117), (-108)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-302454968), (-132816645)⟩, ⟨(-100191496), (-64254045)⟩, ⟨(-8012597), (-7406891)⟩, ⟨75722, 118179⟩, ⟨4265, 4697⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3992512328, 4162150651⟩, ⟨(-100191496), (-64254045)⟩, ⟨(-8012597), (-7406891)⟩, ⟨75722, 118179⟩, ⟨4265, 4697⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨596925122, 917544559⟩, ⟨136085976, 147239814⟩, ⟨(-3254674), (-2092626)⟩, ⟨(-172527), (-156813)⟩, ⟨1467, 2293⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4432022197, 4620334907⟩, ⟨68420240, 115946610⟩, ⟨8943400, 12182241⟩, ⟨128635, 454350⟩, ⟨9393, 29819⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨615973349, 987053652⟩, ⟨149937771, 183164012⟩, ⟨(-90365), 4417996⟩, ⟨27789, 319543⟩, ⟨(-6997), 17559⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-892859277), (-595239517)⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3402108019, 3699727779⟩, ⟨(-148809880), (-148809879)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨88341340, 226841055⟩, ⟨43007390, 84188166⟩, ⟨5192807, 9841905⟩, ⟨262, 523696⟩, ⟨(-1371), 39873⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4383308636, 4521808351⟩, ⟨43007390, 84188166⟩, ⟨5192807, 9841905⟩, ⟨262, 523696⟩, ⟨(-1371), 39873⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4338913140, 4406928521⟩, ⟨20957377, 41667742⟩, ⟨2333454, 4820499⟩, ⟨(-46164), 247926⟩, ⟨(-5739), 19551⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3436918181, 3796172298⟩, ⟨(-136088405), (-114439482)⟩, ⟨404679, 3426307⟩, ⟨(-206786), 132718⟩, ⟨(-13535), 18442⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5636048107, 8454072177⟩, ⟨1409012024, 1409012035⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7395874304, 16640717251⟩, ⟨3697937144, 5546905772⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7395874304, 16640717251⟩, ⟨3697937144, 5546905772⟩, ⟨462242142, 462242150⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-16640717251), (-7395874304)⟩, ⟨(-5546905772), (-3697937144)⟩, ⟨(-462242150), (-462242142)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8320358626), (-3697937152)⟩, ⟨(-2773452886), (-1848968572)⟩, ⟨(-231121075), (-231121071)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨618913028, 1815663298⟩, ⟨(-1172455171), (-266439918)⟩, ⟨(-40353867), 345248438⟩, ⟨(-64755676), 50747593⟩, ⟨(-17481766), 11539674⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨495266504, 1604801676⟩, ⟨(-1093822663), (-229701465)⟩, ⟨(-28509770), 343751428⟩, ⟨(-69197423), 46163671⟩, ⟨(-17133637), 12591006⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨744049396, 744049397⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4367925007, 4367925010⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar529 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2498
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar529 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨595239517, 892859277⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4338913140, 4406928521⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2499
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((13859 / 100000) : ℝ)..(41577 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (13859 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (41577 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((13859 / 100000) : ℝ)..(41577 / 200000), prawitzNormalCorrection
      ((26261 / 10000) * sqrt n) s) ≤ (upper : ℝ) :=
