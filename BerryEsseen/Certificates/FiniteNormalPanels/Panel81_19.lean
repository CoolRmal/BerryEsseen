...
namespace FiniteNormalPanel81_19

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6547 / 160000)
def radius : Rat := (6547 / 160000)

def j0 : Jet := ⟨⟨175744693, 175744694⟩, ⟨175744693, 175744694⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨552118236, 552118240⟩, ⟨552118236, 552118240⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨70974823, 70974825⟩, ⟨141949646, 141949650⟩, ⟨70974823, 70974825⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨17, 18⟩, ⟨35, 36⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94670), (-94668)⟩, ⟨35, 36⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1565), (-1564)⟩, ⟨(-3129), (-3127)⟩, ⟨(-1564), (-1561)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111491, 5111493⟩, ⟨(-3129), (-3127)⟩, ⟨(-1564), (-1561)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨84467, 84469⟩, ⟨168883, 168886⟩, ⟨84337, 84341⟩, ⟨(-104), (-101)⟩, ⟨(-26), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-143081110), (-143081107)⟩, ⟨168883, 168886⟩, ⟨84337, 84341⟩, ⟨(-104), (-101)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2364432), (-2364431)⟩, ⟨(-4726074), (-4726072)⟩, ⟨(-2357458), (-2357455)⟩, ⟨5575, 5578⟩, ⟨1388, 1391⟩⟩
...
def j19 : Jet := ⟨⟨1429291333, 1429291335⟩, ⟨(-4726074), (-4726072)⟩, ⟨(-2357458), (-2357455)⟩, ⟨5575, 5578⟩, ⟨1388, 1391⟩⟩
...
def j25 : Jet := ⟨⟨195, 196⟩, ⟨390, 392⟩, ⟨193, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851982), (-851980)⟩, ⟨390, 392⟩, ⟨193, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14080), (-14079)⟩, ⟨(-28153), (-28151)⟩, ⟨(-14065), (-14062)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35777314, 35777316⟩, ⟨(-28153), (-28151)⟩, ⟨(-14065), (-14062)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨591224, 591225⟩, ⟨1181982, 1181984⟩, ⟨590060, 590063⟩, ⟨(-931), (-928)⟩, ⟨(-233), (-230)⟩⟩
...
def j33 : Jet := ⟨⟨(-715236659), (-715236657)⟩, ⟨1181982, 1181984⟩, ⟨590060, 590063⟩, ⟨(-931), (-928)⟩, ⟨(-233), (-230)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11819368), (-11819367)⟩, ⟨(-23619203), (-23619201)⟩, ⟨(-11770554), (-11770551)⟩, ⟨39017, 39020⟩, ⟨9715, 9718⟩⟩
...
def j36 : Jet := ⟨⟨4283147928, 4283147929⟩, ⟨(-23619203), (-23619201)⟩, ⟨(-11770554), (-11770551)⟩, ⟨39017, 39020⟩, ⟨9715, 9718⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨183735464, 183735466⟩, ⟨183127926, 183127930⟩, ⟨(-910590), (-910586)⟩, ⟨(-302336), (-302332)⟩, ⟨894, 897⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306819278, 4306819280⟩, ⟨23749735, 23749739⟩, ⟨11966567, 11966573⟩, ⟨92019, 92026⟩, ⟨23403, 23411⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨184242482, 184242485⟩, ⟨184649263, 184649269⟩, ⟨611453, 611460⟩, ⟨205957, 205965⟩, ⟨1610, 1618⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-175744694), (-175744693)⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4119222602, 4119222603⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7903504, 7903505⟩, ⟨15841908, 15841910⟩, ⟨7990900, 7990903⟩, ⟨70242, 70248⟩, ⟨17933, 17938⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302870800, 4302870801⟩, ⟨15841908, 15841910⟩, ⟨7990900, 7990903⟩, ⟨70242, 70248⟩, ⟨17933, 17938⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298917231, 4298917233⟩, ⟨7913676, 7913678⟩, ⟨3984494, 3984497⟩, ⟨27753, 27758⟩, ⟨7059, 7064⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4123010910, 4123010914⟩, ⟨(-168316463), (-168316458)⟩, ⟨3497635, 3497640⟩, ⟨(-136424), (-136417)⟩, ⟨5634, 5640⟩⟩
...
def j47 : Jet := ⟨⟨1180666925, 1180666933⟩, ⟨1180666925, 1180666933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨324559953, 324559959⟩, ⟨649119906, 649119918⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨324559953, 324559959⟩, ⟨649119906, 649119918⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-324559959), (-324559953)⟩, ⟨(-649119918), (-649119906)⟩, ⟨(-324559959), (-324559953)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-162279980), (-162279976)⟩, ⟨(-324559959), (-324559953)⟩, ⟨(-162279980), (-162279976)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4135714839, 4135714843⟩, ⟨(-312525649), (-312525642)⟩, ⟨(-144454434), (-144454428)⟩, ⟨11510947, 11510949⟩, ⟨2511551, 2511553⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3970134398, 3970134407⟩, ⟨(-462088631), (-462088617)⟩, ⟨(-123055368), (-123055355)⟩, ⟨16325269, 16325283⟩, ⟨1857603, 1857615⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 351489387⟩, ⟨175744693, 175744694⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1104236477⟩, ⟨552118236, 552118240⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 283899298⟩, ⟨0, 283899300⟩, ⟨70974823, 70974825⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 72⟩, ⟨0, 72⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94614)⟩, ⟨0, 72⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6259), 0⟩, ⟨(-6259), 5⟩, ⟨(-1565), (-1556)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106797, 5113057⟩, ⟨(-6259), 5⟩, ⟨(-1565), (-1556)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 337976⟩, ⟨(-414), 337977⟩, ⟨83872, 84495⟩, ⟨(-208), 2⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142827600)⟩, ⟨(-414), 337977⟩, ⟨83872, 84495⟩, ⟨(-208), 2⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9463310), 0⟩, ⟨(-9463339), 22341⟩, ⟨(-2365856), (-2332315)⟩, ⟨(-21), 11173⟩, ⟨1369, 1398⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422192455, 1431655766⟩, ⟨(-9463339), 22341⟩, ⟨(-2365856), (-2332315)⟩, ⟨(-21), 11173⟩, ⟨1369, 1398⟩⟩
...
def j70 : Jet := ⟨⟨(-8), 0⟩, ⟨(-8), 0⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11827, 11836⟩, ⟨(-8), 0⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 783⟩, ⟨(-1), 783⟩, ⟨193, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851393)⟩, ⟨(-1), 783⟩, ⟨193, 196⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-56330), 0⟩, ⟨(-56331), 52⟩, ⟨(-14084), (-14004)⟩, ⟨(-2), 26⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35735064, 35791395⟩, ⟨(-56331), 52⟩, ⟨(-14084), (-14004)⟩, ⟨(-2), 26⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2365828⟩, ⟨(-3724), 2365832⟩, ⟨585870, 591461⟩, ⟨(-1863), 3⟩, ⟨(-234), (-228)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713462054)⟩, ⟨(-3724), 2365832⟩, ⟨585870, 591461⟩, ⟨(-1863), 3⟩, ⟨(-234), (-228)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-47316550), 0⟩, ⟨(-47316798), 156383⟩, ⟨(-11829385), (-11594562)⟩, ⟨(-186), 78193⟩, ⟨9541, 9775⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4247650746, 4294967296⟩, ⟨(-47316798), 156383⟩, ⟨(-11829385), (-11594562)⟩, ⟨(-186), 78193⟩, ⟨9541, 9775⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 368078826⟩, ⟨180389877, 184045158⟩, ⟨(-1824775), 2872⟩, ⟨(-304137), (-296946)⟩, ⟨(-3), 1797⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4342810927⟩, ⟨(-159888), 48376838⟩, ⟨11592800, 12633295⟩, ⟨(-80857), 275647⟩, ⟨19639, 28611⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 372179027⟩, ⟨180376174, 190241220⟩, ⟨(-1851955), 3158591⟩, ⟨151891, 268099⟩, ⟨(-12263), 16103⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-351489387), 0⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3943477909, 4294967296⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 32251056⟩, ⟨0, 32970586⟩, ⟨7254314, 8973956⟩, ⟨(-164062), 326280⟩, ⟨9268, 28867⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4327218352⟩, ⟨0, 32970586⟩, ⟨7254314, 8973956⟩, ⟨(-164062), 326280⟩, ⟨9268, 28867⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311062666⟩, ⟨0, 16485293⟩, ⟨3582095, 4486978⟩, ⟨(-99254), 163140⟩, ⟨1656, 13321⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3943477909, 4311062666⟩, ⟨(-176403297), (-159259400)⟩, ⟨2614387, 4486978⟩, ⟨(-282856), 16566⟩, ⟨(-5156), 17383⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2361333859⟩, ⟨1180666925, 1180666933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1298239826⟩, ⟨0, 1298239830⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1298239826⟩, ⟨0, 1298239830⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1298239826), 0⟩, ⟨(-1298239830), 0⟩, ⟨(-324559959), (-324559953)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-649119913), 0⟩, ⟨(-649119915), 0⟩, ⟨(-162279980), (-162279976)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3692519193, 4294967296⟩, ⟨(-649119915), 0⟩, ⟨(-162279980), (-90464854)⟩, ⟨0, 24526187⟩, ⟨782359, 3065774⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3390332652, 4311062666⟩, ⟨(-827955786), (-136920342)⟩, ⟨(-160640453), (-51913744)⟩, ⟨2393483, 31299844⟩, ⟨(-466205), 3082330⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨175744693, 175744694⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298917231, 4298917233⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1642
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 351489387⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311062666⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1643
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (160799739 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(6547 / 80000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (6547 / 80000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(6547 / 80000), prawitzNormalCorrection
