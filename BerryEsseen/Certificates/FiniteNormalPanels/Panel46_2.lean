...
namespace FiniteNormalPanel46_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (56 / 625)
def radius : Rat := (56 / 625)

def j0 : Jet := ⟨⟨384829069, 384829070⟩, ⟨384829069, 384829070⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1208976176, 1208976180⟩, ⟨1208976176, 1208976180⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨340310715, 340310718⟩, ⟨680621430, 680621436⟩, ⟨340310715, 340310718⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨85, 86⟩, ⟨170, 171⟩, ⟨85, 86⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94602), (-94600)⟩, ⟨170, 171⟩, ⟨85, 86⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-7496), (-7495)⟩, ⟨(-14979), (-14977)⟩, ⟨(-7464), (-7460)⟩, ⟨26, 28⟩, ⟨6, 7⟩⟩
...
def j13 : Jet := ⟨⟨5105560, 5105562⟩, ⟨(-14979), (-14977)⟩, ⟨(-7464), (-7460)⟩, ⟨26, 28⟩, ⟨6, 7⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨404537, 404538⟩, ⟨807888, 807890⟩, ⟨401571, 401574⟩, ⟨(-2368), (-2365)⟩, ⟨(-588), (-585)⟩⟩
...
def j16 : Jet := ⟨⟨(-142761040), (-142761038)⟩, ⟨807888, 807890⟩, ⟨401571, 401574⟩, ⟨(-2368), (-2365)⟩, ⟨(-588), (-585)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-11311638), (-11311636)⟩, ⟨(-22559263), (-22559260)⟩, ⟨(-11151795), (-11151791)⟩, ⟨127460, 127464⟩, ⟨31395, 31399⟩⟩
...
def j19 : Jet := ⟨⟨1420344127, 1420344130⟩, ⟨(-22559263), (-22559260)⟩, ⟨(-11151795), (-11151791)⟩, ⟨127460, 127464⟩, ⟨31395, 31399⟩⟩
...
def j22 : Jet := ⟨⟨(-9), (-8)⟩, ⟨(-18), (-16)⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11826, 11828⟩, ⟨(-18), (-16)⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨937, 938⟩, ⟨1872, 1874⟩, ⟨933, 936⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851240), (-851238)⟩, ⟨1872, 1874⟩, ⟨933, 936⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-67448), (-67447)⟩, ⟨(-134748), (-134746)⟩, ⟨(-67079), (-67075)⟩, ⟨294, 298⟩, ⟨71, 75⟩⟩
...
def j30 : Jet := ⟨⟨35723946, 35723948⟩, ⟨(-134748), (-134746)⟩, ⟨(-67079), (-67075)⟩, ⟨294, 298⟩, ⟨71, 75⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2830578, 2830579⟩, ⟨5650479, 5650482⟩, ⟨2803909, 2803912⟩, ⟨(-21284), (-21281)⟩, ⟨(-5264), (-5260)⟩⟩
...
def j33 : Jet := ⟨⟨(-712997305), (-712997303)⟩, ⟨5650479, 5650482⟩, ⟨2803909, 2803912⟩, ⟨(-21284), (-21281)⟩, ⟨(-5264), (-5260)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-56494173), (-56494172)⟩, ⟨(-112540632), (-112540629)⟩, ⟨(-55376578), (-55376574)⟩, ⟨890361, 890364⟩, ⟨218376, 218380⟩⟩
...
def j36 : Jet := ⟨⟨4238473123, 4238473124⟩, ⟨(-112540632), (-112540629)⟩, ⟨(-55376578), (-55376574)⟩, ⟨890361, 890364⟩, ⟨218376, 218380⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨399807982, 399807986⟩, ⟨393457849, 393457855⟩, ⟨(-9489215), (-9489211)⟩, ⟨(-3103204), (-3103200)⟩, ⟨44715, 44719⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4352214473, 4352214475⟩, ⟨115560707, 115560712⟩, ⟨59931015, 59931022⟩, ⟨2186865, 2186873⟩, ⟨592560, 592569⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨405136981, 405136986⟩, ⟨409459471, 409459479⟩, ⟨6549540, 6549549⟩, ⟨2293907, 2293916⟩, ⟨84899, 84911⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-384829070), (-384829069)⟩, ⟨(-384829070), (-384829069)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3910138226, 3910138227⟩, ⟨(-384829070), (-384829069)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨38215884, 38215886⟩, ⟨77247234, 77247238⟩, ⟨40271314, 40271319⟩, ⟨1681556, 1681564⟩, ⟨463379, 463388⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4333183180, 4333183182⟩, ⟨77247234, 77247238⟩, ⟨40271314, 40271319⟩, ⟨1681556, 1681564⟩, ⟨463379, 463388⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4314032921, 4314032923⟩, ⟨38452922, 38452925⟩, ⟨19875294, 19875298⟩, ⟨659904, 659910⟩, ⟨178998, 179005⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3927495570, 3927495574⟩, ⟨(-351529811), (-351529805)⟩, ⟨14649084, 14649091⟩, ⟨(-1180051), (-1180043)⟩, ⟨103831, 103840⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨24232694260, 24232694266⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value285

def j47 : Jet := ⟨⟨2171249401, 2171249408⟩, ⟨2171249401, 2171249408⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1097639082, 1097639090⟩, ⟨2195278164, 2195278180⟩, ⟨1097639082, 1097639090⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1097639082, 1097639090⟩, ⟨2195278164, 2195278180⟩, ⟨1097639082, 1097639090⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1097639090), (-1097639082)⟩, ⟨(-2195278180), (-2195278164)⟩, ⟨(-1097639090), (-1097639082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-548819545), (-548819541)⟩, ⟨(-1097639090), (-1097639082)⟩, ⟨(-548819545), (-548819541)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3779765356, 3779765362⟩, ⟨(-965972015), (-965972006)⟩, ⟨(-359552166), (-359552159)⟩, ⟨112918758, 112918762⟩, ⟨15757654, 15757657⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3456373627, 3456373637⟩, ⟨(-1192686851), (-1192686834)⟩, ⟨(-236835679), (-236835661)⟩, ⟨128352615, 128352633⟩, ⟨4297826, 4297845⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 769658140⟩, ⟨384829069, 384829070⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2417952359⟩, ⟨1208976176, 1208976180⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1361242871⟩, ⟨0, 1361242872⟩, ⟨340310715, 340310718⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 342⟩, ⟨0, 342⟩, ⟨85, 86⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94344)⟩, ⟨0, 342⟩, ⟨85, 86⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-30011), 0⟩, ⟨(-30011), 109⟩, ⟨(-7503), (-7338)⟩, ⟨0, 56⟩, ⟨6, 7⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5083045, 5113057⟩, ⟨(-30011), 109⟩, ⟨(-7503), (-7338)⟩, ⟨0, 56⟩, ⟨6, 7⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1620528⟩, ⟨(-9512), 1620563⟩, ⟨390863, 405167⟩, ⟨(-4756), 27⟩, ⟨(-595), (-560)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141545048)⟩, ⟨(-9512), 1620563⟩, ⟨390863, 405167⟩, ⟨(-4756), 27⟩, ⟨(-595), (-560)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-45374763), 0⟩, ⟨(-45377778), 513620⟩, ⟨(-11346706), (-10573254)⟩, ⟨(-2262), 256828⟩, ⟨29272, 32113⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1386281002, 1431655766⟩, ⟨(-45377778), 513620⟩, ⟨(-11346706), (-10573254)⟩, ⟨(-2262), 256828⟩, ⟨29272, 32113⟩⟩
...
def j72 : Jet := ⟨⟨0, 3752⟩, ⟨(-12), 3752⟩, ⟨919, 938⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848424)⟩, ⟨(-12), 3752⟩, ⟨919, 938⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-270089), 0⟩, ⟨(-270093), 1190⟩, ⟨(-67527), (-65736)⟩, ⟨(-3), 596⟩, ⟨69, 75⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35521305, 35791395⟩, ⟨(-270093), 1190⟩, ⟨(-67527), (-65736)⟩, ⟨(-3), 596⟩, ⟨69, 75⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 11343691⟩, ⟨(-85604), 11344069⟩, ⟨2707516, 2836301⟩, ⟨(-42804), 284⟩, ⟨(-5352), (-4995)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-704484191)⟩, ⟨(-85604), 11344069⟩, ⟨2707516, 2836301⟩, ⟨(-42804), 284⟩, ⟨(-5352), (-4995)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-226873812), 0⟩, ⟨(-226900945), 3595379⟩, ⟨(-56745586), (-51325323)⟩, ⟨(-20350), 1797871⟩, ⟨199265, 224825⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4068093484, 4294967296⟩, ⟨(-226900945), 3595379⟩, ⟨(-56745586), (-51325323)⟩, ⟨(-20350), 1797871⟩, ⟨199265, 224825⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 805984121⟩, ⟨364673183, 403281216⟩, ⟨(-19161136), 144578⟩, ⟨(-3195221), (-2831642)⟩, ⟨(-637), 90373⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4534493651⟩, ⟨(-4007584), 252914762⟩, ⟨51113604, 77357884⟩, ⟨(-2128266), 7865270⟩, ⟨155143, 1309147⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 850933111⟩, ⟨363921128, 473233266⟩, ⟨(-20606033), 38417194⟩, ⟨(-561224), 5925832⟩, ⟨(-733782), 1085193⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-769658140), 0⟩, ⟨(-384829070), (-384829069)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3525309156, 4294967296⟩, ⟨(-384829070), (-384829069)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 168589680⟩, ⟨0, 187517078⟩, ⟨22670689, 67365043⟩, ⟨(-4763262), 10813952⟩, ⟨(-598751), 2079493⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4463556976⟩, ⟨0, 187517078⟩, ⟨22670689, 67365043⟩, ⟨(-4763262), 10813952⟩, ⟨(-598751), 2079493⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4378450781⟩, ⟨0, 93758539⟩, ⟨10115359, 33682522⟩, ⟨(-3116916), 5406976⟩, ⟨(-549485), 1095877⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3525309156, 4378450781⟩, ⟨(-392309191), (-291070530)⟩, ⟨(-98080), 33682522⟩, ⟨(-6134870), 4500640⟩, ⟨(-1033951), 1375153⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4342498816⟩, ⟨2171249401, 2171249408⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4390556358⟩, ⟨0, 4390556358⟩, ⟨1097639082, 1097639090⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4390556358⟩, ⟨0, 4390556358⟩, ⟨1097639082, 1097639090⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4390556358), 0⟩, ⟨(-4390556358), 0⟩, ⟨(-1097639090), (-1097639082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2195278179), 0⟩, ⟨(-2195278179), 0⟩, ⟨(-548819545), (-548819541)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2576201190, 4294967296⟩, ⟨(-2195278179), 0⟩, ⟨(-548819545), 231841950⟩, ⟨(-39500307), 280517054⟩, ⟨(-50657648), 40112061⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2114545936, 4378450781⟩, ⟨(-2630258120), (-174589512)⟩, ⟨(-559585313), 470551129⟩, ⟨(-84795862), 340650438⟩, ⟨(-84903560), 50828800⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨384829069, 384829070⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨384829069, 384829070⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4314032921, 4314032923⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar285 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified894
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar285 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 769658140⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4378450781⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified895
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(112 / 625), prawitzNormalCorrection
      ((252323 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
