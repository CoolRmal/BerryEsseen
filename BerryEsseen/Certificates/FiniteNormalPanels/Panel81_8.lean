...
namespace FiniteNormalPanel81_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6547 / 32000)
def radius : Rat := (6547 / 160000)

def j0 : Jet := ⟨⟨878723465, 878723466⟩, ⟨175744693, 175744694⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2760591182, 2760591186⟩, ⟨552118236, 552118240⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1774370594, 1774370600⟩, ⟨709748236, 709748244⟩, ⟨70974823, 70974825⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨444, 445⟩, ⟨177, 178⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94243), (-94241)⟩, ⟨177, 178⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-38935), (-38933)⟩, ⟨(-15501), (-15499)⟩, ⟨(-1522), (-1519)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5074121, 5074124⟩, ⟨(-15501), (-15499)⟩, ⟨(-1522), (-1519)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2096260, 2096262⟩, ⟨832100, 832102⟩, ⟨80659, 80663⟩, ⟨(-508), (-504)⟩, ⟨(-26), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-141069317), (-141069314)⟩, ⟨832100, 832102⟩, ⟨80659, 80663⟩, ⟨(-508), (-504)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-58279664), (-58279662)⟩, ⟨(-22968103), (-22968099)⟩, ⟨(-2160360), (-2160355)⟩, ⟨26868, 26873⟩, ⟨1237, 1241⟩⟩
...
def j19 : Jet := ⟨⟨1373376101, 1373376104⟩, ⟨(-22968103), (-22968099)⟩, ⟨(-2160360), (-2160355)⟩, ⟨26868, 26873⟩, ⟨1237, 1241⟩⟩
...
def j22 : Jet := ⟨⟨(-45), (-44)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11790, 11792⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4870, 4872⟩, ⟨1940, 1942⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847307), (-847304)⟩, ⟨1940, 1942⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-350047), (-350044)⟩, ⟨(-139218), (-139214)⟩, ⟨(-13604), (-13600)⟩, ⟨62, 65⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35441347, 35441351⟩, ⟨(-139218), (-139214)⟩, ⟨(-13604), (-13600)⟩, ⟨62, 65⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨14641807, 14641810⟩, ⟨5799207, 5799211⟩, ⟨557045, 557050⟩, ⟨(-4525), (-4520)⟩, ⟨(-215), (-211)⟩⟩
...
def j33 : Jet := ⟨⟨(-701186076), (-701186072)⟩, ⟨5799207, 5799211⟩, ⟨557045, 557050⟩, ⟨(-4525), (-4520)⟩, ⟨(-215), (-211)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-289679496), (-289679492)⟩, ⟨(-113475986), (-113475980)⟩, ⟨(-10398725), (-10398719)⟩, ⟨186014, 186020⟩, ⟨8368, 8373⟩⟩
...
def j36 : Jet := ⟨⟨4005287800, 4005287804⟩, ⟨(-113475986), (-113475980)⟩, ⟨(-10398725), (-10398719)⟩, ⟨186014, 186020⟩, ⟨8368, 8373⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨882737793, 882737797⟩, ⟨161784804, 161784811⟩, ⟨(-4341123), (-4341118)⟩, ⟨(-260446), (-260440)⟩, ⟨4248, 4253⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4605597644, 4605597649⟩, ⟨130483682, 130483692⟩, ⟨15654074, 15654085⟩, ⟨568370, 568381⟩, ⟨41053, 41065⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨946581154, 946581160⟩, ⟨200303873, 200303885⟩, ⟨3477383, 3477394⟩, ⟨295311, 295324⟩, ⟨10665, 10679⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-878723466), (-878723465)⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3416243830, 3416243831⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨208619954, 208619957⟩, ⟨88291182, 88291190⟩, ⟨10874329, 10874337⟩, ⟨454516, 454526⟩, ⟨35059, 35070⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4503587250, 4503587253⟩, ⟨88291182, 88291190⟩, ⟨10874329, 10874337⟩, ⟨454516, 454526⟩, ⟨35059, 35070⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4398040467, 4398040469⟩, ⟨43110987, 43110992⟩, ⟨5098444, 5098449⟩, ⟨171955, 171962⟩, ⟨12476, 12484⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3498228874, 3498228878⟩, ⟨(-145671572), (-145671565)⟩, ⟨2291286, 2291292⟩, ⟨(-71849), (-71841)⟩, ⟨2886, 2894⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨28853934346, 28853934352⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value393

def j47 : Jet := ⟨⟨5903334628, 5903334637⟩, ⟨1180666925, 1180666933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8113998856, 8113998882⟩, ⟨3245599540, 3245599570⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8113998856, 8113998882⟩, ⟨3245599540, 3245599570⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8113998882), (-8113998856)⟩, ⟨(-3245599570), (-3245599540)⟩, ⟨(-324559959), (-324559953)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4056999441), (-4056999428)⟩, ⟨(-1622799785), (-1622799770)⟩, ⟨(-162279980), (-162279976)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1670044290, 1670044304⟩, ⟨(-631005396), (-631005384)⟩, ⟨56108212, 56108219⟩, ⟨8827903, 8827906⟩, ⟨(-1893869), (-1893867)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1360242524, 1360242538⟩, ⟨(-570593235), (-570593219)⟩, ⟨67992474, 67992487⟩, ⟨4922700, 4922711⟩, ⟨(-1800354), (-1800343)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨702978772, 1054468159⟩, ⟨175744693, 175744694⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2208472945, 3312709422⟩, ⟨552118236, 552118240⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1135597179, 2555093662⟩, ⟨567798588, 851697892⟩, ⟨70974823, 70974825⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨284, 641⟩, ⟨142, 214⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94403), (-94045)⟩, ⟨142, 214⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-56161), (-24865)⟩, ⟨(-18684), (-12304)⟩, ⟨(-1539), (-1500)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5056895, 5088192⟩, ⟨(-18684), (-12304)⟩, ⟨(-1539), (-1500)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1337052, 3026987⟩, ⟨657410, 1005743⟩, ⟨78943, 82061⟩, ⟨(-614), (-396)⟩, ⟨(-26), (-21)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141828525), (-140138589)⟩, ⟨657410, 1005743⟩, ⟨78943, 82061⟩, ⟨(-614), (-396)⟩, ⟨(-26), (-21)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-84374372), (-37052898)⟩, ⟨(-27950971), (-17928128)⟩, ⟨(-2235951), (-2067546)⟩, ⟨20933, 32790⟩, ⟨1166, 1300⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1347281393, 1394602868⟩, ⟨(-27950971), (-17928128)⟩, ⟨(-2235951), (-2067546)⟩, ⟨20933, 32790⟩, ⟨1166, 1300⟩⟩
...
def j70 : Jet := ⟨⟨(-65), (-28)⟩, ⟨(-22), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11770, 11808⟩, ⟨(-22), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3112, 7025⟩, ⟨1542, 2339⟩, ⟨187, 195⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849065), (-845151)⟩, ⟨1542, 2339⟩, ⟨187, 195⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-505113), (-223459)⟩, ⟨(-167964), (-110337)⟩, ⟨(-13779), (-13385)⟩, ⟨47, 78⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35286281, 35567936⟩, ⟨(-167964), (-110337)⟩, ⟨(-13779), (-13385)⟩, ⟨47, 78⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9329756, 21159512⟩, ⟨4564955, 7023998⟩, ⟨541603, 569640⟩, ⟨(-5497), (-3545)⟩, ⟨(-222), (-202)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706498127), (-694668370)⟩, ⟨4564955, 7023998⟩, ⟨541603, 569640⟩, ⟨(-5497), (-3545)⟩, ⟨(-222), (-202)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-420298634), (-183671582)⟩, ⟨(-138892564), (-87657185)⟩, ⟨(-10928272), (-9747722)⟩, ⟨143765, 228097⟩, ⟨7726, 8893⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3874668662, 4111295714⟩, ⟨(-138892564), (-87657185)⟩, ⟨(-10928272), (-9747722)⟩, ⟨143765, 228097⟩, ⟨7726, 8893⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨692772331, 1075657565⟩, ⟨151634490, 170057616⟩, ⟨(-5317689), (-3367793)⟩, ⟨(-276669), (-240492)⟩, ⟨3289, 5219⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4486844381, 4760857169⟩, ⟨95664279, 170659151⟩, ⟨12677795, 19545216⟩, ⟨232983, 1015481⟩, ⟨15258, 79034⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨723721841, 1192337841⟩, ⟨173839256, 231245261⟩, ⟨(-472166), 8133960⟩, ⟨(-32808), 701963⟩, ⟨(-21073), 50492⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1054468159), (-702978772)⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3240499137, 3591988524⟩, ⟨(-175744694), (-175744693)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨121950475, 331008232⟩, ⟨58585436, 128393284⟩, ⟨6774002, 16966657⟩, ⟨(-69060), 1265630⟩, ⟨(-16131), 119031⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4416917771, 4625975528⟩, ⟨58585436, 128393284⟩, ⟨6774002, 16966657⟩, ⟨(-69060), 1265630⟩, ⟨(-16131), 119031⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4355515741, 4457399871⟩, ⟨28225258, 63304209⟩, ⟨2814050, 8273943⟩, ⟨(-154306), 605782⟩, ⟨(-24618), 60023⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3286182181, 3727834948⟩, ⟨(-161095628), (-125279366)⟩, ⟨(-467165), 5764764⟩, ⟨(-467610), 391484⟩, ⟨(-45377), 56514⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4722667702, 7084001563⟩, ⟨1180666925, 1180666933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5192959267, 11684158385⟩, ⟨2596479632, 3894719482⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5192959267, 11684158385⟩, ⟨2596479632, 3894719482⟩, ⟨324559953, 324559959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11684158385), (-5192959267)⟩, ⟨(-3894719482), (-2596479632)⟩, ⟨(-324559959), (-324559953)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5842079193), (-2596479633)⟩, ⟨(-1947359741), (-1298239816)⟩, ⟨(-162279980), (-162279976)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1102112592, 2346450874⟩, ⟨(-1063892610), (-333135586)⟩, ⟨(-38309270), 199545179⟩, ⟨(-21766855), 32588442⟩, ⟨(-7463724), 3191035⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨843252698, 2036611916⟩, ⟨(-1011420748), (-287037386)⟩, ⟨(-23788728), 216250001⟩, ⟨(-28060615), 30051779⟩, ⟨(-7873684), 4000645⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨878723465, 878723466⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨175744693, 175744694⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4398040467, 4398040469⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar393 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1634
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar393 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨702978772, 1054468159⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4355515741, 4457399871⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1635
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((6547 / 40000) : ℝ)..(19641 / 80000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (6547 / 40000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (19641 / 80000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((6547 / 40000) : ℝ)..(19641 / 80000), prawitzNormalCorrection
      ((2969 / 1250) * sqrt n) s) ≤ (upper : ℝ) :=
