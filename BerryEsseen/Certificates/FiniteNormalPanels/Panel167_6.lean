...
namespace FiniteNormalPanel167_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (25169 / 160000)
def radius : Rat := (25169 / 800000)

def j0 : Jet := ⟨⟨675625199, 675625200⟩, ⟨135125039, 135125040⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2122539161, 2122539165⟩, ⟨424507829, 424507833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1048942210, 1048942215⟩, ⟨419576880, 419576886⟩, ⟨41957687, 41957689⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨262, 263⟩, ⟨105, 106⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94425), (-94423)⟩, ⟨105, 106⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-23062), (-23060)⟩, ⟨(-9200), (-9198)⟩, ⟨(-911), (-908)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5089994, 5089997⟩, ⟨(-9200), (-9198)⟩, ⟨(-911), (-908)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1243108, 1243110⟩, ⟨494996, 494998⟩, ⟨48602, 48606⟩, ⟨(-179), (-176)⟩, ⟨(-9), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-141922469), (-141922466)⟩, ⟨494996, 494998⟩, ⟨48602, 48606⟩, ⟨(-179), (-176)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-34661142), (-34661140)⟩, ⟨(-13743567), (-13743564)⟩, ⟨(-1326221), (-1326217)⟩, ⟨9538, 9543⟩, ⟨453, 457⟩⟩
...
def j19 : Jet := ⟨⟨1396994623, 1396994626⟩, ⟨(-13743567), (-13743564)⟩, ⟨(-1326221), (-1326217)⟩, ⟨9538, 9543⟩, ⟨453, 457⟩⟩
...
def j25 : Jet := ⟨⟨2883, 2885⟩, ⟨1150, 1152⟩, ⟨112, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849294), (-849291)⟩, ⟨1150, 1152⟩, ⟨112, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-207420), (-207418)⟩, ⟨(-82688), (-82685)⟩, ⟨(-8158), (-8154)⟩, ⟨20, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35583974, 35583977⟩, ⟨(-82688), (-82685)⟩, ⟨(-8158), (-8154)⟩, ⟨20, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨8690527, 8690529⟩, ⟨3456016, 3456019⟩, ⟨337550, 337554⟩, ⟨(-1601), (-1597)⟩, ⟨(-80), (-75)⟩⟩
...
def j33 : Jet := ⟨⟨(-707137356), (-707137353)⟩, ⟨3456016, 3456019⟩, ⟨337550, 337554⟩, ⟨(-1601), (-1597)⟩, ⟨(-80), (-75)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-172701251), (-172701249)⟩, ⟨(-68236453), (-68236449)⟩, ⟨(-6487994), (-6487989)⟩, ⟨66344, 66348⟩, ⟨3120, 3124⟩⟩
...
def j36 : Jet := ⟨⟨4122266045, 4122266047⟩, ⟨(-68236453), (-68236449)⟩, ⟨(-6487994), (-6487989)⟩, ⟨66344, 66348⟩, ⟨3120, 3124⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨690383788, 690383792⟩, ⟨131284792, 131284798⟩, ⟨(-2013802), (-2013798)⟩, ⟨(-126369), (-126364)⟩, ⟨1165, 1170⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4474903818, 4474903821⟩, ⟨74073711, 74073717⟩, ⟨8269152, 8269161⟩, ⟨181438, 181448⟩, ⟨11432, 11442⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨719307234, 719307240⟩, ⟨148691726, 148691736⟩, ⟨1495254, 1495262⟩, ⟨115532, 115544⟩, ⟨2538, 2551⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-675625200), (-675625199)⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3619342096, 3619342097⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨120467249, 120467252⟩, ⟨49804818, 49804824⟩, ⟨5648546, 5648551⟩, ⟨142226, 142234⟩, ⟨9368, 9379⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4415434545, 4415434548⟩, ⟨49804818, 49804824⟩, ⟨5648546, 5648551⟩, ⟨142226, 142234⟩, ⟨9368, 9379⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4354784376, 4354784379⟩, ⟨24560350, 24560354⟩, ⟨2716220, 2716224⟩, ⟨54816, 54822⟩, ⟨3462, 3470⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3669749575, 3669749579⟩, ⟨(-116310108), (-116310102)⟩, ⟨1516241, 1516246⟩, ⟨(-39263), (-39256)⟩, ⟨1192, 1201⟩⟩
...
def j47 : Jet := ⟨⟨8469856483, 8469856498⟩, ⟨1693971286, 1693971300⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16702913875, 16702913935⟩, ⟨6681165508, 6681165576⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16702913875, 16702913935⟩, ⟨6681165508, 6681165576⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16702913935), (-16702913875)⟩, ⟨(-6681165576), (-6681165508)⟩, ⟨(-668116558), (-668116546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8351456968), (-8351456937)⟩, ⟨(-3340582788), (-3340582754)⟩, ⟨(-334058279), (-334058273)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨614447884, 614447895⟩, ⟨(-477911454), (-477911439)⟩, ⟨138066231, 138066242⟩, ⟨(-11014533), (-11014528)⟩, ⟨(-3227580), (-3227578)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨525002801, 525002812⟩, ⟨(-424981551), (-424981535)⟩, ⟨131126974, 131126988⟩, ⟨(-13324396), (-13324385)⟩, ⟨(-2406184), (-2406176)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨540500159, 810750240⟩, ⟨135125039, 135125040⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1698031328, 2547046998⟩, ⟨424507829, 424507833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨671323014, 1510476789⟩, ⟨335661504, 503492264⟩, ⟨41957687, 41957689⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨168, 379⟩, ⟨84, 127⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94519), (-94307)⟩, ⟨84, 127⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-33241), (-14740)⟩, ⟨(-11068), (-7325)⟩, ⟨(-917), (-902)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5079815, 5098317⟩, ⟨(-11068), (-7325)⟩, ⟨(-917), (-902)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨793998, 1793004⟩, ⟨393106, 596524⟩, ⟨48003, 49094⟩, ⟨(-217), (-139)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142371579), (-141372572)⟩, ⟨393106, 596524⟩, ⟨48003, 49094⟩, ⟨(-217), (-139)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-50069990), (-22097178)⟩, ⟨(-16628553), (-10838800)⟩, ⟨(-1352609), (-1293877)⟩, ⟨7514, 11563⟩, ⟨438, 470⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1381585775, 1409558588⟩, ⟨(-16628553), (-10838800)⟩, ⟨(-1352609), (-1293877)⟩, ⟨7514, 11563⟩, ⟨438, 470⟩⟩
...
def j72 : Jet := ⟨⟨1843, 4157⟩, ⟨916, 1385⟩, ⟨112, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850334), (-848019)⟩, ⟨916, 1385⟩, ⟨112, 116⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-299050), (-132549)⟩, ⟨(-99541), (-65786)⟩, ⟨(-8219), (-8080)⟩, ⟨15, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35492344, 35658846⟩, ⟨(-99541), (-65786)⟩, ⟨(-8219), (-8080)⟩, ⟨15, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5547615, 12540692⟩, ⟨2738799, 4169949⟩, ⟨332164, 341950⟩, ⟨(-1935), (-1263)⟩, ⟨(-81), (-73)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710280268), (-703287190)⟩, ⟨2738799, 4169949⟩, ⟨332164, 341950⟩, ⟨(-1935), (-1263)⟩, ⟨(-81), (-73)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-249795118), (-109927001)⟩, ⟨(-82836954), (-53496990)⟩, ⟨(-6672793), (-6261341)⟩, ⟨52033, 80627⟩, ⟨2988, 3232⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4045172178, 4185040295⟩, ⟨(-82836954), (-53496990)⟩, ⟨(-6672793), (-6261341)⟩, ⟨52033, 80627⟩, ⟨2988, 3232⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨546215085, 835911364⟩, ⟨126692529, 135033402⟩, ⟨(-2445680), (-1582828)⟩, ⟨(-130720), (-121026)⟩, ⟨915, 1422⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4407781711, 4560187617⟩, ⟨56344272, 93383431⟩, ⟨7314832, 9434652⟩, ⟨89947, 290550⟩, ⟨6770, 17534⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨560562327, 887530077⟩, ⟨137185934, 161546731⟩, ⟨(-4400), 3147792⟩, ⟨35242, 208206⟩, ⟨(-3764), 9776⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-810750240), (-540500159)⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3484217056, 3754467137⟩, ⟨(-135125040), (-135125039)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨73162401, 183402942⟩, ⟨35809942, 66765390⟩, ⟨4380048, 7377208⟩, ⟨8866, 322846⟩, ⟨690, 22014⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4368129697, 4478370238⟩, ⟨35809942, 66765390⟩, ⟨4380048, 7377208⟩, ⟨8866, 322846⟩, ⟨690, 22014⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4331394024, 4385710172⟩, ⟨17534506, 33101949⟩, ⟨2019789, 3622092⟩, ⟨(-23286), 151890⟩, ⟨(-2334), 10623⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3513767601, 3833790476⟩, ⟨(-123755364), (-107334834)⟩, ⟨597089, 2614613⟩, ⟨(-134312), 69231⟩, ⟨(-6820), 10020⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6775885184, 10163827798⟩, ⟨1693971286, 1693971300⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10689864872, 24052196068⟩, ⟨5344932404, 8017398692⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10689864872, 24052196068⟩, ⟨5344932404, 8017398692⟩, ⟨668116546, 668116558⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-24052196068), (-10689864872)⟩, ⟨(-8017398692), (-5344932404)⟩, ⟨(-668116558), (-668116546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12026098034), (-5344932436)⟩, ⟨(-4008699346), (-2672466202)⟩, ⟨(-334058279), (-334058273)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨261165696, 1237359765⟩, ⟨(-1154887323), (-162505660)⟩, ⟨(-45682498), 518642708⟩, ⟨(-152931702), 74096548⟩, ⟨(-37459224), 37461197⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨213662991, 1104496905⟩, ⟨(-1066533368), (-139474704)⟩, ⟨(-36679831), 496983108⟩, ⟨(-152196433), 67454003⟩, ⟨(-35620411), 38200074⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨675625199, 675625200⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4354784376, 4354784379⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3374
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨540500159, 810750240⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4331394024, 4385710172⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3375
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (18132749 / 2147483648)

theorem envelope_integral : (∫ s in ((25169 / 200000) : ℝ)..(75507 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((25169 / 200000) : ℝ)..(75507 / 400000), prawitzNormalCorrection
