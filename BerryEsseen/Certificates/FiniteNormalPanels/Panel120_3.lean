...
namespace FiniteNormalPanel120_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (1977 / 25000)
def radius : Rat := (1977 / 25000)

def j0 : Jet := ⟨⟨339646013, 339646014⟩, ⟨339646013, 339646014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1067029419, 1067029423⟩, ⟨1067029419, 1067029423⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨265089744, 265089746⟩, ⟨530179488, 530179492⟩, ⟨265089744, 265089746⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨66, 67⟩, ⟨132, 133⟩, ⟨66, 67⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94621), (-94619)⟩, ⟨132, 133⟩, ⟨66, 67⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-5841), (-5839)⟩, ⟨(-11673), (-11670)⟩, ⟨(-5821), (-5817)⟩, ⟨16, 18⟩, ⟨4, 5⟩⟩
...
def j13 : Jet := ⟨⟨5107215, 5107218⟩, ⟨(-11673), (-11670)⟩, ⟨(-5821), (-5817)⟩, ⟨16, 18⟩, ⟨4, 5⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨315222, 315223⟩, ⟨629723, 629726⟩, ⟨313421, 313424⟩, ⟨(-1440), (-1436)⟩, ⟨(-359), (-355)⟩⟩
...
def j16 : Jet := ⟨⟨(-142850355), (-142850353)⟩, ⟨629723, 629726⟩, ⟨313421, 313424⟩, ⟨(-1440), (-1436)⟩, ⟨(-359), (-355)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-8816870), (-8816868)⟩, ⟨(-17594872), (-17594869)⟩, ⟨(-8719792), (-8719788)⟩, ⟨77467, 77470⟩, ⟨19143, 19147⟩⟩
...
def j19 : Jet := ⟨⟨1422838895, 1422838898⟩, ⟨(-17594872), (-17594869)⟩, ⟨(-8719792), (-8719788)⟩, ⟨77467, 77470⟩, ⟨19143, 19147⟩⟩
...
def j25 : Jet := ⟨⟨730, 731⟩, ⟨1459, 1461⟩, ⟨727, 730⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851447), (-851445)⟩, ⟨1459, 1461⟩, ⟨727, 730⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-52553), (-52552)⟩, ⟨(-105015), (-105013)⟩, ⟨(-52329), (-52325)⟩, ⟨178, 182⟩, ⟨42, 46⟩⟩
...
def j30 : Jet := ⟨⟨35738841, 35738843⟩, ⟨(-105015), (-105013)⟩, ⟨(-52329), (-52325)⟩, ⟨178, 182⟩, ⟨42, 46⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2205837, 2205838⟩, ⟨4405193, 4405195⟩, ⟨2189643, 2189646⟩, ⟨(-12932), (-12928)⟩, ⟨(-3207), (-3203)⟩⟩
...
def j33 : Jet := ⟨⟨(-713622046), (-713622044)⟩, ⟨4405193, 4405195⟩, ⟨2189643, 2189646⟩, ⟨(-12932), (-12928)⟩, ⟨(-3207), (-3203)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-44045478), (-44045477)⟩, ⟨(-87819064), (-87819060)⟩, ⟨(-43366547), (-43366542)⟩, ⟨541386, 541392⟩, ⟨133351, 133356⟩⟩
...
def j36 : Jet := ⟨⟨4250921818, 4250921819⟩, ⟨(-87819064), (-87819060)⟩, ⟨(-43366547), (-43366542)⟩, ⟨541386, 541392⟩, ⟨133351, 133356⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨353486034, 353486037⟩, ⟨349114814, 349114818⟩, ⟨(-6537541), (-6537538)⟩, ⟨(-2147076), (-2147072)⟩, ⟨24000, 24004⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4339469145, 4339469147⟩, ⟨89648343, 89648349⟩, ⟨46121901, 46121910⟩, ⟨1314717, 1314727⟩, ⟨350127, 350138⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨357148642, 357148646⟩, ⟨360110402, 360110408⟩, ⟨4477694, 4477701⟩, ⟨1551424, 1551434⟩, ⟨44910, 44921⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-339646014), (-339646013)⟩, ⟨(-339646014), (-339646013)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3955321282, 3955321283⟩, ⟨(-339646014), (-339646013)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨29698748, 29698749⟩, ⟨59890066, 59890070⟩, ⟨30938047, 30938051⟩, ⟨1008878, 1008884⟩, ⟨272292, 272301⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4324666044, 4324666045⟩, ⟨59890066, 59890070⟩, ⟨30938047, 30938051⟩, ⟨1008878, 1008884⟩, ⟨272292, 272301⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4309791088, 4309791089⟩, ⟨29842035, 29842038⟩, ⟨15312499, 15312503⟩, ⟨396675, 396680⟩, ⟨105727, 105734⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3968972808, 3968972811⟩, ⟨(-313336154), (-313336148)⟩, ⟨11741677, 11741683⟩, ⟨(-845608), (-845601)⟩, ⟨65996, 66004⟩⟩
...
def j47 : Jet := ⟨⟨2391516262, 2391516270⟩, ⟨2391516262, 2391516270⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1331639949, 1331639959⟩, ⟨2663279898, 2663279918⟩, ⟨1331639949, 1331639959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1331639949, 1331639959⟩, ⟨2663279898, 2663279918⟩, ⟨1331639949, 1331639959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1331639959), (-1331639949)⟩, ⟨(-2663279918), (-2663279898)⟩, ⟨(-1331639959), (-1331639949)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-665819980), (-665819974)⟩, ⟨(-1331639959), (-1331639949)⟩, ⟨(-665819980), (-665819974)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3678189495, 3678189503⟩, ⟨(-1140410109), (-1140410097)⟩, ⟨(-393414927), (-393414915)⟩, ⟨158519069, 158519074⟩, ⟨18207163, 18207166⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3399009371, 3399009382⟩, ⟨(-1322190853), (-1322190833)⟩, ⟨(-270300855), (-270300834)⟩, ⟨171346668, 171346687⟩, ⟨4466085, 4466103⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 679292028⟩, ⟨339646013, 339646014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2134058845⟩, ⟨1067029419, 1067029423⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1060358983⟩, ⟨0, 1060358984⟩, ⟨265089744, 265089746⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 266⟩, ⟨0, 266⟩, ⟨66, 67⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94420)⟩, ⟨0, 266⟩, ⟨66, 67⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-23377), 0⟩, ⟨(-23377), 66⟩, ⟨(-5845), (-5744)⟩, ⟨0, 34⟩, ⟨4, 5⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5089679, 5113057⟩, ⟨(-23377), 66⟩, ⟨(-5845), (-5744)⟩, ⟨0, 34⟩, ⟨4, 5⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1262333⟩, ⟨(-5772), 1262350⟩, ⟨306924, 315601⟩, ⟨(-2887), 14⟩, ⟨(-361), (-343)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141903243)⟩, ⟨(-5772), 1262350⟩, ⟨306924, 315601⟩, ⟨(-2887), 14⟩, ⟨(-361), (-343)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-35345300), 0⟩, ⟨(-35346726), 311655⟩, ⟨(-8837751), (-8368840)⟩, ⟨(-1070), 155835⟩, ⟨18140, 19484⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1396310465, 1431655766⟩, ⟨(-35346726), 311655⟩, ⟨(-8837751), (-8368840)⟩, ⟨(-1070), 155835⟩, ⟨18140, 19484⟩⟩
...
def j70 : Jet := ⟨⟨(-27), 0⟩, ⟨(-27), 0⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11808, 11836⟩, ⟨(-27), 0⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 2923⟩, ⟨(-7), 2923⟩, ⟨719, 731⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-849253)⟩, ⟨(-7), 2923⟩, ⟨719, 731⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-210389), 0⟩, ⟨(-210391), 722⟩, ⟨(-52600), (-51513)⟩, ⟨(-2), 362⟩, ⟨42, 46⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35581005, 35791395⟩, ⟨(-210391), 722⟩, ⟨(-52600), (-51513)⟩, ⟨(-2), 362⟩, ⟨42, 46⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 8836326⟩, ⟨(-51943), 8836505⟩, ⟨2131165, 2209261⟩, ⟨(-25974), 135⟩, ⟨(-3248), (-3077)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-706991556)⟩, ⟨(-51943), 8836505⟩, ⟨2131165, 2209261⟩, ⟨(-25974), 135⟩, ⟨(-3248), (-3077)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-176726498), 0⟩, ⟨(-176739322), 2181593⟩, ⟨(-44194449), (-40909211)⟩, ⟨(-9619), 1090865⟩, ⟨124322, 136392⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4118240798, 4294967296⟩, ⟨(-176739322), 2181593⟩, ⟨(-44194449), (-40909211)⟩, ⟨(-9619), 1090865⟩, ⟨124322, 136392⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 711352949⟩, ⟨329332507, 355831329⟩, ⟨(-13172692), 77427⟩, ⟨(-2196158), (-2001699)⟩, ⟨(-266), 48398⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4479277677⟩, ⟨(-2372849), 192233661⟩, ⟨40811567, 56318820⟩, ⟨(-1241799), 4490390⟩, ⟨146554, 668064⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 741879313⟩, ⟨328939504, 402939812⟩, ⟨(-13934561), 25334801⟩, ⟨43720, 3415226⟩, ⟨(-374187), 535375⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-679292028), 0⟩, ⟨(-339646014), (-339646013)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3615675268, 4294967296⟩, ⟨(-339646014), (-339646013)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 128146475⟩, ⟨0, 139201392⟩, ⟨20378658, 46554772⟩, ⟨(-2614592), 5933498⟩, ⟨(-204771), 975209⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4423113771⟩, ⟨0, 139201392⟩, ⟨20378658, 46554772⟩, ⟨(-2614592), 5933498⟩, ⟨(-204771), 975209⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4358569605⟩, ⟨0, 69600696⟩, ⟨9484924, 23277386⟩, ⟨(-1684511), 2966749⟩, ⟨(-213541), 504430⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3615675268, 4358569605⟩, ⟨(-344675685), (-270045317)⟩, ⟨2480764, 23277386⟩, ⟨(-3525287), 2216682⟩, ⟨(-448152), 637642⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4783032540⟩, ⟨2391516262, 2391516270⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 5326559833⟩, ⟨0, 5326559834⟩, ⟨1331639949, 1331639959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 5326559833⟩, ⟨0, 5326559834⟩, ⟨1331639949, 1331639959⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5326559833), 0⟩, ⟨(-5326559834), 0⟩, ⟨(-1331639959), (-1331639949)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2663279917), 0⟩, ⟨(-2663279917), 0⟩, ⟨(-665819980), (-665819974)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2310238491, 4294967296⟩, ⟨(-2663279917), 0⟩, ⟨(-665819980), 467600075⟩, ⟨(-96651873), 412870427⟩, ⟨(-100248986), 66592096⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1944851171, 4358569605⟩, ⟨(-3047394960), (-145255840)⟩, ⟨(-674345432), 711532989⟩, ⟨(-153567988), 474633890⟩, ⟨(-140298061), 80692542⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨339646013, 339646014⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨339646013, 339646014⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4309791088, 4309791089⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2410
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 679292028⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4358569605⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2411
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (525889531 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(1977 / 12500),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(1977 / 12500), prawitzNormalCorrection
