...
namespace FiniteNormalPanel55_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (230923 / 800000)
def radius : Rat := (32989 / 800000)

def j0 : Jet := ⟨⟨1239758416, 1239758417⟩, ⟨177108345, 177108346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3894815931, 3894815936⟩, ⟨556402275, 556402279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3531945668, 3531945678⟩, ⟨1009127332, 1009127342⟩, ⟨72080523, 72080525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨884, 885⟩, ⟨252, 253⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93803), (-93801)⟩, ⟨252, 253⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-77139), (-77136)⟩, ⟨(-21833), (-21830)⟩, ⟨(-1502), (-1498)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5035917, 5035921⟩, ⟨(-21833), (-21830)⟩, ⟨(-1502), (-1498)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4141262, 4141266⟩, ⟨1165262, 1165268⟩, ⟨78149, 78156⟩, ⟨(-714), (-708)⟩, ⟨(-25), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-139024315), (-139024310)⟩, ⟨1165262, 1165268⟩, ⟨78149, 78156⟩, ⟨(-714), (-708)⟩, ⟨(-25), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-114325977), (-114325971)⟩, ⟨(-31706318), (-31706310)⟩, ⟨(-1995134), (-1995124)⟩, ⟨37329, 37339⟩, ⟨1122, 1129⟩⟩
...
def j19 : Jet := ⟨⟨1317329788, 1317329795⟩, ⟨(-31706318), (-31706310)⟩, ⟨(-1995134), (-1995124)⟩, ⟨37329, 37339⟩, ⟨1122, 1129⟩⟩
...
def j22 : Jet := ⟨⟨(-89), (-87)⟩, ⟨(-26), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11746, 11749⟩, ⟨(-26), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9659, 9662⟩, ⟨2737, 2741⟩, ⟨188, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842518), (-842514)⟩, ⟨2737, 2741⟩, ⟨188, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-692841), (-692837)⟩, ⟨(-195705), (-195698)⟩, ⟨(-13343), (-13335)⟩, ⟨87, 93⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35098553, 35098558⟩, ⟨(-195705), (-195698)⟩, ⟨(-13343), (-13335)⟩, ⟨87, 93⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨28863125, 28863131⟩, ⟨8085669, 8085678⟩, ⟨532087, 532099⟩, ⟨(-6350), (-6340)⟩, ⟨(-204), (-197)⟩⟩
...
def j33 : Jet := ⟨⟨(-686964758), (-686964751)⟩, ⟨8085669, 8085678⟩, ⟨532087, 532099⟩, ⟨(-6350), (-6340)⟩, ⟨(-204), (-197)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-564922162), (-564922154)⟩, ⟨(-154757123), (-154757110)⟩, ⟨(-9191691), (-9191676)⟩, ⟨255492, 255506⟩, ⟨7269, 7279⟩⟩
...
def j36 : Jet := ⟨⟨3730045134, 3730045142⟩, ⟨(-154757123), (-154757110)⟩, ⟨(-9191691), (-9191676)⟩, ⟨255492, 255506⟩, ⟨7269, 7279⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1194597465, 1194597474⟩, ⟨141904460, 141904471⟩, ⟨(-5916728), (-5916716)⟩, ⟨(-224614), (-224602)⟩, ⟨5852, 5862⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4945447942, 4945447954⟩, ⟨205183369, 205183389⟩, ⟨20699625, 20699650⟩, ⟨1025669, 1025694⟩, ⟨69855, 69876⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1375521434, 1375521448⟩, ⟨220465624, 220465645⟩, ⟨5723740, 5723765⟩, ⟨427894, 427920⟩, ⟨20807, 20831⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1239758417), (-1239758416)⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3055208879, 3055208880⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨440529364, 440529374⟩, ⟨141214202, 141214218⟩, ⟨14982964, 14982985⟩, ⟨861688, 861712⟩, ⟨64881, 64904⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4735496660, 4735496670⟩, ⟨141214202, 141214218⟩, ⟨14982964, 14982985⟩, ⟨861688, 861712⟩, ⟨64881, 64904⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4509856237, 4509856243⟩, ⟨67242761, 67242770⟩, ⟨6633221, 6633232⟩, ⟨311411, 311425⟩, ⟨21372, 21386⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3208069321, 3208069327⟩, ⟨(-138136676), (-138136666)⟩, ⟨1945676, 1945686⟩, ⟨(-52009), (-51997)⟩, ⟨2360, 2372⟩⟩
...
def j47 : Jet := ⟨⟨8669477867, 8669477876⟩, ⟨1238496837, 1238496845⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨17499515434, 17499515471⟩, ⟨4999861548, 4999861586⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨17499515434, 17499515471⟩, ⟨4999861548, 4999861586⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-17499515471), (-17499515434)⟩, ⟨(-4999861586), (-4999861548)⟩, ⟨(-357132973), (-357132967)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8749757736), (-8749757717)⟩, ⟨(-2499930793), (-2499930774)⟩, ⟨(-178566487), (-178566483)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨560028392, 560028407⟩, ⟨(-325970413), (-325970400)⟩, ⟨71583644, 71583651⟩, ⟨(-4853697), (-4853693)⟩, ⟨(-781787), (-781785)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨418305840, 418305853⟩, ⟨(-261491200), (-261491186)⟩, ⟨64206167, 64206177⟩, ⟨(-6082164), (-6082154)⟩, ⟨(-391159), (-391150)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1062650070, 1416866762⟩, ⟨177108345, 177108346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3338413653, 4451218211⟩, ⟨556402275, 556402279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2594898854, 4613153535⟩, ⟨864966284, 1153288390⟩, ⟨72080523, 72080525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨649, 1156⟩, ⟨216, 289⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94038), (-93530)⟩, ⟨216, 289⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-101005), (-56508)⟩, ⟨(-25122), (-18525)⟩, ⟨(-1526), (-1470)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5012051, 5056549⟩, ⟨(-25122), (-18525)⟩, ⟨(-1526), (-1470)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3028140, 5431156⟩, ⟨982396, 1346597⟩, ⟨75729, 80244⟩, ⟨(-829), (-594)⟩, ⟨(-25), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140137437), (-137734420)⟩, ⟨982396, 1346597⟩, ⟨75729, 80244⟩, ⟨(-829), (-594)⟩, ⟨(-25), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-150519310), (-83215275)⟩, ⟨(-37036292), (-26292067)⟩, ⟨(-2108267), (-1863756)⟩, ⟨30847, 43790⟩, ⟨1020, 1217⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1281136455, 1348440491⟩, ⟨(-37036292), (-26292067)⟩, ⟨(-2108267), (-1863756)⟩, ⟨30847, 43790⟩, ⟨1020, 1217⟩⟩
...
def j70 : Jet := ⟨⟨(-117), (-64)⟩, ⟨(-30), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11718, 11772⟩, ⟨(-30), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7079, 12645⟩, ⟨2326, 3150⟩, ⟨184, 194⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845098), (-839531)⟩, ⟨2326, 3150⟩, ⟨184, 194⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-907706), (-507221)⟩, ⟨(-225522), (-165689)⟩, ⟨(-13604), (-13034)⟩, ⟨73, 106⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34883688, 35284174⟩, ⟨(-225522), (-165689)⟩, ⟨(-13604), (-13034)⟩, ⟨73, 106⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21075746, 37898150⟩, ⟨6783018, 9374434⟩, ⟨510267, 550917⟩, ⟨(-7394), (-5290)⟩, ⟨(-215), (-184)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694752137), (-677929732)⟩, ⟨6783018, 9374434⟩, ⟨510267, 550917⟩, ⟨(-7394), (-5290)⟩, ⟨(-215), (-184)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-746221812), (-409586141)⟩, ⟨(-182457345), (-126459788)⟩, ⟨(-9985391), (-8268429)⟩, ⟨208657, 302064⟩, ⟨6346, 8070⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3548745484, 3885381155⟩, ⟨(-182457345), (-126459788)⟩, ⟨(-9985391), (-8268429)⟩, ⟨208657, 302064⟩, ⟨6346, 8070⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨995808148, 1397496758⟩, ⟨127584351, 154250667⟩, ⟨(-6982926), (-4854740)⟩, ⟨(-249145), (-196060)⟩, ⟨4788, 6935⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4747730875, 5198102867⟩, ⟨154527191, 267258404⟩, ⟨15133070, 28367307⟩, ⟨417270, 1931348⟩, ⟨14209, 161546⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1100783490, 1691359074⟩, ⟨176861788, 273646692⟩, ⟨(-352294), 13462038⟩, ⟨(-189774), 1255820⟩, ⟨(-40644), 106163⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1416866762), (-1062650070)⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2878100534, 3232317226⟩, ⟨(-177108346), (-177108345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨282126546, 666057579⟩, ⟨90657982, 215524258⟩, ⟨7005495, 28037652⟩, ⟨(-194360), 2704510⟩, ⟨(-57301), 285838⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4577093842, 4961024875⟩, ⟨90657982, 215524258⟩, ⟨7005495, 28037652⟩, ⟨(-194360), 2704510⟩, ⟨(-57301), 285838⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4433787135, 4615998223⟩, ⟨42176475, 104388147⟩, ⟨2078801, 13379302⟩, ⟨(-409138), 1290143⟩, ⟨(-78316), 147591⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2971125096, 3473919484⟩, ⟨(-162083581), (-104272061)⟩, ⟨(-2911551), 8329830⟩, ⟨(-859624), 885219⟩, ⟨(-112141), 127947⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7430981023, 9907974714⟩, ⟨1238496837, 1238496845⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12856786829, 22856509996⟩, ⟨4285595608, 5714127526⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12856786829, 22856509996⟩, ⟨4285595608, 5714127526⟩, ⟨357132967, 357132973⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-22856509996), (-12856786829)⟩, ⟨(-5714127526), (-4285595608)⟩, ⟨(-357132973), (-357132967)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-11428254998), (-6428393414)⟩, ⟨(-2857063763), (-2142797804)⟩, ⟨(-178566487), (-178566483)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨300170679, 961478544⟩, ⟨(-639587061), (-149757850)⟩, ⟨(-2616424), 200250672⟩, ⟨(-40252187), 18307701⟩, ⟨(-7207412), 6748450⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨207648760, 777677412⟩, ⟨(-553604644), (-110885296)⟩, ⟨867739, 187971218⟩, ⟨(-41547318), 15538389⟩, ⟨(-6813182), 7522451⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1239758416, 1239758417⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4509856237, 4509856243⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1088
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1062650070, 1416866762⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4433787135, 4615998223⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1089
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (18193945 / 2147483648)

theorem envelope_integral : (∫ s in ((98967 / 400000) : ℝ)..(32989 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (98967 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (32989 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((98967 / 400000) : ℝ)..(32989 / 100000), prawitzNormalCorrection
