...
namespace FiniteNormalPanel6_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8627 / 32000)
def radius : Rat := (8627 / 160000)

def j0 : Jet := ⟨⟨1157896339, 1157896340⟩, ⟨231579267, 231579268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3637638632, 3637638636⟩, ⟨727527723, 727527728⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3080911658, 3080911666⟩, ⟨1232364656, 1232364668⟩, ⟨123236465, 123236467⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨771, 772⟩, ⟨308, 309⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93916), (-93914)⟩, ⟨308, 309⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-67369), (-67367)⟩, ⟨(-26728), (-26724)⟩, ⟨(-2586), (-2582)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5045687, 5045690⟩, ⟨(-26728), (-26724)⟩, ⟨(-2586), (-2582)⟩, ⟨16, 18⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3619425, 3619429⟩, ⟨1428597, 1428603⟩, ⟨135251, 135259⟩, ⟨(-1499), (-1493)⟩, ⟨(-71), (-67)⟩⟩
...
def j16 : Jet := ⟨⟨(-139546152), (-139546147)⟩, ⟨1428597, 1428603⟩, ⟨135251, 135259⟩, ⟨(-1499), (-1493)⟩, ⟨(-71), (-67)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-100100732), (-100100727)⟩, ⟨(-39015517), (-39015509)⟩, ⟨(-3497101), (-3497090)⟩, ⟨78722, 78733⟩, ⟨3398, 3406⟩⟩
...
def j19 : Jet := ⟨⟨1331555033, 1331555039⟩, ⟨(-39015517), (-39015509)⟩, ⟨(-3497101), (-3497090)⟩, ⟨78722, 78733⟩, ⟨3398, 3406⟩⟩
...
def j22 : Jet := ⟨⟨(-78), (-76)⟩, ⟨(-31), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11757, 11760⟩, ⟨(-31), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8433, 8436⟩, ⟨3350, 3354⟩, ⟨325, 328⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843744), (-843740)⟩, ⟨3350, 3354⟩, ⟨325, 328⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-605244), (-605240)⟩, ⟨(-239695), (-239690)⟩, ⟨(-23016), (-23010)⟩, ⟨186, 192⟩, ⟨7, 10⟩⟩
...
def j30 : Jet := ⟨⟨35186150, 35186155⟩, ⟨(-239695), (-239690)⟩, ⟨(-23016), (-23010)⟩, ⟨186, 192⟩, ⟨7, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25240103, 25240108⟩, ⟨9924100, 9924107⟩, ⟨924316, 924326⟩, ⟨(-13350), (-13341)⟩, ⟨(-603), (-596)⟩⟩
...
def j33 : Jet := ⟨⟨(-690587780), (-690587774)⟩, ⟨9924100, 9924107⟩, ⟨924316, 924326⟩, ⟨(-13350), (-13341)⟩, ⟨(-603), (-596)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-495379779), (-495379772)⟩, ⟨(-191033051), (-191033041)⟩, ⟨(-16304608), (-16304595)⟩, ⟨540393, 540405⟩, ⟨22257, 22268⟩⟩
...
def j36 : Jet := ⟨⟨3799587517, 3799587524⟩, ⟨(-191033051), (-191033041)⟩, ⟨(-16304608), (-16304595)⟩, ⟨540393, 540405⟩, ⟨22257, 22268⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1127765520, 1127765527⟩, ⟨192508764, 192508775⟩, ⟨(-9570751), (-9570739)⟩, ⟨(-525704), (-525690)⟩, ⟨16211, 16222⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4854933320, 4854933330⟩, ⟨244092988, 244093004⟩, ⟨33105578, 33105599⟩, ⟨2021393, 2021415⟩, ⟨180518, 180541⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1274800486, 1274800498⟩, ⟨281701066, 281701085⟩, ⟨8814969, 8814993⟩, ⟨876457, 876483⟩, ⟨52677, 52701⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1157896340), (-1157896339)⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3137070956, 3137070957⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨378376869, 378376877⟩, ⟨167224860, 167224876⟩, ⟨23709177, 23709197⟩, ⟨1676608, 1676632⟩, ⟨164331, 164354⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4673344165, 4673344173⟩, ⟨167224860, 167224876⟩, ⟨23709177, 23709197⟩, ⟨1676608, 1676632⟩, ⟨164331, 164354⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4480162982, 4480162987⟩, ⟨80156157, 80156166⟩, ⟨10647506, 10647517⟩, ⟨613152, 613165⟩, ⟨55145, 55159⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3272339042, 3272339048⟩, ⟨(-183018231), (-183018221)⟩, ⟨3455083, 3455094⟩, ⟨(-126251), (-126240)⟩, ⟨7216, 7229⟩⟩
...
def j47 : Jet := ⟨⟨4466397781, 4466397787⟩, ⟨893279553, 893279558⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4644670788, 4644670802⟩, ⟨1857868308, 1857868322⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4644670788, 4644670802⟩, ⟨1857868308, 1857868322⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4644670802), (-4644670788)⟩, ⟨(-1857868322), (-1857868308)⟩, ⟨(-185786833), (-185786830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2322335401), (-2322335394)⟩, ⟨(-928934161), (-928934154)⟩, ⟨(-92893417), (-92893415)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2501106146, 2501106159⟩, ⟨(-540950092), (-540950084)⟩, ⟨4404505, 4404509⟩, ⟨7482392, 7482394⟩, ⟨(-452213), (-452212)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1905594787, 1905594801⟩, ⟨(-518728080), (-518728064)⟩, ⟨28418907, 28418921⟩, ⟨5004463, 5004479⟩, ⟨(-639740), (-639725)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨926317071, 1389475608⟩, ⟨231579267, 231579268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2910110905, 4365166363⟩, ⟨727527723, 727527728⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1971783460, 4436512799⟩, ⟨985891726, 1478837602⟩, ⟨123236465, 123236467⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨493, 1112⟩, ⟨246, 371⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94194), (-93574)⟩, ⟨246, 371⟩, ⟨30, 31⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-97299), (-42959)⟩, ⟨(-32321), (-21095)⟩, ⟨(-2634), (-2523)⟩, ⟨13, 22⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5015757, 5070098⟩, ⟨(-32321), (-21095)⟩, ⟨(-2634), (-2523)⟩, ⟨13, 22⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2302691, 5237189⟩, ⟨1117958, 1736046⟩, ⟨130068, 139478⟩, ⟨(-1830), (-1161)⟩, ⟨(-74), (-62)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140862886), (-137928387)⟩, ⟨1117958, 1736046⟩, ⟨130068, 139478⟩, ⟨(-1830), (-1161)⟩, ⟨(-74), (-62)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-145505182), (-63321765)⟩, ⟨(-47988483), (-29867622)⟩, ⟨(-3725476), (-3215781)⟩, ⟨60042, 97305⟩, ⟨3024, 3709⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1286150583, 1368334001⟩, ⟨(-47988483), (-29867622)⟩, ⟨(-3725476), (-3215781)⟩, ⟨60042, 97305⟩, ⟨3024, 3709⟩⟩
...
def j70 : Jet := ⟨⟨(-112), (-49)⟩, ⟨(-38), (-24)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11723, 11787⟩, ⟨(-38), (-24)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5381, 12176⟩, ⟨2650, 4048⟩, ⟨317, 333⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846796), (-840000)⟩, ⟨2650, 4048⟩, ⟨317, 333⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-874704), (-385636)⟩, ⟨(-290352), (-188636)⟩, ⟨(-23545), (-22364)⟩, ⟨143, 232⟩, ⟨5, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34916690, 35405759⟩, ⟨(-290352), (-188636)⟩, ⟨(-23545), (-22364)⟩, ⟨143, 232⟩, ⟨5, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16029959, 36572596⟩, ⟨7715058, 12104265⟩, ⟨877577, 962339⟩, ⟨(-16374), (-10305)⟩, ⟨(-642), (-550)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699797924), (-679255286)⟩, ⟨7715058, 12104265⟩, ⟨877577, 962339⟩, ⟨(-16374), (-10305)⟩, ⟨(-642), (-550)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-722860556), (-311840404)⟩, ⟨(-237411601), (-143417026)⟩, ⟨(-17905613), (-14328246)⟩, ⟨405899, 673933⟩, ⟨18878, 24996⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3572106740, 3983126892⟩, ⟨(-237411601), (-143417026)⟩, ⟨(-17905613), (-14328246)⟩, ⟨405899, 673933⟩, ⟨18878, 24996⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨871448041, 1390698728⟩, ⟨169089178, 211545927⟩, ⟨(-11915174), (-7238192)⟩, ⟨(-590380), (-445827)⟩, ⟨12218, 20253⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4631221794, 5164107743⟩, ⟨166752421, 343220173⟩, ⟨22663706, 48697026⟩, ⟨542127, 4430721⟩, ⟨10565, 495156⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨939674014, 1672124041⟩, ⟨216161263, 365488655⟩, ⟨(-3162999), 24868188⟩, ⟨(-659772), 3071445⟩, ⟨(-145616), 347413⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1389475608), (-926317071)⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2905491688, 3368650225⟩, ⟨(-231579268), (-231579267)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨205586490, 650994203⟩, ⟨94585642, 284585342⟩, ⟨8416322, 50465426⟩, ⟨(-1052052), 6623978⟩, ⟨(-243989), 937243⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4500553786, 4945961499⟩, ⟨94585642, 284585342⟩, ⟨8416322, 50465426⟩, ⟨(-1052052), 6623978⟩, ⟨(-243989), 937243⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4396559032, 4608985017⟩, ⟨44070683, 139004700⟩, ⟨1825295, 24428779⟩, ⟨(-1286229), 3217163⟩, ⟨(-288761), 498082⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2974217227, 3614942175⟩, ⟨(-218697446), (-128032104)⟩, ⟨(-6260171), 16783867⟩, ⟨(-2325992), 2424885⟩, ⟨(-399949), 460011⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3573118224, 5359677345⟩, ⟨893279553, 893279558⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2972589303, 6688325956⟩, ⟨1486294646, 2229441988⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2972589303, 6688325956⟩, ⟨1486294646, 2229441988⟩, ⟨185786830, 185786833⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6688325956), (-2972589303)⟩, ⟨(-2229441988), (-1486294646)⟩, ⟨(-185786833), (-185786830)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3344162978), (-1486294651)⟩, ⟨(-1114720994), (-743147323)⟩, ⟨(-92893417), (-92893415)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1971550562, 3038576054⟩, ⟨(-788635696), (-341132404)⟩, ⟨(-36207004), 59700181⟩, ⟨(-246113), 14503707⟩, ⟨(-1586689), 407520⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1365276902, 2557476222⟩, ⟨(-818493139), (-295001929)⟩, ⟨(-24734144), 102278865⟩, ⟨(-7974456), 16915995⟩, ⟨(-2943688), 1341369⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1157896339, 1157896340⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4480162982, 4480162987⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified120
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨926317071, 1389475608⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4396559032, 4608985017⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified121
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (51636263 / 1073741824)

theorem envelope_integral : (∫ s in ((8627 / 40000) : ℝ)..(25881 / 80000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((8627 / 40000) : ℝ)..(25881 / 80000), prawitzNormalCorrection
