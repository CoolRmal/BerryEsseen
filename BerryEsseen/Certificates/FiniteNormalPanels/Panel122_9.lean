...
namespace FiniteNormalPanel122_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (27499 / 800000)
def radius : Rat := (27499 / 800000)

def j0 : Jet := ⟨⟨147634132, 147634133⟩, ⟨147634132, 147634133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨463806304, 463806308⟩, ⟨463806304, 463806308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨50085663, 50085665⟩, ⟨100171326, 100171330⟩, ⟨50085663, 50085665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨12, 13⟩, ⟨25, 26⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94675), (-94673)⟩, ⟨25, 26⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1105), (-1104)⟩, ⟨(-2209), (-2207)⟩, ⟨(-1105), (-1102)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111951, 5111953⟩, ⟨(-2209), (-2207)⟩, ⟨(-1105), (-1102)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨59612, 59613⟩, ⟨119199, 119201⟩, ⟨59547, 59550⟩, ⟨(-52), (-49)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-143105965), (-143105963)⟩, ⟨119199, 119201⟩, ⟨59547, 59550⟩, ⟨(-52), (-49)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1668828), (-1668826)⟩, ⟨(-3336265), (-3336262)⟩, ⟨(-1665354), (-1665350)⟩, ⟨2777, 2780⟩, ⟨691, 694⟩⟩
...
def j19 : Jet := ⟨⟨1429986937, 1429986940⟩, ⟨(-3336265), (-3336262)⟩, ⟨(-1665354), (-1665350)⟩, ⟨2777, 2780⟩, ⟨691, 694⟩⟩
...
def j25 : Jet := ⟨⟨137, 139⟩, ⟨274, 277⟩, ⟨135, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852040), (-852037)⟩, ⟨274, 277⟩, ⟨135, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-9937), (-9936)⟩, ⟨(-19870), (-19868)⟩, ⟨(-9930), (-9927)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781457, 35781459⟩, ⟨(-19870), (-19868)⟩, ⟨(-9930), (-9927)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨417264, 417265⟩, ⟨834297, 834299⟩, ⟨416684, 416687⟩, ⟨(-464), (-461)⟩, ⟨(-117), (-113)⟩⟩
...
def j33 : Jet := ⟨⟨(-715410619), (-715410617)⟩, ⟨834297, 834299⟩, ⟨416684, 416687⟩, ⟨(-464), (-461)⟩, ⟨(-117), (-113)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8342745), (-8342744)⟩, ⟨(-16675761), (-16675759)⟩, ⟨(-8318428), (-8318425)⟩, ⟨19441, 19444⟩, ⟨4846, 4849⟩⟩
...
def j36 : Jet := ⟨⟨4286624551, 4286624552⟩, ⟨(-16675761), (-16675759)⟩, ⟨(-8318428), (-8318425)⟩, ⟨19441, 19444⟩, ⟨4846, 4849⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨154421887, 154421890⟩, ⟨154061609, 154061613⟩, ⟨(-540117), (-540115)⟩, ⟨(-179540), (-179537)⟩, ⟨373, 376⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303326276, 4303326278⟩, ⟨16740730, 16740734⟩, ⟨8415959, 8415965⟩, ⟨45705, 45712⟩, ⟨11563, 11571⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨154722426, 154722431⟩, ⟨154963345, 154963351⟩, ⟨361913, 361918⟩, ⟨121529, 121536⟩, ⟨668, 677⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-147634133), (-147634132)⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4147333163, 4147333164⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5573739, 5573740⟩, ⟨11164836, 11164838⟩, ⟨5617184, 5617188⟩, ⟨34868, 34876⟩, ⟨8846, 8853⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300541035, 4300541036⟩, ⟨11164836, 11164838⟩, ⟨5617184, 5617188⟩, ⟨34868, 34876⟩, ⟨8846, 8853⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297753261, 4297753263⟩, ⟨5578799, 5578801⟩, ⟨2803150, 2803153⟩, ⟨13783, 13789⟩, ⟨3487, 3493⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4150023363, 4150023367⟩, ⟨(-142342864), (-142342859)⟩, ⟨2515030, 2515035⟩, ⟨(-83046), (-83038)⟩, ⟨2893, 2900⟩⟩
...
def j47 : Jet := ⟨⟨1526994697, 1526994708⟩, ⟨1526994697, 1526994708⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨542894193, 542894201⟩, ⟨1085788386, 1085788402⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨542894193, 542894201⟩, ⟨1085788386, 1085788402⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-542894201), (-542894193)⟩, ⟨(-1085788402), (-1085788386)⟩, ⟨(-542894201), (-542894193)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-271447101), (-271447096)⟩, ⟨(-542894201), (-542894193)⟩, ⟨(-271447101), (-271447096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4031920195, 4031920200⟩, ⟨(-509644416), (-509644406)⟩, ⟨(-222612070), (-222612062)⟩, ⟨30852992, 30852995⟩, ⟨6059701, 6059703⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3895853414, 3895853424⟩, ⟨(-626070264), (-626070246)⟩, ⟨(-195847978), (-195847961)⟩, ⟨36813146, 36813161⟩, ⟨4714888, 4714903⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 295268265⟩, ⟨147634132, 147634133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 927612613⟩, ⟨463806304, 463806308⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 200342657⟩, ⟨0, 200342658⟩, ⟨50085663, 50085665⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4417), 0⟩, ⟨(-4417), 3⟩, ⟨(-1105), (-1099)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108639, 5113057⟩, ⟨(-4417), 3⟩, ⟨(-1105), (-1099)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 238504⟩, ⟨(-207), 238505⟩, ⟨59315, 59627⟩, ⟨(-104), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142927072)⟩, ⟨(-207), 238505⟩, ⟨59315, 59627⟩, ⟨(-104), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6678089), 0⟩, ⟨(-6678099), 11126⟩, ⟨(-1669533), (-1652832)⟩, ⟨(-8), 5565⟩, ⟨685, 697⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424977676, 1431655766⟩, ⟨(-6678099), 11126⟩, ⟨(-1669533), (-1652832)⟩, ⟨(-8), 5565⟩, ⟨685, 697⟩⟩
...
def j72 : Jet := ⟨⟨0, 553⟩, ⟨(-1), 553⟩, ⟨135, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851623)⟩, ⟨(-1), 553⟩, ⟨135, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-39751), 0⟩, ⟨(-39752), 26⟩, ⟨(-9939), (-9898)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35751643, 35791395⟩, ⟨(-39752), 26⟩, ⟨(-9939), (-9898)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1669523⟩, ⟨(-1855), 1669525⟩, ⟨414597, 417383⟩, ⟨(-929), 2⟩, ⟨(-118), (-113)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714158359)⟩, ⟨(-1855), 1669525⟩, ⟨414597, 417383⟩, ⟨(-929), 2⟩, ⟨(-118), (-113)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-33390443), 0⟩, ⟨(-33390531), 77877⟩, ⟨(-8347698), (-8230794)⟩, ⟨(-66), 38941⟩, ⟨4784, 4869⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4261576853, 4294967296⟩, ⟨(-33390531), 77877⟩, ⟨(-8347698), (-8230794)⟩, ⟨(-66), 38941⟩, ⟨4784, 4869⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 309204205⟩, ⟨152438631, 154604506⟩, ⟨(-1081738), 1202⟩, ⟨(-180293), (-177284)⟩, ⟨(-1), 752⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4328619361⟩, ⟨(-79103), 33915827⟩, ⟨8230179, 8744764⟩, ⟨(-39870), 135021⟩, ⟨10246, 13368⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 311626892⟩, ⟨152432936, 158257545⟩, ⟨(-1093062), 1851624⟩, ⟨98988, 147240⟩, ⟨(-5065), 6589⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-295268265), 0⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3999699031, 4294967296⟩, ⟨(-147634133), (-147634132)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22610492⟩, ⟨0, 22965162⟩, ⟨5251388, 6100043⟩, ⟨(-80554), 157824⟩, ⟨5818, 12609⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317577788⟩, ⟨0, 22965162⟩, ⟨5251388, 6100043⟩, ⟨(-80554), 157824⟩, ⟨5818, 12609⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306257703⟩, ⟨0, 11482581⟩, ⟨2603500, 3050022⟩, ⟨(-48432), 78912⟩, ⟨1610, 5646⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3999699031, 4306257703⟩, ⟨(-148022227), (-136151551)⟩, ⟨2029815, 3050022⟩, ⟨(-153273), (-10580)⟩, ⟨(-1214), 7311⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3053989406⟩, ⟨1526994697, 1526994708⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 2171576790⟩, ⟨0, 2171576798⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 2171576790⟩, ⟨0, 2171576798⟩, ⟨542894193, 542894201⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-2171576790), 0⟩, ⟨(-2171576798), 0⟩, ⟨(-542894201), (-542894193)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1085788395), 0⟩, ⟨(-1085788399), 0⟩, ⟨(-271447101), (-271447096)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3335555157, 4294967296⟩, ⟨(-1085788399), 0⟩, ⟨(-271447101), (-73564829)⟩, ⟨0, 68623134⟩, ⟨(-2012372), 8577892⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3106244078, 4306257703⟩, ⟨(-1236664896), (-105737943)⟩, ⟨(-270584276), (-28036676)⟩, ⟨1407689, 78150495⟩, ⟨(-4576679), 8611736⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨147634132, 147634133⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297753261, 4297753263⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2456
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 295268265⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306257703⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2457
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (65865143 / 1073741824)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(27499 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (27499 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(27499 / 400000), prawitzNormalCorrection
