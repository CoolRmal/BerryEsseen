...
namespace FiniteNormalPanel91_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (32439 / 160000)
def radius : Rat := (32439 / 800000)

def j0 : Jet := ⟨⟨870777775, 870777776⟩, ⟨174155555, 174155556⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2735629060, 2735629065⟩, ⟨547125812, 547125816⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1742426854, 1742426861⟩, ⟨696970740, 696970748⟩, ⟨69697074, 69697076⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨436, 437⟩, ⟨174, 175⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94251), (-94249)⟩, ⟨174, 175⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-38237), (-38235)⟩, ⟨(-15225), (-15223)⟩, ⟨(-1496), (-1492)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5074819, 5074822⟩, ⟨(-15225), (-15223)⟩, ⟨(-1496), (-1492)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2058805, 2058807⟩, ⟨817345, 817348⟩, ⟨79274, 79278⟩, ⟨(-490), (-486)⟩, ⟨(-25), (-22)⟩⟩
...
def j16 : Jet := ⟨⟨(-141106772), (-141106769)⟩, ⟨817345, 817348⟩, ⟨79274, 79278⟩, ⟨(-490), (-486)⟩, ⟨(-25), (-22)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-57245659), (-57245656)⟩, ⟨(-22566676), (-22566671)⟩, ⟨(-2125032), (-2125026)⟩, ⟨25928, 25932⟩, ⟨1195, 1201⟩⟩
...
def j19 : Jet := ⟨⟨1374410106, 1374410110⟩, ⟨(-22566676), (-22566671)⟩, ⟨(-2125032), (-2125026)⟩, ⟨25928, 25932⟩, ⟨1195, 1201⟩⟩
...
def j22 : Jet := ⟨⟨(-44), (-43)⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11791, 11793⟩, ⟨(-18), (-17)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨4783, 4785⟩, ⟨1905, 1908⟩, ⟨187, 190⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-847394), (-847391)⟩, ⟨1905, 1908⟩, ⟨187, 190⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-343780), (-343778)⟩, ⟨(-136740), (-136736)⟩, ⟨(-13368), (-13363)⟩, ⟨59, 62⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35447614, 35447617⟩, ⟨(-136740), (-136736)⟩, ⟨(-13368), (-13363)⟩, ⟨59, 62⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨14380755, 14380757⟩, ⟨5696827, 5696831⟩, ⟨547616, 547622⟩, ⟨(-4366), (-4360)⟩, ⟨(-208), (-203)⟩⟩
...
def j33 : Jet := ⟨⟨(-701447128), (-701447125)⟩, ⟨5696827, 5696831⟩, ⟨547616, 547622⟩, ⟨(-4366), (-4360)⟩, ⟨(-208), (-203)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-284570344), (-284570340)⟩, ⟨(-111516991), (-111516986)⟩, ⟨(-10236193), (-10236188)⟩, ⟨179538, 179544⟩, ⟨8092, 8098⟩⟩
...
def j36 : Jet := ⟨⟨4010396952, 4010396956⟩, ⟨(-111516991), (-111516986)⟩, ⟨(-10236193), (-10236188)⟩, ⟨179538, 179544⟩, ⟨8092, 8098⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨875414401, 875414406⟩, ⟨160709300, 160709307⟩, ⟨(-4228231), (-4228225)⟩, ⟨(-254189), (-254184)⟩, ⟨4063, 4069⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4599730220, 4599730225⟩, ⟨127904557, 127904565⟩, ⟨15297046, 15297056⟩, ⟨545899, 545911⟩, ⟨39208, 39220⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨937532185, 937532192⟩, ⟨198182862, 198182873⟩, ⟨3375574, 3375585⟩, ⟨285507, 285521⟩, ⟨10138, 10151⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-870777776), (-870777775)⟩, ⟨(-174155556), (-174155555)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3424189520, 3424189521⟩, ⟨(-174155556), (-174155555)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨204650358, 204650362⟩, ⟨86521176, 86521182⟩, ⟨10618442, 10618450⟩, ⟨436162, 436172⟩, ⟨33424, 33436⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4499617654, 4499617658⟩, ⟨86521176, 86521182⟩, ⟨10618442, 10618450⟩, ⟨436162, 436172⟩, ⟨33424, 33436⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4396101758, 4396101761⟩, ⟨42265357, 42265361⟩, ⟨4983904, 4983909⟩, ⟨165146, 165154⟩, ⟨11913, 11921⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3504819601, 3504819606⟩, ⟨(-144560113), (-144560107)⟩, ⟨2259640, 2259646⟩, ⟨(-70429), (-70420)⟩, ⟨2800, 2809⟩⟩
...
def j47 : Jet := ⟨⟨5906773004, 5906773012⟩, ⟨1181354600, 1181354608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8123453548, 8123453571⟩, ⟨3249381416, 3249381444⟩, ⟨324938141, 324938146⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8123453548, 8123453571⟩, ⟨3249381416, 3249381444⟩, ⟨324938141, 324938146⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8123453571), (-8123453548)⟩, ⟨(-3249381444), (-3249381416)⟩, ⟨(-324938146), (-324938141)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4061726786), (-4061726774)⟩, ⟨(-1624690722), (-1624690708)⟩, ⟨(-162469073), (-162469070)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1668207133, 1668207146⟩, ⟨(-631045707), (-631045696)⟩, ⟨56250712, 56250718⟩, ⟨8821238, 8821241⟩, ⟨(-1898140), (-1898139)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1361306071, 1361306085⟩, ⟨(-571100410), (-571100395)⟩, ⟨68019650, 68019661⟩, ⟨4945741, 4945754⟩, ⟨(-1804818), (-1804807)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨696622220, 1044933331⟩, ⟨174155555, 174155556⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2188503248, 3282754877⟩, ⟨547125812, 547125816⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1115153186, 2509094678⟩, ⟨557576592, 836364898⟩, ⟨69697074, 69697076⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨279, 629⟩, ⟨139, 210⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94408), (-94057)⟩, ⟨139, 210⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-55153), (-24421)⟩, ⟨(-18349), (-12087)⟩, ⟨(-1511), (-1474)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5057903, 5088636⟩, ⟨(-18349), (-12087)⟩, ⟨(-1511), (-1474)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1313243, 2972752⟩, ⟨645901, 987780⟩, ⟨77620, 80626⟩, ⟨(-592), (-382)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141852334), (-140192824)⟩, ⟨645901, 987780⟩, ⟨77620, 80626⟩, ⟨(-592), (-382)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-82869301), (-36399921)⟩, ⟨(-27455399), (-17622904)⟩, ⟨(-2197922), (-2035541)⟩, ⟨20211, 31632⟩, ⟨1128, 1255⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1348786464, 1395255845⟩, ⟨(-27455399), (-17622904)⟩, ⟨(-2197922), (-2035541)⟩, ⟨20211, 31632⟩, ⟨1128, 1255⟩⟩
...
def j70 : Jet := ⟨⟨(-64), (-27)⟩, ⟨(-22), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11771, 11809⟩, ⟨(-22), (-13)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨3056, 6899⟩, ⟨1515, 2297⟩, ⟨184, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849121), (-845277)⟩, ⟨1515, 2297⟩, ⟨184, 191⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-496052), (-219469)⟩, ⟨(-164958), (-108392)⟩, ⟨(-13537), (-13156)⟩, ⟨45, 76⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35295342, 35571926⟩, ⟨(-164958), (-108392)⟩, ⟨(-13537), (-13156)⟩, ⟨45, 76⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨9164147, 20780911⟩, ⟨4485705, 6898828⟩, ⟨532727, 559762⟩, ⟨(-5303), (-3420)⟩, ⟨(-215), (-195)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-706663736), (-695046971)⟩, ⟨4485705, 6898828⟩, ⟨532727, 559762⟩, ⟨(-5303), (-3420)⟩, ⟨(-215), (-195)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-412828806), (-180463270)⟩, ⟨(-136444927), (-86201379)⟩, ⟨(-10746812), (-9608525)⟩, ⟨138853, 220069⟩, ⟨7485, 8591⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3882138490, 4114504026⟩, ⟨(-136444927), (-86201379)⟩, ⟨(-10746812), (-9608525)⟩, ⟨138853, 220069⟩, ⟨7485, 8591⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨687274978, 1066430223⟩, ⟨150833870, 168758611⟩, ⟨(-5177408), (-3282151)⟩, ⟨(-269691), (-235124)⟩, ⟨3148, 4990⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4483345734, 4751696552⟩, ⟨93928838, 167007152⟩, ⟨12437740, 19023761⟩, ⟨225776, 970592⟩, ⟨14919, 74776⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨717419046, 1179835018⟩, ⟨172479852, 228171979⟩, ⟨(-439044), 7859523⟩, ⟨(-26767), 671266⟩, ⟨(-19819), 47579⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1044933331), (-696622220)⟩, ⟨(-174155556), (-174155555)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3250033965, 3598345076⟩, ⟨(-174155556), (-174155555)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨119835624, 324102741⟩, ⟨57621080, 125358484⟩, ⟨6685334, 16439785⟩, ⟨(-61356), 1203878⟩, ⟨(-14540), 111849⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4414802920, 4619070037⟩, ⟨57621080, 125358484⟩, ⟨6685334, 16439785⟩, ⟨(-61356), 1203878⟩, ⟨(-14540), 111849⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4354472891, 4454071705⟩, ⟨27781395, 61822706⟩, ⟨2794212, 8018943⟩, ⟨(-144109), 575888⟩, ⟨(-22732), 56311⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3295062295, 3731643546⟩, ⟨(-159584652), (-124773059)⟩, ⟨(-392433), 5591811⟩, ⟨(-445895), 369181⟩, ⟨(-42397), 53022⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4725418403, 7088127613⟩, ⟨1181354600, 1181354608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨5199010270, 11697773137⟩, ⟨2599505132, 3899257732⟩, ⟨324938141, 324938146⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨5199010270, 11697773137⟩, ⟨2599505132, 3899257732⟩, ⟨324938141, 324938146⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11697773137), (-5199010270)⟩, ⟨(-3899257732), (-2599505132)⟩, ⟨(-324938146), (-324938141)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5848886569), (-2599505135)⟩, ⟨(-1949628866), (-1299752566)⟩, ⟨(-162469073), (-162469070)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1100367170, 2344798543⟩, ⟨(-1064382244), (-332995562)⟩, ⟨(-38312592), 199954851⟩, ⟨(-21857737), 32639266⟩, ⟨(-7485937), 3205130⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨844192312, 2037257038⟩, ⟨(-1011902698), (-287438113)⟩, ⟨(-23827945), 216330163⟩, ⟨(-28049661), 30080689⟩, ⟨(-7881360), 3996681⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨870777775, 870777776⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4396101758, 4396101761⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1840
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨696622220, 1044933331⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4354472891, 4454071705⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1841
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (56151043 / 2147483648)

theorem envelope_integral : (∫ s in ((32439 / 200000) : ℝ)..(97317 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((32439 / 200000) : ℝ)..(97317 / 400000), prawitzNormalCorrection
