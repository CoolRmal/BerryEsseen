...
namespace FiniteNormalPanel154_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (78213 / 800000)
def radius : Rat := (26071 / 800000)

def j0 : Jet := ⟨⟨419902846, 419902847⟩, ⟨139967615, 139967616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1319163696, 1319163700⟩, ⟨439721231, 439721235⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨405170222, 405170226⟩, ⟨270113480, 270113486⟩, ⟨45018913, 45018915⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨101, 102⟩, ⟨67, 68⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94586), (-94584)⟩, ⟨67, 68⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-8923), (-8922)⟩, ⟨(-5943), (-5941)⟩, ⟨(-987), (-984)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5104133, 5104135⟩, ⟨(-5943), (-5941)⟩, ⟨(-987), (-984)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨481503, 481504⟩, ⟨320441, 320443⟩, ⟨53032, 53036⟩, ⟨(-126), (-122)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142684074), (-142684072)⟩, ⟨320441, 320443⟩, ⟨53032, 53036⟩, ⟨(-126), (-122)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13460252), (-13460250)⟩, ⟨(-8943272), (-8943270)⟩, ⟨(-1470430), (-1470426)⟩, ⟨6681, 6684⟩, ⟨545, 549⟩⟩
...
def j19 : Jet := ⟨⟨1418195513, 1418195516⟩, ⟨(-8943272), (-8943270)⟩, ⟨(-1470430), (-1470426)⟩, ⟨6681, 6684⟩, ⟨545, 549⟩⟩
...
def j25 : Jet := ⟨⟨1115, 1116⟩, ⟨742, 744⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851062), (-851060)⟩, ⟨742, 744⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-80286), (-80285)⟩, ⟨(-53455), (-53452)⟩, ⟨(-8864), (-8861)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35711108, 35711110⟩, ⟨(-53455), (-53452)⟩, ⟨(-8864), (-8861)⟩, ⟨13, 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3368844, 3368845⟩, ⟨2240853, 2240855⟩, ⟨370117, 370121⟩, ⟨(-1118), (-1115)⟩, ⟨(-94), (-89)⟩⟩
...
def j33 : Jet := ⟨⟨(-712459039), (-712459037)⟩, ⟨2240853, 2240855⟩, ⟨370117, 370121⟩, ⟨(-1118), (-1115)⟩, ⟨(-94), (-89)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-67210568), (-67210566)⟩, ⟨(-44595653), (-44595650)⟩, ⟨(-7291999), (-7291995)⟩, ⟨46658, 46662⟩, ⟨3799, 3802⟩⟩
...
def j36 : Jet := ⟨⟨4227756728, 4227756730⟩, ⟨(-44595653), (-44595650)⟩, ⟨(-7291999), (-7291995)⟩, ⟨46658, 46662⟩, ⟨3799, 3802⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨435587026, 435587030⟩, ⟨142448822, 142448826⟩, ⟨(-1367249), (-1367246)⟩, ⟨(-148492), (-148490)⟩, ⟨851, 854⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4363246338, 4363246341⟩, ⟨46024834, 46024839⟩, ⟨8011169, 8011176⟩, ⟨115727, 115737⟩, ⟨10603, 10613⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨442511750, 442511755⟩, ⟨149381141, 149381148⟩, ⟨949971, 949978⟩, ⟨111933, 111940⟩, ⟨1634, 1643⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-419902847), (-419902846)⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3875064449, 3875064450⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨45592116, 45592118⟩, ⟨30781566, 30781570⟩, ⟨5391301, 5391307⟩, ⟨89144, 89150⟩, ⟨8332, 8339⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4340559412, 4340559414⟩, ⟨30781566, 30781570⟩, ⟨5391301, 5391307⟩, ⟨89144, 89150⟩, ⟨8332, 8339⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4317703176, 4317703178⟩, ⟨15309739, 15309742⟩, ⟨2654313, 2654317⟩, ⟨34925, 34930⟩, ⟨3203, 3209⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3895577527, 3895577531⟩, ⟨(-126895587), (-126895582)⟩, ⟨1895884, 1895890⟩, ⟨(-54991), (-54984)⟩, ⟨1750, 1758⟩⟩
...
def j47 : Jet := ⟨⟨5186587944, 5186587958⟩, ⟨1728862643, 1728862657⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6263306015, 6263306050⟩, ⟨4175537330, 4175537378⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6263306015, 6263306050⟩, ⟨4175537330, 4175537378⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6263306050), (-6263306015)⟩, ⟨(-4175537378), (-4175537330)⟩, ⟨(-695922898), (-695922886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3131653025), (-3131653007)⟩, ⟨(-2087768689), (-2087768665)⟩, ⟨(-347961449), (-347961443)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2071554204, 2071554222⟩, ⟨(-1006975315), (-1006975293)⟩, ⟨76914374, 76914388⟩, ⟨41924859, 41924865⟩, ⟨(-8210535), (-8210532)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1878920011, 1878920031⟩, ⟨(-974540949), (-974540923)⟩, ⟨100427783, 100427804⟩, ⟨35282783, 35282799⟩, ⟨(-8638028), (-8638017)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨279935230, 559870462⟩, ⟨139967615, 139967616⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨879442462, 1758884931⟩, ⟨439721231, 439721235⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨180075653, 720302622⟩, ⟨180075652, 360151314⟩, ⟨45018913, 45018915⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨45, 181⟩, ⟨45, 91⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94642), (-94505)⟩, ⟨45, 91⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-15873), (-3962)⟩, ⟨(-7936), (-3946)⟩, ⟨(-992), (-979)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5097183, 5109095⟩, ⟨(-7936), (-3946)⟩, ⟨(-992), (-979)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨213710, 856839⟩, ⟨212379, 428255⟩, ⟨52594, 53347⟩, ⟨(-168), (-81)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142951867), (-142308737)⟩, ⟨212379, 428255⟩, ⟨52594, 53347⟩, ⟨(-168), (-81)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-23974247), (-5966596)⟩, ⟨(-11978220), (-5894773)⟩, ⟨(-1487282), (-1446790)⟩, ⟨4402, 8960⟩, ⟨534, 557⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407681518, 1425689170⟩, ⟨(-11978220), (-5894773)⟩, ⟨(-1487282), (-1446790)⟩, ⟨4402, 8960⟩, ⟨534, 557⟩⟩
...
def j72 : Jet := ⟨⟨495, 1985⟩, ⟨493, 993⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851682), (-850191)⟩, ⟨493, 993⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-142835), (-35646)⟩, ⟨(-71398), (-35479)⟩, ⟨(-8903), (-8806)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35648559, 35755749⟩, ⟨(-71398), (-35479)⟩, ⟨(-8903), (-8806)⟩, ⟨9, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1494641, 5996544⟩, ⟨1482666, 2996785⟩, ⟨366178, 372929⟩, ⟨(-1496), (-736)⟩, ⟨(-95), (-89)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714333242), (-709831338)⟩, ⟨1482666, 2996785⟩, ⟨366178, 372929⟩, ⟨(-1496), (-736)⟩, ⟨(-95), (-89)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-119799774), (-29761190)⟩, ⟨(-59837725), (-29258603)⟩, ⟨(-7409972), (-7126459)⟩, ⟨30641, 62654⟩, ⟨3696, 3876⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4175167522, 4265206106⟩, ⟨(-59837725), (-29258603)⟩, ⟨(-7409972), (-7126459)⟩, ⟨30641, 62654⟩, ⟨3696, 3876⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨288238492, 583851524⟩, ⟨139213897, 144755862⟩, ⟨(-1835414), (-899756)⟩, ⟨(-151368), (-144453)⟩, ⟨559, 1147⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4324936149, 4418204534⟩, ⟨29668340, 63320888⟩, ⟨7429777, 8748813⟩, ⟨35634, 206028⟩, ⟨7710, 14437⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨290249724, 600604213⟩, ⟨142176349, 157517150⟩, ⟨(-427815), 2417409⟩, ⟨60442, 171200⟩, ⟨(-3737), 7534⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-559870462), (-279935230)⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3735096834, 4015032066⟩, ⟨(-139967616), (-139967615)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨19614794, 83987932⟩, ⟨19216278, 44054104⟩, ⟨4586813, 6453012⟩, ⟨(-23214), 225200⟩, ⟨2713, 16027⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4314582090, 4378955228⟩, ⟨19216278, 44054104⟩, ⟨4586813, 6453012⟩, ⟨(-23214), 225200⟩, ⟨2713, 16027⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4304763521, 4336757948⟩, ⟨9515551, 21976926⟩, ⟨2215621, 3208648⟩, ⟨(-27963), 107447⟩, ⟨(-392), 7570⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3743616072, 4054098908⟩, ⟨(-133054371), (-119742336)⟩, ⟨1210602, 2689418⟩, ⟨(-130707), 28240⟩, ⟨(-3869), 7989⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3457725287, 6915450602⟩, ⟨1728862643, 1728862657⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2783691547, 11134766282⟩, ⟨2783691546, 5567383162⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2783691547, 11134766282⟩, ⟨2783691546, 5567383162⟩, ⟨695922886, 695922898⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-11134766282), (-2783691547)⟩, ⟨(-5567383162), (-2783691546)⟩, ⟨(-695922898), (-695922886)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5567383141), (-1391845773)⟩, ⟨(-2783691581), (-1391845773)⟩, ⟨(-347961449), (-347961443)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1174904110, 3106136263⟩, ⟨(-2013176067), (-380744533)⟩, ⟨(-189954146), 557212464⟩, ⟨(-99817510), 149771345⟩, ⟨(-46839365), 23868320⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1024079953, 2931939353⟩, ⟨(-1996499465), (-364623757)⟩, ⟨(-168355024), 590274581⟩, ⟨(-112836689), 147169660⟩, ⟨(-48987311), 26037969⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨419902846, 419902847⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4317703176, 4317703178⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3110
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨279935230, 559870462⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4304763521, 4336757948⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3111
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (62492303 / 2147483648)

theorem envelope_integral : (∫ s in ((26071 / 400000) : ℝ)..(26071 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((26071 / 400000) : ℝ)..(26071 / 200000), prawitzNormalCorrection
