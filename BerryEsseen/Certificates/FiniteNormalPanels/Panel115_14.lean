...
namespace FiniteNormalPanel115_14
...
def j2 : Jet := ⟨⟨477080080, 477080084⟩, ⟨477080080, 477080084⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨52993512, 52993514⟩, ⟨105987024, 105987028⟩, ⟨52993512, 52993514⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1169), (-1168)⟩, ⟨(-2337), (-2335)⟩, ⟨(-1169), (-1166)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111887, 5111889⟩, ⟨(-2337), (-2335)⟩, ⟨(-1169), (-1166)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨63073, 63074⟩, ⟨126117, 126119⟩, ⟨63000, 63003⟩, ⟨(-58), (-55)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-143102504), (-143102502)⟩, ⟨126117, 126119⟩, ⟨63000, 63003⟩, ⟨(-58), (-55)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1765673), (-1765672)⟩, ⟨(-3529789), (-3529787)⟩, ⟨(-1761784), (-1761781)⟩, ⟨3109, 3112⟩, ⟨774, 777⟩⟩
...
def j19 : Jet := ⟨⟨1429890092, 1429890094⟩, ⟨(-3529789), (-3529787)⟩, ⟨(-1761784), (-1761781)⟩, ⟨3109, 3112⟩, ⟨774, 777⟩⟩
...
def j25 : Jet := ⟨⟨146, 147⟩, ⟨291, 293⟩, ⟨144, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852031), (-852029)⟩, ⟨291, 293⟩, ⟨144, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10513), (-10512)⟩, ⟨(-21023), (-21021)⟩, ⟨(-10505), (-10502)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780881, 35780883⟩, ⟨(-21023), (-21021)⟩, ⟨(-10505), (-10502)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨441482, 441483⟩, ⟨882705, 882707⟩, ⟨440833, 440836⟩, ⟨(-520), (-517)⟩, ⟨(-131), (-127)⟩⟩
...
def j33 : Jet := ⟨⟨(-715386401), (-715386399)⟩, ⟨882705, 882707⟩, ⟨440833, 440836⟩, ⟨(-520), (-517)⟩, ⟨(-131), (-127)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8826806), (-8826804)⟩, ⟨(-17642720), (-17642717)⟩, ⟨(-8799585), (-8799581)⟩, ⟨21762, 21765⟩, ⟨5424, 5427⟩⟩
...
def j36 : Jet := ⟨⟨4286140490, 4286140492⟩, ⟨(-17642720), (-17642717)⟩, ⟨(-8799585), (-8799581)⟩, ⟨21762, 21765⟩, ⟨5424, 5427⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨158830564, 158830566⟩, ⟨158438479, 158438482⟩, ⟨(-587782), (-587780)⟩, ⟨(-195352), (-195350)⟩, ⟨430, 433⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303812277, 4303812280⟩, ⟨17715457, 17715462⟩, ⟨8908780, 8908787⟩, ⟨51185, 51192⟩, ⟨12959, 12967⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨159157656, 159157660⟩, ⟨159419892, 159419897⟩, ⟨393970, 393975⟩, ⟨132350, 132358⟩, ⟨771, 779⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-151859307), (-151859306)⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4143107989, 4143107990⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5897870, 5897871⟩, ⟨11815174, 11815178⟩, ⟨5946519, 5946522⟩, ⟨39054, 39058⟩, ⟨9916, 9921⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300865166, 4300865167⟩, ⟨11815174, 11815178⟩, ⟨5946519, 5946522⟩, ⟨39054, 39058⟩, ⟨9916, 9921⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297915219, 4297915220⟩, ⟨5903535, 5903538⟩, ⟨2967165, 2967168⟩, ⟨15437, 15441⟩, ⟨3908, 3913⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4145951680, 4145951683⟩, ⟨(-146268739), (-146268733)⟩, ⟨2653518, 2653523⟩, ⟨(-90021), (-90015)⟩, ⟨3223, 3230⟩⟩
...
def j47 : Jet := ⟨⟨1379792458, 1379792468⟩, ⟨1379792458, 1379792468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨443269318, 443269326⟩, ⟨886538636, 886538652⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨443269318, 443269326⟩, ⟨886538636, 886538652⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-443269326), (-443269318)⟩, ⟨(-886538652), (-886538636)⟩, ⟨(-443269326), (-443269318)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-221634663), (-221634659)⟩, ⟨(-443269326), (-443269318)⟩, ⟨(-221634663), (-221634659)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4078954068, 4078954073⟩, ⟨(-420975318), (-420975309)⟩, ⟨(-188763927), (-188763921)⟩, ⟨20976387, 20976389⟩, ⟨4329198, 4329199⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3937433117, 3937433126⟩, ⟨(-545281638), (-545281621)⟩, ⟨(-165357958), (-165357943)⟩, ⟨26331534, 26331546⟩, ⟨3359884, 3359898⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 303718613⟩, ⟨151859306, 151859307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 954160164⟩, ⟨477080080, 477080084⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 211974052⟩, ⟨0, 211974054⟩, ⟨52993512, 52993514⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4674), 0⟩, ⟨(-4674), 3⟩, ⟨(-1169), (-1163)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108382, 5113057⟩, ⟨(-4674), 3⟩, ⟨(-1169), (-1163)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 252351⟩, ⟨(-231), 252352⟩, ⟨62740, 63089⟩, ⟨(-116), 2⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142913225)⟩, ⟨(-231), 252352⟩, ⟨62740, 63089⟩, ⟨(-116), 2⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7065802), 0⟩, ⟨(-7065814), 12455⟩, ⟨(-1766463), (-1747767)⟩, ⟨(-9), 6229⟩, ⟨767, 780⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424589963, 1431655766⟩, ⟨(-7065814), 12455⟩, ⟨(-1766463), (-1747767)⟩, ⟨(-9), 6229⟩, ⟨767, 780⟩⟩
...
def j72 : Jet := ⟨⟨0, 585⟩, ⟨(-1), 585⟩, ⟨143, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851591)⟩, ⟨(-1), 585⟩, ⟨143, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-42059), 0⟩, ⟨(-42060), 29⟩, ⟨(-10516), (-10470)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35749335, 35791395⟩, ⟨(-42060), 29⟩, ⟨(-10516), (-10470)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1766451⟩, ⟨(-2076), 1766453⟩, ⟨438497, 441615⟩, ⟨(-1040), 2⟩, ⟨(-132), (-127)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714061431)⟩, ⟨(-2076), 1766453⟩, ⟨438497, 441615⟩, ⟨(-1040), 2⟩, ⟨(-132), (-127)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-35329009), 0⟩, ⟨(-35329113), 87182⟩, ⟨(-8832356), (-8701478)⟩, ⟨(-78), 43593⟩, ⟨5351, 5450⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4259638287, 4294967296⟩, ⟨(-35329113), 87182⟩, ⟨(-8832356), (-8701478)⟩, ⟨(-78), 43593⟩, ⟨5351, 5450⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 318053389⟩, ⟨156672106, 159029462⟩, ⟨(-1177297), 1384⟩, ⟨(-196219), (-192755)⟩, ⟨(-1), 866⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4330589321⟩, ⟨(-88636), 35917577⟩, ⟨8700748, 9277372⟩, ⟨(-44695), 151502⟩, ⟨11398, 15101⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 320691292⟩, ⟨156665542, 163008227⟩, ⟨(-1190344), 2018328⟩, ⟨106383, 162003⟩, ⟨(-5842), 7611⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-303718613), 0⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3991248683, 4294967296⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 23944980⟩, ⟨0, 24342594⟩, ⟨5536856, 6488108⟩, ⟨(-90356), 177400⟩, ⟨6326, 14385⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4318912276⟩, ⟨0, 24342594⟩, ⟨5536856, 6488108⟩, ⟨(-90356), 177400⟩, ⟨6326, 14385⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306923146⟩, ⟨0, 12171297⟩, ⟨2743544, 3244054⟩, ⟨(-54372), 88700⟩, ⟨1680, 6472⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3991248683, 4306923146⟩, ⟨(-152282036), (-139688009)⟩, ⟨2119187, 3244054⟩, ⟨(-169074), (-8304)⟩, ⟨(-1576), 8395⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2759584927⟩, ⟨1379792458, 1379792468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1773077289⟩, ⟨0, 1773077296⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1773077289⟩, ⟨0, 1773077296⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1773077289), 0⟩, ⟨(-1773077296), 0⟩, ⟨(-443269326), (-443269318)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-886538645), 0⟩, ⟨(-886538648), 0⟩, ⟨(-221634663), (-221634659)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3493941879, 4294967296⟩, ⟨(-886538648), 0⟩, ⟨(-221634663), (-88802359)⟩, ⟨0, 45748357⟩, ⟨(-69520), 5718545⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3246867778, 4306923146⟩, ⟨(-1041288532), (-113635739)⟩, ⟨(-220527674), (-47845598)⟩, ⟨2049485, 53727214⟩, ⟨(-1860746), 5733943⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297915219, 4297915220⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2322
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306923146⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2323
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (274618917 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(14143 / 200000), prawitzNormalCorrection
