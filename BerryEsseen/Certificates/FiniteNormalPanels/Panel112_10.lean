...
namespace FiniteNormalPanel112_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (85023 / 800000)
def radius : Rat := (28341 / 800000)

def j0 : Jet := ⟨⟨456463755, 456463756⟩, ⟨152154585, 152154586⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1434023179, 1434023183⟩, ⟨478007726, 478007730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨478798169, 478798172⟩, ⟨319198778, 319198784⟩, ⟨53199796, 53199798⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨119, 120⟩, ⟨79, 80⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94568), (-94566)⟩, ⟨79, 80⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10543), (-10542)⟩, ⟨(-7021), (-7019)⟩, ⟨(-1166), (-1163)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102513, 5102515⟩, ⟨(-7021), (-7019)⟩, ⟨(-1166), (-1163)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨568822, 568823⟩, ⟨378431, 378434⟩, ⟨62550, 62553⟩, ⟨(-174), (-171)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-142596755), (-142596753)⟩, ⟨378431, 378434⟩, ⟨62550, 62553⟩, ⟨(-174), (-171)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15896528), (-15896527)⟩, ⟨(-10555499), (-10555496)⟩, ⟨(-1731184), (-1731181)⟩, ⟨9315, 9318⟩, ⟨759, 762⟩⟩
...
def j19 : Jet := ⟨⟨1415759237, 1415759239⟩, ⟨(-10555499), (-10555496)⟩, ⟨(-1731184), (-1731181)⟩, ⟨9315, 9318⟩, ⟨759, 762⟩⟩
...
def j22 : Jet := ⟨⟨(-13), (-11)⟩, ⟨(-9), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11822, 11825⟩, ⟨(-9), (-7)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1317, 1319⟩, ⟨876, 879⟩, ⟨144, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850860), (-850857)⟩, ⟨876, 879⟩, ⟨144, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-94853), (-94852)⟩, ⟨(-63139), (-63137)⟩, ⟨(-10459), (-10456)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35696541, 35696543⟩, ⟨(-63139), (-63137)⟩, ⟨(-10459), (-10456)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3979410, 3979411⟩, ⟨2645901, 2645903⟩, ⟨436297, 436300⟩, ⟨(-1559), (-1556)⟩, ⟨(-130), (-126)⟩⟩
...
def j33 : Jet := ⟨⟨(-711848473), (-711848471)⟩, ⟨2645901, 2645903⟩, ⟨436297, 436300⟩, ⟨(-1559), (-1556)⟩, ⟨(-130), (-126)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-79356076), (-79356074)⟩, ⟨(-52609089), (-52609086)⟩, ⟨(-8572064), (-8572060)⟩, ⟨65024, 65027⟩, ⟨5273, 5276⟩⟩
...
def j36 : Jet := ⟨⟨4215611220, 4215611222⟩, ⟨(-52609089), (-52609086)⟩, ⟨(-8572064), (-8572060)⟩, ⟨65024, 65027⟩, ⟨5273, 5276⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨472700121, 472700124⟩, ⟨154042388, 154042393⟩, ⟨(-1752789), (-1752786)⟩, ⟨(-189562), (-189559)⟩, ⟨1289, 1293⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4375817195, 4375817198⟩, ⟨54608390, 54608395⟩, ⟨9579313, 9579320⟩, ⟨163087, 163094⟩, ⟨15192, 15200⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨481598385, 481598390⟩, ⟨162952281, 162952289⟩, ⟨1227077, 1227085⟩, ⟨146101, 146108⟩, ⟨2513, 2522⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-456463756), (-456463755)⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3838503540, 3838503541⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨54002042, 54002044⟩, ⟨36543958, 36543962⟩, ⟨6457641, 6457647⟩, ⟨125874, 125880⟩, ⟨11998, 12005⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4348969338, 4348969340⟩, ⟨36543958, 36543962⟩, ⟨6457641, 6457647⟩, ⟨125874, 125880⟩, ⟨11998, 12005⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4321883973, 4321883975⟩, ⟨18158181, 18158184⟩, ⟨3170565, 3170570⟩, ⟨49223, 49228⟩, ⟨4590, 4596⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3862559546, 3862559550⟩, ⟨(-136879792), (-136879786)⟩, ⟨2190324, 2190330⟩, ⟨(-68331), (-68324)⟩, ⟨2358, 2365⟩⟩
...
def j47 : Jet := ⟨⟨4724403590, 4724403603⟩, ⟨1574801196, 1574801208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5196777470, 5196777500⟩, ⟨3464518312, 3464518350⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5196777470, 5196777500⟩, ⟨3464518312, 3464518350⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5196777500), (-5196777470)⟩, ⟨(-3464518350), (-3464518312)⟩, ⟨(-577419728), (-577419718)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2598388750), (-2598388735)⟩, ⟨(-1732259175), (-1732259156)⟩, ⟨(-288709864), (-288709859)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2345408094, 2345408113⟩, ⟨(-945957081), (-945957062)⟩, ⟨33103612, 33103623⟩, ⟨37941321, 37941325⟩, ⟨(-4938274), (-4938272)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2109277626, 2109277646⟩, ⟨(-925467940), (-925467916)⟩, ⟨61114382, 61114399⟩, ⟨32546735, 32546748⟩, ⟨(-5617067), (-5617054)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨304309170, 608618341⟩, ⟨152154585, 152154586⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨956015452, 1912030909⟩, ⟨478007726, 478007730⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨212799185, 851196749⟩, ⟨212799184, 425598378⟩, ⟨53199796, 53199798⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨53, 214⟩, ⟨53, 107⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94634), (-94472)⟩, ⟨53, 107⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-18756), (-4680)⟩, ⟨(-9376), (-4658)⟩, ⟨(-1171), (-1156)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5094300, 5108377⟩, ⟨(-9376), (-4658)⟩, ⟨(-1171), (-1156)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨252403, 1012403⟩, ⟨250544, 505972⟩, ⟨61937, 62989⟩, ⟨(-234), (-113)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142913174), (-142153173)⟩, ⟨250544, 505972⟩, ⟨61937, 62989⟩, ⟨(-234), (-113)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-28323203), (-7043145)⟩, ⟨(-14149189), (-6942869)⟩, ⟨(-1754720), (-1698164)⟩, ⟨6124, 12505⟩, ⟨740, 776⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1403332562, 1424612621⟩, ⟨(-14149189), (-6942869)⟩, ⟨(-1754720), (-1698164)⟩, ⟨6124, 12505⟩, ⟨740, 776⟩⟩
...
def j72 : Jet := ⟨⟨585, 2345⟩, ⟨582, 1173⟩, ⟨143, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851592), (-849831)⟩, ⟨582, 1173⟩, ⟨143, 147⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-168773), (-42105)⟩, ⟨(-84359), (-41872)⟩, ⟨(-10514), (-10379)⟩, ⟨13, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35622621, 35749290⟩, ⟨(-84359), (-41872)⟩, ⟨(-10514), (-10379)⟩, ⟨13, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1764964, 7084962⟩, ⟨1748245, 3540407⟩, ⟨430797, 440223⟩, ⟨(-2087), (-1026)⟩, ⟨(-132), (-124)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714062919), (-708742920)⟩, ⟨1748245, 3540407⟩, ⟨430797, 440223⟩, ⟨(-2087), (-1026)⟩, ⟨(-132), (-124)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-141516337), (-35115498)⟩, ⟨(-70671551), (-34413842)⟩, ⟨(-8736810), (-8340800)⟩, ⟨42584, 87427⟩, ⟨5102, 5397⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4153450959, 4259851798⟩, ⟨(-70671551), (-34413842)⟩, ⟨(-8736810), (-8340800)⟩, ⟨42584, 87427⟩, ⟨5102, 5397⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨312367364, 634208174⟩, ⟨149884754, 157006634⟩, ⟨(-2355898), (-1150698)⟩, ⟨(-193929), (-183429)⟩, ⟨845, 1738⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4330372263, 4441305377⟩, ⟨34983551, 75569436⟩, ⟨8761498, 10628140⟩, ⟨48126, 295404⟩, ⟨10363, 21707⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨314942321, 655816909⟩, ⟨153664615, 173514980⟩, ⟨(-578110), 3171715⟩, ⟨67267, 237830⟩, ⟨(-5960), 11962⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-608618341), (-304309170)⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3686348955, 3990658126⟩, ⟨(-152154586), (-152154585)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨23094160, 100139487⟩, ⟨22535906, 52989488⟩, ⟨5321236, 7978543⟩, ⟨(-36848), 328906⟩, ⟨2563, 25215⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4318061456, 4395106783⟩, ⟨22535906, 52989488⟩, ⟨5321236, 7978543⟩, ⟨(-36848), 328906⟩, ⟨2563, 25215⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306498895, 4344748543⟩, ⟨11138847, 26423799⟩, ⟨2549781, 3964185⟩, ⟨(-42699), 157419⟩, ⟨(-1513), 12082⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3696246468, 4036912248⟩, ⟨(-144357733), (-128011499)⟩, ⟨1252367, 3288706⟩, ⟨(-180111), 55937⟩, ⟨(-6983), 12739⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3149602393, 6299204800⟩, ⟨1574801196, 1574801208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2309678875, 9238715543⟩, ⟨2309678874, 4619357796⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2309678875, 9238715543⟩, ⟨2309678874, 4619357796⟩, ⟨577419718, 577419728⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9238715543), (-2309678875)⟩, ⟨(-4619357796), (-2309678874)⟩, ⟨(-577419728), (-577419718)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4619357772), (-1154839437)⟩, ⟨(-2309678898), (-1154839437)⟩, ⟨(-288709864), (-288709859)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1465088860, 3282357559⟩, ⟨(-1765133811), (-393936036)⟩, ⟨(-167680572), 376128722⟩, ⟨(-49769114), 109159649⟩, ⟨(-27317315), 12326797⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1260854658, 3085143267⟩, ⟨(-1769402065), (-382688106)⟩, ⟨(-145437333), 415370817⟩, ⟨(-60910089), 108164775⟩, ⟨(-29501682), 13630715⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨456463755, 456463756⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4321883973, 4321883975⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2256
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨304309170, 608618341⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306498895, 4344748543⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2257
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (75542059 / 2147483648)

theorem envelope_integral : (∫ s in ((28341 / 400000) : ℝ)..(28341 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((28341 / 400000) : ℝ)..(28341 / 200000), prawitzNormalCorrection
