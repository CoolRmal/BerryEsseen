...
namespace FiniteNormalPanel37_4

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (45841 / 400000)
def radius : Rat := (45841 / 400000)

def j0 : Jet := ⟨⟨492213989, 492213990⟩, ⟨492213989, 492213990⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1546335851, 1546335856⟩, ⟨1546335851, 1546335856⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨556734056, 556734060⟩, ⟨1113468112, 1113468120⟩, ⟨556734056, 556734060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨139, 140⟩, ⟨278, 279⟩, ⟨139, 140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94548), (-94546)⟩, ⟨278, 279⟩, ⟨139, 140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-12256), (-12255)⟩, ⟨(-24476), (-24474)⟩, ⟨(-12166), (-12163)⟩, ⟨72, 74⟩, ⟨18, 19⟩⟩
...
def j13 : Jet := ⟨⟨5100800, 5100802⟩, ⟨(-24476), (-24474)⟩, ⟨(-12166), (-12163)⟩, ⟨72, 74⟩, ⟨18, 19⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨661189, 661191⟩, ⟨1319206, 1319209⟩, ⟨653265, 653271⟩, ⟨(-6319), (-6315)⟩, ⟨(-1558), (-1553)⟩⟩
...
def j16 : Jet := ⟨⟨(-142504388), (-142504385)⟩, ⟨1319206, 1319209⟩, ⟨653265, 653271⟩, ⟨(-6319), (-6315)⟩, ⟨(-1558), (-1553)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-18472096), (-18472095)⟩, ⟨(-36773191), (-36773187)⟩, ⟨(-18045414), (-18045409)⟩, ⟨339539, 339546⟩, ⟨82838, 82843⟩⟩
...
def j19 : Jet := ⟨⟨1413183669, 1413183671⟩, ⟨(-36773191), (-36773187)⟩, ⟨(-18045414), (-18045409)⟩, ⟨339539, 339546⟩, ⟨82838, 82843⟩⟩
...
def j22 : Jet := ⟨⟨(-14), (-13)⟩, ⟨(-28), (-27)⟩, ⟨(-14), (-13)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11821, 11823⟩, ⟨(-28), (-27)⟩, ⟨(-14), (-13)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1532, 1533⟩, ⟨3060, 3063⟩, ⟨1522, 1526⟩, ⟨(-8), (-6)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850645), (-850643)⟩, ⟨3060, 3063⟩, ⟨1522, 1526⟩, ⟨(-8), (-6)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-110265), (-110264)⟩, ⟨(-220134), (-220130)⟩, ⟨(-109275), (-109271)⟩, ⟨788, 794⟩, ⟨193, 197⟩⟩
...
def j30 : Jet := ⟨⟨35681129, 35681131⟩, ⟨(-220134), (-220130)⟩, ⟨(-109275), (-109271)⟩, ⟨788, 794⟩, ⟨193, 197⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4625157, 4625158⟩, ⟨9221779, 9221782⟩, ⟨4553922, 4553926⟩, ⟨(-56763), (-56759)⟩, ⟨(-13936), (-13932)⟩⟩
...
def j33 : Jet := ⟨⟨(-711202726), (-711202724)⟩, ⟨9221779, 9221782⟩, ⟨4553922, 4553926⟩, ⟨(-56763), (-56759)⟩, ⟨(-13936), (-13932)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-92189476), (-92189474)⟩, ⟨(-183183581), (-183183576)⟩, ⟨(-89208435), (-89208429)⟩, ⟨2368613, 2368619⟩, ⟨573777, 573783⟩⟩
...
def j36 : Jet := ⟨⟨4202777820, 4202777822⟩, ⟨(-183183581), (-183183576)⟩, ⟨(-89208435), (-89208429)⟩, ⟨2368613, 2368619⟩, ⟨573777, 573783⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨508794694, 508794697⟩, ⟨495555081, 495555086⟩, ⟨(-19736583), (-19736578)⟩, ⟨(-6374725), (-6374718)⟩, ⟨152069, 152076⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4389178979, 4389178983⟩, ⟨191308113, 191308121⟩, ⟨101503405, 101503415⟩, ⟨6011203, 6011214⟩, ⟨1709473, 1709484⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨519955292, 519955296⟩, ⟨529088195, 529088204⟩, ⟨13928092, 13928102⟩, ⟨5029937, 5029950⟩, ⟨301105, 301119⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-492213990), (-492213989)⟩, ⟨(-492213990), (-492213989)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3802753306, 3802753307⟩, ⟨(-492213990), (-492213989)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨62946580, 62946582⟩, ⟨128104446, 128104452⟩, ⟨68549599, 68549606⟩, ⟨4649408, 4649418⟩, ⟨1357325, 1357336⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4357913876, 4357913878⟩, ⟨128104446, 128104452⟩, ⟨68549599, 68549606⟩, ⟨4649408, 4649418⟩, ⟨1357325, 1357336⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4326326106, 4326326108⟩, ⟨63587948, 63587952⟩, ⟨33559058, 33559063⟩, ⟨1814605, 1814611⟩, ⟨516913, 516921⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3830518317, 3830518321⟩, ⟨(-439507179), (-439507173)⟩, ⟨22425767, 22425774⟩, ⟨(-2239307), (-2239298)⟩, ⟨249714, 249723⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨15894814968, 15894814970⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value257

def j47 : Jet := ⟨⟨1821585530, 1821585535⟩, ⟨1821585530, 1821585535⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨772572551, 772572556⟩, ⟨1545145102, 1545145112⟩, ⟨772572551, 772572556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨772572551, 772572556⟩, ⟨1545145102, 1545145112⟩, ⟨772572551, 772572556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-772572556), (-772572551)⟩, ⟨(-1545145112), (-1545145102)⟩, ⟨(-772572556), (-772572551)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-386286278), (-386286275)⟩, ⟨(-772572556), (-772572551)⟩, ⟨(-386286278), (-386286275)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3925542892, 3925542896⟩, ⟨(-706121025), (-706121019)⟩, ⟨(-289552495), (-289552490)⟩, ⟨59700106, 59700109⟩, ⟨10336379, 10336380⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3501042712, 3501042720⟩, ⟨(-1031466251), (-1031466237)⟩, ⟨(-165486145), (-165486129)⟩, ⟨77140734, 77140751⟩, ⟨2193985, 2194001⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 984427980⟩, ⟨492213989, 492213990⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 3092671711⟩, ⟨1546335851, 1546335856⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 2226936238⟩, ⟨0, 2226936240⟩, ⟨556734056, 556734060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 558⟩, ⟨0, 558⟩, ⟨139, 140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94128)⟩, ⟨0, 558⟩, ⟨139, 140⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-49096), 0⟩, ⟨(-49096), 290⟩, ⟨(-12274), (-11838)⟩, ⟨0, 146⟩, ⟨18, 19⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5063960, 5113057⟩, ⟨(-49096), 290⟩, ⟨(-12274), (-11838)⟩, ⟨0, 146⟩, ⟨18, 19⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2651115⟩, ⟨(-25457), 2651266⟩, ⟨624592, 662930⟩, ⟨(-12730), 114⟩, ⟨(-1592), (-1448)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-140514461)⟩, ⟨(-25457), 2651266⟩, ⟨624592, 662930⟩, ⟨(-12730), 114⟩, ⟨(-1592), (-1448)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-74231209), 0⟩, ⟨(-74244409), 1374679⟩, ⟨(-18571003), (-16495743)⟩, ⟨(-9901), 687459⟩, ⟨73535, 85993⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1357424556, 1431655766⟩, ⟨(-74244409), 1374679⟩, ⟨(-18571003), (-16495743)⟩, ⟨(-9901), 687459⟩, ⟨73535, 85993⟩⟩
...
def j70 : Jet := ⟨⟨(-56), 0⟩, ⟨(-56), 0⟩, ⟨(-14), (-13)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11779, 11836⟩, ⟨(-56), 0⟩, ⟨(-14), (-13)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 6137⟩, ⟨(-30), 6137⟩, ⟨1488, 1535⟩, ⟨(-16), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-846039)⟩, ⟨(-30), 6137⟩, ⟨1488, 1535⟩, ⟨(-16), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-441853), 0⟩, ⟨(-441869), 3183⟩, ⟨(-110480), (-105688)⟩, ⟨(-13), 1592⟩, ⟨181, 199⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35349541, 35791395⟩, ⟨(-441869), 3183⟩, ⟨(-110480), (-105688)⟩, ⟨(-13), 1592⟩, ⟨181, 199⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 18557803⟩, ⟨(-229109), 18559454⟩, ⟨4295782, 4641102⟩, ⟨(-114569), 1239⟩, ⟨(-14328), (-12769)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-697270079)⟩, ⟨(-229109), 18559454⟩, ⟨4295782, 4641102⟩, ⟨(-114569), 1239⟩, ⟨(-14328), (-12769)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-371156040), 0⟩, ⟨(-371274834), 9623059⟩, ⟨(-92907804), (-78353992)⟩, ⟨(-89103), 4812815⟩, ⟨490005, 602245⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3923811256, 4294967296⟩, ⟨(-371274834), 9623059⟩, ⟨(-92907804), (-78353992)⟩, ⟨(-89103), 4812815⟩, ⟨490005, 602245⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 1030890571⟩, ⟨435258417, 516435150⟩, ⟨(-40102939), 494932⟩, ⟨(-6693330), (-5444016)⟩, ⟨(-3565), 309430⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4701231245⟩, ⟨(-11529665), 444835070⟩, ⟨77357319, 153406243⟩, ⟨(-6415599), 25154990⟩, ⟨(-329504), 5490323⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 1128403229⟩, ⟨432491033, 672055722⟩, ⟨(-45282654), 90850589⟩, ⟨(-5180353), 19147277⟩, ⟨(-2980037), 4716835⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-984427980), 0⟩, ⟨(-492213990), (-492213989)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3310539316, 4294967296⟩, ⟨(-492213990), (-492213989)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 296461827⟩, ⟨0, 353134166⟩, ⟨19756681, 152897811⟩, ⟨(-16893258), 38492732⟩, ⟨(-4144921), 10392373⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4591429123⟩, ⟨0, 353134166⟩, ⟨19756681, 152897811⟩, ⟨(-16893258), 38492732⟩, ⟨(-4144921), 10392373⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4440724933⟩, ⟨0, 176567083⟩, ⟨6043873, 76448906⟩, ⟨(-11589461), 19246366⟩, ⟨(-3544066), 5668381⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3310539316, 4440724933⟩, ⟨(-508918180), (-315646906)⟩, ⟨(-15576443), 76448906⟩, ⟨(-20350697), 18553724⟩, ⟨(-5749748), 6996563⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3643171069⟩, ⟨1821585530, 1821585535⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3090290222⟩, ⟨0, 3090290224⟩, ⟨772572551, 772572556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3090290222⟩, ⟨0, 3090290224⟩, ⟨772572551, 772572556⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3090290222), 0⟩, ⟨(-3090290224), 0⟩, ⟨(-772572556), (-772572551)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1545145111), 0⟩, ⟨(-1545145112), 0⟩, ⟨(-386286278), (-386286275)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2997224846, 4294967296⟩, ⟨(-1545145112), 0⟩, ⟨(-386286278), 8370236⟩, ⟨(-1003751), 138969244⟩, ⟨(-12875201), 17461433⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2310245924, 4440724933⟩, ⟨(-2106500642), (-220272864)⟩, ⟨(-414972059), 268190147⟩, ⟨(-49883357), 213614620⟩, ⟨(-49079197), 33891763⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨492213989, 492213990⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨492213989, 492213990⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4326326106, 4326326108⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar257 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified718
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar257 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 984427980⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4440724933⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified719
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(45841 / 200000), prawitzNormalCorrection
      ((2313 / 1250) * sqrt n) s) ≤ (upper : ℝ) :=
