...
namespace FiniteNormalPanel171_16
...
def j2 : Jet := ⟨⟨435555256, 435555260⟩, ⟨435555256, 435555260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨44169924, 44169926⟩, ⟨88339848, 88339852⟩, ⟨44169924, 44169926⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-974), (-973)⟩, ⟨(-1948), (-1946)⟩, ⟨(-974), (-971)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5112082, 5112084⟩, ⟨(-1948), (-1946)⟩, ⟨(-974), (-971)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨52573, 52574⟩, ⟨105125, 105127⟩, ⟨52521, 52525⟩, ⟨(-42), (-38)⟩, ⟨(-11), (-7)⟩⟩
...
def j16 : Jet := ⟨⟨(-143113004), (-143113002)⟩, ⟨105125, 105127⟩, ⟨52521, 52525⟩, ⟨(-42), (-38)⟩, ⟨(-11), (-7)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1471791), (-1471790)⟩, ⟨(-2942500), (-2942498)⟩, ⟨(-1469089), (-1469086)⟩, ⟨2160, 2163⟩, ⟨538, 541⟩⟩
...
def j19 : Jet := ⟨⟨1430183974, 1430183976⟩, ⟨(-2942500), (-2942498)⟩, ⟨(-1469089), (-1469086)⟩, ⟨2160, 2163⟩, ⟨538, 541⟩⟩
...
def j25 : Jet := ⟨⟨121, 122⟩, ⟨242, 244⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852056), (-852054)⟩, ⟨242, 244⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-8763), (-8762)⟩, ⟨(-17524), (-17522)⟩, ⟨(-8758), (-8754)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35782631, 35782633⟩, ⟨(-17524), (-17522)⟩, ⟨(-8758), (-8754)⟩, ⟨3, 6⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨367992, 367993⟩, ⟨735804, 735806⟩, ⟨367540, 367543⟩, ⟨(-362), (-359)⟩, ⟨(-92), (-88)⟩⟩
...
def j33 : Jet := ⟨⟨(-715459891), (-715459889)⟩, ⟨735804, 735806⟩, ⟨367540, 367543⟩, ⟨(-362), (-359)⟩, ⟨(-92), (-88)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-7357870), (-7357869)⟩, ⟨(-14708173), (-14708171)⟩, ⟨(-7338957), (-7338954)⟩, ⟨15122, 15125⟩, ⟨3770, 3773⟩⟩
...
def j36 : Jet := ⟨⟨4287609426, 4287609427⟩, ⟨(-14708173), (-14708171)⟩, ⟨(-7338957), (-7338954)⟩, ⟨15122, 15125⟩, ⟨3770, 3773⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨145035830, 145035832⟩, ⟨144737429, 144737432⟩, ⟨(-447383), (-447380)⟩, ⟨(-148763), (-148760)⟩, ⟨273, 275⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4302337791, 4302337793⟩, ⟨14758694, 14758698⟩, ⟨7414791, 7414797⟩, ⟨35519, 35526⟩, ⟨8973, 8981⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨145284722, 145284725⟩, ⟨145484192, 145484197⟩, ⟨299594, 299600⟩, ⟨100515, 100522⟩, ⟨487, 495⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-138641545), (-138641544)⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4156325751, 4156325752⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨4914507, 4914509⟩, ⟨9842510, 9842512⟩, ⟨4948279, 4948283⟩, ⟨27096, 27100⟩, ⟨6860, 6865⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4299881803, 4299881805⟩, ⟨9842510, 9842512⟩, ⟨4948279, 4948283⟩, ⟨27096, 27100⟩, ⟨6860, 6865⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297423846, 4297423848⟩, ⟨4918441, 4918443⟩, ⟨2469910, 2469913⟩, ⟨10712, 10716⟩, ⟨2704, 2709⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4158703003, 4158703007⟩, ⟨(-133961170), (-133961165)⟩, ⟨2231413, 2231418⟩, ⟨(-69363), (-69357)⟩, ⟨2270, 2277⟩⟩
...
def j47 : Jet := ⟨⟨1450541918, 1450541930⟩, ⟨1450541918, 1450541930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨489892404, 489892413⟩, ⟨979784808, 979784826⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨489892404, 489892413⟩, ⟨979784808, 979784826⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-489892413), (-489892404)⟩, ⟨(-979784826), (-979784808)⟩, ⟨(-489892413), (-489892404)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-244946207), (-244946202)⟩, ⟨(-489892413), (-489892404)⟩, ⟨(-244946207), (-244946202)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4056874939, 4056874945⟩, ⟨(-462735132), (-462735122)⟩, ⟨(-204977329), (-204977321)⟩, ⟨25386863, 25386866⟩, ⟨5121109, 5121111⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3928164483, 3928164494⟩, ⟨(-574589172), (-574589155)⟩, ⟨(-181933572), (-181933556)⟩, ⟨30668793, 30668806⟩, ⟨4069931, 4069946⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 277283089⟩, ⟨138641544, 138641545⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 871110516⟩, ⟨435555256, 435555260⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 176679700⟩, ⟨0, 176679702⟩, ⟨44169924, 44169926⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-3896), 0⟩, ⟨(-3896), 2⟩, ⟨(-974), (-970)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5109160, 5113057⟩, ⟨(-3896), 2⟩, ⟨(-974), (-970)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 210334⟩, ⟨(-161), 210335⟩, ⟨52341, 52585⟩, ⟨(-82), 2⟩, ⟨(-11), (-7)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142955242)⟩, ⟨(-161), 210335⟩, ⟨52341, 52585⟩, ⟨(-82), 2⟩, ⟨(-11), (-7)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-5889324), 0⟩, ⟨(-5889331), 8653⟩, ⟨(-1472338), (-1459350)⟩, ⟨(-6), 4329⟩, ⟨533, 542⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1425766441, 1431655766⟩, ⟨(-5889331), 8653⟩, ⟨(-1472338), (-1459350)⟩, ⟨(-6), 4329⟩, ⟨533, 542⟩⟩
...
def j72 : Jet := ⟨⟨0, 487⟩, ⟨(-1), 487⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851689)⟩, ⟨(-1), 487⟩, ⟨119, 122⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-35056), 0⟩, ⟨(-35057), 21⟩, ⟨(-8765), (-8731)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35756338, 35791395⟩, ⟨(-35057), 21⟩, ⟨(-8765), (-8731)⟩, ⟨(-2), 12⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1472331⟩, ⟨(-1443), 1472332⟩, ⟨365918, 368084⟩, ⟨(-723), 2⟩, ⟨(-93), (-87)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714355551)⟩, ⟨(-1443), 1472332⟩, ⟨365918, 368084⟩, ⟨(-723), 2⟩, ⟨(-93), (-87)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-29446617), 0⟩, ⟨(-29446678), 60567⟩, ⟨(-7361715), (-7270803)⟩, ⟨(-45), 30285⟩, ⟨3729, 3787⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4265520679, 4294967296⟩, ⟨(-29446678), 60567⟩, ⟨(-7361715), (-7270803)⟩, ⟨(-45), 30285⟩, ⟨3729, 3787⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 290370173⟩, ⟨143393363, 145186843⟩, ⟨(-895863), 878⟩, ⟨(-149313), (-147114)⟩, ⟨(-1), 550⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4324617195⟩, ⟨(-61408), 29854647⟩, ⟨7270381, 7669808⟩, ⟨(-30923), 104520⟩, ⟨8069, 10206⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 292374716⟩, ⟨143389211, 148207513⟩, ⟨(-904124), 1528624⟩, ⟨84068, 119236⟩, ⟨(-3686), 4783⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-277283089), 0⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨4017684207, 4294967296⟩, ⟨(-138641545), (-138641544)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 19903056⟩, ⟨0, 20178096⟩, ⟨4664010, 5322354⟩, ⟨(-62398), 121732⟩, ⟨4788, 9427⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4314870352⟩, ⟨0, 20178096⟩, ⟨4664010, 5322354⟩, ⟨(-62398), 121732⟩, ⟨4788, 9427⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4304907322⟩, ⟨0, 10089048⟩, ⟨2314797, 2661177⟩, ⟨(-37451), 60866⟩, ⟨1423, 4178⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨4017684207, 4304907322⟩, ⟨(-138962410), (-128552496)⟩, ⟨1839678, 2661177⟩, ⟨(-123354), (-13855)⟩, ⟨(-634), 5387⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2901083849⟩, ⟨1450541918, 1450541930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1959569636⟩, ⟨0, 1959569644⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1959569636⟩, ⟨0, 1959569644⟩, ⟨489892404, 489892413⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1959569636), 0⟩, ⟨(-1959569644), 0⟩, ⟨(-489892413), (-489892404)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-979784818), 0⟩, ⟨(-979784822), 0⟩, ⟨(-244946207), (-244946202)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3418903928, 4294967296⟩, ⟨(-979784822), 0⟩, ⟨(-244946207), (-83227265)⟩, ⟨0, 55878092⟩, ⟨(-813517), 6984762⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3198179490, 4304907322⟩, ⟨(-1121014790), (-102331078)⟩, ⟨(-244048667), (-43492283)⟩, ⟨1760638, 63921549⟩, ⟨(-2775724), 6998806⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297423846, 4297423848⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3470
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4304907322⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3471
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (249777459 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(807 / 12500), prawitzNormalCorrection
