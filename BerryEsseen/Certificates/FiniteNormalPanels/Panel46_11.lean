...
namespace FiniteNormalPanel46_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (196 / 625)
def radius : Rat := (28 / 625)

def j0 : Jet := ⟨⟨1346901744, 1346901745⟩, ⟨192414534, 192414535⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4231416623, 4231416628⟩, ⟨604488086, 604488090⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4168806280, 4168806291⟩, ⟨1191087502, 1191087514⟩, ⟨85077678, 85077680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1043, 1045⟩, ⟨298, 299⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93644), (-93641)⟩, ⟨298, 299⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-90894), (-90890)⟩, ⟨(-25681), (-25677)⟩, ⟨(-1753), (-1749)⟩, ⟨10, 13⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5022162, 5022167⟩, ⟨(-25681), (-25677)⟩, ⟨(-1753), (-1749)⟩, ⟨10, 13⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4874640, 4874646⟩, ⟨1367827, 1367834⟩, ⟨90658, 90666⟩, ⟨(-987), (-980)⟩, ⟨(-33), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-138290937), (-138290930)⟩, ⟨1367827, 1367834⟩, ⟨90658, 90666⟩, ⟨(-987), (-980)⟩, ⟨(-33), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-134228759), (-134228751)⟩, ⟨(-37023426), (-37023415)⟩, ⟨(-2272041), (-2272028)⟩, ⟨51276, 51289⟩, ⟨1488, 1497⟩⟩
...
def j19 : Jet := ⟨⟨1297427006, 1297427015⟩, ⟨(-37023426), (-37023415)⟩, ⟨(-2272041), (-2272028)⟩, ⟨51276, 51289⟩, ⟨1488, 1497⟩⟩
...
def j22 : Jet := ⟨⟨(-105), (-103)⟩, ⟨(-30), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11730, 11733⟩, ⟨(-30), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11385, 11389⟩, ⟨3222, 3226⟩, ⟨220, 224⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840792), (-840787)⟩, ⟨3222, 3226⟩, ⟨220, 224⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-816095), (-816089)⟩, ⟨(-230043), (-230036)⟩, ⟨(-15549), (-15541)⟩, ⟨122, 127⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨34975299, 34975306⟩, ⟨(-230043), (-230036)⟩, ⟨(-15549), (-15541)⟩, ⟨122, 127⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨33947929, 33947937⟩, ⟨9476122, 9476133⟩, ⟨613925, 613939⟩, ⟨(-8752), (-8741)⟩, ⟨(-275), (-266)⟩⟩
...
def j33 : Jet := ⟨⟨(-681879954), (-681879945)⟩, ⟨9476122, 9476133⟩, ⟨613925, 613939⟩, ⟨(-8752), (-8741)⟩, ⟨(-275), (-266)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-661850312), (-661850300)⟩, ⟨(-179902322), (-179902304)⟩, ⟨(-10283326), (-10283304)⟩, ⟨349468, 349485⟩, ⟨9466, 9480⟩⟩
...
def j36 : Jet := ⟨⟨3633116984, 3633116996⟩, ⟨(-179902322), (-179902304)⟩, ⟨(-10283326), (-10283304)⟩, ⟨349468, 349485⟩, ⟨9466, 9480⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1278229570, 1278229581⟩, ⟨146128615, 146128630⟩, ⟨(-7449225), (-7449208)⟩, ⟨(-269258), (-269241)⟩, ⟨8681, 8694⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5077387844, 5077387862⟩, ⟨251418759, 251418788⟩, ⟨26820807, 26820844⟩, ⟨1551300, 1551333⟩, ⟨115294, 115323⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1511086542, 1511086561⟩, ⟨247574072, 247574101⟩, ⟨7729980, 7730016⟩, ⟨619840, 619876⟩, ⟨35073, 35104⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1346901745), (-1346901744)⟩, ⟨(-192414535), (-192414534)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2948065551, 2948065552⟩, ⟨(-192414535), (-192414534)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨531641425, 531641440⟩, ⟨174206610, 174206634⟩, ⟨19710104, 19710136⟩, ⟨1327306, 1327342⟩, ⟨110048, 110079⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4826608721, 4826608736⟩, ⟨174206610, 174206634⟩, ⟨19710104, 19710136⟩, ⟨1327306, 1327342⟩, ⟨110048, 110079⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4553034878, 4553034886⟩, ⟨82166259, 82166272⟩, ⟨8555057, 8555074⟩, ⟨471647, 471666⟩, ⟨35355, 35373⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3125203139, 3125203146⟩, ⟨(-147577044), (-147577031)⟩, ⟨2191142, 2191155⟩, ⟨(-59530), (-59514)⟩, ⟨3136, 3152⟩⟩
...
def j47 : Jet := ⟨⟨7599372919, 7599372928⟩, ⟨1085624697, 1085624704⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13446078813, 13446078846⟩, ⟨3841736782, 3841736814⟩, ⟨274409768, 274409773⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13446078813, 13446078846⟩, ⟨3841736782, 3841736814⟩, ⟨274409768, 274409773⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13446078846), (-13446078813)⟩, ⟨(-3841736814), (-3841736782)⟩, ⟨(-274409773), (-274409768)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6723039423), (-6723039406)⟩, ⟨(-1920868407), (-1920868391)⟩, ⟨(-137204887), (-137204884)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨897730234, 897730249⟩, ⟨(-401498209), (-401498198)⟩, ⟨61103985, 61103991⟩, ⟨(-558616), (-558613)⟩, ⟨(-913541), (-913540)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨653227173, 653227186⟩, ⟨(-322993809), (-322993795)⟩, ⟨58715540, 58715552⟩, ⟨(-2723311), (-2723299)⟩, ⟨(-608147), (-608138)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1154487209, 1539316279⟩, ⟨192414534, 192414535⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3626928534, 4835904714⟩, ⟨604488086, 604488090⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3062796450, 5444971473⟩, ⟨1020932144, 1361242870⟩, ⟨85077678, 85077680⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨766, 1365⟩, ⟨255, 342⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93921), (-93321)⟩, ⟨255, 342⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-119069), (-66548)⟩, ⟨(-29587), (-21748)⟩, ⟨(-1787), (-1711)⟩, ⟨9, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4993987, 5046509⟩, ⟨(-29587), (-21748)⟩, ⟨(-1787), (-1711)⟩, ⟨9, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3561276, 6397744⟩, ⟨1149582, 1583928⟩, ⟨87280, 93576⟩, ⟨(-1148), (-818)⟩, ⟨(-34), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139604301), (-136767832)⟩, ⟨1149582, 1583928⟩, ⟨87280, 93576⟩, ⟨(-1148), (-818)⟩, ⟨(-34), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-176984220), (-97530901)⟩, ⟨(-43426275), (-30502265)⟩, ⟨(-2429879), (-2088550)⟩, ⟨42061, 60451⟩, ⟨1320, 1642⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1254671545, 1334124865⟩, ⟨(-43426275), (-30502265)⟩, ⟨(-2429879), (-2088550)⟩, ⟨42061, 60451⟩, ⟨1320, 1642⟩⟩
...
def j70 : Jet := ⟨⟨(-137), (-76)⟩, ⟨(-35), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11698, 11760⟩, ⟨(-35), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8341, 14909⟩, ⟨2735, 3711⟩, ⟨215, 227⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843836), (-837267)⟩, ⟨2735, 3711⟩, ⟨215, 227⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1069779), (-597065)⟩, ⟨(-265495), (-194316)⟩, ⟨(-15913), (-15120)⟩, ⟨102, 146⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34721615, 35194330⟩, ⟨(-265495), (-194316)⟩, ⟨(-15913), (-15120)⟩, ⟨102, 146⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨24760430, 44617831⟩, ⟨7916893, 11015889⟩, ⟨583469, 640183⟩, ⟨(-10232), (-7257)⟩, ⟨(-292), (-245)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-691067453), (-671210051)⟩, ⟨7916893, 11015889⟩, ⟨583469, 640183⟩, ⟨(-10232), (-7257)⟩, ⟨(-292), (-245)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-876105057), (-478648525)⟩, ⟨(-213380627), (-145584045)⟩, ⟨(-11391184), (-8992830)⟩, ⟨282544, 415935⟩, ⟨7943, 10783⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3418862239, 3816318771⟩, ⟨(-213380627), (-145584045)⟩, ⟨(-11391184), (-8992830)⟩, ⟨282544, 415935⟩, ⟨7943, 10783⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1059520064, 1502153633⟩, ⟨127691000, 162011260⟩, ⟨(-8847875), (-6056687)⟩, ⟨(-306472), (-225884)⟩, ⟨7033, 10358⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4833648649, 5395579812⟩, ⟨184392909, 336753027⟩, ⟨18424257, 38995025⟩, ⟨549293, 3156339⟩, ⟨12420, 300456⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1192406687, 1887089996⟩, ⟨189193854, 321306165⟩, ⟨(-1088073), 19524808⟩, ⟨(-395475), 2060620⟩, ⟨(-77054), 201480⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1539316279), (-1154487209)⟩, ⟨(-192414535), (-192414534)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2755651017, 3140480087⟩, ⟨(-192414535), (-192414534)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨331046457, 829135220⟩, ⟨105051330, 282346108⟩, ⟨7377873, 41194213⟩, ⟨(-510320), 4732060⟩, ⟨(-131831), 574120⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4626013753, 5124102516⟩, ⟨105051330, 282346108⟩, ⟨7377873, 41194213⟩, ⟨(-510320), 4732060⟩, ⟨(-131831), 574120⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4457418286, 4691252789⟩, ⟨48088649, 136027991⟩, ⟨1405179, 19587043⟩, ⟨(-843603), 2264641⟩, ⟨(-175660), 302123⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2859879572, 3430244040⟩, ⟨(-179314449), (-100228670)⟩, ⟨(-5192493), 12167675⟩, ⟨(-1494343), 1592954⟩, ⟨(-229899), 258707⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6513748216, 8684997626⟩, ⟨1085624697, 1085624704⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9878751780, 17562225406⟩, ⟨3292917242, 4390556356⟩, ⟨274409768, 274409773⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9878751780, 17562225406⟩, ⟨3292917242, 4390556356⟩, ⟨274409768, 274409773⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17562225406), (-9878751780)⟩, ⟨(-4390556356), (-3292917242)⟩, ⟨(-274409773), (-274409768)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8781112703), (-4939375890)⟩, ⟨(-2195278178), (-1646458621)⟩, ⟨(-137204887), (-137204884)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨555954852, 1359892804⟩, ⟨(-695079332), (-213123080)⟩, ⟨(-2592517), 159877009⟩, ⟨(-22700325), 15244809⟩, ⟨(-4501689), 2942103⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨370192323, 1086100048⟩, ⟨(-611911567), (-154885686)⟩, ⟨1258878, 160560399⟩, ⟨(-27247138), 13628449⟩, ⟨(-4755692), 4074181⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1346901744, 1346901745⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4553034878, 4553034886⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified906
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1154487209, 1539316279⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4457418286, 4691252789⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified907
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (15088951 / 1073741824)

theorem envelope_integral : (∫ s in ((168 / 625) : ℝ)..(224 / 625),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((168 / 625) : ℝ)..(224 / 625), prawitzNormalCorrection
