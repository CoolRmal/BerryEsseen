...
namespace FiniteNormalPanel173_4

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (193319 / 800000)
def radius : Rat := (27617 / 800000)

def j0 : Jet := ⟨⟨1037873478, 1037873479⟩, ⟨148267639, 148267640⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3260575693, 3260575698⟩, ⟨465796525, 465796529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2475304959, 2475304968⟩, ⟨707229984, 707229992⟩, ⟨50516427, 50516429⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨619, 621⟩, ⟨177, 178⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94068), (-94065)⟩, ⟨177, 178⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-54214), (-54212)⟩, ⟨(-15388), (-15386)⟩, ⟨(-1072), (-1068)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5058842, 5058845⟩, ⟨(-15388), (-15386)⟩, ⟨(-1072), (-1068)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2915546, 2915549⟩, ⟨824144, 824147⟩, ⟨56348, 56353⟩, ⟨(-357), (-351)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140250031), (-140250027)⟩, ⟨824144, 824147⟩, ⟨56348, 56353⟩, ⟨(-357), (-351)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-80829859), (-80829855)⟩, ⟨(-22619270), (-22619265)⟩, ⟨(-1481408), (-1481401)⟩, ⟨18765, 18772⟩, ⟨595, 601⟩⟩
...
def j19 : Jet := ⟨⟨1350825906, 1350825911⟩, ⟨(-22619270), (-22619265)⟩, ⟨(-1481408), (-1481401)⟩, ⟨18765, 18772⟩, ⟨595, 601⟩⟩
...
def j25 : Jet := ⟨⟨6784, 6787⟩, ⟨1927, 1930⟩, ⟨133, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845393), (-845389)⟩, ⟨1927, 1930⟩, ⟨133, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-487223), (-487220)⟩, ⟨(-138097), (-138092)⟩, ⟨(-9551), (-9546)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35304171, 35304175⟩, ⟨(-138097), (-138092)⟩, ⟨(-9551), (-9546)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20346741, 20346744⟩, ⟨5733764, 5733770⟩, ⟨386994, 387001⟩, ⟨(-3175), (-3168)⟩, ⟨(-108), (-102)⟩⟩
...
def j33 : Jet := ⟨⟨(-695481142), (-695481138)⟩, ⟨5733764, 5733770⟩, ⟨386994, 387001⟩, ⟨(-3175), (-3168)⟩, ⟨(-108), (-102)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-400824456), (-400824451)⟩, ⟨(-111216752), (-111216745)⟩, ⟨(-7012908), (-7012899)⟩, ⟨129333, 129341⟩, ⟨3965, 3973⟩⟩
...
def j36 : Jet := ⟨⟨3894142840, 3894142845⟩, ⟨(-111216752), (-111216745)⟩, ⟨(-7012908), (-7012899)⟩, ⟨129333, 129341⟩, ⟨3965, 3973⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1025495611, 1025495618⟩, ⟨129327683, 129327690⟩, ⟨(-3577728), (-3577720)⟩, ⟨(-146417), (-146409)⟩, ⟨2486, 2493⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4737048641, 4737048648⟩, ⟨135290138, 135290150⟩, ⟨12394760, 12394775⟩, ⟨440297, 440311⟩, ⟨25568, 25583⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1131049960, 1131049970⟩, ⟨174942185, 174942198⟩, ⟨3087254, 3087269⟩, ⟨204166, 204182⟩, ⟨7164, 7183⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1037873479), (-1037873478)⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3257093817, 3257093818⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨297854191, 297854197⟩, ⟨92139630, 92139640⟩, ⟨8751741, 8751751⟩, ⟨359028, 359042⟩, ⟨22623, 22638⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4592821487, 4592821493⟩, ⟨92139630, 92139640⟩, ⟨8751741, 8751751⟩, ⟨359028, 359042⟩, ⟨22623, 22638⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4441398212, 4441398216⟩, ⟨44550913, 44550919⟩, ⟨4008158, 4008164⟩, ⟨133390, 133398⟩, ⟨7791, 7801⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3368139885, 3368139890⟩, ⟨(-119537379), (-119537371)⟩, ⟨1501637, 1501644⟩, ⟨(-37211), (-37203)⟩, ⟨1302, 1312⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨38544406993, 38544407000⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value691

def j47 : Jet := ⟨⟨9314207766, 9314207777⟩, ⟨1330601103, 1330601113⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20199098230, 20199098279⟩, ⟨5771170894, 5771170946⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20199098230, 20199098279⟩, ⟨5771170894, 5771170946⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20199098279), (-20199098230)⟩, ⟨(-5771170946), (-5771170894)⟩, ⟨(-412226497), (-412226490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10099549140), (-10099549115)⟩, ⟨(-2885585473), (-2885585447)⟩, ⟨(-206113249), (-206113245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨408999808, 408999816⟩, ⟨(-274787641), (-274787632)⟩, ⟨72680719, 72680725⟩, ⟨(-7485638), (-7485635)⟩, ⟨(-486645), (-486643)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨320740175, 320740183⟩, ⟨(-226873435), (-226873425)⟩, ⟨64787544, 64787553⟩, ⟨(-7992750), (-7992743)⟩, ⟨(-145378), (-145369)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨889605838, 1186141119⟩, ⟨148267639, 148267640⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2794779165, 3726372226⟩, ⟨465796525, 465796529⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1818591398, 3233051386⟩, ⟨606197128, 808262848⟩, ⟨50516427, 50516429⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨455, 810⟩, ⟨151, 203⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94232), (-93876)⟩, ⟨151, 203⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-70934), (-39749)⟩, ⟨(-17671), (-13096)⟩, ⟨(-1083), (-1055)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5042122, 5073308⟩, ⟨(-17671), (-13096)⟩, ⟨(-1083), (-1055)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2134954, 3818951⟩, ⟨698349, 949193⟩, ⟨55162, 57378⟩, ⟨(-412), (-297)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141030623), (-139346625)⟩, ⟨698349, 949193⟩, ⟨55162, 57378⟩, ⟨(-412), (-297)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-106161286), (-59002678)⟩, ⟨(-26244625), (-18953050)⟩, ⟨(-1536850), (-1417143)⟩, ⟨15687, 21838⟩, ⟨560, 631⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1325494479, 1372653088⟩, ⟨(-26244625), (-18953050)⟩, ⟨(-1536850), (-1417143)⟩, ⟨15687, 21838⟩, ⟨560, 631⟩⟩
...
def j72 : Jet := ⟨⟨4976, 8876⟩, ⟨1642, 2213⟩, ⟨132, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847201), (-843300)⟩, ⟨1642, 2213⟩, ⟨132, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-637734), (-357073)⟩, ⟨(-158739), (-117358)⟩, ⟨(-9679), (-9397)⟩, ⟨35, 53⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35153660, 35434322⟩, ⟨(-158739), (-117358)⟩, ⟨(-9679), (-9397)⟩, ⟨35, 53⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14884896, 26673308⟩, ⟨4842140, 6618635⟩, ⟨376310, 396229⟩, ⟨(-3676), (-2666)⟩, ⟨(-111), (-98)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-700942987), (-689154574)⟩, ⟨4842140, 6618635⟩, ⟨376310, 396229⟩, ⟨(-3676), (-2666)⟩, ⟨(-111), (-98)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-527637242), (-291804452)⟩, ⟨(-129859034), (-92285949)⟩, ⟨(-7401570), (-6561865)⟩, ⟨107296, 151285⟩, ⟨3650, 4244⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3767330054, 4003162844⟩, ⟨(-129859034), (-92285949)⟩, ⟨(-7401570), (-6561865)⟩, ⟨107296, 151285⟩, ⟨3650, 4244⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨862512819, 1190932548⟩, ⟨120981940, 136533626⟩, ⟨(-4179668), (-2977639)⟩, ⟨(-156468), (-134744)⟩, ⟨2065, 2917⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4608042388, 4896503309⟩, ⟨106230393, 168781388⟩, ⟨10002321, 15437884⟩, ⟨219668, 732502⟩, ⟨9887, 48093⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨925384375, 1357729818⟩, ⟨151133859, 202456630⟩, ⟨235933, 6451442⟩, ⟨(-16773), 475659⟩, ⟨(-10786), 29682⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1186141119), (-889605838)⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3108826177, 3405361458⟩, ⟨(-148267640), (-148267639)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨199381318, 429207054⟩, ⟨65125948, 128001630⟩, ⟨5419853, 13622297⟩, ⟨5998, 908950⟩, ⟨(-8390), 73303⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4494348614, 4724174350⟩, ⟨65125948, 128001630⟩, ⟨5419853, 13622297⟩, ⟨5998, 908950⟩, ⟨(-8390), 73303⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4393527092, 4504461604⟩, ⟨31048529, 62565088⟩, ⟨2149391, 6548647⟩, ⟨(-90324), 429091⟩, ⟨(-15093), 36591⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3180166714, 3571463734⟩, ⟨(-133025790), (-102063908)⟩, ⟨(-604033), 4120409⟩, ⟨(-297684), 266016⟩, ⟨(-26780), 32131⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7983606654, 10644808889⟩, ⟨1330601103, 1330601113⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14840153792, 26382495716⟩, ⟨4946717908, 6595623940⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14840153792, 26382495716⟩, ⟨4946717908, 6595623940⟩, ⟨412226490, 412226497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-26382495716), (-14840153792)⟩, ⟨(-6595623940), (-4946717908)⟩, ⟨(-412226497), (-412226490)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13191247858), (-7420076896)⟩, ⟨(-3297811970), (-2473358954)⟩, ⟨(-206113249), (-206113245)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨199112995, 763244135⟩, ⟨(-586043030), (-114663948)⟩, ⟨(-3611711), 215435875⟩, ⟨(-51471055), 19673663⟩, ⟨(-8945844), 9966939⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨147431278, 634672761⟩, ⟨(-510961419), (-89633445)⟩, ⟨(-385818), 198028315⟩, ⟨(-50088271), 16601117⟩, ⟨(-8119582), 10135168⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1037873478, 1037873479⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4441398212, 4441398216⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar691 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3496
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar691 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨889605838, 1186141119⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4393527092, 4504461604⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3497
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((82851 / 400000) : ℝ)..(27617 / 100000), prawitzNormalCorrection
      ((41177 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
