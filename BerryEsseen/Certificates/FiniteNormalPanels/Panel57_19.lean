...
namespace FiniteNormalPanel57_19
...
def j2 : Jet := ⟨⟨1685347874, 1685347878⟩, ⟨561782623, 561782627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨661331568, 661331572⟩, ⟨440887710, 440887716⟩, ⟨73481284, 73481286⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨165, 166⟩, ⟨110, 111⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94522), (-94520)⟩, ⟨110, 111⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-14555), (-14554)⟩, ⟨(-9687), (-9684)⟩, ⟨(-1605), (-1602)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098501, 5098503⟩, ⟨(-9687), (-9684)⟩, ⟨(-1605), (-1602)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨785058, 785059⟩, ⟨521880, 521882⟩, ⟨85985, 85989⟩, ⟨(-331), (-328)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-142380519), (-142380517)⟩, ⟨521880, 521882⟩, ⟨85985, 85989⟩, ⟨(-331), (-328)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-21923504), (-21923503)⟩, ⟨(-14535312), (-14535309)⟩, ⟨(-2369134), (-2369130)⟩, ⟨17703, 17706⟩, ⟨1432, 1436⟩⟩
...
def j19 : Jet := ⟨⟨1409732261, 1409732263⟩, ⟨(-14535312), (-14535309)⟩, ⟨(-2369134), (-2369130)⟩, ⟨17703, 17706⟩, ⟨1432, 1436⟩⟩
...
def j25 : Jet := ⟨⟨1819, 1821⟩, ⟨1211, 1213⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850358), (-850355)⟩, ⟨1211, 1213⟩, ⟨199, 202⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-130937), (-130936)⟩, ⟨(-87106), (-87103)⟩, ⟨(-14395), (-14391)⟩, ⟨39, 42⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35660457, 35660459⟩, ⟨(-87106), (-87103)⟩, ⟨(-14395), (-14391)⟩, ⟨39, 42⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5490934, 5490936⟩, ⟨3647210, 3647213⟩, ⟨598944, 598948⟩, ⟨(-2963), (-2960)⟩, ⟨(-243), (-240)⟩⟩
...
def j33 : Jet := ⟨⟨(-710336949), (-710336946)⟩, ⟨3647210, 3647213⟩, ⟨598944, 598948⟩, ⟨(-2963), (-2960)⟩, ⟨(-243), (-240)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-109376445), (-109376443)⟩, ⟨(-72356039), (-72356036)⟩, ⟨(-11686321), (-11686317)⟩, ⟨123424, 123429⟩, ⟨9904, 9909⟩⟩
...
def j36 : Jet := ⟨⟨4185590851, 4185590853⟩, ⟨(-72356039), (-72356036)⟩, ⟨(-11686321), (-11686317)⟩, ⟨123424, 123429⟩, ⟨9904, 9909⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨553179827, 553179830⟩, ⟨178689609, 178689613⟩, ⟨(-2830872), (-2830869)⟩, ⟨(-302938), (-302934)⟩, ⟨2876, 2880⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4407201927, 4407201930⟩, ⟨76187011, 76187016⟩, ⟨13622100, 13622109⟩, ⟨318235, 318244⟩, ⟨30852, 30862⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨567635334, 567635339⟩, ⟨193171739, 193171746⟩, ⟨2019356, 2019363⟩, ⟨246655, 246664⟩, ⟨5810, 5821⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-536462891), (-536462890)⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3758504405, 3758504406⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨75020331, 75020334⟩, ⟨51060274, 51060278⟩, ⟨9221916, 9221921⟩, ⟨246842, 246848⟩, ⟨24669, 24680⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4369987627, 4369987630⟩, ⟨51060274, 51060278⟩, ⟨9221916, 9221921⟩, ⟨246842, 246848⟩, ⟨24669, 24680⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4332315078, 4332315081⟩, ⟨25310048, 25310051⟩, ⟨4497275, 4497279⟩, ⟨96082, 96087⟩, ⟨9331, 9339⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3791187262, 3791187266⟩, ⟨(-158227244), (-158227237)⟩, ⟨2881758, 2881764⟩, ⟨(-103165), (-103158)⟩, ⟨4164, 4173⟩⟩
...
def j47 : Jet := ⟨⟨3587424167, 3587424175⟩, ⟨1195808053, 1195808061⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2996440081, 2996440095⟩, ⟨1997626716, 1997626736⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2996440081, 2996440095⟩, ⟨1997626716, 1997626736⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2996440095), (-2996440081)⟩, ⟨(-1997626736), (-1997626716)⟩, ⟨(-332937790), (-332937785)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1498220048), (-1498220040)⟩, ⟨(-998813368), (-998813358)⟩, ⟨(-166468895), (-166468892)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3030150845, 3030150855⟩, ⟨(-704674791), (-704674781)⟩, ⟨(-35508204), (-35508198)⟩, ⟨20960883, 20960885⟩, ⟨(-530505), (-530503)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2674727999, 2674728012⟩, ⟨(-733650876), (-733650858)⟩, ⟨(-3349816), (-3349802)⟩, ⟨19264798, 19264810⟩, ⟨(-1244446), (-1244431)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨357641926, 715283854⟩, ⟨178820963, 178820964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1123565247, 2247130502⟩, ⟨561782623, 561782627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨293925140, 1175700569⟩, ⟨293925138, 587850286⟩, ⟨73481284, 73481286⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨73, 295⟩, ⟨73, 148⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94614), (-94391)⟩, ⟨73, 148⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-25900), (-6459)⟩, ⟨(-12946), (-6418)⟩, ⟨(-1614), (-1587)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5087156, 5106598⟩, ⟨(-12946), (-6418)⟩, ⟨(-1614), (-1587)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨348138, 1397876⟩, ⟨344594, 698499⟩, ⟨84820, 86821⟩, ⟨(-443), (-215)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142817439), (-141767700)⟩, ⟨344594, 698499⟩, ⟨84820, 86821⟩, ⟨(-443), (-215)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-39094721), (-9701841)⟩, ⟨(-19523779), (-9510634)⟩, ⟨(-2414035), (-2306089)⟩, ⟨11577, 23821⟩, ⟨1382, 1471⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1392561044, 1421953925⟩, ⟨(-19523779), (-9510634)⟩, ⟨(-2414035), (-2306089)⟩, ⟨11577, 23821⟩, ⟨1382, 1471⟩⟩
...
def j72 : Jet := ⟨⟨807, 3239⟩, ⟨802, 1620⟩, ⟨197, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851370), (-848937)⟩, ⟨802, 1620⟩, ⟨197, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-233054), (-58096)⟩, ⟨(-116473), (-57652)⟩, ⟨(-14499), (-14246)⟩, ⟨25, 56⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35558340, 35733299⟩, ⟨(-116473), (-57652)⟩, ⟨(-14499), (-14246)⟩, ⟨25, 56⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2433427, 9781602⟩, ⟨2401543, 4886856⟩, ⟨588445, 606432⟩, ⟨(-3977), (-1944)⟩, ⟨(-248), (-233)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713394456), (-706046280)⟩, ⟨2401543, 4886856⟩, ⟨588445, 606432⟩, ⟨(-3977), (-1944)⟩, ⟨(-248), (-233)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-195283971), (-48318121)⟩, ⟨(-97477637), (-46980397)⟩, ⟨(-12000630), (-11244663)⟩, ⟨80268, 166478⟩, ⟨9454, 10228⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4099683325, 4246649175⟩, ⟨(-97477637), (-46980397)⟩, ⟨(-12000630), (-11244663)⟩, ⟨80268, 166478⟩, ⟨9454, 10228⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨364294553, 743967490⟩, ⟨171932418, 183503888⟩, ⟨(-3816741), (-1847265)⟩, ⟨(-312729), (-289172)⟩, ⟨1875, 3886⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4343835177, 4499553408⟩, ⟨48055559, 106985297⟩, ⟨12033635, 15714910⟩, ⟨83979, 601774⟩, ⟨17759, 49353⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨368439474, 779405576⟩, ⟨177964675, 210776723⟩, ⟨(-1054150), 5424812⟩, ⟨66144, 462534⟩, ⟨(-14993), 29922⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-715283854), (-357641926)⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3579683442, 3937325370⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨31606211, 141438342⟩, ⟨30533042, 76499094⟩, ⟨6991484, 12312803⟩, ⟨(-92118), 700322⟩, ⟨(-1294), 63110⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4326573507, 4436405638⟩, ⟨30533042, 76499094⟩, ⟨6991484, 12312803⟩, ⟨(-92118), 700322⟩, ⟨(-1294), 63110⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310741434, 4365113645⟩, ⟨15021191, 38109582⟩, ⟨3273208, 6107703⟩, ⟨(-99888), 337475⟩, ⟨(-7956), 31081⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3592830555, 4001630633⟩, ⟨(-169221947), (-144541521)⟩, ⟨1141394, 4973708⟩, ⟨(-345866), 173094⟩, ⟨(-21345), 32652⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2391616107, 4783232229⟩, ⟨1195808053, 1195808061⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1331751142, 5327004604⟩, ⟨1331751140, 2663502310⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1331751142, 5327004604⟩, ⟨1331751140, 2663502310⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5327004604), (-1331751142)⟩, ⟨(-2663502310), (-1331751140)⟩, ⟨(-332937790), (-332937785)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2663502302), (-665875571)⟩, ⟨(-1331751155), (-665875570)⟩, ⟨(-166468895), (-166468892)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2310118874, 3678141890⟩, ⟨(-1140490573), (-358152138)⟩, ⟨(-114798043), 87279336⟩, ⟨233452, 41334800⟩, ⟨(-4895629), 2215684⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1932463067, 3426933024⟩, ⟨(-1207516610), (-377345838)⟩, ⟨(-94290535), 130513150⟩, ⟨(-4860444), 43087832⟩, ⟨(-6387047), 2277380⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4332315078, 4332315081⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1136
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310741434, 4365113645⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1137
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (111334775 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((8327 / 100000) : ℝ)..(8327 / 50000), prawitzNormalCorrection
