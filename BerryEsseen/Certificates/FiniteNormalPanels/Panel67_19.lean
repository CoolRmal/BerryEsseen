...
namespace FiniteNormalPanel67_19

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (15961 / 400000)
def radius : Rat := (15961 / 400000)

def j0 : Jet := ⟨⟨171379932, 171379933⟩, ⟨171379932, 171379933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨538405935, 538405939⟩, ⟨538405935, 538405939⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨67493168, 67493170⟩, ⟨134986336, 134986340⟩, ⟨67493168, 67493170⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1488), (-1487)⟩, ⟨(-2976), (-2974)⟩, ⟨(-1487), (-1484)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111568, 5111570⟩, ⟨(-2976), (-2974)⟩, ⟨(-1487), (-1484)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨80325, 80326⟩, ⟨160604, 160606⟩, ⟨80207, 80210⟩, ⟨(-94), (-91)⟩, ⟨(-24), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-143085252), (-143085250)⟩, ⟨160604, 160606⟩, ⟨80207, 80210⟩, ⟨(-94), (-91)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2248511), (-2248509)⟩, ⟨(-4494498), (-4494495)⟩, ⟨(-2242204), (-2242200)⟩, ⟨5041, 5044⟩, ⟨1256, 1259⟩⟩
...
def j19 : Jet := ⟨⟨1429407254, 1429407257⟩, ⟨(-4494498), (-4494495)⟩, ⟨(-2242204), (-2242200)⟩, ⟨5041, 5044⟩, ⟨1256, 1259⟩⟩
...
def j25 : Jet := ⟨⟨185, 186⟩, ⟨370, 372⟩, ⟨183, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851992), (-851990)⟩, ⟨370, 372⟩, ⟨183, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13389), (-13388)⟩, ⟨(-26773), (-26771)⟩, ⟨(-13376), (-13373)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778005, 35778007⟩, ⟨(-26773), (-26771)⟩, ⟨(-13376), (-13373)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨562232, 562233⟩, ⟨1124044, 1124046⟩, ⟨561179, 561182⟩, ⟨(-842), (-839)⟩, ⟨(-211), (-208)⟩⟩
...
def j33 : Jet := ⟨⟨(-715265651), (-715265649)⟩, ⟨1124044, 1124046⟩, ⟨561179, 561182⟩, ⟨(-842), (-839)⟩, ⟨(-211), (-208)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11240027), (-11240026)⟩, ⟨(-22462390), (-22462388)⟩, ⟨(-11195882), (-11195879)⟩, ⟨35286, 35289⟩, ⟨8787, 8790⟩⟩
...
def j36 : Jet := ⟨⟨4283727269, 4283727270⟩, ⟨(-22462390), (-22462388)⟩, ⟨(-11195882), (-11195879)⟩, ⟨35286, 35289⟩, ⟨8787, 8790⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨179186777, 179186780⟩, ⟨178623358, 178623362⟩, ⟨(-844496), (-844494)⟩, ⟨(-280446), (-280443)⟩, ⟨788, 791⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306236814, 4306236816⟩, ⟨22580419, 22580423⟩, ⟨11373112, 11373118⟩, ⟨83176, 83183⟩, ⟨21136, 21144⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨179656943, 179656947⟩, ⟨180034103, 180034110⟩, ⟨566872, 566878⟩, ⟨190844, 190851⟩, ⟨1418, 1427⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-171379933), (-171379932)⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4123587363, 4123587364⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7514985, 7514986⟩, ⟨15061524, 15061526⟩, ⟨7593995, 7593999⟩, ⟨63486, 63494⟩, ⟨16190, 16195⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302482281, 4302482282⟩, ⟨15061524, 15061526⟩, ⟨7593995, 7593999⟩, ⟨63486, 63494⟩, ⟨16190, 16195⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298723146, 4298723147⟩, ⟨7524182, 7524184⟩, ⟨3787094, 3787098⟩, ⟨25086, 25092⟩, ⟨6375, 6380⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4127193345, 4127193348⟩, ⟨(-164305853), (-164305848)⟩, ⟨3335745, 3335751⟩, ⟨(-127030), (-127023)⟩, ⟨5118, 5126⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨33212990394, 33212990401⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value350

def j47 : Jet := ⟨⟨1325281345, 1325281354⟩, ⟨1325281345, 1325281354⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨408936907, 408936913⟩, ⟨817873814, 817873826⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨408936907, 408936913⟩, ⟨817873814, 817873826⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-408936913), (-408936907)⟩, ⟨(-817873826), (-817873814)⟩, ⟨(-408936913), (-408936907)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-204468457), (-204468453)⟩, ⟨(-408936913), (-408936907)⟩, ⟨(-204468457), (-204468453)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4095289531, 4095289536⟩, ⟨(-389924986), (-389924979)⟩, ⟨(-176399522), (-176399516)⟩, ⟨17973825, 17973828⟩, ⟨3771047, 3771049⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3935315575, 3935315584⟩, ⟨(-531360472), (-531360458)⟩, ⟨(-151411431), (-151411416)⟩, ⟨23595987, 23596002⟩, ⟨2815548, 2815563⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 342759866⟩, ⟨171379932, 171379933⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1076811878⟩, ⟨538405935, 538405939⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 269972678⟩, ⟨0, 269972678⟩, ⟨67493168, 67493170⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5952), 0⟩, ⟨(-5952), 5⟩, ⟨(-1488), (-1479)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107104, 5113057⟩, ⟨(-5952), 5⟩, ⟨(-1488), (-1479)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 321397⟩, ⟨(-375), 321398⟩, ⟨79786, 80351⟩, ⟨(-188), 2⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142844179)⟩, ⟨(-375), 321398⟩, ⟨79786, 80351⟩, ⟨(-188), 2⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8999090), 0⟩, ⟨(-8999114), 20203⟩, ⟨(-2249797), (-2219467)⟩, ⟨(-18), 10103⟩, ⟨1239, 1264⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422656675, 1431655766⟩, ⟨(-8999114), 20203⟩, ⟨(-2249797), (-2219467)⟩, ⟨(-18), 10103⟩, ⟨1239, 1264⟩⟩
...
def j72 : Jet := ⟨⟨0, 744⟩, ⟨(-1), 744⟩, ⟨183, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851432)⟩, ⟨(-1), 744⟩, ⟨183, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-53567), 0⟩, ⟨(-53568), 47⟩, ⟨(-13393), (-13320)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35737827, 35791395⟩, ⟨(-53568), 47⟩, ⟨(-13393), (-13320)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2249773⟩, ⟨(-3368), 2249776⟩, ⟨557391, 562447⟩, ⟨(-1685), 3⟩, ⟨(-212), (-206)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713578109)⟩, ⟨(-3368), 2249776⟩, ⟨557391, 562447⟩, ⟨(-1685), 3⟩, ⟨(-212), (-206)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-44995447), 0⟩, ⟨(-44995659), 141417⟩, ⟨(-11249074), (-11036735)⟩, ⟨(-159), 70711⟩, ⟨8639, 8840⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4249971849, 4294967296⟩, ⟨(-44995659), 141417⟩, ⟨(-11249074), (-11036735)⟩, ⟨(-159), 70711⟩, ⟨8639, 8840⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 358937293⟩, ⟨176084330, 179473713⟩, ⟨(-1692164), 2533⟩, ⟨(-282034), (-275693)⟩, ⟨(-3), 1584⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4340439121⟩, ⟨(-144429), 45953463⟩, ⟨11035221, 11975052⟩, ⟨(-72999), 248581⟩, ⟨17901, 25603⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 362737447⟩, ⟨176072259, 185214249⟩, ⟨(-1716116), 2923592⟩, ⟨143193, 245541⟩, ⟨(-10792), 14147⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-342759866), 0⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3952207430, 4294967296⟩, ⟨(-171379933), (-171379932)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 30635497⟩, ⟨0, 31285056⟩, ⟨6928211, 8480931⟩, ⟨(-148012), 293628⟩, ⟨8747, 25559⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4325602793⟩, ⟨0, 31285056⟩, ⟨6928211, 8480931⟩, ⟨(-148012), 293628⟩, ⟨8747, 25559⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4310257827⟩, ⟨0, 15642528⟩, ⟨3423431, 4240466⟩, ⟨(-89451), 146814⟩, ⟨1738, 11742⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3952207430, 4310257827⟩, ⟨(-171990064), (-155737404)⟩, ⟨2526048, 4240466⟩, ⟨(-258657), 10211⟩, ⟨(-4260), 15312⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2650562707⟩, ⟨1325281345, 1325281354⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1635747651⟩, ⟨0, 1635747652⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1635747651⟩, ⟨0, 1635747652⟩, ⟨408936907, 408936913⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1635747651), 0⟩, ⟨(-1635747652), 0⟩, ⟨(-408936913), (-408936907)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-817873826), 0⟩, ⟨(-817873826), 0⟩, ⟨(-204468457), (-204468453)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3550249388, 4294967296⟩, ⟨(-817873826), 0⟩, ⟨(-204468457), (-91142766)⟩, ⟨0, 38936129⟩, ⟨315881, 4867017⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3266921734, 4310257827⟩, ⟨(-992775607), (-128733604)⟩, ⟨(-203108339), (-46877255)⟩, ⟨2238723, 47272806⟩, ⟨(-1476588), 4895309⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨171379932, 171379933⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨171379932, 171379933⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298723146, 4298723147⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar350 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1334
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar350 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 342759866⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4310257827⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1335
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(15961 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (15961 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(15961 / 200000), prawitzNormalCorrection
      ((7307 / 2500) * sqrt n) s) ≤ (upper : ℝ) :=
