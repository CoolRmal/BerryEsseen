...
namespace FiniteNormalPanel77_4

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (216811 / 800000)
def radius : Rat := (30973 / 800000)

def j0 : Jet := ⟨⟨1163995193, 1163995194⟩, ⟨166285027, 166285028⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3656798747, 3656798751⟩, ⟨522399819, 522399823⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3113452595, 3113452603⟩, ⟨889557880, 889557890⟩, ⟨63539848, 63539850⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨779, 781⟩, ⟨222, 223⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93908), (-93905)⟩, ⟨222, 223⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-68075), (-68072)⟩, ⟨(-19290), (-19287)⟩, ⟨(-1335), (-1330)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5044981, 5044985⟩, ⟨(-19290), (-19287)⟩, ⟨(-1335), (-1330)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3657142, 3657146⟩, ⟨1030913, 1030918⟩, ⟨69671, 69678⟩, ⟨(-559), (-554)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-139508435), (-139508430)⟩, ⟨1030913, 1030918⟩, ⟨69671, 69678⟩, ⟨(-559), (-554)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-101130666), (-101130661)⟩, ⟨(-28147160), (-28147154)⟩, ⟨(-1799869), (-1799860)⟩, ⟨29275, 29283⟩, ⟨900, 906⟩⟩
...
def j19 : Jet := ⟨⟨1330525099, 1330525105⟩, ⟨(-28147160), (-28147154)⟩, ⟨(-1799869), (-1799860)⟩, ⟨29275, 29283⟩, ⟨900, 906⟩⟩
...
def j22 : Jet := ⟨⟨(-79), (-77)⟩, ⟨(-23), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11756, 11759⟩, ⟨(-23), (-22)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8522, 8525⟩, ⟨2417, 2421⟩, ⟨166, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843655), (-843651)⟩, ⟨2417, 2421⟩, ⟨166, 170⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-611572), (-611568)⟩, ⟨(-172983), (-172977)⟩, ⟨(-11862), (-11854)⟩, ⟨67, 72⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35179822, 35179827⟩, ⟨(-172983), (-172977)⟩, ⟨(-11862), (-11854)⟩, ⟨67, 72⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25502105, 25502109⟩, ⟨7160918, 7160925⟩, ⟨476024, 476033⟩, ⟨(-4969), (-4961)⟩, ⟨(-163), (-157)⟩⟩
...
def j33 : Jet := ⟨⟨(-690325778), (-690325773)⟩, ⟨7160918, 7160925⟩, ⟨476024, 476033⟩, ⟨(-4969), (-4961)⟩, ⟨(-163), (-157)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-500422109), (-500422103)⟩, ⟨(-137786746), (-137786737)⟩, ⟨(-8384481), (-8384470)⟩, ⟨200927, 200938⟩, ⟨5893, 5903⟩⟩
...
def j36 : Jet := ⟨⟨3794545187, 3794545193⟩, ⟨(-137786746), (-137786737)⟩, ⟨(-8384481), (-8384470)⟩, ⟨200927, 200938⟩, ⟨5893, 5903⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1132828769, 1132828776⟩, ⟨137867771, 137867780⟩, ⟨(-4955995), (-4955984)⟩, ⟨(-193995), (-193986)⟩, ⟨4326, 4334⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4861384733, 4861384742⟩, ⟨176525592, 176525606⟩, ⟨17151730, 17151747⟩, ⟨755429, 755447⟩, ⟨48416, 48436⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1282225475, 1282225486⟩, ⟨202609585, 202609601⟩, ⟨4580747, 4580768⟩, ⟨326542, 326563⟩, ⟨14149, 14169⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1163995194), (-1163995193)⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3130972102, 3130972103⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨382797366, 382797373⟩, ⟨120974690, 120974702⟩, ⟨12292931, 12292948⟩, ⟨627152, 627170⟩, ⟨44141, 44160⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4677764662, 4677764669⟩, ⟨120974690, 120974702⟩, ⟨12292931, 12292948⟩, ⟨627152, 627170⟩, ⟨44141, 44160⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4482281365, 4482281370⟩, ⟨57959585, 57959591⟩, ⟨5514872, 5514882⟩, ⟨229158, 229170⟩, ⟨14791, 14802⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3267521482, 3267521488⟩, ⟨(-131285387), (-131285380)⟩, ⟨1776286, 1776297⟩, ⟨(-46463), (-46453)⟩, ⟨1909, 1919⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨34832209091, 34832209097⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value381

def j47 : Jet := ⟨⟨9440007606, 9440007617⟩, ⟨1348572510, 1348572519⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨20748410281, 20748410330⟩, ⟨5928117200, 5928117248⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨20748410281, 20748410330⟩, ⟨5928117200, 5928117248⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-20748410330), (-20748410281)⟩, ⟨(-5928117248), (-5928117200)⟩, ⟨(-423436947), (-423436941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-10374205165), (-10374205140)⟩, ⟨(-2964058624), (-2964058600)⟩, ⟨(-211718474), (-211718470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨383663683, 383663694⟩, ⟨(-264775400), (-264775389)⟩, ⟨72451352, 72451359⟩, ⟨(-7965478), (-7965475)⟩, ⟨(-411439), (-411437)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨291883322, 291883332⟩, ⟨(-213163148), (-213163137)⟩, ⟨63371607, 63371616⟩, ⟨(-8388266), (-8388259)⟩, ⟨(-36537), (-36527)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨997710165, 1330280221⟩, ⟨166285027, 166285028⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3134398924, 4179198570⟩, ⟨522399819, 522399823⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2287434557, 4066550333⟩, ⟨762478182, 1016637588⟩, ⟨63539848, 63539850⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨572, 1019⟩, ⟨190, 255⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94115), (-93667)⟩, ⟨190, 255⟩, ⟨15, 16⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-89110), (-49885)⟩, ⟨(-22177), (-16386)⟩, ⟨(-1353), (-1308)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5023946, 5063172⟩, ⟨(-22177), (-16386)⟩, ⟨(-1353), (-1308)⟩, ⟨4, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2675677, 4793901⟩, ⟨870894, 1189750⟩, ⟨67792, 71301⟩, ⟨(-648), (-466)⟩, ⟨(-21), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140489900), (-138371675)⟩, ⟨870894, 1189750⟩, ⟨67792, 71301⟩, ⟨(-648), (-466)⟩, ⟨(-21), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-133018301), (-73694659)⟩, ⟨(-32790752), (-23438409)⟩, ⟨(-1887699), (-1697943)⟩, ⟨24304, 34232⟩, ⟨828, 965⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1298637464, 1357961107⟩, ⟨(-32790752), (-23438409)⟩, ⟨(-1887699), (-1697943)⟩, ⟨24304, 34232⟩, ⟨828, 965⟩⟩
...
def j70 : Jet := ⟨⟨(-103), (-56)⟩, ⟨(-26), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11732, 11780⟩, ⟨(-26), (-18)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6248, 11154⟩, ⟨2057, 2780⟩, ⟨164, 172⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845929), (-841022)⟩, ⟨2057, 2780⟩, ⟨164, 172⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-800941), (-447915)⟩, ⟨(-199141), (-146672)⟩, ⟨(-12063), (-11620)⟩, ⟨57, 83⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34990453, 35343480⟩, ⟨(-199141), (-146672)⟩, ⟨(-12063), (-11620)⟩, ⟨57, 83⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18635385, 33463827⟩, ⟨6023244, 8287842⟩, ⟨459089, 490647⟩, ⟨(-5773), (-4152)⟩, ⟨(-169), (-148)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697192498), (-682364055)⟩, ⟨6023244, 8287842⟩, ⟨459089, 490647⟩, ⟨(-5773), (-4152)⟩, ⟨(-169), (-148)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-660114080), (-363416764)⟩, ⟨(-161820633), (-113291846)⟩, ⟨(-9000484), (-7668587)⟩, ⟨165143, 236539⟩, ⟨5263, 6444⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3634853216, 3931550532⟩, ⟨(-161820633), (-113291846)⟩, ⟨(-9000484), (-7668587)⟩, ⟨165143, 236539⟩, ⟨5263, 6444⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨947724997, 1321357935⟩, ⟨126047271, 148064765⟩, ⟨(-5825180), (-4089960)⟩, ⟨(-211867), (-173211)⟩, ⟨3560, 5103⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4691976848, 5074962586⟩, ⟨135204345, 225933102⟩, ⟨13047874, 22624783⟩, ⟨334373, 1353513⟩, ⟨13172, 103347⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1035328894, 1561325529⟩, ⟨167532687, 244463245⟩, ⟨(-36005), 10281377⟩, ⟨(-100067), 878409⟩, ⟨(-25224), 66610⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1330280221), (-997710165)⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2964687075, 3297257131⟩, ⟨(-166285028), (-166285027)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨249572544, 567579970⟩, ⟨80769616, 177736724⟩, ⟨6508726, 21389554⟩, ⟨(-76854), 1809050⟩, ⟨(-29819), 173038⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4544539840, 4862547266⟩, ⟨80769616, 177736724⟩, ⟨6508726, 21389554⟩, ⟨(-76854), 1809050⟩, ⟨(-29819), 173038⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4417991623, 4569954211⟩, ⟨37954741, 86393715⟩, ⟨2241914, 10233935⟩, ⟨(-237482), 860079⟩, ⟨(-43168), 88186⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3049607077, 3508365274⟩, ⟨(-150732472), (-104723396)⟩, ⟨(-1797316), 6387153⟩, ⟨(-578536), 573487⟩, ⟨(-66441), 76896⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8091435087, 10788580127⟩, ⟨1348572510, 1348572519⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨15243729987, 27099964479⟩, ⟨5081243312, 6774991136⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨15243729987, 27099964479⟩, ⟨5081243312, 6774991136⟩, ⟨423436941, 423436947⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-27099964479), (-15243729987)⟩, ⟨(-6774991136), (-5081243312)⟩, ⟨(-423436947), (-423436941)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-13549982240), (-7621864993)⟩, ⟨(-3387495568), (-2540621656)⟩, ⟨(-211718474), (-211718470)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨183157809, 728214389⟩, ⟨(-574351991), (-108344176)⟩, ⟨(-3852337), 217470695⟩, ⟨(-53613454), 19887745⟩, ⟨(-9281490), 10666354⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨130049733, 594845525⟩, ⟨(-494719049), (-81394816)⟩, ⟨(-809802), 198881922⟩, ⟨(-52378807), 16718188⟩, ⟨(-8458559), 11008248⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1163995193, 1163995194⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨166285027, 166285028⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4482281365, 4482281370⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar381 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1542
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar381 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨997710165, 1330280221⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4417991623, 4569954211⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1543
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((92919 / 400000) : ℝ)..(30973 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (92919 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (30973 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((92919 / 400000) : ℝ)..(30973 / 100000), prawitzNormalCorrection
      ((71683 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
