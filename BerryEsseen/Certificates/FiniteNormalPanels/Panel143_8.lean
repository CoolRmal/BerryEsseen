...
namespace FiniteNormalPanel143_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (26159 / 160000)
def radius : Rat := (26159 / 800000)

def j0 : Jet := ⟨⟨702200309, 702200310⟩, ⟨140440061, 140440062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2206027332, 2206027336⟩, ⟨441205463, 441205468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1133083503, 1133083508⟩, ⟨453233396, 453233404⟩, ⟨45323339, 45323341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨283, 284⟩, ⟨113, 114⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94404), (-94402)⟩, ⟨113, 114⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-24906), (-24904)⟩, ⟨(-9934), (-9930)⟩, ⟨(-984), (-979)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5088150, 5088153⟩, ⟨(-9934), (-9930)⟩, ⟨(-984), (-979)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1342338, 1342340⟩, ⟨534314, 534317⟩, ⟨52384, 52389⟩, ⟨(-209), (-205)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-141823239), (-141823236)⟩, ⟨534314, 534317⟩, ⟨52384, 52389⟩, ⟨(-209), (-205)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-37415320), (-37415318)⟩, ⟨(-14825168), (-14825165)⟩, ⟨(-1426410), (-1426405)⟩, ⟨11109, 11114⟩, ⟨526, 530⟩⟩
...
def j19 : Jet := ⟨⟨1394240445, 1394240448⟩, ⟨(-14825168), (-14825165)⟩, ⟨(-1426410), (-1426405)⟩, ⟨11109, 11114⟩, ⟨526, 530⟩⟩
...
def j25 : Jet := ⟨⟨3114, 3116⟩, ⟨1241, 1245⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849063), (-849060)⟩, ⟨1241, 1245⟩, ⟨121, 124⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-223997), (-223996)⟩, ⟨(-89272), (-89269)⟩, ⟨(-8799), (-8794)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35567397, 35567399⟩, ⟨(-89272), (-89269)⟩, ⟨(-8799), (-8794)⟩, ⟨24, 28⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨9383268, 9383269⟩, ⟨3729755, 3729758⟩, ⟨363587, 363591⟩, ⟨(-1866), (-1862)⟩, ⟨(-92), (-88)⟩⟩
...
def j33 : Jet := ⟨⟨(-706444615), (-706444613)⟩, ⟨3729755, 3729758⟩, ⟨363587, 363591⟩, ⟨(-1866), (-1862)⟩, ⟨(-92), (-88)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-186371790), (-186371788)⟩, ⟨(-73564746), (-73564742)⟩, ⟨(-6965364), (-6965360)⟩, ⟨77233, 77237⟩, ⟨3614, 3618⟩⟩
...
def j36 : Jet := ⟨⟨4108595506, 4108595508⟩, ⟨(-73564746), (-73564742)⟩, ⟨(-6965364), (-6965360)⟩, ⟨77233, 77237⟩, ⟨3614, 3618⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨716124784, 716124788⟩, ⟨135610292, 135610298⟩, ⟨(-2255582), (-2255577)⟩, ⟨(-140825), (-140820)⟩, ⟨1411, 1415⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4489793175, 4489793178⟩, ⟨80390117, 80390123⟩, ⟨9051000, 9051007⟩, ⟨213940, 213948⟩, ⟨13707, 13718⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨748609231, 748609237⟩, ⟨155165679, 155165688⟩, ⟨1689482, 1689491⟩, ⟨132016, 132027⟩, ⟨3124, 3136⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-702200310), (-702200309)⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3592766986, 3592766987⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨130481966, 130481970⟩, ⟨54090496, 54090502⟩, ⟨6194670, 6194676⟩, ⟨168092, 168100⟩, ⟨11290, 11299⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4425449262, 4425449266⟩, ⟨54090496, 54090502⟩, ⟨6194670, 6194676⟩, ⟨168092, 168100⟩, ⟨11290, 11299⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4359720157, 4359720160⟩, ⟨26643557, 26643561⟩, ⟨2969918, 2969922⟩, ⟨64647, 64653⟩, ⟨4153, 4160⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3646933158, 3646933163⟩, ⟨(-120269899), (-120269892)⟩, ⟨1613142, 1613148⟩, ⟨(-43036), (-43029)⟩, ⟨1359, 1367⟩⟩
...
def j47 : Jet := ⟨⟨7644443251, 7644443264⟩, ⟨1528888641, 1528888653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13606043676, 13606043723⟩, ⟨5442417436, 5442417490⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13606043676, 13606043723⟩, ⟨5442417436, 5442417490⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13606043723), (-13606043676)⟩, ⟨(-5442417490), (-5442417436)⟩, ⟨(-544241750), (-544241740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6803021862), (-6803021838)⟩, ⟨(-2721208745), (-2721208718)⟩, ⟨(-272120875), (-272120870)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨881167079, 881167095⟩, ⟨(-558290539), (-558290522)⟩, ⟨121032017, 121032028⟩, ⟨(-1979714), (-1979709)⟩, ⟨(-3520603), (-3520600)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨748214646, 748214662⟩, ⟨(-498729330), (-498729311)⟩, ⟨118734934, 118734948⟩, ⟨(-5288732), (-5288721)⟩, ⟨(-2882642), (-2882632)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨561760247, 842640372⟩, ⟨140440061, 140440062⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1764821864, 2647232803⟩, ⟨441205463, 441205468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨725173440, 1631640251⟩, ⟨362586716, 543880086⟩, ⟨45323339, 45323341⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨181, 409⟩, ⟨90, 137⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94506), (-94277)⟩, ⟨90, 137⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-35903), (-15917)⟩, ⟨(-11953), (-7905)⟩, ⟨(-990), (-971)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5077153, 5097140⟩, ⟨(-11953), (-7905)⟩, ⟨(-990), (-971)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨857239, 1936383⟩, ⟨424078, 644127⟩, ⟨51686, 52959⟩, ⟨(-253), (-162)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142308338), (-141229193)⟩, ⟨424078, 644127⟩, ⟨51686, 52959⟩, ⟨(-253), (-162)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-54062348), (-23845503)⟩, ⟨(-17949181), (-11678049)⟩, ⟨(-1457205), (-1388656)⟩, ⟨8741, 13478⟩, ⟨507, 545⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1377593417, 1407810263⟩, ⟨(-17949181), (-11678049)⟩, ⟨(-1457205), (-1388656)⟩, ⟨8741, 13478⟩, ⟨507, 545⟩⟩
...
def j72 : Jet := ⟨⟨1991, 4490⟩, ⟨989, 1496⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850186), (-847686)⟩, ⟨989, 1496⟩, ⟨121, 125⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-322983), (-143125)⟩, ⟨(-107495), (-70993)⟩, ⟨(-8869), (-8707)⟩, ⟨19, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35468411, 35648270⟩, ⟨(-107495), (-70993)⟩, ⟨(-8869), (-8707)⟩, ⟨19, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨5988578, 13542630⟩, ⟨2953452, 4502224⟩, ⟨357303, 368722⟩, ⟨(-2256), (-1471)⟩, ⟨(-94), (-85)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709839305), (-702285252)⟩, ⟨2953452, 4502224⟩, ⟨357303, 368722⟩, ⟨(-2256), (-1471)⟩, ⟨(-94), (-85)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-269665007), (-118575667)⟩, ⟨(-89389668), (-57577455)⟩, ⟨(-7181034), (-6700777)⟩, ⟨60471, 93955⟩, ⟨3448, 3753⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4025302289, 4176391629⟩, ⟨(-89389668), (-57577455)⟩, ⟨(-7181034), (-6700777)⟩, ⟨60471, 93955⟩, ⟨3448, 3753⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨566059486, 867713595⟩, ⟨130451768, 139820369⟩, ⟨(-2742010), (-1770246)⟩, ⟨(-146103), (-134343)⟩, ⟨1105, 1721⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4416909550, 4582697833⟩, ⟨60893333, 101767722⟩, ⟨7926173, 10435365⟩, ⟨103875, 346937⟩, ⟨7738, 21625⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨582130986, 925843886⟩, ⟨142181037, 169747449⟩, ⟨(-31545), 3600749⟩, ⟨33570, 246555⟩, ⟨(-4815), 12331⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-842640372), (-561760247)⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3452326924, 3733207049⟩, ⟨(-140440062), (-140440061)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨78900830, 199579378⟩, ⟨38541846, 73183160⟩, ⟨4693175, 8261218⟩, ⟨6606, 390920⟩, ⟨119, 27827⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4373868126, 4494546674⟩, ⟨38541846, 73183160⟩, ⟨4693175, 8261218⟩, ⟨6606, 390920⟩, ⟨119, 27827⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4334238175, 4393623901⟩, ⟨18838204, 36260038⟩, ⟨2144270, 4052245⟩, ⟨(-30628), 184370⟩, ⟨(-3379), 13514⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3483893151, 3818959864⟩, ⟨(-128523721), (-110206762)⟩, ⟨537922, 2906247⟩, ⟨(-159127), 90142⟩, ⟨(-8967), 12749⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6115554599, 9173331917⟩, ⟨1528888641, 1528888653⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8707867947, 19592702962⟩, ⟨4353933948, 6530900988⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8707867947, 19592702962⟩, ⟨4353933948, 6530900988⟩, ⟨544241740, 544241750⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-19592702962), (-8707867947)⟩, ⟨(-6530900988), (-4353933948)⟩, ⟨(-544241750), (-544241740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9796351481), (-4353933973)⟩, ⟨(-3265450494), (-2176966974)⟩, ⟨(-272120875), (-272120870)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨438916147, 1558485781⟩, ⟨(-1184911971), (-222471066)⟩, ⟨(-42361309), 422633591⟩, ⟨(-97712117), 60784889⟩, ⟨(-24942268), 19914522⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨356029942, 1385760179⟩, ⟨(-1100225759), (-191721354)⟩, ⟨(-31902974), 412305670⟩, ⟨(-100389297), 55320632⟩, ⟨(-24053670), 20965886⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨702200309, 702200310⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4359720157, 4359720160⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2876
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨561760247, 842640372⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4334238175, 4393623901⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2877
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (51793915 / 4294967296)

theorem envelope_integral : (∫ s in ((26159 / 200000) : ℝ)..(78477 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((26159 / 200000) : ℝ)..(78477 / 400000), prawitzNormalCorrection
