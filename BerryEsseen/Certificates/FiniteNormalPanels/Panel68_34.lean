...
namespace FiniteNormalPanel68_34
...
def j2 : Jet := ⟨⟨2961603710, 2961603714⟩, ⟨269236698, 269236703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2042180051, 2042180058⟩, ⟨371305458, 371305468⟩, ⟨16877520, 16877522⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨511, 512⟩, ⟨92, 94⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94176), (-94174)⟩, ⟨92, 94⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-44780), (-44778)⟩, ⟨(-8099), (-8096)⟩, ⟨(-363), (-358)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5068276, 5068279⟩, ⟨(-8099), (-8096)⟩, ⟨(-363), (-358)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2409874, 2409876⟩, ⟨434307, 434311⟩, ⟨19042, 19048⟩, ⟨(-64), (-60)⟩, ⟨(-2), 1⟩⟩
...
def j16 : Jet := ⟨⟨(-140755703), (-140755700)⟩, ⟨434307, 434311⟩, ⟨19042, 19048⟩, ⟨(-64), (-60)⟩, ⟨(-2), 1⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-66926817), (-66926815)⟩, ⟨(-11962008), (-11962003)⟩, ⟨(-506515), (-506510)⟩, ⟨3321, 3326⟩, ⟨67, 71⟩⟩
...
def j19 : Jet := ⟨⟨1364728948, 1364728951⟩, ⟨(-11962008), (-11962003)⟩, ⟨(-506515), (-506510)⟩, ⟨3321, 3326⟩, ⟨67, 71⟩⟩
...
def j22 : Jet := ⟨⟨(-52), (-50)⟩, ⟨(-10), (-9)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11783, 11786⟩, ⟨(-10), (-9)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5602, 5605⟩, ⟨1013, 1015⟩, ⟨44, 47⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846575), (-846571)⟩, ⟨1013, 1015⟩, ⟨44, 47⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-402532), (-402529)⟩, ⟨(-72707), (-72704)⟩, ⟨(-3220), (-3215)⟩, ⟨5, 9⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35388862, 35388866⟩, ⟨(-72707), (-72704)⟩, ⟨(-3220), (-3215)⟩, ⟨5, 9⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16826770, 16826773⟩, ⟨3024841, 3024845⟩, ⟨131246, 131252⟩, ⟨(-563), (-557)⟩, ⟨(-14), (-10)⟩⟩
...
def j33 : Jet := ⟨⟨(-699001113), (-699001109)⟩, ⟨3024841, 3024845⟩, ⟨131246, 131252⟩, ⟨(-563), (-557)⟩, ⟨(-14), (-10)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-332362516), (-332362512)⟩, ⟨(-58991292), (-58991286)⟩, ⟨(-2422892), (-2422887)⟩, ⟨22964, 22970⟩, ⟨459, 464⟩⟩
...
def j36 : Jet := ⟨⟨3962604780, 3962604784⟩, ⟨(-58991292), (-58991286)⟩, ⟨(-2422892), (-2422887)⟩, ⟨22964, 22970⟩, ⟨459, 464⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨941051709, 941051713⟩, ⟨77301726, 77301733⟩, ⟨(-1099127), (-1099121)⟩, ⟨(-29462), (-29457)⟩, ⟨254, 258⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4655206632, 4655206638⟩, ⟨69302046, 69302056⟩, ⟨3878069, 3878077⟩, ⟨73120, 73131⟩, ⟨2511, 2522⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1019982191, 1019982198⟩, ⟨98969860, 98969872⟩, ⟨905701, 905714⟩, ⟨36149, 36161⟩, ⟨672, 683⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-942707741), (-942707740)⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3352259555, 3352259556⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨242228542, 242228547⟩, ⟨47007340, 47007348⟩, ⟨2710759, 2710769⟩, ⟨58908, 58918⟩, ⟨2172, 2185⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4537195838, 4537195843⟩, ⟨47007340, 47007348⟩, ⟨2710759, 2710769⟩, ⟨58908, 58918⟩, ⟨2172, 2185⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4414420430, 4414420434⟩, ⟨22867666, 22867671⟩, ⟨1259473, 1259479⟩, ⟨22132, 22139⟩, ⟨761, 770⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3445493771, 3445493776⟩, ⟨(-70235830), (-70235822)⟩, ⟨526733, 526740⟩, ⟨(-7858), (-7851)⟩, ⟨151, 160⟩⟩
...
def j47 : Jet := ⟨⟨6980658722, 6980658732⟩, ⟨634605333, 634605342⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11345743246, 11345743280⟩, ⟨2062862390, 2062862424⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11345743246, 11345743280⟩, ⟨2062862390, 2062862424⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11345743280), (-11345743246)⟩, ⟨(-2062862424), (-2062862390)⟩, ⟨(-93766475), (-93766471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5672871640), (-5672871623)⟩, ⟨(-1031431212), (-1031431195)⟩, ⟨(-46883238), (-46883235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1146398834, 1146398848⟩, ⟨(-275306300), (-275306291)⟩, ⟨20543312, 20543316⟩, ⟨358984, 358986⟩, ⟨(-133677), (-133676)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨919660097, 919660110⟩, ⟨(-239602388), (-239602377)⟩, ⟨21122874, 21122883⟩, ⟨(-83826), (-83818)⟩, ⟨(-110047), (-110040)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨857007036, 1028408445⟩, ⟨85700703, 85700704⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2692367008, 3230840416⟩, ⟨269236698, 269236703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1687752107, 2430363045⟩, ⟨337550418, 405060510⟩, ⟨16877520, 16877522⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨422, 609⟩, ⟨84, 102⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94265), (-94077)⟩, ⟨84, 102⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-53342), (-36968)⟩, ⟨(-8858), (-7335)⟩, ⟨(-364), (-356)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5059714, 5076089⟩, ⟨(-8858), (-7335)⟩, ⟨(-364), (-356)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1988267, 2872371⟩, ⟨392640, 475847⟩, ⟨18840, 19233⟩, ⟨(-70), (-53)⟩, ⟨(-2), 1⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141177310), (-140293205)⟩, ⟨392640, 475847⟩, ⟨18840, 19233⟩, ⟨(-70), (-53)⟩, ⟨(-2), 1⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-79887016), (-55129675)⟩, ⟨(-13160212), (-10756669)⟩, ⟨(-516510), (-495534)⟩, ⟨2982, 3664⟩, ⟨65, 73⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1351768749, 1376526091⟩, ⟨(-13160212), (-10756669)⟩, ⟨(-516510), (-495534)⟩, ⟨2982, 3664⟩, ⟨65, 73⟩⟩
...
def j70 : Jet := ⟨⟨(-62), (-42)⟩, ⟨(-11), (-8)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11773, 11794⟩, ⟨(-11), (-8)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4626, 6674⟩, ⟨918, 1110⟩, ⟨43, 47⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847551), (-845502)⟩, ⟨918, 1110⟩, ⟨43, 47⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-479598), (-332248)⟩, ⟨(-79573), (-65820)⟩, ⟨(-3243), (-3190)⟩, ⟨4, 10⟩, ⟨(-2), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35311796, 35459147⟩, ⟨(-79573), (-65820)⟩, ⟨(-3243), (-3190)⟩, ⟨4, 10⟩, ⟨(-2), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨13876137, 20065020⟩, ⟨2730199, 3318306⟩, ⟨129420, 132916⟩, ⟨(-618), (-502)⟩, ⟨(-15), (-10)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701951746), (-695762862)⟩, ⟨2730199, 3318306⟩, ⟨129420, 132916⟩, ⟨(-618), (-502)⟩, ⟨(-15), (-10)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-397208516), (-273407259)⟩, ⟨(-65128560), (-52803744)⟩, ⟨(-2492965), (-2345907)⟩, ⟨20549, 25379⟩, ⟨440, 481⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3897758780, 4021560037⟩, ⟨(-65128560), (-52803744)⟩, ⟨(-2492965), (-2345907)⟩, ⟨20549, 25379⟩, ⟨440, 481⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨847377251, 1035476134⟩, ⟨74838103, 79546694⟩, ⟨(-1213508), (-984931)⟩, ⟨(-30510), (-28306)⟩, ⟨226, 285⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4586962249, 4732654101⟩, ⟨60227567, 79079021⟩, ⟨3466521, 4348307⟩, ⟨50780, 99054⟩, ⟨1621, 3604⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨904986509, 1140998298⟩, ⟨91808620, 106718259⟩, ⟨396196, 1461061⟩, ⟨14456, 60375⟩, ⟨(-347), 1829⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1028408445), (-857007036)⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3266558851, 3437960260⟩, ⟨(-85700704), (-85700703)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨190688432, 303116887⟩, ⟨38689728, 56701412⟩, ⟨2129450, 3427949⟩, ⟨23030, 104688⟩, ⟨468, 4472⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4485655728, 4598084183⟩, ⟨38689728, 56701412⟩, ⟨2129450, 3427949⟩, ⟨23030, 104688⟩, ⟨468, 4472⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4389276096, 4443942078⟩, ⟨18696363, 27741558⟩, ⟨942442, 1637330⟩, ⟨907, 47206⟩, ⟨(-376), 2085⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3338285880, 3557208987⟩, ⟨(-74453698), (-65376440)⟩, ⟨163229, 937560⟩, ⟨(-31982), 18982⟩, ⟨(-1243), 1651⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6346053381, 7615264073⟩, ⟨634605333, 634605342⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9376647303, 13502372174⟩, ⟨1875329444, 2250395372⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9376647303, 13502372174⟩, ⟨1875329444, 2250395372⟩, ⟨93766471, 93766475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13502372174), (-9376647303)⟩, ⟨(-2250395372), (-1875329444)⟩, ⟨(-93766475), (-93766471)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6751186087), (-4688323651)⟩, ⟨(-1125197686), (-937664722)⟩, ⟨(-46883238), (-46883235)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨891866280, 1441751265⟩, ⟨(-377710720), (-194709642)⟩, ⟨5516272, 39740941⟩, ⟨(-2053503), 2347259⟩, ⟨(-370638), 104388⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨693207748, 1194097698⟩, ⟨(-337823220), (-164914757)⟩, ⟨7285245, 39776910⟩, ⟨(-2482870), 1859071⟩, ⟨(-349542), 134099⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4414420430, 4414420434⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1362
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4389276096, 4443942078⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1363
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (18491697 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((15963 / 80000) : ℝ)..(47889 / 200000), prawitzNormalCorrection
