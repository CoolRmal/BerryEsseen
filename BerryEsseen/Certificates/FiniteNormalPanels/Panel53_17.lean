...
namespace FiniteNormalPanel53_17
...
def j2 : Jet := ⟨⟨1675228094, 1675228098⟩, ⟨558409363, 558409367⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨653413396, 653413400⟩, ⟨435608928, 435608934⟩, ⟨72601488, 72601490⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨163, 164⟩, ⟨109, 110⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94524), (-94522)⟩, ⟨109, 110⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-14381), (-14380)⟩, ⟨(-9571), (-9569)⟩, ⟨(-1585), (-1582)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5098675, 5098677⟩, ⟨(-9571), (-9569)⟩, ⟨(-1585), (-1582)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨775685, 775686⟩, ⟨515666, 515669⟩, ⟨84974, 84978⟩, ⟨(-323), (-320)⟩, ⟨(-27), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-142389892), (-142389890)⟩, ⟨515666, 515669⟩, ⟨84974, 84978⟩, ⟨(-323), (-320)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-21662439), (-21662437)⟩, ⟨(-14363176), (-14363173)⟩, ⟨(-2341711), (-2341707)⟩, ⟨17284, 17288⟩, ⟨1398, 1402⟩⟩
...
def j19 : Jet := ⟨⟨1409993326, 1409993329⟩, ⟨(-14363176), (-14363173)⟩, ⟨(-2341711), (-2341707)⟩, ⟨17284, 17288⟩, ⟨1398, 1402⟩⟩
...
def j25 : Jet := ⟨⟨1797, 1799⟩, ⟨1196, 1198⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850380), (-850377)⟩, ⟨1196, 1198⟩, ⟨196, 199⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-129373), (-129371)⟩, ⟨(-86068), (-86064)⟩, ⟨(-14225), (-14221)⟩, ⟨38, 42⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35662021, 35662024⟩, ⟨(-86068), (-86064)⟩, ⟨(-14225), (-14221)⟩, ⟨38, 42⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5425429, 5425430⟩, ⟨3603858, 3603861⟩, ⟨591930, 591935⟩, ⟨(-2893), (-2889)⟩, ⟨(-238), (-234)⟩⟩
...
def j33 : Jet := ⟨⟨(-710402454), (-710402452)⟩, ⟨3603858, 3603861⟩, ⟨591930, 591935⟩, ⟨(-2893), (-2889)⟩, ⟨(-238), (-234)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-108076838), (-108076836)⟩, ⟨(-71502955), (-71502950)⟩, ⟨(-11552971), (-11552968)⟩, ⟨120513, 120517⟩, ⟨9674, 9678⟩⟩
...
def j36 : Jet := ⟨⟨4186890458, 4186890460⟩, ⟨(-71502955), (-71502950)⟩, ⟨(-11552971), (-11552968)⟩, ⟨120513, 120517⟩, ⟨9674, 9678⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨549960050, 549960054⟩, ⟨177717739, 177717744⟩, ⟨(-2780798), (-2780794)⟩, ⟨(-297717), (-297712)⟩, ⟨2792, 2795⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4405833935, 4405833938⟩, ⟨75242026, 75242033⟩, ⟨13442071, 13442078⟩, ⟨310357, 310365⟩, ⟨30038, 30048⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨564156251, 564156257⟩, ⟨191939750, 191939759⟩, ⟨1982018, 1982027⟩, ⟨241828, 241840⟩, ⟨5631, 5641⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-533241665), (-533241664)⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3761725631, 3761725632⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨74103538, 74103541⟩, ⟨50423670, 50423676⟩, ⟨9098368, 9098374⟩, ⟨240678, 240686⟩, ⟨24006, 24013⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4369070834, 4369070837⟩, ⟨50423670, 50423676⟩, ⟨9098368, 9098374⟩, ⟨240678, 240686⟩, ⟨24006, 24013⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4331860610, 4331860612⟩, ⟨24997112, 24997116⟩, ⟨4438316, 4438320⟩, ⟨93702, 93708⟩, ⟨9085, 9091⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3794038455, 3794038459⟩, ⟨(-157380457), (-157380450)⟩, ⟨2852770, 2852776⟩, ⟨(-101612), (-101605)⟩, ⟨4078, 4086⟩⟩
...
def j47 : Jet := ⟨⟨3891184882, 3891184892⟩, ⟨1297061625, 1297061633⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3525363231, 3525363250⟩, ⟨2350242150, 2350242172⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3525363231, 3525363250⟩, ⟨2350242150, 2350242172⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3525363250), (-3525363231)⟩, ⟨(-2350242172), (-2350242150)⟩, ⟨(-391707030), (-391707024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1762681625), (-1762681615)⟩, ⟨(-1175121086), (-1175121075)⟩, ⟨(-195853515), (-195853512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2849198259, 2849198273⟩, ⟨(-779552611), (-779552599)⟩, ⟨(-23281005), (-23280998)⟩, ⟨25822021, 25822024⟩, ⟨(-1235439), (-1235438)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2516891751, 2516891767⟩, ⟨(-793035309), (-793035291)⟩, ⟨9891906, 9891920⟩, ⟨23078244, 23078257⟩, ⟨(-2031863), (-2031851)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨355494443, 710988887⟩, ⟨177747221, 177747222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1116818730, 2233637465⟩, ⟨558409363, 558409367⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨290405954, 1161623822⟩, ⟨290405952, 580811912⟩, ⟨72601488, 72601490⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-25590), (-6382)⟩, ⟨(-12791), (-6342)⟩, ⟨(-1595), (-1569)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5087466, 5106675⟩, ⟨(-12791), (-6342)⟩, ⟨(-1595), (-1569)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨343991, 1381160⟩, ⟨340531, 690152⟩, ⟨83835, 85789⟩, ⟨(-433), (-211)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142821586), (-141784416)⟩, ⟨340531, 690152⟩, ⟨83835, 85789⟩, ⟨(-433), (-211)⟩, ⟨(-27), (-24)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-38627758), (-9586810)⟩, ⟨(-19290854), (-9400150)⟩, ⟨(-2385542), (-2280169)⟩, ⟨11306, 23255⟩, ⟨1350, 1436⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1393028007, 1422068956⟩, ⟨(-19290854), (-9400150)⟩, ⟨(-2385542), (-2280169)⟩, ⟨11306, 23255⟩, ⟨1350, 1436⟩⟩
...
def j72 : Jet := ⟨⟨798, 3200⟩, ⟨793, 1600⟩, ⟨195, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851379), (-848976)⟩, ⟨793, 1600⟩, ⟨195, 200⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-230266), (-57403)⟩, ⟨(-115080), (-56970)⟩, ⟨(-14326), (-14078)⟩, ⟨25, 56⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35561128, 35733992⟩, ⟨(-115080), (-56970)⟩, ⟨(-14326), (-14078)⟩, ⟨25, 56⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2404480, 9664674⟩, ⟨2373355, 4828485⟩, ⟨581682, 599240⟩, ⟨(-3883), (-1898)⟩, ⟨(-242), (-227)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713423403), (-706163208)⟩, ⟨2373355, 4828485⟩, ⟨581682, 599240⟩, ⟨(-3883), (-1898)⟩, ⟨(-242), (-227)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-192953651), (-47747511)⟩, ⟨(-96316351), (-46441591)⟩, ⟨(-11859799), (-11121845)⟩, ⟨78397, 162528⟩, ⟨9240, 9987⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4102013645, 4247219785⟩, ⟨(-96316351), (-46441591)⟩, ⟨(-11859799), (-11121845)⟩, ⟨78397, 162528⟩, ⟨9240, 9987⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨362228548, 739560113⟩, ⟨171081885, 182445712⟩, ⟨(-3748721), (-1815069)⟩, ⟨(-307217), (-284361)⟩, ⟨1820, 3771⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4343251587, 4496997249⟩, ⟨47491658, 105590671⟩, ⟨11892616, 15481079⟩, ⟨82315, 585780⟩, ⟨17426, 47826⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨366300743, 774348107⟩, ⟨177010544, 209209629⟩, ⟨(-1030319), 5315630⟩, ⟨66830, 450861⟩, ⟨(-14479), 28900⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-710988887), (-355494443)⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3583978409, 3939472853⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨31240339, 139608745⟩, ⟨30193054, 75437632⟩, ⟨6923702, 12107420⟩, ⟨(-88978), 680428⟩, ⟨(-990), 60925⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4326207635, 4434576041⟩, ⟨30193054, 75437632⟩, ⟨6923702, 12107420⟩, ⟨(-88978), 680428⟩, ⟨(-990), 60925⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4310559164, 4364213454⟩, ⟨14856993, 37582383⟩, ⟨3245101, 6006210⟩, ⟨(-96695), 327800⟩, ⟨(-7537), 29976⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3596989199, 4002987507⟩, ⟨(-168215409), (-143920800)⟩, ⟨1152559, 4894220⟩, ⟨(-337260), 166370⟩, ⟨(-20481), 31497⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2594123257, 5188246524⟩, ⟨1297061625, 1297061633⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1566828105, 6267312448⟩, ⟨1566828100, 3133656230⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1566828105, 6267312448⟩, ⟨1566828100, 3133656230⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6267312448), (-1566828105)⟩, ⟨(-3133656230), (-1566828100)⟩, ⟨(-391707030), (-391707024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3133656224), (-783414052)⟩, ⟨(-1566828115), (-783414050)⟩, ⟨(-195853515), (-195853512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2070588245, 3578848653⟩, ⟨(-1305584025), (-377681088)⟩, ⟨(-128752961), 143721910⟩, ⟨(-5995172), 55346964⟩, ⟨(-8324631), 3482381⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1734095521, 3335551929⟩, ⟨(-1356996138), (-385687571)⟩, ⟨(-106788674), 189163731⟩, ⟨(-12985353), 56664357⟩, ⟨(-10140770), 3772991⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4331860610, 4331860612⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1056
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4310559164, 4364213454⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1057
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (52164627 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((8277 / 100000) : ℝ)..(8277 / 50000), prawitzNormalCorrection
