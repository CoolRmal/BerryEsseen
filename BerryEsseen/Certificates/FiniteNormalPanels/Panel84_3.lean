...
namespace FiniteNormalPanel84_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (891 / 10000)
def radius : Rat := (891 / 10000)

def j0 : Jet := ⟨⟨382681586, 382681587⟩, ⟨382681586, 382681587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1202229659, 1202229663⟩, ⟨1202229659, 1202229663⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨336523203, 336523206⟩, ⟨673046406, 673046412⟩, ⟨336523203, 336523206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨84, 85⟩, ⟨168, 169⟩, ⟨84, 85⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94603), (-94601)⟩, ⟨168, 169⟩, ⟨84, 85⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-7413), (-7412)⟩, ⟨(-14812), (-14810)⟩, ⟨(-7381), (-7378)⟩, ⟨26, 28⟩, ⟨6, 7⟩⟩
...
def j13 : Jet := ⟨⟨5105643, 5105645⟩, ⟨(-14812), (-14810)⟩, ⟨(-7381), (-7378)⟩, ⟨26, 28⟩, ⟨6, 7⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨400042, 400043⟩, ⟨798923, 798925⟩, ⟨397141, 397145⟩, ⟨(-2316), (-2313)⟩, ⟨(-575), (-572)⟩⟩
...
def j16 : Jet := ⟨⟨(-142765535), (-142765533)⟩, ⟨798923, 798925⟩, ⟨397141, 397145⟩, ⟨(-2316), (-2313)⟩, ⟨(-575), (-572)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-11186096), (-11186095)⟩, ⟨(-22309595), (-22309592)⟩, ⟨(-11029784), (-11029780)⟩, ⟨124649, 124653⟩, ⟨30708, 30712⟩⟩
...
def j19 : Jet := ⟨⟨1420469669, 1420469671⟩, ⟨(-22309595), (-22309592)⟩, ⟨(-11029784), (-11029780)⟩, ⟨124649, 124653⟩, ⟨30708, 30712⟩⟩
...
def j22 : Jet := ⟨⟨(-9), (-8)⟩, ⟨(-17), (-16)⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11826, 11828⟩, ⟨(-17), (-16)⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨926, 927⟩, ⟨1851, 1853⟩, ⟨922, 925⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851251), (-851249)⟩, ⟨1851, 1853⟩, ⟨922, 925⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-66698), (-66697)⟩, ⟨(-133251), (-133249)⟩, ⟨(-66336), (-66333)⟩, ⟨288, 291⟩, ⟨70, 73⟩⟩
...
def j30 : Jet := ⟨⟨35724696, 35724698⟩, ⟨(-133251), (-133249)⟩, ⟨(-66336), (-66333)⟩, ⟨288, 291⟩, ⟨70, 73⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2799134, 2799135⟩, ⟨5587827, 5587829⟩, ⟨2773054, 2773058⟩, ⟨(-20815), (-20811)⟩, ⟨(-5148), (-5145)⟩⟩
...
def j33 : Jet := ⟨⟨(-713028749), (-713028747)⟩, ⟨5587827, 5587829⟩, ⟨2773054, 2773058⟩, ⟨(-20815), (-20811)⟩, ⟨(-5148), (-5145)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-55867881), (-55867880)⟩, ⟨(-111297940), (-111297937)⟩, ⟨(-54774960), (-54774956)⟩, ⟨870744, 870748⟩, ⟨213610, 213614⟩⟩
...
def j36 : Jet := ⟨⟨4239099415, 4239099416⟩, ⟨(-111297940), (-111297937)⟩, ⟨(-54774960), (-54774956)⟩, ⟨870744, 870748⟩, ⟨213610, 213614⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨397612053, 397612056⟩, ⟨391367242, 391367247⟩, ⟨(-9332223), (-9332219)⟩, ⟨(-3052521), (-3052517)⟩, ⟨43486, 43490⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4351571469, 4351571471⟩, ⟨114250900, 114250905⟩, ⟨59227915, 59227922⟩, ⟨2137459, 2137467⟩, ⟨578673, 578682⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨402852256, 402852260⟩, ⟨407102065, 407102072⟩, ⟨6438687, 6438695⟩, ⟨2253861, 2253870⟩, ⟨82506, 82517⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-382681587), (-382681586)⟩, ⟨(-382681587), (-382681586)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3912285709, 3912285710⟩, ⟨(-382681587), (-382681586)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨37786071, 37786072⟩, ⟨76369374, 76369378⟩, ⟨39795359, 39795365⟩, ⟨1643398, 1643406⟩, ⟨452396, 452403⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4332753367, 4332753368⟩, ⟨76369374, 76369378⟩, ⟨39795359, 39795365⟩, ⟨1643398, 1643406⟩, ⟨452396, 452403⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4313818959, 4313818960⟩, ⟨38017817, 38017820⟩, ⟨19643199, 19643203⟩, ⟨644990, 644997⟩, ⟨174801, 174807⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3929457688, 3929457691⟩, ⟨(-349730842), (-349730836)⟩, ⟨14505601, 14505607⟩, ⟨(-1162689), (-1162681)⟩, ⟨101756, 101764⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨24474336664, 24474336670⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value402

def j47 : Jet := ⟨⟨2180663396, 2180663403⟩, ⟨2180663396, 2180663403⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1107177894, 1107177902⟩, ⟨2214355788, 2214355804⟩, ⟨1107177894, 1107177902⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1107177894, 1107177902⟩, ⟨2214355788, 2214355804⟩, ⟨1107177894, 1107177902⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1107177902), (-1107177894)⟩, ⟨(-2214355804), (-2214355788)⟩, ⟨(-1107177902), (-1107177894)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-553588951), (-553588947)⟩, ⟨(-1107177902), (-1107177894)⟩, ⟨(-553588951), (-553588947)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3775570393, 3775570400⟩, ⟨(-973285203), (-973285193)⟩, ⟨(-361193469), (-361193460)⟩, ⟨114669500, 114669504⟩, ⟨15887540, 15887543⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3454262415, 3454262425⟩, ⟨(-1197894207), (-1197894190)⟩, ⟨(-238451106), (-238451086)⟩, ⟨130012986, 130013003⟩, ⟨4331214, 4331230⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 765363173⟩, ⟨382681586, 382681587⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2404459322⟩, ⟨1202229659, 1202229663⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1346092819⟩, ⟨0, 1346092822⟩, ⟨336523203, 336523206⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 338⟩, ⟨0, 338⟩, ⟨84, 85⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94348)⟩, ⟨0, 338⟩, ⟨84, 85⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-29677), 0⟩, ⟨(-29677), 106⟩, ⟨(-7420), (-7259)⟩, ⟨0, 54⟩, ⟨6, 7⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5083379, 5113057⟩, ⟨(-29677), 106⟩, ⟨(-7420), (-7259)⟩, ⟨0, 54⟩, ⟨6, 7⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1602492⟩, ⟨(-9302), 1602526⟩, ⟨386669, 400657⟩, ⟨(-4652), 26⟩, ⟨(-582), (-548)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141563084)⟩, ⟨(-9302), 1602526⟩, ⟨386669, 400657⟩, ⟨(-4652), 26⟩, ⟨(-582), (-548)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-44869761), 0⟩, ⟨(-44872677), 502251⟩, ⟨(-11220357), (-10464058)⟩, ⟨(-2187), 251143⟩, ⟨28655, 31402⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1386786004, 1431655766⟩, ⟨(-44872677), 502251⟩, ⟨(-11220357), (-10464058)⟩, ⟨(-2187), 251143⟩, ⟨28655, 31402⟩⟩
...
def j70 : Jet := ⟨⟨(-34), 0⟩, ⟨(-34), 0⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11801, 11836⟩, ⟨(-34), 0⟩, ⟨(-9), (-8)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 3710⟩, ⟨(-11), 3710⟩, ⟨910, 928⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848466)⟩, ⟨(-11), 3710⟩, ⟨910, 928⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-267083), 0⟩, ⟨(-267087), 1163⟩, ⟨(-66775), (-65025)⟩, ⟨(-3), 582⟩, ⟨68, 73⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35524311, 35791395⟩, ⟨(-267087), 1163⟩, ⟨(-66775), (-65025)⟩, ⟨(-3), 582⟩, ⟨68, 73⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 11217441⟩, ⟨(-83709), 11217806⟩, ⟨2678795, 2804726⟩, ⟨(-41858), 275⟩, ⟨(-5234), (-4888)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-704610441)⟩, ⟨(-83709), 11217806⟩, ⟨2678795, 2804726⟩, ⟨(-41858), 275⟩, ⟨(-5234), (-4888)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-224348804), 0⟩, ⟨(-224375040), 3515792⟩, ⟨(-56113438), (-50813455)⟩, ⟨(-19678), 1758069⟩, ⟨195131, 219846⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4070618492, 4294967296⟩, ⟨(-224375040), 3515792⟩, ⟨(-56113438), (-50813455)⟩, ⟨(-19678), 1758069⟩, ⟨195131, 219846⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 801486442⟩, ⟨363062306, 401024399⟩, ⟨(-18842090), 140589⟩, ⟨(-3141982), (-2788458)⟩, ⟨(-613), 87879⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4531680901⟩, ⟨(-3914012), 249789090⟩, ⟨50608981, 76237712⟩, ⟨(-2077001), 7667519⟩, ⟨156035, 1269382⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 845659711⟩, ⟨362331909, 469739825⟩, ⟨(-20246012), 37698104⟩, ⟨(-520491), 5777928⟩, ⟨(-711770), 1050887⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-765363173), 0⟩, ⟨(-382681587), (-382681586)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3529604123, 4294967296⟩, ⟨(-382681587), (-382681586)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 166506588⟩, ⟨0, 184979312⟩, ⟨22594336, 66220537⟩, ⟨(-4633572), 10521368⟩, ⟨(-571849), 2008579⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4461473884⟩, ⟨0, 184979312⟩, ⟨22594336, 66220537⟩, ⟨(-4633572), 10521368⟩, ⟨(-571849), 2008579⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4377428975⟩, ⟨0, 92489656⟩, ⟨10107256, 33110269⟩, ⟨(-3029797), 5260684⟩, ⟨(-526836), 1057642⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3529604123, 4377428975⟩, ⟨(-390028923), (-290191930)⟩, ⟨65313, 33110269⟩, ⟨(-5979922), 4360128⟩, ⟨(-995563), 1327597⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4361326800⟩, ⟨2180663396, 2180663403⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4428711594⟩, ⟨0, 4428711600⟩, ⟨1107177894, 1107177902⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4428711594⟩, ⟨0, 4428711600⟩, ⟨1107177894, 1107177902⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4428711594), 0⟩, ⟨(-4428711600), 0⟩, ⟨(-1107177902), (-1107177894)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2214355797), 0⟩, ⟨(-2214355800), 0⟩, ⟨(-553588951), (-553588947)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2564783460, 4294967296⟩, ⟨(-2214355800), 0⟩, ⟨(-553588951), 240246307⟩, ⟨(-41287921), 285413793⟩, ⟨(-52270660), 40998427⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2107739046, 4377428975⟩, ⟨(-2646899482), (-173291066)⟩, ⟨(-564178639), 479056379⟩, ⟨(-86948145), 345525546⟩, ⟨(-86704039), 51797711⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨382681586, 382681587⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨382681586, 382681587⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4313818959, 4313818960⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar402 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1686
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar402 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 765363173⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4377428975⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1687
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(891 / 5000), prawitzNormalCorrection
      ((50367 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
