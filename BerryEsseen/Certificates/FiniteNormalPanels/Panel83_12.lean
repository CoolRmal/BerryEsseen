...
namespace FiniteNormalPanel83_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (241591 / 800000)
def radius : Rat := (34513 / 800000)

def j0 : Jet := ⟨⟨1297031805, 1297031806⟩, ⟨185290257, 185290258⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4074745589, 4074745594⟩, ⟨582106510, 582106514⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3865815609, 3865815619⟩, ⟨1104518740, 1104518750⟩, ⟨78894195, 78894197⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨967, 969⟩, ⟨276, 277⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93720), (-93717)⟩, ⟨276, 277⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-84356), (-84352)⟩, ⟨(-23854), (-23850)⟩, ⟨(-1635), (-1630)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5028700, 5028705⟩, ⟨(-23854), (-23850)⟩, ⟨(-1635), (-1630)⟩, ⟨9, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4526233, 4526239⟩, ⟨1271738, 1271746⟩, ⟨84765, 84773⟩, ⟨(-852), (-846)⟩, ⟨(-29), (-24)⟩⟩
...
def j16 : Jet := ⟨⟨(-138639344), (-138639337)⟩, ⟨1271738, 1271746⟩, ⟨84765, 84773⟩, ⟨(-852), (-846)⟩, ⟨(-29), (-24)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-124786548), (-124786541)⟩, ⟨(-34508634), (-34508623)⟩, ⟨(-2143323), (-2143311)⟩, ⟨44391, 44401⟩, ⟨1310, 1320⟩⟩
...
def j19 : Jet := ⟨⟨1306869217, 1306869225⟩, ⟨(-34508634), (-34508623)⟩, ⟨(-2143323), (-2143311)⟩, ⟨44391, 44401⟩, ⟨1310, 1320⟩⟩
...
def j22 : Jet := ⟨⟨(-98), (-96)⟩, ⟨(-28), (-27)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11737, 11740⟩, ⟨(-28), (-27)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10564, 10567⟩, ⟨2992, 2996⟩, ⟨205, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841613), (-841609)⟩, ⟨2992, 2996⟩, ⟨205, 210⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-757520), (-757515)⟩, ⟨(-213742), (-213736)⟩, ⟨(-14507), (-14498)⟩, ⟨104, 111⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35033874, 35033880⟩, ⟨(-213742), (-213736)⟩, ⟨(-14507), (-14498)⟩, ⟨104, 111⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨31533301, 31533307⟩, ⟨8817129, 8817138⟩, ⟨575510, 575523⟩, ⟨(-7565), (-7554)⟩, ⟨(-241), (-233)⟩⟩
...
def j33 : Jet := ⟨⟨(-684294582), (-684294575)⟩, ⟨8817129, 8817138⟩, ⟨575510, 575523⟩, ⟨(-7565), (-7554)⟩, ⟨(-241), (-233)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-615920100), (-615920091)⟩, ⟨(-168041048), (-168041035)⟩, ⟨(-9784330), (-9784313)⟩, ⟨303152, 303168⟩, ⟨8408, 8421⟩⟩
...
def j36 : Jet := ⟨⟨3679047196, 3679047205⟩, ⟨(-168041048), (-168041035)⟩, ⟨(-9784330), (-9784313)⟩, ⟨303152, 303168⟩, ⟨8408, 8421⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1239860331, 1239860342⟩, ⟨144383677, 144383692⟩, ⟨(-6710459), (-6710444)⟩, ⟨(-248376), (-248362)⟩, ⟨7258, 7271⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5014000377, 5014000390⟩, ⟨229015221, 229015242⟩, ⟨23794882, 23794911⟩, ⟨1282718, 1282747⟩, ⟨91519, 91544⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1447428988, 1447429005⟩, ⟨234666908, 234666935⟩, ⟨6733960, 6733990⟩, ⟨522430, 522461⟩, ⟨27591, 27619⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1297031806), (-1297031805)⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2997935490, 2997935491⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨487791997, 487792009⟩, ⟨158168228, 158168250⟩, ⟨17360413, 17360439⟩, ⟨1087976, 1088006⟩, ⟨86241, 86269⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4782759293, 4782759305⟩, ⟨158168228, 158168250⟩, ⟨17360413, 17360439⟩, ⟨1087976, 1088006⟩, ⟨86241, 86269⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4532305676, 4532305683⟩, ⟨74942801, 74942812⟩, ⟨7606060, 7606074⟩, ⟨389732, 389749⟩, ⟨28035, 28050⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3163600349, 3163600356⟩, ⟨(-143218415), (-143218405)⟩, ⟨2075988, 2076000⟩, ⟨(-56099), (-56084)⟩, ⟨2753, 2767⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨25901848379, 25901848385⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value399

def j47 : Jet := ⟨⟨7822066814, 7822066823⟩, ⟨1117438111, 1117438118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨14245679891, 14245679925⟩, ⟨4070194234, 4070194266⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨14245679891, 14245679925⟩, ⟨4070194234, 4070194266⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-14245679925), (-14245679891)⟩, ⟨(-4070194266), (-4070194234)⟩, ⟨(-290728162), (-290728158)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7122839963), (-7122839945)⟩, ⟨(-2035097133), (-2035097117)⟩, ⟨(-145364081), (-145364079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨817935761, 817935773⟩, ⟨(-387564941), (-387564932)⟩, ⟨64137311, 64137316⟩, ⟨(-1385314), (-1385312)⟩, ⟨(-921270), (-921268)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨602477662, 602477674⟩, ⟨(-312748378), (-312748367)⟩, ⟨60561409, 60561419⟩, ⟨(-3357116), (-3357106)⟩, ⟨(-595813), (-595803)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1111741547, 1482322063⟩, ⟨185290257, 185290258⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3492639076, 4656852104⟩, ⟨582106510, 582106514⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2840191059, 5049228557⟩, ⟨946730348, 1262307142⟩, ⟨78894195, 78894197⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨710, 1265⟩, ⟨236, 317⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93977), (-93421)⟩, ⟨236, 317⟩, ⟨19, 20⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-110481), (-61777)⟩, ⟨(-27465), (-20219)⟩, ⟨(-1663), (-1598)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5002575, 5051280⟩, ⟨(-27465), (-20219)⟩, ⟨(-1663), (-1598)⟩, ⟨8, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3308120, 5938362⟩, ⟨1070417, 1471221⟩, ⟨81863, 87275⟩, ⟨(-989), (-708)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139857457), (-137227214)⟩, ⟨1070417, 1471221⟩, ⟨81863, 87275⟩, ⟨(-989), (-708)⟩, ⟨(-30), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-164418544), (-90746094)⟩, ⟨(-40396787), (-28519107)⟩, ⟨(-2278957), (-1985724)⟩, ⟨36543, 52208⟩, ⟨1176, 1433⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1267237221, 1340909672⟩, ⟨(-40396787), (-28519107)⟩, ⟨(-2278957), (-1985724)⟩, ⟨36543, 52208⟩, ⟨1176, 1433⟩⟩
...
def j70 : Jet := ⟨⟨(-127), (-70)⟩, ⟨(-32), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11708, 11766⟩, ⟨(-32), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7742, 13833⟩, ⟨2542, 3444⟩, ⟨202, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844435), (-838343)⟩, ⟨2542, 3444⟩, ⟨202, 212⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-992731), (-554382)⟩, ⟨(-246503), (-180745)⟩, ⟨(-14819), (-14136)⟩, ⟨87, 127⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34798663, 35237013⟩, ⟨(-246503), (-180745)⟩, ⟨(-14819), (-14136)⟩, ⟨87, 127⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨23011782, 41425166⟩, ⟨7380800, 10236769⟩, ⟨549345, 598081⟩, ⟨(-8828), (-6285)⟩, ⟨(-254), (-216)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-692816101), (-674402716)⟩, ⟨7380800, 10236769⟩, ⟨549345, 598081⟩, ⟨(-8828), (-6285)⟩, ⟨(-254), (-216)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-814485095), (-445971396)⟩, ⟨(-198740473), (-136622630)⟩, ⟨(-10736125), (-8676354)⟩, ⟨246288, 359663⟩, ⟨7196, 9460⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3480482201, 3848995900⟩, ⟨(-198740473), (-136622630)⟩, ⟨(-10736125), (-8676354)⟩, ⟨246288, 359663⟩, ⟨7196, 9460⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1030508949, 1453891869⟩, ⟨127950955, 158544935⟩, ⟨(-7946045), (-5480035)⟩, ⟨(-279157), (-212522)⟩, ⟨5908, 8630⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4792612035, 5300054133⟩, ⟨170116901, 302640613⟩, ⟨16841850, 33630107⟩, ⟨486031, 2514737⟩, ⟨13908, 225390⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1149910872, 1794124397⟩, ⟨183593080, 298093881⟩, ⟨(-696670), 16440871⟩, ⟨(-286047), 1638491⟩, ⟨(-57482), 149872⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1482322063), (-1111741547)⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2812645233, 3183225749⟩, ⟨(-185290258), (-185290257)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨307870799, 749454450⟩, ⟨98308398, 249043808⟩, ⟨7265851, 34424919⟩, ⟨(-335686), 3651058⟩, ⟨(-90399), 415589⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4602838095, 5044421746⟩, ⟨98308398, 249043808⟩, ⟨7265851, 34424919⟩, ⟨(-335686), 3651058⟩, ⟨(-90399), 415589⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4446238757, 4654634941⟩, ⟨45356011, 120285378⟩, ⟨1797994, 16395514⟩, ⟨(-605686), 1745080⟩, ⟨(-121102), 216748⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2911708374, 3449794324⟩, ⟨(-171104480), (-102666487)⟩, ⟨(-4011810), 10194862⟩, ⟨(-1156229), 1215804⟩, ⟨(-165041), 186775⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6704628697, 8939504934⟩, ⟨1117438111, 1117438118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨10466213795, 18606602323⟩, ⟨3488737914, 4651650586⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨10466213795, 18606602323⟩, ⟨3488737914, 4651650586⟩, ⟨290728158, 290728162⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-18606602323), (-10466213795)⟩, ⟨(-4651650586), (-3488737914)⟩, ⟨(-290728162), (-290728158)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-9303301162), (-5233106897)⟩, ⟨(-2325825293), (-1744368957)⟩, ⟨(-145364081), (-145364079)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨492308529, 1269999236⟩, ⟨(-687734305), (-199947439)⟩, ⟨(-2379814), 169549824⟩, ⟨(-26093558), 15947251⟩, ⟨(-5028178), 3572841⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨333753150, 1020086035⟩, ⟨(-602995154), (-147319449)⟩, ⟨1681742, 166598223⟩, ⟨(-29687750), 13905826⟩, ⟨(-5075892), 4552123⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1297031805, 1297031806⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4532305676, 4532305683⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar399 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1674
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar399 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1111741547, 1482322063⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4446238757, 4654634941⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1675
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((103539 / 400000) : ℝ)..(34513 / 100000), prawitzNormalCorrection
      ((213219 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
