...
namespace FiniteNormalPanel53_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (57939 / 200000)
def radius : Rat := (8277 / 200000)

def j0 : Jet := ⟨⟨1244230550, 1244230551⟩, ⟨177747221, 177747222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3908865555, 3908865559⟩, ⟨558409363, 558409367⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3557472938, 3557472946⟩, ⟨1016420834, 1016420846⟩, ⟨72601488, 72601490⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨890, 892⟩, ⟨254, 255⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93797), (-93794)⟩, ⟨254, 255⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-77691), (-77688)⟩, ⟨(-21988), (-21984)⟩, ⟨(-1512), (-1508)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5035365, 5035369⟩, ⟨(-21988), (-21984)⟩, ⟨(-1512), (-1508)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4170736, 4170740⟩, ⟨1173425, 1173431⟩, ⟨78660, 78667⟩, ⟨(-724), (-718)⟩, ⟨(-25), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-138994841), (-138994836)⟩, ⟨1173425, 1173431⟩, ⟨78660, 78667⟩, ⟨(-724), (-718)⟩, ⟨(-25), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-115127859), (-115127853)⟩, ⟨(-31921740), (-31921732)⟩, ⟨(-2006701), (-2006691)⟩, ⟨37850, 37859⟩, ⟨1136, 1144⟩⟩
...
def j19 : Jet := ⟨⟨1316527906, 1316527913⟩, ⟨(-31921740), (-31921732)⟩, ⟨(-2006701), (-2006691)⟩, ⟨37850, 37859⟩, ⟨1136, 1144⟩⟩
...
def j22 : Jet := ⟨⟨(-90), (-88)⟩, ⟨(-26), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11745, 11748⟩, ⟨(-26), (-25)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9728, 9731⟩, ⟨2757, 2761⟩, ⟨189, 194⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842449), (-842445)⟩, ⟨2757, 2761⟩, ⟨189, 194⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-697792), (-697787)⟩, ⟨(-197086), (-197080)⟩, ⟨(-13433), (-13425)⟩, ⟨88, 93⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35093602, 35093608⟩, ⟨(-197086), (-197080)⟩, ⟨(-13433), (-13425)⟩, ⟨88, 93⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨29067634, 29067640⟩, ⟨8141793, 8141801⟩, ⟨535448, 535460⟩, ⟨(-6439), (-6430)⟩, ⟨(-208), (-199)⟩⟩
...
def j33 : Jet := ⟨⟨(-686760249), (-686760242)⟩, ⟨8141793, 8141801⟩, ⟨535448, 535460⟩, ⟨(-6439), (-6430)⟩, ⟨(-208), (-199)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-568835765), (-568835757)⟩, ⟨(-155780750), (-155780739)⟩, ⟨(-9238602), (-9238586)⟩, ⟨259008, 259022⟩, ⟨7354, 7367⟩⟩
...
def j36 : Jet := ⟨⟨3726131531, 3726131539⟩, ⟨(-155780750), (-155780739)⟩, ⟨(-9238602), (-9238586)⟩, ⟨259008, 259022⟩, ⟨7354, 7367⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1198176896, 1198176904⟩, ⟨142116033, 142116045⟩, ⟨(-5976606), (-5976593)⟩, ⟨(-226454), (-226443)⟩, ⟨5954, 5965⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4950642209, 4950642220⟩, ⟨206974630, 206974648⟩, ⟨20927760, 20927787⟩, ⟨1043967, 1043992⟩, ⟨71356, 71381⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1381092033, 1381092046⟩, ⟨221551826, 221551848⟩, ⟨5797839, 5797865⟩, ⟨434676, 434700⟩, ⟨21276, 21302⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1244230551), (-1244230550)⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3050736745, 3050736746⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨444104709, 444104718⟩, ⟨142484652, 142484670⟩, ⟨15157253, 15157274⟩, ⟨877700, 877722⟩, ⟨66352, 66375⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4739072005, 4739072014⟩, ⟨142484652, 142484670⟩, ⟨15157253, 15157274⟩, ⟨877700, 877722⟩, ⟨66352, 66375⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4511558408, 4511558413⟩, ⟨67822120, 67822130⟩, ⟨6705006, 6705018⟩, ⟨316984, 316997⟩, ⟨21834, 21848⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3204582494, 3204582500⟩, ⟨(-138536456), (-138536445)⟩, ⟨1955780, 1955790⟩, ⟨(-52333), (-52321)⟩, ⟨2389, 2401⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨31341346603, 31341346610⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value307

def j47 : Jet := ⟨⟨9079431398, 9079431408⟩, ⟨1297061625, 1297061633⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨19193644288, 19193644331⟩, ⟨5483898354, 5483898396⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨19193644288, 19193644331⟩, ⟨5483898354, 5483898396⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-19193644331), (-19193644288)⟩, ⟨(-5483898396), (-5483898354)⟩, ⟨(-391707030), (-391707024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9596822166), (-9596822144)⟩, ⟨(-2741949198), (-2741949177)⟩, ⟨(-195853515), (-195853512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨459787732, 459787741⟩, ⟨(-293532999), (-293532990)⟩, ⟨72730524, 72730530⟩, ⟨(-6553755), (-6553752)⟩, ⟨(-612287), (-612285)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨343059123, 343059132⟩, ⟨(-233843010), (-233842999)⟩, ⟨63943495, 63943505⟩, ⟨(-7375152), (-7375144)⟩, ⟨(-208501), (-208491)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1066483329, 1421977773⟩, ⟨177747221, 177747222⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3350456191, 4467274926⟩, ⟨558409363, 558409367⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2613653588, 4646495280⟩, ⟨871217858, 1161623824⟩, ⟨72601488, 72601490⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨654, 1165⟩, ⟨218, 292⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94033), (-93521)⟩, ⟨218, 292⟩, ⟨18, 19⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-101730), (-56911)⟩, ⟨(-25301), (-18654)⟩, ⟨(-1536), (-1480)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5011326, 5056146⟩, ⟨(-25301), (-18654)⟩, ⟨(-1536), (-1480)⟩, ⟨6, 11⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3049585, 5469974⟩, ⟨989156, 1356143⟩, ⟨76205, 80786⟩, ⟨(-841), (-603)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140115992), (-137695602)⟩, ⟨989156, 1356143⟩, ⟨76205, 80786⟩, ⟨(-841), (-603)⟩, ⟨(-25), (-20)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-151583994), (-83793095)⟩, ⟨(-37294060), (-26463892)⟩, ⟨(-2121481), (-1873401)⟩, ⟨31267, 44409⟩, ⟨1032, 1232⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1280071771, 1347862671⟩, ⟨(-37294060), (-26463892)⟩, ⟨(-2121481), (-1873401)⟩, ⟨31267, 44409⟩, ⟨1032, 1232⟩⟩
...
def j70 : Jet := ⟨⟨(-117), (-65)⟩, ⟨(-30), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11718, 11771⟩, ⟨(-30), (-21)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7130, 12735⟩, ⟨2343, 3172⟩, ⟨186, 195⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845047), (-839441)⟩, ⟨2343, 3172⟩, ⟨186, 195⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-914212), (-510832)⟩, ⟨(-227128), (-166845)⟩, ⟨(-13697), (-13120)⟩, ⟨73, 107⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34877182, 35280563⟩, ⟨(-227128), (-166845)⟩, ⟨(-13697), (-13120)⟩, ⟨73, 107⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21224113, 38168154⟩, ⟨6828986, 9440508⟩, ⟨513309, 554551⟩, ⟨(-7501), (-5365)⟩, ⟨(-218), (-187)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694603770), (-677659728)⟩, ⟨6828986, 9440508⟩, ⟨513309, 554551⟩, ⟨(-7501), (-5365)⟩, ⟨(-218), (-187)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-751454649), (-412382134)⟩, ⟨(-183707962), (-127247529)⟩, ⟨(-10043879), (-8301823)⟩, ⟨211443, 306302⟩, ⟨6411, 8174⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3543512647, 3882585162⟩, ⟨(-183707962), (-127247529)⟩, ⟨(-10043879), (-8301823)⟩, ⟨211443, 306302⟩, ⟨6411, 8174⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨998569743, 1401936895⟩, ⟨127638047, 154597926⟩, ⟨(-7055373), (-4902116)⟩, ⟨(-251433), (-197378)⟩, ⟨4870, 7056⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4751149892, 5205779099⟩, ⟨155713798, 269885610⟩, ⟨15262356, 28747282⟩, ⟨422466, 1971831⟩, ⟨14225, 165826⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1104631118, 1699238501⟩, ⟨177397992, 275477127⟩, ⟨(-375599), 13675296⟩, ⟨(-196308), 1282329⟩, ⟨(-41776), 109084⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1421977773), (-1066483329)⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2872989523, 3228483967⟩, ⟨(-177747222), (-177747221)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨284102258, 672277875⟩, ⟨91250678, 217976674⟩, ⟨7029989, 28489816⟩, ⟨(-203516), 2768922⟩, ⟨(-59438), 294355⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4579069554, 4967245171⟩, ⟨91250678, 217976674⟩, ⟨7029989, 28489816⟩, ⟨(-203516), 2768922⟩, ⟨(-59438), 294355⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4434743958, 4618891162⟩, ⟨42425623, 105553184⟩, ⟨2062410, 13592995⟩, ⟨(-422084), 1321095⟩, ⟨(-81060), 152107⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2966488927, 3471974298⟩, ⟨(-162773465), (-104188605)⟩, ⟨(-2988732), 8461935⟩, ⟨(-879824), 907702⟩, ⟨(-115606), 131806⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7782369773, 10376493041⟩, ⟨1297061625, 1297061633⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14101452958, 25069249755⟩, ⟨4700484304, 6267312454⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14101452958, 25069249755⟩, ⟨4700484304, 6267312454⟩, ⟨391707024, 391707030⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-25069249755), (-14101452958)⟩, ⟨(-6267312454), (-4700484304)⟩, ⟨(-391707030), (-391707024)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12534624878), (-7050726479)⟩, ⟨(-3133656227), (-2350242152)⟩, ⟨(-195853515), (-195853512)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨232003957, 831785040⟩, ⟨(-606879679), (-126954512)⟩, ⟨(-3194694), 210813562⟩, ⟨(-47411169), 19226388⟩, ⟨(-8313570), 8720771⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨160242703, 672400063⟩, ⟨(-522114147), (-93314172)⟩, ⟨(-81647), 195056595⟩, ⟨(-47681952), 16261442⟩, ⟨(-7746543), 9411727⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1244230550, 1244230551⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨177747221, 177747222⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4511558408, 4511558413⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar307 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1048
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar307 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1066483329, 1421977773⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4434743958, 4618891162⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1049
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((24831 / 100000) : ℝ)..(8277 / 25000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (24831 / 100000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (8277 / 25000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((24831 / 100000) : ℝ)..(8277 / 25000), prawitzNormalCorrection
      ((74477 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
