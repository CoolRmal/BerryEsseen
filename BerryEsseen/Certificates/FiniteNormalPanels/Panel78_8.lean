...
namespace FiniteNormalPanel78_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (43477 / 160000)
def radius : Rat := (6211 / 160000)

def j0 : Jet := ⟨⟨1167076832, 1167076833⟩, ⟨166725261, 166725262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3666480001, 3666480005⟩, ⟨523782855, 523782859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3129959944, 3129959951⟩, ⟨894274264, 894274274⟩, ⟨63876732, 63876734⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨783, 785⟩, ⟨223, 225⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93904), (-93901)⟩, ⟨223, 225⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-68433), (-68430)⟩, ⟨(-19391), (-19387)⟩, ⟨(-1341), (-1336)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5044623, 5044627⟩, ⟨(-19391), (-19387)⟩, ⟨(-1341), (-1336)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3676271, 3676275⟩, ⟨1036231, 1036237⟩, ⟨70009, 70018⟩, ⟨(-565), (-560)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-139489306), (-139489301)⟩, ⟨1036231, 1036237⟩, ⟨70009, 70018⟩, ⟨(-565), (-560)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-101652915), (-101652910)⟩, ⟨(-28288537), (-28288529)⟩, ⟨(-1807773), (-1807763)⟩, ⟨29575, 29583⟩, ⟨909, 915⟩⟩
...
def j19 : Jet := ⟨⟨1330002850, 1330002856⟩, ⟨(-28288537), (-28288529)⟩, ⟨(-1807773), (-1807763)⟩, ⟨29575, 29583⟩, ⟨909, 915⟩⟩
...
def j25 : Jet := ⟨⟨8567, 8570⟩, ⟨2430, 2433⟩, ⟨167, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843610), (-843606)⟩, ⟨2430, 2433⟩, ⟨167, 171⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-614782), (-614778)⟩, ⟨(-173882), (-173876)⟩, ⟨(-11921), (-11914)⟩, ⟨68, 73⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35176612, 35176617⟩, ⟨(-173882), (-173876)⟩, ⟨(-11921), (-11914)⟩, ⟨68, 73⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25634976, 25634981⟩, ⟨7197562, 7197569⟩, ⟨478269, 478278⟩, ⟨(-5021), (-5011)⟩, ⟨(-164), (-158)⟩⟩
...
def j33 : Jet := ⟨⟨(-690192907), (-690192901)⟩, ⟨7197562, 7197569⟩, ⟨478269, 478278⟩, ⟨(-5021), (-5011)⟩, ⟨(-164), (-158)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-502978489), (-502978482)⟩, ⟨(-138462913), (-138462903)⟩, ⟨(-8417694), (-8417682)⟩, ⟨202967, 202980⟩, ⟨5947, 5956⟩⟩
...
def j36 : Jet := ⟨⟨3791988807, 3791988814⟩, ⟨(-138462913), (-138462903)⟩, ⟨(-8417694), (-8417682)⟩, ⟨202967, 202980⟩, ⟨5947, 5956⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1135382068, 1135382075⟩, ⟨138048392, 138048403⟩, ⟨(-4993104), (-4993093)⟩, ⟨(-195216), (-195206)⟩, ⟨4381, 4390⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4864662049, 4864662058⟩, ⟨177631122, 177631137⟩, ⟨17284991, 17285011⟩, ⟨765070, 765091⟩, ⟨49154, 49173⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1285981865, 1285981877⟩, ⟨203316556, 203316576⟩, ⟨4623316, 4623337⟩, ⟨330204, 330226⟩, ⟨14376, 14397⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1167076833), (-1167076832)⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3127890463, 3127890464⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨385043527, 385043535⟩, ⟨121752452, 121752468⟩, ⟨12393253, 12393272⟩, ⟨635456, 635474⟩, ⟨44846, 44865⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4680010823, 4680010831⟩, ⟨121752452, 121752468⟩, ⟨12393253, 12393272⟩, ⟨635456, 635474⟩, ⟨44846, 44865⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4483357383, 4483357388⟩, ⟨58318214, 58318223⟩, ⟨5556951, 5556962⟩, ⟨232093, 232104⟩, ⟨15017, 15028⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3265089076, 3265089081⟩, ⟨(-131566998), (-131566988)⟩, ⟨1783112, 1783122⟩, ⟨(-46689), (-46678)⟩, ⟨1926, 1936⟩⟩
...
def j47 : Jet := ⟨⟨9057030143, 9057030154⟩, ⟨1293861443, 1293861452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨19099049971, 19099050018⟩, ⟨5456871394, 5456871440⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨19099049971, 19099050018⟩, ⟨5456871394, 5456871440⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-19099050018), (-19099049971)⟩, ⟨(-5456871440), (-5456871394)⟩, ⟨(-389776532), (-389776526)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-9549525009), (-9549524985)⟩, ⟨(-2728435720), (-2728435697)⟩, ⟨(-194888266), (-194888263)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨464878998, 464879012⟩, ⟨(-295320643), (-295320631)⟩, ⟨72708867, 72708875⟩, ⟨(-6462793), (-6462789)⟩, ⟨(-623225), (-623223)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨353406960, 353406972⟩, ⟨(-238747091), (-238747078)⟩, ⟨64513715, 64513726⟩, ⟨(-7268038), (-7268030)⟩, ⟨(-242208), (-242200)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1000351570, 1333802094⟩, ⟨166725261, 166725262⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3142697143, 4190262861⟩, ⟨523782855, 523782859⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2299562406, 4088110953⟩, ⟨766520798, 1022027742⟩, ⟨63876732, 63876734⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨575, 1025⟩, ⟨191, 257⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94112), (-93661)⟩, ⟨191, 257⟩, ⟨15, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-89580), (-50146)⟩, ⟨(-22293), (-16470)⟩, ⟨(-1358), (-1313)⟩, ⟨4, 9⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5023476, 5062911⟩, ⟨(-22293), (-16470)⟩, ⟨(-1358), (-1313)⟩, ⟨4, 9⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2689612, 4819069⟩, ⟨875317, 1195950⟩, ⟨68113, 71657⟩, ⟨(-654), (-469)⟩, ⟨(-21), (-15)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140475965), (-138346507)⟩, ⟨875317, 1195950⟩, ⟨68113, 71657⟩, ⟨(-654), (-469)⟩, ⟨(-21), (-15)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-133710292), (-74071908)⟩, ⟨(-32958922), (-23552285)⟩, ⟨(-1896539), (-1704758)⟩, ⟨24551, 34588⟩, ⟨837, 975⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1297945473, 1357583858⟩, ⟨(-32958922), (-23552285)⟩, ⟨(-1896539), (-1704758)⟩, ⟨24551, 34588⟩, ⟨837, 975⟩⟩
...
def j70 : Jet := ⟨⟨(-103), (-57)⟩, ⟨(-26), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11732, 11779⟩, ⟨(-26), (-19)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6281, 11212⟩, ⟨2068, 2793⟩, ⟨165, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845896), (-840964)⟩, ⟨2068, 2793⟩, ⟨165, 173⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-805156), (-450259)⟩, ⟨(-200182), (-147427)⟩, ⟨(-12124), (-11677)⟩, ⟨57, 84⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34986238, 35341136⟩, ⟨(-200182), (-147427)⟩, ⟨(-12124), (-11677)⟩, ⟨57, 84⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨18731932, 33639019⟩, ⟨6053436, 8330822⟩, ⟨461154, 493048⟩, ⟨(-5834), (-4195)⟩, ⟨(-171), (-150)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-697095951), (-682188863)⟩, ⟨6053436, 8330822⟩, ⟨461154, 493048⟩, ⟨(-5834), (-4195)⟩, ⟨(-171), (-150)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-663522071), (-365249780)⟩, ⟨(-162639458), (-113820337)⟩, ⟨(-9040275), (-7694127)⟩, ⟨166776, 238980⟩, ⟨5306, 6505⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3631445225, 3929717516⟩, ⟨(-162639458), (-113820337)⟩, ⟨(-9040275), (-7694127)⟩, ⟨166776, 238980⟩, ⟨5306, 6505⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨949727727, 1324488135⟩, ⟨126132516, 148327430⟩, ⟨(-5869735), (-4119663)⟩, ⟨(-213325), (-174154)⟩, ⟨3606, 5171⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4694165419, 5079725270⟩, ⟨135961805, 227502749⟩, ⟨13128862, 22834722⟩, ⟨337550, 1373460⟩, ⟨13236, 105257⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1038000698, 1566492918⟩, ⟨167920623, 245586803⟩, ⟨(-46239), 10396085⟩, ⟨(-103019), 891400⟩, ⟨(-25728), 67904⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1333802094), (-1000351570)⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2961165202, 3294615726⟩, ⟨(-166725262), (-166725261)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨250862317, 571343131⟩, ⟨81165564, 179144550⟩, ⟨6531473, 21626165⟩, ⟨(-80436), 1839138⟩, ⟨(-30662), 176641⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4545829613, 4866310427⟩, ⟨81165564, 179144550⟩, ⟨6531473, 21626165⟩, ⟨(-80436), 1839138⟩, ⟨(-30662), 176641⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4418618508, 4571722229⟩, ⟨38126052, 87065673⟩, ⟨2238984, 10346003⟩, ⟨(-242954), 874517⟩, ⟨(-44247), 90070⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3046416530, 3506910976⟩, ⟨(-151182537), (-104738256)⟩, ⟨(-1836114), 6456285⟩, ⟨(-587986), 583918⟩, ⟨(-67890), 78524⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7763168692, 10350891598⟩, ⟨1293861443, 1293861452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨14031955073, 24945697951⟩, ⟨4677318336, 6236424500⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨14031955073, 24945697951⟩, ⟨4677318336, 6236424500⟩, ⟨389776526, 389776532⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-24945697951), (-14031955073)⟩, ⟨(-6236424500), (-4677318336)⟩, ⟨(-389776532), (-389776526)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-12472848976), (-7015977536)⟩, ⟨(-3118212250), (-2338659168)⟩, ⟨(-194888266), (-194888263)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨235365061, 838541992⟩, ⟨(-608794371), (-128158986)⟩, ⟨(-3157627), 210317119⟩, ⟨(-47020929), 19180582⟩, ⟨(-8253021), 8606120⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨166944231, 684683239⟩, ⟨(-526607170), (-96642733)⟩, ⟨188585, 194417397⟩, ⟨(-46826456), 16146674⟩, ⟨(-7599819), 9097002⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1167076832, 1167076833⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4483357383, 4483357388⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1572
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1000351570, 1333802094⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4418618508, 4571722229⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1573
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (29248449 / 4294967296)

theorem envelope_integral : (∫ s in ((18633 / 80000) : ℝ)..(6211 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((18633 / 80000) : ℝ)..(6211 / 20000), prawitzNormalCorrection
