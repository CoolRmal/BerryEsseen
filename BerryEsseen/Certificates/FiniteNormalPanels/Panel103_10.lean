...
namespace FiniteNormalPanel103_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8793 / 80000)
def radius : Rat := (2931 / 80000)

def j0 : Jet := ⟨⟨472070592, 472070593⟩, ⟨157356864, 157356865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1483053503, 1483053507⟩, ⟨494351167, 494351172⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨512098821, 512098825⟩, ⟨341399214, 341399220⟩, ⟨56899868, 56899871⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-11275), (-11274)⟩, ⟨(-7507), (-7505)⟩, ⟨(-1246), (-1243)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101781, 5101783⟩, ⟨(-7507), (-7505)⟩, ⟨(-1246), (-1243)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨608297, 608298⟩, ⟨404635, 404638⟩, ⟨66842, 66845⟩, ⟨(-200), (-196)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-142557280), (-142557278)⟩, ⟨404635, 404638⟩, ⟨66842, 66845⟩, ⟨(-200), (-196)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16997433), (-16997431)⟩, ⟨(-11283377), (-11283375)⟩, ⟨(-1848472), (-1848468)⟩, ⟨10649, 10652⟩, ⟨866, 870⟩⟩
...
def j19 : Jet := ⟨⟨1414658332, 1414658335⟩, ⟨(-11283377), (-11283375)⟩, ⟨(-1848472), (-1848468)⟩, ⟨10649, 10652⟩, ⟨866, 870⟩⟩
...
def j25 : Jet := ⟨⟨1409, 1410⟩, ⟨937, 940⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850768), (-850766)⟩, ⟨937, 940⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-101440), (-101438)⟩, ⟨(-67516), (-67512)⟩, ⟨(-11180), (-11176)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35689954, 35689957⟩, ⟨(-67516), (-67512)⟩, ⟨(-11180), (-11176)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4255395, 4255396⟩, ⟨2828879, 2828882⟩, ⟨466120, 466124⟩, ⟨(-1782), (-1778)⟩, ⟨(-148), (-144)⟩⟩
...
def j33 : Jet := ⟨⟨(-711572488), (-711572486)⟩, ⟨2828879, 2828882⟩, ⟨466120, 466124⟩, ⟨(-1782), (-1778)⟩, ⟨(-148), (-144)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-84842424), (-84842422)⟩, ⟨(-56224324), (-56224320)⟩, ⟨(-9146499), (-9146494)⟩, ⟨74315, 74319⟩, ⟨6015, 6018⟩⟩
...
def j36 : Jet := ⟨⟨4210124872, 4210124874⟩, ⟨(-56224324), (-56224320)⟩, ⟨(-9146499), (-9146494)⟩, ⟨74315, 74319⟩, ⟨6015, 6018⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨488481948, 488481952⟩, ⟨158931162, 158931167⟩, ⟨(-1936996), (-1936993)⟩, ⟨(-209083), (-209079)⟩, ⟨1524, 1528⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4381519462, 4381519465⟩, ⟨58513217, 58513223⟩, ⟨10300265, 10300273⟩, ⟨187329, 187337⟩, ⟨17581, 17589⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨498325834, 498325839⟩, ⟨168788858, 168788866⟩, ⟨1360679, 1360686⟩, ⟨162770, 162779⟩, ⟨2989, 3000⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-472070593), (-472070592)⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3822896703, 3822896704⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨57818516, 57818518⟩, ⟨39167630, 39167634⟩, ⟨6949016, 6949021⟩, ⟨144716, 144722⟩, ⟨13915, 13926⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4352785812, 4352785814⟩, ⟨39167630, 39167634⟩, ⟨6949016, 6949021⟩, ⟨144716, 144722⟩, ⟨13915, 13926⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4323779909, 4323779911⟩, ⟨19453313, 19453316⟩, ⟨3407592, 3407596⟩, ⟨56543, 56548⟩, ⟨5312, 5320⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3848542449, 3848542453⟩, ⟨(-141097338), (-141097332)⟩, ⟨2320334, 2320339⟩, ⟨(-74518), (-74512)⟩, ⟨2656, 2665⟩⟩
...
def j47 : Jet := ⟨⟨4688134359, 4688134371⟩, ⟨1562711453, 1562711464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5117292461, 5117292489⟩, ⟨3411528306, 3411528342⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5117292461, 5117292489⟩, ⟨3411528306, 3411528342⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5117292489), (-5117292461)⟩, ⟨(-3411528342), (-3411528306)⟩, ⟨(-568588060), (-568588051)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2558646245), (-2558646230)⟩, ⟨(-1705764171), (-1705764153)⟩, ⟨(-284294030), (-284294025)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2367211515, 2367211534⟩, ⟨(-940147932), (-940147914)⟩, ⟨30000507, 30000518⟩, ⟨37515462, 37515467⟩, ⟨(-4717759), (-4717757)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2121160272, 2121160293⟩, ⟨(-920194779), (-920194756)⟩, ⟨59046619, 59046637⟩, ⟨32081497, 32081511⟩, ⟨(-5425860), (-5425846)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨314713728, 629427458⟩, ⟨157356864, 157356865⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨988702335, 1977404679⟩, ⟨494351167, 494351172⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨227599476, 910397914⟩, ⟨227599476, 455198960⟩, ⟨56899868, 56899871⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨56, 229⟩, ⟨56, 115⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94631), (-94457)⟩, ⟨56, 115⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-20059), (-5005)⟩, ⟨(-10028), (-4980)⟩, ⟨(-1252), (-1234)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092997, 5108052⟩, ⟨(-10028), (-4980)⟩, ⟨(-1252), (-1234)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨269888, 1082747⟩, ⟨267762, 541111⟩, ⟨66143, 67344⟩, ⟨(-266), (-129)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142895689), (-142082829)⟩, ⟨267762, 541111⟩, ⟨66143, 67344⟩, ⟨(-266), (-129)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-30289390), (-7529272)⟩, ⟨(-15130506), (-7414573)⟩, ⟨(-1875393), (-1810692)⟩, ⟨6995, 14301⟩, ⟨843, 887⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1401366375, 1424126494⟩, ⟨(-15130506), (-7414573)⟩, ⟨(-1875393), (-1810692)⟩, ⟨6995, 14301⟩, ⟨843, 887⟩⟩
...
def j72 : Jet := ⟨⟨625, 2508⟩, ⟨622, 1254⟩, ⟨153, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851552), (-849668)⟩, ⟨622, 1254⟩, ⟨153, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-180503), (-45025)⟩, ⟨(-90220), (-44759)⟩, ⟨(-11242), (-11089)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35610891, 35746370⟩, ⟨(-90220), (-44759)⟩, ⟨(-11242), (-11089)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1887097, 7577106⟩, ⟨1867973, 3786182⟩, ⟨459829, 470612⟩, ⟨(-2388), (-1171)⟩, ⟨(-149), (-141)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713940786), (-708250776)⟩, ⟨1867973, 3786182⟩, ⟨459829, 470612⟩, ⟨(-2388), (-1171)⟩, ⟨(-149), (-141)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-151332981), (-37531718)⟩, ⟨(-75567504), (-36729166)⟩, ⟨(-9334958), (-8881898)⟩, ⟨48606, 99976⟩, ⟨5805, 6166⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4143634315, 4257435578⟩, ⟨(-75567504), (-36729166)⟩, ⟨(-9334958), (-8881898)⟩, ⟨48606, 99976⟩, ⟨5805, 6166⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨322594821, 655668414⟩, ⟨154331318, 162210269⟩, ⟨(-2604955), (-1270239)⟩, ⟨(-214248), (-201825)⟩, ⟨999, 2056⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4332829877, 4451827230⟩, ⟨37379596, 81188023⟩, ⟨9361661, 11509897⟩, ⟨54202, 341987⟩, ⟨11641, 25661⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨325438677, 679614605⟩, ⟨158499415, 180528620⟩, ⟨(-653777), 3541933⟩, ⟨69149, 272250⟩, ⟨(-7203), 14443⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-629427458), (-314713728)⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3665539838, 3980253568⟩, ⟨(-157356865), (-157356864)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨24659170, 107538890⟩, ⟨24019664, 57131932⟩, ⟨5642284, 8709005⟩, ⟨(-44482), 383914⟩, ⟨2282, 30381⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4319626466, 4402506186⟩, ⟨24019664, 57131932⟩, ⟨5642284, 8709005⟩, ⟨(-44482), 383914⟩, ⟨2282, 30381⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307279234, 4348404316⟩, ⟨11862244, 28484313⟩, ⟨2693179, 4325722⟩, ⟨(-50785), 183992⟩, ⟨(-2253), 14642⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3676047461, 4029774991⟩, ⟨(-149190832), (-131410817)⟩, ⟨1254898, 3574153⟩, ⟨(-205548), 71839⟩, ⟨(-8830), 15431⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3125422906, 6250845834⟩, ⟨1562711453, 1562711464⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2274352205, 9097408886⟩, ⟨2274352204, 4548704460⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2274352205, 9097408886⟩, ⟨2274352204, 4548704460⟩, ⟨568588051, 568588060⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-9097408886), (-2274352205)⟩, ⟨(-4548704460), (-2274352204)⟩, ⟨(-568588060), (-568588051)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4548704443), (-1137176102)⟩, ⟨(-2274352230), (-1137176102)⟩, ⟨(-284294030), (-284294025)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1489389274, 3295884264⟩, ⟨(-1745298907), (-394344769)⟩, ⟨(-165957142), 363515635⟩, ⟨(-46763482), 106310559⟩, ⟨(-26104874), 11683319⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1274763061, 3092380236⟩, ⟨(-1752022097), (-383088352)⟩, ⟨(-143209414), 404438193⟩, ⟨(-58113352), 105451056⟩, ⟨(-28359931), 12984197⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨472070592, 472070593⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4323779909, 4323779911⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2076
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨314713728, 629427458⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307279234, 4348404316⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2077
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (78530259 / 2147483648)

theorem envelope_integral : (∫ s in ((2931 / 40000) : ℝ)..(2931 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((2931 / 40000) : ℝ)..(2931 / 20000), prawitzNormalCorrection
