...
namespace FiniteNormalPanel86_13
...
def j2 : Jet := ⟨⟨508974248, 508974252⟩, ⟨508974248, 508974252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨60315892, 60315894⟩, ⟨120631784, 120631788⟩, ⟨60315892, 60315894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1330), (-1329)⟩, ⟨(-2660), (-2657)⟩, ⟨(-1330), (-1327)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111726, 5111728⟩, ⟨(-2660), (-2657)⟩, ⟨(-1330), (-1327)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨71785, 71786⟩, ⟨143533, 143535⟩, ⟨71691, 71694⟩, ⟨(-76), (-73)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-143093792), (-143093790)⟩, ⟨143533, 143535⟩, ⟨71691, 71694⟩, ⟨(-76), (-73)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2009522), (-2009521)⟩, ⟨(-4017029), (-4017027)⟩, ⟨(-2004485), (-2004482)⟩, ⟨4026, 4029⟩, ⟨1002, 1005⟩⟩
...
def j19 : Jet := ⟨⟨1429646243, 1429646245⟩, ⟨(-4017029), (-4017027)⟩, ⟨(-2004485), (-2004482)⟩, ⟨4026, 4029⟩, ⟨1002, 1005⟩⟩
...
def j25 : Jet := ⟨⟨166, 167⟩, ⟨331, 333⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852011), (-852009)⟩, ⟨331, 333⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11966), (-11965)⟩, ⟨(-23927), (-23925)⟩, ⟨(-11955), (-11952)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779428, 35779430⟩, ⟨(-23927), (-23925)⟩, ⟨(-11955), (-11952)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨502464, 502465⟩, ⟨1004591, 1004594⟩, ⟨501623, 501627⟩, ⟨(-673), (-669)⟩, ⟨(-168), (-165)⟩⟩
...
def j33 : Jet := ⟨⟨(-715325419), (-715325417)⟩, ⟨1004591, 1004594⟩, ⟨501623, 501627⟩, ⟨(-673), (-669)⟩, ⟨(-168), (-165)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10045593), (-10045592)⟩, ⟨(-20077079), (-20077076)⟩, ⟨(-10010334), (-10010331)⟩, ⟨28185, 28189⟩, ⟨7022, 7025⟩⟩
...
def j36 : Jet := ⟨⟨4284921703, 4284921704⟩, ⟨(-20077079), (-20077076)⟩, ⟨(-10010334), (-10010331)⟩, ⟨28185, 28189⟩, ⟨7022, 7025⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨169419944, 169419947⟩, ⟨168943906, 168943911⟩, ⟨(-713580), (-713576)⟩, ⟨(-237065), (-237062)⟩, ⟨595, 598⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305036438, 4305036440⟩, ⟨20171323, 20171328⟩, ⟨10151835, 10151841⟩, ⟨66367, 66375⟩, ⟨16835, 16843⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨169817132, 169817137⟩, ⟨170135659, 170135666⟩, ⟨478642, 478650⟩, ⟨160969, 160977⟩, ⟨1069, 1077⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-162011536), (-162011535)⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4132955760, 4132955761⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6714337, 6714338⟩, ⟨13453862, 13453864⟩, ⟨6777396, 6777402⟩, ⟨50648, 50652⟩, ⟨12889, 12894⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301681633, 4301681634⟩, ⟨13453862, 13453864⟩, ⟨6777396, 6777402⟩, ⟨50648, 50652⟩, ⟨12889, 12894⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298323153, 4298323154⟩, ⟨6721679, 6721681⟩, ⟨3380796, 3380800⟩, ⟨20017, 20021⟩, ⟨5077, 5082⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4136185029, 4136185032⟩, ⟨(-155669996), (-155669991)⟩, ⟨2999717, 2999722⟩, ⟨(-108268), (-108261)⟩, ⟨4129, 4136⟩⟩
...
def j47 : Jet := ⟨⟨1395104009, 1395104019⟩, ⟨1395104009, 1395104019⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨453161819, 453161827⟩, ⟨906323638, 906323654⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨453161819, 453161827⟩, ⟨906323638, 906323654⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-453161827), (-453161819)⟩, ⟨(-906323654), (-906323638)⟩, ⟨(-453161827), (-453161819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-226580914), (-226580909)⟩, ⟨(-453161827), (-453161819)⟩, ⟨(-226580914), (-226580909)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4074259290, 4074259296⟩, ⟨(-429874935), (-429874926)⟩, ⟨(-192259426), (-192259418)⟩, ⟨21880456, 21880458⟩, ⟨4494169, 4494170⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3923636460, 3923636470⟩, ⟨(-561653218), (-561653202)⟩, ⟨(-166725441), (-166725425)⟩, ⟨27637000, 27637014⟩, ⟨3415441, 3415456⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 324023071⟩, ⟨162011535, 162011536⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1017948500⟩, ⟨508974248, 508974252⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 241263572⟩, ⟨0, 241263574⟩, ⟨60315892, 60315894⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5319), 0⟩, ⟨(-5319), 4⟩, ⟨(-1330), (-1323)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107737, 5113057⟩, ⟨(-5319), 4⟩, ⟨(-1330), (-1323)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 287219⟩, ⟨(-299), 287220⟩, ⟨71355, 71806⟩, ⟨(-150), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142878357)⟩, ⟨(-299), 287220⟩, ⟨71355, 71806⟩, ⟨(-150), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8042120), 0⟩, ⟨(-8042137), 16135⟩, ⟨(-2010547), (-1986327)⟩, ⟨(-14), 8069⟩, ⟨991, 1010⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423613645, 1431655766⟩, ⟨(-8042137), 16135⟩, ⟨(-2010547), (-1986327)⟩, ⟨(-14), 8069⟩, ⟨991, 1010⟩⟩
...
def j72 : Jet := ⟨⟨0, 665⟩, ⟨(-1), 665⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851511)⟩, ⟨(-1), 665⟩, ⟨164, 167⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-47870), 0⟩, ⟨(-47871), 38⟩, ⟨(-11969), (-11910)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35743524, 35791395⟩, ⟨(-47871), 38⟩, ⟨(-11969), (-11910)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2010530⟩, ⟨(-2690), 2010533⟩, ⟨498597, 502636⟩, ⟨(-1347), 3⟩, ⟨(-170), (-164)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713817352)⟩, ⟨(-2690), 2010533⟩, ⟨498597, 502636⟩, ⟨(-1347), 3⟩, ⟨(-170), (-164)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-40210596), 0⟩, ⟨(-40210748), 112939⟩, ⟨(-10052802), (-9883240)⟩, ⟨(-114), 56471⟩, ⟨6915, 7060⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4254756700, 4294967296⟩, ⟨(-40210748), 112939⟩, ⟨(-10052802), (-9883240)⟩, ⟨(-114), 56471⟩, ⟨6915, 7060⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 339316167⟩, ⟨166798988, 169661910⟩, ⟨(-1429551), 1913⟩, ⟨(-238264), (-233476)⟩, ⟨(-2), 1197⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4335557912⟩, ⟨(-115085), 40974383⟩, ⟨9882162, 10630954⟩, ⟨(-58099), 197401⟩, ⟨14530, 20007⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 342522956⟩, ⟨166789895, 174502449⟩, ⟨(-1447609), 2460403⟩, ⟨125036, 202109⟩, ⟨(-8112), 10600⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-324023071), 0⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3970944225, 4294967296⟩, ⟨(-162011536), (-162011535)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 27316152⟩, ⟨0, 27833086⟩, ⟨6246191, 7482385⟩, ⟨(-117632), 232168⟩, ⟨7586, 19526⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4322283448⟩, ⟨0, 27833086⟩, ⟨6246191, 7482385⟩, ⟨(-117632), 232168⟩, ⟨7586, 19526⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4308603725⟩, ⟨0, 13916543⟩, ⟨3090735, 3741193⟩, ⟨(-70939), 116084⟩, ⟨1780, 8881⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3970944225, 4308603725⟩, ⟨(-162525920), (-148094992)⟩, ⟨2332612, 3741193⟩, ⟨(-212062), (-502)⟩, ⟨(-2734), 11557⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2790208028⟩, ⟨1395104009, 1395104019⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1812647293⟩, ⟨0, 1812647300⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1812647293⟩, ⟨0, 1812647300⟩, ⟨453161819, 453161827⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1812647293), 0⟩, ⟨(-1812647300), 0⟩, ⟨(-453161827), (-453161819)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-906323647), 0⟩, ⟨(-906323650), 0⟩, ⟨(-226580914), (-226580909)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3477883859, 4294967296⟩, ⟨(-906323650), 0⟩, ⟨(-226580914), (-87849517)⟩, ⟨0, 47813087⟩, ⟨(-205129), 5976636⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3215503605, 4308603725⟩, ⟨(-1071727129), (-119921095)⟩, ⟨(-225411453), (-43184529)⟩, ⟨2027614, 56538539⟩, ⟨(-2215178), 6004208⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298323153, 4298323154⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1740
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4308603725⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1741
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (72976703 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(30177 / 400000), prawitzNormalCorrection
