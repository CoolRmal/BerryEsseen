...
namespace FiniteNormalPanel134_13

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (48223 / 200000)
def radius : Rat := (6889 / 200000)

def j0 : Jet := ⟨⟨1035581039, 1035581040⟩, ⟨147940148, 147940149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3253373784, 3253373788⟩, ⟨464767682, 464767686⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2464382205, 2464382212⟩, ⟨704109198, 704109208⟩, ⟨50293514, 50293515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨616, 618⟩, ⟨176, 177⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94071), (-94068)⟩, ⟨176, 177⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-53977), (-53974)⟩, ⟨(-15322), (-15319)⟩, ⟨(-1068), (-1063)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5059079, 5059083⟩, ⟨(-15322), (-15319)⟩, ⟨(-1068), (-1063)⟩, ⟨3, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2902817, 2902820⟩, ⟨820584, 820588⟩, ⟨56116, 56122⟩, ⟨(-355), (-349)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-140262760), (-140262756)⟩, ⟨820584, 820588⟩, ⟨56116, 56122⟩, ⟨(-355), (-349)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-80480485), (-80480482)⟩, ⟨(-22523588), (-22523582)⟩, ⟨(-1475736), (-1475730)⟩, ⟨18603, 18610⟩, ⟨590, 596⟩⟩
...
def j19 : Jet := ⟨⟨1351175280, 1351175284⟩, ⟨(-22523588), (-22523582)⟩, ⟨(-1475736), (-1475730)⟩, ⟨18603, 18610⟩, ⟨590, 596⟩⟩
...
def j25 : Jet := ⟨⟨6755, 6757⟩, ⟨1919, 1922⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845422), (-845419)⟩, ⟨1919, 1922⟩, ⟨132, 136⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-485090), (-485087)⟩, ⟨(-137496), (-137493)⟩, ⟨(-9511), (-9504)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35306304, 35306308⟩, ⟨(-137496), (-137493)⟩, ⟨(-9511), (-9504)⟩, ⟨41, 46⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20258181, 20258184⟩, ⟨5709158, 5709162⟩, ⟨385433, 385440⟩, ⟨(-3148), (-3141)⟩, ⟨(-107), (-101)⟩⟩
...
def j33 : Jet := ⟨⟨(-695569702), (-695569698)⟩, ⟨5709158, 5709162⟩, ⟨385433, 385440⟩, ⟨(-3148), (-3141)⟩, ⟨(-107), (-101)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-399106555), (-399106551)⟩, ⟨(-110754624), (-110754617)⟩, ⟨(-6987928), (-6987921)⟩, ⟨128233, 128241⟩, ⟨3934, 3943⟩⟩
...
def j36 : Jet := ⟨⟨3895860741, 3895860745⟩, ⟨(-110754624), (-110754617)⟩, ⟨(-6987928), (-6987921)⟩, ⟨128233, 128241⟩, ⟨3934, 3943⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1023495158, 1023495163⟩, ⟨129152310, 129152318⟩, ⟨(-3555176), (-3555168)⟩, ⟨(-145602), (-145594)⟩, ⟨2459, 2466⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4734959815, 4734959821⟩, ⟨134609190, 134609201⟩, ⟨12319770, 12319782⟩, ⟨435818, 435833⟩, ⟨25262, 25278⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1128345831, 1128345839⟩, ⟨174460664, 174460678⟩, ⟨3064212, 3064227⟩, ⟨202375, 202392⟩, ⟨7072, 7089⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1035581040), (-1035581039)⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3259386256, 3259386257⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨296431666, 296431671⟩, ⟨91666338, 91666348⟩, ⟨8696573, 8696585⟩, ⟨355266, 355282⟩, ⟨22340, 22357⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4591398962, 4591398967⟩, ⟨91666338, 91666348⟩, ⟨8696573, 8696585⟩, ⟨355266, 355282⟩, ⟨22340, 22357⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4440710346, 4440710350⟩, ⟨44328935, 44328941⟩, ⟨3984321, 3984329⟩, ⟨132029, 132039⟩, ⟨7697, 7707⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3369988470, 3369988475⟩, ⟨(-119319706), (-119319698)⟩, ⟨1496730, 1496738⟩, ⟨(-37047), (-37036)⟩, ⟨1292, 1302⟩⟩
...
def j47 : Jet := ⟨⟨9720800521, 9720800533⟩, ⟨1388685784, 1388685795⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨22001090172, 22001090228⟩, ⟨6286025742, 6286025800⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨22001090172, 22001090228⟩, ⟨6286025742, 6286025800⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-22001090228), (-22001090172)⟩, ⟨(-6286025800), (-6286025742)⟩, ⟨(-449001845), (-449001837)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11000545114), (-11000545086)⟩, ⟨(-3143012900), (-3143012871)⟩, ⟨(-224500923), (-224500918)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨331601919, 331601928⟩, ⟨(-242662881), (-242662872)⟩, ⟨71456032, 71456039⟩, ⟨(-8974161), (-8974157)⟩, ⟨(-225730), (-225728)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨260186997, 260187005⟩, ⟨(-199614503), (-199614493)⟩, ⟨62924059, 62924069⟩, ⟨(-9114023), (-9114014)⟩, ⟨99288, 99297⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨887640891, 1183521189⟩, ⟨147940148, 147940149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2788606102, 3718141473⟩, ⟨464767682, 464767686⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1810566520, 3218784932⟩, ⟨603522170, 804696238⟩, ⟨50293514, 50293515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨453, 807⟩, ⟨151, 202⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94234), (-93879)⟩, ⟨151, 202⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-70622), (-39575)⟩, ⟨(-17593), (-13039)⟩, ⟨(-1078), (-1051)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5042434, 5073482⟩, ⟨(-17593), (-13039)⟩, ⟨(-1078), (-1051)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2125665, 3802229⟩, ⟨695370, 945062⟩, ⟨54941, 57135⟩, ⟨(-409), (-294)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141039912), (-139363347)⟩, ⟨695370, 945062⟩, ⟨54941, 57135⟩, ⟨(-409), (-294)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-105699791), (-58749367)⟩, ⟨(-26131812), (-18874862)⟩, ⟨(-1530688), (-1412042)⟩, ⟨15555, 21649⟩, ⟨556, 626⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1325955974, 1372906399⟩, ⟨(-26131812), (-18874862)⟩, ⟨(-1530688), (-1412042)⟩, ⟨15555, 21649⟩, ⟨556, 626⟩⟩
...
def j70 : Jet := ⟨⟨(-81), (-45)⟩, ⟨(-21), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11754, 11791⟩, ⟨(-21), (-15)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4954, 8837⟩, ⟨1635, 2204⟩, ⟨131, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847223), (-843339)⟩, ⟨1635, 2204⟩, ⟨131, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-634936), (-355514)⟩, ⟨(-158045), (-116852)⟩, ⟨(-9637), (-9359)⟩, ⟨35, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35156458, 35435881⟩, ⟨(-158045), (-116852)⟩, ⟨(-9637), (-9359)⟩, ⟨35, 52⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14820393, 26556775⟩, ⟨4821687, 6589935⟩, ⟨374843, 394586⟩, ⟨(-3643), (-2644)⟩, ⟨(-110), (-97)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701007490), (-689271107)⟩, ⟨4821687, 6589935⟩, ⟨374843, 394586⟩, ⟨(-3643), (-2644)⟩, ⟨(-110), (-97)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-525357283), (-290565935)⟩, ⟨(-129306714), (-91916604)⟩, ⟨(-7373155), (-6540882)⟩, ⟨106402, 149983⟩, ⟨3623, 4210⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3769610013, 4004401361⟩, ⟨(-129306714), (-91916604)⟩, ⟨(-7373155), (-6540882)⟩, ⟨106402, 149983⟩, ⟨3623, 4210⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨860907351, 1188521325⟩, ⟨120862319, 136310230⟩, ⟨(-4152893), (-2959289)⟩, ⟨(-155541), (-134058)⟩, ⟨2043, 2885⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4606617172, 4893541775⟩, ⟨105739801, 167860285⟩, ⟨9951694, 15329519⟩, ⟨217861, 724141⟩, ⟨9822, 47415⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨923376201, 1354161360⟩, ⟨150827366, 201758309⟩, ⟨238670, 6395446⟩, ⟨(-15813), 470263⟩, ⟨(-10614), 29236⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1183521189), (-887640891)⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3111446107, 3407326405⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨198516903, 426953889⟩, ⟨64852832, 127224860⟩, ⟨5399261, 13510545⟩, ⟨6790, 897400⟩, ⟨(-8167), 72142⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4493484199, 4721921185⟩, ⟨64852832, 127224860⟩, ⟨5399261, 13510545⟩, ⟨6790, 897400⟩, ⟨(-8167), 72142⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4393104560, 4503387288⟩, ⟨30925698, 62191397⟩, ⟨2145260, 6495516⟩, ⟨(-88636), 423576⟩, ⟨(-14792), 35997⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3182540666, 3572672238⟩, ⟨(-132715364), (-101982185)⟩, ⟨(-588071), 4087853⟩, ⟨(-294057), 262143⟩, ⟨(-26326), 31612⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8332114736, 11109486328⟩, ⟨1388685784, 1388685795⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨16164066263, 28736117872⟩, ⟨5388022066, 7184029490⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨16164066263, 28736117872⟩, ⟨5388022066, 7184029490⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-28736117872), (-16164066263)⟩, ⟨(-7184029490), (-5388022066)⟩, ⟨(-449001845), (-449001837)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-14368058936), (-8082033131)⟩, ⟨(-3592014745), (-2694011033)⟩, ⟨(-224500923), (-224500918)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨151392348, 654226910⟩, ⟨(-547150315), (-94960596)⟩, ⟨(-4414958), 220886032⟩, ⟨(-58268850), 20297407⟩, ⟨(-10016772), 12298400⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨112180668, 544203986⟩, ⟨(-475350466), (-73959883)⟩, ⟨(-1507263), 201268829⟩, ⟨(-55860619), 17135215⟩, ⟨(-9027074), 12283181⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1035581039, 1035581040⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4440710346, 4440710350⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2700
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨887640891, 1183521189⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4393104560, 4503387288⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2701
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (19538467 / 4294967296)

theorem envelope_integral : (∫ s in ((20667 / 100000) : ℝ)..(6889 / 25000),
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((20667 / 100000) : ℝ)..(6889 / 25000), prawitzNormalCorrection
