...
namespace FiniteNormalPanel129_3

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (31861 / 400000)
def radius : Rat := (31861 / 400000)

def j0 : Jet := ⟨⟨342104882, 342104883⟩, ⟨342104882, 342104883⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1074754184, 1074754188⟩, ⟨1074754184, 1074754188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨268941874, 268941877⟩, ⟨537883748, 537883754⟩, ⟨268941874, 268941877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨67, 68⟩, ⟨134, 135⟩, ⟨67, 68⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94620), (-94618)⟩, ⟨134, 135⟩, ⟨67, 68⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-5925), (-5924)⟩, ⟨(-11842), (-11840)⟩, ⟨(-5905), (-5902)⟩, ⟨16, 18⟩, ⟨4, 5⟩⟩
...
def j13 : Jet := ⟨⟨5107131, 5107133⟩, ⟨(-11842), (-11840)⟩, ⟨(-5905), (-5902)⟩, ⟨16, 18⟩, ⟨4, 5⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨319797, 319798⟩, ⟨638853, 638855⟩, ⟨317943, 317947⟩, ⟨(-1481), (-1478)⟩, ⟨(-368), (-365)⟩⟩
...
def j16 : Jet := ⟨⟨(-142845780), (-142845778)⟩, ⟨638853, 638855⟩, ⟨317943, 317947⟩, ⟨(-1481), (-1478)⟩, ⟨(-368), (-365)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-8944705), (-8944704)⟩, ⟨(-17849406), (-17849404)⟩, ⟨(-8844790), (-8844786)⟩, ⟨79727, 79731⟩, ⟨19698, 19703⟩⟩
...
def j19 : Jet := ⟨⟨1422711060, 1422711062⟩, ⟨(-17849406), (-17849404)⟩, ⟨(-8844790), (-8844786)⟩, ⟨79727, 79731⟩, ⟨19698, 19703⟩⟩
...
def j22 : Jet := ⟨⟨(-7), (-6)⟩, ⟨(-14), (-13)⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11828, 11830⟩, ⟨(-14), (-13)⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨740, 741⟩, ⟨1480, 1482⟩, ⟨737, 740⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851437), (-851435)⟩, ⟨1480, 1482⟩, ⟨737, 740⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-53316), (-53315)⟩, ⟨(-106539), (-106537)⟩, ⟨(-53085), (-53082)⟩, ⟨183, 186⟩, ⟨44, 47⟩⟩
...
def j30 : Jet := ⟨⟨35738078, 35738080⟩, ⟨(-106539), (-106537)⟩, ⟨(-53085), (-53082)⟩, ⟨183, 186⟩, ⟨44, 47⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2237843, 2237844⟩, ⟨4469015, 4469017⟩, ⟨2221175, 2221179⟩, ⟨(-13310), (-13306)⟩, ⟨(-3301), (-3296)⟩⟩
...
def j33 : Jet := ⟨⟨(-713590040), (-713590038)⟩, ⟨4469015, 4469017⟩, ⟨2221175, 2221179⟩, ⟨(-13310), (-13306)⟩, ⟨(-3301), (-3296)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-44683518), (-44683516)⟩, ⟨(-89087195), (-89087192)⟩, ⟨(-43984753), (-43984748)⟩, ⟨557176, 557180⟩, ⟨137211, 137214⟩⟩
...
def j36 : Jet := ⟨⟨4250283778, 4250283780⟩, ⟨(-89087195), (-89087192)⟩, ⟨(-43984753), (-43984748)⟩, ⟨557176, 557180⟩, ⟨137211, 137214⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨356013109, 356013112⟩, ⟨351546550, 351546554⟩, ⟨(-6679842), (-6679839)⟩, ⟨(-2193333), (-2193329)⟩, ⟨24879, 24883⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4340120572, 4340120575⟩, ⟨90970196, 90970201⟩, ⟨46821199, 46821207⟩, ⟨1353847, 1353856⟩, ⟨360871, 360879⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨359755898, 359755902⟩, ⟨362782970, 362782977⟩, ⟨4576960, 4576967⟩, ⟨1586698, 1586707⟩, ⟨46588, 46599⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-342104883), (-342104882)⟩, ⟨(-342104883), (-342104882)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3952862413, 3952862414⟩, ⟨(-342104883), (-342104882)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨30133944, 30133946⟩, ⟨60774996, 60775000⟩, ⟨31409938, 31409942⟩, ⟨1039014, 1039020⟩, ⟨280727, 280736⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4325101240, 4325101242⟩, ⟨60774996, 60775000⟩, ⟨31409938, 31409942⟩, ⟨1039014, 1039020⟩, ⟨280727, 280736⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4310007932, 4310007934⟩, ⟨30281454, 30281457⟩, ⟨15543786, 15543790⟩, ⟨408485, 408490⟩, ⟨108973, 108980⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3966705024, 3966705028⟩, ⟨(-315433448), (-315433442)⟩, ⟨11893690, 11893696⟩, ⟨(-862154), (-862148)⟩, ⟨67755, 67764⟩⟩
...
def j47 : Jet := ⟨⟨2376070824, 2376070832⟩, ⟨2376070824, 2376070832⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1314494889, 1314494899⟩, ⟨2628989778, 2628989798⟩, ⟨1314494889, 1314494899⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1314494889, 1314494899⟩, ⟨2628989778, 2628989798⟩, ⟨1314494889, 1314494899⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1314494899), (-1314494889)⟩, ⟨(-2628989798), (-2628989778)⟩, ⟨(-1314494899), (-1314494889)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-657247450), (-657247444)⟩, ⟨(-1314494899), (-1314494889)⟩, ⟨(-657247450), (-657247444)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3685538299, 3685538308⟩, ⟨(-1127976297), (-1127976285)⟩, ⟨(-391376933), (-391376922)⟩, ⟨155001725, 155001730⟩, ⟨18085933, 18085936⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3403854390, 3403854403⟩, ⟨(-1312441032), (-1312441012)⟩, ⟨(-268416657), (-268416636)⟩, ⟨168035313, 168035329⟩, ⟨4520662, 4520680⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 684209766⟩, ⟨342104882, 342104883⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2149508375⟩, ⟨1074754184, 1074754188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1075767506⟩, ⟨0, 1075767506⟩, ⟨268941874, 268941877⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 270⟩, ⟨0, 270⟩, ⟨67, 68⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94416)⟩, ⟨0, 270⟩, ⟨67, 68⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-23717), 0⟩, ⟨(-23717), 68⟩, ⟨(-5930), (-5826)⟩, ⟨0, 35⟩, ⟨4, 5⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5089339, 5113057⟩, ⟨(-23717), 68⟩, ⟨(-5930), (-5826)⟩, ⟨0, 35⟩, ⟨4, 5⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1280676⟩, ⟨(-5941), 1280694⟩, ⟨311256, 320187⟩, ⟨(-2972), 14⟩, ⟨(-372), (-353)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141884900)⟩, ⟨(-5941), 1280694⟩, ⟨311256, 320187⟩, ⟨(-2972), 14⟩, ⟨(-372), (-353)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-35858917), 0⟩, ⟨(-35860406), 320778⟩, ⟨(-8966219), (-8483559)⟩, ⟨(-1118), 160397⟩, ⟨18651, 20054⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1395796848, 1431655766⟩, ⟨(-35860406), 320778⟩, ⟨(-8966219), (-8483559)⟩, ⟨(-1118), 160397⟩, ⟨18651, 20054⟩⟩
...
def j70 : Jet := ⟨⟨(-28), 0⟩, ⟨(-28), 0⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11807, 11836⟩, ⟨(-28), 0⟩, ⟨(-7), (-6)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 2965⟩, ⟨(-8), 2965⟩, ⟨729, 742⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-849211)⟩, ⟨(-8), 2965⟩, ⟨729, 742⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-213447), 0⟩, ⟨(-213450), 743⟩, ⟨(-53365), (-52246)⟩, ⟨(-3), 372⟩, ⟨42, 47⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35577947, 35791395⟩, ⟨(-213450), 743⟩, ⟨(-53365), (-52246)⟩, ⟨(-3), 372⟩, ⟨42, 47⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 8964730⟩, ⟨(-53464), 8964917⟩, ⟨2160985, 2241370⟩, ⟨(-26734), 141⟩, ⟨(-3343), (-3165)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-706863152)⟩, ⟨(-53464), 8964917⟩, ⟨2160985, 2241370⟩, ⟨(-26734), 141⟩, ⟨(-3343), (-3165)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-179294585), 0⟩, ⟨(-179307977), 2245458⟩, ⟨(-44837039), (-41455434)⟩, ⟨(-10045), 1122801⟩, ⟨127781, 140386⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4115672711, 4294967296⟩, ⟨(-179307977), 2245458⟩, ⟨(-44837039), (-41455434)⟩, ⟨(-10045), 1122801⟩, ⟨127781, 140386⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 716502793⟩, ⟨331331104, 358411938⟩, ⟨(-13460892), 80271⟩, ⟨(-2244229), (-2042614)⟩, ⟨(-280), 50175⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4482072645⟩, ⟨(-2445362), 195270965⟩, ⟨41353344, 57336074⟩, ⟨(-1280683), 4636232⟩, ⟨148128, 693941⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 747716420⟩, ⟨330923159, 406601592⟩, ⟨(-14251365), 25944013⟩, ⟨22516, 3523140⟩, ⟨(-388899), 557368⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-684209766), 0⟩, ⟨(-342104883), (-342104882)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3610757530, 4294967296⟩, ⟨(-342104883), (-342104882)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 130170921⟩, ⟨0, 141571596⟩, ⟨20535237, 47525947⟩, ⟨(-2698334), 6138902⟩, ⟨(-218027), 1017851⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4425138217⟩, ⟨0, 141571596⟩, ⟨20535237, 47525947⟩, ⟨(-2698334), 6138902⟩, ⟨(-218027), 1017851⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4359566943⟩, ⟨0, 70785798⟩, ⟨9540802, 23762974⟩, ⟨(-1740808), 3069451⟩, ⟨(-225339), 527020⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3610757530, 4359566943⟩, ⟨(-347250407), (-271319084)⟩, ⟨2382638, 23762974⟩, ⟨(-3633589), 2309503⟩, ⟨(-469829), 665680⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4752141664⟩, ⟨2376070824, 2376070832⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 5257979593⟩, ⟨0, 5257979594⟩, ⟨1314494889, 1314494899⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 5257979593⟩, ⟨0, 5257979594⟩, ⟨1314494889, 1314494899⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5257979593), 0⟩, ⟨(-5257979594), 0⟩, ⟨(-1314494899), (-1314494889)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2628989797), 0⟩, ⟨(-2628989797), 0⟩, ⟨(-657247450), (-657247444)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2328756775, 4294967296⟩, ⟨(-2628989797), 0⟩, ⟨(-657247450), 448251200⟩, ⟨(-91459590), 402307334⟩, ⟨(-95861370), 64284236⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1957774176, 4359566943⟩, ⟨(-3015782255), (-147110818)⟩, ⟨(-665841083), 691311455⟩, ⟨(-147255693), 463806662⟩, ⟨(-135349847), 78015574⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨342104882, 342104883⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨342104882, 342104883⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4310007932, 4310007934⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2590
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 684209766⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4359566943⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2591
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (265241655 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(31861 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(31861 / 200000), prawitzNormalCorrection
