...
namespace FiniteNormalPanel1_6
...
def j0 : Jet := ⟨⟨1342177280, 1342177280⟩, ⟨268435456, 268435456⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4216574282, 4216574283⟩, ⟨843314856, 843314857⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4139612120, 4139612123⟩, ⟨1655844846, 1655844850⟩, ⟨165584484, 165584486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1036, 1038⟩, ⟨414, 415⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93651), (-93648)⟩, ⟨414, 415⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-90264), (-90260)⟩, ⟨(-35707), (-35704)⟩, ⟨(-3413), (-3409)⟩, ⟨30, 33⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5022792, 5022797⟩, ⟨(-35707), (-35704)⟩, ⟨(-3413), (-3409)⟩, ⟨30, 33⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4841110, 4841116⟩, ⟨1902028, 1902035⟩, ⟨176587, 176595⟩, ⟨(-2665), (-2658)⟩, ⟨(-121), (-116)⟩⟩
...
def j16 : Jet := ⟨⟨(-138324467), (-138324460)⟩, ⟨1902028, 1902035⟩, ⟨176587, 176595⟩, ⟨(-2665), (-2658)⟩, ⟨(-121), (-116)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-133321072), (-133321064)⟩, ⟨(-51495201), (-51495189)⟩, ⟨(-4429353), (-4429339)⟩, ⟨138839, 138852⟩, ⟨5662, 5674⟩⟩
...
def j19 : Jet := ⟨⟨1298334693, 1298334702⟩, ⟨(-51495201), (-51495189)⟩, ⟨(-4429353), (-4429339)⟩, ⟨138839, 138852⟩, ⟨5662, 5674⟩⟩
...
def j22 : Jet := ⟨⟨(-105), (-103)⟩, ⟨(-42), (-41)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11730, 11733⟩, ⟨(-42), (-41)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11305, 11309⟩, ⟨4481, 4485⟩, ⟨430, 435⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840872), (-840867)⟩, ⟨4481, 4485⟩, ⟨430, 435⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-810457), (-810451)⟩, ⟨(-319865), (-319857)⟩, ⟨(-30278), (-30268)⟩, ⟨333, 340⟩, ⟨13, 17⟩⟩
...
def j30 : Jet := ⟨⟨34980937, 34980944⟩, ⟨(-319865), (-319857)⟩, ⟨(-30278), (-30268)⟩, ⟨333, 340⟩, ⟨13, 17⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨33715625, 33715633⟩, ⟨13177954, 13177967⟩, ⟨1196123, 1196139⟩, ⟨(-23686), (-23672)⟩, ⟨(-1028), (-1017)⟩⟩
...
def j33 : Jet := ⟨⟨(-682112258), (-682112249)⟩, ⟨13177954, 13177967⟩, ⟨1196123, 1196139⟩, ⟨(-23686), (-23672)⟩, ⟨(-1028), (-1017)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-657439273), (-657439262)⟩, ⟨(-250274421), (-250274403)⟩, ⟨(-20064200), (-20064176)⟩, ⟨946364, 946388⟩, ⟨35991, 36009⟩⟩
...
def j36 : Jet := ⟨⟨3637528023, 3637528034⟩, ⟨(-250274421), (-250274403)⟩, ⟨(-20064200), (-20064176)⟩, ⟨946364, 946388⟩, ⟨35991, 36009⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1274637103, 1274637114⟩, ⟨204372124, 204372140⟩, ⟨(-14459568), (-14459549)⟩, ⟨(-733398), (-733380)⟩, ⟨32818, 32835⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5071230764, 5071230781⟩, ⟨348918066, 348918095⟩, ⟨51979069, 51979109⟩, ⟨4181526, 4181572⟩, ⟨433431, 433467⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1505012365, 1505012384⟩, ⟨344859928, 344859958⟩, ⟨14956054, 14956095⟩, ⟨1673716, 1673759⟩, ⟨131778, 131817⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1342177280), (-1342177280)⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2952790016, 2952790016⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨527375894, 527375908⟩, ⟨241686802, 241686828⟩, ⟨38171758, 38171796⟩, ⟨3574742, 3574784⟩, ⟨413210, 413249⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4822343190, 4822343204⟩, ⟨241686802, 241686828⟩, ⟨38171758, 38171796⟩, ⟨3574742, 3574784⟩, ⟨413210, 413249⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4551022554, 4551022562⟩, ⟨114044359, 114044373⟩, ⟨16583122, 16583142⟩, ⟨1271249, 1271271⟩, ⟨132909, 132931⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3128828005, 3128828012⟩, ⟨(-206033415), (-206033402)⟩, ⟨4273122, 4273139⟩, ⟨(-162464), (-162446)⟩, ⟨11919, 11938⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨12063145795, 12063145796⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value46

def j47 : Jet := ⟨⟨3769733060, 3769733062⟩, ⟨753946612, 753946613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3308730047, 3308730051⟩, ⟨1323492018, 1323492022⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3308730047, 3308730051⟩, ⟨1323492018, 1323492022⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3308730051), (-3308730047)⟩, ⟨(-1323492022), (-1323492018)⟩, ⟨(-132349203), (-132349201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1654365026), (-1654365023)⟩, ⟨(-661746011), (-661746009)⟩, ⟨(-66174602), (-66174600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2921967137, 2921967145⟩, ⟨(-450201357), (-450201353)⟩, ⟨(-10337807), (-10337803)⟩, ⟨5155241, 5155243⟩, ⟨(-118934), (-118933)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2128615185, 2128615197⟩, ⟨(-468135227), (-468135212)⟩, ⟨16972705, 16972723⟩, ⟨3692996, 3693016⟩, ⟨(-319095), (-319075)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1073741824, 1610612736⟩, ⟨268435456, 268435456⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3373259426, 5059889140⟩, ⟨843314856, 843314857⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2649351757, 5961041458⟩, ⟨1324675878, 1987013820⟩, ⟨165584484, 165584486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨663, 1494⟩, ⟨331, 498⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94024), (-93192)⟩, ⟨331, 498⟩, ⟨41, 42⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-130498), (-57485)⟩, ⟨(-43296), (-28050)⟩, ⟨(-3498), (-3302)⟩, ⟨24, 40⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4982558, 5055572⟩, ⟨(-43296), (-28050)⟩, ⟨(-3498), (-3302)⟩, ⟨24, 40⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3073492, 7016695⟩, ⟨1476654, 2321597⟩, ⟨167207, 184222⟩, ⟨(-3275), (-2043)⟩, ⟨(-128), (-105)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140092085), (-136148881)⟩, ⟨1476654, 2321597⟩, ⟨167207, 184222⟩, ⟨(-3275), (-2043)⟩, ⟨(-128), (-105)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-194435643), (-83983474)⟩, ⟨(-63901007), (-38769562)⟩, ⟨(-4842413), (-3919223)⟩, ⟨103953, 173474⟩, ⟨4752, 6409⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1237220122, 1347672292⟩, ⟨(-63901007), (-38769562)⟩, ⟨(-4842413), (-3919223)⟩, ⟨103953, 173474⟩, ⟨4752, 6409⟩⟩
...
def j70 : Jet := ⟨⟨(-150), (-66)⟩, ⟨(-50), (-33)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11685, 11770⟩, ⟨(-50), (-33)⟩, ⟨(-5), (-4)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨7207, 16336⟩, ⟨3533, 5426⟩, ⟨419, 442⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-844970), (-835840)⟩, ⟨3533, 5426⟩, ⟨419, 442⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1172745), (-515588)⟩, ⟨(-388736), (-250263)⟩, ⟨(-31230), (-29099)⟩, ⟨258, 414⟩, ⟨11, 18⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34618649, 35275807⟩, ⟨(-388736), (-250263)⟩, ⟨(-31230), (-29099)⟩, ⟨258, 414⟩, ⟨11, 18⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨21354523, 48959756⟩, ⟨10137729, 16165545⟩, ⟨1111468, 1264858⟩, ⟨(-29277), (-18047)⟩, ⟨(-1120), (-904)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-694473360), (-666868126)⟩, ⟨10137729, 16165545⟩, ⟨1111468, 1264858⟩, ⟨(-29277), (-18047)⟩, ⟨(-1120), (-904)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-963868688), (-411357786)⟩, ⟨(-315036103), (-183242521)⟩, ⟨(-22961792), (-16475556)⟩, ⟨693011, 1197273⟩, ⟨27750, 42642⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3331098608, 3883609510⟩, ⟨(-315036103), (-183242521)⟩, ⟨(-22961792), (-16475556)⟩, ⟨693011, 1197273⟩, ⟨27750, 42642⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨971710411, 1587689015⟩, ⟨167646001, 234165294⟩, ⟨(-18251768), (-10690535)⟩, ⟨(-869162), (-565167)⟩, ⟨24143, 41613⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4749896720, 5537735818⟩, ⟨224117034, 523727130⟩, ⟨30725271, 87703588⟩, ⟨693283, 10916455⟩, ⟨(-69029), 1550777⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1074635445, 2047094127⟩, ⟨236108443, 495524460⟩, ⟨(-7833607), 49151902⟩, ⟨(-1990121), 7634205⟩, ⟨(-450446), 1116126⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1610612736), (-1073741824)⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2684354560, 3221225472⟩, ⟨(-268435456), (-268435456)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨268882452, 975698784⟩, ⟨118152472, 472359924⟩, ⟨5512249, 104024456⟩, ⟨(-3704666), 18618960⟩, ⟨(-978253), 3388016⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4563849748, 5270666080⟩, ⟨118152472, 472359924⟩, ⟨5512249, 104024456⟩, ⟨(-3704666), 18618960⟩, ⟨(-978253), 3388016⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4427367774, 4757871210⟩, ⟨53328577, 229116998⟩, ⟨(-3254719), 50135626⟩, ⟨(-4391466), 9199513⟩, ⟨(-1234445), 1889037⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2767104858, 3568403408⟩, ⟨(-264036591), (-104872736)⟩, ⟨(-16760853), 34268684⟩, ⟨(-6427077), 7103055⟩, ⟨(-1500804), 1691245⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3015786448, 4523679674⟩, ⟨753946612, 753946613⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2117587230, 4764571273⟩, ⟨1058793614, 1588190426⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2117587230, 4764571273⟩, ⟨1058793614, 1588190426⟩, ⟨132349201, 132349203⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4764571273), (-2117587230)⟩, ⟨(-1588190426), (-1058793614)⟩, ⟨(-132349203), (-132349201)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2382285637), (-1058793615)⟩, ⟨(-794095213), (-529396807)⟩, ⟨(-66174602), (-66174600)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2466437597, 3356585853⟩, ⟨(-620598150), (-304012603)⟩, ⟨(-32980248), 19369529⟩, ⟨1928968, 8407137⟩, ⟨(-537817), 194631⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1589043870, 2788764518⟩, ⟨(-721962667), (-256089681)⟩, ⟨(-33076723), 81026158⟩, ⟨(-9922481), 16985421⟩, ⟨(-3426070), 2519564⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1342177280, 1342177280⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4551022554, 4551022562⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified10
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1073741824, 1610612736⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4427367774, 4757871210⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified11
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((1 / 4) : ℝ)..(3 / 8), prawitzNormalCorrection
      ((280867 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
