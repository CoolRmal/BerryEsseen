...
namespace FiniteNormalPanel73_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (34903 / 160000)
def radius : Rat := (34903 / 800000)

def j0 : Jet := ⟨⟨936920272, 936920273⟩, ⟨187384054, 187384055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2943421843, 2943421847⟩, ⟨588684367, 588684371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2017182331, 2017182338⟩, ⟨806872930, 806872938⟩, ⟨80687292, 80687294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨504, 506⟩, ⟨201, 203⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94183), (-94180)⟩, ⟨201, 203⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-44235), (-44232)⟩, ⟨(-17600), (-17597)⟩, ⟨(-1724), (-1720)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5068821, 5068825⟩, ⟨(-17600), (-17597)⟩, ⟨(-1724), (-1720)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2380631, 2380634⟩, ⟨943985, 943990⟩, ⟨91108, 91114⟩, ⟨(-653), (-649)⟩, ⟨(-32), (-29)⟩⟩
...
def j16 : Jet := ⟨⟨(-140784946), (-140784942)⟩, ⟨943985, 943990⟩, ⟨91108, 91114⟩, ⟨(-653), (-649)⟩, ⟨(-32), (-29)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-66121320), (-66121317)⟩, ⟨(-26005176), (-26005170)⟩, ⟨(-2424723), (-2424716)⟩, ⟨34542, 34549⟩, ⟨1572, 1578⟩⟩
...
def j19 : Jet := ⟨⟨1365534445, 1365534449⟩, ⟨(-26005176), (-26005170)⟩, ⟨(-2424723), (-2424716)⟩, ⟨34542, 34549⟩, ⟨1572, 1578⟩⟩
...
def j25 : Jet := ⟨⟨5534, 5536⟩, ⟨2203, 2206⟩, ⟨215, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846643), (-846640)⟩, ⟨2203, 2206⟩, ⟨215, 219⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-397636), (-397634)⟩, ⟨(-158021), (-158016)⟩, ⟨(-15393), (-15387)⟩, ⟨80, 84⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35393758, 35393761⟩, ⟨(-158021), (-158016)⟩, ⟨(-15393), (-15387)⟩, ⟨80, 84⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16623098, 16623100⟩, ⟨6575022, 6575026⟩, ⟨628006, 628013⟩, ⟨(-5824), (-5818)⟩, ⟨(-275), (-270)⟩⟩
...
def j33 : Jet := ⟨⟨(-699204785), (-699204782)⟩, ⟨6575022, 6575026⟩, ⟨628006, 628013⟩, ⟨(-5824), (-5818)⟩, ⟨(-275), (-270)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-328389822), (-328389818)⟩, ⟨(-128267892), (-128267888)⟩, ⟨(-11605429), (-11605422)⟩, ⟨238765, 238772⟩, ⟨10573, 10581⟩⟩
...
def j36 : Jet := ⟨⟨3966577474, 3966577478⟩, ⟨(-128267892), (-128267888)⟩, ⟨(-11605429), (-11605422)⟩, ⟨238765, 238772⟩, ⟨10573, 10581⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨935826430, 935826435⟩, ⟨169343448, 169343457⟩, ⟨(-5226077), (-5226069)⟩, ⟨(-308670), (-308662)⟩, ⟨5811, 5818⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4650544247, 4650544253⟩, ⟨150385437, 150385443⟩, ⟨18469611, 18469623⟩, ⟨757308, 757320⟩, ⟨57067, 57082⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1013302761, 1013302768⟩, ⟨216130601, 216130614⟩, ⟨4295034, 4295049⟩, ⟨376022, 376037⟩, ⟨15303, 15318⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-936920273), (-936920272)⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3358047023, 3358047024⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨239066426, 239066431⟩, ⟨101982492, 101982500⟩, ⟨12902722, 12902735⟩, ⟨609694, 609706⟩, ⟨49359, 49370⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4534033722, 4534033727⟩, ⟨101982492, 101982500⟩, ⟨12902722, 12902735⟩, ⟨609694, 609706⟩, ⟨49359, 49370⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4412881887, 4412881891⟩, ⟨49628732, 49628737⟩, ⟨5999906, 5999914⟩, ⟨229223, 229231⟩, ⟨17362, 17370⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3450239282, 3450239288⟩, ⟨(-153725988), (-153725981)⟩, ⟨2525824, 2525832⟩, ⟨(-82550), (-82542)⟩, ⟨3572, 3581⟩⟩
...
def j47 : Jet := ⟨⟨5559210978, 5559210986⟩, ⟨1111842193, 1111842200⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨7195590692, 7195590713⟩, ⟨2878236270, 2878236294⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨7195590692, 7195590713⟩, ⟨2878236270, 2878236294⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-7195590713), (-7195590692)⟩, ⟨(-2878236294), (-2878236270)⟩, ⟨(-287823630), (-287823626)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3597795357), (-3597795346)⟩, ⟨(-1439118147), (-1439118135)⟩, ⟨(-143911815), (-143911813)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1858494831, 1858494846⟩, ⟨(-622727364), (-622727352)⟩, ⟨42056140, 42056145⟩, ⟨9213254, 9213256⟩, ⟨(-1476363), (-1476362)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1492968730, 1492968746⟩, ⟨(-566769712), (-566769696)⟩, ⟨57166289, 57166301⟩, ⟨5493983, 5493993⟩, ⟨(-1477513), (-1477502)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨749536217, 1124304327⟩, ⟨187384054, 187384055⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2354737472, 3532106215⟩, ⟨588684367, 588684371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1290996689, 2904742564⟩, ⟨645498342, 968247526⟩, ⟨80687292, 80687294⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨323, 728⟩, ⟨161, 243⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94364), (-93958)⟩, ⟨161, 243⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-63820), (-28242)⟩, ⟨(-21226), (-13956)⟩, ⟨(-1743), (-1695)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5049236, 5084815⟩, ⟨(-21226), (-13956)⟩, ⟨(-1743), (-1695)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1517717, 3438927⟩, ⟨744502, 1142115⟩, ⟨88892, 92920⟩, ⟨(-791), (-509)⟩, ⟨(-33), (-27)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141647860), (-139726649)⟩, ⟨744502, 1142115⟩, ⟨88892, 92920⟩, ⟨(-791), (-509)⟩, ⟨(-33), (-27)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-95798301), (-41999537)⟩, ⟨(-31708983), (-20227340)⟩, ⟨(-2522453), (-2304651)⟩, ⟨26810, 42253⟩, ⟨1467, 1662⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1335857464, 1389656229⟩, ⟨(-31708983), (-20227340)⟩, ⟨(-2522453), (-2304651)⟩, ⟨26810, 42253⟩, ⟨1467, 1662⟩⟩
...
def j72 : Jet := ⟨⟨3535, 7984⟩, ⟨1750, 2658⟩, ⟨211, 220⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848642), (-844192)⟩, ⟨1750, 2658⟩, ⟨211, 220⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-573948), (-253750)⟩, ⟨(-190790), (-125077)⟩, ⟨(-15617), (-15110)⟩, ⟨61, 100⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35217446, 35537645⟩, ⟨(-190790), (-125077)⟩, ⟨(-15617), (-15110)⟩, ⟨61, 100⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨10585786, 24034575⟩, ⟨5163859, 7973929⟩, ⟨608037, 644289⟩, ⟨(-7088), (-4551)⟩, ⟨(-285), (-256)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-705242097), (-691793307)⟩, ⟨5163859, 7973929⟩, ⟨608037, 644289⟩, ⟨(-7088), (-4551)⟩, ⟨(-285), (-256)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-476964456), (-207941715)⟩, ⟨(-157435982), (-98577984)⟩, ⟨(-12290163), (-10762990)⟩, ⟨183598, 293684⟩, ⟨9631, 11345⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3818002840, 4087025581⟩, ⟨(-157435982), (-98577984)⟩, ⟨(-12290163), (-10762990)⟩, ⟨183598, 293684⟩, ⟨9631, 11345⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨732390589, 1142829052⟩, ⟨157020731, 179381769⟩, ⟨(-6420575), (-4035971)⟩, ⟨(-331039), (-281135)⟩, ⟨4478, 7159⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4513488772, 4831516594⟩, ⟨108864163, 199228391⟩, ⟨14511834, 23767885⟩, ⟨289527, 1404349⟩, ⟨17469, 117799⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨769653520, 1285597107⟩, ⟨183573549, 254802869⟩, ⟨(-768076), 10403866⟩, ⟨(-90311), 968621⟩, ⟨(-32620), 77292⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1124304327), (-749536217)⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3170662969, 3545431079⟩, ⟨(-187384055), (-187384054)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨137921082, 384813157⟩, ⟨65792364, 152538452⟩, ⟨7386405, 21344718⟩, ⟨(-145200), 1814306⟩, ⟨(-32107), 186404⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4432888378, 4679780453⟩, ⟨65792364, 152538452⟩, ⟨7386405, 21344718⟩, ⟨(-145200), 1814306⟩, ⟨(-32107), 186404⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4363382931, 4483247038⟩, ⟨31514664, 75073364⟩, ⟨2909538, 10391215⟩, ⟨(-250246), 871917⟩, ⟨(-43178), 95077⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3221169272, 3700853182⟩, ⟨(-172333474), (-128397006)⟩, ⟨(-1127458), 7202848⟩, ⟨(-659931), 592816⟩, ⟨(-73684), 89403⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4447368779, 6671053180⟩, ⟨1111842193, 1111842200⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4605178035, 10361650617⟩, ⟨2302589014, 3453883550⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4605178035, 10361650617⟩, ⟨2302589014, 3453883550⟩, ⟨287823626, 287823630⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10361650617), (-4605178035)⟩, ⟨(-3453883550), (-2302589014)⟩, ⟨(-287823630), (-287823626)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5180825309), (-2302589017)⟩, ⟨(-1726941775), (-1151294507)⟩, ⟨(-143911815), (-143911813)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1285553088, 2512631627⟩, ⟨(-1010291400), (-344601042)⟩, ⟨(-38004652), 160036362⟩, ⟨(-13751689), 27661644⟩, ⟨(-5461759), 2019050⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨964147994, 2165064391⟩, ⟨(-971357963), (-296877569)⟩, ⟨(-23105365), 182650103⟩, ⟨(-20351203), 25972201⟩, ⟨(-6062446), 2767464⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨936920272, 936920273⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4412881887, 4412881891⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1460
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨749536217, 1124304327⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4363382931, 4483247038⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1461
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (131983747 / 4294967296)

theorem envelope_integral : (∫ s in ((34903 / 200000) : ℝ)..(104709 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((34903 / 200000) : ℝ)..(104709 / 400000), prawitzNormalCorrection
