...
namespace FiniteNormalPanel80_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (223741 / 800000)
def radius : Rat := (31963 / 800000)

def j0 : Jet := ⟨⟨1201200347, 1201200348⟩, ⟨171600049, 171600050⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3773682185, 3773682189⟩, ⟨539097453, 539097457⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3315666046, 3315666054⟩, ⟨947333152, 947333162⟩, ⟨67666653, 67666655⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨829, 831⟩, ⟨237, 238⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93858), (-93855)⟩, ⟨237, 238⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-72458), (-72454)⟩, ⟨(-20521), (-20517)⟩, ⟨(-1415), (-1411)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5040598, 5040603⟩, ⟨(-20521), (-20517)⟩, ⟨(-1415), (-1411)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3891284, 3891289⟩, ⟨1095953, 1095959⟩, ⟨73793, 73801⟩, ⟨(-633), (-627)⟩, ⟨(-22), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-139274293), (-139274287)⟩, ⟨1095953, 1095959⟩, ⟨73793, 73801⟩, ⟨(-633), (-627)⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-107518176), (-107518170)⟩, ⟨(-29873416), (-29873409)⟩, ⟨(-1895550), (-1895540)⟩, ⟨33053, 33062⟩, ⟨1005, 1011⟩⟩
...
def j19 : Jet := ⟨⟨1324137589, 1324137596⟩, ⟨(-29873416), (-29873409)⟩, ⟨(-1895550), (-1895540)⟩, ⟨33053, 33062⟩, ⟨1005, 1011⟩⟩
...
def j22 : Jet := ⟨⟨(-84), (-82)⟩, ⟨(-24), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11751, 11754⟩, ⟨(-24), (-23)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9071, 9074⟩, ⟨2572, 2576⟩, ⟨177, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843106), (-843102)⟩, ⟨2572, 2576⟩, ⟨177, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-650869), (-650865)⟩, ⟨(-183978), (-183972)⟩, ⟨(-12581), (-12573)⟩, ⟨77, 81⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35140525, 35140530⟩, ⟨(-183978), (-183972)⟩, ⟨(-12581), (-12573)⟩, ⟨77, 81⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨27128086, 27128091⟩, ⟨7608852, 7608860⟩, ⟨503341, 503351⟩, ⟨(-5615), (-5608)⟩, ⟨(-183), (-177)⟩⟩
...
def j33 : Jet := ⟨⟨(-688699797), (-688699791)⟩, ⟨7608852, 7608860⟩, ⟨503341, 503351⟩, ⟨(-5615), (-5608)⟩, ⟨(-183), (-177)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-531668435), (-531668428)⟩, ⟨(-146031321), (-146031310)⟩, ⟨(-8783534), (-8783520)⟩, ⟨226562, 226572⟩, ⟨6549, 6559⟩⟩
...
def j36 : Jet := ⟨⟨3763298861, 3763298868⟩, ⟨(-146031321), (-146031310)⟩, ⟨(-8783534), (-8783520)⟩, ⟨226562, 226572⟩, ⟨6549, 6559⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1163425489, 1163425498⟩, ⟨139955994, 139956004⟩, ⟨(-5415149), (-5415138)⟩, ⟨(-208886), (-208875)⟩, ⟨5031, 5039⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4901748365, 4901748375⟩, ⟨190207782, 190207799⟩, ⟨18821489, 18821512⟩, ⟨879179, 879198⟩, ⟨58047, 58068⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1327791015, 1327791029⟩, ⟨211252282, 211252301⟩, ⟨5116317, 5116341⟩, ⟨373255, 373279⟩, ⟨17130, 17151⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1201200348), (-1201200347)⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3093766948, 3093766949⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨410487172, 410487181⟩, ⟨130617470, 130617484⟩, ⟨13554077, 13554098⟩, ⟨734084, 734106⟩, ⟨53400, 53423⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4705454468, 4705454477⟩, ⟨130617470, 130617484⟩, ⟨13554077, 13554098⟩, ⟨734084, 734106⟩, ⟨53400, 53423⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4495528117, 4495528122⟩, ⟨62395089, 62395097⟩, ⟨6041689, 6041701⟩, ⟨266811, 266824⟩, ⟨17744, 17758⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3238235670, 3238235676⟩, ⟨(-134668544), (-134668534)⟩, ⟨1859053, 1859064⟩, ⟨(-49199), (-49188)⟩, ⟨2120, 2132⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨30328701790, 30328701796⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value390

def j47 : Jet := ⟨⟨8482217582, 8482217592⟩, ⟨1211745364, 1211745373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨16751702667, 16751702707⟩, ⟨4786200742, 4786200786⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨16751702667, 16751702707⟩, ⟨4786200742, 4786200786⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-16751702707), (-16751702667)⟩, ⟨(-4786200786), (-4786200742)⟩, ⟨(-341871486), (-341871480)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-8375851354), (-8375851333)⟩, ⟨(-2393100393), (-2393100371)⟩, ⟨(-170935743), (-170935740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨610967859, 610967867⟩, ⟨(-340423417), (-340423409)⟩, ⟨70523807, 70523812⟩, ⟨(-4065962), (-4065959)⟩, ⟨(-837017), (-837015)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨460645629, 460645637⟩, ⟨(-275822685), (-275822675)⟩, ⟨64110580, 64110589⟩, ⟨(-5431198), (-5431190)⟩, ⟨(-468867), (-468856)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1029600297, 1372800397⟩, ⟨171600049, 171600050⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3234584729, 4312779643⟩, ⟨539097453, 539097457⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2435999542, 4330665863⟩, ⟨811999844, 1082666470⟩, ⟨67666653, 67666655⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨609, 1085⟩, ⟨203, 272⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94078), (-93601)⟩, ⟨203, 272⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-94860), (-53088)⟩, ⟨(-23600), (-17421)⟩, ⟨(-1436), (-1387)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5018196, 5059969⟩, ⟨(-23600), (-17421)⟩, ⟨(-1436), (-1387)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2846197, 5102027⟩, ⟨924935, 1265627⟩, ⟨71663, 75641⟩, ⟨(-731), (-525)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140319380), (-138063549)⟩, ⟨924935, 1265627⟩, ⟨71663, 75641⟩, ⟨(-731), (-525)⟩, ⟨(-22), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-141485676), (-78306240)⟩, ⟨(-34846819), (-24825933)⟩, ⟨(-1995203), (-1779866)⟩, ⟨27382, 38711⟩, ⟨921, 1084⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1290170089, 1353349526⟩, ⟨(-34846819), (-24825933)⟩, ⟨(-1995203), (-1779866)⟩, ⟨27382, 38711⟩, ⟨921, 1084⟩⟩
...
def j70 : Jet := ⟨⟨(-109), (-60)⟩, ⟨(-28), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11726, 11776⟩, ⟨(-28), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6650, 11874⟩, ⟨2187, 2958⟩, ⟨173, 183⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845527), (-840302)⟩, ⟨2187, 2958⟩, ⟨173, 183⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-852555), (-476598)⟩, ⟨(-211899), (-155883)⟩, ⟨(-12811), (-12307)⟩, ⟨63, 94⟩, ⟨(-1), 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34938839, 35314797⟩, ⟨(-211899), (-155883)⟩, ⟨(-12811), (-12307)⟩, ⟨63, 94⟩, ⟨(-1), 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19816447, 35608324⟩, ⟨6391821, 8813669⟩, ⟨484122, 519931⟩, ⟨(-6534), (-4686)⟩, ⟨(-193), (-165)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696011436), (-680219558)⟩, ⟨6391821, 8813669⟩, ⟨484122, 519931⟩, ⟨(-6534), (-4686)⟩, ⟨(-193), (-165)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-701796489), (-385803759)⟩, ⟨(-171823840), (-119714326)⟩, ⟨(-9482562), (-7970785)⟩, ⟨185640, 267266⟩, ⟨5784, 7214⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3593170807, 3909163537⟩, ⟨(-171823840), (-119714326)⟩, ⟨(-9482562), (-7970785)⟩, ⟨185640, 267266⟩, ⟨5784, 7214⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨971640569, 1358962219⟩, ⟨126948756, 151173609⟩, ⟨(-6377396), (-4456546)⟩, ⟨(-229814), (-184533)⟩, ⟨4129, 5948⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4718846857, 5133834450⟩, ⟨144510088, 245497695⟩, ⟨14047208, 25288045⟩, ⟨373842, 1613348⟩, ⟨13831, 128827⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1067533866, 1624386538⟩, ⟨172169785, 258377376⟩, ⟨(-173759), 11745960⟩, ⟨(-139455), 1047872⟩, ⟨(-31974), 83876⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1372800397), (-1029600297)⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2922166899, 3265366999⟩, ⟨(-171600050), (-171600049)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨265340450, 614354300⟩, ⟨85587182, 195440246⟩, ⟨6770233, 24428319⟩, ⟨(-126394), 2205858⟩, ⟨(-41442), 221648⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4560307746, 4909321596⟩, ⟨85587182, 195440246⟩, ⟨6770233, 24428319⟩, ⟨(-126394), 2205858⟩, ⟨(-41442), 221648⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4425649401, 4591881499⟩, ⟨40026528, 94834610⟩, ⟨2186938, 11672492⟩, ⟨(-311455), 1050584⟩, ⟨(-58016), 113687⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3011079082, 3491104188⟩, ⟨(-156230038), (-104720668)⟩, ⟨(-2301072), 7275125⟩, ⟨(-703153), 711360⟩, ⟨(-86084), 98878⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7270472210, 9693962957⟩, ⟨1211745364, 1211745373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨12307373377, 21879774941⟩, ⟨4102457776, 5469943752⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨12307373377, 21879774941⟩, ⟨4102457776, 5469943752⟩, ⟨341871480, 341871486⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-21879774941), (-12307373377)⟩, ⟨(-5469943752), (-4102457776)⟩, ⟨(-341871486), (-341871480)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10939887471), (-6153686688)⟩, ⟨(-2734971876), (-2051228888)⟩, ⟨(-170935743), (-170935740)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨336318343, 1024984112⟩, ⟨(-652694777), (-160621921)⟩, ⟨(-2437798), 194428048⟩, ⟨(-37007903), 17835219⟩, ⟨(-6708330), 5940034⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨235783198, 833144022⟩, ⟨(-567817776), (-120807621)⟩, ⟨1385635, 183516181⟩, ⟨(-38427094), 15105238⟩, ⟨(-6334347), 6634234⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1201200347, 1201200348⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨171600049, 171600050⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4495528117, 4495528122⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar390 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1616
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar390 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1029600297, 1372800397⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4425649401, 4591881499⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1617
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((95889 / 400000) : ℝ)..(31963 / 100000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (95889 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (31963 / 100000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((95889 / 400000) : ℝ)..(31963 / 100000), prawitzNormalCorrection
      ((12483 / 5000) * sqrt n) s) ≤ (upper : ℝ) :=
