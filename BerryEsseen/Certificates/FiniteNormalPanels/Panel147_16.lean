...
namespace FiniteNormalPanel147_16
...
def j2 : Jet := ⟨⟨1337632289, 1337632294⟩, ⟨445877429, 445877434⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨416594590, 416594594⟩, ⟨277729726, 277729732⟩, ⟨46288287, 46288289⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-9175), (-9173)⟩, ⟨(-6111), (-6108)⟩, ⟨(-1015), (-1012)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103881, 5103884⟩, ⟨(-6111), (-6108)⟩, ⟨(-1015), (-1012)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨495055, 495057⟩, ⟨329444, 329446⟩, ⟨54511, 54515⟩, ⟨(-132), (-129)⟩, ⟨(-11), (-8)⟩⟩
...
def j16 : Jet := ⟨⟨(-142670522), (-142670519)⟩, ⟨329444, 329446⟩, ⟨54511, 54515⟩, ⟨(-132), (-129)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-13838469), (-13838467)⟩, ⟨(-9193692), (-9193690)⟩, ⟨(-1511018), (-1511015)⟩, ⟨7061, 7065⟩, ⟨576, 580⟩⟩
...
def j19 : Jet := ⟨⟨1417817296, 1417817299⟩, ⟨(-9193692), (-9193690)⟩, ⟨(-1511018), (-1511015)⟩, ⟨7061, 7065⟩, ⟨576, 580⟩⟩
...
def j25 : Jet := ⟨⟨1146, 1148⟩, ⟨763, 765⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851031), (-851028)⟩, ⟨763, 765⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-82547), (-82546)⟩, ⟨(-54958), (-54955)⟩, ⟨(-9111), (-9108)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35708847, 35708849⟩, ⟨(-54958), (-54955)⟩, ⟨(-9111), (-9108)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3463614, 3463616⟩, ⟨2303745, 2303747⟩, ⟨380408, 380411⟩, ⟨(-1182), (-1178)⟩, ⟨(-100), (-95)⟩⟩
...
def j33 : Jet := ⟨⟨(-712364269), (-712364266)⟩, ⟨2303745, 2303747⟩, ⟨380408, 380411⟩, ⟨(-1182), (-1178)⟩, ⟨(-100), (-95)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-69096476), (-69096474)⟩, ⟨(-45840864), (-45840861)⟩, ⟨(-7491520), (-7491516)⟩, ⟨49311, 49314⟩, ⟨4012, 4015⟩⟩
...
def j36 : Jet := ⟨⟨4225870820, 4225870822⟩, ⟨(-45840864), (-45840861)⟩, ⟨(-7491520), (-7491516)⟩, ⟨49311, 49314⟩, ⟨4012, 4015⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨441567552, 441567555⟩, ⟨144325883, 144325887⟩, ⟨(-1425029), (-1425026)⟩, ⟨(-154666), (-154663)⟩, ⟨912, 915⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4365193554, 4365193557⟩, ⟨47352187, 47352192⟩, ⟨8252163, 8252171⟩, ⟨122520, 122527⟩, ⟨11256, 11264⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨448787545, 448787550⟩, ⟨151554030, 151554036⟩, ⟨991276, 991283⟩, ⟨116990, 116999⟩, ⟨1756, 1765⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-425781583), (-425781582)⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3869185713, 3869185714⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨46894480, 46894482⟩, ⟨31672212, 31672216⟩, ⟨5554957, 5554962⟩, ⟨94404, 94410⟩, ⟨8850, 8857⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4341861776, 4341861778⟩, ⟨31672212, 31672216⟩, ⟨5554957, 5554962⟩, ⟨94404, 94410⟩, ⟨8850, 8857⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4318350881, 4318350883⟩, ⟨15750354, 15750357⟩, ⟨2733715, 2733719⟩, ⟨36974, 36980⟩, ⟨3400, 3406⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3890251166, 3890251170⟩, ⟨(-128510964), (-128510958)⟩, ⟨1942237, 1942242⟩, ⟨(-57028), (-57021)⟩, ⟨1839, 1848⟩⟩
...
def j47 : Jet := ⟨⟨4238589773, 4238589784⟩, ⟨1412863257, 1412863268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4182952284, 4182952307⟩, ⟨2788634854, 2788634886⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4182952284, 4182952307⟩, ⟨2788634854, 2788634886⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4182952307), (-4182952284)⟩, ⟨(-2788634886), (-2788634854)⟩, ⟨(-464772483), (-464772475)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2091476154), (-2091476142)⟩, ⟨(-1394317443), (-1394317427)⟩, ⟨(-232386242), (-232386237)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2639222062, 2639222076⟩, ⟨(-856796601), (-856796585)⟩, ⟨(-3724289), (-3724279)⟩, ⟨31308604, 31308607⟩, ⟨(-2440252), (-2440250)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2390527330, 2390527346⟩, ⟨(-855029318), (-855029297)⟩, ⟨23456597, 23456613⟩, ⟨28047320, 28047333⟩, ⟨(-3136281), (-3136268)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨283854388, 567708778⟩, ⟨141927194, 141927195⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨891754859, 1783509727⟩, ⟨445877429, 445877434⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨185153151, 740612612⟩, ⟨185153150, 370306308⟩, ⟨46288287, 46288289⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-16320), (-4073)⟩, ⟨(-8159), (-4056)⟩, ⟨(-1019), (-1006)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096736, 5108984⟩, ⟨(-8159), (-4056)⟩, ⟨(-1019), (-1006)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨219716, 880980⟩, ⟨218309, 440316⟩, ⟨54049, 54845⟩, ⟨(-176), (-85)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142945861), (-142284596)⟩, ⟨218309, 440316⟩, ⟨54049, 54845⟩, ⟨(-176), (-85)⟩, ⟨(-11), (-8)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-24649200), (-6133793)⟩, ⟨(-12315190), (-6057866)⟩, ⟨(-1528835), (-1486026)⟩, ⟨4651, 9472⟩, ⟨564, 589⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1407006565, 1425521973⟩, ⟨(-12315190), (-6057866)⟩, ⟨(-1528835), (-1486026)⟩, ⟨4651, 9472⟩, ⟨564, 589⟩⟩
...
def j72 : Jet := ⟨⟨509, 2041⟩, ⟨507, 1021⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851668), (-850135)⟩, ⟨507, 1021⟩, ⟨125, 128⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-146860), (-36648)⟩, ⟨(-73409), (-36471)⟩, ⟨(-9153), (-9050)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35644534, 35754747⟩, ⟨(-73409), (-36471)⟩, ⟨(-9153), (-9050)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1536611, 6165453⟩, ⟨1523952, 3081155⟩, ⟨376243, 383379⟩, ⟨(-1582), (-778)⟩, ⟨(-100), (-93)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714291272), (-709662429)⟩, ⟨1523952, 3081155⟩, ⟨376243, 383379⟩, ⟨(-1582), (-778)⟩, ⟨(-100), (-93)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-123170467), (-30593069)⟩, ⟨(-61519538), (-30061762)⟩, ⟨(-7616240), (-7316504)⟩, ⟨32370, 66229⟩, ⟨3899, 4095⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4171796829, 4264374227⟩, ⟨(-61519538), (-30061762)⟩, ⟨(-7616240), (-7316504)⟩, ⟨32370, 66229⟩, ⟨3899, 4095⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨292133759, 591956150⟩, ⟨140952925, 146731258⟩, ⟨(-1913347), (-937430)⟩, ⟨(-157750), (-150336)⟩, ⟨599, 1229⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4325779842, 4421774317⟩, ⟨30494641, 65205840⟩, ⟨7636831, 9034173⟩, ⟨37480, 218703⟩, ⟨8106, 15442⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨294229557, 609433396⟩, ⟨144038311, 160050464⟩, ⟨(-449621), 2528647⟩, ⟨61718, 180714⟩, ⟨(-4036), 8134⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-567708778), (-283854388)⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3727258518, 4011112908⟩, ⟨(-141927195), (-141927194)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨20156389, 86475412⟩, ⟨19734878, 45420648⟩, ⟨4702947, 6681829⟩, ⟨(-25054), 239746⟩, ⟨2727, 17269⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4315123685, 4381442708⟩, ⟨19734878, 45420648⟩, ⟨4702947, 6681829⟩, ⟨(-25054), 239746⟩, ⟨2727, 17269⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305033693, 4337989528⟩, ⟨9769578, 22657221⟩, ⟨2268983, 3322018⟩, ⟨(-29982), 114444⟩, ⟨(-525), 8176⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3735994338, 4051291801⟩, ⟨(-134870630), (-121100032)⟩, ⟨1220360, 2779631⟩, ⟨(-137778), 31903⟩, ⟨(-4273), 8627⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2825726515, 5651453052⟩, ⟨1412863257, 1412863268⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1859089903, 7436359674⟩, ⟨1859089902, 3718179850⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1859089903, 7436359674⟩, ⟨1859089902, 3718179850⟩, ⟨464772475, 464772483⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7436359674), (-1859089903)⟩, ⟨(-3718179850), (-1859089902)⟩, ⟨(-464772483), (-464772475)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3718179837), (-929544951)⟩, ⟨(-1859089925), (-929544951)⟩, ⟨(-232386242), (-232386237)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1807125990, 3459130967⟩, ⟨(-1497295576), (-391110042)⟩, ⟨(-144838651), 226277009⟩, ⟨(-18540470), 74907041⟩, ⟨(-14227481), 5924692⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1571935710, 3262876749⟩, ⟨(-1520970014), (-391161981)⟩, ⟨(-125080083), 262695948⟩, ⟨(-25674121), 75119974⟩, ⟨(-15880819), 6372187⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4318350881, 4318350883⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2968
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305033693, 4337989528⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2969
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (79295465 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((6609 / 100000) : ℝ)..(6609 / 50000), prawitzNormalCorrection
