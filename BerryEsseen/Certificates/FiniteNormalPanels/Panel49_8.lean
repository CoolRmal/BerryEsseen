...
namespace FiniteNormalPanel49_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (19247 / 80000)
def radius : Rat := (19247 / 400000)

def j0 : Jet := ⟨⟨1033315444, 1033315445⟩, ⟨206663088, 206663089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3246256207, 3246256211⟩, ⟨649251239, 649251243⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2453611083, 2453611090⟩, ⟨981444428, 981444438⟩, ⟨98144442, 98144444⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨614, 615⟩, ⟨245, 246⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94073), (-94071)⟩, ⟨245, 246⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-53742), (-53740)⟩, ⟨(-21358), (-21355)⟩, ⟨(-2082), (-2077)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5059314, 5059317⟩, ⟨(-21358), (-21355)⟩, ⟨(-2082), (-2077)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2890263, 2890266⟩, ⟨1143903, 1143908⟩, ⟨109539, 109546⟩, ⟨(-960), (-954)⟩, ⟨(-46), (-43)⟩⟩
...
def j16 : Jet := ⟨⟨(-140275314), (-140275310)⟩, ⟨1143903, 1143908⟩, ⟨109539, 109546⟩, ⟨(-960), (-954)⟩, ⟨(-46), (-43)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-80135900), (-80135896)⟩, ⟨(-31400876), (-31400870)⟩, ⟨(-2881467), (-2881459)⟩, ⟨50620, 50629⟩, ⟨2256, 2263⟩⟩
...
def j19 : Jet := ⟨⟨1351519865, 1351519870⟩, ⟨(-31400876), (-31400870)⟩, ⟨(-2881467), (-2881459)⟩, ⟨50620, 50629⟩, ⟨2256, 2263⟩⟩
...
def j25 : Jet := ⟨⟨6725, 6727⟩, ⟨2675, 2678⟩, ⟨261, 264⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845452), (-845449)⟩, ⟨2675, 2678⟩, ⟨261, 264⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-482987), (-482984)⟩, ⟨(-191667), (-191663)⟩, ⟨(-18560), (-18556)⟩, ⟨118, 123⟩, ⟨3, 7⟩⟩
...
def j30 : Jet := ⟨⟨35308407, 35308411⟩, ⟨(-191667), (-191663)⟩, ⟨(-18560), (-18556)⟩, ⟨118, 123⟩, ⟨3, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20170840, 20170843⟩, ⟨7958841, 7958846⟩, ⟨752432, 752438⟩, ⟨(-8555), (-8548)⟩, ⟨(-398), (-391)⟩⟩
...
def j33 : Jet := ⟨⟨(-695657043), (-695657039)⟩, ⟨7958841, 7958846⟩, ⟨752432, 752438⟩, ⟨(-8555), (-8548)⟩, ⟨(-398), (-391)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-397412069), (-397412064)⟩, ⟨(-154418135), (-154418128)⟩, ⟨(-13647960), (-13647953)⟩, ⟨348917, 348925⟩, ⟨15010, 15018⟩⟩
...
def j36 : Jet := ⟨⟨3897555227, 3897555232⟩, ⟨(-154418135), (-154418128)⟩, ⟨(-13647960), (-13647953)⟩, ⟨348917, 348925⟩, ⟨15010, 15018⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1021516451, 1021516457⟩, ⟨180569630, 180569638⟩, ⟨(-6924626), (-6924617)⟩, ⟨(-397319), (-397310)⟩, ⟨9357, 9365⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4732901261, 4732901268⟩, ⟨187513892, 187513902⟩, ⟨24002212, 24002225⟩, ⟨1183851, 1183865⟩, ⟨95924, 95940⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1125674810, 1125674820⟩, ⟨243579678, 243579692⟩, ⟨5961487, 5961504⟩, ⟨550516, 550535⟩, ⟨26851, 26869⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1033315445), (-1033315444)⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3261651851, 3261651852⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨295029901, 295029907⟩, ⟨127680370, 127680380⟩, ⟨16938998, 16939013⟩, ⟨964754, 964770⟩, ⟨84790, 84807⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4589997197, 4589997203⟩, ⟨127680370, 127680380⟩, ⟨16938998, 16939013⟩, ⟨964754, 964770⟩, ⟨84790, 84807⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4440032415, 4440032419⟩, ⟨61754392, 61754398⟩, ⟨7763325, 7763334⟩, ⟨358639, 358649⟩, ⟨29234, 29244⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3371816115, 3371816120⟩, ⟨(-166746204), (-166746196)⟩, ⟨2924098, 2924107⟩, ⟨(-101199), (-101188)⟩, ⟨4942, 4953⟩⟩
...
def j47 : Jet := ⟨⟨5107731837, 5107731845⟩, ⟨1021546363, 1021546369⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6074301087, 6074301107⟩, ⟨2429720424, 2429720444⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6074301087, 6074301107⟩, ⟨2429720424, 2429720444⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6074301107), (-6074301087)⟩, ⟨(-2429720444), (-2429720424)⟩, ⟨(-242972045), (-242972041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3037150554), (-3037150543)⟩, ⟨(-1214860222), (-1214860212)⟩, ⟨(-121486023), (-121486020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2117639914, 2117639927⟩, ⟨(-598988615), (-598988606)⟩, ⟨24815103, 24815108⟩, ⟨8955488, 8955491⟩, ⟨(-984237), (-984235)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1662478872, 1662478886⟩, ⟨(-552457732), (-552457718)⟩, ⟨44178035, 44178048⟩, ⟨5609499, 5609512⟩, ⟨(-1086932), (-1086917)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨826652355, 1239978534⟩, ⟨206663088, 206663089⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2597004965, 3895507454⟩, ⟨649251239, 649251243⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1570311092, 3533199971⟩, ⟨785155542, 1177733326⟩, ⟨98144442, 98144444⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨393, 886⟩, ⟨196, 296⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94294), (-93800)⟩, ⟨196, 296⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-77570), (-34294)⟩, ⟨(-25786), (-16903)⟩, ⟨(-2112), (-2040)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5035486, 5078763⟩, ⟨(-25786), (-16903)⟩, ⟨(-2112), (-2040)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1841056, 4177980⟩, ⟨899315, 1386480⟩, ⟨106257, 112220⟩, ⟨(-1168), (-746)⟩, ⟨(-48), (-41)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141324521), (-138987596)⟩, ⟨899315, 1386480⟩, ⟨106257, 112220⟩, ⟨(-1168), (-746)⟩, ⟨(-48), (-41)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-116258812), (-50816164)⟩, ⟨(-38424134), (-24267511)⟩, ⟨(-3026161), (-2703502)⟩, ⟨39013, 62184⟩, ⟨2067, 2415⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1315396953, 1380839602⟩, ⟨(-38424134), (-24267511)⟩, ⟨(-3026161), (-2703502)⟩, ⟨39013, 62184⟩, ⟨2067, 2415⟩⟩
...
def j72 : Jet := ⟨⟨4294, 9705⟩, ⟨2122, 3229⟩, ⟨256, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847883), (-842471)⟩, ⟨2122, 3229⟩, ⟨256, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-697501), (-308021)⟩, ⟨(-231726), (-151353)⟩, ⟨(-18896), (-18145)⟩, ⟨92, 148⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35093893, 35483374⟩, ⟨(-231726), (-151353)⟩, ⟨(-18896), (-18145)⟩, ⟨92, 148⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12830907, 29189945⟩, ⟨6224826, 9674645⟩, ⟨722843, 776530⟩, ⟨(-10445), (-6653)⟩, ⟨(-415), (-367)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-702996976), (-686637937)⟩, ⟨6224826, 9674645⟩, ⟨722843, 776530⟩, ⟨(-10445), (-6653)⟩, ⟨(-415), (-367)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-578311481), (-251046188)⟩, ⟨(-190494595), (-117564369)⟩, ⟨(-14661976), (-12398675)⟩, ⟨265791, 431579⟩, ⟨13310, 16395⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3716655815, 4043921108⟩, ⟨(-190494595), (-117564369)⟩, ⟨(-14661976), (-12398675)⟩, ⟨265791, 431579⟩, ⟨13310, 16395⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨795370996, 1252412555⟩, ⟨163992307, 194061777⟩, ⟨(-8553116), (-5303117)⟩, ⟨(-433863), (-352275)⟩, ⟨7146, 11592⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4561598404, 4963264018⟩, ⟨132614218, 254388628⟩, ⟨17841218, 32618280⟩, ⟨395578, 2349161⟩, ⟨18926, 223265⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨844747541, 1447287894⟩, ⟨198731325, 298437511⟩, ⟨(-1516491), 15373335⟩, ⟨(-253494), 1620939⟩, ⟨(-64458), 151739⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1239978534), (-826652355)⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3054988762, 3468314941⟩, ⟨(-206663089), (-206663088)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨166147576, 487696903⟩, ⟨78174190, 201130752⟩, ⟨8173411, 31097848⟩, ⟨(-381590), 3228872⟩, ⟨(-84101), 382556⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4461114872, 4782664199⟩, ⟨78174190, 201130752⟩, ⟨8173411, 31097848⟩, ⟨(-381590), 3228872⟩, ⟨(-84101), 382556⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4377252846, 4532260620⟩, ⟨37040631, 98674904⟩, ⟨2798580, 15099909⟩, ⟨(-527601), 1560406⟩, ⟨(-102482), 198683⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3113518062, 3659936419⟩, ⟨(-191734236), (-130939516)⟩, ⟨(-2757375), 10411328⟩, ⟨(-1152624), 1125415⟩, ⟨(-157841), 185830⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4086185469, 6129278213⟩, ⟨1021546363, 1021546369⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3887552695, 8746993592⟩, ⟨1943776338, 2915664532⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3887552695, 8746993592⟩, ⟨1943776338, 2915664532⟩, ⟨242972041, 242972045⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8746993592), (-3887552695)⟩, ⟨(-2915664532), (-1943776338)⟩, ⟨(-242972045), (-242972041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4373496796), (-1943776347)⟩, ⟨(-1457832266), (-971888169)⟩, ⟨(-121486023), (-121486020)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1551403279, 2731561008⟩, ⟨(-927168358), (-351059830)⟩, ⟨(-37544183), 113470985⟩, ⟨(-6218437), 21731568⟩, ⟨(-3448878), 1058660⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1124647010, 2327687018⟩, ⟨(-912023477), (-301788354)⟩, ⟨(-23044102), 144705571⟩, ⟨(-13345126), 21505486⟩, ⟨(-4343422), 1821806⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1033315444, 1033315445⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4440032415, 4440032419⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified968
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨826652355, 1239978534⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4377252846, 4532260620⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified969
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (161440879 / 4294967296)

theorem envelope_integral : (∫ s in ((19247 / 100000) : ℝ)..(57741 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((19247 / 100000) : ℝ)..(57741 / 200000), prawitzNormalCorrection
