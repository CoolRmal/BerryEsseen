...
namespace FiniteNormalPanel2_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (57533 / 160000)
def radius : Rat := (8219 / 160000)

def j0 : Jet := ⟨⟨1544389709, 1544389710⟩, ⟨220627101, 220627102⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4851843363, 4851843368⟩, ⟨693120479, 693120483⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5480922763, 5480922775⟩, ⟨1565977928, 1565977940⟩, ⟨111855566, 111855568⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1371, 1374⟩, ⟨391, 393⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93316), (-93312)⟩, ⟨391, 393⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-119084), (-119077)⟩, ⟨(-33526), (-33520)⟩, ⟨(-2255), (-2248)⟩, ⟨19, 22⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4993972, 4993980⟩, ⟨(-33526), (-33520)⟩, ⟨(-2255), (-2248)⟩, ⟨19, 22⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6372941, 6372952⟩, ⟨1778056, 1778069⟩, ⟨114958, 114972⟩, ⟨(-1673), (-1662)⟩, ⟨(-53), (-47)⟩⟩
...
def j16 : Jet := ⟨⟨(-136792636), (-136792624)⟩, ⟨1778056, 1778069⟩, ⟨114958, 114972⟩, ⟨(-1673), (-1662)⟩, ⟨(-53), (-47)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-174564746), (-174564730)⟩, ⟨(-47606618), (-47606595)⟩, ⟨(-2767554), (-2767528)⟩, ⟨86085, 86107⟩, ⟨2315, 2331⟩⟩
...
def j19 : Jet := ⟨⟨1257091019, 1257091036⟩, ⟨(-47606618), (-47606595)⟩, ⟨(-2767554), (-2767528)⟩, ⟨86085, 86107⟩, ⟨2315, 2331⟩⟩
...
def j22 : Jet := ⟨⟨(-138), (-136)⟩, ⟨(-40), (-39)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11697, 11700⟩, ⟨(-40), (-39)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨14926, 14931⟩, ⟨4212, 4217⟩, ⟨285, 289⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-837251), (-837245)⟩, ⟨4212, 4217⟩, ⟨285, 289⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1068439), (-1068430)⟩, ⟨(-299894), (-299883)⟩, ⟨(-19907), (-19897)⟩, ⟨206, 215⟩, ⟨3, 8⟩⟩
...
def j30 : Jet := ⟨⟨34722955, 34722965⟩, ⟨(-299894), (-299883)⟩, ⟨(-19907), (-19897)⟩, ⟨206, 215⟩, ⟨3, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨44310892, 44310906⟩, ⟨12277551, 12277571⟩, ⟨769555, 769575⟩, ⟨(-14808), (-14788)⟩, ⟨(-441), (-428)⟩⟩
...
def j33 : Jet := ⟨⟨(-671516991), (-671516976)⟩, ⟨12277551, 12277571⟩, ⟨769555, 769575⟩, ⟨(-14808), (-14788)⟩, ⟨(-441), (-428)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-856940814), (-856940792)⟩, ⟨(-229172523), (-229172487)⟩, ⟨(-12030051), (-12030014)⟩, ⟨581437, 581472⟩, ⟨14078, 14106⟩⟩
...
def j36 : Jet := ⟨⟨3438026482, 3438026504⟩, ⟨(-229172523), (-229172487)⟩, ⟨(-12030051), (-12030014)⟩, ⟨581437, 581472⟩, ⟨14078, 14106⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1420082691, 1420082713⟩, ⟨149089766, 149089799⟩, ⟨(-10809132), (-10809096)⟩, ⟨(-349382), (-349350)⟩, ⟨16507, 16530⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5365503742, 5365503777⟩, ⟨357654552, 357654616⟩, ⟨42615047, 42615117⟩, ⟨3184642, 3184710⟩, ⟨278890, 278949⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1774043541, 1774043581⟩, ⟨304505400, 304505467⟩, ⟨13001980, 13002056⟩, ⟨1195671, 1195743⟩, ⟨87034, 87094⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1544389710), (-1544389709)⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2750577586, 2750577587⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨732771699, 732771733⟩, ⟨251552944, 251553008⟩, ⟨32329859, 32329935⟩, ⟨2831378, 2831454⟩, ⟨280798, 280865⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5027738995, 5027739029⟩, ⟨251552944, 251553008⟩, ⟨32329859, 32329935⟩, ⟨2831378, 2831454⟩, ⟨280798, 280865⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4646931735, 4646931752⟩, ⟨116250003, 116250034⟩, ⟨13486491, 13486529⟩, ⟨971076, 971115⟩, ⟨85900, 85934⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2975982211, 2975982224⟩, ⟨(-164258396), (-164258372)⟩, ⟨2665382, 2665410⟩, ⟨(-70892), (-70863)⟩, ⟨5126, 5152⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨18421048009, 18421048014⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value56

def j47 : Jet := ⟨⟨6623863469, 6623863476⟩, ⟨946266208, 946266214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨10215576564, 10215576587⟩, ⟨2918736154, 2918736178⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨10215576564, 10215576587⟩, ⟨2918736154, 2918736178⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-10215576587), (-10215576564)⟩, ⟨(-2918736178), (-2918736154)⟩, ⟨(-208481157), (-208481153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5107788294), (-5107788282)⟩, ⟨(-1459368089), (-1459368077)⟩, ⟨(-104240579), (-104240576)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1307601181, 1307601196⟩, ⟨(-444304072), (-444304063)⟩, ⟨43748057, 43748062⟩, ⟨2233971, 2233973⟩, ⟨(-720660), (-720659)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨906036666, 906036682⟩, ⟨(-357866636), (-357866619)⟩, ⟨48116630, 48116648⟩, ⟨(-422515), (-422498)⟩, ⟨(-548744), (-548727)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1323762607, 1765016811⟩, ⟨220627101, 220627102⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4158722881, 5544963848⟩, ⟨693120479, 693120483⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨4026800394, 7158756274⟩, ⟨1342266794, 1789689074⟩, ⟨111855566, 111855568⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1007, 1794⟩, ⟨335, 449⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93680), (-92892)⟩, ⟨335, 449⟩, ⟨27, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-156144), (-87092)⟩, ⟨(-38722), (-28281)⟩, ⟨(-2311), (-2182)⟩, ⟨16, 25⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4956912, 5025965⟩, ⟨(-38722), (-28281)⟩, ⟨(-2311), (-2182)⟩, ⟨16, 25⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4647414, 8377168⟩, ⟨1484597, 2067777⟩, ⟨109106, 120011⟩, ⟨(-1957), (-1375)⟩, ⟨(-56), (-43)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138518163), (-134788408)⟩, ⟨1484597, 2067777⟩, ⟨109106, 120011⟩, ⟨(-1957), (-1375)⟩, ⟨(-56), (-43)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-230879004), (-126372560)⟩, ⟨(-56327849), (-38677661)⟩, ⟨(-3041225), (-2448684)⟩, ⟨69498, 102571⟩, ⟨1931, 2657⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1200776761, 1305283206⟩, ⟨(-56327849), (-38677661)⟩, ⟨(-3041225), (-2448684)⟩, ⟨69498, 102571⟩, ⟨1931, 2657⟩⟩
...
def j72 : Jet := ⟨⟨10926, 19562⟩, ⟨3565, 4861⟩, ⟨277, 295⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-841251), (-832614)⟩, ⟨3565, 4861⟩, ⟨277, 295⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1402179), (-780627)⟩, ⟨(-347203), (-252106)⟩, ⟨(-20537), (-19166)⟩, ⟨171, 250⟩, ⟨3, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34389215, 35010768⟩, ⟨(-347203), (-252106)⟩, ⟨(-20537), (-19166)⟩, ⟨171, 250⟩, ⟨3, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨32242039, 58355172⟩, ⟨10168635, 14352429⟩, ⟨716703, 815043⟩, ⟨(-17441), (-12137)⟩, ⟨(-480), (-380)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-683585844), (-657472710)⟩, ⟨10168635, 14352429⟩, ⟨716703, 815043⟩, ⟨(-17441), (-12137)⟩, ⟨(-480), (-380)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1139385731), (-616421775)⟩, ⟨(-275312703), (-181551613)⟩, ⟨(-13953040), (-9783753)⟩, ⟨459738, 702032⟩, ⟨10596, 17078⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3155581565, 3678545521⟩, ⟨(-275312703), (-181551613)⟩, ⟨(-13953040), (-9783753)⟩, ⟨459738, 702032⟩, ⟨10596, 17078⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1162685870, 1685169570⟩, ⟨121059612, 173195464⟩, ⟨(-13016507), (-8612795)⟩, ⟨(-423499), (-262743)⟩, ⟨13084, 19984⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5014684191, 5845750996⟩, ⟨247495646, 510019937⟩, ⟨25552398, 70345503⟩, ⟨803742, 7661949⟩, ⟨(-19641), 926631⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1357519638, 2293633692⟩, ⟨208345104, 435842117⟩, ⟨(-3823108), 38111303⟩, ⟨(-1184291), 5039855⟩, ⟨(-233260), 633363⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1765016811), (-1323762607)⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2529950485, 2971204689⟩, ⟨(-220627102), (-220627101)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨429074179, 1224865093⟩, ⟨131704178, 465503972⟩, ⟨6023342, 84933148⟩, ⟨(-2040810), 13117722⟩, ⟨(-523419), 2037512⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4724041475, 5519832389⟩, ⟨131704178, 465503972⟩, ⟨6023342, 84933148⟩, ⟨(-2040810), 13117722⟩, ⟨(-523419), 2037512⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4504398255, 4869034770⟩, ⟨58088015, 221930237⟩, ⟨(-2595572), 40117554⟩, ⟨(-2949541), 6381792⟩, ⟨(-742620), 1128272⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2653315791, 3368337392⟩, ⟨(-215899486), (-77856743)⟩, ⟨(-13195864), 24768915⟩, ⟨(-4101245), 4548176⟩, ⟨(-841561), 932040⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5677597256, 7570129685⟩, ⟨946266208, 946266214⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7505321549, 13342793903⟩, ⟨2501773846, 3335698488⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7505321549, 13342793903⟩, ⟨2501773846, 3335698488⟩, ⟨208481153, 208481157⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-13342793903), (-7505321549)⟩, ⟨(-3335698488), (-2501773846)⟩, ⟨(-208481157), (-208481153)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6671396952), (-3752660774)⟩, ⟨(-1667849244), (-1250886923)⟩, ⟨(-104240579), (-104240576)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨908589655, 1792676080⟩, ⟨(-696143472), (-264622019)⟩, ⟨(-4974074), 113113615⟩, ⟨(-10360014), 11907643⟩, ⟨(-2528670), 1066129⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨561302359, 1405910094⟩, ⟨(-636066295), (-179946797)⟩, ⟨(-4611832), 134041646⟩, ⟨(-19537315), 13625828⟩, ⟨(-4017665), 3062984⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1544389709, 1544389710⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4646931735, 4646931752⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar56 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified26
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar56 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1323762607, 1765016811⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4504398255, 4869034770⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified27
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((24657 / 80000) : ℝ)..(8219 / 20000), prawitzNormalCorrection
      ((303277 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
