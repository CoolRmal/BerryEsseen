...
namespace FiniteNormalPanel76_36

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (43771 / 320000)
def radius : Rat := (6253 / 320000)

def j0 : Jet := ⟨⟨587484417, 587484418⟩, ⟨83926345, 83926346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1845636728, 1845636732⟩, ⟨263662388, 263662393⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨793108467, 793108472⟩, ⟨226602416, 226602424⟩, ⟨16185886, 16185888⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨198, 199⟩, ⟨56, 57⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94489), (-94487)⟩, ⟨56, 57⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-17449), (-17447)⟩, ⟨(-4976), (-4974)⟩, ⟨(-355), (-351)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5095607, 5095610⟩, ⟨(-4976), (-4974)⟩, ⟨(-355), (-351)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨940954, 940956⟩, ⟨267925, 267927⟩, ⟨18874, 18878⟩, ⟨(-38), (-35)⟩, ⟨(-2), 1⟩⟩
...
def j16 : Jet := ⟨⟨(-142224623), (-142224620)⟩, ⟨267925, 267927⟩, ⟨18874, 18878⟩, ⟨(-38), (-35)⟩, ⟨(-2), 1⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-26263193), (-26263191)⟩, ⟨(-7454295), (-7454293)⟩, ⟨(-518364), (-518360)⟩, ⟨1996, 2001⟩, ⟨67, 72⟩⟩
...
def j19 : Jet := ⟨⟨1405392572, 1405392575⟩, ⟨(-7454295), (-7454293)⟩, ⟨(-518364), (-518360)⟩, ⟨1996, 2001⟩, ⟨67, 72⟩⟩
...
def j22 : Jet := ⟨⟨(-20), (-19)⟩, ⟨(-6), (-5)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11815, 11817⟩, ⟨(-6), (-5)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2181, 2183⟩, ⟨621, 624⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849996), (-849993)⟩, ⟨621, 624⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-156961), (-156959)⟩, ⟨(-44732), (-44729)⟩, ⟨(-3165), (-3161)⟩, ⟨3, 6⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35634433, 35634436⟩, ⟨(-44732), (-44729)⟩, ⟨(-3165), (-3161)⟩, ⟨3, 6⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6580252, 6580254⟩, ⟨1871811, 1871814⟩, ⟨131344, 131349⟩, ⟨(-336), (-332)⟩, ⟨(-13), (-9)⟩⟩
...
def j33 : Jet := ⟨⟨(-709247631), (-709247628)⟩, ⟨1871811, 1871814⟩, ⟨131344, 131349⟩, ⟨(-336), (-332)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-130969637), (-130969634)⟩, ⟨(-37074249), (-37074245)⟩, ⟨(-2549841), (-2549837)⟩, ⟨13920, 13924⟩, ⟨473, 477⟩⟩
...
def j36 : Jet := ⟨⟨4163997659, 4163997662⟩, ⟨(-37074249), (-37074245)⟩, ⟨(-2549841), (-2549837)⟩, ⟨13920, 13924⟩, ⟨473, 477⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨603926402, 603926406⟩, ⟨83071933, 83071938⟩, ⟨(-680362), (-680359)⟩, ⟨(-30965), (-30961)⟩, ⟨150, 154⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4430056299, 4430056303⟩, ⟨39443103, 39443110⟩, ⟨3063940, 3063947⟩, ⟨36617, 36626⟩, ⟨1561, 1571⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨622921614, 622921619⟩, ⟨91230978, 91230987⟩, ⟨491962, 491969⟩, ⟨26221, 26231⟩, ⟨310, 320⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-587484418), (-587484417)⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3707482878, 3707482879⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨90345585, 90345588⟩, ⟨26463412, 26463418⟩, ⟨2080572, 2080578⟩, ⟨28502, 28512⟩, ⟨1256, 1267⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4385312881, 4385312884⟩, ⟨26463412, 26463418⟩, ⟨2080572, 2080578⟩, ⟨28502, 28512⟩, ⟨1256, 1267⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4339904999, 4339905002⟩, ⟨13094697, 13094701⟩, ⟨1009759, 1009763⟩, ⟨11056, 11063⟩, ⟨470, 478⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3746273805, 3746273809⟩, ⟨(-73500910), (-73500904)⟩, ⟨615760, 615766⟩, ⟨(-10189), (-10181)⟩, ⟨188, 197⟩⟩
...
def j47 : Jet := ⟨⟨4967224085, 4967224095⟩, ⟨709603438, 709603447⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5744703838, 5744703862⟩, ⟨1641343946, 1641343972⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5744703838, 5744703862⟩, ⟨1641343946, 1641343972⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5744703862), (-5744703838)⟩, ⟨(-1641343972), (-1641343946)⟩, ⟨(-117238856), (-117238852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2872351931), (-2872351919)⟩, ⟨(-820671986), (-820671973)⟩, ⟨(-58619428), (-58619426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2200473117, 2200473132⟩, ⟨(-420461096), (-420461086)⟩, ⟨10137408, 10137412⟩, ⟨3180069, 3180071⟩, ⟨(-221090), (-221089)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1919356825, 1919356842⟩, ⟨(-404403353), (-404403338)⟩, ⟨16353264, 16353274⟩, ⟨2534818, 2534829⟩, ⟨(-244723), (-244712)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨503558071, 671410763⟩, ⟨83926345, 83926346⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1581974336, 2109299121⟩, ⟨263662388, 263662393⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨582691933, 1035896778⟩, ⟨194230642, 258974198⟩, ⟨16185886, 16185888⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨145, 260⟩, ⟨48, 65⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94542), (-94426)⟩, ⟨48, 65⟩, ⟨4, 5⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-22803), (-12810)⟩, ⟨(-5695), (-4254)⟩, ⟨(-355), (-349)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5090253, 5100247⟩, ⟨(-5695), (-4254)⟩, ⟨(-355), (-349)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨690587, 1230121⟩, ⟨228821, 306954⟩, ⟨18752, 18982⟩, ⟨(-44), (-30)⟩, ⟨(-2), 1⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142474990), (-141935455)⟩, ⟨228821, 306954⟩, ⟨18752, 18982⟩, ⟨(-44), (-30)⟩, ⟨(-2), 1⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-34363332), (-19256175)⟩, ⟨(-8559790), (-6344691)⟩, ⟨(-524037), (-511805)⟩, ⟨1699, 2298⟩, ⟨66, 72⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1397292433, 1412399591⟩, ⟨(-8559790), (-6344691)⟩, ⟨(-524037), (-511805)⟩, ⟨1699, 2298⟩, ⟨66, 72⟩⟩
...
def j70 : Jet := ⟨⟨(-27), (-14)⟩, ⟨(-7), (-4)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11808, 11822⟩, ⟨(-7), (-4)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1601, 2852⟩, ⟨531, 713⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850576), (-849324)⟩, ⟨531, 713⟩, ⟨42, 45⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-205150), (-115226)⟩, ⟨(-51216), (-38236)⟩, ⟨(-3177), (-3146)⟩, ⟨2, 6⟩, ⟨(-2), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35586244, 35676169⟩, ⟨(-51216), (-38236)⟩, ⟨(-3177), (-3146)⟩, ⟨2, 6⟩, ⟨(-2), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨4827933, 8604683⟩, ⟨1596958, 2145984⟩, ⟨130253, 132294⟩, ⟨(-386), (-284)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-710999950), (-707223199)⟩, ⟨1596958, 2145984⟩, ⟨130253, 132294⟩, ⟨(-386), (-284)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-171485022), (-95947937)⟩, ⟨(-42654600), (-31465058)⟩, ⟨(-2589565), (-2503915)⟩, ⟨11814, 16027⟩, ⟨462, 486⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4123482274, 4199019359⟩, ⟨(-42654600), (-31465058)⟩, ⟨(-2589565), (-2503915)⟩, ⟨11814, 16027⟩, ⟨462, 486⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨514667660, 693642818⟩, ⟨81574148, 84368401⟩, ⟨(-782835), (-578006)⟩, ⟨(-31545), (-30290)⟩, ⟨128, 178⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4393107651, 4473583939⟩, ⟨32919444, 46276163⟩, ⟨2866329, 3288127⟩, ⟨24031, 50491⟩, ⟨1193, 2003⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨526427858, 722489639⟩, ⟨87382873, 95350727⟩, ⟨153318, 848853⟩, ⟨16027, 37334⟩, ⟨(-212), 885⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-671410763), (-503558071)⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3623556533, 3791409225⟩, ⟨(-83926346), (-83926345)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨64523492, 121535566⟩, ⟨21420780, 32079366⟩, ⟨1815422, 2402427⟩, ⟨10166, 50254⟩, ⟨585, 2124⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4359490788, 4416502862⟩, ⟨21420780, 32079366⟩, ⟨1815422, 2402427⟩, ⟨10166, 50254⟩, ⟨585, 2124⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4327108776, 4355311167⟩, ⟨10561994, 15920542⟩, ⟨866035, 1179401⟩, ⟨701, 22828⟩, ⟨44, 967⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3650673496, 3844678155⟩, ⟨(-76194613), (-70500451)⟩, ⟨419554, 834737⟩, ⟨(-22456), 3230⟩, ⟨(-410), 841⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4257620638, 5676827534⟩, ⟨709603438, 709603447⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4220598725, 7503286668⟩, ⟨1406866238, 1875821682⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4220598725, 7503286668⟩, ⟨1406866238, 1875821682⟩, ⟨117238852, 117238856⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7503286668), (-4220598725)⟩, ⟨(-1875821682), (-1406866238)⟩, ⟨(-117238856), (-117238852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3751643334), (-2110299362)⟩, ⟨(-937910841), (-703433119)⟩, ⟨(-58619428), (-58619426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1793100792, 2627680673⟩, ⟨(-573818151), (-293675456)⟩, ⟨(-11814437), 38180639⟩, ⟨(-107092), 6081124⟩, ⟨(-592543), 86471⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1524115339, 2352191714⟩, ⟨(-560274633), (-279053956)⟩, ⟨(-5580056), 44868222⟩, ⟨(-898469), 5626457⟩, ⟨(-641283), 90243⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨587484417, 587484418⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4339904999, 4339905002⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1536
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨503558071, 671410763⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4327108776, 4355311167⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1537
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (37612303 / 2147483648)

theorem envelope_integral : (∫ s in ((18759 / 160000) : ℝ)..(6253 / 40000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (18759 / 160000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (6253 / 40000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((18759 / 160000) : ℝ)..(6253 / 40000), prawitzNormalCorrection
