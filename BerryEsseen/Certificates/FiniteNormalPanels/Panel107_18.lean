...
namespace FiniteNormalPanel107_18
...
def j2 : Jet := ⟨⟨1484672668, 1484672672⟩, ⟨494890887, 494890891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨513217628, 513217632⟩, ⟨342145084, 342145088⟩, ⟨57024180, 57024182⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨128, 129⟩, ⟨85, 86⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94559), (-94557)⟩, ⟨85, 86⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11300), (-11298)⟩, ⟨(-7523), (-7521)⟩, ⟨(-1249), (-1246)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101756, 5101759⟩, ⟨(-7523), (-7521)⟩, ⟨(-1249), (-1246)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨609623, 609624⟩, ⟨405516, 405518⟩, ⟨66985, 66989⟩, ⟨(-200), (-197)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-142555954), (-142555952)⟩, ⟨405516, 405518⟩, ⟨66985, 66989⟩, ⟨(-200), (-197)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-17034409), (-17034408)⟩, ⟨(-11307817), (-11307815)⟩, ⟨(-1852405), (-1852402)⟩, ⟨10696, 10699⟩, ⟨870, 874⟩⟩
...
def j19 : Jet := ⟨⟨1414621356, 1414621358⟩, ⟨(-11307817), (-11307815)⟩, ⟨(-1852405), (-1852402)⟩, ⟨10696, 10699⟩, ⟨870, 874⟩⟩
...
def j25 : Jet := ⟨⟨1412, 1413⟩, ⟨939, 942⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850765), (-850763)⟩, ⟨939, 942⟩, ⟨154, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-101661), (-101660)⟩, ⟨(-67662), (-67660)⟩, ⟨(-11204), (-11200)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35689733, 35689735⟩, ⟨(-67662), (-67660)⟩, ⟨(-11204), (-11200)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4264665, 4264667⟩, ⟨2835024, 2835027⟩, ⟨467121, 467125⟩, ⟨(-1790), (-1786)⟩, ⟨(-148), (-144)⟩⟩
...
def j33 : Jet := ⟨⟨(-711563218), (-711563215)⟩, ⟨2835024, 2835027⟩, ⟨467121, 467125⟩, ⟨(-1790), (-1786)⟩, ⟨(-148), (-144)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-85026676), (-85026674)⟩, ⟨(-56345687), (-56345683)⟩, ⟨(-9165749), (-9165745)⟩, ⟨74637, 74641⟩, ⟨6040, 6044⟩⟩
...
def j36 : Jet := ⟨⟨4209940620, 4209940622⟩, ⟨(-56345687), (-56345683)⟩, ⟨(-9165749), (-9165745)⟩, ⟨74637, 74641⟩, ⟨6040, 6044⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨489002480, 489002483⟩, ⟨159091970, 159091974⟩, ⟨(-1943287), (-1943284)⟩, ⟨(-209748), (-209745)⟩, ⟨1532, 1536⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4381711223, 4381711226⟩, ⟨58644653, 58644659⟩, ⟨10324615, 10324622⟩, ⟨188175, 188183⟩, ⟨17663, 17673⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨498878689, 498878693⟩, ⟨168982066, 168982073⟩, ⟨1365256, 1365263⟩, ⟨163343, 163351⟩, ⟨3007, 3018⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-472585989), (-472585988)⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3822381307, 3822381308⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨57946878, 57946880⟩, ⟨39255968, 39255972⟩, ⟨6965624, 6965630⟩, ⟨145372, 145380⟩, ⟨13983, 13990⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4352914174, 4352914176⟩, ⟨39255968, 39255972⟩, ⟨6965624, 6965630⟩, ⟨145372, 145380⟩, ⟨13983, 13990⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4323843662, 4323843664⟩, ⟨19496900, 19496903⟩, ⟨3415594, 3415599⟩, ⟨56798, 56804⟩, ⟨5339, 5345⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3848080334, 3848080338⟩, ⟨(-141236169), (-141236163)⟩, ⟨2324669, 2324676⟩, ⟨(-74728), (-74721)⟩, ⟨2667, 2674⟩⟩
...
def j47 : Jet := ⟨⟨3914024619, 3914024629⟩, ⟨1304674867, 1304674877⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3566869701, 3566869720⟩, ⟨2377913122, 2377913148⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3566869701, 3566869720⟩, ⟨2377913122, 2377913148⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3566869720), (-3566869701)⟩, ⟨(-2377913148), (-2377913122)⟩, ⟨(-396318859), (-396318852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1783434860), (-1783434850)⟩, ⟨(-1188956574), (-1188956561)⟩, ⟨(-198159430), (-198159426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2835464174, 2835464185⟩, ⟨(-784928860), (-784928848)⟩, ⟨(-22177309), (-22177302)⟩, ⟨26189562, 26189565⟩, ⟨(-1300882), (-1300880)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2540437021, 2540437035⟩, ⟨(-796499526), (-796499508)⟩, ⟨7476607, 7476622⟩, ⟨23719661, 23719675⟩, ⟨(-2023337), (-2023324)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨315057325, 630114652⟩, ⟨157528662, 157528663⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨989781777, 1979563562⟩, ⟨494890887, 494890891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨228096723, 912386900⟩, ⟨228096722, 456193452⟩, ⟨57024180, 57024182⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨57, 229⟩, ⟨57, 115⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94630), (-94457)⟩, ⟨57, 115⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-20103), (-5016)⟩, ⟨(-10049), (-4991)⟩, ⟨(-1254), (-1237)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5092953, 5108041⟩, ⟨(-10049), (-4991)⟩, ⟨(-1254), (-1237)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨270476, 1085110⟩, ⟨268341, 542290⟩, ⟨66284, 67490⟩, ⟨(-268), (-130)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142895101), (-142080466)⟩, ⟨268341, 542290⟩, ⟨66284, 67490⟩, ⟨(-268), (-130)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-30355440), (-7545596)⟩, ⟨(-15163469), (-7430396)⟩, ⟨(-1879444), (-1814461)⟩, ⟨7025, 14363⟩, ⟨847, 891⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1401300325, 1424110170⟩, ⟨(-15163469), (-7430396)⟩, ⟨(-1879444), (-1814461)⟩, ⟨7025, 14363⟩, ⟨847, 891⟩⟩
...
def j70 : Jet := ⟨⟨(-23), (-5)⟩, ⟨(-12), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11812, 11831⟩, ⟨(-12), (-5)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨627, 2514⟩, ⟨624, 1257⟩, ⟨153, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851550), (-849662)⟩, ⟨624, 1257⟩, ⟨153, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-180897), (-45123)⟩, ⟨(-90416), (-44855)⟩, ⟨(-11266), (-11112)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35610497, 35746272⟩, ⟨(-90416), (-44855)⟩, ⟨(-11266), (-11112)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1891198, 7593639⟩, ⟨1871990, 3794438⟩, ⟨460801, 471631⟩, ⟨(-2398), (-1177)⟩, ⟨(-150), (-142)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713936685), (-708234243)⟩, ⟨1871990, 3794438⟩, ⟨460801, 471631⟩, ⟨(-2398), (-1177)⟩, ⟨(-150), (-142)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-151662734), (-37612838)⟩, ⟨(-75731950), (-36806779)⟩, ⟨(-9355032), (-8899989)⟩, ⟨48816, 100412⟩, ⟨5831, 6193⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4143304562, 4257354458⟩, ⟨(-75731950), (-36806779)⟩, ⟨(-9355032), (-8899989)⟩, ⟨48816, 100412⟩, ⟨5831, 6193⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨322931801, 656376733⟩, ⟨154477010, 162381838⟩, ⟨(-2613465), (-1274318)⟩, ⟨(-214943), (-202452)⟩, ⟨1004, 2066⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4332912435, 4452181538⟩, ⟨37460012, 81377651⟩, ⟨9381800, 11539870⟩, ⟨54411, 343619⟩, ⟨11685, 25800⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨325784836, 680402940⟩, ⟨158658341, 180762220⟩, ⟨(-656405), 3554684⟩, ⟨69197, 273454⟩, ⟨(-7249), 14529⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-630114652), (-315057325)⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3664852644, 3979909971⟩, ⟨(-157528663), (-157528662)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨24711657, 107788519⟩, ⟨24069324, 57272216⟩, ⟨5652948, 8733995⟩, ⟨(-44758), 385854⟩, ⟨2270, 30564⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4319678953, 4402755815⟩, ⟨24069324, 57272216⟩, ⟨5652948, 8733995⟩, ⟨(-44758), 385854⟩, ⟨2270, 30564⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307305402, 4348527595⟩, ⟨11886432, 28554082⟩, ⟨2697911, 4338088⟩, ⟨(-51074), 184930⟩, ⟨(-2280), 14733⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3675380626, 4029541355⟩, ⟨(-149350548), (-131521694)⟩, ⟨1254807, 3583904⟩, ⟨(-206439), 72413⟩, ⟨(-8896), 15527⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2609349743, 5218699505⟩, ⟨1304674867, 1304674877⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1585275419, 6341101724⟩, ⟨1585275412, 3170550864⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1585275419, 6341101724⟩, ⟨1585275412, 3170550864⟩, ⟨396318852, 396318859⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6341101724), (-1585275419)⟩, ⟨(-3170550864), (-1585275412)⟩, ⟨(-396318859), (-396318852)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3170550862), (-792637709)⟩, ⟨(-1585275432), (-792637706)⟩, ⟨(-198159430), (-198159426)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2052877651, 3571171143⟩, ⟨(-1318121766), (-378859283)⟩, ⟨(-129805916), 148545013⟩, ⟨(-6622921), 56513791⟩, ⟨(-8641575), 3605598⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1756732060, 3350475293⟩, ⟨(-1360844481), (-387069306)⟩, ⟨(-109582705), 188180530⟩, ⟨(-12650591), 57484594⟩, ⟨(-10210645), 3813297⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4323843662, 4323843664⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2164
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307305402, 4348527595⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2165
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (23324065 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((14671 / 200000) : ℝ)..(14671 / 100000), prawitzNormalCorrection
