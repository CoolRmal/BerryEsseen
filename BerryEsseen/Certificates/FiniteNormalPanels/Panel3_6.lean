...
namespace FiniteNormalPanel3_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (8281 / 32000)
def radius : Rat := (8281 / 160000)

def j0 : Jet := ⟨⟨1111457005, 1111457006⟩, ⟨222291401, 222291402⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3491745161, 3491745165⟩, ⟨698349032, 698349036⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2838737394, 2838737401⟩, ⟨1135494956, 1135494966⟩, ⟨113549495, 113549497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨710, 712⟩, ⟨284, 285⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93977), (-93974)⟩, ⟨284, 285⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-62114), (-62111)⟩, ⟨(-24659), (-24655)⟩, ⟨(-2392), (-2388)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5050942, 5050946⟩, ⟨(-24659), (-24655)⟩, ⟨(-2392), (-2388)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3338395, 3338398⟩, ⟨1319059, 1319065⟩, ⟨125434, 125440⟩, ⟨(-1276), (-1271)⟩, ⟨(-61), (-57)⟩⟩
...
def j16 : Jet := ⟨⟨(-139827182), (-139827178)⟩, ⟨1319059, 1319065⟩, ⟨125434, 125440⟩, ⟨(-1276), (-1271)⟩, ⟨(-61), (-57)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-92418085), (-92418081)⟩, ⟨(-36095410), (-36095402)⟩, ⟨(-3265090), (-3265082)⟩, ⟨67190, 67198⟩, ⟨2937, 2944⟩⟩
...
def j19 : Jet := ⟨⟨1339237680, 1339237685⟩, ⟨(-36095410), (-36095402)⟩, ⟨(-3265090), (-3265082)⟩, ⟨67190, 67198⟩, ⟨2937, 2944⟩⟩
...
def j22 : Jet := ⟨⟨(-72), (-70)⟩, ⟨(-29), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11763, 11766⟩, ⟨(-29), (-28)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨7774, 7777⟩, ⟨3089, 3093⟩, ⟨300, 304⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-844403), (-844399)⟩, ⟨3089, 3093⟩, ⟨300, 304⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-558104), (-558101)⟩, ⟨(-221201), (-221195)⟩, ⟨(-21311), (-21305)⟩, ⟨158, 163⟩, ⟨5, 9⟩⟩
...
def j30 : Jet := ⟨⟨35233290, 35233294⟩, ⟨(-221201), (-221195)⟩, ⟨(-21311), (-21305)⟩, ⟨158, 163⟩, ⟨5, 9⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨23287268, 23287272⟩, ⟨9168705, 9168712⟩, ⟨858923, 858931⟩, ⟨(-11380), (-11371)⟩, ⟨(-520), (-513)⟩⟩
...
def j33 : Jet := ⟨⟨(-692540615), (-692540610)⟩, ⟨9168705, 9168712⟩, ⟨858923, 858931⟩, ⟨(-11380), (-11371)⟩, ⟨(-520), (-513)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-457731296), (-457731291)⟩, ⟨(-177032510), (-177032501)⟩, ⟨(-15317548), (-15317538)⟩, ⟨461958, 461969⟩, ⟨19355, 19364⟩⟩
...
def j36 : Jet := ⟨⟨3837236000, 3837236005⟩, ⟨(-177032510), (-177032501)⟩, ⟨(-15317548), (-15317538)⟩, ⟨461958, 461969⟩, ⟨19355, 19364⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1088780511, 1088780517⟩, ⟨188411065, 188411075⟩, ⟨(-8523479), (-8523469)⟩, ⟨(-476271), (-476261)⟩, ⟨13311, 13321⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4807299850, 4807299857⟩, ⟨221786805, 221786819⟩, ⟨29422079, 29422097⟩, ⟨1663974, 1663994⟩, ⟨143253, 143271⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1218657565, 1218657574⟩, ⟨267109282, 267109300⟩, ⟨7647637, 7647656⟩, ⟨739276, 739297⟩, ⟨41222, 41246⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1111457006), (-1111457005)⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3183510290, 3183510291⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨345782903, 345782909⟩, ⟨151579616, 151579628⟩, ⟨20951745, 20951762⟩, ⟨1370754, 1370774⟩, ⟨128961, 128982⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4640750199, 4640750205⟩, ⟨151579616, 151579628⟩, ⟨20951745, 20951762⟩, ⟨1370754, 1370774⟩, ⟨128961, 128982⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4464512328, 4464512332⟩, ⟨72911602, 72911608⟩, ⟨9482665, 9482675⟩, ⟨504483, 504494⟩, ⟨43721, 43733⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3309180246, 3309180251⟩, ⟨(-177022972), (-177022965)⟩, ⟨3255097, 3255106⟩, ⟨(-116856), (-116846)⟩, ⟨6295, 6306⟩⟩
...
def j47 : Jet := ⟨⟨4656285870, 4656285877⟩, ⟨931257174, 931257179⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨5048000743, 5048000759⟩, ⟨2019200296, 2019200312⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨5048000743, 5048000759⟩, ⟨2019200296, 2019200312⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-5048000759), (-5048000743)⟩, ⟨(-2019200312), (-2019200296)⟩, ⟨(-201920032), (-201920029)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2524000380), (-2524000371)⟩, ⟨(-1009600156), (-1009600148)⟩, ⟨(-100960016), (-100960014)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2386384136, 2386384151⟩, ⟨(-560957429), (-560957420)⟩, ⟨9835223, 9835228⟩, ⟨8020153, 8020155⟩, ⟨(-586913), (-586912)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1838657828, 1838657843⟩, ⟨(-530563776), (-530563761)⟩, ⟨32507064, 32507077⟩, ⟨5283910, 5283923⟩, ⟨(-756555), (-756542)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨889165604, 1333748407⟩, ⟨222291401, 222291402⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2793396129, 4190094198⟩, ⟨698349032, 698349036⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1816791932, 4087781857⟩, ⟨908395964, 1362593960⟩, ⟨113549495, 113549497⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨454, 1025⟩, ⟨227, 342⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94233), (-93661)⟩, ⟨227, 342⟩, ⟨28, 29⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-89688), (-39619)⟩, ⟨(-29800), (-19483)⟩, ⟨(-2433), (-2339)⟩, ⟨11, 20⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5023368, 5073438⟩, ⟨(-29800), (-19483)⟩, ⟨(-2433), (-2339)⟩, ⟨11, 20⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2124908, 4828700⟩, ⟨1034091, 1601326⟩, ⟨121035, 129022⟩, ⟨(-1556), (-989)⟩, ⟨(-63), (-53)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141040669), (-138336876)⟩, ⟨1034091, 1601326⟩, ⟨121035, 129022⟩, ⟨(-1556), (-989)⟩, ⟨(-63), (-53)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-134236992), (-58517167)⟩, ⟨(-44308240), (-27734503)⟩, ⟨(-3458896), (-3026496)⟩, ⟨51457, 82851⟩, ⟨2645, 3181⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1297418773, 1373138599⟩, ⟨(-44308240), (-27734503)⟩, ⟨(-3458896), (-3026496)⟩, ⟨51457, 82851⟩, ⟨2645, 3181⟩⟩
...
def j70 : Jet := ⟨⟨(-103), (-45)⟩, ⟨(-35), (-22)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11732, 11791⟩, ⟨(-35), (-22)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4962, 11223⟩, ⟨2447, 3732⟩, ⟨295, 308⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847215), (-840953)⟩, ⟨2447, 3732⟩, ⟨295, 308⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-806347), (-355727)⟩, ⟨(-267748), (-174311)⟩, ⟨(-21758), (-20754)⟩, ⟨124, 197⟩, ⟨5, 9⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34985047, 35435668⟩, ⟨(-267748), (-174311)⟩, ⟨(-21758), (-20754)⟩, ⟨124, 197⟩, ⟨5, 9⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨14798844, 33726283⟩, ⟨7144588, 11168361⟩, ⟨819273, 891196⟩, ⟨(-13930), (-8809)⟩, ⟨(-548), (-476)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-701029039), (-682101599)⟩, ⟨7144588, 11168361⟩, ⟨819273, 891196⟩, ⟨(-13930), (-8809)⟩, ⟨(-548), (-476)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-667212016), (-288532274)⟩, ⟨(-219381812), (-133636526)⟩, ⟨(-16676015), (-13641857)⟩, ⟨348906, 574277⟩, ⟨16717, 21498⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3627755280, 4006435022⟩, ⟨(-219381812), (-133636526)⟩, ⟨(-16676015), (-13641857)⟩, ⟨348906, 574277⟩, ⟨16717, 21498⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨843825884, 1339609753⟩, ⟨167730135, 205230100⟩, ⟨(-10578828), (-6477945)⟩, ⟨(-528940), (-411271)⟩, ⟨10086, 16576⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4604278859, 5084892076⟩, ⟨153577887, 307499474⟩, ⟨20800168, 41969626⟩, ⟨487866, 3508722⟩, ⟨15733, 369124⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨904595870, 1585989031⟩, ⟨209982811, 338885516⟩, ⟨(-2440262), 20839462⟩, ⟨(-475464), 2427325⟩, ⟨(-108290), 256339⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1333748407), (-889165604)⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2961218889, 3405801692⟩, ⟨(-222291402), (-222291401)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨190523846, 585653169⟩, ⟨88452166, 250278372⟩, ⟨8463934, 42129708⟩, ⟨(-736236), 5081252⟩, ⟨(-166849), 673479⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4485491142, 4880620465⟩, ⟨88452166, 250278372⟩, ⟨8463934, 42129708⟩, ⟨(-736236), 5081252⟩, ⟨(-166849), 673479⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4389195571, 4578439176⟩, ⟨41487846, 122452669⟩, ⟨2332417, 20416553⟩, ⟨(-929810), 2464037⟩, ⟨(-197863), 354832⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3026185751, 3630587807⟩, ⟨(-208358530), (-130066397)⟩, ⟨(-4729577), 14042562⟩, ⟨(-1794002), 1833203⟩, ⟨(-284431), 329497⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3725028696, 5587543051⟩, ⟨931257174, 931257179⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3230720475, 7269121089⟩, ⟨1615360236, 2423040374⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3230720475, 7269121089⟩, ⟨1615360236, 2423040374⟩, ⟨201920029, 201920032⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7269121089), (-3230720475)⟩, ⟨(-2423040374), (-1615360236)⟩, ⟨(-201920032), (-201920029)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3634560545), (-1615360237)⟩, ⟨(-1211520187), (-807680118)⟩, ⟨(-100960016), (-100960014)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1842653896, 2948623873⟩, ⟨(-831744948), (-346516006)⟩, ⟨(-36730448), 73994402⟩, ⟨(-1527152), 16487953⟩, ⟨(-2032405), 539399⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1298313253, 2492507427⟩, ⟨(-846128447), (-299953192)⟩, ⟨(-23801992), 112538825⟩, ⟨(-8831616), 17893803⟩, ⟨(-3188259), 1345604⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1111457005, 1111457006⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4464512328, 4464512332⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified50
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨889165604, 1333748407⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4389195571, 4578439176⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified51
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (191473557 / 4294967296)

theorem envelope_integral : (∫ s in ((8281 / 40000) : ℝ)..(24843 / 80000),
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((8281 / 40000) : ℝ)..(24843 / 80000), prawitzNormalCorrection
