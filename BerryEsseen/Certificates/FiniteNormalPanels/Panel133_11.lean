...
namespace FiniteNormalPanel133_11

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (13601 / 80000)
def radius : Rat := (13601 / 400000)

def j0 : Jet := ⟨⟨730198127, 730198128⟩, ⟨146039625, 146039626⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2293985071, 2293985075⟩, ⟨458797013, 458797017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1225240413, 1225240418⟩, ⟨490096164, 490096170⟩, ⟨49009616, 49009618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨306, 307⟩, ⟨122, 123⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94381), (-94379)⟩, ⟨122, 123⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-26925), (-26923)⟩, ⟨(-10736), (-10733)⟩, ⟨(-1061), (-1057)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5086131, 5086134⟩, ⟨(-10736), (-10733)⟩, ⟨(-1061), (-1057)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1450938, 1450940⟩, ⟨577312, 577315⟩, ⟨56508, 56513⟩, ⟨(-245), (-240)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-141714639), (-141714636)⟩, ⟨577312, 577315⟩, ⟨56508, 56513⟩, ⟨(-245), (-240)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-40427434), (-40427432)⟩, ⟨(-16006283), (-16006279)⟩, ⟨(-1535102), (-1535097)⟩, ⟨12965, 12969⟩, ⟨612, 616⟩⟩
...
def j19 : Jet := ⟨⟨1391228331, 1391228334⟩, ⟨(-16006283), (-16006279)⟩, ⟨(-1535102), (-1535097)⟩, ⟨12965, 12969⟩, ⟨612, 616⟩⟩
...
def j25 : Jet := ⟨⟨3367, 3368⟩, ⟨1342, 1345⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848810), (-848808)⟩, ⟨1342, 1345⟩, ⟨131, 134⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-242144), (-242142)⟩, ⟨(-96476), (-96472)⟩, ⟨(-9496), (-9492)⟩, ⟨28, 32⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35549250, 35549253⟩, ⟨(-96476), (-96472)⟩, ⟨(-9496), (-9492)⟩, ⟨28, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10141259, 10141261⟩, ⟨4028980, 4028985⟩, ⟨391932, 391936⟩, ⟨(-2178), (-2173)⟩, ⟨(-107), (-103)⟩⟩
...
def j33 : Jet := ⟨⟨(-705686624), (-705686621)⟩, ⟨4028980, 4028985⟩, ⟨391932, 391936⟩, ⟨(-2178), (-2173)⟩, ⟨(-107), (-103)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-201313704), (-201313702)⟩, ⟨(-79376121), (-79376117)⟩, ⟨(-7480998), (-7480993)⟩, ⟨90075, 90080⟩, ⟨4192, 4197⟩⟩
...
def j36 : Jet := ⟨⟨4093653592, 4093653594⟩, ⟨(-79376121), (-79376117)⟩, ⟨(-7480998), (-7480993)⟩, ⟨90075, 90080⟩, ⟨4192, 4197⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨743068992, 743068996⟩, ⟨140064681, 140064686⟩, ⟨(-2529738), (-2529732)⟩, ⟨(-157059), (-157055)⟩, ⟨1710, 1716⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4506181006, 4506181010⟩, ⟨87375040, 87375047⟩, ⟨9929074, 9929085⟩, ⟨253041, 253050⟩, ⟨16506, 16517⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨779610913, 779610919⟩, ⟨162069333, 162069341⟩, ⟨1913095, 1913107⟩, ⟨151331, 151340⟩, ⟨3856, 3869⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-730198128), (-730198127)⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3564769168, 3564769169⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨141512876, 141512879⟩, ⟨58836778, 58836784⟩, ⟨6810156, 6810166⟩, ⟨199318, 199324⟩, ⟨13670, 13681⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4436480172, 4436480175⟩, ⟨58836778, 58836784⟩, ⟨6810156, 6810166⟩, ⟨199318, 199324⟩, ⟨13670, 13681⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4365150312, 4365150314⟩, ⟨28945399, 28945403⟩, ⟨3254362, 3254368⟩, ⟨76476, 76481⟩, ⟨5004, 5012⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3623020193, 3623020197⟩, ⟨(-124401706), (-124401699)⟩, ⟨1716862, 1716870⟩, ⟨(-47183), (-47177)⟩, ⟨1552, 1560⟩⟩
...
def j47 : Jet := ⟨⟨7182033221, 7182033233⟩, ⟨1436406640, 1436406651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12009777405, 12009777446⟩, ⟨4803910948, 4803910994⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12009777405, 12009777446⟩, ⟨4803910948, 4803910994⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12009777446), (-12009777405)⟩, ⟨(-4803910994), (-4803910948)⟩, ⟨(-480391101), (-480391093)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6004888723), (-6004888702)⟩, ⟨(-2401955497), (-2401955474)⟩, ⟨(-240195551), (-240195546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1061116685, 1061116698⟩, ⟨(-593428288), (-593428274)⟩, ⟨106594207, 106594216⟩, ⟨2254040, 2254044⟩, ⟨(-3295778), (-3295776)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨895105110, 895105123⟩, ⟨(-531321253), (-531321236)⟩, ⟨107530093, 107530108⟩, ⟨(-1434932), (-1434920)⟩, ⟨(-2795932), (-2795923)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨584158501, 876237753⟩, ⟨146039625, 146039626⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1835188055, 2752782088⟩, ⟨458797013, 458797017⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨784153863, 1764346200⟩, ⟨392076930, 588115404⟩, ⟨49009616, 49009618⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨196, 443⟩, ⟨98, 148⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94491), (-94243)⟩, ⟨98, 148⟩, ⟨12, 13⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-38817), (-17206)⟩, ⟨(-12922), (-8542)⟩, ⟨(-1069), (-1048)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5074239, 5095851⟩, ⟨(-12922), (-8542)⟩, ⟨(-1069), (-1048)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨926429, 2093345⟩, ⟨457905, 696223⟩, ⟨55691, 57179⟩, ⟨(-295), (-190)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142239148), (-141072231)⟩, ⟨457905, 696223⟩, ⟨55691, 57179⟩, ⟨(-295), (-190)⟩, ⟨(-13), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-58430969), (-25756269)⟩, ⟨(-19393388), (-12592129)⟩, ⟨(-1571115), (-1490942)⟩, ⟨10186, 15741⟩, ⟨588, 635⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1373224796, 1405899497⟩, ⟨(-19393388), (-12592129)⟩, ⟨(-1571115), (-1490942)⟩, ⟨10186, 15741⟩, ⟨588, 635⟩⟩
...
def j72 : Jet := ⟨⟨2152, 4855⟩, ⟨1069, 1618⟩, ⟨130, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-850025), (-847321)⟩, ⟨1069, 1618⟩, ⟨130, 135⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-349186), (-154699)⟩, ⟨(-116201), (-76684)⟩, ⟨(-9580), (-9390)⟩, ⟨22, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35442208, 35636696⟩, ⟨(-116201), (-76684)⟩, ⟨(-9580), (-9390)⟩, ⟨22, 38⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6470862, 14639336⟩, ⟨3187696, 4865779⟩, ⟨384580, 397935⟩, ⟨(-2634), (-1716)⟩, ⟨(-109), (-100)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709357021), (-701188546)⟩, ⟨3187696, 4865779⟩, ⟨384580, 397935⟩, ⟨(-2634), (-1716)⟩, ⟨(-109), (-100)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-291399510), (-128019532)⟩, ⟨(-96551178), (-62010933)⟩, ⟨(-7733222), (-7171472)⟩, ⟨70398, 109701⟩, ⟨3982, 4367⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4003567786, 4166947764⟩, ⟨(-96551178), (-62010933)⟩, ⟨(-7733222), (-7171472)⟩, ⟨70398, 109701⟩, ⟨3982, 4367⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨586762498, 901086013⟩, ⟨134260780, 144800538⟩, ⟨(-3078619), (-1982177)⟩, ⟨(-163478), (-149176)⟩, ⟨1339, 2089⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4426919922, 4607576307⟩, ⟨65879739, 111117620⟩, ⟨8599289, 11579661⟩, ⟨120049, 416051⟩, ⟨8830, 26842⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨604789376, 966671520⟩, ⟨147385867, 178652365⟩, ⟨(-68493), 4132564⟩, ⟨30187, 293522⟩, ⟨(-6193), 15645⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-876237753), (-584158501)⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3418729543, 3710808795⟩, ⟨(-146039626), (-146039625)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨85162508, 217569487⟩, ⟨41507838, 80418846⟩, ⟨5026853, 9291419⟩, ⟨2800, 475924⟩, ⟨(-784), 35441⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4380129804, 4512536783⟩, ⟨41507838, 80418846⟩, ⟨5026853, 9291419⟩, ⟨2800, 475924⟩, ⟨(-784), 35441⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4337339537, 4402408194⟩, ⟨20247419, 39816611⟩, ⟨2272029, 4553066⟩, ⟨(-40412), 225032⟩, ⟨(-4845), 17325⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3452457211, 3803636657⟩, ⟨(-133576245), (-113079233)⟩, ⟨454636, 3245342⟩, ⟨(-189732), 117172⟩, ⟨(-11839), 16344⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5745626571, 8618439874⟩, ⟨1436406640, 1436406651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7686257523, 17294079499⟩, ⟨3843128754, 5764693188⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7686257523, 17294079499⟩, ⟨3843128754, 5764693188⟩, ⟨480391093, 480391101⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17294079499), (-7686257523)⟩, ⟨(-5764693188), (-3843128754)⟩, ⟨(-480391101), (-480391093)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8647039750), (-3843128761)⟩, ⟨(-2882346594), (-1921564377)⟩, ⟨(-240195551), (-240195546)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨573583415, 1755310563⟩, ⟨(-1177986484), (-256620686)⟩, ⟨(-40759613), 363194963⟩, ⟨(-71678891), 53037079⟩, ⟨(-19054096), 13165640⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨461068050, 1554508601⟩, ⟨(-1097819854), (-221382898)⟩, ⟨(-29279739), 359609089⟩, ⟨(-75742298), 48258181⟩, ⟨(-18591631), 14221948⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨730198127, 730198128⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4365150312, 4365150314⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2678
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨584158501, 876237753⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4337339537, 4402408194⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2679
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (63502585 / 4294967296)

theorem envelope_integral : (∫ s in ((13601 / 100000) : ℝ)..(40803 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((13601 / 100000) : ℝ)..(40803 / 200000), prawitzNormalCorrection
