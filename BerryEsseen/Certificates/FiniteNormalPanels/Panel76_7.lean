...
namespace FiniteNormalPanel76_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6253 / 160000)
def radius : Rat := (6253 / 160000)

def j0 : Jet := ⟨⟨167852690, 167852691⟩, ⟨167852690, 167852691⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨527324777, 527324781⟩, ⟨527324777, 527324781⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨64743547, 64743549⟩, ⟨129487094, 129487098⟩, ⟨64743547, 64743549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1428), (-1427)⟩, ⟨(-2855), (-2853)⟩, ⟨(-1428), (-1425)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111628, 5111630⟩, ⟨(-2855), (-2853)⟩, ⟨(-1428), (-1425)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨77054, 77055⟩, ⟨154064, 154066⟩, ⟨76945, 76948⟩, ⟨(-88), (-84)⟩, ⟨(-22), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-143088523), (-143088521)⟩, ⟨154064, 154066⟩, ⟨76945, 76948⟩, ⟨(-88), (-84)⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2156957), (-2156956)⟩, ⟨(-4311592), (-4311590)⟩, ⟨(-2151154), (-2151151)⟩, ⟨4639, 4642⟩, ⟨1155, 1158⟩⟩
...
def j19 : Jet := ⟨⟨1429498808, 1429498810⟩, ⟨(-4311592), (-4311590)⟩, ⟨(-2151154), (-2151151)⟩, ⟨4639, 4642⟩, ⟨1155, 1158⟩⟩
...
def j25 : Jet := ⟨⟨178, 179⟩, ⟨355, 357⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851999), (-851997)⟩, ⟨355, 357⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-12844), (-12843)⟩, ⟨(-25682), (-25680)⟩, ⟨(-12832), (-12829)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778550, 35778552⟩, ⟨(-25682), (-25680)⟩, ⟨(-12832), (-12829)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨539335, 539336⟩, ⟨1078283, 1078285⟩, ⟨538366, 538369⟩, ⟨(-775), (-772)⟩, ⟨(-194), (-191)⟩⟩
...
def j33 : Jet := ⟨⟨(-715288548), (-715288546)⟩, ⟨1078283, 1078285⟩, ⟨538366, 538369⟩, ⟨(-775), (-772)⟩, ⟨(-194), (-191)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10782462), (-10782461)⟩, ⟨(-21548669), (-21548667)⟩, ⟨(-10741839), (-10741836)⟩, ⟨32472, 32476⟩, ⟨8088, 8091⟩⟩
...
def j36 : Jet := ⟨⟨4284184834, 4284184835⟩, ⟨(-21548669), (-21548667)⟩, ⟨(-10741839), (-10741836)⟩, ⟨32472, 32476⟩, ⟨8088, 8091⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨175510100, 175510102⟩, ⟨174980734, 174980737⟩, ⟨(-793480), (-793477)⟩, ⟨(-263545), (-263542)⟩, ⟨710, 713⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305776894, 4305776896⟩, ⟨21657270, 21657274⟩, ⟨10904905, 10904911⟩, ⟨76510, 76519⟩, ⟨19428, 19436⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨175951824, 175951827⟩, ⟨176306131, 176306136⟩, ⟨532477, 532483⟩, ⟨179190, 179197⟩, ⟨1277, 1286⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-167852691), (-167852690)⟩, ⟨(-167852691), (-167852690)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4127114605, 4127114606⟩, ⟨(-167852691), (-167852690)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7208214, 7208215⟩, ⟨14445458, 14445460⟩, ⟨7280899, 7280904⟩, ⟨58394, 58402⟩, ⟨14880, 14885⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302175510, 4302175511⟩, ⟨14445458, 14445460⟩, ⟨7280899, 7280904⟩, ⟨58394, 58402⟩, ⟨14880, 14885⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298569892, 4298569893⟩, ⟨7216675, 7216677⟩, ⟨3631340, 3631344⟩, ⟨23075, 23081⟩, ⟨5860, 5865⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4130576407, 4130576410⟩, ⟨(-161058847), (-161058842)⟩, ⟨3207385, 3207391⟩, ⟨(-119745), (-119738)⟩, ⟨4727, 4735⟩⟩
...
def j47 : Jet := ⟨⟨1419206876, 1419206886⟩, ⟨1419206876, 1419206886⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨468955411, 468955419⟩, ⟨937910822, 937910838⟩, ⟨468955411, 468955419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨468955411, 468955419⟩, ⟨937910822, 937910838⟩, ⟨468955411, 468955419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-468955419), (-468955411)⟩, ⟨(-937910838), (-937910822)⟩, ⟨(-468955419), (-468955411)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-234477710), (-234477705)⟩, ⟨(-468955419), (-468955411)⟩, ⟨(-234477710), (-234477705)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4066775173, 4066775179⟩, ⟨(-444039763), (-444039754)⟩, ⟨(-197778156), (-197778149)⟩, ⟨23359430, 23359433⟩, ⟨4761072, 4761073⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3911118391, 3911118401⟩, ⟨(-579545809), (-579545793)⟩, ⟨(-170519936), (-170519920)⟩, ⟨29436927, 29436942⟩, ⟨3572031, 3572045⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 335705382⟩, ⟨167852690, 167852691⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1054649562⟩, ⟨527324777, 527324781⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 258974196⟩, ⟨0, 258974196⟩, ⟨64743547, 64743549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 65⟩, ⟨0, 65⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94621)⟩, ⟨0, 65⟩, ⟨16, 17⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5710), 0⟩, ⟨(-5710), 4⟩, ⟨(-1428), (-1420)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107346, 5113057⟩, ⟨(-5710), 4⟩, ⟨(-1428), (-1420)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 308303⟩, ⟨(-345), 308304⟩, ⟨76557, 77077⟩, ⟨(-174), 2⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142857273)⟩, ⟨(-345), 308304⟩, ⟨76557, 77077⟩, ⟨(-174), 2⟩, ⟨(-22), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8632474), 0⟩, ⟨(-8632495), 18590⟩, ⟨(-2158140), (-2130232)⟩, ⟨(-17), 9297⟩, ⟨1141, 1163⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423023291, 1431655766⟩, ⟨(-8632495), 18590⟩, ⟨(-2158140), (-2130232)⟩, ⟨(-17), 9297⟩, ⟨1141, 1163⟩⟩
...
def j72 : Jet := ⟨⟨0, 714⟩, ⟨(-1), 714⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851462)⟩, ⟨(-1), 714⟩, ⟨176, 179⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-51384), 0⟩, ⟨(-51385), 44⟩, ⟨(-12847), (-12780)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35740010, 35791395⟩, ⟨(-51385), 44⟩, ⟨(-12847), (-12780)⟩, ⟨(-2), 22⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2158119⟩, ⟨(-3099), 2158122⟩, ⟨534880, 539533⟩, ⟨(-1551), 3⟩, ⟨(-195), (-189)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713669763)⟩, ⟨(-3099), 2158122⟩, ⟨534880, 539533⟩, ⟨(-1551), 3⟩, ⟨(-195), (-189)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-43162367), 0⟩, ⟨(-43162554), 130129⟩, ⟨(-10790779), (-10595397)⟩, ⟨(-141), 65067⟩, ⟨7956, 8135⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4251804929, 4294967296⟩, ⟨(-43162554), 130129⟩, ⟨(-10790779), (-10595397)⟩, ⟨(-141), 65067⟩, ⟨7956, 8135⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 351549855⟩, ⟨172595302, 175779493⟩, ⟨(-1589818), 2283⟩, ⟨(-264976), (-259261)⟩, ⟨(-3), 1428⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4338567828⟩, ⟨(-132786), 44043336⟩, ⟨10594062, 11458089⟩, ⟨(-67085), 228242⟩, ⟨16573, 23364⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 355118628⟩, ⟨172584433, 181168943⟩, ⟨(-1611393), 2742726⟩, ⟨136265, 228415⟩, ⟨(-9710), 12714⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-335705382), 0⟩, ⟨(-167852691), (-167852690)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3959261914, 4294967296⟩, ⟨(-167852691), (-167852690)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 29362096⟩, ⟨0, 29959002⟩, ⟨6668482, 8095563⟩, ⟨(-135944), 269158⟩, ⟨8314, 23126⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4324329392⟩, ⟨0, 29959002⟩, ⟨6668482, 8095563⟩, ⟨(-135944), 269158⟩, ⟨8314, 23126⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309623339⟩, ⟨0, 14979501⟩, ⟨3296868, 4047782⟩, ⟨(-82090), 134579⟩, ⟨1773, 10585⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3959261914, 4309623339⟩, ⟨(-168425468), (-152873189)⟩, ⟨2453758, 4047782⟩, ⟨(-240283), 5734⟩, ⟨(-3626), 13794⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2838413771⟩, ⟨1419206876, 1419206886⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1875821673⟩, ⟨0, 1875821674⟩, ⟨468955411, 468955419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1875821673⟩, ⟨0, 1875821674⟩, ⟨468955411, 468955419⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1875821673), 0⟩, ⟨(-1875821674), 0⟩, ⟨(-468955419), (-468955411)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-937910837), 0⟩, ⟨(-937910837), 0⟩, ⟨(-234477710), (-234477705)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3452399707, 4294967296⟩, ⟨(-937910837), 0⟩, ⟨(-234477710), (-86071060)⟩, ⟨0, 51203926⟩, ⟨(-445943), 6400491⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3182551514, 4309623339⟩, ⟨(-1109536810), (-122883206)⟩, ⟨(-233305447), (-38515940)⟩, ⟨1939360, 60579340⟩, ⟨(-2681269), 6439425⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨167852690, 167852691⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298569892, 4298569893⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1516
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 335705382⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309623339⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1517
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (150680351 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(6253 / 80000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (6253 / 80000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(6253 / 80000), prawitzNormalCorrection
