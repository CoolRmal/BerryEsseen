...
namespace FiniteNormalPanel116_15
...
def j2 : Jet := ⟨⟨1451429198, 1451429202⟩, ⟨483809732, 483809737⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨490491911, 490491914⟩, ⟨326994606, 326994612⟩, ⟨54499101, 54499103⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-10800), (-10799)⟩, ⟨(-7191), (-7189)⟩, ⟨(-1193), (-1190)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102256, 5102258⟩, ⟨(-7191), (-7189)⟩, ⟨(-1193), (-1190)⟩, ⟨1, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨582685, 582686⟩, ⟨387635, 387638⟩, ⟨64057, 64061⟩, ⟨(-183), (-180)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-142582892), (-142582890)⟩, ⟨387635, 387638⟩, ⟨64057, 64061⟩, ⟨(-183), (-180)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16283187), (-16283186)⟩, ⟨(-10811191), (-10811188)⟩, ⟨(-1772417), (-1772413)⟩, ⟨9773, 9777⟩, ⟨796, 799⟩⟩
...
def j19 : Jet := ⟨⟨1415372578, 1415372580⟩, ⟨(-10811191), (-10811188)⟩, ⟨(-1772417), (-1772413)⟩, ⟨9773, 9777⟩, ⟨796, 799⟩⟩
...
def j25 : Jet := ⟨⟨1350, 1351⟩, ⟨898, 901⟩, ⟨148, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850827), (-850825)⟩, ⟨898, 901⟩, ⟨148, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-97166), (-97165)⟩, ⟨(-64676), (-64674)⟩, ⟨(-10713), (-10709)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35694228, 35694230⟩, ⟨(-64676), (-64674)⟩, ⟨(-10713), (-10709)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4076336, 4076337⟩, ⟨2710170, 2710173⟩, ⟨446777, 446782⟩, ⟨(-1635), (-1632)⟩, ⟨(-136), (-132)⟩⟩
...
def j33 : Jet := ⟨⟨(-711751547), (-711751545)⟩, ⟨2710170, 2710173⟩, ⟨446777, 446782⟩, ⟨(-1635), (-1632)⟩, ⟨(-136), (-132)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-81283129), (-81283127)⟩, ⟨(-53879248), (-53879245)⟩, ⟨(-8774100), (-8774096)⟩, ⟨68217, 68220⟩, ⟨5528, 5531⟩⟩
...
def j36 : Jet := ⟨⟨4213684167, 4213684169⟩, ⟨(-53879248), (-53879245)⟩, ⟨(-8774100), (-8774096)⟩, ⟨68217, 68220⟩, ⟨5528, 5531⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨478307038, 478307041⟩, ⟨155782175, 155782179⟩, ⟨(-1816801), (-1816798)⟩, ⟨(-196354), (-196349)⟩, ⟨1368, 1373⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4377818396, 4377818399⟩, ⟨55977984, 55977989⟩, ⟨9831644, 9831651⟩, ⟨171398, 171405⟩, ⟨16008, 16017⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨487533712, 487533716⟩, ⟨165021217, 165021224⟩, ⟨1273417, 1273425⟩, ⟨151867, 151877⟩, ⟨2673, 2685⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-462004264), (-462004263)⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3832963032, 3832963033⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨55341310, 55341312⟩, ⟨37464036, 37464040⟩, ⟨6629542, 6629548⟩, ⟨132330, 132336⟩, ⟨12653, 12660⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4350308606, 4350308608⟩, ⟨37464036, 37464040⟩, ⟨6629542, 6629548⟩, ⟨132330, 132336⟩, ⟨12653, 12660⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4322549385, 4322549387⟩, ⟨18612489, 18612492⟩, ⟨3253547, 3253551⟩, ⟨51732, 51737⟩, ⟨4837, 4843⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3857578150, 3857578153⟩, ⟨(-138380047), (-138380041)⟩, ⟨2236192, 2236197⟩, ⟨(-70494), (-70487)⟩, ⟨2460, 2469⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨37223478887, 37223478894⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value503

def j47 : Jet := ⟨⟨4004083091, 4004083102⟩, ⟨1334694363, 1334694373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3732899529, 3732899551⟩, ⟨2488599684, 2488599712⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3732899529, 3732899551⟩, ⟨2488599684, 2488599712⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3732899551), (-3732899529)⟩, ⟨(-2488599712), (-2488599684)⟩, ⟨(-414766621), (-414766614)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1866449776), (-1866449764)⟩, ⟨(-1244299856), (-1244299842)⟩, ⟨(-207383311), (-207383307)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2781185394, 2781185406⟩, ⟨(-805740385), (-805740371)⟩, ⟨(-17574088), (-17574080)⟩, ⟨27634019, 27634022⟩, ⟨(-1577188), (-1577186)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2497956158, 2497956172⟩, ⟨(-813293056), (-813293037)⟩, ⟨11623889, 11623905⟩, ⟨24920895, 24920908⟩, ⟨(-2301251), (-2301238)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨308002842, 616005685⟩, ⟨154001421, 154001422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨967619465, 1935238935⟩, ⟨483809732, 483809737⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨217996404, 871985624⟩, ⟨217996404, 435992816⟩, ⟨54499101, 54499103⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨54, 219⟩, ⟨54, 110⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94633), (-94467)⟩, ⟨54, 110⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-19213), (-4794)⟩, ⟨(-9605), (-4771)⟩, ⟨(-1199), (-1183)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5093843, 5108263⟩, ⟨(-9605), (-4771)⟩, ⟨(-1199), (-1183)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨258544, 1037105⟩, ⟨256593, 518311⟩, ⟨63416, 64518⟩, ⟨(-244), (-119)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142907033), (-142128471)⟩, ⟨256593, 518311⟩, ⟨63416, 64518⟩, ⟨(-244), (-119)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-29013697), (-7213907)⟩, ⟨(-14493826), (-7108676)⟩, ⟨(-1797116), (-1737761)⟩, ⟨6423, 13121⟩, ⟨775, 813⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1402642068, 1424441859⟩, ⟨(-14493826), (-7108676)⟩, ⟨(-1797116), (-1737761)⟩, ⟨6423, 13121⟩, ⟨775, 813⟩⟩
...
def j72 : Jet := ⟨⟨599, 2402⟩, ⟨596, 1201⟩, ⟨146, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851578), (-849774)⟩, ⟨596, 1201⟩, ⟨146, 151⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-172892), (-43131)⟩, ⟨(-86416), (-42887)⟩, ⟨(-10769), (-10629)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35618502, 35748264⟩, ⟨(-86416), (-42887)⟩, ⟨(-10769), (-10629)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1807861, 7257791⟩, ⟨1790316, 3626720⟩, ⟨441005, 450897⟩, ⟨(-2191), (-1076)⟩, ⟨(-138), (-129)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714020022), (-708570091)⟩, ⟨1790316, 3626720⟩, ⟨441005, 450897⟩, ⟨(-2191), (-1076)⟩, ⟨(-138), (-129)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-144963897), (-35964355)⟩, ⟨(-72391080), (-35228040)⟩, ⟨(-8946992), (-8531386)⟩, ⟨44655, 91738⟩, ⟨5343, 5662⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4150003399, 4259002941⟩, ⟨(-72391080), (-35228040)⟩, ⟨(-8946992), (-8531386)⟩, ⟨44655, 91738⟩, ⟨5343, 5662⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨316003283, 641829182⟩, ⟨151470970, 158855773⟩, ⟨(-2442418), (-1192264)⟩, ⟨(-200991), (-189838)⟩, ⟨897, 1846⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4331235345, 4444994932⟩, ⟨35825504, 77536802⟩, ⟨8972404, 10935489⟩, ⟨50232, 311313⟩, ⟨10807, 23047⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨318671713, 664248938⟩, ⟨155385908, 175991675⟩, ⟨(-604128), 3299657⟩, ⟨68020, 249602⟩, ⟨(-6378), 12798⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-616005685), (-308002842)⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3678961611, 3986964454⟩, ⟨(-154001422), (-154001421)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨23644338, 102731086⟩, ⟨23058192, 54436868⟩, ⟨5434778, 8232114⟩, ⟨(-39418), 347622⟩, ⟨2481, 26951⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4318611634, 4397698382⟩, ⟨23058192, 54436868⟩, ⟨5434778, 8232114⟩, ⟨(-39418), 347622⟩, ⟨2481, 26951⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306773238, 4346029306⟩, ⟨11393639, 27143822⟩, ⟨2600696, 4089704⟩, ⟨(-45432), 166455⟩, ⟨(-1755), 12941⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3689074285, 4034364680⟩, ⟨(-146072809), (-129227466)⟩, ⟨1254415, 3387889⟩, ⟨(-188816), 61268⟩, ⟨(-7599), 13643⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2669388727, 5338777466⟩, ⟨1334694363, 1334694373⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1659066457, 6636265859⟩, ⟨1659066456, 3318132946⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1659066457, 6636265859⟩, ⟨1659066456, 3318132946⟩, ⟨414766614, 414766621⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6636265859), (-1659066457)⟩, ⟨(-3318132946), (-1659066456)⟩, ⟨(-414766621), (-414766614)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3318132930), (-829533228)⟩, ⟨(-1659066473), (-829533228)⟩, ⟨(-207383311), (-207383307)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1983535609, 3540624720⟩, ⟨(-1367677881), (-383101565)⟩, ⟨(-133963475), 168378951⟩, ⟨(-9348472), 61274930⟩, ⟨(-9982449), 4137012⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1703717328, 3325792802⟩, ⟨(-1405109731), (-388738096)⟩, ⟨(-113728945), 207470240⟩, ⟨(-15742334), 62051742⟩, ⟨(-11592174), 4408131⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4322549385, 4322549387⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar503 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2344
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar503 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306773238, 4346029306⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2345
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((5737 / 80000) : ℝ)..(5737 / 40000), prawitzNormalCorrection
      ((62547 / 25000) * sqrt n) s) ≤ (upper : ℝ) :=
