...
namespace FiniteNormalPanel28_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (4561 / 20000)
def radius : Rat := (4561 / 100000)

def j0 : Jet := ⟨⟨979467291, 979467292⟩, ⟨195893458, 195893459⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3077087245, 3077087250⟩, ⟨615417448, 615417452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2204549013, 2204549021⟩, ⟨881819602, 881819612⟩, ⟨88181960, 88181962⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨551, 553⟩, ⟨220, 221⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94136), (-94133)⟩, ⟨220, 221⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-48319), (-48317)⟩, ⟨(-19216), (-19212)⟩, ⟨(-1877), (-1874)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5064737, 5064740⟩, ⟨(-19216), (-19212)⟩, ⟨(-1877), (-1874)⟩, ⟨8, 10⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2599661, 2599664⟩, ⟨1030000, 1030005⟩, ⟨99076, 99082⟩, ⟨(-777), (-772)⟩, ⟨(-38), (-34)⟩⟩
...
def j16 : Jet := ⟨⟨(-140565916), (-140565912)⟩, ⟨1030000, 1030005⟩, ⟨99076, 99082⟩, ⟨(-777), (-772)⟩, ⟨(-38), (-34)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-72150597), (-72150594)⟩, ⟨(-28331554), (-28331549)⟩, ⟨(-2623696), (-2623689)⟩, ⟨41089, 41095⟩, ⟨1854, 1860⟩⟩
...
def j19 : Jet := ⟨⟨1359505168, 1359505172⟩, ⟨(-28331554), (-28331549)⟩, ⟨(-2623696), (-2623689)⟩, ⟨41089, 41095⟩, ⟨1854, 1860⟩⟩
...
def j25 : Jet := ⟨⟨6046, 6048⟩, ⟨2406, 2410⟩, ⟨234, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846131), (-846128)⟩, ⟨2406, 2410⟩, ⟨234, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-434308), (-434306)⟩, ⟨(-172490), (-172484)⟩, ⟨(-16760), (-16755)⟩, ⟨95, 99⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35357086, 35357089⟩, ⟨(-172490), (-172484)⟩, ⟨(-16760), (-16755)⟩, ⟨95, 99⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨18148317, 18148319⟩, ⟨7170789, 7170795⟩, ⟨681914, 681920⟩, ⟨(-6936), (-6930)⟩, ⟨(-325), (-320)⟩⟩
...
def j33 : Jet := ⟨⟨(-697679566), (-697679563)⟩, ⟨7170789, 7170795⟩, ⟨681914, 681920⟩, ⟨(-6936), (-6930)⟩, ⟨(-325), (-320)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-358109550), (-358109546)⟩, ⟨(-139563152), (-139563145)⟩, ⟨(-12502099), (-12502090)⟩, ⟨283671, 283679⟩, ⟨12408, 12415⟩⟩
...
def j36 : Jet := ⟨⟨3936857746, 3936857750⟩, ⟨(-139563152), (-139563145)⟩, ⟨(-12502099), (-12502090)⟩, ⟨283671, 283679⟩, ⟨12408, 12415⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨974004159, 974004165⟩, ⟨174502966, 174502974⟩, ⟨(-5939295), (-5939288)⟩, ⟨(-346508), (-346500)⟩, ⟨7215, 7222⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4685651665, 4685651671⟩, ⟨166108181, 166108192⟩, ⟨20768598, 20768612⟩, ⟨926119, 926135⟩, ⟨72036, 72052⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1062602784, 1062602793⟩, ⟨228046013, 228046027⟩, ⟨4979223, 4979237⟩, ⟨446112, 446130⟩, ⟨19712, 19729⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-979467292), (-979467291)⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3315500004, 3315500005⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨262894825, 262894830⟩, ⟨112840126, 112840136⟩, ⟨14572137, 14572148⟩, ⟨749496, 749510⟩, ⟨62896, 62913⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4557862121, 4557862126⟩, ⟨112840126, 112840136⟩, ⟨14572137, 14572148⟩, ⟨749496, 749510⟩, ⟨62896, 62913⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4424462537, 4424462541⟩, ⟨54768759, 54768765⟩, ⟨6733838, 6733845⟩, ⟨280424, 280432⟩, ⟨21930, 21942⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3415463855, 3415463860⟩, ⟨(-159520995), (-159520986)⟩, ⟨2700182, 2700189⟩, ⟨(-90658), (-90650)⟩, ⟨4137, 4149⟩⟩
...
def j47 : Jet := ⟨⟨5463351012, 5463351019⟩, ⟨1092670201, 1092670208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6949576614, 6949576633⟩, ⟨2779830642, 2779830664⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6949576614, 6949576633⟩, ⟨2779830642, 2779830664⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6949576633), (-6949576614)⟩, ⟨(-2779830664), (-2779830642)⟩, ⟨(-277983068), (-277983063)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3474788317), (-3474788307)⟩, ⟨(-1389915332), (-1389915321)⟩, ⟨(-138991534), (-138991531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1912491303, 1912491314⟩, ⟨(-618910650), (-618910641)⟩, ⟨38253280, 38253285⟩, ⟨9226135, 9226137⟩, ⟨(-1365396), (-1365395)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1520860222, 1520860234⟩, ⟨(-563205564), (-563205550)⟩, ⟨54609496, 54609508⟩, ⟨5486599, 5486609⟩, ⟨(-1389516), (-1389504)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨783573833, 1175360751⟩, ⟨195893458, 195893459⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2461669797, 3692504701⟩, ⟨615417448, 615417452⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1410911369, 3174550591⟩, ⟨705455682, 1058183534⟩, ⟨88181960, 88181962⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨353, 796⟩, ⟨176, 266⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94334), (-93890)⟩, ⟨176, 266⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-69726), (-30843)⟩, ⟨(-23185), (-15224)⟩, ⟨(-1902), (-1843)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5043330, 5082214⟩, ⟨(-23185), (-15224)⟩, ⟨(-1902), (-1843)⟩, ⟨6, 12⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1656751, 3756431⟩, ⟨811238, 1247143⟩, ⟨96427, 101241⟩, ⟨(-945), (-605)⟩, ⟨(-40), (-33)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141508826), (-139409145)⟩, ⟨811238, 1247143⟩, ⟨96427, 101241⟩, ⟨(-945), (-605)⟩, ⟨(-40), (-33)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-104593795), (-45796378)⟩, ⟨(-34598105), (-21976384)⟩, ⟨(-2740461), (-2480173)⟩, ⟨31794, 50352⟩, ⟨1716, 1970⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1327061970, 1385859388⟩, ⟨(-34598105), (-21976384)⟩, ⟨(-2740461), (-2480173)⟩, ⟨31794, 50352⟩, ⟨1716, 1970⟩⟩
...
def j72 : Jet := ⟨⟨3861, 8723⟩, ⟨1910, 2903⟩, ⟨231, 241⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848316), (-843453)⟩, ⟨1910, 2903⟩, ⟨231, 241⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-627019), (-277077)⟩, ⟨(-208380), (-136392)⟩, ⟨(-17030), (-16422)⟩, ⟨74, 120⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35164375, 35514318⟩, ⟨(-208380), (-136392)⟩, ⟨(-17030), (-16422)⟩, ⟨74, 120⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨11551616, 26249793⟩, ⟨5621787, 8705126⟩, ⟨658047, 701365⟩, ⟨(-8451), (-5408)⟩, ⟨(-338), (-303)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-704276267), (-689578089)⟩, ⟨5621787, 8705126⟩, ⟨658047, 701365⟩, ⟨(-8451), (-5408)⟩, ⟨(-338), (-303)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-520553589), (-226528748)⟩, ⟨(-171671088), (-106830130)⟩, ⟨(-13320265), (-11494896)⟩, ⟨217261, 349754⟩, ⟨11177, 13414⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3774413707, 4068438548⟩, ⟨(-171671088), (-106830130)⟩, ⟨(-13320265), (-11494896)⟩, ⟨217261, 349754⟩, ⟨11177, 13414⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨760608438, 1191462462⟩, ⟨160407140, 185981266⟩, ⟨(-7313547), (-4570469)⟩, ⟨(-374454), (-312089)⟩, ⟨5538, 8909⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4534109058, 4887313768⟩, ⟨119057828, 222288955⟩, ⟨15936844, 27358132⟩, ⟨334706, 1767817⟩, ⟨18590, 156678⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨802958758, 1355784688⟩, ⟨190422836, 273296086⟩, ⟨(-1053369), 12390029⟩, ⟨(-150138), 1218916⟩, ⟨(-44329), 104543⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1175360751), (-783573833)⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3119606545, 3511393463⟩, ⟨(-195893459), (-195893458)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨150115873, 427978142⟩, ⟨71200394, 172541780⟩, ⟨7777606, 25212574⟩, ⟨(-228844), 2346346⟩, ⟨(-50135), 256869⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4445083169, 4722945438⟩, ⟨71200394, 172541780⟩, ⟨7777606, 25212574⟩, ⟨(-228844), 2346346⟩, ⟨(-50135), 256869⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4369380601, 4503875687⟩, ⟨33948912, 84801643⟩, ⟨2910076, 12259708⟩, ⟨(-350412), 1130583⟩, ⟨(-63783), 132080⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3173655904, 3682188608⟩, ⟨(-180763319), (-129957016)⟩, ⟨(-1754099), 8474638⟩, ⟨(-845649), 791592⟩, ⟨(-103713), 123967⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4370680811, 6556021227⟩, ⟨1092670201, 1092670208⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨4447729036, 10007390364⟩, ⟨2223864514, 3335796800⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨4447729036, 10007390364⟩, ⟨2223864514, 3335796800⟩, ⟨277983063, 277983068⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10007390364), (-4447729036)⟩, ⟨(-3335796800), (-2223864514)⟩, ⟨(-277983068), (-277983063)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5003695182), (-2223864518)⟩, ⟨(-1667898400), (-1111932257)⟩, ⟨(-138991534), (-138991531)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1339679447, 2559111520⟩, ⟨(-993799887), (-346832161)⟩, ⟨(-37920639), 149611041⟩, ⟨(-11883875), 26349236⟩, ⟨(-4978920), 1767324⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨989921760, 2193993723⟩, ⟨(-959716765), (-296818716)⟩, ⟨(-23061086), 175141307⟩, ⟨(-18949870), 25063409⟩, ⟨(-5697313), 2580078⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨979467291, 979467292⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4424462537, 4424462541⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified556
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨783573833, 1175360751⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4369380601, 4503875687⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified557
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (140440435 / 4294967296)

theorem envelope_integral : (∫ s in ((4561 / 25000) : ℝ)..(13683 / 50000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((4561 / 25000) : ℝ)..(13683 / 50000), prawitzNormalCorrection
