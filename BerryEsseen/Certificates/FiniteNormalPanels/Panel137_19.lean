...
namespace FiniteNormalPanel137_19
...
def j2 : Jet := ⟨⟨495818536, 495818540⟩, ⟨495818536, 495818540⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨57238158, 57238160⟩, ⟨114476316, 114476320⟩, ⟨57238158, 57238160⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1262), (-1261)⟩, ⟨(-2524), (-2522)⟩, ⟨(-1262), (-1259)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111794, 5111796⟩, ⟨(-2524), (-2522)⟩, ⟨(-1262), (-1259)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨68123, 68124⟩, ⟨136213, 136215⟩, ⟨68038, 68041⟩, ⟨(-68), (-65)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-143097454), (-143097452)⟩, ⟨136213, 136215⟩, ⟨68038, 68041⟩, ⟨(-68), (-65)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1907031), (-1907030)⟩, ⟨(-3812247), (-3812245)⟩, ⟨(-1902495), (-1902492)⟩, ⟨3627, 3630⟩, ⟨903, 906⟩⟩
...
def j19 : Jet := ⟨⟨1429748734, 1429748736⟩, ⟨(-3812247), (-3812245)⟩, ⟨(-1902495), (-1902492)⟩, ⟨3627, 3630⟩, ⟨903, 906⟩⟩
...
def j25 : Jet := ⟨⟨157, 158⟩, ⟨314, 316⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852020), (-852018)⟩, ⟨314, 316⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11355), (-11354)⟩, ⟨(-22706), (-22704)⟩, ⟨(-11345), (-11342)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35780039, 35780041⟩, ⟨(-22706), (-22704)⟩, ⟨(-11345), (-11342)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨476833, 476834⟩, ⟨953363, 953365⟩, ⟨476075, 476078⟩, ⟨(-606), (-603)⟩, ⟨(-152), (-149)⟩⟩
...
def j33 : Jet := ⟨⟨(-715351050), (-715351048)⟩, ⟨953363, 953365⟩, ⟨476075, 476078⟩, ⟨(-606), (-603)⟩, ⟨(-152), (-149)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9533339), (-9533338)⟩, ⟨(-19053973), (-19053970)⟩, ⟨(-9501585), (-9501582)⟩, ⟨25385, 25388⟩, ⟨6324, 6328⟩⟩
...
def j36 : Jet := ⟨⟨4285433957, 4285433958⟩, ⟨(-19053973), (-19053970)⟩, ⟨(-9501585), (-9501582)⟩, ⟨25385, 25388⟩, ⟨6324, 6328⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨165052694, 165052696⟩, ⟨164612601, 164612604⟩, ⟨(-659721), (-659719)⟩, ⟨(-219210), (-219207)⟩, ⟨522, 525⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304521841, 4304521843⟩, ⟨19138838, 19138843⟩, ⟨9628998, 9629004⟩, ⟨59744, 59751⟩, ⟨15142, 15151⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨165419868, 165419871⟩, ⟨165714288, 165714293⟩, ⟨442377, 442383⟩, ⟨148706, 148714⟩, ⟨936, 946⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-157823943), (-157823942)⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4137143353, 4137143354⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6371115, 6371116⟩, ⟨12764910, 12764912⟩, ⟨6427890, 6427894⟩, ⟨45590, 45594⟩, ⟨11591, 11596⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301338411, 4301338412⟩, ⟨12764910, 12764912⟩, ⟨6427890, 6427894⟩, ⟨45590, 45594⟩, ⟨11591, 11596⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298151673, 4298151674⟩, ⟨6377726, 6377728⟩, ⟨3206831, 3206835⟩, ⟨18019, 18023⟩, ⟨4567, 4572⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4140210716, 4140210719⟩, ⟨(-151797589), (-151797584)⟩, ⟨2854633, 2854639⟩, ⟨(-100484), (-100478)⟩, ⟨3736, 3742⟩⟩
...
def j47 : Jet := ⟨⟨1273746555, 1273746565⟩, ⟨1273746555, 1273746565⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨377751487, 377751494⟩, ⟨755502974, 755502988⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨377751487, 377751494⟩, ⟨755502974, 755502988⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-377751494), (-377751487)⟩, ⟨(-755502988), (-755502974)⟩, ⟨(-377751494), (-377751487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-188875747), (-188875743)⟩, ⟨(-377751494), (-377751487)⟩, ⟨(-188875747), (-188875743)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4110184340, 4110184345⟩, ⟨(-361499442), (-361499433)⟩, ⟨(-164852400), (-164852394)⟩, ⟨15431253, 15431255⟩, ⟨3285476, 3285477⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3962085873, 3962085881⟩, ⟨(-493740650), (-493740634)⟩, ⟨(-143404089), (-143404074)⟩, ⟨20365200, 20365211⟩, ⟨2524167, 2524179⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 315647885⟩, ⟨157823942, 157823943⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 991637077⟩, ⟨495818536, 495818540⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 228952638⟩, ⟨0, 228952640⟩, ⟨57238158, 57238160⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5048), 0⟩, ⟨(-5048), 4⟩, ⟨(-1262), (-1256)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108008, 5113057⟩, ⟨(-5048), 4⟩, ⟨(-1262), (-1256)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 272563⟩, ⟨(-270), 272564⟩, ⟨67735, 68142⟩, ⟨(-136), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142893013)⟩, ⟨(-270), 272564⟩, ⟨67735, 68142⟩, ⟨(-136), 2⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7631755), 0⟩, ⟨(-7631770), 14530⟩, ⟨(-1907954), (-1886143)⟩, ⟨(-12), 7267⟩, ⟨893, 910⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424024010, 1431655766⟩, ⟨(-7631770), 14530⟩, ⟨(-1907954), (-1886143)⟩, ⟨(-12), 7267⟩, ⟨893, 910⟩⟩
...
def j72 : Jet := ⟨⟨0, 631⟩, ⟨(-1), 631⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851545)⟩, ⟨(-1), 631⟩, ⟨155, 158⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-45428), 0⟩, ⟨(-45429), 34⟩, ⟨(-11358), (-11305)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35745966, 35791395⟩, ⟨(-45429), 34⟩, ⟨(-11358), (-11305)⟩, ⟨(-2), 18⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1907939⟩, ⟨(-2422), 1907941⟩, ⟨473351, 476987⟩, ⟨(-1213), 2⟩, ⟨(-153), (-148)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713919943)⟩, ⟨(-2422), 1907941⟩, ⟨473351, 476987⟩, ⟨(-1213), 2⟩, ⟨(-153), (-148)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-38158774), 0⟩, ⟨(-38158904), 101707⟩, ⟨(-9539824), (-9387132)⟩, ⟨(-98), 50855⟩, ⟨6234, 6358⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4256808522, 4294967296⟩, ⟨(-38158904), 101707⟩, ⟨(-9539824), (-9387132)⟩, ⟨(-98), 50855⟩, ⟨6234, 6358⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 330545693⟩, ⟨162629772, 165276202⟩, ⟨(-1321541), 1678⟩, ⟨(-220261), (-216061)⟩, ⟨(-2), 1050⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4333468132⟩, ⟨(-103539), 38846098⟩, ⟨9386212, 10059850⟩, ⟨(-52245), 177337⟩, ⟨13174, 17848⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 333508763⟩, ⟨162621803, 169747409⟩, ⟨(-1337373), 2270763⟩, ⟨117200, 184737⟩, ⟨(-7103), 9269⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-315647885), 0⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3979319411, 4294967296⟩, ⟨(-157823943), (-157823942)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 25897309⟩, ⟨0, 26362134⟩, ⟨5949706, 7061481⟩, ⟨(-105714), 208186⟩, ⟨7062, 17245⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4320864605⟩, ⟨0, 26362134⟩, ⟨5949706, 7061481⟩, ⟨(-105714), 208186⟩, ⟨7062, 17245⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307896491⟩, ⟨0, 13181067⟩, ⟨2945758, 3530741⟩, ⟨(-63693), 104093⟩, ⟨1754, 7809⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3979319411, 4307896491⟩, ⟨(-158299043), (-144642875)⟩, ⟨2244911, 3530741⟩, ⟨(-193435), (-4152)⟩, ⟨(-2201), 10150⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2547493121⟩, ⟨1273746555, 1273746565⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1511005965⟩, ⟨0, 1511005970⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1511005965⟩, ⟨0, 1511005970⟩, ⟨377751487, 377751494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1511005965), 0⟩, ⟨(-1511005970), 0⟩, ⟨(-377751494), (-377751487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-755502983), 0⟩, ⟨(-755502985), 0⟩, ⟨(-188875747), (-188875743)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3602181718, 4294967296⟩, ⟨(-755502985), 0⟩, ⟨(-188875747), (-91961670)⟩, ⟨0, 33224046⟩, ⟨560993, 4153006⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3337448377, 4307896491⟩, ⟨(-916076329), (-121311731)⟩, ⟨(-187561520), (-53826961)⟩, ⟨2282512, 40281948⟩, ⟨(-862241), 4161619⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298151673, 4298151674⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2762
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307896491⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2763
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (287731725 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(29397 / 400000), prawitzNormalCorrection
