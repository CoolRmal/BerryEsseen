...
namespace FiniteNormalPanel105_12
...
def j2 : Jet := ⟨⟨483050749, 483050753⟩, ⟨483050749, 483050753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨54328242, 54328244⟩, ⟨108656484, 108656488⟩, ⟨54328242, 54328244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1198), (-1197)⟩, ⟨(-2396), (-2394)⟩, ⟨(-1198), (-1195)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111858, 5111860⟩, ⟨(-2396), (-2394)⟩, ⟨(-1198), (-1195)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨64661, 64662⟩, ⟨129291, 129293⟩, ⟨64584, 64587⟩, ⟨(-62), (-59)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-143100916), (-143100914)⟩, ⟨129291, 129293⟩, ⟨64584, 64587⟩, ⟨(-62), (-59)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1810124), (-1810123)⟩, ⟨(-3618613), (-3618610)⟩, ⟨(-1806038), (-1806035)⟩, ⟨3267, 3270⟩, ⟨813, 816⟩⟩
...
def j19 : Jet := ⟨⟨1429845641, 1429845643⟩, ⟨(-3618613), (-3618610)⟩, ⟨(-1806038), (-1806035)⟩, ⟨3267, 3270⟩, ⟨813, 816⟩⟩
...
def j28 : Jet := ⟨⟨(-10778), (-10777)⟩, ⟨(-21553), (-21551)⟩, ⟨(-10770), (-10767)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780616, 35780618⟩, ⟨(-21553), (-21551)⟩, ⟨(-10770), (-10767)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨452599, 452600⟩, ⟨904925, 904927⟩, ⟨451916, 451919⟩, ⟨(-546), (-543)⟩, ⟨(-138), (-134)⟩⟩
...
def j33 : Jet := ⟨⟨(-715375284), (-715375282)⟩, ⟨904925, 904927⟩, ⟨451916, 451919⟩, ⟨(-546), (-543)⟩, ⟨(-138), (-134)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9048983), (-9048981)⟩, ⟨(-18086519), (-18086516)⟩, ⟨(-9020374), (-9020370)⟩, ⟨22871, 22874⟩, ⟨5700, 5703⟩⟩
...
def j36 : Jet := ⟨⟨4285918313, 4285918315⟩, ⟨(-18086519), (-18086516)⟩, ⟨(-9020374), (-9020370)⟩, ⟨22871, 22874⟩, ⟨5700, 5703⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨160813333, 160813335⟩, ⟨160406351, 160406354⟩, ⟨(-610106), (-610103)⟩, ⟨(-202757), (-202754)⟩, ⟨458, 460⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304035382, 4304035385⟩, ⟨18162969, 18162974⟩, ⟨9135145, 9135153⟩, ⟨53804, 53812⟩, ⟨13626, 13634⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨161152862, 161152865⟩, ⟨161425083, 161425089⟩, ⟨408986, 408992⟩, ⟨137421, 137429⟩, ⟨821, 828⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-153759830), (-153759829)⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4141207466, 4141207467⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6046668, 6046670⟩, ⟨12113764, 12113768⟩, ⟨6097804, 6097807⟩, ⟨41054, 41058⟩, ⟨10426, 10435⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301013964, 4301013966⟩, ⟨12113764, 12113768⟩, ⟨6097804, 6097807⟩, ⟨41054, 41058⟩, ⟨10426, 10435⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297989566, 4297989568⟩, ⟨6052622, 6052625⟩, ⟨3042496, 3042499⟩, ⟨16227, 16231⟩, ⟨4109, 4116⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4144121538, 4144121542⟩, ⟨(-148032090), (-148032084)⟩, ⟨2716890, 2716895⟩, ⟨(-93276), (-93271)⟩, ⟨3379, 3389⟩⟩
...
def j47 : Jet := ⟨⟨1397723699, 1397723710⟩, ⟨1397723699, 1397723710⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨454865288, 454865296⟩, ⟨909730576, 909730592⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨454865288, 454865296⟩, ⟨909730576, 909730592⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-454865296), (-454865288)⟩, ⟨(-909730592), (-909730576)⟩, ⟨(-454865296), (-454865288)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-227432648), (-227432644)⟩, ⟨(-454865296), (-454865288)⟩, ⟨(-227432648), (-227432644)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4073451404, 4073451409⟩, ⟨(-431405307), (-431405297)⟩, ⟨(-192858325), (-192858318)⟩, ⟨22037874, 22037876⟩, ⟨4522751, 4522753⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3930385619, 3930385629⟩, ⟨(-556650934), (-556650916)⟩, ⟨(-168639096), (-168639080)⟩, ⟨27549639, 27549651⟩, ⟨3494912, 3494930⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 307519659⟩, ⟨153759829, 153759830⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 966101502⟩, ⟨483050749, 483050753⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 217312974⟩, ⟨0, 217312974⟩, ⟨54328242, 54328244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4791), 0⟩, ⟨(-4791), 3⟩, ⟨(-1198), (-1193)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108265, 5113057⟩, ⟨(-4791), 3⟩, ⟨(-1198), (-1193)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 258706⟩, ⟨(-243), 258707⟩, ⟨64311, 64678⟩, ⟨(-122), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142906870)⟩, ⟨(-243), 258707⟩, ⟨64311, 64678⟩, ⟨(-122), 2⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7243766), 0⟩, ⟨(-7243779), 13090⟩, ⟨(-1810955), (-1791305)⟩, ⟨(-11), 6547⟩, ⟨805, 820⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424411999, 1431655766⟩, ⟨(-7243779), 13090⟩, ⟨(-1810955), (-1791305)⟩, ⟨(-11), 6547⟩, ⟨805, 820⟩⟩
...
def j74 : Jet := ⟨⟨(-43118), 0⟩, ⟨(-43119), 31⟩, ⟨(-10781), (-10732)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35748276, 35791395⟩, ⟨(-43119), 31⟩, ⟨(-10781), (-10732)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1810942⟩, ⟨(-2182), 1810944⟩, ⟨449461, 452738⟩, ⟨(-1093), 2⟩, ⟨(-139), (-133)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714016940)⟩, ⟨(-2182), 1810944⟩, ⟨449461, 452738⟩, ⟨(-1093), 2⟩, ⟨(-139), (-133)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-36218830), 0⟩, ⟨(-36218941), 91629⟩, ⟨(-9054819), (-8917262)⟩, ⟨(-84), 45817⟩, ⟨5621, 5728⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4258748466, 4294967296⟩, ⟨(-36218941), 91629⟩, ⟨(-9054819), (-8917262)⟩, ⟨(-84), 45817⟩, ⟨5621, 5728⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 322033835⟩, ⟨158572815, 161019863⟩, ⟨(-1222054), 1473⟩, ⟨(-203680), (-199993)⟩, ⟨(-2), 922⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4331494152⟩, ⟨(-93195), 36837615⟩, ⟨8916476, 9522780⟩, ⟨(-47005), 159398⟩, ⟨11945, 15937⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 324772595⟩, ⟨158565827, 165151329⟩, ⟨(-1235942), 2096554⟩, ⟨109781, 168999⟩, ⟨(-6223), 8110⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-307519659), 0⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3987447637, 4294967296⟩, ⟨(-153759830), (-153759829)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 24558334⟩, ⟨0, 24976502⟩, ⟨5667171, 6667519⟩, ⟨(-95050), 186796⟩, ⟨6560, 15250⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4319525630⟩, ⟨0, 24976502⟩, ⟨5667171, 6667519⟩, ⟨(-95050), 186796⟩, ⟨6560, 15250⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307228961⟩, ⟨0, 12488251⟩, ⟨2807414, 3333760⟩, ⟨(-57219), 93398⟩, ⟨1709, 6875⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3987447637, 4307228961⟩, ⟨(-154198798), (-141271578)⟩, ⟨2159323, 3333760⟩, ⟨(-176568), (-7107)⟩, ⟨(-1758), 8924⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2795447410⟩, ⟨1397723699, 1397723710⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1819461171⟩, ⟨0, 1819461178⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1819461171⟩, ⟨0, 1819461178⟩, ⟨454865288, 454865296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1819461171), 0⟩, ⟨(-1819461178), 0⟩, ⟨(-454865296), (-454865288)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-909730586), 0⟩, ⟨(-909730589), 0⟩, ⟨(-227432648), (-227432644)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3475126158, 4294967296⟩, ⟨(-909730589), 0⟩, ⟨(-227432648), (-87672904)⟩, ⟨0, 48173228⟩, ⟨(-229647), 6021654⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3226307124, 4307228961⟩, ⟨(-1066526569), (-114305074)⟩, ⟨(-226334802), (-45400429)⟩, ⟨2001065, 56470342⟩, ⟨(-2138121), 6041092⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297989566, 4297989568⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2118
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307228961⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2119
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (277477267 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(179 / 2500), prawitzNormalCorrection
