...
namespace FiniteNormalPanel25_15
...
def j2 : Jet := ⟨⟨607726418, 607726422⟩, ⟨607726418, 607726422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨85991667, 85991669⟩, ⟨171983334, 171983338⟩, ⟨85991667, 85991669⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1896), (-1895)⟩, ⟨(-3791), (-3789)⟩, ⟨(-1895), (-1892)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111160, 5111162⟩, ⟨(-3791), (-3789)⟩, ⟨(-1895), (-1892)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨102333, 102334⟩, ⟨204590, 204592⟩, ⟨102143, 102146⟩, ⟨(-152), (-149)⟩, ⟨(-38), (-35)⟩⟩
...
def j16 : Jet := ⟨⟨(-143063244), (-143063242)⟩, ⟨204590, 204592⟩, ⟨102143, 102146⟩, ⟨(-152), (-149)⟩, ⟨(-38), (-35)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2864341), (-2864340)⟩, ⟨(-5724585), (-5724583)⟩, ⟨(-2854104), (-2854101)⟩, ⟨8182, 8186⟩, ⟨2037, 2041⟩⟩
...
def j19 : Jet := ⟨⟨1428791424, 1428791426⟩, ⟨(-5724585), (-5724583)⟩, ⟨(-2854104), (-2854101)⟩, ⟨8182, 8186⟩, ⟨2037, 2041⟩⟩
...
def j25 : Jet := ⟨⟨236, 237⟩, ⟨472, 474⟩, ⟨234, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851941), (-851939)⟩, ⟨472, 474⟩, ⟨234, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-17058), (-17057)⟩, ⟨(-34106), (-34104)⟩, ⟨(-17036), (-17033)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35774336, 35774338⟩, ⟨(-34106), (-34104)⟩, ⟨(-17036), (-17033)⟩, ⟨17, 20⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨716255, 716256⟩, ⟨1431828, 1431830⟩, ⟨714547, 714550⟩, ⟨(-1366), (-1363)⟩, ⟨(-342), (-339)⟩⟩
...
def j33 : Jet := ⟨⟨(-715111628), (-715111626)⟩, ⟨1431828, 1431830⟩, ⟨714547, 714550⟩, ⟨(-1366), (-1363)⟩, ⟨(-342), (-339)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-14317605), (-14317603)⟩, ⟨(-28606542), (-28606539)⟩, ⟨(-14245965), (-14245961)⟩, ⟨57251, 57254⟩, ⟨14244, 14247⟩⟩
...
def j36 : Jet := ⟨⟨4280649691, 4280649693⟩, ⟨(-28606542), (-28606539)⟩, ⟨(-14245965), (-14245961)⟩, ⟨57251, 57254⟩, ⟨14244, 14247⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨202170176, 202170178⟩, ⟨201360162, 201360165⟩, ⟨(-1213863), (-1213860)⟩, ⟨(-402692), (-402688)⟩, ⟨1445, 1448⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4309332787, 4309332790⟩, ⟨28798221, 28798226⟩, ⟨14533867, 14533874⟩, ⟨135327, 135334⟩, ⟨34544, 34552⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨202846379, 202846383⟩, ⟨203389228, 203389234⟩, ⟨816346, 816352⟩, ⟨275579, 275587⟩, ⟨2610, 2618⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-193445328), (-193445327)⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4101521968, 4101521969⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨9580201, 9580203⟩, ⟨19211678, 19211682⟩, ⟨9708656, 9708660⟩, ⟨103346, 103350⟩, ⟨26501, 26506⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4304547497, 4304547499⟩, ⟨19211678, 19211682⟩, ⟨9708656, 9708660⟩, ⟨103346, 103350⟩, ⟨26501, 26506⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299754728, 4299754730⟩, ⟨9595143, 9595146⟩, ⟨4838217, 4838220⟩, ⟨40818, 40822⟩, ⟨10421, 10426⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4106093774, 4106093777⟩, ⟨(-184497978), (-184497971)⟩, ⟨4188137, 4188142⟩, ⟨(-178935), (-178929)⟩, ⟨8112, 8119⟩⟩
...
def j47 : Jet := ⟨⟨1154210888, 1154210895⟩, ⟨1154210888, 1154210895⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨310177629, 310177634⟩, ⟨620355258, 620355268⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨310177629, 310177634⟩, ⟨620355258, 620355268⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-310177634), (-310177629)⟩, ⟨(-620355268), (-620355258)⟩, ⟨(-310177634), (-310177629)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-155088817), (-155088814)⟩, ⟨(-310177634), (-310177629)⟩, ⟨(-155088817), (-155088814)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4142645162, 4142645166⟩, ⟨(-299177104), (-299177098)⟩, ⟨(-138785438), (-138785434)⟩, ⟨10543050, 10543052⟩, ⟨2315379, 2315380⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3960470088, 3960470096⟩, ⟨(-463975339), (-463975324)⟩, ⟨(-115790986), (-115790974)⟩, ⟨15576862, 15576874⟩, ⟨1645615, 1645629⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 386890655⟩, ⟨193445327, 193445328⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1215452840⟩, ⟨607726418, 607726422⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 343966672⟩, ⟨0, 343966674⟩, ⟨85991667, 85991669⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-7584), 0⟩, ⟨(-7584), 7⟩, ⟨(-1896), (-1885)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5105472, 5113057⟩, ⟨(-7584), 7⟩, ⟨(-1896), (-1885)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 409485⟩, ⟨(-608), 409486⟩, ⟨101459, 102373⟩, ⟨(-304), 2⟩, ⟨(-38), (-35)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142756091)⟩, ⟨(-608), 409486⟩, ⟨101459, 102373⟩, ⟨(-304), 2⟩, ⟨(-38), (-35)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-11465556), 0⟩, ⟨(-11465605), 32795⟩, ⟨(-2866438), (-2817196)⟩, ⟨(-38), 16399⟩, ⟨2002, 2051⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1420190209, 1431655766⟩, ⟨(-11465605), 32795⟩, ⟨(-2866438), (-2817196)⟩, ⟨(-38), 16399⟩, ⟨2002, 2051⟩⟩
...
def j72 : Jet := ⟨⟨0, 948⟩, ⟨(-1), 948⟩, ⟨234, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851228)⟩, ⟨(-1), 948⟩, ⟨234, 237⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-68248), 0⟩, ⟨(-68249), 76⟩, ⟨(-17063), (-16947)⟩, ⟨(-2), 38⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35723146, 35791395⟩, ⟨(-68249), 76⟩, ⟨(-17063), (-16947)⟩, ⟨(-2), 38⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2866390⟩, ⟨(-5466), 2866397⟩, ⟨708397, 716605⟩, ⟨(-2735), 6⟩, ⟨(-343), (-334)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712961492)⟩, ⟨(-5466), 2866397⟩, ⟨708397, 716605⟩, ⟨(-2735), 6⟩, ⟨(-343), (-334)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-57327779), 0⟩, ⟨(-57328218), 229559⟩, ⟨(-14332383), (-13987605)⟩, ⟨(-330), 114782⟩, ⟨13935, 14349⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4237639517, 4294967296⟩, ⟨(-57328218), 229559⟩, ⟨(-14332383), (-13987605)⟩, ⟨(-330), 114782⟩, ⟨13935, 14349⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 405150947⟩, ⟨197708421, 202584756⟩, ⟨(-2433540), 4641⟩, ⟨(-405605), (-393984)⟩, ⟨(-6), 2902⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4353070619⟩, ⟨(-235813), 58889810⟩, ⟨13984457, 15519472⟩, ⟨(-119548), 409469⟩, ⟨27829, 43914⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 410631924⟩, ⟨197686176, 210880539⟩, ⟨(-2477585), 4246391⟩, ⟨188001, 376798⟩, ⟨(-20002), 26439⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-386890655), 0⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3908076641, 4294967296⟩, ⟨(-193445328), (-193445327)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 39259572⟩, ⟨0, 40323606⟩, ⟨8625226, 11166095⟩, ⟨(-243298), 489042⟩, ⟨11030, 46257⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4334226868⟩, ⟨0, 40323606⟩, ⟨8625226, 11166095⟩, ⟨(-243298), 489042⟩, ⟨11030, 46257⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4314552428⟩, ⟨0, 20161803⟩, ⟨4245928, 5583048⟩, ⟨(-147858), 244521⟩, ⟨734, 21725⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3908076641, 4314552428⟩, ⟨(-194327443), (-173283524)⟩, ⟨2955366, 5583048⟩, ⟨(-399319), 53285⟩, ⟨(-10347), 28385⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2308421783⟩, ⟨1154210888, 1154210895⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1240710525⟩, ⟨0, 1240710530⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1240710525⟩, ⟨0, 1240710530⟩, ⟨310177629, 310177634⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1240710525), 0⟩, ⟨(-1240710530), 0⟩, ⟨(-310177634), (-310177629)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-620355263), 0⟩, ⟨(-620355265), 0⟩, ⟨(-155088817), (-155088814)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3717332069, 4294967296⟩, ⟨(-620355265), 0⟩, ⟨(-155088817), (-89429387)⟩, ⟨0, 22400675⟩, ⟨805746, 2800085⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3382474795, 4314552428⟩, ⟨(-817511540), (-149978418)⟩, ⟨(-153238130), (-47722327)⟩, ⟨2402370, 29573162⟩, ⟨(-500009), 2837380⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299754728, 4299754730⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified504
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4314552428⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified505
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (44166681 / 536870912)
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(563 / 6250), prawitzNormalCorrection
