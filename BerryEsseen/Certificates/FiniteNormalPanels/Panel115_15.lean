...
namespace FiniteNormalPanel115_15
...
def j2 : Jet := ⟨⟨1431240240, 1431240244⟩, ⟨477080080, 477080084⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨476941611, 476941615⟩, ⟨317961074, 317961080⟩, ⟨52993512, 52993514⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-10502), (-10501)⟩, ⟨(-6993), (-6991)⟩, ⟨(-1161), (-1158)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102554, 5102556⟩, ⟨(-6993), (-6991)⟩, ⟨(-1161), (-1158)⟩, ⟨0, 3⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨566621, 566622⟩, ⟨376970, 376972⟩, ⟨62310, 62313⟩, ⟨(-173), (-170)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-142598956), (-142598954)⟩, ⟨376970, 376972⟩, ⟨62310, 62313⟩, ⟨(-173), (-170)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-15835133), (-15835132)⟩, ⟨(-10514895), (-10514892)⟩, ⟨(-1724634), (-1724631)⟩, ⟨9243, 9248⟩, ⟨753, 756⟩⟩
...
def j19 : Jet := ⟨⟨1415820632, 1415820634⟩, ⟨(-10514895), (-10514892)⟩, ⟨(-1724634), (-1724631)⟩, ⟨9243, 9248⟩, ⟨753, 756⟩⟩
...
def j25 : Jet := ⟨⟨1312, 1314⟩, ⟨874, 876⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850865), (-850862)⟩, ⟨874, 876⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-94486), (-94485)⟩, ⟨(-62894), (-62892)⟩, ⟨(-10420), (-10416)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35696908, 35696910⟩, ⟨(-62894), (-62892)⟩, ⟨(-10420), (-10416)⟩, ⟨19, 22⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3964021, 3964022⟩, ⟨2635695, 2635698⟩, ⟨434631, 434636⟩, ⟨(-1547), (-1543)⟩, ⟨(-129), (-125)⟩⟩
...
def j33 : Jet := ⟨⟨(-711863862), (-711863860)⟩, ⟨2635695, 2635698⟩, ⟨434631, 434636⟩, ⟨(-1547), (-1543)⟩, ⟨(-129), (-125)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-79050079), (-79050077)⟩, ⟨(-52407368), (-52407365)⟩, ⟨(-8539956), (-8539952)⟩, ⟨64524, 64527⟩, ⟨5232, 5236⟩⟩
...
def j36 : Jet := ⟨⟨4215917217, 4215917219⟩, ⟨(-52407368), (-52407365)⟩, ⟨(-8539956), (-8539952)⟩, ⟨64524, 64527⟩, ⟨5232, 5236⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨471803234, 471803237⟩, ⟨153763796, 153763801⟩, ⟨(-1742695), (-1742692)⟩, ⟨(-188491), (-188488)⟩, ⟨1276, 1280⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4375499592, 4375499595⟩, ⟨54391106, 54391111⟩, ⟨9539335, 9539342⟩, ⟨161788, 161795⟩, ⟨15065, 15074⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨480649726, 480649731⟩, ⟨162621802, 162621810⟩, ⟨1219777, 1219785⟩, ⟨145193, 145201⟩, ⟨2486, 2498⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-455577919), (-455577918)⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3839389377, 3839389378⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨53789503, 53789505⟩, ⟨36398006, 36398010⟩, ⟨6430414, 6430419⟩, ⟨124864, 124872⟩, ⟨11896, 11903⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4348756799, 4348756801⟩, ⟨36398006, 36398010⟩, ⟨6430414, 6430419⟩, ⟨124864, 124872⟩, ⟨11896, 11903⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4321778364, 4321778366⟩, ⟨18086101, 18086104⟩, ⟨3157416, 3157420⟩, ⟨48831, 48837⟩, ⟨4552, 4558⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3863356527, 3863356531⟩, ⟨(-136639617), (-136639612)⟩, ⟨2183020, 2183026⟩, ⟨(-67988), (-67981)⟩, ⟨2342, 2349⟩⟩
...
def j47 : Jet := ⟨⟨4139377375, 4139377386⟩, ⟨1379792458, 1379792468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3989423870, 3989423892⟩, ⟨2659615912, 2659615940⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3989423870, 3989423892⟩, ⟨2659615912, 2659615940⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3989423892), (-3989423870)⟩, ⟨(-2659615940), (-2659615912)⟩, ⟨(-443269326), (-443269318)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1994711946), (-1994711935)⟩, ⟨(-1329807970), (-1329807956)⟩, ⟨(-221634663), (-221634659)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2699357748, 2699357761⟩, ⟨(-835775274), (-835775260)⟩, ⟨(-9909495), (-9909486)⟩, ⟨29775255, 29775258⟩, ⟨(-2049073), (-2049072)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2428093313, 2428093329⟩, ⟨(-837663439), (-837663421)⟩, ⟨19047606, 19047622⟩, ⟨26630798, 26630810⟩, ⟨(-2780763), (-2780750)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨303718612, 607437225⟩, ⟨151859306, 151859307⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨954160160, 1908320324⟩, ⟨477080080, 477080084⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨211974049, 847896203⟩, ⟨211974048, 423948104⟩, ⟨52993512, 52993514⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨53, 213⟩, ⟨53, 107⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94634), (-94473)⟩, ⟨53, 107⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-18683), (-4662)⟩, ⟨(-9340), (-4640)⟩, ⟨(-1166), (-1151)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5094373, 5108395⟩, ⟨(-9340), (-4640)⟩, ⟨(-1166), (-1151)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨251427, 1008481⟩, ⟨249583, 504012⟩, ⟨61703, 62746⟩, ⟨(-232), (-112)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142914150), (-142157095)⟩, ⟨249583, 504012⟩, ⟨61703, 62746⟩, ⟨(-232), (-112)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-28213572), (-7016028)⟩, ⟨(-14094469), (-6916527)⟩, ⟨(-1747987), (-1691868)⟩, ⟨6078, 12408⟩, ⟨735, 770⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1403442193, 1424639738⟩, ⟨(-14094469), (-6916527)⟩, ⟨(-1747987), (-1691868)⟩, ⟨6078, 12408⟩, ⟨735, 770⟩⟩
...
def j72 : Jet := ⟨⟨583, 2336⟩, ⟨580, 1168⟩, ⟨142, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851594), (-849840)⟩, ⟨580, 1168⟩, ⟨142, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-168119), (-41943)⟩, ⟨(-84032), (-41712)⟩, ⟨(-10473), (-10340)⟩, ⟨13, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35623275, 35749452⟩, ⟨(-84032), (-41712)⟩, ⟨(-10473), (-10340)⟩, ⟨13, 30⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1758153, 7057522⟩, ⟨1741563, 3526703⟩, ⟨429175, 438528⟩, ⟨(-2071), (-1018)⟩, ⟨(-131), (-123)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714069730), (-708770360)⟩, ⟨1741563, 3526703⟩, ⟨429175, 438528⟩, ⟨(-2071), (-1018)⟩, ⟨(-131), (-123)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-140968946), (-34980690)⟩, ⟨(-70398521), (-34284461)⟩, ⟨(-8703426), (-8310484)⟩, ⟨42260, 86752⟩, ⟨5064, 5355⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4153998350, 4259986606⟩, ⟨(-70398521), (-34284461)⟩, ⟨(-8703426), (-8310484)⟩, ⟨42260, 86752⟩, ⟨5064, 5355⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨311785523, 632989446⟩, ⟨149630370, 156710804⟩, ⟨(-2342256), (-1144140)⟩, ⟨(-192815), (-182416)⟩, ⟨838, 1722⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4330235228, 4440720126⟩, ⟨34849823, 75257645⟩, ⟨8727997, 10579570⟩, ⟨47796, 292922⟩, ⟨10294, 21500⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨314345735, 654470402⟩, ⟨153388914, 173120322⟩, ⟨(-574034), 3151608⟩, ⟨67138, 235993⟩, ⟨(-5893), 11833⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-607437225), (-303718612)⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3687530071, 3991248684⟩, ⟨(-151859307), (-151859306)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨23006750, 99728701⟩, ⟨22452860, 52760416⟩, ⟨5303132, 7938575⟩, ⟨(-36450), 325992⟩, ⟨2576, 24947⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4317974046, 4394695997⟩, ⟨22452860, 52760416⟩, ⟨5303132, 7938575⟩, ⟨(-36450), 325992⟩, ⟨2576, 24947⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306455307, 4344545498⟩, ⟨11098318, 26309836⟩, ⟨2541642, 3944399⟩, ⟨(-42275), 156012⟩, ⟨(-1476), 11949⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3697393332, 4037320964⟩, ⟨(-144083587), (-127816157)⟩, ⟨1251926, 3273063⟩, ⟨(-178751), 55114⟩, ⟨(-6889), 12600⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2759584917, 5519169845⟩, ⟨1379792458, 1379792468⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1773077276, 7092309133⟩, ⟨1773077274, 3546154584⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1773077276, 7092309133⟩, ⟨1773077274, 3546154584⟩, ⟨443269318, 443269326⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-7092309133), (-1773077276)⟩, ⟨(-3546154584), (-1773077274)⟩, ⟨(-443269326), (-443269318)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3546154567), (-886538638)⟩, ⟨(-1773077292), (-886538637)⟩, ⟨(-221634663), (-221634659)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1880975432, 3493941887⟩, ⟨(-1442392595), (-388258461)⟩, ⟨(-140228209), 200664493⟩, ⟨(-14256267), 68918170⟩, ⟨(-12290295), 5089465⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1619268679, 3284347437⟩, ⟨(-1473077933), (-390215612)⟩, ⟨(-119713542), 239677719⟩, ⟨(-21377388), 69419821⟩, ⟨(-13996008), 5485619⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4321778364, 4321778366⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2324
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306455307, 4344545498⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2325
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (43057297 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 12 ≤ n) :
    (∫ s in ((14143 / 200000) : ℝ)..(14143 / 100000), prawitzNormalCorrection
