...
namespace FiniteNormalPanel75_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (38471 / 160000)
def radius : Rat := (38471 / 800000)

def j0 : Jet := ⟨⟨1032698042, 1032698043⟩, ⟨206539608, 206539609⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3244316581, 3244316586⟩, ⟨648863315, 648863319⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2450679912, 2450679921⟩, ⟨980271962, 980271972⟩, ⟨98027196, 98027198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨613, 614⟩, ⟨245, 246⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94074), (-94072)⟩, ⟨245, 246⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-53679), (-53676)⟩, ⟨(-21333), (-21329)⟩, ⟨(-2080), (-2075)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5059377, 5059381⟩, ⟨(-21333), (-21329)⟩, ⟨(-2080), (-2075)⟩, ⟨10, 12⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2886847, 2886850⟩, ⟨1142565, 1142570⟩, ⟨109417, 109423⟩, ⟨(-957), (-952)⟩, ⟨(-46), (-43)⟩⟩
...
def j16 : Jet := ⟨⟨(-140278730), (-140278726)⟩, ⟨1142565, 1142570⟩, ⟨109417, 109423⟩, ⟨(-957), (-952)⟩, ⟨(-46), (-43)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-80042116), (-80042112)⟩, ⟨(-31364907), (-31364901)⟩, ⟨(-2878477), (-2878469)⟩, ⟨50503, 50510⟩, ⟨2251, 2257⟩⟩
...
def j19 : Jet := ⟨⟨1351613649, 1351613654⟩, ⟨(-31364907), (-31364901)⟩, ⟨(-2878477), (-2878469)⟩, ⟨50503, 50510⟩, ⟨2251, 2257⟩⟩
...
def j25 : Jet := ⟨⟨6717, 6719⟩, ⟨2672, 2675⟩, ⟨260, 263⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-845460), (-845457)⟩, ⟨2672, 2675⟩, ⟨260, 263⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-482414), (-482412)⟩, ⟨(-191442), (-191437)⟩, ⟨(-18540), (-18534)⟩, ⟨117, 123⟩, ⟨3, 7⟩⟩
...
def j30 : Jet := ⟨⟨35308980, 35308983⟩, ⟨(-191442), (-191437)⟩, ⟨(-18540), (-18534)⟩, ⟨117, 123⟩, ⟨3, 7⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨20147070, 20147073⟩, ⟨7949592, 7949597⟩, ⟨751608, 751615⟩, ⟨(-8536), (-8528)⟩, ⟨(-397), (-390)⟩⟩
...
def j33 : Jet := ⟨⟨(-695680813), (-695680809)⟩, ⟨7949592, 7949597⟩, ⟨751608, 751615⟩, ⟨(-8536), (-8528)⟩, ⟨(-397), (-390)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-396950869), (-396950865)⟩, ⟨(-154244365), (-154244357)⟩, ⟨(-13634780), (-13634772)⟩, ⟨348113, 348121⟩, ⟨14978, 14987⟩⟩
...
def j36 : Jet := ⟨⟨3898016427, 3898016431⟩, ⟨(-154244365), (-154244357)⟩, ⟨(-13634780), (-13634772)⟩, ⟨348113, 348121⟩, ⟨14978, 14987⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1020976941, 1020976947⟩, ⟨180503079, 180503087⟩, ⟨(-6912796), (-6912787)⟩, ⟨(-396719), (-396710)⟩, ⟨9329, 9336⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4732341281, 4732341287⟩, ⟨187258558, 187258570⟩, ⟨23962948, 23962962⟩, ⟨1180585, 1180601⟩, ⟨95614, 95631⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1124947174, 1124947183⟩, ⟨243398556, 243398570⟩, ⟨5949439, 5949456⟩, ⟨549210, 549229⟩, ⟨26757, 26773⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1032698043), (-1032698042)⟩, ⟨(-206539609), (-206539608)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3262269253, 3262269254⟩, ⟨(-206539609), (-206539608)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨294648610, 294648615⟩, ⟨127502958, 127502968⟩, ⟨16910132, 16910145⟩, ⟨962016, 962032⟩, ⟨84505, 84520⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4589615906, 4589615911⟩, ⟨127502958, 127502968⟩, ⟨16910132, 16910145⟩, ⟨962016, 962032⟩, ⟨84505, 84520⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4439847994, 4439847998⟩, ⟨61671146, 61671152⟩, ⟨7750842, 7750851⟩, ⟨357649, 357659⟩, ⟨29139, 29149⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3372314292, 3372314297⟩, ⟨(-166664037), (-166664030)⟩, ⟨2921511, 2921520⟩, ⟨(-101075), (-101065)⟩, ⟨4932, 4943⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨21452537309, 21452537314⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value374

def j47 : Jet := ⟨⟨5158128513, 5158128520⟩, ⟨1031625700, 1031625706⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6194759569, 6194759587⟩, ⟨2477903820, 2477903840⟩, ⟨247790381, 247790385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6194759569, 6194759587⟩, ⟨2477903820, 2477903840⟩, ⟨247790381, 247790385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6194759587), (-6194759569)⟩, ⟨(-2477903840), (-2477903820)⟩, ⟨(-247790385), (-247790381)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3097379794), (-3097379784)⟩, ⟨(-1238951920), (-1238951910)⟩, ⟨(-123895193), (-123895190)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2088151047, 2088151059⟩, ⟨(-602360527), (-602360518)⟩, ⟨26644202, 26644207⟩, ⟨9022051, 9022053⟩, ⟨(-1034937), (-1034935)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1639570486, 1639570499⟩, ⟨(-553989948), (-553989934)⟩, ⟨45715134, 45715147⟩, ⟨5591121, 5591133⟩, ⟨(-1128013), (-1128000)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨826158434, 1239237652⟩, ⟨206539608, 206539609⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2595453266, 3893179904⟩, ⟨648863315, 648863319⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1568435145, 3528979087⟩, ⟨784217570, 1176326366⟩, ⟨98027196, 98027198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨392, 885⟩, ⟨196, 295⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94295), (-93801)⟩, ⟨196, 295⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-77478), (-34254)⟩, ⟨(-25755), (-16884)⟩, ⟨(-2110), (-2038)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5035578, 5078803⟩, ⟨(-25755), (-16884)⟩, ⟨(-2110), (-2038)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1838891, 4173022⟩, ⟨898283, 1384843⟩, ⟨106142, 112092⟩, ⟨(-1164), (-745)⟩, ⟨(-48), (-41)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141326686), (-138992554)⟩, ⟨898283, 1384843⟩, ⟨106142, 112092⟩, ⟨(-1164), (-745)⟩, ⟨(-48), (-41)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-116121704), (-50757268)⟩, ⟨(-38379201), (-24240770)⟩, ⟨(-3022826), (-2700940)⟩, ⟨38925, 62037⟩, ⟨2063, 2409⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1315534061, 1380898498⟩, ⟨(-38379201), (-24240770)⟩, ⟨(-3022826), (-2700940)⟩, ⟨38925, 62037⟩, ⟨2063, 2409⟩⟩
...
def j70 : Jet := ⟨⟨(-89), (-39)⟩, ⟨(-30), (-19)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11746, 11797⟩, ⟨(-30), (-19)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4289, 9694⟩, ⟨2119, 3226⟩, ⟨256, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-847888), (-842482)⟩, ⟨2119, 3226⟩, ⟨256, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-696671), (-307657)⟩, ⟨(-231451), (-151177)⟩, ⟨(-18873), (-18124)⟩, ⟨92, 148⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35094723, 35483738⟩, ⟨(-231451), (-151177)⟩, ⟨(-18873), (-18124)⟩, ⟨92, 148⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12815882, 29155373⟩, ⟨6217768, 9663252⟩, ⟨722093, 775651⟩, ⟨(-10420), (-6637)⟩, ⟨(-414), (-366)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703012001), (-686672509)⟩, ⟨6217768, 9663252⟩, ⟨722093, 775651⟩, ⟨(-10420), (-6637)⟩, ⟨(-414), (-366)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-577632955), (-250758905)⟩, ⟨(-190273716), (-117439597)⟩, ⟨(-14646367), (-12388494)⟩, ⟨265196, 430569⟩, ⟨13285, 16360⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3717334341, 4044208391⟩, ⟨(-190273716), (-117439597)⟩, ⟨(-14646367), (-12388494)⟩, ⟨265196, 430569⟩, ⟨13285, 16360⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨794978620, 1251717630⟩, ⟨163955766, 193970884⟩, ⟨(-8538194), (-5294360)⟩, ⟨(-433153), (-351811)⟩, ⟨7126, 11557⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4561274368, 4962358073⟩, ⟨132454653, 254000913⟩, ⟨17818749, 32552956⟩, ⟨394859, 2341608⟩, ⟨18930, 222368⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨844270829, 1446220812⟩, ⟨198638496, 298137406⟩, ⟨(-1510454), 15335826⟩, ⟨(-252106), 1615705⟩, ⟨(-64188), 151100⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1239237652), (-826158434)⟩, ⟨(-206539609), (-206539608)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3055729644, 3468808862⟩, ⟨(-206539609), (-206539608)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨165960107, 486978013⟩, ⟨78093580, 200780352⟩, ⟨8169643, 31023263⟩, ⟨(-379480), 3217186⟩, ⟨(-83624), 380831⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4460927403, 4781945309⟩, ⟨78093580, 200780352⟩, ⟨8169643, 31023263⟩, ⟨(-379480), 3217186⟩, ⟨(-83624), 380831⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4377160872, 4531919981⟩, ⟨37005217, 98505067⟩, ⟨2800700, 15063933⟩, ⟨(-525182), 1554711⟩, ⟨(-101937), 197764⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3114207702, 3660182514⟩, ⟨(-191606359), (-130935069)⟩, ⟨(-2744379), 10386777⟩, ⟨(-1148567), 1120973⟩, ⟨(-157094), 184980⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨4126502812, 6189754226⟩, ⟨1031625700, 1031625706⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3964646127, 8920453810⟩, ⟨1982323056, 2973484610⟩, ⟨247790381, 247790385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3964646127, 8920453810⟩, ⟨1982323056, 2973484610⟩, ⟨247790381, 247790385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-8920453810), (-3964646127)⟩, ⟨(-2973484610), (-1982323056)⟩, ⟨(-247790385), (-247790381)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-4460226905), (-1982323063)⟩, ⟨(-1486742305), (-991161528)⟩, ⟨(-123895193), (-123895190)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1520389323, 2707155323⟩, ⟨(-937106634), (-350864465)⟩, ⟨(-37607238), 118335969⟩, ⟨(-6906864), 22360923⟩, ⟨(-3641905), 1140140⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1102408426, 2307044942⟩, ⟨(-919375917), (-300755980)⟩, ⟨(-23082448), 149199148⟩, ⟨(-14155447), 22039115⟩, ⟨(-4535752), 1933136⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1032698042, 1032698043⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4439847994, 4439847998⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar374 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1500
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar374 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨826158434, 1239237652⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4377160872, 4531919981⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1501
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((38471 / 200000) : ℝ)..(115413 / 400000), prawitzNormalCorrection
      ((94393 / 50000) * sqrt n) s) ≤ (upper : ℝ) :=
