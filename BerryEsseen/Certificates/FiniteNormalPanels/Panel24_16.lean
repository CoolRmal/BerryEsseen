...
namespace FiniteNormalPanel24_16

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (54537 / 400000)
def radius : Rat := (18179 / 400000)

def j0 : Jet := ⟨⟨585586578, 585586579⟩, ⟨195195526, 195195527⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1839674491, 1839674495⟩, ⟨613224830, 613224834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨787992550, 787992554⟩, ⟨525328366, 525328372⟩, ⟨87554727, 87554729⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨197, 198⟩, ⟨131, 132⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94490), (-94488)⟩, ⟨131, 132⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-17336), (-17335)⟩, ⟨(-11534), (-11532)⟩, ⟨(-1908), (-1904)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5095720, 5095722⟩, ⟨(-11534), (-11532)⟩, ⟨(-1908), (-1904)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨934905, 934907⟩, ⟨621153, 621156⟩, ⟨102116, 102120⟩, ⟨(-470), (-465)⟩, ⟨(-39), (-36)⟩⟩
...
def j16 : Jet := ⟨⟨(-142230672), (-142230669)⟩, ⟨621153, 621156⟩, ⟨102116, 102120⟩, ⟨(-470), (-465)⟩, ⟨(-39), (-36)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-26094893), (-26094891)⟩, ⟨(-17282634), (-17282631)⟩, ⟨(-2804724), (-2804720)⟩, ⟨25065, 25069⟩, ⟨2015, 2020⟩⟩
...
def j19 : Jet := ⟨⟨1405560872, 1405560875⟩, ⟨(-17282634), (-17282631)⟩, ⟨(-2804724), (-2804720)⟩, ⟨25065, 25069⟩, ⟨2015, 2020⟩⟩
...
def j22 : Jet := ⟨⟨(-20), (-19)⟩, ⟨(-14), (-13)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11815, 11817⟩, ⟨(-14), (-13)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2167, 2169⟩, ⟨1442, 1444⟩, ⟨237, 240⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850010), (-850007)⟩, ⟨1442, 1444⟩, ⟨237, 240⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-155951), (-155949)⟩, ⟨(-103703), (-103701)⟩, ⟨(-17109), (-17105)⟩, ⟨56, 60⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35635443, 35635446⟩, ⟨(-103703), (-103701)⟩, ⟨(-17109), (-17105)⟩, ⟨56, 60⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6537992, 6537993⟩, ⟨4339634, 4339638⟩, ⟨710619, 710623⟩, ⟨(-4198), (-4193)⟩, ⟨(-343), (-339)⟩⟩
...
def j33 : Jet := ⟨⟨(-709289891), (-709289889)⟩, ⟨4339634, 4339638⟩, ⟨710619, 710623⟩, ⟨(-4198), (-4193)⟩, ⟨(-343), (-339)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-130132575), (-130132573)⟩, ⟨(-85958864), (-85958860)⟩, ⟨(-13798009), (-13798003)⟩, ⟨174611, 174616⟩, ⟨13909, 13913⟩⟩
...
def j36 : Jet := ⟨⟨4164834721, 4164834723⟩, ⟨(-85958864), (-85958860)⟩, ⟨(-13798009), (-13798003)⟩, ⟨174611, 174616⟩, ⟨13909, 13913⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨602047536, 602047540⟩, ⟨193279796, 193279800⟩, ⟨(-3668927), (-3668923)⟩, ⟨(-389716), (-389712)⟩, ⟨4441, 4446⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4429165933, 4429165936⟩, ⟨91414444, 91414450⟩, ⟨16560446, 16560455⟩, ⟨458948, 458957⟩, ⟨45706, 45716⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨620858845, 620858850⟩, ⟨212132960, 212132967⟩, ⟨2651580, 2651588⟩, ⟨329594, 329603⟩, ⟨9196, 9208⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-585586579), (-585586578)⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3709380717, 3709380718⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨89748228, 89748230⟩, ⟨61329744, 61329748⟩, ⟨11244068, 11244074⟩, ⟨357216, 357222⟩, ⟨36851, 36862⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4384715524, 4384715526⟩, ⟨61329744, 61329748⟩, ⟨11244068, 11244074⟩, ⟨357216, 357222⟩, ⟨36851, 36862⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4339609403, 4339609405⟩, ⟨30349418, 30349421⟩, ⟨5458073, 5458077⟩, ⟨138598, 138603⟩, ⟨13833, 13841⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3747936207, 3747936211⟩, ⟨(-171012898), (-171012892)⟩, ⟨3334599, 3334605⟩, ⟨(-128355), (-128349)⟩, ⟨5646, 5656⟩⟩
...
def j47 : Jet := ⟨⟨3569431274, 3569431281⟩, ⟨1189810424, 1189810431⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2966457889, 2966457902⟩, ⟨1977638590, 1977638608⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2966457889, 2966457902⟩, ⟨1977638590, 1977638608⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2966457902), (-2966457889)⟩, ⟨(-1977638608), (-1977638590)⟩, ⟨(-329606436), (-329606431)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1483228951), (-1483228944)⟩, ⟨(-988819304), (-988819295)⟩, ⟨(-164803218), (-164803215)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3040745721, 3040745733⟩, ⟨(-700063091), (-700063081)⟩, ⟨(-36090320), (-36090314)⟩, ⟨20677851, 20677853⟩, ⟨(-497738), (-497736)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2653459316, 2653459330⟩, ⟨(-731972640), (-731972625)⟩, ⟨(-1258390), (-1258376)⟩, ⟨18846812, 18846822⟩, ⟨(-1260779), (-1260764)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨390391052, 780782105⟩, ⟨195195526, 195195527⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1226449660, 2452899326⟩, ⟨613224830, 613224834⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨350218910, 1400875651⟩, ⟨350218910, 700437828⟩, ⟨87554727, 87554729⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨87, 351⟩, ⟨87, 176⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94600), (-94335)⟩, ⟨87, 176⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-30856), (-7692)⟩, ⟨(-15421), (-7634)⟩, ⟨(-1921), (-1886)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5082200, 5105365⟩, ⟨(-15421), (-7634)⟩, ⟨(-1921), (-1886)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨414411, 1665201⟩, ⟨409381, 831979⟩, ⟨100460, 103301⟩, ⟨(-629), (-305)⟩, ⟨(-40), (-35)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142751166), (-141500375)⟩, ⟨409381, 831979⟩, ⟨100460, 103301⟩, ⟨(-629), (-305)⟩, ⟨(-40), (-35)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-46560689), (-11538180)⟩, ⟨(-23246964), (-11266816)⟩, ⟨(-2868472), (-2715169)⟩, ⟨16330, 33784⟩, ⟨1930, 2080⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1385095076, 1420117586⟩, ⟨(-23246964), (-11266816)⟩, ⟨(-2868472), (-2715169)⟩, ⟨16330, 33784⟩, ⟨1930, 2080⟩⟩
...
def j70 : Jet := ⟨⟨(-36), (-8)⟩, ⟨(-18), (-8)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11799, 11828⟩, ⟨(-18), (-8)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨962, 3858⟩, ⟨956, 1929⟩, ⟨236, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851215), (-848318)⟩, ⟨956, 1929⟩, ⟨236, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-277639), (-69173)⟩, ⟨(-138743), (-68543)⟩, ⟨(-17257), (-16899)⟩, ⟨37, 80⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35513755, 35722222⟩, ⟨(-138743), (-68543)⟩, ⟨(-17257), (-16899)⟩, ⟨37, 80⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2895851, 11651403⟩, ⟨2850597, 5820113⟩, ⟨695706, 721247⟩, ⟨(-5641), (-2747)⟩, ⟨(-349), (-328)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712932032), (-704176479)⟩, ⟨2850597, 5820113⟩, ⟨695706, 721247⟩, ⟨(-5641), (-2747)⟩, ⟨(-349), (-328)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-232534745), (-57419743)⟩, ⟨(-116034931), (-55521415)⟩, ⟨(-14244251), (-13170524)⟩, ⟨112999, 236047⟩, ⟨13148, 14454⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4062432551, 4237547553⟩, ⟨(-116034931), (-55521415)⟩, ⟨(-14244251), (-13170524)⟩, ⟨112999, 236047⟩, ⟨13148, 14454⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨395520912, 811043538⟩, ⟨184483879, 199543590⟩, ⟨(-4957359), (-2383978)⟩, ⟨(-404891), (-368370)⟩, ⟨2882, 6012⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4353165089, 4540812394⟩, ⟨57036264, 129698857⟩, ⟨14277171, 19626190⟩, ⟨111393, 894265⟩, ⟨23117, 78686⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨400880311, 857467892⟩, ⟨192236111, 235457306⟩, ⟨(-1476438), 7315639⟩, ⟨45742, 675682⟩, ⟨(-25048), 49949⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-780782105), (-390391052)⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3514185191, 3904576244⟩, ⟨(-195195527), (-195195526)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨37417054, 171189007⟩, ⟨35885568, 94015656⟩, ⟨8014663, 15829225⟩, ⟨(-153344), 1071906⟩, ⟨(-8423), 106493⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4332384350, 4466156303⟩, ⟨35885568, 94015656⟩, ⟨8014663, 15829225⟩, ⟨(-153344), 1071906⟩, ⟨(-8423), 106493⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4313635253, 4379725478⟩, ⟨17595548, 46804394⟩, ⟨3679689, 7844475⟩, ⟨(-161457), 518625⟩, ⟨(-16954), 53200⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3529459500, 3981630332⟩, ⟨(-184650722), (-153493828)⟩, ⟨883615, 6331779⟩, ⟨(-503294), 304253⟩, ⟨(-38984), 55703⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2379620849, 4759241706⟩, ⟨1189810424, 1189810431⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1318425728, 5273702931⟩, ⟨1318425726, 2636851476⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1318425728, 5273702931⟩, ⟨1318425726, 2636851476⟩, ⟨329606431, 329606436⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-5273702931), (-1318425728)⟩, ⟨(-2636851476), (-1318425726)⟩, ⟨(-329606436), (-329606431)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2636851466), (-659212864)⟩, ⟨(-1318425738), (-659212863)⟩, ⟨(-164803218), (-164803215)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2324498028, 3683852156⟩, ⟨(-1130831777), (-356775475)⟩, ⟨(-113974140), 84371798⟩, ⟨493409, 40589822⟩, ⟨(-4733689), 2167733⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1910194206, 3415098760⟩, ⟨(-1206710020), (-376259136)⟩, ⟨(-92430530), 132264467⟩, ⟨(-5320668), 42716192⟩, ⟨(-6414969), 2296631⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨585586578, 585586579⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4339609403, 4339609405⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified482
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨390391052, 780782105⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4313635253, 4379725478⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified483
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (120594905 / 2147483648)

theorem envelope_integral : (∫ s in ((18179 / 200000) : ℝ)..(18179 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 4 ≤ n) :
    (∫ s in ((18179 / 200000) : ℝ)..(18179 / 100000), prawitzNormalCorrection
