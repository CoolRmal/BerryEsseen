...
namespace FiniteNormalPanel91_12

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (227073 / 800000)
def radius : Rat := (32439 / 800000)

def j0 : Jet := ⟨⟨1219088886, 1219088887⟩, ⟨174155555, 174155556⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3829880688, 3829880692⟩, ⟨547125812, 547125816⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3415156641, 3415156649⟩, ⟨975759038, 975759048⟩, ⟨69697074, 69697076⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨854, 856⟩, ⟨244, 245⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93833), (-93830)⟩, ⟨244, 245⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-74612), (-74609)⟩, ⟨(-21124), (-21121)⟩, ⟨(-1455), (-1451)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5038444, 5038448⟩, ⟨(-21124), (-21121)⟩, ⟨(-1455), (-1451)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4006334, 4006338⟩, ⟨1127869, 1127874⟩, ⟨75804, 75811⟩, ⟨(-670), (-663)⟩, ⟨(-23), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-139159243), (-139159238)⟩, ⟨1127869, 1127874⟩, ⟨75804, 75811⟩, ⟨(-670), (-663)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-110652907), (-110652902)⟩, ⟨(-30718289), (-30718281)⟩, ⟨(-1941712), (-1941702)⟩, ⟨34990, 35000⟩, ⟨1058, 1066⟩⟩
...
def j19 : Jet := ⟨⟨1321002858, 1321002864⟩, ⟨(-30718289), (-30718281)⟩, ⟨(-1941712), (-1941702)⟩, ⟨34990, 35000⟩, ⟨1058, 1066⟩⟩
...
def j25 : Jet := ⟨⟨9342, 9344⟩, ⟨2649, 2651⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842835), (-842832)⟩, ⟨2649, 2651⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-670183), (-670180)⟩, ⟨(-189375), (-189372)⟩, ⟨(-12933), (-12926)⟩, ⟨81, 87⟩, ⟨0, 4⟩⟩
...
def j30 : Jet := ⟨⟨35121211, 35121215⟩, ⟨(-189375), (-189372)⟩, ⟨(-12933), (-12926)⟩, ⟨81, 87⟩, ⟨0, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨27926740, 27926744⟩, ⟨7828485, 7828491⟩, ⟨516625, 516634⟩, ⟨(-5949), (-5939)⟩, ⟨(-192), (-185)⟩⟩
...
def j33 : Jet := ⟨⟨(-687901143), (-687901138)⟩, ⟨7828485, 7828491⟩, ⟨516625, 516634⟩, ⟨(-5949), (-5939)⟩, ⟨(-192), (-185)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-546986741), (-546986735)⟩, ⟨(-150057083), (-150057074)⟩, ⟨(-8973674), (-8973661)⟩, ⟨239676, 239689⟩, ⟨6878, 6888⟩⟩
...
def j36 : Jet := ⟨⟨3747980555, 3747980561⟩, ⟨(-150057083), (-150057074)⟩, ⟨(-8973674), (-8973661)⟩, ⟨239676, 239689⟩, ⟨6878, 6888⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1177956195, 1177956202⟩, ⟨140887540, 140887551⟩, ⟨(-5644582), (-5644571)⟩, ⟨(-216150), (-216138)⟩, ⟨5400, 5410⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4921782216, 4921782225⟩, ⟨197052312, 197052327⟩, ⟨19673393, 19673413⟩, ⟨944697, 944721⟩, ⟨63276, 63297⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1349869149, 1349869161⟩, ⟨215493324, 215493342⟩, ⟨5391240, 5391262⟩, ⟨397772, 397798⟩, ⟨18757, 18780⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1219088887), (-1219088886)⟩, ⟨(-174155556), (-174155555)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3075878409, 3075878410⟩, ⟨(-174155556), (-174155555)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨424251593, 424251602⟩, ⟨135455182, 135455196⟩, ⟨14200877, 14200896⟩, ⟨791026, 791048⟩, ⟨58471, 58492⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4719218889, 4719218898⟩, ⟨135455182, 135455196⟩, ⟨14200877, 14200896⟩, ⟨791026, 791048⟩, ⟨58471, 58492⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4502098487, 4502098492⟩, ⟨64611600, 64611608⟩, ⟨6310128, 6310139⟩, ⟨286756, 286769⟩, ⟨19351, 19365⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3224217223, 3224217229⟩, ⟨(-136282306), (-136282296)⟩, ⟨1899133, 1899143⟩, ⟨(-50507), (-50494)⟩, ⟨2229, 2242⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨29134180506, 29134180509⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value423

def j47 : Jet := ⟨⟨8269482212, 8269482221⟩, ⟨1181354600, 1181354608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨15921968979, 15921969015⟩, ⟨4549133986, 4549134024⟩, ⟨324938141, 324938146⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨15921968979, 15921969015⟩, ⟨4549133986, 4549134024⟩, ⟨324938141, 324938146⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-15921969015), (-15921968979)⟩, ⟨(-4549134024), (-4549133986)⟩, ⟨(-324938146), (-324938141)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-7960984508), (-7960984489)⟩, ⟨(-2274567012), (-2274566993)⟩, ⟨(-162469073), (-162469070)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨672927816, 672927825⟩, ⟨(-356375108), (-356375099)⟩, ⟨68910782, 68910787⟩, ⟨(-3177544), (-3177542)⟩, ⟨(-882674), (-882672)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨505164604, 505164612⟩, ⟨(-288882042), (-288882031)⟩, ⟨63336668, 63336678⟩, ⟨(-4737456), (-4737446)⟩, ⟨(-526788), (-526778)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1044933330, 1393244442⟩, ⟨174155555, 174155556⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3282754872, 4377006504⟩, ⟨547125812, 547125816⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2509094669, 4460612763⟩, ⟨836364888, 1115153198⟩, ⟨69697074, 69697076⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨628, 1118⟩, ⟨209, 280⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94059), (-93568)⟩, ⟨209, 280⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-97687), (-54661)⟩, ⟨(-24300), (-17929)⟩, ⟨(-1478), (-1426)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5015369, 5058396⟩, ⟨(-24300), (-17929)⟩, ⟨(-1478), (-1426)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2929949, 5253485⟩, ⟨951411, 1302898⟩, ⟨73541, 77762⟩, ⟨(-776), (-556)⟩, ⟨(-23), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140235628), (-137912091)⟩, ⟨951411, 1302898⟩, ⟨73541, 77762⟩, ⟨(-776), (-556)⟩, ⟨(-23), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-145644144), (-80567433)⟩, ⟨(-35855229), (-25502663)⟩, ⟨(-2047459), (-1818935)⟩, ⟨28953, 41010⟩, ⟨967, 1144⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1286011621, 1351088333⟩, ⟨(-35855229), (-25502663)⟩, ⟨(-2047459), (-1818935)⟩, ⟨28953, 41010⟩, ⟨967, 1144⟩⟩
...
def j72 : Jet := ⟨⟨6847, 12229⟩, ⟨2251, 3047⟩, ⟨179, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845330), (-839947)⟩, ⟨2251, 3047⟩, ⟨179, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-877933), (-490692)⟩, ⟨(-218169), (-160399)⟩, ⟨(-13176), (-12641)⟩, ⟨67, 100⟩, ⟨(-1), 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34913461, 35300703⟩, ⟨(-218169), (-160399)⟩, ⟨(-13176), (-12641)⟩, ⟨67, 100⟩, ⟨(-1), 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨20396238, 36662158⟩, ⟨6572162, 9071836⟩, ⟨496231, 534229⟩, ⟨(-6924), (-4959)⟩, ⟨(-203), (-174)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-695431645), (-679165724)⟩, ⟨6572162, 9071836⟩, ⟨496231, 534229⟩, ⟨(-6924), (-4959)⟩, ⟨(-203), (-174)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-722252595), (-396764627)⟩, ⟨(-176723732), (-122833162)⟩, ⟨(-9715497), (-8110977)⟩, ⟨196089, 283027⟩, ⟨6043, 7604⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3572714701, 3898202669⟩, ⟨(-176723732), (-122833162)⟩, ⟨(-9715497), (-8110977)⟩, ⟨196089, 283027⟩, ⟨6043, 7604⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨982932027, 1376895798⟩, ⟨127281895, 152619630⟩, ⟨(-6654083), (-4638983)⟩, ⟨(-238693), (-189915)⟩, ⟨4427, 6391⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4732115192, 5163228978⟩, ⟨149109915, 255398255⟩, ⟨14544578, 26673911⟩, ⟨393679, 1754219⟩, ⟨14049, 143123⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1082976250, 1655246198⟩, ⟨174361629, 265349374⟩, ⟨(-251744), 12515529⟩, ⟨(-161503), 1139922⟩, ⟨(-35762), 93600⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1393244442), (-1044933330)⟩, ⟨(-174155556), (-174155555)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2901722854, 3250033966⟩, ⟨(-174155556), (-174155555)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨273072523, 637918706⟩, ⟨87930588, 204527072⟩, ⟨6884470, 26040446⟩, ⟨(-155592), 2425090⟩, ⟨(-48256), 249471⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4568039819, 4932886002⟩, ⟨87930588, 204527072⟩, ⟨6884470, 26040446⟩, ⟨(-155592), 2425090⟩, ⟨(-48256), 249471⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4429399691, 4602888665⟩, ⟨41024129, 99159836⟩, ⟨2143860, 12435081⟩, ⟨(-353817), 1155889⟩, ⟨(-66728), 128353⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2992546724, 3483040376⟩, ⟨(-158925072), (-104571628)⟩, ⟨(-2572395), 7746243⟩, ⟨(-771963), 787740⟩, ⟨(-97364), 111473⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨7088127604, 9450836822⟩, ⟨1181354600, 1181354608⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨11697773106, 20796041153⟩, ⟨3899257700, 5199010312⟩, ⟨324938141, 324938146⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨11697773106, 20796041153⟩, ⟨3899257700, 5199010312⟩, ⟨324938141, 324938146⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-20796041153), (-11697773106)⟩, ⟨(-5199010312), (-3899257700)⟩, ⟨(-324938146), (-324938141)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-10398020577), (-5848886553)⟩, ⟨(-2599505156), (-1949628850)⟩, ⟨(-162469073), (-162469070)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨381542172, 1100367182⟩, ⟨(-665991140), (-173194712)⟩, ⟨(-2315020), 187110831⟩, ⟨(-33381551), 17262362⟩, ⟨(-6150981), 5094786⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨265842018, 892352156⟩, ⟨(-580807675), (-129964145)⟩, ⟨1680422, 178367129⟩, ⟨(-35393581), 14685425⟩, ⟨(-5886106), 5852598⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1219088886, 1219088887⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4502098487, 4502098492⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar423 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1842
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar423 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1044933330, 1393244442⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4429399691, 4602888665⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1843
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 9 ≤ n) :
    (∫ s in ((97317 / 400000) : ℝ)..(32439 / 100000), prawitzNormalCorrection
      ((226111 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
