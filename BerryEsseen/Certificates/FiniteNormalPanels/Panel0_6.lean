...
namespace FiniteNormalPanel0_6

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (23871 / 80000)
def radius : Rat := (23871 / 400000)

def j0 : Jet := ⟨⟨1281564554, 1281564555⟩, ⟨256312910, 256312911⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4026153787, 4026153792⟩, ⟨805230755, 805230759⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3774164783, 3774164794⟩, ⟨1509665908, 1509665920⟩, ⟨150966590, 150966592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨944, 946⟩, ⟨377, 379⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93743), (-93740)⟩, ⟨377, 379⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-82376), (-82373)⟩, ⟨(-32620), (-32615)⟩, ⟨(-3132), (-3126)⟩, ⟨26, 28⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨5030680, 5030684⟩, ⟨(-32620), (-32615)⟩, ⟨(-3132), (-3126)⟩, ⟨26, 28⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4420665, 4420670⟩, ⟨1739601, 1739608⟩, ⟨162607, 162617⟩, ⟨(-2226), (-2219)⟩, ⟨(-102), (-97)⟩⟩
...
def j16 : Jet := ⟨⟨(-138744912), (-138744906)⟩, ⟨1739601, 1739608⟩, ⟨162607, 162617⟩, ⟨(-2226), (-2219)⟩, ⟨(-102), (-97)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-121920873), (-121920867)⟩, ⟨(-47239691), (-47239680)⟩, ⟨(-4122483), (-4122468)⟩, ⟨116344, 116358⟩, ⟨4842, 4852⟩⟩
...
def j19 : Jet := ⟨⟨1309734892, 1309734899⟩, ⟨(-47239691), (-47239680)⟩, ⟨(-4122483), (-4122468)⟩, ⟨116344, 116358⟩, ⟨4842, 4852⟩⟩
...
def j22 : Jet := ⟨⟨(-95), (-94)⟩, ⟨(-38), (-37)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11740, 11742⟩, ⟨(-38), (-37)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10316, 10319⟩, ⟨4092, 4096⟩, ⟨394, 398⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841861), (-841857)⟩, ⟨4092, 4096⟩, ⟨394, 398⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-739778), (-739774)⟩, ⟨(-292317), (-292309)⟩, ⟨(-27808), (-27800)⟩, ⟨277, 283⟩, ⟨10, 14⟩⟩
...
def j30 : Jet := ⟨⟨35051616, 35051621⟩, ⟨(-292317), (-292309)⟩, ⟨(-27808), (-27800)⟩, ⟨277, 283⟩, ⟨10, 14⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨30801299, 30801305⟩, ⟨12063648, 12063659⟩, ⟨1104865, 1104879⟩, ⟨(-19807), (-19796)⟩, ⟨(-873), (-864)⟩⟩
...
def j33 : Jet := ⟨⟨(-685026584), (-685026577)⟩, ⟨12063648, 12063659⟩, ⟨1104865, 1104879⟩, ⟨(-19807), (-19796)⟩, ⟨(-873), (-864)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-601961095), (-601961087)⟩, ⟨(-230183615), (-230183598)⟩, ⟨(-18867225), (-18867206)⟩, ⟨794982, 795001⟩, ⟨31104, 31120⟩⟩
...
def j36 : Jet := ⟨⟨3693006201, 3693006209⟩, ⟨(-230183615), (-230183598)⟩, ⟨(-18867225), (-18867206)⟩, ⟨794982, 795001⟩, ⟨31104, 31120⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1227761175, 1227761184⟩, ⟨201269181, 201269196⟩, ⟨(-12721076), (-12721058)⟩, ⟨(-663831), (-663814)⟩, ⟨26350, 26365⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4995048215, 4995048227⟩, ⟨311339354, 311339380⟩, ⟨44924867, 44924899⟩, ⟨3315455, 3315489⟩, ⟨327049, 327083⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1427886603, 1427886618⟩, ⟨323075715, 323075744⟩, ⟨12637495, 12637530⟩, ⟨1358830, 1358867⟩, ⟨98319, 98355⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1281564555), (-1281564554)⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3013402741, 3013402742⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨474709121, 474709132⟩, ⟨214816762, 214816786⟩, ⟨32705191, 32705223⟩, ⟨2804732, 2804768⟩, ⟨306982, 307017⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4769676417, 4769676428⟩, ⟨214816762, 214816786⟩, ⟨32705191, 32705223⟩, ⟨2804732, 2804768⟩, ⟨306982, 307017⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4526102542, 4526102548⟩, ⟨101923338, 101923351⟩, ⟨14369908, 14369924⟩, ⟨1007154, 1007173⟩, ⟨100159, 100179⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3175570118, 3175570124⟩, ⟨(-198595799), (-198595785)⟩, ⟨3999576, 3999590⟩, ⟨(-150931), (-150914)⟩, ⟨10166, 10183⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨12602164190, 12602164191⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value1

def j47 : Jet := ⟨⟨3760328267, 3760328271⟩, ⟨752065651, 752065655⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3292241291, 3292241299⟩, ⟨1316896512, 1316896522⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3292241291, 3292241299⟩, ⟨1316896512, 1316896522⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3292241299), (-3292241291)⟩, ⟨(-1316896522), (-1316896512)⟩, ⟨(-131689653), (-131689650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1646120650), (-1646120645)⟩, ⟨(-658448261), (-658448256)⟩, ⟨(-65844827), (-65844825)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2927581365, 2927581373⟩, ⟨(-448818520), (-448818515)⟩, ⟨(-10478359), (-10478355)⟩, ⟨5122600, 5122602⟩, ⟨(-116013), (-116012)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2164565934, 2164565945⟩, ⟨(-467211951), (-467211934)⟩, ⟨15731850, 15731867⟩, ⟨3751174, 3751193⟩, ⟨(-309701), (-309681)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1025251643, 1537877465⟩, ⟨256312910, 256312911⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3220923029, 4831384547⟩, ⟨805230755, 805230759⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2415465460, 5434797295⟩, ⟨1207732726, 1811599102⟩, ⟨150966590, 150966592⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨604, 1362⟩, ⟨302, 454⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94083), (-93324)⟩, ⟨302, 454⟩, ⟨37, 38⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-119052), (-52484)⟩, ⟨(-39515), (-25667)⟩, ⟨(-3203), (-3039)⟩, ⟨20, 33⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4994004, 5060573⟩, ⟨(-39515), (-25667)⟩, ⟨(-3203), (-3039)⟩, ⟨20, 33⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2808599, 6403586⟩, ⟨1354297, 2120095⟩, ⟨154815, 168952⟩, ⟨(-2730), (-1714)⟩, ⟨(-108), (-89)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140356978), (-136761990)⟩, ⟨1354297, 2120095⟩, ⟨154815, 168952⟩, ⟨(-2730), (-1714)⟩, ⟨(-108), (-89)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-177605945), (-76914174)⟩, ⟨(-58440333), (-35774345)⟩, ⟨(-4465608), (-3699097)⟩, ⟨87681, 144822⟩, ⟨4152, 5408⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1254049820, 1354741592⟩, ⟨(-58440333), (-35774345)⟩, ⟨(-4465608), (-3699097)⟩, ⟨87681, 144822⟩, ⟨4152, 5408⟩⟩
...
def j70 : Jet := ⟨⟨(-137), (-60)⟩, ⟨(-46), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11698, 11776⟩, ⟨(-46), (-30)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6578, 14902⟩, ⟨3230, 4952⟩, ⟨385, 405⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845599), (-837274)⟩, ⟨3230, 4952⟩, ⟨385, 405⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1070011), (-470878)⟩, ⟨(-354855), (-229172)⟩, ⟨(-28599), (-26827)⟩, ⟨215, 346⟩, ⟨9, 15⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34721383, 35320517⟩, ⟨(-354855), (-229172)⟩, ⟨(-28599), (-26827)⟩, ⟨215, 346⟩, ⟨9, 15⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨19527110, 44694136⟩, ⟨9314525, 14769161⟩, ⟨1034578, 1161975⟩, ⟨(-24417), (-15160)⟩, ⟨(-941), (-777)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-696300773), (-671133746)⟩, ⟨9314525, 14769161⟩, ⟨1034578, 1161975⟩, ⟨(-24417), (-15160)⟩, ⟨(-941), (-777)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-881090192), (-377441845)⟩, ⟨(-288458296), (-170032212)⟩, ⟨(-21273670), (-15890196)⟩, ⟨587425, 1000723⟩, ⟨24875, 36146⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3413877104, 3917525451⟩, ⟨(-288458296), (-170032212)⟩, ⟨(-21273670), (-15890196)⟩, ⟨587425, 1000723⟩, ⟨24875, 36146⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨940449057, 1523941195⟩, ⟨169373061, 227161961⟩, ⟨(-15979872), (-9481121)⟩, ⟨(-771469), (-530605)⟩, ⟨19551, 33236⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4708774532, 5403458740⟩, ⟨204374766, 456569600⟩, ⟨27970115, 72250021⟩, ⟨662663, 8139714⟩, ⟨(-27857), 1068526⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1031058507, 1917256362⟩, ⟨230442642, 447790490⟩, ⟨(-5920077), 39389258⟩, ⟨(-1421186), 5676576⟩, ⟨(-313143), 764470⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1537877465), (-1025251643)⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2757089831, 3269715653⟩, ⟨(-256312911), (-256312910)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨247517983, 855855634⟩, ⟨110641050, 399783798⟩, ⟨7078796, 81852763⟩, ⟨(-2503272), 13281402⟩, ⟨(-630210), 2227428⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4542485279, 5150822930⟩, ⟨110641050, 399783798⟩, ⟨7078796, 81852763⟩, ⟨(-2503272), 13281402⟩, ⟨(-630210), 2227428⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4416992836, 4703468511⟩, ⟨50515878, 194369609⟩, ⟨(-834997), 39506867⟩, ⟨(-2955557), 6493987⟩, ⟨(-768849), 1216741⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2835422296, 3580703543⟩, ⟨(-248263333), (-115623449)⟩, ⟨(-12235168), 27061522⟩, ⟨(-4607708), 4993639⟩, ⟨(-972863), 1102674⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3008262613, 4512393922⟩, ⟨752065651, 752065655⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2107034425, 4740827463⟩, ⟨1053517208, 1580275824⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2107034425, 4740827463⟩, ⟨1053517208, 1580275824⟩, ⟨131689650, 131689653⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4740827463), (-2107034425)⟩, ⟨(-1580275824), (-1053517208)⟩, ⟨(-131689653), (-131689650)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2370413732), (-1053517212)⟩, ⟨(-790137912), (-526758604)⟩, ⟨(-65844827), (-65844825)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2473264613, 3360711982⟩, ⟨(-618264533), (-303334885)⟩, ⟨(-32920710), 18953684⟩, ⟨1937929, 8337739⟩, ⟨(-528757), 192930⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1632783009, 2801817214⟩, ⟨(-709705885), (-266835531)⟩, ⟨(-28853668), 72714390⟩, ⟨(-7317175), 14522751⟩, ⟨(-2610281), 1754200⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1281564554, 1281564555⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4526102542, 4526102548⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified0
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1025251643, 1537877465⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4416992836, 4703468511⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1
    (by decide +kernel) (by decide +kernel)
...
theorem whole_function_eq (t : ℝ) : f95 t =
    finiteNormalIntegrand 1 (293417 / 100000) ((center : ℝ) + (radius : ℝ) * t) := by
  norm_num only [f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19, f20, f21, f22, f23, f24, f25, f26, f27, f28, f29, f30, f31, f32, f33, f34, f35, f36, f37, f38, f39, f40, f41, f42, f43, f44, f45, f46, f47, f48, f49, f50, f51, f52, f53, f54, f55, f56, f57, f58, f59, f60, f61, f62, f63, f64, f65, f66, f67, f68, f69, f70, f71, f72, f73, f74, f75, f76, f77, f78, f79, f80, f81, f82, f83, f84, f85, f86, f87, f88, f89, f90, f91, f92, f93, f94, f95, FiniteScalarConstants.value0, FiniteScalarConstants.value1, FiniteScalarConstants.value2, FiniteScalarConstants.value4, FiniteScalarConstants.value9, FiniteScalarConstants.value10, FiniteScalarConstants.value11, FiniteScalarConstants.value12, FiniteScalarConstants.value13, FiniteScalarConstants.value14, FiniteScalarConstants.value33, FiniteScalarConstants.value34, FiniteScalarConstants.value35, FiniteScalarConstants.value36, FiniteScalarConstants.value39, finiteNormalIntegrand, finiteNormalKernel, finiteCotangentUpper, cotangentNumeratorUpper, cotangentNumeratorLower, cotangentDenominatorLower, cotangentDenominatorUpper, gaussianFrequency]
  ring_nf

def upper : Rat := (16188721 / 268435456)

theorem envelope_integral : (∫ s in ((23871 / 100000) : ℝ)..(71613 / 200000),
    finiteNormalIntegrand 1 (293417 / 100000) s) ≤ (upper : ℝ) := by
  have he : f95 = (fun t ↦ finiteNormalIntegrand 1 (293417 / 100000)
...
theorem actual_correction_integral {n : ℕ} (hn : 1 ≤ n) :
    (∫ s in ((23871 / 100000) : ℝ)..(71613 / 200000), prawitzNormalCorrection
      ((293417 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
