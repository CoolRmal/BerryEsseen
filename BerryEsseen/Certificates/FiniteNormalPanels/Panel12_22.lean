...
namespace FiniteNormalPanel12_22

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (114717 / 800000)
def radius : Rat := (38239 / 800000)

def j0 : Jet := ⟨⟨615882204, 615882205⟩, ⟨205294068, 205294069⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1934851007, 1934851011⟩, ⟨644950335, 644950340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨871636071, 871636075⟩, ⟨581090712, 581090720⟩, ⟨96848452, 96848454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨218, 219⟩, ⟨145, 146⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94469), (-94467)⟩, ⟨145, 146⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-19172), (-19171)⟩, ⟨(-12753), (-12750)⟩, ⟨(-2108), (-2104)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5093884, 5093886⟩, ⟨(-12753), (-12750)⟩, ⟨(-2108), (-2104)⟩, ⟨6, 8⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1033771, 1033772⟩, ⟨686591, 686595⟩, ⟨112709, 112713⟩, ⟨(-573), (-569)⟩, ⟨(-48), (-44)⟩⟩
...
def j16 : Jet := ⟨⟨(-142131806), (-142131804)⟩, ⟨686591, 686595⟩, ⟨112709, 112713⟩, ⟨(-573), (-569)⟩, ⟨(-48), (-44)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-28844739), (-28844738)⟩, ⟨(-19090487), (-19090484)⟩, ⟨(-3089207), (-3089201)⟩, ⟨30614, 30618⟩, ⟨2453, 2458⟩⟩
...
def j19 : Jet := ⟨⟨1402811026, 1402811028⟩, ⟨(-19090487), (-19090484)⟩, ⟨(-3089207), (-3089201)⟩, ⟨30614, 30618⟩, ⟨2453, 2458⟩⟩
...
def j22 : Jet := ⟨⟨(-22), (-21)⟩, ⟨(-15), (-14)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11813, 11815⟩, ⟨(-15), (-14)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨2397, 2398⟩, ⟨1594, 1597⟩, ⟨262, 266⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-849780), (-849778)⟩, ⟨1594, 1597⟩, ⟨262, 266⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-172458), (-172456)⟩, ⟨(-114649), (-114646)⟩, ⟨(-18894), (-18890)⟩, ⟨69, 73⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35618936, 35618939⟩, ⟨(-114649), (-114646)⟩, ⟨(-18894), (-18890)⟩, ⟨69, 73⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨7228634, 7228636⟩, ⟨4795821, 4795825⟩, ⟨783834, 783838⟩, ⟨(-5129), (-5125)⟩, ⟨(-418), (-413)⟩⟩
...
def j33 : Jet := ⟨⟨(-708599249), (-708599246)⟩, ⟨4795821, 4795825⟩, ⟨783834, 783838⟩, ⟨(-5129), (-5125)⟩, ⟨(-418), (-413)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-143805675), (-143805673)⟩, ⟨(-94897170), (-94897166)⟩, ⟨(-15170481), (-15170478)⟩, ⟨213150, 213153⟩, ⟨16895, 16899⟩⟩
...
def j36 : Jet := ⟨⟨4151161621, 4151161623⟩, ⟨(-94897170), (-94897166)⟩, ⟨(-15170481), (-15170478)⟩, ⟨213150, 213153⟩, ⟨16895, 16899⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨631955993, 631955997⟩, ⟨202051873, 202051879⟩, ⟨(-4258373), (-4258369)⟩, ⟨(-450098), (-450093)⟩, ⟨5702, 5706⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4443754724, 4443754727⟩, ⟨101585957, 101585963⟩, ⟨18562056, 18562062⟩, ⟨567405, 567412⟩, ⟨57498, 57507⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨653848384, 653848390⟩, ⟨223998636, 223998645⟩, ⟨3104300, 3104308⟩, ⟨390305, 390316⟩, ⟨12001, 12012⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-615882205), (-615882204)⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3679085091, 3679085092⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨99539223, 99539226⟩, ⟨68201284, 68201290⟩, ⟨12627540, 12627546⟩, ⟨442636, 442646⟩, ⟨46605, 46616⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4394506519, 4394506522⟩, ⟨68201284, 68201290⟩, ⟨12627540, 12627546⟩, ⟨442636, 442646⟩, ⟨46605, 46616⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4344451838, 4344451841⟩, ⟨33712225, 33712229⟩, ⟨6111053, 6111057⟩, ⟨171375, 171382⟩, ⟨17407, 17415⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3721473735, 3721473739⟩, ⟨(-178781351), (-178781345)⟩, ⟨3623347, 3623353⟩, ⟨(-145301), (-145293)⟩, ⟨6718, 6727⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨22082303500, 22082303505⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value141

def j47 : Jet := ⟨⟨3166519512, 3166519519⟩, ⟨1055506504, 1055506510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2334556966, 2334556977⟩, ⟨1556371310, 1556371324⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2334556966, 2334556977⟩, ⟨1556371310, 1556371324⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2334556977), (-2334556966)⟩, ⟨(-1556371324), (-1556371310)⟩, ⟨(-259395222), (-259395218)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1167278489), (-1167278483)⟩, ⟨(-778185662), (-778185655)⟩, ⟨(-129697611), (-129697609)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3272864967, 3272864978⟩, ⟨(-592995575), (-592995567)⟩, ⟨(-45111508), (-45111503)⟩, ⟨14662535, 14662537⟩, ⟨16969, 16970⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2835849535, 2835849549⟩, ⟨(-650050278), (-650050264)⟩, ⟨(-11642936), (-11642922)⟩, ⟨13971502, 13971515⟩, ⟨(-608516), (-608502)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨410588136, 821176273⟩, ⟨205294068, 205294069⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1289900671, 2579801347⟩, ⟨644950335, 644950340⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨387393809, 1549575243⟩, ⟨387393808, 774787626⟩, ⟨96848452, 96848454⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨96, 389⟩, ⟨96, 195⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94591), (-94297)⟩, ⟨96, 195⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-34128), (-8505)⟩, ⟨(-17056), (-8434)⟩, ⟨(-2123), (-2080)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5078928, 5104552⟩, ⟨(-17056), (-8434)⟩, ⟨(-2123), (-2080)⟩, ⟨4, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨458104, 1841665⟩, ⟨451950, 920073⟩, ⟨110683, 114158⟩, ⟨(-768), (-373)⟩, ⟨(-48), (-43)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142707473), (-141323911)⟩, ⟨451950, 920073⟩, ⟨110683, 114158⟩, ⟨(-768), (-373)⟩, ⟨(-48), (-43)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-51487230), (-12747013)⟩, ⟨(-25702851), (-12415061)⟩, ⟨(-3167205), (-2979590)⟩, ⟨19896, 41308⟩, ⟨2338, 2539⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1380168535, 1418908753⟩, ⟨(-25702851), (-12415061)⟩, ⟨(-3167205), (-2979590)⟩, ⟨19896, 41308⟩, ⟨2338, 2539⟩⟩
...
def j70 : Jet := ⟨⟨(-39), (-9)⟩, ⟨(-20), (-9)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11796, 11827⟩, ⟨(-20), (-9)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨1063, 4268⟩, ⟨1055, 2134⟩, ⟨259, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851114), (-847908)⟩, ⟨1055, 2134⟩, ⟨259, 267⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-307073), (-76478)⟩, ⟨(-153442), (-75708)⟩, ⟨(-19075), (-18637)⟩, ⟨45, 98⟩, ⟨3, 7⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35484321, 35714917⟩, ⟨(-153442), (-75708)⟩, ⟨(-19075), (-18637)⟩, ⟨45, 98⟩, ⟨3, 7⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨3200584, 12885535⟩, ⟨3145223, 6435940⟩, ⟨765582, 796837⟩, ⟨(-6899), (-3352)⟩, ⟨(-427), (-399)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712627299), (-702942347)⟩, ⟨3145223, 6435940⟩, ⟨765582, 796837⟩, ⟨(-6899), (-3352)⟩, ⟨(-427), (-399)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-257107807), (-63403396)⟩, ⟨(-128270214), (-61081382)⟩, ⟨(-15716496), (-14402352)⟩, ⟨137485, 288569⟩, ⟨15863, 17632⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4037859489, 4231563900⟩, ⟨(-128270214), (-61081382)⟩, ⟨(-15716496), (-14402352)⟩, ⟨137485, 288569⟩, ⟨15863, 17632⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨414503812, 852277203⟩, ⟨191813313, 209340707⟩, ⟨(-5762053), (-2759152)⟩, ⟨(-469626), (-422615)⟩, ⟨3689, 7729⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4359320693, 4568446259⟩, ⟨62925513, 145125303⟩, ⟨15745488, 22391871⟩, ⟨129907, 1127761⟩, ⟨26531, 103715⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨420714506, 906545343⟩, ⟨200760226, 251468448⟩, ⟨(-1799110), 8716409⟩, ⟨21502, 845819⟩, ⟨(-33805), 67466⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-821176273), (-410588136)⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3473791023, 3884379160⟩, ⟨(-205294069), (-205294068)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨41211185, 191345918⟩, ⟨39331026, 106155664⟩, ⟨8624679, 18402940⟩, ⟨(-206464), 1377742⟩, ⟨(-15914), 145218⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4336178481, 4486313214⟩, ⟨39331026, 106155664⟩, ⟨8624679, 18402940⟩, ⟨(-206464), 1377742⟩, ⟨(-15914), 145218⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4315523695, 4389597765⟩, ⟨19241566, 52825004⟩, ⟨3901522, 9114745⟩, ⟨(-214312), 668195⟩, ⟨(-25725), 73124⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3490417141, 3969963193⟩, ⟨(-194254614), (-158501572)⟩, ⟨630600, 7323677⟩, ⟨(-629499), 417831⟩, ⟨(-55205), 76378⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2111013008, 4222026023⟩, ⟨1055506504, 1055506510⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1037580873, 4150323509⟩, ⟨1037580872, 2075161764⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1037580873, 4150323509⟩, ⟨1037580872, 2075161764⟩, ⟨259395218, 259395222⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4150323509), (-1037580873)⟩, ⟨(-2075161764), (-1037580872)⟩, ⟨(-259395222), (-259395218)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2075161755), (-518790436)⟩, ⟨(-1037580882), (-518790436)⟩, ⟨(-129697611), (-129697609)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2649266194, 3806284932⟩, ⟨(-919524692), (-320005687)⟩, ⟨(-95613795), 31068254⟩, ⟨3940434, 26211093⟩, ⟨(-2052117), 1324662⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2152995237, 3518259871⟩, ⟨(-1022095698), (-357829543)⟩, ⟨(-76180142), 76796335⟩, ⟨(-328700), 28875445⟩, ⟨(-3383737), 1334444⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨615882204, 615882205⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨205294068, 205294069⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4344451838, 4344451841⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar141 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified250
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar141 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨410588136, 821176273⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4315523695, 4389597765⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified251
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((38239 / 400000) : ℝ)..(38239 / 200000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (38239 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (38239 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((38239 / 400000) : ℝ)..(38239 / 200000), prawitzNormalCorrection
      ((296841 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
