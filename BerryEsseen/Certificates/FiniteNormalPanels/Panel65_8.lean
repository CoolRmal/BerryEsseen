...
namespace FiniteNormalPanel65_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (56791 / 200000)
def radius : Rat := (8113 / 200000)

def j0 : Jet := ⟨⟨1219577438, 1219577439⟩, ⟨174225348, 174225349⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3831415519, 3831415523⟩, ⟨547345073, 547345077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3417894448, 3417894457⟩, ⟨976541268, 976541278⟩, ⟨69752947, 69752949⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨855, 857⟩, ⟨244, 245⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93832), (-93829)⟩, ⟨244, 245⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-74671), (-74668)⟩, ⟨(-21141), (-21138)⟩, ⟨(-1456), (-1452)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5038385, 5038389⟩, ⟨(-21141), (-21138)⟩, ⟨(-1456), (-1452)⟩, ⟨6, 9⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4009499, 4009503⟩, ⟨1128747, 1128752⟩, ⟨75860, 75866⟩, ⟨(-672), (-665)⟩, ⟨(-23), (-19)⟩⟩
...
def j16 : Jet := ⟨⟨(-139156078), (-139156073)⟩, ⟨1128747, 1128752⟩, ⟨75860, 75866⟩, ⟨(-672), (-665)⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-110739095), (-110739089)⟩, ⟨(-30741496), (-30741488)⟩, ⟨(-1942973), (-1942964)⟩, ⟨35044, 35053⟩, ⟨1060, 1067⟩⟩
...
def j19 : Jet := ⟨⟨1320916670, 1320916677⟩, ⟨(-30741496), (-30741488)⟩, ⟨(-1942973), (-1942964)⟩, ⟨35044, 35053⟩, ⟨1060, 1067⟩⟩
...
def j22 : Jet := ⟨⟨(-86), (-85)⟩, ⟨(-25), (-24)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11749, 11751⟩, ⟨(-25), (-24)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨9349, 9352⟩, ⟨2651, 2653⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-842828), (-842824)⟩, ⟨2651, 2653⟩, ⟨182, 186⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-670715), (-670711)⟩, ⟨(-189524), (-189519)⟩, ⟨(-12943), (-12934)⟩, ⟨82, 87⟩, ⟨0, 4⟩⟩
...
def j30 : Jet := ⟨⟨35120679, 35120684⟩, ⟨(-189524), (-189519)⟩, ⟨(-12943), (-12934)⟩, ⟨82, 87⟩, ⟨0, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨27948704, 27948710⟩, ⟨7834522, 7834529⟩, ⟨516989, 517000⟩, ⟨(-5956), (-5947)⟩, ⟨(-193), (-186)⟩⟩
...
def j33 : Jet := ⟨⟨(-687879179), (-687879172)⟩, ⟨7834522, 7834529⟩, ⟨516989, 517000⟩, ⟨(-5956), (-5947)⟩, ⟨(-193), (-186)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-547407762), (-547407754)⟩, ⟨(-150167581), (-150167570)⟩, ⟨(-8978849), (-8978835)⟩, ⟨240044, 240056⟩, ⟨6887, 6897⟩⟩
...
def j36 : Jet := ⟨⟨3747559534, 3747559542⟩, ⟨(-150167581), (-150167570)⟩, ⟨(-8978849), (-8978835)⟩, ⟨240044, 240056⟩, ⟨6887, 6897⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1178351377, 1178351385⟩, ⟨140912314, 140912325⟩, ⟨(-5650927), (-5650916)⟩, ⟨(-216349), (-216338)⟩, ⟨5410, 5420⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4922335153, 4922335165⟩, ⟨197241724, 197241742⟩, ⟨19697123, 19697146⟩, ⟨946543, 946564⟩, ⟨63424, 63446⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1350473706, 1350473720⟩, ⟨215609951, 215609971⟩, ⟨5398913, 5398937⟩, ⟨398462, 398484⟩, ⟨18802, 18825⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1219577439), (-1219577438)⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3075389857, 3075389858⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨424631692, 424631701⟩, ⟨135589190, 135589206⟩, ⟨14218927, 14218946⟩, ⟨792634, 792652⟩, ⟨58614, 58637⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4719598988, 4719598997⟩, ⟨135589190, 135589206⟩, ⟨14218927, 14218946⟩, ⟨792634, 792652⟩, ⟨58614, 58637⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4502279789, 4502279794⟩, ⟨64672917, 64672925⟩, ⟨6317603, 6317614⟩, ⟨287318, 287329⟩, ⟨19397, 19410⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3223834931, 3223834936⟩, ⟨(-136326263), (-136326254)⟩, ⟨1900230, 1900240⟩, ⟨(-50543), (-50532)⟩, ⟨2233, 2244⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨34595804408, 34595804415⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value344

def j47 : Jet := ⟨⟨9823651636, 9823651647⟩, ⟨1403378802, 1403378812⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨22469119044, 22469119095⟩, ⟨6419748284, 6419748338⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨22469119044, 22469119095⟩, ⟨6419748284, 6419748338⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-22469119095), (-22469119044)⟩, ⟨(-6419748338), (-6419748284)⟩, ⟨(-458553455), (-458553447)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-11234559548), (-11234559522)⟩, ⟨(-3209874169), (-3209874142)⟩, ⟨(-229276728), (-229276723)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨314017741, 314017747⟩, ⟨(-234683383), (-234683376)⟩, ⟨70933040, 70933045⟩, ⟨(-9318758), (-9318755)⟩, ⟨(-152188), (-152186)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨235704091, 235704096⟩, ⟨(-186122339), (-186122330)⟩, ⟨60830875, 60830884⟩, ⟨(-9353740), (-9353732)⟩, ⟨215858, 215867⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1045352090, 1393802787⟩, ⟨174225348, 174225349⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3284070446, 4378760597⟩, ⟨547345073, 547345077⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2511106127, 4464188676⟩, ⟨837035372, 1116047174⟩, ⟨69752947, 69752949⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨628, 1119⟩, ⟨209, 280⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94059), (-93567)⟩, ⟨209, 280⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-97765), (-54705)⟩, ⟨(-24320), (-17943)⟩, ⟨(-1479), (-1427)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5015291, 5058352⟩, ⟨(-24320), (-17943)⟩, ⟨(-1479), (-1427)⟩, ⟨6, 10⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2932252, 5257651⟩, ⟨952138, 1303923⟩, ⟨73593, 77821⟩, ⟨(-777), (-558)⟩, ⟨(-24), (-18)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140233325), (-137907925)⟩, ⟨952138, 1303923⟩, ⟨73593, 77821⟩, ⟨(-777), (-558)⟩, ⟨(-24), (-18)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-145758508), (-80629586)⟩, ⟨(-35882948), (-25521230)⟩, ⟨(-2048891), (-1819997)⟩, ⟨28997, 41073⟩, ⟨968, 1146⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1285897257, 1351026180⟩, ⟨(-35882948), (-25521230)⟩, ⟨(-2048891), (-1819997)⟩, ⟨28997, 41073⟩, ⟨968, 1146⟩⟩
...
def j70 : Jet := ⟨⟨(-113), (-62)⟩, ⟨(-29), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11722, 11774⟩, ⟨(-29), (-20)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨6853, 12238⟩, ⟨2253, 3049⟩, ⟨179, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-845324), (-839938)⟩, ⟨2253, 3049⟩, ⟨179, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-878630), (-491080)⟩, ⟨(-218341), (-160523)⟩, ⟨(-13186), (-12651)⟩, ⟨67, 100⟩, ⟨(-1), 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34912764, 35300315⟩, ⟨(-218341), (-160523)⟩, ⟨(-13186), (-12651)⟩, ⟨67, 100⟩, ⟨(-1), 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨20412182, 36691145⟩, ⟨6577116, 9078936⟩, ⟨496563, 534621⟩, ⟨(-6934), (-4967)⟩, ⟨(-204), (-174)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-695415701), (-679136737)⟩, ⟨6577116, 9078936⟩, ⟨496563, 534621⟩, ⟨(-6934), (-4967)⟩, ⟨(-204), (-174)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-722815026), (-397065752)⟩, ⟨(-176858366), (-122918604)⟩, ⟨(-9721867), (-8114756)⟩, ⟨196381, 283466⟩, ⟨6049, 7614⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3572152270, 3897901544⟩, ⟨(-176858366), (-122918604)⟩, ⟨(-9721867), (-8114756)⟩, ⟨196381, 283466⟩, ⟨6049, 7614⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨983238494, 1377384226⟩, ⟨127290070, 152658674⟩, ⟨(-6661742), (-4644020)⟩, ⟨(-238937), (-190063)⟩, ⟨4435, 6404⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4732480763, 5164041922⟩, ⟨149236690, 255673317⟩, ⟨14558318, 26712774⟩, ⟨394230, 1758222⟩, ⟨14056, 143536⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1083397599, 1656094074⟩, ⟨174421133, 265542462⟩, ⟨(-253988), 12537179⟩, ⟨(-162136), 1142537⟩, ⟨(-35872), 93881⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1393802787), (-1045352090)⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2901164509, 3249615206⟩, ⟨(-174225349), (-174225348)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨273285051, 638572402⟩, ⟨87994818, 204780744⟩, ⟨6887472, 26085949⟩, ⟨(-156444), 2431360⟩, ⟨(-48456), 250275⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4568252347, 4933539698⟩, ⟨87994818, 204780744⟩, ⟨6887472, 26085949⟩, ⟨(-156444), 2431360⟩, ⟨(-48456), 250275⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4429502729, 4603193637⟩, ⟨41051375, 99280513⟩, ⟨2142517, 12456600⟩, ⟨(-355043), 1158901⟩, ⟨(-66983), 128778⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2992040503, 3482822338⟩, ⟨(-158999169), (-104566148)⟩, ⟨(-2580088), 7759540⟩, ⟨(-773932), 789926⟩, ⟨(-97692), 111838⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨8420272833, 11227030450⟩, ⟨1403378802, 1403378812⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨16507924204, 29347420839⟩, ⟨5502641386, 7336855240⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨16507924204, 29347420839⟩, ⟨5502641386, 7336855240⟩, ⟨458553447, 458553455⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-29347420839), (-16507924204)⟩, ⟨(-7336855240), (-5502641386)⟩, ⟨(-458553455), (-458553447)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-14673710420), (-8253962102)⟩, ⟨(-3668427620), (-2751320693)⟩, ⟨(-229276728), (-229276723)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨140992932, 628555241⟩, ⟨(-536863089), (-90318911)⟩, ⟨(-4625169), 221746810⟩, ⟨(-59918662), 20422936⟩, ⟨(-10279638), 12917920⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨98221135, 509700327⟩, ⟨(-458615488), (-66352292)⟩, ⟨(-1929252), 200826403⟩, ⟨(-57880742), 17170453⟩, ⟨(-9338140), 13207154⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1219577438, 1219577439⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4502279789, 4502279794⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar344 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1284
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar344 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1045352090, 1393802787⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4429502729, 4603193637⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1285
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((24339 / 100000) : ℝ)..(8113 / 25000), prawitzNormalCorrection
      ((304449 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
