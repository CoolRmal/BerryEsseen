...
namespace FiniteNormalPanel51_4

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (42919 / 400000)
def radius : Rat := (42919 / 400000)

def j0 : Jet := ⟨⟨460839253, 460839254⟩, ⟨460839253, 460839254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1447769211, 1447769215⟩, ⟨1447769211, 1447769215⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨488021338, 488021342⟩, ⟨976042676, 976042684⟩, ⟨488021338, 488021342⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨122, 123⟩, ⟨244, 245⟩, ⟨122, 123⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94565), (-94563)⟩, ⟨244, 245⟩, ⟨122, 123⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10746), (-10744)⟩, ⟨(-21464), (-21461)⟩, ⟨(-10678), (-10674)⟩, ⟨54, 56⟩, ⟨13, 14⟩⟩
...
def j13 : Jet := ⟨⟨5102310, 5102313⟩, ⟨(-21464), (-21461)⟩, ⟨(-10678), (-10674)⟩, ⟨54, 56⟩, ⟨13, 14⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨579756, 579758⟩, ⟨1157074, 1157077⟩, ⟨573664, 573669⟩, ⟨(-4860), (-4856)⟩, ⟨(-1201), (-1197)⟩⟩
...
def j16 : Jet := ⟨⟨(-142585821), (-142585818)⟩, ⟨1157074, 1157077⟩, ⟨573664, 573669⟩, ⟨(-4860), (-4856)⟩, ⟨(-1201), (-1197)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16201503), (-16201502)⟩, ⟨(-32271532), (-32271529)⟩, ⟨(-15873372), (-15873369)⟩, ⟨261287, 261292⟩, ⟨63941, 63945⟩⟩
...
def j19 : Jet := ⟨⟨1415454262, 1415454264⟩, ⟨(-32271532), (-32271529)⟩, ⟨(-15873372), (-15873369)⟩, ⟨261287, 261292⟩, ⟨63941, 63945⟩⟩
...
def j22 : Jet := ⟨⟨(-13), (-12)⟩, ⟨(-25), (-24)⟩, ⟨(-13), (-12)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11822, 11824⟩, ⟨(-25), (-24)⟩, ⟨(-13), (-12)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1343, 1344⟩, ⟨2683, 2686⟩, ⟨1335, 1338⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
...
def j27 : Jet := ⟨⟨(-850834), (-850832)⟩, ⟨2683, 2686⟩, ⟨1335, 1338⟩, ⟨(-6), (-4)⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-96678), (-96676)⟩, ⟨(-193051), (-193047)⟩, ⟨(-95918), (-95912)⟩, ⟨606, 611⟩, ⟨148, 153⟩⟩
...
def j30 : Jet := ⟨⟨35694716, 35694719⟩, ⟨(-193051), (-193047)⟩, ⟨(-95918), (-95912)⟩, ⟨606, 611⟩, ⟨148, 153⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4055859, 4055860⟩, ⟨8089782, 8089785⟩, ⟨4001088, 4001092⟩, ⟨(-43666), (-43661)⟩, ⟨(-10746), (-10741)⟩⟩
...
def j33 : Jet := ⟨⟨(-711772024), (-711772022)⟩, ⟨8089782, 8089785⟩, ⟨4001088, 4001092⟩, ⟨(-43666), (-43661)⟩, ⟨(-10746), (-10741)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-80876039), (-80876037)⟩, ⟨(-160832865), (-160832861)⟩, ⟨(-78582987), (-78582981)⟩, ⟨1823507, 1823511⟩, ⟨443482, 443488⟩⟩
...
def j36 : Jet := ⟨⟨4214091257, 4214091259⟩, ⟨(-160832865), (-160832861)⟩, ⟨(-78582987), (-78582981)⟩, ⟨1823507, 1823511⟩, ⟨443482, 443488⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨477128452, 477128455⟩, ⟨466250201, 466250206⟩, ⟨(-16228928), (-16228924)⟩, ⟨(-5262602), (-5262597)⟩, ⟨109628, 109633⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4377395490, 4377395493⟩, ⟨167065446, 167065452⟩, ⟨88004357, 88004367⟩, ⟨4579934, 4579942⟩, ⟨1282903, 1282915⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨486285410, 486285414⟩, ⟨493757707, 493757714⟩, ⟨11372202, 11372212⟩, ⟨4067429, 4067441⟩, ⟨214195, 214209⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-460839254), (-460839253)⟩, ⟨(-460839254), (-460839253)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3834128042, 3834128043⟩, ⟨(-460839254), (-460839253)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨55058277, 55058279⟩, ⟨111808612, 111808616⟩, ⟨59338506, 59338512⟩, ⟨3535786, 3535794⟩, ⟨1013811, 1013822⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4350025573, 4350025575⟩, ⟨111808612, 111808616⟩, ⟨59338506, 59338512⟩, ⟨3535786, 3535794⟩, ⟨1013811, 1013822⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4322408769, 4322408771⟩, ⟨55549388, 55549391⟩, ⟨29123946, 29123951⟩, ⟨1382382, 1382388⟩, ⟨387803, 387811⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3858625113, 3858625117⟩, ⟨(-414194579), (-414194573)⟩, ⟨20038708, 20038714⟩, ⟨(-1890873), (-1890864)⟩, ⟨197865, 197874⟩⟩
...
def j47 : Jet := ⟨⟨1914537218, 1914537224⟩, ⟨1914537218, 1914537224⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨853429725, 853429731⟩, ⟨1706859450, 1706859462⟩, ⟨853429725, 853429731⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨853429725, 853429731⟩, ⟨1706859450, 1706859462⟩, ⟨853429725, 853429731⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-853429731), (-853429725)⟩, ⟨(-1706859462), (-1706859450)⟩, ⟨(-853429731), (-853429725)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-426714866), (-426714862)⟩, ⟨(-853429731), (-853429725)⟩, ⟨(-426714866), (-426714862)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3888765068, 3888765072⟩, ⟨(-772715484), (-772715476)⟩, ⟨(-309586686), (-309586679)⟩, ⟨71686135, 71686138⟩, ⟨11817982, 11817984⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3493690525, 3493690533⟩, ⟨(-1069233937), (-1069233921)⟩, ⟨(-185472561), (-185472544)⟩, ⟨88941690, 88941707⟩, ⟨2779060, 2779077⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 921678507⟩, ⟨460839253, 460839254⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2895538427⟩, ⟨1447769211, 1447769215⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1952085361⟩, ⟨0, 1952085364⟩, ⟨488021338, 488021342⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 490⟩, ⟨0, 490⟩, ⟨122, 123⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94196)⟩, ⟨0, 490⟩, ⟨122, 123⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-43036), 0⟩, ⟨(-43036), 223⟩, ⟨(-10759), (-10424)⟩, ⟨0, 112⟩, ⟨13, 14⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5070020, 5113057⟩, ⟨(-43036), 223⟩, ⟨(-10759), (-10424)⟩, ⟨0, 112⟩, ⟨13, 14⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 2323912⟩, ⟨(-19561), 2324014⟩, ⟨551635, 581080⟩, ⟨(-9782), 77⟩, ⟨(-1223), (-1126)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-140841664)⟩, ⟨(-19561), 2324014⟩, ⟨551635, 581080⟩, ⟨(-9782), 77⟩, ⟨(-1223), (-1126)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-65069513), 0⟩, ⟨(-65078404), 1056277⟩, ⟨(-16276270), (-14682939)⟩, ⟨(-6669), 528209⟩, ⟨57678, 66061⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1366586252, 1431655766⟩, ⟨(-65078404), 1056277⟩, ⟨(-16276270), (-14682939)⟩, ⟨(-6669), 528209⟩, ⟨57678, 66061⟩⟩
...
def j70 : Jet := ⟨⟨(-50), 0⟩, ⟨(-50), 0⟩, ⟨(-13), (-12)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11785, 11836⟩, ⟨(-50), 0⟩, ⟨(-13), (-12)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨0, 5380⟩, ⟨(-23), 5380⟩, ⟨1310, 1345⟩, ⟨(-12), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-846796)⟩, ⟨(-23), 5380⟩, ⟨1310, 1345⟩, ⟨(-12), 0⟩, ⟨(-2), (-1)⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-387319), 0⟩, ⟨(-387330), 2446⟩, ⟨(-96841), (-93160)⟩, ⟨(-9), 1224⟩, ⟨141, 153⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35404075, 35791395⟩, ⟨(-387330), 2446⟩, ⟨(-96841), (-93160)⟩, ⟨(-9), 1224⟩, ⟨141, 153⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 16267379⟩, ⟨(-176044), 16268491⟩, ⟨3802775, 4067957⟩, ⟨(-88031), 835⟩, ⟨(-11009), (-9958)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-699560503)⟩, ⟨(-176044), 16268491⟩, ⟨3802775, 4067957⟩, ⟨(-88031), 835⟩, ⟨(-11009), (-9958)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-325347561), 0⟩, ⟨(-325427574), 7394116⟩, ⟨(-81416904), (-70245463)⟩, ⟨(-60015), 3697817⟩, ⟨387080, 462607⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3969619735, 4294967296⟩, ⟨(-325427574), 7394116⟩, ⟨(-81416904), (-70245463)⟩, ⟨(-60015), 3697817⟩, ⟨387080, 462607⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 965179477⟩, ⟨416781864, 483301850⟩, ⟨(-32909932), 356056⟩, ⟨(-5490985), (-4593296)⟩, ⟨(-2249), 222589⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4646980141⟩, ⟨(-8655821), 380957265⟩, ⟨69589615, 126540266⟩, ⟨(-4742034), 18257404⟩, ⟨(-53727), 3681335⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 1044284986⟩, ⟨414836698, 608522966⟩, ⟨(-36581228), 71689955⟩, ⟨(-3172785), 13815153⟩, ⟨(-2004769), 3144133⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-921678507), 0⟩, ⟨(-460839254), (-460839253)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3373288789, 4294967296⟩, ⟨(-460839254), (-460839253)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 253909066⟩, ⟨0, 295914430⟩, ⟨22278871, 121078848⟩, ⟨(-11908734), 27032544⟩, ⟨(-2484546), 6640302⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4548876362⟩, ⟨0, 295914430⟩, ⟨22278871, 121078848⟩, ⟨(-11908734), 27032544⟩, ⟨(-2484546), 6640302⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4420099005⟩, ⟨0, 147957215⟩, ⟨8347740, 60539424⟩, ⟨(-8039889), 13516272⟩, ⟨(-2134560), 3589005⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3373288789, 4420099005⟩, ⟨(-474265574), (-312882038)⟩, ⟨(-9319084), 60539424⟩, ⟨(-14535618), 12620581⟩, ⟨(-3584823), 4451665⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 3829074443⟩, ⟨1914537218, 1914537224⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 3413718914⟩, ⟨0, 3413718918⟩, ⟨853429725, 853429731⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 3413718914⟩, ⟨0, 3413718918⟩, ⟨853429725, 853429731⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-3413718914), 0⟩, ⟨(-3413718918), 0⟩, ⟨(-853429731), (-853429725)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-1706859457), 0⟩, ⟨(-1706859459), 0⟩, ⟨(-426714866), (-426714862)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2886471303, 4294967296⟩, ⟨(-1706859459), 0⟩, ⟨(-426714866), 52383264⟩, ⟨(-6939197), 169580408⟩, ⟨(-19450402), 21886977⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2267048993, 4420099005⟩, ⟨(-2230853524), (-210275180)⟩, ⟨(-448466073), 302926345⟩, ⟨(-51520257), 237964494⟩, ⟨(-53357842), 34445022⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨460839253, 460839254⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨460839253, 460839254⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4322408769, 4322408771⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified998
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 921678507⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4420099005⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified999
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (368969853 / 2147483648)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(42919 / 200000),
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(42919 / 200000), prawitzNormalCorrection
