...
namespace FiniteNormalPanel134_15
...
def j2 : Jet := ⟨⟨464767682, 464767686⟩, ⟨464767682, 464767686⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨50293514, 50293515⟩, ⟨100587028, 100587030⟩, ⟨50293514, 50293515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1109), (-1108)⟩, ⟨(-2218), (-2216)⟩, ⟨(-1109), (-1106)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111947, 5111949⟩, ⟨(-2218), (-2216)⟩, ⟨(-1109), (-1106)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨59860, 59861⟩, ⟨119694, 119696⟩, ⟨59795, 59798⟩, ⟨(-52), (-49)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-143105717), (-143105715)⟩, ⟨119694, 119696⟩, ⟨59795, 59798⟩, ⟨(-52), (-49)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1675750), (-1675749)⟩, ⟨(-3350099), (-3350096)⟩, ⟨(-1672247), (-1672244)⟩, ⟨2800, 2803⟩, ⟨697, 700⟩⟩
...
def j19 : Jet := ⟨⟨1429980015, 1429980017⟩, ⟨(-3350099), (-3350096)⟩, ⟨(-1672247), (-1672244)⟩, ⟨2800, 2803⟩, ⟨697, 700⟩⟩
...
def j28 : Jet := ⟨⟨(-9978), (-9977)⟩, ⟨(-19952), (-19950)⟩, ⟨(-9971), (-9968)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35781416, 35781418⟩, ⟨(-19952), (-19950)⟩, ⟨(-9971), (-9968)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨418995, 418996⟩, ⟨837757, 837759⟩, ⟨418410, 418413⟩, ⟨(-468), (-465)⟩, ⟨(-118), (-114)⟩⟩
...
def j33 : Jet := ⟨⟨(-715408888), (-715408886)⟩, ⟨837757, 837759⟩, ⟨418410, 418413⟩, ⟨(-468), (-465)⟩, ⟨(-118), (-114)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8377347), (-8377345)⟩, ⟨(-16744883), (-16744880)⟩, ⟨(-8352828), (-8352824)⟩, ⟨19603, 19606⟩, ⟨4886, 4889⟩⟩
...
def j36 : Jet := ⟨⟨4286589949, 4286589951⟩, ⟨(-16744883), (-16744880)⟩, ⟨(-8352828), (-8352824)⟩, ⟨19603, 19606⟩, ⟨4886, 4889⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨154741224, 154741226⟩, ⟨154378702, 154378705⟩, ⟨(-543480), (-543478)⟩, ⟨(-180656), (-180653)⟩, ⟨377, 380⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303361012, 4303361015⟩, ⟨16810392, 16810397⟩, ⟨8451171, 8451178⟩, ⟨46084, 46091⟩, ⟨11660, 11668⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨155043636, 155043640⟩, ⟨155286059, 155286064⟩, ⟨364174, 364179⟩, ⟨122291, 122298⟩, ⟨675, 683⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-147940149), (-147940148)⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4147027147, 4147027148⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5596906, 5596907⟩, ⟨11211314, 11211316⟩, ⟨5640714, 5640717⟩, ⟨35160, 35166⟩, ⟨8920, 8925⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300564202, 4300564203⟩, ⟨11211314, 11211316⟩, ⟨5640714, 5640717⟩, ⟨35160, 35166⟩, ⟨8920, 8925⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297764837, 4297764839⟩, ⟨5602008, 5602010⟩, ⟨2814870, 2814873⟩, ⟨13898, 13903⟩, ⟨3516, 3521⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4149728326, 4149728330⟩, ⟨(-142627465), (-142627460)⟩, ⟨2524949, 2524954⟩, ⟨(-83540), (-83533)⟩, ⟨2915, 2922⟩⟩
...
def j47 : Jet := ⟨⟨1388685784, 1388685795⟩, ⟨1388685784, 1388685795⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨449001837, 449001845⟩, ⟨898003674, 898003690⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨449001837, 449001845⟩, ⟨898003674, 898003690⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-449001845), (-449001837)⟩, ⟨(-898003690), (-898003674)⟩, ⟨(-449001845), (-449001837)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-224500923), (-224500918)⟩, ⟨(-449001845), (-449001837)⟩, ⟨(-224500923), (-224500918)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4076232873, 4076232879⟩, ⟨(-426135046), (-426135037)⟩, ⟨(-190793150), (-190793143)⟩, ⟨21498175, 21498177⟩, ⟨4424582, 4424583⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3938390644, 3938390654⟩, ⟨(-547088552), (-547088536)⟩, ⟨(-167793806), (-167793791)⟩, ⟨26777250, 26777265⟩, ⟨3459934, 3459948⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 295880298⟩, ⟨147940148, 147940149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 929535371⟩, ⟨464767682, 464767686⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 201174060⟩, ⟨0, 201174060⟩, ⟨50293514, 50293515⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4436), 0⟩, ⟨(-4436), 3⟩, ⟨(-1109), (-1104)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108620, 5113057⟩, ⟨(-4436), 3⟩, ⟨(-1109), (-1104)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 239493⟩, ⟨(-208), 239494⟩, ⟨59561, 59875⟩, ⟨(-104), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142926083)⟩, ⟨(-208), 239494⟩, ⟨59561, 59875⟩, ⟨(-104), 2⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-6705803), 0⟩, ⟨(-6705813), 11218⟩, ⟨(-1676461), (-1659623)⟩, ⟨(-8), 5611⟩, ⟨691, 703⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424949962, 1431655766⟩, ⟨(-6705813), 11218⟩, ⟨(-1676461), (-1659623)⟩, ⟨(-8), 5611⟩, ⟨691, 703⟩⟩
...
def j72 : Jet := ⟨⟨0, 555⟩, ⟨(-1), 555⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851621)⟩, ⟨(-1), 555⟩, ⟨136, 139⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-39916), 0⟩, ⟨(-39917), 26⟩, ⟨(-9980), (-9939)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35751478, 35791395⟩, ⟨(-39917), 26⟩, ⟨(-9980), (-9939)⟩, ⟨(-2), 14⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1676451⟩, ⟨(-1870), 1676453⟩, ⟨416307, 419115⟩, ⟨(-937), 2⟩, ⟨(-119), (-114)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714151431)⟩, ⟨(-1870), 1676453⟩, ⟨416307, 419115⟩, ⟨(-937), 2⟩, ⟨(-119), (-114)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-33529011), 0⟩, ⟨(-33529099), 78525⟩, ⟨(-8382341), (-8264464)⟩, ⟨(-66), 39265⟩, ⟨4824, 4909⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4261438285, 4294967296⟩, ⟨(-33529099), 78525⟩, ⟨(-8382341), (-8264464)⟩, ⟨(-66), 39265⟩, ⟨4824, 4909⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 309845124⟩, ⟨152745609, 154924991⟩, ⟨(-1088478), 1214⟩, ⟨(-181416), (-178376)⟩, ⟨(-1), 761⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4328760114⟩, ⟨(-79766), 34058790⟩, ⟨8263841, 8782742⟩, ⟨(-40205), 136166⟩, ⟨10327, 13487⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 312282987⟩, ⟨152739854, 158600993⟩, ⟨(-1099921), 1863369⟩, ⟨99517, 148274⟩, ⟨(-5118), 6659⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-295880298), 0⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3999086998, 4294967296⟩, ⟨(-147940149), (-147940148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 22705799⟩, ⟨0, 23063456⟩, ⟨5271863, 6127655⟩, ⟨(-81234), 159180⟩, ⟨5854, 12731⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4317673095⟩, ⟨0, 23063456⟩, ⟨5271863, 6127655⟩, ⟨(-81234), 159180⟩, ⟨5854, 12731⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306305231⟩, ⟨0, 11531728⟩, ⟨2613551, 3063828⟩, ⟨(-48844), 79590⟩, ⟨1615, 5703⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3999086998, 4306305231⟩, ⟨(-148330685), (-136408420)⟩, ⟨2036292, 3063828⟩, ⟨(-154378), (-10433)⟩, ⟨(-1239), 7386⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2777371589⟩, ⟨1388685784, 1388685795⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1796007377⟩, ⟨0, 1796007378⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1796007377⟩, ⟨0, 1796007378⟩, ⟨449001837, 449001845⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1796007377), 0⟩, ⟨(-1796007378), 0⟩, ⟨(-449001845), (-449001837)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-898003689), 0⟩, ⟨(-898003689), 0⟩, ⟨(-224500923), (-224500918)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3484627541, 4294967296⟩, ⟨(-898003689), 0⟩, ⟨(-224500923), (-88265344)⟩, ⟨0, 46939277⟩, ⟨(-146704), 5867410⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3244571548, 4306305231⟩, ⟨(-1048704941), (-110671980)⟩, ⟨(-223441465), (-48107524)⟩, ⟨2008340, 54808073⟩, ⟨(-1929572), 5880716⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297764837, 4297764839⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2702
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306305231⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2703
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (66885913 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 14 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(6889 / 100000), prawitzNormalCorrection
