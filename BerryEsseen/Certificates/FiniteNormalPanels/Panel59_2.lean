...
namespace FiniteNormalPanel59_2

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (33761 / 400000)
def radius : Rat := (33761 / 400000)

def j0 : Jet := ⟨⟨362505977, 362505978⟩, ⟨362505977, 362505978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1138846114, 1138846118⟩, ⟨1138846114, 1138846118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨301974469, 301974472⟩, ⟨603948938, 603948944⟩, ⟨301974469, 301974472⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨75, 76⟩, ⟨151, 152⟩, ⟨75, 76⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94612), (-94610)⟩, ⟨151, 152⟩, ⟨75, 76⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-6653), (-6651)⟩, ⟨(-13295), (-13292)⟩, ⟨(-6627), (-6623)⟩, ⟨20, 22⟩, ⟨5, 6⟩⟩
...
def j13 : Jet := ⟨⟨5106403, 5106406⟩, ⟨(-13295), (-13292)⟩, ⟨(-6627), (-6623)⟩, ⟨20, 22⟩, ⟨5, 6⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨359025, 359026⟩, ⟨717116, 717118⟩, ⟨356689, 356692⟩, ⟨(-1866), (-1863)⟩, ⟨(-464), (-460)⟩⟩
...
def j16 : Jet := ⟨⟨(-142806552), (-142806550)⟩, ⟨717116, 717118⟩, ⟨356689, 356692⟩, ⟨(-1866), (-1863)⟩, ⟨(-464), (-460)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-10040574), (-10040572)⟩, ⟨(-20030728), (-20030725)⟩, ⟨(-9914657), (-9914653)⟩, ⟨100443, 100448⟩, ⟨24782, 24786⟩⟩
...
def j19 : Jet := ⟨⟨1421615191, 1421615194⟩, ⟨(-20030728), (-20030725)⟩, ⟨(-9914657), (-9914653)⟩, ⟨100443, 100448⟩, ⟨24782, 24786⟩⟩
...
def j22 : Jet := ⟨⟨(-8), (-7)⟩, ⟨(-16), (-15)⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11827, 11829⟩, ⟨(-16), (-15)⟩, ⟨(-8), (-7)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨831, 832⟩, ⟨1661, 1663⟩, ⟨827, 830⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851346), (-851344)⟩, ⟨1661, 1663⟩, ⟨827, 830⟩, ⟨(-4), (-1)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-59858), (-59857)⟩, ⟨(-119599), (-119597)⟩, ⟨(-59567), (-59564)⟩, ⟨231, 234⟩, ⟨56, 59⟩⟩
...
def j30 : Jet := ⟨⟨35731536, 35731538⟩, ⟨(-119599), (-119597)⟩, ⟨(-59567), (-59564)⟩, ⟨231, 234⟩, ⟨56, 59⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨2512245, 2512246⟩, ⟨5016081, 5016084⟩, ⟨2491238, 2491242⟩, ⟨(-16770), (-16766)⟩, ⟨(-4154), (-4149)⟩⟩
...
def j33 : Jet := ⟨⟨(-713315638), (-713315636)⟩, ⟨5016081, 5016084⟩, ⟨2491238, 2491242⟩, ⟨(-16770), (-16766)⟩, ⟨(-4154), (-4149)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-50152446), (-50152444)⟩, ⟨(-99952216), (-99952213)⟩, ⟨(-49271940), (-49271936)⟩, ⟨701807, 701812⟩, ⟨172504, 172509⟩⟩
...
def j36 : Jet := ⟨⟨4244814850, 4244814852⟩, ⟨(-99952216), (-99952213)⟩, ⟨(-49271940), (-49271936)⟩, ⟨701807, 701812⟩, ⟨172504, 172509⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨376953029, 376953033⟩, ⟨371641715, 371641721⟩, ⟨(-7940268), (-7940264)⟩, ⟨(-2602321), (-2602317)⟩, ⟨33204, 33208⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4345712290, 4345712293⟩, ⟨102328034, 102328039⟩, ⟨52852615, 52852622⟩, ⟨1713798, 1713808⟩, ⟨460315, 460325⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨381406725, 381406730⟩, ⟨385013602, 385013610⟩, ⟨5458992, 5459000⟩, ⟨1901481, 1901491⟩, ⟨62578, 62588⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-362505978), (-362505977)⟩, ⟨(-362505978), (-362505977)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3932461318, 3932461319⟩, ⟨(-362505978), (-362505977)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨33870127, 33870129⟩, ⟨68380858, 68380862⟩, ⟨35483310, 35483317⟩, ⟨1316434, 1316440⟩, ⟨358960, 358969⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4328837423, 4328837425⟩, ⟨68380858, 68380862⟩, ⟨35483310, 35483317⟩, ⟨1316434, 1316440⟩, ⟨358960, 358969⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4311869103, 4311869105⟩, ⟨34056408, 34056411⟩, ⟨17537616, 17537621⟩, ⟨517119, 517123⟩, ⟨139025, 139032⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3947936570, 3947936574⟩, ⟨(-332750571), (-332750566)⟩, ⟨13182950, 13182957⟩, ⟨(-1006748), (-1006741)⟩, ⟨83643, 83652⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨27370812872, 27370812878⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value325

def j47 : Jet := ⟨⟨2310165032, 2310165040⟩, ⟨2310165032, 2310165040⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨1242585125, 1242585134⟩, ⟨2485170250, 2485170268⟩, ⟨1242585125, 1242585134⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨1242585125, 1242585134⟩, ⟨2485170250, 2485170268⟩, ⟨1242585125, 1242585134⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-1242585134), (-1242585125)⟩, ⟨(-2485170268), (-2485170250)⟩, ⟨(-1242585134), (-1242585125)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-621292567), (-621292562)⟩, ⟨(-1242585134), (-1242585125)⟩, ⟨(-621292567), (-621292562)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3716520912, 3716520921⟩, ⟨(-1075233717), (-1075233705)⟩, ⟨(-382077909), (-382077899)⟩, ⟨140539193, 140539197⟩, ⟨17470004, 17470007⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3416228299, 3416228312⟩, ⟨(-1276291204), (-1276291185)⟩, ⟨(-256495556), (-256495535)⟩, ⟨154613538, 154613555⟩, ⟨4321891, 4321911⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 725011955⟩, ⟨362505977, 362505978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 2277692232⟩, ⟨1138846114, 1138846118⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 1207897883⟩, ⟨0, 1207897886⟩, ⟨301974469, 301974472⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 303⟩, ⟨0, 303⟩, ⟨75, 76⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94383)⟩, ⟨0, 303⟩, ⟨75, 76⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-26630), 0⟩, ⟨(-26630), 86⟩, ⟨(-6658), (-6527)⟩, ⟨0, 44⟩, ⟨5, 6⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5086426, 5113057⟩, ⟨(-26630), 86⟩, ⟨(-6658), (-6527)⟩, ⟨0, 44⟩, ⟨5, 6⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 1437974⟩, ⟨(-7490), 1437999⟩, ⟨348258, 359519⟩, ⟨(-3746), 20⟩, ⟨(-469), (-443)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-141727602)⟩, ⟨(-7490), 1437999⟩, ⟨348258, 359519⟩, ⟨(-3746), 20⟩, ⟨(-469), (-443)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-40263263), 0⟩, ⟨(-40265370), 404417⟩, ⟨(-10067923), (-9459186)⟩, ⟨(-1581), 202221⟩, ⟨23299, 25284⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1391392502, 1431655766⟩, ⟨(-40265370), 404417⟩, ⟨(-10067923), (-9459186)⟩, ⟨(-1581), 202221⟩, ⟨23299, 25284⟩⟩
...
def j72 : Jet := ⟨⟨0, 3329⟩, ⟨(-9), 3329⟩, ⟨817, 833⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-848847)⟩, ⟨(-9), 3329⟩, ⟨817, 833⟩, ⟨(-6), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-239663), 0⟩, ⟨(-239666), 937⟩, ⟨(-59919), (-58509)⟩, ⟨(-3), 470⟩, ⟨54, 59⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35551731, 35791395⟩, ⟨(-239666), 937⟩, ⟨(-59919), (-58509)⟩, ⟨(-3), 470⟩, ⟨54, 59⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 10065816⟩, ⟨(-67403), 10066080⟩, ⟨2415348, 2516718⟩, ⟨(-33704), 199⟩, ⟨(-4214), (-3963)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-705762066)⟩, ⟨(-67403), 10066080⟩, ⟨2415348, 2516718⟩, ⟨(-33704), 199⟩, ⟨(-4214), (-3963)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-201316314), 0⟩, ⟨(-201335272), 2830941⟩, ⟨(-50348036), (-46082629)⟩, ⟨(-14219), 1415583⟩, ⟨159155, 177004⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4093650982, 4294967296⟩, ⟨(-201335272), 2830941⟩, ⟨(-50348036), (-46082629)⟩, ⟨(-14219), 1415583⟩, ⟨159155, 177004⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 759230745⟩, ⟨347585840, 379829843⟩, ⟨(-16015884), 107235⟩, ⟨(-2670433), (-2400939)⟩, ⟨(-420), 67030⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4506183883⟩, ⟨(-3116227), 221624600⟩, ⟨45936549, 66321816⟩, ⟨(-1642430), 6003288⟩, ⟨157125, 945049⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 796567963⟩, ⟨347034977, 437686064⟩, ⟨(-17079096), 31435962⟩, ⟨(-200949), 4537135⟩, ⟨(-530803), 771887⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-725011955), 0⟩, ⟨(-362505978), (-362505977)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3569955341, 4294967296⟩, ⟨(-362505978), (-362505977)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 147735822⟩, ⟨0, 162351270⟩, ⟨21705392, 56263725⟩, ⟨(-3555490), 8090038⟩, ⟨(-362857), 1441136⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4442703118⟩, ⟨0, 162351270⟩, ⟨21705392, 56263725⟩, ⟨(-3555490), 8090038⟩, ⟨(-362857), 1441136⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4368210687⟩, ⟨0, 81175635⟩, ⟨9916470, 28131863⟩, ⟨(-2309443), 4045019⟩, ⟨(-350012), 752770⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3569955341, 4368210687⟩, ⟨(-368687904), (-281330342)⟩, ⟨1391093, 28131863⟩, ⟨(-4683843), 3208045⟩, ⟨(-691422), 947693⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 4620330072⟩, ⟨2310165032, 2310165040⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 4970340518⟩, ⟨0, 4970340528⟩, ⟨1242585125, 1242585134⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 4970340518⟩, ⟨0, 4970340528⟩, ⟨1242585125, 1242585134⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4970340518), 0⟩, ⟨(-4970340528), 0⟩, ⟨(-1242585134), (-1242585125)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2485170259), 0⟩, ⟨(-2485170264), 0⟩, ⟨(-621292567), (-621292562)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2408056881, 4294967296⟩, ⟨(-2485170264), 0⟩, ⟨(-621292567), 370649573⟩, ⟨(-71488888), 359494662⟩, ⟨(-78811374), 55278126⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2001564838, 4368210687⟩, ⟨(-2896238537), (-157733323)⟩, ⟨(-631107717), 618433831⟩, ⟨(-125486862), 422166179⟩, ⟨(-117632169), 68443155⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨362505977, 362505978⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨362505977, 362505978⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4311869103, 4311869105⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar325 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1158
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar325 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 725011955⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4368210687⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1159
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(33761 / 200000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (33761 / 200000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(33761 / 200000), prawitzNormalCorrection
      ((260167 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
