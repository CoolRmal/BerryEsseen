...
namespace FiniteNormalPanel123_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (27489 / 160000)
def radius : Rat := (27489 / 800000)

def j0 : Jet := ⟨⟨737902224, 737902225⟩, ⟨147580444, 147580445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2318188205, 2318188210⟩, ⟨463637638, 463637642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨1251231076, 1251231083⟩, ⟨500492426, 500492434⟩, ⟨50049242, 50049244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-27494), (-27492)⟩, ⟨(-10962), (-10960)⟩, ⟨(-1083), (-1080)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5085562, 5085565⟩, ⟨(-10962), (-10960)⟩, ⟨(-1083), (-1080)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨1481551, 1481552⟩, ⟨589426, 589429⟩, ⟨57668, 57672⟩, ⟨(-255), (-250)⟩, ⟨(-13), (-10)⟩⟩
...
def j16 : Jet := ⟨⟨(-141684026), (-141684024)⟩, ⟨589426, 589429⟩, ⟨57668, 57672⟩, ⟨(-255), (-250)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-41276091), (-41276089)⟩, ⟨(-16338723), (-16338719)⟩, ⟨(-1565559), (-1565554)⟩, ⟨13513, 13518⟩, ⟨638, 642⟩⟩
...
def j19 : Jet := ⟨⟨1390379674, 1390379677⟩, ⟨(-16338723), (-16338719)⟩, ⟨(-1565559), (-1565554)⟩, ⟨13513, 13518⟩, ⟨638, 642⟩⟩
...
def j25 : Jet := ⟨⟨3438, 3440⟩, ⟨1371, 1373⟩, ⟨134, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-848739), (-848736)⟩, ⟨1371, 1373⟩, ⟨134, 137⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-247259), (-247257)⟩, ⟨(-98505), (-98503)⟩, ⟨(-9693), (-9690)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35544135, 35544138⟩, ⟨(-98505), (-98503)⟩, ⟨(-9693), (-9690)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨10354892, 10354894⟩, ⟨4113260, 4113262⟩, ⟨399892, 399896⟩, ⟨(-2270), (-2266)⟩, ⟨(-111), (-107)⟩⟩
...
def j33 : Jet := ⟨⟨(-705472991), (-705472988)⟩, ⟨4113260, 4113262⟩, ⟨399892, 399896⟩, ⟨(-2270), (-2266)⟩, ⟨(-111), (-107)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-205521876), (-205521873)⟩, ⟨(-81010456), (-81010452)⟩, ⟨(-7625060), (-7625055)⟩, ⟨93868, 93872⟩, ⟨4361, 4365⟩⟩
...
def j36 : Jet := ⟨⟨4089445420, 4089445423⟩, ⟨(-81010456), (-81010452)⟩, ⟨(-7625060), (-7625055)⟩, ⟨93868, 93872⟩, ⟨4361, 4365⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨750450827, 750450831⟩, ⟨141271415, 141271421⟩, ⟨(-2608754), (-2608749)⟩, ⟨(-161708), (-161703)⟩, ⟨1802, 1807⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4510818012, 4510818016⟩, ⟨89357691, 89357698⟩, ⟨10180876, 10180885⟩, ⟨264746, 264754⟩, ⟨17358, 17369⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨788165979, 788165985⟩, ⟨163984530, 163984540⟩, ⟨1978202, 1978212⟩, ⟨157019, 157029⟩, ⟨4083, 4095⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-737902225), (-737902224)⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3557065071, 3557065072⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨144635702, 144635705⟩, ⟨60185336, 60185342⟩, ⟨6987067, 6987075⟩, ⟨208684, 208694⟩, ⟨14399, 14408⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4439602998, 4439603001⟩, ⟨60185336, 60185342⟩, ⟨6987067, 6987075⟩, ⟨208684, 208694⟩, ⟨14399, 14408⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4366686350, 4366686352⟩, ⟨29598421, 29598425⟩, ⟨3335842, 3335847⟩, ⟨80016, 80023⟩, ⟨5264, 5270⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3616462343, 3616462346⟩, ⟨(-125531575), (-125531569)⟩, ⟨1745684, 1745690⟩, ⟨(-48356), (-48348)⟩, ⟨1609, 1616⟩⟩
...
def j47 : Jet := ⟨⟨7308754654, 7308754666⟩, ⟨1461750922, 1461750934⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12437322780, 12437322822⟩, ⟨4974929082, 4974929132⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12437322780, 12437322822⟩, ⟨4974929082, 4974929132⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12437322822), (-12437322780)⟩, ⟨(-4974929132), (-4974929082)⟩, ⟨(-497492914), (-497492905)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6218661411), (-6218661390)⟩, ⟨(-2487464566), (-2487464541)⟩, ⟨(-248746457), (-248746452)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1009594733, 1009594752⟩, ⟨(-584714854), (-584714836)⟩, ⟨110849643, 110849653⟩, ⟨1176329, 1176334⟩, ⟨(-3380295), (-3380292)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨850102243, 850102261⟩, ⟨(-521851535), (-521851515)⟩, ⟨110838134, 110838147⟩, ⟨(-2498399), (-2498387)⟩, ⟨(-2828656), (-2828646)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨590321779, 885482670⟩, ⟨147580444, 147580445⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1854550564, 2781825852⟩, ⟨463637638, 463637642⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨800787889, 1801772759⟩, ⟨400393940, 600590920⟩, ⟨50049242, 50049244⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-39639), (-17569)⟩, ⟨(-13195), (-8720)⟩, ⟨(-1091), (-1070)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5073417, 5095488⟩, ⟨(-13195), (-8720)⟩, ⟨(-1091), (-1070)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨945928, 2137598⟩, ⟨467428, 710908⟩, ⟨56816, 58367⟩, ⟨(-307), (-198)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142219649), (-141027978)⟩, ⟨467428, 710908⟩, ⟨56816, 58367⟩, ⟨(-307), (-198)⟩, ⟨(-13), (-10)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-59662268), (-26294378)⟩, ⟨(-19800273), (-12848957)⟩, ⟨(-1603118), (-1519501)⟩, ⟨10613, 16411⟩, ⟨613, 662⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1371993497, 1405361388⟩, ⟨(-19800273), (-12848957)⟩, ⟨(-1603118), (-1519501)⟩, ⟨10613, 16411⟩, ⟨613, 662⟩⟩
...
def j72 : Jet := ⟨⟨2198, 4958⟩, ⟨1092, 1652⟩, ⟨133, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-849979), (-847218)⟩, ⟨1092, 1652⟩, ⟨133, 138⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-356573), (-157962)⟩, ⟨(-118655), (-78287)⟩, ⟨(-9780), (-9582)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35434821, 35633433⟩, ⟨(-118655), (-78287)⟩, ⟨(-9780), (-9582)⟩, ⟨23, 40⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨6606750, 14948508⟩, ⟨3253598, 4968240⟩, ⟨392225, 406153⟩, ⟨(-2747), (-1788)⟩, ⟨(-113), (-104)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-709221133), (-700879374)⟩, ⟨3253598, 4968240⟩, ⟨392225, 406153⟩, ⟨(-2747), (-1788)⟩, ⟨(-113), (-104)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-297523877), (-130677529)⟩, ⟨(-98568000), (-63254547)⟩, ⟨(-7888111), (-7302221)⟩, ⟨73325, 114357⟩, ⟨4137, 4548⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3997443419, 4164289767⟩, ⟨(-98568000), (-63254547)⟩, ⟨(-7888111), (-7302221)⟩, ⟨73325, 114357⟩, ⟨4137, 4548⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨592421580, 910244566⟩, ⟨135280869, 146159298⟩, ⟨(-3175752), (-2043146)⟩, ⟨(-168474), (-153398)⟩, ⟨1409, 2201⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4429745552, 4614635441⟩, ⟨67286754, 113786574⟩, ⟨8789775, 11911733⟩, ⟨124778, 436999⟩, ⟨9142, 28465⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨611012070, 977992741⟩, ⟨148807175, 181152833⟩, ⟨(-80346), 4289427⟩, ⟨28917, 307757⟩, ⟨(-6629), 16686⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-885482670), (-590321779)⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3409484626, 3704645517⟩, ⟨(-147580445), (-147580444)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨86924002, 222695480⟩, ⟨42339310, 82499422⟩, ⟨5119110, 9594116⟩, ⟨1448, 501998⟩, ⟨(-1099), 37846⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4381891298, 4517662776⟩, ⟨42339310, 82499422⟩, ⟨5119110, 9594116⟩, ⟨1448, 501998⟩, ⟨(-1099), 37846⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4338211592, 4404907931⟩, ⟨20641288, 40838525⟩, ⟨2306361, 4700135⟩, ⟨(-43530), 237524⟩, ⟨(-5327), 18532⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3443813353, 3799475362⟩, ⟨(-134972418), (-113840898)⟩, ⟨427601, 3344865⟩, ⟨(-199051), 125629⟩, ⟨(-12757), 17481⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5847003721, 8770505599⟩, ⟨1461750922, 1461750934⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨7959886573, 17909744863⟩, ⟨3979943264, 5969914958⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨7959886573, 17909744863⟩, ⟨3979943264, 5969914958⟩, ⟨497492905, 497492914⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17909744863), (-7959886573)⟩, ⟨(-5969914958), (-3979943264)⟩, ⟨(-497492914), (-497492905)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8954872432), (-3979943286)⟩, ⟨(-2984957479), (-1989971632)⟩, ⟨(-248746457), (-248746452)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨533911715, 1700277012⟩, ⟨(-1181674792), (-247375379)⟩, ⟨(-41165131), 379703907⟩, ⟨(-78412124), 55161538⟩, ⟨(-20579601), 14815958⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨428103910, 1504123355⟩, ⟨(-1098782467), (-212503508)⟩, ⟨(-29806087), 374358228⟩, ⟨(-82297595), 50116539⟩, ⟨(-20010587), 15928258⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨737902224, 737902225⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4366686350, 4366686352⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2474
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨590321779, 885482670⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4338211592, 4404907931⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2475
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (1911847 / 134217728)

theorem envelope_integral : (∫ s in ((27489 / 200000) : ℝ)..(82467 / 400000),
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((27489 / 200000) : ℝ)..(82467 / 400000), prawitzNormalCorrection
