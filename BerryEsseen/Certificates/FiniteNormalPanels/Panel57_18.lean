...
namespace FiniteNormalPanel57_18
...
def j2 : Jet := ⟨⟨561782623, 561782627⟩, ⟨561782623, 561782627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨73481284, 73481286⟩, ⟨146962568, 146962572⟩, ⟨73481284, 73481286⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1620), (-1619)⟩, ⟨(-3240), (-3238)⟩, ⟨(-1619), (-1616)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111436, 5111438⟩, ⟨(-3240), (-3238)⟩, ⟨(-1619), (-1616)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨87449, 87451⟩, ⟨174843, 174846⟩, ⟨87310, 87314⟩, ⟨(-112), (-109)⟩, ⟨(-28), (-25)⟩⟩
...
def j16 : Jet := ⟨⟨(-143078128), (-143078125)⟩, ⟨174843, 174846⟩, ⟨87310, 87314⟩, ⟨(-112), (-109)⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2447881), (-2447879)⟩, ⟨(-4892770), (-4892767)⟩, ⟨(-2440406), (-2440402)⟩, ⟨5976, 5979⟩, ⟨1488, 1491⟩⟩
...
def j19 : Jet := ⟨⟨1429207884, 1429207887⟩, ⟨(-4892770), (-4892767)⟩, ⟨(-2440406), (-2440402)⟩, ⟨5976, 5979⟩, ⟨1488, 1491⟩⟩
...
def j25 : Jet := ⟨⟨202, 203⟩, ⟨403, 405⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851975), (-851973)⟩, ⟨403, 405⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14577), (-14576)⟩, ⟨(-29147), (-29145)⟩, ⟨(-14561), (-14558)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35776817, 35776819⟩, ⟨(-29147), (-29145)⟩, ⟨(-14561), (-14558)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨612094, 612095⟩, ⟨1223690, 1223692⟩, ⟨610846, 610849⟩, ⟨(-998), (-995)⟩, ⟨(-250), (-247)⟩⟩
...
def j33 : Jet := ⟨⟨(-715215789), (-715215787)⟩, ⟨1223690, 1223692⟩, ⟨610846, 610849⟩, ⟨(-998), (-995)⟩, ⟨(-250), (-247)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-12236409), (-12236408)⟩, ⟨(-24451883), (-24451881)⟩, ⟨(-12184088), (-12184085)⟩, ⟨41818, 41821⟩, ⟨10410, 10413⟩⟩
...
def j36 : Jet := ⟨⟨4282730887, 4282730888⟩, ⟨(-24451883), (-24451881)⟩, ⟨(-12184088), (-12184085)⟩, ⟨41818, 41821⟩, ⟨10410, 10413⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨186940690, 186940693⟩, ⟨186300714, 186300719⟩, ⟨(-959182), (-959179)⟩, ⟨(-318425), (-318422)⟩, ⟨975, 979⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4307238665, 4307238667⟩, ⟨24591805, 24591809⟩, ⟨12394211, 12394217⟩, ⟨98664, 98671⟩, ⟨25109, 25117⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨187474807, 187474811⟩, ⟨187903374, 187903381⟩, ⟨644247, 644254⟩, ⟨217083, 217091⟩, ⟨1756, 1767⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-178820964), (-178820963)⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4116146332, 4116146333⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8183252, 8183254⟩, ⟨16403918, 16403922⟩, ⟨8276951, 8276954⟩, ⟨75320, 75324⟩, ⟨19242, 19249⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303150548, 4303150550⟩, ⟨16403918, 16403922⟩, ⟨8276951, 8276954⟩, ⟨75320, 75324⟩, ⟨19242, 19249⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299056974, 4299056976⟩, ⟨8194156, 8194159⟩, ⟨4126729, 4126732⟩, ⟨29757, 29761⟩, ⟨7573, 7579⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4120065736, 4120065740⟩, ⟨(-171138246), (-171138240)⟩, ⟨3613748, 3613753⟩, ⟨(-143299), (-143294)⟩, ⟨6017, 6026⟩⟩
...
def j47 : Jet := ⟨⟨1195808053, 1195808061⟩, ⟨1195808053, 1195808061⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨332937785, 332937790⟩, ⟨665875570, 665875580⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨332937785, 332937790⟩, ⟨665875570, 665875580⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-332937790), (-332937785)⟩, ⟨(-665875580), (-665875570)⟩, ⟨(-332937790), (-332937785)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-166468895), (-166468892)⟩, ⟨(-332937790), (-332937785)⟩, ⟨(-166468895), (-166468892)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4131683210, 4131683214⟩, ⟨(-320280315), (-320280309)⟩, ⟨(-147726394), (-147726390)⟩, ⟨12092999, 12093001⟩, ⟨2628511, 2628512⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3963430976, 3963430985⟩, ⟨(-471869711), (-471869697)⟩, ⟨(-125472292), (-125472279)⟩, ⟨17079547, 17079558⟩, ⟨1931787, 1931801⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 357641927⟩, ⟨178820963, 178820964⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1123565251⟩, ⟨561782623, 561782627⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 293925143⟩, ⟨0, 293925144⟩, ⟨73481284, 73481286⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6480), 0⟩, ⟨(-6480), 6⟩, ⟨(-1620), (-1610)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106576, 5113057⟩, ⟨(-6480), 6⟩, ⟨(-1620), (-1610)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 349911⟩, ⟨(-444), 349912⟩, ⟨86811, 87479⟩, ⟨(-222), 2⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142815665)⟩, ⟨(-444), 349912⟩, ⟨86811, 87479⟩, ⟨(-222), 2⟩, ⟨(-28), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9797505), 0⟩, ⟨(-9797536), 23947⟩, ⟨(-2449408), (-2413455)⟩, ⟨(-24), 11975⟩, ⟨1467, 1498⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421858260, 1431655766⟩, ⟨(-9797536), 23947⟩, ⟨(-2449408), (-2413455)⟩, ⟨(-24), 11975⟩, ⟨1467, 1498⟩⟩
...
def j72 : Jet := ⟨⟨0, 810⟩, ⟨(-1), 810⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851366)⟩, ⟨(-1), 810⟩, ⟨200, 203⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-58319), 0⟩, ⟨(-58320), 56⟩, ⟨(-14581), (-14495)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35733075, 35791395⟩, ⟨(-58320), 56⟩, ⟨(-14581), (-14495)⟩, ⟨(-2), 28⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2449377⟩, ⟨(-3992), 2449381⟩, ⟨606356, 612349⟩, ⟨(-1997), 3⟩, ⟨(-251), (-244)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713378505)⟩, ⟨(-3992), 2449381⟩, ⟨606356, 612349⟩, ⟨(-1997), 3⟩, ⟨(-251), (-244)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-48987524), 0⟩, ⟨(-48987799), 167623⟩, ⟨(-12247156), (-11995446)⟩, ⟨(-206), 83813⟩, ⟨10218, 10478⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4245979772, 4294967296⟩, ⟨(-48987799), 167623⟩, ⟨(-12247156), (-11995446)⟩, ⟨(-206), 83813⟩, ⟨10218, 10478⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 374521751⟩, ⟨183416318, 187267141⟩, ⟨(-1922287), 3133⟩, ⟨(-320391), (-312547)⟩, ⟨(-4), 1959⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4344520009⟩, ⟨(-171514), 50124704⟩, ⟨11993489, 13109700⟩, ⟨(-86772), 296046⟩, ⟨20928, 30899⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 378842755⟩, ⟨183401361, 193798598⟩, ⟨(-1951945), 3331852⟩, ⟨158091, 284949⟩, ⟨(-13397), 17609⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-357641927), 0⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3937325369, 4294967296⟩, ⟨(-178820964), (-178820963)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 33416281⟩, ⟨0, 34188478⟩, ⟨7487157, 9332412⟩, ⟨(-176154), 350952⟩, ⟨9621, 31409⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4328383577⟩, ⟨0, 34188478⟩, ⟨7487157, 9332412⟩, ⟨(-176154), 350952⟩, ⟨9621, 31409⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311643064⟩, ⟨0, 17094239⟩, ⟨3695212, 4666206⟩, ⟨(-106649), 175476⟩, ⟨1570, 14540⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3937325369, 4311643064⟩, ⟨(-179515260), (-161726724)⟩, ⟨2675792, 4666206⟩, ⟨(-300927), 21626⟩, ⟨(-5867), 18981⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2391616115⟩, ⟨1195808053, 1195808061⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1331751152⟩, ⟨0, 1331751156⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1331751152⟩, ⟨0, 1331751156⟩, ⟨332937785, 332937790⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1331751152), 0⟩, ⟨(-1331751156), 0⟩, ⟨(-332937790), (-332937785)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-665875576), 0⟩, ⟨(-665875578), 0⟩, ⟨(-166468895), (-166468892)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3678141884, 4294967296⟩, ⟨(-665875578), 0⟩, ⟨(-166468895), (-90943896)⟩, ⟨0, 25808712⟩, ⟨762128, 3226089⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3371863009, 4311643064⟩, ⟨(-847976187), (-138500201)⟩, ⟨(-164823728), (-50873420)⟩, ⟨2400127, 32888387⟩, ⟨(-570131), 3247593⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299056974, 4299056976⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1134
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311643064⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1135
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (81651573 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(8327 / 100000), prawitzNormalCorrection
