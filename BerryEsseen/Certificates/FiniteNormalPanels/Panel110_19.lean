...
namespace FiniteNormalPanel110_19
...
def j2 : Jet := ⟨⟨530984764, 530984768⟩, ⟨530984764, 530984768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨65645393, 65645395⟩, ⟨131290786, 131290790⟩, ⟨65645393, 65645395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1447), (-1446)⟩, ⟨(-2894), (-2892)⟩, ⟨(-1447), (-1443)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111609, 5111611⟩, ⟨(-2894), (-2892)⟩, ⟨(-1447), (-1443)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨78127, 78128⟩, ⟨156209, 156211⟩, ⟨78015, 78018⟩, ⟨(-90), (-87)⟩, ⟨(-23), (-20)⟩⟩
...
def j16 : Jet := ⟨⟨(-143087450), (-143087448)⟩, ⟨156209, 156211⟩, ⟨78015, 78018⟩, ⟨(-90), (-87)⟩, ⟨(-23), (-20)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2186986), (-2186985)⟩, ⟨(-4371585), (-4371583)⟩, ⟨(-2181019), (-2181016)⟩, ⟨4769, 4772⟩, ⟨1188, 1191⟩⟩
...
def j19 : Jet := ⟨⟨1429468779, 1429468781⟩, ⟨(-4371585), (-4371583)⟩, ⟨(-2181019), (-2181016)⟩, ⟨4769, 4772⟩, ⟨1188, 1191⟩⟩
...
def j28 : Jet := ⟨⟨(-13023), (-13022)⟩, ⟨(-26040), (-26038)⟩, ⟨(-13010), (-13007)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35778371, 35778373⟩, ⟨(-26040), (-26038)⟩, ⟨(-13010), (-13007)⟩, ⟨9, 12⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨546845, 546846⟩, ⟨1093292, 1093295⟩, ⟨545849, 545853⟩, ⟨(-797), (-793)⟩, ⟨(-199), (-196)⟩⟩
...
def j33 : Jet := ⟨⟨(-715281038), (-715281036)⟩, ⟨1093292, 1093295⟩, ⟨545849, 545853⟩, ⟨(-797), (-793)⟩, ⟨(-199), (-196)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-10932542), (-10932540)⟩, ⟨(-21848373), (-21848370)⟩, ⟨(-10890780), (-10890776)⟩, ⟨33382, 33385⟩, ⟨8313, 8317⟩⟩
...
def j36 : Jet := ⟨⟨4284034754, 4284034756⟩, ⟨(-21848373), (-21848370)⟩, ⟨(-10890780), (-10890776)⟩, ⟨33382, 33385⟩, ⟨8313, 8317⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨176724545, 176724547⟩, ⟨176184088, 176184091⟩, ⟨(-810096), (-810093)⟩, ⟨(-269050), (-269047)⟩, ⟨735, 738⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4305927735, 4305927738⟩, ⟨21960022, 21960027⟩, ⟨11058425, 11058433⟩, ⟨78666, 78673⟩, ⟨19980, 19989⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨177175532, 177175536⟩, ⟨177537282, 177537287⟩, ⟨543678, 543685⟩, ⟨182985, 182993⟩, ⟨1322, 1331⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-169017701), (-169017700)⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4125949595, 4125949596⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7308826, 7308827⟩, ⟨14647496, 14647500⟩, ⟨7383556, 7383561⟩, ⟨60042, 60046⟩, ⟨15302, 15309⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302276122, 4302276123⟩, ⟨14647496, 14647500⟩, ⟨7383556, 7383561⟩, ⟨60042, 60046⟩, ⟨15302, 15309⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298620155, 4298620157⟩, ⟨7317524, 7317527⟩, ⟨3682412, 3682416⟩, ⟨23726, 23730⟩, ⟨6025, 6031⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4129458704, 4129458708⟩, ⟨(-162131890), (-162131884)⟩, ⟨3249536, 3249542⟩, ⟨(-122121), (-122115)⟩, ⟨4853, 4861⟩⟩
...
def j47 : Jet := ⟨⟨1200042180, 1200042188⟩, ⟨1200042180, 1200042188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨335299697, 335299702⟩, ⟨670599394, 670599404⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨335299697, 335299702⟩, ⟨670599394, 670599404⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-335299702), (-335299697)⟩, ⟨(-670599404), (-670599394)⟩, ⟨(-335299702), (-335299697)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-167649851), (-167649848)⟩, ⟨(-335299702), (-335299697)⟩, ⟨(-167649851), (-167649848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4130547307, 4130547311⟩, ⟨(-322463756), (-322463750)⟩, ⟨(-148644821), (-148644816)⟩, ⟨12259508, 12259509⟩, ⟨2661833, 2661834⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3971374716, 3971374725⟩, ⟨(-465962620), (-465962606)⟩, ⟨(-127618815), (-127618801)⟩, ⟨17036895, 17036905⟩, ⟨1997841, 1997853⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 338035402⟩, ⟨169017700, 169017701⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1061969536⟩, ⟨530984764, 530984768⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 262581580⟩, ⟨0, 262581580⟩, ⟨65645393, 65645395⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-5789), 0⟩, ⟨(-5789), 5⟩, ⟨(-1448), (-1439)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107267, 5113057⟩, ⟨(-5789), 5⟩, ⟨(-1448), (-1439)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 312598⟩, ⟨(-354), 312599⟩, ⟨77617, 78151⟩, ⟨(-178), 2⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142852978)⟩, ⟨(-354), 312599⟩, ⟨77617, 78151⟩, ⟨(-178), 2⟩, ⟨(-23), (-19)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-8752720), 0⟩, ⟨(-8752742), 19112⟩, ⟨(-2188202), (-2159511)⟩, ⟨(-17), 9557⟩, ⟨1173, 1196⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422903045, 1431655766⟩, ⟨(-8752742), 19112⟩, ⟨(-2188202), (-2159511)⟩, ⟨(-17), 9557⟩, ⟨1173, 1196⟩⟩
...
def j72 : Jet := ⟨⟨0, 724⟩, ⟨(-1), 724⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851452)⟩, ⟨(-1), 724⟩, ⟨178, 181⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-52100), 0⟩, ⟨(-52101), 45⟩, ⟨(-13026), (-12956)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35739294, 35791395⟩, ⟨(-52101), 45⟩, ⟨(-13026), (-12956)⟩, ⟨(-2), 24⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2188180⟩, ⟨(-3186), 2188183⟩, ⟨542265, 547048⟩, ⟨(-1595), 3⟩, ⟨(-201), (-195)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713639702)⟩, ⟨(-3186), 2188183⟩, ⟨542265, 547048⟩, ⟨(-1595), 3⟩, ⟨(-201), (-195)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-43763597), 0⟩, ⟨(-43763792), 133780⟩, ⟨(-10941095), (-10740229)⟩, ⟨(-147), 66891⟩, ⟨8177, 8363⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4251203699, 4294967296⟩, ⟨(-43763792), 133780⟩, ⟨(-10941095), (-10740229)⟩, ⟨(-147), 66891⟩, ⟨8177, 8363⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 353989846⟩, ⟨173748631, 176999649⟩, ⟨(-1623151), 2363⟩, ⟨(-270532), (-264615)⟩, ⟨(-3), 1478⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4339181414⟩, ⟨(-136550), 44669475⟩, ⟨10738837, 11627368⟩, ⟨(-68995), 234813⟩, ⟨17004, 24085⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 357633960⟩, ⟨173737376, 182503400⟩, ⟨(-1645489), 2801584⟩, ⟨138542, 233966⟩, ⟨(-10057), 13173⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-338035402), 0⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3956931894, 4294967296⟩, ⟨(-169017701), (-169017700)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 29779517⟩, ⟨0, 30393440⟩, ⟨6753883, 8221571⟩, ⟨(-139842), 277056⟩, ⟨8458, 23906⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4324746813⟩, ⟨0, 30393440⟩, ⟨6753883, 8221571⟩, ⟨(-139842), 277056⟩, ⟨8458, 23906⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4309831334⟩, ⟨0, 15196720⟩, ⟨3338502, 4110786⟩, ⟨(-84467), 138528⟩, ⟨1764, 10955⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3956931894, 4309831334⟩, ⟨(-169602639), (-153820980)⟩, ⟨2477716, 4110786⟩, ⟨(-246237), 7150⟩, ⟨(-3827), 14279⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2400084376⟩, ⟨1200042180, 1200042188⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1341198807⟩, ⟨0, 1341198808⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1341198807⟩, ⟨0, 1341198808⟩, ⟨335299697, 335299702⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1341198807), 0⟩, ⟨(-1341198808), 0⟩, ⟨(-335299702), (-335299697)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-670599404), 0⟩, ⟨(-670599404), 0⟩, ⟨(-167649851), (-167649848)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3674098695, 4294967296⟩, ⟨(-670599404), 0⟩, ⟨(-167649851), (-91062464)⟩, ⟨0, 26176193⟩, ⟨755504, 3272025⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3384928756, 4309831334⟩, ⟨(-842522856), (-131585044)⟩, ⟨(-166110511), (-53303512)⟩, ⟨2373252, 32894208⟩, ⟨(-503027), 3283543⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298620155, 4298620157⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2224
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4309831334⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2225
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (309270655 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(15741 / 200000), prawitzNormalCorrection
