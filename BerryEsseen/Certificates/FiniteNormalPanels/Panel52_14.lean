...
namespace FiniteNormalPanel52_14
...
def j2 : Jet := ⟨⟨564042707, 564042711⟩, ⟨564042707, 564042711⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨74073713, 74073715⟩, ⟨148147426, 148147430⟩, ⟨74073713, 74073715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1633), (-1632)⟩, ⟨(-3266), (-3264)⟩, ⟨(-1632), (-1629)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111423, 5111425⟩, ⟨(-3266), (-3264)⟩, ⟨(-1632), (-1629)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨88154, 88155⟩, ⟨176252, 176254⟩, ⟨88012, 88015⟩, ⟨(-114), (-111)⟩, ⟨(-29), (-26)⟩⟩
...
def j16 : Jet := ⟨⟨(-143077423), (-143077421)⟩, ⟨176252, 176254⟩, ⟨88012, 88015⟩, ⟨(-114), (-111)⟩, ⟨(-29), (-26)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2467604), (-2467603)⟩, ⟨(-4932168), (-4932166)⟩, ⟨(-2460008), (-2460005)⟩, ⟨6072, 6075⟩, ⟨1512, 1515⟩⟩
...
def j19 : Jet := ⟨⟨1429188161, 1429188163⟩, ⟨(-4932168), (-4932166)⟩, ⟨(-2460008), (-2460005)⟩, ⟨6072, 6075⟩, ⟨1512, 1515⟩⟩
...
def j25 : Jet := ⟨⟨204, 205⟩, ⟨407, 409⟩, ⟨202, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851973), (-851971)⟩, ⟨407, 409⟩, ⟨202, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-14694), (-14693)⟩, ⟨(-29381), (-29379)⟩, ⟨(-14677), (-14674)⟩, ⟨12, 16⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35776700, 35776702⟩, ⟨(-29381), (-29379)⟩, ⟨(-14677), (-14674)⟩, ⟨12, 16⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨617027, 617028⟩, ⟨1233548, 1233550⟩, ⟨615759, 615762⟩, ⟨(-1014), (-1011)⟩, ⟨(-254), (-251)⟩⟩
...
def j33 : Jet := ⟨⟨(-715210856), (-715210854)⟩, ⟨1233548, 1233550⟩, ⟨615759, 615762⟩, ⟨(-1014), (-1011)⟩, ⟨(-254), (-251)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-12334978), (-12334977)⟩, ⟨(-24648682), (-24648679)⟩, ⟨(-12281810), (-12281807)⟩, ⟨42495, 42498⟩, ⟨10579, 10582⟩⟩
...
def j36 : Jet := ⟨⟨4282632318, 4282632319⟩, ⟨(-24648682), (-24648679)⟩, ⟨(-12281810), (-12281807)⟩, ⟨42495, 42498⟩, ⟨10579, 10582⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨187690174, 187690176⟩, ⟨187042449, 187042453⟩, ⟨(-970790), (-970786)⟩, ⟨(-322268), (-322265)⟩, ⟨995, 997⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4307337800, 4307337802⟩, ⟨24790870, 24790875⟩, ⟨12495341, 12495347⟩, ⟨100267, 100274⟩, ⟨25520, 25528⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨188230765, 188230768⟩, ⟨188664535, 188664541⟩, ⟨652081, 652089⟩, ⟨219742, 219749⟩, ⟨1792, 1799⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-179540371), (-179540370)⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4115426925, 4115426926⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨8249380, 8249382⟩, ⟨16536782, 16536784⟩, ⟨8344601, 8344604⟩, ⟨76546, 76552⟩, ⟨19559, 19564⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4303216676, 4303216678⟩, ⟨16536782, 16536784⟩, ⟨8344601, 8344604⟩, ⟨76546, 76552⟩, ⟨19559, 19564⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299090007, 4299090009⟩, ⟨8260461, 8260463⟩, ⟨4160362, 4160365⟩, ⟨30241, 30246⟩, ⟨7698, 7703⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4119377296, 4119377300⟩, ⟨(-171797558), (-171797554)⟩, ⟨3641139, 3641145⟩, ⟨(-144938), (-144931)⟩, ⟨6111, 6117⟩⟩
...
def j47 : Jet := ⟨⟨1336520382, 1336520391⟩, ⟨1336520382, 1336520391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨415902289, 415902296⟩, ⟨831804578, 831804592⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨415902289, 415902296⟩, ⟨831804578, 831804592⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-415902296), (-415902289)⟩, ⟨(-831804592), (-831804578)⟩, ⟨(-415902296), (-415902289)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-207951148), (-207951144)⟩, ⟨(-415902296), (-415902289)⟩, ⟨(-207951148), (-207951144)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4091970100, 4091970105⟩, ⟨(-396245104), (-396245096)⟩, ⟨(-178937396), (-178937389)⟩, ⟨18565892, 18565895⟩, ⟨3882385, 3882386⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3924679180, 3924679189⟩, ⟨(-543723246), (-543723232)⟩, ⟨(-152303205), (-152303188)⟩, ⟨24490302, 24490316⟩, ⟨2848526, 2848537⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 359080741⟩, ⟨179540370, 179540371⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1128085419⟩, ⟨564042707, 564042711⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 296294856⟩, ⟨0, 296294856⟩, ⟨74073713, 74073715⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-6533), 0⟩, ⟨(-6533), 6⟩, ⟨(-1634), (-1623)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106523, 5113057⟩, ⟨(-6533), 6⟩, ⟨(-1634), (-1623)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 352733⟩, ⟨(-451), 352734⟩, ⟨87506, 88185⟩, ⟨(-226), 2⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142812843)⟩, ⟨(-451), 352734⟩, ⟨87506, 88185⟩, ⟨(-226), 2⟩, ⟨(-29), (-25)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9876496), 0⟩, ⟨(-9876528), 24334⟩, ⟨(-2469156), (-2432622)⟩, ⟨(-24), 12169⟩, ⟨1490, 1522⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1421779269, 1431655766⟩, ⟨(-9876528), 24334⟩, ⟨(-2469156), (-2432622)⟩, ⟨(-24), 12169⟩, ⟨1490, 1522⟩⟩
...
def j72 : Jet := ⟨⟨0, 817⟩, ⟨(-1), 817⟩, ⟨201, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851359)⟩, ⟨(-1), 817⟩, ⟨201, 205⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-58789), 0⟩, ⟨(-58790), 57⟩, ⟨(-14699), (-14611)⟩, ⟨(-2), 30⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35732605, 35791395⟩, ⟨(-58790), 57⟩, ⟨(-14699), (-14611)⟩, ⟨(-2), 30⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2469124⟩, ⟨(-4056), 2469128⟩, ⟨611196, 617285⟩, ⟨(-2030), 4⟩, ⟨(-255), (-247)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713358758)⟩, ⟨(-4056), 2469128⟩, ⟨611196, 617285⟩, ⟨(-2030), 4⟩, ⟨(-255), (-247)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-49382477), 0⟩, ⟨(-49382757), 170337⟩, ⟨(-12345900), (-12090112)⟩, ⟨(-211), 85171⟩, ⟨10382, 10648⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4245584819, 4294967296⟩, ⟨(-49382757), 170337⟩, ⟨(-12345900), (-12090112)⟩, ⟨(-211), 85171⟩, ⟨10382, 10648⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 376028474⟩, ⟨184123091, 188020630⟩, ⟨(-1945581), 3196⟩, ⟨(-324273), (-316270)⟩, ⟨(-4), 1999⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4344924165⟩, ⟨(-174324), 50538230⟩, ⟨12088107, 13222613⟩, ⟨(-88204), 300980⟩, ⟨21237, 31454⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 380402246⟩, ⟨184107828, 194632262⟩, ⟨(-1975844), 3373298⟩, ⟨159549, 289007⟩, ⟨(-13673), 17977⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-359080741), 0⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3935886555, 4294967296⟩, ⟨(-179540371), (-179540370)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 33691961⟩, ⟨0, 34476888⟩, ⟨7541955, 9417567⟩, ⟨(-179078), 356928⟩, ⟨9702, 32030⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4328659257⟩, ⟨0, 34476888⟩, ⟨7541955, 9417567⟩, ⟨(-179078), 356928⟩, ⟨9702, 32030⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4311780369⟩, ⟨0, 17238444⟩, ⟨3721813, 4708784⟩, ⟨(-108439), 178464⟩, ⟨1546, 14839⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3935886555, 4311780369⟩, ⟨(-180243200), (-162301926)⟩, ⟨2690039, 4708784⟩, ⟨(-305278), 22883⟩, ⟨(-6045), 19373⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2673040774⟩, ⟨1336520382, 1336520391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1663609171⟩, ⟨0, 1663609176⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1663609171⟩, ⟨0, 1663609176⟩, ⟨415902289, 415902296⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1663609171), 0⟩, ⟨(-1663609176), 0⟩, ⟨(-415902296), (-415902289)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-831804586), 0⟩, ⟨(-831804588), 0⟩, ⟨(-207951148), (-207951144)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3538752782, 4294967296⟩, ⟨(-831804588), 0⟩, ⟨(-207951148), (-90789574)⟩, ⟨0, 40273816⟩, ⟨247944, 5034227⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3242895355, 4311780369⟩, ⟨(-1015303970), (-133725440)⟩, ⟨(-206548790), (-43582698)⟩, ⟨2213607, 49181263⟩, ⟨(-1701388), 5075568⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299090007, 4299090009⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1030
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4311780369⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1031
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (323963237 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(16721 / 200000), prawitzNormalCorrection
