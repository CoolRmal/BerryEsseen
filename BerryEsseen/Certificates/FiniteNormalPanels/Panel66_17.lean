...
namespace FiniteNormalPanel66_17
...
def j2 : Jet := ⟨⟨1624780999, 1624781003⟩, ⟨541593665, 541593669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨614652711, 614652715⟩, ⟨409768472, 409768478⟩, ⟨68294745, 68294747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨153, 154⟩, ⟨102, 103⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94534), (-94532)⟩, ⟨102, 103⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-13529), (-13528)⟩, ⟨(-9006), (-9003)⟩, ⟨(-1493), (-1490)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5099527, 5099529⟩, ⟨(-9006), (-9003)⟩, ⟨(-1493), (-1490)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨729793, 729794⟩, ⟨485239, 485242⟩, ⟨80014, 80018⟩, ⟨(-287), (-284)⟩, ⟨(-24), (-21)⟩⟩
...
def j16 : Jet := ⟨⟨(-142435784), (-142435782)⟩, ⟨485239, 485242⟩, ⟨80014, 80018⟩, ⟨(-287), (-284)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-20383984), (-20383982)⟩, ⟨(-13519881), (-13519878)⟩, ⟨(-2207143), (-2207138)⟩, ⟨15306, 15311⟩, ⟨1240, 1243⟩⟩
...
def j19 : Jet := ⟨⟨1411271781, 1411271784⟩, ⟨(-13519881), (-13519878)⟩, ⟨(-2207143), (-2207138)⟩, ⟨15306, 15311⟩, ⟨1240, 1243⟩⟩
...
def j25 : Jet := ⟨⟨1691, 1692⟩, ⟨1125, 1127⟩, ⟨184, 188⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850486), (-850484)⟩, ⟨1125, 1127⟩, ⟨184, 188⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-121714), (-121712)⟩, ⟨(-80983), (-80979)⟩, ⟨(-13391), (-13388)⟩, ⟨33, 36⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35669680, 35669683⟩, ⟨(-80983), (-80979)⟩, ⟨(-13391), (-13388)⟩, ⟨33, 36⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5104687, 5104688⟩, ⟨3391534, 3391538⟩, ⟨557543, 557548⟩, ⟨(-2562), (-2558)⟩, ⟨(-210), (-207)⟩⟩
...
def j33 : Jet := ⟨⟨(-710723196), (-710723194)⟩, ⟨3391534, 3391538⟩, ⟨557543, 557548⟩, ⟨(-2562), (-2558)⟩, ⟨(-210), (-207)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-101711588), (-101711586)⟩, ⟨(-67322364), (-67322361)⟩, ⟨(-10897925), (-10897920)⟩, ⟨106755, 106758⟩, ⟨8589, 8593⟩⟩
...
def j36 : Jet := ⟨⟨4193255708, 4193255710⟩, ⟨(-67322364), (-67322361)⟩, ⟨(-10897925), (-10897920)⟩, ⟨106755, 106758⟩, ⟨8589, 8593⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨533882429, 533882432⟩, ⟨172846254, 172846259⟩, ⟨(-2539812), (-2539808)⟩, ⟨(-272530), (-272526)⟩, ⟨2399, 2402⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4399145997, 4399146000⟩, ⟨70627911, 70627916⟩, ⟨12566934, 12566945⟩, ⟨273316, 273323⟩, ⟨26233, 26243⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨546832277, 546832282⟩, ⟨185818156, 185818163⟩, ⟨1803046, 1803055⟩, ⟨218809, 218818⟩, ⟨4802, 4812⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-517183856), (-517183855)⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3777783440, 3777783441⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨69622308, 69622311⟩, ⟨47316478, 47316482⟩, ⟨8498390, 8498396⟩, ⟨211730, 211736⟩, ⟨20910, 20917⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4364589604, 4364589607⟩, ⟨47316478, 47316482⟩, ⟨8498390, 8498396⟩, ⟨211730, 211736⟩, ⟨20910, 20917⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4329638507, 4329638510⟩, ⟨23468786, 23468789⟩, ⟨4151561, 4151565⟩, ⟨82512, 82517⟩, ⟨7933, 7939⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3808279673, 3808279678⟩, ⟨(-153143517), (-153143511)⟩, ⟨2709637, 2709643⟩, ⟨(-94063), (-94057)⟩, ⟨3664, 3673⟩⟩
...
def j47 : Jet := ⟨⟨4084973408, 4084973417⟩, ⟨1361657800, 1361657809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3885246753, 3885246771⟩, ⟨2590164496, 2590164522⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3885246753, 3885246771⟩, ⟨2590164496, 2590164522⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3885246771), (-3885246753)⟩, ⟨(-2590164522), (-2590164496)⟩, ⟨(-431694088), (-431694082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1942623386), (-1942623376)⟩, ⟨(-1295082261), (-1295082248)⟩, ⟨(-215847044), (-215847041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2732294374, 2732294386⟩, ⟨(-823881941), (-823881928)⟩, ⟨(-13099108), (-13099101)⟩, ⟨28919844, 28919847⟩, ⟨(-1850933), (-1850931)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2422682271, 2422682286⟩, ⟨(-827947172), (-827947154)⟩, ⟨19485741, 19485757⟩, ⟨25530218, 25530230⟩, ⟨(-2660268), (-2660254)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨344789237, 689578475⟩, ⟨172394618, 172394619⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1083187333, 2166374672⟩, ⟨541593665, 541593669⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨273178983, 1092715939⟩, ⟨273178982, 546357972⟩, ⟨68294745, 68294747⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨68, 274⟩, ⟨68, 137⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94619), (-94412)⟩, ⟨68, 137⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-24073), (-6005)⟩, ⟨(-12033), (-5970)⟩, ⟨(-1500), (-1478)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5088983, 5107052⟩, ⟨(-12033), (-5970)⟩, ⟨(-1500), (-1478)⟩, ⟨2, 6⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨323681, 1299325⟩, ⟨320619, 649284⟩, ⟨79007, 80735⟩, ⟨(-383), (-186)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142841896), (-141866251)⟩, ⟨320619, 649284⟩, ⟨79007, 80735⟩, ⟨(-383), (-186)⟩, ⟨(-24), (-21)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-36341515), (-9023323)⟩, ⟨(-18150366), (-8858133)⟩, ⟨(-2245928), (-2152694)⟩, ⟨10025, 20585⟩, ⟨1200, 1272⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1395314250, 1422632443⟩, ⟨(-18150366), (-8858133)⟩, ⟨(-2245928), (-2152694)⟩, ⟨10025, 20585⟩, ⟨1200, 1272⟩⟩
...
def j72 : Jet := ⟨⟨750, 3010⟩, ⟨746, 1505⟩, ⟨184, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851427), (-849166)⟩, ⟨746, 1505⟩, ⟨184, 189⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-216619), (-54010)⟩, ⟨(-108263), (-53627)⟩, ⟨(-13481), (-13261)⟩, ⟨21, 49⟩, ⟨0, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35574775, 35737385⟩, ⟨(-108263), (-53627)⟩, ⟨(-13481), (-13261)⟩, ⟨21, 49⟩, ⟨0, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2262713, 9092226⟩, ⟨2235168, 4542703⟩, ⟨548475, 564012⟩, ⟨(-3436), (-1682)⟩, ⟨(-214), (-201)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713565170), (-706735656)⟩, ⟨2235168, 4542703⟩, ⟨548475, 564012⟩, ⟨(-3436), (-1682)⟩, ⟨(-214), (-201)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-181543649), (-44951524)⟩, ⟨(-90629659), (-43795779)⟩, ⟨(-11169428), (-10516513)⟩, ⟨69551, 143877⟩, ⟨8228, 8851⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4113423647, 4250015772⟩, ⟨(-90629659), (-43795779)⟩, ⟨(-11169428), (-10516513)⟩, ⟨69551, 143877⟩, ⟨8228, 8851⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨351897143, 717573542⟩, ⟨166793555, 177159372⟩, ⟨(-3421597), (-1659914)⟩, ⟨(-280683), (-261069)⟩, ⟨1566, 3238⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4340394262, 4484523273⟩, ⟨44727115, 98805972⟩, ⟨11201056, 14354057⟩, ⟨74284, 511166⟩, ⟨15796, 40802⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨355619085, 749243249⟩, ⟨172222296, 201486023⟩, ⟨(-917918), 4796269⟩, ⟨69289, 396366⟩, ⟨(-12134), 24237⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-689578475), (-344789237)⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3605388821, 3950178059⟩, ⟨(-172394619), (-172394618)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨29444911, 130703079⟩, ⟨28519674, 70297180⟩, ⟨6585621, 11125525⟩, ⟨(-74650), 588298⟩, ⟨296, 51005⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4324412207, 4425670375⟩, ⟨28519674, 70297180⟩, ⟨6585621, 11125525⟩, ⟨(-74650), 588298⟩, ⟨296, 51005⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4309664604, 4359829071⟩, ⟨14047691, 35028723⟩, ⟨3103105, 5520898⟩, ⟨(-82073), 283032⟩, ⟨(-5691), 24967⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3617726402, 4009832893⟩, ⟨(-163205827), (-140767844)⟩, ⟨1198875, 4513839⟩, ⟨(-297087), 135757⟩, ⟨(-16596), 26258⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2723315607, 5446631226⟩, ⟨1361657800, 1361657809⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1726776337, 6907105379⟩, ⟨1726776332, 3453552696⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1726776337, 6907105379⟩, ⟨1726776332, 3453552696⟩, ⟨431694082, 431694088⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6907105379), (-1726776337)⟩, ⟨(-3453552696), (-1726776332)⟩, ⟨(-431694088), (-431694082)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3453552690), (-863388168)⟩, ⟨(-1726776348), (-863388166)⟩, ⟨(-215847044), (-215847041)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1921970654, 3512825567⟩, ⟨(-1412319044), (-386360734)⟩, ⟨(-137706142), 187318745⟩, ⟨(-12159033), 65772911⟩, ⟨(-11317869), 4682391⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1618909644, 3279616010⟩, ⟨(-1452042945), (-388431151)⟩, ⟨(-115364616), 232242025⟩, ⟨(-20197081), 66642307⟩, ⟨(-13268765), 5149606⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4329638507, 4329638510⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1316
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4309664604, 4359829071⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1317
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (48772745 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((32111 / 400000) : ℝ)..(32111 / 200000), prawitzNormalCorrection
