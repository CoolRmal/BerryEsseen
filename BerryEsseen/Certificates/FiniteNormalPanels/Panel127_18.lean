...
namespace FiniteNormalPanel127_18
...
def j2 : Jet := ⟨⟨1479713978, 1479713982⟩, ⟨493237991, 493237995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨509795140, 509795144⟩, ⟨339863424, 339863430⟩, ⟨56643904, 56643906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨127, 128⟩, ⟨85, 86⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94560), (-94558)⟩, ⟨85, 86⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-11224), (-11223)⟩, ⟨(-7473), (-7471)⟩, ⟨(-1241), (-1238)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5101832, 5101834⟩, ⟨(-7473), (-7471)⟩, ⟨(-1241), (-1238)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨605566, 605567⟩, ⟨402823, 402826⟩, ⟨66545, 66549⟩, ⟨(-198), (-194)⟩, ⟨(-17), (-14)⟩⟩
...
def j16 : Jet := ⟨⟨(-142560011), (-142560009)⟩, ⟨402823, 402826⟩, ⟨66545, 66549⟩, ⟨(-198), (-194)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16921294), (-16921292)⟩, ⟨(-11233050), (-11233047)⟩, ⟨(-1840371), (-1840367)⟩, ⟨10553, 10557⟩, ⟨858, 862⟩⟩
...
def j19 : Jet := ⟨⟨1414734471, 1414734474⟩, ⟨(-11233050), (-11233047)⟩, ⟨(-1840371), (-1840367)⟩, ⟨10553, 10557⟩, ⟨858, 862⟩⟩
...
def j25 : Jet := ⟨⟨1403, 1404⟩, ⟨933, 936⟩, ⟨153, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850774), (-850772)⟩, ⟨933, 936⟩, ⟨153, 156⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-100984), (-100983)⟩, ⟨(-67213), (-67210)⟩, ⟨(-11130), (-11126)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35690410, 35690412⟩, ⟨(-67213), (-67210)⟩, ⟨(-11130), (-11126)⟩, ⟨23, 26⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4236306, 4236307⟩, ⟨2816226, 2816228⟩, ⟨464059, 464063⟩, ⟨(-1766), (-1762)⟩, ⟨(-146), (-142)⟩⟩
...
def j33 : Jet := ⟨⟨(-711591577), (-711591575)⟩, ⟨2816226, 2816228⟩, ⟨464059, 464063⟩, ⟨(-1766), (-1762)⟩, ⟨(-146), (-142)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-84463026), (-84463024)⟩, ⟨(-55974410), (-55974407)⟩, ⟨(-9106851), (-9106847)⟩, ⟨73652, 73655⟩, ⟨5962, 5966⟩⟩
...
def j36 : Jet := ⟨⟨4210504270, 4210504272⟩, ⟨(-55974410), (-55974407)⟩, ⟨(-9106851), (-9106847)⟩, ⟨73652, 73655⟩, ⟨5962, 5966⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨487408221, 487408225⟩, ⟨158599364, 158599369⟩, ⟨(-1924064), (-1924061)⟩, ⟨(-207715), (-207711)⟩, ⟨1506, 1510⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4381124654, 4381124657⟩, ⟨58242632, 58242637⟩, ⟨10250156, 10250163⟩, ⟨185595, 185603⟩, ⟨17408, 17417⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨497185665, 497185670⟩, ⟨168390459, 168390468⟩, ⟨1351276, 1351283⟩, ⟨161592, 161601⟩, ⟨2955, 2965⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-471007589), (-471007588)⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3823959707, 3823959708⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨57554241, 57554243⟩, ⟨38985778, 38985782⟩, ⟨6914839, 6914845⟩, ⟨143366, 143374⟩, ⟨13779, 13786⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4352521537, 4352521539⟩, ⟨38985778, 38985782⟩, ⟨6914839, 6914845⟩, ⟨143366, 143374⟩, ⟨13779, 13786⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4323648650, 4323648652⟩, ⟨19363580, 19363583⟩, ⟨3391123, 3391128⟩, ⟨56019, 56025⟩, ⟨5262, 5268⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3849495720, 3849495724⟩, ⟨(-140810905), (-140810899)⟩, ⟨2311399, 2311405⟩, ⟨(-74088), (-74080)⟩, ⟨2636, 2644⟩⟩
...
def j47 : Jet := ⟨⟨3852207262, 3852207272⟩, ⟨1284069084, 1284069094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3455090520, 3455090539⟩, ⟨2303393674, 2303393700⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3455090520, 3455090539⟩, ⟨2303393674, 2303393700⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3455090539), (-3455090520)⟩, ⟨(-2303393700), (-2303393674)⟩, ⟨(-383898951), (-383898944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1727545270), (-1727545260)⟩, ⟨(-1151696850), (-1151696837)⟩, ⟨(-191949476), (-191949472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2872602642, 2872602654⟩, ⟨(-770289318), (-770289305)⟩, ⟨(-25104894), (-25104886)⟩, ⟨25194329, 25194332⟩, ⟨(-1127977), (-1127976)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2574657922, 2574657936⟩, ⟨(-784573895), (-784573876)⟩, ⟨4298908, 4298924⟩, ⟨22940156, 22940170⟩, ⟨(-1835445), (-1835433)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨314005059, 628010119⟩, ⟨157002529, 157002530⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨986475986, 1972951977⟩, ⟨493237991, 493237995⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨226575618, 906302479⟩, ⟨226575616, 453151240⟩, ⟨56643904, 56643906⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨56, 228⟩, ⟨56, 114⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94631), (-94458)⟩, ⟨56, 114⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-19969), (-4983)⟩, ⟨(-9983), (-4958)⟩, ⟨(-1247), (-1228)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5093087, 5108074⟩, ⟨(-9983), (-4958)⟩, ⟨(-1247), (-1228)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨268679, 1077881⟩, ⟨266572, 538680⟩, ⟨65851, 67043⟩, ⟨(-264), (-128)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142896898), (-142087695)⟩, ⟨266572, 538680⟩, ⟨65851, 67043⟩, ⟨(-264), (-128)⟩, ⟨(-17), (-14)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-30153388), (-7495658)⟩, ⟨(-15062632), (-7381988)⟩, ⟨(-1867052), (-1802931)⟩, ⟨6932, 14173⟩, ⟨836, 879⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1401502377, 1424160108⟩, ⟨(-15062632), (-7381988)⟩, ⟨(-1867052), (-1802931)⟩, ⟨6932, 14173⟩, ⟨836, 879⟩⟩
...
def j72 : Jet := ⟨⟨623, 2497⟩, ⟨620, 1249⟩, ⟨152, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851554), (-849679)⟩, ⟨620, 1249⟩, ⟨152, 157⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-179691), (-44823)⟩, ⟨(-89814), (-44559)⟩, ⟨(-11191), (-11039)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35611703, 35746572⟩, ⟨(-89814), (-44559)⟩, ⟨(-11191), (-11039)⟩, ⟨15, 34⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1878650, 7543063⟩, ⟨1859697, 3769182⟩, ⟨457823, 468510⟩, ⟨(-2366), (-1161)⟩, ⟨(-148), (-140)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713949233), (-708284819)⟩, ⟨1859697, 3769182⟩, ⟨457823, 468510⟩, ⟨(-2366), (-1161)⟩, ⟨(-148), (-140)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-150653990), (-37364678)⟩, ⟨(-75228891), (-36569323)⟩, ⟨(-9293619), (-8844629)⟩, ⟨48177, 99081⟩, ⟨5755, 6111⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4144313306, 4257602618⟩, ⟨(-75228891), (-36569323)⟩, ⟨(-9293619), (-8844629)⟩, ⟨48177, 99081⟩, ⟨5755, 6111⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨321899642, 654207427⟩, ⟨154030593, 161856349⟩, ⟨(-2587463), (-1261854)⟩, ⟨(-212822), (-200539)⟩, ⟨988, 2032⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4332659886, 4451097857⟩, ⟨37214003, 80797743⟩, ⟨9320188, 11448251⟩, ⟨53774, 338637⟩, ⟨11552, 25374⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨324724630, 677989162⟩, ⟨158171481, 180047223⟩, ⟨(-648386), 3515738⟩, ⟨69045, 269780⟩, ⟨(-7112), 14258⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-628010119), (-314005059)⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3666957177, 3980962237⟩, ⟨(-157002530), (-157002529)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨24551079, 107025100⟩, ⟨23917376, 56843306⟩, ⟨5620301, 8657638⟩, ⟨(-43922), 379938⟩, ⟨2307, 30000⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4319518375, 4401992396⟩, ⟨23917376, 56843306⟩, ⟨5620301, 8657638⟩, ⟨(-43922), 379938⟩, ⟨2307, 30000⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4307225342, 4348150570⟩, ⟨11812418, 28340768⟩, ⟨2683417, 4300303⟩, ⟨(-50194), 182070⟩, ⟨(-2196), 14453⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3677422851, 4030257282⟩, ⟨(-148861439), (-131181846)⟩, ⟨1255050, 3554106⟩, ⟨(-203723), 70667⟩, ⟨(-8692), 15232⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2568138177, 5136276365⟩, ⟨1284069084, 1284069094⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1535595789, 6142383185⟩, ⟨1535595784, 3071191600⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1535595789, 6142383185⟩, ⟨1535595784, 3071191600⟩, ⟨383898944, 383898951⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6142383185), (-1535595789)⟩, ⟨(-3071191600), (-1535595784)⟩, ⟨(-383898951), (-383898944)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3071191593), (-767797894)⟩, ⟨(-1535595800), (-767797892)⟩, ⟨(-191949476), (-191949472)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2100922268, 3591884745⟩, ⟨(-1284220054), (-375575313)⟩, ⟨(-126957295), 135682184⟩, ⟨(-4980250), 53393176⟩, ⟨(-7804401), 3282122⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1798844793, 3370507539⟩, ⟨(-1329563177), (-385742657)⟩, ⟨(-107047414), 174802471⟩, ⟨(-10609056), 54452044⟩, ⟨(-9307436), 3438382⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4323648650, 4323648652⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2564
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4307225342, 4348150570⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2565
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (188388283 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((7311 / 100000) : ℝ)..(7311 / 50000), prawitzNormalCorrection
