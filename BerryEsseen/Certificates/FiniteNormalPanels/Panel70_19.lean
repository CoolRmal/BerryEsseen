...
namespace FiniteNormalPanel70_19
...
def j2 : Jet := ⟨⟨548323318, 548323322⟩, ⟨548323318, 548323322⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨70002503, 70002505⟩, ⟨140005006, 140005010⟩, ⟨70002503, 70002505⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1544), (-1542)⟩, ⟨(-3087), (-3084)⟩, ⟨(-1543), (-1539)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111512, 5111515⟩, ⟨(-3087), (-3084)⟩, ⟨(-1543), (-1539)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨83311, 83312⟩, ⟨166571, 166573⟩, ⟨83184, 83187⟩, ⟨(-102), (-99)⟩, ⟨(-26), (-23)⟩⟩
...
def j16 : Jet := ⟨⟨(-143082266), (-143082264)⟩, ⟨166571, 166573⟩, ⟨83184, 83187⟩, ⟨(-102), (-99)⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2332059), (-2332058)⟩, ⟨(-4661404), (-4661402)⟩, ⟨(-2325275), (-2325272)⟩, ⟨5423, 5426⟩, ⟨1350, 1353⟩⟩
...
def j19 : Jet := ⟨⟨1429323706, 1429323708⟩, ⟨(-4661404), (-4661402)⟩, ⟨(-2325275), (-2325272)⟩, ⟨5423, 5426⟩, ⟨1350, 1353⟩⟩
...
def j25 : Jet := ⟨⟨192, 193⟩, ⟨384, 386⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851985), (-851983)⟩, ⟨384, 386⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-13887), (-13886)⟩, ⟨(-27767), (-27765)⟩, ⟨(-13872), (-13869)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
...
def j30 : Jet := ⟨⟨35777507, 35777509⟩, ⟨(-27767), (-27765)⟩, ⟨(-13872), (-13869)⟩, ⟨11, 14⟩, ⟨1, 4⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨583127, 583128⟩, ⟨1165802, 1165804⟩, ⟨581994, 581997⟩, ⟨(-906), (-903)⟩, ⟨(-227), (-224)⟩⟩
...
def j33 : Jet := ⟨⟨(-715244756), (-715244754)⟩, ⟨1165802, 1165804⟩, ⟨581994, 581997⟩, ⟨(-906), (-903)⟩, ⟨(-227), (-224)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-11657580), (-11657579)⟩, ⟨(-23296159), (-23296157)⟩, ⟨(-11610093), (-11610090)⟩, ⟨37957, 37960⟩, ⟨9451, 9454⟩⟩
...
def j36 : Jet := ⟨⟨4283309716, 4283309717⟩, ⟨(-23296159), (-23296157)⟩, ⟨(-11610093), (-11610090)⟩, ⟨37957, 37960⟩, ⟨9451, 9454⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨182476713, 182476716⟩, ⟨181881607, 181881612⟩, ⟨(-891966), (-891963)⟩, ⟨(-296168), (-296166)⟩, ⟨864, 866⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4306656602, 4306656604⟩, ⟨23423136, 23423140⟩, ⟨11800766, 11800772⟩, ⟨89503, 89510⟩, ⟨22757, 22765⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨182973346, 182973350⟩, ⟨183371780, 183371787⟩, ⟨598888, 598895⟩, ⟨201696, 201702⟩, ⟨1555, 1563⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-174536734), (-174536733)⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4120430562, 4120430563⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨7794994, 7794995⟩, ⟨15623936, 15623938⟩, ⟨7880005, 7880010⟩, ⟨68322, 68326⟩, ⟨17437, 17442⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4302762290, 4302762291⟩, ⟨15623936, 15623938⟩, ⟨7880005, 7880010⟩, ⟨68322, 68326⟩, ⟨17437, 17442⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298863026, 4298863027⟩, ⟨7804888, 7804890⟩, ⟨3929346, 3929350⟩, ⟨26995, 26999⟩, ⟨6864, 6869⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4124167979, 4124167982⟩, ⟨(-167207331), (-167207326)⟩, ⟨3452495, 3452501⟩, ⟨(-133782), (-133776)⟩, ⟨5487, 5493⟩⟩
...
def j47 : Jet := ⟨⟨1206780974, 1206780982⟩, ⟨1206780974, 1206780982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨339075997, 339076002⟩, ⟨678151994, 678152004⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨339075997, 339076002⟩, ⟨678151994, 678152004⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-339076002), (-339075997)⟩, ⟨(-678152004), (-678151994)⟩, ⟨(-339076002), (-339075997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-169538001), (-169537998)⟩, ⟨(-339076002), (-339075997)⟩, ⟨(-169538001), (-169537998)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4128731839, 4128731843⟩, ⟨(-325952165), (-325952159)⟩, ⟨(-150109564), (-150109559)⟩, ⟨12527926, 12527928⟩, ⟨2715423, 2715425⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3964543259, 3964543267⟩, ⟨(-473725544), (-473725531)⟩, ⟨(-128131603), (-128131590)⟩, ⟨17483015, 17483028⟩, ⟨2014472, 2014485⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 349073467⟩, ⟨174536733, 174536734⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1096646640⟩, ⟨548323318, 548323322⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 280010015⟩, ⟨0, 280010016⟩, ⟨70002503, 70002505⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 71⟩, ⟨0, 71⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94615)⟩, ⟨0, 71⟩, ⟨17, 18⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-6174), 0⟩, ⟨(-6174), 5⟩, ⟨(-1544), (-1535)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5106882, 5113057⟩, ⟨(-6174), 5⟩, ⟨(-1544), (-1535)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 333346⟩, ⟨(-403), 333347⟩, ⟨82731, 83338⟩, ⟨(-202), 2⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142832230)⟩, ⟨(-403), 333347⟩, ⟨82731, 83338⟩, ⟨(-202), 2⟩, ⟨(-26), (-23)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-9333668), 0⟩, ⟨(-9333695), 21733⟩, ⟨(-2333444), (-2300816)⟩, ⟨(-21), 10869⟩, ⟨1332, 1360⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1422322097, 1431655766⟩, ⟨(-9333695), 21733⟩, ⟨(-2333444), (-2300816)⟩, ⟨(-21), 10869⟩, ⟨1332, 1360⟩⟩
...
def j72 : Jet := ⟨⟨0, 772⟩, ⟨(-1), 772⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851404)⟩, ⟨(-1), 772⟩, ⟨190, 193⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-55558), 0⟩, ⟨(-55559), 51⟩, ⟨(-13891), (-13812)⟩, ⟨(-2), 26⟩, ⟨1, 4⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35735836, 35791395⟩, ⟨(-55559), 51⟩, ⟨(-13891), (-13812)⟩, ⟨(-2), 26⟩, ⟨1, 4⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2333417⟩, ⟨(-3623), 2333421⟩, ⟨577919, 583359⟩, ⟨(-1813), 3⟩, ⟨(-228), (-222)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713494465)⟩, ⟨(-3623), 2333421⟩, ⟨577919, 583359⟩, ⟨(-1813), 3⟩, ⟨(-228), (-222)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-46668336), 0⟩, ⟨(-46668574), 152128⟩, ⟨(-11667322), (-11438891)⟩, ⟨(-179), 76066⟩, ⟨9285, 9510⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4248298960, 4294967296⟩, ⟨(-46668574), 152128⟩, ⟨(-11667322), (-11438891)⟩, ⟨(-179), 76066⟩, ⟨9285, 9510⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 365548881⟩, ⟨179199642, 182779991⟩, ⟨(-1787406), 2775⟩, ⟨(-297909), (-290961)⟩, ⟨(-3), 1736⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4342148293⟩, ⟨(-155490), 47699532⟩, ⟨11437201, 12449058⟩, ⟨(-78621), 267940⟩, ⟨19145, 27750⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 369564502⟩, ⟨179186408, 188847617⟩, ⟨(-1813659), 3092297⟩, ⟨149471, 261701⟩, ⟨(-11840), 15541⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-349073467), 0⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3945893829, 4294967296⟩, ⟨(-174536734), (-174536733)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 31799526⟩, ⟨0, 32499142⟩, ⟨7163556, 8835698⟩, ⟨(-159492), 316972⟩, ⟨9126, 27917⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4326766822⟩, ⟨0, 32499142⟩, ⟨7163556, 8835698⟩, ⟨(-159492), 316972⟩, ⟨9126, 27917⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4310837738⟩, ⟨0, 16249571⟩, ⟨3537965, 4417849⟩, ⟨(-96461), 158486⟩, ⟨1684, 12867⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3945893829, 4310837738⟩, ⟨(-175181670), (-158287162)⟩, ⟨2590074, 4417849⟩, ⟨(-275992), 14712⟩, ⟨(-4894), 16787⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2413561957⟩, ⟨1206780974, 1206780982⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1356304000⟩, ⟨0, 1356304004⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1356304000⟩, ⟨0, 1356304004⟩, ⟨339075997, 339076002⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1356304000), 0⟩, ⟨(-1356304004), 0⟩, ⟨(-339076002), (-339075997)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-678152000), 0⟩, ⟨(-678152002), 0⟩, ⟨(-169538001), (-169537998)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3667643558, 4294967296⟩, ⟨(-678152002), 0⟩, ⟨(-169538001), (-91236987)⟩, ⟨0, 26769130⟩, ⟨744052, 3346142⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3369555827, 4310837738⟩, ⟨(-855839529), (-135167709)⟩, ⟨(-167952699), (-51743617)⟩, ⟨2388910, 33797817⟩, ⟨(-589878), 3363852⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298863026, 4298863027⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1406
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4310837738⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1407
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (79700409 / 1073741824)
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(3251 / 40000), prawitzNormalCorrection
