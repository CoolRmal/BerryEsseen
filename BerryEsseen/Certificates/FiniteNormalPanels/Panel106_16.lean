...
namespace FiniteNormalPanel106_16
...
def j2 : Jet := ⟨⟨1463218738, 1463218742⟩, ⟨487739579, 487739583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨498492521, 498492524⟩, ⟨332328346, 332328352⟩, ⟨55388057, 55388059⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨124, 125⟩, ⟨83, 84⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94563), (-94561)⟩, ⟨83, 84⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-10976), (-10975)⟩, ⟨(-7308), (-7306)⟩, ⟨(-1213), (-1210)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5102080, 5102082⟩, ⟨(-7308), (-7306)⟩, ⟨(-1213), (-1210)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨592169, 592170⟩, ⟨393930, 393933⟩, ⟨65089, 65092⟩, ⟨(-189), (-186)⟩, ⟨(-16), (-13)⟩⟩
...
def j16 : Jet := ⟨⟨(-142573408), (-142573406)⟩, ⟨393930, 393933⟩, ⟨65089, 65092⟩, ⟨(-189), (-186)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-16547688), (-16547687)⟩, ⟨(-10986071), (-10986069)⟩, ⟨(-1800599), (-1800594)⟩, ⟨10094, 10097⟩, ⟨822, 825⟩⟩
...
def j19 : Jet := ⟨⟨1415108077, 1415108079⟩, ⟨(-10986071), (-10986069)⟩, ⟨(-1800599), (-1800594)⟩, ⟨10094, 10097⟩, ⟨822, 825⟩⟩
...
def j25 : Jet := ⟨⟨1372, 1373⟩, ⟨912, 915⟩, ⟨150, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850805), (-850803)⟩, ⟨912, 915⟩, ⟨150, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-98749), (-98747)⟩, ⟨(-65728), (-65724)⟩, ⟨(-10886), (-10882)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35692645, 35692648⟩, ⟨(-65728), (-65724)⟩, ⟨(-10886), (-10882)⟩, ⟨21, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨4142643, 4142644⟩, ⟨2754133, 2754135⟩, ⟨453943, 453946⟩, ⟨(-1689), (-1686)⟩, ⟨(-141), (-137)⟩⟩
...
def j33 : Jet := ⟨⟨(-711685240), (-711685238)⟩, ⟨2754133, 2754135⟩, ⟨453943, 453946⟩, ⟨(-1689), (-1686)⟩, ⟨(-141), (-137)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-82601275), (-82601273)⟩, ⟨(-54747861), (-54747858)⟩, ⟨(-8912130), (-8912127)⟩, ⟨70444, 70448⟩, ⟨5706, 5710⟩⟩
...
def j36 : Jet := ⟨⟨4212366021, 4212366023⟩, ⟨(-54747861), (-54747858)⟩, ⟨(-8912130), (-8912127)⟩, ⟨70444, 70448⟩, ⟨5706, 5710⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨482102077, 482102080⟩, ⟨156957933, 156957937⟩, ⟨(-1861019), (-1861015)⟩, ⟨(-201040), (-201036)⟩, ⟨1426, 1429⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4379188316, 4379188319⟩, ⟨56916036, 56916041⟩, ⟨10004806, 10004813⟩, ⟨177210, 177218⟩, ⟨16580, 16590⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨491555729, 491555733⟩, ⟨166424476, 166424483⟩, ⟨1305481, 1305489⟩, ⟨155867, 155877⟩, ⟨2789, 2799⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-465756991), (-465756990)⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3829210305, 3829210306⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨56258178, 56258179⟩, ⟨38094308, 38094312⟩, ⟨6747557, 6747562⟩, ⟨136846, 136856⟩, ⟨13112, 13121⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4351225474, 4351225475⟩, ⟨38094308, 38094312⟩, ⟨6747557, 6747562⟩, ⟨136846, 136856⟩, ⟨13112, 13121⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4323004870, 4323004871⟩, ⟨18923620, 18923623⟩, ⟨3310478, 3310482⟩, ⟨53487, 53494⟩, ⟨5011, 5018⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3854207414, 3854207417⟩, ⟨(-139394325), (-139394319)⟩, ⟨2267439, 2267445⟩, ⟨(-71980), (-71972)⟩, ⟨2533, 2541⟩⟩
...
def j47 : Jet := ⟨⟨4045491779, 4045491789⟩, ⟨1348497259, 1348497269⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨3810507183, 3810507203⟩, ⟨2540338120, 2540338148⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨3810507183, 3810507203⟩, ⟨2540338120, 2540338148⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-3810507203), (-3810507183)⟩, ⟨(-2540338148), (-2540338120)⟩, ⟨(-423389693), (-423389686)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1905253602), (-1905253591)⟩, ⟨(-1270169074), (-1270169060)⟩, ⟨(-211694847), (-211694843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2756171332, 2756171342⟩, ⟨(-815094356), (-815094343)⟩, ⟨(-15323392), (-15323384)⟩, ⟨28294031, 28294034⟩, ⟨(-1714242), (-1714240)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2473326395, 2473326407⟩, ⟨(-820899699), (-820899681)⟩, ⟨14158300, 14158315⟩, ⟨25411247, 25411261⟩, ⟨(-2449421), (-2449407)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨310504660, 621009322⟩, ⟨155252330, 155252331⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨975479158, 1950958324⟩, ⟨487739579, 487739583⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨221552231, 886208933⟩, ⟨221552230, 443104470⟩, ⟨55388057, 55388059⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨55, 223⟩, ⟨55, 112⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94632), (-94463)⟩, ⟨55, 112⟩, ⟨13, 14⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-19527), (-4872)⟩, ⟨(-9762), (-4848)⟩, ⟨(-1219), (-1203)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5093529, 5108185⟩, ⟨(-9762), (-4848)⟩, ⟨(-1219), (-1203)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨262745, 1054006⟩, ⟨260730, 526753⟩, ⟨64426, 65564⟩, ⟨(-252), (-123)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142902832), (-142111570)⟩, ⟨260730, 526753⟩, ⟨64426, 65564⟩, ⟨(-252), (-123)⟩, ⟨(-16), (-13)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-29486084), (-7330704)⟩, ⟨(-14729594), (-7222015)⟩, ⟨(-1826109), (-1764802)⟩, ⟨6633, 13553⟩, ⟨800, 840⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1402169681, 1424325062⟩, ⟨(-14729594), (-7222015)⟩, ⟨(-1826109), (-1764802)⟩, ⟨6633, 13553⟩, ⟨800, 840⟩⟩
...
def j72 : Jet := ⟨⟨609, 2442⟩, ⟨606, 1221⟩, ⟨149, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851568), (-849734)⟩, ⟨606, 1221⟩, ⟨149, 153⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-175710), (-43832)⟩, ⟨(-87824), (-43580)⟩, ⟨(-10944), (-10800)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35615684, 35747563⟩, ⟨(-87824), (-43580)⟩, ⟨(-10944), (-10800)⟩, ⟨13, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1837204, 7376031⟩, ⟨1819082, 3685768⟩, ⟨447981, 458197⟩, ⟨(-2263), (-1112)⟩, ⟨(-143), (-134)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713990679), (-708451851)⟩, ⟨1819082, 3685768⟩, ⟨447981, 458197⟩, ⟨(-2263), (-1112)⟩, ⟨(-143), (-134)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-147322407), (-36544885)⟩, ⟨(-73567369), (-35784376)⟩, ⟨(-9090708), (-8661423)⟩, ⟨46099, 94747⟩, ⟨5513, 5846⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4147644889, 4258422411⟩, ⟨(-73567369), (-35784376)⟩, ⟨(-9090708), (-8661423)⟩, ⟨46099, 94747⟩, ⟨5513, 5846⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨318462797, 646989522⟩, ⟨152540584, 160107108⟩, ⟨(-2502202), (-1220961)⟩, ⟨(-205869), (-194255)⟩, ⟨934, 1922⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4331825801, 4447522527⟩, ⟨36401198, 78886342⟩, ⟨9116607, 11147192⟩, ⟨51690, 322477⟩, ⟨11113, 23992⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨321195777, 669970288⟩, ⟨156548727, 177677397⟩, ⟨(-622274), 3388476⟩, ⟨68477, 257852⟩, ⟨(-6676), 13391⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-621009322), (-310504660)⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3673957974, 3984462636⟩, ⟨(-155252331), (-155252330)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨24020375, 104508407⟩, ⟨23414748, 55431658⟩, ⟨5511959, 8407427⟩, ⟨(-41246), 360800⟩, ⟨2415, 28188⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4318987671, 4399475703⟩, ⟨23414748, 55431658⟩, ⟨5511959, 8407427⟩, ⟨(-41246), 360800⟩, ⟨2415, 28188⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4306960738, 4346907437⟩, ⟨11567485, 27638650⟩, ⟨2635182, 4176474⟩, ⟨(-47368), 172821⟩, ⟨(-1932), 13554⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3684217284, 4032647765⟩, ⟨(-147234896), (-130045348)⟩, ⟨1255092, 3456401⟩, ⟨(-194914), 65072⟩, ⟨(-8041), 14288⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2696994519, 5393989058⟩, ⟨1348497259, 1348497269⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1693558747, 6774235042⟩, ⟨1693558746, 3387117532⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1693558747, 6774235042⟩, ⟨1693558746, 3387117532⟩, ⟨423389686, 423389693⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6774235042), (-1693558747)⟩, ⟨(-3387117532), (-1693558746)⟩, ⟨(-423389693), (-423389686)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3387117521), (-846779373)⟩, ⟨(-1693558766), (-846779373)⟩, ⟨(-211694847), (-211694843)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1951931090, 3526436091⟩, ⟨(-1390517400), (-384835289)⟩, ⟨(-135878348), 177940290⟩, ⟨(-10742577), 63551024⟩, ⟨(-10649993), 4407641⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1674363915, 3311055392⟩, ⟨(-1426479160), (-389212830)⟩, ⟨(-115356788), 217578369⟩, ⟨(-17465464), 64268570⟩, ⟨(-12315134), 4724741⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4323004870, 4323004871⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2144
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4306960738, 4346907437⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2145
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (11201165 / 268435456)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((14459 / 200000) : ℝ)..(14459 / 100000), prawitzNormalCorrection
