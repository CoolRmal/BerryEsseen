...
namespace FiniteNormalPanel84_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (6237 / 20000)
def radius : Rat := (891 / 20000)

def j0 : Jet := ⟨⟨1339385551, 1339385552⟩, ⟨191340793, 191340794⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4207803807, 4207803811⟩, ⟨601114829, 601114833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4122409242, 4122409251⟩, ⟨1177831210, 1177831222⟩, ⟨84130800, 84130802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1031, 1033⟩, ⟨294, 296⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93656), (-93653)⟩, ⟨294, 296⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-89894), (-89890)⟩, ⟨(-25402), (-25397)⟩, ⟨(-1735), (-1730)⟩, ⟨10, 13⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5023162, 5023167⟩, ⟨(-25402), (-25397)⟩, ⟨(-1735), (-1730)⟩, ⟨10, 13⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4821347, 4821353⟩, ⟨1353145, 1353154⟩, ⟨89761, 89771⟩, ⟨(-965), (-958)⟩, ⟨(-32), (-28)⟩⟩
...
def j16 : Jet := ⟨⟨(-138344230), (-138344223)⟩, ⟨1353145, 1353154⟩, ⟨89761, 89771⟩, ⟨(-965), (-958)⟩, ⟨(-32), (-28)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-132786002), (-132785994)⟩, ⟨(-36640079), (-36640066)⟩, ⟨(-2252686), (-2252670)⟩, ⟨50193, 50206⟩, ⟨1462, 1471⟩⟩
...
def j19 : Jet := ⟨⟨1298869763, 1298869772⟩, ⟨(-36640079), (-36640066)⟩, ⟨(-2252686), (-2252670)⟩, ⟨50193, 50206⟩, ⟨1462, 1471⟩⟩
...
def j22 : Jet := ⟨⟨(-104), (-102)⟩, ⟨(-30), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11731, 11734⟩, ⟨(-30), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨11259, 11263⟩, ⟨3188, 3191⟩, ⟨217, 222⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-840918), (-840913)⟩, ⟨3188, 3191⟩, ⟨217, 222⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-807133), (-807127)⟩, ⟨(-227551), (-227544)⟩, ⟨(-15391), (-15381)⟩, ⟨119, 124⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨34984261, 34984268⟩, ⟨(-227551), (-227544)⟩, ⟨(-15391), (-15381)⟩, ⟨119, 124⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨33578705, 33578713⟩, ⟨9375506, 9375516⟩, ⟨608103, 608117⟩, ⟨(-8565), (-8555)⟩, ⟨(-269), (-261)⟩⟩
...
def j33 : Jet := ⟨⟨(-682249178), (-682249169)⟩, ⟨9375506, 9375516⟩, ⟨608103, 608117⟩, ⟨(-8565), (-8555)⟩, ⟨(-269), (-261)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-654838589), (-654838578)⟩, ⟨(-178097913), (-178097898)⟩, ⟨(-10209289), (-10209270)⟩, ⟨342191, 342207⟩, ⟨9303, 9316⟩⟩
...
def j36 : Jet := ⟨⟨3640128707, 3640128718⟩, ⟨(-178097913), (-178097898)⟩, ⟨(-10209289), (-10209270)⟩, ⟨342191, 342207⟩, ⟨9303, 9316⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1272510069, 1272510080⟩, ⟨145890658, 145890676⟩, ⟨(-7335041), (-7335021)⟩, ⟨(-266108), (-266091)⟩, ⟨8456, 8469⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5067607632, 5067607648⟩, ⟨247939107, 247939132⟩, ⟨26343574, 26343607⟩, ⟨1507867, 1507898⟩, ⟨111379, 111405⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1501427436, 1501427455⟩, ⟨245594796, 245594828⟩, ⟨7572431, 7572470⟩, ⟨604166, 604202⟩, ⟨33841, 33871⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1339385552), (-1339385551)⟩, ⟨(-191340794), (-191340793)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2955581744, 2955581745⟩, ⟨(-191340794), (-191340793)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨524866475, 524866489⟩, ⟨171709230, 171709256⟩, ⟨19337914, 19337948⟩, ⟨1288418, 1288450⟩, ⟨106104, 106134⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4819833771, 4819833785⟩, ⟨171709230, 171709256⟩, ⟨19337914, 19337948⟩, ⟨1288418, 1288450⟩, ⟨106104, 106134⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4549838284, 4549838292⟩, ⟨81045245, 81045259⟩, ⟨8405504, 8405522⟩, ⟨458395, 458413⟩, ⟨34149, 34166⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3130971214, 3130971221⟩, ⟨(-146924012), (-146924000)⟩, ⟨2173680, 2173695⟩, ⟨(-59023), (-59008)⟩, ⟨3076, 3091⟩⟩
...
def j47 : Jet := ⟨⟨7632321887, 7632321895⟩, ⟨1090331698, 1090331705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨13562929208, 13562929237⟩, ⟨3875122630, 3875122660⟩, ⟨276794473, 276794478⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨13562929208, 13562929237⟩, ⟨3875122630, 3875122660⟩, ⟨276794473, 276794478⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-13562929237), (-13562929208)⟩, ⟨(-3875122660), (-3875122630)⟩, ⟨(-276794478), (-276794473)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6781464619), (-6781464604)⟩, ⟨(-1937561330), (-1937561315)⟩, ⟨(-138397239), (-138397236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨885600941, 885600953⟩, ⟨(-399515536), (-399515527)⟩, ⟨61578626, 61578631⟩, ⟨(-677436), (-677433)⟩, ⟨(-915727), (-915725)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨645590725, 645590736⟩, ⟨(-321536254), (-321536242)⟩, ⟨59004950, 59004962⟩, ⟨(-2814717), (-2814706)⟩, ⟨(-607094), (-607080)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1148044758, 1530726345⟩, ⟨191340793, 191340794⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3606688977, 4808918641⟩, ⟨601114829, 601114833⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3028708830, 5384371266⟩, ⟨1009569608, 1346092824⟩, ⟨84130800, 84130802⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨758, 1349⟩, ⟨252, 338⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93929), (-93337)⟩, ⟨252, 338⟩, ⟨21, 22⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-117754), (-65819)⟩, ⟨(-29262), (-21515)⟩, ⟨(-1767), (-1694)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4995302, 5047238⟩, ⟨(-29262), (-21515)⟩, ⟨(-1767), (-1694)⟩, ⟨8, 14⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3522568, 6327453⟩, ⟨1137504, 1566693⟩, ⟨86461, 92616⟩, ⟨(-1123), (-801)⟩, ⟨(-34), (-26)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139643009), (-136838123)⟩, ⟨1137504, 1566693⟩, ⟨86461, 92616⟩, ⟨(-1123), (-801)⟩, ⟨(-34), (-26)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-175062988), (-96494991)⟩, ⟨(-42963608), (-30200917)⟩, ⟨(-2407010), (-2073288)⟩, ⟨41196, 59152⟩, ⟨1298, 1609⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1256592777, 1335160775⟩, ⟨(-42963608), (-30200917)⟩, ⟨(-2407010), (-2073288)⟩, ⟨41196, 59152⟩, ⟨1298, 1609⟩⟩
...
def j70 : Jet := ⟨⟨(-136), (-75)⟩, ⟨(-34), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11699, 11761⟩, ⟨(-34), (-25)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8249, 14745⟩, ⟨2706, 3670⟩, ⟨214, 225⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843928), (-837431)⟩, ⟨2706, 3670⟩, ⟨214, 225⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1057988), (-590536)⟩, ⟨(-262589), (-192244)⟩, ⟨(-15746), (-14969)⟩, ⟨100, 143⟩, ⟨1, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34733406, 35200859⟩, ⟨(-262589), (-192244)⟩, ⟨(-15746), (-14969)⟩, ⟨100, 143⟩, ⟨1, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨24493172, 44129439⟩, ⟨7835196, 10896795⟩, ⟨578326, 633780⟩, ⟨(-10009), (-7103)⟩, ⟨(-286), (-241)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-691334711), (-671698443)⟩, ⟨7835196, 10896795⟩, ⟨578326, 633780⟩, ⟨(-10009), (-7103)⟩, ⟨(-286), (-241)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-866689429), (-473665773)⟩, ⟨(-211147166), (-144227859)⟩, ⟨(-11292471), (-8947662)⟩, ⟨276869, 407076⟩, ⟨7832, 10577⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3428277867, 3821301523⟩, ⟨(-211147166), (-144227859)⟩, ⟨(-11292471), (-8947662)⟩, ⟨276869, 407076⟩, ⟨7832, 10577⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1055220914, 1494930950⟩, ⟨127765363, 161505219⟩, ⟨(-8708141), (-5967896)⟩, ⟨(-302287), (-223942)⟩, ⟨6854, 10081⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4827345856, 5380761068⟩, ⟨182199115, 331400341⟩, ⟨18180099, 38134697⟩, ⟨539592, 3050460⟩, ⟨12735, 287751⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1186019812, 1872858558⟩, ⟨188366489, 317683822⟩, ⟨(-1022982), 19027510⟩, ⟨(-377243), 1990887⟩, ⟨(-73762), 192735⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1530726345), (-1148044758)⟩, ⟨(-191340794), (-191340793)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2764240951, 3146922538⟩, ⟨(-191340794), (-191340793)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨327509593, 816676575⟩, ⟨104031706, 277057694⟩, ⟨7369119, 40092200⟩, ⟨(-480336), 4551086⟩, ⟨(-124671), 546904⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4622476889, 5111643871⟩, ⟨104031706, 277057694⟩, ⟨7369119, 40092200⟩, ⟨(-480336), 4551086⟩, ⟨(-124671), 546904⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4455713979, 4685546207⟩, ⟨47679902, 133531208⟩, ⟨1474698, 19067800⟩, ⟨(-802938), 2177669⟩, ⟨(-166149), 287407⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2867697516, 3433099707⟩, ⟨(-178054301), (-100663740)⟩, ⟨(-4999701), 11846839⟩, ⟨(-1437784), 1529882⟩, ⟨(-218754), 246355⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6541990189, 8722653594⟩, ⟨1090331698, 1090331705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9964601051, 17714846349⟩, ⟨3321533682, 4428711612⟩, ⟨276794473, 276794478⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9964601051, 17714846349⟩, ⟨3321533682, 4428711612⟩, ⟨276794473, 276794478⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-17714846349), (-9964601051)⟩, ⟨(-4428711612), (-3321533682)⟩, ⟨(-276794478), (-276794473)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-8857423175), (-4982300525)⟩, ⟨(-2214355806), (-1660766841)⟩, ⟨(-138397239), (-138397236)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨546164204, 1346369495⟩, ⟨(-694147570), (-211189361)⟩, ⟨(-2553146), 161341680⟩, ⟨(-23190851), 15350509⟩, ⟨(-4578032), 3030262⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨364667207, 1076194626⟩, ⟨(-610669307), (-153809351)⟩, ⟨1341676, 161456006⟩, ⟨(-27591207), 13663608⟩, ⟨(-4799391), 4138224⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1339385551, 1339385552⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4549838284, 4549838292⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1698
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1148044758, 1530726345⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4455713979, 4685546207⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1699
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (29674163 / 2147483648)

theorem envelope_integral : (∫ s in ((2673 / 10000) : ℝ)..(891 / 2500),
...
theorem actual_correction_integral {n : ℕ} (hn : 8 ≤ n) :
    (∫ s in ((2673 / 10000) : ℝ)..(891 / 2500), prawitzNormalCorrection
