...
namespace FiniteNormalPanel169_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (35217 / 160000)
def radius : Rat := (5031 / 160000)

def j0 : Jet := ⟨⟨945349145, 945349146⟩, ⟨135049877, 135049878⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨2969901928, 2969901933⟩, ⟨424271701, 424271705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨2053640191, 2053640199⟩, ⟨586754336, 586754344⟩, ⟨41911023, 41911025⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨514, 515⟩, ⟨146, 147⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94173), (-94171)⟩, ⟨146, 147⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-45029), (-45027)⟩, ⟨(-12797), (-12794)⟩, ⟨(-896), (-891)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5068027, 5068030⟩, ⟨(-12797), (-12794)⟩, ⟨(-896), (-891)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨2423278, 2423281⟩, ⟨686246, 686249⟩, ⟨47276, 47282⟩, ⟨(-248), (-243)⟩, ⟨(-9), (-6)⟩⟩
...
def j16 : Jet := ⟨⟨(-140742299), (-140742295)⟩, ⟨686246, 686249⟩, ⟨47276, 47282⟩, ⟨(-248), (-243)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-67295983), (-67295980)⟩, ⟨(-18899296), (-18899291)⟩, ⟨(-1257032), (-1257027)⟩, ⟨13035, 13041⟩, ⟨422, 427⟩⟩
...
def j19 : Jet := ⟨⟨1364359782, 1364359786⟩, ⟨(-18899296), (-18899291)⟩, ⟨(-1257032), (-1257027)⟩, ⟨13035, 13041⟩, ⟨422, 427⟩⟩
...
def j22 : Jet := ⟨⟨(-52), (-51)⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11783, 11785⟩, ⟨(-15), (-14)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨5634, 5636⟩, ⟨1601, 1605⟩, ⟨110, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-846543), (-846540)⟩, ⟨1601, 1605⟩, ⟨110, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-404775), (-404773)⟩, ⟨(-114885), (-114881)⟩, ⟨(-7991), (-7985)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35386619, 35386622⟩, ⟨(-114885), (-114881)⟩, ⟨(-7991), (-7985)⟩, ⟨29, 32⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨16920124, 16920127⟩, ⟨4779388, 4779392⟩, ⟨325792, 325797⟩, ⟨(-2201), (-2195)⟩, ⟨(-76), (-71)⟩⟩
...
def j33 : Jet := ⟨⟨(-698907759), (-698907755)⟩, ⟨4779388, 4779392⟩, ⟨325792, 325797⟩, ⟨(-2201), (-2195)⟩, ⟨(-76), (-71)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-334183004), (-334182999)⟩, ⟨(-93195593), (-93195587)⟩, ⟨(-6011352), (-6011347)⟩, ⟨90092, 90099⟩, ⟨2841, 2848⟩⟩
...
def j36 : Jet := ⟨⟨3960784292, 3960784297⟩, ⟨(-93195593), (-93195587)⟩, ⟨(-6011352), (-6011347)⟩, ⟨90092, 90099⟩, ⟨2841, 2848⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨943433201, 943433207⟩, ⟨121707605, 121707613⟩, ⟨(-2736156), (-2736151)⟩, ⟨(-115161), (-115155)⟩, ⟨1578, 1585⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4657346295, 4657346302⟩, ⟨109585397, 109585406⟩, ⟨9647027, 9647037⟩, ⟨287364, 287377⟩, ⟨15559, 15573⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1023033429, 1023033438⟩, ⟨156047977, 156047990⟩, ⟨2257402, 2257413⟩, ⟨141801, 141815⟩, ⟨4186, 4201⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-945349146), (-945349145)⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3349618150, 3349618151⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨243679945, 243679950⟩, ⟨74339236, 74339246⟩, ⟨6745048, 6745058⟩, ⟨231586, 231598⟩, ⟨13484, 13495⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4538647241, 4538647246⟩, ⟨74339236, 74339246⟩, ⟨6745048, 6745058⟩, ⟨231586, 231598⟩, ⟨13484, 13495⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4415126438, 4415126441⟩, ⟨36158034, 36158040⟩, ⟨3132679, 3132686⟩, ⟨86985, 86993⟩, ⟨4734, 4741⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3443329513, 3443329518⟩, ⟨(-110628709), (-110628700)⟩, ⟨1306211, 1306219⟩, ⟨(-30665), (-30657)⟩, ⟨956, 963⟩⟩
...
def j47 : Jet := ⟨⟨10861786487, 10861786501⟩, ⟨1551683774, 1551683786⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨27468988133, 27468988205⟩, ⟨7848282274, 7848282346⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨27468988133, 27468988205⟩, ⟨7848282274, 7848282346⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-27468988205), (-27468988133)⟩, ⟨(-7848282346), (-7848282274)⟩, ⟨(-560591597), (-560591587)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-13734494103), (-13734494066)⟩, ⟨(-3924141173), (-3924141137)⟩, ⟨(-280295799), (-280295793)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨175455965, 175455971⟩, ⟨(-160307158), (-160307150)⟩, ⟨61782628, 61782634⟩, ⟨(-11841529), (-11841526)⟩, ⟨688770, 688773⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨140665262, 140665268⟩, ⟨(-133039625), (-133039617)⟩, ⟨53714423, 53714433⟩, ⟨(-11134893), (-11134886)⟩, ⟨877178, 877186⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨810299267, 1080399024⟩, ⟨135049877, 135049878⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2545630224, 3394173637⟩, ⟨424271701, 424271705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨1508796875, 2682305565⟩, ⟨502932288, 670576392⟩, ⟨41911023, 41911025⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨377, 672⟩, ⟨125, 168⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94310), (-94014)⟩, ⟨125, 168⟩, ⟨10, 11⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-58899), (-33026)⟩, ⟨(-14682), (-10903)⟩, ⟨(-904), (-883)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5054157, 5080031⟩, ⟨(-14682), (-10903)⟩, ⟨(-904), (-883)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨1775495, 3172596⟩, ⟨582661, 789319⟩, ⟨46461, 47986⟩, ⟨(-286), (-206)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-141390082), (-139992980)⟩, ⟨582661, 789319⟩, ⟨46461, 47986⟩, ⟨(-286), (-206)⟩, ⟨(-9), (-6)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-88301349), (-49178714)⟩, ⟨(-21870653), (-15899956)⟩, ⟨(-1295160), (-1212869)⟩, ⟨10946, 15124⟩, ⟨402, 443⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1343354416, 1382477052⟩, ⟨(-21870653), (-15899956)⟩, ⟨(-1295160), (-1212869)⟩, ⟨10946, 15124⟩, ⟨402, 443⟩⟩
...
def j70 : Jet := ⟨⟨(-68), (-37)⟩, ⟨(-17), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11767, 11799⟩, ⟨(-17), (-12)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨4133, 7369⟩, ⟨1366, 1839⟩, ⟨109, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-848044), (-844807)⟩, ⟨1366, 1839⟩, ⟨109, 115⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-529623), (-296775)⟩, ⟨(-131927), (-97776)⟩, ⟨(-8079), (-7883)⟩, ⟨23, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35261771, 35494620⟩, ⟨(-131927), (-97776)⟩, ⟨(-8079), (-7883)⟩, ⟨23, 36⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨12387253, 22167205⟩, ⟨4046692, 5507454⟩, ⟨318446, 332145⟩, ⟨(-2542), (-1854)⟩, ⟨(-78), (-68)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-703440630), (-693660677)⟩, ⟨4046692, 5507454⟩, ⟨318446, 332145⟩, ⟨(-2542), (-1854)⟩, ⟨(-78), (-68)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-439314805), (-243678936)⟩, ⟨(-108407123), (-77786779)⟩, ⟨(-6278567), (-5701543)⟩, ⟨75189, 104951⟩, ⟨2661, 3002⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3855652491, 4051288360⟩, ⟨(-108407123), (-77786779)⟩, ⟨(-6278567), (-5701543)⟩, ⟨75189, 104951⟩, ⟨2661, 3002⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨796207134, 1092526867⟩, ⟨115417518, 127141944⟩, ⟨(-3183983), (-2289520)⟩, ⟨(-121454), (-107858)⟩, ⟨1319, 1846⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4553303155, 4784337831⟩, ⟨87425715, 134518426⟩, ⟨8086665, 11573021⟩, ⟨154362, 455650⟩, ⟨7310, 26811⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨844097802, 1217009878⟩, ⟨138566812, 175846511⟩, ⟨301717, 4498730⟩, ⟨10909, 297548⟩, ⟨(-5483), 15862⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1080399024), (-810299267)⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3214568272, 3484668029⟩, ⟨(-135049878), (-135049877)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨165892089, 344848504⟩, ⟨54465578, 99654748⟩, ⟨4589117, 9749085⟩, ⟨23754, 537006⟩, ⟨(-2385), 38069⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4460859385, 4639815800⟩, ⟨54465578, 99654748⟩, ⟨4589117, 9749085⟩, ⟨23754, 537006⟩, ⟨(-2385), 38069⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4377127502, 4464062850⟩, ⟨26201230, 48892097⟩, ⟨1939899, 4704627⟩, ⟨(-40897), 251852⟩, ⟨(-6512), 18705⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3276061078, 3621861594⟩, ⟨(-120756567), (-97965309)⟩, ⟨(-85434), 2993177⟩, ⟨(-181114), 143340⟩, ⟨(-13204), 16463⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨9310102701, 12413470287⟩, ⟨1551683774, 1551683786⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨20181297395, 35877862146⟩, ⟨6727099090, 8969465538⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨20181297395, 35877862146⟩, ⟨6727099090, 8969465538⟩, ⟨560591587, 560591597⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-35877862146), (-20181297395)⟩, ⟨(-8969465538), (-6727099090)⟩, ⟨(-560591597), (-560591587)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-17938931073), (-10090648697)⟩, ⟨(-4484732769), (-3363549545)⟩, ⟨(-280295799), (-280295793)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨65921611, 409848263⟩, ⟨(-427956678), (-51625679)⟩, ⟨(-6532293), 219130451⟩, ⟨(-74024669), 20893020⟩, ⟨(-12604421), 19536983⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨50282856, 345616994⟩, ⟨(-372410689), (-40882012)⟩, ⟨(-4339162), 197106389⟩, ⟨(-68900113), 17824527⟩, ⟨(-11236582), 18728751⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨945349145, 945349146⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4415126438, 4415126441⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3422
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨810299267, 1080399024⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4377127502, 4464062850⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3423
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (10207637 / 4294967296)

theorem envelope_integral : (∫ s in ((15093 / 80000) : ℝ)..(5031 / 20000),
...
theorem actual_correction_integral {n : ℕ} (hn : 19 ≤ n) :
    (∫ s in ((15093 / 80000) : ℝ)..(5031 / 20000), prawitzNormalCorrection
