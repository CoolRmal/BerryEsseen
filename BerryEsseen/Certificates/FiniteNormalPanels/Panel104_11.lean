...
namespace FiniteNormalPanel104_11
...
def j2 : Jet := ⟨⟨481870107, 481870111⟩, ⟨481870107, 481870111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨54062996, 54062997⟩, ⟨108125992, 108125994⟩, ⟨54062996, 54062997⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1192), (-1191)⟩, ⟨(-2384), (-2382)⟩, ⟨(-1192), (-1189)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111864, 5111866⟩, ⟨(-2384), (-2382)⟩, ⟨(-1192), (-1189)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨64345, 64346⟩, ⟨128660, 128663⟩, ⟨64268, 64273⟩, ⟨(-62), (-57)⟩, ⟨(-16), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-143101232), (-143101230)⟩, ⟨128660, 128663⟩, ⟨64268, 64273⟩, ⟨(-62), (-57)⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1801290), (-1801289)⟩, ⟨(-3600961), (-3600959)⟩, ⟨(-1797243), (-1797239)⟩, ⟨3235, 3239⟩, ⟨805, 809⟩⟩
...
def j19 : Jet := ⟨⟨1429854475, 1429854477⟩, ⟨(-3600961), (-3600959)⟩, ⟨(-1797243), (-1797239)⟩, ⟨3235, 3239⟩, ⟨805, 809⟩⟩
...
def j25 : Jet := ⟨⟨148, 149⟩, ⟨296, 298⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852029), (-852027)⟩, ⟨296, 298⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10725), (-10724)⟩, ⟨(-21447), (-21445)⟩, ⟨(-10717), (-10714)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780669, 35780671⟩, ⟨(-21447), (-21445)⟩, ⟨(-10717), (-10714)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨450389, 450390⟩, ⟨900509, 900511⟩, ⟨449714, 449717⟩, ⟨(-540), (-537)⟩, ⟨(-136), (-132)⟩⟩
...
def j33 : Jet := ⟨⟨(-715377494), (-715377492)⟩, ⟨900509, 900511⟩, ⟨449714, 449717⟩, ⟨(-540), (-537)⟩, ⟨(-136), (-132)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9004831), (-9004830)⟩, ⟨(-17998326), (-17998324)⟩, ⟨(-8976501), (-8976498)⟩, ⟨22649, 22652⟩, ⟨5644, 5647⟩⟩
...
def j36 : Jet := ⟨⟨4285962465, 4285962466⟩, ⟨(-17998326), (-17998324)⟩, ⟨(-8976501), (-8976498)⟩, ⟨22649, 22652⟩, ⟨5644, 5647⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨160421274, 160421277⟩, ⟨160017267, 160017271⟩, ⟨(-605648), (-605645)⟩, ⟨(-201279), (-201275)⟩, ⟨452, 455⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303991045, 4303991047⟩, ⟨18074032, 18074036⟩, ⟨9090155, 9090161⟩, ⟨53277, 53284⟩, ⟨13494, 13502⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨160758319, 160758324⟩, ⟨161028546, 161028553⟩, ⟨405987, 405993⟩, ⟨136409, 136418⟩, ⟨810, 819⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-153384020), (-153384019)⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4141583276, 4141583277⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6017097, 6017098⟩, ⟨12054422, 12054426⟩, ⟨6067733, 6067738⟩, ⟨40652, 40658⟩, ⟨10326, 10331⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300984393, 4300984394⟩, ⟨12054422, 12054426⟩, ⟨6067733, 6067738⟩, ⟨40652, 40658⟩, ⟨10326, 10331⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297974791, 4297974793⟩, ⟨6022993, 6022996⟩, ⟨3027523, 3027527⟩, ⟨16068, 16073⟩, ⟨4069, 4074⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4144483365, 4144483369⟩, ⟨(-147683530), (-147683524)⟩, ⟨2704305, 2704311⟩, ⟨(-92627), (-92621)⟩, ⟨3348, 3356⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨40780711384, 40780711391⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value465

def j47 : Jet := ⟨⟨1456381149, 1456381160⟩, ⟨1456381149, 1456381160⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨493844517, 493844525⟩, ⟨987689034, 987689050⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨493844517, 493844525⟩, ⟨987689034, 987689050⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-493844525), (-493844517)⟩, ⟨(-987689050), (-987689034)⟩, ⟨(-493844525), (-493844517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-246922263), (-246922258)⟩, ⟨(-493844525), (-493844517)⟩, ⟨(-246922263), (-246922258)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4055008856, 4055008861⟩, ⟨(-466253591), (-466253582)⟩, ⟨(-206321380), (-206321372)⟩, ⟨25778035, 25778037⟩, ⟨5189814, 5189816⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3912932413, 3912932423⟩, ⟨(-589349838), (-589349822)⟩, ⟨(-180506982), (-180506964)⟩, ⟨31588227, 31588238⟩, ⟨4004896, 4004912⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 306768040⟩, ⟨153384019, 153384020⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 963740221⟩, ⟨481870107, 481870111⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 216251988⟩, ⟨0, 216251988⟩, ⟨54062996, 54062997⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4768), 0⟩, ⟨(-4768), 3⟩, ⟨(-1192), (-1187)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108288, 5113057⟩, ⟨(-4768), 3⟩, ⟨(-1192), (-1187)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 257443⟩, ⟨(-241), 257444⟩, ⟨63998, 64362⟩, ⟨(-122), 2⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142908133)⟩, ⟨(-241), 257444⟩, ⟨63998, 64362⟩, ⟨(-122), 2⟩, ⟨(-16), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7208400), 0⟩, ⟨(-7208413), 12963⟩, ⟨(-1802113), (-1782655)⟩, ⟨(-11), 6483⟩, ⟨797, 812⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424447365, 1431655766⟩, ⟨(-7208413), 12963⟩, ⟨(-1802113), (-1782655)⟩, ⟨(-11), 6483⟩, ⟨797, 812⟩⟩
...
def j72 : Jet := ⟨⟨0, 596⟩, ⟨(-1), 596⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851580)⟩, ⟨(-1), 596⟩, ⟨146, 149⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-42908), 0⟩, ⟨(-42909), 31⟩, ⟨(-10728), (-10680)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35748486, 35791395⟩, ⟨(-42909), 31⟩, ⟨(-10728), (-10680)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1802100⟩, ⟨(-2161), 1802102⟩, ⟨447282, 450527⟩, ⟨(-1083), 2⟩, ⟨(-138), (-132)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714025782)⟩, ⟨(-2161), 1802102⟩, ⟨447282, 450527⟩, ⟨(-1083), 2⟩, ⟨(-138), (-132)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-36041999), 0⟩, ⟨(-36042108), 90736⟩, ⟨(-9010609), (-8874394)⟩, ⟨(-83), 45370⟩, ⟨5568, 5673⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4258925297, 4294967296⟩, ⟨(-36042108), 90736⟩, ⟨(-9010609), (-8874394)⟩, ⟨(-83), 45370⟩, ⟨5568, 5673⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 321246741⟩, ⟨158197144, 160626280⟩, ⟨(-1213115), 1455⟩, ⟨(-202190), (-198548)⟩, ⟨(-2), 911⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4331314308⟩, ⟨(-92279), 36654717⟩, ⟨8873619, 9473963⟩, ⟨(-46540), 157812⟩, ⟨11833, 15767⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 323965356⟩, ⟨158190241, 164727242⟩, ⟨(-1226834), 2080924⟩, ⟨109105, 167598⟩, ⟨(-6146), 8010⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-306768040), 0⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3988199256, 4294967296⟩, ⟨(-153384020), (-153384019)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 24436404⟩, ⟨0, 24850444⟩, ⟨5641311, 6631801⟩, ⟨(-94108), 184906⟩, ⟨6513, 15075⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4319403700⟩, ⟨0, 24850444⟩, ⟨5641311, 6631801⟩, ⟨(-94108), 184906⟩, ⟨6513, 15075⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4307168169⟩, ⟨0, 12425222⟩, ⟨2794743, 3315901⟩, ⟨(-56647), 92453⟩, ⟨1703, 6793⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3988199256, 4307168169⟩, ⟨(-153819744), (-140958797)⟩, ⟨2151392, 3315901⟩, ⟨(-175067), (-7354)⟩, ⟨(-1721), 8817⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2912762320⟩, ⟨1456381149, 1456381160⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1975378100⟩, ⟨0, 1975378100⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1975378100⟩, ⟨0, 1975378100⟩, ⟨493844517, 493844525⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1975378100), 0⟩, ⟨(-1975378100), 0⟩, ⟨(-493844525), (-493844517)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-987689050), 0⟩, ⟨(-987689050), 0⟩, ⟨(-246922263), (-246922258)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3412617742, 4294967296⟩, ⟨(-987689050), 0⟩, ⟨(-246922263), (-82628440)⟩, ⟨0, 56783300⟩, ⟨(-889335), 7097913⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3168871519, 4307168169⟩, ⟨(-1144314559), (-112000501)⟩, ⟨(-245914291), (-38037755)⟩, ⟨1774220, 65782026⟩, ⟨(-3117853), 7125765⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297974791, 4297974793⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar465 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2096
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar465 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4307168169⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2097
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 11 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(2857 / 40000), prawitzNormalCorrection
      ((57257 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
