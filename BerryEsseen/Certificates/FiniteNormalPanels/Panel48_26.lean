...
namespace FiniteNormalPanel48_26

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (478959 / 1600000)
def radius : Rat := (36843 / 1600000)

def j0 : Jet := ⟨⟨1285695775, 1285695776⟩, ⟨98899675, 98899676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4039132401, 4039132405⟩, ⟨310702492, 310702496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3798536619, 3798536627⟩, ⟨584390248, 584390258⟩, ⟨22476547, 22476549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨950, 952⟩, ⟨146, 147⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93737), (-93734)⟩, ⟨146, 147⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-82903), (-82899)⟩, ⟨(-12626), (-12622)⟩, ⟨(-468), (-463)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5030153, 5030158⟩, ⟨(-12626), (-12622)⟩, ⟨(-468), (-463)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨4448746, 4448751⟩, ⟨673255, 673261⟩, ⟨24191, 24198⟩, ⟨(-131), (-126)⟩, ⟨(-3), 0⟩⟩
...
def j16 : Jet := ⟨⟨(-138716831), (-138716825)⟩, ⟨673255, 673261⟩, ⟨24191, 24198⟩, ⟨(-131), (-126)⟩, ⟨(-3), 0⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-122683348), (-122683341)⟩, ⟨(-18278925), (-18278917)⟩, ⟨(-612938), (-612927)⟩, ⟨6698, 6706⟩, ⟨105, 110⟩⟩
...
def j19 : Jet := ⟨⟨1308972417, 1308972425⟩, ⟨(-18278925), (-18278917)⟩, ⟨(-612938), (-612927)⟩, ⟨6698, 6706⟩, ⟨105, 110⟩⟩
...
def j22 : Jet := ⟨⟨(-96), (-94)⟩, ⟨(-15), (-14)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11739, 11742⟩, ⟨(-15), (-14)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨10382, 10385⟩, ⟨1583, 1586⟩, ⟨57, 61⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-841795), (-841791)⟩, ⟨1583, 1586⟩, ⟨57, 61⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-744497), (-744493)⟩, ⟨(-113138), (-113134)⟩, ⟨(-4141), (-4135)⟩, ⟨13, 18⟩, ⟨(-2), 1⟩⟩
...
def j30 : Jet := ⟨⟨35046897, 35046902⟩, ⟨(-113138), (-113134)⟩, ⟨(-4141), (-4135)⟩, ⟨13, 18⟩, ⟨(-2), 1⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨30996026, 30996032⟩, ⟨4668557, 4668564⟩, ⟨164350, 164359⟩, ⟨(-1146), (-1138)⟩, ⟨(-23), (-17)⟩⟩
...
def j33 : Jet := ⟨⟨(-684831857), (-684831850)⟩, ⟨4668557, 4668564⟩, ⟨164350, 164359⟩, ⟨(-1146), (-1138)⟩, ⟨(-23), (-17)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-605676066), (-605676057)⟩, ⟨(-89051990), (-89051979)⟩, ⟨(-2803308), (-2803295)⟩, ⟨45779, 45790⟩, ⟨683, 692⟩⟩
...
def j36 : Jet := ⟨⟨3689291230, 3689291239⟩, ⟨(-89051990), (-89051979)⟩, ⟨(-2803308), (-2803295)⟩, ⟨45779, 45790⟩, ⟨683, 692⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1231001899, 1231001909⟩, ⟨77502334, 77502345⟩, ⟨(-1898745), (-1898733)⟩, ⟨(-38042), (-38032)⟩, ⟨582, 590⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5000078030, 5000078044⟩, ⟨120691702, 120691719⟩, ⟨6712542, 6712563⟩, ⟨191673, 191694⟩, ⟨7290, 7307⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1433097186, 1433097203⟩, ⟨124818046, 124818067⟩, ⟨1891320, 1891345⟩, ⟨78418, 78441⟩, ⟨2186, 2207⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1285695776), (-1285695775)⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3009271520, 3009271521⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨478180019, 478180031⟩, ⟨83295810, 83295826⟩, ⟨4889543, 4889565⟩, ⟨162258, 162280⟩, ⟨6846, 6867⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4773147315, 4773147327⟩, ⟨83295810, 83295826⟩, ⟨4889543, 4889565⟩, ⟨162258, 162280⟩, ⟨6846, 6867⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4527749067, 4527749074⟩, ⟨39506692, 39506701⟩, ⟨2146722, 2146734⟩, ⟨58226, 58238⟩, ⟨2229, 2242⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3172370213, 3172370220⟩, ⟨(-76579525), (-76579516)⟩, ⟨594386, 594396⟩, ⟨(-8637), (-8627)⟩, ⟨219, 231⟩⟩
...
def j47 : Jet := ⟨⟨6893241531, 6893241539⟩, ⟨530249348, 530249355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11063362193, 11063362220⟩, ⟨1702055720, 1702055746⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11063362193, 11063362220⟩, ⟨1702055720, 1702055746⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11063362220), (-11063362193)⟩, ⟨(-1702055746), (-1702055720)⟩, ⟨(-65463684), (-65463681)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5531681110), (-5531681096)⟩, ⟨(-851027873), (-851027860)⟩, ⟨(-32731842), (-32731840)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1184711236, 1184711251⟩, ⟨(-234745047), (-234745039)⟩, ⟨14228164, 14228167⟩, ⟨252908, 252910⟩, ⟨(-66745), (-66744)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨875057335, 875057349⟩, ⟨(-194512034), (-194512024)⟩, ⟨14858747, 14858756⟩, ⟨(-101757), (-101747)⟩, ⟨(-51310), (-51300)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1186796100, 1384595451⟩, ⟨98899675, 98899676⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3728429908, 4349834898⟩, ⟨310702492, 310702496⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3236622917, 4405403426⟩, ⟨539437152, 629343354⟩, ⟨22476547, 22476549⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨810, 1104⟩, ⟨135, 158⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93877), (-93582)⟩, ⟨135, 158⟩, ⟨5, 6⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-96291), (-70521)⟩, ⟨(-13655), (-11590)⟩, ⟨(-473), (-458)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5016765, 5042536⟩, ⟨(-13655), (-11590)⟩, ⟨(-473), (-458)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨3780558, 5172195⟩, ⟨616086, 730151⟩, ⟨23766, 24589⟩, ⟨(-142), (-114)⟩, ⟨(-3), 1⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139385019), (-137993381)⟩, ⟨616086, 730151⟩, ⟨23766, 24589⟩, ⟨(-142), (-114)⟩, ⟨(-3), 1⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-142969015), (-103989741)⟩, ⟨(-19959873), (-16582697)⟩, ⟨(-634147), (-589938)⟩, ⟨6062, 7341⟩, ⟨99, 117⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1288686750, 1327666025⟩, ⟨(-19959873), (-16582697)⟩, ⟨(-634147), (-589938)⟩, ⟨6062, 7341⟩, ⟨99, 117⟩⟩
...
def j70 : Jet := ⟨⟨(-111), (-80)⟩, ⟨(-16), (-13)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11724, 11756⟩, ⟨(-16), (-13)⟩, ⟨(-1), 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨8835, 12059⟩, ⟨1455, 1714⟩, ⟨56, 61⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-843342), (-840117)⟩, ⟨1455, 1714⟩, ⟨56, 61⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-865027), (-633099)⟩, ⟨(-122480), (-103757)⟩, ⟨(-4190), (-4081)⟩, ⟨11, 18⟩, ⟨(-3), 1⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34926367, 35158296⟩, ⟨(-122480), (-103757)⟩, ⟨(-4190), (-4081)⟩, ⟨11, 18⟩, ⟨(-3), 1⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨26319986, 36062319⟩, ⟨4261034, 5073571⟩, ⟨160531, 167886⟩, ⟨(-1247), (-1035)⟩, ⟨(-25), (-16)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-689507897), (-679765563)⟩, ⟨4261034, 5073571⟩, ⟨160531, 167886⟩, ⟨(-1247), (-1035)⟩, ⟨(-25), (-16)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-707237156), (-512261129)⟩, ⟨(-97822830), (-80172826)⟩, ⟨(-2952205), (-2641732)⟩, ⟨41180, 50374⟩, ⟨631, 738⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3587730140, 3782706167⟩, ⟨(-97822830), (-80172826)⟩, ⟨(-2952205), (-2641732)⟩, ⟨41180, 50374⟩, ⟨631, 738⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1118699605, 1344626772⟩, ⟨73010109, 81649453⟩, ⟨(-2086168), (-1711729)⟩, ⟨(-40613), (-35241)⟩, ⟨523, 651⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4876599783, 5141619730⟩, ⟨103357428, 140191089⟩, ⟨5596291, 8053284⟩, ⟨122320, 278967⟩, ⟨3628, 12192⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1270195993, 1609688518⟩, ⟨109818529, 141634404⟩, ⟨717215, 3242813⟩, ⟨10277, 159229⟩, ⟨(-1622), 6823⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1384595451), (-1186796100)⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2910371845, 3108171196⟩, ⟨(-98899676), (-98899675)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨375648462, 603286812⟩, ⟨64955584, 106164848⟩, ⟨3232181, 7101370⟩, ⟨42754, 333230⟩, ⟨(-573), 18067⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4670615758, 4898254108⟩, ⟨64955584, 106164848⟩, ⟨3232181, 7101370⟩, ⟨42754, 333230⟩, ⟨(-573), 18067⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4478854980, 4586702651⟩, ⟨30412055, 50903027⟩, ⟨1230839, 3301655⟩, ⟨(-17026), 151418⟩, ⟨(-3214), 8688⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3034978507, 3319293509⟩, ⟨(-85009500), (-66296657)⟩, ⟨(-338093), 1689040⟩, ⟨(-88349), 81236⟩, ⟨(-5813), 6681⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6362992183, 7423490888⟩, ⟨530249348, 530249355⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨9426770154, 12830881627⟩, ⟨1571128356, 1832983110⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨9426770154, 12830881627⟩, ⟨1571128356, 1832983110⟩, ⟨65463681, 65463684⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12830881627), (-9426770154)⟩, ⟨(-1832983110), (-1571128356)⟩, ⟨(-65463684), (-65463681)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6415440814), (-4713385077)⟩, ⟨(-916491555), (-785564178)⟩, ⟨(-32731842), (-32731840)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨964382501, 1433363047⟩, ⟨(-305861498), (-176388851)⟩, ⟨5207435, 25283948⟩, ⟨(-902255), 1236490⟩, ⟨(-162308), 28290⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨681467392, 1107750614⟩, ⟨(-264750226), (-139528816)⟩, ⟨6289647, 26157822⟩, ⟨(-1347503), 926408⟩, ⟨(-159629), 58189⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1285695775, 1285695776⟩) (by decide +kernel)
  · exact Interval.containsRat_sound (q := radius) (a := ⟨98899675, 98899676⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4527749067, 4527749074⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified952
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1186796100, 1384595451⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4478854980, 4586702651⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified953
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (40528309 / 4294967296)

theorem envelope_integral : (∫ s in ((110529 / 400000) : ℝ)..(257901 / 800000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (110529 / 400000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (257901 / 800000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((110529 / 400000) : ℝ)..(257901 / 800000), prawitzNormalCorrection
