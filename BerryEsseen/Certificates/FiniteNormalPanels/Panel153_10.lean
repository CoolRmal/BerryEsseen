...
namespace FiniteNormalPanel153_10

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (39963 / 400000)
def radius : Rat := (13321 / 400000)

def j0 : Jet := ⟨⟨429099445, 429099446⟩, ⟨143033148, 143033149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨1348055664, 1348055668⟩, ⟨449351886, 449351891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨423112435, 423112439⟩, ⟨282074954, 282074960⟩, ⟨47012492, 47012494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨105, 107⟩, ⟨70, 71⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94582), (-94579)⟩, ⟨70, 71⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-9318), (-9317)⟩, ⟨(-6206), (-6204)⟩, ⟨(-1031), (-1028)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5103738, 5103740⟩, ⟨(-6206), (-6204)⟩, ⟨(-1031), (-1028)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨502787, 502788⟩, ⟨334579, 334581⟩, ⟨55355, 55358⟩, ⟨(-136), (-133)⟩, ⟨(-12), (-9)⟩⟩
...
def j16 : Jet := ⟨⟨(-142662790), (-142662788)⟩, ⟨334579, 334581⟩, ⟨55355, 55358⟩, ⟨(-136), (-133)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-14054217), (-14054216)⟩, ⟨(-9336518), (-9336516)⟩, ⟨(-1534154), (-1534151)⟩, ⟨7283, 7286⟩, ⟨594, 598⟩⟩
...
def j19 : Jet := ⟨⟨1417601548, 1417601550⟩, ⟨(-9336518), (-9336516)⟩, ⟨(-1534154), (-1534151)⟩, ⟨7283, 7286⟩, ⟨594, 598⟩⟩
...
def j25 : Jet := ⟨⟨1164, 1166⟩, ⟨775, 777⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851013), (-851010)⟩, ⟨775, 777⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-83837), (-83836)⟩, ⟨(-55815), (-55813)⟩, ⟨(-9254), (-9250)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35707557, 35707559⟩, ⟨(-55815), (-55813)⟩, ⟨(-9254), (-9250)⟩, ⟨15, 18⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨3517677, 3517679⟩, ⟨2339619, 2339621⟩, ⟨386275, 386278⟩, ⟨(-1218), (-1215)⟩, ⟨(-103), (-98)⟩⟩
...
def j33 : Jet := ⟨⟨(-712310206), (-712310203)⟩, ⟨2339619, 2339621⟩, ⟨386275, 386278⟩, ⟨(-1218), (-1215)⟩, ⟨(-103), (-98)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-70172202), (-70172200)⟩, ⟨(-46550984), (-46550981)⟩, ⟨(-7605203), (-7605199)⟩, ⟨50857, 50861⟩, ⟨4137, 4141⟩⟩
...
def j36 : Jet := ⟨⟨4224795094, 4224795096⟩, ⟨(-46550984), (-46550981)⟩, ⟨(-7605203), (-7605199)⟩, ⟨50857, 50861⟩, ⟨4137, 4141⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨444940709, 444940712⟩, ⟨145383128, 145383133⟩, ⟨(-1458337), (-1458334)⟩, ⟨(-158223), (-158220)⟩, ⟨947, 951⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4366305028, 4366305031⟩, ⟨48110210, 48110215⟩, ⟨8390038, 8390045⟩, ⟨126484, 126492⟩, ⟨11636, 11645⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨452331000, 452331005⟩, ⟨152781902, 152781909⟩, ⟨1015125, 1015132⟩, ⟨119914, 119924⟩, ⟨1826, 1836⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-429099446), (-429099445)⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3865867850, 3865867851⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨47637925, 47637927⟩, ⟨32180914, 32180918⟩, ⟨5648622, 5648628⟩, ⟨97476, 97482⟩, ⟨9153, 9160⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4342605221, 4342605223⟩, ⟨32180914, 32180918⟩, ⟨5648622, 5648628⟩, ⟨97476, 97482⟩, ⟨9153, 9160⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4318720574, 4318720576⟩, ⟨16001958, 16001961⟩, ⟨2779131, 2779135⟩, ⟨38171, 38176⟩, ⟨3514, 3520⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3887247997, 3887248001⟩, ⟨(-129420951), (-129420945)⟩, ⟨1968568, 1968574⟩, ⟨(-58196), (-58190)⟩, ⟨1890, 1898⟩⟩
...
def j47 : Jet := ⟨⟨5405221925, 5405221940⟩, ⟨1801740637, 1801740651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨6802478818, 6802478857⟩, ⟨4534985866, 4534985916⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨6802478818, 6802478857⟩, ⟨4534985866, 4534985916⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-6802478857), (-6802478818)⟩, ⟨(-4534985916), (-4534985866)⟩, ⟨(-755830988), (-755830975)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-3401239429), (-3401239409)⟩, ⟨(-2267492958), (-2267492933)⟩, ⟨(-377915494), (-377915487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1945523659, 1945523675⟩, ⟨(-1027123359), (-1027123338)⟩, ⟨99943465, 99943479⟩, ⟨42663149, 42663155⟩, ⟨(-10027945), (-10027943)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1760835979, 1760835997⟩, ⟨(-988243788), (-988243763)⟩, ⟨122298067, 122298086⟩, ⟨35104402, 35104418⟩, ⟨(-10300994), (-10300982)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨286066296, 572132594⟩, ⟨143033148, 143033149⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨898703773, 1797407555⟩, ⟨449351886, 449351891⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨188049970, 752199888⟩, ⟨188049968, 376099946⟩, ⟨47012492, 47012494⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨47, 189⟩, ⟨47, 95⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94640), (-94497)⟩, ⟨47, 95⟩, ⟨11, 12⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-16575), (-4137)⟩, ⟨(-8286), (-4120)⟩, ⟨(-1034), (-1022)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5096481, 5108920⟩, ⟨(-8286), (-4120)⟩, ⟨(-1034), (-1022)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨223143, 894752⟩, ⟨221691, 447196⟩, ⟨54877, 55698⟩, ⟨(-182), (-88)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142942434), (-142270824)⟩, ⟨221691, 447196⟩, ⟨54877, 55698⟩, ⟨(-182), (-88)⟩, ⟨(-12), (-9)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-25034250), (-6229156)⟩, ⟨(-12507419), (-6150836)⟩, ⟨(-1552533), (-1508374)⟩, ⟨4796, 9770⟩, ⟨581, 607⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1406621515, 1425426610⟩, ⟨(-12507419), (-6150836)⟩, ⟨(-1552533), (-1508374)⟩, ⟨4796, 9770⟩, ⟨581, 607⟩⟩
...
def j72 : Jet := ⟨⟨517, 2073⟩, ⟨515, 1037⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851660), (-850103)⟩, ⟨515, 1037⟩, ⟨127, 130⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-149156), (-37220)⟩, ⟨(-74556), (-37038)⟩, ⟨(-9296), (-9191)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35642238, 35754175⟩, ⟨(-74556), (-37038)⟩, ⟨(-9296), (-9191)⟩, ⟨9, 24⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨1560552, 6261815⟩, ⟨1547494, 3129287⟩, ⟨381980, 389341⟩, ⟨(-1632), (-802)⟩, ⟨(-103), (-96)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-714267331), (-709566067)⟩, ⟨1547494, 3129287⟩, ⟨381980, 389341⟩, ⟨(-1632), (-802)⟩, ⟨(-103), (-96)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-125093341), (-31067495)⟩, ⟨(-62478916), (-30519446)⟩, ⟨(-7733855), (-7424660)⟩, ⟨33376, 68313⟩, ⟨4019, 4223⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4169873955, 4263899801⟩, ⟨(-62478916), (-30519446)⟩, ⟨(-7733855), (-7424660)⟩, ⟨33376, 68313⟩, ⟨4019, 4223⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨294329613, 596529003⟩, ⟨141930556, 147845216⟩, ⟨(-1958285), (-959138)⟩, ⟨(-161428), (-153721)⟩, ⟨622, 1278⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4326261154, 4423813351⟩, ⟨30965805, 66283794⟩, ⟨7754889, 9197994⟩, ⟨38550, 226128⟩, ⟨8333, 16032⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨296474148, 614424462⟩, ⟨145086740, 161486643⟩, ⟨(-462310), 2593067⟩, ⟨62413, 186273⟩, ⟨(-4216), 8489⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-572132594), (-286066296)⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3722834702, 4008901000⟩, ⟨(-143033149), (-143033148)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨20465096, 87897624⟩, ⟨20030172, 46203540⟩, ⟨4768848, 6813655⟩, ⟨(-26150), 248290⟩, ⟨2728, 18004⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4315432392, 4382864920⟩, ⟨20030172, 46203540⟩, ⟨4768848, 6813655⟩, ⟨(-26150), 248290⟩, ⟨2728, 18004⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4305187683, 4338693524⟩, ⟨9914151, 23046928⟩, ⟨2299180, 3387325⟩, ⟨(-31178), 118556⟩, ⟨(-608), 8535⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3731693631, 4049714843⟩, ⟨(-135895856), (-121861624)⟩, ⟨1225385, 2831547⟩, ⟨(-141909), 34092⟩, ⟨(-4517), 9006⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3603481275, 7206962578⟩, ⟨1801740637, 1801740651⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨3023323905, 12093295716⟩, ⟨3023323904, 6046647880⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨3023323905, 12093295716⟩, ⟨3023323904, 6046647880⟩, ⟨755830975, 755830988⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-12093295716), (-3023323905)⟩, ⟨(-6046647880), (-3023323904)⟩, ⟨(-755830988), (-755830975)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-6046647858), (-1511661952)⟩, ⟨(-3023323940), (-1511661952)⟩, ⟨(-377915494), (-377915487)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1050849644, 3020682250⟩, ⟨(-2126326078), (-369858328)⟩, ⟨(-200702866), 655919760⟩, ⟨(-132209586), 171823809⟩, ⟨(-59094951), 32096278⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨913033476, 2848194387⟩, ⟨(-2100484559), (-351168264)⟩, ⟨(-178448426), 687735178⟩, ⟨(-146915522), 168281116⟩, ⟨(-61309498), 34955734⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨429099445, 429099446⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4318720574, 4318720576⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3088
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨286066296, 572132594⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4305187683, 4338693524⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3089
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (120461349 / 4294967296)

theorem envelope_integral : (∫ s in ((13321 / 200000) : ℝ)..(13321 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 17 ≤ n) :
    (∫ s in ((13321 / 200000) : ℝ)..(13321 / 100000), prawitzNormalCorrection
