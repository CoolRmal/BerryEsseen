...
namespace FiniteNormalPanel128_17
...
def j2 : Jet := ⟨⟨506359971, 506359975⟩, ⟨506359971, 506359975⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨59697874, 59697876⟩, ⟨119395748, 119395752⟩, ⟨59697874, 59697876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1316), (-1315)⟩, ⟨(-2632), (-2630)⟩, ⟨(-1316), (-1313)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111740, 5111742⟩, ⟨(-2632), (-2630)⟩, ⟨(-1316), (-1313)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨71050, 71051⟩, ⟨142064, 142066⟩, ⟨70957, 70960⟩, ⟨(-74), (-71)⟩, ⟨(-19), (-16)⟩⟩
...
def j16 : Jet := ⟨⟨(-143094527), (-143094525)⟩, ⟨142064, 142066⟩, ⟨70957, 70960⟩, ⟨(-74), (-71)⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1988942), (-1988941)⟩, ⟨(-3975910), (-3975908)⟩, ⟨(-1984007), (-1984004)⟩, ⟨3944, 3948⟩, ⟨982, 986⟩⟩
...
def j19 : Jet := ⟨⟨1429666823, 1429666825⟩, ⟨(-3975910), (-3975908)⟩, ⟨(-1984007), (-1984004)⟩, ⟨3944, 3948⟩, ⟨982, 986⟩⟩
...
def j22 : Jet := ⟨⟨(-2), (-1)⟩, ⟨(-4), (-2)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11833, 11835⟩, ⟨(-4), (-2)⟩, ⟨(-2), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨164, 165⟩, ⟨327, 330⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852013), (-852011)⟩, ⟨327, 330⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-11843), (-11842)⟩, ⟨(-23682), (-23680)⟩, ⟨(-11832), (-11829)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
...
def j30 : Jet := ⟨⟨35779551, 35779553⟩, ⟨(-23682), (-23680)⟩, ⟨(-11832), (-11829)⟩, ⟨7, 10⟩, ⟨0, 3⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨497317, 497318⟩, ⟨994305, 994307⟩, ⟨496493, 496496⟩, ⟨(-659), (-656)⟩, ⟨(-165), (-162)⟩⟩
...
def j33 : Jet := ⟨⟨(-715330566), (-715330564)⟩, ⟨994305, 994307⟩, ⟨496493, 496496⟩, ⟨(-659), (-656)⟩, ⟨(-165), (-162)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-9942734), (-9942733)⟩, ⟨(-19871648), (-19871645)⟩, ⟨(-9908193), (-9908190)⟩, ⟨27612, 27615⟩, ⟨6879, 6882⟩⟩
...
def j36 : Jet := ⟨⟨4285024562, 4285024563⟩, ⟨(-19871648), (-19871645)⟩, ⟨(-9908193), (-9908190)⟩, ⟨27612, 27615⟩, ⟨6879, 6882⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨168552168, 168552170⟩, ⟨168083423, 168083426⟩, ⟨(-702652), (-702650)⟩, ⟨(-233443), (-233440)⟩, ⟨579, 583⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4304933099, 4304933101⟩, ⟨19963970, 19963975⟩, ⟨10046805, 10046811⟩, ⟨65008, 65015⟩, ⟨16488, 16496⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨168943267, 168943270⟩, ⟨169256902, 169256907⟩, ⟨471283, 471289⟩, ⟨158480, 158487⟩, ⟨1041, 1050⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-161179386), (-161179385)⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4133787910, 4133787911⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨6645412, 6645413⟩, ⟨13315496, 13315500⟩, ⟨6707182, 6707188⟩, ⟨49610, 49616⟩, ⟨12621, 12628⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4301612708, 4301612709⟩, ⟨13315496, 13315500⟩, ⟨6707182, 6707188⟩, ⟨49610, 49616⟩, ⟨12621, 12628⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4298288717, 4298288719⟩, ⟨6652603, 6652606⟩, ⟨3345851, 3345855⟩, ⟨19606, 19611⟩, ⟨4972, 4978⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4136984686, 4136984690⟩, ⟨(-154901084), (-154901078)⟩, ⟨2970633, 2970639⟩, ⟨(-106692), (-106685)⟩, ⟨4049, 4057⟩⟩
...
def j47 : Jet := ⟨⟨1250899194, 1250899203⟩, ⟨1250899194, 1250899203⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨364321468, 364321475⟩, ⟨728642936, 728642950⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨364321468, 364321475⟩, ⟨728642936, 728642950⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-364321475), (-364321468)⟩, ⟨(-728642950), (-728642936)⟩, ⟨(-364321475), (-364321468)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-182160738), (-182160734)⟩, ⟨(-364321475), (-364321468)⟩, ⟨(-182160738), (-182160734)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4116615474, 4116615479⟩, ⟨(-349192746), (-349192738)⟩, ⟨(-159786202), (-159786196)⟩, ⟨14391413, 14391415⟩, ⟨3083285, 3083286⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3965193213, 3965193223⟩, ⟨(-484817021), (-484817005)⟩, ⟨(-138467595), (-138467580)⟩, ⟨19281069, 19281084⟩, ⟨2352869, 2352885⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 322358771⟩, ⟨161179385, 161179386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1012719947⟩, ⟨506359971, 506359975⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 238791502⟩, ⟨0, 238791504⟩, ⟨59697874, 59697876⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 60⟩, ⟨0, 60⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94626)⟩, ⟨0, 60⟩, ⟨14, 15⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-5265), 0⟩, ⟨(-5265), 4⟩, ⟨(-1317), (-1310)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5107791, 5113057⟩, ⟨(-5265), 4⟩, ⟨(-1317), (-1310)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 284276⟩, ⟨(-293), 284277⟩, ⟨70628, 71070⟩, ⟨(-148), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142881300)⟩, ⟨(-293), 284277⟩, ⟨70628, 71070⟩, ⟨(-148), 2⟩, ⟨(-19), (-16)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7959717), 0⟩, ⟨(-7959734), 15806⟩, ⟨(-1989947), (-1966219)⟩, ⟨(-14), 7905⟩, ⟨970, 989⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1423696048, 1431655766⟩, ⟨(-7959734), 15806⟩, ⟨(-1989947), (-1966219)⟩, ⟨(-14), 7905⟩, ⟨970, 989⟩⟩
...
def j72 : Jet := ⟨⟨0, 659⟩, ⟨(-1), 659⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851517)⟩, ⟨(-1), 659⟩, ⟨162, 165⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-47380), 0⟩, ⟨(-47381), 37⟩, ⟨(-11846), (-11788)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35744014, 35791395⟩, ⟨(-47381), 37⟩, ⟨(-11846), (-11788)⟩, ⟨(-2), 20⟩, ⟨0, 3⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1989930⟩, ⟨(-2635), 1989933⟩, ⟨493529, 497486⟩, ⟨(-1319), 3⟩, ⟨(-166), (-160)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-713837952)⟩, ⟨(-2635), 1989933⟩, ⟨493529, 497486⟩, ⟨(-1319), 3⟩, ⟨(-166), (-160)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-39798584), 0⟩, ⟨(-39798732), 110637⟩, ⟨(-9949794), (-9783689)⟩, ⟨(-111), 55321⟩, ⟨6775, 6916⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4255168712, 4294967296⟩, ⟨(-39798732), 110637⟩, ⟨(-9949794), (-9783689)⟩, ⟨(-111), 55321⟩, ⟨6775, 6916⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 337573316⟩, ⟨165971393, 168790386⟩, ⟨(-1407637), 1864⟩, ⟨(-234612), (-229945)⟩, ⟨(-2), 1166⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4335138117⟩, ⟨(-112717), 40546690⟩, ⟨9782644, 10516021⟩, ⟨(-56900), 193283⟩, ⟨14252, 19563⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 340730639⟩, ⟨165962533, 173555948⟩, ⟨(-1425233), 2421883⟩, ⟨123463, 198560⟩, ⟨(-7902), 10323⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-322358771), 0⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3972608525, 4294967296⟩, ⟨(-161179386), (-161179385)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 27031026⟩, ⟨0, 27537268⟩, ⟨6186849, 7397518⟩, ⟨(-115186), 227240⟩, ⟨7482, 19052⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4321998322⟩, ⟨0, 27537268⟩, ⟨6186849, 7397518⟩, ⟨(-115186), 227240⟩, ⟨7482, 19052⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4308461611⟩, ⟨0, 13768634⟩, ⟨3061735, 3698759⟩, ⟨(-69451), 113620⟩, ⟨1777, 8658⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3972608525, 4308461611⟩, ⟨(-161685794), (-147410751)⟩, ⟨2315233, 3698759⟩, ⟨(-208257), (-1279)⟩, ⟨(-2621), 11265⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2501798398⟩, ⟨1250899194, 1250899203⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1457285887⟩, ⟨0, 1457285892⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1457285887⟩, ⟨0, 1457285892⟩, ⟨364321468, 364321475⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1457285887), 0⟩, ⟨(-1457285892), 0⟩, ⟨(-364321475), (-364321468)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-728642944), 0⟩, ⟨(-728642946), 0⟩, ⟨(-182160738), (-182160734)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3624779776, 4294967296⟩, ⟨(-728642946), 0⟩, ⟨(-182160738), (-91929052)⟩, ⟨0, 30903644⟩, ⟨638771, 3862956⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3352721929, 4308461611⟩, ⟨(-892618057), (-124408749)⟩, ⟨(-180779105), (-53900496)⟩, ⟨2319412, 37857177⟩, ⟨(-732048), 3872134⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4298288717, 4298288719⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified2584
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4308461611⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified2585
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (147100737 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 13 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(15011 / 200000), prawitzNormalCorrection
