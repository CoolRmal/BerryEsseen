...
namespace FiniteNormalPanel9_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (326151 / 800000)
def radius : Rat := (46593 / 800000)

def j0 : Jet := ⟨⟨1751009848, 1751009849⟩, ⟨250144264, 250144265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨5500959674, 5500959679⟩, ⟨785851382, 785851386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨7045585041, 7045585055⟩, ⟨2013024296, 2013024310⟩, ⟨143787449, 143787452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1763, 1766⟩, ⟨503, 505⟩, ⟨35, 37⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-92924), (-92920)⟩, ⟨503, 505⟩, ⟨35, 37⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-152436), (-152428)⟩, ⟨(-42728), (-42722)⟩, ⟨(-2819), (-2812)⟩, ⟨32, 35⟩, ⟨1, 2⟩⟩
...
def j13 : Jet := ⟨⟨4960620, 4960629⟩, ⟨(-42728), (-42722)⟩, ⟨(-2819), (-2812)⟩, ⟨32, 35⟩, ⟨1, 2⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨8137540, 8137556⟩, ⟨2254918, 2254934⟩, ⟨141420, 141438⟩, ⟨(-2701), (-2689)⟩, ⟨(-80), (-73)⟩⟩
...
def j16 : Jet := ⟨⟨(-135028037), (-135028020)⟩, ⟨2254918, 2254934⟩, ⟨141420, 141438⟩, ⟨(-2701), (-2689)⟩, ⟨(-80), (-73)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-221503787), (-221503758)⟩, ⟨(-59587767), (-59587730)⟩, ⟨(-3231632), (-3231591)⟩, ⟨137341, 137372⟩, ⟨3336, 3357⟩⟩
...
def j19 : Jet := ⟨⟨1210151978, 1210152008⟩, ⟨(-59587767), (-59587730)⟩, ⟨(-3231632), (-3231591)⟩, ⟨137341, 137372⟩, ⟨3336, 3357⟩⟩
...
def j22 : Jet := ⟨⟨(-178), (-175)⟩, ⟨(-51), (-50)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11657, 11661⟩, ⟨(-51), (-50)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨19122, 19130⟩, ⟨5379, 5384⟩, ⟨359, 364⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-833055), (-833046)⟩, ⟨5379, 5384⟩, ⟨359, 364⟩, ⟨(-4), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1366567), (-1366552)⟩, ⟨(-381625), (-381610)⟩, ⟨(-24781), (-24766)⟩, ⟨341, 349⟩, ⟨8, 13⟩⟩
...
def j30 : Jet := ⟨⟨34424827, 34424843⟩, ⟨(-381625), (-381610)⟩, ⟨(-24781), (-24766)⟩, ⟨341, 349⟩, ⟨8, 13⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨56471453, 56471480⟩, ⟨15508672, 15508706⟩, ⟨932960, 932996⟩, ⟨(-23833), (-23809)⟩, ⟨(-658), (-643)⟩⟩
...
def j33 : Jet := ⟨⟨(-659356430), (-659356402)⟩, ⟨15508672, 15508706⟩, ⟨932960, 932996⟩, ⟨(-23833), (-23809)⟩, ⟨(-658), (-643)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-1081626818), (-1081626769)⟩, ⟨(-283595374), (-283595301)⟩, ⟨(-13274747), (-13274668)⟩, ⟨917376, 917437⟩, ⟨18982, 19022⟩⟩
...
def j36 : Jet := ⟨⟨3213340478, 3213340527⟩, ⟨(-283595374), (-283595301)⟩, ⟨(-13274747), (-13274668)⟩, ⟨917376, 917437⟩, ⟨18982, 19022⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1549952949, 1549952990⟩, ⟨145102314, 145102371⟩, ⟨(-15041840), (-15041778)⟩, ⟨(-415388), (-415340)⟩, ⟨29401, 29435⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5740675138, 5740675226⟩, ⟨506646737, 506646884⟩, ⟨68429780, 68429950⟩, ⟨6493311, 6493453⟩, ⟨677125, 677226⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨2071674996, 2071675084⟩, ⟨376781413, 376781552⟩, ⟨21706388, 21706549⟩, ⟨2325542, 2325676⟩, ⟨214369, 214468⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1751009849), (-1751009848)⟩, ⟨(-250144265), (-250144264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2543957447, 2543957448⟩, ⟨(-250144265), (-250144264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨999271238, 999271324⟩, ⟨363480594, 363480744⟩, ⟨53993749, 53993933⟩, ⟨6051886, 6052050⟩, ⟨724524, 724648⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨5294238534, 5294238620⟩, ⟨363480594, 363480744⟩, ⟨53993749, 53993933⟩, ⟨6051886, 6052050⟩, ⟨724524, 724648⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4768498858, 4768498897⟩, ⟨163692736, 163692806⟩, ⟨21506353, 21506440⟩, ⟨1987181, 1987261⟩, ⟨209570, 209632⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2824435518, 2824435543⟩, ⟨(-180766289), (-180766243)⟩, ⟨3204780, 3204838⟩, ⟨(-75533), (-75478)⟩, ⟨8389, 8433⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨14629656585, 14629656590⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value119

def j47 : Jet := ⟨⟨5964346405, 5964346411⟩, ⟨852049486, 852049491⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨8282584147, 8282584164⟩, ⟨2366452612, 2366452630⟩, ⟨169032329, 169032332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨8282584147, 8282584164⟩, ⟨2366452612, 2366452630⟩, ⟨169032329, 169032332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-8282584164), (-8282584147)⟩, ⟨(-2366452630), (-2366452612)⟩, ⟨(-169032332), (-169032329)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-4141292082), (-4141292073)⟩, ⟨(-1183226315), (-1183226306)⟩, ⟨(-84516166), (-84516164)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1637587689, 1637587701⟩, ⟨(-451141238), (-451141230)⟩, ⟨29918377, 29918381⟩, ⟨3170938, 3170940⟩, ⟨(-512759), (-512757)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1076902456, 1076902475⟩, ⟨(-365599990), (-365599962)⟩, ⟨39884293, 39884326⟩, ⟨460618, 460651⟩, ⟨(-437208), (-437179)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1500865584, 2001154113⟩, ⟨250144264, 250144265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4715108292, 6286811061⟩, ⟨785851382, 785851386⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨5176348193, 9202396804⟩, ⟨1725449396, 2300599212⟩, ⟨143787449, 143787452⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨1295, 2306⟩, ⟨431, 577⟩, ⟨35, 37⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93392), (-92380)⟩, ⟨431, 577⟩, ⟨35, 37⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-200102), (-111337)⟩, ⟨(-49507), (-35875)⟩, ⟨(-2912), (-2702)⟩, ⟨28, 40⟩, ⟨1, 2⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4912954, 5001720⟩, ⟨(-49507), (-35875)⟩, ⟨(-2912), (-2702)⟩, ⟨28, 40⟩, ⟨1, 2⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨5921153, 10716686⟩, ⟨1867643, 2635936⟩, ⟨131717, 149781⟩, ⟨(-3185), (-2200)⟩, ⟨(-86), (-63)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-137244424), (-132448890)⟩, ⟨1867643, 2635936⟩, ⟨131717, 149781⟩, ⟨(-3185), (-2200)⟩, ⟨(-86), (-63)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-294059899), (-159629055)⟩, ⟨(-71264070), (-47561928)⟩, ⟨(-3685638), (-2701279)⟩, ⟨108615, 165827⟩, ⟨2517, 4057⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1137595866, 1272026711⟩, ⟨(-71264070), (-47561928)⟩, ⟨(-3685638), (-2701279)⟩, ⟨108615, 165827⟩, ⟨2517, 4057⟩⟩
...
def j70 : Jet := ⟨⟨(-232), (-128)⟩, ⟨(-58), (-42)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11603, 11708⟩, ⟨(-58), (-42)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨13984, 25086⟩, ⟨4536, 6222⟩, ⟨347, 373⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-838193), (-827090)⟩, ⟨4536, 6222⟩, ⟨347, 373⟩, ⟨(-5), (-2)⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1795913), (-996819)⟩, ⟨(-443513), (-318941)⟩, ⟨(-25822), (-23556)⟩, ⟨279, 407⟩, ⟨5, 13⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨33995481, 34794576⟩, ⟨(-443513), (-318941)⟩, ⟨(-25822), (-23556)⟩, ⟨279, 407⟩, ⟨5, 13⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨40971778, 74550858⟩, ⟨12706988, 18253324⟩, ⟨845209, 1008339⟩, ⟨(-28344), (-19267)⟩, ⟨(-747), (-541)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-674856105), (-641277024)⟩, ⟨12706988, 18253324⟩, ⟨845209, 1008339⟩, ⟨(-28344), (-19267)⟩, ⟨(-747), (-541)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1445946672), (-772875073)⟩, ⟨(-346172050), (-218515452)⟩, ⟨(-16469389), (-9530890)⟩, ⟨704228, 1127985⟩, ⟨11512, 25366⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨2849020624, 3522092223⟩, ⟨(-346172050), (-218515452)⟩, ⟨(-16469389), (-9530890)⟩, ⟨704228, 1127985⟩, ⟨11512, 25366⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1248877425, 1861944701⟩, ⟨103832580, 180528573⟩, ⟨(-18434106), (-11667941)⟩, ⟨(-555124), (-251521)⟩, ⟨22636, 36281⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨5237439256, 6474766774⟩, ⟨324937943, 786720627⟩, ⟨34332268, 133019799⟩, ⟨935703, 19415865⟩, ⟨(-182510), 3026608⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1522926532, 2806926539⟩, ⟨221101681, 613208561⟩, ⟨(-9951323), 76506039⟩, ⟨(-3111412), 12818832⟩, ⟨(-701507), 2070587⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-2001154113), (-1500865584)⟩, ⟨(-250144265), (-250144264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2293813183, 2794101712⟩, ⟨(-250144265), (-250144264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨540005327, 1834434596⟩, ⟨156798220, 801510822⟩, ⟨(-1624999), 187549369⟩, ⟨(-6908432), 38601310⟩, ⟨(-1982643), 7729603⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4834972623, 6129401892⟩, ⟨156798220, 801510822⟩, ⟨(-1624999), 187549369⟩, ⟨(-6908432), 38601310⟩, ⟨(-1982643), 7729603⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4556978087, 5130846000⟩, ⟨65626918, 377713334⟩, ⟨(-16419509), 87910399⟩, ⟨(-10542223), 19551894⟩, ⟨(-3402875), 4674779⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2433745286, 3337884693⟩, ⟨(-263777518), (-19681745)⟩, ⟨(-32680250), 53368137⟩, ⟨(-11978282), 13675827⟩, ⟨(-3352476), 3655183⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5112296918, 6816395898⟩, ⟨852049486, 852049491⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨6085163861, 10818069112⟩, ⟨2028387952, 2704517290⟩, ⟨169032329, 169032332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨6085163861, 10818069112⟩, ⟨2028387952, 2704517290⟩, ⟨169032329, 169032332⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-10818069112), (-6085163861)⟩, ⟨(-2704517290), (-2028387952)⟩, ⟨(-169032332), (-169032329)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-5409034556), (-3042581930)⟩, ⟨(-1352258645), (-1014193976)⟩, ⟨(-84516166), (-84516164)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1219029366, 2114963669⟩, ⟨(-665890497), (-287856031)⟩, ⟨(-7631652), 80838895⟩, ⟨(-4707690), 9536510⟩, ⟨(-1546009), 445639⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨690763577, 1643669060⟩, ⟨(-647396214), (-168699976)⟩, ⟨(-20704607), 130000880⟩, ⟨(-22796026), 19681216⟩, ⟨(-6173443), 5296969⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1751009848, 1751009849⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4768498858, 4768498897⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar119 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified184
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar119 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1500865584, 2001154113⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4556978087, 5130846000⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified185
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((139779 / 400000) : ℝ)..(46593 / 100000), prawitzNormalCorrection
      ((240857 / 100000) * sqrt n) s) ≤ (upper : ℝ) :=
