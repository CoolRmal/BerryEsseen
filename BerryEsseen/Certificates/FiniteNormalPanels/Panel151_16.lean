...
namespace FiniteNormalPanel151_16
...
def j2 : Jet := ⟨⟨475781373, 475781378⟩, ⟨475781373, 475781378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨52705387, 52705389⟩, ⟨105410774, 105410778⟩, ⟨52705387, 52705389⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-1162), (-1161)⟩, ⟨(-2324), (-2322)⟩, ⟨(-1162), (-1159)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111894, 5111896⟩, ⟨(-2324), (-2322)⟩, ⟨(-1162), (-1159)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨62730, 62731⟩, ⟨125431, 125433⟩, ⟨62657, 62661⟩, ⟨(-58), (-55)⟩, ⟨(-15), (-12)⟩⟩
...
def j16 : Jet := ⟨⟨(-143102847), (-143102845)⟩, ⟨125431, 125433⟩, ⟨62657, 62661⟩, ⟨(-58), (-55)⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-1756077), (-1756076)⟩, ⟨(-3510615), (-3510612)⟩, ⟨(-1752231), (-1752228)⟩, ⟨3075, 3078⟩, ⟨765, 768⟩⟩
...
def j19 : Jet := ⟨⟨1429899688, 1429899690⟩, ⟨(-3510615), (-3510612)⟩, ⟨(-1752231), (-1752228)⟩, ⟨3075, 3078⟩, ⟨765, 768⟩⟩
...
def j25 : Jet := ⟨⟨145, 146⟩, ⟨289, 291⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-852032), (-852030)⟩, ⟨289, 291⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-10456), (-10455)⟩, ⟨(-20909), (-20907)⟩, ⟨(-10448), (-10445)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
...
def j30 : Jet := ⟨⟨35780938, 35780940⟩, ⟨(-20909), (-20907)⟩, ⟨(-10448), (-10445)⟩, ⟨5, 8⟩, ⟨(-1), 2⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨439083, 439084⟩, ⟨877909, 877911⟩, ⟨438440, 438443⟩, ⟨(-514), (-511)⟩, ⟨(-130), (-126)⟩⟩
...
def j33 : Jet := ⟨⟨(-715388800), (-715388798)⟩, ⟨877909, 877911⟩, ⟨438440, 438443⟩, ⟨(-514), (-511)⟩, ⟨(-130), (-126)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-8778844), (-8778842)⟩, ⟨(-17546914), (-17546911)⟩, ⟨(-8751918), (-8751914)⟩, ⟨21526, 21529⟩, ⟨5365, 5368⟩⟩
...
def j36 : Jet := ⟨⟨4286188452, 4286188454⟩, ⟨(-17546914), (-17546911)⟩, ⟨(-8751918), (-8751914)⟩, ⟨21526, 21529⟩, ⟨5365, 5368⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨158399258, 158399261⟩, ⟨158010364, 158010368⟩, ⟨(-583000), (-582998)⟩, ⟨(-193766), (-193764)⟩, ⟨424, 427⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4303764118, 4303764121⟩, ⟨17618862, 17618867⟩, ⟨8859929, 8859936⟩, ⟨50627, 50634⟩, ⟨12817, 12826⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨158723686, 158723690⟩, ⟨158983783, 158983789⟩, ⟨390751, 390758⟩, ⟨131265, 131271⟩, ⟨760, 769⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-151445916), (-151445915)⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4143521380, 4143521381⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨5865750, 5865752⟩, ⟨11750726, 11750728⟩, ⟨5913870, 5913874⟩, ⟨38628, 38634⟩, ⟨9807, 9814⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4300833046, 4300833048⟩, ⟨11750726, 11750728⟩, ⟨5913870, 5913874⟩, ⟨38628, 38634⟩, ⟨9807, 9814⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4297899170, 4297899172⟩, ⟨5871355, 5871357⟩, ⟨2950907, 2950910⟩, ⟨15269, 15274⟩, ⟨3865, 3871⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4146349872, 4146349876⟩, ⟨(-145884975), (-145884970)⟩, ⟨2639822, 2639827⟩, ⟨(-89323), (-89316)⟩, ⟨3189, 3197⟩⟩
...
def j47 : Jet := ⟨⟨1267493968, 1267493978⟩, ⟨1267493968, 1267493978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨374051965, 374051972⟩, ⟨748103930, 748103944⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨374051965, 374051972⟩, ⟨748103930, 748103944⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-374051972), (-374051965)⟩, ⟨(-748103944), (-748103930)⟩, ⟨(-374051972), (-374051965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-187025986), (-187025982)⟩, ⟨(-374051972), (-374051965)⟩, ⟨(-187025986), (-187025982)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4111954900, 4111954905⟩, ⟨(-358113284), (-358113276)⟩, ⟨(-163462464), (-163462458)⟩, ⟨15141475, 15141477⟩, ⟨3229346, 3229348⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3969670197, 3969670206⟩, ⟨(-485390288), (-485390274)⟩, ⟨(-143115037), (-143115022)⟩, ⟨19864159, 19864172⟩, ⟨2513328, 2513342⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 302891832⟩, ⟨151445915, 151445916⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 951562755⟩, ⟨475781373, 475781378⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 210821554⟩, ⟨0, 210821554⟩, ⟨52705387, 52705389⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-4648), 0⟩, ⟨(-4648), 3⟩, ⟨(-1162), (-1157)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5108408, 5113057⟩, ⟨(-4648), 3⟩, ⟨(-1162), (-1157)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 250979⟩, ⟨(-229), 250980⟩, ⟨62400, 62746⟩, ⟨(-116), 2⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142914597)⟩, ⟨(-229), 250980⟩, ⟨62400, 62746⟩, ⟨(-116), 2⟩, ⟨(-15), (-12)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-7027386), 0⟩, ⟨(-7027398), 12320⟩, ⟨(-1756859), (-1738366)⟩, ⟨(-9), 6161⟩, ⟨758, 771⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1424628379, 1431655766⟩, ⟨(-7027398), 12320⟩, ⟨(-1756859), (-1738366)⟩, ⟨(-9), 6161⟩, ⟨758, 771⟩⟩
...
def j72 : Jet := ⟨⟨0, 581⟩, ⟨(-1), 581⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851595)⟩, ⟨(-1), 581⟩, ⟨143, 146⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-41830), 0⟩, ⟨(-41831), 29⟩, ⟨(-10459), (-10413)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35749564, 35791395⟩, ⟨(-41831), 29⟩, ⟨(-10459), (-10413)⟩, ⟨(-2), 16⟩, ⟨(-1), 2⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 1756847⟩, ⟨(-2054), 1756849⟩, ⟨436130, 439214⟩, ⟨(-1029), 2⟩, ⟨(-131), (-125)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-714071035)⟩, ⟨(-2054), 1756849⟩, ⟨436130, 439214⟩, ⟨(-1029), 2⟩, ⟨(-131), (-125)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-35136926), 0⟩, ⟨(-35137027), 86237⟩, ⟨(-8784333), (-8654875)⟩, ⟨(-77), 43121⟩, ⟨5293, 5391⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4259830370, 4294967296⟩, ⟨(-35137027), 86237⟩, ⟨(-8784333), (-8654875)⟩, ⟨(-77), 43121⟩, ⟨5293, 5391⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 317187586⟩, ⟨156258380, 158596523⟩, ⟨(-1167709), 1365⟩, ⟨(-194621), (-191205)⟩, ⟨(-1), 854⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4330394047⟩, ⟨(-87667), 35719070⟩, ⟨8654157, 9224472⟩, ⟨(-44205), 149825⟩, ⟨11282, 14924⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 319803887⟩, ⟨156251905, 162542585⟩, ⟨(-1180579), 2001582⟩, ⟨105649, 160509⟩, ⟨(-5762), 7505⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-302891832), 0⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3992075464, 4294967296⟩, ⟨(-151445916), (-151445915)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 23812644⟩, ⟨0, 24205890⟩, ⟨5508666, 6449486⟩, ⟨(-89358), 175404⟩, ⟨6275, 14201⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4318779940⟩, ⟨0, 24205890⟩, ⟨5508666, 6449486⟩, ⟨(-89358), 175404⟩, ⟨6275, 14201⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4306857161⟩, ⟨0, 12102945⟩, ⟨2729723, 3224743⟩, ⟨(-53767), 87702⟩, ⟨1673, 6386⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3992075464, 4306857161⟩, ⟨(-151865168), (-139342970)⟩, ⟨2110451, 3224743⟩, ⟨(-167476), (-8551)⟩, ⟨(-1538), 8282⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2534987955⟩, ⟨1267493968, 1267493978⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1496207885⟩, ⟨0, 1496207886⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1496207885⟩, ⟨0, 1496207886⟩, ⟨374051965, 374051972⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1496207885), 0⟩, ⟨(-1496207886), 0⟩, ⟨(-374051972), (-374051965)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-748103943), 0⟩, ⟨(-748103943), 0⟩, ⟨(-187025986), (-187025982)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3608392628, 4294967296⟩, ⟨(-748103943), 0⟩, ⟨(-187025986), (-91975885)⟩, ⟨0, 32576472⟩, ⟨584007, 4072059⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3353919758, 4306857161⟩, ⟨(-902040106), (-117068212)⟩, ⟨(-185770652), (-55812665)⟩, ⟨2254835, 39272498⟩, ⟨(-751008), 4075592⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4297899170, 4297899172⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified3048
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4306857161⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified3049
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (276644275 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 15 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(28209 / 400000), prawitzNormalCorrection
