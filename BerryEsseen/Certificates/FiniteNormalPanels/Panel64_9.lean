...
namespace FiniteNormalPanel64_9

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (282919 / 800000)
def radius : Rat := (40417 / 800000)

def j0 : Jet := ⟨⟨1518909815, 1518909816⟩, ⟨216987116, 216987117⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4771795916, 4771795920⟩, ⟨681685129, 681685133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨5301562199, 5301562209⟩, ⟨1514732052, 1514732064⟩, ⟨108195146, 108195148⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1326, 1329⟩, ⟨379, 380⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93361), (-93357)⟩, ⟨379, 380⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-115242), (-115236)⟩, ⟨(-32460), (-32454)⟩, ⟨(-2186), (-2181)⟩, ⟨18, 20⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨4997814, 4997821⟩, ⟨(-32460), (-32454)⟩, ⟨(-2186), (-2181)⟩, ⟨18, 20⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨6169132, 6169142⟩, ⟨1722541, 1722552⟩, ⟨111753, 111764⟩, ⟨(-1567), (-1561)⟩, ⟨(-50), (-44)⟩⟩
...
def j16 : Jet := ⟨⟨(-136996445), (-136996434)⟩, ⟨1722541, 1722552⟩, ⟨111753, 111764⟩, ⟨(-1567), (-1561)⟩, ⟨(-50), (-44)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-169103774), (-169103759)⟩, ⟨(-46189118), (-46189099)⟩, ⟨(-2705656), (-2705636)⟩, ⟨80869, 80885⟩, ⟨2200, 2212⟩⟩
...
def j19 : Jet := ⟨⟨1262551991, 1262552007⟩, ⟨(-46189118), (-46189099)⟩, ⟨(-2705656), (-2705636)⟩, ⟨80869, 80885⟩, ⟨2200, 2212⟩⟩
...
def j22 : Jet := ⟨⟨(-134), (-132)⟩, ⟨(-39), (-37)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11701, 11704⟩, ⟨(-39), (-37)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨14443, 14448⟩, ⟨4077, 4083⟩, ⟨276, 280⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-837734), (-837728)⟩, ⟨4077, 4083⟩, ⟨276, 280⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-1034071), (-1034063)⟩, ⟨(-290417), (-290406)⟩, ⟨(-19327), (-19317)⟩, ⟨195, 202⟩, ⟨2, 8⟩⟩
...
def j30 : Jet := ⟨⟨34757323, 34757332⟩, ⟨(-290417), (-290406)⟩, ⟨(-19327), (-19317)⟩, ⟨195, 202⟩, ⟨2, 8⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨42903262, 42903274⟩, ⟨11899593, 11899612⟩, ⟨749295, 749315⟩, ⟨(-13893), (-13877)⟩, ⟨(-417), (-404)⟩⟩
...
def j33 : Jet := ⟨⟨(-672924621), (-672924608)⟩, ⟨11899593, 11899612⟩, ⟨749295, 749315⟩, ⟨(-13893), (-13877)⟩, ⟨(-417), (-404)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-830635368), (-830635350)⟩, ⟨(-222635938), (-222635906)⟩, ⟨(-11830138), (-11830102)⟩, ⟨546872, 546902⟩, ⟨13460, 13485⟩⟩
...
def j36 : Jet := ⟨⟨3464331928, 3464331946⟩, ⟨(-222635938), (-222635906)⟩, ⟨(-11830138), (-11830102)⟩, ⟨546872, 546902⟩, ⟨13460, 13485⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1402720910, 1402720930⟩, ⟨149071651, 149071678⟩, ⟨(-10337046), (-10337019)⟩, ⟨(-339588), (-339565)⟩, ⟨15279, 15296⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5324762280, 5324762309⟩, ⟨342196789, 342196845⟩, ⟨40174489, 40174556⟩, ⟨2909761, 2909820⟩, ⟨249435, 249485⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1739048257, 1739048292⟩, ⟨296574480, 296574536⟩, ⟨12182424, 12182488⟩, ⟨1100107, 1100163⟩, ⟨77650, 77697⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1518909816), (-1518909815)⟩, ⟨(-216987117), (-216987116)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2776057480, 2776057481⟩, ⟨(-216987117), (-216987116)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨704147117, 704147146⟩, ⟨240168222, 240168274⟩, ⟨30344366, 30344429⟩, ⟨2573306, 2573364⟩, ⟨249362, 249414⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4999114413, 4999114442⟩, ⟨240168222, 240168274⟩, ⟨30344366, 30344429⟩, ⟨2573306, 2573364⟩, ⟨249362, 249414⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4633684593, 4633684608⟩, ⟨111306092, 111306118⟩, ⟨12726266, 12726297⟩, ⟨886899, 886929⟩, ⟨76784, 76812⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨2994987828, 2994987840⟩, ⟨(-162156709), (-162156688)⟩, ⟨2602312, 2602336⟩, ⟨(-69701), (-69678)⟩, ⟨4820, 4841⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨19712009850, 19712009855⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value340

def j47 : Jet := ⟨⟨6971127641, 6971127648⟩, ⟨995875375, 995875381⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨11314782450, 11314782474⟩, ⟨3232794978, 3232795002⟩, ⟨230913926, 230913930⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨11314782450, 11314782474⟩, ⟨3232794978, 3232795002⟩, ⟨230913926, 230913930⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-11314782474), (-11314782450)⟩, ⟨(-3232795002), (-3232794978)⟩, ⟨(-230913930), (-230913926)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-5657391237), (-5657391225)⟩, ⟨(-1616397501), (-1616397489)⟩, ⟨(-115456965), (-115456963)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1150538266, 1150538284⟩, ⟨(-433001483), (-433001472)⟩, ⟨50550695, 50550701⟩, ⟨1418407, 1418409⟩, ⟨(-812904), (-812903)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨802299031, 802299048⟩, ⟨(-345381368), (-345381352)⟩, ⟨52295358, 52295375⟩, ⟨(-1200485), (-1200470)⟩, ⟨(-581469), (-581456)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1301922699, 1735896933⟩, ⟨216987116, 216987117⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨4090110786, 5453481053⟩, ⟨681685129, 681685133⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3895025290, 6924489419⟩, ⟨1298341758, 1731122360⟩, ⟨108195146, 108195148⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨974, 1735⟩, ⟨324, 434⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93713), (-92951)⟩, ⟨324, 434⟩, ⟨27, 28⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-151088), (-84295)⟩, ⟨(-37479), (-27398)⟩, ⟨(-2240), (-2120)⟩, ⟨16, 23⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4961968, 5028762⟩, ⟨(-37479), (-27398)⟩, ⟨(-2240), (-2120)⟩, ⟨16, 23⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4499915, 8107538⟩, ⟨1439546, 2002039⟩, ⟨106278, 116477⟩, ⟨(-1834), (-1292)⟩, ⟨(-53), (-41)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-138665662), (-135058038)⟩, ⟨1439546, 2002039⟩, ⟨106278, 116477⟩, ⟨(-1834), (-1292)⟩, ⟨(-53), (-41)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-223561402), (-122481601)⟩, ⟨(-54584854), (-37599445)⟩, ⟨(-2961601), (-2407538)⟩, ⟨65433, 96211⟩, ⟨1851, 2508⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1208094363, 1309174165⟩, ⟨(-54584854), (-37599445)⟩, ⟨(-2961601), (-2407538)⟩, ⟨65433, 96211⟩, ⟨1851, 2508⟩⟩
...
def j70 : Jet := ⟨⟨(-175), (-97)⟩, ⟨(-44), (-32)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11660, 11739⟩, ⟨(-44), (-32)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨10574, 18927⟩, ⟨3453, 4703⟩, ⟨270, 286⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-841603), (-833249)⟩, ⟨3453, 4703⟩, ⟨270, 286⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1356861), (-755657)⟩, ⟨(-336085), (-244302)⟩, ⟨(-19914), (-18632)⟩, ⟨160, 235⟩, ⟨2, 8⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34434533, 35035738⟩, ⟨(-336085), (-244302)⟩, ⟨(-19914), (-18632)⟩, ⟨160, 235⟩, ⟨2, 8⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨31228032, 56485785⟩, ⟨9867496, 13899895⟩, ⟨699876, 791844⟩, ⟨(-16349), (-11407)⟩, ⟨(-453), (-361)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-684599851), (-659342097)⟩, ⟨9867496, 13899895⟩, ⟨699876, 791844⟩, ⟨(-16349), (-11407)⟩, ⟨(-453), (-361)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1103734697), (-597944982)⟩, ⟨(-266985028), (-176905119)⟩, ⟨(-13628269), (-9730475)⟩, ⟨433782, 658971⟩, ⟨10309, 16173⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3191232599, 3697022314⟩, ⟨(-266985028), (-176905119)⟩, ⟨(-13628269), (-9730475)⟩, ⟨433782, 658971⟩, ⟨10309, 16173⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1150472039, 1662307537⟩, ⟨122436902, 171982374⟩, ⟨(-12424011), (-8260383)⟩, ⟨(-407745), (-259954)⟩, ⟨12147, 18456⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4989622054, 5780444860⟩, ⟨238756925, 483603807⟩, ⟨24557252, 65144872⟩, ⟨773155, 6837165⟩, ⟨(-11422), 801645⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1336545836, 2237241031⟩, ⟨206194126, 418637154⟩, ⟨(-3336749), 34981864⟩, ⟨(-1040531), 4493619⟩, ⟨(-202626), 547206⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1735896933), (-1301922699)⟩, ⟨(-216987117), (-216987116)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2559070363, 2993044597⟩, ⟨(-216987117), (-216987116)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨415918131, 1165374981⟩, ⟨128330616, 436134738⟩, ⟨6422817, 77249202⟩, ⟨(-1734500), 11500912⟩, ⟨(-441120), 1731003⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4710885427, 5460342277⟩, ⟨128330616, 436134738⟩, ⟨6422817, 77249202⟩, ⟨(-1734500), 11500912⟩, ⟨(-441120), 1731003⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4498121701, 4842725628⟩, ⟨56907601, 208218515⟩, ⟨(-1752861), 36520169⟩, ⟨(-2518605), 5571882⟩, ⟨(-616776), 950116⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2680115852, 3374762316⟩, ⟨(-210753298), (-82148972)⟩, ⟨(-11740981), 22574859⟩, ⟨(-3600192), 3971449⟩, ⟨(-711314), 789354⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨5975252265, 7967003028⟩, ⟨995875375, 995875381⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8312901395, 14778491401⟩, ⟨2770967124, 3694622860⟩, ⟨230913926, 230913930⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8312901395, 14778491401⟩, ⟨2770967124, 3694622860⟩, ⟨230913926, 230913930⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-14778491401), (-8312901395)⟩, ⟨(-3694622860), (-2770967124)⟩, ⟨(-230913930), (-230913926)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7389245701), (-4156450697)⟩, ⟨(-1847311430), (-1385483562)⟩, ⟨(-115456965), (-115456963)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨768742745, 1631818200⟩, ⟨(-701862484), (-247983363)⟩, ⟨(-3868794), 130274006⟩, ⟨(-14233237), 13132944⟩, ⟨(-3163163), 1582468⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨479705542, 1282198022⟩, ⟨(-631560137), (-169448453)⟩, ⟨(-2757608), 145379852⟩, ⟨(-22633183), 13936584⟩, ⟨(-4405257), 3514813⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1518909815, 1518909816⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4633684593, 4633684608⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar340 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1270
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar340 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1301922699, 1735896933⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4498121701, 4842725628⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1271
    (by decide +kernel) (by decide +kernel)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((121251 / 400000) : ℝ)..(40417 / 100000), prawitzNormalCorrection
      ((23421 / 12500) * sqrt n) s) ≤ (upper : ℝ) :=
