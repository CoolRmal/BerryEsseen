...
namespace FiniteNormalPanel75_8

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (269297 / 800000)
def radius : Rat := (38471 / 800000)

def j0 : Jet := ⟨⟨1445777259, 1445777260⟩, ⟨206539608, 206539609⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨4542043215, 4542043219⟩, ⟨648863315, 648863319⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨4803332632, 4803332641⟩, ⟨1372380748, 1372380760⟩, ⟨98027196, 98027198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨1202, 1204⟩, ⟨343, 344⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93485), (-93482)⟩, ⟨343, 344⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-104551), (-104546)⟩, ⟨(-29489), (-29485)⟩, ⟨(-1999), (-1995)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5008505, 5008511⟩, ⟨(-29489), (-29485)⟩, ⟨(-1999), (-1995)⟩, ⟨14, 16⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨5601326, 5601334⟩, ⟨1567399, 1567408⟩, ⟨102653, 102661⟩, ⟨(-1298), (-1291)⟩, ⟨(-42), (-37)⟩⟩
...
def j16 : Jet := ⟨⟨(-137564251), (-137564242)⟩, ⟨1567399, 1567408⟩, ⟨102653, 102661⟩, ⟨(-1298), (-1291)⟩, ⟨(-42), (-37)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-153846773), (-153846762)⟩, ⟨(-42203300), (-42203285)⟩, ⟨(-2524094), (-2524078)⟩, ⟨67121, 67136⟩, ⟨1880, 1891⟩⟩
...
def j19 : Jet := ⟨⟨1277808992, 1277809004⟩, ⟨(-42203300), (-42203285)⟩, ⟨(-2524094), (-2524078)⟩, ⟨67121, 67136⟩, ⟨1880, 1891⟩⟩
...
def j25 : Jet := ⟨⟨13100, 13104⟩, ⟨3703, 3706⟩, ⟨251, 256⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-839077), (-839072)⟩, ⟨3703, 3706⟩, ⟨251, 256⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-938393), (-938387)⟩, ⟨(-263972), (-263965)⟩, ⟨(-17688), (-17678)⟩, ⟨161, 167⟩, ⟨2, 6⟩⟩
...
def j30 : Jet := ⟨⟨34853001, 34853008⟩, ⟨(-263972), (-263965)⟩, ⟨(-17688), (-17678)⟩, ⟨161, 167⟩, ⟨2, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨38978307, 38978316⟩, ⟨10841442, 10841454⟩, ⟨691345, 691361⟩, ⟨(-11497), (-11485)⟩, ⟨(-351), (-342)⟩⟩
...
def j33 : Jet := ⟨⟨(-676849576), (-676849566)⟩, ⟨10841442, 10841454⟩, ⟨691345, 691361⟩, ⟨(-11497), (-11485)⟩, ⟨(-351), (-342)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-756963543), (-756963530)⟩, ⟨(-204150632), (-204150611)⟩, ⟨(-11210872), (-11210847)⟩, ⟨455491, 455512⟩, ⟨11712, 11729⟩⟩
...
def j36 : Jet := ⟨⟨3538003753, 3538003766⟩, ⟨(-204150632), (-204150611)⟩, ⟨(-11210872), (-11210847)⟩, ⟨455491, 455512⟩, ⟨11712, 11729⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1351317312, 1351317327⟩, ⟨148414206, 148414227⟩, ⟨(-9045173), (-9045152)⟩, ⟨(-310347), (-310326)⟩, ⟨12128, 12143⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨5213884804, 5213884824⟩, ⟨300852638, 300852673⟩, ⟨33881057, 33881102⟩, ⟨2237040, 2237081⟩, ⟨180419, 180454⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1640434562, 1640434588⟩, ⟨274824432, 274824472⟩, ⟨10075598, 10075645⟩, ⟨864266, 864312⟩, ⟨55693, 55732⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1445777260), (-1445777259)⟩, ⟨(-206539609), (-206539608)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨2849190036, 2849190037⟩, ⟨(-206539609), (-206539608)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨626553211, 626553232⟩, ⟨209934774, 209934810⟩, ⟨25281957, 25282002⟩, ⟨1949624, 1949670⟩, ⟨176782, 176823⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4921520507, 4921520528⟩, ⟨209934774, 209934810⟩, ⟨25281957, 25282002⟩, ⟨1949624, 1949670⟩, ⟨176782, 176823⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4597583019, 4597583030⟩, ⟨98058369, 98058387⟩, ⟨10763234, 10763257⟩, ⟨681087, 681111⟩, ⟨55446, 55469⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3049938876, 3049938885⟩, ⟨(-156042184), (-156042168)⟩, ⟨2424594, 2424612⟩, ⟨(-65774), (-65755)⟩, ⟨4027, 4045⟩⟩
...
def j47 : Jet := ⟨⟨7221379920, 7221379927⟩, ⟨1031625700, 1031625706⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨12141728761, 12141728786⟩, ⟨3469065350, 3469065376⟩, ⟨247790381, 247790385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨12141728761, 12141728786⟩, ⟨3469065350, 3469065376⟩, ⟨247790381, 247790385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-12141728786), (-12141728761)⟩, ⟨(-3469065376), (-3469065350)⟩, ⟨(-247790385), (-247790381)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-6070864393), (-6070864380)⟩, ⟨(-1734532688), (-1734532675)⟩, ⟨(-123895193), (-123895190)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨1044941259, 1044941271⟩, ⟨(-422002001), (-422001992)⟩, ⟨55070249, 55070254⟩, ⟨702129, 702132⟩, ⟨(-865185), (-865183)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨742032883, 742032895⟩, ⟨(-337635920), (-337635907)⟩, ⟨55028254, 55028267⟩, ⟨(-1756419), (-1756406)⟩, ⟨(-601368), (-601355)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨1239237651, 1652316869⟩, ⟨206539608, 206539609⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨3893179900, 5190906538⟩, ⟨648863315, 648863319⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨3528979079, 6273740597⟩, ⟨1176326356, 1568435154⟩, ⟨98027196, 98027198⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨883, 1572⟩, ⟨294, 393⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-93804), (-93114)⟩, ⟨294, 393⟩, ⟨24, 25⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-137022), (-76507)⟩, ⟨(-34015), (-24927)⟩, ⟨(-2042), (-1944)⟩, ⟨12, 19⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨4976034, 5036550⟩, ⟨(-34015), (-24927)⟩, ⟨(-2042), (-1944)⟩, ⟨12, 19⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨4088580, 7356985⟩, ⟨1313173, 1818766⟩, ⟨98166, 106529⟩, ⟨(-1514), (-1072)⟩, ⟨(-44), (-35)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-139076997), (-135808591)⟩, ⟨1313173, 1818766⟩, ⟨98166, 106529⟩, ⟨(-1514), (-1072)⟩, ⟨(-44), (-35)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-203152421), (-111587735)⟩, ⟨(-49709132), (-34539204)⟩, ⟨(-2733941), (-2279873)⟩, ⟨54645, 79535⟩, ⟨1622, 2111⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1228503344, 1320068031⟩, ⟨(-49709132), (-34539204)⟩, ⟨(-2733941), (-2279873)⟩, ⟨54645, 79535⟩, ⟨1622, 2111⟩⟩
...
def j70 : Jet := ⟨⟨(-158), (-87)⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11677, 11749⟩, ⟨(-40), (-29)⟩, ⟨(-3), (-2)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨9594, 17162⟩, ⟨3139, 4268⟩, ⟨246, 261⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-842583), (-835014)⟩, ⟨3139, 4268⟩, ⟨246, 261⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-1230778), (-686092)⟩, ⟨(-305116), (-222462)⟩, ⟨(-18170), (-17117)⟩, ⟨133, 194⟩, ⟨1, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34560616, 35105303⟩, ⟨(-305116), (-222462)⟩, ⟨(-18170), (-17117)⟩, ⟨133, 194⟩, ⟨1, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨28396884, 51278986⟩, ⟨9019939, 12636961⟩, ⟨650837, 726243⟩, ⟨(-13491), (-9481)⟩, ⟨(-379), (-310)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-687430999), (-664548896)⟩, ⟨9019939, 12636961⟩, ⟨650837, 726243⟩, ⟨(-13491), (-9481)⟩, ⟨(-379), (-310)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-1004143564), (-546029571)⟩, ⟨(-243624619), (-163550806)⟩, ⟨(-12684557), (-9491887)⟩, ⟨364415, 545843⟩, ⟨9373, 13726⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3290823732, 3748937725⟩, ⟨(-243624619), (-163550806)⟩, ⟨(-12684557), (-9491887)⟩, ⟨364415, 545843⟩, ⟨9373, 13726⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨1113578799, 1595437009⟩, ⟨125517904, 168121511⟩, ⟨(-10814068), (-7284613)⟩, ⟨(-363498), (-248305)⟩, ⟨9725, 14568⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4920525606, 5605509616⟩, ⟨214662388, 414984289⟩, ⟨21823055, 52328479⟩, ⟨679391, 4928642⟩, ⟨3944, 528793⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨1275770597, 2082259743⟩, ⟨199456127, 373573984⟩, ⟨(-2182253), 27336753⟩, ⟨(-705366), 3230611⟩, ⟨(-134861), 358946⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1652316869), (-1239237651)⟩, ⟨(-206539609), (-206539608)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2642650427, 3055729645⟩, ⟨(-206539609), (-206539608)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨378952970, 1009508418⟩, ⟨118492292, 362227704⟩, ⟨7146668, 58999744⟩, ⟨(-1063568), 7887966⟩, ⟨(-267362), 1084034⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4673920266, 5304475714⟩, ⟨118492292, 362227704⟩, ⟨7146668, 58999744⟩, ⟨(-1063568), 7887966⟩, ⟨(-267362), 1084034⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4480439117, 4773106925⟩, ⟨53311242, 173616481⟩, ⟨57825, 27961533⟩, ⟨(-1593277), 3780031⟩, ⟨(-361876), 581320⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2756769383, 3395910452⟩, ⟨(-196730873), (-91936232)⟩, ⟨(-8313421), 17330052⟩, ⟨(-2478201), 2686590⟩, ⟨(-439241), 490210⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨6189754219, 8253005633⟩, ⟨1031625700, 1031625706⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨8920453789, 15858584545⟩, ⟨2973484586, 3964646144⟩, ⟨247790381, 247790385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨8920453789, 15858584545⟩, ⟨2973484586, 3964646144⟩, ⟨247790381, 247790385⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-15858584545), (-8920453789)⟩, ⟨(-3964646144), (-2973484586)⟩, ⟨(-247790385), (-247790381)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-7929292273), (-4460226894)⟩, ⟨(-1982323072), (-1486742293)⟩, ⟨(-123895193), (-123895190)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨677911664, 1520389338⟩, ⟨(-701728944), (-234665335)⟩, ⟨(-3242282), 142384495⟩, ⟨(-17392780), 13993816⟩, ⟨(-3668351), 2053655⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨435124644, 1202129304⟩, ⟨(-624478837), (-165133469)⟩, ⟨(-483332), 150856836⟩, ⟨(-23982625), 13522347⟩, ⟨(-4411488), 3573392⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1445777259, 1445777260⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4597583019, 4597583030⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1502
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨1239237651, 1652316869⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4480439117, 4773106925⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1503
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (36599883 / 2147483648)

theorem envelope_integral : (∫ s in ((115413 / 400000) : ℝ)..(38471 / 100000),
...
theorem actual_correction_integral {n : ℕ} (hn : 7 ≤ n) :
    (∫ s in ((115413 / 400000) : ℝ)..(38471 / 100000), prawitzNormalCorrection
