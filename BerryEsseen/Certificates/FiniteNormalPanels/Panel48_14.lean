...
namespace FiniteNormalPanel48_14

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (36843 / 800000)
def radius : Rat := (36843 / 800000)

def j0 : Jet := ⟨⟨197799350, 197799351⟩, ⟨197799350, 197799351⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨621404984, 621404989⟩, ⟨621404984, 621404989⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨89906191, 89906194⟩, ⟨179812382, 179812388⟩, ⟨89906191, 89906194⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨22, 23⟩, ⟨45, 46⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94665), (-94663)⟩, ⟨45, 46⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-1982), (-1981)⟩, ⟨(-3964), (-3962)⟩, ⟨(-1981), (-1978)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5111074, 5111076⟩, ⟨(-3964), (-3962)⟩, ⟨(-1981), (-1978)⟩, ⟨0, 2⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨106989, 106990⟩, ⟨213896, 213898⟩, ⟨106781, 106784⟩, ⟨(-166), (-163)⟩, ⟨(-42), (-39)⟩⟩
...
def j16 : Jet := ⟨⟨(-143058588), (-143058586)⟩, ⟨213896, 213898⟩, ⟨106781, 106784⟩, ⟨(-166), (-163)⟩, ⟨(-42), (-39)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-2994634), (-2994633)⟩, ⟨(-5984791), (-5984788)⟩, ⟨(-2983445), (-2983441)⟩, ⟨8943, 8946⟩, ⟨2227, 2230⟩⟩
...
def j19 : Jet := ⟨⟨1428661131, 1428661133⟩, ⟨(-5984791), (-5984788)⟩, ⟨(-2983445), (-2983441)⟩, ⟨8943, 8946⟩, ⟨2227, 2230⟩⟩
...
def j25 : Jet := ⟨⟨247, 248⟩, ⟨494, 496⟩, ⟨245, 248⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851930), (-851928)⟩, ⟨494, 496⟩, ⟨245, 248⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-17834), (-17833)⟩, ⟨(-35657), (-35655)⟩, ⟨(-17809), (-17806)⟩, ⟨19, 22⟩, ⟨3, 6⟩⟩
...
def j30 : Jet := ⟨⟨35773560, 35773562⟩, ⟨(-35657), (-35655)⟩, ⟨(-17809), (-17806)⟩, ⟨19, 22⟩, ⟨3, 6⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨748844, 748846⟩, ⟨1496942, 1496945⟩, ⟨746978, 746982⟩, ⟨(-1493), (-1490)⟩, ⟨(-373), (-370)⟩⟩
...
def j33 : Jet := ⟨⟨(-715079039), (-715079036)⟩, ⟨1496942, 1496945⟩, ⟨746978, 746982⟩, ⟨(-1493), (-1490)⟩, ⟨(-373), (-370)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-14968691), (-14968689)⟩, ⟨(-29906046), (-29906043)⟩, ⟨(-14890385), (-14890381)⟩, ⟨62575, 62579⟩, ⟨15565, 15568⟩⟩
...
def j36 : Jet := ⟨⟨4279998605, 4279998607⟩, ⟨(-29906046), (-29906043)⟩, ⟨(-14890385), (-14890381)⟩, ⟨62575, 62579⟩, ⟨15565, 15568⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨206701724, 206701727⟩, ⟨205835831, 205835836⟩, ⟨(-1297545), (-1297541)⟩, ⟨(-430359), (-430355)⟩, ⟨1615, 1618⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4309988335, 4309988338⟩, ⟨30115592, 30115597⟩, ⟨15205145, 15205153⟩, ⟨147999, 148007⟩, ⟨37814, 37822⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨207424633, 207424638⟩, ⟨208005069, 208005077⟩, ⟨872973, 872980⟩, ⟨294862, 294872⟩, ⟨2919, 2929⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-197799351), (-197799350)⟩, ⟨(-197799351), (-197799350)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4097167945, 4097167946⟩, ⟨(-197799351), (-197799350)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨10017533, 10017534⟩, ⟨20091130, 20091134⟩, ⟨10157995, 10157999⟩, ⟨113036, 113040⟩, ⟨29017, 29024⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4304984829, 4304984830⟩, ⟨20091130, 20091134⟩, ⟨10157995, 10157999⟩, ⟨113036, 113040⟩, ⟨29017, 29024⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4299973145, 4299973146⟩, ⟨10033870, 10033873⟩, ⟨5061377, 5061380⟩, ⟨44640, 44644⟩, ⟨11407, 11413⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4101943255, 4101943258⟩, ⟨(-188458118), (-188458112)⟩, ⟨4366183, 4366188⟩, ⟨(-190512), (-190507)⟩, ⟨8824, 8833⟩⟩
...
def j47 : Jet := ⟨⟨1060498697, 1060498703⟩, ⟨1060498697, 1060498703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨261854726, 261854730⟩, ⟨523709452, 523709460⟩, ⟨261854726, 261854730⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨261854726, 261854730⟩, ⟨523709452, 523709460⟩, ⟨261854726, 261854730⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-261854730), (-261854726)⟩, ⟨(-523709460), (-523709452)⟩, ⟨(-261854730), (-261854726)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-130927365), (-130927363)⟩, ⟨(-261854730), (-261854726)⟩, ⟨(-130927365), (-130927363)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4166015395, 4166015398⟩, ⟨(-253992816), (-253992811)⟩, ⟨(-119253716), (-119253713)⟩, ⟨7585340, 7585341⟩, ⟨1702043, 1702045⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3978786698, 3978786705⟩, ⟨(-425377755), (-425377742)⟩, ⟨(-98514230), (-98514218)⟩, ⟨12034154, 12034164⟩, ⟨1191306, 1191321⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 395598701⟩, ⟨197799350, 197799351⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1242809973⟩, ⟨621404984, 621404989⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 359624771⟩, ⟨0, 359624774⟩, ⟨89906191, 89906194⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨0, 91⟩, ⟨0, 91⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94687), (-94595)⟩, ⟨0, 91⟩, ⟨22, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-7929), 0⟩, ⟨(-7929), 8⟩, ⟨(-1983), (-1970)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5105127, 5113057⟩, ⟨(-7929), 8⟩, ⟨(-1983), (-1970)⟩, ⟨0, 4⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 428125⟩, ⟨(-664), 428126⟩, ⟨106034, 107033⟩, ⟨(-333), 2⟩, ⟨(-42), (-39)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142737451)⟩, ⟨(-664), 428126⟩, ⟨106034, 107033⟩, ⟨(-333), 2⟩, ⟨(-42), (-39)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-11987493), 0⟩, ⟨(-11987549), 35848⟩, ⟨(-2996930), (-2943100)⟩, ⟨(-42), 17926⟩, ⟨2187, 2242⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1419668272, 1431655766⟩, ⟨(-11987549), 35848⟩, ⟨(-2996930), (-2943100)⟩, ⟨(-42), 17926⟩, ⟨2187, 2242⟩⟩
...
def j72 : Jet := ⟨⟨0, 992⟩, ⟨(-1), 992⟩, ⟨245, 248⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-851184)⟩, ⟨(-1), 992⟩, ⟨245, 248⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-71355), 0⟩, ⟨(-71356), 84⟩, ⟨(-17840), (-17712)⟩, ⟨(-2), 42⟩, ⟨3, 6⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35720039, 35791395⟩, ⟨(-71356), 84⟩, ⟨(-17840), (-17712)⟩, ⟨(-2), 42⟩, ⟨3, 6⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 2996874⟩, ⟨(-5975), 2996882⟩, ⟨740255, 749227⟩, ⟨(-2989), 6⟩, ⟨(-375), (-365)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-712831008)⟩, ⟨(-5975), 2996882⟩, ⟨740255, 749227⟩, ⟨(-2989), 6⟩, ⟨(-375), (-365)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-59937462), 0⟩, ⟨(-59937964), 250934⟩, ⟨(-14984867), (-14607962)⟩, ⟨(-377), 125470⟩, ⟨15212, 15685⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4235029834, 4294967296⟩, ⟨(-59937964), 250934⟩, ⟨(-14984867), (-14607962)⟩, ⟨(-377), 125470⟩, ⟨15212, 15685⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 414269992⟩, ⟨201931849, 207145371⟩, ⟨(-2601590), 5187⟩, ⟨(-433616), (-420625)⟩, ⟨(-7), 3243⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4355753040⟩, ⟨(-258088), 61646549⟩, ⟨14604360, 16284502⟩, ⟨(-130927), 448987⟩, ⟨30136, 48556⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 420133066⟩, ⟨201906955, 216023158⟩, ⟨(-2650858), 4549180⟩, ⟨196913, 408238⟩, ⟨(-22412), 29675⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-395598701), 0⟩, ⟨(-197799351), (-197799350)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3899368595, 4294967296⟩, ⟨(-197799351), (-197799350)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 41097355⟩, ⟨0, 42262708⟩, ⟨8973057, 11755278⟩, ⟨(-266660), 537488⟩, ⟨11318, 51693⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4336064651⟩, ⟨0, 42262708⟩, ⟨8973057, 11755278⟩, ⟨(-266660), 537488⟩, ⟨11318, 51693⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4315467052⟩, ⟨0, 21131354⟩, ⟨4413479, 5877639⟩, ⟨(-162249), 268744⟩, ⟨312, 24378⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3899368595, 4315467052⟩, ⟨(-198743442), (-176667996)⟩, ⟨3033785, 5877639⟩, ⟨(-432937), 65487⟩, ⟨(-12094), 31851⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 2120997401⟩, ⟨1060498697, 1060498703⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 1047418913⟩, ⟨0, 1047418916⟩, ⟨261854726, 261854730⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 1047418913⟩, ⟨0, 1047418916⟩, ⟨261854726, 261854730⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-1047418913), 0⟩, ⟨(-1047418916), 0⟩, ⟨(-261854730), (-261854726)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-523709457), 0⟩, ⟨(-523709458), 0⟩, ⟨(-130927365), (-130927363)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3801928093, 4294967296⟩, ⟨(-523709458), 0⟩, ⟨(-130927365), (-83968187)⟩, ⟨0, 15964709⟩, ⟨793172, 1995589⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3451742000, 4315467052⟩, ⟨(-724952551), (-156387457)⟩, ⟨(-128866756), (-46122545)⟩, ⟨2304293, 22164872⟩, ⟨(-217884), 2030445⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨197799350, 197799351⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4299973145, 4299973146⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified936
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 395598701⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4315467052⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified937
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (90872217 / 1073741824)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(36843 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (36843 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(36843 / 400000), prawitzNormalCorrection
