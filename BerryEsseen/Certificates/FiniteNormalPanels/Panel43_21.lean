...
namespace FiniteNormalPanel43_21
...
def j2 : Jet := ⟨⟨1759222255, 1759222259⟩, ⟨586407416, 586407420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨720578930, 720578935⟩, ⟨480385952, 480385958⟩, ⟨80064325, 80064327⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨180, 181⟩, ⟨120, 121⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94507), (-94505)⟩, ⟨120, 121⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-15856), (-15855)⟩, ⟨(-10551), (-10549)⟩, ⟨(-1746), (-1743)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5097200, 5097202⟩, ⟨(-10551), (-10549)⟩, ⟨(-1746), (-1743)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨855171, 855173⟩, ⟨568343, 568346⟩, ⟨93545, 93549⟩, ⟨(-393), (-388)⟩, ⟨(-33), (-30)⟩⟩
...
def j16 : Jet := ⟨⟨(-142310406), (-142310403)⟩, ⟨568343, 568346⟩, ⟨93545, 93549⟩, ⟨(-393), (-388)⟩, ⟨(-33), (-30)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-23875824), (-23875822)⟩, ⟨(-15821864), (-15821861)⟩, ⟨(-2573608), (-2573605)⟩, ⟨20990, 20994⟩, ⟨1693, 1696⟩⟩
...
def j19 : Jet := ⟨⟨1407779941, 1407779944⟩, ⟨(-15821864), (-15821861)⟩, ⟨(-2573608), (-2573605)⟩, ⟨20990, 20994⟩, ⟨1693, 1696⟩⟩
...
def j22 : Jet := ⟨⟨(-19), (-17)⟩, ⟨(-13), (-11)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11816, 11819⟩, ⟨(-13), (-11)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨1982, 1983⟩, ⟨1318, 1321⟩, ⟨217, 220⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850195), (-850193)⟩, ⟨1318, 1321⟩, ⟨217, 220⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-142640), (-142639)⟩, ⟨(-94873), (-94870)⟩, ⟨(-15666), (-15663)⟩, ⟨47, 50⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35648754, 35648756⟩, ⟨(-94873), (-94870)⟩, ⟨(-15666), (-15663)⟩, ⟨47, 50⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨5980893, 5980894⟩, ⟨3971344, 3971347⟩, ⟨651302, 651306⟩, ⟨(-3515), (-3510)⟩, ⟨(-288), (-284)⟩⟩
...
def j33 : Jet := ⟨⟨(-709846990), (-709846988)⟩, ⟨3971344, 3971347⟩, ⟨651302, 651306⟩, ⟨(-3515), (-3510)⟩, ⟨(-288), (-284)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-119093058), (-119093056)⟩, ⟨(-78729090), (-78729085)⟩, ⟨(-12679104), (-12679099)⟩, ⟨146288, 146292⟩, ⟨11698, 11703⟩⟩
...
def j36 : Jet := ⟨⟨4175874238, 4175874240⟩, ⟨(-78729090), (-78729085)⟩, ⟨(-12679104), (-12679099)⟩, ⟨146288, 146292⟩, ⟨11698, 11703⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨576627860, 576627863⟩, ⟨185728637, 185728641⟩, ⟨(-3214370), (-3214365)⟩, ⟨(-342788), (-342783)⟩, ⟨3558, 3562⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4417456803, 4417456807⟩, ⟨83283717, 83283724⟩, ⟨14982783, 14982792⟩, ⟨380590, 380598⟩, ⟨37368, 37378⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨593072889, 593072893⟩, ⟨202206880, 202206888⟩, ⟨2306960, 2306969⟩, ⟨284106, 284117⟩, ⟨7270, 7283⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-559977837), (-559977836)⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3734989459, 3734989460⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨81894791, 81894793⟩, ⟨55843692, 55843698⟩, ⟨10157005, 10157013⟩, ⟨295682, 295692⟩, ⟨29995, 30006⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4376862087, 4376862089⟩, ⟨55843692, 55843698⟩, ⟨10157005, 10157013⟩, ⟨295682, 295692⟩, ⟨29995, 30006⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4335721338, 4335721340⟩, ⟨27659391, 27659395⟩, ⟨4942540, 4942546⟩, ⟨114920, 114927⟩, ⟨11305, 11313⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3770429988, 3770429992⟩, ⟨(-164377291), (-164377284)⟩, ⟨3096053, 3096060⟩, ⟨(-114868), (-114859)⟩, ⟨4836, 4845⟩⟩
...
def j47 : Jet := ⟨⟨3401148382, 3401148389⟩, ⟨1133716123, 1133716130⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2693340721, 2693340733⟩, ⟨1795560474, 1795560490⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2693340721, 2693340733⟩, ⟨1795560474, 1795560490⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2693340733), (-2693340721)⟩, ⟨(-1795560490), (-1795560474)⟩, ⟨(-299260082), (-299260077)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1346670367), (-1346670360)⟩, ⟨(-897780245), (-897780237)⟩, ⟨(-149630041), (-149630038)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3138979703, 3138979714⟩, ⟨(-656143292), (-656143282)⟩, ⟨(-40780155), (-40780149)⟩, ⟨18080781, 18080784⟩, ⟨(-234502), (-234500)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2755621262, 2755621276⟩, ⟨(-696144843), (-696144826)⟩, ⟨(-8425030), (-8425015)⟩, ⟨16876406, 16876421⟩, ⟨(-906169), (-906154)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨373318557, 746637115⟩, ⟨186659278, 186659279⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1172814836, 2345629676⟩, ⟨586407416, 586407420⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨320257302, 1281029214⟩, ⟨320257300, 640514608⟩, ⟨80064325, 80064327⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨80, 321⟩, ⟨80, 161⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94607), (-94365)⟩, ⟨80, 161⟩, ⟨20, 21⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-28218), (-7036)⟩, ⟨(-14104), (-6987)⟩, ⟨(-1758), (-1727)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5084838, 5106021⟩, ⟨(-14104), (-6987)⟩, ⟨(-1758), (-1727)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨379154, 1522937⟩, ⟨374947, 760949⟩, ⟨92159, 94536⟩, ⟨(-526), (-255)⟩, ⟨(-33), (-29)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142786423), (-141642639)⟩, ⟨374947, 760949⟩, ⟨92159, 94536⟩, ⟨(-526), (-255)⟩, ⟨(-33), (-29)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-42587887), (-10561684)⟩, ⟨(-21265986), (-10334721)⟩, ⟨(-2626914), (-2498742)⟩, ⟨13703, 28266⟩, ⟨1628, 1742⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1389067878, 1421094082⟩, ⟨(-21265986), (-10334721)⟩, ⟨(-2626914), (-2498742)⟩, ⟨13703, 28266⟩, ⟨1628, 1742⟩⟩
...
def j70 : Jet := ⟨⟨(-33), (-7)⟩, ⟨(-17), (-7)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11802, 11829⟩, ⟨(-17), (-7)⟩, ⟨(-3), (-1)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨880, 3529⟩, ⟨874, 1765⟩, ⟨216, 221⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851297), (-848647)⟩, ⟨874, 1765⟩, ⟨216, 221⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-253911), (-63279)⟩, ⟨(-126891), (-62752)⟩, ⟨(-15789), (-15489)⟩, ⟨31, 66⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35537483, 35728116⟩, ⟨(-126891), (-62752)⟩, ⟨(-15789), (-15489)⟩, ⟨31, 66⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2649877, 10656370⟩, ⟨2612030, 5323506⟩, ⟨638835, 660191⟩, ⟨(-4719), (-2303)⟩, ⟨(-293), (-276)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-713178006), (-705171512)⟩, ⟨2612030, 5323506⟩, ⟨638835, 660191⟩, ⟨(-4719), (-2303)⟩, ⟨(-293), (-276)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-212714510), (-52581617)⟩, ⟨(-106162488), (-50993811)⟩, ⟨(-13052256), (-12154590)⟩, ⟨94918, 197523⟩, ⟨11116, 12116⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4082252786, 4242385679⟩, ⟨(-106162488), (-50993811)⟩, ⟨(-13052256), (-12154590)⟩, ⟨94918, 197523⟩, ⟨11116, 12116⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨379308922, 776108460⟩, ⟨178040372, 191205043⟩, ⟨(-4338171), (-2093360)⟩, ⟨(-354922), (-325724)⟩, ⟨2314, 4812⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4348200628, 4518765751⟩, ⟨52265714, 117514383⟩, ⟨13085990, 17503990⟩, ⟨96644, 729838⟩, ⟨20274, 61894⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨384010209, 816549251⟩, ⟨184862898, 222403256⟩, ⟨(-1241953), 6275251⟩, ⟨58878, 555899⟩, ⟨(-19255), 38399⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-746637115), (-373318557)⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3548330181, 3921648739⟩, ⟨(-186659279), (-186659278)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨34334100, 155240456⟩, ⟨33056940, 84565586⟩, ⟨7484586, 13902625⟩, ⟨(-118096), 861268⟩, ⟨(-4069), 81343⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4329301396, 4450207752⟩, ⟨33056940, 84565586⟩, ⟨7484586, 13902625⟩, ⟨(-118096), 861268⟩, ⟨(-4069), 81343⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4312100173, 4371898530⟩, ⟨16237622, 42114795⟩, ⟨3473593, 6893122⟩, ⟨(-126137), 415844⟩, ⟨(-11598), 40344⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3562484678, 3991893111⟩, ⟨(-176587838), (-148949694)⟩, ⟨1039434, 5588285⟩, ⟨(-414750), 228737⟩, ⟨(-28663), 42320⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2267432252, 4534864513⟩, ⟨1133716123, 1133716130⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1197040317, 4788161291⟩, ⟨1197040314, 2394080650⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1197040317, 4788161291⟩, ⟨1197040314, 2394080650⟩, ⟨299260077, 299260082⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4788161291), (-1197040317)⟩, ⟨(-2394080650), (-1197040314)⟩, ⟨(-299260082), (-299260077)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2394080646), (-598520158)⟩, ⟨(-1197040325), (-598520157)⟩, ⟨(-149630041), (-149630038)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2459673463, 3736278668⟩, ⟨(-1041329520), (-342764925)⟩, ⟨(-106283388), 59422032⟩, ⟨2440475, 34059543⟩, ⟨(-3408251), 1766353⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2040189929, 3472628323⟩, ⟨(-1121465469), (-369609892)⟩, ⟨(-86301131), 102904607⟩, ⟨(-2134575), 36142011⟩, ⟨(-4786791), 1771766⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4335721338, 4335721340⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified856
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4312100173, 4371898530⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified857
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (239305301 / 4294967296)
...
theorem actual_correction_integral {n : ℕ} (hn : 5 ≤ n) :
    (∫ s in ((2173 / 25000) : ℝ)..(2173 / 12500), prawitzNormalCorrection
