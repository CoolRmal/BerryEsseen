...
namespace FiniteNormalPanel21_17

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (43207 / 800000)
def radius : Rat := (43207 / 800000)

def j0 : Jet := ⟨⟨231965814, 231965815⟩, ⟨231965814, 231965815⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨728742097, 728742101⟩, ⟨728742097, 728742101⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨123648216, 123648218⟩, ⟨247296432, 247296436⟩, ⟨123648216, 123648218⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j11 : Jet := ⟨⟨(-2726), (-2725)⟩, ⟨(-5450), (-5448)⟩, ⟨(-2723), (-2720)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5110330, 5110332⟩, ⟨(-5450), (-5448)⟩, ⟨(-2723), (-2720)⟩, ⟨2, 4⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨147121, 147122⟩, ⟨294086, 294088⟩, ⟨146728, 146731⟩, ⟨(-314), (-311)⟩, ⟨(-79), (-76)⟩⟩
...
def j16 : Jet := ⟨⟨(-143018456), (-143018454)⟩, ⟨294086, 294088⟩, ⟨146728, 146731⟩, ⟨(-314), (-311)⟩, ⟨(-79), (-76)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-4117372), (-4117371)⟩, ⟨(-8226278), (-8226276)⟩, ⟨(-4096216), (-4096212)⟩, ⟨16904, 16908⟩, ⟨4202, 4206⟩⟩
...
def j19 : Jet := ⟨⟨1427538393, 1427538395⟩, ⟨(-8226278), (-8226276)⟩, ⟨(-4096216), (-4096212)⟩, ⟨16904, 16908⟩, ⟨4202, 4206⟩⟩
...
def j25 : Jet := ⟨⟨340, 341⟩, ⟨680, 682⟩, ⟨338, 341⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-851837), (-851835)⟩, ⟨680, 682⟩, ⟨338, 341⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-24524), (-24523)⟩, ⟨(-49029), (-49027)⟩, ⟨(-24476), (-24473)⟩, ⟨37, 40⟩, ⟨7, 10⟩⟩
...
def j30 : Jet := ⟨⟨35766870, 35766872⟩, ⟨(-49029), (-49027)⟩, ⟨(-24476), (-24473)⟩, ⟨37, 40⟩, ⟨7, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨1029695, 1029696⟩, ⟨2057979, 2057981⟩, ⟨1026166, 1026170⟩, ⟨(-2821), (-2818)⟩, ⟨(-703), (-700)⟩⟩
...
def j33 : Jet := ⟨⟨(-714798188), (-714798186)⟩, ⟨2057979, 2057981⟩, ⟨1026166, 1026170⟩, ⟨(-2821), (-2818)⟩, ⟨(-703), (-700)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-20578393), (-20578391)⟩, ⟨(-41097538), (-41097535)⟩, ⟨(-20430357), (-20430353)⟩, ⟨118249, 118253⟩, ⟨29358, 29361⟩⟩
...
def j36 : Jet := ⟨⟨4274388903, 4274388905⟩, ⟨(-41097538), (-41097535)⟩, ⟨(-20430357), (-20430353)⟩, ⟨118249, 118253⟩, ⟨29358, 29361⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨242215423, 242215426⟩, ⟨240819641, 240819646⟩, ⟨(-2090802), (-2090798)⟩, ⟨(-692152), (-692149)⟩, ⟨3580, 3583⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4315644758, 4315644761⟩, ⟨41494202, 41494207⟩, ⟨21026502, 21026509⟩, ⟨281100, 281108⟩, ⟨72408, 72416⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨243381532, 243381536⟩, ⟨244319102, 244319110⟩, ⟨1411512, 1411520⟩, ⟨479127, 479135⟩, ⟨6518, 6526⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-231965815), (-231965814)⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨4063001481, 4063001482⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨13791623, 13791624⟩, ⟨27689504, 27689506⟩, ⟨14058055, 14058061⟩, ⟨214886, 214892⟩, ⟨55711, 55716⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4308758919, 4308758920⟩, ⟨27689504, 27689506⟩, ⟨14058055, 14058061⟩, ⟨214886, 214892⟩, ⟨55711, 55716⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4301857580, 4301857582⟩, ⟨13822576, 13822578⟩, ⟨6995561, 6995566⟩, ⟨84792, 84797⟩, ⟨21849, 21854⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨4069519629, 4069519633⟩, ⟨(-219261916), (-219261911)⟩, ⟨5871198, 5871205⟩, ⟨(-297610), (-297603)⟩, ⟨16088, 16095⟩⟩
...
def j47 : Jet := ⟨⟨925347701, 925347707⟩, ⟨925347701, 925347707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨199365515, 199365518⟩, ⟨398731030, 398731036⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨199365515, 199365518⟩, ⟨398731030, 398731036⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-199365518), (-199365515)⟩, ⟨(-398731036), (-398731030)⟩, ⟨(-199365518), (-199365515)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-99682759), (-99682757)⟩, ⟨(-199365518), (-199365515)⟩, ⟨(-99682759), (-99682757)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨4196432417, 4196432420⟩, ⟨(-194791687), (-194791683)⟩, ⟨(-92874885), (-92874881)⟩, ⟨4451007, 4451008⟩, ⟨1026123, 1026124⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨3976156956, 3976156964⟩, ⟨(-398798476), (-398798465)⟩, ⟨(-72318988), (-72318974)⟩, ⟨8401650, 8401662⟩, ⟨647287, 647300⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨0, 463931630⟩, ⟨231965814, 231965815⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨0, 1457484201⟩, ⟨728742097, 728742101⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨0, 494592869⟩, ⟨0, 494592870⟩, ⟨123648216, 123648218⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j63 : Jet := ⟨⟨(-10904), 0⟩, ⟨(-10904), 15⟩, ⟨(-2726), (-2703)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5102152, 5113057⟩, ⟨(-10904), 15⟩, ⟨(-2726), (-2703)⟩, ⟨0, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨0, 588802⟩, ⟨(-1256), 588804⟩, ⟨145316, 147203⟩, ⟨(-628), 2⟩, ⟨(-79), (-75)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-143165577), (-142576774)⟩, ⟨(-1256), 588804⟩, ⟨145316, 147203⟩, ⟨(-628), 2⟩, ⟨(-79), (-75)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-16486430), 0⟩, ⟨(-16486575), 67805⟩, ⟨(-4121753), (-4019899)⟩, ⟨(-110), 33905⟩, ⟨4100, 4239⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1415169335, 1431655766⟩, ⟨(-16486575), 67805⟩, ⟨(-4121753), (-4019899)⟩, ⟨(-110), 33905⟩, ⟨4100, 4239⟩⟩
...
def j72 : Jet := ⟨⟨0, 1363⟩, ⟨(-2), 1363⟩, ⟨337, 341⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-852177), (-850813)⟩, ⟨(-2), 1363⟩, ⟨337, 341⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-98134), 0⟩, ⟨(-98135), 157⟩, ⟨(-24535), (-24297)⟩, ⟨(-2), 80⟩, ⟨7, 10⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35693260, 35791395⟩, ⟨(-98135), 157⟩, ⟨(-24535), (-24297)⟩, ⟨(-2), 80⟩, ⟨7, 10⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨0, 4121608⟩, ⟨(-11301), 4121627⟩, ⟨1013449, 1030421⟩, ⟨(-5653), 15⟩, ⟨(-708), (-687)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-715827883), (-711706274)⟩, ⟨(-11301), 4121627⟩, ⟨1013449, 1030421⟩, ⟨(-5653), 15⟩, ⟨(-708), (-687)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-82432145), 0⟩, ⟨(-82433448), 474632⟩, ⟨(-20609339), (-19896086)⟩, ⟨(-977), 237320⟩, ⟨28443, 29667⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4212535151, 4294967296⟩, ⟨(-82433448), 474632⟩, ⟨(-20609339), (-19896086)⟩, ⟨(-977), 237320⟩, ⟨28443, 29667⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨0, 485828068⟩, ⟨234522052, 242937044⟩, ⟨(-4196040), 11505⟩, ⟨(-699391), (-670564)⟩, ⟨(-19), 7192⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4294967296, 4379012498⟩, ⟨(-493390), 85691179⟩, ⟨19886616, 23100668⟩, ⟨(-251717), 872299⟩, ⟨52308, 101118⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨0, 495334897⟩, ⟨234466241, 257383924⟩, ⟨(-4306058), 7471746⟩, ⟨260618, 735238⟩, ⟨(-50781), 68256⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-463931630), 0⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3831035666, 4294967296⟩, ⟨(-231965815), (-231965814)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨0, 57126550⟩, ⟨0, 59367736⟩, ⟨11806501, 17147634⟩, ⟨(-516098), 1065108⟩, ⟨9248, 116865⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4294967296, 4352093846⟩, ⟨0, 59367736⟩, ⟨11806501, 17147634⟩, ⟨(-516098), 1065108⟩, ⟨9248, 116865⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4294967296, 4323436219⟩, ⟨0, 29683868⟩, ⟨5762476, 8573817⟩, ⟨(-317306), 532554⟩, ⟨(-7615), 56761⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3831035666, 4323436219⟩, ⟨(-233503386), (-202281946)⟩, ⟨3536838, 8573817⟩, ⟨(-780368), 221330⟩, ⟨(-36378), 73899⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨0, 1850695413⟩, ⟨925347701, 925347707⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨0, 797462071⟩, ⟨0, 797462072⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨0, 797462071⟩, ⟨0, 797462072⟩, ⟨199365515, 199365518⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-797462071), 0⟩, ⟨(-797462072), 0⟩, ⟨(-199365518), (-199365515)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-398731036), 0⟩, ⟨(-398731036), 0⟩, ⟨(-99682759), (-99682757)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨3914185012, 4294967296⟩, ⟨(-398731036), 0⟩, ⟨(-99682759), (-72336647)⟩, ⟨0, 9254229⟩, ⟨624654, 1156779⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨3491384532, 4323436219⟩, ⟨(-634877386), (-184348076)⟩, ⟨(-97120231), (-34271497)⟩, ⟨1830536, 14956329⟩, ⟨(-201861), 1251225⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨231965814, 231965815⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4301857580, 4301857582⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified426
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨0, 463931630⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4294967296, 4323436219⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified427
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (426917661 / 4294967296)

theorem envelope_integral : (∫ s in ((0 / 1) : ℝ)..(43207 / 400000),
  ...
  have hr : (center : ℝ) + (radius : ℝ) = (43207 / 400000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 3 ≤ n) :
    (∫ s in ((0 / 1) : ℝ)..(43207 / 400000), prawitzNormalCorrection
