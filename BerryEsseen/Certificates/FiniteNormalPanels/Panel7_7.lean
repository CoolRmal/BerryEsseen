...
namespace FiniteNormalPanel7_7

open IntervalJet4 IntervalJet4.Jet Real Set MeasureTheory BerryEsseen

def center : Rat := (5459 / 20000)
def radius : Rat := (5459 / 100000)

def j0 : Jet := ⟨⟨1172311323, 1172311324⟩, ⟨234462264, 234462265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f0 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j1 : Jet := ⟨⟨13493037704, 13493037705⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f1 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value2

def j2 : Jet := ⟨⟨3682924639, 3682924644⟩, ⟨736584926, 736584930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨3158099459, 3158099469⟩, ⟨1263239780, 1263239790⟩, ⟨126323977, 126323980⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨790, 792⟩, ⟨316, 317⟩, ⟨31, 32⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-93897), (-93894)⟩, ⟨316, 317⟩, ⟨31, 32⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-69043), (-69040)⟩, ⟨(-27386), (-27382)⟩, ⟨(-2648), (-2643)⟩, ⟨18, 20⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5044013, 5044017⟩, ⟨(-27386), (-27382)⟩, ⟨(-2648), (-2643)⟩, ⟨18, 20⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨3708874, 3708878⟩, ⟨1463412, 1463417⟩, ⟨138351, 138360⟩, ⟨(-1572), (-1567)⟩, ⟨(-73), (-70)⟩⟩
...
def j16 : Jet := ⟨⟨(-139456703), (-139456698)⟩, ⟨1463412, 1463417⟩, ⟨138351, 138360⟩, ⟨(-1572), (-1567)⟩, ⟨(-73), (-70)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-102542839), (-102542834)⟩, ⟨(-39941086), (-39941079)⟩, ⟨(-3569565), (-3569554)⟩, ⟨82577, 82586⟩, ⟨3552, 3559⟩⟩
...
def j19 : Jet := ⟨⟨1329112926, 1329112932⟩, ⟨(-39941086), (-39941079)⟩, ⟨(-3569565), (-3569554)⟩, ⟨82577, 82586⟩, ⟨3552, 3559⟩⟩
...
def j22 : Jet := ⟨⟨(-80), (-78)⟩, ⟨(-32), (-31)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j24 : Jet := ⟨⟨11755, 11758⟩, ⟨(-32), (-31)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f24 : ℝ → ℝ := fun t ↦ f22 t + f23 t

def j25 : Jet := ⟨⟨8643, 8646⟩, ⟨3433, 3437⟩, ⟨332, 335⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-843534), (-843530)⟩, ⟨3433, 3437⟩, ⟨332, 335⟩, ⟨(-3), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-620253), (-620249)⟩, ⟨(-245578), (-245571)⟩, ⟨(-23558), (-23551)⟩, ⟨194, 201⟩, ⟨7, 10⟩⟩
...
def j30 : Jet := ⟨⟨35171141, 35171146⟩, ⟨(-245578), (-245571)⟩, ⟨(-23558), (-23551)⟩, ⟨194, 201⟩, ⟨7, 10⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨25861421, 25861426⟩, ⟨10163993, 10164003⟩, ⟨944903, 944914⟩, ⟨(-14010), (-14000)⟩, ⟨(-631), (-624)⟩⟩
...
def j33 : Jet := ⟨⟨(-689966462), (-689966456)⟩, ⟨10163993, 10164003⟩, ⟨944903, 944914⟩, ⟨(-14010), (-14000)⟩, ⟨(-631), (-624)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-507333949), (-507333942)⟩, ⟨(-195459973), (-195459960)⟩, ⟨(-16609127), (-16609112)⟩, ⟨566557, 566570⟩, ⟨23206, 23217⟩⟩
...
def j36 : Jet := ⟨⟨3787633347, 3787633354⟩, ⟨(-195459973), (-195459960)⟩, ⟨(-16609127), (-16609112)⟩, ⟨566557, 566570⟩, ⟨23206, 23217⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨1139711295, 1139711303⟩, ⟨193692868, 193692878⟩, ⟨(-9910773), (-9910760)⟩, ⟨(-541370), (-541358)⟩, ⟨17206, 17216⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4870256001, 4870256011⟩, ⟨251328454, 251328475⟩, ⟨34326255, 34326280⟩, ⟨2144980, 2145005⟩, ⟨193766, 193786⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨1292369741, 1292369754⟩, ⟨286329474, 286329493⟩, ⟨9204853, 9204878⟩, ⟨923390, 923416⟩, ⟨56771, 56794⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-1172311324), (-1172311323)⟩, ⟨(-234462265), (-234462264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3122655972, 3122655973⟩, ⟨(-234462265), (-234462264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨388878292, 388878301⟩, ⟨172314954, 172314970⟩, ⟨24628059, 24628079⟩, ⟨1783008, 1783028⟩, ⟨177007, 177030⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4683845588, 4683845597⟩, ⟨172314954, 172314970⟩, ⟨24628059, 24628079⟩, ⟨1783008, 1783028⟩, ⟨177007, 177030⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4485193821, 4485193827⟩, ⟨82503356, 82503365⟩, ⟨11032957, 11032968⟩, ⟨650746, 650757⟩, ⟨59209, 59222⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3260960166, 3260960173⟩, ⟨(-184862668), (-184862657)⟩, ⟨3517652, 3517662⟩, ⟨(-129166), (-129156)⟩, ⟨7522, 7534⟩⟩
noncomputable def f45 : ℝ → ℝ := fun t ↦ f41 t * f44 t

def j46 : Jet := ⟨⟨16284700377, 16284700382⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f46 : ℝ → ℝ := fun _ ↦ FiniteScalarConstants.value99

def j47 : Jet := ⟨⟨4444908966, 4444908972⟩, ⟨888981790, 888981796⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨4600085251, 4600085265⟩, ⟨1840034094, 1840034110⟩, ⟨184003408, 184003412⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨4600085251, 4600085265⟩, ⟨1840034094, 1840034110⟩, ⟨184003408, 184003412⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-4600085265), (-4600085251)⟩, ⟨(-1840034110), (-1840034094)⟩, ⟨(-184003412), (-184003408)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-2300042633), (-2300042625)⟩, ⟨(-920017055), (-920017047)⟩, ⟨(-92001706), (-92001704)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨2514121740, 2514121753⟩, ⟨(-538545403), (-538545395)⟩, ⟨3825868, 3825872⟩, ⟨7417543, 7417545⟩, ⟨(-438202), (-438201)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨1908850587, 1908850602⟩, ⟨(-517103442), (-517103426)⟩, ⟨28143807, 28143821⟩, ⟨4950417, 4950431⟩, ⟨(-628240), (-628225)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨937849058, 1406773589⟩, ⟨234462264, 234462265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨2946339710, 4419509573⟩, ⟨736584926, 736584930⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨2021183652, 4547663235⟩, ⟨1010591824, 1515887748⟩, ⟨126323977, 126323980⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨505, 1140⟩, ⟨252, 380⟩, ⟨31, 32⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94182), (-93546)⟩, ⟨252, 380⟩, ⟨31, 32⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-99724), (-44022)⟩, ⟨(-33124), (-21608)⟩, ⟨(-2698), (-2582)⟩, ⟨14, 24⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5013332, 5069035⟩, ⟨(-33124), (-21608)⟩, ⟨(-2698), (-2582)⟩, ⟨14, 24⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨2359241, 5367274⟩, ⟨1144547, 1778924⟩, ⟨132904, 142792⟩, ⟨(-1922), (-1216)⟩, ⟨(-77), (-64)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-140806336), (-137798302)⟩, ⟨1144547, 1778924⟩, ⟨132904, 142792⟩, ⟨(-1922), (-1216)⟩, ⟨(-77), (-64)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-149090728), (-64846983)⟩, ⟨(-49158294), (-30539903)⟩, ⟨(-3809559), (-3273879)⟩, ⟨62898, 102148⟩, ⟨3147, 3884⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1282565037, 1366808783⟩, ⟨(-49158294), (-30539903)⟩, ⟨(-3809559), (-3273879)⟩, ⟨62898, 102148⟩, ⟨3147, 3884⟩⟩
...
def j70 : Jet := ⟨⟨(-115), (-50)⟩, ⟨(-39), (-25)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f70 : ℝ → ℝ := fun t ↦ f58 t * f69 t

def j71 : Jet := ⟨⟨11720, 11786⟩, ⟨(-39), (-25)⟩, ⟨(-4), (-3)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f71 : ℝ → ℝ := fun t ↦ f70 t + f23 t

def j72 : Jet := ⟨⟨5515, 12480⟩, ⟨2715, 4149⟩, ⟨325, 341⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-846662), (-839696)⟩, ⟨2715, 4149⟩, ⟨325, 341⟩, ⟨(-4), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-896476), (-395155)⟩, ⟨(-297549), (-193183)⟩, ⟨(-24113), (-22870)⟩, ⟨150, 244⟩, ⟨5, 11⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨34894918, 35396240⟩, ⟨(-297549), (-193183)⟩, ⟨(-24113), (-22870)⟩, ⟨150, 244⟩, ⟨5, 11⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨16421321, 37478791⟩, ⟨7895604, 12402021⟩, ⟨895781, 984861⟩, ⟨(-17193), (-10803)⟩, ⟨(-673), (-573)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-699406562), (-678349091)⟩, ⟨7895604, 12402021⟩, ⟨895781, 984861⟩, ⟨(-17193), (-10803)⟩, ⟨(-673), (-573)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-740556398), (-319226666)⟩, ⟨(-243136515), (-146481633)⟩, ⟨(-18291655), (-14531627)⟩, ⟨424795, 707289⟩, ⟨19564, 26157⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨3554410898, 3975740630⟩, ⟨(-243136515), (-146481633)⟩, ⟨(-18291655), (-14531627)⟩, ⟨424795, 707289⟩, ⟨19564, 26157⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨879837269, 1406442491⟩, ⟨169375566, 213456766⟩, ⟨(-12350651), (-7483454)⟩, ⟨(-610191), (-456357)⟩, ⟨12944, 21516⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4639825831, 5189817555⟩, ⟨170949094, 355005146⟩, ⟨23257331, 50991593⟩, ⟨558444, 4760447⟩, ⟨8280, 542081⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨950482601, 1699472762⟩, ⟨217994793, 374181196⟩, ⟨(-3418039), 26257028⟩, ⟨(-726612), 3302260⟩, ⟨(-159367), 381415⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-1406773589), (-937849058)⟩, ⟨(-234462265), (-234462264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨2888193707, 3357118238⟩, ⟨(-234462265), (-234462264)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨210343202, 672463251⟩, ⟨96485138, 296119020⟩, ⟨8359550, 53378238⟩, ⟨(-1170592), 7188410⟩, ⟨(-273624), 1037757⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4505310498, 4967430547⟩, ⟨96485138, 296119020⟩, ⟨8359550, 53378238⟩, ⟨(-1170592), 7188410⟩, ⟨(-273624), 1037757⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4398881817, 4618977349⟩, ⟨44858469, 144561910⟩, ⟨1624368, 25829918⟩, ⟨(-1420327), 3492736⟩, ⟨(-324201), 552998⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨2958072065, 3610377456⟩, ⟨(-221984448), (-127139585)⟩, ⟨(-6799313), 17740875⟩, ⟨(-2520241), 2641389⟩, ⟨(-444078), 509782⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨3555927171, 5333890767⟩, ⟨888981790, 888981796⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨2944054558, 6624122783⟩, ⟨1472027274, 2208040932⟩, ⟨184003408, 184003412⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨2944054558, 6624122783⟩, ⟨1472027274, 2208040932⟩, ⟨184003408, 184003412⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-6624122783), (-2944054558)⟩, ⟨(-2208040932), (-1472027274)⟩, ⟨(-184003412), (-184003408)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-3312061392), (-1472027279)⟩, ⟨(-1104020466), (-736013637)⟩, ⟨(-92001706), (-92001704)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨1986341596, 3048686626⟩, ⟨(-783664275), (-340392464)⟩, ⟨(-36139420), 58171314⟩, ⟨(-123319), 14287697⟩, ⟨(-1541202), 394993⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨1368052695, 2562745816⟩, ⟨(-816323993), (-293238107)⟩, ⟨(-25129079), 101995668⟩, ⟨(-8136191), 16993732⟩, ⟨(-2980451), 1400396⟩⟩
noncomputable def f95 : ℝ → ℝ := fun t ↦ f88 t * f94 t

theorem mid0 : EnclosesOn j0 f0 ({0} : Set ℝ) := by
  apply EnclosesOn.affine_midpoint
  · exact Interval.containsRat_sound (q := center) (a := ⟨1172311323, 1172311324⟩) (by decide +kernel)
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4485193821, 4485193827⟩) (by decide +kernel)

theorem mid45 : EnclosesOn j45 f45 ({0} : Set ℝ) := by
  exact (mid41.mul mid44).congr (by decide +kernel) rfl

theorem mid46 : EnclosesOn j46 f46 ({0} : Set ℝ) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar99 ({0} : Set ℝ)).congr
    (by decide +kernel) rfl
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified142
...
theorem whole46 : EnclosesOn j46 f46 (Icc (-1 : ℝ) 1) := by
  exact (EnclosesOn.constant FiniteScalarConstants.scalar99 (Icc (-1 : ℝ) 1)).congr
    (by decide +kernel) rfl
...
theorem whole56 : EnclosesOn j56 f56 (Icc (-1 : ℝ) 1) := by
  ...
  · simpa only [Rat.cast_sub] using
      Interval.containsRat_sound (q := center - radius) (a := ⟨937849058, 1406773589⟩) (by decide +kernel)
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4398881817, 4618977349⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified143
    (by decide +kernel) (by decide +kernel)
...
theorem envelope_integral : (∫ s in ((5459 / 25000) : ℝ)..(16377 / 50000),
  ...
  have hl : (center : ℝ) - (radius : ℝ) = (5459 / 25000) := by norm_num [center, radius]
  have hr : (center : ℝ) + (radius : ℝ) = (16377 / 50000) := by norm_num [center, radius]
  rw [hl, hr] at hi
  apply hi.trans
  norm_num [radius, upper, j55, j95, scale]

theorem actual_correction_integral {n : ℕ} (hn : 2 ≤ n) :
    (∫ s in ((5459 / 25000) : ℝ)..(16377 / 50000), prawitzNormalCorrection
      ((53621 / 20000) * sqrt n) s) ≤ (upper : ℝ) :=
