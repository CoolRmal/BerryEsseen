...
namespace FiniteNormalPanel62_19
...
def j2 : Jet := ⟨⟨1842761024, 1842761028⟩, ⟨614253673, 614253677⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f2 : ℝ → ℝ := fun t ↦ f0 t * f1 t

def j3 : Jet := ⟨⟨790638893, 790638898⟩, ⟨527092594, 527092600⟩, ⟨87848765, 87848767⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j8 : Jet := ⟨⟨197, 199⟩, ⟨131, 133⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j10 : Jet := ⟨⟨(-94490), (-94487)⟩, ⟨131, 133⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f10 : ℝ → ℝ := fun t ↦ f8 t + f9 t

def j11 : Jet := ⟨⟨(-17395), (-17393)⟩, ⟨(-11573), (-11570)⟩, ⟨(-1914), (-1910)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
...
def j13 : Jet := ⟨⟨5095661, 5095664⟩, ⟨(-11573), (-11570)⟩, ⟨(-1914), (-1910)⟩, ⟨4, 6⟩, ⟨0, 1⟩⟩
noncomputable def f13 : ℝ → ℝ := fun t ↦ f11 t + f12 t

def j14 : Jet := ⟨⟨938034, 938036⟩, ⟨623225, 623228⟩, ⟨102452, 102457⟩, ⟨(-472), (-468)⟩, ⟨(-40), (-37)⟩⟩
...
def j16 : Jet := ⟨⟨(-142227543), (-142227540)⟩, ⟨623225, 623228⟩, ⟨102452, 102457⟩, ⟨(-472), (-468)⟩, ⟨(-40), (-37)⟩⟩
noncomputable def f16 : ℝ → ℝ := fun t ↦ f14 t + f15 t

def j17 : Jet := ⟨⟨(-26181953), (-26181951)⟩, ⟨(-17339909), (-17339907)⟩, ⟨(-2813763), (-2813759)⟩, ⟨25233, 25236⟩, ⟨2029, 2033⟩⟩
...
def j19 : Jet := ⟨⟨1405473812, 1405473815⟩, ⟨(-17339909), (-17339907)⟩, ⟨(-2813763), (-2813759)⟩, ⟨25233, 25236⟩, ⟨2029, 2033⟩⟩
...
def j25 : Jet := ⟨⟨2174, 2176⟩, ⟨1446, 1449⟩, ⟨238, 241⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
...
def j27 : Jet := ⟨⟨(-850003), (-850000)⟩, ⟨1446, 1449⟩, ⟨238, 241⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f27 : ℝ → ℝ := fun t ↦ f25 t + f26 t

def j28 : Jet := ⟨⟨(-156473), (-156472)⟩, ⟨(-104050), (-104047)⟩, ⟨(-17166), (-17162)⟩, ⟨57, 60⟩, ⟨2, 5⟩⟩
...
def j30 : Jet := ⟨⟨35634921, 35634923⟩, ⟨(-104050), (-104047)⟩, ⟨(-17166), (-17162)⟩, ⟨57, 60⟩, ⟨2, 5⟩⟩
noncomputable def f30 : ℝ → ℝ := fun t ↦ f28 t + f29 t

def j31 : Jet := ⟨⟨6559853, 6559854⟩, ⟨4354080, 4354083⟩, ⟨712941, 712946⟩, ⟨(-4226), (-4222)⟩, ⟨(-346), (-342)⟩⟩
...
def j33 : Jet := ⟨⟨(-709268030), (-709268028)⟩, ⟨4354080, 4354083⟩, ⟨712941, 712946⟩, ⟨(-4226), (-4222)⟩, ⟨(-346), (-342)⟩⟩
noncomputable def f33 : ℝ → ℝ := fun t ↦ f31 t + f32 t

def j34 : Jet := ⟨⟨(-130565580), (-130565578)⟩, ⟨(-86242200), (-86242196)⟩, ⟨(-13841699), (-13841695)⟩, ⟨175773, 175777⟩, ⟨13999, 14003⟩⟩
...
def j36 : Jet := ⟨⟨4164401716, 4164401718⟩, ⟨(-86242200), (-86242196)⟩, ⟨(-13841699), (-13841695)⟩, ⟨175773, 175777⟩, ⟨13999, 14003⟩⟩
noncomputable def f36 : ℝ → ℝ := fun t ↦ f34 t + f35 t

def j37 : Jet := ⟨⟨603020275, 603020278⟩, ⟨193567047, 193567052⟩, ⟨(-3687153), (-3687148)⟩, ⟨(-391591), (-391587)⟩, ⟨4478, 4483⟩⟩
noncomputable def f37 : ℝ → ℝ := fun t ↦ f2 t * f19 t

def j38 : Jet := ⟨⟨4429626468, 4429626471⟩, ⟨91734836, 91734842⟩, ⟨16623023, 16623030⟩, ⟨462188, 462197⟩, ⟨46054, 46064⟩⟩
noncomputable def f38 : ℝ → ℝ := fun t ↦ (f36 t)⁻¹

def j39 : Jet := ⟨⟨621926638, 621926642⟩, ⟨212515629, 212515637⟩, ⟨2665479, 2665488⟩, ⟨331441, 331451⟩, ⟨9279, 9290⟩⟩
noncomputable def f39 : ℝ → ℝ := fun t ↦ f37 t * f38 t

def j40 : Jet := ⟨⟨(-586569053), (-586569052)⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f40 : ℝ → ℝ := fun t ↦ -f0 t

def j41 : Jet := ⟨⟨3708398243, 3708398244⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f41 : ℝ → ℝ := fun t ↦ f35 t + f40 t

def j42 : Jet := ⟨⟨90057203, 90057205⟩, ⟨61546046, 61546052⟩, ⟨11287245, 11287253⟩, ⟨359762, 359770⟩, ⟨37138, 37149⟩⟩
noncomputable def f42 : ℝ → ℝ := fun t ↦ f39 t * f39 t

def j43 : Jet := ⟨⟨4385024499, 4385024501⟩, ⟨61546046, 61546052⟩, ⟨11287245, 11287253⟩, ⟨359762, 359770⟩, ⟨37138, 37149⟩⟩
noncomputable def f43 : ℝ → ℝ := fun t ↦ f42 t + f35 t

def j44 : Jet := ⟨⟨4339762299, 4339762301⟩, ⟨30455384, 30455388⟩, ⟨5478504, 5478510⟩, ⟨139577, 139583⟩, ⟨13939, 13947⟩⟩
noncomputable def f44 : ℝ → ℝ := fun t ↦ Real.sqrt (f43 t)

def j45 : Jet := ⟨⟨3747075536, 3747075540⟩, ⟨(-171266201), (-171266195)⟩, ⟨3343853, 3343861⟩, ⟨(-128889), (-128882)⟩, ⟨5680, 5689⟩⟩
...
def j47 : Jet := ⟨⟨3199296782, 3199296790⟩, ⟨1066432259, 1066432265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f47 : ℝ → ℝ := fun t ↦ f0 t * f46 t

def j48 : Jet := ⟨⟨2383138029, 2383138042⟩, ⟨1588758682, 1588758698⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f48 : ℝ → ℝ := fun t ↦ f47 t * f47 t

def j49 : Jet := ⟨⟨2383138029, 2383138042⟩, ⟨1588758682, 1588758698⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f49 : ℝ → ℝ := fun t ↦ f35 t * f48 t

def j50 : Jet := ⟨⟨(-2383138042), (-2383138029)⟩, ⟨(-1588758698), (-1588758682)⟩, ⟨(-264793117), (-264793113)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j53 : Jet := ⟨⟨(-1191569021), (-1191569014)⟩, ⟨(-794379349), (-794379341)⟩, ⟨(-132396559), (-132396556)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f53 : ℝ → ℝ := fun t ↦ f50 t * f52 t

def j54 : Jet := ⟨⟨3254407261, 3254407274⟩, ⟨(-601921681), (-601921671)⟩, ⟨(-44655813), (-44655808)⟩, ⟨15122999, 15123001⟩, ⟨(-10993), (-10992)⟩⟩
noncomputable def f54 : ℝ → ℝ := fun t ↦ Real.exp (f53 t)

def j55 : Jet := ⟨⟨2839255573, 2839255588⟩, ⟨(-654909755), (-654909739)⟩, ⟨(-12423288), (-12423274)⟩, ⟨14408221, 14408235⟩, ⟨(-625039), (-625024)⟩⟩
noncomputable def f55 : ℝ → ℝ := fun t ↦ f45 t * f54 t

def j56 : Jet := ⟨⟨391046034, 782092070⟩, ⟨195523017, 195523018⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f56 : ℝ → ℝ := fun t ↦ (center : ℝ) + (radius : ℝ) * t

def j57 : Jet := ⟨⟨1228507347, 2457014702⟩, ⟨614253673, 614253677⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f57 : ℝ → ℝ := fun t ↦ f56 t * f1 t

def j58 : Jet := ⟨⟨351395062, 1405580260⟩, ⟨351395062, 702790132⟩, ⟨87848765, 87848767⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
...
def j61 : Jet := ⟨⟨87, 353⟩, ⟨87, 177⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f61 : ℝ → ℝ := fun t ↦ f58 t * f60 t

def j62 : Jet := ⟨⟨(-94600), (-94333)⟩, ⟨87, 177⟩, ⟨21, 23⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f62 : ℝ → ℝ := fun t ↦ f61 t + f9 t

def j63 : Jet := ⟨⟨(-30960), (-7717)⟩, ⟨(-15473), (-7659)⟩, ⟨(-1927), (-1892)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f63 : ℝ → ℝ := fun t ↦ f58 t * f62 t

def j64 : Jet := ⟨⟨5082096, 5105340⟩, ⟨(-15473), (-7659)⟩, ⟨(-1927), (-1892)⟩, ⟨2, 8⟩, ⟨0, 1⟩⟩
noncomputable def f64 : ℝ → ℝ := fun t ↦ f63 t + f12 t

def j65 : Jet := ⟨⟨415794, 1670785⟩, ⟨410730, 834767⟩, ⟨100785, 103645⟩, ⟨(-633), (-307)⟩, ⟨(-40), (-35)⟩⟩
noncomputable def f65 : ℝ → ℝ := fun t ↦ f58 t * f64 t

def j66 : Jet := ⟨⟨(-142749783), (-141494791)⟩, ⟨410730, 834767⟩, ⟨100785, 103645⟩, ⟨(-633), (-307)⟩, ⟨(-40), (-35)⟩⟩
noncomputable def f66 : ℝ → ℝ := fun t ↦ f65 t + f15 t

def j67 : Jet := ⟨⟨(-46716602), (-11576472)⟩, ⟨(-23324697), (-11303284)⟩, ⟨(-2877939), (-2723604)⟩, ⟨16438, 34010⟩, ⟨1943, 2093⟩⟩
noncomputable def f67 : ℝ → ℝ := fun t ↦ f58 t * f66 t

def j68 : Jet := ⟨⟨1384939163, 1420079294⟩, ⟨(-23324697), (-11303284)⟩, ⟨(-2877939), (-2723604)⟩, ⟨16438, 34010⟩, ⟨1943, 2093⟩⟩
...
def j72 : Jet := ⟨⟨965, 3871⟩, ⟨959, 1936⟩, ⟨237, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f72 : ℝ → ℝ := fun t ↦ f58 t * f71 t

def j73 : Jet := ⟨⟨(-851212), (-848305)⟩, ⟨959, 1936⟩, ⟨237, 242⟩, ⟨(-2), 0⟩, ⟨(-1), 0⟩⟩
noncomputable def f73 : ℝ → ℝ := fun t ↦ f72 t + f26 t

def j74 : Jet := ⟨⟨(-278570), (-69404)⟩, ⟨(-139207), (-68770)⟩, ⟨(-17314), (-16954)⟩, ⟨37, 80⟩, ⟨2, 5⟩⟩
noncomputable def f74 : ℝ → ℝ := fun t ↦ f58 t * f73 t

def j75 : Jet := ⟨⟨35512824, 35721991⟩, ⟨(-139207), (-68770)⟩, ⟨(-17314), (-16954)⟩, ⟨37, 80⟩, ⟨2, 5⟩⟩
noncomputable def f75 : ℝ → ℝ := fun t ↦ f74 t + f29 t

def j76 : Jet := ⟨⟨2905500, 11690456⟩, ⟨2859942, 5839602⟩, ⟨697929, 723641⟩, ⟨(-5679), (-2766)⟩, ⟨(-352), (-330)⟩⟩
noncomputable def f76 : ℝ → ℝ := fun t ↦ f58 t * f75 t

def j77 : Jet := ⟨⟨(-712922383), (-704137426)⟩, ⟨2859942, 5839602⟩, ⟨697929, 723641⟩, ⟨(-5679), (-2766)⟩, ⟨(-352), (-330)⟩⟩
noncomputable def f77 : ℝ → ℝ := fun t ↦ f76 t + f32 t

def j78 : Jet := ⟨⟨(-233312517), (-57609382)⟩, ⟨(-116422272), (-55698301)⟩, ⟨(-14290945), (-13209983)⟩, ⟨113738, 237628⟩, ⟨13229, 14550⟩⟩
noncomputable def f78 : ℝ → ℝ := fun t ↦ f58 t * f77 t

def j79 : Jet := ⟨⟨4061654779, 4237357914⟩, ⟨(-116422272), (-55698301)⟩, ⟨(-14290945), (-13209983)⟩, ⟨113738, 237628⟩, ⟨13229, 14550⟩⟩
noncomputable def f79 : ℝ → ℝ := fun t ↦ f78 t + f35 t

def j80 : Jet := ⟨⟨396139905, 812382369⟩, ⟨184726631, 199862468⟩, ⟨(-4982209), (-2395605)⟩, ⟨(-406894), (-370064)⟩, ⟨2905, 6063⟩⟩
noncomputable def f80 : ℝ → ℝ := fun t ↦ f57 t * f68 t

def j81 : Jet := ⟨⟨4353359911, 4541681920⟩, ⟨57223098, 130181653⟩, ⟨14323792, 19711418⟩, ⟨111977, 901143⟩, ⟨23229, 79406⟩⟩
noncomputable def f81 : ℝ → ℝ := fun t ↦ (f79 t)⁻¹

def j82 : Jet := ⟨⟨401525660, 859047826⟩, ⟨192515985, 235966649⟩, ⟨(-1486102), 7358079⟩, ⟨45113, 680691⟩, ⟨(-25298), 50447⟩⟩
noncomputable def f82 : ℝ → ℝ := fun t ↦ f80 t * f81 t

def j83 : Jet := ⟨⟨(-782092070), (-391046034)⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f83 : ℝ → ℝ := fun t ↦ -f56 t

def j84 : Jet := ⟨⟨3512875226, 3903921262⟩, ⟨(-195523018), (-195523017)⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f84 : ℝ → ℝ := fun t ↦ f35 t + f83 t

def j85 : Jet := ⟨⟨37537621, 171820440⟩, ⟨35995666, 94392634⟩, ⟨8034783, 15907489⟩, ⟨(-154860), 1080804⟩, ⟨(-8622), 107584⟩⟩
noncomputable def f85 : ℝ → ℝ := fun t ↦ f82 t * f82 t

def j86 : Jet := ⟨⟨4332504917, 4466787736⟩, ⟨35995666, 94392634⟩, ⟨8034783, 15907489⟩, ⟨(-154860), 1080804⟩, ⟨(-8622), 107584⟩⟩
noncomputable def f86 : ℝ → ℝ := fun t ↦ f85 t + f35 t

def j87 : Jet := ⟨⟨4313695275, 4380035074⟩, ⟨17648284, 46991414⟩, ⟨3687292, 7883113⟩, ⟨(-162970), 522971⟩, ⟨(-17193), 53760⟩⟩
noncomputable def f87 : ℝ → ℝ := fun t ↦ Real.sqrt (f86 t)

def j88 : Jet := ⟨⟨3528192933, 3981243832⟩, ⟨(-184961004), (-153662620)⟩, ⟨876628, 6361960⟩, ⟨(-507001), 307497⟩, ⟨(-39436), 56286⟩⟩
noncomputable def f88 : ℝ → ℝ := fun t ↦ f84 t * f87 t

def j89 : Jet := ⟨⟨2132864518, 4265729049⟩, ⟨1066432259, 1066432265⟩, ⟨0, 0⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f89 : ℝ → ℝ := fun t ↦ f56 t * f46 t

def j90 : Jet := ⟨⟨1059172454, 4236689844⟩, ⟨1059172454, 2118344928⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f90 : ℝ → ℝ := fun t ↦ f89 t * f89 t

def j91 : Jet := ⟨⟨1059172454, 4236689844⟩, ⟨1059172454, 2118344928⟩, ⟨264793113, 264793117⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f91 : ℝ → ℝ := fun t ↦ f35 t * f90 t

def j92 : Jet := ⟨⟨(-4236689844), (-1059172454)⟩, ⟨(-2118344928), (-1059172454)⟩, ⟨(-264793117), (-264793113)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f92 : ℝ → ℝ := fun t ↦ -f91 t

def j93 : Jet := ⟨⟨(-2118344922), (-529586227)⟩, ⟨(-1059172464), (-529586227)⟩, ⟨(-132396559), (-132396556)⟩, ⟨0, 0⟩, ⟨0, 0⟩⟩
noncomputable def f93 : ℝ → ℝ := fun t ↦ f92 t * f52 t

def j94 : Jet := ⟨⟨2622762965, 3796729503⟩, ⟨(-936303135), (-323396907)⟩, ⟨(-97099843), 34600605⟩, ⟨3801756, 27223499⟩, ⟨(-2211681), 1379406⟩⟩
noncomputable def f94 : ℝ → ℝ := fun t ↦ Real.exp (f93 t)

def j95 : Jet := ⟨⟨2154524847, 3519399538⟩, ⟨(-1031415999), (-359496872)⟩, ⟨(-77901630), 78018676⟩, ⟨(-202123), 29622358⟩, ⟨(-3468228), 1354170⟩⟩
...
theorem mid44 : EnclosesOn j44 f44 ({0} : Set ℝ) := by
  exact mid43.sqrt (seed := ⟨4339762299, 4339762301⟩) (by decide +kernel)
...
theorem mid54 : EnclosesOn j54 f54 ({0} : Set ℝ) := by
  exact mid53.exp FiniteExpSeeds.certified1238
...
theorem whole87 : EnclosesOn j87 f87 (Icc (-1 : ℝ) 1) := by
  exact whole86.sqrt (seed := ⟨4313695275, 4380035074⟩) (by decide +kernel)
...
theorem whole94 : EnclosesOn j94 f94 (Icc (-1 : ℝ) 1) := by
  exact whole93.exp FiniteExpSeeds.certified1239
    (by decide +kernel) (by decide +kernel)
...
def upper : Rat := (129077373 / 2147483648)
...
theorem actual_correction_integral {n : ℕ} (hn : 6 ≤ n) :
    (∫ s in ((36419 / 400000) : ℝ)..(36419 / 200000), prawitzNormalCorrection
